...
public class allg
  implements alae, allf
{
  public static float a;
  public static int a;
  public static int b;
  private long jdField_a_of_type_Long;
  public volatile alac a;
  alad jdField_a_of_type_Alad;
  public alaj a;
  private alap jdField_a_of_type_Alap = new alap(this);
  ...
  public allg()
  {
    this.jdField_a_of_type_Alaj = new alaj();
    this.jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  }
  
  private alac a(String paramString)
  {
    if (this.jdField_a_of_type_JavaUtilMap.containsKey(paramString)) {
      return (alac)this.jdField_a_of_type_JavaUtilMap.get(paramString);
    }
    return null;
  }
  ...
  private void b(GL10 paramGL10)
  {
    ...
    this.jdField_a_of_type_Alap.onDrawFrame(paramGL10);
    ...
    paramGL10 = this.jdField_a_of_type_Alac;
    if ((paramGL10 != null) && (paramGL10.d()))
    {
      System.currentTimeMillis();
      GLES20.glEnable(2929);
      alak localalak = this.jdField_a_of_type_Alaj.a(paramGL10.b(), paramGL10.c());
      if (localalak != null) {
        paramGL10.a(localalak);
      }
      GLES20.glDisable(2929);
      System.currentTimeMillis();
    }
  ...
  public int a()
  {
    return this.jdField_a_of_type_Alap.a();
  }
  
  public long a()
  {
    return this.jdField_a_of_type_Alaj.jdField_a_of_type_Long;
  }
  ...
  public void a(int paramInt)
  {
    ...
    this.jdField_a_of_type_Alap.b(paramInt);
  }
  ...
  public void a(int paramInt1, SurfaceTexture paramSurfaceTexture, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    this.jdField_a_of_type_Alap.a(paramInt1, paramSurfaceTexture);
    this.jdField_a_of_type_Alap.a(paramInt2, paramInt3, paramInt4, paramInt5);
  ...
  {
    this.jdField_a_of_type_Alaj.a(paramArrayOfFloat);
  }
  
  public void a(long paramLong)
  {
    this.jdField_a_of_type_Alaj.jdField_a_of_type_Long = paramLong;
  }
  
  public void a(alac paramalac, ArCloudConfigInfo paramArCloudConfigInfo, int paramInt1, int paramInt2, Object paramObject)
  {
    if ((paramArCloudConfigInfo != null) && (paramArCloudConfigInfo.a()) && (this.jdField_a_of_type_Alad != null)) {
      this.jdField_a_of_type_Alad.a(paramArCloudConfigInfo, paramInt1, paramInt2, paramObject);
    }
  }
  ...
  {
    this.jdField_a_of_type_Alaj.a(paramalah);
  }
  
  public void a(almp paramalmp)
  {
  ...
  public void a(ArVideoResourceInfo paramArVideoResourceInfo, alae paramalae)
  {
    ...
    this.jdField_a_of_type_Alad.a(paramArVideoResourceInfo, paramalae);
  }
  ...
  {
    this.jdField_a_of_type_Alap.a(paramFloatBuffer, paramSize);
  }
  ...
  public boolean a(alag paramalag)
  {
    QLog.i("AREngine_UniformGLRenderManagerImpl", 1, "startModelRender. resourceInfo.key = " + paramalag.jdField_a_of_type_JavaLangString + ", resourceInfo.arType = " + paramalag.jdField_a_of_type_Int + ", resourceInfo.trackMode = " + paramalag.jdField_b_of_type_Int);
    if (!this.e)
    {
      QLog.i("AREngine_UniformGLRenderManagerImpl", 1, "startModelRender. fail because of render not ready");
      return false;
    }
    alac localalac2 = a(paramalag.jdField_a_of_type_JavaLangString);
    alac localalac1 = localalac2;
    if (localalac2 == null)
    {
      localalac1 = alai.a(this, paramalag, this.jdField_a_of_type_AndroidOpenglGLSurfaceView);
      QLog.d("AREngine_UniformGLRenderManagerImpl", 1, "crate new render here 1" + localalac1);
      this.jdField_a_of_type_JavaUtilMap.put(paramalag.jdField_a_of_type_JavaLangString, localalac1);
      QLog.d("AREngine_UniformGLRenderManagerImpl", 1, "crate new render here " + localalac1);
    }
    if (localalac1 == null)
    {
      ...
      paramalag = this.jdField_a_of_type_Alac;
      this.jdField_a_of_type_Alac = null;
      this.jdField_a_of_type_AndroidOpenglGLSurfaceView.queueEvent(new UniformGLRenderManagerImpl.1(this, paramalag));
      return false;
    }
    this.jdField_a_of_type_AndroidOpenglGLSurfaceView.queueEvent(new UniformGLRenderManagerImpl.2(this, localalac1, paramalag));
    return true;
  }
  ...
  public boolean a(boolean paramBoolean, float paramFloat1, float paramFloat2)
  {
    ...
    {
      this.jdField_a_of_type_Alap.a(paramBoolean);
      this.jdField_a_of_type_Alap.a(paramFloat2);
      return true;
    }
    return false;
  }
  ...
  public void b()
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext()) {
        ((alac)localIterator.next()).f();
      }
      this.jdField_a_of_type_JavaUtilMap.clear();
      this.jdField_a_of_type_Alac = null;
      this.jdField_a_of_type_Alap.g();
      this.jdField_a_of_type_Alaj.a();
      this.e = false;
  ...
  {
    if ((this.jdField_a_of_type_Alad == null) || (this.jdField_a_of_type_Alac == null))
    {
    ...
    default: 
      return;
    case 0: 
      this.jdField_a_of_type_Alad.a(this.jdField_a_of_type_Alac.c(), paramInt2);
      return;
    case 1: 
      this.jdField_a_of_type_Alad.c(this.jdField_a_of_type_Alac.c(), paramInt2);
      return;
    case 2: 
      this.jdField_a_of_type_Alad.b(this.jdField_a_of_type_Alac.c(), paramInt2);
      return;
    }
    this.jdField_a_of_type_Alad.d(this.jdField_a_of_type_Alac.c(), paramInt2);
  }
  
  public void b(long paramLong)
  {
    this.jdField_a_of_type_Alaj.c = paramLong;
  }
  ...
  public void onDrawFrame(GL10 paramGL10)
  {
    ...
    while (i != 0)
    {
      if (!this.jdField_b_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqArARRecordVideoRecordController.a(this.jdField_a_of_type_Avyy, i, j);
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Alad != null) {
        this.jdField_a_of_type_Alad.a(null, 1001, 0, localBitmap);
      }
  ...
  public void onSurfaceChanged(GL10 paramGL10, int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Almp != null) {
      this.jdField_a_of_type_Almp.a(paramGL10, paramInt1, paramInt2);
    }
    this.jdField_a_of_type_Alap.onSurfaceChanged(paramGL10, paramInt1, paramInt2);
    if (this.jdField_a_of_type_Alad != null) {
  ...
  public void onSurfaceCreated(GL10 paramGL10, EGLConfig paramEGLConfig)
  {
    ...
    akxb.a().a(paramGL10.glGetString(7937));
    this.jdField_a_of_type_Alap.onSurfaceCreated(paramGL10, paramEGLConfig);
    if (this.jdField_a_of_type_Almp != null) {
      this.jdField_a_of_type_Almp.a(paramGL10);
    }
    ...
    aldl.a(paramGL10.glGetString(7937), paramGL10.glGetString(7936), paramGL10.glGetString(7938), paramEGLConfig.toString());
  }
}
