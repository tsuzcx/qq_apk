...
{
  public static int a;
  private static adma jdField_a_of_type_Adma;
  public static ArrayList<String> a;
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper(), this);
  private Vector<adku> jdField_a_of_type_JavaUtilVector = new Vector();
  public boolean a;
  ...
  {
    if (jdField_a_of_type_Adma == null) {}
    try
    {
      if (jdField_a_of_type_Adma == null) {
        jdField_a_of_type_Adma = new adma();
      }
      return jdField_a_of_type_Adma;
    }
    finally {}
  }
  
  private void a(int paramInt, abjd paramabjd)
  {
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      Iterator localIterator = this.jdField_a_of_type_JavaUtilVector.iterator();
      if (localIterator.hasNext()) {
        ((adku)localIterator.next()).a(paramInt, paramabjd);
      }
    }
  }
  ...
  public void a(long paramLong)
  {
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      Iterator localIterator = this.jdField_a_of_type_JavaUtilVector.iterator();
      if (localIterator.hasNext()) {
        ((adku)localIterator.next()).a(paramLong);
      }
    }
  }
  ...
  public void a(adku paramadku)
  {
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      this.jdField_a_of_type_JavaUtilVector.add(paramadku);
      return;
    }
  }
  
  public boolean a(long paramLong1, long paramLong2, abjc paramabjc, int paramInt)
  {
    abjd localabjd = paramabjc.a(paramInt);
    if ((localabjd != null) && (paramLong1 >= localabjd.jdField_a_of_type_Int * paramLong2 / 100L))
    {
      if (QLog.isColorLevel()) {
        QLog.d("MemoryReporter", 2, "onNeedTrimMemory|maxHeap=" + paramLong2 / 1024L / 1024L + ",totalSize=" + paramLong1 / 1024L / 84L);
      }
      paramabjc.jdField_a_of_type_Int = localabjd.b;
      a(paramInt, localabjd);
      return true;
    }
    return false;
  }
  ...
  public void b(adku paramadku)
  {
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      this.jdField_a_of_type_JavaUtilVector.remove(paramadku);
      return;
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    paramMessage = MagnifierSDK.a().a().jdField_a_of_type_Abjc;
    abjg.a().c();
    int i;
