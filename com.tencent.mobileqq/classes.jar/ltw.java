  ...
  implements lgo
{
  ...
  public lpa a()
  {
    for (;;)
    {
      ...
      if (QLog.isColorLevel()) {}
      localObject2 = new lpa((short)5, (short)localObject2.length, (byte[])localObject2);
      return localObject2;
      label412:
      i -= 1;
    }
  ...
  public void a(String paramString, lpa paramlpa)
  {
    boolean bool;
    if ((!QLog.isColorLevel()) || (paramlpa != null))
    {
      try
      {
        if (paramlpa.a() == null) {
      ...
      try
      {
        localFrameSyncInfo.mergeFrom(paramlpa.a());
        paramlpa = ltu.a(this.a, localFrameSyncInfo);
        paramString = paramlpa;
        bool = true;
      }
      catch (Exception paramlpa)
      {
        bool = false;
        break label78;
      }
