...
public class bcwd
{
  public static bcxj a(bcxj parambcxj)
  {
    for (parambcxj = parambcxj.a(); (parambcxj != null) && (parambcxj.jdField_a_of_type_Int != 1); parambcxj = parambcxj.a()) {}
    return parambcxj;
  }
  ...
  public static AbsStructMsg a()
  {
    ...
    localStructMsgForGeneralShare.mMsgBrief = anni.a(2131713291);
    ...
    bcwc.a(0).a(new StructMsgItemTitle(""));
  ...
  public static AbsStructMsg a(QQAppInterface paramQQAppInterface, int paramInt1, long paramLong, byte[] paramArrayOfByte, int paramInt2)
  {
    ...
    if ((paramArrayOfByte != null) && ((paramArrayOfByte instanceof AbsShareMsg)))
    {
      ...
      if ((l1 == 23L) && ((paramInt1 == 82) || (paramInt1 == 43))) {
        bcst.b(paramQQAppInterface, "P_CliOper", "Grp_AIO", paramQQAppInterface.getCurrentAccountUin(), "AIOchat", "appear_obj", 0, 0, String.valueOf(paramLong), String.valueOf(l1), String.valueOf(l2), "");
      }
      if (l1 == 52L)
      {
        paramQQAppInterface = new StringBuilder("rec flower msg,");
        paramQQAppInterface.append(bcye.a(paramArrayOfByte));
  ...
  public static AbsStructMsg a(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    //   93: astore_3
    //   94: aload_3
    //   95: invokestatic 250	bcwd:a	(Ljava/lang/String;)Z
    //   98: istore_2
    //   99: aload_3
    //   100: aload_0
    //   101: iload_2
    //   102: invokestatic 255	bdnh:a	(Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    //   105: invokestatic 258	bcwd:a	(Ljava/lang/String;)Ljava/lang/String;
    //   108: astore_3
    ...
    //   153: new 270	bcxk
    //   156: dup
    //   157: invokespecial 271	bcxk:<init>	()V
    //   160: astore 4
    //   162: aload 4
    //   164: aload_0
    //   165: invokevirtual 273	bcxk:a	(Ljava/lang/String;)V
    //   168: aload 4
    //   170: iload_2
    //   171: invokevirtual 276	bcxk:a	(Z)V
    ...
    //   192: aload 4
    //   194: invokevirtual 297	bcxk:a	()Lcom/tencent/mobileqq/structmsg/AbsStructMsg;
    //   197: astore_3
    //   198: aload_3
    //   199: astore_0
    //   200: aload_3
  ...
  public static String a(bcxj parambcxj)
  {
    if (parambcxj.jdField_a_of_type_Int == 3) {}
    Object localObject;
    for (parambcxj = parambcxj.jdField_a_of_type_JavaLangString;; parambcxj = ((StringBuilder)localObject).toString())
    {
      ...
      if (i < j)
      {
        ...
        for (;;)
        {
          i += 1;
          break;
          if (localbcxj.jdField_a_of_type_Int == 3) {
            ((StringBuilder)localObject).append(localbcxj.jdField_a_of_type_JavaLangString);
          }
        }
      }
    }
  ...
  public static final String a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = afur.a().append(paramString);
        i = 0;
        k = 0;
