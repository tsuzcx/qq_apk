  ...
  implements Handler.Callback, Manager
{
  ...
  public awhq(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        for (int i = 1;; i = 0)
        {
          ...
          if (!bkgu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "com.tencent.tim"))
          {
            if (!QLog.isColorLevel()) {
              break;
            }
  ...
  private void b()
  {
    ...
    localObject2 = anni.a(2131713673);
    str4 = "登录TIM";
    str2 = anni.a(2131713672);
    ...
    bglp.a(BaseActivity.sTopActivity, 230, str5, str6, (String)localObject3, (String)localObject1, new awhr(this), new awhs(this)).show();
    bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80085D9", "0X80085D9", 0, 0, "", "", "", "");
  }
  ...
  {
    if (!bgnw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "com.tencent.tim", "775E696D09856872FDD8AB4F3F06B1E0"))
    {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 1, 2131718560, 0).a();
      if (QLog.isColorLevel()) {
        QLog.d(jdField_a_of_type_JavaLangString, 2, "jumpTimLogin tim not install ");
      }
      return;
    }
    String str = bgnw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "com.tencent.tim");
    int i = arag.a().b();
    if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      {
        localbiau = new biau(BaseActivity.sTopActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getResources().getDimensionPixelOffset(2131298998));
        localbiau.a(anni.a(2131713671));
        localbiau.show();
        ...
        localWtloginHelper.SetListener(new awht(this, localbiau, localWtloginHelper, paramBundle));
        paramBundle = util.getPkgSigFromApkName(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "com.tencent.tim");
        i = localWtloginHelper.GetA1WithA1(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), 16L, 16L, "com.tencent.tim".getBytes(), 1L, 16L, 16L, "8.4.1".getBytes(), paramBundle, new WUserSigInfo(), new WFastLoginInfo());
      }
      if (i == -1001) {
        break;
      }
      ...
      if ((localbiau != null) && (localbiau.isShowing())) {
        localbiau.dismiss();
      }
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 1, 2131718559, 0).a();
      return;
    } while (j >= i);
    QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 1, 2131718561, 0).a();
  }
