  ...
  extends DynamicTextItem
{
  ...
  private String jdField_a_of_type_JavaLangString = ajya.a(2131705890);
  ...
  public bjia(int paramInt, List<String> paramList, Bitmap paramBitmap1, Bitmap paramBitmap2)
  {
    ...
    d();
    this.m = ((int)this.jdField_a_of_type_AndroidTextTextPaint.measureText(ajya.a(2131705891)));
    this.n = ((int)(this.jdField_b_of_type_AndroidTextTextPaint.measureText(ajya.a(2131705889)) * 10.0F));
    if (paramList == null) {}
  ...
  public InputFilter a()
  {
    if (this.jdField_a_of_type_AndroidTextInputFilter == null) {
      this.jdField_a_of_type_AndroidTextInputFilter = new bjid(this, 20);
    }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    String str2 = a(paramInt, new bjib(this));
    ...
    for (;;)
    {
      ...
      break label173;
      label965:
      this.jdField_a_of_type_AndroidTextStaticLayout = bjix.a(str2, 0, str2.length(), this.jdField_b_of_type_AndroidTextTextPaint, this.n, Layout.Alignment.ALIGN_NORMAL, 1.5F, 0.0F, false, null, 0, 2);
