...
public final class tdv
  implements Runnable
{
  public tdv(QQAppInterface paramQQAppInterface, String paramString) {}
  ...
  public void run()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.d() == 1)
    {
      ...
      if (!SettingCloneUtil.readValue(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), null, "no_disturb_mode", "qqsetting_nodisturb_mode_key", false)) {
        break label507;
      }
      i = 1;
      label163:
      ...
      if (!SettingCloneUtil.readValue(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131434203), "qqsetting_notify_blncontrol_key", true)) {
        break label517;
      }
      i = 1;
      label231:
      localHashMap.put("Led_blinking", Integer.valueOf(i));
      if (!SettingCloneUtil.readValue(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131435403), "qqsetting_receivemsg_whenexit_key", true)) {
        break label522;
      }
      i = 1;
      label276:
      localHashMap.put("Logout_msg", Integer.valueOf(i));
      if (!SettingCloneUtil.readValue(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131434207), "qqsetting_notify_myfeedpush_key", true)) {
        break label527;
      }
      i = 1;
      label321:
