...
public class amzz
  extends amxi
{
  public amzz(CmGameLoadingFragment paramCmGameLoadingFragment, AppInterface paramAppInterface)
  {
  ...
  public void onDownloadConfirm(CmGameStartChecker.StartCheckParam paramStartCheckParam, amxj paramamxj, long paramLong)
  {
    ...
    do
    {
      ...
      } while (paramamxj == null);
      paramamxj.a(paramStartCheckParam);
      return;
    ...
    CmGameLoadingFragment.a(this.a).a(paramStartCheckParam, paramamxj, paramLong);
  }
  ...
  {
    anav.a().a(paramStartCheckParam, paramLong, null);
    if (CmGameLoadingFragment.a(this.a) != null) {
    ...
    do
    {
      do
      {
        do
        {
          ...
          anav.a().a(paramStartCheckParam, paramLong, paramCmGameInitParams);
