...
public class bnjm
{
  ...
  private bnjn jdField_a_of_type_Bnjn;
  ...
  private String jdField_b_of_type_JavaLangString = antf.aZ + "/tencent/Qzone/AntishakeGif/";
  ...
  static
  {
    ...
    jdField_a_of_type_JavaUtilConcurrentThreadPoolExecutor = new ThreadPoolExecutor(bhlo.b(), bhlo.b() + 5, 200L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue());
    a();
  }
  ...
  public static bnjm a()
  {
    try
    {
      if (jdField_a_of_type_Bnjm == null) {
        jdField_a_of_type_Bnjm = new bnjm();
      }
      bnjm localbnjm = jdField_a_of_type_Bnjm;
      return localbnjm;
    }
    finally {}
  }
  ...
  private String a()
  {
    ...
    if (!this.jdField_b_of_type_Boolean)
    {
      ...
      localFile = new File(bigv.a(this.jdField_b_of_type_JavaLangString));
      if (!localFile.exists()) {
        localFile.mkdirs();
      }
      localFile = new File(bigv.a(this.jdField_b_of_type_JavaLangString + this.jdField_c_of_type_JavaLangString));
      if (localFile.exists()) {}
    }
    try
    {
  ...
  {
    if (this.jdField_a_of_type_Bnjn != null) {
      this.jdField_a_of_type_Bnjn.a(paramInt);
    }
  }
  ...
  public ArrayList<String> a(ArrayList<Bitmap> paramArrayList)
  {
    ...
    catch (IOException localIOException)
    {
      ...
      catch (InterruptedException paramArrayList)
      {
        ...
        System.gc();
        this.jdField_a_of_type_Bnjn = null;
  ...
  public void a(bnjn parambnjn)
  {
    this.jdField_a_of_type_Bnjn = parambnjn;
  }
  ...
  public boolean a(ArrayList<String> paramArrayList)
  {
    ...
    String str = antf.aZ + "/tencent/Qzone/AlbumAutoVConvGif/";
  ...
  public boolean a(ArrayList<String> paramArrayList, LruCache<Integer, BitmapDrawable> paramLruCache)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("QzoneVision", 2, "DeviceInfoUtil.getMemoryClass() = " + bhlo.f() / 1048576L + "M, DeviceInfoUtil.getSystemAvaialbeMemory() = " + bhlo.e() / 1048576L + "M");
    }
