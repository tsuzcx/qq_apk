...
public class agch
{
  public final int a;
  public agcf a;
  ajtq jdField_a_of_type_Ajtq = new agcr(this);
  private ajuh jdField_a_of_type_Ajuh = new agcj(this);
  private akav jdField_a_of_type_Akav = new agdb(this);
  private akbc jdField_a_of_type_Akbc = new agdg(this);
  private akbu jdField_a_of_type_Akbu = new agdh(this);
  akfl jdField_a_of_type_Akfl = new agcv(this);
  private akud jdField_a_of_type_Akud = new agde(this);
  private akue jdField_a_of_type_Akue = new agdd(this);
  protected Bundle a;
  public Handler a;
  private aoeu jdField_a_of_type_Aoeu = new agck(this);
  private atzl jdField_a_of_type_Atzl = new agdf(this);
  private atzm jdField_a_of_type_Atzm = new agcq(this);
  private atzo jdField_a_of_type_Atzo = new agdc(this);
  private atzp jdField_a_of_type_Atzp = new agci(this);
  ...
  public agch(SplashActivity paramSplashActivity)
  {
    this.jdField_a_of_type_Int = 0;
    this.jdField_b_of_type_Int = 1;
    this.jdField_c_of_type_Int = 3;
    this.jdField_a_of_type_AndroidOsHandler = new agcm(this, Looper.getMainLooper());
    this.jdField_a_of_type_Nat = new agcu(this);
    this.jdField_a_of_type_Agcf = new agcf(paramSplashActivity);
    this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity = paramSplashActivity;
  }
  
  private bbgg a(String paramString)
  {
    return bbcv.a(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity, 230).setTitle(null).setMessage(paramString).setPositiveButton(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.getString(2131690575), new agcy(this));
  }
  
  private bbgg a(String paramString1, String paramString2)
  {
    return bbcv.a(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity, 230).setTitle(null).setMessage(paramString1).setPositiveButton(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.getString(2131719411), new agda(this)).setNegativeButton(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.getString(2131719410) + paramString2, new agcz(this));
  }
  ...
  private void a(Bundle paramBundle)
  {
    ...
    if (bool1)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.getIntent().putExtra("key_action", ajwl.class.getSimpleName());
      i();
      return;
    }
    if (bool2)
    {
      ...
      for (this.jdField_c_of_type_Bbgg = a(paramBundle, str4);; this.jdField_c_of_type_Bbgg = a(paramBundle))
      {
        this.jdField_c_of_type_Bbgg.show();
        return;
      }
    }
    ajwl.a(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity, str1, str2, str3);
  }
  ...
  {
    bbcv.a(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity, 230).setTitle(null).setMessage(String.format(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.getString(2131699563), new Object[] { paramString })).setPositiveButton(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.getString(2131691059), new agcx(this, paramString)).setNegativeButton(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.getString(2131690573), new agcw(this)).show();
  }
  ...
  private void b(Bundle paramBundle)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.getIntent().removeExtra("pull_app_not_privilege");
      this.jdField_c_of_type_Bbgg = a(str1);
      this.jdField_c_of_type_Bbgg.show();
    }
    do
    {
      ...
      if (bool2)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.getIntent().putExtra("is_change_account", true);
        this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.getIntent().putExtra("if_check_account_same", true);
        this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.getIntent().putExtra("key_action", aqcn.class.getSimpleName());
        i();
        return;
      }
    } while (!bool3);
  ...
  {
    int i = ((atxb)paramQQAppInterface.getManager(160)).a();
    String str = null;
    switch (i)
    {
    }
    ...
    {
      if (str != null) {
        axqw.b(paramQQAppInterface, "dc00898", "", "", str, str, 0, 0, "", "", "", "");
      }
      return;
      str = "0X80073B0";
      continue;
  ...
  public void a()
  {
    ...
    try
    {
      this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.registObserver(this.jdField_a_of_type_Atzp);
      this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.registObserver(this.jdField_a_of_type_Atzo);
      this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.registObserver(this.jdField_a_of_type_Atzl);
      this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.addObserver(this.jdField_a_of_type_Ajuh);
      this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.addObserver(this.jdField_a_of_type_Akav);
      this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.addObserver(this.jdField_a_of_type_Atzm);
      this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.a(this.jdField_a_of_type_Akbc);
      this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.addObserver(this.jdField_a_of_type_Akud);
      VSNetworkHelper.a().a();
      VSNetworkHelper.a();
      ((akbo)this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.getManager(34)).a(this.jdField_a_of_type_Akbu);
      ((mxq)this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.a(43)).a();
      this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.addObserver(this.jdField_a_of_type_Ajtq);
      this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.addObserver(this.jdField_a_of_type_Nat);
      this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.addObserver(this.jdField_a_of_type_Akfl);
      this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.addObserver(this.jdField_a_of_type_Aoeu);
      ...
      ((KandianMergeManager)localObject).a(this.jdField_a_of_type_Akue);
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.unRegistObserver(this.jdField_a_of_type_Atzo);
    this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.removeObserver(this.jdField_a_of_type_Akav);
    this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.removeObserver(this.jdField_a_of_type_Atzm);
    this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.unRegistObserver(this.jdField_a_of_type_Atzl);
    this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.a(null);
    this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.removeObserver(this.jdField_a_of_type_Ajuh);
    this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.removeObserver(this.jdField_a_of_type_Akud);
    ((akbo)this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.getManager(34)).b(this.jdField_a_of_type_Akbu);
    this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.removeObserver(this.jdField_a_of_type_Akfl);
    this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.unRegistObserver(this.jdField_a_of_type_Atzp);
    ((mxq)this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.a(43)).b();
    VSNetworkHelper.a().a();
    ((KandianMergeManager)this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.getManager(162)).b(this.jdField_a_of_type_Akue);
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.removeObserver(this.jdField_a_of_type_Ajtq);
    this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.removeObserver(this.jdField_a_of_type_Nat);
    this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.removeObserver(this.jdField_a_of_type_Aoeu);
  }
  ...
  public void g()
  {
    ...
    a(this.jdField_a_of_type_Agcf.a(new agcl(this)));
  }
  ...
  public void h()
  {
    ...
    akbo localakbo = (akbo)this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.getManager(34);
    if ((localObject != null) && (localakbo != null)) {
  ...
  protected void i()
  {
    ...
    {
      this.jdField_b_of_type_Bbgg = bbcv.a(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity, 230);
      this.jdField_b_of_type_Bbgg.setMessage(2131695561);
      this.jdField_b_of_type_Bbgg.setTitle(2131692234);
      this.jdField_b_of_type_Bbgg.setNegativeButton(2131690596, new agcs(this));
      this.jdField_b_of_type_Bbgg.setPositiveButton(2131695531, new agct(this));
    }
  ...
  protected void j()
  {
    ...
    {
      this.jdField_a_of_type_Bcpq = new bcpq(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity, this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.getTitleBarHeight());
      this.jdField_a_of_type_Bcpq.a(ajyc.a(2131706413));
    }
    ...
    for (;;)
    {
      ...
      {
        bamn.a(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity, this.jdField_a_of_type_AndroidOsBundle, this.jdField_a_of_type_AndroidOsBundle.getInt("vistor_type", 1));
      }
      ...
      {
        Object localObject2;
        if (aqcn.class.getSimpleName().equals(this.jdField_c_of_type_JavaLangString))
        {
          localObject2 = (ajxn)this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.getManager(51);
          localObject1 = this.jdField_a_of_type_AndroidOsBundle.getString("uin", "");
          if (((ajxn)localObject2).b((String)localObject1))
          {
            if (this.jdField_a_of_type_AndroidOsBundle.getBoolean("thridparty_pull_aio", false))
            {
              ...
              localObject1 = bbcl.a(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app, (String)localObject1);
              if (localObject1 != null) {
                ((Intent)localObject2).putExtra("uinname", (String)localObject1);
              }
              localObject1 = actn.a((Intent)localObject2, new int[] { 2 });
              this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.startActivity((Intent)localObject1);
            }
          }
          else {
        ...
        else if (ajwl.class.getSimpleName().equals(this.jdField_c_of_type_JavaLangString))
        {
          ...
          ajwl.a(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity, (String)localObject1, (String)localObject2, str);
        }
      }
    }
  }
