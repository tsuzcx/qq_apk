...
public class opk
{
  private static volatile opk jdField_a_of_type_Opk;
  ...
  {
    String str1 = "";
    String str2 = opf.a(paramQQAppInterface, opg.b(paramMessageRecord));
    paramQQAppInterface = str1;
    if (!StringUtil.isEmpty(str2)) {
      paramQQAppInterface = opg.a(str2, opg.a(opg.c(paramMessageRecord)), false);
    }
  ...
  public static String a(String paramString1, String paramString2)
  {
    ...
    return opg.a(paramString1, paramString2, false);
  }
  ...
  public static opk a()
  {
    if (jdField_a_of_type_Opk == null) {}
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      if (jdField_a_of_type_Opk == null) {
        jdField_a_of_type_Opk = new opk();
      }
      return jdField_a_of_type_Opk;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    try
    {
      j = Integer.parseInt(opg.a((MessageRecord)localObject1));
      i = j;
    }
    ...
    localObject2 = opg.a((MessageRecord)localObject1);
    if (localObject2 != null)
    {
      if (QLog.isColorLevel()) {
        QLog.i("ReportUtil", 2, "mGdtActionType " + ((bdnu)localObject2).c);
      }
      if ((((bdnu)localObject2).a instanceof StructMsgForGeneralShare))
      {
        a(paramQQAppInterface, paramString, ((StructMsgForGeneralShare)((bdnu)localObject2).a).mContentTitle, NetConnInfoCenter.getServerTimeMillis() + "", "", i);
        paramString = a(paramQQAppInterface, (MessageRecord)localObject1);
        b(paramQQAppInterface, "qgg_push_click", ((StructMsgForGeneralShare)((bdnu)localObject2).a).mContentTitle, NetConnInfoCenter.getServerTimeMillis() + "", paramString, i);
      }
    }
    else
    {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt)
  {
    ...
    try
    {
      bdla.b(paramQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", paramString2, paramString1, paramInt, 0, paramString4, paramString3, "android", "8.4.10");
      return;
    }
    catch (Throwable paramQQAppInterface)
    {
  ...
  public static void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt)
  {
    ...
    localHashMap.put("version", "8.4.10");
    localHashMap.put("A8", opg.a(BaseApplicationImpl.getApplication().getRuntime()));
    ...
    for (;;)
    {
      ...
      if ((paramJSONObject != null) && (paramJSONObject.length() > 0))
      {
        ...
        while (i < paramJSONObject.length())
        {
          ...
          alcd.a("000004B5DU3Q3LD1", "qgg_floor_show", localMap);
          i += 1;
        }
      }
    }
  ...
  public void a(ChatXListView paramChatXListView, afqz paramafqz)
  {
    if ((paramafqz != null) && (!paramafqz.a().isEmpty()))
    {
      int i = 0;
      if (i < paramafqz.a().size())
      {
        ChatMessage localChatMessage = (ChatMessage)paramafqz.a().get(i);
        Object localObject1;
        ...
        for (;;)
        {
          ...
          if (!StringUtil.isEmpty((String)localObject1)) {
            try
            {
              Object localObject2 = alce.a(localChatMessage, paramChatXListView);
              if (localObject2 != null)
              {
                localObject2 = (ArkAppView)((View)localObject2).findViewById(2131362957);
