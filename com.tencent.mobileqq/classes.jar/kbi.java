  ...
  implements Animation.AnimationListener
{
  ...
  public kbi(VideoControlUI paramVideoControlUI, int paramInt)
  {
  ...
  {
    this.jdField_a_of_type_ComTencentAvUiVideoControlUI.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().removeCallbacks(this.jdField_a_of_type_ComTencentAvUiVideoControlUI.jdField_a_of_type_Kbj);
    ...
    if (!this.jdField_a_of_type_ComTencentAvUiVideoControlUI.i)
    {
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_ComTencentAvUiVideoControlUI.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().post(this.jdField_a_of_type_ComTencentAvUiVideoControlUI.jdField_a_of_type_Kbj);
        return;
