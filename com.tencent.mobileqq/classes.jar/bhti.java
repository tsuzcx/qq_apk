  ...
  implements Handler.Callback, NotificationReportController
{
  ...
  private List<bhtj> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  private void a()
  {
    ...
    for (QQAppInterface localQQAppInterface = (QQAppInterface)localObject;; localQQAppInterface = null)
    {
      if ((localQQAppInterface != null) && (this.jdField_a_of_type_JavaUtilList.size() > 0))
      {
        ...
        {
          bhtj localbhtj = (bhtj)localIterator.next();
          boolean bool = a(localQQAppInterface, localbhtj.b);
          localObject = "";
          switch (localbhtj.jdField_a_of_type_Int)
          {
          default: 
            label132:
            if ((localbhtj.c == 7200) || (localbhtj.c == 1008) || (localbhtj.c == 7220)) {
              azqs.a(localQQAppInterface, bool, "tech_push", "push", (String)localObject, "", 0, "", "", localbhtj.jdField_a_of_type_JavaLangString, localbhtj.b + "", "" + localbhtj.c, "", "", "", "");
            }
            break;
          }
          while (QLog.isDevelopLevel())
          {
            QLog.d("NotificationReportControllerImpl", 2, "report real msgType:" + localbhtj.jdField_a_of_type_Int + "    frienduin:" + localbhtj.jdField_a_of_type_JavaLangString + "   uinType:" + localbhtj.c + "    nId:" + localbhtj.b);
            break;
            ...
            break label132;
            azqs.a(localQQAppInterface, bool, "tech_push", "push", (String)localObject, "", 0, "", "", "", localbhtj.b + "", "", "", "", "", "");
          }
        }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 3: 
    case 4: 
      paramMessage = (bhtj)paramMessage.obj;
  ...
  public void report(int paramInt1, int paramInt2, String paramString, int paramInt3)
  {
    ...
    localMessage.obj = new bhtj(paramInt1, paramInt2, paramString, paramInt3);
