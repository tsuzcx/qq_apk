...
{
  BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new awak(this);
      ...
      for (;;)
      {
        try
        {
          ...
          if (!TextUtils.isEmpty(paramJsBridgeListener))
          {
            ...
            xbp.a(localActivity, new VidListPlayInfo(paramJsBridgeListener, paramString3, paramString2, paramString1), 105, null);
            break;
          }
