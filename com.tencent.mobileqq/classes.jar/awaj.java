...
public class awaj
{
  ...
  public static void a(int paramInt1, int paramInt2, int paramInt3, avza paramavza, awal paramawal)
  {
    ...
    if (paramInt1 != 0)
    {
      ...
      localObject2[0] = 0;
      localObject2 = paramavza.jdField_a_of_type_Awak;
      if (localObject2 == null) {
        break label169;
      }
      paramavza = ((awak)localObject2).jdField_a_of_type_JavaLangString;
      localObject1 = ((awak)localObject2).jdField_a_of_type_AndroidGraphicsBitmap$CompressFormat;
    }
    for (paramInt1 = ((awak)localObject2).jdField_a_of_type_Int;; paramInt1 = 100)
    {
      ThreadManager.executeOnFileThread(new ThumbnailUtil.1(paramInt3, paramInt2, arrayOfInt1, arrayOfInt2, paramavza, (Bitmap.CompressFormat)localObject1, paramInt1, paramawal));
      return;
      GLES20.glReadPixels(0, 0, paramInt2, paramInt3, 6408, 5121, (Buffer)localObject1);
      break;
      label169:
      paramavza = a(paramavza.jdField_a_of_type_JavaLangString);
