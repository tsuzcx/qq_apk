...
public class yhi
{
  ...
  private static void b(String paramString, Bitmap paramBitmap, ImageView paramImageView)
  {
    ...
    if (paramBitmap != null)
    {
      localBitmap = bdda.a(paramImageView.getContext(), paramBitmap, 0.25F, 20.0F);
      if (localBitmap != null)
      {
    ...
    for (Object localObject = localBitmap;; localObject = localBitmap.copy(localBitmap.getConfig(), true))
    {
      ...
      localObject = xom.a(paramBitmap.getWidth(), paramBitmap.getHeight(), paramImageView.getWidth(), paramImageView.getHeight());
      paramBitmap = xmn.a(xmn.a(localBitmap, ((Integer)((Pair)localObject).first).intValue(), ((Integer)((Pair)localObject).second).intValue(), true), paramBitmap);
      b(paramBitmap, paramImageView);
      bdbq.a(paramString, paramBitmap);
      return;
    }
  }
}
