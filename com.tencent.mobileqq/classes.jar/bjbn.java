...
public final class bjbn
{
  ...
  public static String a(String paramString, boolean paramBoolean)
  {
    ...
    for (paramString = "&";; paramString = "?")
    {
      ...
      bjbl.e("ReaderUrlHelper", "getUrlWithBid = " + (String)localObject);
      return localObject;
  ...
  private static String d(String paramString)
  {
    String str2 = null;
    String str1;
    if ((bjaa.a != null) && (bjaa.a.size() > 0)) {
      str1 = (String)bjaa.a.get(paramString);
    }
    for (;;)
    {
      bjbl.d("ReaderUrlHelper", "getUrl = " + str1);
      return str1;
      if (bjaa.a != null) {
        str2 = (String)bjaa.a.get(paramString);
      }
      str1 = str2;
      if (str2 == null) {
