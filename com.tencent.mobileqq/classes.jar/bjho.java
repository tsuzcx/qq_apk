...
public class bjho
{
  ...
  public static Fragment a(@NonNull Activity paramActivity, @NonNull QQAppInterface paramQQAppInterface, @NonNull String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((paramString instanceof bjht))
        {
          try
          {
            ((bjht)paramString).attachQQContext(paramActivity, paramQQAppInterface);
            i = 1;
          }
  ...
  @Nullable
  public static bjhn a(@NonNull Activity paramActivity)
  {
    if (!jdField_a_of_type_Boolean) {
    ...
    for (;;)
    {
      ...
      catch (Throwable localThrowable)
      {
        try
        {
          paramActivity = (bjhn)((Constructor)localObject1).newInstance(new Object[] { paramActivity });
  ...
  public static String a(Context paramContext)
  {
    ...
    if (TextUtils.isEmpty(str)) {
      paramContext = alud.a(2131720579);
    }
    return paramContext;
  }
  ...
  public static boolean a(@Nullable bjhq parambjhq)
  {
    boolean bool1 = true;
    ...
    PluginManagerHelper.getPluginInterface(BaseApplicationImpl.getApplication(), new bjhp(l, parambjhq));
    return false;
  }
  ...
  public static boolean b(@Nullable Activity paramActivity, @Nullable QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          paramActivity.getLayoutInflater().inflate(2131560935, null);
          i = 1;
        }
        catch (Throwable paramActivity)
        {
  ...
  public static boolean b(@NonNull Context paramContext, @NonNull QQAppInterface paramQQAppInterface)
  {
    ...
    ((biqn)paramQQAppInterface.getManager(27)).a("qzone_plugin.apk");
