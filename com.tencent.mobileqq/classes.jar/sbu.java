...
public class sbu
  implements bfob
{
  public sbu(SubscriptFeedsActivity paramSubscriptFeedsActivity) {}
  ...
  public void onScrollStateChanged(AbsListView paramAbsListView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      while (paramInt <= paramAbsListView.getChildCount())
      {
        ...
        if ((localObject != null) && ((((View)localObject).getTag() instanceof sbz)))
        {
          localObject = (sbz)((View)localObject).getTag();
          Drawable localDrawable = ((sbz)localObject).b.getDrawable();
          if ((localDrawable != null) && ((localDrawable instanceof URLDrawable)) && (!((URLDrawable)localDrawable).isDownloadStarted()))
          {
            if (QLog.isColorLevel()) {
              QLog.d("SubscriptFeedsActivity", 2, "list child view start download pic!  uin : " + ((sbz)localObject).a);
            }
