  ...
  extends ahbl
{
  ...
  public void a(RecentItemRecommendTroopData paramRecentItemRecommendTroopData, ahbe paramahbe)
  {
    ...
    if (paramRecentItemRecommendTroopData.mUser.uin.equals("sp_uin_for_title"))
    {
      ...
      if (AppSetting.c)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.setContentDescription(ajjy.a(2131647419));
      }
      return;
    }
    ...
    if (paramahbe == null)
    {
      paramahbe = null;
      label225:
      this.jdField_a_of_type_ComTencentWidgetThemeImageView.setImageDrawable(paramahbe);
    ...
    label609:
    label621:
    for (paramahbe = (RecentRecommendTroopItem)paramRecentItemRecommendTroopData.mUser.extraInfo;; paramahbe = null)
    {
      if (paramahbe == null)
      {
        QLog.d("RecentRecommendTroopIte", 1, "bindData, troopItem == null");
        return;
        paramahbe = paramahbe.a(paramRecentItemRecommendTroopData);
        break label225;
      }
      if (paramahbe.activity > 0)
      {
        this.jdField_a_of_type_ComTencentMobileqqTroopWidgetTroopActiveLayout.setVisibility(0);
        this.jdField_a_of_type_ComTencentMobileqqTroopWidgetTroopActiveLayout.setHotLevel(paramahbe.activity);
        ArrayList localArrayList = mne.a((RecentRecommendTroopItem)paramRecentItemRecommendTroopData.mUser.extraInfo);
        ...
        label366:
        if (!paramahbe.isJoined()) {
          break label535;
        }
        this.jdField_a_of_type_AndroidWidgetButton.setEnabled(false);
        this.jdField_a_of_type_AndroidWidgetButton.setText(2131633813);
        this.jdField_a_of_type_AndroidWidgetButton.setMinWidth(bajq.a(60.0F));
        this.jdField_a_of_type_AndroidWidgetButton.setMinWidth(bajq.a(29.0F));
        ...
        if (TextUtils.isEmpty(paramahbe.intro)) {
          break label609;
        }
        this.jdField_a_of_type_ComTencentMobileqqWidgetFolderTextView.setText(new axkd(paramahbe.intro, 11, 16));
      }
      for (;;)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetButton.setText(2131633811);
        ...
        this.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130839032);
        break label445;
