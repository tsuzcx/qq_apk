  ...
  extends WebViewPlugin
{
  ...
  private void a()
  {
    if (this.jdField_a_of_type_Mxn == null)
    {
      ...
      if (localCustomWebView != null) {
        this.jdField_a_of_type_Mxn = new mxn(localCustomWebView, new bcbd(this));
      }
    }
  }
  ...
  void a(long paramLong)
  {
    ...
    try
    {
      localObject3 = bcfa.a((String)localObject1);
      ...
      this.jdField_a_of_type_Wxu.a(1, str, (String)localObject1, (Bundle)localObject3);
      return;
    }
    ...
    if (("UrlSaveVerifyV2".equals(paramString2)) && ("continueVisit".equals(paramString3)) && (paramVarArgs.length > 0)) {
      try
      {
        ...
        if (!TextUtils.isEmpty(paramJsBridgeListener))
        {
          ...
          {
            if (QLog.isColorLevel()) {
              QLog.d("WebSecurityPluginV2", 2, "continueVisit url=" + nax.b(paramJsBridgeListener, new String[0]));
            }
  ...
  public boolean handleSchemaRequest(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((!bbjw.a(paramString2)) && (paramString1.startsWith(paramString2)))
        {
          if (!QLog.isColorLevel()) {
            continue;
          }
    ...
    if (!b(paramString1))
    {
      ...
      QLog.i("UrlCheckLog", 1, "now check url=" + nax.b(paramString1, new String[0]) + ", async=" + bool2);
      ...
      j = k;
      label561:
      this.jdField_a_of_type_Wxu.a(paramString1, j, i, str2, str3, str1, paramString2, new bcbc(this, paramString1, bool2));
      if (QLog.isColorLevel()) {
