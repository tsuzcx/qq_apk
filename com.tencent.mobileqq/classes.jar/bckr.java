...
public class bckr
{
  ...
  private static HashMap<String, bckq> d;
  ...
  public static bckq a(QQAppInterface paramQQAppInterface, String paramString)
  {
    if (QLog.isColorLevel()) {
      QLog.d("TroopNotificationHelper", 2, "HasUnReadRepeatTroopNotification");
    }
    Object localObject = (bckq)jdField_d_of_type_JavaUtilHashMap.get(paramString);
    if (localObject != null)
    {
      paramQQAppInterface = (QQAppInterface)localObject;
      if (QLog.isColorLevel())
      {
        QLog.d("TroopNotificationHelper", 2, "HasUnReadRepeatTroopNotification. type = " + ((bckq)localObject).jdField_a_of_type_Int);
        paramQQAppInterface = (QQAppInterface)localObject;
      }
    }
    label314:
    do
    {
      do
      {
        ...
        List localList = ((awbw)localObject).a(TroopNotificationCache.class, true, "troopUin=? and read=?", new String[] { paramString, "0" }, null, null, null, null);
        ((awbw)localObject).a();
        ...
        paramString = (bckq)jdField_d_of_type_JavaUtilHashMap.get(paramString);
      ...
      return null;
      paramString = new bckq(((TroopInfo)localObject).feeds_id, ((TroopInfo)localObject).troopRepeatType);
      paramQQAppInterface = paramString;
    } while (!QLog.isColorLevel());
  ...
  public static bcks a(DataInputStream paramDataInputStream, boolean paramBoolean)
  {
  ...
  public static bcks a(String paramString, byte[] paramArrayOfByte, boolean paramBoolean)
  {
    boolean bool1 = true;
    boolean bool2 = false;
    label846:
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((i == 5) || (i == 19))
        {
          ...
          localObject5 = new bcks();
          ((bcks)localObject5).jdField_a_of_type_JavaLangString = paramArrayOfByte;
          ((bcks)localObject5).jdField_b_of_type_JavaLangString = paramString;
          ((bcks)localObject5).jdField_c_of_type_JavaLangString = ((String)localObject3);
          ((bcks)localObject5).jdField_d_of_type_JavaLangString = ((String)localObject1);
          ((bcks)localObject5).jdField_a_of_type_Int = 1;
          if (!localGroupFeedsMessage.opt_uint32_ctl_flag.has()) {
            break label894;
          }
          i = localGroupFeedsMessage.opt_uint32_ctl_flag.get();
          ((bcks)localObject5).jdField_e_of_type_Int = i;
          ...
          paramBoolean = bool1;
          ((bcks)localObject5).jdField_a_of_type_Boolean = paramBoolean;
          break label891;
        }
        if (i == 22)
        {
          ...
          localObject3 = new bcks();
          ((bcks)localObject3).jdField_b_of_type_JavaLangString = paramString;
          ((bcks)localObject3).jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
          ((bcks)localObject3).jdField_e_of_type_JavaLangString = ((String)localObject1);
          ((bcks)localObject3).jdField_a_of_type_Int = 2;
          ((bcks)localObject3).jdField_b_of_type_Long = l1;
          ((bcks)localObject3).jdField_d_of_type_Int = i;
          if (localGroupFeedsMessage.opt_uint32_ctl_flag.has())
          {
            i = localGroupFeedsMessage.opt_uint32_ctl_flag.get();
            ((bcks)localObject3).jdField_e_of_type_Int = i;
            if ((!localGroupFeedsMessage.memo_ctrl_info.has()) || (!((group_feeds.GroupFeedsMessage.MemoCtrlInfo)localGroupFeedsMessage.memo_ctrl_info.get()).uint32_need_confirmation.has())) {
              break;
            }
            paramBoolean = bool2;
            ...
            ((bcks)localObject3).jdField_a_of_type_Boolean = paramBoolean;
            break;
          }
        }
        return null;
  ...
  public static TroopNotificationCache a(bcks parambcks, String paramString, int paramInt1, int paramInt2, long paramLong)
  {
    if (parambcks != null)
    {
      if (parambcks.jdField_a_of_type_Int == 1)
      {
        String str2 = a(parambcks.jdField_c_of_type_JavaLangString);
        ...
        str2 = a(parambcks.jdField_a_of_type_JavaLangString);
        if (TextUtils.isEmpty(parambcks.jdField_a_of_type_JavaLangString))
        {
          str2 = new SimpleDateFormat("yyyy年M月d日").format(new Date(parambcks.jdField_c_of_type_Int * 1000L));
          str2 = str2 + " 群公告";
        }
        ...
        localTroopNotificationCache.title = parambcks.jdField_a_of_type_JavaLangString;
        localTroopNotificationCache.feedType = paramInt1;
        localTroopNotificationCache.appId = paramInt2;
        localTroopNotificationCache.userUin = parambcks.jdField_a_of_type_Long;
        localTroopNotificationCache.troopUin = paramLong;
        localTroopNotificationCache.time = parambcks.jdField_c_of_type_Int;
        localTroopNotificationCache.feedsId = parambcks.jdField_b_of_type_JavaLangString;
        localTroopNotificationCache.serviceID = 27;
        localTroopNotificationCache.needConfirm = parambcks.jdField_a_of_type_Boolean;
        String str3 = new SimpleDateFormat("M-d HH:mm").format(new Date(localTroopNotificationCache.time * 1000L));
        if (TextUtils.isEmpty(parambcks.jdField_d_of_type_JavaLangString)) {}
        for (localTroopNotificationCache.xmlBytes = String.format("<?xml version=\"1.0\" encoding=\"utf-8\" ?><msg action=\"web\" serviceID=\"27\" templateID=\"\" actionData=\"\" url=\"%s\" flag=\"5\" brief=\"%s\"><item layout=\"1\"><title size=\"30\" color=\"#000000\">[公告] %s</title><hr /><title size=\"22\" color=\"#000000\">%s</title><summary size=\"28\" color=\"#808080\">%s</summary></item></msg>", new Object[] { paramString, "", str2, str3, str1 }).getBytes();; localTroopNotificationCache.xmlBytes = String.format("<?xml version=\"1.0\" encoding=\"utf-8\" ?><msg action=\"web\" serviceID=\"27\" templateID=\"\" actionData=\"\" url=\"%s\" flag=\"5\" brief=\"%s\"><item layout=\"6\"><title size=\"30\" color=\"#000000\">[公告] %s</title><hr /></item><item layout=\"2\"><picture cover=\"%s\"/><title size=\"22\" color=\"#000000\">%s</title><summary size=\"28\" color=\"#808080\">%s</summary></item></msg>", new Object[] { paramString, "", str2, parambcks.jdField_d_of_type_JavaLangString, str3, str1 }).getBytes()) {
          return localTroopNotificationCache;
        }
      }
      if (parambcks.jdField_a_of_type_Int == 2)
      {
        paramString = new TroopNotificationCache();
        paramString.feedType = paramInt1;
        paramString.appId = paramInt2;
        paramString.userUin = parambcks.jdField_a_of_type_Long;
        paramString.troopUin = paramLong;
        paramString.time = parambcks.jdField_c_of_type_Int;
        paramString.feedsId = parambcks.jdField_b_of_type_JavaLangString;
        paramString.ctrlStr = parambcks.jdField_e_of_type_JavaLangString;
        paramString.xmlBytes = parambcks.jdField_a_of_type_ArrayOfByte;
        paramString.src = parambcks.jdField_d_of_type_Int;
        paramString.filterID = parambcks.jdField_b_of_type_Long;
  ...
  public static TroopNotificationCache a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, byte[] paramArrayOfByte, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramQQAppInterface)
      {
        ...
        QLog.d(bckr.class.getSimpleName(), 2, paramQQAppInterface.getMessage());
        continue;
      }
      return null;
      label310:
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface = localawbw.a(true, TroopNotificationCache.class.getSimpleName(), new String[] { "troopUin", "feedType", "serviceID" }, "read=?", new String[] { String.valueOf(0) }, "troopUin", null, null, null);
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt1, long paramLong1, long paramLong2, long paramLong3, String paramString1, int paramInt2, String paramString2, short paramShort, boolean paramBoolean)
  {
    ...
    catch (Exception localException)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d(bckr.class.getSimpleName(), 2, localException.getMessage());
        }
      }
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt1, long paramLong1, long paramLong2, long paramLong3, String paramString, int paramInt2, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      {
        paramArrayOfByte = null;
        if ((((bcks)localObject).jdField_a_of_type_Int == 1) || (((bcks)localObject).jdField_a_of_type_Int == 2)) {
          paramArrayOfByte = a((bcks)localObject, paramString, 23, paramInt1, paramLong2);
        }
        QQMessageFacade localQQMessageFacade = paramQQAppInterface.a();
        ArrayList localArrayList = new ArrayList();
        localArrayList.add(paramArrayOfByte);
        paramInt1 = (int)ayvc.a();
        localQQMessageFacade.a().a(paramQQAppInterface, String.valueOf(paramLong1), String.valueOf(paramLong2), localArrayList, 23, paramInt1, ((bcks)localObject).jdField_e_of_type_Int, ((bcks)localObject).jdField_b_of_type_JavaLangString);
      }
    }
    catch (Exception paramQQAppInterface)
    {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    if ((jdField_a_of_type_JavaUtilHashMap != null) && (jdField_a_of_type_JavaUtilHashMap.containsKey(paramString)))
    {
      ...
      ((alzf)paramQQAppInterface.a(20)).a(paramQQAppInterface, paramString, arrayOfByte, paramInt);
      return;
    }
    try
    {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    paramQQAppInterface = new bckq(paramString1, paramInt);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, List<TroopNotificationCache> paramList, int paramInt1, int paramInt2, String paramString2)
  {
    ...
    if (paramList.hasNext())
    {
      ...
      if (localTroopNotificationCache.userUin == paramQQAppInterface.getLongAccountUin())
      {
        ...
        ((awbw)localObject).a(localTroopNotificationCache);
    ...
    for (;;)
    {
      ...
      if (paramInt2 == 1)
      {
        ...
        paramQQAppInterface = ajeu.a(paramString1.uin, paramString1.getType());
        ajeu.a().a(paramQQAppInterface);
        if (paramInt2 != 1) {
          break label449;
        }
        i = 29;
        paramString1.msgType = i;
        if (!(paramString1.msg instanceof ajhs)) {
          break label469;
        }
        localObject = (ajhs)paramString1.msg;
        if (!bool1) {
          break label456;
        }
        paramQQAppInterface = BaseApplication.getContext().getString(2131720821);
        label382:
        ((ajhs)localObject).jdField_a_of_type_JavaLangString = paramQQAppInterface;
      }
      for (;;)
      {
        ((ajhs)paramString1.msg).jdField_c_of_type_Int = paramInt2;
        paramString1.lastmsgtime = paramInt1;
        paramString2.a().a(paramString1);
        paramList.sendEmptyMessage(1009);
        return;
        if ((!(paramString1.msg instanceof ajhs)) || (((ajhs)paramString1.msg).jdField_c_of_type_Int != 1)) {
          break;
        }
        return;
        i = 11;
        break label342;
        paramQQAppInterface = BaseApplication.getContext().getString(2131720820);
        break label382;
        paramString1.msg = new ajhs(BaseApplication.getContext(), bool1);
      }
    }
  }
  ...
  public static void a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    QLog.d("TroopNotificationHelper", 2, bckr.class.getSimpleName() + "-->clearTroopNotification");
  }
  ...
  public static byte[] a(long paramLong, short paramShort, byte[] paramArrayOfByte, String paramString)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d(bckr.class.getSimpleName(), 2, paramArrayOfByte.getMessage());
      }
    }
    return null;
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(bckr.class.getSimpleName(), 2, "handGetTroopAuth");
    }
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    yom.b("http://gdynamic.qpic.cn/gdynamic/");
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    } while (((paramString2.msg instanceof ajhs)) && (((ajhs)paramString2.msg).jdField_c_of_type_Int == 1));
    if (QLog.isColorLevel()) {
      QLog.d("TroopNotificationHelper", 2, "setUnReadRepeatTroopNotificationPre, update recent user list");
    }
    Object localObject = ajeu.a(paramString2.uin, paramString2.getType());
    ajeu.a().a((String)localObject);
    paramString2.msgType = 11;
    localObject = new ajhs(BaseApplication.getContext(), true);
    ((ajhs)localObject).jdField_c_of_type_Int = 0;
