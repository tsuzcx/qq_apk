  ...
  implements Manager
{
  ...
  public bckr(QQAppInterface paramQQAppInterface)
  {
  ...
  private void c()
  {
    ...
    Object localObject1 = localamnz.b(alof.aE, 7440);
    if (localObject1 == null)
    {
      localObject1 = new RecentUser(alof.aE, 7440);
    ...
    for (;;)
    {
      try
      {
        ...
        localObject2 = BaseApplicationImpl.getContext().getResources().getString(2131697723);
      ...
      azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "huanjibao", "", "feeds", "view", 0, 0, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "", "", "");
      return;
    }
  }
  ...
  {
    amnz localamnz = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a();
    RecentUser localRecentUser = localamnz.b(alof.aE, 7440);
  ...
  public void a()
  {
    ...
    new bcky("https://innovate.qq.com/GetNewMachine", "GET", new bcks(this), 10001, null).a(localHashMap);
  }
  ...
  public void a(Context paramContext)
  {
    ...
    localObject1 = bhsz.a(bhsz.a((String)localObject1, "qqnum", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()), "qimei", a());
    localObject2 = new Intent(paramContext, QQBrowserActivity.class);
    ((Intent)localObject2).putExtra("url", (String)localObject1);
    paramContext.startActivity((Intent)localObject2);
    d();
    azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "huanjibao", "", "feeds", "click", 0, 0, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "", "", "");
  }
  ...
  public void a(String paramString)
  {
    ...
    try
    {
      ...
      {
        a();
        azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "huanjibao", "", "new_mobile", "request", 0, 0, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "", "", "");
        return;
        if (j >= 0)
        {
