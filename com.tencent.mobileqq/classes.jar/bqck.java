...
public class bqck
  extends bqgi
  implements View.OnClickListener, bqmi
{
  ...
  public bqck(@NonNull bqgk parambqgk)
  {
    super(parambqgk);
  }
  ...
  {
    this.jdField_a_of_type_Bqgk.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a();
  }
  ...
  private void c(boolean paramBoolean)
  {
    ...
    {
      return;
      i = this.jdField_a_of_type_Bqgk.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a();
  ...
  {
    boolean bool = false;
    int i = this.jdField_a_of_type_Bqgk.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a();
    if (i == 103)
    {
  ...
  private void d()
  {
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      if (this.jdField_a_of_type_Bqgk.jdField_a_of_type_AndroidWidgetRelativeLayout != null)
      {
        ...
        localLayoutParams.bottomMargin = bhtq.a(56.5F);
        this.jdField_a_of_type_AndroidViewViewGroup.setLayoutParams(localLayoutParams);
      }
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiCropCropNewView = ((CropNewView)a(2131365217));
      ...
      this.jdField_c_of_type_AndroidViewView = a(2131364161);
      this.jdField_c_of_type_AndroidViewView.setOnClickListener(this);
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)a(2131365216));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)a(2131365214));
      this.jdField_c_of_type_AndroidWidgetTextView.setOnClickListener(this);
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)a(2131378151));
  ...
  private void l()
  {
    if (this.jdField_a_of_type_Bqgk.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a() == 103)
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setEnabled(false);
  ...
  public void a(int paramInt, @NonNull bqua parambqua)
  {
    ...
    localbqug.jdField_a_of_type_Int += this.jdField_a_of_type_Int;
    if (this.jdField_c_of_type_Boolean)
    {
      parambqua.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.add("2");
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131365097: 
      ...
      do
      {
        do
        {
          for (;;)
          {
            ...
            if ((this.jdField_a_of_type_Bqgk != null) && (this.jdField_a_of_type_Bqgk.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a() == 103)) {
              this.jdField_a_of_type_AndroidWidgetTextView.setEnabled(false);
            }
            this.e = false;
            c(this.e);
      ...
      {
        this.jdField_a_of_type_Bqgk.jdField_a_of_type_AndroidOsBundle.remove(bqjh.a);
        this.jdField_a_of_type_Bqgk.jdField_a_of_type_AndroidOsBundle.remove("DynamicFaceLayer");
        this.jdField_a_of_type_Bqgk.jdField_a_of_type_AndroidOsBundle.remove(bqjx.a);
        this.jdField_a_of_type_Bqgk.jdField_a_of_type_AndroidOsBundle.remove("VoteLayer");
        this.jdField_a_of_type_Bqgk.jdField_a_of_type_AndroidOsBundle.remove("InteractPasterLayer");
      }
      ...
      bqzz.a().a(this.jdField_a_of_type_AndroidGraphicsBitmap);
    ...
    for (;;)
    {
      this.jdField_a_of_type_Bqgk.a(this.jdField_a_of_type_AndroidGraphicsBitmap, bool1);
      if (!c()) {
        this.jdField_a_of_type_Bqgk.y();
      }
      yuq.b("0X80075D2");
      ayyb.a("0X800AAE6", 0);
      bqug.a(this.jdField_a_of_type_ArrayOfInt);
      break;
