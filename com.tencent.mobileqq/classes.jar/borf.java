  ...
  extends DynamicTextItem
{
  ...
  public borf(int paramInt, @NonNull List<String> paramList, Typeface paramTypeface1, Typeface paramTypeface2, Bitmap paramBitmap)
  {
  ...
  private void a(Typeface paramTypeface1, Typeface paramTypeface2)
  {
    ...
    this.jdField_c_of_type_Int = ((int)this.jdField_a_of_type_AndroidTextTextPaint.measureText(anni.a(2131704788)));
  ...
  public InputFilter a()
  {
    if (this.jdField_a_of_type_AndroidTextInputFilter == null) {
      this.jdField_a_of_type_AndroidTextInputFilter = new borh(this, 20);
    }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    paramString = super.a(paramInt, new borg(this)).split("\n");
  ...
  public void a(Canvas paramCanvas)
  {
    ...
    while (j < i1)
    {
      ...
      if (m < str.length())
      {
        ...
        int i3;
        int i2;
        if (borx.a(((String)localObject2).charAt(0)) == 3)
        {
