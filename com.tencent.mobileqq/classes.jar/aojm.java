...
public class aojm
{
  ...
  public static void a(String paramString)
  {
    ...
    bbkb.t(BaseApplicationImpl.getApplication().getBaseContext(), str, paramString);
    if (QLog.isColorLevel())
    {
      if (paramString != null) {
  ...
  public static boolean a(aoex paramaoex)
  {
    boolean bool = false;
    if ((paramaoex != null) && (paramaoex.a != null))
    {
      String str = a();
      paramaoex = (aoey)paramaoex.a.get(str);
      if (paramaoex != null)
      {
        paramaoex = paramaoex.c;
        str = b();
        if (TextUtils.isEmpty(str))
        {
          bool = true;
          if ((!TextUtils.isEmpty(paramaoex)) && (!paramaoex.equalsIgnoreCase(str))) {
            bool = true;
          }
        }
      }
  ...
  {
    return aokq.a(a(paramArrayOfString));
  }
  ...
  {
    String str = BaseApplicationImpl.getApplication().getRuntime().getAccount();
    str = bbkb.s(BaseApplicationImpl.getApplication().getBaseContext(), str);
    if (QLog.isColorLevel())
    {
      if (str != null) {
  ...
  {
    return String.format("%s/matchChat", new Object[] { aofa.a() });
  }
}
