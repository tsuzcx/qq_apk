  ...
  extends AsyncTask<Void, Void, Integer>
{
  ...
  public afbr(QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity)
  {
  ...
  protected Integer a(Void... arg1)
  {
    ...
    {
      localObject1 = axdo.a(0, this.jdField_b_of_type_Int);
      axew localaxew = axdo.a(this.jdField_a_of_type_AndroidContentIntent, (axeg)localObject1);
      if (localaxew == null) {
        return Integer.valueOf(5);
      }
      localaxew.d = true;
      localaxew.a = false;
      if ((localaxew.r != null) && (localaxew.r.length() == 39)) {
        localaxew.r = localaxew.r.substring(0, 28);
      }
      ((axeg)localObject1).a(localaxew);
      this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo = ((MessageForShortVideo)new axcy(???.app).a(localaxew));
      ...
      ((afaz)((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getManager(138)).a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo);
