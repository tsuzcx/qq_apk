...
public class ajvc
  extends akdk
{
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new ajvd(this);
  ...
  public ajvc(PhoneContactTabView paramPhoneContactTabView, Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, boolean paramBoolean)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      localView = ajvj.a(paramViewGroup, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberPhoneContactTabView.jdField_a_of_type_AndroidViewLayoutInflater, 2131558894);
    }
    paramView = (ajvj)localView.getTag();
    if (i < 0)
    {
      i = -(i + 1) - 1;
      ...
      ajvj.a(this, paramView, paramViewGroup);
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberPhoneContactTabView.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.b(paramView.jdField_a_of_type_JavaLangString))
      {
        ...
        if ((AppSetting.c) && (paramView.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
        {
          ...
          localView.setContentDescription(paramViewGroup.name + alpo.a(2131708374));
        }
      }
      for (;;)
      {
        ...
        break;
        label265:
        localView.setContentDescription(paramViewGroup.name + alpo.a(2131708372));
      }
    }
