  ...
  extends AutoCompleteTextView
{
  ...
  public bepo(DropdownView paramDropdownView, Context paramContext)
  {
    super(paramContext);
    setId(526);
  ...
  public bepo(DropdownView paramDropdownView, Context paramContext, AttributeSet paramAttributeSet)
  {
  ...
  public bepo(DropdownView paramDropdownView, Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
  ...
  public void showDropDown()
  {
    ...
    catch (Exception localException2)
    {
      try
      {
        ...
        ((PopupWindow)localObject2).setAnimationStyle(2130772294);
        return;
      }
