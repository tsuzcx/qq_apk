...
public class axnj
{
  ...
  private static axnk a()
  {
    Object localObject1 = BaseApplication.getContext();
    axnk localaxnk = new axnk();
    try
    {
      String str1;
      String str2;
      ...
      try
      {
        ...
        if ((str3 != null) && (str3.startsWith("ctwap"))) {
          ...
          {
            localaxnk.jdField_a_of_type_JavaLangString = str1;
            localaxnk.jdField_a_of_type_Int = Integer.valueOf(str2).intValue();
          }
          else
          {
            localaxnk.jdField_a_of_type_JavaLangString = "10.0.0.200";
            localaxnk.jdField_a_of_type_Int = 80;
          }
        }
      }
      ...
      if ((str3 != null) && (str3.startsWith("cmwap")))
      {
        ...
        {
          localaxnk.jdField_a_of_type_JavaLangString = "10.0.0.172";
          localaxnk.jdField_a_of_type_Int = 80;
        }
      }
  ...
  public static InetSocketAddress a()
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          localObject1 = a();
          str = ((axnk)localObject1).jdField_a_of_type_JavaLangString;
          i = ((axnk)localObject1).jdField_a_of_type_Int;
        }
      }
    }
  }
