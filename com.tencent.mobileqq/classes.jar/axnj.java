...
public class axnj
{
  ...
  Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new axno(this);
  ...
  public axnj()
  {
    ...
    this.jdField_a_of_type_Int = aciy.a(4.0F, ((Context)localObject).getResources());
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate((Context)localObject, 2131495548, null));
    ...
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131301769));
    int i = 0;
  ...
  void b()
  {
    ...
    int i = aciy.a(1.0F, ((Context)localObject2).getResources());
    this.d.setPadding(i, i, i, i);
    this.d.setBackgroundResource(2130844229);
    ...
    try
    {
      ...
      ((ScaleAnimation)localObject1).setAnimationListener(new axnk(this));
  ...
  void e()
  {
    int j = this.jdField_a_of_type_AndroidWidgetImageView.getWidth() - aciy.a(5.0F, BaseApplicationImpl.getContext().getResources());
    ...
    localObject2 = new axnm(this, localAnimatorSet);
