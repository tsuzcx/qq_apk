...
public class yzg
{
  ...
  public static String a(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt, String paramString6, String paramString7, String paramString8, String paramString9, String paramString10, String paramString11, String paramString12, String paramString13, String paramString14, Bundle paramBundle)
  {
    ...
    localStringBuilder.append("&version=").append("8.3.3");
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramBaseActivity.append("android").append("_").append("8.3.3").append("_").append(paramInt).append("_").append(paramString2);
        paramString2 = paramBaseActivity.toString();
        paramString11 = bfhi.d(paramString2).toUpperCase();
        if (QLog.isColorLevel()) {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (paramList != null)
      {
        ...
        for (;;)
        {
          ...
          {
            paramList = new baig(paramList.msg, 3).a();
            localObject2 = "1";
            i = 0;
            break label391;
          }
  ...
  public static void a(BaseActivity paramBaseActivity, long paramLong, String paramString1, String paramString2, int paramInt, String paramString3, Bundle paramBundle)
  {
    ...
    bepp localbepp = new bepp(paramBaseActivity, paramBaseActivity.getTitleBarHeight());
    try
    {
      localbepp.show();
      if (paramLong <= 0L)
      {
        ...
        ((auqi)paramBaseActivity.getAppInterface().getManager(204)).a(Long.parseLong(paramString1), new yzh(paramBaseActivity, paramString1, paramString2, paramInt, paramString3, localbepp, paramBundle, paramLong));
        return;
      }
    }
    catch (Exception localException)
    {
      ...
      b(paramBaseActivity, String.valueOf(paramLong), paramString1, paramString2, c(paramInt), b(paramInt, paramString3), localbepp, paramBundle);
    }
  }
  ...
  public static void a(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt, String paramString6, Bundle paramBundle)
  {
    ...
    {
      localbepp.show();
      ThreadManager.excute(new NewReportPlugin.3(paramInt, paramBaseActivity, paramString1, paramString4, paramBundle, paramString2, paramString3, paramString5, paramString6, localbepp), 16, null, false);
      return;
    }
    catch (Exception localException)
    {
  ...
  public static String b(String paramString1, String paramString2)
  {
    ...
    try
    {
      str = bdal.a(a(paramString1.getBytes("utf-8"), paramString2, 1));
      return str;
    }
  ...
  private static void b(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, int paramInt, String paramString4, bepp parambepp, Bundle paramBundle)
  {
    ThreadManager.excute(new NewReportPlugin.2(paramBundle, paramString4, paramInt, paramBaseActivity, paramString2, paramString3, paramString1, parambepp), 16, null, false);
  }
