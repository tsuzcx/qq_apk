...
public class yzg
{
  ...
  private WeakReference<yzh> b;
  
  public yzg(WeakReference<View> paramWeakReference, WeakReference<yzh> paramWeakReference1)
  {
    this(paramWeakReference, paramWeakReference1, 0.0F);
  }
  
  public yzg(WeakReference<View> paramWeakReference, WeakReference<yzh> paramWeakReference1, float paramFloat)
  {
  ...
  public void d()
  {
    ...
    for (;;)
    {
      ...
      else if (this.jdField_a_of_type_Int == 1)
      {
        if (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)
        {
          if (yze.a((View)this.jdField_a_of_type_JavaLangRefWeakReference.get()) > this.jdField_a_of_type_Float) {}
