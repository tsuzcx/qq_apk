...
public class anim
  implements Runnable
{
  public anim(QIMCameraCaptureUnit paramQIMCameraCaptureUnit, List paramList) {}
  ...
  public void run()
  {
    ...
    if (this.jdField_a_of_type_DovComQqImQIMCameraCaptureUnit.a() != null)
    {
      ...
      MediaScanner.a(BaseApplicationImpl.getContext()).a(new anin(this), QIMCameraCaptureUnit.a(this.jdField_a_of_type_DovComQqImQIMCameraCaptureUnit));
    }
    label484:
