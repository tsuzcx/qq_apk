  ...
  implements Manager
{
  ...
  public njm(AppInterface paramAppInterface)
  {
  ...
  private boolean a(troopviewInfo.RspBody paramRspBody)
  {
    ...
    return bgmg.a(new File(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApplication().getFilesDir(), "AddContactTroopManage" + this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin()).getAbsolutePath(), paramRspBody.toByteArray(), false);
  }
  ...
  private troopviewInfo.RspBody b()
  {
    ...
    //   3: dup
    //   4: aload_0
    //   5: getfield 21	njm:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    ...
    //   26: aload_0
    //   27: getfield 21	njm:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    ...
    //   42: invokestatic 96	bgmg:a	(Ljava/io/File;)[B
    //   45: astore_2
