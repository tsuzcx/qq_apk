...
public class awuq
{
  ...
  public awuq(Context paramContext)
  {
    this(paramContext, null);
  }
  
  public awuq(Context paramContext, QQAppInterface paramQQAppInterface)
  {
  ...
  private void b()
  {
    ...
    try
    {
      String str2 = yzg.b(str1, yzg.b(2));
      ...
      localObject1 = yzg.a(str1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 25004, 10, (List)localObject2);
      localObject2 = ((String)localObject1).replaceAll(str1, str2);
      Bundle localBundle = yzg.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
      if (QLog.isColorLevel()) {
        QLog.i("HttpMqqJumper", 2, "openMoreOptions safetyReport reportMsgOrg: " + (String)localObject1 + "  reportMsg: " + (String)localObject2);
      }
      yzg.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a, str1, str2, null, null, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 25004, (String)localObject2, localBundle);
      return;
    }
  ...
  public awuq a(BaseChatPie paramBaseChatPie)
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie = paramBaseChatPie;
    return this;
  }
  
  public awuq a(SessionInfo paramSessionInfo)
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo = paramSessionInfo;
    return this;
  }
  
  public awuq a(String paramString)
  {
  ...
  public void a()
  {
    ...
    do
    {
      ...
      localObject = bdds.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString);
    } while (localObject == null);
    ((bddb)localObject).a();
    ((bddb)localObject).c();
  }
