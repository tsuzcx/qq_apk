...
public class uhs
{
  ...
  public static GdtHandler.Params a(Context paramContext, AdvertisementInfo paramAdvertisementInfo, slt paramslt, int paramInt, boolean paramBoolean, trj paramtrj)
  {
    return a(paramContext, paramAdvertisementInfo, paramslt, paramInt, paramBoolean, true, false, paramtrj);
  }
  
  public static GdtHandler.Params a(Context paramContext, AdvertisementInfo paramAdvertisementInfo, slt paramslt, int paramInt, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, trj paramtrj)
  {
    if ((paramBoolean2) && (!a(paramAdvertisementInfo, paramInt))) {
      return null;
    }
    tqh localtqh = new tqh();
    localtqh.b = paramBoolean1;
    localtqh.d = paramBoolean3;
    if (paramtrj != null) {
      if (paramtrj.b) {
        break label105;
      }
    ...
    {
      localtqh.jdField_a_of_type_Boolean = paramBoolean1;
      localtqh.c = paramtrj.jdField_a_of_type_Boolean;
      localtqh.jdField_a_of_type_Long = paramtrj.jdField_a_of_type_Long;
      if (paramslt != null) {
        localtqh.jdField_a_of_type_Long = paramslt.a();
      }
      return tqe.a(paramAdvertisementInfo, (Activity)paramContext, localtqh);
    }
  }
  ...
  public static qq_ad_get.QQAdGetRsp.AdInfo a(AdvertisementInfo paramAdvertisementInfo)
  {
    ...
    //   358: astore_1
    //   359: aload_0
    //   360: getfield 390	com/tencent/biz/pubaccount/readinjoy/struct/AdvertisementInfo:mAdvertisementExtInfo	Ltro;
    //   363: ifnull +23 -> 386
    //   366: aload_2
    //   367: astore_1
    //   368: aload_0
    //   369: getfield 390	com/tencent/biz/pubaccount/readinjoy/struct/AdvertisementInfo:mAdvertisementExtInfo	Ltro;
    //   372: getfield 395	tro:j	I
    //   375: ldc_w 396
    //   378: if_icmpne +8 -> 386
    //   381: aload_2
    //   382: invokestatic 398	uhs:a	(Ljava/lang/String;)Ljava/lang/String;
    //   385: astore_1
    //   386: aload 6
    ...
    //   600: aload_0
    //   601: invokestatic 470	twr:g	(Lcom/tencent/biz/pubaccount/readinjoy/struct/AdvertisementInfo;)Z
    //   604: ifeq +38 -> 642
    //   607: aload_0
    //   608: getfield 390	com/tencent/biz/pubaccount/readinjoy/struct/AdvertisementInfo:mAdvertisementExtInfo	Ltro;
    //   611: getfield 473	tro:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   614: ifnull +28 -> 642
    //   617: aload_0
    //   618: getfield 390	com/tencent/biz/pubaccount/readinjoy/struct/AdvertisementInfo:mAdvertisementExtInfo	Ltro;
    //   621: getfield 473	tro:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   624: invokeinterface 479 1 0
    //   629: iconst_2
    //   630: if_icmplt +12 -> 642
    //   633: aload_0
    //   634: invokestatic 482	uhs:a	(Lcom/tencent/biz/pubaccount/readinjoy/struct/AdvertisementInfo;)Ltrk;
    //   637: astore_1
    //   638: aload_1
    ...
    //   943: goto -348 -> 595
    //   946: aload_1
    //   947: getfield 567	trk:b	Ljava/lang/String;
    ...
    //   983: aload_1
    //   984: getfield 568	trk:a	Ljava/lang/String;
  ...
  /* Error */
  private static trk a(AdvertisementInfo paramAdvertisementInfo)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_1
    ...
    //   3: ifnull +142 -> 145
    //   6: aload_0
    //   7: getfield 390	com/tencent/biz/pubaccount/readinjoy/struct/AdvertisementInfo:mAdvertisementExtInfo	Ltro;
    //   10: ifnull +135 -> 145
    //   13: aload_0
    //   14: getfield 390	com/tencent/biz/pubaccount/readinjoy/struct/AdvertisementInfo:mAdvertisementExtInfo	Ltro;
    //   17: getfield 473	tro:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   20: ifnull +125 -> 145
    //   23: aload_0
    //   24: getfield 390	com/tencent/biz/pubaccount/readinjoy/struct/AdvertisementInfo:mAdvertisementExtInfo	Ltro;
    //   27: getfield 473	tro:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   45: if_icmpne +20 -> 65
    //   48: aload_0
    //   49: getfield 390	com/tencent/biz/pubaccount/readinjoy/struct/AdvertisementInfo:mAdvertisementExtInfo	Ltro;
    //   52: getfield 473	tro:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   55: iconst_0
    //   56: invokeinterface 577 2 0
    //   61: checkcast 565	trk
    //   64: astore_1
    //   65: aload_0
    ...
    //   71: if_icmpne +72 -> 143
    //   74: aload_0
    //   75: getfield 390	com/tencent/biz/pubaccount/readinjoy/struct/AdvertisementInfo:mAdvertisementExtInfo	Ltro;
    //   78: getfield 473	tro:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   81: iconst_1
    //   82: invokeinterface 577 2 0
    //   87: checkcast 565	trk
    //   90: astore_2
    //   91: aload_2
    //   92: areturn
    //   93: astore_1
  ...
  private static tsp a(slt paramslt, String paramString)
  {
    ...
    int k;
    if (i < paramslt.a().size() + localReadInJoyXListView.getHeaderViewsCount())
    {
      k = i - localReadInJoyXListView.getHeaderViewsCount();
      BaseArticleInfo localBaseArticleInfo = paramslt.b(k);
      if ((66 == paramslt.getItemViewType(k)) && (localBaseArticleInfo != null) && (TextUtils.equals(localBaseArticleInfo.getInnerUniqueID(), paramString)))
      {
        int m = i - j;
        if ((m >= 0) && (m < localReadInJoyXListView.getChildCount())) {
          paramslt = localReadInJoyXListView.getChildAt(i - j);
        }
      }
    }
    for (;;)
    {
      if ((paramslt != null) && ((paramslt.getTag() instanceof tsp)))
      {
        return (tsp)paramslt.getTag();
        if ((k >= 0) && (k < paramslt.a().size())) {
          paramslt = paramslt.getView(k, null, localReadInJoyXListView);
        }
      }
      else
      {
  ...
  private static void a(Activity paramActivity, AdvertisementInfo paramAdvertisementInfo, slt paramslt, int paramInt, boolean paramBoolean)
  {
    if ((paramslt != null) && (paramBoolean)) {
    ...
    if (paramslt != null) {
      localBundle.putLong("param_ad_app_info_video_playposition", paramslt.a());
    }
    a(paramActivity);
    ReadInJoyNativeAdAppFragment.a(paramActivity, ReadInJoyNativeAdAppFragment.class, localBundle);
  }
  
  public static void a(Activity paramActivity, AdvertisementInfo paramAdvertisementInfo, slt paramslt, int paramInt, boolean paramBoolean, trj paramtrj)
  {
    paramtrj = a(paramActivity, paramAdvertisementInfo, paramslt, paramInt, paramBoolean, paramtrj);
    if (((paramAdvertisementInfo instanceof AdvertisementInfo)) && (paramtrj != null))
    {
      a(paramtrj, true, paramAdvertisementInfo, paramActivity);
      if (a(paramtrj, paramActivity, paramAdvertisementInfo)) {
        return;
      }
    }
    ...
    paramtrj = new qq_ad_get.QQAdGetRsp.AdInfo.ReportInfo();
    paramtrj.exposure_url.set(paramAdvertisementInfo.mAdApurl);
    paramtrj.click_url.set(paramAdvertisementInfo.mAdRl);
    paramtrj.trace_info.set((MessageMicro)localObject);
    localObject = new qq_ad_get.QQAdGetRsp.AdInfo();
    ((qq_ad_get.QQAdGetRsp.AdInfo)localObject).report_info.set(paramtrj);
    ...
    for (;;)
    {
      ...
      ((GdtVideoCeilingData)localObject).setWebUrl(paramtrj);
      ...
      a(paramActivity, paramAdvertisementInfo, paramslt, 0, null);
      return;
      label350:
      paramtrj.appendQueryParameter("autodownload", "0");
    }
    a(paramActivity, paramAdvertisementInfo, paramslt, 0, false);
    return;
    label374:
    if (paramInt == 5)
    {
      b(paramActivity, paramAdvertisementInfo, paramslt, 0, false);
      return;
    }
  ...
  public static void a(Activity paramActivity, AdvertisementInfo paramAdvertisementInfo, slt paramslt, int paramInt, boolean paramBoolean1, boolean paramBoolean2, trj paramtrj)
  {
    Object localObject = a(paramActivity, paramAdvertisementInfo, paramslt, paramInt, paramBoolean1, paramtrj);
  ...
  {
    Object localObject2 = pay.d(paramArticleInfo);
    int i;
    int j;
    label32:
    int k;
    ...
    if (paramArticleInfo.hasChannelInfo())
    {
      ...
      localObject3 = uhv.b(paramArticleInfo.mChannelID);
      if ((!pgb.i(paramArticleInfo)) && (!pgb.g(paramArticleInfo)) && (!pgb.j(paramArticleInfo)) && (!pgb.k(paramArticleInfo))) {
        break label635;
      }
      odq.a(null, "CliOper", "", String.valueOf(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfj.jdField_a_of_type_Long), (String)localObject3, (String)localObject3, 0, 0, Long.toString(paramArticleInfo.mFeedId), paramArticleInfo.businessId + "", Integer.toString(paramArticleInfo.mStrategyId), pay.a(paramArticleInfo.mAlgorithmID, pay.a(paramArticleInfo), paramInt, i, j, NetworkUtil.isWifiConnected(paramActivity), String.valueOf(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rer.jdField_a_of_type_Long), paramArticleInfo.mStrCircleId, paramArticleInfo.innerUniqueID, pay.f(paramArticleInfo), k, paramArticleInfo), false);
    }
    Object localObject1;
    for (;;)
    {
      odq.a((String)localObject3, paramArticleInfo.mSubscribeID, Long.toString(paramArticleInfo.mFeedId), Long.toString(paramArticleInfo.mArticleID), Integer.toString(paramArticleInfo.mStrategyId), pay.a(paramArticleInfo.mAlgorithmID, pay.a(paramArticleInfo), paramInt, i, j, NetworkUtil.isWifiConnected(paramActivity), (String)localObject2, paramArticleInfo.mStrCircleId, paramArticleInfo.innerUniqueID, pay.f(paramArticleInfo), k, paramArticleInfo));
      paramslt = new ArrayList();
      ...
      ((rdy)localObject2).jdField_b_of_type_Int = paramArticleInfo.mSocialFeedInfo.d;
      ...
      break label45;
      label635:
      localObject1 = pay.a(paramArticleInfo.mAlgorithmID, pay.a(paramArticleInfo), paramInt, i, j, NetworkUtil.isWifiConnected(paramActivity), (String)localObject2, paramArticleInfo.mStrCircleId, paramArticleInfo.innerUniqueID, pay.f(paramArticleInfo), k, paramArticleInfo);
      paramslt = (slt)localObject1;
      if (paramInt == 0) {
        paramslt = ofe.a(k, (String)ofe.a.get(ReadInJoyChannelActivity.class), (String)localObject1);
      }
      odq.a(null, "CliOper", "", paramArticleInfo.mSubscribeID, (String)localObject3, (String)localObject3, 0, 0, Long.toString(paramArticleInfo.mFeedId), Long.toString(paramArticleInfo.mArticleID), Integer.toString(paramArticleInfo.mStrategyId), paramslt, false);
    }
    label746:
    ((ReportInfo)localObject1).mFeedsReportData = ((rdy)localObject2);
    label753:
    paramslt.add(localObject1);
    pkm.a().a(paramslt);
    pma.a.b(paramInt, paramArticleInfo);
    if ((paramArticleInfo instanceof AdvertisementInfo))
    {
      if (paramArticleInfo.mChannelID == 56L) {
        obb.a(new trn().a(paramActivity).a(obb.jdField_a_of_type_Int).b(obb.W).a((AdvertisementInfo)paramArticleInfo).d(((AdvertisementInfo)paramArticleInfo).clickPos).a());
      }
    }
    else {
      return;
    }
    if ((twr.l((AdvertisementInfo)paramArticleInfo)) && (twx.jdField_a_of_type_Boolean)) {
      paramInt = obb.ap;
    }
    for (;;)
    {
      obb.a(new trn().a(paramActivity).a(obb.jdField_a_of_type_Int).b(paramInt).a((AdvertisementInfo)paramArticleInfo).d(((AdvertisementInfo)paramArticleInfo).clickPos).a());
      return;
  ...
  public static void a(Activity paramActivity, ArticleInfo paramArticleInfo, slt paramslt, int paramInt, trj paramtrj)
  {
    ...
    if (AdvertisementInfo.isAdvertisementInfo(paramArticleInfo))
    {
      ...
      localParams = a(paramActivity, (AdvertisementInfo)paramArticleInfo, paramslt, paramInt, true, paramtrj);
      if (((paramArticleInfo instanceof AdvertisementInfo)) && (localParams != null) && (paramtrj == null)) {
      ...
      {
        paramtrj = paramArticleInfo.mArticleContentUrl;
        if ((!AdvertisementInfo.isAdvertisementInfo(paramArticleInfo)) || (!twr.g((AdvertisementInfo)paramArticleInfo))) {
          break label411;
        }
        paramslt = a((AdvertisementInfo)paramArticleInfo);
        if (paramslt == null) {
          break label417;
        }
      }
    ...
    label411:
    label417:
    for (paramslt = paramslt.a;; paramslt = "")
    {
      if (!TextUtils.isEmpty(paramslt)) {}
      for (;;)
      {
        paramtrj = paramslt;
        if (AdvertisementInfo.isAppAdvertisementInfo(paramArticleInfo))
        {
          ...
          if (NetworkUtil.isWifiConnected(null)) {
            if (!paramslt.contains("?")) {
              break label235;
            }
          }
        }
        label235:
        for (paramslt = paramslt + "&";; paramslt = paramslt + "?")
        {
          paramtrj = paramslt + "acttype=42";
          a(paramActivity);
          if (!twr.l((AdvertisementInfo)paramArticleInfo)) {
            break;
          }
          pay.d(paramActivity, paramtrj);
          return;
        }
        ...
        paramArticleInfo.putExtra("url", paramtrj);
  ...
  public static void a(Activity paramActivity, ArticleInfo paramArticleInfo, slt paramslt, int paramInt, boolean paramBoolean, trj paramtrj)
  {
    ...
    do
    {
      ...
      case 6: 
      case 7: 
        a(paramActivity, paramArticleInfo, paramslt, paramInt, paramtrj);
        return;
      case 2: 
        a(paramActivity, (AdvertisementInfo)paramArticleInfo, paramslt, paramInt, paramBoolean, paramtrj);
        return;
      case 4: 
        ...
        a(paramActivity, (AdvertisementInfo)paramArticleInfo, paramslt, paramInt, true);
        return;
      case 3: 
        int i = ((AdvertisementInfo)paramArticleInfo).clickPos;
        a(paramActivity, (AdvertisementInfo)paramArticleInfo, null, paramInt, paramBoolean, paramtrj);
    ...
    paramslt.notifyDataSetChanged();
    return;
    b(paramActivity, (AdvertisementInfo)paramArticleInfo, paramslt, paramInt, true);
  }
  
  public static void a(Activity paramActivity, ArticleInfo paramArticleInfo, slt paramslt, int paramInt, boolean paramBoolean1, boolean paramBoolean2, trj paramtrj)
  {
    if ((!AdvertisementInfo.isAdvertisementInfo(paramArticleInfo)) || (!(paramArticleInfo instanceof AdvertisementInfo))) {
      return;
    }
    ...
    for (;;)
    {
      ...
      case 7: 
        ...
        return;
      case 2: 
        a(paramActivity, (AdvertisementInfo)paramArticleInfo, paramslt, paramInt, paramBoolean1, paramtrj);
        return;
      case 4: 
        if (TextUtils.isEmpty(((AdvertisementInfo)paramArticleInfo).mAdAppJson))
        {
          a(paramActivity, paramArticleInfo, paramslt, paramInt, null);
          return;
        }
        a(paramActivity, (AdvertisementInfo)paramArticleInfo, paramslt, paramInt, true);
        return;
      case 3: 
        paramtrj.jdField_a_of_type_Boolean = a(paramArticleInfo, paramslt);
        int i = ((AdvertisementInfo)paramArticleInfo).clickPos;
        a(paramActivity, (AdvertisementInfo)paramArticleInfo, paramslt, paramInt, paramBoolean1, paramBoolean2, paramtrj);
        ((AdvertisementInfo)paramArticleInfo).clickPos = i;
        a(paramActivity, paramArticleInfo, paramslt, paramInt);
        pkm.a().a(paramArticleInfo.mArticleID, System.currentTimeMillis());
        if (paramslt == null) {
  ...
  public static void a(Context paramContext, AdvertisementInfo paramAdvertisementInfo, slt paramslt, int paramInt, boolean paramBoolean, trj paramtrj)
  {
    int i = paramAdvertisementInfo.clickPos;
    a(paramContext, paramAdvertisementInfo, paramslt, paramInt, paramBoolean, paramtrj);
    if (i >= 0) {
  ...
  public static void a(Context paramContext, AdvertisementInfo paramAdvertisementInfo, slt paramslt, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    int i = paramAdvertisementInfo.clickPos;
    a(paramContext, paramAdvertisementInfo, paramslt, paramInt, paramBoolean1, paramBoolean2);
    if (i >= 0) {
      paramAdvertisementInfo.setClickPos(i);
    }
    a(paramContext, paramAdvertisementInfo, paramInt);
  ...
  public static void a(Context paramContext, ArticleInfo paramArticleInfo, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      } while ((twr.g((AdvertisementInfo)paramArticleInfo)) && (((AdvertisementInfo)paramArticleInfo).isClickFromPkFragment));
  ...
  public static void a(Context paramContext, ArticleInfo paramArticleInfo, int paramInt1, int paramInt2)
  {
    if ((paramArticleInfo instanceof AdvertisementInfo))
    {
      obb.a(new trn().a(paramContext).a(obb.jdField_a_of_type_Int).b(paramInt2).a((AdvertisementInfo)paramArticleInfo).e(new JSONObject()).a());
  ...
  {
    if ((paramslt != null) && (paramArticleInfo != null) && ((paramArticleInfo instanceof AdvertisementInfo)) && ((paramContext instanceof Activity)))
    {
      paramslt.jdField_a_of_type_ComTencentGdtadAditemGdtHandler$Params = a(paramContext, (AdvertisementInfo)paramArticleInfo, paramslt, paramInt, false, null);
      if (paramslt.jdField_a_of_type_ComTencentGdtadAditemGdtHandler$Params == null) {
        break label57;
      }
    }
    label57:
    ...
    {
      paramslt.jdField_a_of_type_Long = l;
      return;
    }
  }
  ...
  public static void a(ViewBase paramViewBase, Activity paramActivity, ArticleInfo paramArticleInfo, slt paramslt, int paramInt1, int paramInt2)
  {
    AdvertisementInfo localAdvertisementInfo;
    if ((paramArticleInfo instanceof AdvertisementInfo))
    {
      localAdvertisementInfo = (AdvertisementInfo)paramArticleInfo;
      a(paramActivity, localAdvertisementInfo, paramslt, paramInt1);
      if ((paramInt2 != 6) || ((paramslt != null) && (paramslt.a() != null) && (paramslt.a().b()))) {
        break label375;
      }
    }
    label307:
    ...
    for (int i = 5;; i = paramInt2)
    {
      ...
      for (;;)
      {
        twr.a(localAdvertisementInfo, i, null);
        sdc localsdc = null;
        if (paramslt != null) {
          localsdc = paramslt.a();
        }
        if ((twr.g((AdvertisementInfo)paramArticleInfo)) && ((paramInt2 == 4) || (paramInt2 == 3) || (paramInt2 == 1)))
        {
          if (paramInt2 == 1) {
            i = 3;
          }
          twr.a(paramActivity, 1);
          a(paramActivity);
          a(paramActivity, (AdvertisementInfo)paramArticleInfo);
          obb.a(new trn().a(paramActivity).a(obb.jdField_a_of_type_Int).b(obb.ak).a((AdvertisementInfo)paramArticleInfo).d(i).a());
        }
        boolean bool1;
        do
        {
          ...
          {
            return;
          } while ((paramViewBase != null) && (a(paramArticleInfo, paramViewBase, paramActivity, paramInt1, localsdc, localAdvertisementInfo)));
          boolean bool2 = true;
          if ((paramInt2 != 6) && (paramInt2 != 5) && ((paramslt == null) || ((paramInt1 != 0) && (!pcl.b(paramInt1))) || ((pgb.a(localAdvertisementInfo, paramInt1) != 104) && (pgb.a(localAdvertisementInfo, paramInt1) != 105))))
          {
            bool1 = bool2;
            if (j != 0) {
              break label307;
          ...
          bool1 = false;
          paramViewBase = new trj();
          if (paramInt2 == 8) {
            paramViewBase.c = true;
          }
        } while (a(paramActivity, paramslt, paramArticleInfo));
        a(paramActivity, localAdvertisementInfo, paramslt, paramInt1, bool1, twq.b((AdvertisementInfo)paramArticleInfo), paramViewBase);
        tvi.a.b(-1);
        twp.a("ReadInJoySuperMaskAd", "setSuperMaskChannelId -1 : doAdClickAction");
        return;
      }
    }
  }
  
  public static void a(ViewBase paramViewBase1, ViewBase paramViewBase2, Activity paramActivity, ArticleInfo paramArticleInfo, slt paramslt, int paramInt1, int paramInt2)
  {
    if ((paramViewBase2 == null) || (paramActivity == null) || (paramArticleInfo == null)) {
      return;
    }
    a(paramViewBase1, paramActivity, paramArticleInfo, paramslt, paramInt1, paramInt2);
  }
  ...
  public static void a(ruw paramruw)
  {
    a(3, paramruw.jdField_a_of_type_ComTencentGdtadAditemGdtHandler$Params, paramruw.jdField_a_of_type_Long);
    paramruw.jdField_a_of_type_Long = -2147483648L;
    paramruw.jdField_a_of_type_ComTencentGdtadAditemGdtHandler$Params = null;
  }
  ...
  public static boolean a(Context paramContext, AdvertisementInfo paramAdvertisementInfo)
  {
    ...
    while (!twr.n(paramAdvertisementInfo)) {
      return false;
    }
    pay.d(paramContext, paramAdvertisementInfo.mAdLandingPage);
    return true;
  }
  
  public static boolean a(Context paramContext, AdvertisementInfo paramAdvertisementInfo, slt paramslt, int paramInt, boolean paramBoolean)
  {
    paramslt = a(paramContext, paramAdvertisementInfo, paramslt, paramInt, paramBoolean, null);
    if (paramslt == null) {
      return false;
    }
    return b(paramslt, paramContext, paramAdvertisementInfo);
  }
  
  public static boolean a(Context paramContext, AdvertisementInfo paramAdvertisementInfo, slt paramslt, int paramInt, boolean paramBoolean, trj paramtrj)
  {
    paramslt = a(paramContext, paramAdvertisementInfo, paramslt, paramInt, paramBoolean, paramtrj);
    if (paramslt == null) {
      return false;
    }
    return b(paramslt, paramContext, paramAdvertisementInfo);
  ...
  public static boolean a(Context paramContext, AdvertisementInfo paramAdvertisementInfo, slt paramslt, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    paramslt = a(paramContext, paramAdvertisementInfo, paramslt, paramInt, paramBoolean1, null);
    if (paramslt == null) {
      return false;
    }
    paramslt.f = paramBoolean2;
    return b(paramslt, paramContext, paramAdvertisementInfo);
  }
  ...
  public static boolean a(Context paramContext, AdData paramAdData, AdvertisementInfo paramAdvertisementInfo)
  {
    ...
    while (!twh.a(paramAdData)) {
      return false;
    }
    a(paramContext);
    twr.b(paramAdvertisementInfo);
    twh.a(paramContext, paramAdData);
    paramContext = (QQAppInterface)pay.a();
    obb.a(new trn().a(paramContext).a(BaseApplication.getContext()).a(obb.jdField_a_of_type_Int).b(obb.ae).a(paramAdvertisementInfo).d(obb.a(paramAdData)).a());
    return true;
  }
  
  private static boolean a(Context paramContext, slt paramslt, ArticleInfo paramArticleInfo)
  {
    if ((paramslt == null) || (paramslt.a() != 0)) {}
    tsp localtsp;
    do
    {
      do
      {
        return false;
      } while (!twr.a(paramArticleInfo));
      pay.a(paramArticleInfo);
      paramArticleInfo.innerUniqueID = a(paramArticleInfo, "landing_page_rowkey");
      localtsp = a(paramslt, paramArticleInfo.innerUniqueID);
    } while (localtsp == null);
    a(paramContext, paramArticleInfo, paramslt.a());
    paramslt.a(localtsp.a(), paramArticleInfo);
    return true;
  }
  ...
  public static boolean a(AdvertisementInfo paramAdvertisementInfo, int paramInt)
  {
    ...
    while ((!(paramAdvertisementInfo instanceof AdvertisementInfo)) || (twr.a(paramAdvertisementInfo))) {
      return false;
    }
    if ((paramInt == 2) || (paramInt == 5) || (paramInt == 3) || (paramInt == 56) || (paramInt == 4) || (paramInt == 2000001) || (paramInt == 95555552) || ((twr.a(paramInt)) && (!a(paramAdvertisementInfo.mAdJumpMode)) && (jdField_a_of_type_JavaUtilArrayList.contains(Integer.valueOf(paramAdvertisementInfo.mAdProductType))))) {
      return true;
    }
  ...
  {
    if ((AdvertisementInfo.isAppAdvertisementInfo(paramAdvertisementInfo)) && (!twr.c(paramAdvertisementInfo))) {}
  ...
  public static boolean a(ArticleInfo paramArticleInfo, ViewBase paramViewBase, Activity paramActivity, int paramInt, sdc paramsdc, AdvertisementInfo paramAdvertisementInfo)
  {
    Object localObject1;
    Object localObject2;
    if ((paramAdvertisementInfo.mImaxShowAdType == 1001) || (paramAdvertisementInfo.mImaxShowAdType == 1002))
    {
      ...
      if (paramAdvertisementInfo.mImaxShowAdType == 1001)
      {
        ...
        if ((localObject1 != null) && (((ViewBase)localObject1).getNativeView() != null) && (((ViewBase)localObject1).getNativeView().getVisibility() == 0))
        {
          ...
          a(paramActivity, paramArticleInfo, paramInt, obb.ai);
          return true;
        }
      }
      localObject1 = null;
      ...
      {
        localObject2 = paramViewBase.findViewBaseByName("idArticleDoubleImage");
    ...
    for (;;)
    {
      ...
      paramsdc = paramViewBase.getNativeView();
      if (localObject1 != null) {
        if ((localObject1 instanceof NativeReadInjoyImageView))
        {
          ...
          paramsdc = (sdc)localObject1;
        }
      }
      for (;;)
      {
        paramsdc.getLocationOnScreen((int[])localObject2);
        ...
        int k = paramsdc.getWidth();
        int m = paramsdc.getHeight();
        paramViewBase = new pqu();
  ...
  public static boolean a(ArticleInfo paramArticleInfo, slt paramslt)
  {
    if ((paramslt != null) && (paramslt.a() != null) && (paramslt.a().b()) && (paramslt.a().a() != null))
    {
      paramslt = paramslt.a().a();
      if ((paramslt.b) && (paramslt.a != null) && (AdvertisementInfo.isAdvertisementInfo(paramslt.a)))
      {
        paramslt = (AdvertisementInfo)paramslt.a;
        if ((!TextUtils.isEmpty(paramslt.mAdTraceId)) && ((paramArticleInfo instanceof AdvertisementInfo)) && (paramslt.mAdTraceId.equals(((AdvertisementInfo)paramArticleInfo).mAdTraceId))) {
          return true;
        }
      }
    }
  ...
  private static void b(Activity paramActivity, AdvertisementInfo paramAdvertisementInfo, slt paramslt, int paramInt, boolean paramBoolean)
  {
    if ((paramslt != null) && (paramBoolean)) {
      a(paramActivity, paramAdvertisementInfo, paramInt);
    }
    ...
    if (paramslt != null)
    {
      ...
      {
        l1 = l2;
        if (paramslt.a().a() != null)
        {
          l1 = l2;
          if (paramslt.a().a().c == paramAdvertisementInfo.mArticleID) {
            l1 = paramslt.a();
          }
        }
      }
  ...
  private static void b(Context paramContext, ArticleInfo paramArticleInfo, int paramInt)
  {
    ...
    for (int j = 0;; j = 1)
    {
      String str1 = pay.d(paramArticleInfo);
      String str2 = uhv.b(paramInt);
      odq.a(null, "CliOper", "", paramArticleInfo.mSubscribeID, str2, str2, 0, 0, Long.toString(paramArticleInfo.mFeedId), Long.toString(paramArticleInfo.mArticleID), Integer.toString(paramArticleInfo.mStrategyId), pay.a(paramArticleInfo.mAlgorithmID, pay.a(paramArticleInfo), paramInt, i, j, NetworkUtil.isWifiConnected(paramContext), str1, paramArticleInfo.mStrCircleId, paramArticleInfo.innerUniqueID, pay.f(paramArticleInfo), paramArticleInfo), false);
      return;
      i = 0;
      break;
    }
  ...
  public static boolean b(Context paramContext, AdvertisementInfo paramAdvertisementInfo, slt paramslt, int paramInt, boolean paramBoolean)
  {
    paramslt = a(paramContext, paramAdvertisementInfo, paramslt, paramInt, paramBoolean, false, false, null);
    if (paramslt == null) {
      return false;
    }
    a(paramslt, true, paramAdvertisementInfo, paramContext);
    GdtHandler.a(paramslt);
    QLog.i("ReadinJoyActionUtil", 3, "kandian JumpToTangramSDK");
    return true;
  }
  
  public static boolean b(Context paramContext, AdvertisementInfo paramAdvertisementInfo, slt paramslt, int paramInt, boolean paramBoolean, trj paramtrj)
  {
    if (twr.n(paramAdvertisementInfo))
    {
      a(paramContext, paramAdvertisementInfo);
      return true;
    }
    if ((!twr.o(paramAdvertisementInfo)) && (!TextUtils.isEmpty(paramAdvertisementInfo.mAdLandingPage)))
    {
      pay.d(paramContext, paramAdvertisementInfo.mAdLandingPage);
      return true;
    }
  ...
  public static boolean c(Context paramContext, AdvertisementInfo paramAdvertisementInfo, slt paramslt, int paramInt, boolean paramBoolean, trj paramtrj)
  {
    paramslt = a(paramContext, paramAdvertisementInfo, paramslt, paramInt, paramBoolean, false, false, paramtrj);
    if (paramslt == null) {
      return false;
    }
    a(paramslt, true, paramAdvertisementInfo, paramContext);
