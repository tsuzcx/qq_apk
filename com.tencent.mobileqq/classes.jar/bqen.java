  ...
  implements bqep
{
  ...
  public bqen(@NonNull bqgk parambqgk, int paramInt)
  {
    super(parambqgk);
    ...
    {
      wrc.a().a("EditVideoDTextFace.mSrcFrom", this.jdField_a_of_type_JavaLangString);
      return;
    }
  }
  ...
  private void j()
  {
    ...
    QQToast.a(a(), a().getString(2131697597), 0).a();
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_JavaUtilList = bpse.a(0);
    if (TextUtils.isEmpty(this.b)) {
      this.b = anzj.a(2131702721);
    }
    bpse.a(0, Collections.singletonList(this.b));
    this.jdField_a_of_type_Bqgk.a().a().postDelayed(new EditVideoDTextFace.1(this, localDynamicTextConfigManager), 1000L);
  }
      ...
      do
      {
        do
        {
          do
          {
            ...
            paramObject = (bqbr)a(bqbr.class);
          } while (paramObject == null);
          paramObject = paramObject.a();
        } while (paramObject == null);
        localbqjx = paramObject.a();
      } while (localbqjx == null);
      paramInt1 = 0;
      if (localbqjx.a != null) {
  ...
  public void a(int paramInt, @NonNull bqua parambqua)
  {
    ...
    parambqua = ((bqbr)a(bqbr.class)).a().a();
    int i = parambqua.a.size();
    StringBuilder localStringBuilder = new StringBuilder();
    paramInt = 0;
    while (paramInt < i)
    {
      localStringBuilder.append(((bqka)parambqua.a.get(paramInt)).a.c() + 1);
      if (paramInt < i - 1) {
        localStringBuilder.append(",");
      }
      paramInt += 1;
    }
    yup.a("video_edit_text", "pub_withText", 0, 0, new String[] { this.jdField_a_of_type_JavaLangString, localStringBuilder.toString(), String.valueOf(i), "" });
  }
  ...
  public void g()
  {
    ...
    {
      InputMethodManager localInputMethodManager = (InputMethodManager)this.jdField_a_of_type_Bqhs.getActivity().getSystemService("input_method");
      if ((localInputMethodManager != null) && (localInputMethodManager.isActive())) {
        localInputMethodManager.hideSoftInputFromWindow(this.jdField_a_of_type_Bqhs.a().getWindowToken(), 0);
      }
    }
    super.g();
    bpse.a(0, this.jdField_a_of_type_JavaUtilList);
  }
  ...
  public void i()
  {
    if ((this.jdField_a_of_type_AndroidViewView != null) && (this.jdField_a_of_type_AndroidViewView.getVisibility() == 8))
    {
      ...
      yup.a("video_edit_text", "exp_textWording", 0, 0, new String[] { this.jdField_a_of_type_JavaLangString, "", "", "" });
