  ...
  implements QQMessageFacade.GetAioListCallback
{
  ...
  private void a(MessageForUniteGrayTip paramMessageForUniteGrayTip, QQMessageFacade paramQQMessageFacade)
  {
    ...
    Object localObject1 = paramQQMessageFacade.getApp().getString(2131694490);
    Object localObject2 = paramQQMessageFacade.getApp().getString(2131694489);
    localObject2 = new avhz(paramMessageForUniteGrayTip.frienduin, paramMessageForUniteGrayTip.senderuin, (String)localObject1 + (String)localObject2, paramMessageForUniteGrayTip.istroop, -5020, 656396, bcrg.a());
    Bundle localBundle = new Bundle();
    localBundle.putInt("key_action", 64);
    ((avhz)localObject2).a(0, ((String)localObject1).length(), localBundle);
    localObject1 = new MessageForUniteGrayTip();
    ((MessageForUniteGrayTip)localObject1).initGrayTipMsg(paramQQMessageFacade, (avhz)localObject2);
    ((MessageForUniteGrayTip)localObject1).shmsgseq = paramMessageForUniteGrayTip.shmsgseq;
    avia.a(paramQQMessageFacade, (MessageForUniteGrayTip)localObject1);
  }
  ...
  private boolean a(QQMessageFacade paramQQMessageFacade)
  {
    for (;;)
    {
      ...
      {
        paramQQMessageFacade = paramQQMessageFacade.getApp();
        bool = ((afza)paramQQMessageFacade.getManager(QQManagerFactory.PAI_YI_PAI_MANAGER)).a();
        if (bool)
        {
          bool = false;
          return bool;
    ...
    while (paramString.hasNext())
    {
      ...
      if ((paramList instanceof MessageForUniteGrayTip))
      {
        ...
        if ((TextUtils.equals(paramList.getExtInfoFromExtStr("uint64_busi_type"), "12")) && (TextUtils.equals(paramList.getExtInfoFromExtStr("uint64_busi_id"), "1061")) && (a(paramQQMessageFacade)))
        {
          ...
          for (;;)
          {
            bdla.b(null, "dc00898", "", "", "0X800B3A3", "0X800B3A3", paramInt1, 0, "", "", "", "");
            break;
