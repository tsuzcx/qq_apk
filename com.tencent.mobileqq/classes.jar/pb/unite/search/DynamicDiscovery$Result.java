  ...
  extends MessageMicro<Result>
{
  ...
  public final PBRepeatField<ByteStringMicro> result_vt_ext = PBField.initRepeat(PBBytesField.__repeatHelper__);
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32, 162, 170, 178, 184, 194, 202, 210, 218, 226 }, new String[] { "type", "has_header", "title_header", "hide_top_divider", "sub_business_items", "operation_items", "hot_search_items", "hotword_update_ts", "special_topic_item", "hot_wrod_gif_item", "hot_search_gif_item", "result_ext", "result_vt_ext" }, new Object[] { Integer.valueOf(0), Integer.valueOf(0), null, Integer.valueOf(0), null, null, null, Integer.valueOf(0), null, null, null, localByteStringMicro1, localByteStringMicro2 }, Result.class);
  }
}
