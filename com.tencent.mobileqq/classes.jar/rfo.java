...
public class rfo
{
  ...
  private static rfo a(String paramString, int paramInt)
  {
    if (TextUtils.isEmpty(paramString)) {
      return null;
    }
    return a(bgva.a(paramString), paramInt);
  }
  
  private static rfo a(rfo paramrfo)
  {
    SharedPreferences localSharedPreferences = bmqa.a(pha.a(), true, false);
    if ((localSharedPreferences == null) || (paramrfo == null)) {
      return paramrfo;
    }
    paramrfo.jdField_d_of_type_Long = localSharedPreferences.getLong("kandian_push_0x210_c5_msg_time", 0L);
    return paramrfo;
  }
  
  public static rfo a(byte[] paramArrayOfByte)
  {
    return a(paramArrayOfByte, 1);
  }
  
  public static rfo a(byte[] paramArrayOfByte, int paramInt)
  {
    int i1 = 0;
    ...
    for (;;)
    {
      try
      {
        submsgtype0xc5.MsgBody localMsgBody = new submsgtype0xc5.MsgBody();
        localMsgBody.mergeFrom(paramArrayOfByte);
        localrfo.jdField_a_of_type_Int = paramInt;
        localrfo.jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
        localrfo.jdField_b_of_type_Int = localMsgBody.uint32_source.get();
        if (QLog.isColorLevel()) {
          QLog.d("KandianOx210MsgInfo", 2, "receive push 0xc5, bid = " + localrfo.jdField_b_of_type_Int);
        }
        localrfo.jdField_c_of_type_Int = localMsgBody.uint32_bid.get();
        if (QLog.isColorLevel()) {
          QLog.d("KandianOx210MsgInfo", 2, "receive push 0xc5, realbid = " + localrfo.jdField_c_of_type_Int);
        }
        localrfo.jdField_a_of_type_Long = localMsgBody.uint64_article_id.get();
        localrfo.jdField_b_of_type_Long = localMsgBody.uint64_seq.get();
        if (localMsgBody.bytes_diandian_cookie.has()) {
          localrfo.jdField_c_of_type_JavaLangString = localMsgBody.bytes_diandian_cookie.get().toStringUtf8();
        }
        if ((localMsgBody.msg_notify_infos.has()) && (localMsgBody.msg_notify_infos.get() != null) && (((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.has()) && (((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.get() != null))
        {
          ...
          {
            localrfo.jdField_a_of_type_JavaUtilArrayList.clear();
            ...
            if (paramInt < paramArrayOfByte.size())
            {
              ...
              localrfo.jdField_a_of_type_JavaUtilArrayList.add(localObject2);
              paramInt += 1;
              continue;
            }
          }
          ...
          if (((submsgtype0xc5.StyleSheet)localObject1).uint32_show_folder.has())
          {
            ...
            localrfo.jdField_e_of_type_Int = paramInt;
            ...
            localrfo.jdField_g_of_type_Int = paramInt;
            ...
            localrfo.jdField_a_of_type_JavaLangString = paramArrayOfByte;
            ...
            localrfo.jdField_b_of_type_JavaLangString = paramArrayOfByte;
            if (((!((submsgtype0xc5.StyleSheet)((submsgtype0xc5.StyleSheet)localObject1).get()).msg_tip_body.has()) || (((submsgtype0xc5.StyleSheet)((submsgtype0xc5.StyleSheet)localObject1).get()).msg_tip_body.get() == null)) && (localrfo.jdField_a_of_type_JavaUtilArrayList.size() == 0)) {
              return null;
            }
            if (((!((submsgtype0xc5.StyleSheet)((submsgtype0xc5.StyleSheet)localObject1).get()).msg_tip_body.has()) || (((submsgtype0xc5.StyleSheet)((submsgtype0xc5.StyleSheet)localObject1).get()).msg_tip_body.get() == null)) && (localrfo.jdField_a_of_type_JavaUtilArrayList.size() > 0)) {
              return localrfo;
            ...
            if (((submsgtype0xc5.StyleSheet)localObject1).uint32_show_lock_screen.has())
            {
              ...
              localrfo.jdField_f_of_type_Int = paramInt;
              paramInt = i1;
              ...
              localrfo.jdField_h_of_type_Int = paramInt;
              if (((submsgtype0xc5.TipsBody)localObject2).uint64_uin.has())
              {
                ...
                localrfo.jdField_e_of_type_Long = l1;
                ...
                localrfo.jdField_e_of_type_JavaLangString = paramArrayOfByte;
                ...
                localrfo.jdField_d_of_type_JavaLangString = paramArrayOfByte;
                ...
                localrfo.jdField_f_of_type_JavaLangString = paramArrayOfByte;
                ...
                localrfo.jdField_g_of_type_JavaLangString = paramArrayOfByte;
                if ((localMsgBody.msg_notify_infos.has()) && (localMsgBody.msg_notify_infos.get() != null) && (((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.has()) && (((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.get() != null) && (((submsgtype0xc5.StyleSheet)((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.get()).msg_type.has())) {
                  localrfo.i = ((submsgtype0xc5.StyleSheet)((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.get()).msg_type.get();
                }
                if ((((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_bb_info.has()) && (((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_bb_info.get() != null))
                {
                  ...
                  localrfo.jdField_c_of_type_Long = paramArrayOfByte.uint64_bb_uin.get();
                  localrfo.jdField_d_of_type_Int = paramArrayOfByte.uint32_src.get();
                }
                localrfo.jdField_h_of_type_JavaLangString = localMsgBody.str_msgid.get();
                return localrfo;
              }
            }
            else
  ...
  public static rfo b()
  {
    return a(a(bmqa.a(pha.a(), true, false).getString("kandian_push_0x210_msg_for_follow", ""), 1));
  }
  ...
  public static rfo c()
  {
    return a(a(bmqa.a(pha.a(), true, false).getString("kandian_push_0x210_msg_for_follow_show_in_folder", ""), 1));
  }
  ...
  public String a()
  {
    return bgva.a(this.jdField_a_of_type_ArrayOfByte);
  }
