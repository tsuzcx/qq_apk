...
public class acxp
{
  ...
  public static SparseArray<acxq> a;
  ...
  static
  {
    ...
    jdField_a_of_type_AndroidUtilSparseArray.put(6, new acxq(0L, 0));
    jdField_a_of_type_AndroidUtilSparseArray.put(14, new acxq(0L, 0));
  }
      ...
      if ((jdField_a_of_type_Long - l > 0L) && (MagnifierSDK.jdField_a_of_type_AndroidContentSharedPreferences$Editor != null))
      {
        ...
        for (;;)
        {
          if (i < j)
          {
            ...
            jdField_a_of_type_AndroidUtilSparseArray.put(k, new acxq(0L, 0));
            i += 1;
            continue;
    ...
    for (;;)
    {
      ...
      if (MagnifierSDK.jdField_a_of_type_AndroidContentSharedPreferences != null)
      {
        ...
        while (i < j)
        {
          ...
          jdField_a_of_type_AndroidUtilSparseArray.put(k, new acxq(0L, m));
          i += 1;
        }
      }
    }
