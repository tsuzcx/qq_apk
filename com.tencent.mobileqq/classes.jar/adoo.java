...
public class adoo
{
  ...
  aywi jdField_a_of_type_Aywi = new adoq(this);
  ...
  public String a;
  private AccountObserver jdField_a_of_type_MqqObserverAccountObserver = new ador(this);
  WtloginObserver jdField_a_of_type_MqqObserverWtloginObserver = new adop(this);
  public boolean a;
  ...
  public adoo(QQAppInterface paramQQAppInterface, RegisterNewBaseActivity paramRegisterNewBaseActivity, Intent paramIntent)
  {
  ...
  {
    aywm.a().a(true);
    aywm.a().b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_MqqObserverWtloginObserver);
  }
  ...
  public void a()
  {
    if (QLog.isDevelopLevel()) {
      bhix.a(getClass().getSimpleName(), a());
    }
    ...
    if ((this.h) && (this.i))
    {
      this.k = false;
      this.l = true;
      this.jdField_a_of_type_Bhjb = new bhjb(this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity, null);
      this.jdField_a_of_type_Bhjb.a(this.jdField_d_of_type_JavaLangString, new ados(this));
    }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    {
      k();
      this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.a(2131715760, 0);
    }
    for (;;)
    {
      this.k = false;
      ...
      if ((this.j) && (this.k)) {
        if (this.f) {
          ...
          aywk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ArrayOfByte, this.jdField_d_of_type_JavaLangString);
        }
      }
    }
  }
  ...
  public void c()
  {
    ...
    if (this.jdField_e_of_type_Boolean)
    {
      ...
      QQToast.a(BaseApplicationImpl.sApplication, anni.a(2131699645), 0).a();
    }
    j();
    LoginActivity.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount());
    h();
  ...
  public void e()
  {
    ...
    do
    {
      return;
      if (this.g) {
        bcst.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80072FC", "0X80072FC", 0, 0, "", "", "", "");
      }
