  ...
  extends LinearLayout
{
  ...
  public bipo(Context paramContext, int paramInt1, int paramInt2, float paramFloat, View.OnClickListener paramOnClickListener)
  {
    super(paramContext);
  ...
  private void a()
  {
    ...
    if (i < this.b)
    {
      View localView = LayoutInflater.from(getContext()).inflate(2131493439, null);
  ...
  public void a(biou parambiou, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (paramInt1 == paramInt2 - 1)
    {
      ...
      localObject2 = ((View)localObject1).findViewById(2131303876);
      localURLImageView = (URLImageView)((View)localObject1).findViewById(2131303865);
      localObject3 = (TextView)((View)localObject1).findViewById(2131303877);
      localProgressBar = (ProgressBar)((View)localObject1).findViewById(2131303875);
      str = parambiou.b(paramInt2);
      localObject1 = parambiou.a(paramInt2);
      if (localObject1 != null) {
        break label146;
      }
      urk.e("LocationFaceAdapter", "FacePackage's thumbUri is empty , pkg : %s", new Object[] { parambiou.toString() });
    }
    for (;;)
    {
      paramInt2 += 1;
    ...
    Object localObject2 = new bipp((String)localObject1, localURLImageView, localProgressBar);
    ...
    if (((URLDrawable)localObject1).getStatus() == 1) {
      ((bipp)localObject2).onLoadSuccessed(localURLImageView, (URLDrawable)localObject1);
    }
    if (paramBoolean) {}
    for (;;)
    {
