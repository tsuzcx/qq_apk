...
{
  public int a;
  BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new bhuc(this);
  public String a;
  ...
  private int a(int paramInt)
  {
    ...
    if ((localbccw instanceof bcdq)) {
      i = ((bcdq)localbccw).switchRequestCode(this, (byte)paramInt);
    }
    return i;
  }
  ...
  private void a(int paramInt)
  {
    ...
    do
    {
      ...
      for (int i = 1; i != 0; i = 0)
      {
        bcql.a(this.mRuntime.a(), 2131718263, 0).b(j);
        return;
      }
      a();
      switch (paramInt)
      ...
      case 1: 
        ...
        localbgyw.jdField_a_of_type_JavaLangString = this.mRuntime.a().getCurrentAccountUin();
        BaseBusinessAlbumInfo localBaseBusinessAlbumInfo = new BaseBusinessAlbumInfo();
        localBaseBusinessAlbumInfo.jdField_a_of_type_JavaLangString = localbgyw.jdField_a_of_type_JavaLangString;
        ...
        localBaseBusinessAlbumInfo.jdField_b_of_type_JavaLangString = this.mRuntime.a().getString(2131717755);
        bgyp.b(this.mRuntime.a(), localbgyw, localBaseBusinessAlbumInfo, -1, "cover_mall_record_video");
        return;
      }
      QLog.i("CoverStore", 1, "VIDEO_COVER click select record video.");
    } while (!bhpj.a(this.mRuntime.a(), new bhua(this, j), 1));
    b(j);
  }
      ...
      do
      {
        do
        {
          ...
          for (;;)
          {
            ...
            Object localObject = bhsc.a(str);
            if (localObject == null) {
              break;
            }
            double d1 = bhsc.a((bhsf)localObject);
            if (d1 > 0.0D)
            {
            ...
            localObject = bhsc.a(str, ((bhsf)localObject).jdField_a_of_type_Int, ((bhsf)localObject).jdField_b_of_type_Int);
  ...
  private void a(String paramString)
  {
    ...
    ((bgyw)localObject).jdField_a_of_type_JavaLangString = this.mRuntime.a().getAccount();
    paramString.putString("keyAction", "actionSelectPicture");
    paramString.putBoolean("key_need_change_to_jpg", false);
    bgyp.a(this.mRuntime.a(), (bgyw)localObject, paramString, a(3));
  }
    ...
    for (;;)
    {
      ...
      try
      {
        if (i < paramArrayList.size())
        {
          ...
          Object localObject2 = bhsc.a((String)localObject1);
          if (localObject2 == null) {
            break label335;
          }
          double d1 = bhsc.a((bhsf)localObject2);
          if (d1 > 0.0D)
          {
            ((bhsf)localObject2).jdField_a_of_type_Int = ((int)(((bhsf)localObject2).jdField_a_of_type_Int / d1));
            ((bhsf)localObject2).jdField_b_of_type_Int = ((int)(((bhsf)localObject2).jdField_b_of_type_Int / d1));
          }
          localObject2 = bhsc.a((String)localObject1, ((bhsf)localObject2).jdField_a_of_type_Int, ((bhsf)localObject2).jdField_b_of_type_Int);
          ...
          axqn.a(BaseApplication.getContext()).reportTimeKVEvent("Qzone.EventTransformPhotoBase64", (Properties)localObject1, (int)(l2 - l1));
        }
      }
  ...
  {
    bgzt.a(this.mRuntime.a().getLongAccountUin(), this.mRuntime.a(), "cover_mall_record_video", new bhub(this, paramInt));
  }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if (paramString3.equals("showStoreButton"))
    {
      ...
      paramJsBridgeListener = (TextView)this.mRuntime.a().findViewById(2131368457);
      if (paramJsBridgeListener != null)
      {
        paramJsBridgeListener.setVisibility(0);
        paramJsBridgeListener.setTextColor(-1);
        paramJsBridgeListener.setText(ajya.a(2131711640));
        paramJsBridgeListener.setOnClickListener(new bhtz(this));
      }
    }
    label810:
    do
    {
      for (;;)
      {
        ...
        else if (paramString3.equals("openYellowDiamond"))
        {
          ...
          paramString2 = ajya.a(2131711638);
      ...
      if (paramString3.equals("leftButtonClick"))
      {
        ...
        ((TextView)this.mRuntime.a().findViewById(2131368429)).performClick();
        return true;
      }
