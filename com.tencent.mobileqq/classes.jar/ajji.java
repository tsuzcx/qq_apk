...
public class ajji
{
  ...
  private static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3)
  {
    ...
    localMessageForText.msg = String.format(anzj.a(2131700866), new Object[] { paramString1, paramString3, paramString2 });
    localMessageForText.time = bcrg.a();
    paramQQAppInterface.a().a(localMessageForText, paramQQAppInterface.c());
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, SubMsgType0x87.MsgBody paramMsgBody)
  {
    ...
    for (;;)
    {
      ...
      break label172;
      label308:
      localObject2 = str2 + (String)localObject1 + paramQQAppInterface.c();
  ...
  private static void b(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt)
  {
    ...
    Object localObject1 = anzj.a(2131700869);
    String str1 = String.format("%s(%s)", new Object[] { paramString2, paramString1 });
    Object localObject2 = anzj.a(2131700867);
    if (paramInt == 1) {}
    for (paramString2 = anzj.a(2131700861);; paramString2 = anzj.a(2131700864))
    {
      ...
      paramString2 = anzj.a(2131700865);
      paramString4 = anzj.a(2131700862);
      localObject2 = new avpd(paramString3, paramString3, (String)localObject1 + str1 + str2 + str3 + "的好友列表中。\n不想和他们是好友关系，可选择" + paramString2 + "。\n不想再被其他好友克隆，可选择" + paramString4 + "。", 0, -5040, 2686977, bcrg.a());
      ...
      ((avpd)localObject2).a(paramInt, str1.length() + paramInt, localBundle);
      ...
      ((avpd)localObject2).a(paramInt, str3.length() + paramInt, (Bundle)localObject1);
      paramString3 = new Bundle();
      paramString3.putInt("key_action", 45);
      paramString3.putString("key_action_DATA", paramString1);
      paramString3.putString("key_a_action_DATA", String.format(anzj.a(2131700868), new Object[] { str1, str3 }));
      paramInt = paramInt + str3.length() + "的好友列表中。\n不想和他们是好友关系，可选择".length();
      ((avpd)localObject2).a(paramInt, paramString2.length() + paramInt, paramString3);
      ...
      ((avpd)localObject2).a(paramInt, paramString4.length() + paramInt, paramString1);
      localMessageForUniteGrayTip.initGrayTipMsg(paramQQAppInterface, (avpd)localObject2);
  ...
  {
    MessageForUniteGrayTip localMessageForUniteGrayTip = new MessageForUniteGrayTip();
    localMessageForUniteGrayTip.initGrayTipMsg(paramQQAppInterface, new avpd(paramString, paramString, anzj.a(2131700863), 0, -5020, 2686977, bcrg.a()));
    avpe.a(paramQQAppInterface, localMessageForUniteGrayTip);
  }
}
