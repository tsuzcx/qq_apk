  ...
  extends BaseAdapter
{
  ...
  {
    paramView = this.a.jdField_a_of_type_Abbk.a(paramInt, getCount(), (ChatMessage)this.a.jdField_a_of_type_JavaUtilList.get(paramInt), paramView, paramViewGroup, null);
    paramViewGroup = (aece)paramView.getTag();
