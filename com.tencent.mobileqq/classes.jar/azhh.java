...
{
  public azhh(Bundle paramBundle, int paramInt1, int paramInt2, Activity paramActivity) {}
  ...
  public void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    ...
    case 0: 
      ...
      for (;;)
      {
        axqw.b(null, "dc00899", "Grp_tribe", "", paramDialogInterface, str1, paramInt, 0, str2, "", "", "");
        return;
        if ("0".endsWith(str2)) {}
