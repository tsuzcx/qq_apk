...
public class wls
  extends AsyncTask<wlu, wlw, wlv>
{
  public final way a;
  
  public wls(way paramway)
  {
    if (paramway == null) {
  ...
  public static String a(String paramString)
  {
    ...
    //   57: ldc 50
    //   59: ldc 52
    //   61: invokestatic 57	ykq:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   64: aload_3
    //   65: astore_0
    //   66: aload_2
    //   67: ifnull +9 -> 76
    ...
    //   85: invokestatic 67	wls:a	([B)Ljava/lang/String;
    //   88: astore 4
    //   90: aload 4
    //   92: astore_3
    //   93: aload_3
  ...
  {
    ykq.b("FileDownloadTask", paramString);
  }
  ...
  public static boolean a(String paramString1, String paramString2)
  {
    ...
    ykq.b("FileDownloadTask", "expectedMd5 = " + paramString2);
    ykq.b("FileDownloadTask", "file Md5    = " + paramString1);
  ...
  protected wlv a(wlu... paramVarArgs)
  {
    ...
    if (a(paramVarArgs.b, paramVarArgs.c))
    {
      ...
      return new wlv(paramVarArgs, 0, "has local file already");
    }
    this.a.a(new wlt(this, paramVarArgs));
    ...
    if ((i == 0) && (!a(paramVarArgs.b, paramVarArgs.c)))
    {
      ...
      try
      {
        zeb.d(paramVarArgs.b);
        return new wlv(paramVarArgs, -1, "file md5 mismatch");
      }
    ...
    return new wlv(paramVarArgs, i, "error=" + i);
  }
}
