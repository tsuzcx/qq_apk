  ...
  extends WebViewPlugin
{
  ...
  public long a;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new arhi(this);
  protected Context a;
  private Handler jdField_a_of_type_AndroidOsHandler = new arhg(this, Looper.getMainLooper());
  private arek jdField_a_of_type_Arek;
  ...
  private void a(long paramLong, String paramString)
  {
    ...
    this.jdField_a_of_type_Argm.a(str + "/av_" + System.currentTimeMillis() + this.jdField_a_of_type_Argm.a(), new arhf(this));
    ...
    catch (JSONException paramString2)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          argq.a(paramString2, this.e, String.valueOf(this.jdField_a_of_type_Long), this.jdField_a_of_type_JavaLangString, str1, (String)localObject1, String.valueOf(this.jdField_b_of_type_Long), this.jdField_b_of_type_JavaLangString, new arhh(this, paramLong, paramString1));
          return;
  ...
  {
    int i = this.jdField_a_of_type_Argm.c();
  ...
  {
    arhj.a.jdField_a_of_type_Int = -1;
    if (paramString == null) {
      return;
    }
    JSONObject localJSONObject = new JSONObject();
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          catch (Exception paramJsBridgeListener)
          {
            ...
            {
              bbkb.b(this.mRuntime.a().getApp().getApplicationContext());
              arhj.a.a(this.mRuntime.a(), paramString1.getQueryParameter("p"));
              a(this.d, 0);
            ...
            {
              arhj.a.b(this.mRuntime.a(), paramString1.getQueryParameter("p"));
              this.d = paramJsBridgeListener;
              if (arhj.a.jdField_a_of_type_Int != -1)
              {
                a(this.d, arhj.a.jdField_a_of_type_Int);
                return false;
              }
              arhj.a.a(this.mRuntime.a(), new arhe(this));
              return false;
            }
          }
        }
    ...
    arhj.a.jdField_a_of_type_Boolean = false;
    arhj.a.a(11, null);
    return false;
  }
  ...
  public void onCreate()
  {
    ...
    a(" onCreate");
    this.jdField_a_of_type_Argm = new argm(this.jdField_a_of_type_AndroidContentContext, 1);
    this.jdField_a_of_type_Arek = new arek();
    ...
    IntentFilter localIntentFilter = new IntentFilter(arfy.a(this.f));
    localIntentFilter.addAction(arfy.b(this.f));
    localIntentFilter.addAction(arfy.c(this.f));
    localIntentFilter.addAction(arfy.d(this.f));
