  ...
  extends Animation
{
  ...
  public bcqj(float paramFloat1, float paramFloat2, boolean paramBoolean, int paramInt)
  {
  ...
  {
    int i = 1;
    if (this.jdField_a_of_type_Bcqk != null) {
      this.jdField_a_of_type_Bcqk.a(paramFloat);
    }
    float f1;
    float f2;
