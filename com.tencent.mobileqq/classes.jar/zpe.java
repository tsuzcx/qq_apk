...
public class zpe
  implements Runnable
{
  public zpe(BaseMessageManagerForTroopAndDisc paramBaseMessageManagerForTroopAndDisc, QQMessageFacade.RefreshMessageContext paramRefreshMessageContext, String paramString, int paramInt, long paramLong, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    for (int i = (int)localChatMessage.shmsgseq;; i = 0)
    {
      ...
      for (boolean bool = true; (j == i) || (i <= this.jdField_a_of_type_Long); bool = false)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppMessageBaseMessageManagerForTroopAndDisc.a.a.post(new zpf(this));
        return;
      }
