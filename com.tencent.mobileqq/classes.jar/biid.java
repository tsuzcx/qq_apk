  ...
  extends QIMEffectCameraCaptureUnit
{
  ...
  public biid(bjrl parambjrl, bjrk parambjrk)
  {
    super(parambjrl, parambjrk);
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new biie(this);
    this.jdField_a_of_type_Bjrd = new bjrd(10007, 7, 6);
  ...
  public static Bundle a(boolean paramBoolean1, boolean paramBoolean2, int paramInt1, boolean paramBoolean3, boolean paramBoolean4, boolean paramBoolean5, String paramString1, String paramString2, boolean paramBoolean6, boolean paramBoolean7, String paramString3, String paramString4, int paramInt2, String paramString5, String paramString6, String paramString7, String paramString8, String paramString9, String paramString10, String paramString11, biic parambiic)
  {
    ...
    if (parambiic != null)
    {
      localBundle.putBoolean("arg_support_combo", parambiic.jdField_a_of_type_Boolean);
      localBundle.putBoolean("arg_unfold_combo", parambiic.jdField_b_of_type_Boolean);
      localBundle.putString("arg_combo_name", parambiic.jdField_c_of_type_JavaLangString);
      localBundle.putString("arg_combo_id", parambiic.jdField_d_of_type_JavaLangString);
      localBundle.putBoolean("arg_support_music", parambiic.jdField_c_of_type_Boolean);
      localBundle.putBoolean("arg_unfold_music", parambiic.jdField_d_of_type_Boolean);
      localBundle.putString("arg_music_name", parambiic.g);
      localBundle.putString("arg_music_id", parambiic.h);
    }
  ...
  public View a()
  {
    ...
    if ((this.B) && (!this.C))
    {
      ...
      this.f = this.jdField_a_of_type_Bjrl.a().getIntent().getIntExtra("videoId", 0);
      if (this.f == 0) {
        break label103;
      }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    for (paramInt1 = 15;; paramInt1 = 32)
    {
      ...
      biig.a(localActivity, (SessionInfo)localObject, localPublishParam, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView$VideoCaptureResult, paramIntent, null);
  ...
  {
    super.a(paramBundle);
    this.g = this.jdField_a_of_type_Bjrl.a().getIntent().getIntExtra("type", 1);
    this.h = this.jdField_a_of_type_Bjrl.a().getIntent().getIntExtra("WebSceneType", ahty.jdField_d_of_type_Int);
    paramBundle = new IntentFilter();
    paramBundle.addAction("tencent.video.q2v.startUploadPTV");
    this.jdField_a_of_type_Bjrl.a().registerReceiver(this.jdField_a_of_type_AndroidContentBroadcastReceiver, paramBundle);
  }
  
  public void a(avuo paramavuo)
  {
    super.a(paramavuo);
    bjre localbjre = new bjrg(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView.a()).a(3).a();
    localbjre.jdField_a_of_type_Int = this.jdField_j_of_type_Int;
    localbjre.jdField_a_of_type_JavaLangString = this.jdField_q_of_type_JavaLangString;
  ...
  public void a(CameraCaptureView.VideoCaptureResult paramVideoCaptureResult, LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    Object localObject = new bjrj().b(3).a();
    if (this.jdField_j_of_type_Int == jdField_d_of_type_Int)
    {
      ((bjrh)localObject).i = true;
      ((bjrh)localObject).jdField_a_of_type_JavaLangString = this.jdField_q_of_type_JavaLangString;
    }
    ((bjrh)localObject).jdField_a_of_type_Int = this.g;
    ((bjrh)localObject).jdField_b_of_type_Int = this.h;
    ((bjrh)localObject).jdField_b_of_type_JavaLangString = this.jdField_a_of_type_Bjrl.a().getIntent().getStringExtra("succUrl");
    ((bjrh)localObject).jdField_c_of_type_JavaLangString = this.jdField_a_of_type_Bjrl.a().getIntent().getStringExtra("failedUrl");
    this.jdField_a_of_type_Bjrd.a((bjrh)localObject);
    a(paramLocalMediaInfo);
    localObject = new bkuu();
    if (this.h == ahty.jdField_b_of_type_Int)
    {
      ...
      {
        ((bkuu)localObject).jdField_a_of_type_Int = this.jdField_c_of_type_Int;
        ((bkuu)localObject).jdField_a_of_type_JavaLangString = this.jdField_c_of_type_JavaLangString;
        ((bkuu)localObject).g = this.jdField_e_of_type_JavaLangString;
        ((bkuu)localObject).f = this.jdField_d_of_type_JavaLangString;
        ((bkuu)localObject).jdField_b_of_type_JavaLangString = (localPtvTemplateInfo.categoryId + "");
        ((bkuu)localObject).jdField_c_of_type_JavaLangString = localPtvTemplateInfo.id;
        ((bkuu)localObject).jdField_a_of_type_Boolean = true;
        if (localPtvTemplateInfo.kind != 8) {
          break label387;
        }
        bool1 = true;
        ((bkuu)localObject).jdField_b_of_type_Boolean = bool1;
        if (localPtvTemplateInfo.kind != 9) {
          break label392;
        }
        bool1 = true;
        label324:
        ((bkuu)localObject).jdField_c_of_type_Boolean = bool1;
    ...
    {
      ((bkuu)localObject).jdField_d_of_type_Boolean = bool1;
      ((bkuu)localObject).jdField_b_of_type_Int = this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewEffectsCameraCaptureView.e();
      bkvh.a(this.jdField_a_of_type_Bjrl.a(), paramVideoCaptureResult, paramLocalMediaInfo, this.jdField_a_of_type_Bjrd, this.jdField_a_of_type_AndroidOsBundle, 5, (bkuu)localObject);
      return;
      bool1 = false;
      break;
      bool1 = false;
