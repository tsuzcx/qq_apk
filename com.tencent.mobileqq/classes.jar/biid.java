  ...
  extends biic
{
  ...
  private void a(OrderCheckResult paramOrderCheckResult)
  {
    ...
    aokv localaokv = (aokv)((QQAppInterface)localObject).a(27);
    boolean bool1;
    label113:
    long l;
    if (paramOrderCheckResult.operator == 1)
    {
      ...
      bool1 = true;
      localaokv.a(str1, str2, bool1, paramOrderCheckResult.product, "");
    ...
    for (;;)
    {
      ...
      localaokv.a(((TicketManager)((QQAppInterface)localObject).getManager(2)).getSkey(str1), str1);
      return;
      label186:
  ...
  {
    ThreadManager.post(new KCWraperV2.2(this, parambiin, paramBoolean), 5, null, false);
  }
  ...
  void a(Runnable paramRunnable)
  {
    ...
    File localFile = new File(biim.a().a(localContext));
    if (!localFile.exists())
    {
  ...
  boolean a()
  {
    ...
    if (!new File(biim.a().a(BaseApplicationImpl.getApplication())).exists()) {
      return false;
    }
    synchronized (this.a)
    {
