  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2, String paramString)
  {
    ...
    do
    {
      ...
      if (this.a.jdField_a_of_type_Azwj != null)
      {
        ...
        {
          this.a.jdField_a_of_type_Azwj.onDecodeTaskCompleted(this.a.b + this.a.jdField_a_of_type_JavaUtilLinkedList.size(), 113, paramString, localBitmap);
