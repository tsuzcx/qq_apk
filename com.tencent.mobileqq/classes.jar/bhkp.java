  ...
  implements Manager
{
  ...
  public static HashMap<String, bhkt> a;
  public static String[] a;
  bhhe jdField_a_of_type_Bhhe = new bhkq(this);
  ...
  static
  {
    ...
    jdField_a_of_type_JavaLangString = anhk.ba + "voiceChange/";
    jdField_a_of_type_ArrayOfJavaLangString = new String[] { null, null, null };
  }
  
  public bhkp(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a(int paramInt1, String paramString1, String paramString2, int paramInt2, int paramInt3)
  {
    ...
    //   12: istore_0
    //   13: getstatic 24	bhkp:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   16: aload_1
    //   17: invokevirtual 75	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   20: checkcast 77	bhkt
    //   23: astore 7
    //   25: aload 7
    //   27: ifnull +88 -> 115
    //   30: aload 7
    //   32: getfield 80	bhkt:jdField_a_of_type_Bhku	Lbhku;
    //   35: ifnull +84 -> 119
    //   38: aload_1
    //   39: aload_2
    //   40: iload_3
    //   41: invokestatic 85	bhkv:a	(Ljava/lang/String;Ljava/lang/String;I)V
    //   44: aload 7
    //   46: getfield 80	bhkt:jdField_a_of_type_Bhku	Lbhku;
    //   49: aload_1
    //   50: iload 4
    //   52: iload_0
    ...
    //   107: getstatic 24	bhkp:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   110: aload_1
    ...
    //   119: aload 7
    //   121: iconst_1
    //   122: putfield 117	bhkt:jdField_a_of_type_Boolean	Z
    //   125: aload 7
    //   127: iload_0
    //   128: putfield 120	bhkt:jdField_a_of_type_Int	I
    //   131: goto -16 -> 115
    //   134: astore_1
    //   135: ldc 2
    //   137: monitorexit
  ...
  public static void a(Context paramContext, bhkm parambhkm, String paramString, bhkl parambhkl)
  {
    if ((bhkt)jdField_a_of_type_JavaUtilHashMap.get(parambhkm.jdField_a_of_type_JavaLangString) == null) {
      b(paramContext, parambhkm, paramString, parambhkl);
    }
    ((bhkt)jdField_a_of_type_JavaUtilHashMap.get(parambhkm.jdField_a_of_type_JavaLangString)).jdField_a_of_type_ComTencentMobileqqVoicechangeQQVoiceChangerThread.c();
  }
  
  public static void a(Context paramContext, bhkm parambhkm, String paramString, bhkl parambhkl, bhkr parambhkr)
  {
    bhkt localbhkt = (bhkt)jdField_a_of_type_JavaUtilHashMap.get(parambhkm.jdField_a_of_type_JavaLangString);
    if (localbhkt != null) {
      localbhkt.jdField_a_of_type_ComTencentMobileqqVoicechangeQQVoiceChangerThread.jdField_a_of_type_Boolean = false;
    }
    localbhkt = new bhkt();
    localbhkt.jdField_a_of_type_Bhkm = parambhkm;
    localbhkt.jdField_a_of_type_Bhkr = parambhkr;
    localbhkt.jdField_a_of_type_ComTencentMobileqqVoicechangeQQVoiceChangerThread = new QQVoiceChangerThread(paramContext, parambhkm, parambhkr, paramString, parambhkl);
    jdField_a_of_type_JavaUtilHashMap.put(parambhkm.jdField_a_of_type_JavaLangString, localbhkt);
    localbhkt.jdField_a_of_type_ComTencentMobileqqVoicechangeQQVoiceChangerThread.start();
  }
  
  public static void a(bhkm parambhkm)
  {
    bhkt localbhkt = (bhkt)jdField_a_of_type_JavaUtilHashMap.get(parambhkm.jdField_a_of_type_JavaLangString);
    if (localbhkt != null)
    {
      localbhkt.jdField_a_of_type_ComTencentMobileqqVoicechangeQQVoiceChangerThread.d();
      jdField_a_of_type_JavaUtilHashMap.remove(parambhkm.jdField_a_of_type_JavaLangString);
    }
  }
  
  public static boolean a(String paramString, bhku parambhku)
  {
    for (;;)
    {
      try
      {
        ...
        bhkt localbhkt = (bhkt)jdField_a_of_type_JavaUtilHashMap.get(paramString);
        if (localbhkt == null)
        {
          if (QLog.isColorLevel()) {
        ...
        if (localbhkt.jdField_a_of_type_Boolean)
        {
          bhkv.a(paramString, localbhkt.jdField_a_of_type_Bhkm.jdField_a_of_type_JavaLangString, localbhkt.jdField_a_of_type_Bhkm.f);
          jdField_a_of_type_JavaUtilHashMap.remove(paramString);
          parambhku.a(paramString, localbhkt.jdField_a_of_type_Bhkm.e, localbhkt.jdField_a_of_type_Int);
          if (QLog.isColorLevel()) {
            QLog.d("VoiceChangeManager", 2, "queryStateByPath onCompressFinished filePath=" + paramString + " time=" + localbhkt.jdField_a_of_type_Int + " voiceType=" + localbhkt.jdField_a_of_type_Bhkm.e);
          }
        }
        else
        {
          localbhkt.jdField_a_of_type_Bhku = parambhku;
        }
      }
      finally {}
      boolean bool = true;
  ...
  public static void b(Context paramContext, bhkm parambhkm, String paramString, bhkl parambhkl)
  {
    a(paramContext, parambhkm, paramString, parambhkl, bhkr.a());
  }
  
  public static void b(bhkm parambhkm)
  {
    bhkt localbhkt = (bhkt)jdField_a_of_type_JavaUtilHashMap.get(parambhkm.jdField_a_of_type_JavaLangString);
    if (localbhkt != null)
    {
  ...
  public boolean a(ArrayList<bhkn> paramArrayList, JSONObject paramJSONObject)
  {
    boolean bool = bhjt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), "VoiceChangeManager", false);
    if (!bool)
    {
      ...
      if (i < arrayOfInt.length)
      {
        if (arrayOfInt[i] == j)
        {
          ...
          if (i < 0)
          {
            ...
            break label1363;
            this.jdField_a_of_type_Bhhe.onDone(null);
            return true;
          }
        }
        else
        ...
        paramJSONObject = (bhkn)paramArrayList.get(i);
        label687:
        if (paramJSONObject == null)
        {
          if (!QLog.isColorLevel()) {
        ...
        if (j != 0)
        {
          ...
          {
            i = j;
            if (bgyd.a(((JSONObject)localObject2).getString("QQVersion"), "8.4.1"))
            {
              j = 0;
              i = j;
              if (QLog.isColorLevel())
        ...
        for (localObject2 = paramJSONObject.jdField_b_of_type_JavaLangString;; localObject2 = ((JSONObject)localObject4).getString("description"))
        {
          ...
          paramJSONObject.jdField_a_of_type_Bhko.jdField_a_of_type_JavaLangString = ((String)localObject3);
          break label1363;
          localObject3 = bgwh.jdField_b_of_type_JavaLangString + (String)localObject3;
      ...
      for (;;)
      {
        if (i < paramJSONObject.length)
        {
          ...
          if (localObject1 != null)
          {
            ...
            {
              localObject1 = bgwh.jdField_b_of_type_JavaLangString + (String)localObject1;
