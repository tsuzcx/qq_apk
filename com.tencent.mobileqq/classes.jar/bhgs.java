  ...
  implements Handler.Callback, IEventReceiver
{
  ...
  public HashMap<String, bhhk> b;
  public Handler c;
  public ArrayList<QIMFilterCategoryItem> c;
  public HashMap<String, bhgp> c;
  public ArrayList<QIMFilterCategoryItem> d;
  public HashMap<String, bhhr> d;
  ArrayList<bhgv> e;
  public HashMap<String, ArrayList<bhgx>> e;
  ...
  public bhgs()
  {
    ...
    this.jdField_b_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper(), new bhgu(this));
    ...
    this.jdField_a_of_type_ArrayOfBhgw = new bhgw[5];
    int i = 0;
    while (i < this.jdField_a_of_type_ArrayOfBhgw.length)
    {
      this.jdField_a_of_type_ArrayOfBhgw[i] = new bhgw(i);
      i += 1;
    }
    this.jdField_b_of_type_Int = 0;
    this.jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper(), new bhgt(this));
  ...
  {
    bhhh localbhhh = bjac.a().a[paramInt];
    if (localbhhh != null) {
      localbhhh.a(paramActivity, paramInt);
    }
    bjac.a().a(null, paramActivity, paramInt);
  }
  ...
  {
    bhhb localbhhb = (bhhb)bhfm.a(15);
    bhhr localbhhr = localbhhb.a();
    if (localbhhr != null)
    {
      localbhhr.a(paramActivity, paramInt);
      if (paramInt == 0) {
        localbhhb.a(null);
      }
    }
  ...
  public bhgp a(FilterDesc paramFilterDesc)
  {
    bhgp localbhgp2 = (bhgp)this.jdField_c_of_type_JavaUtilHashMap.get(paramFilterDesc.name);
    bhgp localbhgp1 = localbhgp2;
    if (localbhgp2 == null)
    {
      localbhgp1 = new bhgp(paramFilterDesc);
      this.jdField_c_of_type_JavaUtilHashMap.put(paramFilterDesc.name, localbhgp1);
    }
    return localbhgp1;
  }
  
  public bhgw a(int paramInt)
  {
    return this.jdField_a_of_type_ArrayOfBhgw[paramInt];
  }
  
  public bhhh a(QIMFilterCategoryItem paramQIMFilterCategoryItem)
  {
    bhhh localbhhh2 = (bhhh)this.jdField_a_of_type_JavaUtilHashMap.get(paramQIMFilterCategoryItem.jdField_a_of_type_JavaLangString);
    Object localObject1 = localbhhh2;
    Object localObject2;
    Object localObject3;
    int j;
    int i;
    ...
    if (localbhhh2 == null)
    {
      localbhhh2 = new bhhh(paramQIMFilterCategoryItem);
      localObject1 = paramQIMFilterCategoryItem.jdField_a_of_type_JavaUtilArrayList.iterator();
      while (((Iterator)localObject1).hasNext())
      {
        localObject2 = (String)((Iterator)localObject1).next();
        localObject3 = bjac.a().a((String)localObject2);
        if (localObject3 != null) {
          localbhhh2.c(a((FilterDesc)localObject3));
        ...
        if (k < n)
        {
          ...
          for (;;)
          {
            try
            {
              ...
              localObject3 = bhjy.a(paramQIMFilterCategoryItem.jdField_a_of_type_JavaLangString, (String)localObject4, (String)localObject1, f1, f2, f3);
              if (localObject3 != null)
              {
                ((bhgn)localObject3).a((SegmentKeeper)localObject2);
                localbhhh2.c((bhgn)localObject3);
                k += 1;
                break;
              }
              m = 1;
      ...
      if (paramQIMFilterCategoryItem.jdField_b_of_type_OrgJsonJSONArray != null)
      {
        ...
        if (m < i1)
        {
          ...
          try
          {
            ...
            k = i;
            localObject3 = bhjy.a((String)localObject2);
            if (localObject3 != null)
            {
              k = i;
              localbhhh2.c((bhgn)localObject3);
      ...
      if (paramQIMFilterCategoryItem.c != null)
      {
        ...
        if (m < i1)
        {
          ...
          try
          {
            ...
            k = j;
            localObject3 = bhjy.b((String)localObject2);
            if (localObject3 != null)
            {
              k = j;
              localbhhh2.c((bhgn)localObject3);
      ...
      else
      {
        for (;;)
        {
          try
          {
            ...
            j = i;
            localObject2 = bhjy.a(str3, (List)localObject3, f1, f2, f3);
            if (localObject2 != null)
            {
              j = i;
              ((bhgn)localObject2).a((SegmentKeeper)localObject4);
              j = i;
              localbhhh2.c((bhgn)localObject2);
              k = i;
            }
            else
            {
          ...
          if (j == 0) {
            this.jdField_a_of_type_JavaUtilHashMap.put(paramQIMFilterCategoryItem.jdField_a_of_type_JavaLangString, localbhhh2);
          }
          bhhh localbhhh1 = localbhhh2;
          localbhhh1.jdField_a_of_type_JavaLangObject = paramQIMFilterCategoryItem;
          return localbhhh1;
          label1280:
          break;
          label1283:
  ...
  public bhhh a(QIMFilterCategoryItem paramQIMFilterCategoryItem, Activity paramActivity, Bundle paramBundle)
  {
    bhgs localbhgs = (bhgs)bhfm.a(5);
    bhhh localbhhh = localbhgs.a(paramQIMFilterCategoryItem);
    localbhhh.b(paramActivity, paramBundle.getInt("capture_scene", -1));
    localbhhh.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
    localbhgs.a(paramQIMFilterCategoryItem);
    switch (localbhhh.jdField_a_of_type_Int)
    {
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
        QLog.i("QCombo", 2, "applyCombo state = " + localbhhh.jdField_a_of_type_Int);
      }
      return localbhhh;
      a(new bhgx(localbhhh, paramBundle, paramActivity));
      paramQIMFilterCategoryItem = Message.obtain(this.jdField_c_of_type_AndroidOsHandler, 7, 0, 0, localbhhh);
  ...
  public bhhh a(String paramString)
  {
    Object localObject1 = null;
    bhhh localbhhh = null;
    Object localObject2 = this.jdField_a_of_type_Bjad;
    if (localObject2 != null)
    {
      localObject2 = ((bjad)localObject2).a.jdField_a_of_type_JavaUtilArrayList.iterator();
      localObject1 = localbhhh;
      if (((Iterator)localObject2).hasNext())
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          if (TextUtils.equals(localQIMFilterCategoryItem.jdField_a_of_type_JavaLangString, paramString)) {
            localbhhh = a(localQIMFilterCategoryItem);
          }
        }
      }
    }
  ...
  public bhhk a(QIMFilterCategoryItem paramQIMFilterCategoryItem)
  {
    ...
    {
      localObject2 = (String)((Iterator)localObject1).next();
      localObject2 = bjac.a().a((String)localObject2);
      if (localObject2 != null) {
        localArrayList.add(localObject2);
      }
    }
    Object localObject2 = (bhhk)this.jdField_b_of_type_JavaUtilHashMap.get(paramQIMFilterCategoryItem.jdField_a_of_type_JavaLangString);
    localObject1 = localObject2;
    if (localObject2 == null)
    {
      localObject1 = new bhhk(paramQIMFilterCategoryItem);
      localObject2 = localArrayList.iterator();
      while (((Iterator)localObject2).hasNext()) {
        ((bhhk)localObject1).c(a((FilterDesc)((Iterator)localObject2).next()));
      }
  ...
  public bhhk a(String paramString)
  {
    Object localObject = this.jdField_a_of_type_Bjad;
    if (localObject != null)
    {
      localObject = ((bjad)localObject).a.jdField_c_of_type_JavaUtilArrayList.iterator();
  ...
  public bhhr a(QIMTemplateItem paramQIMTemplateItem)
  {
    Object localObject2 = (bhhr)this.jdField_d_of_type_JavaUtilHashMap.get(paramQIMTemplateItem.jdField_a_of_type_JavaLangString);
    ...
    if (localObject2 == null)
    {
      localObject1 = new bhhr(paramQIMTemplateItem);
      if (QLog.isColorLevel()) {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        localObject4 = bjac.a().a((String)localObject3);
        if (localObject4 != null) {
          ((bhhr)localObject1).d(a((FilterDesc)localObject4));
        } else if (QLog.isColorLevel()) {
      ...
      if (paramQIMTemplateItem.jdField_a_of_type_OrgJsonJSONArray != null)
      {
        ...
        if (i < j)
        {
          ...
          try
          {
            ...
            localObject4 = bhjy.a(paramQIMTemplateItem.jdField_a_of_type_JavaLangString, (String)localObject5, (String)localObject2, f1, f2, f3);
            if (localObject4 != null)
            {
              ((bhgn)localObject4).a((SegmentKeeper)localObject3);
              ((bhhr)localObject1).d((bhgn)localObject4);
            }
            else if (QLog.isColorLevel())
            {
      ...
      if (paramQIMTemplateItem.jdField_b_of_type_OrgJsonJSONArray != null)
      {
        ...
        if (i < j)
        {
          ...
          try
          {
            ...
            localObject4 = bhjy.a((String)localObject3);
            if (localObject4 != null) {
              ((bhhr)localObject1).d((bhgn)localObject4);
            } else if (QLog.isColorLevel()) {
      ...
      if (paramQIMTemplateItem.c != null)
      {
        ...
        if (i < j)
        {
          ...
          try
          {
            ...
            localObject4 = bhjy.b((String)localObject3);
            if (localObject4 != null) {
              ((bhhr)localObject1).d((bhgn)localObject4);
            } else if (QLog.isColorLevel()) {
      ...
      else
      {
        for (;;)
        {
          try
          {
            ...
            localObject3 = bhjy.a(str3, (List)localObject4, f1, f2, f3);
            if (localObject3 != null)
            {
              ((bhgn)localObject3).a((SegmentKeeper)localObject5);
              ((bhhr)localObject1).d((bhgn)localObject3);
            }
            else if (QLog.isColorLevel())
            {
          ...
          ((bhhr)localObject1).jdField_a_of_type_JavaLangObject = paramQIMTemplateItem;
          return localObject1;
          label1086:
          i += 1;
          break;
  ...
  public bhhr a(QIMTemplateItem paramQIMTemplateItem, Activity paramActivity, Bundle paramBundle)
  {
    paramQIMTemplateItem = ((bhgs)bhfm.a(5)).a(paramQIMTemplateItem);
    ...
    for (;;)
    {
      ...
      a(new bhgx(paramQIMTemplateItem, paramBundle, paramActivity));
  ...
  public bjae a()
  {
    if (this.jdField_a_of_type_Bjad != null) {
      return this.jdField_a_of_type_Bjad.a;
    }
    return null;
  }
  ...
  public QIMFilterCategoryItem a(int paramInt)
  {
    ...
    Object localObject1 = this.jdField_a_of_type_Bjad;
    if (localObject1 == null) {
      return null;
    }
    localObject1 = ((bjad)localObject1).a;
    if (localObject1 == null) {
      return null;
    }
    localObject1 = ((bjae)localObject1).jdField_a_of_type_JavaUtilArrayList;
    if (localObject1 != null)
    {
  ...
  public QIMFilterCategoryItem a(Activity paramActivity, bhdi parambhdi, int paramInt)
  {
    parambhdi = (ComboProviderView)paramActivity.findViewById(2131298326);
    if (parambhdi != null)
    {
      parambhdi.b();
      parambhdi = bhnz.a().a(parambhdi.g);
      if ((parambhdi != null) && (parambhdi.a() != null))
      {
        parambhdi.a().a();
        parambhdi.a().a();
        parambhdi.a().a();
    ...
    parambhdi = (StaticStickerProviderView)paramActivity.findViewById(2131298337);
    if (parambhdi != null) {
      parambhdi.b();
    }
    parambhdi = (QIMFilterProviderView)paramActivity.findViewById(2131298328);
    if (parambhdi != null) {
      parambhdi.b();
    }
    paramActivity = (MusicProviderView)paramActivity.findViewById(2131298336);
    if (paramActivity != null) {
      paramActivity.b();
    }
    return bjac.a().a(paramInt);
  }
  
  public QIMFilterCategoryItem a(bhhh parambhhh, ArrayList<QIMFilterCategoryItem> paramArrayList)
  {
    ...
    if (parambhhh != null)
    {
      ...
      if ((parambhhh.jdField_a_of_type_JavaLangObject instanceof QIMFilterCategoryItem))
      {
        localObject3 = (QIMFilterCategoryItem)parambhhh.jdField_a_of_type_JavaLangObject;
    ...
    label280:
    label283:
    for (localObject1 = null;; localObject1 = parambhhh)
    {
      if (localObject1 == null)
      {
        localObject3 = ((QIMFilterCategoryItem)localObject3).jdField_a_of_type_JavaUtilArrayList.iterator();
        parambhhh = (bhhh)localObject2;
        do
        {
          localObject2 = parambhhh;
        ...
        if (QQAVImageFilterConstants.getFilterType(((FilterDesc)localObject2).id) == 2)
        {
          ...
          {
            parambhhh = (QIMFilterCategoryItem)paramArrayList.next();
            if ((parambhhh.jdField_a_of_type_JavaUtilArrayList.size() == 1) && (parambhhh.jdField_a_of_type_JavaUtilArrayList.contains(((FilterDesc)localObject2).name)))
            {
              localObject1 = parambhhh;
              return localObject1;
              label176:
  ...
  public QIMFilterCategoryItem a(bhhr parambhhr, ArrayList<QIMFilterCategoryItem> paramArrayList)
  {
    Object localObject3 = null;
    Object localObject2 = null;
    Object localObject1 = localObject3;
    ...
    {
      localObject1 = localObject3;
      if ((parambhhr.jdField_a_of_type_JavaLangObject instanceof QIMTemplateItem))
      {
        localObject3 = (QIMTemplateItem)parambhhr.jdField_a_of_type_JavaLangObject;
    ...
    label280:
    label283:
    for (localObject1 = null;; localObject1 = parambhhr)
    {
      if (localObject1 == null)
      {
        localObject3 = ((QIMTemplateItem)localObject3).jdField_a_of_type_JavaUtilArrayList.iterator();
        parambhhr = (bhhr)localObject2;
        do
        {
          localObject2 = parambhhr;
          if (!((Iterator)localObject3).hasNext()) {
            break;
          }
          localObject2 = (String)((Iterator)localObject3).next();
        ...
        if (QQAVImageFilterConstants.getFilterType(((FilterDesc)localObject2).id) == 2)
        {
          ...
          while (paramArrayList.hasNext())
          {
            parambhhr = (QIMFilterCategoryItem)paramArrayList.next();
            if ((parambhhr.jdField_a_of_type_JavaUtilArrayList.size() == 1) && (parambhhr.jdField_a_of_type_JavaUtilArrayList.contains(((FilterDesc)localObject2).name)))
            {
              localObject1 = parambhhr;
              return localObject1;
              label176:
              Iterator localIterator1 = paramArrayList.iterator();
              parambhhr = null;
  ...
  public void a()
  {
    bjac.a().a(BaseApplicationImpl.getContext(), null, false);
  ...
  {
    Object localObject = bjac.a().a(paramInt);
    if (localObject != null)
    {
      localObject = a((QIMFilterCategoryItem)localObject);
      if ((localObject != null) && (((bhhh)localObject).jdField_a_of_type_Int == 1))
      {
        localObject = new Bundle();
        ((Bundle)localObject).putInt("capture_scene", paramInt);
        bhhh localbhhh = bjac.a().a[paramInt];
        if (localbhhh != null) {
          a((QIMFilterCategoryItem)localbhhh.jdField_a_of_type_JavaLangObject, paramActivity, (Bundle)localObject);
        }
        if (QLog.isColorLevel()) {
  ...
  {
    bhgw[] arrayOfbhgw = this.jdField_a_of_type_ArrayOfBhgw;
    int j = arrayOfbhgw.length;
    int i = 0;
    while (i < j)
    {
      arrayOfbhgw[i].c(paramActivity);
      i += 1;
    }
  }
  ...
  public void a(bhgv parambhgv)
  {
    ...
    {
      if (!this.jdField_e_of_type_JavaUtilArrayList.contains(parambhgv)) {
        this.jdField_e_of_type_JavaUtilArrayList.add(parambhgv);
      }
      return;
    }
  }
  
  public void a(bhgx parambhgx)
  {
    synchronized (this.jdField_e_of_type_JavaUtilHashMap)
    {
      String str = parambhgx.jdField_a_of_type_Bhha.b();
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("QCombo", 2, "downloadComboSuccess captureSet " + parambhha);
    }
    if ((parambhha.jdField_a_of_type_JavaLangObject instanceof QIMFilterCategoryItem)) {}
    synchronized (this.jdField_d_of_type_JavaUtilArrayList)
    {
      this.jdField_d_of_type_JavaUtilArrayList.add((QIMFilterCategoryItem)parambhha.jdField_a_of_type_JavaLangObject);
      this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(1);
      Message.obtain(this.jdField_c_of_type_AndroidOsHandler, 7, 0, 0, parambhha).sendToTarget();
      return;
    }
  }
  
  public void a(bhha parambhha, int paramInt)
  {
    if (QLog.isColorLevel()) {
      QLog.i("QCombo", 2, "downloadComboFailed captureset " + parambhha);
    }
    if ((parambhha.jdField_a_of_type_JavaLangObject instanceof QIMFilterCategoryItem)) {}
    synchronized (this.jdField_d_of_type_JavaUtilArrayList)
    {
      this.jdField_d_of_type_JavaUtilArrayList.add((QIMFilterCategoryItem)parambhha.jdField_a_of_type_JavaLangObject);
      this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(1);
      Message.obtain(this.jdField_c_of_type_AndroidOsHandler, 7, paramInt, 0, parambhha).sendToTarget();
      return;
    }
  }
  ...
  public void a(bhhh parambhhh)
  {
    ...
    while (localIterator.hasNext()) {
      ((bhgv)localIterator.next()).a(parambhhh);
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("QCombo", 2, "downloadTemplateSuccess templateSet " + parambhhr);
    }
    if ((parambhhr.jdField_a_of_type_JavaLangObject instanceof QIMTemplateItem)) {}
    synchronized (this.jdField_b_of_type_JavaUtilArrayList)
    {
      this.jdField_b_of_type_JavaUtilArrayList.add((QIMTemplateItem)parambhhr.jdField_a_of_type_JavaLangObject);
      this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(3);
      Message.obtain(this.jdField_c_of_type_AndroidOsHandler, 7, 0, 0, parambhhr).sendToTarget();
      return;
    }
  }
  
  public void a(bhhr parambhhr, int paramInt)
  {
    if (QLog.isColorLevel()) {
      QLog.i("QCombo", 2, "downloadTemplateFailed templateSet " + parambhhr + ", error " + paramInt);
    }
    if ((parambhhr.jdField_a_of_type_JavaLangObject instanceof QIMTemplateItem)) {}
    synchronized (this.jdField_b_of_type_JavaUtilArrayList)
    {
      this.jdField_b_of_type_JavaUtilArrayList.add((QIMTemplateItem)parambhhr.jdField_a_of_type_JavaLangObject);
      this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(3);
      Message.obtain(this.jdField_c_of_type_AndroidOsHandler, 7, paramInt, 0, parambhhr).sendToTarget();
      return;
    }
  }
  ...
  public void a(bjad parambjad)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (parambjad != null)
      {
        ...
        this.jdField_a_of_type_DovComQqImCaptureDataComboLockManager.a(parambjad);
        Message.obtain(this.jdField_c_of_type_AndroidOsHandler, 9, parambjad).sendToTarget();
      }
      a(1);
      return;
    }
  ...
  public void a(QIMFilterCategoryItem paramQIMFilterCategoryItem, Activity paramActivity, Bundle paramBundle)
  {
    ...
    QIMFilterCategoryItem localQIMFilterCategoryItem = bjac.a().b(i);
    boolean bool1;
    boolean bool2;
    ...
    for (;;)
    {
      ...
      break label58;
      label171:
      paramQIMFilterCategoryItem = ((bhgs)bhfm.a(5)).a(paramQIMFilterCategoryItem);
      ...
      while (QLog.isColorLevel())
      {
        ...
        return;
        a(new bhgx(paramQIMFilterCategoryItem, paramBundle, paramActivity));
        ...
        else
        {
          ...
          continue;
          a(new bhgx(paramQIMFilterCategoryItem, paramBundle, paramActivity));
          bhpu.a(paramQIMFilterCategoryItem).a();
  ...
  public boolean a()
  {
    for (;;)
    {
      ...
      synchronized (this.jdField_d_of_type_JavaUtilArrayList)
      {
        ...
        if (((bhha)???).jdField_a_of_type_Int == 1)
        {
          int j = ((bhha)???).a();
          if (j != ((bhha)???).jdField_a_of_type_Int)
          {
            if (QLog.isColorLevel()) {
              QLog.d("QCombo", 2, "buildComboBatch progress: " + localQIMFilterCategoryItem1.jdField_b_of_type_JavaLangString + ", progress: " + ((bhha)???).jdField_b_of_type_Int);
            }
            ((bhha)???).jdField_a_of_type_Int = j;
          }
          j = (int)(10000.0F * ((bhha)???).a());
          if (j != ((bhha)???).jdField_b_of_type_Int)
          {
            ((bhha)???).jdField_b_of_type_Int = j;
            if (QLog.isColorLevel()) {
              QLog.i("QCombo", 2, "buildComboBatch progress: " + j + ", progress: " + ((bhha)???).jdField_b_of_type_Int);
            }
          }
          bool = true;
          i -= 1;
      ...
      if (((bhha)???).jdField_a_of_type_Int == 2)
      {
        ((bhha)???).a();
        localQIMFilterCategoryItem2 = (QIMFilterCategoryItem)this.jdField_c_of_type_JavaUtilArrayList.remove(i);
        if (QLog.isColorLevel()) {
          QLog.i("QCombo", 2, "removeComboBatch: " + localQIMFilterCategoryItem2.jdField_b_of_type_JavaLangString + ",  STATE_NEED_DOWNLOAD progress: " + ((bhha)???).jdField_b_of_type_Int);
        }
        bool = true;
      }
      else if (((bhha)???).jdField_a_of_type_Int == 3)
      {
        ((bhha)???).a();
        ((bhha)???).jdField_b_of_type_Int = 10000;
        localQIMFilterCategoryItem2 = (QIMFilterCategoryItem)this.jdField_c_of_type_JavaUtilArrayList.remove(i);
        bhpu.a(???).b();
        Message.obtain(this.jdField_b_of_type_AndroidOsHandler, 2, ???).sendToTarget();
        if (QLog.isColorLevel()) {
          QLog.i("QCombo", 2, "removeComboBatch: " + localQIMFilterCategoryItem2.jdField_b_of_type_JavaLangString + ", STATE_DOWNLOADED progress: " + ((bhha)???).jdField_b_of_type_Int);
        }
        bool = true;
        continue;
        label470:
  ...
  public boolean a(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      label411:
      int j;
      if ((paramMessage.obj instanceof bhhk))
      {
        paramMessage = (bhhk)paramMessage.obj;
        if (i == 0)
        {
        ...
        else
        {
          for (;;)
          {
            ...
            localObject3 = (bhgx)((Iterator)localObject2).next();
            i = ((bhgx)localObject3).jdField_a_of_type_AndroidOsBundle.getInt("capture_scene", -1);
            ??? = bjac.a().b(i);
            if ((localObject1 != null) && (??? != null) && (TextUtils.equals(((QIMFilterCategoryItem)localObject1).jdField_a_of_type_JavaLangString, ((QIMFilterCategoryItem)???).jdField_a_of_type_JavaLangString)) && (!this.jdField_a_of_type_Boolean))
            {
              ...
              ((bhdr)bhfm.a(13)).a(((QIMFilterCategoryItem)???).jdField_a_of_type_JavaLangString);
              ??? = (Activity)((bhgx)localObject3).jdField_a_of_type_JavaLangRefWeakReference.get();
              if (??? != null)
              {
                ...
                synchronized (this.jdField_e_of_type_JavaUtilArrayList)
                {
                  ...
                  ((bhgv)((Iterator)???).next()).a(paramMessage, true, 0, ((bhgx)localObject3).jdField_a_of_type_AndroidOsBundle);
                }
                bhpu.a(paramMessage).c();
                break;
              }
            }
          }
          this.jdField_a_of_type_Bhhk = paramMessage;
          continue;
        }
        localObject2 = ((ArrayList)localObject2).iterator();
        while (((Iterator)localObject2).hasNext())
        {
          localObject3 = (bhgx)((Iterator)localObject2).next();
          j = ((bhgx)localObject3).jdField_a_of_type_AndroidOsBundle.getInt("capture_scene", -1);
          ??? = bjac.a().b(j);
          if ((localObject1 != null) && (??? != null) && (TextUtils.equals(((QIMFilterCategoryItem)localObject1).jdField_a_of_type_JavaLangString, ((QIMFilterCategoryItem)???).jdField_a_of_type_JavaLangString)))
          {
            ...
            ((bhdr)bhfm.a(13)).a(((QIMFilterCategoryItem)???).jdField_a_of_type_JavaLangString);
            if ((Activity)((bhgx)localObject3).jdField_a_of_type_JavaLangRefWeakReference.get() != null) {
              synchronized (this.jdField_e_of_type_JavaUtilArrayList)
              {
                ??? = this.jdField_e_of_type_JavaUtilArrayList.iterator();
                if (((Iterator)???).hasNext()) {
                  ((bhgv)((Iterator)???).next()).a(paramMessage, false, i, ((bhgx)localObject3).jdField_a_of_type_AndroidOsBundle);
                }
              }
            }
            bbmy.a(BaseApplicationImpl.sApplication, ajjy.a(2131635559), 0).a();
          }
        }
      }
      else if ((paramMessage.obj instanceof bhhh))
      {
        paramMessage = (bhhh)paramMessage.obj;
        if (i == 0)
        {
          bhpu.a(paramMessage).b();
          localObject1 = (QIMFilterCategoryItem)paramMessage.jdField_a_of_type_JavaLangObject;
        ...
        else
        {
          ...
          for (;;)
          {
            ...
            if (??? != null)
            {
              ...
              if ((??? != null) && (TextUtils.equals(((QIMFilterCategoryItem)???).jdField_a_of_type_JavaLangString, ((QIMFilterCategoryItem)localObject1).jdField_a_of_type_JavaLangString)))
              {
                ...
                ((bhdr)bhfm.a(13)).b(((QIMFilterCategoryItem)localObject1).jdField_a_of_type_JavaLangString);
                b((Activity)???, i);
                if (!bhgp.a(paramMessage, i)) {
                  paramMessage.a((Activity)???, i);
                }
                synchronized (this.jdField_e_of_type_JavaUtilArrayList)
                {
          ...
          label982:
          this.jdField_a_of_type_Bhhh = paramMessage;
          continue;
        }
        localObject2 = ((ArrayList)localObject3).iterator();
        while (((Iterator)localObject2).hasNext())
        {
          ...
          if ((??? != null) && (TextUtils.equals(((QIMFilterCategoryItem)???).jdField_a_of_type_JavaLangString, ((QIMFilterCategoryItem)localObject1).jdField_a_of_type_JavaLangString)))
          {
            ...
            if (??? != null)
            {
              ...
              ??? = (bhgs)bhfm.a(5);
              ??? = ((bhgs)???).jdField_a_of_type_Bhhh;
              if (??? != null) {
                ((bhgs)???).a((QIMFilterCategoryItem)((bhhh)???).jdField_a_of_type_JavaLangObject, (Activity)???, ((bhgx)localObject3).jdField_a_of_type_AndroidOsBundle);
              }
            }
            bbmy.a(BaseApplicationImpl.sApplication, ajjy.a(2131635561), 0).a();
          }
        }
      }
      else if ((paramMessage.obj instanceof bhhr))
      {
        localObject1 = (bhhb)bhfm.a(15);
        paramMessage = (bhhr)paramMessage.obj;
        if (i == 0)
        {
          bhpu.a(paramMessage).b();
        ...
        else
        {
          ...
          for (;;)
          {
            ...
            ??? = (bhgx)((Iterator)localObject3).next();
            ??? = (Activity)((bhgx)???).jdField_a_of_type_JavaLangRefWeakReference.get();
            if (??? != null)
            {
              i = ((bhgx)???).jdField_a_of_type_AndroidOsBundle.getInt("capture_scene", -1);
              ??? = ((bhhb)localObject1).a(i);
              if ((??? != null) && (TextUtils.equals(((QIMTemplateItem)???).jdField_a_of_type_JavaLangString, ((QIMTemplateItem)localObject2).jdField_a_of_type_JavaLangString)))
              {
                ...
                a((Activity)???, i);
                if (!((bhhb)localObject1).a(paramMessage, i)) {
                  paramMessage.a((Activity)???, i);
                }
                synchronized (this.jdField_e_of_type_JavaUtilArrayList)
                {
                  ...
                  ((bhgv)((Iterator)???).next()).a(paramMessage, true, 0, ((bhgx)???).jdField_a_of_type_AndroidOsBundle);
                }
                bhpu.a(paramMessage).c();
                break;
              }
          ...
          label1590:
          ((bhhb)localObject1).a(paramMessage);
          continue;
        }
        localObject3 = ((ArrayList)???).iterator();
        ...
        {
          ??? = (bhgx)((Iterator)localObject3).next();
          j = ((bhgx)???).jdField_a_of_type_AndroidOsBundle.getInt("capture_scene", -1);
          ??? = ((bhhb)localObject1).a(j);
          if ((??? != null) && (TextUtils.equals(((QIMTemplateItem)???).jdField_a_of_type_JavaLangString, ((QIMTemplateItem)localObject2).jdField_a_of_type_JavaLangString)))
          {
            if (QLog.isColorLevel()) {
            ...
            if (??? != null)
            {
              synchronized (this.jdField_e_of_type_JavaUtilArrayList)
              {
                ...
                if (((Iterator)localObject7).hasNext()) {
                  ((bhgv)((Iterator)localObject7).next()).a(paramMessage, false, i, ((bhgx)???).jdField_a_of_type_AndroidOsBundle);
                }
              }
              ??? = ((bhhb)localObject1).a();
              Object localObject7 = (bhgs)bhfm.a(5);
              if (??? != null) {
                ((bhgs)localObject7).a((QIMTemplateItem)((bhhr)???).jdField_a_of_type_JavaLangObject, (Activity)???, ((bhgx)???).jdField_a_of_type_AndroidOsBundle);
              }
            }
            bbmy.a(BaseApplicationImpl.sApplication, ajjy.a(2131635560), 0).a();
          }
        }
        paramMessage = (bjad)paramMessage.obj;
        try
        {
          localObject1 = this.jdField_e_of_type_JavaUtilArrayList.iterator();
          while (((Iterator)localObject1).hasNext()) {
            ((bhgv)((Iterator)localObject1).next()).a(paramMessage);
          }
        }
        finally {}
      }
  ...
  public void b(bhgv parambhgv)
  {
    synchronized (this.jdField_e_of_type_JavaUtilArrayList)
    {
      this.jdField_e_of_type_JavaUtilArrayList.remove(parambhgv);
      return;
    }
  }
  
  public void b(bhha parambhha)
  {
    if (QLog.isColorLevel()) {
      QLog.i("QCombo", 2, "notifyDownloadBegin combo " + parambhha);
    }
    synchronized (this.jdField_d_of_type_JavaUtilArrayList)
    {
      this.jdField_d_of_type_JavaUtilArrayList.add((QIMFilterCategoryItem)parambhha.jdField_a_of_type_JavaLangObject);
  ...
  public void b(bhhr parambhhr)
  {
    if (QLog.isColorLevel()) {
      QLog.i("QCombo", 2, "notifyDownloadTemplateBegin templateSet " + parambhhr);
    }
    synchronized (this.jdField_b_of_type_JavaUtilArrayList)
    {
      this.jdField_b_of_type_JavaUtilArrayList.add((QIMTemplateItem)parambhhr.jdField_a_of_type_JavaLangObject);
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_b_of_type_JavaUtilArrayList)
      {
        ...
        if (((bhha)???).jdField_a_of_type_Int == 1)
        {
          ...
          {
            if (QLog.isColorLevel()) {
              QLog.d("QCombo", 2, "buildComboBatch progress: " + localQIMTemplateItem1.jdField_b_of_type_JavaLangString + ", progress: " + ((bhha)???).jdField_b_of_type_Int);
            }
            ((bhha)???).jdField_a_of_type_Int = j;
          }
          j = (int)(10000.0F * ((bhha)???).a());
      ...
      if (((bhha)???).jdField_a_of_type_Int == 2)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.i("QCombo", 2, "removeComboBatch: " + localQIMTemplateItem2.jdField_b_of_type_JavaLangString + ",  STATE_NEED_DOWNLOAD progress: " + ((bhha)???).jdField_b_of_type_Int);
        }
        bool = true;
      }
      else if (((bhha)???).jdField_a_of_type_Int == 3)
      {
        ...
        Message.obtain(this.jdField_b_of_type_AndroidOsHandler, 2, ???).sendToTarget();
        if (QLog.isColorLevel()) {
          QLog.i("QCombo", 2, "removeComboBatch: " + localQIMTemplateItem2.jdField_b_of_type_JavaLangString + ", STATE_DOWNLOADED progress: " + ((bhha)???).jdField_b_of_type_Int);
        }
        bool = true;
        continue;
        label458:
  ...
  public boolean c()
  {
    return (this.jdField_a_of_type_Sor.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Sor.b);
  }
  
  public void d()
  {
    bjad localbjad = this.jdField_a_of_type_Bjad;
    if (QLog.isColorLevel()) {
      QLog.d("QCombo", 2, "randomliseData " + localbjad);
    }
    if (localbjad != null)
    {
      localbjad.a();
  ...
  public void e()
  {
    a().notifyObservers(bhgy.class, 971, true, null);
  }
