  ...
  extends msa
{
  ...
  private boolean a(int paramInt, Bundle paramBundle)
  {
    ...
    //   1: astore 12
    //   3: aload_0
    //   4: getfield 113	msc:i	Ljava/lang/String;
    //   7: astore 6
    ...
    //   274: aload_0
    //   275: invokevirtual 206	msc:a	()Lmrt;
    //   278: astore 14
    //   280: aload_2
    //   281: astore 13
    //   283: aload 9
    ...
    //   324: astore 11
    //   326: aload 14
    //   328: getfield 211	mrt:a	Lmrz;
    //   331: getfield 217	mrz:jdField_c_of_type_Boolean	Z
    //   334: ifeq +59 -> 393
    //   337: aload_2
    //   338: astore 13
    //   340: aload 9
    ...
    //   346: astore 11
    //   348: aload 14
    //   350: getfield 211	mrt:a	Lmrz;
    //   353: getfield 219	mrz:a	Ljava/lang/String;
    //   356: aload_0
    //   357: getfield 221	msc:jdField_a_of_type_Msq	Lmsq;
    //   360: getfield 225	msq:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   363: invokestatic 228	android/text/TextUtils:equals	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Z
    //   366: ifeq +27 -> 393
    //   369: ldc 230
    //   371: astore 13
    //   373: aload 14
    //   375: getfield 211	mrt:a	Lmrz;
    //   378: getfield 233	mrz:b	Ljava/lang/String;
    //   381: astore 11
    //   383: aload 14
    //   385: getfield 211	mrt:a	Lmrz;
    //   388: getfield 234	mrz:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   391: astore 12
    //   393: aload 13
    //   395: aload 11
    //   397: aload 12
    //   399: invokestatic 236	msc:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    //   402: istore_3
    //   403: aload_0
    //   404: getfield 221	msc:jdField_a_of_type_Msq	Lmsq;
    //   407: aload 13
    //   409: putfield 237	msq:i	Ljava/lang/String;
    //   412: aload_0
    //   413: getfield 221	msc:jdField_a_of_type_Msq	Lmsq;
    //   416: aload 8
    //   418: putfield 238	msq:h	Ljava/lang/String;
    //   421: aload_0
    //   422: getfield 221	msc:jdField_a_of_type_Msq	Lmsq;
    //   425: aload 10
    //   427: putfield 239	msq:g	Ljava/lang/String;
    //   430: aload_0
    //   431: getfield 221	msc:jdField_a_of_type_Msq	Lmsq;
    //   434: aload 11
    //   436: putfield 242	msq:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   439: aload_0
    //   440: getfield 221	msc:jdField_a_of_type_Msq	Lmsq;
    //   443: aload 12
    //   445: putfield 245	msq:f	Ljava/lang/String;
    //   448: aload_0
    //   449: getfield 113	msc:i	Ljava/lang/String;
    //   452: iconst_1
    ...
    //   495: aload_0
    //   496: getfield 190	msc:g	Ljava/lang/String;
    ...
    //   507: aload_0
    //   508: getfield 194	msc:h	Ljava/lang/String;
    ...
    //   590: istore 4
    //   592: aload_0
    //   593: getfield 221	msc:jdField_a_of_type_Msq	Lmsq;
    //   596: iload 4
    //   598: putfield 269	msq:jdField_e_of_type_Int	I
    //   601: aload_0
    //   602: invokevirtual 271	msc:b	()V
    //   605: aload_0
    //   606: getfield 221	msc:jdField_a_of_type_Msq	Lmsq;
    //   609: invokestatic 276	mso:b	(Lmsq;)V
    //   612: iconst_1
    //   613: ireturn
    //   614: iconst_0
    //   615: istore 5
  ...
  public void a(String paramString)
  {
    ...
    this.jdField_a_of_type_Msq.jdField_e_of_type_Int = 4;
    b();
  }
  
  public boolean a(VideoAppInterface paramVideoAppInterface, AVActivity paramAVActivity, msq parammsq, WeakReference<msd> paramWeakReference)
  {
    ...
    if (l == 0L)
    {
      ...
      parammsq.jdField_e_of_type_Int = 2;
      return false;
    }
    ...
    try
    {
      ...
      localJSONObject2.put("listid", parammsq.jdField_c_of_type_JavaLangString);
      localJSONObject2.put("authkey", parammsq.d);
      ...
      if ((paramAVActivity != null) && (paramAVActivity.b() != -1) && (paramAVActivity.b() != 5))
      {
        ...
        QLog.w(this.i, 1, "GetRedBag, userName[" + str + "], userId[" + l + "], redPocketId[" + parammsq.jdField_c_of_type_JavaLangString + "], json[" + AudioHelper.a(localJSONObject1) + "], Activity[" + paramAVActivity + "]");
        parammsq.jdField_e_of_type_Int = 1;
        return true;
      }
    }
  ...
  void b()
  {
    ...
    {
      msd localmsd = (msd)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localmsd != null) {
        localmsd.a(this);
      }
    ...
    for (boolean bool = true;; bool = false)
    {
      lvz.b(bool, this.jdField_a_of_type_Msq.jdField_e_of_type_JavaLangString, this.jdField_a_of_type_Msq.f);
      return;
    }
  }
}
