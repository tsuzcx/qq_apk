...
public class ywu
{
  ...
  private waz jdField_a_of_type_Waz = new waz();
  ArrayList<bicb> b;
  private ArrayList<yxk> jdField_c_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public ywu(EditVideoMusic paramEditVideoMusic, EditVideoParams paramEditVideoParams, Handler paramHandler)
  {
  ...
  private boolean a()
  {
    ...
    if (this.jdField_b_of_type_JavaUtilArrayList == null)
    {
      ...
      if (i < ListenChangeVoicePanel.jdField_a_of_type_ArrayOfInt.length)
      {
        ...
        for (j = 0;; j = 2)
        {
          ((ArrayList)localObject1).add(new bicb(k, (String)localObject4, (String)localObject5, 0, j, 1, new bicc(ListenChangeVoicePanel.jdField_b_of_type_ArrayOfInt[i], null, null, null)));
          i += 1;
          break;
        }
      }
    ...
    if (localObject1 == null)
    {
      ...
      {
        localObject1 = (bicb)this.jdField_b_of_type_JavaUtilArrayList.get(i);
        if (localObject1 != null) {
          ((bicb)localObject1).jdField_b_of_type_Int = 0;
        }
        i += 1;
      }
      return false;
    ...
    for (;;)
    {
      ...
      catch (Exception localException2)
      {
        ...
        localObject4 = (bicb)localIterator.next();
        if (localArrayList.contains(Integer.valueOf(((bicb)localObject4).jdField_a_of_type_Int))) {
          continue;
        }
        ((bicb)localObject4).jdField_b_of_type_Int = 0;
        continue;
      ...
      {
        localObject5 = (bicb)((Iterator)localObject4).next();
        if (!localArrayList.contains(Integer.valueOf(((bicb)localObject5).jdField_a_of_type_Int))) {
          ((bicb)localObject5).jdField_b_of_type_Int = 0;
        }
      }
      label929:
      j += 1;
    ...
    if (this.jdField_b_of_type_JavaUtilArrayList != null)
    {
      localObject3 = (bicb)this.jdField_b_of_type_JavaUtilArrayList.get(j);
      label956:
      ...
      else
      {
        ...
        if (k != 0)
        {
          ...
          {
            j = k;
            if (bhnm.a(((JSONObject)localObject4).getString("QQVersion"), "8.4.10"))
            {
              k = 0;
              j = k;
              if (QLog.isColorLevel())
        ...
        if (j == 0)
        {
          ((bicb)localObject3).jdField_b_of_type_Int = j;
        }
        else
        {
          ...
          for (;;)
          {
            ...
            ((bicb)localObject3).d = 1;
            ((bicb)localObject3).c = 0;
            if (!TextUtils.isEmpty(((JSONObject)localObject6).getString("name"))) {
              break label1364;
            }
            localObject4 = ((bicb)localObject3).jdField_a_of_type_JavaLangString;
            label1225:
            ((bicb)localObject3).jdField_a_of_type_JavaLangString = ((String)localObject4);
            if (!TextUtils.isEmpty(((JSONObject)localObject6).getString("description"))) {
              break label1377;
            }
            localObject4 = ((bicb)localObject3).jdField_b_of_type_JavaLangString;
            label1253:
            ((bicb)localObject3).jdField_b_of_type_JavaLangString = ((String)localObject4);
            ((bicb)localObject3).jdField_a_of_type_Bicc.jdField_a_of_type_JavaLangString = ((String)localObject5);
            break label1632;
            localObject5 = bhln.jdField_b_of_type_JavaLangString + (String)localObject5;
    ...
    for (int j = ((JSONObject)localObject4).getInt("tag");; j = 0)
    {
      ...
      if (localArrayList.size() > 0)
      {
        ...
        {
          localObject4 = (bicb)((Iterator)localObject3).next();
          if (!localArrayList.contains(Integer.valueOf(((bicb)localObject4).jdField_a_of_type_Int))) {
            ((bicb)localObject4).jdField_b_of_type_Int = 0;
          }
        }
      ...
      while (i < this.jdField_b_of_type_JavaUtilArrayList.size())
      {
        localObject3 = (bicb)this.jdField_b_of_type_JavaUtilArrayList.get(i);
        if (localObject3 != null) {
          ((bicb)localObject3).jdField_b_of_type_Int = 0;
        }
        i += 1;
      }
      return true;
      ...
      while (i < this.jdField_b_of_type_JavaUtilArrayList.size())
      {
        localObject4 = (bicb)this.jdField_b_of_type_JavaUtilArrayList.get(i);
        if (localObject4 != null) {
          ((bicb)localObject4).jdField_b_of_type_Int = 0;
        }
        i += 1;
  ...
  private void d()
  {
    ...
    new ywv(this, this.jdField_a_of_type_Waz, l).executeOnExecutor(Bosses.get().getExecutor(16), new wlu[] { new wlu(str1, str2, null) });
  }
  ...
  public void a(yxk paramyxk)
  {
    ...
    if (a((Object[])localObject2))
    {
      ...
      localObject2 = new bica((String)localObject2, i, 64000, 2, paramyxk.c);
      bicd.a(BaseApplicationImpl.getContext(), (bica)localObject2, jdField_c_of_type_JavaLangString, new yww(paramyxk, (String)localObject1), new bicf(false, false, false, true, true, null));
      localObject1 = new Properties();
      ((Properties)localObject1).setProperty("bless_param_voice_id", "" + paramyxk.c);
      aipy.a("bless_event_voice_click", (Properties)localObject1);
    }
  }
  ...
  public void c()
  {
    ...
    synchronized (this.jdField_c_of_type_JavaUtilArrayList)
    {
      ...
      {
        bicb localbicb = (bicb)localIterator.next();
        if (localbicb.jdField_b_of_type_Int == 2)
        {
          yxk localyxk = new yxk(4, localbicb.jdField_a_of_type_JavaLangString, localbicb.jdField_a_of_type_Bicc.jdField_a_of_type_Int, localbicb.jdField_a_of_type_Int);
          if ((localbicb.jdField_a_of_type_Bicc.jdField_a_of_type_Int == 0) && (!TextUtils.isEmpty(localbicb.jdField_a_of_type_Bicc.jdField_a_of_type_JavaLangString))) {
            localyxk.g = (jdField_b_of_type_JavaLangString + localbicb.jdField_a_of_type_Bicc.jdField_a_of_type_JavaLangString.substring(localbicb.jdField_a_of_type_Bicc.jdField_a_of_type_JavaLangString.lastIndexOf("/") + 1));
          }
          this.jdField_c_of_type_JavaUtilArrayList.add(localyxk);
        }
      }
    }
