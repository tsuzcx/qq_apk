...
{
  abdl(abdk paramabdk, ArkLocalAppMgr paramArkLocalAppMgr) {}
  ...
  public void onUpdate(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    if ((paramBoolean) && (!TextUtils.isEmpty(paramObject)))
    {
      try
      {
        ...
        if (paramObject == null)
        {
          ...
          if (this.jdField_a_of_type_Abdk.a.jdField_a_of_type_ComTencentMobileqqArkArkMessageServerLogic$IAnalyzeArkBabyQReplyByServerHandler == null) {
            break label624;
          }
          this.jdField_a_of_type_Abdk.a.jdField_a_of_type_ComTencentMobileqqArkArkMessageServerLogic$IAnalyzeArkBabyQReplyByServerHandler.a(this.jdField_a_of_type_Abdk.a.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Abdk.a.jdField_a_of_type_JavaLangObject, null, false);
          return;
        }
        ...
        if (i != 0)
        {
          ...
          if ((i == 1) && (this.jdField_a_of_type_Abdk.a.jdField_a_of_type_ComTencentMobileqqArkArkMessageServerLogic$IAnalyzeArkBabyQReplyByServerHandler == null)) {
            break label624;
          }
          this.jdField_a_of_type_Abdk.a.jdField_a_of_type_ComTencentMobileqqArkArkMessageServerLogic$IAnalyzeArkBabyQReplyByServerHandler.a(this.jdField_a_of_type_Abdk.a.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Abdk.a.jdField_a_of_type_JavaLangObject, null, false);
          return;
    ...
    for (;;)
    {
      if (paramInt < i)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqArkArkLocalAppMgr.a(((ArkAiInfo)localObject).jdField_a_of_type_JavaLangString, str, 4, new abdm(this, (ArkAiInfo)localObject, localSearchArkBabyQInfo, paramInt, i));
        break label625;
        if (this.jdField_a_of_type_Abdk.a.jdField_a_of_type_ComTencentMobileqqArkArkMessageServerLogic$IAnalyzeArkBabyQReplyByServerHandler != null) {
          this.jdField_a_of_type_Abdk.a.jdField_a_of_type_ComTencentMobileqqArkArkMessageServerLogic$IAnalyzeArkBabyQReplyByServerHandler.a(this.jdField_a_of_type_Abdk.a.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Abdk.a.jdField_a_of_type_JavaLangObject, null, true);
        }
      }
      label624:
      return;
