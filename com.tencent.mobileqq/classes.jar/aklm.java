...
public class aklm
{
  ...
  public String b()
  {
    if (8 == this.jdField_a_of_type_Int) {
      return alef.h + this.jdField_b_of_type_Int + File.separator + this.jdField_a_of_type_JavaLangString;
    }
    return alef.jdField_a_of_type_JavaLangString + this.jdField_b_of_type_Int + File.separator + this.jdField_a_of_type_JavaLangString;
  }
  
  public boolean b()
  {
    if ((ApolloUtil.c(b())) && (this.jdField_a_of_type_Int == 8)) {
      return ApolloUtil.c(alef.h + this.jdField_b_of_type_Int + File.separator + "room.bin");
    }
    return false;
  }
  ...
  public String c()
  {
    ...
    if (this.jdField_a_of_type_Int == 6)
    {
      ...
      localObject1 = new File(alef.j + (String)localObject1 + File.separator + "face.json");
    ...
    {
      return "";
      Object localObject2 = new File(alef.f + this.jdField_b_of_type_Int + File.separator + "blendshape.json");
      if (((File)localObject2).exists())
      {
        try
        {
          localObject2 = bdcs.b((File)localObject2);
          return localObject2;
        }
        ...
        continue;
        Object localObject3 = new File(alef.f + this.jdField_b_of_type_Int + File.separator + "face.json");
        if (((File)localObject3).exists())
        {
          try
          {
            localObject3 = bdcs.b((File)localObject3);
            return localObject3;
          }
        ...
        {
          Object localObject4 = new File(alef.f + this.jdField_b_of_type_Int + File.separator + "blendshape.json");
          if (((File)localObject4).exists()) {
            try
            {
              localObject4 = bdcs.b((File)localObject4);
              return localObject4;
            }
