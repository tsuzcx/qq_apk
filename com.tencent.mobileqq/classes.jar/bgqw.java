...
public class bgqw
{
  private static bgqw jdField_a_of_type_Bgqw;
  ...
  private final ArrayList<bgqx> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private HashMap<Long, WeakReference<bgqv>> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  private static TianShuAccess.AdPosItem a(bgqu parambgqu)
  {
    TianShuAccess.AdPosItem localAdPosItem = new TianShuAccess.AdPosItem();
    localAdPosItem.posId.set(parambgqu.jdField_a_of_type_Int);
    localAdPosItem.nNeedCnt.set(parambgqu.jdField_b_of_type_Int);
    if (parambgqu.jdField_a_of_type_JavaUtilHashMap != null)
    {
      parambgqu = parambgqu.jdField_a_of_type_JavaUtilHashMap.entrySet().iterator();
      while (parambgqu.hasNext())
      {
        Map.Entry localEntry = (Map.Entry)parambgqu.next();
  ...
  private static TianShuReport.UserActionReport a(bgqx parambgqx)
  {
    TianShuReport.UserActionReport localUserActionReport = new TianShuReport.UserActionReport();
    localUserActionReport.to_uid.set(String.valueOf(parambgqx.jdField_a_of_type_JavaLangString));
    localUserActionReport.trace_id.set(String.valueOf(parambgqx.jdField_b_of_type_JavaLangString));
    localUserActionReport.trace_num.set(parambgqx.jdField_a_of_type_Int);
    localUserActionReport.trace_detail.set(String.valueOf(parambgqx.jdField_c_of_type_JavaLangString));
    localUserActionReport.trace_index.set(String.valueOf(parambgqx.jdField_d_of_type_JavaLangString));
    localUserActionReport.appid.set(String.valueOf(parambgqx.jdField_e_of_type_JavaLangString));
    localUserActionReport.page_id.set(String.valueOf(parambgqx.jdField_f_of_type_JavaLangString));
    localUserActionReport.item_id.set(String.valueOf(parambgqx.g));
    localUserActionReport.sub_item_id.set(String.valueOf(parambgqx.h));
    localUserActionReport.module_id.set(String.valueOf(parambgqx.i));
    localUserActionReport.sub_module_id.set(String.valueOf(parambgqx.j));
    localUserActionReport.position_id.set(String.valueOf(parambgqx.k));
    localUserActionReport.test_id.set(parambgqx.jdField_b_of_type_Int);
    localUserActionReport.rule_id.set(parambgqx.jdField_c_of_type_Int);
    localUserActionReport.oper_time.set(parambgqx.jdField_a_of_type_Long);
    localUserActionReport.action_id.set(parambgqx.jdField_d_of_type_Int);
    localUserActionReport.action_value.set(parambgqx.jdField_e_of_type_Int);
    localUserActionReport.action_attr.set(parambgqx.jdField_f_of_type_Int);
    localUserActionReport.trigger_info.set(String.valueOf(parambgqx.l));
    localUserActionReport.busi_info.set(String.valueOf(parambgqx.m));
    localUserActionReport.item_type.set(String.valueOf(parambgqx.n));
  ...
  private static TianShuReport.UserCommReport a()
  {
    ...
    localUserCommReport.qua.set(String.valueOf(bfpk.a()));
    localUserCommReport.network_type.set(b());
    localUserCommReport.mobile_type.set(String.valueOf(Build.MODEL));
    localUserCommReport.os_version.set(String.valueOf(babp.e()));
  ...
  public static String a()
  {
    ...
    try
    {
      jdField_a_of_type_JavaLangString = befc.a("07aa5e");
      label28:
      return jdField_a_of_type_JavaLangString;
    }
  ...
  private void a(ArrayList<bgqx> paramArrayList)
  {
    ...
    NewIntent localNewIntent = new NewIntent(localAppRuntime.getApplication(), bgqy.class);
    localUserActionMultiReportReq.user_comm_report.set(a());
    paramArrayList = paramArrayList.iterator();
    while (paramArrayList.hasNext())
    {
      bgqx localbgqx = (bgqx)paramArrayList.next();
      localUserActionMultiReportReq.report_infos.add(a(localbgqx));
    }
    localNewIntent.putExtra("data", bakc.a(localUserActionMultiReportReq.toByteArray()));
  ...
  {
    switch (badq.b(BaseApplicationImpl.getContext()))
    {
    default: 
      return "UNKNOW";
    case 1: 
  ...
  private void b(bgqx parambgqx)
  {
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      this.jdField_a_of_type_JavaUtilArrayList.add(parambgqx);
  ...
  public void a(List<bgqu> paramList, bgqv parambgqv)
  {
    if ((paramList == null) || (paramList.size() <= 0) || (parambgqv == null)) {
      return;
    }
    long l = System.currentTimeMillis();
    this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(l), new WeakReference(parambgqv));
    parambgqv = BaseApplicationImpl.getApplication().getRuntime();
    TianShuAccess.GetAdsReq localGetAdsReq = new TianShuAccess.GetAdsReq();
    localGetAdsReq.stComminfo.set(a());
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      bgqu localbgqu = (bgqu)paramList.next();
      localGetAdsReq.lstPos.add(a(localbgqu));
    }
    paramList = new NewIntent(parambgqv.getApplication(), bgqy.class);
    paramList.putExtra("data", bakc.a(localGetAdsReq.toByteArray()));
    paramList.putExtra("cmd", "TianShu.GetAds");
    paramList.putExtra("requestKey", l);
    parambgqv.startServlet(paramList);
  }
  ...
  void b(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramIntent != null)
    {
      ...
      paramIntent = (WeakReference)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(l));
      if (paramIntent != null)
      {
        paramIntent = (bgqv)paramIntent.get();
