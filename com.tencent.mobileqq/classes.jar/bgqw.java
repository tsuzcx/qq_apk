...
{
  private SparseArray<List<bgqx>> a = new SparseArray();
  
  public bgqw(AppRuntime paramAppRuntime)
  {
    super("com.tencent.qqfav.favoritesremotecommand");
    a(0, new bgqy());
  }
  
  public boolean a(int paramInt, bgqx parambgqx)
  {
    ...
    if (!((List)localObject).contains(parambgqx)) {
      return ((List)localObject).add(parambgqx);
    }
    return false;
  }
  
  public boolean b(int paramInt, bgqx parambgqx)
  {
    List localList = (List)this.a.get(paramInt);
    if ((localList != null) && (localList.contains(parambgqx))) {
      return localList.remove(parambgqx);
    }
    return false;
  }
  ...
  public Bundle invoke(Bundle paramBundle, RemoteCommand.OnInvokeFinishLinstener paramOnInvokeFinishLinstener)
  {
    ...
    if (-1 != i)
    {
      ...
      } while (!((bgqx)paramOnInvokeFinishLinstener.next()).a(i, paramBundle));
    }
    label100:
    do
    {
