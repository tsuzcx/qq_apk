  ...
  implements IEventReceiver
{
  ...
  public xim(BaseActivity paramBaseActivity)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity = paramBaseActivity;
    this.jdField_a_of_type_Xer = new xer(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity);
  }
  ...
  private void d()
  {
    ...
    {
      sng.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, "biz_src_jc_gxl", str);
      return;
    }
  }
  ...
  private void e()
  {
    sng.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, "biz_src_jc_gxl", "weishi://camera?logsour=2020020030");
  }
  ...
  public void a()
  {
    ...
    if (!nar.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.getApplication().getApplicationContext())) {
      return;
    }
    ...
    VSNetworkHelper.a().a(this.jdField_a_of_type_ComTencentBizVideostoryNetworkRequestGetMineWSPersonalRequest, new xiq(this));
  }
  ...
  public void a(WEISHI.stGetPersonalPageRsp paramstGetPersonalPageRsp, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (j > 0) {
        if (!paramBoolean)
        {
          ...
          {
            i = 1;
            xhe.a("weishi_share_prof", "entry_exp", i, 0, new String[0]);
          }
        }
        else
        {
          ...
          if (this.jdField_b_of_type_AndroidWidgetTextView != null) {
            this.jdField_b_of_type_AndroidWidgetTextView.setText(j + ajyc.a(2131706766));
          }
        }
      }
      for (;;)
    ...
    this.jdField_a_of_type_Xer.a(paramstGetPersonalPageRsp, this.jdField_a_of_type_Boolean);
  }
  ...
  public void a(View paramView)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131370162));
    ...
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370164));
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView = ((RecyclerView)paramView.findViewById(2131379515));
    ...
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.setAdapter(this.jdField_a_of_type_Xer);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131370403));
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setOnClickListener(new xin(this));
    this.jdField_a_of_type_Xer.a(new xio(this));
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      i = 1;
      xhe.a("weishi_share_prof", "entry_clk", i, 0, new String[0]);
      if (vzz.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity)) {
        break label112;
      }
      xhe.a("weishi_share_prof", "dl_clk", 0, 0, new String[0]);
      bcpw.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, ajyc.a(2131706765), 0).a();
      if (!this.jdField_a_of_type_Boolean) {
        break label105;
      }
    }
    ...
    for (int i = 201;; i = 200)
    {
      ...
      skq.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, localWSDownloadParams, false);
      return;
      i = 2;
      break;
    }
    ...
    {
      e();
      xhe.a("weishi_share_prof", "clk_ws", 1, 0, new String[0]);
      return;
    }
    d();
    xhe.a("weishi_share_prof", "clk_ws", 2, 0, new String[0]);
  }
  ...
  public void b()
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130849173);
      return;
    }
    this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130844932);
  }
