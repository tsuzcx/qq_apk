  ...
  extends lmb
{
  ...
  private Queue<lly> jdField_a_of_type_JavaUtilQueue = new LinkedList();
  ...
  public void a()
  {
    this.jdField_a_of_type_JavaUtilQueue.offer(new lly(this, this.jdField_a_of_type_AndroidGraphicsPathMeasure.getLength()));
  }
  ...
  public void b(Canvas paramCanvas, MySurfaceView paramMySurfaceView, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      if ((paramBoolean) && (this.jdField_a_of_type_JavaUtilQueue.size() > 0))
      {
        ...
        locallly = (lly)((LinkedList)this.jdField_a_of_type_JavaUtilQueue).getLast();
        ...
        for (;;)
        {
          ...
          paramMySurfaceView = (lly)localIterator.next();
          localObject2 = paramMySurfaceView;
        ...
        continue;
        f2 = locallly.jdField_a_of_type_Float;
        if (localObject2 == null) {
          break label683;
        }
        if ((localObject1 != null) && (localObject1 != localObject2)) {
          f1 = (((lly)localObject1).jdField_a_of_type_Float * (float)(((lly)localObject2).jdField_a_of_type_Long - l) + ((lly)localObject2).jdField_a_of_type_Float * (float)(l - ((lly)localObject1).jdField_a_of_type_Long)) / (float)(((lly)localObject2).jdField_a_of_type_Long - ((lly)localObject1).jdField_a_of_type_Long);
        }
      }
    }
    for (;;)
    {
      float f3 = 0.01481482F * this.c * (float)(locallly.jdField_a_of_type_Long - l) / 500.0F;
      f4 /= 2.0F;
      ...
      for (;;)
      {
        if (f1 <= locallly.jdField_a_of_type_Float)
        {
          ...
          f1 += f7;
          continue;
          f1 = ((lly)localObject2).jdField_a_of_type_Float;
          break;
        }
      }
