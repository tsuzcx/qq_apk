...
public final class ayeo
{
  ...
  public ayeo(@NonNull LinearLayout paramLinearLayout)
  {
    this.jdField_a_of_type_AndroidContentContext = paramLinearLayout.getContext();
    this.jdField_a_of_type_AndroidWidgetLinearLayout = paramLinearLayout;
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = azlj.a(this.jdField_a_of_type_AndroidContentContext.getResources(), Color.parseColor("#66ffffff"), this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843023));
    this.b = azlj.a(this.jdField_a_of_type_AndroidContentContext.getResources(), Color.parseColor("#ffffffff"), this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843023));
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout$LayoutParams.leftMargin = awmc.a(7.0F);
  }
