  ...
  implements agvc, agvp
{
  ...
  public bemp(aguw paramaguw, BaseChatPie paramBaseChatPie)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo != null)
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString != null) {
          str1 = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString;
        }
      }
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, BaseChatPie paramBaseChatPie, String paramString1, String paramString2, int paramInt)
  {
    ...
    if ((paramBaseChatPie != null) && ((paramBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity instanceof Activity)))
    {
      WriteTogetherEditorFragment.a(paramBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, WriteTogetherEditorFragment.class, paramQQAppInterface, 18005);
      return;
    }
  ...
  {
    boolean bool = bhnv.g(paramContext);
    if (!bool) {
      QQToast.a(paramContext, 2131719395, 0).a();
    }
    return bool;
  }
  ...
  {
    boolean bool = nlj.a().a(paramString);
    if (bool) {
      QQToast.a(paramContext, 2131719378, 0).a();
    }
    return bool;
  }
  ...
  private static boolean a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString)
  {
    ...
    if (bool) {
      QQToast.a(paramContext, 2131719386, 0).a();
    }
    return bool;
  }
  ...
  {
    return ((bgsl)paramQQAppInterface.getManager(48)).a(paramString, true).a;
  }
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_AndroidViewActionMode$Callback = new bemq(this);
  }
  
  private void d()
  {
    ChatXListView localChatXListView = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView;
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    do
    {
      ...
      if ((paramInt2 & 0x4) != 0)
      {
        paramIntent = (aguk)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(24);
        if (paramIntent != null) {
          paramIntent.a(true);
        }
      }
  ...
  {
    a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, paramString, a(), paramInt);
  }
  ...
  public boolean a()
  {
    ...
    SessionInfo localSessionInfo = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo;
    if ((localSessionInfo != null) && (localSessionInfo.jdField_a_of_type_Int == 1) && (b())) {}
    for (;;)
    {
      return bool;
      bool = false;
  ...
  public void b(String paramString, int paramInt)
  {
    ...
    if (!bemv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject))
    {
      QQToast.a(this.jdField_a_of_type_AndroidContentContext, 2131719380, 0).a();
      return;
    }
    ...
    else
    {
      ...
      String str2 = bemv.a(str1);
      paramString.putString("leftViewText", anzj.a(2131719350));
      paramString.putString("KEY_CANCEL_OR_BACK", "VALUE_CANCEL");
      OpenDocParam localOpenDocParam = new OpenDocParam();
      localOpenDocParam.jdField_a_of_type_JavaLangString = str2;
      localOpenDocParam.jdField_f_of_type_Int = paramInt;
      ...
      WriteTogetherEditorFragment.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, WriteTogetherEditorFragment.class, paramString, 18005);
      j = bemv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject);
      paramString = "" + bemv.a(paramInt);
    ...
    {
      bdll.b(null, "dc00898", "", "", "0X800AF2F", "0X800AF2F", j, 0, paramString, paramInt, "", "");
      return;
      if (paramInt == 2)
      {
