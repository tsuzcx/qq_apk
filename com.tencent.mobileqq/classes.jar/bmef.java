...
public class bmef
{
  ...
  private List<WeakReference<bmeg>> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  private void b()
  {
    bmgm.c("QRPluginManagerClient", "dispatchPluginReadyEvent");
    ...
    try
    {
      ...
      {
        bmeg localbmeg = (bmeg)((WeakReference)localIterator2.next()).get();
        if (localbmeg != null) {
          localArrayList.add(localbmeg);
        }
      }
    ...
    while (localIterator1.hasNext()) {
      c((bmeg)localIterator1.next());
    }
  }
  
  private void b(bmeg parambmeg)
  {
    if (parambmeg == null) {
      return;
    }
    try
    {
      ...
      do
      {
        for (;;)
        {
          ...
          localbmeg = (bmeg)((WeakReference)localIterator.next()).get();
          if (localbmeg != null) {
            break;
          }
          localIterator.remove();
        }
      } while (localbmeg != parambmeg);
    }
    finally {}
    return;
    label68:
    this.jdField_a_of_type_JavaUtilList.add(new WeakReference(parambmeg));
  }
  
  private static void c()
  {
    if (BaseApplicationImpl.sProcessId != 7) {
      bmgm.a("QRPluginManagerClient", "checkToolProcess: QRPluginManagerClient的逻辑必须在Tool进程调用");
    }
  }
  
  private void c(bmeg parambmeg)
  {
    if (parambmeg == null) {
      return;
    }
    ThreadManager.getUIHandler().post(new QRPluginManagerClient.2(this, parambmeg));
  }
  ...
  public void a(Context paramContext, Intent paramIntent, String paramString)
  {
    if (!a())
    {
      bmgm.a("QRPluginManagerClient", "startPluginActivityWhenReady: plugin is not ready");
      return;
    }
    if (bmfw.a())
    {
    ...
    bmea.a(paramContext, paramIntent, paramString);
  }
  
  public void a(bmeg parambmeg)
  {
    if (a()) {
      c(parambmeg);
    }
    ...
    if (bmfw.a())
    {
      bmfw.a(BaseApplicationImpl.getApplication());
      return;
    }
