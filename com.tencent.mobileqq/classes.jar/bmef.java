...
public class bmef
{
  ...
  public bmef(QQAppInterface paramQQAppInterface, Context paramContext, Handler paramHandler)
  {
    ...
    bmei.a(paramContext, this.jdField_a_of_type_JavaUtilMap);
  }
  ...
  private void a(UPDATE_INFO paramUPDATE_INFO, PluginRecord paramPluginRecord)
  {
    ...
    paramPluginRecord.mInstalledPath = bmei.a(BaseApplicationImpl.getContext(), paramPluginRecord.id).getAbsolutePath();
  }
  
  private void a(PluginRecord paramPluginRecord)
  {
    File localFile = bmei.c(BaseApplicationImpl.getContext(), paramPluginRecord.id);
    if ((localFile != null) && (localFile.exists())) {
      localFile.delete();
    }
    bmei.a(paramPluginRecord);
    LpReportInfo_dc01500.reportConfig(paramPluginRecord.id, paramPluginRecord.old_ver, paramPluginRecord.ver, 0);
  }
  
  private void a(String paramString)
  {
    paramString = bmei.c(BaseApplicationImpl.getContext(), paramString);
  ...
  {
    PluginIntent localPluginIntent = new PluginIntent(BaseApplicationImpl.getContext(), bmci.class);
    localPluginIntent.a = a();
    localPluginIntent.b = bmau.a().a();
    localPluginIntent.a(new bmeg(this));
