...
public class azos
  extends aodb
{
  public azos(CustomCoverFragment paramCustomCoverFragment) {}
  ...
  public void e(boolean paramBoolean, Object paramObject)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          QQToast.a(this.a.getActivity(), 1, 2131719659, 0).a();
          return;
        ...
        QQToast.a((Context)localObject, 0, 2131719662, 0).a();
    ...
    if ("profilelogic.readUserInfo".equals(paramObject))
    {
      ...
      this.a.stopTitleProgress();
      QQToast.a((Context)localObject, 1, 2131719338, 0).a();
      return;
    }
    QQToast.a((Context)localObject, 1, 2131719659, 0).a();
  }
}
