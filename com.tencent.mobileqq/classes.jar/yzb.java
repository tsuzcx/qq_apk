  ...
  implements wxw
{
  public void a(Bundle paramBundle)
  {
    ...
    {
      paramBundle = yza.a(this.jdField_a_of_type_Yza, str1, str2, paramBundle, this.jdField_a_of_type_JavaUtilList);
      if (Looper.myLooper() == Looper.getMainLooper())
      {
        yza.a(this.jdField_a_of_type_Yza, this.jdField_a_of_type_AndroidAppActivity, bool1, paramBundle, this.jdField_a_of_type_Yzc, this.jdField_a_of_type_JavaUtilList);
        return;
      }
