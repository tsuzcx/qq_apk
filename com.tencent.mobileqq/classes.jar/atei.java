...
public class atei
{
  ...
  atel jdField_a_of_type_Atel;
  atep jdField_a_of_type_Atep;
  String jdField_a_of_type_JavaLangString;
  Set<aten> jdField_a_of_type_JavaUtilSet = new HashSet();
  ...
  atei(atee paramatee, String paramString1, String paramString2, Signature[] paramArrayOfSignature, long paramLong, atel paramatel, atep paramatep)
  {
    this.jdField_a_of_type_Boolean = true;
    this.b = paramString1;
    this.jdField_a_of_type_JavaLangString = atvo.a(paramString1);
    this.c = paramString2;
    this.jdField_a_of_type_ArrayOfAndroidContentPmSignature = paramArrayOfSignature;
    this.jdField_a_of_type_Long = paramLong;
    this.jdField_a_of_type_Atel = paramatel;
    this.jdField_a_of_type_Atep = paramatep;
    int i = atee.jdField_a_of_type_Int;
    atee.jdField_a_of_type_Int = i + 1;
  ...
  void a()
  {
    ...
    if ((!TextUtils.isEmpty(this.jdField_a_of_type_Atel.f)) || (!TextUtils.isEmpty(this.jdField_a_of_type_Atel.g)))
    {
      b();
      return;
    }
    ...
    this.jdField_a_of_type_Atep.a(this.b, new atej(this, l));
  }
  ...
  public void a(int paramInt1, int paramInt2, String paramString1, String paramString2, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      while (localIterator.hasNext()) {
        ((aten)localIterator.next()).a(paramInt1, paramInt2, paramString1, paramString2, paramBundle);
      }
    } while (this.jdField_a_of_type_Atep == null);
    this.jdField_a_of_type_Atep.a(this.b, null);
  }
  
  void a(aten paramaten)
  {
    if (paramaten != null) {
      this.jdField_a_of_type_JavaUtilSet.add(paramaten);
    }
  }
  ...
  public void b()
  {
    ...
    try
    {
      ...
      for (localObject1 = ((String)localObject1).toUpperCase();; localObject1 = "")
      {
        ...
        localBuilder = IteApkInfoReq.newBuilder().pkgName(this.c).certMd5((String)localObject1).fileName(this.jdField_a_of_type_JavaLangString).fileSize(this.jdField_a_of_type_Long).fileMd5(this.jdField_a_of_type_Atel.f).fileSha1(this.jdField_a_of_type_Atel.g).localQQ("");
        if (this.jdField_a_of_type_Atel.jdField_a_of_type_Int != 1) {
          break;
        }
        localBuilder.chattingQQ(new ArrayList());
        QLog.i("MMApkFileSafeChecker<FileAssistant>", 1, "[MMApkCheck] <" + this.jdField_a_of_type_Int + "> run check task. fileName:" + this.jdField_a_of_type_JavaLangString + " pkgName:" + this.c + " fileSize:" + this.jdField_a_of_type_Long + " pkgSignMd5:" + (String)localObject1 + " " + this.jdField_a_of_type_Atel.toString());
        localObject1 = localBuilder.build();
        ((Map)localObject3).put(Integer.valueOf(this.jdField_a_of_type_Int), localObject1);
        TuringFdService.checkApk((Map)localObject3, new atek(this));
        d();
        return;
      }
    }
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        continue;
        if (this.jdField_a_of_type_Atel.jdField_a_of_type_Int == 2) {
  ...
  void d()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 293	atei:jdField_a_of_type_JavaUtilTimer	Ljava/util/Timer;
    //   6: astore_1
    //   7: aload_1
    //   8: ifnull +6 -> 14
    //   11: aload_0
    ...
    //   29: aload_0
    //   30: getfield 56	atei:jdField_a_of_type_Int	I
    ...
    //   56: putfield 293	atei:jdField_a_of_type_JavaUtilTimer	Ljava/util/Timer;
    //   59: aload_0
    //   60: getfield 293	atei:jdField_a_of_type_JavaUtilTimer	Ljava/util/Timer;
    //   63: new 300	com/tencent/mobileqq/filemanager/core/MMApkFileSafeChecker$CheckTask$3
    //   66: dup
    //   67: aload_0
    //   68: invokespecial 301	com/tencent/mobileqq/filemanager/core/MMApkFileSafeChecker$CheckTask$3:<init>	(Latei;)V
    //   71: ldc2_w 302
