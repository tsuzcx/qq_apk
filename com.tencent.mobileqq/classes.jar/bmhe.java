  ...
  implements Handler.Callback
{
  ...
  public bmhe(Context paramContext, String paramString)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_JavaUtilHashMap = new HashMap();
    this.jdField_a_of_type_AndroidOsHandler = new Handler(a().getLooper(), this);
    this.b = paramString;
    this.jdField_a_of_type_Bmge = bmge.a(this.jdField_a_of_type_AndroidContentContext);
    a();
  }
  ...
  {
    bmhc.a(paramPluginInfo, a(this.jdField_a_of_type_AndroidContentContext));
  }
  
  private void a(String paramString)
  {
    bmhc.a(paramString, a(this.jdField_a_of_type_AndroidContentContext));
  }
      ...
      if (paramPluginInfo.mInstalledPath != null)
      {
        ...
        if (localFile != null)
        {
          ...
          if (localFile.exists())
          {
            ...
            if (localFile.isFile())
            {
              if (!bmhc.a(paramPluginInfo, localFile)) {
                break label137;
              }
              bool1 = true;
  ...
  private static boolean a(File paramFile, QZipFile paramQZipFile, ZipEntry paramZipEntry)
  {
    ...
    //   116: invokestatic 200	bnkw:a	(Ljava/io/OutputStream;)Lbnkw;
    //   119: astore_0
    //   120: aload_0
    //   121: astore 5
    //   123: aload_0
  ...
  private void c(PluginInfo paramPluginInfo, bmhh parambmhh)
  {
    int i = 1;
    String str = paramPluginInfo.mID;
    QLog.d("plugin_tag", 1, "doSetupPlugin." + str);
    if (bmhc.a(paramPluginInfo, this.jdField_a_of_type_AndroidContentContext))
    {
  ...
  private boolean c(String paramString)
  {
    ...
    {
      return false;
      paramString = new File(this.b).list(new bmhf(this, paramString));
  ...
  private boolean d(String paramString)
  {
    ...
    if ((localPluginInfo != null) && (bmhc.a(localPluginInfo, this.jdField_a_of_type_AndroidContentContext)))
    {
      if (QLog.isColorLevel()) {
  ...
  public void a()
  {
    ...
    boolean bool = bmhc.a(localFile1);
    File[] arrayOfFile = bmhc.a(localFile1);
    int i;
    File localFile2;
    Object localObject;
    if (arrayOfFile != null)
  ...
  public void a(PluginInfo paramPluginInfo, bmhh parambmhh)
  {
    paramPluginInfo = new Pair(paramPluginInfo, parambmhh);
    this.jdField_a_of_type_AndroidOsHandler.obtainMessage(66816, paramPluginInfo).sendToTarget();
  }
  
  public void a(String paramString, File paramFile, bmhh parambmhh)
  {
    int i = 1;
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(paramFile);
    if ((PluginUtils.isOsNeedReleaseDex()) && (bmgv.a(paramString) > 1)) {
    ...
    for (;;)
    {
      try
      {
        ...
        if (!TextUtils.isEmpty(paramFile))
        {
          ...
          boolean bool = Dex2Oat.a(localArrayList, localFile, true, paramFile, new bmhg(this));
          ...
          bdle.a(paramString, i, l2);
          l2 = System.currentTimeMillis();
          if (parambmhh != null) {
            parambmhh.a(paramString, "pluginOatCost", l2 - l1);
          }
          if (QLog.isColorLevel()) {
  ...
  public boolean a(PluginInfo paramPluginInfo, bmhh parambmhh)
  {
    if (paramPluginInfo == null)
    {
      if (QLog.isColorLevel()) {
    ...
    for (boolean bool = a((PluginInfo)localObject);; bool = false)
    {
      ...
      if (!bmhc.a(paramPluginInfo, (File)localObject))
      {
        if (QLog.isColorLevel()) {
      ...
      bhmi.a((File)localObject, localFile);
      if (!bmhc.a(paramPluginInfo, localFile))
      {
        if (QLog.isColorLevel()) {
  ...
  public boolean a(String paramString, bmhh parambmhh)
  {
    if (QLog.isColorLevel()) {
    ...
    {
      if (parambmhh != null) {
        parambmhh.e(paramString);
      }
      return false;
    }
    if (!this.jdField_a_of_type_Bmge.a(paramString))
    {
      if (QLog.isColorLevel()) {
    ...
    boolean bool = false;
    Object localObject3 = this.jdField_a_of_type_Bmge.a(paramString);
    if (localObject3 == null)
    {
      QLog.d("plugin_tag", 1, "plugin not builtin");
      if (parambmhh != null) {
        parambmhh.b(false, paramString);
      }
      return false;
    }
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if (parambmhh != null) {
        parambmhh.b(true, paramString);
      }
      return true;
    }
    if (parambmhh != null) {
      parambmhh.f(paramString);
    }
    ...
    if (localObject3 != null)
    {
      ...
      try
      {
        ...
        if ((0 == 0) && (bool))
        {
          long l2 = System.currentTimeMillis();
          if (parambmhh != null) {
            parambmhh.a(paramString, "pluginApkCost", l2 - l1);
          }
          i = 0;
          try
          {
            ...
            l2 = System.currentTimeMillis();
            if (parambmhh != null) {
              parambmhh.a(paramString, "pluginLibCost", l2 - l1);
            }
            if (localObject3 != null)
            {
      ...
      if (bmhk.a()) {
        a(paramString, (File)localObject1, parambmhh);
      }
  ...
  public void b(PluginInfo paramPluginInfo, bmhh parambmhh)
  {
    paramPluginInfo = new Pair(paramPluginInfo, parambmhh);
    this.jdField_a_of_type_AndroidOsHandler.obtainMessage(67072, paramPluginInfo).sendToTarget();
  }
  
  public boolean b(PluginInfo paramPluginInfo, bmhh parambmhh)
  {
    String str = paramPluginInfo.mID;
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      {
        a(str, new File(PluginUtils.getPluginInstallDir(this.jdField_a_of_type_AndroidContentContext), str), parambmhh);
        paramPluginInfo.mState = 4;
        paramPluginInfo.mFingerPrint = a();
        a(paramPluginInfo);
        if (QLog.isColorLevel()) {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 66816: 
      ...
      c((PluginInfo)paramMessage.first, (bmhh)paramMessage.second);
      return true;
    }
    paramMessage = (Pair)paramMessage.obj;
    b((PluginInfo)paramMessage.first, (bmhh)paramMessage.second);
    return true;
  }
}
