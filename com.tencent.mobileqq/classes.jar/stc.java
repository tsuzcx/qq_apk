...
public class stc
  implements Runnable
{
  public stc(JumpActivity paramJumpActivity, Bundle paramBundle) {}
  ...
  public void run()
  {
    ...
    if (((String)localObject1).startsWith("image"))
    {
      ...
      for (;;)
      {
        ...
        ((Intent)localObject1).putExtra("forward_text", this.jdField_a_of_type_ComTencentMobileqqActivityJumpActivity.getString(2131436127));
      }
    }
      ...
      if (localObject3 != null) {
        if ((localObject3 instanceof Uri))
        {
          ...
          if (("text/x-vcard".equals(localObject1)) && ("content".equals(localUri.getScheme())))
          {
            ...
            new stg(this.jdField_a_of_type_ComTencentMobileqqActivityJumpActivity, (Intent)localObject2).execute(new Object[] { this.jdField_a_of_type_ComTencentMobileqqActivityJumpActivity.getApplicationContext(), localUri });
            return;
          }
    ...
    for (;;)
    {
      ...
      ((Intent)localObject2).putExtra("forward_text", this.jdField_a_of_type_ComTencentMobileqqActivityJumpActivity.getString(2131436127));
    }
    label941:
    this.jdField_a_of_type_ComTencentMobileqqActivityJumpActivity.finish();
  }
