...
public class aewg
{
  public int a;
  protected aewn a;
  DialogInterface.OnClickListener jdField_a_of_type_AndroidContentDialogInterface$OnClickListener = new aewj(this);
  protected Bundle a;
  public atfq a;
  public BaseActivity a;
  public QQAppInterface a;
  INetEventHandler jdField_a_of_type_ComTencentMobileqqMsfSdkHandlerINetEventHandler = null;
  private TransProcessorHandler jdField_a_of_type_ComTencentMobileqqTransfileTransProcessorHandler = new aewh(this);
  public QQCustomDialog a;
  public String a;
  public ArrayList<aewn> a;
  ...
  public aewg(BaseActivity paramBaseActivity)
  {
    this.jdField_a_of_type_Atfq = new aewi(this);
    this.jdField_b_of_type_AndroidContentDialogInterface$OnClickListener = new aewk(this);
    this.jdField_c_of_type_AndroidContentDialogInterface$OnClickListener = new aewl(this);
    ...
    this.jdField_d_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131718528);
  }
  ...
  private long a(String paramString1, int paramInt, String paramString2, String paramString3)
  {
    if (FileUtils.fileExists(paramString1))
    {
      ...
      bheg.a(-1L, paramInt, true, "compress_start", "SendMultiPictureHelper.doSendPictues");
      String str = bheg.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, paramString1, paramInt);
      ImageInfo localImageInfo = new ImageInfo();
      bheg.a(4, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, paramString1, str, true, localImageInfo, paramInt);
    ...
    {
      long l1;
      if (!bheg.a(null, paramString1, 1, null, "SendMultiPictureHelper.doSendPictues")) {
        l1 = 0L;
      }
      long l2;
      do
  ...
  private long a(String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    {
      paramString2 = bcsa.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString3, paramString2, paramInt);
  ...
  private void e()
  {
    BaseTransProcessor localBaseTransProcessor = (BaseTransProcessor)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getTransFileController().findProcessor(this.jdField_a_of_type_JavaLangString + this.jdField_a_of_type_Aewn.jdField_a_of_type_Long);
    if (localBaseTransProcessor != null)
    {
      if (this.jdField_c_of_type_Boolean)
      {
        this.jdField_c_of_type_Boolean = false;
        QLog.w("SendMultiPictureHelper", 2, this.jdField_a_of_type_JavaLangString + this.jdField_a_of_type_Aewn.jdField_a_of_type_Long + "has error");
        localBaseTransProcessor.stop();
        a();
      }
      for (;;)
      {
        QLog.w("SendMultiPictureHelper", 2, "continue send " + this.jdField_a_of_type_JavaLangString + this.jdField_a_of_type_Aewn.jdField_a_of_type_Long);
        return;
  ...
  private void f()
  {
    if (this.jdField_a_of_type_Aewn.jdField_a_of_type_Long == -1L) {
    ...
    do
    {
      do
      {
        ...
        localBaseTransProcessor.stop();
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getTransFileController().removeProcessor(this.jdField_a_of_type_JavaLangString + this.jdField_a_of_type_Aewn.jdField_a_of_type_Long);
      } while (!QLog.isColorLevel());
      QLog.d("SendMultiPictureHelper", 2, "stop send " + this.jdField_a_of_type_JavaLangString + this.jdField_a_of_type_Aewn.jdField_a_of_type_Long);
      return;
    } while (!QLog.isColorLevel());
  ...
  void a()
  {
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaUtilArrayList)
      {
        ...
        aewn localaewn = (aewn)this.jdField_a_of_type_JavaUtilArrayList.get(0);
        Object localObject2 = localaewn.jdField_a_of_type_JavaLangString;
        this.jdField_a_of_type_Aewn = localaewn;
        localObject2 = new File((String)localObject2);
        if (!((File)localObject2).exists())
        {
          this.jdField_c_of_type_Boolean = true;
          Toast.makeText(BaseApplicationImpl.getApplication(), ((File)localObject2).getName() + anvx.a(2131713278), 0).show();
        ...
        if (((File)localObject2).length() == 0L)
        {
          if (this.jdField_c_of_type_Int == 0) {
            Toast.makeText(BaseApplicationImpl.getApplication(), this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131692344), 0).show();
          }
        }
        else
        {
          a(localaewn, this.jdField_c_of_type_Int, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString);
          return;
        }
      }
      Toast.makeText(BaseApplicationImpl.getApplication(), this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131694666), 0).show();
      continue;
      label261:
  ...
  public void a(aewn paramaewn, int paramInt, String paramString1, String paramString2)
  {
    ThreadManager.getFileThreadHandler().post(new SendMultiPictureHelper.7(this, paramaewn, paramInt, paramString1, paramString2));
  }
  ...
  public void a(String paramString1, String paramString2, int paramInt, String paramString3, Bundle paramBundle, ArrayList<String> paramArrayList)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = bhdj.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 230, this.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131691046), null, this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener);
    ...
    paramString1 = ((aewn)this.jdField_a_of_type_JavaUtilArrayList.get(0)).jdField_a_of_type_JavaLangString;
    this.jdField_b_of_type_Int = this.jdField_a_of_type_JavaUtilArrayList.size();
    this.jdField_a_of_type_Aewn = ((aewn)this.jdField_a_of_type_JavaUtilArrayList.get(0));
    ...
    if (!NetworkUtil.isNetSupport(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity))
    {
      ...
      while (paramInt < this.jdField_a_of_type_JavaUtilArrayList.size())
      {
        ...
        a((aewn)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt), this.jdField_c_of_type_Int, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString);
        paramInt += 1;
      }
      c();
      return;
    ...
    for (;;)
    {
      a((aewn)this.jdField_a_of_type_JavaUtilArrayList.get(0), this.jdField_c_of_type_Int, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString);
      if (this.jdField_a_of_type_ComTencentMobileqqMsfSdkHandlerINetEventHandler == null) {
        this.jdField_a_of_type_ComTencentMobileqqMsfSdkHandlerINetEventHandler = new aewm(this);
      }
  ...
  void b()
  {
    Object localObject = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131691047);
    localObject = bhdj.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 230, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131719342), (String)localObject, 2131692828, 2131694291, this.jdField_c_of_type_AndroidContentDialogInterface$OnClickListener, this.jdField_b_of_type_AndroidContentDialogInterface$OnClickListener);
