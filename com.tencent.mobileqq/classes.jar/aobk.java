...
public class aobk
  implements Handler.Callback, View.OnTouchListener, anyx, anzd, aobb, ARNativeBridge.ARWorldCupCallback
{
  public volatile int a;
  volatile long jdField_a_of_type_Long = -1L;
  private Context jdField_a_of_type_AndroidContentContext;
  private TextView jdField_a_of_type_AndroidWidgetTextView;
  private anyw jdField_a_of_type_Anyw = new anyw(this, 1);
  private anyy jdField_a_of_type_Anyy;
  ...
  private aobm jdField_a_of_type_Aobm;
  private aoga jdField_a_of_type_Aoga;
  private apag jdField_a_of_type_Apag;
  private apak jdField_a_of_type_Apak = new aobl(this);
  public bjmp a;
  ...
  public aobk(aobd paramaobd, aobm paramaobm)
  {
    this.jdField_a_of_type_Int = 0;
    this.jdField_b_of_type_Int = 0;
    this.jdField_a_of_type_Aobd = paramaobd;
    this.jdField_a_of_type_Aobm = paramaobm;
    this.jdField_a_of_type_AndroidContentContext = this.jdField_a_of_type_Aobd.a();
    this.jdField_a_of_type_ComTencentMobileqqArARNativeBridge = ((ARNativeBridge)paramaobd.a(0));
    this.jdField_a_of_type_Anzc = ((anzc)paramaobd.a(8));
    boolean bool = aoce.a();
    if (this.jdField_a_of_type_Boolean)
    {
      paramaobd = this.jdField_a_of_type_AndroidContentContext;
      if (!bool) {
        break label269;
      }
    }
    ...
    for (int k = 5;; k = 4)
    {
      this.jdField_a_of_type_Apag = new apag(paramaobd, k);
      this.jdField_d_of_type_Int = 1;
      this.jdField_a_of_type_Bjmp = new bjmp(ThreadManager.getSubThreadLooper(), this);
      this.jdField_c_of_type_Boolean = aoce.jdField_a_of_type_Boolean;
      ...
      paramaobd = this.jdField_a_of_type_Aobm.a();
      if (!TextUtils.isEmpty(paramaobd))
      {
        paramaobd = SuperPlayerFactory.createVideoInfoForUrl(paramaobd, 101, MD5Utils.toMD5(paramaobd));
        this.h = this.jdField_a_of_type_ComTencentSuperplayerApiISPlayerPreDownloader.startPreDownload(paramaobd, 3000L, 1000L);
      }
  ...
  private void a(int paramInt)
  {
    ...
    case 6: 
      do
      {
        ...
        return;
        this.jdField_a_of_type_Aobd.a(new ARTransferPromotionRenderable.11(this));
  ...
  private void a(int paramInt1, String paramString, boolean paramBoolean1, int paramInt2, boolean paramBoolean2)
  {
    ...
    for (int k = m;; k = 0)
    {
      if ((localFile.exists()) || (k != 0))
      {
        ...
        this.jdField_a_of_type_Anyw.a(paramString, 123456L, paramBoolean1, paramInt2, paramBoolean2);
      }
      return;
    }
  }
  ...
  private void a(float[] arg1, float[] paramArrayOfFloat2, float[] paramArrayOfFloat3, float[] paramArrayOfFloat4, float[] paramArrayOfFloat5)
  {
    ...
    if (this.jdField_e_of_type_Boolean)
    {
      ...
      if (k >= 1)
      {
        ...
        this.jdField_a_of_type_Anzc.b(true);
        ??? = this.jdField_a_of_type_Anzc;
        this.jdField_a_of_type_Anzc.getClass();
        ???.c(6);
  ...
  {
    if (this.jdField_a_of_type_Aoga == null) {}
    while ((!this.jdField_a_of_type_Aoga.a()) || (this.jdField_a_of_type_Aobd.a() == null)) {
      return false;
    }
    paramArrayOfFloat = new float[4];
    float[] arrayOfFloat = new float[3];
    int k = this.jdField_a_of_type_Aobd.a().a();
    FloatBuffer localFloatBuffer = this.jdField_a_of_type_Aoga.a(k, paramArrayOfFloat, arrayOfFloat);
    if ((k == -1) || (localFloatBuffer == null))
    {
      a(-1.0F, -1.0F, -1.0F);
      return false;
    }
    this.jdField_a_of_type_Aobd.a().a(k);
    this.jdField_a_of_type_Aobd.a().a(localFloatBuffer, this.jdField_a_of_type_Aoga.a());
  ...
  private void i()
  {
    if (this.jdField_a_of_type_Aoga != null)
    {
      ...
      aoln.a().e();
      this.jdField_a_of_type_Aoga.a(this.jdField_f_of_type_Int, this.jdField_g_of_type_Int);
      this.jdField_a_of_type_Aoga.c();
    }
  }
  
  private void j()
  {
    if ((this.jdField_a_of_type_Bjmp != null) && (!this.jdField_a_of_type_Bjmp.hasMessages(1105))) {
      this.jdField_a_of_type_Bjmp.sendEmptyMessageDelayed(1105, 200L);
    }
  ...
  private void k()
  {
    ...
    {
      this.jdField_a_of_type_Bjmp.removeMessages(1105);
      this.jdField_a_of_type_Anzc.a(false, "");
    }
  ...
  public String a()
  {
    return this.jdField_a_of_type_Aobm.jdField_a_of_type_JavaLangString;
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Anzc.a(false, "");
    bcef.b(null, "CliOper", "", "", "0X80098C8", "0X80098C8", 0, 0, this.jdField_a_of_type_Aobm.jdField_a_of_type_JavaLangString, "0", "0", "");
  ...
  {
    a((float[])paramaobj.a("TARGET_SIZE"), (float[])paramaobj.a("POSE"), (float[])paramaobj.a("CAMERA_MATRIX"), (float[])paramaobj.a("CAMERA_POSITION"), paramaobj.a);
  }
  ...
  public int b()
  {
    return this.jdField_a_of_type_Aobm.jdField_a_of_type_Int;
  }
  
  public String b()
  {
    return this.jdField_a_of_type_Aobm.c;
  }
  ...
  public int c()
  {
    return this.jdField_a_of_type_Aobm.jdField_b_of_type_Int;
  }
  ...
  public void c()
  {
    ...
    if (!this.jdField_a_of_type_Aobm.jdField_a_of_type_JavaLangBoolean.booleanValue()) {
      this.jdField_a_of_type_Anzc.e();
    }
    if ((this.jdField_a_of_type_Apag != null) && (this.jdField_a_of_type_Boolean)) {
      QLog.d("ARTransferPromotionRenderable", 2, String.format("setNativeState start sensor result=%s", new Object[] { Boolean.valueOf(this.jdField_a_of_type_Apag.a(this.jdField_a_of_type_Apak)) }));
    }
  }
  
  public boolean c()
  {
    return !this.jdField_a_of_type_Aobm.jdField_a_of_type_JavaLangBoolean.booleanValue();
  }
  ...
  public void f()
  {
    ...
    if (this.jdField_a_of_type_Bjmp != null) {
      this.jdField_a_of_type_Bjmp.removeCallbacks(this.jdField_a_of_type_JavaLangRunnable);
    }
    ...
    if (this.jdField_a_of_type_Aobd != null) {
      this.jdField_a_of_type_Aobd.a(local7);
    }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if ((this.jdField_a_of_type_Anyw != null) && (this.jdField_a_of_type_Anyw.a()) && (this.jdField_a_of_type_Anze != null))
    {
      long l = this.jdField_a_of_type_Anyw.a();
      paramMessage = this.jdField_a_of_type_Anze.a(l);
    ...
    for (;;)
    {
      ...
      return false;
      label98:
      this.jdField_a_of_type_Anzc.a(true, paramMessage.jdField_a_of_type_JavaLangString);
    }
  }
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    if (this.jdField_b_of_type_Int == 4)
    {
      ...
      if ((this.jdField_a_of_type_Aobd != null) && (this.jdField_a_of_type_ComTencentMobileqqArARNativeBridge != null)) {
        this.jdField_a_of_type_Aobd.a(new ARTransferPromotionRenderable.17(this, paramView));
      }
