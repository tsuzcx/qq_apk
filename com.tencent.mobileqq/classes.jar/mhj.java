...
public class mhj
{
  ...
  public mhj(Context paramContext, VideoController paramVideoController, int paramInt, QavPanel paramQavPanel, View paramView1, View paramView2, View paramView3, View paramView4, View paramView5, View paramView6)
  {
    ...
    paramInt = mum.a(paramContext);
    if (paramInt <= 320) {
      paramInt = paramContext.getResources().getDimensionPixelSize(2131297735) + paramContext.getResources().getDimensionPixelSize(2131297731);
    }
    for (;;)
    {
      ...
      if (paramInt <= 480) {
        ...
        paramInt = paramContext.getResources().getDimensionPixelSize(2131297738) + paramContext.getResources().getDimensionPixelSize(2131297734);
      }
    }
  }
