...
public class mhj
{
  ...
  mhm jdField_a_of_type_Mhm = null;
  public boolean a;
  
  public mhj(RelativeLayout paramRelativeLayout, int paramInt, mhm parammhm)
  {
    ...
    this.jdField_a_of_type_Mhm = parammhm;
  }
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_AndroidAnimationObjectAnimator != null)
      {
        ...
        if (this.jdField_a_of_type_Mhm != null) {
          this.jdField_a_of_type_Mhm.a(paramLong, this.jdField_a_of_type_AndroidWidgetRelativeLayout, true);
        }
        if (!paramBoolean) {
          break label268;
        }
      ...
      ((ObjectAnimator)localObject).addListener(new mhl(this, i, paramLong));
      ...
      this.jdField_a_of_type_Boolean = true;
    } while (this.jdField_a_of_type_Mhm == null);
    label268:
    this.jdField_a_of_type_Mhm.a(paramLong, this.jdField_a_of_type_AndroidWidgetRelativeLayout, false);
  }
  
  public void a(long paramLong, boolean paramBoolean, int paramInt, mja parammja)
  {
    int i = 4;
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      parammja = anvx.a(2131708394) + this.jdField_a_of_type_Boolean + "], height[" + i + "], seq[" + paramLong + "]";
      QLog.w(this.jdField_a_of_type_JavaLangString, 1, parammja, new Throwable("打印调用栈"));
      throw new IllegalArgumentException(parammja);
    }
    ((ObjectAnimator)localObject).setDuration(300L);
    ((ObjectAnimator)localObject).addListener(new mhk(this, i, paramLong, parammja));
    this.jdField_a_of_type_AndroidAnimationObjectAnimator = ((ObjectAnimator)localObject);
    ((ObjectAnimator)localObject).start();
    this.jdField_a_of_type_Boolean = false;
    if (this.jdField_a_of_type_Mhm != null) {
      this.jdField_a_of_type_Mhm.b(paramLong, this.jdField_a_of_type_AndroidWidgetRelativeLayout, true);
    }
    label319:
    label320:
    do
    ...
    this.jdField_a_of_type_Mhm.b(paramLong, this.jdField_a_of_type_AndroidWidgetRelativeLayout, false);
  }
