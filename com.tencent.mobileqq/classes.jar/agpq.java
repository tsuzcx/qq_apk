  ...
  extends ArkViewModel
{
  ...
  protected static ArrayList<WeakReference<agpq>> a;
  ...
  public String b;
  protected boolean b;
  protected WeakReference<agpq> c;
  boolean c;
  protected WeakReference<agpt> d;
  protected boolean d;
  ...
  static
  {
    ...
    jdField_a_of_type_ComTencentArkArk$ApplicationCallback = new agpr();
  }
  
  public agpq() {}
  
  public agpq(boolean paramBoolean) {}
  ...
  public static WeakReference<agpq> a(ark.Container paramContainer)
  {
    int i = 0;
    while (i < jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      agpq localagpq = (agpq)localWeakReference.get();
      if ((localagpq != null) && (localagpq.getContainer() == paramContainer)) {
  ...
  private static void b(ArkAppMgr.AppPathInfo paramAppPathInfo)
  {
    ...
    for (String str = paramAppPathInfo.desc.name;; str = "")
    {
      ...
      if (paramAppPathInfo != null)
      {
        paramAppPathInfo = (ArkAppCenter)paramAppPathInfo.getManager(121);
        if (paramAppPathInfo != null)
        {
  ...
  public void a(agpt paramagpt)
  {
    this.d = new WeakReference(paramagpt);
  }
  ...
  {
    agpt localagpt = (agpt)this.d.get();
    if (localagpt != null) {
      localagpt.a(this, paramString1, paramString2);
    }
  }
  ...
  public boolean onLoadApp(ArkViewModelBase.AppInfo paramAppInfo)
  {
    ...
    for (Object localObject2 = str2;; localObject2 = str2)
    {
      ...
      ArkAppMgr.getInstance().getAppPathByName(paramAppInfo.name, paramAppInfo.view, paramAppInfo.appMinVersion, null, new agps(this.jdField_c_of_type_JavaLangRefWeakReference));
      return false;
      bool = false;
    }
  }
  ...
  public void onLoadReport(int paramInt)
  {
    if (this.mAppInfo != null) {
      apok.a(a(), this.mAppInfo.name, "ArkAppLoadState", paramInt, 0, 0L, 0L, 0L, this.mAppInfo.view, "");
    }
  }
  ...
  public void onRunAppFailed()
  {
    ...
    if (localObject != null)
    {
      ...
      localObject = ((ArkViewImplement)localObject).getView().getContext().getString(2131693244);
    ...
    for (this.mErrorInfo.canRetry = true;; this.mErrorInfo.canRetry = false)
    {
      ...
      return;
      label72:
      localObject = ((ArkViewImplement)localObject).getView().getContext().getString(2131693245);
      this.mErrorInfo.msg = a((String)localObject);
    }
  }
}
