  ...
  extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
  ...
  public aqdn(HiBoomPanelView paramHiBoomPanelView)
  {
  ...
  {
    if ((paramViewHolder instanceof aqdo))
    {
      paramViewHolder = (aqdo)paramViewHolder;
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    try
    {
      paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqHiboomHiBoomPanelView.getContext()).inflate(2131497008, paramViewGroup, false);
      localObject = paramViewGroup;
      if (paramViewGroup == null) {
        localObject = new View(this.jdField_a_of_type_ComTencentMobileqqHiboomHiBoomPanelView.getContext());
      }
      return new aqdo(this.jdField_a_of_type_ComTencentMobileqqHiboomHiBoomPanelView, (View)localObject, bool);
    }
