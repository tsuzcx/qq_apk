  ...
  extends BroadcastReceiver
{
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if ("com.qzone.topic.video.FakeFeed".equals(paramContext)) {
      if (!TextUtils.isEmpty(bmnj.a(this.a))) {}
    }
    int i;
    do
    {
      ...
      do
      {
        ...
        localObject2 = bmmf.a(paramContext, i, j, true);
        ...
        try
        {
          ...
          this.a.a.callJs(bmnj.a(this.a), new String[] { ((JSONObject)localObject1).toString() });
          return;
        }
      ...
      } while (TextUtils.isEmpty(bmnj.a(this.a)));
      ...
      try
      {
        ...
        this.a.a.callJs(bmnj.a(this.a), new String[] { ((JSONObject)localObject2).toString() });
        return;
      }
      catch (JSONException paramContext)
      {
    ...
    } while ((!"com.qzone.h5.video.recordCallback".equals(paramContext)) || (TextUtils.isEmpty(bmnj.b(this.a))));
    ...
    Object localObject2 = bmmf.a(paramContext, paramIntent.getIntExtra("param.thumbnailWidth", 0), paramIntent.getIntExtra("param.thumbnailHeight", 0), true);
    if (TextUtils.isEmpty((CharSequence)localObject2))
    {
    ...
    for (;;)
    {
      try
      {
        ...
        if (bool)
        {
          ...
          ((JSONObject)localObject1).put("video_info", bmnj.a(this.a, paramIntent));
          this.a.a.callJs(bmnj.b(this.a), new String[] { ((JSONObject)localObject1).toString() });
          return;
        }
      }
      catch (JSONException paramContext)
