  ...
  extends BaseAdapter
{
  ...
  private ArrayList<aekp> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  
  public acnl(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = paramContext.getResources().getDrawable(2130840969);
  }
  ...
  public void a(List<aekp> paramList)
  {
  ...
  {
    int k = a();
    int i = (XPanelContainer.jdField_a_of_type_Int - aciy.a(70.0F, this.jdField_a_of_type_AndroidContentContext.getResources()) - aciy.a(64.0F, this.jdField_a_of_type_AndroidContentContext.getResources()) * 2) / 3;
    int j;
    if (i >= 0)
    {
    ...
    for (;;)
    {
      j = (this.jdField_a_of_type_AndroidContentContext.getResources().getDisplayMetrics().widthPixels - aciy.a(64.0F, this.jdField_a_of_type_AndroidContentContext.getResources()) * 4) / 8;
      Object localObject1;
      Object localObject2;
      if (paramView == null)
      {
        paramViewGroup = new StickerBubbleLinearLayout(this.jdField_a_of_type_AndroidContentContext);
        paramViewGroup.setMinimumHeight(aciy.a(64.0F, this.jdField_a_of_type_AndroidContentContext.getResources()) + i);
        ...
        for (;;)
        {
          ...
          localObject1 = new LinearLayout.LayoutParams(aciy.a(64.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aciy.a(64.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
          ...
          int n = aciy.a(64.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      ...
      if (paramInt == 0)
      {
        ...
        localObject2 = (aekp)this.jdField_a_of_type_JavaUtilArrayList.get(j);
        if (localObject2 != null) {
          ((ImageView)localObject1).setImageDrawable(a(((aekp)localObject2).jdField_a_of_type_JavaLangString));
        }
        ((View)localObject1).setTag(Integer.valueOf(j));
        if (AppSetting.c) {
          ((View)localObject1).setContentDescription(aekq.a(((aekp)localObject2).jdField_a_of_type_Int) + ajjy.a(2131642535));
        }
      }
      for (;;)
      {
