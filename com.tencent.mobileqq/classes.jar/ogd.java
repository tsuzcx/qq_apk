...
public class ogd
{
  ...
  private ConcurrentHashMap<Integer, List<ogf>> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  private ExecutorService jdField_a_of_type_JavaUtilConcurrentExecutorService = MonitorTimeExecutor.a();
  private ConcurrentHashMap<Integer, List<ofj>> b = new ConcurrentHashMap();
  
  public ogd(Handler paramHandler)
  {
  ...
  public static ogd a()
  {
    ...
    if (localQQAppInterface != null) {
      return ((ohd)localQQAppInterface.getManager(163)).a().a();
    }
    return null;
  }
  ...
  private JSONObject a(int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localJSONObject.put("qqVersionID", "8.2.6");
        ...
        localJSONObject.put("cookieString", bgmq.a("readinjoy_dynamic_channel_header_cookie_" + paramInt, ""));
      }
      ...
      str = "";
      continue;
      str = pye.a((String)localObject);
    }
  }
  
  private JSONObject a(JSONObject paramJSONObject, int paramInt, ofj paramofj)
  {
    ...
    {
      localObject2 = ((rdg)localObject2).a();
      localObject1 = paramJSONObject;
      if (localObject2 != null)
      {
        localObject1 = ((ofb)localObject2).a("dp_environment_id");
        localObject2 = paramofj.d;
        paramofj = new StringBuffer();
        localObject2 = (String)ProteusJsHelper.evaluateJs((String)localObject1, (String)localObject2, paramJSONObject.toString(), paramofj);
        QLog.d("DynamicChannelHeaderModule", 2, new Object[] { "preProcessReqData res = ", localObject2, ", exception = ", paramofj });
        localObject1 = paramJSONObject;
      }
    }
    try
    ...
    catch (JSONException paramofj)
    {
      for (;;)
      {
        QLog.d("DynamicChannelHeaderModule", 2, "preProcessReqData e = ", paramofj);
        localObject1 = paramJSONObject;
      }
    }
  }
  
  private void a(int paramInt1, int paramInt2, ofj paramofj)
  {
    JSONObject localJSONObject = a(a(paramInt1), paramInt1, paramofj);
    ...
    new azgm(JSONUtils.a(localJSONObject, paramofj.c), "POST", new oge(this, paramInt1, paramofj), 1000, localBundle).a(localHashMap);
  }
  
  private void a(int paramInt, ogf paramogf)
  {
    if (paramogf == null) {
      return;
    }
    ...
    for (;;)
    {
      if (((List)localObject).size() > 0)
      {
        ...
        {
          ogf localogf = (ogf)((List)localObject).get(paramInt);
          if (localogf.jdField_a_of_type_Int > paramogf.jdField_a_of_type_Int)
          {
            ((List)localObject).add(paramInt, paramogf);
            QLog.d("DynamicChannelHeaderModule", 2, new Object[] { "putHeaderDataModel, i = ", Integer.valueOf(paramInt), "dataModel = ", localogf });
            return;
          }
          paramInt += 1;
        }
      }
      ((List)localObject).add(paramogf);
      return;
    }
  }
  
  private void a(int paramInt, JSONObject paramJSONObject, Bundle paramBundle, ofj paramofj)
  {
    ...
    do
    {
      ...
      paramJSONObject = b(paramJSONObject, paramInt, paramofj);
      ...
      while (j < paramJSONObject.length())
      {
        ...
        if (paramBundle != null)
        {
          ...
          if (!TextUtils.isEmpty((CharSequence)localObject))
          {
            ogf localogf = new ogf();
            localogf.jdField_a_of_type_JavaLangString = ((String)localObject);
            localogf.b = paramBundle.toString();
            localogf.jdField_a_of_type_Int = i;
            paramofj.add(localogf);
            QLog.d("DynamicChannelHeaderModule", 2, new Object[] { "handleRequest [", Integer.valueOf(j), "] = ", localogf });
          }
        }
        j += 1;
      }
    } while (paramofj.size() <= 0);
    b(paramInt, paramofj);
  ...
  private void a(int paramInt1, boolean paramBoolean, List<ogf> paramList, int paramInt2)
  {
  ...
  private JSONObject b(JSONObject paramJSONObject, int paramInt, ofj paramofj)
  {
    Object localObject2 = ReadInJoyDynamicChannelBaseFragment.a(ReadInJoyDynamicChannelBaseFragment.a(paramInt));
    Object localObject1 = paramJSONObject;
    if (localObject2 != null)
    {
      ...
      {
        localObject1 = ((ofb)localObject2).a("dp_environment_id");
        localObject2 = paramofj.e;
        paramofj = new StringBuffer();
        localObject2 = (String)ProteusJsHelper.evaluateJs((String)localObject1, (String)localObject2, paramJSONObject.toString(), paramofj);
        QLog.d("DynamicChannelHeaderModule", 2, new Object[] { "preProcessRecData res = ", localObject2, ", exception = ", paramofj });
        localObject1 = paramJSONObject;
      }
    }
    try
    ...
    {
      QLog.d("DynamicChannelHeaderModule", 2, "preProcessRecData e = ", paramofj);
    }
    return paramJSONObject;
  }
  
  private void b(int paramInt, List<ogf> paramList)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      paramList = paramList.iterator();
      while (paramList.hasNext()) {
        a(paramInt, (ogf)paramList.next());
      }
    }
  }
  
  public List<ogf> a(int paramInt)
  {
  ...
  public void a(int paramInt)
  {
    ...
    if ((localList != null) && (localList.size() > 0))
    {
      ...
      {
        ofj localofj = (ofj)localList.get(i);
        if ((!TextUtils.isEmpty(localofj.jdField_a_of_type_JavaLangString)) && (!TextUtils.isEmpty(localofj.b)))
        {
          ogf localogf = new ogf();
          localogf.jdField_a_of_type_JavaLangString = localofj.jdField_a_of_type_JavaLangString;
          localogf.b = localofj.b;
          localogf.jdField_a_of_type_Int = i;
          localArrayList.add(localogf);
        }
        i += 1;
      }
  ...
  public void a(int paramInt, List<ofj> paramList)
  {
  ...
  public void b(int paramInt)
  {
    ...
    if ((localList != null) && (localList.size() > 0))
    {
      ...
      {
        ofj localofj = (ofj)localList.get(i);
        if ((!TextUtils.isEmpty(localofj.c)) && (a())) {
          this.jdField_a_of_type_JavaUtilConcurrentExecutorService.execute(new DynamicChannelHeaderModule.1(this, paramInt, i, localofj));
        }
        i += 1;
      }
    }
