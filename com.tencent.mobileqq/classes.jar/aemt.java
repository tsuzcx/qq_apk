...
public class aemt
  implements aenz, Handler.Callback, View.OnClickListener
{
  private static final String jdField_a_of_type_JavaLangString = ajjy.a(2131635479);
  private static final String jdField_b_of_type_JavaLangString = ajjy.a(2131635480);
  ...
  public aemt(BaseActivity paramBaseActivity, aeob paramaeob)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity = paramBaseActivity;
    this.jdField_a_of_type_Aeob = paramaeob;
    this.jdField_a_of_type_Bcpn = ((bcpn)paramBaseActivity.app.getManager(165));
  ...
  {
    paramVarArgs = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity).inflate(2131493032, null);
    TextView localTextView = (TextView)paramVarArgs.findViewById(2131296842);
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        paramVarArgs.findViewById(2131296841).setOnClickListener(this);
        return paramVarArgs;
      }
  ...
  {
    if ((paramMessage.what == 1) && (this.jdField_a_of_type_Aeob.a() == this)) {
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131296840: 
      ...
      awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "dc00899", "Qidian", this.f, "0X8009788", "ClickLawTip", 1, 0, String.valueOf(NetConnInfoCenter.getServerTime()), this.jdField_a_of_type_Bcpn.a(this.f), "8.2.6", "");
      return;
    }
    ...
    this.jdField_a_of_type_AndroidOsHandler.removeMessages(1);
    this.jdField_a_of_type_Aeob.a();
    awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "dc00899", "Qidian", this.f, "0X8009789", "CloseLawTip", 1, 0, String.valueOf(NetConnInfoCenter.getServerTime()), this.jdField_a_of_type_Bcpn.a(this.f), "8.2.6", "");
  }
}
