...
public class piq
{
  ...
  private static void a(String paramString, MessageRecord paramMessageRecord)
  {
    ...
    String str4 = uuc.a(AppConstants.KANDIAN_SUBSCRIBE_UIN) + "";
    ...
    for (;;)
    {
      ...
      int i;
      if (uuc.b(AppConstants.KANDIAN_SUBSCRIBE_UIN) > 0)
      {
        i = 1;
        label200:
      ...
      for (int j = 0;; j = 1)
      {
        ...
        olh.a(null, "CliOper", "", str3, paramString, paramString, 0, 0, str4, (String)localObject3, str1, paramMessageRecord.toString(), false);
        return;
        localObject1 = null;
        break;
        i = 0;
  ...
  public static void b()
  {
    ...
    {
      a = localMap;
      QLog.d(piq.class.getSimpleName(), 2, "update kandian subscribe red pnt info success ");
    }
  }
}
