...
public class aujd
{
  ...
  {
    switch (auje.a[paramStatus.ordinal()])
    {
    default: 
  ...
  public static String a(AppRuntime.Status paramStatus)
  {
    if (paramStatus != null)
    {
      ...
      default: 
        ...
        return "";
      case 1: 
        return BaseApplicationImpl.getContext().getString(2131719765);
      case 2: 
        return BaseApplicationImpl.getContext().getString(2131719766);
      case 3: 
        return BaseApplicationImpl.getContext().getString(2131719749);
      case 4: 
        return BaseApplicationImpl.getContext().getString(2131719752);
      case 5: 
        return BaseApplicationImpl.getContext().getString(2131719758);
      }
      return BaseApplicationImpl.getContext().getString(2131719761);
    }
