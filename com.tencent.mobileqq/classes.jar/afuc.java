  ...
  extends BaseAdapter
{
  ...
  private ArrayList<aigr> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  
  public afuc(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = paramContext.getResources().getDrawable(2130841518);
  }
  ...
  public void a(List<aigr> paramList)
  {
  ...
  {
    int k = a();
    int i = (XPanelContainer.jdField_a_of_type_Int - AIOUtils.dp2px(70.0F, this.jdField_a_of_type_AndroidContentContext.getResources()) - AIOUtils.dp2px(64.0F, this.jdField_a_of_type_AndroidContentContext.getResources()) * 2) / 3;
    int j;
    if (i >= 0)
    {
    ...
    for (;;)
    {
      j = (this.jdField_a_of_type_AndroidContentContext.getResources().getDisplayMetrics().widthPixels - AIOUtils.dp2px(64.0F, this.jdField_a_of_type_AndroidContentContext.getResources()) * 4) / 8;
      Object localObject2;
      Object localObject3;
      if (paramView == null)
      {
        localObject1 = new StickerBubbleLinearLayout(this.jdField_a_of_type_AndroidContentContext);
        ((LinearLayout)localObject1).setMinimumHeight(AIOUtils.dp2px(64.0F, this.jdField_a_of_type_AndroidContentContext.getResources()) + i);
        ...
        for (;;)
        {
          ...
          localObject2 = new LinearLayout.LayoutParams(AIOUtils.dp2px(64.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), AIOUtils.dp2px(64.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
          ...
          int n = AIOUtils.dp2px(64.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      ...
      if (paramInt == 0)
      {
        ...
        localObject3 = (aigr)this.jdField_a_of_type_JavaUtilArrayList.get(j);
        if (localObject3 != null) {
          ((ImageView)localObject2).setImageDrawable(a(((aigr)localObject3).jdField_a_of_type_JavaLangString));
        }
        ((View)localObject2).setTag(Integer.valueOf(j));
        if (AppSetting.c) {
          ((View)localObject2).setContentDescription(aigs.a(((aigr)localObject3).jdField_a_of_type_Int) + anvx.a(2131707779));
        }
      }
      for (;;)
      {
