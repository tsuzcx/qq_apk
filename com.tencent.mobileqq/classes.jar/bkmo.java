  ...
  implements Animatable
{
  ...
  Property<bkmo, Float> jdField_a_of_type_AndroidUtilProperty = new bkmp(this, Float.class, "backHeight");
  private bknm jdField_a_of_type_Bknm = new bknm();
  private bkns jdField_a_of_type_Bkns = new bkns();
  private WeakReference<bkmz> jdField_a_of_type_JavaLangRefWeakReference;
  private boolean jdField_a_of_type_Boolean;
  private float jdField_b_of_type_Float = 5.0F;
  private int jdField_b_of_type_Int = 255;
  private RectF jdField_b_of_type_AndroidGraphicsRectF = new RectF();
  private Drawable jdField_b_of_type_AndroidGraphicsDrawableDrawable;
  Property<bkmo, Integer> jdField_b_of_type_AndroidUtilProperty = new bkmr(this, Integer.class, "backAlpha");
  private boolean jdField_b_of_type_Boolean;
  private float jdField_c_of_type_Float = 50.0F;
  private int jdField_c_of_type_Int;
  private RectF jdField_c_of_type_AndroidGraphicsRectF = new RectF();
  Property<bkmo, Integer> jdField_c_of_type_AndroidUtilProperty = new bkms(this, Integer.class, "speedAlpha");
  private float jdField_d_of_type_Float = 50.0F;
  private int jdField_d_of_type_Int = 179;
  Property<bkmo, Integer> jdField_d_of_type_AndroidUtilProperty = new bkmt(this, Integer.class, "reverseAlpha");
  private float jdField_e_of_type_Float = 30.0F;
  private int jdField_e_of_type_Int;
  Property<bkmo, Float> jdField_e_of_type_AndroidUtilProperty = new bkmu(this, Float.class, "foreSpeed");
  private float jdField_f_of_type_Float = 22.0F;
  private int jdField_f_of_type_Int = 179;
  Property<bkmo, Float> jdField_f_of_type_AndroidUtilProperty = new bkmv(this, Float.class, "foreHeight");
  private int jdField_g_of_type_Int = -1;
  Property<bkmo, Float> jdField_g_of_type_AndroidUtilProperty = new bkmw(this, Float.class, "speedPos");
  private int jdField_h_of_type_Int = 0;
  Property<bkmo, Integer> jdField_h_of_type_AndroidUtilProperty = new bkmx(this, Integer.class, "markAlpha");
  ...
  private void a(float paramFloat)
  {
    if (this.jdField_h_of_type_Int == 4)
    {
      ...
      {
        bkmz localbkmz = (bkmz)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        if (localbkmz != null) {
          localbkmz.a(this.jdField_h_of_type_Int, this.jdField_b_of_type_AndroidGraphicsRectF);
        }
      }
    }
  }
  ...
  private void a(int paramInt1, int paramInt2, float paramFloat1, float paramFloat2)
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_AndroidAnimationValueAnimator != null)
      {
        ...
        this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new bkmy(this));
        this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new bkmq(this));
  ...
  {
    RectF localRectF = this.jdField_a_of_type_Bkns.a(this.jdField_g_of_type_Int);
    if (localRectF != null)
    {
  ...
  {
    RectF localRectF = this.jdField_a_of_type_Bkns.a(this.jdField_c_of_type_Int - 1);
    ...
    do
    {
      do
      {
        do
        {
          ...
          if (this.jdField_a_of_type_Bknm != null) {
            this.jdField_a_of_type_Bknm.a(this.jdField_a_of_type_AndroidGraphicsRectF);
          }
          a(this.jdField_c_of_type_AndroidGraphicsRectF, paramRect.height() * 0.9F);
        } while (this.jdField_a_of_type_Bkns == null);
        this.jdField_a_of_type_Bkns.a(this.jdField_c_of_type_AndroidGraphicsRectF);
        return;
  ...
  private void c(float paramFloat)
  {
    if ((this.jdField_h_of_type_Int == 1) || (this.jdField_h_of_type_Int == 3))
    {
      ...
      if (this.jdField_a_of_type_Bkns != null)
      {
        this.jdField_a_of_type_Bkns.a(this.jdField_c_of_type_AndroidGraphicsRectF);
        if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
        {
          bkmz localbkmz = (bkmz)this.jdField_a_of_type_JavaLangRefWeakReference.get();
          if (localbkmz != null) {
            localbkmz.a(this.jdField_h_of_type_Int, a());
          }
        }
      }
    }
  ...
  private void f(int paramInt)
  {
    ...
    {
      return;
      localbkmz = (bkmz)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (localbkmz == null);
    localbkmz.b(paramInt);
  }
  ...
  {
    if (this.jdField_a_of_type_Bkns != null) {
      return this.jdField_a_of_type_Bkns.a(paramFloat);
    }
    return 0;
  }
  ...
  {
    if (this.jdField_a_of_type_Bkns != null) {
      return this.jdField_a_of_type_Bkns.a(this.jdField_g_of_type_Int);
    }
    return null;
  }
  ...
  public RectF a(float paramFloat)
  {
    int i = a(paramFloat);
    if (this.jdField_a_of_type_Bkns != null) {
      return this.jdField_a_of_type_Bkns.a(i);
    }
    return null;
  }
  ...
  public RectF a(int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (this.jdField_a_of_type_Bkns != null)
    {
      localRectF = this.jdField_a_of_type_Bkns.a(paramInt);
      if (localRectF != null)
      {
        if (paramBoolean2) {
          break label160;
        ...
        {
          localObject = (bkmz)this.jdField_a_of_type_JavaLangRefWeakReference.get();
          if (localObject != null)
          {
            ((bkmz)localObject).a(this.jdField_h_of_type_Int, this.jdField_g_of_type_Int, localRectF);
    ...
    for (;;)
    {
      ...
      label160:
      localObject = this.jdField_a_of_type_Bkns.a(i);
      if (localObject != null)
      {
  ...
  public void a()
  {
    this.jdField_a_of_type_Bkns.a();
    this.jdField_a_of_type_Bknm.a();
  ...
  public boolean a(Context paramContext, int paramInt, float paramFloat1, float paramFloat2, bkmz parambkmz)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambkmz);
    if (paramInt > 0) {
      this.jdField_a_of_type_Float /= paramInt;
    }
    a(paramContext);
    this.jdField_c_of_type_Int = paramInt;
    this.jdField_a_of_type_Bkns.a(-1, paramInt, this.jdField_b_of_type_Float, paramFloat1, paramFloat2);
    this.jdField_a_of_type_Bknm.a(0, paramFloat1, paramFloat2);
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = paramContext.getResources().getDrawable(2130841109);
    this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = paramContext.getResources().getDrawable(2130841108);
    return true;
  }
  ...
  public void draw(Canvas paramCanvas)
  {
    if (this.jdField_h_of_type_Int == 0)
    {
      this.jdField_a_of_type_Bkns.a(paramCanvas, this.jdField_d_of_type_Int, this.jdField_g_of_type_Int, (int)(this.jdField_e_of_type_Int * 1.0F * 179.0F / 255.0F), this.jdField_f_of_type_Int);
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_Bknm.a(paramCanvas, this.jdField_a_of_type_Int);
        this.jdField_a_of_type_Bkns.a(paramCanvas, this.jdField_d_of_type_Int, this.jdField_g_of_type_Int, (int)(this.jdField_e_of_type_Int * 1.0F * 127.0F / 255.0F), this.jdField_f_of_type_Int);
        a(paramCanvas, false);
        if ((this.jdField_h_of_type_Int == 3) || (this.jdField_h_of_type_Int == 1))
        {
      ...
      else if (this.jdField_h_of_type_Int == 4)
      {
        ...
        while ((this.jdField_g_of_type_Int >= 0) && (this.jdField_g_of_type_Int < this.jdField_c_of_type_Int))
        {
          ...
          return;
          label292:
          this.jdField_a_of_type_Bkns.a(paramCanvas, this.jdField_d_of_type_Int, -1, (int)(this.jdField_e_of_type_Int * 1.0F * 179.0F / 255.0F), this.jdField_f_of_type_Int);
        }
      }
    }
  }
  ...
  protected void onBoundsChange(Rect paramRect)
  {
    ...
    if (this.jdField_g_of_type_Int >= 0)
    {
      ...
      {
        paramRect = (bkmz)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        if (paramRect != null)
        {
