  ...
  extends baqn
{
  ...
  public baqo(String paramString, BaseApplicationImpl paramBaseApplicationImpl)
  {
  ...
  private void a(Application paramApplication, String paramString1, int paramInt1, String paramString2, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      azri.a(BaseApplication.getContext()).a(paramApplication, paramString1, bool, 0L, 0L, paramString2, "");
      return;
      boolean bool = false;
      continue;
  ...
  private void a(Application paramApplication, String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        azri.a(BaseApplication.getContext()).a(paramApplication.getCurrentAccountUin(), "report_aio_photo_size", false, 0L, 0L, paramString, "");
        return;
        paramInt /= d;
        if (paramInt >= 10)
        {
  ...
  public static void a(baqs parambaqs, boolean paramBoolean, int paramInt1, int paramInt2, String paramString, bast parambast1, bast parambast2, basu parambasu)
  {
    ...
    String str2;
    String str1;
    if (!barf.a(paramInt2, localHashMap))
    {
      ...
      {
        localHashMap.put(barf.k, paramString);
        str2 = "";
        if ((!paramBoolean) || (parambast1 != null) || (parambast2 != null) || (parambasu != null)) {
          break label453;
        }
        ...
        localHashMap.put("param_uuid", parambaqs.f);
        localHashMap.put("flow", String.valueOf(l1));
        localHashMap.put("msgTime", new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date(parambaqs.jdField_a_of_type_Long * 1000L)));
        localHashMap.put("client_exist", String.valueOf(parambaqs.jdField_a_of_type_Boolean));
        if (parambast2 != null) {
          localHashMap.put("param_RequestUrl", parambast2.a());
        }
        if (parambasu != null) {
          localHashMap.put("param_HttpTran", parambasu.a());
        }
        if (parambasu != null)
        {
          localHashMap.put("param_retry", String.valueOf(parambasu.jdField_b_of_type_Int));
          if (!parambasu.jdField_a_of_type_Boolean) {
            break label532;
          }
          localHashMap.put("serverip", parambasu.jdField_b_of_type_JavaLangString);
          localHashMap.put("param_Server", parambasu.jdField_b_of_type_JavaLangString);
        }
        label359:
        if (!paramBoolean) {
          break label596;
        }
        if ((!parambaqs.c.equals("actC2CPicDownloadV1")) && (!parambaqs.c.equals("actC2CPicSmallDownV1"))) {
          break label581;
        }
        localHashMap.put("param_toUin", parambaqs.jdField_a_of_type_JavaLangString);
      }
    }
    for (;;)
    {
      azri.a(BaseApplication.getContext()).a(null, parambaqs.c, true, paramInt1, l1, localHashMap, "");
      return;
      ...
      str1 = parambast1.a(1) + ";" + parambast2.a(2) + ";" + parambasu.a(3);
      break label151;
      label532:
      localHashMap.put("serverip", parambasu.c);
      localHashMap.put("param_Server", parambasu.c);
      if (paramInt2 != -9527) {
        break label359;
      }
      localHashMap.put("param_rspHeader", parambasu.d);
      break label359;
      label581:
      localHashMap.put("param_grpUin", parambaqs.jdField_a_of_type_JavaLangString);
    }
    label596:
    if (paramInt2 == 9301) {
      localHashMap.put("param_connecttrycount", paramString);
    }
    if ((parambaqs.g != null) && (!parambaqs.g.equals(""))) {
      localHashMap.put("param_MsgTime", parambaqs.g);
    }
    long l3 = paramInt1;
    if ((parambaqs.c.equals("actC2CPicDownloadV1")) || (parambaqs.c.equals("actC2CPicSmallDownV1")))
    {
      localHashMap.put("param_toUin", parambaqs.jdField_a_of_type_JavaLangString);
      localHashMap.put("param_url", parambaqs.e);
      localHashMap.put("param_fsized", l1 + "");
      localHashMap.put("param_fsizeo", l2 + "");
    }
    for (;;)
    {
      azri.a(BaseApplication.getContext()).a(null, parambaqs.c, false, 0L, 0L, localHashMap, "");
      return;
      localHashMap.put("param_grpUin", parambaqs.jdField_a_of_type_JavaLangString);
      localHashMap.put("param_url", parambaqs.e);
      localHashMap.put("param_fsized", l1 + "");
  ...
  private void a(Object paramObject, String paramString1, String paramString2)
  {
    if ((paramObject instanceof DownloadParams))
    {
      ...
      if ((((DownloadParams)localObject).tag instanceof awjs))
      {
        paramObject = (awjs)((DownloadParams)localObject).tag;
        localObject = ((DownloadParams)localObject).url.getProtocol();
        if (paramObject.isSendFromLocal())
        {
          i = baws.a(bayu.a((String)localObject, false));
          paramObject = paramObject.getPicUploadInfo();
          baws.a(paramObject.jdField_b_of_type_Int, false, i, String.valueOf(paramObject.jdField_a_of_type_Long), paramString1, paramString2);
        }
      }
    }
    while (!QLog.isColorLevel())
    {
      ...
      {
        i = baws.a(bayu.a((String)localObject, bool));
        baws.a(paramObject.jdField_b_of_type_Int, false, i, String.valueOf(paramObject.jdField_a_of_type_Long), paramString1, paramString2);
        return;
      }
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (n < k)
        {
          ...
          Bitmap localBitmap = Bitmap.createBitmap(j, i, bayu.b);
  ...
  public Object decodeFile(File paramFile, DownloadParams paramDownloadParams, com.tencent.image.URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    //   34: invokespecial 309	baqo:a	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   37: aload_2
    ...
    //   123: invokespecial 309	baqo:a	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   126: new 321	android/graphics/BitmapFactory$Options
    //   129: dup
    //   130: invokespecial 561	android/graphics/BitmapFactory$Options:<init>	()V
    //   133: astore 18
    //   135: aload 18
    //   137: getstatic 563	bayu:jdField_a_of_type_AndroidGraphicsBitmap$Config	Landroid/graphics/Bitmap$Config;
    ...
    //   180: aload_0
    //   181: aload_2
    //   182: invokespecial 586	baqo:a	(Lcom/tencent/image/DownloadParams;)V
    ...
    //   230: invokespecial 309	baqo:a	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   233: aconst_null
    //   234: areturn
    //   235: iconst_0
    //   236: istore 4
    ...
    //   253: astore_3
    //   254: aload 18
    //   256: getstatic 514	bayu:b	Landroid/graphics/Bitmap$Config;
    ...
    //   375: invokespecial 309	baqo:a	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   378: aload 15
    //   380: astore_1
    //   381: aload_1
    ...
    //   407: ifeq +161 -> 568
    //   410: aload_3
    //   411: invokestatic 614	bdhb:a	(Ljava/lang/String;)Z
    //   414: istore 9
    //   416: iload 9
    //   418: ifeq +74 -> 492
    //   421: aload_3
    ...
    //   438: aload_3
    //   439: invokestatic 619	bflr:a	(Ljava/lang/String;)Ljava/lang/String;
    //   442: astore 19
    //   444: aload_3
    //   445: invokestatic 621	bdhb:d	(Ljava/lang/String;)Z
    //   448: pop
    //   449: aload 16
    //   451: astore 15
    ...
    //   485: invokespecial 309	baqo:a	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   488: aload 16
    //   490: astore 15
    //   492: aload 15
    //   494: astore 16
    ...
    //   561: invokespecial 309	baqo:a	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   564: aload 15
    //   566: astore 16
    //   568: aload 16
    //   570: ifnull +299 -> 869
    ...
    //   575: ifeq +8 -> 583
    //   578: aload_3
    //   579: invokestatic 621	bdhb:d	(Ljava/lang/String;)Z
    //   582: pop
    //   583: aload 16
    //   585: astore_3
    //   586: aload_2
    ...
    //   694: invokespecial 309	baqo:a	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   697: aload_3
    //   698: iconst_0
    //   699: aload_3
    ...
    //   746: aload_3
    //   747: aload_2
    //   748: invokevirtual 662	baqo:a	(Landroid/graphics/Bitmap;Lcom/tencent/image/DownloadParams;)Lcom/tencent/image/RoundRectBitmap;
    //   751: astore 15
    //   753: aload_3
    //   754: aload 15
    ...
    //   781: invokespecial 675	bazi:<init>	(Ljava/lang/String;)V
    //   784: aload 15
    //   786: getfield 666	com/tencent/image/RoundRectBitmap:mBitmap	Landroid/graphics/Bitmap;
    //   789: invokevirtual 676	bazi:a	(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    //   792: aload 15
    ...
    //   810: astore_3
    //   811: aload_0
    //   812: getfield 27	baqo:jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl	Lcom/tencent/common/app/BaseApplicationImpl;
    //   815: ifnull +37 -> 852
    //   818: aload_3
    //   819: aload_0
    //   820: getfield 27	baqo:jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl	Lcom/tencent/common/app/BaseApplicationImpl;
    ...
    //   835: aload_3
    //   836: aload_0
    //   837: getfield 27	baqo:jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl	Lcom/tencent/common/app/BaseApplicationImpl;
    ...
    //   860: iconst_1
    //   861: ldc_w 702
    //   864: invokespecial 704	baqo:a	(Lcom/tencent/image/DownloadParams;Ljava/io/File;Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;IZLjava/lang/String;)V
    //   867: aload_3
    //   868: areturn
    //   869: aload_2
    //   870: getfield 276	com/tencent/image/DownloadParams:tag	Ljava/lang/Object;
    //   873: checkcast 389	awjs
    //   876: invokeinterface 401 1 0
    //   881: ifne +99 -> 980
    //   884: aload_1
    //   885: invokevirtual 331	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   888: invokestatic 619	bflr:a	(Ljava/lang/String;)Ljava/lang/String;
    //   891: astore_3
    //   892: aload_2
    //   893: getfield 276	com/tencent/image/DownloadParams:tag	Ljava/lang/Object;
    //   896: checkcast 389	awjs
    ...
    //   919: aload 15
    //   921: getfield 431	awjd:jdField_b_of_type_Int	I
    //   924: invokestatic 706	baws:b	(I)Ljava/lang/String;
    ...
    //   953: aload 15
    //   955: getfield 432	awjd:jdField_a_of_type_Long	J
    ...
    //   993: iconst_0
    //   994: ldc_w 720
    //   997: invokespecial 704	baqo:a	(Lcom/tencent/image/DownloadParams;Ljava/io/File;Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;IZLjava/lang/String;)V
    ...
    //   1044: invokespecial 704	baqo:a	(Lcom/tencent/image/DownloadParams;Ljava/io/File;Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;IZLjava/lang/String;)V
    //   1047: aload_3
    //   1048: athrow
    //   1049: astore 15
    //   1051: aload 15
    //   1053: invokestatic 726	baqo:a	(Ljava/lang/Exception;)Ljava/lang/String;
    //   1056: astore_3
    //   1057: aload_3
    //   1058: ifnull +12 -> 1070
    //   1061: aload_3
    ...
    //   1079: ifeq +40 -> 1119
    //   1082: aload_0
    //   1083: getfield 25	baqo:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   1086: iconst_2
    //   1087: aload_1
    ...
    //   1116: invokespecial 309	baqo:a	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   1139: invokestatic 105	azri:a	(Landroid/content/Context;)Lazri;
    //   1142: aconst_null
    //   1143: ldc_w 734
    //   1146: iconst_0
    //   1147: ldc2_w 735
    ...
    //   1152: ldc 107
    //   1154: iconst_1
    //   1155: invokevirtual 739	azri:a	(Ljava/lang/String;Ljava/lang/String;ZJJLjava/util/HashMap;Ljava/lang/String;Z)V
    //   1158: aload 15
    //   1160: athrow
    //   1161: aload_0
    //   1162: aload_2
    //   1163: invokespecial 586	baqo:a	(Lcom/tencent/image/DownloadParams;)V
    //   1166: aload 18
    //   1168: iconst_1
    ...
    //   1211: iconst_0
    //   1212: ldc_w 747
    //   1215: invokespecial 704	baqo:a	(Lcom/tencent/image/DownloadParams;Ljava/io/File;Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;IZLjava/lang/String;)V
    ...
    //   1241: invokestatic 755	baqo:b	(Landroid/graphics/BitmapFactory$Options;II)I
    ...
    //   1397: invokespecial 675	bazi:<init>	(Ljava/lang/String;)V
    //   1400: aload 15
    //   1402: invokevirtual 676	bazi:a	(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    //   1405: astore 15
    //   1407: aload 15
    //   1409: astore_3
    //   1410: aload_3
    ...
    //   1478: invokespecial 309	baqo:a	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   1481: iload 9
    //   1483: istore 10
    ...
    //   1645: invokespecial 309	baqo:a	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   1648: iload 5
    //   1650: iconst_1
    //   1651: iadd
    //   1652: istore 5
    ...
    //   1726: iconst_1
    //   1727: ldc_w 795
    //   1730: invokespecial 704	baqo:a	(Lcom/tencent/image/DownloadParams;Ljava/io/File;Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;IZLjava/lang/String;)V
    //   1733: aload 15
    //   1735: astore_3
    //   1736: iconst_1
    //   1737: istore 9
    ...
    //   1755: iload 10
    //   1757: ldc 107
    //   1759: invokespecial 704	baqo:a	(Lcom/tencent/image/DownloadParams;Ljava/io/File;Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;IZLjava/lang/String;)V
    //   1762: aload_2
    ...
    //   1822: istore 11
    //   1824: goto +289 -> 2113
    //   1827: getstatic 801	baqo:jdField_a_of_type_Int	I
    //   1830: ifeq +9 -> 1839
    //   1833: getstatic 802	baqo:jdField_b_of_type_Int	I
    //   1836: ifne +35 -> 1871
    //   1839: aload_0
    //   1840: getfield 27	baqo:jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl	Lcom/tencent/common/app/BaseApplicationImpl;
    ...
    //   1852: putstatic 801	baqo:jdField_a_of_type_Int	I
    //   1855: aload_0
    //   1856: getfield 27	baqo:jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl	Lcom/tencent/common/app/BaseApplicationImpl;
    ...
    //   1868: putstatic 802	baqo:jdField_b_of_type_Int	I
    //   1871: getstatic 801	baqo:jdField_a_of_type_Int	I
    //   1874: getstatic 802	baqo:jdField_b_of_type_Int	I
    //   1877: if_icmple +162 -> 2039
    //   1880: getstatic 801	baqo:jdField_a_of_type_Int	I
    //   1883: istore 6
    //   1885: iload 8
    //   1887: getstatic 803	bayu:jdField_a_of_type_Int	I
    ...
    //   1917: aload 15
    //   1919: iload 10
    //   1921: invokespecial 805	baqo:a	(ZZZZIILjava/lang/String;Z)V
    //   1924: aload_0
    //   1925: aload_0
    //   1926: getfield 27	baqo:jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl	Lcom/tencent/common/app/BaseApplicationImpl;
    //   1929: aload 15
    //   1931: iload 8
    //   1933: iload 14
    //   1935: invokespecial 807	baqo:a	(Landroid/app/Application;Ljava/lang/String;IZ)V
    //   1938: aload_3
    ...
    //   1988: invokespecial 309	baqo:a	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   1991: iload 9
    //   1993: istore 10
    ...
    //   2034: istore 12
    //   2036: goto -209 -> 1827
    //   2039: getstatic 802	baqo:jdField_b_of_type_Int	I
    //   2042: istore 6
    //   2044: goto -159 -> 1885
    //   2047: iconst_0
    //   2048: istore 13
