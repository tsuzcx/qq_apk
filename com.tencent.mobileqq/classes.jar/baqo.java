...
public class baqo
{
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new baqp(this);
  protected Handler a;
  public baql a;
  protected QQAppInterface a;
  Runnable jdField_a_of_type_JavaLangRunnable = new QzonePhotoGuideNotifyService.1(this);
  
  public baqo(QQAppInterface paramQQAppInterface, baql parambaql)
  {
    ...
    try
    {
      parambaql = new IntentFilter("com.qzonex.localalbum.new_photo_notification_feedback_action");
      paramQQAppInterface.getApp().registerReceiver(this.jdField_a_of_type_AndroidContentBroadcastReceiver, parambaql);
      return;
    }
