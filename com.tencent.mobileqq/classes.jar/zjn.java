  ...
  implements bfaz
{
  ...
  public zjn(QQAppInterface paramQQAppInterface)
  {
  ...
  private void b()
  {
    ...
    do
    {
      ...
      localObject3 = bhrw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationInfo().sourceDir);
    ...
    for (int i = 1;; i = 0)
    {
      String str1 = bhrw.a((Context)localObject1);
      ...
      if (localObject3 != null) {
        localObject1 = ((bfay)localObject3).encode(localObject2);
      }
