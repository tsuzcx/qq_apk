...
public class rqn
  implements Runnable
{
  public rqn(BaseChatPie paramBaseChatPie, ChatMessage paramChatMessage) {}
  ...
  public void run()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_MqqOsMqqHandler.post(new rqo(this));
  }
}
