...
public class qls
{
  public static JSONObject a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    if (paramBaseArticleInfo.mGalleryPicNumber > 2)
    {
      ...
      ((JSONObject)localObject1).put("gallery_cn_text", paramBaseArticleInfo.mGalleryPicNumber + anvx.a(2131712429));
    ...
    {
      localObject2 = pnl.a(paramBaseArticleInfo.mJsonPictureList, "pictures");
