...
public class adwh
{
  ...
  private static adwh jdField_a_of_type_Adwh;
  public static final String a;
  public static long b;
  public static final String b;
  public Handler a;
  public HandlerThread a;
  HashMap<String, adwi> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  public MqqHandler a;
  adwj[] jdField_a_of_type_ArrayOfAdwj = null;
  private ArrayList[] jdField_a_of_type_ArrayOfJavaUtilArrayList = new ArrayList[6];
  private ArrayList[] b;
  
  static
  {
    jdField_a_of_type_JavaLangString = bbuv.a("Tencent/MobileQQ/poke/");
  ...
  private adwh()
  {
    ...
    this.jdField_a_of_type_ArrayOfAdwj = new adwj[6];
    adwj[] arrayOfadwj = this.jdField_a_of_type_ArrayOfAdwj;
    int k = arrayOfadwj.length;
    i = j;
    while (i < k)
    {
      adwj localadwj = arrayOfadwj[i];
      localadwj = new adwj(this);
      localadwj.jdField_a_of_type_Int = 1;
      localadwj.jdField_a_of_type_Long = -1L;
      i += 1;
    }
  ...
  {
    if (jdField_a_of_type_Adwh == null) {}
    try
    {
      if (jdField_a_of_type_Adwh == null) {
        jdField_a_of_type_Adwh = new adwh();
      }
      return jdField_a_of_type_Adwh;
    }
    finally {}
  }
  ...
  public int a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      localObject1 = new adwi(this);
      ((adwi)localObject1).jdField_a_of_type_ArrayOfAdwk = new adwk[6];
      this.jdField_a_of_type_JavaUtilHashMap.put(paramString, localObject1);
    }
    Object localObject2 = (adwi)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    if (localObject2 == null)
    {
      paramQQAppInterface = new HashMap();
      paramQQAppInterface.put(BaseConstants.RDM_NoChangeFailCode, "");
      axrl.a(BaseApplication.getContext()).a(null, "pokeStrengthNullPoint", false, 0L, 0L, paramQQAppInterface, "");
      return 0;
    }
    Object localObject1 = ((adwi)localObject2).jdField_a_of_type_ArrayOfAdwk;
    paramInt2 = ((adwi)localObject2).jdField_a_of_type_Int;
    if (paramInt1 - 1 == -1) {
      paramInt1 = 0;
    }
    while ((paramInt1 >= 0) && (paramInt1 < 6))
    {
      ...
      {
        localObject1[paramInt1] = new adwk(this);
      ...
      if (paramInt3 != -1)
      {
        ...
        ((adwi)localObject2).jdField_a_of_type_Int = paramInt1;
      ...
      else
      {
        ...
        {
          if (paramInt2 != -1) {
            axqw.b(paramQQAppInterface, "CliOper", "", paramString, "0X8008914", "0X8008914", 0, 0, "" + localObject1[paramInt2].jdField_b_of_type_Int, "", "", "");
          }
          localObject1[paramInt1].jdField_a_of_type_Long = l1;
          if (QLog.isColorLevel()) {
    ...
    {
      axqw.b(paramQQAppInterface, "CliOper", "", paramString, "0X8008914", "0X8008914", 0, 0, "" + localObject1[paramInt2].jdField_b_of_type_Int, "", "", "");
      ((adwi)localObject2).jdField_a_of_type_Int = -1;
    }
    return 0;
  }
  ...
  public void a(View paramView)
  {
    ...
    Object localObject;
    if (adqs.class.isInstance(paramView))
    {
      localObject = (adqs)paramView;
      if (QLog.isColorLevel()) {
        QLog.d("GivingHeart", 2, new Object[] { "==>to be remove obj:", Integer.valueOf(((adqs)localObject).jdField_b_of_type_Int) });
      }
      if ((((adqs)localObject).jdField_a_of_type_ComTencentMobileqqDataChatMessage instanceof MessageForPoke))
      {
        paramView = (MessageForPoke)((adqs)localObject).jdField_a_of_type_ComTencentMobileqqDataChatMessage;
        if (adwl.a(paramView.interactType)) {
          break label82;
        }
      }
    }
    ...
    do
    {
      do
      {
        ...
        } while (!((adqs)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.a());
        localObject = ((adqs)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.a();
        paramView.mUnlimitedState.jdField_a_of_type_Int = ((aefe)localObject).jdField_a_of_type_Int;
        paramView.mUnlimitedState.jdField_b_of_type_Int = ((aefe)localObject).jdField_b_of_type_Int;
        paramView.mUnlimitedState.jdField_a_of_type_Long = ((aefe)localObject).jdField_a_of_type_Long;
        paramView.mFrameState.c = ((aefe)localObject).jdField_b_of_type_Boolean;
        paramView.mFrameState.jdField_a_of_type_Boolean = ((aefe)localObject).jdField_a_of_type_Boolean;
        return;
        localObject = ((adqs)localObject).jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.getBackground();
  ...
  {
    this.jdField_a_of_type_AndroidOsHandler = new bfnk(Looper.getMainLooper(), paramFitSystemWindowsRelativeLayout);
  }
}
