...
public class umm
{
  ...
  {
    return new WSStatisticsReporter.Builder().setSopName(paramString).setSceneFrom("QQ_profile_settings").setFlush(true).setImmediatelyUpload(uqt.c());
  }
  
  private static String a(azxr paramazxr)
  {
    if ((paramazxr != null) && (paramazxr.a != null)) {
      return paramazxr.a.jdField_a_of_type_JavaLangString;
    }
    return "";
  }
  ...
  public static void a(azxr paramazxr, QQAppInterface paramQQAppInterface)
  {
    String str = a(paramazxr);
    a(a(a(paramazxr, paramQQAppInterface, str)), str);
  }
  ...
  private static boolean a(azxr paramazxr, QQAppInterface paramQQAppInterface, String paramString)
  {
    boolean bool2 = false;
    boolean bool1 = bool2;
    if (paramazxr != null)
  ...
  public static void b(azxr paramazxr, QQAppInterface paramQQAppInterface)
  {
    String str = a(paramazxr);
    b(a(a(paramazxr, paramQQAppInterface, str)), str);
  }
  ...
  {
    WSStatisticsReporter.Builder localBuilder = a("privacy_settings").addParams("position", "weishi_switch").addParams("action_id", unz.jdField_a_of_type_JavaLangString).addParams("feed_id", "").addParams("owner_id", "");
