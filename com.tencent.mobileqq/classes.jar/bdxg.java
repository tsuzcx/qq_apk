...
public class bdxg
  extends bdxa
{
  public bdxg(Activity paramActivity, JSONObject paramJSONObject, awmk paramawmk)
  {
    super(paramActivity, paramJSONObject, paramawmk);
    this.d = xod.a(paramActivity, 3.0F);
  }
  
  public ProfileCardFavorShowView a(Activity paramActivity)
  {
    return new ProfileCardFavorShowView(paramActivity, null, 2131561793);
  }
  ...
  protected void a(JSONObject paramJSONObject, View paramView, TextView paramTextView, ImageView paramImageView)
  {
    if ((paramView != null) && (paramTextView != null))
    {
      ...
      int i = xod.a(this.jdField_a_of_type_AndroidAppActivity, 300.0F);
      int j = (int)paramTextView.getPaint().measureText(paramTextView.getText().toString());
      int k = xod.a(this.jdField_a_of_type_AndroidAppActivity, 23.0F);
      int m = xod.a(this.jdField_a_of_type_AndroidAppActivity, 40.0F);
      paramView.setBackgroundDrawable(a(str, new bdxh(Math.min(j + k, i), m)));
    }
    for (;;)
    {
  ...
  {
    paramHashMap.put("map_key_qzone", this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561802, null));
  }
}
