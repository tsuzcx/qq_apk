...
public class rvf
{
  ...
  public static final Map<Long, Map<Long, rvk>> b;
  ...
  public static String a()
  {
    ...
    try
    {
      ...
      localJSONObject.put("channel_id", oab.b());
  ...
  {
    if ((odm.a((int)paramLong)) || (bgmq.a(paramLong))) {
      return "0X8009CCB";
    }
    if (a(paramLong)) {
      return "0X8009356";
  ...
  public static String a(Context paramContext, long paramLong1, long paramLong2, int paramInt1, int paramInt2, String paramString1, String paramString2, int paramInt3, String paramString3)
  {
    try
    {
      ...
      for (;;)
      {
        if (odm.c(paramInt2))
        {
          paramLong1 = ((Long)bgmq.a("readinjoy_daily_article_first_exposure_" + paramLong1, Long.valueOf(0L))).longValue();
          if (paramLong1 != 0L) {
  ...
  public static Map<Long, rvk> a(int paramInt)
  {
  ...
  public static Map<Long, rvk> a(long paramLong)
  {
  ...
  public static ocg a(TemplateBean paramTemplateBean, String paramString)
  {
    ...
    if (paramTemplateBean != null)
    {
      ...
      if ((paramTemplateBean != null) && (paramTemplateBean.entrySet() != null))
      {
        ...
        while ((paramTemplateBean != null) && (paramTemplateBean.hasNext()))
        {
          ...
          localocg.b((String)paramString.getKey(), paramString.getValue().toString());
        }
      }
    }
    return localocg;
  ...
  public static void a()
  {
    ...
    localAttributeList.att_value.set(obz.d + "");
    localArrayList.add(localAttributeList);
    rtr.a(10, localArrayList);
    if (QLog.isColorLevel()) {
      QLog.d("ReadinjoyReportUtils", 2, "reportKandianDelete  , foldStatus :  " + obz.d);
    }
  }
  ...
  {
    if ((paramInt == 1008) && (ajed.aQ.equals(paramString1)))
    {
      if (!azzz.a(paramString2, paramResources.getString(ahbj.a[3]))) {
        break label57;
      }
      ndn.a(null, null, "0X8009884", "0X8009884", 0, 0, "", "", "", a(), false);
    }
    label57:
    while (!azzz.a(paramString2, paramResources.getString(ahbj.a[2]))) {
      return;
    }
    ndn.a(null, null, "0X8009885", "0X8009885", 0, 0, "", "", "", a(), false);
  }
  
  public static void a(int paramInt, String paramString, boolean paramBoolean)
  {
    if ((paramInt == 1008) && (ajed.aQ.equals(paramString)))
    {
      if (paramBoolean) {
        ndn.a(null, null, "0X8009884", "0X8009884", 0, 0, "", "", "", a(), false);
      }
  ...
  {
    ArrayList localArrayList = new ArrayList();
    ohp.a().jdField_a_of_type_Oid.a(paramBoolean1);
    long l;
    if (paramBoolean1)
    {
      ohp.n();
      ...
      if (paramInt1 == 0)
      {
        ...
        if (obz.d != 1)
        {
          ...
          ((oidb_cmd0x80a.AttributeList)localObject).att_value.set(obz.a.b);
          localArrayList.add(localObject);
          localObject = new oidb_cmd0x80a.AttributeList();
          ((oidb_cmd0x80a.AttributeList)localObject).att_id.set(4);
          ((oidb_cmd0x80a.AttributeList)localObject).att_name.set("AlgorithmID");
          ((oidb_cmd0x80a.AttributeList)localObject).att_value.set(obz.a.jdField_a_of_type_JavaLangString);
          localArrayList.add(localObject);
          paramLong = NetConnInfoCenter.getServerTime();
          l = obz.a.jdField_a_of_type_Long;
          localObject = new oidb_cmd0x80a.AttributeList();
      ...
      label483:
      for (paramLong = System.currentTimeMillis() - ohp.a().d();; paramLong = System.currentTimeMillis() - ohp.jdField_a_of_type_Long)
      {
        ((oidb_cmd0x80a.AttributeList)localObject).att_value.set(paramLong + "");
        localArrayList.add(localObject);
        paramInt2 = 4;
        rtr.a(paramInt2, localArrayList);
        if (QLog.isColorLevel()) {
    ...
    ((oidb_cmd0x80a.AttributeList)localObject).att_value.set(String.valueOf(ohp.a(paramLong)));
    localArrayList.add(localObject);
    localObject = new oidb_cmd0x80a.AttributeList();
    ((oidb_cmd0x80a.AttributeList)localObject).att_id.set(4);
    ...
    localArrayList.add(localObject);
    if (obz.a.jdField_a_of_type_Int != 1)
    {
      localObject = new oidb_cmd0x80a.AttributeList();
      ((oidb_cmd0x80a.AttributeList)localObject).att_id.set(5);
      ((oidb_cmd0x80a.AttributeList)localObject).att_name.set("StrategyID");
    ...
    if (((oid)localObject).jdField_a_of_type_Long > 0L)
    {
      paramLong = ((oid)localObject).jdField_a_of_type_Long - ((oid)localObject).d;
      label971:
    ...
    label1206:
    for (paramLong = ((oid)localObject).e - ((oid)localObject).c;; paramLong = 0L)
    {
      localAttributeList.att_value.set(paramLong + "");
      localArrayList.add(localAttributeList);
      localAttributeList = new oidb_cmd0x80a.AttributeList();
  ...
  public static void a(ArticleInfo paramArticleInfo)
  {
    ...
    for (;;)
    {
      ...
      int i = obz.b(paramArticleInfo);
      localObject2 = new JSONObject();
      try
      {
        obz.a((JSONObject)localObject2, paramArticleInfo);
        ((JSONObject)localObject2).put("touin", localObject1);
        ((JSONObject)localObject2).put("entry_mode", String.valueOf(i));
        ndn.a(null, "", "0X8009846", "0X8009846", 0, 0, String.valueOf(l1), String.valueOf(l2), String.valueOf(l3), ((JSONObject)localObject2).toString(), false);
        return;
  ...
  {
    if (((Long)bgmq.a("readinjoy_daily_article_first_exposure_" + paramBaseArticleInfo.mArticleID, Long.valueOf(0L))).longValue() == 0L) {
      bgmq.a("readinjoy_daily_article_first_exposure_" + paramBaseArticleInfo.mArticleID, Long.valueOf(System.currentTimeMillis() / 1000L));
    }
    synchronized (jdField_b_of_type_JavaUtilMap)
    {
      Map localMap2 = a(paramBaseArticleInfo.mChannelID);
      rvk localrvk = (rvk)localMap2.get(Long.valueOf(paramBaseArticleInfo.mArticleID));
      if (localrvk != null)
      {
        long l = paramLong;
        if (localrvk.jdField_a_of_type_Long > paramLong) {
          l = localrvk.jdField_a_of_type_Long;
        }
        localrvk.jdField_a_of_type_Long = l;
        return;
      }
      localrvk = new rvk(obz.d());
      localrvk.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo = paramBaseArticleInfo;
      localrvk.jdField_a_of_type_Long = paramLong;
      localMap2.put(Long.valueOf(paramBaseArticleInfo.mArticleID), localrvk);
    }
  }
  ...
  public static void a(TemplateBean paramTemplateBean, String paramString1, String paramString2)
  {
    ...
    {
      return;
      localocg = a(paramTemplateBean, paramString1);
      paramTemplateBean = a(paramTemplateBean, paramString1, paramString2);
    } while (paramTemplateBean == null);
    ndn.a(null, "CliOper", "", "", paramTemplateBean, paramTemplateBean, 0, 0, "", "", "", localocg.a(), false);
  }
  
  public static void a(RecentItemChatMsgData paramRecentItemChatMsgData)
  {
    if (!jdField_a_of_type_Boolean) {}
    while ((paramRecentItemChatMsgData == null) || (paramRecentItemChatMsgData.mUser == null) || (!ajed.aP.equals(paramRecentItemChatMsgData.mUser.uin))) {
      return;
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        localocg.l(i);
        localocg.b("message_reddot_style", obz.k());
        if (paramBoolean)
        {
          localObject = "0X8009A85";
          ndn.a(null, paramQQAppInterface, (String)localObject, (String)localObject, 0, 0, "", "", "", localocg.a(), false);
          return;
        }
      }
  ...
  public static void a(String paramString)
  {
    ...
    {
      ndn.a(null, null, "0X800978D", "0X800978D", 0, 0, "", "", "", a(), false);
      ohp.l();
    }
    while (!ajed.aQ.equals(paramString)) {
      return;
    }
    ndn.a(null, null, "0X8009886", "0X8009886", 0, 0, "", "", "", a(), false);
    ohp.m();
  }
  ...
  public static void a(List<ArticleInfo> paramList)
  {
    ...
    do
    {
      ...
      Collections.sort(paramList, new rvi());
  ...
  public static void a(List<ArticleInfo> paramList, List<Long> paramList1, boolean paramBoolean)
  {
    ...
    Collections.sort(paramList, new rvh());
  ...
  public static void a(Map<Long, rvk> paramMap)
  {
    Iterator localIterator = paramMap.values().iterator();
    while (localIterator.hasNext())
    {
      rvk localrvk = (rvk)localIterator.next();
      ArticleInfo localArticleInfo = (ArticleInfo)localrvk.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo;
      if ((!obz.s(localArticleInfo)) || (!localArticleInfo.mNewPolymericInfo.jdField_a_of_type_Boolean))
      {
        String str1 = obz.c(localArticleInfo);
        paramMap = localArticleInfo.innerUniqueID;
        Object localObject = paramMap;
        if (obz.j(localArticleInfo))
        {
        ...
        String str2 = obz.e(localArticleInfo);
        if (((qoe.a(localArticleInfo)) || (qoe.i(localArticleInfo)) || (qoe.j(localArticleInfo)) || (qoe.k(localArticleInfo))) && (!qoe.o(localArticleInfo))) {
        ...
        for (;;)
        {
          for (;;)
          {
            localObject = obz.a(localArticleInfo.mAlgorithmID, obz.a(localArticleInfo), (int)localArticleInfo.mChannelID, NetworkState.isWifiConn(), str1, (String)localObject, str2, 0, localrvk.jdField_a_of_type_Int, localArticleInfo);
            str1 = a(localArticleInfo.mChannelID);
            try
            {
              ((JSONObject)localObject).put("exposure_time", "" + (float)localrvk.jdField_a_of_type_Long / 1000.0F);
              if (odm.c((int)localArticleInfo.mChannelID)) {
                ((JSONObject)localObject).put("cmd", bgmq.g());
              }
              ndn.a(null, "CliOper", "", paramMap, str1, str1, 0, 0, Long.toString(localArticleInfo.mFeedId), localArticleInfo.mArticleID + "", localArticleInfo.mStrategyId + "", ((JSONObject)localObject).toString(), false);
            }
          ...
          break;
          if ((obz.i(localArticleInfo)) && (localArticleInfo.mPolymericInfo.jdField_a_of_type_Int == 6)) {
            paramMap = localArticleInfo.mPolymericInfo.b + "";
          } else if (obz.l(localArticleInfo)) {
            paramMap = "";
          } else {
