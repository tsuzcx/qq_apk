  ...
  implements wnt
{
  private boolean a(List<String> paramList)
  {
    ...
    {
      yuk.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleAlbumEntraConfig type: 日迹主页影集入口配置, content: \n", paramList);
      paramList = (wfv)wth.a(30);
        ...
        catch (NumberFormatException localNumberFormatException3)
        {
          try
          {
            for (;;)
            {
              ...
              yuk.e("Q.qqstory.config.QQStoryConfigServletHandler", "get enableCqMode= " + str11 + " from json error:" + localNumberFormatException1);
              continue;
              localNumberFormatException2 = localNumberFormatException2;
              yuk.e("Q.qqstory.config.QQStoryConfigServletHandler", "get highBitrate= " + str11 + " from json error:" + localNumberFormatException2);
              continue;
              bool = false;
            }
            localNumberFormatException3 = localNumberFormatException3;
            yuk.e("Q.qqstory.config.QQStoryConfigServletHandler", "get codecProfile= " + str11 + " from json error:" + localNumberFormatException3);
          }
          catch (NumberFormatException localNumberFormatException4)
          {
            for (;;)
            {
              yuk.e("Q.qqstory.config.QQStoryConfigServletHandler", "get maxVideoSize= " + str11 + " from json error:" + localNumberFormatException4);
            }
          }
        }
      }
  ...
  private boolean a(List<String> paramList, String paramString)
  {
    ...
    {
      return false;
      yuk.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleQzoneSync2QQStory config=%s", paramList);
    ...
    catch (Throwable paramString)
    {
      for (;;)
      {
        yuk.e("Q.qqstory.config.QQStoryConfigServletHandler", "handleQzoneSync2QQStory  parseLong error");
      }
    }
  ...
  private boolean b(List<String> paramList)
  {
    ...
    for (paramList = "";; paramList = str)
    {
      yuk.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleAlbumConfig type: 影集配置, content: \n", paramList);
      if ((!TextUtils.isEmpty(str)) && (str.trim().length() != 0)) {
        break;
      }
      localwfv.f();
  ...
  private boolean b(List<String> paramList, int paramInt)
  {
    ...
    return ((wte)wth.a(5)).a(paramList);
  }
  ...
  private boolean c(List<String> paramList)
  {
    ...
    wwh localwwh = (wwh)QQStoryContext.a().getManager(252);
    String str = (String)paramList.get(0);
    if (str == null) {}
    for (paramList = "";; paramList = str)
    {
      yuk.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleMsgTabTakeVideoNodeConfig type: 日迹拍摄配置, content: \n", paramList);
      if ((!TextUtils.isEmpty(str)) && (str.trim().length() != 0)) {
        break;
      }
      localwwh.a();
  ...
  private boolean d(List<String> paramList)
  {
    ...
    paramList = (String)paramList.get(0);
    yuk.a("Q.qqstory.config.QQStoryConfigServletHandler", "handledAIOSyncToStory config=%s", paramList);
    if (TextUtils.isEmpty(paramList))
    {
      yuk.d("Q.qqstory.config.QQStoryConfigServletHandler", "handledAIOSyncToStory content is null!!");
      bqbn.b();
      return true;
    }
    try
  ...
  private boolean e(List<String> paramList)
  {
    ...
    yuk.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleStorySync2QzoneConfig config=%s", paramList);
    paramList = (String)paramList.get(0);
    if (TextUtils.isEmpty(paramList))
    {
      yuk.d("Q.qqstory.config.QQStoryConfigServletHandler", "handleStorySync2QzoneConfig clear config");
      wta.c(false);
      wta.e(false);
      return true;
    }
    try
    {
      ...
      yuk.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleStorySync2QzoneConfig showSyncBtn = %d,defaultStatus=%d", Integer.valueOf(i), Integer.valueOf(j));
      if (i == 1)
      {
        bool = true;
        wta.c(bool);
    ...
    {
      znw.a("handleStorySync2QzoneConfig:" + paramList.toString(), new Object[0]);
      paramList.printStackTrace();
    }
  }
  ...
  private boolean f(List<String> paramList)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramList = (wtc)JsonORM.a(new JSONObject(paramList), wtc.class);
        localwta = (wta)wth.a(10);
        localwta.b("boolean_enable_revert_play_mode", Boolean.valueOf(true));
        localwta.b("boolean_enable_fast_play_mode", Boolean.valueOf(true));
        localwta.b("boolean_enable_slow_play_mode", Boolean.valueOf(true));
        localwta.b("boolean_enable_hw_encode_pic_to_video", Boolean.valueOf(true));
        localwta.b("boolean_enable_flow_decode", Boolean.valueOf(true));
        localwta.b("boolean_use_flow_decode_first", Boolean.valueOf(false));
        localwta.b("key_story_home_preload_count", Integer.valueOf(4));
        localwta.b("key_story_video_preload_duration", Integer.valueOf(2));
        wtd[] arrayOfwtd;
        int k;
        if (paramList.f != null)
        {
          arrayOfwtd = paramList.f;
          k = arrayOfwtd.length;
          i = 0;
          if (i < k)
          {
            ...
            localwta.b("boolean_use_flow_decode_first", Boolean.valueOf(true));
          }
        }
        if (paramList.jdField_a_of_type_ArrayOfWtd != null)
        {
          arrayOfwtd = paramList.jdField_a_of_type_ArrayOfWtd;
          k = arrayOfwtd.length;
          i = 0;
          if (i < k)
          {
            ...
            localwta.b("boolean_enable_revert_play_mode", Boolean.valueOf(false));
          }
        }
        if (paramList.jdField_b_of_type_ArrayOfWtd != null)
        {
          arrayOfwtd = paramList.jdField_b_of_type_ArrayOfWtd;
          k = arrayOfwtd.length;
          i = 0;
          if (i < k)
          {
            ...
            localwta.b("boolean_enable_fast_play_mode", Boolean.valueOf(false));
          }
        }
        if (paramList.c != null)
        {
          arrayOfwtd = paramList.c;
          k = arrayOfwtd.length;
          i = 0;
          if (i < k)
          {
            ...
            localwta.b("boolean_enable_slow_play_mode", Boolean.valueOf(false));
          }
        }
        if (paramList.d != null)
        {
          arrayOfwtd = paramList.d;
          k = arrayOfwtd.length;
          i = 0;
          if (i < k)
          {
            ...
            localwta.b("boolean_enable_hw_encode_pic_to_video", Boolean.valueOf(false));
          }
        }
        if (paramList.e != null)
        {
          arrayOfwtd = paramList.e;
          k = arrayOfwtd.length;
          i = 0;
          if (i < k)
          {
            ...
            localwta.b("boolean_enable_flow_decode", Boolean.valueOf(false));
          }
        }
      ...
      localwta.b("string_story_global_log_level", Integer.valueOf(i));
      localwta.b("string_auto_play_report_control", paramList.jdField_b_of_type_JavaLangString);
      if ((paramList.jdField_a_of_type_Int > 0) && (paramList.jdField_a_of_type_Int < 20)) {
        localwta.b("key_story_home_preload_count", Integer.valueOf(paramList.jdField_a_of_type_Int));
      }
      if ((paramList.jdField_b_of_type_Int > 0) && (paramList.jdField_b_of_type_Int < 10))
      {
        localwta.b("key_story_video_preload_duration", Integer.valueOf(paramList.jdField_b_of_type_Int));
        break label726;
        i = j;
  ...
  private boolean g(List<String> paramList)
  {
    ...
    paramList = (String)paramList.get(0);
    if (!TextUtils.isEmpty(paramList)) {
      bhsi.i(localQQAppInterface.getApp(), localQQAppInterface.c(), paramList);
    }
    for (;;)
    {
      ((wjb)localQQAppInterface.getManager(181)).b(paramList);
      if (QLog.isColorLevel()) {
        QLog.d("Q.qqstory.config.QQStoryConfigServletHandler", 2, "handleStoryPlayerProxyConfigCmd configContent = " + paramList);
      }
      return true;
      bhsi.i(localQQAppInterface.getApp(), localQQAppInterface.c(), null);
    }
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localObject2 != null)
        {
          ...
          if ((!TextUtils.isEmpty((CharSequence)localObject1)) && (nnr.a((String)localObject2)))
          {
            localwta.b("CertificationLinkText", localObject1);
            localwta.b("CertificationLinkUrl", localObject2);
            ...
            localwta.b("localVideoScanInterval", String.valueOf(i));
            localObject1 = localJSONObject.optJSONObject("mainHallConfig");
            if (localObject1 == null) {
              break label554;
            }
            localwta.b("mainHallConfig", ((JSONObject)localObject1).toString());
            localObject1 = localJSONObject.optJSONObject("troopStoryHallConfig");
            if (localObject1 == null) {
              break label567;
            }
            localwta.b("troopStoryHallConfig", ((JSONObject)localObject1).toString());
            ...
            bool = true;
            localwta.b("key_share_encrypt_flag", Boolean.valueOf(bool));
            ...
            bool = true;
            localwta.b("key_show_in_friend_story_main_page", Boolean.valueOf(bool));
            ...
            localwta.b("boolean_enable_multi_video_fragment", Boolean.valueOf(true));
            i = 0;
            if (i < j)
            {
              ...
              localwta.b("boolean_enable_multi_video_fragment", Boolean.valueOf(false));
            }
            i = localJSONObject.optInt("qim_sync_to_qq", 0);
            QLog.d("Q.qqstory.commonConfig", 2, "qim_sync_to_qq: " + paramList);
            localwta.b("key_qim_int_qim_sync_to_qq_default", Integer.valueOf(i));
            return true;
          }
          localwta.b("CertificationLinkText", "");
          localwta.b("CertificationLinkUrl", "");
          continue;
        }
        localwta.b("CertificationLinkText", "");
      }
      ...
      continue;
      label540:
      localwta.b("localVideoScanInterval", "1441");
      continue;
      label554:
      localwta.b("mainHallConfig", "");
      continue;
      label567:
      localwta.b("troopStoryHallConfig", "");
      continue;
      label580:
      localwta.b("key_share_encrypt_flag", Boolean.valueOf(false));
      continue;
      label595:
      localwta.b("key_show_in_friend_story_main_page", Boolean.valueOf(true));
      continue;
      label610:
      localwta.b("boolean_enable_multi_video_fragment", Boolean.valueOf(true));
      continue;
  ...
  public boolean a(int paramInt, Intent paramIntent, ConfigurationService.Config paramConfig)
  {
    ...
    Object localObject = wta.a(paramInt);
    int i = bhsi.a(QQStoryContext.a().getApp(), (String)localObject, str);
    int j = paramConfig.version.get();
    localObject = arry.a(paramConfig, i, paramInt);
    if (localObject == null) {
      return bool2;
    }
    switch (paramInt)
