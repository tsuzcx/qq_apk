...
public class nxo
  extends osp
{
  public nxo(ReadInJoyVideoSubChannelActivity paramReadInJoyVideoSubChannelActivity) {}
  ...
  public void a(int paramInt, List<Long> paramList)
  {
    ...
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      ...
      Object localObject2 = osj.a().a(ReadInJoyVideoSubChannelActivity.c(this.a), ((Long)localObject1).longValue());
    ...
    label270:
    this.a.jdField_a_of_type_Omw.b = 0L;
    paramList = this.a;
  ...
  public void a(boolean paramBoolean1, int paramInt, List<Long> paramList, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      {
        ReadInJoyVideoSubChannelActivity.a(this.a, this.a.getResources().getString(2131718536));
        continue;
        if (ReadInJoyVideoSubChannelActivity.a(this.a).isEmpty()) {
          ReadInJoyVideoSubChannelActivity.a(this.a, this.a.getResources().getString(2131718503));
        }
      }
    }
  }
  ...
  public void b(int paramInt, List<Long> paramList)
  {
    ...
    ReadInJoyVideoSubChannelActivity.a(this.a).b(osj.a().a(Integer.valueOf(ReadInJoyVideoSubChannelActivity.c(this.a)), paramList));
  ...
  public void b(boolean paramBoolean1, int paramInt, List<Long> paramList, boolean paramBoolean2)
  {
    ...
    for (paramBoolean1 = bool;; paramBoolean1 = false)
    {
      ...
      {
        paramList = this.a.getResources().getString(2131718326);
        bcpw.a(ReadInJoyVideoSubChannelActivity.a(this.a).getApplicationContext(), paramList, 0).a();
      }
      ReadInJoyVideoSubChannelActivity.d(this.a, false);
      return;
      paramBoolean2 = false;
  ...
  public void d(int paramInt)
  {
    if (paramInt == 97)
    {
      bcpw.a(ReadInJoyVideoSubChannelActivity.a(this.a), ajyc.a(2131712766), 0).a();
      ReadInJoyVideoSubChannelActivity.b(this.a, true);
    }
    while (paramInt != 98) {
      return;
    }
    bcpw.a(ReadInJoyVideoSubChannelActivity.a(this.a), ajyc.a(2131712836), 0).a();
