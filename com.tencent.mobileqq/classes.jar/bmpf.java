...
public class bmpf
{
  ...
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new bmpg(this);
  protected Handler a;
  ...
  public bmpf(QQBrowserActivity paramQQBrowserActivity)
  {
    ...
    for (;;)
    {
      try
      {
        if (this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.a() != null)
        {
          ...
          if (paramView != null)
          {
            Object localObject = paramView.getTag(2131375971);
            if ((localObject == null) || (!((Boolean)localObject).booleanValue())) {
              break label119;
            }
            i = 1;
            paramView.setTag(2131375968, Boolean.TRUE);
            if (i != 0)
            {
  ...
  {
    View localView = this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.findViewById(2131365171);
    if (localView == null) {
      return;
    }
    if (!paramBoolean)
