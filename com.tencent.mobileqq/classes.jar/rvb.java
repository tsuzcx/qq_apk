...
public class rvb
  extends pvq
{
  public rvb(ReadInJoyTopicSelectionFragment paramReadInJoyTopicSelectionFragment) {}
  ...
  public void a(List<String> paramList, List<TopicInfo> paramList1)
  {
    if (paramList.size() == 0)
    {
      ...
      pkh.a(ReadInJoyTopicSelectionFragment.a(this.a), ReadInJoyTopicSelectionFragment.a(this.a), "0");
    }
  }
}
