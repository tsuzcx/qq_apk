...
public class aqau
{
  private static aqau jdField_a_of_type_Aqau;
  ...
  private aqat jdField_a_of_type_Aqat = new aqat();
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  protected Runnable a;
  private ArrayList<aqaw> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private double jdField_b_of_type_Double;
  private long jdField_b_of_type_Long = 1800000L;
  
  private aqau(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaLangRunnable = new EnterpriseQQManager.1(this);
    this.jdField_a_of_type_Ampt = new aqav(this, 4, true, true, 0L, false, false, "EnterpriseQQManager");
    if (paramQQAppInterface != null) {
      a(paramQQAppInterface);
    }
  }
  
  public static aqau a(QQAppInterface paramQQAppInterface)
  {
    if (jdField_a_of_type_Aqau == null) {}
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      if (jdField_a_of_type_Aqau == null) {
        jdField_a_of_type_Aqau = new aqau(paramQQAppInterface);
      }
      return jdField_a_of_type_Aqau;
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Aqat != null) {
      return this.jdField_a_of_type_Aqat.a(paramString);
    }
    return null;
  }
  ...
  public void a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString1, String paramString2, boolean paramBoolean, double paramDouble1, double paramDouble2)
  {
    ...
    {
      paramContext = (alrr)paramQQAppInterface.a(21);
  ...
  {
    if (this.jdField_a_of_type_Aqat == null) {
      this.jdField_a_of_type_Aqat = new aqat();
    }
    if (paramQQAppInterface != null)
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_Aqat.a(localEnterpriseQQMenuEntity.uin, localGetCRMMenuResponse.button_info.get(), localEnterpriseQQMenuEntity.seqno, localEnterpriseQQMenuEntity.savedDateTime);
        continue;
        return;
      }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, StructMsg.GetCRMMenuResponse paramGetCRMMenuResponse)
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_Aqat.a(paramString) != paramInt) && (paramGetCRMMenuResponse != null))
      {
        ...
        for (;;)
        {
          this.jdField_a_of_type_Aqat.a(paramString, localList, paramInt, l);
          return;
    ...
    this.jdField_a_of_type_Aqat.a(paramString, l);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    if ((paramQQAppInterface != null) && (!TextUtils.isEmpty(paramString)))
    {
      long l = 0L;
      if (this.jdField_a_of_type_Aqat != null) {
        l = this.jdField_a_of_type_Aqat.a(paramString);
      }
      if ((paramBoolean) || ((!paramBoolean) && (System.currentTimeMillis() - l > 43200000L)))
      {
        paramQQAppInterface = (alrr)paramQQAppInterface.a(21);
        if (paramQQAppInterface != null) {
