...
public class bdmr
{
  ...
  {
    bdht.b("CommonUtils_", "genExistedAPKFileNameByUrl url = " + paramString);
    ...
    if (paramString.contains(".apk"))
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject1))
      {
        ...
        bdht.b("CommonUtils_", "genExistedAPKFileNameByUrl  fileName = " + paramString);
        return paramString;
      }
    }
    ...
    bdht.b("CommonUtils_", "genExistedAPKFileNameByUrl fileName == null, return fileName = " + (String)localObject1);
    return localObject1;
  }
  ...
  public static void a(ImageView paramImageView, String paramString)
  {
    try
    {
      ...
      localURLDrawableOptions.mFailedDrawable = BaseApplication.getContext().getResources().getDrawable(2130841354);
      localURLDrawableOptions.mLoadingDrawable = BaseApplication.getContext().getResources().getDrawable(2130841354);
      paramString = URLDrawable.getDrawable(paramString, localURLDrawableOptions);
      paramString.setAutoDownload(true);
      paramString.setURLDrawableListener(new bdms(paramImageView));
