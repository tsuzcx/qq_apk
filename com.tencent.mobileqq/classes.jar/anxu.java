  ...
  extends anii
{
  ...
  public anxu(QQAppInterface paramQQAppInterface)
  {
  ...
  private List<BusinessGroupWord> a(List<DynamicBusinessHotWord.GroupWord> paramList)
  {
    ...
    bbfi.jdField_a_of_type_JavaUtilHashMap.clear();
    bbfi.b.clear();
    ...
    while (localIterator.hasNext())
    {
      ...
      bblb localbblb = new bblb(((DynamicBusinessHotWord.GroupID)((DynamicBusinessHotWord.GroupWord)localObject1).group_id.get()).rpt_group_mask.get());
      ...
      bbfi.jdField_a_of_type_JavaUtilHashMap.put(bbfi.a(localbblb.a), localArrayList2);
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      if (localRspBody.search_ver.has()) {
        bbup.a("dynamic_unite_search.1", (long[])localObject2, localRspBody.search_ver.get().toStringUtf8());
      }
    ...
    {
      ((List)localObject2).add(new bbms((UniteSearch.TabItemGroup)paramObject.get(i)));
      i += 1;
    }
    i = localRspBody.trigger_netword_num.get();
    if (i >= 0) {
      bgsg.q(BaseApplicationImpl.getContext(), i);
    }
    paramObject = localRspBody.item_groups.get();
    paramToServiceMsg = new bbou().a(new Object[] { str1, paramObject, Integer.valueOf(paramToServiceMsg.extraData.getInt("fromType")) });
    ...
    for (;;)
    {
      try
      {
        ...
        if (((DynamicTabSearch.RspBody)localObject1).search_ver.has()) {
          bbup.a("dynamic_tab_search.1", arrayOfLong, ((DynamicTabSearch.RspBody)localObject1).search_ver.get().toStringUtf8());
        }
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilHashMap != null)
    {
      ...
      {
        localObject1 = (anxv)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramToServiceMsg.extraData.getLong("time_stamp")));
    ...
    try
    {
      ...
      ((anxv)localObject1).a(paramToServiceMsg.msg_search_keywords.rcmds, paramToServiceMsg.msg_search_keywords.sessionid);
      return;
    }
  ...
  public void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    if (!bgsg.a(paramQQAppInterface.getCurrentAccountUin(), paramInt))
    {
      if (QLog.isColorLevel()) {
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    paramQQAppInterface.sversion.set(a("8.4.1"));
  ...
  public void a(ByteStringMicro paramByteStringMicro, anxv paramanxv)
  {
    long l = System.currentTimeMillis();
    this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(l), paramanxv);
    paramanxv = new RequestSearchWord.ReqBody();
    paramanxv.bytes_rowkey.set(paramByteStringMicro);
    paramanxv.uint32_oper_type.set(1);
    paramByteStringMicro = qnf.a("OidbSvc.0xd78_0", 3448, 0, paramanxv.toByteArray());
    ...
    for (;;)
    {
      ...
      if (paramInt3 == 1)
      {
        ...
        if (!paramBoolean1)
        {
          ...
          ((DynamicSearch.RootSearcherRequest)localObject).rpt_busi_mask.set(bbup.a(jdField_a_of_type_ArrayOfLong));
        ...
        i = 2;
        arrayOfString = bgsg.a(this.app.getCurrentAccountUin());
  ...
  public void a(String paramString1, String paramString2, int paramInt1, List<Long> paramList1, List<Long> paramList2, byte[] paramArrayOfByte, int paramInt2, double paramDouble1, double paramDouble2, Bundle paramBundle)
  {
    ...
    ((DynamicSearch.ExtensionRequestInfo)localObject).longitude.set((float)paramDouble2);
    int i;
    if (bbfi.jdField_a_of_type_JavaUtilHashMap.isEmpty()) {
      i = 0;
    }
    boolean bool;
    ...
    do
    {
      ...
      sendPbReq(paramList2);
      return;
      localIterator1 = bbfi.jdField_a_of_type_JavaUtilHashMap.values().iterator();
      paramInt1 = 2;
      i = paramInt1;
    } while (!localIterator1.hasNext());
    Iterator localIterator2 = ((List)localIterator1.next()).iterator();
    while (localIterator2.hasNext()) {
      if (paramString1.equals((bblc)localIterator2.next())) {
        paramInt1 = 1;
      }
    }
    for (;;)
    ...
    for (;;)
    {
      try
      {
        ...
        if (localRspBody.error_msg.get() != null)
        {
          ...
          bgsg.a(this.app.getCurrentAccountUin(), i, localRspBody.expire_time.get());
          paramToServiceMsg = localRspBody.result_items.get();
          paramObject = bbof.a(this.app, paramToServiceMsg, i);
          if (localRspBody.bucket_id.get() == null) {
            break label278;
          }
          paramToServiceMsg = localRspBody.bucket_id.get().toStringUtf8();
          bbrf.jdField_b_of_type_JavaLangString = paramToServiceMsg;
