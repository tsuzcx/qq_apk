  ...
  extends WebViewPlugin
{
  ...
  public static String a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7)
  {
    ...
    //   0: aload_2
    //   1: sipush 640
    //   4: invokestatic 85	nmb:a	(Ljava/lang/String;I)Landroid/graphics/Bitmap;
    //   7: astore 9
    //   9: aload 9
    //   11: ifnonnull +15 -> 26
    //   14: aload 9
    ...
    //   36: getstatic 98	anhk:bs	Ljava/lang/String;
    ...
    //   50: invokestatic 111	bhgg:a	(Ljava/lang/String;)Ljava/lang/String;
    //   53: astore 10
    //   55: aload 9
    //   57: astore_2
    //   58: aload 9
    ...
    //   69: invokestatic 121	bgmo:a	(Landroid/graphics/Bitmap;Ljava/io/File;)V
    //   72: aload 9
    //   74: ifnull +8 -> 82
    //   77: aload 9
    ...
    //   91: ldc 126
    //   93: aload 5
    //   95: invokestatic 127	bfhe:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   411: aload_3
    //   412: aload_0
    //   413: invokestatic 185	nlw:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;)Ljava/lang/String;
    //   416: areturn
    //   417: astore_0
    //   418: aload_0
  ...
  public static void a(Activity paramActivity, int paramInt1, ArrayList<String> paramArrayList1, boolean[] paramArrayOfBoolean, ArrayList<String> paramArrayList2, boolean paramBoolean1, boolean paramBoolean2, String paramString1, int paramInt2, PublicAccountShowPictureReport paramPublicAccountShowPictureReport, String paramString2, String paramString3, ArticleInfo paramArticleInfo, String paramString4)
  {
    ...
    if (paramArticleInfo != null)
    {
      ...
      snh.a(paramArticleInfo, "", paramInt1, localBundle);
    }
    ...
    if ((pha.l(paramArticleInfo)) && (!TextUtils.isEmpty(paramString2))) {
      localBundle.putString("btntext", paramActivity.getString(2131717061));
    }
    localIntent.putExtras(localBundle);
    paramActivity.startActivityForResult(localIntent, paramInt2);
  }
  ...
  protected void a(String paramString)
  {
    try
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject8))
      {
        ...
        blsb.c((Activity)localObject2, (blsi)localObject3, (Bundle)localObject4, 6);
      }
      ...
      for (;;)
      {
        ...
        localObject5 = bgku.encodeToString(((JSONObject)localObject6).optString("title", "").getBytes(), 0);
        ...
        if (bool1)
        {
          if (localObject8 != null)
          {
            ...
            {
              this.jdField_a_of_type_AndroidContentBroadcastReceiver = new bfhf(this);
    ...
    try
    {
      ...
      if (localAppInterface != null)
      {
        ...
        if (localActivity != null)
        {
          ...
          String str5 = bjsy.a(localAppInterface);
