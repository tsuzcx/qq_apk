...
{
  public int a;
  private anyu jdField_a_of_type_Anyu = new aoae(this);
  public bjbs a;
  ...
  public aoad(BaseActivity paramBaseActivity, QQAppInterface paramQQAppInterface, HotChatInfo paramHotChatInfo)
  {
  ...
  private void d()
  {
    ...
    for (String str1 = this.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo.joinUrl.substring(i + 12);; str1 = null)
    {
      ...
      String str3 = anzr.a(str1, this.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo.userCreate);
      if (this.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo.userCreate != 1)
      {
        anzr.a(2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo.name, this.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo.troopUin, str3, str1, anzj.a(2131704496) + this.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo.name + anzj.a(2131704491), anzj.a(2131704493), null, null);
        return;
      }
      String str2 = anzj.a(2131704490);
      if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
        str2 = anzj.a(2131704494) + this.jdField_a_of_type_JavaLangString + anzj.a(2131704495);
      }
      ...
      anzr.a(2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo.name, this.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo.troopUin, str3, str1, anzj.a(2131704489) + this.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo.name + anzj.a(2131704492), str2, this.b, str4);
      return;
    }
  }
  ...
  public void a(HotChatInfo paramHotChatInfo)
  {
    ...
    this.jdField_a_of_type_Int = 0;
    this.jdField_a_of_type_JavaLangString = bhlg.q(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo.ownerUin);
    if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
