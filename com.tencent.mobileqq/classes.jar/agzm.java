  ...
  implements ahan
{
  ...
  public agzm(QQAppInterface paramQQAppInterface, ahap paramahap, Context paramContext, SessionInfo paramSessionInfo, MqqHandler paramMqqHandler)
  {
  ...
  {
    View localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131561671, null);
    TextView localTextView = (TextView)localView.findViewById(2131362407);
    String str = (String)paramVarArgs[0];
    int i = ((Integer)paramVarArgs[1]).intValue();
    localTextView.setText(str);
    localView.setOnClickListener(new agzn(this, i));
    return localView;
  }
  ...
  public void a()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        bdfc.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "SecWarningCfg");
        Object localObject = (Bundle)bdfc.a().a("SecWarningCfg", "BannerWording", 146, i);
        if (localObject != null)
        {
          ...
          if (!this.jdField_a_of_type_Ahap.a(this, new Object[] { localObject, Integer.valueOf(i) })) {
            continue;
          }
          this.jdField_a_of_type_Int = 1;
          azqs.b(null, "P_CliOper", "Safe_AntiFraud", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "banner", "display", i, 0, "", "", "", "");
          Timer localTimer = new Timer();
          FraudTipsBar.1 local1 = new FraudTipsBar.1(this);
          localObject = (Bundle)bdfc.a().a("SecWarningCfg", "BannerTTL", 146, i);
          if (localObject != null)
          {
