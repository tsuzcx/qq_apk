...
{
  agzm(Context paramContext, int paramInt, URLDrawable paramURLDrawable, QQAppInterface paramQQAppInterface, StructMsgForImageShare paramStructMsgForImageShare, PicMessageExtraData paramPicMessageExtraData) {}
  ...
  protected Integer a(Void... paramVarArgs)
  {
    ...
    paramVarArgs = agzl.a(this.jdField_a_of_type_AndroidContentContext, paramVarArgs);
    if (paramVarArgs != null)
    {
      agzl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForImageShare, paramVarArgs);
    ...
    for (paramVarArgs = SecUtil.getFileMd5(localFile.getAbsolutePath());; paramVarArgs = null)
    {
      ...
      {
        paramVarArgs = AppConstants.SDCARD_IMG_FAVORITE + anws.a(str2) + paramVarArgs + str1 + ".jpg";
        try
        {
          FileUtils.copyFile(localFile, new File(paramVarArgs));
          return Integer.valueOf(agzl.a(this.jdField_a_of_type_AndroidContentContext, paramVarArgs, this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForImageShare, this.jdField_a_of_type_ComTencentMobileqqDataPicMessageExtraData));
        }
  ...
  protected void a(Integer paramInteger)
  {
    ...
    {
      QQToast.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 2131694478, 0).b(this.jdField_a_of_type_Int);
      avsq.c("2004", 1);
    }
