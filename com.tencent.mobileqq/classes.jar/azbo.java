...
public class azbo
{
  ...
  {
    switch (azbp.a[paramStatus.ordinal()])
    {
    default: 
  ...
  public static String a(AppRuntime.Status paramStatus)
  {
    if (paramStatus != null)
    {
      ...
      default: 
        ...
        return "";
      case 1: 
        return BaseApplicationImpl.getContext().getString(2131718977);
      case 2: 
        return BaseApplicationImpl.getContext().getString(2131718978);
      case 3: 
        return BaseApplicationImpl.getContext().getString(2131718967);
      case 4: 
        return BaseApplicationImpl.getContext().getString(2131718969);
      case 5: 
        return BaseApplicationImpl.getContext().getString(2131718973);
      }
      return BaseApplicationImpl.getContext().getString(2131718975);
    }
