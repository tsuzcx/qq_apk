...
public class agta
{
  ...
  public agta(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(SpringFestivalRedpacketConfBean paramSpringFestivalRedpacketConfBean)
  {
    ...
    agtk localagtk = (agtk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(342);
    if ((localagtk != null) && (paramSpringFestivalRedpacketConfBean != null)) {
      localagtk.a(paramSpringFestivalRedpacketConfBean.springFestivalHbEntryInfo);
    }
  }
  ...
  private SpringFestivalRedpacketConfBean b()
  {
    ...
    //   7: astore_2
    //   8: aload_0
    //   9: getfield 15	agta:jdField_a_of_type_ArrayOfByte	[B
    //   12: astore 7
    //   14: aload 7
    //   16: monitorenter
    ...
    //   29: aload_0
    //   30: getfield 17	agta:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   57: ifeq +138 -> 195
    //   60: aload_0
    //   61: invokespecial 191	agta:a	()Ljava/lang/String;
    //   64: aload_1
    //   65: invokevirtual 194	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   68: invokestatic 199	bcdu:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   191: aload_0
    //   192: invokespecial 242	agta:a	()V
    //   195: aconst_null
    //   196: astore_3
    //   197: aconst_null
    //   198: astore 5
    ...
    //   225: aload_0
    //   226: invokespecial 242	agta:a	()V
  ...
  private void b(SpringFestivalRedpacketConfBean paramSpringFestivalRedpacketConfBean)
  {
    ...
    //   4: astore 4
    //   6: aload_0
    //   7: getfield 15	agta:jdField_a_of_type_ArrayOfByte	[B
    //   10: astore 6
    //   12: aload 6
    //   14: monitorenter
    //   15: aload_0
    //   16: getfield 17	agta:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   203: invokestatic 199	bcdu:a	(Ljava/lang/String;)Ljava/lang/String;
    //   206: astore 5
    //   208: aload_0
    //   209: aload_1
    ...
    //   213: aload 5
    //   215: invokespecial 146	agta:a	(ILjava/lang/String;)V
    //   218: aload_2
    //   219: ifnull +7 -> 226
    //   222: aload_2
    ...
    //   272: aload_0
    //   273: invokespecial 242	agta:a	()V
    //   276: aload_2
    //   277: ifnull +7 -> 284
    //   280: aload_2
  ...
  private int c()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 17	agta:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   20: aload_0
    //   21: getfield 17	agta:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
  ...
  public boolean a(boolean paramBoolean, int paramInt1, int paramInt2, String paramString, List<Integer> paramList, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      if ((paramString != null) && (paramString.htmlOfflineCheckConfig != null)) {
        agvn.b(paramString.htmlOfflineCheckConfig.bids, paramInt2, paramInt1);
      }
      return paramBoolean;
      localObject1 = localObject3;
