...
public class agta
  extends agsu
  implements agsr, agss, vuf
{
  public agsp a;
  
  protected agta(NewPhotoPreviewActivity paramNewPhotoPreviewActivity)
  {
    super(paramNewPhotoPreviewActivity);
    this.jdField_a_of_type_Agsr = this;
    this.jdField_a_of_type_Agss = this;
    this.a = new agsp();
    this.jdField_a_of_type_Agsp = ((agsp)this.a);
  }
  
  public static agsq a(NewPhotoPreviewActivity paramNewPhotoPreviewActivity)
  {
    ...
    {
      if ((jdField_a_of_type_Agsq == null) || (jdField_a_of_type_Agsq.jdField_a_of_type_MqqUtilWeakReference.get() != paramNewPhotoPreviewActivity)) {
        jdField_a_of_type_Agsq = new agta(paramNewPhotoPreviewActivity);
      }
  ...
  private void i()
  {
    ...
    ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).findViewById(2131363296));
    ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).findViewById(2131363294));
    if (this.jdField_a_of_type_Agrz.a()) {
      ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Boolean = bkvi.a(((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidWidgetLinearLayout, ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidWidgetRelativeLayout, 0);
    }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Agst != null) {
      this.jdField_a_of_type_Agst.aq_();
    }
    String str = "";
    if (((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).a() != -1)
    {
      str = (String)this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList.get(((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).a());
      this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilArrayList.add(str);
      this.jdField_a_of_type_Agrz.jdField_b_of_type_JavaUtilArrayList.add(Integer.valueOf(((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).a()));
      if (this.jdField_a_of_type_Agrz.a())
      {
    ...
    d();
    b((String)this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList.get(((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).a()));
  }
  
  public void a(int paramInt1, int paramInt2)
  {
    if ((paramInt1 >= 0) && (paramInt1 < this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilArrayList.size()) && (paramInt2 >= 0) && (paramInt2 < this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilArrayList.size()))
    {
      Collections.swap(this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilArrayList, paramInt1, paramInt2);
      if (this.jdField_a_of_type_Agsp.jdField_a_of_type_Vud != null)
      {
        String str = this.jdField_a_of_type_Agsp.jdField_a_of_type_Vud.a();
  ...
  protected void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    PhotoUtils.a((Activity)this.jdField_a_of_type_MqqUtilWeakReference.get(), paramInt1, paramInt2, paramIntent, this.jdField_a_of_type_Agsp.jdField_j_of_type_Boolean, this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaLangString);
  }
  ...
  protected void a(Intent paramIntent)
  {
    ...
    this.jdField_a_of_type_Agsp.n = BaseApplicationImpl.getApplication().getSharedPreferences(BaseApplicationImpl.getApplication().getRuntime().getAccount(), 4).getBoolean("showFlashPic", true);
    this.jdField_a_of_type_Agsp.l = paramIntent.getBooleanExtra("showFlashPic", false);
    this.jdField_a_of_type_Agsp.jdField_f_of_type_Int = paramIntent.getIntExtra("PhotoConst.SEND_BUSINESS_TYPE", -1);
    this.jdField_a_of_type_Agsp.jdField_g_of_type_Int = paramIntent.getIntExtra("camera_front_back", 0);
    this.jdField_a_of_type_Agsp.jdField_h_of_type_Int = paramIntent.getIntExtra("camera_filter_id", -1);
    this.jdField_a_of_type_Agsp.jdField_k_of_type_Int = paramIntent.getIntExtra("camera_capture_method", -1);
    this.jdField_a_of_type_Agsp.jdField_h_of_type_Boolean = paramIntent.getBooleanExtra("PhotoConst.IS_FROM_EDIT", false);
    this.jdField_a_of_type_Agsp.p = paramIntent.getBooleanExtra("ReceiptMsgManager.EXTRA_KEY_IS_RECEIPT", false);
    this.jdField_a_of_type_Agsp.jdField_d_of_type_Boolean = paramIntent.getBooleanExtra("PhotoConst.USE_URL_PATH", false);
    this.jdField_a_of_type_Agsp.jdField_b_of_type_JavaUtilHashMap = ((HashMap)paramIntent.getSerializableExtra("PhotoConst.PHOTO_PATHS_FROM_QZONEALBUM"));
    this.jdField_a_of_type_Agsp.jdField_d_of_type_JavaUtilHashMap = ((HashMap)paramIntent.getSerializableExtra("PhotoConst.PHOTO_INFOS"));
    this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilHashMap = ((HashMap)paramIntent.getSerializableExtra("PhotoConst.editPathMap"));
    if (this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilHashMap == null) {
      this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilHashMap = new HashMap();
    }
    this.jdField_a_of_type_Agsp.jdField_e_of_type_JavaUtilHashMap = new HashMap(1);
    if (this.jdField_a_of_type_Agsp.jdField_d_of_type_JavaUtilHashMap != null) {
      this.jdField_a_of_type_Agsp.jdField_e_of_type_JavaUtilHashMap.putAll(this.jdField_a_of_type_Agsp.jdField_d_of_type_JavaUtilHashMap);
    }
    this.jdField_a_of_type_Agsp.jdField_c_of_type_JavaUtilHashMap = new HashMap(1);
    if (this.jdField_a_of_type_Agsp.jdField_b_of_type_JavaUtilHashMap != null) {
      this.jdField_a_of_type_Agsp.jdField_c_of_type_JavaUtilHashMap.putAll(this.jdField_a_of_type_Agsp.jdField_b_of_type_JavaUtilHashMap);
    }
    if (QLog.isColorLevel()) {
      QLog.d("aioSendPhotos", 2, "mCanUseURL:" + this.jdField_a_of_type_Agsp.jdField_d_of_type_Boolean + " mSelectedSendParams size:" + this.jdField_a_of_type_Agsp.jdField_c_of_type_JavaUtilHashMap.size());
    }
    ...
    this.jdField_a_of_type_Agsp.jdField_e_of_type_Boolean = paramIntent.getBooleanExtra("PhotoConst.HANDLE_DEST_RESULT", false);
    this.jdField_a_of_type_Agsp.jdField_f_of_type_Boolean = paramIntent.getBooleanExtra("PhotoConst.SHOULD_SEND_RAW_PHOTO", false);
    if (!this.jdField_a_of_type_Agsp.jdField_g_of_type_Boolean) {
      this.jdField_a_of_type_Agsp.jdField_g_of_type_Boolean = paramIntent.getBooleanExtra("PhotoConst.SHOW_MAGIC_USE_PASTER", false);
    }
    if ("FROM_QZONE_PHOTO_LIST".equals(this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaLangString)) {
      this.jdField_a_of_type_Agsp.jdField_g_of_type_Boolean = false;
    }
    if (this.jdField_a_of_type_Agsp.jdField_g_of_type_Boolean)
    {
      this.jdField_a_of_type_Agsp.jdField_f_of_type_JavaUtilHashMap = ((HashMap)paramIntent.getSerializableExtra("PasterConstants.pasters_data"));
      this.jdField_a_of_type_Agsp.jdField_e_of_type_JavaLangString = paramIntent.getStringExtra("PasterConstants.paster_id");
      this.jdField_a_of_type_Agsp.jdField_f_of_type_JavaLangString = paramIntent.getStringExtra("PasterConstants.paster_cate_id");
    }
    this.jdField_a_of_type_Agsp.jdField_e_of_type_Int = paramIntent.getIntExtra("uintype", -1);
    this.jdField_a_of_type_Agsp.jdField_j_of_type_Boolean = paramIntent.getBooleanExtra("PhotoConst.IS_CALL_IN_PLUGIN", false);
    this.jdField_a_of_type_Agsp.jdField_k_of_type_Boolean = paramIntent.getBooleanExtra("PhotoConst.IS_SINGLE_DERECTBACK_MODE", false);
    this.jdField_a_of_type_Agrz.c = paramIntent.getIntExtra("PhotoConst.CURRENT_QUALITY_TYPE", 0);
    this.jdField_a_of_type_Agsp.q = paramIntent.getBooleanExtra("PhotoConst.SEND_FLAG", false);
    if (this.jdField_a_of_type_Agsp.q)
    {
      ...
      PhotoUtils.a((Activity)this.jdField_a_of_type_MqqUtilWeakReference.get(), paramIntent, this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilArrayList, this.jdField_a_of_type_Agrz.c, true);
    }
    this.jdField_a_of_type_Agsp.jdField_i_of_type_Int = paramIntent.getIntExtra("key_pic_to_edit_from", 0);
  }
  ...
  public void a(Intent paramIntent, boolean paramBoolean, ArrayList<String> paramArrayList)
  {
    ...
    if (((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).a((String)localObject1) == 1)
    {
      ...
      {
        bcql.a((Context)this.jdField_a_of_type_MqqUtilWeakReference.get(), ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).getResources().getString(2131719567), 0).b(((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).getResources().getDimensionPixelSize(2131298865));
    ...
    do
    {
      ...
      catch (Exception localException2)
      {
        for (;;)
        {
          ...
          if (QLog.isColorLevel())
          {
            ...
            if (paramBoolean)
            {
              PhotoUtils.a((Activity)this.jdField_a_of_type_MqqUtilWeakReference.get(), paramIntent, paramArrayList, this.jdField_a_of_type_Agsp.jdField_c_of_type_JavaUtilHashMap, this.jdField_a_of_type_Agrz.c, true);
            ...
            for (;;)
            {
              ...
              return;
              PhotoUtils.a((Activity)this.jdField_a_of_type_MqqUtilWeakReference.get(), paramIntent, paramArrayList, this.jdField_a_of_type_Agrz.c, this.jdField_a_of_type_Agsp.jdField_e_of_type_Boolean);
            }
            i = 0;
          }
        }
      ...
      str = ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).getResources().getString(2131719257);
      ...
      if (bcwb.a((Activity)this.jdField_a_of_type_MqqUtilWeakReference.get(), 4, new agtg(this, paramIntent))) {
        bbdj.a((Context)this.jdField_a_of_type_MqqUtilWeakReference.get(), 232, null, str, new agth(this, paramIntent), new agti(this)).show();
      }
  ...
  protected void a(View paramView)
  {
    ...
    if (this.jdField_a_of_type_Agrz.jdField_b_of_type_JavaUtilArrayList.contains(Integer.valueOf(i)))
    {
      ...
      int j = this.jdField_a_of_type_Agrz.jdField_b_of_type_JavaUtilArrayList.indexOf(Integer.valueOf(i));
      if (j >= 0)
      {
        this.jdField_a_of_type_Agrz.jdField_b_of_type_JavaUtilArrayList.remove(j);
        if (i != -1)
        {
          this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilArrayList.remove(this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList.get(i));
          if (this.jdField_a_of_type_Agsp.jdField_e_of_type_JavaUtilHashMap != null) {
            this.jdField_a_of_type_Agsp.jdField_e_of_type_JavaUtilHashMap.remove(this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList.get(i));
          }
          if (this.jdField_a_of_type_Agsp.jdField_c_of_type_JavaUtilHashMap != null) {
            this.jdField_a_of_type_Agsp.jdField_c_of_type_JavaUtilHashMap.remove(this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList.get(i));
          }
          if (paramView != null) {
            paramView.b((String)this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList.get(i), 1014);
          }
        }
      }
      d();
    ...
    for (;;)
    {
      if ((this.jdField_a_of_type_Agrz.a()) && (i != -1)) {
        b((String)this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList.get(i));
      }
      ...
      do
      {
        ...
        localObject = (String)this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList.get(i);
        localLocalMediaInfo = ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).b((String)localObject);
      } while ((this.jdField_a_of_type_Agrz.c == 2) && (c()));
      if ((this.jdField_a_of_type_Agrz.a()) && (!bkpv.a((Activity)this.jdField_a_of_type_MqqUtilWeakReference.get(), localLocalMediaInfo)))
      {
        ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.setChecked(false);
        return;
      }
      if ((((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).getIntent().getBooleanExtra("PhotoConst.IS_SEND_GIF_SIZE_LIMIT", false)) && (aupa.a((String)localObject)) && (bbdx.a((String)localObject) > 3145728L))
      {
        bcql.a((Context)this.jdField_a_of_type_MqqUtilWeakReference.get(), "图片文件过大", 0).b(this.jdField_a_of_type_Agsp.jdField_a_of_type_Int);
        ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.setChecked(false);
        return;
      }
      if ((paramView != null) && (!this.jdField_a_of_type_Agsp.m) && (((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).a((String)this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList.get(i)) != 1)) {
        paramView.a((String)this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList.get(i), this.jdField_a_of_type_Agsp.jdField_j_of_type_Int);
      }
      paramView = (String)this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList.get(i);
      ...
      if (this.jdField_a_of_type_Agsp.jdField_d_of_type_JavaUtilHashMap != null)
      {
        localObject = (PicInfo)this.jdField_a_of_type_Agsp.jdField_d_of_type_JavaUtilHashMap.get(paramView);
      ...
      this.jdField_a_of_type_Agrz.jdField_b_of_type_JavaUtilArrayList.add(Integer.valueOf(i));
      if (this.jdField_a_of_type_Agrz.a())
      {
        if (this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilHashMap == null) {
          this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilHashMap = new HashMap();
        ...
        this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilHashMap.put(paramView, localObject);
      }
  ...
  protected void a(View paramView, int paramInt1, Bundle paramBundle, int paramInt2, Intent paramIntent)
  {
    int i = ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).a();
    if (i != -1) {
      this.jdField_a_of_type_Agsp.jdField_d_of_type_JavaLangString = ((String)this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList.get(i));
    }
    if (this.jdField_a_of_type_Agsp.jdField_d_of_type_JavaLangString != null)
    {
      ...
      if (this.jdField_a_of_type_Agsp.jdField_g_of_type_Boolean)
      {
        ...
        if (paramIntent == null) {
          paramView = EditPicActivity.a((Activity)this.jdField_a_of_type_MqqUtilWeakReference.get(), this.jdField_a_of_type_Agsp.jdField_d_of_type_JavaLangString, true, true, true, true, true, paramInt2, 99, 4, paramBundle);
        }
        paramView.putExtra("PhotoConst.CURRENT_QUALITY_TYPE", this.jdField_a_of_type_Agrz.c);
        if (!this.jdField_a_of_type_Agsp.m) {
          break label368;
        }
        ...
        if ((a()) && (this.jdField_a_of_type_Agsp.jdField_i_of_type_Int > 0))
        {
          paramInt2 = this.jdField_a_of_type_Agsp.jdField_i_of_type_Int;
    ...
    label386:
    label404:
    for (paramInt1 = this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilArrayList.size();; paramInt1 = 0)
    {
      axqy.b(null, "dc00898", "", "", "0X800A06D", "0X800A06D", paramInt2, 0, paramInt1 + "", "", "", "");
      LpReportInfo_pf00064.allReport(603, 4, 1);
      return;
      label368:
      paramView.putExtra("PhotoConst.SEND_BUSINESS_TYPE", this.jdField_a_of_type_Agsp.jdField_f_of_type_Int);
      break;
  ...
  public void a(CompoundButton paramCompoundButton, boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      if (!paramBoolean)
      {
        ...
        if (bbbx.a(this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilArrayList, this.jdField_a_of_type_Agrz.jdField_b_of_type_Int, this.jdField_a_of_type_Agrz.jdField_b_of_type_JavaUtilHashMap, true, this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilHashMap) <= 0) {
          break label202;
        }
        bcql.a((Context)this.jdField_a_of_type_MqqUtilWeakReference.get(), ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).getResources().getString(2131695113), 0).b(((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).getResources().getDimensionPixelSize(2131298865));
        this.jdField_a_of_type_Agrz.c = 0;
        ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_b_of_type_AndroidWidgetTextView.setText(((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).getString(2131695117));
        ...
        do
        {
          do
          {
            do
            {
              ...
              } while (j >= this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList.size());
              long l = new File((String)this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList.get(j)).length();
              if (((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).a((String)this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList.get(j)) == 1) {}
              for (int i = 1; (i == 0) && (l > ayxe.a()); i = 0)
              {
                bcql.a((Context)this.jdField_a_of_type_MqqUtilWeakReference.get(), ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).getResources().getString(2131695113), 0).b(((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).getResources().getDimensionPixelSize(2131298865));
                this.jdField_a_of_type_Agrz.c = 0;
                ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_b_of_type_AndroidWidgetTextView.setText(((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).getString(2131695117));
              ...
              this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilArrayList.add(this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList.get(j));
              this.jdField_a_of_type_Agrz.jdField_b_of_type_JavaUtilArrayList.add(Integer.valueOf(j));
              ...
              if ((paramCompoundButton != null) && (((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).a((String)this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList.get(j)) != 1)) {
                paramCompoundButton.a((String)this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList.get(j), this.jdField_a_of_type_Agsp.jdField_j_of_type_Int);
              }
          ...
          return;
          if (bbbx.a(this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilArrayList, 104345600L, this.jdField_a_of_type_Agrz.jdField_b_of_type_JavaUtilHashMap, true, this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilHashMap) > 0)
          {
            bcql.a((Context)this.jdField_a_of_type_MqqUtilWeakReference.get(), ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).getResources().getString(2131719589), 0).b(((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).getResources().getDimensionPixelSize(2131298865));
            bbbx.d();
          }
  ...
  protected void a(TextView paramTextView)
  {
    ...
    Object localObject2 = this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (((Iterator)localObject2).hasNext())
    {
      ...
      if ((!NetworkUtils.isNetworkUrl(str)) && (((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).a(str) == 1)) {
        paramTextView.setText(((Resources)localObject1).getString(2131695117));
      }
    }
    int i = bbbx.a(this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilArrayList, this.jdField_a_of_type_Agrz.jdField_b_of_type_JavaUtilHashMap, false, this.jdField_a_of_type_Agsp.jdField_c_of_type_JavaUtilHashMap, this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilHashMap);
    localObject2 = PhotoUtils.a((Context)this.jdField_a_of_type_MqqUtilWeakReference.get(), i);
    if ((this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilArrayList.size() == 0) || (((String)localObject2).equals("0"))) {}
    for (localObject1 = ((Resources)localObject1).getString(2131695117);; localObject1 = ((Resources)localObject1).getString(2131695117) + "(共" + (String)localObject2 + ")")
    {
  ...
  public void a(SlideItemInfo paramSlideItemInfo)
  {
    ...
    if (this.jdField_a_of_type_Agst != null) {
      this.jdField_a_of_type_Agst.a_(paramSlideItemInfo);
    }
    int i = 0;
    label24:
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilArrayList.remove(paramSlideItemInfo.jdField_b_of_type_JavaLangString);
      d();
  ...
  protected void a(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    paramAdapterView = ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Agrw.a(paramInt);
    try
    {
      ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_ComTencentWidgetDragView.setOriginRect(((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).b((String)this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).thumbRect);
      if (this.jdField_a_of_type_Agrz.a())
      {
        if (paramAdapterView != null) {
          ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).a(paramAdapterView);
        }
        b((String)this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList.get(paramInt));
      }
      return;
    }
  ...
  {
    int j = 0;
    if ((this.jdField_a_of_type_Agrz.a()) && (!this.jdField_a_of_type_Agsp.jdField_i_of_type_Boolean))
    {
      this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList.clear();
      this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList.addAll(this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilArrayList);
      ...
      ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Agrw.notifyDataSetChanged();
      this.jdField_a_of_type_Agsp.jdField_i_of_type_Boolean = true;
    }
    int i = this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList.indexOf(paramString);
    if (i < 0) {
      i = j;
    }
    for (;;)
  ...
  {
    if (this.jdField_a_of_type_Agsp.jdField_h_of_type_Boolean) {
      vtz.a().a(vtz.a().c());
    }
    Intent localIntent1 = ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).getIntent();
    localIntent1.putExtra("PhotoConst.SEND_BUSINESS_TYPE", this.jdField_a_of_type_Agsp.jdField_f_of_type_Int);
    if ("FROM_PHOTO_LIST".equals(this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaLangString))
    {
      ...
      localIntent1.putExtra("PhotoConst.CURRENT_QUALITY_TYPE", this.jdField_a_of_type_Agrz.c);
    ...
    for (;;)
    {
      localIntent1.putExtra("PhotoConst.PHOTO_PATHS_FROM_QZONEALBUM", this.jdField_a_of_type_Agsp.jdField_c_of_type_JavaUtilHashMap);
      localIntent1.putExtra("PhotoConst.PHOTO_INFOS", this.jdField_a_of_type_Agsp.jdField_e_of_type_JavaUtilHashMap);
      ...
      if (localIntent1.getBooleanExtra("keep_selected_status_after_finish", false))
      {
        ...
        localIntent1.putStringArrayListExtra("PhotoConst.SELECTED_PATHS", this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilArrayList);
        localIntent1.putIntegerArrayListExtra("PhotoConst.SELECTED_INDEXS", this.jdField_a_of_type_Agrz.jdField_b_of_type_JavaUtilArrayList);
        localIntent1.putExtra("PhotoConst.CURRENT_QUALITY_TYPE", this.jdField_a_of_type_Agrz.c);
        localIntent1.putExtra("PhotoConst.editPathMap", this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilHashMap);
      ...
      if (paramBoolean) {
        try
        {
          ...
          return;
          localIntent1.putStringArrayListExtra("PhotoConst.PHOTO_PATHS", this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilArrayList);
          localIntent1.putExtra("PhotoConst.editPathMap", this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilHashMap);
          continue;
          if (!"FROM_QZONE_PHOTO_LIST".equals(this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaLangString)) {
            break label161;
          ...
          localIntent2.putStringArrayListExtra("PhotoConst.PHOTO_PATHS", this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilArrayList);
          localIntent2.putExtra("PhotoConst.PHOTO_PATHS_FROM_QZONEALBUM", this.jdField_a_of_type_Agsp.jdField_c_of_type_JavaUtilHashMap);
          localIntent2.putExtra("PhotoConst.CURRENT_QUALITY_TYPE", this.jdField_a_of_type_Agrz.c);
          localIntent2.putExtra("PeakConstants.selectedMediaInfoHashMap", this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilHashMap);
    ...
    bbbx.a((Activity)this.jdField_a_of_type_MqqUtilWeakReference.get(), true, false);
  }
  ...
  void b(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    do
    {
      ...
      paramInt1 = this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList.indexOf(str1);
    } while (paramInt1 < 0);
    if (this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilHashMap.containsValue(str1)) {}
    for (paramIntent = agpk.a(this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilHashMap, str1);; paramIntent = str1)
    {
      this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilHashMap.put(paramIntent, str2);
      this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList.add(paramInt1, str2);
      this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList.remove(paramInt1 + 1);
      paramInt2 = this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilArrayList.indexOf(str1);
      if (paramInt2 >= 0)
      {
        this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilArrayList.add(paramInt2, str2);
        this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilArrayList.remove(paramInt2 + 1);
      }
      ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Agrw.notifyDataSetChanged();
      ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Agrx.notifyDataSetChanged();
      ...
      paramIntent.a(str2, this.jdField_a_of_type_Agsp.jdField_j_of_type_Int);
      return;
    }
  }
  ...
  void b(String paramString)
  {
    ...
    {
      if (this.jdField_a_of_type_Agsp.jdField_a_of_type_Vud == null) {
        this.jdField_a_of_type_Agsp.jdField_a_of_type_Vud = new vud((Activity)this.jdField_a_of_type_MqqUtilWeakReference.get(), this);
      }
      vtz.a().a(this.jdField_a_of_type_Agsp.jdField_a_of_type_Vud);
      vtz.a().b(this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilArrayList, this.jdField_a_of_type_Agrz.jdField_b_of_type_JavaUtilHashMap);
      vtz.a().a((Activity)this.jdField_a_of_type_MqqUtilWeakReference.get());
      this.jdField_a_of_type_Agsp.jdField_a_of_type_Vud.a(this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilArrayList.indexOf(paramString));
  ...
  {
    this.jdField_a_of_type_Agsp.m = paramBoolean;
    if (paramBoolean)
    {
      this.jdField_a_of_type_Agsp.o = true;
      ...
      if (!paramBoolean)
      {
        ...
        if ((this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilArrayList.isEmpty()) && (((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_ComTencentMobileqqActivityPhotoDragGallery.getFirstVisiblePosition() < this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList.size()))
        {
          ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_b_of_type_AndroidViewView.performClick();
          d();
        }
        if ((this.jdField_a_of_type_Agsp.n) && (((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_ComTencentWidgetBubblePopupWindow == null))
        {
          this.jdField_a_of_type_Agsp.n = false;
          ...
          int i = actj.a(10.0F, ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).getResources());
        ...
        if (this.jdField_a_of_type_Agsp.jdField_e_of_type_Int != 0) {
          break label392;
        }
    ...
    do
    {
      do
      {
        ...
        paramBoolean = false;
        break;
        if (this.jdField_a_of_type_Agsp.jdField_e_of_type_Int == 3000)
        {
          axqy.b(null, "dc00898", "", "", "0X8006998", "0X8006998", 0, 0, "", "", "", "");
          return;
        }
      } while (this.jdField_a_of_type_Agsp.jdField_e_of_type_Int != 1);
  ...
  protected void c()
  {
    ...
    ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_ComTencentWidgetDragView.setGestureChangeListener((bfqu)this.jdField_a_of_type_MqqUtilWeakReference.get());
    ...
    if (localObject1 != null) {
      if (((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Boolean)
      {
        i = bkvi.jdField_a_of_type_Int;
        ((Rect)localObject1).top -= i;
        ((Rect)localObject1).bottom -= i;
        if ((this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList != null) && (-1 != this.jdField_a_of_type_Agsp.jdField_d_of_type_Int) && (this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_a_of_type_Agsp.jdField_d_of_type_Int) != null))
        {
          localObject2 = ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).b((String)this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_a_of_type_Agsp.jdField_d_of_type_Int));
        ...
        if (this.jdField_a_of_type_Agsp.jdField_a_of_type_Boolean)
        {
        ...
        if ((this.jdField_a_of_type_Agsp.l) && (this.jdField_a_of_type_Agsp.jdField_e_of_type_JavaUtilHashMap.size() == 0))
        {
          ...
          ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new agtb(this));
        ...
        if (!this.jdField_a_of_type_Agsp.jdField_f_of_type_Boolean) {
          break label1216;
        }
        ...
        ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new agtc(this));
        ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_b_of_type_AndroidWidgetButton.setOnClickListener(new agtd(this));
        d();
        if ((this.jdField_a_of_type_Agsp.jdField_k_of_type_Boolean) || (this.jdField_a_of_type_Agsp.jdField_c_of_type_Boolean))
        {
        ...
        ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_ComTencentMobileqqActivityPhotoDragGallery.setOnItemClickListener(new agtf(this));
        if (this.jdField_a_of_type_Agrz.a()) {
          ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_c_of_type_AndroidWidgetTextView.setText("");
        }
        if (this.jdField_a_of_type_Agsp.jdField_e_of_type_Int == 1001)
        {
          ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_b_of_type_AndroidWidgetCheckBox.setVisibility(8);
          ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
        }
    ...
    for (;;)
    {
      ...
      actj.a(((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidWidgetButton, (int)(10.0F * f + 0.5F), (int)(10.0F * f + 0.5F), (int)(10.0F * f + 0.5F), (int)(f * 10.0F + 0.5F));
      return;
    }
  }
  ...
  {
    int i = ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).a();
    if ((this.jdField_a_of_type_Agrz.a()) && (i != -1) && (new File((String)this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList.get(i)).length() > ayxe.a()))
    {
      bcql.a((Context)this.jdField_a_of_type_MqqUtilWeakReference.get(), ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).getResources().getString(2131695113), 0).b(((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).getResources().getDimensionPixelSize(2131298865));
      ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.setChecked(false);
      return true;
  ...
  protected void d()
  {
    ...
    if (this.jdField_a_of_type_Agsp.jdField_f_of_type_Boolean)
    {
      localObject = ((Resources)localObject).getString(2131695147);
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilArrayList.size() > 0))
      {
        ...
        bool1 = this.jdField_a_of_type_Agrz.jdField_b_of_type_JavaUtilArrayList.contains(Integer.valueOf(((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).a()));
        if (((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).a() == -1) {
          break label789;
        }
        if (((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).a((String)this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList.get(((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).a())) == 1) {
          break label764;
        }
        j = 1;
        label227:
        boolean bool2 = bbbx.a((String)this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilArrayList.get(((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).a()));
        ...
        if (((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Agrx != null)
        {
          if (!a()) {
            break label809;
          }
      ...
      for (;;)
      {
        if ((bool1) || (this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilArrayList.size() < this.jdField_a_of_type_Agrz.jdField_a_of_type_Int)) {
          break label846;
        }
        ...
        if (this.jdField_a_of_type_Agrz.a())
        {
          localObject = ((Resources)localObject).getString(2131699544);
          break;
        }
        localObject = ((Resources)localObject).getString(2131695085);
        break;
        i = 0;
        break label79;
        ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_b_of_type_AndroidWidgetButton.setEnabled(true);
        ...
        if (this.jdField_a_of_type_Agrz.a())
        {
          ...
          if (this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilArrayList.size() < 2) {
            break label595;
          }
        }
  ...
  public void g()
  {
    switch (this.jdField_a_of_type_Agrz.c)
    {
    case 1: 
    default: 
      return;
  ...
  protected void h()
  {
    if ((this.jdField_a_of_type_Agsp.jdField_g_of_type_Boolean) && ((!TextUtils.isEmpty(this.jdField_a_of_type_Agsp.jdField_e_of_type_JavaLangString)) || (!TextUtils.isEmpty(this.jdField_a_of_type_Agsp.jdField_f_of_type_JavaLangString)))) {
    ...
    {
      agqd.a(((ArrayList)localObject3).size(), this.jdField_a_of_type_Agsp.jdField_b_of_type_Int);
      agqd.a(localIntent, ((ArrayList)localObject3).size(), this.jdField_a_of_type_Agrz.c);
    }
    ...
    if (this.jdField_a_of_type_Agrz.c == 2)
    {
      if ((this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilArrayList.size() == 0) && (((ArrayList)localObject3).size() == 1) && (bbdx.a((String)((ArrayList)localObject3).get(0)) > ayxe.a()))
      {
        bcql.a((Context)this.jdField_a_of_type_MqqUtilWeakReference.get(), ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).getResources().getString(2131695113), 0).b(((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).getResources().getDimensionPixelSize(2131298865));
      ...
      do
      {
        ...
        if (this.jdField_a_of_type_Agsp.jdField_e_of_type_Boolean) {
        ...
        a(localIntent, this.jdField_a_of_type_Agrz.b(), ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).a());
        if ((localIntent != null) && (localIntent.getBooleanExtra("custom_photopreview_sendbtn_report", false)))
        {
          ...
          if ((str != null) && (localObject1 != null)) {
            axqy.b(null, "CliOper", "", "", str, str, 0, 0, (String)localObject1, "", "", "");
          }
        }
      } while ((!a()) || (this.jdField_a_of_type_Agsp.jdField_i_of_type_Int <= 0));
    ...
    for (;;)
    {
      ...
      localObject3 = this.jdField_a_of_type_Agsp.jdField_a_of_type_JavaUtilHashMap.values().iterator();
      for (;;)
      {
        if (((Iterator)localObject3).hasNext())
        {
          ...
          if ((!TextUtils.isEmpty((CharSequence)localObject2)) && (!TextUtils.isEmpty(str)) && (((String)localObject2).equals(str)))
          {
            i += 1;
            continue;
            if ((localObject1 == null) || (this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilArrayList.size() <= 0) || (this.jdField_a_of_type_Agsp.m) || (this.jdField_a_of_type_Agsp.o) || (this.jdField_a_of_type_Agsp.p) || (localIntent.getBooleanExtra("PhotoConst.SEND_NO_PRESEND", false))) {
              break;
            }
            ...
            if (this.jdField_a_of_type_Agsp.jdField_e_of_type_Int != 1) {
              break label379;
            }
    ...
    if (this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilArrayList != null) {}
    for (int j = this.jdField_a_of_type_Agrz.jdField_a_of_type_JavaUtilArrayList.size();; j = 0)
    {
      axqy.b(null, "dc00898", "", "", "0X800A070", "0X800A070", 0, 0, j + "", i + "", "", "");
      return;
    }
  }
}
