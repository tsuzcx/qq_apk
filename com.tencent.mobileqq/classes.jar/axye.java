...
public class axye
  extends biun
{
  public axye(GameRoomInviteActivity paramGameRoomInviteActivity) {}
  ...
  public void a(int paramInt)
  {
    ...
    do
    {
      ...
      if (paramInt == 0)
      {
        ...
        this.a.jdField_a_of_type_ComTencentMobileqqWerewolvesWereWolvesLoadingView.setComplete(new axyf(this));
    ...
    {
      this.a.jdField_a_of_type_ComTencentMobileqqWerewolvesWereWolvesLoadingView.a.setText(anzj.a(2131703992));
      this.a.jdField_a_of_type_ComTencentMobileqqWerewolvesWereWolvesLoadingView.c();
    ...
    this.a.jdField_a_of_type_Biup.a();
  ...
  public void a(submsgtype0xdd.MsgBody paramMsgBody)
  {
    ...
    case 1: 
      do
      {
        ...
        if ((!paramMsgBody.uint64_invite_leader.has()) || (paramMsgBody.uint64_invite_leader.get() == this.a.app.getLongAccountUin()))
        {
          ...
          ((axyx)localObject).jdField_a_of_type_JavaLangString = (localPlayerState.uint64_uin.get() + "");
        ...
        {
          ((axyx)localObject).jdField_a_of_type_Boolean = bool;
    ...
    case 2: 
      ...
      axws.a(this.a.app.getCurrentAccountUin(), "game_room_last_time", Long.valueOf(bcrg.a()));
      return;
    case 3: 
      label135:
      label250:
      QQToast.a(this.a, anzj.a(2131704017), 0).a();
      this.a.finish();
      this.a.jdField_a_of_type_JavaUtilList = null;
      bhsi.a(this.a, this.a.app.getCurrentAccountUin(), false, System.currentTimeMillis());
      return;
    }
    this.a.a(null, anzj.a(2131703994), true);
  }
}
