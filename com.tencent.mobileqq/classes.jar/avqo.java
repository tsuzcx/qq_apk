  ...
  extends MSFServlet
{
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      notifyObserver(paramIntent, i, bool1, (Bundle)localObject1, avqn.class);
      return;
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    for (;;)
    {
      ...
      paramPacket.putSendData(bhuf.a(paramIntent.getByteArrayExtra("RequestBytes")));
      return;
      if (str.equals("QQApkSvc.check_download_apk")) {
        paramPacket.setTimeout(((aqjz)aran.a().a(416)).a);
      } else if (str.equals("QQApkSvc.check_jump_apk")) {
        paramPacket.setTimeout(((aqjz)aran.a().a(416)).b);
      }
    }
  }
}
