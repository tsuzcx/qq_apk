...
public class wkq
  extends wpc<CertifiedAccountMeta.StFollowRcmd>
{
  public static int a;
  ...
  {
    paramViewGroup = LayoutInflater.from(a()).inflate(2131558661, paramViewGroup, false);
    URLImageView localURLImageView = (URLImageView)paramViewGroup.findViewById(2131368672);
    ...
    if (this.e)
    {
      ...
      ((TextView)paramViewGroup.findViewById(2131378430)).setTextColor(-10132123);
      paramViewGroup.findViewById(2131365276).setBackgroundColor(-14540254);
  ...
  {
    xhe.b("auth_follow", "exp_more", 0, 0, new String[0]);
    paramViewGroup = LayoutInflater.from(a()).inflate(2131558660, paramViewGroup, false);
    LinearLayout localLinearLayout = (LinearLayout)paramViewGroup.findViewById(2131369430);
    ...
    for (int i = -13224394;; i = -460552)
    {
      ...
      localLinearLayout.setOnClickListener(new wks(this));
      if (this.e) {
        ((TextView)paramViewGroup.findViewById(2131378429)).setTextColor(-5723992);
      }
      return paramViewGroup;
    }
  }
  ...
  protected void a(Rect paramRect, View paramView, RecyclerView paramRecyclerView, RecyclerView.State paramState)
  {
    ...
    while (paramView.getId() != 2131375507) {
      return;
    }
  ...
  public void a(wkt paramwkt)
  {
    if (a() != null)
    {
      ...
      VSNetworkHelper.a().a(localSubscribeGetFollowRcmdRequest, new wkr(this, localSubscribeGetFollowRcmdRequest, paramwkt));
    }
  }
  ...
  public void onBindViewHolder(RecyclerView.ViewHolder paramViewHolder, int paramInt)
  {
    ...
    ((wku)paramViewHolder).a(localStFollowRcmd, i);
  }
  
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    if (paramInt == 100000) {
      return new wku(this, a(paramViewGroup));
    }
    if (paramInt == 100001) {
      return new wku(this, b(paramViewGroup));
    }
    paramViewGroup = new BlankRecommendItemView(paramViewGroup.getContext());
    paramViewGroup.setIsInNightMode(this.e);
    return new wku(this, paramViewGroup);
  }
