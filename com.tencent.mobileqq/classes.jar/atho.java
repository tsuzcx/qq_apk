  ...
  extends WebViewPlugin
{
  ...
  private static final String e = alud.a(2131706096);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = alud.a(2131706092);
    jdField_b_of_type_JavaLangString = alud.a(2131706091);
    d = alud.a(2131706097);
    jdField_c_of_type_JavaLangString = alud.a(2131706100);
  }
  ...
  private void a()
  {
    ...
    {
      b();
      asxg.a(this.jdField_a_of_type_AndroidAppActivity, this.g, this.k, this.m, this.jdField_a_of_type_Long, new athp(this));
      return;
    }
      ...
      for (;;)
      {
        ...
        try
        {
          if (paramIntent.hasExtra("data"))
          {
            ...
            localJSONObject.put("errMsg", paramIntent.getString("errMsg", alud.a(2131706099)));
            localJSONObject.put("idKey", paramIntent.getString("idKey"));
            localJSONObject.put("allResults", localObject1);
          }
          for (;;)
          {
            azqs.b(null, "dc00898", "", "", "0X8009862", "0X8009862", 0, 0, this.jdField_c_of_type_Int + "", "", this.jdField_b_of_type_Int + "", paramInt + "");
            if (QLog.isColorLevel()) {
            ...
            else
            {
              ...
              localJSONObject.put("errMsg", alud.a(2131706098));
              localJSONObject.put("allResults", localObject1);
              paramInt = 299;
            }
          }
