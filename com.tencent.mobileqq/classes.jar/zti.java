...
{
  zti(zth paramzth, CertifiedAccountMeta.StFeed paramStFeed) {}
  ...
  public void onClick(View paramView)
  {
    ...
    {
      if (zsx.a(this.jdField_a_of_type_Zth.a) == 0)
      {
        zsx.a(this.jdField_a_of_type_Zth.a, 6);
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_Zth.a.a(this.jdField_a_of_type_Zth.itemView.getContext(), str1, (String)localObject1, this.jdField_a_of_type_Zth.a.b(), zsx.b(this.jdField_a_of_type_Zth.a), (String)localObject2);
        EventCollector.getInstance().onViewClicked(paramView);
        return;
        if (zsx.a(this.jdField_a_of_type_Zth.a) == 1)
        {
          zsx.a(this.jdField_a_of_type_Zth.a, 5);
          MobileReportManager.getInstance().reportActionLive(str1 + "", "25", "qq_live", "find_page", "hot_push", 102, 1, System.currentTimeMillis(), str1 + "");
        }
        else if (zsx.a(this.jdField_a_of_type_Zth.a) == 2)
        {
          zsx.a(this.jdField_a_of_type_Zth.a, 2);
