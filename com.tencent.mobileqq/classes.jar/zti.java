  ...
  extends zqp
{
  ...
  public zti(QQAppInterface paramQQAppInterface)
  {
  ...
  private void b(MessageForDeviceFile paramMessageForDeviceFile)
  {
    ...
    if (i < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      if ((localView != null) && (localObject != null)) {
        ((apae)localObject).a(localView, paramMessageForDeviceFile);
      }
      for (;;)
      {
        i += 1;
  ...
  {
    paramLong = (zqr)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramLong);
    if (paramLong == null) {
      return null;
    }
  ...
  public MessageForDeviceFile a(String paramString, MessageForDeviceFile paramMessageForDeviceFile)
  {
    ...
    MessageForDeviceFile localMessageForDeviceFile = (MessageForDeviceFile)ayvw.a(paramMessageForDeviceFile);
    if ("device_groupchat".equals(paramMessageForDeviceFile.extStr))
    {
      ...
      localMessageForDeviceFile.srcFileName = arni.a(localMessageForDeviceFile.filePath);
      localMessageForDeviceFile.fileSize = arni.a(localMessageForDeviceFile.filePath);
      localMessageForDeviceFile.msgStatus = 2;
      localMessageForDeviceFile.nFileStatus = 1;
      localMessageForDeviceFile.progress = 0.0F;
      ((alxl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(13)).a(localMessageForDeviceFile);
      ...
      paramString = bdda.a(BaseApplication.getContext(), Uri.parse(localMessageForDeviceFile.filePath));
      bdda.a(BaseApplication.getContext(), localMessageForDeviceFile.filePath, paramString, 160, 160);
      agkk.a(((zpa)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51)).a(Long.parseLong(localMessageForDeviceFile.frienduin), localMessageForDeviceFile.filePath, paramString), localMessageForDeviceFile);
    ...
    if (paramString.compareTo(ztk.d) == 0)
    {
      localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691650);
      label361:
      ((alxl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(13)).a(localMessageForDeviceFile);
      paramMessageForDeviceFile = (zpa)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51);
    ...
    for (;;)
    {
      localMessageForDeviceFile.fileSize = arni.a(str1);
      if (!bdee.d(BaseApplication.getContext()))
      {
        localMessageForDeviceFile.nFileStatus = 6;
        localMessageForDeviceFile.msgStatus = 1;
      ...
      break;
      if (paramString.compareTo(ztk.c) != 0) {
        break label361;
      }
      localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691648);
      ...
      break label361;
      label545:
      if (paramString.compareTo(ztk.f) == 0)
      {
  ...
  public void a(View paramView, apae paramapae)
  {
  ...
  public void a(Session paramSession, boolean paramBoolean)
  {
    ...
    Object localObject2 = ((zpa)localObject1).a(Long.parseLong(localMessageForDeviceFile.frienduin));
    int i = 0;
    long l = 0L;
    ...
    if (paramSession.actionInfo.strServiceName.compareTo(ztk.d) == 0)
    {
    ...
    for (int j = 0;; j = 1)
    {
      aabm.a((AppRuntime)localObject2, l, "Net_SendMsg_Pic", 0, j, i);
      if ((paramSession.actionInfo.strServiceName.compareTo(ztk.c) == 0) && (paramSession.bSend) && (paramBoolean))
      {
        ...
        ((zpa)localObject1).a(Long.parseLong(localMessageForDeviceFile.frienduin), str, String.valueOf(((Session)localObject2).uSessionID), paramSession.strFileNameSrc, paramSession.emFileType, localBundle);
        localObject1 = (MessageForDeviceFile)ayvw.a(-4500);
        ((MessageForDeviceFile)localObject1).strServiceName = ztk.c;
        ...
        ((MessageForDeviceFile)localObject1).time = ayvc.a();
        ...
        ((MessageForDeviceFile)localObject1).msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691648);
  ...
  public void a(String paramString, long paramLong, boolean paramBoolean)
  {
    ...
    DeviceInfo localDeviceInfo = ((zpa)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51)).a(Long.parseLong(localMessageForDeviceFile.frienduin));
    ...
    for (int i = localDeviceInfo.productId;; i = 0)
    {
      ...
      if (paramBoolean)
      {
        ...
        label76:
        localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691345);
        if (paramString.compareTo(ztk.d) != 0) {
          break label251;
        }
        localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691350);
      }
      for (;;)
      {
        if (QLog.isDevelopLevel()) {
        ...
        if (paramString.compareTo(ztk.c) == 0)
        {
          ...
          if (!paramBoolean)
          {
            ...
            if (localMessageForDeviceFile.isSend())
            {
              ...
              if (arni.a(localMessageForDeviceFile.filePath) == 0) {
                aabm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendFile", 1, 2, i);
              } else {
                aabm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendFile", 2, 2, i);
              }
            }
            else
            {
              ...
              for (;;)
              {
                aabm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendPrint", 2, j, i);
                break;
          ...
          {
            if (arni.a(localMessageForDeviceFile.filePath) == 0) {
              aabm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendFile", 1, 1, i);
            } else {
              aabm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendFile", 2, 1, i);
            }
          }
          else
          {
            aabm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendPrint", 1, 0, i);
          }
        }
      }
    }
  ...
  {
    MessageForStructing localMessageForStructing = ayvw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 9501, 100L, paramAbsStructMsg);
    ...
    ((zpa)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51)).a(Long.parseLong(paramString), paramAbsStructMsg);
  }
  ...
  public void a(String paramString1, String paramString2, List<String> paramList, Bundle paramBundle)
  {
    ...
    if (paramList.hasNext())
    {
      ...
      localMessageForDeviceFile.srcFileName = arni.a((String)localObject1);
      localMessageForDeviceFile.fileSize = arni.a((String)localObject1);
      ...
      if (paramString1.compareTo(ztk.d) == 0)
      {
        localMessageForDeviceFile.nFileMsgType = 2;
        localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691650);
      }
      int i;
      if (paramString1.compareTo(ztk.c) == 0)
      {
        int i3 = 1;
        int i2 = 1;
        int i1 = 1;
      ...
      if ((localObject2 != null) && (((zpa)localObject2).a(paramString2))) {
        if (paramString1.compareTo(ztk.d) == 0)
        {
          String str = bdda.a(BaseApplication.getContext(), Uri.parse((String)localObject1));
          bdda.a(BaseApplication.getContext(), (String)localObject1, str, 160, 160);
          localMessageForDeviceFile.uSessionID = ((zpa)localObject2).a(Long.parseLong(paramString2), (String)localObject1, str);
        }
      }
      for (;;)
      {
        ...
        localArrayList.add(localMessageForDeviceFile);
        break;
        if (paramString1.compareTo(ztk.f) == 0)
        {
          localMessageForDeviceFile.uSessionID = ((zpa)localObject2).a(Long.parseLong(paramString2), (String)localObject1, 0);
        }
        else
        {
          if (paramString1.compareTo(ztk.c) == 0)
          {
            localObject2 = ((zpa)localObject2).a(Long.parseLong(paramString2));
            i = 0;
            if (localObject2 != null) {
              i = ((DeviceInfo)localObject2).productId;
            }
            ...
            aabm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendFile", 1, 0, i);
          }
          for (;;)
          {
            ...
            break label526;
            label722:
            aabm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendFile", 2, 0, i);
          }
          localObject1 = ((DeviceFileHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(50)).a((String)localObject1, paramString1, null, Long.parseLong(paramString2));
          if (localObject1 == null) {
            break;
  ...
  public void a(String paramString, List<String> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      localMessageForDeviceFile.srcFileName = arni.a(str);
      localMessageForDeviceFile.fileSize = arni.a(str);
      localMessageForDeviceFile.issend = 1;
      localMessageForDeviceFile.isread = true;
      localMessageForDeviceFile.selfuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
      localMessageForDeviceFile.senderuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
      ...
      localMessageForDeviceFile.time = ayvc.a();
      localMessageForDeviceFile.progress = 0.0F;
      localMessageForDeviceFile.msg = (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131694672) + ": " + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691650));
      localMessageForDeviceFile.nFileMsgType = 2;
      ...
      str = bdda.a(BaseApplication.getContext(), Uri.parse(localMessageForDeviceFile.filePath));
      bdda.a(BaseApplication.getContext(), localMessageForDeviceFile.filePath, str, 160, 160);
      int i = ((zpa)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51)).a(Long.parseLong(localMessageForDeviceFile.frienduin), localMessageForDeviceFile.filePath, str);
      localMessageForDeviceFile.uSessionID = i;
      a(localMessageForDeviceFile.uSessionID, localMessageForDeviceFile.frienduin, localMessageForDeviceFile.istroop, localMessageForDeviceFile.uniseq);
      agkk.a(i, localMessageForDeviceFile);
    }
  }
  ...
  public boolean a(String paramString, List<FileInfo> paramList)
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        {
          localMessageForDeviceFile.strServiceName = ztk.b;
          continue;
          label512:
          if (localMessageForDeviceFile.strServiceName.compareTo(ztk.f) == 0)
          {
            localMessageForDeviceFile.uSessionID = localzpa.a(Long.parseLong(paramString), ((FileInfo)localObject).c(), 0);
          }
          else
          {
    ...
    if ((localzpa != null) && (localzpa.a(l1, 9))) {}
    for (int i = 1;; i = 0)
    {
      ArrayList localArrayList = new ArrayList();
      paramList = paramList.iterator();
      for (;;)
      {
        ...
        localMessageForDeviceFile = (MessageForDeviceFile)ayvw.a(-4500);
        ...
        localMessageForDeviceFile.srcFileName = arni.a(((FileInfo)localObject).c());
        localMessageForDeviceFile.fileSize = arni.a(((FileInfo)localObject).c());
        localMessageForDeviceFile.issend = 1;
        localMessageForDeviceFile.isread = true;
        localMessageForDeviceFile.selfuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
        localMessageForDeviceFile.senderuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
        ...
        localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691649);
        localMessageForDeviceFile.nFileMsgType = 1;
        if (localMessageForDeviceFile.strServiceName.compareTo(ztk.d) == 0)
        {
          localMessageForDeviceFile.nFileMsgType = 2;
          localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691650);
        }
        ((alxl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(13)).a(localMessageForDeviceFile);
        if ((localzpa == null) || (!localzpa.a(paramString))) {
          break label600;
        }
        if (localMessageForDeviceFile.strServiceName.compareTo(ztk.d) != 0) {
          break label512;
        }
        localMessageForDeviceFile.uSessionID = localzpa.a(Long.parseLong(paramString), ((FileInfo)localObject).c(), null);
        if (!bdee.d(BaseApplication.getContext()))
        {
          localMessageForDeviceFile.nFileStatus = 6;
          localMessageForDeviceFile.msgStatus = 1;
  ...
  public void b(Bundle paramBundle)
  {
    ...
    Object localObject = ((zpa)localObject).a(Long.parseLong(paramBundle.frienduin));
    long l = 0L;
    int i;
    if (localObject != null)
    {
    ...
    {
      int j;
      if (paramBundle.strServiceName.compareTo(ztk.d) == 0)
      {
        localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
        if (m == 0)
        {
          j = 0;
          aabm.a((AppRuntime)localObject, l, "Net_SendMsg_Pic", 0, j, i);
        }
      }
      else
      {
