  ...
  extends mll
{
  ...
  private volatile ConcurrentHashMap<Long, moa> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
  ...
  protected mln(Context paramContext, VideoAppInterface paramVideoAppInterface)
  {
  ...
  public void a(lid paramlid, mgp[] paramArrayOfmgp, int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3, int paramInt4)
  {
    ...
    paramInt3 = Math.min(paramlid.c.size(), paramArrayOfmgp.length);
    label35:
    float f1;
    float f2;
    if (paramInt3 > jdField_a_of_type_Int)
    {
      ...
      if ((paramInt3 >= 2) && (mww.a(1))) {
        ThreadManager.getUIHandler().post(new ScreenLayoutMultipleGrid.1(this));
      }
      paramlid = a(paramInt3, paramInt1, paramInt2);
      f1 = mww.a(this.jdField_a_of_type_AndroidContentContext, 12.0F);
      f2 = mww.a(this.jdField_a_of_type_AndroidContentContext, 18.0F);
      paramInt2 = 0;
      label98:
      if (paramInt2 < paramInt3)
      {
        Object localObject = (Rect)paramlid.get(paramInt2);
        if (localObject == null) {
          break label356;
        }
        paramArrayOfmgp[paramInt2].b(((Rect)localObject).left, ((Rect)localObject).top, ((Rect)localObject).right, ((Rect)localObject).bottom);
        paramArrayOfmgp[paramInt2].a(0, 0, 0, 0);
        long l1 = AudioHelper.a(paramArrayOfmgp[paramInt2].b());
        long l2 = paramArrayOfmgp[paramInt2].h();
        if ((TextUtils.isEmpty(paramArrayOfmgp[paramInt2].a())) && (l1 != 0L)) {
          paramArrayOfmgp[paramInt2].b(String.valueOf(l1));
        }
        if (l1 != 0L)
        {
          localObject = (moa)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(l1));
          if (localObject != null)
          {
            if (!((moa)localObject).e()) {
              break label320;
            }
            paramInt1 = 1;
            label254:
    ...
    {
      label277:
      paramArrayOfmgp[paramInt2].h(paramInt1);
      if (paramInt3 == 1)
      {
        paramArrayOfmgp[paramInt2].g(false);
        paramArrayOfmgp[paramInt2].a(f2);
      }
      for (;;)
      {
        paramInt2 += 1;
        ...
        if (paramInt3 >= 2)
        {
          paramArrayOfmgp[paramInt2].g(true);
          paramArrayOfmgp[paramInt2].a(f1);
        }
      }
      label356:
      if (!QLog.isDevelopLevel()) {
