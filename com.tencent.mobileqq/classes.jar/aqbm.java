...
public class aqbm
  extends apxc
{
  public aqbm(ExtendFriendLimitChatMatchFragment paramExtendFriendLimitChatMatchFragment) {}
  
  protected void a(int paramInt)
  {
    atwl.a(this.a.jdField_a_of_type_ComTencentMobileqqRedtouchRedTouch, ExtendFriendLimitChatMatchFragment.a(this.a).app);
  }
  ...
  protected void a(boolean paramBoolean1, ArrayList<apyr> paramArrayList, boolean paramBoolean2, int paramInt, ArrayList<String> paramArrayList1)
  {
    ...
    if (paramBoolean1)
    {
      if (paramInt <= 0)
      {
        ...
        {
          if (this.a.jdField_a_of_type_Aqef == null) {
            break label255;
          }
          this.a.jdField_a_of_type_Aqef.a(paramArrayList1);
        }
      }
      for (;;)
      {
        ...
        {
          paramArrayList1 = (apyr)paramArrayList.get(paramInt);
        ...
        String str = paramInt + BaseApplication.getContext().getResources().getString(2131699322);
      ...
      {
        paramArrayList1 = (apwx)ExtendFriendLimitChatMatchFragment.a(this.a).app.getManager(264);
        paramBoolean1 = paramBoolean2;
      ...
      while (paramInt >= 0)
      {
        if ((((apyr)paramArrayList.get(paramInt)).jdField_a_of_type_Int == 10000) && (!paramBoolean1))
        {
      ...
      if (ExtendFriendLimitChatMatchFragment.a(this.a) != null)
      {
        ...
        azmj.b(ExtendFriendLimitChatMatchFragment.a(this.a).app, "dc00898", "", "", "qq_kuolie", "0X800AA94", 0, 0, "", "", ExtendFriendLimitChatMatchFragment.a(this.a), "");
      }
    }
    return;
    label459:
