  ...
  implements vtv
{
  ...
  {
    SlideItemInfo localSlideItemInfo = (SlideItemInfo)vtz.a().a().get(paramInt);
    if (localSlideItemInfo == null)
    {
      if (QLog.isColorLevel()) {
        QLog.d(vud.a(this.a), 2, "slideItem is null, do not jump");
      }
      return;
    }
    int i = vtz.a().a();
    ...
    if (i == 11)
    {
      ...
      if ((!(vud.a(this.a) instanceof PhotoListActivity)) && (!(vud.a(this.a) instanceof NewPhotoListActivity))) {
        break label355;
      }
      str = "0";
      label187:
      ...
      localIntent.setClass(vud.a(this.a), LocalVideoSelectActivity.class);
      vud.a(this.a).startActivityForResult(localIntent, 24747);
      if (i != 11) {
        break label361;
      }
      paramInt = 0;
    ...
    {
      vei.a("pic_choose", "clk_cutVideo", paramInt, 0, new String[] { str, localSlideItemInfo.b + "-" + localSlideItemInfo.c });
      return;
      paramInt = 1;
      break;
      str = "1";
