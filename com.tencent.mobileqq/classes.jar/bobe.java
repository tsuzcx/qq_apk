...
public class bobe
{
  ...
  public int a;
  public long a;
  private Handler jdField_a_of_type_AndroidOsHandler = new bobg(this, Looper.getMainLooper());
  public boax a;
  protected boay a;
  public bobh a;
  private bobm jdField_a_of_type_Bobm = new bobf(this);
  public Lyric a;
  ...
  public bobe(LyricView paramLyricView)
  {
    this.jdField_c_of_type_Int = 100;
    this.jdField_a_of_type_DovComQqImAeeditorLyricCommonTimerTaskManager = boat.a();
    this.jdField_a_of_type_Boay = new boay();
    ...
    this.jdField_a_of_type_Boax = paramLyricView.a();
    this.jdField_a_of_type_DovComQqImAeeditorLyricWidgetLyricViewScroll.setScrollListener(this.jdField_a_of_type_Bobm);
  }
  ...
  private void b(int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      b(this.f);
      return;
      if (this.jdField_a_of_type_Bobh != null) {
        paramInt = this.jdField_a_of_type_Bobh.a();
      } else {
        paramInt = (int)bogt.a().a(false);
      }
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    boat.a().post(new LyricViewController.5(this, paramInt));
  }
  
  protected void a(int paramInt1, int paramInt2)
  {
    boat.a().post(new LyricViewController.6(this, paramInt1, paramInt2));
  }
  
  public void a(int paramInt, boolean paramBoolean)
  {
    boat.a().post(new LyricViewController.4(this, paramInt, paramBoolean));
  }
  
  public void a(boaz paramboaz)
  {
    this.jdField_a_of_type_Boay.a(paramboaz);
  }
  
  public void a(bobh parambobh)
  {
    this.jdField_a_of_type_Bobh = parambobh;
  }
  
  public void a(Lyric paramLyric1, Lyric paramLyric2, Lyric paramLyric3)
  {
    Log.v("ModuleController", "setLyric begin");
    boat.a().post(new LyricViewController.3(this, paramLyric3, paramLyric1, paramLyric2));
  }
  
  public void a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Boax != null) {
      this.jdField_a_of_type_Boax.setEffectEnable(paramBoolean);
    }
  }
  
  public void b(int paramInt)
  {
    this.jdField_a_of_type_ComTencentWeseevideoEditorStickerMusicLyricDataLyric = this.jdField_a_of_type_Boax.a();
  ...
  {
    if ((this.jdField_a_of_type_ComTencentWeseevideoEditorStickerMusicLyricDataLyric != null) || (this.jdField_a_of_type_Boax != null))
    {
      paramInt = this.jdField_a_of_type_Boax.a(paramInt);
    ...
    do
    {
      ...
      i = this.jdField_a_of_type_Boax.b();
    ...
    } while (this.jdField_a_of_type_Boay == null);
    ...
    this.jdField_a_of_type_Boay.a(l1, i);
    return;
    ...
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_ComTencentWeseevideoEditorStickerMusicLyricDataLyric.mSentences.size()))
    {
      ...
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_Boay != null) {
          this.jdField_a_of_type_Boay.a(l1);
        }
  ...
  protected void d(int paramInt)
  {
    if ((this.jdField_a_of_type_ComTencentWeseevideoEditorStickerMusicLyricDataLyric != null) || (this.jdField_a_of_type_Boax != null))
    {
      paramInt = this.jdField_a_of_type_Boax.b(paramInt);
      if ((this.jdField_a_of_type_ComTencentWeseevideoEditorStickerMusicLyricDataLyric == null) || (this.jdField_a_of_type_ComTencentWeseevideoEditorStickerMusicLyricDataLyric.isEmpty())) {
    ...
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_ComTencentWeseevideoEditorStickerMusicLyricDataLyric.mSentences.size()))
    {
      ...
      for (;;)
      {
        ...
        bnzb.a("ModuleController", "onScrolling() scrollY => " + i + ",position => " + l1 + ",lineNo:" + paramInt);
        this.jdField_a_of_type_Boay.a(l1, i);
        return;
        label235:
        l1 = l2;
