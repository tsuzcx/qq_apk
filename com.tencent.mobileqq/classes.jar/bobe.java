...
{
  private final bobf jdField_a_of_type_Bobf;
  private final ReleaseLooperHandler jdField_a_of_type_ComTencentWeiyunTransmissionUtilsHandlerReleaseLooperHandler;
  
  public bobe(bobf parambobf, ReleaseLooperHandler paramReleaseLooperHandler)
  {
    this.jdField_a_of_type_Bobf = parambobf;
  ...
  private void b(boak paramboak)
  {
    ...
    do
    {
        ...
        do
        {
          do
          {
            ...
            do
            {
              ...
              {
                this.jdField_a_of_type_Bobf.a(paramboak.a(), true, false, false, str2);
                return;
              }
            } while (paramboak.d());
            if (!IOUtils.ensureStorageSpace(str4, l1 - l2))
            {
              this.jdField_a_of_type_Bobf.a(paramboak.a(), false, false, true, "");
              return;
            }
          } while (paramboak.d());
          if (!IOUtils.ensureWritable(str4))
          {
            this.jdField_a_of_type_Bobf.a(paramboak.a(), false, true, false, "");
            return;
          }
        } while (paramboak.d());
        localObject = IOUtils.ensureFilePath(str4, paramboak.a().b);
      } while (paramboak.d());
      String str1 = a(str3);
      if ((!TextUtils.isEmpty(str1)) && (!TextUtils.equals(str2, str1)) && (TextUtils.equals(str3, IOUtils.getFileSha1(str1))))
      {
        ...
        for (;;)
        {
          this.jdField_a_of_type_Bobf.a(paramboak.a(), bool, false, false, (String)localObject);
          return;
          bool = IOUtils.copyFileAndNotifyOS(WeiyunTransmissionGlobal.getInstance().getContext(), str1, (String)localObject);
        }
      }
    } while (paramboak.d());
    this.jdField_a_of_type_Bobf.a(paramboak.a(), false, false, false, (String)localObject);
  }
  
  public void a(boak paramboak)
  {
    if (paramboak == null) {
      return;
    }
    this.jdField_a_of_type_ComTencentWeiyunTransmissionUtilsHandlerReleaseLooperHandler.sendMessage(Message.obtain(null, 11, paramboak));
  }
