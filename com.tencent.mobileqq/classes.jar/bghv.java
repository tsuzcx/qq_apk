  ...
  implements bgcc
{
  ...
  private void a(WebViewPlugin paramWebViewPlugin, bbac parambbac, String[] paramArrayOfString)
  {
    ...
    do
    {
      for (;;)
      {
        try
        {
          parambbac = new JSONObject(paramArrayOfString[0]);
          paramWebViewPlugin = parambbac.getString("zipUrl");
        ...
        catch (JSONException parambbac)
        {
          try
          {
            parambbac = parambbac.getString("callback");
            if ((!TextUtils.isEmpty(paramWebViewPlugin)) && (!TextUtils.isEmpty(parambbac))) {
              break;
            }
            return;
          }
      ...
      paramWebViewPlugin = paramWebViewPlugin.replace("sbig", arhc.a());
      paramWebViewPlugin = new File(bfrb.b(bcdu.d(paramWebViewPlugin)) + arhc.a());
    ...
    paramWebViewPlugin = "window." + parambbac + "({checked:" + i + "})";
  ...
  private void b(WebViewPlugin paramWebViewPlugin, bbac parambbac, String[] paramArrayOfString)
  {
    parambbac.a().getHandler(bgir.class).post(new QZonePassivePraiseJsPlugin.1(this, paramArrayOfString));
  }
  
  private void c(WebViewPlugin paramWebViewPlugin, bbac parambbac, String[] paramArrayOfString)
  {
    Object localObject;
    if ((paramArrayOfString != null) && (paramArrayOfString.length > 0) && (paramArrayOfString[0] != null)) {
      localObject = "";
    ...
    do
    {
      do
      {
        for (;;)
        {
          ...
          parambbac = (bbac)localObject;
        }
        paramArrayOfString = bfrb.b(bcdu.d(paramWebViewPlugin.replace("sbig", arhc.a())));
        localObject = new File(paramArrayOfString);
      } while ((!((File)localObject).exists()) || (!((File)localObject).isDirectory()));
      this.jdField_a_of_type_Bfre = new bfre(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a());
    } while (!bfre.a());
    this.jdField_a_of_type_Bfre.a(paramWebViewPlugin, paramArrayOfString, true, new bghw(this, parambbac));
  }
  
  private void d(WebViewPlugin paramWebViewPlugin, bbac parambbac, String[] paramArrayOfString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramWebViewPlugin = parambbac;
        bgbz.a().a().a(0L, localAlbumThemeSkin);
      }
      catch (JSONException parambbac)
      {
        parambbac.printStackTrace();
        parambbac = paramWebViewPlugin;
        continue;
      }
      if (TextUtils.isEmpty(parambbac)) {}
      return;
      ...
      parambbac = paramArrayOfString;
      paramWebViewPlugin = paramArrayOfString;
      if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin != null)
      {
        paramWebViewPlugin = paramArrayOfString;
        parambbac = "window." + paramArrayOfString + "({})";
        paramWebViewPlugin = paramArrayOfString;
        this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.callJs(parambbac);
        parambbac = paramArrayOfString;
      }
    }
  }
    ...
    if (paramLong == 8589934601L)
    {
      ...
      if (!TextUtils.isEmpty(str))
      {
        ...
        if (i != -1)
        {
          ...
          if ((!TextUtils.isEmpty(paramString)) && (paramString.startsWith(str)) && (this.jdField_a_of_type_Bfre != null)) {
            this.jdField_a_of_type_Bfre.b();
          }
        }
      }
    }
