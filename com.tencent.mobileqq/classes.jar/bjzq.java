...
{
  public int a;
  BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new bjzu(this);
  public String a;
  ...
  private int a(int paramInt)
  {
    ...
    if ((localbegg instanceof beha)) {
      i = ((beha)localbegg).switchRequestCode(this, (byte)paramInt);
    }
    return i;
  }
  ...
  private void a(int paramInt)
  {
    ...
    do
    {
      ...
      for (int i = 1; i != 0; i = 0)
      {
        QQToast.a(this.mRuntime.a(), 2131718650, 0).b(j);
        return;
      }
      a();
      switch (paramInt)
      ...
      case 1: 
        ...
        localbjea.jdField_a_of_type_JavaLangString = this.mRuntime.a().getCurrentAccountUin();
        BaseBusinessAlbumInfo localBaseBusinessAlbumInfo = new BaseBusinessAlbumInfo();
        localBaseBusinessAlbumInfo.jdField_a_of_type_JavaLangString = localbjea.jdField_a_of_type_JavaLangString;
        ...
        localBaseBusinessAlbumInfo.jdField_b_of_type_JavaLangString = this.mRuntime.a().getString(2131718138);
        bjdt.b(this.mRuntime.a(), localbjea, localBaseBusinessAlbumInfo, -1, "cover_mall_record_video");
        return;
      }
      QLog.i("CoverStore", 1, "VIDEO_COVER click select record video.");
    } while (!bjvb.a(this.mRuntime.a(), new bjzs(this, j), 1));
    b(j);
  }
      ...
      do
      {
        do
        {
          ...
          for (;;)
          {
            ...
            Object localObject = bjxu.a(str);
            if (localObject == null) {
              break;
            }
            double d1 = bjxu.a((bjxx)localObject);
            if (d1 > 0.0D)
            {
            ...
            localObject = bjxu.a(str, ((bjxx)localObject).jdField_a_of_type_Int, ((bjxx)localObject).jdField_b_of_type_Int);
  ...
  private void a(String paramString)
  {
    ...
    ((bjea)localObject).jdField_a_of_type_JavaLangString = this.mRuntime.a().getAccount();
    paramString.putString("keyAction", "actionSelectPicture");
    paramString.putBoolean("key_need_change_to_jpg", false);
    bjdt.a(this.mRuntime.a(), (bjea)localObject, paramString, a(3));
  }
    ...
    for (;;)
    {
      ...
      try
      {
        if (i < paramArrayList.size())
        {
          ...
          Object localObject2 = bjxu.a((String)localObject1);
          if (localObject2 == null) {
            break label335;
          }
          double d1 = bjxu.a((bjxx)localObject2);
          if (d1 > 0.0D)
          {
            ((bjxx)localObject2).jdField_a_of_type_Int = ((int)(((bjxx)localObject2).jdField_a_of_type_Int / d1));
            ((bjxx)localObject2).jdField_b_of_type_Int = ((int)(((bjxx)localObject2).jdField_b_of_type_Int / d1));
          }
          localObject2 = bjxu.a((String)localObject1, ((bjxx)localObject2).jdField_a_of_type_Int, ((bjxx)localObject2).jdField_b_of_type_Int);
          ...
          azqh.a(BaseApplication.getContext()).reportTimeKVEvent("Qzone.EventTransformPhotoBase64", (Properties)localObject1, (int)(l2 - l1));
        }
      }
  ...
  {
    bjfd.a(this.mRuntime.a().getLongAccountUin(), this.mRuntime.a(), "cover_mall_record_video", new bjzt(this, paramInt));
  }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if (paramString3.equals("showStoreButton"))
    {
      ...
      paramJsBridgeListener = (TextView)this.mRuntime.a().findViewById(2131368655);
      if (paramJsBridgeListener != null)
      {
        paramJsBridgeListener.setVisibility(0);
        paramJsBridgeListener.setTextColor(-1);
        paramJsBridgeListener.setText(alud.a(2131712024));
        paramJsBridgeListener.setOnClickListener(new bjzr(this));
      }
    }
    label810:
    do
    {
      for (;;)
      {
        ...
        else if (paramString3.equals("openYellowDiamond"))
        {
          ...
          paramString2 = alud.a(2131712022);
      ...
      if (paramString3.equals("leftButtonClick"))
      {
        ...
        ((TextView)this.mRuntime.a().findViewById(2131368624)).performClick();
        return true;
      }
