  ...
  extends awmu
{
  ...
  public awmy(QQAppInterface paramQQAppInterface, int paramInt, String paramString, List<awmw> paramList)
  {
    ...
    if (awwa.a(this.jdField_b_of_type_Int))
    {
      ...
      if (this.jdField_a_of_type_JavaUtilList != null)
      {
        ...
        for (m = 1;; m = 0)
        {
          ...
          localSpannableStringBuilder.append(awwa.a((String)this.jdField_b_of_type_JavaUtilList.get(j), (String)this.jdField_c_of_type_JavaUtilList.get(j), 6, false));
          i += 1;
      ...
      {
        this.jdField_c_of_type_JavaLangCharSequence = (this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo.wMemberNum + ajya.a(2131702560));
        return;
      }
    }
    this.jdField_a_of_type_JavaLangCharSequence = ajya.a(2131702569);
    ...
    for (;;)
    {
      ...
      if ((!this.jdField_a_of_type_JavaUtilSet.isEmpty()) && (this.jdField_a_of_type_JavaUtilList != null))
      {
        ...
        for (m = 1;; m = 0)
        {
          ...
          ((SpannableStringBuilder)localObject).append(awwa.a((String)this.jdField_b_of_type_JavaUtilList.get(j), (String)this.jdField_c_of_type_JavaUtilList.get(j), 6, false));
          if (j > 0) {
