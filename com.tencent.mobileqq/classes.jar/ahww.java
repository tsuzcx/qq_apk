...
public class ahww
{
  private static ahww jdField_a_of_type_Ahww;
  public static final String a;
  public static final String b;
  private static boolean jdField_b_of_type_Boolean;
  public static final String c;
  private static final String d = ahvy.jdField_a_of_type_JavaLangString + "/qav" + File.separator + "beauty" + File.separator;
  private static final String e = d + "SKINCOLOR" + File.separator;
  private int jdField_a_of_type_Int;
  private ahxa jdField_a_of_type_Ahxa;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ahvy.jdField_a_of_type_JavaLangString + "/qsvf" + File.separator;
  ...
  public static int a(Context paramContext)
  {
    ...
    if ((j > 0) && (!new File(jdField_a_of_type_JavaLangString + "filter_config.xml").exists())) {
      lcg.c("VideoFilterTools", "getQQShortVideoFilterConfigVersion config file don't exist!");
    }
    for (;;)
    {
      lcg.c("VideoFilterTools", "getQQShortVideoFilterConfigVersion:" + i);
      return i;
      i = j;
    }
  }
  
  public static ahww a()
  {
    if (jdField_a_of_type_Ahww == null) {
      jdField_a_of_type_Ahww = new ahww();
    }
    return jdField_a_of_type_Ahww;
  }
  
  private static ahxb a(String paramString)
  {
    if (TextUtils.isEmpty(paramString))
    {
      lcg.c("VideoFilterTools", "parseConfig|content is empty.");
      return null;
    }
    for (;;)
    {
      ...
      try
      {
        ...
        localahxb = new ahxb(i, str1, str2);
        try
        {
          lcg.c("VideoFilterTools", "parseConfig:" + i + "|" + str1 + "|" + str2);
          return localahxb;
        }
      ...
      try
      {
        ...
        lcg.c("VideoFilterTools", "parseConfig failed. info = " + localJSONObject);
        return localahxb;
      }
      catch (JSONException localJSONException2)
      {
        localJSONException2.printStackTrace();
        lcg.c("VideoFilterTools", "parseConfig|parse failed.context = " + paramString);
        return localahxb;
      }
    }
  }
  ...
  public static String a(Context paramContext)
  {
    try
    {
      ...
      lcg.c("VideoFilterTools", "getQQShortVideoFilterConfig:" + jdField_a_of_type_JavaLangString + "filter_config.xml" + "|" + localFile.exists());
      if (localFile.exists()) {
  ...
  {
    lcg.c("VideoFilterTools", "setQQShortVideoFilterConfigVersion:" + paramInt);
    paramContext = PreferenceManager.getDefaultSharedPreferences(paramContext).edit();
  ...
  public static void a(Context paramContext, String paramString, int paramInt)
  {
    if (paramString == null)
    {
      lcg.c("VideoFilterTools", "updateQQShortVideoFilterConfig error ");
      return;
    }
  ...
  static void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        lcg.c("VideoFilterTools", "compareContent :" + (l2 - l1));
        return;
        ...
        if (paramString1 != null)
        {
          ...
          while (paramString1.hasNext())
          {
            ...
            while (localIterator.hasNext())
            {
              ...
              {
                lcg.c("VideoFilterTools", "compareContent res:" + localFilterDesc.name + "|" + localFilterDesc.resMD5 + "|" + paramString2.resMD5);
                ...
                lcg.c("VideoFilterTools", "compareContent iconMD5:" + localFilterDesc.name + "|" + localFilterDesc.iconMD5 + "|" + paramString2.iconMD5);
  ...
  {
    if (paramString == null) {
      lcg.c("VideoFilterTools", "handleQQSvCommonConfig empty content!");
    }
    do
    {
      for (;;)
      ...
      try
      {
        ...
        while (i < localJSONArray.length())
        {
          ...
          try
          {
            ...
            lcg.c("VideoFilterTools", "parseConfig:" + k + "|" + m + "|" + n + "|" + str5 + "|" + str1 + "|" + str4 + "|" + str2 + "|" + str3);
            i += 1;
          }
  ...
  public static boolean a(int paramInt1, long paramLong1, long paramLong2, int paramInt2)
  {
    ...
    if (i < paramInt2)
    {
      lcg.c("VideoFilterTools", "isSupportOfDevice error OSversion: " + i);
      return false;
    }
    paramInt2 = llw.e();
    if (paramInt2 < paramInt1)
    {
      lcg.c("VideoFilterTools", "isSupportOfDevice error cpucount: " + paramInt2);
      return false;
    }
    long l = llw.c();
    if (l < paramLong1)
    {
      lcg.c("VideoFilterTools", "isSupportOfDevice error cpuFrequency: " + l);
      return false;
    }
    paramLong1 = bbdh.d();
    if (paramLong1 < paramLong2)
    {
      lcg.c("VideoFilterTools", "isSupportOfDevice error memory: " + paramLong1);
      return false;
    }
    return true;
  }
  ...
  public static String b(Context paramContext)
  {
    try
    {
      ...
      lcg.c("VideoFilterTools", "getVideoEffectBeautyConfig:" + d + "beauty_config.json" + "|" + localFile.exists());
      if (localFile.exists()) {
        return bbdx.b(localFile);
      }
      b(paramContext, 0);
  ...
  public static void b(Context paramContext)
  {
    try
    {
      ...
      if ((paramContext != null) && (!TextUtils.isEmpty(paramContext.jdField_a_of_type_JavaLangString)))
      {
        ...
        lcg.c("VideoFilterTools", "preDownloadResource :" + ((File)localObject).exists());
        if (!((File)localObject).exists())
        {
          localObject = new ayrx();
          ((ayrx)localObject).jdField_a_of_type_Aysc = new ahwy();
          ...
          ((ayrx)localObject).jdField_c_of_type_JavaLangString = (d + "skin_color.zip");
  ...
  {
    lcg.c("VideoFilterTools", "setVideoEffectBeautyConfigVersion:" + paramInt);
    paramContext = PreferenceManager.getDefaultSharedPreferences(paramContext).edit();
  ...
  public static boolean b(Context paramContext)
  {
    ...
    lcg.c("VideoFilterTools", "getIsFirstLauncher:" + i);
    if (i == 0) {
      bool = true;
    }
    return bool;
  ...
  public FilterRender a(int paramInt1, int paramInt2)
  {
    ...
    {
      lcg.c("VideoFilterTools", "getFilter|init texture.");
    ...
    {
      lcg.c("VideoFilterTools", "getFilterRender|destroy current filterRender.");
  ...
  public List<FilterDesc> a()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        lcg.c("VideoFilterTools", "getFilterDescs " + str1 + " exist: " + bool);
        if (bool)
        {
          ...
          lcg.c("VideoFilterTools", "getFilterDescs " + str2 + " exist: " + bool);
    ...
    while (((Iterator)???).hasNext())
    {
      ...
      lcg.c("VideoFilterTools", "getFilterDescs " + (String)localObject3 + " exist: " + bool);
      if (bool)
      {
  ...
  public void a()
  {
    this.jdField_a_of_type_Ahxa = null;
    if (this.jdField_c_of_type_Int != -1) {
      this.jdField_c_of_type_Int = -1;
    }
    if (this.jdField_a_of_type_ArrayOfInt[0] != -1) {
  ...
  public void a(Context paramContext, ahxa arg2)
  {
    if (QLog.isColorLevel()) {
      com.tencent.av.video.effect.QavVideoEffect.DEBUG_MODE = true;
    }
    lcg.c("VideoFilterTools", "init");
    if (this.jdField_a_of_type_JavaUtilArrayList == null) {
      this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
    }
    this.jdField_a_of_type_Ahxa = ???;
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      a(a(paramContext), this.jdField_a_of_type_JavaUtilArrayList);
      a(this.jdField_a_of_type_JavaUtilArrayList);
      lcg.c("VideoFilterTools", "filter list size:" + this.jdField_a_of_type_JavaUtilArrayList.size());
  ...
  void a(List<FilterDesc> paramList)
  {
    if ((paramList == null) || (paramList.size() == 0)) {
      lcg.c("VideoFilterTools", "preDownloadResource list is empty!");
    }
    do
    {
      return;
      lcg.c("VideoFilterTools", "preDownloadResource list size: " + paramList.size());
      this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(0);
      paramList = paramList.iterator();
      while (paramList.hasNext())
      {
        FilterDesc localFilterDesc = (FilterDesc)paramList.next();
        lcg.c("VideoFilterTools", "preDownloadResource predownload: " + localFilterDesc.predownload + ", iconurl: " + localFilterDesc.iconurl + ", resurl:" + localFilterDesc.resurl);
        if (localFilterDesc.predownload == 1)
        {
          ...
          if (!TextUtils.isEmpty(localFilterDesc.iconurl))
          {
            ...
            lcg.c("VideoFilterTools", "preDownloadResource " + (String)localObject1 + " exist: " + ((File)localObject2).exists());
            if (!((File)localObject2).exists())
            {
              localObject2 = new ayrx();
              ((ayrx)localObject2).jdField_a_of_type_Aysc = new ahwz(this);
              ((ayrx)localObject2).jdField_a_of_type_JavaLangString = localFilterDesc.iconurl;
              ((ayrx)localObject2).jdField_a_of_type_Int = 0;
              ((ayrx)localObject2).jdField_c_of_type_JavaLangString = ((String)localObject1);
          ...
          if ((!TextUtils.isEmpty(localFilterDesc.resurl)) && (!TextUtils.isEmpty((CharSequence)localObject1)))
          {
            ...
            lcg.c("VideoFilterTools", "preDownloadResource " + (String)localObject1 + "params.json" + " exist: " + ((File)localObject2).exists());
            if (!((File)localObject2).exists())
            {
              localObject1 = new ayrx();
              ((ayrx)localObject1).jdField_a_of_type_Aysc = new ahwx(this);
              ((ayrx)localObject1).jdField_a_of_type_JavaLangString = localFilterDesc.resurl;
              ((ayrx)localObject1).jdField_a_of_type_Int = 0;
              ((ayrx)localObject1).jdField_c_of_type_JavaLangString = (jdField_b_of_type_JavaLangString + localFilterDesc.name + ".zip");
              ((ayrx)localObject1).a(localFilterDesc);
    ...
    } while ((this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 0) || (this.jdField_a_of_type_Ahxa == null));
    this.jdField_a_of_type_Ahxa.a(false);
  }
  ...
  public void b()
  {
    lcg.c("VideoFilterTools", "destroy");
  ...
  public void c(Context paramContext)
  {
    if (new File(d + "beauty_config.json").exists())
    {
      ...
      {
        lcg.c("VideoFilterTools", "!JasonFile.exists()");
        b(paramContext);
      }
      return;
    }
    lcg.c("VideoFilterTools", "BEAUTY_CONFIG  is not exsit");
  }
