...
public class anhg
{
  private static anhg jdField_a_of_type_Anhg;
  private static boolean jdField_a_of_type_Boolean;
  private angv jdField_a_of_type_Angv = new angv(this);
  private final LRULinkedHashMap<String, anhi> jdField_a_of_type_ComTencentUtilLRULinkedHashMap = new LRULinkedHashMap(128);
  ...
  private anhe a(CustomWebView paramCustomWebView)
  {
  ...
  public static anhg a()
  {
    try
    {
      if (jdField_a_of_type_Anhg == null) {
        jdField_a_of_type_Anhg = new anhg();
      }
      anhg localanhg = jdField_a_of_type_Anhg;
      return localanhg;
    }
    finally {}
  }
  ...
  {
    return jdField_a_of_type_Anhg != null;
  }
  ...
  private String b(String paramString)
  {
    ...
    do
    {
      ...
      str = this.jdField_a_of_type_Angv.a(paramString);
      localObject = str;
  ...
  public WebResourceResponse a(String paramString1, String paramString2)
  {
    ...
    if ((paramString1.contains("http://cmshow.qq.com/get_thunder_data?cmd=")) || (paramString1.contains("https://cmshow.qq.com/get_thunder_data?cmd=")))
    {
      ...
      if (!this.jdField_a_of_type_Angv.a(paramString2, paramString1))
      {
        if (QLog.isColorLevel()) {
      ...
      paramString2 = angv.a(paramString2, paramString1);
      localObject = (anhi)this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.get(paramString2);
      if (localObject != null) {
        if (anhi.a((anhi)localObject))
        {
          if (((anhi)localObject).a(paramString1))
          {
            if (QLog.isColorLevel()) {
              QLog.d("apollo_client_ApolloWebDataHandler", 2, "getApolloCmdResource, webSSOTask.isValid true, webSSOTask=" + localObject);
            }
            if (anhi.a((anhi)localObject) != null)
            {
              anhi.a((anhi)localObject).c = System.currentTimeMillis();
              anhi.a((anhi)localObject).d = System.currentTimeMillis();
            }
            paramString1 = new WebResourceResponse("text/plain", "utf-8", angg.a(anhi.a((anhi)localObject).toString()));
      ...
      for (;;)
      {
        return new WebResourceResponse("text/plain", "utf-8", new anhk(null, null, null));
        if (QLog.isColorLevel()) {
  ...
  {
    if (this.jdField_a_of_type_Angv != null) {
      return this.jdField_a_of_type_Angv.a(paramString);
    }
    return null;
  }
  
  public void a(Context paramContext, String paramString1, String paramString2, AppInterface paramAppInterface, anhj paramanhj)
  {
    if ((TextUtils.isEmpty(paramString1)) || (this.jdField_a_of_type_Angv == null)) {}
    for (;;)
    {
      return;
      ...
      {
        this.jdField_a_of_type_Angv.a(paramAppInterface);
        Object localObject1 = this.jdField_a_of_type_Angv.a(paramString1);
        ...
        else
        {
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            String str = angv.a(paramString1, (String)localObject2);
            anhi localanhi = (anhi)this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.get(str);
            if ((localanhi != null) && (localanhi.a((String)localObject2)))
            {
              if (QLog.isColorLevel()) {
                QLog.d("apollo_client_ApolloWebDataHandler", 2, "preloadSSOCmd, apolloClientId:" + paramString1 + " mPreloadSSOCmds.has WebSSOTask:" + localanhi);
              }
            }
            else
            {
              this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.remove(str);
              localanhi = new anhi(paramanhj, str, (String)localObject2);
              this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.put(str, localanhi);
              localObject2 = this.jdField_a_of_type_Angv.a(paramString2, paramString1, (String)localObject2, paramAppInterface);
              if (QLog.isColorLevel()) {
              ...
              if (localObject2 != null) {
                localanhi.a(paramContext, paramString2, (JSONObject)localObject2, paramAppInterface);
              }
            }
          }
        }
  ...
  public boolean a(String paramString)
  {
    ...
    } while (this.jdField_a_of_type_Angv == null);
    return this.jdField_a_of_type_Angv.a(paramString);
  }
  ...
  public boolean a(String paramString1, String paramString2, AppInterface paramAppInterface, WebViewPlugin paramWebViewPlugin)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        anhe localanhe = a(paramWebViewPlugin.mRuntime.a());
        if (localanhe == null)
        {
          if (!QLog.isColorLevel()) {
            break label737;
        ...
        if (!this.jdField_a_of_type_Angv.a(str3, str2))
        {
          if (!QLog.isColorLevel()) {
            break label739;
          }
        ...
        str3 = angv.a(str3, str2);
        paramString2 = (anhi)this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.get(str3);
        if (paramString2 != null)
        {
          if (anhi.a(paramString2))
          {
            if (paramString2.a(str2))
            {
              ...
              if (anhi.a(paramString2) != null)
              {
                anhi.a(paramString2).c = System.currentTimeMillis();
                anhi.a(paramString2).d = System.currentTimeMillis();
              }
              paramWebViewPlugin.callJs(str1, new String[] { anhi.a(paramString2).toString() });
            ...
            if (localanhe != null)
            {
              paramString2 = localanhe.a();
              paramString2.c = System.currentTimeMillis();
              paramString2 = new anhi(paramString2, str3, str2);
              paramString2.a(new anhh(this, str1, paramWebViewPlugin));
  ...
  public boolean b(String paramString1, String paramString2)
  {
    ...
    angg.a(angg.d(angg.e(str)), paramString2);
    if (QLog.isColorLevel()) {
