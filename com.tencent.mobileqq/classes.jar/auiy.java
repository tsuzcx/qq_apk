  ...
  implements atrs, aujc
{
  ...
  public auiy(QQAppInterface paramQQAppInterface, FileManagerEntity paramFileManagerEntity)
  {
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity = null;
    this.jdField_a_of_type_Aujb = null;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = null;
    this.jdField_a_of_type_Auja = null;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity = paramFileManagerEntity;
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.status = 2;
    this.jdField_a_of_type_Aujb = new aujb(paramQQAppInterface.getCurrentAccountUin(), "actDiscussFileUp");
  }
  ...
  private boolean a(long paramLong, String paramString1, String paramString2, String paramString3)
  {
    ...
    if ((paramString1 == null) || (paramString1.length() == 0))
    {
      ...
      if (paramLong == 0L)
      {
        this.jdField_a_of_type_Aujb.jdField_a_of_type_Long = 9048L;
        this.jdField_a_of_type_Aujb.c = "onSendDiscFile Host null";
        this.jdField_a_of_type_Aujb.c();
        a(false);
        bool = false;
      }
    }
    while ((paramString2 != null) && (paramString2.length() != 0) && (paramString3 != null) && (paramString3.length() != 0)) {
      ...
      {
        return bool;
        this.jdField_a_of_type_Aujb.jdField_a_of_type_Long = ((int)paramLong);
      }
    }
    ...
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.status = 0;
    if (paramLong == 0L) {}
    for (this.jdField_a_of_type_Aujb.jdField_a_of_type_Long = 9005L;; this.jdField_a_of_type_Aujb.jdField_a_of_type_Long = ((int)paramLong))
    {
      this.jdField_a_of_type_Aujb.c = "onSendDiscFile param error";
      this.jdField_a_of_type_Aujb.c();
      a(false);
      return false;
    }
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    if (paramLong1 - this.jdField_a_of_type_Long >= 1000L)
    {
      ...
      {
        String str = this.jdField_a_of_type_Aujb.a();
  ...
  protected void a(boolean paramBoolean, long paramLong, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt, String paramString5, String paramString6, Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_Aujb.jdField_d_of_type_Long = System.currentTimeMillis();
    if (!paramBoolean)
    {
      ...
      for (this.jdField_a_of_type_Aujb.jdField_a_of_type_Long = 9043L;; this.jdField_a_of_type_Aujb.jdField_a_of_type_Long = 9045L)
      {
        this.jdField_a_of_type_Aujb.c = "server retError";
        if (paramString6 != null) {
          this.jdField_a_of_type_Aujb.c = paramString6;
        }
        this.jdField_a_of_type_Aujb.c();
        a(false);
        return;
    ...
    paramBoolean = false;
    int i;
    if ((atpj.e(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) && (paramBundle != null))
    {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerDataCenter().c(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity);
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.status = 2;
      this.jdField_a_of_type_Auiz = new auiz();
      this.jdField_a_of_type_Auiz.a(paramString3, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strFileSHA, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, this);
      this.jdField_a_of_type_Auja = new auja(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Aujb, paramString4, paramInt, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.getFilePath(), this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId, this.jdField_a_of_type_Auiz, paramBoolean, paramString2, paramString5);
  ...
  {
    this.jdField_a_of_type_Aujb.jdField_a_of_type_Long = paramLong.longValue();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerRSCenter().a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId);
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Aujb.jdField_a_of_type_Long = 9004L;
    this.jdField_a_of_type_Aujb.g = System.currentTimeMillis();
    this.jdField_a_of_type_Aujb.c();
  }
  ...
  public void d()
  {
    ...
    this.jdField_a_of_type_Aujb.jdField_a_of_type_Long = 9037L;
    this.jdField_a_of_type_Aujb.g = System.currentTimeMillis();
    this.jdField_a_of_type_Aujb.c();
  ...
  public void f()
  {
    this.jdField_a_of_type_Aujb.jdField_a_of_type_Int = 3000;
    this.jdField_a_of_type_Aujb.jdField_d_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileName;
    this.jdField_a_of_type_Aujb.j = this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize;
    this.jdField_a_of_type_Aujb.h = this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerUin;
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.status = 0;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerDataCenter().c(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity);
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.status = 2;
    if (QLog.isColorLevel()) {
    ...
    auel.a().execute(new DiscFileOperator.2(this));
  }
}
