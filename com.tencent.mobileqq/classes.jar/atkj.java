  ...
  extends Handler
{
  ...
  public atkj(QQMusicPlayService paramQQMusicPlayService, Looper paramLooper)
  {
    super(paramLooper);
    ...
    do
    {
      do
      {
        do
        {
                    ...
                    do
                    {
                          ...
                          do
                          {
                            do
                            {
                              ...
                              do
                              {
                                ...
                                localatkm = (atkm)paramMessage.obj;
                              } while (localatkm == null);
                              ...
                              for (paramMessage = "null";; paramMessage = QQMusicPlayService.b().a())
                              {
                                ...
                                {
                                  localatkm.a.release();
                                  if (QQMusicPlayService.a() == localatkm.a) {
                      ...
                      if ((paramMessage.equals(QQMusicPlayService.b())) && ((QQMusicPlayService.e() == 2) || (QQMusicPlayService.e() == 1)))
                      {
                        ...
                        for (i = -1;; i = Math.abs(m - paramMessage.a()))
                        {
                          ...
                          atkh.a(i, bdee.b((Context)localObject));
                          return;
                        }
                      }
                      if (QQMusicPlayService.a().isPlaying())
                      {
                        ...
                        atkh.b(QQMusicPlayService.b(), QQMusicPlayService.d());
                      }
          ...
          } while (!bdee.g(((QQMusicPlayService)localObject).getApplicationContext()));
          if (QLog.isColorLevel()) {
