  ...
  extends axup
{
  ...
  List<axup> jdField_a_of_type_JavaUtilList = null;
  ...
  private View a(View paramView)
  {
    ...
    ((ImageView)localObject).setImageResource(2130843605);
    int i = actj.a(9.0F, paramView.getResources());
    LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(actj.a(8.0F, paramView.getResources()), i);
    localLayoutParams.leftMargin = actj.a(24.0F, paramView.getResources());
    localLayoutParams.rightMargin = actj.a(4.0F, paramView.getResources());
    localLinearLayout.addView((View)localObject, localLayoutParams);
    paramView.setPadding(0, 0, 0, 0);
    localObject = paramView.findViewById(2131378365);
    if (localObject != null) {
  ...
  private void a(Resources paramResources, ImageView paramImageView)
  {
    ...
    {
      paramImageView.setBackgroundResource(2130843604);
      return;
    }
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if ((paramView != null) && ((paramView instanceof LinearLayout)))
    {
      ...
      localObject2 = (axup)this.jdField_a_of_type_JavaUtilList.get(i);
      paramView = ((axup)localObject2).jdField_a_of_type_JavaLangString;
      if (!"summary".equals(paramView)) {
        break label334;
      }
      paramView = new LinearLayout(paramContext);
      paramView.setId(2131376570);
      paramView.setOrientation(0);
      localObject1 = new LinearLayout.LayoutParams(-1, actj.a(42.0F, localResources));
      ((LinearLayout.LayoutParams)localObject1).leftMargin = actj.a(13.0F, localResources);
      ((LinearLayout.LayoutParams)localObject1).rightMargin = actj.a(13.0F, localResources);
      ((LinearLayout.LayoutParams)localObject1).topMargin = 0;
      ((LinearLayout.LayoutParams)localObject1).bottomMargin = 0;
      localObject3 = (LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131376571);
      ...
      ((ImageView)localObject1).setId(2131376569);
    ...
    do
    {
      for (;;)
      {
        ...
        paramView = ((axup)localObject2).a(paramContext, null, paramBundle);
        ...
        ((LinearLayout.LayoutParams)localObject1).topMargin = 0;
        ((LinearLayout.LayoutParams)localObject1).bottomMargin = 0;
        localObject2 = (LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131376571);
    ...
    label430:
    Object localObject1 = (LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131376571);
    paramView = (View)localObject1;
    if (localObject1 == null)
    {
      paramView = new LinearLayout(paramContext);
      paramView.setOrientation(1);
      paramView.setId(2131376571);
      if (!this.jdField_a_of_type_Boolean) {
        break label646;
      }
    ...
    for (;;)
    {
      ...
      ((LinearLayout.LayoutParams)localObject1).bottomMargin = 0;
      this.jdField_a_of_type_AndroidViewViewGroup.addView(paramView, (ViewGroup.LayoutParams)localObject1);
      localObject3 = ((axup)localObject2).a(paramContext, null, paramBundle);
      ...
      localObject2 = new LinearLayout.LayoutParams(-1, actj.a(48.0F, localResources));
      ((LinearLayout.LayoutParams)localObject2).gravity = 16;
      paramView.addView((View)localObject1, (ViewGroup.LayoutParams)localObject2);
      this.k += 1;
      break;
  ...
  public void a()
  {
    ...
    {
      return;
      localLinearLayout = (LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131376571);
    } while (localLinearLayout == null);
    localLinearLayout.setVisibility(8);
    this.jdField_a_of_type_Boolean = false;
    a(this.jdField_a_of_type_AndroidContentContext.getResources(), (ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131376569));
  }
  ...
  public boolean a(axwg paramaxwg)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_b_of_type_JavaLangString = paramaxwg.a("url");
      this.k = 0;
      Object localObject = paramaxwg.a("expand");
      if ((localObject != null) && (((String)localObject).toLowerCase().equals("true"))) {
        this.jdField_a_of_type_Boolean = true;
      }
      localObject = paramaxwg.a("animation");
      if ((localObject != null) && (((String)localObject).toLowerCase().equals("false"))) {
        this.jdField_b_of_type_Boolean = false;
      }
      localObject = paramaxwg.a("duration");
      if (localObject != null) {}
      try
      {
        this.jdField_c_of_type_Long = Long.parseLong((String)localObject);
        label157:
        if ((paramaxwg.jdField_a_of_type_JavaUtilList != null) && (paramaxwg.a() > 0))
        {
          Iterator localIterator = paramaxwg.jdField_a_of_type_JavaUtilList.iterator();
          localObject = null;
          if (localIterator.hasNext())
          {
            axwg localaxwg = (axwg)localIterator.next();
            if (("summary".equals(localaxwg.jdField_b_of_type_JavaLangString)) || ("hr".equals(localaxwg.jdField_b_of_type_JavaLangString))) {
              paramaxwg = axuz.a(localaxwg.jdField_b_of_type_JavaLangString);
            }
            do
            {
              ...
              localObject = paramaxwg;
              if (!paramaxwg.a(localaxwg)) {
                break;
              }
              a(paramaxwg);
              localObject = paramaxwg;
              break;
              paramaxwg = (axwg)localObject;
            } while (!"item".equals(localaxwg.jdField_b_of_type_JavaLangString));
            paramaxwg = localaxwg.a("layout");
            try
            {
              if (!TextUtils.isEmpty(paramaxwg)) {}
              for (int i = Integer.parseInt(paramaxwg);; i = 0)
              {
                paramaxwg = axuz.a(i);
                this.k += 1;
                break;
  ...
  public void b()
  {
    ...
    {
      return;
      localObject1 = (LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131376571);
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      if (this.jdField_b_of_type_Boolean)
      {
        localObject2 = new axvw((ViewGroup)localObject1);
        ((axvw)localObject2).setDuration(this.jdField_c_of_type_Long);
        ((axvw)localObject2).setInterpolator(new DecelerateInterpolator());
      ...
      for (;;)
      {
        ...
        localObject2 = (bdvn)((QQAppInterface)localObject3).a(85);
        localObject3 = new StringBuilder();
        ((StringBuilder)localObject3).append(this.d).append("&expand=").append(this.jdField_a_of_type_Boolean);
        ((bdvn)localObject2).a(((StringBuilder)localObject3).toString(), 1, false, 0.0D, 0.0D, (String)localObject1, 1, "", "", "");
        return;
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      localObject2 = new axvv((ViewGroup)localObject1);
      ((axvv)localObject2).setDuration(this.jdField_c_of_type_Long);
      ((axvv)localObject2).setInterpolator(new AccelerateInterpolator());
      ((LinearLayout)localObject1).startAnimation((Animation)localObject2);
    }
    for (;;)
    {
