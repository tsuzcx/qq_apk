...
public class asei
  extends aryv
{
  private URLDrawableDownListener.Adapter jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new asej(this);
  AbsShareMsg jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg;
  String h = "";
  boolean i = false;
  
  public asei(Intent paramIntent)
  {
    super(paramIntent);
  }
  ...
  private void a(boolean paramBoolean, String paramString, long paramLong)
  {
    ...
    {
      if (str2.startsWith(alud.a(2131705225))) {
    ...
    for (;;)
    {
      ...
      adpn.a(this.jdField_a_of_type_AndroidAppActivity, localIntent, MiniChatActivity.class, MiniMultiForwardFragment.class);
      return;
      str1 = str2;
      if (!str2.startsWith(alud.a(2131705196))) {
        break;
      }
  ...
  private boolean a(AbsShareMsg paramAbsShareMsg)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject = (azus)paramAbsShareMsg.get(j);
        if (!(localObject instanceof azyj)) {
          break label139;
        }
        localObject = ((azyj)localObject).a;
        if (localObject == null) {
          break label179;
        }
        k = 0;
        ...
        azus localazus = (azus)((List)localObject).get(k);
        if ((!(localazus instanceof azzv)) || (((azzv)localazus).a())) {
          break label132;
        }
        bool1 = true;
      }
      ...
      do
      {
        do
        {
          ...
          paramAbsShareMsg = (azxl)localObject;
          bool1 = bool2;
  ...
  private View b()
  {
    ...
    for (;;)
    {
      ...
      if (j != 0)
      {
        ...
        ((ImageView)localObject).setImageResource(2130839709);
        ...
        ((View)localObject).setBackgroundResource(2130839719);
        localFrameLayout.addView((View)localObject, new FrameLayout.LayoutParams(-1, bdoo.a(33.0F), 16));
        ((View)localObject).setOnClickListener(new asek(this));
        ((View)localObject).setContentDescription(alud.a(2131705197));
      }
  ...
  private void b(bdjz parambdjz)
  {
    ...
    {
      localObject3 = URLDrawable.getDrawable((String)localObject3, -1, aepi.a(165.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), localDrawable, localDrawable, true);
  ...
  private View c()
  {
    Object localObject1 = alud.a(2131705214);
    ...
    if (k == 1) {
      localObject1 = alud.a(2131705213) + (String)localObject2;
    }
    int j;
    if ((k == 0) || (k == -1))
    {
      localObject1 = (azus)this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mStructMsgItemLists.get(0);
      if ((localObject1 instanceof azut))
      {
        localObject1 = (azus)((azut)localObject1).a.get(0);
        if ((localObject1 instanceof StructMsgItemTitle))
        {
          localObject1 = ((StructMsgItemTitle)localObject1).Y;
          if ((!TextUtils.isEmpty((CharSequence)localObject1)) && (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.hasTSum()) && (((String)localObject1).endsWith(alud.a(2131705194))))
          {
            j = 1;
            if (j == 0) {
              break label565;
            ...
            label183:
            localObject2 = alud.a(2131705183) + (String)localObject1;
          }
        }
      }
    }
    for (;;)
    {
      ...
      ((EllipsizingTextView)localObject4).setText(new bamp((CharSequence)localObject2, 3, 16));
      ...
      localObject4 = new LinearLayout.LayoutParams(bdoo.a(8.0F), bdoo.a(14.0F));
      ((LinearLayout.LayoutParams)localObject4).gravity = 17;
      ((LinearLayout.LayoutParams)localObject4).setMargins(bdoo.a(3.0F), 0, 0, 0);
      ...
      if (k == 1)
      {
        bool = true;
        label450:
        ((View)localObject2).setOnClickListener(new asel(this, bool, (String)localObject1, l));
      ...
      while ((k != 0) && (k != -1))
      {
        ...
        j = 0;
        break;
        localObject1 = alud.a(2131705191);
        break label183;
        bool = false;
        break label450;
      }
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg != null)
    {
      ...
      for (;;)
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForAudioShare)) {
          ...
          localLayoutParams.setMargins(aepi.a(-10.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0, aepi.a(-7.5F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0);
        }
      }
  ...
  protected void b()
  {
    ...
    {
      ViewGroup.LayoutParams localLayoutParams = ((LinearLayout)this.jdField_a_of_type_Bdjz.findViewById(2131363352)).getLayoutParams();
  ...
  protected boolean c()
  {
    ...
    if (f())
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForImageShare))
      {
        ...
        {
          localObject2 = aepi.a(new Intent(this.jdField_a_of_type_AndroidAppActivity, ChatActivity.class), null);
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForImageShare))
      {
        ...
        if (!this.jdField_a_of_type_AndroidOsBundle.getBoolean("k_back", true))
        {
          localObject1 = aepi.a(new Intent(this.jdField_a_of_type_AndroidAppActivity, ChatActivity.class), null);
  ...
  protected int d()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForImageShare))
    {
      localObject1 = bivs.a((StructMsgForImageShare)this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg);
      if ((localObject1 == null) || (!biva.b(((azwy)localObject1).S).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), -1, null))) {}
    }
    else
    {
      for (j = 0;; j = 0)
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgServiceID != 32) || (TextUtils.isEmpty((CharSequence)localObject1)) || (TextUtils.isEmpty(localObject2)) || (TextUtils.isEmpty(localObject3)) || (!biva.a(Float.valueOf((String)localObject1).floatValue(), Float.valueOf(localObject2).floatValue(), localObject4, localObject3, null).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), -1, null))) {
          break label540;
        }
      }
      localObject1 = bivs.a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.getXmlBytes());
      if (!(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForAudioShare)) {
        break label545;
      }
    }
  ...
  protected void d()
  {
    ...
    azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800567B", "0X800567B", 0, 0, j + "", "", "", "");
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForGeneralShare))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        {
          localObject2 = ((azyj)localObject2).a.iterator();
          while (((Iterator)localObject2).hasNext())
          {
            Object localObject3 = (azus)((Iterator)localObject2).next();
            if ((localObject3 instanceof azzv))
            {
              localObject3 = (azzv)localObject3;
              if (((azzv)localObject3).a()) {
                ntd.a("0X80065FF", ((StructMsgForGeneralShare)localObject1).uinType, ntd.a(((azzv)localObject3).r, ((StructMsgForGeneralShare)localObject1).mSourceName), ((azzv)localObject3).U, "");
              }
            }
          }
        }
    ...
    for (;;)
    {
      ...
      localObject1 = "";
      if (j != 0) {
        localObject1 = this.jdField_a_of_type_Bdjz.getInputValue();
      }
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForImageShare))
      {
        if (agiy.b(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgActionData))
        {
          localObject1 = agiy.b(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgActionData);
  ...
  protected void y()
  {
    ((zxz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(49)).a().a(this.jdField_a_of_type_AndroidOsBundle.getString("uin"), this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg);
    this.jdField_a_of_type_AndroidAppActivity.finish();
  }
}
