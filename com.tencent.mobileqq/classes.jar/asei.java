...
public class asei
{
  ...
  public asei(String paramString)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_b_of_type_JavaLangString = "";
    this.jdField_b_of_type_Boolean = false;
    this.jdField_a_of_type_ArrayOfAsej = new asej[6];
    int i = 0;
    while (i < this.jdField_a_of_type_ArrayOfAsej.length)
    {
      this.jdField_a_of_type_ArrayOfAsej[i] = null;
      i += 1;
    }
    this.jdField_a_of_type_Long = 0L;
    this.jdField_a_of_type_JavaUtilArrayList = bbdh.a();
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if ((i < this.jdField_a_of_type_ArrayOfAsej.length) && (i < aseg.a.length))
      {
        if (((JSONObject)localObject).has(aseg.a[i])) {
          this.jdField_a_of_type_ArrayOfAsej[i] = asej.a(((JSONObject)localObject).getJSONObject(aseg.a[i]));
        } else {
          this.jdField_a_of_type_ArrayOfAsej[i] = null;
        }
      }
      else
      {
        ...
        i = j;
        while ((i < this.jdField_a_of_type_ArrayOfAsej.length) && (i < aseg.a.length))
        {
          ((StringBuilder)localObject).append(aseg.a[i]).append(": ").append(this.jdField_a_of_type_ArrayOfAsej[i]).append("\n");
          i += 1;
        }
