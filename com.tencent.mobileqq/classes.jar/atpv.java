  ...
  extends atqb
{
  ...
  public atpv(QQAppInterface paramQQAppInterface, Context paramContext)
  {
  ...
  public boolean b()
  {
    ...
    if ((!TextUtils.isEmpty(str)) && (l > 0L) && (l > ((atam)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(317)).a(bfpj.a(str)).b)) {
      return true;
    }
    return l > 1048576L;
  }
