  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      View localView = paramView.findViewById(2131377946);
      if (localView != null)
      {
        Object localObject1 = localView.getTag(2131377946);
        if ((localObject1 != null) && (StructMsgForGeneralShare.class.isInstance(localObject1)))
        {
          ...
          if (localObject1 != null) {
            ...
            {
              localObject3 = (ahkc)localObject1;
          ...
          for (;;)
          {
            for (;;)
            {
              ...
              break;
              if (paramView.getTag(2131377943) == null) {
                break;
              }
              do
              {
                localObject3 = null;
                break;
              } while (paramView.getTag(2131377943) != null);
              break;
              label253:
              ...
              if ((localObject2 != null) && ((localObject2 instanceof QQAppInterface)))
              {
                ...
                aoqq.a((QQAppInterface)localObject2, 0, 4, localStructMsgForGeneralShare.message);
                ...
                try
                {
                  ...
                  ((JSONObject)localObject4).put("net", String.valueOf(nlw.a()));
                  ((JSONObject)localObject4).put("mobile_imei", bgln.a());
                  ...
                  txr.a((AppInterface)localObject2, localStructMsgForGeneralShare.message.selfuin, ((JSONObject)localObject4).toString(), "" + localStructMsgForGeneralShare.msgId);
                  Object localObject5 = (oda)((QQAppInterface)localObject2).getManager(88);
                  localObject4 = (odu)((QQAppInterface)localObject2).a(88);
                  if ((localStructMsgForGeneralShare.message != null) && (localObject5 != null) && (localObject4 != null) && (((oda)localObject5).a(localStructMsgForGeneralShare.message.senderuin)))
                  {
                    localObject5 = localStructMsgForGeneralShare.message;
                    if (TextUtils.isEmpty(localStructMsgForGeneralShare.index))
                    {
                      i = 0;
                      ((odu)localObject4).a(false, (MessageRecord)localObject5, i, localStructMsgForGeneralShare.mMsgUrl);
                    }
                  }
                  else
                  {
                    ...
                    {
                      bcst.b((QQAppInterface)localObject2, "P_CliOper", "Pb_account_lifeservice", localStructMsgForGeneralShare.uin, "mp_msg_msgpic_click", "aio_morpic_click", 0, 0, "", "", Long.toString(localStructMsgForGeneralShare.msgId), "");
                    ...
                    if ((localObject3 != null) && (((ahkc)localObject3).a != null)) {
                      nmj.a((QQAppInterface)localObject2, "", "click", localStructMsgForGeneralShare.mSourceAppid, localStructMsgForGeneralShare.mMsgServiceID, nmj.a(((ahkc)localObject3).a.jdField_a_of_type_Int));
                    }
                    ...
                    bcst.b((QQAppInterface)localObject2, "CliOper", "", "", "0X800567A", "0X800567A", 0, 0, localStructMsgForGeneralShare.mMsgServiceID + "", "", "", "");
                    if (localStructMsgForGeneralShare.uinType != 1008) {
                      break label1672;
                    }
                    j = 2;
                    bcst.b((QQAppInterface)localObject2, "CliOper", "", "", "0X8004B5C", "0X8004B5C", j, 0, "", String.valueOf(i), (String)localObject4, localStructMsgForGeneralShare.source_puin);
                    bcst.b(null, "dc00898", "", "", "0X800A630", "0X800A630", 0, 0, "1", ForwardUtils.b(localStructMsgForGeneralShare.uinType), localStructMsgForGeneralShare.mContentTitle, "");
                    ...
                    if ((localView instanceof ViewGroup))
                    {
                      ...
                      if ((localObject4 != null) && ((localObject4 instanceof TextViewWrapLayout)))
                      {
                        ...
                        if ((localObject4 != null) && ((localObject4 instanceof bcyl))) {
                          bcst.b((QQAppInterface)localObject2, "dc00898", "", "", "0X8007C38", "0X8007C38", 0, 0, ((bcyl)localObject4).o + "", "", "", "");
                        }
                      }
                    }
                    if ((localObject3 != null) && (localStructMsgForGeneralShare.hasFlag(16)))
                    {
                      ...
                      ThreadManager.post(new StructMsgForGeneralShare.5.2(this, (ahkc)localObject3, (QQAppInterface)localObject2), 2, null, false);
                    }
                    if ((localStructMsgForGeneralShare != null) && (localObject3 != null) && (((ahkc)localObject3).a != null) && ((((ahkc)localObject3).a.jdField_a_of_type_Int == 1025) || (((ahkc)localObject3).a.jdField_a_of_type_Int == 0)) && (!TextUtils.isEmpty(localStructMsgForGeneralShare.mMsgAction)) && (nki.b(((ahkc)localObject3).a.jdField_a_of_type_JavaLangString)) && ((localStructMsgForGeneralShare.mMsgServiceID != 92) || (localStructMsgForGeneralShare.message == null))) {}
                  }
                  try
                  {
                    if (QLog.isColorLevel()) {
                    ...
                    if (!localStructMsgForGeneralShare.mQidianBulkTaskId.equals("0"))
                    {
                      ...
                      ((bjhb)((QQAppInterface)localObject2).a(85)).a(((JSONObject)localObject4).toString(), localStructMsgForGeneralShare.message.frienduin, "", 10009, 0);
                    }
                  }
                  ...
                  ((bjft)((QQAppInterface)localObject2).getManager(165)).a(localStructMsgForGeneralShare.mMsgAction, localStructMsgForGeneralShare.mMsg_A_ActionData, localStructMsgForGeneralShare.mMsgActionData, localStructMsgForGeneralShare.mMsgUrl, 0, "");
                  if ((localObject3 != null) && (tzo.a(((ahkc)localObject3).a)) && (localStructMsgForGeneralShare.message != null)) {
                    bcst.b(null, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "public.message.click", 0, 0, localStructMsgForGeneralShare.message.time + "", "", "", localStructMsgForGeneralShare.mMsgBrief);
                  }
                  if (localChatFragment != null)
                  {
                  ...
                  StructMsgForGeneralShare.onClickEvent((QQAppInterface)localObject2, localContext, localStructMsgForGeneralShare, paramView, new bcwp((QQAppInterface)localObject2, paramView, localStructMsgForGeneralShare));
                }
                catch (JSONException localJSONException)
                {
                  for (;;)
                  {
                    ...
                    else
                    {
                      ...
                      j = 1;
                      continue;
                      if ((localStructMsgForGeneralShare != null) && (localObject3 != null) && (((ahkc)localObject3).a != null) && (!TextUtils.isEmpty(localStructMsgForGeneralShare.mMsgAction)) && (((ahkc)localObject3).a.jdField_a_of_type_Int == 1024)) {
                        ((bjft)((QQAppInterface)localObject2).getManager(165)).a(localStructMsgForGeneralShare.mMsgAction, localStructMsgForGeneralShare.mMsg_A_ActionData, localStructMsgForGeneralShare.mMsgActionData, localStructMsgForGeneralShare.mMsgUrl, 1, "");
                      }
                    }
                  }
                }
