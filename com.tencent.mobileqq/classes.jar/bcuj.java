...
public class bcuj
  extends bcug
  implements SeekBar.OnSeekBarChangeListener, bctu, IVideoOuterStatusListener
{
  ...
  private void a(boolean paramBoolean)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        if (this.jdField_e_of_type_AndroidWidgetImageView != null)
        {
          ...
          if (paramBoolean)
          {
            ...
            this.jdField_e_of_type_AndroidWidgetImageView.setImageResource(2130837747);
        ...
        for (;;)
        {
          ...
          this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundColor(localResources.getColor(2131166807));
          return;
          ...
          m = actj.a(20.0F, localResources);
          k = actj.a(8.0F, localResources);
          break label118;
      ...
      {
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130845351);
        return;
      }
    } while (localResources == null);
    label235:
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundColor(localResources.getColor(2131167087));
    label265:
    label275:
    label277:
    return;
  ...
  private void b()
  {
    ...
    do
    {
      ...
      {
        if ((this.jdField_a_of_type_Bcue == null) || (!this.jdField_a_of_type_Bcue.a(this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer.a(), this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer.b())))
        {
  ...
  private void c(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166807));
    }
    if (this.jdField_f_of_type_AndroidWidgetImageView != null)
    {
      if (!a(paramInt)) {
      ...
      this.jdField_f_of_type_AndroidWidgetImageView.setImageResource(2130845349);
    ...
    for (;;)
    {
      if (this.jdField_c_of_type_AndroidWidgetTextView != null)
      {
        ...
        this.jdField_c_of_type_AndroidWidgetTextView.setText(2131699626);
      }
      return;
      label138:
    ...
    if (paramInt == 401)
    {
      this.jdField_c_of_type_AndroidWidgetTextView.setText(2131699627);
      return;
    }
    if (paramInt == 402)
    {
      this.jdField_c_of_type_AndroidWidgetTextView.setText(2131699629);
      return;
    }
    if (paramInt == 403)
    {
      this.jdField_c_of_type_AndroidWidgetTextView.setText(2131699628);
      return;
    }
    this.jdField_c_of_type_AndroidWidgetTextView.setText(2131699627);
  }
  ...
  private void c(boolean paramBoolean)
  {
    if (Build.VERSION.SDK_INT >= 21) {
      if (this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer != null)
      {
        ...
        if ((this.jdField_a_of_type_AndroidContentContext != null) && (this.jdField_a_of_type_AndroidContentContext.getResources() != null))
        {
          ...
          aokl.a(this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer, this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130845345));
        }
      }
    }
    for (;;)
    {
      ...
      return;
      label97:
      aokl.a(this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer, this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130845344));
    }
  }
  ...
  private void d(int paramInt)
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null)
      {
        ...
        this.jdField_a_of_type_AndroidAnimationObjectAnimator.addUpdateListener(new bcul(this, f2, f1));
        this.jdField_a_of_type_AndroidAnimationObjectAnimator.addListener(new bcum(this, paramInt));
  ...
  private void f()
  {
    ...
    if (this.jdField_a_of_type_Bcud != null) {
      this.jdField_a_of_type_Bcud.a();
    }
  ...
  private void h()
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer.b())
      {
        ...
        {
          this.jdField_a_of_type_AndroidWidgetRelativeLayout.setContentDescription(ajya.a(2131704638));
          return;
        }
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.setContentDescription(ajya.a(2131704639));
        return;
      }
      if (this.jdField_f_of_type_Int == 0)
      {
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.setContentDescription(ajya.a(2131704642));
        return;
      }
    } while (this.jdField_f_of_type_Int != 1);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setContentDescription(ajya.a(2131704636));
  }
  ...
  public void a(Context paramContext)
  {
    ...
    this.jdField_b_of_type_AndroidWidgetFrameLayout.setId(2131373164);
    this.jdField_b_of_type_AndroidWidgetImageView = new ImageView(this.jdField_a_of_type_AndroidContentContext);
    this.jdField_b_of_type_AndroidWidgetImageView.setId(2131373150);
    this.jdField_b_of_type_AndroidWidgetImageView.setScaleType(ImageView.ScaleType.FIT_XY);
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373154));
    this.jdField_c_of_type_AndroidWidgetImageView.setContentDescription(ajya.a(2131704644));
    this.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373153));
    this.jdField_d_of_type_AndroidWidgetImageView.setContentDescription(ajya.a(2131704640));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373160));
    this.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(ajya.a(2131704641));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373159));
    this.jdField_b_of_type_AndroidWidgetTextView.setContentDescription(ajya.a(2131704637));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373157));
    this.jdField_e_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373155));
    this.jdField_e_of_type_AndroidWidgetImageView.setContentDescription(ajya.a(2131704643));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373161));
    this.jdField_f_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373156));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373163));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373162));
    ...
    this.jdField_a_of_type_AndroidWidgetSeekBar = ((SeekBar)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373166));
    this.jdField_a_of_type_AndroidWidgetSeekBar.setOnSeekBarChangeListener(this);
    this.jdField_a_of_type_AndroidWidgetSeekBar.setThumb(paramContext.getResources().getDrawable(2130848696));
    this.jdField_a_of_type_AndroidWidgetSeekBar.setProgressDrawable(paramContext.getResources().getDrawable(2130845186));
  ...
  public void a(bcud parambcud)
  {
    this.jdField_a_of_type_Bcud = parambcud;
  }
  
  public void a(bcue parambcue)
  {
    super.a(parambcue);
  }
  ...
  public void d()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenStatusReceiver == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenStatusReceiver.a(0, new bcuk(this));
    }
  }
  ...
  public void onVideoStart(int paramInt)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        return;
        if ((this.jdField_a_of_type_AndroidContentContext != null) && (this.jdField_a_of_type_AndroidContentContext.getResources() != null)) {
          this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167087));
        }
      }
