...
public class bojf
{
  private static final int jdField_a_of_type_Int = bgtn.a(2.0F);
  private static final int jdField_b_of_type_Int = bgtn.a(4.0F);
  private float jdField_a_of_type_Float;
  private Bitmap jdField_a_of_type_AndroidGraphicsBitmap;
  private Paint jdField_a_of_type_AndroidGraphicsPaint = new Paint();
  private GestureDetector.OnGestureListener jdField_a_of_type_AndroidViewGestureDetector$OnGestureListener = new bojg(this);
  ...
  public bojf(boji paramboji, String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean, int paramInt4, int paramInt5)
  {
    ...
    if (this.jdField_c_of_type_Int < this.jdField_d_of_type_Int)
    {
      ...
      this.jdField_a_of_type_AndroidViewGestureDetector = new GestureDetector(this.jdField_a_of_type_Boji.a(), this.jdField_a_of_type_AndroidViewGestureDetector$OnGestureListener);
    ...
    {
      if (this.m > 10000) {
        bnzb.c("AEEditorMusicWaveScrollProcessor", "AEEditorMusicWaveScrollProcessor() called with: parent = [" + paramboji + "], audioPath = [" + paramString2 + "], audioDuration = [" + paramInt1 + "], perScreenDuration = [" + paramInt2 + "], padding = [" + paramInt3 + "], isFromLibrary = [" + paramBoolean + "], width = [" + paramInt4 + "], height = [" + paramInt5 + "] lineCount=" + this.m);
      }
      boje.a(paramString1, paramString2, this.m);
      return;
  ...
  private void a()
  {
    if (this.jdField_a_of_type_AndroidGraphicsBitmap == null) {
      this.jdField_a_of_type_AndroidGraphicsBitmap = BitmapUtils.decodeSampledBitmapFromResource(BaseApplicationImpl.getApplication().getResources(), 2130837745, 16, 118);
    }
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Boji != null) {
      this.jdField_a_of_type_Boji.a();
    }
  }
  ...
  public void a(Canvas paramCanvas, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (i4 < i6)
      {
        ...
        if (!this.jdField_a_of_type_Boolean)
        {
          i7 = (int)(boje.a(i4 - i5) * (this.e - this.g * 4));
  ...
  public void a(MotionEvent paramMotionEvent)
  {
    if (paramMotionEvent.getAction() == 1) {
      if (this.jdField_a_of_type_Bojh != null) {
        this.jdField_a_of_type_Bojh.b();
      }
    }
