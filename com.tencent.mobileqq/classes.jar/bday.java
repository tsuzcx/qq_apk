  ...
  extends bczq
{
  ...
  static bday jdField_a_of_type_Bday;
  ...
  public int a;
  public Camera a;
  aqpp jdField_a_of_type_Aqpp = aqpp.a();
  bdba jdField_a_of_type_Bdba = new bdba(this);
  ...
  static
  {
    if (!bday.class.desiredAssertionStatus()) {}
  ...
  private bdbb a(List<Camera.Size> paramList, int paramInt1, int paramInt2)
  {
    int j = -1;
    ...
    for (;;)
    {
      ...
      if (i > 0)
      {
        localbdbb.jdField_b_of_type_Int = paramInt2;
        localbdbb.jdField_a_of_type_Int = i;
        if (localbdbb.jdField_a_of_type_Int / 4 == localbdbb.jdField_b_of_type_Int / 3)
        {
          if (QLog.isColorLevel()) {
  ...
  private bdbb a(List<Camera.Size> paramList, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      ...
      if (localIterator.hasNext())
      {
        ...
        if ((localSize != null) && (localSize.width >= paramInt1) && (localSize.height >= paramInt2) && (localSize.width / localSize.height >= d1))
        {
          ...
          if (l2 < l1)
          {
            localbdbb.jdField_a_of_type_Int = localSize.width;
            localbdbb.jdField_b_of_type_Int = localSize.height;
            l1 = l2;
          }
        }
        for (;;)
        {
          break;
          if ((l2 == l1) && (localSize.width < localbdbb.jdField_a_of_type_Int))
          {
            localbdbb.jdField_a_of_type_Int = localSize.width;
            localbdbb.jdField_b_of_type_Int = localSize.height;
          }
    ...
    if (((localbdbb.jdField_a_of_type_Int <= 0) || (localbdbb.jdField_b_of_type_Int <= 0)) && (paramList != null) && (!paramList.isEmpty()))
    {
      localIterator = paramList.iterator();
      l1 = 0L;
      if (localIterator.hasNext())
    ...
    if (QLog.isColorLevel()) {
      QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewSize[self-adaption] cSize.width=" + localbdbb.jdField_a_of_type_Int + "  cSize.height=" + localbdbb.jdField_b_of_type_Int);
    }
    if ((localbdbb.jdField_a_of_type_Int > 0) && (localbdbb.jdField_b_of_type_Int > 0)) {
      return localbdbb;
    }
    if ((paramList != null) && (!paramList.isEmpty()) && (paramList.get(0) != null))
    {
      localbdbb.jdField_a_of_type_Int = ((Camera.Size)paramList.get(0)).width;
      localbdbb.jdField_b_of_type_Int = ((Camera.Size)paramList.get(0)).height;
      return localbdbb;
    }
    return null;
  }
  
  private bdbb a(List<Camera.Size> paramList, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6)
  {
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (((List)localObject1).size() == 0)
      {
        ...
        if (paramList.hasNext())
        {
          localObject3 = (bdbb)paramList.next();
          if (localObject3 == null) {
            break label885;
          }
          paramInt1 = Math.max(((bdbb)localObject3).jdField_a_of_type_Int, ((bdbb)localObject3).jdField_b_of_type_Int);
          paramInt2 = Math.min(((bdbb)localObject3).jdField_a_of_type_Int, ((bdbb)localObject3).jdField_b_of_type_Int);
      ...
      for (;;)
      {
        ...
        if (QLog.isColorLevel())
        {
          ...
          if (localObject1 != null)
          {
            ...
            for (;;)
            {
              ...
              QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getHighVersionPreviewSizeV2 secend: width=" + ((bdbb)((List)localObject1).get(paramInt1)).jdField_a_of_type_Int + " height=" + ((bdbb)((List)localObject1).get(paramInt1)).jdField_b_of_type_Int + " w/h=" + ((bdbb)((List)localObject1).get(paramInt1)).jdField_a_of_type_Int / ((bdbb)((List)localObject1).get(paramInt1)).jdField_b_of_type_Int);
              paramInt1 += 1;
            }
            f2 = 10000.0F;
          }
        ...
        if (((List)localObject1).size() == 0)
        {
          ...
          while (paramList.hasNext())
          {
            ...
            {
              paramInt1 = Math.max(((bdbb)localObject2).jdField_a_of_type_Int, ((bdbb)localObject2).jdField_b_of_type_Int);
              paramInt2 = Math.min(((bdbb)localObject2).jdField_a_of_type_Int, ((bdbb)localObject2).jdField_b_of_type_Int);
          ...
          if ((QLog.isColorLevel()) && (localObject1 != null))
          {
            ...
            {
              QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getHighVersionPreviewSizeV2 third: width=" + ((bdbb)((List)localObject1).get(paramInt1)).jdField_a_of_type_Int + " height=" + ((bdbb)((List)localObject1).get(paramInt1)).jdField_b_of_type_Int + " w/h=" + ((bdbb)((List)localObject1).get(paramInt1)).jdField_a_of_type_Int / ((bdbb)((List)localObject1).get(paramInt1)).jdField_b_of_type_Int);
              paramInt1 += 1;
            }
          }
        }
        if (((List)localObject1).size() > 0)
        {
          ...
          if ((localObject1 == null) || (((bdbb)localObject1).jdField_a_of_type_Int * ((bdbb)localObject1).jdField_b_of_type_Int <= paramList.jdField_a_of_type_Int * paramList.jdField_b_of_type_Int)) {
            break label882;
          }
  ...
  private int c()
  {
    ...
    float f = i * 1.0F / 8.0F;
    int j = (int)(this.jdField_a_of_type_Bdbb.jdField_b_of_type_Int * this.jdField_a_of_type_Bdbb.jdField_a_of_type_Int * f);
    if (QLog.isColorLevel()) {
      ...
      try
      {
        for (;;)
        {
          ...
          if (VersionUtils.isGingerBread())
          {
            ...
            bpam.b(jdField_b_of_type_JavaLangString, "【Real Old openCamera】:" + this.jdField_a_of_type_Int);
            bpam.b(jdField_b_of_type_JavaLangString, "【Real Old openCamera】:currentCount= " + j);
          }
          for (this.jdField_a_of_type_AndroidHardwareCamera = Camera.open(this.jdField_a_of_type_Int);; this.jdField_a_of_type_AndroidHardwareCamera = Camera.open())
          {
            ...
            if (bdaw.a().a(this.jdField_a_of_type_AndroidHardwareCamera)) {
              break label321;
            }
            if (QLog.isColorLevel()) {
          ...
          try
          {
            ...
            i = 3;
            break label83;
            this.jdField_a_of_type_Bdba = new bdba(this);
  ...
  public bdbb a(int paramInt)
  {
    Object localObject2 = bdaw.a().a();
    int i;
    ...
    if (((List)localObject1).size() > 0)
    {
      ...
      for (paramInt = 2147483647; ((Iterator)localObject1).hasNext(); paramInt = i)
      {
        ...
        if (((Camera.Size)localObject2).width < paramInt)
        {
          ...
          localbdbb.jdField_b_of_type_Int = ((Camera.Size)localObject2).height;
          localbdbb.jdField_a_of_type_Int = ((Camera.Size)localObject2).width;
        }
      }
    }
    if (localbdbb.jdField_a_of_type_Int > 0) {
      return localbdbb;
    }
    return null;
  }
  
  public bdbb a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    Object localObject2 = bdaw.a().a();
    ...
    for (;;)
    {
      ...
      if (paramInt2 > 0)
      {
        localbdbb.jdField_b_of_type_Int = j;
        localbdbb.jdField_a_of_type_Int = paramInt2;
        if ((bdax.a()) && (a((ArrayList)localObject3, i, j))) {
          localbdbb.jdField_a_of_type_Int = i;
        }
        return localbdbb;
      }
      ...
      if (((Iterator)localObject1).hasNext())
      {
        ...
        if ((localObject5 != null) && (a(paramInt1, paramInt3, paramInt4, ((Camera.Size)localObject5).width, ((Camera.Size)localObject5).height)))
        {
          ...
          if (l2 < l1)
          {
            localbdbb.jdField_a_of_type_Int = ((Camera.Size)localObject5).width;
            localbdbb.jdField_b_of_type_Int = ((Camera.Size)localObject5).height;
            l1 = l2;
          }
        }
        for (;;)
        {
          break;
          if ((l2 == l1) && (((Camera.Size)localObject5).width < localbdbb.jdField_a_of_type_Int))
          {
            localbdbb.jdField_a_of_type_Int = ((Camera.Size)localObject5).width;
            localbdbb.jdField_b_of_type_Int = ((Camera.Size)localObject5).height;
          }
      ...
      for (;;)
      {
        ...
        if (paramInt1 > 0)
        {
          localbdbb.jdField_b_of_type_Int = i;
          localbdbb.jdField_a_of_type_Int = paramInt1;
          return localbdbb;
        }
        if ((localbdbb.jdField_a_of_type_Int <= 0) || (localbdbb.jdField_b_of_type_Int <= 0))
        {
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            if (localObject4 != null)
            {
              ...
              if (l2 < l1)
              {
                localbdbb.jdField_a_of_type_Int = ((Camera.Size)localObject4).width;
                localbdbb.jdField_b_of_type_Int = ((Camera.Size)localObject4).height;
                l1 = l2;
              }
            }
            for (;;)
            {
              break;
              if ((l2 == l1) && (((Camera.Size)localObject4).width < localbdbb.jdField_a_of_type_Int))
              {
                localbdbb.jdField_a_of_type_Int = ((Camera.Size)localObject4).width;
                localbdbb.jdField_b_of_type_Int = ((Camera.Size)localObject4).height;
              }
        ...
        if ((localbdbb.jdField_a_of_type_Int <= 0) || (localbdbb.jdField_b_of_type_Int <= 0))
        {
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            if ((localObject3 != null) && (a(320, paramInt3, paramInt4, ((Camera.Size)localObject3).width, ((Camera.Size)localObject3).height)))
            {
              ...
              if (l2 < l1)
              {
                localbdbb.jdField_a_of_type_Int = ((Camera.Size)localObject3).width;
                localbdbb.jdField_b_of_type_Int = ((Camera.Size)localObject3).height;
                l1 = l2;
              }
            }
            for (;;)
            {
              break;
              if ((l2 == l1) && (((Camera.Size)localObject3).width < localbdbb.jdField_a_of_type_Int))
              {
                localbdbb.jdField_a_of_type_Int = ((Camera.Size)localObject3).width;
                localbdbb.jdField_b_of_type_Int = ((Camera.Size)localObject3).height;
              }
        ...
        if ((localbdbb.jdField_a_of_type_Int <= 0) || (localbdbb.jdField_b_of_type_Int <= 0))
        {
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            {
              break;
              if ((l2 == l1) && (((Camera.Size)localObject2).width < localbdbb.jdField_a_of_type_Int))
              {
                localbdbb.jdField_a_of_type_Int = ((Camera.Size)localObject2).width;
                localbdbb.jdField_b_of_type_Int = ((Camera.Size)localObject2).height;
              }
        ...
        if (QLog.isColorLevel()) {
          QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getFullVideoPreviewSize[self-adaption] cSize.width=" + localbdbb.jdField_a_of_type_Int + "  cSize.height=" + localbdbb.jdField_b_of_type_Int);
        }
        if ((localbdbb.jdField_a_of_type_Int > 0) && (localbdbb.jdField_b_of_type_Int > 0)) {
          return localbdbb;
        }
  ...
  public bdbb a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    if ((!jdField_c_of_type_Boolean) && (this.jdField_a_of_type_AndroidHardwareCamera == null)) {
      throw new AssertionError();
    }
    if ((!jdField_c_of_type_Boolean) && (this.jdField_a_of_type_Bdbb == null)) {
      throw new AssertionError();
    }
    if (a() == null) {
      return null;
    ...
    bdbb localbdbb = new bdbb();
    Object localObject1 = bdaw.a().b();
    if ((localObject1 == null) || (((List)localObject1).isEmpty())) {
      return null;
    }
    Object localObject2 = new bdbb();
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localSize != null)
      {
        ...
        if (localSize.width >= paramInt1)
        {
          ...
          {
            f2 = Math.abs(f4 - f3);
            ((bdbb)localObject2).jdField_a_of_type_Int = localSize.width;
            ((bdbb)localObject2).jdField_b_of_type_Int = localSize.height;
          }
        }
        f1 = f2;
      }
    }
    if ((localArrayList.isEmpty()) && (((bdbb)localObject2).jdField_a_of_type_Int >= paramInt1))
    {
      if (QLog.isColorLevel()) {
        QLog.i(jdField_b_of_type_JavaLangString, 2, "getPictureSize: width=" + ((bdbb)localObject2).jdField_a_of_type_Int + " height=" + ((bdbb)localObject2).jdField_b_of_type_Int + " w/h=" + ((bdbb)localObject2).jdField_a_of_type_Int / ((bdbb)localObject2).jdField_b_of_type_Int);
      }
      return localObject2;
    }
    if ((localArrayList.isEmpty()) && (((List)localObject1).size() > 0))
    {
      localbdbb.jdField_a_of_type_Int = ((Camera.Size)((List)localObject1).get(0)).width;
      localbdbb.jdField_b_of_type_Int = ((Camera.Size)((List)localObject1).get(0)).height;
      return localbdbb;
    }
    ...
    if (paramInt5 == -1)
    {
      ...
      {
        localObject2 = (Camera.Size)((Iterator)localObject1).next();
        if (localbdbb.jdField_a_of_type_Int < ((Camera.Size)localObject2).width)
        {
          localbdbb.jdField_a_of_type_Int = ((Camera.Size)localObject2).width;
          localbdbb.jdField_b_of_type_Int = ((Camera.Size)localObject2).height;
        }
    ...
    while (localbdbb.jdField_a_of_type_Int == 0)
    {
      return null;
      localbdbb = a(paramInt3, paramInt4, paramInt5, localArrayList);
    }
    return localbdbb;
  }
  
  public bdbb a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean)
  {
    int j = 0;
    if (QLog.isColorLevel()) {
      QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewSizeV2: dstwidth=" + paramInt1 + "  dstheight=" + paramInt2);
    }
    Object localObject = bdaw.a().a();
    ...
    bdbb localbdbb = a((List)localObject, paramInt1, paramInt2);
    if (localbdbb != null)
    {
      if (QLog.isColorLevel()) {
        QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewSizeGuaranteeOK: DEFAULT resolution os OK.");
      }
      localObject = localbdbb;
      if (paramBoolean)
      {
        alwe.a(2, paramInt1, paramInt2, localbdbb.jdField_a_of_type_Int, localbdbb.jdField_b_of_type_Int);
        localObject = localbdbb;
      }
    }
    do
    {
      ...
      {
        return localObject;
        localbdbb = a((List)localObject, 960, 720);
        if (localbdbb == null) {
          break;
        }
        if (QLog.isColorLevel()) {
      ...
      alwe.a(3, paramInt1, paramInt2, localbdbb.jdField_a_of_type_Int, localbdbb.jdField_b_of_type_Int);
      return localbdbb;
      localbdbb = a((List)localObject, paramInt1, paramInt2, paramInt3, paramInt4);
      localObject = localbdbb;
    } while (!paramBoolean);
    if (localbdbb == null)
    {
    ...
    label379:
    for (paramInt4 = j;; paramInt4 = localbdbb.jdField_b_of_type_Int)
    {
      alwe.a(4, paramInt1, paramInt2, paramInt3, paramInt4);
      return localbdbb;
      paramInt3 = localbdbb.jdField_a_of_type_Int;
      break;
    }
  }
  
  public bdbb a(int paramInt1, int paramInt2, int paramInt3, List<Camera.Size> paramList)
  {
  ...
  @TargetApi(17)
  public void a(File paramFile, Rect paramRect, amap paramamap, int paramInt1, boolean paramBoolean, int paramInt2)
  {
    if (this.jdField_a_of_type_AndroidHardwareCamera == null) {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          this.jdField_a_of_type_AndroidHardwareCamera.takePicture(null, null, null, new bdaz(this, paramInt1, l, paramFile, paramRect, paramamap, paramBoolean, paramInt2));
          return;
        }
  ...
  public boolean a(bdbb parambdbb)
  {
    if ((!jdField_c_of_type_Boolean) && (this.jdField_a_of_type_AndroidHardwareCamera == null)) {
      throw new AssertionError();
    }
    ...
    try
    {
      localParameters.setPreviewSize(parambdbb.jdField_a_of_type_Int, parambdbb.jdField_b_of_type_Int);
      this.jdField_a_of_type_Bdbb = parambdbb;
      boolean bool = a(localParameters);
      if (QLog.isColorLevel()) {
        QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] setParamsPreviewSize, result = " + bool + ",size.width = " + parambdbb.jdField_a_of_type_Int + ",size.height = " + parambdbb.jdField_b_of_type_Int);
      }
      return bool;
    }
    catch (Exception parambdbb)
    {
      parambdbb.printStackTrace();
    }
    return false;
  }
  
  public boolean a(bdbp parambdbp)
  {
    Camera.Parameters localParameters = a();
    if (localParameters == null)
    {
    ...
    localParameters.setPreviewFormat(parambdbp.jdField_a_of_type_Int);
    localParameters.setPreviewSize(parambdbp.jdField_a_of_type_Bdbb.jdField_a_of_type_Int, parambdbp.jdField_a_of_type_Bdbb.jdField_b_of_type_Int);
    localParameters.setPreviewFpsRange(parambdbp.jdField_b_of_type_Int, parambdbp.jdField_c_of_type_Int);
    if (parambdbp.jdField_a_of_type_Boolean) {
      localParameters.setPictureSize(parambdbp.jdField_b_of_type_Bdbb.jdField_a_of_type_Int, parambdbp.jdField_b_of_type_Bdbb.jdField_b_of_type_Int);
    }
    boolean bool = a(localParameters);
    if (bool)
    {
      this.jdField_b_of_type_Int = parambdbp.jdField_a_of_type_Int;
      this.jdField_a_of_type_Bdbb = parambdbp.jdField_a_of_type_Bdbb;
      this.jdField_a_of_type_ArrayOfInt = new int[] { parambdbp.jdField_b_of_type_Int, parambdbp.jdField_c_of_type_Int };
      this.jdField_b_of_type_Bdbb = parambdbp.jdField_b_of_type_Bdbb;
    }
    return bool;
  }
  ...
  public bdbb[] a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    bdbb localbdbb1 = a(paramInt1, paramInt2, paramInt3, paramInt4, true);
    if (localbdbb1 != null)
    {
      arrayOfbdbb[0] = localbdbb1;
      if (QLog.isColorLevel()) {
        QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewAndPictureSizeGuarantee way2 preview=" + localbdbb1.jdField_a_of_type_Int + " " + localbdbb1.jdField_b_of_type_Int);
      }
      bdbb localbdbb2 = a(localbdbb1.jdField_a_of_type_Int, localbdbb1.jdField_b_of_type_Int, paramInt3, paramInt4, 1);
      arrayOfbdbb[1] = localbdbb2;
      if (localbdbb2 != null)
      {
        if (QLog.isColorLevel()) {
          QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewAndPictureSizeGuarantee way2 picture=" + localbdbb2.jdField_a_of_type_Int + " " + localbdbb2.jdField_b_of_type_Int);
        }
        alwe.a(true, localbdbb1.jdField_a_of_type_Int, localbdbb1.jdField_b_of_type_Int, localbdbb2.jdField_a_of_type_Int, localbdbb2.jdField_b_of_type_Int);
      }
    }
    else
    {
    ...
    alwe.a(true, localbdbb1.jdField_a_of_type_Int, localbdbb1.jdField_b_of_type_Int, -1, -1);
    return arrayOfbdbb;
  }
  ...
  public bdbb b()
  {
    return this.jdField_b_of_type_Bdbb;
  }
  
  public bdbb b(int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean)
  {
    if (QLog.isColorLevel()) {
    ...
    bdbb localbdbb = a((List)localObject, paramInt1, paramInt2, 2600, 1500, (int)f1, 1000);
    if (localbdbb != null)
    {
      if (QLog.isColorLevel()) {
        QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewSizeGuaranteeOK: DEFAULT resolution os OK.");
    ...
    do
    {
      ...
      localbdbb = a((List)localObject, paramInt1, paramInt2, 2600, 1500, (int)f1, 700);
      if (localbdbb == null) {
        break;
      }
      if (QLog.isColorLevel()) {
    ...
    label444:
    label453:
    for (paramInt4 = 0;; paramInt4 = ((bdbb)localObject).jdField_b_of_type_Int)
    {
      alwe.a(4, paramInt1, paramInt2, paramInt3, paramInt4);
      return localObject;
      paramInt3 = ((bdbb)localObject).jdField_a_of_type_Int;
      break;
    }
  }
  ...
  public boolean b()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 347	bday:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   4: ifnonnull +5 -> 9
    //   7: iconst_0
    //   8: ireturn
    //   9: aload_0
    //   10: getfield 531	bday:jdField_a_of_type_Boolean	Z
    //   13: ifne +5 -> 18
    //   16: iconst_1
    //   17: ireturn
    //   18: aload_0
    //   19: iconst_0
    //   20: putfield 531	bday:jdField_a_of_type_Boolean	Z
    //   23: aload_0
    //   24: invokespecial 597	bday:h	()Z
    //   27: istore_1
    //   28: iload_1
    //   29: ifeq +10 -> 39
    //   32: aload_0
    //   33: getfield 347	bday:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   36: invokevirtual 600	android/hardware/Camera:cancelAutoFocus	()V
    //   39: aload_0
    //   40: getfield 347	bday:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   43: invokevirtual 752	android/hardware/Camera:stopPreview	()V
    //   46: aload_0
    //   47: getfield 347	bday:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   50: aconst_null
    //   51: invokevirtual 623	android/hardware/Camera:setPreviewCallback	(Landroid/hardware/Camera$PreviewCallback;)V
    //   54: aload_0
    //   55: getfield 347	bday:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   58: aconst_null
  ...
  public boolean b(bdbb parambdbb)
  {
    Camera.Parameters localParameters = a();
    if (localParameters == null) {}
    do
    {
      ...
      try
      {
        localParameters.setPictureSize(parambdbb.jdField_a_of_type_Int, parambdbb.jdField_b_of_type_Int);
        this.jdField_b_of_type_Bdbb = parambdbb;
        boolean bool = a(localParameters);
        if (QLog.isColorLevel()) {
          QLog.i(jdField_b_of_type_JavaLangString, 2, "setRawPictureSize w " + parambdbb.jdField_a_of_type_Int + ", h " + parambdbb.jdField_b_of_type_Int + ", success=" + bool);
        }
        return bool;
      }
      catch (Exception parambdbb)
    ...
    QLog.i(jdField_b_of_type_JavaLangString, 2, "setParamsPictureSize", parambdbb);
    return false;
  }
  ...
  public bdbb[] b(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if (QLog.isColorLevel()) {
    ...
    bdbb[] arrayOfbdbb = new bdbb[2];
    bdbb localbdbb1 = b(paramInt1, paramInt2, paramInt3, paramInt4, true);
    if (localbdbb1 != null)
    {
      arrayOfbdbb[0] = localbdbb1;
      if (QLog.isColorLevel()) {
  ...
  public bdbb c(int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean)
  {
    int j = 0;
    if (QLog.isColorLevel()) {
    ...
    bdbb localbdbb = a((List)localObject, bczp.jdField_c_of_type_Int, bczp.d);
    if (localbdbb != null)
    {
      if (QLog.isColorLevel()) {
        QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewSizeGuaranteeOK: DEFAULT resolution os OK.");
      ...
      if (paramBoolean)
      {
        alwe.a(2, bczp.jdField_c_of_type_Int, bczp.d, localbdbb.jdField_a_of_type_Int, localbdbb.jdField_b_of_type_Int);
        localObject = localbdbb;
      }
    }
    do
    {
      do
      {
        ...
        localbdbb = a((List)localObject, bczp.jdField_a_of_type_ArrayOfInt[1], bczp.b[1]);
        if (localbdbb == null) {
          break;
        }
        if (QLog.isColorLevel()) {
      ...
      alwe.a(3, bczp.jdField_c_of_type_Int, bczp.d, localbdbb.jdField_a_of_type_Int, localbdbb.jdField_b_of_type_Int);
      return localbdbb;
      localbdbb = a((List)localObject, paramInt1, paramInt2, paramInt3, paramInt4);
      localObject = localbdbb;
    } while (!paramBoolean);
    ...
    label413:
    for (paramInt2 = j;; paramInt2 = localbdbb.jdField_b_of_type_Int)
    {
      alwe.a(4, bczp.jdField_c_of_type_Int, bczp.d, paramInt1, paramInt2);
      return localbdbb;
      paramInt1 = localbdbb.jdField_a_of_type_Int;
      break;
    }
  }
    ...
    for (;;)
    {
      try
      {
        if (this.jdField_a_of_type_Int == 1)
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.i(jdField_b_of_type_JavaLangString, 2, "setDisplayOrientation degrees=" + i + " blackPhone=" + bool1 + " camera=" + aluf.jdField_a_of_type_Int + " rom_black=" + bool2);
          }
          return true;
          i = 0;
          break;
  ...
  public bdbb[] c(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if (QLog.isColorLevel()) {
    ...
    bdbb[] arrayOfbdbb = new bdbb[2];
    bdbb localbdbb1 = c(paramInt1, paramInt2, paramInt3, paramInt4, true);
    if (localbdbb1 != null)
    {
      arrayOfbdbb[0] = localbdbb1;
      if (QLog.isColorLevel()) {
