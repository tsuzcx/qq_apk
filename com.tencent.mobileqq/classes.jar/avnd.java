  ...
  extends avmz
{
  ...
  public avnd(QQAppInterface paramQQAppInterface, int paramInt, String paramString, List<avnb> paramList)
  {
    ...
    if (avwf.a(this.jdField_b_of_type_Int))
    {
      ...
      if (this.jdField_a_of_type_JavaUtilList != null)
      {
        ...
        for (m = 1;; m = 0)
        {
          ...
          localSpannableStringBuilder.append(avwf.a((String)this.jdField_b_of_type_JavaUtilList.get(j), (String)this.jdField_c_of_type_JavaUtilList.get(j), 6, false));
          i += 1;
      ...
      {
        this.jdField_c_of_type_JavaLangCharSequence = (this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo.wMemberNum + ajjy.a(2131636765));
        return;
      }
    }
    this.jdField_a_of_type_JavaLangCharSequence = ajjy.a(2131636774);
    ...
    for (;;)
    {
      ...
      if ((!this.jdField_a_of_type_JavaUtilSet.isEmpty()) && (this.jdField_a_of_type_JavaUtilList != null))
      {
        ...
        for (m = 1;; m = 0)
        {
          ...
          ((SpannableStringBuilder)localObject).append(avwf.a((String)this.jdField_b_of_type_JavaUtilList.get(j), (String)this.jdField_c_of_type_JavaUtilList.get(j), 6, false));
          if (j > 0) {
