  ...
  implements Handler.Callback
{
  ...
  public aitt(Activity paramActivity)
  {
  ...
  private void a(int paramInt, float paramFloat)
  {
    ...
    while ((this.jdField_a_of_type_Aium == null) || (!this.jdField_a_of_type_Aium.isShowing())) {
      return;
    }
    int i = (int)(paramInt * paramFloat);
    int j = (int)(paramFloat * 100.0D);
    String str = String.format(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131691208), new Object[] { Integer.valueOf(i), Integer.valueOf(paramInt) });
    if (QLog.isColorLevel()) {
  ...
  private void a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    String str = "";
    if ((paramInt1 > 0) && (paramInt2 == 0)) {
      str = String.format(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131691211), new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt1) });
    }
    for (;;)
    {
      a(null, str, bool, paramString);
      bcef.b(null, "dc00898", "", "", "0X8009DC9", "0X8009DC9", 0, 0, this.jdField_c_of_type_JavaLangString, paramInt1 + paramInt2 + "", paramInt1 + "", paramInt2 + "");
      if (paramInt2 <= 0) {
        break;
      }
      bcef.b(null, "dc00898", "", "", "0X8009DCC", "0X8009DCC", 0, 0, "" + paramInt2, "", "", "");
      return;
      if ((paramInt1 > 0) && (paramInt2 > 0))
      {
        str = String.format(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131691213), new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt1 + paramInt2), Integer.valueOf(paramInt2) });
        bool = false;
      }
      else if ((paramInt1 == 0) && (paramInt2 > 0))
      {
        str = String.format(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131691206), new Object[] { Integer.valueOf(paramInt2), Integer.valueOf(paramInt2) });
        bool = false;
      }
      else
      {
  ...
  private void a(int paramInt, String paramString)
  {
    ...
    if (paramInt == 0)
    {
      localObject = ((Resources)localObject).getString(2131691212);
    ...
    for (str = "0";; str = "1")
    {
      bcef.b(null, "dc00898", "", "", "0X8009DC9", "0X8009DC9", 0, 0, this.jdField_c_of_type_JavaLangString, "1", paramString + "", str + "");
      return;
      if ((paramInt == 2) || (paramInt == 3))
      {
        str = ((Resources)localObject).getString(2131691204);
        localObject = null;
        bool = false;
        break;
      }
      if (paramInt == 1)
      {
        str = ((Resources)localObject).getString(2131691209);
        localObject = null;
        bool = false;
        break;
      }
      str = ((Resources)localObject).getString(2131691207);
      localObject = null;
      bool = false;
      break;
      paramString = "0";
  ...
  private void a(String paramString1, String paramString2, boolean paramBoolean, String paramString3)
  {
    ...
    for (String str = amtj.a(2131712712);; str = amtj.a(2131712712) + this.jdField_a_of_type_JavaLangString)
    {
      QQCustomDialog localQQCustomDialog = bfur.a(this.jdField_a_of_type_AndroidAppActivity, 230);
      localQQCustomDialog.setTitle(paramString1);
      localQQCustomDialog.setMessage(paramString2);
      localQQCustomDialog.setPositiveButton("留在QQ", new aiug(this, paramBoolean, paramString3)).setNegativeButton(str, new aiuf(this, paramBoolean, paramString3)).show();
      return;
    }
  }
  ...
  private void a(List<Uri> paramList)
  {
    ...
    ((arbb)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(103)).b();
    this.jdField_a_of_type_MqqOsMqqHandler.postDelayed(this.jdField_c_of_type_JavaLangRunnable, 2000L);
    new aitu(this, paramList).execute(new Void[0]);
  }
  ...
  private void b(ArrayList<String> paramArrayList)
  {
    ...
    ((arbb)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(103)).a(paramArrayList, new aiud(this, i));
  }
  ...
  private void h()
  {
    ...
    //   9: aload_0
    //   10: getfield 87	aitt:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   13: ldc_w 523
    ...
    //   22: aload_0
    //   23: getfield 370	aitt:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   32: astore_3
    //   33: aload_0
    //   34: getfield 326	aitt:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   37: invokestatic 376	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   40: ifne +276 -> 316
    //   43: aload_0
    //   44: getfield 87	aitt:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   47: invokevirtual 528	android/app/Activity:getPackageManager	()Landroid/content/pm/PackageManager;
    //   50: aload_0
    //   51: getfield 326	aitt:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   54: bipush 64
    ...
    //   112: invokestatic 567	com/tencent/mobileqq/utils/HexUtil:bytes2HexStr	([B)Ljava/lang/String;
    //   115: astore_1
    //   116: ldc 79
    //   118: iconst_1
    //   119: bipush 8
    ...
    //   131: iconst_1
    //   132: aload_0
    //   133: getfield 96	aitt:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   136: aastore
    //   137: dup
    //   138: iconst_2
    //   139: ldc_w 571
    ...
    //   144: iconst_3
    //   145: aload_0
    //   146: getfield 326	aitt:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   149: aastore
    //   150: dup
    //   151: iconst_4
    //   152: ldc_w 573
    ...
    //   168: bipush 7
    //   170: aload_0
    //   171: getfield 577	aitt:e	Ljava/lang/String;
    //   174: aastore
    //   175: invokestatic 421	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   178: aload_0
    //   179: getfield 96	aitt:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   182: invokestatic 376	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   185: ifne +20 -> 205
    //   188: aload_0
    //   189: getfield 326	aitt:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   220: iconst_1
    //   221: aload_0
    //   222: getfield 96	aitt:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   225: aastore
    //   226: dup
    //   227: iconst_2
    //   228: ldc_w 581
    ...
    //   233: iconst_3
    //   234: aload_0
    //   235: getfield 326	aitt:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   238: aastore
    //   239: dup
    //   240: iconst_4
    //   241: ldc_w 583
    ...
    //   247: aload_1
    //   248: aastore
    //   249: invokestatic 585	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   252: aload_0
    //   253: getfield 87	aitt:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   256: sipush 230
    //   259: invokestatic 386	bfur:a	(Landroid/content/Context;I)Lcom/tencent/mobileqq/utils/QQCustomDialog;
    //   262: astore_1
    //   263: aload_1
    //   264: ldc_w 586
    //   267: invokestatic 381	amtj:a	(I)Ljava/lang/String;
    ...
    //   281: dup
    //   282: aload_0
    //   283: invokespecial 590	aiue:<init>	(Laitt;)V
    //   286: invokevirtual 593	com/tencent/mobileqq/utils/QQCustomDialog:setNegativeButton	(ILandroid/content/DialogInterface$OnClickListener;)Lcom/tencent/mobileqq/utils/QQCustomDialog;
    //   289: pop
    //   290: aload_1
    //   291: iconst_0
    //   292: invokevirtual 597	com/tencent/mobileqq/utils/QQCustomDialog:setCancelable	(Z)V
    //   295: aload_1
    ...
    //   304: ldc_w 599
    //   307: aload_1
    //   308: invokestatic 602	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   311: aload_2
    //   312: astore_1
    //   313: goto -197 -> 116
    //   316: ldc 79
    //   318: iconst_1
    //   319: ldc_w 604
    //   322: invokestatic 606	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   325: aload_2
    //   326: astore_1
    //   327: goto -211 -> 116
    //   330: astore_1
    ...
    //   334: ldc_w 608
    //   337: aload_1
    //   338: invokestatic 602	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   341: return
    //   342: invokestatic 612	acjz:a	()V
    //   345: new 614	android/os/Bundle
    //   348: dup
    //   349: invokespecial 615	android/os/Bundle:<init>	()V
    //   352: astore_2
    //   353: aload_2
    //   354: ldc_w 617
    //   357: aload_0
    //   358: getfield 577	aitt:e	Ljava/lang/String;
    //   361: invokevirtual 621	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   364: aload_2
    //   365: ldc_w 623
    //   368: aload_0
    //   369: getfield 326	aitt:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   372: invokevirtual 621	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   375: aload_2
    //   376: ldc_w 625
    //   379: aload_1
    //   380: invokevirtual 621	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   383: aload_0
    //   384: ldc_w 626
    //   387: invokevirtual 628	aitt:a	(I)V
    //   390: aload_0
    //   391: getfield 54	aitt:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   394: aload_0
    //   395: getfield 61	aitt:jdField_a_of_type_JavaLangRunnable	Ljava/lang/Runnable;
    //   398: ldc2_w 629
    //   401: invokevirtual 251	mqq/os/MqqHandler:postDelayed	(Ljava/lang/Runnable;J)Z
    //   404: pop
    //   405: aload_0
    //   406: getfield 87	aitt:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   409: iconst_1
    //   410: aload_0
    //   411: getfield 96	aitt:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   414: aload_2
    //   415: invokestatic 633	acjz:a	(Landroid/app/Activity;ILjava/lang/String;Landroid/os/Bundle;)Lacju;
    //   418: ldc_w 635
    //   421: aconst_null
    //   422: new 637	aiuh
    //   425: dup
    //   426: aload_0
    //   427: aload_3
    //   428: invokespecial 640	aiuh:<init>	(Laitt;Ljava/lang/String;)V
    //   431: invokevirtual 645	acju:a	(Ljava/lang/String;Lorg/json/JSONObject;Lacjr;)V
    //   434: return
  ...
  private void i()
  {
    ...
    if (!bool)
    {
      PermissionUtils.requestStorePermission((AppActivity)this.jdField_a_of_type_AndroidAppActivity, 3, new aiui(this));
      return;
    }
  ...
  private void j()
  {
    ...
    if (localOpenID == null)
    {
      ...
      try
      {
        ...
        localQQAppInterface.getMsgHandler().a(l, this.jdField_d_of_type_JavaLangString, Long.valueOf(this.jdField_c_of_type_JavaLangString).longValue(), new aiuk(this));
        return;
      }
  ...
  private void k()
  {
    ((arbb)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(103)).e();
  }
  ...
  public ArrayList<String> a(List<Uri> paramList)
  {
    ...
    aucz localaucz = new aucz(this.jdField_a_of_type_AndroidAppActivity, false, null);
    int i = 0;
    while (i < localArrayList.size())
    {
      String str = localaucz.a((Uri)localArrayList.get(i), false);
  ...
  protected void a(String paramString1, String paramString2)
  {
    ...
    paramString1 = new aiul(this);
    this.jdField_b_of_type_ComTencentMobileqqUtilsQQCustomDialog.setNegativeButton(paramString2, paramString1);
    this.jdField_b_of_type_ComTencentMobileqqUtilsQQCustomDialog.setOnKeyListener(new aitv(this));
  ...
  public void a(ArrayList<String> paramArrayList)
  {
    ...
    int i = paramArrayList.size();
    this.jdField_a_of_type_Aium = new aium(this.jdField_a_of_type_AndroidAppActivity);
    this.jdField_a_of_type_Aium.a("收藏为QQ表情");
    this.jdField_a_of_type_Aium.a(2131690620, new aitx(this));
    this.jdField_a_of_type_Aium.c(2131691201, new aity(this, paramArrayList, i));
    this.jdField_a_of_type_Aium.b(2131691202, new aitz(this, i));
    this.jdField_a_of_type_Aium.a(paramArrayList, new aiua(this, i, paramArrayList));
    if (i > 1)
    {
      paramArrayList = String.format(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131691205), new Object[] { Integer.valueOf(i) });
      this.jdField_a_of_type_Aium.b(paramArrayList);
    }
    this.jdField_a_of_type_Aium.setOnDismissListener(new aiub(this));
    this.jdField_a_of_type_Aium.setOnKeyListener(new aiuc(this, i));
    this.jdField_a_of_type_Aium.setCanceledOnTouchOutside(false);
    this.jdField_a_of_type_Aium.show();
  ...
  {
    if ((this.jdField_a_of_type_Aium != null) && (this.jdField_a_of_type_Aium.isShowing()))
    {
      if (QLog.isColorLevel()) {
  ...
  protected void d()
  {
    ...
    this.jdField_b_of_type_ComTencentMobileqqUtilsQQCustomDialog = bfur.a(this.jdField_a_of_type_AndroidAppActivity, 230);
    this.jdField_b_of_type_ComTencentMobileqqUtilsQQCustomDialog.setMessage(amtj.a(2131712713));
    this.jdField_b_of_type_ComTencentMobileqqUtilsQQCustomDialog.setTitle(2131691966);
    aitw localaitw = new aitw(this);
    this.jdField_b_of_type_ComTencentMobileqqUtilsQQCustomDialog.setNegativeButton(2131690620, localaitw);
    this.jdField_b_of_type_ComTencentMobileqqUtilsQQCustomDialog.setPositiveButton(2131718248, localaitw);
    this.jdField_b_of_type_ComTencentMobileqqUtilsQQCustomDialog.show();
  }
  ...
  {
    this.jdField_a_of_type_MqqOsMqqHandler.removeMessages(11);
    if (this.jdField_a_of_type_Aium != null) {
