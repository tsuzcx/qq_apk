  ...
  extends MSFServlet
{
  ...
  {
    int j = 0;
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApplication(), azil.class);
  ...
  private void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      notifyObserver(paramIntent, 2, bool1, localBundle, azik.class);
      return;
  ...
  {
    int i = 0;
    azih localazih = (azih)paramQQAppInterface.getManager(370);
    ...
    for (;;)
    {
      localazih.a(new OnlineStatusFriendsPermissionItem(bool, paramQQAppInterface));
      if (paramIntent != null) {
        localazih.a(paramIntent);
      }
      return;
      label134:
  ...
  private void a(oidb_cmd0xe63.RspBody paramRspBody)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        paramRspBody = (azih)((QQAppInterface)getAppRuntime()).getManager(370);
  ...
  private void b(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    //   211: aload_0
    //   212: aload 7
    //   214: invokespecial 423	azil:a	(Ltencent/im/oidb/cmd0xe63/oidb_cmd0xe63$RspBody;)V
    //   217: iconst_1
    //   218: istore 6
    //   220: aload_0
    //   221: aload_1
    ...
    //   225: aload 9
    //   227: ldc 224
    //   229: invokevirtual 228	azil:notifyObserver	(Landroid/content/Intent;IZLandroid/os/Bundle;Ljava/lang/Class;)V
    //   232: return
    //   233: astore 7
    //   235: aconst_null
    //   236: astore_2
