  ...
  implements Manager
{
  ...
  public azil(QQAppInterface paramQQAppInterface)
  {
  ...
  public int a(String paramString)
  {
    ...
    while (!bhff.a(paramString, localSQLiteDatabase)) {
      return 0;
    }
  ...
  public long a(String paramString)
  {
    ...
    do
    {
      return l3;
      l2 = l1;
      if (bhff.a(paramString, localSQLiteDatabase)) {
        l3 = l1;
      }
      try
      {
  ...
  public Cursor a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      paramString2 = bhff.b(null, paramString1, localSQLiteDatabase, (String)localObject1);
    ...
    for (;;)
    {
      ...
      if (paramString1.indexOf("mr_discusssion_") != -1)
      {
        ...
        paramString2 = bhff.b(null, paramString1, localSQLiteDatabase, (String)localObject2);
      ...
      Object localObject2 = bhff.a(null, paramString1, localSQLiteDatabase, paramString2, null);
  ...
  public azhs a()
  {
    ...
    {
      if ((this.jdField_a_of_type_Azhs == null) || (!this.jdField_a_of_type_Azhs.isOpen())) {
        this.jdField_a_of_type_Azhs = ((azhs)a().createMessageRecordEntityManager());
      }
  ...
  public azik a()
  {
    ...
    if (this.jdField_a_of_type_Azik != null) {
      return this.jdField_a_of_type_Azik;
    }
    try
    {
      if (this.jdField_a_of_type_Azik == null)
      {
        this.jdField_a_of_type_Azik = new azik(str);
  ...
  public List<MessageRecord> a(String paramString1, String paramString2)
  {
    ...
    {
      return null;
      paramString1 = bhff.a(null, paramString1, localSQLiteDatabase, paramString2, null);
  ...
  public void onDestroy()
  {
    ...
    if (this.jdField_a_of_type_Azik != null) {
      this.jdField_a_of_type_Azik.close();
    }
  }
}
