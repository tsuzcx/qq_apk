...
public class bfwa
{
  ...
  public void a(Canvas paramCanvas, bfwb parambfwb)
  {
    if ((paramCanvas == null) || (parambfwb == null)) {
      return;
    }
    if ((this.jdField_a_of_type_Boolean) && (a()))
    {
      this.jdField_a_of_type_AndroidGraphicsRectF.set(0.0F, 0.0F, parambfwb.getWidth(), parambfwb.getHeight());
      int i = this.e;
      if (b()) {
        i = c;
      }
