...
public final class oyh
{
  ...
  private static final Map<String, qfg> b = (Map)new LinkedHashMap();
  
  static
  {
    jdField_a_of_type_Oyh = new oyh();
  ...
  private final VafContext a(String paramString)
  {
    ...
    Object localObject = new qfg();
    b.put(paramString, localObject);
    ((qfg)localObject).setContext((Context)localBaseApplication);
    oyj.a((VafContext)localObject, paramString);
  ...
  private final void a(String paramString, TemplateBean paramTemplateBean, int paramInt, VafContext paramVafContext)
  {
    ...
    if (j < paramInt)
    {
      try
      {
        ...
        if ((((Resources)localObject).getConfiguration().orientation == 2) || (zps.b(paramVafContext.getContext()) > zps.c(paramVafContext.getContext())))
        {
  ...
  public final void a(@NotNull String paramString1, @NotNull String paramString2, int paramInt)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject = suz.a(paramString1, true);
      } while (localObject == null);
      localTemplateBean = ((suz)localObject).getTemplate(paramString2);
    } while (localTemplateBean == null);
    Object localObject = (qfg)b.get(paramString1);
    if (localObject != null) {}
