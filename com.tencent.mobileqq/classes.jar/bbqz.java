...
public class bbqz
{
  ...
  {
    return a(paramString, paramArrayOfInt, paramDrawable, null, new bbra(paramArrayOfInt));
  }
  ...
  {
    return bbvj.a(new StringBuilder().append(ajsd.aW).append(".vipicon/").toString()) + paramString.hashCode() + ".png";
  }
