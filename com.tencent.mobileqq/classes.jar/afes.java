...
public class afes
  extends ajjh
{
  private afes(AlphabetFriendFragment paramAlphabetFriendFragment) {}
    ...
    if ((paramBoolean) && (this.a.isResumed())) {
      try
      {
        ...
        if ((paramArrayOfObject != null) && (paramArrayOfObject.length > 0))
        {
          ...
          {
            bbmy.a(this.a.getActivity(), 2, ajjy.a(2131634432), 0).a();
            return;
          }
          bbmy.a(this.a.getActivity(), 2, ajjy.a(2131634433), 0).a();
          return;
        }
      }
