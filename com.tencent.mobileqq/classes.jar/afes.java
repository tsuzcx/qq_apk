  ...
  extends affb
{
  ...
  private agmy jdField_a_of_type_Agmy;
  protected Rect a;
  public View a;
  public bgfp a;
  public String a;
  ...
  public afes(int paramInt, AIOAnimationConatiner paramAIOAnimationConatiner, ListView paramListView)
  {
  ...
  protected boolean a(Object... paramVarArgs)
  {
    ...
    this.jdField_a_of_type_Bgfp = ((bgfp)paramVarArgs[6]);
  ...
  public boolean b()
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_Agmy = null;
      ...
      if ((localObject != null) && ((localObject instanceof agmy))) {
        this.jdField_a_of_type_Agmy = ((agmy)localObject);
      }
      while (this.jdField_a_of_type_Agmy == null)
      {
        a(true);
        return false;
        if (QLog.isColorLevel()) {
      ...
      if (this.jdField_a_of_type_Agmy.a != null)
      {
        localObject = this.jdField_a_of_type_Agmy.a.a();
    ...
    {
      label284:
      m += (int)(this.jdField_a_of_type_Bgfp.a * k);
      j += (int)(this.jdField_a_of_type_Bgfp.b * i);
      localObject = this.jdField_a_of_type_AndroidGraphicsRect;
      float f = this.jdField_a_of_type_Bgfp.c;
      k = (int)(k * f);
      f = this.jdField_a_of_type_Bgfp.d;
      ...
      if (this.jdField_a_of_type_AndroidViewView == null)
      {
        this.jdField_a_of_type_Afet = null;
        ...
        localObject = AIOUtils.getHolder(AIOUtils.getViewByPostion(this.jdField_a_of_type_ComTencentWidgetListView, this.c));
        if ((localObject != null) && ((localObject instanceof afet)))
        {
          this.jdField_a_of_type_Afet = ((afet)localObject);
          label484:
          ...
          j = this.jdField_a_of_type_Afet.a.getRight() - this.jdField_a_of_type_Afet.a.getLeft();
          i = this.jdField_a_of_type_Afet.a.getBottom() - this.jdField_a_of_type_Afet.a.getTop();
        }
      }
      for (;;)
      {
