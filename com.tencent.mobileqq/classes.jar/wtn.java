  ...
  extends wfm
{
  ...
  public wtn()
  {
    this.jdField_c_of_type_JavaLangString = weg.a("StoryGroupSvc.datacard_get_feeds_new");
  ...
  public wfh a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return new wvd(this.a, localRspGroupDateVideoList);
    }
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      ykq.b("Q.qqstory.shareGroup:GetShareGroupDateListRequest", a(), paramArrayOfByte);
    }
    return null;
  }
