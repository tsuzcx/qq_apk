...
{
  uti(uta paramuta, String paramString1, int paramInt, boolean paramBoolean, String paramString2) {}
      ...
      if (localObject != null)
      {
        ...
        for (;;)
        {
            ...
            if (j == 2)
            {
              ...
              if (paramBundle.equals(""))
              {
                ...
                try
                {
                  ...
                  this.jdField_a_of_type_Uta.c((String)localObject);
          ...
          catch (InvalidProtocolBufferMicroException paramBundle)
          {
            ...
            return;
            this.jdField_a_of_type_Uta.a(this.jdField_a_of_type_Int, paramBundle, (String)localObject, true, this.jdField_a_of_type_JavaLangString);
          }
          ...
          if (paramBundle.equals(""))
          {
            ...
            try
            {
              ...
              this.jdField_a_of_type_Uta.callJs(this.jdField_a_of_type_JavaLangString, new String[] { ((JSONObject)localObject).toString() });
          ...
          {
            localObject = ((JSONObject)localObject).optString("mediaid");
            this.jdField_a_of_type_Uta.a(this.jdField_a_of_type_Int, paramBundle, (String)localObject, false, this.jdField_a_of_type_JavaLangString);
            continue;
            label494:
            if (QLog.isColorLevel()) {
