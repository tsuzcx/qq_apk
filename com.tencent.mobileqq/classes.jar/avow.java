...
public class avow
{
  public static final String g = amtj.a(2131713047);
  ...
  public avow(Context paramContext, QQAppInterface paramQQAppInterface)
  {
  ...
  private void a()
  {
    AbsShareMsg localAbsShareMsg = new bcgt(StructMsgForGeneralShare.class).c(114).a(this.b).e(this.jdField_a_of_type_JavaLangString).a();
    localAbsShareMsg.mSourceName = this.e;
    localAbsShareMsg.mSourceAction = "web";
    localAbsShareMsg.mSourceUrl = this.f;
    Object localObject = bchg.a(2);
    ((bcgx)localObject).a(this.d, this.b, this.c);
    localAbsShareMsg.addItem((bcgw)localObject);
  ...
  private void b()
  {
    ...
    QZoneShareManager.jumpToQzoneShare(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, localBundle, null);
  }
  
  private void c()
  {
    long l = System.currentTimeMillis();
    WXShareHelper.getInstance().shareWebPageToWXFriend(String.valueOf(l), this.b, this.jdField_a_of_type_AndroidGraphicsBitmap, this.c, this.jdField_a_of_type_JavaLangString);
  }
  
  private void d()
  {
    long l = System.currentTimeMillis();
    WXShareHelper.getInstance().shareWebPageToWXFriendCircle(String.valueOf(l), this.b, this.jdField_a_of_type_AndroidGraphicsBitmap, this.c, this.jdField_a_of_type_JavaLangString);
  }
  
  public void a(DialogInterface.OnDismissListener paramOnDismissListener)
  {
    if (!a()) {
      QQToast.a(this.jdField_a_of_type_AndroidContentContext, amtj.a(2131713048), 0).a();
    }
    do
    {
      for (;;)
      {
        ...
        {
          avox localavox = new avox(this);
          paramOnDismissListener = new avoy(this, paramOnDismissListener);
          ...
          this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder.setItemClickListener(localavox);
