  ...
  implements avpj
{
  ...
  public avph(Intent paramIntent, String paramString, avqk paramavqk)
  {
  ...
  private faceproto.Request a(String paramString1, String paramString2)
  {
    ...
    if ((this.f == null) || (avpm.e.contains(this.f)))
    {
  ...
  private String a(faceproto.Request paramRequest, String paramString)
  {
    ...
    //   3: dup
    //   4: getstatic 52	avph:j	Ljava/lang/String;
    ...
    //   36: dup
    //   37: getstatic 52	avph:j	Ljava/lang/String;
    ...
    //   97: aload_1
    //   98: arraylength
    //   99: invokestatic 293	bhbx:a	(I)[B
    ...
    //   117: arraylength
    //   118: invokestatic 293	bhbx:a	(I)[B
    ...
    //   166: aload 4
    //   168: invokestatic 307	bhbx:a	(Ljava/io/Closeable;)V
    //   171: aload 5
    ...
    //   209: aload 4
    //   211: invokestatic 307	bhbx:a	(Ljava/io/Closeable;)V
    //   214: aconst_null
    //   215: areturn
    //   216: astore_1
    //   217: aconst_null
    ...
    //   235: aload 4
    //   237: invokestatic 307	bhbx:a	(Ljava/io/Closeable;)V
    //   240: aconst_null
    //   241: areturn
    //   242: astore_1
    //   243: aconst_null
    //   244: astore_3
    //   245: aload_3
    //   246: invokestatic 307	bhbx:a	(Ljava/io/Closeable;)V
    //   249: aload_1
    //   250: athrow
    //   251: astore_1
    //   252: goto -7 -> 245
  ...
  public void b()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      this.jdField_a_of_type_Avqk.a(2, a(211, anvx.a(2131705524), false));
      return;
    }
    ...
    QIPCClientHelper.getInstance().callServer("IdentificationIpcServer_Model", "action_upload", localBundle, new avpi(this, l));
    return;
    label237:
