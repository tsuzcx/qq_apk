  ...
  implements View.OnClickListener
{
  ...
  public avph(Context paramContext)
  {
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqNearbyNowViewWidgetRoundRelativeLayout = ((RoundRelativeLayout)findViewById(2131364794));
    ...
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131370702));
  ...
  {
    new azmo(null).a("dc00899").b("grp_lbs").c("home").d(paramString).e(this.jdField_a_of_type_Aupq.g).a(new String[] { this.jdField_a_of_type_Aupq.f }).a();
  }
  
  public boolean a(aupq paramaupq)
  {
    this.jdField_a_of_type_Aupq = paramaupq;
    if (QLog.isColorLevel()) {
      QLog.d("NearbyAppDownloadDialog", 2, "initContent=" + paramaupq.toString());
    }
    a(this.jdField_a_of_type_AndroidWidgetImageView, paramaupq.a);
    if (!TextUtils.isEmpty(paramaupq.c))
    {
      this.jdField_a_of_type_AndroidWidgetButton.setText(paramaupq.c);
      this.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
      if (TextUtils.isEmpty(paramaupq.b)) {
        break label141;
      }
      this.jdField_a_of_type_AndroidWidgetTextView.setText(paramaupq.b);
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    }
    for (;;)
    {
      if (TextUtils.isEmpty(paramaupq.e)) {
        break label153;
      }
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("NearbyAppDownloadDialog", 2, "btn onClick, jumpUrl=" + this.jdField_a_of_type_Aupq.d);
        }
        avpq.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Aupq.d);
        dismiss();
        a("pop_new_clk");
        return;
      }
    ...
    if (QLog.isColorLevel()) {
      QLog.d("NearbyAppDownloadDialog", 2, "more onClick, jumpUrl=" + this.jdField_a_of_type_Aupq.e);
    }
    avpq.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Aupq.e);
  }
