...
public class acdq
  extends aiab
{
  public acdq(UncommonlyUsedContactsActivity paramUncommonlyUsedContactsActivity, Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, int paramInt, boolean paramBoolean)
  {
  ...
  {
    Object localObject1 = (acds)getItem(paramInt);
    View localView;
    if ((paramView != null) && (paramView.getTag() != null))
    {
      paramViewGroup = (acdr)paramView.getTag();
      localView = paramView;
    }
    Object localObject2;
    for (;;)
    {
      paramView = (TextView)localView.findViewById(2131310129);
      localObject2 = localView.findViewById(2131309349);
      if (((acds)localObject1).jdField_a_of_type_Int != 0) {
        break;
      }
      ((View)localObject2).setVisibility(8);
      paramView.setVisibility(0);
      paramView.setText(((acds)localObject1).jdField_a_of_type_JavaLangString);
      if (AppSetting.c)
      {
        paramView.setFocusable(true);
        paramView.setContentDescription(((acds)localObject1).jdField_a_of_type_JavaLangString);
      }
      paramViewGroup.jdField_b_of_type_Int = 0;
      paramViewGroup.jdField_a_of_type_JavaLangString = "";
      paramViewGroup.jdField_a_of_type_Int = paramInt;
      return localView;
      localView = this.a.getLayoutInflater().inflate(2131495132, null);
      paramViewGroup = new acdr(this.a, null);
      paramViewGroup.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131302061));
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(16908308));
      paramViewGroup.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131301546));
      paramViewGroup.jdField_c_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131301372));
      paramViewGroup.d = ((TextView)localView.findViewById(2131309984));
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131298635));
    ...
    label402:
    int i;
    if ((((acds)localObject1).jdField_a_of_type_Atmo instanceof Friends))
    {
      localObject1 = (Friends)((acds)localObject1).jdField_a_of_type_Atmo;
      ...
      if (!TextUtils.isEmpty(((Friends)localObject1).remark))
      {
        ...
        if (TextUtils.equals(ajjy.a(2131650079), ((Friends)localObject1).recommReason)) {
          ((Friends)localObject1).recommReason = ajjy.a(2131650083);
        }
        ...
        {
        default: 
          paramViewGroup.jdField_c_of_type_AndroidWidgetTextView.setBackgroundResource(2130844934);
          i = 0;
          label440:
    ...
    for (;;)
    {
      ...
      break label440;
      i = 2130840108;
      paramViewGroup.jdField_c_of_type_AndroidWidgetTextView.setBackgroundResource(2130844932);
      break label440;
      ...
      {
        paramView = ajjy.a(2131650080) + ((Friends)localObject1).age;
        break label500;
      }
      paramView = ajjy.a(2131650085) + ((Friends)localObject1).age;
      break label500;
      if ((((acds)localObject1).jdField_a_of_type_Atmo instanceof PhoneContact))
      {
        paramView = (PhoneContact)((acds)localObject1).jdField_a_of_type_Atmo;
        ...
        paramViewGroup.jdField_b_of_type_AndroidWidgetTextView.setText(null);
        paramViewGroup.d.setText(ajjy.a(2131650084));
        if (AppSetting.c)
        {
          paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(paramView.name);
          paramViewGroup.d.setContentDescription(ajjy.a(2131650082));
        }
        paramViewGroup.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
