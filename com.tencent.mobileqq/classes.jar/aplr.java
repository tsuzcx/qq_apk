  ...
  implements aplq
{
  ...
  public static aplq a(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("com.tencent.mobileqq.ar.aidl.IArFaceCallback");
    if ((localIInterface != null) && ((localIInterface instanceof aplq))) {
      return (aplq)localIInterface;
    }
    return new apls(paramIBinder);
  }
