    ...
    do
    {
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          try
          {
            localObject3 = ((ure)localObject2).a((String)localObject3);
            paramArrayOfByte = paramBundle;
            ...
            if (paramInt < ((List)localObject4).size())
            {
              ...
              paramArrayOfByte = ((uro)localObject1).a(localStoryVideoItem.mVid, localStoryVideoItem);
              ((VideoCollectionItem)localObject3).videoVidList.add(paramArrayOfByte.mVid);
              paramArrayOfByte = new wiu(paramArrayOfByte.mVid, paramArrayOfByte);
              ((VideoCollectionItem)localObject3).collectionVideoUIItemList.add(paramArrayOfByte);
              paramInt += 1;
            }
            else
            {
              ((ure)localObject2).a((VideoCollectionItem)localObject3);
