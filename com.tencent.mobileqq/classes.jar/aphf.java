  ...
  implements IExcitingTransferRecvListener
{
  ...
  public aphf(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, int paramInt, aphg paramaphg)
  {
  ...
  public void OnOneSlotComplete(int paramInt, ExcitingTransferOneSlotComplete paramExcitingTransferOneSlotComplete)
  {
    ...
    for (String str = paramExcitingTransferOneSlotComplete.toString();; str = "")
    {
      ...
      this.jdField_a_of_type_Aphi.a(paramInt, paramExcitingTransferOneSlotComplete);
      return;
    }
  }
  ...
  protected ExcitingTransferDownloadReqInfo a()
  {
    ...
    {
      localExcitingTransferDownloadReqInfo.fileSize = this.jdField_a_of_type_Aphg.a();
      localExcitingTransferDownloadReqInfo.md5 = this.jdField_a_of_type_Aphg.a();
      localExcitingTransferDownloadReqInfo.isSupportHttps = this.jdField_a_of_type_Aphg.b();
      localExcitingTransferDownloadReqInfo.sslCName = this.jdField_a_of_type_Aphg.d();
      localExcitingTransferDownloadReqInfo.strFileName = this.jdField_a_of_type_Aphg.a();
      if (this.jdField_a_of_type_Aphg.a() != null) {
        localExcitingTransferDownloadReqInfo.mHosts = ((ExcitingTransferHostInfo[])this.jdField_a_of_type_Aphg.a().toArray(new ExcitingTransferHostInfo[this.jdField_a_of_type_Aphg.a().size()]));
      }
      localExcitingTransferDownloadReqInfo.strFileName = this.jdField_a_of_type_Aphg.a();
      localExcitingTransferDownloadReqInfo.serverPath = this.jdField_a_of_type_Aphg.b();
    }
    for (;;)
    {
  ...
  public void a(int paramInt, ExcitingTransferDownloadCompletedInfo paramExcitingTransferDownloadCompletedInfo)
  {
    ...
    if (this.jdField_a_of_type_Aphi != null) {
      this.jdField_a_of_type_Aphi.a(paramInt, paramExcitingTransferDownloadCompletedInfo);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Aphi != null) {
      this.jdField_a_of_type_Aphi.a(paramLong1, paramLong2, paramLong3);
    }
  }
  
  public void a(aphi paramaphi)
  {
    this.jdField_a_of_type_Aphi = paramaphi;
  }
  ...
  public void a(ExcitingTransferDownloadCompletedInfo paramExcitingTransferDownloadCompletedInfo)
  {
    ...
    if (this.jdField_a_of_type_Aphi != null) {
      this.jdField_a_of_type_Aphi.a(0, paramExcitingTransferDownloadCompletedInfo);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Aphg != null) {
      return "Cookie:t=0;v=" + AppSetting.a() + ";" + this.jdField_a_of_type_Aphg.c() + ";\r\n";
    }
    return "";
  }
  ...
  public void onRecvComplete(int paramInt, ExcitingTransferDownloadCompletedInfo paramExcitingTransferDownloadCompletedInfo)
  {
    ...
    {
      QLog.i("ExcitingTransfer.BaseDownloader<FileAssistant>", 1, str);
      if ((bool) && (this.jdField_a_of_type_Aphg != null)) {
        this.jdField_b_of_type_Long = this.jdField_a_of_type_Aphg.a();
      }
  ...
  public void onRecvStart()
  {
    ...
    } while (this.jdField_a_of_type_Aphi == null);
