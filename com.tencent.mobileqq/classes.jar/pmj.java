  ...
  extends NativeText
{
  ...
  public pmj(VafContext paramVafContext)
  {
  ...
  {
    ReadInJoyUserInfo localReadInJoyUserInfo = ReadInJoyUserInfoModule.a(paramLong, new pml(this, String.valueOf(paramLong)));
    if (localReadInJoyUserInfo != null)
    {
      setText(onk.d(localReadInJoyUserInfo.nick));
      return;
    }
  ...
  {
    ReadInJoyUserInfo localReadInJoyUserInfo = ReadInJoyUserInfoModule.a(paramLong, new pmk(this, String.valueOf(paramLong), paramString));
    if (localReadInJoyUserInfo != null)
    {
      setText(a(paramString, onk.d(localReadInJoyUserInfo.nick)));
      return;
    }
