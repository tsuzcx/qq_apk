...
{
  public abzy(TroopMemberListActivity paramTroopMemberListActivity, List paramList, CheckBox paramCheckBox, boolean paramBoolean, Dialog paramDialog) {}
  
  public void onClick(View paramView)
  {
    paramView = (ajtg)this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.app.a(20);
    String str;
    if (paramView != null)
    {
    ...
    {
      awqx.b(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.app, "P_CliOper", "Grp_manage", "", "del_mber", "Clk_del", 1, 0, this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.b, str, paramView, "");
