  ...
  implements View.OnClickListener
{
  ...
  public affw(Context paramContext, List<ReadInJoySearchHistoryEntity> paramList, affx paramaffx)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramContext);
    b(paramList);
    this.jdField_a_of_type_Affx = paramaffx;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    do
    {
      ...
      if (paramView == null)
      {
        ...
        paramViewGroup.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131364241));
      ...
      for (;;)
      {
        ...
        return paramView;
        paramViewGroup = (affy)paramView.getTag();
      }
      localView = paramView;
  ...
  {
    if ((paramView.getTag() instanceof affy))
    {
      paramView = (affy)paramView.getTag();
      ...
      if (this.jdField_a_of_type_Affx != null)
      {
        ...
        this.jdField_a_of_type_Affx.a(paramView);
      }
    }
    label69:
    while ((paramView.jdField_a_of_type_Int != this.jdField_a_of_type_JavaUtilList.size()) || (this.jdField_a_of_type_Affx == null)) {
      return;
    }
    this.jdField_a_of_type_Affx.a();
  }
}
