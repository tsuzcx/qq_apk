...
public class nwu
{
  ...
  public static int a(String paramString)
  {
    ...
    //   2: aload_0
    //   3: ldc 68
    //   5: invokevirtual 74	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   8: astore_0
    //   9: iconst_0
    //   10: istore_1
    //   11: iload_1
    ...
    //   30: iload_2
    //   31: aaload
    //   32: invokestatic 80	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   35: lstore 8
    //   37: lload 4
    //   39: ldc2_w 81
    //   42: lload 6
    ...
    //   60: istore_1
    //   61: aload_0
    //   62: invokevirtual 85	java/lang/Exception:printStackTrace	()V
    //   65: iload_1
    //   66: istore_3
    //   67: iload_3
    //   68: ireturn
  ...
  public static Intent a(Context paramContext, Intent paramIntent, String paramString, boolean paramBoolean1, int paramInt1, boolean paramBoolean2, int paramInt2)
  {
    try
    {
      bool = ((bjxa)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(QQManagerFactory.QIDIAN_MANAGER)).c(paramString, false);
      if (bool) {
        if (paramIntent == null)
        {
  ...
  public static String a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    for (;;)
    {
      ...
      Object localObject = paramQQAppInterface.getManager(QQManagerFactory.PUBLICACCOUNTDATA_MANAGER);
      if (localObject != null)
      {
        localObject = ((aoan)localObject).c(paramString);
        if (localObject != null) {
        ...
        if (paramQQAppInterface != null)
        {
          paramQQAppInterface = ((anty)paramQQAppInterface).a(paramString);
          if (paramQQAppInterface != null) {
  ...
  private static void a(int paramInt, bisl parambisl)
  {
    b(paramInt, parambisl);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo)
  {
    ...
    do
    {
      ...
      if (llq.c())
      {
        ...
        localbkzi.a(new nwx(localbkzi, paramQQAppInterface, paramContext, paramSessionInfo));
        localbkzi.show();
        return;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, String paramString)
  {
    ...
    if (bjxa.b(paramQQAppInterface, paramSessionInfo.curFriendUin)) {
    ...
    for (;;)
    {
      ...
      if (localObject != null)
      {
        localObject = ((aoan)localObject).c(paramSessionInfo.curFriendUin);
        if (localObject == null)
        {
          localObject = (anty)paramQQAppInterface.getManager(QQManagerFactory.EQQ_DETAIL_DATA_MANAGER);
          if (localObject != null)
          {
            localObject = ((anty)localObject).a(paramSessionInfo.curFriendUin);
            if (localObject == null)
            {
              if (QLog.isDevelopLevel()) {
              ...
              if ((paramContext instanceof Activity)) {
                localbisl = new bisl(paramContext, paramContext.getResources().getDimensionPixelSize(2131299080));
              }
              if (localbisl != null) {
              ...
              localObject = new NewIntent(paramContext.getApplicationContext(), nta.class);
      ...
      try
      {
        localGetEqqDetailInfoRequest.eqq_id.set((int)Long.parseLong(paramSessionInfo.curFriendUin));
        label282:
        ((NewIntent)localObject).putExtra("data", localGetEqqDetailInfoRequest.toByteArray());
        ((NewIntent)localObject).setObserver(new nwv(paramContext, paramQQAppInterface, localbisl, paramSessionInfo, paramString));
        ...
        return;
        a(paramContext, 2131694983);
        bdla.b(paramQQAppInterface, "CliOper", "", "", "0X80049DF", "GetDetailFalse", 0, 0, "", "", "", "");
        return;
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, int paramInt, BusinessObserver paramBusinessObserver)
  {
    ...
    {
      paramContext = new NewIntent(paramContext.getApplicationContext(), nta.class);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2)
  {
    ...
    localSessionInfo.curType = 1024;
    localSessionInfo.curFriendNick = paramString2;
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    ...
    SessionInfo localSessionInfo = new SessionInfo();
    localSessionInfo.curType = 1024;
    localSessionInfo.curFriendNick = paramString1;
    localSessionInfo.curFriendUin = paramString2;
  ...
  {
    if ((paramQQAppInterface != null) && (nut.a(paramString)) && (nut.b(paramString)))
    {
  ...
  public static String b(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      str = bjxa.a(paramQQAppInterface, paramString);
    }
    label25:
    do
    {
      do
      {
        ...
        do
        {
          ...
          {
            return str;
            localObject = paramQQAppInterface.getManager(QQManagerFactory.PUBLICACCOUNTDATA_MANAGER);
            str = paramString;
  ...
  private static void b(int paramInt, bisl parambisl)
  {
    if (parambisl != null)
    {
      parambisl.c(paramInt);
      parambisl.show();
    }
  }
  
  private static void b(bisl parambisl)
  {
  ...
  private static void b(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, PublicAccountInfo paramPublicAccountInfo, EqqDetail paramEqqDetail, String paramString)
  {
    ...
    for (;;)
    {
      if (bool)
      {
        ...
        if ((paramContext instanceof Activity)) {
          paramPublicAccountInfo = new bisl(paramContext, paramContext.getResources().getDimensionPixelSize(2131299080));
        }
        if (paramPublicAccountInfo != null) {
          paramPublicAccountInfo.setCanceledOnTouchOutside(true);
        }
        NewIntent localNewIntent = new NewIntent(paramContext.getApplicationContext(), oln.class);
        ...
        localNewIntent.setObserver(new nww(paramContext, paramQQAppInterface, paramPublicAccountInfo, paramEqqDetail, paramSessionInfo, paramString));
        paramQQAppInterface.startServlet(localNewIntent);
      }
      try
      {
        if (((paramContext instanceof Activity)) && (!((Activity)paramContext).isFinishing())) {
          a(2131695032, paramPublicAccountInfo);
        }
        label257:
        if (QLog.isColorLevel()) {
  ...
  public static void b(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2)
  {
    ...
    {
      new bisy(paramContext).a(2131693229, paramContext.getResources().getDimensionPixelSize(2131299080), 0, 1);
      return;
    }
  ...
  public static void b(QQAppInterface paramQQAppInterface, EqqDetail paramEqqDetail)
  {
    ...
    anty localanty = (anty)paramQQAppInterface.getManager(QQManagerFactory.EQQ_DETAIL_DATA_MANAGER);
    if (localanty != null) {
      localanty.a(paramEqqDetail);
    }
  ...
  public static boolean b(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    for (boolean bool1 = false;; bool1 = false)
    {
      ...
      return bool1;
      localObject = paramQQAppInterface.getManager(QQManagerFactory.EQQ_DETAIL_DATA_MANAGER);
      if ((localObject != null) && (((anty)localObject).a(paramString) != null))
      {
        if (QLog.isColorLevel()) {
  ...
  private static void c(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, String paramString)
  {
    ...
    if ((paramQQAppInterface.isVideoChatting()) && (str != null) && (str.equals(paramQQAppInterface.getAVNotifyCenter().c()))) {}
    for (int i = 1;; i = 0)
    {
      if (i == 0) {
        bdla.b(paramQQAppInterface, "CliOper", "", "", "0X8004628", "0X8004628", 0, 0, "", "", "", "");
      }
      if (paramSessionInfo.curType != 1008) {
        paramSessionInfo.curType = 1024;
      }
      aftr.a(paramQQAppInterface, paramContext, paramSessionInfo, true, paramString, null);
      return;
    }
  }
  ...
  {
    if (!((anvk)paramQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER)).b(paramString2)) {}
    for (;;)
    {
      return;
      try
      {
        ...
        {
          ((bjyi)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.QIDIAN_HANDLER)).a(Long.valueOf(paramString1).longValue(), Long.valueOf(paramString2).longValue());
          return;
        }
      }
      catch (Exception paramQQAppInterface)
  ...
  private static boolean c(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    if (paramInt == 1024)
    {
      Manager localManager = paramQQAppInterface.getManager(QQManagerFactory.PUBLICACCOUNTDATA_MANAGER);
      if (localManager != null)
      {
        if (((aoan)localManager).c(paramString) != null) {}
        for (bool1 = true;; bool1 = true)
        {
          ...
          if (((anty)paramQQAppInterface).a(paramString) == null) {
            break label159;
          }
        }
        label159:
