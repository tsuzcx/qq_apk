...
public class amoj
{
  public static void a(AppInterface paramAppInterface, int paramInt, String paramString, amok paramamok)
  {
    ...
    try
    {
      ...
      paramString = new NewIntent(BaseApplicationImpl.getContext(), amln.class);
      ...
      paramString.setObserver(paramamok);
