...
public class omz
{
  ...
  {
    Long localLong = (Long)bhvy.a("sp_key_readinjoy_refresh_optimize_id", Long.valueOf(0L));
    if (localLong != null) {}
  ...
  public static void a(String paramString)
  {
    ...
    bhvy.a("sp_key_readinjoy_refresh_optimize_id", Long.valueOf(l1));
  }
  
  public static void a(pow parampow)
  {
    if (parampow != null)
    {
