  ...
  implements IEventReceiver, vuf
{
  ...
  public ArrayList<xpe> a;
  private HashMap<String, String> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  public Map<String, String> a;
  private AtomicBoolean jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
  private vkq<String, FeedItem> jdField_a_of_type_Vkq = new vkq(300);
  public vwp a;
  private xbd jdField_a_of_type_Xbd = new xbd("feeItem");
  private xna jdField_a_of_type_Xna = new xna();
  public xnl a;
  private xns jdField_a_of_type_Xns;
  private xnt jdField_a_of_type_Xnt;
  public boolean a;
  public int b;
  private ConcurrentHashMap<String, vwa> jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  public xnl b;
  ...
  {
    paramString = vuu.a(QQStoryContext.a().a().createEntityManager(), FeedEntry.class, FeedEntry.class.getSimpleName(), FeedEntry.queryFeedId(), new String[] { paramString });
  ...
  private static FeedItem a(boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    Object localObject2 = localxnp.a(paramString1, paramString2);
    xvv.b("Q.qqstory.publish.upload:StoryVideoUploadManager", "find true feedId:%s", localObject2);
    Object localObject1 = localObject2;
    if (TextUtils.isEmpty((CharSequence)localObject2))
    {
      localObject1 = VideoListFeedItem.makeFakeFeedId(paramString1, paramString2);
      xvv.b("Q.qqstory.publish.upload:StoryVideoUploadManager", "make fake feedId:%s", localObject1);
    }
    localObject2 = localxnp.a((String)localObject1);
    ...
    {
      localxnp.a(paramString1);
      xvv.b("Q.qqstory.publish.upload:StoryVideoUploadManager", "save fake item %s", paramString1.feedId);
  ...
  public static ShareGroupFeedItem a(String paramString1, String paramString2)
  {
    ...
    {
      yos.a("feed type wrong for shareGroupItem:%s", new Object[] { paramString1 });
      return null;
    }
  ...
  private void a(wdu paramwdu)
  {
    xvv.a("Q.qqstory.home.data.FeedManager", "request feed item list from net, %s", paramwdu.b);
    vqn.a().a(paramwdu, new xnr(this));
  }
  ...
  {
    wbl.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.clear();
    jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.clear();
    wnv.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.clear();
  }
  
  public FeedItem a(FeedItem paramFeedItem)
  {
    xvv.a("Q.qqstory.home.data.FeedManager", "save feed item %s", paramFeedItem.feedId);
    paramFeedItem = (FeedItem)this.jdField_a_of_type_Vkq.a(paramFeedItem.feedId, paramFeedItem);
  ...
  public FeedItem a(String paramString)
  {
    ...
    {
      xvv.e("Q.qqstory.home.data.FeedManager", "feedId is null,you cant queryFeedItem:" + ypg.a(3));
      localObject = null;
    }
    do
    {
      return localObject;
      localFeedItem = (FeedItem)this.jdField_a_of_type_Vkq.a(paramString);
    ...
    {
      xvv.e("Q.qqstory.home.data.FeedManager", "这种类型目前还不支持：" + ((FeedEntry)localObject).type);
      return null;
    }
    localFeedItem.covertFromEntry((FeedEntry)localObject);
    return (FeedItem)this.jdField_a_of_type_Vkq.a(paramString, localFeedItem);
  }
  ...
  {
    xvv.a("Q.qqstory.home.data.FeedManager", "query my feedId unionId:%s, date:%s %s", paramString1, paramString2, this.jdField_a_of_type_JavaUtilHashMap);
  ...
  public List<String> a()
  {
    ...
    Object localObject = vuu.a(QQStoryContext.a().a().createEntityManager(), FeedIdListEntry.class, FeedIdListEntry.class.getSimpleName(), null, null);
    if (localObject == null) {
  ...
  {
    return ((vuu)vux.a(5)).a(paramString, 0, paramList, paramBoolean);
  }
  ...
  public List<FeedItem> a(List<FeedItem> paramList)
  {
    ...
    try
    {
      ...
      while (paramList.hasNext())
      {
        ...
        localFeedItem = (FeedItem)this.jdField_a_of_type_Vkq.a(localFeedItem.feedId, localFeedItem);
  ...
  public vwa a(String paramString)
  {
    if (TextUtils.isEmpty(paramString)) {
      return null;
    }
    vwa localvwa = (vwa)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
    if (this.jdField_a_of_type_Xnt == null)
    {
      this.jdField_a_of_type_Xnt = new xnt(this);
      vli.a().registerSubscriber(this.jdField_a_of_type_Xnt);
    }
    new wbl(Collections.singletonList(paramString), true).a();
    xvv.a("Q.qqstory.home.data.FeedManager", "request feed feature : %s", paramString);
    return localvwa;
  }
  
  public xna a()
  {
    return this.jdField_a_of_type_Xna;
  }
  
  public void a()
  {
    this.jdField_a_of_type_Xns = new xns(this);
    vli.a().registerSubscriber(this.jdField_a_of_type_Xns);
  }
  ...
  public void a(String paramString)
  {
    ...
    this.jdField_a_of_type_Vkq.a(paramString);
  }
  
  public void a(String paramString1, String paramString2, String paramString3)
  {
    this.jdField_a_of_type_JavaUtilHashMap.put(paramString1 + paramString2, paramString3);
    xvv.a("Q.qqstory.home.data.FeedManager", "save my feedId %s", this.jdField_a_of_type_JavaUtilHashMap);
  }
  
  public void a(List<xnh> paramList)
  {
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      xnh localxnh = (xnh)paramList.next();
      this.jdField_a_of_type_JavaUtilHashMap.put(localxnh.b + localxnh.c, localxnh.a);
    }
  }
  ...
  {
    ArrayList localArrayList = new ArrayList();
    List localList = vuu.a(QQStoryContext.a().a().createEntityManager(), FeedIdListEntry.class, FeedIdListEntry.class.getSimpleName(), null, null);
    if (localList == null) {
      return false;
    }
    int i = 0;
  ...
  {
    xvv.a("Q.qqstory.home.position", "disableAutoRefresh mIsFirstTimeUse:%b, fromOldLeba:%b, hasRedPoint:%b, mLastViewTime:%d", Boolean.valueOf(this.jdField_b_of_type_Boolean), Boolean.valueOf(paramBoolean1), Boolean.valueOf(paramBoolean2), Long.valueOf(this.jdField_a_of_type_Long));
    if ((!this.jdField_b_of_type_Boolean) && (paramBoolean1) && (!paramBoolean2) && (this.jdField_a_of_type_Long > 0L))
    {
      ...
      long l2 = ((Long)((vuq)vux.a(10)).b("key_disable_auto_refresh_time", Long.valueOf(60000L))).longValue();
      xvv.a("Q.qqstory.home.position", "disableAutoRefresh duration:%d, severConfigTime:%d", Long.valueOf(l1), Long.valueOf(l2));
      if (l1 < l2)
      {
  ...
  public FeedItem b(String paramString)
  {
    ...
    return (FeedItem)this.jdField_a_of_type_Vkq.a(paramString);
  }
  
  public List<String> b()
  {
    ArrayList localArrayList = new ArrayList();
    Object localObject = vuu.a(QQStoryContext.a().a().createEntityManager(), TroopAssistantFeedIdListEntry.class, TroopAssistantFeedIdListEntry.class.getSimpleName(), null, null);
    if (localObject == null) {
      return localArrayList;
    }
    localObject = ((List)localObject).iterator();
  ...
  public List<xpe> b(List<String> paramList)
  {
    ArrayList localArrayList = new ArrayList(paramList.size());
    ...
    while (localIterator.hasNext())
    {
      ...
      Object localObject = (FeedItem)this.jdField_a_of_type_Vkq.a(str);
      ...
      if (localObject == null)
      {
        ...
        if (localObject != null)
        {
          ...
          else
          {
            ...
            this.jdField_a_of_type_Vkq.a(str, paramList);
          }
        }
      }
      else
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Xnt != null) {
      vli.a().unRegisterSubscriber(this.jdField_a_of_type_Xnt);
    }
    if (this.jdField_a_of_type_Xns != null) {
      vli.a().unRegisterSubscriber(this.jdField_a_of_type_Xns);
    }
  ...
  public void b(@NonNull List<String> paramList)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (a((String)localObject1) == null)
      {
        ...
        {
          xvv.a("Q.qqstory.home.data.FeedManager", "request feed item list, ignore same request %s", localObject1);
        }
        else
        {
          jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(localObject1, Long.valueOf(System.currentTimeMillis()));
          localObject2 = new xnh((String)localObject1, 0, "", "");
  ...
  public FeedItem c(String paramString)
  {
    ...
    if (localFeedItem == null)
    {
      xvv.e("Q.qqstory.home.data.FeedManager", "这种类型目前还不支持：" + paramString.type);
      return null;
    }
  ...
  {
    ArrayList localArrayList = new ArrayList();
    Object localObject = vuu.a(QQStoryContext.a().a().createEntityManager(), MemoriesFeedIdListEntry.class, MemoriesFeedIdListEntry.class.getSimpleName(), null, null);
    if (localObject == null) {
      return localArrayList;
    }
    localObject = ((List)localObject).iterator();
  ...
  public void c()
  {
    ...
    long l = ((Long)((vuq)vux.a(10)).b("key_disable_auto_refresh_time", Long.valueOf(60000L))).longValue();
