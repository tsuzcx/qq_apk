  ...
  extends apap
{
  ...
  aznw jdField_a_of_type_Aznw = null;
  private Object jdField_a_of_type_JavaLangObject = new Object();
  
  public aost(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager)
  {
    super(paramQQAppInterface, paramProxyManager);
  }
  
  private long a(@NonNull HashMap<String, String> paramHashMap, bfoy parambfoy, msg_comm.Msg paramMsg, msg_comm.MsgHead paramMsgHead, long paramLong1, long paramLong2, int paramInt, MessageHandler paramMessageHandler, ArrayList<MessageRecord> paramArrayList)
  {
    if ((bcsa.c(paramInt)) || (paramInt == 208)) {
      a(paramHashMap, parambfoy, paramMsg, paramMsgHead, paramLong1, paramMessageHandler, paramArrayList);
    }
    do
    {
      return paramLong2;
      if ((paramInt == 82) || (paramInt == 43))
      {
        ...
        c(paramHashMap, parambfoy, paramMsg, paramMsgHead, paramLong1, paramMessageHandler, paramArrayList);
        return paramLong2;
      }
    } while ((paramInt != 83) && (paramInt != 42));
    paramLong2 = paramMsgHead.discuss_info.discuss_uin.get();
    b(paramHashMap, parambfoy, paramMsg, paramMsgHead, paramLong1, paramMessageHandler, paramArrayList);
    return paramLong2;
  }
  ...
  private MessageRecord a(MessageRecord paramMessageRecord1, msg_comm.MsgHead paramMsgHead, ArrayList<MessageRecord> paramArrayList, int paramInt, MessageRecord paramMessageRecord2)
  {
    ...
    if (!bbal.a(paramMessageRecord1))
    {
      localMessageRecord = paramMessageRecord2;
      if (!axpm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)paramMessageRecord2))
      {
        localMessageRecord = paramMessageRecord2;
        if (!(paramMessageRecord2 instanceof MessageForArkApp))
        {
          ...
          localMessageRecord = bcry.a(-1000);
  ...
  private String a(msg_comm.Msg paramMsg, HashMap<String, String> paramHashMap, bfoy parambfoy, msg_comm.MsgHead paramMsgHead, long paramLong, int paramInt, String paramString, MessageHandler paramMessageHandler, ArrayList<MessageRecord> paramArrayList, MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      parambfoy = paramString;
      if (paramMsgHead.from_nick.has())
      {
        parambfoy = paramString;
        if (paramHashMap != null)
        {
          parambfoy = paramMsgHead.from_nick.get();
  ...
  private String a(msg_comm.Msg paramMsg, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, bfoy parambfoy, msg_comm.MsgHead paramMsgHead, long paramLong, String paramString, MessageHandler paramMessageHandler, ArrayList<MessageRecord> paramArrayList)
  {
  ...
  private String a(msg_comm.Msg paramMsg, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, msg_comm.MsgHead paramMsgHead, long paramLong, String paramString, MessageHandler paramMessageHandler, ArrayList<MessageRecord> paramArrayList, bfoy parambfoy)
  {
            ...
            if (paramHashMap.anon_group_msg.has())
            {
              ...
              for (;;)
              {
                try
                {
                  ...
                  paramHashMap = "";
                  paramMessageHandler.saveExtInfoToExtStr("anonymous", nlj.a(i, paramMsg, paramHashMap, j, k, paramMsgHead));
  ...
  {
    im_msg_body.RichText localRichText = bcrw.a(paramMessageForStructing);
    try
    {
      ...
      else
      {
        ...
        for (Object localObject = localArrayList;; localObject = null)
        {
          ...
          while (paramMessageForStructing.hasNext())
          {
            ...
            if (axpm.a((ChatMessage)localObject))
            {
              if (QLog.isColorLevel()) {
  ...
  private void a(MessageRecord paramMessageRecord, msg_comm.Msg paramMsg, MessageHandler paramMessageHandler, ArrayList<MessageRecord> paramArrayList)
  {
    ...
    new bcsp().a(paramMessageHandler, paramMsg, paramArrayList, null);
  }
  ...
  private void a(@NonNull HashMap<String, String> paramHashMap, bfoy parambfoy, msg_comm.Msg paramMsg, msg_comm.MsgHead paramMsgHead, long paramLong, MessageHandler paramMessageHandler, ArrayList<MessageRecord> paramArrayList)
  {
    int i = paramMsgHead.c2c_cmd.get();
    if ((i == 175) || (i == 11))
    {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage)
  {
    ...
    } while (!aunj.a(paramQQAppInterface, (MessageForFile)paramChatMessage).sendCloudUnsuccessful());
    return false;
    return false;
  }
  ...
  public static byte[] a(byte[] paramArrayOfByte)
  {
    ...
    //   33: new 630	java/io/ByteArrayInputStream
    //   36: dup
    //   37: aload_0
    //   38: invokespecial 631	java/io/ByteArrayInputStream:<init>	([B)V
    //   41: astore_3
    //   42: new 633	java/io/ByteArrayOutputStream
    //   45: dup
    //   46: invokespecial 634	java/io/ByteArrayOutputStream:<init>	()V
    //   49: astore 4
    //   51: sipush 1024
    //   54: newarray byte
    //   56: astore_0
    //   57: new 636	java/util/zip/GZIPOutputStream
    //   60: dup
    //   61: aload 4
    //   63: invokespecial 639	java/util/zip/GZIPOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   66: astore_2
    //   67: aload_3
    //   68: aload_0
    //   69: iconst_0
    //   70: sipush 1024
    //   73: invokevirtual 643	java/io/ByteArrayInputStream:read	([BII)I
    //   76: istore_1
    //   77: iload_1
    //   78: iconst_m1
    //   79: if_icmpeq +64 -> 143
    ...
    //   84: iconst_0
    //   85: iload_1
    //   86: invokevirtual 647	java/util/zip/GZIPOutputStream:write	([BII)V
    //   89: goto -22 -> 67
    //   92: astore_2
    //   93: aconst_null
    //   94: astore_0
    ...
    //   117: aload_2
    //   118: invokevirtual 652	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   130: aload 4
    //   132: invokevirtual 655	java/io/ByteArrayOutputStream:close	()V
    //   135: aload_3
    //   136: invokevirtual 656	java/io/ByteArrayInputStream:close	()V
    //   139: aload_0
    //   140: astore_2
    //   141: aload_2
    //   142: areturn
    //   143: aload_2
    //   144: invokevirtual 659	java/util/zip/GZIPOutputStream:flush	()V
    //   147: aload_2
    //   148: invokevirtual 660	java/util/zip/GZIPOutputStream:close	()V
    //   151: aload 4
    //   153: invokevirtual 661	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   156: astore_0
    ...
    //   190: aload 4
    //   192: invokevirtual 655	java/io/ByteArrayOutputStream:close	()V
    //   195: aload_3
    //   196: invokevirtual 656	java/io/ByteArrayInputStream:close	()V
    //   199: aload_0
    //   200: areturn
    //   201: astore_3
    //   202: aload_0
    ...
    //   226: aload_3
    //   227: invokevirtual 666	java/io/IOException:getMessage	()Ljava/lang/String;
    ...
    //   266: aload_3
    //   267: invokevirtual 666	java/io/IOException:getMessage	()Ljava/lang/String;
    ...
    //   306: aload_2
    //   307: invokevirtual 669	java/lang/OutOfMemoryError:getMessage	()Ljava/lang/String;
    ...
    //   319: aload 4
    //   321: invokevirtual 655	java/io/ByteArrayOutputStream:close	()V
    //   324: aload_3
    //   325: invokevirtual 656	java/io/ByteArrayInputStream:close	()V
    //   328: aload_0
    //   329: areturn
    //   330: astore_3
    //   331: aload_0
    ...
    //   355: aload_3
    //   356: invokevirtual 666	java/io/IOException:getMessage	()Ljava/lang/String;
    ...
    //   370: astore_0
    //   371: aload 4
    //   373: invokevirtual 655	java/io/ByteArrayOutputStream:close	()V
    //   376: aload_3
    //   377: invokevirtual 656	java/io/ByteArrayInputStream:close	()V
    //   380: aload_0
    //   381: athrow
    //   382: astore_2
    ...
    //   405: aload_2
    //   406: invokevirtual 666	java/io/IOException:getMessage	()Ljava/lang/String;
  ...
  private void b(MessageForStructing paramMessageForStructing, HashMap<String, ArrayList<MessageRecord>> paramHashMap, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (paramMessageForStructing.hasNext())
      {
        ...
        if (!axpm.a((ChatMessage)localMessageRecord1)) {
          continue;
        }
        if (paramInt != 2) {
          break label214;
        }
        MessageRecord localMessageRecord2 = a(localMessageRecord1, axpd.jdField_a_of_type_JavaLangString, false);
  ...
  private void b(@NonNull HashMap<String, String> paramHashMap, bfoy parambfoy, msg_comm.Msg paramMsg, msg_comm.MsgHead paramMsgHead, long paramLong, MessageHandler paramMessageHandler, ArrayList<MessageRecord> paramArrayList)
  {
    if (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().b(paramArrayList, paramMsg)) {
      bcrw.a(paramMessageHandler, paramArrayList, paramMsg, false, false, parambfoy);
    }
  ...
  public static byte[] b(byte[] paramArrayOfByte)
  {
    ...
    //   36: aconst_null
    //   37: astore 4
    //   39: new 630	java/io/ByteArrayInputStream
    //   42: dup
    //   43: aload_0
    //   44: invokespecial 631	java/io/ByteArrayInputStream:<init>	([B)V
    //   47: astore 6
    //   49: new 633	java/io/ByteArrayOutputStream
    //   52: dup
    //   53: invokespecial 634	java/io/ByteArrayOutputStream:<init>	()V
    //   56: astore 7
    //   58: aload 4
    //   60: astore_2
    //   61: aload 5
    ...
    //   74: aload 5
    //   76: astore_3
    //   77: new 719	java/util/zip/GZIPInputStream
    //   80: dup
    //   81: aload 6
    //   83: invokespecial 722	java/util/zip/GZIPInputStream:<init>	(Ljava/io/InputStream;)V
    //   86: astore 9
    //   88: aload 4
    //   90: astore_2
    //   91: aload 5
    ...
    //   98: iconst_0
    //   99: sipush 1024
    //   102: invokevirtual 723	java/util/zip/GZIPInputStream:read	([BII)I
    //   105: istore_1
    //   106: iload_1
    //   107: iconst_m1
    ...
    //   121: iconst_0
    //   122: iload_1
    //   123: invokevirtual 724	java/io/ByteArrayOutputStream:write	([BII)V
    //   126: goto -38 -> 88
    //   129: astore_3
    ...
    //   152: aload_3
    //   153: invokevirtual 652	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   165: aload 7
    //   167: invokevirtual 655	java/io/ByteArrayOutputStream:close	()V
    //   170: aload 6
    //   172: invokevirtual 656	java/io/ByteArrayInputStream:close	()V
    //   175: aload_2
    ...
    //   186: astore_3
    //   187: aload 9
    //   189: invokevirtual 727	java/util/zip/GZIPInputStream:close	()V
    //   192: aload 4
    //   194: astore_2
    //   195: aload 5
    //   197: astore_3
    //   198: aload 7
    //   200: invokevirtual 661	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   203: astore 4
    //   205: aload 4
    //   207: astore_2
    //   208: aload 4
    ...
    //   251: aload 7
    //   253: invokevirtual 655	java/io/ByteArrayOutputStream:close	()V
    //   256: aload 6
    //   258: invokevirtual 656	java/io/ByteArrayInputStream:close	()V
    //   261: aload 4
    //   263: astore_2
    //   264: goto -89 -> 175
    //   267: astore_2
    ...
    //   290: aload_2
    //   291: invokevirtual 666	java/io/IOException:getMessage	()Ljava/lang/String;
    ...
    //   332: aload_3
    //   333: invokevirtual 666	java/io/IOException:getMessage	()Ljava/lang/String;
    ...
    //   371: aload_2
    //   372: invokevirtual 669	java/lang/OutOfMemoryError:getMessage	()Ljava/lang/String;
    ...
    //   384: aload 7
    //   386: invokevirtual 655	java/io/ByteArrayOutputStream:close	()V
    //   389: aload 6
    //   391: invokevirtual 656	java/io/ByteArrayInputStream:close	()V
    //   394: aload_3
    //   395: astore_2
    //   396: goto -221 -> 175
    //   399: astore_2
    ...
    //   422: aload_2
    //   423: invokevirtual 666	java/io/IOException:getMessage	()Ljava/lang/String;
    ...
    //   440: astore_0
    //   441: aload 7
    //   443: invokevirtual 655	java/io/ByteArrayOutputStream:close	()V
    //   446: aload 6
    //   448: invokevirtual 656	java/io/ByteArrayInputStream:close	()V
    //   451: aload_0
    //   452: athrow
    //   453: astore_2
    ...
    //   476: aload_2
    //   477: invokevirtual 666	java/io/IOException:getMessage	()Ljava/lang/String;
  ...
  private im_msg_body.RichText c(MessageRecord paramMessageRecord)
  {
    if (!TextUtils.isEmpty(paramMessageRecord.getExtInfoFromExtStr("sens_msg_source_msg_info"))) {
      return bcrw.a(paramMessageRecord);
    }
    return bcrw.a((MessageForText)paramMessageRecord);
  }
  
  private void c(@NonNull HashMap<String, String> paramHashMap, bfoy parambfoy, msg_comm.Msg paramMsg, msg_comm.MsgHead paramMsgHead, long paramLong, MessageHandler paramMessageHandler, ArrayList<MessageRecord> paramArrayList)
  {
    if (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a(paramArrayList, paramMsg)) {
      bcrw.a(paramMessageHandler, paramArrayList, paramMsg, false, false, parambfoy);
    }
  ...
  public ArrayList<MessageRecord> a(MessageRecord paramMessageRecord, ArrayList<? extends MessageRecord> paramArrayList, ProxyListener paramProxyListener, boolean paramBoolean1, boolean paramBoolean2, ArrayList<MessageRecord> paramArrayList1)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (paramBoolean2)
      {
          ...
          else if (localMessageRecord.msgtype == -1035)
          {
            ...
            if (((MessageForMixedMsg)localObject1).getReplyMessage(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) != null)
            {
              ...
              if ((localObject1 != null) && (localObject2 != null)) {
                auoo.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((MessageForReplyText)localObject1).getSourceMessage(), ((MessageForReplyText)localObject2).getSourceMessage());
              }
            }
          }
        ...
        if ((nlj.a(paramArrayList)) && (nlj.b(paramArrayList))) {
      ...
      auoo.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord, paramArrayList);
  ...
  public ArrayList<MessageRecord> a(msg_comm.Msg paramMsg, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, bfoy parambfoy)
  {
    ...
    long l6 = bcrw.a(localMessageHandler, paramMsg, String.valueOf(l2), String.valueOf(l2));
    ArrayList localArrayList = new ArrayList();
    long l1;
    if (((bcsa.c(j)) || (j == 208) || (j == 529)) && (localMsgHead.c2c_cmd.has()))
    {
      paramHashMap = a(paramMsg, paramHashMap, parambfoy, localMsgHead, l2, j, str, localMessageHandler, localArrayList, paramMessageRecord);
      l1 = l2;
    }
    for (;;)
    {
      int i = 0;
      int k = bcrw.a(paramMsg);
      ...
      for (;;)
      {
        ...
        parambfoy = a(paramMessageRecord, localMsgHead, localArrayList, i, (MessageRecord)paramMsg.next());
        i += 1;
        parambfoy.time = l4;
        parambfoy.shmsgseq = l3;
        parambfoy.msgUid = l5;
        parambfoy.selfuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
        parambfoy.senderuin = String.valueOf(l2);
        parambfoy.frienduin = String.valueOf(l1);
        parambfoy.vipBubbleDiyTextId = k;
        parambfoy.vipBubbleID = aogu.a((int)l6, k);
        axpm.a(parambfoy, paramHashMap, paramMessageRecord);
        if ((j == 82) || (j == 43))
        {
          parambfoy.istroop = 1;
          continue;
          if (((j == 82) || (j == 43)) && (localMsgHead.group_info.has()))
          {
            ...
            paramHashMap = a(paramMsg, paramHashMap, paramMessageRecord, localMsgHead, l2, str, localMessageHandler, localArrayList, parambfoy);
            break;
          }
          ...
          paramHashMap = a(paramMsg, paramHashMap, paramMessageRecord, parambfoy, localMsgHead, l2, str, localMessageHandler, localArrayList);
          break;
        }
        if ((j == 83) || (j == 42)) {
          parambfoy.istroop = 3000;
        } else {
          parambfoy.istroop = 0;
        }
      }
      label567:
      aoci.a(localArrayList);
      return localArrayList;
      label575:
      l1 = l2;
      paramHashMap = str;
  ...
  public ArrayList<MessageRecord> a(@NonNull byte[] paramArrayOfByte, @NonNull HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, bfoy parambfoy)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          ...
          MessageHandler localMessageHandler = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
          long l5 = bcrw.a(localMessageHandler, (msg_comm.Msg)localObject3, String.valueOf(l1), String.valueOf(l1));
          localObject2 = new ArrayList();
          long l6 = a(paramHashMap, parambfoy, (msg_comm.Msg)localObject3, (msg_comm.MsgHead)localObject4, l1, l1, j, localMessageHandler, (ArrayList)localObject2);
          a(paramMessageRecord, (msg_comm.Msg)localObject3, localMessageHandler, (ArrayList)localObject2);
          int k = bcrw.a((msg_comm.Msg)localObject3);
          ...
          ((MessageRecord)localObject4).vipBubbleID = aogu.a((int)l5, k);
          if ((j == 82) || (j == 43))
          {
  ...
  public HashMap<String, ArrayList<MessageRecord>> a(MessageRecord paramMessageRecord, HashMap<String, ArrayList<MessageRecord>> paramHashMap, ProxyListener paramProxyListener, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    do
    {
      ...
      {
        return localHashMap;
        if (axpm.a((ChatMessage)paramMessageRecord)) {
          break;
        }
      } while (!QLog.isColorLevel());
  ...
  public HashMap<String, ArrayList<MessageRecord>> a(byte[] paramArrayOfByte, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, bfoy parambfoy)
  {
    ...
    try
    {
      ...
      if (paramArrayOfByte.msg.has())
      {
        ...
        {
          localObject3 = a((msg_comm.Msg)paramArrayOfByte.msg.get(i), paramHashMap, paramMessageRecord, parambfoy);
    ...
    if (!a(paramMessageRecord, (HashMap)localObject1, null))
    {
      ...
      if (i < paramArrayOfByte.pbItemList.size())
      {
        ...
        try
        {
          ...
          {
            ArrayList localArrayList = a((msg_comm.Msg)((msg_transmit.PbMultiMsgNew)localObject3).msg.get(j), paramHashMap, paramMessageRecord, parambfoy);
  ...
  public msg_comm.MsgHead a(MessageRecord paramMessageRecord, HashMap<String, String> paramHashMap, boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
    ...
    localMsgHead.from_uin.set(Long.valueOf(adak.c(paramMessageRecord)).longValue());
    ...
    if (paramBoolean1)
    {
      ...
      String str = adak.c(paramMessageRecord);
      ...
      axpm.a("step:packPb.getMsgHead.nickName = %s", new Object[] { localObject1 });
  ...
  public im_msg_body.MsgBody a(MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        localRichText = bcrw.a((MessageForReplyText)paramMessageRecord);
      }
      ...
      {
        localRichText = bcrw.a((MessageForPic)paramMessageRecord);
      }
      else if (paramMessageRecord.msgtype == -5008)
      {
        localRichText = bcrw.a((MessageForArkApp)paramMessageRecord, true);
      }
      else if (paramMessageRecord.msgtype == -5016)
      {
        localRichText = bcrw.c((MessageForArkBabyqReply)paramMessageRecord, true);
      }
      else if (paramMessageRecord.msgtype == -5017)
      {
        localRichText = bcrw.b((MessageForArkApp)paramMessageRecord, true);
      }
      else if (paramMessageRecord.msgtype == -5014)
      {
        localRichText = bcrw.d((MessageForHiBoom)paramMessageRecord);
      }
      ...
      {
        localRichText = bcrw.a((MessageForMixedMsg)paramMessageRecord);
      }
      else if (paramMessageRecord.msgtype == -1051)
      {
        localRichText = bcrw.a((MessageForLongTextMsg)paramMessageRecord, false);
      }
    ...
    for (;;)
    {
      ...
      if ((paramHashMap != null) && (paramHashMap.size() > 0))
      {
        ...
        if (((Iterator)localObject1).hasNext())
        {
          ...
          if (!axpm.a((ChatMessage)paramHashMap)) {
            break label610;
          }
          paramHashMap = a(paramHashMap, axpd.jdField_b_of_type_JavaLangString, false);
        }
      }
      for (;;)
      {
