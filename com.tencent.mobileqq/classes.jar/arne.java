...
public class arne
{
  ...
  private static LruCache<String, arnf> a;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bedk.a(armt.jdField_a_of_type_JavaLangString + "combo" + File.separator);
    ...
    jdField_b_of_type_JavaLangString = armt.jdField_a_of_type_JavaLangString;
  ...
  public static arnf a(int paramInt)
  {
    return a(jdField_a_of_type_JavaLangString + jdField_a_of_type_ArrayOfJavaLangString[paramInt], 2);
  }
  
  public static arnf a(String paramString, int paramInt)
  {
    int i = 0;
    Object localObject1 = (arnf)jdField_a_of_type_AndroidUtilLruCache.get(paramString);
    ...
    for (;;)
    {
      ...
      localarnf.jdField_a_of_type_Int = i;
      localarnf.b = paramInt;
      localarnf.jdField_a_of_type_AndroidGraphicsDrawableDrawable = ((Drawable)localObject2);
      jdField_a_of_type_AndroidUtilLruCache.put(paramString, localarnf);
      return localarnf;
      i = afur.a(k / jdField_a_of_type_Float, localarnf);
      paramInt = afur.a(j / jdField_a_of_type_Float, localarnf);
      continue;
      paramInt = afur.a(32.0F, localarnf);
      i = (int)(paramInt / j * k);
      continue;
      paramInt = afur.a(24.0F, localarnf);
      i = (int)(paramInt / j * k);
    }
  }
