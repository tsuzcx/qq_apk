...
public class bdol
{
  public static final int a = bdnh.jdField_b_of_type_ArrayOfJavaLangString.length;
  ...
  public static final Drawable a(int paramInt, bdom parambdom)
  {
    if (paramInt < 0) {
      throw new IllegalArgumentException("invaid emoji index: " + paramInt);
    }
    ...
    if (paramInt >= 1000)
    {
      ...
      ThreadManager.executeOnFileThread(new TextUtils.1(paramInt, parambdom));
      return null;
    }
    if ((paramInt >= 0) && (paramInt < bdnh.jdField_b_of_type_Int)) {}
    for (paramInt = 2130839808 + paramInt;; paramInt = 2130839942)
    {
      if (BaseApplicationImpl.sImageCache != null)
      {
        ...
        ThreadManager.executeOnFileThread(new TextUtils.2(paramInt, parambdom));
        return null;
      }
  ...
  public static Drawable a(Resources paramResources, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramInt = bgjc.a((Drawable)localObject);
  ...
  public static final String a(int paramInt)
  {
    ...
    return String.valueOf(Character.toChars(bdnh.d[paramInt]));
  }
  ...
  public static String a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      catch (Throwable paramString)
      {
        ...
        paramString[j] = 13;
        continue;
        paramString = arpm.a(paramString);
        if (paramString == null) {
          continue;
        }
      }
  ...
  public static final Drawable b(Resources paramResources, int paramInt)
  {
    ...
    //   63: getstatic 499	bdne:b	Ljava/lang/String;
    ...
    //   114: astore_0
    //   115: aload 6
    //   117: invokestatic 525	bdne:a	([B)I
    //   120: istore_2
    //   121: aload 5
    //   123: astore_0
    ...
    //   212: getstatic 499	bdne:b	Ljava/lang/String;
    ...
    //   256: astore_0
    //   257: aload 6
    //   259: invokestatic 551	bgjw:a	(Landroid/graphics/Bitmap;)I
    //   262: istore_2
    //   263: aload 5
    //   265: astore_0
    ...
    //   408: ldc_w 531
    //   411: iconst_2
    //   412: invokestatic 565	afur:a	()Ljava/lang/StringBuilder;
    //   415: ldc_w 567
    ...
    //   448: getstatic 499	bdne:b	Ljava/lang/String;
    ...
    //   465: getstatic 499	bdne:b	Ljava/lang/String;
    ...
    //   521: getstatic 499	bdne:b	Ljava/lang/String;
    ...
    //   533: ldc_w 531
    //   536: iconst_2
    //   537: invokestatic 565	afur:a	()Ljava/lang/StringBuilder;
    //   540: ldc_w 567
    ...
    //   575: getstatic 499	bdne:b	Ljava/lang/String;
  ...
  public static String b(String paramString)
  {
    ...
    do
    {
      ...
      while (i < j)
      {
        k = paramString.indexOf(arvj.a(i), 0);
        str1 = paramString;
        if (k != -1)
        {
          str1 = paramString;
          if (k + 2 <= paramString.length()) {
            str1 = paramString.replace(paramString.substring(k, k + 2), arvj.a(i));
          }
        }
        i += 1;
        paramString = str1;
  ...
  {
    return String.valueOf(new char[] { '<', '$', (char)arvq.a(paramInt), '>' });
  }
      ...
      catch (AccountNotMatchException localAccountNotMatchException)
      {
        for (;;)
        {
          try
          {
            ...
            localObject1 = (awmr)((AppInterface)localObject1).getManager(14);
            localStringBuilder = new StringBuilder(paramString);
            i = 0;
            if (i >= localStringBuilder.length()) {
              break label465;
  ...
  public static String e(String paramString)
  {
    ...
    while (i < a)
    {
      k = paramString.indexOf(bdnh.d[i], 0);
      localObject = paramString;
      if (k != -1)
      {
        ...
        catch (AccountNotMatchException paramString)
        {
          for (;;)
          {
            try
            {
              ...
              localObject = arvq.a(m);
              if (k != 0) {
                break label647;
              }
              localObject = anni.a(2131713577) + (String)localObject;
