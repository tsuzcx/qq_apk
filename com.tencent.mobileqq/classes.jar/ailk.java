  ...
  extends BaseAdapter
{
  ...
  List<bbnn> jdField_a_of_type_JavaUtilList;
  
  public ailk(ailh paramailh) {}
  ...
  public android.view.View getView(int paramInt, android.view.View paramView, android.view.ViewGroup paramViewGroup)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 22	ailk:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   4: ifnonnull +5 -> 9
    //   7: aload_2
    //   8: areturn
    //   9: aload_2
    ...
    //   16: dup
    //   17: aload_0
    //   18: invokespecial 60	aill:<init>	(Lailk;)V
    //   21: astore 5
    //   23: aload_0
    //   24: getfield 13	ailk:jdField_a_of_type_Ailh	Lailh;
    //   27: getfield 65	ailh:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    ...
    //   56: putfield 88	aill:jdField_a_of_type_AndroidWidgetRelativeLayout	Landroid/widget/RelativeLayout;
    //   59: aload_2
    //   60: astore_3
    //   61: aload 5
    //   63: aload_2
    ...
    //   72: putfield 94	aill:jdField_a_of_type_ComTencentMobileqqVasAvatarVasAvatar	Lcom/tencent/mobileqq/vas/avatar/VasAvatar;
    //   75: aload_2
    //   76: astore_3
    //   77: aload 5
    //   79: aload_2
    ...
    //   88: putfield 100	aill:jdField_a_of_type_AndroidWidgetImageView	Landroid/widget/ImageView;
    //   91: aload_2
    //   92: astore_3
    //   93: aload 5
    //   95: aload_2
    ...
    //   104: putfield 106	aill:jdField_a_of_type_AndroidWidgetTextView	Landroid/widget/TextView;
    //   107: aload_2
    //   108: astore_3
    //   109: aload 5
    //   111: aload_2
    ...
    //   120: putfield 110	aill:b	Landroid/widget/ImageView;
    //   123: aload_2
    //   124: astore_3
    //   125: aload 5
    //   127: getfield 88	aill:jdField_a_of_type_AndroidWidgetRelativeLayout	Landroid/widget/RelativeLayout;
    ...
    //   142: aload 4
    //   144: aload_0
    //   145: getfield 13	ailk:jdField_a_of_type_Ailh	Lailh;
    //   148: getfield 117	ailh:g	I
    //   151: putfield 122	android/view/ViewGroup$LayoutParams:width	I
    //   154: aload_2
    //   155: astore_3
    //   156: aload 4
    //   158: aload_0
    //   159: getfield 13	ailk:jdField_a_of_type_Ailh	Lailh;
    //   162: getfield 117	ailh:g	I
    //   165: putfield 125	android/view/ViewGroup$LayoutParams:height	I
    //   168: aload_2
    //   169: astore_3
    //   170: aload 5
    //   172: getfield 88	aill:jdField_a_of_type_AndroidWidgetRelativeLayout	Landroid/widget/RelativeLayout;
    //   175: aload 4
    ...
    //   194: aload_0
    //   195: iload_1
    //   196: invokevirtual 135	ailk:getItem	(I)Ljava/lang/Object;
    //   199: checkcast 137	bbnn
    //   202: astore 6
    //   204: aload 6
    //   206: ifnull +321 -> 527
    //   209: aload_2
    //   210: astore_3
    //   211: aload 4
    //   213: getfield 106	aill:jdField_a_of_type_AndroidWidgetTextView	Landroid/widget/TextView;
    //   216: aload 6
    //   218: getfield 140	bbnn:b	Ljava/lang/String;
    //   221: invokevirtual 144	android/widget/TextView:setText	(Ljava/lang/CharSequence;)V
    //   224: aload_2
    //   225: astore_3
    //   226: aload 6
    //   228: getfield 145	bbnn:jdField_a_of_type_Int	I
    //   231: istore_1
    //   232: aload_2
    //   233: astore_3
    //   234: aload 4
    //   236: getfield 94	aill:jdField_a_of_type_ComTencentMobileqqVasAvatarVasAvatar	Lcom/tencent/mobileqq/vas/avatar/VasAvatar;
    ...
    //   275: ldc 158
    //   277: iconst_1
    //   278: invokespecial 161	bbsi:<init>	(IILjava/lang/String;Z)V
    //   281: astore 7
    //   283: aload_2
    //   284: astore_3
    //   285: aload 7
    //   287: aload 5
    //   289: putfield 164	bbsi:a	Landroid/graphics/drawable/Drawable;
    //   292: aload_2
    //   293: astore_3
    //   294: aload 4
    //   296: getfield 94	aill:jdField_a_of_type_ComTencentMobileqqVasAvatarVasAvatar	Lcom/tencent/mobileqq/vas/avatar/VasAvatar;
    //   299: aconst_null
    //   300: aload 7
    //   302: invokevirtual 168	com/tencent/mobileqq/vas/avatar/VasAvatar:setLoader	(Lcom/tencent/mobileqq/vas/avatar/AvatarLayout;Lbbsi;)V
    //   305: aload_2
    //   306: astore_3
    //   307: aload 4
    //   309: getfield 88	aill:jdField_a_of_type_AndroidWidgetRelativeLayout	Landroid/widget/RelativeLayout;
    //   312: aload 6
    //   314: invokevirtual 169	android/widget/RelativeLayout:setTag	(Ljava/lang/Object;)V
    //   317: aload_2
    //   318: astore_3
    //   319: aload_0
    //   320: getfield 13	ailk:jdField_a_of_type_Ailh	Lailh;
    //   323: ldc 171
    //   325: iconst_0
    ...
    //   329: putfield 180	ailh:jdField_a_of_type_AndroidContentSharedPreferences	Landroid/content/SharedPreferences;
    //   332: aload_2
    //   333: astore_3
    //   334: aload_0
    //   335: getfield 13	ailk:jdField_a_of_type_Ailh	Lailh;
    //   338: aload_0
    //   339: getfield 13	ailk:jdField_a_of_type_Ailh	Lailh;
    //   342: getfield 180	ailh:jdField_a_of_type_AndroidContentSharedPreferences	Landroid/content/SharedPreferences;
    //   345: ldc 182
    //   347: iconst_0
    //   348: invokeinterface 188 3 0
    //   353: putfield 191	ailh:n	I
    //   356: aload_2
    //   357: astore_3
    //   358: aload_0
    //   359: getfield 13	ailk:jdField_a_of_type_Ailh	Lailh;
    //   362: getfield 191	ailh:n	I
    //   365: aload 6
    //   367: getfield 145	bbnn:jdField_a_of_type_Int	I
    //   370: if_icmpne +119 -> 489
    //   373: aload_2
    //   374: astore_3
    //   375: aload_2
    //   376: aload_0
    //   377: getfield 13	ailk:jdField_a_of_type_Ailh	Lailh;
    //   380: getfield 65	ailh:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    ...
    //   395: astore_3
    //   396: aload 6
    //   398: getfield 145	bbnn:jdField_a_of_type_Int	I
    //   401: aload_0
    //   402: getfield 13	ailk:jdField_a_of_type_Ailh	Lailh;
    //   405: getfield 210	ailh:m	I
    //   408: if_icmpne +94 -> 502
    //   411: aload_2
    //   412: astore_3
    //   413: aload 4
    //   415: getfield 100	aill:jdField_a_of_type_AndroidWidgetImageView	Landroid/widget/ImageView;
    //   418: iconst_0
    ...
    //   448: dup
    //   449: aload_0
    //   450: getfield 13	ailk:jdField_a_of_type_Ailh	Lailh;
    //   453: getfield 117	ailh:g	I
    //   456: aload_0
    //   457: getfield 13	ailk:jdField_a_of_type_Ailh	Lailh;
    //   460: getfield 231	ailh:h	I
    ...
    //   503: astore_3
    //   504: aload 4
    //   506: getfield 100	aill:jdField_a_of_type_AndroidWidgetImageView	Landroid/widget/ImageView;
    //   509: bipush 8
    ...
    //   202	195	6	localbbnn	bbnn
    //   281	20	7	localbbsi	bbsi
    // Exception table:
    //   from	to	target	type
