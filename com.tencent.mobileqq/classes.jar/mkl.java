...
public class mkl
  extends mbn
{
  BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new mkm(this);
  Intent jdField_a_of_type_AndroidContentIntent;
  public VideoController a;
  ldz jdField_a_of_type_Ldz = new mko(this);
  lff jdField_a_of_type_Lff = new mkn(this);
  ...
  public mkl(VideoController paramVideoController, VideoAppInterface paramVideoAppInterface, Intent paramIntent)
  {
  ...
  private boolean a(int paramInt)
  {
    ...
    {
      bcef.b(null, "dc00899", "Grp_video", "", "invite", (String)localObject, 0, 0, String.valueOf(this.jdField_a_of_type_ComTencentAvVideoController.a().g), this.jdField_d_of_type_Int + "", "", "");
      bool1 = true;
      return bool1;
    }
  }
  ...
  public int a(long paramLong, Intent paramIntent)
  {
    ...
    if (mqu.b(this.jdField_b_of_type_Int))
    {
      ...
      this.jdField_a_of_type_Lez = lbu.a().a();
      return 2;
    }
    ...
    while (this.jdField_c_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_Lez = lbu.a().c(paramIntent);
      this.jdField_a_of_type_Lez.a(paramLong, "onStartCommand.1", 4);
      this.jdField_a_of_type_Lez.e("onStartCommand", true);
    ...
    {
      this.jdField_a_of_type_Lez.a(paramLong, "onStartCommand.2", 1);
    ...
    for (;;)
    {
      ...
      return 2;
      this.jdField_a_of_type_Lez.a(paramLong, "onStartCommand.3", 2);
      paramIntent = this.jdField_a_of_type_Lez;
  ...
  public void a(long paramLong)
  {
    ...
    int i = 1;
    if (!this.jdField_a_of_type_Lez.N) {
      i = 4;
    }
    if (1008 == this.jdField_a_of_type_Lez.j) {
      i = 4;
    }
    for (;;)
    {
      ...
      for (;;)
      {
        if (this.jdField_a_of_type_Mkk != null) {
          this.jdField_a_of_type_Mkk.c(amtj.a(2131715298));
        }
        if (!this.jdField_a_of_type_Lez.S) {
          break;
        }
        ...
        return;
        this.jdField_a_of_type_ComTencentAvVideoController.a(paramLong, this.jdField_a_of_type_Lez.jdField_d_of_type_JavaLangString, j, i);
      }
  ...
  protected boolean a()
  {
    if (this.jdField_a_of_type_Mur == null) {
      this.jdField_a_of_type_Mur = new mur(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApplication().getApplicationContext(), 1, "video wifi lock");
    }
    if ((msm.e(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApplication().getApplicationContext())) && (this.jdField_a_of_type_Mur != null)) {
  ...
  public void b(long paramLong)
  {
    ...
    while (this.jdField_c_of_type_Boolean)
    {
      ...
      long l = mrb.a(this.jdField_c_of_type_JavaLangString);
  ...
  public void d(long paramLong)
  {
    ...
    if (this.jdField_a_of_type_Mkk != null) {
      this.jdField_a_of_type_Mkk.c(amtj.a(2131715299));
    }
    this.jdField_a_of_type_ComTencentAvVideoController.a(paramLong, this.jdField_c_of_type_Int, this.jdField_a_of_type_Lez.g, this.jdField_a_of_type_ArrayOfLong, false);
