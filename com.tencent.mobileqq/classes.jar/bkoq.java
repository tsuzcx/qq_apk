...
public class bkoq
{
  ...
  public static boolean a()
  {
    ...
    SharedPreferences localSharedPreferences = bljc.a().a();
    ...
    AECoderFactory.setAEDecoder(new bkor());
    AECoderFactory.setAEEncoder(new bkos());
    ...
    CfConfig.setDecryptListener(new bkot());
    a = true;
    return true;
  }
