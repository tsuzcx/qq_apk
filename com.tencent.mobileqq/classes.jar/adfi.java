  ...
  extends adee
{
  ...
  private void a(JSONObject paramJSONObject, @NonNull adea paramadea)
  {
    ...
    for (int i = ((BaseActivity)paramJSONObject).getTitleBarHeight();; i = 0)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder == null)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder.setActionSheetTitle(paramJSONObject.getString(2131718027));
        this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder.setActionSheetItems(a(paramJSONObject));
      }
      this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder.setItemClickListener(paramadea);
      try
      {
  ...
  private void b(JSONObject paramJSONObject, @NonNull adea paramadea)
  {
    ...
    Activity localActivity = this.jdField_a_of_type_Aded.a();
    if (!bgnt.g(BaseApplicationImpl.getContext()))
    {
      adhh.a(paramadea, -1, "net work not available");
      return;
    }
