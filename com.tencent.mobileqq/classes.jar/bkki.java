  ...
  extends bfwn
{
  ...
  static
  {
    jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarPOI = new TroopBarPOI("-1", "", ajyc.a(2131710991), 0, "", 0, "");
  }
  
  public bkki(Context paramContext)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561338, null);
      paramViewGroup = new bkkj();
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131375821));
    ...
    for (paramInt = 0;; paramInt = 8)
    {
      ...
      return paramView;
      paramViewGroup = (bkkj)paramView.getTag();
      break;
    }
  }
}
