...
public class pjz
{
  ...
  {
    Long localLong = (Long)bmhv.a("sp_key_readinjoy_refresh_optimize_id", Long.valueOf(0L));
    if (localLong != null) {}
  ...
  public static void a(String paramString)
  {
    ...
    bmhv.a("sp_key_readinjoy_refresh_optimize_id", Long.valueOf(l1));
  }
  
  public static void a(qxs paramqxs)
  {
    if (paramqxs != null)
    {
