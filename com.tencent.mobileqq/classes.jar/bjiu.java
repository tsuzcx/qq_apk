  ...
  extends DynamicTextItem
{
  ...
  public bjiu(int paramInt, Typeface paramTypeface, @NonNull List<String> paramList, @NonNull List<Bitmap> paramList1)
  {
  ...
  private boolean a(int paramInt1, int paramInt2, int paramInt3, String paramString, Point paramPoint)
  {
    ...
    while (i >= 16)
    {
      this.jdField_a_of_type_AndroidTextTextPaint.setTextSize(actj.a(i, this.jdField_a_of_type_AndroidContentResResources));
      StaticLayout localStaticLayout = bjix.a(paramString, 0, paramString.length(), this.jdField_a_of_type_AndroidTextTextPaint, paramInt1, Layout.Alignment.ALIGN_NORMAL, 1.0F, 0.0F, false, null, 0, 2);
  ...
  public InputFilter a()
  {
    if (this.jdField_a_of_type_AndroidTextInputFilter == null) {
      this.jdField_a_of_type_AndroidTextInputFilter = new bjiv(this, 20);
    }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    while (paramInt < 3)
    {
      ...
      f1 = actj.a(jdField_a_of_type_ArrayOfFloat[(paramInt * 4)], this.jdField_a_of_type_AndroidContentResResources);
      f2 = actj.a(jdField_a_of_type_ArrayOfFloat[(paramInt * 4 + 1)], this.jdField_a_of_type_AndroidContentResResources);
  ...
  public void a(Canvas paramCanvas)
  {
    ...
    {
      float f1 = actj.a(jdField_a_of_type_ArrayOfFloat[(this.jdField_b_of_type_Int * 4 + 2)], this.jdField_a_of_type_AndroidContentResResources);
      float f2 = actj.a(jdField_a_of_type_ArrayOfFloat[(this.jdField_b_of_type_Int * 4 + 3)], this.jdField_a_of_type_AndroidContentResResources);
      float f3 = actj.a(jdField_a_of_type_ArrayOfFloat[(this.jdField_b_of_type_Int * 4)], this.jdField_a_of_type_AndroidContentResResources);
      float f4 = actj.a(jdField_a_of_type_ArrayOfFloat[(this.jdField_b_of_type_Int * 4 + 1)], this.jdField_a_of_type_AndroidContentResResources);
      ...
      this.jdField_a_of_type_Float = actj.a(2.0F, this.jdField_a_of_type_AndroidContentResResources);
