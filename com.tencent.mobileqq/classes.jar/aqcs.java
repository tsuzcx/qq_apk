  ...
  extends aqbc
{
  ...
  public aqcs(Intent paramIntent)
  {
    super(paramIntent);
  ...
  protected View a()
  {
    ...
    localFrameLayout.setMinimumHeight(bbkx.a(85.0F));
    int j = bbkx.a(15.0F);
    ...
    localImageView.setMaxWidth(bbkx.a(120.0F));
    localImageView.setMaxHeight(bbkx.a(120.0F));
  ...
  protected void e()
  {
    ...
    for (Object localObject = AIOEmotionFragment.a; localObject == null; localObject = adug.a) {
      return;
    }
    localObject = ((aobk)localObject).a("fromAIO", false);
    ((URLDrawable)localObject).setBounds(bbdr.a((Drawable)localObject, 36, 100, this.jdField_a_of_type_Float));
    this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
    ((URLDrawable)localObject).setURLDrawableListener(new aqct(this));
  }
