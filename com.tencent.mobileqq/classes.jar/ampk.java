...
public class ampk
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ampk.class.getName();
  }
    ...
    for (;;)
    {
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        ...
        if (BaseApplicationImpl.sProcessId == 12) {
          njd.a(jdField_a_of_type_JavaUtilMap);
        }
      }
      f();
    }
  ...
  private static void f()
  {
    ...
    jdField_a_of_type_JavaUtilMap.put("MultibusidURLSvr.HeadUrlReq", new int[] { 1 });
    jdField_a_of_type_JavaUtilMap.put("OidbSvc.0xedb", new int[] { 1 });
    ...
    jdField_a_of_type_JavaUtilMap.put(ancl.jdField_a_of_type_JavaLangString, new int[] { 20 });
    ...
    jdField_a_of_type_JavaUtilMap.put("OidbSvc.0xebc", new int[] { 20 });
    jdField_a_of_type_JavaUtilMap.put("OidbSvc.0xede_1", new int[] { 20 });
    jdField_a_of_type_JavaUtilMap.put("OidbSvc.0xeb7", new int[] { 20 });
    jdField_a_of_type_JavaUtilMap.put("OidbSvc.0xe2e_1", new int[] { 20 });
    jdField_a_of_type_JavaUtilMap.put("oidbSvc.0xe83", new int[] { 20 });
    jdField_a_of_type_JavaUtilMap.put("OidbSvc.0xeac_1", new int[] { 20 });
    jdField_a_of_type_JavaUtilMap.put("OidbSvc.0xeac_2", new int[] { 20 });
    jdField_a_of_type_JavaUtilMap.put("OidbSvcTcp.0xece_1", new int[] { 20 });
    ...
    jdField_a_of_type_JavaUtilMap.put("OidbSvc.0xeae", new int[] { 127 });
    jdField_a_of_type_JavaUtilMap.put("OidbSvc.0xeaf", new int[] { 127 });
    jdField_a_of_type_JavaUtilMap.put("OidbSvc.0xec9", new int[] { 189 });
    ...
    jdField_a_of_type_JavaUtilMap.put("OidbSvc.0x89a_0", new int[] { 22, 35, 20 });
    ...
    jdField_a_of_type_JavaUtilMap.put("OidbSvc.0xeb8", new int[] { 34 });
    jdField_a_of_type_JavaUtilMap.put("OidbSvc.0xebd", new int[] { 34 });
    jdField_a_of_type_JavaUtilMap.put("OidbSvc.0xec0", new int[] { 34 });
    ...
    jdField_a_of_type_JavaUtilMap.put(andu.jdField_a_of_type_JavaLangString, new int[] { 86 });
    jdField_a_of_type_JavaUtilMap.put(andu.b, new int[] { 86 });
    ...
    jdField_a_of_type_JavaUtilMap.put("OidbSvc.0xc15", new int[] { 137 });
    ...
    jdField_a_of_type_JavaUtilMap.put(vkz.jdField_a_of_type_JavaLangString, new int[] { 98 });
    jdField_a_of_type_JavaUtilMap.put(vkz.c, new int[] { 98 });
    jdField_a_of_type_JavaUtilMap.put(vkz.e, new int[] { 98 });
    jdField_a_of_type_JavaUtilMap.put(vkz.b, new int[] { 98 });
    jdField_a_of_type_JavaUtilMap.put(vkz.d, new int[] { 98 });
    jdField_a_of_type_JavaUtilMap.put(vkz.f, new int[] { 98 });
    jdField_a_of_type_JavaUtilMap.put(vkz.h, new int[] { 98 });
    jdField_a_of_type_JavaUtilMap.put(vkz.i, new int[] { 98 });
    jdField_a_of_type_JavaUtilMap.put(vkz.j, new int[] { 98 });
    jdField_a_of_type_JavaUtilMap.put(vkz.k, new int[] { 98 });
    jdField_a_of_type_JavaUtilMap.put(vkz.l, new int[] { 98 });
    jdField_a_of_type_JavaUtilMap.put(vkz.m, new int[] { 98 });
    ...
    jdField_a_of_type_JavaUtilMap.put("trpc.qqshop.adpush.PushService.GetAd", new int[] { 139 });
    jdField_a_of_type_JavaUtilMap.put("trpc.qqshop.adreport.ReportService.AdReport", new int[] { 139 });
    ...
    jdField_a_of_type_JavaUtilMap.put(vkz.n, new int[] { 98 });
    ...
    jdField_a_of_type_JavaUtilMap.put(bcxv.b, new int[] { 143 });
    jdField_a_of_type_JavaUtilMap.put(bcxv.d, new int[] { 143 });
    jdField_a_of_type_JavaUtilMap.put(bcxv.f, new int[] { 143 });
    jdField_a_of_type_JavaUtilMap.put(bcxv.e, new int[] { 143 });
    jdField_a_of_type_JavaUtilMap.put(bcxv.g, new int[] { 143 });
    jdField_a_of_type_JavaUtilMap.put(bcxv.h, new int[] { 143 });
    jdField_a_of_type_JavaUtilMap.put(bcxv.c, new int[] { 143 });
    ...
    jdField_a_of_type_JavaUtilMap.put("OidbSvc.0xed1_SimpleUI", new int[] { 154 });
    ...
    jdField_a_of_type_JavaUtilMap.put("QQAIOMediaSvc.create_room", new int[] { 156, 165 });
    ...
    jdField_a_of_type_JavaUtilMap.put("QQAIOMediaSvc.VideoWrite", new int[] { 165 });
    ...
    jdField_a_of_type_JavaUtilMap.put("qqvgame.Operation-GetGameLobbyInfo", new int[] { 178 });
    jdField_a_of_type_JavaUtilMap.put("qqvgame.StrangerMatch-AddMatchUser", new int[] { 178 });
    jdField_a_of_type_JavaUtilMap.put("qqvgame.StrangerMatch-DelMatchUser", new int[] { 178 });
    ...
    jdField_a_of_type_JavaUtilMap.put("OidbSvc.oidb_0xeb5", new int[] { 186 });
    jdField_a_of_type_JavaUtilMap.put("OidbSvc.oidb_0xd51", new int[] { 186 });
    jdField_a_of_type_JavaUtilMap.put("OidbSvc.oidb_0x587", new int[] { 186 });
    jdField_a_of_type_JavaUtilMap.put("OidbSvc.0x5eb_42483", new int[] { 190 });
    jdField_a_of_type_JavaUtilMap.put("OidbSvc.0x4ff_42483", new int[] { 190 });
    jdField_a_of_type_JavaUtilMap.put("OidbSvc.0x5eb_42482", new int[] { 128 });
    jdField_a_of_type_JavaUtilMap.put("OidbSvc.0x4ff_42482", new int[] { 128 });
    jdField_a_of_type_JavaUtilMap.put("RedTouchSvc.BatchSetSetting", new int[] { 128 });
    jdField_a_of_type_JavaUtilMap.put("SelfStudyRoomForQQ.17101", new int[] { 185 });
    jdField_a_of_type_JavaUtilMap.put("OidbSvc.0x5eb_troopnotifycation", new int[] { 188 });
    jdField_a_of_type_JavaUtilMap.put("OidbSvc.0x668", new int[] { 188 });
    jdField_a_of_type_JavaUtilMap.put("OidbSvcTcp.0xe89_0", new int[] { 184 });
    jdField_a_of_type_JavaUtilMap.put("OidbSvcTcp.0xe89_1", new int[] { 184 });
    jdField_a_of_type_JavaUtilMap.put("OidbSvcTcp.0xe89_2", new int[] { 184 });
    jdField_a_of_type_JavaUtilMap.put("OidbSvc.0xe95", new int[] { 184 });
    jdField_a_of_type_JavaUtilMap.put("OidbSvc.0xe94", new int[] { 184 });
    jdField_a_of_type_JavaUtilMap.put("OidbSvc.0xed3", new int[] { 193 });
    jdField_a_of_type_JavaUtilMap.put("OidbSvc.0xecc_0", new int[] { 187 });
    jdField_a_of_type_JavaUtilMap.put("OidbSvc.0x5eb_22_common", new int[] { 191 });
    jdField_a_of_type_JavaUtilMap.put("OidbSvc.0x587_74_common", new int[] { 191 });
    jdField_a_of_type_JavaUtilMap.put("QQLive.GetLiveGroupTips", new int[] { 192 });
  }
}
