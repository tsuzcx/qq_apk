...
public class achv
{
  ...
  public void a()
  {
    ...
    new achw(this).execute(new Void[0]);
  }
  ...
  public void a(int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_Long > 0L) && (this.jdField_a_of_type_Int > 0))
    {
      ...
      if ((l > 1000L) || ((l >= 500L) && ("actFPSRecent".equals(this.jdField_a_of_type_JavaLangString))))
      {
        ...
        this.jdField_a_of_type_JavaLangStringBuffer.append(",aioBusiness=").append(bfwz.a());
        ...
        if ((paramInt > 0) && (!"".equals(this.jdField_a_of_type_JavaLangString))) {
          bfwz.a(this.jdField_a_of_type_JavaLangString, paramInt, bfwz.a());
        }
