...
public class bjfa
  extends Handler
{
  bjfa(bjey parambjey, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    paramMessage = bjey.a(BaseApplicationImpl.getApplication(), "qzone_plugin.apk");
    int i;
    ...
    for (;;)
    {
      ...
      bjey.a(this.a, i, bjey.a(this.a), k);
      ...
      {
        if (j != 0) {
          bjuz.a(new CaughtQZonePluginException("start failed. " + paramMessage.getMessage()), localStringBuilder.toString());
        }
        if (i == 0) {
          break;
        }
