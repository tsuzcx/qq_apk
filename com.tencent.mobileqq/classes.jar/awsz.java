...
class awsz
{
  ...
  private awtd jdField_a_of_type_Awtd;
  public String a;
  private Map<String, Integer> jdField_a_of_type_JavaUtilMap = new HashMap();
  private long jdField_b_of_type_Long;
  private awtd jdField_b_of_type_Awtd;
  public String b;
  public String c;
  
  public awsz(awsx paramawsx)
  {
    this.jdField_a_of_type_Awtd = new awtd(awsx.a(paramawsx), awsx.a(paramawsx));
    this.jdField_b_of_type_Awtd = new awtd(awsx.b(paramawsx), awsx.b(paramawsx));
  }
  ...
  public Pair<Boolean, List<awte>> a(PowerManager.WakeLock paramWakeLock, String paramString, long paramLong)
  {
    boolean bool = false;
    ...
    this.jdField_a_of_type_Awtd.a(paramString);
    return new Pair(Boolean.valueOf(bool), this.jdField_b_of_type_Awtd.a(paramString));
  }
