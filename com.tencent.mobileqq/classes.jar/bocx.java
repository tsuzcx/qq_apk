  ...
  extends RecyclerView.ViewHolder
{
  ...
  public bocx(boct paramboct, View paramView)
  {
    super(paramView);
    this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131364649);
    this.jdField_b_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368524));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131377285));
    this.c = paramView.findViewById(2131380646);
    this.d = paramView.findViewById(2131380647);
