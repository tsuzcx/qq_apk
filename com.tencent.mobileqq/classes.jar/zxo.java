...
public class zxo
  extends ajuc
{
  public zxo(AddFriendVerifyActivity paramAddFriendVerifyActivity) {}
  ...
  protected void a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    default: 
      AddFriendVerifyActivity.b(this.a, 1002);
      this.a.jdField_a_of_type_Bbms.dismiss();
      bbmy.a(this.a, 1, 2131652916, 1).b(this.a.getTitleBarHeight());
    case -2: 
      do
      {
        return;
      ...
      ((ajtg)this.a.app.a(20)).b(Long.parseLong(this.a.jdField_a_of_type_JavaLangString), Long.parseLong(this.a.app.getAccount()));
    ...
    case 1: 
      ...
      for (;;)
      {
        try
        {
          ...
          aqrr.a("closeJoinWebView", null, paramString, null);
          return;
        }
    ...
    AddFriendVerifyActivity.b(this.a, 1002);
    this.a.jdField_a_of_type_Bbms.dismiss();
    bbmy.a(this.a, 1, 2131654599, 1).b(this.a.getTitleBarHeight());
  }
  ...
  protected void a(boolean paramBoolean, TroopInfo paramTroopInfo, String paramString)
  {
    if (paramBoolean)
    {
      ...
      if (i == 4) {
        ...
        {
          paramString = aciy.a(new Intent(this.a, SplashActivity.class), null);
  ...
  {
    if (!azzz.a(String.valueOf(paramLong), this.a.jdField_a_of_type_JavaLangString)) {}
    label262:
    do
    {
      do
      ...
      paramTroopInfo = this.a.getString(2131632066, new Object[] { this.a.app.getCurrentNickname() }) + paramTroopInfo;
