...
class yjm
  implements Runnable
{
  yjm(yjl paramyjl, ApolloSurfaceView paramApolloSurfaceView, AVVideoCtrl.VideoFrame paramVideoFrame) {}
  
  public void run()
  {
    String str = CmGameUtil.a().getCurrentAccountUin();
    CmGameOpenIdFinder localCmGameOpenIdFinder = CmGameUtil.a(AVCameraCaptureModel.a(this.jdField_a_of_type_Yjl.a.a));
