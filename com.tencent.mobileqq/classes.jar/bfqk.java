...
public class bfqk
{
  ...
  public bfqk(int paramInt, String paramString1, String paramString2, Object paramObject, Bundle paramBundle)
  {
  ...
  {
    if ((paramObject instanceof bfqk))
    {
      paramObject = (bfqk)paramObject;
      if ((paramObject.jdField_a_of_type_Int == this.jdField_a_of_type_Int) && (bftf.a(this.jdField_a_of_type_JavaLangString, paramObject.jdField_a_of_type_JavaLangString)) && ((3 != this.jdField_a_of_type_Int) || ((bftf.a(this.b, paramObject.b)) && (bftf.a(this.jdField_a_of_type_JavaLangObject, paramObject.jdField_a_of_type_JavaLangObject)) && (bftf.a(this.jdField_a_of_type_AndroidOsBundle, paramObject.jdField_a_of_type_AndroidOsBundle))))) {
        return true;
      }
    }
    return false;
