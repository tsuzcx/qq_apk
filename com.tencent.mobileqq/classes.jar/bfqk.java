...
public class bfqk
{
  ...
  {
    anwd localanwd = (anwd)paramQQAppInterface.a(20);
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      localanwd.e(Long.valueOf(paramString).longValue());
      bftr.a(paramQQAppInterface, paramString, 1102858908);
      ChatActivityUtils.a(paramQQAppInterface, paramString, Integer.valueOf(0));
      return;
    }
    ThreadManager.post(new TroopAioNotifyManager.1(paramQQAppInterface, paramString, localanwd), 8, null, true);
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface, List<TroopAIONotifyItem> paramList)
  {
    ...
    //   21: return
    //   22: aload_0
    //   23: invokevirtual 21	com/tencent/mobileqq/app/QQAppInterface:a	()Lcom/tencent/mobileqq/data/QQEntityManagerFactory;
    //   26: invokevirtual 27	com/tencent/mobileqq/data/QQEntityManagerFactory:createEntityManager	()Lcom/tencent/mobileqq/persistence/EntityManager;
    //   29: astore_0
    //   30: iconst_0
    //   31: istore_2
    //   32: iload_2
    ...
    //   45: checkcast 242	com/tencent/mobileqq/persistence/Entity
    //   48: invokevirtual 244	com/tencent/mobileqq/persistence/EntityManager:remove	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   51: pop
    //   52: iload_2
    //   53: iconst_1
    //   54: iadd
    ...
    //   56: goto -24 -> 32
    //   59: aload_0
    //   60: invokevirtual 42	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   63: invokestatic 48	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   66: ifeq -48 -> 18
    //   69: ldc 59
    //   71: iconst_2
    //   72: new 50	java/lang/StringBuilder
    //   75: dup
    //   76: invokespecial 51	java/lang/StringBuilder:<init>	()V
    //   79: ldc 246
    //   81: invokevirtual 57	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   84: iload_3
    //   85: invokevirtual 62	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   88: invokevirtual 66	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   91: invokestatic 70	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   94: goto -76 -> 18
    //   97: astore_0
    ...
    //   110: dup
    //   111: invokespecial 51	java/lang/StringBuilder:<init>	()V
    //   114: ldc 248
    //   116: invokevirtual 57	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   119: aload_0
    //   120: invokevirtual 79	java/lang/Exception:toString	()Ljava/lang/String;
    ...
    //   129: invokestatic 82	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   132: goto -114 -> 18
    //   135: astore_0
    //   136: ldc 2
    //   138: monitorexit
