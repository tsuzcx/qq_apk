  ...
  implements Manager, BusinessObserver
{
  ...
  public bmyi(QQAppInterface paramQQAppInterface)
  {
  ...
  public ArrayList<QZoneMsgEntityNew> a()
  {
    ...
    //   13: aload_0
    //   14: getfield 101	bmyi:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   17: ifnull +8 -> 25
    //   20: aload_0
    //   21: getfield 101	bmyi:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   24: areturn
    //   25: aload_0
    //   26: invokevirtual 103	bmyi:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   29: astore_2
    //   30: aload_2
    //   31: ifnonnull +12 -> 43
    //   34: ldc 71
    ...
    //   75: putfield 101	bmyi:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   78: aload_3
    //   79: ifnull +68 -> 147
    //   82: aload_3
    ...
    //   130: aload_0
    //   131: getfield 101	bmyi:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   134: aload 4
    ...
    //   155: aload_0
    //   156: getfield 101	bmyi:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   159: areturn
    //   160: astore_3
    //   161: aconst_null
    //   162: astore_2
  ...
  public void a()
  {
    ...
    return;
    bmyq localbmyq = new bmyq(localQQAppInterface.getLongAccountUin(), "", a(0), 1);
    localbmyq.a(0);
    QzoneCommonIntent localQzoneCommonIntent = new QzoneCommonIntent(localQQAppInterface.getApplication(), arxx.class);
  ...
  public void a(MQLikeCell paramMQLikeCell, long paramLong)
  {
    ...
    {
      i = 0;
      localObject1 = new bmyp(Long.valueOf(l), (String)localObject1, (String)localObject2, i, paramMQLikeCell.appid);
      ((bmyp)localObject1).a(100);
      localObject2 = new QzoneCommonIntent(localQQAppInterface.getApplication(), arxx.class);
    ...
    do
    {
      ...
      if ((localObject1 instanceof QzoneMessageBoxRsp))
      {
        ...
        if (localObject1 != null)
        {
          ...
          localQQAppInterface.notifyObservers(bmyj.class, paramInt, true, paramBundle);
          a((QZoneMsgEntityNew)localObject1, paramInt);
          return;
        }
        localQQAppInterface.notifyObservers(bmyj.class, paramInt, false, paramBundle);
