...
{
  public static ConcurrentHashMap<Long, ahtt> a;
  private static vni jdField_a_of_type_Vni;
  private int jdField_a_of_type_Int;
  private ahtw jdField_a_of_type_Ahtw = new ahtv(this);
  ...
  public ahtt(Context paramContext, String paramString, boolean paramBoolean, ahtz paramahtz)
  {
    this(paramContext, paramString, paramBoolean, paramahtz, false);
  }
  
  public ahtt(Context paramContext, String paramString, boolean paramBoolean1, ahtz paramahtz, boolean paramBoolean2)
  {
    ...
    if (paramahtz != null) {
      this.jdField_b_of_type_JavaLangString = paramahtz.jdField_a_of_type_JavaLangString;
    }
    this.jdField_d_of_type_Boolean = paramBoolean2;
  }
  
  public ahtt(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, boolean paramBoolean, ahtz paramahtz, MessageForShortVideo paramMessageForShortVideo)
  {
    this(paramContext, paramString, paramBoolean, paramahtz, false);
  ...
  public static void a(long paramLong, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        awrn.a(BaseApplicationImpl.getContext()).a(null, str, true, paramLong, 0L, localHashMap, "");
        return;
        if (paramInt1 == 2)
        {
  ...
  private static void b(String paramString, PublishVideoEntry paramPublishVideoEntry, ahtw paramahtw)
  {
    String str = ShortVideoUtils.b(new File(paramPublishVideoEntry.mLocalRawVideoDir));
    if (jdField_a_of_type_Vni == null) {
      jdField_a_of_type_Vni = vni.a(BaseApplicationImpl.getApplication());
    }
    ...
    try
    {
      ahua localahua = new ahua(paramPublishVideoEntry, paramString, str, paramahtw);
      jdField_a_of_type_Vni.a(str);
      jdField_a_of_type_Vni.a(paramPublishVideoEntry.doodlePath, paramString, str, paramPublishVideoEntry.videoWidth, paramPublishVideoEntry.videoHeight, localahua);
      return;
    }
  ...
  protected Integer a()
  {
    ...
    PublishVideoEntry localPublishVideoEntry = sjj.a(this.jdField_a_of_type_JavaLangString);
    ...
    if (TextUtils.isEmpty(localPublishVideoEntry.mLocalRawVideoDir))
    {
      ...
      avan.a(new RuntimeException("onMediaCodecEncode failed"));
      return Integer.valueOf(-62);
    }
    String str = ShortVideoUtils.b(new File(localPublishVideoEntry.mLocalRawVideoDir).getParentFile());
    new sjj().a(localPublishVideoEntry, str, false, true, new ahtu(this, localPublishVideoEntry, str, l));
  ...
  public void a(int paramInt, PublishVideoEntry paramPublishVideoEntry, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      {
        urp.a("AIOMergeVideoSuc", bool, 0L, new String[] { str });
        if (paramInt == 0) {
          break label107;
        }
        urp.a("AIOMergeVideoError", true, 0L, new String[] { String.valueOf(paramInt) });
        return;
        bool = false;
        break;
      }
      ...
      {
        if ((!bhnt.jdField_c_of_type_Boolean) || (paramInt != 0) || (!bhnt.g.a())) {
          break label339;
        }
        long l1 = bhnt.g.a[0];
        long l2 = bhnt.g.a[1];
        ...
        if ((urp.a(paramLong, 0L, 120000L)) && (urp.a(l1, 0L, 120000L)) && (urp.a(l2, 0L, 120000L)) && (urp.a(l3, 0L, 10000L)) && (urp.a(l4, 0L, 120000L)) && (urp.a(l5, 0L, 120000L))) {
          urp.a("AIOMergeVideoCost", true, paramLong, new String[] { String.valueOf(l1), String.valueOf(l2), String.valueOf(l3), String.valueOf(l4), String.valueOf(l5) });
        }
        bhnt.g.c();
        return;
  ...
  protected void a(Integer paramInteger)
  {
    ...
    {
      localawrn.a(null, "actMediaCodecEncodeSuccessRate", bool, 0L, 0L, localHashMap, "");
      if (paramInteger.intValue() != 0)
      {
        if (QLog.isColorLevel()) {
          QLog.d("EncodeVideoTask", 2, "onPostExecute result:" + paramInteger);
        }
        this.jdField_a_of_type_Ahty.a(paramInteger.intValue());
      }
      return;
    }
  }
  ...
  protected Integer b(Void... paramVarArgs)
  {
    ...
    {
      this.jdField_a_of_type_Ahtw.a(-61, null, null, null, 0L);
      return Integer.valueOf(-61);
    }
    long l = SystemClock.uptimeMillis();
    int i = zrr.a().a(0, 1, 1, Process.myTid(), 8000, 603, 1L, Process.myTid(), "video", true);
    int j = a().intValue();
    if (j != 0) {
      this.jdField_a_of_type_Ahtw.a(j, null, null, null, 0L);
    }
    if (i != 0) {
      zrr.a().a(i);
    }
  ...
  protected Integer c(Void... paramVarArgs)
  {
    ...
    awje.y = (int)localPublishVideoEntry.recordTime;
    awje.z = localPublishVideoEntry.recordFrames;
    if (localPublishVideoEntry.saveMode != 0) {
      awje.J = localPublishVideoEntry.saveMode;
    }
    int i;
    label131:
    int j;
    ...
    for (;;)
    {
      try
      {
        ...
        localObject2 = new ahtx(localPublishVideoEntry, paramVarArgs, (String)localObject1);
        ((ahtx)localObject2).a(this.jdField_a_of_type_Ahtw);
        vnr.b(this.jdField_a_of_type_AndroidContentContext, paramVarArgs, localPublishVideoEntry.backgroundMusicPath, localPublishVideoEntry.backgroundMusicOffset, (int)l, (String)localObject1, (vnh)localObject2);
        return Integer.valueOf(0);
        i = 1;
        break;
        label385:
      ...
      label415:
      this.jdField_a_of_type_Ahtw.a(localPublishVideoEntry, paramVarArgs);
    }
  }
}
