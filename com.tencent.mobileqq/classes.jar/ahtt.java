  ...
  implements ahts
{
  ...
  public static ahts a(IBinder paramIBinder)
  {
    ...
    if ((localIInterface != null) && ((localIInterface instanceof ahts))) {
      return (ahts)localIInterface;
    }
    return new ahtu(paramIBinder);
  }
