...
{
  public nys(ReadInJoyNativeAdFragment paramReadInJoyNativeAdFragment) {}
  ...
  public void onPageSelected(int paramInt)
  {
    ...
    ((nyy)ReadInJoyNativeAdFragment.a(this.a).get(paramInt)).a();
    if (paramInt + 1 < ReadInJoyNativeAdFragment.a(this.a).size()) {
      ((nyy)ReadInJoyNativeAdFragment.a(this.a).get(paramInt + 1)).b();
    }
