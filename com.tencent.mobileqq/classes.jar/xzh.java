...
class xzh
  implements Runnable
{
  xzh(xzf paramxzf, PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo, int paramInt) {}
  
  public void run()
  {
    int j = this.jdField_a_of_type_Xzf.a.jdField_a_of_type_ComTencentWidgetHorizontalListView.getFirstVisiblePosition();
    int k = this.jdField_a_of_type_Xzf.a.jdField_a_of_type_ComTencentWidgetHorizontalListView.getLastVisiblePosition();
    int i = j;
    Object localObject;
    if (i <= k)
    {
      ...
      localObject = this.jdField_a_of_type_Xzf.a.jdField_a_of_type_ComTencentWidgetHorizontalListView.getChildAt(i - j);
