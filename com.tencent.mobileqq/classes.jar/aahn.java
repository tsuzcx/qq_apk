...
{
  public aahn(AddFriendVerifyActivity paramAddFriendVerifyActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if (TextUtils.isEmpty(paramView))
    {
      if (!this.a.isFinishing())
      {
        ...
        paramView.jdField_a_of_type_AndroidWidgetTextView.setText(ajya.a(2131699853));
        paramView.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130845303);
        paramView.a();
      }
      return;
    }
