...
class abgk
  extends Handler
{
  abgk(abgj paramabgj, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    if ((paramMessage.what == 203) && ((paramMessage.obj instanceof Bundle)))
    {
      ...
      if ((paramMessage.getInt("req_state", 0) == 2) && (!TextUtils.isEmpty(abgj.a(this.a))) && (!TextUtils.isEmpty(abgj.b(this.a))) && (abgj.b(this.a).equals(localObject)))
      {
    ...
    try
    {
      ...
      {
        label113:
        this.a.callJs(abgj.a(this.a) + "(" + ((JSONObject)localObject).toString() + ");");
        return;
        label158:
