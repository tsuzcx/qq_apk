  ...
  extends ayev
{
  protected void e(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    {
      int i = bcsq.a().decrementAndGet();
      bcsq.a(0);
      AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
      localAppRuntime.getPreferences().edit().putInt(localAppRuntime.getAccount() + "_" + "qzone_xp_req_left", i).apply();
      bcsq.b(((mobile_get_qzone_public_msg_rsp)paramBundle).next_req_tmstamp);
      if (QLog.isColorLevel()) {
        QLog.i("QZoneReport", 2, "next req time: " + bcsq.b() + ", left: " + i);
      }
      bcst.b(null, "CliOper", "", "", "0X800915D", "0X800915D", 0, 0, "", "", "", "");
    }
    for (;;)
    {
      bcsq.a().set(false);
      BaseApplicationImpl.getApplication().getRuntime().unRegistObserver(bcsq.a());
      return;
      bcsq.c();
      if (QLog.isColorLevel()) {
