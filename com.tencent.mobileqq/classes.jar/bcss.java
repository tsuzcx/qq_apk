class bcss
{
  private static bcss jdField_a_of_type_Bcss;
  private static bcss jdField_b_of_type_Bcss;
  ...
  public static bcss a(int paramInt)
  {
    if (paramInt == 0)
    {
      if (jdField_a_of_type_Bcss == null) {
        jdField_a_of_type_Bcss = new bcss(0);
      }
      return jdField_a_of_type_Bcss;
    }
    if (jdField_b_of_type_Bcss == null) {
      jdField_b_of_type_Bcss = new bcss(1);
    }
    return jdField_b_of_type_Bcss;
  }
