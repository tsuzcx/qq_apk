...
public class tpz
{
  ...
  public static boolean a(Context paramContext)
  {
    ...
    for (int j = 1;; j = 0)
    {
      if ((i == 0) || (j == 0) || (!bhnv.g(paramContext))) {
        break label45;
      }
      return true;
      i = 0;
  ...
  public static boolean a(AdvertisementInfo paramAdvertisementInfo, ProteusBannerVideoItemData paramProteusBannerVideoItemData, Context paramContext, int paramInt)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        paramAdvertisementInfo = ozs.d();
        if (QLog.isColorLevel()) {
          QLog.d("ReadInJoyAdSwitchUtil", 2, " isADVideoAutoPlayFlag adFlag = " + paramInt + " kandianVideoAutoPlaySetting = " + paramAdvertisementInfo);
        }
        if (ozs.e.equals(paramAdvertisementInfo)) {
          break;
        }
        if (!ozs.c.equals(paramAdvertisementInfo)) {
          break label184;
        }
        if (paramInt == 0) {
          break;
        }
        if ((paramInt != 1) || (paramContext == null) || ((!rmn.a(paramContext)) && (!a(paramContext)))) {
          break label166;
        }
        return true;
        if (paramInt == 2)
      ...
      if ((paramInt == 2) && (paramContext != null) && (bhnv.g(paramContext))) {
        return true;
      }
    } while ((!ozs.d.equals(paramAdvertisementInfo)) || (paramInt == 0));
    if ((paramInt == 1) && (paramContext != null) && ((rmn.a(paramContext)) || (a(paramContext)))) {
      return true;
    }
    if ((paramInt == 2) && (paramContext != null) && (rmn.a(paramContext))) {}
    for (boolean bool = true;; bool = false) {
      return bool;
    }
  }
  ...
  public static boolean d(VideoAdInfo paramVideoAdInfo)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      tpx.a("isADVideoDownloadProgress", bool);
      if (i != 1) {
        break;
      }
      return true;
