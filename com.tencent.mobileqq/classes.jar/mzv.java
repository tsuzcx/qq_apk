  ...
  implements axay
{
  ...
  public ReqItem a(int paramInt)
  {
    ...
    BnrReport.BNRConfigMsg localBNRConfigMsg = mzu.a(this.a.getCurrentAccountUin());
    if (localBNRConfigMsg != null) {
      localReqItem.vecParam = bbma.a(localBNRConfigMsg.toByteArray());
    }
    mzu.a = true;
    return localReqItem;
  }
  ...
  public void a(RespItem paramRespItem)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        mzu.a((BnrReport.BNReportConfigRsp)localBNRConfigMsg.msg_rsp_body.get());
        mzu.a(this.a, 74);
        mzu.a = false;
        return;
      }
