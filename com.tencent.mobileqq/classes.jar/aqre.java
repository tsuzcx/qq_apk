...
{
  aqre(aqrd paramaqrd, String paramString, long paramLong, boolean paramBoolean) {}
  
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    Object localObject = null;
    if (QLog.isColorLevel()) {
      QLog.d("UniformDownloadMgr<FileAssistant>", 2, "handleCheck, success: " + paramBoolean + ", canceled: " + aqrd.a(this.jdField_a_of_type_Aqrd));
    }
    Activity localActivity = (Activity)aqrd.a(this.jdField_a_of_type_Aqrd).get();
    if ((aqrd.a(this.jdField_a_of_type_Aqrd)) || (localActivity == null) || (localActivity.isFinishing())) {
      return;
    }
    ...
    for (;;)
    {
      ...
      catch (InvalidProtocolBufferMicroException paramBundle)
      {
        ...
        continue;
        this.jdField_a_of_type_Aqrd.a.sendEmptyMessage(2);
      }
      adky.a(localActivity, localIntent, PublicFragmentActivity.class, ApkFileDownloadFragment.class);
