...
public class ajuh
{
  public static Comparator<auko> a = new ajui();
  ...
  public static ArrayList<auko> a(ArrayList<auko> paramArrayList, auko paramauko)
  {
    ...
    {
      paramArrayList.add(paramauko);
      return paramArrayList;
    }
    Groups localGroups1 = (Groups)paramauko;
    int j = 0;
    ...
    paramArrayList.add(i + 1, paramauko);
    return paramArrayList;
  }
