...
public class ldh
{
  ...
  anvi jdField_a_of_type_Anvi = new ldi(this);
  anyz jdField_a_of_type_Anyz = new ldj(this);
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = null;
  public HashMap<String, ldk> a;
  ...
  public ldh(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(String paramString, int paramInt)
  {
    ...
    ((ldk)this.jdField_a_of_type_JavaUtilHashMap.get(paramString)).b = paramInt;
  }
  ...
  private void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    ((ldk)this.jdField_a_of_type_JavaUtilHashMap.get(paramString)).b = paramInt1;
    ((ldk)this.jdField_a_of_type_JavaUtilHashMap.get(paramString)).b = paramInt2;
  }
  ...
  private void d(String paramString)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.FRIENDLIST_HANDLER) != null) {
      ((FriendListHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.FRIENDLIST_HANDLER)).getUserAddFriendSetting(paramString, this.jdField_a_of_type_Int, 0, "");
    }
  }
  ...
  public int a(String paramString)
  {
    ...
    return ((ldk)this.jdField_a_of_type_JavaUtilHashMap.get(paramString)).b;
  }
  ...
  public boolean a(String paramString, int paramInt)
  {
    ...
    if (((anvk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER)).b(paramString))
    {
      localldk = new ldk(this);
      this.jdField_a_of_type_JavaUtilHashMap.put(paramString, localldk);
      a(paramString, 4);
      a(paramString);
      return true;
    }
    ...
    ldk localldk = new ldk(this);
    this.jdField_a_of_type_JavaUtilHashMap.put(paramString, localldk);
    ((FriendListHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.FRIENDLIST_HANDLER)).queryUinSafetyFlag("OidbSvc.0x476_147", Long.parseLong(paramString), 147);
    return true;
  }
