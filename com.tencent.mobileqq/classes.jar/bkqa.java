  ...
  implements axmg, bncv
{
  ...
  private bkle jdField_a_of_type_Bkle = (bkle)this.jdField_a_of_type_Blbm.a(65537, new Object[0]);
  private bkph jdField_a_of_type_Bkph;
  private bkpt jdField_a_of_type_Bkpt = new bkpw();
  ...
  private AtomicReference<axmg> jdField_a_of_type_JavaUtilConcurrentAtomicAtomicReference = new AtomicReference();
  ...
  public bkqa(Activity paramActivity, View paramView, blbm paramblbm)
  {
  ...
  private void a(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      this.jdField_b_of_type_AndroidWidgetTextView.setText(alpo.a(2131716797) + paramString + alpo.a(2131716796));
    ...
    for (;;)
    {
      ...
      localAlphaAnimation1.setAnimationListener(new bkqi(this, localAlphaAnimation2));
      localAlphaAnimation2.setAnimationListener(new bkqc(this));
      return;
      label423:
      paramString = null;
    }
  ...
  private void a(AEMaterialPanel paramAEMaterialPanel)
  {
    ...
    {
      int i = xod.c(localActivity);
      this.jdField_b_of_type_AndroidViewView.post(new VideoStoryAIScenePart.18(this, paramAEMaterialPanel, i));
    }
  }
  
  private void a(AtomicReference<axmg> paramAtomicReference, AEFilterManager paramAEFilterManager)
  {
    if (paramAtomicReference.get() == null) {
      awen.a("Q.videostory", "Q.videostory.capture", "requestAIScene()", "sceneCallback is null");
    }
    do
    {
      do
      {
        do
        {
          do
          {
            ...
            ((axmg)paramAtomicReference.get()).a("mQQFilterRenderManager is null");
            return;
            awen.a("Q.videostory", "Q.videostory.capture", "requestAIScene()", "start");
        ...
        if (localObject2 != null)
        {
          ...
          while (((Iterator)localObject2).hasNext())
          {
            ...
            localObject3 = new bkpu();
            ((bkpu)localObject3).jdField_b_of_type_Int = ((int)(f3 - f4));
            ((bkpu)localObject3).jdField_a_of_type_Int = ((int)(f1 - f2));
        ...
        try
        {
          ...
          this.jdField_a_of_type_Bkpt.a((Bitmap)localObject2, (ArrayList)localObject1, new bkqd(this, paramAtomicReference));
          return;
        }
        catch (Exception paramAEFilterManager) {}
      } while ((axmg)paramAtomicReference.get() == null);
      ((axmg)paramAtomicReference.get()).a(paramAEFilterManager.toString());
      return;
    } while ((axmg)paramAtomicReference.get() == null);
    ((axmg)paramAtomicReference.get()).a("no bitmap");
  }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      yvu.a("mystatus_shoot", "cam_reverse", 0, 0, new String[0]);
      return;
      label66:
      if (!paramBoolean) {
  ...
  private void k()
  {
    ...
    for (;;)
    {
      ...
      localMarginLayoutParams.bottomMargin -= azgq.a(i);
      ...
      for (;;)
      {
        ...
        if (bkwm.i(this.jdField_a_of_type_AndroidAppActivity.getIntent()))
        {
          ...
          if (f2 < 1.78D) {}
          for (i = -20;; i = -bmtu.a(this.jdField_a_of_type_AndroidAppActivity, f1 / 2.0F))
          {
            break;
            if (f2 < 1.78D) {
              break label236;
  ...
  private void l()
  {
    ((bklp)bklq.a(this.jdField_a_of_type_Bkle).a(bklp.class)).b.a(this.jdField_a_of_type_Bkle, new bkqf(this));
    ((blbj)bklq.a(this.jdField_a_of_type_Bkle).a(blbj.class)).a.a(this.jdField_a_of_type_Bkle, new bkqg(this));
  }
  
  private void m()
  {
    if (blev.a().a("ai_guide_shown", false, 0)) {}
  ...
  private void o()
  {
    if ((this.jdField_a_of_type_Bkle.a() != null) && (bkwm.i(this.jdField_a_of_type_Bkle.a().getIntent())))
    {
  ...
  protected void a()
  {
    ...
    a(this);
    this.jdField_a_of_type_DovComQqImAeCameraCoreAECameraGLSurfaceView.setSceneListener(new bkqb(this));
    this.jdField_a_of_type_AndroidOsHandler = new bkqe(this, Looper.getMainLooper());
    k();
  }
  ...
  public void a(int paramInt, QIMFilterCategoryItem paramQIMFilterCategoryItem)
  {
    ...
    if (paramQIMFilterCategoryItem != null)
    {
      ...
      awen.a("Q.videostory", "Q.videostory.capture", "onFilterSelect", str);
      if (paramInt != 0) {
        a(null);
      }
    ...
    for (;;)
    {
      ...
      yvu.a("mystatus_shoot", "filter_change", 0, 0, new String[0]);
      return;
      str = "no filter";
      break;
      label102:
  ...
  public void a(int paramInt, String paramString, boolean paramBoolean)
  {
    if ((this.jdField_a_of_type_AndroidWidgetTextView != null) && (this.jdField_a_of_type_AndroidWidgetTextView.getVisibility() == 0) && (!this.jdField_a_of_type_Boolean) && (!this.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()))
    {
      ...
      localAnimationSet.setAnimationListener(new bkqh(this, paramBoolean, paramInt, paramString));
    }
  }
  ...
  public void a(axmg paramaxmg)
  {
    this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicReference.set(paramaxmg);
  }
  ...
  public void a(bkpz parambkpz)
  {
    ...
    if ((parambkpz.jdField_a_of_type_Int == -1) || ((this.jdField_a_of_type_Bkle != null) && (!this.jdField_a_of_type_Bkle.b())))
    {
      e();
      return;
    }
    Object localObject2 = parambkpz.b;
    Object localObject1 = bncp.a().c(0);
    Bundle localBundle;
    blnl localblnl;
    if (localObject1 != null)
    {
      ...
      awen.a("Q.videostory", "Q.videostory.capture", "onAISceneSuccess", (String)localObject2 + " " + (String)localObject1);
      localBundle = new Bundle();
      localBundle.putInt("apply_source", blnl.jdField_a_of_type_Int);
      ...
      parambkpz = new ArrayList();
      e();
    }
    for (;;)
    {
      awen.a("Q.videostory", "Q.videostory.capture", "onAISceneSuccess", "filterLister is empty:" + parambkpz.size());
      return;
      localObject1 = "";
      break;
      label243:
      localObject1 = localblnl.a().c;
      ...
      while (((Iterator)localObject3).hasNext())
      {
        ...
        if (localQIMFilterCategoryItem.b.equals(localObject2))
        {
          ...
          ((Bundle)localObject3).putString("sceneName", parambkpz.jdField_a_of_type_JavaLangString);
          ((Bundle)localObject3).putInt("sceneLvOne", parambkpz.jdField_a_of_type_Int);
          ...
          for (;;)
          {
            ...
            this.jdField_a_of_type_AndroidViewView.postDelayed(new VideoStoryAIScenePart.13(this, localQIMFilterCategoryItem, localblnl, localBundle), 500L);
            parambkpz = (bkpz)localObject1;
            break;
          }
          label419:
          e();
  ...
  public void a(String paramString)
  {
    ...
    awen.a("Q.videostory", "Q.videostory.capture", "onAISceneFail", paramString);
  }
  ...
  public void d()
  {
    this.jdField_a_of_type_AndroidWidgetTextView.setText(alpo.a(2131716777));
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    a();
    if (this.jdField_a_of_type_AndroidViewAnimationAnimationSet != null) {
