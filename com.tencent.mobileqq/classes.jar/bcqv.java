  ...
  extends Dialog
{
  ...
  public bcqv(Context paramContext, Intent paramIntent)
  {
    super(paramContext, 2131755794);
    String str2 = paramIntent.getStringExtra("qzone_plugin_activity_name");
    Object localObject1 = LayoutInflater.from(paramContext).inflate(2131562086, null);
    Object localObject2 = getWindow();
    ((Window)localObject2).setWindowAnimations(2131755789);
    ...
    this.a = ((TextView)((View)localObject1).findViewById(2131370457));
    localObject2 = paramIntent.getStringExtra("leftViewText");
    if (localObject2 == null) {
      localObject2 = paramContext.getString(2131690572);
    }
    for (;;)
    {
      if ("com.qzone.album.business.albumlist.activity.QZonePersonalAlbumActivity".equals(str2))
      {
        localObject3 = ((ViewStub)((View)localObject1).findViewById(2131376788)).inflate();
        localObject1 = paramIntent.getStringExtra("key_left_tab_title");
        if (!TextUtils.isEmpty((CharSequence)localObject1)) {
          break label917;
        }
        localObject1 = paramContext.getString(2131717655);
      }
      label917:
      for (;;)
      {
        ...
        for (paramContext = paramContext.getString(2131717736);; paramContext = paramIntent)
        {
          paramIntent = (ExtendButton)((View)localObject3).findViewById(2131363481);
          Object localObject4 = (ExtendButton)((View)localObject3).findViewById(2131363482);
          ...
          ((TextView)paramContext.findViewById(2131368429)).setText((CharSequence)localObject2);
          ((ProgressBar)((ViewStub)paramContext.findViewById(2131368486)).inflate()).setVisibility(0);
          return;
          localObject4 = ((ViewStub)((View)localObject1).findViewById(2131364529)).inflate();
          TextView localTextView = (TextView)((ViewStub)((View)localObject4).findViewById(2131368472)).inflate();
          String str1 = "";
          long l;
          if ("com.qzone.homepage.ui.activity.QZoneUserHomeActivity".equals(str2))
          {
            ...
            {
              localObject1 = ajya.a(2131712211);
          ...
          for (;;)
          {
            ...
            {
              localObject1 = paramContext.getString(2131717881);
              localObject3 = paramContext.getString(2131717804);
            }
            else if ("com.qzone.cover.ui.activity.QzoneCoverPhotoWallActivity".equals(str2))
            {
              localObject1 = paramContext.getString(2131717778);
              localObject3 = localObject2;
            }
            else if ("com.qzone.cover.ui.activity.QZoneCoverStoreActivity".equals(str2))
            {
              localObject1 = paramContext.getString(2131717779);
              localObject3 = localObject2;
            }
            else if ("com.qzone.detail.ui.activity.QzoneDetailActivity".equals(str2))
            {
              ...
              {
                localObject3 = paramContext.getString(2131699451);
                localObject1 = str1;
              }
            }
            else if ("com.qzone.publish.ui.activity.QZoneUploadPhotoRealActivity".equals(str2))
            {
              str1 = paramContext.getString(2131718259);
              ...
              if (!TextUtils.isEmpty(paramIntent))
              {
                ...
                for (;;)
                {
                  ...
                  case 8: 
                  case 11: 
                    localObject1 = paramContext.getString(2131718171);
                    localObject3 = localObject2;
                    break;
            ...
            {
              localObject1 = paramContext.getString(2131718198);
              localObject3 = localObject2;
            }
            else if ("com.qzone.setting.QZoneSettingManager".equals(str2))
            {
              localObject1 = paramContext.getString(2131718207);
              localObject3 = localObject2;
            }
            else if ("com.qzone.album.business.photolist.activity.QZonePersonalPhotoListActivity".equals(str2))
            {
              ...
              {
                localObject1 = paramIntent + ajya.a(2131712210);
                localObject3 = localObject2;
              }
              else
              {
            ...
            {
              localObject1 = paramContext.getString(2131718123);
              localObject3 = localObject2;
            }
            else
            {
              ...
              {
                localObject1 = paramContext.getString(2131718012);
                localObject3 = localObject2;
              }
            }
          }
  ...
  public void setOnDismissListener(@Nullable DialogInterface.OnDismissListener paramOnDismissListener)
  {
    ...
    super.setOnDismissListener(new bcqw(paramOnDismissListener));
  }
}
