...
{
  avpr(int paramInt, AtomicBoolean paramAtomicBoolean, String paramString1, String paramString2, String paramString3, long paramLong, avpt paramavpt) {}
  ...
  public void onFailed(int paramInt, String paramString1, String paramString2)
  {
    ...
    avpp.a(101810106, this.jdField_a_of_type_JavaLangString, this.b, this.c, this.jdField_a_of_type_Long, (String)localObject, this.jdField_a_of_type_Avpt);
  ...
  public void onSuccess(LiveStyleRequester.YTLiveStyleReq paramYTLiveStyleReq, LiveStyleResponse paramLiveStyleResponse)
  {
    ...
    avpp.a(this.jdField_a_of_type_Int, this.jdField_a_of_type_JavaLangString, this.b, this.c, this.jdField_a_of_type_Long, paramYTLiveStyleReq, this.jdField_a_of_type_Avpt);
