  ...
  extends avoj
{
  ...
  public avpr(QQAppInterface paramQQAppInterface, PublicAccountInfo paramPublicAccountInfo, int paramInt)
  {
  ...
  protected long a(String paramString)
  {
    ...
    long l2 = avwf.b(paramString, this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.name, 1073741824L);
    long l1 = l2;
  ...
  public void a(View paramView)
  {
    ...
    do
    {
      ...
      {
        avwf.a("all_result", "clk_public_uin", new String[] { "" + this.jdField_a_of_type_JavaLangString });
        avsv.a(null, 0, this.c, "0X8009D51", 0, 0, this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.getUin(), null);
      }
      str = this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.getUin();
      badx.a(null, "pubAcc_aio_open", str);
      localObject1 = (ajoy)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(56);
      if (!ajed.aO.equals(str)) {
        break;
      }
      rww.a((Context)localObject2, "from_search_result", 1, true);
      avwf.a(this.jdField_a_of_type_JavaLangString, 50, 0, paramView, str, this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.isOffLine, this.c);
      ajrs.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString);
      avwf.a(this.jdField_a_of_type_JavaLangString, 50, paramView, false);
    ...
    if ((localObject2 instanceof UniteSearchActivity))
    {
      ...
      awqx.b((QQAppInterface)localObject2, "CliOper", "", "", (String)localObject1, (String)localObject1, 0, 1, 0, this.jdField_a_of_type_Int + "", "", str, this.jdField_a_of_type_JavaLangString);
      label285:
      paramView = ndo.a();
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (((localObject1 != null) && (((ajoy)localObject1).a(Long.valueOf(str)))) || ((localObject1 == null) && (rtr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str))))
      {
        ...
        localIntent.putExtra("selfSet_leftViewText", ((Context)localObject2).getString(2131625011));
        ahcq.a = true;
        ahcq.a(localIntent);
        ...
        ((ajoy)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo);
        break label133;
      }
      if (TextUtils.isEmpty(str))
      {
      ...
      break label214;
      break;
      ndn.a((QQAppInterface)localObject2, "P_CliOper", "Pb_account_lifeservice", str, paramView, paramView, 0, 0, this.jdField_a_of_type_Int + "", "", this.jdField_a_of_type_JavaLangString, "", false);
      break label285;
    }
  }
  ...
  {
    SpannableString localSpannableString = new avvu(new ArrayList(), a()).a(avwf.a(this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.summary));
