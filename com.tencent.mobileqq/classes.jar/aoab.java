...
class aoab
  implements Runnable
{
  aoab(aoaa paramaoaa, String paramString) {}
  
  public void run()
  {
    try
    {
      EditPicSave.a(this.jdField_a_of_type_Aoaa.a, PlusPanelUtils.a());
      File localFile = new File(EditPicSave.a(this.jdField_a_of_type_Aoaa.a));
      if (FileUtils.a(new File(this.jdField_a_of_type_JavaLangString), localFile)) {
        ImageUtil.a(this.jdField_a_of_type_Aoaa.a.a.getActivity(), localFile);
      }
      return;
    }
