  ...
  extends BusinessHandler
{
  ...
  private anyz jdField_a_of_type_Anyz = new aoac(this);
  private aocp jdField_a_of_type_Aocp = new aoad(this);
  private Timer jdField_a_of_type_JavaUtilTimer;
  private boolean jdField_a_of_type_Boolean;
  
  public aoab(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.app.addObserver(this.jdField_a_of_type_Anyz);
    this.app.addObserver(this.jdField_a_of_type_Aocp);
    a();
  }
  ...
  private ToServiceMsg a(boolean paramBoolean, long paramLong1, String paramString, int paramInt1, int paramInt2, int paramInt3, byte[] paramArrayOfByte, long paramLong2)
  {
    ...
    paramString = bcrx.a(this.app, 13, paramString, localbcsf, paramLong2, bcsc.b(paramLong1));
  ...
  public void a()
  {
    Object localObject1 = (aocn)this.app.getBusinessHandler(BusinessHandlerFactory.REGPRXYSVCPACK_HANDLER);
    if ((((aocn)localObject1).a() != 0) && (((aocn)localObject1).e() == 1))
    {
