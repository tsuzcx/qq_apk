...
public class baah
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = aktw.jdField_a_of_type_JavaLangString + "/capture_qsvf" + File.separator;
    jdField_b_of_type_JavaLangString = jdField_a_of_type_JavaLangString + "capture_res" + File.separator;
    f = aktw.jdField_a_of_type_JavaLangString + "/qav" + File.separator + "beauty" + File.separator;
  ...
  public static int a(Context paramContext)
  {
    ...
    if ((j > 0) && (!new File(jdField_a_of_type_JavaLangString + "filter_config.xml").exists())) {
      lba.f("CaptureVideoFilterManager", "getQQShortVideoFilterConfigVersion config file don't exist!");
    }
    for (;;)
    {
      lba.f("CaptureVideoFilterManager", "getQQShortVideoFilterConfigVersion:" + i);
      return i;
      i = j;
    }
  }
  
  public static final baah a()
  {
    return baai.a();
  }
  ...
  public static String a(Context paramContext)
  {
    try
    {
      ...
      lba.f("CaptureVideoFilterManager", "getQQShortVideoFilterConfig:" + jdField_a_of_type_JavaLangString + "filter_config.xml" + "|" + localFile.exists());
      if (localFile.exists()) {
  ...
  {
    lba.f("CaptureVideoFilterManager", "setQQShortVideoFilterConfigVersion:" + paramInt);
  ...
  static void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      if ((paramString2 != null) && (!paramString2.equals("")))
      {
        ...
        lba.f("CaptureVideoFilterManager", "compareContent newList.size=0");
        FileUtils.deleteDirectory(jdField_b_of_type_JavaLangString);
      }
      for (;;)
      {
        long l2 = System.currentTimeMillis();
        lba.f("CaptureVideoFilterManager", "compareContent :" + (l2 - l1));
        return;
        ...
        if (paramString1 != null)
        {
          ...
          while (paramString1.hasNext())
          {
            ...
            while (localIterator.hasNext())
            {
              ...
              {
                lba.f("CaptureVideoFilterManager", "compareContent res:" + localFilterDesc.name + "|" + localFilterDesc.resMD5 + "|" + paramString2.resMD5);
                ...
                lba.f("CaptureVideoFilterManager", "compareContent iconMD5:" + localFilterDesc.name + "|" + localFilterDesc.iconMD5 + "|" + paramString2.iconMD5);
  ...
  static void a(String paramString, List<FilterDesc> paramList)
  {
    ...
    {
      lba.f("CaptureVideoFilterManager", "parseConfig|content is empty.");
      return;
    }
    paramList.clear();
    try
  ...
  public static boolean a(int paramInt1, long paramLong1, long paramLong2, int paramInt2)
  {
    ...
    if (i < paramInt2)
    {
      lba.f("CaptureVideoFilterManager", "isSupportOfDevice error OSversion: " + i);
      return false;
    }
    paramInt2 = lld.e();
    if (paramInt2 < paramInt1)
    {
      lba.f("CaptureVideoFilterManager", "isSupportOfDevice error cpucount: " + paramInt2);
      return false;
    }
    long l = lld.d();
    if (l < paramLong1)
    {
      lba.f("CaptureVideoFilterManager", "isSupportOfDevice error cpuFrequency: " + l);
      return false;
    }
    paramLong1 = DeviceInfoUtil.getSystemTotalMemory();
    if (paramLong1 < paramLong2)
    {
      lba.f("CaptureVideoFilterManager", "isSupportOfDevice error memory: " + paramLong1);
      return false;
    }
    return true;
  }
  ...
  public void a()
  {
    this.jdField_a_of_type_Baaj = null;
  }
  ...
  public void a(Context paramContext, String paramString, int paramInt)
  {
    if (paramString == null)
    {
      lba.f("CaptureVideoFilterManager", "updateQQShortVideoFilterConfig error ");
      return;
    }
    ...
    c();
    a(paramString);
    lba.f("CaptureVideoFilterManager", "updateQQShortVideoFilterConfig sendBroadcast");
    paramContext.sendBroadcast(new Intent("action_brocassreceiver_for_filter"));
  }
  
  public void a(baaj parambaaj)
  {
    this.jdField_a_of_type_Baaj = parambaaj;
  }
  
  public void a(baam parambaam)
  {
    if ((this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList == null) || (this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() == 0)) {
      lba.f("CaptureVideoFilterManager", "preDownloadResource list is empty!");
    }
    do
    {
      return;
      this.jdField_a_of_type_Baam = parambaam;
      lba.f("CaptureVideoFilterManager", "preDownloadResource list size: " + this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size());
      this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(0);
      parambaam = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
      while (parambaam.hasNext())
      {
        Object localObject1 = (FilterCategory)parambaam.next();
        if (((FilterCategory)localObject1).a != null)
        {
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            {
              lba.f("CaptureVideoFilterManager", "preDownloadResource predownload: " + localFilterDesc.predownload + ", iconurl: " + localFilterDesc.iconurl + ", resurl:" + localFilterDesc.resurl);
              if (localFilterDesc.predownload == 1)
              {
                ...
                if (!TextUtils.isEmpty(localFilterDesc.iconurl))
                {
                  ...
                  lba.f("CaptureVideoFilterManager", "preDownloadResource icon " + (String)localObject2 + " exist: " + ((File)localObject3).exists());
                  if (!((File)localObject3).exists())
                  {
                    localObject3 = new HttpNetReq();
                    ((HttpNetReq)localObject3).mCallback = new baal(this);
                    ...
                    lbc.a().sendReq((NetReq)localObject3);
                ...
                if ((!TextUtils.isEmpty(localFilterDesc.resurl)) && (!TextUtils.isEmpty((CharSequence)localObject2)))
                {
                  ...
                  lba.f("CaptureVideoFilterManager", "preDownloadResource file " + (String)localObject2 + "params.json" + " exist: " + ((File)localObject3).exists());
                  if (!((File)localObject3).exists())
                  {
                    localObject2 = new HttpNetReq();
                    ((HttpNetReq)localObject2).mCallback = new baak(this);
    ...
    } while ((this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 0) || (this.jdField_a_of_type_Baam == null));
    this.jdField_a_of_type_Baam.a(false);
  }
  ...
  public void b()
  {
    ...
    lba.f("CaptureVideoFilterManager", "init mFilterCategoryRaw size:" + this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size());
  }
