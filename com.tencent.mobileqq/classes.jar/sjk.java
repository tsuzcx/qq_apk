...
public class sjk
{
  ...
  public static String a(String paramString1, String paramString2)
  {
    ...
    {
      String str = bhzn.a(paramString1 + System.currentTimeMillis());
      StringBuilder localStringBuilder = new StringBuilder(a());
  ...
  public static boolean a(sjl paramsjl)
  {
    if (paramsjl == null) {}
    long l;
    do
    {
      do
      {
        ...
        {
          return false;
          if (a(paramsjl.a, paramsjl.jdField_b_of_type_Int))
          {
            if (QLog.isColorLevel()) {
          ...
          if ((paramsjl.d >= a()) && (paramsjl.d <= b())) {
            break;
          }
        } while (!QLog.isColorLevel());
        QLog.d("VideoConvertUtils", 2, "needCompress(): false! fileSize not match, size=" + paramsjl.d);
        return false;
        if (a()) {
          break;
        }
      ...
      return false;
      l = a(paramsjl.a, paramsjl.jdField_b_of_type_Int);
      if ((l > 0L) && (paramsjl.jdField_b_of_type_Long > 3L * l))
      {
        if (QLog.isColorLevel()) {
          QLog.d("VideoConvertUtils", 2, "needCompress(): true! sourceBitRate:" + paramsjl.jdField_b_of_type_Long + ", targetBitRate:" + l);
        }
        return true;
      }
    } while (!QLog.isColorLevel());
    QLog.d("VideoConvertUtils", 2, "needCompress(): false, bitrate not match, sourceBitRate:" + paramsjl.jdField_b_of_type_Long + ", targetBitRate:" + l);
    return false;
  }
