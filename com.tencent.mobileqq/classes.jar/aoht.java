...
public class aoht
{
  ...
  public static aoht a()
  {
    try
    {
      if (jdField_a_of_type_Aoht == null) {
        jdField_a_of_type_Aoht = new aoht();
      }
      return jdField_a_of_type_Aoht;
    }
    finally {}
  }
  ...
  public static void a(aohl paramaohl, aohi paramaohi)
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("errorcode_mq", String.valueOf(paramaohi.jdField_a_of_type_Int));
    localHashMap.put("errorcode_yt", String.valueOf(paramaohi.b));
    if ((paramaohi.jdField_a_of_type_Int == 0) && (paramaohi.b == 0)) {}
    for (boolean bool = true;; bool = false)
    {
      ...
      {
        i = m;
        if (paramaohl.a.a != null) {
          i = paramaohl.a.a.length;
        }
        j = k;
        if (paramaohi.jdField_a_of_type_JavaUtilArrayList != null) {
          j = paramaohi.jdField_a_of_type_JavaUtilArrayList.size();
        }
        localHashMap.put("send_person_count", String.valueOf(i));
        localHashMap.put("receive_star_count", String.valueOf(j));
      }
      long l = System.currentTimeMillis() - paramaohl.c;
  ...
  public static void c()
  {
    ...
    HashMap localHashMap = new HashMap();
    localHashMap.put("device_type", String.valueOf(ARMapTracer.a()));
    localHashMap.put("ppTotalCost", String.valueOf(localaoht.b));
    localHashMap.put("ppFaceDectectCost", String.valueOf(localaoht.c));
    localHashMap.put("upload_cost", String.valueOf(localaoht.d));
    localHashMap.put("ppExtractCost", String.valueOf(localaoht.e));
    localHashMap.put("ppExtractFaceCount", String.valueOf(localaoht.jdField_a_of_type_Int));
    localHashMap.put("firstDrawUICost", String.valueOf(localaoht.f));
    long l2 = localaoht.b;
    if (localaoht.e > localaoht.d) {}
    for (long l1 = localaoht.e;; l1 = localaoht.d)
    {
      localHashMap.put("totalCost", String.valueOf(l1 + l2 + localaoht.f));
