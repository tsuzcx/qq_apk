  ...
  extends ReportDialog
{
  ...
  static
  {
    ...
    jdField_b_of_type_JavaLangString = anhk.ba + "MsgPushNotify" + File.separator;
    ...
    jdField_g_of_type_JavaLangString = anni.a(2131705737);
    h = anni.a(2131705731);
    i = anni.a(2131705734);
  ...
  @TargetApi(14)
  public aoht(Context paramContext)
  {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    if (paramString == null)
    {
      jdField_a_of_type_AndroidContentIntent = bgnj.a(paramQQAppInterface.getApp());
      return;
    }
    Object localObject;
    label143:
    ...
    } while ((!((String)localObject).equals("device")) || (!paramString.getAttributeValue(null, "id").equals(bgln.d())));
    jdField_a_of_type_AndroidContentIntent = null;
    for (;;)
    {
      if (paramString.next() != 3)
  ...
  public static boolean a(File paramFile)
  {
    ...
    for (;;)
    {
      ...
      if (k < jdField_a_of_type_Int)
      {
        bgmg.d(String.format(jdField_c_of_type_JavaLangString + jdField_e_of_type_JavaLangString, new Object[] { Integer.valueOf(k) }));
        k += 1;
      }
      else
      {
        if (paramFile.exists())
        {
          bgmg.a(paramFile.getPath(), jdField_b_of_type_JavaLangString, false);
          return true;
        }
        return false;
        label151:
  ...
  private static boolean b(QQAppInterface paramQQAppInterface)
  {
    ...
    if (bgnt.a(BaseApplicationImpl.getApplication()) == 0)
    {
      QLog.d(jdField_a_of_type_JavaLangString, 1, "res download give up");
      return false;
    }
    if (jdField_a_of_type_Bhhf != null)
    {
      if ((jdField_a_of_type_Bhhf.a() == 2) || (jdField_a_of_type_Bhhf.a() == 3))
      {
        QLog.d(jdField_a_of_type_JavaLangString, 1, "res download duplicated, " + str);
        return false;
      }
      QLog.d(jdField_a_of_type_JavaLangString, 1, "res download task status error, cancel it, status: " + jdField_a_of_type_Bhhf.a());
      jdField_a_of_type_Bhhf.a(true);
    }
    jdField_a_of_type_Bhhf = new bhhf(jdField_f_of_type_JavaLangString, localFile);
    jdField_a_of_type_Bhhf.n = true;
    paramQQAppInterface = ((bhhh)paramQQAppInterface.getManager(47)).a(1);
    QLog.d(jdField_a_of_type_JavaLangString, 1, "start download ");
    paramQQAppInterface.a(jdField_a_of_type_Bhhf, new aohx(str), null);
    return false;
  }
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131365468));
    ...
    try
    {
      ...
      localButton.setText(anni.a(2131705732));
      localButton.setOnClickListener(new aohu(this));
      localImageView.setOnClickListener(new aohv(this));
      localImageView.setOnTouchListener(new aohw(this, localImageView));
      return;
    }
