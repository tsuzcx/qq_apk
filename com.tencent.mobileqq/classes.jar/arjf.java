  ...
  implements IShadow
{
  ...
  private void a(String paramString)
  {
    try
    {
      arjh.a().a().b("enter_shadow_err").c(paramString).b();
  ...
  public areh a(Context paramContext, String paramString1, String paramString2)
  {
    return areq.a(paramContext, paramString1, paramString2);
  }
  ...
  {
    akhl.b(192).execute(new NowShadowImpl.1(this, paramContext, paramString1, paramString2, paramLong, paramBundle, paramEnterCallback));
  }
