...
public class acza
{
  ...
  public acza(acyy paramacyy, Context paramContext)
  {
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(paramContext).inflate(2131493584, null);
  }
  ...
  public void a(aczc paramaczc)
  {
    this.jdField_a_of_type_Aczc = paramaczc;
  }
  ...
  public void a(IntimateInfo.MemoryDayInfo paramMemoryDayInfo)
  {
    ...
    URLThemeImageView localURLThemeImageView = (URLThemeImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131302061);
    TextView localTextView2 = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131313660);
    TextView localTextView1 = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131303578);
    RelativeLayout localRelativeLayout = (RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131304200);
    Object localObject2 = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131297453);
    ...
    Object localObject1 = this.jdField_a_of_type_Acyy.jdField_a_of_type_JavaLangString;
    if (localURLThemeImageView != null)
    {
      if (localURLThemeImageView.a != null) {
        localURLThemeImageView.a.a(beog.c);
      }
    ...
    if ((localRelativeLayout != null) && (ThemeUtil.isNowThemeIsNight(null, false, null))) {
      localObject1 = this.jdField_a_of_type_Acyy.b;
    }
    for (;;)
    {
      ...
      for (;;)
      {
        if ((localTextView2 != null) && (paramMemoryDayInfo.wording != null))
        {
          ...
          int i = aciy.a(95.0F, this.jdField_a_of_type_Acyy.jdField_a_of_type_AndroidContentContext.getResources());
          i = acyy.a(this.jdField_a_of_type_Acyy, (String)localObject1, 14.0F, i + 80);
          if (i > 200) {
        ...
        try
        {
          ...
          localTextView1.setOnClickListener(new aczb(this));
          return;
