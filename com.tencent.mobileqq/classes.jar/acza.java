  ...
  extends acyo
{
  ...
  public acza(int paramInt, AIOAnimationConatiner paramAIOAnimationConatiner, ListView paramListView)
  {
  ...
  protected boolean a(Object... paramVarArgs)
  {
    ...
    if (i > 0)
    {
      ...
      this.jdField_a_of_type_AndroidViewView = new aczf(this, this.jdField_a_of_type_ComTencentWidgetListView.getContext());
      this.jdField_b_of_type_AndroidViewView = new aczf(this, this.jdField_a_of_type_ComTencentWidgetListView.getContext());
      ...
      if (a(this.jdField_a_of_type_Long))
      {
        ...
        ((AnimatorSet)localObject3).addListener(new aczb(this));
    ...
    for (;;)
    {
      ...
      paramVarArgs.setAnimationListener(new aczd(this));
      paramVarArgs = new acze(this);
      paramVarArgs.setDuration(1000L);
      paramVarArgs.setFillAfter(true);
