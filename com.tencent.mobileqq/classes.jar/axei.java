...
public final class axei
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      bcst.b(paramQQAppInterface, "dc00899", "grp_lbs", paramString2, "talk_safety_check", paramString1, 0, 0, "", "", "", "");
      if (QLog.isColorLevel()) {
  ...
  public static void a(NearbyAppInterface paramNearbyAppInterface, String paramString, int paramInt)
  {
    ...
    {
      paramInt = ((Integer)axdz.a(paramNearbyAppInterface.getCurrentAccountUin(), "self_gender", Integer.valueOf(-1))).intValue();
      bcst.b(null, "dc00899", "grp_lbs", "", "home", paramString, 0, 0, str, String.valueOf(paramInt), "", "");
      if (QLog.isColorLevel()) {
