  ...
  extends ajtd
{
  ...
  public long a;
  private avwg jdField_a_of_type_Avwg = new avwg(paramAppInterface, this.jdField_a_of_type_Awbg);
  private awbg jdField_a_of_type_Awbg = new awbg();
  private Random jdField_a_of_type_JavaUtilRandom = new Random();
  
  public awbh(AppInterface paramAppInterface)
  {
  ...
  private void a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    ...
    for (long l = Long.valueOf(paramArrayOfByte1).longValue();; l = 0L)
    {
      ...
      {
        if (this.jdField_a_of_type_Awbg.b())
        {
          this.jdField_a_of_type_Awbg.a(2);
          paramArrayOfByte1 = (avwh)paramArrayOfByte2.get(0);
          this.jdField_a_of_type_Avwg.a(paramArrayOfByte2);
          this.jdField_a_of_type_Avwg.a(paramArrayOfByte1, l);
          if (!QLog.isColorLevel()) {
            break;
          }
  ...
  private void b(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (j == 4)
        {
          this.jdField_a_of_type_Awbg.a(0);
  ...
  {
    Object localObject = lgv.a(paramArrayOfByte);
    paramArrayOfByte = ((lgw)localObject).a;
    localObject = ((lgw)localObject).b;
    AudioTransClientTransInfo.IntHead localIntHead = new AudioTransClientTransInfo.IntHead();
    for (;;)
    {
      try
    ...
    do
    {
      do
      {
        ...
        if (this.jdField_a_of_type_Awbg.d())
        {
          ...
          this.jdField_a_of_type_Avwg.a(paramLong);
          return;
        }
        ...
        {
          this.jdField_a_of_type_Awbg.c(4);
          return;
        }
      } while (!this.jdField_a_of_type_Awbg.g());
      this.jdField_a_of_type_Awbg.c(4);
      return;
    } while (this.jdField_a_of_type_Awbg.c());
    this.jdField_a_of_type_Awbg.c(4);
  }
  ...
  public void a(long paramLong, boolean paramBoolean)
  {
    ...
    {
      return;
      i = this.jdField_a_of_type_Awbg.c();
  ...
  public void a(String paramString1, String paramString2, String paramString3, int paramInt1, byte[] paramArrayOfByte, int paramInt2, int paramInt3, boolean paramBoolean, int paramInt4)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString1 = lgv.a(paramString1.toByteArray(), paramString2.toByteArray());
        if (this.jdField_a_of_type_Avwg == null) {
          break;
        }
        if (this.jdField_a_of_type_Avwg.a()) {
          break label200;
        }
        if (!QLog.isColorLevel()) {
          break;
    ...
    label200:
    this.jdField_a_of_type_Avwg.a(paramString1);
  }
  ...
  public void a(String paramString1, String paramString2, byte[] paramArrayOfByte, int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3)
  {
    ...
    do
    {
      do
      {
        ...
        for (;;)
        {
          ...
          if ("TransInfoCreate.CreateSession".equals(paramString2))
          {
            ...
            if (!this.jdField_a_of_type_Awbg.c())
            {
              if (QLog.isColorLevel()) {
                QLog.e("PeakAudioTransHandler", 2, "sendCmdToService create last session not close state = " + this.jdField_a_of_type_Awbg.a());
              }
              if (paramBoolean) {}
              for (paramInt1 = 0;; paramInt1 = 1)
              {
                this.jdField_a_of_type_Awbg.c(paramInt1);
                return;
              }
            }
            if (this.jdField_a_of_type_Avwg.a())
            {
              ...
              this.jdField_a_of_type_Awbg.a(1);
              return;
            }
          ...
          if ("TransInfo.JoinSession".equals(paramString2))
          {
            ...
            localToServiceMsg.putWupBuffer(lgv.a(paramString1.toByteArray(), paramString2.toByteArray()));
            if (this.jdField_a_of_type_Awbg.a()) {
              break;
            }
            if (QLog.isColorLevel()) {
              QLog.e("PeakAudioTransHandler", 2, "sendCmdToService other  session not open ! state =" + this.jdField_a_of_type_Awbg.a());
            }
            paramInt1 = -1;
            if (i == 5) {
              if (!paramBoolean) {
      ...
      this.jdField_a_of_type_Awbg.a(3);
      return;
      if (QLog.isColorLevel()) {
