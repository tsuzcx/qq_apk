...
public class awbh
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    awbi.a(paramQQAppInterface, 0, paramString, false);
    a(paramQQAppInterface, 0, paramString, false);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, boolean paramBoolean, bepr parambepr)
  {
    if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      if (parambepr != null) {}
      for (paramQQAppInterface = parambepr.a;; paramQQAppInterface = paramMsg.msg_head.to_uin.get() + "") {
        break;
      }
      if (QLog.isColorLevel()) {
        paramStringBuilder.append("elemType:LbsShareMsg;\n");
      }
      paramList = (MessageForLocationShare)bbzh.a(-2076);
      paramList.msgtype = -2076;
      paramList.msg = BaseApplicationImpl.context.getString(2131718199);
  ...
  {
    awbi.a(paramQQAppInterface, 1, paramString, false);
