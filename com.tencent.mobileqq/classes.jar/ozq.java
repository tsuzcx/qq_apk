public class ozq
{
  ...
  static
  {
    ...
    String[] arrayOfString3 = { "&egrave;", "è" };
    String[] arrayOfString4 = { "&Euml;", "Ë" };
    String[] arrayOfString5 = { "&ugrave;", "ù" };
    String[] arrayOfString6 = { "&Ucirc;", "Û" };
    String[] arrayOfString7 = { "&uuml;", "ü" };
    a = new String[][] { { "&lt;", "<" }, { "&gt;", ">" }, { "&amp;", "&" }, { "&quot;", "\"" }, { "&agrave;", "à" }, { "&Agrave;", "À" }, arrayOfString1, arrayOfString2, { "&Auml;", "Ä" }, { "&Acirc;", "Â" }, { "&aring;", "å" }, { "&Aring;", "Å" }, { "&aelig;", "æ" }, { "&AElig;", "Æ" }, { "&ccedil;", "ç" }, { "&Ccedil;", "Ç" }, { "&eacute;", "é" }, { "&Eacute;", "É" }, arrayOfString3, { "&Egrave;", "È" }, { "&ecirc;", "ê" }, { "&Ecirc;", "Ê" }, { "&euml;", "ë" }, arrayOfString4, { "&iuml;", "ï" }, { "&Iuml;", "Ï" }, { "&ocirc;", "ô" }, { "&Ocirc;", "Ô" }, { "&ouml;", "ö" }, { "&Ouml;", "Ö" }, { "&oslash;", "ø" }, { "&Oslash;", "Ø" }, { "&szlig;", "ß" }, arrayOfString5, { "&Ugrave;", "Ù" }, { "&ucirc;", "û" }, arrayOfString6, arrayOfString7, { "&Uuml;", "Ü" }, { "&nbsp;", " " }, { "&copy;", "©" }, { "&reg;", "®" }, { "&euro;", "₠" } };
  }
