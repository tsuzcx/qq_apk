...
public abstract class anfv<DATA, CONFIG extends angp>
{
  ...
  protected final PriorityQueue<anfz> a;
  protected boolean a;
  protected float b;
  protected int b;
  protected long b;
  ...
  private void j()
  {
    try
    {
      this.jdField_a_of_type_Angp = this.jdField_a_of_type_Ange.a(a());
      return;
    }
  ...
  private void k()
  {
    ...
    if (this.jdField_a_of_type_JavaUtilHashMap != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localObject instanceof anfx)) {
          ((anfx)localObject).a();
        }
      }
  ...
  public long a()
  {
    return this.jdField_a_of_type_Anhn.a();
  }
  ...
  public final void a(long paramLong1, long paramLong2)
  {
    ...
    if (!this.jdField_a_of_type_JavaUtilPriorityQueue.isEmpty())
    {
      ...
      while (localIterator.hasNext())
      {
        anfz localanfz = (anfz)localIterator.next();
        localanfz.jdField_a_of_type_Long -= paramLong1;
        if (localanfz.jdField_a_of_type_Long <= 0L)
        {
          localIterator.remove();
          localanfz.jdField_a_of_type_Anfy.a(this);
        }
      }
    }
  }
  ...
  public boolean a(long paramLong)
  {
    ...
    while (paramLong - this.jdField_b_of_type_Long < this.jdField_a_of_type_Anhn.a()) {
      return false;
    }
    return true;
  }
  ...
  {
    return (this.jdField_a_of_type_Long > 0L) && (paramLong - this.jdField_a_of_type_Long >= this.jdField_a_of_type_Anhn.a());
  }
  ...
  {
    this.jdField_a_of_type_Anhn.a(paramFloat);
  }
  ...
  public boolean e()
  {
    return (this.jdField_a_of_type_Boolean) && (angu.a());
  }
  ...
  public void f()
  {
    ...
    {
      anhx.c("BaseDanmaku", "onFirstExposure, danmaku = " + toString());
      i();
      this.jdField_d_of_type_Boolean = true;
    }
    if ((this.jdField_a_of_type_Anfw != null) && (f1 <= 0.0F))
    {
      this.jdField_a_of_type_Anfw.a(this);
  ...
  {
    return "BaseDanmaku" + this.jdField_a_of_type_Int + "[left:" + b() + ",top:" + c() + ",right:" + d() + ",bottom:" + e() + ", time:" + this.jdField_b_of_type_Long + ", mData=" + String.valueOf(this.jdField_a_of_type_JavaLangObject) + ", mType=" + a() + ", playerTime=" + this.jdField_a_of_type_Ange.a() + "]";
  }
}
