  ...
  extends AbstractImageAdapter
{
  ...
  protected void a(View paramView, URLDrawable paramURLDrawable)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      {
        paramURLDrawable = bame.a(str);
        if ((paramURLDrawable != null) && (paramURLDrawable.exists())) {
          paramView.setTag(2131296389, Integer.valueOf(bdda.d(paramURLDrawable.getAbsolutePath())));
        }
      }
      return;
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    do
    {
      ...
      localzev = (zev)getItem(paramInt);
      paramView = localURLImageView;
    } while (localzev == null);
    URLDrawable localURLDrawable = a(localzev.a(), paramViewGroup);
    if (localURLDrawable == null) {
      localURLDrawable = (URLDrawable)localzev.b();
    }
    for (;;)
    {
      ...
      {
        int i = localURLDrawable.getProgress();
        localURLImageView.setURLDrawableDownListener(new zex(this, paramInt, paramViewGroup));
        a(paramInt, i / 100);
        return localURLImageView;
      }
      paramView = localURLImageView;
