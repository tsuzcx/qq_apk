...
public class rqi
{
  private static rqi jdField_a_of_type_Rqi;
  private QIPCModule jdField_a_of_type_ComTencentMobileqqQipcQIPCModule = new rqj(this, "Module_VideoFeedsIPCServer");
  private List<rqk> jdField_a_of_type_JavaUtilList = new Vector();
  ...
  public static rqi a()
  {
    if (jdField_a_of_type_Rqi == null) {}
    try
    {
      jdField_a_of_type_Rqi = new rqi();
      return jdField_a_of_type_Rqi;
    }
    finally {}
  }
  ...
  public void a(rqk paramrqk)
  {
    ...
    {
      this.jdField_a_of_type_JavaUtilList.add(paramrqk);
      return;
    }
  }
  
  public void b(rqk paramrqk)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      this.jdField_a_of_type_JavaUtilList.remove(paramrqk);
      return;
    }
  }
}
