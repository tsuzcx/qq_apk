...
public class bmrr
{
  ...
  {
    int i = bhhr.aS(paramContext, paramQQAppInterface.getCurrentAccountUin());
    if (i == 1)
    {
      String str = bhhr.t(paramContext, paramQQAppInterface.getCurrentAccountUin());
      i = bhhr.aT(paramContext, paramQQAppInterface.getCurrentAccountUin());
