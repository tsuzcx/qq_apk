  ...
  extends BusinessHandler
{
  ...
  public ofc(AppInterface paramAppInterface)
  {
    super(paramAppInterface);
  }
  
  public ofc(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          twp.a("AdVideoDataLink", "视频浮层混排回包: article size=" + localList.size());
          ...
          try
          {
            ...
            twp.a("AdVideoDataLink", "isAd = " + ((VideoInfo)localObject2).jdField_c_of_type_Boolean + " article = " + ((VideoInfo)localObject2).jdField_c_of_type_JavaLangString);
          }
      ...
      if (!bool3)
      {
        ...
        obi.a(localBundle, (ArrayList)localObject4);
        ...
        localObject3 = localObject5;
        localObject1 = localStringBuilder;
        obi.a(localRspBody, localBundle, this.jdField_a_of_type_Long);
        paramFromServiceMsg = null;
        paramObject = null;
        continue;
        paramObject = localObject1;
  ...
  private void a(Object paramObject, long paramLong1, VideoInfo paramVideoInfo, int paramInt1, ArrayList<VideoInfo> paramArrayList1, String paramString1, long paramLong2, boolean paramBoolean, int paramInt2, String paramString2, String paramString3, WeishiRedDotInfo paramWeishiRedDotInfo, int paramInt3, String paramString4, byte[] paramArrayOfByte, ArrayList<oidb_0x885.AdTagInfo> paramArrayList, int paramInt4, int paramInt5, int paramInt6, int paramInt7, ArrayList<VideoInfo> paramArrayList2, Bundle paramBundle)
  {
    ...
    paramString3.msg_phone_info.set(tvv.a());
    ...
    if ((paramArrayList1 == null) || (paramArrayList1.size() <= 0))
    {
      ...
      paramString1.businessIdForAidTicketAndTaidTicket = "ce2d9f";
      paramString1 = GdtDeviceInfoHelper.create(BaseApplication.getContext(), paramString1);
      if (paramString1 == null) {
        break label1580;
      }
      paramString1 = paramString1.deviceInfo;
    ...
    for (;;)
    {
      ...
      catch (Exception paramString3)
      {
        ...
        if (!QLog.isColorLevel())
        {
          ...
          ((JSONObject)localObject2).put("last_expo_ad_pos", oeg.a().a());
          ((JSONObject)localObject2).put("last_req_video_cnt", oeg.a().b());
      ...
      for (;;)
      {
        twp.a("AdVideoDataLink", paramString1.toString());
        break;
      ...
      label2100:
      a(localReqBody);
      paramInt1 = ((Integer)bkwm.a("key_sp_is_readinjoy_youngster", Integer.valueOf(0))).intValue();
  ...
  private void a(List<VideoInfo> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if ((localVideoInfo.jdField_c_of_type_Boolean) && (localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo != null) && (localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo.jdField_o_of_type_Int == 32)) {
        localHashSet.add(Long.valueOf(localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo.jdField_e_of_type_Long));
      }
    }
    nwz.a().a("RIJAdRefreshSceneFloatVideo", localHashSet);
  }
  ...
  private void a(oidb_0x6cf.ReqBody paramReqBody)
  {
    ...
    if (i < k)
    {
      ...
      str = bfwv.a(BaseApplicationImpl.getContext(), str);
    ...
    try
    {
      ...
      try
      {
        ...
        if (k == 2) {
          ...
          {
            localVideoInfo.jdField_a_of_type_Oey = new oey();
            localVideoInfo.jdField_a_of_type_Oey.jdField_a_of_type_JavaLangString = str1;
            localVideoInfo.jdField_a_of_type_Oey.jdField_b_of_type_JavaLangString = str2;
            localVideoInfo.jdField_a_of_type_Oey.jdField_c_of_type_JavaLangString = str3;
            localVideoInfo.jdField_a_of_type_Oey.jdField_d_of_type_JavaLangString = str4;
            localVideoInfo.jdField_a_of_type_Oey.jdField_e_of_type_JavaLangString = str5;
            localVideoInfo.jdField_a_of_type_Oey.jdField_f_of_type_JavaLangString = str6;
            localVideoInfo.jdField_a_of_type_Oey.jdField_g_of_type_JavaLangString = str7;
            localVideoInfo.jdField_a_of_type_Oey.jdField_h_of_type_JavaLangString = str8;
            localVideoInfo.jdField_a_of_type_Oey.i = str9;
            localVideoInfo.jdField_a_of_type_Oey.jdField_j_of_type_JavaLangString = str10;
            localVideoInfo.jdField_a_of_type_Oey.jdField_k_of_type_JavaLangString = str11;
            localVideoInfo.jdField_a_of_type_Oey.jdField_l_of_type_JavaLangString = str12;
            localVideoInfo.jdField_a_of_type_Oey.jdField_m_of_type_JavaLangString = str13;
            localVideoInfo.jdField_a_of_type_Oey.jdField_a_of_type_Int = i;
            localVideoInfo.jdField_a_of_type_Oey.jdField_b_of_type_Int = j;
            localVideoInfo.jdField_a_of_type_Oey.jdField_n_of_type_JavaLangString = ((String)localObject5);
            localVideoInfo.jdField_a_of_type_Oey.jdField_c_of_type_Int = k;
          }
        }
      }
      catch (Exception localException4)
      {
        for (;;)
        {
          ...
          {
            localVideoInfo.jdField_b_of_type_Oey = new oey();
            localVideoInfo.jdField_b_of_type_Oey.jdField_a_of_type_JavaLangString = localException4;
            localVideoInfo.jdField_b_of_type_Oey.jdField_b_of_type_JavaLangString = str2;
            localVideoInfo.jdField_b_of_type_Oey.jdField_c_of_type_JavaLangString = str3;
            localVideoInfo.jdField_b_of_type_Oey.jdField_d_of_type_JavaLangString = str4;
            localVideoInfo.jdField_b_of_type_Oey.jdField_e_of_type_JavaLangString = str5;
            localVideoInfo.jdField_b_of_type_Oey.jdField_f_of_type_JavaLangString = str6;
            localVideoInfo.jdField_b_of_type_Oey.jdField_g_of_type_JavaLangString = str7;
            localVideoInfo.jdField_b_of_type_Oey.jdField_h_of_type_JavaLangString = str8;
            localVideoInfo.jdField_b_of_type_Oey.i = str9;
            localVideoInfo.jdField_b_of_type_Oey.jdField_j_of_type_JavaLangString = str10;
            localVideoInfo.jdField_b_of_type_Oey.jdField_k_of_type_JavaLangString = str11;
            localVideoInfo.jdField_b_of_type_Oey.jdField_l_of_type_JavaLangString = str12;
            localVideoInfo.jdField_b_of_type_Oey.jdField_m_of_type_JavaLangString = str13;
            localVideoInfo.jdField_b_of_type_Oey.jdField_a_of_type_Int = i;
            localVideoInfo.jdField_b_of_type_Oey.jdField_b_of_type_Int = j;
            localVideoInfo.jdField_b_of_type_Oey.jdField_n_of_type_JavaLangString = ((String)localObject5);
            localVideoInfo.jdField_b_of_type_Oey.jdField_c_of_type_Int = k;
          }
        }
      }
      try
      {
        ...
        {
          localVideoInfo.jdField_b_of_type_Oey = new oey();
          localVideoInfo.jdField_b_of_type_Oey.jdField_a_of_type_JavaLangString = str1;
          localVideoInfo.jdField_b_of_type_Oey.jdField_b_of_type_JavaLangString = str2;
          localVideoInfo.jdField_b_of_type_Oey.jdField_c_of_type_JavaLangString = str3;
          localVideoInfo.jdField_b_of_type_Oey.jdField_d_of_type_JavaLangString = str4;
          localVideoInfo.jdField_b_of_type_Oey.jdField_e_of_type_JavaLangString = str5;
      ...
      catch (Exception localException2)
      {
        ...
        localVideoInfo.jdField_q_of_type_Int = paramArticleSummary.uint32_strategy_id.get();
        ...
        localVideoInfo.t = paramArticleSummary.uint32_like_count.get();
        ...
        for (;;)
        {
          ...
          else
          {
            ...
            {
              localObject3 = paramArticleSummary.msg_top_bar_info;
        ...
        AdvertisementInfo localAdvertisementInfo = obb.a(localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo);
        if (!twq.a(null, localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo)) {
          break label4170;
        }
        ...
        try
        {
          ...
          obb.a(new trn().a(BaseApplication.getContext()).a(obb.jdField_k_of_type_Int).b(obb.V).a(localAdvertisementInfo).a(localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo).b(localJSONObject).a());
          twr.a(localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo);
          ...
          localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoInfo$SoftAdDownloadBarInfo.jdField_a_of_type_Trt = trt.a(localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoInfo$SoftAdDownloadBarInfo.jdField_e_of_type_JavaLangString);
        ...
        catch (JSONException localJSONException2)
        {
          ...
          localVideoInfo.s = a(paramArticleSummary.bytes_first_page_gif_url);
          ...
          obi.a(paramArticleSummary, localVideoInfo);
          ...
          localVideoInfo.v = a(paramArticleSummary.bytes_wechat_share_url);
          ...
          for (bool = true;; bool = false)
          {
            ...
            paramArticleSummary = a(paramArticleSummary.bytes_title_with_topic);
            if (!TextUtils.isEmpty(paramArticleSummary)) {
              localVideoInfo.a(paramArticleSummary);
            }
            return localVideoInfo;
            l = 0L;
            break;
  ...
  public void a(ofd paramofd, long paramLong1, VideoInfo paramVideoInfo, int paramInt1, ArrayList<VideoInfo> paramArrayList1, String paramString1, long paramLong2, boolean paramBoolean, int paramInt2, String paramString2, String paramString3, WeishiRedDotInfo paramWeishiRedDotInfo, int paramInt3, String paramString4, byte[] paramArrayOfByte, int paramInt4, ArrayList<VideoInfo> paramArrayList2)
  {
    a(paramofd, paramLong1, paramVideoInfo, paramInt1, paramArrayList1, paramString1, paramLong2, paramBoolean, paramInt2, paramString2, paramString3, paramWeishiRedDotInfo, paramInt3, paramString4, paramArrayOfByte, paramInt4, paramArrayList2, null);
  }
  ...
  public void a(ofd paramofd, long paramLong1, VideoInfo paramVideoInfo, int paramInt1, ArrayList<VideoInfo> paramArrayList1, String paramString1, long paramLong2, boolean paramBoolean, int paramInt2, String paramString2, String paramString3, WeishiRedDotInfo paramWeishiRedDotInfo, int paramInt3, String paramString4, byte[] paramArrayOfByte, int paramInt4, ArrayList<VideoInfo> paramArrayList2, Bundle paramBundle)
  {
    ...
    ThreadManager.post(new VideoPlayRecommendHandler.1(this, paramofd, paramLong1, paramVideoInfo, paramInt1, paramArrayList1, paramString1, paramLong2, paramBoolean, paramInt2, paramString2, paramString3, paramWeishiRedDotInfo, paramInt3, paramString4, paramArrayOfByte, paramInt4, paramArrayList2, paramBundle), 5, null, true);
  }
  ...
  public void a(ofd paramofd, long paramLong1, VideoInfo paramVideoInfo, int paramInt1, ArrayList<VideoInfo> paramArrayList1, String paramString1, long paramLong2, boolean paramBoolean, int paramInt2, String paramString2, String paramString3, WeishiRedDotInfo paramWeishiRedDotInfo, int paramInt3, String paramString4, byte[] paramArrayOfByte, ArrayList<VideoInfo.AdTagInfo> paramArrayList, int paramInt4, int paramInt5, int paramInt6, ArrayList<VideoInfo> paramArrayList2)
  {
    ...
    ThreadManager.post(new VideoPlayRecommendHandler.2(this, paramArrayList, paramofd, paramLong1, paramVideoInfo, paramInt1, paramArrayList1, paramString1, paramLong2, paramBoolean, paramInt2, paramString2, paramString3, paramWeishiRedDotInfo, paramInt3, paramString4, paramArrayOfByte, paramInt4, paramInt5, paramInt6, paramArrayList2), 5, null, true);
  }
  
  public void a(ofd paramofd, long paramLong, String paramString, int paramInt, VideoInfo paramVideoInfo)
  {
    ThreadManager.post(new VideoPlayRecommendHandler.3(this, paramLong, paramInt, paramString, paramofd, paramVideoInfo), 5, null, true);
  }
  
  public void a(ofd paramofd, String paramString, int paramInt, boolean paramBoolean)
  {
    oidb_0x6cf.ReqBody localReqBody = new oidb_0x6cf.ReqBody();
    ...
    for (paramInt = 1;; paramInt = 0)
    {
      ...
      paramString = qlk.a("OidbSvc.0x6cf", 1743, 1, localReqBody.toByteArray());
      paramString.addAttribute("is_from_first_recommend_video", Boolean.valueOf(true));
      paramString.addAttribute("VALUE_OBSERVER_TAG", Integer.valueOf(paramofd.hashCode()));
