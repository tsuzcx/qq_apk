  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if ("goShare".equals(paramString3))
    {
      ...
      try
      {
        ...
        {
          bdis.a().a(this.mRuntime.a().getString(2131720726));
          return true;
        }
      }
      catch (JSONException paramJsBridgeListener)
      {
        bdis.a().a(this.mRuntime.a().getString(2131690286));
        return true;
      }
    ...
    try
    {
      bdii.c(this.TAG, "doReport");
      paramJsBridgeListener = new JSONObject(paramVarArgs[0]);
      ymt.a(null, paramJsBridgeListener.optString("actionName"), paramJsBridgeListener.optInt("fromType"), paramJsBridgeListener.optInt("actionResult"), paramJsBridgeListener.optInt("ext2"));
      return true;
    }
    catch (JSONException paramJsBridgeListener)
    {
    ...
    try
    {
      paramString1 = new String(bbco.decode(paramString1, 0));
    ...
    if ("jumpPublicDevice".equals(paramString3)) {
      try
      {
        bdii.c(this.TAG, "METHOD_JUMP_PUBLICDEVICE");
