...
public class akwk
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        localakwq = akwt.a(paramQQAppInterface);
      } while (localakwq == null);
      akwl localakwl = akwt.a(paramQQAppInterface);
      if (localakwl != null) {
        localakwl.a(paramString, paramBoolean);
      }
      if (akwt.a(paramQQAppInterface))
      {
        QLog.i("cmshow_scripted_SpriteCommFunc", 1, "showOrHideSprite double should hide");
        return;
      }
      paramQQAppInterface = localakwq.a();
    } while (paramQQAppInterface == null);
  ...
  {
    boolean bool1 = akwt.b(paramQQAppInterface);
    boolean bool2 = akwt.a(paramQQAppInterface);
    return (bool1) || (bool2);
  }
