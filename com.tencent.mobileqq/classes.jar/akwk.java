  ...
  implements apiu
{
  ...
  public boolean notify(String paramString1, String paramString2, String paramString3)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        try
        {
          ...
          paramString2 = bgnw.a(BaseApplicationImpl.getContext(), paramString2);
    ...
    if ("beacon_report".equals(paramString2)) {
      ...
      {
        paramString1 = new JSONObject(paramString3);
        akxd.a("000004B5DU3Q3LD1", paramString1.optString("event_name"), paramString1.optJSONObject("params"));
        return true;
      }
      catch (Throwable paramString1)
      {
    ...
    akwh.a(this.a);
    this.a.notifyObservers(new akwj(this.a, paramString1, paramString2, paramString3));
