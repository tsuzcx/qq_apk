...
public class afce
{
  ...
  {
    int i = 0 + axcz.a().a(paramQQAppInterface) + ajqt.b(paramQQAppInterface);
  ...
  {
    if ((paramazwg == null) || (paramString == null) || (paramInt == -1)) {
      return null;
    }
    if (paramazwg.a()) {
      paramazwg.b();
    }
    Bitmap localBitmap2 = paramazwg.a(paramInt, paramString);
    Bitmap localBitmap1 = localBitmap2;
    if (localBitmap2 == null)
    {
      paramazwg.a(paramString, paramInt, true);
      if (paramInt != 4) {
        break label68;
      }
    }
    label68:
    for (localBitmap1 = bacm.f();; localBitmap1 = bacm.a()) {
