...
public class aauo
  extends ImageSpan
{
  public aauo(ChatSettingForTroop paramChatSettingForTroop, Drawable paramDrawable, int paramInt)
  {
  ...
  {
    paramCanvas.save();
    paramCanvas.translate(axli.a(9.0F), 0.0F);
  ...
  {
    return getDrawable().getBounds().right + axli.a(9.0F);
  }
}
