...
public class bgkd
  extends ajno
{
  public bgkd(Context paramContext, QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
  ...
  protected void a(RecommendTroopItem paramRecommendTroopItem)
  {
    ...
    {
      bdll.b(null, "dc00899", "Grp_recom", "", "set_page", "clk_grp", 0, 0, str1, str2, paramRecommendTroopItem, "");
      return;
    }
  }
  ...
  protected void b(RecommendTroopItem paramRecommendTroopItem)
  {
    ...
    for (paramRecommendTroopItem = "1";; paramRecommendTroopItem = "2")
    {
      bdll.b(null, "dc00899", "Grp_recom", "", "set_page", "clk_add", 0, 0, str1, str2, paramRecommendTroopItem, "");
      return;
    }
  }
  ...
  protected void c(RecommendTroopItem paramRecommendTroopItem)
  {
    ...
    for (paramRecommendTroopItem = "1";; paramRecommendTroopItem = "2")
    {
      bdll.b(null, "dc00899", "Grp_recom", "", "set_page", "exp_grp", 0, 0, str1, str2, paramRecommendTroopItem, "");
      return;
    }
  }
}
