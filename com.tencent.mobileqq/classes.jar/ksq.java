...
public class ksq
{
  ...
  private List<ksr> jdField_a_of_type_JavaUtilList;
  private kss jdField_a_of_type_Kss;
  ...
  public ksq(@NonNull VideoAppInterface paramVideoAppInterface, String paramString)
  {
    ...
    this.d = 0L;
    this.jdField_a_of_type_Kss = new kss(this);
  ...
  private void a(int paramInt)
  {
    ...
    Map localMap = babp.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp());
  ...
  private void a(long paramLong, Map<String, Integer> paramMap)
  {
    ...
    this.jdField_a_of_type_JavaUtilList.add(new ksr(a(), a(paramMap, "summary.total-pss"), a(paramMap, "summary.java-heap"), a(paramMap, "summary.native-heap"), a(paramMap, "summary.code"), a(paramMap, "summary.graphics"), paramLong));
  }
  ...
  private void c()
  {
    ...
    if (j >= 4)
    {
      l1 = ((ksr)this.jdField_a_of_type_JavaUtilList.get(j - 1 - 1)).jdField_a_of_type_Long;
      l2 = ((ksr)this.jdField_a_of_type_JavaUtilList.get(1)).jdField_a_of_type_Long;
      l3 = ((ksr)this.jdField_a_of_type_JavaUtilList.get(j - 1 - 1)).jdField_b_of_type_Long;
      l4 = ((ksr)this.jdField_a_of_type_JavaUtilList.get(1)).jdField_b_of_type_Long;
      l5 = ((ksr)this.jdField_a_of_type_JavaUtilList.get(j - 1 - 1)).jdField_c_of_type_Long;
      l6 = ((ksr)this.jdField_a_of_type_JavaUtilList.get(1)).jdField_c_of_type_Long;
      i = 1;
      if (i >= j - 1 - 1) {
        break label1067;
      }
      localObject3 = (ksr)this.jdField_a_of_type_JavaUtilList.get(i);
      localksr = (ksr)this.jdField_a_of_type_JavaUtilList.get(i + 1);
      if ((((ksr)localObject3).jdField_a_of_type_Int != 0) && (((ksr)localObject3).jdField_a_of_type_Int != localksr.jdField_a_of_type_Int))
      {
        if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (i == 0)
      {
        ...
        for (;;)
        {
          if (((Iterator)localObject3).hasNext())
          {
            ...
            continue;
            this.jdField_c_of_type_Int = localksr.jdField_a_of_type_Int;
            if ((!((ksr)localObject3).a()) || (!localksr.a())) {
              if (QLog.isColorLevel()) {
      ...
      do
      {
        ...
        {
          return;
          d1 = localksr.f - ((ksr)localObject3).f;
          d2 = localksr.jdField_a_of_type_Long - ((ksr)localObject3).jdField_a_of_type_Long;
          d3 = localksr.jdField_b_of_type_Long - ((ksr)localObject3).jdField_b_of_type_Long;
          double d4 = localksr.jdField_c_of_type_Long - ((ksr)localObject3).jdField_c_of_type_Long;
          if (d1 <= 0.0D)
          {
            if (QLog.isColorLevel()) {
          ...
          if (this.jdField_a_of_type_Boolean)
          {
            ...
            ((HashMap)localObject2).put("device_memory", String.valueOf(babp.d() / 1024L));
  ...
  public void a()
  {
    if (this.jdField_b_of_type_Int == 0)
    {
      ...
      this.jdField_a_of_type_Boolean = this.jdField_a_of_type_ComTencentAvVideoController.i;
      this.jdField_b_of_type_Long = SystemClock.uptimeMillis();
      this.jdField_c_of_type_Long = System.currentTimeMillis();
      this.d = this.jdField_a_of_type_ComTencentAvVideoController.c(this.jdField_a_of_type_JavaLangString);
      this.jdField_a_of_type_Kss.a();
