...
public class uwd
  implements tch
{
  private ssj<String, FeedVideoInfo> a = new ssj(300);
  ...
  public FeedVideoInfo a(int paramInt1, String paramString1, int paramInt2, List<StoryVideoItem> paramList, String paramString2, boolean paramBoolean1, int paramInt3, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (ved.a()) {
          ved.b("Q.qqstory.home.data.FeedVideoManager", "**before** update feed video list:" + localFeedVideoInfo);
        }
        ...
        paramString1 = new uwe(paramString1, paramInt1);
        stb.a().dispatch(paramString1);
        if (ved.a()) {
          ved.a("Q.qqstory.home.data.FeedVideoManager", "**after** update feed video list:%s", paramList);
        }
  ...
  public FeedVideoInfo a(String paramString, int paramInt)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 20	uwd:a	Lssj;
    //   6: aload_0
    //   7: aload_1
    //   8: iload_2
    //   9: invokespecial 68	uwd:a	(Ljava/lang/String;I)Ljava/lang/String;
    //   12: invokevirtual 71	ssj:a	(Ljava/lang/Object;)Lssi;
    ...
    //   82: invokestatic 87	ved:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   85: aload_3
    //   86: astore_1
    //   87: goto -64 -> 23
    //   90: astore_1
  ...
  public void a(FeedVideoInfo paramFeedVideoInfo)
  {
    ...
    new uqa(4, paramFeedVideoInfo).c();
    ved.d("Q.qqstory.home.data.FeedVideoManager", "triggerSyncVideoList for %s", new Object[] { paramFeedVideoInfo });
  }
