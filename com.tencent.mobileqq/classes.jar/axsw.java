...
public class axsw
{
  ...
  WeakReference<bezv> jdField_a_of_type_MqqUtilWeakReference;
  boolean jdField_a_of_type_Boolean = false;
  ArrayList<axta> b = new ArrayList();
  ...
  private void a(String paramString1, String arg2, boolean paramBoolean, axtb paramaxtb)
  {
    ...
    synchronized (this.b)
    {
      ...
      while (i >= 0)
      {
        paramaxtb = (axta)this.b.get(i);
        if ((paramaxtb != null) && (TextUtils.equals(paramString1, paramaxtb.jdField_a_of_type_JavaLangString)))
        {
          if (paramaxtb.jdField_a_of_type_Axtb != null) {
            paramaxtb.jdField_a_of_type_Axtb.a(paramBoolean);
          }
          this.b.remove(i);
        }
        i -= 1;
  ...
  public void a(QQAppInterface arg1, int paramInt, String paramString1, String paramString2, String paramString3, String[] paramArrayOfString, axtb paramaxtb)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ZipResourcesDownloader", 2, String.format("downloadResource url=%s md5=%s callback=%s", new Object[] { paramString2, paramString3, paramaxtb }));
    }
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_MqqUtilWeakReference != null) {
          localObject1 = (bezv)this.jdField_a_of_type_MqqUtilWeakReference.get();
        }
        localObject2 = localObject1;
        if (localObject1 == null)
        {
          localObject2 = (bezv)???.getManager(193);
        ...
        if (localObject2 != null)
        {
          ...
          synchronized (this.jdField_a_of_type_JavaUtilArrayList)
          {
            ...
            if (i != 0)
            {
              ...
              synchronized (this.b)
              {
                this.b.add(new axta(this, paramString2, paramaxtb));
                return;
              }
            }
          }
      ...
      ??? = new beum();
      ((beum)???).jdField_a_of_type_Beuq = new axsx(this);
      ((beum)???).jdField_a_of_type_JavaLangString = paramString2;
      ((beum)???).jdField_a_of_type_Int = 0;
      ((beum)???).c = ((String)localObject1);
      ((beum)???).d = 0;
      ((beum)???).jdField_a_of_type_Beup = new axsy(this);
      ((bezv)localObject2).a(paramInt, paramString1, paramString3, 0, paramString2, (String)localObject1, 2, 0, false, new bezt(???, paramString3, new axsz(this, paramString3, paramArrayOfString, paramaxtb), (beum)???));
      synchronized (this.jdField_a_of_type_JavaUtilArrayList)
      {
