  ...
  extends avvd
{
  ...
  protected void b(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if ((paramBoolean) && (paramBundle != null) && ((paramBundle instanceof AIONewestFeedRsp))) {
      acjm.a(localQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, (AIONewestFeedRsp)paramBundle, this.jdField_a_of_type_Boolean);
    }
    paramBundle = (acjs)acjm.a().get(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a);
    acjm.a().remove(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a);
