  ...
  extends avxd
{
  ...
  public avxk(Intent paramIntent, avxp paramavxp)
  {
  ...
  public int a(android.content.Context paramContext, String paramString)
  {
    ...
    //   345: aload_2
    //   346: astore 7
    //   348: invokestatic 135	avxt:a	()Lavxt;
    //   351: aload 9
    ...
    //   361: invokevirtual 138	avxt:a	(Ljava/lang/String;Ljava/lang/String;)I
    //   364: pop
    //   365: aload 6
    //   367: astore 8
    //   369: aload_2
    //   370: astore 7
    //   372: aload_0
    //   373: getfield 29	avxk:jdField_a_of_type_ComTencentMobileqqJspFaceDetectForThirdPartyManager$AppConf	Lcom/tencent/mobileqq/jsp/FaceDetectForThirdPartyManager$AppConf;
    //   376: ifnull +564 -> 940
    //   379: aload 6
    //   381: astore 8
    //   383: aload_2
    //   384: astore 7
    //   386: aload_0
    //   387: getfield 29	avxk:jdField_a_of_type_ComTencentMobileqqJspFaceDetectForThirdPartyManager$AppConf	Lcom/tencent/mobileqq/jsp/FaceDetectForThirdPartyManager$AppConf;
    ...
    //   400: aload_2
    //   401: astore 7
    //   403: invokestatic 135	avxt:a	()Lavxt;
    //   406: iconst_5
    //   407: invokevirtual 145	avxt:a	(I)Lorg/json/JSONObject;
    //   410: astore 10
    //   412: aload 10
    ...
    //   536: astore 7
    //   538: aload_0
    //   539: getfield 29	avxk:jdField_a_of_type_ComTencentMobileqqJspFaceDetectForThirdPartyManager$AppConf	Lcom/tencent/mobileqq/jsp/FaceDetectForThirdPartyManager$AppConf;
    ...
    //   617: ldc 165
    //   619: aload_0
    //   620: getfield 29	avxk:jdField_a_of_type_ComTencentMobileqqJspFaceDetectForThirdPartyManager$AppConf	Lcom/tencent/mobileqq/jsp/FaceDetectForThirdPartyManager$AppConf;
    ...
    //   665: aload_2
    //   666: astore 7
    //   668: getstatic 190	borf:b	Lborf;
    //   671: invokestatic 195	bork:a	(Lborf;)Ljava/lang/String;
    //   674: astore 9
    //   676: aload 9
    //   678: astore_1
    //   679: aload 6
  ...
  public void a(boolean paramBoolean, Activity paramActivity)
  {
    ...
    if (paramBoolean)
    {
      ...
      localObject = bday.a().jdField_a_of_type_AndroidHardwareCamera;
      k = bday.a().jdField_a_of_type_Int;
      i = -1;
    }
    try
    {
    ...
    catch (Exception localException)
    {
      ...
      localYtSDKPlatformContex.reflectListener = new avxl(this);
      ...
      JSONObject localJSONObject = avxt.a().a(5);
      ...
      return;
      QLog.d("qq_Identification.Model", 1, new Object[] { "YtSDKKitFramework init result : ", Integer.valueOf(YtSDKKitFramework.getInstance().init(localYtSDKPlatformContex, localJSONObject, (YtSDKKitFramework.YtSDKKitFrameworkWorkMode)localObject, localArrayList, new avxm(this))) });
    }
