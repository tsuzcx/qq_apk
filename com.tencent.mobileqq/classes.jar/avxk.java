...
public class avxk
  extends avwr<avwv>
{
  avxk(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(int paramInt1, int paramInt2, long paramLong, LocationRoom.Venue paramVenue)
  {
    ...
    Object localObject = awbi.a(this.a, paramInt2, paramLong);
  ...
  {
    awbi.a(this.a, paramInt1, paramString, false);
    awbh.a(this.a, paramInt1, paramString, false);
  ...
  protected avwv a()
  {
    return avwv.a(this.a);
  }
  
  void a(avwp paramavwp, LocationRoom.Venue paramVenue)
  {
    if ((paramavwp == null) || (paramVenue == null)) {
      return;
    }
    a(1, paramavwp.a(), Long.parseLong(paramavwp.a()), paramVenue);
  }
  ...
  void b(avwp paramavwp, LocationRoom.Venue paramVenue)
  {
    if ((paramavwp == null) || (paramVenue == null)) {
      return;
    }
    a(3, paramavwp.a(), Long.parseLong(paramavwp.a()), paramVenue);
  }
}
