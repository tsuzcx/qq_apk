...
public class ampp
{
  ...
  private ampu jdField_a_of_type_Ampu = new ampu(null);
  private List<Member> jdField_a_of_type_JavaUtilList = new ArrayList();
  
  public static ampp a()
  {
    return ampr.a;
  }
  ...
  private void b(ampb paramampb, ampi[] paramArrayOfampi, int paramInt, Exception paramException) {}
  
  private void b(ampc paramampc, File paramFile, Exception paramException) {}
  ...
  {
    axps.a(new QConfigureException(paramException, "TAG: " + paramString2 + " Message: " + paramException.getMessage()), paramString1);
  }
  
  public void a(ampb paramampb, ampi[] paramArrayOfampi, int paramInt, Exception paramException)
  {
    int i = paramampb.a();
    ...
    b(paramampb, paramArrayOfampi, paramInt, paramException);
  }
  
  public void a(ampc paramampc, File paramFile, Exception paramException)
  {
    if (QLog.isColorLevel()) {
    ...
    b(paramampc, paramFile, paramException);
  }
