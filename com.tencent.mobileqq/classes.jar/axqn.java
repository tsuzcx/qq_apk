...
{
  private static volatile axqn jdField_a_of_type_Axqn;
  ...
  private axqn(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext.getApplicationContext();
    this.jdField_a_of_type_Boolean = axqi.a(this.jdField_a_of_type_AndroidContentContext, true);
  }
  
  public static axqn a(Context paramContext)
  {
    if (jdField_a_of_type_Axqn == null) {}
    try
    {
      if (jdField_a_of_type_Axqn == null) {
        jdField_a_of_type_Axqn = new axqn(paramContext);
      }
      return jdField_a_of_type_Axqn;
    }
    finally {}
  }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    for (Object localObject = (QQAppInterface)localObject;; localObject = null)
    {
      ...
      axqy.b((QQAppInterface)localObject, "dc00898", "", "", "0X80075F3", "0X80075F3", 0, 0, new SimpleDateFormat("yyyyMMdd", Locale.US).format(localDate), "", "", "");
      MTAReportManager.setMTAReporter(jdField_a_of_type_Axqn);
