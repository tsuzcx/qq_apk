...
public class axqn
{
  ...
  {
    new bdlf(null).a("dc00899").b("grp_lbs").c(paramString1).d(paramString2).a(paramInt1).b(paramInt2).a(paramVarArgs).a();
  }
  ...
  public static boolean a(Activity paramActivity, QQAppInterface paramQQAppInterface)
  {
    ...
    new aynn(paramActivity).a(localImageView, localLayoutParams).b(anvx.a(2131706866)).a(new aynh(anvx.a(2131706868), new axqo(paramActivity, paramQQAppInterface))).show();
