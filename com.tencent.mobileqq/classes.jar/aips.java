  ...
  implements Manager
{
  ...
  private CopyOnWriteArrayList<aipj> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  ...
  public aips(AppInterface paramAppInterface)
  {
    this.jdField_a_of_type_JavaUtilList = new CopyOnWriteArrayList();
    QLog.i("cmgame_process.CmGameManager", 1, "[CmGameManager] created.");
    this.jdField_a_of_type_ComTencentCommonAppAppInterface = paramAppInterface;
    this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel = new ApolloCmdChannel(aing.a());
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new aipu();
  ...
  private void c()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        if (localSharedPreferences.contains("exit_game_guide_today_" + ApolloUtil.a())) {
          this.jdField_a_of_type_Boolean = false;
        }
      }
  ...
  private void d()
  {
    ...
    String str1 = "exit_game_guide_today_" + ApolloUtil.a();
  ...
  public aikb a()
  {
    ...
    //   16: areturn
    //   17: aload_0
    //   18: getfield 378	aips:jdField_a_of_type_Aikb	Laikb;
    //   21: ifnonnull +29 -> 50
    //   24: aload_0
    //   25: new 380	aikb
    //   28: dup
    //   29: invokespecial 381	aikb:<init>	()V
    //   32: putfield 378	aips:jdField_a_of_type_Aikb	Laikb;
    //   35: invokestatic 234	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   38: ifeq +12 -> 50
    //   41: ldc 70
    //   43: iconst_2
    //   44: ldc_w 383
    //   47: invokestatic 385	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   50: aload_0
    //   51: getfield 378	aips:jdField_a_of_type_Aikb	Laikb;
    //   54: astore_2
    //   55: goto -42 -> 13
    //   58: astore_2
    //   59: aload_0
  ...
  public aipj a()
  {
    ...
    {
      aipj localaipj = (aipj)localIterator.next();
      if ((localaipj != null) && (!aing.a(localaipj.a())) && (!aing.b(localaipj.a()))) {
        return localaipj;
      }
    }
    return null;
  ...
  public aipj a(int paramInt)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
    while (localIterator.hasNext())
    {
      aipj localaipj = (aipj)localIterator.next();
      if ((localaipj != null) && (paramInt == localaipj.a())) {
        return localaipj;
      }
    }
    return null;
  ...
  public aipj a(int paramInt1, int paramInt2)
  {
    if (paramInt1 <= 0) {}
    for (;;)
    {
      ...
      aipj localaipj = new aipj(paramInt1);
      localaipj.d = paramInt2;
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(0, localaipj);
  ...
  /* Error */
  public aipj a(long paramLong)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 47	aips:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   6: invokevirtual 387	java/util/concurrent/CopyOnWriteArrayList:iterator	()Ljava/util/Iterator;
    //   9: astore 6
    //   11: aload 6
    ...
    //   28: checkcast 389	aipj
    //   31: astore 5
    //   33: aload 5
    //   35: ifnull -24 -> 11
    //   38: aload 5
    //   40: invokevirtual 422	aipj:a	()Lcom/tencent/mobileqq/apollo/ApolloSurfaceView;
    //   43: astore 7
    //   45: aload 7
    //   47: ifnull -36 -> 11
    //   50: aload 7
    //   52: invokevirtual 428	com/tencent/mobileqq/apollo/ApolloSurfaceView:getLuaState	()J
    //   55: lstore_3
    //   56: lload_3
    //   57: lload_1
    //   58: lcmp
  ...
  public List<aipv> a()
  {
    ...
    Collections.sort(localArrayList, new aipt(this));
  ...
  public void a()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localaipv != null) {
        ...
        {
          localArrayList.add(localaipv);
          QLog.e("cmgame_process.CmGameManager", 1, "checkValidGameTask remove invalid 1 gameTask:" + localaipv.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam);
        }
        else
        {
          if (localaipv.jdField_a_of_type_JavaLangRefWeakReference.get() == null) {
            localArrayList.add(localaipv);
          }
          QLog.e("cmgame_process.CmGameManager", 1, "checkValidGameTask remove invalid 2 gameTask:" + localaipv.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam);
        }
      }
    }
  ...
  public void a(Activity paramActivity, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        localaipv = (aipv)localIterator.next();
        if ((localaipv != null) && (localaipv.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId == paramStartCheckParam.gameId))
        {
          localaipv.jdField_a_of_type_Int = 1;
          localaipv.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
          QLog.d("cmgame_process.CmGameManager", 1, "onGameActivityCreate foundTask" + localaipv);
        }
      }
      for (;;)
      {
        ...
        localaipv = new aipv();
        localaipv.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam = paramStartCheckParam;
        localaipv.jdField_a_of_type_JavaLangString = paramActivity.getClass().getSimpleName();
        localaipv.jdField_a_of_type_Int = 1;
        localaipv.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
        this.jdField_a_of_type_JavaUtilList.add(localaipv);
        return;
        localaipv = null;
      }
    }
  ...
  /* Error */
  public aipj b(int paramInt1, int paramInt2)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   36: iload_1
    //   37: aload_3
    //   38: invokevirtual 391	aipj:a	()I
    //   41: if_icmpne -30 -> 11
    //   44: iload_2
    //   45: aload_3
    //   46: getfield 405	aipj:d	I
    //   49: if_icmpne -38 -> 11
    //   52: aload_0
    //   53: getfield 47	aips:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   56: aload_3
    //   57: invokevirtual 524	java/util/concurrent/CopyOnWriteArrayList:remove	(Ljava/lang/Object;)Z
    //   60: ifeq -49 -> 11
    //   63: ldc 70
    //   65: iconst_1
    //   66: new 167	java/lang/StringBuilder
    //   69: dup
    //   70: invokespecial 168	java/lang/StringBuilder:<init>	()V
    //   73: ldc_w 526
    //   76: invokevirtual 172	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   79: iload_1
    //   80: invokevirtual 413	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   83: ldc_w 415
    //   86: invokevirtual 172	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   89: aload_0
    //   90: getfield 47	aips:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   93: invokevirtual 418	java/util/concurrent/CopyOnWriteArrayList:size	()I
    //   96: invokevirtual 413	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
  ...
  public void b(Activity paramActivity, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localaipv != null) && (localaipv.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId == paramStartCheckParam.gameId))
        {
          localaipv.jdField_a_of_type_Int = 2;
          localaipv.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
          localaipv.jdField_a_of_type_Long = System.currentTimeMillis();
          QLog.d("cmgame_process.CmGameManager", 1, "onGameActivityResume foundTask" + localaipv);
        }
      }
      for (paramActivity = localaipv; (paramActivity == null) && (paramStartCheckParam != null); paramActivity = null)
      {
  ...
  public void c(Activity paramActivity, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    if ((paramStartCheckParam != null) && (paramActivity != null))
    {
      ...
      while (localIterator.hasNext())
      {
        paramActivity = (aipv)localIterator.next();
