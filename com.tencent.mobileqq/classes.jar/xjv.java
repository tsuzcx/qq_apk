...
public class xjv
{
  ...
  private umy jdField_a_of_type_Umy = new umy();
  ArrayList<bedl> b;
  private ArrayList<xkl> jdField_c_of_type_JavaUtilArrayList = new ArrayList();
  
  static
  {
    jdField_a_of_type_JavaLangString = BaseApplicationImpl.sApplication.getFilesDir() + File.separator + "blessVoiceChange.json";
    jdField_b_of_type_JavaLangString = alof.aX + "voiceChange/bless/";
    jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
    a();
  }
  
  public xjv(EditVideoMusic paramEditVideoMusic, EditVideoParams paramEditVideoParams, Handler paramHandler)
  {
  ...
  private boolean a()
  {
    ...
    if (this.jdField_b_of_type_JavaUtilArrayList == null)
    {
      ...
      if (i < ListenChangeVoicePanel.jdField_a_of_type_ArrayOfInt.length)
      {
        ...
        for (j = 0;; j = 2)
        {
          ((ArrayList)localObject1).add(new bedl(k, (String)localObject4, (String)localObject5, 0, j, 1, new bedm(ListenChangeVoicePanel.jdField_b_of_type_ArrayOfInt[i], null, null, null)));
          i += 1;
          break;
        }
      }
    ...
    if (localObject1 == null)
    {
      ...
      {
        localObject1 = (bedl)this.jdField_b_of_type_JavaUtilArrayList.get(i);
        if (localObject1 != null) {
          ((bedl)localObject1).jdField_b_of_type_Int = 0;
        }
        i += 1;
      }
      return false;
    ...
    for (;;)
    {
      ...
      catch (Exception localException2)
      {
        ...
        localObject4 = (bedl)localIterator.next();
        if (localArrayList.contains(Integer.valueOf(((bedl)localObject4).jdField_a_of_type_Int))) {
          continue;
        }
        ((bedl)localObject4).jdField_b_of_type_Int = 0;
        continue;
      ...
      {
        localObject5 = (bedl)((Iterator)localObject4).next();
        if (!localArrayList.contains(Integer.valueOf(((bedl)localObject5).jdField_a_of_type_Int))) {
          ((bedl)localObject5).jdField_b_of_type_Int = 0;
        }
      }
      label929:
      j += 1;
    ...
    if (this.jdField_b_of_type_JavaUtilArrayList != null)
    {
      localObject3 = (bedl)this.jdField_b_of_type_JavaUtilArrayList.get(j);
      label956:
      ...
      else
      {
        ...
        if (k != 0)
        {
          ...
          {
            j = k;
            if (bdtd.a(((JSONObject)localObject4).getString("QQVersion"), "8.3.5"))
            {
              k = 0;
              j = k;
              if (QLog.isColorLevel())
        ...
        if (j == 0)
        {
          ((bedl)localObject3).jdField_b_of_type_Int = j;
        }
        else
        {
          ...
          for (;;)
          {
            ...
            ((bedl)localObject3).d = 1;
            ((bedl)localObject3).c = 0;
            if (!TextUtils.isEmpty(((JSONObject)localObject6).getString("name"))) {
              break label1364;
            }
            localObject4 = ((bedl)localObject3).jdField_a_of_type_JavaLangString;
            label1225:
            ((bedl)localObject3).jdField_a_of_type_JavaLangString = ((String)localObject4);
            if (!TextUtils.isEmpty(((JSONObject)localObject6).getString("description"))) {
              break label1377;
            }
            localObject4 = ((bedl)localObject3).jdField_b_of_type_JavaLangString;
            label1253:
            ((bedl)localObject3).jdField_b_of_type_JavaLangString = ((String)localObject4);
            ((bedl)localObject3).jdField_a_of_type_Bedm.jdField_a_of_type_JavaLangString = ((String)localObject5);
            break label1632;
            localObject5 = bdrh.jdField_a_of_type_JavaLangString + (String)localObject5;
    ...
    for (int j = ((JSONObject)localObject4).getInt("tag");; j = 0)
    {
      ...
      if (localArrayList.size() > 0)
      {
        ...
        {
          localObject4 = (bedl)((Iterator)localObject3).next();
          if (!localArrayList.contains(Integer.valueOf(((bedl)localObject4).jdField_a_of_type_Int))) {
            ((bedl)localObject4).jdField_b_of_type_Int = 0;
          }
        }
      ...
      while (i < this.jdField_b_of_type_JavaUtilArrayList.size())
      {
        localObject3 = (bedl)this.jdField_b_of_type_JavaUtilArrayList.get(i);
        if (localObject3 != null) {
          ((bedl)localObject3).jdField_b_of_type_Int = 0;
        }
        i += 1;
      }
      return true;
      ...
      while (i < this.jdField_b_of_type_JavaUtilArrayList.size())
      {
        localObject4 = (bedl)this.jdField_b_of_type_JavaUtilArrayList.get(i);
        if (localObject4 != null) {
          ((bedl)localObject4).jdField_b_of_type_Int = 0;
        }
        i += 1;
  ...
  private void d()
  {
    ...
    new xjw(this, this.jdField_a_of_type_Umy, l).executeOnExecutor(Bosses.get().getExecutor(16), new uyc[] { new uyc(str1, str2, null) });
  }
  ...
  public void a(xkl paramxkl)
  {
    ...
    if (a((Object[])localObject2))
    {
      ...
      if (!localFile.exists()) {
        bdhb.a(new File((String)localObject1), localFile);
      }
      localObject2 = new bedk((String)localObject2, i, 64000, 2, paramxkl.c);
      bedn.a(BaseApplicationImpl.getContext(), (bedk)localObject2, jdField_c_of_type_JavaLangString, new xjx(paramxkl, (String)localObject1), new bedp(false, false, false, true, true, null));
      localObject1 = new Properties();
      ((Properties)localObject1).setProperty("bless_param_voice_id", "" + paramxkl.c);
      ahct.a("bless_event_voice_click", (Properties)localObject1);
    }
  }
  ...
  protected void b()
  {
    ...
    if (a((Object[])localObject))
    {
      ...
      if (localFile.exists()) {
        bdhb.a(localFile, new File((String)localObject));
      }
    }
  }
  ...
  public void c()
  {
    ...
    synchronized (this.jdField_c_of_type_JavaUtilArrayList)
    {
      ...
      {
        bedl localbedl = (bedl)localIterator.next();
        if (localbedl.jdField_b_of_type_Int == 2)
        {
          xkl localxkl = new xkl(4, localbedl.jdField_a_of_type_JavaLangString, localbedl.jdField_a_of_type_Bedm.jdField_a_of_type_Int, localbedl.jdField_a_of_type_Int);
          if ((localbedl.jdField_a_of_type_Bedm.jdField_a_of_type_Int == 0) && (!TextUtils.isEmpty(localbedl.jdField_a_of_type_Bedm.jdField_a_of_type_JavaLangString))) {
            localxkl.g = (jdField_b_of_type_JavaLangString + localbedl.jdField_a_of_type_Bedm.jdField_a_of_type_JavaLangString.substring(localbedl.jdField_a_of_type_Bedm.jdField_a_of_type_JavaLangString.lastIndexOf("/") + 1));
          }
          this.jdField_c_of_type_JavaUtilArrayList.add(localxkl);
        }
      }
    }
