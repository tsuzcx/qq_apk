  ...
  extends ViewBase
{
  ...
  private RecyclerView.OnScrollListener jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$OnScrollListener = new pca(this);
  ...
  private pcj jdField_a_of_type_Pcj;
  private pcv jdField_a_of_type_Pcv;
  ...
  public pbz(VafContext paramVafContext)
  {
  ...
  {
    this.jdField_a_of_type_Pcj = new pcj(paramVafContext);
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView.setAdapter(this.jdField_a_of_type_Pcj);
    this.jdField_a_of_type_Pcj.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView);
    this.jdField_a_of_type_Pcj.a(new pcb(this));
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView.addOnChildAttachStateChangeListener(new pcc(this));
  ...
  private void b()
  {
    ...
    {
      return;
      int m = this.jdField_a_of_type_Pcj.a();
        ...
        if (m > k)
        {
          ...
          if (i < m)
          {
            ...
            if (i == 0)
            {
              ...
              this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = localContext.getResources().getDrawable(2130848202);
              this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = localContext.getResources().getDrawable(2130848203);
  ...
  private void c()
  {
    if ((this.jdField_e_of_type_Boolean) && (this.jdField_a_of_type_Pci != null))
    {
      if (this.jdField_a_of_type_Pcj.a() > 1)
      {
        this.jdField_a_of_type_Pci.a();
        this.jdField_a_of_type_Pci.a(this.jdField_b_of_type_Int);
        this.jdField_a_of_type_Pci.b(this.jdField_c_of_type_Int);
      }
    }
    else {
      return;
    }
    this.jdField_a_of_type_Pci.b();
  }
  ...
  private void d()
  {
    ...
    for (float f1 = 1.0F;; f1 = 0.0F)
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView.setOnStateChangeListener(new pcg(this));
      return;
    }
  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Pcj == null) {
      return;
    }
    b();
  }
  ...
  {
    this.jdField_a_of_type_Pcj.a(paramopw);
    a();
  }
  
  public void a(pby parampby)
  {
  ...
  {
    this.jdField_a_of_type_Pcj.a(parampct);
  }
  ...
  public void onParseValueFinished()
  {
    ...
    d();
    if ((this.jdField_a_of_type_Int == 1) && (this.jdField_a_of_type_Pci == null))
    {
      this.jdField_a_of_type_Pci = new pci();
      this.jdField_a_of_type_Pci.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView);
      this.jdField_a_of_type_Pci.a(new pcf(this));
    }
    if (this.jdField_a_of_type_Pcv == null)
    {
      this.jdField_a_of_type_Pcv = new pcv(this.jdField_f_of_type_Boolean, this.jdField_a_of_type_ArrayOfInt[0], this.jdField_a_of_type_ArrayOfInt[1], this.jdField_a_of_type_ArrayOfInt[2], this.jdField_a_of_type_ArrayOfInt[3]);
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView.addItemDecoration(this.jdField_a_of_type_Pcv);
    }
    ...
    for (int i = 0;; i = 8)
    {
      ...
      this.jdField_a_of_type_Pcj.a(this.jdField_d_of_type_Boolean);
      c();
      return;
    }
  }
  ...
  public boolean setAttribute(int paramInt, Object paramObject)
  {
    ...
    case 1052: 
      try
      {
        ...
        this.jdField_a_of_type_Pcj.a(localList);
