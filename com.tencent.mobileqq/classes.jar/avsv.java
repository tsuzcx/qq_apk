...
public class avsv
{
  ...
  static
  {
    ...
    File localFile1 = new File(aljq.aX, "ocr");
  ...
  public static String a(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    //   88: lstore 5
    //   90: goto -72 -> 18
    //   93: invokestatic 178	avsv:a	()Ljava/lang/String;
    //   96: iconst_1
    //   97: invokestatic 180	avsv:a	(Ljava/lang/String;Z)Ljava/lang/String;
    //   100: astore 9
    //   102: iload_2
    //   103: ifle +19 -> 122
    //   106: iload_1
    ...
    //   146: bipush 100
    //   148: invokestatic 190	avsv:a	(Ljava/lang/String;Landroid/graphics/YuvImage;I)Z
    //   151: ifne +13 -> 164
    //   154: ldc 41
    //   156: iconst_1
    //   157: ldc 192
    ...
    //   163: areturn
    //   164: aload 9
    //   166: invokestatic 195	avsv:a	(Ljava/lang/String;)[B
    //   169: astore_0
    //   170: aload_0
    ...
    //   190: iconst_0
    //   191: iconst_0
    //   192: getstatic 203	azgq:a	I
    //   195: getstatic 205	azgq:b	I
    //   198: invokespecial 208	android/graphics/Rect:<init>	(IIII)V
    //   201: iconst_0
    //   202: iconst_0
    //   203: invokestatic 213	anwv:a	([BLandroid/graphics/Rect;ZI)Landroid/graphics/Bitmap;
    //   206: astore 8
    //   208: aload 8
    ...
    //   255: iload 4
    //   257: iconst_1
    //   258: invokestatic 230	anwv:a	(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;
    //   261: astore_0
    //   262: aload_0
    //   263: astore 7
    ...
    //   320: invokestatic 237	bdda:b	(Landroid/graphics/Bitmap;ILjava/io/File;)Z
    //   323: pop
    //   324: aload_0
    //   325: astore 7
    //   327: ldc 41
    ...
    //   397: invokestatic 237	bdda:b	(Landroid/graphics/Bitmap;ILjava/io/File;)Z
    //   400: pop
    //   401: goto -66 -> 335
    //   404: astore 7
    //   406: aload_0
    ...
    //   418: astore 7
    //   420: aload_0
    //   421: invokestatic 247	anwv:a	(Landroid/graphics/Bitmap;)Z
    //   424: pop
    ...
    //   466: aload_0
    //   467: invokestatic 247	anwv:a	(Landroid/graphics/Bitmap;)Z
    //   470: pop
  ...
  public static String a(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, android.graphics.RectF paramRectF, boolean paramBoolean)
  {
    ...
    //   97: lstore 9
    //   99: goto -84 -> 15
    //   102: invokestatic 178	avsv:a	()Ljava/lang/String;
    //   105: iconst_1
    //   106: invokestatic 180	avsv:a	(Ljava/lang/String;Z)Ljava/lang/String;
    //   109: astore 13
    //   111: iload 7
    //   113: ifeq +22 -> 135
    //   116: aload_0
    ...
    //   179: bipush 100
    //   181: invokestatic 190	avsv:a	(Ljava/lang/String;Landroid/graphics/YuvImage;I)Z
    //   184: ifne +13 -> 197
    //   187: ldc 41
    //   189: iconst_1
    //   190: ldc 192
    ...
    //   196: areturn
    //   197: aload 13
    //   199: invokestatic 195	avsv:a	(Ljava/lang/String;)[B
    //   202: astore 11
    //   204: goto -85 -> 119
    //   207: aconst_null
    //   208: astore 12
    ...
    //   219: iconst_0
    //   220: iconst_0
    //   221: getstatic 203	azgq:a	I
    //   224: getstatic 205	azgq:b	I
    //   227: invokespecial 208	android/graphics/Rect:<init>	(IIII)V
    //   230: iconst_0
    //   231: iconst_0
    //   232: invokestatic 213	anwv:a	([BLandroid/graphics/Rect;ZI)Landroid/graphics/Bitmap;
    //   235: astore 14
    //   237: aload 14
    ...
    //   285: aload 12
    //   287: astore_0
    //   288: invokestatic 266	anvz:a	()Lanvz;
    //   291: iload 4
    //   293: iload 5
    //   295: invokestatic 269	anwv:a	(Lanvz;II)I
    //   298: istore_3
    //   299: aload 12
    //   301: astore_0
    //   302: aload 14
    //   304: iload_3
    //   305: iconst_1
    //   306: invokestatic 230	anwv:a	(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;
    //   309: astore 11
    //   311: aload 11
    //   313: astore_0
    //   314: aload_0
    ...
    //   594: invokestatic 237	bdda:b	(Landroid/graphics/Bitmap;ILjava/io/File;)Z
    //   597: pop
    //   598: aload 6
    //   600: astore_0
    //   601: aload 6
    ...
    //   772: invokestatic 237	bdda:b	(Landroid/graphics/Bitmap;ILjava/io/File;)Z
    //   775: pop
    //   776: goto -163 -> 613
    //   779: astore 6
    //   781: aload_0
    ...
    //   793: astore 11
    //   795: aload_0
    //   796: invokestatic 247	anwv:a	(Landroid/graphics/Bitmap;)Z
    //   799: pop
    ...
    //   845: astore 11
    //   847: aload_0
    //   848: invokestatic 247	anwv:a	(Landroid/graphics/Bitmap;)Z
    //   851: pop
