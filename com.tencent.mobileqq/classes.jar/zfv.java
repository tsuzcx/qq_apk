...
{
  zfv(zft paramzft, long paramLong, String paramString) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (((WebSSOAgent.UniSsoServerRsp)localObject3).comm.has())
        {
          ...
          if (!TextUtils.isEmpty(paramBundle))
          {
            if (((WebSSOAgent.UniSsoServerRsp)localObject3).comm.delayms.has())
            {
              ...
              this.jdField_a_of_type_Zft.e.put(paramBundle, Integer.valueOf(2147483647));
              if (QLog.isColorLevel()) {
            ...
            if (((WebSSOAgent.UniSsoServerRsp)localObject3).comm.packagesize.has())
            {
              ...
              this.jdField_a_of_type_Zft.b.put(paramBundle, Long.valueOf(l1));
              if (QLog.isColorLevel()) {
        ...
        zft.a(this.jdField_a_of_type_Zft, this.jdField_a_of_type_JavaLangString, l2, paramInt);
        ...
        atkg.d = System.currentTimeMillis();
        l1 = atkg.d - atkg.jdField_a_of_type_Long;
        long l3 = atkg.b - atkg.jdField_a_of_type_Long;
        long l4 = atkg.c - atkg.b;
        long l5 = atkg.d - atkg.c;
        if (QLog.isColorLevel()) {
        ...
        this.jdField_a_of_type_Zft.callJs((String)localObject1, new String[] { ((JSONObject)localObject2).toString() });
        try
        {
          ...
          localObject3 = this.jdField_a_of_type_Zft.mRuntime.a().getCurrentAccountUin();
          ...
          localObject1 = azri.a(this.jdField_a_of_type_Zft.mRuntime.a());
          if (0L != l6) {
            break;
          }
          paramBoolean = true;
          label1110:
          ((azri)localObject1).a((String)localObject3, paramBundle, paramBoolean, l1, 0L, (HashMap)localObject2, "", false);
          return;
        }
      ...
      return;
      label1197:
      this.jdField_a_of_type_Zft.e.put(paramBundle, Integer.valueOf((int)l1));
      continue;
      label1218:
      zft.a(this.jdField_a_of_type_Zft, this.jdField_a_of_type_JavaLangString, paramInt);
      continue;
      label1233:
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject3)) {
        zft.b(this.jdField_a_of_type_Zft, (String)localObject3, paramInt);
      }
      ...
      ((JSONObject)localObject2).put("businessRet", 0);
      ((JSONObject)localObject2).put("msg", alud.a(2131714730));
    }
    for (;;)
    {
      label1431:
      ...
      ((JSONObject)localObject2).put("businessRet", 0);
      ((JSONObject)localObject2).put("msg", alud.a(2131714736));
      break;
      label1510:
      label1511:
      do
      {
        ((JSONObject)localObject2).put("ssoRet", 255);
        ((JSONObject)localObject2).put("businessRet", 0);
        ((JSONObject)localObject2).put("msg", alud.a(2131714735));
        break;
        paramBoolean = false;
        break label1110;
        return;
