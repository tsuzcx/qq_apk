...
public class awbk
{
  ...
  {
    int i = 0;
    int j = bajr.a(paramQQAppInterface, paramString);
    if ((j & 0x4) != 0) {
      i = 2;
    }
    while ((j & 0x2) == 0) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (paramString != null)
    {
      ...
      {
        i = j;
        if (akbm.a((MessageRecord)paramString.get(paramString.size() - 1), localMessageRecord, false))
        {
