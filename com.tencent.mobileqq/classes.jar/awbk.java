...
public class awbk
{
  public static Map<String, awbk> a;
  public int a;
  public int b;
  public int c;
  public int d;
  ...
  private static void a(String paramString1, String paramString2)
  {
    try
    {
      ...
      awbk localawbk = new awbk();
      localawbk.jdField_a_of_type_Int = paramString2.optInt("startupId");
      localawbk.b = paramString2.optInt("downloadSucId");
      localawbk.c = paramString2.optInt("downloadFailId");
      localawbk.d = paramString2.optInt("loadSucId");
      localawbk.e = paramString2.optInt("loadFailId");
      localawbk.f = paramString2.optInt("startSucId");
      localawbk.g = paramString2.optInt("firstUserId");
      localawbk.h = paramString2.optInt("exitId");
      jdField_a_of_type_JavaUtilMap.put(paramString1, localawbk);
      if (QLog.isColorLevel()) {
        QLog.d("MonitorConfig", 2, paramString1 + localawbk);
      }
      return;
    }
  ...
  public static void b(Context paramContext, String paramString)
  {
    if (jdField_a_of_type_JavaUtilMap.get(paramString) != null)
    {
      awbj.b(String.valueOf(((awbk)jdField_a_of_type_JavaUtilMap.get(paramString)).jdField_a_of_type_Int));
      return;
    }
    if (QLog.isColorLevel()) {
