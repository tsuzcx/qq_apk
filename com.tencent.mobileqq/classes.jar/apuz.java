...
public class apuz
  extends aptd
  implements aghc, apww
{
  private static int jdField_a_of_type_Int;
  private float jdField_a_of_type_Float;
  private TextWatcher jdField_a_of_type_AndroidTextTextWatcher = new apvc(this);
  ...
  public apuz(EmoticonPanelController paramEmoticonPanelController)
  {
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    localValueAnimator.addUpdateListener(new apvb(this));
  ...
  private void a(String paramString)
  {
    ...
    {
      localapwv = (apwv)this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonPanelController.jdField_b_of_type_JavaUtilList.get(EmoticonPanelController.jdField_b_of_type_Int);
      if (localapwv.jdField_a_of_type_Int != 7) {
        break label88;
      }
      azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", paramString, paramString, 1, 0, "", "", "", "");
    }
    label88:
    do
    {
      return;
      if (localapwv.jdField_a_of_type_Int == 4)
      {
        azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", paramString, paramString, 2, 0, "", "", "", "");
        return;
      }
      if (localapwv.jdField_a_of_type_Int == 11)
      {
        azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", paramString, paramString, 3, 0, "", "", "", "");
        return;
      }
      if (localapwv.jdField_a_of_type_Int == 8)
      {
        azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", paramString, paramString, 4, 0, "", "", "", "");
        return;
      }
      if (localapwv.jdField_a_of_type_Int == 10)
      {
        azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", paramString, paramString, 5, 0, "", "", "", "");
        return;
      }
    } while ((localapwv.jdField_a_of_type_Int != 9) && (localapwv.jdField_a_of_type_Int != 6));
    azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", paramString, paramString, 6, 0, "", "", "", "");
  }
  ...
  public boolean a()
  {
    return (this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonPanelController.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null) && (!this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonPanelController.jdField_a_of_type_Apux.a) && (this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonPanelController.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx != null);
  }
    ...
    for (;;)
    {
      ...
      if ((j != jdField_a_of_type_Int) && (j != this.jdField_b_of_type_Int))
      {
        ...
        for (;;)
        {
          ...
          paramMotionEvent.addUpdateListener(new apva(this, i));
  ...
  public void c()
  {
    if (a())
    {
      ...
      {
        Object localObject = (apwv)this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonPanelController.jdField_b_of_type_JavaUtilList.get(EmoticonPanelController.jdField_b_of_type_Int);
        localObject = this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonPanelController.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmotionPanelViewPagerAdapter.a((apwv)localObject);
        if ((localObject != null) && (((apte)localObject).a() != null))
        {
          bhtv localbhtv = ((apte)localObject).a().getOnScrollListener();
          if ((localbhtv instanceof apvn)) {
            ((apvn)localbhtv).a(((apte)localObject).a());
          }
        }
      }
    }
