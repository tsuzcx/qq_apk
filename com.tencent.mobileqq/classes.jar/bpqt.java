  ...
  implements ThreadExcutor.IThreadListener
{
  ...
  public bpqt(String paramString)
  {
    this.jdField_a_of_type_Int = -1;
    this.jdField_a_of_type_JavaLangString = paramString;
  }
  
  public static bpqt a(String paramString)
  {
    bpqt localbpqt = new bpqt(paramString);
    for (;;)
    {
      try
      {
        ...
        localObject = nlw.a(BaseApplicationImpl.getApplication().getApplicationContext(), (String)localObject, null, "GET", null, null, 10000, 10000);
        int i;
        if ((localObject != null) && (((HttpResponse)localObject).getStatusLine().getStatusCode() == 200))
        {
          localObject = new JSONObject(nlw.a((HttpResponse)localObject));
          ...
          if (i == 0)
          {
            ...
            localbpqt.jdField_a_of_type_Int = 0;
            if (!((JSONObject)localObject).has("errTypeCode")) {
              break label357;
            }
            str = "2";
            localObject = ((JSONObject)localObject).getString("errTypeCode");
            yqu.a("video_edit", "url_rich", 0, 0, new String[] { str, localObject, paramString });
          }
        }
        else
        {
          ...
          QLog.i("LinkerObject", 2, "parse result,mResultCode:" + localbpqt.jdField_a_of_type_Int + ",mShareTitle:" + localbpqt.b + ",mShareDesc:" + localbpqt.c + ",mShareThumb:" + localbpqt.d);
          return localbpqt;
        }
        if (!QLog.isColorLevel()) {
          continue;
  ...
  public void a(bpqu parambpqu)
  {
    this.jdField_a_of_type_Bpqu = parambpqu;
  }
  ...
  {
    if (this.jdField_a_of_type_Bpqu != null)
    {
      if (this.jdField_a_of_type_Int == 0) {
        this.jdField_a_of_type_Bpqu.a(this);
      }
    }
    else {
      return;
    }
    this.jdField_a_of_type_Bpqu.a(this, this.jdField_a_of_type_Int);
  }
