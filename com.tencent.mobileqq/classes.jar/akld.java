  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    Object localObject = ((TextView)this.a.jdField_a_of_type_ComTencentOpenAgentAuthorityLoginView.jdField_a_of_type_AndroidViewView.findViewById(2131365699)).getText().toString();
    ...
    for (;;)
    {
      ...
      ((BaseActivity)AuthorityLoginView.a(this.a.jdField_a_of_type_ComTencentOpenAgentAuthorityLoginView)).runOnUiThread(new aklf(this));
      return;
      label228:
    ...
    for (;;)
    {
      ((BaseActivity)AuthorityLoginView.a(this.a.jdField_a_of_type_ComTencentOpenAgentAuthorityLoginView)).runOnUiThread(new akle(this, (String)localObject));
      break;
      i += 1;
      break label296;
      localObject = null;
