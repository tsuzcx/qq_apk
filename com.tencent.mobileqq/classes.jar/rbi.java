  ...
  extends rbt
{
  ...
  public rbi(View paramView, int paramInt)
  {
    ...
    if (paramInt == 4)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131361990));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362001));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131361965));
    }
    for (;;)
    {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdViewReadInJoyAdGestureView = ((ReadInJoyAdGestureView)paramView.findViewById(2131361956));
      this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131362026));
      this.jdField_d_of_type_AndroidViewView = paramView.findViewById(2131362027);
      this.jdField_e_of_type_AndroidViewView = paramView.findViewById(2131362028);
      this.jdField_f_of_type_AndroidViewView = paramView.findViewById(2131362029);
      return;
      if ((paramInt == 5) || (paramInt == 7))
      {
        ...
        this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131361990));
        this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362001));
        this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362024));
        this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131361991));
        this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131361992);
  ...
  public void a(raw paramraw, LinearLayoutManager paramLinearLayoutManager, boolean paramBoolean)
  {
    int i1 = 1;
    super.a(paramraw, paramLinearLayoutManager, paramBoolean);
    ...
    for (float f1 = Math.abs(paramLinearLayoutManager.getDecoratedTop(this.itemView) - (paramLinearLayoutManager.getHeight() / 2 - i1 / 2)) / i1;; f1 = Math.abs(paramLinearLayoutManager.getDecoratedLeft(this.itemView) - (paramLinearLayoutManager.getWidth() / 2 - i1 / 2)) / i1)
    {
      ...
      odt.a(raw.a(paramraw), f1, this, paramBoolean);
      return;
      i1 = 0;
      break;
      label129:
