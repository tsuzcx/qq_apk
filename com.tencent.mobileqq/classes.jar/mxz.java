  ...
  extends mxw
{
  ...
  protected mxz(AppInterface paramAppInterface)
  {
  ...
  private ngd a()
  {
    ...
    if ((this.mApp instanceof AVGameAppInterface)) {
      localngd = ((AVGameAppInterface)this.mApp).a();
    }
    return localngd;
  }
  ...
  private void a(int paramInt, List<String> arg2, HashMap<String, String> paramHashMap)
  {
    ...
    if (localObject != null)
    {
      ...
      ((ngd)localObject).a(paramInt, ???, paramHashMap);
  ...
  public static UserInfo b(String paramString)
  {
    ...
    if (localObject != null)
    {
      localObject = (mxz)((AVGameAppInterface)localObject).a(2);
      if (localObject != null) {
        return ((mxz)localObject).a(paramString);
      }
    }
    return null;
  }
  ...
  public Bitmap b(int paramInt1, String paramString, byte paramByte, int paramInt2)
  {
    Object localObject = a();
    if (localObject == null) {}
    for (localObject = null;; localObject = ((ngd)localObject).a(paramInt1, paramString, paramByte, paramInt2))
    {
      if (localObject != null) {}
      try
      {
  ...
  public UserInfo b(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      ...
      return localObject1;
      localObject1 = ((ngd)localObject2).a(paramInt, paramString);
    }
  }
