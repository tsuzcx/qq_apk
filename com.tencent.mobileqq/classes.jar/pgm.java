...
public class pgm
  extends Handler
{
  public pgm(OfflinePlugin paramOfflinePlugin, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        ((OfflineUpdateStatus)localObject2).a(3);
      } while (localException2 == null);
      paramMessage = localException2.getResources().getDrawable(2130838578);
    ...
    if ((paramMessage.arg2 == 5) || (paramMessage.arg2 == 7))
    {
      ...
      ((OfflineUpdateStatus)localObject2).a(4);
      return;
    }
    QRUtils.a(1, 2131430205);
    if (this.a.jdField_a_of_type_AndroidWidgetRelativeLayout != null) {
      this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
    }
    ((OfflineUpdateStatus)localObject2).a(4);
