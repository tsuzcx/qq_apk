...
public class apgb
{
  ...
  private WeakReference<apmi> jdField_a_of_type_JavaLangRefWeakReference;
  private WeakReference<apmi> b;
  private WeakReference<apmi> c;
  private WeakReference<apmi> d;
  
  public apgb(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Apmd = new apmd(paramQQAppInterface);
  }
  
  private apmi a(String paramString)
  {
    ...
    if (paramString.equalsIgnoreCase("arsdk2"))
    {
      ...
      if (this.jdField_a_of_type_JavaLangRefWeakReference != null) {
        localObject1 = (apmi)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      }
    }
    do
    {
      ...
      do
      {
        do
        {
          do
          {
            ...
            return (apmi)this.b.get();
            if (!paramString.equalsIgnoreCase("arfeature")) {
              break;
            }
            localObject1 = localObject2;
          } while (this.d == null);
          return (apmi)this.d.get();
          localapjd = apjb.a();
          localObject1 = localObject2;
        } while (localapjd == null);
        localObject1 = localObject2;
      } while (!paramString.equalsIgnoreCase(localapjd.a()));
      localObject1 = localObject2;
    } while (this.c == null);
    return (apmi)this.c.get();
  }
  ...
  private String a(String paramString)
  {
    ...
    if ((localapjd != null) && (paramString.equalsIgnoreCase(localapjd.a()))) {
      return localapjd.b();
    }
    return "";
  }
  
  private void a(ARCommonConfigInfo.NativeSoRes paramNativeSoRes, apmj paramapmj)
  {
    QLog.i("AREngine_ArNativeSoManager", 1, "downloadSoRes. fileName = " + paramapmj.c + ", url = " + paramapmj.jdField_a_of_type_JavaLangString);
    if (this.jdField_a_of_type_Apmd == null) {
      return;
    }
    this.jdField_a_of_type_Apmd.a(paramapmj, new apgd(this, paramNativeSoRes));
  }
  ...
  private void a(String paramString, apmi paramapmi)
  {
    if (paramString.equalsIgnoreCase("arsdk2")) {
      this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramapmi);
    }
    apjd localapjd;
    do
    {
      ...
      if (paramString.equalsIgnoreCase("arcloud"))
      {
        this.b = new WeakReference(paramapmi);
        return;
      }
      if (paramString.equalsIgnoreCase("arfeature"))
      {
        this.d = new WeakReference(paramapmi);
        return;
      }
      localapjd = apjb.a();
    } while ((localapjd == null) || (!paramString.equalsIgnoreCase(localapjd.a())));
    this.c = new WeakReference(paramapmi);
  }
  ...
  private void b(ArrayList<ARCommonConfigInfo.NativeSoRes> paramArrayList, String paramString, apmi paramapmi)
  {
    boolean bool = false;
    QLog.i("AREngine_ArNativeSoManager", 1, "downloadArNativeSo. resName = " + paramString);
    String str = a(paramString);
    a(paramString, paramapmi);
    ...
    for (;;)
    {
      if ((i != 0) && (this.jdField_a_of_type_Apmd != null))
      {
        localObject1 = apga.a(paramArrayList.jdField_a_of_type_JavaLangString, paramArrayList.b, paramArrayList.d) + File.separator + paramArrayList.d + ".zip";
        if (!b((String)localObject1, paramArrayList.d))
        {
          a((String)localObject1);
          if ((!TextUtils.isEmpty(paramArrayList.c)) && (!TextUtils.isEmpty(paramArrayList.d)))
          {
            localObject2 = new apmj();
            ((apmj)localObject2).jdField_a_of_type_Int = 5;
            ((apmj)localObject2).jdField_a_of_type_JavaLangString = paramArrayList.c;
            ((apmj)localObject2).b = paramArrayList.d;
            ((apmj)localObject2).d = paramArrayList.jdField_a_of_type_JavaLangString;
            ((apmj)localObject2).c = ((String)localObject1);
            ((apmj)localObject2).jdField_a_of_type_Boolean = true;
            this.jdField_a_of_type_Apmd.a((apmj)localObject2, new apgc(this, paramString, paramapmi));
          }
        }
      }
      label370:
      while (paramapmi == null)
      {
        do
        {
          do
          ...
          paramapmi.a(bool, null);
          return;
        } while (paramapmi == null);
        paramapmi.a(true, null);
        return;
      }
      paramapmi.a(false, null);
      return;
  ...
  private void b(ArrayList<ARCommonConfigInfo.NativeSoRes> paramArrayList1, ArrayList<ARCommonConfigInfo.NativeSoRes> paramArrayList2, String paramString)
  {
    ...
    if (i < paramArrayList2.size())
    {
      ...
      if (localNativeSoRes.jdField_a_of_type_JavaLangString.equalsIgnoreCase(paramString)) {
        ...
        {
          str2 = apga.a(localNativeSoRes.jdField_a_of_type_JavaLangString, localNativeSoRes.b, localNativeSoRes.d) + File.separator + localNativeSoRes.d + ".zip";
            ...
            if ((!TextUtils.isEmpty(localNativeSoRes.c)) && (!TextUtils.isEmpty(localNativeSoRes.d)))
            {
              ...
              while (j < paramArrayList1.size())
              {
                ...
                if ((((ARCommonConfigInfo.NativeSoRes)localObject).jdField_a_of_type_JavaLangString.equalsIgnoreCase(paramString)) && (((ARCommonConfigInfo.NativeSoRes)localObject).b.equalsIgnoreCase(str1))) {
                  a(apga.a(((ARCommonConfigInfo.NativeSoRes)localObject).jdField_a_of_type_JavaLangString), apga.a(((ARCommonConfigInfo.NativeSoRes)localObject).jdField_a_of_type_JavaLangString, ((ARCommonConfigInfo.NativeSoRes)localObject).b, ((ARCommonConfigInfo.NativeSoRes)localObject).d));
                }
                j += 1;
              }
              Object localObject = new apmj();
              ((apmj)localObject).jdField_a_of_type_Int = 5;
              ((apmj)localObject).jdField_a_of_type_JavaLangString = localNativeSoRes.c;
              ((apmj)localObject).b = localNativeSoRes.d;
              ((apmj)localObject).d = localNativeSoRes.jdField_a_of_type_JavaLangString;
              ((apmj)localObject).c = str2;
              ((apmj)localObject).jdField_a_of_type_Boolean = true;
              a(localNativeSoRes, (apmj)localObject);
            }
          }
        }
      }
  ...
  public int a(String paramString1, String paramString2, String paramString3)
  {
    ...
    //   11: aload_2
    //   12: aload_3
    //   13: invokestatic 271	apgj:a	(Ljava/lang/String;Ljava/lang/String;)I
    //   16: istore 4
    //   18: aload_0
    //   19: monitorexit
    //   20: iload 4
    ...
    //   32: aload_2
    //   33: aload_3
    //   34: invokestatic 272	apfm:a	(Ljava/lang/String;Ljava/lang/String;)I
    //   37: istore 4
    //   39: goto -21 -> 18
    //   42: aload_1
    //   43: ldc 51
    ...
    //   51: aload_2
    //   52: aload_3
    //   53: invokestatic 273	apfy:a	(Ljava/lang/String;Ljava/lang/String;)I
    //   56: istore 4
    //   58: goto -40 -> 18
    //   61: invokestatic 58	apjb:a	()Lapjd;
    //   64: astore 5
    //   66: aload 5
    //   68: ifnull +29 -> 97
    //   71: aload_1
    ...
    //   87: aload_2
    //   88: aload_3
    //   89: invokestatic 276	apjb:a	(Lapjd;Ljava/lang/String;Ljava/lang/String;)I
    //   92: istore 4
    //   94: goto -76 -> 18
    //   97: iconst_m1
    //   98: istore 4
  ...
  public void a(ArrayList<ARCommonConfigInfo.NativeSoRes> paramArrayList, String paramString, apmi paramapmi)
  {
    ThreadManager.getSubThreadHandler().post(new ArNativeSoManager.1(this, paramArrayList, paramString, paramapmi));
  }
  ...
  public boolean a(ArrayList<ARCommonConfigInfo.NativeSoRes> paramArrayList, String paramString)
  {
    ...
    for (;;)
    {
      if (i < paramArrayList.size())
      {
        ...
        paramArrayList = apga.a(localNativeSoRes.jdField_a_of_type_JavaLangString, localNativeSoRes.b, localNativeSoRes.d) + File.separator + localNativeSoRes.d + ".zip";
