  ...
  implements bajj
{
  ...
  public static bajj asInterface(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("com.tencent.mobileqq.theme.IDownloadListener");
    if ((localIInterface != null) && ((localIInterface instanceof bajj))) {
      return (bajj)localIInterface;
    }
    return new bajl(paramIBinder);
  }
