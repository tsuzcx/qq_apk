...
public class bajk
  implements Handler.Callback, aqkr, Manager
{
  public static final String a;
  private float jdField_a_of_type_Float = 7.0F;
  public int a;
  anmu jdField_a_of_type_Anmu = new bajl(this);
  private anxg jdField_a_of_type_Anxg = new bajm(this);
  private bkfv jdField_a_of_type_Bkfv = new bkfv(ThreadManager.getFileThreadLooper(), this);
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private final Object jdField_a_of_type_JavaLangObject = new Object();
  private WeakReference<bajo> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  private WeakReference<bajj> jdField_b_of_type_JavaLangRefWeakReference;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = anni.a(2131704485);
  }
  ...
  private Object[] a(boolean paramBoolean, String paramString)
  {
    ...
    if (!paramBoolean) {
      localObject2 = bgsg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), "breaking_ice_config");
    }
    bool6 = bool7;
    i1 = i2;
    n = i3;
  ...
  private void g()
  {
    ...
    Object localObject1 = bgmg.a(String.format("%s_%s", new Object[] { "break_ice_map", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }));
    ??? = bgmg.a(String.format("%s_%s", new Object[] { "entered_c2c", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }));
    ??? = bgmg.a(String.format("%s_%s", new Object[] { "entered_troop", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }));
    ??? = bgmg.a(String.format("%s_%s", new Object[] { "entered_match_chat", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }));
    ??? = bgmg.a(String.format("%s_%s", new Object[] { "entered_qcircle_chat", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }));
  ...
  private void h()
  {
    ...
    bgmg.a(String.format("%s_%s", new Object[] { "break_ice_map", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }), localConcurrentHashMap);
  }
    ...
    if (localTroopInfo.wMemberNum < this.jdField_b_of_type_Int)
    {
      ...
      if ((localObject2 == null) || (((List)localObject2).size() <= 1))
      {
        ...
        for (i = 0;; i = ((List)localObject2).size())
        {
          ...
          ((anwd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).o(paramString);
          return;
        }
      }
      ...
      if (((Iterator)localObject2).hasNext())
      {
        ...
        if ((TextUtils.isEmpty(str2)) || (str2.equals(str1)) || (((anmw)localObject1).b(str2))) {
          break label318;
        }
        i += 1;
      }
  ...
  public void a(bajj parambajj)
  {
    this.jdField_b_of_type_JavaLangRefWeakReference = new WeakReference(parambajj);
  }
  
  public void a(bajo parambajo)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambajo);
  }
  
  public void a(QQAppInterface paramQQAppInterface, int paramInt, String paramString, aqkq paramaqkq)
  {
    if ((paramaqkq != null) && ("breaking_ice_config".equals(paramString)))
    {
      if (!this.jdField_b_of_type_Boolean) {
        g();
      }
      paramQQAppInterface = a(true, paramaqkq.jdField_a_of_type_JavaLangString);
      ...
      if ((bool1 != this.jdField_c_of_type_Boolean) || (bool2 != this.jdField_d_of_type_Boolean))
      {
        ...
        if (a(this.jdField_c_of_type_Boolean, this.jdField_d_of_type_Boolean, paramQQAppInterface))
        {
          ...
          if (this.jdField_a_of_type_Bkfv.hasMessages(1)) {
            this.jdField_a_of_type_Bkfv.removeMessages(1);
          }
          this.jdField_a_of_type_Bkfv.sendEmptyMessage(1);
        }
      }
      if (QLog.isColorLevel())
      {
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2)
  {
    ...
    try
    {
      ...
      paramString1 = ((anmw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      ...
      for (;;)
      {
        ...
        paramString2 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), aijv.class);
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    {
      return;
      Object localObject = ((anmw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).e(paramString);
      boolean bool;
      int i;
      if ((localObject != null) && (((Friends)localObject).isFriend()))
      {
        ...
        {
          localObject = (bajo)this.jdField_a_of_type_JavaLangRefWeakReference.get();
          if (localObject != null) {
            ((bajo)localObject).a(paramString, false);
          }
        }
        if (this.jdField_a_of_type_Bkfv.hasMessages(1)) {
          this.jdField_a_of_type_Bkfv.removeMessages(1);
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    catch (Exception paramArrayOfByte)
    {
      ...
      if (QLog.isColorLevel())
      {
        QLog.d("IceBreak.HotPic", 2, bkgg.a(paramArrayOfByte));
        return;
        ...
        while (i < paramArrayOfByte.size())
        {
          ...
          localaijj.a(localImgInfo.bytes_img_word.get().toStringUtf8());
          ...
          ((List)localObject).add(localaijj);
          i += 1;
        }
  ...
  public void b()
  {
    ...
    bgmg.a(String.format("%s_%s", new Object[] { "entered_c2c", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }), localHashSet);
  }
  
  public void b(bajo parambajo)
  {
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() == parambajo)) {
  ...
  public void c()
  {
    ...
    bgmg.a(String.format("%s_%s", new Object[] { "entered_troop", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }), localHashSet);
  }
  ...
  public void d()
  {
    ...
    bgmg.a(String.format("%s_%s", new Object[] { "entered_match_chat", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }), localHashSet);
  }
  ...
  public void e()
  {
    ...
    bgmg.a(String.format("%s_%s", new Object[] { "entered_qcircle_chat", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }), localHashSet);
  }
  ...
  public boolean e(String paramString)
  {
    ...
    if (localObject != null)
    {
      if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
      {
        bajo localbajo = (bajo)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        if (localbajo != null) {
          localbajo.b(paramString, false);
        }
      }
      if (this.jdField_a_of_type_Bkfv.hasMessages(1)) {
        this.jdField_a_of_type_Bkfv.removeMessages(1);
  ...
  public boolean f(String paramString)
  {
    ...
    if (bool2)
    {
      paramString = ((anmw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).e(paramString);
  ...
  public void j(String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
          if (((asfu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(264)).e()) {
            break;
          }
      ...
      localbajo = (bajo)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (localbajo == null);
    localbajo.a(paramString, false);
  }
  ...
  {
    if (!aijp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b()) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      if ((localTroopMemberInfo == null) || (localTroopMemberInfo.last_active_time == localTroopMemberInfo.join_time))
      {
        ...
        this.jdField_d_of_type_JavaLangString = paramString;
        ((anwd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(Long.valueOf(paramString).longValue(), Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).longValue(), true);
        return;
      }
