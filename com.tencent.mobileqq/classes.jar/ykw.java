...
public class ykw
{
  ...
  public static int a(View paramView)
  {
    ...
    do
    {
      ...
      j = zlx.d(paramView.getContext()) / 2;
    } while (i <= 0);
    int i = Math.min(Math.abs(j - arrayOfInt[1]), Math.abs(j - (arrayOfInt[1] + i)));
    yqp.b("Q.qqstory.home.StoryListUtils", "getDistanceToCenterY=" + i);
    return i;
  }
  
  public static Bitmap a(Drawable paramDrawable, int paramInt1, int paramInt2, Map<String, Bitmap> paramMap, yki paramyki)
  {
    ...
    for (Bitmap localBitmap = (Bitmap)paramMap.get("w=" + paramInt1 + "h=" + paramInt2);; localBitmap = null)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          {
            ykv.b("Q.qqstory.home.StoryListUtils", new Object[] { "drawable2Bitmap need create width=", Integer.valueOf(paramInt1), ",height=", Integer.valueOf(paramInt2) });
          ...
          yqp.a("Q.qqstory.home.StoryListUtils", "drawable2Bitmap:width=%d,height=%d,cost time=%d", Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Long.valueOf(System.currentTimeMillis() - l));
          paramDrawable = (Drawable)localObject;
          if (paramyki == null) {
            break;
          }
          return paramyki.a((Bitmap)localObject);
        }
        catch (OutOfMemoryError paramDrawable)
        {
          label347:
          yqp.e("Q.qqstory.home.StoryListUtils", "drawable2Bitmap out off memory width=" + paramInt1 + ",height=" + paramInt2);
          return null;
        }
      }
  ...
  public static String a(int paramInt, boolean paramBoolean)
  {
    ...
    default: 
      if (TextUtils.isEmpty((CharSequence)localObject1)) {
        localObject2 = anni.a(2131713146);
      }
      break;
    }
    do
    {
      return localObject2;
      localObject1 = anni.a(2131713147);
      break;
      localObject1 = anni.a(2131713145);
      break;
      localObject1 = anni.a(2131713174);
      break;
      localObject1 = anni.a(2131713138);
      break;
      localObject1 = anni.a(2131713135);
      break;
      localObject1 = anni.a(2131713171);
      break;
      localObject1 = anni.a(2131713149);
      break;
      localObject1 = anni.a(2131713139);
      break;
      localObject1 = anni.a(2131713160);
      break;
      localObject1 = anni.a(2131713161);
      break;
      localObject1 = anni.a(2131713176);
      break;
      localObject1 = anni.a(2131713156);
      break;
      localObject1 = anni.a(2131713175);
      break;
      localObject1 = anni.a(2131713169);
      break;
      localObject1 = anni.a(2131713154);
      break;
      localObject1 = anni.a(2131713153);
      break;
      localObject1 = anni.a(2131713143);
      break;
      localObject1 = anni.a(2131713170);
      break;
      localObject1 = anni.a(2131713134);
      break;
      localObject1 = anni.a(2131713140);
      break;
      localObject1 = anni.a(2131713148);
      break;
      localObject1 = anni.a(2131713157);
      break;
      localObject1 = anni.a(2131713168);
      break;
      localObject1 = anni.a(2131713152);
      break;
      localObject1 = anni.a(2131713165);
      break;
      localObject1 = anni.a(2131713136);
      break;
      localObject2 = localObject1;
    } while (!paramBoolean);
    return anni.a(2131713158) + (String)localObject1;
  }
  ...
  {
    Object localObject = ((wfg)paramQQAppInterface.getManager(181)).a(false);
  ...
  public static void a(ArrayList<String> paramArrayList)
  {
    ...
    yqp.b("Q.qqstory.home.StoryListUtils", "reportShieldFriendStory:" + paramArrayList.size());
    ylg localylg = new ylg();
    localylg.a = paramArrayList;
    wfo.a().dispatch(localylg);
  }
  ...
  public static int b(View paramView)
  {
    ...
    yqp.b("Q.qqstory.home.StoryListUtils", "getDistanceToTop=" + i);
    return i;
  }
  ...
  public static String b(long paramLong)
  {
    ...
    if (m == i3) {
      return String.format(Locale.getDefault(), anni.a(2131713155), new Object[] { Integer.valueOf(n), Integer.valueOf(i1) });
    }
    localCalendar.setTimeInMillis(paramLong);
    localCalendar.add(6, 1);
    if (localCalendar.get(6) == i3) {
      return String.format(Locale.getDefault(), anni.a(2131713144), new Object[] { Integer.valueOf(n), Integer.valueOf(i1) });
    }
    if (i != i2) {
  ...
  public static int c(View paramView)
  {
    ...
    do
    {
      ...
      paramView.getLocationOnScreen(arrayOfInt);
      i = paramView.getHeight();
      j = zlx.d(paramView.getContext());
    } while (i <= 0);
    int i = Math.min(Math.abs(j - arrayOfInt[1]), Math.abs(j - (arrayOfInt[1] + i)));
    yqp.b("Q.qqstory.home.StoryListUtils", "getDistanceToBottom=" + i);
    return i;
  }
}
