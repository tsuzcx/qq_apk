...
public class ajkc
{
  private static ajkc jdField_a_of_type_Ajkc;
  private static boolean jdField_a_of_type_Boolean;
  private ajjr jdField_a_of_type_Ajjr = new ajjr(this);
  private final LRULinkedHashMap<String, ajke> jdField_a_of_type_ComTencentUtilLRULinkedHashMap = new LRULinkedHashMap(128);
  ...
  private ajka a(CustomWebView paramCustomWebView)
  {
  ...
  public static ajkc a()
  {
    try
    {
      if (jdField_a_of_type_Ajkc == null) {
        jdField_a_of_type_Ajkc = new ajkc();
      }
      ajkc localajkc = jdField_a_of_type_Ajkc;
      return localajkc;
    }
    finally {}
  }
  ...
  {
    return jdField_a_of_type_Ajkc != null;
  }
  ...
  private String b(String paramString)
  {
    ...
    do
    {
      ...
      str = this.jdField_a_of_type_Ajjr.a(paramString);
      localObject = str;
  ...
  public WebResourceResponse a(String paramString1, String paramString2)
  {
    ...
    if ((paramString1.contains("http://cmshow.qq.com/get_thunder_data?cmd=")) || (paramString1.contains("https://cmshow.qq.com/get_thunder_data?cmd=")))
    {
      ...
      if (!this.jdField_a_of_type_Ajjr.a(paramString2, paramString1))
      {
        if (QLog.isColorLevel()) {
      ...
      paramString2 = ajjr.a(paramString2, paramString1);
      localObject = (ajke)this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.get(paramString2);
      if (localObject != null) {
        if (ajke.a((ajke)localObject))
        {
          if (((ajke)localObject).a(paramString1))
          {
            if (QLog.isColorLevel()) {
              QLog.d("apollo_client_ApolloWebDataHandler", 2, "getApolloCmdResource, webSSOTask.isValid true, webSSOTask=" + localObject);
            }
            if (ajke.a((ajke)localObject) != null)
            {
              ajke.a((ajke)localObject).c = System.currentTimeMillis();
              ajke.a((ajke)localObject).d = System.currentTimeMillis();
            }
            paramString1 = new WebResourceResponse("text/plain", "utf-8", ajjc.a(ajke.a((ajke)localObject).toString()));
      ...
      for (;;)
      {
        return new WebResourceResponse("text/plain", "utf-8", new ajkg(null, null, null));
        if (QLog.isColorLevel()) {
  ...
  {
    if (this.jdField_a_of_type_Ajjr != null) {
      return this.jdField_a_of_type_Ajjr.a(paramString);
    }
    return null;
  }
  
  public void a(Context paramContext, String paramString1, String paramString2, AppInterface paramAppInterface, ajkf paramajkf)
  {
    if ((TextUtils.isEmpty(paramString1)) || (this.jdField_a_of_type_Ajjr == null)) {}
    for (;;)
    {
      return;
      ...
      {
        this.jdField_a_of_type_Ajjr.a(paramAppInterface);
        Object localObject1 = this.jdField_a_of_type_Ajjr.a(paramString1);
        ...
        else
        {
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            String str = ajjr.a(paramString1, (String)localObject2);
            ajke localajke = (ajke)this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.get(str);
            if ((localajke != null) && (localajke.a((String)localObject2)))
            {
              if (QLog.isColorLevel()) {
                QLog.d("apollo_client_ApolloWebDataHandler", 2, "preloadSSOCmd, apolloClientId:" + paramString1 + " mPreloadSSOCmds.has WebSSOTask:" + localajke);
              }
            }
            else
            {
              this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.remove(str);
              localajke = new ajke(paramajkf, str, (String)localObject2);
              this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.put(str, localajke);
              localObject2 = this.jdField_a_of_type_Ajjr.a(paramString2, paramString1, (String)localObject2, paramAppInterface);
              if (QLog.isColorLevel()) {
              ...
              if (localObject2 != null) {
                localajke.a(paramContext, paramString2, (JSONObject)localObject2, paramAppInterface);
              }
            }
          }
        }
  ...
  public boolean a(String paramString)
  {
    ...
    } while (this.jdField_a_of_type_Ajjr == null);
    return this.jdField_a_of_type_Ajjr.a(paramString);
  }
  ...
  public boolean a(String paramString1, String paramString2, AppInterface paramAppInterface, WebViewPlugin paramWebViewPlugin)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        ajka localajka = a(paramWebViewPlugin.mRuntime.a());
        if (localajka == null)
        {
          if (!QLog.isColorLevel()) {
            break label737;
        ...
        if (!this.jdField_a_of_type_Ajjr.a(str3, str2))
        {
          if (!QLog.isColorLevel()) {
            break label739;
          }
        ...
        str3 = ajjr.a(str3, str2);
        paramString2 = (ajke)this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.get(str3);
        if (paramString2 != null)
        {
          if (ajke.a(paramString2))
          {
            if (paramString2.a(str2))
            {
              ...
              if (ajke.a(paramString2) != null)
              {
                ajke.a(paramString2).c = System.currentTimeMillis();
                ajke.a(paramString2).d = System.currentTimeMillis();
              }
              paramWebViewPlugin.callJs(str1, new String[] { ajke.a(paramString2).toString() });
            ...
            if (localajka != null)
            {
              paramString2 = localajka.a();
              paramString2.c = System.currentTimeMillis();
              paramString2 = new ajke(paramString2, str3, str2);
              paramString2.a(new ajkd(this, str1, paramWebViewPlugin));
  ...
  public boolean b(String paramString1, String paramString2)
  {
    ...
    ajjc.a(ajjc.d(ajjc.e(str)), paramString2);
    if (QLog.isColorLevel()) {
