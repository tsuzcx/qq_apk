  ...
  implements View.OnClickListener
{
  ...
  private List<ajhd> jdField_a_of_type_JavaUtilList;
  private boolean jdField_a_of_type_Boolean;
  
  public ajkc(Context paramContext, QQAppInterface paramQQAppInterface, ListView paramListView, int paramInt, boolean paramBoolean, PhoneContactFragment paramPhoneContactFragment)
  {
    ...
    do
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        if (!localPhoneContact.isHiden) {
          ((List)localObject1).add(ajhc.a(1, localPhoneContact, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext));
        }
      }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (a())
    {
      ...
      {
        this.jdField_a_of_type_AndroidViewView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131558949, null);
        this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130839394);
        this.jdField_a_of_type_AndroidViewView.findViewById(2131369120).setVisibility(8);
        this.jdField_a_of_type_AndroidViewView.findViewById(2131369233).setVisibility(8);
        localObject1 = (SingleLineTextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367657);
        ((SingleLineTextView)localObject1).setText(anni.a(2131706765));
        ...
        ((SimpleTextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364936)).setText("0");
      }
    ...
    for (;;)
    {
      ...
      return localObject1;
      localObject1 = ((ajhd)this.jdField_a_of_type_JavaUtilList.get(paramInt)).a(0, paramInt, paramView, paramViewGroup, this);
      if (localObject1 != null)
      {
        localObject2 = (ajhg)((View)localObject1).getTag();
        if (((ajhg)localObject2).d != null) {
          ((ajhg)localObject2).d.setBackgroundDrawable(new BitmapDrawable(a(((ajhg)localObject2).b, ((ajhg)localObject2).jdField_a_of_type_JavaLangString)));
        }
        ((View)localObject1).setOnClickListener(this);
        if ((localObject2 instanceof ajkb)) {
          ((ajkb)localObject2).a.setOnClickListener(this);
        }
      }
    }
  }
  ...
  public void onClick(View paramView)
  {
    int i = 17;
    Object localObject;
    if ((paramView != null) && (paramView.getId() == 2131376443) && ((paramView.getTag() instanceof PhoneContact)))
    {
    ...
    for (;;)
    {
      ...
      localObject = AddFriendLogicActivity.a(this.jdField_a_of_type_AndroidContentContext, 2, ((PhoneContact)localObject).unifiedCode, null, 3006, i, ((PhoneContact)localObject).name, null, null, anni.a(2131706760), null);
      this.jdField_a_of_type_AndroidContentContext.startActivity((Intent)localObject);
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "contact", "", "addbook", "add_friend", 0, 0, "", "", "", "");
      do
      {
        do
        {
          ...
          return;
        } while ((paramView == null) || (!(paramView.getTag() instanceof ajhg)));
        localObject = (ajhg)paramView.getTag();
      } while (!(((ajhg)localObject).jdField_a_of_type_JavaLangObject instanceof PhoneContact));
      PhoneContact localPhoneContact = (PhoneContact)((ajhg)localObject).jdField_a_of_type_JavaLangObject;
      if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        ...
        bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80053DF", "0X80053DF", 0, 0, "1", "", "", "");
        break;
