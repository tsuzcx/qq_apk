  ...
  implements Manager
{
  ...
  public nsb(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Aukn = this.jdField_a_of_type_ComTencentBizPubaccountPersistenceManagerPublicAccountEntityManagerFactory.createEntityManager();
  }
  ...
  /* Error */
  public java.util.List<? extends aukm> a(java.lang.Class<? extends aukm> paramClass, boolean paramBoolean, java.lang.String paramString1, java.lang.String[] paramArrayOfString, java.lang.String paramString2, java.lang.String paramString3, java.lang.String paramString4, java.lang.String paramString5)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 30	nsb:jdField_a_of_type_Aukn	Laukn;
    //   6: astore 9
    //   8: aload 9
    //   10: ifnonnull +9 -> 19
    //   13: aconst_null
    ...
    //   18: areturn
    //   19: aload_0
    //   20: getfield 30	nsb:jdField_a_of_type_Aukn	Laukn;
    //   23: aload_1
    //   24: iload_2
    //   25: aload_3
    //   26: aload 4
    ...
    //   32: aload 7
    //   34: aload 8
    //   36: invokevirtual 61	aukn:a	(Ljava/lang/Class;ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    //   39: astore_1
    //   40: goto -25 -> 15
    //   43: astore_1
    //   44: aload_0
  ...
  public void a(aukm paramaukm)
  {
    ...
    //   26: astore_2
    //   27: aload_0
    //   28: getfield 30	nsb:jdField_a_of_type_Aukn	Laukn;
    //   31: ldc 66
    //   33: invokevirtual 71	java/lang/Class:getSimpleName	()Ljava/lang/String;
    //   36: invokevirtual 75	aukn:d	(Ljava/lang/String;)Z
    //   39: ifeq +43 -> 82
    //   42: aload_1
    ...
    //   56: ifne +26 -> 82
    //   59: aload_0
    //   60: getfield 30	nsb:jdField_a_of_type_Aukn	Laukn;
    //   63: ldc 66
    //   65: ldc 87
    //   67: iconst_1
    ...
    //   77: aastore
    //   78: invokevirtual 92	aukn:a	(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/String;)Laukm;
    //   81: astore_2
    //   82: aload_2
    //   83: ifnull -72 -> 11
    //   86: aload_0
    //   87: getfield 30	nsb:jdField_a_of_type_Aukn	Laukn;
    //   90: aload_2
    //   91: invokevirtual 96	aukn:b	(Laukm;)Z
    //   94: pop
    //   95: goto -84 -> 11
    //   98: astore_1
    //   99: aload_0
  ...
  public void a(java.lang.String paramString)
  {
    ...
    //   13: return
    //   14: aload_0
    //   15: getfield 30	nsb:jdField_a_of_type_Aukn	Laukn;
    ...
    //   37: invokevirtual 110	aukn:b	(Ljava/lang/String;)Z
    //   40: pop
    //   41: goto -30 -> 11
    //   44: astore_1
    //   45: aload_0
  ...
  public boolean a(aukm paramaukm)
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 30	nsb:jdField_a_of_type_Aukn	Laukn;
    //   8: astore_3
    //   9: aload_3
    //   10: ifnonnull +7 -> 17
    //   13: aload_0
    ...
    //   16: ireturn
    //   17: aload_1
    //   18: invokevirtual 116	aukm:getStatus	()I
    //   21: sipush 1000
    //   24: if_icmpne +31 -> 55
    //   27: aload_0
    //   28: aload_1
    //   29: invokevirtual 118	nsb:a	(Laukm;)V
    //   32: aload_0
    //   33: getfield 30	nsb:jdField_a_of_type_Aukn	Laukn;
    //   36: aload_1
    //   37: invokevirtual 120	aukn:b	(Laukm;)V
    //   40: aload_1
    //   41: invokevirtual 116	aukm:getStatus	()I
    //   44: sipush 1001
    //   47: if_icmpne -34 -> 13
    //   50: iconst_1
    //   51: istore_2
    //   52: goto -39 -> 13
    //   55: aload_1
    //   56: invokevirtual 116	aukm:getStatus	()I
    //   59: sipush 1001
    //   62: if_icmpeq +13 -> 75
    //   65: aload_1
    //   66: invokevirtual 116	aukm:getStatus	()I
    //   69: sipush 1002
    //   72: if_icmpne -59 -> 13
    //   75: aload_0
    //   76: getfield 30	nsb:jdField_a_of_type_Aukn	Laukn;
    //   79: aload_1
    //   80: invokevirtual 122	aukn:a	(Laukm;)Z
    //   83: istore_2
    //   84: goto -71 -> 13
    //   87: astore_1
    //   88: aload_0
