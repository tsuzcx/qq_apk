...
{
  private static azpb jdField_a_of_type_Azpb;
  private ConcurrentLinkedQueue<azpd> jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue;
  ...
  {
    if (jdField_a_of_type_Azpb != null) {
      return jdField_a_of_type_Azpb;
    }
    try
    {
      if (jdField_a_of_type_Azpb == null) {
        jdField_a_of_type_Azpb = new azpb();
      }
      azpb localazpb = jdField_a_of_type_Azpb;
      return localazpb;
    }
    finally {}
  }
  ...
  public static void a(Context paramContext, MonitorHttpInfo paramMonitorHttpInfo, boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    if (paramBoolean)
    {
      azmz.a(paramContext).a(null, "MonitorApkDownload", true, 0L, 0L, localHashMap, "");
      label231:
      if (!QLog.isColorLevel()) {
        break label348;
      }
    ...
    for (paramContext = "MonitorApkDownload{";; paramContext = "UnMonitorApkDownload{")
    {
      ...
      azmz.a(paramContext).a(null, "UnMonitorApkDownload", true, 0L, 0L, localHashMap, "");
      break label231;
      break;
    }
  ...
  private void b(MonitorHttpInfo paramMonitorHttpInfo, String paramString1, String paramString2)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue != null)
    {
      ...
      while (i < m)
      {
        ...
        if ((localObject instanceof azpd))
        {
          localObject = (azpd)localObject;
          int k = 0;
          try
          {
            j = a(str, ((azpd)localObject).a());
            if (QLog.isColorLevel()) {
              QLog.d("NetworkMonitor", 2, new Object[] { "url=", str, " bean's url=", ((azpd)localObject).a(), " lcs length=", Integer.valueOf(j) });
            }
            if (j < 10) {
              break label258;
            }
  ...
  public void a(String paramString)
  {
    ...
    azpd localazpd = new azpd(this, paramString);
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.add(localazpd);
    if (QLog.isColorLevel()) {
    ...
    {
      paramString = (azpd)this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.peek();
      if ((paramString == null) || (paramString.a - localazpd.a <= 600000L)) {
        break;
      }
  ...
  public void addDownloadURL(String paramString)
  {
    ...
    if (1 != BaseApplicationImpl.sProcessId)
    {
      ...
      QIPCClientHelper.getInstance().callServer("NetworkMonitorIPCModule", "ACTION_REPORT_DOWNLOAD_URL", localBundle, new azpc(this));
      return;
    }
    a(paramString);
  }
