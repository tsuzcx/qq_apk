  ...
  implements Manager
{
  ...
  public boolean a;
  ArrayList<auko> jdField_b_of_type_JavaUtilArrayList = new ArrayList();
    ...
    if (this.jdField_a_of_type_AndroidSupportV4UtilLruCache != null)
    {
      ...
      if (paramString != null)
      {
        ...
        if (localAccountDetail == null)
        {
          ...
          {
            paramString = (AccountDetail)this.jdField_a_of_type_Aukp.a(AccountDetail.class, paramString);
  ...
  public PublicAccountInfo a(String paramString, boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap != null) && (paramString != null))
    {
      ...
      if (localPublicAccountInfo == null)
      {
        ...
        if (this.jdField_a_of_type_Aukp != null)
        {
          paramString = (PublicAccountInfo)this.jdField_a_of_type_Aukp.a(PublicAccountInfo.class, paramString);
          localObject = paramString;
          if (paramString != null)
          {
            localObject = paramString;
    ...
    return (PublicAccountInfo)this.jdField_a_of_type_Aukp.a(PublicAccountInfo.class, paramString);
  }
  ...
  public List<PublicAccountInfo> a(List<PublicAccountInfo> paramList, long paramLong)
  {
    ...
    //   15: areturn
    //   16: aload_0
    //   17: getfield 114	akdh:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   20: ifnonnull +14 -> 34
    //   23: aload_0
    //   24: new 116	java/util/concurrent/ConcurrentHashMap
    //   27: dup
    //   28: invokespecial 163	java/util/concurrent/ConcurrentHashMap:<init>	()V
    //   31: putfield 114	akdh:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   34: aconst_null
    //   35: astore 4
    //   37: aload_0
    //   38: getfield 57	akdh:jdField_a_of_type_Aukp	Laukp;
    //   41: invokevirtual 166	aukp:a	()Laukr;
    //   44: astore 5
    //   46: aload 5
    //   48: astore 4
    //   50: aload 4
    //   52: invokevirtual 170	aukr:a	()V
    //   55: aload_1
    //   56: ifnull +77 -> 133
    //   59: aload_1
    ...
    //   95: aload_0
    //   96: aload 5
    //   98: invokevirtual 180	akdh:a	(Lauko;)Z
    //   101: pop
    //   102: aload_0
    //   103: getfield 114	akdh:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   106: aload 5
    ...
    //   120: astore_1
    //   121: aload 4
    //   123: invokevirtual 182	aukr:b	()V
    //   126: aload_0
    //   127: invokevirtual 183	akdh:b	()V
    //   130: aload 6
    //   132: areturn
    //   133: aload_0
    //   134: getfield 114	akdh:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    ...
    //   199: aload_0
    //   200: getfield 57	akdh:jdField_a_of_type_Aukp	Laukp;
    //   203: aload 5
    //   205: invokevirtual 195	aukp:b	(Lauko;)Z
    //   208: pop
    //   209: aload 6
    //   211: aload 5
    ...
    //   222: astore_1
    //   223: aload 4
    //   225: invokevirtual 182	aukr:b	()V
    //   228: aload_1
    //   229: athrow
    //   230: aload 4
    //   232: invokevirtual 198	aukr:c	()V
    //   235: aload 4
    //   237: invokevirtual 182	aukr:b	()V
    //   240: goto -114 -> 126
    //   243: astore_1
    //   244: aconst_null
    //   245: astore 4
  ...
  public List<PublicAccountInfo> a(List<PublicAccountInfo> paramList, long paramLong, boolean paramBoolean1, boolean paramBoolean2)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 114	akdh:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   4: ifnonnull +28 -> 32
    //   7: aload_1
    //   8: ifnull +140 -> 148
    //   11: aload_1
    ...
    //   29: putfield 114	akdh:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    ...
    //   42: astore 7
    //   44: aload_0
    //   45: getfield 57	akdh:jdField_a_of_type_Aukp	Laukp;
    //   48: invokevirtual 166	aukp:a	()Laukr;
    //   51: astore 8
    //   53: aload 8
    //   55: astore 7
    //   57: aload 7
    //   59: invokevirtual 170	aukr:a	()V
    //   62: aload_1
    //   63: ifnull +133 -> 196
    //   66: aload_1
    ...
    //   102: aload_0
    //   103: aload 8
    //   105: invokevirtual 180	akdh:a	(Lauko;)Z
    //   108: pop
    //   109: aload 8
    //   111: invokevirtual 206	com/tencent/mobileqq/data/PublicAccountInfo:isNeedShow	()Z
    //   114: ifeq +40 -> 154
    //   117: aload_0
    //   118: getfield 114	akdh:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   121: aload 8
    ...
    //   135: astore_1
    //   136: aload 7
    //   138: invokevirtual 182	aukr:b	()V
    //   141: aload_0
    //   142: invokevirtual 183	akdh:b	()V
    //   145: aload 9
    //   147: areturn
    //   148: iconst_0
    //   149: istore 6
    //   151: goto -132 -> 19
    //   154: aload_0
    //   155: getfield 114	akdh:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   158: aload 8
    ...
    //   188: astore_1
    //   189: aload 7
    //   191: invokevirtual 182	aukr:b	()V
    //   194: aload_1
    //   195: athrow
    //   196: iload 4
    //   198: ifne +96 -> 294
    ...
    //   203: ifeq +91 -> 294
    //   206: aload_0
    //   207: getfield 114	akdh:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    ...
    //   271: aload_0
    //   272: getfield 57	akdh:jdField_a_of_type_Aukp	Laukp;
    //   275: aload 8
    //   277: invokevirtual 195	aukp:b	(Lauko;)Z
    //   280: pop
    //   281: aload 9
    //   283: aload 8
    ...
    //   291: goto -72 -> 219
    //   294: aload 7
    //   296: invokevirtual 198	aukr:c	()V
    //   299: aload 7
    //   301: invokevirtual 182	aukr:b	()V
    //   304: goto -163 -> 141
    //   307: astore_1
    //   308: aconst_null
    //   309: astore 7
  ...
  public void a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 214	akdh:jdField_a_of_type_Boolean	Z
    //   6: istore_1
    //   7: iload_1
    //   8: ifeq +6 -> 14
    //   11: aload_0
    ...
    //   13: return
    //   14: aload_0
    //   15: invokevirtual 215	akdh:c	()V
    //   18: aload_0
    //   19: invokevirtual 183	akdh:b	()V
    //   22: aload_0
    //   23: invokevirtual 218	akdh:e	()V
    //   26: aload_0
    //   27: invokevirtual 221	akdh:d	()V
    //   30: aload_0
    //   31: iconst_1
    //   32: putfield 214	akdh:jdField_a_of_type_Boolean	Z
    //   35: invokestatic 226	sdc:a	()Lsdc;
    //   38: aload_0
    //   39: getfield 59	akdh:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   42: aload_0
    //   43: invokevirtual 228	akdh:a	()Ljava/util/List;
    //   46: invokevirtual 231	sdc:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/util/List;)V
    //   49: invokestatic 236	saz:a	()Lsaz;
    //   52: aload_0
    //   53: getfield 59	akdh:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   56: invokevirtual 238	saz:b	(Lcom/tencent/mobileqq/app/QQAppInterface;)V
    //   59: aload_0
    //   60: getfield 59	akdh:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   63: bipush 88
    //   65: invokevirtual 242	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   68: checkcast 244	nqn
    //   71: astore_2
    //   72: aload_2
    //   73: ifnull +10 -> 83
    //   76: aload_2
    //   77: aconst_null
    //   78: ldc 246
    //   80: invokevirtual 249	nqn:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   83: aload_0
    //   84: invokespecial 251	akdh:f	()V
    //   87: goto -76 -> 11
    //   90: astore_2
    //   91: aload_0
    //   92: monitorexit
  ...
  public void a(String paramString)
  {
    ...
    if (localAccountDetail != null)
    {
      ...
      this.jdField_a_of_type_Aukp.b(localAccountDetail);
    }
  }
  ...
  public void a(ArrayList<MessageRecord> paramArrayList, QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      while (paramArrayList.hasNext())
      {
        ...
        {
          sgg.a(paramQQAppInterface, BaseApplication.getContext(), null, ((Long)localObject).toString());
  ...
  public void a(List<PublicRecommendAccountInfo> paramList)
  {
    ...
    //   14: astore_2
    //   15: aload_0
    //   16: getfield 57	akdh:jdField_a_of_type_Aukp	Laukp;
    //   19: invokevirtual 166	aukp:a	()Laukr;
    //   22: astore_3
    //   23: aload_3
    //   24: astore_2
    //   25: aload_2
    //   26: invokevirtual 170	aukr:a	()V
    //   29: aload_0
    //   30: getfield 57	akdh:jdField_a_of_type_Aukp	Laukp;
    //   33: ldc_w 380
    //   36: invokevirtual 383	aukp:a	(Ljava/lang/Class;)Ljava/util/List;
    //   39: astore_3
    //   40: aload_3
    //   41: ifnull +49 -> 90
    //   44: aload_3
    ...
    //   69: astore 4
    //   71: aload_0
    //   72: getfield 57	akdh:jdField_a_of_type_Aukp	Laukp;
    //   75: aload 4
    //   77: invokevirtual 195	aukp:b	(Lauko;)Z
    //   80: pop
    //   81: goto -30 -> 51
    //   84: astore_1
    //   85: aload_2
    //   86: invokevirtual 182	aukr:b	()V
    //   89: return
    //   90: aload_1
    ...
    //   115: astore 4
    //   117: aload_0
    //   118: getfield 57	akdh:jdField_a_of_type_Aukp	Laukp;
    //   121: aload 4
    //   123: invokevirtual 386	aukp:a	(Lauko;)V
    //   126: goto -29 -> 97
    //   129: astore_1
    //   130: aload_2
    //   131: invokevirtual 182	aukr:b	()V
    //   134: aload_1
    //   135: athrow
    //   136: aload_0
    //   137: getfield 38	akdh:c	Ljava/util/ArrayList;
    //   140: ifnull +3 -> 143
    //   143: aload_0
    //   144: aload_1
    //   145: checkcast 31	java/util/ArrayList
    //   148: putfield 38	akdh:c	Ljava/util/ArrayList;
    //   151: aload_2
    //   152: invokevirtual 198	aukr:c	()V
    //   155: aload_2
    //   156: invokevirtual 182	aukr:b	()V
    //   159: return
    //   160: astore_1
    //   161: aconst_null
    //   162: astore_2
  ...
  public boolean a(SessionInfo paramSessionInfo)
  {
    ...
    return (paramSessionInfo != null) && (sgg.a(paramSessionInfo.accountFlag2) == -10L);
  }
  ...
  public void b()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        PublicAccountInfo localPublicAccountInfo = (PublicAccountInfo)localauko;
        ...
        if (localPublicAccountInfo.hasIvrAbility()) {
          localArrayList2.add(localauko);
        } else {
          localArrayList3.add(localauko);
        }
      }
      finally {}
    }
  ...
  public void b(String paramString)
  {
    ...
    if (localPublicAccountInfo != null)
    {
      ...
      this.jdField_a_of_type_Aukp.b(localPublicAccountInfo);
    }
    b();
  }
  ...
  public void c()
  {
    ...
    localObject2 = this.jdField_a_of_type_Aukp.a(PublicAccountInfo.class, false, "showFlag=?", new String[] { String.valueOf(1) }, null, null, null, null);
    ...
    for (int i = ((List)localObject2).size();; i = 0)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        {
          if ((!sgg.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) || (!TextUtils.equals(localPublicAccountInfo.getUin(), ajsd.ay))) {
  ...
  public void d()
  {
    ...
    Object localObject = this.jdField_a_of_type_Aukp.a(AccountDetail.class);
    this.jdField_a_of_type_AndroidSupportV4UtilLruCache = new LruCache(this.jdField_a_of_type_Int);
    if (localObject != null)
    {
  ...
  public void e()
  {
    ...
    this.c = ((ArrayList)this.jdField_a_of_type_Aukp.a(PublicRecommendAccountInfo.class));
