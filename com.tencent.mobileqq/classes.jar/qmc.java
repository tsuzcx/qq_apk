  ...
  implements Cloneable
{
  ...
  public SpannableStringBuilder a(ArticleInfo paramArticleInfo, String paramString, pgr parampgr)
  {
    return SocializeFeedsInfo.a(paramArticleInfo, paramString, parampgr, this.jdField_a_of_type_JavaUtilList);
  }
  ...
  public qmc a()
  {
    try
    {
      qmc localqmc = (qmc)super.clone();
      try
      {
        localqmc.jdField_a_of_type_JavaUtilList = new ArrayList();
        ...
        while (localIterator.hasNext())
        {
          ...
          localqmc.jdField_a_of_type_JavaUtilList.add(localBiuCommentInfo.a());
        }
        return localqmc;
      }
