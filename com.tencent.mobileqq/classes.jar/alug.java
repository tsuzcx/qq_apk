...
public class alug
{
  ...
  public static void a(Activity paramActivity, RMVideoStateMgr paramRMVideoStateMgr, float paramFloat, boolean paramBoolean, double paramDouble1, double paramDouble2, aluh paramaluh, int paramInt)
  {
    a(paramActivity, paramRMVideoStateMgr, paramFloat, paramBoolean, paramDouble1, paramDouble2, paramaluh, false, paramInt, 0);
  }
  
  private static void a(Activity paramActivity, RMVideoStateMgr paramRMVideoStateMgr, float paramFloat, boolean paramBoolean1, double paramDouble1, double paramDouble2, aluh paramaluh, boolean paramBoolean2, int paramInt1, int paramInt2)
  {
    String str1 = "";
    int i = 0;
    String str2 = "";
    try
    {
      ...
      paramActivity = new alul(paramActivity, paramRMVideoStateMgr, str1, i, str2, paramFloat, paramBoolean1, paramDouble1, paramDouble2, paramaluh, paramInt1, paramInt2, false);
  ...
  public static void a(Activity paramActivity, RMVideoStateMgr paramRMVideoStateMgr, float paramFloat, boolean paramBoolean1, double paramDouble1, double paramDouble2, aluh paramaluh, boolean paramBoolean2, int paramInt1, int paramInt2, String paramString1, int paramInt3, ArrayList<String> paramArrayList, boolean paramBoolean3, String paramString2, boolean paramBoolean4, int paramInt4, int paramInt5, String paramString3)
  {
    String str1 = "";
    int i = 0;
    String str2 = "";
    try
    {
      ...
      paramActivity = new alul(paramActivity, paramRMVideoStateMgr, str1, i, str2, paramFloat, paramBoolean1, paramDouble1, paramDouble2, paramaluh, paramInt1, paramInt2, paramString1, paramInt3, paramArrayList, paramBoolean3, paramString2, paramBoolean4, paramInt4, paramInt5, paramString3);
      paramActivity.a(paramBoolean2);
      paramActivity.execute(new Void[0]);
      if (paramBoolean1) {
        a("", "0X8005E94");
  ...
  public static void a(Activity paramActivity, RMVideoStateMgr paramRMVideoStateMgr, float paramFloat, boolean paramBoolean1, double paramDouble1, double paramDouble2, aluh paramaluh, boolean paramBoolean2, int paramInt1, int paramInt2, String paramString1, int paramInt3, ArrayList<String> paramArrayList, boolean paramBoolean3, String paramString2, boolean paramBoolean4, String paramString3, String paramString4, int paramInt4, boolean paramBoolean5, boolean paramBoolean6)
  {
    ...
    try
    {
      ...
      paramActivity = new alul(paramActivity, paramRMVideoStateMgr, str1, i, str2, paramFloat, paramBoolean1, paramDouble1, paramDouble2, paramaluh, paramInt1, paramInt2, paramString1, paramInt3, paramArrayList, paramBoolean3, paramString2, paramBoolean4, paramString3, paramString4, paramInt4, paramBoolean5, paramBoolean6);
      paramActivity.a(paramBoolean2);
      paramActivity.execute(new Void[0]);
      if (paramBoolean1) {
        a("", "0X8005E94");
  ...
  {
    bdll.b(null, "CliOper", paramString1, "", paramString2, paramString2, jdField_a_of_type_Int, paramInt, 0, paramString3, "", "", "");
  }
  
  public static void a(String paramString1, String paramString2, String paramString3)
  {
    bdll.b(null, "dc00898", paramString1, "", paramString2, paramString2, jdField_a_of_type_Int, 0, paramString3, "", "", "");
  }
  ...
  {
    bdll.b(null, "dc00898", paramString1, "", paramString2, paramString2, jdField_a_of_type_Int, 0, paramString3, paramString4, paramString5, paramString6);
  }
  
  public static boolean a()
  {
    return lju.b(BaseApplicationImpl.getContext());
  }
  ...
  {
    bdll.b(null, "CliOper", paramString1, "", paramString2, paramString2, jdField_a_of_type_Int, 0, paramString3, "", "", "");
  }
}
