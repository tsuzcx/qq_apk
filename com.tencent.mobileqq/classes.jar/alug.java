...
public class alug
  implements Runnable
{
  public alug(QidianProfileCardActivity paramQidianProfileCardActivity) {}
  
  public void run()
  {
    int j = 0;
    LinearLayout localLinearLayout1 = (LinearLayout)this.a.getLayoutInflater().inflate(2130970076, null);
    LinearLayout localLinearLayout2 = (LinearLayout)localLinearLayout1.findViewById(2131362846);
    int i = j;
    Object localObject1;
    Object localObject2;
    ...
    for (;;)
    {
      ...
      for (j = i;; j = i)
      {
        ...
        {
          localLinearLayout1 = (LinearLayout)this.a.getLayoutInflater().inflate(2130970075, null);
          localLinearLayout2 = (LinearLayout)localLinearLayout1.findViewById(2131362846);
        ...
        return;
        RelativeLayout localRelativeLayout = (RelativeLayout)this.a.getLayoutInflater().inflate(2130970077, null);
        URLImageView localURLImageView = (URLImageView)localRelativeLayout.findViewById(2131362724);
        TextView localTextView1 = (TextView)localRelativeLayout.findViewById(2131362759);
        ImageView localImageView = (ImageView)localRelativeLayout.findViewById(2131362725);
        TextView localTextView2 = (TextView)localRelativeLayout.findViewById(2131363598);
        localURLImageView.post(new aluh(this, (GroupItem)localObject2, localURLImageView));
        ...
        i += 1;
        break;
        localRelativeLayout = (RelativeLayout)this.a.getLayoutInflater().inflate(2130970077, null);
        localURLImageView = (URLImageView)localRelativeLayout.findViewById(2131362724);
        localTextView1 = (TextView)localRelativeLayout.findViewById(2131362759);
        localImageView = (ImageView)localRelativeLayout.findViewById(2131362725);
        localTextView2 = (TextView)localRelativeLayout.findViewById(2131363598);
        localURLImageView.post(new alui(this, (PublicAccountItem)localObject2, localURLImageView));
