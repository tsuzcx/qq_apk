  ...
  extends ayrb
{
  ...
  protected void onGetNewestStoryFeed(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      if (paramBundle != null)
      {
        paramBundle = QzoneAioStoryFeedRequest.onResponse(bhjl.b(paramBundle.getWupBuffer()));
        if (paramBundle != null) {
          admh.a(localQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramBundle);
        }
      }
