...
public class rlo
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new rlr(this, Looper.getMainLooper());
  ...
  public rlo(Activity paramActivity, AppRuntime paramAppRuntime, View paramView, boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  public void a(VideoInfo paramVideoInfo)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidViewAnimationTranslateAnimation.setAnimationListener(new rlp(this));
