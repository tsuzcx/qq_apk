...
public class arkw
  extends arku
{
  public arkw(QQAppInterface paramQQAppInterface)
  {
  ...
  private String a(long paramLong, String paramString1, String paramString2, int paramInt)
  {
    ...
    {
      return paramString1;
      paramString2 = aljq.bp + aroo.a(paramLong, paramInt, paramString2);
  ...
  private boolean a(MessageRecord paramMessageRecord, List<MsgBackupResEntity> paramList)
  {
    ...
    for (Object localObject1 = (MessageForTroopFile)arni.a((ChatMessage)paramMessageRecord); localObject1 == null; localObject1 = (MessageForTroopFile)paramMessageRecord)
    {
    ...
    TroopFileTransferManager.Item localItem = localTroopFileTransferManager.a(((bbpe)localObject1).jdField_a_of_type_JavaUtilUUID);
    Object localObject2;
    String str;
    if (localItem != null) {
        ...
        for (;;)
        {
          if (localIterator.hasNext())
          {
            ...
            if ((a((MsgBackupResEntity)localObject2)) && (b(paramMessageRecord, (MsgBackupResEntity)localObject2)))
            {
              ...
              {
                if (bdcs.b(localItem.largeThumbnailFile)) {
                  continue;
                }
  ...
  private void c(MessageRecord paramMessageRecord, List<MsgBackupResEntity> paramList)
  {
    ...
    bbnr localbbnr = bcil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, l).b(((MessageForTroopFile)localObject1).url, ((MessageForTroopFile)localObject1).fileName, ((MessageForTroopFile)localObject1).fileSize, ((MessageForTroopFile)localObject1).bisID);
    Object localObject2;
    String str;
    if ((localbbnr != null) && (paramList != null) && (!paramList.isEmpty()))
    {
      localObject1 = "";
      localObject2 = "";
      Iterator localIterator = paramList.iterator();
      ...
      for (;;)
      {
        if (localIterator.hasNext())
        {
          ...
          if ((a((MsgBackupResEntity)localObject2)) && (b(paramMessageRecord, (MsgBackupResEntity)localObject2)))
          {
            ...
            if (((MsgBackupResEntity)localObject2).msgSubType == 12) {
              localObject1 = a(l, str, UUID.nameUUIDFromBytes(localbbnr.b.getBytes()).toString(), 640);
            }
          }
        }
      }
    ...
    for (;;)
    {
      ...
      if (((MsgBackupResEntity)localObject2).msgSubType == 11)
      {
        paramList = a(str, localbbnr.c);
        continue;
        if (bdcs.b(paramList))
        {
          localbbnr.h = paramList;
          localbbnr.e = 11;
        ...
        if (bdcs.b((String)localObject1))
        {
          localbbnr.j = ((String)localObject1);
        ...
        TroopFileTransferManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, l).a(localbbnr);
        return;
      }
    }
  }
  ...
  protected String a(MessageRecord paramMessageRecord, int paramInt)
  {
    ...
    try
    {
      ...
      localObject = bcjk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForTroopFile);
      if ((localObject != null) && (((bbpe)localObject).e > 0) && (((bbpe)localObject).f > 0))
      {
        localJSONObject.put("uint32_img_width", ((bbpe)localObject).e);
        localJSONObject.put("uint32_img_height", ((bbpe)localObject).f);
      }
  ...
  public void a(MessageRecord paramMessageRecord, List<MsgBackupResEntity> paramList)
  {
    ...
    if (paramMessageRecord.isMultiMsg)
    {
      localObject1 = (MessageForTroopFile)arni.a((ChatMessage)paramMessageRecord);
      localObject1 = bcjk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForTroopFile)localObject1);
    ...
    for (;;)
    {
      ...
      break;
      label145:
      int i = arni.a(((bbpe)localObject1).g);
      if ((i == 0) || (i == 2))
      {
        Object localObject2 = ((bbpe)localObject1).c;
      ...
      localObject1 = ((bbpe)localObject1).jdField_a_of_type_JavaLangString;
      if (bdcs.b((String)localObject1))
      {
  ...
  public boolean a(MessageRecord paramMessageRecord, MsgBackupResEntity paramMsgBackupResEntity)
  {
    ...
    do
    {
      ...
      if (paramMsgBackupResEntity.msgSubType == 12)
      {
        bool1 = bdcs.b(paramMessageRecord.c);
    ...
    boolean bool2 = bdcs.b(paramMessageRecord.jdField_a_of_type_JavaLangString);
