...
public class binc
{
  ...
  private static ThreadLocal<char[]> jdField_a_of_type_JavaLangThreadLocal = new bind();
  ...
  public static String a(Context paramContext)
  {
    ...
    try
    {
      jdField_b_of_type_JavaLangString = bhsp.a("2240ca");
      if (!TextUtils.isEmpty(jdField_b_of_type_JavaLangString)) {}
    }
  ...
  public static void a(Intent paramIntent, befe parambefe)
  {
    if ((paramIntent == null) || (parambefe == null)) {
    ...
    for (;;)
    {
      ...
      bekk.a(l7 - l1, l2 - l1, l3, l4, l5 - l2, 0L, parambefe.b, parambefe.e, parambefe.c, parambefe.a, parambefe.d, parambefe.f, 2L, 0L, i, 0L, l6 - l5, l7 - l6 + "", Build.VERSION.RELEASE, j + "");
      return;
  ...
  public static void a(AppInterface paramAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, String paramString9, String paramString10, String... paramVarArgs)
  {
    ...
    for (paramAppInterface = (QQAppInterface)paramAppInterface;; paramAppInterface = null)
    {
      a(paramAppInterface, "dc00145", paramString1);
      return;
      paramVarArgs = bimq.jdField_b_of_type_JavaLangString;
      break;
      paramString1 = bimq.a;
      break label1060;
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, List<String> paramList)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      azps.a(paramQQAppInterface, paramString, paramList);
    }
