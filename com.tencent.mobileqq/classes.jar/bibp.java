...
public class bibp
{
  ...
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new bibq(this);
  private View jdField_a_of_type_AndroidViewView;
  private ImageView jdField_a_of_type_AndroidWidgetImageView;
  private RelativeLayout jdField_a_of_type_AndroidWidgetRelativeLayout;
  private TextView jdField_a_of_type_AndroidWidgetTextView;
  bibs jdField_a_of_type_Bibs;
  ...
  public bibp(Context paramContext, int paramInt1, int paramInt2, int paramInt3, GdtAppReceiver paramGdtAppReceiver)
  {
  ...
  public void a(int paramInt1, String paramString, int paramInt2)
  {
    ...
    {
      bhzt.a().a(this.jdField_c_of_type_Int, 0L, paramInt1, paramString, paramInt2);
      return;
    }
    QZLog.i("VipGeneralGdtShowView", " @getGdtInfo sendBusinessReport");
  }
  
  public void a(View paramView, bibs parambibs)
  {
    if (paramView == null) {
      return;
    }
    this.jdField_a_of_type_Bibs = parambibs;
  ...
  public void a(AlumBasicData paramAlumBasicData, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((this.jdField_c_of_type_Int == 3) && (!axmv.b()))
        {
          ((URLDrawable)localObject1).setTag(bavw.a(bbll.a(40.0F), bbll.a(40.0F)));
          ...
          if (localURLDrawable != null)
          {
            ...
            int j = this.jdField_a_of_type_AndroidContentContext.getResources().getDisplayMetrics().widthPixels - bbll.b(56.0F);
            paramInt = i;
      ...
      ((URLDrawable)localObject1).setTag(bavw.b(bbll.a(40.0F), bbll.a(40.0F), bbll.a(3.5F)));
