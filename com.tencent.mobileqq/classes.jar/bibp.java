...
public class bibp
  extends Handler
{
  public bibp(VipFunCallPreviewActivity paramVipFunCallPreviewActivity, Looper paramLooper)
  {
    super(paramLooper);
  }
      ...
      do
      {
        do
        {
          ...
          if (this.a.jdField_a_of_type_JavaUtilArrayList.size() > 0)
          {
            if (this.a.jdField_a_of_type_Boolean)
            {
              if ((this.a.g instanceof Button)) {
                ((Button)this.a.g).setText(anvx.a(2131716097));
              }
          ...
          if (this.a.jdField_a_of_type_Boolean)
          {
            ...
            this.a.g.setEnabled(true);
            if ((this.a.g instanceof Button)) {
              ((Button)this.a.g).setText(anvx.a(2131716091));
            }
            this.a.g.setEnabled(false);
        ...
        localRelativeLayout = (RelativeLayout)this.a.findViewById(2131381239);
