...
public class alaa
  extends alif
{
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new alab(this);
  ...
  public alaa(PhoneContactTabView paramPhoneContactTabView, Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, boolean paramBoolean)
  {
  ...
  protected boolean a(aliz paramaliz)
  {
    boolean bool2 = super.a(paramaliz);
    boolean bool1 = bool2;
    if ((paramaliz instanceof alaf))
    {
      paramaliz = (alaf)paramaliz;
      if ((bool2) && (!paramaliz.jdField_a_of_type_Boolean)) {
        bool1 = true;
      }
    }
    else
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    int i = Arrays.binarySearch(this.jdField_a_of_type_ArrayOfInt, paramInt);
    if (paramView == null) {
      paramView = alaf.a(paramViewGroup, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberPhoneContactTabView.jdField_a_of_type_AndroidViewLayoutInflater, 2131558968);
    }
    for (;;)
    {
      ...
      if (i < 0)
      {
        ...
        alaf.a(this, localalaf, (PhoneContact)localObject);
        localalaf.jdField_b_of_type_AndroidWidgetTextView.setText(((PhoneContact)localObject).name);
        localalaf.d.setText(((PhoneContact)localObject).mobileNo);
        localalaf.d.setVisibility(0);
        if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberPhoneContactTabView.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.isResultListContainFriend(localalaf.jdField_a_of_type_JavaLangString))
        {
          localalaf.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(true);
          localalaf.jdField_a_of_type_AndroidWidgetCheckBox.setEnabled(true);
          if ((AppSetting.c) && (localalaf.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
          {
            if (!localalaf.jdField_a_of_type_AndroidWidgetCheckBox.isChecked()) {
              break label291;
            }
            paramView.setContentDescription(((PhoneContact)localObject).name + amtj.a(2131707104));
          }
          label226:
          localalaf.jdField_a_of_type_ComTencentMobileqqDataPhoneContact = ((PhoneContact)localObject);
          localalaf.jdField_b_of_type_AndroidViewView.setVisibility(8);
          localalaf.jdField_b_of_type_AndroidViewView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
      ...
      for (;;)
      {
        ...
        return paramView;
        localalaf.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(false);
        break;
        label291:
        paramView.setContentDescription(((PhoneContact)localObject).name + amtj.a(2131707102));
        break label226;
        localalaf.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
        localalaf.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
        localObject = String.valueOf(this.jdField_a_of_type_ArrayOfJavaLangString[i]);
        localalaf.jdField_a_of_type_AndroidWidgetTextView.setText((CharSequence)localObject);
        localalaf.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(String.format(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberPhoneContactTabView.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getString(2131691682), new Object[] { ((String)localObject).toLowerCase() }));
      }
    }
  }
}
