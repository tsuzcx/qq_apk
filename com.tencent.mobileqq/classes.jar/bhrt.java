...
public class bhrt
  extends bhro
{
  public static bhrt a;
  public static final HashMap<Integer, String> a;
  
  static
  {
    jdField_a_of_type_Bhrt = new bhrt();
  ...
  public Bitmap a(Context paramContext, int paramInt, String paramString)
  {
    ...
    paramString = new bgyp();
    bgyo.a(paramContext, localOptions, paramString);
  ...
  public boolean a(Context paramContext, int paramInt)
  {
    ...
    paramContext = jdField_a_of_type_Bhrt.getDir(paramContext, (String)localObject);
