...
public class baan
{
  ...
  private static arkm jdField_a_of_type_Arkm = new baao();
    ...
    for (;;)
    {
      ...
      if (paramInt1 != AppSetting.d)
      {
        ...
        if (jdField_a_of_type_AndroidMediaMediaPlayer != null)
        {
          ...
          jdField_a_of_type_AndroidMediaMediaPlayer.setOnCompletionListener(new baas(paramOnCompletionListener, paramHandler));
  ...
  public static void a(int paramInt, boolean paramBoolean)
  {
    for (;;)
    {
      ...
      jdField_a_of_type_AndroidMediaMediaPlayer.setOnCompletionListener(new baaq());
      jdField_a_of_type_AndroidMediaMediaPlayer.start();
  ...
  public static void a(Uri paramUri, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    //   2: ldc 2
    //   4: monitorenter
    //   5: getstatic 103	baan:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   8: astore 4
    //   10: aload 4
    //   12: ifnull +13 -> 25
    //   15: getstatic 103	baan:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   18: invokevirtual 106	android/media/MediaPlayer:release	()V
    //   21: aconst_null
    //   22: putstatic 103	baan:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   25: aload_0
    ...
    //   44: putstatic 103	baan:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   47: iload_2
    //   48: ifeq +25 -> 73
    ...
    //   67: getstatic 103	baan:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   70: invokestatic 57	baan:a	(Landroid/media/MediaPlayer;)V
    ...
    //   94: aload_0
    //   95: astore 4
    //   97: getstatic 103	baan:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   100: aload_0
    ...
    //   109: aload_0
    //   110: astore 4
    //   112: getstatic 103	baan:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   115: invokevirtual 80	android/media/MediaPlayer:prepare	()V
    //   118: aload_0
    //   119: astore_3
    //   120: aload_0
    //   121: astore 4
    //   123: getstatic 103	baan:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   126: new 282	baat
    //   129: dup
    //   130: invokespecial 283	baat:<init>	()V
    ...
    //   138: aload_0
    //   139: astore 4
    //   141: getstatic 103	baan:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   144: invokevirtual 136	android/media/MediaPlayer:start	()V
    //   147: aload_0
    //   148: astore_3
    //   149: aload_0
    //   150: astore 4
    //   152: getstatic 103	baan:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   155: iload_1
    ...
    //   171: astore 4
    //   173: aconst_null
    //   174: putstatic 103	baan:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   177: goto -152 -> 25
    //   180: astore_0
    //   181: aconst_null
    //   182: astore 4
    ...
    //   211: astore_0
    //   212: aconst_null
    //   213: putstatic 103	baan:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   216: aload_0
    //   217: athrow
    //   218: astore_0
    //   219: aload_3
    ...
    //   236: putstatic 103	baan:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   239: getstatic 103	baan:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   242: astore_0
    //   243: aload_0
    ...
    //   287: getstatic 103	baan:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   290: invokestatic 57	baan:a	(Landroid/media/MediaPlayer;)V
    //   293: aconst_null
    //   294: astore_0
    //   295: goto -177 -> 118
    //   298: astore_0
  ...
  public static void a(java.lang.String paramString, boolean paramBoolean)
  {
    ...
    //   9: aload 5
    //   11: astore_3
    //   12: getstatic 103	baan:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   15: ifnull +60 -> 75
    //   18: aload 5
    //   20: astore_3
    //   21: getstatic 103	baan:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    ...
    //   60: aload_0
    //   61: athrow
    //   62: getstatic 103	baan:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   65: invokevirtual 106	android/media/MediaPlayer:release	()V
    //   68: aload 5
    //   70: astore_3
    //   71: aconst_null
    //   72: putstatic 103	baan:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   75: aload 5
    //   77: astore_3
    //   78: getstatic 103	baan:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   81: ifnonnull +16 -> 97
    //   84: aload 5
    //   86: astore_3
    ...
    //   94: putstatic 103	baan:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   97: aload 5
    //   99: astore_3
    //   100: getstatic 103	baan:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    ...
    //   117: astore_0
    //   118: getstatic 103	baan:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   121: aload_0
    ...
    //   128: getstatic 103	baan:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   131: invokestatic 57	baan:a	(Landroid/media/MediaPlayer;)V
    //   134: getstatic 103	baan:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   137: invokevirtual 80	android/media/MediaPlayer:prepare	()V
    //   140: getstatic 103	baan:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   143: new 297	baap
    //   146: dup
    //   147: invokespecial 298	baap:<init>	()V
    ...
    //   153: getstatic 103	baan:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   156: invokevirtual 136	android/media/MediaPlayer:start	()V
    //   159: getstatic 103	baan:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   162: iload_1
    ...
    //   188: astore_3
    //   189: aconst_null
    //   190: putstatic 103	baan:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   193: goto -118 -> 75
    //   196: astore_3
    //   197: aload 4
    //   199: astore_0
    ...
    //   254: astore_3
    //   255: aconst_null
    //   256: putstatic 103	baan:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   259: aload 5
    //   261: astore_3
    //   262: aload_0
    //   263: athrow
  ...
  public static void b(int paramInt, boolean paramBoolean)
  {
    for (;;)
    {
      ...
      jdField_a_of_type_AndroidMediaMediaPlayer.setOnCompletionListener(new baar());
      jdField_a_of_type_AndroidMediaMediaPlayer.start();
      jdField_a_of_type_AndroidMediaMediaPlayer.setLooping(paramBoolean);
    }
  }
