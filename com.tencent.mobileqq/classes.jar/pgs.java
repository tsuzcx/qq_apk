...
public class pgs
{
  ...
  {
    Long localLong = (Long)bmqa.a("sp_key_readinjoy_refresh_optimize_id", Long.valueOf(0L));
    if (localLong != null) {}
  ...
  public static void a(String paramString)
  {
    ...
    bmqa.a("sp_key_readinjoy_refresh_optimize_id", Long.valueOf(l1));
  }
  
  public static void a(qni paramqni)
  {
    if (paramqni != null)
    {
