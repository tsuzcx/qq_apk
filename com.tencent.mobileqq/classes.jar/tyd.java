...
public class tyd
{
  ...
  public static void a(int paramInt, String paramString)
  {
    ...
    if (3 == paramInt)
    {
      if (((Boolean)bnrf.a(paramString, Boolean.valueOf(false))).booleanValue()) {
        return;
      }
      bnrf.a(paramString, Boolean.valueOf(true));
    }
    tzq.a(200, localArrayList);
  }
    ...
    try
    {
      ...
      if ((paramMap != null) && (paramMap.entrySet() != null))
      {
        ...
        while ((paramMap != null) && (paramMap.hasNext()))
        {
          ...
          continue;
          ocd.a(null, ozs.d(paramArticleInfo), paramString1, paramString2, 0, 0, sel.a(paramArticleInfo.mFeedId), String.valueOf(paramArticleInfo.mArticleID), Integer.toString(paramArticleInfo.mStrategyId), paramMap, false);
        }
      }
    }
    catch (Exception paramMap)
    {
      agej.a("ProteusReportUtil", "reportClickEvent", new IllegalArgumentException(paramMap));
      paramMap = null;
    }
    for (;;)
    {
  ...
  {
    paramBaseArticleInfo = quv.a(paramBaseArticleInfo);
  ...
  public static void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    bdmc.a(BaseApplicationImpl.getApplication()).a(null, "actKandianProteusShowFail", false, 0L, 0L, localHashMap, null);
  }
  ...
  {
    return bhny.a(BaseApplicationImpl.getContext(), "com.tencent.weishi");
  }
}
