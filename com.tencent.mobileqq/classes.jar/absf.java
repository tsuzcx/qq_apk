  ...
  extends MSFServlet
{
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramFromServiceMsg != null)
    {
      ...
      localObject1 = (ExposeAndGetAdvInfoRsp)absg.a(paramFromServiceMsg, "ExposeAndGetAdvInfo");
    ...
    for (;;)
    {
      ...
      {
        notifyObserver(paramIntent, 100, bool, localBundle, abse.class);
        return;
        i = -1;
        break;
        label278:
        ...
        localObject1 = (GetAdvInfoRsp)absg.a(paramFromServiceMsg, "GetAdvInfo");
        if (localObject1 == null) {
          break label339;
        }
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    for (;;)
    {
      localObject3 = new absg((String)localObject3, (JceStruct)localObject1, paramIntent, (String)localObject2);
      localObject2 = ((absg)localObject3).encode();
      localObject1 = localObject2;
      if (localObject2 == null)
      {
        QLog.e("QBossC2SCheckerServlet", 1, "onSend request encode result is null.cmd = " + ((absg)localObject3).uniKey());
