  ...
  implements bhqg
{
  ...
  private static ConcurrentHashMap<String, bhqm> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  private Handler jdField_a_of_type_AndroidOsHandler;
  private String jdField_a_of_type_JavaLangString;
  
  private bhqm(String paramString)
  {
    super(paramString, false);
    this.jdField_a_of_type_JavaLangString = paramString;
  }
  
  public static bhqm a(String paramString)
  {
    Object localObject1 = (bhqm)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
    if (localObject1 == null) {
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        bhqm localbhqm = (bhqm)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
        localObject1 = localbhqm;
        if (localbhqm == null)
        {
          localObject1 = new bhqm(paramString);
  ...
  public void onLocationFinish(int paramInt, SosoInterface.SosoLbsInfo paramSosoLbsInfo)
  {
    ...
    bhlg.a(paramInt, this.jdField_a_of_type_JavaLangString, l1 - l2);
