  ...
  extends bmth
{
  ...
  private String jdField_d_of_type_JavaLangString = alpo.a(2131715469);
  ...
  public bmtr(Context paramContext, String paramString)
  {
  ...
  protected void b()
  {
    ...
    {
      this.jdField_d_of_type_JavaLangString = alpo.a(2131715467);
      ...
      this.jdField_b_of_type_AndroidTextTextPaint.setShadowLayer(bmth.g, 0.0F, 0.0F, 1711276032);
      if (Build.VERSION.SDK_INT >= 21)
      {
    ...
    for (;;)
    {
      ...
      for (this.jdField_d_of_type_Int = i1;; this.jdField_d_of_type_Int = i4)
      {
        ...
        this.jdField_e_of_type_Int = this.jdField_a_of_type_Bmsv.a("T", 0L, 165L, 0, 255, new LinearInterpolator());
        this.h = this.jdField_a_of_type_Bmsv.a("X", 0L, 330L, 0, this.t, new DecelerateInterpolator());
        this.i = this.jdField_a_of_type_Bmsv.a("X", 330L, 340L, this.t, this.u, new AccelerateInterpolator());
        this.j = this.jdField_a_of_type_Bmsv.a("X", 825L, 200L, 0, 100, new DecelerateInterpolator());
        this.k = this.jdField_a_of_type_Bmsv.a("X", 825L, 355L, a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), a(20.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), new DecelerateInterpolator());
        ...
        if ((this.jdField_d_of_type_JavaLangString == null) || (this.jdField_d_of_type_JavaLangString.contains(alpo.a(2131715471))) || (this.jdField_d_of_type_JavaLangString.contains(alpo.a(2131715470))) || (this.jdField_d_of_type_JavaLangString.endsWith(alpo.a(2131715465))) || (this.jdField_d_of_type_JavaLangString.endsWith(alpo.a(2131715466)))) {
          break;
        }
        this.jdField_d_of_type_JavaLangString += alpo.a(2131715468);
        break;
        label1272:
