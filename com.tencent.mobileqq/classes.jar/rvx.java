...
public class rvx
{
  ...
  static
  {
    jdField_b_of_type_JavaLangString = "QQ/8.3.0 Android/0.17 Android/" + Build.VERSION.RELEASE;
  }
  ...
  public static String a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if ((!TextUtils.isEmpty(paramString)) && (paramString.startsWith("http")))
      {
        ...
        {
          Object localObject2 = bcgl.a(paramString);
          if ((localObject2 != null) && (!TextUtils.isEmpty(((bcgm)localObject2).jdField_b_of_type_JavaLangString)))
          {
            if (QLog.isColorLevel()) {
              QLog.d("ViolaAccessHelper", 2, "load offline想 data cache on loadRes");
            }
            return ((bcgm)localObject2).jdField_b_of_type_JavaLangString;
          }
          try
          {
            if (!TextUtils.isEmpty((CharSequence)localObject1))
            {
              localObject2 = mzh.a((String)localObject1);
  ...
  public static void a()
  {
    ...
    if (TextUtils.isEmpty(jdField_a_of_type_JavaLangString)) {
      jdField_a_of_type_JavaLangString = onh.a();
    }
    if (QLog.isColorLevel()) {
  ...
  @Deprecated
  public static void a(Context paramContext, String paramString1, String paramString2, Bundle paramBundle, rwf paramrwf)
  {
    if (!a(paramContext)) {
      if (paramrwf != null) {
        paramrwf.a();
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, Bundle paramBundle, boolean paramBoolean)
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        continue;
        label387:
        abtq.a((Activity)paramContext, localIntent, PublicTransFragmentActivity.class, ViolaFragment.class);
      }
      label405:
      ...
      abtq.a((Activity)paramContext, localIntent, PublicTransFragmentActivity.class, ViolaFragment.class, paramBundle.getInt("requestCode", -1));
      ...
      localIntent.putExtra("public_fragment_window_feature", 1);
      abtq.a(paramContext, localIntent, PublicTransFragmentActivity.class, ViolaFragment.class);
      ((Activity)paramContext).overridePendingTransition(2130772010, 0);
      return;
      label536:
    ...
    if ((paramContext instanceof SplashActivity))
    {
      ...
      localIntent.putExtra(rxb.jdField_a_of_type_JavaLangString, paramString1);
      if (paramBundle != null) {
  ...
  public static void a(Context paramContext, String paramString, rwf paramrwf) {}
  ...
  /* Error */
  public static void a(com.tencent.common.app.AppInterface paramAppInterface, String paramString, rwt paramrwt, rwd paramrwd)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    ...
    //   24: new 718	rwm
    //   27: dup
    //   28: invokespecial 719	rwm:<init>	()V
    ...
    //   34: new 725	rwv
    //   37: dup
    //   38: invokespecial 726	rwv:<init>	()V
    ...
    //   48: new 736	rws
    //   51: dup
    //   52: invokespecial 737	rws:<init>	()V
    ...
    //   77: aload_3
    //   78: aload_0
    //   79: invokespecial 756	rwb:<init>	(Lrwd;Lcom/tencent/common/app/AppInterface;)V
    //   82: invokestatic 757	ryp:a	()Ljava/lang/String;
    ...
    //   116: dup
    //   117: aload_3
    //   118: invokespecial 774	com/tencent/biz/pubaccount/readinjoy/viola/ViolaAccessHelper$5:<init>	(Lrwd;)V
    ...
    //   0	172	2	paramrwt	rwt
    //   0	172	3	paramrwd	rwd
    // Exception table:
    //   from	to	target	type
  ...
  @Deprecated
  public static void a(String paramString, rwd paramrwd)
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)onh.a();
    if ((localQQAppInterface == null) && (paramrwd != null))
    {
      paramrwd.a();
      return;
    }
    a(localQQAppInterface, paramString, null, paramrwd);
  }
  
  public static void a(String paramString, rwe paramrwe)
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)onh.a();
    ...
    ThreadManager.post(new ViolaAccessHelper.3(paramString, localQQAppInterface, paramrwe, System.currentTimeMillis()), 8, null, true);
  }
  
  public static void a(String paramString, rzz paramrzz)
  {
    ThreadManager.post(new ViolaAccessHelper.6(paramString, paramrzz), 8, null, false);
  }
  ...
  private static boolean a(Context paramContext)
  {
    ...
    do
    {
      ...
      do
      {
        do
        {
          do
          {
            ...
            a(paramContext, ajya.a(2131716475));
          } while (!QLog.isColorLevel());
          ...
          a(paramContext, ajya.a(2131716477));
        } while (!QLog.isColorLevel());
        QLog.d("ViolaAccessHelper", 2, "isViolaPermit checkSO is false");
        return false;
        str = ryp.b("https://kd.qpic.cn/viola/lib/viola.js?v_bid=3547");
        if (!TextUtils.isEmpty(str)) {
          break;
        }
      ...
      a(paramContext, ajya.a(2131716476));
      if (QLog.isColorLevel()) {
  ...
  {
    a("http://sqimg.qq.com/qq_product_operations/kan/viola_config/viola_config.json?v_bid=3192", new rwc());
  }
