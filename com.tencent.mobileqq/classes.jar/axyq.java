  ...
  extends axxg
{
  ...
  public axyq()
  {
    this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new axyr(this);
  }
  ...
  public static String a(AbsShareMsg paramAbsShareMsg, String paramString)
  {
    ...
    } while ((!(localObject1 instanceof axuo)) || (((axuo)localObject1).a == null) || (((axuo)localObject1).a.isEmpty()));
    Object localObject1 = ((axuo)localObject1).a.iterator();
    label191:
    if (((Iterator)localObject1).hasNext())
    {
      localObject2 = (axun)((Iterator)localObject1).next();
      if ((paramString.equals("cover")) && ((localObject2 instanceof axwq)))
      {
    ...
    for (;;)
    {
      if (!TextUtils.isEmpty(paramAbsShareMsg))
      {
        ...
        if ((!paramString.equals("summary")) || (!(localObject2 instanceof axzh))) {
          break label301;
        }
        paramAbsShareMsg = StructMsgForGeneralShare.getSummary((axun)localObject2);
        break label231;
        label295:
        break label191;
      }
  ...
  void a()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg != null) && (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.message != null))
    {
      ...
      {
        localObject = (AbsShareMsg)axuy.a(((MessageRecord)localObject).msgData);
  ...
  {
    Object localObject = new axyt(this);
    Resources localResources = paramContext.getResources();
    View localView;
    int i;
    label122:
    int j;
    if ((paramView != null) && ((paramView instanceof RelativeLayout)) && (paramView.findViewById(2131363709) != null) && ((paramView.getTag() instanceof axyt)))
    {
      localObject = (axyt)paramView.getTag();
      localView = paramView;
      paramView = (View)localObject;
      a();
      boolean bool = paramBundle.getBoolean("isSend", true);
      paramBundle = (BubbleViewLayout)localView.findViewById(2131363709);
      i = 19;
      ...
      paramView.jdField_a_of_type_AndroidWidgetTextView.setPadding(actn.a(9.0F, localResources), 0, actn.a(i, localResources), 0);
      paramView.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setPadding(actn.a(9.0F, localResources), actn.a(3.0F, localResources), actn.a(i, localResources), 0);
      paramBundle = (ViewGroup.MarginLayoutParams)paramView.jdField_a_of_type_AndroidWidgetRelativeLayout.getLayoutParams();
      if (j == 0) {
        break label925;
      }
      paramBundle.setMargins(actn.a(18.0F, localResources), 0, 0, 0);
      ...
      paramBundle.setMargins(actn.a(18.0F, localResources), 0, 0, 0);
      paramView.jdField_a_of_type_AndroidWidgetLinearLayout.setPadding(actn.a(19.5F, localResources), 0, actn.a(10.0F, localResources), 0);
      label339:
      paramBundle = localResources.getDrawable(2130849344);
    ...
    try
    {
      localObject = URLDrawable.getDrawable(new URL(this.T), actn.a(249.0F, localResources), actn.a(139.0F, localResources), paramBundle, paramBundle, true);
    ...
    for (;;)
    {
      ...
      i = (int)(BaseChatItemLayout.A * 0.8F) - actn.a(19.5F, localResources) - actn.a(10.0F, localResources) - actn.a(13.0F, localResources);
      paramView.jdField_b_of_type_AndroidWidgetTextView.setMaxWidth(i);
      i /= actn.a(14.0F, localResources);
      ...
      paramView.jdField_b_of_type_AndroidWidgetTextView.setText(new ayks(paramBundle, 3, 15));
      paramView.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
      paramContext = new axys(this, paramContext, new String(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.mMsgActionData), this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.mMsgUrl);
      ...
      ((axyt)localObject).jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localView.findViewById(2131364799));
      ((axyt)localObject).jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131377350));
      ((axyt)localObject).jdField_a_of_type_ComTencentWidgetSingleLineTextView = ((SingleLineTextView)localView.findViewById(2131376710));
      ((axyt)localObject).jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localView.findViewById(2131363709));
      ((axyt)localObject).jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localView.findViewById(2131362213));
      ((axyt)localObject).jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)localView.findViewById(2131364468));
      ((axyt)localObject).jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131362212));
      ((axyt)localObject).c = ((RelativeLayout)localView.findViewById(2131363758));
      ((axyt)localObject).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131363750));
      ...
      break label339;
      paramView.jdField_a_of_type_AndroidWidgetTextView.setPadding(actn.a(i, localResources), 0, actn.a(9.0F, localResources), 0);
      paramView.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setPadding(actn.a(i, localResources), actn.a(3.0F, localResources), actn.a(9.0F, localResources), 0);
      paramBundle = (ViewGroup.MarginLayoutParams)paramView.jdField_a_of_type_AndroidWidgetRelativeLayout.getLayoutParams();
      if (j != 0)
      {
        paramBundle.setMargins(0, 0, actn.a(18.0F, localResources), 0);
        ((RelativeLayout.LayoutParams)paramView.c.getLayoutParams()).addRule(11);
        paramBundle = (RelativeLayout.LayoutParams)paramView.jdField_a_of_type_AndroidWidgetLinearLayout.getLayoutParams();
        paramBundle.addRule(11);
        paramBundle.setMargins(0, 0, actn.a(18.0F, localResources), 0);
        paramView.jdField_a_of_type_AndroidWidgetLinearLayout.setPadding(actn.a(10.0F, localResources), 0, actn.a(19.5F, localResources), 0);
        break label339;
      }
      paramBundle.setMargins(0, 0, 0, 0);
      break label339;
