...
public class uex
{
  ...
  private static QQHashMap<Integer, uey> jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = "https://find.mp.qq.com/public/index?_wv=67109947&_bid=2258";
    jdField_b_of_type_JavaLangString = "https://find.mp.qq.com/public/categories?_wv=67109947&_bid=2258";
  ...
  public static Drawable a(Context paramContext, int paramInt)
  {
    ...
    {
    default: 
      return paramContext.getResources().getDrawable(2130840312);
    case 1: 
      return paramContext.getResources().getDrawable(2130840404);
    }
    return paramContext.getResources().getDrawable(2130840409);
  }
  ...
  {
    uey localuey = a(paramQQAppInterface, paramContext, paramInt);
    if (localuey != null) {
      return localuey.a();
    }
  ...
  public static uey a(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt)
  {
    int i1 = paramInt;
    if (paramInt == 3) {
      i1 = 2;
    ...
    return (uey)jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.get(Integer.valueOf(i1));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (localSharedPreferences != null)
    {
      ...
      jdField_a_of_type_Boolean = localSharedPreferences.getBoolean("service_account_folder_delete", true);
      ...
      localSet = bfza.a(localSharedPreferences, "big_data_share_channel_urls", null);
      if (localSet != null) {
  ...
  private static void a(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    if (!a(paramQQAppInterface, paramContext, bfyz.e(paramContext)))
    {
      localObject = new uey(paramQQAppInterface, paramContext, 1, 2131695912, 2130840404);
      jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.put(Integer.valueOf(1), localObject);
    }
    Object localObject = bfyz.h(paramContext);
    String str = bfyz.i(paramContext);
    if ((TextUtils.isEmpty((CharSequence)localObject)) || (TextUtils.isEmpty(str)))
    {
      paramQQAppInterface = new uey(paramQQAppInterface, paramContext, 2, 2131694787, 2130840409);
    ...
    for (;;)
    {
      ...
      return;
      paramQQAppInterface = new uey(paramQQAppInterface, paramContext, 2, (String)localObject, str);
      jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.put(Integer.valueOf(2), paramQQAppInterface);
    }
  }
  ...
  public static void a(ArrayList<uey> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      {
        uey localuey = (uey)paramArrayList.next();
        jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.put(Integer.valueOf(localuey.jdField_a_of_type_Int), localuey);
      }
    }
  }
    ...
    try
    {
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        while (i1 < i2)
        {
          ...
          localObject = new uey(paramQQAppInterface, paramContext, i3, ((Element)localObject).getElementsByTagName("name").item(0).getFirstChild().getNodeValue(), ((Element)localObject).getElementsByTagName("icon").item(0).getFirstChild().getNodeValue());
          if (jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap == null) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          ...
          bool = true;
          ucp.a(paramQQAppInterface, bool, (String)localObject1);
          ucp.b(paramQQAppInterface, i1);
          if (i3 == 1)
          {
        ...
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          ...
          bool = true;
          ucp.a(paramQQAppInterface, bool);
          ucp.c(paramQQAppInterface, i1);
          if (QLog.isColorLevel()) {
        ...
        if (localObject1 != null)
        {
          ...
          bool = true;
          bfyz.b((Context)localObject1, bool);
        }
        localObject1 = paramString.getElementsByTagName("channel_version");
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          i1 = Integer.valueOf(((Element)((NodeList)localObject1).item(0)).getFirstChild().getNodeValue()).intValue();
          i2 = bkwm.b(paramQQAppInterface);
          if (i1 <= i2) {
            break label2992;
          }
          ...
          bkwm.a(paramQQAppInterface, i3, (String)localObject2, i4);
          if (QLog.isColorLevel()) {
        ...
        if (localObject1 != null)
        {
          ...
          bool = true;
          bfyz.c((Context)localObject1, bool);
          localObject1 = sek.a();
          if (i1 != 0) {
            break label3033;
          }
          bool = true;
          ((sek)localObject1).a(bool);
          if (QLog.isColorLevel()) {
        ...
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          ...
          bool = true;
          bkwm.b(paramQQAppInterface, bool);
          if (QLog.isColorLevel()) {
        ...
        if (localObject1 != null)
        {
          ...
          bool = true;
          bfyz.a((Context)localObject1, bool, paramQQAppInterface.getCurrentUin());
          if (QLog.isColorLevel()) {
        ...
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          ...
          bool = true;
          bkwm.d(paramQQAppInterface, bool);
        }
        ...
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          ...
          bkwm.i(paramQQAppInterface, bool);
        }
  ...
  public static String b(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt)
  {
    ...
    default: 
      return null;
    case 1: 
      return paramContext.getString(2131695912);
    }
    return paramContext.getString(2131694787);
  }
  ...
  public static boolean b()
  {
    return "1".equals((String)VSConfigManager.getInstance().getValue("subscribe_entrance_enable", "1"));
  }
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if ((localObject != null) && (((NodeList)localObject).getLength() > 0))
          {
            ...
            if (i1 > bfyz.x(paramQQAppInterface.getApp()))
            {
              ...
              if ((!TextUtils.isEmpty((CharSequence)localObject)) && (!TextUtils.isEmpty(paramString))) {
                bfyz.a(paramQQAppInterface.getApp(), (String)localObject, paramString);
              }
              bfyz.o(paramQQAppInterface.getApp(), i1);
              return false;
            }
          }
        }
  ...
  {
    return (String)VSConfigManager.getInstance().getValue("subscribe_account_title", VSConfigManager.SUBSCRIBE_ACCOUNT_TITLE_DEFVALUE);
  }
  ...
  public static boolean c()
  {
    String str1 = (String)VSConfigManager.getInstance().getValue("subscribe_entrance_enable", "1");
    String str2 = (String)VSConfigManager.getInstance().getValue("newfollowlist", "1");
