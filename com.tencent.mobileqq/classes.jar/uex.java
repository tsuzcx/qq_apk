  ...
  extends BaseAdapter
{
  ...
  public uex(Context paramContext, aaga paramaaga)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    if (this.jdField_a_of_type_JavaUtilList == null)
    {
      upe.a("comment", "create mComments ...");
  ...
  {
    upe.d("comment", "addCommentReply :" + paramstSimpleMetaReply.wording + ",mComments size:" + this.jdField_a_of_type_JavaUtilList.size());
  ...
  {
    boolean bool2 = false;
    upe.d("comment", "removeCommentReply ...");
    boolean bool1 = bool2;
    int i;
  ...
  {
    boolean bool2 = false;
    upe.d("comment", "updateCommentReply ............. mComments.size:" + this.jdField_a_of_type_JavaUtilList.size());
    boolean bool1 = bool2;
    int i;
    if (!TextUtils.isEmpty(paramString1))
    {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (localstSimpleMetaComment.isTempData)
    {
      if (!this.jdField_a_of_type_JavaUtilHashSet.contains(Integer.valueOf(localstSimpleMetaComment.hashCode())))
      {
        ...
        localObject2 = umt.c(this.jdField_b_of_type_JavaLangString);
        localObject1 = localObject2;
        if (!((String)localObject2).equals("comment_tag")) {
          localObject1 = (String)localObject2 + jdField_a_of_type_Int;
        }
        umt.b(this.jdField_b_of_type_JavaLangString, a(), (String)localObject1, this.jdField_a_of_type_UserGrowthStSimpleMetaFeed);
      }
      for (;;)
      {
        localObject1 = new MoreCommentPanel(this.jdField_a_of_type_AndroidContentContext);
        ((TextView)((MoreCommentPanel)localObject1).findViewById(2131371290)).setTextColor(-7829368);
        ((MoreCommentPanel)localObject1).setOnClickListener(new uey(this, paramInt));
        ((MoreCommentPanel)localObject1).setHintText(localstSimpleMetaComment.wording);
        EventCollector.getInstance().onListGetView(paramInt, paramView, paramViewGroup, getItemId(paramInt));
        return localObject1;
        upe.b("beacon-comment", "重复的position:" + paramInt + ",不上报");
      }
    }
    if (paramView != null)
    {
    ...
    else
    {
      ...
      ((WsCommentView)localObject1).setOnCommentElementClickListener(this.jdField_a_of_type_Aaga);
