  ...
  extends ArkViewModel
{
  ...
  protected static ArrayList<WeakReference<adll>> a;
  ...
  public String b;
  protected boolean b;
  protected WeakReference<adll> c;
  boolean c;
  protected WeakReference<adlo> d;
  protected boolean d;
  ...
  static
  {
    ...
    jdField_a_of_type_ComTencentArkArk$ApplicationCallback = new adlm();
  }
  
  public adll() {}
  
  public adll(boolean paramBoolean) {}
  ...
  public static WeakReference<adll> a(ark.Container paramContainer)
  {
    int i = 0;
    while (i < jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      adll localadll = (adll)localWeakReference.get();
      if ((localadll != null) && (localadll.getContainer() == paramContainer)) {
  ...
  public void a(adlo paramadlo)
  {
    this.d = new WeakReference(paramadlo);
  }
  ...
  {
    adlo localadlo = (adlo)this.d.get();
    if (localadlo != null) {
      localadlo.a(this, paramString1, paramString2);
    }
  }
  ...
  public boolean onLoadApp(ArkViewModelBase.AppInfo paramAppInfo)
  {
    ...
    for (Object localObject2 = str2;; localObject2 = str2)
    {
      ...
      ArkAppMgr.getInstance().getAppPathByName(paramAppInfo.name, paramAppInfo.view, paramAppInfo.appMinVersion, null, new adln(this.jdField_c_of_type_JavaLangRefWeakReference));
      return false;
      bool = false;
    }
  }
  ...
  public void onLoadReport(int paramInt)
  {
    if (this.mAppInfo != null) {
      altd.a(a(), this.mAppInfo.name, "ArkAppLoadState", paramInt, 0, 0L, 0L, 0L, this.mAppInfo.view, "");
    }
  }
  ...
  public void onRunAppFailed()
  {
    ...
    if (localObject != null)
    {
      ...
      localObject = ((ArkViewImplement)localObject).getView().getContext().getString(2131693797);
    ...
    for (this.mErrorInfo.canRetry = true;; this.mErrorInfo.canRetry = false)
    {
      ...
      return;
      label72:
      localObject = ((ArkViewImplement)localObject).getView().getContext().getString(2131693802);
      this.mErrorInfo.msg = a((String)localObject);
    }
  }
}
