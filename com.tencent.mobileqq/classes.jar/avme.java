...
public class avme
{
  public static aldq a;
  public static String a;
  
  static
  {
    jdField_a_of_type_Aldq = new avmf();
  ...
  public static long a(ArrayList<WadlResult> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      {
        int j = acik.a((String)localObject1);
  ...
  public static void a(int paramInt1, QQGameMsgInfo paramQQGameMsgInfo, int paramInt2)
  {
    ...
    do
    {
      return;
      if (paramInt1 == 117) {
        apeg.a(paramQQGameMsgInfo.frienduin, paramQQGameMsgInfo.uniseq);
      }
      str = "";
  ...
  public static boolean a(avmq paramavmq)
  {
    return ((paramavmq instanceof GameArkView)) && (a(paramavmq.a()));
  }
  ...
  private static boolean b()
  {
    ...
    long l = a();
    if (NetConnInfoCenter.getServerTimeMillis() - l < avmc.a() * 24 * 60 * 60 * 1000)
    {
