  ...
  implements bphw
{
  ...
  public bphu(AppInterface paramAppInterface, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
  ...
  public void a(Context paramContext, ArrayList<bphx> paramArrayList)
  {
    int[] arrayOfInt1;
    if (this.c)
    {
    ...
    label76:
    for (int[] arrayOfInt2 = bphx.jdField_b_of_type_ArrayOfInt;; arrayOfInt2 = bphx.a)
    {
      int i = 0;
      while (i < arrayOfInt1.length)
      {
        paramArrayList.add(new bphx(paramContext.getResources().getDrawable(arrayOfInt1[i]), 0, arrayOfInt2[i]));
        i += 1;
      }
      arrayOfInt1 = bphx.c;
      break;
  ...
  public void a(@NonNull ArrayList<bphx> paramArrayList, @NonNull Context paramContext)
  {
    ...
    {
      localObject1 = new bphx(paramContext.getResources().getDrawable(2130846795), 1, 0);
      ((bphx)localObject1).jdField_b_of_type_JavaLangString = anvx.a(2131701934);
    ...
    if (this.b)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentCommonAppAppInterface != null) && (bool))
      {
        ...
        if ((localObject1 != null) && (!((ArrayList)localObject1).isEmpty()))
        {
          ...
          do
          {
            localObject7 = localbphx1;
            localObject6 = localObject2;
            localObject5 = localObject3;
            localbphx3 = localbphx2;
          ...
          {
            localObject4 = new bphx(paramContext.getResources().getDrawable(2130845026), 2, i);
            ((bphx)localObject4).jdField_b_of_type_JavaLangString = anvx.a(2131701933);
    ...
    for (;;)
    {
      ...
      {
        localbphx1 = new bphx(paramContext.getResources().getDrawable(2130845027), 2, i);
        localbphx1.jdField_b_of_type_JavaLangString = anvx.a(2131701932);
        localObject4 = localObject1;
      ...
      {
        localObject4 = new bphx(paramContext.getResources().getDrawable(2130845028), 2, i);
        ((bphx)localObject4).jdField_b_of_type_JavaLangString = anvx.a(2131701935);
        localObject3 = localObject1;
        localObject1 = localObject2;
      ...
      {
        localObject4 = new bphx(paramContext.getResources().getDrawable(2130845025), 2, i);
        ((bphx)localObject4).jdField_b_of_type_JavaLangString = anvx.a(2131701930);
        localObject1 = localObject2;
        localObject2 = localObject3;
        localObject3 = localObject4;
      }
      ...
      {
        localbphx2 = new bphx(paramContext.getResources().getDrawable(2130845024), 2, i);
        localbphx2.jdField_b_of_type_JavaLangString = anvx.a(2131701931);
        localObject4 = localObject1;
        localObject1 = localObject2;
        localObject2 = localObject3;
        localObject3 = localObject4;
