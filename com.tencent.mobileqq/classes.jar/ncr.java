...
public class ncr
{
  ...
  public static AVUserInfo a(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (ncl.c()) {
        ncl.a("MavJniUtil", "AVUserInfo-->Uin = " + l + " ,isPstn = " + i + " ,pstnState = " + j + " ,micOffByAdmin = " + paramInt);
      }
      return paramArrayOfByte;
      ncl.a("MavJniUtil", "getAVInfoFromByte", new Throwable("打印调用栈"));
    }
  }
  ...
  public static ArrayList<AVUserInfo> a(byte[] paramArrayOfByte, int paramInt)
  {
    if (paramArrayOfByte == null) {
      if (ncl.c()) {
        ncl.b("MavJniUtil", "getAVInfoListFromByte--> buf is null");
      }
    }
    int i;
    ...
    do
    {
      do
      {
        ...
        ncl.b("MavJniUtil", "getAVInfoListFromByte--> structLen is 0");
        return null;
      ...
      ncl.b("MavJniUtil", "getAVInfoListFromByte--> buf len is incorrect");
      return null;
      int j = i / paramInt;
    ...
    ncl.b("MavJniUtil", "Can not get AVUserInfo...Error");
    return null;
    ...
    label162:
    if (ncl.c()) {
      ncl.a("MavJniUtil", "getAVInfoListFromByte --> length = " + localArrayList.size());
    }
  ...
  public static long[] a(byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      if (l == 0L)
      {
        ncl.c("MavJniUtil", "getUinListFromBuf-->get the wrong uin==0");
        return arrayOfLong2;
      }
      arrayOfLong2[(j / 8)] = l;
      j += 8;
