...
public class raz
{
  private static Map<String, rba> jdField_a_of_type_JavaUtilMap = new HashMap();
  ...
  public static ocg a(ArticleInfo paramArticleInfo)
  {
    ...
    localocg.b("folder_status", obz.d);
    localocg.b("feeds_source", paramArticleInfo.mSubscribeID);
    localocg.b("feeds_type", paramArticleInfo.mFeedType);
    localocg.b("kandian_mode", obz.e());
    localocg.b("tab_source", obz.d());
    localocg.b("rowkey", paramArticleInfo.innerUniqueID);
    localocg.a("channel_id", paramArticleInfo.mChannelID);
    return localocg;
  }
  
  public static ocg a(ArticleInfo paramArticleInfo, boolean paramBoolean, long paramLong)
  {
    ocg localocg = obz.a();
    localocg.b("algorithm_id", "" + paramArticleInfo.mAlgorithmID);
    localocg.b("strategy_id", "" + paramArticleInfo.mStrategyId);
    if (paramBoolean) {}
    for (String str = "2";; str = "1")
    {
      localocg.b("feeds_channel_entrance", str);
      localocg.b("mp_article_id", "" + paramArticleInfo.mArticleID);
      localocg.b("rowkey", paramArticleInfo.innerUniqueID);
      localocg.b("channel_id", "" + a(paramBoolean, paramLong));
      return localocg;
    }
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if (NetworkState.isWifiConn())
        {
          ...
          localJSONObject.put("net_type", mpl.a() + "");
  ...
  private static rba a(String paramString)
  {
    rba localrba2 = (rba)jdField_a_of_type_JavaUtilMap.get(paramString);
    rba localrba1 = localrba2;
    if (localrba2 == null)
    {
      localrba1 = new rba(ocr.a(paramString));
      jdField_a_of_type_JavaUtilMap.put(paramString, localrba1);
    }
    return localrba1;
  }
  ...
  public static void a(Context paramContext, AppInterface paramAppInterface, ArticleInfo paramArticleInfo, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    paramContext = nzv.a(paramContext, paramAppInterface.getCurrentAccountUin(), i, paramArticleInfo.mArticleID, paramArticleInfo.innerUniqueID, paramInt1, paramInt2, paramBoolean);
    ndn.a(null, "", "0X8009544", "0X8009544", 0, 0, "", String.valueOf(paramArticleInfo.mArticleID), String.valueOf(paramArticleInfo.mAlgorithmID), paramContext, false);
  }
  ...
  public static void a(Context paramContext, AppInterface paramAppInterface, ArticleInfo paramArticleInfo, int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    int i = a((int)paramArticleInfo.mChannelID, paramArticleInfo.mFeedType);
    paramContext = nzv.a(paramContext, paramAppInterface.getCurrentAccountUin(), i, paramArticleInfo.mArticleID, paramArticleInfo.innerUniqueID, paramInt1, paramInt2, paramBoolean1, Boolean.valueOf(paramBoolean2));
    ndn.a(null, "", "0X800979D", "0X800979D", 0, 0, "", String.valueOf(paramArticleInfo.mArticleID), String.valueOf(paramArticleInfo.mAlgorithmID), paramContext, false);
  }
  
  public static void a(ArticleInfo paramArticleInfo, int paramInt1, int paramInt2, ocg paramocg)
  {
    int j = BaseApplicationImpl.getApplication().getResources().getDisplayMetrics().widthPixels;
    int i = Utils.px2dp(paramInt1);
    j = Utils.px2dp(j);
    paramocg.b("read_area", "" + j * i);
    paramocg.b("article_page", "" + Utils.px2dp(paramInt2));
    paramocg.b("read_page", "" + Utils.px2dp(paramInt1));
    ndn.a(null, "CliOper", "", "", "0X8009782", "0X8009782", 0, 0, "" + paramArticleInfo.mArticleID, "", "", paramocg.a(), false);
  }
  
  public static void a(ArticleInfo paramArticleInfo, int paramInt1, int paramInt2, boolean paramBoolean, long paramLong)
  {
    if (paramArticleInfo == null) {
      return;
    }
    ocg localocg = a(paramArticleInfo, paramBoolean, paramLong);
    a(paramArticleInfo, paramInt2, localocg);
    a(paramArticleInfo, localocg);
    a(paramArticleInfo, paramInt1, paramInt2, localocg);
    b(paramArticleInfo, localocg);
    c(paramArticleInfo, a(paramArticleInfo, paramBoolean, paramLong));
  }
  
  public static void a(ArticleInfo paramArticleInfo, int paramInt, ocg paramocg)
  {
    ArrayList localArrayList = new ArrayList();
    oidb_cmd0x80a.AttributeList localAttributeList = new oidb_cmd0x80a.AttributeList();
    localAttributeList.att_id.set(1);
    localAttributeList.att_name.set("body_show_time");
    long l3 = ocr.b(a(paramArticleInfo, 0));
    ...
    for (;;)
    {
      if (((oidb_cmd0x80a.AttributeList)localObject1).att_value.get() != null)
      {
        ...
        rtr.a(201, localArrayList);
      }
      try
      {
        paramocg.a("body_show_time", String.valueOf(l3));
        paramocg.a("body_height", String.valueOf(paramInt));
        paramocg.a("scroll_time", String.valueOf(l2));
        paramocg.a("scroll_list", localStringBuilder.toString());
        ndn.a(null, "", "0X800A467", "0X800A467", 0, 0, "", "", "", paramocg.a(), false);
        return;
        label666:
  ...
  public static void a(ArticleInfo paramArticleInfo, long paramLong1, long paramLong2, ocg paramocg)
  {
    if (paramArticleInfo == null) {
      return;
    }
    paramocg.b("read_duration", "" + paramLong1 / 1000L);
    paramocg.b("read_begin_timestamp", "" + paramLong2 / 1000L);
    paramocg.b("read_end_timestamp", "" + NetConnInfoCenter.getServerTime());
    ndn.a(null, "CliOper", "", "" + paramArticleInfo.mSubscribeID, "0X8009781", "0X8009781", 0, 0, "" + paramArticleInfo.mArticleID, "", "", paramocg.a(), false);
  }
  ...
  {
    ndn.a(null, "CliOper", "", paramArticleInfo.mSubscribeID, paramString1, paramString1, 0, 0, paramArticleInfo.mArticleID + "", paramArticleInfo.mAlgorithmID + "", paramArticleInfo.innerUniqueID, paramString2, false);
  }
  ...
  public static void a(ArticleInfo paramArticleInfo, List<BaseData> paramList)
  {
    ...
    paramList.put("param_uin", obz.a());
    awrn.a(BaseApplicationImpl.getApplication()).a(null, "actKandianFastWebItemCount", true, 0L, 0L, paramList, null);
  }
  
  public static void a(ArticleInfo paramArticleInfo, ocg paramocg)
  {
    if (paramArticleInfo != null)
    {
      a(paramArticleInfo, ocr.b(paramArticleInfo.innerUniqueID), ocr.a(paramArticleInfo.innerUniqueID), paramocg);
      ocr.a(paramArticleInfo.innerUniqueID);
    }
  }
  ...
  public static void a(BaseData paramBaseData, String paramString)
  {
    ...
    ocg localocg = new ocg();
    localocg.b("card_source", localProteusBookData.c);
    localocg.b("topic_id", localProteusBookData.d);
    localocg.b("source_id", localProteusBookData.e);
    ndn.a(null, "CliOper", "", "" + localFastWebArticleInfo.d, paramString, paramString, 0, 0, localFastWebArticleInfo.n + "", paramBaseData.mAlgorithmID + "", paramBaseData.innerUniqueID, localocg.a(), false);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, AdData paramAdData)
  {
    ...
    {
      nbe.a(paramQQAppInterface, paramAdData);
  ...
  public static void a(QQAppInterface paramQQAppInterface, AdData paramAdData, float paramFloat, long paramLong)
  {
    if ((paramQQAppInterface != null) && (paramAdData != null))
    {
      nbe.a(paramQQAppInterface, paramAdData, paramFloat, paramLong);
  ...
  public static void a(String paramString, JSONObject paramJSONObject1, JSONObject paramJSONObject2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramString = new ocg(localJSONObject2);
        paramString.e();
        ndn.a(null, "", str, str, 0, 0, "", "", "", paramString.a(), false);
  ...
  public static void a(JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        Object localObject2 = new ocg((JSONObject)localObject1);
        ((ocg)localObject2).e();
        ndn.a(null, "", str, str, 0, 0, "", "", "", ((ocg)localObject2).a(), false);
        ...
        try
        {
          ...
          else
          {
            ...
            avsv.a(null, new ReportModelDC02528().module("all_search").action("exp_jingtan_list").obj1("2049").ver2("kandian").ver4(str).ver6(localJSONObject.getString("articleRowKey")).ver7("{\"title\":\"" + localJSONObject.getString("articleTitle") + "\"}").session_id(paramJSONObject.getString("kdschSessionId")));
            return;
          }
        }
  ...
  public static void b(ArticleInfo paramArticleInfo, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ocg localocg = a(paramArticleInfo);
        localocg.b("source_from", paramString2);
        if (!obz.o()) {
          continue;
        }
        i = 1;
      ...
      ndn.a(null, paramArticleInfo.mSubscribeID, paramString1, paramString1, 0, 0, String.valueOf(paramArticleInfo.mFeedId), String.valueOf(paramArticleInfo.mArticleID), "", paramString2, false);
      return;
      i = 0;
    }
  }
  
  public static void b(ArticleInfo paramArticleInfo, ocg paramocg)
  {
    rba localrba = a(paramArticleInfo.innerUniqueID);
    if (localrba.a.isEmpty()) {
      return;
    }
    paramocg.i();
    paramocg.b("read_begin_timestamp", "" + localrba.jdField_b_of_type_Long / 1000L);
    paramocg.b("read_end_timestamp", "" + localrba.c / 1000L);
    String str1 = "";
    Iterator localIterator = localrba.a.iterator();
    long l = 0L;
    ...
    paramocg.b("read_speed_array", str1);
    paramocg.b("avg_speed", "" + l / localrba.a.size());
    ndn.a(null, "CliOper", "", "", "0X8009783", "0X8009783", 0, 0, "" + paramArticleInfo.mArticleID, "", "", paramocg.a(), false);
  ...
  public static void b(QQAppInterface paramQQAppInterface, AdData paramAdData)
  {
    if ((paramQQAppInterface != null) && (paramAdData != null))
    {
      nbe.b(paramQQAppInterface, paramAdData);
  ...
  public static void b(JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      paramJSONObject = new ocg(localJSONObject);
      paramJSONObject.e();
      ndn.a(null, "", "0X8009A7D", "0X8009A7D", 0, 0, "", "", "", paramJSONObject.a(), false);
      return;
    }
    catch (Exception paramJSONObject) {}
  }
  ...
  private static void c(ArticleInfo paramArticleInfo, ocg paramocg)
  {
    paramocg.b().e();
    ...
    while (i < j)
    {
      ...
      long l = ocr.b(str);
      paramocg.a(jdField_a_of_type_ArrayOfJavaLangString[localInteger.intValue()] + "_duration_millis", l);
      ocr.a(str);
      i += 1;
    }
    ndn.a(null, "CliOper", "", "" + paramArticleInfo.mSubscribeID, "0X80099D2", "0X80099D2", 0, 0, "", "" + paramArticleInfo.mArticleID, "", paramocg.a(), false);
  }
}
