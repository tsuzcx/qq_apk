...
public class mdu
{
  ...
  {
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131380641) != null)
    {
  ...
  private boolean a(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if (paramBoolean)
      {
        ...
        if (!mvk.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface)) {
          return false;
        }
      }
  ...
  private void b(TextView paramTextView)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetPopupWindow.setAnimationStyle(2131755821);
    paramTextView.measure(0, 0);
  ...
  private void d()
  {
    ...
    {
      TextView localTextView = (TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131380641);
  ...
  private void e()
  {
    ...
    do
    {
      ...
      localTextView = null;
      if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) {
        localTextView = (TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131380641);
      }
    ...
    localTextView.getViewTreeObserver().addOnPreDrawListener(new mdv(this, localTextView));
    d();
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout == null) {
      b(localTextView);
    }
    for (;;)
    {
      localTextView.setOnClickListener(new mdw(this));
      return;
      a(localTextView);
    }
  }
  ...
  public void a()
  {
    ...
    mvk.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
    d();
  }
