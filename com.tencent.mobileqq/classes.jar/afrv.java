...
class afrv
  implements akxc
{
  afrv(afru paramafru, CustomizeStrategyFactory.RedPacketInfo paramRedPacketInfo) {}
  ...
  public void onResult(int paramInt, PreloadManager.PathResult paramPathResult)
  {
    ...
    try
    {
      ...
      BitmapFactory.Options localOptions = bheg.a(str1, paramInt);
    ...
    if (paramInt < j)
    {
      ...
      localObject2 = SafeBitmapFactory.decodeFile((String)localObject2, bheg.a((String)localObject2, i));
