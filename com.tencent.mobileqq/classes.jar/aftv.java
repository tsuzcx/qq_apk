...
public class aftv
{
  private static final String jdField_a_of_type_JavaLangString = aftv.class.getSimpleName();
  private static final byte[] jdField_a_of_type_ArrayOfByte = new byte[0];
  private afts jdField_a_of_type_Afts;
  private SharedPreferences jdField_a_of_type_AndroidContentSharedPreferences;
  private AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface;
  
  public aftv(AppInterface paramAppInterface)
  {
    this.jdField_a_of_type_ComTencentCommonAppAppInterface = paramAppInterface;
    if (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null) {
      this.jdField_a_of_type_Afts = ((afts)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(321));
    }
  ...
  private void a(File paramFile)
  {
    ...
    if (paramFile.length > 0)
    {
      ...
      if ((localObject != null) && (((File)localObject).isFile()) && (((File)localObject).exists()))
      {
        ...
        if (bgmg.d(paramFile[0].getAbsolutePath())) {
  ...
  private File[] a(File paramFile)
  {
    ...
    Arrays.sort(paramFile, new aftw(this));
    return paramFile;
  }
  ...
  private void b(AcsMsg paramAcsMsg)
  {
    ...
    {
      if (this.jdField_a_of_type_Afts == null) {
        this.jdField_a_of_type_Afts = ((afts)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(321));
      }
      if (this.jdField_a_of_type_Afts == null) {
        break label146;
      ...
      this.jdField_a_of_type_Afts.a(paramAcsMsg.msg_id.hashCode());
    }
    while ((this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof QQAppInterface))
    {
      ...
      localQQAppInterface.a().b(anhk.ad, 9002, paramAcsMsg.msg_id.hashCode());
  ...
  {
    paramFile = paramFile.listFiles(new aftx(this));
  ...
  public List<AcsMsg> a()
  {
    ...
    if (arrayOfFile.length > 0)
    {
      ...
      while (i < j)
      {
        ...
        if ((localObject != null) && (((File)localObject).isFile()) && (((File)localObject).exists()) && (afsx.a(a((File)localObject))))
        {
          localObject = a((File)localObject);
  ...
  public void a(AcsMsg paramAcsMsg)
  {
    ...
    //   8: return
    //   9: aload_0
    //   10: getfield 39	aftv:jdField_a_of_type_Afts	Lafts;
    //   13: ifnonnull +20 -> 33
    //   16: aload_0
    //   17: aload_0
    //   18: getfield 29	aftv:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    //   21: sipush 321
    //   24: invokevirtual 35	com/tencent/common/app/AppInterface:getManager	(I)Lmqq/manager/Manager;
    //   27: checkcast 37	afts
    //   30: putfield 39	aftv:jdField_a_of_type_Afts	Lafts;
    //   33: aload_0
    //   34: getfield 39	aftv:jdField_a_of_type_Afts	Lafts;
    //   37: ifnull +35 -> 72
    //   40: aload_0
    //   41: getfield 39	aftv:jdField_a_of_type_Afts	Lafts;
    //   44: aload_1
    //   45: invokevirtual 313	afts:a	(LWallet/AcsMsg;)V
    //   48: new 315	com/tencent/mobileqq/activity/activateFriend/biz/ReminderDataManager$1
    //   51: dup
    //   52: aload_0
    //   53: aload_1
    //   54: invokespecial 317	com/tencent/mobileqq/activity/activateFriend/biz/ReminderDataManager$1:<init>	(Laftv;LWallet/AcsMsg;)V
    //   57: bipush 64
    //   59: aconst_null
    //   60: iconst_1
    //   61: invokestatic 311	com/tencent/mobileqq/app/ThreadManagerV2:excute	(Ljava/lang/Runnable;ILcom/tencent/mobileqq/app/ThreadExcutor$IThreadListener;Z)V
    //   64: goto -58 -> 6
    //   67: astore_1
    //   68: aload_0
    //   69: monitorexit
    ...
    //   71: athrow
    //   72: aload_1
    //   73: invokestatic 318	akwm:a	(LWallet/AcsMsg;)V
    //   76: goto -28 -> 48
    //   79: astore_2
    //   80: aload_2
  ...
  public void a(String paramString, aftz paramaftz)
  {
    try
    {
      ThreadManagerV2.excute(new ReminderDataManager.5(this, paramString, paramaftz), 64, null, true);
      return;
    }
    finally
    {
  ...
  public void a(String paramString, afua paramafua)
  {
    try
    {
      aftu.b(paramString, new afty(this, paramafua));
      return;
    }
