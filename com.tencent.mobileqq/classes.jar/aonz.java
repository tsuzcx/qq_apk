...
public class aonz
{
  ...
  public aonz(AppInterface paramAppInterface, Drawable paramDrawable, int paramInt1, int paramInt2, String paramString, int paramInt3, boolean paramBoolean1, DynamicAvatar paramDynamicAvatar, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4, boolean paramBoolean5, int paramInt4)
  {
    this.jdField_a_of_type_Boolean = true;
  ...
  public static void a(AppInterface paramAppInterface)
  {
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      ...
      paramAppInterface = (aqib)paramAppInterface.getManager(180);
  ...
  public void a(AppInterface paramAppInterface, Drawable paramDrawable, int paramInt1, int paramInt2, String paramString, int paramInt3, int paramInt4, boolean paramBoolean1, int paramInt5, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4, DynamicAvatar paramDynamicAvatar, boolean paramBoolean5)
  {
    ...
    for (this.jdField_b_of_type_Int = 18;; this.jdField_b_of_type_Int = 17)
    {
      ...
      this.jdField_d_of_type_JavaLangString = aqib.b(paramInt1, paramInt2, paramString, paramInt3);
      if (!paramBoolean5) {
        this.jdField_a_of_type_ComTencentImageURLDrawable = null;
      }
      this.jdField_a_of_type_Aqib = ((aqib)paramAppInterface.getManager(180));
      return;
  ...
  {
    this.jdField_a_of_type_Aqib.a(this);
    if ((paramBoolean) && (this.jdField_a_of_type_Aqib.a(this.jdField_e_of_type_Int)))
    {
      paramBoolean = true;
    ...
    do
    {
      do
      {
        ...
        paramBoolean = false;
        break;
      } while ((!this.g) && (!bhnv.h(BaseApplicationImpl.getContext())) && (this.jdField_d_of_type_Boolean));
      ...
      {
        this.jdField_a_of_type_Aqib.b(this);
        return;
      }
      if (paramDynamicAvatar != null)
      {
        this.jdField_b_of_type_JavaLangString = aqib.a(this.jdField_b_of_type_Int, this.jdField_d_of_type_Int, paramDynamicAvatar);
        this.jdField_c_of_type_JavaLangString = aqib.a(this.jdField_b_of_type_Int, 640, paramDynamicAvatar);
        if ((this.jdField_c_of_type_Boolean) && (TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)))
        {
          this.jdField_b_of_type_JavaLangString = aqib.a(17, this.jdField_d_of_type_Int, paramDynamicAvatar);
          this.jdField_c_of_type_JavaLangString = aqib.a(17, 640, paramDynamicAvatar);
        }
  ...
  public boolean b()
  {
    ...
    if (localDynamicAvatarView.jdField_a_of_type_Aonz != this)
    {
      QLog.e("Q.dynamicAvatar", 1, "mDynamicFaceDrawable is changed : " + this + " " + localDynamicAvatarView.jdField_a_of_type_Aonz);
      return false;
    }
    return true;
  }
