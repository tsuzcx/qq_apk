...
public class akgy
{
  ...
  public static final Point a(Activity paramActivity, int paramInt)
  {
    ...
    for (int i = localDisplayMetrics.widthPixels;; i = localDisplayMetrics.heightPixels) {
      ...
      {
      default: 
        paramInt = i - afur.a(65.0F, paramActivity.getResources());
  ...
  public static String a()
  {
    ...
    if (bgjq.a())
    {
      localStringBuilder.append(anhk.cX).append("tmp/").append(System.currentTimeMillis()).append("_photo.tmp");
  ...
  {
    if (paramInt == 0) {
      return paramContext.getString(2131717787);
    }
    if (paramInt == 1) {
      return paramContext.getString(2131695389);
    }
    if (paramInt == 2) {
      return paramContext.getString(2131695388);
    }
    if (paramInt == 3) {
      return paramContext.getString(2131695390);
    }
    if (paramInt == 5) {
      return paramContext.getString(2131695387);
    }
    if (paramInt == 100) {
      return paramContext.getString(2131695371);
    }
    if (paramInt == 101) {
      return paramContext.getString(2131695372);
    }
    if (paramInt == 102) {
      return paramContext.getString(2131695369);
    }
    if (paramInt == 103) {
      return paramContext.getString(2131695373);
    }
    if (paramInt == 1793) {
      return paramContext.getString(2131693019);
    }
    return paramContext.getString(2131695386);
  }
  
  public static String a(List<akeh> paramList, TroopInfo paramTroopInfo)
  {
    String str = akeh.a;
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localTroopClipPic.type == 1) {
        ...
        paramList.add(akeh.a(localTroopClipPic, paramTroopInfo.mTroopVerifyingPics));
      }
    }
    if (com.tencent.TMG.utils.QLog.isColorLevel()) {
  ...
  public static URL a(String paramString)
  {
    ...
    do
    {
      ...
      try
      {
        paramString = bdwn.a(paramString);
        return paramString;
      }
  ...
  public static void a(int paramInt, String paramString1, String paramString2)
  {
    ...
    URL localURL = a(bfpi.b(bfpi.a(str, paramString2, 1)));
    if (localURL != null)
    {
      paramInt = a(paramString1, bdsh.d(localURL.toString()));
      if (com.tencent.TMG.utils.QLog.isColorLevel()) {
        com.tencent.TMG.utils.QLog.d("TroopPhotoUtil", 0, "cacheFileFromLocal origin photo,result:" + paramInt);
      }
    }
    paramString2 = a(bfpi.a(bfpi.a(str, paramString2, 1)));
    if (paramString2 != null)
    {
      paramInt = b(paramString1, bdsh.d(paramString2.toString()));
      if (com.tencent.TMG.utils.QLog.isColorLevel()) {
  ...
  public static final void a(Rect paramRect, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      if ((paramString.length == 4) && (azby.a(paramString[0])) && (azby.a(paramString[1])) && (azby.a(paramString[2])) && (azby.a(paramString[3])))
      {
  ...
  public static int b(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      BitmapFactory.Options localOptions = bgmo.a(((File)localObject).getPath(), 100);
      try
      {
        localObject = bgmo.a(((File)localObject).getPath(), localOptions);
      ...
      try
      {
        int i = bfup.a(paramString1);
        paramString1 = (String)localObject;
        if (i != 0) {
          paramString1 = bgmo.b((Bitmap)localObject, i);
        }
        if (paramString1 != null)
        {
          bgmo.a(paramString1, paramString2);
          return 0;
        }
      }
