  ...
  extends QIMEffectCameraCaptureUnit
{
  ...
  public bnch(boyn paramboyn, boym paramboym)
  {
    super(paramboyn, paramboym);
    this.jdField_a_of_type_Boyf = new boyf(10004, 8, 2);
  ...
  private void a(Activity paramActivity)
  {
    ...
    blsb.c(paramActivity, localAppRuntime.getAccount(), localIntent, -1);
  }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (!(localObject1 instanceof alip)) {
          break label564;
        }
        localObject1 = (alip)localObject1;
        ((alip)localObject1).c_((String)localObject2);
        ...
        bncv.a(this.jdField_a_of_type_Boyn.a(), paramIntent, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView$VideoCaptureResult, this.jdField_a_of_type_Boym, null, (alip)localObject1, (String)localObject2, 1, null, bool, null, false);
      ...
      {
        bncv.a(this.jdField_a_of_type_Boyn.a(), paramIntent, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView$VideoCaptureResult, this.jdField_a_of_type_Boym, new bnci(this, localActivity, paramIntent));
        continue;
        if ((paramInt2 == -1) && (paramIntent != null))
        {
          localObject1 = this.jdField_a_of_type_Boyn.a();
          paramInt1 = paramIntent.getIntExtra("forward_to_someplace_from_shoot_quick", 0);
          if (paramInt1 == 1002)
          {
        ...
        if ((bool) || (paramIntent != null) || (!(this.jdField_a_of_type_Boyn.a() instanceof SplashActivity))) {
          break;
        }
        if (this.jdField_a_of_type_Bojo != null)
        {
  ...
  {
    super.a(parambaox);
    boyg localboyg = new boyi(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView.a()).a(2).b(101).a();
  ...
  public void a(CameraCaptureView.VideoCaptureResult paramVideoCaptureResult, LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    boyj localboyj = new boyl().a(101).b(2).a();
