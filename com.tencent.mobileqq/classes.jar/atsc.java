...
{
  static final int[] jdField_a_of_type_ArrayOfInt = { 2131375582, 2131375578, 2131375577, 2131375583, 2131375580, 2131375581, 2131375579 };
  int jdField_a_of_type_Int;
  private amnf jdField_a_of_type_Amnf = new atsk(this);
  private View.OnLongClickListener jdField_a_of_type_AndroidViewView$OnLongClickListener = new atsu(this);
  ...
  atol jdField_a_of_type_Atol;
  private atte jdField_a_of_type_Atte;
  private aywb jdField_a_of_type_Aywb = new atst(this);
  ...
  private amnf jdField_b_of_type_Amnf = new atsl(this);
  ...
  private amnf jdField_c_of_type_Amnf = new atsv(this);
  ...
  public atsc(NearbyPeopleProfileActivity paramNearbyPeopleProfileActivity)
  {
    ...
    if (Build.VERSION.SDK_INT >= 11) {
      this.jdField_a_of_type_Atte = new atte(this, this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.f);
    }
    this.jdField_h_of_type_Int = vzl.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, 2.0F);
    int k = atol.jdField_a_of_type_ArrayOfInt.length - 1;
    this.jdField_a_of_type_ArrayOfAtfm = new atfm[k];
    int j = 0;
    while (j < k)
    {
      this.jdField_a_of_type_ArrayOfAtfm[j] = new atfm(atol.jdField_a_of_type_ArrayOfInt[j]);
      j += 1;
    }
    this.jdField_a_of_type_Aywb.addFilter(new Class[] { aysv.class });
    this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.a().a(this.jdField_a_of_type_Aywb);
  }
  
  private View.OnClickListener a(int paramInt)
  {
    return new atta(this, paramInt);
  }
  ...
  private RelativeLayout a(PicInfo paramPicInfo, Drawable paramDrawable)
  {
    ...
    localRelativeLayout.setBackgroundResource(2130844239);
    ...
    if (Build.VERSION.SDK_INT >= 11)
    {
      ...
      localRelativeLayout.setOnDragListener(this.jdField_a_of_type_Atte);
    }
  ...
  {
    if (paramBoolean) {}
    for (int j = 2131166848;; j = 2131166854)
    {
  ...
  private void a(PicInfo paramPicInfo, View paramView)
  {
    ...
    paramPicInfo = bbdj.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, ajya.a(2131707340), 0, 0, null, null);
    paramPicInfo.setPositiveButton(2131694794, new attd(this, paramPicInfo));
    paramPicInfo.show();
  }
  ...
  private void a(CustomImgView paramCustomImgView, PicInfo paramPicInfo, Drawable paramDrawable)
  {
    ...
    if (paramDrawable == null) {
      localObject = this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getResources().getDrawable(2130844864);
    }
    try
    {
    ...
    {
      paramCustomImgView.setImageDrawable(URLDrawable.getDrawable(ayst.a(paramDrawable), localURLDrawableOptions));
      return;
    }
    label258:
  }
  ...
  {
    RelativeLayout localRelativeLayout = new RelativeLayout(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity);
    localRelativeLayout.setBackgroundResource(2130840974);
    Object localObject = new RelativeLayout.LayoutParams(vzl.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, 35.0F), vzl.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, 16.0F));
    int j = vzl.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, 5.0F);
    ...
    ((TextView)localObject).setText(ajya.a(2131707359));
  ...
  private boolean e()
  {
    ...
    if (!bbkk.a(str))
    {
      if (bbkk.d(str).length() == 0)
      {
        this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.b(ajya.a(2131707278));
        return false;
      }
    }
    else
    {
      this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.b(ajya.a(2131707291));
      return false;
    }
    return true;
  }
  ...
  private void j()
  {
    bfpc localbfpc = bfpc.c(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity);
    Object localObject = (DispatchActionMoveScrollView)localbfpc.findViewById(2131361922);
    ((DispatchActionMoveScrollView)localObject).jdField_a_of_type_Boolean = true;
    ((DispatchActionMoveScrollView)localObject).setBackgroundResource(17170445);
    localObject = (IphonePickerView)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity).inflate(2131560804, null);
    ((IphonePickerView)localObject).a(this.jdField_b_of_type_Amnf);
    if (this.jdField_h_of_type_AndroidWidgetEditText.getTag() != null)
    {
      ...
      ((IphonePickerView)localObject).setPickListener(new atsy(this, (IphonePickerView)localObject, localbfpc));
      localbfpc.a(new atsz(this));
    ...
    localbfpc.show();
    a(this.jdField_e_of_type_AndroidWidgetLinearLayout, localbfpc.a());
        ...
        if (((RelativeLayout)localObject).getChildCount() == 2) {
          if (j == 0)
          {
            ...
            if (this.jdField_a_of_type_AndroidWidgetLinearLayout.getChildAt(j) != null) {
              this.jdField_a_of_type_AndroidWidgetLinearLayout.getChildAt(j).setContentDescription(ajya.a(2131707269) + (j + 1));
            }
          }
        }
      }
  ...
  private void m()
  {
    axqy.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "dc00899", "grp_lbs", "", "data_card", "del_pho", 0, 0, "", "", "", "");
  }
  
  private void n()
  {
    axqy.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "dc00899", "grp_lbs", "", "data_card", "up_gif", 0, 0, "", "", "", "");
  }
  ...
  private void o()
  {
    ...
    {
      Object localObject = this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131694596, new Object[] { this.jdField_a_of_type_JavaLangString });
      localObject = bbdj.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, (String)localObject, 0, 0, null, null);
      ((bbgu)localObject).setPositiveButton(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131694973), new attc(this, (bbgu)localObject));
  ...
  private void p()
  {
    this.jdField_a_of_type_AndroidWidgetTextView.setText(ajya.a(2131707298));
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    this.jdField_b_of_type_AndroidWidgetTextView.setText(ajya.a(2131707259));
    ...
    this.jdField_b_of_type_AndroidViewView.findViewById(2131368429).setVisibility(8);
    TextView localTextView = (TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131368431);
    localTextView.setVisibility(0);
    localTextView.setText(2131690596);
    localTextView.setOnClickListener(new atsm(this));
    localTextView = (TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131368457);
    localTextView.setVisibility(0);
    localTextView.setText(2131692601);
    localTextView.setEnabled(true);
    localTextView.setOnClickListener(new atso(this));
    this.jdField_b_of_type_AndroidViewView.findViewById(2131375329).setOnClickListener(this);
  }
  ...
  private void q()
  {
    if (this.jdField_a_of_type_JavaUtilLinkedList.size() > 0)
    {
      Object localObject = new StringBuilder(ajya.a(2131707287));
  ...
  Intent a(String paramString)
  {
    ...
    paramString = ajsd.aW + "nearby_people_photo/";
    ...
    localIntent.putExtra("PhotoConst.QZONE_COVER_CROP_LEFT_TITLE", ajya.a(2131707292));
  ...
  public void a()
  {
    this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.a().b(this.jdField_a_of_type_Aywb);
  }
  ...
  public void a(int paramInt)
  {
    ...
    String str = ajsd.aW + "nearby_people_photo/";
    ...
    bbbx.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, false, true);
    axqy.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X800481F", "0X800481F", 1, 0, "", "", "", "");
  }
  ...
  void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    j = paramInt2 + 1;
    int m = paramInt3 + 1;
    localObject1 = bbbr.a(paramInt2 + 1, paramInt3 + 1);
                      ...
                      if ((paramInt2 == -1) && (paramIntent != null))
                      {
                        ...
                        for (;;)
                        {
                          try
                          {
                            ...
                            paramInt1 = j;
                            if (paramInt1 < this.jdField_a_of_type_ArrayOfAtfm.length)
                            {
                              if (this.jdField_a_of_type_ArrayOfAtfm[paramInt1].jdField_a_of_type_Int != paramInt2) {
                                break label406;
                              }
                              paramIntent = this.jdField_a_of_type_ArrayOfAtfm[paramInt1];
                            ...
                            this.jdField_a_of_type_Atol.a(this.jdField_a_of_type_ArrayOfAtfm);
                        ...
                        if ((paramInt2 == -1) && (this.jdField_d_of_type_AndroidWidgetEditText != null))
                        {
                          ...
                          if (paramInt2 == -1)
                          {
                            ...
                            try
                            {
                              paramIntent = this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.jdField_a_of_type_Ajtw.a((String[])localObject2);
                              if (paramIntent != null)
                              {
  ...
  protected void a(View paramView)
  {
    ...
    paramView.findViewById(2131377400).setVisibility(0);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131377438));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131377379));
    paramView.findViewById(2131368472).setVisibility(4);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131365507));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundColor(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getResources().getColor(2131166912));
    this.jdField_a_of_type_AndroidWidgetHorizontalScrollView = ((HorizontalScrollView)paramView.findViewById(2131365508));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131365488));
    ...
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131371489));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131376631));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131365505));
    this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131365506));
    this.jdField_e_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131376459));
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131370832));
    this.jdField_b_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131366980));
    this.jdField_c_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131362189));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131363954));
    this.jdField_d_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131368752));
    this.jdField_c_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131368753));
    this.jdField_e_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131364571));
    this.jdField_d_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131364359));
    this.jdField_f_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131364358));
    this.jdField_g_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131363977));
    this.jdField_f_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131367563));
    this.jdField_g_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131379557));
    this.jdField_h_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131376454));
    this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem = ((FormSwitchItem)paramView.findViewById(2131366497));
    this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem.setVisibility(8);
    this.jdField_h_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131375576));
    this.jdField_a_of_type_ComTencentWidgetImmersiveImmersiveTitleBar2 = ((ImmersiveTitleBar2)paramView.findViewById(2131377439));
    this.jdField_a_of_type_ComTencentMobileqqWidgetBounceScrollView = ((BounceScrollView)this.jdField_b_of_type_AndroidViewView.findViewById(2131365512));
    this.jdField_a_of_type_ComTencentMobileqqWidgetBounceScrollView.mScrollFlag = 1;
    paramView = (LinearLayout)this.jdField_b_of_type_AndroidViewView.findViewById(2131368874);
    this.jdField_a_of_type_Atol = new atol();
    this.jdField_a_of_type_Atol.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, paramView);
    p();
  }
  ...
  public void a(NearbyPeopleCard paramNearbyPeopleCard)
  {
    ...
    {
      j = ((Integer)atbi.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getCurrentAccountUin(), "self_gender", Integer.valueOf(-1))).intValue();
      axqy.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "dc00899", "grp_lbs", "", "data_card", "exp_edit", 0, 0, atbr.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.jdField_j_of_type_Int), j + "", "", "");
      ...
      this.jdField_a_of_type_JavaLangString = ajya.a(2131707288);
      if (!this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.godFlag) {
        break label1232;
      }
      this.jdField_d_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131694562));
      this.jdField_a_of_type_AndroidWidgetButton.setContentDescription(ajya.a(2131707252));
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new atse(this));
      e();
      ...
      this.jdField_b_of_type_AndroidWidgetEditText.setText(bazx.b(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.gender));
      ...
      int n = (0xFF00 & k) >> 8;
      int i1 = k & 0xFF;
      paramNearbyPeopleCard = bbbr.a(n, i1);
      ...
      this.jdField_e_of_type_AndroidWidgetTextView.setText(bazx.d(j));
      if (!bbkk.a(bazx.d(j))) {
        break label1276;
      }
      this.jdField_e_of_type_AndroidWidgetTextView.setVisibility(8);
      this.jdField_d_of_type_AndroidWidgetEditText.setText(bazx.e(j));
      ...
      paramNearbyPeopleCard = (String)atbi.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getCurrentAccountUin(), "school_name", "");
      if (!this.jdField_b_of_type_Boolean)
      {
        ...
        this.i = ((Integer)atbi.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getCurrentAccountUin(), "school_valid_state", Integer.valueOf(0))).intValue();
        if (this.i != 2) {
          break label1298;
        }
      ...
      this.jdField_h_of_type_AndroidWidgetEditText.setText(bazx.a(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.maritalStatus - 1));
      ...
      if (bazx.a(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.vGiftInfo) == 0) {
        break label1439;
      }
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.godFlag)
      {
        paramNearbyPeopleCard = this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131694597, new Object[] { this.jdField_a_of_type_JavaLangString });
        paramNearbyPeopleCard = bbdj.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, paramNearbyPeopleCard, 0, 0, null, null);
        paramNearbyPeopleCard.setPositiveButton(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131694973), new atsf(this, paramNearbyPeopleCard));
      ...
      this.jdField_b_of_type_AndroidViewView.findViewById(2131379558).setOnClickListener(this);
      this.jdField_g_of_type_AndroidWidgetEditText.setOnClickListener(this);
      this.jdField_b_of_type_AndroidViewView.findViewById(2131376459).setOnClickListener(this);
      this.jdField_h_of_type_AndroidWidgetEditText.setOnClickListener(this);
      this.jdField_b_of_type_AndroidViewView.findViewById(2131366983).setOnClickListener(this);
      this.jdField_b_of_type_AndroidWidgetEditText.setOnClickListener(this);
      this.jdField_b_of_type_AndroidViewView.findViewById(2131362191).setOnClickListener(this);
      this.jdField_c_of_type_AndroidWidgetEditText.setOnClickListener(this);
      this.jdField_b_of_type_AndroidViewView.findViewById(2131368753).setOnClickListener(this);
      this.jdField_d_of_type_AndroidWidgetEditText.setOnClickListener(this);
      this.jdField_b_of_type_AndroidViewView.findViewById(2131367564).setOnClickListener(this);
      this.jdField_f_of_type_AndroidWidgetEditText.setOnClickListener(this);
      this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new atsg(this));
      this.jdField_g_of_type_AndroidWidgetEditText.addTextChangedListener(new atsh(this));
      this.jdField_e_of_type_AndroidWidgetEditText.addTextChangedListener(new atsi(this));
      this.jdField_a_of_type_AndroidWidgetEditText.getViewTreeObserver().addOnGlobalLayoutListener(new atsj(this));
      return;
      ...
      this.jdField_a_of_type_JavaLangString = ajya.a(2131707343);
      break label268;
      label1232:
      if (this.jdField_a_of_type_JavaUtilArrayList.size() <= NearbyPeopleProfileActivity.jdField_b_of_type_Int) {
        break label295;
      }
      this.jdField_d_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131694563, new Object[] { this.jdField_a_of_type_JavaLangString }));
      break label295;
      label1276:
      this.jdField_e_of_type_AndroidWidgetTextView.setBackgroundResource(bazx.b(j));
      this.jdField_e_of_type_AndroidWidgetTextView.setVisibility(0);
      break label587;
      label1298:
      ...
      for (;;)
      {
        atbi.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getCurrentAccountUin(), "school_name", this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.college);
        atbi.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getCurrentAccountUin(), "school_valid_state", Integer.valueOf(this.i));
        break;
        this.jdField_g_of_type_AndroidWidgetTextView.setVisibility(0);
        this.i = 2;
        continue;
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    if (TextUtils.isEmpty(paramString))
    {
      ...
      {
        this.jdField_g_of_type_AndroidWidgetTextView.setVisibility(0);
        axqy.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8006784", "0X8006784", 0, 0, "", "", "", "");
      }
    }
    else
    {
  ...
  public boolean a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard != null)
    {
      ...
      if (!bbbr.a(this.jdField_a_of_type_AndroidWidgetEditText.getText().toString(), this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.nickname)) {
        return true;
      }
      ...
      if (!bbkk.d(this.jdField_e_of_type_AndroidWidgetEditText.getText().toString()).equals(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.company)) {
        return true;
      }
      if (!bbkk.d(this.jdField_f_of_type_AndroidWidgetTextView.getText().toString()).equals(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.college)) {
        return true;
      }
      ...
      Object localObject2 = this.jdField_a_of_type_ArrayOfAtfm;
    ...
    for (int k = j;; k = j)
    {
      if (k != 0)
      {
        ...
        j = 0;
        break label440;
        localObject1 = ((atfm)localObject1).toString();
        break label507;
      }
      return false;
      break;
  ...
  public void c()
  {
    ...
    ajtw localajtw = (ajtw)this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getManager(59);
    int j = localajtw.a();
    Object localObject1;
    if (j != 0)
    {
      j = localajtw.a(j, true);
      if (QLog.isColorLevel()) {
        QLog.d("Q.nearby_people_card.", 2, "startLocationSelectActivity | update result = " + j);
      }
      if (j == 2)
      {
        bcql.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, 2131694610, 0).b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getTitleBarHeight());
        return;
      }
      if (j == 0)
      {
        this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getResources().getString(2131691031));
        localajtw.c(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.jdField_a_of_type_Ajua);
        return;
      }
      this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getResources().getString(2131691031));
    ...
    localIntent.putExtra("param_location_param", localajtw.b((String[])localObject1));
  ...
  public void d()
  {
    ...
    do
    {
      ...
      str = this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.jdField_a_of_type_Ajtw.a(arrayOfString);
  ...
  void e()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.oldPhotoCount > 0) && (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.age >= 14) && (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.age <= 24) && (this.jdField_a_of_type_JavaUtilArrayList.size() <= 1)) {
      axqy.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X800481B", "0X800481B", 0, 0, "", "", "", "");
    }
    if (Build.VERSION.SDK_INT >= 11)
    {
  ...
  void f()
  {
    axqy.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004823", "0X8004823", 0, 0, "", "", "", "");
    if (QLog.isDevelopLevel()) {
  ...
  void g()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.a(ajya.a(2131707335));
    ArrayList localArrayList = new ArrayList();
    localArrayList.addAll(this.jdField_a_of_type_JavaUtilArrayList);
    if (d())
    {
      axqy.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 10, 0, "", "", "", "");
    ...
    for (int j = 1;; j = 3)
    {
      ...
      {
        localObject = "1";
        axqy.b(null, "dc00899", "grp_lbs", "", "data_card", "upload_video", 0, 0, "", (String)localObject, "", String.valueOf(j));
        j = ((Integer)atbi.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getCurrentAccountUin(), "self_gender", Integer.valueOf(-1))).intValue();
        axqy.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "dc00899", "grp_lbs", "", "data_card", "suc_edit", 0, 0, atbr.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.jdField_j_of_type_Int), j + "", "", "");
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard != null)
        {
          ...
          if (!Arrays.equals(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.xuanYan, (byte[])this.jdField_g_of_type_AndroidWidgetEditText.getTag()))
          {
            ...
            axqy.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 2, 0, "", "", "", "");
          }
          ...
          if (!((String)localObject).equals(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.nickname))
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.d = true;
            axqy.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 1, 0, "", "", "", "");
          }
          if ((this.jdField_h_of_type_AndroidWidgetEditText.getTag() != null) && (((Byte)this.jdField_h_of_type_AndroidWidgetEditText.getTag()).byteValue() != this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.maritalStatus))
          {
            localBundle.putByte("key_marital_status", ((Byte)this.jdField_h_of_type_AndroidWidgetEditText.getTag()).byteValue());
            axqy.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 3, 0, "", "", "", "");
          }
          ...
          if (b1 != this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.gender)
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.d = true;
            axqy.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 4, 0, "", "", "", "");
          }
          ...
          if (j != this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.birthday)
          {
            ...
            axqy.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 5, 0, "", "", "", "");
          }
          ...
          if (j != this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.job)
          {
            ...
            axqy.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 6, 0, "", "", "", "");
          }
          ...
          if (!((String)localObject).equals(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.company))
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.d = true;
            axqy.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 7, 0, "", "", "", "");
          }
          ...
          if (!((String)localObject).equals(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.college))
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.d = true;
            axqy.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 8, 0, "", "", "", "");
          }
          ...
          if (!Arrays.equals((Object[])localObject, new String[] { this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.hometownCountry, this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.hometownProvice, this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.hometownCity, this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.hometownDistrict }))
          {
            ...
            axqy.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 9, 0, "", "", "", "");
          }
          boolean bool2 = this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem.a();
          if (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.switchGiftVisible != 0L) {
            break label1242;
          ...
          if (bool2 != bool1)
          {
            ...
            axqy.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X80060BB", "0X80060BB", 0, 0, "", "", "", "");
          }
          if (QLog.isColorLevel()) {
        ...
        localObject = this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.jdField_a_of_type_Atbz;
        if (localObject == null) {
          break label1288;
        }
        this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.a(new NearbyProfileEditPanel.23(this, (atbz)localObject, localBundle, localArrayList));
      }
      label1242:
      label1247:
      label1252:
      while (!QLog.isDevelopLevel())
      {
        ...
        j = 1;
        break label1110;
        axqy.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X80060BC", "0X80060BC", 0, 0, "", "", "", "");
        break label1158;
      }
  ...
  public void onClick(View paramView)
  {
    ...
    Object localObject2;
    int k;
    if ((paramView.getId() == 2131366983) || (paramView == this.jdField_b_of_type_AndroidWidgetEditText))
    {
      localObject1 = bfpc.c(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity);
      localObject2 = (DispatchActionMoveScrollView)((bfpc)localObject1).findViewById(2131361922);
      ...
      localObject2 = (IphonePickerView)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity).inflate(2131560804, null);
      ((IphonePickerView)localObject2).a(this.jdField_c_of_type_Amnf);
      if (this.jdField_b_of_type_AndroidWidgetEditText.getTag() != null)
      {
        ...
        ((IphonePickerView)localObject2).setPickListener(new atsd(this, (IphonePickerView)localObject2, (bfpc)localObject1));
        ((bfpc)localObject1).a(new atsn(this));
        ((bfpc)localObject1).a((View)localObject2, null);
        ((bfpc)localObject1).show();
        a(paramView, ((bfpc)localObject1).a());
    ...
    do
    {
      ...
      {
        return;
        if ((paramView.getId() == 2131368753) || (paramView == this.jdField_d_of_type_AndroidWidgetEditText))
        {
          h();
          return;
        }
        if (paramView == this.jdField_d_of_type_AndroidWidgetLinearLayout)
        {
          ...
          paramView = bfnx.a(bfnx.a(bfnx.a(bfnx.a("https://qun.qq.com/qqweb/m/nearby/pages/school_edit.html", "_bid", "2473"), "_wv", "1031"), "schoolName", paramView), "isValid", String.valueOf(this.i));
        ...
        if ((paramView.getId() == 2131367564) || (paramView == this.jdField_f_of_type_AndroidWidgetEditText))
        {
          c();
          return;
        }
        if ((paramView.getId() == 2131379558) || (paramView == this.jdField_g_of_type_AndroidWidgetEditText))
        {
          i();
          return;
        }
        if ((paramView.getId() == 2131376459) || (paramView == this.jdField_h_of_type_AndroidWidgetEditText))
        {
          j();
          return;
        }
      } while ((paramView.getId() != 2131362191) && (paramView != this.jdField_c_of_type_AndroidWidgetEditText));
      localObject1 = bfpc.c(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity);
      localObject2 = Calendar.getInstance();
      this.jdField_b_of_type_Int = ((Calendar)localObject2).get(1);
      localObject3 = (DispatchActionMoveScrollView)((bfpc)localObject1).findViewById(2131361922);
      ...
      localObject3 = (IphonePickerView)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity).inflate(2131560804, null);
      ((IphonePickerView)localObject3).a(this.jdField_a_of_type_Amnf);
    ...
    for (j = 0;; j = (j & 0xFF) - 1)
    {
      ...
      ((IphonePickerView)localObject3).setPickListener(new atsw(this, (IphonePickerView)localObject3, (bfpc)localObject1));
      ...
      ((bfpc)localObject1).a(new atsx(this));
      ((bfpc)localObject1).a((View)localObject3, null);
      ((bfpc)localObject1).show();
      a(paramView, ((bfpc)localObject1).a());
