  ...
  extends BusinessHandler
{
  ...
  public axpy(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    anzn.d(this, 7, paramToServiceMsg, paramFromServiceMsg, paramObject);
  }
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (m == 0)
    {
      ...
      if (localRspBody.rpt_msg_event_list.has())
      {
        ...
        if (QLog.isColorLevel())
        {
          axql.a("handleGetNearbyUneadMsg", new Object[] { "dating", Long.valueOf(localRspBody.uint64_max_event_id.get()), Integer.valueOf(j), Long.valueOf(paramToServiceMsg.extraData.getLong("dating_lastEventId")), Long.valueOf(paramToServiceMsg.extraData.getLong("dating_readEventId")) });
          i = j;
        }
      }
      j = i;
      if (localRspBody.rpt_msg_nearby_event_list.has())
      {
        ...
        if (QLog.isColorLevel())
        {
          axql.a("handleGetNearbyUneadMsg", new Object[] { "rank", Integer.valueOf(k), Long.valueOf(paramToServiceMsg.extraData.getLong("rank_lastEventId")), Long.valueOf(paramToServiceMsg.extraData.getLong("rank_readEventId")) });
          j = k;
        }
      }
      i = j;
      if (localRspBody.rpt_msg_feed_event_list.has())
      {
        ...
        if (QLog.isColorLevel())
        {
          axql.a("handleGetNearbyUneadMsg", new Object[] { "feed", Long.valueOf(localRspBody.uint64_max_fresh_event_id.get()), Integer.valueOf(k), Long.valueOf(paramToServiceMsg.extraData.getLong("feed_lastEventId")), Long.valueOf(paramToServiceMsg.extraData.getLong("feed_readEventId")) });
          i = k;
        }
      }
    }
    if (QLog.isColorLevel()) {
      axql.a("handleGetNearbyUneadMsg", new Object[] { Integer.valueOf(m), Integer.valueOf(i) });
    }
    if (i != 0) {
      this.app.getNearbyProxy().a(i);
    }
    axpo.b(this.app.getCurrentAccountUin(), i);
  }
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramFromServiceMsg.isSuccess()) && (paramObject != null))
    {
      ...
      paramFromServiceMsg = (axnt)this.app.getManager(QQManagerFactory.NEARBY_GENERAL_MANAGER);
  ...
  private void f(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (bool1)
      {
        paramToServiceMsg = (axnt)this.app.getManager(QQManagerFactory.NEARBY_GENERAL_MANAGER);
        if (i == 0)
        {
          bool2 = true;
          label321:
  ...
  public void a()
  {
    long l1 = ((Long)axqc.a(this.app.getAccount(), "nearby_event_file", 4, "dating_last_event_id", Long.valueOf(0L))).longValue();
    long l2 = ((Long)axqc.a(this.app.getAccount(), "nearby_event_file", 4, "dating_read_event_id", Long.valueOf(0L))).longValue();
    long l3 = ((Long)axqc.a(this.app.getAccount(), "nearby_event_file", 4, "rank_last_event_seq", Long.valueOf(0L))).longValue();
    long l4 = ((Long)axqc.a(this.app.getAccount(), "nearby_event_file", 4, "rank_read_event_seq", Long.valueOf(0L))).longValue();
    long l5 = ((Long)axqc.a(this.app.getAccount(), "nearby_event_file", 4, "freshfeed_last_event_seq", Long.valueOf(0L))).longValue();
    long l6 = ((Long)axqc.a(this.app.getAccount(), "nearby_event_file", 4, "freshfeed_red_event_seq", Long.valueOf(0L))).longValue();
    ...
    if (QLog.isColorLevel()) {
      axql.a("getNearbyUnreadMsg", new Object[] { Long.valueOf(l1), Long.valueOf(l2), Long.valueOf(l3), Long.valueOf(l4), Long.valueOf(l5), Long.valueOf(l6) });
    }
  }
  
  public void a(byte paramByte)
  {
    anzn.a(this, paramByte);
  }
  ...
  public void b()
  {
    try
    {
      ...
      sendPbReq((ToServiceMsg)localObject);
      arxx.a("getNotifyOnLikeSwitch...", new Object[0]);
      return;
    }
    catch (Exception localException)
    {
