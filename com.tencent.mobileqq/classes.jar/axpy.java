...
public class axpy
{
  ...
  private Map<Integer, ajsu> jdField_a_of_type_JavaUtilMap = new HashMap();
  ...
  private Map<Integer, ajsu> e = new HashMap();
  private Map<Integer, Integer> f = new HashMap();
  
  private axpy()
  {
    this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(1), new ajsu(960, 720));
    this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(2), new ajsu(960, 720));
  ...
  private void a()
  {
    ...
    for (;;)
    {
      ...
      for (j = arrayOfString2.length - 1;; j = 0)
      {
        ...
        {
          this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(2), new ajsu(arrayOfInt3[i], arrayOfInt2[i]));
          this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(1), new ajsu(arrayOfInt3[i], arrayOfInt2[i]));
          this.e.put(Integer.valueOf(2), new ajsu(arrayOfInt3[j], arrayOfInt2[j]));
          this.e.put(Integer.valueOf(1), new ajsu(arrayOfInt3[j], arrayOfInt2[j]));
        }
        if (localObject != null)
        {
  ...
  public ajsu a(int paramInt)
  {
    if (this.jdField_a_of_type_JavaUtilMap.containsKey(Integer.valueOf(paramInt))) {
      return (ajsu)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
    }
    return new ajsu(960, 720);
  }
  
  public ajsu b(int paramInt)
  {
    if (this.e.containsKey(Integer.valueOf(paramInt))) {
      return (ajsu)this.e.get(Integer.valueOf(paramInt));
    }
    return new ajsu(640, 480);
  }
}
