...
public class aaqs
  implements aaqh
{
  public aaqs(GdtVideoImaxFragment paramGdtVideoImaxFragment) {}
  ...
  public void a(View paramView)
  {
    ...
    paramView = aapa.a(this.a.getActivity());
  ...
  {
    aanp.a("GdtVideoImaxFragment", "onPrepared() called with: v = [" + paramGdtVideoCommonView + "]");
  }
  ...
  {
    aanp.a("GdtVideoImaxFragment", "onStop() called with: v = [" + paramGdtVideoCommonView + "]");
  }
  
  public void d(GdtVideoCommonView paramGdtVideoCommonView)
  {
    aanp.a("GdtVideoImaxFragment", "onComplete() called with: v = [" + paramGdtVideoCommonView + "]");
  }
}
