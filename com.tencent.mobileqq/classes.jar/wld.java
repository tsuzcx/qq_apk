...
public abstract class wld
  extends woz<CertifiedAccountMeta.StFeed>
  implements wpv, wvq
{
  private Handler a;
  ...
  private void a(SubscribeFeedsEvent paramSubscribeFeedsEvent)
  {
        ...
        do
        {
          do
          {
            ...
            case 1: 
              if (win.a() != null)
              {
                paramSubscribeFeedsEvent.mSingleFakeFeed.poster.icon.set(win.a().icon.get());
                paramSubscribeFeedsEvent.mSingleFakeFeed.poster.nick.set(win.a().nick.get());
              }
    ...
    if (win.a() != null)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        {
          localStFeed.poster.icon.set(win.a().icon.get());
          localStFeed.poster.nick.set(win.a().nick.get());
        }
      }
    }
