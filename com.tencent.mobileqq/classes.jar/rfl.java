...
public class rfl
  extends xoi<TabChannelCoverInfo>
{
  public static final String a;
  private Map<Integer, qar> jdField_a_of_type_JavaUtilMap;
  private ntk jdField_a_of_type_Ntk;
  private TabLayout b;
  
  static
  {
    jdField_a_of_type_JavaLangString = rfl.class.getSimpleName();
  }
  
  public rfl(Context paramContext, List<TabChannelCoverInfo> paramList, TabLayout paramTabLayout, ntk paramntk)
  {
  ...
  protected void a(xoj paramxoj, TabChannelCoverInfo paramTabChannelCoverInfo, int paramInt)
  {
    TextView localTextView = (TextView)paramxoj.a(2131378378);
    Object localObject2 = (ImageView)paramxoj.a(2131368596);
    ImageView localImageView2 = (ImageView)paramxoj.a(2131368600);
    Object localObject1 = (ImageView)paramxoj.a(2131370756);
    a(new View[] { localTextView, localObject2, localImageView2, localObject1 });
    ImageView localImageView1 = (ImageView)paramxoj.a(2131368674);
    ...
    try
    {
      ...
      else
      {
        ...
        paramxoj.a().setOnClickListener(new rfm(this, paramInt, paramTabChannelCoverInfo, localImageView1));
        if (this.b != null)
        {
          ...
          {
            localObject1 = new qcb();
            ((qar)localObject1).a = paramTabChannelCoverInfo;
            ((qar)localObject1).l = paramInt;
        ...
        {
          paramxoj = paramxoj.a(2131368347);
          if (paramInt != this.jdField_a_of_type_Ntk.c()) {
            break label784;
          }
          ...
          paramxoj.setVisibility(0);
          if (this.jdField_a_of_type_Ntk.a() == 0)
          {
            paramTabChannelCoverInfo = (ViewGroup.MarginLayoutParams)paramxoj.getLayoutParams();
            paramTabChannelCoverInfo.leftMargin = bbkx.b(0.0F);
            paramTabChannelCoverInfo.rightMargin = bbkx.b(0.0F);
            paramxoj.setLayoutParams(paramTabChannelCoverInfo);
          }
        }
        return;
      }
    ...
    catch (Exception localException)
    {
      ...
      for (;;)
      {
        ...
        if (QLog.isColorLevel())
        {
          ...
          if ((paramInt < b()) && (i == 0))
          {
            Object localObject3 = this.jdField_a_of_type_Ntk;
            if (ntk.b)
            {
