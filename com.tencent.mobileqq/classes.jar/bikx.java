...
public class bikx
  implements bitu
{
  public bikx(ChallengeBragBase paramChallengeBragBase) {}
  ...
  protected void a(Intent paramIntent)
  {
    ...
    if (i != 0)
    {
      ...
      bisy.e("qqBaseActivity", "onGetNickNameError{KEY_ERROR_CODE:" + i + "; KEY_ERROR_MSG:" + paramIntent.getStringExtra("key_error_msg") + "}");
    }
  ...
  {
    this.a.d();
    bisy.c("qqBaseActivity", "GetNickNameCallback exception." + paramException.getMessage(), paramException);
  ...
  public void a(JSONObject paramJSONObject)
  {
    try
    {
      ...
      if (paramJSONObject.length() == 0)
      {
        ...
        paramJSONObject.putExtra("key_error_msg", biuc.c);
        paramJSONObject.putExtra("key_error_detail", anni.a(2131700315));
        a(paramJSONObject);
        return;
      }
    }
    ...
    {
      bisy.c("qqBaseActivity", "GetNickNameCallback exception." + paramJSONObject.getMessage(), paramJSONObject);
      paramJSONObject = new Intent();
      paramJSONObject.putExtra("key_error_code", -4);
      paramJSONObject.putExtra("key_error_msg", biuc.b);
      a(paramJSONObject);
      return;
      paramJSONObject = bite.a(bite.a(paramJSONObject.getJSONObject(0).getString("nick")), 12, true, true);
      if ("action_brag".equals(this.a.p))
      {
        this.a.a.setText(this.a.getString(2131689807, new Object[] { paramJSONObject }));
        return;
      }
    }
    ...
    if ("action_challenge".equals(this.a.p)) {
      this.a.a.setText(this.a.getString(2131689811, new Object[] { paramJSONObject }));
    }
  }
}
