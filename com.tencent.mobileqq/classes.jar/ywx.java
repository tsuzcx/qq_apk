...
public class ywx
{
  ...
  private yxa jdField_a_of_type_Yxa;
  private boolean jdField_a_of_type_Boolean;
  
  public ywx(Context paramContext, yxa paramyxa, Handler paramHandler)
  {
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new ywy(this);
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidOsHandler = paramHandler;
    this.jdField_a_of_type_Yxa = paramyxa;
  ...
  private void a(String paramString)
  {
    if (TextUtils.isEmpty(paramString))
    {
      ...
      a(7, this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131698028));
      return;
    }
    if (!NetworkUtil.isNetSupport(this.jdField_a_of_type_AndroidContentContext))
    {
      ...
      a(7, this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131698033));
      return;
    }
    if (NetworkUtil.isMobileNetWork(this.jdField_a_of_type_AndroidContentContext)) {
      a(7, this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131698032));
    }
    ((QIMMusicConfigManager)bogd.a(2)).a(paramString, this.jdField_a_of_type_Boolean, new ywz(this));
  }
