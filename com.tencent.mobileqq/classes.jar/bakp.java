...
public class bakp
  extends xbb
{
  public bakp(TroopFileTransferManager paramTroopFileTransferManager) {}
  ...
  public void a(boolean paramBoolean, int paramInt1, String paramString, int paramInt2, int paramInt3, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      paramString = (azpi)this.a.a().b.get(paramString);
    } while ((paramString == null) || (paramInt1 != 0));
    xam.a(this.a.a, this.a.e, paramString.a, paramString.b, TroopFileTransferManager.a(this.a));
