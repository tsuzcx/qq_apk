...
public class acju
{
  ...
  private WeakReference<acjw> jdField_a_of_type_JavaLangRefWeakReference;
  private URL jdField_a_of_type_JavaNetURL;
  private boolean jdField_a_of_type_Boolean;
  
  public acju(String paramString, WeakReference<acjw> paramWeakReference)
  {
    try
    {
    ...
    {
      acho.d("GdtDrawableLoader", "GdtDrawableLoader error " + paramString, paramWeakReference);
    }
  }
  
  private URLDrawable.URLDrawableListener a()
  {
    return new acjv(this);
  }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    acho.b("GdtDrawableLoader", "notify " + paramBoolean + " " + a());
    this.jdField_a_of_type_Boolean = true;
    if (paramBoolean)
    {
      ((acjw)this.jdField_a_of_type_JavaLangRefWeakReference.get()).a(this.jdField_a_of_type_ComTencentImageURLDrawable);
      return;
    }
    ((acjw)this.jdField_a_of_type_JavaLangRefWeakReference.get()).b(this.jdField_a_of_type_ComTencentImageURLDrawable);
  }
  ...
  private boolean a()
  {
    ...
    acho.b("GdtDrawableLoader", "retry " + a());
  ...
  private void b()
  {
    ...
    if ((!b()) || (this.jdField_a_of_type_ComTencentImageURLDrawable == null)) {
      acho.b("GdtDrawableLoader", "update error " + a());
    }
    for (;;)
    {
      return;
      ...
      {
        acho.b("GdtDrawableLoader", "drawable status is loading " + a());
        i = j;
      ...
      while ((i != 0) && (!this.jdField_a_of_type_Boolean))
      {
        ...
        {
          acho.b("GdtDrawableLoader", "drawable status is file downloaded " + a());
          i = j;
        }
        else if (this.jdField_a_of_type_ComTencentImageURLDrawable.getStatus() == 1)
        {
          acho.b("GdtDrawableLoader", "drawable status is successed " + a());
          a(true);
          i = 0;
        }
        else if (this.jdField_a_of_type_ComTencentImageURLDrawable.getStatus() == 2)
        {
          acho.d("GdtDrawableLoader", "drawable status is failed " + a());
          i = j;
          if (!a())
          {
            a(false);
        ...
        {
          acho.d("GdtDrawableLoader", "drawable status is cancled " + a());
          a(false);
          i = 0;
        }
        else
        {
          acho.d("GdtDrawableLoader", "drawable status is " + this.jdField_a_of_type_ComTencentImageURLDrawable.getStatus() + " " + a());
          i = 0;
        }
      }
    }
  ...
  public void a()
  {
    if (!b())
    {
      acho.d("GdtDrawableLoader", "load error");
      return;
    }
    acho.b("GdtDrawableLoader", "load " + a());
    ...
    {
      acho.d("GdtDrawableLoader", "load error " + a());
      return;
    }
