...
public class uid
{
  ...
  private void a(Context paramContext, int paramInt1, String paramString, stSimpleMetaFeed paramstSimpleMetaFeed, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      {
        int i = a();
        upe.d("WSGridCardPresenter", "open weishi scheme = " + paramString + ", weishi_jump_url = " + paramstSimpleMetaFeed.weishi_jump_url);
        upg.a(paramContext.getApplicationContext(), "biz_src_jc_gzh_weishi", paramString, 1, i, paramInt2);
        if (i == 2) {
          umq.a(paramstSimpleMetaFeed, paramInt1, 1000);
        }
        umq.a(1, 114, paramInt1, paramstSimpleMetaFeed, null);
        return;
      }
      catch (Exception paramContext)
      {
        paramContext.printStackTrace();
        upe.d("WSGridCardPresenter", "open weishi error scheme = " + paramString);
        return;
      }
  ...
  private void a(Context paramContext, stSimpleMetaFeed paramstSimpleMetaFeed)
  {
    ...
    ugx.a((Activity)paramContext, localWSDownloadParams, false);
  }
  ...
  private void b(Context paramContext, int paramInt, stSimpleMetaFeed paramstSimpleMetaFeed)
  {
    ...
    for (;;)
    {
      umq.a(paramstSimpleMetaFeed, paramInt, 1001);
      return;
      if (ugb.a().a()) {
        c(paramContext, paramInt, paramstSimpleMetaFeed);
      } else {
        upe.a("WSGridCardPresenter", "B test do not download when 4g is not open is server");
      }
    }
  }
  ...
  private void c(Context paramContext, int paramInt, stSimpleMetaFeed paramstSimpleMetaFeed)
  {
    ...
    if (i < 10000)
    {
      ...
      paramContext = ((udo)localObject).a();
      label97:
      if (localObject == null) {
        break label158;
      }
    ...
    label153:
    label158:
    for (Object localObject = ((udo)localObject).a();; localObject = null)
    {
      ugx.a(localActivity, localWSDownloadParams, paramContext, (RockDownloadListenerWrapper)localObject);
      umq.a(1, 115, paramInt, paramstSimpleMetaFeed, ugx.a(localWSDownloadParams.mScene, localWSDownloadParams.mLinkStrategyType, localWSDownloadParams.mEventId));
      return;
      i = 100;
      break;
      paramContext = null;
  ...
  private void d(Context paramContext, int paramInt, stSimpleMetaFeed paramstSimpleMetaFeed)
  {
    if (paramstSimpleMetaFeed.video != null)
    {
      ...
      {
        pha.d(paramContext, localstH5OpInfo.h5Url);
        umw.a(140, localstH5OpInfo.type, paramInt, paramstSimpleMetaFeed.h5_op_info.id);
        umq.a(140, 9, null);
  ...
  public void a(Context paramContext, int paramInt, stSimpleMetaFeed paramstSimpleMetaFeed)
  {
    ...
    {
      umq.a(str2, str3, str1, paramstSimpleMetaFeed.feed_desc, paramInt, 112, 1, 0);
      umw.a(true);
      if ((paramContext instanceof BaseActivity))
      {
        paramContext = bgng.a(((BaseActivity)paramContext).app, paramContext, paramstSimpleMetaFeed.video_url + "&click_index=" + (paramInt + 1));
        if (paramContext != null) {
          paramContext.a();
        }
        avks.jdField_a_of_type_JavaLangString = paramstSimpleMetaFeed.id;
        avks.b = paramstSimpleMetaFeed.feed_desc;
        avks.jdField_a_of_type_Int = paramInt;
      }
      return;
    }
  }
  ...
  public void a(Context paramContext, int paramInt, ArrayList<stSimpleMetaFeed> paramArrayList, stSimpleMetaFeed paramstSimpleMetaFeed)
  {
    ...
    {
      umw.a(141, paramstSimpleMetaFeed.id);
      return;
    }
    umw.a(112, Integer.valueOf(2));
  }
  ...
  public void a(Context paramContext, stSimpleMetaFeed paramstSimpleMetaFeed, int paramInt)
  {
    ...
    {
      umw.a(112, paramstSimpleMetaFeed.h5_op_info.type, paramInt, paramstSimpleMetaFeed.h5_op_info.id);
    ...
    {
      umq.a(i, (Map)localObject2, str1, j, str2, str3, str4, paramInt, "", (String)localObject1, paramstSimpleMetaFeed.h5_op_info.id);
      ...
      ups.a(paramContext, (String)localObject1, str1, "", paramstSimpleMetaFeed.h5_op_info.type, new uie(this, paramContext, paramInt, paramstSimpleMetaFeed));
      return;
    }
  }
    ...
    while (i != 0)
    {
      ...
      else
      {
        ...
        if ((localstWaterFallItemStrategy != null) && (localstWaterFallItemStrategy.isCallWeishi))
        {
          ...
          bool2 = ugb.a().b();
          upe.d("WSGridCardPresenter", "openCallWeishi = " + bool1 + ", isOpenVideoPage = " + bool2 + ", callCount = " + i + ", openCallWSCount = " + localudo.jdField_a_of_type_Int);
          umw.a(112, Integer.valueOf(114));
          WSPublicAccReport.getInstance().feedsItemReport("gzh_click", ups.a(1), paramstSimpleMetaFeed, umq.a(paramstSimpleMetaFeed, paramInt), 1000003);
          if ((!bool1) || (localudo.jdField_a_of_type_Int >= i)) {
            break;
          }
          localudo.jdField_a_of_type_Int += 1;
          if (i >= 10000) {
            break label307;
          }
          i = 104;
        ...
        for (i = 143;; i = 142)
        {
          umq.a(paramstSimpleMetaFeed, paramInt, i);
          return true;
          bool1 = false;
          break;
          bool2 = false;
        ...
        label322:
        upe.d("WSGridCardPresenter", "openDownloadWeishi = " + bool2 + ", downloadCount = " + j + ", openDownloadWSCount = " + udo.b);
        umw.a(112, Integer.valueOf(115));
        WSPublicAccReport.getInstance().feedsItemReport("gzh_click", ups.a(1), paramstSimpleMetaFeed, umq.a(paramstSimpleMetaFeed, paramInt), 1000002);
        if ((bool2) && (udo.b < j))
        {
          a(paramContext, paramInt, paramArrayList, paramstSimpleMetaFeed);
