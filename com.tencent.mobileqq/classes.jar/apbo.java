...
public class apbo
{
  ...
  /* Error */
  private void a(File paramFile1, File paramFile2, apbn paramapbn)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 9
    ...
    //   25: iconst_1
    //   26: ldc 150
    //   28: invokestatic 54	apbo:a	(ILjava/lang/String;)V
    //   31: iconst_0
    //   32: ifeq +11 -> 43
    ...
    //   134: aload_0
    //   135: getfield 29	apbo:jdField_a_of_type_Boolean	Z
    //   138: ifne +62 -> 200
    //   141: aload 5
    //   143: aload 7
    //   145: iconst_0
  ...
  private void a(List<String> paramList, apbn paramapbn)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          this.jdField_b_of_type_Long += apdh.a(str1);
        }
    ...
    if (str2.contains("/.tmp/")) {
      localObject = b(str1) + apck.a(str2);
    }
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          ThreadManager.post(new FMSettings.4(this, str2, (File)localObject, j, paramapbn), 8, null, false);
          i += 1;
        }
      ...
      if (str2.contains("/.thumbnails/")) {
        localObject = c(str1) + apck.a(str2);
      } else {
        localObject = a(str1) + apck.a(str2);
      }
    }
  }
  ...
  private apbu b()
  {
    return (apbu)this.jdField_a_of_type_JavaUtilMap.get("sdCard");
  }
  ...
  private apbu c()
  {
    ...
    return (apbu)this.jdField_a_of_type_JavaUtilMap.get("externalSdCard");
  }
  ...
  private void c()
  {
    ...
    ThreadManager.post(new FMSettings.1(this, b(localapbu.jdField_b_of_type_JavaLangString + localapbu.c)), 8, null, false);
  }
  ...
  private apbu d()
  {
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      localObject2 = (apbu)this.jdField_a_of_type_JavaUtilMap.get(localObject2);
      ((apbu)localObject2).a();
      if (((apbu)localObject2).jdField_a_of_type_Boolean)
      {
        a(2, "getDefaultStorage[" + ((apbu)localObject2).jdField_b_of_type_JavaLangString + "] + ext[" + ((apbu)localObject2).c + "]");
        return localObject2;
      }
    }
    a(2, "getDefaultStorage nothing is default refresh!");
    Object localObject2 = (apbu)this.jdField_a_of_type_JavaUtilMap.get("sdCard");
    localObject1 = localObject2;
    if (localObject2 == null)
    {
      localObject1 = new apbu(this, null);
      ((apbu)localObject1).jdField_a_of_type_Boolean = true;
      ((apbu)localObject1).jdField_a_of_type_JavaLangString = "SD卡";
      ((apbu)localObject1).jdField_b_of_type_JavaLangString = Environment.getExternalStorageDirectory().getPath();
      ((apbu)localObject1).c = "";
    }
    ((apbu)localObject1).a(BaseApplicationImpl.getContext());
    return localObject1;
  }
  ...
  public apbu a()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      localObject = (apbu)this.jdField_a_of_type_JavaUtilMap.get(localObject);
      if (localapbu != localObject) {
        return localObject;
      }
    }
  ...
  public String a()
  {
    ...
    return a(localapbu.jdField_b_of_type_JavaLangString + localapbu.c);
  }
  ...
  public void a()
  {
    ...
    Map localMap = apck.a(localBaseApplication);
    a(1, "qurey strorages[" + localMap.size() + "]");
    String str1 = localBaseApplication.getSharedPreferences("FMSETTING_59", 4).getString("DefaultRootPath", ajed.aT);
    ...
    if (localIterator.hasNext())
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          localapbu = new apbu(this, null);
          localapbu.jdField_a_of_type_Boolean = false;
          if (!str2.equalsIgnoreCase("sdCard")) {
            break label402;
          }
          localapbu.jdField_a_of_type_JavaLangString = "SD卡";
          localapbu.jdField_b_of_type_JavaLangString = ((String)localObject);
          localapbu.c = "";
          a(1, "rootPath[" + localapbu.jdField_b_of_type_JavaLangString + "],bDefault[" + localapbu.jdField_a_of_type_Boolean + "]");
          localObject = new StatFs((String)localObject);
          localapbu.jdField_a_of_type_Long = (((StatFs)localObject).getAvailableBlocks() * ((StatFs)localObject).getBlockSize());
          a(4, "defaultRootPath[" + str1 + "].equalsIgnoreCase(si.rootPath[" + localapbu.jdField_b_of_type_JavaLangString + "])");
          if ((localMap.size() == 1) || (str1.equalsIgnoreCase(localapbu.jdField_b_of_type_JavaLangString)))
          {
            a(4, "defaultRootPath.equalsIgnoreCase(si.rootPath) = true");
            localapbu.jdField_a_of_type_Boolean = true;
            localapbu.a(localBaseApplication);
          }
          localapbu.a();
          this.jdField_a_of_type_JavaUtilMap.put(str2, localapbu);
        }
        catch (Exception localException)
        {
          localException.printStackTrace();
        ...
        {
          localapbu.jdField_a_of_type_JavaLangString = "外置SD卡";
          localBaseApplication.getExternalFilesDir(null);
          String str3 = BaseApplicationImpl.sApplication.getPackageName();
          localapbu.jdField_b_of_type_JavaLangString = ((String)localObject);
          localapbu.c = ("/Android/data/" + str3 + "/");
        }
      }
    }
  }
  
  public void a(long paramLong, List<String> arg3, Activity paramActivity, apbn paramapbn)
  {
    ...
    for (;;)
    {
      ...
      a(1, "showChoosePath, callback[" + paramapbn + "]");
      ??? = b();
      apbu localapbu = c();
      if (((apbu)???).jdField_a_of_type_Boolean) {
        this.jdField_a_of_type_JavaLangString = ajjy.a(2131638875);
      }
      ...
      {
        label216:
        paramActivity.runOnUiThread(new FMSettings.5(this, paramActivity, ???, paramapbn));
        return;
        if ((localapbu == null) || (!localapbu.jdField_a_of_type_Boolean)) {
          break label216;
        }
        this.jdField_a_of_type_JavaLangString = ajjy.a(2131638871);
      }
    }
  }
  ...
  public void a(String paramString)
  {
    try
    {
      if (this.jdField_a_of_type_JavaUtilMap != null)
      {
        ...
        {
          ((apbu)this.jdField_a_of_type_JavaUtilMap.get("sdCard")).a(BaseApplicationImpl.getContext());
          return;
        }
      }
    }
  ...
  public long b()
  {
    ...
    localObject = ((apbu)localObject).jdField_b_of_type_JavaLangString;
    try
    {
      localObject = new StatFs((String)localObject);
      long l = ((StatFs)localObject).getAvailableBlocks();
  ...
  public void b()
  {
    ...
    {
      a(1, "FMSettings free");
      Field localField = this.jdField_a_of_type_Bafb.getClass().getSuperclass().getDeclaredField("mShowing");
      localField.setAccessible(true);
      localField.set(this.jdField_a_of_type_Bafb, Boolean.valueOf(true));
