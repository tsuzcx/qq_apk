...
public class ulj
{
  ...
  static
  {
    jdField_a_of_type_ArrayOfJavaLangString = skt.a(2130903123);
  }
  ...
  public String a(int paramInt, TextPaint paramTextPaint)
  {
    ...
    do
    {
      ...
      do
      {
        return str;
        if (j == 0) {
          return skt.a(2131633900);
        }
        localStringBuilder.append(vms.a(j)).append("个小视频");
        if (j > 0) {
        ...
        localStringBuilder.append(skt.a(2131633914, new Object[] { Integer.valueOf(this.g) }));
        return localStringBuilder.toString();
        if (this.jdField_a_of_type_Boolean)
        {
          localStringBuilder.append(vms.a(j)).append("个小视频");
          ...
          if (this.jdField_d_of_type_Int > 0) {
            localStringBuilder.append(jdField_a_of_type_ArrayOfJavaLangString[1]).append("赞").append(vms.a(this.jdField_d_of_type_Int));
          }
          if (this.e <= 0) {
            break;
          }
          localStringBuilder.append(jdField_a_of_type_ArrayOfJavaLangString[1]).append("评论").append(vms.a(this.e));
          break;
        }
        localStringBuilder.append(vms.a(this.f)).append("个小视频发送失败");
        break;
        long l1 = l2;
        int k = i1;
        i = n;
        if (this.jdField_a_of_type_JavaUtilArrayList.size() > 0)
        {
          ...
          i = n;
          j = m;
          if (this.jdField_a_of_type_Srj != null)
          {
            i = this.jdField_a_of_type_Srj.b;
            k = this.jdField_a_of_type_Srj.jdField_a_of_type_Int;
            l1 = this.jdField_a_of_type_Srj.c;
            j = m;
          }
        }
        localStringBuilder.append(vms.a(j)).append("个小视频");
        ...
        str = localStringBuilder.toString();
        if (k > 0) {
          localStringBuilder.append(jdField_a_of_type_ArrayOfJavaLangString[1]).append("赞").append(vms.a(k));
        }
      } while ((paramTextPaint != null) && (paramTextPaint.measureText(localStringBuilder.toString()) > paramInt));
      str = localStringBuilder.toString();
      if (i > 0) {
        localStringBuilder.append(jdField_a_of_type_ArrayOfJavaLangString[1]).append("评论").append(vms.a(i));
      }
    } while ((paramTextPaint == null) || (paramTextPaint.measureText(localStringBuilder.toString()) <= paramInt));
    return str;
  }
  ...
  public void a()
  {
    ...
    do
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        int i = ulr.a(localStoryVideoItem.mUploadStatus);
        if ((i == 1) || (i == 0))
        {
  ...
  public void c(StoryVideoItem paramStoryVideoItem)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          if ((this.jdField_a_of_type_JavaUtilArrayList.size() != 0) || (this.jdField_a_of_type_Srj == null)) {
            break;
          }
          this.jdField_a_of_type_Srj.b = 0;
          this.jdField_a_of_type_Srj.jdField_a_of_type_Int = 0;
          this.jdField_a_of_type_Srj.c = 0;
          paramStoryVideoItem = (spz)sqg.a(10);
