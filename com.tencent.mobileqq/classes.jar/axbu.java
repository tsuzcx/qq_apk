...
public class axbu
{
  ...
  static
  {
    jdField_a_of_type_ArrayOfJavaLangString = new String[] { anni.a(2131706187), "18-22岁", "23-26岁", "27-35岁", "35岁以上" };
    jdField_b_of_type_ArrayOfJavaLangString = new String[] { anni.a(2131706195), anni.a(2131706182), anni.a(2131706191), anni.a(2131706193), anni.a(2131706198), anni.a(2131706184), anni.a(2131706202), anni.a(2131706186) };
    jdField_c_of_type_ArrayOfJavaLangString = new String[] { anni.a(2131706199), anni.a(2131706204), anni.a(2131706201), anni.a(2131706188), anni.a(2131706189), anni.a(2131706194), anni.a(2131706203), anni.a(2131706192), anni.a(2131706185), anni.a(2131706190), anni.a(2131706200), anni.a(2131706183), anni.a(2131706197) };
    jdField_a_of_type_ArrayOfInt = new int[] { 0, 2130845567, 2130845563, 2130845562, 2130845568, 2130845565, 2130845566, 2130845564 };
  ...
  public static axbu a(String paramString)
  {
    return a(paramString, "nearpeople_filters");
  }
  
  public static axbu a(String paramString1, String paramString2)
  {
  ...
  public static void a(String paramString, axbu paramaxbu)
  {
    a(paramString, paramaxbu, "nearpeople_filters");
  }
  
  public static void a(String paramString1, axbu paramaxbu, String paramString2)
  {
    if ((paramaxbu == null) || (TextUtils.isEmpty(paramString1))) {}
    do
    {
      return;
      paramString1 = BaseApplicationImpl.getApplication().getSharedPreferences(paramString2 + paramString1, 4);
    } while (paramString1 == null);
    paramString1.edit().putBoolean("byuser", paramaxbu.jdField_a_of_type_Boolean).putInt("gender", paramaxbu.jdField_a_of_type_Int).putInt("time", paramaxbu.jdField_b_of_type_Int).putInt("age", paramaxbu.jdField_c_of_type_Int).putInt("xingzuo", paramaxbu.e).putInt("key_career", paramaxbu.f).putString("key_hometown_country", paramaxbu.jdField_d_of_type_ArrayOfJavaLangString[0]).putString("key_hometown_province", paramaxbu.jdField_d_of_type_ArrayOfJavaLangString[1]).putString("key_hometown_city", paramaxbu.jdField_d_of_type_ArrayOfJavaLangString[2]).putString("key_hometown_string", paramaxbu.jdField_a_of_type_JavaLangString).putString("str_country", paramaxbu.jdField_b_of_type_JavaLangString).putString("str_province", paramaxbu.jdField_c_of_type_JavaLangString).putString("str_city", paramaxbu.jdField_d_of_type_JavaLangString).putInt("interest", paramaxbu.jdField_d_of_type_Int).commit();
  }
  ...
  public boolean equals(Object paramObject)
  {
    int i = 0;
    boolean bool1;
    if ((paramObject == null) || (!(paramObject instanceof axbu)))
    {
      bool1 = false;
      return bool1;
    }
  ...
  public String toString()
  {
    ...
    default: 
      ...
      if ((this.f != 0) && (this.f < bght.e.length))
      {
        String str2 = bght.e[this.f];
        str1 = str2;
        if (TextUtils.isEmpty(str2)) {
          str1 = anni.a(2131706196);
        }
