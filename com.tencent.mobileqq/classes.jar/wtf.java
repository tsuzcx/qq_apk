  ...
  implements wsp
{
  ...
  public List<PromoteTaskEntry> a(String paramString, int paramInt)
  {
    ...
    {
      yuk.a("StoryPromoteTaskManager", "findPromoteTaskListByFeedIdInner(%s, %d) return null", paramString, Integer.valueOf(paramInt));
  ...
  {
    yuk.a("StoryPromoteTaskManager", "findPromoteTaskListByFeedIds(%s, %d)", paramList, Integer.valueOf(paramInt));
    a();
  ...
  public void a()
  {
    ...
    this.jdField_b_of_type_JavaLangString = ((String)((wta)wth.a(10)).b("key_story_player_promote_url", this.jdField_b_of_type_JavaLangString));
    yuk.a("StoryPromoteTaskManager", "onInit() mUrl = %s", this.jdField_b_of_type_JavaLangString);
    ...
    for (;;)
    {
      ...
      if ((a()) && (localObject1 != null))
      {
        ...
        yuk.a("StoryPromoteTaskManager", "onInit() update memory count from DB; %s", this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap);
      }
      return;
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      yuk.a("StoryPromoteTaskManager", "refreshPromoteTask, time not expire now: %s(%d), expire: %s(%d), won't request!", zof.a(l), Long.valueOf(l), zof.a(this.jdField_a_of_type_Long), Long.valueOf(this.jdField_a_of_type_Long));
      return;
    }
    yuk.a("StoryPromoteTaskManager", "refreshPromoteTask(clear=%b), time expire, will request new list, now: %d, expire: %d", Boolean.valueOf(paramBoolean), Long.valueOf(l), Long.valueOf(this.jdField_a_of_type_Long));
    if (paramBoolean) {
      this.jdField_a_of_type_JavaLangString = "";
    }
    xea localxea = new xea(this.jdField_a_of_type_JavaLangString);
    wow.a().a(localxea, new wtg(this));
  }
  ...
  public boolean a()
  {
    ...
    String str = zof.a();
    if (TextUtils.equals((String)((wta)localObject).b("key_story_promote_task_date", ""), str))
    {
      yuk.a("StoryPromoteTaskManager", "ensureCountValidate() date is %s, keep last promoteCount", str);
      return true;
    }
    yuk.a("StoryPromoteTaskManager", "ensureCountValidate() date is %s new date, so mTaskIdCounts should be empty, taskIdCounts=%s", str, this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap);
    ((wta)localObject).b("key_story_promote_task_date", str);
    ...
    yuk.a("StoryPromoteTaskManager", "ensureCountValidate() exec sql: taskEntry updated sql=%s", localObject);
  ...
  {
    yuk.a("StoryPromoteTaskManager", "markTaskIdPromoted(%s)", Long.valueOf(paramLong));
  ...
  public boolean a(PromoteTaskEntry paramPromoteTaskEntry)
  {
    ...
    for (;;)
    {
      ...
      yuk.a("StoryPromoteTaskManager", "updateEntry %s, return %b", paramPromoteTaskEntry, Boolean.valueOf(bool));
      return bool;
      bool = false;
      continue;
      ...
      {
        yuk.e("StoryPromoteTaskManager", "updateEntry error: entry status unknown: %d", new Object[] { Integer.valueOf(paramPromoteTaskEntry.getStatus()) });
        bool = false;
      }
    }
  }
  ...
  public boolean a(qqstory_service.RspGetPromoteTaskList paramRspGetPromoteTaskList)
  {
    ...
    {
      Object localObject = wun.a((qqstory_service.PromoteTask)paramRspGetPromoteTaskList.get(i));
      Long localLong = (Long)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(((wun)localObject).jdField_a_of_type_Long));
      if (localLong != null) {}
      for (((wun)localObject).e = localLong.longValue();; ((wun)localObject).e = 0L)
      {
        localArrayList.remove(Long.valueOf(((wun)localObject).jdField_a_of_type_Long));
        localObject = ((wun)localObject).a();
        a((PromoteTaskEntry)localObject);
        yuk.a("StoryPromoteTaskManager", "overwriteEntries() [%d] taskEntry updated %s", Integer.valueOf(i), localObject);
        i += 1;
        break;
      }
    }
    ...
    {
      yuk.b("StoryPromoteTaskManager", "overwriteEntries() taskIds not empty, will delete it");
      a(localArrayList);
    }
    return true;
  }
  ...
  {
    yuk.a("StoryPromoteTaskManager", "deleteListOfTasks(%s)", paramList);
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      ...
      yuk.a("StoryPromoteTaskManager", "deleteListOfTasks() exec sql: taskEntry updated %s", paramList);
  ...
  {
    yuk.a("StoryPromoteTaskManager", "findPromoteTaskByUnionId(%s, %d)", paramString, Integer.valueOf(paramInt));
    a();
    ...
    yuk.a("StoryPromoteTaskManager", "findPromoteTaskListByUnionId(%s, %d) return null", paramString, Integer.valueOf(paramInt));
    return Collections.emptyList();
  }
  ...
  {
    yuk.a("StoryPromoteTaskManager", "markEntryPromoted(%s)", paramPromoteTaskEntry);
    if (paramPromoteTaskEntry == null)
    {
      yuk.b("StoryPromoteTaskManager", "markEntryPromoted entry is null!");
      return false;
    }
    if (paramPromoteTaskEntry.promoteCount >= paramPromoteTaskEntry.limitPromoteCount)
    {
      yuk.e("StoryPromoteTaskManager", "Error: entry.promoteCount >= entry.limitPromoteCount");
      return false;
    }
  ...
  public void c()
  {
    ((wta)wth.a(10)).b("key_story_promote_task_date", "");
  }
}
