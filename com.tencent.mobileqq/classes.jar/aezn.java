  ...
  implements FaceDecoder.DecodeTaskCompletionListener
{
  ...
  private static ahos jdField_a_of_type_Ahos = new ahoq();
  private static SparseArrayCompat<ahos> jdField_a_of_type_AndroidSupportV4UtilSparseArrayCompat;
  ...
  public aezn(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner, BaseChatPie paramBaseChatPie)
  {
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_a_of_type_JavaLangBoolean = Boolean.valueOf(true);
    this.jdField_a_of_type_AndroidSupportV4UtilArraySet = new ArraySet();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Agcw = new agcw(paramContext, paramQQAppInterface, paramSessionInfo, paramAIOAnimationConatiner, paramBaseChatPie);
    ...
    for (long l = NetConnInfoCenter.getServerTime();; l = paramBaseChatPie.getCreateTime())
    {
      ...
      this.jdField_a_of_type_Akxz = new akxz(this, paramQQAppInterface);
      this.jdField_a_of_type_Akyb = new akyb(paramBaseChatPie);
      this.jdField_a_of_type_Aezo = new aezo(this);
      return;
    }
  }
  ...
  static ChatMessage a(List<ChatMessage> paramList, ArraySet<Long> paramArraySet, long paramLong)
  {
    ...
    if (i < paramList.size())
    {
      ...
      label86:
      Object localObject2;
      if ((bblk.b(localChatMessage.msgtype)) && (localChatMessage.needShowTimeStamp()))
      {
        j = 1;
  ...
  protected static void a(MessageForStructing paramMessageForStructing, aezf paramaezf, View paramView, boolean paramBoolean)
  {
    if ((paramMessageForStructing == null) || (paramMessageForStructing.structingMsg == null)) {
      return;
    }
    e();
    ahos localahos2 = (ahos)jdField_a_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramMessageForStructing.structingMsg.mMsgServiceID);
    ahos localahos1 = localahos2;
    if (localahos2 == null) {
      localahos1 = jdField_a_of_type_Ahos;
    }
    localahos1.a(paramMessageForStructing, paramaezf, paramView, paramBoolean);
  }
    ...
    for (paramChatMessage1 = ((MessageForMarketFace)paramChatMessage1).mMarkFaceMessage;; paramChatMessage1 = (ChatMessage)localObject)
    {
      ...
      if (paramChatMessage1 != null)
      {
        ...
        if (localObject != null)
        {
          ...
          {
            bool1 = bool2;
            if (aqyy.a(paramChatMessage1.sbufID, paramChatMessage1.mediaType).equals(aqyy.a(((MarkFaceMessage)localObject).sbufID, ((MarkFaceMessage)localObject).mediaType)))
            {
              bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", "Ep_show_follow", 0, 0, "", paramChatMessage1.dwTabID + "", "", "");
              bool1 = true;
            }
          }
        }
  ...
  {
    this.jdField_a_of_type_Agcw.a(paramChatMessage, this).a(paramView, paramChatMessage, paramInt);
  }
  ...
  public void a(ChatMessage paramChatMessage, int paramInt)
  {
    ...
    if (i >= 0)
    {
      ...
      localChatMessage = (ChatMessage)localView.getTag(2131364454);
  ...
  public void a(List<ChatMessage> paramList)
  {
    ...
    if (paramList.size() > 0)
    {
      ...
      for (;;)
      {
        if ((bblk.a(localChatMessage1.msgtype)) || (abwz.j(localChatMessage1.msgtype)))
        {
          i += 1;
          ...
          else
          {
            ...
            if (paramList.size() - k >= 0)
            {
              ...
              {
                if (!bblk.a(localChatMessage3.msgtype))
                {
                  localChatMessage2 = localChatMessage3;
                  localChatMessage4 = localChatMessage1;
                  i = j;
                  if (!abwz.j(localChatMessage3.msgtype)) {
                    break label216;
                  }
                }
                k += 1;
  ...
  public void a(List<ChatMessage> paramList, CharSequence paramCharSequence, int paramInt)
  {
    ...
    paramCharSequence = (amsw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType == 3000) || (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType == 1) || ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType == 0) && (paramCharSequence != null) && (paramCharSequence.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin)))) {
      ((aqwg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(214)).a(paramList, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie, paramInt);
    }
  ...
  public void c()
  {
    ...
    if (this.jdField_a_of_type_Agcw != null) {
      this.jdField_a_of_type_Agcw.a();
    }
    ...
    this.jdField_a_of_type_Akyb.c();
  }
  
  public void d()
  {
    if (this.jdField_a_of_type_Aezo.a != null)
    {
      akym localakym = this.jdField_a_of_type_Aezo.a.a();
      if ((localakym == null) || (!localakym.c())) {
        break label41;
      }
      localakym.d();
    }
    label41:
    while (!this.jdField_a_of_type_Aezo.a.a()) {
      return;
    }
    this.jdField_a_of_type_Aezo.a.a();
  }
  ...
  public int getItemViewType(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      return agcw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localChatMessage);
    }
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      bfzg.a(null, "AIO_ChatAdapter_getView" + " | " + localChatMessage.getClass().getName());
      Object localObject2 = this.jdField_a_of_type_Agcw.a(localChatMessage, this);
      if (paramInt != 0)
      {
      ...
      localObject1 = ((aezx)localObject2).a(paramInt, this.jdField_a_of_type_JavaUtilList.size(), localChatMessage, paramView, paramViewGroup, this.jdField_a_of_type_Aezo);
      if (localObject1 != null)
      {
        ((View)localObject1).setTag(2131364454, localChatMessage);
        if (((localObject2 instanceof aexf)) && ((localObject1 instanceof ajip))) {
          localObject2 = (ajip)localObject1;
        }
      }
      bfzg.a("AIO_ChatAdapter_getView" + " | " + localChatMessage.getClass().getName(), null);
    }
  }
