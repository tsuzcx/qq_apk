  ...
  extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
  ...
  private aitr jdField_a_of_type_Aitr = new aito(this);
  ...
  private arao jdField_a_of_type_Arao;
  ...
  public aitl(QQAppInterface paramQQAppInterface, EmoticonGroupStoreFragment paramEmoticonGroupStoreFragment, int paramInt, View paramView, ViewPager paramViewPager, Button paramButton)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131363853));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368523));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379976));
    ...
    this.jdField_a_of_type_AndroidSupportV4ViewViewPager.setOnPageChangeListener(new aitm(this));
    this.jdField_b_of_type_AndroidWidgetButton = paramButton;
    this.jdField_a_of_type_Arao = ((arao)paramQQAppInterface.getManager(259));
    this.jdField_a_of_type_Araq = ((bgga)paramQQAppInterface.getManager(235)).jdField_a_of_type_Araq;
    this.jdField_a_of_type_Araq.a();
  }
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    while (this.jdField_a_of_type_ComTencentMobileqqActivityEmogroupstoreEmoticonGroupStoreFragment.a.size() > 0)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetButton.setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130844306));
      this.jdField_b_of_type_AndroidWidgetButton.setEnabled(true);
      return;
      label234:
      paramInt1 = this.jdField_a_of_type_ComTencentMobileqqActivityEmogroupstoreEmoticonGroupStoreFragment.a.size();
      if (this.jdField_a_of_type_Arao.jdField_b_of_type_Int <= paramInt1)
      {
        if (300 == aray.jdField_a_of_type_Int)
        {
          QQToast.a(this.jdField_a_of_type_AndroidContentContext, 2131689609, 0).b(2131299076);
        }
        else if (144 == aray.jdField_a_of_type_Int)
        {
          localObject = new aitn(this);
          localObject = bfur.a(this.jdField_a_of_type_AndroidContentContext, 0, amtj.a(2131707270), this.jdField_a_of_type_AndroidContentContext.getString(2131689608), amtj.a(2131707271), amtj.a(2131707273), (DialogInterface.OnClickListener)localObject, (DialogInterface.OnClickListener)localObject);
          if (localObject != null) {
      ...
      {
        QQToast.a(this.jdField_a_of_type_AndroidContentContext, "单次最多收藏20个表情哦~", 0).b(2131299076);
      }
    }
    this.jdField_b_of_type_AndroidWidgetButton.setTextColor(Color.parseColor("#FFBFBFBF"));
    this.jdField_b_of_type_AndroidWidgetButton.setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130844307));
  ...
  private void a(EmoticonFromGroupEntity paramEmoticonFromGroupEntity)
  {
    ...
    {
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFaceBitmap(4, paramEmoticonFromGroupEntity.troopUin, (byte)2, false, (byte)1, 0);
      paramEmoticonFromGroupEntity = ContactUtils.getTroopName(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramEmoticonFromGroupEntity.troopUin, true);
    }
    for (;;)
    {
      ...
      {
        localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFaceBitmap(101, paramEmoticonFromGroupEntity.troopUin, (byte)3, false, (byte)1, 0);
        paramEmoticonFromGroupEntity = ContactUtils.getDiscussionName(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, paramEmoticonFromGroupEntity.troopUin);
      }
      else
      {
  ...
  private void a(EmoticonFromGroupEntity paramEmoticonFromGroupEntity, int paramInt1, int paramInt2)
  {
    ...
    if (-1 != paramEmoticonFromGroupEntity.status)
    {
      ...
      {
        this.jdField_a_of_type_AndroidWidgetButton.setText(amtj.a(2131707268));
        this.jdField_a_of_type_AndroidWidgetButton.setTextColor(Color.parseColor("#FFBBBBBB"));
        this.jdField_a_of_type_AndroidWidgetButton.setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130844307));
    ...
    for (;;)
    {
      j += 1;
      break label138;
      this.jdField_a_of_type_AndroidWidgetButton.setText(amtj.a(2131707269));
      this.jdField_a_of_type_AndroidWidgetButton.setTextColor(Color.parseColor("#FFFFFFFF"));
      this.jdField_a_of_type_AndroidWidgetButton.setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130844306));
  ...
  private void b(EmoticonFromGroupEntity paramEmoticonFromGroupEntity)
  {
    if (paramEmoticonFromGroupEntity.status == 0)
    {
      this.jdField_a_of_type_AndroidWidgetButton.setText(amtj.a(2131707274));
      this.jdField_a_of_type_AndroidWidgetButton.setTextColor(Color.parseColor("#FFBBBBBB"));
      this.jdField_a_of_type_AndroidWidgetButton.setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130844307));
      this.jdField_a_of_type_AndroidWidgetButton.setEnabled(false);
      return;
    }
    this.jdField_a_of_type_AndroidWidgetButton.setText(amtj.a(2131707272));
    this.jdField_a_of_type_AndroidWidgetButton.setTextColor(Color.parseColor("#FFFFFFFF"));
    this.jdField_a_of_type_AndroidWidgetButton.setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130844306));
    this.jdField_a_of_type_AndroidWidgetButton.setEnabled(true);
  }
  ...
  public void a(Map<String, List<EmoticonFromGroupEntity>> paramMap, List<EmoticonFromGroupEntity> paramList)
  {
    ...
    while (paramMap.hasNext())
    {
      ...
      String str = (String)((Map.Entry)localObject).getKey();
      localObject = (List)((Map.Entry)localObject).getValue();
      this.jdField_b_of_type_JavaUtilMap.put(str, this.jdField_a_of_type_Araq.a(str, ((List)localObject).size(), "  "));
    }
    notifyDataSetChanged();
  ...
  {
    if ((paramViewHolder instanceof aits))
    {
      aits localaits = (aits)paramViewHolder;
      List localList = (List)this.e.get(Integer.valueOf(paramInt));
      int j = localList.size();
      int i = 0;
      if (i < 3)
      {
        RelativeLayout localRelativeLayout = (RelativeLayout)localaits.jdField_a_of_type_ArrayOfAndroidWidgetImageView[i].getParent();
        if (i < j)
        {
          localRelativeLayout.setVisibility(0);
          localaits.jdField_a_of_type_ArrayOfAndroidWidgetImageView[i].setImageDrawable(this.jdField_a_of_type_Araq.a((EmoticonFromGroupEntity)localList.get(i), 65537, this.jdField_a_of_type_Int, null));
          this.jdField_b_of_type_Int = ((EmoticonFromGroupEntity)((List)this.e.get(Integer.valueOf(paramInt))).get(i)).status;
          if (this.jdField_b_of_type_Int == 0)
          {
            ((aits)paramViewHolder).jdField_a_of_type_ArrayOfComTencentMobileqqWidgetNumberCheckBox[i].setVisibility(4);
            ((aits)paramViewHolder).b[i].setVisibility(0);
        ...
        for (;;)
        {
          ...
          {
            ((aits)paramViewHolder).b[i].setVisibility(4);
            if (this.jdField_b_of_type_Int > 0)
            {
              ((aits)paramViewHolder).jdField_a_of_type_ArrayOfComTencentMobileqqWidgetNumberCheckBox[i].setVisibility(0);
              ((aits)paramViewHolder).jdField_a_of_type_ArrayOfComTencentMobileqqWidgetNumberCheckBox[i].setCheckedNumber(this.jdField_b_of_type_Int);
            }
            else
            {
              ((aits)paramViewHolder).jdField_a_of_type_ArrayOfComTencentMobileqqWidgetNumberCheckBox[i].setChecked(false);
              ((aits)paramViewHolder).jdField_a_of_type_ArrayOfComTencentMobileqqWidgetNumberCheckBox[i].setVisibility(0);
            }
          }
          else
    ...
    for (;;)
    {
      ...
      return;
      if ((paramViewHolder instanceof aitp)) {
        ((aitp)paramViewHolder).jdField_a_of_type_AndroidWidgetTextView.setText((CharSequence)this.jdField_b_of_type_JavaUtilMap.get(this.d.get(Integer.valueOf(paramInt))));
      } else if ((paramViewHolder instanceof aitq)) {
        ((aitq)paramViewHolder).jdField_a_of_type_AndroidWidgetTextView.setText("仅保留最新的300个聊天表情，\n更多表情请在消息记录中查找哦～");
      }
    }
  }
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    default: 
      return null;
    case 0: 
      return new aitp(this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561860, paramViewGroup, false));
    case 1: 
      paramViewGroup = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561861, paramViewGroup, false);
      ...
      paramViewGroup = new aits(paramViewGroup);
      paramViewGroup.a(this.jdField_a_of_type_Aitr);
      return paramViewGroup;
    }
    return new aitq(this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561864, paramViewGroup, false));
  }
}
