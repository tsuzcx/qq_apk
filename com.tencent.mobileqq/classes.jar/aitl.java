...
public class aitl
  implements ajfn, Manager
{
  int jdField_a_of_type_Int = 0;
  aitp jdField_a_of_type_Aitp;
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new aitm(this);
  ...
  Comparator<ApolloActionData> jdField_a_of_type_JavaUtilComparator = new aitn(this);
  
  public aitl(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentWidgetListView != null)
    {
      ...
      this.jdField_a_of_type_Aitp = null;
    }
  ...
  public void a(BaseChatPie paramBaseChatPie, ApolloActionData paramApolloActionData, int paramInt, String paramString)
  {
    ...
    if (airx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
      if (airx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c()) == 1) {
    ...
    for (;;)
    {
      ...
      paramBaseChatPie = (RelativeLayout)paramBaseChatPie.a().findViewById(2131364075);
      int i;
      if (this.jdField_a_of_type_ComTencentWidgetListView == null)
      {
        ...
        this.jdField_a_of_type_ComTencentWidgetListView.setSelector(localBaseActivity.getResources().getDrawable(2130849558));
        this.jdField_a_of_type_ComTencentWidgetListView.setCacheColorHint(2131165414);
        ...
        i = actj.a(9.0F, localBaseActivity.getResources());
        this.jdField_a_of_type_AndroidWidgetTextView.setPadding(0, 0, 0, i);
        this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(localBaseActivity.getResources().getColor(2131166861));
        ...
        this.jdField_a_of_type_Aitp = new aitp(this, localBaseActivity);
        this.jdField_a_of_type_ComTencentWidgetListView.setAdapter(this.jdField_a_of_type_Aitp);
        localObject = new RelativeLayout.LayoutParams(actj.a(99.0F, localBaseActivity.getResources()), -2);
        ((RelativeLayout.LayoutParams)localObject).addRule(11);
        ((RelativeLayout.LayoutParams)localObject).addRule(2, 2131368187);
        ((RelativeLayout.LayoutParams)localObject).rightMargin = actj.a(10.0F, localBaseActivity.getResources());
      ...
      try
      {
        for (;;)
        {
          ...
          if (paramBaseChatPie.getBoolean("first_show_resp", true))
          {
            ...
            this.jdField_a_of_type_AndroidWidgetTextView.setText(ajya.a(2131700517));
            this.jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130838262, 0);
          }
          else
          {
            this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
            continue;
            paramBaseChatPie = bbcz.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, true);
            paramBaseChatPie = String.format(ajya.a(2131700519), new Object[] { paramBaseChatPie });
        ...
        this.jdField_a_of_type_Aitp.a(paramBaseChatPie, paramInt);
        return;
      }
  ...
  public void a(SpriteTaskParam paramSpriteTaskParam, long paramLong)
  {
    ...
    do
    {
      do
      {
        ...
        localApolloActionData = ((ajmu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155)).b(i);
