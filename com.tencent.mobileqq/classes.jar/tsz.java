  ...
  extends ViewBase
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new tta(this, Looper.getMainLooper());
  ...
  public tsz(VafContext paramVafContext)
  {
  ...
  {
    this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)paramContext.getSystemService("layout_inflater")).inflate(2131560040, null);
  ...
  private void b()
  {
    ...
    {
      return;
      localBitmap = bhld.a(String.valueOf(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdAid));
  ...
  public void a(NativeReadInjoyImageView paramNativeReadInjoyImageView, String paramString, Drawable paramDrawable)
  {
    ...
    if (bhld.a(paramNativeReadInjoyImageView) == null)
    {
