...
public class pbl
{
  ...
  public static long a(ArticleInfo paramArticleInfo)
  {
    ...
    if ((pgb.i(paramArticleInfo)) || (pgb.n(paramArticleInfo)) || (pgb.j(paramArticleInfo))) {
      return b(paramArticleInfo);
    }
    if ((pay.i(paramArticleInfo)) && ((paramArticleInfo.mPolymericInfo.jdField_a_of_type_Int == 7) || (paramArticleInfo.mPolymericInfo.jdField_a_of_type_Int == 8))) {
      ...
      if (paramArticleInfo.mTopicRecommendFeedsInfo.a != null)
      {
        ...
        if (paramArticleInfo.mTopicRecommendFeedsInfo.a.size() > 0)
        {
          ...
          if (paramArticleInfo.mTopicRecommendFeedsInfo.a.get(0) != null) {
            l1 = ((rgc)paramArticleInfo.mTopicRecommendFeedsInfo.a.get(0)).jdField_a_of_type_Int;
          }
        }
      }
    }
  ...
  pbl E(String paramString)
  {
    this.a.put("is_column", paramString);
    return this;
  }
  
  public pbl F(int paramInt)
  {
    if (paramInt != 41695) {}
    Object localObject;
    do
  ...
  pbl F(String paramString)
  {
    this.a.put("gamelist", paramString);
    return this;
  }
  
  public pbl G(int paramInt)
  {
    if (pcl.c(paramInt)) {
      r(bkwm.h());
    }
  ...
  public pbl I(int paramInt)
  {
    ...
    label27:
    for (String str = uhv.jdField_a_of_type_JavaLangString;; str = ozh.jdField_a_of_type_JavaLangString)
    {
      f(str);
      return this;
    }
  ...
  {
    int j = 1;
    if ((paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rep != null) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rep.jdField_a_of_type_JavaUtilList != null))
    {
      if (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rep.jdField_a_of_type_JavaUtilList.size() > 1) {
        i = 2;
      }
      do
      {
        do
        {
          return i;
          i = j;
        } while (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rep.jdField_a_of_type_JavaUtilList.size() == 1);
        i = j;
  ...
  {
    Object localObject = qks.a(paramLong);
  ...
  pbl a(int paramInt1, int paramInt2)
  {
  ...
  pbl a(int paramInt1, int paramInt2, int paramInt3)
  {
  ...
  pbl a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
  ...
  public pbl a(int paramInt, ArticleInfo paramArticleInfo)
  {
  ...
  pbl a(long paramLong)
  {
    this.a.put("algorithm_id", paramLong);
    return this;
  }
  
  public pbl a(long paramLong, String paramString, ArticleInfo paramArticleInfo)
  {
    if ((paramArticleInfo != null) && (paramArticleInfo.mFeedType == 26))
    {
      o(paramArticleInfo.mSubscribeID);
      c(paramLong);
      if ((paramArticleInfo.mSocialFeedInfo != null) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfn != null) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfn.a != null)) {
        k(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfn.a.jdField_a_of_type_Int);
      }
      p(paramString);
      if ((paramArticleInfo.mSocialFeedInfo != null) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfn != null) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfn.a != null) && (!TextUtils.isEmpty(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfn.a.jdField_a_of_type_JavaLangString))) {
        g(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfn.a.jdField_a_of_type_JavaLangString);
      }
    }
    return this;
  }
  
  pbl a(JsonArray paramJsonArray)
  {
    this.a.put("all_rowkey", paramJsonArray);
    return this;
  }
  
  public pbl a(ArticleInfo paramArticleInfo)
  {
    if ((paramArticleInfo.mFeedType == 38) || (paramArticleInfo.mFeedType == 39))
    {
      ...
      a(twr.a(paramArticleInfo));
    }
    return this;
  }
  
  public pbl a(ArticleInfo paramArticleInfo, int paramInt)
  {
  ...
  public pbl a(ArticleInfo paramArticleInfo, boolean paramBoolean)
  {
  ...
  public pbl a(ArticleInfo paramArticleInfo, boolean paramBoolean, int paramInt)
  {
    if ((!a("jump_src")) && (rbp.a().a(paramArticleInfo, false, rbp.jdField_a_of_type_Int))) {
      v(rbt.a(paramArticleInfo));
    }
  ...
  pbl a(Long paramLong1, Long paramLong2)
  {
  ...
  pbl a(String paramString1, String paramString2)
  {
  ...
  pbl a(String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, String paramString4, int paramInt3)
  {
  ...
  pbl a(@NotNull Map<String, Object> paramMap)
  {
  ...
  public pbl b(int paramInt, ArticleInfo paramArticleInfo)
  {
    if (((paramInt != 0) && (!pcl.c(paramInt))) || (paramArticleInfo == null)) {}
    for (;;)
    {
      return this;
      if (paramInt == 0) {}
      for (paramArticleInfo = uhv.a(paramArticleInfo.mArticleID); paramArticleInfo != null; paramArticleInfo = ozh.a(paramArticleInfo.mArticleID))
      {
  ...
  pbl b(long paramLong)
  {
    this.a.put("topicid", paramLong);
    return this;
  }
  
  pbl b(JsonArray paramJsonArray)
  {
    this.a.put("rowkey", paramJsonArray);
    return this;
  }
  
  public pbl b(ArticleInfo paramArticleInfo)
  {
    if (paramArticleInfo != null) {
  ...
  public pbl b(ArticleInfo paramArticleInfo, boolean paramBoolean)
  {
    int i = 0;
    if ((paramBoolean) || (pgb.g(paramArticleInfo)) || (pgb.i(paramArticleInfo)) || (pgb.n(paramArticleInfo)) || (pgb.j(paramArticleInfo)) || (pgb.k(paramArticleInfo)))
    {
  ...
  pbl b(String paramString1, String paramString2)
  {
  ...
  pbl c(long paramLong)
  {
    this.a.put("uin", paramLong);
    return this;
  }
  
  public pbl c(ArticleInfo paramArticleInfo)
  {
  ...
  pbl c(String paramString1, String paramString2)
  {
  ...
  pbl d(long paramLong)
  {
    this.a.put("main_text_read_time", paramLong);
    return this;
  }
  
  public pbl d(ArticleInfo paramArticleInfo)
  {
  ...
  public pbl e(ArticleInfo paramArticleInfo)
  {
    int i;
  ...
  public pbl f(ArticleInfo paramArticleInfo)
  {
    String str4 = "";
    try
    {
      if (!TextUtils.isEmpty(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rex.jdField_a_of_type_Ren.jdField_a_of_type_JavaLangString)) {}
      for (str1 = paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rex.jdField_a_of_type_Ren.jdField_a_of_type_JavaLangString;; str1 = paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rex.jdField_a_of_type_Rfg.f)
      {
        str2 = str4;
        str3 = str1;
        try
        {
          if (!TextUtils.isEmpty(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rex.jdField_a_of_type_Rfd.b))
          {
            str2 = paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rex.jdField_a_of_type_Rfd.b;
            str3 = str1;
          }
          C(str3);
          D(str2);
        ...
        if (TextUtils.isEmpty(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rex.jdField_a_of_type_Rfg.f)) {
          break label179;
        }
      }
    }
  ...
  public pbl g(ArticleInfo paramArticleInfo)
  {
  ...
  public pbl h(ArticleInfo paramArticleInfo)
  {
    if ((paramArticleInfo != null) && (paramArticleInfo.mFeedType == 35) && (paramArticleInfo.multiVideoColumnInfo != null))
    {
      ...
      x(localrdl.jdField_a_of_type_Int);
      if (localrdl.jdField_a_of_type_JavaUtilList.size() > 0)
      {
        JsonArray localJsonArray = new JsonArray();
      ...
      if (!TextUtils.isEmpty(localrdl.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructUrlJumpInfo.e)) {
        A(localrdl.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructUrlJumpInfo.e);
      }
    }
    return this;
  }
  
  pbl h(String paramString)
  {
    if (!TextUtils.isEmpty(paramString)) {
  ...
  public pbl i(ArticleInfo paramArticleInfo)
  {
    if ((paramArticleInfo != null) && (paramArticleInfo.mFeedType == 34) && (paramArticleInfo.scripCmsInfo != null))
    {
      ...
      a(str1, "" + localrea.a, paramArticleInfo.innerUniqueID, pxs.a(BaseApplicationImpl.getApplication(), str1), rea.c, localrea.j, localrea.b);
    }
    return this;
  }
  
  pbl i(String paramString)
  {
  ...
  public pbl j(ArticleInfo paramArticleInfo)
  {
    if (paramArticleInfo != null)
    {
      if ((puf.a() != -1) && (puf.a() != 0))
  ...
  public pbl k(ArticleInfo paramArticleInfo)
  {
  ...
  public pbl l(ArticleInfo paramArticleInfo)
  {
    if (paramArticleInfo != null) {}
  ...
  public pbl m(ArticleInfo paramArticleInfo)
  {
  ...
  public pbl n(ArticleInfo paramArticleInfo)
  {
    boolean bool;
    int i;
    if (paramArticleInfo != null)
    {
      ...
      if ((!TextUtils.isEmpty(paramArticleInfo.proteusItemsData)) && (paramArticleInfo.proteusItemsData.contains("article_main_body_text")))
      {
        ...
        Map localMap = uhv.a(paramArticleInfo.mChannelID);
        if ((localMap == null) || (localMap.get(Long.valueOf(paramArticleInfo.mArticleID)) == null)) {
          break label117;
        }
        d(((uia)localMap.get(Long.valueOf(paramArticleInfo.mArticleID))).a);
      }
    }
    for (;;)
    {
  ...
  public pbl o(ArticleInfo paramArticleInfo)
  {
  ...
  public pbl p(ArticleInfo paramArticleInfo)
  {
    if (pgb.f(paramArticleInfo))
    {
      paramArticleInfo = paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rep;
      if (paramArticleInfo != null) {
  ...
  public pbl q(ArticleInfo paramArticleInfo)
  {
  ...
  public pbl r(ArticleInfo paramArticleInfo)
  {
    if (paramArticleInfo == null) {
      return this;
    }
  ...
  public pbl s(ArticleInfo paramArticleInfo)
  {
  ...
  public pbl t(ArticleInfo paramArticleInfo)
  {
    if (paramArticleInfo == null) {
      return this;
    }
    qmc.a.a(paramArticleInfo, this.a);
    return this;
  }
  
  pbl t(String paramString)
  {
