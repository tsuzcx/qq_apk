...
{
  aocb(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (!paramFromServiceMsg.isSuccess()) {
      bjgx.a().a(paramFromServiceMsg.getServiceCmd(), 100, paramFromServiceMsg.getBusinessFailCode(), this.app.getCurrentAccountUin(), 1000277, anvx.a(2131710851), true);
    }
  }
      ...
      if ((localObject != null) && (((List)localObject).size() > 0))
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          if ((localRemindItem.uint64_uin.has()) && (localRemindItem.uint32_id.has()))
          {
            ...
            paramRspBody.add(str);
            amci.a(str, localRemindItem.uint32_id.get(), this.app);
          }
        }
        amci.a(paramRspBody, this.app);
      }
    }
  }
  ...
  private void c(RemindPB.RspBody paramRspBody)
  {
    if (paramRspBody.msg_quota.has())
    {
      ...
      if (paramRspBody.uint32_comm_quota.has()) {
        amci.a(paramRspBody.uint32_comm_quota.get(), this.app);
      }
      if (paramRspBody.uint32_svip_quota.has()) {
        amci.b(paramRspBody.uint32_svip_quota.get(), this.app);
      }
      amci.b(this.app);
    }
  }
