...
@TargetApi(11)
public class aocb
  implements SurfaceTexture.OnFrameAvailableListener, aobb, ISuperPlayer.OnCompletionListener, ISuperPlayer.OnDefinitionInfoListener, ISuperPlayer.OnErrorListener, ISuperPlayer.OnInfoListener, ISuperPlayer.OnSeekCompleteListener, ISuperPlayer.OnVideoPreparedListener
{
  ...
  private aokx jdField_a_of_type_Aokx = new aocc(this);
  ...
  private aokw jdField_b_of_type_Aokw;
  ...
  public aocb(aobd paramaobd, aocd paramaocd)
  {
    this.jdField_a_of_type_Aobd = paramaobd;
    this.jdField_a_of_type_Aocd = paramaocd;
    this.jdField_e_of_type_Int = paramaocd.jdField_e_of_type_Int;
    this.jdField_d_of_type_Int = paramaocd.jdField_d_of_type_Int;
    this.jdField_a_of_type_Aokz = paramaocd.jdField_a_of_type_Aokz;
    this.jdField_a_of_type_JavaLangString = paramaocd.jdField_b_of_type_JavaLangString;
    this.jdField_a_of_type_Long = paramaocd.jdField_b_of_type_Long;
    boolean bool = aocj.a();
    if (QLog.isColorLevel()) {
      QLog.d("AREngine_OnlineVideoARRenderable", 2, "Construction mSoftwarePlayConfig:false  isRubbishDevice:" + bool + "  isSoftPlay:" + this.jdField_a_of_type_Aocd.jdField_a_of_type_Boolean);
    }
  }
  ...
  {
    if (paramBoolean) {
      if (this.jdField_b_of_type_Aokw == null)
      {
        this.jdField_b_of_type_Aokw = aoky.a(this.jdField_a_of_type_Aokz, 3);
        this.jdField_b_of_type_Aokw.a(aocj.jdField_b_of_type_ArrayOfFloat, aocj.jdField_a_of_type_ArrayOfShort);
        this.jdField_b_of_type_Aokw.a("uniform int uDisplayType;\n", null, "    if(uDisplayType == 1){\n        // 需要渲染成圆形\n        float x = vTextureCoord.x;\n        float y = vTextureCoord.y;\n        // 圆心(0.5, 0.5), 0.25=0.5*0.5\n        if(pow(abs(x-0.5), 2.0) + pow(abs(y-0.5), 2.0) >= 0.25) {\n            gl_FragColor[3] = 0.0;\n        }\n    }\n", this.jdField_a_of_type_Aokx);
        this.jdField_b_of_type_Aokw.a(this.jdField_a_of_type_Aocd.jdField_c_of_type_Int, this.jdField_a_of_type_Aocd.jdField_a_of_type_Float, this.jdField_a_of_type_Aocd.jdField_b_of_type_Float, this.jdField_a_of_type_Aocd.jdField_c_of_type_Float);
      }
    }
    while (this.jdField_a_of_type_Aokw != null) {
      return;
    }
    ...
    this.jdField_a_of_type_Aokw.a(this.jdField_a_of_type_Aocd.jdField_c_of_type_Int, this.jdField_a_of_type_Aocd.jdField_a_of_type_Float, this.jdField_a_of_type_Aocd.jdField_b_of_type_Float, this.jdField_a_of_type_Aocd.jdField_c_of_type_Float);
  }
  
  public void a(float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, float[] paramArrayOfFloat3, float[] paramArrayOfFloat4)
  {
    if ((!this.jdField_e_of_type_Boolean) || (paramArrayOfFloat2 == null) || (this.jdField_a_of_type_Aocd == null)) {
      return;
    }
    ...
    label54:
    int m;
    if (this.jdField_a_of_type_Aocd.jdField_b_of_type_Int == 1)
    {
      ...
      if (this.jdField_a_of_type_Aokw != null)
      {
        ...
        paramArrayOfFloat3 = this.jdField_a_of_type_Aokz;
    ...
    for (;;)
    {
      ...
      if (this.jdField_b_of_type_Aokw != null)
      {
        paramArrayOfFloat2 = this.jdField_b_of_type_Aokw;
  ...
  public float[] a(float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, float[] paramArrayOfFloat3)
  {
    ...
    if (c() == 2) {
      if (this.jdField_a_of_type_Aocd.jdField_a_of_type_Aoex != null)
      {
        Matrix.scaleM(this.jdField_a_of_type_ArrayOfFloat, 0, this.jdField_a_of_type_Aocd.jdField_a_of_type_Aoex.jdField_a_of_type_Float * paramArrayOfFloat1[0], this.jdField_a_of_type_Aocd.jdField_a_of_type_Aoex.jdField_b_of_type_Float * paramArrayOfFloat1[1], 1.0F);
        Matrix.translateM(this.jdField_a_of_type_ArrayOfFloat, 0, this.jdField_a_of_type_Aocd.jdField_a_of_type_Aoex.jdField_c_of_type_Float, this.jdField_a_of_type_Aocd.jdField_a_of_type_Aoex.d, this.jdField_a_of_type_Aocd.jdField_a_of_type_Aoex.e);
      }
    }
    for (;;)
    {
    ...
    if (this.jdField_a_of_type_Aocd.jdField_c_of_type_Int == 1) {}
    for (;;)
    {
  ...
  public int b()
  {
    if (this.jdField_a_of_type_Aocd != null) {
      return this.jdField_a_of_type_Aocd.jdField_a_of_type_Int;
    }
    return 4;
  }
  ...
  {
    if (this.jdField_a_of_type_Aocd != null) {
      return this.jdField_a_of_type_Aocd.jdField_b_of_type_Int;
    }
    return 0;
  }
  ...
  public String c()
  {
    return this.jdField_a_of_type_Aocd.jdField_a_of_type_JavaLangString;
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("AREngine_OnlineVideoARRenderable", 2, "start, arResourceInfo=" + this.jdField_a_of_type_Aocd);
    }
    ...
    this.j = true;
    String str = aoma.a(this.jdField_a_of_type_JavaLangString);
    if (QLog.isColorLevel()) {
  ...
  public void f()
  {
    ...
    try
    {
      ...
      if (this.jdField_b_of_type_Aokw != null)
      {
        this.jdField_b_of_type_Aokw.b();
        this.jdField_b_of_type_Aokw = null;
      }
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_Aobd != null) {
          this.jdField_a_of_type_Aobd.a(this.jdField_a_of_type_Aocd.jdField_a_of_type_JavaLangString);
        }
      }
    }
  }
  ...
  public void onCompletion(ISuperPlayer paramISuperPlayer)
  {
    ...
    if (this.jdField_a_of_type_Aobd != null) {
      this.jdField_a_of_type_Aobd.b(2, this.jdField_e_of_type_Int - this.jdField_c_of_type_Int);
    }
    ...
    } while (this.jdField_a_of_type_Aobd == null);
    this.jdField_a_of_type_Aobd.a(paramISuperPlayer);
  }
  ...
  public void onVideoPrepared(ISuperPlayer paramISuperPlayer)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_Aobd != null)
        {
          this.jdField_a_of_type_Aobd.b(0, this.jdField_e_of_type_Int);
          return;
        }
      }
