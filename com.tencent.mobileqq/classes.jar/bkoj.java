  ...
  implements KingCardProxy
{
  ...
  public ImageView getCapsuleButtonMoreView(Context paramContext)
  {
    ...
    for (Object localObject = MiniAppGlobal.KINGCARD_GUIDE_TEXT;; localObject = paramContext.getResources().getString(2131693972))
    {
      this.c = ((String)localObject);
      this.jdField_a_of_type_ComTencentMobileqqVipDiyCommonDIYLottieLoader = new DIYLottieLoader(null, paramContext);
      ...
      ((DiniFlyAnimationView)localObject).setContentDescription(anvx.a(2131700851));
