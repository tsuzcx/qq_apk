...
public class zck
{
  ...
  private static int a(zct paramzct)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 30	zct:b	()Ljava/lang/String;
    ...
    //   557: aload 8
    //   559: invokestatic 134	zck:a	(Ljava/io/InputStream;Ljava/io/File;)V
    //   562: aload 6
    //   564: astore 4
    //   566: aload 8
  ...
  public static void a(Context paramContext)
  {
    ...
    zct localzct = zcu.a(paramContext, "dex");
    if ((jdField_a_of_type_Int == 0) && (a(paramContext, localzct)))
    {
      a(localzct);
      int j;
      if (jdField_a_of_type_Int == 500) {
        if ((localzct.b()) && (PatchCommonUtil.isArtGeN()) && (!SoLoadUtil.a()))
        {
          j = a(localzct);
          i = j;
          if (j != 800)
          {
            String str = akhd.a(BaseApplicationImpl.sApplication, 0);
      ...
      for (int i = j;; i = 0)
      {
        a(paramContext, localzct);
        PatchReporter.reportPatchEvent(paramContext, "", "actPatchInstall", jdField_a_of_type_Int, localzct.b(), i);
        ...
        if (PatchCommonUtil.isDalvik()) {
          PatchResolveForDalvik.a(paramContext, localzct);
        }
      }
    }
  ...
  private static void a(Context paramContext, zct paramzct)
  {
    paramContext = new DexPatchInstaller.1(paramzct, paramContext);
  ...
  public static void a(java.io.InputStream paramInputStream, File paramFile)
  {
    // Byte code:
    //   0: aload_1
    //   1: invokevirtual 270	java/io/File:getParentFile	()Ljava/io/File;
    //   4: invokevirtual 273	java/io/File:mkdirs	()Z
    //   7: pop
    //   8: new 275	java/io/FileOutputStream
    //   11: dup
    //   12: aload_1
    //   13: invokespecial 276	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   16: astore_3
    //   17: sipush 4096
    //   20: newarray byte
    //   22: astore_1
    //   23: aload_0
    //   24: aload_1
    //   25: invokevirtual 282	java/io/InputStream:read	([B)I
    //   28: istore_2
    //   29: iload_2
    //   30: ifle +32 -> 62
    //   33: aload_3
    ...
    //   35: iconst_0
    //   36: iload_2
    //   37: invokevirtual 288	java/io/OutputStream:write	([BII)V
    //   40: goto -17 -> 23
    //   43: astore_1
    //   44: aload_0
    //   45: ifnull +7 -> 52
    //   48: aload_0
    //   49: invokevirtual 289	java/io/InputStream:close	()V
    //   52: aload_3
    //   53: ifnull +7 -> 60
    //   56: aload_3
    //   57: invokevirtual 290	java/io/OutputStream:close	()V
    //   60: aload_1
    //   61: athrow
    //   62: aload_0
    //   63: ifnull +7 -> 70
    //   66: aload_0
    //   67: invokevirtual 289	java/io/InputStream:close	()V
    //   70: aload_3
    //   71: ifnull +7 -> 78
    //   74: aload_3
    //   75: invokevirtual 290	java/io/OutputStream:close	()V
    //   78: return
    //   79: astore_0
    //   80: goto -10 -> 70
    //   83: astore_0
  ...
  private static void a(zct paramzct)
  {
    long l = System.currentTimeMillis();
    try
    {
      paramzct = paramzct.b();
      String str = PatchCommonUtil.getPatchPath(paramzct);
      if ("Success".equals(akhd.a(BaseApplicationImpl.sApplication, str, null, false)))
      {
        jdField_a_of_type_Int = 500;
        jdField_a_of_type_JavaLangString = paramzct;
      }
      for (;;)
      {
    ...
    catch (Throwable paramzct)
    {
      for (;;)
      {
        jdField_a_of_type_Int = 502;
        QLog.d("PatchLogTag", 1, "DexPatchInstaller injectDexPatch throwable=" + paramzct);
      }
    }
  }
  
  private static boolean a(Context paramContext, zct paramzct)
  {
    if (paramzct == null) {
      QLog.d("PatchLogTag", 1, "DexPatchInstaller checkDexPatchConfigAndStatus patch config is null");
    }
    while (!paramzct.a(paramContext, true)) {
      return false;
    }
    String str = paramzct.b();
    ...
    if (localFile.length() != paramzct.b())
    {
