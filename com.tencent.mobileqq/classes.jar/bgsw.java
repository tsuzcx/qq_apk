  ...
  extends DefaultHandler
{
  ...
  public bgsw(String paramString)
  {
  ...
  {
    if (this.b != null) {
      this.b = this.b.jdField_a_of_type_Bgss;
    }
  }
        ...
        for (;;)
        {
          ...
          if (paramString2.startsWith("L"))
          {
            ...
            try
            {
              ...
              if (i != 0)
              {
                paramString2 = new bgss(i, paramString1, paramString3);
                this.b = paramString2;
                if (paramString2.a(paramAttributes))
                {
                  ...
                  this.jdField_a_of_type_Bgss = paramString2;
                }
              }
            }
