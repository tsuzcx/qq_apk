  ...
  extends MSFServlet
{
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      try
      {
        Object localObject = phy.a(paramFromServiceMsg.getWupBuffer());
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    if (paramIntent != null)
    {
      paramIntent = qnf.a("OidbSvc.0xbf8", 3064, 0, paramIntent);
      paramPacket.setSSOCommand(paramIntent.getServiceCmd());
      paramPacket.putSendData(phy.b(paramIntent.getWupBuffer()));
