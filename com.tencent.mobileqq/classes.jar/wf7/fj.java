...
public class fj
{
  ...
  private static String a(java.net.HttpURLConnection paramHttpURLConnection)
  {
    ...
    //   7: dup
    //   8: ldc 18
    //   10: invokespecial 22	java/net/URL:<init>	(Ljava/lang/String;)V
    //   13: invokevirtual 26	java/net/URL:getHost	()Ljava/lang/String;
    //   16: aload_0
    //   17: invokevirtual 32	java/net/HttpURLConnection:getURL	()Ljava/net/URL;
    //   20: invokevirtual 26	java/net/URL:getHost	()Ljava/lang/String;
    //   23: invokevirtual 38	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   26: ifne +293 -> 319
    //   29: aload_0
    //   30: invokevirtual 32	java/net/HttpURLConnection:getURL	()Ljava/net/URL;
    //   33: invokevirtual 41	java/net/URL:toExternalForm	()Ljava/lang/String;
    //   36: astore_2
    //   37: aload_2
    //   38: astore_1
    //   39: aload_1
    ...
    //   52: aload_0
    //   53: ldc 43
    //   55: invokevirtual 47	java/net/HttpURLConnection:getHeaderField	(Ljava/lang/String;)Ljava/lang/String;
    //   58: ifnull +15 -> 73
    //   61: aload_1
    //   62: astore_3
    //   63: aload_1
    ...
    //   66: aload_0
    //   67: ldc 43
    //   69: invokevirtual 47	java/net/HttpURLConnection:getHeaderField	(Ljava/lang/String;)Ljava/lang/String;
    //   72: astore_2
    //   73: aload_2
    //   74: astore_1
    //   75: aload_2
    ...
    //   86: aload_0
    //   87: ldc 49
    //   89: invokevirtual 47	java/net/HttpURLConnection:getHeaderField	(Ljava/lang/String;)Ljava/lang/String;
    //   92: ifnull +48 -> 140
    //   95: aload_2
    //   96: astore_3
    //   97: aload_2
    ...
    //   100: aload_0
    //   101: ldc 49
    //   103: invokevirtual 47	java/net/HttpURLConnection:getHeaderField	(Ljava/lang/String;)Ljava/lang/String;
    //   106: ldc 51
    //   108: invokevirtual 55	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   111: astore 5
    //   113: aload_2
    //   114: astore_1
    //   115: aload_2
    ...
    //   134: iconst_1
    //   135: aaload
    //   136: invokevirtual 58	java/lang/String:trim	()Ljava/lang/String;
    //   139: astore_1
    //   140: aload_1
    ...
    //   147: astore 4
    //   149: aload_0
    //   150: invokevirtual 62	java/net/HttpURLConnection:getInputStream	()Ljava/io/InputStream;
    //   153: astore_0
    //   154: aload_0
    //   155: ifnull +150 -> 305
    //   158: aload_0
    //   159: invokestatic 66	wf7/fj:b	(Ljava/io/InputStream;)Ljava/lang/String;
    //   162: astore_2
    //   163: aload_2
    //   164: ifnull +141 -> 305
    //   167: aload_2
    ...
    //   176: ifnull +9 -> 185
    //   179: aload_2
    //   180: invokevirtual 72	java/io/InputStream:close	()V
    //   183: aload_0
    //   184: astore_1
    //   185: aload_1
    //   186: areturn
    ...
    //   195: ifnull -10 -> 185
    //   198: aload_2
    //   199: invokevirtual 72	java/io/InputStream:close	()V
    //   202: aload_0
    //   203: areturn
    //   204: astore_1
    //   205: aload_0
    ...
    //   235: ifnull -50 -> 185
    //   238: aload_2
    //   239: invokevirtual 72	java/io/InputStream:close	()V
    //   242: aload_0
    //   243: areturn
    //   244: astore_1
    //   245: aload_0
  ...
  public static String a(fj.a parama)
  {
    ...
    //   9: dup
    //   10: ldc 18
    //   12: invokespecial 22	java/net/URL:<init>	(Ljava/lang/String;)V
    //   15: invokevirtual 78	java/net/URL:openConnection	()Ljava/net/URLConnection;
    //   18: checkcast 28	java/net/HttpURLConnection
    //   21: astore_3
    //   22: invokestatic 84	wf7/dk:bJ	()I
    //   25: bipush 8
    //   27: if_icmpge +11 -> 38
    //   30: ldc 86
    //   32: ldc 88
    //   34: invokestatic 94	java/lang/System:setProperty	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   37: pop
    //   38: aload_3
    //   39: iconst_0
    //   40: invokevirtual 98	java/net/HttpURLConnection:setUseCaches	(Z)V
    //   43: aload_3
    //   44: ldc 100
    //   46: ldc 102
    //   48: invokevirtual 106	java/net/HttpURLConnection:setRequestProperty	(Ljava/lang/String;Ljava/lang/String;)V
    //   51: aload_3
    //   52: ldc 108
    //   54: ldc 102
    //   56: invokevirtual 106	java/net/HttpURLConnection:setRequestProperty	(Ljava/lang/String;Ljava/lang/String;)V
    //   59: aload_3
    //   60: iconst_0
    //   61: invokevirtual 111	java/net/HttpURLConnection:setInstanceFollowRedirects	(Z)V
    //   64: aload_3
    //   65: ldc 113
    //   67: invokevirtual 116	java/net/HttpURLConnection:setRequestMethod	(Ljava/lang/String;)V
    //   70: aload_3
    //   71: sipush 5000
    //   74: invokevirtual 120	java/net/HttpURLConnection:setReadTimeout	(I)V
    //   77: aload_3
    //   78: invokevirtual 123	java/net/HttpURLConnection:getResponseCode	()I
    //   81: istore_1
    //   82: iload_1
    //   83: sipush 200
    //   86: if_icmpeq +17 -> 103
    ...
    //   103: aload_3
    //   104: ldc 125
    //   106: invokevirtual 47	java/net/HttpURLConnection:getHeaderField	(Ljava/lang/String;)Ljava/lang/String;
    //   109: astore 5
    //   111: aload 5
    //   113: ifnull +13 -> 126
    //   116: aload 5
    //   118: ldc 125
    //   120: invokevirtual 38	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   123: ifne +9 -> 132
    //   126: aload_3
    //   127: invokestatic 127	wf7/fj:a	(Ljava/net/HttpURLConnection;)Ljava/lang/String;
    //   130: astore 4
    //   132: iconst_0
    //   133: istore_2
    //   134: aload_3
    //   135: ifnull +7 -> 142
    //   138: aload_3
    //   139: invokevirtual 130	java/net/HttpURLConnection:disconnect	()V
    //   142: aload 4
    //   144: ifnonnull +23 -> 167
    //   147: aload_0
    //   148: iconst_0
    //   149: iload_2
    //   150: invokeinterface 136 3 0
    //   155: aload 4
    //   157: areturn
    //   158: iconst_1
    //   159: istore_2
    ...
    //   164: goto -30 -> 134
    //   167: aload 4
    //   169: putstatic 138	wf7/fj:pY	Ljava/lang/String;
    //   172: aload_0
    //   173: iconst_1
    //   174: iload_2
    //   175: invokeinterface 136 3 0
    //   180: aload 4
    //   182: areturn
    //   183: astore_3
    //   184: aconst_null
    ...
    //   199: iconst_0
    //   200: iconst_1
    //   201: invokeinterface 136 3 0
    //   206: aconst_null
    //   207: areturn
    //   208: aconst_null
    //   209: putstatic 138	wf7/fj:pY	Ljava/lang/String;
    //   212: aload_0
    //   213: iconst_1
    //   214: iconst_1
    ...
    //   241: ifnull +8 -> 249
    //   244: aload 4
    //   246: invokevirtual 130	java/net/HttpURLConnection:disconnect	()V
    //   249: iconst_0
    //   250: ifne +52 -> 302
    //   253: aload_0
    //   254: iconst_0
    //   255: iload_2
    //   256: invokeinterface 136 3 0
    //   261: aload_3
    //   262: athrow
    //   263: astore_3
    //   264: aconst_null
    ...
    //   267: ifnull +7 -> 274
    //   270: aload_3
    //   271: invokevirtual 130	java/net/HttpURLConnection:disconnect	()V
    //   274: iconst_0
    //   275: ifne +13 -> 288
    //   278: aload_0
    //   279: iconst_0
    //   280: iconst_1
    //   281: invokeinterface 136 3 0
    //   286: aconst_null
    //   287: areturn
    //   288: aconst_null
    //   289: putstatic 138	wf7/fj:pY	Ljava/lang/String;
    //   292: aload_0
    //   293: iconst_1
    //   294: iconst_1
    //   295: invokeinterface 136 3 0
    //   300: aconst_null
    //   301: areturn
    //   302: aconst_null
    //   303: putstatic 138	wf7/fj:pY	Ljava/lang/String;
    //   306: aload_0
    //   307: iconst_1
    //   308: iload_2
    //   309: invokeinterface 136 3 0
    //   314: goto -53 -> 261
    //   317: astore_3
    //   318: aconst_null
    //   319: astore 4
