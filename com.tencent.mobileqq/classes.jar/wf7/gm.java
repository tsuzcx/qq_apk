  ...
  extends gl
{
  ...
  private int a(String paramString, int paramInt, java.io.InputStream paramInputStream, boolean paramBoolean)
  {
    ...
    //   11: newarray byte
    //   13: astore 12
    //   15: new 59	android/os/Bundle
    //   18: dup
    //   19: invokespecial 60	android/os/Bundle:<init>	()V
    //   22: astore 13
    ...
    //   37: ifne +16 -> 53
    //   40: aload_1
    //   41: invokevirtual 70	java/io/File:getParentFile	()Ljava/io/File;
    //   44: invokevirtual 73	java/io/File:mkdirs	()Z
    //   47: pop
    //   48: aload_1
    //   49: invokevirtual 76	java/io/File:createNewFile	()Z
    //   52: pop
    //   53: new 78	java/io/FileOutputStream
    //   56: dup
    //   57: aload_1
    //   58: iconst_1
    //   59: invokespecial 81	java/io/FileOutputStream:<init>	(Ljava/io/File;Z)V
    //   62: astore 8
    //   64: aload_3
    //   65: astore_1
    //   66: iload 4
    ...
    //   77: aload_3
    //   78: astore 10
    //   80: new 83	java/util/zip/InflaterInputStream
    //   83: dup
    //   84: aload_3
    //   85: invokespecial 86	java/util/zip/InflaterInputStream:<init>	(Ljava/io/InputStream;)V
    //   88: astore_1
    //   89: iconst_0
    //   90: istore 7
    //   92: iconst_0
    ...
    //   114: i2l
    //   115: aload_0
    //   116: getfield 25	wf7/gm:ss	J
    //   119: ladd
    //   120: putfield 27	wf7/gm:st	J
    //   123: aload_1
    //   124: astore 9
    //   126: aload_1
    //   127: astore 11
    ...
    //   130: astore 10
    //   132: aload_0
    //   133: getfield 25	wf7/gm:ss	J
    //   136: ldc2_w 87
    //   139: lmul
    //   140: aload_0
    //   141: getfield 27	wf7/gm:st	J
    //   144: ldiv
    //   145: l2i
    //   146: istore 5
    //   148: iload 7
    ...
    //   161: aload_1
    //   162: aload 12
    //   164: invokevirtual 94	java/io/InputStream:read	([B)I
    //   167: istore 7
    //   169: iload 7
    //   171: iconst_m1
    ...
    //   209: ifnull -203 -> 6
    //   212: aload 8
    //   214: invokevirtual 98	java/io/FileOutputStream:close	()V
    //   217: sipush -5003
    //   220: ireturn
    //   221: astore_1
    //   222: sipush -5003
    ...
    //   239: iconst_0
    //   240: iload 7
    //   242: invokevirtual 102	java/io/FileOutputStream:write	([BII)V
    //   245: aload_1
    //   246: astore 9
    //   248: aload_1
    //   249: astore 11
    ...
    //   254: aload_0
    //   255: aload_0
    //   256: getfield 25	wf7/gm:ss	J
    //   259: iload 7
    //   261: i2l
    //   262: ladd
    //   263: putfield 25	wf7/gm:ss	J
    //   266: iload 7
    //   268: iload 6
    //   270: iadd
    //   271: istore 6
    ...
    //   298: astore 10
    //   300: aload_0
    //   301: getfield 25	wf7/gm:ss	J
    //   304: ldc2_w 87
    //   307: lmul
    //   308: aload_0
    //   309: getfield 27	wf7/gm:st	J
    //   312: ldiv
    //   313: l2i
    //   314: istore 7
    //   316: iload 7
    ...
    //   334: ldc 104
    //   336: iload 7
    //   338: invokevirtual 108	android/os/Bundle:putInt	(Ljava/lang/String;I)V
    //   341: aload_1
    //   342: astore 9
    //   344: aload_1
    //   345: astore 11
    ...
    //   351: iconst_2
    //   352: aload 13
    //   354: invokevirtual 111	wf7/gm:a	(ILandroid/os/Bundle;)V
    //   357: iload 7
    //   359: istore 5
    //   361: goto +216 -> 577
    //   364: aload_1
    ...
    //   371: astore 10
    //   373: aload 8
    //   375: invokevirtual 114	java/io/FileOutputStream:flush	()V
    //   378: iload_2
    //   379: ifle +47 -> 426
    //   382: iload 6
    //   384: iload_2
    ...
    //   392: ifnull +7 -> 399
    //   395: aload_1
    //   396: invokevirtual 97	java/io/InputStream:close	()V
    //   399: iload 5
    //   401: istore_2
    //   402: aload 8
    //   404: ifnull -398 -> 6
    //   407: aload 8
    //   409: invokevirtual 98	java/io/FileOutputStream:close	()V
    //   412: iload 5
    //   414: ireturn
    //   415: astore_1
    //   416: iload 5
    ...
    //   440: ifnull +7 -> 447
    //   443: aload_3
    //   444: invokevirtual 97	java/io/InputStream:close	()V
    //   447: aload_1
    //   448: ifnull -442 -> 6
    //   451: aload_1
    //   452: invokevirtual 98	java/io/FileOutputStream:close	()V
    //   455: sipush -5056
    //   458: ireturn
    //   459: astore_1
    //   460: sipush -5056
    ...
    //   473: ifnull +7 -> 480
    //   476: aload_3
    //   477: invokevirtual 97	java/io/InputStream:close	()V
    //   480: aload 8
    //   482: ifnull -476 -> 6
    //   485: aload 8
    //   487: invokevirtual 98	java/io/FileOutputStream:close	()V
    //   490: sipush -5000
    //   493: ireturn
    //   494: astore_1
    //   495: sipush -5000
    ...
    //   504: ifnull +7 -> 511
    //   507: aload_3
    //   508: invokevirtual 97	java/io/InputStream:close	()V
    //   511: aload 8
    //   513: ifnull +8 -> 521
    //   516: aload 8
    //   518: invokevirtual 98	java/io/FileOutputStream:close	()V
    //   521: aload_1
    //   522: athrow
    //   523: astore_1
    //   524: goto -317 -> 207
  ...
  private int a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    //   12: sipush -7001
    //   15: istore 5
    //   17: new 39	java/io/File
    //   20: dup
    //   21: aload_1
    //   22: invokespecial 63	java/io/File:<init>	(Ljava/lang/String;)V
    //   25: astore 10
    //   27: new 39	java/io/File
    //   30: dup
    //   31: aload_2
    ...
    //   41: ifeq +337 -> 378
    //   44: aload_0
    //   45: getfield 31	wf7/gm:mContext	Landroid/content/Context;
    //   48: invokevirtual 48	android/content/Context:getFilesDir	()Ljava/io/File;
    //   51: invokevirtual 43	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   54: aload_0
    //   55: getfield 50	wf7/gm:sp	Ljava/lang/String;
    //   58: invokevirtual 123	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   61: ifeq +141 -> 202
    //   64: aload_0
    //   65: getfield 31	wf7/gm:mContext	Landroid/content/Context;
    //   68: astore_1
    //   69: aload_0
    //   70: getfield 125	wf7/gm:sq	Ljava/lang/String;
    //   73: astore_2
    //   74: getstatic 131	android/os/Build$VERSION:SDK_INT	I
    //   77: bipush 24
    ...
    //   86: aload_2
    //   87: iload 4
    //   89: invokevirtual 135	android/content/Context:openFileOutput	(Ljava/lang/String;I)Ljava/io/FileOutputStream;
    //   92: astore_1
    //   93: new 137	java/io/FileInputStream
    //   96: dup
    //   97: aload 10
    //   99: invokespecial 140	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   102: astore_2
    //   103: sipush 8192
    //   106: newarray byte
    //   108: astore 6
    //   110: aload_2
    //   111: aload 6
    //   113: invokevirtual 141	java/io/FileInputStream:read	([B)I
    //   116: istore 4
    //   118: iload 4
    //   120: iconst_m1
    ...
    //   127: iconst_0
    //   128: iload 4
    //   130: invokevirtual 102	java/io/FileOutputStream:write	([BII)V
    //   133: goto -23 -> 110
    //   136: astore 6
    //   138: aload_2
    //   139: ifnull +7 -> 146
    //   142: aload_2
    //   143: invokevirtual 142	java/io/FileInputStream:close	()V
    //   146: aload_1
    //   147: ifnull +7 -> 154
    //   150: aload_1
    //   151: invokevirtual 98	java/io/FileOutputStream:close	()V
    //   154: iload 5
    //   156: istore 4
    //   158: iload_3
    //   159: ifeq +34 -> 193
    ...
    //   173: istore 4
    //   175: aload 10
    //   177: invokevirtual 67	java/io/File:exists	()Z
    //   180: ifeq +13 -> 193
    //   183: aload 10
    //   185: invokevirtual 145	java/io/File:delete	()Z
    //   188: pop
    //   189: iload 5
    //   191: istore 4
    //   193: iload 4
    ...
    //   199: goto -114 -> 85
    //   202: aload_1
    //   203: invokevirtual 67	java/io/File:exists	()Z
    //   206: ifeq +20 -> 226
    //   209: aload_1
    //   210: invokevirtual 145	java/io/File:delete	()Z
    //   213: pop
    //   214: new 78	java/io/FileOutputStream
    //   217: dup
    //   218: aload_1
    //   219: invokespecial 146	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   222: astore_1
    //   223: goto -130 -> 93
    //   226: aload_1
    //   227: invokevirtual 70	java/io/File:getParentFile	()Ljava/io/File;
    //   230: invokevirtual 73	java/io/File:mkdirs	()Z
    //   233: pop
    //   234: aload_1
    //   235: invokevirtual 76	java/io/File:createNewFile	()Z
    //   238: pop
    //   239: new 78	java/io/FileOutputStream
    //   242: dup
    //   243: aload_1
    //   244: invokespecial 146	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   247: astore_1
    //   248: goto -155 -> 93
    //   251: astore_1
    //   252: aconst_null
    ...
    //   263: ifnull +7 -> 270
    //   266: aload_2
    //   267: invokevirtual 142	java/io/FileInputStream:close	()V
    //   270: aload_1
    //   271: ifnull +7 -> 278
    //   274: aload_1
    //   275: invokevirtual 98	java/io/FileOutputStream:close	()V
    //   278: iload 5
    //   280: istore 4
    //   282: iload_3
    //   283: ifeq -90 -> 193
    ...
    //   297: istore 4
    //   299: aload 10
    //   301: invokevirtual 67	java/io/File:exists	()Z
    //   304: ifeq -111 -> 193
    //   307: aload 10
    ...
    //   316: ireturn
    //   317: aload_1
    //   318: invokevirtual 114	java/io/FileOutputStream:flush	()V
    //   321: iconst_0
    //   322: istore 5
    //   324: aload_2
    //   325: ifnull +7 -> 332
    ...
    //   333: ifnull +7 -> 340
    //   336: aload_1
    //   337: invokevirtual 98	java/io/FileOutputStream:close	()V
    //   340: iload 5
    //   342: istore 4
    //   344: iload_3
    //   345: ifeq -152 -> 193
    ...
    //   359: istore 4
    //   361: aload 10
    //   363: invokevirtual 67	java/io/File:exists	()Z
    //   366: ifeq -173 -> 193
    //   369: aload 10
    //   371: invokevirtual 145	java/io/File:delete	()Z
    //   374: pop
    //   375: iload 5
    //   377: ireturn
    //   378: aconst_null
    ...
    //   397: ifnull +7 -> 404
    //   400: aload_2
    //   401: invokevirtual 142	java/io/FileInputStream:close	()V
    //   404: aload_1
    //   405: ifnull +7 -> 412
    //   408: aload_1
    //   409: invokevirtual 98	java/io/FileOutputStream:close	()V
    ...
    //   431: istore 4
    //   433: aload 10
    //   435: invokevirtual 67	java/io/File:exists	()Z
    //   438: ifeq -245 -> 193
    //   441: aload 10
    //   443: invokevirtual 145	java/io/File:delete	()Z
    //   446: pop
    //   447: sipush -7000
    //   450: ireturn
    //   451: astore_2
    ...
    //   456: ifnull +8 -> 464
    //   459: aload 6
    //   461: invokevirtual 142	java/io/FileInputStream:close	()V
    //   464: aload_1
    //   465: ifnull +7 -> 472
    //   468: aload_1
    //   469: invokevirtual 98	java/io/FileOutputStream:close	()V
    //   472: iload_3
    //   473: ifeq +22 -> 495
    //   476: aload 10
    //   478: ifnull +17 -> 495
    //   481: aload 10
    //   483: invokevirtual 67	java/io/File:exists	()Z
    //   486: ifeq +9 -> 495
    //   489: aload 10
    //   491: invokevirtual 145	java/io/File:delete	()Z
    //   494: pop
    //   495: aload_2
    //   496: athrow
    //   497: astore_2
