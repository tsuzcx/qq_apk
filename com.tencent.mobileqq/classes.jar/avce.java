...
public class avce
{
  ...
  private static final Comparator<PadFaceAd> jdField_a_of_type_JavaUtilComparator = new avcf();
  ...
  static
  {
    jdField_a_of_type_JavaLangString = anvx.a(2131707321);
  }
  
  public avce(AppInterface paramAppInterface)
  {
  ...
  public static avcg a(AppInterface paramAppInterface)
  {
    paramAppInterface = paramAppInterface.getApp().getSharedPreferences("gamecenter_sp" + paramAppInterface.getCurrentAccountUin(), 4);
    avcg localavcg = new avcg();
    localavcg.jdField_b_of_type_Long = paramAppInterface.getLong("pwa_version", 0L);
    localavcg.jdField_a_of_type_Long = paramAppInterface.getLong("last_pwa_version", 0L);
    localavcg.jdField_a_of_type_JavaLangString = paramAppInterface.getString("pwa_url", "");
    return localavcg;
  }
  ...
  public void a(int paramInt)
  {
    try
    {
      ...
      if (localPadFaceAd != null)
      {
        ...
        ((VasExtensionHandler)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(BusinessHandlerFactory.VAS_EXTENSION_HANDLER)).c(paramInt);
        return;
      }
    }
    finally {}
      ...
      try
      {
        ...
        if ((k > 0) && (b(k) == null) && (i < 2))
        {
          ...
          if (i != 0)
          {
            ...
            ((VasExtensionHandler)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(BusinessHandlerFactory.VAS_EXTENSION_HANDLER)).a(k, j, l);
          }
        }
        else
        {
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    //   24: dup
    //   25: aload_1
    //   26: invokespecial 358	com/tencent/mobileqq/gamecenter/data/PadFaceAd:<init>	(Lorg/json/JSONObject;)V
    //   29: astore 11
    //   31: aload_1
    //   32: ldc_w 360
    //   35: iconst_1
    //   36: invokevirtual 364	org/json/JSONObject:optInt	(Ljava/lang/String;I)I
    //   39: iconst_1
    ...
    //   46: aload_1
    //   47: ldc_w 366
    //   50: invokevirtual 370	org/json/JSONObject:optLong	(Ljava/lang/String;)J
    //   53: lstore 7
    //   55: aload_1
    //   56: ldc 178
    ...
    //   67: ldc_w 372
    //   70: iconst_2
    //   71: invokevirtual 364	org/json/JSONObject:optInt	(Ljava/lang/String;I)I
    //   74: invokestatic 378	java/lang/Math:min	(II)I
    //   77: invokestatic 381	java/lang/Math:max	(II)I
    //   80: istore 5
    //   82: iconst_0
    //   83: istore_2
    //   84: iconst_0
    ...
    //   92: dup
    //   93: invokespecial 382	java/util/ArrayList:<init>	()V
    //   96: astore 12
    //   98: aload_0
    //   99: monitorenter
    //   100: aload_0
    //   101: getfield 257	avce:jdField_b_of_type_Boolean	Z
    //   104: ifne +6 -> 110
    //   107: aload_0
    //   108: monitorexit
    //   109: return
    //   110: aload_0
    //   111: getfield 258	avce:jdField_b_of_type_Long	J
    //   114: iload 5
    //   116: i2l
    //   117: ldc2_w 383
    //   120: lmul
    ...
    //   129: ldc2_w 383
    //   132: lmul
    //   133: putfield 258	avce:jdField_b_of_type_Long	J
    //   136: ldc_w 287
    //   139: iconst_2
    //   140: iconst_2
    ...
    //   151: iconst_1
    //   152: iload 5
    //   154: invokestatic 389	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   157: aastore
    ...
    //   163: iload 6
    //   165: aload_0
    //   166: getfield 236	avce:jdField_a_of_type_Boolean	Z
    //   169: if_icmpeq +29 -> 198
    //   172: aload_0
    //   173: iload 6
    //   175: putfield 236	avce:jdField_a_of_type_Boolean	Z
    //   178: aload_0
    //   179: getfield 236	avce:jdField_a_of_type_Boolean	Z
    //   182: ifne +452 -> 634
    //   185: ldc_w 287
    //   188: iconst_2
    //   189: ldc_w 391
    //   192: invokestatic 394	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   195: goto +439 -> 634
    //   198: aload_0
    //   199: invokevirtual 396	avce:a	()J
    //   202: lstore 9
    //   204: lload 9
    //   206: lload 7
    //   208: lcmp
    ...
    //   227: iconst_1
    //   228: aload_0
    //   229: invokevirtual 400	avce:a	()Ljava/lang/String;
    //   232: aastore
    //   233: dup
    //   234: iconst_2
    //   235: ldc_w 402
    ...
    //   240: iconst_3
    //   241: lload 9
    //   243: invokestatic 350	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   246: aastore
    ...
    //   252: goto +388 -> 640
    //   255: aload_0
    //   256: getfield 130	avce:jdField_a_of_type_AndroidContentSharedPreferences	Landroid/content/SharedPreferences;
    ...
    //   283: ifeq +23 -> 306
    //   286: aload_0
    //   287: getfield 236	avce:jdField_a_of_type_Boolean	Z
    //   290: ifeq +373 -> 663
    //   293: iconst_1
    //   294: istore_2
    //   295: aload_1
    ...
    //   338: pop
    //   339: aload_0
    //   340: getfield 236	avce:jdField_a_of_type_Boolean	Z
    //   343: ifeq +236 -> 579
    //   346: aload 11
    ...
    //   354: aload_0
    //   355: aload 11
    //   357: invokespecial 412	avce:a	(Lcom/tencent/mobileqq/gamecenter/data/PadFaceAd;)Z
    //   360: ifne +219 -> 579
    //   363: aload_0
    //   364: getfield 46	avce:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   367: aload 11
    //   369: invokeinterface 415 2 0
    //   374: pop
    ...
    //   382: iload_2
    //   383: aload_0
    //   384: getfield 46	avce:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   387: invokeinterface 272 1 0
    //   392: if_icmpge +49 -> 441
    //   395: aload_0
    //   396: getfield 46	avce:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   399: iload_2
    ...
    //   464: aload_0
    //   465: getfield 46	avce:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   468: aload 12
    //   470: iload_2
    ...
    //   486: goto -33 -> 453
    //   489: aload_0
    //   490: getfield 46	avce:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   493: getstatic 36	avce:jdField_a_of_type_JavaUtilComparator	Ljava/util/Comparator;
    ...
    //   505: ifnull +122 -> 627
    //   508: aload_0
    //   509: getfield 199	avce:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   512: aload_1
    //   513: invokevirtual 419	com/tencent/mobileqq/persistence/EntityManager:persist	(Lcom/tencent/mobileqq/persistence/Entity;)V
    //   516: aload 12
    //   518: invokeinterface 272 1 0
    //   523: ifle +104 -> 627
    //   526: aload_0
    //   527: getfield 199	avce:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   530: astore 11
    //   532: aload 11
    //   534: invokevirtual 423	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   537: astore_1
    //   538: aload_1
    //   539: invokevirtual 428	com/tencent/mobileqq/persistence/EntityTransaction:begin	()V
    //   542: iconst_0
    //   543: istore_2
    //   544: iload_2
    //   545: aload 12
    ...
    //   565: checkcast 430	com/tencent/mobileqq/persistence/Entity
    ...
    //   588: athrow
    //   589: aload_1
    //   590: invokevirtual 432	com/tencent/mobileqq/persistence/EntityTransaction:commit	()V
    //   593: aload_1
    //   594: invokevirtual 435	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   597: return
    //   598: astore 11
    //   600: ldc_w 287
    //   603: iconst_1
    ...
    //   610: invokestatic 438	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   613: aload_1
    //   614: invokevirtual 435	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   617: return
    //   618: astore 11
    //   620: aload_1
    //   621: invokevirtual 435	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   624: aload 11
    //   626: athrow
    //   627: return
    //   628: iconst_0
