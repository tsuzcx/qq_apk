  ...
  extends AsyncTask<RespondQueryQQBindingStat, Void, List<PhoneContact>>
{
  ...
  private ajoa(PhoneContactManagerImp paramPhoneContactManagerImp) {}
  ...
  protected List<PhoneContact> a(RespondQueryQQBindingStat... paramVarArgs)
  {
    ...
    Collections.sort(paramVarArgs, new ajob(this));
    ArrayList localArrayList = new ArrayList();
    ajjj localajjj = (ajjj)PhoneContactManagerImp.a(this.jdField_a_of_type_ComTencentMobileqqAppPhoneContactManagerImp).getManager(51);
    ...
    do
    {
      do
      {
        ...
        {
          Collections.sort(localArrayList, new ajoc(this));
    ...
    for (;;)
    {
      ...
      break;
      paramVarArgs = localajjj.e(localPhoneContact.uin);
      break label201;
      label260:
      localPhoneContact.uin = "0";
      if (localajjj.d(localPhoneContact.nationCode + localPhoneContact.mobileCode))
      {
