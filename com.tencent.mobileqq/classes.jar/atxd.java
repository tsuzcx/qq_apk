  ...
  implements Handler.Callback, Manager
{
  ...
  private atxg jdField_a_of_type_Atxg;
  atxh jdField_a_of_type_Atxh;
  ...
  private ConcurrentHashMap<Integer, atxg> b = new ConcurrentHashMap();
  ...
  public atxd(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Atxh = new atxc(paramQQAppInterface, this);
    d();
  }
  ...
  private void a(RedTouchItem paramRedTouchItem, int paramInt)
  {
    ...
    if (localRedTouchItem == null)
    {
      ...
      atxi.a(localRedTouchItem, paramRedTouchItem);
    ...
    do
    {
      ...
      j = atxi.a(localRedTouchItem.redtouchType);
      k = atxi.a(paramRedTouchItem.redtouchType);
      if (k > j)
      {
        localRedTouchItem = new RedTouchItem();
        atxi.a(localRedTouchItem, paramRedTouchItem);
  ...
  private void a(RedTouchItem paramRedTouchItem, boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Atxh.a(paramRedTouchItem, localRedPointConfig1.redPointId);
  ...
  private void d()
  {
    this.jdField_a_of_type_Atxg = new atxg();
    this.jdField_a_of_type_Atxg.jdField_a_of_type_Int = -1;
    this.b.put(Integer.valueOf(this.jdField_a_of_type_Atxg.jdField_a_of_type_Int), this.jdField_a_of_type_Atxg);
    atxg localatxg1 = new atxg();
    localatxg1.jdField_a_of_type_Int = 10018;
    localatxg1.jdField_a_of_type_Atxg = this.jdField_a_of_type_Atxg;
    this.b.put(Integer.valueOf(localatxg1.jdField_a_of_type_Int), localatxg1);
    localatxg1 = new atxg();
    localatxg1.jdField_a_of_type_Int = -3;
    localatxg1.jdField_a_of_type_Atxg = this.jdField_a_of_type_Atxg;
    this.b.put(Integer.valueOf(localatxg1.jdField_a_of_type_Int), localatxg1);
    localatxg1.jdField_a_of_type_JavaUtilList = new ArrayList();
    Object localObject1 = new atxg();
    ((atxg)localObject1).jdField_a_of_type_Int = -7;
    this.b.put(Integer.valueOf(((atxg)localObject1).jdField_a_of_type_Int), localObject1);
    ((atxg)localObject1).jdField_a_of_type_Atxg = localatxg1;
    localatxg1.jdField_a_of_type_JavaUtilList.add(localObject1);
    ((atxg)localObject1).jdField_a_of_type_JavaUtilList = new ArrayList();
    atxg localatxg2 = new atxg();
    localatxg2.jdField_a_of_type_Int = -4;
    this.b.put(Integer.valueOf(localatxg2.jdField_a_of_type_Int), localatxg2);
    localatxg2.jdField_a_of_type_Atxg = localatxg1;
    localatxg1.jdField_a_of_type_JavaUtilList.add(localatxg2);
    localatxg2.jdField_a_of_type_JavaUtilList = new ArrayList();
    Object localObject2 = new atxg();
    ((atxg)localObject2).jdField_a_of_type_Int = 10015;
    this.b.put(Integer.valueOf(((atxg)localObject2).jdField_a_of_type_Int), localObject2);
    ((atxg)localObject2).jdField_a_of_type_Atxg = ((atxg)localObject1);
    ((atxg)localObject1).jdField_a_of_type_JavaUtilList.add(localObject2);
    localObject2 = new atxg();
    ((atxg)localObject2).jdField_a_of_type_Int = 10016;
    this.b.put(Integer.valueOf(((atxg)localObject2).jdField_a_of_type_Int), localObject2);
    ((atxg)localObject2).jdField_a_of_type_Atxg = ((atxg)localObject1);
    ((atxg)localObject1).jdField_a_of_type_JavaUtilList.add(localObject2);
    localObject2 = new atxg();
    ((atxg)localObject2).jdField_a_of_type_Int = 100601;
    ((atxg)localObject2).jdField_a_of_type_Atxg = ((atxg)localObject1);
    ((atxg)localObject1).jdField_a_of_type_JavaUtilList.add(localObject2);
    this.b.put(Integer.valueOf(100601), localObject2);
    localObject1 = new atxg();
    ((atxg)localObject1).jdField_a_of_type_Int = 10019;
    this.b.put(Integer.valueOf(((atxg)localObject1).jdField_a_of_type_Int), localObject1);
    ((atxg)localObject1).jdField_a_of_type_Atxg = localatxg2;
    localatxg2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new atxg();
    ((atxg)localObject1).jdField_a_of_type_Int = 10020;
    this.b.put(Integer.valueOf(((atxg)localObject1).jdField_a_of_type_Int), localObject1);
    ((atxg)localObject1).jdField_a_of_type_Atxg = localatxg2;
    localatxg2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new atxg();
    ((atxg)localObject1).jdField_a_of_type_Int = 10022;
    this.b.put(Integer.valueOf(((atxg)localObject1).jdField_a_of_type_Int), localObject1);
    ((atxg)localObject1).jdField_a_of_type_Atxg = localatxg2;
    localatxg2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new atxg();
    ((atxg)localObject1).jdField_a_of_type_Int = 10021;
    this.b.put(Integer.valueOf(((atxg)localObject1).jdField_a_of_type_Int), localObject1);
    ((atxg)localObject1).jdField_a_of_type_Atxg = localatxg2;
    localatxg2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new atxg();
    ((atxg)localObject1).jdField_a_of_type_Int = 10023;
    ((atxg)localObject1).jdField_a_of_type_Atxg = localatxg2;
    this.b.put(Integer.valueOf(((atxg)localObject1).jdField_a_of_type_Int), localObject1);
    localatxg2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new atxg();
    ((atxg)localObject1).jdField_a_of_type_Int = 10024;
    ((atxg)localObject1).jdField_a_of_type_Atxg = localatxg2;
    this.b.put(Integer.valueOf(((atxg)localObject1).jdField_a_of_type_Int), localObject1);
    localatxg2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new atxg();
    ((atxg)localObject1).jdField_a_of_type_Int = 10025;
    ((atxg)localObject1).jdField_a_of_type_Atxg = localatxg2;
    this.b.put(Integer.valueOf(((atxg)localObject1).jdField_a_of_type_Int), localObject1);
    localatxg2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new atxg();
    ((atxg)localObject1).jdField_a_of_type_Int = 10026;
    ((atxg)localObject1).jdField_a_of_type_Atxg = localatxg2;
    this.b.put(Integer.valueOf(((atxg)localObject1).jdField_a_of_type_Int), localObject1);
    localatxg2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localatxg2 = new atxg();
    localatxg2.jdField_a_of_type_Int = -2;
    localatxg2.jdField_a_of_type_Atxg = this.jdField_a_of_type_Atxg;
    this.b.put(Integer.valueOf(localatxg2.jdField_a_of_type_Int), localatxg2);
    this.jdField_a_of_type_Atxg.jdField_a_of_type_JavaUtilList = Arrays.asList(new atxg[] { localatxg1, localatxg2 });
    localatxg2.jdField_a_of_type_JavaUtilList = new ArrayList();
    localObject1 = new atxg();
    ((atxg)localObject1).jdField_a_of_type_Int = 100510;
    this.b.put(Integer.valueOf(((atxg)localObject1).jdField_a_of_type_Int), localObject1);
    ((atxg)localObject1).jdField_a_of_type_Atxg = localatxg2;
    localatxg2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localatxg1 = new atxg();
    localatxg1.jdField_a_of_type_Int = 10011;
    localatxg1.jdField_a_of_type_Atxg = ((atxg)localObject1);
    this.b.put(Integer.valueOf(localatxg1.jdField_a_of_type_Int), localatxg1);
    localObject2 = new ArrayList();
    ((List)localObject2).add(localatxg1);
    ((atxg)localObject1).jdField_a_of_type_JavaUtilList = ((List)localObject2);
    localObject1 = new ArrayList();
    localObject2 = new atxg();
    ((atxg)localObject2).jdField_a_of_type_Int = 100523;
    ((atxg)localObject2).jdField_a_of_type_Atxg = localatxg1;
    this.b.put(Integer.valueOf(((atxg)localObject2).jdField_a_of_type_Int), localObject2);
    ((List)localObject1).add(localObject2);
    localObject2 = new atxg();
    ((atxg)localObject2).jdField_a_of_type_Int = 100517;
    ((atxg)localObject2).jdField_a_of_type_Atxg = localatxg1;
    this.b.put(Integer.valueOf(((atxg)localObject2).jdField_a_of_type_Int), localObject2);
    ((List)localObject1).add(localObject2);
    localatxg1.jdField_a_of_type_JavaUtilList = ((List)localObject1);
    localatxg1 = new atxg();
    localatxg1.jdField_a_of_type_Int = -5;
    localatxg1.jdField_a_of_type_Atxg = localatxg2;
    localatxg2.jdField_a_of_type_JavaUtilList.add(localatxg1);
    localatxg1.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.b.put(Integer.valueOf(localatxg1.jdField_a_of_type_Int), localatxg1);
    localatxg1 = new atxg();
    localatxg1.jdField_a_of_type_Int = -6;
    localatxg1.jdField_a_of_type_Atxg = localatxg2;
    localatxg2.jdField_a_of_type_JavaUtilList.add(localatxg1);
    localatxg1.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.b.put(Integer.valueOf(localatxg1.jdField_a_of_type_Int), localatxg1);
    localObject1 = new atxg();
    ((atxg)localObject1).jdField_a_of_type_Int = 10014;
    ((atxg)localObject1).jdField_a_of_type_Atxg = localatxg1;
    localatxg1.jdField_a_of_type_JavaUtilList.add(localObject1);
    this.b.put(Integer.valueOf(((atxg)localObject1).jdField_a_of_type_Int), localObject1);
    localatxg1 = new atxg();
    localatxg1.jdField_a_of_type_Int = 10013;
    localatxg1.jdField_a_of_type_Atxg = localatxg2;
    localatxg2.jdField_a_of_type_JavaUtilList.add(localatxg1);
    this.b.put(Integer.valueOf(localatxg1.jdField_a_of_type_Int), localatxg1);
  }
  ...
  private void e()
  {
    ...
    a();
    ??? = (ConcurrentHashMap)bbdx.a("red_point_configs_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    if (??? != null)
    {
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.clear();
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.putAll((Map)???);
    }
    ??? = (ConcurrentHashMap)bbdx.a("red_point_info_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    if (??? != null)
    {
      this.c.clear();
      this.c.putAll((Map)???);
  ...
  private void e(int paramInt)
  {
    ...
    if ((localRedTouchItem1 != null) && (localRedTouchItem1.passThroughLevel > 0))
    {
      ...
      {
        atxg localatxg = (atxg)this.b.get(Integer.valueOf(i));
        if ((localatxg == null) || (localatxg.jdField_a_of_type_Atxg == null)) {
          break;
        }
        RedTouchItem localRedTouchItem2 = (RedTouchItem)this.c.get(Integer.valueOf(localatxg.jdField_a_of_type_Atxg.jdField_a_of_type_Int));
        if (localRedTouchItem2 != null) {
          localRedTouchItem2.unReadFlag = false;
        }
        if (localatxg.jdField_a_of_type_Atxg.jdField_a_of_type_JavaUtilList != null)
        {
          i = 0;
          while (i < localatxg.jdField_a_of_type_Atxg.jdField_a_of_type_JavaUtilList.size())
          {
            j = ((atxg)localatxg.jdField_a_of_type_Atxg.jdField_a_of_type_JavaUtilList.get(i)).jdField_a_of_type_Int;
            ...
            if ((localRedTouchItem2 != null) && (localRedTouchItem2.unReadFlag) && (!localRedTouchItem2.isClosed) && (localRedTouchItem2.passThroughLevel > 0)) {
              a(localRedTouchItem2, localatxg.jdField_a_of_type_Atxg.jdField_a_of_type_Int);
            }
            i += 1;
          }
        }
        i = localatxg.jdField_a_of_type_Atxg.jdField_a_of_type_Int;
        paramInt += 1;
      }
    }
  }
  ...
  private void f()
  {
    bbdx.a("red_point_info_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.c);
  }
  ...
  private void g()
  {
    ...
    if ((localConcurrentHashMap != null) && (localConcurrentHashMap.size() > 0))
    {
      ...
      {
        ((atxj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(91)).a(localArrayList, false);
        long l = SystemClock.elapsedRealtime();
        atbi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "pull_red_touch_time2", Long.valueOf(l));
      }
      return;
    }
    if (QLog.isColorLevel()) {
    ...
    ((atxj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(91)).a();
  }
  ...
  public String a()
  {
    if (this.jdField_a_of_type_JavaLangString == null) {
      this.jdField_a_of_type_JavaLangString = ((String)atbi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "red_point_config_version", ""));
    }
    if (QLog.isColorLevel()) {
  ...
  public void a()
  {
    if (this.jdField_a_of_type_JavaUtilVector.size() > 0)
    {
      ...
      f();
      this.jdField_a_of_type_Atxh.a(this.jdField_a_of_type_JavaUtilVector);
  ...
  public void a(int paramInt, boolean paramBoolean1, long paramLong, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (paramBoolean2 = true;; paramBoolean2 = false)
    {
      ...
      ((atxj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(91)).a(localArrayList);
      return;
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      atbi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "red_point_config_version", paramString);
    }
  }
  ...
  public void a(cmd0x6f5.RspBody paramRspBody)
  {
    ...
    if ((paramRspBody != null) && (paramRspBody.rpt_task_info != null) && (paramRspBody.rpt_task_info.has()))
    {
      ...
      bbdx.a("red_point_configs_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), localConcurrentHashMap);
    }
  }
  ...
  public void a(short paramShort)
  {
    ...
    long l1 = ((Long)atbi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "pull_red_touch_time2", Long.valueOf(0L))).longValue();
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      ...
      for (int i = 0;; i = localRedPointConfig.redPointId)
      {
        ...
        akfh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        this.jdField_a_of_type_Atxh.a(Collections.singletonList(paramArrayOfByte));
        return;
      }
