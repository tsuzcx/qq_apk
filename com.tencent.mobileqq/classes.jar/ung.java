...
{
  private static final String jdField_a_of_type_JavaLangString = ung.class.getName();
  ...
  private unm jdField_a_of_type_Unm;
  ...
  public ung(Activity paramActivity)
  {
  ...
  public ung(Activity paramActivity, String paramString1, String paramString2, String paramString3)
  {
    this(paramActivity);
  ...
  public static ung a(Activity paramActivity, String paramString1, String paramString2, String paramString3)
  {
    return new ung(paramActivity, paramString1, paramString2, paramString3);
  }
  ...
  private void a(Activity paramActivity)
  {
    ...
    this.jdField_a_of_type_Acko = new unl(this, paramActivity.getApplicationContext(), paramActivity, null, localAppInterface);
  ...
  private void b()
  {
    View localView = getLayoutInflater().inflate(2131560101, null);
    ((RelativeLayout)localView.findViewById(2131373038)).setOnClickListener(new uni(this));
    localView.setOnClickListener(new unj(this));
    this.jdField_a_of_type_ComTencentMobileqqWidgetWebViewProgressBar = ((WebViewProgressBar)localView.findViewById(2131373229));
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localView.findViewById(2131373041));
    this.jdField_a_of_type_ComTencentMobileqqMiniUtilSoftKeyboardStateHelper = new SoftKeyboardStateHelper(localView);
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localView.findViewById(2131373039));
    ...
    this.jdField_a_of_type_ComTencentMobileqqMiniUtilSoftKeyboardStateHelper.addSoftKeyboardStateListener(new unk(this, (RelativeLayout.LayoutParams)localObject));
    ...
    int k = (int)(i * 0.85D);
    int m = (int)(k * 0.72D);
    localObject = (RelativeLayout)localView.findViewById(2131373039);
    if (localObject != null)
    {
  ...
  public void onDismiss(DialogInterface paramDialogInterface)
  {
    ...
    if (this.jdField_a_of_type_Unm != null) {
  ...
  public void show()
  {
    ...
    getWindow().getDecorView().setOnSystemUiVisibilityChangeListener(new unh(this));
