  ...
  implements Handler.Callback
{
  ...
  private bgxg jdField_a_of_type_Bgxg;
  ...
  public void a(int paramInt1, int paramInt2, bhpk parambhpk)
  {
    ...
    } while (parambhpk == null);
    parambhpk.a("");
    return;
    ThreadManager.post(new SwiftBrowserMiscHandler.3(this, bgim.a(localCustomWebView, paramInt1, paramInt2), parambhpk), 8, null, true);
  }
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
        } while (this.jdField_a_of_type_Bgxg == null);
        this.jdField_a_of_type_Bgxg.f();
        return;
      } while (this.jdField_a_of_type_Bgxg == null);
      this.jdField_a_of_type_Bgxg.g();
      return;
      if (this.jdField_a_of_type_Bgxg != null) {
        this.jdField_a_of_type_Bgxg.e();
      }
  ...
  public void b()
  {
    if ((this.jdField_a_of_type_Bhov.a() instanceof QQBrowserActivity))
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity = ((QQBrowserActivity)this.jdField_a_of_type_Bhov.a());
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.d != null))
      {
        ...
        {
          RelativeLayout localRelativeLayout = (RelativeLayout)this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.d.findViewById(2131363653);
          this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)LayoutInflater.from(BaseApplicationImpl.getContext()).inflate(2131561930, null));
          RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, -2);
          localLayoutParams.addRule(12);
          localRelativeLayout.addView(this.jdField_a_of_type_AndroidViewViewGroup, localLayoutParams);
          this.jdField_a_of_type_AndroidViewViewGroup.setOnTouchListener(new bhpj(this));
        }
        if (this.jdField_a_of_type_Bgxg == null) {
          this.jdField_a_of_type_Bgxg = new bgxg(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity, this.jdField_a_of_type_AndroidViewViewGroup);
        }
        this.jdField_a_of_type_Bgxg.h();
        paramMessage = (Bundle)paramMessage.obj;
        this.jdField_a_of_type_Bgxg.a(paramMessage.getLong("id"), paramMessage.getString("type"), paramMessage.getString("callbackId"));
        continue;
        paramMessage = (Bundle)paramMessage.obj;
        if (this.jdField_a_of_type_Bgxg != null)
        {
          this.jdField_a_of_type_Bgxg.a(paramMessage.getLong("id"), paramMessage.getString("type"), paramMessage.getInt("status"), paramMessage.getString("callbackId"));
          continue;
          if (this.jdField_a_of_type_Bgxg != null)
          {
            paramMessage = (Bundle)paramMessage.obj;
            this.jdField_a_of_type_Bgxg.a(paramMessage.getString("callbackId"));
          }
        }
      }
    }
