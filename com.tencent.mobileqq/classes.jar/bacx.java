...
public class bacx
{
  ...
  private Animation.AnimationListener jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener = new bacy(this);
  ...
  public bacx(View paramView)
  {
    if (paramView != null)
    {
      this.jdField_a_of_type_AndroidViewView = paramView;
      this.jdField_a_of_type_Int = bhgr.a(this.jdField_a_of_type_AndroidViewView.getContext(), 15.0F);
