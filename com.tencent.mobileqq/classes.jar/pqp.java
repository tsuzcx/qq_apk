  ...
  extends pqj
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = pqp.class.getSimpleName();
  }
  
  public pqp(AppInterface paramAppInterface, EntityManager paramEntityManager, ExecutorService paramExecutorService, qfo paramqfo, Handler paramHandler)
  {
  ...
  public void a(long paramLong, byte[] paramArrayOfByte)
  {
    ...
    a(qfq.a("OidbSvc.0xbbe", 3006, 1, localReqBody.toByteArray()));
  }
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (qfq.a(paramFromServiceMsg, paramObject, (MessageMicro)localObject) != 0) {
          break label525;
        }
