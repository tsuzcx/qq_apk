...
public class bpej
  extends bpen
  implements DialogInterface.OnDismissListener, bpqs
{
  RelativeLayout jdField_a_of_type_AndroidWidgetRelativeLayout;
  bpqr jdField_a_of_type_Bpqr;
  LinkerSummaryView jdField_a_of_type_DovComTencentBizQqstoryTakevideoLinkerLinkerSummaryView;
  public Map<String, bpqt> a;
  private boolean jdField_a_of_type_Boolean;
  
  public bpej(@NonNull bpep parambpep)
  {
    super(parambpep);
  ...
  public static void a(String paramString, Context paramContext)
  {
    ...
    for (;;)
    {
      bcst.b(null, "dc00899", "grp_story", "", "video_edit", paramString, 0, 0, str, "", "", "");
      return;
  ...
  public bpqt a()
  {
    if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoLinkerLinkerSummaryView != null) {
      return this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoLinkerLinkerSummaryView.jdField_a_of_type_Bpqt;
    }
    return null;
  }
  ...
  public void a(int paramInt, @NonNull bpsf parambpsf)
  {
    ...
    if (localbpqt != null)
    {
      ...
      if (localbpqt.jdField_a_of_type_JavaLangString != null) {
        break label278;
      }
      localObject1 = "null";
      ...
      localObject1 = "null";
      label139:
      yqp.b("Q.qqstory.publish.editEditVideoLinker", (String)localObject1);
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoLinkerLinkerSummaryView == null) {
        break label350;
      }
      ...
      localObject2 = "null";
      label225:
      yqp.b("Q.qqstory.publish.editEditVideoLinker", (String)localObject2);
    }
    for (;;)
    {
      if (bool) {}
      for (localObject1 = wrb.a(localbpqt.jdField_a_of_type_JavaLangString, localbpqt.b, localbpqt.c, str, (String)localObject1);; localObject1 = wrb.a(localbpqt.jdField_a_of_type_JavaLangString, true, str, (String)localObject1))
      {
        parambpsf.a.setLinkInfo((wrb)localObject1);
        return;
        label278:
        localObject1 = localbpqt.jdField_a_of_type_JavaLangString;
        break;
        label288:
        localObject1 = localbpqt.b;
        break label87;
        label298:
        localObject1 = localbpqt.c;
        break label113;
        label308:
        localObject1 = localbpqt.d;
        break label139;
        label318:
  ...
  public void a(bpqt parambpqt)
  {
    ...
    if ((!TextUtils.isEmpty(str)) && (!this.jdField_a_of_type_JavaUtilMap.containsKey(str))) {
      this.jdField_a_of_type_JavaUtilMap.put(str, parambpqt);
    }
  }
  
  public void a(String paramString)
  {
    bpqt localbpqt2 = (bpqt)this.jdField_a_of_type_JavaUtilMap.get(paramString);
    bpqt localbpqt1 = localbpqt2;
    if (localbpqt2 == null) {
      localbpqt1 = new bpqt(paramString);
    }
    a("clk_added", a());
    d();
    yqu.a("video_shoot", "exp_linkbar", 1, 0, new String[] { "", "", "", "" });
    ...
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoLinkerLinkerSummaryView.setLinkerObject(localbpqt1);
    this.jdField_a_of_type_Bpep.a(Message.obtain(null, 15, 1, 0));
  }
  
  public void b(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Bpqr == null)
    {
      this.jdField_a_of_type_Bpqr = new bpqr(a());
      this.jdField_a_of_type_Bpqr.a(this);
    }
    Object localObject = a();
    if ((localObject != null) && (((bpqt)localObject).jdField_a_of_type_JavaLangString != null)) {}
    for (localObject = ((bpqt)localObject).jdField_a_of_type_JavaLangString;; localObject = null)
    {
      this.jdField_a_of_type_Bpqr.a((String)localObject);
      if ((!paramBoolean) && (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoLinkerLinkerSummaryView == null)) {
        bcst.b(null, "dc00899", "grp_story", "", "video_edit", "clk_linkbutton", 0, 0, "", "", "", "");
      }
      return;
    }
  }
  ...
  void d()
  {
    ...
    if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoLinkerLinkerSummaryView == null)
    {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)a(2131365635));
      if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null)
      {
        localLayoutParams = new RelativeLayout.LayoutParams(-1, -1);
        localLayoutParams.addRule(12, -1);
        localLayoutParams.setMargins(0, 0, 0, a().getDimensionPixelSize(2131298004) + afur.a(17.0F, a()));
        i = 0;
      }
    }
    for (;;)
    {
      ...
      {
        if (this.jdField_a_of_type_AndroidWidgetRelativeLayout.getChildAt(i).getId() == 2131365637)
        {
  ...
  public void f()
  {
    ...
    Looper.myQueue().addIdleHandler(new bpek(this));
  }
  ...
  public void j()
  {
    ...
    this.jdField_a_of_type_Bpep.a(Message.obtain(null, 15, 0, 0));
  }
