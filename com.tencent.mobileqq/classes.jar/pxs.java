...
public class pxs
{
    ...
    for (;;)
    {
      try
      {
        ...
        if (bmqa.a(paramInt))
        {
          ...
          localObject1 = (String)bmqa.a("DAILY_CHILD_FEEDS_REQUEST_CONFIG" + paramInt, "");
          ...
          if (bmqa.y()) {
            localJSONArray.put(bmqa.a());
          }
          localJSONArray.put(bmqa.b());
          return localJSONArray.toString();
        }
        Object localObject1 = ReadInJoyMMapKvStorage.getInstance().getValeForKey("KANDIAN_DAILY_SETTING_CONFIG");
        Object localObject3 = (String)bmqa.a("KANDIAN_DAILY_LCAOL_SETTING_CONFIG", "");
        if (TextUtils.isEmpty((CharSequence)localObject1)) {
          break label198;
        }
  ...
  public static pxs a(JSONObject paramJSONObject)
  {
    int j = 0;
    pxs localpxs = new pxs();
    if (paramJSONObject != null)
    {
      localpxs.jdField_a_of_type_JavaLangString = paramJSONObject.optString("key");
      localpxs.jdField_b_of_type_JavaLangString = paramJSONObject.optString("name");
      localpxs.d = paramJSONObject.optString("value");
      localpxs.c = paramJSONObject.optString("id");
      ...
      if (localObject != null)
      {
        ...
        while (i < ((JSONArray)localObject).length())
        {
          ...
          localpxs.jdField_b_of_type_JavaUtilList.add(str);
          i += 1;
        }
      }
      ...
      if (paramJSONObject != null)
      {
        ...
        while (i < paramJSONObject.length())
        {
          ...
          localpxs.jdField_a_of_type_JavaUtilList.add(localObject);
          i += 1;
        }
      }
    }
