...
public class akvd
  extends Handler
{
  public akvd(P2VEditMusicDialog paramP2VEditMusicDialog) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 2: 
      do
      {
        do
        {
          return;
          this.a.b();
          if (this.a.jdField_a_of_type_Yio != null)
          {
            this.a.jdField_a_of_type_Yio.a(this.a.jdField_a_of_type_JavaUtilArrayList);
            this.a.jdField_a_of_type_Yio.notifyDataSetChanged();
          }
          paramMessage = this.a.jdField_a_of_type_Akvf.a();
          if (this.a.jdField_a_of_type_Yio != null) {
            this.a.jdField_a_of_type_Yio.a(paramMessage);
          }
        ...
        return;
        if (!this.a.jdField_a_of_type_Akvf.c())
        {
          this.a.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(3);
          return;
        }
      ...
      this.a.jdField_a_of_type_Akvf.a(3);
      ...
      this.a.c();
      MusicHorizontalSeekView.a((this.a.a() + 500) / 1000, this.a.getContext().getResources().getDisplayMetrics().widthPixels - ViewUtils.dip2px(8.0F));
    ...
    case 11: 
      this.a.b();
      paramMessage = this.a.jdField_a_of_type_Yir;
      paramMessage.f = ((int)ShortVideoUtils.getDuration(paramMessage.g));
      if (paramMessage.d < 0) {
        paramMessage.d = 0;
      }
      ...
      paramMessage.e = (paramMessage.d + this.a.jdField_a_of_type_Int);
      this.a.jdField_a_of_type_Akvf.a(paramMessage);
      this.a.jdField_a_of_type_Akvf.a(3);
      this.a.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
      this.a.jdField_b_of_type_AndroidViewView.setVisibility(0);
      this.a.jdField_a_of_type_AndroidViewView.setVisibility(0);
    ...
    case 3: 
      this.a.b();
      this.a.jdField_a_of_type_Akvf.a(yir.jdField_a_of_type_Yir);
      this.a.jdField_a_of_type_Akvf.a(0);
      this.a.jdField_a_of_type_AndroidWidgetTextView.setText("");
      this.a.jdField_b_of_type_AndroidWidgetTextView.setText(amtj.a(2131706973));
      this.a.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
      this.a.jdField_a_of_type_AndroidViewView.setVisibility(8);
      return;
    case 6: 
      this.a.b();
      this.a.jdField_a_of_type_Akvf.a(yir.jdField_b_of_type_Yir);
      this.a.jdField_a_of_type_Akvf.a(1);
      this.a.jdField_a_of_type_AndroidWidgetTextView.setText("");
      this.a.jdField_b_of_type_AndroidWidgetTextView.setText(amtj.a(2131706972));
      this.a.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
      this.a.jdField_a_of_type_AndroidViewView.setVisibility(8);
    ...
    paramMessage = (yir)paramMessage.obj;
