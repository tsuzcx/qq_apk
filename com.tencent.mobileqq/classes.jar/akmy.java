...
public class akmy
{
  ...
  public static FullMessageSearchResult.SearchResultItem a(QQAppInterface paramQQAppInterface, aukn paramaukn, Cursor paramCursor, String paramString1, int paramInt, String paramString2, akmw paramakmw)
  {
    ...
    {
      if ((paramakmw.c == 3) || (paramakmw.c == 2)) {
        return null;
      }
    ...
    for (;;)
    {
      ...
      if (paramInt != 0)
      {
        ...
        {
          paramString1 = (MessageRecord)paramaukn.a(MessageRecord.class, null, paramCursor);
              ...
              if (bool)
              {
                ...
                if (TextUtils.isEmpty(paramString2))
                {
                  ...
                  if ((localObject instanceof AbsStructMsg))
                  {
                    ...
                    paramString1 = paramakmw.a;
                    paramaukn = paramQQAppInterface;
                    if (paramString1 == null) {
                      break;
                    }
