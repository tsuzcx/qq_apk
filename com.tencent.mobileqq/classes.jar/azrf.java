  ...
  extends BroadcastReceiver
{
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if (TextUtils.isEmpty(azre.a(this.a)))
    {
    ...
    for (;;)
    {
      ...
      {
        if (((String)paramContext.get(i)).equals(azre.a(this.a)))
        {
          azre.a(this.a, (String)paramIntent.get(i));
          j = 1;
        }
      }
      else
      {
        if ((j == 0) || (!azre.a(this.a))) {
          break;
        }
        azre.a(this.a, azre.b(this.a));
        return;
      }
      i += 1;
    }
