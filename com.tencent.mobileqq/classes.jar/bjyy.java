...
public class bjyy
  ...
  implements bjqx
{
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new bjyz(this);
        ...
        if (!TextUtils.isEmpty(str1))
        {
          ...
          if ((localObject != null) && (((JSONObject)localObject).optInt("videoType") == 0))
          {
            ...
            if (!TextUtils.isEmpty((CharSequence)localObject)) {
              this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getHandler(bjze.class).post(new QzoneUiJsPlugin.1(this, (String)localObject));
            }
          }
          ...
          if (bjfh.a().a() > 0)
          {
            bool1 = true;
            break label512;
            bjfd.a(paramString, "ref_h5_record_video", bool1, bool2, bool3, bool4, bool5, bool6, str1, str2, (Intent)localObject);
          }
        }
        else
        {
  ...
  private void b(String paramString)
  {
    ...
    bjfd.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), i, paramString, l2, localBundle);
    return;
    label201:
    if (i == 1) {
      bjdt.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), bjea.a(), i, paramString, l1, l1 + l2);
    }
  }
  ...
  private void c(String paramString)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getHandler(bjze.class).post(new QzoneUiJsPlugin.2(this, paramString));
      return;
    }
    catch (JSONException paramString)
    {
    ...
    try
    {
      ...
      if (!TextUtils.isEmpty(str))
      {
        ...
        if (!TextUtils.isEmpty(paramString)) {
          this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getHandler(bjze.class).post(new QzoneUiJsPlugin.3(this, paramString));
        }
      }
      return;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        if ("ptucamera".equals(paramString.optString("shoot")))
        {
          ...
          bjfd.a(0L, paramString, true, true, "QZonePublishMoodTabActivity", bool2, true, str, bool1, null, null, null);
          return;
        }
      }
      catch (JSONException paramString)
  ...
  public void onWebEvent(String paramString, Bundle paramBundle)
  {
    ...
    if (TextUtils.isEmpty(paramString)) {}
    for (paramString = "";; paramString = bjxu.a(paramString, i, j))
    {
