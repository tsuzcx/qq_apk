  ...
  implements bnym, bnyx
{
  ...
  public bkaj(boolean paramBoolean, bjvc parambjvc)
  {
  ...
  private void a()
  {
    ...
    while (((Iterator)localObject2).hasNext()) {
      ((JSONArray)localObject1).put(bkan.a((WadlResult)((Iterator)localObject2).next()));
    }
    localObject1 = ((JSONArray)localObject1).toString();
    localObject2 = this.jdField_a_of_type_Bjvc.getJsCallbackMethod();
  ...
  private void a(int paramInt, WadlParams paramWadlParams)
  {
    ...
    while (i != 0)
    {
      a(bkan.a(paramInt));
      return;
      bnyp.a().c(0, paramWadlParams.jdField_a_of_type_JavaLangString);
      i = j;
      continue;
      bnyp.a().a(0, paramWadlParams.jdField_a_of_type_JavaLangString);
  ...
  private void b(String paramString)
  {
    ...
    {
      return;
      bkad.c(jdField_a_of_type_JavaLangString, "doJsCallBack loadJs=" + paramString);
      try
      {
        WebView localWebView = this.jdField_a_of_type_Bjvc.getWebview();
      ...
      {
        bkad.a(jdField_a_of_type_JavaLangString, "doJsCallback exception", paramString);
      }
    }
  }
  ...
  public void a(WadlResult paramWadlResult)
  {
    ...
    {
      paramWadlResult = bkan.a(paramWadlResult).toString();
      str = this.jdField_a_of_type_Bjvc.getJsCallbackMethod();
  ...
  public void a(String paramString)
  {
    ...
    {
      bkad.a(jdField_a_of_type_JavaLangString, "showToast exception", paramString);
    }
  }
  ...
  {
    bkad.c(jdField_a_of_type_JavaLangString, "onCmdRsp cmd=" + paramString + ",isSucc");
  ...
  {
    bkad.c(jdField_a_of_type_JavaLangString, "onQueryCallback params:" + paramArrayList);
    ...
    if (paramArrayList != null) {
      try
      {
        ...
        {
          localJSONArray.put(bkan.a((WadlResult)paramArrayList.next()));
          continue;
          return;
        }
      }
      ...
      {
        bkad.a(jdField_a_of_type_JavaLangString, "onQueryCallback exception:" + paramArrayList.getMessage());
      }
    }
  ...
  {
    bkad.c(jdField_a_of_type_JavaLangString, "onQueryCallbackVia params:" + paramArrayList);
    JSONArray localJSONArray;
    if (paramArrayList != null) {
      try
      {
      ...
      {
        bkad.a(jdField_a_of_type_JavaLangString, "onQueryCallbackVia exception:" + paramArrayList.getMessage());
      }
    }
  ...
  public void onWadlTaskStatusChanged(WadlResult paramWadlResult)
  {
    ...
    {
      bkad.a(jdField_a_of_type_JavaLangString, "onWadlTaskStatusChanged error wadlResult is null");
      return;
    }
    WadlParams localWadlParams = paramWadlResult.a;
    String str = localWadlParams.jdField_a_of_type_JavaLangString;
    int i = bkan.a(paramWadlResult.b);
    bkai.b(localWadlParams.jdField_a_of_type_JavaLangString);
    bkad.c(jdField_a_of_type_JavaLangString, "onWadlTaskStatusChanged:" + paramWadlResult + ",localStatus:" + i);
    switch (i)
    {
    default: 
      bkad.a(jdField_a_of_type_JavaLangString, "download status not response!");
      return;
    case 3: 
    case 4: 
    case 6: 
    ...
    case -2: 
      ...
      bkad.a(jdField_a_of_type_JavaLangString, "onWadlTaskStatusChanged  error,wadlErrCode=" + i);
      c(str);
      a(i, localWadlParams);
      a(paramWadlResult);
      return;
