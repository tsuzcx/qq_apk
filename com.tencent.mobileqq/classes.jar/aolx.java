...
public class aolx
  extends akbg
{
  public aolx(Face2FaceAddFriendActivity paramFace2FaceAddFriendActivity) {}
  ...
  public void a(aonm paramaonm)
  {
    ...
    else if ((this.a.jdField_b_of_type_Int == 0) && (paramaonm != null) && (!this.a.jdField_b_of_type_JavaUtilList.contains(paramaonm)))
    {
      this.a.jdField_b_of_type_JavaUtilList.add(paramaonm);
      if (this.a.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() != this.a.jdField_d_of_type_JavaUtilList.size()) {
        break label162;
      }
      Face2FaceAddFriendActivity.a(this.a, paramaonm);
    }
    for (;;)
    {
      paramaonm = this.a;
      ...
      ((Message)localObject).obj = paramaonm;
  ...
  public void a(aonq paramaonq)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        if ((this.a.jdField_f_of_type_Long == 0L) || (l2 >= 1000L) || (paramaonq.a != 0L)) {
          break label269;
        }
        localObject = Message.obtain();
        ((Message)localObject).what = 16;
        ((Message)localObject).obj = paramaonq;
        l3 = 1000L - l2;
    ...
    } while ((this.a.jdField_b_of_type_Int != 1) || (this.a.jdField_a_of_type_JavaUtilList.contains(paramaonq)));
    label269:
    this.a.jdField_a_of_type_JavaUtilList.add(paramaonq);
    if ((this.a.l) && (this.a.jdField_a_of_type_Aonn != null))
    {
      this.a.jdField_a_of_type_AndroidWidgetTextView.setText(String.valueOf(this.a.jdField_a_of_type_JavaUtilList.size()));
      this.a.jdField_a_of_type_Aonn.a(paramaonq);
      return;
    }
    Face2FaceAddFriendActivity.a(this.a, paramaonq);
    this.a.e();
  }
  ...
  public void a(nearfield_group.BusiRespHead paramBusiRespHead, String paramString)
  {
    ...
    if (i == 0)
    {
      Iterator localIterator = this.a.jdField_a_of_type_Aomx.jdField_a_of_type_JavaUtilList.iterator();
      while (localIterator.hasNext())
      {
        ...
        if ((paramBusiRespHead != null) && (paramBusiRespHead.a() == 2) && (paramString.equals(paramBusiRespHead.b())))
        {
          ...
          if (!(paramBusiRespHead instanceof aonm)) {
            break label477;
          }
        }
      }
    ...
    label477:
    for (paramBusiRespHead = paramBusiRespHead.e + "_" + ((aonm)paramBusiRespHead).jdField_b_of_type_JavaLangString;; paramBusiRespHead = paramString)
    {
      this.a.jdField_a_of_type_Aomx.a(paramBusiRespHead);
      ...
      break;
      axqy.b(null, "P_CliOper", "Grp_set", "", "Radar_grp_guest", "suc_join", 0, 0, paramString, "8.3.0", "", this.a.app.getCurrentAccountUin());
      this.a.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceTroopDetailView.a(i, str, paramString, this.a.isFinishing());
      return;
    }
  }
  
  public void a(nearfield_group.BusiRespHead paramBusiRespHead, List<aonm> paramList)
  {
    boolean bool2 = false;
    int i;
    boolean bool1;
    if (paramList == null)
    {
      ...
      if (this.a.jdField_b_of_type_Int == 1) {
        bbdj.a(this.a, 230, this.a.getString(2131720260), ajya.a(2131704300), 2131690596, 2131692201, new aoly(this), null).show();
      }
    }
    label179:
    label185:
    do
    {
      ...
      for (;;)
      {
        ...
        {
          paramList = (aonp)paramBusiRespHead.next();
    ...
    label421:
    bbdj.a(this.a, 230, this.a.getString(2131720260), ajya.a(2131704293), 2131690596, 2131692201, new aolz(this), null).show();
  }
}
