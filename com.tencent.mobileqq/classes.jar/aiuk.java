...
public class aiuk
  implements ajfk, View.OnClickListener
{
  private aiuk(FriendCardApolloViewController paramFriendCardApolloViewController) {}
  ...
  public void a()
  {
    ...
    if ((localObject2 != null) && (((auuy)localObject2).jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne != null)) {}
    for (localObject1 = ((auuy)localObject2).jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a;; localObject1 = null)
    {
      if ((TextUtils.isEmpty((CharSequence)localObject1)) && (localObject2 != null) && (((auuy)localObject2).jdField_a_of_type_ComTencentMobileqqDataCard != null)) {}
      for (localObject2 = ((auuy)localObject2).jdField_a_of_type_ComTencentMobileqqDataCard.uin;; localObject2 = localObject1)
      {
        airx localairx = (airx)localQQAppInterface.getManager(153);
        localObject1 = localObject3;
        if (!FriendCardApolloViewController.a(this.a)) {
          localObject1 = localairx.a(localQQAppInterface, (String)localObject2, new int[] { 4 });
        }
        int i = 5;
        ...
        for (;;)
        {
          ajfh.a(FriendCardApolloViewController.a(this.a), i, (ApolloActionData)localObject1);
          new aixn((String)localObject2).a(FriendCardApolloViewController.a(this.a), localFriendProfileCardActivity, localQQAppInterface, ajya.a(2131704872));
          return;
          i = 12;
        }
      }
