  ...
  implements biny
{
  ...
  public static biny a(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("cooperation.qappcenter.remote.IServiceHandler");
    if ((localIInterface != null) && ((localIInterface instanceof biny))) {
      return (biny)localIInterface;
    }
    return new bioa(paramIBinder);
  }
