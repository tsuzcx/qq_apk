  ...
  implements aiec
{
  ...
  public static aiec a(IBinder paramIBinder)
  {
    ...
    if ((localIInterface != null) && ((localIInterface instanceof aiec))) {
      return (aiec)localIInterface;
    }
    return new aiee(paramIBinder);
  }
