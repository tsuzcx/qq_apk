...
{
  private static final String jdField_a_of_type_JavaLangString = amtj.a(2131712253);
  ...
  public sou(@NonNull Context paramContext, int paramInt)
  {
    super(paramContext, paramInt);
  }
  
  public sou(@NonNull Context paramContext, Runnable paramRunnable)
  {
    this(paramContext, 0);
  ...
  private SpannableString a()
  {
    ...
    localSpannableString.setSpan(new sov(this, Color.parseColor("#12B7F5")), i, "《QQ看点用户行为规范》".length() + i, 33);
  ...
  public static boolean a(BaseActivity paramBaseActivity, Runnable paramRunnable)
  {
    ...
    paramRunnable = new sou(paramBaseActivity, paramRunnable);
    paramRunnable.jdField_a_of_type_ComTencentMobileqqAppBaseActivity = paramBaseActivity;
    paramRunnable.show();
    odq.a(null, "", "0X800992C", "0X800992C", 0, 0, "", "", "", "");
    return false;
  }
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    paramBundle = LayoutInflater.from(getContext()).inflate(2131560165, null);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramBundle.findViewById(2131365104));
    this.jdField_a_of_type_AndroidWidgetTextView.setFocusable(false);
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)paramBundle.findViewById(2131362320));
    this.jdField_a_of_type_AndroidViewView = paramBundle.findViewById(2131364630);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(a());
    this.jdField_a_of_type_AndroidWidgetTextView.setMovementMethod(new sow());
    ...
    paramBundle.findViewById(2131363434).setBackgroundDrawable(localDrawable);
