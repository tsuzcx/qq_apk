...
public final class uak
{
  ...
  @JvmStatic
  @NotNull
  public final List<twm> a(@NotNull JSONArray paramJSONArray, @Nullable JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          localObject1 = (Integer)uai.a().get(localObject2);
          if (localObject1 == null) {
            break label334;
          }
          localArrayList.add(new twm((String)localObject2, ((Integer)localObject1).intValue(), false));
          break label334;
        }
        ...
        if ((TextUtils.isEmpty((CharSequence)localObject1)) || (uai.a().get(localObject1) == null)) {
          break label334;
        }
        ...
        localObject2 = (Integer)uai.a().get(localObject1);
      ...
      localArrayList.add(new txe((String)localObject1, j, bool, (String)localObject2));
      break label334;
      label245:
      return (List)localArrayList;
      label251:
    ...
    Object localObject2 = (Integer)uai.a().get(localObject1);
    if (localObject2 != null) {
      j = ((Integer)localObject2).intValue();
    }
    for (;;)
    {
      label300:
      localArrayList.add(new twm((String)localObject1, j, bool));
      break label334;
      j = 0;
      label334:
      label341:
  ...
  {
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(new twm("kandian", 13, false));
    localArrayList.add(new twm("qq_friend", 2, false));
    localArrayList.add(new twm("qzone", 3, false));
    localArrayList.add(new twm("we_chat", 9, false));
    localArrayList.add(new twm("we_chat_circle", 10, false));
    localArrayList.add(new twm("we_bo", 12, false));
    localArrayList.add(new twm("send_pc", 26, false));
    localArrayList.add(new twm("qq_browser", 5, false));
    localArrayList.add(new twm("sys_browser", 4, false));
    return (List)localArrayList;
  }
  
  @JvmStatic
  @NotNull
  public final List<twm> c()
  {
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(new twm("screen_shot", 21, false));
    localArrayList.add(new twm("set_font", 7, false));
    localArrayList.add(new twm("add_favourite", 6, false));
    localArrayList.add(new twm("copy_link", 1, false));
    localArrayList.add(new twm("report", 11, false));
    return (List)localArrayList;
  }
}
