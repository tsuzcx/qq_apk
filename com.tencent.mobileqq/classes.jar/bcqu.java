...
public class bcqu
{
  ...
  public static bcqu a(bcqu parambcqu)
  {
    if (parambcqu == null)
    {
    ...
    localbcqu.jdField_a_of_type_JavaLangString = parambcqu.jdField_a_of_type_JavaLangString;
    localbcqu.jdField_a_of_type_Int = parambcqu.jdField_a_of_type_Int;
    localbcqu.jdField_b_of_type_JavaLangString = parambcqu.jdField_b_of_type_JavaLangString;
    localbcqu.jdField_c_of_type_JavaLangString = parambcqu.jdField_c_of_type_JavaLangString;
    ArrayList localArrayList = new ArrayList();
    if (parambcqu.jdField_a_of_type_JavaUtilArrayList != null) {
      localArrayList.addAll(parambcqu.jdField_a_of_type_JavaUtilArrayList);
    }
    localbcqu.jdField_a_of_type_JavaUtilArrayList = localArrayList;
    localArrayList = new ArrayList();
    if (parambcqu.jdField_b_of_type_JavaUtilArrayList != null) {
      localArrayList.addAll(parambcqu.jdField_b_of_type_JavaUtilArrayList);
    }
    localbcqu.jdField_b_of_type_JavaUtilArrayList = localArrayList;
    localArrayList = new ArrayList();
    if (parambcqu.jdField_c_of_type_JavaUtilArrayList != null) {
      localArrayList.addAll(parambcqu.jdField_c_of_type_JavaUtilArrayList);
    }
    localbcqu.jdField_c_of_type_JavaUtilArrayList = localArrayList;
    localbcqu.jdField_a_of_type_JavaLangObject = parambcqu.jdField_a_of_type_JavaLangObject;
    localbcqu.jdField_b_of_type_Int = parambcqu.jdField_b_of_type_Int;
    localbcqu.jdField_a_of_type_Boolean = parambcqu.jdField_a_of_type_Boolean;
    localbcqu.jdField_b_of_type_Boolean = parambcqu.jdField_b_of_type_Boolean;
    localbcqu.jdField_c_of_type_Boolean = parambcqu.jdField_c_of_type_Boolean;
    localbcqu.d = parambcqu.d;
    return localbcqu;
  }
