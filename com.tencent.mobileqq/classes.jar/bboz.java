  ...
  implements WebEventListener
{
  ...
  private static void b(String paramString)
  {
    ...
    {
      jdField_a_of_type_ComTencentMobileqqAppSosoLbsManagerService$OnLocationChangeListener = new bbpa(paramString, false);
      try
      {
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    {
      bbnx.a(paramIntent, paramFromServiceMsg, (QQAppInterface)localObject, this);
      return;
    }
    bbnx.a((QQAppInterface)localObject, paramIntent, paramFromServiceMsg, this);
  }
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        Object localObject2 = (bbox)((QQAppInterface)localObject1).getManager(10);
        Object localObject3;
        if (localObject2 != null)
        {
          paramIntent = ((bbox)localObject2).a;
          if (paramIntent != null)
          {
            localObject3 = bbnx.a(paramIntent);
            ...
            if (j < i1)
            {
              ...
              localObject4 = (QZoneCountInfo)((bbox)localObject2).a.get(Integer.valueOf(i2));
            ...
            paramIntent = (QZoneCountInfo)((bbox)localObject2).a.get(Integer.valueOf(56));
            if (paramIntent != null)
            {
        ...
        for (;;)
        {
          ...
          paramIntent = bbnx.a(Long.valueOf(((QQAppInterface)localObject1).getCurrentAccountUin()).longValue(), null, m, n, i, k, localConcurrentHashMap1, paramIntent, localConcurrentHashMap2);
          if (paramIntent == null)
          {
            paramIntent = new byte[4];
            notifyObserver(null, 1000, false, new Bundle(), axkw.class);
          }
          for (;;)
          {
            a();
  ...
  public void onWebEvent(String paramString, Bundle paramBundle)
  {
    ...
    bbnx.a((QQAppInterface)paramString, i, paramBundle);
  }
  ...
  public void service(Intent paramIntent)
  {
    if (paramIntent.getAction().equals("Qzone_Refresh_UI"))
    {
      ...
      notifyObserver(null, 1000, true, paramIntent, axkw.class);
      if (QLog.isColorLevel()) {
