...
{
  public agoq(PhotoPreviewActivity paramPhotoPreviewActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if (this.a.jdField_b_of_type_JavaUtilArrayList.size() >= this.a.jdField_c_of_type_Int)
      {
        ...
        {
          bcql.a(this.a, this.a.a(), 1000).b(this.a.jdField_d_of_type_Int);
        ...
        for (i = 0;; i = 1)
        {
          vei.a("pic_choose_toast", "exp_tooMuch", i, 0, new String[] { "1" });
      ...
      if ((this.a.t >= 0) && (this.a.t < this.a.jdField_a_of_type_JavaUtilArrayList.size()))
      {
        ...
        {
          bcql.a(this.a, this.a.getResources().getString(2131719567), 0).b(this.a.getResources().getDimensionPixelSize(2131298865));
        ...
        if (this.a.jdField_e_of_type_Int == 2)
        {
          ...
          {
            bcql.a(this.a, this.a.getResources().getString(2131719589), 0).b(this.a.getResources().getDimensionPixelSize(2131298865));
            bbbx.d();
          }
        }
        while ((this.a.z) && (this.a.jdField_a_of_type_JavaUtilArrayList != null) && (this.a.t < this.a.jdField_a_of_type_JavaUtilArrayList.size()) && (this.a.t >= 0) && (this.a.t < this.a.jdField_a_of_type_JavaUtilArrayList.size()) && (this.a.t >= 0) && (this.a.a((String)localObject) == 1) && (!bbbx.a(this.a, PhotoPreviewActivity.a(this.a), localLocalMediaInfo1, this.a.k)))
        {
          this.a.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.setChecked(false);
          return;
          label936:
          if ((this.a.t < this.a.jdField_a_of_type_JavaUtilArrayList.size()) && (this.a.t >= 0) && (new File((String)this.a.jdField_a_of_type_JavaUtilArrayList.get(this.a.t)).length() > ayxe.a()))
          {
        ...
        if ((PhotoPreviewActivity.c(this.a)) && (this.a.t < this.a.jdField_a_of_type_JavaUtilArrayList.size()) && (this.a.t >= 0) && (!bkpv.a(this.a, localLocalMediaInfo1)))
        {
          this.a.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.setChecked(false);
          return;
        }
        if ((this.a.getIntent().getBooleanExtra("PhotoConst.IS_SEND_GIF_SIZE_LIMIT", false)) && (aupa.a((String)localObject)) && (bbdx.a((String)localObject) > 3145728L))
        {
          bcql.a(this.a, ajya.a(2131708137), 0).b(this.a.jdField_d_of_type_Int);
          this.a.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.setChecked(false);
          return;
        }
