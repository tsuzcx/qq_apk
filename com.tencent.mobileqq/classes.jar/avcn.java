...
public class avcn
{
  static ArrayList<WeakReference<avcn>> a;
  public static boolean a;
  public Context a;
  public ArrayMap<HotVideoData, avbz> a;
  boolean b = false;
  ...
  /* Error */
  public static avcn a(Context paramContext)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: iconst_0
    //   4: invokestatic 37	avcn:a	(Z)V
    //   7: aload_0
    //   8: ifnonnull +10 -> 18
    //   11: aconst_null
    //   12: astore_0
    ...
    //   21: dup
    //   22: aload_0
    //   23: invokespecial 39	avcn:<init>	(Landroid/content/Context;)V
    //   26: astore_1
    //   27: aload_1
    //   28: astore_0
    //   29: getstatic 21	avcn:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   32: invokevirtual 43	java/util/ArrayList:size	()I
    //   35: iconst_3
    //   36: if_icmpge -23 -> 13
    //   39: getstatic 21	avcn:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
      ...
      try
      {
        ...
        if (jdField_a_of_type_JavaUtilArrayList.size() < 3)
        {
          ...
          if (localIterator.hasNext())
          {
            ...
            if (localObject != null)
            {
              localObject = (avcn)((WeakReference)localObject).get();
              if ((localObject != null) && (paramavcn.equals(localObject)))
              {
                i = 1;
                if (i == 0) {
                  jdField_a_of_type_JavaUtilArrayList.add(new WeakReference(paramavcn));
                }
              }
            }
          }
  ...
  public static void a(boolean paramBoolean)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        localavcn = (avcn)localWeakReference.get();
      }
      finally {}
      avcn localavcn;
      if (localavcn == null) {
        localObject.add(localWeakReference);
      } else if ((paramBoolean) && (!localavcn.b)) {
        localavcn.a();
      }
    }
  }
  ...
  /* Error */
  public static void b(avcn paramavcn)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    ...
    //   13: monitorexit
    //   14: return
    //   15: getstatic 21	avcn:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   62: ifeq -40 -> 22
    //   65: getstatic 21	avcn:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   68: aload_2
  ...
  {
    if ((paramavbz == null) || (paramHotVideoData == null)) {
      return;
    }
    for (;;)
    {
      try
      {
        if (this.jdField_a_of_type_AndroidSupportV4UtilArrayMap.containsKey(paramHotVideoData))
        {
          ...
          this.jdField_a_of_type_AndroidSupportV4UtilArrayMap.setValueAt(i, paramavbz);
          if (QLog.isColorLevel()) {
      ...
      this.jdField_a_of_type_AndroidSupportV4UtilArrayMap.put(paramHotVideoData, paramavbz);
    }
  }
