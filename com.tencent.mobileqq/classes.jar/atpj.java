...
public class atpj
{
  ...
  public atpj(QQAppInterface paramQQAppInterface, auen paramauen, long paramLong)
  {
    ...
    Object localObject1 = (HashMap)paramauen.a().get("OnlinePreView");
    ...
    paramauen = (HashMap)paramauen.a().get("OfflineConfig");
    localObject1 = paramauen.keySet().iterator();
    while (((Iterator)localObject1).hasNext())
    {
      localObject2 = (String)((Iterator)localObject1).next();
      localObject3 = paramauen.get(localObject2);
  ...
  {
    long l1 = Long.parseLong(auea.c("OfflineConfigFlowSize"));
    try
    {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        new atpj(paramQQAppInterface, paramString, paramLong);
        localFile.delete();
        return;
      }
  ...
  {
    long l1 = Long.parseLong(auea.c("OfflineConfigFlowTime"));
    try
    {
  ...
  {
    long l1 = Long.parseLong(auea.c("OfflineConfigFtnThumbMaxSize"));
    try
    {
