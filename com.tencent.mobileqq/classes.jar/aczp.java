  ...
  implements aczn
{
  ...
  public aczp(HandlerThread paramHandlerThread)
  {
  ...
  public boolean a(ResultObject paramResultObject, aczo paramaczo)
  {
    ...
    if (localObject3 != null)
    {
      ...
      paramResultObject = new QCloudFileUploadRunnable(new URL((String)localObject1), (String)localObject2, localJSONObject, paramaczo, paramResultObject.dbId, this.jdField_a_of_type_MqqOsMqqHandler);
    ...
    else
    {
      ...
      paramResultObject = new JsonUploadRunnable(new URL((String)localObject1), localJSONObject, paramaczo, paramResultObject.dbId, this.jdField_a_of_type_MqqOsMqqHandler);
      this.jdField_a_of_type_MqqOsMqqHandler.post(paramResultObject);
    }
    return true;
  }
