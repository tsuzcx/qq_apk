...
public class ahas
{
  private static final String jdField_a_of_type_JavaLangString = ajyc.a(2131705431);
  private int jdField_a_of_type_Int = -1;
  private ahap jdField_a_of_type_Ahap = ahar.a(jdField_a_of_type_JavaLangString);
  private ajzf jdField_a_of_type_Ajzf;
  private AdapterView.OnItemClickListener jdField_a_of_type_AndroidWidgetAdapterView$OnItemClickListener = new ahav(this);
  private SendHbActivity jdField_a_of_type_ComTencentMobileqqActivityQwalletSendHbActivity;
  private IRedPacket.OnGetSkinListener jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketIRedPacket$OnGetSkinListener = new ahau(this);
  private QwAdapter jdField_a_of_type_CooperationQwalletPluginQwAdapter;
  List<ahaz> jdField_a_of_type_JavaUtilList = new ArrayList();
  private BusinessObserver jdField_a_of_type_MqqObserverBusinessObserver = new ahat(this);
  private boolean jdField_a_of_type_Boolean;
  private int jdField_b_of_type_Int = -1;
  private List<ahap> jdField_b_of_type_JavaUtilList = new ArrayList();
  private boolean jdField_b_of_type_Boolean;
  private List<LinearLayout> c = new ArrayList();
  
  public ahas(SendHbActivity paramSendHbActivity)
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletSendHbActivity = paramSendHbActivity;
    d();
  }
  
  private void a(List<ahap> paramList)
  {
    paramList.add(ahar.b(jdField_a_of_type_JavaLangString));
    if ((b()) && (!paramList.contains(this.jdField_a_of_type_Ahap)))
    {
      QLog.d("HbSkinLogic", 2, "add vip info to list!");
      paramList.add(this.jdField_a_of_type_Ahap);
    }
  }
  
  private void b(List<ahap> paramList)
  {
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      SkinInfo localSkinInfo = ((ahap)paramList.next()).jdField_a_of_type_WalletSkinInfo;
      ...
      localRedPacketInfoBase.isCache = ahap.jdField_a_of_type_Boolean;
  ...
  private boolean b()
  {
    if (this.jdField_a_of_type_Ajzf != null) {
      return this.jdField_a_of_type_Ajzf.a();
    }
    return false;
  }
  ...
  private void d()
  {
    ...
    a(localArrayList);
    this.jdField_a_of_type_CooperationQwalletPluginQwAdapter = new QwAdapter(this.jdField_a_of_type_ComTencentMobileqqActivityQwalletSendHbActivity, localArrayList, 2131560209, new ahay(this));
    this.jdField_a_of_type_Ajzf = ((ajzf)this.jdField_a_of_type_ComTencentMobileqqActivityQwalletSendHbActivity.getAppRuntime().getManager(131));
  ...
  public int a()
  {
    return ahap.a(this.jdField_a_of_type_CooperationQwalletPluginQwAdapter.getList());
  }
  ...
  public void a(ahaz paramahaz)
  {
    this.jdField_a_of_type_JavaUtilList.add(paramahaz);
  }
  ...
  public void a(LinearLayout paramLinearLayout)
  {
    ...
    LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(-1, actn.a(226.0F, this.jdField_a_of_type_ComTencentMobileqqActivityQwalletSendHbActivity.getResources()));
    ...
    localHorizontalListView.setDividerWidth(actn.a(12.0F, this.jdField_a_of_type_ComTencentMobileqqActivityQwalletSendHbActivity.getResources()));
  ...
  public void b()
  {
    ...
    if (-2 != i)
    {
      ...
      if (this.jdField_a_of_type_Ajzf != null) {
        this.jdField_a_of_type_Ajzf.a(0, 0, true);
      }
    }
  }
  ...
  public void c()
  {
    ...
    if (b()) {
      if (!localList.contains(this.jdField_a_of_type_Ahap))
      {
        QLog.d("HbSkinLogic", 2, "add vip info to list!");
        localList.add(this.jdField_a_of_type_Ahap);
        ahap.c = this.jdField_a_of_type_Ahap.jdField_a_of_type_WalletSkinInfo.skin_id;
        ahap.a(localList);
        this.jdField_a_of_type_CooperationQwalletPluginQwAdapter.notifyDataSetChanged();
      }
    }
    while (!localList.contains(this.jdField_a_of_type_Ahap)) {
      return;
    }
    QLog.d("HbSkinLogic", 2, "remove vip info to list!");
    localList.remove(this.jdField_a_of_type_Ahap);
    ahap.c = 0;
    ahap.a(localList);
    this.jdField_a_of_type_CooperationQwalletPluginQwAdapter.notifyDataSetChanged();
  }
