...
public class arsd
  implements AdapterView.OnItemClickListener, aryp
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajed.aU + "TempMail" + File.separator;
    j = ajjy.a(2131634327);
    jdField_b_of_type_JavaLangString = "0X8007F0A ";
  }
  
  public arsd(QQAppInterface paramQQAppInterface, Context paramContext, Activity paramActivity, BaseChatPie paramBaseChatPie, MqqHandler paramMqqHandler)
  {
  ...
  {
    URL localURL = axwd.a(paramMessageForPic, 131075);
    if (axoa.a(localURL.toString()) != null) {
      return axoa.d(localURL.toString());
    }
    localURL = axwd.a(paramMessageForPic, 1);
    if (axoa.a(localURL.toString()) != null) {
      return axoa.d(localURL.toString());
    }
    paramMessageForPic = axwd.a(paramMessageForPic, 65537);
    if (axoa.a(paramMessageForPic.toString()) != null) {
      return axoa.d(paramMessageForPic.toString());
    }
    return null;
  }
  ...
  public static String a(MessageForPic paramMessageForPic, List<String> paramList1, List<String> paramList2)
  {
    ...
    paramMessageForPic = "";
    if (str2.indexOf(".") == -1) {
      paramMessageForPic = bace.b(str1);
    }
    paramMessageForPic = ajjy.a(2131634331) + paramList1.size() + "." + paramMessageForPic;
    paramList1 = paramMessageForPic + ajjy.a(2131634326);
      ...
      if (paramMessageForStructing == null)
      {
        ...
        if (((StructMsgForGeneralShare)localObject2).mStructMsgItemLists != null)
        {
          ...
          for (;;)
          {
            ...
            {
              localObject3 = (awxe)localObject3;
              localObject1 = paramMessageForStructing;
              if (((awxe)localObject3).a != null)
              {
                localObject3 = ((awxe)localObject3).a.iterator();
                for (;;)
                {
                  localObject1 = paramMessageForStructing;
                  ...
                  if ((localObject1 instanceof awzf)) {
                    paramMessageForStructing = ((awzf)localObject1).Y;
                  }
                }
              }
            }
  ...
  public void a(Map<String, String> paramMap, ArrayList<ChatMessage> paramArrayList)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          paramArrayList = Intent.createChooser((Intent)paramMap.remove(0), ajjy.a(2131634325));
    ...
    this.jdField_a_of_type_AndroidContentContext.startActivity(Intent.createChooser(localIntent, ajjy.a(2131634323)));
  }
  ...
  public void a(Map<String, String> paramMap, ArrayList<ChatMessage> paramArrayList, Intent paramIntent)
  {
    ...
    //   19: ifne +725 -> 744
    //   22: aload_0
    //   23: getfield 103	arsd:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   26: ldc_w 415
    ...
    //   37: iconst_0
    //   38: aload_0
    //   39: getfield 101	arsd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   42: aload 6
    //   44: getfield 421	com/tencent/mobileqq/data/ChatMessage:selfuin	Ljava/lang/String;
    //   47: invokestatic 426	babh:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;)Ljava/lang/String;
    //   50: aastore
    //   51: dup
    //   52: iconst_1
    //   53: aload_0
    //   54: getfield 101	arsd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   57: aload 6
    //   59: getfield 429	com/tencent/mobileqq/data/ChatMessage:frienduin	Ljava/lang/String;
    //   62: invokestatic 426	babh:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;)Ljava/lang/String;
    //   65: aastore
    ...
    //   80: pop
    //   81: getstatic 56	arsd:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   84: iconst_1
    //   85: invokestatic 438	bace:a	(Ljava/lang/String;Z)V
    //   88: new 47	java/io/File
    //   91: dup
    //   92: getstatic 56	arsd:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   165: getstatic 56	arsd:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   168: invokevirtual 43	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   171: getstatic 64	arsd:j	Ljava/lang/String;
    ...
    //   180: invokestatic 448	bace:a	(Ljava/lang/String;)Ljava/io/File;
    //   183: pop
    ...
    //   199: getstatic 56	arsd:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   202: invokevirtual 43	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   205: getstatic 64	arsd:j	Ljava/lang/String;
    ...
    //   442: astore 7
    //   444: aload 5
    //   446: invokestatic 521	axku:a	(Ljava/lang/String;)Z
    //   449: ifeq +1189 -> 1638
    //   452: aload 5
    //   454: invokestatic 522	axku:d	(Ljava/lang/String;)Ljava/lang/String;
    //   457: astore 7
    //   459: goto +1179 -> 1638
    //   462: aload 6
    //   464: astore 7
    ...
    //   753: aload_0
    //   754: getfield 103	arsd:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   757: ldc_w 547
    ...
    //   768: iconst_0
    //   769: aload_0
    //   770: getfield 101	arsd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   773: aload 6
    //   775: getfield 429	com/tencent/mobileqq/data/ChatMessage:frienduin	Ljava/lang/String;
    //   778: invokestatic 549	babh:g	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;)Ljava/lang/String;
    //   781: aastore
    ...
    //   801: aload_0
    //   802: getfield 103	arsd:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   805: ldc_w 547
    ...
    //   816: iconst_0
    //   817: aload_0
    //   818: getfield 101	arsd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   821: aload_0
    //   822: getfield 101	arsd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   833: invokestatic 558	babh:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    //   836: aastore
    ...
    //   868: aload 12
    //   870: aload 13
    //   872: invokestatic 563	arsd:a	(Lcom/tencent/mobileqq/data/MessageForPic;Ljava/util/List;Ljava/util/List;)Ljava/lang/String;
    //   875: astore 5
    //   877: goto -415 -> 462
    //   880: aload 16
    //   882: instanceof 565
    ...
    //   951: ldc_w 574
    //   954: invokestatic 62	ajjy:a	(I)Ljava/lang/String;
    ...
    //   993: ldc_w 577
    //   996: invokestatic 62	ajjy:a	(I)Ljava/lang/String;
    ...
    //   1111: ldc_w 595
    //   1114: invokestatic 62	ajjy:a	(I)Ljava/lang/String;
    //   1117: astore 5
    //   1119: goto -657 -> 462
    //   1122: ldc_w 597
    //   1125: aload 7
    ...
    //   1136: ifeq +14 -> 1150
    //   1139: ldc_w 603
    //   1142: invokestatic 62	ajjy:a	(I)Ljava/lang/String;
    //   1145: astore 5
    //   1147: goto -41 -> 1106
    //   1150: aload 7
    ...
    //   1163: aload_0
    //   1164: aload 7
    //   1166: invokevirtual 608	arsd:a	(Lcom/tencent/mobileqq/data/MessageForStructing;)Ljava/lang/String;
    //   1169: astore 5
    //   1171: goto -65 -> 1106
    //   1174: aload 7
    ...
    //   1277: aload_1
    //   1278: aload_0
    //   1279: getstatic 64	arsd:j	Ljava/lang/String;
    //   1282: invokevirtual 630	arsd:a	(Ljava/lang/String;)Landroid/net/Uri;
    ...
    //   1336: getstatic 56	arsd:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   1367: invokestatic 637	bace:d	(Ljava/lang/String;Ljava/lang/String;)Z
    //   1370: ifeq -63 -> 1307
    //   1373: aload_1
    //   1374: aload_0
    //   1375: aload 13
    ...
    //   1394: invokevirtual 630	arsd:a	(Ljava/lang/String;)Landroid/net/Uri;
    ...
    //   1512: getstatic 56	arsd:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   1543: invokestatic 637	bace:d	(Ljava/lang/String;Ljava/lang/String;)Z
    //   1546: ifeq -63 -> 1483
    //   1549: aload_1
    //   1550: aload_0
    //   1551: aload 11
    ...
    //   1570: invokevirtual 630	arsd:a	(Ljava/lang/String;)Landroid/net/Uri;
  ...
  public boolean a()
  {
    Iterator localIterator = arxu.a().a.entrySet().iterator();
    boolean bool2 = false;
    if (localIterator.hasNext())
    {
      ...
      if (((Boolean)((Map.Entry)localObject).getValue()).booleanValue())
      {
        ...
        bool2 |= ajhz.a((MessageRecord)localObject);
        if (akbp.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)localObject)) {}
      }
    }
    while (bool2)
    {
      ...
      do
      {
        do
        {
          ...
          localObject = azjg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForTroopFile)localObject);
        } while (localObject == null);
        bool1 = bool2;
        if (((ayqd)localObject).jdField_b_of_type_Int == 8) {
          break;
        }
        bool1 = bool2;
        if (((ayqd)localObject).jdField_b_of_type_Int == 9) {
          break;
        }
        bool1 = bool2;
        if (((ayqd)localObject).jdField_b_of_type_Int == 6) {
          break;
        }
        bool1 = bool2;
        if (((ayqd)localObject).jdField_b_of_type_Int == 7) {
          break;
        }
        if (((ayqd)localObject).jdField_b_of_type_Int == 11)
        {
          bool1 = bool2;
          if (apdh.a(((ayqd)localObject).jdField_a_of_type_JavaLangString)) {
            break;
          }
        }
      } while (((ayqd)localObject).jdField_b_of_type_Int != 10);
      boolean bool1 = bool2;
      bool2 = bool1;
      break;
    }
  ...
  {
    if (((paramChatMessage instanceof MessageForPic)) && (ajhz.a(paramChatMessage))) {
      return false;
    }
    ...
    else if (((paramChatMessage instanceof MessageForPic)) && (aeor.a((MessageForPic)paramChatMessage)))
    {
      return false;
    }
    return akbp.a(paramChatMessage);
  }
  ...
  public List<bahx>[] a(Context paramContext)
  {
    ...
    for (int m = 1;; m = 0)
    {
      ...
      ((bahx)localObject).jdField_a_of_type_JavaLangString = paramContext.getString(2131630989);
      ((bahx)localObject).jdField_b_of_type_Int = 2130839018;
      ((bahx)localObject).c = 25;
      ((bahx)localObject).jdField_b_of_type_JavaLangString = "";
      localArrayList.add(localObject);
      if (this.jdField_a_of_type_Boolean)
      {
        localObject = new bahx();
        ((bahx)localObject).jdField_a_of_type_JavaLangString = paramContext.getString(2131627272);
        ((bahx)localObject).jdField_b_of_type_Int = 2130839594;
        ((bahx)localObject).c = 50;
        ((bahx)localObject).jdField_b_of_type_JavaLangString = "";
        localArrayList.add(localObject);
      }
      ...
      {
        localbahx = new bahx();
        localbahx.jdField_a_of_type_JavaLangString = paramContext.getString(2131630991);
        localbahx.jdField_b_of_type_Int = 2130839051;
      ...
      {
        localbahx = new bahx();
        localbahx.jdField_a_of_type_JavaLangString = paramContext.getString(2131631006);
        localbahx.jdField_b_of_type_Int = 2130839184;
        localbahx.jdField_b_of_type_Boolean = true;
        localbahx.c = 27;
        localbahx.jdField_b_of_type_JavaLangString = "";
        ((ArrayList)localObject).add(localbahx);
      ...
      localbahx.jdField_a_of_type_JavaLangString = paramContext.getString(2131630987);
      ...
      ((ArrayList)localObject).add(localbahx);
      localbahx = new bahx();
      localbahx.jdField_a_of_type_JavaLangString = paramContext.getString(2131630982);
      localbahx.jdField_b_of_type_Int = 2130839561;
      localbahx.jdField_b_of_type_Boolean = true;
      localbahx.c = 47;
      localbahx.jdField_b_of_type_JavaLangString = "";
      ((ArrayList)localObject).add(localbahx);
  ...
  public void b()
  {
    Iterator localIterator = arxu.a().a().iterator();
    ...
    } while ((!(localChatMessage instanceof MessageForPic)) || (bado.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForPic)localChatMessage, false)));
    for (boolean bool = true;; bool = false)
    {
      if ((this.jdField_a_of_type_Bahv == null) || (this.jdField_a_of_type_Boolean != bool))
      {
        this.jdField_a_of_type_Boolean = bool;
        this.jdField_a_of_type_Bahv = new bahv(this.jdField_a_of_type_AndroidAppActivity);
        int k = DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 4.0F);
        int m = this.jdField_a_of_type_Bahv.b();
        this.jdField_a_of_type_Bahv.c(Math.max(k, m));
  ...
  public void b(Map<String, String> paramMap, ArrayList<ChatMessage> paramArrayList)
  {
    ...
    if (k < paramArrayList.size())
    {
      ...
      for (;;)
      {
        ...
        {
          localObject1 = ajjy.a(2131634324);
        }
        else if ((localChatMessage instanceof MessageForShortVideo))
        {
          localObject1 = ajjy.a(2131634328);
        }
        else
        {
    ...
    for (;;)
    {
      ...
      localObject1 = ajjy.a(2131634330);
      break;
      ...
      else
      {
        ...
        if (((MessageForStructing)localObject1).structingMsg.mMsgUrl != null)
        {
          ...
          if (((localChatMessage instanceof MessageForArkFlashChat)) && (localChatMessage.msg != null))
          {
            ...
            bbmy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131628804, 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a());
            return;
          }
          localObject1 = null;
          break;
  ...
  public boolean b()
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      if (((Boolean)((Map.Entry)localObject).getValue()).booleanValue())
      {
        localObject = (ChatMessage)((Map.Entry)localObject).getKey();
        bool2 |= ajhz.a((MessageRecord)localObject);
        if (akbp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)localObject)) {}
      }
    }
    while (bool2)
    {
      ...
      do
      {
        ...
        localObject = (MessageForTroopFile)localObject;
      } while (azjg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForTroopFile)localObject) == null);
      boolean bool1 = bool2;
      bool2 = bool1;
      break;
    }
  ...
  public boolean b(ChatMessage paramChatMessage)
  {
    ...
    if (((paramChatMessage instanceof MessageForPic)) && (aeor.a((MessageForPic)paramChatMessage))) {
      return false;
    }
    return akbp.a(paramChatMessage);
  }
  ...
  public boolean c()
  {
    ...
    Object localObject1 = arxu.a().a();
    if (((List)localObject1).size() == 0)
    {
      bbmy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131632729, 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a());
      return false;
    }
    ...
    if (localArrayList1.size() > 0)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        azjg.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)localObject2);
      }
    }
    ...
    if (localArrayList2.size() > 0)
    {
      ...
      localObject2 = apck.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForFile)localObject1);
      if (localObject2 == null)
      {
        apcb.a(2131627029);
        return false;
      ...
      apck.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)localObject1, BaseActivity.sTopActivity);
    }
    while ((localArrayList1.size() == 0) && (localArrayList2.size() == 0))
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        apck.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)localObject2, BaseActivity.sTopActivity);
      }
    }
    return true;
  }
  ...
  public boolean e()
  {
    ...
    {
      bbmy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131628798, 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a());
      return false;
    }
    ((acxp)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(1)).a(localList, 3);
    return true;
  }
  ...
  public boolean g()
  {
    ...
    if (localList.isEmpty())
    {
      bbmy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131628803, 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a());
      return false;
    }
    ((acxp)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(1)).a(localList, 4);
    return true;
  }
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    do
    {
      ...
      default: 
        return;
      case 9: 
        awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", e, e, 0, 0, "", "", "", "");
        paramInt = -1;
        ...
        while (paramInt != -1)
        {
          bbmy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_AndroidContentContext.getString(paramInt), 0).a();
          return;
        ...
        if (this.jdField_a_of_type_Bbsh != null) {
          this.jdField_a_of_type_Bbsh = new arse(this);
        }
        WXShareHelper.a().a(this.jdField_a_of_type_Bbsh);
        ((acxp)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(1)).a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Acka, true);
        return;
      case 25: 
        awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", f, f, 0, 0, "", "", "", "");
        if (!d())
        {
          babr.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage(this.jdField_a_of_type_AndroidContentContext.getString(2131628796)).setPositiveButton(17039370, new arsi(this)).setNegativeButton(17039360, new arsh(this)).show();
          return;
        }
        break;
      }
    } while ((arxu.a().a().isEmpty()) || (!e()));
    this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(false, null, false);
    return;
    awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", i, i, 0, 0, "", "", "", "");
    paramView = arxu.a().a();
    ...
    if (paramView.hasNext())
    {
      ...
      {
        if (bado.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForPic)localObject1, false)) {
          break label1178;
        }
    ...
    for (;;)
    {
      ...
      int k = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a;
      if (paramInt != 0) {
        bbmy.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidContentContext.getString(2131653001), 0).a();
      }
      apto.a(this.jdField_a_of_type_AndroidAppActivity, paramView, (String)localObject1, (String)localObject2, k, paramAdapterView, 102);
      return;
      if (!b())
      {
        babr.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage(this.jdField_a_of_type_AndroidContentContext.getString(2131628807)).setPositiveButton(17039370, new arsk(this)).setNegativeButton(17039360, new arsj(this)).show();
        return;
      }
      awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80067F7", "0X80067F7", 0, 0, "", "", "", "");
      if (!c()) {
        break;
      }
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(false, null, false);
      return;
      awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", g, g, 0, 0, "", "", "", "");
      if (!a())
      {
        babr.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage(this.jdField_a_of_type_AndroidContentContext.getString(2131628805)).setPositiveButton(17039370, new arsm(this)).setNegativeButton(17039360, new arsl(this)).show();
        return;
      }
      if (!bgtr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(), this.jdField_a_of_type_MqqOsMqqHandler)) {
        break;
      }
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(false, null, false);
      return;
      awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", h, h, 0, 0, "", "", "", "");
      if (!f())
      {
        babr.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage(this.jdField_a_of_type_AndroidContentContext.getString(2131628802)).setPositiveButton(17039370, new arso(this)).setNegativeButton(17039360, new arsn(this)).show();
        return;
      }
      if ((arxu.a().a().isEmpty()) || (!g())) {
        break;
      }
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(false, null, false);
      return;
      paramAdapterView = new aryh(this.jdField_a_of_type_AndroidAppActivity);
      paramView = (aryq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(324);
      if ((paramView == null) || (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie == null) || (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Acka == null)) {
        break;
      }
      localObject1 = new ArrayList();
      localObject2 = arxu.a().a.entrySet().iterator();
      while (((Iterator)localObject2).hasNext())
      {
      ...
      localObject1 = aryl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (List)localObject1, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Acka.a, this);
      if ((localObject1 == null) || (((List)localObject1).isEmpty()))
      {
        bbmy.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidContentContext.getString(2131653000), 0).a();
        return;
      }
      paramView.a(new arsf(this, paramAdapterView, paramView, (List)localObject1));
