  ...
  extends MSFServlet
{
  ...
  static
  {
    ...
    int[] arrayOfInt6 = { -1, 219 };
    int[] arrayOfInt7 = { -1, 350 };
    int[] arrayOfInt8 = { -1, 356 };
    jdField_a_of_type_Array2dOfInt = new int[][] { localObject, arrayOfInt1, arrayOfInt2, { 2131427349, -151 }, arrayOfInt3, arrayOfInt4, arrayOfInt5, { 2131427361, 317 }, { 2131427363, 318 }, arrayOfInt6, arrayOfInt7, arrayOfInt8, { -1, 366 } };
    ...
    if (i < j)
    {
      ...
      int m = arrayOfInt1[1];
      if (k != -1) {
        jdField_a_of_type_AndroidUtilSparseIntArray.put(wnu.a(k), m);
      }
      for (;;)
      {
        i += 1;
    ...
    wnx.a(jdField_a_of_type_AndroidUtilSparseIntArray);
  }
  ...
  private void a(QQAppInterface paramQQAppInterface, Intent paramIntent, Packet paramPacket)
  {
    ...
    boolean bool = bhsi.b(paramQQAppInterface.getApp(), "Q.qqstory.config.QQStoryConfigServlet");
    ArrayList localArrayList2 = new ArrayList(k);
    int i = 0;
    if (i < k)
    {
      int m = jdField_a_of_type_AndroidUtilSparseIntArray.keyAt(i);
      String str = wta.a(jdField_a_of_type_AndroidUtilSparseIntArray.valueAt(i));
      ConfigurationService.ConfigSeq localConfigSeq = new ConfigurationService.ConfigSeq();
      localConfigSeq.type.set(m);
      int j = 0;
      if (bool) {
        bhsi.b(paramQQAppInterface.getApp(), str, paramIntent);
      }
      for (;;)
      {
        ...
        i += 1;
        break;
        j = bhsi.a(paramQQAppInterface.getApp(), str, paramIntent);
      }
    }
    if (bool) {
      bhsi.g(paramQQAppInterface.getApp(), "Q.qqstory.config.QQStoryConfigServlet");
    }
    if (QLog.isColorLevel())
    {
    ...
    yuk.b("Q.qqstory.config.QQStoryConfigServlet", "addAllConfigs");
    if (paramQQAppInterface == null) {
      yuk.b("Q.qqstory.config.QQStoryConfigServlet", "lbsInfo is null.");
    }
    for (;;)
    {
      ...
      {
        yuk.b("Q.qqstory.config.QQStoryConfigServlet", "lbsInfo.location is null.");
      }
      else if (TextUtils.isEmpty(paramQQAppInterface.a.f))
      {
        yuk.b("Q.qqstory.config.QQStoryConfigServlet", "lbsInfo.location.cityCode is null");
      }
      else
      {
        yuk.a("Q.qqstory.config.QQStoryConfigServlet", "adcode:%s", paramQQAppInterface.a.f);
  ...
  {
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApp(), arsd.class);
  ...
  private void a(ConfigurationService.RespGetConfig paramRespGetConfig, QQAppInterface paramQQAppInterface, Intent paramIntent, boolean paramBoolean)
  {
    ...
    if (i < j)
    {
      ...
      for (;;)
      {
        ...
        if (localConfig.type.has())
        {
          ...
          yuk.a("Q.qqstory.config.QQStoryConfigServlet", "receiveAllConfigs|receive type: %d, localConfigId: %d, length: %d", Integer.valueOf(k), Integer.valueOf(m), Integer.valueOf(j));
          String str1 = paramIntent.getStringExtra("key_uin");
          String str2 = wta.a(m);
          int n = bhsi.a(paramQQAppInterface.getApp(), str2, str1);
          String str3 = arry.a(localConfig, n, m);
          if (localConfig.content_list.size() > 0) {
            yuk.a("Q.qqstory.config.QQStoryConfigServlet", "%d --> %s", Integer.valueOf(m), (String)localConfig.content_list.get(0));
          }
          yuk.a("Q.qqstory.config.QQStoryConfigServlet", "%d ---> %s", Integer.valueOf(m), str3);
          paramBoolean = localwta.a(m, paramIntent, localConfig);
          if (paramBoolean) {
            bhsi.a(paramQQAppInterface.getApp(), str2, str1, localConfig.version.get());
          }
          yuk.b("Q.qqstory.config.QQStoryConfigServlet", "receiveAllConfigs|receive type: %d, localConfigId: %d, length: %d, localVersion:%d, newVersion: %d, handled: %b", new Object[] { Integer.valueOf(k), Integer.valueOf(m), Integer.valueOf(j), Integer.valueOf(n), Integer.valueOf(localConfig.version.get()), Boolean.valueOf(paramBoolean) });
        }
      }
    }
    ...
    while (paramRespGetConfig.hasNext())
    {
      ...
      default: 
        break;
      case 243: 
        ((wja)paramQQAppInterface.a(98)).notifyUI(1021, true, null);
      }
    }
  }
  ...
  public void onReceive(Intent paramIntent, com.tencent.qphone.base.remote.FromServiceMsg paramFromServiceMsg)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 433	arsd:getAppRuntime	()Lmqq/app/AppRuntime;
    ...
    //   13: istore 5
    //   15: getstatic 30	arsd:jdField_a_of_type_AndroidUtilSparseIntArray	Landroid/util/SparseIntArray;
    //   18: invokevirtual 63	android/util/SparseIntArray:size	()I
    //   21: ifne +10 -> 31
    //   24: aload_0
    //   25: aload_1
    //   26: iconst_0
    //   27: invokestatic 441	wnx:a	(Lmqq/app/MSFServlet;Landroid/content/Intent;Z)V
    //   30: return
    //   31: invokestatic 127	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   34: ifeq +73 -> 107
    //   37: getstatic 30	arsd:jdField_a_of_type_AndroidUtilSparseIntArray	Landroid/util/SparseIntArray;
    //   40: invokevirtual 63	android/util/SparseIntArray:size	()I
    //   43: istore 4
    //   45: iconst_0
    //   46: istore_3
    //   47: iload_3
    //   48: getstatic 30	arsd:jdField_a_of_type_AndroidUtilSparseIntArray	Landroid/util/SparseIntArray;
    ...
    //   73: getstatic 30	arsd:jdField_a_of_type_AndroidUtilSparseIntArray	Landroid/util/SparseIntArray;
    //   76: iload_3
    ...
    //   141: aload_1
    //   142: iconst_0
    //   143: invokestatic 441	wnx:a	(Lmqq/app/MSFServlet;Landroid/content/Intent;Z)V
    //   146: return
    //   147: aload_2
    //   148: aload 7
    //   150: invokestatic 450	arsd:a	([B)[B
    ...
    //   180: aload_1
    //   181: iload 5
    //   183: invokespecial 460	arsd:a	(Lcom/tencent/mobileqq/config/struct/splashproto/ConfigurationService$RespGetConfig;Lcom/tencent/mobileqq/app/QQAppInterface;Landroid/content/Intent;Z)V
    //   186: aload_0
    //   187: aload_1
    //   188: iconst_1
    //   189: invokestatic 441	wnx:a	(Lmqq/app/MSFServlet;Landroid/content/Intent;Z)V
    //   192: return
    //   193: astore_2
    ...
    //   234: aload_1
    //   235: iconst_0
    //   236: invokestatic 441	wnx:a	(Lmqq/app/MSFServlet;Landroid/content/Intent;Z)V
    //   239: return
    //   240: astore_2
    //   241: goto -55 -> 186
