...
public class bbew
  extends Handler
{
  public bbew(ScribbleResMgr paramScribbleResMgr, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      {
        Object localObject = (bbfa)localIterator.next();
        if (localObject != null)
        {
          View localView = ((bbfa)localObject).a();
          localObject = ((bbfa)localObject).a();
          if ((localView != null) && (localObject != null)) {
            ((bbfb)localObject).a(localView, paramMessage.arg1, (ScribbleResMgr.ResInfo)paramMessage.obj, paramMessage.what);
          } else {
