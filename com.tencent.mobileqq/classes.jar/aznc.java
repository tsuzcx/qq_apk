...
public class aznc
  implements Manager
{
  public final SparseArray<azmt> a;
  public QQAppInterface a;
  protected final List<String> a;
  protected final Map<String, azms> a;
  protected boolean a;
  public final SparseArray<TroopAioKeywordTipInfo> b;
  public final List<String> b;
  protected boolean b;
  
  public aznc(QQAppInterface paramQQAppInterface)
  {
  ...
  private List<Integer> a(MessageRecord arg1)
  {
    ...
    if (!TextUtils.isEmpty((CharSequence)localObject1)) {
      ...
      {
        localObject1 = (azms)this.jdField_a_of_type_JavaUtilMap.get(localObject1);
        if (localObject1 != null)
        {
          localObject1 = ((azms)localObject1).jdField_a_of_type_JavaUtilList;
          return localObject1;
        }
      }
    }
  ...
  private void a(MessageRecord paramMessageRecord, TroopAioKeywordTipInfo paramTroopAioKeywordTipInfo, aznf paramaznf)
  {
    if (paramaznf != null) {
      ThreadManager.getUIHandler().post(new TroopAioKeywordTipManager.5(this, paramaznf, paramMessageRecord, paramTroopAioKeywordTipInfo));
    }
  }
  
  private void a(Integer paramInteger, MessageRecord paramMessageRecord, aznf paramaznf)
  {
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(paramInteger);
    ((akhq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(localArrayList, new azne(this, paramMessageRecord, paramaznf));
  }
  ...
  private boolean a(Integer paramInteger, int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    {
      localObject1 = (azmt)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInteger.intValue());
      if (localObject1 == null) {
        return false;
      }
    }
    synchronized (this.jdField_b_of_type_JavaUtilList)
    {
      ...
      {
        this.jdField_b_of_type_JavaUtilList.addAll(azmr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      ...
      if ((((azmt)localObject1).b > NetConnInfoCenter.getServerTime()) || (((azmt)localObject1).c < NetConnInfoCenter.getServerTime()))
      {
        if (QLog.isColorLevel()) {
          QLog.i("TroopAioKeywordTipManager", 2, "isSupportedRuleId, not support timelimit, currentTime=" + NetConnInfoCenter.getServerTime() + ",ruleInfo.startTime =" + ((azmt)localObject1).b + ",ruleInfo.endTime=" + ((azmt)localObject1).c);
        }
        return false;
      }
    }
    if ((((azmt)localObject1).d & paramInt) == 0)
    {
      if (QLog.isColorLevel()) {
        QLog.i("TroopAioKeywordTipManager", 2, "isSupportedRuleId, not support positionFlag, ruleInfo.positionFlag=" + ((azmt)localObject1).d + ", curInvokeType=" + paramInt);
      }
      return false;
    }
    if ((((azmt)localObject1).jdField_a_of_type_JavaUtilList != null) && (((azmt)localObject1).jdField_a_of_type_JavaUtilList.size() > 0))
    {
      if (QLog.isColorLevel()) {
      ...
      if (!((azmt)localObject1).jdField_a_of_type_JavaUtilList.contains(Integer.valueOf((int)paramInteger.dwGroupClassExt)))
      {
        if (QLog.isColorLevel())
        {
          paramMessageRecord = new StringBuilder();
          paramMessageRecord.append("[");
          localObject1 = ((azmt)localObject1).jdField_a_of_type_JavaUtilList.iterator();
  ...
  public void a()
  {
    try
    {
      ...
      {
        oidb_0x496.AioKeyword localAioKeyword = azmr.a();
        a(azmr.a(localAioKeyword), azmr.b(localAioKeyword));
      }
      return;
    }
    finally
  ...
  public void a(List<azms> arg1, List<azmt> paramList1)
  {
    if (??? != null)
    {
      Object localObject2;
      try
      {
        synchronized (this.jdField_a_of_type_JavaUtilList)
        {
          ...
          {
            azms localazms = (azms)((Iterator)localObject2).next();
            this.jdField_a_of_type_JavaUtilList.add(localazms.jdField_a_of_type_JavaLangString.toLowerCase());
          }
        }
      }
      finally {}
      synchronized (this.jdField_a_of_type_JavaUtilMap)
      {
        ...
        if (???.hasNext())
        {
          localObject2 = (azms)???.next();
          this.jdField_a_of_type_JavaUtilMap.put(((azms)localObject2).jdField_a_of_type_JavaLangString.toLowerCase(), localObject2);
        }
      }
    }
    if (paramList1 != null) {
      synchronized (this.jdField_a_of_type_AndroidUtilSparseArray)
      {
        ...
        {
          ??? = (azmt)paramList1.next();
          this.jdField_a_of_type_AndroidUtilSparseArray.put(((azmt)???).jdField_a_of_type_Int, ???);
        }
      }
    }
  ...
  public void a(List<MessageRecord> paramList, List<String> paramList1, int paramInt, aznf paramaznf)
  {
    ThreadManager.post(new TroopAioKeywordTipManager.3(this, paramList, paramList1, paramInt, paramaznf), 8, null, true);
  }
