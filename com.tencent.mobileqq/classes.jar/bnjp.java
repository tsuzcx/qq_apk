...
public class bnjp
{
  public static boolean a(String paramString, double paramDouble1, double paramDouble2)
  {
    ...
    localExifInterface.setAttribute("GPSLatitude", bnkc.a(paramDouble2));
    localExifInterface.setAttribute("GPSLongitude", bnkc.a(paramDouble1));
    ...
    for (paramString = "N";; paramString = "S")
    {
      ...
      try
      {
        ...
        bdmc.a(BaseApplication.getContext()).a(null, "gpsComplement", true, 0L, 0L, paramString, null, true);
        return true;
      }
      catch (IOException paramString)
      {
    ...
    if ((localExifInterface2 != null) && (TextUtils.isEmpty(localExifInterface1.getAttribute("GPSLongitude"))))
    {
      ...
      if ((!TextUtils.isEmpty(paramString2)) && (!TextUtils.isEmpty(str)))
      {
        ...
        try
        {
          ...
          bdmc.a(BaseApplication.getContext()).a(null, "gpsComplement", true, 0L, 0L, paramString1, null, true);
          return true;
        }
