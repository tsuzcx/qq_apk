  ...
  implements RecyclerView.OnChildAttachStateChangeListener
{
  ...
  public bfya mCallback;
  private RecyclerView.ChildDrawingOrderCallback mChildDrawingOrderCallback;
  private List<Integer> mDistances;
  private long mDragScrollStartTimeInMs;
  float mDx;
  float mDy;
  bfxr mGestureDetector;
  float mInitialTouchX;
  float mInitialTouchY;
  float mMaxSwipeVelocity;
  private final RecyclerView.OnItemTouchListener mOnItemTouchListener = new bfxx(this);
  View mOverdrawChild = null;
  int mOverdrawChildPosition = -1;
  final List<View> mPendingCleanup = new ArrayList();
  List<bfye> mRecoverAnimations = new ArrayList();
  ...
  public bfxw(bfya parambfya)
  {
    this.mCallback = parambfya;
  }
  ...
  private void addChildDrawingOrderCallback()
  {
    ...
    if (this.mChildDrawingOrderCallback == null) {
      this.mChildDrawingOrderCallback = new bfxz(this);
    }
  ...
  private void destroyCallbacks()
  {
    ...
    while (i >= 0)
    {
      bfye localbfye = (bfye)this.mRecoverAnimations.get(0);
      this.mCallback.clearView(this.mRecyclerView, localbfye.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder);
      i -= 1;
    }
  ...
  private void initGestureDetector()
  {
    ...
    this.mGestureDetector = new bfxr(this.mRecyclerView.getContext(), new bfyd(this));
  }
  ...
  private int swipeIfNecessary(RecyclerView.ViewHolder paramViewHolder)
  {
    ...
    do
    {
      do
      {
        ...
        {
          if ((j & k) == 0) {
            return bfya.convertToRelativeDirection(k, ViewCompat.getLayoutDirection(this.mRecyclerView));
          }
          return k;
        }
    ...
    if ((j & i) == 0) {
      return bfya.convertToRelativeDirection(i, ViewCompat.getLayoutDirection(this.mRecyclerView));
    }
    return i;
  }
  ...
  int endRecoverAnimation(RecyclerView.ViewHolder paramViewHolder, boolean paramBoolean)
  {
    ...
    while (i >= 0)
    {
      bfye localbfye = (bfye)this.mRecoverAnimations.get(i);
      if (localbfye.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder == paramViewHolder)
      {
        localbfye.jdField_b_of_type_Boolean |= paramBoolean;
        if (!localbfye.jdField_c_of_type_Boolean) {
          localbfye.b();
        }
        this.mRecoverAnimations.remove(i);
        return localbfye.jdField_c_of_type_Int;
      }
      i -= 1;
    }
    return 0;
  ...
  bfye findAnimation(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      bfye localbfye = (bfye)this.mRecoverAnimations.get(i);
      paramMotionEvent = localbfye;
      if (localbfye.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder.itemView == localView) {
        break;
      }
      i -= 1;
    }
  ...
  View findChildView(MotionEvent paramMotionEvent)
  {
    ...
    while (i >= 0)
    {
      paramMotionEvent = (bfye)this.mRecoverAnimations.get(i);
  ...
  public boolean hasRunningRecoverAnim()
  {
    ...
    while (i < j)
    {
      if (!((bfye)this.mRecoverAnimations.get(i)).jdField_c_of_type_Boolean) {
        return true;
      }
      i += 1;
    }
  ...
  void postDispatchSwipe(bfye parambfye, int paramInt)
  {
    this.mRecyclerView.post(new ItemTouchHelper.4(this, parambfye, paramInt));
  }
    ...
    else
    {
      ...
      default: 
        ...
        if (k == 2)
        {
          ...
          localObject = new bfxy(this, (RecyclerView.ViewHolder)localObject, i, k, f3, f4, f1, f2, j, (RecyclerView.ViewHolder)localObject);
          ((bfye)localObject).a(this.mCallback.getAnimationDuration(this.mRecyclerView, i, f1 - f3, f2 - f4));
