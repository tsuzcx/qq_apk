...
public class rdm
{
  ...
  public rdm(String paramString1, String paramString2)
  {
  ...
  {
    return new rdp(paramContext, paramString1).a(paramString2);
  }
  
  public static void a(String paramString)
  {
    rdw.a(paramString, true);
  }
  ...
  public rdg a(Context paramContext)
  {
    ...
    {
      return localObject1;
      localObject2 = rdz.a(this.jdField_a_of_type_JavaLangString);
      localObject1 = localObject2;
    } while (localObject2 != null);
    Object localObject2 = rdz.a(this.jdField_a_of_type_JavaLangString);
    if (!((rea)localObject2).jdField_a_of_type_Boolean)
    {
      if (((rea)localObject2).jdField_a_of_type_Int == 1001) {
    ...
    Object localObject1 = new rdg();
    ((rdg)localObject1).a(2);
    ((rdg)localObject1).a(this.jdField_a_of_type_JavaLangString);
    ((rdg)localObject1).a((rea)localObject2);
    long l = System.currentTimeMillis();
    localObject2 = mol.a(this.jdField_a_of_type_JavaLangString);
    ...
    if (!mpr.a((String)localObject3, this.jdField_a_of_type_JavaLangString))
    {
    ...
    try
    {
      ...
      localObject3 = new rdr(paramContext, (String)localObject3, this.b);
      paramContext = new rdr(paramContext, (String)localObject2, (String)localObject4);
      localObject2 = new rdi(paramContext);
      localObject4 = paramContext.a();
      if (localObject4 != null)
      {
        Object localObject5 = ((rdq)localObject3).a("style_map.geojson");
        localObject3 = new ProteusParser();
        ((ProteusParser)localObject3).setVersion("8.2.6");
        ((ProteusParser)localObject3).setAladdinKey(odz.a());
        if (localObject5 != null) {
          ((ProteusParser)localObject3).parseDataMap(rdz.a((InputStream)localObject5));
        }
          ...
          if (((Iterator)localObject5).hasNext())
          {
            ...
            try
            {
              if (((String)localObject4).endsWith(".geojson"))
              {
                ...
                ((ProteusParser)localObject3).createViewTemplate((BaseTemplateFactory)localObject1, rdz.a(paramContext.a((String)localObject4)), (ComplementFileStringLoader)localObject2);
              }
            }
    ...
    catch (OutOfMemoryError paramContext)
    {
      ...
      rdz.a(this.jdField_a_of_type_JavaLangString, (rdg)localObject1);
      b();
      rsk.a(3, this.jdField_a_of_type_JavaLangString);
      return localObject1;
  ...
  /* Error */
  public rdg b(Context paramContext)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 26	rdm:b	Ljava/lang/String;
    //   4: ifnonnull +35 -> 39
    //   7: ldc 73
    //   9: iconst_2
    ...
    //   42: lstore_2
    //   43: aload_0
    //   44: getfield 26	rdm:b	Ljava/lang/String;
    //   47: invokestatic 110	rdz:a	(Ljava/lang/String;)Lrdg;
    //   50: astore 6
    //   52: aload 6
    //   54: astore 5
    //   56: aload 6
    ...
    //   61: new 130	rdg
    //   64: dup
    //   65: invokespecial 131	rdg:<init>	()V
    //   68: astore 8
    //   70: aload 8
    //   72: iconst_1
    //   73: invokevirtual 133	rdg:a	(I)V
    //   76: aload 8
    //   78: ldc 97
    //   80: invokevirtual 135	rdg:a	(Ljava/lang/String;)V
    //   83: aload_1
    ...
    //   96: aload_0
    //   97: getfield 26	rdm:b	Ljava/lang/String;
    ...
    //   122: aload_1
    //   123: aload 10
    //   125: invokespecial 36	rdp:<init>	(Landroid/content/Context;Ljava/lang/String;)V
    //   128: astore 11
    //   130: aload 11
    ...
    //   202: aload_1
    //   203: aload_0
    //   204: getfield 26	rdm:b	Ljava/lang/String;
    //   207: ldc 183
    //   209: invokespecial 297	rdm:a	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/io/InputStream;
    //   212: invokestatic 204	rdz:a	(Ljava/io/InputStream;)Ljava/lang/String;
    ...
    //   222: aload_1
    //   223: aload 10
    //   225: invokespecial 300	rdh:<init>	(Landroid/content/Context;Ljava/lang/String;)V
    //   228: astore 12
    //   230: aload 6
    ...
    //   326: aload_0
    //   327: getfield 26	rdm:b	Ljava/lang/String;
    ...
    //   521: aload 8
    //   523: aload 6
    //   525: invokestatic 204	rdz:a	(Ljava/io/InputStream;)Ljava/lang/String;
    //   528: aload 12
    ...
    //   582: aload_0
    //   583: getfield 26	rdm:b	Ljava/lang/String;
    //   586: aload 8
    //   588: invokestatic 252	rdz:a	(Ljava/lang/String;Lrdg;)V
    //   591: aload_0
    //   592: invokespecial 254	rdm:b	()V
    //   595: aload 8
    //   597: areturn
    //   598: goto -399 -> 199
