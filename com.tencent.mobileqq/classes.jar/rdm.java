...
public class rdm
  extends rbp
{
  public rdm(Context paramContext, FaceDecoder paramFaceDecoder, szd paramszd)
  {
  ...
  public rbp a()
  {
    ...
    return c(this.jdField_a_of_type_Szd, this.jdField_a_of_type_ComTencentMobileqqAppFaceFaceDecoder).q().l().n().h().g().j();
  }
  ...
  public rbp d()
  {
    ...
    if ((this.jdField_a_of_type_Rbo != null) && ((this.jdField_a_of_type_Rbo instanceof ComponentContentBig)) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentTitle != null))
    {
      ...
      localLinearLayout2.setOnClickListener(new rdn(this));
