...
public class rdm
{
  ...
  {
    if (((paramView.getLayoutParams() instanceof ViewGroup.MarginLayoutParams)) && (paramView.getTag(2131362578) == null))
    {
      ...
      localValueAnimator.addUpdateListener(new rds(i, localMarginLayoutParams, j, paramView));
      localValueAnimator.addListener(new rdt(paramView));
      paramView.setTag(2131362578, localValueAnimator);
  ...
  public static ObjectAnimator a(View paramView, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (paramInt1 == 0)
    {
      ...
      localObjectAnimator1.addListener(new rdz(paramView));
      localObjectAnimator1.start();
    }
    for (;;)
    {
      ...
      if ((paramInt1 == 8) || (paramInt1 == 4))
      {
        ...
        localObjectAnimator1.start();
        paramView.setLayerType(2, null);
        localObjectAnimator1.addListener(new rea(paramView));
        localObjectAnimator1.start();
      }
    }
  }
  ...
  public static VideoInfo a(Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      localVideoInfo.n = paramBundle.getString("VIDEO_THIRD_ICON");
      ...
      localVideoInfo.m = paramBundle.getString("VIDEO_THIRD_ACTION");
      localVideoInfo.jdField_a_of_type_Int = paramBundle.getInt("VIDEO_ARTICLE_BUSITYPE");
      localVideoInfo.jdField_p_of_type_JavaLangString = paramBundle.getString("VIDEO_URL");
      localVideoInfo.jdField_d_of_type_Long = paramBundle.getLong("VIDEO_FEED_ID");
      localVideoInfo.jdField_g_of_type_Int = paramBundle.getInt("VIDEO_FEED_TYPE");
      ...
      localVideoInfo.o = paramBundle.getInt("VIDEO_STRATEGY_ID", 0);
      ...
      localVideoInfo.u = paramBundle.getString("RED_PACKET_ID");
      localVideoInfo.jdField_p_of_type_Int = paramBundle.getInt("VIDEO_PLAY_COUNT");
  ...
  public static Long a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    if (paramBaseArticleInfo.busiType == 6)
    {
      if (rqj.b((ArticleInfo)paramBaseArticleInfo)) {
        return Long.valueOf(paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qme.jdField_a_of_type_Long);
      }
      return Long.valueOf(paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qmw.jdField_a_of_type_Long);
    }
  ...
  public static void a(Activity paramActivity, Bundle paramBundle, int paramInt, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    if (paramBaseArticleInfo.busiType == 6)
    {
      ...
      if (paramBaseArticleInfo.mSocialFeedInfo != null)
      {
        ...
        i = j;
        localObject1 = localObject2;
        if (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qmc != null)
        {
          bool1 = bool2;
          l1 = l2;
          i = j;
          ...
          if (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qmw != null)
          {
            ...
            i = j;
            localObject1 = localObject2;
            if (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qmw.b != null)
            {
              bool1 = bool2;
              l1 = l2;
              i = j;
              localObject1 = localObject2;
              if (!paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qmw.b.isEmpty())
              {
                bool1 = true;
                l1 = paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qmc.a.longValue();
                i = paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qmc.b.intValue();
                localObject1 = ((qmy)paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qmw.b.get(0)).jdField_b_of_type_JavaLangString;
              }
            }
          }
        }
  ...
  public static void a(Activity paramActivity, Bundle paramBundle, boolean paramBoolean, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramBoolean = otp.a(localBundle.getInt("VIDEO_FROM_TYPE", -1));
        for (;;)
        {
          if (!paramBoolean) {
            break label212;
          ...
          if (paramBundle != null) {
            paramBoolean = otp.a(localBundle.getInt("VIDEO_FROM_TYPE", -1), paramBundle.jdField_b_of_type_Int, paramBundle.jdField_c_of_type_Int, paramBundle.jdField_d_of_type_Int);
          } else {
            paramBoolean = otp.a(localBundle.getInt("VIDEO_FROM_TYPE", -1), Integer.valueOf(localBundle.getString("VIDEO_WIDTH")).intValue(), Integer.valueOf(localBundle.getString("VIDEO_HEIGHT")).intValue(), Integer.valueOf(localBundle.getString("VIDEO_TIME")).intValue());
          }
        }
      }
  ...
  public static void a(Context paramContext, TextView paramTextView, String paramString1, String paramString2, String paramString3, View.OnClickListener paramOnClickListener)
  {
    ...
    paramString1.setSpan(new rdn(paramString3, paramContext, paramOnClickListener), i, j, 33);
  ...
  public static void a(Context paramContext, UrlJumpInfo paramUrlJumpInfo)
  {
    ...
    for (;;)
    {
      ...
      {
        if (!nxu.a(paramUrlJumpInfo.jdField_b_of_type_JavaLangString))
        {
          if (!QLog.isColorLevel()) {
            break;
          }
  ...
  public static void a(View paramView, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      if (paramInt1 == 0)
      {
        ...
        localAlphaAnimation.setAnimationListener(new reb(paramView));
        paramView.clearAnimation();
    ...
    localAlphaAnimation.setDuration(paramInt2);
    localAlphaAnimation.setFillAfter(true);
    localAlphaAnimation.setAnimationListener(new rec(paramView));
    paramView.clearAnimation();
    paramView.startAnimation(localAlphaAnimation);
  }
  ...
  public static void a(View paramView, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    do
    {
      ...
      if (paramInt2 == 0)
      {
        ...
        paramView.setLayerType(2, null);
        localObjectAnimator2.addListener(new rdx(paramView));
    ...
    localObjectAnimator1.setRepeatCount(0);
    paramView.setLayerType(2, null);
    localObjectAnimator1.addListener(new rdy(paramView));
    localObjectAnimator1.start();
  }
  ...
  public static void a(TextView paramTextView, rjn paramrjn) {}
    ...
    if (paramVideoInfo.jdField_a_of_type_Int != 0)
    {
      if (paramVideoInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo == null)
      {
        ...
        if (paramVideoInfo.jdField_b_of_type_Boolean)
        {
          ...
          localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qmw.b = new ArrayList();
          qmy localqmy = new qmy();
          localqmy.h = paramVideoInfo.jdField_f_of_type_JavaLangString;
          localqmy.e = paramVideoInfo.jdField_c_of_type_JavaLangString;
          localqmy.jdField_d_of_type_JavaLangString = paramVideoInfo.jdField_b_of_type_JavaLangString;
          localqmy.jdField_a_of_type_Long = paramVideoInfo.jdField_d_of_type_Int;
          localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qmw.b.add(localqmy);
        }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    ((nsi)paramQQAppInterface.a(155)).a(paramInt);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    rdq localrdq = new rdq(paramString, paramBoolean);
    if (paramBoolean) {}
    for (int i = 2;; i = 1)
    {
      localphg.a(paramQQAppInterface, paramString, true, localrdq, i);
      return;
    }
  }
  ...
  public static void a(String paramString1, String paramString2, TextView paramTextView)
  {
    if (!TextUtils.isEmpty(paramString1))
    {
      ...
      try
      {
        opi.a(paramTextView, paramString1);
  ...
  public static void a(rjk paramrjk, View paramView)
  {
    if (!otp.a()) {}
    do
    {
    ...
    if (!TextUtils.isEmpty(str)) {
      paramrjk.jdField_b_of_type_JavaLangString = str;
    }
    paramrjk.j = paramView.getNativeView().getWidth();
    paramrjk.k = paramView.getNativeView().getHeight();
  }
  ...
  public static boolean a(Activity paramActivity, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    if (i == 1)
    {
      if (ors.a(paramBaseArticleInfo.bytes_jump_url))
      {
        ors.a(paramActivity, ors.a(paramBaseArticleInfo.bytes_jump_url));
        return true;
      }
    }
  ...
  {
    String str = opy.a(paramBaseArticleInfo);
    if (!TextUtils.isEmpty(str))
    {
      if (qjz.a(str))
      {
        ors.a(paramContext, paramBaseArticleInfo, str);
        return true;
      }
      a(paramContext, str);
      return true;
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, long paramLong)
  {
    try
    {
      boolean bool = owy.a().b(Long.valueOf(paramLong));
      return bool;
    }
  ...
  public static void b(Context paramContext, TextView paramTextView, String paramString1, String paramString2, String paramString3, View.OnClickListener paramOnClickListener)
  {
    ...
    paramString1 = new SpannableString(paramString1);
    paramString1.setSpan(new rdo(paramTextView), i, j, 33);
    paramTextView.setMovementMethod(LinkMovementMethod.getInstance());
    paramTextView.setText(paramString1);
    paramTextView.setOnClickListener(new rdp(paramString3, paramContext, paramOnClickListener));
  }
  ...
  public static void b(VideoInfo paramVideoInfo)
  {
    ...
    paramVideoInfo.jdField_g_of_type_JavaLangString = paramVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo.D;
  }
