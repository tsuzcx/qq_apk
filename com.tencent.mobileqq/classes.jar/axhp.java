  ...
  implements View.OnClickListener
{
  ...
  public axhp(Context paramContext, View.OnClickListener paramOnClickListener)
  {
  ...
  private void a(AsyncImageView paramAsyncImageView, GroupPadTemplateInfo paramGroupPadTemplateInfo)
  {
    ...
    {
      Drawable localDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839674);
      if (!befm.a(paramGroupPadTemplateInfo.mobThumbUrl)) {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (paramGroupPadTemplateInfo != null)
          {
            ...
            paramGroupPadTemplateInfo.setDownloadListener(new axhq(this, str));
    ...
    paramAsyncImageView.setImageResource(2130839674);
  }
  ...
  public GroupPadTemplateInfo a()
  {
    ...
    localGroupPadTemplateInfo.templateName = this.jdField_a_of_type_AndroidContentContext.getString(2131627572);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131493556, null);
      paramView = new axhr(this);
      paramView.jdField_a_of_type_Int = jdField_b_of_type_Int;
      paramView.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView = ((AsyncImageView)paramViewGroup.findViewById(2131301610));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131301606));
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131301604));
    ...
    for (;;)
    {
      ...
      paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131493555, null);
      paramView = new axhr(this);
      paramView.jdField_a_of_type_Int = jdField_a_of_type_Int;
      paramView.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView = ((AsyncImageView)paramViewGroup.findViewById(2131301609));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131301608));
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131301603));
      paramView.jdField_a_of_type_ComTencentMobileqqTeamworkforgroupGroupPadTemplateInfo = localGroupPadTemplateInfo;
      paramViewGroup.setTag(paramView);
      paramViewGroup.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
      break;
      ...
      paramView.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setImageResource(2130839676);
      break label135;
      label287:
      paramView.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setImageResource(2130839674);
