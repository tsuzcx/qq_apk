  ...
  implements bgph
{
  ...
  public alhk(MessageForQQWalletMsg paramMessageForQQWalletMsg)
  {
  ...
  public static void a(MessageRecord paramMessageRecord, QQAppInterface paramQQAppInterface)
  {
    if (paramMessageRecord != null)
    {
      ...
      alil.a(paramQQAppInterface, paramMessageRecord);
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageForQQWalletMsg paramMessageForQQWalletMsg)
  {
    ...
    if (bool)
    {
      ((bgot)paramQQAppInterface.getManager(223)).a(new alhk(paramMessageForQQWalletMsg), false);
      return true;
    }
    return false;
  }
  ...
  public static boolean a(Object paramObject, QQAppInterface paramQQAppInterface)
  {
    ...
    if ((i == 7) || (i == 8) || (i == 11) || (i == 12))
    {
      ...
      if ((!alfc.a().a()) && (!paramQQAppInterface.c().equals(paramObject.senderuin)))
      {
  ...
  public void a(BaseChatPie paramBaseChatPie, bdyi parambdyi)
  {
    alil.a(alil.a(), "212", "only.animation.show");
    String str = alhi.a() + this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg.mQQWalletRedPacketMsg.body.feedId + ".zip";
    ...
    parambdyi = new alhl(this, parambdyi);
    this.jdField_a_of_type_JavaLangRunnable = new SpecifyRedPacketAnimMsg.2(this, parambdyi);
    ThreadManager.getUIHandler().postDelayed(this.jdField_a_of_type_JavaLangRunnable, 10000L);
    PreloadManager.a().c(str, new alhm(this, localWeakReference, parambdyi, paramBaseChatPie));
  }
