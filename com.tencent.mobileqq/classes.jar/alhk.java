...
{
  public alhk(AuthorityActivity paramAuthorityActivity) {}
  ...
  public void onFailed(String paramString, int paramInt1, int paramInt2, Bundle paramBundle)
  {
    ...
    catch (Exception paramBundle)
    {
      ...
      this.a.a(3003, this.a.getResources().getString(2131435619));
      paramString = this.a.jdField_a_of_type_CooperationQqfavUtilHandlerPlus.obtainMessage();
      paramString.what = 6;
      paramString.arg1 = 3003;
      paramString.obj = this.a.getResources().getString(2131435619);
