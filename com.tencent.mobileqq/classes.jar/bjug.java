...
public class bjug
{
  ...
  {
    return bjih.d + File.separator + paramString;
  }
  ...
  public static boolean a(Activity paramActivity, Bitmap paramBitmap, int paramInt, String paramString)
  {
    ...
    if (Build.VERSION.SDK_INT >= 23)
    {
      ...
      if (paramActivity != null) {
        bool1 = bjvb.a(paramActivity, new bjui(paramBitmap, paramInt, paramString, paramActivity), 1);
      }
    }
    if (bool1) {
  ...
  public static boolean a(Activity paramActivity, String paramString1, String paramString2)
  {
    ...
    if (Build.VERSION.SDK_INT >= 23)
    {
      bool1 = bool2;
      if (paramActivity != null) {
        bool1 = bjvb.a(paramActivity, new bjuh(paramString1, paramString2, paramActivity), 1);
      }
    }
    if (bool1) {
  ...
  private static boolean b(Bitmap paramBitmap, int paramInt, String paramString)
  {
    ...
    //   14: getstatic 23	bjih:d	Ljava/lang/String;
  ...
  private static boolean b(String paramString1, String paramString2)
  {
    try
    {
      ...
      paramString2 = new File(bjih.d + File.separator + paramString2);
      bjtz.a(paramString1, paramString2);
