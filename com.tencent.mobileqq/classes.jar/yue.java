  ...
  implements ytv
{
  ...
  private yts jdField_b_of_type_Yts;
  private yts c;
  
  public yue(Context paramContext, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, String paramString4)
  {
    super(paramContext);
    ...
    localLinearLayout.addView(this.jdField_a_of_type_Yts);
    this.jdField_b_of_type_Yts = new yts(paramContext, paramString2);
    this.jdField_b_of_type_Yts.setId(2131366952);
    localLinearLayout.addView(this.jdField_b_of_type_Yts);
    this.c = new yts(paramContext, paramString3);
  ...
  {
    if ((this.jdField_a_of_type_Int <= 0) || (this.jdField_b_of_type_Int <= 0) || (this.jdField_a_of_type_Yts == null) || (this.jdField_b_of_type_Yts == null) || (this.c == null) || (this.jdField_a_of_type_AndroidWidgetTextView == null) || (paramInt1 <= 0) || (paramInt2 <= 0))
    {
      yxs.d("GdtBannerViewForCreativeSize285", "setSize error");
      return;
    }
    yua localyua = new yua(getContext(), paramInt1, paramInt2);
    paramInt2 = Double.valueOf((paramInt1 - localyua.jdField_a_of_type_Int * 2) * 1.0D / 3.0D).intValue();
    int i = Double.valueOf((paramInt2 - localyua.jdField_b_of_type_Int * 2) * 1.0D / this.jdField_a_of_type_Int * this.jdField_b_of_type_Int + localyua.jdField_b_of_type_Int * 2).intValue();
    ...
    this.jdField_b_of_type_Yts.setPadding(localyua.jdField_b_of_type_Int, localyua.jdField_b_of_type_Int, localyua.jdField_b_of_type_Int, localyua.jdField_b_of_type_Int);
    this.jdField_b_of_type_Yts.setLayoutParams(localLayoutParams);
    localLayoutParams = new LinearLayout.LayoutParams(paramInt2, i);
    localLayoutParams.leftMargin = localyua.jdField_a_of_type_Int;
    this.c.setPadding(localyua.jdField_b_of_type_Int, localyua.jdField_b_of_type_Int, localyua.jdField_b_of_type_Int, localyua.jdField_b_of_type_Int);
    this.c.setLayoutParams(localLayoutParams);
    localLayoutParams = new LinearLayout.LayoutParams(paramInt1, -2);
    localLayoutParams.topMargin = localyua.jdField_b_of_type_Int;
