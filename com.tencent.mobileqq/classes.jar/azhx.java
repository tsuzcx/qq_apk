  ...
  implements Manager
{
  ...
  public static boolean a(MessageRecord paramMessageRecord)
  {
    ...
    if ((paramMessageRecord instanceof MessageForStructing))
    {
      ...
      if ((localMessageForStructing.istroop == 1) && (localMessageForStructing.msgData != null) && (localMessageForStructing.structingMsg == null))
      {
        paramMessageRecord = awuw.a(paramMessageRecord.msgData);
        if ((paramMessageRecord != null) && (paramMessageRecord.mMsgServiceID == 43)) {
          return true;
        }
      }
    }
    ...
    for (;;)
    {
      ...
      else
      {
        for (;;)
        {
          ...
          for (;;)
          {
            awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_public", "", "oper", "bottom_one", 0, 0, paramString, "", "", "");
            break;
            if (((ChatMessage)???.get(i)).shmsgseq > l) {
              ???.add(i, ???);
  ...
  public boolean a(String paramString)
  {
    ...
    //   1: monitorenter
    //   2: aload_1
    //   3: invokestatic 316	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   6: ifne +63 -> 69
    //   9: aload_1
    //   10: aload_0
    //   11: getfield 33	azhx:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   14: invokevirtual 321	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   17: ifeq +52 -> 69
    //   20: iconst_1
    //   21: istore_2
    //   22: invokestatic 170	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   25: ifeq +40 -> 65
    //   28: ldc_w 323
    //   31: iconst_2
    ...
    //   55: iload_2
    //   56: invokevirtual 227	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   59: invokevirtual 77	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   62: invokestatic 178	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   65: aload_0
    //   66: monitorexit
    //   67: iload_2
    //   68: ireturn
