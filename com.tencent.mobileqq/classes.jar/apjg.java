...
public class apjg
  extends Handler
{
  public apjg(apje paramapje, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    default: 
      return;
    case 100: 
      apoo.a().a(new ARCamera.ARCameraHandler.1(this));
      removeMessages(100);
      sendEmptyMessageDelayed(100, 3000L);
      return;
    case 101: 
      apoo.a().a(new ARCamera.ARCameraHandler.2(this));
      return;
    }
    apoo.a().a(new ARCamera.ARCameraHandler.3(this));
  }
}
