  ...
  implements bids
{
  ...
  public bidq(Context paramContext, bidp parambidp, TypedArray paramTypedArray)
  {
  ...
  public bidr a(ViewGroup paramViewGroup, int paramInt)
  {
    return new bidr(new SimpleMonthView(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidContentResTypedArray), this);
  }
  ...
  public void a(bidr parambidr, int paramInt)
  {
    SimpleMonthView localSimpleMonthView = parambidr.a;
    HashMap localHashMap = new HashMap();
    CalendarDay localCalendarDay1 = this.jdField_a_of_type_Bidp.a();
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Bidp.a(localSimpleMonthView, j, i);
      EventCollector.getInstance().onRecyclerBindViewHolder(parambidr, paramInt, getItemId(paramInt));
      return;
    }
  }
  ...
  public void a(SimpleMonthView paramSimpleMonthView, CalendarDay paramCalendarDay, Object paramObject)
  {
    ...
    {
      a(paramCalendarDay);
      this.jdField_a_of_type_Bidp.a(paramCalendarDay, (MessageRecord)paramObject);
    }
  }
  
  public int getItemCount()
  {
    int i = this.jdField_a_of_type_Bidp.a().year * 12 + this.jdField_a_of_type_Bidp.a().month;
    int j = this.jdField_a_of_type_Bidp.b().year * 12 + this.jdField_a_of_type_Bidp.b().month;
    if (i == j) {
      return 2;
    }
    return j - i + 1;
