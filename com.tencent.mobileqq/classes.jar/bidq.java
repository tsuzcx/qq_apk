...
class bidq
  extends ntf
{
  bidq(bidm parambidm, bids parambids, int paramInt) {}
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramArrayOfByte == null)
        {
          ...
          if (this.jdField_a_of_type_Bids != null)
          {
            ...
            this.jdField_a_of_type_Bids.a(paramBundle);
          }
          return;
        }
      }
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          paramBundle = paramArrayOfByte;
          localObject1 = new bidr(null);
          paramBundle = paramArrayOfByte;
          ((bidr)localObject1).jdField_a_of_type_Long = (l2 * 1000L + l1);
          paramBundle = paramArrayOfByte;
          ((bidr)localObject1).jdField_a_of_type_Int = ((oidb_0xbcb.UrlCheckResult)localObject2).result.get();
          paramBundle = paramArrayOfByte;
          ((bidr)localObject1).jdField_b_of_type_Int = ((oidb_0xbcb.UrlCheckResult)localObject2).jump_result.get();
          paramBundle = paramArrayOfByte;
          ((bidr)localObject1).jdField_a_of_type_JavaLangString = ((oidb_0xbcb.UrlCheckResult)localObject2).jump_url.get();
          paramBundle = paramArrayOfByte;
          ((bidr)localObject1).c = ((oidb_0xbcb.UrlCheckResult)localObject2).uint32_level.get();
          paramBundle = paramArrayOfByte;
          ((bidr)localObject1).d = ((oidb_0xbcb.UrlCheckResult)localObject2).uint32_sub_level.get();
          paramBundle = paramArrayOfByte;
          ((bidr)localObject1).e = ((oidb_0xbcb.UrlCheckResult)localObject2).uint32_umrtype.get();
          paramBundle = paramArrayOfByte;
          ((bidr)localObject1).f = ((oidb_0xbcb.UrlCheckResult)localObject2).ret_from.get();
          paramBundle = paramArrayOfByte;
          ((bidr)localObject1).jdField_b_of_type_Long = ((oidb_0xbcb.UrlCheckResult)localObject2).operation_bit.get();
          if (paramInt == 0) {
            paramArrayOfByte = (byte[])localObject1;
          }
          paramBundle = paramArrayOfByte;
          localObject2 = (bidr)this.jdField_a_of_type_Bidm.a.get(str);
          if (localObject2 != null)
          {
            paramBundle = paramArrayOfByte;
            ((bidr)localObject1).jdField_a_of_type_Boolean = ((bidr)localObject2).jdField_a_of_type_Boolean;
          }
          paramBundle = paramArrayOfByte;
          this.jdField_a_of_type_Bidm.a.put(str, localObject1);
          paramInt += 1;
        }
