  ...
  implements Manager
{
  ...
  public ajof(QQAppInterface paramQQAppInterface)
  {
  ...
  private void d()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("MobileUnityManager", 2, "tryShowBannerInner ve" + this.jdField_a_of_type_Ajog);
    }
    if (((ajog)localObject).c > 0L)
    {
      ((ajog)localObject).c -= 1L;
      a((ajog)localObject);
    }
    label68:
    ajoe localajoe;
    ...
    do
    {
      ...
      {
        return;
        if ((localObject != null) && (((ajog)localObject).jdField_a_of_type_Int != -1))
        {
          localajoe = a();
          if (QLog.isColorLevel()) {
            QLog.d("MobileUnityManager", 2, "tryShowBannerInner bd " + localajoe);
          }
          if ((localajoe == null) || (localajoe.e <= 0) || (localajoe.jdField_a_of_type_Int <= 0) || (!localajoe.jdField_a_of_type_Boolean) || (((ajog)localObject).jdField_b_of_type_Long <= 0L)) {
            break;
          }
          int j = 0;
          long l1 = ((ajog)localObject).jdField_a_of_type_Long;
          long l2 = (localajoe.jdField_b_of_type_Int + 1) * 24 * 60 * 60 * 1000;
          long l3 = System.currentTimeMillis();
          int i;
          if (l3 - l1 > l2)
          {
            ((ajog)localObject).jdField_a_of_type_Long = l3;
            ((ajog)localObject).jdField_b_of_type_Long -= 1L;
            ((ajog)localObject).jdField_b_of_type_Int = (localajoe.jdField_a_of_type_Int - 1);
            a((ajog)localObject);
            i = 1;
          }
          for (;;)
          {
            ...
            {
              i = j;
              if (((ajog)localObject).jdField_b_of_type_Int > 0)
              {
                ((ajog)localObject).jdField_b_of_type_Long -= 1L;
                ((ajog)localObject).jdField_b_of_type_Int -= 1;
                a((ajog)localObject);
                i = 1;
              }
            }
  ...
  public ajoe a()
  {
    if (this.jdField_a_of_type_Ajoe != null) {
      return this.jdField_a_of_type_Ajoe;
    }
    Object localObject = a();
    ...
    try
    {
      if (((File)localObject).exists()) {
        this.jdField_a_of_type_Ajoe = ajoe.a(bace.a((File)localObject));
      }
      localObject = this.jdField_a_of_type_Ajoe;
      return localObject;
    }
  ...
  public ajog a()
  {
    if (this.jdField_a_of_type_Ajog != null) {
      return this.jdField_a_of_type_Ajog;
    }
    ajog localajog = ajog.a(a().getString("mobileunityversion", ""));
    this.jdField_a_of_type_Ajog = localajog;
    return localajog;
  }
  ...
  {
    ajru localajru = (ajru)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(34);
    if (localajru != null) {
      localajru.a(paramInt1, paramInt2, paramString1, paramString2);
    }
  }
  
  public void a(int paramInt, String paramString, ajoe paramajoe)
  {
    if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      } while (paramajoe == null);
      bace.a(str);
      bace.a(str, paramString);
      this.jdField_a_of_type_Ajoe = paramajoe;
      if (QLog.isColorLevel()) {
        QLog.d("MobileUnityManager", 2, "saveBannerConfig date = " + this.jdField_a_of_type_Ajoe);
      }
      awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005B71 ", "0X8005B71 ", 0, 0, "", "", "", "");
      paramString = a();
    } while (paramString == null);
    paramString.jdField_a_of_type_Long = 0L;
    paramString.jdField_a_of_type_Int = paramInt;
    paramString.jdField_b_of_type_Long = paramajoe.c;
    paramString.jdField_b_of_type_Int = paramajoe.jdField_a_of_type_Int;
    paramString.c = paramajoe.e;
    a(paramString);
    b();
  }
  
  public void a(ajog paramajog)
  {
    if (paramajog == null)
    {
      this.jdField_a_of_type_Ajog = null;
      a().edit().remove("mobileunityversion").commit();
      return;
    }
    this.jdField_a_of_type_Ajog = paramajog;
    a().edit().putString("mobileunityversion", paramajog.a()).commit();
  }
