...
public final class srv
{
  ...
  static
  {
    jdField_a_of_type_Srw = new srw(null);
  }
  
  @SuppressLint({"ClickableViewAccessibility"})
  private final void a(View paramView)
  {
    paramView = (ViewStub)paramView.findViewById(2131380848);
    if (this.jdField_a_of_type_AndroidViewView == null) {
      this.jdField_a_of_type_AndroidViewView = paramView.inflate();
    }
    paramView = this.jdField_a_of_type_AndroidViewView;
    if (paramView != null) {
      paramView.setOnTouchListener((View.OnTouchListener)new srz(this));
    }
  }
  ...
  private final void a(Function0<Unit> paramFunction0)
  {
    ...
    if (localView != null)
    {
      ...
      this.jdField_a_of_type_AndroidViewViewPropertyAnimator = localView.animate().alpha(1.0F).setDuration(300L).setListener((Animator.AnimatorListener)new ssb(this, paramFunction0));
  ...
  private final boolean a()
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if ((i == 0) || (!bmhv.a("video_column", j)) || (this.d)) {
        break;
      }
      return true;
    }
  ...
  {
    paramView = (ViewStub)paramView.findViewById(2131380846);
  ...
  private final void c()
  {
    ...
    if (localObject2 != null)
    {
      ...
      localObject2 = ObjectAnimator.ofFloat(localObject2, "translationX", new float[] { 0.0F, -DisplayUtil.dip2px(((View)localObject2).getContext(), 40.0F), 0.0F });
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView = ((DiniFlyAnimationView)paramView.findViewById(2131380847));
    ...
    if (paramView != null)
    {
      ...
      paramView.addAnimatorListener((Animator.AnimatorListener)new ssa(this));
  ...
  private final void d()
  {
    ...
    if (localObject != null)
    {
      ...
      localObjectAnimator.addListener((Animator.AnimatorListener)new srx((View)localObject));
