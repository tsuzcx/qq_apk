...
public class baob
{
  ...
  public baob(Context paramContext, String paramString)
  {
  ...
  private void b()
  {
    this.jdField_a_of_type_AndroidViewView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131561147, null);
    if (this.jdField_a_of_type_AndroidViewView != null)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131375300));
      ...
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131375028));
    }
  ...
  public void a(AppInterface paramAppInterface, ArrayList<balv> paramArrayList)
  {
    QLog.d("RobotMemberFormItem", 2, "setMemberUinList!");
    if ((paramArrayList == null) || (paramArrayList.size() == 0)) {
      if (this.jdField_b_of_type_AndroidWidgetTextView != null)
      {
        this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131694677));
    ...
    do
    {
      ...
      {
        balv localbalv = (balv)paramArrayList.get(i);
        String str = String.valueOf(localbalv.a());
        Object localObject = bbdr.a();
        localObject = baxt.a(paramAppInterface, 1, str, 3, (Drawable)localObject, (Drawable)localObject, 4);
        ...
        if (localbalv.b()) {
          ((baxt)localObject).setAlpha(50);
        }
        localThemeImageView.setTag(localbalv);
