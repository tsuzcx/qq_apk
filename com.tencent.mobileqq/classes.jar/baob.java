...
public class baob
{
  ...
  public static Drawable a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    do
    {
      ...
      localObject1 = localObject3;
      if (a(paramQQAppInterface, paramString)) {
        localObject1 = aoot.b(paramQQAppInterface, paramString, (byte)3);
      }
      localObject2 = localObject1;
    } while (localObject1 != null);
    return bhmq.b();
  ...
  public static PhoneContact a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (localaxfr != null)
    {
      PhoneContact localPhoneContact = localaxfr.c(paramString);
      azos localazos = azot.a(paramString);
      paramQQAppInterface = localPhoneContact;
      if (localPhoneContact == null) {
        paramQQAppInterface = localaxfr.b(localazos.c);
      }
      paramString = paramQQAppInterface;
      if (paramQQAppInterface == null) {
        paramString = localaxfr.b("+" + localazos.a + localazos.c);
      }
      paramQQAppInterface = paramString;
      if (paramString == null) {
        paramQQAppInterface = localaxfr.b(localazos.a + localazos.c);
      }
      paramString = paramQQAppInterface;
      if (paramQQAppInterface == null) {
        paramString = localaxfr.b("00" + localazos.a + localazos.c);
      }
      if (paramString == null) {
        return localaxfr.b(localazos.a + "-" + localazos.c);
      }
      return paramString;
    }
    return null;
  ...
  public static String a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    for (String str = ((PhoneContact)localObject2).uin;; str = null)
    {
      ...
      if (!TextUtils.isEmpty(str))
      {
        ...
        if (!str.equals("0"))
        {
          localObject2 = ((anyw)paramQQAppInterface.getManager(51)).e(str);
  ...
  {
    azos localazos = azot.a(paramString);
    if (localazos.a.equals("86")) {
      paramString = localazos.c;
    }
    return paramString;
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString)
  {
    ...
    localblir.a(2131689515);
    arrayOfInt[0] = 1;
    localblir.b(2131690573);
    localblir.c(2131690580);
    localblir.a(new baoc());
    localblir.a(new baod(localblir, arrayOfInt, paramString, paramContext, paramQQAppInterface));
    localblir.show();
  }
  
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString)
  {
    paramQQAppInterface = (axfr)paramQQAppInterface.getManager(11);
    if (paramQQAppInterface != null) {}
