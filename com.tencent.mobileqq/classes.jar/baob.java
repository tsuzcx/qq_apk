  ...
  extends bame
{
  ...
  public baob(BaseApplicationImpl paramBaseApplicationImpl)
  {
  ...
  {
    // Byte code:
    //   0: getstatic 38	baob:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   3: ifnull +12 -> 15
    //   6: getstatic 38	baob:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   9: invokevirtual 44	java/io/File:exists	()Z
    //   12: ifne +55 -> 67
    //   15: aload_0
    //   16: getfield 22	baob:jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl	Lcom/tencent/common/app/BaseApplicationImpl;
    //   19: ldc 46
    //   21: iconst_0
    //   22: invokevirtual 30	com/tencent/common/app/BaseApplicationImpl:getDir	(Ljava/lang/String;I)Ljava/io/File;
    //   25: putstatic 38	baob:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   28: aload_0
    //   29: getfield 22	baob:jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl	Lcom/tencent/common/app/BaseApplicationImpl;
    //   32: ldc 48
    //   34: iconst_0
    ...
    //   50: pop
    //   51: getstatic 38	baob:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   54: invokevirtual 44	java/io/File:exists	()Z
    //   57: ifne +10 -> 67
    //   60: getstatic 38	baob:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   63: invokevirtual 54	java/io/File:mkdirs	()Z
    //   66: pop
    //   67: invokestatic 59	apgj:a	()Ljava/lang/String;
    //   70: astore_1
    //   71: aload_0
    //   72: getfield 22	baob:jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl	Lcom/tencent/common/app/BaseApplicationImpl;
    //   75: aload_1
    ...
    //   93: checkcast 56	apgj
    //   96: astore_1
    //   97: aload_1
    //   98: ifnull +644 -> 742
    //   101: aload_1
    //   102: ldc 71
    //   104: invokevirtual 74	apgj:a	(Ljava/lang/String;)Lapgu;
    //   107: checkcast 76	aphm
    //   110: astore_1
    //   111: aload_2
    ...
    //   130: getstatic 38	baob:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    ...
    //   230: getstatic 139	bahu:c	[Ljava/lang/String;
    //   233: astore 8
    //   235: aload 8
    //   237: arraylength
    //   238: istore 7
    ...
    //   285: getstatic 38	baob:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    ...
    //   330: astore 8
    //   332: aload_0
    //   333: getfield 22	baob:jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl	Lcom/tencent/common/app/BaseApplicationImpl;
    ...
    //   462: ldc 199
    //   464: aload_1
    //   465: invokestatic 204	bamf:a	(Ljava/lang/Exception;)Ljava/lang/String;
    ...
    //   475: invokestatic 215	azmz:a	(Landroid/content/Context;)Lazmz;
    //   478: aconst_null
    //   479: ldc 217
    //   481: iconst_0
    //   482: lconst_0
    ...
    //   484: aload_2
    //   485: ldc 24
    //   487: invokevirtual 220	azmz:a	(Ljava/lang/String;Ljava/lang/String;ZJJLjava/util/HashMap;Ljava/lang/String;)V
    ...
    //   505: getstatic 32	baob:jdField_b_of_type_JavaIoFile	Ljava/io/File;
    //   508: areturn
    //   509: astore_1
    ...
    //   574: invokestatic 215	azmz:a	(Landroid/content/Context;)Lazmz;
    //   577: aconst_null
    //   578: ldc 217
    //   580: iconst_1
    //   581: lconst_0
    ...
    //   583: aconst_null
    //   584: ldc 24
    //   586: invokevirtual 220	azmz:a	(Ljava/lang/String;Ljava/lang/String;ZJJLjava/util/HashMap;Ljava/lang/String;)V
    //   589: aload 9
    ...
    //   622: invokevirtual 251	aphm:b	(Ljava/lang/String;)V
    //   625: aload_1
    //   626: iconst_0
    //   627: invokevirtual 254	aphm:c	(Z)V
    //   630: aload_1
    //   631: iconst_0
    //   632: invokevirtual 256	aphm:d	(Z)V
    //   635: goto -46 -> 589
    //   638: aload_1
    //   639: ifnull -50 -> 589
    //   642: aload_1
    //   643: iconst_1
    //   644: invokevirtual 256	aphm:d	(Z)V
    //   647: goto -58 -> 589
    ...
    //   673: invokestatic 215	azmz:a	(Landroid/content/Context;)Lazmz;
    //   676: aconst_null
    //   677: ldc 217
    //   679: iconst_0
    //   680: lconst_0
    ...
    //   682: aload_1
    //   683: ldc 24
    //   685: invokevirtual 220	azmz:a	(Ljava/lang/String;Ljava/lang/String;ZJJLjava/util/HashMap;Ljava/lang/String;)V
    //   688: getstatic 32	baob:jdField_b_of_type_JavaIoFile	Ljava/io/File;
    //   691: astore_1
    //   692: aload_1
    //   693: areturn
    //   694: astore_1
