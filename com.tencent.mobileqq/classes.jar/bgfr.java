...
public class bgfr
{
  private static bgfr jdField_a_of_type_Bgfr;
  private Pattern jdField_a_of_type_JavaUtilRegexPattern = Pattern.compile("(\\d+)\\.(\\d+).(\\d+)_(\\d+)");
  
  public static bgfr a()
  {
    if (jdField_a_of_type_Bgfr == null) {}
    try
    {
      if (jdField_a_of_type_Bgfr == null) {
        jdField_a_of_type_Bgfr = new bgfr();
      }
      return jdField_a_of_type_Bgfr;
    }
    finally {}
  }
      ...
      try
      {
        ...
        if (localObject.length >= 2)
        {
          ...
          if ((paramString != null) && (localObject != null) && (paramString.length >= 4) && (localObject.length >= 4))
          {
            ...
            paramString = this.jdField_a_of_type_JavaUtilRegexPattern.matcher(bgxr.a());
            if (paramString.find())
            {
