  ...
  extends pxz
{
  ...
  private HashMap<String, pwy<Parcelable>> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  private ConcurrentHashMap<String, pwy<FastWebArticleInfo>> b = new ConcurrentHashMap();
  
  static
  {
    jdField_a_of_type_JavaLangString = pwt.class.getSimpleName();
  }
  
  public pwt(AppInterface paramAppInterface, EntityManager paramEntityManager, ExecutorService paramExecutorService, qnd paramqnd, Handler paramHandler)
  {
  ...
  {
    int i = biii.a(null);
    Object localObject = bmqa.f(pha.a());
  ...
  private void b()
  {
    this.jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache = new pwu(this, 2012, 30, 1);
  }
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int k = qnf.a(paramFromServiceMsg, paramObject, localRspBody);
    boolean bool1 = false;
    boolean bool2 = false;
    ...
    for (;;)
    {
      paramFromServiceMsg = (pwx)a(Integer.valueOf(i));
      ...
      if (str != null)
      {
        ...
        this.b.put(str, new pwy(this, paramToServiceMsg));
      }
      for (;;)
      {
        ...
        paramToServiceMsg.put("param_uin", pha.a());
        paramToServiceMsg.put("param_retCode", k + "");
        paramToServiceMsg.put("param_succ", String.valueOf(bool1));
        paramToServiceMsg.put("param_netType", biii.a(null) + "");
        bctj.a(BaseApplicationImpl.getApplication()).a(null, "actKandianFastWebCost", bool1, l, 0L, paramToServiceMsg, null);
        return;
        label534:
        if ((paramToServiceMsg != null) && (this.b.containsKey(str)))
        {
          paramFromServiceMsg = (pwy)this.b.get(str);
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int k = qnf.a(paramFromServiceMsg, paramObject, paramToServiceMsg);
    paramFromServiceMsg = new tbl();
    boolean bool;
    ...
    for (;;)
    {
      paramToServiceMsg = (pww)a(Integer.valueOf(i));
  ...
  private void f(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int k = qnf.a(paramFromServiceMsg, paramObject, localRspBody);
    paramFromServiceMsg = (tht)a(Integer.valueOf(i));
    paramToServiceMsg = "";
  ...
  public int a(String paramString1, String paramString2, String paramString3, int paramInt, pwx parampwx)
  {
    for (;;)
    {
      Object localObject1;
      try
      {
        QLog.d("Q.readinjoy.fast_web", 1, "getArticleContent, rowkey : " + paramString2 + ", url : " + paramString1 + " callback: " + parampwx + ", reqType : " + paramInt);
        if ((paramInt != 2) && (paramString2 != null))
        {
          localObject1 = (pwy)this.b.get(paramString2);
          if (localObject1 != null)
          {
            if (!((pwy)localObject1).a()) {
              continue;
            }
        ...
        ((oidb_cmd0xad6.Client)localObject2).bytes_version.set(ByteStringMicro.copyFromUtf8("8.4.1"));
        ...
        if (paramInt == 1)
        {
          ...
          paramString3 = qnf.a("OidbSvc.0xad6", 2774, 0, ((oidb_cmd0xad6.ReqBody)localObject1).toByteArray());
          ...
          if (parampwx != null)
          {
            parampwx.a(true, ((pwy)localObject1).a, (FastWebArticleInfo)((pwy)localObject1).a());
            oat.a(null, "CliOper", "", "", "0X8009C51", "0X8009C51", 0, 0, "", "", "", "", false);
          }
          QLog.d("Q.readinjoy.fast_web", 2, "hit cache, rowkey : " + paramString2 + ", url : " + paramString1 + " isUserWeb " + ((pwy)localObject1).a);
          return -1;
        }
        if (paramInt == 3)
        {
  ...
  {
    paramString = (pwy)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
  ...
  {
    paramString = (pwy)this.b.get(paramString);
    if (paramString != null) {
  ...
  {
    return tbx.a((List)this.jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache.get(paramString));
  }
  ...
  public void a(@NonNull ArticleInfo paramArticleInfo, int paramInt, tht paramtht)
  {
    ...
    for (;;)
    {
      ...
      localFeedParam.multi_level_info.set(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rgy.a());
      ...
      try
      {
        ...
        localObject = qnf.a("OidbSvc.0xbd3", 3027, 0, localReqBody.toByteArray());
        int i = this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.incrementAndGet();
  ...
  public void a(ArticleInfo paramArticleInfo, pww parampww, boolean paramBoolean)
  {
    Object localObject1 = new oidb_cmd0xb54.ReqBody();
    Object localObject2 = new oidb_cmd0xb54.Client();
    ((oidb_cmd0xb54.Client)localObject2).bytes_version.set(ByteStringMicro.copyFromUtf8("8.4.1"));
    ...
    if (bmqa.n(this.jdField_a_of_type_ComTencentCommonAppAppInterface) != 1) {
    ...
    Object localObject3 = (pwy)this.b.get(paramArticleInfo.innerUniqueID);
    if (localObject3 != null)
    {
      localObject3 = (FastWebArticleInfo)((pwy)localObject3).a();
    ...
    localObject1 = qnf.a("OidbSvc.0xb54", 2900, 0, ((oidb_cmd0xb54.ReqBody)localObject1).toByteArray());
    int i = this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.incrementAndGet();
  ...
  public void a(BaseArticleInfo paramBaseArticleInfo, List<BaseData> paramList)
  {
    ...
    qnb.a(localReqBody.bytes_qq, pha.a());
    Object localObject = new oidb_cmd0xe7e.WebInfo();
    qnb.a(((oidb_cmd0xe7e.WebInfo)localObject).bytes_url, paramBaseArticleInfo.mArticleContentUrl);
    try
    {
      qnb.a(((oidb_cmd0xe7e.WebInfo)localObject).bytes_domain, new URL(paramBaseArticleInfo.mArticleContentUrl).getHost());
      localReqBody.rpt_web_info.set((MessageMicro)localObject);
      qnb.a(localReqBody.bytes_rowkey, paramBaseArticleInfo.innerUniqueID);
      localObject = new ArrayList();
    ...
    catch (MalformedURLException localMalformedURLException)
    {
      for (;;)
      {
        qnb.a(((oidb_cmd0xe7e.WebInfo)localObject).bytes_domain, "post.mp.qq.com");
        ...
        if ((paramBaseArticleInfo instanceof PtsData))
        {
          ...
          a(qnf.a("OidbSvc.0xe7e", 3710, 0, localReqBody.toByteArray()));
        }
        else
        {
  ...
  {
    pwy localpwy = (pwy)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    if (localpwy == null)
    {
      paramParcelable = new pwy(this, paramParcelable);
      this.jdField_a_of_type_JavaUtilHashMap.put(paramString, paramParcelable);
      return;
    }
    localpwy.a(paramParcelable);
  }
  
  public void a(String paramString1, String paramString2, String paramString3, int paramInt, pww parampww)
  {
    oidb_cmd0xad7.ReqBody localReqBody = new oidb_cmd0xad7.ReqBody();
    Object localObject = new oidb_cmd0xad7.Client();
    ((oidb_cmd0xad7.Client)localObject).bytes_version.set(ByteStringMicro.copyFromUtf8("8.4.1"));
    ...
    try
    {
      ...
      if (paramInt == 72)
      {
        ...
        paramString3 = qnf.a("OidbSvc.0xad7", 2775, 0, localReqBody.toByteArray());
        int i = this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.incrementAndGet();
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (paramToServiceMsg = localRspBody.rpt_insert_module_info.get();; paramToServiceMsg = null)
    {
      ...
      pmk.a().a(new pwv(this, paramToServiceMsg, paramFromServiceMsg));
      return;
    }
  }
  ...
  public void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int j = qnf.a(paramFromServiceMsg, paramObject, localRspBody);
    paramFromServiceMsg = (pww)b(Integer.valueOf(i));
    paramObject = (pwy)this.b.get(str2);
    if (paramObject == null) {
      return;
    }
    ...
    if (j == 0)
    {
      pwz.a(localRspBody, paramObject, paramFromServiceMsg, str1);
      pwz.b(localRspBody, paramObject, paramFromServiceMsg, str1);
      pwz.a(localRspBody, paramObject, paramFromServiceMsg);
      pwz.c(localRspBody, paramObject, paramFromServiceMsg, str1);
      pwz.a(localRspBody, paramObject);
      if (((Boolean)paramToServiceMsg.getAttribute("fetchBusiness", Boolean.valueOf(false))).booleanValue()) {
        pwz.b(localRspBody, paramObject, paramFromServiceMsg);
      }
    }
    for (;;)
    {
