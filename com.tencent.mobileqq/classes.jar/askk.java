  ...
  implements Manager
{
  ...
  private asgf jdField_a_of_type_Asgf = new askl(this);
  private ashh jdField_a_of_type_Ashh;
  asld jdField_a_of_type_Asld;
  asln jdField_a_of_type_Asln;
  public aslo a;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  public String a;
  private WeakReference<askp> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  public askk(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Aslo = new askm(this);
  ...
  public static int a(QQAppInterface paramQQAppInterface)
  {
    ...
    Card localCard = ((anmw)paramQQAppInterface.getManager(51)).a(paramQQAppInterface.getCurrentAccountUin());
    int i;
    if (localCard == null)
    {
  ...
  public static void a(QQAppInterface paramQQAppInterface, ArrayList<ashw> paramArrayList)
  {
    if (paramQQAppInterface == null) {
    ...
    {
      return;
      paramArrayList = ashw.a(paramArrayList);
      paramQQAppInterface = paramQQAppInterface.getApp().getSharedPreferences(paramQQAppInterface.getCurrentAccountUin(), 0).edit();
  ...
  private void d()
  {
    ...
    do
    {
      ...
      try
      {
        ...
        Object localObject3 = ((aong)localObject1).getRecentList(false);
        ...
        if ((localObject3 != null) && (((List)localObject3).size() > 0))
        {
          ...
          while (((Iterator)localObject3).hasNext())
          {
            ...
            if ((localRecentUser.getType() == 1044) && (!localRecentUser.uin.equals(anhk.aT))) {
  ...
  public asld a()
  {
    if (this.jdField_a_of_type_Asld != null) {
      return this.jdField_a_of_type_Asld;
    }
    synchronized (jdField_b_of_type_JavaLangObject)
    {
      if (this.jdField_a_of_type_Asld != null)
      {
        asld localasld1 = this.jdField_a_of_type_Asld;
        return localasld1;
      }
    }
    this.jdField_a_of_type_Asld = new asld(this);
    asld localasld2 = this.jdField_a_of_type_Asld;
    return localasld2;
  }
  ...
  public asln a()
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (this.jdField_a_of_type_Asln != null)
      {
        asln localasln1 = this.jdField_a_of_type_Asln;
        return localasln1;
      }
    }
    this.jdField_a_of_type_Asln = new asln(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_a_of_type_Asln.a(this.jdField_a_of_type_Aslo);
    asln localasln2 = this.jdField_a_of_type_Asln;
    return localasln2;
  }
  
  public String a()
  {
    if (this.jdField_a_of_type_Ashh != null) {
      return this.jdField_a_of_type_Ashh.jdField_b_of_type_JavaLangString;
    }
    return "";
  }
  ...
  public void a()
  {
    this.jdField_a_of_type_Ashh = null;
  }
  ...
  public void a(askp paramaskp)
  {
    ...
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramaskp);
  }
  ...
  public void a(boolean paramBoolean, ashg paramashg)
  {
  ...
  public boolean a(Context paramContext)
  {
    ...
    if ((!this.jdField_c_of_type_Boolean) && (this.jdField_d_of_type_Boolean))
    {
      if (TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
        this.jdField_b_of_type_JavaLangString = paramContext.getString(2131698209);
      }
      if (TextUtils.isEmpty(this.jdField_c_of_type_JavaLangString)) {
        this.jdField_c_of_type_JavaLangString = paramContext.getString(2131698207);
      }
      if (TextUtils.isEmpty(this.jdField_d_of_type_JavaLangString)) {
        this.jdField_d_of_type_JavaLangString = "https://ti.qq.com/realname/index.html";
      }
      paramContext = bglp.a(paramContext, 230, this.jdField_b_of_type_JavaLangString, this.jdField_c_of_type_JavaLangString, paramContext.getString(2131698208), paramContext.getString(2131698210), new askn(this, paramContext), new asko(this));
  ...
  public void onDestroy()
  {
    if (this.jdField_a_of_type_Asln != null)
    {
      this.jdField_a_of_type_Asln.b();
      this.jdField_a_of_type_Asln = null;
    }
