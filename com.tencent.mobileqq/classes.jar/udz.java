...
public class udz
  implements ufn
{
  public udz(TextureVideoView paramTextureVideoView) {}
  ...
  public boolean a(ufk paramufk, int paramInt1, int paramInt2)
  {
    ...
    if ((this.a.jdField_a_of_type_Ufn != null) && (this.a.jdField_a_of_type_Ufn.a(paramufk, paramInt1, paramInt2))) {}
    ...
    {
      paramufk = TextureVideoView.a(this.a);
      if (paramufk == null) {
        break;
      }
      new AlertDialog.Builder(paramufk).setMessage(paramInt1).setPositiveButton(17039376, new uea(this)).setCancelable(false).show();
      return true;
    }
  }
}
