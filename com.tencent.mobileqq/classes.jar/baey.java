...
public class baey
  extends PopupWindow
  implements View.OnClickListener, Animation.AnimationListener, baeq, bafh
{
  ...
  private baey(BaseActivity paramBaseActivity, View paramView, int paramInt1, int paramInt2)
  {
    super(paramView, paramInt1, paramInt2);
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity = paramBaseActivity;
    this.jdField_a_of_type_Bafg = new bafg(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity);
  ...
  private static View a(baey parambaey, Activity paramActivity, int paramInt)
  {
    View localView = parambaey.getContentView();
    AtPanelTouchController localAtPanelTouchController = (AtPanelTouchController)localView.findViewById(2131364691);
    int i = actj.a(60.0F, paramActivity.getResources());
    IndexBar localIndexBar = (IndexBar)localView.findViewById(2131368074);
    XListView localXListView = (XListView)localView.findViewById(2131377855);
    ...
    for (localLayoutParams.height = -2;; localLayoutParams.height = -1)
    {
      ...
      localAtPanelTouchController.setAtPanelTouchListener(parambaey);
      ...
      if (((localListAdapter instanceof bafa)) && (((bafa)localListAdapter).b() == 1)) {
        localIndexBar.setVisibility(8);
      }
      i = actj.a(40.0F, paramActivity.getResources());
    }
  }
  
  public static baey a(BaseActivity paramBaseActivity, int paramInt1, int paramInt2)
  {
    View localView = LayoutInflater.from(paramBaseActivity).inflate(2131558570, null);
    baey localbaey = new baey(paramBaseActivity, localView, paramInt1, paramInt2);
    a(localbaey, paramBaseActivity, 1);
    localView.findViewById(2131369309).setBackgroundColor(localView.getResources().getColor(2131166829));
    localView.findViewById(2131362315).setBackgroundColor(localView.getResources().getColor(2131166829));
    localbaey.setFocusable(false);
    localView.setOnClickListener(localbaey);
    ((TextView)localView.findViewById(2131362836)).setOnClickListener(localbaey);
    ((RelativeLayout)localView.findViewById(2131362837)).setOnClickListener(localbaey);
    localbaey.setInputMethodMode(32);
    localbaey.setInputMethodMode(1);
    localbaey.setClippingEnabled(false);
    localbaey.setOutsideTouchable(true);
    if (AppSetting.d) {
      a(localbaey);
    }
    return localbaey;
  ...
  {
    View localView = getContentView().findViewById(2131362315);
    if (localView == null) {
      return;
    }
    localView.setVisibility(paramInt1);
    ((TextView)localView.findViewById(2131369508)).setText(localView.getResources().getText(paramInt2));
    if (paramInt2 != 2131689877) {}
    for (paramInt1 = 0;; paramInt1 = 8)
    {
      getContentView().findViewById(2131362229).setVisibility(paramInt1);
      return;
    }
  }
  ...
  public void dismiss()
  {
    this.jdField_a_of_type_Bafg.a();
    this.jdField_a_of_type_Bafg.a(null);
  ...
  {
    if (paramView.getId() == 2131362836) {
      if (this.jdField_a_of_type_Baez != null) {
        this.jdField_a_of_type_Baez.a(paramView);
      }
    }
    while (paramView.getId() == 2131362837) {
      return;
    }
    dismiss();
  }
  ...
  public void showAtLocation(View paramView, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    this.jdField_a_of_type_Bafg.a(this);
    this.jdField_a_of_type_Bafg.a(this.jdField_a_of_type_AndroidViewView);
  }
}
