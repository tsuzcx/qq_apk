  ...
  implements aeyv
{
  ...
  public ajdx(Context paramContext, View.OnClickListener paramOnClickListener)
  {
    ...
    paramContext = new RelativeLayout.LayoutParams(-1, actn.a(44.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()));
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(ajyc.a(2131702117));
    this.jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablePadding(actn.a(8.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()));
    ...
    paramContext = new RelativeLayout.LayoutParams(-2, actn.a(44.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()));
    paramContext.addRule(15);
    paramContext.leftMargin = actn.a(12.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
    ...
    localLayoutParams.rightMargin = actn.a(12.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
    ...
    localObject = new RelativeLayout.LayoutParams(-1, actn.a(44.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()));
    ...
    this.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131702118));
    this.jdField_b_of_type_AndroidWidgetTextView.setCompoundDrawablePadding(actn.a(8.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()));
    this.jdField_b_of_type_AndroidWidgetTextView.setCompoundDrawables(paramOnClickListener, null, null, null);
    paramOnClickListener = new RelativeLayout.LayoutParams(-2, actn.a(44.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()));
    paramOnClickListener.addRule(15);
    paramOnClickListener.leftMargin = actn.a(12.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
    ...
    ((RelativeLayout.LayoutParams)localObject).rightMargin = actn.a(12.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
