  ...
  extends aods
{
  ...
  public aody(QQAppInterface paramQQAppInterface, FriendListHandler paramFriendListHandler)
  {
  ...
  private void a(FromServiceMsg paramFromServiceMsg, CheckUpdateResp paramCheckUpdateResp)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppFriendListHandler.a(paramCheckUpdateResp);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
    if ((aone.a) && (bguq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))) {
      if (!bbum.b()) {
        break label173;
      }
    }
    ...
    for (int i = 1;; i = 0)
    {
      ...
      bguq.f(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, true);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a();
      return;
    }
    bguq.e(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false);
  }
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (1000 == paramFromServiceMsg.getResultCode())
    {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqAppFriendListHandler.a(str1, str2, true);
    ...
    if ((paramFromServiceMsg.isSuccess()) && (paramObject != null))
    {
      ...
      if (paramObject.cResult == 0)
      {
        ...
        if (localanmw != null)
        {
          ...
          paramFromServiceMsg = localanmw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
  ...
  private void f(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (j == 0)
    {
      ...
      paramFromServiceMsg = (awmz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(11);
      if (paramFromServiceMsg != null) {
      ...
      try
      {
        ...
        if ((bool) && (paramToServiceMsg.bytes_bodybuffer != null) && (paramToServiceMsg.bytes_bodybuffer.has()) && (paramToServiceMsg.bytes_bodybuffer.get() != null))
        {
          ...
          if (k == -1)
          {
            ...
            if (i < j)
            {
              String str = String.valueOf(bgjw.a(paramToServiceMsg.getInt()));
              ...
              if (QLog.isColorLevel())
              {
                ...
                paramObject.append(bgjw.a((String)localObject));
              }
  ...
  private void h(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppFriendListHandler.a = paramFromServiceMsg.dwInterval;
      a(68, true, new Object[] { Long.valueOf(l), paramToServiceMsg, paramFromServiceMsg });
      return;
      if ((l == 1L) && (paramFromServiceMsg.result == 0)) {
        ((awmz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(11)).a(paramToServiceMsg, paramFromServiceMsg);
      }
    }
  }
