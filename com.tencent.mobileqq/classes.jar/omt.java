...
public class omt
{
  ...
  public omt(int paramInt1, int paramInt2, BaseCommentData paramBaseCommentData, ArticleInfo paramArticleInfo)
  {
  ...
  public omt(int paramInt, BaseCommentData paramBaseCommentData, ArticleInfo paramArticleInfo)
  {
  ...
  private CharSequence a(SubCommentData paramSubCommentData)
  {
    ...
    if (paramSubCommentData.hasTarget())
    {
      ...
      if (!TextUtils.isEmpty(paramSubCommentData.repliedUserNickname))
      {
        ...
        localSpannableStringBuilder.setSpan(new omw(this, paramSubCommentData), i, localSpannableStringBuilder.length(), 33);
  ...
  private void a(SpannableStringBuilder paramSpannableStringBuilder)
  {
    ...
    paramSpannableStringBuilder.setSpan(new omy(this, null), i, paramSpannableStringBuilder.length(), 33);
  }
  ...
  private void a(SpannableStringBuilder paramSpannableStringBuilder, String paramString1, String paramString2, String paramString3, BaseCommentData paramBaseCommentData)
  {
    ...
    paramSpannableStringBuilder.setSpan(new omx(this, paramBaseCommentData, paramString2, paramString3), i, paramSpannableStringBuilder.length(), 33);
  }
  ...
  public void a()
  {
    ...
    for (this.jdField_a_of_type_JavaLangCharSequence = new bamp(azah.b(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData.commentContent), 3, this.d);; this.jdField_a_of_type_JavaLangCharSequence = new bamp(a((SubCommentData)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData), 3, this.d))
    {
      ...
      while ((i < j) && ((this.c == null) || (this.c.size() <= 2)))
      {
        ...
        if ((localObject1 != null) && (((SubCommentData)localObject1).isAuthorReply()))
        {
          ...
          {
            a((SpannableStringBuilder)localObject2, ((SubCommentData)localObject1).nickName, ((SubCommentData)localObject1).uin, new oke(this).a().a(), (BaseCommentData)localObject1);
          ...
          if (!TextUtils.isEmpty(((SubCommentData)localObject1).repliedUserNickname))
          {
            ...
            a((SpannableStringBuilder)localObject2, ((SubCommentData)localObject1).repliedUserNickname, ((SubCommentData)localObject1).repliedUserUin, new oke(this).a().b(((SubCommentData)localObject1).repliedUserUin).a(), (BaseCommentData)localObject1);
          }
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(((SubCommentData)localObject1).nickName))
      {
        ...
        ((SpannableStringBuilder)localObject2).setSpan(new omu(this, (SubCommentData)localObject1), 0, ((SpannableStringBuilder)localObject2).length(), 33);
      }
      if ((((SubCommentData)localObject1).hasTarget()) && (!TextUtils.isEmpty(((SubCommentData)localObject1).repliedUserNickname)))
      {
        ...
        ((SpannableStringBuilder)localObject2).setSpan(new omv(this, (SubCommentData)localObject1), k, ((SpannableStringBuilder)localObject2).length(), 33);
      }
