...
public class oay
  implements Manager
{
  private MQLruCache<Long, oao> jdField_a_of_type_AndroidSupportV4UtilMQLruCache = new MQLruCache(50);
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private EntityManager jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager;
  
  public oay(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager = paramQQAppInterface.getEntityManagerFactory().createEntityManager();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
  }
  
  public static oay a(QQAppInterface paramQQAppInterface)
  {
    return (oay)paramQQAppInterface.getManager(QQManagerFactory.ACCOUNT_DETAIL_DYNAMIC_DATA_MANAGER);
  }
  ...
  public int a(boolean paramBoolean1, long paramLong1, long paramLong2, long paramLong3, ArrayList<String> paramArrayList, boolean paramBoolean2)
  {
    try
    {
      oao localoao1 = new oao();
      localoao1.jdField_a_of_type_Long = paramLong1;
      localoao1.c = paramLong3;
      localoao1.b = paramLong2;
      localoao1.jdField_a_of_type_Boolean = paramBoolean1;
      oao localoao2 = (oao)this.jdField_a_of_type_AndroidSupportV4UtilMQLruCache.get(Long.valueOf(paramLong1));
      if (localoao2 != null)
      {
        if (paramLong3 == 0L) {
          localoao1.b = localoao2.b;
        }
        if (!paramBoolean1) {
          localoao1.a(localoao2.a());
        }
      }
      localoao1.b(paramArrayList);
      if (QLog.isColorLevel()) {
        QLog.d("AccountDetailDynamicDataManager", 2, "updateAccountDetailDynamicInfoCache puin:" + paramLong1 + " last_msg_id:" + localoao1.b + " msg_cnt:" + paramLong3 + " isFirstEnter:" + paramBoolean1 + " isFromDB:" + paramBoolean2);
      }
      this.jdField_a_of_type_AndroidSupportV4UtilMQLruCache.put(Long.valueOf(paramLong1), localoao1);
      return 0;
    }
    finally {}
  }
  ...
  public ArrayList<oap> a(long paramLong)
  {
    oao localoao = a(paramLong);
    if (localoao == null) {
      return null;
    }
    return localoao.a();
  ...
  public oao a(long paramLong)
  {
    return (oao)this.jdField_a_of_type_AndroidSupportV4UtilMQLruCache.get(Long.valueOf(paramLong));
  }
  
  public oao a(String paramString)
  {
    long l2 = 0L;
    try
    {
  ...
  public void a(QQAppInterface paramQQAppInterface, long paramLong, aoav paramaoav)
  {
    ArrayList localArrayList = a(paramLong);
    if ((localArrayList == null) || (localArrayList.isEmpty())) {
      ThreadManager.post(new AccountDetailDynamicDataManager.2(this, paramLong, paramQQAppInterface, paramaoav), 8, null, true);
    }
  }
