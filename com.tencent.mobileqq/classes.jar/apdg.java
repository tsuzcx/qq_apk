...
public class apdg
{
  private static apdg jdField_a_of_type_Apdg;
  ...
  private apdi jdField_a_of_type_Apdi;
  ...
  private apdg()
  {
    try
    {
      ...
      this.jdField_a_of_type_Apdi = new apdi(this, BaseApplicationImpl.getContext());
  ...
  {
    if (jdField_a_of_type_Apdg == null) {
      jdField_a_of_type_Apdg = new apdg();
    }
    return jdField_a_of_type_Apdg;
  }
  ...
  public int a(apwh paramapwh, Bundle paramBundle, long paramLong, int paramInt)
  {
    if (-1 == paramInt)
    {
      paramInt = a();
    ...
    while (paramapwh != null)
    {
      paramapwh.a(new apdh(this, ThreadManager.getSubThreadHandler().getLooper(), paramInt, paramBundle, paramLong), false);
      return paramInt;
  ...
  public Notification a(Bundle paramBundle)
  {
    ...
    if (paramBundle != null)
    {
      ...
      ((Notification)localObject1).icon = 2130843548;
      paramBundle = new RemoteViews(BaseApplication.getContext().getPackageName(), 2131560497);
      paramBundle.setImageViewResource(2131370949, 2130843544);
      ...
      float f1 = this.jdField_a_of_type_Apdi.a();
      if (this.jdField_a_of_type_Apdi.a() <= 0.0F)
      {
      ...
      float f2 = this.jdField_a_of_type_Apdi.b();
      f1 = f2;
      if (f2 <= 0.0F)
      {
      ...
      try
      {
        int i = this.jdField_a_of_type_Apdi.a().intValue();
  ...
  protected void a(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    {
      return;
      paramNotification.tickerText = (BaseApplication.getContext().getString(2131720618) + " " + paramBundle1.getString("_notify_param_Filename"));
      paramNotification.contentView.setImageViewResource(2131370949, 2130843544);
      int i = paramBundle2.getInt("_START_WAITING_");
      if (1 == i)
      {
        paramNotification.contentView.setTextViewText(2131370945, BaseApplication.getContext().getString(2131720619));
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    ...
    if (localNotification != null)
    {
      ...
      apcy.a().b(paramBundle.getString("_notify_param_Url"));
      return;
    }
  ...
  protected void a(int paramInt, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    localNotification.tickerText = (BaseApplication.getContext().getString(2131720612) + " " + paramBundle1.getString("_notify_param_Filename"));
    ...
    localObject = BaseApplication.getContext().getString(2131720614);
    if (apwc.a(str1) != null)
    {
      localBitmap = apwc.a(str1);
      localObject = BaseApplication.getContext().getString(2131720613);
    }
    if (localBitmap == null)
    {
      int j = apue.b(str1);
      if (j != 0)
      {
        ...
        label236:
        localNotification.contentView.setImageViewResource(2131370949, 2130843546);
      }
    }
    for (;;)
    {
  ...
  public void b(int paramInt, Bundle paramBundle)
  {
    ...
    if (localNotification != null)
    {
      ...
      apcy.a().a(paramBundle.getString("_notify_param_Url"), paramBundle.getString("_notify_param_Filename"), paramBundle.getString("_notify_param_ContentTitle", ""), paramBundle.getLong("_notify_param_Filesize"), paramBundle.getBundle("_notify_param_userdata"), paramInt, true);
      return;
    }
  ...
  protected void c(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    paramNotification.tickerText = null;
    int i = paramBundle2.getInt("_FILE_PROGRESS_");
    paramNotification.contentView.setImageViewResource(2131370949, 2130843547);
    paramNotification.contentView.setViewVisibility(2131370948, 0);
    paramNotification.contentView.setViewVisibility(2131370944, 8);
    paramNotification.contentView.setTextViewText(2131370948, BaseApplication.getContext().getString(2131720617));
    paramNotification.contentView.setProgressBar(2131370943, 100, i, false);
    paramNotification.contentView.setTextViewText(2131370945, "" + i + "%");
  ...
  protected void d(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    if (2 == i)
    {
      paramNotification.tickerText = BaseApplication.getContext().getString(2131720616);
      paramNotification.contentView.setTextViewText(2131370948, BaseApplication.getContext().getString(2131720616));
      label115:
    ...
    for (;;)
    {
      ...
      paramNotification.tickerText = (BaseApplication.getContext().getString(2131720615) + " " + paramBundle1.getString("_notify_param_Filename"));
      paramNotification.contentView.setTextViewText(2131370948, apwh.a(i) + ajyc.a(2131715882));
      break label115;
      label397:
      paramNotification.contentView.setOnClickPendingIntent(2131370950, paramBundle2);
    }
