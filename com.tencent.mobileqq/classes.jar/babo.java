  ...
  implements Manager
{
  ...
  private final BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new babq(this);
  private final GuardProcessExitListener jdField_a_of_type_ComTencentMobileqqAppGuardProcessExitListener = new babp(this);
  ...
  public babo(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(Context paramContext)
  {
    ...
    if ((localbabr != null) && (localbabr.a()) && (bdin.a(paramContext)))
    {
      ...
      if (l - this.jdField_a_of_type_Long > 1800000L)
      {
        ...
        bacn.a(paramContext, new Bundle(), true, new bacp());
      }
    }
    else
    {
  ...
  public void a(Context paramContext, HashMap<String, String> paramHashMap)
  {
    ...
    for (;;)
    {
      ...
      if (j != 0)
      {
        ...
        QQToast.a(paramContext, 2131696354, 1).b(paramContext.getResources().getDimensionPixelSize(2131298914));
        return;
      }
