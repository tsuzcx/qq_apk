  ...
  implements affa
{
  ...
  public affg(BaseChatPie paramBaseChatPie)
  {
  ...
  private awge a(awge paramawge)
  {
    ...
    //   0	214	0	this	affg
    //   0	214	1	paramawge	awge
    //   75	47	2	i	int
    //   73	10	3	j	int
    //   54	56	4	localawge1	awge
    //   125	47	4	localException	Exception
    //   177	35	4	localObject	Object
    //   50	58	5	localawge2	awge
  ...
  public static FileManagerEntity a(bbtn parambbtn)
  {
    ...
    if (arso.a(parambbtn.jdField_b_of_type_JavaLangString))
    {
      ...
      localFileManagerEntity.nFileType = arrr.a(parambbtn.g);
    ...
    for (;;)
    {
      ...
      localFileManagerEntity.strTroopFilePath = parambbtn.e;
      ...
      QLog.i("MultiFavoriteHelper", 1, "=_= create new Entity[" + localFileManagerEntity.nSessionId + "] fileName[" + parambbtn.g + "] by troop size(" + localFileManagerEntity.imgHeight + ":" + localFileManagerEntity.imgWidth + ")");
      ...
      for (int i = Integer.parseInt((String)localObject); (i == 1) || (i == 2) || (i == 3); i = -1)
      {
        ...
        for (;;)
        {
          ...
          if (i == 1)
          {
            ...
            label148:
            ((FileManagerEntity)localObject).peerNick = arrr.a(paramQQAppInterface, ((FileManagerEntity)localObject).peerUin, null, ((FileManagerEntity)localObject).peerType);
  ...
  public static String a(QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage)
  {
    ...
    do
    {
      ...
      if (paramChatMessage.isMultiMsg)
      {
        ...
        if (!nav.a(paramChatMessage))
        {
          ...
          if (TextUtils.isEmpty(str2)) {
            str1 = aupg.a().a(paramChatMessage.senderuin, paramChatMessage.msgseq, paramQQAppInterface);
          }
        }
      }
      if (str1 != null)
      ...
      {
        paramQQAppInterface = aupn.a(paramChatMessage.senderuin);
      }
  ...
  private ArrayList<ChatMessage> a(MessageForStructing paramMessageForStructing, ArrayList<ChatMessage> paramArrayList)
  {
    ...
    //   100: aload_0
    //   101: aload 7
    //   103: invokespecial 457	affg:a	(Lawge;)Lawge;
    ...
    //   348: goto -279 -> 69
    //   351: aload 7
    //   353: invokevirtual 492	com/tencent/mobileqq/data/ChatMessage:deepCopyByReflect	()Lawge;
  ...
  private void a(aeqo paramaeqo, ChatMessage paramChatMessage)
  {
    if ((paramChatMessage == null) || (paramaeqo == null)) {}
    for (;;)
    {
      return;
      ...
      bivp.a().a = false;
      paramaeqo.a.a(paramChatMessage, paramaeqo).a(2131366017, this.jdField_a_of_type_AndroidContentContext, paramChatMessage);
      if (bivp.a().a) {
        bivp.a().a = false;
      }
      while (ajxm.a().c())
  ...
  private void a(List<ChatMessage> paramList)
  {
    ...
    {
      return;
      afcq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramList, 4);
      aupg.a().b(paramList);
      if (QLog.isColorLevel()) {
    ...
    aupg.a().jdField_a_of_type_Int = 6;
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof agso)) {
      this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo = aupg.a().a();
    }
  ...
  private void a(List<ChatMessage> paramList, List<String> paramList1)
  {
    ...
    for (;;)
    {
      ...
      while (paramList.hasNext())
      {
        String str = abti.c((ChatMessage)paramList.next());
  ...
  private boolean a(ChatMessage paramChatMessage)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return false;
        } while (!aupn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage));
        if (!(paramChatMessage instanceof MessageForStructing)) {
          break;
        }
      } while (((MessageForStructing)paramChatMessage).structingMsg.mMsgServiceID != 35);
      return true;
    } while (((paramChatMessage instanceof MessageForArkApp)) || (((paramChatMessage instanceof MessageForPic)) && (ahbf.a((MessageForPic)paramChatMessage))));
    return true;
  }
  ...
  public void a(BaseChatPie paramBaseChatPie, aeqo paramaeqo, MessageForStructing paramMessageForStructing)
  {
    if (QLog.isColorLevel()) {
      QLog.d("MultiFavoriteHelper", 2, "onClickMultiFavoriteBtn");
    }
    int i = aupg.a().c();
    azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009C5B", "0X8009C5B", 0, i, "", "", "", "");
    if (paramMessageForStructing == null)
    {
      paramMessageForStructing = aupg.a().a();
      if (paramMessageForStructing.size() == 1)
      {
        localArrayList = aupn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ArrayList)paramMessageForStructing);
        if ((localArrayList != null) && (localArrayList.size() > 0))
        {
          paramMessageForStructing = (ChatMessage)localArrayList.get(0);
          a(paramaeqo, paramMessageForStructing);
          paramBaseChatPie.a(false, null, false);
        }
      }
    }
    while (!bivs.a(paramMessageForStructing))
    {
      for (;;)
      {
      ...
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131698782, 0).b(paramBaseChatPie.a());
      return;
    }
    paramaeqo = new ArrayList();
    paramaeqo.add(paramMessageForStructing);
    for (;;)
    {
      bivp.a().a = true;
      if (!a(paramaeqo, aupg.a().a()))
      {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131694201, 0).b(paramBaseChatPie.a());
        return;
      }
      i = a(paramaeqo);
      paramMessageForStructing = paramaeqo;
      if (i > 0)
      {
        if (paramaeqo.size() == i)
        {
          QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131694594, 0).b(paramBaseChatPie.a());
          paramBaseChatPie.a(false, null, false);
          return;
        }
        ...
        {
          bivs.b(paramMessageForStructing);
          a(this.jdField_a_of_type_AndroidContentContext.getString(2131693511), this.jdField_a_of_type_AndroidContentContext.getString(2131694595), new affh(this, paramaeqo, paramBaseChatPie));
          return;
        }
      ...
      return;
      label423:
      paramaeqo = paramMessageForStructing;
    }
  }
  ...
  public void a(BaseChatPie paramBaseChatPie, LinearLayout paramLinearLayout, boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_AndroidWidgetImageView == null)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetImageView.setId(2131364220);
        if (AppSetting.c) {
          this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(alud.a(2131707390));
        }
      }
      ...
      localObject = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839184);
      paramBaseChatPie.addState(new int[] { 16842919 }, (Drawable)localObject);
      localObject = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839183);
  ...
  public void a(String paramString1, String paramString2, DialogInterface.OnClickListener paramOnClickListener)
  {
    try
    {
      bdgm.a(this.jdField_a_of_type_AndroidAppActivity, 230, null, paramString1, "", paramString2, new affi(this, paramOnClickListener), null).show();
      return;
    }
  ...
  public void a(Map<String, String> paramMap, ArrayList<ChatMessage> paramArrayList, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 0) {
      localObject1 = bdgc.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    }
    for (;;)
    {
      if ((paramArrayList != null) && (paramArrayList.size() == 1) && (bivs.a((ChatMessage)paramArrayList.get(0))))
      {
        localObject1 = (MessageForStructing)paramArrayList.get(0);
        localObject2 = null;
        label87:
        paramArrayList = biva.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForStructing)localObject1, (List)localObject2, paramMap);
        ...
        paramArrayList = this.jdField_a_of_type_AndroidContentContext.getString(paramArrayList.getIntExtra("nReasonInt", 2131692403));
      ...
      {
        localObject1 = acjm.a((Context)localObject2, (String)localObject1, paramArrayList, paramMap, bool);
        if (localObject1 == null) {
          break;
        }
        MessageForStructing localMessageForStructing = aupg.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_b_of_type_JavaLangString, (AbsStructMsg)localObject1);
      ...
      label399:
      bivc.a(this.jdField_a_of_type_AndroidContentContext, paramMap, bool, null, false);
      return;
      label412:
