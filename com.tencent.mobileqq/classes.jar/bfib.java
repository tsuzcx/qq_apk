  ...
  extends bfhq
{
  ...
  public bfib(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo)
  {
  ...
  public bfhr a(int paramInt1, List<Long> paramList, long paramLong1, Object paramObject, long paramLong2, long paramLong3, int paramInt2)
  {
    ...
    {
      if ((StructMsgForGeneralShare)bcwd.a(paramObject.msgData) == null) {
        if (QLog.isColorLevel()) {
          QLog.d(this.jdField_a_of_type_JavaLangString, 2, "showNavigateBarIfNeeded() :calendarMsg getStructMsg is null");
        }
      }
      for (paramList = this.jdField_a_of_type_AndroidContentContext.getString(2131696556);; paramList = StructMsgForGeneralShare.remindBrief)
      {
        ...
        bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_calendar", "", "notice", "exp", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.b, "", "");
  ...
  {
    bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_calendar", "", "notice", "Clk", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.b, "", "");
  }
}
