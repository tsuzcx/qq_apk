...
public class bfib
{
  ...
  private List<bfiq> jdField_a_of_type_JavaUtilList = new ArrayList();
  private List<String> b = new ArrayList();
  
  public bfib(JSONObject paramJSONObject)
  {
      ...
      try
      {
        ...
        if (localObject != null)
        {
          ...
          if (i < ((JSONArray)localObject).length())
          {
            ...
            this.jdField_a_of_type_JavaUtilList.add(new bfiq(localJSONObject));
            break label248;
          }
        }
  ...
  public boolean a(Object paramObject)
  {
    if (!this.jdField_a_of_type_JavaUtilList.isEmpty())
    {
      ...
      {
        bfiq localbfiq = (bfiq)localIterator.next();
        if (!localbfiq.a()) {
          return false;
        }
        if (!localbfiq.a(paramObject)) {
          return false;
        }
      }
      return true;
