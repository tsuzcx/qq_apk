...
public class bdit
{
  ...
  private static bdiw jdField_a_of_type_Bdiw = new bdiw(Looper.getMainLooper(), null);
  ...
  private static BlockingQueue<WeakReference<bdit>> jdField_a_of_type_JavaUtilConcurrentBlockingQueue = new LinkedBlockingQueue();
  ...
  public static int a(Context paramContext)
  {
    ...
    try
    {
      ...
      while (bdnw.a())
      {
        bdnw.a("PushOpenNotify", "isNotificationEnabled,  isEnabled, " + bool);
        break;
    ...
    {
      if (bdnw.a()) {
        bdnw.a("PushOpenNotify", " isNotificationEnabled, get except, " + paramContext.getMessage());
      }
      i = 2;
      return i;
    }
  ...
  public static bdit a(Context paramContext, int paramInt1, CharSequence paramCharSequence, int paramInt2)
  {
    paramContext = new bdit(paramContext);
  ...
  public static bdit a(Context paramContext, CharSequence paramCharSequence, int paramInt)
  {
  ...
  public static boolean a(Context paramContext, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if ((jdField_a_of_type_Int == -1) || (paramBoolean))
      {
        ...
        bdnw.a("QQToast", "canUseCustomToast = " + jdField_a_of_type_Int);
        if ((i == 0) && (jdField_a_of_type_Int == 1)) {
          bdnw.a("QQToast", "Temp Report mark: now Notification from disable to Enabled ");
        }
      }
  ...
  {
    return a(paramInt, 2131493738, null);
  }
  
  public Toast a(int paramInt1, int paramInt2, View.OnTouchListener paramOnTouchListener)
  {
    bdiv localbdiv = new bdiv(this.jdField_a_of_type_AndroidContentContext);
    ...
    if (this.jdField_a_of_type_AndroidGraphicsDrawableDrawable != null)
    {
      ...
      localbdiv.setGravity(55, 0, 0);
    }
    for (;;)
    {
      localbdiv.setView(localView);
      localbdiv.setDuration(this.jdField_c_of_type_Int);
      if (a()) {
        localView.setOnTouchListener(new bdiu(this, localbdiv, paramOnTouchListener));
      }
      return localbdiv;
      ...
      if (paramInt1 == 6316128) {
        localbdiv.setGravity(55, 0, a());
      } else {
        localbdiv.setGravity(55, 0, b());
      }
    }
  }
  ...
  public void a()
  {
    ...
    jdField_a_of_type_Bdiw.sendEmptyMessage(2);
  }
