...
public class bfmn
{
  ...
  public bfmn(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_MqqObserverBusinessObserver = new bfmo(this);
  ...
  public void a(long paramLong, int paramInt, JSONObject paramJSONObject)
  {
    ...
    NewIntent localNewIntent = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), bfmm.class);
