...
{
  public ljn(ReadInJoyCommentComponentFragment paramReadInJoyCommentComponentFragment) {}
  ...
  public void afterTextChanged(Editable paramEditable)
  {
    ...
    for (;;)
    {
      ...
      this.a.f.setImageResource(2130840727);
      return;
      ...
      break label51;
      label261:
      this.a.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.a.getResources().getColor(2131493495));
    ...
    this.a.f.setImageResource(2130840861);
  }
