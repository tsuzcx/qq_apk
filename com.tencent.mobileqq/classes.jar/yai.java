  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        boolean bool2 = bhwm.a().a(paramMessage);
        boolean bool3 = bbfj.h(BaseApplicationImpl.getContext());
        boolean bool4 = bbdh.e();
        if (bbdx.a() <= 1.048576E+008F) {
          bool1 = true;
        }
        yah.a(this.a, "SmartDeviceProxyMgr check plugin: isInstalled " + bool2 + " isWifiConnected " + bool3 + " lowPhone = " + bool4 + " lowMemory = " + bool1);
      ...
      try
      {
        if (yah.a(this.a) != null)
        {
          paramMessage = new Bundle();
          paramMessage.putString("notify_cmd", "getServerDeviceList");
          paramMessage = yah.a(this.a).a(paramMessage);
          if (paramMessage != null)
          {
            ...
            if (paramMessage != null)
            {
              ...
              yah.a(this.a, arrayOfDeviceInfo);
