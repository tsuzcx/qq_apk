...
{
  public int a;
  private LinkedHashMap<String, List<ahyq>> jdField_a_of_type_JavaUtilLinkedHashMap = new LinkedHashMap();
  ...
  public bcdq(List<ahyq> paramList)
  {
    this.jdField_a_of_type_JavaUtilList = paramList;
    this.jdField_c_of_type_JavaUtilList = new ArrayList();
  }
  
  private bcdr a(QQAppInterface paramQQAppInterface, TroopInfo paramTroopInfo, String paramString, bcdr parambcdr, boolean paramBoolean)
  {
    if (((bcde.a(paramQQAppInterface, paramTroopInfo)) || (bcde.b(paramQQAppInterface, paramTroopInfo))) && (!paramBoolean))
    {
      paramQQAppInterface = bcdp.a();
      if ((TextUtils.isEmpty(paramString)) || (bcdp.a(paramString, paramQQAppInterface))) {
        parambcdr.jdField_a_of_type_JavaUtilList.add(0, paramQQAppInterface);
      }
    }
    return parambcdr;
  }
  
  private bcdr a(String paramString, boolean paramBoolean, TroopInfo paramTroopInfo)
  {
  ...
  private List<ahyq> a(LinkedHashMap<String, List<ahyq>> paramLinkedHashMap)
  {
  ...
  private Object[] a(String paramString, TroopInfo paramTroopInfo)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((localahyq.jdField_a_of_type_Boolean) || ((!TextUtils.isEmpty(paramString)) && (bcde.a(localahyq.jdField_a_of_type_JavaLangString, paramTroopInfo)))) {
          break label664;
        }
        if ((TextUtils.isEmpty(paramString)) || (!bcde.b(localahyq.jdField_a_of_type_JavaLangString, paramTroopInfo))) {
          break label228;
        }
      }
      finally {}
      ...
      ((List)localLinkedHashMap.get(localObject2)).add(localahyq);
      continue;
      label228:
      localObject1 = localahyq.x;
      if ((localObject1 == null) || (((String)localObject1).length() == 0)) {
        break label688;
      }
      localObject1 = ((String)localObject1).substring(0, 1);
    }
    paramTroopInfo = new bcdi(paramTroopInfo);
  ...
  public bcdr a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean1, SessionInfo paramSessionInfo, boolean paramBoolean2)
  {
    ...
    for (this.jdField_b_of_type_JavaUtilList = bcdp.a(paramQQAppInterface, this.jdField_a_of_type_JavaUtilList, paramBoolean1);; this.jdField_b_of_type_JavaUtilList = new ArrayList(bcdp.a(paramString, bcdp.a(paramQQAppInterface, this.jdField_a_of_type_JavaUtilList, paramBoolean1), paramQQAppInterface, localTroopInfo))) {
