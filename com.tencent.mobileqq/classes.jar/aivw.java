  ...
  implements aivg, aiwf
{
  ...
  public aivw(QQAppInterface paramQQAppInterface, aiwh paramaiwh, Context paramContext, XPanelContainer paramXPanelContainer, List<QQOperationViopTipTask> paramList, SessionInfo paramSessionInfo, aggs paramaggs)
  {
  ...
  private void b(QQOperationViopTipTask paramQQOperationViopTipTask)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Aiwh.a(this, new Object[] { paramQQOperationViopTipTask });
      return;
      i = 0;
    }
  }
  ...
  public View a(Object... paramVarArgs)
  {
    if ((paramVarArgs[0] instanceof QQOperationViopTipTask))
    {
      ...
      View localView = LayoutInflater.from((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).inflate(2131561064, null);
      TextView localTextView = (TextView)localView.findViewById(2131374291);
      Button localButton = (Button)localView.findViewById(2131374288);
      localTextView.setText(paramVarArgs.adwords);
      localButton.setText(paramVarArgs.clickableWord);
      localButton.setOnClickListener(new aivx(this, paramVarArgs));
      return localView;
    }
    return null;
  }
  ...
  public MessageRecord a(Object... paramVarArgs)
  {
    ...
    {
      paramVarArgs = (QQOperationViopTipTask)paramVarArgs[0];
      MessageRecord localMessageRecord = bcry.a(-1041);
      long l = bcrg.a();
  ...
  {
    arrs localarrs = arrs.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    ...
    for (;;)
    {
      ...
      if (paramList.hasNext())
      {
        ...
        localQQOperationViopTipTask = localarrs.a(i);
      ...
      for (;;)
      {
        ...
        if ((!localQQOperationViopTipTask.isGryTipsTask()) || (localarrs.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, 2))) {
          break;
        }
