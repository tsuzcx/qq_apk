...
public class bdaw
{
  ...
  private static bdaw jdField_a_of_type_Bdaw;
  ...
  {
    int j = 0;
    if (!bdaw.class.desiredAssertionStatus()) {}
    for (boolean bool = true;; bool = false)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          Object localObject = aqql.b(BaseApplicationImpl.getContext());
  ...
  public static bdaw a()
  {
    if (jdField_a_of_type_Bdaw == null) {}
    try
    {
      if (jdField_a_of_type_Bdaw == null) {
        jdField_a_of_type_Bdaw = new bdaw();
      }
      return jdField_a_of_type_Bdaw;
    }
    finally {}
  }
