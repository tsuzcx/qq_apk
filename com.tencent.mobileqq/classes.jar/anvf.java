  ...
  extends Handler
{
  ...
  public anvf(Looper paramLooper, QQAppInterface paramQQAppInterface, anux paramanux)
  {
    super(paramLooper);
    this.jdField_a_of_type_Anux = paramanux;
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    Object localObject1 = (anvb)paramMessage.obj;
    label270:
    boolean bool;
    for (;;)
    {
      try
      {
        ...
        default: 
          ...
          if (System.currentTimeMillis() - this.b > 300000L)
          {
            ...
            localObject1 = (anvc)this.jdField_a_of_type_Anux.a(1);
            if (localObject1 != null) {
              paramMessage.append(((anvc)localObject1).a());
            }
            localObject1 = (anvg)this.jdField_a_of_type_Anux.a(2);
            if (localObject1 != null) {
              paramMessage.append(((anvg)localObject1).a()).append("\n");
            }
      ...
      finally
      {
        ...
        Object localObject2 = (anvc)this.jdField_a_of_type_Anux.a(1);
        if (localObject2 == null) {
          continue;
        }
        ((StringBuilder)localObject1).append(((anvc)localObject2).a());
        localObject2 = (anvg)this.jdField_a_of_type_Anux.a(2);
        if (localObject2 == null) {
          continue;
        }
        ((StringBuilder)localObject1).append(((anvg)localObject2).a()).append("\n");
        QLog.d("Q.fts.BgCpu.Total", 1, ((StringBuilder)localObject1).toString());
        this.d = 0L;
        this.c = 0L;
        this.b = System.currentTimeMillis();
      }
      if (((anvb)localObject1).c())
      {
      ...
      else if (QLog.isColorLevel())
      {
        ...
        if (((anvb)localObject1).d()) {
          ((anvb)localObject1).e();
        }
        bool = this.jdField_a_of_type_Anux.b;
        if (bool)
        {
          this.d += SystemClock.currentThreadTimeMillis() - l3;
          this.c += System.currentTimeMillis() - l2;
