...
public class bhpu
{
  public static final SparseArray<ConcurrentHashMap<String, bhpu>> a;
  public static final AccelerateInterpolator a;
  public static final ConcurrentHashMap<String, bhpu> a;
  public byte a;
  float jdField_a_of_type_Float = 1.0F;
  long jdField_a_of_type_Long;
  public ArrayList<WeakReference<bhpv>> a;
  long b = 0L;
  long c = 0L;
  ...
  static bhpu a(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      bhpu localbhpu2 = (bhpu)localConcurrentHashMap.get(paramString);
      bhpu localbhpu1 = localbhpu2;
      if (localbhpu2 == null)
      {
        localbhpu1 = new bhpu();
        localConcurrentHashMap.put(paramString, localbhpu1);
      }
      return localbhpu1;
    }
  }
  
  public static bhpu a(Object paramObject)
  {
    bhpu localbhpu = null;
    if ((paramObject instanceof bhhh)) {
      localbhpu = a(1, ((bhhh)paramObject).a());
    }
    do
    {
      return localbhpu;
      ...
      if ((paramObject instanceof bgya)) {
        return a(3, ((bgya)paramObject).a);
      }
      if ((paramObject instanceof MusicItemInfo)) {
        return a(2, ((MusicItemInfo)paramObject).mMusicName);
      }
      if ((paramObject instanceof bhhk)) {
        return a(4, ((bhhk)paramObject).a());
      }
    } while (!(paramObject instanceof bhhr));
    return a(5, ((bhhr)paramObject).a());
  }
  ...
  public void a(float paramFloat)
  {
    ...
    if (i >= 0)
    {
      bhpv localbhpv = (bhpv)((WeakReference)this.jdField_a_of_type_JavaUtilArrayList.get(i)).get();
      if (localbhpv == null) {
  ...
  public void a(bhpv parambhpv)
  {
    int i = this.jdField_a_of_type_JavaUtilArrayList.size() - 1;
    while (i >= 0)
    {
      bhpv localbhpv = (bhpv)((WeakReference)this.jdField_a_of_type_JavaUtilArrayList.get(i)).get();
      if ((localbhpv == null) || (localbhpv == parambhpv)) {
        this.jdField_a_of_type_JavaUtilArrayList.remove(i);
      }
      i -= 1;
    }
  ...
  public void b(bhpv parambhpv)
  {
    this.jdField_a_of_type_JavaUtilArrayList.add(new WeakReference(parambhpv));
  }
