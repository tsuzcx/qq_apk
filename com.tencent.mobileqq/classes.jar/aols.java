...
public class aols
  extends aolh
{
  public aols(QQAppInterface paramQQAppInterface, FriendListHandler paramFriendListHandler)
  {
  ...
  private void a(FromServiceMsg paramFromServiceMsg, DelFriendResp paramDelFriendResp)
  {
    ...
    paramFromServiceMsg = (PhoneContactManagerImp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.CONTACT_MANAGER);
    if (paramFromServiceMsg != null) {
      paramFromServiceMsg.b();
    }
    ((anvk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER)).d(String.valueOf(paramDelFriendResp.deluin));
    bbdk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramDelFriendResp.deluin + "");
    bejj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramDelFriendResp.deluin + "");
    ...
    paramFromServiceMsg = (axny)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.NEARBY_CARD_MANAGER);
    if (paramFromServiceMsg != null) {
  ...
  private void a(ToServiceMsg paramToServiceMsg, boolean paramBoolean)
  {
    ...
    bhdd.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext(), paramToServiceMsg, i);
    ...
    if (paramAddFriendResp.result == 0)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          for (;;)
          {
            ((anvk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER)).a().a((String)localObject);
            if (QLog.isColorLevel())
            {
            ...
            break;
            if (bpup.a(j)) {
              ((PhoneContactManagerImp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.CONTACT_MANAGER)).a((String)localObject, k, str2);
            }
          }
        }
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramFromServiceMsg != null) && (paramFromServiceMsg.isSuccess()) && (paramObject != null))
    {
      ...
      m = j * 30;
      localPhoneContactManagerImp = (PhoneContactManagerImp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.CONTACT_MANAGER);
      bool1 = bool2;
      if (bool2)
      {
