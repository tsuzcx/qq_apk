...
public class ajkp
{
  ...
  public static ajkp a()
  {
    try
    {
      if (jdField_a_of_type_Ajkp == null) {
        jdField_a_of_type_Ajkp = new ajkp();
      }
      ajkp localajkp = jdField_a_of_type_Ajkp;
      return localajkp;
    }
    finally {}
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    {
      return;
      localajmw = (ajmw)paramQQAppInterface.getManager(155);
      localObject1 = localajmw.a(paramSessionInfo);
    ...
    if (i >= 0)
    {
      ...
      ApolloGameData localApolloGameData = localajmw.a(((MessageForApollo)localObject1).gameId);
      if ((localApolloGameData == null) || (!ajmt.a("8.2.8", localApolloGameData.minVer, localApolloGameData.maxVer))) {
        break label262;
      }
    }
    label262:
        ...
        do
        {
          do
          {
            do
            {
              ...
              localObject1 = localajmw.a(((MessageForApollo)localObject1).gameId);
            } while ((localObject1 != null) && (ajmt.a("8.2.8", ((ApolloGameData)localObject1).minVer, ((ApolloGameData)localObject1).maxVer)));
            paramQQAppInterface = ((ajfg)paramQQAppInterface.getManager(249)).a();
