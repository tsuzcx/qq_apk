...
class ajkp
  implements Runnable
{
  ajkp(ajko paramajko, ArithmeticInfo.ArithmeticImageInfo paramArithmeticImageInfo) {}
  
  public void run()
  {
    ArithmeticViewHolder.a(this.jdField_a_of_type_Ajko.a).a();
    ArithmeticViewHolder.ArithmeticImageView localArithmeticImageView = (ArithmeticViewHolder.ArithmeticImageView)ArithmeticViewHolder.a(this.jdField_a_of_type_Ajko.a).get(this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkXmediaeditorModelArithmeticInfo$ArithmeticImageInfo);
