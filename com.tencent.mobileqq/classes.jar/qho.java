  ...
  extends ViewBase
{
  ...
  public qho(VafContext paramVafContext)
  {
  ...
  private void a(int paramInt)
  {
    ...
    if (!this.jdField_a_of_type_JavaUtilArrayList.isEmpty())
    {
      ...
      localObject = "还Biu了" + this.i + amtj.a(2131712090);
    }
    label132:
    label183:
    label332:
    ...
    for (;;)
    {
      ...
      for (paramInt = this.c * paramInt;; paramInt = (paramInt - 1) * this.c)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131165432));
        ...
        localObject = amtj.a(2131712224) + k + "人也Biu了";
        break;
        k = this.jdField_a_of_type_JavaUtilArrayList.size();
        break label132;
        k = m * this.c + this.d;
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (int m = 20;; m = 0)
    {
      ...
      localImageView.setBackgroundResource(2130849340);
