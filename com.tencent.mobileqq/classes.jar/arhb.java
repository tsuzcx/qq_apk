  ...
  extends WebViewPlugin
{
  ...
  public long a;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new arhg(this);
  protected Context a;
  private Handler jdField_a_of_type_AndroidOsHandler = new arhe(this, Looper.getMainLooper());
  private arei jdField_a_of_type_Arei;
  private argk jdField_a_of_type_Argk;
  ...
  private void a(long paramLong, String paramString)
  {
    ...
    this.jdField_a_of_type_Argk.a(str + "/av_" + System.currentTimeMillis() + this.jdField_a_of_type_Argk.a(), new arhd(this));
    ...
    catch (JSONException paramString2)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          argo.a(paramString2, this.e, String.valueOf(this.jdField_a_of_type_Long), this.jdField_a_of_type_JavaLangString, str1, (String)localObject1, String.valueOf(this.jdField_b_of_type_Long), this.jdField_b_of_type_JavaLangString, new arhf(this, paramLong, paramString1));
          return;
  ...
  {
    int i = this.jdField_a_of_type_Argk.c();
  ...
  {
    arhh.a.jdField_a_of_type_Int = -1;
    if (paramString == null) {
      return;
    }
    JSONObject localJSONObject = new JSONObject();
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          catch (Exception paramJsBridgeListener)
          {
            ...
            {
              bbjn.b(this.mRuntime.a().getApp().getApplicationContext());
              arhh.a.a(this.mRuntime.a(), paramString1.getQueryParameter("p"));
              a(this.d, 0);
            ...
            {
              arhh.a.b(this.mRuntime.a(), paramString1.getQueryParameter("p"));
              this.d = paramJsBridgeListener;
              if (arhh.a.jdField_a_of_type_Int != -1)
              {
                a(this.d, arhh.a.jdField_a_of_type_Int);
                return false;
              }
              arhh.a.a(this.mRuntime.a(), new arhc(this));
              return false;
            }
          }
        }
    ...
    arhh.a.jdField_a_of_type_Boolean = false;
    arhh.a.a(11, null);
    return false;
  }
  ...
  public void onCreate()
  {
    ...
    a(" onCreate");
    this.jdField_a_of_type_Argk = new argk(this.jdField_a_of_type_AndroidContentContext, 1);
    this.jdField_a_of_type_Arei = new arei();
    ...
    IntentFilter localIntentFilter = new IntentFilter(arfw.a(this.f));
    localIntentFilter.addAction(arfw.b(this.f));
    localIntentFilter.addAction(arfw.c(this.f));
    localIntentFilter.addAction(arfw.d(this.f));
