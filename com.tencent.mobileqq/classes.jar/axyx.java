...
public class axyx
  extends axyy
{
  private ArrayList<axvj> jdField_a_of_type_JavaUtilArrayList;
  private boolean jdField_a_of_type_Boolean = true;
  private OnlineStatusPermissionChecker.OnlineStatusPermissionItem b;
  
  public axyx(@NonNull BaseActivity paramBaseActivity, axut paramaxut)
  {
    super(paramBaseActivity, paramaxut);
  }
  
  private void a(ArrayList<axvj> paramArrayList)
  {
  ...
  private boolean d()
  {
    ...
    if (this.jdField_a_of_type_JavaUtilArrayList.size() != this.jdField_a_of_type_Axvx.a().size()) {
      return true;
    }
    Iterator localIterator1 = this.jdField_a_of_type_Axvx.a().iterator();
    for (;;)
    {
      if (localIterator1.hasNext())
      {
        axvj localaxvj1 = (axvj)localIterator1.next();
        ...
        do
        {
          ...
          localaxvj2 = (axvj)localIterator2.next();
        } while (localaxvj1.a != localaxvj2.a);
      }
      for (int i = 1; i == 0; i = 0)
      {
        return true;
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetButton.setText(2131694201);
    if (paramBoolean2)
    {
  ...
  protected boolean a(boolean paramBoolean)
  {
    ...
    if ((this.b == null) && (localaxvp.a(this.jdField_a_of_type_ComTencentMobileqqOnlinestatusOnlineStatusPermissionChecker$OnlineStatusPermissionItem, this))) {
      return true;
    }
    if ((this.b != null) && (c())) {
      return true;
  ...
  protected void b()
  {
    ...
    this.jdField_a_of_type_Axvx.a(this.jdField_a_of_type_JavaUtilArrayList);
  }
  ...
  public ArrayList<Integer> c()
  {
    ...
    while (((Iterator)localObject).hasNext()) {
      localArrayList.add(Integer.valueOf((int)((axvj)((Iterator)localObject).next()).a));
    }
    return localArrayList;
  }
  ...
  public void c()
  {
    ...
    a(this.jdField_a_of_type_Axvx.a());
  }
