...
public class atiz
  implements bbhc, bbtj<atjd>
{
  private int jdField_a_of_type_Int = 0;
  private long jdField_a_of_type_Long;
  private Context jdField_a_of_type_AndroidContentContext;
  protected anif a;
  private atih jdField_a_of_type_Atih;
  private bbgx jdField_a_of_type_Bbgx;
  private bbtk<atjd> jdField_a_of_type_Bbtk;
  ...
  private List<bbgl> jdField_b_of_type_JavaUtilList;
  private boolean jdField_b_of_type_Boolean;
  private List<bewg> jdField_c_of_type_JavaUtilList;
  private boolean jdField_c_of_type_Boolean;
  private volatile boolean d = true;
  
  public atiz(QQAppInterface paramQQAppInterface, Context paramContext, long paramLong, int paramInt, atih paramatih)
  {
    this.jdField_a_of_type_Anif = new atja(this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_Long = paramLong;
    this.jdField_a_of_type_Atih = paramatih;
  }
  ...
  private void a(QQAppInterface paramQQAppInterface, long paramLong, List<Long> paramList, String paramString1, String paramString2)
  {
    for (;;)
    {
      ...
      ((anie)paramQQAppInterface.a(22)).a("GroupFileAppSvr.GetFileSearch", paramList.toByteArray(), (Bundle)localObject);
  ...
  private void a(boolean paramBoolean, List<bewg> paramList)
  {
  ...
  private void b(String paramString)
  {
    for (;;)
    {
      ...
      this.jdField_a_of_type_Bbgx = null;
      label96:
      QLog.i("TroopFileSearchEngine<QFile>", 4, "execSearch. success.");
      this.jdField_a_of_type_Bbgx = new bbgx(paramString, paramString, this.jdField_b_of_type_JavaUtilList, this);
      this.jdField_a_of_type_Bbgx.a();
    }
  }
  ...
  public List<atjd> a(bbtx parambbtx)
  {
    return null;
  }
  ...
  public void a(bbtx parambbtx, bbtk<atjd> parambbtk)
  {
