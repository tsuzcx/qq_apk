  ...
  extends BaseAdapter
{
  ...
  public atiz(Context paramContext, Comments paramComments, VideoData paramVideoData, atlp paramatlp, Paint paramPaint, int paramInt)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewLayoutInflater = LayoutInflater.from(paramContext);
    this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments = paramComments;
    this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelVideoData = paramVideoData;
    this.jdField_a_of_type_Atlp = paramatlp;
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    Object localObject;
    if ((this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments.a != null) && (this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments.a.size() > 0)) {
      if ((paramView == null) || (!(paramView.getTag() instanceof atjd)))
      {
        paramView = new atjd();
        localObject = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131560878, paramViewGroup, false);
        paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject).findViewById(2131368542));
        paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)((View)localObject).findViewById(2131378262));
        paramView.jdField_b_of_type_AndroidWidgetTextView = ((TextView)((View)localObject).findViewById(2131378109));
        paramView.jdField_c_of_type_AndroidWidgetTextView = ((TextView)((View)localObject).findViewById(2131378293));
        ...
        ((View)localObject).setTag(2131364483, paramView);
        ...
        localObject = baxt.a((AppInterface)localObject, 32, str2, 3, paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.getResources().getDrawable(2130844585), paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.getResources().getDrawable(2130844585));
        ...
        paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new atja(this, l1, l2, l3));
        ...
        paramView.setTag(2131364474, this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments.a.get(paramInt));
        paramView.setTag(2131364524, this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments);
    ...
    {
      return localObject;
      paramViewGroup = (atjd)paramView.getTag();
      break;
      ...
      break label318;
      atiu.a().a(paramViewGroup.jdField_a_of_type_AndroidWidgetImageView, ((Comments.Comment)this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments.a.get(paramInt)).jdField_c_of_type_JavaLangString, paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.getResources().getDrawable(2130844585), paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.getResources().getDrawable(2130844585), null, true);
      break label469;
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        for (;;)
        {
          ...
          paramView.findViewById(2131369434).setOnClickListener(new atjb(this));
    ...
    label910:
    paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131560869, paramViewGroup, false);
