...
class apdo
  implements bieg<WeiyunPB.LibInfoListGetMsgRsp>
{
  apdo(apdn paramapdn, String paramString) {}
  ...
  public void a(int paramInt, String paramString, WeiyunPB.LibInfoListGetMsgRsp paramLibInfoListGetMsgRsp)
  {
    ...
    apdn.a(this.jdField_a_of_type_Apdn).a().a(false, 31, new Object[] { Integer.valueOf(paramInt), paramString, this.jdField_a_of_type_JavaLangString });
  }
  ...
  public void a(WeiyunPB.LibInfoListGetMsgRsp paramLibInfoListGetMsgRsp)
  {
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      localWeiYunFileInfo.jdField_b_of_type_JavaLangString = bige.a(((WeiyunPB.FileItem)localObject2).pdir_key.get());
      ...
      localWeiYunFileInfo.i = bige.a(((WeiyunPB.FileItem)localObject2).file_md5.get());
      localWeiYunFileInfo.j = bige.a(((WeiyunPB.FileItem)localObject2).file_sha.get());
      if (!apdn.a(this.jdField_a_of_type_Apdn).containsKey(localWeiYunFileInfo.jdField_a_of_type_JavaLangString))
      {
        apdn.a(this.jdField_a_of_type_Apdn).put(localWeiYunFileInfo.jdField_a_of_type_JavaLangString, localWeiYunFileInfo);
        localArrayList.add(localWeiYunFileInfo);
      }
    }
    localObject1 = apdn.a(this.jdField_a_of_type_Apdn).a();
    Object localObject2 = this.jdField_a_of_type_JavaLangString;
    if (paramLibInfoListGetMsgRsp.finish_flag.get() == 1) {}
    for (boolean bool = true;; bool = false)
    {
      ((aozg)localObject1).a(true, 31, new Object[] { localObject2, Boolean.valueOf(bool), Integer.valueOf(paramLibInfoListGetMsgRsp.FileItem_items.size()), paramLibInfoListGetMsgRsp.server_version.get(), localArrayList, Integer.valueOf(apdn.a(this.jdField_a_of_type_Apdn)) });
      return;
    }
  }
}
