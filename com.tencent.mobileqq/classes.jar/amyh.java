...
public class amyh
{
  ...
  private static LruCache<String, amyi> a;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = amxv.jdField_a_of_type_JavaLangString + "combo" + File.separator;
    ...
    jdField_b_of_type_JavaLangString = amxv.jdField_a_of_type_JavaLangString;
  ...
  public static amyi a(int paramInt)
  {
    return a(jdField_a_of_type_JavaLangString + jdField_a_of_type_ArrayOfJavaLangString[paramInt], 2);
  }
  
  public static amyi a(String paramString, int paramInt)
  {
    int i = 0;
    Object localObject1 = (amyi)jdField_a_of_type_AndroidUtilLruCache.get(paramString);
    ...
    for (;;)
    {
      ...
      localamyi.jdField_a_of_type_Int = i;
      localamyi.b = paramInt;
      localamyi.jdField_a_of_type_AndroidGraphicsDrawableDrawable = ((Drawable)localObject2);
      jdField_a_of_type_AndroidUtilLruCache.put(paramString, localamyi);
      return localamyi;
      i = aciy.a(k / jdField_a_of_type_Float, localamyi);
      paramInt = aciy.a(j / jdField_a_of_type_Float, localamyi);
      continue;
      paramInt = aciy.a(32.0F, localamyi);
      i = (int)(paramInt / j * k);
      continue;
      paramInt = aciy.a(24.0F, localamyi);
      i = (int)(paramInt / j * k);
    }
  }
