  ...
  implements Manager
{
  ...
  public arwz(QQAppInterface paramQQAppInterface)
  {
  ...
  public List<EmosmPb.SmallYellowItem> a()
  {
    ...
    if ((this.jdField_a_of_type_JavaUtilList == null) || (this.jdField_a_of_type_JavaUtilList.size() < 1))
    {
      ...
      if (i < this.jdField_a_of_type_ArrayOfInt.length)
      {
        ...
        if (j > arvq.a())
        {
          ...
          label180:
          if (!arvk.a().a(((EmosmPb.SmallYellowItem)localObject2).type.get()).b(((EmosmPb.SmallYellowItem)localObject2).id.get())) {
            break label307;
          }
          if (QLog.isColorLevel()) {
    ...
    if ((!this.jdField_a_of_type_Boolean) && (localList != null))
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        if (arvk.a().a(localSmallYellowItem.type.get()).b(localSmallYellowItem.id.get())) {
  ...
  public List<EmosmPb.SmallYellowItem> a(List<EmosmPb.SmallYellowItem> paramList1, List<EmosmPb.SmallYellowItem> paramList2)
  {
    ...
    for (List<EmosmPb.SmallYellowItem> localList = paramList2;; localList = null)
    {
      ...
      for (;;)
      {
        ...
        Collections.sort(localList, new arxa(this));
        d(localList);
        ...
        while (paramList2.hasNext())
        {
          ...
          if ((paramList1.contains(str)) || (arvk.a().a(localSmallYellowItem.type.get()).b(localSmallYellowItem.id.get()))) {
            paramList2.remove();
          } else {
            paramList1.add(str);
          }
  ...
  public void a(File paramFile1, File paramFile2)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      localObject2 = bgmg.a(paramFile1);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (((Iterator)localObject2).hasNext())
        {
          ...
          if (localSmallYellowItem.id.get() == bdnh.c[i]) {
            ((Iterator)localObject2).remove();
          }
        }
        else
        {
          ...
          bgmg.a(paramFile2.getAbsolutePath(), paramFile1.toByteArray(), false);
          return;
        }
      }
  ...
  public void a(List<EmosmPb.SmallYellowItem> paramList)
  {
    ...
    this.jdField_a_of_type_Boolean = asdb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false);
    if (QLog.isColorLevel())
    {
  ...
  public List<EmosmPb.SmallYellowItem> c()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      localObject3 = bgmg.a((File)localObject3);
