  ...
  extends arvv
{
  ...
  {
    return FileUtil.filesizeToString(paramWeiYunFileInfo.jdField_a_of_type_Long);
  }
  ...
  {
    paramAsyncImageView.setDefaultImage(2130844201);
  ...
  public View getChildView(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      try
      {
        localObject2 = new arxa(this);
        localObject1 = paramView;
        paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131560753, paramViewGroup, false);
        localObject1 = paramView;
        ((arxa)localObject2).jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131376021));
        localObject1 = paramView;
        ((arxa)localObject2).jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this.b);
        localObject1 = paramView;
        ((arxa)localObject2).jdField_a_of_type_AndroidWidgetRelativeLayout.setOnLongClickListener(this.jdField_a_of_type_AndroidViewView$OnLongClickListener);
        localObject1 = paramView;
        ((arxa)localObject2).jdField_a_of_type_AndroidWidgetRelativeLayout.setTag(localObject2);
        localObject1 = paramView;
        ((arxa)localObject2).jdField_a_of_type_ComTencentMobileqqWidgetCircleFileStateView = ((CircleFileStateView)paramView.findViewById(2131361941));
        localObject1 = paramView;
        ((arxa)localObject2).jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)paramView.findViewById(2131366644));
        localObject1 = paramView;
        ((arxa)localObject2).jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView = ((AsyncImageView)paramView.findViewById(2131366631));
        localObject1 = paramView;
        ((arxa)localObject2).jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setOnClickListener(this.b);
        localObject1 = paramView;
        ((arxa)localObject2).jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setTag(localObject2);
        localObject1 = paramView;
        ((arxa)localObject2).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131366642));
        localObject1 = paramView;
        ((arxa)localObject2).jdField_a_of_type_AndroidWidgetTextView.setGravity(48);
        localObject1 = paramView;
        ((arxa)localObject2).jdField_a_of_type_AndroidWidgetTextView.setMaxLines(2);
        localObject1 = paramView;
        ((arxa)localObject2).jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131366629));
        localObject1 = paramView;
        ((arxa)localObject2).jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131369605));
        localObject1 = paramView;
        ((arxa)localObject2).jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setAsyncClipSize(AIOUtils.dp2px(70.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), AIOUtils.dp2px(70.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
        localObject1 = paramView;
      ...
      try
      {
        i = aszt.a(localWeiYunFileInfo.c);
        aszt.a(paramViewGroup.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView, localWeiYunFileInfo.h, i);
        ...
        if ((aszt.a(localWeiYunFileInfo.c) == 0) && (FileUtils.fileExistsAndNotEmpty(localWeiYunFileInfo.h))) {
        ...
        localObject1 = atbg.b(localWeiYunFileInfo.b) + a((String)localObject2, (String)localObject1);
        paramViewGroup.jdField_c_of_type_AndroidWidgetTextView.setText((CharSequence)localObject1);
        localObject2 = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.app.getFileManagerRSCenter().a(localWeiYunFileInfo.jdField_a_of_type_JavaLangString);
        ...
        if (localObject2 == null)
        {
          localObject2 = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.app.getFileManagerDataCenter().c(localWeiYunFileInfo.jdField_a_of_type_JavaLangString);
          localObject1 = localObject2;
          if (localObject2 != null)
          {
            localObject1 = localObject2;
            if (!FileUtil.fileExistsAndNotEmpty(((FileManagerEntity)localObject2).getFilePath()))
            {
      ...
      paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(aslg.a(localWeiYunFileInfo));
      ...
      return paramView;
      localObject1 = paramView;
      paramViewGroup = (arxa)paramView.getTag();
      continue;
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetCircleFileStateView.setVisibility(0);
