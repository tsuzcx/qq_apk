...
public abstract class baqp
  implements baob, baof
{
  ...
  private static baqr<baof> listeners = new baqr();
  private static baqr<WeakReference<baof>> weakListeners = new baqr();
  ...
  private String getSavePath(Context paramContext, String paramString)
  {
  ...
  protected void _onCompleted(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      bace.a(paramQQAppInterface, paramString2, false);
      return;
    }
  ...
  public void download(QQAppInterface paramQQAppInterface, int paramInt, baof parambaof, boolean paramBoolean)
  {
    download(paramQQAppInterface, getScid(paramInt), parambaof, paramBoolean);
  }
  ...
  public void download(QQAppInterface paramQQAppInterface, long paramLong, String paramString, baof parambaof, boolean paramBoolean)
  {
    if (FlatBuffersParser.c())
    {
      ...
      if (parambaof != null) {
        parambaof.onCompleted(paramQQAppInterface, paramLong, paramString, "", "BaseUpdateCallback", 10086, 0);
      }
    }
    do
    {
    ...
    } while (parambaof == null);
    parambaof.onCompleted(paramQQAppInterface, paramLong, paramString, "", "BaseUpdateCallback", 10087, 0);
    return;
    ...
    for (;;)
    {
      if (parambaof != null)
      {
        ...
        weakListeners.a((String)localObject, new WeakReference(parambaof));
      }
      for (;;)
      {
        QLog.e("BaseUpdateCallback", 1, "download: " + paramLong + "_" + paramString + ", " + parambaof);
        ...
        parambaof.onCompleted(paramQQAppInterface, paramLong, paramString, "", "BaseUpdateCallback", 10088, 0);
        return;
        listeners.a((String)localObject, parambaof);
      }
    }
  }
  ...
  public void download(QQAppInterface paramQQAppInterface, String paramString, baof parambaof, boolean paramBoolean)
  {
    download(paramQQAppInterface, getBID(), paramString, parambaof, paramBoolean);
  }
  ...
  public final void onCompleted(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2)
  {
    ...
    for (localObject1 = listeners.b((String)localObject2);; localObject1 = listeners.a((String)localObject2))
    {
      ...
      while (((Iterator)localObject1).hasNext()) {
        ((baof)((Iterator)localObject1).next()).onCompleted(paramQQAppInterface, paramLong, paramString1, paramString2, paramString3, paramInt1, paramInt2);
      }
    ...
    for (localObject1 = weakListeners.b((String)localObject2);; localObject1 = weakListeners.a((String)localObject2))
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        localObject2 = (baof)((WeakReference)((Iterator)localObject1).next()).get();
        if (localObject2 != null) {
          ((baof)localObject2).onCompleted(paramQQAppInterface, paramLong, paramString1, paramString2, paramString3, paramInt1, paramInt2);
        }
      }
    }
  }
  ...
  public final void onProgress(QQAppInterface paramQQAppInterface, long paramLong1, String paramString1, String paramString2, long paramLong2, long paramLong3)
  {
    ...
    for (boolean bool = false;; bool = ((VasQuickUpdateEngine.TagItemInfo)localObject1).bPreConfig)
    {
      ...
      while (((Iterator)localObject2).hasNext()) {
        ((baof)((Iterator)localObject2).next()).onProgress(paramQQAppInterface, paramLong1, paramString1, paramString2, paramLong2, paramLong3);
      }
    }
    ...
    while (((Iterator)localObject1).hasNext())
    {
      localObject2 = (baof)((WeakReference)((Iterator)localObject1).next()).get();
      if (localObject2 != null) {
        ((baof)localObject2).onProgress(paramQQAppInterface, paramLong1, paramString1, paramString2, paramLong2, paramLong3);
      }
    }
  }
  
  public void removeListener(long paramLong, String paramString, baof parambaof)
  {
    paramString = getKey(paramLong, paramString, "");
    listeners.a(paramString, parambaof, false);
    weakListeners.a(paramString, parambaof, true);
  }
}
