...
public class accr
  extends ameq
{
  public accr(AddFriendVerifyActivity paramAddFriendVerifyActivity) {}
  ...
  protected void a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    default: 
      AddFriendVerifyActivity.b(this.a, 1002);
      this.a.jdField_a_of_type_Bety.dismiss();
      QQToast.a(this.a, 1, 2131719237, 1).b(this.a.getTitleBarHeight());
    case -2: 
      do
      {
        return;
      ...
      ((amdu)this.a.app.a(20)).b(Long.parseLong(this.a.jdField_a_of_type_JavaLangString), Long.parseLong(this.a.app.getAccount()));
    ...
    case 1: 
      ...
      for (;;)
      {
        try
        {
          ...
          athj.a("closeJoinWebView", null, paramString, null);
          return;
        }
    ...
    AddFriendVerifyActivity.b(this.a, 1002);
    this.a.jdField_a_of_type_Bety.dismiss();
    QQToast.a(this.a, 1, 2131721057, 1).b(this.a.getTitleBarHeight());
  }
  ...
  protected void a(boolean paramBoolean, TroopInfo paramTroopInfo, String paramString)
  {
    if (paramBoolean)
    {
      ...
      if (i == 4) {
        ...
        {
          paramString = aepi.a(new Intent(this.a, SplashActivity.class), null);
  ...
  protected void a(boolean paramBoolean, String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (!paramBoolean)
    {
      QQToast.a(this.a, this.a.getString(2131696668), 0).b(this.a.getTitleBarHeight());
  ...
  {
    if (!bdeu.a(String.valueOf(paramLong), this.a.jdField_a_of_type_JavaLangString)) {}
    label262:
    do
    {
      do
      ...
      paramTroopInfo = this.a.getString(2131697975, new Object[] { this.a.app.getCurrentNickname() }) + paramTroopInfo;
