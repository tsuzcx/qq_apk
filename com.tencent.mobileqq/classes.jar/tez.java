...
public class tez
{
  private static QQHashMap<String, teh> jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap = new QQHashMap(2019, 10, 10000);
  public static String a;
  private static Map<String, tfa> jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  public static teh a(String paramString)
  {
    try
    {
      paramString = (teh)jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.get(paramString);
      return paramString;
    }
    finally
    {
  ...
  public static tfa a(String paramString)
  {
    tfa localtfa = (tfa)jdField_a_of_type_JavaUtilMap.get(paramString);
    if (localtfa != null) {
      return localtfa;
    }
    localtfa = new tfa();
    ...
    if (str == null)
    {
      ...
      localtfa.a = false;
      jdField_a_of_type_JavaUtilMap.put(paramString, localtfa);
      return localtfa;
    }
    str = str + paramString;
  ...
  public static void a(String paramString, teh paramteh)
  {
    try
    {
      jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.put(paramString, paramteh);
      return;
    }
    finally
    {
  ...
  public static boolean a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    {
      return false;
      paramString3 = a("8.4.1");
      paramString3.add(Integer.valueOf(Integer.parseInt("4680")));
  ...
  {
    String str = bmqa.a("default_feeds_proteus_offline_bid");
    bgmg.a(nku.a(str) + str);
  }
}
