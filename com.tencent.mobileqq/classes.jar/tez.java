...
public class tez
  extends AsyncTask<tfb, tfd, tfc>
{
  public final stw a;
  
  public tez(stw paramstw)
  {
    if (paramstw == null) {
  ...
  public static String a(String paramString)
  {
    ...
    //   57: ldc 50
    //   59: ldc 52
    //   61: invokestatic 57	ved:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   64: aload_3
    //   65: astore_0
    //   66: aload_2
    //   67: ifnull +9 -> 76
    ...
    //   85: invokestatic 67	tez:a	([B)Ljava/lang/String;
    //   88: astore 4
    //   90: aload 4
    //   92: astore_3
    //   93: aload_3
  ...
  {
    ved.b("FileDownloadTask", paramString);
  }
  ...
  public static boolean a(String paramString1, String paramString2)
  {
    ...
    ved.b("FileDownloadTask", "expectedMd5 = " + paramString2);
    ved.b("FileDownloadTask", "file Md5    = " + paramString1);
  ...
  protected tfc a(tfb... paramVarArgs)
  {
    ...
    if (a(paramVarArgs.b, paramVarArgs.c))
    {
      ...
      return new tfc(paramVarArgs, 0, "has local file already");
    }
    this.a.a(new tfa(this, paramVarArgs));
    ...
    if ((i == 0) && (!a(paramVarArgs.b, paramVarArgs.c)))
    {
      ...
      try
      {
        vyf.d(paramVarArgs.b);
        return new tfc(paramVarArgs, -1, "file md5 mismatch");
      }
    ...
    return new tfc(paramVarArgs, i, "error=" + i);
  }
}
