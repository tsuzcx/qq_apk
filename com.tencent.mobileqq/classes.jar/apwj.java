  ...
  implements apts<String>
{
  ...
  public ConcurrentHashMap<String, aovu> a;
  public boolean a;
  public String b;
    ...
    try
    {
      ...
      if ((localObject1 != null) && (((JSONArray)localObject1).length() > 0))
      {
        ...
        if (i < ((JSONArray)localObject1).length())
        {
          ...
          if (!TextUtils.isEmpty((CharSequence)localObject2))
          {
            localObject3 = new aovu();
            ((aovu)localObject3).jdField_a_of_type_JavaLangString = ((String)localObject2);
            ((aovu)localObject3).jdField_a_of_type_Int = j;
