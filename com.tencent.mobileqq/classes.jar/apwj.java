...
public class apwj
{
  ...
  private apwm jdField_a_of_type_Apwm = new apwk(this);
  private Object jdField_a_of_type_JavaLangObject = new Object();
  private List<apwm> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  public apwj(long paramLong, String paramString, Bundle paramBundle)
  {
  ...
  public static String a(int paramInt)
  {
    ...
    case 1: 
      return str + "[" + String.valueOf(paramInt) + "]";
    case 2: 
      return ajya.a(2131715904);
    case 3: 
      return ajya.a(2131715892);
    case 4: 
      return ajya.a(2131715897);
    case 5: 
      return ajya.a(2131715894);
    case 6: 
      return ajya.a(2131715905);
    case 7: 
      return ajya.a(2131715902);
    case 8: 
      return ajya.a(2131715903);
    case 9: 
      return ajya.a(2131715901);
    case 10: 
      return "SDK下载服务错误";
    case 11: 
      return ajya.a(2131715896);
    case 12: 
      return "下载器DC失败";
    case 13: 
      return ajya.a(2131715895);
    }
    return ajya.a(2131715900);
  }
  ...
  private List<apwm> a()
  {
    ...
    synchronized (this.jdField_b_of_type_JavaLangObject)
    {
      ...
      while (i < j)
      {
        localArrayList.add((apwm)this.jdField_a_of_type_JavaUtilList.get(i));
        i += 1;
      }
  ...
  private boolean a(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 150	apwj:jdField_a_of_type_Apwl	Lapwl;
    //   8: ifnull +24 -> 32
    //   11: aload_0
    //   12: getfield 150	apwj:jdField_a_of_type_Apwl	Lapwl;
    //   15: aconst_null
    //   16: invokeinterface 155 2 0
    //   21: pop
    //   22: aload_0
    //   23: getfield 150	apwj:jdField_a_of_type_Apwl	Lapwl;
    ...
    //   36: aload_0
    //   37: iconst_1
    //   38: putfield 29	apwj:jdField_a_of_type_Int	I
    //   41: aload_0
    //   42: new 159	apwn
    //   45: dup
    //   46: aload_0
    //   47: getfield 51	apwj:jdField_a_of_type_Long	J
    //   50: invokespecial 162	apwn:<init>	(J)V
    //   53: putfield 150	apwj:jdField_a_of_type_Apwl	Lapwl;
    //   56: aload_0
    //   57: getfield 150	apwj:jdField_a_of_type_Apwl	Lapwl;
    //   60: aload_0
    //   61: getfield 45	apwj:jdField_a_of_type_Apwm	Lapwm;
    //   64: invokeinterface 155 2 0
    //   69: pop
    //   70: iload_3
    //   71: istore_1
    //   72: aload_0
    //   73: getfield 150	apwj:jdField_a_of_type_Apwl	Lapwl;
    //   76: aload_0
    //   77: getfield 47	apwj:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   80: aload_2
    //   81: invokeinterface 165 3 0
    //   86: ifeq +39 -> 125
    //   89: getstatic 22	apwj:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   92: iconst_1
    ...
    //   105: aload_0
    //   106: getfield 51	apwj:jdField_a_of_type_Long	J
    ...
    //   129: aload_0
    //   130: iconst_2
    //   131: putfield 29	apwj:jdField_a_of_type_Int	I
    //   134: aload_0
    //   135: new 180	apwv
    //   138: dup
    //   139: aload_0
    //   140: getfield 51	apwj:jdField_a_of_type_Long	J
    //   143: invokespecial 181	apwv:<init>	(J)V
    //   146: putfield 150	apwj:jdField_a_of_type_Apwl	Lapwl;
    //   149: goto -93 -> 56
    //   152: astore_2
    //   153: aload_0
    //   154: monitorexit
  ...
  public int a()
  {
    if (this.jdField_a_of_type_Apwl != null)
    {
      ...
      return this.jdField_a_of_type_Apwl.a();
    }
  ...
  public void a(apwm paramapwm)
  {
    synchronized (this.jdField_b_of_type_JavaLangObject)
    {
      if (this.jdField_a_of_type_JavaUtilList.contains(paramapwm)) {
        this.jdField_a_of_type_JavaUtilList.remove(paramapwm);
      }
      return;
    }
  }
  
  public void a(apwm paramapwm, boolean paramBoolean)
  {
    for (;;)
    {
      synchronized (this.jdField_b_of_type_JavaLangObject)
      {
        ...
        if ((apwm)this.jdField_a_of_type_JavaUtilList.get(i) == paramapwm)
        {
          if (paramBoolean == true)
          {
            ...
            paramapwm = (apwm)this.jdField_a_of_type_JavaUtilList.remove(i);
            this.jdField_a_of_type_JavaUtilList.add(paramapwm);
      ...
      if (paramapwm != null)
      {
        ...
        apwm localapwm = (apwm)this.jdField_a_of_type_JavaUtilList.remove(i - 1);
        this.jdField_a_of_type_JavaUtilList.add(paramapwm);
        this.jdField_a_of_type_JavaUtilList.add(localapwm);
      }
      for (;;)
      {
  ...
  public boolean a(Bundle paramBundle)
  {
    ...
    String str1 = apug.b(aptm.a().c() + (String)localObject1);
    String str2 = aptm.a().b() + (String)localObject1;
    ...
    return a(apwe.a((String)localObject1), (Bundle)localObject2);
  }
  ...
  public int b()
  {
    if (this.jdField_a_of_type_Apwl != null)
    {
      ...
      return this.jdField_a_of_type_Apwl.c();
    }
  ...
  public int c()
  {
    if (this.jdField_a_of_type_Apwl != null)
    {
      ...
      return this.jdField_a_of_type_Apwl.d();
    }
  ...
  public int d()
  {
    if (this.jdField_a_of_type_Apwl != null)
    {
      ...
      return this.jdField_a_of_type_Apwl.b();
    }
  ...
  public int e()
  {
    if (this.jdField_a_of_type_Apwl != null)
    {
      ...
      return this.jdField_a_of_type_Apwl.f();
    }
  ...
  {
    if (this.jdField_a_of_type_Apwl != null) {
      return this.jdField_a_of_type_Apwl.e();
    }
