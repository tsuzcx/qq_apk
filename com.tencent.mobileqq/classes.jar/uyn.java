  ...
  implements uyr
{
  ...
  public uyn(DoodleView paramDoodleView)
  {
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    urk.b("BaseLayer", "layer size,width=" + paramInt1 + ",height=" + paramInt2);
  ...
  public void a(uyo paramuyo)
  {
    this.jdField_a_of_type_Uyo = paramuyo;
  }
  ...
  public void f()
  {
    urk.b("BaseLayer", getClass().getName() + " onDestroy.");
  }
  ...
  public void h()
  {
    urk.b("BaseLayer", getClass().getName() + " onPause.");
    this.b = false;
  }
  
  public void i()
  {
    urk.b("BaseLayer", getClass().getName() + " onResume.");
    this.b = true;
  }
}
