...
public class uyn
{
  ...
  public static int a(View paramView)
  {
    ...
    do
    {
      ...
      j = vzo.d(paramView.getContext()) / 2;
    } while (i <= 0);
    int i = Math.min(Math.abs(j - arrayOfInt[1]), Math.abs(j - (arrayOfInt[1] + i)));
    veg.b("Q.qqstory.home.StoryListUtils", "getDistanceToCenterY=" + i);
    return i;
  }
  
  public static Bitmap a(Drawable paramDrawable, int paramInt1, int paramInt2, Map<String, Bitmap> paramMap, uxz paramuxz)
  {
    ...
    for (Bitmap localBitmap = (Bitmap)paramMap.get("w=" + paramInt1 + "h=" + paramInt2);; localBitmap = null)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          {
            uym.b("Q.qqstory.home.StoryListUtils", new Object[] { "drawable2Bitmap need create width=", Integer.valueOf(paramInt1), ",height=", Integer.valueOf(paramInt2) });
          ...
          veg.a("Q.qqstory.home.StoryListUtils", "drawable2Bitmap:width=%d,height=%d,cost time=%d", Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Long.valueOf(System.currentTimeMillis() - l));
          paramDrawable = (Drawable)localObject;
          if (paramuxz == null) {
            break;
          }
          return paramuxz.a((Bitmap)localObject);
        }
        catch (OutOfMemoryError paramDrawable)
        {
          label347:
          veg.e("Q.qqstory.home.StoryListUtils", "drawable2Bitmap out off memory width=" + paramInt1 + ",height=" + paramInt2);
          return null;
        }
      }
  ...
  public static String a(int paramInt, boolean paramBoolean)
  {
    ...
    default: 
      if (TextUtils.isEmpty((CharSequence)localObject1)) {
        localObject2 = ajyc.a(2131714450);
      }
      break;
    }
    do
    {
      return localObject2;
      localObject1 = ajyc.a(2131714451);
      break;
      localObject1 = ajyc.a(2131714449);
      break;
      localObject1 = ajyc.a(2131714478);
      break;
      localObject1 = ajyc.a(2131714442);
      break;
      localObject1 = ajyc.a(2131714439);
      break;
      localObject1 = ajyc.a(2131714475);
      break;
      localObject1 = ajyc.a(2131714453);
      break;
      localObject1 = ajyc.a(2131714443);
      break;
      localObject1 = ajyc.a(2131714464);
      break;
      localObject1 = ajyc.a(2131714465);
      break;
      localObject1 = ajyc.a(2131714480);
      break;
      localObject1 = ajyc.a(2131714460);
      break;
      localObject1 = ajyc.a(2131714479);
      break;
      localObject1 = ajyc.a(2131714473);
      break;
      localObject1 = ajyc.a(2131714458);
      break;
      localObject1 = ajyc.a(2131714457);
      break;
      localObject1 = ajyc.a(2131714447);
      break;
      localObject1 = ajyc.a(2131714474);
      break;
      localObject1 = ajyc.a(2131714438);
      break;
      localObject1 = ajyc.a(2131714444);
      break;
      localObject1 = ajyc.a(2131714452);
      break;
      localObject1 = ajyc.a(2131714461);
      break;
      localObject1 = ajyc.a(2131714472);
      break;
      localObject1 = ajyc.a(2131714456);
      break;
      localObject1 = ajyc.a(2131714469);
      break;
      localObject1 = ajyc.a(2131714440);
      break;
      localObject2 = localObject1;
    } while (!paramBoolean);
    return ajyc.a(2131714462) + (String)localObject1;
  }
  ...
  {
    Object localObject = ((ssw)paramQQAppInterface.getManager(181)).a(false);
  ...
  public static void a(ArrayList<String> paramArrayList)
  {
    ...
    veg.b("Q.qqstory.home.StoryListUtils", "reportShieldFriendStory:" + paramArrayList.size());
    uyx localuyx = new uyx();
    localuyx.a = paramArrayList;
    ste.a().dispatch(localuyx);
  }
  ...
  public static int b(View paramView)
  {
    ...
    veg.b("Q.qqstory.home.StoryListUtils", "getDistanceToTop=" + i);
    return i;
  }
  ...
  public static String b(long paramLong)
  {
    ...
    if (m == i3) {
      return String.format(Locale.getDefault(), ajyc.a(2131714459), new Object[] { Integer.valueOf(n), Integer.valueOf(i1) });
    }
    localCalendar.setTimeInMillis(paramLong);
    localCalendar.add(6, 1);
    if (localCalendar.get(6) == i3) {
      return String.format(Locale.getDefault(), ajyc.a(2131714448), new Object[] { Integer.valueOf(n), Integer.valueOf(i1) });
    }
    if (i != i2) {
  ...
  public static int c(View paramView)
  {
    ...
    do
    {
      ...
      paramView.getLocationOnScreen(arrayOfInt);
      i = paramView.getHeight();
      j = vzo.d(paramView.getContext());
    } while (i <= 0);
    int i = Math.min(Math.abs(j - arrayOfInt[1]), Math.abs(j - (arrayOfInt[1] + i)));
    veg.b("Q.qqstory.home.StoryListUtils", "getDistanceToBottom=" + i);
    return i;
  }
}
