  ...
  extends xom
{
  ...
  {
    paramFromServiceMsg = bgzj.a(paramFromServiceMsg.getWupBuffer());
  ...
  {
    paramFromServiceMsg = bgyo.a(paramFromServiceMsg.getWupBuffer());
    if (QLog.isColorLevel()) {
  ...
  private byte[] b(ToServiceMsg paramToServiceMsg)
  {
    ...
    return bbma.a(localUniPacket.encode());
  }
  
  private Object c(FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg)
  {
    paramFromServiceMsg = bgym.a(paramFromServiceMsg.getWupBuffer());
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      catch (Exception paramToServiceMsg)
      {
        try
        {
          ...
          l3 = l1;
          return new bgzj(l3, l2, localInteger.intValue()).encode();
        }
        catch (Exception paramToServiceMsg)
        {
          long l1;
    ...
    for (;;)
    {
      ...
      catch (Exception paramToServiceMsg)
      {
        try
        {
          l2 = Long.parseLong(paramToServiceMsg.getUin());
          l3 = l1;
          return new bgym(l3, l2, str1, localLong).encode();
        }
        catch (Exception paramToServiceMsg)
        {
          long l1;
    ...
    for (;;)
    {
      ...
      catch (Exception paramToServiceMsg)
      {
        try
        {
          l2 = Long.parseLong(paramToServiceMsg.getUin());
          l3 = l1;
          return new bgyo(l3, l2, str1).encode();
        }
        catch (Exception paramToServiceMsg)
        {
          long l1;
