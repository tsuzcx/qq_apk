...
public class axbh
{
  ...
  public static HashMap<Integer, HashMap<Integer, bhav>> a;
  ...
  public static List<Integer> a(Map<Integer, bhav> paramMap)
  {
  ...
  public static Map<Integer, String> a(long paramLong)
  {
    ...
    Map localMap = axbj.a(LocalMultiProcConfig.getString("EXTEND_INFO" + paramLong, ""));
    if (a(paramLong)) {
  ...
  public static void a(mobile_count_rsp_new parammobile_count_rsp_new)
  {
    if ((parammobile_count_rsp_new != null) && (parammobile_count_rsp_new.vec_soft_infos != null) && (parammobile_count_rsp_new.vec_soft_infos.size() != 0))
    {
      ...
      LocalMultiProcConfig.putString("qzone_soft_infos", bbca.encodeToString(localJceOutputStream.toByteArray(), 0));
    }
  }
  ...
  private static void a(mobile_count_rsp_new parammobile_count_rsp_new, axcj paramaxcj)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
        } while (paramaxcj == null);
        if (parammobile_count_rsp_new.iNextTimeout > 0)
        {
          paramaxcj.jdField_a_of_type_Long = (parammobile_count_rsp_new.iNextTimeout * 1000);
          if (QLog.isColorLevel()) {
            QLog.d("UndealCount.QZoneUnreadServletLogic", 2, "onReceive getFeedInterval:" + paramaxcj.jdField_a_of_type_Long);
          }
        }
      } while (parammobile_count_rsp_new.switchTimeout <= 0);
      paramaxcj.jdField_b_of_type_Long = (parammobile_count_rsp_new.switchTimeout * 1000);
    } while (!QLog.isColorLevel());
    QLog.d("UndealCount.QZoneUnreadServletLogic", 2, "onReceive getActiveAppInterval:" + paramaxcj.jdField_b_of_type_Long);
  }
  ...
  public static void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg, QQAppInterface paramQQAppInterface, axcj paramaxcj)
  {
    ...
    do
    {
      ...
      {
        return;
        paramFromServiceMsg = axbe.a(paramIntent, paramQQAppInterface, "getUndealCount");
    ...
    askn localaskn = (askn)paramQQAppInterface.getManager(10);
    if (localaskn != null) {
      localaskn.b(0);
    }
  ...
  private static void a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface != null)
    {
      long l = System.currentTimeMillis();
      HashMap localHashMap = new HashMap();
      axrl.a(paramQQAppInterface.getApp()).a(paramQQAppInterface.getCurrentAccountUin(), "actQzoneUnread", true, l - axcj.c, 0L, localHashMap, "");
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, Long paramLong)
  {
    ...
    do
    {
      ...
      } while ((paramQQAppInterface == null) || (!(paramQQAppInterface instanceof axch)));
    ...
    {
      bhav localbhav = (bhav)localHashMap.get(Integer.valueOf(1));
      localbhav.jdField_a_of_type_Long = paramLong.longValue();
      localHashMap.put(Integer.valueOf(1), localbhav);
    }
    ((axch)paramQQAppInterface).a(localHashMap);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, Intent paramIntent, FromServiceMsg paramFromServiceMsg, axcj paramaxcj)
  {
    if (QLog.isColorLevel()) {
      QLog.d("UndealCount.QZoneUnreadServletLogic", 2, "inform QZONE_GET_UNREAD isSuccess false");
    }
    if (paramaxcj != null) {
      paramaxcj.notifyObserver(null, 1000, false, new Bundle(), atzo.class);
    }
    if (paramQQAppInterface != null)
    {
      ...
      axrl.a(paramQQAppInterface.getApp()).a(paramQQAppInterface.getCurrentAccountUin(), "actQzoneUnread", false, axcj.d - axcj.c, 0L, paramFromServiceMsg, "");
    }
  }
  
  private static void a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, axcj paramaxcj)
  {
    if (QLog.isColorLevel()) {
      QLog.d("UndealCount.QZoneUnreadServletLogic", 2, "inform QZONE_GET_UNREAD isSuccess false");
    }
    ...
    if (paramQQAppInterface != null)
    {
      paramArrayOfByte = "|wufbuf: " + bbdm.a(paramArrayOfByte);
      paramaxcj = new HashMap();
      paramaxcj.put("param_FailCode", String.valueOf(9045));
      paramaxcj.put("param_errorDesc", paramArrayOfByte);
      axrl.a(paramQQAppInterface.getApp()).a(paramQQAppInterface.getCurrentAccountUin(), "actQzoneUnread", false, axcj.d - axcj.c, 0L, paramaxcj, "");
    }
  }
  
  public static void a(String paramString) {}
  
  private static void a(String paramString, axcj paramaxcj)
  {
    if (TextUtils.isEmpty(paramString)) {}
    while (paramaxcj == null) {
      return;
    ...
    paramaxcj.notifyObserver(null, 1003, true, localBundle, atzo.class);
  }
    ...
    if (paramArrayList != null)
    {
      ...
      while (paramArrayList.hasNext())
      {
        ...
        if (localoperat_data != null)
        {
          ...
          localbhop.jdField_a_of_type_Int = localoperat_data.cmd;
          if ((localoperat_data.mapExt != null) && (localoperat_data.mapExt.size() > 0)) {
            localbhop.jdField_a_of_type_JavaUtilMap.putAll(localoperat_data.mapExt);
          }
          localbhop.jdField_a_of_type_JavaUtilMap.put("key_desc", localoperat_data.desc);
  ...
  private static void a(byte[] paramArrayOfByte, mobile_count_rsp_new parammobile_count_rsp_new, QQAppInterface paramQQAppInterface, axcj paramaxcj)
  {
    HashMap localHashMap = new HashMap();
    boolean bool = a(parammobile_count_rsp_new, localHashMap, paramQQAppInterface);
    int i = 0;
    if (bool) {
      i = bhkl.a().a().a(paramQQAppInterface.getLongAccountUin());
    }
    ...
    if ((paramArrayOfByte != null) && ((paramArrayOfByte instanceof axch)))
    {
      ((axch)paramArrayOfByte).a(localHashMap);
      if (QLog.isColorLevel()) {
    ...
    label129:
    a(paramQQAppInterface, paramArrayOfByte, paramaxcj);
  }
  ...
  public static boolean a(int paramInt, String paramString)
  {
    ...
    if (Build.VERSION.SDK_INT >= 21)
    {
      ...
      if (localaxbi.a())
      {
        ...
        if (localaxbi.jdField_a_of_type_Int <= 0) {
          break label53;
        }
        bool1 = bool2;
      }
  ...
  private static boolean a(long paramLong)
  {
    ...
    try
    {
      localObject = (stNuanNuanComment)b(stNuanNuanComment.class, bbca.decode((String)localObject, 0));
  ...
  public static boolean a(mobile_count_rsp_new parammobile_count_rsp_new, HashMap<Integer, bhav> paramHashMap, QQAppInterface paramQQAppInterface)
  {
    if (QLog.isDevelopLevel()) {
    ...
    if (localcount_info != null)
    {
      ...
      {
        localbhav.jdField_a_of_type_Long = localcount_info.stCount.uCount;
        localbhav.jdField_a_of_type_Int = localcount_info.stCount.iControl;
        if (QLog.isDevelopLevel())
        {
        ...
        if ((i == 1) && (localbhav.jdField_a_of_type_Long > 0L) && (paramQQAppInterface != null) && (parammobile_count_rsp_new.isPreLoad == 1) && (!TextUtils.isEmpty(parammobile_count_rsp_new.undealCountTime)) && (!LocalMultiProcConfig.getString4Uin("qzone_passive_undealtime", "", paramQQAppInterface.getLongAccountUin()).equals(parammobile_count_rsp_new.undealCountTime)))
        {
          bool1 = true;
          label423:
          ...
          if (parammobile_count_rsp_new.mapTransData != null)
          {
            ...
            if (arrayOfByte != null) {
              localObject = (PassiveFeedsPush)bhnw.a(PassiveFeedsPush.class, arrayOfByte);
            }
          }
          if ((localcount_info.vecUinList != null) && (localcount_info.vecUinList.size() > 0))
          {
            ...
            while (j < localcount_info.vecUinList.size())
            {
              ...
              localbhav.jdField_a_of_type_JavaUtilArrayList.add(localQZoneCountUserInfo);
              j += 1;
            }
            localbhav.jdField_a_of_type_JavaLangString = ((feed_host_info)localcount_info.vecUinList.get(0)).actiondesc;
            if (QLog.isDevelopLevel()) {
          ...
          localbhav.jdField_b_of_type_JavaLangString = localcount_info.trace_info;
          localbhav.c = localcount_info.iSubCountID;
          localbhav.f = localcount_info.strShowMsg;
          localbhav.g = localcount_info.strReportValue;
          localbhav.e = localcount_info.strIconUrl;
          localbhav.jdField_b_of_type_Long = localcount_info.cTime;
          paramHashMap.put(Integer.valueOf(i), localbhav);
        }
      }
    }
    for (;;)
  ...
  public static byte[] a(long paramLong, String paramString1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, Map<Integer, count_info> paramMap, String paramString2, Map<Long, Long> paramMap1)
  {
    ...
    return axbe.a(paramString1, "getUndealCount", paramLong, paramInt1, paramInt2, paramInt4);
  }
  ...
  public static void b(int paramInt, QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface != null)
    {
      ...
      if (str != null)
      {
        ...
        bhog.a();
        paramQQAppInterface = (askn)paramQQAppInterface.getManager(10);
        if ((paramInt & 0x80) == 0) {
          break label84;
        }
      }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((parammobile_count_rsp_new.snnComment != null) && (parammobile_count_rsp_new.snnComment.iStatus != 0) && (paramLong != -1L))
        {
          ...
          LocalMultiProcConfig.putString4Uin("qzone_dual_warm_comment_info", bbca.encodeToString(localJceOutputStream.toByteArray(), 0), paramLong);
        ...
        if ((parammobile_count_rsp_new.sContentOpComment != null) && (parammobile_count_rsp_new.sContentOpComment.iStatus != 0) && (paramLong != -1L))
        {
          ...
          LocalMultiProcConfig.putString4Uin("qzone_dual_warm_operation_comment_info", bbca.encodeToString(((JceOutputStream)localObject).toByteArray(), 0), paramLong);
          return;
        }
      }
  ...
  private static void d(mobile_count_rsp_new parammobile_count_rsp_new, QQAppInterface paramQQAppInterface)
  {
    ...
    bgzg.a().a(parammobile_count_rsp_new.stYellowInfo.iYellowType, parammobile_count_rsp_new.stYellowInfo.iYellowLevel, parammobile_count_rsp_new.stYellowInfo.isAnnualVip, parammobile_count_rsp_new.stuStarInfo, parammobile_count_rsp_new.stuCombineDiamondInfo);
  }
  ...
  private static void i(mobile_count_rsp_new parammobile_count_rsp_new, QQAppInterface paramQQAppInterface)
  {
    ...
    if ((parammobile_count_rsp_new != null) && (parammobile_count_rsp_new.length > 0))
    {
      ...
      bhnw.a((JceStruct)localObject, parammobile_count_rsp_new);
