...
public class ult
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new ulu(this, Looper.getMainLooper());
  ...
  public ult(shl paramshl, ArrayList<VideoInfo> paramArrayList)
  {
  ...
  public static void a(int paramInt, ArrayList<AdvertisementInfo> paramArrayList)
  {
    ...
    while (paramArrayList.hasNext())
    {
      ...
      VideoInfo localVideoInfo = ulq.a(localAdvertisementInfo, false);
    ...
    ukq.a("VideoAdTimeLoadManager", "onAsyncDataReady :" + localStringBuilder.toString());
  }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    if ((!paramBoolean) && (this.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() == 1))
    {
      ...
      {
        ukq.a("VideoAdTimeLoadManager", paramBoolean);
        return;
      }
    }
    ...
    for (paramBoolean = bool2;; paramBoolean = false)
    {
      ...
      int i = uls.jdField_b_of_type_Int;
      if (this.jdField_a_of_type_Boolean) {
        i = uls.jdField_c_of_type_Int;
      }
      if (this.jdField_a_of_type_Long >= i - uls.d) {
        i();
      }
  ...
  {
    if ((this.jdField_a_of_type_Shl == null) || (this.jdField_a_of_type_JavaUtilArrayList == null) || (paramInt < 0) || (this.jdField_a_of_type_JavaUtilArrayList.size() <= paramInt))
    {
      ukq.a("VideoAdTimeLoadManager", "Invalid parameter");
      return false;
    }
    if (((VideoInfo)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).jdField_c_of_type_Boolean)
    {
      ukq.a("VideoAdTimeLoadManager", paramInt + " has adVideo");
      return true;
    }
    return false;
  }
  ...
  private boolean b(int paramInt)
  {
    ...
    do
    {
      return false;
      int i = a();
      if ((i > 0) && (paramInt - i < uls.e + 1))
      {
        ukq.a("VideoAdTimeLoadManager", "not meet adProtectGap");
        return false;
      }
      if (paramInt > this.jdField_a_of_type_JavaUtilArrayList.size() - 1)
      {
        ukq.a("VideoAdTimeLoadManager", "article size = " + this.jdField_a_of_type_JavaUtilArrayList.size() + " but  pos = " + paramInt);
        return false;
      }
    } while (a(paramInt));
    return true;
  ...
  private void i()
  {
    if (jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() > 0) {
      ukq.a("VideoAdTimeLoadManager", "adVideoCache size :" + jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size());
    }
    ...
    if (j >= 3)
    {
      ukq.a("VideoAdTimeLoadManager", "has preLoad 3 times");
      return;
    }
    if (jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.compareAndSet(false, true))
    {
      ukq.a("VideoAdTimeLoadManager", "preLoadAd :" + this.jdField_a_of_type_Long);
      oha localoha = new oha();
      localoha.h = 1;
      localoha.i = this.jdField_b_of_type_Int;
      localoha.j = i;
      localoha.jdField_a_of_type_Boolean = true;
      ThreadManager.executeOnSubThread(new VideoAdTimeLoadManager.2(this, localoha));
      jdField_a_of_type_AndroidUtilSparseArray.put(i, Integer.valueOf(j + 1));
      return;
    }
    ukq.a("VideoAdTimeLoadManager", "preLoading : so return");
  }
  ...
  public void b()
  {
    ...
    {
      ukq.a("VideoAdTimeLoadManager", bool);
      return;
    }
  }
  ...
  public void b(int paramInt)
  {
    ...
    ukq.a("VideoAdTimeLoadManager", "lastPlayPosition = " + this.jdField_a_of_type_Int);
  }
  ...
  public void f()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.removeMessages(1001);
    ukq.a("VideoAdTimeLoadManager", "restoreTiming :" + this.jdField_a_of_type_Long);
  }
  
  public void g()
  {
    ukq.a("VideoAdTimeLoadManager", "onInsertAd :");
    ...
    {
      ukq.a("VideoAdTimeLoadManager", "empty cache");
      return;
    }
    ukq.a("VideoAdTimeLoadManager", "onInsertAd : success");
    ...
    {
      localVideoInfo.a.jdField_c_of_type_Int = uls.jdField_c_of_type_Int;
      c(i);
      ukq.a("VideoAdTimeLoadManager", "insert success: pos = " + i);
      return;
    }
  }
}
