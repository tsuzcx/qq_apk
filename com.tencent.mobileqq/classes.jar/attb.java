  ...
  extends atta
{
  ...
  {
    String str2 = atut.a().d();
    String str1 = atwt.a(paramInt, bkdr.a(paramString1));
    paramString1 = str1;
    if (!atwl.b(str2 + str1))
    {
      paramString1 = str1;
      if (!TextUtils.isEmpty(paramString2)) {
        paramString1 = atwt.a(paramInt, bkdr.a(paramString2));
      }
    }
    return paramString1;
  }
          ...
          for (;;)
          {
            ...
            if ((a((MsgBackupResEntity)localObject2)) && (b(paramMessageRecord, (MsgBackupResEntity)localObject2)))
            {
              ...
              if (!TextUtils.isEmpty(str))
              {
                ...
                {
                  if (bgmg.b(((FileManagerEntity)localObject1).strLargeThumPath)) {
                    continue;
                  }
                  localObject2 = a((FileManagerEntity)localObject1, 7, str);
                  if ((bgmg.b(((FileManagerEntity)localObject1).strLargeThumPath)) || (!bgmg.b((String)localObject2))) {
                    continue;
                  }
                ...
                if ((((MsgBackupResEntity)localObject2).msgSubType == 11) && (!bgmg.b(((FileManagerEntity)localObject1).getFilePath())))
                {
  ...
  private void c(MessageRecord paramMessageRecord, List<MsgBackupResEntity> paramList)
  {
    ...
    if (paramMessageRecord.isMultiMsg)
    {
      ...
      localFileManagerEntity = atvo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)paramMessageRecord);
    }
    for (;;)
    {
      label139:
              ...
              if ((a((MsgBackupResEntity)localObject)) && (b(paramMessageRecord, (MsgBackupResEntity)localObject)))
              {
                ...
                if (!TextUtils.isEmpty(str)) {
                  if (((MsgBackupResEntity)localObject).msgSubType == 12)
                  {
                    ...
                    localFileManagerEntity.peerNick = atvo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localFileManagerEntity.peerUin, null, localFileManagerEntity.peerType);
  ...
  protected String a(MessageRecord paramMessageRecord, int paramInt)
  {
    ...
    try
    {
      ...
      for (paramInt = i;; paramInt = 0)
      {
        ...
        QLog.i("OfflineFileMsgBackupHandler<QFile>", 1, "buildResourceInfo: can not handle peerType[" + localFileManagerEntity.peerType + "] msgInfo[" + atwt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord) + "]");
        break;
      }
      return "{}";
    }
  ...
  public void a(MessageRecord paramMessageRecord, List<MsgBackupResEntity> paramList)
  {
    ...
    for (Object localObject1 = atvo.a((ChatMessage)paramMessageRecord);; localObject1 = paramMessageRecord)
    {
      ...
      if (localObject2 == null) {
        QLog.i("OfflineFileMsgBackupHandler<QFile>", 1, "handleExport: get offline file entity null. " + atwt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageRecord)localObject1, false));
      }
      for (;;)
      {
        return;
        int i = atvo.a(((FileManagerEntity)localObject2).fileName);
        if ((i == 0) || (i == 2))
        {
  ...
  public boolean a(MessageRecord paramMessageRecord, MsgBackupResEntity paramMsgBackupResEntity)
  {
    ...
    do
    {
      ...
      if (paramMsgBackupResEntity.msgSubType == 12)
      {
        bool1 = bgmg.b(paramMessageRecord.strLargeThumPath);
    ...
    boolean bool2 = bgmg.b(paramMessageRecord.getFilePath());
  ...
  public void b(MessageRecord paramMessageRecord, List<MsgBackupResEntity> paramList)
  {
    if (QLog.isDebugVersion())
    {
      QLog.i("<QFile_Backup>", 1, "Import: type[offline]" + atwt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord));
      if (paramList != null)
      {
