...
public class uyy
{
  ...
  public static uyy a(List<uyy> paramList, long paramLong)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if (paramLong == localuyy.jdField_a_of_type_Long) {
        return localuyy;
      }
    }
    return null;
  ...
  public void a(@NonNull JSONObject paramJSONObject)
  {
    try
    {
      ...
      if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
        this.jdField_a_of_type_ComTencentBizQqstoryModelItemStoryVideoItem = ((uvx)uwa.a(5)).a(this.jdField_a_of_type_JavaLangString);
      }
      return;
    }
