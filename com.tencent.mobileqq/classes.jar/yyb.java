...
{
  private static yyb jdField_a_of_type_Yyb = new yyb();
  ...
  public static yyb a()
  {
    try
    {
      yyb localyyb = jdField_a_of_type_Yyb;
      return localyyb;
    }
    finally
    {
  ...
  {
    yxs.a("GdtImpressionPolicy", "report view: " + paramView.hashCode());
    GdtAd localGdtAd = a(paramView);
    if (localGdtAd == null)
    {
      yxs.a("GdtImpressionPolicy", "break: statistics == null");
      return;
    }
    if (localGdtAd.reportState == 2)
    {
      yxs.a("GdtImpressionPolicy", "break: already report " + localGdtAd.getTraceId());
      return;
    }
    if (!a(paramView))
    {
      yxs.a("GdtImpressionPolicy", "break: isVisibleAreaSatisfied not");
      return;
    }
    ...
    if (!b(paramView))
    {
      yxs.a("GdtImpressionPolicy", "inCountingMap not " + localGdtAd.getTraceId());
  ...
  {
    yxs.a("GdtImpressionPolicy", "handleMessage : ");
    ...
    for (;;)
    {
      ...
      if (paramMessage.get() != null)
      {
        ...
        {
          yxs.a("GdtImpressionPolicy", "break: statistics.reportState != 1 " + localGdtAd.getTraceId());
        }
        else if (!a(paramMessage))
        {
          yxs.a("GdtImpressionPolicy", "break: isVisibleAreaSatisfied not " + localGdtAd.getTraceId());
          localGdtAd.reportState = -1;
        }
        else if (!b(paramMessage))
        {
          yxs.a("GdtImpressionPolicy", "break: inCountingMap not " + localGdtAd.getTraceId());
        }
        else
        {
          localObject = paramMessage.getTag(2131379205);
          if (localObject == null)
          {
            yxs.a("GdtImpressionPolicy", "break: o2 == null " + localGdtAd.getTraceId());
          }
          else if (!(localObject instanceof yyc))
          {
            yxs.a("GdtImpressionPolicy", "break: o2 instanceof ReportListener not " + localGdtAd.getTraceId());
          }
          else
          {
            ...
            yxs.a("GdtImpressionPolicy", "break: already reported " + localGdtAd.getTraceId());
          }
        }
      }
    }
    ((yyc)localObject).reportImpression(paramMessage);
    localGdtAd.reportState = 2;
    a(localGdtAd.getTraceId(), true);
    yxs.a("GdtImpressionPolicy", "report " + localGdtAd.getTraceId());
