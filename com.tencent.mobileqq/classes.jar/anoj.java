...
public class anoj
{
  ...
  private ArkAppPreloader.PreloadAppCallback jdField_a_of_type_ComTencentArkArkAppPreloader$PreloadAppCallback = new anol(this);
  private WeakReference<QQAppInterface> jdField_a_of_type_JavaLangRefWeakReference;
  private ConcurrentHashMap<String, anon> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap(8);
  private boolean jdField_a_of_type_Boolean;
  private boolean b;
  
  public anoj(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(anon paramanon)
  {
    ...
    ThreadManagerV2.executeOnSubThread(new ArkAppPreDownloadMgr.3(this, paramanon));
  }
  ...
  private void c()
  {
    ...
    ArkAppPreloader.preloadCommon(anob.a(), str2, str1);
  }
  ...
  public void a()
  {
    ...
    if ((this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() > 0) && (!this.jdField_a_of_type_Boolean))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (!TextUtils.isEmpty(localanon.a)) {
          if (TextUtils.isEmpty(ArkAppMgr.getInstance().getAppPathByNameFromLocal(localanon.a, "", null, false))) {
            a(localanon);
          } else {
            QLog.d("ArkApp.ArkAppPreDownloadMgr", 1, new Object[] { "profiling ark app predowloaded,app=", localanon.a });
          }
        }
      }
    }
  ...
  public void a(aolw paramaolw)
  {
    if ((paramaolw != null) && (paramaolw.a() != null)) {
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = paramaolw.a().jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          ...
          azri.a(BaseApplicationImpl.getApplication()).a(str, "ark_app_predownload_first_hit", true, 0L, 0L, localHashMap, "", false);
        ...
        continue;
        azri.a(BaseApplicationImpl.getApplication()).a(str, "ark_app_predownload_first_hit", false, 0L, 0L, localHashMap, "", false);
      }
      finally {}
      label193:
      continue;
