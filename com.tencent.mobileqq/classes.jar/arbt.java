...
public class arbt
{
  ...
  public static arbt a(aqxa[] paramArrayOfaqxa)
  {
    ...
    for (;;)
    {
      localObject = localarbt;
      try
      {
        if (i < paramArrayOfaqxa.length)
        {
          localarbt.a.clear();
          localObject = paramArrayOfaqxa[i].a;
          if (!TextUtils.isEmpty((CharSequence)localObject))
          {
            ...
            {
              localarbt.a.add(((JSONArray)localObject).getString(j));
              j += 1;
            }
          }
          i += 1;
      ...
      {
        QLog.d("MiniAppApiReportProcessor", 2, "parse, failed!", paramArrayOfaqxa);
        localObject = null;
      }
    }
    return localObject;
