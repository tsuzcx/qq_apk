...
public abstract class lie
{
  ...
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramlif);
  }
  
  public void a(lig paramlig)
  {
    if (paramlig != null)
    {
      this.b = new WeakReference(paramlig);
      return;
    }
    this.b = null;
  }
