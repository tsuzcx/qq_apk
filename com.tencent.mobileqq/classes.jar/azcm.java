...
public class azcm
{
  ...
  public static Pair<azcd, List<PrecoverResource>> a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if ((localObject4 == null) || (!((azcd)localObject4).a()) || (localArrayList.size() <= 0)) {
        break;
      }
      ...
      while (paramString.hasNext())
      {
        ...
        if (localObject1 != null) {
          ((PrecoverResource)localObject1).businessId = ((azcd)localObject4).a;
        }
      }
      localObject3 = paramString;
  ...
  {
    if (bgjq.a()) {
      return anhk.ba + "pddata/prd/" + "res_precover";
    }
