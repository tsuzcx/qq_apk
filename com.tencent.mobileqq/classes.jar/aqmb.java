  ...
  extends MSFServlet
{
  ...
  static
  {
    ...
    int[] arrayOfInt3 = { 2131427349, -151 };
    ...
    int[] arrayOfInt9 = { -1, 350 };
    int[] arrayOfInt10 = { -1, 356 };
    int[] arrayOfInt11 = { -1, 366 };
    jdField_a_of_type_Array2dOfInt = new int[][] { localObject, arrayOfInt1, arrayOfInt2, arrayOfInt3, { 2131427351, -208 }, arrayOfInt4, arrayOfInt5, arrayOfInt6, arrayOfInt7, arrayOfInt8, arrayOfInt9, arrayOfInt10, arrayOfInt11 };
    ...
    if (i < j)
    {
      ...
      int m = arrayOfInt1[1];
      if (k != -1) {
        jdField_a_of_type_AndroidUtilSparseIntArray.put(vpl.a(k), m);
      }
      for (;;)
      {
        i += 1;
    ...
    vpo.a(jdField_a_of_type_AndroidUtilSparseIntArray);
  }
  ...
  private void a(QQAppInterface paramQQAppInterface, Intent paramIntent, Packet paramPacket)
  {
    ...
    boolean bool = bfyz.b(paramQQAppInterface.getApp(), "Q.qqstory.config.QQStoryConfigServlet");
    ArrayList localArrayList2 = new ArrayList(k);
    int i = 0;
    if (i < k)
    {
      int m = jdField_a_of_type_AndroidUtilSparseIntArray.keyAt(i);
      String str = vuq.a(jdField_a_of_type_AndroidUtilSparseIntArray.valueAt(i));
      ConfigurationService.ConfigSeq localConfigSeq = new ConfigurationService.ConfigSeq();
      localConfigSeq.type.set(m);
      int j = 0;
      if (bool) {
        bfyz.b(paramQQAppInterface.getApp(), str, paramIntent);
      }
      for (;;)
      {
        ...
        i += 1;
        break;
        j = bfyz.a(paramQQAppInterface.getApp(), str, paramIntent);
      }
    }
    if (bool) {
      bfyz.g(paramQQAppInterface.getApp(), "Q.qqstory.config.QQStoryConfigServlet");
    }
    if (QLog.isColorLevel())
    {
    ...
    xvv.b("Q.qqstory.config.QQStoryConfigServlet", "addAllConfigs");
    if (paramQQAppInterface == null) {
      xvv.b("Q.qqstory.config.QQStoryConfigServlet", "lbsInfo is null.");
    }
    for (;;)
    {
      ...
      {
        xvv.b("Q.qqstory.config.QQStoryConfigServlet", "lbsInfo.location is null.");
      }
      else if (TextUtils.isEmpty(paramQQAppInterface.mLocation.cityCode))
      {
        xvv.b("Q.qqstory.config.QQStoryConfigServlet", "lbsInfo.location.cityCode is null");
      }
      else
      {
        xvv.a("Q.qqstory.config.QQStoryConfigServlet", "adcode:%s", paramQQAppInterface.mLocation.cityCode);
  ...
  {
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApp(), aqmb.class);
  ...
  private void a(ConfigurationService.RespGetConfig paramRespGetConfig, QQAppInterface paramQQAppInterface, Intent paramIntent, boolean paramBoolean)
  {
    ...
    if (i < j)
    {
      ...
      for (;;)
      {
        ...
        if (localConfig.type.has())
        {
          ...
          xvv.a("Q.qqstory.config.QQStoryConfigServlet", "receiveAllConfigs|receive type: %d, localConfigId: %d, length: %d", Integer.valueOf(k), Integer.valueOf(m), Integer.valueOf(j));
          String str1 = paramIntent.getStringExtra("key_uin");
          String str2 = vuq.a(m);
          int n = bfyz.a(paramQQAppInterface.getApp(), str2, str1);
          String str3 = aqlw.a(localConfig, n, m);
          if (localConfig.content_list.size() > 0) {
            xvv.a("Q.qqstory.config.QQStoryConfigServlet", "%d --> %s", Integer.valueOf(m), (String)localConfig.content_list.get(0));
          }
          xvv.a("Q.qqstory.config.QQStoryConfigServlet", "%d ---> %s", Integer.valueOf(m), str3);
          paramBoolean = localvuq.a(m, paramIntent, localConfig);
          if (paramBoolean) {
            bfyz.a(paramQQAppInterface.getApp(), str2, str1, localConfig.version.get());
          }
          xvv.b("Q.qqstory.config.QQStoryConfigServlet", "receiveAllConfigs|receive type: %d, localConfigId: %d, length: %d, localVersion:%d, newVersion: %d, handled: %b", new Object[] { Integer.valueOf(k), Integer.valueOf(m), Integer.valueOf(j), Integer.valueOf(n), Integer.valueOf(localConfig.version.get()), Boolean.valueOf(paramBoolean) });
        }
      }
    }
    ...
    while (paramRespGetConfig.hasNext())
    {
      ...
      default: 
        break;
      case 243: 
        ((vkz)paramQQAppInterface.getBusinessHandler(98)).notifyUI(1021, true, null);
      }
    }
  }
  ...
  public void onReceive(Intent paramIntent, com.tencent.qphone.base.remote.FromServiceMsg paramFromServiceMsg)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 438	aqmb:getAppRuntime	()Lmqq/app/AppRuntime;
    //   4: checkcast 68	com/tencent/mobileqq/app/QQAppInterface
    //   7: astore 6
    //   9: aload_2
    //   10: invokevirtual 443	com/tencent/qphone/base/remote/FromServiceMsg:isSuccess	()Z
    //   13: istore 5
    //   15: getstatic 30	aqmb:jdField_a_of_type_AndroidUtilSparseIntArray	Landroid/util/SparseIntArray;
    //   18: invokevirtual 63	android/util/SparseIntArray:size	()I
    //   21: ifne +10 -> 31
    //   24: aload_0
    //   25: aload_1
    //   26: iconst_0
    //   27: invokestatic 446	vpo:a	(Lmqq/app/MSFServlet;Landroid/content/Intent;Z)V
    //   30: return
    //   31: invokestatic 127	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   34: ifeq +73 -> 107
    //   37: getstatic 30	aqmb:jdField_a_of_type_AndroidUtilSparseIntArray	Landroid/util/SparseIntArray;
    //   40: invokevirtual 63	android/util/SparseIntArray:size	()I
    //   43: istore 4
    //   45: iconst_0
    //   46: istore_3
    //   47: iload_3
    //   48: getstatic 30	aqmb:jdField_a_of_type_AndroidUtilSparseIntArray	Landroid/util/SparseIntArray;
    ...
    //   73: getstatic 30	aqmb:jdField_a_of_type_AndroidUtilSparseIntArray	Landroid/util/SparseIntArray;
    //   76: iload_3
    ...
    //   104: goto -57 -> 47
    //   107: aload_2
    //   108: invokevirtual 451	com/tencent/qphone/base/remote/FromServiceMsg:getWupBuffer	()[B
    //   111: astore 7
    //   113: aload 7
    //   115: ifnull +10 -> 125
    //   118: aload 7
    ...
    //   141: aload_1
    //   142: iconst_0
    //   143: invokestatic 446	vpo:a	(Lmqq/app/MSFServlet;Landroid/content/Intent;Z)V
    //   146: return
    //   147: aload_2
    //   148: aload 7
    //   150: invokestatic 455	aqmb:a	([B)[B
    //   153: invokevirtual 458	com/tencent/qphone/base/remote/FromServiceMsg:putWupBuffer	([B)V
    //   156: new 275	com/tencent/mobileqq/config/struct/splashproto/ConfigurationService$RespGetConfig
    //   159: dup
    //   160: invokespecial 459	com/tencent/mobileqq/config/struct/splashproto/ConfigurationService$RespGetConfig:<init>	()V
    //   163: astore 7
    //   165: aload 7
    //   167: aload_2
    //   168: invokevirtual 451	com/tencent/qphone/base/remote/FromServiceMsg:getWupBuffer	()[B
    //   171: invokevirtual 463	com/tencent/mobileqq/config/struct/splashproto/ConfigurationService$RespGetConfig:mergeFrom	([B)Lcom/tencent/mobileqq/pb/MessageMicro;
    //   174: pop
    //   175: aload_0
    //   176: aload 7
    //   178: aload 6
    //   180: aload_1
    //   181: iload 5
    //   183: invokespecial 465	aqmb:a	(Lcom/tencent/mobileqq/config/struct/splashproto/ConfigurationService$RespGetConfig;Lcom/tencent/mobileqq/app/QQAppInterface;Landroid/content/Intent;Z)V
    //   186: aload_0
    //   187: aload_1
    //   188: iconst_1
    //   189: invokestatic 446	vpo:a	(Lmqq/app/MSFServlet;Landroid/content/Intent;Z)V
    //   192: return
    //   193: astore_2
    ...
    //   216: aload_2
    //   217: invokevirtual 468	com/tencent/mobileqq/pb/InvalidProtocolBufferMicroException:toString	()Ljava/lang/String;
    ...
    //   229: aload_2
    //   230: invokevirtual 471	com/tencent/mobileqq/pb/InvalidProtocolBufferMicroException:printStackTrace	()V
    //   233: aload_0
    //   234: aload_1
    //   235: iconst_0
    //   236: invokestatic 446	vpo:a	(Lmqq/app/MSFServlet;Landroid/content/Intent;Z)V
    //   239: return
    //   240: astore_2
    //   241: goto -55 -> 186
