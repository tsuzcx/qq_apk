...
{
  public owk(MoveFileActivity paramMoveFileActivity, TroopFileInfo paramTroopFileInfo) {}
  ...
  protected void a(boolean paramBoolean, int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
      default: 
        paramString = this.jdField_a_of_type_ComTencentBizTroopFileMoveFileActivity.getString(2131430212);
