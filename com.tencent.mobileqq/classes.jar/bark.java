...
{
  public bark(TroopGiftActionButton paramTroopGiftActionButton, TextView paramTextView) {}
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    if (paramMotionEvent.getAction() == 0)
    {
      ...
      paramMotionEvent.setAnimationListener(new barl(this));
      ...
      ((GradientDrawable)localObject).setCornerRadius(baxn.a(this.jdField_a_of_type_ComTencentMobileqqTroopgiftTroopGiftActionButton.getContext(), 56.0F));
      ...
      localObject = new RelativeLayout.LayoutParams(baxn.a(this.jdField_a_of_type_ComTencentMobileqqTroopgiftTroopGiftActionButton.getContext(), 56.0F), baxn.a(this.jdField_a_of_type_ComTencentMobileqqTroopgiftTroopGiftActionButton.getContext(), 56.0F));
      ...
      ((ScaleAnimation)localObject).setAnimationListener(new barm(this, paramMotionEvent));
