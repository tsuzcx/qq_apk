...
public class bdia
{
  private static bdia jdField_a_of_type_Bdia;
  ...
  {
    if (jdField_a_of_type_Bdia == null) {}
    try
    {
      if (jdField_a_of_type_Bdia == null) {
        jdField_a_of_type_Bdia = new bdia();
      }
      return jdField_a_of_type_Bdia;
    }
    finally {}
  }
  ...
  private static String a()
  {
    ...
    try
    {
      localObject = asrb.b((String)localObject);
      return localObject;
    }
    ...
    for (;;)
    {
      ...
      try
      {
        if (a().a())
        {
          ...
          {
            if (paramBoolean) {
              QQToast.a(paramActivity, 1, str, 1000).b(paramActivity.getResources().getDimensionPixelSize(2131298914));
            }
