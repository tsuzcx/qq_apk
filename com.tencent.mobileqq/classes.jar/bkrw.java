  ...
  extends VideoJsProxy
{
  ...
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new bksa(this);
  ...
  private void a(File paramFile, boolean paramBoolean)
  {
    ...
    //   52: astore 7
    //   54: aload 5
    //   56: invokestatic 503	bkrw:a	(Landroid/media/MediaExtractor;)I
    //   59: istore_3
    //   60: iload_3
    //   61: iconst_m1
    ...
    //   278: aload_0
    //   279: aload_0
    //   280: getfield 61	bkrw:jdField_a_of_type_Int	I
    //   283: ldc_w 549
    //   286: aconst_null
    //   287: ldc_w 433
    //   290: invokespecial 551	bkrw:a	(ILjava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;)V
    //   293: return
    //   294: aload 6
    //   296: astore 8
    //   298: aload 5
    ...
    //   430: aload 4
    //   432: iconst_1
    //   433: invokespecial 404	bkrw:a	(Lcom/tencent/mobileqq/activity/photo/LocalMediaInfo;Z)V
    //   436: return
    //   437: aload_0
    //   438: aload_0
    //   439: getfield 192	bkrw:jdField_a_of_type_ComTencentQqminiSdkLauncherCoreIMiniAppContext	Lcom/tencent/qqmini/sdk/launcher/core/IMiniAppContext;
    //   442: ldc 194
    ...
    //   467: aload 4
    //   469: invokespecial 416	bkrw:a	(Ljava/lang/String;JLcom/tencent/mobileqq/activity/photo/LocalMediaInfo;)V
    //   472: return
    //   473: astore 4
    //   475: goto -218 -> 257
    //   478: astore 4
  ...
  private void a(String paramString, long paramLong, LocalMediaInfo paramLocalMediaInfo, int paramInt)
  {
    try
    {
      ...
      localJSONObject.put("__plugin_ready__", new File(bddn.a(MobileQQ.getContext())).exists());
  ...
  private void a(String paramString1, String paramString2, LocalMediaInfo paramLocalMediaInfo, int paramInt)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentBizQqstoryUtilsFfmpegFFmpeg.execute(arrayOfString, new bksb(this, l1, paramString1, paramLocalMediaInfo, paramInt, paramString2, l2));
      return;
    }
  ...
  private boolean a(Bitmap paramBitmap, LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    //   38: ireturn
    //   39: aload_0
    //   40: getfield 192	bkrw:jdField_a_of_type_ComTencentQqminiSdkLauncherCoreIMiniAppContext	Lcom/tencent/qqmini/sdk/launcher/core/IMiniAppContext;
    //   43: ldc 194
    ...
    //   168: aload_2
    //   169: aload_0
    //   170: getfield 192	bkrw:jdField_a_of_type_ComTencentQqminiSdkLauncherCoreIMiniAppContext	Lcom/tencent/qqmini/sdk/launcher/core/IMiniAppContext;
    //   173: ldc 194
  ...
  private void b(Activity paramActivity, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    localIActivityResultManager.addActivityResultListener(new bksc(this, localFile, localIActivityResultManager, paramBoolean1));
    ...
    catch (JSONException paramActivity)
    {
      for (;;)
      {
        ...
        if ("saveVideoToPhotosAlbum".equals(paramString1))
        {
          ...
          else if (zeb.a(paramActivity, ((IMiniAppFileManager)this.jdField_a_of_type_ComTencentQqminiSdkLauncherCoreIMiniAppContext.getManager(IMiniAppFileManager.class)).getAbsolutePath(paramString2), a()))
          {
            a(paramInt, paramString1, null);
          }
          else
