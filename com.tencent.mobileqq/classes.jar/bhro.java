...
public abstract class bhro
  implements bhoc, bhog
{
  ...
  private static bhrq<bhog> listeners = new bhrq();
  private static bhrq<WeakReference<bhog>> weakListeners = new bhrq();
  ...
  protected void doOnCompleted(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      FileUtils.uncompressZip(paramQQAppInterface, paramString2, false);
      return;
    }
  ...
  public void download(QQAppInterface paramQQAppInterface, int paramInt, bhog parambhog, boolean paramBoolean)
  {
    download(paramQQAppInterface, getScid(paramInt), parambhog, paramBoolean);
  }
  ...
  public void download(QQAppInterface paramQQAppInterface, long paramLong, String paramString, bhog parambhog, boolean paramBoolean)
  {
    if (FlatBuffersParser.c())
    {
      ...
      if (parambhog != null) {
        parambhog.onCompleted(paramQQAppInterface, paramLong, paramString, "", "BaseUpdateCallback", 10086, 0);
      }
    }
    do
    {
    ...
    } while (parambhog == null);
    parambhog.onCompleted(paramQQAppInterface, paramLong, paramString, "", "BaseUpdateCallback", 10087, 0);
    return;
    ...
    for (;;)
    {
      if (parambhog != null)
      {
        ...
        weakListeners.a((String)localObject, new WeakReference(parambhog));
      }
      for (;;)
      {
        QLog.e("BaseUpdateCallback", 1, "download: " + paramLong + "_" + paramString + ", " + parambhog);
        ((VasQuickUpdateManager)paramQQAppInterface.getManager(QQManagerFactory.VAS_QUICKUPDATE_MANAGER)).downloadItem(paramLong, paramString, "BaseUpdateCallback");
        return;
        QLog.e("BaseUpdateCallback", 1, "wrong app:" + localObject);
        if (parambhog == null) {
          break;
        }
        parambhog.onCompleted(paramQQAppInterface, paramLong, paramString, "", "BaseUpdateCallback", 10088, 0);
        return;
        listeners.a((String)localObject, parambhog);
      }
    }
  }
  ...
  public void download(QQAppInterface paramQQAppInterface, String paramString, bhog parambhog, boolean paramBoolean)
  {
    download(paramQQAppInterface, getBID(), paramString, parambhog, paramBoolean);
  }
  ...
  public final void onCompleted(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2)
  {
    ...
    for (localObject1 = listeners.b((String)localObject2);; localObject1 = listeners.a((String)localObject2))
    {
      ...
      while (((Iterator)localObject1).hasNext()) {
        ((bhog)((Iterator)localObject1).next()).onCompleted(paramQQAppInterface, paramLong, paramString1, paramString2, paramString3, paramInt1, paramInt2);
      }
    ...
    for (localObject1 = weakListeners.b((String)localObject2);; localObject1 = weakListeners.a((String)localObject2))
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        localObject2 = (bhog)((WeakReference)((Iterator)localObject1).next()).get();
        if (localObject2 != null) {
          ((bhog)localObject2).onCompleted(paramQQAppInterface, paramLong, paramString1, paramString2, paramString3, paramInt1, paramInt2);
        }
      }
    }
  }
  ...
  public final void onProgress(QQAppInterface paramQQAppInterface, long paramLong1, String paramString1, String paramString2, long paramLong2, long paramLong3)
  {
    ...
    for (boolean bool = false;; bool = ((VasQuickUpdateEngine.TagItemInfo)localObject1).bPreConfig)
    {
      ...
      while (((Iterator)localObject2).hasNext()) {
        ((bhog)((Iterator)localObject2).next()).onProgress(paramQQAppInterface, paramLong1, paramString1, paramString2, paramLong2, paramLong3);
      }
    }
    ...
    while (((Iterator)localObject1).hasNext())
    {
      localObject2 = (bhog)((WeakReference)((Iterator)localObject1).next()).get();
      if (localObject2 != null) {
        ((bhog)localObject2).onProgress(paramQQAppInterface, paramLong1, paramString1, paramString2, paramLong2, paramLong3);
      }
    }
  }
  
  public void removeListener(long paramLong, String paramString, bhog parambhog)
  {
    paramString = getKey(paramLong, paramString, "");
    listeners.a(paramString, parambhog, false);
    weakListeners.a(paramString, parambhog, true);
  }
}
