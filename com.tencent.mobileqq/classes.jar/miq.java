  ...
  extends min
{
  ...
  public miq(Context paramContext, VideoAppInterface paramVideoAppInterface)
  {
  ...
  public void a(ley paramley, mdt[] paramArrayOfmdt, int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3, int paramInt4)
  {
    ...
    if (paramley.D == 2)
    {
      paramArrayOfmdt[0].a(Boolean.valueOf(false));
      paramArrayOfmdt[1].a(Boolean.valueOf(true));
      paramArrayOfmdt[2].a(Boolean.valueOf(true));
      paramArrayOfmdt[3].a(Boolean.valueOf(true));
      paramArrayOfmdt[4].a(Boolean.valueOf(true));
      if ((!paramArrayOfmdt[0].f()) || ((paramInt3 != 0) && (paramInt3 != 180)) || (paramArrayOfmdt[0].k())) {
        break label471;
      }
      if (paramInt3 == 0) {
        paramArrayOfmdt[0].a(0, 0, 0, this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131297709));
      }
    }
    else
    {
      i = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131299089);
      if (paramInt4 == 0) {
        break label528;
      }
    }
    ...
    for (paramInt3 = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131299090);; paramInt3 = i)
    {
      ...
      for (;;)
      {
        ...
        return;
        paramArrayOfmdt[0].a(0, this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131297709), 0, 0);
        break;
        label471:
        paramArrayOfmdt[0].a(0, 0, 0, 0);
        break;
  ...
  public boolean a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null)
    {
      ...
      if (QLog.isDevelopLevel()) {
        QLog.w("OriginScreenLayout", 1, "canSwitchView, mCanSwitch[" + localmcb.jdField_b_of_type_Boolean + "], mBlockName[" + localmcb.jdField_b_of_type_JavaLangString + "]");
      }
    }
