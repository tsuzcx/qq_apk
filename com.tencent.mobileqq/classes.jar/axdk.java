...
class axdk
  extends bahz
{
  axdk(axdj paramaxdj, QQAppInterface paramQQAppInterface) {}
  ...
  public void a(String paramString, List<NumRedMsg.NumMsgBusi> paramList)
  {
    ...
    {
      this.jdField_a_of_type_Axdj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramList);
