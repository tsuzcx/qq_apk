...
class bfhw
  implements bfmp
{
  bfhw(bfhv parambfhv, bfhx parambfhx, String paramString) {}
  ...
  public void a(String paramString1, String arg2, String paramString3)
  {
    try
    {
      ...
      bflp.c("ImageLoader", "-->imgDownloaded path = " + ??? + " localUrl = " + paramString3);
      localBitmap = bfii.a(bfbm.a().a(), localBitmap, 50, 50);
      synchronized (bfhv.jdField_a_of_type_ArrayOfByte)
      {
        this.jdField_a_of_type_Bfhv.jdField_a_of_type_AndroidSupportV4UtilLruCache.put(paramString1, localBitmap);
        this.jdField_a_of_type_Bfhx.a(this.jdField_a_of_type_JavaLangString, localBitmap, paramString3);
        return;
      }
      return;
    }
  ...
  public void b(String paramString1, String arg2, String paramString3)
  {
    ...
    //   30: invokestatic 54	bflp:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   33: invokestatic 101	bfiu:a	()Z
    //   36: ifne +157 -> 193
    //   39: new 103	java/net/URL
    //   42: dup
    //   43: aload_0
    //   44: getfield 18	bfhw:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   132: invokestatic 54	bflp:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   135: aload_2
    //   136: ifnull +57 -> 193
    //   139: invokestatic 59	bfbm:a	()Lbfbm;
    //   142: invokevirtual 62	bfbm:a	()Landroid/content/Context;
    //   145: aload_2
    //   146: bipush 50
    //   148: bipush 50
    //   150: invokestatic 67	bfii:a	(Landroid/content/Context;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    //   153: astore 4
    //   155: getstatic 72	bfhv:jdField_a_of_type_ArrayOfByte	[B
    //   158: astore_2
    //   159: aload_2
    //   160: monitorenter
    //   161: aload_0
    //   162: getfield 14	bfhw:jdField_a_of_type_Bfhv	Lbfhv;
    //   165: getfield 75	bfhv:jdField_a_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
    //   168: aload_1
    //   169: aload 4
    ...
    //   176: monitorexit
    //   177: aload_0
    //   178: getfield 16	bfhw:jdField_a_of_type_Bfhx	Lbfhx;
    //   181: aload_0
    //   182: getfield 18	bfhw:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   185: aload 4
    //   187: aload_3
