...
{
  public sdk(ChatSettingForTroop paramChatSettingForTroop) {}
    ...
    do
    {
      do
      {
        ...
        if ((this.a.jdField_a_of_type_JavaUtilList != null) && (this.a.jdField_a_of_type_JavaUtilList.contains(Integer.valueOf(paramInt))))
        {
          ...
          if (paramBoolean)
          {
            this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier.a(1, this.a.getString(2131433503), 1000);
            return;
          }
          this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier.a(2, this.a.getString(2131433504), 1000);
  ...
  {
    ThreadManager.post(new sdl(this), 8, null, true);
  }
  ...
  protected void b(boolean paramBoolean, String paramString)
  {
    if ((paramBoolean) && (this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData != null))
    {
      ...
      ThreadManager.post(new sdm(this), 8, null, true);
    }
  }
  ...
  protected void c(boolean paramBoolean, ArrayList paramArrayList)
  {
    ...
    do
    {
      ...
      for (bool = false;; bool = a(paramArrayList))
      {
        ...
        this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier.a(2, 2131433656, 1000);
        return;
      }
    } while ((!bool) || ((this.a.c & 0x1) != 1));
    paramArrayList = this.a;
    paramArrayList.c &= 0xFFFFFFFE;
    this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier.a(1, 2131433655, 1000);
  }
