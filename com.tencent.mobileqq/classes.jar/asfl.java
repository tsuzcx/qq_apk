...
public class asfl
  extends asdc<CustomEmotionData>
{
  public int a;
  private anub jdField_a_of_type_Anub = new asfn(this);
  private asex jdField_a_of_type_Asex;
  public asiu a;
  private asiv jdField_a_of_type_Asiv = new asfp(this);
  ...
  public asfl(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger = new AtomicInteger(0);
    this.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicInteger = new AtomicInteger(0);
    this.jdField_a_of_type_JavaUtilMap = new HashMap();
    this.jdField_a_of_type_ComTencentMobileqqTransfileTransProcessorHandler = new asfm(this, ThreadManager.getSubThreadLooper());
    this.jdField_a_of_type_Asiu = new asfo(this);
    ...
    if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
    {
      ...
      if (i > 144) {
        asfi.jdField_a_of_type_Int = i;
      }
    }
  }
  
  public static asfl a(QQAppInterface paramQQAppInterface)
  {
    return (asfl)paramQQAppInterface.getManager(QQManagerFactory.FAV_ROAMING_MANAGER);
  }
  ...
  private String a(String paramString)
  {
    ...
    return String.format(BaseApplicationImpl.getApplication().getString(2131691850), new Object[] { str });
  }
  
  private void a(String paramString, asex paramasex)
  {
    ...
    if (localList != null)
    {
      ...
      for (int i = 1;; i = k)
      {
        ...
        if ((str != null) && (str.equals(localCustomEmotionData.md5)))
        {
          ...
          {
            ((asfk)localObject).a(localCustomEmotionData, j);
            if (paramasex != null) {
              paramasex.a(0, str);
            }
          }
          while (paramasex == null) {
            return;
          }
          paramasex.a(1, str);
          return;
    ...
    {
      ((CustomEmotionData)localObject).eId = paramString;
      paramString = new aset(localQQAppInterface, null, (CustomEmotionData)localObject, null, 2);
      paramString.a(paramasex);
  ...
  private void i()
  {
    ...
    while (i < this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size())
    {
      ...
      {
        asft localasft = (asft)((WeakReference)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i)).get();
        if (localasft != null) {
          localasft.onDownloadFinish(j);
        }
      }
      i += 1;
    }
  ...
  public int a(List<CustomEmotionData> paramList)
  {
    ...
    if (paramList.size() > asfi.jdField_a_of_type_Int)
    {
      j = paramList.size() - asfi.jdField_a_of_type_Int;
      localObject = paramList.subList(j, asfi.jdField_a_of_type_Int + j);
    }
  ...
  protected ansq<CustomEmotionData> a()
  {
    return (anua)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.FAVEMO_ROAMING_HANDLER);
  }
  
  protected asda<CustomEmotionData> a()
  {
    return (asfk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.FAVROAMING_DB_MANAGER);
  }
  
  public TransferRequest a(CustomEmotionData paramCustomEmotionData, azla paramazla)
  {
  ...
  public void a(CustomEmotionData paramCustomEmotionData, TransferRequest paramTransferRequest)
  {
    ...
    Object localObject = anvn.a(paramCustomEmotionData.emoPath);
    if ((!TextUtils.isEmpty((CharSequence)localObject)) && (((String)localObject).contains("qto_")))
    {
      ...
      j = anvn.a(paramCustomEmotionData.eId);
      if (j != 0) {
        break label352;
      }
    }
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        return;
        localObject = ants.a(paramCustomEmotionData.emoPath);
  ...
  public void a(CustomEmotionData paramCustomEmotionData, String paramString)
  {
    ...
    do
    {
      return;
      localanua = (anua)a();
    } while (localanua == null);
    localanua.a(paramCustomEmotionData, paramString);
  }
  ...
  public void a(CustomEmotionData paramCustomEmotionData, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if ((localObject != null) && (paramBoolean))
      {
        ...
        ((asfk)localObject).b(paramCustomEmotionData);
      }
      for (;;)
      {
        i = 0;
        while (i < this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size())
        {
          if (this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i) != null)
          {
            localObject = (asft)((WeakReference)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i)).get();
            if (localObject != null) {
              ((asft)localObject).onFileDone(paramCustomEmotionData, this.jdField_a_of_type_Int, this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get());
            }
          }
          i += 1;
        }
  ...
  protected void a(EmoticonPackage paramEmoticonPackage, asih paramasih)
  {
    ArrayList localArrayList = (ArrayList)this.jdField_a_of_type_JavaUtilMap.get(paramEmoticonPackage.epId);
    int i;
    ...
    if (localArrayList != null) {
      if (paramEmoticonPackage.jobType == 0)
      {
        ...
        localEmoticon = localawyr.a(localCustomEmotionData.emoPath, localCustomEmotionData.eId);
      }
    }
    label367:
    label368:
    for (;;)
    {
      if (localEmoticon == null)
      {
        ...
        ((asfk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.FAVROAMING_DB_MANAGER)).b(localCustomEmotionData);
      ...
      if (paramasih.a(localEmoticon, 14))
      {
      ...
      if ((paramEmoticonPackage.jobType == 3) || (paramEmoticonPackage.jobType == 5))
      {
        ...
        paramasih.a(paramEmoticonPackage, false);
      }
      return;
    }
  }
  
  protected void a(EmoticonPackage paramEmoticonPackage, asih paramasih, ArrayList<Emoticon> paramArrayList, asjh paramasjh)
  {
    if ((!paramasjh.jdField_a_of_type_Boolean) && (paramEmoticonPackage.jobType != 4))
    {
      int i = 0;
      int j;
      do
      {
        paramasjh.jdField_a_of_type_JavaLangString = null;
        if (QLog.isColorLevel()) {
          QLog.d("FavroamingManager", 2, "addEmoticonsTask| fetchEncryptKeys count=" + i);
        }
        paramasih.a(paramEmoticonPackage.epId, paramArrayList, paramasjh);
        j = i + 1;
        if (paramasjh.jdField_a_of_type_Boolean) {
          break;
        }
        i = j;
      } while (j < 3);
      if (QLog.isColorLevel()) {
        QLog.d("FavroamingManager", 2, "addEmoticonsTask| fetchEncryptKeys count=" + j + " encryptKeysSuccess=" + paramasjh.jdField_a_of_type_Boolean);
      }
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    asig.a().a(this.jdField_a_of_type_Asiv);
    ((asih)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.CHAT_EMOTION_MANAGER)).a(paramString, asih.c, null, false);
  }
  ...
  public void a(List<String> paramList, asfr paramasfr)
  {
    if (paramList == null) {}
    int i;
    do
    ...
    ThreadManager.excute(new FavroamingManager.8(this, i, paramasfr, paramList), 64, null, true);
  }
  
  public TransferRequest b(CustomEmotionData paramCustomEmotionData, azla paramazla)
  {
    return a(paramCustomEmotionData, paramazla);
  }
  ...
  public void b(CustomEmotionData paramCustomEmotionData, TransferRequest paramTransferRequest)
  {
    ...
    try
    {
      ...
      paramCustomEmotionData = asih.a(paramCustomEmotionData.emoPath, paramCustomEmotionData.eId, false);
  ...
  public void c()
  {
    ...
    {
      return;
      localanua = (anua)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.FAVEMO_ROAMING_HANDLER);
    } while (localanua == null);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Anub);
    ThreadManager.excute(new FavroamingManager.3(this, localanua), 128, null, true);
  }
  ...
  public void d()
  {
    ...
    do
    {
      ...
      localObject2 = ((asfk)localObject1).b("needDownload");
      localObject3 = ((asfk)localObject1).b("overflow");
  ...
  public void h()
  {
    ...
    {
      return;
      localObject = (asfk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.FAVROAMING_DB_MANAGER);
