...
public class bewl
{
  public Context a;
  public Handler a;
  private anxg jdField_a_of_type_Anxg = new bewm(this);
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  public String a;
  
  public bewl(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, Handler paramHandler)
  {
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      ((anwd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(true, this.jdField_a_of_type_JavaLangString, str, 5);
      if (l1 == 0L)
      {
