...
public class tjq
{
  ...
  public tjq(@NonNull String paramString1, @NonNull JSONObject paramJSONObject, String paramString2, int paramInt, String paramString3)
  {
    this(paramString1, paramJSONObject, paramString2, paramString3);
    this.jdField_b_of_type_Int = paramInt;
  }
  
  public tjq(@NonNull String paramString1, @NonNull JSONObject paramJSONObject, String paramString2, String paramString3)
  {
    ...
    this.jdField_d_of_type_Int = bhtq.c(CommonSuspensionGestureLayout.a(BaseActivity.sTopActivity));
  }
  ...
  public JSONObject a()
  {
    ...
    try
    {
      ...
      for (int i = 1;; i = 0)
      {
        ...
        localJSONObject.put("netType", nnr.a());
        float[] arrayOfFloat = thy.a();
        localJSONObject.put("topActivityWidth", arrayOfFloat[0]);
        localJSONObject.put("topActivityHeight", arrayOfFloat[1]);
        if (!TextUtils.isEmpty(this.f)) {
          localJSONObject.put("colorBallData", new JSONObject(this.f));
        }
