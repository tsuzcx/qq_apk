  ...
  implements mqq.observer.BusinessObserver
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new anbh(this, Looper.getMainLooper());
  ...
  Queue<anbk> jdField_a_of_type_JavaUtilQueue = new LinkedList();
  public boolean a;
  final int jdField_b_of_type_Int = 2;
  private Handler jdField_b_of_type_AndroidOsHandler = new anbi(this, Looper.getMainLooper());
  final int c = 3;
  
  public anbg(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject1 = (anbk)paramArrayOfByte.next();
      ...
      {
        localObject3 = (anbk)((Iterator)localObject2).next();
        if (((anbk)localObject3).jdField_a_of_type_JavaLangString.equals(paramArrayOfByte))
        {
      ...
      {
        localObject4 = (anbk)((Iterator)localObject3).next();
        if (((anbk)localObject4).jdField_a_of_type_JavaLangString.equals(paramArrayOfByte))
        {
  ...
  private boolean a(signature.SignatureResult paramSignatureResult)
  {
    ...
    this.jdField_a_of_type_Anbj.jdField_b_of_type_Long = System.currentTimeMillis();
    if (paramSignatureResult.u32_timeout.has()) {
      this.jdField_a_of_type_Anbj.jdField_a_of_type_Long = paramSignatureResult.u32_timeout.get();
    }
    if (paramSignatureResult.u32_check_result.has()) {
      this.jdField_a_of_type_Anbj.jdField_a_of_type_Int = paramSignatureResult.u32_check_result.get();
    }
    if (paramSignatureResult.str_title.has()) {
      this.jdField_a_of_type_Anbj.jdField_c_of_type_JavaLangString = paramSignatureResult.str_title.get();
    }
    if (paramSignatureResult.str_content.has()) {
      this.jdField_a_of_type_Anbj.d = paramSignatureResult.str_content.get();
    }
    if (paramSignatureResult.str_left_button.has()) {
      this.jdField_a_of_type_Anbj.e = paramSignatureResult.str_left_button.get();
    }
    if (paramSignatureResult.str_right_button.has()) {
      this.jdField_a_of_type_Anbj.f = paramSignatureResult.str_right_button.get();
    }
    if (paramSignatureResult.str_url.has()) {
      this.jdField_a_of_type_Anbj.g = paramSignatureResult.str_url.get();
    }
    this.jdField_a_of_type_Anbj.b();
    this.jdField_a_of_type_Anbj = null;
    return true;
  }
  ...
  public void b(String paramString, Context paramContext, Intent paramIntent)
  {
    ...
    this.jdField_a_of_type_Anbl = new anbl(this, paramString);
    this.jdField_a_of_type_Anbj = new anbj(this, paramString);
    long l;
    if (Long.valueOf(System.currentTimeMillis()).longValue() < this.jdField_a_of_type_Anbj.jdField_b_of_type_Long + 86400000L)
    {
      PackageInfo localPackageInfo = a(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApplication(), this.jdField_a_of_type_Anbl.jdField_a_of_type_JavaLangString);
      if (localPackageInfo != null)
      {
        ...
        if ((this.jdField_a_of_type_Anbj.jdField_c_of_type_Long == l) && (this.jdField_a_of_type_Anbj.jdField_a_of_type_JavaLangString.equalsIgnoreCase(str)))
        {
          if (this.jdField_a_of_type_Anbj.jdField_a_of_type_Int != 2)
          {
            paramContext.startActivity(paramIntent);
            return;
          }
          ...
          paramContext.putString("dlg_title", this.jdField_a_of_type_Anbj.jdField_c_of_type_JavaLangString);
          paramContext.putString("dlg_content", this.jdField_a_of_type_Anbj.d);
          paramContext.putString("dlg_lbutton", this.jdField_a_of_type_Anbj.e);
          paramContext.putString("dlg_rbutton", this.jdField_a_of_type_Anbj.f);
          paramContext.putString("dlg_url", this.jdField_a_of_type_Anbj.g);
          ...
          try
          {
            bcef.b(null, "P_CliOper", "Safe_StartAppCheck", this.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount(), "startAppByCheckValid", this.jdField_a_of_type_Anbj.jdField_b_of_type_JavaLangString, 0, 0, "", "", "", "");
            return;
          }
    ...
    for (;;)
    {
      try
      {
        this.jdField_a_of_type_Anbl.jdField_a_of_type_Long = Long.valueOf(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount()).longValue();
        this.jdField_a_of_type_Anbl.jdField_a_of_type_Int = 1;
        this.jdField_a_of_type_Anbl.jdField_a_of_type_JavaLangString = paramString;
        paramString = new anbk(this, paramString, paramContext, paramIntent);
        ...
        if (this.jdField_a_of_type_Anbj.jdField_a_of_type_Long <= 0L) {
          break label579;
        }
        l = this.jdField_a_of_type_Anbj.jdField_a_of_type_Long;
