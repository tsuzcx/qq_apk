...
public class anbg
{
  ...
  {
    // Byte code:
    //   0: getstatic 15	anbg:jdField_a_of_type_Boolean	Z
    //   3: ifeq +5 -> 8
    //   6: iconst_0
    //   7: ireturn
    //   8: fconst_0
    ...
    //   152: fstore_0
    //   153: lload_3
    //   154: getstatic 65	anbg:jdField_a_of_type_Long	J
    //   157: lsub
    //   158: l2f
    //   159: fstore_2
    //   160: aload 8
    ...
    //   165: fstore_0
    //   166: lload_3
    //   167: getstatic 65	anbg:jdField_a_of_type_Long	J
    //   170: lsub
    //   171: lload 5
    //   173: ladd
    //   174: getstatic 67	anbg:b	J
    //   177: lsub
    //   178: l2f
    //   179: fstore_1
    //   180: aload 8
    ...
    //   198: fstore_0
    //   199: lload_3
    //   200: putstatic 65	anbg:jdField_a_of_type_Long	J
    //   203: aload 8
    //   205: astore 7
    //   207: fload_1
    //   208: fstore_0
    //   209: lload 5
    //   211: putstatic 67	anbg:b	J
    //   214: fload_1
    //   215: fstore_2
    //   216: aload 8
    //   218: ifnull +10 -> 228
    ...
    //   259: astore 7
    //   261: iconst_1
    //   262: putstatic 15	anbg:jdField_a_of_type_Boolean	Z
    //   265: fload_0
    //   266: fstore_2
    //   267: aload 8
    //   269: ifnull -41 -> 228
  ...
  public static anax a()
  {
    ...
    if ((localAppRuntime instanceof QQAppInterface)) {
      return new anaz().a(1).a(((QQAppInterface)localAppRuntime).getCurrentAccountUin()).a();
    }
