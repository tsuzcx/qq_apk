...
public abstract class aczc
{
  ...
  public static aczc a(String paramString, JSONObject paramJSONObject)
  {
    if ("dex".equals(paramString))
    {
      ...
      do
      {
        ...
        if (PatchCommonUtil.isDalvik()) {
          return new aczf(paramJSONObject);
        }
        if (PatchCommonUtil.isArtLM()) {
          return new acze(paramJSONObject);
        }
      } while (!PatchCommonUtil.isArtGeN());
      return new aczd(paramJSONObject);
    }
    if ("Native".equals(paramString)) {
      return new aczg(paramJSONObject);
    }
