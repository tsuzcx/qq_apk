...
public class ayvu
{
    ...
    for (;;)
    {
      ...
      if ((str.charAt(k) == '\024') && (k + 1 < str.length()))
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "localeCode value:" + j + ",max len:" + ayvy.a.length);
        }
        if (apog.c(j))
        {
          m = apog.a(j);
        ...
        arrayOfInt = apih.a((char[])localObject2);
      ...
      for (paramString = paramString.getSharedPreferences("Last_Login", j).getString("uin", "");; paramString = null) {
        for (;;)
        {
          try
          {
            ...
            localObject1 = baig.jdField_c_of_type_JavaLangString;
            if (paramString == null) {
              break label1151;
            }
            paramString = (aube)paramString.getManager(14);
            if (paramString == null) {
              break label1157;
            }
  ...
  public static long a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (long l1 = bdlr.a(arrayOfByte, 0);; l1 = 0L)
    {
  ...
  public static ayvk a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, long paramLong1, boolean paramBoolean1, boolean paramBoolean2, long paramLong2, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (localObject != null)
      {
        if (!paramMessageHandler.app.a().a((aqxw)localObject))
        {
          if (QLog.isColorLevel()) {
        ...
        if (!((aqxw)localObject).jdField_b_of_type_Boolean)
        {
          if (QLog.isColorLevel()) {
        ...
        paramMessageHandler.app.a().b(i, String.valueOf(paramLong1), paramMsg, l, s, paramBoolean1, 0, null, (aqxw)localObject, paramLong2, paramInt);
      }
      else
      {
        if (QLog.isColorLevel()) {
  ...
  public static aywa a(msg_comm.Msg paramMsg, QQAppInterface paramQQAppInterface)
  {
    ...
    if (!localC2CTmpMsgHead.c2c_type.has())
    {
      ...
      localaywa.jdField_b_of_type_Int = localC2CTmpMsgHead.direction_flag.get();
      ...
      default: 
        label312:
        localaywa.jdField_a_of_type_Int = i;
        localaywa.jdField_a_of_type_Long = -1L;
        localaywa.jdField_b_of_type_Long = -1L;
        switch (k)
        {
        }
        break;
    ...
    for (;;)
    {
      paramQQAppInterface = (abpm)paramQQAppInterface.a().a().a(k);
      if (paramQQAppInterface != null) {
        paramQQAppInterface.a(paramMsg, localaywa);
      }
      if (QLog.isColorLevel())
      {
        paramMsg = new StringBuilder("<---getC2CMsgPkgTempInfo: dump info:");
        paramMsg.append(" c2cType:").append(j).append(" serviceType:").append(k).append("direction_flag:").append(localaywa.jdField_b_of_type_Int).append(" info:").append(localaywa.toString());
      ...
      i = 1045;
      break label312;
      localaywa.jdField_a_of_type_Long = localC2CTmpMsgHead.group_code.get();
      localaywa.jdField_b_of_type_Long = localC2CTmpMsgHead.group_uin.get();
      continue;
      localaywa.jdField_a_of_type_Long = localC2CTmpMsgHead.group_code.get();
      localaywa.jdField_b_of_type_Long = localC2CTmpMsgHead.group_code.get();
      continue;
      localaywa.jdField_a_of_type_Long = localC2CTmpMsgHead.group_code.get();
      localaywa.jdField_b_of_type_Long = localC2CTmpMsgHead.group_uin.get();
    }
  ...
  public static MessageRecord a(MessageHandler paramMessageHandler, byte[] paramArrayOfByte, msg_comm.Msg paramMsg)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramArrayOfByte = (MessageForNearbyLiveTip)ayvw.a(-2053);
        if (localMsgBody.uint32_anchor_status.get() == 1)
        {
          ...
          paramArrayOfByte.senderuin = String.valueOf(aljq.l + l1);
          paramArrayOfByte.frienduin = String.valueOf(aljq.l + l1);
          ...
          azmj.b(null, "dc00899", "grp_lbs", "", "msg_box", "view_live_message", 0, 0, "", "", "", "");
  ...
  public static MessageRecord a(List<MessageRecord> paramList, byte[] paramArrayOfByte, bbku parambbku)
  {
    ...
    paramList = (MessageForMixedMsg)ayvw.a(-1035);
    paramList.msgtype = -1035;
    paramList.msgData = localMsg.toByteArray();
    if ((parambbku != null) && (parambbku.jdField_a_of_type_Int == 3000)) {
      paramList.frienduin = parambbku.jdField_a_of_type_JavaLangString;
    }
    if (i != 0) {
      bceh.a(parambbku.jdField_a_of_type_Int, localJSONObject.toString(), paramList);
    }
    if (paramArrayOfByte != null) {
      paramList.saveExtInfoToExtStr("sens_msg_ctrl_info", bdcv.a(paramArrayOfByte));
    }
    paramList.parse();
    return paramList;
  }
  ...
  public static String a(String paramString)
  {
    ...
    if (i < paramString.length())
    {
      if ((paramString.charAt(i) == '\024') && (i + 1 < paramString.length()))
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "localeCode value:" + k + ",max len:" + ayvy.a.length);
        }
        j = i;
        if (apog.c(k))
        {
  ...
  public static msg_svc.PbSendMsgReq a(QQAppInterface paramQQAppInterface, int paramInt1, String paramString, aywb paramaywb, long paramLong, int paramInt2)
  {
    if (paramaywb == null) {
    ...
    do
    {
      ...
      {
        l = 0x0 | paramaywb.jdField_a_of_type_ArrayOfByte.length << 16 | 0xA6;
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "<PbSendMsg><S>--->createPbSendMsgReq: routingType:" + paramInt1 + ",toUin:" + paramString + ",msgUid:" + l + ",msgSeq:" + paramLong + ",uint32Seq:" + k + ",shortSeq:" + j + ",randomNum:" + paramInt2 + ",msgContext:" + paramaywb);
        }
      ...
      for (;;)
      {
        ...
        ((msg_svc.TransMsg)localObject).c2c_cmd.set(paramaywb.jdField_a_of_type_Int);
        ...
        ((msg_svc.Trans0x211)localObject).cc_cmd.set(paramaywb.jdField_a_of_type_Int);
      ...
      localMsgBody.msg_content.set(ByteStringMicro.copyFrom(paramaywb.jdField_a_of_type_ArrayOfByte));
      ...
      paramaywb = paramQQAppInterface.a();
      paramQQAppInterface = paramString;
    } while (paramaywb == null);
    paramString.sync_cookie.set(ByteStringMicro.copyFrom(paramaywb));
    return paramString;
  }
  ...
  public static msg_svc.PbSendMsgReq a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, im_msg_body.RichText paramRichText, int paramInt)
  {
    ...
    do
    {
      ...
      k = ayvy.a(l);
      localayvc = paramQQAppInterface.a();
      localRoutingHead = new msg_svc.RoutingHead();
    ...
    if ((i != 2) && (i != 4) && (i != 21))
    {
      paramQQAppInterface = localayvc.a();
      if (paramQQAppInterface != null) {
  ...
  public static im_msg_body.RichText a(ChatMessage paramChatMessage, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      byte[] arrayOfByte = azsd.b((byte[])localObject3);
      localObject1 = localObject2;
      if (arrayOfByte == null) {
        continue;
      }
      ...
      try
      {
        ...
        for (;;)
        {
          ...
          if ((paramChatMessage == null) || (paramChatMessage.length() == 0)) {
            localObject1 = BaseApplication.getContext().getString(2131693910);
          } else {
            localObject1 = String.format(BaseApplication.getContext().getString(2131693911), new Object[] { paramChatMessage });
          }
        }
        return null;
      }
  ...
  public static im_msg_body.RichText a(MessageForMarketFace paramMessageForMarketFace)
  {
    ...
    for (String str = alpo.a(2131707031);; str = "[" + paramMessageForMarketFace.mMarkFaceMessage.faceName + "]")
    {
      boolean bool = true;
  ...
  public static im_msg_body.RichText a(MessageForReplyText paramMessageForReplyText)
  {
    ...
    try
    {
      String str = bdcv.a(ammq.a(paramMessageForReplyText.mSourceMsgInfo));
      localObject1 = str;
      localObject2 = str;
      ...
      if ((paramMessageForStructing.structingMsg instanceof AbsShareMsg))
      {
        ...
        if (localObject1 != null)
        {
          ...
          for (;;)
          {
            ...
            {
              localObject2 = ((azqk)localObject2).a;
              if (localObject2 != null)
              {
  ...
  public static im_msg_body.RichText a(MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      if (!TextUtils.isEmpty((CharSequence)localObject4))
      {
        try
        {
          localSourceMsgInfo = (MessageForReplyText.SourceMsgInfo)ammq.a(bdcv.a((String)localObject4));
    ...
    do
    {
      do
      {
        do
        {
          ...
          return;
          ((alxw)paramMessageHandler.app.a(18)).a(((msg_comm.MsgType0x210)localObject1).msg_content.get().toByteArray());
          ...
          return;
          ((azwd)paramMessageHandler.app.getManager(17)).a(((msg_comm.MsgType0x210)localObject1).msg_content.get().toByteArray());
          return;
          ...
          ((alzf)paramMessageHandler.app.a(20)).a(((msg_comm.MsgType0x210)localObject1).msg_content.get().toByteArray());
          return;
          if (QLog.isColorLevel()) {
          ...
          aiqx.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramMessageHandler, paramLong, i, l1, j);
          return;
          if (QLog.isColorLevel()) {
      ...
      try
      {
        ...
        localObject2 = (apdq)paramMessageHandler.app.getManager(71);
        if (localObject2 != null) {
          ((apdq)localObject2).a().a((SubMsgType0x6f.MCardNotificationLike)localObject4);
        }
        a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
        return;
      }
    ...
    for (;;)
    {
      for (;;)
      {
        for (;;)
        {
          ...
          ((ambd)paramMessageHandler.app.a(27)).a((String)localObject4, (String)localObject2);
          break label1915;
          if ((i == 2003) && (((SubMsgType0x6f.ForwardBody)localObject2).msg_push_lost_dev_found.has()))
          {
            ...
            ((zpa)paramMessageHandler.app.a(51)).a(111, (Bundle)localObject4);
            break label1915;
          }
          ...
          ((QIMNotifyAddFriend)localObject4).pushTime = ayvc.a();
          if (QLog.isColorLevel()) {
            QLog.d("QIMNewNotifyPush_offLine", 2, "receive data= " + ((QIMNotifyAddFriend)localObject4).toString());
          }
          ((alvf)paramMessageHandler.app.getManager(257)).a((QIMNotifyAddFriend)localObject4);
          break label1915;
          if (QLog.isColorLevel()) {
            QLog.d("TurnBrand", 2, "decode recv msg0x210.Submsgtype0x6e");
          }
          localObject2 = (alws)paramMessageHandler.app.getManager(22);
          if (localObject2 != null) {
            ((alws)localObject2).a();
          }
          a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
          ...
          try
          {
            ...
            if (((submsgtype0x67.MsgBody)localObject4).rpt_msg_grpinfo.has())
            {
              ...
              localObject4 = (alqx)paramMessageHandler.app.a(3);
              if (localObject4 != null) {
                ((alqx)localObject4).a((List)localObject2);
              }
            }
            a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
            return;
          ...
          ((alvj)paramMessageHandler.app.a(47)).a(true);
          a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
          return;
          ...
          try
          {
            ...
            ((ayto)paramMessageHandler.app.getManager(94)).a(paramMsg, 1);
            return;
          }
          catch (InvalidProtocolBufferMicroException paramMessageHandler) {}
        }
        ...
        try
        {
          ...
          if (((SubMsgType0x87.MsgBody)localObject4).rpt_msg_msg_notify.has()) {
            ahgp.a(paramMessageHandler.app, (SubMsgType0x87.MsgBody)localObject4);
          }
          a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
          return;
        }
        ...
        try
        {
          ...
          ((askw)paramMessageHandler.app.getManager(156)).a((SubMsgType0xaa.MsgBody)localObject4, true);
          a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
          return;
        }
        ...
        label4682:
        paramMsg = ((abow)paramMessageHandler.a("businessbase_processor")).a(localException5.msg_content.get().toByteArray());
        if (TextUtils.isEmpty(paramMsg)) {
          break;
        }
        paramBoolean1 = ((aloz)paramMessageHandler.app.getManager(51)).b(paramMsg);
        if (QLog.isColorLevel()) {
        ...
        ((abow)paramMessageHandler.a("businessbase_processor")).a(localException5.msg_content.get().toByteArray(), paramMsg.msg_head.msg_time.get());
        a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
        return;
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "handleMsgType0x210SubMsgType0xee receive 0xee push message");
        }
        ((abow)paramMessageHandler.a("businessbase_processor")).b(localException5.msg_content.get().toByteArray(), paramMsg.msg_head.msg_time.get());
        a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
        return;
        localObject4 = (abow)paramMessageHandler.a("businessbase_processor");
        ...
        ((abow)localObject4).a(localException5.msg_content.get().toByteArray(), 2, (MsgInfo)localObject5);
        ...
        ((MsgInfo)localObject5).lMsgUid = paramMsg.msg_head.msg_uid.get();
        ((MsgInfo)localObject5).shMsgType = ((short)paramMsg.msg_head.msg_type.get());
        ((abow)localObject4).a(localException5.msg_content.get().toByteArray(), 2);
        a(paramMessageHandler, ((MsgInfo)localObject5).lFromUin, ((MsgInfo)localObject5).shMsgSeq, ((MsgInfo)localObject5).lMsgUid, ((MsgInfo)localObject5).shMsgType);
        return;
        if (QLog.isColorLevel()) {
        ...
        paramMsg = new amgu(paramLong, i, l1, j, k, false);
        ((abow)paramMessageHandler.a("businessbase_processor")).a(localException5.msg_content.get().toByteArray(), paramMsg);
        a(paramMessageHandler, paramLong, i, l1, j);
        return;
        if (QLog.isColorLevel()) {
        ...
        if ((localObject3 == null) || (alsh.a(paramMessageHandler.app, (MessageRecord)localObject3, true)) || (((MessageRecord)localObject3).msgtype != -2053)) {
          break;
        }
        ...
        localObject4 = (akji)paramMessageHandler.app.getManager(153);
        if (localObject4 != null) {
          ((akji)localObject4).a(((msg_comm.MsgType0x210)localObject3).msg_content.get().toByteArray());
        }
        a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
        return;
        ...
        try
        {
          ...
          paramMessageHandler = (akkd)paramMessageHandler.app.getManager(227);
      ...
      paramMessageHandler = (uhj)paramMessageHandler.app.getManager(253);
      ...
      try
      {
        ...
        while (((Iterator)localObject3).hasNext())
        {
          ...
          if (paramMessageHandler.app != null) {
            ((avqq)paramMessageHandler.app.getManager(266)).b((NowPushMsgList.NowPushMsg)localObject4);
          }
          if (QLog.isColorLevel()) {
      ...
      try
      {
        ...
        alro.a(paramMessageHandler.app, (byte[])localObject3);
        a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
        return;
      }
      catch (Exception paramMessageHandler)
      ...
      atig.a(paramMessageHandler.app, (byte[])localObject3, paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_time.get(), true);
      a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
      return;
      if (QLog.isColorLevel()) {
      ...
      localObject3 = ((msg_comm.MsgType0x210)localObject3).msg_content.get().toByteArray();
      localObject4 = ((baky)paramMessageHandler.app.getManager(339)).a(4);
      if (localObject4 != null) {
        ((balj)localObject4).a(paramMessageHandler.app, (byte[])localObject3, paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_time.get(), true);
      }
      a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
      return;
      if (QLog.isColorLevel()) {
      ...
      localObject3 = apdm.a(paramMessageHandler.app, ((msg_comm.MsgType0x210)localObject3).msg_content.get().toByteArray(), paramMsg);
      paramMessageHandler.app.a().a((MessageRecord)localObject3, paramMessageHandler.app.getCurrentAccountUin());
      a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
      return;
      if (QLog.isColorLevel()) {
      ...
      localObject3 = apeq.a(paramMessageHandler.app, ((msg_comm.MsgType0x210)localObject3).msg_content.get().toByteArray(), paramMsg);
      paramMessageHandler.app.a().a((MessageRecord)localObject3, paramMessageHandler.app.getCurrentAccountUin());
      a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
      return;
      if (!QLog.isColorLevel()) {
      ...
      try
      {
        ...
        if (!badt.a(paramMsg.msg_head.msg_seq.get()))
        {
          badt.a(paramMessageHandler.app, (SubMsgType0x119.MsgBody)localObject4);
      ...
      {
        aslq.a(paramMessageHandler, (byte[])localObject3, (MsgInfo)localObject4, paramBoolean1);
        return;
      }
      if (QLog.isColorLevel()) {
      ...
      try
      {
        ...
        ((apwv)paramMessageHandler.app.a(127)).a((submsgtype0x128.MsgBody)localObject4);
      ...
      {
        localObject3 = ((msg_comm.MsgType0x210)localObject3).msg_content.get().toByteArray();
        localObject4 = (ahfa)paramMessageHandler.app.a(169);
        if (localObject4 != null) {
          ((ahfa)localObject4).a((byte[])localObject3);
        }
        a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
        return;
      }
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (!paramMessageHandler.a().a(str))
        {
          ...
          if ((paramInt1 == 241) || (ayvy.a(str, paramInt1)))
          {
            ...
            paramMsg = (MessageForPic)ayvw.a(-2000);
        ...
        for (;;)
        {
          ...
          QLog.d("Q.msg.MessageHandler", 2, localStringBuilder.toString());
          return;
          if ((paramInt1 != 242) && (!ayvy.b(str, paramInt1))) {
            break;
          }
          ...
          for (;;)
          {
            paramMsg = bauj.a((String)localObject1, paramLong1, 2, false, (String)localObject1, null, "ftn");
            ...
            bark.a(paramMessageHandler.app, 1, false, 4);
            break;
            if (QLog.isColorLevel()) {
  ...
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg)
  {
    ...
    Object localObject4;
    long l2;
    if (azwd.a(paramMessageHandler.app))
    {
      i4 = 1;
      l1 = -1L;
      localObject2 = "";
      ...
      i2 = localObject7[i1];
      i1 += 1;
      i5 = bdlr.a((byte[])localObject7, i1);
      i6 = i1 + 2;
      if (i2 != 3) {
        break label514;
      }
      localObject4 = new byte[i5];
      bdlr.a((byte[])localObject4, 0, (byte[])localObject7, i6, i5);
      l2 = bdlr.a((byte[])localObject4, 0);
      if (l2 > 0L) {
        l1 = l2;
      }
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (i2 == 9)
      {
        localObject4 = new byte[i5];
        bdlr.a((byte[])localObject4, 0, (byte[])localObject7, i6, i5);
        n = bdic.b(bdal.a(bdlr.a((byte[])localObject4, 0)));
        localObject4 = localObject1;
        localObject1 = localObject2;
        localObject2 = localObject4;
      }
      else if (i2 == 8)
      {
        localObject4 = new byte[i5];
        bdlr.a((byte[])localObject4, 0, (byte[])localObject7, i6, i5);
        m = (int)bdlr.a((byte[])localObject4, 0);
        localObject4 = localObject1;
        localObject1 = localObject2;
        localObject2 = localObject4;
      }
      else
      {
        ...
        bdlr.a((byte[])localObject5, 0, (byte[])localObject7, i6, i5);
    ...
    for (;;)
    {
      ...
      for (localObject4 = ((ByteStringMicro)localObject4).toStringUtf8();; localObject4 = "") {
        for (;;)
        {
          ...
          {
            i1 = 1;
            azmj.b(paramMessageHandler.app, "CliOper", "", "", "0X80060E4", "0X80060E4", i1, 0, "", "", "", "8.3.3");
            ...
            localObject8 = bdcv.a(((im_msg_body.Ptt)localObject6).bytes_file_md5.get().toByteArray());
          }
          try
          {
            ...
            for (;;)
            {
              try
              {
                ...
                if (((generalflags.ResvAttr)localObject6).bytes_pb_ptt_waveform.has())
                {
                  ...
                  ((MessageForPtt)localObject5).waveformArray = bdew.a((ptt_waveform.PttWaveform)localObject7);
                  if (QLog.isColorLevel())
                  {
            ...
            if (localRichText.elems.has())
            {
              ...
              while (paramList.hasNext())
              {
                ...
                if ((((im_msg_body.Elem)localObject3).common_elem.has()) && (21 == ((im_msg_body.Elem)localObject3).common_elem.uint32_service_type.get()))
                {
                  ...
                  aoep.a(paramMsg, (im_msg_body.Elem)localObject3, localArrayList, paramMessageHandler.app);
                }
              }
            }
            ajat.b((String)localObject1, (MessageRecord)localObject4);
            return;
          }
        }
      }
  ...
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg, long paramLong1, long paramLong2, boolean paramBoolean)
  {
    ...
    if (paramMsg.appshare_info.has())
    {
      ...
      localObject1 = bdaw.a((msg_comm.PluginInfo)localObject1);
      if (QLog.isColorLevel()) {
      ...
      if (localObject2 == null)
      {
        paramMessageHandler.a().a((awbv)localObject1);
        if (QLog.isColorLevel()) {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if ((paramMsg.msg_body.has()) && (((im_msg_body.MsgBody)paramMsg.msg_body.get()).rich_text.has()))
      {
        ...
        paramMsg = null;
        localObject2 = BaseApplication.getContext().getString(2131719918);
          ...
          for (localObject1 = localObject4;; localObject1 = null)
          {
            if (localObject1 != null)
            {
              ...
              if (localObject1 != null)
              {
                ...
                localObject2 = localObject1;
                ((PBStringField)localObject4).set((String)localObject2);
                localObject2 = bauj.a((String)localObject1, j, 1, false, (String)localObject1);
                if (QLog.isColorLevel()) {
            ...
            for (localObject1 = localObject3;; localObject1 = localObject3)
            {
              ...
              for (;;)
              {
                ...
                {
                  paramMessageHandler.a().b((awbv)localObject2);
                  paramMessageHandler.a().a((awbv)localObject1);
                  if (!QLog.isColorLevel()) {
                    break;
                  }
                ...
                else if (((im_msg_body.Elem)localObject1).custom_face.has())
                {
                  ...
                  localObject7 = bdcv.a((byte[])localObject7);
                  localObject5 = bdcv.a((byte[])localObject5);
                  localObject6 = bdcv.a((byte[])localObject6);
                  if (QLog.isColorLevel()) {
                  ...
                  {
                    ((PBStringField)localObject4).set((String)localObject2);
                    localObject2 = bauj.a((String)localObject1, 0L, 1, false, (String)localObject1);
                    paramBoolean = true;
                    break;
                    localObject2 = "";
                    break label1455;
                  ...
                  for (;;)
                  {
                    ...
                    do
                    {
                      ...
                      if ((!paramBoolean) && (bool1))
                      {
                        paramMessageHandler = (MessageForText)ayvw.a(-1000);
                    ...
                    paramMessageHandler.d(String.valueOf(bdaw.b(l1)));
                    paramMsg = bdao.a(localAppShareInfo.appshare_cookie.get().toByteArray());
                    if (QLog.isColorLevel()) {
                    ...
                    localObject1 = bdao.a((String)localObject2, (String)localObject1, l1, paramMsg.jdField_a_of_type_JavaLangString);
                    if (QLog.isColorLevel()) {
                      QLog.d("Q.msg.MessageHandler", 2, "<--decodeC2CMsgPkg_AppShared : content:" + (String)localObject2 + ",encodeMsg:" + (String)localObject1);
                    }
                    localObject2 = ayvw.a(paramMsg.jdField_b_of_type_Int);
  ...
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg, long paramLong, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (paramBoolean2 = true;; paramBoolean2 = false)
    {
      ...
      paramMsg = new ayvr().a((List)localObject);
      if (TextUtils.isEmpty(paramMsg)) {
        break;
      }
      paramMessageHandler = paramMessageHandler + " " + paramMsg;
      paramMsg = ayvw.a(-10000);
    ...
    do
    {
      ...
      do
      {
              ...
              if (QLog.isColorLevel())
              {
                ...
                if (QLog.isColorLevel())
                {
                  ...
                  try
                  {
                    ...
                    if (!paramBoolean4)
                    {
                      ((allz)paramMessageHandler.app.a(8)).a(paramMsg, paramList);
                      return;
                    }
                  }
                  catch (InvalidProtocolBufferMicroException paramMessageHandler) {}
        ...
        try
        {
          ...
          if (paramMsg != null)
          {
            aqxj.a(String.valueOf(paramLong1), paramMsg);
            paramList = (List<MessageRecord>)localObject1;
          }
        }
      ...
      ((zpa)paramMessageHandler.app.a(51)).a(paramLong1, paramLong2, paramInt, l1, i, "im_push.msg_push", (byte[])localObject2);
    } while (!QLog.isColorLevel());
    label801:
    label943:
  ...
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg, aywa paramaywa, ayva paramayva)
  {
    ...
    for (;;)
    {
      ...
      if ((!paramayva.d) && (paramaywa.jdField_a_of_type_Int == 1006))
      {
        ...
        if ((!((msg_comm.C2CTmpMsgHead)localObject4).from_phone.has()) || (localObject1 == null) || (((String)localObject1).equals("+0")))
        {
          ...
          bdbt.a(paramMessageHandler.app, ((msg_comm.C2CTmpMsgHead)localObject4).from_phone.get(), paramayva.e + "");
        }
      }
      else
      {
        ...
        if (!paramayva.d)
        {
          ...
          if (((msg_comm.C2CTmpMsgHead)localObject4).sig.has())
          {
            ...
            if (QLog.isDevelopLevel()) {
              QLog.d("Q.msg.MessageHandler", 4, "tempHead.sig.get()----> sig:" + bdcv.a((byte[])localObject1) + ",length:" + localObject1.length);
            }
          }
        }
        if (localObject1 != null) {}
        switch (paramaywa.jdField_a_of_type_Int)
        {
        default: 
          localObject3 = (abpj)paramMessageHandler.app.a().a().a(paramaywa.jdField_a_of_type_Int);
          if (localObject3 != null) {
            ((abpj)localObject3).a(paramayva, (byte[])localObject1);
          }
          label588:
          k = 0;
          i = k;
        ...
        for (i = 1;; i = 0)
        {
          ...
          if (paramayva.jdField_b_of_type_Boolean) {
            break;
          }
          ...
          bdlr.a((byte[])localObject3, 2, (byte[])localObject1, 0, localObject1.length);
          paramMessageHandler.app.a().a(String.valueOf(paramayva.e), (byte[])localObject3);
          break label588;
          localObject3 = new byte[localObject1.length + 2];
          localObject3[0] = ((byte)i);
          localObject3[1] = ((byte)k);
          bdlr.a((byte[])localObject3, 2, (byte[])localObject1, 0, localObject1.length);
          paramMessageHandler.app.a().b(String.valueOf(paramayva.e), (byte[])localObject3);
          break label588;
          paramMessageHandler.app.a().c(String.valueOf(paramayva.e), (byte[])localObject1);
          break label588;
          localObject3 = new byte[localObject1.length + 2];
          localObject3[0] = ((byte)i);
          localObject3[1] = ((byte)k);
          bdlr.a((byte[])localObject3, 2, (byte[])localObject1, 0, localObject1.length);
          paramMessageHandler.app.a().e(String.valueOf(paramayva.e), (byte[])localObject3);
          break label588;
          localObject3 = new byte[localObject1.length + 2];
          localObject3[0] = ((byte)i);
          localObject3[1] = ((byte)k);
          bdlr.a((byte[])localObject3, 2, (byte[])localObject1, 0, localObject1.length);
          paramMessageHandler.app.a().f(String.valueOf(paramayva.e), (byte[])localObject3);
          break label588;
          paramMessageHandler.app.a().g(String.valueOf(paramayva.e), (byte[])localObject1);
          break label588;
          paramMessageHandler.app.a().h(String.valueOf(paramayva.e), (byte[])localObject1);
          break label588;
          paramMessageHandler.app.a().i(String.valueOf(paramayva.e), (byte[])localObject1);
          break label588;
          paramMessageHandler.app.a().j(String.valueOf(paramayva.e), (byte[])localObject1);
          break label588;
          paramMessageHandler.app.a().m(String.valueOf(paramayva.e), (byte[])localObject1);
          break label588;
          paramMessageHandler.app.a().o(String.valueOf(paramayva.e), (byte[])localObject1);
          break label588;
          paramMessageHandler.app.a().l(String.valueOf(paramayva.e), (byte[])localObject1);
          break label588;
          paramMessageHandler.app.a().k(String.valueOf(paramayva.e), (byte[])localObject1);
          break label588;
          paramMessageHandler.app.a().a(String.valueOf(paramayva.e), String.valueOf(paramayva.jdField_a_of_type_Long), (byte[])localObject1);
          break label588;
          paramMessageHandler.app.a().b(String.valueOf(paramayva.e), String.valueOf(paramayva.jdField_a_of_type_Long), (byte[])localObject1);
          break label588;
          paramMessageHandler.app.a().c(String.valueOf(paramayva.e), String.valueOf(paramayva.jdField_a_of_type_Long), (byte[])localObject1);
          break label588;
          paramMessageHandler.app.a().a(String.valueOf(paramayva.e), String.valueOf(paramayva.jdField_a_of_type_Long), (byte[])localObject1, false);
          break label588;
          if (!paramayva.i) {
            break label588;
          }
          paramMessageHandler.app.a().d(String.valueOf(paramayva.e), String.valueOf(paramayva.jdField_a_of_type_Long), (byte[])localObject1);
          break label588;
          paramMessageHandler.app.a().e(String.valueOf(paramayva.e), String.valueOf(paramayva.jdField_a_of_type_Long), (byte[])localObject1);
          break label588;
        }
        label1445:
        if (paramaywa != null) {
          ...
          {
            paramayva = ((im_msg_body.MsgBody)paramMsg.msg_body.get()).msg_content.get().toByteArray();
            localObject1 = new im_msg_body.TmpPtt();
            try
            {
              paramayva = (im_msg_body.TmpPtt)((im_msg_body.TmpPtt)localObject1).mergeFrom(paramayva);
              int m;
              int n;
              if ((paramayva != null) && (paramayva.uint32_file_type.has()) && (paramayva.uint32_file_type.get() == 4) && (paramayva.bytes_file_uuid.has()))
              {
                localObject1 = paramayva.bytes_file_uuid.get().toStringUtf8();
                if (QLog.isColorLevel()) {
                  QLog.d("Q.msg.MessageHandler", 2, "<---decodeC2CMsgPkg_Temp2 : ptt uuid:" + (String)localObject1);
                }
                localObject4 = new RichMsg.PttRec();
                ((RichMsg.PttRec)localObject4).localPath.set(paramayva.bytes_file_uuid.get().toStringUtf8());
                ((RichMsg.PttRec)localObject4).size.set(paramayva.uint32_file_size.get());
                ...
                i = 0;
                k = i;
                if (paramayva.uint32_user_type.has())
                {
                  j = paramayva.uint32_user_type.get();
                  if (j != 1)
                  {
                    k = i;
                    if (j != 2) {}
                ...
                localObject3 = "";
                localObject1 = localObject3;
                if (paramayva.bytes_pb_reserve.has())
                {
              ...
              try
              {
                ((ptt_reserve.ReserveStruct)localObject1).mergeFrom(paramayva.bytes_pb_reserve.get().toByteArray());
                j = n;
                i = m;
              ...
              ((RichMsg.PttRec)localObject4).busiType.set(paramayva.uint32_busi_type.get());
              ((RichMsg.PttRec)localObject4).autototext_voice.set(j);
              ((RichMsg.PttRec)localObject4).sttText.set((String)localObject1);
              localObject1 = ayvw.a(-2002);
              ((MessageRecord)localObject1).msgtype = -2002;
              ((MessageRecord)localObject1).msgData = ((RichMsg.PttRec)localObject4).toByteArray();
              ((MessageForPtt)localObject1).parse();
              if ((paramayva.uint64_msg_id.has()) && (paramayva.uint64_msg_id.get() != 0L)) {
                ((MessageRecord)localObject1).saveExtInfoToExtStr("pa_msgId", paramayva.uint64_msg_id.get() + "");
              }
              aoep.a(paramMsg, (MessageRecord)localObject1, paramMessageHandler.app);
              bfvv.a(paramaywa, paramMsg, (MessageRecord)localObject1);
              paramList.add(localObject1);
              return;
            }
            catch (InvalidProtocolBufferMicroException paramayva)
            {
              for (;;)
              {
                paramayva.printStackTrace();
                paramayva = null;
              }
            }
          }
    ...
    localObject1 = new bbku();
    ((bbku)localObject1).jdField_a_of_type_JavaLangString = String.valueOf(paramayva.e);
    a(paramMessageHandler, paramList, paramMsg, true, paramayva.jdField_b_of_type_Boolean, (bbku)localObject1, paramaywa, paramayva);
  }
  
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg, boolean paramBoolean1, boolean paramBoolean2, bbku parambbku)
  {
    a(paramMessageHandler, paramList, paramMsg, paramBoolean1, paramBoolean2, parambbku, null, null);
  }
  
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg, boolean paramBoolean1, boolean paramBoolean2, bbku parambbku, aywa paramaywa, ayva paramayva)
  {
    ...
    for (;;)
    {
      if (paramList.isEmpty()) {
        localayvr.g(localList, paramList, (StringBuilder)localObject1, paramMsg, parambbku);
      }
      if (paramList.isEmpty()) {
        localayvr.i(localList, paramList, (StringBuilder)localObject1, paramMsg, parambbku);
      }
      localayvr.a(localList, paramList);
      if (ayvq.a((ArrayList)localObject2)) {
        localayvr.a((ArrayList)localObject2, localList, paramList, (StringBuilder)localObject1, paramMsg, parambbku, paramaywa, paramayva);
      }
      if (!QLog.isColorLevel()) {
        break;
      }
      ...
      return;
      localayvr.a(localList, paramList, (StringBuilder)localObject1, paramBoolean2);
      continue;
      localayvr.a(localList, paramList, (StringBuilder)localObject1, paramMsg);
      continue;
      localayvr.b(localList, paramList, (StringBuilder)localObject1, paramBoolean1);
      continue;
      localayvr.a(localList, paramList, (StringBuilder)localObject1, paramMsg);
      continue;
      localayvr.d(localList, paramList, (StringBuilder)localObject1, paramMsg, parambbku);
      continue;
      localayvr.b(localList, paramList, (StringBuilder)localObject1, paramMsg, parambbku);
      continue;
      localayvr.c(localList, paramList, (StringBuilder)localObject1, paramMsg, parambbku);
      continue;
      localayvr.e(localList, paramList, (StringBuilder)localObject1, paramMsg, parambbku);
      continue;
      localayvr.c(localList, paramList, (StringBuilder)localObject1);
      continue;
      localayvr.a(localList, paramList, (StringBuilder)localObject1);
      continue;
      localayvr.d(localList, paramList, (StringBuilder)localObject1);
      continue;
      localayvr.h(localList, paramList, (StringBuilder)localObject1, paramMsg, parambbku);
      continue;
      localayvr.b(localList, paramList, (StringBuilder)localObject1, paramMsg);
      continue;
      localayvr.f(localList, paramList, (StringBuilder)localObject1, paramMsg, parambbku);
      continue;
      localayvr.h(localList, paramList, (StringBuilder)localObject1);
      continue;
      localayvr.i(localList, paramList, (StringBuilder)localObject1);
      continue;
      localayvr.g(localList, paramList, (StringBuilder)localObject1, paramMsg, parambbku);
      continue;
      localayvr.a(localList, paramList, (StringBuilder)localObject1, paramMsg, parambbku, paramBoolean1);
      continue;
      localayvr.a(paramMessageHandler, localList, paramList, (StringBuilder)localObject1, paramMsg, parambbku, paramBoolean1);
      continue;
      localayvr.a(paramMessageHandler, localList, paramList, (StringBuilder)localObject1, paramMsg, parambbku);
      continue;
      localayvr.i(localList, paramList, (StringBuilder)localObject1, paramMsg, parambbku);
      continue;
      localayvr.a(localList, paramList, (StringBuilder)localObject1, paramMsg, paramBoolean1);
      continue;
      localayvr.b(localList, paramList, (StringBuilder)localObject1, paramMsg, paramBoolean1);
      continue;
      localayvr.e(localList, paramList, (StringBuilder)localObject1);
      continue;
      localayvr.f(localList, paramList, (StringBuilder)localObject1);
      continue;
      if (paramBoolean1)
      {
        ...
        {
          localayvr.a(localList, paramList, (StringBuilder)localObject1, paramMsg, paramMessageHandler);
          break;
        }
      }
      if (parambbku != null) {}
      for (paramMessageHandler = parambbku.jdField_a_of_type_JavaLangString;; paramMessageHandler = paramMsg.msg_head.to_uin.get() + "") {
        break;
      }
      localayvr.g(localList, paramList, (StringBuilder)localObject1);
      continue;
      localayvr.c(localList, paramList, (StringBuilder)localObject1, paramMsg);
      continue;
      aofk.a(localList, paramList, (StringBuilder)localObject1, paramMsg);
      continue;
      localayvr.j(localList, paramList, (StringBuilder)localObject1);
      continue;
      localayvr.b(localList, paramList, (StringBuilder)localObject1);
      continue;
      atpu.a(paramMessageHandler.app, localList, paramList, (StringBuilder)localObject1, paramMsg, paramBoolean1, parambbku);
    }
  }
  
  public static void a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, ayva paramayva)
  {
    if ((!paramMsg.msg_body.has()) || (!((im_msg_body.MsgBody)paramMsg.msg_body.get()).msg_content.has())) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      do
      {
        ...
        if (((paramayva.jdField_a_of_type_Boolean) || (paramayva.f)) && ((paramayva.jdField_a_of_type_Long == paramayva.jdField_b_of_type_Long) && ((paramayva.jdField_a_of_type_Long != paramayva.jdField_b_of_type_Long) || (bool)))) {
          break;
        }
      } while (!QLog.isColorLevel());
      QLog.e("Q.msg.MessageHandler", 2, "<---decodeC2CMsgPkg_SharpVideo return null:,isReaded:" + paramayva.jdField_a_of_type_Boolean + "syncOther:" + paramayva.f + ",isSharpRequest" + bool);
      return;
      if (bool)
      {
    ...
    if (l5 >= 60L)
    {
      ...
      for (;;)
      {
        ...
        VideoMsgTools.a(paramMessageHandler.app, 0, 6, true, paramayva, String.valueOf(l4), false, null, false, new Object[] { paramMsg });
        a(l4, l2, 208);
        if (!QLog.isColorLevel()) {
          break;
        }
      ...
      {
        VideoMsgTools.a(paramMessageHandler.app, i, 6, bool, paramayva, String.valueOf(l2), false, null, false, new Object[] { paramMsg });
        break;
      }
    }
    if (bool) {
  ...
  public static void a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, List<MessageRecord> paramList)
  {
    ...
    for (Object localObject5 = ((ByteStringMicro)localObject5).toStringUtf8();; localObject5 = "")
    {
      ...
      localObject2 = bdcv.a((byte[])localObject2);
      Object localObject6 = bdcv.a((byte[])localObject1);
      ...
      for (localObject1 = localPtt.bytes_group_file_key.get().toByteArray();; localMessageRecord = null) {
        try
        {
          ...
          if (localObject6 == null)
          {
            ...
            if (localPtt.bytes_pb_reserve.has())
            {
              ...
              ((RichMsg.PttRec)localObject7).voiceLength.set(bdal.a(l1));
              ...
              new ayvr().a((List)localObject3, paramList);
              ajat.b((String)localObject2, (MessageRecord)localObject1);
              if (localObject1 == null)
              {
                return;
                m = 0;
        ...
        catch (UnsupportedEncodingException localUnsupportedEncodingException)
        {
          for (;;)
          {
              ...
              for (;;)
              {
                ...
                try
                {
                  ...
                  if (paramList.uint32_holiday_flag.has())
                  {
                    ...
                    if (j == 1) {
                      localMessageRecord.saveExtInfoToExtStr(ayvj.jdField_c_of_type_JavaLangString, String.valueOf(j));
                    }
                    if (QLog.isColorLevel()) {
                ...
                try
                {
                  ...
                  ((MessageForPtt)localMessageRecord).waveformArray = bdew.a((ptt_waveform.PttWaveform)localObject2);
                  if (QLog.isColorLevel())
                  {
                    ...
                    for (;;)
                    {
                      if (j < k)
                      {
                        ...
                        new ayvr().a((List)localObject5, paramMsg, (StringBuilder)localObject4);
                        break;
                      }
                    }
            ...
            bool = ((bckx)paramMessageHandler.app.getManager(203)).a(((msg_comm.MsgHead)paramMsg.msg_head.get()).from_uin.get());
            ...
            aoep.a(paramMsg, localMessageRecord, paramMessageHandler.app);
            if (QLog.isColorLevel())
            {
              QLog.d("Q.msg.MessageHandler", 2, ((StringBuilder)localObject4).toString());
              return;
  ...
  public static void a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, boolean paramBoolean)
  {
    ...
    ((allz)paramMessageHandler.app.a(8)).a(paramMsg);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Submsgtype0x8a.ReqBody paramReqBody, long paramLong, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (!((ArrayList)localObject2).isEmpty())
      {
        ...
        azyu localazyu = (azyu)paramQQAppInterface.getManager(61);
        if (localazyu != null)
        {
          List localList = localazyu.a(str1);
          paramReqBody = null;
          localObject1 = null;
          ...
          for (;;)
          {
            ...
            localObject2 = alpo.a(2131707037);
            localObject3 = (SubAccountMessage)((SubAccountMessage)localObject1).deepCopyByReflect();
            ((SubAccountMessage)localObject3).msg = ((String)localObject2).concat(BaseApplicationImpl.getApplication().getString(2131694586));
            ...
            ((SubAccountMessage)localObject3).mTimeString = bdjj.a(((SubAccountMessage)localObject3).time * 1000L, true, azyl.jdField_a_of_type_JavaLangString);
            ((SubAccountMessage)localObject3).mEmoRecentMsg = new baig(((SubAccountMessage)localObject3).msg, 0);
            if (localazyu != null) {
              localazyu.b((SubAccountMessage)localObject3);
            }
            azyl.a(paramQQAppInterface, str1, 6);
  ...
  public static void a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      if ((TroopNotificationCache)paramArrayOfByte.a(TroopNotificationCache.class, "troopUin=? and feedsId=?", new String[] { String.valueOf(l2), str }) != null)
      {
        ...
        bckr.a(paramQQAppInterface, i, l1, l2, l3, str, j, "OidbSvc.0x852_35", (short)23, false, false);
      }
    }
    paramArrayOfByte.a();
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, msg_svc.RoutingHead paramRoutingHead)
  {
    ...
    case 5: 
      ...
      return true;
    case 6: 
      paramQQAppInterface = ((ayvc)localObject1).b(paramMessageRecord.frienduin);
      ...
      if (paramQQAppInterface != null)
      {
        ...
        bdlr.a(paramMessageRecord, 0, paramQQAppInterface, 2, paramQQAppInterface.length - 2);
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "wpa------>" + bdcv.a(paramMessageRecord) + ",length:" + paramMessageRecord.length);
        }
      ...
      return true;
    case 18: 
      paramQQAppInterface = ((ayvc)localObject1).c(paramMessageRecord.frienduin);
      ...
      return true;
    case 15: 
      localObject2 = ((ayvc)localObject1).d(paramMessageRecord.frienduin);
      paramQQAppInterface = new msg_svc.BusinessWPATmp();
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      if (localObject2 != null)
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "conversation------>sig:" + bdcv.a((byte[])localObject2) + ",length:" + localObject2.length);
        }
      ...
      for (;;)
      {
        ...
        return true;
        paramMessageRecord = ((ayvc)localObject1).e(paramMessageRecord.frienduin);
        if (paramMessageRecord != null)
        {
          if (QLog.isColorLevel()) {
            QLog.d("Q.msg.MessageHandler", 2, "conversation------>sigt:" + bdcv.a(paramMessageRecord) + ",length:" + paramMessageRecord.length);
          }
    ...
    case 10: 
      ...
      paramMessageRecord = ((ayvc)localObject1).f(paramMessageRecord.frienduin);
      if (paramMessageRecord != null)
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "sameState------>" + bdcv.a(paramMessageRecord) + ",length:" + paramMessageRecord.length);
        }
      ...
      return true;
    case 8: 
      paramQQAppInterface = ((ayvc)localObject1).a(paramMessageRecord.frienduin);
    ...
    case 11: 
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((ayvc)localObject1).j(paramMessageRecord.frienduin);
      if (paramMessageRecord != null)
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "sameState------>" + bdcv.a(paramMessageRecord) + ",length:" + paramMessageRecord.length);
    ...
    case 12: 
      ...
      paramQQAppInterface = ((ayvc)localObject1).m(paramMessageRecord.frienduin);
      if (paramQQAppInterface != null)
      {
        if (QLog.isDevelopLevel()) {
          QLog.d("fight_accost", 4, "发送附近人临时会消息 有keyLBSFriend------>" + bdcv.a(paramQQAppInterface) + ",length:" + paramQQAppInterface.length);
        }
    ...
    case 23: 
      ...
      paramQQAppInterface = ((ayvc)localObject1).k(paramMessageRecord.frienduin);
      if (paramQQAppInterface != null)
      {
        if (QLog.isDevelopLevel()) {
          QLog.d("fight_accost", 4, "发送兴趣部落临时会消息 有key------>" + bdcv.a(paramQQAppInterface) + ",length:" + paramQQAppInterface.length);
        }
    ...
    case 24: 
      ...
      paramMessageRecord = ((ayvc)localObject1).l(paramMessageRecord.frienduin);
      if (paramMessageRecord != null)
      {
        if (QLog.isDevelopLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "movieTicket------>" + bdcv.a(paramMessageRecord) + ",length:" + paramMessageRecord.length);
        }
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
      paramRoutingHead.comm_tmp.set(paramQQAppInterface);
    ...
    case 16: 
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((ayvc)localObject1).g(paramMessageRecord.frienduin);
      if (paramMessageRecord != null)
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "circleGroup------>" + bdcv.a(paramMessageRecord) + ",length:" + paramMessageRecord.length);
        }
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
    ...
    case 17: 
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((ayvc)localObject1).i(paramMessageRecord.frienduin);
      if (paramMessageRecord != null)
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "friendValidation------>" + bdcv.a(paramMessageRecord) + ",length:" + paramMessageRecord.length);
        }
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
    ...
    case 19: 
      ...
      paramQQAppInterface = ((ayvc)localObject1).p(paramMessageRecord.frienduin);
      if (paramQQAppInterface != null)
      {
        if (QLog.isDevelopLevel()) {
          QLog.d("nearby_dating", 4, "发送附近人约会临时会话消息 有keyNearbyDating------>" + bdcv.a(paramQQAppInterface) + ",length:" + paramQQAppInterface.length);
        }
    ...
    case 20: 
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((ayvc)localObject1).o(paramMessageRecord.frienduin);
      if (paramMessageRecord != null)
      {
        if (QLog.isDevelopLevel()) {
          QLog.d("nearby_assistant", 4, "发送附近人助手临时会话消息 有NearbyAssistantKey------>" + bdcv.a(paramMessageRecord) + ",length:" + paramMessageRecord.length);
        }
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
    ...
    case 22: 
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((ayvc)localObject1).n(paramMessageRecord.frienduin);
      if (paramMessageRecord != null) {
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
      paramRoutingHead.comm_tmp.set(paramQQAppInterface);
    ...
    case 26: 
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((ayvc)localObject1).a(paramMessageRecord.frienduin, paramMessageRecord.selfuin);
      if (paramMessageRecord != null) {
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
      paramRoutingHead.comm_tmp.set(paramQQAppInterface);
    ...
    case 28: 
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((ayvc)localObject1).b(paramMessageRecord.frienduin, paramMessageRecord.selfuin);
      if (paramMessageRecord != null) {
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
      paramRoutingHead.comm_tmp.set(paramQQAppInterface);
    ...
    case 29: 
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((ayvc)localObject1).c(paramMessageRecord.frienduin, paramMessageRecord.selfuin);
      if (paramMessageRecord != null) {
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
      paramRoutingHead.comm_tmp.set(paramQQAppInterface);
    ...
    case 30: 
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((ayvc)localObject1).a(paramMessageRecord.frienduin, paramMessageRecord.selfuin, false);
      if (paramMessageRecord != null) {
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
      paramRoutingHead.comm_tmp.set(paramQQAppInterface);
    ...
    case 31: 
      ...
      localObject1 = ((ayvc)localObject1).d(paramMessageRecord.frienduin, paramMessageRecord.selfuin);
      if (localObject1 != null) {
    ...
    localObject1 = ((ayvc)localObject1).e(paramMessageRecord.frienduin, paramMessageRecord.selfuin);
    if (localObject1 != null) {
  ...
  {
    Object localObject2 = paramQQAppInterface.a().b(aljq.ad, 0);
        ...
        for (;;)
        {
          ...
          if (paramArrayOfByte.hasNext())
          {
            ...
            if ((localObject2 instanceof MessageForActivateFriends))
            {
              ...
              paramQQAppInterface.a().b(aljq.ad, 0, ((MessageForActivateFriends)localObject2).uniseq);
              continue;
              return false;
            }
          }
    ...
    do
    {
      ...
      break label113;
      paramArrayOfByte = ayvw.a(-5003);
      paramArrayOfByte.selfuin = paramQQAppInterface.getCurrentAccountUin();
      paramArrayOfByte.frienduin = aljq.ad;
      paramArrayOfByte.istroop = 9002;
      paramArrayOfByte.senderuin = "";
      localObject2 = (aloz)paramQQAppInterface.getManager(51);
      localambl = (ambl)paramQQAppInterface.getManager(85);
      if (j != 1) {
        break label584;
      }
      ...
      ((MessageForActivateFriends)localObject2).msg = ambl.a(paramQQAppInterface.getApp(), (SubMsgType0x76.MsgBody)localObject1);
      ...
      break label883;
      azmj.b(paramQQAppInterface, "CliOper", "", "", (String)localObject1, (String)localObject2, localambl.jdField_a_of_type_Int, 0, "", "", "", "");
    ...
    if (QLog.isColorLevel())
    {
      ...
      if (j == 2)
      {
        ...
        if (((List)localObject2).size() > 0)
        {
          ...
          localMessageForActivateFriends.msg = ambl.a(paramQQAppInterface.getApp(), (SubMsgType0x76.MsgBody)localObject1);
      ...
      else
      {
        ...
        if (((List)localObject2).size() > 0)
        {
          ...
          localMessageForActivateFriends.msgData = ((SubMsgType0x76.MsgBody)localObject1).toByteArray();
          localMessageForActivateFriends.msg = ambl.a(paramQQAppInterface.getApp(), (SubMsgType0x76.MsgBody)localObject1);
          azmj.b(paramQQAppInterface, "dc00898", "", "", "0X8007AD4", "0X8007AD4", (int)((SubMsgType0x76.OneMemorialDayInfo)localObject2).uint32_type.get(), 0, "", "", "", "");
        }
        else
        {
          if (!QLog.isColorLevel()) {
  ...
  public static im_msg_body.RichText b(ChatMessage paramChatMessage)
  {
    if ((paramChatMessage != null) && ((paramChatMessage instanceof MessageForLimitChatConfirm)))
    {
      ...
      for (int i = 1;; i = 2)
      {
        ...
        ((im_msg_body.Text)localObject2).str.set(ByteStringMicro.copyFromUtf8(alpo.a(2131707034)));
  ...
  public static im_msg_body.RichText b(ChatMessage paramChatMessage, boolean paramBoolean)
  {
    ...
    localObject2 = azsd.b((byte[])localObject2);
    if ((localObject2 == null) || (localObject2.length == 0)) {
      return null;
    }
    ...
    if (((MessageForArkApp)localObject1).ark_app_message.containStructMsg != null)
    {
      ...
      if (!"1".equals(paramChatMessage.getExtInfoFromExtStr(ayvj.e))) {
        break label469;
      }
    }
    label469:
    for (int i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        ...
        if ((localObject1 == null) || (((String)localObject1).length() == 0)) {
          ...
          localObject1 = String.format(BaseApplication.getContext().getString(2131693911), new Object[] { localObject1 });
        }
      }
    }
  }
  ...
  public static im_msg_body.RichText b(MessageForApollo paramMessageForApollo)
  {
    ...
    localApolloActMsg.uint32_peer_uin.set(bdal.a(localApolloMessage.peer_uin));
    localApolloActMsg.uint32_sender_ts.set(bdal.a(localApolloMessage.sender_ts));
    localApolloActMsg.uint32_peer_ts.set(bdal.a(localApolloMessage.peer_ts));
    ...
    localObject1 = alpo.a(2131707035);
  ...
  public static void b(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, ayva paramayva)
  {
    if ((!paramMsg.msg_body.has()) || (!((im_msg_body.MsgBody)paramMsg.msg_body.get()).msg_content.has())) {
      if (QLog.isColorLevel()) {
        ...
        else
        {
          ...
          else
          {
            ...
            catch (Exception localException)
            {
              ...
              {
                if (QLog.isColorLevel()) {
                  QLog.e("decodeC2CMsgPkg_QCall", 2, "<---decodeC2CMsgPkg_QCall return null:,isReaded:" + paramayva.jdField_a_of_type_Boolean + "syncOther:" + paramayva.f + ",isSharpRequest" + bool);
                }
              }
              else
              {
                ...
                try
                {
                  new maf(BaseApplicationImpl.getContext()).a(new ayvv(paramMsg, l3 - l1, paramMessageHandler, l4, l2, l1, bool));
                  return;
                }
                catch (Exception paramMessageHandler) {}
              }
  ...
  public static im_msg_body.RichText c(ChatMessage paramChatMessage)
  {
    ...
    do
    {
      ...
      localObject2 = azsd.b((byte[])localObject1);
    ...
    try
    {
      ...
      paramChatMessage = a(ayvy.a(paramChatMessage.getSummery(), true, null), null);
      paramChatMessage.elems.add((MessageMicro)localObject2);
      return paramChatMessage;
    }
    catch (Exception paramChatMessage) {}
  ...
  public static im_msg_body.RichText c(ChatMessage paramChatMessage, boolean paramBoolean)
  {
    ...
    paramChatMessage = azsd.b(paramChatMessage);
    if ((paramChatMessage == null) || (paramChatMessage.length == 0)) {
      return null;
    }
  ...
  public static void c(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, ayva paramayva)
  {
    if ((!paramMsg.msg_body.has()) || (!((im_msg_body.MsgBody)paramMsg.msg_body.get()).msg_content.has()) || (paramayva.jdField_a_of_type_Boolean) || (paramayva.f)) {
      if (QLog.isColorLevel()) {
        QLog.e("Q.msg.MessageHandler", 2, "<---decodeC2CMsgPkg_Video return null:hasBody:" + paramMsg.msg_body.has() + ",hasMsgContent" + ((im_msg_body.MsgBody)paramMsg.msg_body.get()).msg_content.has() + ",isReaded:" + paramayva.jdField_a_of_type_Boolean + "syncOther:" + paramayva.f);
      }
    }
    long l1;
    long l2;
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          return;
          localHashMap = (HashMap)paramayva.a(1000);
          paramayva = (HashSet)paramayva.a(1001);
          if (i != 1) {
            break label511;
          }
          if (lnz.c()) {
  ...
  public static im_msg_body.RichText e(ChatMessage paramChatMessage)
  {
    ...
    paramChatMessage = new im_msg_body.Elem();
    paramChatMessage.common_elem.set((MessageMicro)localObject1);
    Object localObject2 = alpo.a(2131707033);
    localObject1 = new im_msg_body.Text();
    ((im_msg_body.Text)localObject1).str.set(ByteStringMicro.copyFromUtf8((String)localObject2));
    localObject2 = new im_msg_body.Elem();
    ((im_msg_body.Elem)localObject2).text.set((MessageMicro)localObject1);
  ...
  public static im_msg_body.RichText f(ChatMessage paramChatMessage)
  {
    ...
    Object localObject2 = alpo.a(2131707038);
    Object localObject1 = "";
  ...
  public static im_msg_body.RichText g(ChatMessage paramChatMessage)
  {
    if ((paramChatMessage != null) && ((paramChatMessage instanceof MessageForScribble)))
    {
      ...
      localObject1 = new im_msg_body.Elem();
      localObject2 = new im_msg_body.Text();
      ((im_msg_body.Text)localObject2).str.set(ByteStringMicro.copyFromUtf8(alpo.a(2131707030)));
      ((im_msg_body.Elem)localObject1).text.set((MessageMicro)localObject2);
      ((im_msg_body.Elem)localObject1).text.setHasFlag(true);
      localObject2 = new im_msg_body.RichText();
      ((im_msg_body.RichText)localObject2).elems.add((MessageMicro)localObject1);
