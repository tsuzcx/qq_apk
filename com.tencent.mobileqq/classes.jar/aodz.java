...
public class aodz
  extends aods
{
  public aodz(QQAppInterface paramQQAppInterface, FriendListHandler paramFriendListHandler)
  {
  ...
  private void a(FromServiceMsg paramFromServiceMsg, GetLastLoginInfoResp paramGetLastLoginInfoResp)
  {
    if ((paramFromServiceMsg.isSuccess()) && (paramGetLastLoginInfoResp != null) && (paramGetLastLoginInfoResp.errorCode == 0))
    {
      ...
      {
        bgle.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), paramGetLastLoginInfoResp.iRefreshIntervalMin);
  ...
  private void a(FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (int i = paramFromServiceMsg.intervalTimeMin * 60 * 1000;; i = 180000)
    {
      ...
      ((anmw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).a(paramFromServiceMsg.vecFriendInfo);
      a(13, true, null);
      return;
      i = 30000;
      break;
  ...
  private void a(List<LastLoginInfo> paramList)
  {
    ...
    else
    {
      ...
      localObject2 = ((anmw)localObject1).d();
    ...
    for (int i = 1;; i = 0)
    {
      ...
      while (paramList.hasNext())
      {
        ...
        localFriends = ((anmw)localObject1).e(String.valueOf(((LastLoginInfo)localObject2).dwFriendUin));
      ...
      for (i = 1;; i = 0)
      {
        ...
        break;
        ((anmw)localObject1).a((Friends[])localArrayList.toArray(new Friends[localArrayList.size()]), localArrayList.size());
        if (QLog.isColorLevel()) {
