...
public class anxc
{
  ...
  private int a(int paramInt, String paramString)
  {
    ...
    if (paramString[0] == 0)
    {
      Log.e(GPUVideoFrameRender.a(), "Could not compile shader " + paramInt + ":");
      Log.e(GPUVideoFrameRender.a(), " " + GLES20.glGetShaderInfoLog(i));
  ...
  private int a(String paramString1, String paramString2)
  {
    ...
    if (k == 0) {
      Log.e(GPUVideoFrameRender.a(), "Could not create program");
    }
    ...
    if (paramString1[0] != 1)
    {
      Log.e(GPUVideoFrameRender.a(), "Could not link program: ");
      Log.e(GPUVideoFrameRender.a(), GLES20.glGetProgramInfoLog(k));
  ...
  public void a(String paramString)
  {
    ...
    if (i != 0)
    {
      Log.e(GPUVideoFrameRender.a(), paramString + ": glError " + i);
