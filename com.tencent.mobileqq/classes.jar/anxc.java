  ...
  extends ajuc
{
  ...
  public anxc(FMActivity paramFMActivity) {}
  ...
  protected void a(boolean paramBoolean, long paramLong1, int paramInt1, List<oidb_0x899.memberlist> paramList, long paramLong2, int paramInt2, String paramString)
  {
    ...
    do
    {
      ...
      } while ((paramString == null) || (baip.a(paramString.troopowneruin)));
    ...
    {
      awqx.b(paramString, "P_CliOper", "Grp_files", "", "power", "nopower_upload", 0, 0, (String)localObject1, paramList, "", "");
