...
public class albu
{
  ...
  public static int a(int paramInt, String paramString)
  {
    ...
    paramString = new File(alef.g, paramInt + "/" + paramString + "/");
    ...
    for (;;)
    {
      ...
      int i = attl.a(localObject.length);
      ...
      try
      {
        ...
        if (paramInt >= alef.jdField_a_of_type_Int) {
          if (!ApolloUtil.c(paramString.getAbsolutePath() + "/" + (String)localObject + "/action/" + alef.R)) {
            continue;
          }
        }
        for (;;)
        {
          return j;
          if ((!ApolloUtil.c(paramString.getAbsolutePath() + "/" + (String)localObject + "/" + alef.x)) || (!ApolloUtil.c(paramString.getAbsolutePath() + "/" + (String)localObject + "/" + alef.w)) || (!ApolloUtil.c(paramString.getAbsolutePath() + "/" + (String)localObject + "/" + alef.y))) {
            break;
          }
          if (QLog.isColorLevel()) {
  ...
  public static int a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    paramString = ((akji)paramQQAppInterface.getManager(153)).a(paramString);
    if (paramString == null)
    {
      if (QLog.isColorLevel()) {
  ...
  public static String a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      localStringBuilder.append(alef.F);
      localStringBuilder.append("/");
      localStringBuilder.append(paramInt2);
      localStringBuilder.append("/dress");
      return localStringBuilder.toString();
  ...
  public static String a(String paramString)
  {
    ...
    int i = attl.a(paramString.countTokens());
  ...
  public static String a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    if (akji.a(paramQQAppInterface, paramString) == 2) {
      return "3D";
    }
    return "2D";
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, SpriteTaskParam paramSpriteTaskParam, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    do
    {
      ...
      localObject = ((aleh)paramQQAppInterface.getManager(155)).a(paramSpriteTaskParam.f);
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    while (i < j)
    {
      ...
      localObject = new File(alef.c + (String)localObject);
      if (!((File)localObject).exists())
      {
        QLog.d("ApolloActionHelper", 1, new Object[] { "[checkBasicActionExit] rsc file not exist:", ((File)localObject).toString() });
        akzg.a(paramQQAppInterface, paramQQAppInterface.c(), null, 0, null, -1, -1, true);
        return false;
      }
      i += 1;
    }
  ...
  public static boolean a(String paramString, int paramInt, int[] paramArrayOfInt, QQAppInterface paramQQAppInterface, akzo paramakzo)
  {
    if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        ...
        if (!bool)
        {
          ...
          if (paramQQAppInterface != null)
          {
            ...
            paramakzo = ((akji)paramQQAppInterface.getManager(153)).a();
          }
        }
        for (;;)
        {
          akzg.a(paramQQAppInterface, paramString, paramakzo, paramInt, paramArrayOfInt, -1, -1, false);
          if (QLog.isColorLevel()) {
  ...
  public static boolean a(String paramString, QQAppInterface paramQQAppInterface, JSONObject paramJSONObject)
  {
    ...
    ApolloBaseInfo localApolloBaseInfo = ((akji)paramQQAppInterface.getManager(153)).b(paramString);
  ...
  public static Object[] a(String paramString, int paramInt, QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    Object localObject = ((akji)paramQQAppInterface.getManager(153)).b(paramString);
    if (localObject != null)
    {
      localObject = ((ApolloBaseInfo)localObject).getApolloDress3D();
      if (localObject != null)
      {
        paramInt = ((aknx)localObject).jdField_a_of_type_Int;
        localObject = ((aknx)localObject).a();
        if ((paramInt > alef.jdField_a_of_type_Int) && (localObject != null) && (localObject.length > 0) && ((!paramBoolean) || (a(paramString, paramInt, (int[])localObject, paramQQAppInterface))))
        {
          if (QLog.isColorLevel()) {
  ...
  public static Object[] a(String paramString, QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    Object localObject2 = ((akji)paramQQAppInterface.getManager(153)).b(paramString);
    aknx[] arrayOfaknx;
    if (localObject2 != null)
    {
      ...
      if (!akji.a((ApolloBaseInfo)localObject2)) {
      ...
      if ((paramBoolean) && (((ApolloBaseInfo)localObject2).apolloLocalTS != ((ApolloBaseInfo)localObject2).apolloServerTS))
      {
        ...
        akji.a(paramQQAppInterface, paramString, "getRoleDressIdByUin");
      }
      arrayOfaknx = ((ApolloBaseInfo)localObject2).getApolloDress(false);
      if ((arrayOfaknx != null) && (arrayOfaknx.length > 0))
      {
        j = arrayOfaknx.length;
        i = 0;
        label439:
        if (i >= j) {
          break label749;
        }
        aknx localaknx = arrayOfaknx[i];
        localObject2 = localaknx.a();
        if (a(paramString, localaknx.jdField_a_of_type_Int, (int[])localObject2, paramQQAppInterface))
        {
          if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      if (j == 0)
      {
        localObject2 = akzg.a(arrayOfaknx[0].jdField_a_of_type_Int);
        if (a(paramString, arrayOfaknx[0].jdField_a_of_type_Int, (int[])localObject2, paramQQAppInterface))
        {
          if (QLog.isColorLevel()) {
            QLog.d("ApolloActionHelper", 2, "valid basic dress.");
          }
          j = arrayOfaknx[0].jdField_a_of_type_Int;
          paramString = (String)localObject2;
          i = j;
          if (QLog.isColorLevel())
          {
      ...
      for (paramString = (String)localObject2;; paramString = (String)localObject1)
      {
        ...
        i += 1;
        break label439;
        akwt.a(110, new Object[] { "basicDresses is not vaild" });
      }
      if (QLog.isColorLevel()) {
  ...
  public static String[] a(int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean, int paramInt4)
  {
    ...
    if (paramInt4 == 2)
    {
      ...
      default: 
        ...
        if ((paramBoolean) || (paramInt2 < 21)) {
          if (localStringBuilder.indexOf(alef.u) > -1) {
            localStringBuilder.append("/action");
          }
        }
        break;
    ...
    for (;;)
    {
      ...
      if (paramInt4 != 0)
      {
        localStringBuilder.append(alef.u);
        paramInt3 = 1;
        paramInt4 = paramInt2;
        break label177;
      }
      ...
      break label177;
      if (paramInt4 != 0) {
        localStringBuilder.append(alef.u).append(alef.G);
      }
      for (;;)
      {
        paramInt3 = 1;
        paramInt4 = 1;
        break;
        localStringBuilder.append("def/basic/").append(alef.G);
      }
      localStringBuilder.append(alef.u).append(alef.G);
      paramInt3 = 1;
      paramInt4 = 1;
      break label177;
      int i = a(paramInt3, alef.G);
      if (-1 != i)
      {
        localStringBuilder.append("role/");
        localStringBuilder.append(paramInt3).append("/").append(alef.G);
        paramInt4 = i;
        paramInt3 = 1;
        break label177;
      }
      ...
      if (paramInt4 != 0)
      {
        localStringBuilder.append(alef.u).append(alef.I);
        paramInt3 = 1;
        paramInt4 = paramInt2;
        break label177;
      }
      localStringBuilder.append("def/role/").append(0).append("/").append(alef.I);
      paramInt3 = 1;
      paramInt4 = paramInt2;
      break label177;
      if (paramInt4 != 0)
      {
        localStringBuilder.append(alef.u).append(alef.K);
        paramInt3 = 1;
        paramInt4 = paramInt2;
        break label177;
      }
      localStringBuilder.append("def/role/").append(0).append("/").append(alef.K);
      paramInt3 = 1;
      paramInt4 = paramInt2;
      break label177;
      i = a(paramInt3, alef.H);
      if (-1 != i)
      {
        localStringBuilder.append("role/");
        localStringBuilder.append(paramInt3).append("/").append(alef.H);
        paramInt4 = i;
        paramInt3 = 1;
        break label177;
      }
  ...
  public static String b(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    paramString = ((akji)paramQQAppInterface.getManager(153)).b(paramString);
    if (paramString != null)
    {
