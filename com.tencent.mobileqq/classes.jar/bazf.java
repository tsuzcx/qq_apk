  ...
  implements Manager
{
  ...
  private void a(ArrayList<Long> paramArrayList, int paramInt)
  {
    ...
    NewIntent localNewIntent = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), bazh.class);
    paramArrayList = new ArrayList(paramArrayList.subList(paramInt, i));
    bazi.a(localNewIntent, bazi.a(1, Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).longValue(), paramArrayList, 0L, null));
  ...
  public void a(long paramLong, String paramString)
  {
    ...
    NewIntent localNewIntent = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), bazh.class);
    bazi.a(localNewIntent, bazi.a(2, Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).longValue(), null, paramLong, paramString));
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.startServlet(localNewIntent);
  }
  ...
  public void b()
  {
    ...
    this.e = 1;
    this.f = 0;
    this.jdField_a_of_type_JavaUtilArrayList = bazi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    if (QLog.isColorLevel())
    {
      ...
      QLog.d("QzoneContactsFeedManager", 2, new Object[] { "allFriends.size:", Integer.valueOf(i), ",getAllFreindsCount:", Integer.valueOf(localanvk.a()) });
    }
    a(this.jdField_a_of_type_JavaUtilArrayList, this.f);
  }
