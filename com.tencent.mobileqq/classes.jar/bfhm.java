  ...
  implements View.OnClickListener
{
  ...
  public bfhm()
  {
    ...
    this.jdField_a_of_type_Anvi = new bfhp(this, null);
  }
  ...
  public void a(long paramLong, int paramInt)
  {
    ...
    ntb.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new bfhn(this, paramLong), localReqBody.toByteArray(), "OidbSvc.0x487_0", 1159, paramInt);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, Observer paramObserver, SessionInfo paramSessionInfo, RelativeLayout paramRelativeLayout, afqz paramafqz, ChatXListView paramChatXListView)
  {
    ...
    this.d = paramContext.getResources().getColor(2131166258);
    this.e = paramContext.getResources().getColor(2131166259);
  ...
  public void b()
  {
    ...
    if (this.jdField_c_of_type_AndroidViewView == null) {
      this.jdField_c_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560628, null);
    }
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout.indexOfChild(this.jdField_c_of_type_AndroidViewView) == -1)
    {
      ...
      ((RelativeLayout.LayoutParams)localObject).addRule(3, 2131374261);
    ...
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131379394));
    ...
    for (;;)
    {
      this.jdField_c_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843743);
  ...
  public void c()
  {
    ...
    ImageView localImageView = (ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131379393);
    ...
    Drawable localDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843744);
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(2131697422);
  }
  ...
  public void e()
  {
    ...
    {
      bdla.b(localQQAppInterface, "P_CliOper", "Grp_public", "", "oper", str1, 0, 0, "", "", "", str2);
      return;
