...
public final class bkpj
{
  ...
  public static ContentValues a(AppInterface paramAppInterface, FileManagerEntity paramFileManagerEntity, String paramString, boolean paramBoolean)
  {
    ...
    for (paramString = new File(str1);; paramString = null)
    {
      ...
      for (;;)
      {
        ...
        {
          new ContentValues().put("errorMsg", BaseApplicationImpl.getContext().getResources().getString(2131692054));
          return null;
          i = aszt.a(paramFileManagerEntity);
          break;
          if (paramString == null) {
            break label633;
          }
        ...
        {
        default: 
          new ContentValues().put("errorMsg", BaseApplicationImpl.getContext().getResources().getString(2131692056));
          return null;
        case 1: 
          if ((paramFileManagerEntity.lastTime > 0L) && (paramFileManagerEntity.lastTime <= System.currentTimeMillis() / 1000L))
          {
            new ContentValues().put("errorMsg", BaseApplicationImpl.getContext().getResources().getString(2131692053));
            return null;
          }
          break;
        case 4: 
  ...
  public static bcjc a(StructMsgForImageShare paramStructMsgForImageShare)
  {
    if (paramStructMsgForImageShare.getItemCount() > 0)
    {
      paramStructMsgForImageShare = paramStructMsgForImageShare.getItemByIndex(0);
      if ((paramStructMsgForImageShare instanceof bcla))
      {
        paramStructMsgForImageShare = (bcla)paramStructMsgForImageShare;
        if ((paramStructMsgForImageShare.a.size() > 0) && ((paramStructMsgForImageShare.a.get(0) instanceof bcjc))) {
          return (bcjc)paramStructMsgForImageShare.a.get(0);
        }
      }
    }
    return null;
  ...
  public static bkpe a(byte[] paramArrayOfByte)
  {
    if ((paramArrayOfByte == null) || (paramArrayOfByte.length <= 16)) {
      return null;
    }
    ...
    if ((localObject2 instanceof ChatMessage))
    {
      if ((localObject2 instanceof MessageForStructing))
      {
        ...
        {
          localObject1 = bchh.a((byte[])localObject1);
          ((MessageForStructing)localObject2).structingMsg = ((AbsStructMsg)localObject1);
        }
        return new bkpe((ChatMessage)localObject2, paramArrayOfByte);
      }
      return new bkpe((ChatMessage)localObject2, paramArrayOfByte);
    }
    return null;
  ...
  public static List<bkpd> a(List<byte[]> paramList)
  {
    if ((paramList == null) || (paramList.size() == 0)) {
      return null;
    }
    ...
    while (paramList.hasNext())
    {
      ...
      if (l1 != 2L)
      {
        ...
        if (l1 == 1L)
        {
          ...
          if (localObject != null) {
            localArrayList.add(new bkpd(l2, l1, ((bkpe)localObject).jdField_a_of_type_ComTencentMobileqqDataChatMessage, ((bkpe)localObject).jdField_a_of_type_JavaLangString));
        ...
        else if (l1 == 3L)
        {
          ...
          localObject = a((byte[])localObject);
          if (localObject != null) {
            localArrayList.add(new bkpd(l2, l1, (ContentValues)localObject));
          }
        }
      }
    }
  ...
  public static void a(long paramLong, List<bkpd> paramList1, List<bkpd> paramList2)
  {
    ...
    for (;;)
    {
      ...
      {
        bkpd localbkpd = (bkpd)paramList1.next();
        if (localbkpd.b == paramLong) {
          paramList2.add(localbkpd);
        }
      }
    }
  }
  ...
  public static void a(Context paramContext, int paramInt1, int paramInt2)
  {
    ...
    paramInt1 = paramContext.getResources().getDimensionPixelSize(2131299076) - (int)bfvh.a(paramContext, 5.0F);
  ...
  public static void a(Context paramContext, String paramString, int paramInt)
  {
    ...
    paramInt = paramContext.getResources().getDimensionPixelSize(2131299076) - (int)bfvh.a(paramContext, 5.0F);
    paramContext = Looper.getMainLooper();
    if (Thread.currentThread() != paramContext.getThread())
    {
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageForStructing paramMessageForStructing, List<ChatMessage> paramList, Map<String, String> paramMap, ArrayList<byte[]> paramArrayList)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramList = (String)paramMap.get(abwz.c(localChatMessage));
        ...
        continue;
        paramList = awcm.a().a(paramQQAppInterface, paramMessageForStructing.uniseq);
      }
  ...
  public static boolean a(Activity paramActivity)
  {
    ...
    {
      a(paramActivity, 2131693478, 1);
      return false;
    }
    if (SystemUtil.getSDCardAvailableSize() < 500L)
    {
      a(paramActivity, 2131693477, 1);
      return false;
    }
    return true;
  }
  ...
  public static byte[] a(QQAppInterface paramQQAppInterface, long paramLong, ChatMessage paramChatMessage, String paramString)
  {
    ...
    if (TextUtils.isEmpty(paramString)) {
      str = afri.a(paramQQAppInterface, paramChatMessage);
    }
  ...
  public static String[] a(byte[] paramArrayOfByte)
  {
    ...
    //   0: aconst_null
    //   1: astore 4
    //   3: invokestatic 944	javax/xml/parsers/DocumentBuilderFactory:newInstance	()Ljavax/xml/parsers/DocumentBuilderFactory;
    //   6: astore 5
    //   8: aload 5
    //   10: invokevirtual 948	javax/xml/parsers/DocumentBuilderFactory:newDocumentBuilder	()Ljavax/xml/parsers/DocumentBuilder;
    //   13: new 950	java/io/ByteArrayInputStream
    //   16: dup
    //   17: aload_0
    //   18: invokespecial 953	java/io/ByteArrayInputStream:<init>	([B)V
    //   21: invokevirtual 959	javax/xml/parsers/DocumentBuilder:parse	(Ljava/io/InputStream;)Lorg/w3c/dom/Document;
    //   24: invokeinterface 965 1 0
    //   29: astore 5
    //   31: aload 4
    //   33: astore_0
    //   34: aconst_null
    //   35: invokestatic 60	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   38: ifeq +14 -> 52
    //   41: aload 5
    //   43: ldc_w 967
    //   46: invokeinterface 972 2 0
    //   51: astore_0
    //   52: aload 5
    //   54: invokeinterface 973 1 0
    //   59: astore 26
    //   61: aload 26
    //   63: invokeinterface 562 1 0
    //   68: istore_3
    //   69: iconst_0
    //   70: istore_1
    //   71: aconst_null
    ...
    //   254: aload 28
    //   256: ldc_w 977
    //   259: invokevirtual 980	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   262: ifeq +1246 -> 1508
    //   265: aload 4
    //   267: astore 16
    //   269: aload 5
    ...
    //   507: astore 21
    //   509: aload 9
    //   511: invokeinterface 976 1 0
    //   516: ldc_w 982
    //   519: invokevirtual 980	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   522: ifeq +160 -> 682
    //   525: aload 4
    //   527: astore 16
    //   529: aload 5
    ...
    //   587: astore 25
    //   589: aload 5
    //   591: invokestatic 60	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   594: ifeq +1463 -> 2057
    //   597: aload 4
    //   599: astore 16
    //   601: aload 5
    ...
    //   643: astore 21
    //   645: aload 9
    //   647: invokeinterface 986 1 0
    //   652: ldc_w 988
    //   655: invokeinterface 994 2 0
    //   660: invokeinterface 553 1 0
    //   665: astore 22
    //   667: aload 4
    //   669: astore 23
    //   671: aload 6
    ...
    //   728: astore 21
    //   730: aload 9
    //   732: invokeinterface 976 1 0
    //   737: ldc_w 996
    //   740: invokevirtual 980	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   743: ifeq +145 -> 888
    //   746: aload 4
    //   748: astore 16
    //   750: aload 5
    ...
    //   808: astore 25
    //   810: aload 7
    //   812: invokestatic 60	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   815: ifeq +1242 -> 2057
    //   818: aload 4
    //   820: astore 16
    //   822: aload 5
    ...
    //   864: astore 21
    //   866: aload 9
    //   868: invokestatic 998	bkpj:a	(Lorg/w3c/dom/Node;)Ljava/lang/String;
    //   871: astore 25
    //   873: aload 4
    //   875: astore 23
    //   877: aload 5
    ...
    //   934: astore 21
    //   936: aload 9
    //   938: invokeinterface 976 1 0
    //   943: ldc_w 1000
    //   946: invokevirtual 980	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   949: ifeq +145 -> 1094
    //   952: aload 4
    //   954: astore 16
    //   956: aload 5
    ...
    //   1014: astore 25
    //   1016: aload 6
    //   1018: invokestatic 60	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   1021: ifeq +1036 -> 2057
    //   1024: aload 4
    //   1026: astore 16
    //   1028: aload 5
    ...
    //   1070: astore 21
    //   1072: aload 9
    //   1074: invokestatic 998	bkpj:a	(Lorg/w3c/dom/Node;)Ljava/lang/String;
    //   1077: astore 24
    //   1079: aload 4
    //   1081: astore 23
    //   1083: aload 5
    ...
    //   1156: astore 25
    //   1158: aload 9
    //   1160: invokeinterface 976 1 0
    //   1165: ldc_w 1002
    //   1168: invokevirtual 980	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   1171: ifeq +886 -> 2057
    //   1174: aload 4
    //   1176: astore 16
    //   1178: aload 5
    ...
    //   1281: astore 21
    //   1283: aload 5
    //   1285: invokestatic 60	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   1288: ifeq +68 -> 1356
    //   1291: aload 4
    //   1293: astore 16
    //   1295: aload 5
    ...
    //   1339: aload 28
    //   1341: ldc_w 988
    //   1344: invokeinterface 994 2 0
    //   1349: invokeinterface 553 1 0
    //   1354: astore 9
    //   1356: aload 4
    //   1358: astore 16
    //   1360: aload 9
    ...
    //   1418: astore 25
    //   1420: aload 4
    //   1422: invokestatic 60	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   1425: ifeq +632 -> 2057
    //   1428: aload 4
    //   1430: astore 16
    //   1432: aload 9
    ...
    //   1476: aload 28
    //   1478: ldc_w 1004
    //   1481: invokeinterface 994 2 0
    //   1486: invokeinterface 553 1 0
    //   1491: astore 23
    //   1493: aload 9
    //   1495: astore 22
    //   1497: aload 6
    ...
    //   1576: aload 28
    //   1578: ldc_w 1006
    //   1581: invokevirtual 980	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   1584: ifeq +165 -> 1749
    //   1587: aload 4
    //   1589: astore 22
    //   1591: aload 5
    ...
    //   1653: astore 21
    //   1655: aload 8
    //   1657: invokestatic 60	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   1660: ifeq +89 -> 1749
    //   1663: aload 4
    //   1665: astore 16
    //   1667: aload 5
    ...
    //   1709: astore 21
    //   1711: aload 27
    //   1713: invokeinterface 986 1 0
    //   1718: ldc_w 1008
    //   1721: invokeinterface 994 2 0
    //   1726: invokeinterface 553 1 0
    //   1731: astore 25
    //   1733: aload 7
    //   1735: astore 9
    //   1737: aload 6
    ...
    //   1781: astore_0
    //   1782: bipush 6
    //   1784: anewarray 84	java/lang/String
    //   1787: dup
    //   1788: iconst_0
    //   1789: aload 7
    //   1791: aastore
    ...
    //   1834: astore 7
    //   1836: aload 9
    //   1838: invokevirtual 1009	javax/xml/parsers/ParserConfigurationException:printStackTrace	()V
    //   1841: aload 6
    //   1843: astore 9
    //   1845: goto -63 -> 1782
    //   1848: astore 9
    ...
    //   1865: astore 7
    //   1867: aload 9
    //   1869: invokevirtual 1010	org/xml/sax/SAXException:printStackTrace	()V
    //   1872: aload 6
    //   1874: astore 9
    //   1876: goto -94 -> 1782
    //   1879: astore 9
    ...
    //   1896: astore 7
    //   1898: aload 9
    //   1900: invokevirtual 1011	java/io/IOException:printStackTrace	()V
    //   1903: aload 6
    //   1905: astore 9
    //   1907: goto -125 -> 1782
    //   1910: astore 9
  ...
  public static byte[] b(QQAppInterface paramQQAppInterface, long paramLong, ChatMessage paramChatMessage, String paramString)
  {
    ...
    if (((paramChatMessage instanceof MessageForTroopFile)) || ((paramChatMessage instanceof MessageForFile)))
    {
      ...
      localObject = afri.a(paramQQAppInterface, paramChatMessage);
      a((FileManagerEntity)localObject);
      if (localObject == null) {
        break label221;
      }
      localbkov.a(paramQQAppInterface, null, (FileManagerEntity)localObject, paramChatMessage, true);
    }
    for (;;)
    {
      paramQQAppInterface = new ContentValues();
      localObject = (ContentValues)localbkov.a().getExtras().getParcelable("fileContents");
      if (localObject != null) {
        paramQQAppInterface.put("fileContents", a((ContentValues)localObject));
      }
      localObject = abwz.c(paramChatMessage);
      ...
      localObject = aszt.a(paramQQAppInterface, (MessageForFile)paramChatMessage);
      break;
      label221:
      label490:
      if (QLog.isColorLevel())
      {
        ...
        if ((paramChatMessage instanceof MessageForTroopFile))
        {
          ...
          {
            a((FileManagerEntity)localObject);
            afri.a((FileManagerEntity)localObject, localMessageForTroopFile);
            if (localObject == null) {
              break label490;
            }
            localbkov.a(paramQQAppInterface, null, (FileManagerEntity)localObject, localMessageForTroopFile, true);
            break;
            if (QLog.isColorLevel()) {
              QLog.d("qqfav", 2, "parcelFileMsg, isMultiMsg T, find in db");
            }
            localObject = bfby.a(paramQQAppInterface, localMessageForTroopFile);
            if (localObject != null)
            {
              FileManagerEntity localFileManagerEntity = afri.a((becp)localObject);
              localObject = bfbb.a(paramQQAppInterface, ((becp)localObject).b);
              if ((localObject != null) && (localFileManagerEntity != null) && (!TextUtils.isEmpty(localFileManagerEntity.strTroopFilePath)))
              {
                bebc localbebc = ((bfbb)localObject).a(localFileManagerEntity.strTroopFilePath);
                localObject = localFileManagerEntity;
                if (localbebc != null)
                {
                  localFileManagerEntity.lastTime = localbebc.c;
                  localFileManagerEntity.selfUin = String.valueOf(localbebc.b);
                  localObject = localFileManagerEntity;
                }
              }
              else
