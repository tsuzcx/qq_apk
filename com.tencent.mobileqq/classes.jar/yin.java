...
class yin
  implements Runnable
{
  yin(yim paramyim, QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, Bundle paramBundle, Handler paramHandler) {}
  ...
  public void run()
  {
    ...
    catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
    {
      ...
      {
        TroopListAdapter.a((QQAppInterface)TroopListAdapter.a(this.jdField_a_of_type_Yim.a).b.get(), TroopListAdapter.a(this.jdField_a_of_type_Yim.a), localArrayList);
        return;
      }
      this.jdField_a_of_type_AndroidOsHandler.post(new yio(this));
    }
  }
}
