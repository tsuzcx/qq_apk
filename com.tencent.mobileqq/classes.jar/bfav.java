...
public class bfav
{
  private static bfav jdField_a_of_type_Bfav;
  private String jdField_a_of_type_JavaLangString;
  private ConcurrentLinkedQueue<bfaw> jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue = new ConcurrentLinkedQueue();
  ...
  public static bfav a()
  {
    try
    {
      if (jdField_a_of_type_Bfav == null) {
        jdField_a_of_type_Bfav = new bfav();
      }
      bfav localbfav = jdField_a_of_type_Bfav;
      return localbfav;
    }
    finally {}
  }
  ...
  private String a(String paramString)
  {
    try
    {
      ...
      if (localFile.exists())
      {
        ...
        paramString = bhrw.a(paramString);
        return paramString;
      }
    }
  ...
  private String b(PackageInfo paramPackageInfo)
  {
    ...
    return bhpp.a(paramPackageInfo);
  }
  ...
  private void c()
  {
    ...
    try
    {
      ...
      localSharedInfoPacket.qq_version.set(a("8.3.5"));
      if (QLog.isColorLevel()) {
        QLog.d("SecShare.AV", 2, String.format("Version = %s intVersion= 0x%x", new Object[] { "8.3.5", Integer.valueOf(a("8.3.5")) }));
      }
      if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.isEmpty()) {
        break label561;
      }
      localSendInfo = new SecSharedInfo.SendInfo();
      localObject1 = (bfaw)this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.poll();
      i = ((bfaw)localObject1).a();
      localObject3 = ((bfaw)localObject1).a();
      str3 = ((bfaw)localObject1).b();
      j = ((bfaw)localObject1).b();
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        {
          localObject2 = bhqh.a((String)localObject3);
  ...
  {
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.offer(new bfaw(paramInt1, paramString1, paramInt2, paramString2));
  }
