...
public class asqm
{
  ...
  private List<asqs> jdField_a_of_type_JavaUtilList;
  private int b = 0;
  
  public asqm(QQAppInterface paramQQAppInterface)
  {
  ...
  private boolean a()
  {
    Object localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerProxy().b();
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      if ((this.jdField_a_of_type_JavaLangString == null) || (this.jdField_a_of_type_JavaLangString.trim().length() == 0) || (this.jdField_a_of_type_JavaLangString.equals(localFileManagerEntity.peerUin)))
      {
        ...
        {
          i += 1;
          this.jdField_a_of_type_JavaUtilList.add(asql.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localFileManagerEntity));
          break;
        }
      }
    }
  ...
  private boolean a(ForwardFileInfo paramForwardFileInfo)
  {
    ...
    while (paramForwardFileInfo.hasNext())
    {
      ...
      localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerDataCenter().b(((Long)localObject).longValue());
      if (localObject != null)
      {
        if (FileUtil.fileExistsAndNotEmpty(((FileManagerEntity)localObject).getFilePath())) {
        ...
        {
          this.jdField_a_of_type_JavaUtilList.add(asql.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (FileManagerEntity)localObject));
          i += 1;
          break;
        }
      }
  ...
  private boolean b()
  {
    ...
    if ((localObject2 != null) && (((Set)localObject2).size() > 0))
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        if (((FileInfo)localObject3).a() == 0) {
          this.jdField_a_of_type_JavaUtilList.add(asql.a((FileInfo)localObject3));
        }
      }
    }
    if ((localObject1 != null) && (((ArrayList)localObject1).size() > 0))
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if (aszt.a(((WeiYunFileInfo)localObject2).c) == 0) {
          this.jdField_a_of_type_JavaUtilList.add(asql.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (WeiYunFileInfo)localObject2));
        }
      }
    }
  ...
  private boolean b(Intent paramIntent)
  {
    ...
    if (paramIntent.hasNext())
    {
      ...
      if ((i == 0) && (((FileInfo)localObject).hashCode() == k))
      {
        ...
        this.jdField_a_of_type_JavaUtilList.add(asql.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity));
        i = 1;
      }
      for (;;)
      {
        j += 1;
        break;
        this.jdField_a_of_type_JavaUtilList.add(asql.a((FileInfo)localObject));
      }
    }
    aslg.a();
    return true;
  ...
  private boolean c(Intent paramIntent)
  {
    ...
    while (paramIntent.hasNext())
    {
      ...
      do
      {
        ...
        {
          i += 1;
          this.jdField_a_of_type_JavaUtilList.add(asql.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localWeiYunFileInfo));
          break;
        } while (aszt.a(localWeiYunFileInfo.c) == 0);
  ...
  private boolean d(Intent paramIntent)
  {
    ...
    while (paramIntent.hasNext())
    {
      ...
      FileManagerEntity localFileManagerEntity = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerDataCenter().a(l, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerUin, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerType, -1L);
  ...
  private boolean e(Intent paramIntent)
  {
    ...
    {
      long l = Long.parseLong((String)paramIntent.next());
      FileManagerEntity localFileManagerEntity = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerDataCenter().a(0L, "", 0, l);
      if (localFileManagerEntity != null)
      {
        if (localFileManagerEntity.nSessionId == this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId) {
          this.jdField_a_of_type_Int = i;
  ...
  {
    return new asqn(this, paramBaseActivity);
  }
  ...
  public boolean a(Intent paramIntent)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerDataCenter().a(l);
    if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity == null)
    {
      if (localForwardFileInfo.d() != 9) {
        break label104;
      }
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity = bcug.a(localForwardFileInfo);
    }
    ...
    if (5 != this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.cloudType) {
      aszt.b(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity);
    }
    boolean bool;
    ...
    {
      this.jdField_a_of_type_Asqs = asql.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity);
      this.b = 3;
      return true;
    }
    return bool;
