...
public class adcp
  extends bcfx
{
  adcp(ConfessHalfScreenActivity.ConfessBrowserFragment paramConfessBrowserFragment) {}
  ...
  public void a()
  {
    ...
    {
      localWebView = this.jdField_a_of_type_Bceh.a();
    ...
    for (;;)
    {
      this.c.setOnClickListener(new adcq(this));
      return;
      label171:
