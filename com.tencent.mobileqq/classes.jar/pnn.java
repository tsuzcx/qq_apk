  ...
  implements bkhe
{
  ...
  private HashMap<Long, pmz> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  private pni jdField_b_of_type_Pni;
  private int jdField_c_of_type_Int;
  public long c;
  private ArrayList<pnm> jdField_c_of_type_JavaUtilArrayList = new ArrayList();
  private int d;
  public long d;
  private int e;
  public long e;
  ...
  private pni a(AbsListView paramAbsListView)
  {
    ...
    paramAbsListView = new pni(this.jdField_a_of_type_Pmy, null);
    ...
    for (long l = System.currentTimeMillis() - this.jdField_d_of_type_Long;; l = System.currentTimeMillis() - this.jdField_a_of_type_Pni.jdField_a_of_type_Long)
    {
      paramAbsListView.jdField_b_of_type_Long = l;
      this.jdField_a_of_type_Pni = paramAbsListView;
      QLog.d("ReadinjoySPEventReport", 2, new Object[] { paramAbsListView });
      return paramAbsListView;
    }
  }
  
  private pnm a(AbsListView paramAbsListView)
  {
    pnm localpnm = new pnm();
    localpnm.jdField_e_of_type_Int = this.jdField_b_of_type_Int;
    localpnm.f = this.jdField_c_of_type_Int;
    if (this.jdField_d_of_type_Int - this.f > 0) {}
    for (int i = this.jdField_d_of_type_Int - this.f;; i = 0)
    {
      localpnm.g = i;
      localpnm.jdField_a_of_type_Int = this.jdField_e_of_type_Int;
      localpnm.jdField_a_of_type_Long = (this.jdField_c_of_type_Long - this.jdField_b_of_type_Long);
      localpnm.h = this.f;
      localpnm.i = paramAbsListView.getWidth();
      localpnm.jdField_a_of_type_ArrayOfFloat = ((float[])((ReadInJoyXListView)paramAbsListView).jdField_a_of_type_ArrayOfFloat.clone());
      localpnm.b = ((float[])((ReadInJoyXListView)paramAbsListView).b.clone());
      return localpnm;
    }
  }
  ...
  public String a()
  {
    ...
    while (((Iterator)localObject).hasNext()) {
      localStringBuilder.append((pmz)((Iterator)localObject).next()).append("|");
    }
  ...
  public void a(int paramInt, AbsListView paramAbsListView)
  {
    ...
    //   44: ifle +14 -> 58
    //   47: aload_0
    //   48: getfield 138	pnn:jdField_d_of_type_Long	J
    //   51: lstore_3
    //   52: lload_3
    //   53: lconst_0
    //   54: lcmp
    ...
    //   60: return
    //   61: aload_0
    //   62: getfield 46	pnn:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   65: invokevirtual 265	java/util/ArrayList:size	()I
    //   68: ifle +12 -> 80
    //   71: aload_0
    //   72: getfield 266	pnn:jdField_a_of_type_Int	I
    //   75: iload_1
    //   76: iand
    //   77: ifne -19 -> 58
    //   80: iload_1
    ...
    //   83: ifeq +15 -> 98
    //   86: aload_0
    //   87: getfield 268	pnn:jdField_a_of_type_Boolean	Z
    //   90: ifeq -32 -> 58
    //   93: aload_0
    //   94: iconst_0
    //   95: putfield 268	pnn:jdField_a_of_type_Boolean	Z
    //   98: aload_0
    //   99: aload_0
    //   100: getfield 266	pnn:jdField_a_of_type_Int	I
    //   103: iload_1
    //   104: ior
    //   105: putfield 266	pnn:jdField_a_of_type_Int	I
    //   108: aload_0
    //   109: aload_2
    //   110: invokespecial 270	pnn:a	(Lcom/tencent/widget/AbsListView;)Lpni;
    //   113: astore_2
    //   114: aload_2
    //   115: ifnull -57 -> 58
    //   118: aload_0
    //   119: aload_2
    //   120: invokevirtual 273	pnn:a	(Lpni;)V
    //   123: aload_0
    //   124: aload_2
    //   125: invokevirtual 276	pni:a	()Ljava/util/ArrayList;
    //   128: putfield 46	pnn:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   131: ldc 142
    //   133: iconst_2
    //   134: iconst_1
  ...
  public void a(pni parampni)
  {
    if ((parampni == null) || (this.jdField_d_of_type_Long == 0L)) {
      return;
    }
    Iterator localIterator = parampni.jdField_a_of_type_JavaUtilArrayList.iterator();
    label23:
    Object localObject;
    long l1;
    float f1;
    ...
    if (localIterator.hasNext())
    {
      ...
      l1 = parampni.jdField_b_of_type_Long;
      f1 = ((Float)((Pair)localObject).second).floatValue();
      pmz localpmz = (pmz)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(localBaseArticleInfo.mArticleID));
      localObject = localpmz;
      if (localpmz == null)
      {
        localObject = new pmz(this.jdField_a_of_type_Pmy, null);
        ((pmz)localObject).jdField_a_of_type_Long = localBaseArticleInfo.mRecommendSeq;
        ((pmz)localObject).jdField_b_of_type_Long = localBaseArticleInfo.mArticleID;
        ((pmz)localObject).jdField_a_of_type_JavaLangString = localBaseArticleInfo.mTitle;
        this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(localBaseArticleInfo.mArticleID), localObject);
      }
      l2 = ((pmz)localObject).jdField_c_of_type_Long;
      if (f1 <= 0.8F) {
        break label204;
      }
    }
    for (;;)
    {
      ((pmz)localObject).jdField_c_of_type_Long = (l1 + l2);
      ((pmz)localObject).jdField_a_of_type_Float = Math.max(((pmz)localObject).jdField_a_of_type_Float, f1);
      break label23;
      break;
      label204:
      l1 = 0L;
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Pni != null)
    {
      localArrayList1 = this.jdField_a_of_type_Pni.a();
      if (this.jdField_b_of_type_Pni == null) {
        break label267;
      }
      localArrayList2 = this.jdField_b_of_type_Pni.a();
      ...
      do
      {
        ...
        localpmz = (pmz)this.jdField_a_of_type_JavaUtilHashMap.get(localLong);
      } while (localpmz == null);
      localpmz.jdField_a_of_type_Int = 1;
      if (!this.jdField_a_of_type_JavaUtilArrayList.contains(localLong)) {
        break label273;
      }
    }
    for (localpmz.jdField_a_of_type_Int = 0;; localpmz.jdField_a_of_type_Int = 2) {
      label267:
      label273:
      do
      {
        if (this.jdField_b_of_type_JavaUtilArrayList.contains(localLong)) {
          localpmz.jdField_a_of_type_Boolean = true;
        }
        if ((localArrayList2 != null) && (localArrayList2.contains(localLong))) {
          localpmz.jdField_b_of_type_Boolean = true;
        }
        if (this.jdField_b_of_type_JavaUtilHashMap.containsKey(localLong)) {
          localpmz.jdField_b_of_type_JavaLangString = String.format("%.2f", new Object[] { this.jdField_b_of_type_JavaUtilHashMap.get(localLong) });
        }
        localStringBuilder.append(localpmz.toString()).append("\n");
        break label96;
    ...
    this.jdField_a_of_type_Pmy.b = this;
    this.jdField_a_of_type_Pmy.a = new pnn(this.jdField_a_of_type_Pmy);
  }
  ...
  public String b()
  {
    ...
    {
      localStringBuilder.append(((pnm)this.jdField_c_of_type_JavaUtilArrayList.get(i)).a()).append("|");
      i += 1;
    }
    if (localStringBuilder.length() == 0) {
      return "nil";
  ...
  public void onScrollStateChanged(AbsListView paramAbsListView, int paramInt)
  {
    ...
    case 0: 
      ...
      localpnm = a(paramAbsListView);
      this.jdField_c_of_type_JavaUtilArrayList.add(localpnm);
      this.jdField_a_of_type_Pni = a(paramAbsListView);
    ...
    case 1: 
      while ((paramInt <= i) && (paramInt < paramAbsListView.getCount()))
      {
        ...
        this.jdField_a_of_type_Pni = a(paramAbsListView);
        this.jdField_b_of_type_Pni = this.jdField_a_of_type_Pni;
        a(this.jdField_a_of_type_Pni);
        return;
      }
      QLog.d("ReadinjoySPEventReport", 2, "one scroll " + localpnm.a());
      return;
    }
    this.jdField_a_of_type_Pni = a(paramAbsListView);
    a(this.jdField_a_of_type_Pni);
