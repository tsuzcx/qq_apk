...
{
  pnn(pnh parampnh, ViewBase paramViewBase, pgd parampgd) {}
  
  public void onClick(ViewBase paramViewBase)
  {
    boolean bool = true;
    paramViewBase = (psd)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreViewBase.getParent().findViewBaseByName("id_pgc_short_content_video_view");
