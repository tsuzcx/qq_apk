...
public class awwg
  ...
  implements Manager
{
  private almw jdField_a_of_type_Almw = new awwi(this);
  private alox jdField_a_of_type_Alox = new awwh(this);
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  
  public awwg(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Alox);
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Almw);
  }
  ...
  public static awwj a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2, QQMessageFacade.Message paramMessage)
  {
    return new awwj(paramQQAppInterface, paramString, paramInt1, paramInt2, paramMessage, null);
  }
  ...
  private QCallRecent a(MessageForVideo paramMessageForVideo)
  {
    ...
    localQCallRecent.lastCallMsg = bdec.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), paramMessageForVideo.text);
    ...
    catch (Exception paramMessageForVideo)
    {
      for (;;)
      {
        ...
        else
        {
          ...
          if (QLog.isColorLevel())
          {
            QLog.d("QCallFacade", 2, "getMessageToCallRecord java.lang.NumberFormatException: Invalid int: " + arrayOfString[1] + " msg byte " + bdal.a(str));
            paramMessageForVideo = (MessageForVideo)localObject;
          }
        }
      }
  ...
  private void a(QCallRecent paramQCallRecent, String paramString)
  {
    ...
    if ((abot.d(paramQCallRecent.type)) && (paramQCallRecent.state == 5))
    {
      a(1);
      return;
    }
  ...
  public int a()
  {
    ...
    do
    {
      ...
      localObject = ((amjk)localObject).a(false);
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      {
        DiscussionMemberInfo localDiscussionMemberInfo = ((almv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).a(localRecentUser.uin, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      ...
      if ((localRecentUser.getType() != 0) || ((!FriendsStatusUtil.a(localRecentUser.uin, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) && (!afai.a(localRecentUser.uin, localRecentUser.getType(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)))) {
  ...
  public int a(MessageRecord paramMessageRecord, int paramInt)
  {
    ...
    while ((paramMessageRecord.msgtype != -2026) && (!abot.d(paramInt))) {
      return i;
    }
    return 1;
  }
  ...
  public String a(String paramString, boolean paramBoolean)
  {
    ...
    for (j = k;; j = k)
    {
      ...
      if ((j == 1) || (i == 1)) {
        if (paramBoolean) {
          if (paramString != null) {
            ((StringBuilder)localObject1).append(paramString).append(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131696051));
          }
        }
      }
      for (;;)
      {
        ...
        {
          ((StringBuilder)localObject1).append(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131696414));
        }
        else
        {
          ((StringBuilder)localObject1).append(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131695843));
          continue;
          ((StringBuilder)localObject1).append(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131696008, new Object[] { "" + i, "" + j }));
        }
      }
      break label238;
      break label192;
    ...
    if (localIterator.hasNext())
    {
      ...
      for (;;)
      {
        ...
        if (localQCallRecord.time > l1)
        {
          ...
          localObject = ayvw.a(-2016);
          ((MessageRecord)localObject).msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131696100);
      ...
      for (((MessageRecord)localObject).msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131696101);; ((MessageRecord)localObject).msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131696099))
      {
  ...
  public void a(int paramInt, long paramLong, String paramString)
  {
    ...
    ((QCallRecord)localObject).time = ayvc.a();
    ...
    if (paramInt == 1)
    {
      ...
      ((QCallRecent)localObject).lastCallTime = ayvc.a();
  ...
  public void a(int paramInt, long paramLong, String paramString1, String paramString2)
  {
    ...
    localQCallRecent.lastCallTime = ayvc.a();
  ...
  public void a(long paramLong1, long paramLong2, boolean paramBoolean1, long paramLong3, boolean paramBoolean2)
  {
    ...
    while ((((almv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).a(String.valueOf(paramLong1)) == null) || (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin().equals(String.valueOf(paramLong2)))) {
      return;
    }
  ...
  public void a(MessageForVideo paramMessageForVideo)
  {
    ...
    {
      azmj.b(localQQAppInterface, "CliOper", "", "", "0X8004067", "0X8004067", 0, 0, paramMessageForVideo, "", "", "");
    ...
    for (paramMessageForVideo = "1";; paramMessageForVideo = "0")
    {
      azmj.b(localQQAppInterface, "CliOper", "", "", "Msg_tab", "Call_history_count", 0, 0, paramMessageForVideo, "", "", "");
      break;
    }
  }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    localQCallRecent.readTime = ayvc.a();
    if (QLog.isDevelopLevel()) {
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, int paramInt3, String paramString2, int paramInt4)
  {
    ...
    do
    {
      ...
      } while ((localaloz != null) && (!localaloz.b(paramString1)));
    } while ((paramString1 == null) || ((paramInt1 == 3000) && (((almv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).a(paramString1) == null)));
    paramString1 = a().a(paramString1, paramInt1);
    if ((paramInt4 == 6) || (paramInt4 == 5) || (paramString1.isMissedCall())) {
      paramString1.lastCallTime = ayvc.a();
    }
    if (QLog.isColorLevel()) {
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, long paramLong, String paramString2)
  {
    ...
    localawwk.a((QCallRecord)localObject);
    localObject = localawwk.a(paramString1, paramInt1);
    ...
    localawwk.d((QCallRecent)localObject);
  ...
  public void a(String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    paramString2.lastCallTime = ayvc.a();
  ...
  {
    int k = 0;
    Object localObject2 = (aubm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(11);
    ...
    for (;;)
    {
      ...
      return;
      localObject2 = ((aubm)localObject2).c(paramString);
      break;
      label152:
      i = 0;
      break label57;
      ...
      break label77;
      label162:
      localObject1 = ((aloz)localObject1).e(((PhoneContact)localObject2).uin);
      break label89;
      label177:
      j = 0;
      break label104;
