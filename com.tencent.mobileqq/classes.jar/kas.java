...
{
  public kas(PSTNC2CActivity paramPSTNC2CActivity) {}
    ...
    for (;;)
    {
      if (paramBoolean.booleanValue())
      {
        if (localObject != null)
        {
          ...
          this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().jdField_b_of_type_Int = 1;
          this.a.jdField_a_of_type_MqqOsMqqHandler.postDelayed(new kat(this), 500L);
        }
        return;
      }
      this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().jdField_b_of_type_Int = -1;
      ...
      for (;;)
      {
        if (i == 2)
        {
          ...
          DialogUtil.a(this.a, 230, paramBoolean, paramObject, this.a.getString(2131428675), (String)localObject, new kau(this), new kav(this)).show();
          return;
        ...
        {
          DialogUtil.b(this.a, 230, "", paramBoolean, 2131428674, 2131428674, null, new kaw(this)).show();
          return;
          i = 1;
        }
      }
