  ...
  implements bket
{
  ...
  public bkem()
  {
    bfnq.c("WadlProxyServiceWrap", "##@WadlProxyServiceWrap()");
    this.a = new bkee();
    bkeu.a().a(this);
  }
  ...
  public void a()
  {
    bfnq.c("WadlProxyServiceWrap", "##@launchService");
    this.a.a();
  }
  
  public void a(int paramInt, String paramString)
  {
    bfnq.c("WadlProxyServiceWrap", "doPauseAction from=" + paramInt + ",appId=" + paramString);
  ...
  {
    bfnq.c("WadlProxyServiceWrap", "doDownloadAction wadlParams=" + paramWadlParams);
    Bundle localBundle = new Bundle();
    ...
    bkeu.a().a(paramWadlParams, localBundle);
  }
  
  public void a(String paramString)
  {
    bfnq.c("WadlProxyServiceWrap", "doQueryActionByVia via=" + paramString);
    Bundle localBundle = new Bundle();
  ...
  {
    bfnq.c("WadlProxyServiceWrap", "receive system receiver cmd=" + paramString1 + ",packageName=" + paramString2);
    Bundle localBundle = new Bundle();
  ...
  {
    bfnq.c("WadlProxyServiceWrap", "doQueryAction:" + paramArrayList.toString());
    Bundle localBundle = new Bundle();
  ...
  public void b()
  {
    bfnq.c("WadlProxyServiceWrap", "doQueryAllTask");
    Bundle localBundle = new Bundle();
  ...
  {
    bfnq.c("WadlProxyServiceWrap", "doResumeAction from=" + paramInt + ",appId=" + paramString);
    Bundle localBundle = new Bundle();
  ...
  {
    bfnq.c("WadlProxyServiceWrap", "doInstallAction：" + paramWadlParams);
    Bundle localBundle = new Bundle();
    ...
    try
    {
      bfob.a(paramWadlParams.j, paramWadlParams.a);
      return;
    }
    catch (Exception paramWadlParams)
    {
      bfnq.a("WadlProxyServiceWrap", "savePackageInfo", paramWadlParams);
    }
  }
  
  public void c()
  {
    bfnq.c("WadlProxyServiceWrap", "initWadlTaskManager:");
    Bundle localBundle = new Bundle();
  ...
  {
    bfnq.c("WadlProxyServiceWrap", "##@deleteDownload from=" + paramInt + ",appID=" + paramString);
    Bundle localBundle = new Bundle();
  ...
  public void onCmdRsp(android.content.Intent paramIntent, String paramString, long paramLong, org.json.JSONObject paramJSONObject)
  {
    ...
    //   30: invokestatic 22	bfnq:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   33: ldc 196
    //   35: aload_2
    ...
    //   335: aload_0
    //   336: getfield 27	bkem:a	Lbkee;
    //   339: aload 13
    //   341: invokevirtual 93	bkee:a	(Landroid/os/Bundle;)V
    //   344: aload 14
    ...
    //   354: invokestatic 170	bfob:a	(Ljava/lang/String;Ljava/lang/String;)Z
    //   357: pop
    //   358: return
    //   359: astore_1
    //   360: ldc 14
    //   362: ldc 172
    //   364: aload_1
    //   365: invokestatic 175	bfnq:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   368: return
    //   369: aload 14
    ...
    //   417: ldc_w 289
    //   420: aload_1
    //   421: invokestatic 175	bfnq:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   424: iload 7
    //   426: istore 6
    //   428: goto -137 -> 291
    //   431: aload 14
