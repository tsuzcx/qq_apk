...
public class bkzb
{
  private static bkzb jdField_a_of_type_Bkzb;
  ...
  static
  {
    jdField_a_of_type_JavaIoFile = a(new File(ahwa.d), "qqstroy_follow_capture");
    d();
  }
  
  public static bkzb a()
  {
    if (jdField_a_of_type_Bkzb == null) {}
    try
    {
      if (jdField_a_of_type_Bkzb == null) {
        jdField_a_of_type_Bkzb = new bkzb();
      }
      return jdField_a_of_type_Bkzb;
    }
    finally {}
  }
  ...
  public static void a(String paramString, bkzd parambkzd)
  {
    ...
    for (;;)
    {
      ...
      if (!b(str2, str1))
      {
        ...
        localayrv.jdField_a_of_type_Aysa = new bkzc(str2, str1, parambkzd);
        localayrv.jdField_a_of_type_JavaLangString = paramString;
        localayrv.jdField_a_of_type_Int = 0;
        localayrv.jdField_c_of_type_JavaLangString = str2;
        localayrv.jdField_c_of_type_Int = bbev.a(aysy.a().a());
        try
        {
          parambkzd = BaseApplicationImpl.getApplication().getRuntime();
          if (QQAppInterface.class.isInstance(parambkzd))
          {
            ((QQAppInterface)parambkzd).getNetEngine(0).a(localayrv);
  ...
  private static boolean b(File paramFile, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        paramFile = bbdj.c(paramFile.getPath());
  ...
  public boolean a()
  {
    return !TextUtils.isEmpty(tcv.d());
  }
