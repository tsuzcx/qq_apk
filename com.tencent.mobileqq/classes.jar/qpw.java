...
public class qpw
  extends qpu
{
  public qpw(Context paramContext, FaceDecoder paramFaceDecoder, slt paramslt)
  {
  ...
  public qpk d()
  {
    ...
    if ((this.jdField_a_of_type_Qpj != null) && ((this.jdField_a_of_type_Qpj instanceof ComponentContentBig)) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentTitle != null))
    {
      ...
      ((ComponentContentBig)this.jdField_a_of_type_Qpj).setId(1);
      ((ComponentContentBig)this.jdField_a_of_type_Qpj).setLayoutParams(localLayoutParams);
      localLinearLayout3.addView((ComponentContentBig)this.jdField_a_of_type_Qpj);
      ...
      localLinearLayout3.setOnClickListener(new qpx(this, localLinearLayout1, localLinearLayout3, localLinearLayout2));
      localLinearLayout3.setDuplicateParentStateEnabled(true);
      localLinearLayout3.setOnTouchListener(new qpy(this, localLinearLayout3));
      localLinearLayout2.setOnTouchListener(new qpz(this, localLinearLayout3));
      ...
      localLinearLayout2.setOnTouchListener(new qqa(this, localLinearLayout2));
      localLinearLayout1.setOnTouchListener(new qqb(this, localLinearLayout2, localLinearLayout3));
    }
    localLinearLayout2.setOnClickListener(new qqc(this));
