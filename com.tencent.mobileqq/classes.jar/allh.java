...
public class allh
  implements alaf, allg
{
  public static float a;
  public static int a;
  public static int b;
  private long jdField_a_of_type_Long;
  public volatile alad a;
  alae jdField_a_of_type_Alae;
  public alak a;
  private alaq jdField_a_of_type_Alaq = new alaq(this);
  ...
  public allh()
  {
    this.jdField_a_of_type_Alak = new alak();
    this.jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  }
  
  private alad a(String paramString)
  {
    if (this.jdField_a_of_type_JavaUtilMap.containsKey(paramString)) {
      return (alad)this.jdField_a_of_type_JavaUtilMap.get(paramString);
    }
    return null;
  }
  ...
  private void b(GL10 paramGL10)
  {
    ...
    this.jdField_a_of_type_Alaq.onDrawFrame(paramGL10);
    ...
    paramGL10 = this.jdField_a_of_type_Alad;
    if ((paramGL10 != null) && (paramGL10.d()))
    {
      System.currentTimeMillis();
      GLES20.glEnable(2929);
      alal localalal = this.jdField_a_of_type_Alak.a(paramGL10.b(), paramGL10.c());
      if (localalal != null) {
        paramGL10.a(localalal);
      }
      GLES20.glDisable(2929);
      System.currentTimeMillis();
    }
  ...
  public int a()
  {
    return this.jdField_a_of_type_Alaq.a();
  }
  
  public long a()
  {
    return this.jdField_a_of_type_Alak.jdField_a_of_type_Long;
  }
  ...
  public void a(int paramInt)
  {
    ...
    this.jdField_a_of_type_Alaq.b(paramInt);
  }
  ...
  public void a(int paramInt1, SurfaceTexture paramSurfaceTexture, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    this.jdField_a_of_type_Alaq.a(paramInt1, paramSurfaceTexture);
    this.jdField_a_of_type_Alaq.a(paramInt2, paramInt3, paramInt4, paramInt5);
  ...
  {
    this.jdField_a_of_type_Alak.a(paramArrayOfFloat);
  }
  
  public void a(long paramLong)
  {
    this.jdField_a_of_type_Alak.jdField_a_of_type_Long = paramLong;
  }
  
  public void a(alad paramalad, ArCloudConfigInfo paramArCloudConfigInfo, int paramInt1, int paramInt2, Object paramObject)
  {
    if ((paramArCloudConfigInfo != null) && (paramArCloudConfigInfo.a()) && (this.jdField_a_of_type_Alae != null)) {
      this.jdField_a_of_type_Alae.a(paramArCloudConfigInfo, paramInt1, paramInt2, paramObject);
    }
  }
  
  public void a(alae paramalae)
  {
  ...
  {
    this.jdField_a_of_type_Alak.a(paramalai);
  }
  
  public void a(almq paramalmq)
  {
    this.jdField_a_of_type_Almq = paramalmq;
  }
  ...
  public void a(ArVideoResourceInfo paramArVideoResourceInfo, alaf paramalaf)
  {
    ...
    this.jdField_a_of_type_Alae.a(paramArVideoResourceInfo, paramalaf);
  }
  ...
  {
    this.jdField_a_of_type_Alaq.a(paramFloatBuffer, paramSize);
  }
  ...
  public boolean a(alah paramalah)
  {
    QLog.i("AREngine_UniformGLRenderManagerImpl", 1, "startModelRender. resourceInfo.key = " + paramalah.jdField_a_of_type_JavaLangString + ", resourceInfo.arType = " + paramalah.jdField_a_of_type_Int + ", resourceInfo.trackMode = " + paramalah.jdField_b_of_type_Int);
    if (!this.e)
    {
      QLog.i("AREngine_UniformGLRenderManagerImpl", 1, "startModelRender. fail because of render not ready");
      return false;
    }
    alad localalad2 = a(paramalah.jdField_a_of_type_JavaLangString);
    alad localalad1 = localalad2;
    if (localalad2 == null)
    {
      localalad1 = alaj.a(this, paramalah, this.jdField_a_of_type_AndroidOpenglGLSurfaceView);
      QLog.d("AREngine_UniformGLRenderManagerImpl", 1, "crate new render here 1" + localalad1);
      this.jdField_a_of_type_JavaUtilMap.put(paramalah.jdField_a_of_type_JavaLangString, localalad1);
      QLog.d("AREngine_UniformGLRenderManagerImpl", 1, "crate new render here " + localalad1);
    }
    if (localalad1 == null)
    {
      ...
      paramalah = this.jdField_a_of_type_Alad;
      this.jdField_a_of_type_Alad = null;
      this.jdField_a_of_type_AndroidOpenglGLSurfaceView.queueEvent(new UniformGLRenderManagerImpl.1(this, paramalah));
      return false;
    }
    this.jdField_a_of_type_AndroidOpenglGLSurfaceView.queueEvent(new UniformGLRenderManagerImpl.2(this, localalad1, paramalah));
    return true;
  }
  ...
  public boolean a(boolean paramBoolean, float paramFloat1, float paramFloat2)
  {
    ...
    {
      this.jdField_a_of_type_Alaq.a(paramBoolean);
      this.jdField_a_of_type_Alaq.a(paramFloat2);
      return true;
    }
    return false;
  }
  ...
  public void b()
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext()) {
        ((alad)localIterator.next()).f();
      }
      this.jdField_a_of_type_JavaUtilMap.clear();
      this.jdField_a_of_type_Alad = null;
      this.jdField_a_of_type_Alaq.g();
      this.jdField_a_of_type_Alak.a();
      this.e = false;
  ...
  {
    if ((this.jdField_a_of_type_Alae == null) || (this.jdField_a_of_type_Alad == null))
    {
    ...
    default: 
      return;
    case 0: 
      this.jdField_a_of_type_Alae.a(this.jdField_a_of_type_Alad.c(), paramInt2);
      return;
    case 1: 
      this.jdField_a_of_type_Alae.c(this.jdField_a_of_type_Alad.c(), paramInt2);
      return;
    case 2: 
      this.jdField_a_of_type_Alae.b(this.jdField_a_of_type_Alad.c(), paramInt2);
      return;
    }
    this.jdField_a_of_type_Alae.d(this.jdField_a_of_type_Alad.c(), paramInt2);
  }
  
  public void b(long paramLong)
  {
    this.jdField_a_of_type_Alak.c = paramLong;
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Alae = null;
  }
  ...
  public void onDrawFrame(GL10 paramGL10)
  {
    ...
    while (i != 0)
    {
      if (!this.jdField_b_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqArARRecordVideoRecordController.a(this.jdField_a_of_type_Avyw, i, j);
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Alae != null) {
        this.jdField_a_of_type_Alae.a(null, 1001, 0, localBitmap);
      }
  ...
  public void onSurfaceChanged(GL10 paramGL10, int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Almq != null) {
      this.jdField_a_of_type_Almq.a(paramGL10, paramInt1, paramInt2);
    }
    this.jdField_a_of_type_Alaq.onSurfaceChanged(paramGL10, paramInt1, paramInt2);
    if (this.jdField_a_of_type_Alae != null) {
  ...
  public void onSurfaceCreated(GL10 paramGL10, EGLConfig paramEGLConfig)
  {
    ...
    akxc.a().a(paramGL10.glGetString(7937));
    this.jdField_a_of_type_Alaq.onSurfaceCreated(paramGL10, paramEGLConfig);
    if (this.jdField_a_of_type_Almq != null) {
      this.jdField_a_of_type_Almq.a(paramGL10);
    }
    ...
    aldm.a(paramGL10.glGetString(7937), paramGL10.glGetString(7936), paramGL10.glGetString(7938), paramEGLConfig.toString());
  }
}
