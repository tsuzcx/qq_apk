...
public class allh
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = allh.class.getName();
  }
  ...
  private static void f()
  {
    ...
    jdField_a_of_type_JavaUtilMap.put(alzk.jdField_a_of_type_JavaLangString, new int[] { 20 });
    ...
    jdField_a_of_type_JavaUtilMap.put(amas.jdField_a_of_type_JavaLangString, new int[] { 86 });
    jdField_a_of_type_JavaUtilMap.put(amas.b, new int[] { 86 });
    ...
    jdField_a_of_type_JavaUtilMap.put(uhk.jdField_a_of_type_JavaLangString, new int[] { 98 });
    jdField_a_of_type_JavaUtilMap.put(uhk.c, new int[] { 98 });
    jdField_a_of_type_JavaUtilMap.put(uhk.e, new int[] { 98 });
    jdField_a_of_type_JavaUtilMap.put(uhk.b, new int[] { 98 });
    jdField_a_of_type_JavaUtilMap.put(uhk.d, new int[] { 98 });
    jdField_a_of_type_JavaUtilMap.put(uhk.f, new int[] { 98 });
    jdField_a_of_type_JavaUtilMap.put(uhk.h, new int[] { 98 });
    jdField_a_of_type_JavaUtilMap.put(uhk.i, new int[] { 98 });
    jdField_a_of_type_JavaUtilMap.put(uhk.j, new int[] { 98 });
    jdField_a_of_type_JavaUtilMap.put(uhk.k, new int[] { 98 });
    jdField_a_of_type_JavaUtilMap.put(uhk.l, new int[] { 98 });
    jdField_a_of_type_JavaUtilMap.put(uhk.m, new int[] { 98 });
    ...
    jdField_a_of_type_JavaUtilMap.put(uhk.n, new int[] { 98 });
    ...
    jdField_a_of_type_JavaUtilMap.put(bafw.b, new int[] { 143 });
    jdField_a_of_type_JavaUtilMap.put(bafw.d, new int[] { 143 });
    jdField_a_of_type_JavaUtilMap.put(bafw.f, new int[] { 143 });
    jdField_a_of_type_JavaUtilMap.put(bafw.e, new int[] { 143 });
    jdField_a_of_type_JavaUtilMap.put(bafw.g, new int[] { 143 });
    jdField_a_of_type_JavaUtilMap.put(bafw.h, new int[] { 143 });
    jdField_a_of_type_JavaUtilMap.put(bafw.c, new int[] { 143 });
