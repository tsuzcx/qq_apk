...
public class airq
{
  ...
  public static ArrayList<airp> a;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bigv.a(antf.bG) + File.separator;
  ...
  public static airp a(int paramInt)
  {
    if (jdField_a_of_type_JavaUtilArrayList.size() > paramInt) {
      return (airp)jdField_a_of_type_JavaUtilArrayList.get(paramInt);
    }
    return null;
  }
  ...
  public static Drawable a(int paramInt)
  {
    ...
    ((URLDrawable.URLDrawableOptions)localObject).mLoadingDrawable = BaseApplicationImpl.getContext().getResources().getDrawable(2130841475);
    ((URLDrawable.URLDrawableOptions)localObject).mFailedDrawable = BaseApplicationImpl.getContext().getResources().getDrawable(2130841475);
  ...
  public static String a(int paramInt)
  {
    ...
    if (TextUtils.isEmpty(str2)) {
      str1 = anzj.a(2131706790);
    }
    return str1;
  }
  
  public static List<airp> a(String paramString)
  {
        ...
        for (;;)
        {
          if (i < j) {
            try
            {
              ...
              localairp.jdField_a_of_type_Int = k;
              localairp.jdField_a_of_type_JavaLangString = b(k);
              jdField_a_of_type_JavaUtilArrayList.add(localairp);
              i += 1;
            }
  ...
  public static airp b(int paramInt)
  {
    Object localObject;
    airp localairp;
    if (jdField_a_of_type_JavaUtilArrayList.size() != 0)
    {
      ...
      do
      {
        ...
        localairp = (airp)((Iterator)localObject).next();
      } while (localairp.jdField_a_of_type_Int != paramInt);
    }
    for (;;)
    {
      localObject = localairp;
      if (localairp == null)
      {
        localObject = new airp();
        ((airp)localObject).jdField_a_of_type_Int = paramInt;
        ((airp)localObject).jdField_a_of_type_JavaLangString = b(paramInt);
      }
      return localObject;
      localairp = null;
    }
