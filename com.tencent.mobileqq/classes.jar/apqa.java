  ...
  implements Animatable
{
  ...
  public apqa(int paramInt1, int[] paramArrayOfInt, ImageView paramImageView, int paramInt2)
  {
  ...
  public apqa(int[] paramArrayOfInt, ImageView paramImageView, int paramInt)
  {
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_AndroidAnimationValueAnimator$AnimatorUpdateListener = new apqb(this);
    this.jdField_a_of_type_AndroidAnimationAnimator$AnimatorListener = new apqc(this);
  }
