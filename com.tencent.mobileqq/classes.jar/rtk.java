  ...
  implements bcmt
{
  ...
  rtk(rtj paramrtj, String paramString, int paramInt1, int paramInt2, long paramLong1, long paramLong2)
  {
  ...
  public bcmu a(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 <= paramInt2)
    {
      ...
      paramInt1 = j;
      label87:
      localbcmu.jdField_a_of_type_Int = ((int)(i * 1.0F / 640.0F * paramInt1));
    ...
    {
      localbcmu.jdField_b_of_type_Int = j;
      ...
      if (QLog.isColorLevel()) {
        QLog.d("ReadInJoyUploadVideoCompressTask", 2, "CompressTask, step: getEncodeConfig()\n quality:" + (String)localObject + ", sourceLongEdge:" + paramInt2 + ", targetLongEdge:" + paramInt1 + ", scaleRate:" + localbcmu.jdField_a_of_type_Float + "\n defaultBitRate:" + i + ", videoBitRate:" + localbcmu.jdField_a_of_type_Int + ", videoFrameRate:" + localbcmu.jdField_b_of_type_Int + "\n setRotation:" + localbcmu.jdField_b_of_type_Boolean + ", beginTime:" + localbcmu.jdField_a_of_type_Long + ", endTime:" + localbcmu.jdField_b_of_type_Long);
      }
      return localbcmu;
      paramInt2 = paramInt1;
      break;
  ...
  {
    if ((this.jdField_a_of_type_Rtj.a != null) && (!this.jdField_a_of_type_Rtj.isCancelled())) {
      this.jdField_a_of_type_Rtj.a.a(paramInt / 100.0F);
    }
  }
