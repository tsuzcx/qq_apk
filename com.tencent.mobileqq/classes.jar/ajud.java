...
public class ajud
  extends Handler
{
  public ajud(CreateFaceToFaceDiscussionActivity paramCreateFaceToFaceDiscussionActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      this.a.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130844762);
      this.a.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130844762);
      this.a.jdField_c_of_type_AndroidWidgetImageView.setImageResource(2130844762);
      this.a.d.setImageResource(2130844762);
