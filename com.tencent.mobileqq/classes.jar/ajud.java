  ...
  implements View.OnClickListener
{
  ...
  public ajud(BulkSendMessageFragment paramBulkSendMessageFragment)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqTroopTroop_appsEntryUiBulkSendMessageFragment.getActivity()).inflate(2130968775, null);
      paramViewGroup = new BulkSendMessageFragment.ViewHolder(localView);
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131362724));
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131362759));
      ...
      localTextView.setTextColor(this.jdField_a_of_type_ComTencentMobileqqTroopTroop_appsEntryUiBulkSendMessageFragment.getResources().getColor(2131494283));
      ...
      label230:
      paramViewGroup.jdField_a_of_type_AndroidViewView.setTag(2131373091, null);
    ...
    for (;;)
    {
      ...
      localImageView.setTag(2131362365, str);
      localImageView.setTag(null);
      break label230;
      label392:
      localTextView.setText(this.jdField_a_of_type_ComTencentMobileqqTroopTroop_appsEntryUiBulkSendMessageFragment.getString(2131435242));
      localTextView.setTextColor(this.jdField_a_of_type_ComTencentMobileqqTroopTroop_appsEntryUiBulkSendMessageFragment.getResources().getColorStateList(2131494166));
      localImageView.setBackgroundDrawable(null);
      localImageView.setImageResource(2130838425);
      localImageView.setEnabled(true);
      localImageView.setTag(Integer.valueOf(0));
      paramViewGroup.jdField_a_of_type_AndroidViewView.setTag(2131373091, Integer.valueOf(0));
  ...
  {
    paramView = (Integer)paramView.getTag(2131373091);
    if (paramView == null) {}
    ...
    paramView.putStringArrayListExtra("param_pick_selected_list", this.jdField_a_of_type_ComTencentMobileqqTroopTroop_appsEntryUiBulkSendMessageFragment.jdField_a_of_type_Ajud.jdField_a_of_type_JavaUtilArrayList);
    ...
    paramView.putExtra("param_pick_max_num_exceeds_wording", 2131430857);
