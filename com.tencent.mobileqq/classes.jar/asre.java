  ...
  implements asqv
{
  ...
  private void a()
  {
    ...
    try
    {
      ...
      this.jdField_c_of_type_AndroidGraphicsDrawableDrawable = localResources.getDrawable(2130847115);
      this.d = localResources.getDrawable(2130847116);
  ...
  public static void a(URLDrawable paramURLDrawable)
  {
    ...
    if (paramURLDrawable != null)
    {
      ...
      if ((localObject != null) && ((localObject instanceof GifDrawable)))
      {
        ...
        if ((localObject == null) || (!(localObject instanceof assu))) {
          break label72;
        }
        ((assu)localObject).b();
        ((assu)localObject).a();
    ...
    do
    {
      ...
      {
        return;
      } while ((localObject == null) || (!(localObject instanceof assv)));
      ((assv)localObject).b();
      ((assv)localObject).a();
      paramURLDrawable.invalidateSelf();
    } while (!QLog.isColorLevel());
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, Emoticon paramEmoticon, EmojiStickerManager.StickerInfo paramStickerInfo)
  {
    ...
    if (paramEmoticon.isNewSoundEmoticon()) {
      axfj.a(paramQQAppInterface, "0X800A932", paramSessionInfo.jdField_a_of_type_Int, paramEmoticon.epId);
    }
  ...
  private void a(QQAppInterface paramQQAppInterface, URL paramURL, EmoticonPackage paramEmoticonPackage, boolean paramBoolean, URLDrawable paramURLDrawable)
  {
    if (paramQQAppInterface != null)
    {
      ...
      if ((paramEmoticonPackage == null) && (!paramBoolean) && (this.jdField_a_of_type_ComTencentMobileqqDataEmoticon != null) && (!(paramURLDrawable.getCurrDrawable() instanceof ApngDrawable)))
      {
        ...
        paramQQAppInterface.a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId, new asrf(this, paramURL));
      }
    }
  }
  ...
  public static void b(URLDrawable paramURLDrawable)
  {
    if (paramURLDrawable != null)
    {
      ...
      if ((paramURLDrawable != null) && ((paramURLDrawable instanceof GifDrawable)))
      {
        ...
        if ((paramURLDrawable == null) || (!(paramURLDrawable instanceof assu))) {
          break label61;
        }
        ((assu)paramURLDrawable).b();
        if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      {
        return;
      } while ((paramURLDrawable == null) || (!(paramURLDrawable instanceof assv)));
      ((assv)paramURLDrawable).b();
    } while (!QLog.isColorLevel());
    QLog.d("PicEmoticonInfo", 2, "soundgif stopSoundDrawablePlay stop");
  }
  ...
  {
    aean.a(paramQQAppInterface, paramContext, paramSessionInfo, paramEmoticon, paramStickerInfo);
    paramSessionInfo = "";
    int m = -1;
    ...
    bdll.b(paramQQAppInterface, "CliOper", "", "", "ep_mall", "0X80057A9", 0, 0, paramEmoticon.epId, "", paramContext, paramEmoticon.eId);
  }
  ...
  private static void d(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, Emoticon paramEmoticon, EmojiStickerManager.StickerInfo paramStickerInfo)
  {
    ...
    bdll.b(paramQQAppInterface, "CliOper", "", "", "MbFasong", "MbIDDianji", 0, 0, paramEmoticon.epId, "", "", "");
    ((axfj)paramQQAppInterface.getManager(14)).a(paramEmoticon.epId, -1, new asri(paramContext, paramQQAppInterface, paramEmoticon, localaskd, paramSessionInfo, paramStickerInfo));
  }
  ...
  private static void e(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, Emoticon paramEmoticon, EmojiStickerManager.StickerInfo paramStickerInfo)
  {
    ...
    bdll.b(paramQQAppInterface, "CliOper", "", "", "ep_mall", "0X800579D", 0, 0, paramEmoticon.epId, "", "", "");
    localObject = (askd)paramQQAppInterface.getManager(43);
    ((axfj)paramQQAppInterface.getManager(14)).a(paramEmoticon.epId, 0, new asrk(paramContext, paramQQAppInterface, paramEmoticon, (askd)localObject, paramSessionInfo));
    c(paramQQAppInterface, paramContext, paramSessionInfo, paramEmoticon, paramStickerInfo);
  }
  ...
  public URLDrawable a()
  {
    ...
    {
      return localObject1;
      String str = asos.q.replace("[epId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId).replace("[eId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.eId);
      localObject1 = localObject4;
      if (str == null) {
        continue;
      }
  ...
  public URLDrawable a(String paramString, boolean paramBoolean1, boolean paramBoolean2, ahmg paramahmg)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqDataEmoticon == null) {}
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramahmg != null)
        {
          localObject1 = paramahmg.e.getDrawable();
          paramahmg = BaseApplicationImpl.getApplication().waitAppRuntime(null);
          if ((paramahmg instanceof QQAppInterface))
          {
            paramahmg = (QQAppInterface)paramahmg;
            ...
            if (paramahmg != null)
            {
              localObject1 = (axfj)paramahmg.getManager(14);
              if (this.jdField_a_of_type_ComTencentMobileqqDataEmoticon != null)
              {
                localObject1 = ((axfj)localObject1).b(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId, 0);
      ...
      catch (MalformedURLException paramString)
      {
        for (;;)
        {
          ...
          continue;
          a(paramahmg, paramString, (EmoticonPackage)localObject1, paramBoolean1, (URLDrawable)localObject2);
          continue;
          paramBoolean1 = false;
          continue;
  ...
  public URLDrawable a(String paramString, boolean paramBoolean1, boolean paramBoolean2, ahmg paramahmg, int paramInt1, int paramInt2)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqDataEmoticon == null) {}
    for (;;)
    {
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, EditText paramEditText, SessionInfo paramSessionInfo, boolean paramBoolean, int paramInt)
  {
    ...
    do
    {
      ...
      {
        return;
        paramEditText = (askd)paramQQAppInterface.getManager(43);
        if ((this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.jobType != 2) || (!paramBoolean) || ((!(paramContext instanceof SplashActivity)) && (!(paramContext instanceof ChatActivity))) || (!awzk.a())) {
          break label226;
        }
        if (paramEditText.a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId, Boolean.valueOf(false))) {
          break;
        }
        ChatActivityUtils.a(paramContext, 2131689916, 0);
        paramQQAppInterface = paramQQAppInterface.getHandler(ChatActivity.class);
      } while (paramQQAppInterface == null);
      paramQQAppInterface.obtainMessage(10).sendToTarget();
      paramQQAppInterface.obtainMessage(21).sendToTarget();
      return;
      paramInt = awyt.a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon, 0);
      if (QLog.isColorLevel()) {
        QLog.d("PicEmoticonInfo", 2, "forward,【maxInt:】" + paramInt);
      }
      paramInt = awxv.a(paramInt);
      ((axfj)paramQQAppInterface.getManager(14)).a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId, new asrg(this, paramQQAppInterface, paramInt, paramContext, paramSessionInfo));
      return;
      ...
      for (;;)
      {
        aean.a(paramQQAppInterface, paramContext, paramSessionInfo, this.jdField_a_of_type_ComTencentMobileqqDataEmoticon, paramInt);
        return;
        if (QLog.isColorLevel()) {
  ...
  public boolean d()
  {
    ...
    Object localObject = asos.s.replace("[epId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId).replace("[eId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.eId);
    if (localObject != null)
    {
    ...
    for (;;)
    {
      ...
      {
        localObject = asos.o.replace("[epId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId).replace("[eId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.eId);
        if (localObject == null) {
          break label165;
        }
        localObject = new File((String)localObject);
  ...
  public boolean e()
  {
    ...
    {
      localObject = asos.p.replace("[epId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId).replace("[eId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.eId);
      label52:
      if (localObject == null) {
        break label112;
      }
    ...
    {
      return bool;
      localObject = asos.q.replace("[epId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId).replace("[eId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.eId);
      break label52;
      label112:
      break;
      label114:
