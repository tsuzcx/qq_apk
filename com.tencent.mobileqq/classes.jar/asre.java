  ...
  extends Dialog
{
  ...
  public asre(Context paramContext)
  {
    super(paramContext, 2131689478);
    paramContext = LayoutInflater.from(paramContext).inflate(2131495718, null);
    paramContext.setOnTouchListener(new asrf(this));
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryViewAnimationPoint.setOnAnimationListener(new asrg(this));
  }
