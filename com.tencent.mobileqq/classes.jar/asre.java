...
{
  public asre(FMActivity paramFMActivity) {}
  ...
  public void onCheckedChanged(RadioGroup paramRadioGroup, int paramInt)
  {
    ...
    if ((paramInt == 2131376121) && (this.a.jdField_b_of_type_AndroidWidgetRadioButton.isChecked()))
    {
      this.a.a().f();
      FMActivity.d(this.a);
    ...
    for (;;)
    {
      ...
      return;
      if ((paramInt == 2131370238) && (this.a.jdField_a_of_type_AndroidWidgetRadioButton.isChecked()))
      {
        this.a.a().e();
        FMActivity.e(this.a);
        if ((this.a.h == 0) && (this.a.f)) {
      ...
      else if ((paramInt == 2131364585) && (this.a.jdField_c_of_type_AndroidWidgetRadioButton.isChecked()))
      {
        this.a.a().d();
      ...
      else if ((paramInt == 2131366262) && (this.a.d.isChecked()))
      {
        this.a.a().g();
        FMActivity.f(this.a);
        this.a.jdField_a_of_type_AndroidWidgetRadioButton.setSelected(false);
        ...
        bcst.b(this.a.app, "dc00898", "", "", "0X800AFA6", "0X800AFA6", 0, 0, "", "", "", "");
        i = 1408041718;
      }
      else
      {
