  ...
  extends qtk
{
  ...
  {
    return bigv.a(antf.ba + ".readInjoy/skin_res/");
  }
  ...
  public static JSONObject a()
  {
    ...
    try
    {
      jdField_a_of_type_OrgJsonJSONObject = new JSONObject(bhmi.b(new File(b() + "/colors.json")));
  ...
  public static void a()
  {
    ...
    try
    {
      String str = bhmi.b(new File(d() + "refreshConfig.json"));
      localObject = str;
  ...
  {
    return bigv.a(antf.ba + ".readInjoy/skin_guide/");
  }
  ...
  public Drawable a(String paramString)
  {
    ...
    ((URLDrawable.URLDrawableOptions)localObject1).mPlayGifImage = azru.a(paramString.getAbsolutePath());
