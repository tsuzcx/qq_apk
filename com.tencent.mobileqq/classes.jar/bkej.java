  ...
  extends RemoteCommand
{
  ...
  public bkej(String paramString, boolean paramBoolean)
  {
    super(paramString);
    this.a = paramBoolean;
  }
  ...
  public static Bitmap a(String paramString, Resources paramResources, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    catch (OutOfMemoryError paramString)
    {
      ...
      if (paramBoolean)
      {
        ...
        paramResources = bfpx.a(paramResources, 2130843592);
  ...
  private Bundle a(Bundle paramBundle1, Bundle paramBundle2, RemoteCommand.OnInvokeFinishLinstener paramOnInvokeFinishLinstener)
  {
    ...
    for (Bundle localBundle = new Bundle();; localBundle = paramBundle2)
    {
      ...
      if (!TextUtils.isEmpty(paramBundle2))
      {
        ...
        if (!TextUtils.isEmpty(paramBundle2))
        {
          localObject1 = bflj.a(paramBundle2, BaseApplicationImpl.getContext().getResources(), i, j, bool1);
          if (localObject1 != null) {
            localBundle.putString("path", yyi.a(BaseApplicationImpl.getContext(), paramBundle2.hashCode() + "", (Bitmap)localObject1));
          }
        }
      }
      if (QLog.isColorLevel())
      ...
      for (boolean bool1 = true;; bool1 = false)
      {
        ...
        {
          SosoInterface.startLocation(new bkek(this, 3, true, true, 300000L, false, false, "buscardLocation", localBundle, paramOnInvokeFinishLinstener));
          break;
        }
        Object localObject2;
        if (paramBundle2.equals("publicAccount"))
        {
          ...
          for (paramBundle2 = (Bundle)localObject1;; paramBundle2 = "null")
          {
            ...
            ugf.a(a(), a().getApp(), (String)localObject1, new bkel(this, localBundle, paramOnInvokeFinishLinstener));
            break;
          }
        }
        ...
        else
        {
          ...
          if (a() != null)
          {
            ...
            if (!TextUtils.isEmpty(paramBundle2))
            {
              localObject2 = (amxz)a().getManager(56);
              if (localObject2 != null) {
                bool1 = ((amxz)localObject2).a(Long.valueOf(paramBundle2));
              }
              bool2 = bool1;
              if (QLog.isColorLevel())
              {
  ...
  public static void a()
  {
    ...
    if ((localPluginCommunicationHandler != null) && (!localPluginCommunicationHandler.containsCmd("com.tencent.nfc.buscard.remotecommand"))) {
      localPluginCommunicationHandler.register(new bkej("com.tencent.nfc.buscard.remotecommand", true));
    }
    if ((localPluginCommunicationHandler != null) && (!localPluginCommunicationHandler.containsCmd("com.tencent.nfc.buscard.remotecommand.async"))) {
      localPluginCommunicationHandler.register(new bkej("com.tencent.nfc.buscard.remotecommand.async", false));
    }
  }
