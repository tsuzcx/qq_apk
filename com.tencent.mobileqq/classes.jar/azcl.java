  ...
  extends WebViewPlugin
{
  ...
  protected void a(String paramString)
  {
    try
    {
      ...
      bbmy.a(this.mRuntime.a(), 0, ajjy.a(2131649415), 0).a();
      return;
    }
  ...
  protected void d(String paramString)
  {
    try
    {
      ...
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        azlj.a(localActivity, localBundle, 2);
        return;
      }
    }
    catch (Exception paramString)
  ...
  protected void f(String paramString)
  {
    try
    {
      ...
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        Activity localActivity = this.mRuntime.a();
        Intent localIntent = aciy.a(new Intent(localActivity, SplashActivity.class), null);
        localIntent.putExtra("uin", str);
  ...
  protected void h(String paramString)
  {
    try
    {
      ...
      localbfpy.a = localAppInterface.getCurrentAccountUin();
      localbfpy.b = "";
      bfpr.b(localActivity, localbfpy, paramString, "mqqChat.QzoneCard", -1);
      return;
    }
    catch (Exception paramString)
    {
  ...
  public void onDestroy()
  {
    ...
    //   4: aload_0
    //   5: getfield 346	azcl:jdField_a_of_type_Wis	Lwis;
    //   8: ifnull +10 -> 18
    //   11: aload_0
    //   12: getfield 346	azcl:jdField_a_of_type_Wis	Lwis;
    //   15: invokevirtual 350	wis:b	()V
    //   18: aload_0
    //   19: getfield 18	azcl:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   22: iconst_0
    //   23: invokevirtual 353	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   26: return
    //   27: astore_1
    //   28: aload_0
    //   29: getfield 18	azcl:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   32: iconst_0
    //   33: invokevirtual 353	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   36: return
    //   37: astore_1
    //   38: aload_0
    //   39: getfield 18	azcl:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   42: iconst_0
