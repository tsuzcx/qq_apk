...
public class azcl
{
  ...
  public azcl(Settings paramSettings)
  {
  ...
  {
    return azcq.a(paramFloat1, this.jdField_a_of_type_Float / paramFloat2, this.b * paramFloat2);
  }
  
  public azcl a(azcn paramazcn)
  {
    ...
    if (!azcn.a(f9, 0.0F))
    {
      ...
      label202:
      switch (azcm.a[this.jdField_a_of_type_ComTencentMobileqqOcrViewGestureSettings.a().ordinal()])
      {
      default: 
