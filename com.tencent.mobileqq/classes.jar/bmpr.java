...
public class bmpr
{
  ...
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new bmps(this);
  private View jdField_a_of_type_AndroidViewView;
  private ImageView jdField_a_of_type_AndroidWidgetImageView;
  private RelativeLayout jdField_a_of_type_AndroidWidgetRelativeLayout;
  private TextView jdField_a_of_type_AndroidWidgetTextView;
  bmpu jdField_a_of_type_Bmpu;
  ...
  public bmpr(Context paramContext, int paramInt1, int paramInt2, int paramInt3, GdtAppReceiver paramGdtAppReceiver)
  {
  ...
  public void a(int paramInt1, String paramString, int paramInt2)
  {
    ...
    {
      localObject = new bmmt();
      ((bmmt)localObject).a(this.jdField_c_of_type_Int).a(l).b(paramInt1).a(paramString).c(paramInt2).d(1);
      paramString = ((bmmt)localObject).a();
      bmnn.a().a(paramString);
      return;
  ...
  public void a(View paramView, bmpu parambmpu)
  {
    if (paramView == null) {
      return;
    }
    this.jdField_a_of_type_Bmpu = parambmpu;
    QZLog.i("VipGeneralGdtShowView", " @getGdtInfo initAdvView");
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131367633));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131367642));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367643));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367645));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367641));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367646));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367647));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131367644));
  ...
  public void a(AlumBasicData paramAlumBasicData, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject1 = this.jdField_a_of_type_AndroidWidgetTextView.getResources().getDrawable(2130840348);
        ...
        if ((this.jdField_c_of_type_Int == 3) && (!bdfk.b()))
        {
          ((URLDrawable)localObject1).setTag(bgxc.a(ViewUtils.dip2px(40.0F), ViewUtils.dip2px(40.0F)));
          ((URLDrawable)localObject1).setDecodeHandler(bgxc.p);
      ...
      ((URLDrawable)localObject1).setTag(bgxc.b(ViewUtils.dip2px(40.0F), ViewUtils.dip2px(40.0F), ViewUtils.dip2px(3.5F)));
