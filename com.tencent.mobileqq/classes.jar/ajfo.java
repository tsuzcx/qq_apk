...
public class ajfo
{
  ...
  public static void a()
  {
    ...
    {
      return;
      localObject1 = ((QQAppInterface)localObject1).a().a(anhk.N, 0, null);
  ...
  public static boolean a(int paramInt)
  {
    ...
    if (!localaqlz.jdField_a_of_type_Boolean)
    {
      if (QLog.isColorLevel()) {
    ...
    if ((paramInt < localaqlz.c) || (localaqlz.c == 0))
    {
      if (QLog.isColorLevel()) {
        QLog.d("TroopNotifyHelper", 2, new Object[] { "isShowUndealTipsInTabRecent", "undealMsgCount =", Integer.valueOf(paramInt), "todoGroupVerifyMsgLevel =", Integer.valueOf(localaqlz.c) });
      }
      return false;
    }
    if (a()) {
    ...
    for (;;)
    {
      ...
      while ((System.currentTimeMillis() - b()) / 1000L < localaqlz.jdField_a_of_type_Long)
      {
        if (QLog.isColorLevel()) {
      ...
      if ((1 == j) && (6 == i) && (b() >= localaqlz.b))
      {
        if (QLog.isColorLevel()) {
          QLog.d("TroopNotifyHelper", 2, new Object[] { "isShowUndealTipsInTabRecent", "RemindCntOfOneDay =", Integer.valueOf(b()), "totalRemindCntOfOneDay =", Integer.valueOf(localaqlz.b) });
        }
        return false;
      }
      if ((1 == j) && (3 == paramInt) && (a() >= localaqlz.jdField_a_of_type_Int))
      {
        if (QLog.isColorLevel()) {
          QLog.d("TroopNotifyHelper", 2, new Object[] { "isShowUndealTipsInTabRecent", "RemindCntOfOneWeak =", Integer.valueOf(b()), "totalRemindCntOfOneWeak =", Integer.valueOf(localaqlz.jdField_a_of_type_Int) });
        }
        return false;
      }
      return true;
  ...
  public static int c()
  {
    ...
    new ArrayList();
    ArrayList localArrayList = new ArrayList();
    localObject = ((QQAppInterface)localObject).a().a(anhk.N, 0, null);
    long l = a();
