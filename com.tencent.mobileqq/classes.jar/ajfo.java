...
{
  protected int a;
  View.OnTouchListener jdField_a_of_type_AndroidViewView$OnTouchListener = new ajfp(this);
  private List<String> jdField_a_of_type_JavaUtilList;
  
  public ajfo()
  {
    this.jdField_a_of_type_Int = 2131562529;
  }
  ...
  public View a(int paramInt, Object paramObject, ajfa paramajfa, View paramView, ViewGroup paramViewGroup, Context paramContext, View.OnClickListener paramOnClickListener, View.OnLongClickListener paramOnLongClickListener, ajgx paramajgx)
  {
    ...
    label71:
    Object localObject2;
    if ((paramView != null) && ((paramView.getTag() instanceof ajfq)))
    {
      paramViewGroup = (ajfq)paramView.getTag();
      localObject1 = paramContext.getResources();
      paramajgx = ((Resources)localObject1).getColorStateList(2131166979);
      localObject1 = ((Resources)localObject1).getColorStateList(2131166980);
    ...
    for (;;)
    {
      ...
      paramViewGroup.jdField_a_of_type_ComTencentWidgetSingleLineTextView = ((SingleLineTextView)paramView.findViewById(2131371142));
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131375675));
      ...
      paramViewGroup.d = ((TextView)paramView.findViewById(2131375426));
      paramViewGroup.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131375439));
      paramViewGroup.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131375427));
      ...
      paramViewGroup.e = ((TextView)paramView.findViewById(2131370102));
      localObject2 = paramContext.getResources();
      float f = bdcb.a();
      paramajgx = ((Resources)localObject2).getColorStateList(2131166979);
      localObject1 = ((Resources)localObject2).getColorStateList(2131166908);
      localObject2 = ((Resources)localObject2).getColorStateList(2131166980);
      ...
      for (;;)
      {
        ...
        paramViewGroup.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setExtendTextColor(paramajgx, 2);
        paramViewGroup.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setExtendTextSize(17.0F, 2);
        paramView.setTag(paramViewGroup);
        break;
        paramViewGroup.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setExtendTextColor(paramajgx, 0);
      }
      label636:
      paramViewGroup.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setExtendTextColor(paramajgx, 0);
      break label71;
      ...
      paramajgx = null;
      if (paramajfa != null) {
        paramajgx = paramajfa.a((RecentBaseData)localObject1);
      }
      if ((((RecentUser)localObject2).extraInfo instanceof MayKnowRecommend))
      {
        paramajfa = (MayKnowRecommend)((RecentUser)localObject2).extraInfo;
        a(paramView, (RecentBaseData)localObject1, paramContext, paramajgx, paramajfa);
        if (paramajfa != null) {
          if (paramajfa.friendStatus == 0)
          {
            paramViewGroup.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(paramOnClickListener);
            ...
            paramViewGroup.jdField_a_of_type_AndroidWidgetButton.setTag(paramajfa);
            paramajfa = paramContext.getResources().getColorStateList(2131166934);
            if (paramajfa != null) {
              paramViewGroup.jdField_a_of_type_AndroidWidgetButton.setTextColor(paramajfa);
            }
            paramViewGroup.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130839141);
            paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
            if (AppSetting.c) {
              paramViewGroup.jdField_a_of_type_AndroidWidgetButton.setContentDescription(alpo.a(2131689628));
            }
          }
          else if (paramajfa.friendStatus == 1)
          {
            ...
            if (AppSetting.c) {
              paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(alpo.a(2131713576));
            }
          }
          else
          {
            ...
            if (AppSetting.c) {
              paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(alpo.a(2131713575));
            }
          }
        }
      }
      ...
      {
        a(paramView, (RecentBaseData)localObject1, paramContext, paramajgx);
        continue;
        label977:
  ...
  public void a(View paramView, RecentBaseData paramRecentBaseData, Context paramContext, Drawable paramDrawable)
  {
    ...
    if ((paramView.getTag() instanceof ajfq)) {}
    for (ajfq localajfq = (ajfq)paramView.getTag();; localajfq = null) {
      for (;;)
      {
        if (localajfq == null)
        {
        ...
        if (a(paramRecentBaseData))
        {
          ...
          int j = ((Integer)ajfa.a(localQQAppInterface, paramRecentBaseData.a(), paramRecentBaseData.a()).first).intValue();
          i = j;
          if (j == 103) {
            i = 1;
          }
          RecentDynamicAvatarView localRecentDynamicAvatarView = localajfq.jdField_a_of_type_ComTencentWidgetRecentDynamicAvatarView;
          ...
          if (localQQAppInterface.a.a() == 1)
          {
            ...
            a(localajfq.jdField_a_of_type_ComTencentWidgetRecentDynamicAvatarView);
            f = bdcb.a();
            if (paramRecentBaseData.mAuthenIconId == 0) {
              break label459;
            }
            localajfq.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setCompoundDrawablePadding((int)(f * 3.0F));
            localajfq.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setCompoundDrawablesWithIntrinsicBounds(0, paramRecentBaseData.mAuthenIconId);
            if (QLog.isColorLevel()) {
            ...
            localajfq.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setExtendText(paramContext, 2);
            localajfq.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setExtendText(paramRecentBaseData.mShowTime, 0);
            localajfq.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setText(paramRecentBaseData.mTitleName);
            if (!TextUtils.isEmpty(paramRecentBaseData.mTitleName_cs)) {
              localajfq.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setText(paramRecentBaseData.mTitleName_cs);
            }
            localajfq.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setIconDrawablesWithIntrinsicBounds(null);
          }
        }
        try
        {
          localajfq.c.setText(paramRecentBaseData.mLastMsg);
          ahgy.a(localajfq.jdField_b_of_type_AndroidWidgetTextView, ((RecentItemMayKnowFriendVerticalListData)paramRecentBaseData).gender, ((RecentItemMayKnowFriendVerticalListData)paramRecentBaseData).age, null);
          if (!AppSetting.c) {
            break;
          }
          ...
          bool = false;
          break label205;
          localajfq.jdField_a_of_type_ComTencentWidgetRecentDynamicAvatarView.setImageDrawable(paramDrawable);
          break label224;
          label459:
          if (a(paramRecentBaseData))
          {
            ...
            if (i == 3)
            {
              localajfq.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setCompoundDrawablePadding((int)(f * 5.0F));
              localajfq.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setCompoundDrawablesWithIntrinsicBounds(0, 2130846537);
              break label308;
            }
            localajfq.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0);
            break label308;
          }
          if (QLog.isColorLevel()) {
  ...
  public void a(View paramView, RecentBaseData paramRecentBaseData, Context paramContext, Drawable paramDrawable, MayKnowRecommend paramMayKnowRecommend)
  {
    ...
    for (ajfq localajfq = (ajfq)paramView.getTag();; localajfq = null) {
      for (;;)
      {
        ...
        try
        {
          localajfq.e.setText(paramRecentBaseData.mLastMsg);
          localajfq.jdField_a_of_type_ComTencentMobileqqTroopWidgetTroopLabelLayout.a(paramMayKnowRecommend);
          if (!AppSetting.c) {
            break;
          }
          paramView.setContentDescription(paramRecentBaseData.mContentDesc);
