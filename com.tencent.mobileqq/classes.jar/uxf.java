  ...
  extends upy<utx>
{
  ...
  public uxf(ViewGroup paramViewGroup, int paramInt)
  {
  ...
  {
    super.a(paramutx);
    this.jdField_a_of_type_ComTencentBizQqstoryMsgTabNodeRoundwithdashdemo2018WidgetsStoryMsgNodeFrameLayout.setTag(paramutx.jdField_a_of_type_JavaLangString);
    b(paramutx);
  }
  ...
  protected void b(utx paramutx)
  {
    ...
    if ((paramutx.jdField_a_of_type_JavaUtilList != null) && (!paramutx.jdField_a_of_type_JavaUtilList.isEmpty())) {
      this.jdField_a_of_type_ComTencentBizQqstoryMsgTabNodeRoundwithdashdemo2018WidgetsStoryMsgNodeFrameLayout.a(paramutx.jdField_a_of_type_JavaUtilList.size(), paramutx.jdField_a_of_type_JavaUtilList.size() - paramutx.b);
    }
  ...
  {
    Drawable localDrawable = a().getResources().getDrawable(2130846089);
    URLDrawable.URLDrawableOptions localURLDrawableOptions = URLDrawable.URLDrawableOptions.obtain();
    localURLDrawableOptions.mMemoryCacheKeySuffix = "msg_tab_thumb";
    localURLDrawableOptions.mPlayGifImage = true;
    localURLDrawableOptions.mGifRoundCorner = xod.a(a(), 3.0F);
    ...
    paramString.setURLDrawableListener(new uxg(this));
