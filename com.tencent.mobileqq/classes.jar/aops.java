...
public abstract class aops
  implements IExcitingTransferRecvListener
{
  protected final int a;
  protected long a;
  protected final aopt a;
  private aopv a;
  ...
  public aops(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, int paramInt, aopt paramaopt)
  {
    this.jdField_a_of_type_Boolean = true;
    this.jdField_b_of_type_Int = 201;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.d = paramLong1;
    this.jdField_a_of_type_Aopt = paramaopt;
    this.c = paramLong2;
  ...
  public void OnOneSlotComplete(int paramInt, ExcitingTransferOneSlotComplete paramExcitingTransferOneSlotComplete)
  {
    ...
    for (String str = paramExcitingTransferOneSlotComplete.toString();; str = "")
    {
      ...
      this.jdField_a_of_type_Aopv.a(paramInt, paramExcitingTransferOneSlotComplete);
      return;
    }
  }
  ...
  protected ExcitingTransferDownloadReqInfo a()
  {
    ...
    if (this.jdField_a_of_type_Aopt != null)
    {
      localExcitingTransferDownloadReqInfo.fileSize = this.jdField_a_of_type_Aopt.a();
      localExcitingTransferDownloadReqInfo.md5 = this.jdField_a_of_type_Aopt.a();
      localExcitingTransferDownloadReqInfo.isSupportHttps = this.jdField_a_of_type_Aopt.b();
      localExcitingTransferDownloadReqInfo.strFileName = this.jdField_a_of_type_Aopt.a();
      if (this.jdField_a_of_type_Aopt.a() != null) {
        localExcitingTransferDownloadReqInfo.mHosts = ((ExcitingTransferHostInfo[])this.jdField_a_of_type_Aopt.a().toArray(new ExcitingTransferHostInfo[this.jdField_a_of_type_Aopt.a().size()]));
      }
      localExcitingTransferDownloadReqInfo.strFileName = this.jdField_a_of_type_Aopt.a();
      localExcitingTransferDownloadReqInfo.serverPath = this.jdField_a_of_type_Aopt.b();
    }
    for (;;)
    {
  ...
  public void a(int paramInt, ExcitingTransferDownloadCompletedInfo paramExcitingTransferDownloadCompletedInfo)
  {
    ...
    if (this.jdField_a_of_type_Aopv != null) {
      this.jdField_a_of_type_Aopv.a(paramInt, paramExcitingTransferDownloadCompletedInfo);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Aopv != null) {
      this.jdField_a_of_type_Aopv.a(paramLong1, paramLong2, paramLong3);
    }
  }
  
  public void a(aopv paramaopv)
  {
    this.jdField_a_of_type_Aopv = paramaopv;
  }
  ...
  public void a(ExcitingTransferDownloadCompletedInfo paramExcitingTransferDownloadCompletedInfo)
  {
    ...
    if (this.jdField_a_of_type_Aopv != null) {
      this.jdField_a_of_type_Aopv.a(0, paramExcitingTransferDownloadCompletedInfo);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Aopt != null) {
      return "Cookie:t=0;v=" + AppSetting.a() + ";" + this.jdField_a_of_type_Aopt.c() + ";\r\n";
    }
    return "";
  }
  ...
  public void onRecvComplete(int paramInt, ExcitingTransferDownloadCompletedInfo paramExcitingTransferDownloadCompletedInfo)
  {
    ...
    {
      QLog.i("ExcitingTransfer.BaseDownloader<FileAssistant>", 1, str);
      if ((bool) && (this.jdField_a_of_type_Aopt != null)) {
        this.jdField_b_of_type_Long = this.jdField_a_of_type_Aopt.a();
      }
  ...
  public void onRecvStart()
  {
    ...
    } while (this.jdField_a_of_type_Aopv == null);
    this.jdField_a_of_type_Aopv.a();
  }
}
