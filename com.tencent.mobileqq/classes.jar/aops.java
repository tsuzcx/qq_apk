    ...
    if ((paramFile.exists()) && (paramFile.isDirectory()))
    {
      ...
      if (i < j)
      {
        ...
        for (;;)
        {
          ...
          {
            localObject2 = paramFile.getAbsolutePath() + "/" + aopp.a((String)localObject2);
            bgmg.c((String)localObject2 + "/.moveflag");
            aopp.a(((File)localObject1).getAbsolutePath(), (String)localObject2);
          }
        }
      }
    }
    paramFile = new File(anhk.ba);
    if ((paramFile.exists()) && (paramFile.isDirectory()))
    {
      paramFile = aopp.a(paramFile);
      ...
      while (k < n)
      {
        ...
        if (arrayOfFile.isDirectory())
        {
          ...
          if (((String)localObject1).length() > 4)
          {
            ...
            {
              if (aopp.a(arrayOfFile).length > 0)
              {
                localObject2 = aopp.a(arrayOfFile);
                ...
                for (;;)
                {
                  ...
                  if (((File)localObject3).isDirectory())
                  {
                    ...
                    {
                      localObject3 = aopp.a((File)localObject3);
                      ...
                      while (i < j)
                      {
                        ...
                        {
                          bgmg.c(ThemeDiyStyleLogic.getSdcardDIYDir() + aopp.a((String)localObject1) + "/.moveflag");
                          bgmg.a(localObject4.getAbsolutePath(), ThemeDiyStyleLogic.getSdcardDIYDir() + aopp.a((String)localObject1) + "/" + localObject4.getName());
                        }
                        i += 1;
                      }
                      j = 1;
        ...
        if (j != 0) {
          bgmg.a(arrayOfFile.getAbsolutePath());
        }
        k += 1;
      }
    }
