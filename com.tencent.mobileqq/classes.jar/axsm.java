  ...
  extends axox
{
  ...
  public axsm(axos paramaxos, axvt paramaxvt)
  {
    ...
    this.jdField_a_of_type_Axqf.jdField_a_of_type_JavaLangString = paramaxvt.a();
  }
  
  private boolean a()
  {
    if (QLog.isColorLevel()) {
      QLog.i("NearbyPeoplePhotoUploadProcessor", 2, "personality_label start uniseq:" + this.jdField_a_of_type_Axvt.jdField_a_of_type_Long + " src:" + this.jdField_a_of_type_Axvt.i);
    }
    Object localObject = new CompressInfo(this.jdField_a_of_type_Axvt.i, 0);
    ...
    do
    {
      ...
      axvt localaxvt = this.jdField_a_of_type_Axvt;
      localObject = ((CompressInfo)localObject).e;
      localaxvt.i = ((String)localObject);
      localaxqf.jdField_c_of_type_JavaLangString = ((String)localObject);
    } while (c() != 0);
    return false;
  }
  ...
  private void g()
  {
    ...
    localaxyo.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin();
    axyg localaxyg = new axyg();
    localaxyg.jdField_a_of_type_Axzn = this;
    if (this.jdField_a_of_type_Axvt.b == 22)
    {
      localaxyg.jdField_a_of_type_JavaLangString = "friend_avatar_up";
      localaxyg.jdField_a_of_type_JavaUtilList.add(localaxyo);
    ...
    {
      return;
      localaxyg.jdField_a_of_type_JavaLangString = "nearby_people_pic_up";
      break;
      if (QLog.isColorLevel()) {
  ...
  public void a(axyg paramaxyg, axyv paramaxyv)
  {
    if (paramaxyv != null)
    {
      ...
      {
        paramaxyg = (axzg)paramaxyv.jdField_a_of_type_JavaUtilList.get(i);
        if (QLog.isColorLevel()) {
          b("procUrl", paramaxyg.toString());
        }
        a(this.jdField_a_of_type_Axow, paramaxyg);
        if (QLog.isColorLevel()) {
          QLog.i("NearbyPeoplePhotoUploadProcessor", 2, "onBusiProtoResp()------response.result = " + paramaxyg.jdField_c_of_type_Int);
        }
        if (paramaxyg.jdField_c_of_type_Int == 0)
        {
          this.jdField_d_of_type_ArrayOfByte = paramaxyg.jdField_a_of_type_ArrayOfByte;
          if (QLog.isColorLevel()) {
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      this.m = (i | j);
      str1 = "";
      if ((this.jdField_a_of_type_Axqf.b != 8) && (this.jdField_a_of_type_Axqf.b != 64)) {
        break label190;
      }
      ...
      awrn.a(BaseApplication.getContext()).a(null, str1, true, l, this.q, this.jdField_a_of_type_JavaUtilHashMap, "");
    }
    for (;;)
    {
      l();
      ...
      break;
      label190:
      if (this.jdField_a_of_type_Axqf.b == 21)
      {
        str1 = "actFreshNewsPicUpload";
        break label100;
      }
      if (this.jdField_a_of_type_Axqf.b == 22)
      {
        str1 = "actFriendAvatarUpload";
        break label100;
      }
      if (this.jdField_a_of_type_Axqf.b == 34)
      {
        str1 = "C2BUploadFile";
        break label100;
      }
      if (this.jdField_a_of_type_Axqf.b == 35)
      {
        str1 = "actProfileCoverPicUpload";
        break label100;
      }
      if ((this.jdField_a_of_type_Axqf.b == 36) || (this.jdField_a_of_type_Axqf.b == 37) || (this.jdField_a_of_type_Axqf.b == 38) || (this.jdField_a_of_type_Axqf.b == 48))
      {
        str1 = "actBaseDynamicAvatarUpload";
        break label100;
      }
      if ((this.jdField_a_of_type_Axqf.b == 39) || (this.jdField_a_of_type_Axqf.b == 40) || (this.jdField_a_of_type_Axqf.b == 41))
      {
        str1 = "actNearbyDynamicAvatarUpload";
        break label100;
      }
      if ((this.jdField_a_of_type_Axqf.b == 50) || (this.jdField_a_of_type_Axqf.b == 51))
      {
        str1 = "actHongbaoStarPhotoUpload";
        break label100;
      }
      if (this.jdField_a_of_type_Axqf.b == 56)
      {
        str1 = "actPersonalityLabelPhotoUpload";
        break label100;
      }
      if (this.jdField_a_of_type_Axqf.b != 23) {
        break label100;
      }
      str1 = "actExtendFriendSoundUpload";
      break label100;
      label442:
      str2 = bakz.a(this.jdField_d_of_type_ArrayOfByte);
      break label139;
      label454:
      if (this.j != -9527) {
      ...
      awrn.a(BaseApplication.getContext()).a(null, str1, false, l, this.q, this.jdField_a_of_type_JavaUtilHashMap, "");
    }
  }
  ...
  public void aS_()
  {
    ...
    this.b.a();
    axsn localaxsn = new axsn(this, SystemClock.uptimeMillis());
    if ((this.jdField_a_of_type_Axqf.b == 8) || (this.jdField_a_of_type_Axqf.b == 64)) {
      i = 3;
    }
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction = new Transaction(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), i, this.jdField_a_of_type_Axvt.i, (int)this.r, this.jdField_d_of_type_ArrayOfByte, this.jdField_a_of_type_ArrayOfByte, localaxsn, this.jdField_a_of_type_Axqf.jdField_a_of_type_ArrayOfByte);
      ...
      if (QLog.isColorLevel()) {
        QLog.i("NearbyPeoplePhotoUploadProcessor", 2, "<BDH_LOG> Transaction submit RetCode:" + j + " T_ID:" + this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction.getTransationId() + " UniSeq:" + this.jdField_a_of_type_Axvt.jdField_a_of_type_Long + " MD5:" + this.jdField_c_of_type_JavaLangString + " uuid:" + this.jdField_k_of_type_JavaLangString + " Path:" + this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction.filePath + " Cmd:" + i);
      }
      if (j != 0)
      {
      ...
      if (this.jdField_a_of_type_Axqf.b == 21) {
        i = 6;
      } else if (this.jdField_a_of_type_Axqf.b == 22) {
        i = 5;
      } else if (this.jdField_a_of_type_Axqf.b == 34) {
        i = 13;
      } else if (this.jdField_a_of_type_Axqf.b != 35) {
        if ((this.jdField_a_of_type_Axqf.b == 36) || (this.jdField_a_of_type_Axqf.b == 37) || (this.jdField_a_of_type_Axqf.b == 38))
        {
          i = 23;
        }
        else if ((this.jdField_a_of_type_Axqf.b == 39) || (this.jdField_a_of_type_Axqf.b == 40) || (this.jdField_a_of_type_Axqf.b == 41))
        {
          i = 22;
        }
        else if (this.jdField_a_of_type_Axqf.b == 48)
        {
          i = 24;
        }
        else if (this.jdField_a_of_type_Axqf.b == 23)
        {
          i = 59;
          ...
          this.jdField_a_of_type_Axqf.jdField_a_of_type_ArrayOfByte = localCommFileExtReq.toByteArray();
        }
        else if ((this.jdField_a_of_type_Axqf.b == 50) || (this.jdField_a_of_type_Axqf.b == 51))
        {
          i = 35;
        }
        else if (this.jdField_a_of_type_Axqf.b == 56)
        {
          i = 39;
        }
        else
  ...
  public void aU_()
  {
    ...
    if ((this.jdField_a_of_type_Axqf.b == 56) && (a())) {
      return;
    }
  ...
  void d()
  {
    ...
    d(1005);
    if (QLog.isColorLevel()) {
      QLog.i("NearbyPeoplePhotoUploadProcessor", 2, "onError()---- errCode: " + this.j + ", errDesc:" + this.i);
    }
