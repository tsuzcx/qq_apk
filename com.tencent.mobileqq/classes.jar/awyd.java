...
public class awyd
{
  ...
  public awyd(awum paramawum, Context paramContext, int paramInt)
  {
  ...
  private TextView a(String paramString, View paramView, boolean paramBoolean)
  {
    ...
    if (paramView == null)
    {
      ...
      int i = aciy.a(12.5F, localResources);
  ...
  public static boolean a(awum paramawum, int paramInt)
  {
    ...
    label14:
    String str;
    if (paramawum.hasNext())
    {
      str = ((awul)paramawum.next()).a;
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      localObject1 = (FrameLayout)localLinearLayout.findViewById(2131310851);
      if (localObject1 == null) {
        break label381;
      }
      localObject2 = this.jdField_a_of_type_Awum.a.iterator();
      paramView = null;
      if (((Iterator)localObject2).hasNext())
      {
        awul localawul = (awul)((Iterator)localObject2).next();
        String str = localawul.a;
        if ("title".equals(str)) {
          paramView = ((StructMsgItemTitle)localawul).b();
        }
        for (;;)
        {
          break;
          if ("picture".equals(str)) {
            this.jdField_a_of_type_AndroidViewView = a(localawul, (View)localObject1, paramBundle);
          }
        }
      }
      ...
      paramBundle = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131310864);
    ...
    for (;;)
    {
      if (localLinearLayout == null)
      {
        ...
        localLinearLayout.setId(2131310865);
      }
      for (;;)
      {
        localObject1 = this.jdField_a_of_type_Awum.a.iterator();
        label331:
        if (((Iterator)localObject1).hasNext())
        {
          paramContext = (awul)((Iterator)localObject1).next();
        ...
        for (;;)
        {
          ...
          if ((!TextUtils.isEmpty(paramView)) && (paramView.trim().length() > 0))
          {
            ...
            this.jdField_a_of_type_AndroidWidgetTextView.setId(2131310867);
  ...
  public View a(awul paramawul, View paramView, Bundle paramBundle)
  {
    ...
    {
      PAImageView localPAImageView = (PAImageView)paramawul;
      localPAImageView.setUseRadiusRound(true, localResources.getDimensionPixelSize(2131165279));
      localPAImageView.setTag(2131306412, Integer.valueOf(1));
    }
