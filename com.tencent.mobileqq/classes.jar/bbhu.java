...
public class bbhu
{
  private static bbhu jdField_a_of_type_Bbhu;
  private String jdField_a_of_type_JavaLangString;
  private Map<Integer, alsn> jdField_a_of_type_JavaUtilMap = new HashMap();
  ...
  private Map<Integer, alsn> e = new HashMap();
  private Map<Integer, Integer> f = new HashMap();
  
  private bbhu()
  {
    this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(1), new alsn(960, 720));
    this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(2), new alsn(960, 720));
  ...
  {
    if (jdField_a_of_type_Bbhu == null) {}
    try
    {
      if (jdField_a_of_type_Bbhu == null) {
        jdField_a_of_type_Bbhu = new bbhu();
      }
      return jdField_a_of_type_Bbhu;
    }
    finally {}
  }
  ...
  private void a()
  {
    ...
    for (;;)
    {
      ...
      for (j = arrayOfString2.length - 1;; j = 0)
      {
        ...
        {
          this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(2), new alsn(arrayOfInt3[i], arrayOfInt2[i]));
          this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(1), new alsn(arrayOfInt3[i], arrayOfInt2[i]));
          this.e.put(Integer.valueOf(2), new alsn(arrayOfInt3[j], arrayOfInt2[j]));
          this.e.put(Integer.valueOf(1), new alsn(arrayOfInt3[j], arrayOfInt2[j]));
        }
        if (localObject != null)
        {
  ...
  public alsn a(int paramInt)
  {
    if (this.jdField_a_of_type_JavaUtilMap.containsKey(Integer.valueOf(paramInt))) {
      return (alsn)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
    }
    return new alsn(960, 720);
  }
}
