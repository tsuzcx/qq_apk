...
public class anqc
{
  ...
  {
    return autm.a(a(paramQQAppInterface, paramLong1, paramLong2, paramLong3), paramUinPairMsg, paramQQAppInterface);
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    if ((str != null) && (str.equals(paramString1))) {
      return anni.a(2131705407);
    }
    paramString2 = bglf.a(paramQQAppInterface, paramString1, paramString2, 1, 0);
    if (paramString2 == paramString1)
    {
      paramQQAppInterface = ((anmw)paramQQAppInterface.getManager(51)).e(paramString1);
      if (paramQQAppInterface != null) {
        return bglf.a(paramQQAppInterface);
      }
    }
    return paramString2;
  }
  ...
  public static msg_svc.PbSendMsgReq a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    {
      localObject1 = bbzf.a((MessageForText)paramMessageRecord);
    ...
    while (localObject1 == null)
    {
      ...
      {
        localObject1 = bbzf.a((MessageForReplyText)paramMessageRecord);
      ...
      {
        localObject1 = bbzf.a((MessageForPic)paramMessageRecord);
        i = ((MessageForPic)paramMessageRecord).msgVia;
      }
      else if (paramMessageRecord.msgtype == -2002)
      {
        localObject1 = bbzf.a((MessageForPtt)paramMessageRecord);
        i = ((MessageForPtt)paramMessageRecord).msgVia;
      }
      else if (paramMessageRecord.msgtype == -2007)
      {
        localObject1 = bbzf.a((MessageForMarketFace)paramMessageRecord);
      ...
      {
        localObject1 = bbzf.a((MessageForApollo)paramMessageRecord);
        i = 0;
      }
      else if ((paramMessageRecord.msgtype == -2011) || (paramMessageRecord.msgtype == -2051) || (paramMessageRecord.msgtype == -7002))
      {
        localObject1 = bbzf.a((MessageForStructing)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -2010)
      {
        localObject1 = bbzf.a((MessageForFunnyFace)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -2020)
      {
        localObject1 = bbzf.a((MessageForShakeWindow)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -2022)
      {
        localObject1 = bbzf.a((MessageForShortVideo)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -2071)
      {
        localObject1 = bbzf.a((MessageForLightVideo)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5008)
      {
        localObject1 = bbzf.a((ChatMessage)paramMessageRecord, false);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5013)
      {
        localObject1 = bbzf.c((ChatMessage)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5014)
      {
        localObject1 = bbzf.d((ChatMessage)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5012)
      {
        localObject1 = bbzf.e((MessageForPoke)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5018)
      {
        localObject1 = bbzf.f((MessageForPokeEmo)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -1051)
      {
        localObject1 = bbzf.a((MessageForLongTextMsg)paramMessageRecord, true);
        i = 0;
      }
      ...
      {
        localObject1 = bbzf.a((MessageForMixedMsg)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -2057)
      {
        localObject1 = bbzf.a((MessageForTroopStory)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -7001)
      {
        localObject1 = bbzf.g((MessageForScribble)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5016)
      {
        localObject1 = bbzf.c((MessageForArkBabyqReply)paramMessageRecord, false);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5017)
      {
        localObject1 = bbzf.b((MessageForArkApp)paramMessageRecord, false);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -7005)
      {
        localObject1 = bbzf.b((MessageForLimitChatConfirm)paramMessageRecord);
        i = 0;
      }
      else
      {
    ...
    if (njo.a(paramMessageRecord))
    {
      ...
      localObject4 = njo.a(paramMessageRecord);
      ((im_msg_body.AnonymousGroupMsg)localObject3).uint32_flags.set(((njp)localObject4).jdField_a_of_type_Int);
      if (!TextUtils.isEmpty(((njp)localObject4).jdField_a_of_type_JavaLangString)) {
        ((im_msg_body.AnonymousGroupMsg)localObject3).str_anon_id.set(ByteStringMicro.copyFrom(((njp)localObject4).jdField_a_of_type_JavaLangString.getBytes()));
      }
      if (!TextUtils.isEmpty(((njp)localObject4).jdField_b_of_type_JavaLangString)) {
        ((im_msg_body.AnonymousGroupMsg)localObject3).str_anon_nick.set(ByteStringMicro.copyFrom(((njp)localObject4).jdField_b_of_type_JavaLangString.getBytes()));
      }
      ((im_msg_body.AnonymousGroupMsg)localObject3).uint32_head_portrait.set(((njp)localObject4).jdField_b_of_type_Int);
      ((im_msg_body.AnonymousGroupMsg)localObject3).uint32_expire_time.set(((njp)localObject4).jdField_c_of_type_Int);
      if (!TextUtils.isEmpty(((njp)localObject4).jdField_c_of_type_JavaLangString)) {
        ((im_msg_body.AnonymousGroupMsg)localObject3).str_rank_color.set(ByteStringMicro.copyFrom(((njp)localObject4).jdField_c_of_type_JavaLangString.getBytes()));
      }
    ...
    do
    {
      localObject2 = arkw.a(paramMessageRecord);
      ...
      localObject2 = (aopm)paramQQAppInterface.getManager(199);
      if ((localObject2 != null) && (((aopm)localObject2).a()) && (((aopm)localObject2).a() == 1L) && ((paramMessageRecord.istroop == 1) || (paramMessageRecord.istroop == 3000)))
      {
        localObject2 = ((aopm)localObject2).a();
        if (localObject2 != null)
        {
      ...
      if (((anmw)paramQQAppInterface.getManager(51)).a)
      {
        if (QLog.isColorLevel()) {
      ...
      localObject1 = bbzf.a(paramQQAppInterface, paramMessageRecord, (im_msg_body.RichText)localObject1, i);
      if ((localObject1 != null) && ((paramMessageRecord instanceof MessageForStructing)))
      {
        ...
        if ((((MessageForStructing)localObject2).structingMsg != null) && (ubp.a(((MessageForStructing)localObject2).structingMsg)))
        {
      ...
      localObject4 = (anmw)paramQQAppInterface.getManager(51);
      ...
      {
        localObject3 = aqjq.b(paramMessageRecord);
    ...
    for (;;)
    {
      try
      {
        localObject2 = (String)axdz.a(paramQQAppInterface.getCurrentAccountUin(), "self_nick", String.valueOf(""));
        k = ((Integer)axdz.a(paramQQAppInterface.getCurrentAccountUin(), "self_gender", Integer.valueOf(-1))).intValue();
        j = ((Integer)axdz.a(paramQQAppInterface.getCurrentAccountUin(), "self_age", Integer.valueOf(-1))).intValue();
        if ((j >= 0) && (k >= 0)) {
          continue;
        }
        localFriends = ((anmw)localObject4).e(paramQQAppInterface.getCurrentAccountUin());
      ...
      if (paramMessageRecord.msgtype == -2011)
      {
        ...
        k = 0;
        continue;
        localObject4 = ((anmw)localObject4).b(paramQQAppInterface.getCurrentAccountUin());
      ...
      if ((paramMessageRecord.istroop == 1033) || (paramMessageRecord.istroop == 1034))
      {
        ...
        aqjq.a(localElem, paramMessageRecord);
      ...
      {
        localElem = aqjq.a(paramMessageRecord);
        if (localElem != null) {
          ((im_msg_body.RichText)localObject1).elems.add(localElem);
        }
        if (!QLog.isColorLevel()) {
      ...
      autm.a(localElem, paramMessageRecord);
      ((im_msg_body.RichText)localObject1).elems.add(localElem);
      if (!QLog.isColorLevel()) {
        break label1073;
      }
  ...
  public static msg_svc.PbSendMsgReq a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, ArrayList<String> paramArrayList, adrq paramadrq)
  {
    int i = 0;
    Object localObject1;
    boolean bool1;
    ...
    do
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandlerUtils", 2, String.format("getPbSendReqFromBlessMsg, hongbao param, temp_id: %d, video_len: %d, redbag_id: %s, redbag_amount: %d, has_readbag: %d, has_video: %d", new Object[] { Long.valueOf(paramadrq.jdField_a_of_type_Long), Long.valueOf(paramadrq.jdField_b_of_type_Long), paramadrq.jdField_a_of_type_ArrayOfByte, Long.valueOf(paramadrq.c), Integer.valueOf(paramadrq.jdField_a_of_type_Int), Integer.valueOf(paramadrq.jdField_b_of_type_Int) }));
        }
        ((msg_svc.MultiMsgAssist)localObject1).uint64_temp_id.set(paramadrq.jdField_a_of_type_Long);
        ((msg_svc.MultiMsgAssist)localObject1).uint64_vedio_len.set(paramadrq.jdField_b_of_type_Long);
        ((msg_svc.MultiMsgAssist)localObject1).uint32_has_readbag.set(paramadrq.jdField_a_of_type_Int);
        if (paramadrq.jdField_a_of_type_Int == 1)
        {
          if (paramadrq.jdField_a_of_type_ArrayOfByte != null) {
            ((msg_svc.MultiMsgAssist)localObject1).bytes_redbag_id.set(ByteStringMicro.copyFrom(paramadrq.jdField_a_of_type_ArrayOfByte));
          }
          ((msg_svc.MultiMsgAssist)localObject1).uint64_redbag_amount.set(paramadrq.c);
        }
        ((msg_svc.MultiMsgAssist)localObject1).uint32_has_vedio.set(paramadrq.jdField_b_of_type_Int);
      }
      int j = bbzj.a(paramMessageRecord.msgUid);
      int k = (short)(int)paramMessageRecord.msgseq;
      paramArrayList = paramQQAppInterface.a().a();
      paramadrq = new msg_svc.PbSendMsgReq();
      paramadrq.msg_body.set((MessageMicro)localObject2);
      paramadrq.msg_seq.set(k & 0xFFFF);
      paramadrq.msg_rand.set(j);
      paramadrq.msg_via.set(i);
      paramadrq.multi_msg_assist.set((MessageMicro)localObject1);
      if (paramArrayList != null) {
        paramadrq.sync_cookie.set(ByteStringMicro.copyFrom(paramArrayList));
      }
      paramArrayList = paramadrq;
    } while (paramadrq == null);
    label257:
    label263:
    a(paramQQAppInterface, paramMessageRecord, paramadrq);
    return paramadrq;
  }
  ...
  private static im_msg_body.GeneralFlags a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, msg_svc.PbSendMsgReq paramPbSendMsgReq)
  {
    ...
    Object localObject1 = paramMessageRecord.getExtInfoFromExtStr(bbyw.jdField_c_of_type_JavaLangString);
    ...
    for (;;)
    {
      ...
      catch (Exception localException2)
      {
        ...
        localGeneralFlags.babyq_guide_msg_cookie.set(ByteStringMicro.copyFrom(paramQQAppInterface.toByteArray()));
        return localGeneralFlags;
        paramQQAppInterface = bgjw.a(paramMessageRecord.msg);
        if (paramQQAppInterface == null) {
          continue;
        }
      ...
      if (paramPbSendMsgReq != null)
      {
        ...
        localObject2 = (anuk)paramQQAppInterface.a(13);
        k = ((anuk)localObject2).d();
        m = ((anuk)localObject2).b();
        if (m <= 0) {
          break label3296;
        }
        localObject1 = ((BubbleManager)localObject1).a(m, false);
        if ((localObject1 != null) && ((localObject1 == null) || (((apwq)localObject1).a == null) || (((apwq)localObject1).a.size() <= 0))) {
          break label2164;
        }
      }
      label1866:
        ...
        for (j = k;; j = 0) {
          for (;;)
          {
            ...
            if ((paramMessageRecord instanceof MessageForFoldMsg))
            {
              i1 = i;
              n = j;
              if (aklj.a(paramQQAppInterface))
              {
                bool = aklj.b(paramQQAppInterface);
                localObject2 = (aklj)paramQQAppInterface.getManager(125);
                ...
                if (((MessageForFoldMsg)localObject1).redBagId != null)
                {
                  k = i;
                  m = j;
                  if (aklj.b(paramQQAppInterface))
                  {
                    n = 1;
                    i1 = 1;
                    if ((!bool) || (((aklj)localObject2).e)) {
                      break label2170;
                    }
                    i = 1;
                    label1018:
            ...
            if ((paramMessageRecord instanceof MessageForLongTextMsg))
            {
              ...
              localObject1 = ((anmw)paramQQAppInterface.getManager(51)).a(paramQQAppInterface.c());
              k = j;
              j = i;
              if (localObject1 != null)
              {
              ...
              for (;;)
              {
                ...
                try
                {
                  ...
                  if ((k & 0x1) == 1)
                  {
                    ...
                    if (!((bftx)paramQQAppInterface.getManager(203)).a(paramMessageRecord)) {
                      break label2338;
                    }
                    ...
                    bbzf.a(paramPbSendMsgReq, ((MessageForPtt)localObject1).mInputContent, ((MessageForPtt)localObject1).atInfoList);
                    i = k;
                ...
                catch (NumberFormatException localNumberFormatException)
                {
                  ...
                  {
                    k = i;
                    if (ains.b((MessageForPic)paramMessageRecord))
                    {
                      i = 1;
                  ...
                  catch (Exception paramQQAppInterface)
                  {
                    try
                    {
                      ...
                      localResvAttr.bytes_pb_ptt_waveform.set(ByteStringMicro.copyFrom(bgog.a(paramQQAppInterface.waveformArray).toByteArray()));
  ...
  private static im_msg_body.RichText a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    {
      im_msg_body.RichText localRichText = ((acxh)localIterator.next()).a(paramMessageRecord, paramQQAppInterface);
  ...
  protected static void a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, msg_svc.PbSendMsgReq paramPbSendMsgReq)
  {
    ...
    Object localObject = (anuk)paramQQAppInterface.a(13);
    int j = ((anuk)localObject).d();
    paramQQAppInterface = (BubbleManager)paramQQAppInterface.getManager(44);
    int n = ((anuk)localObject).b();
    boolean bool;
    if (n > 0)
    {
  ...
  private static void a(MessageRecord paramMessageRecord, msg_svc.PbSendMsgReq paramPbSendMsgReq, QQAppInterface paramQQAppInterface)
  {
    Iterator localIterator = paramQQAppInterface.a().a().d().iterator();
    while (localIterator.hasNext()) {
      ((acxh)localIterator.next()).a(paramMessageRecord, paramPbSendMsgReq, paramQQAppInterface);
    }
  }
  ...
  {
    paramQQAppInterface = (acxp)paramQQAppInterface.a().a().a().a(Integer.valueOf(paramInt));
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if ((localMessageRecord != null) && (localMessageRecord.msgtype == paramMessageRecord.msgtype) && (bgjw.a(localMessageRecord.msg, paramMessageRecord.msg)))
        {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((paramMessageRecord.istroop == 1) || (paramMessageRecord.istroop == 1026) || (paramMessageRecord.istroop == 3000))
      {
        if ((localObject != null) && (((List)localObject).size() > 0))
        {
          ...
          while (((Iterator)localObject).hasNext()) {
            if (acwh.a((MessageRecord)((Iterator)localObject).next(), paramMessageRecord, false, paramBoolean))
            {
              if ((QLog.isColorLevel()) && (localStringBuilder != null))
              {
      ...
      else if (acwh.d(paramMessageRecord.istroop))
      {
        if ((localObject != null) && (((List)localObject).size() > 0))
        {
          localObject = ((List)localObject).iterator();
          while (((Iterator)localObject).hasNext()) {
            if (acwh.a((MessageRecord)((Iterator)localObject).next(), paramMessageRecord, paramBoolean))
            {
              if ((QLog.isColorLevel()) && (localStringBuilder != null))
              {
      ...
      else if (paramMessageRecord.istroop == 7220)
      {
        if ((localObject != null) && (((List)localObject).size() > 0))
        {
          ...
          } while (!acwh.a((MessageRecord)paramQQAppInterface.next(), paramMessageRecord, true));
          if ((QLog.isColorLevel()) && (localStringBuilder != null))
          {
            localStringBuilder.append(" filterType: other");
            QLog.w("Q.msg.MessageHandlerUtils", 2, localStringBuilder.toString());
