...
public class aokv
  implements aokt
{
  private static volatile aokv jdField_a_of_type_Aokv;
  ...
  private aokv(BaseActivity paramBaseActivity)
  {
    this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(paramBaseActivity);
  }
  
  public static final aokv a(BaseActivity paramBaseActivity)
  {
    if (jdField_a_of_type_Aokv == null) {}
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (jdField_a_of_type_Aokv == null) {
        jdField_a_of_type_Aokv = new aokv(paramBaseActivity);
      }
      return jdField_a_of_type_Aokv;
    }
  }
  ...
  public static final void b()
  {
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (jdField_a_of_type_Aokv != null)
      {
        if (jdField_a_of_type_Aokv.a()) {
          jdField_a_of_type_Aokv.c();
        }
        ExtendFriendVoiceView localExtendFriendVoiceView = jdField_a_of_type_Aokv.a();
  ...
  public void a(String paramString)
  {
    ...
    {
      if (this.jdField_a_of_type_Aokr == null) {
        this.jdField_a_of_type_Aokr = new aokr(this, localBaseActivity);
      }
      if (!TextUtils.isEmpty(paramString))
      {
        this.jdField_a_of_type_Aokr.a(paramString);
