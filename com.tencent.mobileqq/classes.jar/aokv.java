  ...
  extends anud
{
  ...
  aokv(QQAppInterface paramQQAppInterface)
  {
  ...
  private static PayRuleCfg a(String arg0, String paramString2)
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      ...
      if (paramString2 != null) {
        return (PayRuleCfg)bnjr.a(PayRuleCfg.class, paramString2);
      }
    }
    return null;
  }
  ...
  public static String a(PayRuleCfg paramPayRuleCfg)
  {
    ...
    return Base64.encodeToString(bnjr.a(paramPayRuleCfg), 2) + "\n" + paramPayRuleCfg;
  }
  ...
  public static void a(int paramInt, String paramString)
  {
    ...
    localbnwr.jdField_e_of_type_JavaLangString = "tianshu.47";
    localbnwr.jdField_f_of_type_JavaLangString = "tianshu.47";
    localbnwr.g = paramString;
    localbnwr.h = "";
  ...
  private void a(@NonNull PrivExtV2Rsp paramPrivExtV2Rsp, String paramString)
  {
    ...
    Friends localFriends = localanyw.d(paramString);
    ...
    localSharedPreferences.edit().putString("sp_vip_info_current_version", bmsw.a());
    ...
    {
      paramPrivExtV2Rsp = (aoan)this.app.getManager(131);
    ...
    for (;;)
    {
      bihn.a().a(this.app, localVipUserInfo);
      return;
      label555:
  ...
  private void a(VipMedalList paramVipMedalList, String paramString)
  {
    ...
    anyw localanyw = (anyw)this.app.getManager(51);
    paramString = localanyw.d(paramString);
  ...
  private static boolean a(PayRuleCfg paramPayRuleCfg1, PayRuleCfg paramPayRuleCfg2)
  {
    ...
    return Arrays.equals(bnjr.a(paramPayRuleCfg1), bnjr.a(paramPayRuleCfg2));
  }
  
  private boolean a(PrivExtV2Rsp paramPrivExtV2Rsp)
  {
    if (paramPrivExtV2Rsp.data_flag != null) {
      bmfq.a("drawer_trace_info", paramPrivExtV2Rsp.data_flag.trace_info);
    }
    bmfq.a(paramPrivExtV2Rsp.isQQLivePgc, paramPrivExtV2Rsp.qqLiveMsg);
    biik.a(this.app, "setting_me_vip_sync_freq", paramPrivExtV2Rsp.iSyncFreq);
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, PayRuleCfg paramPayRuleCfg, boolean paramBoolean)
  {
    ...
    for (paramQQAppInterface = Boolean.valueOf(false);; paramQQAppInterface = Integer.valueOf(paramPayRuleCfg.enable))
    {
      ...
      return false;
      long l1 = biik.a(paramQQAppInterface, "last_pull_pay_rule", 0L);
  ...
  private boolean a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, PrivExtV2Rsp paramPrivExtV2Rsp, boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      if (localObject != null) {
        if (((VipUserInfo)localObject).bUpdate == 0)
        {
          ...
          label114:
          bihq.a(paramPrivExtV2Rsp.trafficResult, paramToServiceMsg.extraData);
          if ((localObject != null) && (((VipUserInfo)localObject).bUpdate == 1) && (paramPrivExtV2Rsp.trafficResult != null) && (paramPrivExtV2Rsp.trafficResult.bUpdate == 1) && (paramPrivExtV2Rsp.medalInfoList != null) && (paramPrivExtV2Rsp.medalInfoList.bUpdate == 1)) {
            biik.a(this.app, "setting_me_get_vip_info_sequence", NetConnInfoCenter.getServerTime());
          }
          biik.a(this.app, "setting_me_last_request_success_time", NetConnInfoCenter.getServerTime());
      ...
      {
        biik.a(this.app, "key_long_setting_me_vip_medal_list_record", l1);
        paramToServiceMsg = paramPrivExtV2Rsp.itemCfgList;
        if (paramToServiceMsg != null)
        {
          l1 = biik.a(this.app, "name_plate_config_version", 0L);
          ...
          {
            biik.a(this.app, "name_plate_config_version", paramToServiceMsg.iItemCfgVer);
        ...
        biik.a(this.app, "last_pull_pay_rule", NetConnInfoCenter.getServerTime());
    ...
    bjqh.a().a("ClubInfoSvc.queryPrivExt", 100, paramFromServiceMsg.getBusinessFailCode(), this.app.getCurrentAccountUin(), 1000277, "[CMD:ClubInfoSvc.queryPrivExtfailed]", true);
    return paramBoolean;
  }
  ...
  private static void b(String paramString1, String arg1, PayRuleCfg paramPayRuleCfg)
  {
    ...
    paramPayRuleCfg = bnjr.a(paramPayRuleCfg);
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      bhmi.a(paramPayRuleCfg, paramString1.getAbsolutePath());
      return;
    }
  }
  ...
  public void a(UniGetReq paramUniGetReq, anui paramanui, boolean paramBoolean)
  {
    paramanui = createToServiceMsg("QCUniBusinessLogic.uniGet", paramanui, paramBoolean);
    paramUniGetReq.stLogin = a();
    paramanui.extraData.putSerializable("req", paramUniGetReq);
    send(paramanui);
  }
  
  public void a(UniSetReq paramUniSetReq, anui paramanui, boolean paramBoolean)
  {
    paramanui = createToServiceMsg("QCUniBusinessLogic.uniSet", paramanui, paramBoolean);
    paramUniSetReq.stLogin = a();
    paramanui.extraData.putSerializable("req", paramUniSetReq);
    send(paramanui);
  }
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ("ClubInfoSvc.queryPrivExt".equals(str))
    {
      ...
      {
        bhyu.jdField_a_of_type_Long = System.currentTimeMillis() / 1000L;
        bhyu.a((VAResourcesRsp)paramObject);
