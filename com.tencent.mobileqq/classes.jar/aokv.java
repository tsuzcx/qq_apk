...
public class aokv
{
  ...
  aoky jdField_a_of_type_Aoky = new aoky();
  aokz jdField_a_of_type_Aokz;
  ...
  aokv(QQAppInterface paramQQAppInterface, String paramString, aokz paramaokz)
  {
  ...
  private Pair<Boolean, Integer> a(String paramString, List<FullMessageSearchResult.SearchResultItem> paramList, RecentUser paramRecentUser, long paramLong, QQMessageFacade.Message paramMessage)
  {
    try
    {
      if (aola.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramRecentUser))
      {
        long l1 = SystemClock.uptimeMillis();
        paramString = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageProxy(paramRecentUser.getType()).a(paramRecentUser.uin, paramRecentUser.getType(), paramString, aola.jdField_a_of_type_Int, this);
        long l2 = SystemClock.uptimeMillis();
        if ((this.c == 2) || (this.c == 3)) {
          return new Pair(Boolean.valueOf(true), Integer.valueOf(2));
        }
        aoky localaoky = this.jdField_a_of_type_Aoky;
        localaoky.b += 1;
        localaoky = this.jdField_a_of_type_Aoky;
        localaoky.jdField_a_of_type_Long = (l2 - l1 + localaoky.jdField_a_of_type_Long);
      ...
      if ((this.b == 0) && (SystemClock.uptimeMillis() - paramLong > aola.c))
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.FullMessageSearchTask", 2, "queryHistroyByUser timeout! " + aola.c);
        }
    ...
    if (SystemClock.uptimeMillis() - paramLong > aola.b)
    {
      if (QLog.isColorLevel()) {
        QLog.d("Q.msg.FullMessageSearchTask", 2, "queryHistroyByUser timeout! " + aola.b);
      }
      return new Pair(Boolean.valueOf(true), Integer.valueOf(3));
    }
  ...
  private FullMessageSearchResult a(int paramInt)
  {
    ...
    Object localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProxyManager().a().getRecentList(false);
    if (localObject == null)
    {
    ...
    Collections.sort((List)localObject, new aokw(this));
    ...
    if (localObject != null)
    {
      localObject = ((anvk)localObject).f();
      if (QLog.isColorLevel()) {
        QLog.d("Q.msg.FullMessageSearchTask", 2, "friends size = " + ((List)localObject).size());
      }
      this.jdField_a_of_type_JavaUtilList.addAll((Collection)localObject);
      localObject = ((antp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.DISCUSSION_MANAGER)).a();
      if (QLog.isColorLevel()) {
  ...
  private FullMessageSearchResult a(long paramLong)
  {
    ...
    if (this.jdField_a_of_type_Int < this.jdField_a_of_type_JavaUtilList.size())
    {
      ...
      if ((localObject3 instanceof RecentUser))
      {
        ...
        localObject2 = acnh.a(((RecentUser)localObject1).uin, ((RecentUser)localObject1).getType());
      ...
      do
      {
        ...
        if ((localObject3 instanceof DiscussionInfo))
        {
          ...
          ((RecentUser)localObject2).displayName = ContactUtils.getDiscussionName(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, BaseApplicationImpl.getApplication(), ((DiscussionInfo)localObject1).uin);
          localObject1 = localObject2;
          break label129;
        }
        localObject1 = localObject2;
        ...
        localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getLastMessageLoadIfInexist(((RecentUser)localObject1).uin, ((RecentUser)localObject1).getType());
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqAppFmsFullMessageSearchResult.jdField_a_of_type_JavaUtilList.size() != i) {
          this.jdField_a_of_type_Aokz.a(this.jdField_a_of_type_ComTencentMobileqqAppFmsFullMessageSearchResult);
        }
      ...
      if (((Integer)((Pair)localObject2).second).intValue() == 3)
      {
        a();
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.FullMessageSearchTask", 2, "finish search scs=" + this.jdField_a_of_type_Aoky.toString() + ",searchType=" + this.b + ",searchStatus=" + this.c + ",searchFinFlag=" + ((Pair)localObject2).second);
        }
        if (this.jdField_a_of_type_Aoky.jdField_a_of_type_Int > 0)
        {
          localObject3 = new HashMap();
          ((HashMap)localObject3).put("queryMessageSize", Integer.toString(this.jdField_a_of_type_Aoky.jdField_a_of_type_Int));
          ((HashMap)localObject3).put("queryConversationSize", Integer.toString(this.jdField_a_of_type_Aoky.b));
          ((HashMap)localObject3).put("resultSize", Integer.toString(this.jdField_a_of_type_Aoky.c));
    ...
    {
      localStatisticCollector.collectPerformance(null, (String)localObject1, false, this.jdField_a_of_type_Aoky.jdField_a_of_type_Long, 0L, (HashMap)localObject3, null);
  ...
  public FullMessageSearchResult a()
  {
    ...
    //   0: aload_0
    //   1: monitorenter
    //   2: invokestatic 140	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   5: ifeq +29 -> 34
    //   8: ldc 142
    //   10: iconst_2
    ...
    //   24: aload_0
    //   25: invokevirtual 176	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   28: invokevirtual 158	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   31: invokestatic 162	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   34: aload_0
    //   35: getfield 39	aokv:c	I
    //   38: ifne +12 -> 50
    //   41: aload_0
    //   42: invokevirtual 440	aokv:c	()Lcom/tencent/mobileqq/app/fms/FullMessageSearchResult;
    //   45: astore_1
    //   46: aload_0
    //   47: monitorexit
    //   48: aload_1
    //   49: areturn
    //   50: aload_0
    //   51: getfield 39	aokv:c	I
    //   54: iconst_2
    //   55: if_icmpeq +11 -> 66
    //   58: aload_0
    //   59: getfield 39	aokv:c	I
    //   62: iconst_1
    //   63: if_icmpne +24 -> 87
    //   66: aload_0
    //   67: iconst_1
    //   68: putfield 39	aokv:c	I
    //   71: aload_0
    //   72: iconst_1
    //   73: putfield 37	aokv:b	I
    //   76: aload_0
    //   77: invokestatic 67	android/os/SystemClock:uptimeMillis	()J
    //   80: invokespecial 278	aokv:a	(J)Lcom/tencent/mobileqq/app/fms/FullMessageSearchResult;
    //   83: astore_1
    //   84: goto -38 -> 46
    //   87: aload_0
    //   88: getfield 39	aokv:c	I
    //   91: iconst_3
    //   92: if_icmpne +11 -> 103
    //   95: aload_0
    //   96: getfield 282	aokv:jdField_a_of_type_ComTencentMobileqqAppFmsFullMessageSearchResult	Lcom/tencent/mobileqq/app/fms/FullMessageSearchResult;
    //   99: astore_1
    //   100: goto -54 -> 46
    //   103: aconst_null
    //   104: astore_1
  ...
  public FullMessageSearchResult b()
  {
    ...
    //   39: if_icmpeq +11 -> 50
    //   42: aload_0
    //   43: getfield 39	aokv:c	I
    //   46: iconst_1
    //   47: if_icmpne +12 -> 59
    //   50: aload_0
    //   51: invokevirtual 448	aokv:a	()Lcom/tencent/mobileqq/app/fms/FullMessageSearchResult;
    //   54: astore_1
    //   55: aload_0
    //   56: monitorexit
    //   57: aload_1
    //   58: areturn
    //   59: aload_0
    //   60: getfield 39	aokv:c	I
    //   63: iconst_3
    //   64: if_icmpne +11 -> 75
    //   67: aload_0
    //   68: getfield 282	aokv:jdField_a_of_type_ComTencentMobileqqAppFmsFullMessageSearchResult	Lcom/tencent/mobileqq/app/fms/FullMessageSearchResult;
    //   71: astore_1
    //   72: goto -17 -> 55
    //   75: aload_0
    //   76: iconst_0
    //   77: invokespecial 450	aokv:a	(I)Lcom/tencent/mobileqq/app/fms/FullMessageSearchResult;
    //   80: astore_1
    //   81: goto -26 -> 55
    //   84: astore_1
    //   85: aload_0
  ...
  public void b(int paramInt)
  {
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.FullMessageSearchTask", 2, "finish search scs=" + this.jdField_a_of_type_Aoky.toString() + ",searchType=" + this.b + ",searchStatus=" + this.c + ",searchFinFlag=" + paramInt);
        }
        if ((this.jdField_a_of_type_Aoky.jdField_a_of_type_Int > 0) && (this.c == 3) && (paramInt == 1))
        {
          HashMap localHashMap = new HashMap();
          localHashMap.put("queryMessageSize", Integer.toString(this.jdField_a_of_type_Aoky.jdField_a_of_type_Int));
          localHashMap.put("queryConversationSize", Integer.toString(this.jdField_a_of_type_Aoky.b));
          localHashMap.put("resultSize", Integer.toString(this.jdField_a_of_type_Aoky.c));
          ...
          if (this.b == 1)
          {
            ...
            localStatisticCollector.collectPerformance(null, str1, true, this.jdField_a_of_type_Aoky.jdField_a_of_type_Long, 0L, localHashMap, null);
          }
        }
        else
        {
  ...
  public FullMessageSearchResult c()
  {
    ...
    //   41: aload_0
    //   42: iconst_1
    //   43: invokespecial 450	aokv:a	(I)Lcom/tencent/mobileqq/app/fms/FullMessageSearchResult;
    //   46: astore_1
    //   47: aload_0
    //   48: monitorexit
    //   49: aload_1
    ...
    //   64: if_icmpne +11 -> 75
    //   67: aload_0
    //   68: invokevirtual 448	aokv:a	()Lcom/tencent/mobileqq/app/fms/FullMessageSearchResult;
    //   71: astore_1
    //   72: goto -25 -> 47
    //   75: aload_0
    //   76: getfield 39	aokv:c	I
    //   79: iconst_3
    //   80: if_icmpne +11 -> 91
    //   83: aload_0
    //   84: getfield 282	aokv:jdField_a_of_type_ComTencentMobileqqAppFmsFullMessageSearchResult	Lcom/tencent/mobileqq/app/fms/FullMessageSearchResult;
    //   87: astore_1
    //   88: goto -41 -> 47
    //   91: aconst_null
    //   92: astore_1
