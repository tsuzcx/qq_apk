  ...
  extends qxr
{
  ...
  public nni(nnh paramnnh, View paramView, BaseData paramBaseData)
  {
  ...
  private void a(BaseData paramBaseData, Context paramContext, JSONObject paramJSONObject)
  {
    ...
    ViewFactory.findClickableViewListener(paramJSONObject, new nnj(this, paramContext, paramBaseData, paramJSONObject));
  }
  ...
  private void a(Container paramContainer, ProteusItemData paramProteusItemData)
  {
    if (paramContainer != null)
    {
      ...
      if (((paramProteusItemData instanceof AdData)) && (((AdData)paramProteusItemData).a != null) && (npa.a((AdData)paramProteusItemData)))
      {
        ...
        if ((localObject != null) && ((localObject instanceof pap)) && (((AdData)paramProteusItemData).a.a != null) && (!TextUtils.isEmpty(((AdData)paramProteusItemData).a.k))) {
          npa.a(paramContainer.getContext(), (ViewBase)localObject, ((AdData)paramProteusItemData).a.k, 10);
        }
        localObject = localViewBase.findViewBaseByName("id_inner_game_img1");
        if ((localObject != null) && ((localObject instanceof pap)) && (((AdData)paramProteusItemData).a.a != null) && (!TextUtils.isEmpty(((AdData)paramProteusItemData).a.a.d))) {
          npa.a(paramContainer.getContext(), (ViewBase)localObject, ((AdData)paramProteusItemData).a.a.d, 10);
        }
        localObject = localViewBase.findViewBaseByName("id_inner_game_img2");
        if ((localObject != null) && ((localObject instanceof pap)) && (((AdData)paramProteusItemData).a.a != null) && (!TextUtils.isEmpty(((AdData)paramProteusItemData).a.a.e))) {
          npa.a(paramContainer.getContext(), (ViewBase)localObject, ((AdData)paramProteusItemData).a.a.e, 10);
        }
        localViewBase = localViewBase.findViewBaseByName("id_inner_game_img3");
        if ((localViewBase != null) && ((localViewBase instanceof pap)) && (((AdData)paramProteusItemData).a.a != null) && (!TextUtils.isEmpty(((AdData)paramProteusItemData).a.a.f))) {
          npa.a(paramContainer.getContext(), localViewBase, ((AdData)paramProteusItemData).a.a.f, 10);
        }
      }
    }
  }
  ...
  public void a(BaseData paramBaseData1, BaseData paramBaseData2, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      if (nnh.a(this.jdField_a_of_type_Nnh) != null) {
        a(paramBaseData2, (Context)nnh.a(this.jdField_a_of_type_Nnh).get(), this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataProteusItemData.b);
      }
