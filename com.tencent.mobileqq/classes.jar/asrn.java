  ...
  implements alke
{
  ...
  WeakReference<asrz> jdField_b_of_type_JavaLangRefWeakReference;
  int d = 0;
  
  public asrn(Context paramContext, PicInfo paramPicInfo)
  {
    ...
    if ((paramContext instanceof QQAppInterface)) {
      this.jdField_a_of_type_Alkl = ((alkl)paramContext.getManager(180));
    }
    for (;;)
    {
  ...
  public View a(int paramInt, Handler paramHandler, asrz paramasrz)
  {
    ...
    this.jdField_b_of_type_JavaLangRefWeakReference = new WeakReference(paramasrz);
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      if (!bool1)
      {
        ...
        {
          bool1 = alkc.b(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.d);
          bool2 = bool1;
          if (bool1)
          {
            localURLImageView.setImageDrawable(URLDrawable.getDrawable(alkc.a(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.d), a(paramHandler)));
            bool2 = bool1;
          }
        }
      }
      if (!bool2) {
        if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.d))
        {
          ...
          if (this.jdField_a_of_type_Alkc.a(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.d)) {
            this.jdField_b_of_type_Int = 0;
          }
          paramasrz.a(paramInt, this.jdField_b_of_type_Int);
          label396:
          if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        ...
        paramHandler = axwd.a;
        break label186;
        localURLImageView.setImageDrawable(BaseApplicationImpl.getApplication().getResources().getDrawable(2130837854));
        this.d = 2;
        paramasrz.a(paramInt, false);
        break label396;
        this.jdField_b_of_type_Int = 0;
        this.d = 1;
        paramasrz.a(paramInt, true);
      }
    }
  }
  ...
  public void a()
  {
    if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.d))
    {
      ...
      if (!alkc.b(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.d)) {
        this.jdField_a_of_type_Alkc.a(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.d);
      }
    }
  }
  
  public void a(View paramView, int paramInt, asrz paramasrz)
  {
    boolean bool2 = true;
    ...
    if ((this.d != 1) && (this.d != 2) && (this.d != 3) && (this.d != 4))
    {
      ...
      if (this.jdField_b_of_type_Int > 0) {
        paramasrz.b(paramInt, this.jdField_b_of_type_Int / 100);
      }
  ...
  public void a(String paramString, int paramInt)
  {
    if (paramString.equals(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.d))
    {
      ...
      if ((this.jdField_b_of_type_JavaLangRefWeakReference != null) && (this.jdField_b_of_type_JavaLangRefWeakReference.get() != null)) {
        ((asrz)this.jdField_b_of_type_JavaLangRefWeakReference.get()).b(this.jdField_a_of_type_Int, paramInt);
      }
    }
  }
  ...
  public void a(String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    Object localObject = (asrz)this.jdField_b_of_type_JavaLangRefWeakReference.get();
    paramString = (URLImageView)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if (localObject != null)
    {
      ((asrz)localObject).a(this.jdField_a_of_type_Int, paramBoolean1);
      ((asrz)localObject).a(this.jdField_a_of_type_Int);
    }
    ...
    for (paramBoolean2 = true;; paramBoolean2 = false)
    {
      ...
      if (paramBoolean1)
      {
        ...
        if (alkc.b(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.d))
        {
          localObject = URLDrawable.getDrawable(alkc.a(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.d), a(paramString.getDrawable()));
      ...
      localObject = BaseApplicationImpl.getApplication().getResources().getDrawable(2130837854);
