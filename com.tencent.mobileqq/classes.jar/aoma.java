  ...
  implements Comparator<RecentBaseData>
{
  ...
  public aoma(QQAppInterface paramQQAppInterface)
  {
      ...
      else
      {
        ...
        for (;;)
        {
          ...
          if (localRecentUser.getType() == 3000)
          {
            ...
            DiscussionInfo localDiscussionInfo = ((antp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.DISCUSSION_MANAGER)).a(localRecentUser.uin);
