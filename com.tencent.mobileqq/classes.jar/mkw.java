...
public class mkw
{
  ...
  static
  {
    ...
    jdField_a_of_type_AndroidSupportV4UtilArrayMap.put("pskey", "[\"game.qq.com\",\"kg.qq.com\",\"id.qq.com\",\"qzone.qq.com\",\"qzone.com\",\"openmobile.qq.com\", \"tenpay.com\", \"buluo.qq.com\", \"docs.qq.com\"]");
  ...
  private mkw(Context paramContext)
  {
    ...
    this.jdField_a_of_type_OicqWlogin_sdkRequestWtTicketPromise = new mky(this);
    ...
    this.jdField_a_of_type_Mnt = new mnt(this.jdField_a_of_type_AndroidContentSharedPreferences);
    this.jdField_a_of_type_Mnu = new mnu(this.jdField_a_of_type_AndroidContentSharedPreferences, this.jdField_a_of_type_Mnt);
    this.jdField_a_of_type_Mnt.a(this.jdField_a_of_type_Mnu);
    FlatBuffersParser.f();
    k();
  ...
  public static mkw a()
  {
    if (jdField_a_of_type_Mkw == null) {}
    try
    {
      if (jdField_a_of_type_Mkw == null) {
        jdField_a_of_type_Mkw = new mkw(BaseApplication.getContext());
      }
      jdField_a_of_type_Mkw.a();
      if (!jdField_a_of_type_Mkw.a(true)) {
        jdField_a_of_type_Mkw.i();
      }
      return jdField_a_of_type_Mkw;
    }
    finally {}
  }
  
  public static mkw a(boolean paramBoolean)
  {
    if (jdField_a_of_type_Mkw == null) {}
    try
    {
      ...
      jdField_a_of_type_Mkw.a();
      jdField_a_of_type_Mkw.a(paramBoolean);
      return jdField_a_of_type_Mkw;
    }
    finally {}
  }
  ...
  private JSONArray a(String paramString)
  {
    ...
    //   20: areturn
    //   21: aload_0
    //   22: getfield 139	mkw:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   25: aload_1
    ...
    //   40: ifnonnull -22 -> 18
    //   43: aload_0
    //   44: getfield 139	mkw:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   47: astore 8
    //   49: aload 8
    //   51: monitorenter
    //   52: aload_0
    //   53: getfield 139	mkw:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   56: aload_1
    ...
    //   74: aload_0
    //   75: getfield 192	mkw:jdField_a_of_type_Mnu	Lmnu;
    //   78: aload_1
    //   79: invokevirtual 359	mnu:a	(Ljava/lang/String;)Lorg/json/JSONArray;
    //   82: astore 6
    //   84: aload 6
    //   86: ifnonnull +195 -> 281
    //   89: new 80	org/json/JSONArray
    //   92: dup
    //   93: getstatic 62	mkw:jdField_a_of_type_AndroidSupportV4UtilArrayMap	Landroid/support/v4/util/ArrayMap;
    //   96: aload_1
    ...
    //   188: astore 6
    //   190: aload_0
    //   191: getfield 139	mkw:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   194: aload_1
    //   195: aload 6
    //   197: invokevirtual 370	java/util/concurrent/ConcurrentHashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   200: pop
    //   201: aload_0
    //   202: getfield 141	mkw:jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   205: aload_1
    ...
    //   297: dup
    //   298: getstatic 62	mkw:jdField_a_of_type_AndroidSupportV4UtilArrayMap	Landroid/support/v4/util/ArrayMap;
    //   301: ldc 44
  ...
  private JSONObject a()
  {
    ...
    {
      localObject = this.jdField_a_of_type_Mnu.a();
  ...
  private JSONObject b()
  {
    ...
    {
      str = this.jdField_a_of_type_Mnu.b();
  ...
  /* Error */
  public java.lang.Boolean a(String paramString1, String paramString2)
  {
    // Byte code:
    //   0: aload_1
    //   1: ifnonnull +8 -> 9
    ...
    //   61: ldc 239
    //   63: ldc 239
    //   65: invokestatic 500	azld:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   68: ldc 161
    //   70: iconst_1
    //   71: ldc_w 502
    ...
    //   130: astore 5
    //   132: aload_0
    //   133: getfield 504	mkw:jdField_c_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   136: astore_1
    ...
    //   145: aload_0
    //   146: getfield 192	mkw:jdField_a_of_type_Mnu	Lmnu;
    //   149: invokevirtual 506	mnu:c	()Ljava/lang/String;
    //   152: astore 6
    //   154: aload 6
    //   156: ifnull +101 -> 257
    ...
    //   192: aload_0
    //   193: aload_1
    //   194: putfield 504	mkw:jdField_c_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   197: aload_1
    //   198: ldc_w 510
    ...
    //   227: aload 5
    //   229: invokestatic 515	mkw:b	(Ljava/lang/String;Ljava/lang/String;)Z
    //   232: ifeq +33 -> 265
    //   235: iconst_1
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    for (paramString1 = this.jdField_a_of_type_Mnt.a(localEditor, paramString1); paramString1 == null; paramString1 = this.jdField_a_of_type_Mnu.a(localEditor, paramString1)) {
      return;
    }
    ...
    if (TextUtils.isEmpty(paramString1))
    {
      ...
      localEditor.putString("qqVersion", "2013 8.2.6");
      ...
      awqx.b(null, "P_CliOper", "Pb_account_lifeservice", "", "webview_whitelist", "update_ok", 0, 1, 0, "", "", "", "");
    }
    for (;;)
    {
      localEditor.commit();
      ...
      return;
      this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(0);
      awqx.b(null, "P_CliOper", "Pb_account_lifeservice", "", "webview_whitelist", "update_failed", 0, 1, 0, "", "", "", "");
      if (QLog.isColorLevel()) {
  ...
  public boolean a(String paramString1, String paramString2)
  {
    ...
    if ("file".equals(str))
    {
      ...
      for (;;)
      {
        azld.a("webview", "file_js", paramString1, "", "", "");
    ...
    System.currentTimeMillis();
    int j = this.jdField_a_of_type_Mnu.a(localUri.getHost(), paramString2);
    if (mns.a(j)) {
      return true;
    }
    if (mns.b(j)) {
    ...
    if (rsv.a(paramString1)) {
      return (!TextUtils.isEmpty(paramString2)) && (rsv.a(paramString1, paramString2));
    }
    return false;
  }
  ...
  {
    return bbdc.a(paramJSONObject, "sonicWhiteList");
  }
      ...
      try
      {
        if (!TextUtils.isEmpty(paramString))
        {
          if ((this.jdField_b_of_type_OrgJsonJSONArray == null) && (!a()))
          {
            if (QLog.isColorLevel())
            {
              QLog.d("AuthorizeConfig", 2, "CgiConfig loadfromsp fail , url: " + mpw.b(paramString, new String[0]));
              return false;
            }
          }
          else
          {
            ...
            if ((this.jdField_b_of_type_OrgJsonJSONArray.length() != 0) && (!TextUtils.isEmpty(str1)))
            {
              ...
              if (j < k)
              {
                ...
                QLog.d("AuthorizeConfig", 2, "CgiConfig hit , url: " + mpw.b(paramString, new String[0]) + " domain: " + str2);
                break label247;
              }
            }
          }
    ...
    if ((localObject2 != null) && (localObject1 != null) && (((AppRuntime)localObject1).isLogin()))
    {
      ...
      if ((localObject2 != null) && (((JSONArray)localObject2).length() > 0))
      {
        ...
        if (j < ((JSONArray)localObject2).length())
        {
          ...
          {
            if (bbdc.a(localJSONObject, "X5Config"))
            {
      ...
      try
      {
        if (!TextUtils.isEmpty(paramString))
        {
          if ((this.jdField_c_of_type_OrgJsonJSONArray == null) && (!b()))
          {
            if (QLog.isColorLevel())
            {
              QLog.d("AuthorizeConfig", 2, "AsyncCheckConfig loadfromsp fail , url: " + mpw.b(paramString, new String[0]));
              return false;
            }
          }
          else
          {
            ...
            if ((k != 0) && (!TextUtils.isEmpty(str1)))
            {
              ...
              if (j < k)
              {
                ...
                QLog.d("AuthorizeConfig", 2, "AsyncCheckConfig hit , url: " + mpw.b(paramString, new String[0]) + " domain: " + str2);
                break label253;
              }
            }
          }
  ...
  public boolean c(String paramString1, String paramString2)
  {
    ...
    if ("file".equals(paramString1))
    {
      ...
      {
        azld.a("webview", "file_scheme", paramString1, "", "", "");
        QLog.e("AuthorizeConfig", 1, "action deprecated with file protocol");
        return false;
      }
    }
    ...
    for (;;)
    {
      try
      {
        paramString1 = this.jdField_a_of_type_Mnu.a();
        if (paramString1 == null)
        {
          try
          {
      ...
      try
      {
        if (!TextUtils.isEmpty(paramString))
        {
          if ((this.jdField_d_of_type_OrgJsonJSONArray == null) && (!c()))
          {
            if (QLog.isColorLevel())
            {
              QLog.d("AuthorizeConfig", 2, "SkipInputWarningConfig loadfromsp fail , url: " + mpw.b(paramString, new String[0]));
              return false;
            }
          }
          else
          {
            ...
            if ((k != 0) && (!TextUtils.isEmpty(str1)))
            {
              ...
              if (j < k)
              {
                ...
                QLog.d("AuthorizeConfig", 2, "SkipInputWarningConfig hit , url: " + mpw.b(paramString, new String[0]) + " domain: " + str2);
                break label253;
              }
            }
          }
  ...
  public boolean e()
  {
    ...
    //   11: aload_0
    //   12: iload_1
    //   13: putfield 132	mkw:jdField_a_of_type_Int	I
    //   16: invokestatic 888	mmz:d	()Ljava/lang/String;
    //   19: astore_3
    //   20: aload_3
    ...
    //   68: putfield 892	mkw:jdField_e_of_type_OrgJsonJSONArray	Lorg/json/JSONArray;
    //   71: invokestatic 894	mmz:e	()Ljava/lang/String;
    //   74: astore_3
    //   75: aload_3
    ...
    //   123: putfield 898	mkw:jdField_f_of_type_OrgJsonJSONArray	Lorg/json/JSONArray;
    //   126: iload_2
    //   127: iconst_m1
    //   128: if_icmpeq +138 -> 266
    //   131: aload_0
    //   132: getfield 892	mkw:jdField_e_of_type_OrgJsonJSONArray	Lorg/json/JSONArray;
    //   135: ifnull +131 -> 266
    //   138: aload_0
    //   139: getfield 898	mkw:jdField_f_of_type_OrgJsonJSONArray	Lorg/json/JSONArray;
    //   142: ifnull +124 -> 266
    //   145: iconst_1
    //   146: ireturn
    //   147: iconst_0
      ...
      try
      {
        if (!TextUtils.isEmpty(paramString))
        {
          if ((this.jdField_e_of_type_OrgJsonJSONArray == null) && (!e()))
          {
            if (QLog.isColorLevel())
            {
              QLog.d("AuthorizeConfig", 2, "forceHttpsConfig loadfromsp fail , url: " + mpw.b(paramString, new String[0]));
              return false;
            }
          }
          else
          {
            ...
            if ((k != 0) && (!TextUtils.isEmpty(str1)))
            {
              ...
              if (j < k)
              {
                ...
                QLog.d("AuthorizeConfig", 2, "forceHttpsConfig hit , url: " + mpw.b(paramString, new String[0]) + " domain: " + str2);
                break label253;
              }
            }
          }
      ...
      try
      {
        if (!TextUtils.isEmpty(paramString))
        {
          if ((this.jdField_f_of_type_OrgJsonJSONArray == null) && (!e()))
          {
            if (QLog.isColorLevel())
            {
              QLog.d("AuthorizeConfig", 2, "forceHttpsExcludeConfig loadfromsp fail , url: " + mpw.b(paramString, new String[0]));
              return false;
            }
          }
          else
          {
            ...
            if ((k != 0) && (!TextUtils.isEmpty(str1)))
            {
              ...
              if (j < k)
              {
                ...
                QLog.d("AuthorizeConfig", 2, "forceHttpsExcludeConfig hit , url: " + mpw.b(paramString, new String[0]) + " domain: " + str2);
                break label253;
              }
            }
          }
  ...
  public void g()
  {
    ...
    if (((amgp)alzw.a().a(585)).jdField_a_of_type_Int == 1)
    {
      Object localObject4 = a("pskey");
      localObject1 = new ArrayList(((Set)localObject4).size());
      ??? = new HashSet(20);
      Object localObject5 = WebViewConstant.DEFAULT_PSKEY_LIST;
      int k = localObject5.length;
      int j = 0;
      while (j < k)
      {
        ((HashSet)???).add(localObject5[j]);
        j += 1;
      }
      ...
      while (((Iterator)localObject4).hasNext())
      {
        ...
        if (!((HashSet)???).contains(localObject5)) {
  ...
  public boolean g(String paramString)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.i("AuthorizeConfig", 2, "isInSonicWhiteList: " + bool + ", url: " + mpw.b(paramString, new String[0]));
      }
      return bool;
  ...
  public void h()
  {
    ...
    } while ((!(localAppRuntime instanceof QQAppInterface)) || ((!localAppRuntime.isLogin()) && (!"com.tencent.mobileqq".equals(MobileQQ.getMobileQQ().getQQProcessName()))));
  ...
  public boolean i(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        paramString = this.jdField_a_of_type_Mnu.a();
        if (paramString == null)
        {
          try
          {
  ...
  public void j()
  {
    ...
    while (localObject1 != null)
    {
      ...
      if (localObject2 == null)
      {
        ...
        localObject1 = anah.a("download_FuncDev_webview", "", 0, null);
        anfc.a().b((Bundle)localObject1);
        localObject1 = localObject2;
      }
    }
