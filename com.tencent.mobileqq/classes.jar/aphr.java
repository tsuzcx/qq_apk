...
public final class aphr
  extends Animation
{
  static final WeakHashMap<View, aphr> jdField_a_of_type_JavaUtilWeakHashMap;
  ...
  public static aphr a(View paramView)
  {
    aphr localaphr2 = (aphr)jdField_a_of_type_JavaUtilWeakHashMap.get(paramView);
    aphr localaphr1;
    if (localaphr2 != null)
    {
      localaphr1 = localaphr2;
      if (localaphr2 == paramView.getAnimation()) {}
    }
    else
    {
      localaphr1 = new aphr(paramView);
      jdField_a_of_type_JavaUtilWeakHashMap.put(paramView, localaphr1);
    }
    return localaphr1;
  }
