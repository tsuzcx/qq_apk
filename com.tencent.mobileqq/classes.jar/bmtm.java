...
{
  private int jdField_a_of_type_Int = blik.jdField_a_of_type_Int;
  private bmtf jdField_a_of_type_Bmtf;
  private bmtg jdField_a_of_type_Bmtg;
  private bocy jdField_a_of_type_Bocy = new bocy();
  private MusicItemInfo jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo;
  private HashMap<Integer, bmtg> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private List<bmth> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  private ConcurrentHashMap<String, bgoe> jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  /* Error */
  private bmtg a(MusicItemInfo paramMusicItemInfo)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   9: if_icmpne +62 -> 71
    //   12: aload_0
    //   13: getfield 44	bmtm:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   16: iconst_1
    ...
    //   33: new 73	bmtg
    //   36: dup
    //   37: invokespecial 74	bmtg:<init>	()V
    //   40: astore_2
    //   41: aload_2
    //   42: aload_0
    //   43: getfield 49	bmtm:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   46: invokevirtual 77	bmtg:a	(Ljava/util/List;)V
    //   49: aload_0
    //   50: getfield 44	bmtm:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   53: iconst_1
    ...
    //   62: aload_2
    //   63: aload_1
    //   64: invokevirtual 84	bmtg:a	(Lcom/tencent/mobileqq/richmedia/capture/data/MusicItemInfo;)V
    //   67: aload_0
    //   68: monitorexit
    //   69: aload_2
    //   70: areturn
    ...
    //   76: if_icmpne -9 -> 67
    //   79: aload_0
    //   80: getfield 44	bmtm:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   83: iconst_2
    ...
    //   108: aload_2
    //   109: aload_0
    //   110: getfield 49	bmtm:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   113: invokevirtual 77	bmtg:a	(Ljava/util/List;)V
    //   116: aload_0
    //   117: getfield 44	bmtm:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   120: iconst_2
    ...
    //   129: aload_2
    //   130: aload_1
    //   131: invokevirtual 84	bmtg:a	(Lcom/tencent/mobileqq/richmedia/capture/data/MusicItemInfo;)V
    //   134: goto -67 -> 67
    //   137: astore_1
    //   138: aload_0
    //   139: monitorexit
  ...
  {
    if ((this.jdField_a_of_type_Bmtf != null) && (!this.jdField_a_of_type_Boolean) && ((this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo == null) || (this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.isMute() != paramMusicItemInfo.isMute()))) {
      this.jdField_a_of_type_Bmtf.a(paramMusicItemInfo.isMute());
    }
  }
  
  private void e()
  {
    if (this.jdField_a_of_type_Bmtg != null)
    {
      d();
      this.jdField_a_of_type_Bmtg.a();
    }
  }
  ...
  public int a()
  {
    int i = -1;
    if (a()) {
      i = this.jdField_a_of_type_Bmtg.a();
    }
    return i;
  }
    ...
    if (this.jdField_a_of_type_Bmtg != null)
    {
      if ((this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo != null) && (this.jdField_a_of_type_JavaUtilList != null))
      {
        ...
        while (localIterator.hasNext()) {
          ((bmth)localIterator.next()).a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo);
        }
      }
      this.jdField_a_of_type_Bmtg.b();
      d();
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Bmtf != null) {
      this.jdField_a_of_type_Bmtf.a(true);
    }
    a(-1, -1, paramInt);
  }
  
  public void a(bmtf parambmtf)
  {
    this.jdField_a_of_type_Bmtf = parambmtf;
    if ((!this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo != null) && (this.jdField_a_of_type_Bmtf != null)) {
      this.jdField_a_of_type_Bmtf.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.isMute());
    }
  }
  
  public void a(bmth parambmth)
  {
    if ((parambmth == null) || (this.jdField_a_of_type_JavaUtilList == null)) {
    ...
    {
      return;
      if (!this.jdField_a_of_type_JavaUtilList.contains(parambmth)) {
        break;
      }
    } while (!QLog.isColorLevel());
    QLog.d("QimMusicPlayer", 2, "addMusicPlayerSceneListener mListeners has listener");
    return;
    this.jdField_a_of_type_JavaUtilList.add(parambmth);
  }
  ...
  public void a(MusicItemInfo paramMusicItemInfo)
  {
    ...
    {
      localObject = (bgoe)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramMusicItemInfo.getLocalPath());
      if (localObject != null) {
        QQMusicDownloader.a((bgoe)localObject);
      }
    }
  ...
  public boolean a()
  {
    return (this.jdField_a_of_type_Bmtg != null) && (this.jdField_a_of_type_Bmtg.a());
  }
  
  public boolean a(int paramInt1, int paramInt2, int paramInt3)
  {
    MusicItemInfo localMusicItemInfo = ((QIMMusicConfigManager)bmql.a(2)).a(paramInt1, paramInt2);
  ...
  public boolean a(MusicItemInfo paramMusicItemInfo)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
      while (localIterator.hasNext()) {
        ((bmth)localIterator.next()).a(paramMusicItemInfo);
      }
    }
    c();
    ...
    this.jdField_a_of_type_Bmtg = a(paramMusicItemInfo);
    return true;
  }
  ...
  public boolean a(MusicItemInfo paramMusicItemInfo, bmte parambmte)
  {
    String str;
    ...
    if (!this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(str))
    {
      ...
      parambmte = new bmtl(this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap, this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap, parambmte);
      bgoe localbgoe = QQMusicDownloader.a(paramMusicItemInfo.mUrl, str, parambmte);
      if (localbgoe != null)
      {
        this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.put(str, localbgoe);
        QQMusicDownloader.a(localbgoe, parambmte);
  ...
  public boolean a(MusicItemInfo paramMusicItemInfo, boolean paramBoolean, int paramInt)
  {
    ...
    if (!b(paramMusicItemInfo)) {}
    while ((bbta.a().b()) || (c(paramMusicItemInfo))) {
      return false;
    }
  ...
  public void b(int paramInt)
  {
    ...
    while (this.jdField_a_of_type_Bmtg == null) {
      return;
    }
    this.jdField_a_of_type_Bmtg.c();
  }
  
  public void b(bmth parambmth)
  {
    if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.contains(parambmth))) {
      this.jdField_a_of_type_JavaUtilList.remove(parambmth);
    }
  }
  ...
  public boolean b()
  {
    ...
    int i = j;
    if (j == blik.jdField_a_of_type_Int) {
      i = blik.a();
    }
    QQFilterRenderManager localQQFilterRenderManager = blik.a(i);
  ...
  public void d()
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
        } while (this.jdField_a_of_type_Bocy == null);
        int j = this.jdField_a_of_type_Int;
        int i = j;
        if (j == blik.jdField_a_of_type_Int) {
          i = blik.a();
        }
        localQQFilterRenderManager = blik.a(i);
        if ((localMusicItemInfo.needPlay()) && (b()))
        {
          if (a()) {}
          for (i = a() - localMusicItemInfo.musicStart;; i = 0)
          {
            this.jdField_a_of_type_Bocy.a(localMusicItemInfo, i);
            if (localQQFilterRenderManager == null) {
              break;
            }
  ...
  public float getCurrentMusicGain()
  {
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          if ((this.jdField_a_of_type_Bocy != null) && (localMusicItemInfo.needPlay()) && (a()))
          {
            float f = this.jdField_a_of_type_Bocy.a(a() - localMusicItemInfo.musicStart);
            return f;
          }
        }
  ...
  public void onDestroy()
  {
    this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo = null;
    this.jdField_b_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo = null;
    this.jdField_a_of_type_Bmtf = null;
    this.jdField_a_of_type_JavaUtilList.clear();
    this.jdField_a_of_type_JavaUtilList = null;
    this.jdField_a_of_type_Bmtg = null;
    this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.clear();
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.clear();
    Iterator localIterator = this.jdField_a_of_type_JavaUtilHashMap.values().iterator();
    while (localIterator.hasNext()) {
      ((bmtg)localIterator.next()).f();
    }
    this.jdField_a_of_type_JavaUtilHashMap.clear();
    this.jdField_a_of_type_JavaUtilHashMap = null;
    this.jdField_a_of_type_Bocy.a();
    this.jdField_a_of_type_Bocy = null;
  }
