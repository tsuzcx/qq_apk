  ...
  implements SoLoadReport
{
  ...
  {
    azmz.a(paramHashMap, paramInt);
    azmz localazmz = azmz.a(BaseApplicationImpl.getContext());
    if (paramBoolean)
    {
      localazmz.a("", "loadSoNew", false, 0L, 0L, paramHashMap, "");
      return;
    }
    localazmz.a("", "loadSoOld", false, 0L, 0L, paramHashMap, "");
  }
  ...
  public void reportThrowable(Throwable paramThrowable, String paramString)
  {
    ...
    azmz.a(BaseApplicationImpl.getContext()).a("", "SoCountLimit", false, 0L, 0L, a(paramString, 0L), "");
  }
}
