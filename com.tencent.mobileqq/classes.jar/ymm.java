  ...
  implements BusinessObserver
{
  ...
  {
    if ((this.a.jdField_a_of_type_Bcpq != null) && (!this.a.jdField_a_of_type_AndroidAppActivity.isFinishing())) {
      this.a.jdField_a_of_type_Bcpq.dismiss();
    }
    if (!paramBoolean)
    {
      bdid.a().a(2131691576);
      if (this.a.jdField_a_of_type_Ymn != null) {
        this.a.jdField_a_of_type_Ymn.a(false);
      }
    }
    do
    {
      ...
      bdid.a().a(2131691576);
    } while (this.a.jdField_a_of_type_Ymn == null);
    this.a.jdField_a_of_type_Ymn.a(false);
    return;
    int j;
    for (;;)
    {
      try
      {
        ...
        if (j != 0)
        {
          bdht.a("LightAppUtil", "GETLightAppSettingCallBack failed,resultCode=" + j);
          bdid.a().a(2131691576);
          if (this.a.jdField_a_of_type_Ymn != null) {
            this.a.jdField_a_of_type_Ymn.a(false);
          }
          ...
          ymw.a(this.a.jdField_a_of_type_MqqAppAppRuntime, "Net_Get_LiteappSetting", 0, j, paramInt);
          return;
        }
      }
      ...
      try
      {
        ...
        bdid.a().a(2131691576);
        if ((this.a.jdField_a_of_type_Bcpq != null) && (this.a.jdField_a_of_type_Bcpq.isShowing()) && (this.a.jdField_a_of_type_AndroidAppActivity != null) && (!this.a.jdField_a_of_type_AndroidAppActivity.isFinishing())) {
          this.a.jdField_a_of_type_Bcpq.dismiss();
        }
        if (this.a.jdField_a_of_type_Ymn != null) {
          this.a.jdField_a_of_type_Ymn.a(true);
        }
        ymw.a(null, "Net_LiteApp_Setting", 0, 1, this.a.jdField_a_of_type_ComTencentDeviceDatadefDeviceInfo.productId);
        return;
      }
    ...
    for (;;)
    {
      if (paramInt < paramBundle.length())
      {
        ...
        for (;;)
        {
          if (!yml.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(Integer.valueOf(localLightAppSettingInfo.jdField_c_of_type_Int)))
          {
            yml.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(Integer.valueOf(localLightAppSettingInfo.jdField_c_of_type_Int), localLightAppSettingInfo);
            yml.jdField_a_of_type_JavaUtilArrayList.add(localLightAppSettingInfo);
          }
      ...
      {
        if ((this.a.c) || (yml.jdField_a_of_type_JavaUtilArrayList.size() <= 0)) {
          break;
        }
        ...
        ((yak)((QQAppInterface)paramBundle).a(51)).a(yml.jdField_a_of_type_JavaUtilArrayList);
        break;
        label909:
        ymw.a(null, "Net_Get_LiteappSetting", 0, j, paramInt);
        return;
        label920:
        paramInt = 0;
        break label223;
