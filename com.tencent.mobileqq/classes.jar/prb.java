  ...
  extends ViewBase
{
  ...
  public prb(VafContext paramVafContext)
  {
  ...
  private void a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      for (paramInt = this.c * paramInt;; paramInt = (paramInt - 1) * this.c)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131165390));
