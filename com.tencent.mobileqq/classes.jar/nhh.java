...
public class nhh
  extends akdo
{
  public nhh(AccountDetailActivity paramAccountDetailActivity) {}
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      new localnew = nfg.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(this.a.d);
      if (localnew != null)
      {
        this.a.jdField_a_of_type_Ned.a(localnew.b(), localnew.a);
        this.a.jdField_a_of_type_Ned.a(localnew.b());
      }
    }
    if (paramBoolean) {
      if (this.a.jdField_a_of_type_Ned.a() == 0)
      {
        paramBoolean = bool1;
        if (paramBoolean) {
          this.a.u();
    ...
    for (this.a.l = AccountDetailActivity.jdField_j_of_type_Int;; this.a.l = AccountDetailActivity.k) {
      ...
      do
      {
        this.a.jdField_a_of_type_Ned.b(this.a.l);
