  ...
  implements ISPlayerPreDownloader.Listener
{
  ...
  private final ConcurrentHashMap<Integer, nhi> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        localnhi = (nhi)((Map.Entry)localIterator.next()).getValue();
      } while (!localnhi.jdField_a_of_type_JavaLangString.equalsIgnoreCase(paramString));
      for (paramString = localnhi; paramString != null; paramString = null)
      {
  ...
  public void a(String paramString, long paramLong1, long paramLong2)
  {
    ...
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(Integer.valueOf(i), new nhi(i, paramString));
  }
  ...
  {
    Object localObject = (nhi)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt));
    StringBuilder localStringBuilder = new StringBuilder().append("onPrepareSuccess content:=");
    if (localObject != null) {}
    for (localObject = ((nhi)localObject).toString();; localObject = null)
    {
