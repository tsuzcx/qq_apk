...
{
  public abep(NotificationActivity paramNotificationActivity, String paramString1, int paramInt, String paramString2) {}
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          awqx.b(null, "P_CliOper", "Safe_AlertReport", "", "0X8007536", "0X8007536", this.jdField_a_of_type_Int, 0, this.b, "", "", "");
      ...
      try
      {
        ...
        ((AlertReport.ButtonAction)localObject).str_package_name.set(bdzl.c());
        ((AlertReport.ButtonAction)localObject).uint32_app_id.set(AppSetting.a());
        mmj.a(this.jdField_a_of_type_ComTencentMobileqqActivityNotificationActivity.app, ((AlertReport.ButtonAction)localObject).toByteArray(), 34, "SecuritySvc.AlertReport");
        awqx.b(null, "P_CliOper", "Safe_AlertReport", "", "0X8007536", "0X8007536", this.jdField_a_of_type_Int, 0, this.b, "", "", "");
        this.jdField_a_of_type_ComTencentMobileqqActivityNotificationActivity.finish();
