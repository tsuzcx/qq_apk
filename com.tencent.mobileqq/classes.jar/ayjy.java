  ...
  extends SpannableStringBuilder
{
  ...
  static
  {
    jdField_a_of_type_AndroidTextEditable$Factory = new ayjz();
  }
  
  public ayjy(CharSequence paramCharSequence, int paramInt)
  {
  ...
  {
    if ((paramCharSequence instanceof ayju)) {
      return ((ayju)paramCharSequence).a();
    }
    return new ayju(paramCharSequence, paramInt).a();
  }
  ...
  public SpannableStringBuilder replace(int paramInt1, int paramInt2, CharSequence paramCharSequence, int paramInt3, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      i = paramInt2;
      localObject = new ayju(paramCharSequence, this.jdField_a_of_type_Int).a();
