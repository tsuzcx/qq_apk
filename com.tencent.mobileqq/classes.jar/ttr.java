  ...
  implements View.OnClickListener
{
  ...
  private final sps jdField_a_of_type_Sps = (sps)sqg.a(15);
  protected tci a;
  private tla jdField_a_of_type_Tla;
  private tlj jdField_a_of_type_Tlj;
  private tuf jdField_a_of_type_Tuf;
  private tug jdField_a_of_type_Tug;
  private final uje jdField_a_of_type_Uje = (uje)sqg.a(11);
  ...
  public ttr(ViewGroup paramViewGroup)
  {
  ...
  private void a(Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    biys.a(paramActivity, paramString6, paramLocalMediaInfo, 0, (int)paramLocalMediaInfo.mDuration, 118, 10002, 0, null, null, false, 3);
  }
  ...
  private void a(VideoListFeedItem paramVideoListFeedItem)
  {
    ...
    if (paramVideoListFeedItem.mHadLike == 1) {
      this.jdField_a_of_type_ComTencentBizQqstoryViewPressDarkImageView.setImageResource(2130845475);
    }
    while (paramVideoListFeedItem.mLikeCount > 0)
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(vms.a(paramVideoListFeedItem.mLikeCount));
      return;
      this.jdField_a_of_type_ComTencentBizQqstoryViewPressDarkImageView.setImageResource(2130845791);
    }
    this.jdField_a_of_type_AndroidWidgetTextView.setText(ajjy.a(2131635388));
  }
  ...
  private void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    agak localagak = agak.a(b().getApplicationContext());
    System.currentTimeMillis();
    localagak.a(new ttx(this, paramString3, paramString4, paramString2, paramString5, paramString6, paramString1, localLocalMediaInfo), localLocalMediaInfo);
  }
  ...
  private void b(VideoListFeedItem paramVideoListFeedItem)
  {
    ...
    {
      this.jdField_b_of_type_AndroidWidgetTextView.setText(vms.a(paramVideoListFeedItem.mCommentCount));
      return;
    }
    this.jdField_b_of_type_AndroidWidgetTextView.setText(ajjy.a(2131635391));
  }
  ...
  private void d()
  {
    ...
    if (((Boolean)localspz.b("first_clk_forward", Boolean.valueOf(true))).booleanValue())
    {
      VideoViewVideoHolder localVideoViewVideoHolder = ((StoryPlayerGroupHolder)a()).a();
      bafb localbafb = babr.a(b(), 230);
      localbafb.setTitle(ajjy.a(2131635389)).setMessage(ajjy.a(2131635382)).setPositiveButton(ajjy.a(2131635390), new ttv(this)).setOnDismissListener(new ttu(this, localVideoViewVideoHolder));
      localbafb.show();
      if (localVideoViewVideoHolder != null) {
        localVideoViewVideoHolder.c(true);
      }
      localspz.b("first_clk_forward", Boolean.valueOf(false));
      urp.a("play_video", "exp_window", 0, 0, new String[0]);
    }
    for (;;)
    {
      urp.a("play_video", "clk_repost", 0, 0, new String[] { "", "", "", this.jdField_a_of_type_Tnz.jdField_a_of_type_JavaLangString });
      return;
      e();
    }
  }
  ...
  private void e()
  {
    ...
    Object localObject2 = (sqs)sqg.a(2);
    ...
    Object localObject1 = this.jdField_a_of_type_Tnz.a();
    localObject2 = ((sqs)localObject2).b(localStoryVideoItem.mOwnerUid);
    ...
    for (;;)
    {
      urp.a("share", "clk_video", 0, 0, new String[] { localStoryVideoItem.mVid });
      return;
      localObject1 = ((VideoListFeedItem)localObject1).feedId;
      break;
      label171:
      a(b().getString(2131654838), true);
      this.jdField_a_of_type_Sif.a(localStoryVideoItem.mVid, 0, true, new ttw(this, localVideoViewVideoHolder, localStoryVideoItem, (QQUserUIItem)localObject2, (String)localObject1));
      if (localVideoViewVideoHolder != null) {
        localVideoViewVideoHolder.c(true);
      }
  ...
  {
    new tts(this);
    this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131313676);
    this.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
    this.jdField_c_of_type_AndroidViewView = paramView.findViewById(2131313677);
    this.jdField_c_of_type_AndroidViewView.setOnClickListener(this);
    this.d = paramView.findViewById(2131303512);
    this.d.setOnClickListener(this);
    this.jdField_a_of_type_ComTencentBizQqstoryViewPressDarkImageView = ((PressDarkImageView)paramView.findViewById(2131303518));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131303516));
    this.jdField_e_of_type_AndroidViewView = paramView.findViewById(2131298878);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131298911));
    this.jdField_b_of_type_ComTencentBizQqstoryViewPressDarkImageView = ((PressDarkImageView)paramView.findViewById(2131298924));
  ...
  {
    paramMap.put(new tuc(this), "");
    paramMap.put(new tua(this), "");
    paramMap.put(new tub(this), "");
    paramMap.put(new tud(this), "");
    paramMap.put(new ttz(this), "");
    paramMap.put(new tue(this), "");
    this.jdField_a_of_type_Tuf = new tuf(this);
    a(this.jdField_a_of_type_Tuf);
  }
  ...
  public void a(@NonNull tnz paramtnz, @NonNull StoryVideoItem paramStoryVideoItem)
  {
    ...
    VideoListFeedItem localVideoListFeedItem = (VideoListFeedItem)this.jdField_a_of_type_Uje.a(paramtnz.jdField_b_of_type_JavaLangString, true);
    Object localObject;
    boolean bool1;
    boolean bool2;
    if ((!paramStoryVideoItem.isUploadSuc()) || (localVideoListFeedItem == null))
    {
      ...
      {
        urk.d((String)localObject, "hide BottomWidget because uploading=%s, no-feed=%s , feed id = %s", new Object[] { Boolean.valueOf(bool1), Boolean.valueOf(bool2), paramtnz.jdField_b_of_type_JavaLangString });
        k();
        return;
        bool1 = false;
        break;
    ...
    if (TextUtils.equals(this.jdField_c_of_type_JavaLangString, paramtnz.jdField_a_of_type_JavaLangString))
    {
      ...
      localObject = ((sqs)sqg.a(2)).c(paramStoryVideoItem.mOwnerUid);
    ...
    for (int m = 1;; m = 0)
    {
      ...
      urp.a("play_video", "exp_repost", 0, 0, new String[] { "", "", "", paramtnz.jdField_a_of_type_JavaLangString });
      return;
      ...
      {
        i = 1;
        urk.d(this.jdField_b_of_type_JavaLangString, "show BottomWidget because friend and showBottomWidgetFlag=3");
        break label435;
      }
      i = 0;
      urk.d(this.jdField_b_of_type_JavaLangString, "hide BottomWidget");
      break label435;
  ...
  {
    return (paramtnz.jdField_a_of_type_Ssm == null) || (paramtnz.jdField_a_of_type_Ssm.a != 13);
  }
  ...
  public boolean d()
  {
    ...
    for (;;)
    {
      ...
      tnz localtnz = this.jdField_a_of_type_Tnz;
      StoryVideoItem localStoryVideoItem = localtnz.a();
      VideoListFeedItem localVideoListFeedItem = localtnz.a();
      int i;
      boolean bool;
      if (localStoryVideoItem != null)
      {
        localObject = ((sqs)localObject).b(localStoryVideoItem.mOwnerUid);
        if ((localObject == null) || (!((QQUserUIItem)localObject).isVip)) {
          break label309;
        }
        i = 1;
        if (((localObject != null) && (((QQUserUIItem)localObject).isMe())) && ((this.jdField_a_of_type_Tjs == null) || (!(this.jdField_a_of_type_Tjs instanceof tkg)))) {
          break label348;
        }
        ...
        l = ((ssm)localObject).a(localStoryVideoItem.mVid);
      }
      for (;;)
      {
        ...
        for (localObject = ((MsgTabPlayInfo)((OpenPlayerBuilder.Data)localObject).mInfo).nodeUnionId;; localObject = null)
        {
          ...
          for (localObject = String.valueOf(l);; localObject = String.valueOf(urp.a((String)localObject, localVideoListFeedItem)))
          {
            urp.a("play_video", "dbl_like", i, j, new String[] { "", localObject, "", localtnz.jdField_a_of_type_JavaLangString });
            return true;
            localObject = null;
            break;
            i = 0;
  ...
  public void g()
  {
    ...
    if (this.jdField_a_of_type_Tlj != null) {
      this.jdField_a_of_type_Tlj.a();
    }
    if (this.jdField_a_of_type_Tuf != null) {
      b(this.jdField_a_of_type_Tuf);
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    Object localObject2 = this.jdField_a_of_type_Tnz.a();
    ...
    {
      i = 1;
      bool5 = tfy.a(localStoryVideoItem);
      bool2 = false;
      l = 0L;
      ...
      l = ((ssm)localObject1).a(localStoryVideoItem.mVid);
    }
    for (;;)
    {
      label265:
      ...
      case 2131313677: 
        for (;;)
        {
          ...
          bbmy.a(tfy.a(), 1, ajjy.a(2131635386), 0).a();
          return;
          i = 0;
          break;
          bool2 = true;
        ...
        if (this.jdField_a_of_type_Tlj == null) {
          this.jdField_a_of_type_Tlj = new tlj();
        }
        paramView = ajjy.a(2131635387);
        ...
        while (localQQUserUIItem == null)
        {
          ...
          if ((((OpenPlayerBuilder.Data)localObject2).mInfo instanceof MsgTabPlayInfo)) {
            bool1 = stf.a(QQStoryContext.a()).a(((MsgTabPlayInfo)((OpenPlayerBuilder.Data)localObject2).mInfo).nodeUnionId);
          }
          paramView = paramView + ajjy.a(2131635384);
          this.jdField_a_of_type_Tla = new tla(b(), this.jdField_a_of_type_Tnz.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Tlj, paramView, 4444, bool2, bool1);
          this.jdField_a_of_type_Tla.show();
          this.jdField_a_of_type_Tla.setOnDismissListener(new ttt(this, (VideoViewVideoHolder)localObject1));
          if (!(this.jdField_a_of_type_Tjs instanceof tkg)) {
            break label1204;
          }
          paramView = ((tkg)this.jdField_a_of_type_Tjs).jdField_a_of_type_Ssm;
          if (!bool1) {
            break label1204;
          }
          ...
          localObject1 = "2";
          urp.a("play_video", "input_reply", j, 0, new String[] { paramView, localObject1, "", localStoryVideoItem.mVid });
          return;
        }
      ...
      for (;;)
      {
        ...
        {
          paramView = ((sqo)sqg.a(23)).a(localQQUserUIItem, paramView, false, true);
          break label338;
        }
        ...
        {
          urp.a("play_video", "clk_reply", j, 1, new String[] { paramView, localObject1, "", localStoryVideoItem.mVid });
          return;
          paramView = "1";
          break;
        }
        ...
        for (;;)
        {
          if (localObject2 != null)
          {
            ...
            if (((VideoListFeedItem)localObject2).mHadLike == 1)
            {
              ...
              j = 106;
              label915:
              snm.a((CommentLikeFeedItem)localObject2, bool4, k, j);
              i();
            ...
            {
              urp.a("play_video", paramView, j, k, new String[] { localObject1, localObject2, String.valueOf(localStoryVideoItem.mOwnerUid), this.jdField_a_of_type_Tnz.jdField_a_of_type_JavaLangString });
              return;
              bool3 = false;
              break;
              ...
              paramView = "like";
              break label992;
              j = urp.a((String)localObject1, (VideoListFeedItem)localObject2);
              break label1001;
              localObject1 = "1";
              break label1016;
            }
