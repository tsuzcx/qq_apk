...
public class abrv
  extends absc
{
  abrr jdField_a_of_type_Abrr = new abrr();
  abru jdField_a_of_type_Abru = new abru();
  private final bdzm jdField_a_of_type_Bdzm = new abrw(this, Looper.getMainLooper());
  private final ArrayList<abrx> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private Set<Long> jdField_a_of_type_JavaUtilSet = new HashSet(10);
  private ConcurrentHashMap<String, absa> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap(20);
  ...
  private void a(long paramLong1, String paramString, long paramLong2, int paramInt)
  {
    ...
    {
      paramString = new absa(this, paramString, paramLong2, paramInt, "", 0L);
  ...
  {
    absa localabsa = (absa)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(paramSession.uSessionID));
    if (localabsa == null) {
      return;
    }
    Object localObject1;
    Object localObject2;
    if (paramSession.actionInfo.strServiceName.equalsIgnoreCase(abux.e))
    {
      this.jdField_a_of_type_Abru.a(paramSession, localabsa.jdField_a_of_type_JavaLangString, localabsa.jdField_a_of_type_Long, localabsa.jdField_a_of_type_Int, paramBoolean);
      localObject1 = BaseApplicationImpl.getApplication().getRuntime();
      if ((localObject1 instanceof QQAppInterface))
      {
        localObject1 = (QQAppInterface)localObject1;
        localObject2 = ((abqn)((QQAppInterface)localObject1).a(51)).a(Long.parseLong(localabsa.jdField_a_of_type_JavaLangString));
    ...
    for (int i = ((DeviceInfo)localObject2).productId;; i = 0)
    {
      ...
      {
        int j;
        if (paramSession.actionInfo.strServiceName.compareTo(abux.f) == 0) {
          if (paramBoolean)
          {
            j = 0;
            accz.a((AppRuntime)localObject1, l, "Net_SendMsg_Audio", 0, j, i);
            localObject1 = ((QQAppInterface)localObject1).getHandler(Conversation.class);
            if (localObject1 != null) {
              ((MqqHandler)localObject1).sendEmptyMessage(1009);
            }
            localObject1 = this.jdField_a_of_type_Bdzm.obtainMessage();
            localObject2 = new abrz(this);
            if (!paramBoolean) {
              break label364;
            }
          }
        ...
        for (i = 1003;; i = 1005)
        {
          ((abrz)localObject2).jdField_a_of_type_Int = i;
          ((abrz)localObject2).jdField_a_of_type_Long = localabsa.jdField_a_of_type_Long;
          ((Message)localObject1).obj = localObject2;
          this.jdField_a_of_type_Bdzm.sendMessageDelayed((Message)localObject1, 0L);
          this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(String.valueOf(paramSession.uSessionID));
          return;
          if (!paramSession.actionInfo.strServiceName.equalsIgnoreCase(abux.f)) {
            break;
          }
          this.jdField_a_of_type_Abrr.a(paramSession, localabsa.jdField_a_of_type_JavaLangString, localabsa.jdField_a_of_type_Long, localabsa.jdField_a_of_type_Int, paramBoolean);
          break;
          j = 1;
          break label157;
          if (paramSession.actionInfo.strServiceName.compareTo(abux.e) != 0) {
            break label170;
          }
          if (paramBoolean) {}
          for (j = 0;; j = 1)
          {
            accz.a((AppRuntime)localObject1, l, "Net_SendMsg_Video", 0, j, i);
            break;
          }
        }
      }
  ...
  private void c(Session paramSession)
  {
    ...
    if ((localObject instanceof QQAppInterface))
    {
      ...
      MessageForDevShortVideo localMessageForDevShortVideo = (MessageForDevShortVideo)bbzh.a(-4503);
  ...
  public String a(DataPoint paramDataPoint)
  {
    for (;;)
    {
      try
      {
        ...
        long l1 = ((JSONObject)localObject1).optLong("msg_time", bbyp.a());
        ...
        if (TextUtils.isEmpty(str1))
        {
          ...
          if ((localObject2 instanceof QQAppInterface))
          {
            ...
            MessageForDevPtt localMessageForDevPtt = (MessageForDevPtt)bbzh.a(-4501);
  ...
  public void a(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      paramBundle = (absa)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(i));
    } while (paramBundle == null);
    this.jdField_a_of_type_Abrr.a((Session)localObject, paramBundle.jdField_a_of_type_JavaLangString, paramBundle.jdField_a_of_type_Long, paramBundle.jdField_a_of_type_Int, f);
    Object localObject = this.jdField_a_of_type_Bdzm.obtainMessage();
    abrz localabrz = new abrz(this);
    localabrz.jdField_a_of_type_Int = 1002;
    localabrz.jdField_a_of_type_Float = f;
    localabrz.jdField_a_of_type_Long = paramBundle.jdField_a_of_type_Long;
    ((Message)localObject).obj = localabrz;
    this.jdField_a_of_type_Bdzm.sendMessageDelayed((Message)localObject, 0L);
  }
  
  void a(Message paramMessage)
  {
    if (QLog.isColorLevel()) {
      QLog.d("DeviceAVFileMsgObserver", 2, "handleMessage" + ((abrz)paramMessage.obj).jdField_a_of_type_Long + " status " + paramMessage.what + "retCode " + paramMessage.arg1);
    }
    int i = 0;
    if (i < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      Object localObject = (abrx)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      View localView = ((abrx)localObject).a();
      localObject = ((abrx)localObject).a();
      if ((localView != null) && (localObject != null)) {
        ((abry)localObject).a(localView, (abrz)paramMessage.obj);
      }
      for (;;)
      {
        i += 1;
  ...
  public void a(View paramView, abry paramabry)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (localIterator.hasNext())
    {
      abrx localabrx = (abrx)localIterator.next();
      if (localabrx.a() == paramView)
      {
        localabrx.b = new WeakReference(paramabry);
        return;
      }
    }
    this.jdField_a_of_type_JavaUtilArrayList.add(new abrx(this, paramView, paramabry));
  }
  ...
  public void a(MessageForDevPtt paramMessageForDevPtt)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        {
          paramMessageForDevPtt = new absa(this, paramMessageForDevPtt.frienduin, paramMessageForDevPtt.uniseq, paramMessageForDevPtt.istroop, "", 0L);
  ...
  public void a(Session paramSession)
  {
    ...
    if ((!paramSession.bSend) && (paramSession.actionInfo.strServiceName.equalsIgnoreCase(abux.e))) {
      c(paramSession);
    }
  }
  ...
  public void a(Session paramSession, float paramFloat)
  {
    ...
    if (localabsa != null)
    {
      ...
      this.jdField_a_of_type_Abru.a(paramSession, localabsa.jdField_a_of_type_JavaLangString, localabsa.jdField_a_of_type_Long, localabsa.jdField_a_of_type_Int, paramFloat);
      localMessage = this.jdField_a_of_type_Bdzm.obtainMessage();
      localabrz = new abrz(this);
    ...
    label165:
    label205:
    for (localabrz.jdField_a_of_type_Int = 1002;; localabrz.jdField_a_of_type_Int = 2002)
    {
      localabrz.jdField_a_of_type_Float = paramFloat;
      localabrz.jdField_a_of_type_Long = localabsa.jdField_a_of_type_Long;
      localMessage.obj = localabrz;
      this.jdField_a_of_type_Bdzm.sendMessageDelayed(localMessage, 0L);
      return;
      if (!paramSession.actionInfo.strServiceName.equalsIgnoreCase(abux.f)) {
        break;
      }
      this.jdField_a_of_type_Abrr.a(paramSession, localabsa.jdField_a_of_type_JavaLangString, localabsa.jdField_a_of_type_Long, localabsa.jdField_a_of_type_Int, paramFloat);
      break;
    }
  }
  ...
  public void a(Session paramSession, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      localabsa = (absa)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(paramSession.uSessionID));
    } while (localabsa == null);
    label135:
    Object localObject1;
    Object localObject2;
    if (paramSession.actionInfo.strServiceName.equalsIgnoreCase(abux.e))
    ...
    for (int i = 2003;; i = 2005)
    {
      ...
      this.jdField_a_of_type_Bdzm.sendMessageDelayed((Message)localObject1, 0L);
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(String.valueOf(paramSession.uSessionID));
      this.jdField_a_of_type_JavaUtilSet.remove(Long.valueOf(localabsa.jdField_a_of_type_Long));
      if (!paramBoolean) {
        break label439;
      }
      this.b.remove(Long.valueOf(localabsa.jdField_a_of_type_Long));
      return;
      if ((paramSession.actionInfo.strServiceName.equalsIgnoreCase(abux.f)) || (!paramSession.actionInfo.strServiceName.equalsIgnoreCase(abux.g))) {
        break label135;
      }
      localObject1 = BaseApplicationImpl.getApplication().getRuntime();
      if (!(localObject1 instanceof QQAppInterface)) {
      ...
      localObject1 = (QQAppInterface)localObject1;
      localObject2 = ((QQAppInterface)localObject1).a().a(localabsa.jdField_a_of_type_JavaLangString, localabsa.jdField_a_of_type_Int, localabsa.jdField_a_of_type_Long);
      if (localObject2 == null) {
        break;
      }
      ...
      if (paramBoolean) {}
      for (localMessageForDevPtt.fileSize = atvo.a(paramSession.strFilePathSrc);; localMessageForDevPtt.fileSize = -1L)
      {
        localMessageForDevPtt.msg = localMessageForDevPtt.getSummary();
        localMessageForDevPtt.serial();
    ...
    label439:
    this.b.put(Long.valueOf(localabsa.jdField_a_of_type_Long), Long.valueOf(bbyp.a()));
  }
  
  public void a(MessageRecord paramMessageRecord, float paramFloat)
  {
    Message localMessage = this.jdField_a_of_type_Bdzm.obtainMessage();
    abrz localabrz = new abrz(this);
    localabrz.jdField_a_of_type_Int = 1002;
    localabrz.jdField_a_of_type_Long = paramMessageRecord.uniseq;
    localabrz.jdField_a_of_type_Float = paramFloat;
    localMessage.obj = localabrz;
    this.jdField_a_of_type_Bdzm.sendMessageDelayed(localMessage, 0L);
  }
  ...
  public void a(MessageRecord paramMessageRecord, Boolean paramBoolean)
  {
    ...
    {
      i = 1003;
      localabrz.jdField_a_of_type_Int = i;
      localabrz.jdField_a_of_type_Long = paramMessageRecord.uniseq;
      if (!paramBoolean.booleanValue()) {
        break label89;
      }
  ...
  public void a(String paramString1, String paramString2, long paramLong1, long paramLong2, int paramInt1, int paramInt2)
  {
    ...
    {
      localObject1 = (QQAppInterface)localObject1;
      localObject2 = (abqn)((QQAppInterface)localObject1).a(51);
      if ((!paramString1.equalsIgnoreCase(abux.f)) || (localObject2 == null) || (!((abqn)localObject2).b(paramLong1))) {
        break label192;
      }
      localObject1 = new Session();
      ((Session)localObject1).uSessionID = ((abqn)localObject2).a(paramLong1, paramString2, paramInt2);
      ((Session)localObject1).strFilePathSrc = paramString2;
      ((Session)localObject1).uFileSizeSrc = atvo.a(paramString2);
      ...
      paramString2 = new absa(this, String.valueOf(paramLong1), paramLong2, paramInt1, paramString2, ((Session)localObject1).uFileSizeSrc);
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(localObject2, paramString2);
      label154:
      if (!bgnt.d(BaseApplication.getContext()))
      {
        if (!paramString1.equalsIgnoreCase(abux.e)) {
          break label238;
        }
        this.jdField_a_of_type_Abru.a((Session)localObject1, String.valueOf(paramLong1), paramLong2, paramInt1, false);
      }
    }
    label192:
    label221:
    label238:
    while (!paramString1.equalsIgnoreCase(abux.f))
    {
      return;
    ...
    this.jdField_a_of_type_Abrr.a((Session)localObject1, String.valueOf(paramLong1), paramLong2, paramInt1, false);
  }
  ...
  public boolean a(long paramLong)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (((absa)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).jdField_a_of_type_Long == paramLong) {
        return true;
      }
    }
    return false;
  ...
  public void b(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      localabsa = (absa)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(paramBundle.uSessionID));
    } while (localabsa == null);
    paramBundle.strFilePathSrc = localabsa.jdField_b_of_type_JavaLangString;
    paramBundle.uFileSizeSrc = localabsa.jdField_b_of_type_Long;
    Object localObject1 = this.jdField_a_of_type_Abrr;
    Object localObject2 = localabsa.jdField_a_of_type_JavaLangString;
    long l = localabsa.jdField_a_of_type_Long;
    int j = localabsa.jdField_a_of_type_Int;
    if (i == 0)
    {
      ((abrr)localObject1).a(paramBundle, (String)localObject2, l, j, bool);
      localObject1 = BaseApplicationImpl.getApplication().getRuntime();
      if ((localObject1 instanceof QQAppInterface))
      {
        localObject1 = (QQAppInterface)localObject1;
  ...
  public void b(Session paramSession)
  {
    ...
    abrz localabrz = new abrz(this);
    if (paramSession.bSend) {}
    for (localabrz.jdField_a_of_type_Int = 1001;; localabrz.jdField_a_of_type_Int = 2001)
    {
      localabrz.jdField_a_of_type_Long = localabsa.jdField_a_of_type_Long;
      localMessage.obj = localabrz;
      this.jdField_a_of_type_Bdzm.sendMessageDelayed(localMessage, 0L);
