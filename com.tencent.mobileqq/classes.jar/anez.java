...
class anez
  implements nwq
{
  anez(aney paramaney, StringBuilder paramStringBuilder, String paramString) {}
  
  public boolean a(ZipEntry paramZipEntry)
  {
    if (paramZipEntry.isDirectory())
    {
      if ((this.jdField_a_of_type_Aney.a != null) && (this.jdField_a_of_type_Aney.a.length > 0))
      {
        localObject = this.jdField_a_of_type_Aney.a;
