...
public class anez
{
  public static FrameworkView a(Context paramContext, ande paramande, blhq paramblhq, amzn paramamzn, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    for (;;)
    {
      paramContext.a(paramande, paramblhq, paramamzn, paramStartCheckParam);
      return paramContext;
      paramContext = new QzoneGameFloatView(paramContext, paramStartCheckParam);
      continue;
  ...
  public static FrameworkView a(Context paramContext, ande paramande, blhq paramblhq, CmGameStartChecker.StartCheckParam paramStartCheckParam, int paramInt)
  {
    switch (paramInt)
    {
    default: 
    ...
    for (;;)
    {
      paramContext.a(paramande, paramblhq, null, paramStartCheckParam);
      return paramContext;
      paramContext = new CmGameGuideView(paramContext, paramStartCheckParam);
      continue;
