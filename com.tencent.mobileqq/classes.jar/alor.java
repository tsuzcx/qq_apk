  ...
  extends aluc
{
  protected void a()
  {
    ...
    {
      f1 = alwk.a().d;
      if ((f2 >= f1) && (alwk.a().c) && (this.a.a == null))
      {
      ...
      localHashMap.put("ramSize", String.valueOf(bdgk.d() / 1024L));
  ...
  protected void b(String paramString)
  {
    ...
    BaseApplicationImpl.sApplication.getRuntime().onGuardEvent(2, alua.a().a, 0L);
