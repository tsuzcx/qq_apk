  ...
  implements AdIPCManager.Adapter
{
  public AdIPCManager.Result receive(String paramString, AdIPCManager.Params paramParams)
  {
    ...
    for (;;)
    {
      ...
      yny.b("GdtIPCAdapter", String.format("receive action:%s result:%b", new Object[] { paramString, Boolean.valueOf(bool) }));
      return localResult1;
  ...
  public AdIPCManager.Result send(String paramString, AdIPCManager.Params paramParams)
  {
    ...
    {
      yny.b("GdtIPCAdapter", String.format("send action:%s result:%b", new Object[] { paramString, Boolean.valueOf(bool) }));
      return localResult;
