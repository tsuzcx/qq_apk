  ...
  implements Manager
{
  ...
  public static HashMap<String, bdzi> a;
  public static String[] a;
  bdvu jdField_a_of_type_Bdvu = new bdzf(this);
  ...
  static
  {
    ...
    jdField_a_of_type_JavaLangString = aljq.aX + "voiceChange/";
    jdField_a_of_type_ArrayOfJavaLangString = new String[] { null, null, null };
  }
  
  public bdze(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a(int paramInt1, String paramString1, String paramString2, int paramInt2, int paramInt3)
  {
    ...
    //   12: istore_0
    //   13: getstatic 24	bdze:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   16: aload_1
    //   17: invokevirtual 75	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   20: checkcast 77	bdzi
    //   23: astore 7
    //   25: aload 7
    //   27: ifnull +88 -> 115
    //   30: aload 7
    //   32: getfield 80	bdzi:jdField_a_of_type_Bdzj	Lbdzj;
    //   35: ifnull +84 -> 119
    //   38: aload_1
    //   39: aload_2
    //   40: iload_3
    //   41: invokestatic 85	bdzk:a	(Ljava/lang/String;Ljava/lang/String;I)V
    //   44: aload 7
    //   46: getfield 80	bdzi:jdField_a_of_type_Bdzj	Lbdzj;
    //   49: aload_1
    //   50: iload 4
    //   52: iload_0
    ...
    //   107: getstatic 24	bdze:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   110: aload_1
    ...
    //   119: aload 7
    //   121: iconst_1
    //   122: putfield 117	bdzi:jdField_a_of_type_Boolean	Z
    //   125: aload 7
    //   127: iload_0
    //   128: putfield 120	bdzi:jdField_a_of_type_Int	I
    //   131: goto -16 -> 115
    //   134: astore_1
    //   135: ldc 2
    //   137: monitorexit
  ...
  public static void a(Context paramContext, bdzb parambdzb, String paramString, bdza parambdza)
  {
    if ((bdzi)jdField_a_of_type_JavaUtilHashMap.get(parambdzb.jdField_a_of_type_JavaLangString) == null) {
      b(paramContext, parambdzb, paramString, parambdza);
    }
    ((bdzi)jdField_a_of_type_JavaUtilHashMap.get(parambdzb.jdField_a_of_type_JavaLangString)).jdField_a_of_type_ComTencentMobileqqVoicechangeQQVoiceChangerThread.c();
  }
  
  public static void a(Context paramContext, bdzb parambdzb, String paramString, bdza parambdza, bdzg parambdzg)
  {
    bdzi localbdzi = (bdzi)jdField_a_of_type_JavaUtilHashMap.get(parambdzb.jdField_a_of_type_JavaLangString);
    if (localbdzi != null) {
      localbdzi.jdField_a_of_type_ComTencentMobileqqVoicechangeQQVoiceChangerThread.jdField_a_of_type_Boolean = false;
    }
    localbdzi = new bdzi();
    localbdzi.jdField_a_of_type_Bdzb = parambdzb;
    localbdzi.jdField_a_of_type_Bdzg = parambdzg;
    localbdzi.jdField_a_of_type_ComTencentMobileqqVoicechangeQQVoiceChangerThread = new QQVoiceChangerThread(paramContext, parambdzb, parambdzg, paramString, parambdza);
    jdField_a_of_type_JavaUtilHashMap.put(parambdzb.jdField_a_of_type_JavaLangString, localbdzi);
    localbdzi.jdField_a_of_type_ComTencentMobileqqVoicechangeQQVoiceChangerThread.start();
  }
  
  public static void a(bdzb parambdzb)
  {
    bdzi localbdzi = (bdzi)jdField_a_of_type_JavaUtilHashMap.get(parambdzb.jdField_a_of_type_JavaLangString);
    if (localbdzi != null)
    {
      localbdzi.jdField_a_of_type_ComTencentMobileqqVoicechangeQQVoiceChangerThread.d();
      jdField_a_of_type_JavaUtilHashMap.remove(parambdzb.jdField_a_of_type_JavaLangString);
    }
  }
  
  public static boolean a(String paramString, bdzj parambdzj)
  {
    for (;;)
    {
      try
      {
        ...
        bdzi localbdzi = (bdzi)jdField_a_of_type_JavaUtilHashMap.get(paramString);
        if (localbdzi == null)
        {
          if (QLog.isColorLevel()) {
        ...
        if (localbdzi.jdField_a_of_type_Boolean)
        {
          bdzk.a(paramString, localbdzi.jdField_a_of_type_Bdzb.jdField_a_of_type_JavaLangString, localbdzi.jdField_a_of_type_Bdzb.f);
          jdField_a_of_type_JavaUtilHashMap.remove(paramString);
          parambdzj.a(paramString, localbdzi.jdField_a_of_type_Bdzb.e, localbdzi.jdField_a_of_type_Int);
          if (QLog.isColorLevel()) {
            QLog.d("VoiceChangeManager", 2, "queryStateByPath onCompressFinished filePath=" + paramString + " time=" + localbdzi.jdField_a_of_type_Int + " voiceType=" + localbdzi.jdField_a_of_type_Bdzb.e);
          }
        }
        else
        {
          localbdzi.jdField_a_of_type_Bdzj = parambdzj;
        }
      }
      finally {}
      boolean bool = true;
  ...
  public static void b(Context paramContext, bdzb parambdzb, String paramString, bdza parambdza)
  {
    a(paramContext, parambdzb, paramString, parambdza, bdzg.a());
  }
  
  public static void b(bdzb parambdzb)
  {
    bdzi localbdzi = (bdzi)jdField_a_of_type_JavaUtilHashMap.get(parambdzb.jdField_a_of_type_JavaLangString);
    if (localbdzi != null)
    {
  ...
  public boolean a(ArrayList<bdzc> paramArrayList, JSONObject paramJSONObject)
  {
    boolean bool = bdyi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), "VoiceChangeManager", false);
    if (!bool)
    {
      ...
      if (i < arrayOfInt.length)
      {
        if (arrayOfInt[i] == j)
        {
          ...
          if (i < 0)
          {
            ...
            break label1363;
            this.jdField_a_of_type_Bdvu.onDone(null);
            return true;
          }
        }
        else
        ...
        paramJSONObject = (bdzc)paramArrayList.get(i);
        label687:
        if (paramJSONObject == null)
        {
          if (!QLog.isColorLevel()) {
        ...
        if (j != 0)
        {
          ...
          {
            i = j;
            if (bdou.a(((JSONObject)localObject2).getString("QQVersion"), "8.3.3"))
            {
              j = 0;
              i = j;
              if (QLog.isColorLevel())
        ...
        for (localObject2 = paramJSONObject.jdField_b_of_type_JavaLangString;; localObject2 = ((JSONObject)localObject4).getString("description"))
        {
          ...
          paramJSONObject.jdField_a_of_type_Bdzd.jdField_a_of_type_JavaLangString = ((String)localObject3);
          break label1363;
          localObject3 = bdmy.jdField_a_of_type_JavaLangString + (String)localObject3;
      ...
      for (;;)
      {
        if (i < paramJSONObject.length)
        {
          ...
          if (localObject1 != null)
          {
            ...
            {
              localObject1 = bdmy.jdField_a_of_type_JavaLangString + (String)localObject1;
