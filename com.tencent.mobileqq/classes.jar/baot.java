  ...
  extends ajfb
{
  ...
  public Bundle a;
  public atyx a;
  private WeakReference<baou> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  public baot(QQAppInterface paramQQAppInterface)
  {
  ...
  private void B(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramIntent = (aifg)this.app.getManager(153);
  ...
  private void C(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramIntent)
      {
        ...
        localBundle.putString("msg", ajjy.a(2131650250));
        if (!QLog.isColorLevel()) {
          continue;
        }
      ...
      localBundle.putString("msg", ajjy.a(2131650251));
      if (QLog.isColorLevel()) {
  ...
  private void E(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    if (paramFromServiceMsg != null)
    {
      ...
      paramArrayOfByte = new ayqr();
      paramArrayOfByte.a(paramFromServiceMsg);
      paramIntent.a(paramArrayOfByte);
      paramIntent.a(paramFromServiceMsg);
      baig.f(this.app.getApplication(), this.app.getCurrentAccountUin(), System.currentTimeMillis());
    ...
    if ((paramIntent != null) && (paramArrayOfByte != null) && (paramFromServiceMsg != null) && (paramFromServiceMsg.isSuccess()))
    {
      try
      {
        ...
        if (paramIntent.ret.get() == 0L)
        {
          if (this.app != null)
          {
            ((aifc)this.app.getManager(211)).a(paramIntent.ret.get(), paramIntent.pbRsqData.get().toByteArray());
            return;
          }
    ...
    if ((paramIntent != null) && (paramArrayOfByte != null) && (paramFromServiceMsg != null) && (paramFromServiceMsg.isSuccess()))
    {
      try
      {
        ...
        if (paramFromServiceMsg.ret.get() == 0L)
        {
          if (this.app != null)
          {
            ((aifc)this.app.getManager(211)).a(paramFromServiceMsg.ret.get(), paramFromServiceMsg.pbRsqData.get().toByteArray(), paramIntent.getBundleExtra("extras"));
            return;
          }
      ...
      try
      {
        ...
        if (paramIntent.ret.get() == 0L)
        {
          ...
          if (paramFromServiceMsg.getResultCode() == 1002)
          {
            ...
            awrn.a(BaseApplication.getContext()).a(BaseApplicationImpl.getApplication().getRuntime().getAccount(), "RichTextIllegalWordTime", bool1, l, 0L, null, "");
            if (QLog.isColorLevel()) {
              QLog.d(jdField_a_of_type_JavaLangString, 2, "costTime:" + l + " isTimeOut:" + bool2 + " legalSuccess:" + bool1);
            }
            ((aqdf)this.app.getManager(219)).b(bool1);
          }
        }
        else
        {
  ...
  private void J(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramIntent = new aimf(paramFromServiceMsg.ip_list.get(), i, paramFromServiceMsg.aes_key.get(), paramFromServiceMsg.distribute_ts.get(), paramFromServiceMsg.sign.get());
      }
      catch (Exception paramIntent)
      {
      ...
      paramFromServiceMsg = ((aifg)this.mApp.getManager(153)).a();
      if (paramIntent != null)
      {
    ...
    while (!QLog.isColorLevel()) {
      for (;;)
      {
        try
        {
          ...
          paramIntent.mergeFrom(paramArrayOfByte);
          if (QLog.isColorLevel()) {
            QLog.d(jdField_a_of_type_JavaLangString, 2, "handleApolloSetModel ret: " + paramIntent.ret.get());
          }
          if (paramIntent.ret.get() == 0L)
          {
            paramFromServiceMsg = (aifg)this.app.getManager(153);
            if (paramFromServiceMsg != null)
            {
              paramArrayOfByte = paramFromServiceMsg.b(this.app.c());
              int i = paramArrayOfByte.cmshow3dFlag;
              paramArrayOfByte.cmshow3dFlag |= 0x1;
              if (paramArrayOfByte.cmshow3dFlag != i)
              {
                paramFromServiceMsg.a(paramArrayOfByte);
                paramFromServiceMsg.c(i, paramArrayOfByte.cmshow3dFlag);
                paramFromServiceMsg = new ArrayList();
                paramFromServiceMsg.add(this.app.c());
                paramArrayOfByte = aisl.a(this.app);
                if (paramArrayOfByte != null) {
                  paramArrayOfByte.a(3, paramFromServiceMsg);
                }
              }
            }
          }
          ...
          {
            paramFromServiceMsg = (baou)this.jdField_a_of_type_JavaLangRefWeakReference.get();
            if (paramIntent.ret.get() == 0L)
            {
              bool = true;
    ...
    try
    {
      ...
      if (paramIntent.ret.get() == 0L)
      {
        ...
        if (paramIntent != null)
        {
          ...
          {
            paramIntent = (awcl)this.app.getManager(12);
  ...
  private void O(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    if ((paramIntent != null) && (paramArrayOfByte != null) && (paramFromServiceMsg != null) && (paramFromServiceMsg.isSuccess())) {
      try
      {
        ...
        paramIntent.mergeFrom(paramArrayOfByte);
        if (QLog.isColorLevel()) {
          QLog.d(jdField_a_of_type_JavaLangString, 2, new Object[] { "[handleGetGameRegisterInfo] ret=", Long.valueOf(paramIntent.ret.get()) });
        }
        if (paramIntent.ret.get() == 0L)
        {
          paramIntent = new JSONObject(paramIntent.rspdata.get());
          if (paramIntent != null)
          {
            ...
            if (paramFromServiceMsg != null)
            {
              ...
              {
                QLog.e(jdField_a_of_type_JavaLangString, 1, "[handleGetGameRegisterInfo] ret:" + i);
                return;
              }
            }
          }
      ...
      {
        QLog.e(jdField_a_of_type_JavaLangString, 1, "[handleGetGameRegisterInfo] err:" + paramIntent.getMessage());
      }
    }
  }
  ...
  private void a(String paramString, oidb_0x5eb.UdcUinData paramUdcUinData)
  {
    int i;
    ...
    for (;;)
    {
      ...
      this.app.a(13).notifyUI(114, true, new Object[] { paramString, Integer.valueOf(i) });
      return;
  ...
  private void a(Long[] paramArrayOfLong, String paramString)
  {
    try
    {
      ...
      localJSONObject.put("cpuCount", babp.b());
      localJSONObject.put("cpuFrequency", babp.a());
      localJSONObject.put("systemTotalMemory", babp.d());
      ...
      paramString = new NewIntent(this.app.getApp(), baoy.class);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i == 0)
        {
          ...
          if ((this.jdField_a_of_type_AndroidOsBundle == null) || (this.jdField_a_of_type_Atyx == null)) {
            break;
          }
          this.jdField_a_of_type_Atyx.a(i, j, paramIntent, this.jdField_a_of_type_AndroidOsBundle);
          this.jdField_a_of_type_AndroidOsBundle = null;
          this.jdField_a_of_type_Atyx = null;
          return;
        }
      }
      catch (Exception paramIntent)
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 2, "[handleExploreInfo]");
    }
    if ((paramArrayOfByte == null) || (!paramFromServiceMsg.isSuccess()))
    {
      QLog.e(jdField_a_of_type_JavaLangString, 1, "[handleExploreInfo] data null or rsp failed");
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        Object localObject = this.app.getApp().getSharedPreferences("apollo_sp" + this.app.c(), 0);
        if (i == 1)
        {
        ...
        for (;;)
        {
          ...
          while (((Iterator)localObject).hasNext())
          {
            ...
            if (aifg.a(this.app, this.app.c()) == 2) {
            ...
            QLog.d(jdField_a_of_type_JavaLangString, 1, "[handleExploreInfo] id:" + i + ",info:" + paramFromServiceMsg.toString());
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (0L == paramFromServiceMsg.ret.get())
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.d(jdField_a_of_type_JavaLangString, 2, "handleGetUserApolloDress rootData: " + localJSONObject);
          }
          ...
          if (localJSONArray != null)
          {
            ...
            if (i < localJSONArray.length())
            {
              ...
              ApolloBaseInfo localApolloBaseInfo = localaifg.b(l1 + "");
          ...
          if (paramFromServiceMsg != null)
          {
            ApolloUtil.a(paramFromServiceMsg.optInt("level"));
            if (QLog.isColorLevel()) {
              QLog.d(jdField_a_of_type_JavaLangString, 2, "handleGetUserApolloDress MSAA_level deviceJson : " + paramFromServiceMsg);
            }
          }
          ...
          if (paramArrayOfByte != null)
          {
            ...
            if (i < paramArrayOfByte.length())
            {
              ...
              paramFromServiceMsg = localaifg.b(l1 + "");
              j = 1;
              ...
              if ((paramFromServiceMsg == null) || (TextUtils.isEmpty(paramFromServiceMsg.jdField_a_of_type_JavaLangString))) {
                break label1046;
              }
              aitw.a(this.app, paramFromServiceMsg.jdField_a_of_type_JavaLangString, null);
              break label1046;
            }
          }
      ...
      for (;;)
      {
        ...
        break;
        label839:
        localaifg.b(localArrayList);
        ((aifg)this.app.getManager(153)).a(localArrayList);
        continue;
        label867:
        if (QLog.isColorLevel())
        {
  ...
  private void z(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    for (int i = paramArrayOfByte.length;; i = -1)
    {
      ...
      do
      {
        try
        {
          ...
          if ((paramFromServiceMsg.uint32_result.has()) && (paramFromServiceMsg.uint32_result.get() == 0))
          {
            ...
            localObject1 = (aifg)this.app.getManager(153);
            i = 0;
            while (i < paramIntent.rpt_msg_uin_data.size())
            {
              localObject2 = (oidb_0x5eb.UdcUinData)paramIntent.rpt_msg_uin_data.get(i);
              ApolloBaseInfo localApolloBaseInfo = ((aifg)localObject1).b(((oidb_0x5eb.UdcUinData)localObject2).uint64_uin.get() + "");
            ...
            ((aifg)localObject1).b(paramArrayOfByte);
      ...
      while (i < j)
      {
        ...
        localObject1 = ((aifg)this.app.getManager(153)).b(paramArrayOfByte);
  ...
  public void a()
  {
    for (;;)
    {
      try
      {
        ...
        boolean bool = ((aifg)this.app.getManager(153)).b(this.app.c());
        if (bool)
        {
          ...
          NewIntent localNewIntent = new NewIntent(this.app.getApp(), baoy.class);
  ...
  public void a(int paramInt)
  {
    ...
    ((IndividPub.Platform_Comm_Req)localObject).mqqver.set("8.2.6.4370");
    ...
    localObject = new NewIntent(this.app.getApp(), baoy.class);
  ...
  public void a(int paramInt1, int paramInt2, long paramLong)
  {
    ...
    try
    {
      ...
      ((WebSSOAgent.UniSsoServerReqComm)localObject).platform.set(109L);
      ((WebSSOAgent.UniSsoServerReqComm)localObject).osver.set(Build.VERSION.RELEASE);
      ((WebSSOAgent.UniSsoServerReqComm)localObject).mqqver.set("8.2.6.4370");
      WebSSOAgent.UniSsoServerReq localUniSsoServerReq = new WebSSOAgent.UniSsoServerReq();
      localUniSsoServerReq.comm.set((MessageMicro)localObject);
      localObject = new JSONObject();
      ...
      localJSONObject2.put("qq_version", "8.2.6.4370");
  ...
  public void a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    try
    {
      i = badq.a(this.app.getApp().getApplicationContext());
    }
    catch (Exception paramString)
    {
      for (;;)
    ...
    ((qqshop_act.SQQSHPUsrInfo)localObject).carriertype.set(nfp.b());
    ((qqshop_act.SQQSHPUsrInfo)localObject).net_type.set(i);
    ((qqshop_act.SQQSHPUsrInfo)localObject).src.set(nfp.a(paramInt2));
  ...
  public void a(int paramInt, Bundle paramBundle, atyx paramatyx)
  {
    if (QLog.isColorLevel()) {
    ...
    localTPraiseSsoReq.str_qq_ver.set("8.2.6.4370");
  ...
  public void a(int paramInt, String paramString1, String paramString2)
  {
    ...
    for (paramString1 = Long.valueOf(0L);; paramString1 = Long.valueOf(Long.parseLong(paramString1)))
    {
      ...
      paramString1 = new NewIntent(this.app.getApp(), baoy.class);
  ...
  public void a(int paramInt, List<MessageRecord> paramList)
  {
    ...
    for (;;)
    {
      ...
      break;
      localUniSsoServerReq.pbReqData.set(ByteStringMicro.copyFrom(((MonitReport.MonitReportReq)localObject).toByteArray()));
      paramList = new NewIntent(this.app.getApp(), baoy.class);
  ...
  public void a(long paramLong, int paramInt1, int paramInt2)
  {
    ...
    localSetAddonReq.str_qq_version.set("8.2.6");
    if (paramInt2 != -1) {
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    localReqBody.str_version.set(babp.c());
    Object localObject;
    if (paramLong1 == 8192L)
    {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      localObject = new NewIntent(this.mApp.getApp(), baoy.class);
  ...
  public void a(Intent paramIntent, byte[] paramArrayOfByte)
  {
    ...
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      ...
      localObject1 = ((ajjj)localObject2).a((String)localObject3);
      paramArrayOfByte = (byte[])localObject1;
      ...
      ((ajjj)localObject2).a(paramArrayOfByte);
      label679:
  ...
  public void a(baou parambaou)
  {
    ...
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambaou);
  }
  ...
  public void a(ReportInfoManager.ReportChannlInfo paramReportChannlInfo)
  {
    ...
    try
    {
      ...
      localUniSsoServerReq.reqdata.set(((JSONObject)localObject).toString());
      paramReportChannlInfo = new NewIntent(this.app.getApp(), baoy.class);
  ...
  public void a(QQAppInterface paramQQAppInterface, int[] paramArrayOfInt)
  {
    ...
    try
    {
      ...
      paramArrayOfInt = new NewIntent(paramQQAppInterface.getApp(), baoy.class);
  ...
  public void a(String paramString1, int paramInt, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localUniSsoServerReq.reqdata.set(localJSONObject.toString());
        paramString2 = new NewIntent(this.app.getApp(), baoy.class);
  ...
  public void a(String paramString, long paramLong1, long paramLong2, int paramInt1, int paramInt2)
  {
    ...
    Card localCard = ((ajjj)localObject).b(paramString);
    ...
    if ((!TextUtils.isEmpty(paramString)) && (this.app.c().equals(paramString)))
    {
      ...
      String str = "plate_of_king_display_switch_" + this.app.c();
      if (paramInt2 == 1)
      {
        bool1 = true;
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      this.app.a(2).notifyUI(1, true, localCard);
      if (localObject != null)
      {
        ...
        this.app.a(1).notifyUI(3, true, paramString);
      }
      return;
      bool1 = false;
      break;
  ...
  public void a(String paramString1, long paramLong1, long paramLong2, List<String> paramList, boolean paramBoolean, String paramString2, String paramString3)
  {
    ...
    for (int i = 0;; i = 1)
    {
      ...
      localJSONObject2.put("qq_version", "8.2.6");
      localJSONObject2.put("skey", ((TicketManager)this.app.getManager(2)).getSkey(this.app.getCurrentAccountUin()));
      localJSONObject1.put("req", localJSONObject2);
  ...
  public void a(String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    try
    {
      ...
      localObject2 = new NewIntent(this.app.getApp(), baoy.class);
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    try
    {
      ...
      localUniSsoServerReqComm.mqqver.set("8.2.6.4370");
      WebSSOAgent.UniSsoServerReq localUniSsoServerReq = new WebSSOAgent.UniSsoServerReq();
  ...
  public void a(String paramString, ArrayList<bbha> paramArrayList)
  {
    ...
    if (localIterator.hasNext())
    {
      bbha localbbha = (bbha)localIterator.next();
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("ColorNick", 2, "modifyTroopMemberCardInfoWithColorNick type = " + localbbha.c + " text = " + localbbha.jdField_a_of_type_JavaLangString);
        }
        localArrayList2.add(localRichCardNameElem);
        break;
        localRichCardNameElem.bytes_text.set(ByteStringMicro.copyFrom(localbbha.jdField_a_of_type_JavaLangString.getBytes()));
        localStringBuilder.append(localbbha.jdField_a_of_type_JavaLangString);
        continue;
        paramArrayList = localbbha.jdField_a_of_type_JavaLangString;
    ...
    paramString.string_clientver.set(babp.c());
    ...
    paramArrayList = new NewIntent(this.app.getApp(), baoy.class);
  ...
  public void a(String paramString1, List<ApolloGameScoreData> paramList1, String paramString2, List<ApolloGameScoreData> paramList2)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        paramString1.putExtra("data", localUniSsoServerReq.toByteArray());
        this.app.startServlet(paramString1);
        bajr.a(this.app, "cmshow", "Apollo", "get_rank_compare", 1, 0, new String[0]);
        return;
      }
      catch (Exception paramString1) {}
    } while (!QLog.isColorLevel());
  ...
  public void a(long... paramVarArgs)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localUniSsoServerReq.reqdata.set(((JSONObject)localObject).toString());
        paramVarArgs = new NewIntent(this.app.getApp(), baoy.class);
  ...
  public void a(String[] paramArrayOfString, int[] paramArrayOfInt)
  {
    ...
    localObject1 = new NewIntent(this.app.getApp(), baoy.class);
  ...
  public boolean a(String paramString1, String paramString2)
  {
    try
    {
      ...
      localSCUpdateReq.comm.qver.set(ByteStringMicro.copyFrom("8.2.6.4370".getBytes()));
      localSCUpdateReq.comm.osrelease.set(ByteStringMicro.copyFrom(String.valueOf(Build.VERSION.SDK_INT).getBytes()));
      localSCUpdateReq.comm.network.set(badq.b(this.app.getApplication()));
  ...
  public void b(int paramInt)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (aifg.a(this.app, this.app.c()) != 2);
      l = NetConnInfoCenter.getServerTime();
      if (paramInt != 1) {
        break;
      }
      if (this.jdField_a_of_type_Int == 0) {
        this.jdField_a_of_type_Int = this.app.getApp().getSharedPreferences("apollo_sp" + this.app.c(), 0).getInt("next_req_st_drawer", (int)l);
      }
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d(jdField_a_of_type_JavaLangString, 1, "[getExploreInfo] get info");
        }
        Object localObject = new WebSSOAgent.UniSsoServerReqComm();
        ((WebSSOAgent.UniSsoServerReqComm)localObject).platform.set(109L);
        ((WebSSOAgent.UniSsoServerReqComm)localObject).osver.set(Build.VERSION.RELEASE);
      ...
      {
        QLog.e(jdField_a_of_type_JavaLangString, 1, "[getExploreInfo] exception=", localException);
        return;
      }
      if (this.jdField_b_of_type_Int == 0) {
        this.jdField_b_of_type_Int = this.app.getApp().getSharedPreferences("apollo_sp" + this.app.c(), 0).getInt("next_req_st_drawer_friend_card", (int)l);
      }
      if (QLog.isColorLevel()) {
  ...
  public void b(String paramString, int paramInt)
  {
    ...
    localObject = this.app.getApp().getSharedPreferences("com.tencent.mobileqq_preferences", 4).edit();
  ...
  public void b(String paramString1, int paramInt, String paramString2)
  {
    ...
    localEditor.putInt("hot_friend_new_boat_graytip_sp" + str + "_" + paramString1, paramInt);
    if (!TextUtils.isEmpty(paramString2)) {
      localEditor.putString("hot_friend_new_boat_graytip_sp" + str + "_" + paramString1 + "_tips", paramString2);
    }
    localEditor.commit();
  }
  ...
  public void d(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    if ((paramArrayOfByte != null) && (paramFromServiceMsg.isSuccess()))
    {
      try
      {
        ...
        paramIntent = new Pair(this.app.c(), Integer.valueOf(i));
        if (0L != paramFromServiceMsg.ret.get()) {
          break label198;
        }
        if (i != 0)
  ...
  public void d(String paramString)
  {
    ...
    default: 
      ...
      return;
    case 1: 
      localObject1 = this.app.getApp().getString(2131627546);
    }
    for (;;)
    {
      paramString = new aqax(paramString, paramString, (String)localObject1, 0, -5020, 2097156, awao.a());
      localObject2 = new Bundle();
      String str = ajjy.a(2131650252);
      if (!TextUtils.isEmpty(str))
      {
      ...
      aqay.a(this.app, (MessageForUniteGrayTip)localObject1);
      return;
      localObject1 = this.app.getApp().getString(2131627549);
      continue;
      localObject1 = this.app.getApp().getString(2131627548);
      continue;
      localObject1 = this.app.getApp().getString(2131627545);
      continue;
      localObject1 = this.app.getApp().getString(2131627547);
      continue;
      localObject1 = this.app.getApp().getString(2131627544);
    }
  }
  ...
  public void e()
  {
    ...
    try
    {
      ...
      localAddrDistribueReq.net_type.set(aing.d());
      WebSSOAgent.UniSsoServerReq localUniSsoServerReq = new WebSSOAgent.UniSsoServerReq();
      localUniSsoServerReq.comm.set((MessageMicro)localObject);
  ...
  public void e(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    if ((paramArrayOfByte != null) && (paramFromServiceMsg.isSuccess()) && (!TextUtils.isEmpty((CharSequence)localObject1)))
    {
      try
      {
        ...
        localObject3 = (aifg)this.mApp.getManager(153);
        if (localObject3 != null) {
          ((aifg)localObject3).a = ((HashMap)localObject1);
        }
        localObject2 = (aiyu)this.mApp.getManager(155);
        if (localObject2 == null) {
          break label1385;
        }
        ((aiyu)localObject2).a((JSONArray)localObject4);
        Object localObject5 = ((aiyu)localObject2).a(1);
        localObject4 = ((aiyu)localObject2).b();
        k = 0;
        i = 0;
        if (localObject5 == null) {
          break label1395;
        ...
        if (k < ((List)localObject5).size())
        {
          ...
          if (localObject3 != null) {
            ((aifg)localObject3).a(localApolloActionData, localBundle);
          }
          m = 1;
          i = m;
          if (!QLog.isColorLevel()) {
        ...
        ((aiyu)localObject2).b((List)localObject5);
        k = i;
      }
      catch (Exception paramIntent)
      {
      ...
      ((aiyu)localObject2).b((List)localObject4);
      m = i;
      break label1418;
    }
    label1102:
    ...
    for (;;)
    {
      ...
      while (((Iterator)localObject1).hasNext()) {
        if (((aiyu)localObject2).a(((Integer)((Iterator)localObject1).next()).intValue()) == null)
        {
      ...
      do
      {
        ...
        if (paramIntent.has("CurrencyInfo"))
        {
          ...
          if (localObject1 != null)
          {
            ((aify)localObject1).jdField_a_of_type_Int = i;
            if (((aify)localObject1).jdField_a_of_type_Boolean) {
              ((aify)localObject1).b();
            }
          }
          if (QLog.isColorLevel()) {
  ...
  public void e(String paramString)
  {
    ...
    for (Object localObject1 = str1.replace("gray_small_ship", " ");; localObject1 = str1)
    {
      ...
      for (;;)
      {
        ...
        if (!TextUtils.isEmpty(str1))
        {
          str1 = asav.a(this.app, 12L, 1L);
          str2 = asav.a(this.app, 12L, 2L);
  ...
  public void f(String paramString)
  {
    ...
    localFilter_Req_Comm.mqqver.set("8.2.6");
  ...
  {
    QLog.d(jdField_a_of_type_JavaLangString, 1, "getGameRegisterInfo");
    try
    {
      Object localObject = new WebSSOAgent.UniSsoServerReqComm();
      ((WebSSOAgent.UniSsoServerReqComm)localObject).platform.set(109L);
    ...
    if ((paramArrayOfByte != null) && (paramFromServiceMsg.isSuccess())) {
      try
      {
        ...
        if (0L == paramIntent.ret.get())
        {
          ...
          paramArrayOfByte = (aifg)this.app.getManager(153);
          if (paramArrayOfByte != null)
          {
  ...
  public void k(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    do
    {
      return;
      int j = 0;
      paramIntent = this.app.getHandler(abai.class);
  ...
  public void l(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      if (paramFromServiceMsg.isSuccess())
      {
        ...
        ((aifc)this.app.getManager(211)).a((int)paramFromServiceMsg.ret.get(), paramArrayOfByte.rpt_msg_list.get(), paramIntent);
        return;
      }
    ...
    if ((paramArrayOfByte != null) && (paramFromServiceMsg != null)) {
      for (;;)
      {
        ...
        try
        {
          ...
          localObject = (aifc)this.app.getManager(211);
          ...
          {
            ((aifc)localObject).a(localUniSsoServerRsp.ret.get(), paramArrayOfByte, paramFromServiceMsg, paramIntent.getStringExtra("reqData"));
            if (!QLog.isColorLevel()) {
              return;
            }
        ...
        {
          localObject = ((aifg)this.app.getManager(153)).a();
          if (localObject != null) {
            ((aify)localObject).a(localUniSsoServerRsp.ret.get(), paramFromServiceMsg, paramIntent.getStringExtra("reqData"));
          }
        }
      }
    }
      ...
      try
      {
        ...
        if ((paramFromServiceMsg.uint32_result.has()) && (paramFromServiceMsg.uint32_result.get() == 0))
        {
          ...
          if (i1 < i2)
          {
            ...
            paramFromServiceMsg = localajjj.a(str);
            if (paramFromServiceMsg != null) {
              break label2080;
            }
            ...
            if (QLog.isColorLevel())
            {
              QLog.d("VasShieldFont", 2, "handleGetStrangerVasInfo: " + gh.c);
              i = k;
            }
            if ((fv.a(l) == paramFromServiceMsg.uVipFont) && (fv.b(l) == paramFromServiceMsg.vipFontType)) {
              break label2071;
            }
            paramFromServiceMsg.uVipFont = fv.a(l);
            paramFromServiceMsg.vipFontType = fv.b(l);
            ...
            if (localUdcUinData.uint32_req_font_effect_id.has())
            {
              ...
              if (QLog.isColorLevel()) {
                QLog.d(jdField_a_of_type_JavaLangString, 2, "handleGetStrangerVasInfo uin = " + str + " fontEffect = " + m + " extInfo.fontEffect = " + paramFromServiceMsg.fontEffect);
              }
              ...
              if (QLog.isColorLevel())
              {
                QLog.d(jdField_a_of_type_JavaLangString, 2, "handleGetStrangerVasInfo uin = " + str + " extInfo.fontEffect = " + paramFromServiceMsg.fontEffect + " extInfo.fontEffectLastUpdateTime = " + paramFromServiceMsg.fontEffectLastUpdateTime);
                n = j;
              }
            }
            m = n;
            ...
            if (QLog.isColorLevel())
            {
              QLog.d(jdField_a_of_type_JavaLangString, 1, "uint32_vas_face_id uin: " + str + " oldId: " + n + " newId: " + i3);
              j = m;
            }
            Object localObject3;
            if (localUdcUinData.uint32_bubble_unread_switch.has())
            {
              ...
              if (localObject3 != null)
              {
                ...
                bool = true;
                ((BubbleManager)localObject3).a(bool);
              }
              if (QLog.isColorLevel()) {
                QLog.d(jdField_a_of_type_JavaLangString, 1, "uint32_bubble_unread_switch : " + m);
              }
            }
            m = j;
            if (localUdcUinData.uint32_vas_pendant_diy_id.has())
            {
              ...
              if (paramFromServiceMsg.pendantDiyId != n)
              {
                ...
                j = 1;
                if (str.equals(this.app.getCurrentAccountUin())) {
                  ((ajrm)this.app.a(13)).b(n, false);
                }
                m = j;
                if (QLog.isColorLevel())
                {
                  QLog.d(jdField_a_of_type_JavaLangString, 2, "handleGetStrangerVasInfo, uin=" + str + ", pendant=" + paramFromServiceMsg.pendantId + ",font=" + paramFromServiceMsg.uVipFont + ", fontType = " + paramFromServiceMsg.vipFontType + ", magicFont = " + paramFromServiceMsg.magicFont + ", colorRing = " + paramFromServiceMsg.colorRingId + ", pendantDiyId = " + paramFromServiceMsg.pendantDiyId);
                  m = j;
                }
              }
            }
            if (localUdcUinData.uint32_rsp_qq_level_icon_type.has())
            {
              ...
              localObject3 = (ajjj)this.app.getManager(51);
              Card localCard = ((ajjj)localObject3).b(str + "");
              if ((localCard != null) && (localCard.mQQLevelType != j))
              {
                localCard.mQQLevelType = j;
                ((ajjj)localObject3).a(localCard);
                this.app.a(2).notifyUI(1, true, localCard);
              }
            }
          ...
          paramIntent = localajjj.a(this.app.getCurrentAccountUin());
          fv.a(this.app, this.app.getCurrentAccountUin(), paramIntent, i, j);
          localajjj.b((List)localObject2);
          localVasFaceManager.b(localArrayList);
          localVasFaceManager.a((Collection)localObject2);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i != 0)
        {
          ...
          aitw.a(this.app, (String)localObject4, str);
        }
      ...
      Object localObject1 = localaifg.b((String)localObject1);
      if (localObject1 != null)
      {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          paramIntent = (aiyu)this.app.getManager(155);
          ...
          if (localObject4 != null)
          {
            ...
            if ((localObject4 != null) && (((List)localObject4).size() > 0))
            {
              ...
              if (((Iterator)localObject4).hasNext())
              {
                ...
                bajr.a(this.mApp, "cmshow", "Apollo", "beyond_notice_disappear", 3, 0, new String[] { String.valueOf(((ApolloGameRankData)localObject5).mGameId) });
                continue;
              }
            }
          }
  ...
  public void s(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramIntent = ((aifg)this.app.getManager(153)).a();
        if (paramIntent != null) {
        ...
        paramIntent.put("tips", this.app.getApp().getString(2131624517));
      ...
      if (i == 0) {
        ApolloItemBuilder.a(ajjy.a(2131650253), 1, BaseApplicationImpl.getContext());
      }
      return;
      label397:
      i = 0;
