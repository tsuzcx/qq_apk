  ...
  implements agma
{
  ...
  public agmt(BaseChatPie paramBaseChatPie)
  {
  ...
  {
    paramContext = afxa.a(paramContext, paramString1, paramString2);
  ...
  {
    String str1;
    if ((paramSessionInfo != null) && (paramSessionInfo.jdField_a_of_type_Afxa != null))
    {
      ...
      if (paramSessionInfo.jdField_a_of_type_Afxa.a == null) {
        break label410;
      }
      if ((paramSessionInfo.jdField_a_of_type_Afxa.a instanceof arni)) {
    ...
    for (;;)
    {
      ...
      {
        ((bgzk)paramQQAppInterface.getManager(235)).a.a(i, new agmu(this, i));
        paramContext = paramSessionInfo + "-effect";
        label181:
        QAPM.setAbFactor("AIO背景", paramContext, adbr.class);
      }
      do
      {
        return;
        if (!(paramSessionInfo.jdField_a_of_type_Afxa.a instanceof URLDrawable)) {
          break label410;
        }
        ...
        {
          paramContext = afxa.a(paramContext, str2, str1);
        ...
        {
          paramQQAppInterface = ThemeBackground.getDynamicDrawable(a(paramContext, str2, str1), 2130839091);
          bhbt.a().a(paramQQAppInterface, true);
