...
public class bibv
{
  ...
  public void a(Canvas paramCanvas, bibw parambibw)
  {
    if ((paramCanvas == null) || (parambibw == null)) {
      return;
    }
    if ((this.jdField_a_of_type_Boolean) && (a()))
    {
      this.jdField_a_of_type_AndroidGraphicsRectF.set(0.0F, 0.0F, parambibw.getWidth(), parambibw.getHeight());
      int i = this.e;
      if (b()) {
        i = c;
      }
