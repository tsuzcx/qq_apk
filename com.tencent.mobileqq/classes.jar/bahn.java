...
public class bahn
  extends bdih<HashMap<String, Object>, Void, JSONObject>
{
  protected int a;
  protected Bundle a;
  protected baho a;
  ...
  public bahn(String paramString1, String paramString2, baho parambaho, int paramInt, Bundle paramBundle)
  {
    super(paramString1, paramString2);
    this.jdField_a_of_type_Baho = parambaho;
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_AndroidOsBundle = paramBundle;
  }
  
  public bahn(String paramString1, String paramString2, baho parambaho, int paramInt, Bundle paramBundle, boolean paramBoolean)
  {
    super(paramString1, paramString2);
    this.jdField_a_of_type_Baho = parambaho;
    this.jdField_a_of_type_Int = paramInt;
  ...
  protected JSONObject a(HashMap<String, Object>... paramVarArgs)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = new JSONObject(nam.a(paramVarArgs, this.jdField_a_of_type_JavaLangString, this.b, (Bundle)localObject, localBundle));
  ...
  {
    if (isCancelled()) {}
    while (this.jdField_a_of_type_Baho == null) {
      return;
    }
    this.jdField_a_of_type_Baho.a(paramJSONObject, this.jdField_a_of_type_Int, this.jdField_a_of_type_AndroidOsBundle);
  }
}
