...
public class aaqm
  implements Runnable
{
  public aaqm(ArkRecommendController paramArkRecommendController, RecommendCommonMessage paramRecommendCommonMessage, RecommendCommonMessage.ArkContextInfo paramArkContextInfo, ArkAiInfo paramArkAiInfo, String paramString) {}
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        else
        {
          ...
          localObject = new aaqn(this, (RecommendCommonMessage.ArkContextInfo)localObject);
