...
public class bltq<T extends RecyclerView.Adapter>
  extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
  ...
  public bltq(T paramT)
  {
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$Adapter = paramT;
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$Adapter.registerAdapterDataObserver(new bltr(this));
  }
  ...
  public bltq a(bltu parambltu)
  {
    this.jdField_a_of_type_Bltu = parambltu;
    return this;
  }
  ...
  protected void a(RecyclerView.ViewHolder paramViewHolder, int paramInt)
  {
    if (this.jdField_a_of_type_Bltv != null) {
      this.jdField_a_of_type_Bltv.a(paramViewHolder, paramInt);
    }
  }
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    if (c(paramInt))
    {
      ...
      return new blts(this, (View)this.jdField_a_of_type_JavaUtilList.get(paramInt));
    }
    if (d(paramInt))
    {
      paramInt = Math.abs(paramInt + 2000);
      return new bltt(this, (View)this.b.get(paramInt));
    }
  ...
  public void onViewAttachedToWindow(RecyclerView.ViewHolder paramViewHolder)
  {
    ...
    if ((this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$Adapter != null) && ((paramViewHolder instanceof blsy))) {
