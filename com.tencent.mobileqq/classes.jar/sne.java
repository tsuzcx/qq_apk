  ...
  implements View.OnClickListener
{
  ...
  public sne(Context paramContext)
  {
  ...
  public void a(sng paramsng)
  {
    this.jdField_a_of_type_Sng = paramsng;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = new snh(this, null);
      localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560236, paramViewGroup, false);
      paramView.jdField_a_of_type_AndroidViewView = localView.findViewById(2131365035);
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131378151));
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (!((ChannelCoverInfo)localObject).isReport)
        {
          ...
          opq.a("0X8007F01", (ChannelCoverInfo)localObject, opq.b);
        }
        ...
        return localView;
        localObject = (snh)paramView.getTag();
        localView = paramView;
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_Sng == null) || (!(paramView.getTag() instanceof ChannelCoverInfo))) {
        break;
      }
      this.jdField_a_of_type_Sng.a((ChannelCoverInfo)paramView.getTag());
      break;
      if (tgc.b(localChannelCoverInfo.mChannelJumpUrl)) {
        tgc.a(this.jdField_a_of_type_AndroidContentContext, "", localChannelCoverInfo.mChannelJumpUrl, null);
      }
      for (;;)
      {
        if (!QLog.isColorLevel()) {
