...
public final class rzq
  implements Runnable
{
  public rzq(QQAppInterface paramQQAppInterface, Emoticon paramEmoticon, Context paramContext, SessionInfo paramSessionInfo) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      localObject1 = new rzr(this, (MessageForMarketFace)localObject2, (EmoticonPackage)localObject1);
