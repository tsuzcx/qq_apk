  ...
  extends pad
{
  ...
  public pab(AppInterface paramAppInterface, aukn paramaukn, ExecutorService paramExecutorService, pou parampou, Handler paramHandler)
  {
  ...
  private void a(List<qat> paramList1, List<qat> paramList2)
  {
    ...
    {
      localObject1 = ((qat)paramList2.next()).jdField_a_of_type_JavaUtilList.iterator();
    ...
    {
      localObject1 = (qat)paramList2.next();
      localObject2 = ((qat)localObject1).jdField_a_of_type_JavaUtilList.iterator();
      label272:
      label285:
      label291:
      label296:
      ...
      for (;;)
      {
        ...
        if (((Iterator)localObject2).hasNext())
        {
          ...
          i = 11;
          label214:
          if ((paramList1.indexOf(localObject1) != 0) || (((qat)localObject1).jdField_a_of_type_JavaUtilList.indexOf(localTabChannelCoverInfo1) >= i)) {
            break label291;
          }
          i = 1;
          label243:
  ...
  private boolean a()
  {
    ...
    this.d = 0;
    bhvh.a("UPDATE_CHANNEL_LIST_KEY_0xbbc", Boolean.valueOf(false));
    return false;
  }
  
  public static boolean a(int paramInt)
  {
    if (!((Boolean)bhvh.a("sp_key_channel_list_dynamic_order_switch", Boolean.valueOf(false))).booleanValue())
    {
      QLog.d("ChannelCoverInfoModule", 1, "isSupportChannelDynamicOrder, switch is off.");
      return false;
    }
    Object localObject1 = (QQAppInterface)onk.a();
    if (localObject1 != null)
    {
      localObject1 = (oso)((QQAppInterface)localObject1).getManager(163);
      if (localObject1 != null)
      {
        localObject1 = ((oso)localObject1).a().a();
          ...
          do
          {
            ...
            while (!((Iterator)localObject2).hasNext())
            {
              do
              {
                ...
                localObject2 = ((qat)((Iterator)localObject1).next()).jdField_a_of_type_JavaUtilList;
  ...
  private List<TabChannelCoverInfo> b(List<qat> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    paramList = paramList.iterator();
    int i = 0;
    ...
    {
      qat localqat = (qat)paramList.next();
      if ((localqat.jdField_a_of_type_JavaUtilList == null) || (localqat.jdField_a_of_type_JavaUtilList.isEmpty())) {
        break label129;
      }
      Iterator localIterator = localqat.jdField_a_of_type_JavaUtilList.iterator();
      while (localIterator.hasNext())
      {
        TabChannelCoverInfo localTabChannelCoverInfo = (TabChannelCoverInfo)localIterator.next();
        localTabChannelCoverInfo.channelConfigType = localqat.jdField_a_of_type_Long;
        localTabChannelCoverInfo.seq = i;
        localArrayList.add(localTabChannelCoverInfo);
        i += 1;
      }
  ...
  private void b(boolean paramBoolean, List<TabChannelCoverInfo> paramList)
  {
    if (Looper.getMainLooper() == Looper.myLooper()) {
      osm.a().e(paramBoolean, paramList);
    }
  ...
  private List<qat> c(List<qat> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    if (paramList != null)
    {
      ...
      while (paramList.hasNext())
      {
        Object localObject = (qat)paramList.next();
        qat localqat = new qat(((qat)localObject).jdField_a_of_type_Long, ((qat)localObject).jdField_a_of_type_JavaLangString, ((qat)localObject).b);
        localObject = ((qat)localObject).jdField_a_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject).hasNext())
        {
          ...
          localqat.jdField_a_of_type_JavaUtilList.add(localTabChannelCoverInfo2);
          i += 1;
        }
  ...
  private List<TabChannelCoverInfo> d(List<TabChannelCoverInfo> paramList)
  {
    ...
    for (;;)
    {
      ...
      label275:
      for (paramList = a();; paramList = ajyc.a(2131701501))
      {
        if (!bool2) {
        ...
        ((List)localObject2).add(0, new TabChannelCoverInfo(70, ajyc.a(2131701524), 4, "https://p.qpic.cn/kandianac/0/993c416b9d2b9.png/0"));
  ...
  private List<ChannelCoverInfo> e(int paramInt)
  {
    ...
    return this.jdField_a_of_type_Aukn.a(ChannelCoverInfo.class, true, "mChannelID = ?", new String[] { String.valueOf(paramInt) }, null, null, null, null);
  }
  ...
  private void f()
  {
    for (;;)
    {
      try
      {
        ...
        {
          str = bdhv.d(str.toLowerCase()).toLowerCase();
      ...
      catch (Throwable localThrowable)
      {
        ...
        int i;
        int j;
        QLog.e("ChannelCoverInfoModule", 2, "requestWeiShiChannelCoverListFromServer failed for param error:" + onk.a(localThrowable));
        return;
      }
      try
      {
      ...
      a(pow.a("OidbSvc.0xbe6", 3046, 1, localReqBody.toByteArray()));
      return;
      str = bbct.c(BaseApplication.getContext());
      if (!TextUtils.isEmpty(str))
      {
        str = bdhv.d(str.replaceAll(":", "").toUpperCase()).toLowerCase();
        localPhoneInfo.bytes_muid.set(ByteStringMicro.copyFromUtf8(str));
  ...
  private void g(List<qat> paramList)
  {
    if (paramList != null)
    {
      paramList = paramList.iterator();
      while (paramList.hasNext())
      {
        ...
        if (localObject != null)
        {
          localObject = ((qat)localObject).jdField_a_of_type_JavaUtilList;
          if (localObject != null)
          {
  ...
  {
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(new TabChannelCoverInfo(51, ajyc.a(2131701530)));
    localArrayList.add(new TabChannelCoverInfo(58, ajyc.a(2131701517)));
    localArrayList.add(new TabChannelCoverInfo(59, ajyc.a(2131701516)));
    localArrayList.add(new TabChannelCoverInfo(10, ajyc.a(2131701519)));
    localArrayList.add(new TabChannelCoverInfo(52, ajyc.a(2131701532)));
    localArrayList.add(new TabChannelCoverInfo(53, ajyc.a(2131701513)));
    localArrayList.add(new TabChannelCoverInfo(9, ajyc.a(2131701523)));
    localArrayList.add(new TabChannelCoverInfo(54, ajyc.a(2131701508)));
    localArrayList.add(new TabChannelCoverInfo(55, ajyc.a(2131701510)));
    localArrayList.add(new TabChannelCoverInfo(40007, ajyc.a(2131701512)));
    return localArrayList;
  }
  ...
  private List<TabChannelCoverInfo> l()
  {
    ...
    return this.jdField_a_of_type_Aukn.a(TabChannelCoverInfo.class);
  }
  ...
  public List<TabChannelCoverInfo> a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 413	pab:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   6: ifnull +36 -> 42
    //   9: aload_0
    //   10: getfield 413	pab:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   13: invokeinterface 406 1 0
    //   18: ifne +24 -> 42
    //   21: aload_0
    //   22: getfield 413	pab:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   25: iconst_0
    //   26: invokeinterface 255 2 0
    //   31: checkcast 268	qat
    //   34: getfield 270	qat:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   37: astore_1
    //   38: aload_0
    //   39: monitorexit
    //   40: aload_1
  ...
  public List<TabChannelCoverInfo> a(int paramInt)
  {
    ...
    //   19: checkcast 268	qat
    //   22: getfield 270	qat:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   25: astore_2
    //   26: aload_0
    //   27: monitorexit
    //   28: aload_2
  ...
  public void a(TabChannelCoverInfo paramTabChannelCoverInfo)
  {
    ...
    for (Object localObject = paramTabChannelCoverInfo.toString();; localObject = "null")
    {
      ...
      while (((Iterator)localObject).hasNext()) {
        if (a(paramTabChannelCoverInfo, ((qat)((Iterator)localObject).next()).jdField_a_of_type_JavaUtilList)) {
  ...
  public void a(List<channel_button.Section> paramList)
  {
    ...
    try
    {
      ...
      while (paramList.hasNext())
      {
        ...
        qat localqat = new qat(localSection);
        localJSONArray.put(localqat.a());
        localqat.jdField_a_of_type_JavaUtilList = pot.b(localSection.rpt_msg_channel.get());
        this.jdField_a_of_type_JavaUtilList.add(localqat);
      }
  ...
  public void a(List<qat> paramList, int paramInt)
  {
    ...
    if (QLog.isColorLevel())
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        localObject2 = (qat)((Iterator)localObject1).next();
        a(((qat)localObject2).jdField_a_of_type_JavaUtilList, "0xbbc update sectionId=" + ((qat)localObject2).jdField_a_of_type_Long);
      }
    }
    ...
    {
      qat localqat = (qat)localIterator1.next();
      channel_button.Section localSection = new channel_button.Section();
      ArrayList localArrayList = new ArrayList();
      if (localqat.jdField_a_of_type_JavaUtilList != null)
      {
        Iterator localIterator2 = localqat.jdField_a_of_type_JavaUtilList.iterator();
      ...
      {
        localSection.uint64_section_id.set(localqat.jdField_a_of_type_Long);
        localSection.str_section_name.set(localqat.jdField_a_of_type_JavaLangString);
        localSection.str_note_text.set(localqat.b);
    ...
    {
      localObject2 = bdhv.d(((String)localObject2).toLowerCase()).toLowerCase();
    ...
    for (;;)
    {
      ...
      a(pow.a("OidbSvc.0xbbc", 3004, 1, ((oidb_cmd0xbbc.ReqBody)localObject1).toByteArray()));
      bhvh.a("UPDATE_CHANNEL_LIST_KEY_0xbbc", Boolean.valueOf(true));
      return;
      localObject2 = bbct.c(BaseApplication.getContext());
      if (!TextUtils.isEmpty((CharSequence)localObject2))
      {
        localObject2 = bdhv.d(((String)localObject2).replaceAll(":", "").toUpperCase()).toLowerCase();
        paramList.bytes_muid.set(ByteStringMicro.copyFromUtf8((String)localObject2));
  ...
  public void a(List<qat> paramList, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      ((qat)paramList.get(0)).jdField_a_of_type_JavaUtilList = d(((qat)paramList.get(0)).jdField_a_of_type_JavaUtilList);
      this.jdField_a_of_type_JavaUtilList = c(paramList);
      paramList = b(this.jdField_a_of_type_JavaUtilList);
      if (paramBoolean) {
        b(true, ((qat)this.jdField_a_of_type_JavaUtilList.get(0)).jdField_a_of_type_JavaUtilList);
      }
      if (!QLog.isColorLevel()) {
        break label193;
      }
  ...
  {
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(new TabChannelCoverInfo(70, ajyc.a(2131701515), 4, "https://p.qpic.cn/kandianac/0/993c416b9d2b9.png/0"));
    localArrayList.add(new TabChannelCoverInfo(0, ajyc.a(2131701514), 4, "https://p.qpic.cn/kandianac/0/9558fc75932c5.png/0"));
    TabChannelCoverInfo localTabChannelCoverInfo = new TabChannelCoverInfo(56, ajyc.a(2131701525));
    localTabChannelCoverInfo.reason = 4;
    localTabChannelCoverInfo.mChannelType = 3;
    localArrayList.add(localTabChannelCoverInfo);
    localArrayList.add(new TabChannelCoverInfo(40531, ajyc.a(2131701527)));
    localArrayList.add(new TabChannelCoverInfo(14, ajyc.a(2131701511)));
    localArrayList.add(new TabChannelCoverInfo(8, ajyc.a(2131701529)));
    localArrayList.add(new TabChannelCoverInfo(1, ajyc.a(2131701518)));
    localArrayList.add(new TabChannelCoverInfo(13, ajyc.a(2131701504)));
    localArrayList.add(new TabChannelCoverInfo(5, ajyc.a(2131701534)));
    localArrayList.add(new TabChannelCoverInfo(11, ajyc.a(2131701503)));
    localArrayList.add(new TabChannelCoverInfo(40466, ajyc.a(2131701528)));
    localArrayList.add(new TabChannelCoverInfo(40013, ajyc.a(2131701526)));
    localArrayList.add(new TabChannelCoverInfo(16, ajyc.a(2131701521)));
    localArrayList.add(new TabChannelCoverInfo(15, ajyc.a(2131701507)));
    return localArrayList;
  }
  ...
  public void b()
  {
    ...
    //   21: invokestatic 328	bhvh:a	(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    //   24: checkcast 314	java/lang/Boolean
    //   27: invokevirtual 331	java/lang/Boolean:booleanValue	()Z
    //   30: ifeq +29 -> 59
    //   33: aload_0
    //   34: invokespecial 951	pab:a	()Z
    //   37: ifeq +22 -> 59
    //   40: ldc 60
    //   42: iconst_2
    //   43: ldc_w 953
    ...
    //   49: aload_0
    //   50: aload_0
    //   51: getfield 413	pab:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   54: iconst_3
    //   55: invokevirtual 955	pab:a	(Ljava/util/List;I)V
    //   58: return
    //   59: getstatic 958	ntk:a	Z
    //   62: ifeq +13 -> 75
    //   65: ldc 60
    //   67: iconst_2
    //   68: ldc_w 960
    ...
    //   74: return
    //   75: invokestatic 965	java/lang/System:currentTimeMillis	()J
    //   78: ldc2_w 966
    //   81: ldiv
    //   82: aload_0
    //   83: getfield 968	pab:jdField_a_of_type_Long	J
    //   86: lcmp
    //   87: iflt -29 -> 58
    //   90: new 970	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$ReqBody
    //   93: dup
    //   94: invokespecial 971	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$ReqBody:<init>	()V
    //   97: astore_2
    //   98: aload_2
    //   99: getfield 974	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$ReqBody:bytes_city	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   102: invokestatic 977	akug:a	()Ljava/lang/String;
    ...
    //   111: aload_2
    //   112: getfield 980	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$ReqBody:str_city	Lcom/tencent/mobileqq/pb/PBStringField;
    //   115: invokestatic 982	akug:b	()Ljava/lang/String;
    //   118: invokevirtual 633	com/tencent/mobileqq/pb/PBStringField:set	(Ljava/lang/String;)V
    //   121: aload_0
    //   122: getfield 621	pab:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    ...
    //   133: checkcast 984	ajxn
    //   136: aload_0
    //   137: getfield 621	pab:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    //   140: checkcast 106	com/tencent/mobileqq/app/QQAppInterface
    //   143: invokevirtual 985	com/tencent/mobileqq/app/QQAppInterface:c	()Ljava/lang/String;
    //   146: invokevirtual 988	ajxn:c	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/Friends;
    //   149: astore_3
    //   150: aload_3
    //   151: ifnull +25 -> 176
    //   154: aload_2
    //   155: getfield 991	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$ReqBody:uint32_age	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   158: aload_3
    //   159: getfield 996	com/tencent/mobileqq/data/Friends:age	I
    //   162: invokevirtual 568	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   165: aload_2
    //   166: getfield 999	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$ReqBody:uint32_sex	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   169: aload_3
    //   170: getfield 1003	com/tencent/mobileqq/data/Friends:gender	B
    //   173: invokevirtual 568	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   176: new 1005	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo
    //   179: dup
    //   180: invokespecial 1006	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:<init>	()V
    //   183: astore_3
    //   184: invokestatic 536	onk:f	()Ljava/lang/String;
    //   187: astore 4
    //   189: aload 4
    ...
    //   202: astore 4
    //   204: aload 4
    //   206: invokestatic 544	bdhv:d	(Ljava/lang/String;)Ljava/lang/String;
    //   209: invokevirtual 539	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   212: astore 4
    //   214: aload_3
    //   215: getfield 1007	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:bytes_muid	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   218: aload 4
    ...
    //   226: aload_3
    //   227: getfield 1008	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:uint32_muid_type	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   230: iconst_1
    //   231: invokevirtual 568	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   234: invokestatic 571	njo:a	()I
    //   237: istore_1
    //   238: aload_3
    //   239: getfield 1009	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:uint32_conn	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   242: iload_1
    //   243: invokevirtual 568	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   246: invokestatic 578	bbct:e	()I
    //   249: istore_1
    //   250: aload_3
    //   251: getfield 1010	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:uint32_carrier	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   254: iload_1
    //   255: invokevirtual 568	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   258: invokestatic 583	bbct:e	()Ljava/lang/String;
    //   261: astore 4
    //   263: aload_3
    //   264: getfield 1011	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:bytes_os_ver	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   267: aload 4
    ...
    //   275: invokestatic 588	bbct:c	()Ljava/lang/String;
    //   278: astore 4
    //   280: aload_3
    //   281: getfield 1012	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:bytes_qq_ver	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   284: aload 4
    ...
    //   295: istore_1
    //   296: aload_3
    //   297: getfield 1013	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:bytes_appid	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   300: iload_1
    ...
    //   310: invokestatic 602	fi:a	()J
    //   313: invokestatic 605	fi:a	(J)Ljava/lang/String;
    //   316: astore 4
    //   318: aload_3
    //   319: getfield 1014	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:bytes_client_ip	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   322: aload 4
    ...
    //   330: aload_3
    //   331: getfield 1015	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:uint32_os_type	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   334: iconst_2
    //   335: invokevirtual 568	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   338: aload_2
    //   339: getfield 1018	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$ReqBody:msg_phone_type	Ltencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo;
    //   342: aload_3
    //   343: iconst_1
    //   344: invokevirtual 1019	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:set	(Lcom/tencent/mobileqq/pb/MessageMicro;Z)V
    //   347: invokestatic 1020	osj:a	()Losj;
    //   350: invokevirtual 1023	osj:a	()Lcom/tencent/biz/pubaccount/readinjoy/model/SelectPositionModule;
    //   353: astore_3
    //   354: aload_3
    //   355: ifnull +132 -> 487
    //   358: aload_3
    //   359: invokevirtual 1028	com/tencent/biz/pubaccount/readinjoy/model/SelectPositionModule:a	()Lcom/tencent/biz/pubaccount/readinjoy/model/SelectPositionModule$PositionData;
    //   362: astore_3
    ...
    //   385: aload_3
    //   386: invokevirtual 1033	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    ...
    //   396: ifnull +91 -> 487
    //   399: aload_3
    //   400: getfield 1038	com/tencent/biz/pubaccount/readinjoy/model/SelectPositionModule$PositionData:city	Ljava/lang/String;
    //   403: invokestatic 485	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   406: ifne +81 -> 487
    //   409: new 1040	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$LocationInfo
    //   412: dup
    //   413: invokespecial 1041	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$LocationInfo:<init>	()V
    //   416: astore 4
    //   418: aload 4
    //   420: getfield 1042	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$LocationInfo:bytes_city	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   423: aload_3
    //   424: getfield 1038	com/tencent/biz/pubaccount/readinjoy/model/SelectPositionModule$PositionData:city	Ljava/lang/String;
    ...
    //   433: aload 4
    //   435: getfield 1045	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$LocationInfo:bytes_province	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   438: aload_3
    //   439: getfield 1048	com/tencent/biz/pubaccount/readinjoy/model/SelectPositionModule$PositionData:province	Ljava/lang/String;
    ...
    //   448: aload 4
    //   450: getfield 1051	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$LocationInfo:bytes_country	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   453: aload_3
    //   454: getfield 1054	com/tencent/biz/pubaccount/readinjoy/model/SelectPositionModule$PositionData:country	Ljava/lang/String;
    ...
    //   463: aload 4
    //   465: getfield 1057	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$LocationInfo:bytes_city_code	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   468: aload_3
    //   469: getfield 1060	com/tencent/biz/pubaccount/readinjoy/model/SelectPositionModule$PositionData:cityCode	Ljava/lang/String;
    ...
    //   478: aload_2
    //   479: getfield 1064	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$ReqBody:msg_location_info	Ltencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$LocationInfo;
    //   482: aload 4
    //   484: invokevirtual 1067	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$LocationInfo:set	(Lcom/tencent/mobileqq/pb/MessageMicro;)V
    //   487: aload_0
    //   488: ldc_w 1069
    //   491: sipush 3003
    //   494: iconst_1
    //   495: aload_2
    //   496: invokevirtual 1070	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$ReqBody:toByteArray	()[B
    //   499: invokestatic 644	pow:a	(Ljava/lang/String;II[B)Lcom/tencent/qphone/base/remote/ToServiceMsg;
    //   502: invokevirtual 647	pab:a	(Lcom/tencent/qphone/base/remote/ToServiceMsg;)V
    //   505: return
    //   506: astore 4
    //   508: aload_3
    //   509: getfield 1007	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:bytes_muid	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   512: ldc 181
    ...
    //   526: invokestatic 656	bbct:c	(Landroid/content/Context;)Ljava/lang/String;
    //   529: astore 4
    //   531: aload 4
    ...
    //   552: invokestatic 544	bdhv:d	(Ljava/lang/String;)Ljava/lang/String;
    //   555: invokevirtual 539	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   558: astore 4
    //   560: aload_3
    //   561: getfield 1007	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:bytes_muid	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   564: aload 4
    ...
    //   572: aload_3
    //   573: getfield 1008	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:uint32_muid_type	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   576: iconst_3
  ...
  public void b(int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      ...
      localObject = pow.a("OidbSvc.0x69f", 1695, 0, ((oidb_cmd0x69f.ReqBody)localObject).toByteArray());
      if (paramInt != 0) {
        break label247;
      }
  ...
  public void b(List<oidb_cmd0x69f.ChannelInfo> paramList, int paramInt)
  {
    ...
    for (StringBuilder localStringBuilder = new StringBuilder("saveChannelCoverList channelID=" + paramInt + "\n");; localStringBuilder = null)
    {
      ...
      while (paramList.hasNext())
      {
        ChannelCoverInfo localChannelCoverInfo1 = pot.a((oidb_cmd0x69f.ChannelInfo)paramList.next(), paramInt);
  ...
  public List<qat> c()
  {
    ...
    {
      ArrayList localArrayList = new ArrayList();
      Object localObject2 = bbdj.a(new File(BaseApplicationImpl.getApplication().getDir("readinjoy", 0).getAbsolutePath() + "/channel_section_data"));
        ...
        try
        {
          ...
          while (i < ((JSONArray)localObject2).length())
          {
            ...
            if (localJSONObject != null) {
              localArrayList.add(new qat(localJSONObject));
            }
            i += 1;
          }
        }
  ...
  public void c()
  {
    try
    {
      if (this.jdField_a_of_type_JavaUtilList == null)
      {
        ...
        this.jdField_a_of_type_JavaUtilList.add(new qat(TabChannelCoverInfo.TYPE_CHANNEL_MY_CONFIG, ajyc.a(2131701502), ajyc.a(2131701506)));
        this.jdField_a_of_type_JavaUtilList.add(new qat(TabChannelCoverInfo.TYPE_CHANNEL_RECOMMEND_CONFIG, ajyc.a(2131701509), ajyc.a(2131701520)));
      }
  ...
  {
    int i = pow.a(paramFromServiceMsg, paramObject, new oidb_cmd0xbbc.RspBody());
  ...
  public void c(List<oidb_cmd0xbe6.MsgChannelInfo> paramList, int paramInt)
  {
    ...
    for (StringBuilder localStringBuilder = new StringBuilder("saveChannelCoverList channelID=" + paramInt + "\n");; localStringBuilder = null)
    {
      ...
      while (paramList.hasNext())
      {
        ChannelCoverInfo localChannelCoverInfo = pot.a((oidb_cmd0xbe6.MsgChannelInfo)paramList.next(), paramInt);
  ...
  protected void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int j = pow.a(paramFromServiceMsg, paramObject, paramToServiceMsg);
    if (QLog.isColorLevel()) {
  ...
  protected void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (pow.a(paramFromServiceMsg, paramObject, paramToServiceMsg) == 0) {
      if ((this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof QQAppInterface)) {
