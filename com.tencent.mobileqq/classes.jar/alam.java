...
public class alam
  implements akya, akyg, alad, Handler.Callback, View.OnTouchListener, ARNativeBridge.ARWorldCupCallback
{
  public volatile int a;
  volatile long jdField_a_of_type_Long = -1L;
  private akxz jdField_a_of_type_Akxz = new akxz(this, 1);
  private akyb jdField_a_of_type_Akyb;
  ...
  private alfe jdField_a_of_type_Alfe;
  private alxt jdField_a_of_type_Alxt;
  private alxx jdField_a_of_type_Alxx = new alan(this);
  ...
  public alam(alaf paramalaf, alao paramalao)
  {
    this.jdField_a_of_type_Int = 0;
    this.jdField_b_of_type_Int = 0;
    this.jdField_a_of_type_Alaf = paramalaf;
    this.jdField_a_of_type_Alao = paramalao;
    this.jdField_a_of_type_AndroidContentContext = this.jdField_a_of_type_Alaf.a();
    this.jdField_a_of_type_ComTencentMobileqqArARNativeBridge = ((ARNativeBridge)paramalaf.a(0));
    this.jdField_a_of_type_Akyf = ((akyf)paramalaf.a(8));
    boolean bool = albg.a();
    int j;
    long l;
    if (this.jdField_a_of_type_Boolean)
    {
      paramalaf = this.jdField_a_of_type_AndroidContentContext;
      if (bool)
      {
        j = 5;
        this.jdField_a_of_type_Alxt = new alxt(paramalaf, j);
      }
    }
    else
    {
      ...
      this.jdField_c_of_type_Boolean = albg.jdField_a_of_type_Boolean;
    ...
    label304:
    for (paramalaf = alfa.a().a((Activity)this.jdField_a_of_type_AndroidContentContext);; paramalaf = null)
    {
      this.jdField_a_of_type_Alfe = paramalaf;
      if (this.jdField_a_of_type_Alfe != null)
      {
        this.jdField_a_of_type_Akxz.a();
        this.jdField_a_of_type_Alfe.a(this.jdField_a_of_type_AndroidContentContext);
        akxw.jdField_a_of_type_Int = 9;
      }
  ...
  private void a(int paramInt)
  {
    ...
    case 6: 
      do
      {
        ...
        return;
        this.jdField_a_of_type_Alaf.a(new ARTransferPromotionRenderable.11(this));
  ...
  private void a(int paramInt1, String paramString, boolean paramBoolean1, int paramInt2, boolean paramBoolean2)
  {
    ...
    for (int j = k;; j = 0)
    {
      if ((localFile.exists()) || (j != 0))
      {
        ...
        this.jdField_a_of_type_Akxz.a(paramString, 123456L, paramBoolean1, paramInt2, paramBoolean2);
      }
      return;
    }
  }
  ...
  private void a(float[] arg1, float[] paramArrayOfFloat2, float[] paramArrayOfFloat3, float[] paramArrayOfFloat4, float[] paramArrayOfFloat5)
  {
    ...
    if (this.jdField_e_of_type_Boolean)
    {
      ...
      if (j >= 1)
      {
        ...
        this.jdField_a_of_type_Akyf.b(true);
        ??? = this.jdField_a_of_type_Akyf;
        this.jdField_a_of_type_Akyf.getClass();
        ???.c(6);
  ...
  {
    if (this.jdField_a_of_type_Alfe == null) {}
    while ((!this.jdField_a_of_type_Alfe.a()) || (this.jdField_a_of_type_Alaf.a() == null)) {
      return false;
    }
    paramArrayOfFloat = new float[4];
    float[] arrayOfFloat = new float[3];
    int j = this.jdField_a_of_type_Alaf.a().a();
    FloatBuffer localFloatBuffer = this.jdField_a_of_type_Alfe.a(j, paramArrayOfFloat, arrayOfFloat);
    if ((j == -1) || (localFloatBuffer == null))
    {
      a(-1.0F, -1.0F, -1.0F);
      return false;
    }
    this.jdField_a_of_type_Alaf.a().a(j);
    this.jdField_a_of_type_Alaf.a().a(localFloatBuffer, this.jdField_a_of_type_Alfe.a());
  ...
  private void i()
  {
    if (this.jdField_a_of_type_Alfe != null)
    {
      ...
      alkv.a().e();
      this.jdField_a_of_type_Alfe.a(this.jdField_f_of_type_Int, this.jdField_g_of_type_Int);
      this.jdField_a_of_type_Alfe.c();
    }
  }
  
  private void j()
  {
    if ((this.jdField_a_of_type_Bfmt != null) && (!this.jdField_a_of_type_Bfmt.hasMessages(1105))) {
      this.jdField_a_of_type_Bfmt.sendEmptyMessageDelayed(1105, 200L);
    }
  ...
  private void k()
  {
    ...
    {
      this.jdField_a_of_type_Bfmt.removeMessages(1105);
      this.jdField_a_of_type_Akyf.a(false, "");
    }
  ...
  public String a()
  {
    return this.jdField_a_of_type_Alao.jdField_a_of_type_JavaLangString;
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Akyf.f();
    this.jdField_a_of_type_Akyf.a(false, "");
    axqw.b(null, "CliOper", "", "", "0X80098C8", "0X80098C8", 0, 0, this.jdField_a_of_type_Alao.jdField_a_of_type_JavaLangString, "0", "0", "");
  ...
  {
    a((float[])paramalal.a("TARGET_SIZE"), (float[])paramalal.a("POSE"), (float[])paramalal.a("CAMERA_MATRIX"), (float[])paramalal.a("CAMERA_POSITION"), paramalal.a);
  }
  ...
  public int b()
  {
    return this.jdField_a_of_type_Alao.jdField_a_of_type_Int;
  }
  
  public String b()
  {
    return this.jdField_a_of_type_Alao.c;
  }
  ...
  public int c()
  {
    return this.jdField_a_of_type_Alao.jdField_b_of_type_Int;
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Akyf.a(this);
    if (!this.jdField_a_of_type_Alao.jdField_a_of_type_JavaLangBoolean.booleanValue()) {
      this.jdField_a_of_type_Akyf.e();
    }
    if ((this.jdField_a_of_type_Alxt != null) && (this.jdField_a_of_type_Boolean)) {
      QLog.d("ARTransferPromotionRenderable", 2, String.format("setNativeState start sensor result=%s", new Object[] { Boolean.valueOf(this.jdField_a_of_type_Alxt.a(this.jdField_a_of_type_Alxx)) }));
    }
  }
  
  public boolean c()
  {
    return !this.jdField_a_of_type_Alao.jdField_a_of_type_JavaLangBoolean.booleanValue();
  }
  ...
  public void f()
  {
    ...
    if (this.jdField_a_of_type_Bfmt != null) {
      this.jdField_a_of_type_Bfmt.removeCallbacks(this.jdField_a_of_type_JavaLangRunnable);
    }
    ...
    if (this.jdField_a_of_type_Alaf != null) {
      this.jdField_a_of_type_Alaf.a(local7);
    }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if ((this.jdField_a_of_type_Akxz != null) && (this.jdField_a_of_type_Akxz.a()) && (this.jdField_a_of_type_Akyh != null))
    {
      long l = this.jdField_a_of_type_Akxz.a();
      paramMessage = this.jdField_a_of_type_Akyh.a(l);
    ...
    for (;;)
    {
      ...
      return false;
      label98:
      this.jdField_a_of_type_Akyf.a(true, paramMessage.jdField_a_of_type_JavaLangString);
    }
  }
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    if (this.jdField_b_of_type_Int == 4)
    {
      ...
      if ((this.jdField_a_of_type_Alaf != null) && (this.jdField_a_of_type_ComTencentMobileqqArARNativeBridge != null)) {
        this.jdField_a_of_type_Alaf.a(new ARTransferPromotionRenderable.17(this, paramView));
      }
