  ...
  implements alaf
{
  ...
  public alam(@NonNull String paramString1, @NonNull QQAppInterface paramQQAppInterface, @Nullable String paramString2, int paramInt, @Nullable Bundle paramBundle, boolean paramBoolean)
  {
  ...
  public void onEnter()
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.recent.banner", 2, "onEnter: " + this.jdField_a_of_type_Alah + " / " + this.b + " / " + this.jdField_a_of_type_Int + " / " + this.jdField_a_of_type_JavaLangString);
    }
    if (this.jdField_a_of_type_Alah == null) {}
    QQAppInterface localQQAppInterface;
    do
