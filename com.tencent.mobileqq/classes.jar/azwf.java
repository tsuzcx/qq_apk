...
public class azwf
{
  static final String jdField_a_of_type_JavaLangString = azwf.class.getSimpleName();
  ...
  public byte[] a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    //   27: astore 4
    //   29: aload_0
    //   30: getfield 29	azwf:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   33: aload 4
    ...
    //   45: ifeq +65 -> 110
    //   48: getstatic 18	azwf:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   51: astore 5
    //   53: aload_1
    //   54: ifnonnull +34 -> 88
    //   57: iconst_0
