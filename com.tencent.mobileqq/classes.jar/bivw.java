...
public class bivw
{
  private static String jdField_a_of_type_JavaLangString = bivw.class.getSimpleName();
  private double jdField_a_of_type_Double = 1.0D;
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private SurfaceTexture jdField_a_of_type_AndroidGraphicsSurfaceTexture;
  private Handler jdField_a_of_type_AndroidOsHandler;
  private bisx jdField_a_of_type_Bisx = new bisx();
  ...
  public bivw(String paramString, List<List<List<PointF>>> paramList, List<List<float[]>> paramList1, double paramDouble)
  {
  ...
  public void a(bivx parambivx)
  {
    ...
    this.jdField_b_of_type_JavaLangString = (biix.jdField_b_of_type_JavaLangString + File.separator + System.currentTimeMillis());
    try
    {
