...
public class lkm
{
      ...
      try
      {
        if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() > 0)
        {
          ...
          if (localIterator.hasNext())
          {
            ...
            localObject2 = localObject1;
            if (lbz.a().c((String)localObject3) == null)
            {
              localObject2 = localObject1;
    ...
    for (;;)
    {
      ...
      if (c.equals(paramString))
      {
        ...
        if ((j == 1) || (j == 3000))
        {
          ...
          label155:
          paramIntent = lbz.a(i, paramString, new int[0]);
      ...
      do
      {
        for (;;)
        {
          ...
          paramString = lbz.a(i, String.valueOf(l), new int[0]);
      ...
      for (;;)
      {
        paramString = lbz.a(i, (String)localObject2, new int[0]);
        localObject1 = paramString;
        if (localStringBuilder == null) {
          break;
        }
  ...
  public boolean a(BaseActivity paramBaseActivity)
  {
    ...
    lfe locallfe = lbz.a().a();
    if (locallfe != null) {}
    for (Object localObject1 = locallfe.c;; localObject1 = null)
    {
      if (!TextUtils.isEmpty((CharSequence)localObject1)) {}
      for (Intent localIntent = b(locallfe.c);; localIntent = null)
      {
        label74:
        boolean bool1;
        if (localIntent != null)
