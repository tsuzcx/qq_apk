...
public class bltj
{
  ...
  public static void a(long paramLong, Activity paramActivity, String paramString, bltl parambltl)
  {
    ...
    bltk localbltk2 = b();
    if (QLog.isColorLevel()) {
      QLog.d("QZoneVideoCommonUtils", 2, "support record=" + localbltk1.a() + ", support trim=" + localbltk2.a());
    }
    if ((!localbltk1.a()) && (!localbltk2.a()))
    {
      if (localbltk1.b()) {}
      for (paramString = localbltk1.a();; paramString = null)
      {
        String str;
        if (paramString != null)
        {
        ...
        {
          str = paramActivity.getString(2131716803);
        }
        if (parambltl != null) {
          parambltl.onFail(paramActivity, str);
        }
        if (!QLog.isColorLevel()) {
          break;
        }
        QLog.w("QZoneVideoCommonUtils", 2, "qzone video is not supported, recordSupport tips=" + localbltk1.a() + ",trimSupport tips=" + localbltk2.a() + ",show tips=" + str);
        return;
      }
    }
    a(paramLong, paramActivity, localbltk1.a(), localbltk2.a(), paramString);
    PerfTracer.traceEnd("Video_component_pre_launch");
  }
  
  public static void a(long paramLong, Activity paramActivity, String paramString, bltl parambltl, Bundle paramBundle)
  {
    PerfTracer.traceStart("Video_component_pre_launch");
    if (paramActivity == null)
    {
    ...
    if ((!localbltk1.a()) && (!localbltk2.a()))
    {
      ...
      for (paramString = localbltk1.a();; paramString = null)
      {
        ...
        {
          paramBundle = paramActivity.getString(2131716803);
        }
        if (parambltl != null) {
          parambltl.onFail(paramActivity, paramBundle);
        }
        if (!QLog.isColorLevel()) {
          break;
        }
        QLog.w("QZoneVideoCommonUtils", 2, "qzone video is not supported, recordSupport tips=" + localbltk1.a() + ",trimSupport tips=" + localbltk2.a() + ",show tips=" + paramBundle);
        return;
      }
    }
