...
public class apcy
{
  private static apcy jdField_a_of_type_Apcy;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver;
  public QQAppInterface a;
  private List<apdf> jdField_a_of_type_JavaUtilList = new ArrayList();
  private Map<String, apdd> jdField_a_of_type_JavaUtilMap = new HashMap();
  private boolean jdField_a_of_type_Boolean = false;
  private Map<String, apwk> jdField_b_of_type_JavaUtilMap = new HashMap();
  ...
  private int a(String paramString)
  {
    ...
    {
      apdd localapdd = (apdd)this.jdField_a_of_type_JavaUtilMap.remove(paramString);
      if (localapdd != null)
      {
        apwk localapwk = a(paramString);
        if ((localapdd.jdField_a_of_type_Apwh != null) && (localapwk != null)) {
          localapdd.jdField_a_of_type_Apwh.a(localapwk);
        }
      }
  ...
  private int a(String paramString, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      catch (UnsupportedEncodingException localUnsupportedEncodingException)
      {
        ...
        int k = localUnsupportedEncodingException.jdField_a_of_type_Apwh.f();
      ...
      if ((localObject2 == null) && (paramBundle.containsKey("big_brother_source_key")))
      {
        ...
        if ((localObject2 != null) && ((localObject2 == null) || (((apdd)localObject2).jdField_a_of_type_Apwh != null))) {
          break label201;
        }
    ...
    localUnsupportedEncodingException.jdField_a_of_type_Apwh.a(paramString);
    localUnsupportedEncodingException.jdField_a_of_type_Apwh.a(paramString, false);
    return 0;
    d(paramString);
    return 0;
    a(paramString);
  ...
  private int a(String paramString1, String paramString2, long paramLong, String paramString3, Bundle paramBundle, int paramInt, boolean paramBoolean)
  {
    ...
    long l = a();
    apwh localapwh = new apwh(l, paramString1, paramBundle);
    ...
    if (1 == localapwh.g())
    {
      ...
      paramInt = apdg.a().a(localapwh, (Bundle)localObject, l, paramInt);
      a(paramString1, new apdd(this, null, localapwh.g(), localapwh, l, paramInt));
      if (!paramBoolean) {
        break label435;
      }
    ...
    for (;;)
    {
      ...
      {
        localapwh.a(true);
        apdg.a().b(paramInt, (Bundle)localObject);
      }
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
        if (1 == localapwh.g()) {
          axrk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "Start_download_2-0_3-0");
        } else if (2 == localapwh.g()) {
          axrk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "Start_download_2-0_3-1");
        }
      }
    }
  }
  ...
  public static apcy a()
  {
    try
    {
      ...
      apcy localapcy = jdField_a_of_type_Apcy;
      return localapcy;
    }
    finally {}
  }
  
  private apdd a(String paramString)
  {
    synchronized (this.jdField_a_of_type_JavaUtilMap)
    {
      paramString = (apdd)this.jdField_a_of_type_JavaUtilMap.get(paramString);
      return paramString;
    }
  }
  
  private apde a(String paramString)
  {
    if (paramString == null)
    {
  ...
  private apdf a(String paramString)
  {
    if (paramString == null)
    {
    ...
    return new apdf(arrayOfString[0], Integer.parseInt(arrayOfString[1]));
  }
  
  private apwk a(String paramString)
  {
    if (paramString == null) {
      paramString = null;
    }
    for (;;)
    {
      ...
      try
      {
        paramString = (apwk)this.jdField_b_of_type_JavaUtilMap.get(paramString);
      }
      finally {}
    }
  }
  
  private String a(apde paramapde)
  {
    if (paramapde == null)
    {
    ...
    return String.valueOf(paramapde.jdField_a_of_type_Int) + "^" + paramapde.jdField_a_of_type_JavaLangString + "^" + String.valueOf(paramapde.jdField_a_of_type_Long) + "^" + String.valueOf(paramapde.jdField_a_of_type_Boolean) + "^" + paramapde.b;
  }
  
  private String a(apdf paramapdf)
  {
    if (paramapdf == null)
    {
    ...
    return String.valueOf(paramapdf.jdField_a_of_type_JavaLangString) + "^" + String.valueOf(paramapdf.jdField_a_of_type_Int);
  }
  
  private void a(String paramString, apwk paramapwk)
  {
    if ((paramString != null) && (paramapwk != null)) {}
    try
    {
      this.jdField_b_of_type_JavaUtilMap.put(paramString, paramapwk);
      return;
    }
    finally
    {
  ...
  private boolean a(String paramString, apdd paramapdd)
  {
    if ((paramString == null) || (paramapdd == null))
    {
    ...
    this.jdField_a_of_type_JavaUtilMap.put(paramString, paramapdd);
  ...
  {
    int i = 0;
    if ((bbev.d(BaseApplication.getContext())) && (!apue.a())) {}
    for (int m = 2;; m = 1)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaUtilMap)
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          int n = j;
          k = i;
          if (localapdd.jdField_a_of_type_Apwh != null)
          {
            n = j;
            k = i;
            if (localapdd.jdField_a_of_type_Apwh.b())
            {
              i += 1;
              n = j;
              k = i;
              if (paramString != null)
              {
                n = j;
                k = i;
                if (paramString.equalsIgnoreCase(localapdd.jdField_a_of_type_JavaLangString))
                {
          ...
          ((List)localObject2).add(localapdd);
          j = n;
          i = k;
        }
      }
      ...
      for (;;)
      {
        if (j < m)
        {
          ...
          if (((Iterator)???).hasNext())
          {
            localObject2 = (apdd)((Iterator)???).next();
            k = j;
            if (((apdd)localObject2).jdField_a_of_type_Apwh == null) {
              break label526;
            }
            k = j;
            if (!((apdd)localObject2).jdField_a_of_type_Apwh.a()) {
              break label526;
            }
            if (j < m)
            {
              QLog.i("UniformDownloadMgr<FileAssistant>", 1, "[UniformDL] >>> Happy. start a download task, url:[" + ((apdd)localObject2).jdField_a_of_type_JavaLangString + "]");
              j += 1;
              ((apdd)localObject2).jdField_a_of_type_Apwh.a();
              k = j;
              if (paramString == null) {
                break label526;
              }
              k = j;
              if (!paramString.equalsIgnoreCase(((apdd)localObject2).jdField_a_of_type_JavaLangString)) {
                break label526;
              }
  ...
  private int b(String paramString, Bundle paramBundle)
  {
    ...
    if (-1 == c(paramString))
    {
      apwc.a(paramString, new apdc(this));
      apdg.a().a(i, (Bundle)paramBundle.clone());
      b(null);
    }
    return 0;
  }
  
  private apwk b(String paramString)
  {
    try
    {
      paramString = (apwk)this.jdField_b_of_type_JavaUtilMap.remove(paramString);
      return paramString;
    }
    finally
    {
  ...
  {
    apdd localapdd = a(paramString);
    if (localapdd != null)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
      {
        if (localapdd.jdField_a_of_type_Int != 1) {
          break label71;
        }
        axrk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "Stop_download_2-2_3-0");
      }
      for (;;)
      {
        if (localapdd.jdField_a_of_type_Apwh != null) {
          localapdd.jdField_a_of_type_Apwh.b();
        }
        b(null);
        return 0;
        label71:
        axrk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "Stop_download_2-2_3-1");
      }
    }
  ...
  private int d(String paramString)
  {
    ...
    if (localapdd != null)
    {
      if (localapdd.jdField_a_of_type_Apwh != null)
      {
        paramString = a(paramString);
        if (paramString != null) {
          localapdd.jdField_a_of_type_Apwh.a(paramString, false);
        }
        localapdd.jdField_a_of_type_Apwh.c();
      }
      b(null);
      return 0;
    }
  ...
  private int e(String paramString)
  {
    ...
    {
      if (localapdd.jdField_a_of_type_Apwh != null) {
        localapdd.jdField_a_of_type_Apwh.d();
      }
      return 0;
    }
  ...
  private void g(String paramString, Bundle paramBundle)
  {
    ...
    axtn.a().addDownloadURL(paramString);
    HashMap localHashMap = new HashMap();
    localHashMap.put("url", paramString);
    localHashMap.put("NetworkType", bbev.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()) + "");
    if (bdgu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) {}
    Object localObject2;
    ...
    for (;;)
    {
      try
      {
        ...
        axrl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), "UniformDownloadEvent_NO_SOURCE", true, 0L, 0L, localHashMap, "");
        ...
        axqw.b(null, "dc00898", "", "", "0X800A003", "0X800A003", 0, 0, paramBundle, (String)localObject1, (String)localObject2, paramString);
      }
      ...
      axrl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), "UniformDownloadEvent", true, 0L, 0L, localHashMap, "");
      paramBundle = (String)localHashMap.get("isForeground");
      localObject1 = (String)localHashMap.get("isAPK");
      localObject2 = paramString.toString();
      localStringBuilder = new StringBuilder().append((String)localHashMap.get("Stack"));
      ...
      paramString = (String)localHashMap.get("Stack1");
      axqw.b(null, "dc00898", "", "", "0X800A002", "0X800A002", 0, 0, paramBundle, (String)localObject1, (String)localObject2, paramString);
    }
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if ((??? != null) && (((Map)???).size() > 0))
        {
          ...
          if (localIterator.hasNext())
          {
            apdf localapdf = a((String)((Map.Entry)localIterator.next()).getKey());
            if (localapdf == null) {
              break label207;
            }
            QLog.i("UniformDownloadMgr<FileAssistant>", 1, "[UniformDL] initSucDownloadInfo, pkgName:[" + localapdf.jdField_a_of_type_JavaLangString + "]] nId:[" + localapdf.jdField_a_of_type_Int + "] ");
            synchronized (this.jdField_a_of_type_JavaUtilList)
            {
              this.jdField_a_of_type_JavaUtilList.add(localapdf);
            }
          }
        }
        return;
  ...
  public List<apdf> a(String paramString, boolean paramBoolean)
  {
    if (paramString == null) {
      return null;
    }
    ...
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      ...
      {
        localapdf = (apdf)localIterator.next();
        if ((localapdf != null) && (paramString.equalsIgnoreCase("package:" + localapdf.jdField_a_of_type_JavaLangString))) {
          localArrayList.add(localapdf);
        }
      }
    }
    if ((localArrayList.size() > 0) && (paramBoolean))
    {
      ...
      try
      {
        ...
        {
          localapdf = (apdf)localIterator.next();
          this.jdField_a_of_type_JavaUtilList.remove(localapdf);
          paramString.remove(a(localapdf));
          continue;
      ...
      try
      {
        ...
        if ((localObject1 != null) && (((Map)localObject1).size() > 0))
        {
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            QLog.i("UniformDownloadMgr<FileAssistant>", 1, "[UniformDL] getDownloadingRbResmeInfo, url:[" + str + "]] nId:[" + ((apde)localObject2).jdField_a_of_type_Int + "] w:[" + ((apde)localObject2).jdField_a_of_type_Boolean + "]");
  ...
  public void a(apdf paramapdf)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      this.jdField_a_of_type_JavaUtilList.add(paramapdf);
      QLog.i("UniformDownloadMgr<FileAssistant>", 1, "[UniformDL] saveSucDownloadInfo. pkgName:" + paramapdf.jdField_a_of_type_JavaLangString + " notificationId:" + paramapdf.jdField_a_of_type_Int + " size:" + this.jdField_a_of_type_JavaUtilList.size());
      try
      {
        ??? = BaseApplication.getContext().getSharedPreferences("download_suc_info", 0).edit();
        ((SharedPreferences.Editor)???).putString(a(paramapdf), "-");
        ((SharedPreferences.Editor)???).commit();
        return;
      }
      catch (Exception paramapdf)
      {
        paramapdf.printStackTrace();
        return;
      }
    }
  }
  ...
  {
    apwk localapwk = b(paramString);
    if (!TextUtils.isEmpty(paramString))
    {
      paramString = a(paramString);
      if ((paramString != null) && (paramString.jdField_a_of_type_Apwh != null) && (localapwk != null)) {
        paramString.jdField_a_of_type_Apwh.a(localapwk);
      }
    }
  }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaUtilList)
      {
        ...
        if (localIterator.hasNext())
        {
          localObject = (apdf)localIterator.next();
          if ((localObject == null) || (!paramString.equalsIgnoreCase(((apdf)localObject).jdField_a_of_type_JavaLangString)) || (paramInt != ((apdf)localObject).jdField_a_of_type_Int)) {
            continue;
          }
          if (localObject != null)
          {
          ...
          try
          {
            ...
            ((SharedPreferences.Editor)localObject).remove(a(new apdf(paramString, paramInt)));
  ...
  public void a(String paramString, Bundle paramBundle, apwk paramapwk)
  {
    apwk localapwk = a(paramString);
    a(paramString, paramapwk);
    ThreadManager.getSubThreadHandler().post(new UniformDownloadMgr.9(this, paramBundle, paramString, localapwk));
  }
  
  public void a(String paramString1, String paramString2)
  {
    apwc.a(paramString1, new apda(this, paramString1, paramString2));
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3, long paramLong, Bundle paramBundle, int paramInt, boolean paramBoolean)
  {
    try
    {
      ...
      apde localapde = new apde(this);
      localapde.jdField_a_of_type_Int = paramInt;
      localapde.jdField_a_of_type_JavaLangString = paramString2;
      if (!TextUtils.isEmpty(paramString3)) {}
      for (localapde.b = paramString3;; localapde.b = paramString2)
      {
        localapde.jdField_a_of_type_Long = paramLong;
        localapde.jdField_a_of_type_Boolean = paramBoolean;
        localapde.jdField_a_of_type_AndroidOsBundle = paramBundle;
        localEditor.putString(paramString1, a(localapde));
        localEditor.commit();
        return;
      }
      return;
  ...
  public void c()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilMap)
    {
      if (this.jdField_a_of_type_JavaUtilMap.size() > 0)
      {
        ...
        {
          apdd localapdd = (apdd)((Map.Entry)localIterator.next()).getValue();
          if ((localapdd.jdField_a_of_type_Apwh != null) && (localapdd.jdField_a_of_type_Apwh.b())) {
            QLog.i("UniformDownloadMgr<FileAssistant>", 1, "[UniformDL] >>>onQQProcessExit. stop download:url:" + localapdd.jdField_a_of_type_JavaLangString);
          }
          Bundle localBundle = new Bundle();
          localBundle.putString("_notify_param_Url", localapdd.jdField_a_of_type_JavaLangString);
          apdg.a().c(localapdd.b, localBundle);
          QLog.i("UniformDownloadMgr<FileAssistant>", 1, "[UniformDL] >>>onQQProcessExit. cancel notification:" + localapdd.b);
        }
      }
    }
    e();
