  ...
  extends aoxs
{
  ...
  private acnf jdField_a_of_type_Acnf;
  private bfgn jdField_a_of_type_Bfgn;
  private volatile boolean jdField_a_of_type_Boolean;
  private bfgn jdField_b_of_type_Bfgn;
  private volatile boolean jdField_b_of_type_Boolean;
  private bfgn c;
  
  public acng(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager, acne paramacne)
  {
    super(paramQQAppInterface, paramProxyManager);
    this.jdField_a_of_type_Acne = paramacne;
    this.jdField_a_of_type_Acnf = new acnf(paramQQAppInterface, paramProxyManager, paramacne);
    this.jdField_a_of_type_Bfgn = new bfgn(paramQQAppInterface, paramProxyManager, paramacne);
    this.jdField_b_of_type_Bfgn = new bfgn(paramQQAppInterface, paramProxyManager, paramacne);
    this.c = new bfgn(paramQQAppInterface, paramProxyManager, paramacne);
  }
  
  public acnf a(int paramInt)
  {
    switch (paramInt)
    {
    default: 
      return this.jdField_a_of_type_Acnf;
    case 1: 
      return this.jdField_a_of_type_Bfgn;
    case 3000: 
      return this.jdField_b_of_type_Bfgn;
    }
    return this.c;
  }
    ...
    for (;;)
    {
      ...
      try
      {
        if (!this.jdField_a_of_type_Boolean)
        {
          ...
          this.jdField_a_of_type_Bfgn.a();
          this.jdField_b_of_type_Bfgn.a();
          this.jdField_a_of_type_Acnf.a();
          this.c.a();
          localList1 = ((ProxyManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.PROXY_MANAGER)).a().getRecentList(true);
          if (localList1 == null) {
            return;
          }
      ...
      if (((RecentUser)localList1.get(k)).getType() != 6000)
      {
        if ((((RecentUser)localList1.get(k)).getType() == 0) && (AppConstants.TROOP_SYSTEM_MSG_UIN.equals(((RecentUser)localList1.get(k)).uin))) {
          bdzy.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        }
        localObject1 = this.jdField_a_of_type_Acne.a(((RecentUser)localList1.get(k)).uin, ((RecentUser)localList1.get(k)).getType());
        ...
        try
        {
          ...
          {
            this.jdField_a_of_type_Acne.b().put(acnh.a(((RecentUser)localList1.get(k)).uin, ((RecentUser)localList1.get(k)).getType()), localList2);
  ...
  protected void b()
  {
    this.jdField_a_of_type_Bfgn.b();
    this.jdField_b_of_type_Bfgn.b();
    this.jdField_a_of_type_Acnf.b();
    this.c.b();
  }
