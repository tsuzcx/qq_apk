...
{
  public aqrl(MessageForQQWalletTips paramMessageForQQWalletTips, SoftReference paramSoftReference1, SoftReference paramSoftReference2, QQAppInterface paramQQAppInterface, Context paramContext, afsd paramafsd, ajul paramajul, int paramInt) {}
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletTips.bytes_jumpurl))
      {
        ...
        paramView = bkvx.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletTips.bytes_jumpurl, MessageForQQWalletTips.access$100(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletTips, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), true);
        akgc.a(this.jdField_a_of_type_AndroidContentContext, paramView);
        return;
      }
      if ((MessageForQQWalletTips.access$200(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletTips) != 524288) || (this.jdField_a_of_type_Afsd == null) || (this.jdField_a_of_type_Ajul == null)) {
        break;
      }
      localObject2 = this.jdField_a_of_type_Ajul.a(MessageForQQWalletTips.access$300(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletTips));
      if ((localObject2 == null) || (((ajuk)localObject2).a) || (((ajuk)localObject2).b) || (((ajuk)localObject2).a())) {
        break;
      }
      paramView = this.jdField_a_of_type_Ajul;
    } while (StringUtil.isEmpty(ajul.a(((ajuk)localObject2).e)));
    this.jdField_a_of_type_Afsd.a(MessageForQQWalletTips.access$300(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletTips), ((ajuk)localObject2).e, this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletTips.subChannel);
    return;
