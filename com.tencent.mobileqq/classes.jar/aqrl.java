...
public class aqrl
{
  ...
  public static Point a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      paramQQAppInterface = bhhr.a(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentUin());
  ...
  private static void a(Context paramContext, int paramInt)
  {
    ...
    if ((paramInt == 3) && (aqny.c())) {}
    while (ColorNoteSmallScreenPermissionDialogFragment.jdField_a_of_type_Boolean) {
      return;
    }
    aeow.a(paramContext, PublicTransFragmentActivity.class, ColorNoteSmallScreenPermissionDialogFragment.class);
  }
  ...
  public static void a(Context paramContext, boolean paramBoolean1, boolean paramBoolean2, ColorNote paramColorNote)
  {
    for (;;)
    {
      try
      {
        ...
        if ((!aqqx.a(paramContext)) && (paramBoolean1)) {
          a(paramContext, i);
        }
  ...
  public static void b(Context paramContext)
  {
    ...
    //   25: getstatic 80	aqrl:jdField_a_of_type_Boolean	Z
    ...
    //   47: astore_1
    //   48: iconst_0
    //   49: putstatic 80	aqrl:jdField_a_of_type_Boolean	Z
    //   52: aload_0
    //   53: aload_1
