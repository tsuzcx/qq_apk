  ...
  extends bkhw
{
  ...
  public bkam(bkaj parambkaj)
  {
    this(parambkaj, new bkal(0.0F, 0.0F, 1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F));
    this.jdField_b_of_type_AndroidGraphicsPointF.set(parambkaj.jdField_a_of_type_AndroidGraphicsPointF);
    this.jdField_j_of_type_Int = vzo.a(BaseApplicationImpl.getContext(), 15.0F);
  }
  
  public bkam(bkaj parambkaj, @NonNull bkal parambkal)
  {
    super(parambkal.jdField_a_of_type_AndroidGraphicsPointF, parambkal.jdField_a_of_type_Float, parambkal.jdField_b_of_type_Float, parambkal.jdField_c_of_type_Float, parambkal.jdField_d_of_type_Float, parambkal.e, parambkal.jdField_f_of_type_Float, true);
    this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem = new bjhs();
    ...
    this.jdField_a_of_type_Float = bkaj.jdField_a_of_type_Int;
    this.jdField_j_of_type_Int = vzo.a(BaseApplicationImpl.getContext(), 15.0F);
  }
  
  public bkam(bkaj parambkaj, @NonNull bkam parambkam)
  {
    super(parambkam, 1.0F);
    if (parambkam.jdField_a_of_type_AndroidGraphicsRect == null) {}
    for (this.jdField_a_of_type_AndroidGraphicsRect = new Rect(0, 0, 0, 0);; this.jdField_a_of_type_AndroidGraphicsRect = new Rect(parambkam.jdField_a_of_type_AndroidGraphicsRect))
    {
      ...
      this.jdField_c_of_type_Float = parambkam.jdField_c_of_type_Float;
      this.jdField_d_of_type_Float = parambkam.jdField_d_of_type_Float;
      this.e = parambkam.e;
      this.jdField_f_of_type_Float = parambkam.jdField_f_of_type_Float;
      this.jdField_g_of_type_Float = parambkam.jdField_g_of_type_Float;
      this.jdField_h_of_type_Float = parambkam.jdField_h_of_type_Float;
      this.i = parambkam.i;
      this.jdField_j_of_type_Int = vzo.a(BaseApplicationImpl.getContext(), 15.0F);
      a(parambkam);
      return;
  ...
  private void b(Canvas paramCanvas)
  {
    ...
    if (this.jdField_k_of_type_Int == 0)
    {
      ...
      if (!bkaj.b(this.jdField_a_of_type_Bkaj).a.e()) {
        break label133;
      }
      k = -1;
      j = -1;
    ...
    for (;;)
    {
      bkht.a(paramCanvas, this.jdField_a_of_type_Bkaj.jdField_a_of_type_Bkhv, this, j, m, k);
      paramCanvas.restore();
      return;
      j = 2130843818;
      break;
  ...
  private void f()
  {
    ...
    localValueAnimator.setDuration(bkaj.e);
    localValueAnimator.addUpdateListener(new bkan(this));
  ...
  private void g()
  {
    ...
    localValueAnimator.setInterpolator(new AccelerateDecelerateInterpolator());
    localValueAnimator.setDuration(bkaj.e);
    localValueAnimator.addUpdateListener(new bkao(this));
    localValueAnimator.start();
  }
  ...
  protected void a()
  {
    ...
    this.jdField_f_of_type_Float = (this.jdField_a_of_type_Bkaj.n - this.jdField_b_of_type_AndroidGraphicsPointF.x - this.jdField_d_of_type_Float);
    this.jdField_g_of_type_Float = (this.jdField_a_of_type_Bkaj.o - this.jdField_b_of_type_AndroidGraphicsPointF.y - this.e);
  ...
  {
    if ((!this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper.isInSegment(bkaj.a(this.jdField_a_of_type_Bkaj).a())) && (!this.jdField_k_of_type_Boolean)) {}
    do
    {
      return;
      ...
      if ((this.jdField_d_of_type_Boolean) && (this.jdField_k_of_type_Boolean))
      {
        if ((this.jdField_g_of_type_Boolean) && (this.jdField_h_of_type_Boolean))
        {
          ...
          paramCanvas.drawLine(f2 + f1, f4 + f3, f6 + f5, this.t + f7, this.jdField_a_of_type_Bkaj.jdField_a_of_type_AndroidGraphicsPaint);
          paramCanvas.save();
          paramCanvas.concat(this.jdField_a_of_type_Bkaj.jdField_a_of_type_Bkhv.b(this));
          int j = (int)(this.u * this.q * this.w) + this.jdField_j_of_type_Int * 2;
          int k = (int)(this.v * this.q * this.w) + this.jdField_j_of_type_Int * 2;
          paramCanvas.drawRect(new RectF(-j / 2, -k / 2, j / 2, k / 2), bkaj.a(this.jdField_a_of_type_Bkaj));
          paramCanvas.restore();
        }
      ...
      paramCanvas.save();
      paramCanvas.concat(this.jdField_a_of_type_Bkaj.jdField_a_of_type_Bkhv.a(this));
