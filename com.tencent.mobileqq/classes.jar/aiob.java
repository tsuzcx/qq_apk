...
public class aiob
  implements azwh
{
  ajjh jdField_a_of_type_Ajjh = new aioc(this);
  ...
  public aiob(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(int paramInt1, String paramString, int paramInt2)
  {
    ...
    do
    {
      ...
      default: 
        return;
      case 1: 
        localObject = babh.c((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), paramString, true);
        if ((!azge.b((String)localObject)) || (!((String)localObject).equals(paramString))) {
          break label147;
        }
    ...
    aind.a().callbackResult(paramInt1, paramString);
    return;
    Object localObject = this.jdField_a_of_type_Azwg.a(1, String.valueOf(paramString), 0, (byte)1);
    if (localObject != null)
    {
      if (QLog.isColorLevel()) {
    ...
    this.jdField_a_of_type_Azwg.a(paramString, 200, false, 1, true, (byte)0, 1);
  }
