  ...
  extends azwo
{
  ...
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new baaw(this);
  private baar jdField_a_of_type_Baar = new baar();
  private float jdField_b_of_type_Float;
  private final int jdField_b_of_type_Int = 500;
  
  public baav(azxt paramazxt, azrb paramazrb)
  {
  ...
  {
    int i = aogw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin(), false);
    if (QLog.isColorLevel()) {
    ...
    {
      this.jdField_a_of_type_Baar.removeMessages(paramPrivilegeInfo.iType);
      ...
      this.jdField_a_of_type_Baar.sendMessageDelayed(paramDrawable, 500L);
      if (paramPrivilegeInfo.iType == 1) {
        a("0X800B27D", i);
      }
    }
  ...
  private void a(PrivilegeInfo paramPrivilegeInfo, String paramString, LinearLayout paramLinearLayout, int paramInt1, int paramInt2, int paramInt3, Drawable paramDrawable, boolean paramBoolean)
  {
    ...
    if (!TextUtils.isEmpty(paramPrivilegeInfo.strJumpUrl))
    {
      ...
      paramString.setTag(new azpb(93, paramPrivilegeInfo));
    ...
    for (;;)
    {
      ...
      {
        paramPrivilegeInfo = String.valueOf(aogw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin(), false));
      }
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "qvip", paramString, paramInt1, 0, paramPrivilegeInfo, "", "", "");
      return;
  ...
  {
    bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin(), paramString, paramString, paramInt, 0, String.valueOf(paramInt), "", "", "");
  }
  ...
  private View b(PrivilegeInfo paramPrivilegeInfo, String paramString, float paramFloat1, float paramFloat2, float paramFloat3, Drawable paramDrawable)
  {
    ...
    if (paramDrawable != null)
    {
      ...
      localURLImageView.setURLDrawableDownListener(new birx(localURLImageView, paramString, "showDiamondImage onLoadFailed iconUrl = "));
  ...
  public void a(azrb paramazrb, View paramView)
  {
    if ((paramazrb == null) || (paramazrb.jdField_a_of_type_ComTencentMobileqqDataCard == null) || (paramView == null)) {
      return;
    }
    paramView.setVisibility(0);
    Object localObject3 = paramazrb.jdField_a_of_type_ComTencentMobileqqDataCard;
    Object localObject1 = ((Card)localObject3).getPrivilegeOpenInfo();
    Object localObject2 = ((Card)localObject3).getPrivilegeCloseInfo();
    TextView localTextView = (TextView)paramView.findViewById(2131373260);
    paramView = (LinearLayout)paramView.findViewById(2131365688);
    paramView.removeAllViews();
    StringBuilder localStringBuilder = new StringBuilder(24);
    localStringBuilder.append(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131693235));
    if ((paramazrb.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Int == 0) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin().equals(paramazrb.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_JavaLangString)))
    {
      ...
      for (;;)
      {
        ...
        localTextView.setText(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131698747));
      ...
      label404:
      paramazrb.addAll((Collection)localObject3);
      paramazrb.addAll(localArrayList);
      a(paramazrb, paramView, false);
    }
    for (;;)
    {
    ...
    paramazrb = ((Card)localObject3).privilegePromptStr;
    if (TextUtils.isEmpty(paramazrb)) {
      localTextView.setText(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131698746));
    }
    for (;;)
    {
  ...
  public void a(@NonNull BaseActivity paramBaseActivity, @Nullable Bundle paramBundle)
  {
    ...
    float f2 = paramBaseActivity.getDimensionPixelSize(2131297232) + paramBaseActivity.getDimensionPixelSize(2131297539) + paramBaseActivity.getDimensionPixelSize(2131297540);
    float f3 = this.jdField_a_of_type_Float;
    int i = paramBaseActivity.getDimensionPixelSize(2131297536);
    int j = paramBaseActivity.getDimensionPixelSize(2131297537);
    float f4 = i;
  ...
  public boolean a(azrb paramazrb)
  {
    ...
    return a((azrb)this.jdField_b_of_type_JavaLangObject, ((azrb)this.jdField_b_of_type_JavaLangObject).d) | bool;
  }
  
  public boolean a(azrb paramazrb, boolean paramBoolean)
  {
    paramBoolean = true;
    boolean bool = true;
    Object localObject;
    ...
    if (0 == 0)
    {
      localObject = this.jdField_a_of_type_Baea.a("map_key_diamond");
      if (localObject != null) {
        paramBoolean = true;
      }
    }
    for (;;)
    {
      if (localObject == null)
      {
        localObject = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity).inflate(2131561394, null);
        paramBoolean = true;
      }
      for (;;)
      {
        this.jdField_a_of_type_JavaLangObject = localObject;
        ImageView localImageView = (ImageView)((View)localObject).findViewById(2131362985);
        View localView = ((View)localObject).findViewById(2131365687);
        if (bool)
        {
          a(paramazrb, localView);
          paramazrb = (ViewGroup.MarginLayoutParams)localView.getLayoutParams();
          paramazrb.leftMargin = 0;
          localView.setLayoutParams(paramazrb);
        }
        for (;;)
        {
          if (bool)
          {
            ((View)localObject).setTag(new azpb(26, null));
