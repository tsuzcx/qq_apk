...
public class anyo
  implements anil
{
  private anyp jdField_a_of_type_Anyp;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  
  public anyo(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if (localObject2 != null) {
          ...
          {
            localObject2 = (NewCommonConchArgs)bmip.a(new NewCommonConchArgs(), ((Conch)localObject2).params);
            ...
            else
            {
              ...
              bihb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), i, (String)localObject2);
              bihb.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), System.currentTimeMillis());
            }
          }
          else if (6142 == ((Conch)localObject2).cmdId)
          {
            ...
            else
            {
              ...
              bihb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), (String)localObject2);
              bihb.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), System.currentTimeMillis());
            }
          }
        }
  ...
  public void a(anyp paramanyp)
  {
    this.jdField_a_of_type_Anyp = paramanyp;
  }
  ...
  public void onUpdate(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_Anyp != null) {
        this.jdField_a_of_type_Anyp.a(paramInt);
      }
      return;
      try
      {
      ...
      if (QLog.isColorLevel())
      {
        ...
        {
          bihb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramObject);
          continue;
          paramObject = (bihd)paramObject;
          a(paramObject.jdField_a_of_type_MConchSCPullConchs);
          if (this.jdField_a_of_type_Anyp != null) {
            this.jdField_a_of_type_Anyp.a(paramObject.jdField_a_of_type_MWIFISCGet3rdCloudCheck);
          }
        }
      }
    }
