  ...
  extends ahxr
{
  ...
  public void a()
  {
    ...
    if (localRMVideoStateMgr != null)
    {
      if (localRMVideoStateMgr.jdField_a_of_type_Axkg != null) {
        localRMVideoStateMgr.jdField_a_of_type_Axkg.a(localRMVideoStateMgr);
      }
      if (localRMVideoStateMgr.jdField_a_of_type_Ahxz != null) {
        localRMVideoStateMgr.jdField_a_of_type_Ahxz.o();
      }
  ...
  public void a(AVCodec.AVCodecCallback paramAVCodecCallback, MessageStruct paramMessageStruct)
  {
    ...
    paramAVCodecCallback.jdField_a_of_type_Ahxl = null;
  ...
  {
    if ((paramObject instanceof axif)) {
      switch (paramInt)
      {
      }
    }
      ...
      if (paramVarArgs != null) {
        if ((paramVarArgs[0] instanceof Boolean))
        {
          ...
          if ((localObject != null) && (((String)localObject).endsWith(":story"))) {
            vei.b("take_video", "camera_initial", 0, 0, new String[0]);
          }
        ...
        else if ((paramVarArgs[0] instanceof String))
        {
          ...
          {
            this.d = true;
            RMVideoStateMgr.a().a(2002, ajya.a(2131713475), false);
          }
          if (QLog.isColorLevel()) {
            QLog.d("RMVideoInitState", 2, "[@] EVENT_CREATE_CAMERA, error = " + paramVarArgs[0]);
          }
          if (1 == ahtz.a) {
            bhqq.a(axgi.a + "", "qzone_video_record", "2", null);
          }
          localObject = BaseApplicationImpl.sApplication.getQQProcessName();
          if ((localObject != null) && (((String)localObject).endsWith(":story")))
          {
            vei.b("take_video", "camera_initial", 0, -1, new String[0]);
            continue;
            if ((paramVarArgs != null) && ((paramVarArgs[0] instanceof String)))
            {
              ...
              {
                this.d = true;
                RMVideoStateMgr.a().a(2003, ajya.a(2131713470), false);
              }
              if (QLog.isColorLevel()) {
              ...
              if (1 == ahtz.a)
              {
                bhqq.a(axgi.a + "", "qzone_video_record", "3", null);
                continue;
                if (!this.d)
                {
                  this.d = true;
                  RMVideoStateMgr.a().a(2002, ajya.a(2131713468), false);
                }
                if (QLog.isColorLevel()) {
                ...
                if (1 == ahtz.a)
                {
                  bhqq.a(axgi.a + "", "qzone_video_record", "4", null);
                  continue;
                  if ((paramObject instanceof AudioCapture))
                  {
                    ...
                    case 3: 
                      ...
                      else
                      {
                        if (QLog.isColorLevel())
                        {
                          ...
                          QLog.d("RMVideoInitState", 2, "[@] EVENT_INIT [error]mAudioSampleRate=" + axim.q + " mAudioChannel=" + axim.o + " mAudioFormat=" + axim.p);
                        }
                        ...
                        while (1 == ahtz.a)
                        {
                          bhqq.a(axgi.a + "", "qzone_video_record", "5", null);
                          break;
                          if (QLog.isColorLevel()) {
                    ...
                    case 5: 
                      ...
                      for (;;)
                      {
                        ...
                        {
                          RMVideoStateMgr.a().b(0, ajya.a(2131713471), false);
                          ((RMVideoStateMgr)localObject).h = true;
                        }
                        if (1 != ahtz.a) {
                          break;
                        }
                        bhqq.a(axgi.a + "", "qzone_video_record", "6", null);
                        break;
                        ((RMVideoStateMgr)localObject).c(false);
                      }
                    case 6: 
    ...
    for (;;)
    {
      if (!((RMVideoStateMgr)localObject).h)
      {
        RMVideoStateMgr.a().b(0, ajya.a(2131713466), false);
        ((RMVideoStateMgr)localObject).h = true;
      }
      if (1 != ahtz.a) {
        break;
      }
      bhqq.a(axgi.a + "", "qzone_video_record", "7", null);
      break;
      ((RMVideoStateMgr)localObject).c(false);
    }
  }
