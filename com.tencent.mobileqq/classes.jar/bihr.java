...
{
  bihr(biho parambiho, int paramInt, String paramString) {}
  
  public void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    ThreadManager.excute(new SwiftBrowserShareMenuHandler.4.1(this), 128, null, false);
    biho.a(this.jdField_a_of_type_Biho, this.jdField_a_of_type_Int, this.jdField_a_of_type_JavaLangString);
  }
}
