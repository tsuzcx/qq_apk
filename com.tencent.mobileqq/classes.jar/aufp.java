  ...
  extends akej
{
  ...
  public aufp(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager)
  {
  ...
  private Cursor a(String paramString)
  {
    ...
    paramString = akbm.a(paramString);
  ...
  private ArrayList<QCallRecord> a(List<QCallRecord> paramList)
  {
    ...
    Collections.sort(paramList, new aufq(this));
  ...
  private List<QCallRecord> b(String paramString, int paramInt)
  {
    ...
    //   4: astore 7
    //   6: aload_0
    //   7: getfield 124	aufp:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   10: invokevirtual 381	com/tencent/mobileqq/app/QQAppInterface:a	()Lcom/tencent/mobileqq/app/SQLiteDatabase;
    //   13: astore 8
    //   15: aload 8
    //   17: ifnonnull +5 -> 22
    //   20: aconst_null
    ...
    //   35: aload_1
    //   36: iload_2
    //   37: invokestatic 362	com/tencent/mobileqq/data/QCallRecord:getTableName	(Ljava/lang/String;I)Ljava/lang/String;
    //   40: astore_1
    //   41: aload 8
    //   43: aload_1
    //   44: invokevirtual 382	com/tencent/mobileqq/app/SQLiteDatabase:a	(Ljava/lang/String;)I
    //   47: istore_2
    //   48: iload_2
    //   49: aload_0
    //   50: getfield 39	aufp:jdField_a_of_type_Int	I
    //   53: if_icmple +39 -> 92
    //   56: aload 8
    //   58: ldc_w 384
    //   61: iconst_3
    ...
    //   75: iload_2
    //   76: aload_0
    //   77: getfield 39	aufp:jdField_a_of_type_Int	I
    //   80: isub
    //   81: invokestatic 387	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   84: aastore
    //   85: invokestatic 391	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   88: invokevirtual 394	com/tencent/mobileqq/app/SQLiteDatabase:a	(Ljava/lang/String;)Z
    //   91: pop
    ...
    //   118: astore_1
    //   119: aload_0
    //   120: invokespecial 400	aufp:a	()Latmp;
    //   123: ldc 214
    //   125: aload_1
    //   126: aconst_null
    //   127: invokevirtual 403	atmp:a	(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/String;)Ljava/util/List;
    //   130: astore_1
    //   131: aload_1
    //   132: ifnull +310 -> 442
    //   135: invokestatic 408	awao:a	()J
    //   138: lstore 4
    //   140: aload_1
    //   141: invokeinterface 203 1 0
    //   146: astore 6
    //   148: aload 6
    //   150: invokeinterface 208 1 0
    //   155: ifeq +287 -> 442
    //   158: aload 6
    //   160: invokeinterface 212 1 0
    //   165: checkcast 214	com/tencent/mobileqq/data/QCallRecord
    //   168: astore 7
    //   170: aload 7
    //   172: ifnull -24 -> 148
    //   175: aload 7
    //   177: getfield 231	com/tencent/mobileqq/data/QCallRecord:time	J
    //   180: lload 4
    //   182: lcmp
    //   183: ifle -35 -> 148
    //   186: aload 7
    //   188: lload 4
    //   190: putfield 231	com/tencent/mobileqq/data/QCallRecord:time	J
    //   193: goto -45 -> 148
    //   196: aload_0
    //   197: aload_1
    //   198: invokespecial 95	aufp:a	(Ljava/lang/String;)Landroid/database/Cursor;
    //   201: astore_1
    //   202: aload_1
    //   203: ifnull +201 -> 404
    //   206: new 41	java/util/ArrayList
    //   209: dup
    //   210: invokespecial 197	java/util/ArrayList:<init>	()V
    //   213: astore 6
    //   215: aload_1
    //   216: ldc_w 410
    //   219: invokeinterface 415 2 0
    //   224: istore_2
    //   225: aload_1
    //   226: invokeinterface 418 1 0
    //   231: ifeq +173 -> 404
    //   234: aload_1
    //   235: iload_2
    //   236: invokeinterface 421 2 0
    //   241: invokestatic 424	com/tencent/mobileqq/utils/SecurityUtile:a	(Ljava/lang/String;)Ljava/lang/String;
    //   244: astore 7
    //   246: aload 8
    //   248: aload 7
    //   250: invokevirtual 382	com/tencent/mobileqq/app/SQLiteDatabase:a	(Ljava/lang/String;)I
    //   253: istore_3
    //   254: iload_3
    //   255: ifle -30 -> 225
    //   258: iload_3
    //   259: aload_0
    //   260: getfield 39	aufp:jdField_a_of_type_Int	I
    ...
    //   287: iload_3
    //   288: aload_0
    //   289: getfield 39	aufp:jdField_a_of_type_Int	I
    //   292: isub
    //   293: invokestatic 387	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   296: aastore
    //   297: invokestatic 391	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   300: invokevirtual 394	com/tencent/mobileqq/app/SQLiteDatabase:a	(Ljava/lang/String;)Z
    //   303: pop
    ...
    //   331: astore 7
    //   333: aload_0
    //   334: invokespecial 400	aufp:a	()Latmp;
    //   337: ldc 214
    //   339: aload 7
    //   341: aconst_null
    //   342: invokevirtual 403	atmp:a	(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/String;)Ljava/util/List;
    //   345: astore 7
    //   347: aload 7
    //   349: ifnull +13 -> 362
    //   352: aload 6
    //   354: aload 7
    //   356: invokeinterface 428 2 0
    //   361: pop
    //   362: aload 6
    //   364: new 430	aufr
    //   367: dup
    //   368: aload_0
    //   369: invokespecial 431	aufr:<init>	(Laufp;)V
    //   372: invokestatic 193	java/util/Collections:sort	(Ljava/util/List;Ljava/util/Comparator;)V
    //   375: goto -150 -> 225
    //   378: astore 7
    //   380: aload_1
    //   381: astore 7
  ...
  public List<QCallRecent> a(aufs arg1)
  {
  ...
  public void d()
  {
    ...
    try
    {
      List localList1 = localatmp.a(QCallRecent.class, false, null, null, null, null, "lastCallTime desc", null);
    ...
    try
    {
      bool = localatmp.b("delete from" + "recent_call" + " where lastCallTime < " + ((QCallRecent)localList1.get(90)).lastCallTime + ";");
