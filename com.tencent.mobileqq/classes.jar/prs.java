  ...
  extends pro
{
  ...
  public static pro b(oidb_cmd0xbc9.BannerItem paramBannerItem)
  {
    ...
    prs localprs = new prs();
    if (localVideoBannerItem.bytes_share_url.has()) {
      localprs.jdField_f_of_type_JavaLangString = localVideoBannerItem.bytes_share_url.get().toStringUtf8();
    }
    if (localVideoBannerItem.uint32_video_duration.has()) {
      localprs.jdField_b_of_type_Int = localVideoBannerItem.uint32_video_duration.get();
    }
    if (localVideoBannerItem.uint32_video_width.has()) {
      localprs.jdField_c_of_type_Int = localVideoBannerItem.uint32_video_width.get();
    }
    if (localVideoBannerItem.uint32_video_height.has()) {
      localprs.d = localVideoBannerItem.uint32_video_height.get();
    }
    if (localVideoBannerItem.bytes_video_vid.has()) {
      localprs.jdField_g_of_type_JavaLangString = localVideoBannerItem.bytes_video_vid.get().toStringUtf8();
    }
    if (localVideoBannerItem.bytes_video_cover.has()) {
      localprs.jdField_c_of_type_JavaLangString = localVideoBannerItem.bytes_video_cover.get().toStringUtf8();
    }
    if (localVideoBannerItem.bytes_inner_uinque_id.has()) {
      localprs.jdField_e_of_type_JavaLangString = localVideoBannerItem.bytes_inner_uinque_id.get().toStringUtf8();
    }
    if (localVideoBannerItem.uint32_busi_type.has()) {
      localprs.jdField_e_of_type_Int = localVideoBannerItem.uint32_busi_type.get();
    }
    if (localVideoBannerItem.bytes_title.has()) {
      localprs.i = localVideoBannerItem.bytes_title.get().toStringUtf8();
    }
    if (localVideoBannerItem.bytes_account_name.has()) {
      localprs.h = localVideoBannerItem.bytes_account_name.get().toStringUtf8();
    }
    if (localVideoBannerItem.uint64_account_uin.has()) {
      localprs.jdField_b_of_type_Long = localVideoBannerItem.uint64_account_uin.get();
    }
    if (localVideoBannerItem.uint32_is_ugc.has()) {
      localprs.jdField_f_of_type_Int = localVideoBannerItem.uint32_is_ugc.get();
    }
    if (localVideoBannerItem.uint64_feeds_id.has()) {
      localprs.jdField_c_of_type_Long = localVideoBannerItem.uint64_feeds_id.get();
    }
    if (localVideoBannerItem.uint32_feeds_type.has()) {
      localprs.jdField_g_of_type_Int = localVideoBannerItem.uint32_feeds_type.get();
    }
    a(localprs, paramBannerItem);
    a(paramBannerItem, localprs);
    return localprs;
  }
