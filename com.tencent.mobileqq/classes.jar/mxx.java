  ...
  implements Manager
{
  ...
  public final String b = mxx.class.getSimpleName();
  
  public mxx(QQAppInterface paramQQAppInterface)
  {
  ...
  private oidb_0x791.GetRedDotRes a()
  {
    ...
    //   5: dup
    //   6: aload_0
    //   7: getfield 51	mxx:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   28: aload_0
    //   29: getfield 51	mxx:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   44: invokestatic 189	bbdj:a	(Ljava/io/File;)[B
    //   47: astore_3
  ...
  private void a(String paramString, long paramLong, BusinessInfoCheckUpdate.RedTypeInfo paramRedTypeInfo, boolean paramBoolean)
  {
    try
    {
      ...
      localJSONObject.put("isOfficialNotify", paramBoolean);
  ...
  public int a()
  {
    ...
    if (i < this.jdField_a_of_type_TencentImOidbCmd0x791Oidb_0x791$GetRedDotRes.rpt_msg_reddot_info.size())
    {
      ...
      for (;;)
      {
        ...
        j = k;
        break;
        boolean bool = bbjn.f(BaseApplicationImpl.getApplication(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
        k = j;
  ...
  public int a(QQAppInterface paramQQAppInterface)
  {
    ...
    boolean bool3 = aszg.a(paramQQAppInterface);
    boolean bool4 = a();
    boolean bool1;
    boolean bool2;
    label66:
  ...
  public atxc a(boolean paramBoolean)
  {
    try
    {
      atxc localatxc = a(paramBoolean, true);
      return localatxc;
    }
    finally
    {
  ...
  public atxc a(boolean paramBoolean1, boolean paramBoolean2)
  {
    Object localObject2;
    ...
    try
    {
      ...
      localObject2 = (mxx)localQQAppInterface.getManager(70);
      localRedTypeInfo1 = ((mxx)localObject2).a();
      i = 0;
      localatxc = new atxc();
      if (!paramBoolean1) {
        break label965;
      }
      if (!aszg.a(localQQAppInterface)) {
        break label907;
      }
      localRedTypeInfo2 = ((mxx)localObject2).b();
      localRedTypeInfo3 = ((mxx)localObject2).g();
      localRedTypeInfo4 = ((mxx)localObject2).i();
      localRedTypeInfo5 = ((mxx)localObject2).h();
      localObject3 = ((mxx)localObject2).b();
      localObject1 = ((mxx)localObject2).a();
      d();
      ((mxx)localObject2).e();
      f();
      j = i;
    ...
    localatxc.a((List)localObject2, false);
    int j = 56;
    label233:
    int i = j;
    ...
    if (i == 0) {
      if (aszg.b(localAppInterface))
      {
        ...
        if (paramBoolean2)
        {
          ...
          localatxc.a(5);
          localatxc.b(j);
          QLog.d("nearby.redpoint", 1, "addRedNum:" + j + ", total=" + localatxc.b + ", type=" + 60);
          k = 60;
          j = 2;
          i = j;
          m = k;
          ...
          if (localRedTypeInfo4 != null)
          {
            ...
            {
              localatxc.a(5);
              localatxc.a(localRedTypeInfo4.red_content.get());
              bbjn.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext());
              k = m;
              j = i;
            }
          }
          ...
          if ((localRedTypeInfo1 == null) || (!aszg.a(localAppInterface, 2))) {
            break label856;
          }
          localatxc.a(0);
          i = 25;
    ...
    for (;;)
    {
      label677:
      localatxc.c = j;
      QLog.d("nearby.redpoint", 1, "getNearbyRedPoint, needShow, isNewTab=" + paramBoolean1 + ", redType=" + i + ", redInfo=" + localatxc);
      for (;;)
      {
        localatxc.d = i;
        return localatxc;
        this.jdField_a_of_type_Int = MsgBoxListActivity.a(localAppInterface, ajsf.I);
        break;
        label758:
        i = j;
        ...
        localatxc.a(5);
        localatxc.a(localRedTypeInfo3.red_content.get());
        i = 2;
        QLog.d("nearby.redpoint", 1, "addRedNum:" + localRedTypeInfo3.red_content.get() + ", total=" + localatxc.b + ", type=" + 38);
        break label998;
        label856:
        if ((localRedTypeInfo2 != null) && (aszg.a(localAppInterface, 3)))
        {
          i = 23;
          localatxc.a(0);
          m = j;
        ...
        if ((localRedTypeInfo1 == null) || (!aszg.a(localAppInterface, 1001))) {
          break label1023;
        }
        localatxc.a(0);
        i = 25;
  ...
  public ArrayList<oidb_0x791.RedDotInfo> a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 249	mxx:jdField_a_of_type_TencentImOidbCmd0x791Oidb_0x791$GetRedDotRes	Ltencent/im/oidb/cmd0x791/oidb_0x791$GetRedDotRes;
    //   6: ifnonnull +11 -> 17
    //   9: aload_0
    //   10: aload_0
    //   11: invokespecial 251	mxx:a	()Ltencent/im/oidb/cmd0x791/oidb_0x791$GetRedDotRes;
    //   14: putfield 249	mxx:jdField_a_of_type_TencentImOidbCmd0x791Oidb_0x791$GetRedDotRes	Ltencent/im/oidb/cmd0x791/oidb_0x791$GetRedDotRes;
    //   17: aload_0
    //   18: getfield 249	mxx:jdField_a_of_type_TencentImOidbCmd0x791Oidb_0x791$GetRedDotRes	Ltencent/im/oidb/cmd0x791/oidb_0x791$GetRedDotRes;
    //   21: astore_3
    //   22: aload_3
    //   23: ifnonnull +9 -> 32
    //   26: aconst_null
    ...
    //   30: aload_3
    //   31: areturn
    //   32: new 361	java/util/ArrayList
    //   35: dup
    //   36: invokespecial 363	java/util/ArrayList:<init>	()V
    //   39: astore_3
    //   40: iconst_0
    //   41: istore_1
    //   42: iload_1
    //   43: aload_0
    //   44: getfield 249	mxx:jdField_a_of_type_TencentImOidbCmd0x791Oidb_0x791$GetRedDotRes	Ltencent/im/oidb/cmd0x791/oidb_0x791$GetRedDotRes;
    //   47: getfield 255	tencent/im/oidb/cmd0x791/oidb_0x791$GetRedDotRes:rpt_msg_reddot_info	Lcom/tencent/mobileqq/pb/PBRepeatMessageField;
    //   50: invokevirtual 260	com/tencent/mobileqq/pb/PBRepeatMessageField:size	()I
    //   53: if_icmpge +98 -> 151
    //   56: aload_0
    //   57: getfield 249	mxx:jdField_a_of_type_TencentImOidbCmd0x791Oidb_0x791$GetRedDotRes	Ltencent/im/oidb/cmd0x791/oidb_0x791$GetRedDotRes;
    //   60: getfield 255	tencent/im/oidb/cmd0x791/oidb_0x791$GetRedDotRes:rpt_msg_reddot_info	Lcom/tencent/mobileqq/pb/PBRepeatMessageField;
    //   63: iload_1
    //   64: invokevirtual 263	com/tencent/mobileqq/pb/PBRepeatMessageField:get	(I)Lcom/tencent/mobileqq/pb/MessageMicro;
    ...
    //   126: ifeq +18 -> 144
    //   129: aload 5
    //   131: invokestatic 382	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   134: ifne +10 -> 144
    //   137: aload_3
    //   138: aload 4
    //   140: invokevirtual 389	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   143: pop
    //   144: iload_1
    //   145: iconst_1
    //   146: iadd
  ...
  public oidb_0x791.RedDotInfo a()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        bool1 = ((tgc)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(252)).jdField_a_of_type_Boolean;
        ...
        {
          veg.d(this.b, "%d red dot time out", new Object[] { Integer.valueOf(i) });
          continue;
        }
        if (i != 37) {}
      }
      finally {}
      if ((!bool2) && (i != 48) && ((bool1) || (i != 28)) && ((i != vzg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) || (localRedDotInfo2.uint32_number.get() > 0))) {
        if (mxp.a(localRedDotInfo2, localRedDotInfo1) > 0)
        {
  ...
  public void a()
  {
    for (;;)
    {
      ...
      try
      {
        ...
        {
          oidb_0x791.RedDotInfo localRedDotInfo = (oidb_0x791.RedDotInfo)this.jdField_a_of_type_TencentImOidbCmd0x791Oidb_0x791$GetRedDotRes.rpt_msg_reddot_info.get(i);
          if ((!localRedDotInfo.bool_display_reddot.get()) || (!mxp.a(localRedDotInfo.uint32_appid.get()))) {
            break label209;
          }
  ...
  public void a(int paramInt)
  {
    ...
    if (localRedDotInfo1 != null) {
      mxq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRedDotInfo1);
    }
    label187:
    label330:
    label342:
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        {
          this.jdField_a_of_type_TencentImOidbCmd0x791Oidb_0x791$GetRedDotRes.rpt_msg_reddot_info.remove(i);
          mxq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRedDotInfo2);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (j < n)
        {
          ...
          if (mxp.c(localRedDotInfo1.uint32_appid.get())) {
            break label779;
          }
  ...
  public BusinessInfoCheckUpdate.RedTypeInfo g()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject3 = (oidb_0x791.RedDotInfo)this.jdField_a_of_type_TencentImOidbCmd0x791Oidb_0x791$GetRedDotRes.rpt_msg_reddot_info.get(m);
        k = ((oidb_0x791.RedDotInfo)localObject3).uint32_number.get();
        bool2 = ((oidb_0x791.RedDotInfo)localObject3).bool_display_reddot.get();
        l = ((oidb_0x791.RedDotInfo)localObject3).uint64_cmd_uin.get();
        localObject8 = ((oidb_0x791.RedDotInfo)localObject3).str_face_url.get().toStringUtf8();
        if ((38 != ((oidb_0x791.RedDotInfo)localObject3).uint32_appid.get()) || ((!bool2) && (k <= 0))) {
          break label644;
        }
        if (!((oidb_0x791.RedDotInfo)localObject3).str_custom_buffer.has()) {
          break label623;
        }
        localObject5 = ((oidb_0x791.RedDotInfo)localObject3).str_custom_buffer.get().toStringUtf8();
      }
      finally {}
      label612:
      try
      {
        n = new JSONObject((String)localObject5).optInt("official_topic");
        j = i;
        if (n != 1) {
          break label670;
        }
        try
        {
          j = ((oidb_0x791.RedDotInfo)localObject3).uint32_number.get();
          i = j;
          boolean bool3 = ((oidb_0x791.RedDotInfo)localObject3).bool_display_reddot.get();
          i = j;
          bool1 = bool3;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (j > 0)
        {
          ...
          localRedTypeInfo.red_content.set(String.valueOf(j));
          bool1 = false;
          bool2 = false;
          if (((oidb_0x791.RedDotInfo)localObject8).str_custom_buffer.has())
          {
            localObject3 = ((oidb_0x791.RedDotInfo)localObject8).str_custom_buffer.get().toStringUtf8();
            bool2 = bool1;
          }
          for (;;)
          {
            try
            {
              ...
              bool2 = bool1;
              if (((JSONObject)localObject3).optInt("official_topic") != 1) {
                continue;
              }
              bool1 = true;
              bool2 = bool1;
              if (((JSONObject)localObject3).optInt("red_type") != 0) {
                continue;
              }
              i = 1;
              bool2 = bool1;
            ...
            a((String)localObject1, l, localRedTypeInfo, bool2);
            localObject6 = localRedTypeInfo;
            break;
            bool1 = false;
            continue;
        ...
        {
          String str2 = localException1.str_custom_buffer.get().toStringUtf8();
          localRedTypeInfo.red_content.set(String.valueOf(i));
          try
          {
            if (new JSONObject(str2).optInt("red_type") != 0) {
              localRedTypeInfo.red_type.set(0);
            }
            for (;;)
            {
              a(str1, l, localRedTypeInfo, true);
              localObject6 = localRedTypeInfo;
              break;
              localRedTypeInfo.red_type.set(5);
            }
      ...
      localRedTypeInfo.red_content.set("");
      localRedTypeInfo.red_desc.set("");
      Object localObject6 = localRedTypeInfo;
      break;
      localObject6 = null;
      break;
      label623:
      Object localObject7 = localException2;
