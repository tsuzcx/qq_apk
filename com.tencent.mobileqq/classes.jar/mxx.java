  ...
  extends BusinessHandler
{
  ...
  private void k(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      localmxn = (mxn)this.app.getManager(373);
      if (i != 0) {
        break;
      }
      localmxn.a().a(paramFromServiceMsg, k);
      return;
    }
    ...
    localmxn.a().a(paramFromServiceMsg, k, str);
  }
  ...
  public void a(int paramInt, String paramString1, String paramString2, long paramLong)
  {
    ...
    try
    {
      ...
      localCmdRoomEnterReq.uin.set(njk.a(str));
      if ((paramInt == 1) || (paramInt == 2))
      {
        localCmdRoomEnterReq.invitor_uin.set(njk.a(paramString2));
        if (TextUtils.isEmpty(paramString2)) {
          QLog.e("AvGameRoomListHandler", 1, "INVITER UIN EMPTY FP=" + paramInt);
        }
      }
      localCmdRoomEnterReq.roomid.set(njk.a(paramString1));
      localCmdRoomEnterReq.invitor_uin.set(njk.a(paramString2));
  ...
  {
    long l = njk.a(this.app.getCurrentUin());
  ...
  public void a(String paramString)
  {
    ...
    try
    {
      ...
      localCmdRoomDestroyReq.uin.set(njk.a((String)localObject));
      localCmdRoomDestroyReq.type.set(2);
      localCmdRoomDestroyReq.groupid.set(njk.a(paramString));
  ...
  public void a(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    try
    {
      ...
      localCmdRoomBatchForGroupReq.groupid.set(njk.a(paramString));
      localCmdRoomBatchForGroupReq.uin.set(njk.a((String)localObject));
  ...
  protected void i(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramFromServiceMsg != null) && (paramFromServiceMsg.isSuccess()) && (paramObject != null))
    {
      bool1 = true;
      if (QLog.isColorLevel()) {
        QLog.d("AvGameRoomListHandler", 2, "handleGetGameLobbyInfo. isSuccess = " + bool1 + " " + l);
      }
      if (bool1)
      {
        localObject = new AvGameLobbyInfo.CmdGetGameLobbyInfoRsp();
        i = 0;
        j = i;
      }
    }
    else
    {
      for (;;)
      {
        try
        {
          ((AvGameLobbyInfo.CmdGetGameLobbyInfoRsp)localObject).mergeFrom((byte[])paramObject);
          j = i;
          if (!((AvGameCommon.Result)((AvGameLobbyInfo.CmdGetGameLobbyInfoRsp)localObject).res.get()).errcode.has()) {
            continue;
          }
          j = i;
          i = ((AvGameCommon.Result)((AvGameLobbyInfo.CmdGetGameLobbyInfoRsp)localObject).res.get()).errcode.get();
          j = i;
          if (!((AvGameCommon.Result)((AvGameLobbyInfo.CmdGetGameLobbyInfoRsp)localObject).res.get()).errmsg.has()) {
            continue;
          }
          j = i;
          paramToServiceMsg = ((AvGameCommon.Result)((AvGameLobbyInfo.CmdGetGameLobbyInfoRsp)localObject).res.get()).errmsg.get().toStringUtf8();
          j = i;
        }
        catch (InvalidProtocolBufferMicroException paramToServiceMsg)
        {
          ...
          paramFromServiceMsg = "";
          continue;
          if (!((AvGameLobbyInfo.CmdGetGameLobbyInfoRsp)localObject).random_match_info.has()) {
            continue;
          }
          paramFromServiceMsg = (AvGameLobbyInfo.RandomMatchInfo)((AvGameLobbyInfo.CmdGetGameLobbyInfoRsp)localObject).random_match_info.get();
          if (!paramFromServiceMsg.players_num.has()) {
            continue;
          }
          i = paramFromServiceMsg.players_num.get();
          int m = i;
          ...
          k = 0;
          m = i;
          if (k >= paramFromServiceMsg.player_list.get().size()) {
            continue;
          }
          localObject = (AvGameLobbyInfo.PlayerInfo)paramFromServiceMsg.player_list.get().get(k);
          ...
          paramObject.add(Long.valueOf(((AvGameLobbyInfo.PlayerInfo)((AvGameLobbyInfo.PlayerInfo)localObject).get()).uid.get()));
          k += 1;
          continue;
          i = 0;
          continue;
          notifyUI(10, true, new Object[] { Long.valueOf(l), localArrayList, Integer.valueOf(m), paramObject, Integer.valueOf(j), paramToServiceMsg });
          bool2 = bool1;
        }
        if (QLog.isColorLevel()) {
          QLog.i("AvGameRoomListHandler", 2, String.format("handleGetGameLobbyInfo() uin=%d errCode=%d errMsg=%s", new Object[] { Long.valueOf(l), Integer.valueOf(j), paramToServiceMsg }));
        }
        bool2 = bool1;
        if (!bool1) {
          break label725;
        ...
        if (!((AvGameLobbyInfo.CmdGetGameLobbyInfoRsp)localObject).banner_list.has()) {
          continue;
        }
        localList = ((AvGameLobbyInfo.CmdGetGameLobbyInfoRsp)localObject).banner_list.get();
        i = 0;
        if (i >= localList.size()) {
          continue;
        }
        localnil = new nil();
        if (!((AvGameLobbyInfo.BannerInfo)localList.get(i)).picture_url.has()) {
          continue;
        }
        paramFromServiceMsg = ((AvGameLobbyInfo.BannerInfo)localList.get(i)).picture_url.get();
        localnil.a = paramFromServiceMsg;
        if (!((AvGameLobbyInfo.BannerInfo)localList.get(i)).skip_url.has()) {
          continue;
        }
        paramFromServiceMsg = ((AvGameLobbyInfo.BannerInfo)localList.get(i)).skip_url.get();
        localnil.b = paramFromServiceMsg;
        localArrayList.add(localnil);
        i += 1;
        continue;
        bool1 = false;
        break;
    ...
    for (;;)
    {
      ...
      label725:
      if (!bool2) {
        notifyUI(10, false, new Object[] { Long.valueOf(l), null, Integer.valueOf(0), null, Integer.valueOf(-1), null });
      }
      return;
      bool2 = bool1;
    }
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    } while (!"qqvgame.Operation-GetGameLobbyInfo".equals(paramFromServiceMsg.getServiceCmd()));
