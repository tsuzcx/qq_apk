...
{
  public bbvr(PublishHomeWorkFragment paramPublishHomeWorkFragment) {}
  
  public void onClick(View paramView)
  {
    if (this.a.jdField_a_of_type_ComTencentMobileqqTroopHomeworkXmediaeditorXMediaEditor.a(4) >= 6)
    {
      QQToast.a(this.a.getActivity(), String.format(alpo.a(2131709223), new Object[] { Integer.valueOf(6) }), 0).a();
      return;
    }
    ...
    bdaj.a("Grp_edu", "Grp_recite", "Assign_Clk", 0, 0, new String[] { this.a.b });
  }
}
