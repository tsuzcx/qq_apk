...
public class agbp
  implements behi
{
  public agbp(PhotoListActivity paramPhotoListActivity) {}
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    Object localObject3;
    Object localObject4;
    switch (this.a.jdField_a_of_type_Agbx.getItemViewType(paramInt))
    {
    default: 
      return;
    case 0: 
      ...
      {
        paramAdapterView = this.a.jdField_a_of_type_Agbx.a(paramInt);
        if ((this.a.I) && (paramAdapterView.mediaWidth > 0) && (paramAdapterView.mediaHeight > 0))
        {
          ...
          {
            bbmy.a(this.a, this.a.getResources().getString(2131629485), 0).b(this.a.getResources().getDimensionPixelSize(2131167766));
            return;
          }
          if ((this.a.p > 0) && (paramAdapterView.fileSize > this.a.p))
          {
            bbmy.a(this.a, this.a.getResources().getString(2131629490, new Object[] { Integer.valueOf(this.a.p / 1048576) }), 0).b(this.a.getResources().getDimensionPixelSize(2131167766));
            return;
          }
        }
        ...
        {
          this.a.e();
          agak.a(BaseApplicationImpl.getContext()).a(new agbq(this, paramInt), paramAdapterView);
          return;
        }
      ...
      if ((PhotoListActivity.d(this.a)) && (!PhotoListActivity.jdField_a_of_type_Boolean) && (PhotoListActivity.jdField_a_of_type_JavaUtilHashMap != null))
      {
        ...
        if (k < m)
        {
          ...
          if (baaf.a((LocalMediaInfo)localObject4) != 0) {
            break label4547;
          }
    ...
    for (;;)
    {
      ...
      paramView.putExtra("PhotoConst.editPathMap", agdo.a(PhotoListActivity.a(this.a)));
      ...
      if (PhotoListActivity.f(this.a))
      {
        ...
        awqx.b(null, "dc00898", "", "", "0X800A06C", "0X800A06C", 3, 0, this.a.jdField_c_of_type_JavaUtilArrayList.size() + "", "", "", "");
      }
      ...
      if ((this.a.jdField_c_of_type_JavaUtilArrayList != null) && (this.a.jdField_c_of_type_JavaUtilArrayList.size() > 0)) {
        awqx.b(null, "CliOper", "", this.a.e, "0X8005674", "0X8005674", 0, this.a.jdField_c_of_type_JavaUtilArrayList.size(), 0, "", "", "", "");
      }
      if (this.a.P) {
      ...
      if (!azzz.b())
      {
        bbmy.a(this.a, this.a.getResources().getString(2131653216), 0).a();
        return;
      }
      paramView = this.a.jdField_a_of_type_Agbx.a(paramInt);
      if (paramView == null) {
        break;
      }
      ...
      while (i != 0)
      {
        ...
        {
          paramAdapterView = ajjy.a(2131642297) + paramLong / 60L / 1000L + ajjy.a(2131642305);
          bbmy.a(this.a, paramAdapterView, 0).b(this.a.e());
          return;
          label1760:
          i = 0;
        }
        else
        {
          ...
          {
            bbmy.a(this.a, ajjy.a(2131642282) + (float)paramLong / 1024.0F / 1024.0F / 1024.0F + "G的视频", 0).b(this.a.e());
            return;
          }
        }
      }
      ...
      {
        paramAdapterView = babr.a(this.a, ajjy.a(2131642329));
      ...
      {
        paramAdapterView = babr.a(this.a, ajjy.a(2131642323));
        paramAdapterView.setPositiveButton(2131629116, new baca());
        paramAdapterView.show();
        paramAdapterView = this.a.getIntent().getStringExtra("PhotoConst.INIT_ACTIVITY_CLASS_NAME");
        if (!this.a.H) {
      ...
      localObject3 = baaf.jdField_c_of_type_JavaUtilHashMap;
      ...
      {
        paramAdapterView = ajjy.a(2131642335) + this.a.jdField_d_of_type_Long / 1000L + ajjy.a(2131642283);
        bbmy.a(this.a, paramAdapterView, 0).b(this.a.e());
      ...
      {
        paramAdapterView = ajjy.a(2131642295) + this.a.jdField_c_of_type_Long / 1000L + ajjy.a(2131642322);
        bbmy.a(this.a, paramAdapterView, 0).b(this.a.e());
        return;
      }
      if (this.a.jdField_b_of_type_Boolean) {
        if ("qzone_plugin.apk".equals(localObject1))
        {
          ...
          if ((this.a.jdField_c_of_type_JavaUtilArrayList != null) && (this.a.jdField_c_of_type_JavaUtilArrayList.size() > 0))
          {
            bbmy.a(this.a, ajjy.a(2131642315), 0).a();
            this.a.g = false;
            return;
          }
      ...
      while (!this.a.g)
      {
        ...
        {
          this.a.e();
          agak.a(BaseApplicationImpl.getContext()).a(new agbr(this, paramAdapterView, (ArrayList)localObject1), paramView);
          return;
          label2677:
          this.a.g = false;
          ...
          for (;;)
          {
            ...
            bbmy.a(this.a, paramAdapterView.toString(), 0).a();
            return;
        ...
        else
        {
          ...
          {
            this.a.e();
            agak.a(BaseApplicationImpl.getContext()).a(new agbt(this, paramAdapterView, (ArrayList)localObject1), paramView);
            return;
          }
      ...
      if (((PhotoListActivity.f(this.a)) || (PhotoListActivity.e(this.a)) || (PhotoListActivity.d(this.a)) || (PhotoListActivity.j(this.a)) || (PhotoListActivity.s(this.a)) || (PhotoListActivity.g(this.a)) || (PhotoListActivity.a(this.a))) && ((this.a.K) || (this.a.jdField_b_of_type_Boolean)))
      {
        ...
        paramView.putExtra("ALBUM_ID", this.a.jdField_b_of_type_JavaLangString);
        paramView.putExtra("PhotoConst.IS_OVERLOAD", this.a.y);
        localObject1 = this.a.jdField_a_of_type_Agbx.a(paramInt);
        ...
        if (!this.a.y)
        {
          ...
          {
            paramInt = i;
            if (baaf.a((LocalMediaInfo)localObject1) == 1)
            {
      ...
      if (this.a.M)
      {
        ...
        {
          paramAdapterView = ajjy.a(2131642310);
          bbmy.a(this.a, paramAdapterView, 0).b(this.a.e());
          return;
        }
      }
