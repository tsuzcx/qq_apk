...
{
  public agbp(TroopChatPie paramTroopChatPie) {}
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (TextUtils.equals(paramContext, this.a.sessionInfo.curFriendUin))
        {
          ...
          {
            ((TroopManager)this.a.app.getManager(QQManagerFactory.TROOP_MANAGER)).b(this.a.sessionInfo.curFriendUin, str3, str2, i, str4, (String)localObject);
            if (this.a.jdField_a_of_type_Aiku != null)
            {
              if (QLog.isColorLevel()) {
                QLog.d(this.a.tag, 2, "mHomeworkTroopIdentityChangedReceiver dismissTipsBar.");
              }
              this.a.jdField_a_of_type_Aiku.a(this.a.mTipsMgr, false);
            }
            if (this.a.jdField_a_of_type_Bfox != null) {
              this.a.jdField_a_of_type_Bfox.a(i);
            }
          }
          if (QLog.isColorLevel())
          {
