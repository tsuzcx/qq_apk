...
{
  protected String a;
  protected List<wvq> a;
  protected AtomicBoolean a;
  protected wvp a;
  protected boolean a;
  protected List<wvq> b;
  protected AtomicBoolean b;
  protected List<wvq> c = new ArrayList();
  protected List<wvq> d = new ArrayList();
  
  public wvo(List<wvq> paramList)
  {
    ...
    while (localIterator.hasNext()) {
      ((wvq)localIterator.next()).a(this);
    }
    this.jdField_a_of_type_JavaUtilList = new ArrayList(paramList);
  }
  
  public static wvo a(ArrayList<String> paramArrayList)
  {
    ...
    for (int i = 0;; i = j)
    {
      ...
      {
        return new wvo(localArrayList1);
      }
      ...
      {
        localArrayList2.add(new wqt("", (String)localList.get(i)));
        i += 1;
      }
      localArrayList1.add(new wwv(1, localArrayList2));
    }
  }
  
  public static wvo a(@NonNull List<String> paramList)
  {
    ...
    for (int i = 0;; i = j)
    {
      ...
      {
        return new wvo(paramList);
      }
      paramList.add(new wxu(localArrayList.subList(i, j)));
    }
  }
  ...
  public void a()
  {
    try
    {
      ...
      this.jdField_a_of_type_Wvp = null;
      return;
    }
    finally
    {
  ...
  public void a(wvp paramwvp)
  {
    this.jdField_a_of_type_Wvp = paramwvp;
  }
  
  /* Error */
  public void a(wvq paramwvq)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 30	wvo:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   6: aload_1
    //   7: invokeinterface 170 2 0
    //   12: pop
    //   13: aload_0
    //   14: getfield 32	wvo:c	Ljava/util/List;
    //   17: aload_1
    //   18: invokeinterface 116 2 0
    //   23: pop
    //   24: aload_0
    //   25: getfield 43	wvo:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   28: astore_1
    //   29: aload_0
    //   30: getfield 30	wvo:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   33: invokeinterface 49 1 0
    //   38: ifne +105 -> 143
    //   41: aload_0
    //   42: getfield 34	wvo:d	Ljava/util/List;
    ...
    //   60: aload_0
    //   61: getfield 30	wvo:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   64: invokeinterface 49 1 0
    //   69: ifne +71 -> 140
    //   72: aload_0
    //   73: getfield 151	wvo:jdField_a_of_type_Wvp	Lwvp;
    //   76: ifnull +19 -> 95
    //   79: aload_0
    //   80: getfield 151	wvo:jdField_a_of_type_Wvp	Lwvp;
    //   83: aload_0
    //   84: getfield 43	wvo:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   87: invokevirtual 172	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   90: invokeinterface 176 2 0
    //   95: aload_0
    //   96: getfield 23	wvo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   99: astore_3
    ...
    //   112: astore 4
    //   114: aload_0
    //   115: getfield 43	wvo:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   137: invokestatic 184	yqp:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   140: aload_0
    //   141: monitorexit
    //   142: return
    //   143: iconst_0
    ...
    //   155: aload_0
    //   156: getfield 34	wvo:d	Ljava/util/List;
  ...
  public void b()
  {
    for (;;)
    {
      try
      {
        ...
        {
          yqp.d(this.jdField_a_of_type_JavaLangString, "Task list is empty , return result now");
          if (this.jdField_a_of_type_Wvp == null) {
            continue;
          }
          this.jdField_a_of_type_Wvp.a(this.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get());
          continue;
        }
      ...
      while (localIterator.hasNext())
      {
        wvq localwvq = (wvq)localIterator.next();
        this.jdField_b_of_type_JavaUtilList.add(localwvq);
        localwvq.a();
        i += 1;
      }
      this.jdField_a_of_type_JavaUtilList.clear();
      yqp.d(this.jdField_a_of_type_JavaLangString, "Run! Request count = %d", new Object[] { Integer.valueOf(i) });
    }
  }
  
  /* Error */
  public void b(wvq paramwvq)
  {
    // Byte code:
    //   0: iconst_0
    //   1: istore_2
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 41	wvo:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   8: invokevirtual 172	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   11: ifeq +8 -> 19
    //   14: aload_1
    //   15: invokevirtual 209	wvq:a	()Z
    //   18: istore_2
    //   19: iload_2
    //   20: ifne +135 -> 155
    //   23: aload_0
    //   24: getfield 30	wvo:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   27: aload_1
    //   28: invokeinterface 170 2 0
    //   33: pop
    //   34: aload_0
    //   35: getfield 34	wvo:d	Ljava/util/List;
    //   38: aload_1
    //   39: invokeinterface 116 2 0
    //   44: pop
    //   45: aload_0
    //   46: getfield 43	wvo:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   49: iconst_0
    //   50: invokevirtual 54	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   53: aload_0
    //   54: getfield 30	wvo:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   57: invokeinterface 49 1 0
    //   62: ifne +73 -> 135
    //   65: aload_0
    //   66: getfield 151	wvo:jdField_a_of_type_Wvp	Lwvp;
    //   69: ifnull +19 -> 88
    //   72: aload_0
    //   73: getfield 151	wvo:jdField_a_of_type_Wvp	Lwvp;
    //   76: aload_0
    //   77: getfield 43	wvo:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   80: invokevirtual 172	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   83: invokeinterface 176 2 0
    //   88: aload_0
    //   89: getfield 23	wvo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   92: astore 4
    ...
    //   106: astore 5
    //   108: aload_0
    //   109: getfield 43	wvo:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   132: invokestatic 184	yqp:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   135: aload_0
    //   136: getfield 23	wvo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   139: ldc 211
    //   141: iconst_1
    ...
    //   152: invokestatic 184	yqp:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   155: aload_0
    //   156: monitorexit
    //   157: return
    ...
    //   165: aload_0
    //   166: getfield 34	wvo:d	Ljava/util/List;
