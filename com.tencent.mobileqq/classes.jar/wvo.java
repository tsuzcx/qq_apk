...
public class wvo
{
  ...
  public wvo(BlankRecommendItemView paramBlankRecommendItemView, View paramView, int paramInt)
  {
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeDiscoverRoundCornerImageView = ((RoundCornerImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368570));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378168));
  }
    ...
    if (paramStFeed != null)
    {
      ...
      try
      {
        for (;;)
        {
          ...
          this.jdField_a_of_type_AndroidViewView.setOnClickListener(new wvp(this, paramStFeed));
          return;
