...
public class arsc
{
  ...
  public static String a(arph paramarph)
  {
    String str = String.format("%s_%d", new Object[] { paramarph.jdField_a_of_type_JavaLangString, Integer.valueOf(b(paramarph.jdField_a_of_type_Int)) });
    if (!TextUtils.isEmpty(paramarph.b)) {
      str = String.format("%s_%d_%s", new Object[] { paramarph.jdField_a_of_type_JavaLangString, Integer.valueOf(b(paramarph.jdField_a_of_type_Int)), paramarph.b });
    }
    return arrw.f + str + ".db";
  }
  ...
  public static void a(MessageRecord paramMessageRecord, MsgBackupResEntity paramMsgBackupResEntity)
  {
    ...
    int i = awbk.b(paramMessageRecord.msgUid);
  ...
  public static void a(MsgBackupMsgEntity paramMsgBackupMsgEntity)
  {
    if ((b) && (paramMsgBackupMsgEntity != null))
    {
      if (!TextUtils.isEmpty(paramMsgBackupMsgEntity.chatUin)) {
        paramMsgBackupMsgEntity.chatUin = MsgBackupJniProxy.decryptFromString(paramMsgBackupMsgEntity.chatUin, arpa.c);
      }
      if (paramMsgBackupMsgEntity.extraData != null) {
        paramMsgBackupMsgEntity.extraData = MsgBackupJniProxy.decryptFromByteArray(paramMsgBackupMsgEntity.extraData, arpa.c);
      }
      if (paramMsgBackupMsgEntity.extensionData != null) {
        paramMsgBackupMsgEntity.extensionData = MsgBackupJniProxy.decryptFromByteArray(paramMsgBackupMsgEntity.extensionData, arpa.c);
      }
    }
  }
  ...
  {
    if ((b) && (paramMsgBackupResEntity != null) && (paramMsgBackupResEntity.extraData != null) && (arpa.b != null)) {
      paramMsgBackupResEntity.extraData = MsgBackupJniProxy.encryptFromByteArray(paramMsgBackupResEntity.extraData, arpa.b);
    }
  }
  
  public static void a(String paramString, arph paramarph)
  {
    paramString = paramString.substring(0, paramString.indexOf(".")).split("_");
    paramarph.jdField_a_of_type_JavaLangString = paramString[0];
    paramarph.jdField_a_of_type_Int = c(Integer.parseInt(paramString[1]));
    if (paramString.length > 2) {
      paramarph.b = paramString[2];
    }
  }
  ...
  public static boolean a()
  {
    ...
    for (;;)
    {
      ...
      if (bool2)
      {
        File localFile = new File(arrw.c);
  ...
  public static long b(MessageRecord paramMessageRecord)
  {
    ...
    return awbk.b(paramMessageRecord.msgUid);
  }
  ...
  {
    if ((b) && (paramMsgBackupMsgEntity != null) && (arpa.b != null))
    {
      if (!TextUtils.isEmpty(paramMsgBackupMsgEntity.chatUin)) {
        paramMsgBackupMsgEntity.chatUin = MsgBackupJniProxy.encryptFromString(paramMsgBackupMsgEntity.chatUin, arpa.b);
      }
      if (paramMsgBackupMsgEntity.extraData != null) {
        paramMsgBackupMsgEntity.extraData = MsgBackupJniProxy.encryptFromByteArray(paramMsgBackupMsgEntity.extraData, arpa.b);
      }
      if (paramMsgBackupMsgEntity.extensionData != null) {
        paramMsgBackupMsgEntity.extensionData = MsgBackupJniProxy.encryptFromByteArray(paramMsgBackupMsgEntity.extensionData, arpa.b);
      }
    }
  }
  ...
  {
    if ((b) && (paramMsgBackupResEntity != null) && (paramMsgBackupResEntity.extraData != null) && (arpa.c != null)) {
      paramMsgBackupResEntity.extraData = MsgBackupJniProxy.decryptFromByteArray(paramMsgBackupResEntity.extraData, arpa.c);
    }
  }
