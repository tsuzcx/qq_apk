...
public class afrd
  extends Handler
{
  public afrd(VisitorsActivity paramVisitorsActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 2: 
      ...
      this.a.jdField_a_of_type_ComTencentWidgetSwipListView.springBackOverScrollHeaderView();
      this.a.jdField_a_of_type_ComTencentWidgetSwipListView.springBackOverScrollHeaderView();
      this.a.a(1, this.a.getString(2131693948));
      return;
    case 3: 
      ...
      for (;;)
      {
        ...
        return;
        this.a.jdField_b_of_type_Afrz.notifyDataSetChanged();
      }
    case 5: 
      ...
      if ((paramMessage instanceof Object[]))
      {
        ...
        this.a.jdField_a_of_type_Afrz.a(this.a.jdField_a_of_type_JavaUtilArrayList);
        if (QLog.isColorLevel()) {
          QLog.d("VisitorsActivity", 2, "setDataSet favor UI_ONINIT");
        }
        this.a.jdField_b_of_type_Afrz.a(this.a.jdField_b_of_type_JavaUtilArrayList);
        this.a.jdField_a_of_type_Afrz.notifyDataSetChanged();
        this.a.jdField_b_of_type_Afrz.notifyDataSetChanged();
      }
      ...
      return;
    case 6: 
      this.a.jdField_a_of_type_Azkn.b();
      return;
    case 7: 
      if (QLog.isColorLevel()) {
    ...
    case 9: 
      ...
      this.a.jdField_a_of_type_Azkn.a(paramMessage);
      return;
    case 10: 
    ...
    case 11: 
            ...
            if (paramMessage.length == 2)
            {
              ...
              if (i1 >= i2)
              {
                ...
                if (i1 <= i3)
                {
                  ...
                  if (localObject != null)
                  {
                    localObject = (TextView)((View)localObject).findViewById(2131380006);
                    j = m;
                    if (localObject != null)
                    {
                      int[] arrayOfInt = new int[2];
                      ((TextView)localObject).getLocationInWindow(arrayOfInt);
                      localazhm = (azhm)paramMessage[1];
                      if (!TextUtils.isEmpty(localazhm.jdField_b_of_type_JavaLangString)) {
                        break label929;
                      }
                      j = 1;
                      ...
                      if ((n <= 0) || (localazhm.c == null)) {
                        break label961;
                      }
                      this.a.jdField_a_of_type_ComTencentMobileqqNearbyAnimNearbyZanAnimLayout.a(localazhm, localazhm.c, f1, f2);
                      i -= 1;
                      if (i <= 0) {
                        break label983;
                      }
                      ...
                      i = arlo.a[this.a.jdField_a_of_type_JavaUtilRandom.nextInt(arlo.a.length)];
      ...
      for (;;)
      {
        ...
        break label542;
        label929:
        j = localazhm.jdField_b_of_type_JavaLangString.length() + 1;
        break label718;
        k = ((TextView)localObject).getText().length() * 2;
        break label729;
        this.a.jdField_a_of_type_ComTencentMobileqqNearbyAnimNearbyZanAnimLayout.a(localazhm, localazhm.jdField_b_of_type_AndroidGraphicsBitmap, f1, f2);
        break label811;
