  ...
  extends BusinessHandler
{
  ...
  public ook(AppInterface paramAppInterface)
  {
    super(paramAppInterface);
    this.jdField_a_of_type_Anyz = new ool(this);
  }
  ...
  public void a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        onq.b = localArrayList;
        if ((localJSONArray2 != null) && (localJSONArray2.length() > 0))
        {
          i = 0;
          if (i < localJSONArray2.length())
          {
            onq.c.add(String.valueOf(localJSONArray2.getLong(i)));
            i += 1;
            continue;
          }
        }
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    do
    {
      ...
      localObject = localonq.a(paramMessageRecord.senderuin);
      ...
      localonq.a((EcShopData)localObject);
      ...
      if ("1".equals(paramMessageRecord.getExtInfoFromExtStr("is_AdArrive_Msg")))
      {
        if ((paramMessageRecord instanceof MessageForStructing))
        {
          ...
          if ((paramString instanceof StructMsgForGeneralShare))
          {
            ...
            {
              paramString = (bdnu)paramString.mStructMsgItemLists.get(0);
              if ((paramString != null) && (!onq.b(paramString.Y)))
              {
                paramString = new ooa();
                paramString.a = 3;
                paramMessageRecord = onx.a(paramString, paramMessageRecord);
                paramMessageRecord.f = paramInt;
                ((onx)this.app.getBusinessHandler(BusinessHandlerFactory.ESHOP_AD_HANDLER)).a(paramMessageRecord, null);
              }
            }
          }
        }
  ...
  public void b(MessageRecord paramMessageRecord)
  {
    ...
    try
    {
      ...
      {
        localObject1 = new ooa();
        ((ooa)localObject1).a = 1;
        localObject1 = onx.a((ooa)localObject1, paramMessageRecord);
        ((onx)this.app.getBusinessHandler(BusinessHandlerFactory.ESHOP_AD_HANDLER)).a((ooa)localObject1, null);
      }
    }
    catch (Throwable paramMessageRecord)
    {
    ...
    try
    {
      j = Integer.parseInt(opg.a(paramMessageRecord));
      i = j;
    }
    ...
    if ((paramMessageRecord instanceof MessageForStructing))
    {
      ...
      if ((paramMessageRecord instanceof StructMsgForGeneralShare))
      {
        ...
        {
          paramMessageRecord = (bdnu)paramMessageRecord.mStructMsgItemLists.get(0);
          achv.a(0, 2, onq.a(paramMessageRecord));
          if ((paramMessageRecord.a instanceof StructMsgForGeneralShare))
          {
            opg.a(paramMessageRecord.g, false);
            opk.a(this.app, "qgg.push.arrive", ((StructMsgForGeneralShare)paramMessageRecord.a).mContentTitle, NetConnInfoCenter.getServerTimeMillis() + "", "", i);
            opk.b(this.app, "qgg_push_arrive", ((StructMsgForGeneralShare)paramMessageRecord.a).mContentTitle, NetConnInfoCenter.getServerTimeMillis() + "", "", i);
          }
        }
      }
    }
    ...
    {
      localObject1 = onq.a(paramMessageRecord);
      if (localObject1 != null) {
        achv.a(0, 2, (qq_ad_get.QQAdGetRsp.AdInfo)localObject1);
      }
      ...
      {
        paramMessageRecord = opk.a(this.app, paramMessageRecord);
        opk.a(this.app, "qgg.push.arrive", ((MessageForArkApp)localObject1).msg, NetConnInfoCenter.getServerTimeMillis() + "", paramMessageRecord, i);
        opk.b(this.app, "qgg_push_arrive", ((MessageForArkApp)localObject1).msg, NetConnInfoCenter.getServerTimeMillis() + "", paramMessageRecord, i);
        return;
        if ((paramMessageRecord instanceof MessageForArkApp))
        {
          ...
          if ((localObject3 != null) && (!StringUtil.isEmpty(((ArkAppMessage)localObject3).mSourceAd)))
          {
            ...
            if ("gw".equals(((JSONObject)localObject3).optString("from"))) {
              localObject3 = opk.a(this.app, paramMessageRecord);
            }
          }
        }
        try
        {
          i = Integer.parseInt(opg.a(paramMessageRecord));
          opk.a(this.app, "qgg.push.arrive", ((MessageForArkApp)localObject2).msg, NetConnInfoCenter.getServerTimeMillis() + "", (String)localObject3, i);
          opk.b(this.app, "qgg_push_arrive", ((MessageForArkApp)localObject2).msg, NetConnInfoCenter.getServerTimeMillis() + "", (String)localObject3, i);
    ...
    do
    {
      do
      {
        do
        {
          ...
          paramToServiceMsg = (onq)this.app.getManager(QQManagerFactory.EC_SHOP_ASSISTANT_MANAGER);
