...
public class wjm
  extends naa
{
  public wjm(StoryMessageListActivity paramStoryMessageListActivity)
  {
    ...
    if ((paramInt == 0) && (paramArrayOfByte != null)) {
      try
      {
        ...
        if ((localRspStoryMessageList.errinfo.error_code.has()) && (localRspStoryMessageList.errinfo.error_code.get() == 0))
        {
          ...
          {
            wjj localwjj = new wjj((qqstory_710_message.StoryMessage)localIterator.next());
            if (localwjj.d) {
              paramArrayOfByte.add(localwjj);
            }
          }
        }
