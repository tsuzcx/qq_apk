  ...
  implements View.OnClickListener
{
  ...
  public void a(int paramInt1, int paramInt2)
  {
    if (Build.VERSION.SDK_INT >= 21)
    {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer.setOutlineProvider(new bjfb(paramInt2));
      ...
      {
        this.jdField_a_of_type_AndroidWidgetFrameLayout.setOutlineProvider(new bjfb(paramInt1));
  ...
  public void a(Context paramContext)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer.setBackgroundColor(paramContext.getResources().getColor(2131167247));
    this.jdField_a_of_type_AndroidWidgetFrameLayout = new FrameLayout(paramContext);
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setId(2131374505);
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setBackgroundColor(paramContext.getResources().getColor(2131167247));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate(paramContext, 2131561673, null));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131374492));
    this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(anzj.a(2131703522));
  ...
  {
    this.jdField_a_of_type_Bjft = parambjft;
  }
  ...
  {
    if ((paramInt != 1) || (this.jdField_a_of_type_Bjft == null) || (!this.jdField_a_of_type_Bjft.a()))
    {
      this.jdField_a_of_type_Bjft = null;
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      if ((i == 2131374498) && (this.jdField_a_of_type_Bjft != null)) {
        this.jdField_a_of_type_Bjft.a(this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer.a(), this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer.b());
      }
    }
  }
}
