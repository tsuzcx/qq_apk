...
class bjfv
  implements zac<FeedCloudWrite.StPublishFeedRsp>
{
  bjfv(bjfr parambjfr, String paramString, int paramInt) {}
  ...
  public void a(boolean paramBoolean, long paramLong, String paramString, FeedCloudWrite.StPublishFeedRsp paramStPublishFeedRsp)
  {
    ...
    if ((paramBoolean) && (paramLong == 0L) && (paramStPublishFeedRsp != null) && (paramStPublishFeedRsp.feed != null) && (paramStPublishFeedRsp.feed.id != null))
    {
      ...
      yiw.a().a(new QCircleFeedEvent((QCircleFakeFeed)localObject, 2));
    }
    ...
    this.jdField_a_of_type_Bjfr.callbackResult(this.jdField_a_of_type_Int, EIPCResult.createResult(0, (Bundle)localObject));
  }
}
