...
public class aebz
  ...
  implements acum, Handler.Callback
{
  ...
  protected bcjb a;
  private hl jdField_a_of_type_Hl = new aecf(this);
  public Handler b;
  ...
  public aebz(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo, paramAIOAnimationConatiner);
    this.jdField_b_of_type_AndroidOsHandler = null;
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new aeca(this);
    this.jdField_b_of_type_AndroidViewView$OnClickListener = new aecb(this);
    this.jdField_a_of_type_Bcjb = new aech(this, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (Activity)this.jdField_a_of_type_AndroidContentContext);
  ...
  public static String a(QQAppInterface paramQQAppInterface, Activity paramActivity, ChatMessage paramChatMessage, String paramString)
  {
    ...
    bgpd.a(null, paramString).b(paramQQAppInterface, paramChatMessage).a(paramActivity, paramQQAppInterface.getAccount());
    bgpr.a(paramQQAppInterface, 6, 1);
    return paramString;
  }
  ...
  public static void a(Message paramMessage, XListView paramXListView)
  {
    ...
    paramXListView = actn.a(paramXListView, actn.a(l, paramXListView.getAdapter()));
    if ((paramXListView != null) && ((paramXListView.getTag() instanceof aecg)))
    {
      paramXListView = (aecg)paramXListView.getTag();
  ...
  private boolean a(ChatMessage paramChatMessage, aecg paramaecg)
  {
    int i = 0;
    boolean bool2 = false;
    int j;
    ...
    if (((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 3000) || (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1)) && (paramChatMessage.isShowQIMStyleGroup))
    {
      ...
      paramaecg.d.setTextColor(i);
      paramaecg.d.setLinkTextColor(j);
      bool1 = true;
    }
    do
    {
      ...
      bool1 = bool2;
    } while (!aekr.a().a(this, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo));
    ...
    {
      paramaecg.d.setTextColor(j);
      paramaecg.d.setLinkTextColor(i);
      return true;
  ...
  {
    String str1 = ayla.g(paramCharSequence.toString());
    ...
    Object localObject = alrj.a(null, str1);
    String[] arrayOfString = ((alrl)localObject).jdField_a_of_type_ArrayOfJavaLangString;
    long l2 = System.currentTimeMillis();
    if (QLog.isColorLevel()) {
      QLog.d("ChatItemBuilder", 2, "generateMagicFont word segment cost " + (l2 - l1) + "ms; msg length = " + paramCharSequence.length());
    }
    if (!((alrl)localObject).jdField_a_of_type_Boolean)
    {
      if (QLog.isColorLevel()) {
  ...
  public View a(ChatMessage paramChatMessage, acun paramacun, View paramView, BaseChatItemLayout paramBaseChatItemLayout, acxn paramacxn)
  {
    ...
    if ((paramacun instanceof aecg))
    {
      ...
      ((RelativeLayout.LayoutParams)localObject1).addRule(15, 2131363077);
      paramView.setContentDescription(ajyc.a(2131714857));
      ...
      ((ETTextView)localObject1).setSpannableFactory(ayki.a);
      ...
      ((ETTextView)localObject1).setId(2131364113);
      localObject2 = new ImageView(localContext);
      ((ImageView)localObject2).setId(2131366477);
      localObject3 = new RelativeLayout.LayoutParams(-2, -2);
      ((RelativeLayout.LayoutParams)localObject3).addRule(1, 2131364110);
      ((RelativeLayout.LayoutParams)localObject3).addRule(15, 2131363077);
      ((ImageView)localObject2).setContentDescription(ajyc.a(2131714859));
      ...
      localaecg.d = ((TextView)localObject1);
      localaecg.b = paramView;
      localaecg.c = ((ImageView)localObject2);
      localaecg.jdField_a_of_type_Aibs = new aibs();
      localaecg.jdField_a_of_type_Aibs.a((aice)localObject1);
      localaecg.jdField_a_of_type_Aibs.a(paramBaseChatItemLayout, paramBaseChatItemLayout);
    }
    for (;;)
    {
      ((ETTextView)localaecg.d).setFont(0, paramChatMessage.uniseq);
      localaecg.d.setTypeface(null);
      ((ETTextView)localaecg.d).setShadowLayer(0.0F, 0.0F, 0.0F, 0);
      ((ETTextView)localaecg.d).setStrokeColor(false, 0);
      ((ETTextView)localaecg.d).mMagicFont = false;
      ((ETTextView)localaecg.d).setCacheMeasureResult(true);
      localaecg.d.setTypeface(ia.a(paramChatMessage));
      if (!TextUtils.isEmpty(paramChatMessage.getExtInfoFromExtStr("sens_msg_ctrl_info")))
      {
        paramView = ((ETTextView)localaecg.d).getETLayout();
        if (paramView != null) {
          paramView.jdField_a_of_type_Long = (paramChatMessage.uniseq + 1L);
        }
      }
      localaecg.d.setTextSize(0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_b_of_type_Int);
      localaecg.d.setGravity(16);
      ...
      localaecg.d.setPadding(j, BaseChatItemLayout.l, i, BaseChatItemLayout.m);
      localaecg.jdField_a_of_type_Long = paramChatMessage.uniseq;
      paramView = "";
      if ((paramChatMessage instanceof MessageForText))
      {
        ...
        if (paramChatMessage.msgtype == -2008) {
          if (paramChatMessage.isSend())
          {
            localaecg.d.setText(localContext.getString(2131719133));
            paramView = "";
          }
        }
      }
      for (;;)
      {
        localObject2 = (balw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(203);
        if (balw.b(paramChatMessage)) {
          balw.a(localaecg.d, paramChatMessage);
        }
        localObject3 = bbwa.a();
        if (((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 0) || (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1) || (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 3000)) && (!paramChatMessage.isread))
        {
          ...
          ((bbwa)localObject3).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramChatMessage, paramView, localContext, paramChatMessage.isSend());
        }
        localaecg.d.setOnTouchListener(paramacxn);
        localaecg.d.setOnLongClickListener(paramacxn);
        localaecg.jdField_a_of_type_Acxn = paramacxn;
        localaecg.d.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
        if ((localaecg.d instanceof AnimationTextView))
        {
          paramView = (AnimationTextView)localaecg.d;
          ApolloUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramChatMessage, paramView, paramacun.jdField_b_of_type_Int, paramacun.c, false);
          paramView.onDoubleClick = this.jdField_a_of_type_Bcjb;
          paramView.onSingleClick = new aecc(this, paramChatMessage.isSend());
        }
        if (localaecg.c != null) {
          localaecg.c.setVisibility(8);
        }
        if (localaecg.b != null) {
          localaecg.b.setVisibility(8);
        }
        paramacun = (TextView)paramBaseChatItemLayout.findViewById(2131364141);
        if ((!paramChatMessage.mNeedTimeStamp) || (paramChatMessage.time <= 0L) || (paramacun == null) || (paramChatMessage.time == ((Long)paramacun.getTag()).longValue())) {
          break label1513;
        }
        if (localaecg.b != null) {
          localaecg.b.setPadding(0, actn.a(70.0F, localContext.getResources()), 0, 0);
        }
        if (localaecg.c != null) {
          localaecg.c.setPadding(0, actn.a(80.0F, localContext.getResources()), 0, 0);
        }
        label964:
        ...
        if ((paramChatMessage.isFlowMessage) && (i == 0) && (!(this.jdField_a_of_type_AndroidContentContext instanceof MultiForwardActivity)))
        {
          ...
          if (localaecg.b != null)
          {
            localaecg.b.setImageResource(2130846197);
            localaecg.b.setVisibility(0);
          }
        }
        label1055:
        if (localaecg.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout != null)
        {
          if (!((balw)localObject2).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage)) {
            break label1613;
          }
          localaecg.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.setRobotNextTipsView(true, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage);
        }
        label1094:
        if (localaecg.jdField_a_of_type_Aibs != null) {
          localaecg.jdField_a_of_type_Aibs.b(paramChatMessage);
        }
        return localObject1;
        localaecg = (aecg)a();
        localaecg.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout = paramBaseChatItemLayout;
        paramBaseChatItemLayout.setTag(localaecg);
        paramView = null;
        break;
        label1142:
        ((ETTextView)localObject1).setAutoLinkMask(0);
        break label154;
        localaecg.d.setText(localContext.getString(2131719132));
        paramView = "";
        continue;
        a(localaecg, paramChatMessage);
        if (!TextUtils.isEmpty(paramView.sb))
        {
          if (!TextUtils.isEmpty(paramView.sb2))
          {
            localaecg.d.setText(paramView.sb2);
            label1213:
            super.a(localaecg.d, paramChatMessage);
            if (AppSetting.d)
            {
              localObject2 = ayla.e(paramChatMessage.msg);
              ...
              localaecg.d.setContentDescription((CharSequence)localObject3);
            }
          }
          for (;;)
          {
            ...
            break;
            localaecg.d.setText(paramView.sb);
            break label1213;
            label1296:
            localaecg.d.setContentDescription((CharSequence)localObject2);
          }
        }
        localaecg.d.setText("");
        if (QLog.isColorLevel()) {
        ...
        {
          localaecg.d.setText(((MessageForHiBoom)localObject2).mHiBoomMessage.text);
      ...
      for (;;)
      {
        localaecg.d.setText(paramView);
        break;
        localaecg.d.setText(paramChatMessage.msg);
        super.a(localaecg.d, paramChatMessage);
        paramView = paramChatMessage.msg;
        break;
        label1513:
        if (localaecg.b != null) {
          localaecg.b.setPadding(0, actn.a(30.0F, localContext.getResources()), 0, 0);
        }
        if (localaecg.c == null) {
          break label964;
        }
        localaecg.c.setPadding(0, actn.a(30.0F, localContext.getResources()), 0, 0);
        break label964;
        i = 0;
        break label998;
        if (localaecg.c == null) {
        ...
        localaecg.c.setImageResource(2130846197);
        localaecg.c.setVisibility(0);
        break label1055;
        localaecg.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.setRobotNextTipsView(false, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage);
        break label1094;
      }
      label1637:
  ...
  public String a(ChatMessage paramChatMessage)
  {
    if (((paramChatMessage instanceof MessageForText)) || ((paramChatMessage instanceof MessageForReplyText))) {
      return ajyc.a(2131714856) + ayla.e(paramChatMessage.msg);
    }
    return ajyc.a(2131714854) + paramChatMessage.msg;
  }
  ...
  public void a(int paramInt, Context paramContext, ChatMessage paramChatMessage)
  {
    ...
    case 2131364825: 
      do
      {
        ...
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006447", "0X8006447", 0, 0, "1", "", "", "");
      ...
      if (paramChatMessage.isMultiMsg)
      {
        ...
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009D65", "0X8009D65", paramInt, 0, "" + paramInt, "", "", "");
      }
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800644A", "0X800644A", 0, 0, "1", "", "", "");
    }
    label515:
    label904:
    label1294:
    for (;;)
    {
      ...
      aaod.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramChatMessage.msg, paramChatMessage.uniseq);
      return;
      ...
      if (aibp.a().c())
      {
        ...
        if (paramContext != null) {
          if (paramContext.length() == aibp.a().a())
          {
            ...
            axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004045", "0X8004045", 0, 0, "1", "", "", "");
            if (paramInt == 0) {
              break label904;
            }
      ...
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009D67", "0X8009D67", 1, 0, "1", "", "", "");
      return;
  ...
  public void a(acun paramacun, View paramView, ChatMessage paramChatMessage, ambh paramambh)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
        } while (!(paramacun instanceof aecg));
        localObject = (aecg)paramacun;
      } while (a(paramChatMessage, (aecg)localObject));
      boolean bool = axmt.b();
      if ((paramambh.jdField_a_of_type_Int == 0) || (!paramambh.a()) || (bool))
      {
        ...
        if (paramChatMessage.isSend())
        {
          ...
          ((aecg)localObject).d.setTextColor(paramacun);
          if (arqn.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo))
          {
            ...
            i = -1;
            ((aecg)localObject).d.setTextColor(i);
          }
          if (!paramChatMessage.isSend()) {
            break label200;
          }
        ...
        {
          ((aecg)localObject).d.setLinkTextColor(paramacun);
          return;
      ...
      ColorStateList.valueOf(paramambh.jdField_b_of_type_Int);
      if (paramambh.jdField_b_of_type_Int == 0)
      {
        ((aecg)localObject).d.setTextColor(-16777216);
        ColorStateList.valueOf(-16777216);
        if (paramambh.c != 0) {
          break label385;
        }
      }
      for (paramacun = paramView.getResources().getColorStateList(2131166874);; paramacun = ColorStateList.valueOf(paramambh.c))
      {
        ((aecg)localObject).d.setLinkTextColor(paramacun);
        ...
        ((ETTextView)((aecg)localObject).d).setShadowLayer(3.0F, 0.0F, 0.0F, paramambh.d);
        ((ETTextView)((aecg)localObject).d).setStrokeColor(true, paramambh.d);
        if (!QLog.isColorLevel()) {
          break;
        }
        QLog.d("ChatItemBuilder", 2, "bubble has stroke, color = " + paramambh.d);
        return;
        ((aecg)localObject).d.setTextColor(paramambh.jdField_b_of_type_Int);
        break label246;
      }
    } while ((!paramambh.jdField_b_of_type_Boolean) || (((ChatBackgroundManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(63)).a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, ((aecg)localObject).d.getCurrentTextColor(), 10000.0D * ((aecg)localObject).jdField_a_of_type_Ambh.jdField_a_of_type_Double) != 1));
    label146:
    paramacun = (ETTextView)((aecg)localObject).d;
    label385:
    label397:
  ...
  public void a(acun paramacun, ChatMessage paramChatMessage)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
        } while ((actn.g) || (!(paramacun instanceof aecg)));
        paramacun = (aecg)paramacun;
        if (((paramChatMessage.istroop == 3000) || (paramChatMessage.istroop == 1)) && ((!paramChatMessage.isShowQIMStyleGroup) && (!arqn.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo)) && ((!this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Boolean) || (!this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.h)) && (!axmt.b()))) {
          break;
        }
        localObject1 = new ETFont(0, null, 0.0F);
      } while (!(paramacun.d instanceof ETTextView));
      ((ETTextView)paramacun.d).setFont((ETFont)localObject1, paramChatMessage.uniseq);
      return;
    } while (!(paramacun.d instanceof ETTextView));
    ...
    localETTextView.setMinWidth(actn.a(65.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
    if ((!(paramChatMessage instanceof MessageForReplyText)) || (!(paramacun instanceof adyq))) {
      localETTextView.setMinHeight(actn.a(57.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
    }
    ...
    if ((ho.a(paramChatMessage)) && ((paramChatMessage instanceof MessageForText)))
    {
      ...
      if (!TextUtils.isEmpty(((MessageForText)???).sb))
      {
        ...
        paramacun = ((MessageForText)???).sb2;
      }
      if ((paramacun != null) && (ayla.a(paramacun)))
      {
    ...
    for (;;)
    {
      synchronized (jdField_a_of_type_ComTencentUtilLRULinkedHashMap)
      {
        ...
        {
          paramacun = (SpannableString)jdField_a_of_type_ComTencentUtilLRULinkedHashMap.get(Long.valueOf(l2));
          if (paramacun != null)
          {
            localETTextView.setText(paramacun);
          ...
          {
            axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Font_Mall", "0X8007B2B", 0, 0, "" + (((hn)localObject1).jdField_b_of_type_Int - 1), "" + ((hn)localObject1).jdField_a_of_type_Int, "", "");
            ho.jdField_a_of_type_Long = paramChatMessage.time * 1000L;
            paramacun = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().edit();
            paramacun.putLong("personal_font_last_send_report", paramChatMessage.time * 1000L);
            paramacun.commit();
          }
          if (((hn)localObject1).jdField_a_of_type_ComEtrumpMixlayoutETFont == null) {
            break label946;
          }
          paramacun = ((hn)localObject1).jdField_a_of_type_ComEtrumpMixlayoutETFont;
          paramacun.setSize(localETTextView.getTextSize());
          ...
          localETTextView.setFont(paramacun, paramChatMessage, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
          if (!QLog.isColorLevel()) {
            break;
          }
          ...
          return;
          label705:
          paramacun = ((MessageForText)???).sb;
          break label293;
        }
        if ((localObject1 != null) && (((hn)localObject1).jdField_b_of_type_Int == 1)) {
          localETTextView.isParsingMagicFont = true;
        }
        ArkRecommendLogic.a().post(new TextItemBuilder.6(this, paramacun, l1, l2));
      }
      label762:
      ...
      {
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Font_Mall", "0X8007B2C", 0, 0, "" + (((hn)localObject1).jdField_b_of_type_Int - 1), "" + ((hn)localObject1).jdField_a_of_type_Int, "", "");
        ho.jdField_b_of_type_Long = paramChatMessage.time * 1000L;
        paramacun = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().edit();
        paramacun.putLong("personal_font_last_receive_report", paramChatMessage.time * 1000L);
        paramacun.commit();
        continue;
        label946:
        paramacun = new ETFont(((hn)localObject1).jdField_a_of_type_Int, ((hn)localObject1).jdField_a_of_type_JavaLangString, localETTextView.getTextSize(), ((hn)localObject1).jdField_b_of_type_Int, ((hn)localObject1).jdField_a_of_type_AndroidGraphicsTypeface);
        continue;
        label982:
    ...
    label1092:
    label1094:
    for (paramacun = "null";; paramacun = ((hn)localObject1).toString())
    {
      QLog.d("VasFont", 2, paramacun);
      return;
  ...
  void a(aecg paramaecg, ChatMessage paramChatMessage)
  {
    if ((paramChatMessage instanceof MessageForLongTextMsg)) {}
    ho localho;
    do
    {
      ...
      {
        return;
      } while ((axmt.b()) || ((1 == paramChatMessage.istroop) && (mye.a(paramChatMessage))));
  ...
  public void a(View paramView)
  {
    ...
    bbcv.a(this.jdField_a_of_type_AndroidContentContext, 230, str1, str2, new aecd(this, paramView), new aece(this)).show();
  }
  ...
  protected void a(ChatMessage paramChatMessage, String paramString)
  {
    ...
    if (localaibp.c())
    {
      localObject = localaibp.a();
      if (localObject != null) {
        if (((String)localObject).length() == localaibp.a())
        {
          i = 1;
          localaibp.d();
        }
    ...
    while (j < ((StringBuilder)localObject).length())
    {
      ...
      {
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", "0X800588D", 0, 0, "", "", "", "");
        if (QLog.isColorLevel()) {
          QLog.d("ChatItemBuilder", 2, "report save small emoticon amount");
        }
        bgpr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 13, 0, paramChatMessage.istroop);
        return;
      }
      j += 1;
    }
    if (i == 0)
    {
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", paramString, "0X8009AAC", "0X8009AAC", 4, 0, "", "", "", "");
      return;
    }
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", paramString, "0X8009AAB", "0X8009AAC", 4, 0, "", "", "", "");
  }
  
  public boolean a(acun paramacun)
  {
    return paramacun instanceof aecg;
  }
  ...
  public bblt[] a(View paramView)
  {
    ...
    for (i = 1;; i = 0)
    {
      ...
      j = 1;
      if (j != 0) {
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009B17", "0X8009B17", 0, 0, "", "", "", "");
      }
      ...
      if (j == 0) {
        localbblr.a(2131364825, ajyc.a(2131714855), 2130838597);
      }
  ...
  {
    int i = 0;
    super.b(paramacun, paramChatMessage);
    if ((paramChatMessage instanceof MessageForLongTextMsg)) {
      break label15;
    }
    label15:
    ...
    for (;;)
    {
      ...
      if ((paramacun instanceof aecg))
      {
        ...
        for (paramacun = paramChatMessage.sb2;; paramacun = paramChatMessage.sb)
        {
          if ((paramacun == null) || (!(paramacun instanceof ayki))) {
            break label152;
          }
          paramChatMessage = (ayki)paramacun;
          paramacun = (aykp[])paramChatMessage.getSpans(0, paramacun.length(), aykp.class);
          if ((paramacun.length <= 0) || (paramChatMessage.b().length() != 0)) {
            break;
          }
    ...
    localaecg.d.setText(paramChatMessage);
  }
