...
{
  public ahoe(CameraProxy paramCameraProxy, Looper paramLooper)
  {
    super(paramLooper);
  }
    ...
    for (;;)
    {
      ...
      if ((!CameraControl.a().a((String)localObject3)) && (!CameraControl.a().a("auto")) && (!CameraControl.a().a(this)))
      {
        ...
        if (!CameraControl.a().a("auto"))
        {
          this.a.jdField_a_of_type_ComTencentMobileqqShortvideoMediadeviceCameraProxy$CameraPreviewObservable.a(9, new Object[] { "无法开启自动对焦功能" });
          continue;
          localObject3 = (ahoh)paramMessage.obj;
          a(((ahoh)localObject3).jdField_a_of_type_AndroidGraphicsRect, ((ahoh)localObject3).b, ((ahoh)localObject3).jdField_a_of_type_AndroidHardwareCamera$AutoFocusCallback);
          continue;
          if (QLog.isColorLevel()) {
                          ...
                          else
                          {
                            ...
                            if ((((CameraControl)localObject3).c()) && (CameraProxy.a(this.a) != null))
                            {
                              ...
                              try
                              {
                                ...
                                localObject3 = (ahoi)paramMessage.obj;
                                ...
                                if (((ahoi)localObject3).jdField_a_of_type_JavaIoFile == null)
                                {
                                ...
                                ((CameraControl)localObject4).a(((ahoi)localObject3).jdField_a_of_type_JavaIoFile, ((ahoi)localObject3).jdField_a_of_type_AndroidGraphicsRect, ((ahoi)localObject3).jdField_a_of_type_ComTencentMobileqqActivityRichmediaViewCameraCover$PictureCallback, ((ahoi)localObject3).jdField_a_of_type_Int, ((ahoi)localObject3).jdField_a_of_type_Boolean, ((ahoi)localObject3).jdField_b_of_type_Int);
                                continue;
                                i = ((Integer)((Object[])(Object[])paramMessage.obj)[0]).intValue();
                                CameraControl.a().c(i);
                                continue;
