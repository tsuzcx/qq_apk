...
public class ahoe
  extends alox
{
  private ahoe(AlphabetFriendFragment paramAlphabetFriendFragment) {}
    ...
    if ((paramBoolean) && (this.a.isResumed())) {
      try
      {
        ...
        if ((paramArrayOfObject != null) && (paramArrayOfObject.length > 0))
        {
          ...
          {
            QQToast.a(this.a.getActivity(), 2, alpo.a(2131700600), 0).a();
            return;
          }
          QQToast.a(this.a.getActivity(), 2, alpo.a(2131700601), 0).a();
          return;
        }
      }
    ...
    if ((paramBoolean2) || (!paramBoolean1))
    {
      ...
      if (AlphabetFriendFragment.a(this.a))
      {
        if (AlphabetFriendFragment.b(this.a))
        {
          ...
          if (this.a.a != null) {
            this.a.a.a(this.a.b(), paramBoolean1, null);
          }
        }
