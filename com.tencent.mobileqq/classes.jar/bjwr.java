  ...
  implements MessageQueue.IdleHandler
{
  ...
  public boolean queueIdle()
  {
    ...
    Object localObject = this.a.jdField_a_of_type_Bjye.getActivity().getIntent().getExtras();
    ...
    for (localObject = "null";; localObject = str6)
    {
      ...
      localObject = new bkja(str4);
      ((bkja)localObject).b = str1;
      ((bkja)localObject).c = str2;
      ((bkja)localObject).d = str3;
      this.a.jdField_a_of_type_DovComTencentBizQqstoryTakevideoLinkerLinkerSummaryView.setLinkerObject((bkja)localObject);
      this.a.jdField_a_of_type_Bjww.a(Message.obtain(null, 15, 1, 0));
      return false;
      localObject = str4;
      break label168;
      localObject = str1;
