...
public abstract class bjwr
{
  ...
  public long a(long paramLong)
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Bjwv != null) {
        this.jdField_a_of_type_Bjwv.b(l2 / 1000L);
      }
      ...
      ykq.b(a(), "end seekTo timecost=" + (System.currentTimeMillis() - l1) + " seekTargetTimeUs:" + paramLong + " realStartTime:" + l2);
      return l2;
    }
    catch (RuntimeException localRuntimeException)
    {
      for (;;)
      {
        ykq.c(a(), "decoder flush error %s", localRuntimeException);
      }
    }
  }
  ...
  protected abstract void a(bjws parambjws, MediaCodec paramMediaCodec, MediaFormat paramMediaFormat);
  
  public boolean a()
  {
    boolean bool2 = false;
    bjwo.a(this.jdField_a_of_type_Bjwt.jdField_a_of_type_Long, "[" + a() + "] init now");
    ...
    for (;;)
    {
      ...
      try
      {
        this.jdField_a_of_type_AndroidMediaMediaExtractor.setDataSource(this.jdField_a_of_type_Bjws.b);
        bjwo.a(this.jdField_a_of_type_Bjwt.jdField_a_of_type_Long, "[" + a() + "] extractor setDataSource");
        i = 0;
        bool1 = bool2;
        if (i < this.jdField_a_of_type_AndroidMediaMediaExtractor.getTrackCount())
        {
          ...
          if (!str.startsWith(this.jdField_a_of_type_Bjws.a)) {
            break label353;
          }
          this.jdField_a_of_type_AndroidMediaMediaExtractor.selectTrack(i);
          bjwo.a(this.jdField_a_of_type_Bjwt.jdField_a_of_type_Long, "[" + a() + "] find and selectTrack");
        }
      }
      catch (IOException localIOException)
      {
        String str;
        ykq.b(a(), "init set data source error :%s", localIOException);
        return false;
      }
      try
      {
        this.jdField_a_of_type_AndroidMediaMediaCodec = MediaCodec.createDecoderByType(str);
        bjwo.a(this.jdField_a_of_type_Bjwt.jdField_a_of_type_Long, "[" + a() + "] create codec");
        a(this.jdField_a_of_type_Bjws, this.jdField_a_of_type_AndroidMediaMediaCodec, this.jdField_a_of_type_AndroidMediaMediaFormat);
        bjwo.a(this.jdField_a_of_type_Bjwt.jdField_a_of_type_Long, "[" + a() + "] configureCodec");
        bool1 = true;
      }
      catch (Throwable localThrowable)
      {
        ykq.b(a(), "init createDecoderByType error :%s", localThrowable);
        bool1 = bool2;
        continue;
      }
      if (!bool1) {
      ...
      ykq.b(a(), "create media decoder success!");
      return bool1;
      label353:
      i += 1;
    }
    ykq.d(a(), "create media decoder error!");
    return bool1;
  }
  ...
  public void b()
  {
    ...
    {
      ykq.c(a(), "onRelease error :%s ", localException);
    }
  }
  
  public boolean b()
  {
    ykq.a(a(), "start ! %s", this.jdField_a_of_type_Bjws);
    try
    {
    ...
    catch (Throwable localThrowable)
    {
      ...
      {
        ykq.c(a(), "decode start error :%s", localException);
      }
      localThrowable = localThrowable;
      ykq.c(a(), "decode start error", localThrowable);
      return false;
    }
  }
