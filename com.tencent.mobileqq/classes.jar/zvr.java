...
public class zvr
{
  private static final String jdField_a_of_type_JavaLangString = zvr.class.getSimpleName();
  ...
  public static String a(long paramLong)
  {
    ...
    try
    {
      str = BaseApplicationImpl.getContext().getString(2131720182);
      localObject2 = BaseApplicationImpl.getContext().getString(2131720183);
      localObject1 = BaseApplicationImpl.getContext().getString(2131720181);
