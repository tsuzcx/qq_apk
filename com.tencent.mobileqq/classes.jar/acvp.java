...
public final class acvp
{
  ...
  public static void a(Context paramContext, acvr paramacvr, int paramInt, long paramLong)
  {
    paramContext = BaseApplicationImpl.getContext();
    paramacvr = a(paramContext, 1059, new GdtAd(paramacvr.jdField_a_of_type_TencentGdtQq_ad_get$QQAdGetRsp$AdInfo), paramacvr.jdField_a_of_type_Int, paramacvr.jdField_b_of_type_Int, null);
    if (paramInt == 0)
    {
      paramacvr.internalErrorCode = 0;
      paramacvr.errorCode1 = paramInt;
      if (paramLong == -2147483648L) {
        break label124;
      }
    }
    ...
    {
      paramacvr.duration = paramLong;
      AdAnalysis.INSTANCE.handleAsync(new WeakReference(paramContext), new AdAnalysisEvent(paramacvr, 102));
      return;
      if (paramInt == 1)
      {
        paramacvr.internalErrorCode = 2;
        break;
      }
      if (paramInt == 2)
      {
        paramacvr.internalErrorCode = 4;
        break;
      }
      paramacvr.internalErrorCode = 0;
      break;
  ...
  public static void a(Context paramContext, acvr paramacvr, String paramString)
  {
    paramContext = BaseApplicationImpl.getContext();
    paramacvr = a(paramContext, 1056, new GdtAd(paramacvr.jdField_a_of_type_TencentGdtQq_ad_get$QQAdGetRsp$AdInfo), paramacvr.jdField_a_of_type_Int, paramacvr.jdField_b_of_type_Int, paramString);
    AdAnalysis.INSTANCE.handleAsync(new WeakReference(paramContext), new AdAnalysisEvent(paramacvr, 102));
  }
  
  public static void a(Context paramContext, acvr paramacvr, String paramString, int paramInt)
  {
    paramContext = BaseApplicationImpl.getContext();
    paramacvr = a(paramContext, 1060, new GdtAd(paramacvr.jdField_a_of_type_TencentGdtQq_ad_get$QQAdGetRsp$AdInfo), paramacvr.jdField_a_of_type_Int, paramacvr.jdField_b_of_type_Int, paramString);
    paramacvr.httpErrorCode = paramInt;
    if (paramacvr.httpErrorCode == 200) {
      paramacvr.internalErrorCode = 0;
    }
    for (;;)
    {
      AdAnalysis.INSTANCE.handleAsync(new WeakReference(paramContext), new AdAnalysisEvent(paramacvr, 102));
      return;
      if (paramacvr.httpErrorCode == -1) {
        paramacvr.internalErrorCode = 3;
      } else {
        paramacvr.internalErrorCode = 5;
      }
    }
  }
  
  public static void a(Context paramContext, acvr paramacvr, String paramString, int paramInt, long paramLong)
  {
    paramContext = BaseApplicationImpl.getContext();
    paramacvr = a(paramContext, 1057, new GdtAd(paramacvr.jdField_a_of_type_TencentGdtQq_ad_get$QQAdGetRsp$AdInfo), paramacvr.jdField_a_of_type_Int, paramacvr.jdField_b_of_type_Int, paramString);
    paramacvr.httpErrorCode = paramInt;
    if (paramacvr.httpErrorCode == 200) {
      paramacvr.internalErrorCode = 0;
    }
