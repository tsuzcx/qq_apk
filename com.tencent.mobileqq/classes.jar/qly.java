  ...
  extends ViewBase
{
  ...
  private RecyclerView.OnScrollListener jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$OnScrollListener = new qlz(this);
  ...
  public qly(VafContext paramVafContext)
  {
  ...
  {
    this.jdField_a_of_type_Qmi = new qmi(paramVafContext);
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView.setAdapter(this.jdField_a_of_type_Qmi);
    this.jdField_a_of_type_Qmi.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView);
    this.jdField_a_of_type_Qmi.a(new qma(this));
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView.addOnChildAttachStateChangeListener(new qmb(this));
  ...
  private void b()
  {
    ...
    {
      return;
      int m = this.jdField_a_of_type_Qmi.a();
        ...
        if (m > k)
        {
          ...
          if (i < m)
          {
            ...
            if (i == 0)
            {
              ...
              this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = localContext.getResources().getDrawable(2130849412);
              this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = localContext.getResources().getDrawable(2130849413);
  ...
  private void c()
  {
    if ((this.jdField_e_of_type_Boolean) && (this.jdField_a_of_type_Qmh != null))
    {
      if (this.jdField_a_of_type_Qmi.a() > 1)
      {
        this.jdField_a_of_type_Qmh.a();
        this.jdField_a_of_type_Qmh.a(this.jdField_b_of_type_Int);
        this.jdField_a_of_type_Qmh.b(this.jdField_c_of_type_Int);
      }
    }
    else {
      return;
    }
    this.jdField_a_of_type_Qmh.b();
  }
  ...
  private void d()
  {
    ...
    for (float f1 = 1.0F;; f1 = 0.0F)
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView.setOnStateChangeListener(new qmf(this));
      return;
    }
  }
  ...
  {
    this.jdField_a_of_type_Qmi.a(parampxk);
    a();
  }
  
  public void a(qlx paramqlx)
  {
  ...
  {
    this.jdField_a_of_type_Qmi.a(paramqms);
  }
  ...
  public void onParseValueFinished()
  {
    ...
    d();
    if ((this.jdField_a_of_type_Int == 1) && (this.jdField_a_of_type_Qmh == null))
    {
      this.jdField_a_of_type_Qmh = new qmh();
      this.jdField_a_of_type_Qmh.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView);
      this.jdField_a_of_type_Qmh.a(new qme(this));
    }
    if (this.jdField_a_of_type_Qmu == null)
    {
      this.jdField_a_of_type_Qmu = new qmu(this.jdField_f_of_type_Boolean, this.jdField_a_of_type_ArrayOfInt[0], this.jdField_a_of_type_ArrayOfInt[1], this.jdField_a_of_type_ArrayOfInt[2], this.jdField_a_of_type_ArrayOfInt[3]);
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView.addItemDecoration(this.jdField_a_of_type_Qmu);
    }
    ...
    for (int i = 0;; i = 8)
    {
      ...
      this.jdField_a_of_type_Qmi.a(this.jdField_d_of_type_Boolean);
      c();
      return;
    }
  }
  ...
  public boolean setAttribute(int paramInt, Object paramObject)
  {
    ...
    case 1052: 
      try
      {
        ...
        this.jdField_a_of_type_Qmi.a(localList);
