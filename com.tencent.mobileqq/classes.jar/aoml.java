...
public class aoml
  extends ajzm
{
  public aoml(Face2FaceAddFriendActivity paramFace2FaceAddFriendActivity) {}
  
  protected void a(aonm paramaonm, boolean paramBoolean, int paramInt)
  {
    super.a(paramaonm, paramBoolean, paramInt);
    ...
    if (paramaonm == null)
    {
      ...
      if ((this.a.jdField_b_of_type_Int == 0) && (paramaonm != null) && (!this.a.a(paramaonm, this.a.jdField_a_of_type_JavaUtilList)))
      {
        this.a.jdField_a_of_type_JavaUtilList.add(paramaonm);
        if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      QLog.d(Face2FaceAddFriendActivity.jdField_a_of_type_JavaLangString, 2, "onGetFaceToFaceNearbyUserPush, nearbyUser=" + paramaonm.e);
      break;
      label267:
      Message localMessage = Face2FaceAddFriendActivity.a(this.a).obtainMessage();
      localMessage.what = 10;
      localMessage.obj = paramaonm;
  ...
  protected void a(boolean paramBoolean, List<aonm> paramList, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      long l = System.currentTimeMillis() - aomz.c;
      if (QLog.isColorLevel()) {
        QLog.d(Face2FaceAddFriendActivity.jdField_a_of_type_JavaLangString, 2, "onGetFaceToFaceNearbyUserList interval=" + l + "leaveFaceTofaceTime=" + aomz.c);
      }
      if ((l > i * 1000) || (aomz.c == 0L)) {
        break label259;
      }
    ...
    for (;;)
    {
      ...
      {
        localaonk = (aonk)paramList.next();
        if (!this.a.jdField_a_of_type_JavaUtilList.contains(localaonk)) {}
      }
      else
      {
      ...
      this.a.jdField_a_of_type_JavaUtilList.add(localaonk);
    }
  }
}
