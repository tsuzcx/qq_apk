...
public final class bgch
{
  ...
  private final List<bgcl> jdField_b_of_type_JavaUtilList = new ArrayList();
  private int jdField_c_of_type_Int = -1;
  private final List<bgci> jdField_c_of_type_JavaUtilList = new ArrayList();
  
  public bgch(@NonNull Bitmap paramBitmap)
  {
    if ((paramBitmap == null) || (paramBitmap.isRecycled())) {
      throw new IllegalArgumentException("Bitmap is not valid");
    }
    this.jdField_c_of_type_JavaUtilList.add(bgcf.a);
    this.jdField_a_of_type_AndroidGraphicsBitmap = paramBitmap;
    this.jdField_a_of_type_JavaUtilList = null;
    this.jdField_b_of_type_JavaUtilList.add(bgcl.a);
    this.jdField_b_of_type_JavaUtilList.add(bgcl.b);
    this.jdField_b_of_type_JavaUtilList.add(bgcl.c);
    this.jdField_b_of_type_JavaUtilList.add(bgcl.d);
    this.jdField_b_of_type_JavaUtilList.add(bgcl.e);
    this.jdField_b_of_type_JavaUtilList.add(bgcl.f);
  }
  ...
  public bgcf a()
  {
    ...
    if (this.jdField_a_of_type_AndroidGraphicsBitmap != null)
    {
      ...
      {
        localObject = null;
        localObject = new bgca(arrayOfInt, i, (bgci[])localObject);
        if (localBitmap != this.jdField_a_of_type_AndroidGraphicsBitmap) {
          localBitmap.recycle();
        }
        localObject = ((bgca)localObject).a();
        if (0 != 0) {
          throw new NullPointerException();
        }
      }
    ...
    for (;;)
    {
      localObject = new bgcf((List)localObject, this.jdField_b_of_type_JavaUtilList);
      ((bgcf)localObject).a();
      if (0 != 0) {
        throw new NullPointerException();
      }
      return localObject;
      localObject = (bgci[])this.jdField_c_of_type_JavaUtilList.toArray(new bgci[this.jdField_c_of_type_JavaUtilList.size()]);
      break;
