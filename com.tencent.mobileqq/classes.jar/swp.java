...
public class swp
{
  public static CharSequence a(String paramString1, String paramString2, String paramString3, String paramString4, ArticleInfo paramArticleInfo)
  {
    ...
    {
      paramString4.setBounds(0, 0, zft.b(BaseApplicationImpl.getContext(), 17.0F), zft.b(BaseApplicationImpl.getContext(), 17.0F));
      ...
      paramString3.setSpan(new zuc(paramString4), 0, 1, 17);
      paramString3.setSpan(new swq(-15504151, 16777215, 860716207, paramString2, paramArticleInfo), 0, paramString1.length(), 33);
