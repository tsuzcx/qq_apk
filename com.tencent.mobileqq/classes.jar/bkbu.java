...
public class bkbu
{
  ...
  private List<bkbv> jdField_a_of_type_JavaUtilList;
  ...
  private Pair<Integer, List<bkbv>> a(String paramString, int paramInt)
  {
    Object localObject = null;
    byte[] arrayOfByte = new bkcp().a(paramString, null, 1);
  ...
  /* Error */
  private Pair<Integer, List<bkbv>> a(byte[] paramArrayOfByte, int paramInt)
  {
    // Byte code:
    ...
    //   42: aload_0
    //   43: aload 7
    //   45: invokespecial 155	bkbu:a	(Lorg/w3c/dom/Element;)I
    //   48: istore_3
    //   49: iload_3
    //   50: ifeq +8 -> 58
    //   53: iload_3
    ...
    //   208: aload_0
    //   209: aload 8
    //   211: invokespecial 172	bkbu:a	(Lorg/w3c/dom/Node;)Lbkbv;
    //   214: astore 8
    //   216: aload 8
    //   218: ifnull +127 -> 345
    //   221: aload 5
  ...
  private bkbv a(Node paramNode)
  {
    ...
    do
    {
      for (;;)
      {
          ...
          else
          {
            ...
            if (str != null)
            {
              ...
              if (localObject != null) {
                ...
                {
                  localbkbv.jdField_a_of_type_Int = Integer.parseInt((String)localObject);
                  i = k + 1;
                }
                else if (str.equalsIgnoreCase("type"))
                {
                  localbkbv.jdField_b_of_type_Int = Integer.parseInt((String)localObject);
                  i = k + 1;
                }
                else if (str.equalsIgnoreCase("flags"))
                {
                  localbkbv.c = Integer.parseInt((String)localObject);
                  i = k + 1;
                }
                else if (str.equalsIgnoreCase("path"))
                {
                  localbkbv.jdField_b_of_type_JavaLangString = ((String)localObject);
                  i = k + 1;
                }
                else
                {
                  ...
                  {
                    localbkbv.jdField_a_of_type_JavaLangString = ((String)localObject);
                    i = k + 1;
                  }
                }
              }
        ...
        localbkbv.jdField_a_of_type_AndroidOsBundle = a(paramNode);
        return localbkbv;
        j += 1;
        k = i;
      }
  ...
  private String a()
  {
    return bkaa.a() + File.separator + "QSec.dat";
  }
  ...
  private boolean a(String paramString, int paramInt, List<bkbv> paramList)
  {
    paramList = a(paramInt, paramList);
    if (paramList == null) {
      return false;
    }
    return new bkcp().a(paramString, paramList, null, 1);
  }
  
  /* Error */
  private byte[] a(int paramInt, List<bkbv> paramList)
  {
    // Byte code:
    ...
    //   132: ldc 182
    //   134: aload 6
    //   136: getfield 183	bkbv:jdField_a_of_type_Int	I
    ...
    //   154: ldc 185
    //   156: aload 6
    //   158: getfield 188	bkbv:jdField_b_of_type_Int	I
    ...
    //   198: ldc 200
    //   200: aload 6
    //   202: getfield 202	bkbv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   217: ldc 195
    //   219: aload 6
    //   221: getfield 198	bkbv:jdField_b_of_type_JavaLangString	Ljava/lang/String;
  ...
  private bkbv b(int paramInt)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext())
    {
      bkbv localbkbv = (bkbv)localIterator.next();
      if (localbkbv.jdField_a_of_type_Int == paramInt) {
        return localbkbv;
      }
    }
    return null;
  ...
  {
    bkbv localbkbv = b(paramInt);
    if (localbkbv == null) {}
    do
    {
      return;
      this.jdField_a_of_type_JavaUtilList.remove(localbkbv);
    } while (!paramBoolean);
  ...
  public boolean a(bkbv parambkbv, boolean paramBoolean)
  {
    if (a(parambkbv.jdField_a_of_type_Int)) {
      return false;
    }
    this.jdField_a_of_type_JavaUtilList.add(parambkbv);
    if (paramBoolean) {
      return a();
    }
    return true;
