...
public class bjoz
{
  private static final bjoe<bjoz, Void> jdField_a_of_type_Bjoe = new bjpa();
  private LinkedHashMap<Long, WebAppIpRecord> jdField_a_of_type_JavaUtilLinkedHashMap;
  
  public static bjoz a()
  {
    return (bjoz)jdField_a_of_type_Bjoe.b(null);
  }
  
  private File a()
  {
    File localFile = new File(bjdq.n() + File.separator + "webapp_iplist");
    if (!localFile.exists())
    {
  ...
  public void a()
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 159	bjoz:jdField_a_of_type_JavaUtilLinkedHashMap	Ljava/util/LinkedHashMap;
    //   8: ifnull +17 -> 25
    //   11: aload_0
    //   12: getfield 159	bjoz:jdField_a_of_type_JavaUtilLinkedHashMap	Ljava/util/LinkedHashMap;
    ...
    //   49: aload_0
    //   50: getfield 159	bjoz:jdField_a_of_type_JavaUtilLinkedHashMap	Ljava/util/LinkedHashMap;
    ...
    //   92: aload_0
    //   93: aload_0
    //   94: getfield 159	bjoz:jdField_a_of_type_JavaUtilLinkedHashMap	Ljava/util/LinkedHashMap;
    //   97: iload_2
    //   98: sipush 1000
    //   101: imul
    //   102: i2l
    //   103: invokespecial 191	bjoz:a	(Ljava/util/LinkedHashMap;J)Ljava/util/LinkedHashMap;
    //   106: astore 8
    //   108: aload 6
    //   110: astore 5
    ...
    //   506: astore 5
    //   508: aload_0
    //   509: invokespecial 277	bjoz:a	()Ljava/io/File;
    //   512: astore 8
    //   514: aload 8
    //   516: ifnull +91 -> 607
    //   519: aload 6
  ...
  public void b()
  {
    ...
    //   19: invokestatic 39	bjdq:n	()Ljava/lang/String;
    ...
    //   78: pop
    //   79: aload 4
    //   81: invokestatic 314	bjps:a	(Ljava/io/File;)Z
    //   84: pop
    //   85: aload 5
    //   87: ifnonnull +39 -> 126
    //   90: aload_3
    ...
    //   286: ifnull -24 -> 262
    //   289: aload 6
    //   291: getfield 101	cooperation/qzone/statistic/serverip/WebAppIpRecord:jdField_a_of_type_CooperationQzoneStatisticServeripWebAppIpRecord$FixedSizeLinkedHashMap	Lcooperation/qzone/statistic/serverip/WebAppIpRecord$FixedSizeLinkedHashMap;
    //   294: ifnull -32 -> 262
    //   297: aload 6
    //   299: getfield 101	cooperation/qzone/statistic/serverip/WebAppIpRecord:jdField_a_of_type_CooperationQzoneStatisticServeripWebAppIpRecord$FixedSizeLinkedHashMap	Lcooperation/qzone/statistic/serverip/WebAppIpRecord$FixedSizeLinkedHashMap;
    //   302: invokevirtual 338	cooperation/qzone/statistic/serverip/WebAppIpRecord$FixedSizeLinkedHashMap:keySet	()Ljava/util/Set;
    //   305: invokeinterface 339 1 0
    //   310: astore 5
    //   312: aload 5
    //   314: invokeinterface 235 1 0
    //   319: ifeq -57 -> 262
    //   322: aload 5
    //   324: invokeinterface 239 1 0
    //   329: checkcast 111	java/lang/Integer
    //   332: astore_3
    //   333: invokestatic 164	cooperation/qzone/util/QZLog:isColorLevel	()Z
    //   336: ifeq +43 -> 379
    //   339: ldc 166
    //   341: iconst_2
    //   342: new 32	java/lang/StringBuilder
    //   345: dup
    //   346: invokespecial 33	java/lang/StringBuilder:<init>	()V
    //   349: ldc_w 341
    //   352: invokevirtual 43	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   355: aload_3
    //   356: invokevirtual 344	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   359: ldc_w 346
    //   362: invokevirtual 43	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   365: aload 6
    //   367: getfield 130	cooperation/qzone/statistic/serverip/WebAppIpRecord:jdField_a_of_type_Long	J
    ...
    //   376: invokestatic 252	cooperation/qzone/util/QZLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   379: aload_3
    ...
    //   391: invokestatic 360	bjod:c	(ILjava/lang/String;)V
    //   394: goto -82 -> 312
    //   397: astore_3
    //   398: aload_3
