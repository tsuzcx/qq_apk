  ...
  extends azqj
{
  ...
  public azsm()
  {
    this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new azsn(this);
    this.jdField_a_of_type_JavaLangString = "picture";
    this.jdField_a_of_type_Int = 16;
  }
  
  public azsm(String paramString)
  {
    this();
    this.S = paramString;
  }
  
  public azsm(String paramString1, String paramString2)
  {
    this();
    this.S = paramString1;
    this.T = paramString2;
  ...
  public static Bitmap a(Drawable paramDrawable)
  {
    try
    {
      ...
      for (Object localObject = Bitmap.Config.ARGB_8888;; localObject = Bitmap.Config.RGB_565)
      {
        ...
        paramDrawable = bdda.a((Bitmap)localObject, i, i, i);
  ...
  public View a(Context paramContext, View paramView, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        Drawable localDrawable1 = nth.a().a((Resources)localObject3, 2130849786);
        ...
        else
        {
          try
          {
            ...
            ((PAHighLightImageView)localObject1).setImageDrawable(bcxb.a(((BaseActivity)paramContext).app, 4, paramBundle.optString("groupcode")));
      ...
      catch (OutOfMemoryError localOutOfMemoryError)
      {
        for (;;)
        {
          ...
          ((PAHighLightImageView)localObject2).setId(2131368083);
          ((PAHighLightImageView)localObject2).setContentDescription(((Resources)localObject3).getString(2131691290));
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          ((PAHighLightImageView)localObject1).setImageDrawable(bdda.a());
          return localObject2;
        }
        ...
        paramContext.setTag(bcuq.b(j, j, j));
      ...
      if ("StructMsgItemCover createView ,exception  = " + paramContext != null)
      {
          ...
          if ((localObject3 instanceof BaseActivity))
          {
            ...
            if (paramView.indexOf("internal_phone") > -1)
            {
              ...
              else
              {
                ...
                paramContext = ((Context)localObject3).getResources().getDrawable(2130841731);
              }
            }
            for (;;)
            {
              ...
              {
                paramContext = bcxb.b(localQQAppInterface, paramBundle, (byte)3);
              }
              else
              {
                paramContext = bcxb.a(11, 3);
                continue;
                paramContext = bcxb.a(localQQAppInterface, 1, paramBundle, 3, paramContext, paramContext);
              }
            }
          }
        }
        ...
        {
          ((PAHighLightImageView)localObject1).setImageResource(2130843441);
          return localObject2;
        }
        if (QLog.isColorLevel()) {
        ...
        for (;;)
        {
          for (;;)
          {
            try
            {
              if (this.p == m)
              {
                j = aekt.a(70.0F, (Resources)localObject3);
                i = j;
              }
            }
            catch (MalformedURLException paramContext) {}
          ...
          j = aekt.a(140.0F, (Resources)localObject3);
          i = j;
          continue;
          paramBundle = null;
          if (paramView.startsWith("http://p.qlogo.cn/gh/"))
          {
            ...
            if ((paramView instanceof BaseActivity))
            {
              ...
              paramBundle = bcxb.a(4, 3);
              ((PAHighLightImageView)localObject1).setImageDrawable(bcxb.a(paramView, 4, paramContext, 3, paramBundle, paramBundle));
              return localObject2;
            }
            ((PAHighLightImageView)localObject1).setImageDrawable(bdda.a());
            return localObject2;
      ...
      for (;;)
      {
        ...
        {
          ((PAHighLightImageView)localObject1).setScaleType(ImageView.ScaleType.CENTER_CROP);
          i = aekt.a(70.0F, (Resources)localObject3);
          if (!bool1) {
            break label1943;
          }
          ((PAHighLightImageView)localObject1).setBackgroundColor(Color.parseColor("#dddfe2"));
        ...
        for (;;)
        {
          ...
          paramContext.restartDownload();
          break label2045;
          if ((paramView.startsWith(yqb.b)) || (paramView.startsWith(yqb.c)) || (paramView.startsWith(yqb.d)))
          {
            ((PAHighLightImageView)localObject1).setBackgroundDrawable(null);
            i = paramView.lastIndexOf("&uin=");
            paramContext = paramView.substring("&uin=".length() + i);
          ...
          if ((paramView.startsWith("http://imgplat.store.qq.com/bqq_qfpic/520520")) || (paramView.contains(yjq.jdField_a_of_type_JavaLangString)))
          {
            paramBoolean = true;
          ...
          if (this.p == n)
          {
            ...
            i = aekt.a(140.0F, (Resources)localObject3);
            break label1367;
          }
          ((PAHighLightImageView)localObject1).setScaleType(ImageView.ScaleType.CENTER);
          break label1367;
  ...
  StructMsgForGeneralShare a(View paramView)
  {
    for (paramView = paramView.getParent(); paramView != null; paramView = paramView.getParent())
    {
      ...
      if (paramView.getId() == 2131377085) {
        return (StructMsgForGeneralShare)paramView.getTag(2131377085);
      }
    }
    return null;
  }
  ...
  public void a(View paramView, int paramInt1, int paramInt2)
  {
    ...
    for (localObject2 = null;; localObject2 = ((ChatFragment)localObject2).a())
    {
      ...
      catch (Exception localException)
      {
        ...
        azmj.b((QQAppInterface)localObject2, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D93", "0X8005D93", paramInt2, 1, paramInt1, str, String.valueOf(paramView.msgId), "1", "");
        return;
      }
  ...
  public boolean a(azsa paramazsa)
  {
    ...
    do
    {
      ...
      {
        return true;
        str = paramazsa.a("cover");
        if (str == null) {
          break;
        }
        this.S = str;
      } while (this.jdField_a_of_type_Int <= 3);
      this.c = paramazsa.a("action");
    ...
    for (;;)
    {
      ...
      this.T = paramazsa.a("needRoundView");
      return true;
      str = "";
      break label18;
