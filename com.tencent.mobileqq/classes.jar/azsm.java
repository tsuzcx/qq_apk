  ...
  implements IServiceCmdCallback
{
  ...
  public azsm(azsk paramazsk, String paramString)
  {
  ...
  public void e()
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_b_of_type_JavaUtilMap)
      {
        ...
        azsk.b(this.jdField_b_of_type_Azsk, new String[] { "fg30CmdCount", "|", String.valueOf(i) });
        ...
        if (localIterator1.hasNext())
        {
          ...
          azsk.b(this.jdField_b_of_type_Azsk, new String[] { "fg30CmdAlarm", "|", str, "|", localStringBuilder.toString() });
        }
      }
  ...
  public void f()
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_b_of_type_JavaUtilMap)
      {
        ...
        azsk.b(this.jdField_b_of_type_Azsk, new String[] { "bg5CmdCount", "|", String.valueOf(i) });
        ...
        if (localIterator1.hasNext())
        {
          ...
          azsk.b(this.jdField_b_of_type_Azsk, new String[] { "bg5CmdAlarm", "|", str, "|", localStringBuilder.toString() });
        }
      }
      this.jdField_c_of_type_JavaUtilMap.clear();
      return;
  ...
  public void onCmdRequest(String paramString)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Aztb.a(paramString);
    ...
    if ((localMap == null) || ((localMap != null) && (localMap.size() > 0)))
    {
      ...
      if (localIterator.hasNext())
      {
        ...
        if (!azsk.a())
        {
          ...
          label299:
          if (!azsk.a.contains(localObject)) {
            break label475;
          }
          i = 1;
        }
    ...
    for (;;)
    {
      ...
      azsk.a(this.jdField_b_of_type_Azsk, new String[] { "cmd|", localStringBuilder.toString() });
      localObject = this.jdField_b_of_type_Azsk;
      if (j > this.jdField_c_of_type_Int)
      {
        i = 1;
        azsk.a((azsk)localObject, 3, 0, i, alud.a(2131701460) + paramString, "2秒钟命令字请求次数：" + j);
      }
      for (;;)
      {
        ...
        if ((azsk.a(this.jdField_b_of_type_Azsk) != null) && (QLog.isColorLevel())) {
          azsk.a(this.jdField_b_of_type_Azsk, "No high frequnecy cmd in last 2seconds");
        }
      }
      break label236;
    }
