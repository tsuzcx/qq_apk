...
public class awia
{
  ...
  public int a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, String paramString, WtloginObserver paramWtloginObserver)
  {
    ...
    return paramQQAppInterface.RegGetSMSVerifyLoginAccount(paramArrayOfByte1, paramArrayOfByte2, paramString, "8.3.5", paramWtloginObserver);
  }
  ...
  public boolean a(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    localbdjz.setTitle(2131717563);
    localbdjz.setMessage(2131717562);
    paramQQAppInterface = new awib(this, str, paramActivity, paramQQAppInterface);
    paramActivity = new awic(this);
    localbdjz.setPositiveButton(2131717561, paramQQAppInterface);
    localbdjz.setNegativeButton(2131690648, paramActivity);
    localbdjz.show();
    return false;
  }
