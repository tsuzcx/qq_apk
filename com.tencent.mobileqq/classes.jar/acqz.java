...
public class acqz
  extends anii
{
  public acqz(AppInterface paramAppInterface)
  {
  ...
  public void a(Context paramContext, GdtBaseAdItem paramGdtBaseAdItem)
  {
    ...
    if (ardl.a(paramGdtBaseAdItem.jdField_a_of_type_JavaLangString, paramContext))
    {
      acrg.a(paramGdtBaseAdItem.f);
      ...
      {
        acrw.b(paramContext, paramGdtBaseAdItem);
        return;
      }
      acrw.a(paramContext, paramGdtBaseAdItem);
      return;
    }
    if (!TextUtils.isEmpty(paramGdtBaseAdItem.jdField_b_of_type_JavaLangString))
    {
      ...
      label133:
      String str;
      if ((acrw.a()) && (paramGdtBaseAdItem.jdField_a_of_type_Boolean))
      {
        localObject = "1";
        if (QLog.isColorLevel()) {
          QLog.d("GdtAdHandler", 2, "doAppJump autoDownload  " + (String)localObject);
        }
        if (!acrw.a(paramGdtBaseAdItem.jdField_b_of_type_JavaLangString)) {
          break label576;
        }
        if (("1".equals(localObject)) && (TextUtils.isEmpty((String)acrw.a(paramGdtBaseAdItem.jdField_b_of_type_JavaLangString).get("acttype")))) {
          paramGdtBaseAdItem.jdField_b_of_type_JavaLangString += "&acttype=42";
        }
        if (TextUtils.isEmpty((String)acrw.a(paramGdtBaseAdItem.jdField_b_of_type_JavaLangString).get("wv"))) {
          paramGdtBaseAdItem.jdField_b_of_type_JavaLangString += "&wv=1";
        }
        str = (String)acrw.a(paramGdtBaseAdItem.jdField_b_of_type_JavaLangString).get("_autodownload");
      ...
      label576:
      acrg.a(paramGdtBaseAdItem.f);
      paramContext = (String)biqd.a(paramGdtBaseAdItem.jdField_b_of_type_JavaLangString).get("auto_download");
