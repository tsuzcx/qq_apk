...
{
  public adkx(AuthDevVerifyCodeActivity paramAuthDevVerifyCodeActivity) {}
  ...
  private void a(int paramInt1, String paramString, int paramInt2, ErrMsg paramErrMsg, DevlockInfo paramDevlockInfo)
  {
    ...
    paramString = this.a.getString(2131716463);
  ...
  public void onVerifyClose(int paramInt1, String paramString, int paramInt2, ErrMsg paramErrMsg)
  {
    ...
    this.a.setResult(-1);
    this.a.finish();
    asll.a().a((AppRuntime)AuthDevVerifyCodeActivity.a(this.a).get(), this.a, paramString, true);
  }
}
