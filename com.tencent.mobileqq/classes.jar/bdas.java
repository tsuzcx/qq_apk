  ...
  extends bcod
{
  ...
  public bdas(FriendListOpenFrame paramFriendListOpenFrame)
  {
  ...
  protected void a()
  {
    ...
    Object localObject1 = this.jdField_a_of_type_ComTencentOpenAgentFriendListOpenFrame.jdField_a_of_type_Bddv.a(this.jdField_a_of_type_ComTencentOpenAgentFriendListOpenFrame.jdField_a_of_type_Int);
    bdht.c("FriendListOpenFrame", "-->start constructHashStruct()");
    ...
    bdht.c("FriendListOpenFrame", "-->end constructHashStruct()");
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_ComTencentOpenAgentFriendListOpenFrame.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562408, paramViewGroup, false);
      paramViewGroup = new bdat();
      ...
      if (!this.jdField_a_of_type_ComTencentOpenAgentFriendListOpenFrame.jdField_a_of_type_Bddv.a(localFriend.a)) {
        break label369;
      }
      ...
      if ((localFriend.d == null) || ("".equals(localFriend.d))) {
        localFriend.d = bdec.a(this.jdField_a_of_type_ComTencentOpenAgentFriendListOpenFrame.jdField_a_of_type_ComTencentOpenAgentFriendChooser.a(), localFriend.a);
      }
      ...
      bddz.a().a(localFriend.d, this.jdField_a_of_type_ComTencentOpenAgentFriendListOpenFrame);
    }
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = (bdat)paramView.getTag();
      break;
      label369:
