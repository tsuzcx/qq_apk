...
{
  public jvc(MultiIncomingCallUICtr paramMultiIncomingCallUICtr) {}
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if (paramContext.equals("tencent.av.EXIT_QZONE_LIVE_RSP_ACTION")) {
      if (this.a.b == 1) {
        this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().postDelayed(new jvd(this), 500L);
      }
    }
    do
    {
