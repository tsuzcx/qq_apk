...
{
  nwv(Context paramContext, QQAppInterface paramQQAppInterface, bisl parambisl, SessionInfo paramSessionInfo, String paramString) {}
    ...
    for (;;)
    {
      try
      {
        ...
        if (((mobileqq_mp.RetInfo)localGetEqqAccountDetailInfoResponse.ret_info.get()).ret_code.get() == 0)
        {
          ...
          nwu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramBundle);
          nwu.a(this.jdField_a_of_type_Bisl);
          if (QLog.isDevelopLevel()) {
            QLog.d("IVR_TS_CrmUtils", 4, "<<<end getDetail, ts=" + System.currentTimeMillis());
          }
          nwu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, null, paramBundle, this.jdField_a_of_type_JavaLangString);
          nwu.a(this.jdField_a_of_type_Bisl);
          return;
        }
      }
      catch (InvalidProtocolBufferMicroException paramBundle)
      {
        ...
        bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80049DF", "GetDetailFalse", 0, 0, "", "", "", "");
        nwu.a(this.jdField_a_of_type_Bisl);
        return;
      }
      nwu.a(this.jdField_a_of_type_AndroidContentContext, 2131694983);
