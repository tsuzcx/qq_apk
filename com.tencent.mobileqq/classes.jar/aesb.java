...
import com.tencent.mobileqq.activity.QQSettingMe.35.2;
import com.tencent.mobileqq.activity.QQSettingMe.35.3;
import com.tencent.mobileqq.activity.QQSettingMe.35.4;
...
{
  public aesb(QQSettingMe paramQQSettingMe) {}
  ...
  public void onCardDownload(boolean paramBoolean, Object paramObject)
  {
    ...
    do
    {
      ...
      {
        this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.runOnUiThread(new QQSettingMe.35.1(this));
        ThreadManager.post(new QQSettingMe.35.2(this), 5, null, true);
        return;
      }
    ...
    ThreadManager.post(new QQSettingMe.35.3(this, (Card)paramObject), 5, null, true);
  }
  ...
  {
    if (paramBoolean) {
      ThreadManager.getUIHandler().post(new QQSettingMe.35.4(this));
    }
  }
  ...
  {
    if ((paramBoolean) && (this.a.c) && (this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (bhbx.a(paramString, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))) {
