  ...
  implements rjs
{
  ...
  public rkc(XListView paramXListView, List<BaseData> paramList, rjp paramrjp)
  {
  ...
  private rjp a()
  {
    ...
    {
      bfsi localbfsi = (bfsi)this.jdField_a_of_type_ComTencentWidgetXListView.getAdapter();
      if ((localbfsi.getWrappedAdapter() instanceof rjp)) {
        return (rjp)localbfsi.getWrappedAdapter();
      }
    }
    return null;
  }
  ...
  private boolean a(int paramInt)
  {
    ...
    {
      actj.a("ItemHeightHelper", "", new IllegalArgumentException(" data == null index: " + paramInt + "   itemArrayList.size() :" + this.jdField_a_of_type_JavaUtilList.size()));
      return true;
    }
    return false;
  }
  ...
  private int b(int paramInt)
  {
    ...
    try
    {
      localObject = ((rjp)localObject).a(paramInt, null, this.jdField_a_of_type_ComTencentWidgetXListView, true);
  ...
  public void a(int paramInt, View paramView)
  {
    ...
    paramView.getViewTreeObserver().addOnGlobalLayoutListener(new rkd(this, paramInt, paramView));
  }
}
