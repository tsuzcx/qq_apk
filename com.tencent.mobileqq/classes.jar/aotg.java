  ...
  implements agdg
{
  ...
  private List<aovl> jdField_a_of_type_JavaUtilList;
  private Drawable b;
  
  public aotg(Context paramContext)
  {
    ...
    this.b = paramContext.getResources().getDrawable(2130839117);
  }
  ...
  public void a(List<aovl> paramList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131494932, null);
      paramViewGroup = new aoti(this, null);
      paramViewGroup.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)paramView.findViewById(2131302158));
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131311502));
      paramViewGroup.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)paramView.findViewById(2131306307));
      paramView.setTag(paramViewGroup);
      localaovl = (aovl)getItem(paramInt);
      if (localaovl != null) {
        break label111;
      }
    ...
    {
      return paramView;
      paramViewGroup = (aoti)paramView.getTag();
      break;
      URL localURL = localaovl.a();
      int i = localaovl.a();
      if (localURL != null)
      {
        ...
        for (;;)
        {
          a(paramView, (URLDrawable)localObject, localaovl.b());
          if ((i != 1) || (!AsyncImageView.a(localURL)) || (!apdh.a(localaovl.b()))) {
            break;
          }
