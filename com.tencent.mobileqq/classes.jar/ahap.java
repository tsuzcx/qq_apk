...
public class ahap
  implements ahao, Handler.Callback
{
  int jdField_a_of_type_Int = xin.b(BaseApplicationImpl.getContext(), 50.0F);
  private aepc jdField_a_of_type_Aepc;
  private ahan jdField_a_of_type_Ahan;
  Animation.AnimationListener jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener = new ahaq(this);
  ...
  private ArrayList<ahar> jdField_a_of_type_JavaUtilArrayList;
  public List<QQOperationViopTipTask> a;
  private Observer jdField_a_of_type_JavaUtilObserver;
  protected final MqqHandler a;
  int jdField_b_of_type_Int = xin.b(BaseApplicationImpl.getContext(), 30.0F);
  Animation jdField_b_of_type_AndroidViewAnimationAnimation;
  ImageView jdField_b_of_type_AndroidWidgetImageView;
  RelativeLayout jdField_b_of_type_AndroidWidgetRelativeLayout;
  Animation c;
  
  public ahap(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, aepc paramaepc, XPanelContainer paramXPanelContainer, List<QQOperationViopTipTask> paramList)
  {
    this.jdField_a_of_type_MqqOsMqqHandler = new bhsl(Looper.getMainLooper(), this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo = paramSessionInfo;
    this.jdField_a_of_type_Aepc = paramaepc;
  ...
  private RelativeLayout a()
  {
    ...
    //   23: putfield 111	ahap:jdField_a_of_type_ComTencentImageURLImageView	Lcom/tencent/image/URLImageView;
    //   26: aload_1
    //   27: astore_2
    //   28: new 113	java/io/File
    //   31: dup
    //   32: getstatic 119	ntw:h	Ljava/lang/String;
    ...
    //   74: getstatic 119	ntw:h	Ljava/lang/String;
    ...
    //   92: astore_2
    //   93: aload_0
    //   94: getfield 111	ahap:jdField_a_of_type_ComTencentImageURLImageView	Lcom/tencent/image/URLImageView;
    //   97: aload_2
  ...
  private boolean a(ahar paramahar)
  {
    boolean bool3 = false;
    Object localObject1 = a(paramahar.b());
    int i = -1;
    int[] arrayOfInt = paramahar.a();
    boolean bool1;
    if (arrayOfInt != null)
    {
      if (this.jdField_a_of_type_Ahan != null) {
        i = this.jdField_a_of_type_Ahan.b();
      }
      boolean bool2 = true;
      int j = 0;
    ...
    for (;;)
    {
      if ((bool1) && ((paramahar instanceof ahan)) && (this.jdField_a_of_type_Ahan != null) && (this.jdField_a_of_type_Ahan.a() > ((ahan)paramahar).a()))
      {
  ...
  {
    if (this.jdField_a_of_type_Ahan != null) {
      return this.jdField_a_of_type_Ahan.b();
    }
    return -1;
  }
  ...
  public ahan a()
  {
    return this.jdField_a_of_type_Ahan;
  }
  ...
  public void a()
  {
    if (Thread.currentThread() == Looper.getMainLooper().getThread())
    {
      if (this.jdField_a_of_type_Aepc != null) {
        this.jdField_a_of_type_Aepc.a(this.jdField_a_of_type_Ahan);
      }
      this.jdField_a_of_type_Ahan = null;
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    if (this.jdField_a_of_type_JavaUtilArrayList != null)
    {
      ...
      while (localIterator.hasNext()) {
        ((ahar)localIterator.next()).a(paramInt, paramVarArgs);
      }
    }
  }
  
  public void a(ahar paramahar)
  {
    if (paramahar == null) {}
    do
    {
    ...
    } while (this.jdField_a_of_type_JavaUtilArrayList.contains(paramahar));
    this.jdField_a_of_type_JavaUtilArrayList.add(paramahar);
  }
  ...
  public void a(View.OnClickListener paramOnClickListener)
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setId(2131367726);
    }
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(paramOnClickListener);
    if (this.jdField_b_of_type_AndroidWidgetRelativeLayout == null) {
      this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_ComTencentWidgetXPanelContainer.findViewById(2131364139));
    }
    if (this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131367726) == null) {
  ...
  public boolean a(agzt paramagzt, Object... paramVarArgs)
  {
    if (paramagzt != null)
    {
      if (a(paramagzt)) {
    ...
    {
      return false;
      paramVarArgs = paramagzt.a(paramVarArgs);
      if (paramVarArgs != null)
      {
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(paramVarArgs, paramVarArgs.selfuin);
        if (QLog.isColorLevel()) {
          QLog.d("TipsManager", 2, "showGrayTips() success: from " + a(paramagzt.b()));
        }
        return true;
      }
    } while (!QLog.isColorLevel());
    QLog.d("TipsManager", 2, "showGrayTips() failure: MessageRecord null, from " + a(paramagzt.b()));
    return false;
  }
  
  public boolean a(ahan paramahan, Object... paramVarArgs)
  {
    if (aepi.l) {}
    label136:
    do
    {
      ...
      if (Thread.currentThread() == Looper.getMainLooper().getThread())
      {
        paramVarArgs = paramahan.a(paramVarArgs);
        this.jdField_a_of_type_Aepc.a(paramVarArgs, paramahan);
        this.jdField_a_of_type_Ahan = paramahan;
      }
      for (;;)
      {
        if (QLog.isColorLevel()) {
          QLog.d("TipsManager", 2, "showTipsBar() success: from " + a(paramahan.b()));
        }
        return true;
        paramVarArgs = new TipsManager.1(this, paramahan, paramVarArgs);
  ...
  public void c()
  {
    ...
    View localView1 = this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131378316);
    View localView2 = this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131378310);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        int k = BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131298914);
        if (i == -1) {
        ...
        for (i = j + k;; i = j)
        {
          ...
          localLayoutParams.rightMargin = xin.b(BaseApplicationImpl.getContext(), 40.0F);
  ...
  public void d()
  {
    ...
    try
    {
      if ((this.jdField_b_of_type_AndroidWidgetRelativeLayout != null) && (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) && (this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131367726) != null))
      {
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(null);
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.clearAnimation();
        this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131366607));
        this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131366608));
