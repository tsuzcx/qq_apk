  ...
  extends lrc
{
  ...
  private Frame a(List<lrh> paramList, Frame paramFrame)
  {
    ArrayList localArrayList1 = new ArrayList();
    int i = 0;
    while (i < paramList.size())
    {
      float[][] arrayOfFloat = ((TTFaceOriginDataModel)((lrh)paramList.get(i)).jdField_a_of_type_JavaUtilList.get(0)).facePoint;
  ...
  {
    Object localObject2 = (lrg)paramList.get(0);
    Object localObject1 = ((lrg)paramList.get(0)).jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame;
    ...
    if (((lrg)localObject2).a())
    {
      int i = 0;
      while (i < ((lrg)localObject2).jdField_a_of_type_JavaUtilList.size())
      {
        localArrayList.addAll(((lrh)((lrg)localObject2).jdField_a_of_type_JavaUtilList.get(i)).jdField_a_of_type_JavaUtilList);
        i += 1;
      }
    }
    ...
    if ((this.d) && (((lrg)localObject2).a()))
    {
      localObject2 = a(((lrg)localObject2).jdField_a_of_type_JavaUtilList, (Frame)localObject1);
      paramList = (List<lrg>)localObject2;
    ...
    for (paramList = (List<lrg>)localObject2;; paramList = (List<lrg>)localObject1)
    {
