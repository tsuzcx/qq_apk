  ...
  extends ExploreByTouchHelper
{
  ...
  public void onPopulateEventForVirtualView(int paramInt, AccessibilityEvent paramAccessibilityEvent)
  {
    ...
    if ((localObject instanceof ParticipleView))
    {
      ...
      if (paramInt < ((List)localObject).size()) {
        paramAccessibilityEvent.setContentDescription(((bhze)((List)localObject).get(paramInt)).a.a());
      }
    }
  }
  ...
  public void onPopulateNodeForVirtualView(int paramInt, AccessibilityNodeInfoCompat paramAccessibilityNodeInfoCompat)
  {
    ...
    if ((localObject instanceof ParticipleView))
    {
      ...
      {
        localObject = (bhze)((List)localObject).get(paramInt);
        if (bhze.a((bhze)localObject).size() > 0)
        {
          RectF localRectF = (RectF)bhze.a((bhze)localObject).get(0);
          paramAccessibilityNodeInfoCompat.setContentDescription(((bhze)localObject).a.a());
