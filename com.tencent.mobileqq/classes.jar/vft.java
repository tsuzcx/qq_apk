  ...
  extends Paint
{
    ...
    for (;;)
    {
      try
      {
        ...
        if (localSparseArray == null)
        {
          ...
          try
          {
            localBitmap1 = Bitmap.createBitmap(vtc.a(), paramInt, Bitmap.Config.ARGB_8888);
  ...
  private boolean c()
  {
    ...
    if (!vfu.a().a().native_isFontLoaded(this.jdField_a_of_type_ComEtrumpMixlayoutETFont.mFontId)) {
      return vfu.a().a().native_loadFont(this.jdField_a_of_type_ComEtrumpMixlayoutETFont.mFontPath, this.jdField_a_of_type_ComEtrumpMixlayoutETFont.mFontId, true);
    }
    return true;
  }
  ...
  public void a(String paramString, int paramInt, float paramFloat1, float paramFloat2, Canvas paramCanvas, Bitmap paramBitmap)
  {
    ...
    if (paramBitmap == null)
    {
      ...
      if ((paramBitmap == null) || (vfu.a().a() == null) || (!c()))
      {
        paramCanvas.drawText(paramString, paramFloat1, paramFloat2 - ascent(), this.jdField_a_of_type_AndroidGraphicsPaint);
        return;
      }
      ...
      jdField_a_of_type_AndroidGraphicsCanvas.setBitmap(paramBitmap);
      vfu.a().a().native_spaceDrawText(paramString, jdField_a_of_type_AndroidGraphicsCanvas, paramBitmap, 0, 0, this.jdField_a_of_type_ComEtrumpMixlayoutETFont, this.jdField_a_of_type_AndroidGraphicsPaint);
    ...
    vfu.a().a().native_spaceDrawText(paramString, paramCanvas, paramBitmap, (int)paramFloat1, (int)paramFloat2, this.jdField_a_of_type_ComEtrumpMixlayoutETFont, this.jdField_a_of_type_AndroidGraphicsPaint);
  }
  ...
  public boolean a(int paramInt1, String paramString, Paint paramPaint, int paramInt2)
  {
    ...
    do
    {
      ...
      {
        paramInt1 = BaseApplication.getContext().getResources().getDimensionPixelSize(2131296400);
        jdField_a_of_type_Int = Math.max(paramInt1 * paramInt1 * 240 * 8, 1048576);
      }
    } while ((!vfu.a().a(8, jdField_a_of_type_Int)) || ((paramInt2 == 4) && (!vfu.a().a())) || (vfu.a().a() == null) || (!c()));
    this.jdField_a_of_type_AndroidGraphicsPaint$FontMetrics = vfu.a().a(this.jdField_a_of_type_ComEtrumpMixlayoutETFont);
    return true;
  }
  ...
  public int getTextWidths(String paramString, int paramInt1, int paramInt2, float[] paramArrayOfFloat)
  {
    ...
    return localvfu.a(paramString, paramInt1, paramInt2, localETFont, localPaint, paramArrayOfFloat, bool);
  }
  ...
  public float measureText(String paramString, int paramInt1, int paramInt2)
  {
    ...
    return vfu.a().a(paramString, paramInt1, paramInt2, this.jdField_a_of_type_ComEtrumpMixlayoutETFont, this.jdField_a_of_type_AndroidGraphicsPaint);
  }
