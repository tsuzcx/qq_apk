...
public class awdz
  extends BaseAdapter
{
  private awdz(SignatureHistoryFragment paramSignatureHistoryFragment) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    do
    {
      ...
      if (i == 0)
      {
        ...
        if (paramView == null)
        {
          ...
          paramViewGroup = new awfn(this.a.getActivity(), this.a.getActivity().app, paramViewGroup, SignatureHistoryFragment.a(this.a));
          ...
          LayoutInflater.from(this.a.getActivity()).inflate(2131561108, (ViewGroup)localObject2);
          paramView.setTag(paramViewGroup);
          paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)paramView.findViewById(2131363980));
          paramViewGroup.jdField_a_of_type_ComTencentMobileqqRichstatusCommentWidgetCommentsView = ((CommentsView)paramView.findViewById(2131364309));
          paramViewGroup.jdField_a_of_type_ComTencentMobileqqRichstatusCommentWidgetCommentsView.setOnSpanItemClick(new awea(this));
          paramViewGroup.jdField_a_of_type_ComTencentMobileqqRichstatusCommentWidgetCommentsView.setOnItemClickListener(new aweb(this, (HistorySignItem)localObject1));
          paramViewGroup.jdField_a_of_type_ComTencentMobileqqRichstatusCommentWidgetCommentsView.setOnItemLongClickListener(new awec(this, (HistorySignItem)localObject1));
          paramViewGroup.jdField_a_of_type_ComTencentMobileqqRichstatusCommentWidgetLikesView = ((LikesView)paramView.findViewById(2131369471));
          paramViewGroup.jdField_a_of_type_ComTencentMobileqqRichstatusCommentWidgetLikesView.setOnItemClickListener(new awee(this));
          paramView.setTag(paramViewGroup);
        ...
        for (;;)
        {
          ...
          paramViewGroup.j();
          return paramView;
          paramViewGroup = (awfn)paramView.getTag();
          break;
      ...
      localObject1 = (awef)paramViewGroup.getTag();
      localObject2 = new AbsListView.LayoutParams(-1, -2);
      if (SignatureHistoryFragment.a(this.a) == 3)
      {
        ((awef)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
        ((awef)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(ajyc.a(2131714121));
        ((AbsListView.LayoutParams)localObject2).height = actn.a(60.0F, this.a.getResources());
        paramViewGroup.setLayoutParams((ViewGroup.LayoutParams)localObject2);
        return paramViewGroup;
      }
      if (SignatureHistoryFragment.a(this.a) == 2)
      {
        ((awef)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
        ((awef)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(ajyc.a(2131714107));
        ((AbsListView.LayoutParams)localObject2).height = actn.a(60.0F, this.a.getResources());
        paramViewGroup.setLayoutParams((ViewGroup.LayoutParams)localObject2);
        return paramViewGroup;
      }
    ...
    label662:
    label673:
    ((awef)localObject1).jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
    ((AbsListView.LayoutParams)localObject2).height = (axli.b / 4);
    paramViewGroup.setLayoutParams((ViewGroup.LayoutParams)localObject2);
    return paramViewGroup;
  }
