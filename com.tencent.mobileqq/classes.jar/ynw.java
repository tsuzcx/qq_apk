  ...
  implements IEventReceiver
{
  ...
  protected List<ynu> a;
  protected Map<Class<? extends ynv>, ynv> a;
  ...
  private ynu a(@NonNull EditVideoParams paramEditVideoParams)
  {
    ...
    if ((paramEditVideoParams.mEditSource instanceof EditLocalVideoSource))
    {
      ...
      paramEditVideoParams = new yll(this);
      this.jdField_a_of_type_Yll = paramEditVideoParams;
      return paramEditVideoParams;
    }
    if (paramEditVideoParams.getEnableHWEncode()) {
      return new HWEditLocalVideoPlayer(this);
    }
    paramEditVideoParams = new yog(this);
    this.jdField_a_of_type_Yog = paramEditVideoParams;
    return paramEditVideoParams;
  }
  
  private void a(EditVideoParams.EditSource paramEditSource)
  {
    yya localyya = new yya(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams);
    localyya.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.getStringExtra("extra_upload_temp_directory");
    if (localyya.jdField_b_of_type_JavaLangString == null) {
      localyya.jdField_b_of_type_JavaLangString = yyq.a(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.mBusinessId);
    }
    ...
    label139:
    for (localyya.jdField_a_of_type_Yye = new yye((String)((EditLocalGifSource)paramEditSource).a.get(0));; localyya.jdField_a_of_type_Yye = new yye(paramEditSource.getSourcePath()))
    {
      paramEditSource = this.jdField_a_of_type_JavaUtilList.iterator();
      while (paramEditSource.hasNext()) {
        ((ynu)paramEditSource.next()).a(0, localyya);
      }
    }
    a(localyya);
    b(localyya);
    ykq.d("Q.qqstory.publish.edit.EditVideoPartManager", "PUBLISH start, Folder = %s", new Object[] { localyya.jdField_b_of_type_JavaLangString });
    this.jdField_a_of_type_Ypg.a(anvx.a(2131703288), false, 500L);
    Stream.of(localyya).map(new yyc((ylc)a(ylc.class), null, true)).map(new ThreadOffFunction("Q.qqstory.publish.edit.EditVideoPartManager", 2)).map(new yyo(yls.jdField_a_of_type_JavaLangString + "qq_pic_merged_" + System.currentTimeMillis() + ".jpg")).map(new UIThreadOffFunction(this)).subscribe(a(localyya));
  }
  ...
  private boolean a(yya paramyya)
  {
    if (paramyya.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.doodlePath != null) {}
    do
    {
      do
      {
        return true;
      } while (paramyya.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.doodleRawPath != null);
      if (paramyya.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.atJsonData != null)
      {
        ykq.c("Q.qqstory.publish.edit.EditVideoPartManager", "HAS AT LABELS.");
        return true;
      }
    } while ((paramyya.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.backgroundMusicPath != null) || (paramyya.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.isMuteRecordVoice) || (paramyya.jdField_b_of_type_Boolean) || (paramyya.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.saveMode != 0));
    return false;
  }
  ...
  private void b(int paramInt)
  {
    ...
    for (String str1 = "2";; str1 = "1")
    {
      ...
      Bosses.get().postJob(new yoc(this, "Q.qqstory.publish.edit.EditVideoPartManager"));
      break;
      paramInt = 0;
      break label52;
    }
  ...
  private void b(EditVideoParams.EditSource paramEditSource)
  {
    ...
    if ((paramEditSource instanceof EditRecordVideoSource))
    {
      ...
      for (i = this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoFilter.a();; i = 0)
      {
        ...
        ykq.b("Q.qqstory.publish.edit.EditVideoPartManager", "publish video groupId=%s. fragment count=%d", str3, Integer.valueOf(localArrayList.size()));
        ...
        if (this.jdField_a_of_type_Ynf != null) {
          localObject1 = this.jdField_a_of_type_Ynf.a();
        }
        ...
        while (((Iterator)localObject1).hasNext()) {
          localArrayList.add(Integer.valueOf(((yqa)((Iterator)localObject1).next()).c));
        }
      }
    }
    if ((paramEditSource instanceof EditLocalVideoSource))
    {
      ...
      for (i = this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoFilter.a();; i = 0)
      {
        ...
        str2 = "";
        bool1 = false;
        ykq.b("Q.qqstory.publish.edit.EditVideoPartManager", "publishVideo EditLocalVideoSource.mediaInfo" + ((EditLocalVideoSource)localObject1).jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.toString());
        break;
      }
    }
    ...
    throw new IllegalArgumentException(anvx.a(2131703219) + paramEditSource);
    ykq.e("Q.qqstory.publish.edit.EditVideoPartManager", "can not find any video fragment ! break the process of publish");
    return;
    int m = 1;
    ...
    if (n < localArrayList.size())
    {
      ...
      b(i1);
      localyya = new yya(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams);
      localyya.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.multiFragmentGroupId = str3;
      localyya.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.createTime = (n * 1000 + l);
      localyya.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoMaxrate = CodecParam.mMaxrate;
      localyya.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoMinrate = CodecParam.mMinrate;
      localyya.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoUploadGroupTempDir = str4;
      localyya.jdField_b_of_type_JavaLangString = yyq.a(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.mBusinessId);
      localObject1 = this.jdField_a_of_type_Ypg.getActivity();
      boolean bool2;
      ...
      {
        bool2 = true;
        localyya.jdField_a_of_type_Yyg = new yyg((Activity)localObject1, i, j, str1, f, bool2, k, 0.0D, 0.0D, str2, bool1);
        if (!(paramEditSource instanceof EditLocalVideoSource)) {
          break label1065;
        }
        localyya.c = 0;
        localyya.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.putExtra("thumb_rotation", Integer.valueOf(localyya.c));
        if (!(paramEditSource instanceof EditTakeVideoSource)) {
          break label1075;
        }
        localyya.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.putExtra("is_hw_encode", Boolean.valueOf(true));
      }
      for (;;)
      {
        localObject1 = this.jdField_a_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject1).hasNext()) {
          ((ynu)((Iterator)localObject1).next()).a(i1, localyya);
        }
        label1041:
        ...
        break label957;
        label1075:
        localyya.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.putExtra("is_hw_encode", Boolean.valueOf(false));
      }
      a(localyya);
      b(localyya);
      ykq.d("Q.qqstory.publish.edit.EditVideoPartManager", "PUBLISH start, Folder = %s", new Object[] { localyya.jdField_b_of_type_JavaLangString });
      this.jdField_a_of_type_Ypg.a(anvx.a(2131703217), false, 500L);
      localObject1 = Stream.of(localyya).map(new ThreadOffFunction("Q.qqstory.publish.edit.EditVideoPartManager", 2));
      if ((!(paramEditSource instanceof EditTakeVideoSource)) && (!(paramEditSource instanceof EditLocalVideoSource))) {
        break label1305;
      }
      localObject1 = ((Stream)localObject1).map(new yyl(null, (yoi)a(yoi.class), i1));
      label1205:
      localObject2 = localObject1;
      if (this.jdField_a_of_type_Yml != null) {
        localObject2 = ((Stream)localObject1).map(this.jdField_a_of_type_Yml.a(i1));
      }
      if ((!(paramEditSource instanceof EditTakeVideoSource)) && (!(paramEditSource instanceof EditLocalVideoSource))) {
        break label1357;
      }
    ...
    label1305:
    label1357:
    for (Object localObject1 = ((Stream)localObject2).map(new yym());; localObject1 = ((Stream)localObject2).map(new yyp()).map(new yxz()))
    {
      ((Stream)localObject1).map(new yys(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams)).map(new UIThreadOffFunction(this)).subscribe(a(localyya));
      n += 1;
      break label759;
      break;
      if (m != 0)
      {
        localObject1 = ((Stream)localObject1).map(new yyh(null, (yoi)a(yoi.class), i1));
        break label1205;
      }
      localObject1 = ((Stream)localObject1).map(new yyh());
      break label1205;
    }
  }
  ...
  private void c(EditVideoParams.EditSource paramEditSource)
  {
    ...
    localyya.jdField_a_of_type_Yye = new yye(paramEditSource.getSourcePath());
    paramEditSource = this.jdField_a_of_type_JavaUtilList.iterator();
    while (paramEditSource.hasNext()) {
      ((ynu)paramEditSource.next()).a(0, localyya);
    }
    ...
    b(localyya);
    ykq.d("Q.qqstory.publish.edit.EditVideoPartManager", "PUBLISH start, Folder = %s", new Object[] { localyya.jdField_b_of_type_JavaLangString });
    this.jdField_a_of_type_Ypg.a(anvx.a(2131703274), false, 500L);
    this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(1);
    this.jdField_b_of_type_JavaUtilList.clear();
    paramEditSource = Stream.of(localyya).map(new ThreadOffFunction("Q.qqstory.publish.edit.EditVideoPartManager", 2)).map(new yyo(false)).map(new yyt());
    Object localObject = this.jdField_a_of_type_Ypg.getActivity();
    if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoFilter != null) {}
    for (int i = this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoFilter.a();; i = 0)
    {
      localObject = paramEditSource.map(new yyf((Activity)localObject, i));
      paramEditSource = (EditVideoParams.EditSource)localObject;
      if (this.jdField_a_of_type_Yml != null) {
        paramEditSource = ((Stream)localObject).map(this.jdField_a_of_type_Yml.a(0));
      }
      paramEditSource.map(new yyp()).map(new yxz()).map(new yys(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams)).map(new UIThreadOffFunction(this)).subscribe(a(localyya));
      return;
    }
  }
  ...
  private void v()
  {
    if ((this.jdField_a_of_type_Ypg == null) || (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams == null)) {
  ...
  public int a()
  {
    if ((this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.isEditVideo()) && (a(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.mEnableMasks, 32768)))
    {
      ...
      return this.jdField_a_of_type_Ynf.a();
    }
    return 0;
  }
  ...
  public int a(@NonNull Message paramMessage)
  {
    ...
    {
      ykq.b("Q.qqstory.publish.edit.EditVideoPartManager", "broadcast message ignore because of publishing, %s", new Throwable());
      return 0;
    }
    ...
    {
      if (!((ynu)localIterator.next()).b(Message.obtain(paramMessage))) {
        break label105;
      }
      i += 1;
    }
    ...
    for (;;)
    {
      break;
      if (i == 0) {
        ykq.d("Q.qqstory.publish.edit.EditVideoPartManager", "broadcastEditVideoMessage, but no one handled. %s", new Object[] { paramMessage });
      }
  ...
  public long a()
  {
    ...
    for (;;)
    {
      ...
      default: 
        ...
        {
          throw new RuntimeException(anvx.a(2131703291));
        }
        break;
      case 1: 
        return l / 2L;
  ...
  public long a(int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.isEditVideo()) && (a(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.mEnableMasks, 32768)))
    {
      localObject = (yoi)a(yoi.class);
      if (localObject != null)
      {
        l2 = ((yoi)localObject).a(paramInt);
        ykq.a("Q.qqstory.publish.edit.EditVideoPartManager", "getRealVideoTime %d by index %d", Long.valueOf(l2), Integer.valueOf(paramInt));
      }
    }
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        default: 
          ...
          {
            throw new RuntimeException(anvx.a(2131703329));
          }
          break;
        case 1: 
          return l1 / 2L;
  ...
  {
    return new yod(this, paramyya, SystemClock.uptimeMillis());
  }
  ...
  public ynv a(Class<? extends ynv> paramClass)
  {
    ...
    return (ynv)this.jdField_a_of_type_JavaUtilMap.get(paramClass);
  }
  ...
  public void a()
  {
    ...
    if (!this.jdField_b_of_type_Boolean)
    {
      ...
      localObject = this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.mEditSource;
      ykq.d("Q.qqstory.publish.edit.EditVideoPartManager", "onConfirmClick : %s", new Object[] { localObject });
      ...
      if ((localObject instanceof EditLocalVideoSource)) {
        ykv.a("video_edit", "pub_local", 0, 0, new String[] { "1" });
      }
    }
    label131:
    do
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext()) {
        ((ynu)localIterator.next()).a(paramInt1, paramInt2, paramIntent);
      }
  ...
  public final void a(int paramInt, Object paramObject)
  {
    ...
    if (this.jdField_b_of_type_Int != paramInt)
    {
      if (this.jdField_a_of_type_Boolean) {
        ykq.b("Q.qqstory.publish.edit.EditVideoPartManager", "change state while state changing, " + paramInt + " oldState:" + this.jdField_b_of_type_Int, new Throwable());
      }
      this.jdField_a_of_type_Boolean = true;
      ykq.b("Q.qqstory.publish.edit.EditVideoPartManager", "changeState : %s => %s", Integer.valueOf(this.jdField_b_of_type_Int), Integer.valueOf(paramInt));
      int i = this.jdField_b_of_type_Int;
      this.jdField_b_of_type_Int = paramInt;
      Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
      while (localIterator.hasNext()) {
        ((ynu)localIterator.next()).a(i, this.jdField_b_of_type_Int, paramObject);
      }
    }
    ...
    for (;;)
    {
      ...
      for (i = 1;; i = 0)
      {
        ...
        if ((i != 0) && (!TextUtils.isEmpty(paramContext)) && (l > 0L)) {
          ykv.a("content_flow", "clk_hot_pub", 0, 0, new String[] { String.valueOf(l), paramContext });
        }
        return;
        i = 2;
        break;
  ...
  void a(Intent paramIntent, int paramInt, PublishParam paramPublishParam)
  {
    ...
    {
    default: 
      this.jdField_a_of_type_Ypg.a(-1, paramIntent, 2130772030, 0);
      return;
    }
    ...
    this.jdField_a_of_type_Ypg.getActivity().startActivityForResult(paramIntent, 10010);
  }
  ...
  public void a(Bundle paramBundle)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
      ((ynu)localIterator.next()).a(paramBundle);
    }
  }
  ...
  protected void a(@NonNull EditVideoParams paramEditVideoParams)
  {
    ...
    Object localObject = new ymj(this, i);
    this.jdField_a_of_type_Ymj = ((ymj)localObject);
    ...
    {
      localObject = new yml(this, i);
      this.jdField_a_of_type_Yml = ((yml)localObject);
      localArrayList.add(localObject);
      localObject = new yoj(this);
      this.jdField_a_of_type_Yoj = ((yoj)localObject);
      localArrayList.add(localObject);
      localObject = new yop(this);
      this.jdField_a_of_type_Yop = ((yop)localObject);
      localArrayList.add(localObject);
    }
    if (a(i, 64))
    {
    ...
    else
    {
      if (a(i, 128))
      {
        localObject = new yno(this);
        this.jdField_a_of_type_Yno = ((yno)localObject);
        localArrayList.add(localObject);
      }
      ...
      {
        localObject = new ylt(this);
        this.jdField_a_of_type_Ylt = ((ylt)localObject);
        localArrayList.add(localObject);
      }
      if (a(i, 1024))
      {
        ...
        localObject = new ylw(this);
        this.jdField_a_of_type_Ylw = ((ylw)localObject);
        localArrayList.add(localObject);
      }
    }
    for (;;)
    {
      if (a(i, 4096))
      {
        localObject = new ylf(this);
        this.jdField_a_of_type_Ylf = ((ylf)localObject);
        localArrayList.add(localObject);
      }
      if (a(i, 16384))
      {
        localObject = new yoe(this);
        this.jdField_a_of_type_Yoe = ((yoe)localObject);
        localArrayList.add(localObject);
      }
      if (a(i, 131072))
      {
        localObject = new yoz(this);
        this.jdField_a_of_type_Yoz = ((yoz)localObject);
        localArrayList.add(localObject);
      }
      if ((paramEditVideoParams.isEditVideo()) && (a(i, 32768)))
      {
        paramEditVideoParams = new ynf(this);
        this.jdField_a_of_type_Ynf = paramEditVideoParams;
        localArrayList.add(paramEditVideoParams);
      }
      if (a(i, 2097152))
      {
        paramEditVideoParams = new yox(this);
        this.jdField_a_of_type_Yox = paramEditVideoParams;
        localArrayList.add(paramEditVideoParams);
      }
      if (a(i, 4194304))
      {
        paramEditVideoParams = new ypa(this);
        this.jdField_a_of_type_Ypa = paramEditVideoParams;
        localArrayList.add(paramEditVideoParams);
      }
      a(localArrayList);
      ...
      while (paramEditVideoParams.hasNext()) {
        ykq.a("Q.qqstory.publish.edit.EditVideoPartManager", "initEditVideoParts : %s", ((ynu)paramEditVideoParams.next()).getClass().getSimpleName());
      }
      ...
      break;
      label751:
      localObject = new yot(this);
      this.jdField_a_of_type_Yot = ((yot)localObject);
      localArrayList.add(localObject);
    }
  }
  ...
  public void a(Class<? extends ynv> paramClass, ynv paramynv)
  {
    ...
    if (!paramClass.isInstance(paramynv)) {
      throw new IllegalArgumentException("the 2nd parameter's type " + paramynv.getClass().getName() + " is not instance of " + paramClass.getName());
    }
    ynv localynv = (ynv)this.jdField_a_of_type_JavaUtilMap.get(paramClass);
    if (localynv == null) {
      ykq.b("Q.qqstory.publish.edit.EditVideoPartManager", "publishEditExport for %s with %s", paramClass.getSimpleName(), paramynv);
    }
    for (;;)
    {
      this.jdField_a_of_type_JavaUtilMap.put(paramClass, paramynv);
      return;
      ykq.d("Q.qqstory.publish.edit.EditVideoPartManager", "publishEditExport for %s replace %s by %s", new Object[] { paramClass.getSimpleName(), localynv, paramynv });
    }
  }
  ...
  public void a(String paramString, int paramInt1, int paramInt2, String... paramVarArgs)
  {
    if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.mBusinessId == 1) {
      Bosses.get().postJob(new yoa(this, "Q.qqstory.publish.edit.EditVideoPartManager", paramString, paramInt1, paramInt2, paramVarArgs));
    }
  }
  
  public void a(String paramString1, String paramString2, String paramString3, boolean paramBoolean) {}
  
  protected void a(List<ynu> paramList) {}
  
  public void a(ypg paramypg, EditVideoParams paramEditVideoParams)
  {
    o();
    if ((paramypg == null) || (paramEditVideoParams == null)) {
      throw new IllegalArgumentException("both ui ant params should not be null");
    }
    if ((this.jdField_a_of_type_Ypg != paramypg) || (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams != paramEditVideoParams))
    {
    ...
    while (paramEditVideoParams.hasNext())
    {
      ((ynu)paramEditVideoParams.next()).a(paramypg);
      continue;
      ykq.d("Q.qqstory.publish.edit.EditVideoPartManager", "duplicate attachUiAndParams ui=%s, params=%s", new Object[] { paramypg, paramEditVideoParams });
    }
  }
  
  public void a(yya paramyya)
  {
    Object localObject = paramyya.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.readerConfBytes;
    if ((localObject == null) || (localObject.length == 0))
    {
      ...
      paramyya.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.readerConfBytes = ((qqstory_struct.VideoReaderConf)localObject).toByteArray();
    }
  }
  ...
  public void b(Bundle paramBundle)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
      ((ynu)localIterator.next()).b(paramBundle);
    }
  ...
  {
    Bosses.get().postJob(new yob(this, "Q.qqstory.publish.edit.EditVideoPartManager", paramString, paramInt1, paramInt2, paramVarArgs));
  }
  
  public void b(yya paramyya)
  {
    ...
    if (l != 0L)
    {
      ...
      if (((ArrayList)localObject).size() > 0) {
        try
        {
          ...
          byte[] arrayOfByte = paramyya.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.spreadGroupBytes;
          if (arrayOfByte != null) {}
          try
          {
            localVideoSpreadGroupList.mergeFrom(paramyya.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.spreadGroupBytes);
            localVideoSpreadGroupList.group_list.set((List)localObject);
            localVideoSpreadGroupList.visibility_type.set(4);
            localVideoSpreadGroupList.setHasFlag(true);
            paramyya.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.spreadGroupBytes = localVideoSpreadGroupList.toByteArray();
            return;
          }
  ...
  public boolean b()
  {
    if ((this.jdField_a_of_type_Yop != null) && (this.jdField_a_of_type_Yop.a()))
    {
      ykq.d("Q.qqstory.publish.edit.EditVideoPartManager", "%s consume the back press event", new Object[] { this.jdField_a_of_type_Yop });
      return true;
    }
    if ((this.jdField_a_of_type_Yoj != null) && (this.jdField_a_of_type_Yoj.a()))
    {
      ykq.d("Q.qqstory.publish.edit.EditVideoPartManager", "%s consume the back press event", new Object[] { this.jdField_a_of_type_Yoj });
      return true;
    }
    if ((this.jdField_a_of_type_Ypa != null) && (this.jdField_a_of_type_Ypa.a()))
    {
      ykq.d("Q.qqstory.publish.edit.EditVideoPartManager", "%s consume the back press event", new Object[] { this.jdField_a_of_type_Ypa });
      return true;
    }
    ...
    {
      ykq.d("Q.qqstory.publish.edit.EditVideoPartManager", "%s consume the back press event", new Object[] { this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoMusic });
      return true;
    }
    if ((this.jdField_a_of_type_Yno != null) && (this.jdField_a_of_type_Yno.a()))
    {
      ykq.d("Q.qqstory.publish.edit.EditVideoPartManager", "%s consume the back press event", new Object[] { this.jdField_a_of_type_Yno });
      return true;
    }
    if ((this.jdField_a_of_type_Yml != null) && (this.jdField_a_of_type_Yml.a()))
    {
      ykq.d("Q.qqstory.publish.edit.EditVideoPartManager", "%s consume the back press event", new Object[] { this.jdField_a_of_type_Yml });
      return true;
    }
    if ((this.jdField_a_of_type_Ylt != null) && (this.jdField_a_of_type_Ylt.a()))
    {
      ykq.d("Q.qqstory.publish.edit.EditVideoPartManager", "%s consume the back press event", new Object[] { this.jdField_a_of_type_Ylt });
      return true;
    }
    ...
    {
      ykq.d("Q.qqstory.publish.edit.EditVideoPartManager", "%s consume the back press event", new Object[] { this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoArtFilter });
      return true;
    }
    if ((this.jdField_a_of_type_Ylf != null) && (this.jdField_a_of_type_Ylf.a()))
    {
      ykq.d("Q.qqstory.publish.edit.EditVideoPartManager", "%s consume the back press event", new Object[] { this.jdField_a_of_type_Ylf });
      return true;
    }
    d();
    return true;
  ...
  public int c()
  {
    int i = 0;
    if (this.jdField_a_of_type_Yml != null) {
      i = this.jdField_a_of_type_Yml.a(a());
    }
    int j = i;
  ...
  protected void c()
  {
    this.jdField_a_of_type_Ypg.a(0, null, 2130772030, 0);
  }
  ...
  public int d()
  {
    if (this.jdField_a_of_type_Ynf != null)
    {
      List localList = this.jdField_a_of_type_Ynf.a();
      if (localList != null) {
  ...
  public void d()
  {
    ...
    label444:
    label478:
    for (int j = this.jdField_a_of_type_Yml.b();; j = 0)
    {
      int i = j;
      if (this.jdField_a_of_type_Yno != null)
      {
        i = j;
        if (!TextUtils.isEmpty(this.jdField_a_of_type_Yno.a())) {
          i = j + 1;
        }
      }
      j = i;
      if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoMusic != null)
      {
        ...
        {
          j = i;
          if (!TextUtils.isEmpty(((yxk)localObject).g)) {
            j = i + 1;
          }
        }
      }
      ...
      if (this.jdField_a_of_type_Ylt != null) {
        i = j + this.jdField_a_of_type_Ylt.jdField_a_of_type_Int;
      }
      j = i;
      if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoArtFilter != null)
      {
      ...
      if (j < 4)
      {
        if ((this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.mBusinessId == 3) && (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.isEditPhoto()) && (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.mExtra != null) && (!anvx.a(2131703278).equals(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.mExtra.get("extra_publish_text"))))
        {
          localObject = anvx.a(2131703325);
          bhdj.a(this.jdField_a_of_type_Ypg.a(), 230, (String)localObject, null, anvx.a(2131703300), anvx.a(2131703243), new ynx(this), new yny(this)).show();
          return;
          localObject = "1";
          break;
        }
      ...
      if (a())
      {
        ...
        localObject = anvx.a(2131703207);
      }
      for (;;)
      {
        bkzi localbkzi = bkzi.a(this.jdField_a_of_type_Ypg.a(), false);
        localbkzi.a((CharSequence)localObject);
        localbkzi.a(anvx.a(2131703277), 3);
        localbkzi.d(anvx.a(2131703242));
        localbkzi.a(new ynz(this, localbkzi));
        localbkzi.show();
        return;
        localObject = "1";
        break;
  ...
  public void e()
  {
    ...
    if (this.jdField_a_of_type_Yml != null)
    {
      yre localyre = this.jdField_a_of_type_Yml.a().a();
      i = j;
      if (localyre != null)
      {
        i = j;
        if (localyre.a.a())
        {
          ...
          this.jdField_a_of_type_Ypg.a(anvx.a(2131703191), false, 500L);
          this.jdField_a_of_type_Yml.jdField_a_of_type_Int = 2;
          this.jdField_a_of_type_Yml.a().h();
          i = 1;
        }
      }
    }
  ...
  public void f()
  {
    a(this.jdField_a_of_type_Ypg.a());
    a();
  ...
  public void g()
  {
    ...
    ykq.b("Q.qqstory.publish.edit.EditVideoPartManager", "duplicate publish", new Throwable());
  }
  ...
  public void i()
  {
    ...
    while (((Iterator)localObject).hasNext()) {
      ((ynu)((Iterator)localObject).next()).a();
    }
    if (a()) {}
    for (localObject = "2";; localObject = "1")
    {
      a("exp_edit", 0, 0, new String[] { localObject });
      if (this.jdField_a_of_type_Yoz != null) {
        ykv.a("story_grp", "exp_share_grp", 0, 0, new String[] { "", "", "", "" });
      }
      return;
    }
  }
  ...
  public void k()
  {
    ...
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
      ((ynu)localIterator.next()).S_();
    }
    if ((!a()) || (a(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.mEnableMasks, 32)))
    {
      ykq.a("Q.qqstory.publish.edit.EditVideoPartManager", "getAudioResource, edit photo = %s", Boolean.valueOf(a()));
      bczp.a();
    }
  }
  ...
  public void l()
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
      ((ynu)localIterator.next()).f();
    }
    if ((!a()) || (a(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.mEnableMasks, 32)))
    {
      ykq.a("Q.qqstory.publish.edit.EditVideoPartManager", "releaseAudioResource, edit photo = %s", Boolean.valueOf(a()));
      bczp.b();
    }
  }
  ...
  void p()
  {
    DoodleLayout localDoodleLayout = this.jdField_a_of_type_Yml.a();
  ...
  {
    int j = 0;
    Object localObject = this.jdField_a_of_type_Ylt;
    ((ylt)localObject).jdField_a_of_type_Int += c();
    ...
    {
      return;
      localObject = this.jdField_a_of_type_Yml.a();
      yre localyre = ((DoodleLayout)localObject).a();
      i = j;
      if (localyre != null)
      {
        i = j;
        if (localyre.a.a())
        {
          this.jdField_a_of_type_Ypg.a(anvx.a(2131703411), false, 500L);
          this.jdField_a_of_type_Yml.jdField_a_of_type_Int = 3;
  ...
  public void r()
  {
    this.jdField_a_of_type_Ypg.b();
    Object localObject1 = this.jdField_a_of_type_Yml.a();
    Object localObject2 = ((DoodleLayout)localObject1).a(0);
    Object localObject3 = ((DoodleLayout)localObject1).b(0);
    this.jdField_a_of_type_Ylt.jdField_a_of_type_ArrayOfInt[0] = localObject2[0];
    this.jdField_a_of_type_Ylt.jdField_a_of_type_ArrayOfInt[1] = localObject2[1];
    this.jdField_a_of_type_Ylt.jdField_a_of_type_ArrayOfInt[2] = localObject3[0];
    this.jdField_a_of_type_Ylt.jdField_a_of_type_ArrayOfInt[3] = localObject3[1];
    this.jdField_a_of_type_Ylt.jdField_a_of_type_ArrayOfInt[4] = ((DoodleLayout)localObject1).a().a();
    ...
    if (localObject3 != null)
    {
      ...
      ykq.b("Q.qqstory.publish.edit.EditVideoPartManager", "onCropBtnPressed merge ： cost " + (SystemClock.uptimeMillis() - l));
    }
    this.jdField_a_of_type_Ylt.jdField_a_of_type_AndroidGraphicsBitmap = ((Bitmap)localObject1);
    a(11);
  }
