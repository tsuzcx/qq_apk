...
public class awbc
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7)
  {
    ...
    awbk.a(paramQQAppInterface.getApp(), paramString1);
    ...
    for (;;)
    {
      ThreadManagerV2.executeOnSubThread(new HuayangOpenHelper.1(paramString1, awat.a(paramQQAppInterface.getApp(), paramString6, paramString1), paramQQAppInterface, paramString3, paramString5, paramString4));
      a(paramString2, paramString2);
      return;
      if (!"download".equals(paramString5)) {
        break;
      }
      if (awax.a(paramString6))
      {
        awbj.a("2691701");
        break;
      }
      if (awax.b(paramString6))
      {
        awbj.a("2597718");
        break;
      }
      awbk.b(paramQQAppInterface.getApp(), paramString1);
      break;
    }
  }
  ...
  private static void a(String paramString1, String paramString2)
  {
    ...
    yup.a("huayang", "openHy", 0, 0, new String[] { str, paramString2 });
  }
}
