  ...
  extends pyz
{
  protected int a;
  protected Handler a;
  protected SparseArray<pyw[]> a;
  protected String a;
  protected ArrayList<pzv> b = new ArrayList();
  
  public pzi(AppInterface paramAppInterface)
  {
    ...
    a(3, new pyw[] { new pyw(), new pzj(this) });
    a(2, new pyw[] { new pyw(), new pzn(this) });
    a(4, new pyw[] { new pzo(this), new pzp(this, paramAppInterface) });
    a(5, new pyw[] { new pzq(this), new pzr(this, paramAppInterface) });
    a(6, new pyw[] { new pzs(this), new pzt(this, paramAppInterface) });
    a(7, new pyw[] { new pzu(this), new pzk(this, paramAppInterface) });
    a(8, new pyw[] { new pzl(this), new pzm(this) });
  }
  ...
  private void b(int paramInt, String paramString, boolean paramBoolean)
  {
    ...
    pyx.a(this.jdField_a_of_type_JavaLangString);
    paramInt = 0;
    while (paramInt < this.b.size())
    {
      ((pzv)this.b.get(paramInt)).a(this.jdField_a_of_type_Int, this.jdField_a_of_type_JavaLangString, paramBoolean);
      paramInt += 1;
    }
  }
  ...
  public SkinData a(Context paramContext)
  {
    ...
    paramContext = bbjn.p(paramContext, this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin());
  ...
  {
    if ((!pyx.a(paramString1)) && (!TextUtils.isEmpty(paramString1)))
    {
    ...
    for (;;)
    {
      boolean bool = bbjn.u(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApplication().getBaseContext(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin());
      ...
      paramString3 = (pzc)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(270);
      ...
      if ("".equals(paramString1))
      {
        if (localObject != null)
        {
          ...
          bbjn.f(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApplication().getBaseContext(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), ((RefreshData)localObject).toJson().toString(), 0);
        ...
        bbjn.l(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApplication().getBaseContext(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), paramBoolean);
      ...
      {
        bbjn.r(paramString3, (String)localObject, paramString2);
  ...
  public pyw a(int paramInt)
  {
    pyw[] arrayOfpyw = (pyw[])this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt);
    if ((arrayOfpyw != null) && (this.jdField_a_of_type_Int < arrayOfpyw.length)) {
      return arrayOfpyw[this.jdField_a_of_type_Int];
    }
    return null;
  }
  ...
  public void a(int paramInt, pyw... paramVarArgs)
  {
  ...
  {
    bbjn.g(paramContext, paramString, paramBaseResData.seq);
  }
  ...
  {
    axqw.b(null, "dc00899", "BizTechReport", "", "skin_download", "skin_guide", 0, 0, paramArrayOfString[0], paramArrayOfString[1], paramArrayOfString[2], String.valueOf(bbev.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApplication())));
  }
  ...
  public boolean a(String paramString)
  {
    ...
    if (paramString != null)
    {
      this.jdField_a_of_type_Bbwl.a(false, paramString);
      return true;
    }
    return false;
  }
  ...
  public boolean a(String paramString1, String paramString2, String paramString3, long paramLong1, long paramLong2, long paramLong3, bbwf parambbwf)
  {
  ...
  public String b(String paramString1, String paramString2)
  {
    if ("skin".equals(paramString1)) {
      return pyx.a(paramString2);
    }
    if ("guide".equals(paramString1)) {
      return pyx.b(paramString2);
    }
    return pyx.b(paramString2);
  }
  ...
  {
    bbjn.s(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), paramBaseResData.id);
    bbjn.C(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin());
  }
  
  public void b(pzv parampzv)
  {
    synchronized (this.b)
    {
      this.b.remove(parampzv);
      return;
    }
  }
  ...
  public boolean b(String paramString, BaseResData paramBaseResData)
  {
    ...
    long l1 = bbjn.h(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin()) / 86400000L;
    long l2 = System.currentTimeMillis() / 86400000L;
    return (aybq.a(new File(paramString))) && (pyx.a(paramBaseResData.id)) && (!bbjn.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), paramBaseResData.id)) && (l2 > l1);
  }
