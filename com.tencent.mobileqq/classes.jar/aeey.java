...
public class aeey
  extends MqqHandler
{
  public aeey(ChatSettingActivity paramChatSettingActivity) {}
        ...
        do
        {
          do
          {
            ...
            if ((ChatSettingActivity.a(this.a) != 1001) && (ChatSettingActivity.a(this.a) != 10002)) {
              ...
              {
                paramMessage = (axad)this.a.app.getManager(16);
            ...
            for (;;)
            {
              ...
              return;
              paramMessage = bhlg.e(this.a.app, ChatSettingActivity.c(this.a));
              ...
              bool1 = false;
              break label308;
              paramMessage = (anyw)this.a.app.getManager(51);
              if (paramMessage != null)
              {
