...
public class akgj
  extends QIPCModule
{
  private static volatile akgj jdField_a_of_type_Akgj;
  private static Object jdField_a_of_type_JavaLangObject = new Object();
  
  private akgj(String paramString)
  {
    super(paramString);
  }
  
  public static akgj a()
  {
    if (jdField_a_of_type_Akgj != null) {
      return jdField_a_of_type_Akgj;
    }
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (jdField_a_of_type_Akgj != null)
      {
        akgj localakgj1 = jdField_a_of_type_Akgj;
        return localakgj1;
      }
    }
    jdField_a_of_type_Akgj = new akgj("soso_interface");
    akgj localakgj2 = jdField_a_of_type_Akgj;
    return localakgj2;
  }
