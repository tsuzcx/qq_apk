  ...
  extends Handler
{
  ...
  public bjkd(Looper paramLooper)
  {
    super(paramLooper);
    this.jdField_a_of_type_ComTencentOpenDownloadnewCommonNoticeParam = new NoticeParam();
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    Object localObject2 = ((Bundle)localObject1).getString(bjmy.jdField_a_of_type_JavaLangString);
    bjko.a("NoticeHintHandler", "+++++what:" + paramMessage.what + "+++++" + localObject1);
    localObject2 = bjjq.a().a((String)localObject2);
    if (localObject2 != null)
    {
      if (((DownloadInfo)localObject2).i == TMAssistantDownloadConst.SHOW_NOTIFICATION_TRUE) {
        bjko.c("NoticeHintHandler", "notification isShowNotification=" + ((DownloadInfo)localObject2).i);
      }
    }
    else {
      return;
    ...
    for (;;)
    {
      ...
      {
        bjko.c("NoticeHintHandler", "init Notification>>>", localException);
        continue;
        bjko.b("NoticeHintHandler", ">>downloading:" + this.jdField_a_of_type_ComTencentOpenDownloadnewCommonNoticeParam.jdField_a_of_type_JavaLangString);
        bjko.c("NoticeHintHandler", "size = " + ((DownloadInfo)localObject2).jdField_f_of_type_Int + " content = ");
        ...
        continue;
        bjko.b("NoticeHintHandler", ">>complete:" + this.jdField_a_of_type_ComTencentOpenDownloadnewCommonNoticeParam.jdField_a_of_type_JavaLangString);
      ...
      for (;;)
      {
        ...
        bjom.a().b(this.jdField_a_of_type_ComTencentOpenDownloadnewCommonNoticeParam.jdField_f_of_type_JavaLangString);
        break;
        bjko.b("NoticeHintHandler", ">>download icon fail,so we use default notification icon");
        this.jdField_a_of_type_AndroidAppNotification.contentView.setImageViewResource(2131372108, 2130844336);
      }
      bjko.b("NoticeHintHandler", ">>pause:" + this.jdField_a_of_type_ComTencentOpenDownloadnewCommonNoticeParam.jdField_a_of_type_JavaLangString);
      ...
      bjom.a().b(this.jdField_a_of_type_ComTencentOpenDownloadnewCommonNoticeParam.jdField_f_of_type_JavaLangString);
      continue;
      bjko.b("NoticeHintHandler", ">>error:" + this.jdField_a_of_type_ComTencentOpenDownloadnewCommonNoticeParam.jdField_a_of_type_JavaLangString);
      this.jdField_a_of_type_AndroidAppNotification.contentView.setViewVisibility(2131372107, 0);
      this.jdField_a_of_type_AndroidAppNotification.contentView.setViewVisibility(2131372102, 8);
      this.jdField_a_of_type_AndroidAppNotification.contentView.setViewVisibility(2131372113, 8);
