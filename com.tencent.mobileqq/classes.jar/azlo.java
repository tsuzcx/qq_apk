...
public class azlo
{
  public static long a(String paramString)
  {
    ...
    {
      azjq.b("compress.Utils", "getFileSize()", "path is empty, or file does not exist. path:" + paramString);
      return 0L;
    }
  ...
  public static Bitmap a(Bitmap paramBitmap)
  {
    ...
    azjq.a("compress.Utils", "compositingWhiteBg()", "compositingWhiteBg is success");
    return paramBitmap;
  }
  ...
  public static Bitmap a(Bitmap paramBitmap, boolean paramBoolean, String paramString1, String paramString2, String paramString3, ThumbWidthHeightDP paramThumbWidthHeightDP, azlq paramazlq)
  {
    ...
    {
      azjq.a("compress.Utils", paramString2, paramString3 + " ClipStrategy fail");
      return null;
      int j = paramazlq.c;
      int k = paramazlq.a;
      int i = 0;
      ...
      azjq.a("compress.Utils", paramString2, paramString3 + " ClipStrategy begin, thumbSizeMax：" + j + " thumbSizeMin:" + k + " degree:" + i);
      paramString1 = new azlf(j, k, i);
      paramBitmap = paramString1.a(paramBitmap);
      azjq.a("compress.Utils", paramString2, " needCut:" + paramString1.jdField_b_of_type_Boolean + " needScale:" + paramString1.c);
    }
    azjq.a("compress.Utils", paramString2, paramString3 + " ClipStrategy suc, destWidth：" + paramBitmap.getWidth() + " destHeight:" + paramBitmap.getHeight());
    return paramBitmap;
  }
  
  public static azlq a(ThumbWidthHeightDP paramThumbWidthHeightDP, int paramInt1, int paramInt2)
  {
    boolean bool2 = true;
    if (paramInt1 == 1)
    {
    ...
    for (;;)
    {
      return new azlq(paramInt1, paramInt1, paramInt2, paramInt2);
      if (paramInt1 == 2)
      {
        paramInt2 = aues.b;
        paramInt1 = aues.d;
  ...
  public static String a(String paramString)
  {
    ...
    azjq.a("compress.Utils", "getThumbnailPath()", "realpath is empty, or file does not exist, realpath:" + paramString);
    return "";
  }
  
  public static String a(String paramString, int paramInt)
  {
    if ((!TextUtils.isEmpty(paramString)) && (FileUtils.fileExists(paramString)) && (azlh.a(paramInt)))
    {
      int i = paramString.lastIndexOf("/");
      int j = paramString.lastIndexOf(".");
      Object localObject;
    ...
    azjq.a("compress.Utils", "getSendPhotoPath()", "realpath is empty, or file does not exist, or picQuality Illegal realpath:" + paramString + " picQuality:" + paramInt);
    return "";
  }
  ...
  public static void a(Context paramContext, List<CompressInfo> paramList)
  {
    ...
    {
      j = 1;
      str1 = BaseApplication.getContext().getString(2131691011);
      str2 = BaseApplication.getContext().getString(2131691012);
      str3 = BaseApplication.getContext().getString(2131691007);
      str4 = BaseApplication.getContext().getString(2131691008);
      str5 = BaseApplication.getContext().getString(2131691009);
      str6 = BaseApplication.getContext().getString(2131691010);
      localObject1 = BaseApplication.getContext().getString(2131691014);
      localObject2 = BaseApplication.getContext().getString(2131691015);
    ...
    for (int i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        ...
        QQToast.a(paramContext, paramList, 0).b(paramContext.getResources().getDimensionPixelSize(2131299080));
        return;
        j = 0;
        break;
        break label168;
  ...
  public static boolean a(Bitmap paramBitmap, String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    {
      bool = a(paramBitmap);
      azjq.a("compress.Utils", paramString2, paramString3 + " isDrawGIFSucc：" + bool);
    }
  ...
  private static boolean a(BitmapFactory.Options paramOptions, int paramInt)
  {
    ...
    {
      azjq.b("compress.Utils", "calculateInSampleSizeThumbnail()", "options is null");
      return false;
    }
    ...
    if ((m == 0) || (n == 0))
    {
      azjq.b("compress.Utils", "calculateInSampleSizeThumbnail()", "width == 0 || height ==0");
      return false;
    }
    int j = n;
    int k = m;
    ...
    for (paramInt = paramOptions.inSampleSize;; paramInt = 1)
    {
      ...
      azjq.a("compress.Utils", "calculateInSampleSizeThumbnail()", "options.inSampleSize=" + paramOptions.inSampleSize + " srcWidth:" + m + " srcHeight:" + n);
      return true;
      i *= 2;
      break;
    }
  ...
  public static boolean a(BitmapFactory.Options paramOptions, String paramString, int paramInt1, int paramInt2)
  {
    ...
    {
      azjq.b("compress.Utils", "calculateInSampleSize()", "options == null || TextUtils.isEmpty(filepath)");
      return false;
    }
    ...
    for (paramInt1 = paramOptions.inSampleSize;; paramInt1 = 1)
    {
      ...
      azjq.a("compress.Utils", "calculateInSampleSize()", "options.inSampleSize=" + paramOptions.inSampleSize);
      return true;
      break;
    }
  }
  ...
  private static boolean a(JpegOptions paramJpegOptions, int paramInt)
  {
    ...
    for (paramInt = paramJpegOptions.inSampleSize;; paramInt = 1)
    {
      ...
      azjq.a("compress.Utils", "calculateInSampleSizeThumbnail()", "options.inSampleSize=" + paramJpegOptions.inSampleSize + " srcWidth:" + m + " srcHeight:" + n);
      return true;
      i *= 2;
      break;
    }
  ...
  public static boolean a(String paramString1, String paramString2, boolean paramBoolean, String paramString3, int paramInt, ThumbWidthHeightDP paramThumbWidthHeightDP)
  {
    ...
    {
      azjq.b("compress.Utils", "compressAIOThumbnail", paramString3 + " infilePath is empty, or outfilePath is empty, or file does not exist. infilePath:" + paramString1 + " outfilePath:" + paramString2);
      return false;
    }
    azjq.a("compress.Utils", "compressAIOThumbnail", paramString3);
    BitmapFactory.Options localOptions = new BitmapFactory.Options();
    localOptions.inJustDecodeBounds = true;
    bheg.a(paramString1, localOptions);
    azlq localazlq = a(paramThumbWidthHeightDP, paramInt, Math.max(localOptions.outHeight, localOptions.outWidth));
    if (!a(localOptions, localazlq.c))
    {
      azjq.b("compress.Utils", "compressAIOThumbnail", paramString3 + " calculateInSampleSize fail");
      return false;
    }
    try
    {
      ...
      {
        azjq.b("compress.Utils", "compressAIOThumbnail", paramString3 + " bm == null, maybe is broken");
        return false;
      }
    }
    catch (OutOfMemoryError localOutOfMemoryError)
    {
      localOutOfMemoryError.printStackTrace();
      azjq.b("compress.Utils", "compressAIOThumbnail", paramString3 + " decodeFile OutOfMemoryError");
      localOptions.inSampleSize *= 2;
      try
      {
        Bitmap localBitmap2 = bheg.a(paramString1, localOptions);
        int i = localBitmap2.getWidth();
        int j = localBitmap2.getHeight();
        azjq.a("compress.Utils", "compressAIOThumbnail", paramString3 + " sample after W:" + i + " H:" + j);
        paramString1 = a(localBitmap2, paramBoolean, paramString1, "compressAIOThumbnail", paramString3, paramThumbWidthHeightDP, localazlq);
      ...
      catch (OutOfMemoryError paramString1)
      {
        ...
        azjq.b("compress.Utils", "compressAIOThumbnail", paramString3 + " decodeFile OutOfMemoryError, op.inSampleSize:" + localOptions.inSampleSize);
        return false;
      }
    }
    return false;
  ...
  public static boolean b(String paramString)
  {
    ...
    try
    {
      ...
      azjq.a("compress.Utils", "isMatchQualityAndSizeCondition()", "getJpegQuality = " + f + ",picSize = " + l + "result = " + bool1);
      return bool1;
    }
    catch (RuntimeException paramString)
    {
      azjq.b("compress.Utils", "isMatchQualityAndSizeCondition()", "getJpegQuality RuntimeException error = " + paramString + ",return false!");
      return false;
    }
    catch (OutOfMemoryError paramString)
    {
      azjq.b("compress.Utils", "isMatchQualityAndSizeCondition()", "getJpegQuality OutOfMemoryError error = " + paramString + ",return false!");
    }
    return false;
  }
  ...
  private static boolean b(String paramString1, Bitmap paramBitmap, int paramInt, String paramString2, CompressInfo paramCompressInfo)
  {
    ...
    {
      azjq.b("compress.Utils", "compressQualityWithProgressive()", paramString2 + " TextUtils.isEmpty(destPath) || bm == null || quality > 100 || quality <= 0");
      return false;
    }
    azjq.a("compress.Utils", "compressQualityWithProgressive()", paramString2 + " quality:" + paramInt);
    ...
    try
    {
      ...
      localObject = new JpegCompressor(new azlp((File)localObject, paramCompressInfo));
      ((JpegCompressor)localObject).setParams(paramInt, true, true, false);
      try
      {
        bhfd.a();
        ((JpegCompressor)localObject).compress(paramBitmap);
        bhfd.a("peak_pgjpeg", "pgjpeg " + paramBitmap.getWidth() + "x" + paramBitmap.getHeight() + " compress");
        azjq.a("compress.Utils", "compressQualityWithProgressive()", paramString2 + " quality:" + paramInt);
        return true;
      }
    ...
    {
      azjq.b("compress.Utils", "compressQualityWithProgressive()", paramString2 + " FileOutputStream FileNotFoundException");
      paramString1.printStackTrace();
      return false;
    }
    catch (IOException paramString1)
    {
      azjq.b("compress.Utils", "compressQualityWithProgressive()", paramString2 + " createNewFile IOException");
      paramString1.printStackTrace();
    }
  }
  ...
  public static boolean b(String paramString1, String paramString2, boolean paramBoolean, String paramString3, int paramInt)
  {
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)) || (!FileUtils.fileExistsAndNotEmpty(paramString1)))
    {
      azjq.b("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3 + " infilePath is empty, or outfilePath is empty, or file does not exist. infilePath:" + paramString1 + " outfilePath:" + paramString2);
      return false;
    }
    azjq.a("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3);
    ...
    azlq localazlq = a(null, paramInt, Math.max(localJpegOptions.outHeight, localJpegOptions.outWidth));
    if (!a(localJpegOptions, localazlq.c))
    {
      azjq.b("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3 + " calculateInSampleSize fail");
      return false;
    }
    try
    {
      ...
      if (localBitmap3 == null)
      {
        azjq.b("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3 + " bm == null, maybe is broken");
        return false;
      }
    }
    catch (OutOfMemoryError localOutOfMemoryError)
    {
      localOutOfMemoryError.printStackTrace();
      azjq.b("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3 + " decodeFile OutOfMemoryError");
      ...
      try
      {
        ...
        int i = localBitmap2.getWidth();
        int j = localBitmap2.getHeight();
        azjq.a("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3 + " sample after W:" + i + " H:" + j);
        paramString1 = a(localBitmap2, paramBoolean, paramString1, "compressAIOThumbnailWithTrubo", paramString3, null, localazlq);
        if (paramString1 != null) {
      ...
      {
        paramString1.printStackTrace();
        azjq.b("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3 + " decodeFile OutOfMemoryError, op.inSampleSize:" + localJpegOptions.inSampleSize);
        return false;
      }
    }
    return false;
  ...
  private static boolean c(String paramString1, Bitmap paramBitmap, int paramInt, String paramString2, CompressInfo paramCompressInfo)
  {
    ...
    //   49: invokestatic 44	azjq:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   52: iconst_0
    //   53: istore 5
    //   55: iload 5
    //   57: ireturn
    ...
    //   87: invokestatic 116	azjq:a	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   98: astore 6
    //   100: aload 6
    //   102: invokevirtual 363	java/io/File:exists	()Z
    //   105: ifeq +9 -> 114
    //   108: aload 6
    //   110: invokevirtual 679	java/io/File:delete	()Z
    //   113: pop
    //   114: aload_0
    //   115: invokestatic 740	com/tencent/mobileqq/utils/FileUtils:createFile	(Ljava/lang/String;)Ljava/io/File;
    //   118: pop
    //   119: new 742	java/io/FileOutputStream
    //   122: dup
    //   123: aload 6
    //   125: invokespecial 745	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   128: astore 8
    //   130: new 747	java/io/BufferedOutputStream
    //   133: dup
    //   134: aload 8
    //   136: invokespecial 750	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   139: astore 7
    //   141: aload 7
    //   143: astore 6
    //   145: aload_1
    //   146: getstatic 756	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   149: iload_2
    //   150: aload 7
    //   152: invokevirtual 759	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   155: pop
    //   156: aload 7
    //   158: astore 6
    //   160: aload 7
    //   162: invokevirtual 762	java/io/BufferedOutputStream:flush	()V
    //   165: aload 7
    //   167: astore 6
    //   169: aload 8
    //   171: invokevirtual 766	java/io/FileOutputStream:getFD	()Ljava/io/FileDescriptor;
    //   174: astore_1
    //   175: aload_1
    //   176: ifnull +22 -> 198
    //   179: aload 7
    //   181: astore 6
    //   183: aload_1
    //   184: invokevirtual 771	java/io/FileDescriptor:valid	()Z
    //   187: ifeq +11 -> 198
    //   190: aload 7
    //   192: astore 6
    //   194: aload_1
    //   195: invokevirtual 774	java/io/FileDescriptor:sync	()V
    //   198: aload 7
    //   200: ifnull +8 -> 208
    //   203: aload 7
    //   205: invokevirtual 777	java/io/BufferedOutputStream:close	()V
    //   208: aload_0
    ...
    //   240: invokestatic 44	azjq:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   243: iconst_0
    //   244: ireturn
    //   245: astore_1
    //   246: aload 4
    ...
    //   255: aload 4
    //   257: iconst_1
    //   258: invokevirtual 782	com/tencent/mobileqq/pic/CompressInfo:b	(Z)V
    //   261: aload 7
    //   263: astore 6
    //   265: ldc 20
    //   267: ldc_w 736
    //   270: ldc_w 784
    //   273: invokestatic 44	azjq:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   276: goto -78 -> 198
    //   279: astore_0
    //   280: aload 7
    //   282: astore 6
    ...
    //   309: invokestatic 44	azjq:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   312: aload 7
    //   314: astore 6
    //   316: aload_0
    ...
    //   322: ifnull +8 -> 330
    //   325: aload 7
    //   327: invokevirtual 777	java/io/BufferedOutputStream:close	()V
    //   330: iconst_0
    //   331: ireturn
    //   332: astore_1
    //   333: aload 4
    ...
    //   342: aload 4
    //   344: iconst_1
    //   345: invokevirtual 782	com/tencent/mobileqq/pic/CompressInfo:b	(Z)V
    //   348: aload 7
    //   350: astore 6
    //   352: ldc 20
    //   354: ldc_w 736
    //   357: ldc_w 786
    //   360: invokestatic 44	azjq:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   363: goto -165 -> 198
    //   366: astore_0
    //   367: aload 7
    //   369: astore 6
    ...
    //   396: invokestatic 44	azjq:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   399: aload 7
    //   401: astore 6
    //   403: aload_0
    //   404: invokevirtual 789	java/lang/Exception:printStackTrace	()V
    //   407: aload 7
    //   409: ifnull +8 -> 417
    //   412: aload 7
    //   414: invokevirtual 777	java/io/BufferedOutputStream:close	()V
    //   417: iconst_0
    //   418: ireturn
    //   419: astore_1
    //   420: aload_1
    ...
    //   449: ifnull +8 -> 457
    //   452: aload 6
    //   454: invokevirtual 777	java/io/BufferedOutputStream:close	()V
    //   457: aload_0
    //   458: athrow
    //   459: astore_1
    //   460: aload_1
