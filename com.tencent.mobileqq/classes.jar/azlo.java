...
public class azlo
{
  ...
  private ArrayList<aukm> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private HashMap<String, Long> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private ArrayList<aukm> b = new ArrayList();
  
  public azlo(QQAppInterface paramQQAppInterface, PinnedFooterExpandableListView paramPinnedFooterExpandableListView, azlq paramazlq)
  {
    ...
    this.jdField_a_of_type_Azlk = new azlk(paramQQAppInterface);
  }
  ...
  private void e()
  {
    ...
    if (localazoa != null)
    {
      ArrayList localArrayList1 = this.jdField_a_of_type_Azlq.a();
      if (localArrayList1 != null)
      {
        ...
        localazoa.a(localArrayList2, new azlp(this));
      }
    }
  }
  ...
  public View a(int paramInt1, int paramInt2, View paramView, ViewGroup paramViewGroup, Context paramContext, View.OnClickListener paramOnClickListener, RelationTroopEntity paramRelationTroopEntity)
  {
    ...
    {
      paramContext = baxt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt1, paramRelationTroopEntity.troopInfo.troopuin, 3, baxt.a(4, 3), baxt.a(4, 3));
  ...
  public void a()
  {
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_create", "", "grptab", "friendlist_exp", a(), 0, "", "", "", "");
  }
  ...
  public void a(ArrayList<Groups> paramArrayList, SparseArray<ArrayList<aukm>> paramSparseArray)
  {
    if (QLog.isColorLevel()) {
    ...
    if (!this.b.isEmpty())
    {
      ...
      ((Groups)localObject2).group_name = ajyc.a(2131718689);
    ...
    if (!this.jdField_a_of_type_JavaUtilArrayList.isEmpty())
    {
      ...
      ((Groups)localObject1).group_name = ajyc.a(2131718688);
  ...
  public void b()
  {
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_create", "", "grptab", "friendlist_clk", a(), 0, "", "", "", "");
  }
  
  public void c()
  {
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_create", "", "grptab", "grplist_exp", a(), 0, "", "", "", "");
  }
  
  public void d()
  {
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_create", "", "grptab", "grplist_clk", a(), 0, "", "", "", "");
  }
}
