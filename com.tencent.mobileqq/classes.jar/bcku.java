...
{
  public bcku(ConfigClearableEditText paramConfigClearableEditText, View paramView)
  {
    super(paramView);
  }
  ...
  {
    if (paramInt == 0) {
      paramAccessibilityEvent.setContentDescription(ajya.a(2131702424));
    }
  }
  ...
  public void onPopulateNodeForVirtualView(int paramInt, AccessibilityNodeInfoCompat paramAccessibilityNodeInfoCompat)
  {
    if (paramInt == 0)
    {
      paramAccessibilityNodeInfoCompat.setContentDescription(ajya.a(2131702425));
