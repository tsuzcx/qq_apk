  ...
  extends awxe
{
  ...
  public awyo()
  {
    this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new awyp(this);
  }
  ...
  public static String a(AbsShareMsg paramAbsShareMsg, String paramString)
  {
    ...
    } while ((!(localObject1 instanceof awum)) || (((awum)localObject1).a == null) || (((awum)localObject1).a.isEmpty()));
    Object localObject1 = ((awum)localObject1).a.iterator();
    label191:
    if (((Iterator)localObject1).hasNext())
    {
      localObject2 = (awul)((Iterator)localObject1).next();
      if ((paramString.equals("cover")) && ((localObject2 instanceof awwo)))
      {
    ...
    for (;;)
    {
      if (!TextUtils.isEmpty(paramAbsShareMsg))
      {
        ...
        if ((!paramString.equals("summary")) || (!(localObject2 instanceof awzf))) {
          break label301;
        }
        paramAbsShareMsg = StructMsgForGeneralShare.getSummary((awul)localObject2);
        break label231;
        label295:
        break label191;
      }
  ...
  void a()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg != null) && (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.message != null))
    {
      ...
      {
        localObject = (AbsShareMsg)awuw.a(((MessageRecord)localObject).msgData);
  ...
  {
    Object localObject = new awyr(this);
    Resources localResources = paramContext.getResources();
    View localView;
    int i;
    label122:
    int j;
    if ((paramView != null) && ((paramView instanceof RelativeLayout)) && (paramView.findViewById(2131298156) != null) && ((paramView.getTag() instanceof awyr)))
    {
      localObject = (awyr)paramView.getTag();
      localView = paramView;
      paramView = (View)localObject;
      a();
      boolean bool = paramBundle.getBoolean("isSend", true);
      paramBundle = (BubbleViewLayout)localView.findViewById(2131298156);
      i = 19;
      ...
      paramView.jdField_a_of_type_AndroidWidgetTextView.setPadding(aciy.a(9.0F, localResources), 0, aciy.a(i, localResources), 0);
      paramView.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setPadding(aciy.a(9.0F, localResources), aciy.a(3.0F, localResources), aciy.a(i, localResources), 0);
      paramBundle = (ViewGroup.MarginLayoutParams)paramView.jdField_a_of_type_AndroidWidgetRelativeLayout.getLayoutParams();
      if (j == 0) {
        break label925;
      }
      paramBundle.setMargins(aciy.a(18.0F, localResources), 0, 0, 0);
      ...
      paramBundle.setMargins(aciy.a(18.0F, localResources), 0, 0, 0);
      paramView.jdField_a_of_type_AndroidWidgetLinearLayout.setPadding(aciy.a(19.5F, localResources), 0, aciy.a(10.0F, localResources), 0);
      label339:
      paramBundle = localResources.getDrawable(2130849109);
    ...
    try
    {
      localObject = URLDrawable.getDrawable(new URL(this.T), aciy.a(249.0F, localResources), aciy.a(139.0F, localResources), paramBundle, paramBundle, true);
    ...
    for (;;)
    {
      ...
      i = (int)(BaseChatItemLayout.A * 0.8F) - aciy.a(19.5F, localResources) - aciy.a(10.0F, localResources) - aciy.a(13.0F, localResources);
      paramView.jdField_b_of_type_AndroidWidgetTextView.setMaxWidth(i);
      i /= aciy.a(14.0F, localResources);
      ...
      paramView.jdField_b_of_type_AndroidWidgetTextView.setText(new axkn(paramBundle, 3, 15));
      paramView.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
      paramContext = new awyq(this, paramContext, new String(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.mMsgActionData), this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.mMsgUrl);
      ...
      return localView;
      localView = LayoutInflater.from(paramContext).inflate(2131493876, null);
      ((awyr)localObject).jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localView.findViewById(2131299236));
      ((awyr)localObject).jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131311534));
      ((awyr)localObject).jdField_a_of_type_ComTencentWidgetSingleLineTextView = ((SingleLineTextView)localView.findViewById(2131310903));
      ((awyr)localObject).jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localView.findViewById(2131298156));
      ((awyr)localObject).jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localView.findViewById(2131296672));
      ((awyr)localObject).jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)localView.findViewById(2131298908));
      ((awyr)localObject).jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131296671));
      ((awyr)localObject).c = ((RelativeLayout)localView.findViewById(2131298203));
      ((awyr)localObject).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131298195));
      ...
      break label339;
      paramView.jdField_a_of_type_AndroidWidgetTextView.setPadding(aciy.a(i, localResources), 0, aciy.a(9.0F, localResources), 0);
      paramView.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setPadding(aciy.a(i, localResources), aciy.a(3.0F, localResources), aciy.a(9.0F, localResources), 0);
      paramBundle = (ViewGroup.MarginLayoutParams)paramView.jdField_a_of_type_AndroidWidgetRelativeLayout.getLayoutParams();
      if (j != 0)
      {
        paramBundle.setMargins(0, 0, aciy.a(18.0F, localResources), 0);
        ((RelativeLayout.LayoutParams)paramView.c.getLayoutParams()).addRule(11);
        paramBundle = (RelativeLayout.LayoutParams)paramView.jdField_a_of_type_AndroidWidgetLinearLayout.getLayoutParams();
        paramBundle.addRule(11);
        paramBundle.setMargins(0, 0, aciy.a(18.0F, localResources), 0);
        paramView.jdField_a_of_type_AndroidWidgetLinearLayout.setPadding(aciy.a(10.0F, localResources), 0, aciy.a(19.5F, localResources), 0);
        break label339;
      }
      paramBundle.setMargins(0, 0, 0, 0);
      break label339;
