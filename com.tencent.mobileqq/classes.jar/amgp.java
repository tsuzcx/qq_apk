...
class amgp
  implements abnz
{
  amgp(amgn paramamgn, String paramString, long paramLong1, int paramInt1, long paramLong2, int paramInt2, byte[] paramArrayOfByte) {}
  
  public ToServiceMsg a()
  {
    ToServiceMsg localToServiceMsg = amgn.b(this.jdField_a_of_type_Amgn).createToServiceMsg("MessageSvc.PbSendMsg");
    ...
    localaywb.jdField_a_of_type_Int = this.jdField_b_of_type_Int;
    localaywb.jdField_a_of_type_ArrayOfByte = this.jdField_a_of_type_ArrayOfByte;
    localToServiceMsg.putWupBuffer(ayvu.a(amgn.b(this.jdField_a_of_type_Amgn), 9, this.jdField_a_of_type_JavaLangString, localaywb, this.jdField_b_of_type_Long, this.jdField_a_of_type_Int).toByteArray());
