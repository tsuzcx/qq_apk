  ...
  extends ajwt
{
  ...
  protected List<ajyc> a;
  public Set<Long> a;
  
  public ajwx(Context paramContext, bkfv parambkfv, SessionInfo paramSessionInfo, QQAppInterface paramQQAppInterface)
  {
  ...
  {
    Object localObject = ((ajyc)getItem(paramInt)).a;
    try
    {
      localObject = bend.a(((MessageRecord)localObject).msgData);
      if (localObject != null)
      {
  ...
  public ChatHistorySearchData a(SessionInfo paramSessionInfo, String paramString)
  {
    ...
    while (paramString.hasNext())
    {
      ...
      MessageForText localMessageForText = bbzh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), localC2CLinkElement.uin, "", 0, (byte)1, (byte)0, (short)0, localC2CLinkElement.description());
      localMessageForText.msgData = bend.a(localC2CLinkElement);
  ...
  public void a(List<Object> paramList)
  {
    ...
    while (i < paramList.size())
    {
      ...
      localObject = C2CLinkElement.parseFrom(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localObject, this.jdField_a_of_type_Anmw, this.jdField_a_of_type_JavaTextSimpleDateFormat, i);
      if (localObject != null) {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      localajwu = new ajwu();
      localajwu.jdField_a_of_type_ComTencentMobileqqWidgetColorNickTextView = ((ColorNickTextView)paramView.findViewById(2131378879));
      localajwu.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131365368));
      localajwu.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368138));
      paramView.setTag(localajwu);
    }
    for (;;)
    {
      localObject = localajyc.a;
      try
      {
        localObject = bend.a(((MessageRecord)localObject).msgData);
        if (localObject == null) {
      ...
      if (localObject != null)
      {
        localCharSequence = localajyc.a(((C2CLinkElement)localObject).title, -11353092);
        localajwu.jdField_a_of_type_ComTencentMobileqqWidgetColorNickTextView.setText(localCharSequence);
        localajwu.jdField_a_of_type_AndroidWidgetTextView.setText(localajyc.a(((C2CLinkElement)localObject).timeSecond, -11353092));
        ajun.a(localajwu.jdField_a_of_type_AndroidWidgetImageView, ((C2CLinkElement)localObject).iconUrl);
      }
