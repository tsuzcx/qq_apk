...
public class ajwx
  implements ahmj
{
  public ajwx(FrameHelperActivity paramFrameHelperActivity) {}
  ...
  public void a(int paramInt)
  {
    ...
    ahmj[] arrayOfahmj = this.a.jdField_a_of_type_ArrayOfAhmj;
    int j = arrayOfahmj.length;
    while (i < j)
    {
      ahmj localahmj = arrayOfahmj[i];
      if (localahmj != null) {
        localahmj.a(paramInt);
      }
      i += 1;
    }
    this.a.d(true);
  ...
  public void a(int paramInt, float paramFloat)
  {
    ...
    if ((!this.a.getActivity().isFinishing()) && (FrameHelperActivity.a(this.a) != null) && (bfnf.a()))
    {
      localObject1 = FrameHelperActivity.a(this.a).a(bfnf.a);
      if (localObject1 != null) {
        ((bfwx)localObject1).c();
      }
    }
    if (Build.VERSION.SDK_INT >= 11) {}
    Object localObject1 = this.a.jdField_a_of_type_ArrayOfAhmj;
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    {
      if (Build.VERSION.SDK_INT < 11) {}
      localObject1 = this.a.jdField_a_of_type_ArrayOfAhmj;
      int j = localObject1.length;
      int i = 0;
      while (i < j)
      {
    ...
    if ((localObject1 instanceof ReadinjoyTabFrame)) {
      ((ReadinjoyTabFrame)localObject1).l();
    }
    this.a.m();
  }
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    ...
    while (i < j)
    {
      ahmj localahmj = arrayOfahmj[i];
      if (localahmj != null) {
        localahmj.a(paramInt, paramBoolean);
      }
      i += 1;
    }
    if (paramBoolean) {
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    if (this.a.jdField_a_of_type_AndroidViewViewGroup != null) {
      ((ImageView)this.a.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378658)).setImageResource(0);
    }
    Object localObject1 = this.a.jdField_a_of_type_ArrayOfAhmj;
    int j = localObject1.length;
    int i = 0;
