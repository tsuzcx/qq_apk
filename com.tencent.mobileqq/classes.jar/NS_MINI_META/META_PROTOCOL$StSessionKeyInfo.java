  ...
  extends MessageMicro<StSessionKeyInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 32, 40 }, new String[] { "uin", "openid", "sessionKey", "createTimestamp", "renewTimestamp" }, new Object[] { "", "", "", localInteger, localInteger }, StSessionKeyInfo.class);
  }
}
