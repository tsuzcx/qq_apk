  ...
  extends MessageMicro<StMemberInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 32, 42, 50, 58, 66, 74 }, new String[] { "appid", "createTime", "updateTime", "state", "uin", "nick", "avatar", "remark", "authority" }, new Object[] { "", localInteger, localInteger, localInteger, "", "", "", "", null }, StMemberInfo.class);
  }
}
