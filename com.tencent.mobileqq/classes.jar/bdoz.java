  ...
  implements bich, bicx
{
  ...
  public bdoz(boolean paramBoolean, bdjn parambdjn)
  {
    this.jdField_a_of_type_Int = 1000;
    this.jdField_a_of_type_Boolean = paramBoolean;
    this.jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
    this.jdField_a_of_type_Bdjn = parambdjn;
  }
  ...
  private void a()
  {
    ...
    while (((Iterator)localObject2).hasNext()) {
      ((JSONArray)localObject1).put(bdpe.a((WadlResult)((Iterator)localObject2).next()));
    }
    localObject1 = ((JSONArray)localObject1).toString();
    localObject2 = this.jdField_a_of_type_Bdjn.getJsCallbackMethod();
  ...
  private void a(int paramInt, WadlParams paramWadlParams)
  {
    ...
    while (i != 0)
    {
      a(bdpe.a(paramInt));
      return;
      bicp.a().c(0, paramWadlParams.jdField_a_of_type_JavaLangString);
      i = j;
      continue;
      bicp.a().a(0, paramWadlParams.jdField_a_of_type_JavaLangString);
  ...
  private void b(String paramString)
  {
    ...
    {
      return;
      bdot.b(jdField_a_of_type_JavaLangString, "doJsCallBack loadJs=" + paramString);
      try
      {
        WebView localWebView = this.jdField_a_of_type_Bdjn.getWebview();
      ...
      {
        bdot.a(jdField_a_of_type_JavaLangString, "doJsCallback exception", paramString);
      }
    }
  }
  ...
  public void a(WadlResult paramWadlResult)
  {
    ...
    {
      paramWadlResult = bdpe.a(paramWadlResult).toString();
      str = this.jdField_a_of_type_Bdjn.getJsCallbackMethod();
  ...
  public void a(String paramString)
  {
    ...
    {
      bdot.a(jdField_a_of_type_JavaLangString, "showToast>>>", paramString);
    }
  }
  ...
  {
    bdot.b(jdField_a_of_type_JavaLangString, "onCmdRsp cmd=" + paramString + ",isSucc");
  ...
  {
    bdot.b(jdField_a_of_type_JavaLangString, "onQueryCallback params:" + paramArrayList);
    ...
    if (paramArrayList != null) {
      try
      {
        ...
        {
          localJSONArray.put(bdpe.a((WadlResult)paramArrayList.next()));
          continue;
          return;
        }
      }
      ...
      {
        bdot.a(jdField_a_of_type_JavaLangString, "onQueryCallback exception:" + paramArrayList.getMessage());
      }
    }
  ...
  {
    bdot.b(jdField_a_of_type_JavaLangString, "onQueryCallbackVia params:" + paramArrayList);
    JSONArray localJSONArray;
    if (paramArrayList != null) {
      try
      {
      ...
      {
        bdot.a(jdField_a_of_type_JavaLangString, "onQueryCallbackVia exception:" + paramArrayList.getMessage());
      }
    }
  ...
  public void onWadlTaskStatusChanged(WadlResult paramWadlResult)
  {
    ...
    {
      bdot.a(jdField_a_of_type_JavaLangString, "onWadlTaskStatusChanged error wadlResult is null");
      return;
    }
    WadlParams localWadlParams = paramWadlResult.a;
    String str = localWadlParams.jdField_a_of_type_JavaLangString;
    int i = bdpe.a(paramWadlResult.b);
    bdoy.b(localWadlParams.jdField_a_of_type_JavaLangString);
    bdot.b(jdField_a_of_type_JavaLangString, "onWadlTaskStatusChanged:" + paramWadlResult + ",localStatus:" + i);
    switch (i)
    {
    default: 
      bdot.a(jdField_a_of_type_JavaLangString, "download status not response!");
      return;
    case 3: 
    case 4: 
    case 6: 
    ...
    case 20: 
      ...
      return;
    case -2: 
      i = bdpe.b(paramWadlResult.c);
      bdot.a(jdField_a_of_type_JavaLangString, "onWadlTaskStatusChanged  error,wadlErrCode=" + i);
      c(str);
      a(i, localWadlParams);
      a(paramWadlResult);
      return;
