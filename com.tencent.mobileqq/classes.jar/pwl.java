  ...
  extends pwn
{
  ...
  private List<rex> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  public pwl(AppInterface paramAppInterface, EntityManager paramEntityManager, ExecutorService paramExecutorService, qnd paramqnd, Handler paramHandler)
  {
  ...
  private void a(List<rex> paramList1, List<rex> paramList2)
  {
    ...
    {
      localObject1 = ((rex)paramList2.next()).jdField_a_of_type_JavaUtilList.iterator();
    ...
    {
      localObject1 = (rex)paramList2.next();
      localObject2 = ((rex)localObject1).jdField_a_of_type_JavaUtilList.iterator();
      label272:
      label285:
      label291:
      label296:
      ...
      for (;;)
      {
        ...
        if (((Iterator)localObject2).hasNext())
        {
          ...
          i = 11;
          label214:
          if ((paramList1.indexOf(localObject1) != 0) || (((rex)localObject1).jdField_a_of_type_JavaUtilList.indexOf(localTabChannelCoverInfo1) >= i)) {
            break label291;
          }
          i = 1;
          label243:
  ...
  private boolean a()
  {
    ...
    bmqa.a("UPDATE_CHANNEL_LIST_KEY_0xBBC", Boolean.valueOf(false));
    return false;
  }
  
  public static boolean a(int paramInt)
  {
    if (!((Boolean)bmqa.a("sp_key_channel_list_dynamic_order_switch", Boolean.valueOf(false))).booleanValue())
    {
      QLog.d("ChannelCoverInfoModule", 1, "isSupportChannelDynamicOrder, switch is off.");
      return false;
    }
    Object localObject1 = (QQAppInterface)pha.a();
    if (localObject1 != null)
    {
      localObject1 = (pmm)((QQAppInterface)localObject1).getManager(163);
      if (localObject1 != null)
      {
        localObject1 = ((pmm)localObject1).a().a();
          ...
          do
          {
            ...
            while (!((Iterator)localObject2).hasNext())
            {
              do
              {
                ...
                localObject2 = ((rex)((Iterator)localObject1).next()).jdField_a_of_type_JavaUtilList;
  ...
  private List<TabChannelCoverInfo> b(List<rex> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    if (paramList != null)
    {
      ...
      {
        rex localrex = (rex)paramList.next();
        if ((localrex.jdField_a_of_type_JavaUtilList == null) || (localrex.jdField_a_of_type_JavaUtilList.isEmpty())) {
          break label133;
        }
        Iterator localIterator = localrex.jdField_a_of_type_JavaUtilList.iterator();
        while (localIterator.hasNext())
        {
          TabChannelCoverInfo localTabChannelCoverInfo = (TabChannelCoverInfo)localIterator.next();
          localTabChannelCoverInfo.channelConfigType = localrex.jdField_a_of_type_Long;
          localTabChannelCoverInfo.seq = i;
          localArrayList.add(localTabChannelCoverInfo);
          i += 1;
        }
  ...
  private void b(boolean paramBoolean, List<TabChannelCoverInfo> paramList)
  {
    if (Looper.getMainLooper() == Looper.myLooper()) {
      pmk.a().e(paramBoolean, paramList);
    }
  ...
  private List<rex> c(List<rex> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    if (paramList != null)
    {
      ...
      while (paramList.hasNext())
      {
        Object localObject = (rex)paramList.next();
        rex localrex = new rex(((rex)localObject).jdField_a_of_type_Long, ((rex)localObject).jdField_a_of_type_JavaLangString, ((rex)localObject).b);
        localObject = ((rex)localObject).jdField_a_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject).hasNext())
        {
          ...
          localrex.jdField_a_of_type_JavaUtilList.add(localTabChannelCoverInfo2);
          i += 1;
        }
  ...
  private List<TabChannelCoverInfo> d(List<TabChannelCoverInfo> paramList)
  {
    ...
    for (;;)
    {
      ...
      label275:
      for (paramList = a();; paramList = anni.a(2131700317))
      {
        if (!bool2) {
        ...
        ((List)localObject2).add(0, new TabChannelCoverInfo(70, anni.a(2131700340), 4, "https://p.qpic.cn/kandianac/0/993c416b9d2b9.png/0"));
  ...
  private void f()
  {
    for (;;)
    {
      try
      {
        ...
        {
          str = bita.d(str.toLowerCase()).toLowerCase();
      ...
      catch (Throwable localThrowable)
      {
        ...
        int i;
        int j;
        QLog.e("ChannelCoverInfoModule", 2, "requestWeiShiChannelCoverListFromServer failed for param error:" + pha.a(localThrowable));
        return;
      }
      try
      {
      ...
      a(qnf.a("OidbSvc.0xbe6", 3046, 1, localReqBody.toByteArray()));
      return;
      str = bgln.c(BaseApplication.getContext());
      if (!TextUtils.isEmpty(str))
      {
        str = bita.d(str.replaceAll(":", "").toUpperCase()).toLowerCase();
        localPhoneInfo.bytes_muid.set(ByteStringMicro.copyFromUtf8(str));
  ...
  private void g(List<rex> paramList)
  {
    if (paramList != null) {
      try
      {
        ...
        while (paramList.hasNext())
        {
          ...
          if (localObject != null)
          {
            localObject = ((rex)localObject).jdField_a_of_type_JavaUtilList;
            if (localObject != null)
            {
  ...
  {
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(new TabChannelCoverInfo(51, anni.a(2131700346)));
    localArrayList.add(new TabChannelCoverInfo(58, anni.a(2131700333)));
    localArrayList.add(new TabChannelCoverInfo(59, anni.a(2131700332)));
    localArrayList.add(new TabChannelCoverInfo(10, anni.a(2131700335)));
    localArrayList.add(new TabChannelCoverInfo(52, anni.a(2131700348)));
    localArrayList.add(new TabChannelCoverInfo(53, anni.a(2131700329)));
    localArrayList.add(new TabChannelCoverInfo(9, anni.a(2131700339)));
    localArrayList.add(new TabChannelCoverInfo(54, anni.a(2131700324)));
    localArrayList.add(new TabChannelCoverInfo(55, anni.a(2131700326)));
    localArrayList.add(new TabChannelCoverInfo(40007, anni.a(2131700328)));
    return localArrayList;
  }
  ...
  public List<TabChannelCoverInfo> a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 49	pwl:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   6: ifnull +36 -> 42
    //   9: aload_0
    //   10: getfield 49	pwl:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   13: invokeinterface 403 1 0
    //   18: ifne +24 -> 42
    //   21: aload_0
    //   22: getfield 49	pwl:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   25: iconst_0
    //   26: invokeinterface 250 2 0
    //   31: checkcast 263	rex
    //   34: getfield 264	rex:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   37: astore_1
    //   38: aload_0
    //   39: monitorexit
    //   40: aload_1
  ...
  public List<TabChannelCoverInfo> a(int paramInt)
  {
    ...
    //   19: checkcast 263	rex
    //   22: getfield 264	rex:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   25: astore_2
    //   26: aload_0
    //   27: monitorexit
    //   28: aload_2
  ...
  public void a(TabChannelCoverInfo paramTabChannelCoverInfo)
  {
    ...
    for (Object localObject = paramTabChannelCoverInfo.toString();; localObject = "null")
    {
      ...
      while (((Iterator)localObject).hasNext()) {
        if (a(paramTabChannelCoverInfo, ((rex)((Iterator)localObject).next()).jdField_a_of_type_JavaUtilList)) {
  ...
  public void a(List<channel_button.Section> paramList)
  {
    ...
    try
    {
      ...
      while (paramList.hasNext())
      {
        ...
        rex localrex = new rex(localSection);
        localJSONArray.put(localrex.a());
        localrex.jdField_a_of_type_JavaUtilList = qnc.b(localSection.rpt_msg_channel.get());
        this.jdField_a_of_type_JavaUtilList.add(localrex);
      }
  ...
  public void a(List<rex> paramList, int paramInt)
  {
    ...
    if (QLog.isColorLevel())
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        localObject2 = (rex)((Iterator)localObject1).next();
        a(((rex)localObject2).jdField_a_of_type_JavaUtilList, "0xbbc update sectionId=" + ((rex)localObject2).jdField_a_of_type_Long);
      }
    }
    ...
    {
      rex localrex = (rex)localIterator1.next();
      channel_button.Section localSection = new channel_button.Section();
      ArrayList localArrayList = new ArrayList();
      if (localrex.jdField_a_of_type_JavaUtilList != null)
      {
        Iterator localIterator2 = localrex.jdField_a_of_type_JavaUtilList.iterator();
      ...
      {
        localSection.uint64_section_id.set(localrex.jdField_a_of_type_Long);
        localSection.str_section_name.set(localrex.jdField_a_of_type_JavaLangString);
        localSection.str_note_text.set(localrex.b);
    ...
    {
      localObject2 = bita.d(((String)localObject2).toLowerCase()).toLowerCase();
    ...
    for (;;)
    {
      ...
      a(qnf.a("OidbSvc.0xbbc", 3004, 1, ((oidb_cmd0xbbc.ReqBody)localObject1).toByteArray()));
      bmqa.a("UPDATE_CHANNEL_LIST_KEY_0xBBC", Boolean.valueOf(true));
      return;
      localObject2 = bgln.c(BaseApplication.getContext());
      if (!TextUtils.isEmpty((CharSequence)localObject2))
      {
        localObject2 = bita.d(((String)localObject2).replaceAll(":", "").toUpperCase()).toLowerCase();
        paramList.bytes_muid.set(ByteStringMicro.copyFromUtf8((String)localObject2));
  ...
  public void a(List<rex> paramList1, List<rex> paramList2, boolean paramBoolean)
  {
    if (paramList1 == null) {}
    try
    {
      ...
      ((rex)paramList2.get(0)).jdField_a_of_type_JavaUtilList = d(((rex)paramList2.get(0)).jdField_a_of_type_JavaUtilList);
      this.jdField_a_of_type_JavaUtilList = c(paramList2);
      paramList2 = b(this.jdField_a_of_type_JavaUtilList);
      if (paramBoolean) {
        b(true, ((rex)this.jdField_a_of_type_JavaUtilList.get(0)).jdField_a_of_type_JavaUtilList);
      }
      if (!QLog.isColorLevel()) {
        break label216;
      }
  ...
  {
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(new TabChannelCoverInfo(70, anni.a(2131700331), 4, "https://p.qpic.cn/kandianac/0/993c416b9d2b9.png/0"));
    localArrayList.add(new TabChannelCoverInfo(0, anni.a(2131700330), 4, "https://p.qpic.cn/kandianac/0/9558fc75932c5.png/0"));
    TabChannelCoverInfo localTabChannelCoverInfo = new TabChannelCoverInfo(56, anni.a(2131700341));
    localTabChannelCoverInfo.reason = 4;
    localTabChannelCoverInfo.mChannelType = 3;
    localArrayList.add(localTabChannelCoverInfo);
    localArrayList.add(new TabChannelCoverInfo(40531, anni.a(2131700343)));
    localArrayList.add(new TabChannelCoverInfo(14, anni.a(2131700327)));
    localArrayList.add(new TabChannelCoverInfo(8, anni.a(2131700345)));
    localArrayList.add(new TabChannelCoverInfo(1, anni.a(2131700334)));
    localArrayList.add(new TabChannelCoverInfo(13, anni.a(2131700320)));
    localArrayList.add(new TabChannelCoverInfo(5, anni.a(2131700350)));
    localArrayList.add(new TabChannelCoverInfo(11, anni.a(2131700319)));
    localArrayList.add(new TabChannelCoverInfo(40466, anni.a(2131700344)));
    localArrayList.add(new TabChannelCoverInfo(40013, anni.a(2131700342)));
    localArrayList.add(new TabChannelCoverInfo(16, anni.a(2131700337)));
    localArrayList.add(new TabChannelCoverInfo(15, anni.a(2131700323)));
    return localArrayList;
  }
  ...
  public void b()
  {
    ...
    //   15: ldc_w 308
    //   18: iconst_0
    //   19: invokestatic 313	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   22: invokestatic 324	bmqa:a	(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    //   25: checkcast 310	java/lang/Boolean
    //   28: invokevirtual 327	java/lang/Boolean:booleanValue	()Z
    //   31: ifeq +29 -> 60
    //   34: aload_0
    //   35: invokespecial 956	pwl:a	()Z
    //   38: ifeq +22 -> 60
    //   41: ldc 57
    //   43: iconst_2
    //   44: ldc_w 958
    ...
    //   50: aload_0
    //   51: aload_0
    //   52: getfield 49	pwl:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   55: iconst_3
    //   56: invokevirtual 960	pwl:a	(Ljava/util/List;I)V
    //   59: return
    //   60: getstatic 963	ogh:a	Z
    //   63: ifeq +13 -> 76
    //   66: ldc 57
    //   68: iconst_2
    //   69: ldc_w 965
    ...
    //   75: return
    //   76: invokestatic 970	java/lang/System:currentTimeMillis	()J
    //   79: ldc2_w 971
    //   82: ldiv
    //   83: aload_0
    //   84: getfield 973	pwl:jdField_a_of_type_Long	J
    //   87: lcmp
    //   88: iflt -29 -> 59
    //   91: new 975	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$ReqBody
    //   94: dup
    //   95: invokespecial 976	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$ReqBody:<init>	()V
    //   98: astore_2
    //   99: aload_2
    //   100: getfield 979	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$ReqBody:bytes_city	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   103: invokestatic 982	aoor:a	()Ljava/lang/String;
    //   106: invokestatic 553	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   109: invokevirtual 558	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   112: aload_2
    //   113: getfield 985	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$ReqBody:str_city	Lcom/tencent/mobileqq/pb/PBStringField;
    //   116: invokestatic 987	aoor:b	()Ljava/lang/String;
    //   119: invokevirtual 632	com/tencent/mobileqq/pb/PBStringField:set	(Ljava/lang/String;)V
    //   122: aload_0
    //   123: getfield 620	pwl:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    //   126: bipush 51
    //   128: invokevirtual 990	com/tencent/common/app/AppInterface:getManager	(I)Lmqq/manager/Manager;
    //   131: checkcast 992	anmw
    //   134: aload_0
    //   135: getfield 620	pwl:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    //   138: checkcast 104	com/tencent/mobileqq/app/QQAppInterface
    //   141: invokevirtual 993	com/tencent/mobileqq/app/QQAppInterface:c	()Ljava/lang/String;
    //   144: invokevirtual 996	anmw:c	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/Friends;
    //   147: astore_3
    //   148: aload_3
    //   149: ifnull +25 -> 174
    //   152: aload_2
    //   153: getfield 999	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$ReqBody:uint32_age	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   156: aload_3
    //   157: getfield 1004	com/tencent/mobileqq/data/Friends:age	I
    //   160: invokevirtual 567	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   163: aload_2
    //   164: getfield 1007	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$ReqBody:uint32_sex	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   167: aload_3
    //   168: getfield 1011	com/tencent/mobileqq/data/Friends:gender	B
    //   171: invokevirtual 567	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   174: new 1013	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo
    //   177: dup
    //   178: invokespecial 1014	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:<init>	()V
    //   181: astore_3
    //   182: invokestatic 535	pha:h	()Ljava/lang/String;
    //   185: astore 4
    //   187: aload 4
    //   189: invokestatic 482	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   192: ifne +329 -> 521
    //   195: aload 4
    //   197: invokevirtual 538	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   200: astore 4
    //   202: aload 4
    //   204: invokestatic 543	bita:d	(Ljava/lang/String;)Ljava/lang/String;
    //   207: invokevirtual 538	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   210: astore 4
    //   212: aload_3
    //   213: getfield 1015	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:bytes_muid	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   216: aload 4
    //   218: invokestatic 553	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   221: invokevirtual 558	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   224: aload_3
    //   225: getfield 1016	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:uint32_muid_type	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   228: iconst_1
    //   229: invokevirtual 567	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   232: invokestatic 570	nve:a	()I
    //   235: istore_1
    //   236: aload_3
    //   237: getfield 1017	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:uint32_conn	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   240: iload_1
    //   241: invokevirtual 567	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   244: invokestatic 577	bgln:e	()I
    //   247: istore_1
    //   248: aload_3
    //   249: getfield 1018	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:uint32_carrier	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   252: iload_1
    //   253: invokevirtual 567	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   256: invokestatic 582	bgln:e	()Ljava/lang/String;
    //   259: astore 4
    //   261: aload_3
    //   262: getfield 1019	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:bytes_os_ver	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   265: aload 4
    //   267: invokestatic 553	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   270: invokevirtual 558	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   273: invokestatic 587	bgln:c	()Ljava/lang/String;
    //   276: astore 4
    //   278: aload_3
    //   279: getfield 1020	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:bytes_qq_ver	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   282: aload 4
    //   284: invokestatic 553	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   287: invokevirtual 558	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   290: invokestatic 593	com/tencent/common/config/AppSetting:a	()I
    //   293: istore_1
    //   294: aload_3
    //   295: getfield 1021	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:bytes_appid	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   298: iload_1
    //   299: invokestatic 516	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   302: invokestatic 553	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   305: invokevirtual 558	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   308: invokestatic 601	dw:a	()J
    //   311: invokestatic 604	dw:a	(J)Ljava/lang/String;
    //   314: astore 4
    //   316: aload_3
    //   317: getfield 1022	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:bytes_client_ip	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   320: aload 4
    //   322: invokestatic 553	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   325: invokevirtual 558	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   328: aload_3
    //   329: getfield 1023	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:uint32_os_type	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   332: iconst_2
    //   333: invokevirtual 567	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   336: aload_2
    //   337: getfield 1026	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$ReqBody:msg_phone_type	Ltencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo;
    //   340: aload_3
    //   341: iconst_1
    //   342: invokevirtual 1027	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:set	(Lcom/tencent/mobileqq/pb/MessageMicro;Z)V
    //   345: invokestatic 1028	pmh:a	()Lpmh;
    //   348: invokevirtual 1031	pmh:a	()Lcom/tencent/biz/pubaccount/readinjoy/model/SelectPositionModule;
    //   351: astore_3
    //   352: aload_3
    //   353: ifnull +132 -> 485
    //   356: aload_3
    //   357: invokevirtual 1036	com/tencent/biz/pubaccount/readinjoy/model/SelectPositionModule:a	()Lcom/tencent/biz/pubaccount/readinjoy/model/SelectPositionModule$PositionData;
    //   360: astore_3
    //   361: invokestatic 55	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   364: ifeq +29 -> 393
    //   367: ldc 57
    //   369: iconst_2
    //   370: new 110	java/lang/StringBuilder
    //   373: dup
    //   374: invokespecial 111	java/lang/StringBuilder:<init>	()V
    //   377: ldc_w 1038
    //   380: invokevirtual 117	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   383: aload_3
    //   384: invokevirtual 1041	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   387: invokevirtual 124	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   390: invokestatic 418	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   393: aload_3
    //   394: ifnull +91 -> 485
    //   397: aload_3
    //   398: getfield 1046	com/tencent/biz/pubaccount/readinjoy/model/SelectPositionModule$PositionData:city	Ljava/lang/String;
    //   401: invokestatic 482	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   404: ifne +81 -> 485
    //   407: new 1048	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$LocationInfo
    //   410: dup
    //   411: invokespecial 1049	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$LocationInfo:<init>	()V
    //   414: astore 4
    //   416: aload 4
    //   418: getfield 1050	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$LocationInfo:bytes_city	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   421: aload_3
    //   422: getfield 1046	com/tencent/biz/pubaccount/readinjoy/model/SelectPositionModule$PositionData:city	Ljava/lang/String;
    //   425: invokestatic 553	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   428: invokevirtual 558	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   431: aload 4
    //   433: getfield 1053	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$LocationInfo:bytes_province	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   436: aload_3
    //   437: getfield 1056	com/tencent/biz/pubaccount/readinjoy/model/SelectPositionModule$PositionData:province	Ljava/lang/String;
    //   440: invokestatic 553	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   443: invokevirtual 558	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   446: aload 4
    //   448: getfield 1059	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$LocationInfo:bytes_country	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   451: aload_3
    //   452: getfield 1062	com/tencent/biz/pubaccount/readinjoy/model/SelectPositionModule$PositionData:country	Ljava/lang/String;
    //   455: invokestatic 553	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   458: invokevirtual 558	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   461: aload 4
    //   463: getfield 1065	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$LocationInfo:bytes_city_code	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   466: aload_3
    //   467: getfield 1068	com/tencent/biz/pubaccount/readinjoy/model/SelectPositionModule$PositionData:cityCode	Ljava/lang/String;
    //   470: invokestatic 553	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   473: invokevirtual 558	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   476: aload_2
    //   477: getfield 1072	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$ReqBody:msg_location_info	Ltencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$LocationInfo;
    //   480: aload 4
    //   482: invokevirtual 1075	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$LocationInfo:set	(Lcom/tencent/mobileqq/pb/MessageMicro;)V
    //   485: aload_0
    //   486: ldc_w 1077
    //   489: sipush 3003
    //   492: iconst_1
    //   493: aload_2
    //   494: invokevirtual 1078	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$ReqBody:toByteArray	()[B
    //   497: invokestatic 643	qnf:a	(Ljava/lang/String;II[B)Lcom/tencent/qphone/base/remote/ToServiceMsg;
    //   500: invokevirtual 646	pwl:a	(Lcom/tencent/qphone/base/remote/ToServiceMsg;)V
    //   503: return
    //   504: astore 4
    //   506: aload_3
    //   507: getfield 1015	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:bytes_muid	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   510: ldc 179
    //   512: invokestatic 553	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   515: invokevirtual 558	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   518: goto -294 -> 224
    //   521: invokestatic 652	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   524: invokestatic 655	bgln:c	(Landroid/content/Context;)Ljava/lang/String;
    //   527: astore 4
    //   529: aload 4
    //   531: invokestatic 482	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   534: ifne -302 -> 232
    //   537: aload 4
    //   539: ldc_w 657
    //   542: ldc 179
    //   544: invokevirtual 660	java/lang/String:replaceAll	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   547: invokevirtual 663	java/lang/String:toUpperCase	()Ljava/lang/String;
    //   550: invokestatic 543	bita:d	(Ljava/lang/String;)Ljava/lang/String;
    //   553: invokevirtual 538	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   556: astore 4
    //   558: aload_3
    //   559: getfield 1015	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:bytes_muid	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   562: aload 4
    //   564: invokestatic 553	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   567: invokevirtual 558	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   570: aload_3
    //   571: getfield 1016	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:uint32_muid_type	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   574: iconst_3
    //   575: invokevirtual 567	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   578: goto -346 -> 232
    //   581: astore 4
    //   583: iconst_0
    //   584: istore_1
    ...
    //   244	248	581	java/lang/Exception
  }
  ...
  public void b(int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      ...
      localObject = qnf.a("OidbSvc.0x69f", 1695, 0, ((oidb_cmd0x69f.ReqBody)localObject).toByteArray());
      if (paramInt != 0) {
        break label247;
      }
  ...
  public void b(List<oidb_cmd0x69f.ChannelInfo> paramList, int paramInt)
  {
    ...
    for (StringBuilder localStringBuilder = new StringBuilder("saveChannelCoverList channelID=" + paramInt + "\n");; localStringBuilder = null)
    {
      ...
      while (paramList.hasNext())
      {
        ChannelCoverInfo localChannelCoverInfo1 = qnc.a((oidb_cmd0x69f.ChannelInfo)paramList.next(), paramInt);
  ...
  public List<rex> c()
  {
    ...
    {
      ArrayList localArrayList = new ArrayList();
      Object localObject2 = bgmg.a(new File(BaseApplicationImpl.getApplication().getDir("readinjoy", 0).getAbsolutePath() + "/channel_section_data"));
        ...
        try
        {
          ...
          while (i < ((JSONArray)localObject2).length())
          {
            ...
            if (localJSONObject != null) {
              localArrayList.add(new rex(localJSONObject));
            }
            i += 1;
          }
        }
  ...
  public void c()
  {
    try
    {
      if (this.jdField_a_of_type_JavaUtilList == null)
      {
        ...
        this.jdField_a_of_type_JavaUtilList.add(new rex(TabChannelCoverInfo.TYPE_CHANNEL_MY_CONFIG, anni.a(2131700318), anni.a(2131700322)));
        this.jdField_a_of_type_JavaUtilList.add(new rex(TabChannelCoverInfo.TYPE_CHANNEL_RECOMMEND_CONFIG, anni.a(2131700325), anni.a(2131700336)));
      }
  ...
  {
    int i = qnf.a(paramFromServiceMsg, paramObject, new oidb_cmd0xbbc.RspBody());
  ...
  public void c(List<oidb_cmd0xbe6.MsgChannelInfo> paramList, int paramInt)
  {
    ...
    for (StringBuilder localStringBuilder = new StringBuilder("saveChannelCoverList channelID=" + paramInt + "\n");; localStringBuilder = null)
    {
      ...
      while (paramList.hasNext())
      {
        ChannelCoverInfo localChannelCoverInfo = qnc.a((oidb_cmd0xbe6.MsgChannelInfo)paramList.next(), paramInt);
