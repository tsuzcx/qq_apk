...
public class mzs
  implements mzp
{
  private static HashMap<String, mzn> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private ITMAssistantDownloadClientListener jdField_a_of_type_ComTencentTmdownloaderITMAssistantDownloadClientListener = new mzt(this);
  ...
  public void a(Context paramContext, String paramString1, String paramString2, String paramString3, myy parammyy, Map<String, String> paramMap)
  {
    if (parammyy == null) {
      return;
    }
    if (paramContext == null)
    {
      parammyy.loaded(paramString1, 11);
      return;
    }
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString3)))
    {
      parammyy.loaded(paramString1, 12);
      return;
    }
    if (AppNetConnInfo.getRecentNetworkInfo() == null)
    {
      parammyy.loaded(paramString1, 10);
      return;
    }
    Object localObject = new File(paramString3.substring(0, paramString3.lastIndexOf("/")));
    if ((!((File)localObject).exists()) && (!((File)localObject).mkdirs()))
    {
      parammyy.loaded(paramString1, 13);
      return;
    }
    localObject = Md5Utils.getMD5(paramString1);
    paramString2 = new mzn((String)localObject, paramString3, paramString2, parammyy);
      ...
      try
      {
        ...
        if (i == 0)
        {
          ...
          try
          {
            ...
            bdhj.a(paramContext, paramString3);
            return;
          }
  ...
  public void a(Context paramContext, String paramString1, String paramString2, myy parammyy)
  {
    a(paramContext, paramString1, "0", paramString2, parammyy, null);
  }
  
  public void a(TMAssistantDownloadClient paramTMAssistantDownloadClient, mzn parammzn, String paramString)
  {
    ...
    try
    {
      ...
      for (paramTMAssistantDownloadClient = localObject;; paramTMAssistantDownloadClient = paramTMAssistantDownloadClient.mSavePath)
      {
        ...
        a(parammzn.jdField_a_of_type_Myy, paramString, parammzn.c, 14, "get current download path fail after download");
        return;
      }
    ...
    {
      a(parammzn.jdField_a_of_type_Myy, paramString, parammzn.c, 15, "cannot get current file after download");
      return;
    }
    if (!bbdx.d(localTMAssistantDownloadClient, parammzn.b))
    {
      a(parammzn.jdField_a_of_type_Myy, paramString, parammzn.c, 16, "rename file fail after download");
      paramTMAssistantDownloadClient.delete();
      return;
    }
    a(parammzn.jdField_a_of_type_Myy, paramString, parammzn.c, 0, "offline zip download success");
  }
  ...
  public void a(myy parammyy, String paramString1, String paramString2, int paramInt, String paramString3)
  {
    if (QLog.isColorLevel()) {
      QLog.d("OfflineDownload", 2, paramString3 + ", bid: " + paramString2 + ", errCode: " + paramInt);
    }
    if ((parammyy != null) && (paramInt >= 0)) {
      parammyy.loaded(paramString1, paramInt);
    }
