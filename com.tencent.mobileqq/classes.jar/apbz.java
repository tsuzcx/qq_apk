  ...
  extends apbm
{
  ...
  protected void a(int paramInt, String paramString)
  {
    ...
    apbi.a(this.jdField_a_of_type_Apbi, 11, 12, true);
    a("StateExcepInvalidWhenChangeToOff");
    this.jdField_a_of_type_Apbm = new apbv(this.jdField_a_of_type_Apbi);
  }
  ...
  protected boolean a(int paramInt, String paramString, long paramLong)
  {
    ...
    apbi.a(this.jdField_a_of_type_Apbi, 11, 13, true);
