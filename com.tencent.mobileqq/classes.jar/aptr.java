  ...
  extends apto
{
  ...
  public aptr(Context paramContext, int paramInt, SensorManager paramSensorManager, aptg paramaptg)
  {
    ...
    if (paramInt == 5)
    {
      ...
      paramaptg.onSensorSupport(4, true);
    ...
    for (;;)
    {
      ...
      paramaptg.onSensorSupport(1, true);
      this.jdField_a_of_type_JavaUtilList.add(localSensor);
      return;
      paramInt = 11;
      break;
      label150:
      paramaptg.onSensorSupport(4, false);
    ...
    label298:
    paramaptg.onSensorSupport(1, false);
  }
  ...
  private void a(float paramFloat1, float paramFloat2, float paramFloat3, long paramLong)
  {
    ...
    this.jdField_a_of_type_Aptg.updateAccelerometer(paramFloat1, paramFloat2, paramFloat3, paramLong);
  }
  ...
  public void onSensorChanged(SensorEvent paramSensorEvent)
  {
    ...
    while (paramSensorEvent.sensor.getType() != 1) {
      try
      {
        ...
        this.jdField_a_of_type_Aptg.onRotationUpdateQuaternion(this.d);
        return;
      }
