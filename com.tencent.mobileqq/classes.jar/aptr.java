  ...
  implements aptt
{
  ...
  private boolean a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    try
    {
      Object localObject2 = aptq.a(new JSONObject(paramString2));
  ...
  public boolean a(String paramString1, String paramString2, JSONObject paramJSONObject, long paramLong, String paramString3)
  {
    ...
    ((ArkAppCenter)paramString3.getManager(QQManagerFactory.ARK_APP_CENTER_MANAGER)).a(paramString1, this, new apts(this, paramString2, paramJSONObject));
    return true;
  }
}
