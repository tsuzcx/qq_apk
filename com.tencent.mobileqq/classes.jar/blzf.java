...
public class blzf
{
  private static blzf jdField_a_of_type_Blzf;
  private WeakReference<DoodleLayout> jdField_a_of_type_JavaLangRefWeakReference;
  private WeakReference<DoodleLayout> b;
  
  public static blzf a()
  {
    if (jdField_a_of_type_Blzf == null) {
      jdField_a_of_type_Blzf = new blzf();
    }
    return jdField_a_of_type_Blzf;
  }
