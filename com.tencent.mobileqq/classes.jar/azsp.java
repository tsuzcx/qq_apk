...
public class azsp
{
  ...
  public static azsq a(String paramString)
  {
    int i = 1;
    azsq localazsq = new azsq();
    if (TextUtils.isEmpty(paramString)) {
      return localazsq;
    }
    for (;;)
      ...
      try
      {
        ...
        if (j == -1)
        {
          ...
          if (-1 == m)
          {
            ...
            localazsq.jdField_a_of_type_JavaLangString = paramString;
            localazsq.jdField_a_of_type_Int = Integer.valueOf(str1).intValue();
            if (i == 0) {
              break;
            }
            localazsq.b = 1;
          ...
          str1 = str1 + ":" + str2;
          continue;
          localazsq.jdField_a_of_type_JavaLangString = str2;
          localazsq.jdField_a_of_type_Int = 0;
          continue;
        }
        j += 3;
      }
  ...
  public static bajk a(long paramLong)
  {
    QQAppInterface localQQAppInterface = a();
    if (localQQAppInterface == null) {
      return null;
    }
    return bajk.a(localQQAppInterface, paramLong);
  }
