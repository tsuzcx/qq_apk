...
public class aqpg
{
  void a(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    default: 
      ...
      return;
    case 5004: 
      a(paramBoolean, (aqpd)localObject[0], (alsj)localObject[1], (List)localObject[2]);
      return;
    case 5005: 
      a(paramBoolean, (aqpd)localObject[0], (alsj)localObject[1]);
      return;
    case 5006: 
      ...
      return;
    case 5007: 
      b(paramBoolean, (aqpd)localObject[0], (alsj)localObject[1]);
      return;
    case 5013: 
    ...
    b(paramBoolean, (aqpd)localObject[0], (alsj)localObject[1], (List)localObject[2]);
  }
