  ...
  implements ServiceConnection
{
  ...
  {
    bkxg.a(this.a).removeMessages(1);
    this.a.jdField_a_of_type_Boolean = false;
    this.a.jdField_a_of_type_Bkxd = bkxe.a(paramIBinder);
    this.a.b();
    QLog.d("SmartDeviceIPCHost", 1, "plugin service connected");
    if (this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
      abdm.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Net_Start_Service_Host", 0, 1, 0);
    }
  }
