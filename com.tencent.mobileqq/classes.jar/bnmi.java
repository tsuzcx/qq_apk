...
public class bnmi
{
  ...
  public Frame a(Frame paramFrame, int paramInt1, int paramInt2, List<List<PointF>> paramList, List<float[]> paramList1)
  {
    ...
    for (;;)
    {
      if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Bnmj != null))
      {
        GLES20.glEnable(3042);
        GLES20.glBlendFunc(770, 771);
        float f1 = -1.0F + this.jdField_a_of_type_Bnmj.jdField_a_of_type_Float * 2.0F;
        float f2 = -1.0F + this.jdField_a_of_type_Bnmj.b * 2.0F;
        float f3 = this.jdField_a_of_type_Bnmj.c * 2.0F + f1;
        float f4 = this.jdField_a_of_type_Bnmj.d * 2.0F + f2;
        this.jdField_a_of_type_ComTencentFilterBaseFilter.setPositions(new float[] { f1, f2, f1, f4, f3, f4, f3, f2 });
        this.jdField_a_of_type_ComTencentFilterBaseFilter.RenderProcess(this.jdField_a_of_type_Bnmj.jdField_a_of_type_Int, paramFrame.width, paramFrame.height, -1, 0.0D, paramFrame);
  ...
  {
    this.jdField_a_of_type_Bnmj = new bnmj(this);
    bnmp localbnmp = new bnmp((int)(320.0F * paramFloat3), (int)(320.0F * paramFloat4));
    localbnmp.a(paramString1);
    localbnmp.a(paramInt1);
    localbnmp.b(paramString2);
    localbnmp.c(paramString3);
    localbnmp.a(paramInt2);
    localbnmp.d(paramString4);
    localbnmp.a();
    paramString1 = localbnmp.a();
    this.jdField_a_of_type_Bnmj.jdField_a_of_type_Int = RendererUtils.createTexture(paramString1);
    localbnmp.b();
    this.jdField_a_of_type_Bnmj.jdField_a_of_type_Float = paramFloat1;
    this.jdField_a_of_type_Bnmj.b = paramFloat2;
    this.jdField_a_of_type_Bnmj.c = paramFloat3;
    this.jdField_a_of_type_Bnmj.d = paramFloat4;
  }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Bnmj != null)
    {
      ...
      arrayOfInt[0] = this.jdField_a_of_type_Bnmj.jdField_a_of_type_Int;
