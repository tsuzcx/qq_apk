  ...
  extends svb
{
  ...
  public svh(@NonNull String[] paramArrayOfString)
  {
  ...
  protected void a(String[] paramArrayOfString, svc paramsvc)
  {
    ...
    for (;;)
    {
      ...
      while (j < k)
      {
        localArrayList.add(new svi(this, arrayOfFile[j]));
        j += 1;
      }
      ...
      while (j < n)
      {
        ...
        catch (InterruptedException localInterruptedException)
        {
          ...
          a(((svi)localArrayList.get(j)).a);
          k += 1;
          j += 1;
        }
      }
      paramsvc.jdField_a_of_type_Double = (d - a(localFile) + paramsvc.jdField_a_of_type_Double);
      paramsvc.jdField_a_of_type_Int += k;
    }
  }
