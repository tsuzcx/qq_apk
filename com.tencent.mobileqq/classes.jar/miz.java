  ...
  implements View.OnTouchListener
{
  ...
  public miz(Context paramContext, ImageView paramImageView1, ImageView paramImageView2, ShimmerTextView paramShimmerTextView, ImageView paramImageView3)
  {
    ...
    this.jdField_c_of_type_Int = paramContext.getResources().getDimensionPixelSize(2131297737);
  ...
  {
    this.jdField_a_of_type_Mix = parammix;
  }
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      do
      {
        ...
        } while (this.jdField_a_of_type_Mix == null);
        this.jdField_a_of_type_Mix.a(true);
        return true;
    ...
    this.jdField_a_of_type_Mix.a(false);
    return true;
  }
}
