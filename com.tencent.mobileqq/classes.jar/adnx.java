  ...
  extends addc
{
  ...
  adnx(QQAppInterface paramQQAppInterface, String paramString)
  {
  ...
  public void a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    do
    {
      ...
      this.jdField_c_of_type_Int = 0;
      paramString = this.jdField_a_of_type_Adid;
  ...
  public boolean b(String paramString)
  {
    ...
    WeakReference localWeakReference = new WeakReference(this);
    if (!((alez)localObject).a(str, paramString, this.jdField_a_of_type_Int, i, new adny(this, localWeakReference)))
    {
