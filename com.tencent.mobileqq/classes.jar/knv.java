...
{
  public knv(LebaSearchMoreInfoActivity paramLebaSearchMoreInfoActivity) {}
  ...
  public void onUpdate(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    case 17: 
      ...
      if (paramBoolean)
      {
        paramObject = this.a.getString(2131430519);
    ...
    for (paramInt = -1;; paramInt = 0)
    {
      ...
      if (this.a.c != null) {
        this.a.b = this.a.getString(2131430513, new Object[] { this.a.c });
      }
      LebaSearchMoreInfoActivity.a(this.a);
      return;
      paramObject = this.a.getString(2131430520);
      break;
      paramInt = 1;
      break label104;
    }
