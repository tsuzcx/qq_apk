  ...
  implements View.OnClickListener, FaceDecoder.DecodeTaskCompletionListener
{
  ...
  private akez jdField_a_of_type_Akez = new akez();
  akfe jdField_a_of_type_Akfe;
  protected algy a;
  ...
  public akex(QQAppInterface paramQQAppInterface, Context paramContext, XListView paramXListView, akfe paramakfe)
  {
    ...
    this.jdField_a_of_type_Akfe = paramakfe;
  }
  
  protected View a()
  {
    return View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131559467, null);
  }
    ...
    do
    {
      ...
      do
      {
        ...
        if (paramDrawable == null)
        {
          localDrawable = paramDrawable;
          if (this.jdField_a_of_type_Algy != null) {
            localDrawable = this.jdField_a_of_type_Algy.a(paramRecentBaseData.getRecentUserType(), paramRecentBaseData.getRecentUserUin());
          }
        }
      } while (this.jdField_a_of_type_Akez == null);
      try
      {
        this.jdField_a_of_type_Akez.a(paramView, paramRecentBaseData, this.jdField_a_of_type_AndroidContentContext, localDrawable);
        return;
      }
      catch (Throwable paramView) {}
    } while (!alht.b(this.jdField_a_of_type_AndroidContentContext));
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      catch (Throwable localThrowable)
      {
        ...
        alht.a(this.jdField_a_of_type_AndroidContentContext, false, localThrowable);
        if (!alht.b(this.jdField_a_of_type_AndroidContentContext)) {
          continue;
        }
      ...
      return paramView;
      localObject2 = paramView;
      localObject1 = this.jdField_a_of_type_Akez.a(paramInt, localObject1, this.jdField_a_of_type_Algy, paramView, paramViewGroup, this.jdField_a_of_type_AndroidContentContext, this, null, null);
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if ((localObject instanceof RecentBaseData))
      {
        ...
        {
          this.jdField_a_of_type_Akfe.a((RecentBaseData)localObject);
  ...
  public void onDecodeTaskCompleted(int paramInt1, int paramInt2, String paramString, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      if (paramInt1 < paramInt2)
      {
        ...
        i = ((Integer)algy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, i, paramString).first).intValue();
        if (i == -2147483648) {
          break label667;
        }
        ...
        {
          l = System.currentTimeMillis();
          paramBitmap = BaseApplication.getContext().getResources().getDrawable(2130840429);
