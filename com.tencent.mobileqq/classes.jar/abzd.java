  ...
  extends BroadcastReceiver
{
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            do
            {
              do
              {
                  ...
                  for (;;)
                  {
                    ...
                    if (paramIntent.getAction().equalsIgnoreCase("tencent.av.v2q.StartVideoChat"))
                    {
                      ...
                      for (l1 = Long.parseLong(paramIntent.getStringExtra("peerUin"));; l1 = 0L)
                      {
                        ...
                        abzb.a(this.a).add(paramContext);
                        return;
                      }
                    }
                    int i;
                    if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_DeviceAdminUnbind"))
                    {
                      ...
                      if (abzb.a(this.a).contains(paramContext) != true)
                      {
                        this.a.app.a().a(paramContext.toString(), 9501);
                        return;
                      }
                      if (paramContext.longValue() != 0L) {
                        abzb.b(this.a).add(paramContext);
                      }
                    }
                    else if (paramIntent.getAction().equalsIgnoreCase("tencent.av.v2q.StopVideoChat"))
                    {
                      ...
                      for (l1 = Long.parseLong(paramIntent.getStringExtra("peerUin"));; l1 = 0L)
                      {
                        ...
                        if ((i != 0) || (paramContext != null) || (paramIntent.longValue() == 0L) || (!abzb.b(this.a).contains(paramIntent))) {
                          break;
                        }
                        this.a.app.a().a(paramIntent.toString(), 9501);
                        abzb.b(this.a).remove(paramIntent);
                        return;
                      }
                      if (paramIntent.longValue() != 0L) {
                        abzb.a(this.a).remove(paramIntent);
                      }
                    }
                    else if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_receiveDPMsg"))
                    {
                      ...
                      if (localObject1 == null)
                      {
                        ...
                        QLog.d(abzb.jdField_a_of_type_JavaLangString, 2, "dp is null in DeviceMsgHandler::onreceive");
                        return;
                      }
                      paramIntent = ((abur)this.a.app.a(51)).a(((DataPoint)localObject1).mDin);
                      i = 0;
                      if (paramIntent != null) {
                      ...
                      if ((11015 == ((DataPoint)localObject1).mProperityId) || (((DataPoint)localObject1).mProperityId == 11008) || (((DataPoint)localObject1).mProperityId == 11012)) {
                        if (QLog.isColorLevel()) {
                          QLog.d(abzb.jdField_a_of_type_JavaLangString, 2, "device info pid is 0; dp.mDin = " + ((DataPoint)localObject1).mDin);
                        }
                      }
                      for (;;)
                      {
                        ...
                        {
                          this.a.jdField_a_of_type_Abyv.a((DataPoint)localObject1);
                          if (abzb.a(this.a, ((DataPoint)localObject1).mValue)) {
                            break;
                          }
                          abzb.a(this.a);
                          return;
                        ...
                        for (;;)
                        {
                          try
                          {
                            ...
                            if (paramContext.optInt("flag") == 0)
                            {
                              ...
                              QLog.d(abzb.jdField_a_of_type_JavaLangString, 2, "PID_MSG_PROXY JSON :" + ((DataPoint)localObject1).mValue);
                              return;
                            }
                          }
                      ...
                      {
                        this.a.jdField_a_of_type_Abvz.a((DataPoint)localObject1);
                        achd.a(this.a.app, ((DataPoint)localObject1).mDin, "Usr_AIO_ReceiveMsg", 2, 0, i);
                        if (abzb.a(this.a, ((DataPoint)localObject1).mValue)) {
                          continue;
                        }
                        abzb.a(this.a);
                      ...
                      if (10007 == ((DataPoint)localObject1).mProperityId)
                      {
                        for (;;)
                        {
                          ...
                          catch (Exception paramIntent)
                          {
                            try
                            {
                              ...
                              QLog.d(abzb.jdField_a_of_type_JavaLangString, 2, "onRecvRawTextMsg parse from json error:" + paramContext.getMessage());
                              return;
                            }
                            catch (Exception paramIntent)
                            {
                        ...
                        achd.a(this.a.app, ((DataPoint)localObject1).mDin, "Usr_AIO_ReceiveMsg", 1, 0, i);
                        if (abzb.a(this.a, ((DataPoint)localObject1).mValue)) {
                          continue;
                        }
                        abzb.a(this.a);
                      ...
                      {
                        this.a.jdField_a_of_type_Abza.a((DataPoint)localObject1);
                        if (abzb.a(this.a, ((DataPoint)localObject1).mValue)) {
                          continue;
                        }
                        abzb.a(this.a);
                      ...
                      if (10009 == ((DataPoint)localObject1).mProperityId)
                      {
                        try
                        {
                          ...
                          localObject4 = (MessageForDevLittleVideo)bcry.a(-4509);
                          ...
                          ((MessageForDevLittleVideo)localObject4).msg = (bhlg.b(this.a.app, ((MessageForDevLittleVideo)localObject4).senderuin, true) + anzj.a(2131702075));
                        ...
                        QLog.d(abzb.jdField_a_of_type_JavaLangString, 2, "getString from json error:" + paramContext.getMessage());
                        return;
                      }
                      if (((DataPoint)localObject1).mProperityId == 10008)
                      {
                        try
                        {
                          ...
                          abzb.a(this.a, l2, paramContext, paramIntent, l1, true);
                          if (abzb.a(this.a, ((DataPoint)localObject1).mValue)) {
                            continue;
                          }
                          abzb.a(this.a);
                    ...
                    try
                    {
                      if (!DeviceTipActivity.a)
                      {
                        ...
                        if (QLog.isColorLevel())
                        {
                          QLog.d(abzb.jdField_a_of_type_JavaLangString, 2, "ReceiveDoorTip appear_time= " + l2 + " : serverTime = " + bcrg.a() + " loginTimeStr= " + (String)localObject2);
                          i = (int)(bcrg.a() - l2);
                          QQToast.a(this.a.app.getApp(), anzj.a(2131702072) + i + anzj.a(2131702074), 1).a();
                        }
                        if (l1 - l2 > 1L)
                        {
                          if (QLog.isColorLevel()) {
                            QQToast.a(this.a.app.getApp(), "该消息是手Q登录前" + (l1 - l2) + anzj.a(2131702083), 1).a();
                          }
                          this.a.a(paramContext, anzj.a(2131702077), l2, "");
                          return;
                        }
                        if (bcrg.a() - l2 <= 30L)
                        {
                    ...
                    if (((DataPoint)localObject1).mProperityId == 10004)
                    {
                      try
                      {
                        ...
                        l1 = paramIntent.optLong("msg_time", bcrg.a());
                        abzb.a(this.a, paramContext, Long.toString(((DataPoint)localObject1).mDin), (String)localObject2, (String)localObject3, (String)localObject4, str1, str2, l1);
                        if (abzb.a(this.a, ((DataPoint)localObject1).mValue)) {
                          continue;
                        }
                        abzb.a(this.a);
                    ...
                    else if (((DataPoint)localObject1).mProperityId == 11010)
                    {
                      try
                      {
                        ...
                        paramContext = bcry.a(this.a.app, ((SessionInfo)localObject5).jdField_a_of_type_JavaLangString, ((SessionInfo)localObject5).b, ((SessionInfo)localObject5).jdField_a_of_type_Int, paramContext);
                    ...
                    else if ((((DataPoint)localObject1).mProperityId == 11008) || (((DataPoint)localObject1).mProperityId == 11012))
                    {
                      ...
                      {
                        paramContext = new JSONObject(((DataPoint)localObject1).mValue);
                        ache.a(this.a.app, paramContext, String.valueOf(((DataPoint)localObject1).mDin));
                        if (abzb.a(this.a, ((DataPoint)localObject1).mValue)) {
                          continue;
                        }
                        abzb.a(this.a);
                      ...
                      if (QLog.isColorLevel()) {
                        QLog.d(abzb.jdField_a_of_type_JavaLangString, 2, "auth_request_structmsg:" + paramContext.getMessage());
                      }
                    }
                    else if (((DataPoint)localObject1).mProperityId == 700154)
                    {
                      try
                      {
                        ...
                        if (QLog.isColorLevel()) {
                          QLog.d(abzb.jdField_a_of_type_JavaLangString, 2, "openav roomId:" + i + ",sessionId:" + paramContext + ", cTime: " + j + ", cmd:" + k);
                        }
                        if (k != 1) {
                          continue;
                        }
                      ...
                      if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_sendCCDataPointMsgResult"))
                      {
                        ...
                        if (bool)
                        {
                          abzb.a(this.a, String.valueOf(l1), i);
                          return;
                        }
                        abzb.b(this.a, String.valueOf(l1), i);
                        return;
                      }
                      ...
                      else
                      {
                        if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_OnMiniFileTransferComplete"))
                        {
                          ...
                          if ((l1 != 0L) && (this.a.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(Long.valueOf(l1))))
                          {
                            ...
                            paramIntent = antf.ba + "/smart_device/" + paramIntent.getName();
                            bhmi.b((String)localObject1, paramIntent);
                            ...
                            paramContext.srcFileName = aunj.a(paramIntent);
                            paramContext.fileSize = aunj.a(paramIntent);
                            paramContext.msg = (bhlg.b(this.a.app, paramContext.senderuin, true) + ": " + this.a.app.getApp().getString(2131691403));
                            paramContext.serial();
                            this.a.app.a().a(paramContext.frienduin, paramContext.istroop, paramContext.uniseq, paramContext.msgData);
                        ...
                        if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_DeviceVasFlagChange"))
                        {
                          ...
                          if (paramIntent != null)
                          {
                            ...
                            localObject1 = (abur)this.a.app.a(51);
                            localObject2 = ((abur)localObject1).a(l1);
                            paramIntent = "";
                            ...
                            {
                              paramIntent = this.a.app.getApp().getString(2131694170).split(":")[0];
                              paramContext = paramIntent;
                              if (((DeviceInfo)localObject2).isAdmin != 1)
                              {
                                ((abur)localObject1).a(((DeviceInfo)localObject2).productId, ((DeviceInfo)localObject2).serialNum);
                                paramContext = paramIntent;
                              }
                            }
                            ...
                            {
                              aiit.W = true;
                              paramContext = paramContext + this.a.app.getApp().getString(2131691376);
                            ...
                            {
                              aiit.W = false;
                              paramContext = paramContext + this.a.app.getApp().getString(2131691375);
                        ...
                        else if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_QueryIsDeviceBinded"))
                        {
                          ...
                          if (paramIntent != null)
                          {
                            ...
                            localObject1 = bhlg.b(this.a.app, l1 + "", true);
                        ...
                        else
                        {
                          ...
                          paramContext = (abur)this.a.app.a(51);
                          ...
                          if (paramIntent != null)
                          {
                            ...
                            if (localObject1 != null)
                            {
                              ...
                              for (paramContext = anzj.a(2131702085); !TextUtils.isEmpty(paramContext); paramContext = anzj.a(2131702082) + ((ProductInfo)localObject1).deviceName)
                              {
                                localObject1 = bhlg.b(this.a.app, Long.toString(((Long)localObject3).longValue()), true);
                ...
                paramContext = anzj.a(2131702073);
          ...
          } while ((localObject1 != null) && (((abur)localObject1).a(l1, 13)));
          if (asvf.a().a(this.a.app, paramContext) != 0) {
        ...
        } while ((localObject2 == null) || (((DeviceInfo)localObject2).isAdmin == 1) || (!((abur)localObject1).a(l1).booleanValue()));
        paramContext = paramContext + this.a.app.getApp().getString(2131691376);
        this.a.a(l1 + "", paramContext, bcrg.a(), true, false, 1);
        return;
        ...
        if (QLog.isColorLevel()) {
          QLog.d(abzb.jdField_a_of_type_JavaLangString, 2, "DeviceMsghandle intent.getExtras() : " + paramIntent.getExtras());
        }
        paramContext = paramIntent.getExtras();
      ...
      localObject1 = bhlg.b(this.a.app, paramContext, true);
      if ((TextUtils.isEmpty((CharSequence)localObject1)) || (paramContext.equals(localObject1))) {}
      for (paramContext = anzj.a(2131702092);; paramContext = (String)localObject1 + anzj.a(2131702081))
      {
      ...
      if ("SmartDevice_sendToAIO_Capture".equals(paramIntent.getAction()))
      {
        ...
        try
        {
          ...
          ((JSONObject)localObject2).put("guidewords", anzj.a(2131702079));
          ((JSONObject)localObject2).put("appear_time", bcrg.a());
          ((JSONObject)localObject2).put("digest", anzj.a(2131702088));
          ((JSONObject)localObject2).put("title", anzj.a(2131702091));
          paramIntent = (MessageForDeviceSingleStruct)bcry.a(-4502);
          ...
          paramIntent.strMediaFileName = aunj.a((String)localObject1);
    ...
    try
    {
      ...
      ((JSONObject)localObject3).put("guidewords", anzj.a(2131702090));
      ...
      localObject2 = (MessageForDeviceSingleStruct)bcry.a(-4502);
      ...
      ((MessageForDeviceSingleStruct)localObject2).strMediaFileName = aunj.a(paramIntent);
      ((MessageForDeviceSingleStruct)localObject2).nMediaFileSize = bhmi.a(paramIntent);
