...
public class lei
{
  ...
  public void a()
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Lej == null)
      {
        ...
        this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApplication().registerReceiver(this.jdField_a_of_type_Lej, (IntentFilter)localObject);
      }
      if (QLog.isColorLevel()) {
    ...
    this.jdField_a_of_type_JavaLangObject = mrt.a(localDexClassLoader, "com.tencent.av.camera2.CameraManagerWrapper");
    ...
    mrt.a(localDexClassLoader, localObject, "registerAvailabilityCb", new Class[] { Context.class, String.class, Handler.class }, new Object[] { localContext, str, null });
  }
  ...
  public void b()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApplication().unregisterReceiver(this.jdField_a_of_type_Lej);
        ...
        mrt.a(mrt.a(), this.jdField_a_of_type_JavaLangObject, "unRegisterAvailabilityCb", null, null);
        return;
      }
