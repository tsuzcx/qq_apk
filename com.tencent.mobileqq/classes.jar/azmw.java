...
{
  private akat jdField_a_of_type_Akat = new azmx(this);
  private aznd jdField_a_of_type_Aznd;
  ...
  private void a(MessageRecord paramMessageRecord, TroopAioKeywordTipInfo paramTroopAioKeywordTipInfo)
  {
    ...
    this.jdField_d_of_type_Int = this.jdField_a_of_type_Acup.a(paramMessageRecord.uniseq);
    if (this.jdField_a_of_type_Aznd == null)
    {
      this.jdField_a_of_type_Aznd = new aznd(this);
      this.jdField_a_of_type_Aznd.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560290, null));
      this.jdField_a_of_type_Aznd.jdField_a_of_type_AndroidViewViewGroup.setOnClickListener(this);
      this.jdField_a_of_type_Aznd.jdField_a_of_type_ComTencentWidgetURLThemeImageView = ((URLThemeImageView)this.jdField_a_of_type_Aznd.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131377716));
      this.jdField_a_of_type_Aznd.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_Aznd.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131377719));
      this.jdField_a_of_type_Aznd.b = ((TextView)this.jdField_a_of_type_Aznd.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131377718));
      this.jdField_a_of_type_Aznd.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_Aznd.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131377715));
      this.jdField_a_of_type_Aznd.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130849566);
    }
    this.jdField_a_of_type_Aznd.jdField_a_of_type_AndroidViewViewGroup.setBackgroundResource(2130843262);
    for (;;)
    {
      try
      {
        ...
        this.jdField_a_of_type_Aznd.jdField_a_of_type_ComTencentWidgetURLThemeImageView.setImageDrawable((Drawable)localObject1);
        if (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipInfo.title))
        {
          this.jdField_a_of_type_Aznd.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
          if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipInfo.summary)) {
            break label688;
          }
          this.jdField_a_of_type_Aznd.b.setVisibility(8);
          if (this.jdField_a_of_type_AndroidWidgetRelativeLayout.indexOfChild(this.jdField_a_of_type_Aznd.jdField_a_of_type_AndroidViewViewGroup) < 0)
          {
            localObject1 = new RelativeLayout.LayoutParams(-2, -2);
            ((RelativeLayout.LayoutParams)localObject1).topMargin = baxn.a(this.jdField_a_of_type_AndroidContentContext, 18.0F);
            ((RelativeLayout.LayoutParams)localObject1).addRule(11);
            this.jdField_a_of_type_AndroidWidgetRelativeLayout.addView(this.jdField_a_of_type_Aznd.jdField_a_of_type_AndroidViewViewGroup, (ViewGroup.LayoutParams)localObject1);
          }
          localObject1 = (RelativeLayout.LayoutParams)this.jdField_a_of_type_Aznd.jdField_a_of_type_AndroidViewViewGroup.getLayoutParams();
          ...
          this.jdField_a_of_type_Aznd.jdField_a_of_type_AndroidViewViewGroup.setVisibility(0);
          localObject1 = new TranslateAnimation(2, 1.0F, 2, 0.0F, 2, 0.0F, 2, 0.0F);
          ((Animation)localObject1).setDuration(500L);
          this.jdField_b_of_type_Boolean = true;
          ((Animation)localObject1).setAnimationListener(new azmy(this));
          if (this.jdField_a_of_type_Aznd.jdField_a_of_type_AndroidViewViewGroup.getAnimation() == null) {
            this.jdField_a_of_type_Aznd.jdField_a_of_type_AndroidViewViewGroup.startAnimation((Animation)localObject1);
          }
          localObject2 = new axrc(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_AIO").c("notice_center_new");
          if (!paramMessageRecord.isSend()) {
            break label719;
          }
          localObject1 = "exp_keyword_input";
          ((axrc)localObject2).d((String)localObject1).a(new String[] { paramMessageRecord.frienduin, String.valueOf(paramTroopAioKeywordTipInfo.ruleId), paramMessageRecord.getExtInfoFromExtStr("key_aio_keyword") }).a();
          return;
        }
      }
      ...
      this.jdField_a_of_type_Aznd.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
      this.jdField_a_of_type_Aznd.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipInfo.title);
      continue;
      label688:
      this.jdField_a_of_type_Aznd.b.setVisibility(0);
      this.jdField_a_of_type_Aznd.b.setText(this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipInfo.summary);
      continue;
      label719:
  ...
  private boolean a(MessageRecord paramMessageRecord)
  {
    ...
    return a(this.jdField_a_of_type_Acup.b(paramMessageRecord.uniseq));
  }
  
  private void b(boolean paramBoolean)
  {
    if ((!this.jdField_a_of_type_Boolean) || (this.jdField_a_of_type_Aznd == null) || (!this.jdField_b_of_type_Boolean) || (this.jdField_a_of_type_AndroidWidgetRelativeLayout.indexOfChild(this.jdField_a_of_type_Aznd.jdField_a_of_type_AndroidViewViewGroup) < 0)) {}
    ...
    do
    {
      ...
      localTranslateAnimation.setAnimationListener(new azmz(this, paramBoolean));
    } while (this.jdField_a_of_type_Aznd.jdField_a_of_type_AndroidViewViewGroup.getAnimation() != null);
    this.jdField_a_of_type_Aznd.jdField_a_of_type_AndroidViewViewGroup.startAnimation(localTranslateAnimation);
  }
  ...
  private boolean b()
  {
    ...
    do
    {
      ...
      return false;
      if ((this.jdField_a_of_type_Azno == null) || (!this.jdField_a_of_type_Azno.g())) {
        break label129;
      }
    } while (!QLog.isColorLevel());
  ...
  {
    if (this.jdField_a_of_type_Aznd != null) {
      return this.jdField_a_of_type_Aznd.jdField_a_of_type_AndroidViewViewGroup;
    }
    return null;
  }
  ...
  protected void d()
  {
    ...
    if ((this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) && (this.jdField_a_of_type_Aznd != null) && (this.jdField_a_of_type_AndroidWidgetRelativeLayout.indexOfChild(this.jdField_a_of_type_Aznd.jdField_a_of_type_AndroidViewViewGroup) >= 0))
    {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.removeView(this.jdField_a_of_type_Aznd.jdField_a_of_type_AndroidViewViewGroup);
      this.jdField_a_of_type_Aznd = null;
    }
  ...
  public void e()
  {
    ...
    {
      return;
      i = this.jdField_a_of_type_Acup.a().size();
      if (i != this.e) {
        break;
      }
    } while (!QLog.isColorLevel());
  ...
  public void f()
  {
    ...
    this.jdField_d_of_type_Int = this.jdField_a_of_type_Acup.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.uniseq);
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramView = paramView.replace("$TEXT$", bbco.encodeToString(((MessageForText)this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord).sb.toString().getBytes(), 0));
        localObject = paramView;
        if (this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipInfo.url.contains("$KEYWORD$")) {
          localObject = paramView.replace("$KEYWORD$", bbco.encodeToString(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.getExtInfoFromExtStr("key_aio_keyword").getBytes(), 0));
        }
      ...
      localObject = new axrc(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_AIO").c("notice_center_new");
      if (this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.isSend())
      {
        paramView = "clk_keyword_input";
        ((axrc)localObject).d(paramView).a(new String[] { this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.frienduin, String.valueOf(this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipInfo.ruleId), this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.getExtInfoFromExtStr("key_aio_keyword") }).a();
        b(true);
        return;
        if ((this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord instanceof MessageForStructing))
        {
          ...
          {
            paramView = paramView.replace("$TEXT$", bbco.encodeToString(((AbsShareMsg)((MessageForStructing)localObject).structingMsg).mContentTitle.getBytes(), 0));
            continue;
            if (((String)localObject).startsWith("mqqapi"))
            {
              paramView = bbex.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, (String)localObject);
              if (paramView != null)
              {
                paramView.c();
                continue;
