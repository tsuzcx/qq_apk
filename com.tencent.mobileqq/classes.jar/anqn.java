  ...
  implements FFmpegExecuteResponseCallback
{
  ...
  anqn(anqk paramanqk, PublishVideoEntry paramPublishVideoEntry, String paramString1, String paramString2)
  {
  ...
  public void a(boolean paramBoolean)
  {
    ...
    ((HashMap)localObject).put("generate_video_cost", this.jdField_a_of_type_Anqk.a + "");
    ...
    if (anqk.a(this.jdField_a_of_type_Anqk).get() != null)
    {
      localObject = (Activity)anqk.a(this.jdField_a_of_type_Anqk).get();
      if (anqk.b(this.jdField_a_of_type_Anqk).get() != null) {
        SaveVideoActivity.a((AppInterface)anqk.b(this.jdField_a_of_type_Anqk).get(), this.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry);
      }
      if (!paramBoolean) {
        break label288;
      }
    ...
    label288:
    for (int i = anqk.b(this.jdField_a_of_type_Anqk, -1);; i = anqk.b(this.jdField_a_of_type_Anqk, 1))
    {
      ((Activity)localObject).getIntent().putExtra("save_video_path", anqk.a(this.jdField_a_of_type_Anqk));
      ((Activity)localObject).setResult(i, ((Activity)localObject).getIntent());
      ((Activity)localObject).finish();
      if (i == -1) {
        anqk.a(this.jdField_a_of_type_Anqk, anqk.a(this.jdField_a_of_type_Anqk));
      }
      return;
    }
  }
