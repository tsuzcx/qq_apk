  ...
  extends Dialog
{
  ...
  public wdr(Context paramContext)
  {
    super(paramContext);
    super.requestWindowFeature(1);
    super.getWindow().setBackgroundDrawable(new ColorDrawable(0));
    paramContext = LayoutInflater.from(paramContext).inflate(2131561196, null);
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setOnTouchListener(new wds(this));
  }
  ...
  private void a()
  {
    ...
    localAlphaAnimation.setAnimationListener(new wdt(this));
  }
