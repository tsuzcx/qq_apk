  ...
  implements VComponentAdapter
{
  ...
  {
    if ((paramImageAction == null) || (paramImageAction.getTarget() == null) || (paramURLDrawable == null) || (!bgnt.g(paramImageAction.getTarget().getContext()))) {}
    do
    {
      return;
  ...
  private void a(ImageAction paramImageAction, String paramString, int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    paramString.setURLDrawableListener(new tmj(this, paramBoolean1, paramImageAction));
  }
      ...
      if (paramString.contains("item_image_width"))
      {
        ...
        if ((!TextUtils.isEmpty((CharSequence)localObject1)) && (!TextUtils.isEmpty(str))) {
          try
          {
            ...
            localObject1 = new tdw();
            ((tdw)localObject1).jdField_a_of_type_JavaNetURL = new URL((String)localObject2);
            ((tdw)localObject1).jdField_a_of_type_Int = i;
            ((tdw)localObject1).b = j;
            localObject2 = tdv.a().a((tdw)localObject1);
            if ((localObject2 != null) && (((tds)localObject2).a() != null))
            {
              localObject1 = null;
              if (paramBoolean)
              {
              ...
              paramImageAction.onSuccess(((tds)localObject2).a(), paramString, (Bundle)localObject1);
              return true;
            }
          }
  ...
  {
    PullRefreshHeader localPullRefreshHeader = (PullRefreshHeader)LayoutInflater.from(paramVRefreshLayout.getContext()).inflate(2131562761, paramVRefreshLayout, false);
    RefreshAnimView localRefreshAnimView = (RefreshAnimView)localPullRefreshHeader.findViewById(2131376304);
    paramVRefreshLayout.addView(localPullRefreshHeader);
    paramVRefreshLayout.setonRefreshStateChangeListener(new tmi(this, localRefreshAnimView, paramVRefreshLayout));
  }
  
  public void onClick(View paramView, Object paramObject)
  {
    tre.a(paramView, paramObject);
  }
  ...
  public CharSequence setEmoticonText(@NonNull CharSequence paramCharSequence, int paramInt)
  {
    ...
    try
    {
      paramCharSequence = new bdnt(a(paramCharSequence.toString()), 2, (int)(paramInt / 2.5D));
