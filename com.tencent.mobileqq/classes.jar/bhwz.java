...
public class bhwz
  implements Manager
{
  private static bhxd jdField_a_of_type_Bhxd = new bhxd(null);
  public static final String a;
  public static AtomicBoolean a;
  public Handler a;
  private askr jdField_a_of_type_Askr = new bhxb(this);
  public bhxg a;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private VasQuickUpdateManager.CallBacker jdField_a_of_type_ComTencentMobileqqVasVasQuickUpdateManager$CallBacker = new bhxc(this);
  private Vector<Integer> jdField_a_of_type_JavaUtilVector = new Vector();
  public ConcurrentHashMap<Integer, bhxf> a;
  
  static
  {
    jdField_a_of_type_JavaLangString = bigv.a(antf.ba + ".CorlorNick/");
    jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
  }
  
  public bhwz(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Bhxg = new bhxg(this);
  }
  
  public static int a(List<biwb> paramList, Paint paramPaint, Rect paramRect)
  {
    ...
    {
      biwb localbiwb = (biwb)paramList.next();
      switch (localbiwb.c)
      {
      }
      for (;;)
      {
        break;
        int j = (int)Math.ceil(paramPaint.measureText(localbiwb.jdField_a_of_type_JavaLangString));
        paramPaint.getTextBounds(localbiwb.jdField_a_of_type_JavaLangString, 0, localbiwb.jdField_a_of_type_JavaLangString.length(), localRect);
        paramRect.bottom = Math.max(paramRect.bottom, localRect.height());
        i += j;
        continue;
        i += ((begw)localbiwb.jdField_a_of_type_AndroidTextStyleCharacterStyle).a().getBounds().width();
        paramRect.bottom = Math.max(paramRect.bottom, ((begw)localbiwb.jdField_a_of_type_AndroidTextStyleCharacterStyle).a().getBounds().height());
      }
    }
    paramRect.left = 0;
    paramRect.right = i;
  ...
  public static bhwz a(QQAppInterface paramQQAppInterface)
  {
    return ((bhzq)paramQQAppInterface.getManager(235)).a;
  }
  
  private bhxf a(File paramFile, int paramInt)
  {
    int i = 0;
    paramFile = bhmi.a(paramFile, -1);
    try
    {
      paramFile = new JSONObject(paramFile);
      bhxf localbhxf = new bhxf();
      paramFile = paramFile.optJSONArray("baseInfo");
      if ((paramFile != null) && (paramFile.length() > 0))
      {
        Object localObject = paramFile.getJSONObject(0);
        localbhxf.jdField_a_of_type_Int = ((JSONObject)localObject).optInt("type");
        if (localbhxf.jdField_a_of_type_Int == 5)
        {
          ...
          localbhxf.jdField_a_of_type_AndroidGraphicsBitmap = bhmq.a((String)localObject, null);
          return localbhxf;
        }
        localbhxf.b = ((JSONObject)localObject).optInt("orientation");
        paramFile = ((JSONObject)localObject).optJSONArray("colors");
        if ((paramFile != null) && (paramFile.length() > 0))
        {
          localbhxf.jdField_a_of_type_ArrayOfInt = new int[paramFile.length()];
          paramInt = 0;
          while (paramInt < paramFile.length())
          {
            String str = paramFile.getString(paramInt);
            localbhxf.jdField_a_of_type_ArrayOfInt[paramInt] = Color.parseColor(str);
            paramInt += 1;
          }
        }
        if ((localbhxf.jdField_a_of_type_Int != 1) && (localbhxf.jdField_a_of_type_Int != 2))
        {
          paramFile = localbhxf;
          if (localbhxf.jdField_a_of_type_Int != 3) {
            return paramFile;
          }
        }
        ...
        localbhxf.jdField_a_of_type_ArrayOfFloat = new float[((JSONArray)localObject).length()];
        paramInt = i;
        for (;;)
        {
          paramFile = localbhxf;
          ...
          if (TextUtils.isDigitsOnly(paramFile))
          {
            ...
            localbhxf.jdField_a_of_type_ArrayOfFloat[paramInt] = (i / 100.0F);
          }
          paramInt += 1;
        }
      }
  ...
  public static CharSequence a(MessageRecord paramMessageRecord, MsgSummary paramMsgSummary)
  {
    ...
    for (;;)
    {
      ...
      paramMsgSummary.strContent = new begp((CharSequence)localObject, 5, 16);
  ...
  public static CharSequence a(String paramString, MessageRecord paramMessageRecord, int paramInt1, int paramInt2)
  {
    ...
    if (paramMessageRecord != null)
    {
      ...
      str = bgmh.a(localMessageForReplyText.mSourceMsgInfo.mSourceMsgSenderUin, str);
    }
    label71:
    for (;;)
    {
      return a(paramString, str, paramInt1, paramMessageRecord, paramInt2);
      return new begp(paramString, paramInt2, paramInt1, paramMessageRecord);
    }
  }
    ...
    if (!TextUtils.isEmpty(paramString2))
    {
      ...
      if ((paramString2 != null) && (paramString2.size() > 0))
      {
        ...
        while (i < paramString2.size())
        {
          ...
          {
            bhxe localbhxe = new bhxe(null);
            localbhxe.jdField_a_of_type_Int = localAtTroopMemberInfo.startPos;
            ...
            {
              localbhxe.b = j;
              localbhxe.jdField_a_of_type_AndroidTextSpannableString = new begb(paramString1.subSequence(localbhxe.jdField_a_of_type_Int, localbhxe.b), paramInt1).a();
              ((ArrayList)localObject).add(localbhxe);
              break;
        ...
        {
          paramString2 = (bhxe[])((ArrayList)localObject).toArray(new bhxe[((ArrayList)localObject).size()]);
          Arrays.sort(paramString2, jdField_a_of_type_Bhxd);
          localObject = new SpannableStringBuilder();
          ...
          if (i < m)
          {
            ...
            if (localAtTroopMemberInfo.jdField_a_of_type_Int >= j) {
              ((SpannableStringBuilder)localObject).append(new begp(paramString1.subSequence(j, localAtTroopMemberInfo.b), paramInt2, paramInt1, paramMessageRecord));
            }
            for (;;)
            {
          ...
          if (j < paramString1.length()) {
            ((SpannableStringBuilder)localObject).append(new begp(paramString1.subSequence(j, paramString1.length()), paramInt2, paramInt1, paramMessageRecord));
          }
          return localObject;
        }
      }
    }
    return new begp(paramString1, paramInt2, paramInt1, paramMessageRecord);
  }
  
  public static String a(bhws parambhws)
  {
    int j = 0;
    char[] arrayOfChar = new char[7];
    arrayOfChar[0] = '<';
    arrayOfChar[1] = '%';
    arrayOfChar[2] = ((char)(parambhws.b >>> 24 & 0xFF));
    arrayOfChar[3] = ((char)(parambhws.b >>> 16 & 0xFF));
    arrayOfChar[4] = ((char)(parambhws.b >>> 8 & 0xFF));
    arrayOfChar[5] = ((char)(parambhws.b & 0xFF));
    arrayOfChar[6] = '>';
    int i = j;
  ...
  public static List<biwb> a(int paramInt1, String paramString, Paint paramPaint, biwc parambiwc, int paramInt2)
  {
    Object localObject = new ArrayList();
    ArrayList localArrayList = new ArrayList();
    ColorClearableEditText.a((List)localObject, parambiwc, new begb(paramString, paramInt2).a());
    int i = (int)Math.ceil(paramPaint.measureText("..."));
    paramString = ((ArrayList)localObject).iterator();
    paramInt2 = 0;
    if (paramString.hasNext())
    {
      parambiwc = (biwb)paramString.next();
      switch (parambiwc.c)
      {
      }
      for (;;)
      {
        break;
        localObject = bdxx.a(paramInt1 - paramInt2, parambiwc.jdField_a_of_type_JavaLangString, paramPaint);
        int j;
        if (((String)localObject).equals(parambiwc.jdField_a_of_type_JavaLangString))
        {
          j = (int)Math.ceil(paramPaint.measureText(parambiwc.jdField_a_of_type_JavaLangString));
          localArrayList.add(parambiwc);
          paramInt2 += j;
        }
        else
        {
          parambiwc.jdField_a_of_type_JavaLangString = ((String)localObject);
          localArrayList.add(parambiwc);
          return localArrayList;
          j = ((begw)parambiwc.jdField_a_of_type_AndroidTextStyleCharacterStyle).a().getBounds().width();
          if (j > paramInt1 - paramInt2 - i)
          {
            localArrayList.add(new biwb(1, parambiwc.jdField_a_of_type_Int, parambiwc.b, "...", null));
            return localArrayList;
          }
          localArrayList.add(parambiwc);
          paramInt2 += j;
  ...
  public static void a(asrv paramasrv, QQAppInterface paramQQAppInterface, EditText paramEditText)
  {
    if (paramasrv.a == null)
    {
    ...
    try
    {
      ...
      ((axfj)paramQQAppInterface.getManager(14)).a(String.valueOf(j), new bhxa(j, i, paramEditText));
      return;
    }
      ...
      do
      {
        do
        {
          do
          {
            ...
            {
              return;
              paramSpannable = (bhxs[])paramSpannable.getSpans(0, paramSpannable.length(), bhxs.class);
    ...
    if ((paramDraftTextInfo != null) && (!TextUtils.isEmpty(paramDraftTextInfo.mAtInfoStr)) && (!TextUtils.isEmpty(paramString1)))
    {
      ...
      if (paramDraftTextInfo != null)
      {
        ...
        while (paramDraftTextInfo.hasNext())
        {
          ...
          {
            SpannableString localSpannableString = bgme.a(paramQQAppInterface, paramBaseActivity, paramString2, Long.toString(localAtTroopMemberInfo.uin), paramString1.substring(localAtTroopMemberInfo.startPos + 1, localAtTroopMemberInfo.startPos + localAtTroopMemberInfo.textLen), false, paramXEditTextEx, true);
            if (localSpannableString != null) {
  ...
  private void a(List<biwb> paramList, Paint paramPaint, bhxf parambhxf, Canvas paramCanvas, float paramFloat1, float paramFloat2)
  {
    ...
    {
      localbiwb = (biwb)paramList.get(j);
      switch (localbiwb.c)
      {
      default: 
        j += 1;
    ...
    for (;;)
    {
      ...
      {
        float f5 = paramPaint.measureText(localbiwb.jdField_a_of_type_JavaLangString, k, k + 1);
        float f1;
        float f2;
        float f3;
        if (parambhxf.b == 1)
        ...
        {
          localPaint.setShader(new LinearGradient(f1, f2, f3, f4, parambhxf.jdField_a_of_type_ArrayOfInt, parambhxf.jdField_a_of_type_ArrayOfFloat, Shader.TileMode.CLAMP));
      ...
      break;
      paramFloat1 += ((begw)localbiwb.jdField_a_of_type_AndroidTextStyleCharacterStyle).a().getBounds().width();
      break;
      return;
    }
  }
  ...
  public Shader a(int paramInt1, List<biwb> paramList, float paramFloat1, float paramFloat2, Rect paramRect, Paint paramPaint, int paramInt2, int paramInt3)
  {
    bhxf localbhxf = a(paramInt1);
    if (localbhxf != null) {
      switch (localbhxf.jdField_a_of_type_Int)
      {
      }
    }
    label90:
    ...
    do
    {
      ...
      {
        return new LinearGradient(f1, f2, paramFloat1, paramFloat2, localbhxf.jdField_a_of_type_ArrayOfInt, localbhxf.jdField_a_of_type_ArrayOfFloat, Shader.TileMode.CLAMP);
      ...
      a(paramList, paramPaint, localbhxf, new Canvas((Bitmap)localObject1), paramFloat1, paramFloat2 + paramRect.height());
      return new BitmapShader((Bitmap)localObject1, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
      return new RadialGradient(paramRect.width() / 2 + paramFloat1, paramRect.height() / 2 + paramFloat2, paramRect.width() / 2, localbhxf.jdField_a_of_type_ArrayOfInt, localbhxf.jdField_a_of_type_ArrayOfFloat, Shader.TileMode.CLAMP);
      ...
      {
        localObject3 = (biwb)paramList.get(paramInt2);
        switch (((biwb)localObject3).c)
        {
        }
        for (;;)
        {
          ...
          break;
          int i = 0;
          while (i < ((biwb)localObject3).jdField_a_of_type_JavaLangString.length())
          {
            paramFloat2 = paramPaint.measureText(((biwb)localObject3).jdField_a_of_type_JavaLangString, i, i + 1);
            ((Paint)localObject2).setColor(localbhxf.jdField_a_of_type_ArrayOfInt[(paramInt1 % localbhxf.jdField_a_of_type_ArrayOfInt.length)]);
          ...
          continue;
          paramFloat1 += ((begw)((biwb)localObject3).jdField_a_of_type_AndroidTextStyleCharacterStyle).a().getBounds().width();
        }
      }
      return new BitmapShader(paramRect, Shader.TileMode.REPEAT, Shader.TileMode.REPEAT);
    } while (localbhxf.jdField_a_of_type_AndroidGraphicsBitmap == null);
    label177:
    label184:
    label200:
    paramList = Bitmap.createBitmap(paramInt2, paramInt3, Bitmap.Config.ARGB_8888);
    Object localObject1 = new Canvas(paramList);
    paramInt1 = localbhxf.jdField_a_of_type_AndroidGraphicsBitmap.getWidth();
    Object localObject2 = new Rect();
    Object localObject3 = new Rect(0, 0, paramInt1, localbhxf.jdField_a_of_type_AndroidGraphicsBitmap.getHeight());
    for (paramFloat1 = 0.0F; paramFloat1 < paramRect.width(); paramFloat1 += paramInt1)
    {
      ...
      ((Canvas)localObject1).drawBitmap(localbhxf.jdField_a_of_type_AndroidGraphicsBitmap, (Rect)localObject3, (Rect)localObject2, paramPaint);
    }
  ...
  public bhxf a(int paramInt)
  {
    if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(Integer.valueOf(paramInt))) {
      return (bhxf)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt));
    }
    a(paramInt);
    return null;
  }
