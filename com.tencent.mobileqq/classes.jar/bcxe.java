  ...
  implements Manager
{
  ...
  private bcxc jdField_a_of_type_Bcxc;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private List<MessageRecord> jdField_a_of_type_JavaUtilList = new ArrayList();
  
  public bcxe(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Long = 0L;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Bcxc = new bcxc(paramQQAppInterface);
  }
  
  private void a(DataLineMsgRecord paramDataLineMsgRecord, String paramString1, String paramString2, String paramString3, aqjy paramaqjy)
  {
    if (!this.jdField_a_of_type_Bcxc.a())
    {
    ...
    this.jdField_a_of_type_Bcxc.a(paramDataLineMsgRecord);
    new Handler(ThreadManager.getSubThreadLooper()).postDelayed(new DataLineMessageSpreadManager.2(this, paramDataLineMsgRecord, paramString1, paramaqjy, paramString2, paramString3), 1000L);
  }
  
  private boolean a(DataLineMsgRecord paramDataLineMsgRecord)
  {
    int i = this.jdField_a_of_type_Bcxc.a();
    int j = aqjz.a().a();
    if (j == 0) {
      if (QLog.isColorLevel()) {
  ...
  {
    this.jdField_a_of_type_Bcxc.a(paramaqjw);
  }
  ...
  public void a(DataLineMsgRecord paramDataLineMsgRecord, Context paramContext)
  {
    ...
    catch (Exception paramDataLineMsgRecord)
    {
      ...
      bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80098F8", "0X80098F8", 0, 0, "", "", "", "");
      ...
      bcua.a(paramDataLineMsgRecord, paramContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 6, i);
    }
  }
  ...
  public void a(MessageRecord paramMessageRecord, int paramInt)
  {
    ...
    {
      QLog.e("DataLineMessageSpreadManager", 1, aszt.a());
      return;
    }
    if (QLog.isColorLevel()) {
