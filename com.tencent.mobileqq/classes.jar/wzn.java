  ...
  extends wzy
{
  ...
  public wzn(DoodleView paramDoodleView)
  {
  ...
  private void b()
  {
    ...
    if (bngs.b()) {
      this.jdField_c_of_type_Int = bngs.jdField_a_of_type_Int;
    }
    this.d = localDisplayMetrics.heightPixels;
    if (bngs.b()) {
      this.d = (localDisplayMetrics.heightPixels - bngs.e);
    }
    ...
    this.jdField_a_of_type_Xeg.b(0.5F);
  }
