...
public class aevt
{
  private aevs jdField_a_of_type_Aevs = new aevu(this);
  ...
  private List<WeakReference<aevw>> jdField_a_of_type_JavaUtilList = new LinkedList();
  private boolean jdField_a_of_type_Boolean;
  private aevs jdField_b_of_type_Aevs = new aevv(this);
  ...
  private List<WeakReference<aevw>> jdField_b_of_type_JavaUtilList = new LinkedList();
  ...
  private void a(List<WeakReference<aevw>> paramList)
  {
    try
    {
      ...
      {
        aevw localaevw = (aevw)((WeakReference)paramList.next()).get();
        if (localaevw != null) {
          localaevw.a();
        }
      }
  ...
  private void b(List<WeakReference<aevw>> paramList)
  {
    Iterator localIterator = new ArrayList(paramList).iterator();
    while (localIterator.hasNext())
    {
      WeakReference localWeakReference = (WeakReference)localIterator.next();
      aevw localaevw = (aevw)localWeakReference.get();
      if (localaevw != null) {
        localaevw.b();
      } else {
  ...
  public void a(aevw paramaevw)
  {
    try
    {
      this.jdField_a_of_type_JavaUtilList.add(new WeakReference(paramaevw));
      return;
    }
    finally
    {
  ...
  public void b(aevw paramaevw)
  {
    try
    {
      this.jdField_b_of_type_JavaUtilList.add(new WeakReference(paramaevw));
      return;
    }
    finally
    {
  ...
  public StickerBubbleAnimationView c(Context paramContext)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioStickerbubbleStickerBubbleAnimationView == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityAioStickerbubbleStickerBubbleAnimationView.setId(2131376509);
      this.jdField_a_of_type_ComTencentMobileqqActivityAioStickerbubbleStickerBubbleAnimationView.setAnimationCallback(this.jdField_a_of_type_Aevs);
    }
  ...
  public StickerBubbleAnimationView d(Context paramContext)
  {
    if (this.jdField_b_of_type_ComTencentMobileqqActivityAioStickerbubbleStickerBubbleAnimationView == null)
    {
      ...
      this.jdField_b_of_type_ComTencentMobileqqActivityAioStickerbubbleStickerBubbleAnimationView.setId(2131376509);
      this.jdField_b_of_type_ComTencentMobileqqActivityAioStickerbubbleStickerBubbleAnimationView.setAnimationCallback(this.jdField_b_of_type_Aevs);
    }
