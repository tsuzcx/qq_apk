...
public class aevt
  implements Runnable
{
  public aevt(ImageUploader paramImageUploader, int paramInt, String paramString, byte[] paramArrayOfByte, TicketManager paramTicketManager, ImageUploader.OnResultListener paramOnResultListener) {}
