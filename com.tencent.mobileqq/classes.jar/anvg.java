  ...
  implements andc
{
  ...
  public anvg(QQAppInterface paramQQAppInterface, anvf paramanvf)
  {
    ...
    if (paramList != null)
    {
      ...
      while (paramList.hasNext())
      {
        ...
        if (paramHashMap.containsKey(str))
        {
          ...
          {
            bftf.a("Q.fts.troop.operator", new Object[] { "checkTroopTimeStamp troop ignore troopuin:" + str + " wMemberNum:" + localTroopInfo.wMemberNum + " mMemberNumSeq:" + localTroopInfo.mMemberNumSeq });
          ...
          else
          {
            ...
            try
            {
              ...
              bftf.a("Q.fts.troop.operator", new Object[] { "checkTroopTimeStamp add troop:" + localTroopInfo.troopname + " mMemberNumSeq:" + localTroopInfo.mMemberNumSeq + " troopTime:" + localFTSTroopTime.toString() });
              paramHashMap.remove(str);
            }
        ...
        else
        {
          try
          {
            ...
            bftf.a("Q.fts.troop.operator", new Object[] { "checkTroopTimeStamp delete troop=" + str });
          }
    ...
    if (paramList != null)
    {
      ...
      if (bbko.a != null)
      {
        ...
        if (bbko.a.a != null)
        {
          ...
          {
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache();
            paramList1 = bbko.a.a.entrySet().iterator();
            if (paramList1.hasNext())
            {
              ...
              while (i < ((ArrayList)((Map.Entry)localObject).getValue()).size()) {
                try
                {
                  ...
                  bftf.a("Q.fts.troop.operator", new Object[] { "checkTroopMemberCache modify troop=" + str1 + " member=" + str2 });
                  i += 1;
                }
                catch (Exception localException2)
                {
      ...
      int i = atur.b(this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase, "TroopIndex");
      bftf.a("Q.fts.troop.operator", new Object[] { "FTSDatabaseHelper.queryItemCount = " + i });
      if (i > 0)
      {
  ...
  public List<com.tencent.mobileqq.fts.entity.FTSEntity> a(String paramString)
  {
    ...
    atut localatut = new atut().a(TroopIndex.class).a(new atuu[] { new atuu("TroopIndex", paramString, true) }).a(true);
    if (((bbgk.a(paramString)) || (bbgk.b(paramString))) && (!bbgk.c(paramString))) {
      localatut.a(200);
    }
    return this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase.a(localatut.a());
  }
  ...
  public boolean a(FTSDatatbase paramFTSDatatbase, FTSDatabase paramFTSDatabase)
  {
    ...
    this.jdField_a_of_type_Anvi = new anvh(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this);
    this.jdField_e_of_type_Boolean = true;
    if (QLog.isColorLevel()) {
      QLog.d("Q.fts.troop.operator", 2, "init success");
    }
    this.jdField_e_of_type_Int = atur.b(this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase, "TroopIndex");
    return true;
  }
  ...
  public boolean a(ArrayList<FTSOptSync> paramArrayList)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 28	anvg:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   4: invokevirtual 466	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lcom/tencent/mobileqq/data/QQEntityManagerFactory;
    //   7: invokevirtual 472	com/tencent/mobileqq/data/QQEntityManagerFactory:createEntityManager	()Lcom/tencent/mobileqq/persistence/EntityManager;
    //   10: astore 5
    //   12: aconst_null
    //   13: astore_3
    //   14: aconst_null
    //   15: astore_2
    //   16: aload 5
    //   18: invokevirtual 611	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   21: astore 4
    //   23: aload 4
    //   25: astore_2
    //   26: aload 4
    //   28: astore_3
    //   29: aload 4
    //   31: invokevirtual 616	com/tencent/mobileqq/persistence/EntityTransaction:begin	()V
    //   34: aload 4
    //   36: astore_2
    //   37: aload 4
    //   39: astore_3
    ...
    //   74: checkcast 618	com/tencent/mobileqq/persistence/fts/FTSOptSync
    ...
    //   111: aload_1
    //   112: invokevirtual 623	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   121: invokestatic 626	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   124: aload_2
    //   125: ifnull +7 -> 132
    //   128: aload_2
    //   129: invokevirtual 629	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   132: iconst_0
    //   133: ireturn
    //   134: aload 4
    //   136: astore_2
    ...
    //   139: astore_3
    //   140: aload 4
    //   142: invokevirtual 631	com/tencent/mobileqq/persistence/EntityTransaction:commit	()V
    //   145: aload 4
    //   147: ifnull +8 -> 155
    //   150: aload 4
    //   152: invokevirtual 629	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   155: iconst_1
    //   156: ireturn
    //   157: astore_1
    //   158: aload_3
    //   159: ifnull +7 -> 166
    //   162: aload_3
    //   163: invokevirtual 629	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   166: aload_1
    //   167: athrow
  ...
  public List<com.tencent.mobileqq.fts.entity.FTSEntity> b(String paramString)
  {
    ...
    paramString = new atut().a(TroopIndex.class).a(new atuu[] { new atuu("ext1", paramString, true) }).a(true);
  ...
  protected void b(ArrayList<FTSOptSync> paramArrayList)
  {
    ...
    this.jdField_a_of_type_Anvf.post(new FTSTroopOperator.2(this, paramArrayList));
  }
    ...
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      do
      {
        for (;;)
        {
          try
          {
            bool1 = atur.a(this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase, c());
            bool2 = bool1;
            bool2 = bool1;
          }
          catch (Throwable localThrowable1)
          {
            try
            {
              ...
              bool1 = atur.b(this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase, c());
              if (QLog.isColorLevel()) {
        ...
        i = atur.a(this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase, c());
        if (QLog.isColorLevel()) {
  ...
  public void e()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase != null) && (this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase.d()))
    {
      ...
      {
        bftf.a("Q.fts.troop.operator", new Object[] { i });
        if (localObject1 == null) {
          break label628;
        }
        ...
        for (;;)
        {
          ...
          bftf.a("Q.fts.troop.operator", new Object[] { "transToDatabase, ignore troopSync , it's a QidianPrivateTroop, troopSync = " + localFTSTroopSync.toString() });
        }
      }
      ...
      localObject2 = this.jdField_a_of_type_Amsw.b(String.valueOf(localFTSTroopSync.mMemberUin));
    ...
    for (;;)
    {
      ...
      {
        label389:
        bftf.a("Q.fts.troop.operator", new Object[] { "transToDatabase start troopUin:" + localFTSTroopSync.mTroopUin + " entityList size:" + localArrayList.size() + " opt:" + localFTSTroopSync.mOpt });
        n = atur.a(this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase, localArrayList, c(), 1);
        if (n != -1) {
        ...
        bftf.a("Q.fts.troop.operator", new Object[] { "transToDatabase end troopUin=%s totalTime=%s curSegmentTotal:%s", String.valueOf(localFTSTroopSync.mTroopUin), String.valueOf(l3 - l2), String.valueOf(n) });
        ...
        break label350;
        label652:
        bftf.a("Q.fts.troop.operator", new Object[] { "transToDatabase modify member can't find memberuin:" + localFTSTroopSync.mMemberUin + " troopuin:" + localFTSTroopSync.mTroopUin });
        break label385;
        label706:
        ...
        else
        {
          ...
          try
          {
            ...
            i1 = i;
            n = j;
            bftf.a("Q.fts.troop.operator", new Object[] { "transToDatabase memberList is null" });
          }
    ...
    if (((Iterator)localObject3).hasNext())
    {
      ...
      i1 = i;
      n = j;
      localObject2 = this.jdField_a_of_type_Amsw.b(String.valueOf(localTroopMemberInfo.memberuin));
      if (localObject2 == null) {
        break label1161;
      }
      i1 = i;
  ...
  public void g()
  {
    this.jdField_a_of_type_Anvf.post(new FTSTroopOperator.1(this));
  }
}
