...
public class apti
{
  ...
  /* Error */
  private void a(File paramFile1, File paramFile2, apth paramapth)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 8
    ...
    //   25: iconst_1
    //   26: ldc 150
    //   28: invokestatic 54	apti:a	(ILjava/lang/String;)V
    //   31: iconst_0
    //   32: ifeq +11 -> 43
    ...
    //   134: aload_0
    //   135: getfield 29	apti:jdField_a_of_type_Boolean	Z
    //   138: ifne +62 -> 200
    //   141: aload 5
    //   143: aload 7
    //   145: iconst_0
  ...
  private void a(List<String> paramList, apth paramapth)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          this.jdField_b_of_type_Long += apvb.a(str1);
        }
    ...
    if (str2.contains("/.tmp/")) {
      localObject = b(str1) + apue.a(str2);
    }
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          ThreadManager.post(new FMSettings.4(this, str2, (File)localObject, j, paramapth), 8, null, false);
          i += 1;
        }
      ...
      if (str2.contains("/.thumbnails/")) {
        localObject = c(str1) + apue.a(str2);
      } else {
        localObject = a(str1) + apue.a(str2);
      }
    }
  }
  ...
  private apto b()
  {
    return (apto)this.jdField_a_of_type_JavaUtilMap.get("sdCard");
  }
  ...
  private apto c()
  {
    ...
    return (apto)this.jdField_a_of_type_JavaUtilMap.get("externalSdCard");
  }
  ...
  private void c()
  {
    ...
    ThreadManager.post(new FMSettings.1(this, b(localapto.jdField_b_of_type_JavaLangString + localapto.c)), 8, null, false);
  }
  ...
  private apto d()
  {
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      localObject2 = (apto)this.jdField_a_of_type_JavaUtilMap.get(localObject2);
      ((apto)localObject2).a();
      if (((apto)localObject2).jdField_a_of_type_Boolean)
      {
        a(2, "getDefaultStorage[" + ((apto)localObject2).jdField_b_of_type_JavaLangString + "] + ext[" + ((apto)localObject2).c + "]");
        return localObject2;
      }
    }
    a(2, "getDefaultStorage nothing is default refresh!");
    Object localObject2 = (apto)this.jdField_a_of_type_JavaUtilMap.get("sdCard");
    localObject1 = localObject2;
    if (localObject2 == null)
    {
      localObject1 = new apto(this, null);
      ((apto)localObject1).jdField_a_of_type_Boolean = true;
      ((apto)localObject1).jdField_a_of_type_JavaLangString = "SD卡";
      ((apto)localObject1).jdField_b_of_type_JavaLangString = Environment.getExternalStorageDirectory().getPath();
      ((apto)localObject1).c = "";
    }
    ((apto)localObject1).a(BaseApplicationImpl.getContext());
    return localObject1;
  }
  ...
  public apto a()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      localObject = (apto)this.jdField_a_of_type_JavaUtilMap.get(localObject);
      if (localapto != localObject) {
        return localObject;
      }
    }
  ...
  public String a()
  {
    ...
    return a(localapto.jdField_b_of_type_JavaLangString + localapto.c);
  }
  ...
  public void a()
  {
    ...
    Map localMap = apue.a(localBaseApplication);
    a(1, "qurey strorages[" + localMap.size() + "]");
    String str1 = localBaseApplication.getSharedPreferences("FMSETTING_59", 4).getString("DefaultRootPath", ajsf.aV);
    ...
    if (localIterator.hasNext())
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          localapto = new apto(this, null);
          localapto.jdField_a_of_type_Boolean = false;
          if (!str2.equalsIgnoreCase("sdCard")) {
            break label402;
          }
          localapto.jdField_a_of_type_JavaLangString = "SD卡";
          localapto.jdField_b_of_type_JavaLangString = ((String)localObject);
          localapto.c = "";
          a(1, "rootPath[" + localapto.jdField_b_of_type_JavaLangString + "],bDefault[" + localapto.jdField_a_of_type_Boolean + "]");
          localObject = new StatFs((String)localObject);
          localapto.jdField_a_of_type_Long = (((StatFs)localObject).getAvailableBlocks() * ((StatFs)localObject).getBlockSize());
          a(4, "defaultRootPath[" + str1 + "].equalsIgnoreCase(si.rootPath[" + localapto.jdField_b_of_type_JavaLangString + "])");
          if ((localMap.size() == 1) || (str1.equalsIgnoreCase(localapto.jdField_b_of_type_JavaLangString)))
          {
            a(4, "defaultRootPath.equalsIgnoreCase(si.rootPath) = true");
            localapto.jdField_a_of_type_Boolean = true;
            localapto.a(localBaseApplication);
          }
          localapto.a();
          this.jdField_a_of_type_JavaUtilMap.put(str2, localapto);
        }
        catch (Exception localException)
        {
          localException.printStackTrace();
        ...
        {
          localapto.jdField_a_of_type_JavaLangString = "外置SD卡";
          localBaseApplication.getExternalFilesDir(null);
          String str3 = BaseApplicationImpl.sApplication.getPackageName();
          localapto.jdField_b_of_type_JavaLangString = ((String)localObject);
          localapto.c = ("/Android/data/" + str3 + "/");
        }
      }
    }
  }
  
  public void a(long paramLong, List<String> arg3, Activity paramActivity, apth paramapth)
  {
    ...
    for (;;)
    {
      ...
      a(1, "showChoosePath, callback[" + paramapth + "]");
      ??? = b();
      apto localapto = c();
      if (((apto)???).jdField_a_of_type_Boolean) {
        this.jdField_a_of_type_JavaLangString = ajyc.a(2131704660);
      }
      ...
      {
        label216:
        paramActivity.runOnUiThread(new FMSettings.5(this, paramActivity, ???, paramapth));
        return;
        if ((localapto == null) || (!localapto.jdField_a_of_type_Boolean)) {
          break label216;
        }
        this.jdField_a_of_type_JavaLangString = ajyc.a(2131704656);
      }
    }
  }
  ...
  public void a(String paramString)
  {
    try
    {
      if (this.jdField_a_of_type_JavaUtilMap != null)
      {
        ...
        {
          ((apto)this.jdField_a_of_type_JavaUtilMap.get("sdCard")).a(BaseApplicationImpl.getContext());
          return;
        }
      }
    }
  ...
  public long b()
  {
    ...
    localObject = ((apto)localObject).jdField_b_of_type_JavaLangString;
    try
    {
      localObject = new StatFs((String)localObject);
      long l = ((StatFs)localObject).getAvailableBlocks();
  ...
  public void b()
  {
    ...
    {
      a(1, "FMSettings free");
      Field localField = this.jdField_a_of_type_Bbgg.getClass().getSuperclass().getDeclaredField("mShowing");
      localField.setAccessible(true);
      localField.set(this.jdField_a_of_type_Bbgg, Boolean.valueOf(true));
