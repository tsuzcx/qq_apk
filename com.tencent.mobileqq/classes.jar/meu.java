  ...
  extends lsc
{
  ...
  public Runnable a;
  protected String a;
  private lqs jdField_a_of_type_Lqs;
  protected lrs a;
  protected lrt a;
  protected lrw a;
  private mar jdField_a_of_type_Mar;
  mew jdField_a_of_type_Mew = null;
  ...
  public meu(Context paramContext, VideoAppInterface paramVideoAppInterface, String paramString)
  {
    this(paramContext, paramVideoAppInterface, paramString, 0L);
  }
  
  public meu(Context paramContext, VideoAppInterface paramVideoAppInterface, String paramString, long paramLong)
  {
    this(paramContext, paramVideoAppInterface, paramString, paramLong, true);
  }
  
  public meu(Context paramContext, VideoAppInterface paramVideoAppInterface, String paramString, long paramLong, boolean paramBoolean)
  {
    super(paramContext);
    ...
    this.jdField_a_of_type_Lqs = new lqs();
    this.t = AIOUtils.dp2px(6.0F, paramContext.getResources());
    this.u = AIOUtils.dp2px(10.0F, paramContext.getResources());
    if (paramBoolean)
    {
      this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture = new lsa(this.jdField_a_of_type_AndroidContentContext, this, paramString, paramLong);
      this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture.a(new mev(this, paramVideoAppInterface));
    }
  ...
  Bitmap a(Bitmap paramBitmap)
  {
    ...
    //   11: aload_1
    //   12: aload_1
    //   13: invokevirtual 444	android/graphics/Bitmap:getWidth	()I
    //   16: iconst_4
    //   17: idiv
    //   18: aload_1
    //   19: invokevirtual 447	android/graphics/Bitmap:getHeight	()I
    //   22: iconst_4
    //   23: idiv
    //   24: iconst_1
    //   25: invokestatic 451	android/graphics/Bitmap:createScaledBitmap	(Landroid/graphics/Bitmap;IIZ)Landroid/graphics/Bitmap;
    //   28: astore_2
    //   29: new 453	android/graphics/Canvas
    //   32: dup
    //   33: invokespecial 454	android/graphics/Canvas:<init>	()V
    //   36: astore_3
    //   37: aload_3
    //   38: aload_2
    //   39: invokevirtual 458	android/graphics/Canvas:setBitmap	(Landroid/graphics/Bitmap;)V
    //   42: aload_3
    //   43: ldc_w 460
    //   46: invokestatic 466	android/graphics/Color:parseColor	(Ljava/lang/String;)I
    //   49: getstatic 472	android/graphics/PorterDuff$Mode:LIGHTEN	Landroid/graphics/PorterDuff$Mode;
    //   52: invokevirtual 476	android/graphics/Canvas:drawColor	(ILandroid/graphics/PorterDuff$Mode;)V
    //   55: aload_2
    //   56: bipush 20
    //   58: invokestatic 482	com/tencent/mobileqq/utils/StackBlur:fastblur	(Landroid/graphics/Bitmap;I)V
    //   61: aload_2
    //   62: aload_1
    //   63: invokevirtual 444	android/graphics/Bitmap:getWidth	()I
    //   66: aload_1
    //   67: invokevirtual 447	android/graphics/Bitmap:getHeight	()I
    //   70: iconst_1
    //   71: invokestatic 451	android/graphics/Bitmap:createScaledBitmap	(Landroid/graphics/Bitmap;IIZ)Landroid/graphics/Bitmap;
    //   74: astore_1
    //   75: aload_1
    //   76: astore_2
    //   77: aload_2
    ...
    //   81: astore_1
    //   82: aload_0
    //   83: getfield 147	meu:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   86: iconst_2
    ...
    //   100: aload_2
    //   101: invokevirtual 396	java/lang/OutOfMemoryError:getStackTrace	()[Ljava/lang/StackTraceElement;
    //   104: invokevirtual 399	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   107: invokevirtual 145	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   110: invokestatic 257	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   113: aload_1
    //   114: areturn
    //   115: astore_2
    //   116: aload 4
    //   118: astore_1
    //   119: aload_0
    //   120: getfield 147	meu:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   123: iconst_2
    ...
    //   137: aload_2
    //   138: invokevirtual 402	java/lang/Exception:getStackTrace	()[Ljava/lang/StackTraceElement;
    //   141: invokevirtual 399	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   144: invokevirtual 145	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   147: invokestatic 257	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   150: aload_1
    //   151: areturn
    //   152: astore_3
    //   153: aload_2
  ...
  public mey a(lqo paramlqo)
  {
    ...
    for (;;)
    {
      if (i1 != 0)
      {
        ...
        {
          paramlqo = this.jdField_a_of_type_Lrs.a(paramlqo);
          i1 = this.jdField_a_of_type_Lrs.e();
          i2 = this.jdField_a_of_type_Lrs.f();
          this.jdField_a_of_type_Mey.a(paramlqo[0], i1, i2);
          return this.jdField_a_of_type_Mey;
          i1 = 0;
          break;
          label139:
          i1 = 0;
        ...
        if (!c())
        {
          ...
          label449:
          a(paramlqo, i1);
          paramlqo.a(i7 * 90, 0.0F, 0.0F, 1.0F);
          if (i2 == 0) {
            break label553;
          }
          this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture.a(paramlqo, 0, 0, i5, i6);
        }
        for (;;)
        {
          paramlqo.c();
          ...
          this.jdField_a_of_type_Mey.a(this.jdField_a_of_type_ComTencentTtpicOpenapiFilterRenderBuffer.getTexId(), i5, i6);
          return this.jdField_a_of_type_Mey;
          i1 = this.A;
          break;
          label548:
          ...
          break label449;
          label553:
          this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture.a(paramlqo, 0, 0, i6, i5);
        }
      }
    }
    if ((this.jdField_e_of_type_Boolean) && (this.jdField_c_of_type_Lrr != null))
    {
      paramlqo = this.jdField_c_of_type_Lrr.a(paramlqo);
      i1 = this.jdField_c_of_type_Lrr.c();
      i2 = this.jdField_c_of_type_Lrr.d();
      if (QLog.isColorLevel()) {
    ...
    this.jdField_a_of_type_Mey.a(-1, 0, 0);
    return this.jdField_a_of_type_Mey;
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      if (this.jdField_a_of_type_Mar != null)
      {
        this.jdField_a_of_type_Mar.a();
        this.jdField_a_of_type_Mar = null;
      }
      return;
    }
    if (this.jdField_a_of_type_Mar == null)
    {
      this.jdField_a_of_type_Mar = new mar();
      int i1 = b();
      int i2 = c();
      this.jdField_a_of_type_Mar.a(i1);
      this.jdField_a_of_type_Mar.b(i2);
    }
    this.jdField_a_of_type_Mar.a(paramInt1, paramInt2, paramInt3);
  }
  ...
  protected void a(lqo paramlqo, int paramInt)
  {
    if (this.jdField_d_of_type_Boolean)
    {
      if (paramInt % 2 == 0) {
        paramlqo.b(-1.0F, 1.0F, 1.0F);
      }
    }
    else {
      return;
  ...
  protected void a(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    try
    {
      if (this.jdField_a_of_type_Mar != null)
      {
        this.jdField_a_of_type_Mar.a(paramInt1);
        this.jdField_a_of_type_Mar.b(paramInt2);
      }
      return;
    }
    catch (Exception localException)
  ...
  {
    if (this.jdField_c_of_type_Lrs != null)
    {
      this.jdField_c_of_type_Lrs.a();
      this.jdField_c_of_type_Lrs = null;
    }
    this.jdField_c_of_type_Lrs = new lrs(mvk.a(this.jdField_a_of_type_AndroidContentContext, paramInt1));
    this.jdField_c_of_type_Lrs.a(false);
    if (this.jdField_b_of_type_Lrs != null)
    {
      this.jdField_b_of_type_Lrs.a();
      this.jdField_b_of_type_Lrs = null;
    }
    this.jdField_b_of_type_Lrs = new lrs(mvk.a(this.jdField_a_of_type_AndroidContentContext, paramInt2));
  ...
  public void b(Bitmap paramBitmap)
  {
    ...
    this.jdField_a_of_type_Lrs = new lrs(paramBitmap);
  }
  ...
  protected void c(lqo paramlqo)
  {
    ...
    paramlqo.a(-i1 / 2, -i2 / 2);
    if (this.jdField_q_of_type_Boolean)
    {
      this.jdField_a_of_type_Lqs.a(-9013642);
      if (localRect.left > 0)
      {
        this.jdField_a_of_type_Lqs.a(localRect.left);
        paramlqo.a(localRect.left / 2, 0.0F, localRect.left / 2, i2, this.jdField_a_of_type_Lqs);
      }
      if (localRect.top > 0)
      {
        this.jdField_a_of_type_Lqs.a(localRect.top);
        paramlqo.a(0.0F, localRect.top / 2, i1, localRect.top / 2, this.jdField_a_of_type_Lqs);
      }
      if (localRect.right > 0)
      {
        this.jdField_a_of_type_Lqs.a(localRect.right);
        paramlqo.a(i1 - localRect.right / 2, 0.0F, i1 - localRect.right / 2, i2, this.jdField_a_of_type_Lqs);
      }
      if (localRect.bottom > 0)
      {
        this.jdField_a_of_type_Lqs.a(localRect.bottom);
        paramlqo.a(0.0F, i2 - localRect.bottom / 2, i1, i2 - localRect.bottom / 2, this.jdField_a_of_type_Lqs);
      }
    }
    paramlqo.a(i1 / 2, i2 / 2);
    if (this.jdField_q_of_type_Boolean) {
      if (((!e()) || (!this.f)) && (this.jdField_a_of_type_Lrr != null)) {
        this.jdField_a_of_type_Lrr.a(paramlqo, 0, 0, i3, i4);
      }
    }
    do
    {
      ...
      paramlqo.a(0, 0, i3, i4, this.jdField_g_of_type_Int);
      return;
      if (((!e()) || (!this.f)) && (this.jdField_a_of_type_Lrr != null))
      {
        this.jdField_a_of_type_Lrr.a(paramlqo, 0, 0, i1, i2);
        return;
      }
    } while (this.jdField_m_of_type_Boolean);
    paramlqo.a(0.0F, 0.0F, i1, i2, this.jdField_g_of_type_Int);
  }
  ...
  public String d()
  {
    return "TAG[" + this.jdField_c_of_type_JavaLangString + "], uin[" + c() + "], VST[" + h() + "], LRT[" + a() + "], Drc[" + (int)this.jdField_c_of_type_AndroidGraphicsRectF.width() + ", " + (int)this.jdField_c_of_type_AndroidGraphicsRectF.height() + "], Src[" + (int)this.jdField_b_of_type_AndroidGraphicsRectF.width() + ", " + (int)this.jdField_b_of_type_AndroidGraphicsRectF.height() + "], " + this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture.a();
  }
  ...
  protected void d(lqo paramlqo)
  {
    ...
    float f3;
    float f4;
    if (((this.jdField_m_of_type_Boolean) && (!bool3)) || (this.jdField_n_of_type_Boolean))
    {
      i1 = 0;
      i8 = (i7 + i1 + 4) % 4;
    ...
    for (float f1 = f5;; f1 = f6)
    {
      ...
      String str;
      boolean bool4;
      if ((!this.jdField_m_of_type_Boolean) && (a(i8)) && (!this.jdField_n_of_type_Boolean))
      {
        bool1 = true;
        float f9 = f1;
        float f8 = f4;
        ...
        paramlqo.a(2);
        a(paramlqo, i1);
        paramlqo.a(i8 * 90, 0.0F, 0.0F, 1.0F);
        this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture.a((int)this.jdField_c_of_type_AndroidGraphicsRectF.width());
        this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture.b((int)this.jdField_c_of_type_AndroidGraphicsRectF.height());
        ...
        this.jdField_a_of_type_Lrs.a(paramlqo, i9, i10, (int)this.jdField_c_of_type_AndroidGraphicsRectF.width(), (int)this.jdField_c_of_type_AndroidGraphicsRectF.height());
        ...
        if (QLog.isColorLevel())
        {
          if (this.jdField_a_of_type_Mew == null) {
            this.jdField_a_of_type_Mew = new mew();
          }
          localObject = this.jdField_a_of_type_Mew;
      ...
      for (boolean bool2 = true;; bool2 = false)
      {
        ...
        break label414;
        if ((this.jdField_a_of_type_Mar != null) && (this.jdField_a_of_type_Mar.f()))
        {
          paramlqo.a((4 - i7) * 90, 0.0F, 0.0F, 1.0F);
          ...
          for (;;)
          {
            ...
            this.jdField_a_of_type_Mar.a(paramlqo, i9, i10, i2, i3);
            break;
            i4 = i2;
            i2 = i3;
            i3 = i4;
        ...
        this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture.a(paramlqo, i9, i10, (int)this.jdField_c_of_type_AndroidGraphicsRectF.width(), (int)this.jdField_c_of_type_AndroidGraphicsRectF.height());
        break label615;
      }
      label1188:
      f4 = f5;
  ...
  protected void e(lqo paramlqo)
  {
    ...
    if (this.jdField_m_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_Mar.a(paramlqo, (int)this.jdField_c_of_type_AndroidGraphicsRectF.left, (int)this.jdField_c_of_type_AndroidGraphicsRectF.top, (int)this.jdField_c_of_type_AndroidGraphicsRectF.width(), (int)this.jdField_c_of_type_AndroidGraphicsRectF.height());
    }
    for (;;)
    {
      paramlqo.c();
      lbd.f(this.jdField_c_of_type_JavaLangString, "renderDoubleScreenOfPC:|" + c() + "|" + h() + "|" + i2 + "|" + i3 + "|" + i4 + "|" + i5 + "|" + this.jdField_b_of_type_AndroidGraphicsRectF.toString() + "|" + this.jdField_c_of_type_AndroidGraphicsRectF.toString());
      return;
      i1 = this.A;
      break;
      label398:
      this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture.a(paramlqo, (int)this.jdField_c_of_type_AndroidGraphicsRectF.left, (int)this.jdField_c_of_type_AndroidGraphicsRectF.top, (int)this.jdField_c_of_type_AndroidGraphicsRectF.width(), (int)this.jdField_c_of_type_AndroidGraphicsRectF.height());
    }
  }
  ...
  protected void f(lqo paramlqo)
  {
    ...
    if ((this.jdField_e_of_type_Boolean) && (this.jdField_c_of_type_Lrr != null))
    {
      ...
      i1 = super.b();
      i2 = super.c();
      i4 = this.jdField_c_of_type_Lrr.c();
      i3 = this.jdField_c_of_type_Lrr.d();
      if (i4 <= i1) {
        break label201;
      }
    }
    for (;;)
    {
      ...
      {
        paramlqo.a(2);
        this.jdField_c_of_type_Lrr.a(paramlqo, 0, 0, i1, i2);
        paramlqo.c();
  ...
  protected void finalize()
  {
    try
    {
      if (this.jdField_d_of_type_Lrr != null)
      {
        this.jdField_d_of_type_Lrr.a();
        this.jdField_d_of_type_Lrr = null;
      }
      if (this.jdField_a_of_type_Lrw != null)
      {
        this.jdField_a_of_type_Lrw.a();
        this.jdField_a_of_type_Lrw = null;
      }
      if (this.jdField_c_of_type_Lrr != null)
      {
        this.jdField_c_of_type_Lrr.a();
        this.jdField_c_of_type_Lrr = null;
      }
      if (this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture != null)
      {
      ...
      if (this.jdField_e_of_type_Lrr != null)
      {
        this.jdField_e_of_type_Lrr.a();
        this.jdField_e_of_type_Lrr = null;
      }
  ...
  public void g(int paramInt)
  {
    if (this.jdField_p_of_type_Int != paramInt) {
      this.jdField_a_of_type_Lrt = new lrt(paramInt);
    }
  }
  
  protected void g(lqo paramlqo)
  {
    int i1;
    int i2;
    int i3;
    ...
    if (this.jdField_r_of_type_Boolean)
    {
      ...
      if (this.jdField_d_of_type_Lrr != null)
      {
        ...
        i4 = localRect.left;
        i4 = localRect.bottom;
        this.jdField_d_of_type_Lrr.a(paramlqo, 0, 0, i1 - i2 - i3, 36);
      }
      if (this.jdField_i_of_type_Boolean)
      {
        if (this.jdField_a_of_type_Lrw == null) {
          this.jdField_a_of_type_Lrw = new lrw();
        }
        this.jdField_a_of_type_Lrw.a();
        this.jdField_a_of_type_Lrw.a(this.jdField_a_of_type_JavaLangString);
        this.jdField_a_of_type_Lrw.a(this.jdField_h_of_type_Float);
        this.jdField_a_of_type_Lrw.c(this.jdField_n_of_type_Int);
        this.jdField_a_of_type_Lrw.d(this.jdField_o_of_type_Int);
        this.jdField_a_of_type_Lrw.e(super.b() - this.u);
        this.jdField_a_of_type_Lrw.e();
        this.jdField_i_of_type_Boolean = false;
      }
      if ((this.jdField_a_of_type_Lrw != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)))
      {
        i6 = super.b();
        i5 = super.c();
        i3 = this.jdField_a_of_type_Lrw.c();
        i4 = this.jdField_a_of_type_Lrw.d();
        if (!this.jdField_g_of_type_Boolean) {
          break label312;
        }
        i1 = this.u;
        i2 = i5 - this.jdField_a_of_type_Lrw.j() - this.t;
      }
    }
    for (;;)
    {
      ...
      i5 = (i4 - i5) / 2;
      paramlqo.a(i6, i5);
      this.jdField_a_of_type_Lrw.a(paramlqo, i1, i2, i3, i4);
      paramlqo.c();
      return;
      label312:
  ...
  public void h(int paramInt)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d(this.jdField_c_of_type_JavaLangString, 1, "refreshMicState, uin[" + c() + ", state[" + this.jdField_q_of_type_Int + "->" + paramInt + "]");
    }
  ...
  {
    if ((this.jdField_l_of_type_Boolean) && (this.jdField_a_of_type_Lrt != null)) {
      this.jdField_a_of_type_Lrt.a(paramlqo, 0, 0, b(), c());
    }
  }
  ...
  protected void i(lqo paramlqo)
  {
    ...
    int i6;
    int i1;
    if ((this.jdField_r_of_type_Boolean) && (this.jdField_a_of_type_Lrw != null))
    {
      locallrs = null;
      if (this.jdField_q_of_type_Int != 2) {
        break label168;
      }
      locallrs = this.jdField_c_of_type_Lrs;
      if (locallrs != null)
      {
        i3 = super.b();
        i4 = super.c();
    ...
    for (int i2 = i4 - this.jdField_a_of_type_Lrw.j() - this.t + this.jdField_a_of_type_Lrw.k() - i6 + (i6 - this.jdField_a_of_type_Lrw.k()) / 2;; i2 = this.y + this.jdField_a_of_type_Lrw.k() - i6 + Math.abs((i6 - this.jdField_a_of_type_Lrw.k()) / 2))
    {
      paramlqo.a(3);
      paramlqo.a((i5 - i3) / 2, (i6 - i4) / 2);
      locallrs.a(paramlqo, i1, i2, i5, i6);
      paramlqo.c();
      return;
      label168:
      ...
      locallrs = this.jdField_b_of_type_Lrs;
      break;
      label185:
      i1 = AIOUtils.dp2px(16.0F, this.jdField_a_of_type_AndroidContentContext.getResources()) + this.jdField_a_of_type_Lrw.c() + this.u;
    }
  }
  ...
  public void k(boolean paramBoolean)
  {
    if (this.jdField_e_of_type_Boolean != paramBoolean)
    {
      ...
      if (this.jdField_c_of_type_Lrr == null) {
        this.jdField_c_of_type_Lrr = new lrv(this.jdField_a_of_type_AndroidContentContext, 2130842331);
      }
      localGLRootView = a();
      if (localGLRootView != null) {
  ...
  public void n(boolean paramBoolean)
  {
    ...
    if (paramBoolean) {
      this.z = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131297912);
    }
  }
  ...
  public void o(boolean paramBoolean)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.w(this.jdField_c_of_type_JavaLangString, 1, "setCameraIsBindData, uin[" + c() + "], VideoSrcType[" + h() + "], isBind[" + paramBoolean + "]");
      }
