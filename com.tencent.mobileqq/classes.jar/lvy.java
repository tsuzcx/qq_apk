...
public class lvy
  extends lwg
{
  private lvy(AVServiceForQQ paramAVServiceForQQ) {}
  ...
  public int a(long paramLong, int paramInt)
  {
    ...
    if (this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null)
    {
      ...
      if (((lcp)((Iterator)localObject).next()).d != 1) {
        break label123;
      }
      paramInt += 1;
    }
  ...
  public void a(long paramLong, String paramString)
  {
    ...
    AVServiceForQQ.a(this.a, mua.a());
    AVServiceForQQ.a(this.a).a(null);
    AVServiceForQQ.a(this.a).c();
    AVServiceForQQ.a(this.a).d();
    if ((lbu.a().a().jdField_a_of_type_Lfb.jdField_a_of_type_Int == 3) && ((paramLong == -1L) || (paramLong == lbu.a().a().jdField_a_of_type_Lfb.jdField_a_of_type_Long)))
    {
      AVServiceForQQ.a(this.a, true);
      this.a.jdField_a_of_type_JavaLangString = lbu.a().a().c;
      ...
      lbu.a().b(this.a.jdField_a_of_type_JavaLangString);
    ...
    for (;;)
    {
      ...
      localVideoController.a().jdField_a_of_type_Lfa.b = paramString;
      localVideoController.a().aB = true;
      return;
      this.a.jdField_a_of_type_JavaLangString = lbu.a(AVServiceForQQ.a(this.a), String.valueOf(paramLong), new int[0]);
      lbu.a().a(this.a.jdField_a_of_type_JavaLangString, false);
      ...
      AVServiceForQQ.a(this.a).a();
      if (lbu.a().c(this.a.jdField_a_of_type_JavaLangString).jdField_g_of_type_Boolean)
      {
        i = localVideoController.f();
        localVideoController.a("enterRoom", lbu.a().c(this.a.jdField_a_of_type_JavaLangString).jdField_a_of_type_Lfb.jdField_a_of_type_Long, false, false, -1);
        localVideoController.a(-1L, i, localVideoController.f());
        break label339;
      }
      int i = localVideoController.f();
      localVideoController.a("enterRoom", lbu.a().c(this.a.jdField_a_of_type_JavaLangString).jdField_a_of_type_Lfb.jdField_a_of_type_Long, true, false, -1);
      localVideoController.a(-1L, i, localVideoController.f());
      break label339;
      label598:
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    for (VideoController localVideoController = this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a();; localVideoController = VideoController.a())
    {
      if (localVideoController != null)
      {
        ...
        localVideoController.jdField_a_of_type_Lbt.g(localBundle);
      }
      return;
    }
  }
  ...
  public void b(byte[] paramArrayOfByte)
  {
    ...
    for (VideoController localVideoController = this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a();; localVideoController = VideoController.a())
    {
      if (localVideoController != null)
      {
        Bundle localBundle = new Bundle();
        localBundle.putByteArray("buffer", paramArrayOfByte);
        localVideoController.jdField_a_of_type_Lbt.h(localBundle);
      }
      return;
    }
  }
  ...
  public void c()
  {
    ...
    for (;;)
    {
      ...
      lba.f("AVServiceForQQ", "DataReport onClose: ");
      ...
      lhs.a("AVServiceForQQ", this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
      mbu.b(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin());
      mlr.a(localVideoController.a());
  ...
  public void c(byte[] paramArrayOfByte)
  {
    ...
    {
      if (localVideoController != null) {
        localVideoController.jdField_a_of_type_Lbt.a(paramArrayOfByte);
      }
      return;
    }
  }
