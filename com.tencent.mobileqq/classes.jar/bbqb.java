  ...
  extends bbpz
{
  ...
  private void a(long paramLong, int paramInt1, int paramInt2, int paramInt3, String paramString, RichMediaBrowserInfo paramRichMediaBrowserInfo)
  {
    ...
    else
    {
      ...
      str = new bbpt().a((AIOFilePictureData)paramRichMediaBrowserInfo.baseData, 20);
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        catch (Throwable localThrowable)
        {
          ...
          continue;
          GalleryUrlImageView localGalleryUrlImageView = (GalleryUrlImageView)this.jdField_a_of_type_Bbra.mBrowserItemView.findViewById(2131368501);
          if (localGalleryUrlImageView == null) {
            break label399;
          }
          localGalleryUrlImageView.setGalleryImageListener(new bbqc(this, paramString, paramRichMediaBrowserInfo));
          localGalleryUrlImageView.setImageDrawable(paramString);
          this.jdField_a_of_type_Bbra.a = AIOUtils.showDelayView(this.jdField_a_of_type_Bbra.b, paramString);
        }
        if (paramString != null) {
          continue;
        }
        QQToast.a(this.jdField_a_of_type_Bbra.mContext, this.jdField_a_of_type_Bbra.mContext.getString(2131694770), 0).a();
        return;
    ...
    {
      if (!this.jdField_a_of_type_Bbra.mContext.getString(2131692622).equals(paramString)) {
        break label480;
      }
      QQToast.a(this.jdField_a_of_type_Bbra.mContext, paramString, 0).a();
    }
    for (;;)
    {
  ...
  public Intent a(AIOFilePictureData paramAIOFilePictureData, Activity paramActivity)
  {
    ...
    if ((paramAIOFilePictureData != null) && (RichMediaBrowserManager.getInstance().getProvider() != null) && (RichMediaBrowserManager.getInstance().getProvider().isPingBinder()))
    {
      ...
      if (localIntent != null)
      {
        ...
        for (;;)
        {
          bbqr.a(paramActivity, localIntent, bool);
  ...
  public void a(int paramInt, URLDrawable paramURLDrawable)
  {
    if (paramURLDrawable != null)
    {
      ...
      if ((this.jdField_a_of_type_Bbra != null) && (paramInt == getCurrentPosition())) {
        this.jdField_a_of_type_Bbra.bindView(paramInt);
      }
    }
  }
    ...
    if ((localObject2 != null) && (((RichMediaBrowserInfo)localObject2).baseData != null) && (((AIOBrowserBaseData)((RichMediaBrowserInfo)localObject2).baseData).jdField_a_of_type_Long == paramLong))
    {
      ...
      if ((this.mainBrowserPresenter != null) && (this.mainBrowserPresenter.browserModel != null))
      {
        ...
        if ((paramInt3 == 2) && (!TextUtils.isEmpty(paramString))) {
          new bbpt().b((AIOFilePictureData)((RichMediaBrowserInfo)localObject2).baseData, paramInt2, paramString);
        }
        this.jdField_a_of_type_Bbra.updateView(paramInt1, this.jdField_a_of_type_Bbra.mBrowserItemView, paramBoolean);
  ...
  public void b()
  {
    if ((this.jdField_a_of_type_Bbqa != null) && (this.jdField_a_of_type_Bbqa.a != null) && (this.jdField_a_of_type_Bbqa.a() != null))
    {
      ...
      this.jdField_a_of_type_Bbqa.a().a((int)AIOUtils.px2dp(LiuHaiUtils.jdField_a_of_type_Int, this.jdField_a_of_type_Bbra.mContext.getResources()) + 40);
    }
    for (;;)
    {
      this.jdField_a_of_type_Bbqa.a().c();
      this.jdField_a_of_type_Bbqa.a().e();
      this.jdField_a_of_type_Bbqa.a.a();
      return;
      label101:
      this.jdField_a_of_type_Bbqa.a().a(40);
    }
  }
  ...
  public boolean b()
  {
    if (QLog.isColorLevel()) {
      QLog.d("AIOFilePicPresenter", 2, "isImmersionOpen, ImmersiveConfProcessor.isImageEnable() = " + aqsp.a());
    }
    return aqsp.a();
  }
  ...
  {
    super.onDestroy();
    if (this.jdField_a_of_type_Bbra.a != null) {
      this.jdField_a_of_type_Bbra.b.removeCallbacks(this.jdField_a_of_type_Bbra.a);
    }
  }
  ...
  public void setGalleryView(BrowserBaseView paramBrowserBaseView)
  {
    ...
    if ((paramBrowserBaseView instanceof bbra)) {
      this.jdField_a_of_type_Bbra = ((bbra)paramBrowserBaseView);
    }
  }
}
