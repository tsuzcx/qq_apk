  ...
  implements Manager
{
  ...
  private ArrayList<zuw> jdField_a_of_type_JavaUtilArrayList;
  private ArrayList<zuz> b;
  
  public zux(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a()
  {
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 1)) {
      Collections.sort(this.jdField_a_of_type_JavaUtilArrayList, new zuy(this));
    }
  }
  ...
  public int a()
  {
    ...
    return ((zuw)this.jdField_a_of_type_JavaUtilArrayList.get(0)).jdField_b_of_type_Int;
  }
  ...
  public String a()
  {
    ...
    Object localObject = (aqoh)aqlk.a().a(528);
    if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (((aqoh)localObject).a == 1)) {}
    for (boolean bool = SettingCloneUtil.readValue(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), null, "qqsetting_qrlogin_set_mute", false);; bool = false)
    {
      if (this.jdField_a_of_type_JavaUtilArrayList.size() == 1)
      {
        localObject = (zuw)this.jdField_a_of_type_JavaUtilArrayList.get(0);
        localStringBuilder.append(((zuw)localObject).jdField_a_of_type_JavaLangString).append(" ").append(((zuw)localObject).jdField_b_of_type_JavaLangString).append(" ").append(anni.a(2131693430));
        if (bool) {
          localStringBuilder.append("，").append(anni.a(2131694242));
        }
      }
      for (;;)
      {
        return localStringBuilder.toString();
        localStringBuilder.append(anni.a(2131698045));
        localObject = this.jdField_a_of_type_JavaUtilArrayList.iterator();
        while (((Iterator)localObject).hasNext()) {
          localStringBuilder.append(((zuw)((Iterator)localObject).next()).jdField_a_of_type_JavaLangString).append("、");
        }
        if (bool)
        {
          localStringBuilder.replace(localStringBuilder.length() - 1, localStringBuilder.length(), "，");
          localStringBuilder.append(anni.a(2131694242));
        }
        else
        {
          localStringBuilder.replace(localStringBuilder.length() - 1, localStringBuilder.length(), "。");
  ...
  public String a(Context paramContext)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilArrayList != null)
    {
      ...
      while (localIterator.hasNext()) {
        localStringBuilder.append(((zuw)localIterator.next()).jdField_a_of_type_JavaLangString).append("、");
      }
      localStringBuilder.deleteCharAt(localStringBuilder.lastIndexOf("、"));
    }
    return paramContext.getString(2131715814, new Object[] { localStringBuilder.toString() });
  }
  ...
  public void a(zuz paramzuz)
  {
    try
    {
      ...
      if (!this.b.contains(paramzuz)) {
        this.b.add(paramzuz);
      }
      if (paramzuz != null) {
        paramzuz.a(this.jdField_a_of_type_JavaUtilArrayList);
      }
      return;
    }
    finally {}
  ...
  public boolean a(SvcRespParam paramSvcRespParam)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localOnlineInfos.onlineStatus != 0)
      {
        ...
        if (zva.a(j))
        {
          zuw localzuw = new zuw(j);
          localzuw.jdField_a_of_type_Long = localOnlineInfos.instanceId;
          this.jdField_a_of_type_JavaUtilArrayList.add(localzuw);
          if (QLog.isDevelopLevel()) {
            QLog.d("LoginDevicesManager", 4, localzuw.toString());
          }
        }
    ...
    for (;;)
    {
      ...
      {
        paramSvcRespParam = new zuw(paramSvcRespParam.iPCClientType);
      ...
      if (this.b != null)
      {
        ...
        while (paramSvcRespParam.hasNext()) {
          ((zuz)paramSvcRespParam.next()).a(this.jdField_a_of_type_JavaUtilArrayList);
        }
      }
  ...
  public boolean a(ArrayList<InstanceInfo> paramArrayList)
  {
    ...
    while (paramArrayList.hasNext())
    {
      ...
      if (zva.a(i))
      {
        zuw localzuw = new zuw(i);
        localzuw.jdField_a_of_type_Long = localInstanceInfo.iAppId;
        this.jdField_a_of_type_JavaUtilArrayList.add(localzuw);
        if (QLog.isDevelopLevel()) {
          QLog.d("LoginDevicesManager", 4, localzuw.toString());
        }
    ...
    if (this.b != null)
    {
      ...
      while (paramArrayList.hasNext()) {
        ((zuz)paramArrayList.next()).a(this.jdField_a_of_type_JavaUtilArrayList);
      }
    }
    if (this.jdField_a_of_type_JavaUtilArrayList.size() > 0) {}
  ...
  public void b(zuz paramzuz)
  {
    try
    {
      if (this.b != null) {
        this.b.remove(paramzuz);
      }
      return;
    }
    finally
