...
public class zux
  extends zsa<CertifiedAccountMeta.StComment>
  implements View.OnClickListener, Animation.AnimationListener, CompoundButton.OnCheckedChangeListener, IEventReceiver
{
  private static final String jdField_a_of_type_JavaLangString = zux.class.getSimpleName();
  ...
  private View.OnLayoutChangeListener jdField_a_of_type_AndroidViewView$OnLayoutChangeListener = new zva(this);
  private ViewStub jdField_a_of_type_AndroidViewViewStub;
  private Animation jdField_a_of_type_AndroidViewAnimationAnimation;
  private AbsListView.OnScrollListener jdField_a_of_type_AndroidWidgetAbsListView$OnScrollListener = new zuz(this);
  public ListView a;
  ...
  private ztv jdField_a_of_type_Ztv;
  protected zug a;
  private final zve jdField_a_of_type_Zve;
  private zvf jdField_a_of_type_Zvf;
  private zvg jdField_a_of_type_Zvg;
  private zvh jdField_a_of_type_Zvh;
  private zwd jdField_a_of_type_Zwd;
  private zwf jdField_a_of_type_Zwf;
  ...
  public zux(Activity paramActivity, boolean paramBoolean, CertifiedAccountMeta.StFeed paramStFeed, zvg paramzvg, ExtraTypeInfo paramExtraTypeInfo)
  {
    super(paramActivity, paramBoolean);
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_Zve = new zve(this);
    wad.a().registerSubscriber(this.jdField_a_of_type_Zve);
    this.jdField_a_of_type_Zvg = paramzvg;
  ...
  private zug a()
  {
    if (this.jdField_a_of_type_Zug == null)
    {
      this.jdField_a_of_type_Zug = new zug();
      this.jdField_e_of_type_Int = this.jdField_a_of_type_Zug.hashCode();
    }
    return this.jdField_a_of_type_Zug;
  }
  ...
  private void a(long paramLong, String paramString1, String paramString2)
  {
    ...
    {
      QQToast.a(a(), 1, a().getResources().getString(2131694264), 0).a();
      return;
    }
  ...
  private void a(CertifiedAccountMeta.StComment paramStComment, CertifiedAccountMeta.StReply paramStReply, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (this.jdField_a_of_type_Zwk == null) {
      this.jdField_a_of_type_Zwk = new zwk((Activity)this.jdField_a_of_type_AndroidContentContext);
    }
    String str2;
    String str1;
    if (paramStReply != null) {
      ...
      {
        str2 = String.format(this.jdField_a_of_type_AndroidContentContext.getString(2131692184), new Object[] { paramStReply.postUser.nick.get() });
        str1 = str2;
        if (str2.length() > 10)
        {
        ...
        this.jdField_a_of_type_Zwk.b(str1);
      }
    }
    for (;;)
    {
      this.jdField_a_of_type_Zwk.a(new zvb(this, paramStComment, paramStReply));
      c(paramStComment, paramStReply);
      this.jdField_a_of_type_Zwk.a(paramBoolean2);
      return;
      if ((paramStComment != null) && (paramStComment.postUser != null))
      {
        str2 = String.format(this.jdField_a_of_type_AndroidContentContext.getString(2131692184), new Object[] { paramStComment.postUser.nick.get() });
        str1 = str2;
        if (str2.length() > 10)
        {
          str1 = str2.substring(0, 10);
      ...
      {
        this.jdField_a_of_type_Zwk.b(this.jdField_a_of_type_AndroidContentContext.getString(2131692179));
      }
    }
  }
  ...
  private void a(CertifiedAccountMeta.StFeed paramStFeed, CertifiedAccountMeta.StComment paramStComment, CertifiedAccountMeta.StReply paramStReply)
  {
    ...
    for (paramStComment = paramStReply;; paramStComment = str)
    {
      ...
      paramStReply.version = AppSetting.f();
      paramStReply.uintype = "1";
      paramStReply.eviluin = paramStComment;
      paramStReply.appname = "KQQ";
      paramStReply.appid = "2400002";
      paramStReply.subapp = "qzone_authentication_comment";
      paramStReply.scene = "24000";
      paramStReply.buddyflag = "0";
      paramStReply.srv_para = localStringBuilder.toString();
      paramStReply.text_evidence = paramStFeed;
      EvilReportUtil.doEvilReport(this.jdField_a_of_type_AndroidContentContext, paramStReply);
      return;
  ...
  private void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_Zwk != null) && (this.jdField_a_of_type_AndroidWidgetTextView != null)) {
        this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Zwk.a());
      }
      return;
      k = 0;
    }
  ...
  private void a(Object[] paramArrayOfObject)
  {
    ...
    do
    {
        ...
        do
        {
          do
          {
            ...
            do
            {
              do
              {
                do
                {
                  for (;;)
                  {
                    ...
                    if (paramArrayOfObject[3] != null)
                    {
                      ...
                      if (this.jdField_a_of_type_Zvg != null) {
                        this.jdField_a_of_type_Zvg.a((CertifiedAccountRead.StGetFeedDetailRsp)localObject2, VSNetworkHelper.isProtocolCache((String)localObject1), localLong.longValue(), (String)localObject1);
                      }
                    ...
                    for (;;)
                    {
                      ...
                      if (this.jdField_a_of_type_Zvg != null) {
                        this.jdField_a_of_type_Zvg.a(null, VSNetworkHelper.isProtocolCache((String)localObject1), localLong.longValue(), (String)localObject1);
                      }
                      if (!this.h) {
                  ...
                  if (this.jdField_a_of_type_Zwk != null) {
                    this.jdField_a_of_type_Zwk.b(this.jdField_a_of_type_AndroidWidgetTextView);
                  }
                ...
                if ((paramArrayOfObject[3] instanceof CertifiedAccountWrite.StDoCommentRsp))
                {
                  ...
                  if ((localLong.longValue() != 0L) && (this.jdField_a_of_type_Zwd != null) && (this.jdField_a_of_type_Zwd.a(String.valueOf(paramArrayOfObject[4])))) {
                    m();
                  }
                  if (localLong.longValue() == 0L)
                  {
                    if ((this.jdField_a_of_type_Zwd != null) && (this.jdField_a_of_type_Zwd.a(String.valueOf(paramArrayOfObject[4]), (CertifiedAccountMeta.StComment)localObject2))) {
                      m();
                    }
                    b(1);
                  }
                }
                a(localLong.longValue(), anvx.a(2131701693), (String)localObject1);
              ...
              if ((localLong.longValue() == 0L) && ((paramArrayOfObject[3] instanceof CertifiedAccountWrite.StDoCommentRsp)))
              {
                ...
                if ((this.jdField_a_of_type_Zwd != null) && (this.jdField_a_of_type_Zwd.a(paramArrayOfObject))) {
                  m();
                }
                b(-1);
              }
              a(localLong.longValue(), anvx.a(2131701687), anvx.a(2131701696));
              return;
            ...
            if ((paramArrayOfObject[3] instanceof CertifiedAccountWrite.StDoReplyRsp))
            {
              ...
              if ((localLong.longValue() != 0L) && (this.jdField_a_of_type_Zwd != null) && (this.jdField_a_of_type_Zwd.a(((CertifiedAccountMeta.StComment)localObject2).id.get(), paramArrayOfObject))) {
                m();
              }
              if ((localLong.longValue() == 0L) && (this.jdField_a_of_type_Zwd != null) && (this.jdField_a_of_type_Zwd.a(((CertifiedAccountMeta.StComment)localObject2).id.get(), paramArrayOfObject, (CertifiedAccountMeta.StReply)localObject1))) {
                m();
              }
            }
            a(localLong.longValue(), anvx.a(2131701686), anvx.a(2131701697));
            return;
          } while (a(5, paramArrayOfObject));
          a(localLong.longValue(), anvx.a(2131701692), anvx.a(2131701699));
      ...
      } while ((localLong.longValue() != 0L) || (this.jdField_a_of_type_Zwd == null) || (TextUtils.isEmpty(paramArrayOfObject)) || (TextUtils.isEmpty((CharSequence)localObject1)));
      this.jdField_a_of_type_Zwd.a(paramArrayOfObject, (String)localObject1);
      m();
      return;
    ...
    label1207:
    for (paramArrayOfObject = this.jdField_a_of_type_Zug.a((List)localObject1, (String)paramArrayOfObject[5]);; paramArrayOfObject = (Object[])localObject1)
    {
      this.jdField_a_of_type_Zwd.a(paramArrayOfObject);
      m();
      return;
    }
  }
  ...
  {
    if ((paramStUser != null) && (zqh.a() != null) && (paramStUser.id.get().equals(zqh.a().id.get()))) {}
  ...
  private void b(int paramInt)
  {
    ...
    wad.a().dispatch(new zut(5, new Object[] { b(), Integer.valueOf(this.jdField_d_of_type_Int) }));
  }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    {
      localTextView = (TextView)this.jdField_c_of_type_AndroidViewView.findViewById(2131371598);
      if (localTextView != null)
      {
        if (!paramBoolean) {
          break label37;
        }
        localTextView.setText(2131693531);
      }
    }
    return;
    label37:
  ...
  private void c(int paramInt)
  {
    ...
    if (paramInt == 0) {
      this.jdField_a_of_type_Zwd.a(a().poster.id.get());
    }
  ...
  private void c(CertifiedAccountMeta.StComment paramStComment, CertifiedAccountMeta.StReply paramStReply)
  {
    ...
    this.jdField_a_of_type_Zwk.setOnShowListener(new zvc(this, paramStComment, paramStReply));
    this.jdField_a_of_type_Zwk.a(new zvd(this, paramStComment, paramStReply));
  }
  ...
  private void n()
  {
    this.jdField_a_of_type_AndroidWidgetListView = ((ListView)a(2131366524));
    this.jdField_b_of_type_AndroidViewView = a(2131364921);
    this.jdField_e_of_type_AndroidViewView = a(2131366525);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)a(2131364952));
    this.jdField_c_of_type_AndroidViewView = a(2131364932);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)a(2131378740));
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_d_of_type_AndroidViewView = a(2131363899);
    ...
    this.jdField_a_of_type_Zvh = new zvh(this);
    this.jdField_a_of_type_Zwd = new zwd(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Zvh);
    this.jdField_a_of_type_Zwd.a(this.jdField_d_of_type_JavaLangString);
    this.jdField_a_of_type_AndroidWidgetListView.setAdapter(this.jdField_a_of_type_Zwd);
    this.jdField_a_of_type_AndroidWidgetListView.setEmptyView(this.jdField_c_of_type_AndroidViewView);
    if (this.jdField_b_of_type_AndroidViewView != null) {
      this.jdField_b_of_type_AndroidViewView.setOnClickListener(new zuy(this));
    }
  }
  ...
  private void p()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 313	zux:jdField_a_of_type_Zug	Lzug;
    //   6: ifnonnull +16 -> 22
    //   9: getstatic 65	zux:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   12: iconst_1
    //   13: ldc_w 922
    ...
    //   22: aload_0
    //   23: aload_0
    //   24: invokespecial 326	zux:a	()Lzug;
    //   27: aload_0
    //   28: invokespecial 299	zux:b	()Ljava/lang/String;
    //   31: invokevirtual 632	zug:a	(Ljava/lang/String;)Ljava/util/ArrayList;
    //   34: putfield 305	zux:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   37: aload_0
    //   38: aload_0
    //   39: invokespecial 326	zux:a	()Lzug;
    //   42: aload_0
    //   43: invokespecial 299	zux:b	()Ljava/lang/String;
    //   46: invokevirtual 925	zug:a	(Ljava/lang/String;)LNS_COMM/COMM$StCommonExt;
    //   49: putfield 286	zux:jdField_a_of_type_NS_COMMCOMM$StCommonExt	LNS_COMM/COMM$StCommonExt;
    //   52: aload_0
    //   53: getfield 305	zux:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   56: ifnull -37 -> 19
    //   59: aload_0
    //   60: getfield 330	zux:jdField_a_of_type_Zwd	Lzwd;
    //   63: ifnull +44 -> 107
    //   66: aload_0
    //   67: getfield 330	zux:jdField_a_of_type_Zwd	Lzwd;
    //   70: invokevirtual 927	zwd:a	()V
    //   73: aload_0
    //   74: getfield 330	zux:jdField_a_of_type_Zwd	Lzwd;
    //   77: aload_0
    //   78: getfield 305	zux:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   81: invokevirtual 783	zwd:a	(Ljava/util/Collection;)Z
    //   84: pop
    //   85: aload_0
    //   86: getfield 679	zux:i	Z
    //   89: ifeq +11 -> 100
    //   92: aload_0
    //   93: getfield 330	zux:jdField_a_of_type_Zwd	Lzwd;
    //   96: iconst_0
    //   97: invokevirtual 929	zwd:a	(I)V
    //   100: aload_0
    //   101: getfield 330	zux:jdField_a_of_type_Zwd	Lzwd;
    //   104: invokevirtual 932	zwd:notifyDataSetChanged	()V
    //   107: aload_0
    //   108: getfield 339	zux:jdField_a_of_type_AndroidWidgetListView	Landroid/widget/ListView;
    //   111: ifnull +47 -> 158
    //   114: aload_0
    //   115: getfield 97	zux:jdField_g_of_type_Int	I
    //   118: aload_0
    //   119: invokevirtual 149	zux:a	()I
    //   122: if_icmpeq +36 -> 158
    //   125: aload_0
    //   126: getfield 679	zux:i	Z
    //   129: ifeq +29 -> 158
    //   132: aload_0
    //   133: aload_0
    //   134: invokevirtual 149	zux:a	()I
    //   137: putfield 97	zux:jdField_g_of_type_Int	I
    //   140: getstatic 65	zux:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   143: iconst_1
    //   144: ldc_w 934
    //   147: invokestatic 373	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   150: aload_0
    //   151: getfield 339	zux:jdField_a_of_type_AndroidWidgetListView	Landroid/widget/ListView;
    //   154: iconst_0
    //   155: invokevirtual 937	android/widget/ListView:setSelection	(I)V
    //   158: aload_0
    //   159: getfield 305	zux:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   162: ifnull -143 -> 19
    //   165: aload_0
    //   166: getfield 305	zux:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   169: invokevirtual 647	java/util/ArrayList:size	()I
    //   172: ifle -153 -> 19
    //   175: aload_0
    //   176: aload_0
    //   177: invokespecial 326	zux:a	()Lzug;
    //   180: aload_0
    //   181: invokespecial 299	zux:b	()Ljava/lang/String;
    //   184: invokevirtual 800	zug:a	(Ljava/lang/String;)I
    //   187: putfield 131	zux:jdField_d_of_type_Int	I
    //   190: goto -171 -> 19
    //   193: astore_1
    //   194: aload_0
    //   195: monitorexit
    ...
    for (;;)
    {
      try
      {
        ...
        if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0))
        {
          ...
          {
            this.jdField_b_of_type_AndroidWidgetTextView.setText(zwa.a(this.jdField_d_of_type_Int));
          ...
          if (this.jdField_a_of_type_Zwd.getCount() == 0)
          {
            bool = true;
            b(bool);
          }
  ...
  private void r()
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewAnimationAnimation = AnimationUtils.loadAnimation(this.jdField_a_of_type_AndroidContentContext, 2130772020);
  ...
  public void a(CertifiedAccountMeta.StComment paramStComment, CertifiedAccountMeta.StReply paramStReply)
  {
    ...
    String str = b();
    if ((!StringUtil.isEmpty(str)) && (a() != null) && (a().vecComment.size() == 0) && (a().commentCount.get() != 0))
    {
  ...
  public void a(zvf paramzvf)
  {
    this.jdField_a_of_type_Zvf = paramzvf;
  }
  
  public void a(zwf paramzwf)
  {
    this.jdField_a_of_type_Zwf = paramzwf;
  }
  ...
  public boolean d()
  {
    return (this.jdField_a_of_type_Zwk != null) && (this.jdField_a_of_type_Zwk.isShowing());
  }
  
  protected void e()
  {
    wad.a().unRegisterSubscriber(this.jdField_a_of_type_Zve);
    a().a();
    this.jdField_a_of_type_Zug = null;
  ...
  public void onAnimationStart(Animation paramAnimation)
  {
    ...
    ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).mSystemBarComp.setStatusBarMask(new PorterDuffColorFilter(paramAnimation.getColor(2131167217), PorterDuff.Mode.SRC_ATOP));
  }
