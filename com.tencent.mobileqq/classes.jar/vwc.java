  ...
  extends wcg
{
  ...
  public vwc(ImageView paramImageView, MediaMetadataRetriever paramMediaMetadataRetriever, Integer paramInteger, int paramInt1, int paramInt2, long paramLong, int paramInt3, boolean paramBoolean1, vwd paramvwd, boolean paramBoolean2)
  {
  ...
  public void a()
  {
    veg.d("Q.qqstory.frameWidget.FrameLoader", "runOnBackGround:%s", new Object[] { a() });
    long l3 = System.currentTimeMillis();
    if ((vzo.a()) && (this.jdField_c_of_type_Boolean)) {
      veg.d("Q.qqstory.frameWidget.FrameLoader", "runOnBackGround: TrimNative:%s", new Object[] { a() });
    }
    long l1;
    Object localObject;
    Bitmap localBitmap2;
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_b_of_type_Boolean)
        {
          ...
          if (TrimNative.getThumbnail(0L, l1, localBitmap1) == 0)
          {
            ...
            if (this.jdField_b_of_type_Boolean) {
              localObject = vzo.a(localBitmap3, 90.0F);
            }
            a(new BitmapDrawable((Bitmap)localObject));
            localBitmap1.recycle();
            l1 = System.currentTimeMillis() - l3;
            veg.d("Q.qqstory.frameWidget.FrameLoader", "runOnBackGround: TrimNative 完成时间:%s,key=%s", new Object[] { Long.valueOf(l1), a() });
            this.jdField_a_of_type_Vwd.a(this.jdField_a_of_type_JavaLangInteger.intValue(), l1);
          }
        }
        else
        {
      ...
      {
        veg.e("Q.qqstory.frameWidget.FrameLoader", "create bitmap width=%s,height=%s,error:%s", new Object[] { Integer.valueOf(this.jdField_b_of_type_Int), Integer.valueOf(this.jdField_c_of_type_Int), localException });
        continue;
        ...
        veg.e("Q.qqstory.frameWidget.FrameLoader", "mRetriever return null!");
        return;
      ...
      {
        veg.e("Q.qqstory.frameWidget.FrameLoader", "mRetriever is null!");
        return;
        veg.e("Q.qqstory.frameWidget.FrameLoader", "TrimNative return error!");
      }
      else
      {
    ...
    for (;;)
    {
      ...
      a(new BitmapDrawable((Bitmap)localObject));
      l1 = System.currentTimeMillis() - l3;
      veg.d("Q.qqstory.frameWidget.FrameLoader", "runOnBackGround: mRetriever 完成时间:%s,key=%s", new Object[] { Long.valueOf(l1), a() });
      this.jdField_a_of_type_Vwd.a(this.jdField_a_of_type_JavaLangInteger.intValue(), l1);
      return;
