...
public class rqm
{
  private static QQHashMap<String, rpu> jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap = new QQHashMap(2019, 10, 10000);
  public static String a;
  private static Map<String, rqn> jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  public static rpu a(String paramString)
  {
    try
    {
      paramString = (rpu)jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.get(paramString);
      return paramString;
    }
    finally
    {
  ...
  public static rqn a(String paramString)
  {
    rqn localrqn = (rqn)jdField_a_of_type_JavaUtilMap.get(paramString);
    if (localrqn != null) {
      return localrqn;
    }
    localrqn = new rqn();
    ...
    if (str == null)
    {
      ...
      localrqn.a = false;
      jdField_a_of_type_JavaUtilMap.put(paramString, localrqn);
      return localrqn;
    }
    str = str + paramString;
  ...
  public static void a(String paramString, rpu paramrpu)
  {
    try
    {
      jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.put(paramString, paramrpu);
      return;
    }
    finally
    {
  ...
  public static boolean a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    {
      return false;
      paramString3 = a("8.2.8");
      paramString3.add(Integer.valueOf(Integer.parseInt("4440")));
  ...
  {
    String str = bhvh.a("default_feeds_proteus_offline_bid");
    bbdj.a(mzk.a(str) + str);
  }
}
