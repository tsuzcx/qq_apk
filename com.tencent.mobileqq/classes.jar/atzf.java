  ...
  implements DialogInterface.OnDismissListener, Handler.Callback, DownloadListener
{
  ...
  final MqqHandler jdField_a_of_type_MqqOsMqqHandler = new bkfv(Looper.getMainLooper(), this, true);
  ...
  public atzf(AppInterface paramAppInterface, Activity paramActivity, TouchWebView paramTouchWebView)
  {
  ...
  private void a(String paramString1, String paramString2, long paramLong, Activity paramActivity, AppInterface paramAppInterface, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      paramString2 = new NewIntent(paramActivity.getApplicationContext(), avqx.class);
      ...
      paramString2.setObserver(new atzg(this, paramString1, paramLong, paramBoolean));
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_AndroidAppDialog == null)
      {
        ...
        this.jdField_a_of_type_AndroidAppDialog.setContentView(2131561888);
        this.jdField_a_of_type_AndroidAppDialog.findViewById(2131363377).setBackgroundColor(0);
        ((TextView)this.jdField_a_of_type_AndroidAppDialog.findViewById(2131378445)).setText(anni.a(2131714560));
      }
  ...
  public void onDownloadStart(String paramString1, String paramString2, String paramString3, String paramString4, long paramLong)
  {
    ...
    } while ((!atzd.a(localActivity, paramString1, (Bundle)localObject2)) || (!bool));
