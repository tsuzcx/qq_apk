...
public abstract class atzf
{
  ...
  public atzf(long paramLong, String paramString, byte[] paramArrayOfByte)
  {
    ...
    this.jdField_b_of_type_ComTencentUploadUinterfaceIUploadTaskCallback = new atzg(this);
    this.jdField_a_of_type_Long = paramLong;
    this.g = paramString;
    this.h = atzd.a(paramString);
