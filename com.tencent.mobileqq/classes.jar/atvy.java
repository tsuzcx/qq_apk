  ...
  implements Handler.Callback, Manager
{
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        for (int i = 1;; i = 0)
        {
          ...
          if (!bhpe.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "com.tencent.tim"))
          {
            if (!QLog.isColorLevel()) {
              break;
            }
  ...
  private void b()
  {
    ...
    localObject2 = alpo.a(2131715365);
    str4 = "登录TIM";
    str2 = alpo.a(2131715364);
    ...
    bdcd.a(BaseActivity.sTopActivity, 230, str5, str6, (String)localObject3, (String)localObject1, new atvz(this), new atwa(this)).show();
    azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80085D9", "0X80085D9", 0, 0, "", "", "", "");
  }
  ...
  {
    if (!bdem.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "com.tencent.tim", "775E696D09856872FDD8AB4F3F06B1E0"))
    {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 1, 2131720790, 0).a();
      if (QLog.isColorLevel()) {
        QLog.d(jdField_a_of_type_JavaLangString, 2, "jumpTimLogin tim not install ");
      }
      return;
    }
    String str = bdem.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "com.tencent.tim");
    int i = aosx.a().b();
    if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      {
        localbepp = new bepp(BaseActivity.sTopActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getResources().getDimensionPixelOffset(2131298914));
        localbepp.a(alpo.a(2131715363));
        localbepp.show();
        ...
        localWtloginHelper.SetListener(new atwb(this, localbepp, localWtloginHelper, paramBundle));
        paramBundle = util.getPkgSigFromApkName(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "com.tencent.tim");
        i = localWtloginHelper.GetA1WithA1(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), 16L, 16L, "com.tencent.tim".getBytes(), 1L, 16L, 16L, "8.3.3".getBytes(), paramBundle, new WUserSigInfo(), new WFastLoginInfo());
      }
      if (i == -1001) {
        break;
      }
      ...
      if ((localbepp != null) && (localbepp.isShowing())) {
        localbepp.dismiss();
      }
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 1, 2131720789, 0).a();
      return;
    } while (j >= i);
    QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 1, 2131720791, 0).a();
  }
