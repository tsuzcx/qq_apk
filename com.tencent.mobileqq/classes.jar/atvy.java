...
public class atvy
{
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong, int paramInt1, int paramInt2, int paramInt3, atwg paramatwg)
  {
    ...
    try
    {
      ...
      new athv(paramQQAppInterface).a(24624).b(10).a(new atwa(paramInt2, paramatwg)).a(new atvz(paramatwg, paramInt2)).a(localReadNearUserFeedsReq.toByteArray());
      return;
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong, int paramInt, atwf paramatwf)
  {
    ...
    new athv(paramQQAppInterface).a(22528).b(5).a(new atwc(paramatwf, paramString)).a(new atwb(paramatwf, paramString)).a(localDelFeedReq.toByteArray());
  }
  
  public static void a(QQAppInterface paramQQAppInterface, String paramString, atwh paramatwh)
  {
    new athz(paramQQAppInterface).a(paramString, new atwd(paramatwh), null);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, String paramString, atwi paramatwi)
  {
    new athz(paramQQAppInterface).b(paramString, new atwe(paramatwi), null);
  }
}
