...
{
  private View b = this.jdField_a_of_type_AndroidViewView.findViewById(2131363358);
  private View c = this.jdField_a_of_type_AndroidViewView.findViewById(2131363372);
  private View d = this.jdField_a_of_type_AndroidViewView.findViewById(2131364505);
  
  public rkm(rkk paramrkk, View paramView, BaseData paramBaseData)
  {
  ...
  public void a(BaseData paramBaseData1, BaseData paramBaseData2, boolean paramBoolean)
  {
    ...
    if ((paramBaseData1.p == 14) && (paramBaseData1.b))
    {
      ...
      this.c.getLayoutParams().height = baxn.a(this.c.getContext(), 6.0F);
      label78:
    ...
    for (;;)
    {
      ...
      break;
      label123:
      this.c.getLayoutParams().height = baxn.a(this.c.getContext(), 10.0F);
      break label78;
      label148:
      this.c.setVisibility(8);
      break label78;
      label160:
      i = baxn.a(this.b.getContext(), 12.0F);
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    {
      rno.a(localArticleInfo, "0X800900A", onh.a(localArticleInfo, i, paramView));
      return;
    }
  }
}
