...
class axov
  implements axkz
{
  axov(axop paramaxop, VideoData paramVideoData) {}
    ...
    if ((paramInt == 0) && (paramArrayOfByte != null))
    {
      ...
      try
      {
        ...
        if (paramBundle.busi_buf.has())
        {
          ...
          this.jdField_a_of_type_Axop.f(false);
          ...
          ((axyl)this.jdField_a_of_type_Axop.a.getManager(263)).b(axop.a(this.jdField_a_of_type_Axop), paramArrayOfByte.total.get());
          if (QLog.isColorLevel()) {
