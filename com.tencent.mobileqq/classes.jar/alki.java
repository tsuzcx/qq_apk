  ...
  extends alxv
{
  public void a()
  {
    ...
    if (i > 10)
    {
      ...
      {
        bool1 = SettingCloneUtil.readValue(BaseApplicationImpl.sApplication, null, BaseApplicationImpl.sApplication.getString(2131695442), "qqsetting_screenshot_key", false);
        boolean bool2 = bczj.a(BaseApplication.getContext());
        if ((bool1) && (bool2))
        {
    ...
    for (;;)
    {
      ...
      while (QLog.isColorLevel())
      {
        ...
        if ((!bdlz.g) && (Build.VERSION.SDK_INT < 11)) {
          bdlw.a().a(BaseActivity2.topActivity.getWindow());
        }
      }
    }
  }
