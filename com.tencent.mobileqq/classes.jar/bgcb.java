...
public class bgcb
{
  ...
  public int a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt, ArrayList<String> paramArrayList, Intent paramIntent)
  {
    Bundle localBundle = new Bundle();
    ...
    for (;;)
    {
      ...
      paramString2 = String.valueOf(awbk.a());
  ...
  public void x()
  {
    this.a.a("cmd.getTravelGroup", null, true);
  }
}
