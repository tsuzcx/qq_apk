  ...
  implements Handler.Callback
{
  ...
  public yat(Context paramContext, zha paramzha)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Zha = paramzha;
    this.jdField_a_of_type_Aneh = aneh.a();
    this.jdField_a_of_type_Aneh.a(paramContext, hashCode(), "QrImageScan");
  }
  ...
  public void a()
  {
    try
    {
      ...
      if (this.jdField_a_of_type_Aneh != null) {
        this.jdField_a_of_type_Aneh.a(hashCode(), "QrImageScan");
      }
      this.jdField_a_of_type_Zha = null;
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (int i = yak.a((Uri)paramMessage.obj, this.jdField_a_of_type_AndroidContentContext, j, (SparseArray)localObject);; i = 0)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          if ((!yak.a(k)) || (paramMessage == null)) {
            break label350;
          }
          i = 1;
          if ((!yak.b(k)) || (paramMessage == null)) {
            break label355;
          }
          j = 1;
          if ((i == 0) && (j == 0)) {
      ...
      i = paramMessage.arg1;
      j = paramMessage.arg2;
      if (this.jdField_a_of_type_Zha == null) {
        break;
      }
      this.jdField_a_of_type_Zha.a(String.valueOf(paramMessage.obj), i, j);
      return true;
      i = paramMessage.arg1;
      if (this.jdField_a_of_type_Zha == null) {
        break;
      }
      this.jdField_a_of_type_Zha.a(i);
      return true;
    }
  }
}
