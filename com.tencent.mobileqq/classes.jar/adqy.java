  ...
  implements View.OnClickListener, View.OnLongClickListener
{
  ...
  public adqy(HotPicPageView paramHotPicPageView, View paramView, OnHolderItemClickListener paramOnHolderItemClickListener)
  {
    super(paramView);
    if (paramOnHolderItemClickListener != null)
    {
      this.a = paramOnHolderItemClickListener;
      this.d = ((ImageView)paramView.findViewById(2131362994));
