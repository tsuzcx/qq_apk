...
{
  public adqy(UniformDownloaderGen paramUniformDownloaderGen) {}
  ...
  public void a(String paramString, long paramLong, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      if (!FileUtils.b(new File(this.a.f), new File(this.a.e)))
      {
      ...
      for (;;)
      {
        ...
        if (paramString != null)
        {
          ...
          StatisticAssist.a(paramString.getApplication().getApplicationContext(), paramString.getCurrentAccountUin(), "Complete_download_2_1");
        }
        while (UniformDownloaderGen.a(this.a) != null)
        {
          ...
          UniformDownloaderGen.a(this.a).a(this.a.e, l1, paramBundle);
          return;
