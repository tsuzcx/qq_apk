  ...
  extends actq
{
  ...
  String jdField_a_of_type_JavaLangString = BaseApplication.getContext().getString(2131719127);
  protected boolean a;
  
  public adqy(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo)
  {
  ...
  private CharSequence a(String paramString, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      str = ajyc.a(2131705319) + paramString + ajyc.a(2131705320);
      if (!paramBoolean) {
        break label130;
      }
    }
    label130:
    for (int i = ajyc.a(2131705324).length();; i = ajyc.a(2131705323).length())
    {
      int j = paramString.length();
      paramString = new SpannableString(str);
      paramString.setSpan(new adri(this), i, i + j, 33);
      return paramString;
      str = ajyc.a(2131705330) + paramString + ajyc.a(2131705327);
      break;
    }
  }
  ...
  private void a(TextView paramTextView, String paramString1, String paramString2, int paramInt, String paramString3, String paramString4)
  {
    ...
    paramString1.setSpan(new adru(this, paramString3, paramString4), paramInt, paramString2.length() + paramInt, 33);
    paramTextView.setMovementMethod(LinkMovementMethod.getInstance());
    paramTextView.setText(paramString1);
  }
  
  private void a(ChatMessage paramChatMessage, actr paramactr, View paramView)
  {
    aquu.a(paramChatMessage, paramactr, paramView);
  }
    ...
    do
    {
      ...
      for (String str5 = "0";; str5 = paramString)
      {
        ...
        for (localObject2 = ((JSONObject)localObject2).getString("sens_msg_default_wording");; localObject2 = null)
        {
          localObject1 = null;
          paramString = null;
          Object localObject3 = (Bundle)bbbl.a().a("SensMsgTipsCfg", "TailWording", i, j);
          if (localObject3 != null)
          {
            localObject1 = ((Bundle)localObject3).getString("0");
            paramString = ((Bundle)localObject3).getString("1");
          }
          Bundle localBundle = (Bundle)bbbl.a().a("SensMsgTipsCfg", "Action", i, j);
          ...
          if (localBundle != null)
          {
            ...
            while (((Iterator)localObject2).hasNext())
            {
              ...
              {
                localObject4 = new adsa(this, str5, str2, i, j, str1, (Bundle)localObject4, str3, k, l, str4, m, str6);
  ...
  private void c(TextView paramTextView, MessageRecord paramMessageRecord)
  {
    ...
    {
      return;
      int j = paramMessageRecord.msg.indexOf(ajyc.a(2131705326));
      i = j;
      if (j < 0) {
        i = paramMessageRecord.msg.indexOf(ajyc.a(2131705310));
      }
    } while (i < 0);
    SpannableString localSpannableString = new SpannableString(new SpannableString(paramMessageRecord.msg));
    localSpannableString.setSpan(new adsq(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, paramMessageRecord), i, i + 4, 33);
    paramTextView.setMovementMethod(LinkMovementMethod.getInstance());
  ...
  {
    if (TextUtils.isEmpty(paramString)) {}
    for (paramString = ajyc.a(2131705321);; paramString = paramString + ajyc.a(2131705318))
    {
      String str = ajyc.a(2131705309);
      Object localObject = ajyc.a(2131705308);
      localObject = new SpannableString(paramString + str + (String)localObject);
      ((SpannableString)localObject).setSpan(new adrz(this), paramString.length(), (paramString + str).length(), 33);
      paramTextView.setMovementMethod(LinkMovementMethod.getInstance());
  ...
  private void f(TextView paramTextView)
  {
    ...
    int i = ((String)localObject).indexOf(paramTextView.getResources().getString(2131720351));
    localObject = new SpannableString((CharSequence)localObject);
    ((SpannableString)localObject).setSpan(new adrr(this), i, i + 4, 33);
    paramTextView.setMovementMethod(LinkMovementMethod.getInstance());
    paramTextView.setText((CharSequence)localObject);
  }
  ...
  {
    Object localObject = BaseApplicationImpl.getContext().getString(2131720641);
    String str = this.jdField_a_of_type_AndroidContentContext.getString(2131720642);
    int j = ((String)localObject).length() + str.indexOf(ajyc.a(2131705311));
    int i = j;
    if (j < 0) {
      i = 20;
    }
    localObject = new SpannableString(new SpannableString((String)localObject + str));
    ((SpannableString)localObject).setSpan(new adsb(this), i, i + 4, 33);
    paramTextView.setMovementMethod(LinkMovementMethod.getInstance());
    paramTextView.setText((CharSequence)localObject);
  }
  ...
  {
    Object localObject = ajyc.a(2131705312);
    ...
    localObject = new SpannableString((CharSequence)localObject);
    ((SpannableString)localObject).setSpan(new adsc(this), i, j + 4, 33);
    paramTextView.setMovementMethod(LinkMovementMethod.getInstance());
    paramTextView.setText((CharSequence)localObject);
  }
  ...
  {
    adsl localadsl = (adsl)paramactr;
    View localView = paramView;
    if (paramView == null)
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558782, null);
      localadsl.b = ((TextView)paramView.findViewById(2131367153));
      localObject = localadsl.b.getLayoutParams();
      localView = paramView;
    ...
    localadsl.b.setMovementMethod(null);
    localadsl.b.setTextColor(localView.getResources().getColorStateList(2131167108));
    Object localObject = paramMessageRecord.msg;
    int i;
    switch (paramMessageRecord.msgtype)
    {
    default: 
      localadsl.b.setText((CharSequence)localObject);
    case -1002: 
    case -1001: 
      for (;;)
      {
        if ((paramMessageRecord instanceof MessageForGrayTips))
        {
          ...
          localadsl.b.setGravity(i);
          label652:
          a((ChatMessage)paramMessageRecord, paramactr, localView);
          localadsl.b.setOnTouchListener(paramacxn);
          localadsl.b.setOnLongClickListener(paramacxn);
          localadsl.b.setMovementMethod(bcjw.a());
          return localView;
          paramView = null;
    ...
    {
      localadsl.b.setText(paramView);
      localadsl.b.setOnTouchListener(paramacxn);
      localadsl.b.setOnLongClickListener(paramacxn);
      if ((paramView != null) && (paramView.equals(this.jdField_a_of_type_AndroidContentContext.getString(2131696140))))
      {
        paramLinearLayout = bbjn.e(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
        if (!paramLinearLayout.getBoolean(ldi.l, false))
        {
          localObject = new SpannableStringBuilder(localadsl.b.getText().toString());
          ((SpannableStringBuilder)localObject).setSpan(new ForegroundColorSpan(-12541697), 0, 8, 33);
          localadsl.b.setText((CharSequence)localObject);
          localObject = new adqz(this, paramMessageRecord.uniseq);
          localadsl.b.setClickable(true);
          localadsl.b.setOnClickListener((View.OnClickListener)localObject);
      ...
      boolean bool1 = paramView.equals(this.jdField_a_of_type_AndroidContentContext.getString(2131696011));
      boolean bool2 = paramView.equals(this.jdField_a_of_type_AndroidContentContext.getString(2131720764));
      if (QLog.isColorLevel()) {
      ...
      {
        i = 1;
        paramView = new SpannableStringBuilder(localadsl.b.getText().toString());
      ...
      for (int k = 14;; k = 15)
      {
        ...
        localadsl.b.setText(paramView);
        paramView = new adrq(this, paramMessageRecord, i);
        localadsl.b.setClickable(true);
        localadsl.b.setOnClickListener(paramView);
        break;
        paramView = null;
        break label772;
        i = 2;
      ...
      paramView = new ayki((CharSequence)localObject, 1);
      localadsl.b.setText(paramView);
      localadsl.b.setOnTouchListener(paramacxn);
      localadsl.b.setOnLongClickListener(paramacxn);
      break;
      ...
      {
        e(localadsl.b, (String)localObject);
        break;
      }
      paramView = null;
      if ((paramMessageRecord instanceof MessageForGrayTips))
      ...
      if (paramView != null)
      {
        localadsl.b.setText(paramView.getHightlightMsgText(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramLinearLayout.getContext(), false, localadsl.b));
        localadsl.b.setClickable(true);
        localadsl.b.setFocusable(true);
        localadsl.b.setMovementMethod(LinkMovementMethod.getInstance());
        break;
      }
      localadsl.b.setText((CharSequence)localObject);
      localadsl.b.setOnTouchListener(paramacxn);
      localadsl.b.setOnLongClickListener(paramacxn);
      break;
      localadsl.b.setText(a((String)localObject, true));
      localadsl.b.setOnTouchListener(paramacxn);
      localadsl.b.setOnLongClickListener(paramacxn);
      break;
      localadsl.b.setText(a((String)localObject, false));
      localadsl.b.setOnTouchListener(paramacxn);
      localadsl.b.setOnLongClickListener(paramacxn);
      break;
      paramView = null;
      ...
      localadsl.b.setOnLongClickListener(paramacxn);
      break;
      localadsl.b.setText(a((CharSequence)localObject));
      localadsl.b.setMovementMethod(LinkMovementMethod.getInstance());
      localadsl.b.setOnTouchListener(paramacxn);
      localadsl.b.setOnLongClickListener(paramacxn);
      break;
      paramView = BaseApplicationImpl.getContext().getString(2131692436) + "\"" + (String)localObject + "\"";
      localadsl.b.setText(paramView);
      break;
      localadsl.b.setText((CharSequence)localObject);
      break;
      ...
      {
        paramView = apue.a((String)localObject, paramLinearLayout, new adsd(this, i, k, str1, j));
        localadsl.b.setText(paramView);
      }
      for (;;)
      {
        localadsl.b.setMovementMethod(LinkMovementMethod.getInstance());
        localadsl.b.setHighlightColor(17170445);
        break;
      ...
      g(localadsl.b);
      break;
      localadsl.b.setText(this.jdField_a_of_type_AndroidContentContext.getString(2131720639));
      break;
      c(localadsl.b);
      break;
      a(localadsl.b, (String)localObject);
      break;
      paramView = apue.a(BaseApplicationImpl.getContext().getString(2131698359), BaseApplicationImpl.getContext().getString(2131698358), new adse(this));
      localadsl.b.setText(paramView);
      localadsl.b.setMovementMethod(LinkMovementMethod.getInstance());
      localadsl.b.setHighlightColor(17170445);
      break;
      paramLinearLayout = this.jdField_a_of_type_AndroidContentContext.getString(2131698405);
      paramView = paramLinearLayout;
      if (!((String)localObject).contains(paramLinearLayout)) {
        paramView = this.jdField_a_of_type_AndroidContentContext.getString(2131698368);
      }
      paramView = apue.a((String)localObject, paramView, new adsf(this));
      localadsl.b.setText(paramView);
      localadsl.b.setMovementMethod(LinkMovementMethod.getInstance());
      localadsl.b.setHighlightColor(17170445);
      break;
      paramView = apue.a((String)localObject, this.jdField_a_of_type_AndroidContentContext.getString(2131690711), new adsg(this, paramMessageRecord.getExtInfoFromExtStr("bat_process_tips_last_file_type")));
      localadsl.b.setText(paramView);
      localadsl.b.setMovementMethod(LinkMovementMethod.getInstance());
      localadsl.b.setHighlightColor(17170445);
      break;
      paramView = apue.a((String)localObject, this.jdField_a_of_type_AndroidContentContext.getString(2131692702), new adsh(this));
      localadsl.b.setText(paramView);
      paramView = ((String)localObject).replace("TIM", "t i m");
      localadsl.b.setContentDescription(paramView);
      localadsl.b.setMovementMethod(LinkMovementMethod.getInstance());
      localadsl.b.setHighlightColor(17170445);
      break;
      d(localadsl.b, paramMessageRecord.extStr);
      break;
      ...
      ((SpannableString)localObject).setSpan(new adsi(this, paramView), 0, paramLinearLayout.length(), 33);
      localadsl.b.setHighlightColor(17170445);
      localadsl.b.setMovementMethod(LinkMovementMethod.getInstance());
      localadsl.b.setText((CharSequence)localObject);
      break;
      ...
      paramView.setSpan(new adsj(this, i), j, paramMessageRecord.extStr.length() + j, 33);
      localadsl.b.setMovementMethod(LinkMovementMethod.getInstance());
      localadsl.b.setText(paramView);
      break;
      b(localadsl.b, paramMessageRecord);
      break;
      f(localadsl.b);
      break;
      paramView = ((String)localObject).split("\\|");
      ...
      a(localadsl.b, paramView[0], paramView[1], Integer.parseInt(paramView[2]), paramView[3], paramView[4]);
      break;
      d(localadsl.b);
      break;
      i(localadsl.b);
      ...
      b(localadsl.b, paramView);
      break;
      if (QLog.isColorLevel()) {
        QLog.d("GrayTipsItemBuilder", 2, "getItemView msgtype:-5000 istroop:" + paramMessageRecord.istroop + " msg:" + bbbd.a((String)localObject));
      }
      ...
      paramView.buildTextView(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localadsl.b);
      break;
      h(localadsl.b);
      break;
      ...
      localObject = new adra(this, (String)localObject);
      ...
      localadsl.b.setText(paramLinearLayout);
      localadsl.b.setMovementMethod(LinkMovementMethod.getInstance());
      localadsl.b.setHighlightColor(17170445);
      break;
      paramView = null;
      ...
      e(localadsl.b);
      break;
      c(localadsl.b, (String)localObject);
      break;
      a(localadsl.b, paramMessageRecord);
      break;
      if ((paramMessageRecord instanceof MessageForNearbyMarketGrayTips))
      {
        ...
        localadsl.b.setMovementMethod(LinkMovementMethod.getInstance());
        localadsl.b.setText(paramView);
        if (!asyu.a(paramMessageRecord, "isFaceScoreGrayTips")) {
          break;
        }
        if (asyu.a(paramMessageRecord, "isFaceScoreSecondMember"))
        {
          paramView = "2";
          if (!asyu.a(paramMessageRecord, "isFaceScoreSpecialLike")) {
            break label3181;
          }
        }
        for (paramLinearLayout = "2";; paramLinearLayout = "1")
        {
          asyu.a("exp_grey", paramMessageRecord.frienduin, new String[] { paramView, "", "", paramLinearLayout });
          break;
          paramView = "1";
          break label3123;
        }
      ...
      paramLinearLayout = ajyc.a(2131705306);
      paramView = apue.a(paramView.msg + paramLinearLayout, paramLinearLayout, new adrb(this));
      localadsl.b.setMovementMethod(LinkMovementMethod.getInstance());
      localadsl.b.setText(paramView);
      break;
      if (!(paramMessageRecord instanceof MessageForGrayTips)) {
      ...
      paramLinearLayout = ajyc.a(2131705314);
      paramView = apue.a(paramView.msg + paramLinearLayout, paramLinearLayout, new adre(this));
      localadsl.b.setMovementMethod(LinkMovementMethod.getInstance());
      localadsl.b.setText(paramView);
      break;
      if (!(paramMessageRecord instanceof MessageForGrayTips)) {
      ...
      paramLinearLayout = ajyc.a(2131705317);
      paramView = apue.a(paramView.msg + paramLinearLayout + ajyc.a(2131705307), paramLinearLayout, new adrf(this));
      localadsl.b.setMovementMethod(LinkMovementMethod.getInstance());
      localadsl.b.setText(paramView);
      break;
      ...
      ((MessageForQQWalletTips)paramMessageRecord).buildQQWalletTips(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, localadsl.b);
      break;
      localadsl.b.setText((CharSequence)localObject);
      localadsl.b.setOnTouchListener(paramacxn);
      localadsl.b.setOnLongClickListener(paramacxn);
      ...
      ((MessageForDeliverGiftTips)paramMessageRecord).buildDeliverGiftTips(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, localadsl.b);
      break;
      a(paramMessageRecord, localadsl.b);
      break;
      paramLinearLayout = bbwa.a();
      ...
      for (;;)
      {
        paramView = apue.a((String)localObject, paramView, new adrg(this, str2, str1, paramMessageRecord, str3, paramLinearLayout));
        localadsl.b.setText(paramView);
        if (e) {
          localadsl.b.setContentDescription(paramView);
        }
        ...
        localadsl.b.setHighlightColor(17170445);
        break;
        paramView = bbvz.a().b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        i = ((String)localObject).indexOf(paramView);
        paramView.length();
        if (i == -1) {}
        paramView = apue.a((String)localObject, paramView, new adrh(this));
        localadsl.b.setText(paramView);
        if (e) {
          localadsl.b.setContentDescription(paramView);
        }
        ...
        localadsl.b.setMovementMethod(LinkMovementMethod.getInstance());
        break;
        c(localadsl.b, paramMessageRecord);
        break;
        localadsl.b.setGravity(19);
        break label652;
      }
    }
  }
  ...
  public void a(View paramView, ChatMessage paramChatMessage, int paramInt)
  {
    if (paramInt == 890)
    {
      ...
      do
      {
        ...
        } while ((paramView == null) || (!(paramView instanceof adsl)));
        paramView = (adsl)paramView;
  ...
  {
    paramTextView.setText(BaseApplicationImpl.getContext().getString(2131719667));
    paramTextView.setContentDescription(BaseApplicationImpl.getContext().getString(2131719667));
  }
        ...
        catch (Exception localException1)
        {
          for (;;)
          {
            ...
            try
            {
              ...
              j = k;
              ((bankcode_info.BankcodeCtrlInfo)localObject3).mergeFrom(bbdm.a((String)localObject5));
              i = k;
              j = k;
            ...
            try
            {
              ...
              try
              {
                ...
                try
                {
                  localObject5 = paramTextView.getTag(2131375882);
                  ...
                  bool2 = bool1;
                  localObject5 = paramTextView.getTag(2131375881);
                  if (localObject5 == null) {
                    break label1027;
                  }
                  bool2 = bool1;
                ...
                {
                  axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Safe_SensMsg", localMessageRecord2.senderuin, "Tips_Show", "Mask", i, j, Long.toString(localMessageRecord2.msgUid), Long.toString(localMessageRecord2.uniseq), "", "");
                  paramTextView.setTag(2131375882, Boolean.valueOf(true));
                }
                if ((!bool2) && (((String)localObject3).equalsIgnoreCase("1")))
                {
                  axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Safe_SensMsg", localMessageRecord2.senderuin, "Tips_Show", "Show", i, j, Long.toString(localMessageRecord2.msgUid), Long.toString(localMessageRecord2.uniseq), "", "");
                  paramTextView.setTag(2131375881, Boolean.valueOf(true));
                }
                bbbl.a().a(null, "SensMsgTipsCfg", (String)localObject2, (String)localObject1);
                try
                {
  ...
  void a(TextView paramTextView, String paramString)
  {
    ...
    if ((paramString != null) && (paramString.length() > 0))
    {
      ...
      str1 = paramTextView.getResources().getString(2131720351);
    }
    for (;;)
    {
      label126:
      ...
      for (;;)
      {
        ...
        if ((str2.equals("1")) && (i < 0)) {
          i = paramString.indexOf(paramTextView.getResources().getString(2131720351));
        }
        for (;;)
        {
          ...
          paramString.setSpan(new adrn(this), i, ((String)localObject).length() + i, 33);
          paramTextView.setMovementMethod(LinkMovementMethod.getInstance());
          paramTextView.setText(paramString);
          return;
        }
  ...
  {
    bbbl.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "SensMsgTipsCfg");
    ...
    for (String str1 = paramMessageForSafeGrayTips.safeInfo.strFromMobile.get();; str1 = null)
    {
      ...
      for (String str2 = paramMessageForSafeGrayTips.safeInfo.strFromName.get();; str2 = null)
      {
        ...
        try
        {
          ...
          bbbl.a().a(null, "SensMsgTipsCfg", null, null);
          try
          {
  ...
  {
    SpannableString localSpannableString = apue.a(BaseApplicationImpl.getContext().getString(2131719665), BaseApplicationImpl.getContext().getString(2131719666), new adrj(this));
    paramTextView.setMovementMethod(LinkMovementMethod.getInstance());
    paramTextView.setText(localSpannableString);
    ...
    {
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "0X800994B", "0X800994B", 0, 0, "", "", "", "");
  ...
  public void b(TextView paramTextView, MessageRecord paramMessageRecord)
  {
    ...
    String str = ajyc.a(2131705329);
    SpannableString localSpannableString = new SpannableString(paramMessageRecord + str);
    localSpannableString.setSpan(new adsm(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext), paramMessageRecord.length(), (paramMessageRecord + str).length(), 33);
    paramTextView.setMovementMethod(LinkMovementMethod.getInstance());
    paramTextView.setText(localSpannableString);
  }
  ...
  {
    int j = paramString.indexOf(ajyc.a(2131705313)) - 1;
    int k = paramString.indexOf(ajyc.a(2131705328)) + 1;
    int i = j;
    if (j < 0) {
      i = 10;
    }
    paramString = new SpannableString(paramString);
    paramString.setSpan(new adsn(this, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString), i, k, 33);
  ...
  {
    Object localObject = this.jdField_a_of_type_AndroidContentContext.getString(2131698553);
    String str = paramTextView.getResources().getString(2131720351);
    ...
    localObject = new SpannableString((CharSequence)localObject);
    ((SpannableString)localObject).setSpan(new adrk(this), i, str.length() + i, 33);
    paramTextView.setMovementMethod(LinkMovementMethod.getInstance());
    paramTextView.setText((CharSequence)localObject);
  }
  ...
  {
    Object localObject = ajyc.a(2131705325);
    int j = ((String)localObject).indexOf(ajyc.a(2131705316));
    int i = j;
    if (j < 0) {
      i = 10;
    }
    localObject = new SpannableString((CharSequence)localObject);
    ((SpannableString)localObject).setSpan(new adso(this, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext), i, j + 5, 33);
    paramTextView.setMovementMethod(LinkMovementMethod.getInstance());
    paramTextView.setText((CharSequence)localObject);
  }
  ...
  {
    Object localObject = ajyc.a(2131705315);
    ...
    ((SpannableString)localObject).setSpan(new adsp(this, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext), 0, j, 33);
    paramTextView.setMovementMethod(LinkMovementMethod.getInstance());
    paramTextView.setText((CharSequence)localObject);
  }
}
