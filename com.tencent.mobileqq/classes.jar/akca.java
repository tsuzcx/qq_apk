  ...
  implements Comparator<PhoneContact>
{
  ...
  public akca(int[] paramArrayOfInt, Set<String> paramSet, ajxn paramajxn)
  {
    this.jdField_a_of_type_ArrayOfInt = paramArrayOfInt;
    this.jdField_a_of_type_JavaUtilSet = paramSet;
    this.jdField_a_of_type_Ajxn = paramajxn;
  }
  
  private int a(PhoneContact paramPhoneContact)
  {
    int j = bbcl.a(paramPhoneContact.detalStatusFlag, paramPhoneContact.iTermType);
    if ((j != 6) && (j != 0)) {}
  ...
  private int c(PhoneContact paramPhoneContact1, PhoneContact paramPhoneContact2)
  {
    ...
    boolean bool1 = this.jdField_a_of_type_Ajxn.a(paramPhoneContact1.unifiedCode, true);
    boolean bool2 = this.jdField_a_of_type_Ajxn.a(paramPhoneContact2.unifiedCode, true);
    if (bool1) {}
    for (;;)
    {
      return i;
