...
{
  ztc(ztb paramztb, int paramInt, zrt paramzrt) {}
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    this.jdField_a_of_type_Ztb.a.b();
    long l = paramLong;
    label92:
    int j;
    int i;
    ...
    for (;;)
    {
      for (;;)
      {
        if (i != -1)
        {
          ...
          bbmy.a(paramAdapterView, paramAdapterView.getString(i), 0).b(this.jdField_a_of_type_Int);
          return;
          l = 0L;
          break label92;
          l = 1L;
        ...
        try
        {
          ...
          zva.a(this.jdField_a_of_type_Zrt, paramAdapterView);
        ...
        catch (Exception paramAdapterView)
        {
          for (;;)
          {
            ...
            zva.a(localzrt, -1, paramAdapterView);
          }
        }
      }
      label316:
