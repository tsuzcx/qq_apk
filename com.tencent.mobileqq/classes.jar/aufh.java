...
public class aufh
{
  ...
  public static String a(aucm paramaucm)
  {
    String str = String.format("%s_%d", new Object[] { paramaucm.jdField_a_of_type_JavaLangString, Integer.valueOf(b(paramaucm.jdField_a_of_type_Int)) });
    if (!TextUtils.isEmpty(paramaucm.b)) {
      str = String.format("%s_%d_%s", new Object[] { paramaucm.jdField_a_of_type_JavaLangString, Integer.valueOf(b(paramaucm.jdField_a_of_type_Int)), paramaucm.b });
    }
    return aufb.c + str + ".db";
  }
  ...
  {
    arof.c(aufb.jdField_a_of_type_JavaLangString);
  }
  ...
  public static void a(MessageRecord paramMessageRecord, MsgBackupResEntity paramMsgBackupResEntity)
  {
    ...
    int i = ayvy.b(paramMessageRecord.msgUid);
  ...
  public static void a(MsgBackupMsgEntity paramMsgBackupMsgEntity)
  {
    if ((b) && (paramMsgBackupMsgEntity != null))
    {
      if (!TextUtils.isEmpty(paramMsgBackupMsgEntity.chatUin)) {
        paramMsgBackupMsgEntity.chatUin = MsgBackupJniProxy.decryptFromString(paramMsgBackupMsgEntity.chatUin, aucf.c);
      }
      if (paramMsgBackupMsgEntity.extraData != null) {
        paramMsgBackupMsgEntity.extraData = MsgBackupJniProxy.decryptFromByteArray(paramMsgBackupMsgEntity.extraData, aucf.c);
      }
      if (paramMsgBackupMsgEntity.extensionData != null) {
        paramMsgBackupMsgEntity.extensionData = MsgBackupJniProxy.decryptFromByteArray(paramMsgBackupMsgEntity.extensionData, aucf.c);
      }
    }
  }
  ...
  {
    if ((b) && (paramMsgBackupResEntity != null) && (paramMsgBackupResEntity.extraData != null) && (aucf.b != null)) {
      paramMsgBackupResEntity.extraData = MsgBackupJniProxy.encryptFromByteArray(paramMsgBackupResEntity.extraData, aucf.b);
    }
  }
  
  public static void a(String paramString, aucm paramaucm)
  {
    paramString = paramString.substring(0, paramString.indexOf(".")).split("_");
    paramaucm.jdField_a_of_type_JavaLangString = paramString[0];
    paramaucm.jdField_a_of_type_Int = c(Integer.parseInt(paramString[1]));
    if (paramString.length > 2) {
      paramaucm.b = paramString[2];
    }
  }
  ...
  public static boolean a()
  {
    ...
    for (;;)
    {
      ...
      if (bool2)
      {
        File localFile = new File(aufb.b);
  ...
  public static long b(MessageRecord paramMessageRecord)
  {
    ...
    return ayvy.b(paramMessageRecord.msgUid);
  }
  ...
  {
    if ((b) && (paramMsgBackupMsgEntity != null) && (aucf.b != null))
    {
      if (!TextUtils.isEmpty(paramMsgBackupMsgEntity.chatUin)) {
        paramMsgBackupMsgEntity.chatUin = MsgBackupJniProxy.encryptFromString(paramMsgBackupMsgEntity.chatUin, aucf.b);
      }
      if (paramMsgBackupMsgEntity.extraData != null) {
        paramMsgBackupMsgEntity.extraData = MsgBackupJniProxy.encryptFromByteArray(paramMsgBackupMsgEntity.extraData, aucf.b);
      }
      if (paramMsgBackupMsgEntity.extensionData != null) {
        paramMsgBackupMsgEntity.extensionData = MsgBackupJniProxy.encryptFromByteArray(paramMsgBackupMsgEntity.extensionData, aucf.b);
      }
    }
  }
  ...
  {
    if ((b) && (paramMsgBackupResEntity != null) && (paramMsgBackupResEntity.extraData != null) && (aucf.c != null)) {
      paramMsgBackupResEntity.extraData = MsgBackupJniProxy.decryptFromByteArray(paramMsgBackupResEntity.extraData, aucf.c);
    }
  }
