  ...
  extends mnz
{
  ...
  {
    lbc.c(this.jdField_a_of_type_JavaLangString, "getSPEED: " + this.i);
    return this.i;
  }
  ...
  protected void a(Canvas paramCanvas, int paramInt1, int paramInt2)
  {
    ...
    paramCanvas.drawText((String)this.jdField_a_of_type_Lga.a, 0.0F, f1, this.jdField_a_of_type_AndroidGraphicsPaint);
    this.jdField_a_of_type_AndroidGraphicsPaint.setStyle(Paint.Style.FILL_AND_STROKE);
    ...
    float f2 = this.jdField_a_of_type_Mnv.jdField_a_of_type_Float / 6.0F;
    paramCanvas.drawText((String)this.jdField_a_of_type_Lga.a, 0.0F + f2, f1 - f2, this.jdField_a_of_type_AndroidGraphicsPaint);
  }
}
