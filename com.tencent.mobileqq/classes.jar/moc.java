...
public class moc
  implements Runnable
{
  public moc(FastWebVideoFeedsPlayManager paramFastWebVideoFeedsPlayManager) {}
  ...
  public void run()
  {
    ...
    do
    {
      do
      {
        ...
        ((ThirdVideoManager)localObject3).a(((FastWebVideoFeedsPlayManager.VideoPlayParam)localObject2).jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebVideoFastWebVideoInfo.jdField_a_of_type_JavaLangString, "PubAccountArticleCenter.GetUrlByVid", new mod(this, (VideoPlayerWrapper)localObject1, l, (ThirdVideoManager)localObject3));
        return;
