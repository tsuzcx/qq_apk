...
public class bdgb
{
  ...
  {
    new biib("QC.HomepageLogicServer.HomepageLogicObj", "QcHomePageLogic.GetConciseThemeReq", "stReq", "stRsp").a("GetConciseTheme", new GetConciseThemeReq(biib.a()), new GetConciseThemeRsp(), new bdgc(paramString, paramAppInterface, paramBoolean), false);
  }
      ...
      if (true == jdField_a_of_type_Boolean)
      {
        ...
        for (;;)
        {
          ...
          if ((ImmersiveUtils.isSupporImmersive() != 0) && (paramImmersiveTitleBar2 != null)) {
            paramImmersiveTitleBar2.setBackgroundColor(BaseApplicationImpl.getApplication().getResources().getColor(2131167048));
          }
        }
      }
      ...
      if (true == jdField_a_of_type_Boolean)
      {
        ...
        for (;;)
        {
          ...
          if ((ImmersiveUtils.isSupporImmersive() != 0) && (paramSystemBarCompact != null)) {
            paramSystemBarCompact.setStatusBarColor(2131167048);
          }
        }
      }
  ...
  private static final void a(String paramString)
  {
    ...
    {
      localObject = (bdfv)((QQAppInterface)localObject).a(154);
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      ((bdfv)localObject).a(bool, i);
      ((bdfv)localObject).notifyUI(4, true, new Object[] { Boolean.valueOf(bool), Integer.valueOf(i), paramString });
