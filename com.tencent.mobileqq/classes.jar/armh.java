  ...
  implements Manager
{
  ...
  public armh(QQAppInterface paramQQAppInterface)
  {
  ...
  public static armh a(QQAppInterface paramQQAppInterface)
  {
    return (armh)paramQQAppInterface.getManager(349);
  }
  ...
  {
    return ajed.M.equals(paramString);
  }
  ...
  private Bitmap b(String paramString)
  {
    ...
    String str = axoa.d(paramString);
    Object localObject = new File(str);
    long l1 = SystemClock.uptimeMillis();
    localObject = new batm(paramString, (File)localObject);
    ((batm)localObject).n = true;
    ((batm)localObject).b = 2;
    ((batm)localObject).a = str;
    ((batm)localObject).b(512);
    int i = bato.a((batm)localObject, null, null);
    long l2 = SystemClock.uptimeMillis();
    if (QLog.isColorLevel()) {
      QLog.i("NewMsgNotificationManager", 2, "download cost " + (l2 - l1) + " result " + i + " key " + ((batm)localObject).a + " iconUrl: " + paramString);
    }
  ...
  {
    Intent localIntent = badh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp());
  ...
  {
    this.jdField_a_of_type_AndroidWidgetCompoundButton$OnCheckedChangeListener = new armi(this, paramNotifyPushSettingActivity, paramFormSwitchItem);
  ...
  {
    armk localarmk = new armk(this);
    arml localarml = new arml(this, paramBaseActivity);
    babr.a(paramBaseActivity, 230, null, paramBaseActivity.getString(2131628057), paramBaseActivity.getString(2131625035), paramBaseActivity.getString(2131628056), localarml, localarmk).show();
  }
  ...
  public void a(BaseActivity paramBaseActivity, TextView paramTextView)
  {
    ...
    String str = ((Resources)localObject).getString(2131629610);
    localObject = new SpannableString(str + "允许QQ通知" + ((Resources)localObject).getString(2131629611));
    ((SpannableString)localObject).setSpan(new armj(this, paramBaseActivity), str.length(), (str + "允许QQ通知").length(), 17);
