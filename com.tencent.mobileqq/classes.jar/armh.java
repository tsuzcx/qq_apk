...
public final class armh
{
  ...
  public armh(WebViewPlugin paramWebViewPlugin)
  {
  ...
  private AppActivity a()
  {
    ...
    label38:
    for (Object localObject = null;; localObject = ((bhod)localObject).a())
    {
  ...
  private void b()
  {
    ...
    localAppActivity.requestPermissions(new armi(this), 1819, new String[] { "android.permission.CAMERA" });
    if (this.jdField_a_of_type_AndroidOsHandler == null) {
      this.jdField_a_of_type_AndroidOsHandler = new armj(this, Looper.getMainLooper());
    }
