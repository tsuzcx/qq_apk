...
public final class rgl
{
  private final void a(Readinjoy.ArticleSummary paramArticleSummary, WeiShiVideoArticleInfo paramWeiShiVideoArticleInfo)
  {
    if (paramArticleSummary.msg_video_data.has())
    {
      ...
      paramArticleSummary.jdField_a_of_type_JavaLangString = psy.a(paramWeiShiVideoArticleInfo);
      ...
      paramArticleSummary.jdField_b_of_type_JavaLangString = psy.a(paramWeiShiVideoArticleInfo);
    }
  }
  ...
  private final void a(oidb_cmd0xbed.ArticleSummary paramArticleSummary, WeiShiVideoArticleInfo paramWeiShiVideoArticleInfo)
  {
    if (paramArticleSummary.rpt_article_list.has())
    {
      ...
      if (i < m)
      {
        ...
        SimpleChannelInfo localSimpleChannelInfo = sdu.a(paramArticleSummary.msg_channel_info);
        int j;
        ...
        {
          localObject = (BaseVideoArticleInfo)sdu.a((oidb_cmd0xbed.ArticleSummary)localObject, j, k);
          if (localObject != null) {
  ...
  private final void b(oidb_cmd0xbed.ArticleSummary paramArticleSummary, WeiShiVideoArticleInfo paramWeiShiVideoArticleInfo)
  {
    if (paramArticleSummary.rpt_label_list.has())
    {
      ...
      {
        SimpleChannelInfo localSimpleChannelInfo = sdu.a((oidb_cmd0xbed.ChannelInfo)paramArticleSummary.next());
        if (localSimpleChannelInfo != null) {
  ...
  private final void c(Readinjoy.ArticleSummary paramArticleSummary, WeiShiVideoArticleInfo paramWeiShiVideoArticleInfo)
  {
    if (paramArticleSummary.rpt_label_list.has())
    {
      ...
      while (paramArticleSummary.hasNext())
      {
        ...
        paramWeiShiVideoArticleInfo.labelList.add(sdu.a(localChannelInfo));
      }
    }
  }
  ...
  public final WeiShiVideoArticleInfo a(@Nullable Readinjoy.ArticleSummary paramArticleSummary)
  {
    ...
    try
    {
      ...
      localWeiShiVideoArticleInfo.rowkey = psy.a(localPBBytesField);
      ...
      for (;;)
      {
        ...
        localWeiShiVideoArticleInfo.title = psy.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.summary = psy.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.pagePicUrl = psy.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.articleContentUrl = psy.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.subscribeName = psy.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.subscribeIcon = psy.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.subscribeID = psy.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.recommendReason = psy.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.pushContext = psy.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.adsJumpUrl = psy.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.videoReportInfo = psy.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.businessInfo = psy.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.videoSubscriptTxt = psy.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.videoSubscriptColor = psy.a(localPBBytesField);
        ((rgl)this).c(paramArticleSummary, localWeiShiVideoArticleInfo);
        ((rgl)this).b(paramArticleSummary, localWeiShiVideoArticleInfo);
        ((rgl)this).a(paramArticleSummary, localWeiShiVideoArticleInfo);
    ...
    if (paramArticleSummary != null)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          Intrinsics.checkExpressionValueIsNotNull(localPBBytesField, "summary.bytes_video_subscript_color");
          localWeiShiVideoArticleInfo.videoSubscriptColor = psy.a(localPBBytesField);
          ((rgl)this).d(paramArticleSummary, localWeiShiVideoArticleInfo);
          ((rgl)this).c(paramArticleSummary, localWeiShiVideoArticleInfo);
          ((rgl)this).b(paramArticleSummary, localWeiShiVideoArticleInfo);
          ((rgl)this).a(paramArticleSummary, localWeiShiVideoArticleInfo);
        }
        catch (Throwable paramArticleSummary)
        {
          ...
          QLog.e("VideoProtoHelper", 0, "cmd0xbedToWeiShiVideoArticleInfo error:" + pay.a(paramArticleSummary));
          continue;
        }
        return localWeiShiVideoArticleInfo;
        bool = false;
