  ...
  implements Runnable
{
  ...
  public thp(QQSettingCleanActivity paramQQSettingCleanActivity, int paramInt)
  {
  ...
  public void run()
  {
    ...
    case 2: 
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityQQSettingCleanActivity.jdField_b_of_type_AndroidWidgetButton.setText(this.jdField_a_of_type_ComTencentMobileqqActivityQQSettingCleanActivity.getString(2131435402));
      return;
    case 3: 
    ...
    case 4: 
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityQQSettingCleanActivity.jdField_b_of_type_AndroidWidgetButton.setText(this.jdField_a_of_type_ComTencentMobileqqActivityQQSettingCleanActivity.getString(2131435401));
      return;
    }
    ...
    for (String str = "0M";; str = QQSettingCleanActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQSettingCleanActivity, this.jdField_a_of_type_ComTencentMobileqqActivityQQSettingCleanActivity.jdField_d_of_type_Long))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityQQSettingCleanActivity.jdField_b_of_type_AndroidWidgetButton.setEnabled(true);
      this.jdField_a_of_type_ComTencentMobileqqActivityQQSettingCleanActivity.jdField_b_of_type_AndroidWidgetButton.setBackgroundResource(2130838487);
      this.jdField_a_of_type_ComTencentMobileqqActivityQQSettingCleanActivity.jdField_b_of_type_AndroidWidgetButton.setTextColor(this.jdField_a_of_type_ComTencentMobileqqActivityQQSettingCleanActivity.getResources().getColor(2131494229));
      return;
