...
public class avba
{
  ...
  private Animation.AnimationListener jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener = new avbb(this);
  ...
  public avba(View paramView)
  {
    if (paramView != null)
    {
      this.jdField_a_of_type_AndroidViewView = paramView;
      this.jdField_a_of_type_Int = baxn.a(this.jdField_a_of_type_AndroidViewView.getContext(), 15.0F);
