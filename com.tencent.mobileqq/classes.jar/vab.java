  ...
  implements aaga, View.OnClickListener, zwr
{
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_ComTencentBizQqcircleWidgetsQCircleRecommendImageView.setReportListener(new vac(this));
    zwp.a().a(this);
  }
  ...
  private void a(FeedCloudMeta.StComment paramStComment, FeedCloudMeta.StReply paramStReply)
  {
    ...
    this.jdField_a_of_type_Vth = new vad(this, paramStComment);
    vtd.a().a(a(), paramStReply, this.jdField_a_of_type_Vth, b());
  }
  ...
  private void b()
  {
    vah localvah = new vah(this);
    this.jdField_a_of_type_ComTencentBizQqcircleUtilsQCircleSlidBottomView.setOnClickListener(localvah);
    this.jdField_a_of_type_ComTencentBizQqcircleUtilsQCircleSlidBottomView.setStatusListener(new vai(this));
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(localvah);
  }
  ...
  private void b(int paramInt)
  {
    if (b())
    {
      vrg.a(paramInt, 2, this.jdField_a_of_type_ComTencentBizSubscribeBaseUIExtraTypeInfo, a());
      return;
    }
    vrc.a(paramInt, 2, this.jdField_a_of_type_ComTencentBizSubscribeBaseUIExtraTypeInfo, b());
  }
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_ComTencentBizQqcirclePolylikeQCirclePolyLikeFrameLayout.setOnClickHookListener(new vaj(this));
    ...
    if (this.jdField_a_of_type_Zxl != null) {
      this.jdField_a_of_type_ComTencentBizQqcirclePolylikeQCirclePolyLikeFrameLayout.setReportBeanAgent(this.jdField_a_of_type_Zxl);
    }
  ...
  private void c(int paramInt)
  {
    if (this.jdField_b_of_type_AndroidWidgetTextView != null)
    {
      if (paramInt > 0)
      {
        this.jdField_b_of_type_AndroidWidgetTextView.setText(uxx.d(paramInt));
  ...
  private void c(View paramView)
  {
    ...
    this.jdField_a_of_type_Uyc.setOnLoadDataDelegate(new vaf(this));
    this.jdField_a_of_type_Uyc.addOnScrollListener(new vag(this));
  ...
  private void f()
  {
    ...
    do
    {
      ...
      do
      {
        ...
        localTextView = (TextView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131371338);
  ...
  private void g()
  {
    this.jdField_a_of_type_Aage = new aage(this.jdField_a_of_type_AndroidWidgetRelativeLayout);
    this.jdField_a_of_type_Aage.a(new vae(this));
  }
  ...
  public void a(View paramView, int paramInt1, int paramInt2, Object paramObject)
  {
    ...
    case 14: 
      ...
      for (;;)
      {
        vrr.a().a(new vrt().a("likecommentbutton").b("likecomment").a(this.jdField_a_of_type_Uzc.jdField_a_of_type_FeedcloudFeedCloudMeta$StFeed).a(a()).a(c()).c(paramView));
        return;
    ...
    for (;;)
    {
      vrr.a().a(new vrt().a("likecommentbutton").b("unlikecomment").a(this.jdField_a_of_type_Uzc.jdField_a_of_type_FeedcloudFeedCloudMeta$StFeed).a(a()).a(c()).c(paramView));
      return;
      paramView = (View)localObject;
      if ((paramObject instanceof Object[]))
      {
  ...
  public void a(String paramString, Object paramObject)
  {
    if (paramString.equals("comment_panel_show"))
    {
      ...
      {
        this.jdField_a_of_type_Uzc = ((uzc)paramObject);
        this.jdField_a_of_type_ComTencentBizQqcircleFragmentsQCircleBlockContainer.a().e();
        a(this.jdField_a_of_type_Uzc.jdField_a_of_type_FeedcloudFeedCloudMeta$StFeed);
        a(this.jdField_a_of_type_Uzc.jdField_a_of_type_ComTencentBizSubscribeBaseUIExtraTypeInfo);
        if ((this.jdField_a_of_type_FeedcloudFeedCloudMeta$StFeed != null) && (!TextUtils.equals(this.jdField_a_of_type_FeedcloudFeedCloudMeta$StFeed.id.get(), a().id.get())) && (this.jdField_a_of_type_Uyc.getItemCount() > 0))
        {
          this.jdField_a_of_type_ComTencentBizQqcircleFragmentsQCircleBlockContainer.a().scrollToPosition(0);
          this.jdField_a_of_type_Uyc.clearData();
        }
        a(false);
        e();
        a(this.jdField_a_of_type_Uzc.c);
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
        if (this.jdField_a_of_type_Uzc.b == uzc.d) {
      ...
      zwp.a().a(new QCircleDanmakuEvent(7, true));
    }
    do
    {
      do
      ...
      return;
    } while ((!paramString.equals("comment_input_window_show")) || (!(paramObject instanceof uzc)));
    this.jdField_a_of_type_Uzc = ((uzc)paramObject);
    a(this.jdField_a_of_type_Uzc.jdField_a_of_type_FeedcloudFeedCloudMeta$StFeed);
    a(this.jdField_a_of_type_Uzc.jdField_a_of_type_ComTencentBizSubscribeBaseUIExtraTypeInfo);
    a(this.jdField_a_of_type_Uzc.c);
    a(this.jdField_a_of_type_Uzc.jdField_a_of_type_FeedcloudFeedCloudMeta$StComment, this.jdField_a_of_type_Uzc.jdField_a_of_type_FeedcloudFeedCloudMeta$StReply);
  }
  ...
  {
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131364799));
    this.jdField_a_of_type_ComTencentBizQqcircleUtilsQCircleSlidBottomView = ((QCircleSlidBottomView)paramView.findViewById(2131373782));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131373783));
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)paramView.findViewById(2131373779));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131364787));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131378525));
    this.jdField_a_of_type_ComTencentBizQqcirclePolylikeQCirclePolyLikeFrameLayout = ((QCirclePolyLikeFrameLayout)paramView.findViewById(2131369361));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131369087));
    this.jdField_a_of_type_ComTencentBizQqcircleWidgetsQCircleRecommendImageView = ((QCircleRecommendImageView)paramView.findViewById(2131369236));
    this.jdField_a_of_type_ComTencentBizQqcircleWidgetsQCircleRocketView = ((QCircleRocketView)paramView.findViewById(2131364798));
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131364768));
  }
  ...
  public void b(View paramView, int paramInt1, int paramInt2, Object paramObject)
  {
    ...
    do
    {
      do
      {
        ...
        uxp.a().a(paramView, a(), paramObject, new val(this, paramObject), localvak);
        return;
      } while (!(paramObject instanceof Object[]));
      localObject = (Object[])paramObject;
    ...
    uxp.a().a(paramView, a(), (FeedCloudMeta.StReply)localObject, new vas(this, (FeedCloudMeta.StReply)localObject, paramObject), localvak);
  }
                  ...
                  do
                  {
                    do
                    {
                      do
                      {
                        ...
                        e();
                      } while (this.jdField_a_of_type_Uyc == null);
                      ...
                      return;
                    } while ((!paramSimpleBaseEvent.feedId.equals(c())) || (this.jdField_a_of_type_Uyc == null) || (paramSimpleBaseEvent.commentList == null));
