  ...
  extends ammq
{
  ...
  {
    SharedPreferences localSharedPreferences = amhd.a();
  ...
  {
    if ((paramamux == null) || (paramAppInterface == null) || (paramContext == null))
    {
    ...
    paramContext = ((amhd)paramAppInterface.getManager(153)).a((QQAppInterface)paramAppInterface, paramAppInterface.getCurrentAccountUin(), new int[] { 2, 4 });
    if (paramContext != null)
    {
      ...
      amuo.a(paramamux, 12, paramContext);
    }
    for (;;)
    {
      return 0;
      ...
      amuo.a(paramamux, 5, paramAppInterface);
    }
  }
}
