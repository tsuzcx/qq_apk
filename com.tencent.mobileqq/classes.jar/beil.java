  ...
  extends WebViewPlugin
{
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2, String paramString)
  {
    ...
    if (localWebViewFragment != null)
    {
      ...
      localImageView.setImageResource(2130844379);
      int k;
      if (localWebViewFragment.a.b != null)
      {
        ...
        localImageView.setPadding(j, k, aekt.a(i, this.jdField_a_of_type_ComTencentSmttSdkWebView.getResources()) + m, localImageView.getPaddingBottom());
      }
      label388:
      for (;;)
      {
        localImageView.setOnClickListener(new beim(this, paramString));
        return;
