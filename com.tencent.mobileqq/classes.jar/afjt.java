...
public abstract class afjt
{
  public static final int[] a;
  public static final int[] b;
  public static final int[] c = { 2131369914 };
  public aipn a;
  protected Context a;
  public atza a;
  protected bfwd a;
  ...
  public afjt(Context paramContext, QQAppInterface paramQQAppInterface, aipn paramaipn, atza paramatza)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Aipn = paramaipn;
  ...
  public static void a(TextView paramTextView, int paramInt1, int paramInt2, StringBuilder paramStringBuilder)
  {
    ...
    {
    default: 
      paramTextView.setBackgroundResource(2130845022);
      j = 0;
      i = 0;
    }
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (i != 0)
        {
          ...
          break;
          j = 2130845019;
          paramTextView.setBackgroundResource(2130845020);
          i = j;
          if (paramStringBuilder == null) {
            break label231;
          }
  ...
  protected View a(Context paramContext, int paramInt, afjv paramafjv)
  {
    View localView = LayoutInflater.from(paramContext).inflate(paramInt, null);
    if (this.jdField_a_of_type_Aipn != null) {
      return this.jdField_a_of_type_Bfwd.a(paramContext, localView, paramafjv, -1);
    }
    paramafjv.g = localView;
    paramafjv.a = null;
    return localView;
  }
  ...
  protected bfwd a(Context paramContext)
  {
    ...
    return new afju(this, 1, 2, new int[] { i, j }, -1, paramContext, arrayOfInt1, arrayOfInt2);
  }
  ...
  protected void a(Context paramContext, View paramView, int paramInt, Object paramObject, bfwe parambfwe, View.OnClickListener paramOnClickListener)
  {
    ...
    {
      if ((this.jdField_a_of_type_Aipn != null) && (this.jdField_a_of_type_Aipn.a != -1))
      {
        if (paramInt != this.jdField_a_of_type_Aipn.a) {
  ...
  protected void a(View paramView)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (!bbbr.a(paramView, this.jdField_a_of_type_AndroidContentContext.getResources().getString(jdField_a_of_type_ArrayOfInt[0]))) {
          continue;
        }
        a();
        return;
  ...
  public void a(View paramView, int paramInt)
  {
    ...
    {
      return;
      localView = paramView.findViewById(2131375335);
