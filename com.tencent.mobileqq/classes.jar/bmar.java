...
public final class bmar
{
  ...
  public static ContentValues a(AppInterface paramAppInterface, FileManagerEntity paramFileManagerEntity, String paramString, boolean paramBoolean)
  {
    ...
    for (paramString = new File(str1);; paramString = null)
    {
      ...
      for (;;)
      {
        ...
        {
          new ContentValues().put("errorMsg", BaseApplicationImpl.getContext().getResources().getString(2131692144));
          return null;
          i = auea.a(paramFileManagerEntity);
          break;
          if (paramString == null) {
            break label633;
          }
        ...
        {
        default: 
          new ContentValues().put("errorMsg", BaseApplicationImpl.getContext().getResources().getString(2131692146));
          return null;
        case 1: 
          if ((paramFileManagerEntity.lastTime > 0L) && (paramFileManagerEntity.lastTime <= System.currentTimeMillis() / 1000L))
          {
            new ContentValues().put("errorMsg", BaseApplicationImpl.getContext().getResources().getString(2131692143));
            return null;
          }
          break;
        case 4: 
  ...
  public static bdqa a(StructMsgForImageShare paramStructMsgForImageShare)
  {
    if (paramStructMsgForImageShare.getItemCount() > 0)
    {
      paramStructMsgForImageShare = paramStructMsgForImageShare.getItemByIndex(0);
      if ((paramStructMsgForImageShare instanceof bdry))
      {
        paramStructMsgForImageShare = (bdry)paramStructMsgForImageShare;
        if ((paramStructMsgForImageShare.a.size() > 0) && ((paramStructMsgForImageShare.a.get(0) instanceof bdqa))) {
          return (bdqa)paramStructMsgForImageShare.a.get(0);
        }
      }
    }
    return null;
  ...
  public static bmam a(byte[] paramArrayOfByte)
  {
    if ((paramArrayOfByte == null) || (paramArrayOfByte.length <= 16)) {
      return null;
    }
    ...
    if ((localObject2 instanceof ChatMessage))
    {
      if ((localObject2 instanceof MessageForStructing))
      {
        ...
        {
          localObject1 = bdof.a((byte[])localObject1);
          ((MessageForStructing)localObject2).structingMsg = ((AbsStructMsg)localObject1);
        }
        return new bmam((ChatMessage)localObject2, paramArrayOfByte);
      }
      return new bmam((ChatMessage)localObject2, paramArrayOfByte);
    }
    return null;
  ...
  public static List<bmal> a(List<byte[]> paramList)
  {
    if ((paramList == null) || (paramList.size() == 0)) {
      return null;
    }
    ...
    while (paramList.hasNext())
    {
      ...
      if (l1 != 2L)
      {
        ...
        if (l1 == 1L)
        {
          ...
          if (localObject != null) {
            localArrayList.add(new bmal(l2, l1, ((bmam)localObject).jdField_a_of_type_ComTencentMobileqqDataChatMessage, ((bmam)localObject).jdField_a_of_type_JavaLangString));
        ...
        else if (l1 == 3L)
        {
          ...
          localObject = a((byte[])localObject);
          if (localObject != null) {
            localArrayList.add(new bmal(l2, l1, (ContentValues)localObject));
          }
        }
      }
    }
  ...
  public static void a(long paramLong, List<bmal> paramList1, List<bmal> paramList2)
  {
    ...
    for (;;)
    {
      ...
      {
        bmal localbmal = (bmal)paramList1.next();
        if (localbmal.b == paramLong) {
          paramList2.add(localbmal);
        }
      }
    }
  }
  ...
  public static void a(Context paramContext, int paramInt1, int paramInt2)
  {
    ...
    paramInt1 = paramContext.getResources().getDimensionPixelSize(2131299080) - (int)bhdz.a(paramContext, 5.0F);
  ...
  public static void a(Context paramContext, String paramString, int paramInt)
  {
    ...
    paramInt = paramContext.getResources().getDimensionPixelSize(2131299080) - (int)bhdz.a(paramContext, 5.0F);
    paramContext = Looper.getMainLooper();
    if (Thread.currentThread() != paramContext.getThread())
    {
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageForStructing paramMessageForStructing, List<ChatMessage> paramList, Map<String, String> paramMap, ArrayList<byte[]> paramArrayList)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramList = (String)paramMap.get(acnh.c(localChatMessage));
        ...
        continue;
        paramList = axio.a().a(paramQQAppInterface, paramMessageForStructing.uniseq);
      }
  ...
  public static byte[] a(QQAppInterface paramQQAppInterface, long paramLong, ChatMessage paramChatMessage, String paramString)
  {
    ...
    if (TextUtils.isEmpty(paramString)) {
      str = agit.a(paramQQAppInterface, paramChatMessage);
    }
  ...
  public static String[] a(byte[] paramArrayOfByte)
  {
    ...
    //   0: aconst_null
    //   1: astore 4
    //   3: invokestatic 929	javax/xml/parsers/DocumentBuilderFactory:newInstance	()Ljavax/xml/parsers/DocumentBuilderFactory;
    //   6: astore 5
    //   8: aload 5
    //   10: invokevirtual 933	javax/xml/parsers/DocumentBuilderFactory:newDocumentBuilder	()Ljavax/xml/parsers/DocumentBuilder;
    //   13: new 935	java/io/ByteArrayInputStream
    //   16: dup
    //   17: aload_0
    //   18: invokespecial 938	java/io/ByteArrayInputStream:<init>	([B)V
    //   21: invokevirtual 944	javax/xml/parsers/DocumentBuilder:parse	(Ljava/io/InputStream;)Lorg/w3c/dom/Document;
    //   24: invokeinterface 950 1 0
    //   29: astore 5
    //   31: aload 4
    //   33: astore_0
    //   34: aconst_null
    ...
    //   41: aload 5
    //   43: ldc_w 952
    //   46: invokeinterface 957 2 0
    //   51: astore_0
    //   52: aload 5
    //   54: invokeinterface 958 1 0
    //   59: astore 26
    //   61: aload 26
    ...
    //   254: aload 28
    //   256: ldc_w 962
    //   259: invokevirtual 965	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   262: ifeq +1246 -> 1508
    //   265: aload 4
    //   267: astore 16
    //   269: aload 5
    ...
    //   507: astore 21
    //   509: aload 9
    //   511: invokeinterface 961 1 0
    //   516: ldc_w 967
    //   519: invokevirtual 965	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   522: ifeq +160 -> 682
    //   525: aload 4
    //   527: astore 16
    //   529: aload 5
    ...
    //   643: astore 21
    //   645: aload 9
    //   647: invokeinterface 971 1 0
    //   652: ldc_w 973
    //   655: invokeinterface 979 2 0
    ...
    //   728: astore 21
    //   730: aload 9
    //   732: invokeinterface 961 1 0
    //   737: ldc_w 981
    //   740: invokevirtual 965	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   743: ifeq +145 -> 888
    //   746: aload 4
    //   748: astore 16
    //   750: aload 5
    ...
    //   864: astore 21
    //   866: aload 9
    //   868: invokestatic 983	bmar:a	(Lorg/w3c/dom/Node;)Ljava/lang/String;
    //   871: astore 25
    //   873: aload 4
    //   875: astore 23
    //   877: aload 5
    ...
    //   934: astore 21
    //   936: aload 9
    //   938: invokeinterface 961 1 0
    //   943: ldc_w 985
    //   946: invokevirtual 965	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   949: ifeq +145 -> 1094
    //   952: aload 4
    //   954: astore 16
    //   956: aload 5
    ...
    //   1070: astore 21
    //   1072: aload 9
    //   1074: invokestatic 983	bmar:a	(Lorg/w3c/dom/Node;)Ljava/lang/String;
    //   1077: astore 24
    //   1079: aload 4
    //   1081: astore 23
    //   1083: aload 5
    ...
    //   1156: astore 25
    //   1158: aload 9
    //   1160: invokeinterface 961 1 0
    //   1165: ldc_w 987
    //   1168: invokevirtual 965	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   1171: ifeq +886 -> 2057
    //   1174: aload 4
    //   1176: astore 16
    //   1178: aload 5
    ...
    //   1576: aload 28
    //   1578: ldc_w 991
    //   1581: invokevirtual 965	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   1584: ifeq +165 -> 1749
    //   1587: aload 4
    //   1589: astore 22
    //   1591: aload 5
    ...
    //   1709: astore 21
    //   1711: aload 27
    //   1713: invokeinterface 971 1 0
    //   1718: ldc_w 993
    //   1721: invokeinterface 979 2 0
    ...
    //   1834: astore 7
    //   1836: aload 9
    //   1838: invokevirtual 994	javax/xml/parsers/ParserConfigurationException:printStackTrace	()V
    //   1841: aload 6
    //   1843: astore 9
    //   1845: goto -63 -> 1782
    //   1848: astore 9
    ...
    //   1865: astore 7
    //   1867: aload 9
    //   1869: invokevirtual 995	org/xml/sax/SAXException:printStackTrace	()V
    //   1872: aload 6
    //   1874: astore 9
    //   1876: goto -94 -> 1782
    //   1879: astore 9
    ...
    //   1896: astore 7
    //   1898: aload 9
    //   1900: invokevirtual 996	java/io/IOException:printStackTrace	()V
    //   1903: aload 6
    //   1905: astore 9
    //   1907: goto -125 -> 1782
    //   1910: astore 9
  ...
  public static byte[] b(QQAppInterface paramQQAppInterface, long paramLong, ChatMessage paramChatMessage, String paramString)
  {
    ...
    if (((paramChatMessage instanceof MessageForTroopFile)) || ((paramChatMessage instanceof MessageForFile)))
    {
      ...
      localObject = agit.a(paramQQAppInterface, paramChatMessage);
      a((FileManagerEntity)localObject);
      if (localObject == null) {
        break label221;
      }
      localbmad.a(paramQQAppInterface, null, (FileManagerEntity)localObject, paramChatMessage, true);
    }
    for (;;)
    {
      paramQQAppInterface = new ContentValues();
      localObject = (ContentValues)localbmad.a().getExtras().getParcelable("fileContents");
      if (localObject != null) {
        paramQQAppInterface.put("fileContents", a((ContentValues)localObject));
      }
      localObject = acnh.c(paramChatMessage);
      ...
      localObject = auea.a(paramQQAppInterface, (MessageForFile)paramChatMessage);
      break;
      label221:
      label490:
      if (QLog.isColorLevel())
      {
        ...
        if ((paramChatMessage instanceof MessageForTroopFile))
        {
          ...
          {
            a((FileManagerEntity)localObject);
            agit.a((FileManagerEntity)localObject, localMessageForTroopFile);
            if (localObject == null) {
              break label490;
            }
            localbmad.a(paramQQAppInterface, null, (FileManagerEntity)localObject, localMessageForTroopFile, true);
            break;
            if (QLog.isColorLevel()) {
              QLog.d("qqfav", 2, "parcelFileMsg, isMultiMsg T, find in db");
            }
            localObject = bgke.a(paramQQAppInterface, localMessageForTroopFile);
            if (localObject != null)
            {
              FileManagerEntity localFileManagerEntity = agit.a((bfjs)localObject);
              localObject = bgjh.a(paramQQAppInterface, ((bfjs)localObject).b);
              if ((localObject != null) && (localFileManagerEntity != null) && (!TextUtils.isEmpty(localFileManagerEntity.strTroopFilePath)))
              {
                bfif localbfif = ((bgjh)localObject).a(localFileManagerEntity.strTroopFilePath);
                localObject = localFileManagerEntity;
                if (localbfif != null)
                {
                  localFileManagerEntity.lastTime = localbfif.c;
                  localFileManagerEntity.selfUin = String.valueOf(localbfif.b);
                  localObject = localFileManagerEntity;
                }
              }
              else
