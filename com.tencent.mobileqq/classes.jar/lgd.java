...
public class lgd
  implements lgc
{
  private static final lgf jdField_a_of_type_Lgf = new lge();
  ...
  private final lid jdField_b_of_type_Lid = new lid();
  private float jdField_c_of_type_Float;
  private volatile int jdField_c_of_type_Int;
  private final lid jdField_c_of_type_Lid = new lid();
  ...
  {
    jdField_a_of_type_Lgf.a(1, this.jdField_a_of_type_ArrayOfInt, 0);
    lie.a();
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, lgg paramlgg)
  {
    a(paramInt1, paramInt2, paramInt3, paramFloat1, paramFloat2, paramFloat3, paramFloat4, paramlgg.a(), paramlgg.a());
  }
  ...
  private static void a(RectF paramRectF, lhf paramlhf)
  {
    int j = paramlhf.e();
    int k = paramlhf.f();
    paramRectF.left /= j;
  ...
  private void a(lhf paramlhf, RectF paramRectF1, RectF paramRectF2)
  {
    a(paramRectF1);
    a(paramlhf, this.jdField_i_of_type_ArrayOfFloat, paramRectF2);
  }
  
  private void a(lhf paramlhf, float[] paramArrayOfFloat, RectF paramRectF)
  {
    lhd[] arrayOflhd = paramlhf.a(this);
    a(arrayOflhd, 0);
    GLES20.glUniformMatrix4fv(arrayOflhd[3].jdField_a_of_type_Int, 1, false, paramArrayOfFloat, 0);
    lie.a();
    if (paramlhf.a())
    {
      a(2);
    ...
    a(arrayOflhd, 5, 4, paramRectF.left, paramRectF.top, paramRectF.width(), paramRectF.height());
    if (paramlhf.a()) {
      c();
    }
  ...
  private void a(lhd[] paramArrayOflhd, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    f();
    a(paramFloat1, paramFloat2, 0.0F);
    b(paramFloat3, paramFloat4, 1.0F);
    GLES20.glUniformMatrix4fv(paramArrayOflhd[1].jdField_a_of_type_Int, 1, false, a(), 0);
    g();
    lie.a();
  }
  
  private void a(lhd[] paramArrayOflhd, int paramInt)
  {
    GLES20.glBindBuffer(34962, this.jdField_e_of_type_Int);
    lie.a();
    GLES20.glVertexAttribPointer(paramArrayOflhd[0].jdField_a_of_type_Int, 2, 5126, false, 8, paramInt * 8);
    lie.a();
    GLES20.glBindBuffer(34962, 0);
    lie.a();
  }
  
  private void a(lhd[] paramArrayOflhd, int paramInt1, int paramInt2, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    a(paramArrayOflhd, paramFloat1, paramFloat2, paramFloat3, paramFloat4);
    int j = paramArrayOflhd[0].jdField_a_of_type_Int;
  ...
  public void a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, lgg paramlgg)
  {
    a(3, 4, 2, paramFloat1, paramFloat2, paramFloat3 - paramFloat1, paramFloat4 - paramFloat2, paramlgg);
  ...
  public void a(int paramInt)
  {
    ...
    for (this.jdField_c_of_type_ArrayOfFloat = Arrays.copyOf(this.jdField_c_of_type_ArrayOfFloat, this.jdField_c_of_type_ArrayOfFloat.length * 2);; this.jdField_c_of_type_ArrayOfFloat = arrayOfFloat)
    {
      ...
      this.jdField_a_of_type_Lid.a(paramInt);
      return;
      j = 0;
      break;
  ...
  public void a(lhf paramlhf)
  {
    int k = paramlhf.g();
    int[] arrayOfInt = paramlhf.a();
    int j = 0;
    while (j < arrayOfInt.length)
    {
      GLES20.glBindTexture(k, paramlhf.a()[j]);
      j += 1;
    }
    lie.a();
  ...
  public void a(lhf paramlhf, int paramInt1, int paramInt2)
  {
    int k = paramlhf.g();
    int[] arrayOfInt = paramlhf.a();
    int j = 0;
    ...
    lie.a();
    GLES20.glTexImage2D(k, 0, paramInt1, paramlhf.e(), paramlhf.f(), 0, paramInt1, paramInt2, null);
  }
  
  public void a(lhf paramlhf, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if ((paramInt3 <= 0) || (paramInt4 <= 0)) {
      return;
    }
    Rect localRect = paramlhf.a();
    ...
    a(this.jdField_a_of_type_AndroidGraphicsRectF, paramlhf);
    a(paramlhf, this.jdField_a_of_type_AndroidGraphicsRectF, this.jdField_b_of_type_AndroidGraphicsRectF);
  }
  
  public void a(lhf paramlhf, int paramInt1, int paramInt2, Bitmap paramBitmap, int paramInt3, int paramInt4)
  {
    int k = paramlhf.g();
    int[] arrayOfInt = paramlhf.a();
    int j = 0;
  ...
  public void a(lhf paramlhf, Bitmap paramBitmap)
  {
    int k = paramlhf.g();
    int[] arrayOfInt = paramlhf.a();
    int j = 0;
  ...
  public boolean a(lhf paramlhf)
  {
    boolean bool = paramlhf.c();
    if (bool) {}
    for (;;)
    {
      synchronized (this.jdField_b_of_type_Lid)
      {
        paramlhf = paramlhf.a();
        if (paramlhf != null) {
          break label68;
        ...
        return bool;
        if (j < paramlhf.length)
        {
          this.jdField_b_of_type_Lid.a(paramlhf[j]);
          j += 1;
          continue;
        }
        return bool;
  ...
  {
    int k = 1;
    int m = this.jdField_a_of_type_Lid.a();
    if ((m & 0x1) == 1)
    {
      j = 1;
      if (j != 0) {
  ...
  public void d()
  {
    synchronized (this.jdField_b_of_type_Lid)
    {
      lid locallid2 = this.jdField_b_of_type_Lid;
      if (this.jdField_b_of_type_Lid.b() > 0)
      {
        jdField_a_of_type_Lgf.a(null, locallid2.b(), locallid2.a(), 0);
        locallid2.a();
      }
      locallid2 = this.jdField_c_of_type_Lid;
      if (locallid2.b() > 0)
      {
        jdField_a_of_type_Lgf.b(null, locallid2.b(), locallid2.a(), 0);
        locallid2.a();
      }
      return;
    }
