  ...
  extends DynamicTextItem
{
  ...
  static
  {
    jdField_a_of_type_Float = azgq.a(22.0F);
    jdField_b_of_type_Float = azgq.a(3.0F);
    Resources localResources = BaseApplicationImpl.getContext().getResources();
    jdField_b_of_type_Int = aekt.a(27.0F, localResources);
    jdField_d_of_type_Int = aekt.a(6.0F, localResources);
    int i = bmtu.a();
    jdField_c_of_type_Int = localResources.getDisplayMetrics().widthPixels - wzs.a - i * 2;
  }
  
  public bltz(int paramInt, List<String> paramList, Typeface paramTypeface)
  {
