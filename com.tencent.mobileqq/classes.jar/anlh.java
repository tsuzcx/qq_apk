...
public class anlh
  extends abvw
{
  public anlh(QQAppInterface paramQQAppInterface, QQMessageFacade paramQQMessageFacade, abww paramabww)
  {
  ...
  protected String a(String paramString1, String paramString2)
  {
    ...
    String str;
    for (paramString2 = amtj.a(2131704568);; paramString2 = ContactUtils.getTroopMemberName(this.a, paramString2, paramString1))
    {
  ...
  public void a(MessageRecord paramMessageRecord, EntityManager paramEntityManager, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4, abvu paramabvu)
  {
    ...
    Map localMap2 = paramabvu.jdField_a_of_type_JavaUtilMap;
    Map localMap1 = paramabvu.d;
    ...
    localObject = (RecentUser)((anuz)localObject).findRecentUserByUin(str1, 1);
    if (localMap2.containsKey(abwz.a(((RecentUser)localObject).uin, ((RecentUser)localObject).getType()))) {
      localObject = (RecentUser)localMap2.get(abwz.a(((RecentUser)localObject).uin, ((RecentUser)localObject).getType()));
    }
    for (;;)
    {
      int i;
  ...
  public void b(QQMessageFacade.Message paramMessage)
  {
    ...
    if (QLog.isDevelopLevel()) {
      awkj.a("PttShow", "processNickName", new Object[] { paramMessage.senderuin, paramMessage.nickName });
    }
  }
}
