...
public class anlh
  extends anjw<CustomEmotionData>
{
  public anlh(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
  }
  
  private void a(int paramInt, List<FavEmotionOcr.OcrInfo> paramList, arro paramarro, List<CustomEmotionData> paramList1)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      while (j < paramList.size())
      {
        ...
        localObject = paramarro.a(paramList1, str);
        int i = k;
        if (localObject != null)
        {
          i = m;
          ...
          if (m != 0)
          {
            paramarro.b((CustomEmotionBase)localObject);
            i = 1;
          }
        }
        j += 1;
    ...
    do
    {
      ...
      if (i < paramList2.size())
      {
        ...
        for (;;)
        {
          i += 1;
          break;
          localObject2 = new arrw((String)localObject1);
          if ((!((arrw)localObject2).a()) || (TextUtils.isEmpty(((arrw)localObject2).c)) || (TextUtils.isEmpty(((arrw)localObject2).d)))
          {
            if (QLog.isColorLevel()) {
      ...
      if (i < paramList1.size())
      {
        ...
        for (;;)
        {
          i += 1;
          break;
          localarrw1 = new arrw((String)localObject2);
          if ((!localarrw1.a()) || (TextUtils.isEmpty(localarrw1.c)) || (TextUtils.isEmpty(localarrw1.d)))
          {
            if (QLog.isColorLevel()) {
            ...
            ((List)localObject1).add(localarrw1);
          }
        }
      }
      ...
      {
        localarrw1 = (arrw)localArrayList.get(i);
        int j = 0;
        while (j < ((List)localObject1).size())
        {
          arrw localarrw2 = (arrw)((List)localObject1).get(j);
          if ((localarrw1.c.equals(localarrw2.c)) && (localarrw2.c.equals("0")) && (localarrw2.d.equals(localarrw1.d)))
          {
            paramList1.remove(localarrw2.a);
            ((StringBuilder)localObject2).append(localarrw2.a).append(", ");
          }
          j += 1;
        }
        i += 1;
  ...
  public void a()
  {
    ...
    localPlatInfo.mqqver.set("8.4.1");
  ...
  public void a(CustomEmotionData paramCustomEmotionData, String paramString)
  {
    ...
    if ((this.app == null) || (this.app.getApp() == null))
    {
      ...
      notifyUI(3, false, this.mApp.getApplication().getString(2131691755));
      return;
    }
    if (!bgnt.a())
    {
      notifyUI(3, false, this.app.getApp().getString(2131693359));
      return;
    }
    try
    {
      ...
      ((FavEmotionOcr.ReqBody)localObject1).string_version.set("8.4.1");
  ...
  public void a(FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        bctj.a(BaseApplication.getContext()).a(null, "favEmoModifyOcrsSuc", false, 0L, 0L, (HashMap)localObject, null);
        if ((i != 0) && (paramObject.bytes_bodybuffer.has()) && (paramObject.bytes_bodybuffer.get() != null))
        {
          ...
          if (i < paramFromServiceMsg.size())
          {
            ...
            {
              paramObject = ((arro)this.app.getManager(149)).a();
              if (paramObject != null)
              {
            ...
            {
              notifyUI(3, false, this.mApp.getApplication().getString(2131691761));
              if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      try
      {
        ...
        if (i != 0)
        {
          ...
          bctj.a(BaseApplication.getContext()).a(null, "favEmoGetOcrSuc", false, 0L, 0L, localHashMap, null);
          if ((i == 0) || (!paramObject.bytes_bodybuffer.has()) || (paramObject.bytes_bodybuffer.get() == null)) {
            break label384;
          }
          paramFromServiceMsg = new FavEmotionOcr.RspBody();
          ...
          if (paramFromServiceMsg.list_ocr_info.has())
          {
            ...
            paramObject = (arro)this.app.getManager(149);
  ...
  public void a(Object paramObject, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      ((arro)this.app.getManager(149)).c(localArrayList);
  ...
  public void a(List<CustomEmotionData> paramList, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localReqBody.string_version.set("8.4.1");
  ...
  public void b(List<String> paramList)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      {
        arrw localarrw = new arrw((String)paramList.next());
        if (!TextUtils.isEmpty(localarrw.d)) {
          localArrayList.add(localarrw.d);
        }
      }
      if (localArrayList.size() > 0) {
        ((arss)this.app.getManager(141)).a(localArrayList);
      }
    }
  }
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramObject == null) || (paramFromServiceMsg == null) || (!paramFromServiceMsg.isSuccess()))
    {
      ...
      if (i == 1)
      {
        paramToServiceMsg = (arrp)this.mApp.getManager(72);
