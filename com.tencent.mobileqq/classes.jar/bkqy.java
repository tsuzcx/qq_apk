...
public class bkqy<K extends bkqg>
  extends bkqw<K>
  implements bkqx
{
  protected bkqd a;
  
  protected bkqy(K paramK)
  {
    super(paramK);
  ...
  {
    Resources localResources = ((bkqg)this.jdField_a_of_type_MqqUtilWeakReference.get()).getResources();
    bkqd localbkqd = b();
    View localView;
    ...
    if (paramView == null)
    {
      localView = ((bkqg)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getLayoutInflater().inflate(2131560834, null);
      paramViewGroup = (TextView)localView;
      localQQAlbumInfo = localbkqd.a(paramInt);
      ...
      if (localbkqd.getItemViewType(paramInt) != 1) {
        break label389;
      }
    ...
    for (;;)
    {
      if (localObject == null)
      {
        localObject = bayu.a(paramView, bkqd.jdField_a_of_type_AndroidGraphicsDrawableColorDrawable, bkqd.jdField_a_of_type_AndroidGraphicsDrawableColorDrawable);
        ((URLDrawable)localObject).setTag(localQQAlbumInfo.mCoverInfo);
        ((URLDrawable)localObject).setBounds(0, 0, localbkqd.jdField_a_of_type_Int, localbkqd.b);
        if (!localQQAlbumInfo._id.equals(this.jdField_a_of_type_Aiqy.albumId)) {
          break label401;
        }
        paramView = localbkqd.jdField_a_of_type_AndroidGraphicsDrawableDrawable$ConstantState.newDrawable(localResources);
  ...
  protected bkqd a()
  {
    return new bkqd((bkqg)this.jdField_a_of_type_MqqUtilWeakReference.get());
  }
  ...
  {
    if ((this.jdField_a_of_type_MqqUtilWeakReference.get() == null) || (((bkqg)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity() == null)) {
      return null;
    }
    Object localObject;
        ...
        for (i = j;; i = 0)
        {
          ...
          if (paramInt == -1)
          {
            ...
            if ((this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumAlbumListBaseData.filter != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumAlbumListBaseData.filter.showVideo()))
            {
              ...
              paramList1 = ((bkqg)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getContentResolver().query(paramList1, new String[] { "_id" }, "_size>0 ", null, null);
              i = 0;
              if (paramList1 != null)
              {
              ...
              if (bool)
              {
                ...
                paramList1 = b().a(((bkqg)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity());
              }
            }
          }
          for (;;)
  ...
  public void a(int paramInt)
  {
    ...
    {
      bdif.a();
      localList1 = localbkqd.a(((bkqg)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), paramInt);
    ...
    for (;;)
    {
      ...
      {
        bdif.a();
        localList2 = localbkqd.a(((bkqg)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), paramInt, localMediaFileFilter);
      ...
      {
        bdif.a();
        localList1 = this.jdField_a_of_type_Bkqx.a(localList1, localList2, paramInt);
        if (localList1 != null) {
        ...
        {
          return;
          bdif.a("PEAK", "compact(" + (localList1.size() - 1) + "," + k + ")");
          localbkqd.b(localList1);
        } while (paramInt == -1);
        if (i != 0)
        {
          ThreadManager.getFileThreadHandler().post(new AEAlbumListLogicBase.2(this, localbkqd));
          return;
        }
        ThreadManager.getFileThreadHandler().post(new AEAlbumListLogicBase.3(this, localbkqd, localMediaFileFilter));
        return;
        break;
        localList2 = null;
      }
  ...
  public void a(Intent paramIntent)
  {
    ...
    this.jdField_a_of_type_Aiqy.mIsAwlaysShowNumber = paramIntent.getBooleanExtra("PhotoConst.ALWAYS_SHOW_NUMBER_WHEN_ONLY_ONE_IMAGE", this.jdField_a_of_type_Aiqy.mIsAwlaysShowNumber);
    paramIntent = (HashMap)paramIntent.getSerializableExtra("PeakConstants.selectedMediaInfoHashMap");
    if (paramIntent != null)
    {
      if ((this.jdField_a_of_type_Aiqy.selectedMediaInfoHashMap != null) && (!this.jdField_a_of_type_Aiqy.selectedMediaInfoHashMap.isEmpty())) {
        break label178;
      }
      this.jdField_a_of_type_Aiqy.selectedMediaInfoHashMap = paramIntent;
    }
    for (;;)
    {
      this.jdField_a_of_type_Bkqd = a();
      ((bkqg)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bkqd = this.jdField_a_of_type_Bkqd;
      ThreadManager.getFileThreadHandler().post(new AEAlbumListLogicBase.1(this));
      return;
      label178:
      this.jdField_a_of_type_Aiqy.selectedMediaInfoHashMap.putAll(paramIntent);
    }
  }
  ...
  boolean a(Intent paramIntent, QQAlbumInfo paramQQAlbumInfo)
  {
    ...
    if (((str1 != null) && (!str1.equals(this.jdField_a_of_type_Aiqy.albumName))) || ((str2 != null) && (!str2.equals(this.jdField_a_of_type_Aiqy.albumId)))) {}
    for (boolean bool = true; a(bool, paramQQAlbumInfo); bool = false)
    {
      this.jdField_a_of_type_Aiqy.albumName = str1;
      this.jdField_a_of_type_Aiqy.albumId = str2;
  ...
  public boolean a(QQAlbumInfo paramQQAlbumInfo, int paramInt, Intent paramIntent)
  {
    ...
    XListView localXListView = ((bkqg)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_ComTencentWidgetXListView;
  ...
  protected bkqd b()
  {
    return this.jdField_a_of_type_Bkqd;
  }
