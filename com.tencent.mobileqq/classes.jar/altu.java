  ...
  extends ArkPlayer
{
  ...
  private static final Set<WeakReference<altu>> jdField_a_of_type_JavaUtilSet = Collections.synchronizedSet(new HashSet());
  ...
  static
  {
    jdField_a_of_type_ComTencentArkArk$PlayerStubFactory = new altv();
  }
  ...
  public static void a()
  {
    synchronized (jdField_a_of_type_JavaUtilSet)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        {
          localObject2 = (altu)((WeakReference)localObject2).get();
          if (localObject2 != null) {
            ((altu)localObject2).c();
          }
        }
