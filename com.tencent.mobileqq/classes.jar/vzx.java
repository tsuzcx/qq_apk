  ...
  implements BusinessObserver
{
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, int paramInt, String paramString)
  {
    ...
    label58:
    label68:
    for (String str = anvx.a(2131710420);; str = anvx.a(2131710418))
    {
      bjkv.a().a(paramString + str + anvx.a(2131710421));
      return;
      paramString = anvx.a(2131710419);
      break;
    }
  }
              ...
              do
              {
                do
                {
                  ...
                  if (localObject2 != null)
                  {
                    ...
                    localObject1 = ((wke)localObject3).b(((UserInfo)localObject2).uid);
                  ...
                  for (paramInt = i;; paramInt = 0)
                  {
                    ...
                    ((wke)localObject3).a(paramObject);
                  ...
                  if (paramBoolean)
                  {
                    Bosses.get().postJob(new vzy(this, "QQStoryObserver", paramObject, (Boolean)localObject1, paramBoolean, paramInt));
                    return;
                  }
                  localObject1 = ((wke)wjs.a(2)).b(paramObject);
                  if (localObject1 != null)
                  {
