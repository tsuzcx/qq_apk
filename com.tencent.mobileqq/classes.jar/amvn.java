...
public class amvn
{
  private void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    Boolean localBoolean = (Boolean)bhvy.a("local_kd_tab_has_set");
    boolean bool3 = TextUtils.equals("1", paramString);
    bhvy.a(paramQQAppInterface, "remote_kd_tab_switch", Boolean.valueOf(bool3));
    boolean bool2;
  ...
  public void a(amph[] paramArrayOfamph)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        int j = 0;
        if (j < paramArrayOfamph.length)
        {
          if (TextUtils.isEmpty(paramArrayOfamph[j].a))
          {
          ...
          try
          {
            str2 = paramArrayOfamph[j].a.trim();
            ...
            bhvy.c(localQQAppInterface, str1);
            continue;
            if (!QLog.isColorLevel()) {
              continue;
            }
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.e("ReadinjoyCommonConfProcessor", 2, "received readinjoy cropandgroup config error,cmd : 92" + paramArrayOfamph.toString());
        }
      }
      if (TextUtils.equals((CharSequence)localObject2, "feeds_group"))
      {
        bhvy.a(localQQAppInterface, str1);
      }
      else if (TextUtils.equals((CharSequence)localObject2, "remind_only_wifi"))
      {
        bhvy.b(localQQAppInterface, str1);
      }
      else if (TextUtils.equals((CharSequence)localObject2, "kandian_individual_time_push"))
      {
        ...
        bool = true;
        bhvy.a(localQQAppInterface, bool);
      }
      else if (TextUtils.equals((CharSequence)localObject2, "push_switch"))
      {
        bhvy.d(localQQAppInterface, TextUtils.equals(str1, "1"));
      }
      else
      {
        ...
        else
        {
          ...
          if (TextUtils.equals((CharSequence)localObject2, "socializeWebUrl"))
          {
            ...
            if (localObject1 != null)
            {
              if (((Node)localObject1).getNodeType() == 1)
              {
                ...
                if (!bhvy.a((String)localObject2)) {
                  break label641;
                }
                bhvy.a(localQQAppInterface, (String)localObject2, (String)localObject3);
              }
              for (;;)
              {
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "kandian_report_tt"))
          {
            ...
            if (TextUtils.equals((CharSequence)localObject1, "1")) {
              bhvy.j(localQQAppInterface, true);
            } else {
              bhvy.j(localQQAppInterface, false);
            }
          }
          else if (TextUtils.equals((CharSequence)localObject2, "kandian_report_user_apps_switch"))
          {
            ...
            bhvy.a("kandian_report_user_apps_switch", localObject1);
          }
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "maintab_reddot_times"))
          {
            ...
            bhvy.h(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "maintab_reddot_feeds"))
          {
            ...
            bhvy.i(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "feedsbackWebUrl"))
          {
            bhvy.b(localQQAppInterface, (String)localObject2, (String)localObject1);
            if (QLog.isColorLevel()) {
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "biufeedsSwitch"))
          {
            ...
            bhvy.k(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "biufeedsName"))
          {
            ...
            bhvy.d(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "biufeedsWebUrl"))
          {
            ...
            bhvy.e(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "badgeNumber"))
          {
            ...
            bhvy.z(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "biu_word_count"))
          {
            ...
            bhvy.f(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "new_channel_style"))
          {
            ...
            bhvy.l(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "local_record_time"))
          {
            ...
            bhvy.b(localQQAppInterface, Long.valueOf((String)localObject1).longValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "local_record_feeds"))
          {
            ...
            bhvy.A(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "local_record_time_weishi"))
          {
            ...
            bhvy.c(localQQAppInterface, Long.valueOf((String)localObject1).longValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "local_record_feeds_weishi"))
          {
            ...
            bhvy.B(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "kandianWebPreLoadData"))
          {
            ...
            if (TextUtils.equals((CharSequence)localObject1, "1")) {
              bhvy.o(localQQAppInterface, true);
            } else {
              bhvy.o(localQQAppInterface, false);
            }
          }
          else if ((TextUtils.equals((CharSequence)localObject2, "ExitAIO_Android_Uin")) && (localObject1 != null))
          {
            ...
            if (localObject1.length >= 2) {
              bhvy.b(Integer.valueOf(localObject1[0]).intValue(), Integer.valueOf(localObject1[1]).intValue());
            }
          }
          ...
          {
            bhvy.a(localQQAppInterface, "remote_kd_tab_type", localObject1);
            localObject2 = bhvy.a("local_kd_tab_has_set");
            ...
            if (!bool)
            {
              bhvy.a(localQQAppInterface, "local_kd_tab_type", localObject1);
          ...
          {
            bhvy.H(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "topic_card_jump"))
          {
            bhvy.a(localQQAppInterface, "kd_topic_recommend_card_jump_switch", Boolean.valueOf(((String)localObject1).equals("1")));
          }
          else if (TextUtils.equals((CharSequence)localObject2, "topic_card_jump_url"))
          {
            bhvy.a(localQQAppInterface, "kd_topic_recommend_card_jump_url", localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "comment_word_count"))
          {
            ...
            bhvy.g(localQQAppInterface, (String)localObject1);
          }
          else if ((TextUtils.equals((CharSequence)localObject2, "KW")) && (!TextUtils.isEmpty((CharSequence)localObject1)))
          {
            ...
            onh.a("kandian_aio_sp_word", localObject2, true);
          }
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "ugc_gif_switch"))
          {
            ...
            bhvy.i(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "biu_at_switch"))
          {
            ...
            bhvy.n(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "UGC_at_switch"))
          {
            ...
            bhvy.m(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "comment_at_switch"))
          {
            ...
            bhvy.v(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "biu_profile_switch"))
          {
            ...
            bhvy.o(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "IconMerge_BiuMsg"))
          {
            ...
            bhvy.b(TextUtils.equals((CharSequence)localObject1, "1"));
          }
          else if (TextUtils.equals((CharSequence)localObject2, "IconMerge_InteractiveMsg"))
          {
            ...
            bhvy.c(TextUtils.equals((CharSequence)localObject1, "1"));
          }
          else if (TextUtils.equals((CharSequence)localObject2, "IconMerge_SubscribeMsg"))
          {
            ...
            bhvy.e((String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "nw_support"))
          {
            bhvy.p(localQQAppInterface, TextUtils.equals((CharSequence)localObject1, "1"));
          }
          else if (TextUtils.equals((CharSequence)localObject2, "nw_preload"))
          {
            bhvy.q(localQQAppInterface, TextUtils.equals((CharSequence)localObject1, "1"));
          }
          else if (TextUtils.equals((CharSequence)localObject2, "arkapp_enable_switch"))
          {
            ...
            bhvy.b(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "exposure_strengthen"))
          {
            bhvy.r(localQQAppInterface, "1".equals(localObject1));
          }
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "diandian_publish_switch_new"))
          {
            ...
            bhvy.p(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "kandian_publish_switch_new"))
          {
            ...
            bhvy.q(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "readinjoy_QA_square_autoTimeval"))
          {
            ...
            bhvy.r(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "WXShareFromKandian_Switch"))
          {
            ...
            bhvy.s(localQQAppInterface, (String)localObject1);
          }
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "zhitu"))
          {
            ...
            bhvy.j(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "comment_biu_switch"))
          {
            ...
            bhvy.t(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "native_comment_biu"))
          {
            ...
            bhvy.u(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "readinjoy_short_video_width_height_ratio"))
          {
            ...
            bhvy.b(localQQAppInterface, Float.valueOf((String)localObject1).floatValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "readinjoy_short_video_max_duration_limit"))
          {
            ...
            bhvy.w(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "record_duration_count"))
          {
            ...
            bhvy.g(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "kandiansettings"))
          {
            ...
            bhvy.D(localQQAppInterface, str2);
          }
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "ReadInJoy_Message_Auto_Refresh_Time_Duration"))
          {
            ...
            bhvy.K(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "is_show_weishi_entrance"))
          {
            ...
            bhvy.E(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "is_jump_to_video_content"))
          {
            ...
            bhvy.L(localQQAppInterface, (String)localObject1);
          }
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "video_switch"))
          {
            ...
            try
            {
              ...
              bool = true;
              label4507:
              bhvy.a("sp_key_readinjoy_video_entrance_reddot_button_switch", Boolean.valueOf(bool));
            }
          ...
          else
          {
            ...
            if (bool)
            {
              try
              {
                bhvy.a("sp_key_readinjoy_video_entrance_reddot_button_color", Integer.valueOf(Color.parseColor(localNumberFormatException1)));
              }
            ...
            {
              bhvy.a("sp_key_readinjoy_video_entrance_reddot_expire_time_list", localIllegalArgumentException);
            }
            else if (TextUtils.equals((CharSequence)localObject2, "ReadInJoy_guanzhu_Auto_Refresh_Time_Duration"))
            {
              ...
              bhvy.a("sp_key_kandian_subscribe_auto_refresh_config", Integer.valueOf(i));
            ...
            {
              bhvy.a("sp_native_web_sharpp_pic_switch", Boolean.valueOf("1".equals(localIllegalArgumentException)));
            }
            else if (TextUtils.equals((CharSequence)localObject2, "video_feeds_preload_switch"))
            {
              bhvy.l(localQQAppInterface, "1".equals(localIllegalArgumentException));
            }
            else if (TextUtils.equals((CharSequence)localObject2, "enable_preoutput_kandianvideo_first_frame"))
            {
              bhvy.f(localQQAppInterface, "1".equals(localIllegalArgumentException));
            }
            else if (TextUtils.equals((CharSequence)localObject2, "rij_discover_entrance_show"))
            {
              bhvy.A(localQQAppInterface, localIllegalArgumentException);
            }
            else if (TextUtils.equals((CharSequence)localObject2, "rijvideo_1to3_loop_play"))
            {
              bhvy.B(localQQAppInterface, localIllegalArgumentException);
            }
            else if (TextUtils.equals((CharSequence)localObject2, "readinjoy_small_video_pack_ui_style"))
            {
              bhvy.z(localQQAppInterface, str2);
            }
            else if (TextUtils.equals((CharSequence)localObject2, "hot_comment_number"))
            {
              i = Integer.parseInt(localIllegalArgumentException);
              bhvy.a(oez.READINJOY_COMMENT_HOT_NUM, Integer.valueOf(i));
            }
            else if (TextUtils.equals((CharSequence)localObject2, "hot_comment_likes_number"))
            {
              i = Integer.parseInt(localIllegalArgumentException);
              bhvy.a(oez.READINJOY_COMMENT_HOT_COMMENT_LIKE_FILTER, Integer.valueOf(i));
            }
            else if (TextUtils.equals((CharSequence)localObject2, "weishi_with_channel_discovery_switch"))
            {
              ...
              bhvy.f(localIllegalArgumentException);
            }
            else if (TextUtils.equals((CharSequence)localObject2, "ugc_upload_lbs_switch"))
            {
              i = Integer.parseInt(localIllegalArgumentException);
              bhvy.a(oez.READINJOY_UGC_LBS, Integer.valueOf(i));
            }
            else if (TextUtils.equals((CharSequence)localObject2, "local_record_time_weishi_recommend"))
            {
              ...
              bhvy.c(localIllegalArgumentException);
            }
            else if (TextUtils.equals((CharSequence)localObject2, "local_record_feeds_counts_weishi_recommend"))
            {
              ...
              bhvy.d(localIllegalArgumentException);
            }
            else
            {
              ...
              bhvy.a("should_request_aladdin_config", Boolean.valueOf(TextUtils.equals("1", localIllegalArgumentException)));
            }
          }
        }
      }
    ...
    for (;;)
    {
      for (;;)
      {
        for (;;)
        {
          for (;;)
          {
            for (;;)
            {
              for (;;)
              {
                for (;;)
                {
                  for (;;)
                  {
                    for (;;)
                    {
                      try
                      {
                        ...
                        bool = true;
                        bhvy.a("sp_key_create_topic_switch", Boolean.valueOf(bool));
                      }
                      ...
                      {
                        bhvy.a("readinjoy_coin_item_jump_url", localIllegalArgumentException);
                        if (!QLog.isColorLevel()) {
                          break;
                        }
                      ...
                      {
                        bhvy.a("readinjoy_coin_item_title", localIllegalArgumentException);
                        if (!QLog.isColorLevel()) {
                          break;
                        }
                    ...
                    {
                      bhvy.a("kandianreport_ON", Integer.valueOf(Integer.parseInt(localNumberFormatException2)));
                      break;
                    }
                  ...
                  {
                    bhvy.a("kandian_daily_fast_web_bottom_share", localException3);
                    break;
                  }
                  ...
                  try
                  {
                    bhvy.g(Integer.parseInt(localException3));
                  }
                ...
                try
                {
                  bhvy.h(Integer.parseInt(localException4));
                }
              ...
              try
              {
                bhvy.i(Integer.parseInt(localException5));
              }
            ...
            try
            {
              ...
              bhvy.a("readinjoy_video_ff_probesize", Long.valueOf(Long.parseLong(localException6)));
            }
          ...
          try
          {
            ...
            bhvy.a("readinjoy_video_is_ff_probelist_switch", Integer.valueOf(Integer.parseInt(localException7)));
          }
        ...
        try
        {
          ...
          bhvy.a("readinjoy_video_is_download_async_io", Integer.valueOf(Integer.parseInt(localException8)));
        }
      ...
      {
        bhvy.a("kandian_daily_wrapper_alpha", localException9);
        break;
      }
      if (TextUtils.equals((CharSequence)localObject2, "kandian_daily_wrapper_default_text"))
      {
        bhvy.a("kandian_daily_wrapper_default_text", localException9);
        break;
      }
      if (TextUtils.equals((CharSequence)localObject2, "kandian_daily_wrapper_drag_text"))
      {
        bhvy.a("kandian_daily_wrapper_drag_text", localException9);
        break;
      }
      ...
      bhvy.a("kandian_video_extract_frame", localException9);
      break;
      label6385:
