  ...
  implements amuq
{
  ...
  public amvn(amvm paramamvm, amut paramamut, amvs paramamvs, amvt paramamvt)
  {
    this.jdField_a_of_type_Amvm = paramamvm;
    this.jdField_a_of_type_Amut = paramamut;
    this.jdField_a_of_type_Amvs = paramamvs;
    this.jdField_a_of_type_Amvt = paramamvt;
  }
  
  private boolean a(int paramInt1, int paramInt2)
  {
    if (this.jdField_a_of_type_Amvm == null) {}
    while (this.jdField_a_of_type_Amvt.a(paramInt1, paramInt2) == null) {
      return false;
    }
    return true;
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    try
    {
      ...
      localObject = this.jdField_a_of_type_Amvt.a(100);
      if (localObject == null)
      {
        QLog.w("CmShow_SpriteDrawerInfoBridge", 1, "actionScript == null.");
        return;
      }
      ((amvk)localObject).a(localStringBuilder.toString());
      this.jdField_a_of_type_Amut.a(paramInt2);
      return;
    }
  ...
  public void a(amvm paramamvm, int paramInt, amve paramamve, Bundle paramBundle)
  {
    if (QLog.isColorLevel()) {
      QLog.d("CmShow_SpriteDrawerInfoBridge", 2, "[initSprite]");
    }
    anaw.a(paramamvm.a());
    anaw.a(paramamvm.a(), 300);
    if ((this.jdField_a_of_type_Amvs == null) || (paramamvm == null) || (!paramamvm.a())) {
      if (paramamvm != null) {
        anaw.a(paramamvm.a(), 300, 160, new Object[] { "glview is not ready" });
      }
    }
    do
    {
      ...
      if (paramamvm.jdField_e_of_type_Int == 1) {
        ThreadManager.getUIHandler().post(new CmShowSpriteDrawerInfoBridge.5(this, paramamvm));
      }
    } while (paramamvm == null);
    anaw.a(paramamvm.a(), 300, 200, new Object[] { "script no exit" });
    return;
    Bundle localBundle = new Bundle();
    IPCSpriteContext localIPCSpriteContext = paramamvm.a();
    if (paramBundle != null)
    {
      ...
      if (!TextUtils.isEmpty(paramamvm.jdField_b_of_type_JavaLangString)) {
        this.jdField_a_of_type_JavaUtilHashMap.put(paramamvm.jdField_b_of_type_JavaLangString, Integer.valueOf(localIPCSpriteContext.d));
      }
      if (!TextUtils.isEmpty(paramamvm.jdField_a_of_type_JavaLangString)) {
        this.jdField_a_of_type_JavaUtilHashMap.put(paramamvm.jdField_a_of_type_JavaLangString, Integer.valueOf(localIPCSpriteContext.jdField_e_of_type_Int));
      }
    }
    localBundle.putParcelable("IPCSpriteContext", localIPCSpriteContext);
    QIPCClientHelper.getInstance().callServer("cm_game_module", "action_render_view_get_initavatar_js", localBundle, new amvq(this, paramamve, paramInt, paramamvm));
  }
  
  public void a(amvm paramamvm, CmShowRenderView.PlayActionConfig paramPlayActionConfig)
  {
    int i = 1;
    if ((paramamvm == null) || (paramPlayActionConfig == null)) {
      return;
    }
    long l = System.currentTimeMillis();
    Object localObject1 = amuz.a(paramPlayActionConfig);
    if (!TextUtils.isEmpty((CharSequence)localObject1))
    {
      ...
      if ((!TextUtils.isEmpty(paramamvm.jdField_b_of_type_JavaLangString)) && (!paramamvm.jdField_b_of_type_JavaLangString.equals(paramPlayActionConfig.jdField_a_of_type_JavaLangString)))
      {
        ((SpriteTaskParam)localObject2).jdField_b_of_type_JavaLangString = paramamvm.jdField_b_of_type_JavaLangString;
        ((SpriteTaskParam)localObject2).jdField_a_of_type_JavaLangString = paramamvm.jdField_a_of_type_JavaLangString;
      ...
      for (;;)
      {
        ...
        ((SpriteTaskParam)localObject2).jdField_a_of_type_Amuq = this;
        ...
        return;
        ((SpriteTaskParam)localObject2).jdField_b_of_type_JavaLangString = paramamvm.jdField_a_of_type_JavaLangString;
        ((SpriteTaskParam)localObject2).jdField_a_of_type_JavaLangString = paramamvm.jdField_b_of_type_JavaLangString;
        break;
        label222:
        i = 0;
      }
    ...
    Object localObject2 = paramamvm.a();
    if ((!TextUtils.isEmpty(paramamvm.jdField_b_of_type_JavaLangString)) && (!paramamvm.jdField_b_of_type_JavaLangString.equals(paramPlayActionConfig.jdField_a_of_type_JavaLangString)))
    {
    ...
    QIPCClientHelper.getInstance().callServer("cm_game_module", "action_render_view_play_action", (Bundle)localObject1, new amvo(this, l, paramPlayActionConfig));
  }
  
  public void a(amvm paramamvm, String paramString1, String paramString2)
  {
    if (QLog.isColorLevel()) {
      QLog.d("CmShow_SpriteDrawerInfoBridge", 2, "[initSprite]");
    }
    ...
    } while (paramamvm.jdField_e_of_type_Int != 1);
    ThreadManager.getUIHandler().post(new CmShowSpriteDrawerInfoBridge.3(this, paramamvm));
    return;
    Bundle localBundle = new Bundle();
    IPCSpriteContext localIPCSpriteContext = paramamvm.a();
    ...
    QIPCClientHelper.getInstance().callServer("cm_game_module", "action_render_view_get_initavatar_js", localBundle, new amvp(this, paramamvm));
  }
  ...
  public void a(String paramString)
  {
    try
    {
      ...
      ((amvk)localObject).a(paramString.toString());
      return;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramInt == 1)
        {
          ...
          localObject2 = this.jdField_a_of_type_Amvt.a(100);
          if (localObject2 == null)
          {
            QLog.w("CmShow_SpriteDrawerInfoBridge", 1, "actionScript == null.");
            return;
          }
          ((amvk)localObject2).a(((StringBuilder)localObject1).toString());
          amuz.a(paramString, paramInt);
          return;
        }
      }
      catch (Throwable paramString)
  ...
  public void a(String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    for (;;)
    {
      try
      {
        ...
        localJSONObject.put("text", amuo.a(bgku.encodeToString(paramString2.getBytes("utf-8"), 0)));
        localJSONObject.put("direction", paramInt1);
        paramString1 = "";
        if (paramInt2 != 1) {
          break label408;
        }
        Object localObject = amuh.a(paramString2, 1);
        if (QLog.isColorLevel()) {
        ...
        if (TextUtils.isEmpty(paramString1))
        {
          ...
          localObject = amuh.a(paramString2, 0, 1);
        }
        ...
        if (paramInt2 == 1)
        {
          localObject = amuh.a(paramString2, 2);
          if (QLog.isColorLevel()) {
          ...
          if (localObject != null)
          {
            ...
            localObject = paramString1;
            if (TextUtils.isEmpty(paramString1)) {
              localObject = amuh.a(paramString2, 0, 2);
            }
            ...
            paramString2 = this.jdField_a_of_type_Amvt.a(100);
  ...
  public void a(List<String> paramList, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      ((amvk)localObject).a(paramList.toString());
      return;
      label172:
      if (paramBoolean) {
        i = 1;
  ...
  {
    if ((paramSpriteTaskParam == null) || (this.jdField_a_of_type_Amvs == null) || (this.jdField_a_of_type_Amvm == null) || (!this.jdField_a_of_type_Amvm.a())) {
      return;
    }
    Object localObject1 = this.jdField_a_of_type_Amvs;
    amvs.a(paramSpriteTaskParam);
    localObject1 = "";
    ...
    Object localObject3 = this.jdField_a_of_type_Amvt.a(paramSpriteTaskParam.jdField_c_of_type_Int);
    Object localObject2 = localObject3;
    if (localObject3 == null)
    {
      QLog.i("CmShow_SpriteDrawerInfoBridge", 1, "playAction CmShow_ get sdk basic script");
      localObject3 = this.jdField_a_of_type_Amvt.a(100);
    ...
    {
      amzq.a((QQAppInterface)localObject1, paramSpriteTaskParam, bool, paramSpriteTaskParam.jdField_b_of_type_Boolean);
      return;
    }
  }
}
