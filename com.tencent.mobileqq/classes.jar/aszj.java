  ...
  implements Manager
{
  ...
  public aszj(AppInterface paramAppInterface)
  {
    this.a = paramAppInterface;
  }
  
  public void a(long paramLong, asys paramasys)
  {
    ...
    mxi.a(this.a, new aszl(this, paramasys, paramLong), localReqBody.toByteArray(), "OidbSvc.0x8da_1", 2266, 0, null, 0L);
  }
  
  public void a(asys paramasys)
  {
    cmd0x938.ReqBody localReqBody = new cmd0x938.ReqBody();
    cmd0x938.CommParamReq localCommParamReq = new cmd0x938.CommParamReq();
    localCommParamReq.bytes_version.set(ByteStringMicro.copyFromUtf8("8.2.8"));
    ...
    mxi.a(this.a, new aszk(this, paramasys), localReqBody.toByteArray(), "OidbSvc.0x938_1", 2360, 1, null, 0L);
  }
