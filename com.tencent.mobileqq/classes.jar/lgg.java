  ...
  implements Observer
{
  ...
  public void a(Object paramObject)
  {
    ...
    {
      a(mtj.a(arrayOfObject, 3), j, i);
      return;
      b();
      return;
      a((RecvMsg)arrayOfObject[1]);
      return;
      a(mtj.a(arrayOfObject, 1));
      return;
      ...
      a(mtj.a(arrayOfObject, 3), i, paramObject);
      return;
      c();
      return;
      b(mtj.a(arrayOfObject, 1));
      return;
      d();
      return;
      e();
      ...
      for (;;)
      {
        for (;;)
        {
          ...
          try
          {
            ...
            a(mtj.a(arrayOfObject, 2), paramObject, true);
            return;
          }
          catch (Exception paramObject)
          {
        ...
        paramObject = (String)arrayOfObject[1];
        bool = ((Boolean)arrayOfObject[2]).booleanValue();
        b(mtj.a(arrayOfObject, 3), paramObject, bool);
        return;
        g();
        return;
