  ...
  extends asny
{
  ...
  asnz jdField_a_of_type_Asnz;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private FileManagerEntity jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity;
  boolean jdField_a_of_type_Boolean = false;
  long b;
  
  public asoa(QQAppInterface paramQQAppInterface, FileManagerEntity paramFileManagerEntity)
  {
    ...
    this.jdField_a_of_type_Asnz.a.jdField_a_of_type_JavaLangString = aszt.f(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileName);
    this.jdField_a_of_type_Asnz.a.d = this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize;
    this.jdField_a_of_type_Asnz.a.jdField_b_of_type_Int = this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerType;
    try
    {
      this.jdField_a_of_type_Asnz.a.c = Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerUin);
      return;
    }
  ...
  private void a(int paramInt, ExcitingTransferOneSlotComplete paramExcitingTransferOneSlotComplete)
  {
    ...
    String str = "";
    if (this.jdField_a_of_type_Asnz.a != null) {
      str = String.valueOf(this.jdField_a_of_type_Asnz.a.c);
    }
    Bundle localBundle = new Bundle();
    localBundle.putInt("param_fromType", 1);
    localBundle.putInt("param_V6SelectType", this.jdField_a_of_type_Int);
    localBundle.putInt("param_ipAddrType", ataw.b(paramExcitingTransferOneSlotComplete.m_strIp));
    ...
    for (int i = 1;; i = 0)
    {
      ...
      aszt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId, "actFileDownDetail", this.jdField_b_of_type_Long, paramExcitingTransferOneSlotComplete.m_strIp, str, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strFileMd5, paramInt, "", paramExcitingTransferOneSlotComplete.m_DownloadedSize, paramExcitingTransferOneSlotComplete.m_DownloadedSize, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, paramExcitingTransferOneSlotComplete.m_strIp, "", 0, "", null, localBundle);
      return;
    }
    aszt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId, "actFileDownDetail", paramExcitingTransferOneSlotComplete.m_TotalTimes, paramExcitingTransferOneSlotComplete.m_strIp, str, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strFileMd5, paramExcitingTransferOneSlotComplete.m_DownloadedSize, paramExcitingTransferOneSlotComplete.m_DownloadedSize, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, 0, null, localBundle);
  }
  ...
  private void a(List<String> paramList1, String paramString, int paramInt, List<String> paramList2, boolean paramBoolean)
  {
    if ((paramList1 == null) || (!asgv.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1)))
    {
      ...
      this.jdField_a_of_type_Asnz.b(this.jdField_a_of_type_Int);
      return;
    }
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        if ((paramString != null) && (!paramString.a()))
        {
          ...
          asgv.a(paramString.jdField_a_of_type_JavaUtilList, paramList1, true, true);
          this.jdField_a_of_type_Int = 2;
  ...
  protected asnn a(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Asnz = new asnz(paramQQAppInterface);
  ...
  protected void a(ExcitingTransferDownloadCompletedInfo paramExcitingTransferDownloadCompletedInfo)
  {
    ...
    aszt.a(paramExcitingTransferDownloadCompletedInfo);
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileName = aszt.a(paramExcitingTransferDownloadCompletedInfo);
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileName.getBytes().length > 250 - i) {
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileName = aszt.a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileName, 250 - i);
    }
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strFileSha3 = asnl.a(aszt.c(paramExcitingTransferDownloadCompletedInfo));
      if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize < 104857600L) {
        this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strFileSHA = asnl.a(aszt.a(paramExcitingTransferDownloadCompletedInfo));
      }
    }
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nFileType == 0)
    {
      ...
      atal.a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity);
    }
    for (;;)
    {
  ...
  protected void a(ExcitingTransferDownloadReqInfo paramExcitingTransferDownloadReqInfo)
  {
    ...
    this.jdField_a_of_type_Asnz.c();
    this.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileTransferHandler().a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileIdCrc, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.bSend, false, new asob(this, paramExcitingTransferDownloadReqInfo));
  }
  ...
  protected void a(boolean paramBoolean1, long paramLong, String paramString1, String paramString2, ByteStringMicro paramByteStringMicro, boolean paramBoolean2, String paramString3, short paramShort, String paramString4, List<String> paramList, String paramString5, Bundle paramBundle, ExcitingTransferDownloadReqInfo paramExcitingTransferDownloadReqInfo)
  {
    ...
    {
      return;
      this.jdField_a_of_type_Asnz.d();
      if (!paramBoolean1)
      {
        this.jdField_a_of_type_Asnz.b(paramLong);
        a(null, 0);
        return;
      }
      ...
      this.jdField_a_of_type_Asnz.c(this.jdField_a_of_type_Boolean);
    ...
    for (paramString1 = new ArrayList();; paramString1 = paramList)
    {
      ...
      paramExcitingTransferDownloadReqInfo.strSaveFileDir = this.jdField_a_of_type_Asyy.b();
  ...
  protected boolean a(long paramLong, ByteStringMicro paramByteStringMicro, String paramString)
  {
    ...
    if ((TextUtils.isEmpty(paramString)) || (paramByteStringMicro == null))
    {
      ...
      this.jdField_a_of_type_Asnz.a.jdField_b_of_type_Long = 9048L;
      this.jdField_a_of_type_Asnz.a.jdField_a_of_type_Long = 2L;
      this.jdField_a_of_type_Asnz.a(5);
      this.jdField_a_of_type_Asnz.a(false);
    }
    for (;;)
    {
      ...
      return bool;
      label101:
      this.jdField_a_of_type_Asnz.c(paramLong);
    }
  }
  ...
  public String b()
  {
    String str1 = this.jdField_a_of_type_Asyy.c();
  ...
  public void onOneSlotComplete(int paramInt, ExcitingTransferOneSlotComplete paramExcitingTransferOneSlotComplete)
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_Asnz.a(i, j, paramExcitingTransferOneSlotComplete);
  ...
  public void onRecvComplete(int paramInt, ExcitingTransferDownloadCompletedInfo paramExcitingTransferDownloadCompletedInfo)
  {
    ...
    if (paramExcitingTransferDownloadCompletedInfo != null) {
      this.jdField_a_of_type_Asnz.c(0);
    }
    int i;
    if (paramInt != 0)
    {
      i = a(paramInt);
      this.jdField_a_of_type_Asnz.a.jdField_b_of_type_Long = i;
      this.jdField_a_of_type_Asnz.a.jdField_a_of_type_Long = 4L;
      if (i == 9004)
      {
        this.jdField_a_of_type_Asnz.a.jdField_a_of_type_Long = 5L;
        this.jdField_a_of_type_Asnz.a(3);
        a(null, i);
        label107:
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerDataCenter().c(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity);
        if (paramExcitingTransferDownloadCompletedInfo != null)
        {
          this.jdField_a_of_type_Asnz.a(paramExcitingTransferDownloadCompletedInfo);
          paramExcitingTransferDownloadCompletedInfo = this.jdField_a_of_type_Asnz;
          if (i != 0) {
            break label304;
          }
        }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (i == 506)
      {
        this.jdField_a_of_type_Asnz.a.jdField_a_of_type_Long = 3L;
        this.jdField_a_of_type_Asnz.a(i);
        break;
      }
      this.jdField_a_of_type_Asnz.a(i);
      break;
      ...
      this.jdField_a_of_type_Asnz.a.jdField_b_of_type_Long = paramInt;
      this.jdField_a_of_type_Asnz.a.jdField_a_of_type_Long = 0L;
      this.jdField_a_of_type_Asnz.a(0);
  ...
  {
    this.jdField_a_of_type_Asnz.a(paramLong2);
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.status = 2;
  ...
  {
    paramExcitingTransferDownloadSpeedInfo = ataw.b(paramExcitingTransferDownloadSpeedInfo.mTotalSpeed);
