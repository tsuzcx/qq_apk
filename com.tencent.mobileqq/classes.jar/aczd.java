  ...
  extends acyl
{
  ...
  public aczd(int paramInt, AIOAnimationConatiner paramAIOAnimationConatiner, ListView paramListView)
  {
  ...
  private BaseChatItemLayout a(long paramLong)
  {
    ...
    if (paramLong == 0L)
    {
      ...
      while (k < this.jdField_a_of_type_ComTencentWidgetListView.getChildCount())
      {
        ...
        {
          localObject2 = (acuj)actj.a((View)localObject1);
          if ((((acuj)localObject2).jdField_a_of_type_Int != 0) && (((acuj)localObject2).jdField_a_of_type_AndroidViewView.getTop() + ((View)localObject1).getTop() + BaseChatItemLayout.jdField_g_of_type_Int > 0)) {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          if (((localObject2 instanceof BaseChatItemLayout)) && (((acuj)actj.a((View)localObject2)).jdField_a_of_type_Int != 0)) {
  ...
  int a(int paramInt, acuj paramacuj)
  {
    int k;
    int m;
    int n;
    if (paramacuj.jdField_a_of_type_ComTencentMobileqqDataChatMessage.isSend())
    {
      k = paramacuj.jdField_a_of_type_AndroidViewView.getLeft() + BaseChatItemLayout.j + BaseChatItemLayout.o;
      m = paramacuj.jdField_a_of_type_AndroidViewView.getRight() - BaseChatItemLayout.i - BaseChatItemLayout.n;
      if (paramInt > k) {
        break label135;
      }
    ...
    {
      return n;
      k = paramacuj.jdField_a_of_type_AndroidViewView.getLeft() + BaseChatItemLayout.i + BaseChatItemLayout.n;
      m = paramacuj.jdField_a_of_type_AndroidViewView.getRight() - BaseChatItemLayout.j - BaseChatItemLayout.j;
      break;
      d1 = Math.random();
  ...
  public long a()
  {
    ...
    case 3: 
      ...
      if (this.jdField_b_of_type_Int == 1)
      {
        ...
        {
          localacuj = (acuj)actj.a(localBaseChatItemLayout);
          if (localacuj != null)
          {
            this.jdField_b_of_type_Int = 2;
            this.jdField_a_of_type_Long = 0L;
            this.jdField_b_of_type_Long = localacuj.jdField_a_of_type_ComTencentMobileqqDataChatMessage.uniseq;
            this.jdField_d_of_type_Long = 0L;
            this.jdField_e_of_type_Int = 0;
            k = localacuj.jdField_a_of_type_AndroidViewView.getTop();
            ...
            this.jdField_g_of_type_Int = a((localacuj.jdField_a_of_type_AndroidViewView.getLeft() + localacuj.jdField_a_of_type_AndroidViewView.getRight()) / 2, localacuj);
            this.h = 0;
      ...
      if (localBaseChatItemLayout != null)
      {
        ...
        if (localacuj != null)
        {
          ...
          this.jdField_e_of_type_Int = (a(this.i, localacuj) - this.i);
  ...
  public boolean a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      while ((this.jdField_a_of_type_ComTencentMobileqqActivityAioAnimAIOAnimationConatiner == null) || (this.jdField_a_of_type_AndroidViewView == null))
      {
        ...
        return false;
        k = actj.a(this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentWidgetListView.getAdapter());
        ...
        {
          acuj localacuj = (acuj)actj.a(actj.a(this.jdField_a_of_type_ComTencentWidgetListView, k));
          if (localacuj != null)
          {
            k = localacuj.jdField_a_of_type_AndroidViewView.getTop();
            k = localacuj.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() + k + BaseChatItemLayout.jdField_g_of_type_Int - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - (this.h + this.jdField_f_of_type_Int);
            if (k != 0)
            {
              this.h += k;
              this.j += k;
          ...
          else
          {
            ...
            return false;
            k = actj.a(this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentWidgetListView.getAdapter());
            int m = actj.a(this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentWidgetListView.getAdapter());
            ...
            {
              localacuj = (acuj)actj.a(actj.a(this.jdField_a_of_type_ComTencentWidgetListView, k));
              if (localacuj != null)
              {
                k = localacuj.jdField_a_of_type_AndroidViewView.getTop();
                k = localacuj.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() + k + BaseChatItemLayout.jdField_g_of_type_Int - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - (this.h + this.jdField_f_of_type_Int);
            ...
            {
              localacuj = (acuj)actj.a(actj.a(this.jdField_a_of_type_ComTencentWidgetListView, m));
              if (localacuj != null)
              {
                k = localacuj.jdField_a_of_type_AndroidViewView.getTop();
                k = localacuj.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() + k + BaseChatItemLayout.jdField_g_of_type_Int - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - (this.h + this.jdField_f_of_type_Int);
