  ...
  implements Manager
{
  ...
  List<bprf> jdField_a_of_type_JavaUtilList = Collections.synchronizedList(new LinkedList());
  public Map<String, Integer> a;
  Timer jdField_a_of_type_JavaUtilTimer;
  public PriorityBlockingQueue<bprf> a;
  public AtomicBoolean a;
  public AtomicInteger a;
  List<bprf> b;
  public PriorityBlockingQueue<bprf> b;
  public AtomicInteger b;
  List<bprf> c = Collections.synchronizedList(new LinkedList());
  List<bprf> d = Collections.synchronizedList(new LinkedList());
  ...
  public bprd(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Bprl = new bpre(this);
  }
  ...
  public void a(bprf parambprf)
  {
    bpqy.a(parambprf, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    if (QLog.isColorLevel()) {
      QLog.d("ShortVideoPreDownloader", 2, "launchRequest:" + parambprf.a.busiType);
    }
  }
