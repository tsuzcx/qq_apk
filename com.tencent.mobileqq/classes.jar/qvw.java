...
public class qvw
  implements quf
{
  private static final String jdField_a_of_type_JavaLangString = qvw.class.getSimpleName();
  ...
  {
    if (paramInt1 == 2) {
      onx.a().a(paramString1, "PubAccountArticleCenter.GetUrlByVid", new qvx(this, paramString1, paramInt2, paramLong));
    }
    do
    {
      do
      ...
      } while (this.jdField_a_of_type_Qvz == null);
      paramString2 = (String)this.jdField_a_of_type_JavaUtilHashMap.get(paramString1);
    } while (TextUtils.isEmpty(paramString2));
    this.jdField_a_of_type_Qvz.a(paramString1, 1, paramString2);
  }
  ...
  private void a(String paramString1, String paramString2, long paramLong, int paramInt)
  {
    ...
    if (paramString1 != null) {
      ...
      {
        localObject = nmf.a(paramString1);
      }
    }
    ...
    ((TVK_PlayerVideoInfo)localObject).setConfigMap("cache_servers_type", qua.jdField_a_of_type_JavaLangString);
    if (paramLong > 0L) {
  ...
  private void d()
  {
    ...
    this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_ICacheMgr.setPreloadCallback(new qvy(this));
  }
  ...
  public void b()
  {
    this.jdField_a_of_type_Qvz = null;
