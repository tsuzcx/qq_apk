  ...
  implements Manager
{
  ...
  private HashMap<Long, WeakReference<awav>> jdField_a_of_type_JavaUtilHashMap = new HashMap(5);
  private boolean jdField_a_of_type_Boolean = true;
  private HashMap<Long, WeakReference<awat>> b = new HashMap(20);
  private HashMap<Long, Boolean> c = new HashMap(200);
  private HashMap<Long, WeakReference<awau>> d = new HashMap(5);
  ...
  public awas(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Atud = ((atud)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(323));
  }
  ...
  private ArrayList<Long> a(long paramLong)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 58	awas:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   20: aload_0
    //   21: getfield 58	awas:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   24: invokevirtual 95	com/tencent/mobileqq/app/QQAppInterface:getCurrentUin	()Ljava/lang/String;
    //   27: invokevirtual 99	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   30: ldc 101
    //   32: invokevirtual 99	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   35: lload_1
    //   36: invokevirtual 104	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   39: invokevirtual 107	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   42: ldc 109
    //   44: invokeinterface 115 3 0
    //   49: astore 5
    //   51: aload 5
    //   53: invokestatic 121	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   56: ifne +125 -> 181
    //   59: new 123	org/json/JSONArray
    //   62: dup
    //   63: aload 5
    //   65: invokespecial 126	org/json/JSONArray:<init>	(Ljava/lang/String;)V
    //   68: astore 7
    //   70: new 128	java/util/ArrayList
    //   73: dup
    //   74: aload 7
    //   76: invokevirtual 132	org/json/JSONArray:length	()I
    //   79: invokespecial 133	java/util/ArrayList:<init>	(I)V
    //   82: astore 5
    //   84: aload 7
    //   86: invokevirtual 132	org/json/JSONArray:length	()I
    //   89: istore 4
    //   91: iconst_0
    //   92: istore_3
    //   93: aload 5
    ...
    //   105: aload 7
    //   107: iload_3
    //   108: invokevirtual 137	org/json/JSONArray:optLong	(I)J
    //   111: invokestatic 143	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   114: invokevirtual 147	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   117: pop
    //   118: iload_3
    //   119: iconst_1
    //   120: iadd
    ...
    //   130: aload 5
    //   132: astore 6
    //   134: invokestatic 153	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   137: ifeq +36 -> 173
    //   140: ldc 155
    //   142: iconst_2
    ...
    //   155: aload 7
    //   157: invokevirtual 158	org/json/JSONException:toString	()Ljava/lang/String;
    //   160: invokevirtual 99	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   163: invokevirtual 107	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   166: invokestatic 161	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   169: aload 5
    //   171: astore 6
    //   173: aload 6
    //   175: areturn
  ...
  private void a(long paramLong, awav paramawav)
  {
    ThreadManager.getSubThreadHandler().post(new MultiCardManager.3(this, paramLong, paramawav));
  }
  
  private void a(long paramLong, ArrayList<Long> paramArrayList, awat paramawat)
  {
    ThreadManager.getSubThreadHandler().post(new MultiCardManager.2(this, paramLong, paramArrayList, paramawat));
  }
  
  private void a(long paramLong, ArrayList<Long> paramArrayList, awau paramawau)
  {
    ThreadManager.getSubThreadHandler().post(new MultiCardManager.1(this, paramArrayList, paramLong, paramawau));
  }
  ...
  public IntimateInfo a(long paramLong1, long paramLong2)
  {
    ...
    if (localIntimateInfo2 == null)
    {
      ...
      localIntimateInfo2 = this.jdField_a_of_type_Atud.a(str);
  ...
  public void a(long paramLong)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Awaw);
      this.jdField_a_of_type_Awaw = null;
    }
    if (this.jdField_a_of_type_Awax != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Awax);
      this.jdField_a_of_type_Awax = null;
    }
    if (this.jdField_a_of_type_Away != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Away);
  ...
  public void a(Context paramContext, long paramLong, ArrayList<Long> arg4, awat paramawat)
  {
    if (QLog.isColorLevel())
    {
    ...
    for (Object localObject1 = ???.toString();; localObject1 = "null")
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (paramawat != null) && (??? != null))
      {
        if (NetworkUtil.isNetSupport(paramContext)) {
          break;
        }
        a(paramLong, ???, paramawat);
      }
      return;
    }
    ...
    a(paramLong, ???, paramawat);
    paramawat = new WeakReference(paramawat);
    synchronized (this.b)
    {
      this.b.put(Long.valueOf(paramLong), paramawat);
      ??? = new HashMap(5);
      ???.put("alreadyRequest", localObject1);
      ???.put("notRequest", paramContext);
      paramawat = new ArrayList(1);
      paramawat.add(Long.valueOf(paramLong));
      ???.put("groupUin", paramawat);
      ((atub)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(153)).a(paramLong, paramContext, ???);
      return;
    }
  }
  
  public void a(Context arg1, long paramLong, ArrayList<Long> paramArrayList, awau paramawau)
  {
    Object localObject2;
    if (QLog.isColorLevel())
    {
    ...
    {
      QLog.d("MultiCardManager", 2, (String)localObject1);
      if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (paramawau != null) && (paramArrayList != null))
      {
        if (NetworkUtil.isNetSupport(???)) {
          break;
        }
        a(paramLong, paramArrayList, paramawau);
      }
      return;
    }
    synchronized (this.e)
    ...
    for (;;)
    {
      ...
      paramArrayList = new WeakReference(paramawau);
      synchronized (this.d)
      {
        this.d.put(Long.valueOf(paramLong), paramArrayList);
        ((anca)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(20)).a(false, paramLong + "", "0", 9);
        return;
        label317:
  ...
  public void a(String paramString, IntimateInfo paramIntimateInfo)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Atud.a(paramString, paramIntimateInfo);
