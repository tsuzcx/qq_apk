...
class zpc
  extends baua
{
  zpc(zpa paramzpa, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    if ((localObject == null) || (((baoj)localObject).jdField_b_of_type_Int != 24)) {}
    while (((baoj)localObject).c != 7) {
      return;
    }
    ...
    case 1003: 
      ...
      localBundle.putLong("uniseq", ((baoj)localObject).jdField_b_of_type_Long);
      localBundle.putString("fileUrl", ((baoj)localObject).i);
      localObject = ((baoj)localObject).i;
      if (localObject != null)
      {
