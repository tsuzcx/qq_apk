  ...
  implements zph
{
  ...
  public zpc()
  {
    ...
    this.jdField_a_of_type_JavaLangString = anvx.a(2131701767);
    this.jdField_b_of_type_JavaLangString = anvx.a(2131701841);
    this.jdField_c_of_type_JavaLangString = anvx.a(2131701840);
    this.jdField_d_of_type_JavaLangString = anvx.a(2131697697);
    this.jdField_e_of_type_JavaLangString = anvx.a(2131708317);
  ...
  protected RecyclerView.ViewHolder b(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    return new zpf(this.jdField_a_of_type_ComTencentBizRichframeworkPartBlockBaseRefreshHeaderView);
  }
  ...
  {
    if ((paramViewHolder instanceof zpe))
    {
      paramViewHolder = (zpe)paramViewHolder;
      if (!this.jdField_f_of_type_Boolean)
      {
        zpe.a(paramViewHolder).setVisibility(8);
    ...
    {
      bool = true;
      zpe.a(paramViewHolder).setIndeterminate(bool);
      localProgressBar = zpe.a(paramViewHolder);
      if (!bool) {
        break label146;
      }
    }
    ...
    for (paramInt = 0;; paramInt = 8)
    {
      ...
      zpe.a(paramViewHolder).setVisibility(8);
      zpe.a(paramViewHolder).setVisibility(0);
    ...
    label152:
    zpe.a(paramViewHolder).setVisibility(0);
    zpe.a(paramViewHolder).setText(this.jdField_f_of_type_JavaLangString);
    if (this.jdField_a_of_type_AndroidViewView != null) {
      zpe.a(paramViewHolder).setVisibility(8);
    }
  ...
  {
    paramViewGroup = new zpe(LayoutInflater.from(paramViewGroup.getContext()).inflate(2131560753, paramViewGroup, false));
    if (this.jdField_a_of_type_AndroidViewView != null) {
      zpe.a(paramViewGroup).addView(this.jdField_a_of_type_AndroidViewView);
    }
  ...
  public void onAttachedToRecyclerView(RecyclerView paramRecyclerView)
  {
    ...
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.addOnScrollListener(new zpd(this));
  }
