...
public final class bmhk
  extends bmgk
  implements Handler.Callback, bmhb, bmhh, bmht
{
  private Application jdField_a_of_type_AndroidAppApplication;
  private Handler jdField_a_of_type_AndroidOsHandler;
  private bmge jdField_a_of_type_Bmge;
  private bmgy jdField_a_of_type_Bmgy;
  private bmhe jdField_a_of_type_Bmhe;
  private bmhp jdField_a_of_type_Bmhp;
  private bmhr jdField_a_of_type_Bmhr;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private PluginUpdater jdField_a_of_type_CooperationPluginPluginUpdater;
  private Object jdField_a_of_type_JavaLangObject = new Object();
  private ArrayList<bmho> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public bmhk(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Bmhr = new bmhr(this.jdField_a_of_type_AndroidAppApplication, this, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_a_of_type_CooperationPluginPluginUpdater.a(this);
    this.jdField_a_of_type_Bmgy = new bmgy(this.jdField_a_of_type_AndroidAppApplication, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    try
    {
      this.jdField_a_of_type_Bmhe = new bmhe(this.jdField_a_of_type_AndroidAppApplication, bmgy.a(this.jdField_a_of_type_AndroidAppApplication).getCanonicalPath());
      label160:
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
      this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
      this.jdField_a_of_type_Bmge = bmge.a(this.jdField_a_of_type_AndroidAppApplication);
      this.jdField_a_of_type_Bmhp = new bmhp(this);
      this.jdField_a_of_type_Bmhp.a();
      PluginCommunicationHandler localPluginCommunicationHandler = PluginCommunicationHandler.getInstance();
      localPluginCommunicationHandler.setCommunicationChannel(new bmhu());
      localPluginCommunicationHandler.register(new bmhv(paramQQAppInterface));
  ...
  {
    if (paramBoolean) {}
    for (paramString = anzj.a(2131707164) + paramString + "（" + bmgf.a(paramLong) + anzj.a(2131707161);; paramString = paramString + "（" + bmgf.a(paramLong) + anzj.a(2131707163)) {
      return new AlertDialog.Builder(paramContext).setMessage(paramString).setNegativeButton(anzj.a(2131707162), paramOnClickListener2).setPositiveButton(anzj.a(2131707166), paramOnClickListener1).create();
    }
  }
  ...
  private static ProgressDialog a(Context paramContext, String paramString, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    paramContext.setMessage(anzj.a(2131707165));
    paramContext.setCancelable(false);
    paramContext.setButton(-2, anzj.a(2131707167), new bmhl(paramOnClickListener));
    return paramContext;
  }
  
  private void a(int paramInt, Context paramContext, bmgt parambmgt, bmgr parambmgr)
  {
    a(paramInt, false, paramContext, parambmgt, parambmgr);
  }
  
  private void a(int paramInt, boolean paramBoolean, Context paramContext, bmgt parambmgt, bmgr parambmgr)
  {
    QLog.d("plugin_tag", 1, "doInstallAndLaunch. confirmCode, pluginId:" + paramInt + "," + parambmgt.b + ", " + this.c);
    if ((!this.c) && (!bmge.b(parambmgt.b))) {
      if (parambmgr != null) {
    ...
    do
    {
      ...
      localObject1 = this.jdField_a_of_type_Bmhe.a(parambmgt.b);
      if ((localObject1 != null) && (((PluginInfo)localObject1).mInstalledPath != null))
      {
        parambmgt.c = ((PluginInfo)localObject1).mInstalledPath;
        parambmgt.a((PluginBaseInfo)localObject1);
      }
      parambmgr.a(true, paramContext, parambmgt);
      return;
      if (paramInt == 4)
      {
        localObject1 = parambmgt.b;
        localObject2 = new bmho();
        ((bmho)localObject2).jdField_a_of_type_AndroidContentContext = paramContext;
        ((bmho)localObject2).jdField_a_of_type_Bmgt = parambmgt;
        ((bmho)localObject2).jdField_a_of_type_Bmgr = parambmgr;
        ((bmho)localObject2).jdField_a_of_type_Boolean = true;
        a((String)localObject1, new bmhq(this, (bmho)localObject2));
        return;
      }
      if (paramInt == 1)
      {
        localObject2 = parambmgt.b;
        ...
        {
          bmho localbmho = new bmho();
          localbmho.jdField_a_of_type_AndroidContentContext = paramContext;
          localbmho.jdField_a_of_type_Bmgt = parambmgt;
          localbmho.jdField_a_of_type_Bmgr = parambmgr;
          localbmho.jdField_a_of_type_Boolean = false;
          localbmho.jdField_a_of_type_AndroidAppProgressDialog = a(paramContext, (String)localObject1, new bmhm(this, parambmgt.b, null));
          a((String)localObject2, paramBoolean, new bmhq(this, localbmho));
          return;
        }
      }
    } while (paramInt != 3);
    Object localObject1 = parambmgt.b;
    Object localObject2 = new bmho();
    ((bmho)localObject2).jdField_a_of_type_AndroidContentContext = paramContext;
    ((bmho)localObject2).jdField_a_of_type_Bmgt = parambmgt;
    ((bmho)localObject2).jdField_a_of_type_Bmgr = parambmgr;
    ((bmho)localObject2).jdField_a_of_type_Boolean = true;
    a((String)localObject1, paramBoolean, new bmhq(this, (bmho)localObject2));
  }
  
  private void a(String paramString, bmgs parambmgs)
  {
    if (QLog.isColorLevel()) {
      QLog.d("plugin_tag", 2, "doQueryPlugin: " + paramString + ", " + parambmgs);
    }
    ...
    b();
    parambmgs.a(paramString, localPluginInfo1, this);
  }
  ...
  {
    paramString = this.jdField_a_of_type_Bmge.a(paramString);
    if (paramString == null) {
      return false;
    }
  ...
  private PluginInfo b(String paramString)
  {
    ...
    {
      PluginInfo localPluginInfo = this.jdField_a_of_type_Bmhe.a(paramString);
      if (QLog.isColorLevel()) {
  ...
  private void b()
  {
    ...
    try
    {
      bhmi.a(localFile1.getCanonicalPath());
      bhmi.a(localFile2.getCanonicalPath());
      return;
    }
    catch (IOException localIOException) {}
  }
  ...
  private void c(Context paramContext, bmgt parambmgt, bmgr parambmgr)
  {
    int j = 2;
    boolean bool2 = false;
    boolean bool3 = true;
    ...
    do
    {
      ...
      {
        return;
        QLog.d("plugin_tag", 1, "checkUpdate:" + parambmgt.b + ", " + parambmgt.e);
        if ((this.c) || (bmge.b(parambmgt.b))) {
          break;
        }
      } while (parambmgr == null);
      parambmgr.a(false, paramContext, parambmgt);
      return;
      String str = parambmgt.b;
      localPluginInfo2 = this.jdField_a_of_type_CooperationPluginPluginUpdater.a(str);
      if (localPluginInfo2 == null)
      {
        a(0, paramContext, parambmgt, parambmgr);
        return;
      }
      bool4 = this.jdField_a_of_type_Bmhe.a(str);
      if (QLog.isColorLevel()) {
        QLog.d("plugin_tag", 2, "installed :" + bool4);
      }
      if (bool4)
      {
        PluginInfo localPluginInfo1 = this.jdField_a_of_type_Bmhe.a(str);
        ...
        if (bool1)
        {
          ...
          if (a())
          {
            ...
            {
              if (!bmhc.a(localPluginInfo2, this.jdField_a_of_type_AndroidAppApplication)) {
                break label309;
              }
          ...
          for (;;)
          {
            a(i, paramContext, parambmgt, parambmgr);
            return;
            i = 4;
      ...
      if ((!bmhc.a(localPluginInfo2, this.jdField_a_of_type_AndroidAppApplication)) || (localObject == null)) {
        break;
      }
      if (QLog.isColorLevel()) {
    ...
    parambmgt.c = ((PluginInfo)localObject).mInstalledPath;
    parambmgt.a((PluginBaseInfo)localObject);
    parambmgr.a(true, paramContext, parambmgt);
    return;
    ...
    for (;;)
    {
      ...
      a(3, paramContext, parambmgt, parambmgr);
      return;
      bool1 = bool3;
    ...
    {
      parambmgt = new bmhn(this, parambmgr, bool1, paramContext, parambmgt, bool4, (String)localObject, null);
      a(paramContext, localPluginInfo2.mName, localPluginInfo2.mLength, parambmgt, parambmgt, bool1).show();
      return;
    }
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if (!this.jdField_a_of_type_Boolean)
        {
          ...
          if (!bhnv.g(this.jdField_a_of_type_AndroidAppApplication)) {
            a(false);
          } else {
  ...
  public void a(Context paramContext, bmgt parambmgt, bmgr parambmgr)
  {
    if ((!this.c) && (!bmge.b(parambmgt.b)))
    {
      if (QLog.isColorLevel()) {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        if (!this.jdField_a_of_type_JavaUtilArrayList.isEmpty())
        {
          ...
          localbmho.jdField_a_of_type_Bmgt = parambmgt;
          localbmho.jdField_a_of_type_Bmgr = parambmgr;
          this.jdField_a_of_type_JavaUtilArrayList.add(localbmho);
          return;
        }
        synchronized (this.jdField_a_of_type_JavaLangObject)
        {
    ...
    c(paramContext, parambmgt, parambmgr);
  }
  ...
  public void a(String paramString, OnPluginInstallListener paramOnPluginInstallListener)
  {
    ...
    if (bmhc.a(localPluginInfo, this.jdField_a_of_type_AndroidAppApplication))
    {
    ...
    this.jdField_a_of_type_Bmhe.b(localPluginInfo, this);
  }
  ...
  public void a(String paramString1, String paramString2, long paramLong)
  {
    ...
    paramString1 = this.jdField_a_of_type_Bmhe.a(paramString1);
  ...
  public void a(String paramString, boolean paramBoolean1, boolean paramBoolean2, OnPluginInstallListener paramOnPluginInstallListener)
  {
    ...
    if (paramBoolean1)
    {
      localPluginInfo1 = this.jdField_a_of_type_Bmge.a(paramString);
    ...
    for (;;)
    {
      ...
      localPluginInfo1 = localPluginInfo2.a();
      break;
      if (bmhc.a(localPluginInfo1, this.jdField_a_of_type_AndroidAppApplication))
      {
      ...
      {
        this.jdField_a_of_type_Bmhe.a(localPluginInfo1, this);
        return;
      }
      this.jdField_a_of_type_Bmgy.a(localPluginInfo1, this, paramBoolean2);
      return;
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        bmho localbmho = (bmho)localIterator.next();
        c(localbmho.jdField_a_of_type_AndroidContentContext, localbmho.jdField_a_of_type_Bmgt, localbmho.jdField_a_of_type_Bmgr);
      }
      this.jdField_a_of_type_Bmhr.a();
    }
  ...
  public void a(boolean paramBoolean, String paramString)
  {
    ...
    if (localObject != null)
    {
      ...
      this.jdField_a_of_type_Bmhe.a((PluginInfo)localObject, this);
    }
    label72:
    do
    {
  ...
  {
    this.jdField_a_of_type_Bmgy.a(paramPluginInfo.mID);
    return this.jdField_a_of_type_Bmhe.b(paramPluginInfo.mID);
  }
  ...
  public void c(String paramString)
  {
    ...
    if (localObject != null)
    {
      ...
      ((PluginInfo)localObject).a = bhnv.b(this.jdField_a_of_type_AndroidAppApplication);
    }
    localObject = (OnPluginInstallListener)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
    if (localObject != null) {}
    try
  ...
  {
    this.jdField_a_of_type_Bmgy.a(paramString);
    this.jdField_a_of_type_Bmhe.b(paramString);
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    default: 
      return true;
    case 65536: 
      a(paramMessage.getData().getString("index_for_id"), (bmgs)paramMessage.obj);
      return true;
    case 66049: 
      e();
      return true;
