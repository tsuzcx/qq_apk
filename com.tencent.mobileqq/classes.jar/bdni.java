...
public class bdni
{
  ...
  public bdni(View paramView, int paramInt, bdnk parambdnk)
  {
  ...
  public static int a(int paramInt)
  {
    int i;
    if (paramInt == 0) {
      i = aepi.a(210.0F, BaseApplicationImpl.getContext().getResources());
    }
    do
    {
      return i;
  ...
  private static int b()
  {
    ...
    if (bidj.a(localBaseApplication)) {
      i = bidj.a(localBaseApplication);
    }
  ...
  private void b()
  {
    this.jdField_a_of_type_AndroidViewViewTreeObserver$OnGlobalLayoutListener = new bdnj(this);
  }
  ...
  public int a()
  {
    ...
    if (localSharedPreferences.contains("key_height"))
    {
      ...
      this.jdField_a_of_type_Bdnk.a(i, true);
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
