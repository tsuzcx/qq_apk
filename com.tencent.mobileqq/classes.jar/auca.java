  ...
  implements Handler.Callback
{
  ...
  public auca(aubt paramaubt, ViewGroup paramViewGroup)
  {
    this.jdField_a_of_type_Aubt = paramaubt;
    this.jdField_a_of_type_AndroidViewView = paramaubt.a().getLayoutInflater().inflate(2131560878, paramViewGroup, false);
    int i = View.MeasureSpec.makeMeasureSpec(0, 0);
    this.jdField_a_of_type_AndroidViewView.measure(i, i);
    TextView localTextView1 = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374633);
    TextView localTextView2 = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374631);
    paramViewGroup = (AsyncImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374632);
    String str = paramaubt.a();
    int j = paramaubt.a();
    localTextView1.setText(atvo.a(str, true, localTextView1.getMeasuredWidth(), localTextView1.getPaint(), 2));
    localTextView2.setText(atwl.a(paramaubt.a()));
    paramViewGroup.setImageResource(atvo.b(str));
    if ((j == 5) || (j == 0))
    {
      paramaubt = paramaubt.b();
      if (atwl.b(paramaubt))
      {
        if (j != 5) {
          break label268;
        }
        paramViewGroup.setApkIconAsyncImage(paramaubt);
      }
    }
    for (;;)
    {
      paramViewGroup.setSupportMaskView(false);
      ((AsyncImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374612)).setSupportMaskView(false);
      this.jdField_a_of_type_AndroidViewView.measure(i, i);
      ...
      this.b = new bkfv(ThreadManagerV2.getFileThreadLooper(), this, false);
      return;
      label268:
      paramViewGroup.setAsyncImage(paramaubt);
    }
  }
  ...
  private Bitmap a(Bitmap paramBitmap, int paramInt, String paramString)
  {
    ...
    localAsyncImageView = (AsyncImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374612);
    localAsyncImageView.setImageBitmap(paramBitmap);
    TextView localTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374635);
    BaseApplicationImpl localBaseApplicationImpl = BaseApplicationImpl.sApplication;
    if (TextUtils.isEmpty(paramString))
    {
      paramBitmap = new StringBuilder().append(BaseApplicationImpl.sApplication.getString(2131697438)).append(":");
      paramString = BaseApplicationImpl.sApplication;
      if (paramInt == 1) {
        paramInt = 2131697436;
      }
    }
    for (paramBitmap = paramString.getString(paramInt);; paramBitmap = BaseApplicationImpl.sApplication.getString(2131697439) + ":" + paramString)
    {
      localTextView.setText(localBaseApplicationImpl.getString(2131697429, new Object[] { paramBitmap }));
      try
      {
  ...
  private static String a(Bitmap paramBitmap)
  {
    ...
    try
    {
      paramBitmap = zvc.a(BaseApplicationImpl.sApplication, str, paramBitmap);
      return paramBitmap;
    }
  ...
  private void a(ShareActionSheetBuilder.ActionSheetItem paramActionSheetItem, Bitmap paramBitmap, String paramString)
  {
    ...
    do
    {
      ...
      localObject = this.jdField_a_of_type_Aubt.a();
    ...
    {
      aubv.a(1, 2131695774, true);
      return;
    }
    if (paramString == null)
    {
      if (i == 39) {}
      for (i = 2131715855;; i = 2131695773)
      {
        aubv.a(1, i, true);
        return;
      }
    ...
    case 2: 
      ...
      aufz.a((Activity)localObject, paramActionSheetItem, 1, -1);
      return;
    case 3: 
      paramActionSheetItem = blsi.a();
      ...
      blsb.a((Activity)localObject, paramActionSheetItem, paramString, ((BaseActivity)localObject).getString(2131691908), ((BaseActivity)localObject).getString(2131697429, new Object[] { "" }), 2);
      return;
    case 9: 
    case 10: 
      paramActionSheetItem = this.jdField_a_of_type_Aubt.c();
    ...
    case 39: 
      ...
      aubv.a(2, ((BaseActivity)localObject).getString(2131715857, new Object[] { paramString }), true);
      return;
    }
    ...
    aufz.a((Activity)localObject, paramActionSheetItem, ForwardRecentTranslucentActivity.class, 1, -1, "");
  }
  ...
  private static String b(Bitmap paramBitmap)
  {
    ...
    //   22: dup
    //   23: getstatic 462	anhk:bg	Ljava/lang/String;
    ...
    //   60: getstatic 462	anhk:bg	Ljava/lang/String;
    ...
    //   118: getstatic 462	anhk:bg	Ljava/lang/String;
  ...
  public void a(ShareActionSheetBuilder.ActionSheetItem paramActionSheetItem)
  {
    ...
    do
    {
      do
      {
        return;
        i = paramActionSheetItem.action;
        if ((i == 39) || (bgnt.d(this.jdField_a_of_type_Aubt.a()))) {
          break;
        }
        aubv.a(0, 2131691985, false);
    ...
    if (this.jdField_a_of_type_Biau == null)
    {
      this.jdField_a_of_type_Biau = new biau(this.jdField_a_of_type_Aubt.a());
  ...
  public boolean a(Bitmap paramBitmap, int paramInt, String paramString)
  {
    ...
    if (paramBitmap == null)
    {
      aubv.a(1, BaseApplicationImpl.sApplication.getResources().getString(2131697423, new Object[] { Integer.valueOf(-2) }), true);
      return false;
    }
    this.jdField_a_of_type_Aubt.a(paramBitmap);
