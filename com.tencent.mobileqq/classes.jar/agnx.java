...
import com.tencent.mobileqq.activity.aio.item.ArkAppContainer.4;
...
{
  public static int a;
  private static final ark.ApplicationCallback a;
  public static String a;
  protected static ArrayList<WeakReference<agnx>> a;
  ...
  public String b;
  protected boolean b;
  protected WeakReference<agnx> c;
  boolean c;
  private String d;
  protected WeakReference<agoa> d;
  protected boolean d;
  ...
  static
  {
    ...
    jdField_a_of_type_ComTencentArkArk$ApplicationCallback = new agny();
  }
  
  public agnx() {}
  
  public agnx(boolean paramBoolean) {}
  ...
  public static WeakReference<agnx> a(ark.Container paramContainer)
  {
    int i = 0;
    while (i < jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      agnx localagnx = (agnx)localWeakReference.get();
      if ((localagnx != null) && (localagnx.getContainer() == paramContainer)) {
  ...
  private static void a()
  {
    ...
    ArkDispatchTask.getInstance().postToMainThread(new ArkAppContainer.2());
  }
  ...
  private static void b(ArkAppMgr.AppPathInfo paramAppPathInfo)
  {
    ...
    for (String str = paramAppPathInfo.desc.name;; str = "")
    {
      ...
      if (paramAppPathInfo != null)
      {
        paramAppPathInfo = (ArkAppCenter)paramAppPathInfo.getManager(QQManagerFactory.ARK_APP_CENTER_MANAGER);
        if (paramAppPathInfo != null)
        {
  ...
  {
    this.jdField_d_of_type_JavaLangRefWeakReference = new WeakReference(paramagoa);
  }
  
  public void a(SessionInfo paramSessionInfo, String paramString)
  {
    jdField_c_of_type_JavaLangString = "";
    if ((paramSessionInfo.curType == 0) || (paramSessionInfo.curType == 1008)) {
  ...
  {
    agoa localagoa = (agoa)this.jdField_d_of_type_JavaLangRefWeakReference.get();
    if (localagoa != null) {
      localagoa.openCardView(this, paramString1, paramString2);
    }
  }
  ...
  public boolean a(String paramString1, String paramString2, String paramString3, String paramString4, float paramFloat, SessionInfo paramSessionInfo)
  {
    ...
    if (paramSessionInfo.curType == 1) {
      jdField_a_of_type_JavaLangString = paramSessionInfo.curFriendUin;
    }
    this.jdField_b_of_type_Int = paramSessionInfo.curType;
  ...
  public void applicationCreate(ark.Application paramApplication)
  {
  ...
  public void onFirstDrawEnd()
  {
    ...
    ThreadManager.executeOnSubThread(new ArkAppContainer.4(this));
  }
  ...
  public boolean onLoadApp(ArkViewModelBase.AppInfo paramAppInfo)
  {
    ...
    for (Object localObject2 = str2;; localObject2 = str2)
    {
      ...
      {
        b(localAppPathInfo);
        ArkDispatchTask.getInstance().post(this.mAppInfo.name, new ArkAppContainer.3(this, (String)localObject1));
        return true;
      }
      ...
      ArkAppMgr.getInstance().getAppPathByName(paramAppInfo.name, paramAppInfo.view, paramAppInfo.appMinVersion, null, new agnz(this.jdField_c_of_type_JavaLangRefWeakReference));
      return false;
      bool = false;
    }
  }
  ...
  public void onLoadReport(int paramInt)
  {
    if (this.mAppInfo != null) {
      apyp.a(a(), this.mAppInfo.name, "ArkAppLoadState", paramInt, 0, 0L, 0L, 0L, this.mAppInfo.view, "");
    }
  }
  ...
  public void onRunAppFailed()
  {
    ...
    if (localObject != null)
    {
      ...
      localObject = ((ArkViewImplement)localObject).getView().getContext().getString(2131693525);
    ...
    for (this.mErrorInfo.canRetry = true;; this.mErrorInfo.canRetry = false)
    {
      ...
      return;
      label72:
      localObject = ((ArkViewImplement)localObject).getView().getContext().getString(2131693526);
      this.mErrorInfo.msg = a((String)localObject);
    }
  }
}
