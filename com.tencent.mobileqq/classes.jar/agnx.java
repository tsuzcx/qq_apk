...
public class agnx
{
  ...
  private Set<agob> jdField_a_of_type_JavaUtilSet;
  private boolean jdField_a_of_type_Boolean;
  private Set<Integer> jdField_b_of_type_JavaUtilSet;
  
  static
  {
    jdField_a_of_type_JavaLangString = bigv.a(antf.aZ + "/Tencent/MobileQQ/pttPanelAnimations/");
    jdField_b_of_type_JavaLangString = bigv.a(antf.aZ + "/Tencent/MobileQQ/pttPanelAnimations/qq_android_ptt_transition_anim_res/");
  }
  ...
  private void a(Animator paramAnimator, int paramInt)
  {
    ...
    {
      agob localagob = (agob)localIterator.next();
      if (localagob != null) {
        localagob.a(paramAnimator, paramInt);
      }
    }
  }
  ...
  private void a(LottieDrawable paramLottieDrawable, int paramInt)
  {
    ...
    while (localIterator.hasNext())
    {
      agob localagob = (agob)localIterator.next();
      if (localagob != null) {
        localagob.a(paramLottieDrawable, paramInt);
      }
    }
  }
  ...
  public void a(agob paramagob)
  {
    this.jdField_a_of_type_JavaUtilSet.add(paramagob);
  }
  ...
  public void a(LottieDrawable paramLottieDrawable, int paramInt, ImageView paramImageView, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      paramLottieDrawable.addAnimatorListener(new agnz(this, paramLottieDrawable, paramInt, paramImageView));
    } while (!paramBoolean);
