  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          localObject = new NewIntent(BaseApplicationImpl.getApplication(), bhfy.class);
          ...
          ((NewIntent)localObject).putExtra("has_report_yes", new Boolean(bhfq.jdField_a_of_type_Boolean));
          BaseApplicationImpl.getApplication().getRuntime().startServlet((NewIntent)localObject);
          bhfq.jdField_a_of_type_Float = bhfq.jdField_a_of_type_Int - bhfq.b + bhfq.c;
          localObject = BaseApplicationImpl.getApplication().getRuntime().getAccount();
          if (!TextUtils.isEmpty((CharSequence)localObject)) {
            bhfq.jdField_a_of_type_JavaLangString = (String)localObject;
          }
          bhfq.jdField_a_of_type_Long = NetConnInfoCenter.getServerTimeMillis();
          QLog.i("SSOHttpUtils", 1, "SSOHttpUtils do report success steps:" + bhfq.jdField_a_of_type_Float);
        }
        ...
        if (((JSONObject)localObject).has("svr_steps"))
        {
          ...
          paramBundle = new NewIntent(BaseApplicationImpl.getApplication(), bhfy.class);
