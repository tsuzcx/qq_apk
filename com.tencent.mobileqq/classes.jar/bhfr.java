...
public class bhfr
{
  ...
  public static String a()
  {
    ...
    if (ThemeBackground.sAIOBusinessFlag.useStatic)
    {
      l1 = l2 | 0x800;
      if (!ThemeBackground.sRecentBusinessFlag.useStatic) {
        break label151;
      }
      l2 = l1 | 0x10000;
    }
    for (;;)
    {
      ...
      if (ThemeBackground.sAIOBusinessFlag.useEffect)
      {
        l1 = l2 | 0x1000;
        break;
      }
      if (ThemeBackground.sAIOBusinessFlag.useApng)
      {
        l1 = l2 | 0x2000;
        break;
      }
      if (ThemeBackground.sAIOBusinessFlag.useVideo)
      {
        l1 = l2 | 0x4000;
        break;
      }
      l1 = l2;
      if (!ThemeBackground.sAIOBusinessFlag.use3D) {
        break;
      }
      l1 = l2 | 0x8000;
      break;
      label151:
      if (ThemeBackground.sRecentBusinessFlag.useApng)
      {
        l2 = l1 | 0x20000;
      }
      else if (ThemeBackground.sRecentBusinessFlag.useVideo)
      {
        l2 = l1 | 0x40000;
      }
      else
      {
        l2 = l1;
        if (ThemeBackground.sRecentBusinessFlag.useAETC) {
          l2 = l1 | 0x80000;
        }
      }
    }
  ...
  {
    new bhfs(paramString1, paramInt, paramString2).execute(new Void[0]);
  }
