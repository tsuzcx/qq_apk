...
public class bjrl
{
  private static bjrl jdField_a_of_type_Bjrl;
  ...
  public static bjrl a()
  {
    if (jdField_a_of_type_Bjrl == null) {}
    try
    {
      if (jdField_a_of_type_Bjrl == null) {
        jdField_a_of_type_Bjrl = new bjrl();
      }
      return jdField_a_of_type_Bjrl;
    }
    finally {}
  }
  ...
  private HashMap<String, Object> a(String paramString1, String paramString2, String[] paramArrayOfString)
  {
    ...
    do
    {
      ...
      {
        return paramString1;
        localObject1 = bjpx.a("com.adobe.xmp.XmpUtil", "extractXMPMeta", false, a(new Class[] { String.class }), new Object[] { paramString1 });
    ...
    for (;;)
    {
      i += 1;
      break;
      Object localObject2 = bjpx.a(localObject1, "getProperty", false, a(new Class[] { String.class, String.class }), new Object[] { paramString2, paramString1 });
      if (localObject2 != null)
      {
        localObject2 = bjpx.a(localObject2, "getValue", false, new Class[0], new Object[0]);
        if (localObject2 != null) {
  ...
  public void a(bjro parambjro)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      parambjro.a(this.jdField_a_of_type_Boolean);
      return;
    }
    if ((a()) || (!b())) {}
    for (int i = 1; i == 0; i = 0)
    ...
    QzoneModuleManager.getInstance().downloadModule("xmpcore.jar", new bjrm(this, parambjro));
  }
