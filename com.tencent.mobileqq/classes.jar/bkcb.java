  ...
  extends ajec
{
  ...
  private Drawable a(String paramString)
  {
    ...
    localGradientDrawable.setCornerRadius(bdkf.b(20.0F));
  ...
  private String a()
  {
    ...
    if (this.jdField_a_of_type_Bkca.d != 1) {
      return this.jdField_a_of_type_Bkca.h;
    }
    return a(this.jdField_a_of_type_Bkca.e, this.jdField_a_of_type_Bkca.f);
  }
  ...
  public View a()
  {
    ...
    this.b = ((TextView)localView.findViewById(2131378934));
    this.c = ((TextView)localView.findViewById(2131378622));
    return localView;
  }
  ...
  {
    super.a(paramajdy);
    ThreadManagerV2.getUIHandlerV2().post(new QbossADBannerCountDownManager.1(this, paramajdy));
  }
