...
{
  private static sfc jdField_a_of_type_Sfc;
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper(), this);
  private final ArrayList<sfi> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private int jdField_b_of_type_Int;
  private long jdField_b_of_type_Long = 600000L;
  private final ArrayList<sfj> jdField_b_of_type_JavaUtilArrayList = new ArrayList();
  ...
  private sfc()
  {
    ...
    this.jdField_a_of_type_JavaUtilArrayList.add(new sfg());
    this.jdField_b_of_type_JavaUtilArrayList.add(new sfh(f));
    a();
  }
  
  public static sfc a()
  {
    if (jdField_a_of_type_Sfc == null) {}
    try
    {
      if (jdField_a_of_type_Sfc == null) {
        jdField_a_of_type_Sfc = new sfc();
      }
      return jdField_a_of_type_Sfc;
    }
    finally {}
  }
  ...
  private void a()
  {
    ...
    {
      ((ConnectivityManager)BaseApplicationImpl.getApplication().getSystemService("connectivity")).registerNetworkCallback(new NetworkRequest.Builder().build(), new sfe(this, null));
      return;
    }
    BaseApplicationImpl.getApplication().registerReceiver(new sff(this, null), new IntentFilter("android.net.conn.CONNECTIVITY_CHANGE"));
  }
  ...
  private long b()
  {
    ...
    {
      long l2 = ((sfi)localIterator.next()).a();
      l1 = l2;
      if (l2 > 0L) {
        l1 = l2;
      }
  ...
  private void b()
  {
    ...
    if (l > this.jdField_a_of_type_Long)
    {
      ...
      if (this.e > this.jdField_a_of_type_Long)
      {
        ...
        while (localIterator.hasNext()) {
          ((sfj)localIterator.next()).a(this.e);
        }
      }
      this.e = l;
    }
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        sfj localsfj = (sfj)localIterator.next();
        if (this.e > localsfj.jdField_a_of_type_Long) {
          localsfj.a(this.e);
        }
      }
      this.e = 0L;
  ...
  private void c()
  {
    ...
    {
      sfj localsfj = (sfj)localIterator.next();
      long l2 = Math.max(localsfj.jdField_a_of_type_Long, l1);
      l1 = l2;
      if (QLog.isColorLevel())
      {
        QLog.d("BandwidthPredictor", 2, "predict: predictor=" + localsfj + ", currentPrediction=" + localsfj.jdField_b_of_type_Long + ", prediction=" + localsfj.jdField_a_of_type_Long);
        l1 = l2;
      }
    }
