...
public class asnx
  extends asnp
{
  private static final String b = azac.a(asoc.jdField_a_of_type_JavaLangString + "shortvideo" + File.separator);
  ...
  public asnx(MsgBackupResEntity paramMsgBackupResEntity)
  {
  ...
  public aslo a()
  {
    ...
    localaslo.jdField_a_of_type_JavaLangString = str1;
    if ((!bool1) && (!bool2)) {}
