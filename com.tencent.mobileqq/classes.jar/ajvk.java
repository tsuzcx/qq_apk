...
public class ajvk
  extends ajvl
{
  public ajvk(QzoneFrame paramQzoneFrame)
  {
  ...
  public void a(int paramInt)
  {
    ...
    {
      QzoneFrame.a(this.a, blvu.a(this.a.a(), this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "com.qzone.feed.ui.activity.QQLebaExtendFeedFragment"));
      if (QzoneFrame.a(this.a) == null) {
        QzoneFrame.a(this.a, (TextView)QzoneFrame.a(this.a).findViewById(2131368994));
      }
      if (QzoneFrame.b(this.a) != QzoneFrame.c(this.a)) {
        break label490;
      }
      QzoneFrame.b(this.a, QzoneFrame.a(this.a));
      ((blwb)QzoneFrame.a(this.a)).setTitleAlphaAndGetLastValue(QzoneFrame.a(this.a));
      str = "动态";
      localDrawable = null;
      ...
      if ((QzoneFrame.b(this.a) == QzoneFrame.c(this.a)) && ((QzoneFrame.c(this.a) instanceof blwb)))
      {
      ...
      ((blwb)QzoneFrame.b(this.a)).resetReportFlag();
    ...
    for (;;)
    {
      ...
      ((blwb)QzoneFrame.a(this.a)).setRightButtonType(QzoneFrame.jdField_a_of_type_Int);
      return;
      ...
      if (QzoneFrame.a(this.a) == null)
      {
        ...
        QzoneFrame.a(this.a, this.a.a().getDrawable(2130845088));
      }
      for (;;)
      {
        QzoneFrame.a(this.a, ((blwb)QzoneFrame.a(this.a)).setTitleAlphaAndGetLastValue(0));
        localDrawable = QzoneFrame.a(this.a);
        str = "暖说说";
        break;
        label581:
        QzoneFrame.a(this.a, this.a.a().getResources().getDrawable(2130845088));
      }
      label607:
      ((blwb)QzoneFrame.c(this.a)).forceRefresh();
      break label321;
      label625:
      QzoneFrame.b(this.a).setBackgroundDrawable(localDrawable);
    }
    label639:
    ((blwb)QzoneFrame.a(this.a)).setRightButtonType(QzoneFrame.b);
  }
}
