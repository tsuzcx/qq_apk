  ...
  implements bhvc
{
  ...
  private void a()
  {
    ...
    try
    {
      ...
      bhva localbhva = new bhva(this.jdField_a_of_type_JavaLangString, null, this, true);
      String str = "gprs";
      ...
      QLog.d("ZipThumbDownloader", 1, "[downloadThumb]  ID[" + this.jdField_a_of_type_Long + "] start runDownload... , url[" + this.jdField_a_of_type_JavaLangString + "] data RANGE[" + String.valueOf("bytes=0-") + "], peerType[" + String.valueOf(localbhva.jdField_c_of_type_Int) + "]");
      localbhva.a("Accept-Encoding", "identity");
      if (!TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
        localbhva.a("Cookie", this.jdField_b_of_type_JavaLangString);
      }
    ...
    catch (FileNotFoundException localFileNotFoundException)
    {
      ...
      {
        a(true);
      } while (this.jdField_a_of_type_Atvq == null);
      this.jdField_a_of_type_Atvq.a(this.jdField_a_of_type_JavaLangString, false, -2, null, this.jdField_a_of_type_Long);
    }
  }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        if (paramBoolean) {
          auog.c(this.jdField_d_of_type_JavaLangString);
        }
        return;
  ...
  public void a(long paramLong, String paramString1, String paramString2, atvq paramatvq)
  {
  ...
  public void a(bhva parambhva1, bhva parambhva2)
  {
    ...
    long l1 = -1L;
    if (parambhva2 != null) {
      l1 = Long.parseLong(parambhva2.jdField_a_of_type_JavaLangString);
    }
    ...
    do
    {
      do
      {
        ...
        this.jdField_a_of_type_Atvq.a(this.jdField_a_of_type_JavaLangString, false, -7, null, this.jdField_a_of_type_Long);
        return;
      } while ((parambhva2.c() != 206) && (parambhva2.c() != 200));
      if (this.jdField_a_of_type_JavaIoFileOutputStream != null) {
        break;
      }
      a(true);
    } while (this.jdField_a_of_type_Atvq == null);
    this.jdField_a_of_type_Atvq.a(this.jdField_a_of_type_JavaLangString, false, -8, null, this.jdField_a_of_type_Long);
    return;
    for (;;)
    {
      try
      {
        this.jdField_a_of_type_JavaIoFileOutputStream.write(parambhva2.a());
      ...
      catch (Exception parambhva1)
      {
        try
        {
          ...
          a(false);
          if (bhmi.b(new File(this.jdField_d_of_type_JavaLangString), new File(this.jdField_c_of_type_JavaLangString))) {
            break label615;
          }
          i = -9;
          ...
          this.jdField_a_of_type_Atvq.a(this.jdField_a_of_type_JavaLangString, bool, i, this.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_Long);
          return;
        }
      ...
      this.jdField_a_of_type_Atvq.a(this.jdField_a_of_type_JavaLangString, i);
      return;
      label615:
      i = 0;
      bool = true;
  ...
  public void b(bhva parambhva1, bhva parambhva2)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Atvq.a(this.jdField_a_of_type_JavaLangString, false, -1, null, this.jdField_a_of_type_Long);
      return;
    ...
    this.jdField_a_of_type_Atvq.a(this.jdField_a_of_type_JavaLangString, false, -3, null, this.jdField_a_of_type_Long);
    return;
    if (parambhva1 == null)
    {
      i = -6;
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Atvq.a(this.jdField_a_of_type_JavaLangString, false, i, null, this.jdField_a_of_type_Long);
      return;
      if (!parambhva2.c())
      {
        i = -4;
      ...
      else
      {
        if (this.jdField_b_of_type_Int < 3)
        {
          ...
          for (this.jdField_d_of_type_Int += 1;; this.jdField_d_of_type_Int = 0)
          {
            a(true);
            if (this.jdField_a_of_type_Atvq != null) {
              this.jdField_a_of_type_Atvq.a(this.jdField_a_of_type_JavaLangString);
            }
