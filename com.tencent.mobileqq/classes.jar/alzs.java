...
public class alzs
  implements bjoe
{
  public alzs(CmGameFloatView paramCmGameFloatView) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    default: 
      return;
    case 0: 
      if ((this.a.jdField_a_of_type_Alxy != null) && (this.a.jdField_a_of_type_Alxy.a()))
      {
        QLog.d("cmframe_CmGameFloatView", 1, "pack up game");
        this.a.f();
        if (this.a.jdField_a_of_type_Aluh != null) {
          this.a.jdField_a_of_type_Aluh.c();
        }
    ...
    for (paramInt = 0;; paramInt = 1)
    {
      ...
      for (paramView = String.valueOf(this.a.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);; paramView = "")
      {
        ...
        return;
        paramView = this.a.jdField_a_of_type_Alxy.a();
      ...
      if ((this.a.jdField_a_of_type_Alxy != null) && (this.a.jdField_a_of_type_Alxy.a()) && (this.a.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null)) {}
      try
      {
        ...
        this.a.jdField_a_of_type_Alxy.b(paramView.toString());
        if (this.a.jdField_a_of_type_Aluh != null) {
          this.a.jdField_a_of_type_Aluh.b();
        }
        if (this.a.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null)
        {
      ...
      for (paramView = String.valueOf(this.a.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);; paramView = "")
      {
        ...
        PublicFragmentActivity.a(this.a.jdField_a_of_type_Alxy.a(), paramView, ApolloGameInfoFragment.class, 10000);
        if (this.a.jdField_a_of_type_Aluh == null) {
          break;
        }
        this.a.jdField_a_of_type_Aluh.d();
        return;
        paramInt = 0;
        break label518;
      }
      ...
      if ((!TextUtils.isEmpty(paramView)) && (localActivity != null)) {
        alvx.b(localActivity, paramView);
      }
      for (paramInt = 0;; paramInt = 1)
      {
      ...
      for (boolean bool1 = true;; bool1 = false)
      {
        ...
        if ((bool2) || (!alsn.a(this.a.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam))) {
          break label1082;
        }
        paramView.b(true);
        return;
