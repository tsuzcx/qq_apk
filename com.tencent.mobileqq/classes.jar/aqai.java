...
public class aqai
{
  ...
  aqai(QQAppInterface paramQQAppInterface)
  {
  ...
  public static String a()
  {
    ...
    Iterator localIterator = ((arcm)localObject1).a.iterator();
    while (localIterator.hasNext())
    {
      Object localObject2 = (arcw)localIterator.next();
      if (localObject2 != null)
      {
        arcv localarcv = ((arcw)localObject2).jdField_a_of_type_Arcv;
        if (localarcv != null)
        {
          localObject2 = ((arcw)localObject2).jdField_a_of_type_Arcy;
          if ((localObject2 != null) && (a(localarcv)))
          {
            localObject2 = b((arcy)localObject2);
            if (localObject2 != null)
            {
              ArkAppCenter.c("ArkApp.Dict.Update", String.format("getEffectDictIdentifier, use condition dict, dict-id=%s, condition=%s", new Object[] { localObject2, localarcv.toString() }));
              return localObject2;
            }
          }
        }
    ...
    localObject1 = b((arcy)localObject1);
  ...
  {
    return aqaf.a(paramString) + "/WordData";
  }
  ...
  private static Map<String, aqas> a(arcy paramarcy)
  {
    if (paramarcy == null) {
      return new HashMap();
    }
    Object localObject = paramarcy.jdField_b_of_type_JavaUtilArrayList;
    if (localObject == null)
    {
      ArkAppCenter.c("ArkApp.Dict.Update", "getDictInfoFromConfig, 'word_dict_list' field not found");
      return new HashMap();
    }
    paramarcy = new HashMap();
    localObject = ((ArrayList)localObject).iterator();
    while (((Iterator)localObject).hasNext())
    {
      aqas localaqas = (aqas)((Iterator)localObject).next();
      if (localaqas != null) {
        paramarcy.put(localaqas.a, localaqas);
      }
    }
    return paramarcy;
  }
  
  private void a(arcy paramarcy1, arcy paramarcy2, aqau paramaqau)
  {
    if (paramarcy2 == null)
    {
    ...
    for (;;)
    {
      ...
      Object localObject = a(paramarcy2);
      ...
      paramarcy2 = b(paramarcy1);
      paramarcy1 = a(paramarcy1);
      aqaw localaqaw = new aqaw(null);
      localaqaw.jdField_a_of_type_Int = ((Map)localObject).size();
      localaqaw.jdField_a_of_type_Boolean = true;
      localObject = ((Map)localObject).values().iterator();
      while (((Iterator)localObject).hasNext())
      {
        aqas localaqas = (aqas)((Iterator)localObject).next();
        a(str2, paramarcy2, (aqas)paramarcy1.get(localaqas.a), localaqas, new aqak(this, localaqaw, localaqas, str2, paramaqau, str1));
      }
    }
  }
  
  private void a(String paramString, aqas paramaqas, aqau paramaqau)
  {
    a(paramaqas.a, paramaqas.jdField_b_of_type_JavaLangString, new aqap(this, paramaqas, paramString, paramaqau));
  }
  
  private void a(String paramString1, String paramString2, aqas paramaqas1, aqas paramaqas2, aqau paramaqau)
  {
    boolean bool = false;
    if (!a(paramString2, paramaqas1)) {
      paramaqas1 = null;
    }
    for (;;)
    {
      if (paramaqas1 == null)
      {
        ArkAppCenter.c("ArkApp.Dict.Update", String.format("updateDict, local not exists, full update, name=%s", new Object[] { paramaqas2.a }));
        a(paramString1, paramaqas2, new aqal(this, paramaqas2, paramaqau));
        return;
      }
      if (paramaqas1.d.equals(paramaqas2.d))
      {
        ArkAppCenter.c("ArkApp.Dict.Update", String.format("updateDict, file not change, copy from origin, name=%s", new Object[] { paramaqas2.a }));
        paramString2 = b(paramString2, paramaqas1.a);
        paramString1 = String.format("%s/%s", new Object[] { paramString1, paramaqas2.a });
        if (bhmi.d(paramString2, paramString1)) {
          break label281;
        }
      ...
      for (;;)
      {
        paramaqau.a(bool);
        return;
        if ((paramaqas2.b()) && (paramaqas1.d.equals(paramaqas2.g)))
        {
          ArkAppCenter.c("ArkApp.Dict.Update", String.format("updateDict, incremental update, name=%s", new Object[] { paramaqas2.a }));
          b(paramString1, paramString2, paramaqas1, paramaqas2, new aqam(this, paramaqas2, paramaqau, paramString1));
          return;
        }
        ArkAppCenter.c("ArkApp.Dict.Update", String.format("updateDict, full update, name=%s", new Object[] { paramaqas2.a }));
        a(paramString1, paramaqas2, new aqao(this, paramaqau));
        return;
        label281:
        bool = true;
      }
  ...
  private void a(String paramString1, String paramString2, aqat paramaqat)
  {
    aqav localaqav = new aqav(null);
    ...
    localaqav.jdField_a_of_type_JavaLangRefWeakReference = new java.lang.ref.WeakReference(localbezv);
    paramaqat = new ArkAiDictUpdateMgr.8(this, paramString2, localaqav, paramaqat);
    if (localQQAppInterface == null)
    {
      ArkAppCenter.c("ArkApp.Dict.Update", "downloadDictFile, qq app interface is null, return");
      return;
    }
    localaqav.jdField_a_of_type_Boolean = localbezv.a();
    if (localaqav.jdField_a_of_type_Boolean)
    {
      localbezv.a(10022, "prd", paramString1, 0, paramString2, "", 1, 0, false, new bezw(localQQAppInterface, paramString1, paramaqat, 10000L));
      return;
    }
    paramaqat.run();
  ...
  private static boolean a(arcv paramarcv)
  {
    if (paramarcv == null) {}
    for (;;)
    {
      return false;
      paramarcv = paramarcv.a;
      String[] arrayOfString = paramarcv.split("-");
      if (arrayOfString.length == 2) {
        ...
        {
          ArkAppCenter.c("ArkApp.Dict.Update", String.format(Locale.CHINA, "isDictConditionEffect, invalid date, date=%s", new Object[] { paramarcv }));
        }
      }
    }
    return false;
  ...
  private boolean a(arcy paramarcy)
  {
    if (paramarcy == null)
    {
    ...
    String str = b(paramarcy);
    paramarcy = a(paramarcy);
    if (paramarcy == null)
    {
      ArkAppCenter.c("ArkApp.Dict.Update", "checkLocalDictIntegrity, local dict list is empty");
      return true;
    }
    Iterator localIterator = paramarcy.values().iterator();
    do
    {
      if (!localIterator.hasNext()) {
        break;
      }
    } while (a(str, (aqas)localIterator.next()));
    for (int i = 1;; i = 0)
    {
      if (i == 0)
      {
      ...
      ArkAppCenter.c("ArkApp.Dict.Update", String.format(Locale.CHINA, "checkLocalDictIntegrity, %d of %d files need update", new Object[] { Integer.valueOf(i), Integer.valueOf(paramarcy.size()) }));
      return false;
    }
  }
  
  private static boolean a(String paramString, aqas paramaqas)
  {
    if (paramaqas == null) {}
    while (!b(b(paramString, paramaqas.a), paramaqas.d)) {
      return false;
    }
    return true;
  }
  ...
  private static String b(arcy paramarcy)
  {
    if (paramarcy == null) {}
    String str;
    do
    {
      return null;
      str = paramarcy.c;
      paramarcy = paramarcy.jdField_b_of_type_JavaLangString;
    } while ((TextUtils.isEmpty(str)) || (TextUtils.isEmpty(paramarcy)));
    return String.format("%s-%s", new Object[] { str, paramarcy });
  }
  ...
  private static Map<String, arcy> b(arcm paramarcm)
  {
    ...
    Object localObject1 = b(paramarcm);
    if (localObject1 != null) {
      localHashMap.put(localObject1, paramarcm);
    }
    paramarcm = paramarcm.a.iterator();
    while (paramarcm.hasNext())
    {
      Object localObject2 = (arcw)paramarcm.next();
      if (localObject2 != null)
      {
        localObject1 = ((arcw)localObject2).jdField_a_of_type_Arcv;
        localObject2 = ((arcw)localObject2).jdField_a_of_type_Arcy;
        if ((localObject1 != null) && (localObject2 != null))
        {
          localObject1 = b((arcy)localObject2);
          if (localObject1 != null) {
  ...
  private void b(String paramString1, String paramString2, aqas paramaqas1, aqas paramaqas2, aqau paramaqau)
  {
    a(paramaqas2.a, paramaqas2.e, new aqaq(this, paramaqas2, paramString2, paramaqas1, paramString1, paramaqau));
  }
  
  private static boolean b(arcy paramarcy)
  {
    if (paramarcy == null) {
      return false;
    }
    paramarcy = paramarcy.e;
    if ((TextUtils.isEmpty(paramarcy)) || (paramarcy.equalsIgnoreCase("wifi")))
    {
      if ((AppNetConnInfo.isNetSupport()) && (AppNetConnInfo.isWifiConn()))
      {
        ArkAppCenter.c("ArkApp.Dict.Update", String.format("getNetType, invalid dict info, netType=%s", new Object[] { paramarcy }));
        return true;
      }
  ...
  private static boolean b(String paramString1, String paramString2)
  {
    ...
    //   80: invokestatic 521	aqai:a	([B)Ljava/lang/String;
    //   83: aload_1
  ...
  private static arcm c()
  {
    ...
    try
    {
      localObject = (arcm)arax.a(localObject, arcm.class);
      return localObject;
    }
  ...
  private static void c(arcm paramarcm)
  {
    if (paramarcm == null)
    {
  ...
  private static arcm d()
  {
    arbv localarbv = arca.b(170).a();
    if (localarbv == null)
    {
  ...
  private static void d(arcm paramarcm)
  {
    if (paramarcm == null) {
