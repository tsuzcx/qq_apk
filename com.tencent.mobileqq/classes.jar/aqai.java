...
public class aqai
{
  ...
  private static List<aqag> jdField_a_of_type_JavaUtilList;
    ...
    if (jdField_a_of_type_JavaUtilList.size() > 0)
    {
      synchronized (jdField_a_of_type_JavaUtilList)
      {
        ...
        if (localIterator.hasNext()) {
          ((aqag)localIterator.next()).a(paramInt);
        }
      }
  ...
  public static void a(aqag paramaqag)
  {
    synchronized (jdField_a_of_type_JavaUtilList)
    {
      if (!jdField_a_of_type_JavaUtilList.contains(paramaqag)) {
        jdField_a_of_type_JavaUtilList.add(paramaqag);
      }
      return;
    }
  }
  ...
  public static void a(boolean paramBoolean1, String arg1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (;;)
    {
      ...
      synchronized (jdField_a_of_type_JavaUtilList)
      {
        ...
        ((aqag)localIterator.next()).a(paramBoolean1, paramBoolean2, paramBoolean3);
      }
  ...
  private static boolean a()
  {
    ...
    String str1 = "";
    File localFile = new File(ajsd.aV, "qflutter");
    ...
    if (localFile.exists())
    {
      int i = bbdx.a(localFile.getAbsolutePath(), jdField_a_of_type_JavaLangString + "/", false, true, true);
      if (i == 0) {
    ...
    if (apvd.a(str2))
    {
      ...
      b(str2);
      bcql.a(BaseApplicationImpl.getContext(), 0, 2131698245, 0).a();
      return true;
    }
    return false;
  }
  ...
  public static void b(aqag paramaqag)
  {
    synchronized (jdField_a_of_type_JavaUtilList)
    {
      jdField_a_of_type_JavaUtilList.remove(paramaqag);
      return;
    }
  }
  ...
  private static void b(String arg0)
  {
    ...
    if (a(???))
    {
      com.tencent.qflutter.utils.FLog.sLog = new aqak();
      QFlutterSkinEngine.get().init(BaseApplicationImpl.getContext(), new aqaf(BaseApplicationImpl.getContext()));
      ??? = new aqaj();
      QFlutterSkinEngine.get().setCurrentThemeId(ThemeUtil.getCurrentThemeId());
      ??? = new FlutterBoost.ConfigBuilder(BaseApplicationImpl.getApplication(), aqah.a()).isDebug(false).whenEngineStart(FlutterBoost.ConfigBuilder.IMMEDIATELY).renderMode(FlutterView.RenderMode.texture).pluginsRegister(???).build();
    ...
    else
    {
      for (;;)
      {
        synchronized (jdField_a_of_type_JavaUtilList)
        {
          ...
          aqag localaqag = (aqag)localIterator.next();
          if (i != 0) {
            break label186;
          }
          bool = true;
  ...
  public static void c(aqag paramaqag)
  {
