...
public class bnkr
{
  ...
  private bnkt jdField_a_of_type_Bnkt;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajrx.jdField_d_of_type_JavaLangString + "pddata/prd/dov_capture_qsvf" + File.separator;
    jdField_b_of_type_JavaLangString = jdField_a_of_type_JavaLangString + "capture_res" + File.separator;
    e = ajrx.jdField_d_of_type_JavaLangString + "qav" + File.separator + "beauty" + File.separator;
  ...
  private boolean a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Bnkt != null) {
  ...
  public void a()
  {
    this.jdField_a_of_type_Bnkt = null;
  }
  ...
  public void a(bnkt parambnkt)
  {
    this.jdField_a_of_type_Bnkt = parambnkt;
  }
  
  public void a(bnkw parambnkw)
  {
    ...
    do
    {
      ...
      parambnkw = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
      while (parambnkw.hasNext())
      {
        Object localObject1 = (FilterCategory)parambnkw.next();
              ...
              if (localFilterDesc.predownload == 1)
              {
                ...
                if (!TextUtils.isEmpty(localFilterDesc.iconurl))
                {
                  ...
                  if (!((File)localObject3).exists())
                  {
                    ...
                    ((baub)localObject3).jdField_a_of_type_Baug = new bnkv(this);
                ...
                if ((!TextUtils.isEmpty(localFilterDesc.resurl)) && (!TextUtils.isEmpty((CharSequence)localObject2)))
                {
                  ...
                  if (!((File)localObject3).exists())
                  {
                    ...
                    ((baub)localObject2).jdField_a_of_type_Baug = new bnku(this);
    ...
    } while ((this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 0) || (this.jdField_a_of_type_Bnkw == null));
    this.jdField_a_of_type_Bnkw.a(false);
  }
  ...
  public void d()
  {
    this.jdField_a_of_type_Bnkw = null;
  }
}
