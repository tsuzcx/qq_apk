...
public class aywe
{
  ...
  public aywe(Settings paramSettings)
  {
  ...
  {
    return aywj.a(paramFloat1, this.jdField_a_of_type_Float / paramFloat2, this.b * paramFloat2);
  }
  
  public aywe a(aywg paramaywg)
  {
    ...
    if (!aywg.a(f9, 0.0F))
    {
      ...
      label202:
      switch (aywf.a[this.jdField_a_of_type_ComTencentMobileqqOcrViewGestureSettings.a().ordinal()])
      {
      default: 
