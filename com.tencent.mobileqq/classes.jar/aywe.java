  ...
  extends zdf
{
  ...
  private aywt jdField_a_of_type_Aywt;
  private final AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface;
  
  public aywe(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_Aywt = new aywt(paramAppInterface);
  }
  ...
  private boolean e(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    if (bool)
    {
      ...
      while (paramToServiceMsg.hasNext())
      {
        ...
        localObject = (aywc)((Map.Entry)localObject).getValue();
        if ((((aywc)localObject).a() & i) != 0)
        {
          localObject = ((aywc)localObject).a(i);
          if (localObject != null)
          {
            if (QLog.isColorLevel()) {
    ...
    paramToServiceMsg = (aywc)((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface).a.a().get(Integer.valueOf(101));
  ...
  private boolean o(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    for (int m = 1;; m = 0)
    {
      ...
      if (localObject != null)
      {
        ...
        bdlr.a(arrayOfByte, 0, (short)20002);
        bdlr.a(arrayOfByte, 2, s);
        bdlr.a(arrayOfByte, 4, (byte[])localObject, localObject.length);
        j = s + 4;
      }
      i = j;
      if (localInteger != null)
      {
        bdlr.a(arrayOfByte, j, (short)20031);
        i = j + 2;
        bdlr.a(arrayOfByte, i, (short)4);
        i += 2;
        bdlr.a(arrayOfByte, i, localInteger.intValue());
        i += 4;
      }
      j = i;
      if (localByte != null)
      {
        bdlr.a(arrayOfByte, i, (short)20009);
        i += 2;
        bdlr.a(arrayOfByte, i, (short)1);
        i += 2;
      ...
      {
        bdlr.a(arrayOfByte, j, (short)20032);
        i = j + 2;
        bdlr.a(arrayOfByte, i, (short)12);
        i += 2;
        bdlr.a(arrayOfByte, i, arrayOfInteger[0].intValue());
        i += 4;
        bdlr.a(arrayOfByte, i, arrayOfInteger[1].intValue());
        i += 4;
        bdlr.a(arrayOfByte, i, arrayOfInteger[2].intValue());
      }
  ...
  private boolean r(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    aloz localaloz = (aloz)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(51);
  ...
  public Object a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    return this.jdField_a_of_type_Aywt.a(paramToServiceMsg, paramFromServiceMsg);
  }
  ...
  public boolean b(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    return this.jdField_a_of_type_Aywt.a(paramToServiceMsg, paramUniPacket);
  }
}
