  ...
  implements Manager
{
  ...
  public aywe(QQAppInterface paramQQAppInterface)
  {
  ...
  public int a(String paramString)
  {
    ...
    while (!bgnn.a(paramString, localSQLiteDatabase)) {
      return 0;
    }
  ...
  public long a(String paramString)
  {
    ...
    do
    {
      return l3;
      l2 = l1;
      if (bgnn.a(paramString, localSQLiteDatabase)) {
        l3 = l1;
      }
      try
      {
  ...
  public Cursor a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      paramString2 = bgnn.b(null, paramString1, localSQLiteDatabase, (String)localObject1);
    ...
    for (;;)
    {
      ...
      if (paramString1.indexOf("mr_discusssion_") != -1)
      {
        ...
        paramString2 = bgnn.b(null, paramString1, localSQLiteDatabase, (String)localObject2);
      ...
      Object localObject2 = bgnn.a(null, paramString1, localSQLiteDatabase, paramString2, null);
  ...
  public ayvj a()
  {
    ...
    {
      if ((this.jdField_a_of_type_Ayvj == null) || (!this.jdField_a_of_type_Ayvj.isOpen())) {
        this.jdField_a_of_type_Ayvj = ((ayvj)a().createMessageRecordEntityManager());
      }
  ...
  public aywd a()
  {
    ...
    try
    {
      if (this.jdField_a_of_type_Aywd == null)
      {
        this.jdField_a_of_type_Aywd = new aywd(str);
  ...
  public List<MessageRecord> a(String paramString1, String paramString2)
  {
    ...
    {
      return null;
      paramString1 = bgnn.a(null, paramString1, localSQLiteDatabase, paramString2, null);
  ...
  public void onDestroy()
  {
    ...
    if (this.jdField_a_of_type_Aywd != null) {
      this.jdField_a_of_type_Aywd.close();
    }
  }
}
