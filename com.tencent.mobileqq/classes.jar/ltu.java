...
public class ltu
{
  ...
  /* Error */
  public static List<ltv> a(java.lang.String paramString1, java.lang.String paramString2)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 11
    ...
    //   317: new 158	ltv
    //   320: dup
    //   321: invokespecial 159	ltv:<init>	()V
    //   324: astore 4
    //   326: aload_1
    //   327: iload_2
    ...
    //   346: putfield 176	ltv:expressionID	Ljava/lang/String;
    //   349: aload 5
    ...
    //   376: putfield 183	ltv:expressionFeat	Ljava/util/List;
    //   379: iconst_0
    //   380: istore_3
    //   381: iload_3
    //   382: aload 6
    ...
    //   392: aload 4
    //   394: getfield 183	ltv:expressionFeat	Ljava/util/List;
    ...
    //   705: d2f
    //   706: fastore
    //   707: invokestatic 238	ltu:a	([F)[F
    //   710: putfield 242	ltv:expressionAngle	[F
    //   713: aload 5
    ...
    //   743: bipush 7
    //   745: newarray double
    //   747: putfield 248	ltv:expressionWeight	[D
    //   750: iconst_0
    //   751: istore_3
    //   752: iload_3
    //   753: bipush 7
    ...
    //   758: aload 4
    //   760: getfield 248	ltv:expressionWeight	[D
    //   763: iload_3
    //   764: aload 6
    //   766: iload_3
    ...
    //   775: goto -23 -> 752
    //   778: aload 4
    //   780: getstatic 18	ltu:a	[D
    //   783: putfield 248	ltv:expressionWeight	[D
    //   786: aload 5
    //   788: ldc 250
    ...
    //   811: iconst_3
    //   812: newarray int
    //   814: putfield 253	ltv:a	[I
    //   817: aload 4
    //   819: getfield 253	ltv:a	[I
    //   822: iconst_0
    //   823: aload 6
    //   825: iconst_0
  ...
  public static ltw a(ltv paramltv, List<PointF> paramList, float[] paramArrayOfFloat)
  {
    ltw localltw = new ltw();
    Object localObject = paramltv.expressionFeat;
    float[] arrayOfFloat = paramltv.expressionAngle;
    double[] arrayOfDouble = paramltv.expressionWeight;
    int[] arrayOfInt = paramltv.a;
    ...
    if (paramList.size() == 83) {
      paramltv = FaceDetectUtil.facePointf83to90(paramList);
    }
    List localList = FaceOffUtil.getFullCoords(paramltv, 2.0F);
    if ((localList.size() < 106) || (((List)localObject).size() < 106)) {
      return localltw;
    }
    paramltv = new ArrayList(((List)localObject).size());
    ...
    {
      paramltv.add(new PointF(((PointF)((List)localObject).get(i)).x / f1, ((PointF)((List)localObject).get(i)).y / f2));
      paramList.add(new PointF(((PointF)localList.get(i)).x / f3, ((PointF)localList.get(i)).y / f4));
      i += 1;
    }
    localObject = new float[7];
    float f9 = a((PointF)paramltv.get(37), (PointF)paramltv.get(41)) / a((PointF)paramltv.get(35), (PointF)paramltv.get(39));
    ...
    for (f1 = (f6 - f9) / 4 + f9;; f1 = f6)
    {
      ...
      float f10 = a((PointF)paramltv.get(47), (PointF)paramltv.get(51)) / a((PointF)paramltv.get(45), (PointF)paramltv.get(49));
      ...
      for (f2 = (f7 - f10) / 4 + f10;; f2 = f7)
      {
        ...
        float f11 = a((PointF)paramltv.get(73), (PointF)paramltv.get(81)) / a((PointF)paramltv.get(65), (PointF)paramltv.get(66));
        ...
        for (f3 = (f8 - f11) / 4 + f11;; f3 = f8)
        {
          ...
          f4 = (((PointF)paramltv.get(44)).x - ((PointF)paramltv.get(35)).x) / (((PointF)paramltv.get(39)).x - ((PointF)paramltv.get(35)).x);
          float f5 = (((PointF)paramltv.get(54)).x - ((PointF)paramltv.get(45)).x) / (((PointF)paramltv.get(49)).x - ((PointF)paramltv.get(45)).x);
          ...
          f5 = 0.0F;
          f4 = 0.0F;
          paramltv = new StringBuilder("Score:");
          ...
          while (i < 7)
          {
            ...
            paramltv.append("[").append(localObject[i]).append("]");
            paramList.append("[").append(arrayOfDouble[i]).append("]");
            i += 1;
          }
          f4 = f5 / f4;
          if (QLog.isColorLevel()) {
            QLog.d("AVActUtil", 2, "raymond__ getExpressionSimilarity2 ,totalScore = " + 100.0F * f4 + "," + paramltv.toString() + paramList.toString());
          }
          if (QLog.isColorLevel())
          {
  ...
  public static boolean a(float paramFloat, double[] paramArrayOfDouble, int[] paramArrayOfInt, ltv paramltv, List<PointF> paramList, float[] paramArrayOfFloat)
  {
    boolean bool = false;
    paramltv.expressionWeight = paramArrayOfDouble;
    paramltv.a = paramArrayOfInt;
    float f = a(paramltv, paramList, paramArrayOfFloat).a;
    if (f > paramFloat) {
      bool = true;
    }
    if (QLog.isColorLevel()) {
  ...
  public static boolean a(ltw paramltw)
  {
    boolean bool = false;
    if ((paramltw.b < paramltw.c) && (paramltw.c - paramltw.b > 0.05D)) {
      if (paramltw.d <= paramltw.e) {
        break label118;
      }
    }
    for (;;)
    {
      ...
      return bool;
      if ((paramltw.b <= paramltw.c) || (paramltw.b - paramltw.c <= 0.05D) || (paramltw.d >= paramltw.e)) {
        label118:
        bool = true;
      }
    }
