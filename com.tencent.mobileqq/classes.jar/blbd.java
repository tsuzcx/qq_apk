  ...
  extends VasWebviewJsPlugin
{
  ...
  public int a;
  blbc jdField_a_of_type_Blbc = new blbe(this);
  public blbg a;
  public String a;
  ...
  private void b()
  {
    if (this.jdField_a_of_type_OrgJsonJSONObject != null) {
      blae.jdField_a_of_type_Blai.b(this.jdField_a_of_type_OrgJsonJSONObject);
    }
    if (QLog.isColorLevel()) {
      QLog.d("QQComicJsPlugin", 2, "setContainerInfo success on Resume extrasParams: " + blae.jdField_a_of_type_Blai.toString());
    }
  }
  
  private void b(JSONObject paramJSONObject)
  {
    blae.a(paramJSONObject.optInt("useWebBundle"));
  }
  ...
  private static String c()
  {
    ...
    return bhgg.a("tencent/MobileQQ/qqcomic/cache/");
  }
  ...
  private void c(JSONObject paramJSONObject)
  {
    ...
    blcg.a(str1, false, blcg.b);
    for (;;)
    {
      a(localIntent.getExtras());
      blae.a(paramJSONObject, localIntent, 100);
      return;
      label126:
      blcg.a(str1, false, blcg.e);
    }
  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Blbg != null) {
  ...
  public void a(String paramString)
  {
    ...
    //   1: monitorenter
    //   2: aload_1
    //   3: putstatic 121	blbd:f	Ljava/lang/String;
    //   6: getstatic 28	blbd:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   9: invokevirtual 312	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   12: istore_2
    //   13: iload_2
    //   14: ifeq +6 -> 20
    //   17: aload_0
    //   18: monitorexit
    //   19: return
    //   20: getstatic 28	blbd:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   23: iconst_1
    //   24: invokevirtual 315	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   27: new 317	cooperation/comic/jsp/QQComicJsPlugin$4
    //   30: dup
    //   31: aload_0
    //   32: invokespecial 318	cooperation/comic/jsp/QQComicJsPlugin$4:<init>	(Lblbd;)V
    //   35: iconst_5
    //   36: aconst_null
    //   37: iconst_1
    //   38: invokestatic 322	com/tencent/mobileqq/app/ThreadManager:post	(Ljava/lang/Runnable;ILcom/tencent/mobileqq/app/ThreadExcutor$IThreadListener;Z)V
    //   41: goto -24 -> 17
    //   44: astore_1
    //   45: aload_0
    //   46: monitorexit
  ...
  public void a(String paramString1, JSONObject paramJSONObject, String paramString2)
  {
    if (this.jdField_a_of_type_Blbg == null)
    {
      ...
      this.jdField_a_of_type_Blbg = blbu.a(this.mRuntime, this.jdField_a_of_type_Blbc);
    }
    if (this.jdField_a_of_type_Blbg != null) {
      this.jdField_a_of_type_Blbg.a(paramString1, paramJSONObject);
    }
    do
    {
      return;
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      {
        paramJsBridgeListener = (String)blae.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicReference.get();
        paramString1 = new JSONObject();
        ...
        for (;;)
        {
          ...
          paramString1.put("message", anni.a(2131708942));
    ...
    else
    {
      if ("attachSwitchChannel".equals(paramString3))
      {
        ...
        for (;;)
        {
          ...
          try
          {
            ...
            paramString3.put("subIndex", paramVarArgs.mSwiftTitleUI.a());
            paramString1.put("data", paramString3);
            super.callJs(paramString2, new String[] { paramString1.toString() });
            break label2202;
            paramVarArgs.mSwiftTitleUI.a.a(paramString1, false);
            i = 0;
          }
          catch (Exception paramJsBridgeListener)
          {
      ...
      if ("setSwitchChannel".equals(paramString3))
      {
        ...
        if ((paramString3 != null) && (paramString3.length() > 0))
        {
          ...
          paramVarArgs.mSwiftTitleUI.a(new bhnc(m, k, paramString1, paramString2, paramJsBridgeListener));
          break label2202;
        }
      }
      else
      {
        if ("getSwitchChannel".equals(paramString3))
        {
          ...
          try
          {
            ...
            paramString1.put("subIndex", paramVarArgs.mSwiftTitleUI.a());
        ...
        {
          paramJsBridgeListener = "ok";
          if (!paramVarArgs.mSwiftTitleUI.a(true))
          {
        ...
        else
        {
          if ("hideSwitchChannel".equals(paramString3))
          {
            paramJsBridgeListener = "ok";
            i = m;
            if (!paramVarArgs.mSwiftTitleUI.a(false))
            {
              paramJsBridgeListener = "not exist sub tab";
              i = -1;
            }
          ...
          if ("setTabRedPoint".equals(paramString3))
          {
            ...
            break label2202;
            label1074:
            paramVarArgs.mSwiftTitleUI.a(new bhnd(paramJsBridgeListener, j, paramString2));
            break label2202;
          }
          ...
          if ("openQQBrowser".equals(paramString3))
          {
            ...
            blae.a(paramString1, paramString2, -1);
            break label2202;
          }
          ...
          if ("setTitleAndBottomBar".equals(paramString3))
          {
            ...
            paramJsBridgeListener = (bhne)paramString1;
            bool1 = bool2;
            if (!bool3) {
              bool1 = true;
            }
          ...
          if ("getReporterInfo".equals(paramString3))
          {
            paramJsBridgeListener = new JSONObject();
            paramString1 = new JSONObject();
            paramString1.put("mod", blae.jdField_a_of_type_JavaLangString);
            paramString1.put("land_page", blae.c);
            paramString1.put("obj_ownerid", blae.b);
            paramJsBridgeListener.put("data", paramString1);
    ...
    for (i = 1;; i = 2)
    {
      ...
      else if ("initPrivateSettingIcon".equals(paramString3))
      {
        ...
        {
          paramVarArgs.mSwiftTitleUI.d(true);
      ...
      else if ("setContainerInfo".equals(paramString3))
      {
        ...
        blae.jdField_a_of_type_Blai.b(this.jdField_a_of_type_OrgJsonJSONObject);
        if (QLog.isColorLevel()) {
          QLog.d("QQComicJsPlugin", 2, "setContainerInfo success extrasParams: " + blae.jdField_a_of_type_Blai.toString());
        }
      }
      else if (blbu.a)
      {
