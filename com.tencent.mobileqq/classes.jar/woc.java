...
public class woc
{
  private static final String jdField_a_of_type_JavaLangString = woc.class.getSimpleName();
  ...
  public static String a(long paramLong)
  {
    ...
    try
    {
      str = BaseApplicationImpl.getContext().getString(2131720925);
      localObject2 = BaseApplicationImpl.getContext().getString(2131720926);
      localObject1 = BaseApplicationImpl.getContext().getString(2131720924);
