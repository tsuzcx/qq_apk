  ...
  extends BroadcastReceiver
{
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if (paramContext.equals("com.tencent.mobileqq.addLbsObserver")) {
      if (antb.a(this.a) != null) {
        antb.a(this.a).addObserver(antb.a(this.a));
      }
    }
    do
    {
      do
      {
        ...
        do
        {
          ...
          do
          {
            do
            {
              do
              {
                ...
                } while (antb.a(this.a) == null);
                antb.a(this.a).removeObserver(antb.a(this.a));
                return;
                if (!paramContext.equals("com.tencent.mobileqq.getStreetViewUrl")) {
                  break;
                }
              } while (antb.a(this.a) == null);
              ((anos)antb.a(this.a).a(3)).b((int)(paramIntent.getDoubleExtra("latitude", 0.0D) * 1000000.0D), (int)(paramIntent.getDoubleExtra("longitude", 0.0D) * 1000000.0D));
              return;
              ...
              try
              {
                antb.a(this.a).unregisterReceiver(antb.a(this.a));
                return;
              }
          ...
          ((anos)antb.a(this.a).a(3)).a(i, j, k, paramContext, str, m, n, i1);
          return;
