  ...
  extends AsyncTask<Integer, Void, Bitmap>
{
  ...
  private WeakReference<antb> jdField_a_of_type_JavaLangRefWeakReference;
  
  public antc(antb paramantb, int paramInt)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramantb);
  ...
  protected Bitmap a(Integer... paramVarArgs)
  {
    ...
    //   1: astore_2
    //   2: aload_0
    //   3: getfield 21	antc:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    ...
    //   66: aload_3
    //   67: getfield 66	antb:a	Ljava/lang/String;
  ...
  protected void a(Bitmap paramBitmap)
  {
    ...
    antb localantb = (antb)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if ((localantb != null) && (paramBitmap != null) && (!paramBitmap.isRecycled())) {
      localantb.a(paramBitmap, this.jdField_a_of_type_Int);
    }
  }
}
