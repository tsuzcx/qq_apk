...
{
  public wkc(SystemMsgListView paramSystemMsgListView) {}
  
  protected void a(String paramString)
  {
    if (this.a.jdField_a_of_type_ComTencentMobileqqActivityContactNewfriendBaseNewFriendView$INewFriendContext.a())
    {
      paramString = SystemMsgListView.a(this.a).getResources().getString(2131433176);
    ...
    for (;;)
    {
      ...
      if (!paramBoolean)
      {
        ...
        for (;;)
        {
          ...
          return;
          paramString3 = SystemMsgListView.a(this.a).getResources().getString(2131434464);
        }
      }
      paramString1 = SystemMsgListView.a(this.a).getResources().getString(2131433071);
