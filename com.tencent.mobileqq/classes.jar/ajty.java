  ...
  implements Manager
{
  ...
  private ajud jdField_a_of_type_Ajud;
  private ajxl jdField_a_of_type_Ajxl = new ajua(this);
  ...
  static
  {
    ...
    jdField_a_of_type_ArrayOfInt = new int[] { 2130845047, 2130844109, 2130844109, 2130844109, 2130844807, 2130844807, 2130845064, 2130845064, 2130844589, 2130844589, 2130844589, 2130845047, 2130845047, 2130844868, 2130845047 };
  ...
  public ajty(QQAppInterface paramQQAppInterface)
  {
  ...
  public int a(int paramInt, boolean paramBoolean)
  {
    ...
    if (paramInt == 1)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        {
          bool = true;
          QLog.d("ConditionSearch.Manager", 2, bool + " | isNetAvaiable = " + bbev.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()));
        }
      }
      else
      {
        ...
        localObject = ((ayxq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(193)).a(this.jdField_a_of_type_JavaLangString);
        if (QLog.isColorLevel()) {
          QLog.d("ConditionSearch.Manager", 2, "update, find task=" + localObject);
        }
        if ((localObject != null) && ((localObject instanceof ajub))) {
          ((ajub)localObject).realStart();
        }
      }
    }
    label246:
    while (paramInt != 2)
    {
      ...
      for (paramBoolean = true;; paramBoolean = false)
      {
        ...
        localObject = (ajuf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(4);
        ((ajuf)localObject).a(null, new GetResourceReqInfo[] { ((ajuf)localObject).e() });
        return 0;
      }
    }
    label264:
  ...
  public List<BaseAddress> a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqConditionsearchDataAddressData != null)
    {
      ...
      Collections.sort(localArrayList, new ajtz(this));
    }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Ajud != null) {
      this.jdField_a_of_type_Ajud.a();
    }
  }
  ...
  public void a(ajud paramajud)
  {
    this.jdField_a_of_type_Ajud = paramajud;
  }
  ...
  public void a(GetResourceRespInfo paramGetResourceRespInfo)
  {
    ...
    do
    {
      ...
      paramGetResourceRespInfo = new ajub(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject, paramGetResourceRespInfo, localFile);
      ...
      bool = ((ayxq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(193)).a(10023, "prd", (String)localObject, 0, (String)localObject, localFile.getAbsolutePath(), 2, 0, false, paramGetResourceRespInfo);
    } while (!QLog.isColorLevel());
  ...
  void a(boolean paramBoolean1, List<CondFitUser> paramList, boolean paramBoolean2, int paramInt)
  {
    ...
    if (this.jdField_b_of_type_JavaUtilLinkedList != null)
    {
      ...
      while (((Iterator)localObject).hasNext()) {
        ((ajue)((Iterator)localObject).next()).a(paramBoolean1, paramList, paramBoolean2, paramInt);
      }
    }
  }
  ...
  public String c(String paramString)
  {
    ...
    {
      String[] arrayOfString = bbjw.a(paramString, '-');
      str = paramString;
      if (arrayOfString.length >= 2)
      {
  ...
  {
    if ((paramObject instanceof ajuc))
    {
    ...
    do
    {
      this.jdField_a_of_type_JavaUtilLinkedList.add((ajuc)paramObject);
      do
      {
        return;
      } while (!(paramObject instanceof ajue));
      if (this.jdField_b_of_type_JavaUtilLinkedList == null) {
    ...
    this.jdField_b_of_type_JavaUtilLinkedList.add((ajue)paramObject);
  }
  ...
  public int d()
  {
    if (this.jdField_g_of_type_Boolean)
    {
      Card localCard = ((ajxn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      if (localCard == null) {
        break label134;
      }
      if (localCard.shGender != 0) {
  ...
  public void d(Object paramObject)
  {
    ...
    while ((!(paramObject instanceof ajue)) || (this.jdField_b_of_type_JavaUtilLinkedList == null)) {
      return;
    }
