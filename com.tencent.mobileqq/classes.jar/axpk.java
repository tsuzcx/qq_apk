...
public class axpk
{
  private static axpk jdField_a_of_type_Axpk = new axpk();
  private aocm jdField_a_of_type_Aocm = new axpl(this);
  
  public static axpk a()
  {
    return jdField_a_of_type_Axpk;
  }
  
  private void c(QQAppInterface paramQQAppInterface)
  {
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApplication(), bcvf.class);
  ...
  private void c(QQAppInterface paramQQAppInterface, List<Submsgtype0x89.NumRedBusiInfo> paramList)
  {
    ...
    ((bbbl)paramQQAppInterface.getManager(QQManagerFactory.NUMREDMSG_MANAGER)).a(paramList, "nearby_num_red_dot", new axpm(this, paramQQAppInterface));
  }
  
  public List<Submsgtype0x89.NumRedBusiInfo> a(QQAppInterface paramQQAppInterface)
  {
    Object localObject = ((bbbq)paramQQAppInterface.getManager(QQManagerFactory.MGR_RED_TOUCH)).a(7719);
    if (localObject == null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("NearbyNewRedDotManagerQ.qqstory.redPoint", 2, "queryNearbyMsgInfo: numRedPaths is null.");
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Aocm);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, List<BusinessInfoCheckUpdate.NumRedInfo> paramList)
  {
    ...
    if (paramList.size() > 0)
    {
      ...
      ((bbbl)paramQQAppInterface.getManager(QQManagerFactory.NUMREDMSG_MANAGER)).a(localArrayList, "nearby_num_red_dot", new axpn(this, paramQQAppInterface));
    }
  }
  ...
  public void b(QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface.removeObserver(this.jdField_a_of_type_Aocm);
  }
  ...
  public void b(QQAppInterface paramQQAppInterface, List<NumRedMsg.NumMsgBusi> paramList)
  {
    ...
    ntq localntq = (ntq)paramQQAppInterface.getManager(QQManagerFactory.MGR_RED_TOUCH_EX);
    ...
    while (((Iterator)localObject3).hasNext())
    {
      ...
      try
      {
        ...
        localObject4 = (bbbq)paramQQAppInterface.getManager(QQManagerFactory.MGR_RED_TOUCH);
        if ((!str2.equals("7719.771901")) && (!str2.equals("7719.771903")) && (!str2.equals("7719.771904"))) {
          break label1155;
        }
        i = ((bbbq)localObject4).a(str2, 0);
        i = ((bbbq)localObject4).a(str2, 1) + i;
      }
      ...
      catch (Exception localException4)
      {
        try
        {
          ayme.a().a(paramQQAppInterface, (oidb_0x791.RedDotInfo)localObject1);
        }
    ...
    if (((Iterator)localObject1).hasNext())
    {
      ...
      localObject3 = localntq.a(((Integer)localObject2).intValue());
      if ((localObject3 != null) && (nti.h(((oidb_0x791.RedDotInfo)localObject3).uint32_appid.get()))) {
        i = 1;
      }
      for (;;)
      {
        ...
        {
          localntq.a((oidb_0x791.RedDotInfo)localHashMap2.get(localObject2));
          i = 1;
        }
      }
    }
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          localntq.a(localHashMap1);
          localObject2 = new bdlf(paramQQAppInterface).a("dc00899").b("grp_lbs").c("entry").d("nearby_push_red_tmp");
          if (paramList != null)
          {
            localObject1 = Integer.valueOf(paramList.uint32_appid.get());
            ((bdlf)localObject2).a(new String[] { String.valueOf(localObject1) }).a();
            if (paramList != null) {
              break label945;
            }
            if (!QLog.isColorLevel()) {
        ...
        catch (Exception localException1)
        {
          ...
          {
            new bdlf(paramQQAppInterface).a("dc00899").b("grp_lbs").c("entry").d("like_exp_red").a();
            return;
          }
          if (paramList.uint32_appid.get() == 60)
          {
            ...
            {
              new bdlf(paramQQAppInterface).a("dc00899").b("grp_lbs").c("entry").d("assist_exp_red").a();
              return;
            }
            new bdlf(paramQQAppInterface).a("dc00899").b("grp_lbs").c("entry").d("c2c_exp_red").a();
            return;
          }
        }
      }
    } while (paramList.uint32_appid.get() != 61);
    new bdlf(paramQQAppInterface).a("dc00899").b("grp_lbs").c("entry").d("paried_exp_red").a();
  }
}
