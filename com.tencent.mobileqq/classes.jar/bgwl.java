...
public class bgwl
{
  private static final int jdField_a_of_type_Int = bgpx.a("qqminiapp", "mini_game_judge_timing_request_begin_delay", 1000);
  private static long jdField_a_of_type_Long;
  private static COMM.StCommonExt jdField_a_of_type_NS_COMMCOMM$StCommonExt;
  private static bgxi jdField_a_of_type_Bgxi;
  private static Runnable jdField_a_of_type_JavaLangRunnable;
  private static final String jdField_a_of_type_JavaLangString = bgpx.a("qqminiapp", "enable_heart_beat_scene_whitelist", "");
  private static boolean jdField_a_of_type_Boolean;
  private static final String b = bgpx.a("qqminiapp", "enable_heart_beat_appid_whitelist", "");
  private static final String c = bgpx.a("qqminiapp", "enable_heart_beat_via_whitelist", "");
  
  public static void a()
  {
    jdField_a_of_type_Bgxi = null;
  }
  ...
  public static void a(bgxi parambgxi)
  {
    jdField_a_of_type_Bgxi = parambgxi;
  }
  ...
  public static void b(Context paramContext, MiniAppInfo paramMiniAppInfo)
  {
    ...
    if (jdField_a_of_type_Bgxi != null) {
      jdField_a_of_type_Bgxi.a();
    }
  }
  ...
  private static void b(Context paramContext, MiniAppInfo paramMiniAppInfo, int paramInt)
  {
    ...
    String str2 = bhcg.a(paramMiniAppInfo);
    String str1;
    int i;
    label70:
    int j;
    ...
    {
      localChannelProxy.JudgeTiming(str1, i, j, paramInt, l, k, str2, 0, str3, paramMiniAppInfo.gameAdsTotalTime, jdField_a_of_type_NS_COMMCOMM$StCommonExt, new bgwm(paramContext, paramMiniAppInfo, paramInt));
      return;
      str1 = "";
      break;
      i = 0;
  ...
  private static void b(MiniAppInfo paramMiniAppInfo, INTERFACE.StJudgeTimingRsp paramStJudgeTimingRsp, INTERFACE.GuardInstruction paramGuardInstruction)
  {
    ...
    {
      localChannelProxy.ReportExecute(str, i, paramStJudgeTimingRsp, paramMiniAppInfo, new bgwn());
      return;
