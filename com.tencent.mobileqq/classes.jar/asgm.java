  ...
  extends WebViewPlugin
{
  ...
  private void a(String paramString)
  {
    try
    {
      ...
      bmfd.a().a().a((Bundle)localObject, this.mRuntime.a().getCurrentAccountUin());
      return;
    }
    ...
    do
    {
      ...
      if ("answerResult".equals(paramString3))
      {
        ...
        if (!TextUtils.isEmpty(paramJsBridgeListener)) {
          asfu.a(paramJsBridgeListener, false);
        }
        return true;
      }
      if ("notifyCampusFriendCertificateResult".equals(paramString3))
      {
        ...
        {
          b(paramVarArgs[0]);
          bmfd.a().a().a(paramVarArgs[0], "notifyCampusFriendCertificateResult", this.mRuntime.a().getCurrentAccountUin());
        }
        for (;;)
        {
          return true;
      ...
      if ("notifyUploadSutudentIDResult".equals(paramString3))
      {
        ...
        {
          c(paramVarArgs[0]);
          bmfd.a().a().a(paramVarArgs[0], "notifyUploadSutudentIDResult", this.mRuntime.a().getCurrentAccountUin());
        }
        for (;;)
        {
          return true;
