...
public class ajcr
{
  ...
  WeakReference<ajcs> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  public static void a(Activity paramActivity, QQAppInterface paramQQAppInterface, Runnable paramRunnable1, Runnable paramRunnable2)
  {
    ...
    do
    {
      ...
      if (VersionUtils.isM())
      {
        ...
        localajct.jdField_a_of_type_JavaLangRunnable = paramRunnable1;
        localajct.jdField_b_of_type_JavaLangRunnable = paramRunnable2;
        localajct.jdField_a_of_type_Int = 1;
        paramQQAppInterface.a().a(paramActivity, localajct, null, new String[] { "android.permission.READ_CONTACTS", "android.permission.WRITE_CONTACTS", "android.permission.GET_ACCOUNTS" });
        return;
      }
  ...
  {
    ajcs localajcs;
    if (this.jdField_a_of_type_Ajct != null)
    {
      this.jdField_a_of_type_Ajct.jdField_b_of_type_Int = a();
      QLog.d("contact.PermissionChecker", 1, "onPermissionResult = " + this.jdField_a_of_type_Ajct.jdField_b_of_type_Int);
      ...
      localajcs.a(paramBoolean, this.jdField_a_of_type_Ajct);
    }
    for (;;)
    {
      this.jdField_a_of_type_Ajct = null;
      return;
      label78:
      localajcs = (ajcs)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      break;
      label92:
      this.jdField_a_of_type_Ajct.a(paramBoolean);
    }
  }
  ...
  public void a(Activity paramActivity, ajct paramajct, ajcs paramajcs, String... paramVarArgs)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramActivity = paramajct;
        if (paramajct == null) {
          paramActivity = new ajct();
        }
        paramajct = new StringBuilder(512);
        ...
        if (i < j)
        {
          ...
          paramajct.append(str).append(",");
          i += 1;
        }
        else
        {
          paramActivity.jdField_a_of_type_JavaUtilList = localArrayList;
          this.jdField_a_of_type_Ajct = paramActivity;
          this.jdField_a_of_type_JavaLangRefWeakReference = null;
          if (paramajcs != null) {
            this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramajcs);
          }
          QLog.d("contact.PermissionChecker", 1, "requestPermissions = " + paramajct.toString());
