...
public class bbtv
  implements bbtg
{
  public bbtv(SignTextEditFragment paramSignTextEditFragment) {}
  ...
  public void a(int paramInt, RichStatus paramRichStatus, Object paramObject)
  {
    ...
    if ((paramRichStatus == null) || (paramRichStatus == RichStatus.getEmptyStatus())) {
      if (paramInt == 100) {
        QQToast.a(BaseApplication.context, 2, anvx.a(2131713599), 0).a();
      }
    }
    for (int i = 0;; i = 1)
    {
      ...
      if (paramInt == 100)
      {
        ...
        {
          bbvh.a().addObserver(this.a.jdField_a_of_type_JavaUtilObserver);
          paramObject = bbvh.a().a(this.a.jdField_a_of_type_ComTencentMobileqqRichstatusRichStatus.tplId);
      ...
      {
        return;
        QQToast.a(BaseApplication.context, 1, anvx.a(2131713591), 0).a();
        break;
        int j = i;
        if (Integer.parseInt(paramObject.jdField_a_of_type_JavaLangString) > 0)
        {
          ...
          if (paramObject.f < 2)
          {
            ...
            {
              bhiw.a(this.a.getActivity(), this.a.getActivity().app, 0, "signature_chouti");
              j = 0;
            }
          }
        }
