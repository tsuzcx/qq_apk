...
public class lpj
{
  ...
  public lps a(lps paramlps, int paramInt1, int paramInt2)
  {
    if ((paramlps == null) || (paramlps.b == -1) || (paramInt1 == 0) || (paramInt2 == 0)) {
      return null;
    }
    ...
    this.jdField_a_of_type_ComTencentTtpicOpenapiFilterTextureRender.drawTexture(3553, paramlps.b, this.jdField_a_of_type_ArrayOfFloat, this.b);
    this.jdField_a_of_type_ComTencentTtpicOpenapiFilterRenderBuffer.unbind();
    return lps.a(0, this.jdField_a_of_type_ComTencentTtpicOpenapiFilterRenderBuffer.getTexId());
  }
