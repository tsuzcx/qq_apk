...
public class bfgn
{
  public static Object a(PBField paramPBField)
  {
    ...
    {
      betc.d("GdtJsonPbUtil", "pbToJson error");
      return null;
    }
    ...
    betc.d("GdtJsonPbUtil", "pbToJson error, " + paramPBField.getClass().getName() + " is not supported");
    return null;
  }
  ...
  private static Object a(PBPrimitiveField<?> paramPBPrimitiveField)
  {
    ...
    {
      betc.d("GdtJsonPbUtil", "pbPrimitiveFieldToJson", paramPBPrimitiveField);
    }
    return "";
  }
  ...
  private static Object a(Object paramObject)
  {
    if (paramObject == null)
    {
      betc.d("GdtJsonPbUtil", "getOfPB error");
      return null;
    }
    try
    {
    ...
    {
      betc.d("GdtJsonPbUtil", "getOfPB", paramObject);
    }
    return null;
  }
  ...
  private static JSONArray a(PBField paramPBField)
  {
    ...
    {
      betc.d("GdtJsonPbUtil", "pbRepeatToJson error");
      return null;
    }
    ...
    if (i < j)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          betc.d("GdtJsonPbUtil", "pbMessagebToJson error");
        }
        catch (IllegalAccessException localIllegalAccessException)
        {
          betc.d("GdtJsonPbUtil", "pbMessagebToJson", localIllegalAccessException);
        }
        continue;
        label177:
        ...
        if ((localObject1 != null) && (localObject1 != JSONObject.NULL)) {
          ...
          {
            betc.d("GdtJsonPbUtil", "pbMessagebToJson", localJSONException);
          }
        }
      }
    }
