...
{
  public agnz(PersonalityLabelGalleryActivity paramPersonalityLabelGalleryActivity) {}
  ...
  public void a(boolean paramBoolean, String paramString, PersonalityLabel paramPersonalityLabel, byte[] paramArrayOfByte, int paramInt)
  {
    ...
    {
      PersonalityLabelGalleryActivity.a(this.a, this.a.getResources().getString(2131433213));
      paramString = this.a;
    ...
    for (paramInt = 8;; paramInt = 0)
    {
      ...
      return;
      PersonalityLabelGalleryActivity.a(this.a, this.a.getResources().getString(2131435101));
      break;
    }
  }
}
