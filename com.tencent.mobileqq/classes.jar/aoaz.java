  ...
  implements aobg
{
  ...
  private void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    localBundle.putString("brief_key", ajya.a(2131704389));
    ...
    paramSessionInfo = aeht.a(this.jdField_a_of_type_JavaLangString);
    if ((paramSessionInfo != null) && (paramSessionInfo.length >= 8)) {
      bghx.a(paramQQAppInterface, "100007", "2", "40051", paramSessionInfo[0], new String[] { paramSessionInfo[2], paramSessionInfo[4], aeht.a(this.jdField_a_of_type_JavaLangString) });
    }
  }
  ...
  public Drawable a(Context paramContext, float paramFloat)
  {
    ...
    //   68: ldc 169
    //   70: aload_0
    //   71: getfield 64	aoaz:d	Ljava/lang/String;
    ...
    //   87: aload_3
    //   88: aload_0
    //   89: getfield 64	aoaz:d	Ljava/lang/String;
    ...
    //   131: aload_0
    //   132: getfield 64	aoaz:d	Ljava/lang/String;
    ...
    //   219: aload_0
    //   220: invokevirtual 238	aoaz:toString	()Ljava/lang/String;
  ...
  public Drawable a(Context paramContext, float paramFloat, int paramInt1, int paramInt2)
  {
    ...
    //   73: ldc 250
    //   75: aload_0
    //   76: getfield 64	aoaz:d	Ljava/lang/String;
    ...
    //   93: aload 5
    //   95: aload_0
    //   96: getfield 64	aoaz:d	Ljava/lang/String;
    ...
    //   139: aload_0
    //   140: getfield 64	aoaz:d	Ljava/lang/String;
    ...
    //   231: aload_0
    //   232: invokevirtual 238	aoaz:toString	()Ljava/lang/String;
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, EditText paramEditText, SessionInfo paramSessionInfo)
  {
    ...
    if (aeht.a(this.jdField_a_of_type_JavaLangString))
    {
    ...
    if (((paramContext instanceof BaseActivity)) && (asyx.a(paramSessionInfo.jdField_a_of_type_Int, paramSessionInfo.jdField_a_of_type_JavaLangString)))
    {
      ...
      bcql.a(paramQQAppInterface.getApp(), ajya.a(2131704391), 0).b(paramContext.getTitleBarHeight());
      return;
    }
    ...
    {
      aanz.a(paramQQAppInterface, paramContext, paramSessionInfo, paramEditText, true, bool, this.c, null);
      if ((TextUtils.isEmpty(this.d)) || (!this.d.contains("qto_"))) {
        break;
      }
      axqy.b(((BaseActivity)paramContext).app, "CliOper", "", "", "0X8005C74", "0X8005C74", 0, 0, String.valueOf(ajxo.a(this.c)), "", ajxo.a(this.d), "");
      return;
    }
    axqy.b(((BaseActivity)paramContext).app, "CliOper", "", "", "ep_mall", "0X800579F", 0, 0, "", "", "1", "");
  }
  ...
  public Drawable b(Context paramContext, float paramFloat)
  {
    try
    {
      ...
      localURLDrawableOptions.mFailedDrawable = paramContext.getResources().getDrawable(2130843143);
