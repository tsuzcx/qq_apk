...
public class adhd
  extends allb
{
  public adhd(NotifyPushSettingActivity paramNotifyPushSettingActivity) {}
  ...
  protected void onSetShowPushNotice(boolean paramBoolean1, boolean paramBoolean2)
  {
    if (paramBoolean1)
    {
      ...
      {
        azmj.b(null, "dc00898", "", "", (String)localObject, (String)localObject, 0, 1, "", "", "", "");
        return;
      }
    }
    ...
    QQToast.a(this.a.app.getApp(), 1, this.a.getString(2131719872), 0).b(5);
