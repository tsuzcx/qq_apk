...
public class avqx
  extends astz
{
  public avqx(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
  }
  
  private aaog a(MessageForReplyText paramMessageForReplyText, asug paramasug)
  {
    SessionInfo localSessionInfo = paramasug.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo;
    int i = paramasug.g;
    aaog localaaog = new aaog();
    localaaog.jdField_c_of_type_Int = bbfj.a(BaseApplication.getContext());
    localaaog.jdField_a_of_type_Long = System.currentTimeMillis();
    ...
    {
      localaaog.jdField_b_of_type_JavaLangString = ((String)localObject);
      localObject = MessageForText.getTroopMemberInfoFromExtrJson((String)localObject);
      String str2 = aanz.a(str1, (ArrayList)localObject);
      if (!TextUtils.isEmpty(str2)) {
        str1 = axau.a(str2, true, (ArrayList)localObject);
      }
      localaaog.jdField_a_of_type_JavaLangString = str1;
    ...
    {
      localaaog.jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText$SourceMsgInfo = new MessageForReplyText.SourceMsgInfo(paramMessageForReplyText.mSourceMsgInfo);
      if (paramMessageForReplyText.getSourceMessage() != null) {
        localaaog.jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText$SourceMsgInfo.packSourceMsg(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageForReplyText.getSourceMessage());
      }
      if (i > 0)
      {
        localaaog.jdField_c_of_type_Long = paramMessageForReplyText.uniseq;
        localaaog.e = i;
        paramMessageForReplyText.atInfoList = null;
      }
      localaaog.jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText$SourceMsgInfo.mType = 0;
    }
    ...
    for (i = 1;; i = 0)
    {
      if ((!paramasug.jdField_a_of_type_Boolean) || (i != 0))
      {
        localaaog.jdField_d_of_type_Boolean = paramMessageForReplyText.isBarrageMsg;
        localaaog.jdField_b_of_type_Long = paramMessageForReplyText.barrageTimeLocation;
        localaaog.jdField_d_of_type_Int = paramMessageForReplyText.barrageSourceMsgType;
      }
      return localaaog;
    }
  }
  ...
  {
    HashMap localHashMap = paramasug.jdField_a_of_type_JavaUtilHashMap;
    ...
    {
      aaog localaaog = a(localMessageForReplyText, paramasug);
      aanz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, null, paramasug.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, (String)localObject, localMessageForReplyText.atInfoList, localaaog);
      break label55;
      break;
    }
  }
  ...
  public ArrayList<MessageRecord> a(QQAppInterface paramQQAppInterface, List<? extends MessageRecord> paramList, boolean paramBoolean)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((paramList instanceof MessageForReplyText))
      {
        ...
        if ((localMessageForReplyText2.getSourceMessage() != null) && (apug.a(localMessageForReplyText2.getSourceMessage()))) {
      ...
      if ((paramList instanceof MessageForMixedMsg))
      {
        ...
        if ((localMessageForReplyText1 != null) && (localMessageForReplyText2 != null) && (localMessageForReplyText1.getSourceMessage() != null) && (apug.a(localMessageForReplyText1.getSourceMessage()))) {
  ...
  public void b(auor paramauor)
  {
    ...
    do
    {
      do
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("ReplyMsgController", 2, "onSend result.data=" + paramauor.a);
        }
      } while ((paramauor.a == null) || (!(paramauor.a instanceof String)));
      paramauor = (String)paramauor.a;
      paramauor = (asug)this.jdField_a_of_type_JavaUtilMap.get(paramauor);
      if (QLog.isColorLevel()) {
        QLog.d("ReplyMsgController", 2, "onSend request=" + paramauor);
      }
    } while (paramauor == null);
    this.jdField_a_of_type_JavaUtilMap.remove(paramauor.a());
    h(paramauor);
  }
  ...
  public void f(asug paramasug)
  {
    ...
    while (localIterator.hasNext()) {
      ((asts)localIterator.next()).a(paramasug, paramasug.jdField_a_of_type_JavaUtilHashMap, this);
    }
    asuh.b("ReplyMsgController step.uploadRichStart", new Object[0]);
  }
