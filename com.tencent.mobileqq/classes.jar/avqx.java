  ...
  extends alko
{
  ...
  private void a(int paramInt, Intent paramIntent, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      for (paramIntent = Integer.toString(j);; paramIntent = i + "_" + j)
      {
        ...
        azmz.a(this.mApp.getApplication()).a(this.app.getCurrentAccountUin(), "ocrTextSearch", bool, l, 0L, paramArrayOfByte, "");
        if (QLog.isColorLevel()) {
  ...
  private void a(Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      Object localObject4 = baoc.a().b(l1);
      Object localObject5 = baoc.a().a(l1);
      ...
      try
      {
        ...
        ((baps)localObject1).jdField_a_of_type_ArrayOfByte = ((byte[])localObject5);
        ((baps)localObject1).jdField_a_of_type_Bapx = new avqy(this, paramIntent, (byte[])localObject2, (String)localObject3);
        ((baps)localObject1).jdField_a_of_type_JavaLangString = ((String)localObject4);
        ((baps)localObject1).jdField_a_of_type_Int = 1;
        ((baps)localObject1).f = 57;
        ((baps)localObject1).jdField_a_of_type_JavaUtilHashMap.put("Accept-Encoding", "identity");
        ((baps)localObject1).jdField_c_of_type_Int = 2;
        ((baps)localObject1).jdField_c_of_type_Long = 15000L;
        paramIntent = BaseApplicationImpl.sApplication.getRuntime();
        if ((paramIntent instanceof AppInterface))
        {
          ((AppInterface)paramIntent).getNetEngine(0).a((baqv)localObject1);
          if (QLog.isColorLevel()) {
