...
public class ydn
  extends MqqHandler
{
  public ydn(ShortVideoPlayActivity paramShortVideoPlayActivity) {}
    ...
    do
    {
      do
      {
        do
        {
          ...
          return;
          paramMessage = DialogUtil.b(this.a.jdField_a_of_type_AndroidContentContext, 232, this.a.jdField_a_of_type_AndroidContentContext.getResources().getString(2131437389), this.a.jdField_a_of_type_AndroidContentContext.getResources().getString(2131437390), 2131437391, 2131434587, new ydo(this), new ydp(this));
