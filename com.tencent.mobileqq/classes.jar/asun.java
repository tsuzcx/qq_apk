...
{
  private DialogInterface.OnKeyListener jdField_a_of_type_AndroidContentDialogInterface$OnKeyListener = new asuo(this);
  private TextView jdField_a_of_type_AndroidWidgetTextView;
  public asup a;
  private FileSaveProgressView jdField_a_of_type_ComTencentMobileqqMultimsgSaveFileSaveProgressView;
  
  public asun(@NonNull Context paramContext)
  {
  ...
  private void a(@NonNull Context paramContext)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqMultimsgSaveFileSaveProgressView = ((FileSaveProgressView)paramContext.findViewById(2131375572));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramContext.findViewById(2131363851));
  ...
  {
    if (isShowing()) {
      if (this.jdField_a_of_type_Asup != null) {
        this.jdField_a_of_type_Asup.a();
      }
    }
    try
    {
  ...
  {
    this.jdField_a_of_type_Asup = paramasup;
  }
