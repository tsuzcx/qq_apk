  ...
  extends AvatarWallPagerAdapter<GridView>
{
  ...
  public asun(aste paramaste, AvatarWallViewPager paramAvatarWallViewPager)
  {
  ...
  {
    return aste.a(this.jdField_a_of_type_Aste, aste.a(this.jdField_a_of_type_Aste), paramInt);
  }
  ...
  public View a(boolean paramBoolean, int paramInt)
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetLinearLayout$LayoutParams = new LinearLayout.LayoutParams(vms.a(this.jdField_a_of_type_Aste.jdField_a_of_type_AndroidContentContext, 30.0F), vms.a(this.jdField_a_of_type_Aste.jdField_a_of_type_AndroidContentContext, 1.5F));
