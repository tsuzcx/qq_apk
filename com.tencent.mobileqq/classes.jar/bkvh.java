  ...
  extends zdf
{
  ...
  public bkvh(AppInterface paramAppInterface)
  {
  ...
  private boolean d(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    paramToServiceMsg.MqVersion = "8.3.3";
    paramUniPacket.setServantName("CameraModuleSvc");
  ...
  {
    bkvp localbkvp = new bkvp(true);
    try
    {
      localbkvp.setEncodeName("utf-8");
      localbkvp.decode(paramArrayOfByte);
      return localbkvp.getByClass(paramString, paramT);
    }
