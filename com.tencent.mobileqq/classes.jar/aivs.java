...
public class aivs
  extends bcvj
{
  public aivs(ChatHistoryC2CAllFragment paramChatHistoryC2CAllFragment) {}
  ...
  public void a(boolean paramBoolean, Object[] paramArrayOfObject)
  {
    try
    {
      ...
      if (this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131718877).equals(str))
      {
      ...
      QLog.i(bctz.i, 2, " onGetUserAuth  isSuccess = " + paramBoolean + " tips =" + str);
      return;
    }
    catch (Exception paramArrayOfObject)
    {
      QLog.e(bctz.i, 2, " onGetUserAuth  exception = " + paramArrayOfObject.toString());
    }
  }
  ...
  public void b(boolean paramBoolean, Object[] paramArrayOfObject)
  {
    try
    {
      QLog.i(bctz.i, 2, " onSetUserAuth  isSuccess = " + paramBoolean);
      Object localObject = (DocsGrayTipsInfo)paramArrayOfObject[0];
      String str = (String)paramArrayOfObject[1];
      long l = ((Long)paramArrayOfObject[2]).longValue();
      if (paramBoolean)
    ...
    {
      QLog.e(bctz.i, 1, " onSetUserAuth  exception  = " + paramArrayOfObject.toString());
    }
  }
}
