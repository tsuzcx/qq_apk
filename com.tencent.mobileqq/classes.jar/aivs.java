...
public class aivs
  implements Runnable
{
  public aivs(TroopAvatarWallEditActivity paramTroopAvatarWallEditActivity, URLDrawable paramURLDrawable, ActionSheet paramActionSheet) {}
  ...
  public void run()
  {
    try
    {
      ...
      if ((!TextUtils.isEmpty((CharSequence)localObject)) && (TroopAvatarWallEditActivity.a(this.jdField_a_of_type_ComTencentMobileqqTroopActivityTroopAvatarWallEditActivity, new File((String)localObject))))
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqTroopActivityTroopAvatarWallEditActivity.runOnUiThread(new aivt(this));
      }
      for (;;)
      {
