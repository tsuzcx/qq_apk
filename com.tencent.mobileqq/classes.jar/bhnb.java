...
public class bhnb
  extends aodb
{
  public bhnb(FriendCloneSettingFragment paramFriendCloneSettingFragment) {}
    ...
    for (;;)
    {
      ...
      if (i == 258)
      {
        ...
        if (this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity != null) {
          QQToast.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 1, anvx.a(2131704342), 0).a();
        }
