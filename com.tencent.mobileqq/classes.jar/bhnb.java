...
public class bhnb
{
  ...
  private static void a(Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4, bhnm parambhnm, int paramInt)
  {
    paramActivity = new FreeWifiHelper.5(paramActivity, paramString1, paramString2, paramString3, paramString4, new bhnf(paramInt, paramActivity, parambhnm), new bhng(parambhnm, paramInt), new bhnh(parambhnm, paramInt), paramInt);
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      do
      {
        ...
        localObject = bhnr.a(localBaseApplication, str);
        if (QLog.isColorLevel()) {
      ...
      return;
      long l = bhnr.c(localBaseApplication, str);
    ...
    Object localObject = new anek(paramQQAppInterface);
    anel localanel = new anel(paramQQAppInterface);
    localanel.a(new bhnd(paramQQAppInterface, localanel));
    paramQQAppInterface.addObserver(localanel);
    ((anek)localObject).a(2);
    bhnr.c(localBaseApplication, str, System.currentTimeMillis());
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, ConfigurationService.Config paramConfig)
  {
    ...
    int j = bfyz.a(paramQQAppInterface.getApp(), "wifi_connect_config_version", str);
    if (QLog.isColorLevel()) {
    ...
    if (i != j)
    {
      bfyz.a(paramQQAppInterface.getApp(), "wifi_connect_config_version", str, i);
      ...
      if (!TextUtils.isEmpty(paramConfig))
      {
        ...
        try
        {
          ...
          {
            e = bool;
            bfyz.a(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentUin(), c, d, e);
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    try
    {
      if (((d) || (e)) && (Conversation.b > 0L))
      {
        ...
        long l2 = bhnr.a((Context)localObject, str);
        long l3 = bhnr.b((Context)localObject, str) * 60 * 60 * 1000L;
        if (QLog.isColorLevel()) {
        ...
        bhnr.a((Context)localObject, str, l1);
        anek localanek = new anek(paramQQAppInterface);
        anel localanel = new anel(paramQQAppInterface);
        localanel.a(new bhnc((Context)localObject, str, paramQQAppInterface, localanel));
        paramQQAppInterface.addObserver(localanel);
        localanek.a(1);
      }
    }
  ...
  public static boolean a(Activity paramActivity, int paramInt, bhnm parambhnm)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt == 1)
      {
        str1 = paramActivity.getString(2131692422);
        str2 = paramActivity.getString(2131692425);
        i = 1;
      }
      while (i != 0)
      {
        String str5 = paramActivity.getString(2131692428);
        String str4 = bhnr.a(paramActivity);
        String str3 = str4;
        if (TextUtils.isEmpty(str4)) {
          str3 = paramActivity.getString(2131692421);
        }
        QLog.i("WifiSdk", 2, "shouldOverrideDialog btn1Text: " + str3);
        a(paramActivity, str5, str1, str3, str2, parambhnm, paramInt);
        return false;
        if ((paramInt == 2) || (paramInt == 4))
        {
          str1 = paramActivity.getString(2131692424);
          str2 = paramActivity.getString(2131692427);
          i = 1;
        }
        else if (paramInt == 3)
        {
          str1 = paramActivity.getString(2131692423);
          str2 = paramActivity.getString(2131692426);
          i = 1;
        }
        else if (paramInt == 5)
        {
          str1 = paramActivity.getString(2131692377);
          str2 = paramActivity.getString(2131692427);
          i = 1;
        }
        else
  ...
  public static boolean a(Context paramContext)
  {
    ...
    try
    {
      ...
      if (!TMSDKWifiManager.init(paramContext.getApplicationContext(), new TMSDKCustomConfig().setCustomToast(new bhnl()).setCustomInstaller(new bhnk()).setCustomThreadPool(new bhnj()).setCustomReporter(new bhni()))) {
        bool = true;
      }
      b = bool;
      WifiSDKUIApi.init(new bhno(), new bhnp());
    }
  ...
  public static void b(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      str = paramQQAppInterface.getCurrentAccountUin();
      localBaseApplication = paramQQAppInterface.getApp();
      long l = bhnr.b(localBaseApplication, str);
      if ((l == -1L) || (System.currentTimeMillis() - l >= 86400000L)) {
        break;
      }
    } while (!QLog.isColorLevel());
    ...
    anek localanek = new anek(paramQQAppInterface);
    anel localanel = new anel(paramQQAppInterface);
    localanel.a(new bhne(paramQQAppInterface, localanel));
    paramQQAppInterface.addObserver(localanel);
    localanek.a(3);
    bhnr.b(localBaseApplication, str, System.currentTimeMillis());
  }
  ...
  public static void c(Context paramContext, int paramInt)
  {
    ...
    bhnq localbhnq = bhnq.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime());
    if (QLog.isColorLevel()) {
      QLog.i("WifiSdk", 2, "dialog click, jumpType: " + localbhnq.jdField_a_of_type_Int + " jumpUrl: " + localbhnq.jdField_a_of_type_JavaLangString);
    }
    if (WifiSDKUIApi.isWiFiManagerExist())
    {
      if (localbhnq.jdField_a_of_type_Int == 4)
      {
    ...
    switch (localbhnq.jdField_a_of_type_Int)
    {
    case 4: 
    default: 
      a(paramContext, paramInt);
      ...
      return;
    case 1: 
      a(paramContext, localbhnq.jdField_a_of_type_JavaLangString);
