...
public class lcy
{
  ...
  public static lcz a(byte[] paramArrayOfByte)
  {
    lcz locallcz = new lcz();
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramArrayOfByte.msg_video_head.has())
        {
          ...
          locallcz.jdField_a_of_type_JavaLangString = ((hd_video.VideoHead)localObject).str_from_mobile.get();
          locallcz.jdField_b_of_type_JavaLangString = ((hd_video.VideoHead)localObject).str_from_nation.get();
          locallcz.jdField_a_of_type_Int = ((hd_video.VideoHead)localObject).enum_body_type.get();
          locallcz.jdField_b_of_type_Long = ((hd_video.VideoHead)localObject).uint64_uin.get();
          if (((hd_video.VideoHead)localObject).int32_sub_service_type.has())
          {
            i = ((hd_video.VideoHead)localObject).int32_sub_service_type.get();
            locallcz.jdField_b_of_type_Int = i;
            locallcz.jdField_c_of_type_Int = ((hd_video.VideoHead)localObject).uint32_seq.get();
            locallcz.jdField_a_of_type_Long = ((hd_video.VideoHead)localObject).uint64_room_id.get();
            if (paramArrayOfByte.msg_invite_body.has())
            {
              ...
              locallcz.jdField_c_of_type_Long = paramArrayOfByte.uint64_from_uin.get();
              locallcz.jdField_d_of_type_Int = paramArrayOfByte.uint32_new_business_flag.get();
              locallcz.jdField_a_of_type_Boolean = paramArrayOfByte.bool_terminal_switch_flag.get();
              if (paramArrayOfByte.msg_temp_session.has())
              {
                paramArrayOfByte = paramArrayOfByte.msg_temp_session;
                locallcz.jdField_d_of_type_Long = paramArrayOfByte.uint64_group_uin.get();
                locallcz.e = paramArrayOfByte.uint32_relationship_type.get();
              }
            }
            QLog.d("VideoPackageUtils", 1, " --- parse video message " + locallcz.toString());
            return locallcz;
          }
        }
        else
