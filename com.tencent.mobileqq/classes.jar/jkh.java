...
public class jkh
{
  ...
  public void a(String paramString)
  {
    ...
    if (!this.jdField_a_of_type_JavaUtilMap.containsKey(paramString))
    {
      ...
      localObject = VideoController.a().a().getResources().getDrawable(2130840222);
    }
    for (;;)
    {
      ...
      if (GestureFilterManager.jdField_a_of_type_JavaLangString.equals("palmup")) {
        localObject = VideoController.a().a().getResources().getDrawable(2130840223);
      } else if (GestureFilterManager.jdField_a_of_type_JavaLangString.equals("qheart")) {
        localObject = VideoController.a().a().getResources().getDrawable(2130840224);
      } else {
