...
public class aanf
{
  private static aanf jdField_a_of_type_Aanf;
  public static String a;
  private Handler jdField_a_of_type_AndroidOsHandler;
  private String b = antf.cY;
  private String c = antf.cZ;
  ...
  public static aanf a()
  {
    try
    {
      if (jdField_a_of_type_Aanf == null) {
        jdField_a_of_type_Aanf = new aanf();
      }
      aanf localaanf = jdField_a_of_type_Aanf;
      return localaanf;
    }
    finally {}
  }
  ...
  public void a(Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4, aanj paramaanj)
  {
    boolean bool = true;
    if (Build.VERSION.SDK_INT >= 23) {
      bool = apdr.a(paramActivity);
    }
    if (!bool)
    {
      bhlq.b(paramActivity);
      return;
    }
    ...
    {
      this.jdField_a_of_type_AndroidOsHandler.post(new SubscribeDraftManager.1(this, paramString1, paramString2, paramString3, paramString4, paramaanj));
      return;
    }
    if (paramaanj != null) {
      paramaanj.a(3, false, paramString2, new Object[0]);
    }
    QLog.d(jdField_a_of_type_JavaLangString, 4, "modifyDraft failed because something is empty");
  }
  
  public void a(Context paramContext, String paramString1, String paramString2, int paramInt, aanq paramaanq)
  {
    ...
    do
    {
      ...
      paramContext.a(new aang(this, paramaanq, paramString1, paramContext));
      paramContext.a(new aanh(this, paramString1, paramString2, paramaanq, paramContext));
    } while (paramContext.isShowing());
    paramContext.show();
  }
  
  public void a(String paramString, aanj paramaanj)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.post(new SubscribeDraftManager.2(this, paramString, paramaanj));
  }
  
  public void a(String paramString1, String paramString2, aanj paramaanj)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.post(new SubscribeDraftManager.4(this, paramString1, paramString2, paramaanj));
  }
  ...
  public void b(String paramString1, String paramString2, aanj paramaanj)
  {
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)))
    {
      QLog.d(jdField_a_of_type_JavaLangString, 4, "deletDraft failed because uin or draftID is empty");
    ...
    this.jdField_a_of_type_AndroidOsHandler.post(new SubscribeDraftManager.5(this, paramString1, paramString2, paramaanj));
  }
}
