...
class axvy
  extends nte
{
  axvy(axvw paramaxvw, axvv paramaxvv, Comments.Comment paramComment) {}
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    if ((paramInt == 0) && (paramArrayOfByte != null))
    {
      ...
      for (;;)
      {
        try
        {
          ...
          if (!localRspBody.busi_buf.has())
          {
            ...
            this.jdField_a_of_type_Axvv.a(this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments$Comment, -1, "");
            return;
          }
        ...
        try
        {
          ...
          this.jdField_a_of_type_Axvv.a(this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments$Comment, (int)localAddCommentNoFilterResp.result.get(), paramArrayOfByte);
          return;
        }
        catch (InvalidProtocolBufferMicroException paramBundle) {}
      }
      QLog.i("CommentsDataSource", 1, "merge publish resp data error");
      this.jdField_a_of_type_Axvv.a(this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments$Comment, -1, paramArrayOfByte);
      return;
      if (localAddCommentNoFilterResp.comment_id.get() > 0L)
      {
        ...
        this.jdField_a_of_type_Axvv.a(this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments$Comment);
        axvw.a(this.jdField_a_of_type_Axvw).add(Long.valueOf(localAddCommentNoFilterResp.comment_id.get()));
        paramBundle = (AppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        if (paramBundle != null) {
          ((ayks)paramBundle.getManager(QQManagerFactory.NEARBY_MOMENT_MANAGER)).e(axvw.a(this.jdField_a_of_type_Axvw).a);
        }
      }
    }
    else
