  ...
  public void a(String arg1, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    synchronized (this.a.c)
    {
      ...
      if (i >= 0)
      {
        ...
        else if (???.equals(((baxa)((WeakReference)this.a.c.get(i)).get()).jdField_b_of_type_JavaLangString))
        {
    ...
    for (;;)
    {
      synchronized (this.a.a)
      {
        ...
        else if (this.a.a.size() < alyz.a(this.a).a)
        {
          this.a.b.remove(i);
          if (this.a.a.contains(???)) {
            break label712;
          }
          paramBoolean1 = this.a.a((baxa)((WeakReference)???).get());
          if (paramBoolean1) {
            this.a.a.add(???);
          }
          if (!QLog.isColorLevel()) {
      ...
      if (QLog.isColorLevel())
      {
        QLog.i("Q.dynamicAvatar", 2, "onFileDownloadFinish to play.02 beyond maxPlayingCount : " + alyz.a(this.a).a);
        break label712;
        label695:
        return;
        ??? = null;
