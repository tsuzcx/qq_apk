  ...
  extends RelativeLayout
{
  ...
  public annc(ApolloGameInfoFragment paramApolloGameInfoFragment, Context paramContext, String paramString)
  {
    super(paramContext);
    a(paramString);
  }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    setOnClickListener(new annf(this, paramString, paramInt));
  }
  ...
  public void a(Bitmap paramBitmap, String paramString)
  {
    ...
    for (;;)
    {
      ...
      setOnClickListener(new anne(this));
      return;
  ...
  public void a(String paramString)
  {
    ...
    ((RelativeLayout.LayoutParams)localObject).setMargins(AIOUtils.dp2px(12.0F, getResources()), AIOUtils.dp2px(17.0F, getResources()), 100, AIOUtils.dp2px(20.0F, getResources()));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130849601);
    paramString = new RelativeLayout.LayoutParams(AIOUtils.dp2px(9.0F, getResources()), AIOUtils.dp2px(18.0F, getResources()));
    paramString.addRule(11);
    paramString.addRule(15);
    paramString.rightMargin = AIOUtils.dp2px(27.0F, getResources());
    ...
    paramString.rightMargin = AIOUtils.dp2px(11.0F, getResources());
    paramString.addRule(11);
    paramString.rightMargin = AIOUtils.dp2px(27.0F, getResources());
    paramString.addRule(15);
    this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(4);
    ...
    this.jdField_a_of_type_ComTencentImageURLImageView.setVisibility(4);
    paramString = new RelativeLayout.LayoutParams(AIOUtils.dp2px(25.0F, getResources()), AIOUtils.dp2px(25.0F, getResources()));
    paramString.rightMargin = AIOUtils.dp2px(11.0F, getResources());
    paramString.addRule(0, this.c);
    paramString.addRule(15);
    setBackgroundResource(2130839418);
    addView(this.jdField_a_of_type_ComTencentImageURLImageView, paramString);
    setOnClickListener(new annd(this));
  }
