...
public class annc
  extends ajyr
{
  public annc(NearbyTransitActivity paramNearbyTransitActivity) {}
  ...
  {
    anml.a("NearbyTransitActivity", new Object[] { "onJoinHotChat", Boolean.valueOf(NearbyTransitActivity.a(this.a)), Boolean.valueOf(paramBoolean), paramString1 });
  ...
  public void a(boolean paramBoolean, HotChatInfo paramHotChatInfo, Common.WifiPOIInfo paramWifiPOIInfo, int paramInt, String paramString)
  {
    ...
    if ((NearbyTransitActivity.a(this.a) == 1) && (!bbbr.a(str, NearbyTransitActivity.a(this.a)))) {}
    do
    {
      return;
      NearbyTransitActivity.a("onQuickJoinHotChat", 1);
      anml.a("NearbyTransitActivity", new Object[] { "onQuickJoinHotChat", Boolean.valueOf(NearbyTransitActivity.a(this.a)), Boolean.valueOf(paramBoolean), Integer.valueOf(NearbyTransitActivity.a(this.a)), Integer.valueOf(paramInt), str, paramHotChatInfo, paramWifiPOIInfo });
    ...
    {
      atbr.a("NearbyTransitActivity", new Object[] { "onQuickJoinHotChat allocate room success,is to showing entering tip " });
      paramString = Message.obtain();
      paramString.what = 5;
      paramString.obj = String.format(this.a.getResources().getString(2131693303), new Object[] { Integer.valueOf(paramHotChatInfo.mFissionRoomNum) });
      ...
      paramWifiPOIInfo.obj = asyx.a(paramInt);
    }
