  ...
  implements Handler.Callback
{
  ...
  private aocj jdField_a_of_type_Aocj = new avqu(this);
  private avsi jdField_a_of_type_Avsi;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private long[] jdField_a_of_type_ArrayOfLong;
  private avsi b;
  
  public avqr(QQAppInterface paramQQAppInterface)
  {
  ...
  public static avqr a(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    QQToast.a(paramContext, 0, anzj.a(2131703569), 2000).a();
    int j;
    if (this.b != null)
    {
    ...
    for (int i = this.b.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble.fontId;; i = this.b.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble.bubbleId)
    {
      ...
      this.b = null;
      this.jdField_a_of_type_Avsi = null;
      return;
    }
  }
  ...
  private void a(BaseChatPie paramBaseChatPie)
  {
    ...
    do
    {
      ...
      paramBaseChatPie.a(localaeau);
      localaeau.i = paramBaseChatPie.I;
      paramBaseChatPie.I = false;
      this.jdField_a_of_type_ArrayOfLong = aean.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramBaseChatPie.a(), paramBaseChatPie.a(), str, new ArrayList(), localaeau);
  ...
  private void a(BaseChatPie paramBaseChatPie, long paramLong, int paramInt)
  {
    ...
    if (TextUtils.isEmpty((CharSequence)localObject2)) {
      localObject1 = anzj.a(2131703570);
    }
    ...
    bhlq.a(paramBaseChatPie.a(), 230, (String)localObject1, (CharSequence)localObject2, anzj.a(2131703571), (String)localObject3, new avqs(this, paramBaseChatPie, str), new avqt(this)).show();
  }
  ...
  public void a(long paramLong)
  {
    ...
    for (;;)
    {
      if (i < j)
      {
        ...
        if (this.jdField_a_of_type_Avsi != null) {
          this.jdField_a_of_type_Avsi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        }
      }
      return;
      label59:
  ...
  public void a(BaseChatPie paramBaseChatPie, Bundle paramBundle)
  {
    ...
    if (this.b != null)
    {
      ...
      this.b = new avsi(this.b.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble);
  ...
  public void a(BaseChatPie paramBaseChatPie, boolean paramBoolean, SetFontBubbleRsp paramSetFontBubbleRsp, int paramInt)
  {
    if ((paramBoolean) && (paramSetFontBubbleRsp.stRet != null) && (paramSetFontBubbleRsp.stRet.ret == 0))
    {
      ...
      if ((this.jdField_a_of_type_Avsi != null) && (this.jdField_a_of_type_Avsi.jdField_a_of_type_Int == paramInt))
      {
        if ((paramSetFontBubbleRsp.stFontRsp.authRet != 0) || (paramSetFontBubbleRsp.stBubbleRsp.authRet != 0)) {
          QLog.e("FontBubbleManager", 1, "onSetFontBubble failed," + " fontAuth:" + paramSetFontBubbleRsp.stFontRsp.authRet + " bubbleAuth:" + paramSetFontBubbleRsp.stBubbleRsp.authRet + this.jdField_a_of_type_Avsi.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble);
        }
        for (;;)
        {
          this.jdField_a_of_type_Avsi = null;
          return;
          if (QLog.isColorLevel()) {
            QLog.d("FontBubbleManager", 2, "onSetFontBubble mRestore success: " + this.jdField_a_of_type_Avsi.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble);
          }
        }
      }
    ...
    StringBuilder localStringBuilder = agej.a().append("onSetFontBubble failed,");
    ...
    if ((this.jdField_a_of_type_Avsi != null) && (this.jdField_a_of_type_Avsi.jdField_a_of_type_Int == paramInt)) {
      QLog.e("FontBubbleManager", 1, "restore failed: " + this.jdField_a_of_type_Avsi.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble);
    }
    a(paramBaseChatPie.a());
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 1000: 
      ...
      this.jdField_a_of_type_Avsi = new avsi((FontBubble)paramMessage[0]);
      this.b = new avsi((FontBubble)paramMessage[1]);
      this.b.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      return true;
    }
