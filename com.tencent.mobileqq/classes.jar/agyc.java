  ...
  implements Manager
{
  ...
  private agyx jdField_a_of_type_Agyx;
  ...
  private ConcurrentHashMap<String, bdvv> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  private AtomicBoolean jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
  private volatile boolean jdField_a_of_type_Boolean;
  private agyx jdField_b_of_type_Agyx;
  ...
  public agyc(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaLangRunnable = new BlessManager.1(this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    paramQQAppInterface = aljq.aX + jdField_a_of_type_JavaLangString;
  ...
  private void a(amjk paramamjk)
  {
    RecentUser localRecentUser = paramamjk.a(aljq.au, 9003);
    long l = NetConnInfoCenter.getServerTime();
    localRecentUser.uin = aljq.au;
  ...
  private void a(amjk paramamjk, RecentUser paramRecentUser)
  {
    paramamjk.b(paramRecentUser);
    a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
      ...
      for (;;)
      {
        if (m < arrayOfString.length) {
          ...
          else
          {
            ...
            {
              localObject = bfhi.b(arrayOfString[m]);
              j = 1;
  ...
  private void a(BlessTask paramBlessTask, ArrayList<BlessPtvModule> paramArrayList, ArrayList<BlessWording> paramArrayList1)
  {
    ...
    for (;;)
    {
      ...
      {
        localawby.a();
        localawbw.a(BlessTask.class);
        if (paramBlessTask != null) {
          localawbw.b(paramBlessTask);
        }
        localawbw.a(BlessPtvModule.class);
        if (paramArrayList != null)
        {
          paramBlessTask = paramArrayList.iterator();
          if (paramBlessTask.hasNext())
          {
            localawbw.b((BlessPtvModule)paramBlessTask.next());
            continue;
          }
        }
      }
      catch (Exception paramBlessTask)
      {
        ...
        localawby.b();
        return;
        localawbw.a(BlessWording.class);
        if (paramArrayList1 != null)
        {
          paramBlessTask = paramArrayList1.iterator();
          if (paramBlessTask.hasNext())
          {
            localawbw.b((BlessWording)paramBlessTask.next());
            continue;
          }
        }
      }
  ...
  private void a(String paramString, BlessTask paramBlessTask, ArrayList<BlessPtvModule> paramArrayList, ArrayList<BlessWording> paramArrayList1)
  {
    ...
    this.jdField_a_of_type_Agyx.b();
    Object localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences();
    agyx.a((SharedPreferences)localObject1, this.jdField_a_of_type_Agyx, 1);
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    {
      return;
      localbdvv = (bdvv)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString2);
      if (localbdvv == null) {
        break label147;
      }
      if ((localbdvv.a() != 2) && (localbdvv.a() != 3)) {
        break;
      }
    ...
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString2, localbdvv);
    localbdwa.a(localbdvv, new agyd(this, paramString2, paramString1), null);
  }
  ...
  private void a(ArrayList<BlessPtvModule> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        bdcs.a(this.jdField_b_of_type_JavaLangString + str1);
        if (!QLog.isColorLevel()) {
          break;
        }
    ...
    for (int i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        ...
        if (i != 0)
        {
          ...
          if ((bhou.d()) && (!new File((String)localObject1).exists()))
          {
            k();
            if (QLog.isColorLevel()) {
  ...
  private void d(boolean paramBoolean)
  {
    ...
    RecentUser localRecentUser = localamjk.b(aljq.au, 9003);
    int i;
    label78:
    Object localObject;
  ...
  private void h()
  {
    ...
    Object localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences();
    this.jdField_a_of_type_Agyx = agyx.a((SharedPreferences)localObject1, 1);
    this.jdField_b_of_type_Agyx = agyx.a((SharedPreferences)localObject1, 2);
    Object localObject3 = bdiw.a((SharedPreferences)localObject1, "bless_uin_to_send", null);
    if (localObject3 != null)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        if (this.jdField_b_of_type_Agyx != null) {
          break label212;
        }
      }
    }
    ...
    label198:
    label212:
    for (localObject1 = localObject2;; localObject1 = Integer.valueOf(this.jdField_b_of_type_Agyx.a()))
    {
      ...
      break label112;
      localObject1 = Integer.valueOf(this.jdField_a_of_type_Agyx.a());
      break label133;
    }
  }
  ...
  private void i()
  {
    ...
    Object localObject2 = (ArrayList)((awbw)localObject1).a(BlessTask.class, new BlessTask().getTableName(), false, null, null, null, null, null, null);
    if ((localObject2 != null) && (((ArrayList)localObject2).size() > 0)) {
      this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessTask = ((BlessTask)((ArrayList)localObject2).get(0));
    }
    this.jdField_a_of_type_JavaUtilArrayList = ((ArrayList)((awbw)localObject1).a(BlessPtvModule.class, new BlessPtvModule().getTableName(), false, null, null, null, null, null, null));
    this.jdField_b_of_type_JavaUtilArrayList = ((ArrayList)((awbw)localObject1).a(BlessWording.class, new BlessWording().getTableName(), false, null, null, null, null, null, null));
    ((awbw)localObject1).a();
    if (QLog.isColorLevel())
    {
  ...
  private void k()
  {
    if ((bhou.d()) && (!this.jdField_a_of_type_Boolean)) {
  ...
  public acfb a(int paramInt1, int paramInt2)
  {
    acfb localacfb = new acfb();
    localacfb.jdField_a_of_type_Int = 0;
    if (paramInt1 == 2) {
      localacfb.jdField_b_of_type_Int = 1;
    }
    for (;;)
    {
      localacfb.jdField_b_of_type_Long = paramInt2;
      return localacfb;
      if (paramInt1 == 3) {
        localacfb.jdField_b_of_type_Int = 4;
      } else {
        localacfb.jdField_b_of_type_Int = 0;
      }
    }
  }
  ...
  public Drawable a()
  {
    Object localObject2 = BaseApplication.getContext().getResources().getDrawable(2130838616);
    boolean bool = azib.a();
    Object localObject3;
    Object localObject1;
    int i;
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessTask != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessTask.recentHeadImgUrl != null))
    {
      if ((this.jdField_b_of_type_AndroidGraphicsDrawableDrawable == null) || (this.jdField_d_of_type_Boolean != bool))
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject1))
        {
          ...
          i = aekt.a(50.0F, BaseApplication.getContext().getResources());
  ...
  public String a(String paramString1, String paramString2)
  {
    ...
    return paramString1 + bdbi.encodeToString(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentNickname().getBytes(), 2);
  }
  ...
  public void a(Context paramContext)
  {
    ...
    aeif.a(paramContext, localIntent, str);
  }
  ...
  public void a(ArrayList<String> paramArrayList, int paramInt)
  {
    ...
    if (paramInt == 1)
    {
      ...
      while (paramArrayList.hasNext())
      {
        ...
        this.jdField_a_of_type_Agyx.a(str);
      }
      agyx.a(localSharedPreferences, this.jdField_a_of_type_Agyx, 1);
    }
    while (paramInt != 2) {
      return;
    }
    ...
    {
      str = (String)paramArrayList.next();
      this.jdField_b_of_type_Agyx.a(str);
    }
    agyx.a(localSharedPreferences, this.jdField_b_of_type_Agyx, 2);
  }
  ...
  public void a(List<String> paramList)
  {
    ...
    bdiw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().edit(), "bless_uin_to_send", paramList.toArray()).commit();
  }
  ...
  public boolean a()
  {
    return this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().b(aljq.au, 9003) != null;
  }
  
  public boolean a(String paramString)
  {
    this.jdField_a_of_type_Agyx.a();
    return this.jdField_a_of_type_Agyx.a(paramString);
  }
  ...
  {
    this.jdField_c_of_type_JavaUtilArrayList.clear();
    bdiw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().edit(), "bless_uin_to_send", new String[0]).commit();
  }
    ...
    for (;;)
    {
      ...
      if (paramBoolean)
      {
        ...
        while ((this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessTask.unread != -1) || (this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessTask.videoPlayed))
        {
          ...
          {
            localawby.a();
            localawbw.a(this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessTask);
            localawby.c();
          }
  ...
  {
    this.jdField_b_of_type_Agyx.a();
    return this.jdField_b_of_type_Agyx.a(paramString);
  }
  ...
  {
    this.jdField_a_of_type_Agyx.a();
    return c() - this.jdField_a_of_type_Agyx.a();
  }
  ...
  public int f()
  {
    ...
    int i = j;
    if (j > 0) {
      i = j - this.jdField_a_of_type_Agyx.b();
    }
    return i;
  }
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessTask == null) {}
    while ((!bhou.d()) || (this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessTask.videoPlayed) || (!d()) || (!i())) {
      return false;
    }
    return true;
  }
  ...
  {
    this.jdField_b_of_type_Agyx.a();
    return i() - this.jdField_b_of_type_Agyx.a();
  }
  ...
  public int k()
  {
    ...
    int i = j;
    if (j > 0) {
      i = j - this.jdField_b_of_type_Agyx.b();
    }
    return i;
  }
  ...
  {
    Object localObject = (bdvx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(47);
    if (localObject != null)
    {
      localObject = ((bdvx)localObject).a(1);
      if (localObject != null) {
        ((bdwa)localObject).a(true, null);
      }
    }
    ThreadManager.getSubThreadHandler().removeCallbacks(this.jdField_a_of_type_JavaLangRunnable);
  }
