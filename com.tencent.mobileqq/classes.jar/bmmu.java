  ...
  extends bmmk
{
  ...
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new bmmv(this);
  ...
  private void a(int paramInt1, int paramInt2, String paramString, boolean paramBoolean)
  {
    ...
    if (paramInt2 > 0)
    {
      ...
      if (paramInt1 > 0)
      {
        str = String.format(localActivity.getString(2131716696), new Object[] { Integer.valueOf(paramInt1) }) + "，";
        str = str + paramString + anni.a(2131711056);
      }
      paramString = str + String.format(localActivity.getString(2131716689), new Object[] { Integer.valueOf(paramInt2) });
      bglp.a(localActivity, 232).setMessage(paramString).setNegativeButton(2131716694, new bmnb(this)).show();
      return;
    }
    biti.a().a(localActivity.getString(2131716697) + paramString + anni.a(2131711055));
  }
  
  private void a(String paramString)
  {
    bmfd.a().a().d(paramString);
  }
  ...
  private void b(String... paramVarArgs)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localIntent.putExtra("source_name", this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getString(2131716498));
  ...
  private void c(String... paramVarArgs)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        i = bglj.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getAccount(), "troop_photo_message", String.valueOf(i));
        if (QLog.isDevelopLevel()) {
  ...
  private void f(String... paramVarArgs)
  {
    ...
    try
    {
      ...
      blsb.b(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), str, i, 1, l, "", paramVarArgs, (String)localObject, 7001, 43);
      return;
    }
    catch (Exception paramVarArgs)
    {
  ...
  private void h(String... paramVarArgs)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        blsb.c(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), (blsi)localObject2, (Bundle)localObject4, 6);
  ...
  private void i(String... paramVarArgs)
  {
    ...
    bmfd.a().a(new bmmw(this, paramVarArgs));
    if (!a())
    {
      biti.a().a(anni.a(2131711054));
      return;
    }
    if (!NetworkState.isNetSupport())
    {
      biti.a().a(anni.a(2131711051));
      return;
    }
    if (!NetworkState.isWifiConn())
    {
      Activity localActivity = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a();
      bglp.a(localActivity, 230).setTitle(localActivity.getString(2131716693)).setMessage(localActivity.getString(2131716695)).setPositiveButton(localActivity.getString(2131716692), new bmna(this, paramVarArgs)).setNegativeButton(localActivity.getString(2131716691), new bmmz(this)).show();
      return;
    }
    a(paramVarArgs[0]);
  }
  ...
  private void j(String... paramVarArgs)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        blsb.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), str, i, 4, j, "", paramVarArgs, (String)localObject, 7001, 43);
        return;
      }
      catch (Exception paramVarArgs) {}
  ...
  private void l(String... paramVarArgs)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localblsi.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getCurrentAccountUin();
        paramVarArgs.putBoolean("key_need_change_to_jpg", true);
        blsb.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), localblsi, paramVarArgs, blsb.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin, this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime, 6));
        return;
      }
      catch (Exception paramVarArgs) {}
    } while (!QLog.isColorLevel());
