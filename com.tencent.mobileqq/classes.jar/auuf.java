...
public class auuf
{
  private static auuf jdField_a_of_type_Auuf;
  private String jdField_a_of_type_JavaLangString;
  private Map<Integer, ahkf> jdField_a_of_type_JavaUtilMap = new HashMap();
  ...
  private Map<Integer, ahkf> e = new HashMap();
  private Map<Integer, Integer> f = new HashMap();
  
  private auuf()
  {
    this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(1), new ahkf(960, 720));
    this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(2), new ahkf(960, 720));
  ...
  {
    if (jdField_a_of_type_Auuf == null) {}
    try
    {
      if (jdField_a_of_type_Auuf == null) {
        jdField_a_of_type_Auuf = new auuf();
      }
      return jdField_a_of_type_Auuf;
    }
    finally {}
  }
  ...
  private void a()
  {
    ...
    for (;;)
    {
      ...
      for (j = arrayOfString2.length - 1;; j = 0)
      {
        ...
        {
          this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(2), new ahkf(arrayOfInt3[i], arrayOfInt2[i]));
          this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(1), new ahkf(arrayOfInt3[i], arrayOfInt2[i]));
          this.e.put(Integer.valueOf(2), new ahkf(arrayOfInt3[j], arrayOfInt2[j]));
          this.e.put(Integer.valueOf(1), new ahkf(arrayOfInt3[j], arrayOfInt2[j]));
        }
        if (localObject != null)
        {
  ...
  public ahkf a(int paramInt)
  {
    if (this.jdField_a_of_type_JavaUtilMap.containsKey(Integer.valueOf(paramInt))) {
      return (ahkf)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
    }
    return new ahkf(960, 720);
  }
  
  public ahkf b(int paramInt)
  {
    if (this.e.containsKey(Integer.valueOf(paramInt))) {
      return (ahkf)this.e.get(Integer.valueOf(paramInt));
    }
    return new ahkf(640, 480);
  }
}
