  ...
  extends apun
{
  ...
  public void a(Context paramContext, apui paramapui, int paramInt)
  {
    RelativeLayout localRelativeLayout = (RelativeLayout)paramapui.a();
    ...
    this.jdField_a_of_type_AndroidViewAnimationAlphaAnimation.setAnimationListener(new apup(this));
    this.b.setAnimationListener(new apuq(this));
  }
