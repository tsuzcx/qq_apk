...
import com.tencent.biz.pubaccount.readinjoy.proteus.view.polymeric.RvPolymericContainer.9;
  ...
  extends ViewBase
{
  ...
  private RecyclerView.OnScrollListener jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$OnScrollListener = new qwo(this);
  ...
  public qwn(VafContext paramVafContext)
  {
  ...
  private void a(Activity paramActivity)
  {
    ...
    localBaseApplication.registerActivityLifecycleCallbacks(new qws(this, paramActivity));
  }
  
  private void a(VafContext paramVafContext)
  {
    this.jdField_a_of_type_Qwx = new qwx(paramVafContext);
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView.setAdapter(this.jdField_a_of_type_Qwx);
    this.jdField_a_of_type_Qwx.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView);
    this.jdField_a_of_type_Qwx.a(new qwp(this));
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView.addOnChildAttachStateChangeListener(new qwq(this));
  ...
  private void b()
  {
    ...
    {
      return;
      int m = this.jdField_a_of_type_Qwx.a();
        ...
        if (m > k)
        {
          ...
          if (i < m)
          {
            ...
            if (i == 0)
            {
              ...
              this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = localContext.getResources().getDrawable(2130849435);
              this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = localContext.getResources().getDrawable(2130849436);
  ...
  private void c()
  {
    if ((this.jdField_e_of_type_Boolean) && (this.jdField_a_of_type_Qww != null))
    {
      if (this.jdField_a_of_type_Qwx.a() > 1)
      {
        this.jdField_a_of_type_Qww.a();
        this.jdField_a_of_type_Qww.a(this.jdField_b_of_type_Int);
        this.jdField_a_of_type_Qww.b(this.jdField_c_of_type_Int);
      }
    }
    else {
      return;
    }
    this.jdField_a_of_type_Qww.b();
  }
  ...
  private void d()
  {
    ...
    for (float f1 = 1.0F;; f1 = 0.0F)
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView.setOnStateChangeListener(new qwu(this));
      return;
    }
  }
  ...
  private boolean g(Object paramObject)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Qwx.a(paramObject);
      return true;
    }
    catch (Exception paramObject)
    {
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Qwx == null) {
      return;
    }
    b();
  }
  ...
  {
    this.jdField_a_of_type_Qwx.a(paramqfw);
    a();
  }
  
  public void a(qwm paramqwm)
  {
  ...
  {
    this.jdField_a_of_type_Qwx.a(paramqxg);
  }
  ...
  public void onParseValueFinished()
  {
    ...
    d();
    if ((this.jdField_a_of_type_Int == 1) && (this.jdField_a_of_type_Qww == null))
    {
      this.jdField_a_of_type_Qww = new qww();
      this.jdField_a_of_type_Qww.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView);
      this.jdField_a_of_type_Qww.a(new qwt(this));
    }
    if (this.jdField_a_of_type_Qxi == null)
    {
      this.jdField_a_of_type_Qxi = new qxi(this.jdField_f_of_type_Boolean, this.jdField_a_of_type_ArrayOfInt[0], this.jdField_a_of_type_ArrayOfInt[1], this.jdField_a_of_type_ArrayOfInt[2], this.jdField_a_of_type_ArrayOfInt[3]);
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView.addItemDecoration(this.jdField_a_of_type_Qxi);
    }
    ...
    for (int i = 0;; i = 8)
    {
      ...
      this.jdField_a_of_type_Qwx.a(this.jdField_d_of_type_Boolean);
      c();
      return;
    }
  }
