...
public class avvz
{
  ...
  public avvz(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Avwd = new avwd();
  ...
  protected View a()
  {
    ...
    this.jdField_a_of_type_Avwd.a((RelativeLayout)localView.findViewById(2131362137));
    ...
    for (int j = 0;; j = 1)
    {
      ...
      for (int k = 0;; k = 1)
      {
        ...
        for (;;)
        {
          ...
          ((GridView)localObject4).setAdapter(new avwb(this.jdField_a_of_type_AndroidContentContext, (List)localObject1));
          ...
          for (;;)
          {
            ...
            ((GridView)localObject1).setNumColumns(i);
            ((GridView)localObject1).setAdapter(new avwb(this.jdField_a_of_type_AndroidContentContext, (List)localObject2));
            ...
            ((TextView)localObject1).setOnClickListener(new avwa(this));
            if (j == 0) {
