...
public class bikq
  extends Handler
{
  public bikq(VipFunCallPreviewActivity paramVipFunCallPreviewActivity, Looper paramLooper)
  {
    super(paramLooper);
  }
      ...
      do
      {
        do
        {
          ...
          if (this.a.jdField_a_of_type_JavaUtilArrayList.size() > 0)
          {
            if (this.a.jdField_a_of_type_Boolean)
            {
              if ((this.a.g instanceof Button)) {
                ((Button)this.a.g).setText(anzj.a(2131715515));
              }
          ...
          if (this.a.jdField_a_of_type_Boolean)
          {
            ...
            this.a.g.setEnabled(true);
            if ((this.a.g instanceof Button)) {
              ((Button)this.a.g).setText(anzj.a(2131715509));
            }
            this.a.g.setEnabled(false);
        ...
        localRelativeLayout = (RelativeLayout)this.a.findViewById(2131381168);
