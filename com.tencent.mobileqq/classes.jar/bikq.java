  ...
  implements bikn
{
  ...
  private bikr a(Bitmap paramBitmap, ArrayList<biko> paramArrayList)
  {
    bikr localbikr = new bikr(this);
    ...
    {
      paramBitmap = (biko)paramArrayList.get(i);
      int j = paramBitmap.jdField_b_of_type_Int;
      double d2 = paramBitmap.jdField_a_of_type_Int * j;
      double d3 = localbikr.jdField_a_of_type_Double;
      localbikr.jdField_a_of_type_Double = (d2 / d1 + d3);
      if (localbikr.jdField_a_of_type_Double > jdField_a_of_type_JavaLangDouble.doubleValue()) {
        localbikr.jdField_a_of_type_Boolean = true;
      }
      i += 1;
    }
    if ((paramArrayList.size() > 1) && (localbikr.jdField_a_of_type_Double > b.doubleValue())) {
      localbikr.b = true;
    }
    return localbikr;
  }
  
  private bikt a(String paramString)
  {
    bikt localbikt = new bikt();
    if (paramString == null) {}
    do
    {
      return null;
    ...
    while (i < localJSONArray1.length())
    {
      ...
      if (j < localJSONArray2.length())
      {
        ...
        {
          localbikt.jdField_a_of_type_Int = localJSONObject1.optInt("sceneLvOne");
          localbikt.jdField_b_of_type_Int = localJSONObject2.optInt("sceneLvTwo");
          localbikt.jdField_a_of_type_JavaLangString = localJSONObject2.optString("sceneName");
          localbikt.jdField_b_of_type_JavaLangString = localJSONObject2.optString("sceneFilterID");
          localbikt.jdField_a_of_type_Double = localJSONObject2.optDouble("sceneFilterPercent");
        }
      }
      else
      {
  ...
  private bikt a(JSONArray paramJSONArray)
  {
    double d2 = -1.0D;
    Object localObject1 = new bikt();
    ...
    if (paramJSONArray.length() > 0)
    {
      ...
      if (i < paramJSONArray.length())
      {
        ...
        bikt localbikt = a((String)localObject3);
        double d6;
        double d5;
        if (localbikt == null)
        {
        ...
        for (;;)
        {
          ...
          d5 = d2;
          d6 = d3;
          if (localbikt.jdField_b_of_type_Int != -1)
          {
            localObject3 = localObject1;
            double d1 = d2;
            if (localbikt.jdField_a_of_type_Int == 3)
            {
              localObject3 = localObject1;
              d1 = d2;
              if (d4 > c.doubleValue())
  ...
  private String a(Bitmap paramBitmap, int paramInt)
  {
    ...
    if (i > paramInt)
    {
      paramBitmap = augt.a(paramBitmap, i / paramInt);
      localByteArrayOutputStream = new ByteArrayOutputStream();
      paramBitmap.compress(Bitmap.CompressFormat.JPEG, 100, localByteArrayOutputStream);
      return bikl.a(localByteArrayOutputStream.toByteArray());
    }
  ...
  private JSONObject a()
  {
    ...
    try
    {
      JSONObject localJSONObject2 = new JSONObject(bbdj.d("video_story_aiSceneParams.json"));
  ...
  private JSONObject a(String paramString)
  {
    ...
    try
    {
      ...
      paramString = bikm.a("https://tu.qq.com/cgi-bin/qq/get_face_detail.fcg", localJSONObject2.toString());
      return paramString;
    }
  ...
  private JSONObject b(String paramString)
  {
    ...
    try
    {
      ...
      localJSONObject2.put("token", b(paramString));
      paramString = bikm.a("https://tu.qq.com/cgi-bin/qq/do_image_classify.fcg", localJSONObject2.toString());
      return paramString;
    }
    catch (Exception paramString)
    {
  ...
  public void a(Bitmap paramBitmap, ArrayList<biko> paramArrayList, bikp parambikp)
  {
    if (paramBitmap == null)
    {
      parambikp.a("image is null");
      return;
    }
    ...
    if (paramArrayList.jdField_a_of_type_Boolean) {
      if (paramArrayList.b) {
        paramBitmap = a(ajyc.a(2131715827));
      }
    }
    while (paramBitmap == null)
    {
      parambikp.a("unknown error");
      bikm.a(System.currentTimeMillis() - l, 1);
      return;
      paramBitmap = a(paramBitmap);
      if ((paramBitmap == null) || (paramBitmap.isNull("retcode")))
      {
        parambikp.a("network error");
        bikm.a(System.currentTimeMillis() - l, 1);
        return;
      }
      if ((paramBitmap != null) && (paramBitmap.has("retcode")) && (paramBitmap.optInt("retcode") == 0))
      {
        ...
        if (i <= 5) {
          paramBitmap = a(ajyc.a(2131715830));
        } else if (j < 50) {
          paramBitmap = a(ajyc.a(2131715828));
        } else {
          paramBitmap = a(ajyc.a(2131715825));
        }
      }
      else
      {
        paramBitmap = a(ajyc.a(2131715829));
        continue;
        ...
        if ((paramArrayList == null) || (paramArrayList.isNull("retcode")))
        {
          ...
          bikm.a(l, 1);
          xhe.a("record_smart_filter", xhe.a(1L, l));
          return;
        }
        paramBitmap = localbikt;
    ...
    parambikp.a(paramBitmap);
    l = System.currentTimeMillis() - l;
    bikm.a(l, 0);
    xhe.a("record_smart_filter", xhe.a(0L, l));
  }
}
