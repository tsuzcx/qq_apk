...
public class avtc
{
  ...
  public static void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    do
    {
      ...
      bbjn.a(BaseApplicationImpl.getApplication().getSharedPreferences("CaptureUtil", 4).edit().putBoolean("capture_shared_gesture_recognize_result", paramBoolean1));
  ...
  public static boolean a()
  {
    ...
    for (;;)
    {
      ...
      for (bool1 = false;; bool1 = bool2)
      {
        ...
        axrl.a(BaseApplicationImpl.getContext()).a(null, "actMediaCodecSupport", bool1, 0L, 0L, localHashMap, "");
        if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      try
      {
        if (!jdField_a_of_type_Boolean)
        {
          ...
          int j = axlc.a(BaseApplicationImpl.getContext());
          if (j != 1) {
            continue;
          }
          bool2 = axlc.a();
