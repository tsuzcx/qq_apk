...
public class asud
{
  ...
  public asud(Context paramContext, asug paramasug)
  {
  ...
  private void b()
  {
    if ((this.jdField_a_of_type_Asug.d()) && (b())) {}
    do
    {
      return;
      Intent localIntent = this.jdField_a_of_type_Asug.a();
      if (localIntent == null)
      {
      ...
      this.jdField_a_of_type_Asug.b(localBundle);
  ...
  private boolean b()
  {
    ...
    do
    {
      do
      {
        ...
        {
          return false;
          localChatMessage = this.jdField_a_of_type_Asug.a();
        ...
        return false;
        localSessionInfo = this.jdField_a_of_type_Asug.a();
      ...
      return false;
      if (this.jdField_a_of_type_Asug.c())
      {
        if (QLog.isColorLevel()) {
      ...
      if (this.jdField_a_of_type_Asug.d()) {
        break;
      }
    } while (!QLog.isColorLevel());
    ...
    return false;
    ataw.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidGraphicsRect, localChatMessage, localSessionInfo, this.jdField_a_of_type_Asug.a(), this.jdField_a_of_type_Asug.e(), this.jdField_a_of_type_Asug.f(), null);
    return true;
  }
  
  private void c()
  {
    asuf localasuf = new asuf(this);
    ...
    aszg.a(this.jdField_a_of_type_AndroidContentContext, str1, str2, localasuf);
  }
  
  public void a()
  {
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Asug.b()))
    {
      if (ataw.a(this.jdField_a_of_type_AndroidContentContext, false, new asue(this))) {
        c();
      }
      return;
    }
