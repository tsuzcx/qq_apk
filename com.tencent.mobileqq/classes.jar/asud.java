  ...
  implements auoo
{
  ...
  private asty jdField_a_of_type_Asty;
  ...
  private asud(MessageRecord paramMessageRecord, ArrayList<MessageRecord> paramArrayList, QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2, asty paramasty)
  {
    this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord = paramMessageRecord;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_Int = paramInt1;
    this.jdField_a_of_type_Asty = paramasty;
    this.b = paramInt2;
  ...
  public MessageRecord a(im_msg_body.RichText paramRichText)
  {
    if (paramRichText != null)
    {
      ...
      for (;;)
      {
        ...
        asty.a(this.jdField_a_of_type_Asty, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int, new HashMap(), this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord, null, this.jdField_a_of_type_JavaUtilArrayList, true, this.b);
        return null;
        label272:
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("MultiMsg_TAG", 2, "mPttUpCallBack updateMsg with " + paramauop.toString());
    }
  }
  ...
  public void b(auop paramauop)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("MultiMsg_TAG", 2, "mPttUpCallBack onSend fail with " + paramauop.toString());
      }
      if ((this.jdField_a_of_type_JavaUtilArrayList.get(0) instanceof MessageForPtt))
      {
        if (((MessageForPtt)this.jdField_a_of_type_JavaUtilArrayList.get(0)).fileSize < 0L)
        {
          ...
          {
            QLog.d("MultiMsg_TAG", 2, "start print stack trace ---------");
            paramauop = Thread.currentThread().getStackTrace();
            int j = paramauop.length;
            int i = 0;
            while (i < j)
            {
              QLog.d("MultiMsg_TAG", 2, new Object[] { paramauop[i] });
              i += 1;
            }
          }
        }
