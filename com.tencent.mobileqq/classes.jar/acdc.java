...
{
  public acdc(AddFriendVerifyActivity paramAddFriendVerifyActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if (TextUtils.isEmpty(paramView))
    {
      if (!this.a.isFinishing())
      {
        ...
        paramView.jdField_a_of_type_AndroidWidgetTextView.setText(alud.a(2131700234));
        paramView.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130845744);
        paramView.a();
      }
      return;
    }
