  ...
  extends BroadcastReceiver
{
  ...
  private lez(VideoAppInterface paramVideoAppInterface)
  {
    ...
    do
    {
          ...
          do
          {
            do
            {
              ...
              if ("com.tencent.qav.notify.refuse".equals(paramContext))
              {
                ...
                paramIntent = lcb.a().c(paramContext);
                if (QLog.isColorLevel()) {
                ...
                for (;;)
                {
                  bdll.b(null, "dc00898", "", "", "0X800A2C7", "0X800A2C7", 0, 0, "", "", "", "");
                  return;
              ...
              if ((bool) && (i == borf.b.a) && (paramContext != null))
              {
                lil.a(paramContext);
                ((lih)paramContext.a(5)).a(3);
              }
      ...
      if (TextUtils.equals(paramContext, "avChatRoom"))
      {
        ...
        if (localObject != null)
        {
          ...
          if (localObject != null) {
            ((ljz)localObject).a(i, paramIntent);
          }
        }
      }
