...
public class lez
{
  ...
  public BeautyRender a(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvVideoEffectBeautyBeautyRender == null) {
      this.jdField_a_of_type_ComTencentAvVideoEffectBeautyBeautyRender = new BeautyRender(VideoController.a().a(), lfd.a);
    }
    if (paramInt == this.jdField_a_of_type_Int) {
      return this.jdField_a_of_type_ComTencentAvVideoEffectBeautyBeautyRender;
    }
    this.jdField_a_of_type_ComTencentAvVideoEffectBeautyBeautyRender.setBeautyLevel(paramInt * 1.0F / 100.0F * lfd.a());
    this.jdField_a_of_type_Int = paramInt;
    return this.jdField_a_of_type_ComTencentAvVideoEffectBeautyBeautyRender;
  }
  
  public lfs a(int paramInt1, int paramInt2, lfs paramlfs, FilterDesc paramFilterDesc, int paramInt3)
  {
    if (!lfd.a()) {}
    ...
    for (;;)
    {
      paramlfs = localBeautyRender.process(paramlfs.b, paramlfs.jdField_a_of_type_Int, paramInt1, paramInt2);
      return lfs.a(paramlfs.getFbo(), paramlfs.getTextureId());
  ...
  public byte[] a(int paramInt1, int paramInt2, byte[] paramArrayOfByte, FilterDesc paramFilterDesc, int paramInt3)
  {
    ...
    {
      krx.e("AVSDKBeautyRender", "(mHeight * mWidth * 3 / 2) != yuvData.length");
      return paramArrayOfByte;
    }
    ...
    for (;;)
    {
      ...
      {
        krx.e("AVSDKBeautyRender", "convertI420ToNV21 or convertI420ToNV12 e = " + paramArrayOfByte.getMessage());
