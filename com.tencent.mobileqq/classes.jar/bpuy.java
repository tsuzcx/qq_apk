  ...
  implements Animatable
{
  ...
  Property<bpuy, Integer> jdField_a_of_type_AndroidUtilProperty = new bpuz(this, Integer.class, "bfIndex");
  private String jdField_a_of_type_JavaLangString;
  private WeakReference<bpve> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  Property<bpuy, Integer> jdField_b_of_type_AndroidUtilProperty = new bpva(this, Integer.class, "textAlpha");
  ...
  Property<bpuy, Float> jdField_c_of_type_AndroidUtilProperty = new bpvb(this, Float.class, "textPos");
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_AndroidAnimationValueAnimator != null)
      {
        ...
        this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new bpvc(this));
        this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new bpvd(this));
  ...
  private void b(Context paramContext)
  {
    ...
    this.jdField_a_of_type_JavaUtilMap.put("1/2", paramContext.getResources().getDrawable(2130841486));
    this.jdField_a_of_type_JavaUtilMap.put("1/4", paramContext.getResources().getDrawable(2130841487));
    this.jdField_a_of_type_JavaUtilMap.put("1x", paramContext.getResources().getDrawable(2130841488));
    this.jdField_a_of_type_JavaUtilMap.put("2x", paramContext.getResources().getDrawable(2130841489));
    this.jdField_a_of_type_JavaUtilMap.put("4x", paramContext.getResources().getDrawable(2130841490));
    this.jdField_a_of_type_JavaUtilMap.put(PickerContainer.jdField_a_of_type_JavaLangString, paramContext.getResources().getDrawable(2130841513));
    this.jdField_b_of_type_JavaUtilMap.put("1/2", paramContext.getResources().getDrawable(2130841530));
    this.jdField_b_of_type_JavaUtilMap.put("1/4", paramContext.getResources().getDrawable(2130841531));
    this.jdField_b_of_type_JavaUtilMap.put("1x", paramContext.getResources().getDrawable(2130841532));
    this.jdField_b_of_type_JavaUtilMap.put("2x", paramContext.getResources().getDrawable(2130841533));
    this.jdField_b_of_type_JavaUtilMap.put("4x", paramContext.getResources().getDrawable(2130841534));
    this.jdField_b_of_type_JavaUtilMap.put(PickerContainer.jdField_a_of_type_JavaLangString, paramContext.getResources().getDrawable(2130841535));
  }
  ...
  private void c(int paramInt)
  {
    ...
    do
    {
      ...
      localbpve = (bpve)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (localbpve == null);
    localbpve.a(this.jdField_c_of_type_Int, this.jdField_a_of_type_Int, this.jdField_a_of_type_AndroidGraphicsDrawableAnimationDrawable.getNumberOfFrames());
  }
  ...
  public boolean a(Context paramContext, int paramInt1, int paramInt2, int paramInt3, bpve parambpve)
  {
    b();
    a(paramContext);
    ...
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambpve);
    b(paramContext);
