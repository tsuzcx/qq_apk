  ...
  extends alsi
{
  ...
  private void d(String paramString)
  {
    try
    {
      if (!this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.isFinishing()) {
        bdcd.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 230, alpo.a(2131703715), this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131719741), new aglc(this, paramString), null).show();
      }
      return;
    }
  ...
  protected void a(String paramString1, int paramInt1, int paramInt2, SendMessageHandler paramSendMessageHandler, long paramLong1, long paramLong2, String paramString2)
  {
    ...
    for (;;)
    {
      this.a.e(196608);
      return;
      QQToast.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 2131719739, 1).b(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getTitleBarHeight());
      continue;
      QQToast.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 2131719742, 1).b(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getTitleBarHeight());
      continue;
      bdcd.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 230, alpo.a(2131703714), this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131691937), new aglb(this, paramString1), null).show();
      continue;
  ...
  public void a(boolean paramBoolean1, List<MessageRecord> paramList, boolean paramBoolean2)
  {
    ...
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      ...
      {
        int i = this.a.jdField_a_of_type_Bblx.b();
        if (i != -1)
        {
          aubr localaubr = (aubr)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(37);
          long l = localaubr.b(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString + "&" + 3000);
          if (((MessageRecord)localObject).uniseq == l)
          {
            localaubr.a(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString + "&" + 3000, i);
            this.a.jdField_a_of_type_Bblx.a(i);
            this.a.jdField_a_of_type_Bblx.e();
          }
          if (QLog.isColorLevel())
          {
