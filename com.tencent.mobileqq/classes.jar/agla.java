  ...
  extends BaseAdapter
{
  ...
  public agla(Activity paramActivity, aglv paramaglv, List<String> paramList)
  {
    ...
    if (paramList != null)
    {
      this.jdField_a_of_type_AndroidGraphicsDrawableDrawable$ConstantState = this.jdField_a_of_type_AndroidContentResResources.getDrawable(2130838759).getConstantState();
    ...
    for (;;)
    {
      ...
      return;
      this.jdField_a_of_type_AndroidGraphicsDrawableDrawable$ConstantState = this.jdField_a_of_type_AndroidContentResResources.getDrawable(2130839016).getConstantState();
    }
  }
  ...
  private boolean b()
  {
    return (this.jdField_a_of_type_Aglv == aglv.a.get(5)) || (this.jdField_a_of_type_Aglv == aglv.a.get(4)) || (this.jdField_a_of_type_Aglv == aglv.a.get(6)) || (this.jdField_a_of_type_Aglv == aglv.a.get(7));
  }
  ...
  public QQAlbumInfo a(Context paramContext)
  {
    ...
    //   19: aload 4
    //   21: getstatic 273	bbbw:n	Ljava/lang/String;
    ...
    //   41: aload_2
    //   42: getstatic 144	agla:jdField_c_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   45: ldc_w 293
    //   48: aconst_null
    //   49: ldc_w 295
    ...
    //   56: aload_2
    //   57: astore_1
    //   58: getstatic 248	aglv:a	Landroid/util/SparseArray;
    //   61: iconst_2
    //   62: invokevirtual 254	android/util/SparseArray:get	(I)Ljava/lang/Object;
    //   65: checkcast 245	aglv
    //   68: astore 5
    //   70: aload 5
    //   72: ifnull +14 -> 86
    //   75: aload_2
    ...
    //   79: iconst_m1
    //   80: aload 5
    //   82: invokevirtual 304	agla:a	(Landroid/database/Cursor;ILaglv;)Ljava/util/List;
    //   85: astore_3
    //   86: aload_2
    //   87: astore_1
    //   88: invokestatic 310	com/tencent/common/app/BaseApplicationImpl:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   91: invokestatic 315	agmg:a	(Landroid/content/Context;)Lagmg;
    //   94: iconst_0
    //   95: iconst_m1
    //   96: invokevirtual 318	agmg:a	(ZI)Ljava/util/ArrayList;
    //   99: astore 5
    //   101: aload_3
    //   102: ifnull +50 -> 152
    //   105: aload_2
    ...
    //   246: aload_3
    //   247: getfield 343	agml:jdField_a_of_type_Int	I
    //   250: i2l
    ...
    //   261: aload_3
    //   262: getfield 347	agml:jdField_c_of_type_Long	J
    ...
    //   275: aload_3
    //   276: getfield 352	agml:jdField_a_of_type_Long	J
    ...
    //   289: aload_3
    //   290: getfield 357	agml:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   317: aload_3
    //   318: getfield 362	agml:d	Ljava/lang/String;
  ...
  /* Error */
  QQAlbumInfo a(Context paramContext, int paramInt1, int paramInt2, aglv paramaglv)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 7
    ...
    //   38: aload 8
    //   40: getstatic 399	bbbw:l	Ljava/lang/String;
    ...
    //   82: aload 5
    //   84: getstatic 144	agla:jdField_c_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   87: ldc_w 293
    //   90: aconst_null
    //   91: ldc_w 295
    ...
    //   108: iload_3
    //   109: aload 4
    //   111: invokevirtual 304	agla:a	(Landroid/database/Cursor;ILaglv;)Ljava/util/List;
    //   114: astore 6
    //   116: aload 6
    //   118: ifnull +59 -> 177
    //   121: aload_1
  ...
  QQAlbumInfo a(Context paramContext, int paramInt1, int paramInt2, aglv paramaglv, int paramInt3, boolean paramBoolean, ArrayList<String> paramArrayList)
  {
    QQAlbumInfo localQQAlbumInfo = new QQAlbumInfo();
    localQQAlbumInfo._id = "$RecentAlbumId";
    localQQAlbumInfo.name = bbbw.l;
    if (((AlbumListActivity)this.jdField_a_of_type_AndroidAppActivity).b()) {}
    for (paramArrayList = bbbx.a(paramContext, null, null, paramInt2, paramaglv, paramInt1, 240, true, paramArrayList, false);; paramArrayList = bbbx.a(paramContext, paramInt3, paramInt2, paramaglv, paramBoolean, paramInt1, paramArrayList, false))
    {
    ...
    paramContext = bbbx.a(paramContext, 0, paramInt2, paramaglv, -1L);
  ...
  /* Error */
  public List<QQAlbumInfo> a(Context paramContext, int paramInt, aglv paramaglv)
  {
    // Byte code:
    //   0: iload_2
    //   1: ifge +118 -> 119
    ...
    //   7: astore 14
    //   9: aload_0
    //   10: invokespecial 443	agla:b	()Z
    //   13: ifeq +641 -> 654
    //   16: ldc_w 445
    //   19: astore 13
    //   21: aload_0
    //   22: getfield 165	agla:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    ...
    //   41: getstatic 129	agla:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   79: aload 14
    //   81: getstatic 56	agla:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   84: aload 13
    //   86: aconst_null
    //   87: ldc_w 453
  ...
  List<LocalMediaInfo> a(Cursor paramCursor, int paramInt, aglv paramaglv)
  {
      ...
      do
      {
        ...
        do
        {
          for (;;)
          {
            ...
            if ((paramaglv == null) || (!paramaglv.a(str1))) {
              break;
            }
      ...
      for (i = 1;; i = 0)
      {
        ...
        for (i = j;; i = 0)
        {
          ...
          if (!this.jdField_e_of_type_Boolean)
          {
            ...
            {
              paramList1 = b(this.jdField_a_of_type_AndroidAppActivity, this.jdField_d_of_type_Int, this.jdField_c_of_type_Int, this.jdField_a_of_type_Aglv, this.jdField_e_of_type_Int, true, this.jdField_a_of_type_JavaUtilArrayList);
              ((List)localObject).add(0, paramList1);
            }
          }
          else if ((this.jdField_a_of_type_Aglv != null) && (this.jdField_a_of_type_Aglv.b()) && (!this.jdField_e_of_type_Boolean))
          {
          ...
          for (;;)
          {
            ...
            if ((!this.jdField_e_of_type_Boolean) && (paramInt == -1) && (this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Long > 0L))
            {
              ...
              paramList1.name = ajya.a(2131700210);
              paramList1.mMediaFileCount = ((int)this.jdField_a_of_type_Long);
              ((List)localObject).add(0, paramList1);
            }
            bbfb.a("PEAK", "compact.queryRecentBucket");
            return localObject;
            paramList1 = b(this.jdField_a_of_type_AndroidAppActivity, 210, 100, this.jdField_a_of_type_Aglv);
            break;
            label595:
            paramList1 = new QQAlbumInfo();
  ...
  void a()
  {
    ...
    localQQAlbumInfo.name = ajya.a(2131700195);
  ...
  public void a(int paramInt)
  {
    int k = 1;
    int n = 0;
    Object localObject = this.jdField_a_of_type_Aglv;
    List localList;
    int i;
    if ((localObject != null) && (((aglv)localObject).a()))
    {
      bbfb.a();
      localList = a(this.jdField_a_of_type_AndroidAppActivity, paramInt, this.jdField_a_of_type_Aglv);
    ...
    {
      int j;
      if ((localObject != null) && (((aglv)localObject).b()) && (!this.jdField_e_of_type_Boolean))
      {
        bbfb.a();
        localObject = b(this.jdField_a_of_type_AndroidAppActivity, paramInt, (aglv)localObject);
        j = i;
        if (paramInt != -1)
        {
          j = i;
  ...
  public void a(QQAlbumInfo paramQQAlbumInfo)
  {
    ...
    for (;;)
    {
      if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Long > 0L) && (a()))
      {
        ...
        paramQQAlbumInfo.name = ajya.a(2131700199);
  ...
  public QQAlbumInfo b(Context paramContext, int paramInt1, int paramInt2, aglv paramaglv)
  {
    return b(paramContext, paramInt1, paramInt2, paramaglv, -1, false, null);
  }
  
  public QQAlbumInfo b(Context paramContext, int paramInt1, int paramInt2, aglv paramaglv, int paramInt3, boolean paramBoolean, ArrayList<String> paramArrayList)
  {
    if (paramaglv == null) {
      return null;
    }
    if (paramaglv.a()) {
      return a(paramContext, paramInt1, paramInt2, paramaglv, paramInt3, paramBoolean, paramArrayList);
    }
    return a(paramContext, paramInt1, paramInt2, paramaglv);
  }
  
  /* Error */
  public List<QQAlbumInfo> b(Context paramContext, int paramInt, aglv paramaglv)
  {
    // Byte code:
    //   0: iload_2
    //   1: ifge +51 -> 52
    ...
    //   12: aload_3
    //   13: getstatic 146	agla:jdField_d_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   16: ldc_w 668
    //   19: aconst_null
    //   20: ldc_w 453
  ...
  {
    return bbbx.a(((QQAlbumInfo)this.jdField_a_of_type_JavaUtilList.get(paramInt)).mCoverInfo);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_AndroidAppActivity.getLayoutInflater().inflate(2131560640, null);
      localTextView = (TextView)localView;
      localQQAlbumInfo = a(paramInt);
      localView.setContentDescription(localQQAlbumInfo.name + "，" + localQQAlbumInfo.mMediaFileCount + ajya.a(2131700204));
    ...
    for (;;)
    {
      ...
      if (paramViewGroup == null)
      {
        if (bfnz.d())
        {
          paramView = aywm.a(paramView, jdField_a_of_type_AndroidGraphicsDrawableColorDrawable, jdField_a_of_type_AndroidGraphicsDrawableColorDrawable);
          label237:
      ...
      else if (this.jdField_b_of_type_JavaUtilList != null)
      {
        ...
        paramView = this.jdField_a_of_type_AndroidContentResResources.getDrawable(2130840202);
        localTextView.setContentDescription(ajya.a(2131700203));
        label344:
      ...
      for (;;)
      {
        ...
        break label157;
        paramViewGroup = this.jdField_a_of_type_AndroidContentResResources.getDrawable(2130842852);
        paramView = aywm.a(paramView, paramViewGroup, paramViewGroup);
        break label237;
        label521:
        paramView = this.jdField_a_of_type_AndroidContentResResources.getDrawable(2130840203);
        localTextView.setContentDescription(ajya.a(2131700206));
        break label344;
        label546:
        paramView = this.jdField_a_of_type_AndroidContentResResources.getDrawable(2130846750);
        paramView.setBounds(0, 0, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
        paramViewGroup = this.jdField_a_of_type_AndroidGraphicsDrawableDrawable$ConstantState.newDrawable(this.jdField_a_of_type_AndroidContentResResources);
        paramViewGroup.setBounds(0, 0, paramViewGroup.getIntrinsicWidth(), paramViewGroup.getIntrinsicHeight());
        localTextView.setCompoundDrawables(paramView, null, paramViewGroup, null);
