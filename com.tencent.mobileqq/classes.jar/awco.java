  ...
  extends MSFServlet
{
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    {
      localObject = awag.a(paramFromServiceMsg.getWupBuffer());
      if ((localObject != null) && (((List)localObject).size() > 0))
      {
        paramFromServiceMsg = (awcl)paramIntent.getManager(12);
        if (paramFromServiceMsg != null)
        {
          ...
          notifyObserver(null, 10000, true, paramFromServiceMsg, atdh.class);
          QLog.e("Q.lebatab.GameCenterServlet", 2, "[red dot] 1");
          if (paramIntent != null)
          {
            paramFromServiceMsg = new HashMap();
            awrn.a(paramIntent.getApp()).a(paramIntent.getCurrentAccountUin(), "actPluginUnread", true, this.b - this.a, 0L, paramFromServiceMsg, "");
          }
        }
      }
      else if (paramIntent != null)
      {
        paramFromServiceMsg = "|wufbuf: " + bach.a(paramFromServiceMsg.getWupBuffer());
        ...
        awrn.a(paramIntent.getApp()).a(paramIntent.getCurrentAccountUin(), "actPluginUnread", false, this.b - this.a, 0L, (HashMap)localObject, "");
      }
    }
    for (;;)
    {
      ...
      notifyObserver(null, 10000, false, paramIntent, atdh.class);
      return;
      if (paramIntent != null)
      {
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    if ((str != null) && (str.equals("gc_get_newandunreadmsg"))) {
      awag.a(paramPacket, paramIntent);
    }
  ...
  public void service(Intent paramIntent)
  {
    ...
    if ((str != null) && ("gc_refresh_ui".equals(str)))
    {
      ...
      notifyObserver(null, 10000, true, paramIntent, atdh.class);
