...
public class awco
{
  private static volatile awco jdField_a_of_type_Awco;
  ...
  private awct jdField_a_of_type_Awct;
  ...
  private awco()
  {
    if (Build.VERSION.SDK_INT >= 21) {
      this.jdField_a_of_type_AndroidNetConnectivityManager$NetworkCallback = new awcp(this);
    }
    try
    {
      b();
  ...
  public static awco a()
  {
    if (jdField_a_of_type_Awco == null) {}
    try
    {
      if (jdField_a_of_type_Awco == null) {
        jdField_a_of_type_Awco = new awco();
      }
      return jdField_a_of_type_Awco;
    }
    finally {}
  }
  ...
  private void a(awct paramawct)
  {
    this.jdField_a_of_type_Awct = paramawct;
  }
  
  @RequiresApi(api=21)
  private void a(String paramString, Network paramNetwork, awcr paramawcr)
  {
    ThreadManagerV2.excute(new GateWayVerifyManager.2(this, paramString, paramNetwork, paramawcr), 128, null, true);
  }
  
  /* Error */
  private void a(java.net.HttpURLConnection paramHttpURLConnection, java.net.URL paramURL, awcr paramawcr)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 5
  ...
  private void b(String paramString, awcr paramawcr)
  {
    ThreadManagerV2.excute(new GateWayVerifyManager.3(this, paramString, paramawcr), 128, null, true);
  }
  ...
  private void c(String paramString, awcr paramawcr)
  {
    QLog.d("GateWayVerifyManager", 1, "start changeNetTypeToMobileV19");
    ThreadManagerV2.excute(new GateWayVerifyManager.4(this, paramString, paramawcr), 128, null, true);
  }
  
  @RequiresApi(api=21)
  private void d(String paramString, awcr paramawcr)
  {
    boolean bool = false;
    ...
    a(new awcq(this, paramString, paramawcr));
    if (localNetwork == null)
    {
      this.jdField_a_of_type_MqqOsMqqHandler.postDelayed(new GateWayVerifyManager.6(this, paramawcr), 4000L);
      return;
    }
    a(paramString, localNetwork, new awcs(paramawcr, localNetwork));
  }
  ...
  public void a()
  {
    ...
    //   2: monitorenter
    //   3: aload_0
    //   4: getfield 414	awco:jdField_a_of_type_Boolean	Z
    //   7: ifeq +16 -> 23
    //   10: ldc 67
    //   12: iconst_1
    //   13: ldc_w 416
    ...
    //   22: return
    //   23: aconst_null
    //   24: putstatic 120	awco:jdField_a_of_type_Awco	Lawco;
    //   27: aload_0
    //   28: iconst_1
    //   29: putfield 414	awco:jdField_a_of_type_Boolean	Z
    //   32: ldc 2
    //   34: monitorexit
    ...
    //   40: if_icmplt +19 -> 59
    //   43: aload_0
    //   44: getfield 42	awco:jdField_a_of_type_AndroidNetConnectivityManager	Landroid/net/ConnectivityManager;
    //   47: aload_0
    //   48: getfield 63	awco:jdField_a_of_type_AndroidNetConnectivityManager$NetworkCallback	Landroid/net/ConnectivityManager$NetworkCallback;
    ...
    //   54: aload_0
    //   55: aconst_null
    //   56: invokespecial 178	awco:a	(Landroid/net/Network;)V
    //   59: aload_0
    //   60: getfield 50	awco:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   63: aconst_null
  ...
  public void a(String paramString, awcr paramawcr)
  {
    ...
    if (this.b)
    {
      paramawcr.a(new Exception("request network error"));
      return;
    }
