  ...
  implements BaseLayer.OnLayerTouchListener
{
  ...
  private ooi(DoodleLayout paramDoodleLayout) {}
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    ((AlphaAnimation)localObject).setAnimationListener(new ooj(this));
    ...
    localAlphaAnimation.setAnimationListener(new ook(this));
    if (paramBoolean2) {
