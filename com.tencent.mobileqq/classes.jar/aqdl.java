  ...
  extends ajrp
{
  ...
  public aqdl(Context paramContext)
  {
  ...
  public void b(boolean paramBoolean, Object paramObject)
  {
    ...
    Object localObject = aqdf.a(localContext);
    if ((localObject != null) && (((bbms)localObject).isShowing())) {
      ((bbms)localObject).dismiss();
    }
    label124:
    int j;
    if ((paramBoolean) && ((paramObject instanceof Object[])))
    {
      ...
      if (arrayOfObject.length >= 5)
      {
        ...
        for (paramObject = (String)arrayOfObject[3];; paramObject = null)
        {
          ...
          aqdf.a(localContext, (byte[])localObject, j);
          aqdf.b.set(false);
          return;
          i = -1;
          break;
    ...
    {
    default: 
      bbmy.a(localContext, 1, ajjy.a(2131639685), 0).a();
      aqdf.b.set(false);
      return;
    case 1: 
      label234:
      ...
      ((Bundle)localObject).putInt("key_hiboom_type", aqdf.a(j));
      paramObject = new Intent();
      paramObject.putExtras((Bundle)localObject);
      aphp.a((Activity)localContext, paramObject, 21);
      return;
    }
    if ((localContext instanceof FragmentActivity))
    {
      ...
      if ((((FragmentActivity)localObject).getChatFragment() != null) && (((FragmentActivity)localObject).getChatFragment().a() != null))
      {
        ...
        ((aqdf)((BaseChatPie)localObject).jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(219)).a((BaseChatPie)localObject, paramObject, j, aqdf.a(j));
        ((BaseChatPie)localObject).aA();
  ...
  public void c(boolean paramBoolean, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean)
      {
        ...
        if (localObject.length >= 5)
        {
          ...
          for (localObject = (String)localObject[4];; localObject = null)
          {
            ...
            aqdf.a(localContext, paramObject, j);
            aqdf.b.set(false);
            return;
            i = -1;
            break label102;
          ...
          if (paramBoolean)
          {
            if ((localContext instanceof FragmentActivity))
            {
              ...
              if ((paramObject.getChatFragment() != null) && (paramObject.getChatFragment().a() != null))
              {
                ...
                ((aqdf)paramObject.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(219)).a(paramObject, (String)localObject, j, aqdf.a(j));
                paramObject.aA();
          ...
          ((ajrm)((QQAppInterface)paramObject).a(13)).b();
          return;
        }
        paramBoolean = false;
      }
      while (paramBoolean)
      {
        bbmy.a(localContext, 1, ajjy.a(2131639682), 0).a();
        aqdf.b.set(false);
        return;
