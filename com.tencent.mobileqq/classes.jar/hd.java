final class hd
{
  static int a(ha paramha)
  {
    return a(paramha, true) + a(paramha, false);
  }
  
  private static int a(ha paramha, boolean paramBoolean)
  {
    int m;
    int n;
    label20:
  ...
  static int b(ha paramha)
  {
    byte[][] arrayOfByte = paramha.a();
    int n = paramha.b();
    int i1 = paramha.a();
    int i = 0;
    int j = 0;
