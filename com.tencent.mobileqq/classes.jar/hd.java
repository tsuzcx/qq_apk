...
public class hd
{
  ...
  private ArrayList<gy> jdField_a_of_type_JavaUtilArrayList = new ArrayList(16);
  public boolean a;
  ...
  public hd(CharacterStyle paramCharacterStyle, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
  ...
  public hd(String paramString, int paramInt1, int paramInt2, ETFont paramETFont, boolean paramBoolean)
  {
  ...
  private int a(ETEngine paramETEngine, String paramString)
  {
    ...
    {
      localObject = new gy("");
      ((gy)localObject).d(this.e);
      ((gy)localObject).e(0);
      ((gy)localObject).a(this);
      this.jdField_a_of_type_JavaUtilArrayList.add(localObject);
      this.g = 0;
      this.e += 1;
    }
    Object localObject = new gy[j];
    int i = 0;
    while (i < j)
    {
      localObject[i] = new gy("");
      i += 1;
    }
    i = 0;
    while (i < j)
  ...
  private void a(CharacterStyle paramCharacterStyle, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        paramCharacterStyle = new gy(paramCharacterStyle, paramInt);
  ...
  private void a(ETEngine paramETEngine, String paramString)
  {
    ...
    for (;;)
    {
      paramETEngine = new gy(paramString);
      paramETEngine.b(i);
      paramETEngine.c(j);
