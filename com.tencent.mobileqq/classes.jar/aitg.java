  ...
  extends aisk
{
  ...
  public aitg(Emoticon paramEmoticon)
  {
  ...
  {
    ((axfj)paramQQAppInterface.getManager(14)).a(this);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqDataEmoticon != null) && (this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.isNewSoundEmoticon())) {
      axfj.a(paramQQAppInterface, "0X800A932", paramSessionInfo.a, this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId);
    }
    ((axfj)paramQQAppInterface.getManager(14)).b(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon);
  }
  ...
  public String c()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.isAPNG) {}
    for (Object localObject = asos.t.replace("[epId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId).replace("[eId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.eId);; localObject = asos.s.replace("[epId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId).replace("[eId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.eId))
    {
