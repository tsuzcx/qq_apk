  ...
  implements Cursor
{
  ...
  protected akpw(List<MessageRecord> paramList)
  {
    Object localObject;
  ...
  private Object a(int paramInt)
  {
    ...
    case 14: 
      return bbcl.a(akpv.a(this.jdField_a_of_type_Akpv), localMessageRecord.senderuin, localMessageRecord.frienduin, 1, 0);
    case 15: 
      if (localMessageRecord.istroop == 3000) {
        return bbcl.d(akpv.b(this.jdField_a_of_type_Akpv), localMessageRecord.senderuin);
      }
      if (localMessageRecord.istroop == 1) {
        return ((TroopManager)akpv.c(this.jdField_a_of_type_Akpv).getManager(52)).a(localMessageRecord.senderuin);
      }
      return bbcl.a(akpv.d(this.jdField_a_of_type_Akpv), localMessageRecord.senderuin);
    case 16: 
      return Integer.valueOf(((ajxn)akpv.e(this.jdField_a_of_type_Akpv).getManager(51)).b(localMessageRecord.frienduin));
    case 17: 
