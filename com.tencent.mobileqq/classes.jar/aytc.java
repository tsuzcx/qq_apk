...
public class aytc
{
  ...
  public aytc(Application paramApplication)
  {
    this.jdField_a_of_type_AndroidAppApplication = paramApplication;
    this.jdField_a_of_type_JavaLangString = bhlo.c();
    this.b = aytg.a();
  ...
  private Bundle a(Application paramApplication)
  {
    ...
    localBundle.putString("deviceID", String.valueOf(aytg.a(paramApplication)));
    ...
    localBundle.putString("network", String.valueOf(aytg.a(paramApplication)));
    localBundle.putString("imei", this.b);
    return localBundle;
  }
  
  public aytc a(String paramString)
  {
    this.jdField_a_of_type_AndroidOsBundle.putString("uin", paramString);
    return this;
  }
  
  public aytc a(String paramString1, String paramString2)
  {
  ...
  public void a()
  {
    ayte.a.a(this.jdField_a_of_type_AndroidOsBundle);
  }
  
  public aytc b(String paramString)
  {
    this.jdField_a_of_type_AndroidOsBundle.putString("module", paramString);
    return this;
  }
  
  public aytc c(String paramString)
  {
    this.jdField_a_of_type_AndroidOsBundle.putString("action", paramString);
    return this;
  }
  
  public aytc d(String paramString)
  {
