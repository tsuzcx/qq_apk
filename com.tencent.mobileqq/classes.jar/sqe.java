  ...
  implements spj, spo
{
  ...
  private ssa jdField_a_of_type_Ssa = new ssa();
  ...
  private void a(Container paramContainer, RecommendAdData paramRecommendAdData)
  {
    ...
    {
      return;
      if (nzq.a(BaseApplicationImpl.getContext(), paramRecommendAdData.h)) {
      ...
      for (;;)
      {
        ...
        paramContainer.getComLayoutParams().mLayoutMarginLeft = agej.a(16.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
        return;
  ...
  public spi a(Context paramContext, BaseData paramBaseData, ViewGroup paramViewGroup)
  {
    ...
    return new sqf(this, paramViewGroup, localProteusItemData);
  }
