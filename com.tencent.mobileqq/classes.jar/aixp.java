  ...
  extends aixj
{
  ...
  public aixp(QQAppInterface paramQQAppInterface, DrawerPushItem paramDrawerPushItem)
  {
  ...
  public int a(ajfq paramajfq, int paramInt, AppInterface paramAppInterface, Context paramContext)
  {
    ...
    int i;
    boolean bool;
    if (this.jdField_b_of_type_Int > ajms.jdField_a_of_type_Int)
    {
      i = 3;
      ...
      paramInt = 6;
      ajfh.a(paramajfq, 6, paramAppInterface);
    }
    for (;;)
    {
      ...
      break;
      label172:
      super.a(paramajfq, i, paramInt, paramAppInterface, paramContext);
  ...
  public void a(ajfq paramajfq, Context paramContext, QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.is_reddot == 0)
    {
      ...
      if (!TextUtils.isEmpty(jdField_a_of_type_JavaLangString)) {
        ajfh.a(paramajfq, jdField_a_of_type_JavaLangString, this.jdField_c_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.bubble_res_id);
      }
      this.jdField_a_of_type_Long = System.currentTimeMillis();
      paramajfq = (airx)paramQQAppInterface.getManager(153);
      paramContext = jdField_d_of_type_JavaLangString;
      if (!paramajfq.jdField_d_of_type_Boolean) {
        break label202;
      }
    }
    label202:
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.is_reddot != 1) {
        localairx.a(this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem);
      }
    ...
    ((avps)paramQQAppInterface.getManager(36)).b(String.valueOf("103100.103200"));
  }
  
  public void a(QQAppInterface paramQQAppInterface, ajfq paramajfq)
  {
    super.a(paramQQAppInterface, paramajfq);
    ...
    paramajfq = this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem;
    paramajfq.show_sum += 1;
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.reddotGameId > 0)
    {
      ...
      paramContext = jdField_d_of_type_JavaLangString;
      if (!localairx.jdField_d_of_type_Boolean) {
        break label168;
      }
    }
    label168:
    for (int i = 0;; i = 1)
    {
      ...
      return;
      localairx.a(paramQQAppInterface, paramContext, this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.scheme, this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.ext_url, "drawer");
      break;
    }
  }
