...
public class zqk
{
  ...
  private static zqk jdField_a_of_type_Zqk;
  ...
  private final RecyclablePool jdField_a_of_type_ComTencentCommonsdkPoolRecyclablePool = new RecyclablePool(zqn.class, 4);
  private AbstractUnifiedMonitor.ThreadMonitorCallback jdField_a_of_type_MqqUtilAbstractUnifiedMonitor$ThreadMonitorCallback = new zqm(this);
  ...
  public static zqk a()
  {
    if (jdField_a_of_type_Zqk == null) {}
    try
    {
      if (jdField_a_of_type_Zqk == null) {
        jdField_a_of_type_Zqk = new zqk();
      }
      return jdField_a_of_type_Zqk;
    }
    finally {}
  }
  ...
  public void a(long paramLong)
  {
    ...
    if (this.jdField_a_of_type_Zqn != null)
    {
      if (this.jdField_a_of_type_Zqn.jdField_b_of_type_Long == 0L) {
        this.jdField_a_of_type_Zqn.jdField_b_of_type_Long = paramLong;
      }
    }
    ...
    for (;;)
    {
      ...
      Object localObject = this.jdField_a_of_type_Zqn;
      ((zqn)localObject).jdField_a_of_type_Long += 1L;
      localObject = this.jdField_a_of_type_Zqn.jdField_a_of_type_ArrayOfLong;
      localObject[i] += 1L;
      this.jdField_a_of_type_Zqn.jdField_c_of_type_Long = paramLong;
      break;
      label186:
  ...
  {
    if (!zrr.jdField_a_of_type_Boolean) {
      if (UnifiedMonitor.a().whetherReportDuringThisStartup(9)) {}
    }
    while ((!this.jdField_a_of_type_Boolean) || ((this.jdField_a_of_type_Zqn != null) && (this.jdField_a_of_type_Zqn.jdField_a_of_type_JavaLangString.equals(paramString)))) {
      do
      {
        return;
    ...
    if (paramString.equals("qzone_homepage")) {
      zrr.a().a(0, 1, 1, 0, 1500, 701, 32L, Process.myTid(), "qzoneList", false);
    }
    for (;;)
    {
      this.jdField_a_of_type_Zqn = ((zqn)this.jdField_a_of_type_ComTencentCommonsdkPoolRecyclablePool.obtain(zqn.class));
      this.jdField_a_of_type_Zqn.jdField_a_of_type_JavaLangString = paramString;
      ...
      if (paramString.equals("list_photo")) {
        zrr.a().a(0, 1, 1, 0, 1500, 702, 32L, Process.myTid(), "photoList", false);
      }
    }
  }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Zqn != null) {
      if (!paramBoolean)
      {
        l1 = a(this.jdField_a_of_type_Zqn.jdField_c_of_type_Long - this.jdField_a_of_type_Zqn.jdField_b_of_type_Long);
        if ((this.jdField_a_of_type_Zqn.jdField_a_of_type_Long > 0L) && (l1 > a()))
        {
          long l2 = (this.jdField_a_of_type_Zqn.jdField_c_of_type_Long - this.jdField_a_of_type_Zqn.jdField_b_of_type_Long) / this.jdField_c_of_type_Long + 1L - this.jdField_a_of_type_Zqn.jdField_a_of_type_Long;
          bgmy.a().a(paramString, l2, this.jdField_a_of_type_Zqn.jdField_a_of_type_ArrayOfLong, l1);
          if (QLog.isColorLevel()) {
            Log.d("AutoMonitor.DropFrame", "tag = " + paramString + ", dropCount = " + l2 + ", " + Arrays.toString(this.jdField_a_of_type_Zqn.jdField_a_of_type_ArrayOfLong) + ", totalMs = " + l1);
          }
          if (b()) {}
          double d1 = this.jdField_a_of_type_Zqn.jdField_a_of_type_ArrayOfLong[4];
          double d2 = this.jdField_a_of_type_Zqn.jdField_a_of_type_ArrayOfLong[5];
          double d3 = this.jdField_a_of_type_Zqn.jdField_a_of_type_ArrayOfLong[0];
          double d4 = this.jdField_a_of_type_Zqn.jdField_a_of_type_ArrayOfLong[1];
          double d5 = this.jdField_a_of_type_Zqn.jdField_a_of_type_ArrayOfLong[2];
          double d6 = this.jdField_a_of_type_Zqn.jdField_a_of_type_ArrayOfLong[3];
          localHashMap = new HashMap(10);
          localHashMap.put("dropCount", String.valueOf(l2));
          localHashMap.put("totalMs", String.valueOf(l1));
          localHashMap.put("scene", this.jdField_a_of_type_Zqn.jdField_a_of_type_JavaLangString);
          localHashMap.put("dropTimes", Arrays.toString(this.jdField_a_of_type_Zqn.jdField_a_of_type_ArrayOfLong));
          ...
          localHashMap.put("hcState", String.valueOf(zrr.a().a()));
    ...
    {
      if (awoa.e != 0L) {
        str1 = String.valueOf(l1 - awoa.e);
      }
      if (awoa.d != 0L) {
        str2 = String.valueOf(l1 - awoa.d);
      }
      if (awoa.g != 0L) {
        str3 = String.valueOf(l1 - awoa.g);
      }
      if (awoa.f != 0L) {
        str4 = String.valueOf(l1 - awoa.f);
      }
      ...
      zqt.a().a(localHashMap);
      this.jdField_a_of_type_ComTencentCommonsdkPoolRecyclablePool.recycle(this.jdField_a_of_type_Zqn);
      this.jdField_a_of_type_Zqn = null;
      if (!this.jdField_b_of_type_Boolean)
      {
        this.jdField_a_of_type_AndroidViewChoreographer.removeFrameCallback(this.jdField_a_of_type_AndroidViewChoreographer$FrameCallback);
        this.d = 0L;
  ...
  public void c()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_AndroidViewChoreographer$FrameCallback = new zql(this);
