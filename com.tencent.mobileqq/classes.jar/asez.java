  ...
  extends asey
{
  ...
  public asez(Reader paramReader, int paramInt)
  {
  ...
  public final asew a()
  {
    ...
    for (;;)
    {
      ...
      return new asew(new String(this.jdField_a_of_type_ArrayOfChar, 0, k), n, k + n, this.jdField_a_of_type_JavaLangString);
      label700:
      m = i1;
    }
  }
