...
{
  public jwi(MultiMembersAudioUI paramMultiMembersAudioUI) {}
  ...
  public Object instantiateItem(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    View localView1 = View.inflate(paramViewGroup.getContext(), 2130969323, null);
    Object localObject1;
    if (AudioHelper.a(0) == 1)
    {
      localView1.setBackgroundColor(-16776961);
      localView1.addOnLayoutChangeListener(new jwj(this));
      if (paramViewGroup.getTag(2131361845) == null)
      {
        paramViewGroup.setBackgroundColor(-16711936);
        localObject1 = new jwk(this);
    ...
    for (int i = this.a.jdField_b_of_type_Int - paramInt * 8;; i = 8)
    {
      ...
      for (;;)
      {
            ...
            if ((localMVMembersInfo.jdField_a_of_type_JavaLangString == null) || (localMVMembersInfo.jdField_a_of_type_AndroidGraphicsBitmap == null) || (!localMVMembersInfo.jdField_d_of_type_Boolean))
            {
              ...
              if (localObject2 != null)
              {
                ...
                if ((((String)localObject1).equals(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin())) && (localMVMembersInfo.jdField_a_of_type_JavaLangString != null)) {
                  localMVMembersInfo.jdField_a_of_type_JavaLangString += this.a.getResources().getString(2131429346);
                }
              }
              label471:
              ...
              if (localObject2 == null)
              {
                ...
                localObject1 = BitmapFactory.decodeResource(this.a.getResources(), 2130840287, (BitmapFactory.Options)localObject2);
        ...
        try
        {
          localObject2 = BitmapFactory.decodeResource(this.a.getResources(), 2130840287, (BitmapFactory.Options)localObject2);
          localObject1 = localObject2;
        }
        ...
        for (;;)
        {
          ...
          localHolder.jdField_c_of_type_AndroidWidgetImageView.setImageResource(2130840266);
          localHolder.jdField_a_of_type_AndroidWidgetTextView.setText("更多成员");
          localHolder.jdField_c_of_type_Boolean = true;
          localView2.setContentDescription(this.a.getResources().getString(2131428927));
          break;
          label730:
        ...
        for (;;)
        {
          localMVMembersInfo.jdField_a_of_type_AndroidGraphicsBitmap = ((BitmapDrawable)this.a.getResources().getDrawable(2130840217)).getBitmap();
          localMVMembersInfo.jdField_d_of_type_Boolean = true;
          break;
          ...
          localMVMembersInfo.jdField_b_of_type_JavaLangString = null;
          localMVMembersInfo.jdField_a_of_type_JavaLangString = this.a.getResources().getString(2131428928);
        }
        label1091:
        if (this.a.jdField_a_of_type_Int == 7) {
        ...
        default: 
          ...
          {
            localHolder.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.a.getResources().getColor(2131493250));
            label1210:
            ...
            localObject1 = ((BitmapDrawable)this.a.getResources().getDrawable(2130840183)).getBitmap();
        ...
        for (;;)
        {
          ...
          break;
          localHolder.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130840058);
          break label1148;
          localHolder.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130840062);
          break label1148;
          localHolder.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130840060);
          break label1148;
          localHolder.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.a.getResources().getColor(2131492968));
          break label1210;
          label1621:
          ...
          label1704:
          localHolder.jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
          localHolder.jdField_c_of_type_AndroidWidgetImageView.setImageResource(2130839128);
          break label1385;
          label1728:
          if (localHolder.d.getVisibility() != 0) {
            break label1510;
