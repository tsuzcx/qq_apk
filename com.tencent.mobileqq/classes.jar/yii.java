  ...
  extends BaseAdapter
{
  ...
  public yii(Context paramContext, Activity paramActivity, int paramInt)
  {
    this(paramContext, paramActivity, paramInt, 0);
  }
  
  public yii(Context paramContext, Activity paramActivity, int paramInt1, int paramInt2)
  {
  ...
  {
    yuk.d("Q.qqstory.detail.FeedItemThumbAdapter", "publishAnimationForQIM");
    ...
    for (;;)
    {
      ...
      localObjectAnimator.addUpdateListener(new yik(this, localStoryHomeHorizontalListView));
    }
  }
  ...
  protected View a(int paramInt, yqw paramyqw, ViewGroup paramViewGroup)
  {
    ...
    {
      yuk.e("Q.qqstory.detail.FeedItemThumbAdapter", "bind view failed because of invalidate data.");
      return paramyqw.a();
    }
    StoryVideoItem localStoryVideoItem = (StoryVideoItem)this.jdField_a_of_type_JavaUtilList.get(paramInt);
    QQStoryAutoPlayView localQQStoryAutoPlayView = (QQStoryAutoPlayView)paramyqw.a(2131374612);
    TextView localTextView = (TextView)paramyqw.a(2131374613);
    StoryNickNameView localStoryNickNameView = (StoryNickNameView)paramyqw.a(2131374611);
    if ((this.c != 0) && (this.c != localQQStoryAutoPlayView.getLayoutParams().width) && (this.d != 0) && (this.d != localQQStoryAutoPlayView.getLayoutParams().height))
    {
      ...
      paramyqw.a().getLayoutParams().width = this.c;
    }
    if (this.e > 0) {
    ...
    if (this.jdField_a_of_type_Yol != null) {
      localQQStoryAutoPlayView.a(this.jdField_a_of_type_Yol);
    }
    if (this.jdField_a_of_type_Yoo != null) {
      localQQStoryAutoPlayView.setStoryCoverClickListener(this.jdField_a_of_type_Yoo);
    }
    yrh.a(localStoryVideoItem, localQQStoryAutoPlayView, "QQStory_feed_min", this.c, this.d);
    if (localStoryVideoItem.mHadRead == 1)
    {
      ...
      localTextView.setText(anzj.a(2131703343));
      localTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167084));
      ...
      wmf.a().a(localStoryVideoItem.mVid, localQQStoryAutoPlayView.a());
    }
    for (;;)
    {
      if ((wnv.a()) && (this.jdField_a_of_type_Boolean) && (paramInt == 0) && (this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelVideoListFeedItem.getOwner().isMe()))
      {
      ...
      if ((this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelVideoListFeedItem.type == 3) && ((this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelVideoListFeedItem.getOwner() instanceof QQUserUIItem)))
      {
        ...
        if ((paramViewGroup.isVip) && (!paramViewGroup.isSubscribe())) {
          yup.c("video_exp", "exp_IDrecommend", 0, 0, new String[] { "", "", "", localStoryVideoItem.mVid });
        }
      }
      if (this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelVideoListFeedItem.type == 6) {
        yup.c("video_exp", "exp_topicrecommend", 0, 0, new String[] { "", "", "", localStoryVideoItem.mVid });
      }
      return paramyqw.a();
      ...
      {
        str = zps.a(localStoryVideoItem.mCreateTime, localStoryVideoItem.mTimeZoneOffsetMillis);
        label601:
      ...
      for (;;)
      {
        ...
        break;
        str = zps.b(localStoryVideoItem.mCreateTime);
        break label601;
        label679:
        if ((this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelVideoListFeedItem.getOwner() instanceof TagUserItem))
        {
        ...
        else if ((yrh.a(localStoryVideoItem)) && (localStoryVideoItem.getVideoLinkInfo().a != null))
        {
          localStoryNickNameView.setFormat(anzj.a(2131703341));
      ...
      for (String str = localStoryVideoItem.mVid;; str = wmf.a().a(localStoryVideoItem.mVid))
      {
        localQQStoryAutoPlayView.a().a(str);
        if (!localQQStoryAutoPlayView.a().a()) {
          break label865;
        }
        yuk.a("Q.qqstory.detail.FeedItemThumbAdapter", "vid:%s, animation not end", str);
        localQQStoryAutoPlayView.a().a(new yij(this, str, localQQStoryAutoPlayView));
        break;
      }
      label865:
      localQQStoryAutoPlayView.a().a(4);
      wmf.a().a(localQQStoryAutoPlayView.a());
    }
  }
  
  protected yqw a(int paramInt, ViewGroup paramViewGroup)
  {
    return new yqw(LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131561736, paramViewGroup, false));
  }
  ...
  public void a(yol paramyol)
  {
    this.jdField_a_of_type_Yol = paramyol;
  }
  
  public void a(yoo paramyoo)
  {
  ...
  {
    blqm.a("FeedItem.getView");
    Object localObject;
    if (paramInt == 0)
    {
      if (this.jdField_a_of_type_Yqw == null) {
        this.jdField_a_of_type_Yqw = a(0, paramViewGroup);
      }
      localObject = a(0, this.jdField_a_of_type_Yqw, paramViewGroup);
      blqm.a();
    ...
    for (;;)
    {
      localObject = a(paramInt, (yqw)localObject, paramViewGroup);
      blqm.a();
      break;
