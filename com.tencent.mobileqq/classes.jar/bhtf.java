  ...
  implements Handler.Callback
{
  ...
  private HashMap<String, bhtg> jdField_a_of_type_JavaUtilHashMap;
  private boolean jdField_a_of_type_Boolean;
  private boolean b;
  
  public bhtf(QQAppInterface paramQQAppInterface)
  {
      ...
      try
      {
        ...
        if (i < j)
        {
          ...
          if (!TextUtils.isEmpty((CharSequence)localObject4))
          {
            ...
            localObject4 = new bhtg(this, localObject3[0], Integer.valueOf(localObject3[1]).intValue(), Integer.valueOf(localObject3[2]).intValue(), Long.valueOf(localObject3[3]).longValue(), Integer.valueOf(localObject3[4]).intValue());
            localHashMap2.put(localObject3[0], localObject4);
            if (QLog.isColorLevel()) {
              QLog.d("NCtr", 2, "LimitEntry:[" + ((bhtg)localObject4).toString() + "]");
            }
          }
  ...
  private void a(Context paramContext, String paramString)
  {
    ...
    {
      bhtg localbhtg = (bhtg)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
      paramContext = paramContext.getSharedPreferences("config_prefile", 0).edit();
      paramContext.putString("extra_limit_entry_" + this.mApp.getAccount() + "_" + paramString, localbhtg.toString());
      paramContext.apply();
    }
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        if (localObject != null)
        {
          ...
          {
            l = a().longValue();
            localObject = (bhtg)((HashMap)localObject).get(paramString);
            if (QLog.isColorLevel()) {
              QLog.d("NCtr", 2, "todayBeginTime = " + new Date(l) + "----" + l + " ，entry.mBaseLineTime = " + new Date(((bhtg)localObject).jdField_a_of_type_Long) + "----" + ((bhtg)localObject).jdField_a_of_type_Long);
            }
            if (((bhtg)localObject).jdField_a_of_type_Long >= 1L) {
              continue;
            }
            if (((bhtg)localObject).b <= 0) {
              continue;
            }
            ((bhtg)localObject).jdField_a_of_type_Long = l;
            ((bhtg)localObject).c += 1;
            paramInt = 1;
            bool2 = bool1;
            if (paramInt != 0)
            {
      ...
      if (!bool2) {
        azqs.b(this.app, "dc00898", "", paramString, "0X8009995", "0X8009995", 0, 0, "" + System.currentTimeMillis(), "", "", "");
      }
      azqs.b(this.app, "dc00898", "", paramString, "0X8009996", "0X8009996", 0, 0, "" + System.currentTimeMillis(), "", "", "");
      if (QLog.isColorLevel()) {
      ...
      bool1 = false;
      continue;
      if ((int)((l - ((bhtg)localObject).jdField_a_of_type_Long) / 86400000L) >= ((bhtg)localObject).jdField_a_of_type_Int)
      {
        ((bhtg)localObject).jdField_a_of_type_Long = l;
        ((bhtg)localObject).c = 0;
        paramInt = 1;
        if ((((bhtg)localObject).b > 0) && (((bhtg)localObject).c < ((bhtg)localObject).b))
        {
          ((bhtg)localObject).c += 1;
          paramInt = 1;
        }
  ...
  public void b(String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject3 = (bhtg)((HashMap)localObject1).get(paramString);
        ((HashMap)localObject1).remove(paramString);
        if ((j == ((bhtg)localObject3).jdField_a_of_type_Int) && (k == ((bhtg)localObject3).b))
        {
          localHashMap.put(paramString, localObject3);
          break label935;
        }
        localHashMap.put(paramString, new bhtg(this, paramString, j, k, 0L, 0));
        break label935;
      }
      localHashMap.put(paramString, new bhtg(this, paramString, j, k, 0L, 0));
      break label935;
    ...
    for (;;)
    {
      ...
      if (localHashMap.size() > 0)
      {
        ...
        {
          str = (String)((Iterator)localObject1).next();
          bhtg localbhtg = (bhtg)localHashMap.get(str);
          ((SharedPreferences.Editor)localObject2).putString("extra_limit_entry_" + (String)localObject3 + "_" + str, localbhtg.toString());
          paramString.append(str).append(",");
          if (QLog.isColorLevel()) {
            QLog.d("NCtr", 2, "LimitEntry:[" + localbhtg.toString() + "]");
          }
        }
