...
{
  static final ArrayList<bhuk> c = new ArrayList();
  private final ListAdapter jdField_a_of_type_AndroidWidgetListAdapter;
  ArrayList<bhuk> jdField_a_of_type_JavaUtilArrayList;
  boolean jdField_a_of_type_Boolean;
  ArrayList<bhuk> jdField_b_of_type_JavaUtilArrayList;
  private final boolean jdField_b_of_type_Boolean;
  
  public bhtf(ArrayList<bhuk> paramArrayList1, ArrayList<bhuk> paramArrayList2, ListAdapter paramListAdapter)
  {
  ...
  private boolean a(ArrayList<bhuk> paramArrayList)
  {
    if (paramArrayList != null)
    {
      paramArrayList = paramArrayList.iterator();
      while (paramArrayList.hasNext()) {
        if (!((bhuk)paramArrayList.next()).jdField_a_of_type_Boolean) {
          return false;
        }
      }
    }
  ...
  public boolean a(View paramView)
  {
    ...
    {
      if (((bhuk)this.jdField_a_of_type_JavaUtilArrayList.get(i)).jdField_a_of_type_AndroidViewView == paramView)
      {
  ...
  public boolean b(View paramView)
  {
    ...
    {
      if (((bhuk)this.jdField_b_of_type_JavaUtilArrayList.get(i)).jdField_a_of_type_AndroidViewView == paramView)
      {
  ...
  public Object getItem(int paramInt)
  {
    int i = a();
    if (paramInt < i) {
      return ((bhuk)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).jdField_a_of_type_JavaLangObject;
    }
    int j = paramInt - i;
    paramInt = 0;
    if (this.jdField_a_of_type_AndroidWidgetListAdapter != null)
    ...
    return ((bhuk)this.jdField_b_of_type_JavaUtilArrayList.get(j - paramInt)).jdField_a_of_type_JavaLangObject;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    int j = a();
    if (paramInt < j) {
      return ((bhuk)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).jdField_a_of_type_AndroidViewView;
    }
    int k = paramInt - j;
    paramInt = 0;
    if (this.jdField_a_of_type_AndroidWidgetListAdapter != null)
    ...
    try
    {
      paramView = ((bhuk)this.jdField_b_of_type_JavaUtilArrayList.get(k - paramInt)).jdField_a_of_type_AndroidViewView;
      return paramView;
    }
  ...
  public boolean isEnabled(int paramInt)
  {
    int k = a();
    if (paramInt < k) {
      return ((bhuk)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).jdField_a_of_type_Boolean;
    }
    int m = paramInt - k;
    int i;
    if (this.jdField_a_of_type_AndroidWidgetListAdapter != null)
    ...
    boolean bool = ((bhuk)this.jdField_b_of_type_JavaUtilArrayList.get(m - i)).jdField_a_of_type_Boolean;
    return bool;
  }
