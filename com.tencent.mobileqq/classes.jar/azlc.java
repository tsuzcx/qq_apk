...
{
  public BroadcastReceiver a = new azld(this);
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if ("ptv".equals(paramString2))
    {
      ...
      for (;;)
      {
        ...
        localbkoe.f = str21;
        localbkoe.g = str22;
        localbkoe.h = ((String)localObject2);
        if (!TextUtils.isEmpty(str9))
        {
          azla.a(this.mRuntime.a(), this.mRuntime.a(), str4, str5, str6, str7, str10, str11, str12, str13, str14, str15, str16, str17, str18, str8, str19, paramString3, str9, paramString1, paramJsBridgeListener, paramString2, (String)localObject1, localbkoe);
          continue;
          continue;
            ...
            if ((paramVarArgs != null) && (paramVarArgs.length > 0)) {
              for (;;)
              {
                try
                {
                  ...
                  bool1 = azla.c(this.mRuntime.a());
                  boolean bool2 = aziv.c();
                  boolean bool3 = VideoEnvironment.e(this.mRuntime.a());
                  boolean bool4 = azkt.a(BaseApplicationImpl.getContext());
          ...
          else if ("onClickShareBattle".equals(paramString3))
          {
            try
            {
              ...
              xdd.a().a(paramString1, Integer.valueOf(i).toString());
            }
            catch (JSONException paramJsBridgeListener) {}
            if (QLog.isColorLevel())
            {
          ...
          else if (("startStoryActivity".equals(paramString3)) && (paramVarArgs != null))
          {
            try
            {
              ...
              azla.a(this.mRuntime.a(), this.mRuntime.a(), i);
            }
