  ...
  implements Handler.Callback
{
  ...
  private bapz jdField_a_of_type_Bapz;
  private baqb jdField_a_of_type_Baqb;
  ...
  public bapy(Context paramContext, ListView paramListView, baqb parambaqb)
  {
    this.jdField_a_of_type_ComTencentWidgetListView = paramListView;
    this.jdField_a_of_type_Baqb = parambaqb;
    this.jdField_a_of_type_AndroidWidgetScroller = new Scroller(paramContext, new baqa());
  ...
  private void a(int paramInt1, int paramInt2, View paramView, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      {
        if (this.jdField_a_of_type_Bapz != null) {
          this.jdField_a_of_type_Bapz.a(true);
        }
  ...
  private void b(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Bapz != null) {
        this.jdField_a_of_type_Bapz.a(paramView);
      }
  ...
  {
    this.jdField_a_of_type_Bapz = parambapz;
  }
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    {
      bool2 = this.jdField_a_of_type_Baqb.a(paramMotionEvent);
      return bool2;
    }
    ...
    for (;;)
    {
      ...
      return this.jdField_a_of_type_Baqb.a(paramMotionEvent);
      ...
      this.g = -1;
      break label80;
      if (((k == 1) || (k == 3)) && (this.jdField_a_of_type_Bapz != null)) {
        this.jdField_a_of_type_Bapz.a(false);
      }
    }
  }
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_Bapz = null;
  }
  ...
  public boolean b(MotionEvent paramMotionEvent)
  {
    ...
    if (!this.jdField_b_of_type_Boolean)
    {
      bool2 = this.jdField_a_of_type_Baqb.b(paramMotionEvent);
      return bool2;
    }
    a(paramMotionEvent);
    ...
    case 2: 
      for (;;)
      {
        if ((k == 0) && (this.jdField_c_of_type_Boolean))
        {
          ...
          return this.jdField_a_of_type_Baqb.b(paramMotionEvent);
