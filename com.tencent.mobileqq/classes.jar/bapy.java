  ...
  implements Manager
{
  ...
  public bapy(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a()
  {
    ...
    NewIntent localNewIntent = new NewIntent(this.a.getApplication(), baqa.class);
  ...
  public boolean b()
  {
    ...
    Object localObject = (bbav)this.a.getManager(36);
    if (localObject == null) {
      return false;
    }
    localObject = ((bbav)localObject).a(String.valueOf(100180));
    return (localObject != null) && (((BusinessInfoCheckUpdate.AppInfo)localObject).iNewFlag.get() == 1);
  }
  
  public void c()
  {
    if ((!bnkc.d()) && (bnkc.c()) && (bnkc.e()))
    {
  ...
  public void d()
  {
    ...
    while ((i == 1) && (this.a != null) && (this.a.getApp() != null) && (baqb.a(this.a.getApp(), 84)))
    {
      if (QLog.isColorLevel()) {
        QLog.d("QzoneAlbumRedTouchManager", 2, "GetQZonePhotoGuideCheck supportJumpToQzone");
      }
      new baqb(this.a, this).a();
      return;
      localEditor.apply();
    }
    a();
