  ...
  extends JceStruct
{
  ...
  public msgb_rapidemotion(int paramInt1, String paramString1, String paramString2, int paramInt2, int paramInt3, int paramInt4, int paramInt5, String paramString3, Map paramMap)
  {
