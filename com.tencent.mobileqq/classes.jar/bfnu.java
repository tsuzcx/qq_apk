  ...
  implements bfli
{
  ...
  public bfnu(WadlJsBridge paramWadlJsBridge, String paramString)
  {
  ...
  public void a(String paramString)
  {
    ...
    bfnq.a("WadlJsBridge", "##@!JsCheckUpdateCallback onException >>> " + paramString);
  ...
  {
    bfnq.c("WadlJsBridge", "##@checkUpdate(End) onResult()");
    if (!this.jdField_a_of_type_ComTencentOpenWadlWadlJsBridge.hasRight()) {
      return;
    }
