...
public class aize
{
  ...
  public static android.graphics.drawable.Drawable a(Context paramContext, int paramInt1, int paramInt2, String paramString)
  {
    ...
    //   22: iload_1
    //   23: iload_2
    //   24: invokespecial 38	anpa:<init>	(IFII)V
    //   27: astore 5
    //   29: new 27	anpa
    //   32: dup
    //   33: ldc 29
    ...
    //   42: iload_1
    //   43: iload_2
    //   44: invokespecial 38	anpa:<init>	(IFII)V
    //   47: astore_0
    //   48: new 27	anpa
    //   51: dup
    //   52: aload_3
    ...
    //   60: iload_1
    //   61: iload_2
    //   62: invokespecial 38	anpa:<init>	(IFII)V
    //   65: astore 4
    //   67: new 27	anpa
    //   70: dup
    ...
    //   108: iload_1
    //   109: iload_2
    //   110: invokespecial 38	anpa:<init>	(IFII)V
    //   113: astore_3
    //   114: aload_3
    //   115: sipush 204
        ...
        if (paramInt1 >= 0)
        {
          ...
          for (;;)
          {
            ...
            if ((((MessageForApollo)localObject2).gameId == paramInt2) && (((MessageForApollo)localObject2).roomId == paramLong))
            {
              ...
              if (a()) {
                localairt.a().a((MessageForApollo)localObject2);
              }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, ApolloGameData paramApolloGameData, int paramInt)
  {
    ...
    if (!bbfr.a(paramContext, paramApolloGameData.gameAppPkgName))
    {
    ...
    ((airx)paramQQAppInterface.getManager(153)).a().a(paramApolloGameData.gameId, paramApolloGameData.gameAppid, 0, paramSessionInfo.jdField_a_of_type_JavaLangString, paramInt);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localajrd.e = 1;
        localajrd.d = 3;
        a(paramQQAppInterface, paramString, localajrd);
        return;
        localajrd.jdField_b_of_type_JavaLangString = ajya.a(2131702116);
        i = 0;
      }
    }
  }
  
  public static void a(QQAppInterface paramQQAppInterface, String paramString, ajrd paramajrd)
  {
    if ((paramajrd == null) || (paramQQAppInterface == null))
    {
      QLog.e("CmGameTemp_CmGameSessionUtil", 1, "[sendGameMsg], errInfo->param is null.");
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.d("CmGameTemp_CmGameSessionUtil", 2, new Object[] { "[sendGameMsg], gameId:", Integer.valueOf(paramajrd.jdField_a_of_type_Int), ",roomId:", Long.valueOf(paramajrd.jdField_a_of_type_Long), ",extendInfo:", paramajrd.jdField_c_of_type_JavaLangString });
    }
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramajrd.jdField_a_of_type_Int == 1)
        {
          ...
          ((JSONObject)localObject).put("gameStatus", paramajrd.e);
          if (localObject != null) {
          ...
          paramString = axas.a(paramQQAppInterface, paramString, paramQQAppInterface.getCurrentAccountUin(), 1036, localApolloMessage);
          if (paramajrd.jdField_a_of_type_Int == 1)
          {
            paramString.msgType = 2;
            paramString.gameId = paramajrd.jdField_a_of_type_Int;
            paramString.mGameMode = paramajrd.jdField_c_of_type_Int;
            paramString.roomId = paramajrd.jdField_a_of_type_Long;
            paramString.mApolloMessage.id = paramajrd.jdField_b_of_type_Int;
            paramString.gameName = paramajrd.jdField_b_of_type_JavaLangString;
            paramString.gameExtendJson = paramajrd.jdField_c_of_type_JavaLangString;
            paramString.gameStatus = paramajrd.e;
            paramString.extendJson = ("{\"gameStatus\":" + paramajrd.e + "}");
        ...
        paramString.msgType = paramajrd.d;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    ((airx)paramQQAppInterface.getManager(153)).a().b(paramString1, paramString2);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, long paramLong, int paramInt)
  {
    ...
    ApolloGameData localApolloGameData = ((ajmu)localObject2).a(paramInt);
    Object localObject1 = ajya.a(2131702115);
    if ((localApolloGameData != null) && (!TextUtils.isEmpty(localApolloGameData.name)))
    {
      localObject2 = ((ajmu)localObject2).a(localApolloGameData.actionId);
    ...
    for (;;)
    {
      int i = localApolloGameData.actionId;
      localajrd.jdField_b_of_type_JavaLangString = localApolloGameData.name;
      localajrd.jdField_a_of_type_JavaLangString = ((String)localObject1);
      localajrd.jdField_b_of_type_Int = i;
      localajrd.jdField_a_of_type_Int = paramInt;
      localajrd.jdField_a_of_type_Long = paramLong;
      localajrd.e = 0;
      ...
      if (!TextUtils.isEmpty(localajrd.jdField_a_of_type_JavaLangString)) {
        ((ApolloMessage)localObject2).name = localajrd.jdField_a_of_type_JavaLangString.getBytes();
      }
      localObject1 = null;
      if (0 == 0) {}
      for (;;)
      {
        try
        {
          ...
          ((JSONObject)localObject1).put("gameId", localajrd.jdField_a_of_type_Int);
          ((JSONObject)localObject1).put("gameMode", localajrd.jdField_c_of_type_Int);
          ((JSONObject)localObject1).put("roomid", localajrd.jdField_a_of_type_Long);
          if (localajrd.jdField_a_of_type_Int == 1)
          {
            ((JSONObject)localObject1).put("msgTyep", 2);
            ((JSONObject)localObject1).put("gameName", localajrd.jdField_b_of_type_JavaLangString);
            if (!TextUtils.isEmpty(localajrd.jdField_c_of_type_JavaLangString)) {
              ((JSONObject)localObject1).put("gameExtendJson", localajrd.jdField_c_of_type_JavaLangString);
            }
            ((JSONObject)localObject1).put("gameStatus", localajrd.e);
            if (localObject1 != null) {
              ((ApolloMessage)localObject2).extStr = ((JSONObject)localObject1).toString();
            }
            localObject1 = ((airx)paramQQAppInterface.getManager(153)).b(paramQQAppInterface.getCurrentAccountUin());
            ((ApolloMessage)localObject2).sender_ts = bbbr.a(((ApolloBaseInfo)localObject1).apolloServerTS);
            ...
            localObject1 = axas.a(paramQQAppInterface, paramString1, paramQQAppInterface.getCurrentAccountUin(), 1036, (ApolloMessage)localObject2);
            if (localajrd.jdField_a_of_type_Int != 1) {
              break label698;
            }
            ((MessageForApollo)localObject1).msgType = 2;
            ((MessageForApollo)localObject1).gameId = localajrd.jdField_a_of_type_Int;
            ((MessageForApollo)localObject1).mGameMode = localajrd.jdField_c_of_type_Int;
            ((MessageForApollo)localObject1).roomId = localajrd.jdField_a_of_type_Long;
            ((MessageForApollo)localObject1).mApolloMessage.id = localajrd.jdField_b_of_type_Int;
            ((MessageForApollo)localObject1).gameName = localajrd.jdField_b_of_type_JavaLangString;
            ((MessageForApollo)localObject1).gameExtendJson = localajrd.jdField_c_of_type_JavaLangString;
            ((MessageForApollo)localObject1).gameStatus = localajrd.e;
            ((MessageForApollo)localObject1).extendJson = ("{\"gameStatus\":" + localajrd.e + ",\"robotOpenId\":" + paramString2 + "}");
            ...
            jdField_a_of_type_Long = System.currentTimeMillis();
            return;
            localajrd.jdField_b_of_type_JavaLangString = ajya.a(2131702117);
            i = 0;
            break;
          }
          ((JSONObject)localObject1).put("msgTyep", localajrd.d);
          continue;
          ((MessageForApollo)localObject1).msgType = localajrd.d;
        }
        catch (Throwable paramQQAppInterface)
        {
          QLog.d("CmGameTemp_CmGameSessionUtil", 2, paramQQAppInterface, new Object[0]);
  ...
  public static boolean a()
  {
    if ((BaseActivity.sTopActivity instanceof FragmentActivity))
    {
      ...
      if (localObject != null)
      {
        ...
        if (!(localObject instanceof aemy)) {}
      }
    }
    for (Object localObject = (aemy)localObject;; localObject = null) {
      return (localObject != null) && (((aemy)localObject).D());
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      aanz.b(paramQQAppInterface, localSessionInfo, (ArkAppMessage)localObject);
      return true;
    }
