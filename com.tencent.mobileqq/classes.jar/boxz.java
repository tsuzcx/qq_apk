...
{
  public boxz(AEVideoShelfEditFragment paramAEVideoShelfEditFragment) {}
  ...
  protected void a(Void paramVoid)
  {
    ...
    {
      bpam.c("AEVideoShelfEditFrag", "init NodeGroup Error!");
      return;
    }
    ...
    AEVideoShelfEditFragment.a(this.a, new bozi(this.a.getActivity(), paramVoid, AEVideoShelfEditFragment.a(this.a).getVideoWidth(), AEVideoShelfEditFragment.a(this.a).getVideoHeight()));
