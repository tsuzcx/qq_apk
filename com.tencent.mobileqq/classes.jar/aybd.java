...
public class aybd
{
  ...
  public static ayax a(Spannable paramSpannable, int paramInt)
  {
    if ((paramInt < 0) || (paramInt >= paramSpannable.length())) {
      return null;
    }
    ayax[] arrayOfayax = (ayax[])paramSpannable.getSpans(paramInt, paramInt, ayax.class);
    int i = 0;
    while (i < arrayOfayax.length)
    {
      int j = paramSpannable.getSpanStart(arrayOfayax[i]);
      int k = paramSpannable.getSpanEnd(arrayOfayax[i]);
      if ((paramInt >= j) && (paramInt < k)) {
        return arrayOfayax[i];
      }
      i += 1;
    }
    return null;
  ...
  public static List<Pair<Integer, String>> a(Editable paramEditable)
  {
    ...
    if (i < paramEditable.length())
    {
      Object localObject2 = (ayax[])paramEditable.getSpans(i, i, ayax.class);
  ...
  public static void a(ETTextView paramETTextView, CharSequence paramCharSequence, int paramInt)
  {
    ...
    for (paramETTextView = paramETTextView.getText();; paramETTextView = paramCharSequence)
    {
      ...
      paramETTextView = (ayax[])paramETTextView.getSpans(0, paramETTextView.length(), ayax.class);
      paramInt = 0;
  ...
  public static List<Pair<Integer, Integer>> b(Editable paramEditable)
  {
    ...
    if (i < paramEditable.length())
    {
      arrayOfayax = (ayax[])paramEditable.getSpans(i, i, ayax.class);
      if ((arrayOfayax == null) || (arrayOfayax.length <= 0)) {
        break label184;
      }
      if (arrayOfayax.length > 1)
      {
        int k = arrayOfayax.length;
        j = 0;
        localObject1 = null;
        label66:
        if (j < k)
        {
          ayax localayax = arrayOfayax[j];
          if (localayax == localObject2) {
            break label194;
          }
          localObject1 = localayax;
        }
      }
    }
    label184:
    ...
    for (;;)
    {
      ...
      if (localObject1 == null) {
        localObject1 = arrayOfayax[(arrayOfayax.length - 1)];
      }
      for (;;)
      {
        label110:
        ...
        {
          localObject2 = ((ayax)localObject1).a();
