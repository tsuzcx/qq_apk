  ...
  implements zao, zat
{
  ...
  private static yzz jdField_a_of_type_Yzz;
  long jdField_a_of_type_Long;
  protected Handler a;
  boiw jdField_a_of_type_Boiw = new zaa(this);
  ...
  public static yzz a()
  {
    if (jdField_a_of_type_Yzz == null) {
      jdField_a_of_type_Yzz = new yzz();
    }
    return jdField_a_of_type_Yzz;
  }
  
  private void a(Activity paramActivity, List<String> paramList, zab paramzab, int paramInt)
  {
    paramList = (SlideItemInfo)a().get(0);
    if (paramList.jdField_b_of_type_Int == 0)
    {
      this.jdField_a_of_type_Zab = paramzab;
    ...
    bpij.a(paramActivity, paramList.jdField_b_of_type_JavaLangString, paramList.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo, (int)paramList.jdField_b_of_type_Long, (int)paramList.jdField_c_of_type_Long, 120, 10023, 0, "", "", false, 11, 14, null);
  }
  ...
  private void a(Context paramContext, List<SlideItemInfo> paramList)
  {
    ...
    {
      paramContext = yzw.a(paramContext).a(((SlideItemInfo)paramList.get(0)).jdField_e_of_type_JavaLangString);
      if ((paramContext != null) && (paramContext.size() > 0))
      {
        paramContext = ((QIMMusicConfigManager)bogd.a(2)).a(((yzx)paramContext.get(0)).jdField_a_of_type_Int, ((yzx)paramContext.get(0)).jdField_b_of_type_Int);
        if (paramContext != null)
        {
          paramList = (boje)bogd.a().c(8);
          if ((paramList != null) && (!paramList.b(paramContext)))
          {
            paramList.a(paramContext, this.jdField_a_of_type_Boiw);
            if (QLog.isColorLevel()) {
  ...
  private void c(List<SlideItemInfo> paramList)
  {
    ...
    for (;;)
    {
      ...
      localObject1 = (zag)QQStoryContext.a().getBusinessHandler(1);
      ...
      for (;;)
      {
        ...
        if ((localSlideItemInfo != null) && (!TextUtils.isEmpty(localSlideItemInfo.jdField_b_of_type_JavaLangString)))
        {
          ...
          if ((!((zag)localObject1).a(localSlideItemInfo.jdField_b_of_type_JavaLangString)) && (!this.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowCoreSlideShowProcessor.a(localSlideItemInfo.jdField_b_of_type_JavaLangString))) {
  ...
  private void d(List<SlideItemInfo> paramList)
  {
    ...
    for (;;)
    {
      ...
      l2 = 0L;
      label95:
      if ((l2 <= this.jdField_b_of_type_Int) || (yzm.a().b() == 22)) {
        if (paramList != null) {
          e(paramList);
        }
      }
  ...
  private void e(@NonNull List<SlideItemInfo> paramList)
  {
    if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowCoreSlideShowProcessor != null)
    {
      zag localzag = (zag)QQStoryContext.a().getBusinessHandler(1);
      paramList = paramList.iterator();
      while (paramList.hasNext())
      {
        ...
        if ((localSlideItemInfo != null) && (!TextUtils.isEmpty(localSlideItemInfo.jdField_b_of_type_JavaLangString)))
        {
          ...
          else
          {
            ...
            if (!localzag.a(localSlideItemInfo.jdField_b_of_type_JavaLangString))
            {
              ...
              else
              {
                ...
                if ((bool) && (localSlideItemInfo.jdField_b_of_type_Int == 1))
                {
                  ...
                  localLocalMediaInfo = localzag.a(localSlideItemInfo.jdField_b_of_type_JavaLangString);
                  if (localLocalMediaInfo != null)
                  {
                    FileUtil.deleteFile(localLocalMediaInfo.path);
                    localzag.a(localSlideItemInfo.jdField_b_of_type_JavaLangString);
                  }
                  this.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowCoreSlideShowProcessor.a(localSlideItemInfo, this);
                }
              }
  ...
  public void a(Activity paramActivity, zab paramzab, int paramInt)
  {
    Object localObject1 = zac.a(a());
    ...
    do
    {
      ...
      if (a(paramActivity))
      {
        a(paramActivity, (List)localObject1, paramzab, paramInt);
        return;
      }
      ...
      {
        paramzab = EditPicActivity.a(paramActivity, localSlideItemInfo.jdField_b_of_type_JavaLangString, true, true, true, true, true, false, false, false, 2, paramInt, 0, false, null);
        paramzab.putExtra("media_info", localSlideItemInfo.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo);
        paramzab.putExtra("extra_edit_video_from", 2);
        paramActivity.startActivityForResult(paramzab, 10002);
        paramActivity = new StringBuilder();
        if (bool) {}
        for (paramInt = 0;; paramInt = 1)
        {
          ykv.a("video_edit", "edit_local", 0, 0, new String[] { paramInt + "" });
          return;
        }
      }
    } while (localSlideItemInfo.jdField_b_of_type_Int != 1);
    paramzab = new StringBuilder();
    if (bool) {}
    Object localObject2;
    int j;
    for (int i = 0;; i = 1)
    {
      ykv.a("video_edit", "edit_local", 0, 1, new String[] { i + "" });
      i = 0;
      paramzab = null;
      localObject1 = null;
      bool = false;
      ...
      if (localIntent != null)
      {
        ...
        paramzab = localIntent.getStringExtra("shareGroupId");
    ...
    paramzab = this.jdField_b_of_type_JavaUtilList.iterator();
    i = 0;
    if (paramzab.hasNext())
    {
      localObject1 = (SlideItemInfo)paramzab.next();
    ...
    for (;;)
    {
      ...
      for (paramzab = "0";; paramzab = "1")
      {
        ykv.a("pic_choose_slides", "clk_create", k, 0, new String[] { paramzab, this.jdField_b_of_type_JavaUtilList.size() + "", m - i + "", i + "" });
        a(paramActivity, this.jdField_b_of_type_JavaUtilList);
        g();
        j = -1;
        localObject1 = "";
        i = j;
        paramzab = (zab)localObject1;
        if (this.jdField_b_of_type_JavaUtilList.size() > 0)
        {
          ...
          if (localObject2 != null)
          {
            ...
            paramzab = ((SlideItemInfo)localObject2).jdField_a_of_type_JavaLangString;
          }
        }
        this.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowCoreSlideShowProcessor.a(this.jdField_b_of_type_JavaUtilList, this, paramActivity, this.jdField_a_of_type_AndroidOsHandler, paramInt, i, paramzab);
        return;
        j = 0;
        break;
        k = 1;
  ...
  public void a(List<String> paramList, HashMap<String, LocalMediaInfo> paramHashMap)
  {
    ...
    for (;;)
    {
      if ((paramList != null) && (paramHashMap != null))
      {
        ...
        paramList = zac.a(paramList, paramHashMap, localArrayList);
        this.jdField_b_of_type_JavaUtilList.clear();
        this.jdField_b_of_type_JavaUtilList.addAll(paramList);
      }
      return;
  ...
  public void a(List<String> paramList, HashMap<String, LocalMediaInfo> paramHashMap, boolean paramBoolean)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      {
        paramList = zac.a(paramList, paramHashMap, (List)localObject);
        this.jdField_b_of_type_JavaUtilList.addAll(paramList);
      }
      ((List)localObject).clear();
      if (this.jdField_a_of_type_Zad != null) {
        this.jdField_a_of_type_Zad.a();
      }
      if (paramBoolean) {
  ...
  public void a(@NonNull vxg paramvxg)
  {
    ...
    for (;;)
    {
      return;
      if (QLog.isColorLevel()) {
        QLog.e("SlideShowPhotoListManager", 2, "setData StoryAlbum AlbumId : " + paramvxg.a() + " mTransId=" + paramvxg.jdField_a_of_type_JavaLangString);
      }
      Object localObject = new ArrayList();
      HashMap localHashMap = new HashMap();
      this.jdField_c_of_type_JavaUtilList.clear();
      Iterator localIterator = paramvxg.a().iterator();
      while (localIterator.hasNext())
      {
        vxh localvxh = (vxh)localIterator.next();
        LocalMediaInfo localLocalMediaInfo = localvxh.a();
        localHashMap.put(localvxh.jdField_a_of_type_JavaLangString, localLocalMediaInfo);
        if (localvxh.a())
        {
          ((List)localObject).add(localvxh.jdField_a_of_type_JavaLangString);
          localLocalMediaInfo.selectStatus = 1;
        }
        localLocalMediaInfo.mAlbumName = paramvxg.jdField_b_of_type_JavaLangString;
        localLocalMediaInfo.mTransId = paramvxg.jdField_a_of_type_JavaLangString;
        localLocalMediaInfo.mTextId = paramvxg.jdField_b_of_type_Int;
        localLocalMediaInfo.mTextStr = paramvxg.jdField_b_of_type_JavaLangString;
      ...
      while (((Iterator)localObject).hasNext()) {
        ((SlideItemInfo)((Iterator)localObject).next()).jdField_a_of_type_Vxg = paramvxg;
      }
    }
  }
  ...
  public void a(yzo paramyzo)
  {
    ...
    {
      str = paramyzo.jdField_a_of_type_JavaLangString;
      localLocalMediaInfo = new LocalMediaInfo();
      localLocalMediaInfo.path = paramyzo.jdField_b_of_type_JavaLangString;
      localLocalMediaInfo.mMimeType = "video";
      localLocalMediaInfo.mAudioPath = paramyzo.c;
      localLocalMediaInfo.mHasAudioTrack = paramyzo.jdField_a_of_type_Boolean;
      localLocalMediaInfo.mSampleRate = paramyzo.jdField_b_of_type_Int;
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = (zag)((AppInterface)localObject).getBusinessHandler(1);
        ((zag)localObject).a(str, localLocalMediaInfo);
        if (((zag)localObject).a() == null) {
          ((zag)localObject).a(paramyzo.jdField_a_of_type_AndroidMediaMediaFormat);
        }
        if (QLog.isColorLevel()) {
          QLog.e("SlideShowPhotoListManager", 2, "onImage2VideoResult RESULT_SUCC  hasAudioTrack:" + localLocalMediaInfo.mHasAudioTrack);
        }
        if (QLog.isColorLevel()) {
          QLog.e("SlideShowPhotoListManager", 2, "onImage2VideoResult " + paramyzo);
        }
        return;
      }
      ...
      if (paramyzo.jdField_a_of_type_Int == 2)
      {
        if (QLog.isColorLevel()) {
          QLog.i("SlideShowPhotoListManager", 2, "onImage2VideoResult cancel" + paramyzo);
        }
        ykv.a("actAlbumResult", new String[] { paramyzo.jdField_a_of_type_Int + "" });
      }
      else if (paramyzo.jdField_a_of_type_Int == 5)
      {
        if (QLog.isColorLevel()) {
          QLog.e("SlideShowPhotoListManager", 2, "onImage2VideoResult fail load");
        }
        ykv.a("actAlbumResult", new String[] { paramyzo.jdField_a_of_type_Int + "" });
        a(((AppInterface)localObject).getApp(), anvx.a(2131713643));
      }
      else if (paramyzo.jdField_a_of_type_Int == 8)
      {
        if (QLog.isColorLevel()) {
          QLog.d("SlideShowPhotoListManager", 2, "result audio fail");
        }
        ykv.a("actAlbumResult", new String[] { paramyzo.jdField_a_of_type_Int + "" });
        a(((AppInterface)localObject).getApp(), anvx.a(2131713642));
        if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowCoreSlideShowProcessor != null) {
          this.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowCoreSlideShowProcessor.b();
        }
        if (this.jdField_a_of_type_Zad != null) {
          this.jdField_a_of_type_Zad.e();
        }
      }
      else
      {
  ...
  protected void g()
  {
    ...
    for (;;)
    {
      ...
      {
        SlideItemInfo localSlideItemInfo = (SlideItemInfo)localIterator.next();
        if (localzag.a(localSlideItemInfo.jdField_b_of_type_JavaLangString) == null) {
          if (QLog.isColorLevel()) {
