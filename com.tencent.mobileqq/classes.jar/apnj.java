...
public class apnj
  extends aphp
{
  public apnj(Intent paramIntent)
  {
    super(paramIntent);
  }
  ...
  {
    int i = azvv.a(this.jdField_a_of_type_AndroidAppActivity, 164.0F);
    int j = azvv.a(this.jdField_a_of_type_AndroidAppActivity, 265.0F);
    ...
    ((ImageView)localObject5).setImageResource(2130839290);
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-2, -2);
    int m = azvv.a(this.jdField_a_of_type_AndroidAppActivity, 8.0F);
    ...
    if (!TextUtils.isEmpty((CharSequence)localObject3))
    {
      ...
      ((LinearLayout.LayoutParams)localObject5).topMargin = azvv.a(this.jdField_a_of_type_AndroidAppActivity, 5.0F);
    ...
    parambafb = this.jdField_a_of_type_AndroidOsBundle.getString("key_thumb_url");
    try
    {
      ...
      parambafb = URLDrawable.getDrawable(parambafb, (URLDrawable.URLDrawableOptions)localObject2);
      if (parambafb.getStatus() == 2) {
        parambafb.restartDownload();
      }
      localURLImageView.setImageDrawable(parambafb);
    }
    catch (Exception parambafb)
    {
      for (;;)
      {
        if (QLog.isColorLevel()) {
          QLog.w("Q.qqstory.troopstory.share", 2, "addStructView:", parambafb);
        }
      }
    }
    return true;
