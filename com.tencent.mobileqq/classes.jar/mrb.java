...
public class mrb
  extends MqqHandler
{
  public mrb(SubscriptFeedsActivity paramSubscriptFeedsActivity, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          case 1002: 
            try
            {
              ...
              this.a.runOnUiThread(new mrc(this, paramMessage));
              return;
            }
        ...
        return;
        this.a.runOnUiThread(new mrd(this));
        return;
    ...
    this.a.runOnUiThread(new mre(this, paramMessage));
    return;
    this.a.runOnUiThread(new mrf(this));
    return;
    this.a.runOnUiThread(new mrg(this));
    return;
    this.a.runOnUiThread(new mrh(this));
  }
}
