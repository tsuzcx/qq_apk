...
public class bdll
{
  public static final HashMap<String, bdln> a = new HashMap();
  
  static
  {
    a.put("dc01160", new pcm());
  }
  
  private static String a()
  {
    int i = bhlo.b();
    long l = bhlo.d() / 1024L / 1024L;
    ...
    str2 = String.format("%.2f", new Object[] { Double.valueOf(bhlo.a()) });
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append(i).append(";").append(l).append(";").append(arrayOfLong[0]).append(";").append(arrayOfLong[1]).append(";").append(str1.replaceAll(";", "")).append(";").append(str2).append(";").append(brkm.a).append(";").append(brkm.b).append(";");
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt1, int paramInt2, int paramInt3, String paramString6, String paramString7, String paramString8, String paramString9)
  {
    ...
    if (localQQAppInterface == null)
    {
      ...
      if (!"CliOper".equals(paramString1)) {
        bnro.a().a(paramString4, paramQQAppInterface);
      }
      return;
    }
  ...
  {
    paramPluginRuntime.setClickEventReportor(new bdlm());
  }
  ...
  protected bdln a(String paramString)
  {
    if (a.containsKey(paramString)) {
      return (bdln)a.get(paramString);
    }
    return null;
  }
  ...
  protected void a()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      localObject = (bdln)a.get(localObject);
      if (localObject != null) {
        ((bdln)localObject).a();
      }
    }
