  ...
  extends whp<LikeEntry>
{
  ...
  public whe(Context paramContext, Activity paramActivity, View paramView, CommentLikeFeedItem paramCommentLikeFeedItem, int paramInt)
  {
    ...
    this.jdField_a_of_type_Xwm = new xwm(paramActivity, paramCommentLikeFeedItem, paramInt, false);
    this.jdField_a_of_type_Xyd = new xyd();
  }
  
  public static whe a(Context paramContext, Activity paramActivity, View paramView, CommentLikeFeedItem paramCommentLikeFeedItem, int paramInt)
  {
    paramContext = new whe(paramContext, paramActivity, paramView, paramCommentLikeFeedItem, paramInt);
  ...
  public whq a()
  {
    return new wgz(this, this.jdField_a_of_type_Boolean);
  }
  ...
  {
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370095));
  ...
  public void a(List<LikeEntry> paramList)
  {
    ...
    if (!bool)
    {
      ...
      paramList = xwj.a(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem, this.jdField_a_of_type_JavaUtilList, this.jdField_a_of_type_Xwm);
      if ((bool) || (j != 0) || (k <= 0)) {
        break label153;
      }
    }
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setOnTouchListener(this.jdField_a_of_type_Xyd);
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      for (((CommentLikeFeedItem)localObject).mLikeCount += 1;; this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem.mLikeCount = 1)
      {
        ...
        ThreadManager.post(new FeedLikeLego.2(this, (wke)wjs.a(2), str, (LikeEntry)localObject), 5, null, true);
        return;
      }
    }
