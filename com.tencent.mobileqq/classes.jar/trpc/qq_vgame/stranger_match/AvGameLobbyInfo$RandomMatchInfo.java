...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 34, 42, 50 }, new String[] { "players_num", "player_list", "game_type", "title_url", "backgroud_url", "wording" }, new Object[] { Integer.valueOf(0), null, Integer.valueOf(0), "", "", "" }, RandomMatchInfo.class);
