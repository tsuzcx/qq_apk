  ...
  extends MessageMicro<AddMatchUserReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "uin", "game_type", "from" }, new Object[] { Long.valueOf(0L), localInteger, localInteger }, AddMatchUserReq.class);
  }
}
