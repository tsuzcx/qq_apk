  ...
  extends MessageMicro<PkConfig>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40 }, new String[] { "pk_id", "pk_begin_min_user_num", "pool_timeout_ts", "pool_timeout_min_user_num", "max_award_top_n" }, new Object[] { localInteger, localInteger, localInteger, localInteger, localInteger }, PkConfig.class);
  }
}
