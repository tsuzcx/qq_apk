  ...
  extends MessageMicro<DelMatchUserReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32 }, new String[] { "uin", "game_type", "extr_info", "from" }, new Object[] { Long.valueOf(0L), localInteger, localByteStringMicro, localInteger }, DelMatchUserReq.class);
  }
}
