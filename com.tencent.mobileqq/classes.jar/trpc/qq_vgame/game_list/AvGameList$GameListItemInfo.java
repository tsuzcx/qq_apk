...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 34, 42, 50, 58, 66, 72, 80, 90, 96, 106, 114, 122, 130, 138 }, new String[] { "game_type", "game_name", "game_desc", "backgroup_pic_url", "game_info", "prepare_pic_url", "prepare_pic_tp_url", "music_name", "status", "online_time", "prepare_wording", "offline_time", "game_name_url", "answer_right_pic_url", "game_over_pic_url", "tips_one_line_pic_url", "tips_two_line_pic_url" }, new Object[] { Integer.valueOf(0), "", "", "", null, "", "", "", Integer.valueOf(0), Long.valueOf(0L), "", Long.valueOf(0L), "", "", "", "", "" }, GameListItemInfo.class);
