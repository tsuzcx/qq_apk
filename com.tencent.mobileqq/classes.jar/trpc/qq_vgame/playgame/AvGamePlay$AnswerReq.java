  ...
  extends MessageMicro<AnswerReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 40, 48, 56, 64, 74 }, new String[] { "uin", "play_game_id", "question_index", "answer_index", "scene_type", "answer_duration", "trans_mod", "trans_cost", "answer" }, new Object[] { Long.valueOf(0L), "", localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, "" }, AnswerReq.class);
  }
}
