  ...
  extends MessageMicro<CmdAnswerQuestionReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 32, 40 }, new String[] { "uin", "play_game_id", "answer", "trans_mod", "trans_cost" }, new Object[] { Long.valueOf(0L), "", "", localInteger, localInteger }, CmdAnswerQuestionReq.class);
  }
}
