...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 32 }, new String[] { "play_game_id", "uin", "req_src", "req_type" }, new Object[] { "", Long.valueOf(0L), Integer.valueOf(0), Integer.valueOf(0) }, CmdGetQuestionReq.class);
