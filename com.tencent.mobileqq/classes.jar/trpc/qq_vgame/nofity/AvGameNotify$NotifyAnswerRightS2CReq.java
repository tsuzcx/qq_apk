...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 32, 40, 48, 58 }, new String[] { "actor_info", "question_info", "score", "actor_score", "actor_uin", "continue_correct_num", "user_answer_info" }, new Object[] { null, null, Integer.valueOf(0), Integer.valueOf(0), Long.valueOf(0L), Long.valueOf(0L), null }, NotifyAnswerRightS2CReq.class);
