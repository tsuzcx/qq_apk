  ...
  extends MessageMicro<RoomUserExitS2CReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 26, 32, 40, 48, 56, 66, 74 }, new String[] { "exit_reason", "room_info", "exit_uin", "new_owner_uin", "heartbeat_timeout", "sub_reason", "onwer_tip", "exiter_tip" }, new Object[] { localInteger, null, localLong, localLong, localInteger, localInteger, "", "" }, RoomUserExitS2CReq.class);
  }
}
