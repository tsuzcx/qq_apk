...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16 }, new String[] { "seq", "game_type" }, new Object[] { Integer.valueOf(0), Integer.valueOf(0) }, NotifyMatchV2UserCreateRoom.class);
