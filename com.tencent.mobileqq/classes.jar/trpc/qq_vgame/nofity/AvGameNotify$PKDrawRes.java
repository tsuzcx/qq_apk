...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 24, 32, 40 }, new String[] { "is_draw", "self_cost", "peer_cost" }, new Object[] { Boolean.valueOf(false), Integer.valueOf(0), Integer.valueOf(0) }, PKDrawRes.class);
