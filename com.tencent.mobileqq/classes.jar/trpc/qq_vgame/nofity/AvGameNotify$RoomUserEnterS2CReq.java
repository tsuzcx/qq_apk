  ...
  extends MessageMicro<RoomUserEnterS2CReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 32 }, new String[] { "room_info", "type", "enter_uin", "inviter_uin" }, new Object[] { null, Integer.valueOf(0), localLong, localLong }, RoomUserEnterS2CReq.class);
  }
}
