...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 42, 50, 56 }, new String[] { "seq", "roomid", "owner_uin", "game_status", "game_name", "users", "room_create_ts" }, new Object[] { Long.valueOf(0L), Long.valueOf(0L), Long.valueOf(0L), Integer.valueOf(0), "", null, Integer.valueOf(0) }, RoomInfo.class);
