  ...
  extends MessageMicro<UserAnswerInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "uin", "answer_result", "answer_index" }, new Object[] { Long.valueOf(0L), localInteger, localInteger }, UserAnswerInfo.class);
  }
}
