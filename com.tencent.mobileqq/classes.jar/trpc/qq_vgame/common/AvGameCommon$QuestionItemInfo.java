...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 26, 32, 42, 50 }, new String[] { "question_content", "question_duration", "answer_content", "answer_duration", "question_md5", "answer_md5" }, new Object[] { "", Integer.valueOf(0), "", Integer.valueOf(0), "", "" }, QuestionItemInfo.class);
