  ...
  extends MessageMicro<GameQuestionInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34, 42, 48 }, new String[] { "type", "id", "topic", "picture", "questions", "index" }, new Object[] { localInteger, localInteger, null, null, null, localInteger }, GameQuestionInfo.class);
  }
}
