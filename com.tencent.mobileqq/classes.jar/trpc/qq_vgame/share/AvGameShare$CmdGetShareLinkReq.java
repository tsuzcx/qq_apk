...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32, 42, 48 }, new String[] { "roomid", "share_uin", "share_name", "share_type", "play_game_id", "game_type" }, new Object[] { Long.valueOf(0L), Long.valueOf(0L), "", Integer.valueOf(0), "", Integer.valueOf(0) }, CmdGetShareLinkReq.class);
