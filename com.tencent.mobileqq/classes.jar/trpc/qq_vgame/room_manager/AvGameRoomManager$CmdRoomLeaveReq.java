...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48 }, new String[] { "roomid", "reason", "operator_uin", "target_uin", "no_need_ban", "scene" }, new Object[] { Long.valueOf(0L), Integer.valueOf(0), Long.valueOf(0L), Long.valueOf(0L), Boolean.valueOf(false), Integer.valueOf(0) }, CmdRoomLeaveReq.class);
