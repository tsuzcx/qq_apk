  ...
  extends MessageMicro<CmdCheckUserCliVerReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26 }, new String[] { "uin", "roomid", "cli_ver" }, new Object[] { Long.valueOf(0L), Long.valueOf(0L), localByteStringMicro }, CmdCheckUserCliVerReq.class);
  }
}
