  ...
  extends MessageMicro<RoomInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 42, 50, 56, 66 }, new String[] { "seq", "roomid", "owner_uin", "last_update_time", "player_status", "users", "room_create_ts", "video_info_rsp" }, new Object[] { localLong, localLong, localLong, localLong, null, null, localLong, null }, RoomInfo.class);
  }
}
