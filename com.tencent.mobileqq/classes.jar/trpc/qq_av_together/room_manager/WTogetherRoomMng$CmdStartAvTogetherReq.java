...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 42, 48 }, new String[] { "from", "creator_uin", "room_id", "users", "video_info_req", "client_type" }, new Object[] { Integer.valueOf(0), Long.valueOf(0L), Long.valueOf(0L), null, null, Integer.valueOf(0) }, CmdStartAvTogetherReq.class);
