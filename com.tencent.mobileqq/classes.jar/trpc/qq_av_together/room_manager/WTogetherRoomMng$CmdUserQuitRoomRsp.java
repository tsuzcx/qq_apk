...
public final class WTogetherRoomMng$CmdUserQuitRoomRsp
  extends MessageMicro<CmdUserQuitRoomRsp>
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18 }, new String[] { "res", "room_info" }, new Object[] { null, null }, CmdUserQuitRoomRsp.class);
