  ...
  extends MessageMicro<CmdUserQuitRoomReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "from", "room_id", "client_type" }, new Object[] { localInteger, Long.valueOf(0L), localInteger }, CmdUserQuitRoomReq.class);
  }
}
