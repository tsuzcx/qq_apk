...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "from", "room_id", "client_type" }, new Object[] { Integer.valueOf(0), Long.valueOf(0L), Integer.valueOf(0) }, CmdUserEnterRoomReq.class);
