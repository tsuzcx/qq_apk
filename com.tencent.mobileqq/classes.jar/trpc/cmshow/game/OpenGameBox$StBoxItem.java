  ...
  extends MessageMicro<StBoxItem>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 34, 42, 50, 56, 64, 74 }, new String[] { "appid", "avatar", "name", "gamer_range", "background", "footer_icon", "ad_id", "box_type", "hall_jump_url" }, new Object[] { "", "", "", "", "", "", localInteger, localInteger, "" }, StBoxItem.class);
  }
}
