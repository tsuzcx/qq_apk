...
public class bcpn
{
  private static volatile bcpn a;
  
  public static bcpn a()
  {
    if (a == null) {}
    try
    {
  ...
  public TipsBar a(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    localTipsBar.setOriginalOnClickListener(new bcpo(this, paramContext, paramQQAppInterface));
    return localTipsBar;
  }
  ...
  protected void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    bcpq localbcpq = (bcpq)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.SECURITY_TOP_BAR);
    if (localbcpq == null)
    {
    ...
    paramString = new bcpp(this, l, localHashMap, paramQQAppInterface, paramString);
  ...
  protected void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      bdla.b(paramQQAppInterface, "dc00898", "", "", "0X800B186", "0X800B186", 0, 0, "", "", "", "");
