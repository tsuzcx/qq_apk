...
public class ausj
{
  private static ausl a = new ausl(null);
  ...
  public static void a()
  {
    try
    {
      ...
      JavaHookBridge.findAndHookMethod(localClass1, "setView", new Object[] { View.class, WindowManager.LayoutParams.class, View.class, new ausk(localClass1) });
    }
    catch (NoSuchMethodException localNoSuchMethodException1)
    {
      for (;;)
      {
        ...
        catch (ClassNotFoundException localClassNotFoundException2)
        {
          Class localClass1;
          Class localClass2;
          bftf.a(localClassNotFoundException2);
          return;
        }
        try
        {
        ...
        {
          bftf.a(localClassNotFoundException3);
          return;
        }
    ...
    catch (ClassNotFoundException localClassNotFoundException1)
    {
      for (;;)
      {
        bftf.a(localClassNotFoundException1);
      }
    }
    try
    {
