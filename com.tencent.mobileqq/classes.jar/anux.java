  ...
  extends anud
{
  ...
  protected anux(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(Map<Integer, Integer> paramMap)
  {
    ...
    SharedPreferences.Editor localEditor = aggu.a(this.a.getApplication().getApplicationContext(), this.a.getCurrentAccountUin(), 0).edit();
