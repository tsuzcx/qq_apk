...
public class lju
  ...
  implements ljr, lkd
{
  public static final String d = len.a() + 176 + File.separator;
  ...
  ljw jdField_a_of_type_Ljw = new ljw();
  private lke jdField_a_of_type_Lke;
  private lkh jdField_a_of_type_Lkh = new lkh();
  private llc jdField_a_of_type_Llc;
  private boolean jdField_a_of_type_Boolean;
  private ArrayList<ljv> b = new ArrayList();
  private String e;
  private String f;
  ...
  private MagicFaceDataEntity a(FaceItem paramFaceItem, String paramString, boolean paramBoolean, int paramInt)
  {
    ...
    {
      lek.c(this.jdField_a_of_type_JavaLangString, String.format("createMagicEntity: id=%s, senderType%s.", new Object[] { paramFaceItem.getId(), Integer.valueOf(paramInt) }));
      str1 = paramFaceItem.getId();
      str2 = paramFaceItem.getType();
      if (!"multi_result".equalsIgnoreCase(paramFaceItem.getAttr())) {
        break label100;
      }
      paramString = new lkb(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, str1, str2, paramString, paramBoolean, paramInt);
    }
    for (;;)
    {
      ...
      if ("huanlian".equalsIgnoreCase(paramFaceItem.getAttr())) {
        paramString = new mcn(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, str1, str2, paramString, paramBoolean, paramInt);
      } else {
  ...
  private MagicFaceDataEntity a(String paramString, boolean paramBoolean)
  {
    ...
    if (paramString != null)
    {
      ...
      this.jdField_a_of_type_Ljk.a(paramString, a(paramString), b(paramString), localArrayList, false);
      lek.e(this.jdField_a_of_type_JavaLangString, "prepareEntity FILE not exist: " + ((File)localObject).getPath());
    }
    return null;
  }
  
  private void a(long paramLong, MagicFaceDataEntity paramMagicFaceDataEntity, lke paramlke)
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicFaceDataEntity != null)
    {
      ...
      if (localFaceItem != null)
      {
        ...
        if (!TextUtils.isEmpty(str))
        {
          ...
          this.jdField_a_of_type_Lkh.a(paramLong, str, paramMagicFaceDataEntity, paramlke, this);
        }
      }
    }
  }
  ...
  private boolean a(long paramLong)
  {
    if (this.jdField_a_of_type_JavaUtilQueue.size() > 0)
    {
      ...
      a(paramLong, localMagicFaceDataEntity, this.jdField_a_of_type_Lke);
  ...
  private int b()
  {
    ...
    int i = localVideoController.b(locallid.d);
    if ((i == 2) || (i == 3) || (i == 4))
    {
      i = 1;
      if (i != 0) {
    ...
    do
    {
      ...
      i = 0;
      break;
      k = localVideoController.c(locallid.d);
  ...
  public int a(int paramInt, String paramString)
  {
    ...
    if (paramInt == 3)
    {
      ...
      if ((bool1) || (bool2)) {
        if ((!"0".equalsIgnoreCase(str2)) && (!"0_iOS".equalsIgnoreCase(str2)))
        {
          ...
          new mez(l, str2, false, 4).a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
    ...
    for (;;)
    {
      ...
      if ("STOP".equals(str1))
      {
        continue;
        if (paramInt == 1) {
          new mez(l, paramString, false, 4).a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
        }
      }
    }
  }
  ...
  public FaceItem a()
  {
    if ((this.jdField_a_of_type_Ljo != null) && (((FaceItem)this.jdField_a_of_type_Ljo).isSameType("creativecop"))) {
      return (FaceItem)this.jdField_a_of_type_Ljo;
    }
    return null;
  }
      ...
      else if (paramInt == 370)
      {
        if (((JSONObject)localObject1).has("blessingTips"))
        {
          ...
          while (i < localJSONArray.length())
          {
            ...
            ljv localljv = new ljv();
            localljv.jdField_a_of_type_JavaLangString = localJSONObject.optString("id");
            if (localJSONObject.has("start_date")) {
              localljv.jdField_a_of_type_Long = ((SimpleDateFormat)localObject2).parse(localJSONObject.optString("start_date")).getTime();
            }
            if (localJSONObject.has("end_date")) {
              localljv.jdField_b_of_type_Long = ((SimpleDateFormat)localObject2).parse(localJSONObject.optString("end_date")).getTime();
            }
            if (localJSONObject.has("text")) {
              localljv.jdField_b_of_type_JavaLangString = localJSONObject.getString("text");
            }
            if (localJSONObject.has("image_url")) {
              localljv.c = localJSONObject.getString("image_url");
            }
            if (localJSONObject.has("call_time_len")) {
              localljv.jdField_a_of_type_Int = localJSONObject.getInt("call_time_len");
            }
            if (localJSONObject.has("show_time_len")) {
              localljv.jdField_b_of_type_Int = localJSONObject.getInt("show_time_len");
            }
            this.b.add(localljv);
            QLog.w(this.jdField_a_of_type_JavaLangString, 1, "parseConfig, blessingTips[" + localljv + "]");
            i += 1;
          }
        }
        ...
        {
          this.jdField_a_of_type_Ljw.jdField_a_of_type_Int = ((JSONObject)localObject1).optInt("exposure_show_time_len", 5);
          this.jdField_a_of_type_Ljw.jdField_b_of_type_Int = ((JSONObject)localObject1).optInt("exposure_call_time", 2);
          this.jdField_a_of_type_Ljw.c = ((JSONObject)localObject1).optInt("click_call_time", 2);
          this.jdField_a_of_type_Ljw.d = ((JSONObject)localObject1).optInt("click_show_time_len", 5);
          this.jdField_a_of_type_Ljw.jdField_a_of_type_JavaLangString = ((JSONObject)localObject1).optString("exposure_show_text", this.jdField_a_of_type_Ljw.jdField_a_of_type_JavaLangString);
        }
      }
    }
  ...
  public ljw a()
  {
    return this.jdField_a_of_type_Ljw;
  }
  ...
  public void a()
  {
    ...
    if (localljq != null) {
      localljq.a(3003, this);
    }
    this.jdField_a_of_type_Llc = ((llc)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(5));
  }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (bool1)
      {
        ...
        this.f = null;
        a(l, null);
        if (this.jdField_a_of_type_Lkh.a()) {
          this.jdField_a_of_type_Lkh.b();
        }
      }
      return;
      bool1 = bool2;
  ...
  protected void a(long paramLong, int paramInt, String paramString1, String paramString2)
  {
    ...
    case 2: 
      ...
      new mfa(paramLong, "onSessionStatusChanged", 5, null).a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
      ljx.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, paramString1);
      ljx.a(2, paramString1);
      ljx.a(2);
      return;
    }
    a(paramLong, 6101, null, Boolean.valueOf(false));
  ...
  public void a(long paramLong, String paramString, int paramInt)
  {
    ...
    {
      bool2 = this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicFaceDataEntity.a((lkf)localObject);
      bool1 = bool2;
      if (bool2)
      {
        bool1 = bool2;
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      if (!bool1)
      {
        ...
        {
          ((lkt)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(2)).a(paramLong, this.e);
          a(paramLong, 6102, null, null);
          this.e = null;
        }
      }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      ljx.a(4, paramString2);
      ljx.a(4);
    } while (!this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(13));
    ((lkj)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(13)).a(l, "stopInteractiveVideo");
  }
  ...
  public boolean a(int paramInt, String paramString, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicFaceDataEntity != null)
    {
      ...
      {
        this.jdField_a_of_type_JavaUtilQueue.clear();
        lek.e(this.jdField_a_of_type_JavaLangString, "stop dequeue" + paramString);
        this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicFaceDataEntity = null;
        if (paramBoolean) {
          e(paramString);
        }
        ...
        {
          this.jdField_a_of_type_Lkh.b();
          lek.e(this.jdField_a_of_type_JavaLangString, "stop " + paramString + ", mStopType =" + paramInt);
        }
      }
    }
  ...
  public boolean a(long paramLong, FaceItem paramFaceItem)
  {
    ...
    for (;;)
    {
      ...
      if (i != 0) {
        mdd.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1010, i);
      }
      if (bool2)
      {
        this.jdField_a_of_type_AndroidOsHandler.obtainMessage(101, this.jdField_a_of_type_Ljo).sendToTarget();
        if (paramFaceItem != null)
        {
          ...
          if ((!paramFaceItem.equalsIgnoreCase("face")) && (!paramFaceItem.equalsIgnoreCase("voicesticker")))
          {
            ...
            if (localObject != null) {
              ((ljq)localObject).a(3003, paramFaceItem);
            }
          }
        }
      }
  ...
  public boolean a(long paramLong, FaceItem paramFaceItem, String paramString, boolean paramBoolean, lke paramlke)
  {
    boolean bool2 = true;
    if (AudioHelper.e()) {
      QLog.w(this.jdField_a_of_type_JavaLangString, 1, "start, id[" + paramString + "], curData[" + this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicFaceDataEntity + "], isSender[" + paramBoolean + "], queue[" + this.jdField_a_of_type_JavaUtilQueue.size() + "], isPlaying[" + this.jdField_a_of_type_Lkh.a() + "], mLastPendantId[" + this.e + "], seq[" + paramLong + "]");
    }
    boolean bool1;
    ...
    if (bool3)
    {
      ...
      if ((this.jdField_a_of_type_Lkh == null) || (!this.jdField_a_of_type_Lkh.a())) {
        break label461;
      }
      if (bool3) {
        break label547;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if ((paramFaceItem != null) || (bool3))
        {
          ...
          paramFaceItem = (lkt)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(2);
        ...
        for (;;)
        {
          QLog.w(this.jdField_a_of_type_JavaLangString, 1, "start, step[" + i + "], mLastPendantId[" + paramlke + "->" + this.e + "]");
          ...
          a(paramLong, (MagicFaceDataEntity)localObject, paramlke);
          paramFaceItem = (FaceItem)localObject;
          break label269;
          label499:
          i = 2;
