...
public class aaqh
  implements Runnable
{
  public aaqh(ArkAppModuleReg.ModuleQQ paramModuleQQ, String paramString1, String paramString2, String paramString3, long paramLong) {}
    ...
    do
    {
      do
      {
        do
        {
          ...
          ((QQCustomDialog)localObject2).setNegativeButton(2131433015, null);
          ((QQCustomDialog)localObject2).setPositiveButton(2131433016, null);
