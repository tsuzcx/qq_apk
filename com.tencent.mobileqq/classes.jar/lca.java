...
public class lca
  ...
  implements lby
{
  private bcbs jdField_a_of_type_Bcbs;
  ...
  public void a(String paramString, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Bcbs == null) {
        this.jdField_a_of_type_Bcbs = new bcbs(this.mRuntime.a());
      }
      if ("checkAioShareMusic".equals(paramString))
      {
        this.jdField_a_of_type_Bcbs.a(paramJSONObject);
        return;
      }
      if ("startListenAioShareMusic".equals(paramString))
      {
        this.jdField_a_of_type_Bcbs.b(paramJSONObject);
        return;
      }
      if ("updateSongIdToAioShareMusic".equals(paramString)) {
        try
        {
          ...
          this.jdField_a_of_type_Bcbs.a = paramString;
          if (QLog.isColorLevel())
          {
  ...
  public boolean handleEvent(String paramString, long paramLong, Map<String, Object> paramMap)
  {
    ...
    if (paramLong == 8589934594L)
    {
      if (!this.jdField_a_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_Bcbs.a(this.mRuntime.a().getIntent());
        return true;
      }
    }
    else if (paramLong == 8589934622L)
    {
      ...
      if ((localObject != null) && ((localObject instanceof Intent)))
      {
        ...
        this.jdField_a_of_type_Bcbs.b(paramString);
        return true;
      }
    }
  ...
  public void onDestroy()
  {
    ...
    if (this.jdField_a_of_type_Bcbs != null)
    {
      this.jdField_a_of_type_Bcbs.a();
      this.jdField_a_of_type_Bcbs = null;
    }
    lbw.a().a();
  }
}
