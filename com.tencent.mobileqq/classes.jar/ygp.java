  ...
  extends LinearLayout
{
  ...
  public ygp(Context paramContext, int paramInt1, int paramInt2, float paramFloat, View.OnClickListener paramOnClickListener)
  {
    super(paramContext);
  ...
  public void a(yge paramyge, int paramInt1, int paramInt2)
  {
    int i = paramInt1 * this.b;
    if (paramInt1 == paramInt2 - 1) {}
    for (paramInt1 = paramyge.b();; paramInt1 = this.b + i)
    {
      a(paramInt1 - i);
      paramInt2 = i;
      while (paramInt2 < paramInt1)
      {
        ...
        String str = paramyge.a(paramInt2);
        localImageView.setTag(2131378207, str);
        localImageView.setTag(2131378194, Integer.valueOf(paramInt2));
        localImageView.setContentDescription(amtj.a(2131706706) + paramInt2);
        ydf.a().a(getContext(), localImageView, str, this.d, this.d, null);
        paramInt2 += 1;
      }
    }
  }
