  ...
  extends MSFServlet
{
  private void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject4 = ((Appconf.AppConfResponse)localObject3).Wordings.get();
        ...
        localObject5 = (Appconf.Wording)((Iterator)localObject4).next();
        localArrayList.add(new FaceDetectForThirdPartyManager.AppWordings(((Appconf.Wording)localObject5).serviceType.get(), ((Appconf.Wording)localObject5).Text.get()));
        continue;
      ...
      label386:
      Object localObject4 = new ArrayList(3);
      Object localObject3 = ((Appconf.AppConfResponse)localObject3).protocols.get();
      if ((localObject3 != null) && (!((List)localObject3).isEmpty())) {
        localObject3 = ((List)localObject3).iterator();
      }
      while (((Iterator)localObject3).hasNext())
      {
        Object localObject6 = (Appconf.ServiceProtocol)((Iterator)localObject3).next();
        localObject5 = ((Appconf.ServiceProtocol)localObject6).name.get();
        localObject6 = ((Appconf.ServiceProtocol)localObject6).url.get();
        QLog.d("FaceDetectForThirdPartyServlet", 1, new Object[] { "handleFaceDetectResponse ServiceProtocol name=", localObject5, ", url=", localObject6 });
        if ((!TextUtils.isEmpty((CharSequence)localObject5)) && (!TextUtils.isEmpty((CharSequence)localObject6)))
        {
          ((List)localObject4).add(new FaceDetectForThirdPartyManager.ServiceProtocolSerializable((String)localObject5, (String)localObject6));
          continue;
          QLog.d("FaceDetectForThirdPartyServlet", 1, "handleFaceDetectResponse rspBody.protocols isEmpty");
        }
      }
      Object localObject2 = new FaceDetectForThirdPartyManager.AppConf((String)localObject2, localArrayList, i);
      ...
      ((FaceDetectForThirdPartyManager.AppConf)localObject2).serviceProtocols.addAll((Collection)localObject4);
  ...
  {
    if (aujs.c.contains(paramString1)) {
      a(paramString2, paramInt, paramString3, paramString4, paramString5, paramLong, paramBusinessObserver);
    }
    do
    {
      return;
      NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApplication(), autp.class);
  ...
  private static void a(String paramString1, int paramInt, String paramString2, String paramString3, String paramString4, long paramLong, BusinessObserver paramBusinessObserver)
  {
    ...
    bbon.a(paramString1, paramLong, Base64.encodeToString(localAppConfRequest.toByteArray(), 11), new autq(paramInt, paramBusinessObserver));
  }
