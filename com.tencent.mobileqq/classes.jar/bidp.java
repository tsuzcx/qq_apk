...
public final class bidp
{
    ...
    if (!jdField_a_of_type_Boolean) {
      try
      {
        if (!jdField_a_of_type_Boolean)
        {
          ...
          bidb.a(localBaseApplicationImpl, false);
          bieh.a(localBaseApplicationImpl);
  ...
  private static void a(Application paramApplication)
  {
    ...
    for (paramApplication = new File(bbvj.a(ajsd.aW));; paramApplication = paramApplication.getCacheDir())
    {
  ...
  public static void b()
  {
    if (jdField_a_of_type_Boolean) {
      try
      {
        if (jdField_a_of_type_Boolean)
        {
          bidb.a(false, BaseApplicationImpl.getApplication().getRuntime().getLongAccountUin());
