  ...
  implements View.OnClickListener
{
  ...
  public bazr(TribeVideoListPlayerFragment paramTribeVideoListPlayerFragment, View paramView)
  {
  ...
  {
    bbaa localbbaa = (bbaa)this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_a_of_type_Int);
    String str;
    ...
    case 2131366705: 
      ...
      do
      {
        do
        {
          ...
          str = "2";
          break;
          paramView = new ProfileActivity.AllInOne(String.valueOf(localbbaa.jdField_c_of_type_Long), 86);
          ...
          boolean bool = BaseApplicationImpl.getApplication().getRuntime().getAccount().equals(String.valueOf(localbbaa.jdField_c_of_type_Long));
          ...
          for (;;)
          {
            azmj.b(null, "dc00899", "Grp_tribe", "", "video_player", "Clk_poster", 0, 0, localbbaa.d, localbbaa.b + "", "", str);
            return;
        ...
        } while (localbbaa.jdField_c_of_type_Boolean);
        ...
        this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment.a(1, String.valueOf(localbbaa.jdField_c_of_type_Long), new bazs(this, localbbaa, str));
        return;
        ...
        for (paramView = "" + localbbaa.h;; paramView = "")
        {
          azmj.b(null, "dc00899", "Grp_tribe", "", "video_player", "Clk_comment", this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment.e, 0, localbbaa.d, localbbaa.b + "", paramView, str);
          return;
        ...
        for (;;)
        {
          azmj.b(null, "dc00899", "Grp_tribe", "", "video_player", "Clk_comment", this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment.e, 0, localbbaa.d, localbbaa.b + "", "", str);
          return;
        ...
        for (;;)
        {
          azmj.b(null, "dc00899", "Grp_tribe", "", "video_player", "Clk_share", 0, 0, localbbaa.d, localbbaa.b + "", "", str);
          return;
          if (TribeVideoListPlayerFragment.a(this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment).jdField_c_of_type_Boolean)
          {
            if (TribeVideoListPlayerFragment.a(this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment).jdField_a_of_type_ComTencentBizUiTouchWebView != null) {
      ...
      this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment.a(localbbaa.b, localbbaa.d, new bazt(this, localbbaa));
      azmj.b(null, "dc00899", "Grp_tribe", "", "video_player", "Clk_like", 0, 0, localbbaa.d, localbbaa.b + "", "", str);
      return;
    }
    ...
    paramView.putExtra("url", localbbaa.g);
    this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment.getActivity().startActivity(paramView);
    azmj.b(null, "dc00899", "Grp_tribe", "", "video_player", "Clk_detail", 0, 0, localbbaa.d, localbbaa.b + "", "", str);
  }
}
