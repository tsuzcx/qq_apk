...
public final class aefh
  implements bixa
{
  public aefh(aefo paramaefo, QQAppInterface paramQQAppInterface, String paramString, int paramInt, Activity paramActivity) {}
  ...
  public void a(Dialog paramDialog, View paramView, boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Aefo != null)
    {
      if (paramBoolean)
      {
        this.jdField_a_of_type_Aefo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0);
        this.jdField_a_of_type_Aefo.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0);
      }
      this.jdField_a_of_type_Aefo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1);
      this.jdField_a_of_type_Aefo.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1);
    }
    paramDialog = new StringBuilder();
    paramView = (aocm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(92);
    ...
    for (paramDialog = paramDialog.toString();; paramDialog = null)
    {
      if (i <= 0)
      {
        QQToast.a(BaseApplication.getContext(), 2, 2131691327, 1).a();
        if (this.jdField_a_of_type_Aefo != null) {
          this.jdField_a_of_type_Aefo.a(this.jdField_a_of_type_AndroidAppActivity);
        }
      }
      label356:
      do
      {
        ...
        for (;;)
        {
          anfz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "chat_history_c2c_start_del_msg");
          if (!paramBoolean) {
            break label442;
          }
          ...
          QQToast.a(BaseApplication.getContext(), 2131691324, 1).a();
          return;
        ...
        ((aocm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(92)).i();
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int);
        paramView.n();
      ...
      } while (this.jdField_a_of_type_Aefo == null);
      label405:
      label442:
      this.jdField_a_of_type_Aefo.a(this.jdField_a_of_type_AndroidAppActivity);
      return;
