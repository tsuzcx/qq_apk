...
public class ocs
  extends obj
{
  public ocs(Context paramContext, ArrayList<oji> paramArrayList, oat paramoat, String paramString1, String paramString2)
  {
  ...
  public static View a(Context paramContext, View paramView, ViewGroup paramViewGroup, ojh paramojh, int paramInt, oat paramoat, String paramString1, String paramString2)
  {
    ...
    if (paramojh.size() % 2 != 0)
    {
      paramojh.remove(paramojh.size() - 1);
    ...
    for (;;)
    {
      ...
      if ((paramViewGroup == null) || (!(paramViewGroup instanceof ocs)) || (!((ocs)paramViewGroup).a(paramojh))) {
        break label162;
      }
      paramContext = paramView;
      if (!QLog.isDevelopLevel()) {
    ...
    paramContext = new ocs(paramContext, paramojh, paramoat, paramString1, paramString2);
  ...
  private void a(LinearLayout paramLinearLayout)
  {
    ...
    if (i < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      for (;;)
      {
        localObject2 = (oji)this.jdField_a_of_type_JavaUtilArrayList.get(i);
        ...
        ((URLImageView)localObject1).setBackgroundDrawable(URLDrawable.getDrawable(((oji)localObject2).e, null, null, true));
        ...
        ((TextView)localObject1).setText(((oji)localObject2).a);
