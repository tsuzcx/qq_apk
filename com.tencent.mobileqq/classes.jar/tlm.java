...
public final class tlm
  extends tks
{
  public static final tln a = new tln(null);
  
  public tlm(@NotNull BridgeModule paramBridgeModule)
  {
  ...
  private final void a(JSONObject paramJSONObject, String paramString)
  {
    ...
    {
      ufd.a(paramJSONObject, str, (tiu)new tlp(this, paramString));
      return;
    }
  }
  ...
  private final void b(JSONObject paramJSONObject, String paramString)
  {
    ...
    try
    {
      for (;;)
      {
        paramJSONObject = new JSONObject().put("app_type", uhv.c()).toString();
  ...
  private final void c(JSONObject paramJSONObject, String paramString)
  {
    ...
    try
    {
      for (;;)
      {
        ReadInJoyUserInfoModule.a(Long.parseLong(paramJSONObject.opt("uin").toString()), (pwf)new tlo(str, this, paramString));
        return;
        label59:
    ...
    catch (Exception paramJSONObject)
    {
      ...
      {
        QLog.e("PublicAccountNewBridgeInvokeHandler", 1, paramJSONObject.getMessage());
        a(str, ufd.a(paramJSONObject.getMessage()));
      }
    }
  }
  ...
  public void a()
  {
    a("showReadInJoyNativeCommentView", (Function2)new PublicAccountNewBridgeInvokeHandler.register.1((tlm)this));
    a("getRIJAppType", (Function2)new PublicAccountNewBridgeInvokeHandler.register.2((tlm)this));
    a("getUserInfo", (Function2)new PublicAccountNewBridgeInvokeHandler.register.3((tlm)this));
  }
}
