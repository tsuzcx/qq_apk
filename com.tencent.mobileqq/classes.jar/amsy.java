...
public class amsy
{
  public static int a(String paramString)
  {
    try
    {
      int i = amsp.a("arsdk2", a(), amsp.b("arsdk2", a(), "arsdk2"), paramString);
      return i;
    }
    finally
    {
  ...
  public static int a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        amsp.a("arsdk2", a(), "arsdk2", paramString2);
        try
        {
          amsl.a(paramString1, amsp.a("arsdk2", a(), amsp.b("arsdk2", a(), "arsdk2")));
          paramString2 = amsp.a("arsdk2", a(), amsp.b("arsdk2", a(), "arsdk2")) + File.separator + "md5_config.xml";
        ...
        catch (IOException paramString2)
        {
          ...
          String str;
          i = -6;
          bdcs.a(amsp.a("arsdk2", a(), amsp.b("arsdk2", a(), "arsdk2")), false);
      ...
      try
      {
        paramString2 = a(bdcs.b((File)localObject));
        ...
        paramString1 = amsp.a("arsdk2", a(), amsp.b("arsdk2", a(), "arsdk2")) + File.separator + (String)((Map.Entry)localObject).getKey() + ".so";
        amsp.a("arsdk2", a(), "libAlphaAR", (String)((Map.Entry)localObject).getValue());
      }
      catch (IOException paramString2)
      {
      ...
      catch (OutOfMemoryError paramString2)
      {
        ...
        paramString1 = amsp.a("arsdk2", a(), amsp.b("arsdk2", a(), "arsdk2")) + File.separator + (String)((Map.Entry)localObject).getKey() + ".so";
        amsp.a("arsdk2", a(), "libYTCommon", (String)((Map.Entry)localObject).getValue());
        continue;
        if (!((String)((Map.Entry)localObject).getKey()).equalsIgnoreCase("AlphaAR_mqq_license")) {
          continue;
        }
        paramString1 = amsp.a("arsdk2", a(), amsp.b("arsdk2", a(), "arsdk2")) + File.separator + (String)((Map.Entry)localObject).getKey() + ".dat";
        amsp.a("arsdk2", a(), "AlphaAR_mqq_license", (String)((Map.Entry)localObject).getValue());
        continue;
  ...
  {
    File localFile1 = new File(amsp.a("arsdk2", a(), amsp.b("arsdk2", a(), "arsdk2")) + File.separator + "libYTCommon" + ".so");
    File localFile2 = new File(amsp.a("arsdk2", a(), amsp.b("arsdk2", a(), "arsdk2")) + File.separator + "libAlphaAR" + ".so");
    File localFile3 = new File(amsp.a("arsdk2", a(), amsp.b("arsdk2", a(), "arsdk2")) + File.separator + "AlphaAR_mqq_license" + ".dat");
  ...
  public static boolean a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        String str = amsp.a("arsdk2", a(), amsp.b("arsdk2", a(), "arsdk2")) + File.separator + paramString + ".so";
        ...
        if (((File)localObject).exists())
        {
          paramString = amsp.b("arsdk2", a(), paramString);
  ...
  {
    String str = amsp.a("arsdk2", a(), amsp.b("arsdk2", a(), "arsdk2")) + File.separator + "AlphaAR_mqq_license" + ".dat";
