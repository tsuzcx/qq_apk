...
public class birf
{
  private static birf jdField_a_of_type_Birf = new birf();
  private static final String jdField_a_of_type_JavaLangString = birf.class.getSimpleName();
  private Map<String, WeakReference<birh>> jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  private Map<String, MetaMaterial> b = new HashMap();
  
  public static birf a()
  {
    return jdField_a_of_type_Birf;
  }
  ...
  private void a(MetaMaterial paramMetaMaterial)
  {
    if (this.jdField_a_of_type_JavaUtilMap.containsKey(paramMetaMaterial.id))
    {
      ...
      if (localObject != null)
      {
        localObject = (birh)((WeakReference)localObject).get();
        if (localObject != null) {
          ((birh)localObject).a(paramMetaMaterial);
        }
      }
    }
  }
  ...
  private void a(MetaMaterial paramMetaMaterial, int paramInt)
  {
    if (this.jdField_a_of_type_JavaUtilMap.containsKey(paramMetaMaterial.id))
    {
      ...
      if (localObject != null)
      {
        localObject = (birh)((WeakReference)localObject).get();
        if (localObject != null) {
          ((birh)localObject).a(paramMetaMaterial, paramInt);
        }
      }
    }
  }
  ...
  {
    return new File(biiu.e, paramMetaMaterial.id).getAbsolutePath();
  }
  
  public void a(AppInterface paramAppInterface, MetaMaterial paramMetaMaterial, birh parambirh)
  {
    if ((paramMetaMaterial == null) || (TextUtils.isEmpty(paramMetaMaterial.id)))
    {
      if (parambirh != null) {
        parambirh.b(paramMetaMaterial);
      }
      return;
    }
    this.jdField_a_of_type_JavaUtilMap.put(paramMetaMaterial.id, new WeakReference(parambirh));
  ...
  public boolean a(MetaMaterial paramMetaMaterial)
  {
    ...
    //   14: iconst_0
    //   15: ireturn
    //   16: getstatic 127	biiu:d	Ljava/lang/String;
    //   19: astore_2
    ...
    //   44: invokestatic 140	bbdx:c	(Ljava/lang/String;)Ljava/lang/String;
    //   47: astore_3
    //   48: aload_3
    ...
    //   73: getstatic 80	biiu:e	Ljava/lang/String;
    ...
    //   162: getstatic 80	biiu:e	Ljava/lang/String;
    ...
    //   177: invokestatic 171	nav:a	(Ljava/io/File;Ljava/lang/String;)V
    //   180: iconst_1
    //   181: ireturn
    //   182: astore_1
