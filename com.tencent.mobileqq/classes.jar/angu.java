  ...
  extends BaseAdapter
{
  ...
  protected List<anjy> a;
  protected Map<Integer, ArrayList<View>> a;
  public int b;
  protected List<anjy> b;
  protected int c;
  protected List<anjy> c;
  public int d;
  protected int e;
  ...
  public angu(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, anhs paramanhs)
  {
    ...
    this.e = paramContext.getResources().getColor(2131100784);
    this.jdField_a_of_type_Float = paramContext.getResources().getDisplayMetrics().density;
  }
  
  public abstract View a(angv paramangv, int paramInt, View paramView, ViewGroup paramViewGroup);
  ...
  public RelativeLayout a()
  {
    ...
    try
    {
      ...
      if (localObject1 != null)
      {
        ...
        ((TextView)localObject1).setId(2131300008);
      ...
      ((URLImageView)localObject1).setId(2131300003);
      ...
      localLayoutParams.addRule(2, 2131300008);
      ...
      ((ImageView)localObject1).setId(2131300009);
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localObject != null) && (((ArrayList)localObject).size() > 0))
        {
          ...
          while (i < ((ArrayList)localObject).size())
          {
            ...
            Integer localInteger = (Integer)localView.getTag(2131300032);
            if (ankg.jdField_a_of_type_Int == localInteger.intValue()) {
              ankg.a().a(j, localView);
            }
            i += 1;
          }
        }
  ...
  public void a(int paramInt, View paramView)
  {
    ...
    do
    {
      ...
      paramView.setTag(2131300032, Integer.valueOf(this.d));
  ...
  public void a(View paramView, anjy paramanjy)
  {
    if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      paramanjy = (URLImageView)paramView.findViewById(2131300003);
      long l = System.currentTimeMillis();
      localObject2 = ((anht)localObject1).a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Float);
      if (QLog.isColorLevel()) {
        QLog.d(jdField_a_of_type_JavaLangString, 2, "getDrawable cost = " + (System.currentTimeMillis() - l));
      }
      paramanjy.setImageDrawable((Drawable)localObject2);
      paramanjy.setVisibility(0);
    } while (!(localObject1 instanceof anla));
    paramanjy = (anla)localObject1;
    Object localObject1 = (TextView)paramView.findViewById(2131300008);
    if (paramanjy.a != null)
    {
      localObject2 = paramanjy.a.name;
  ...
  {
    if (paramView == null) {}
    for (angv localangv = a();; localangv = (angv)paramView.getTag()) {
      return a(localangv, paramInt, paramView, paramViewGroup);
    }
  }
}
