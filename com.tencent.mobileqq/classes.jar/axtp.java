...
{
  private static axtp jdField_a_of_type_Axtp;
  private ConcurrentLinkedQueue<axtr> jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue;
  ...
  public static axtp a()
  {
    if (jdField_a_of_type_Axtp != null) {
      return jdField_a_of_type_Axtp;
    }
    try
    {
      if (jdField_a_of_type_Axtp == null) {
        jdField_a_of_type_Axtp = new axtp();
      }
      axtp localaxtp = jdField_a_of_type_Axtp;
      return localaxtp;
    }
    finally {}
  }
  ...
  public static void a(Context paramContext, MonitorHttpInfo paramMonitorHttpInfo, boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    if (paramBoolean)
    {
      axrn.a(paramContext).a(null, "MonitorApkDownload", true, 0L, 0L, localHashMap, "");
      label231:
      if (!QLog.isColorLevel()) {
        break label348;
      }
    ...
    for (paramContext = "MonitorApkDownload{";; paramContext = "UnMonitorApkDownload{")
    {
      ...
      axrn.a(paramContext).a(null, "UnMonitorApkDownload", true, 0L, 0L, localHashMap, "");
      break label231;
      break;
    }
  ...
  private void b(MonitorHttpInfo paramMonitorHttpInfo, String paramString1, String paramString2)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue != null)
    {
      ...
      while (i < m)
      {
        ...
        if ((localObject instanceof axtr))
        {
          localObject = (axtr)localObject;
          int k = 0;
          try
          {
            j = a(str, ((axtr)localObject).a());
            if (QLog.isColorLevel()) {
              QLog.d("NetworkMonitor", 2, new Object[] { "url=", str, " bean's url=", ((axtr)localObject).a(), " lcs length=", Integer.valueOf(j) });
            }
            if (j < 10) {
              break label258;
            }
  ...
  public void a(String paramString)
  {
    ...
    axtr localaxtr = new axtr(this, paramString);
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.add(localaxtr);
    if (QLog.isColorLevel()) {
    ...
    {
      paramString = (axtr)this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.peek();
      if ((paramString == null) || (paramString.a - localaxtr.a <= 600000L)) {
        break;
      }
  ...
  public void addDownloadURL(String paramString)
  {
    ...
    if (1 != BaseApplicationImpl.sProcessId)
    {
      ...
      QIPCClientHelper.getInstance().callServer("NetworkMonitorIPCModule", "ACTION_REPORT_DOWNLOAD_URL", localBundle, new axtq(this));
      return;
    }
    a(paramString);
  }
