...
{
  bgob(String paramString1, int paramInt, String paramString2) {}
  
  protected Void a(Void... paramVarArgs)
  {
    paramVarArgs = bgrj.a(ServerConfigManager.ConfigType.common, bgoa.p());
    ...
    for (;;)
    {
      try
      {
        ...
        l1 = bgoa.a();
        paramVarArgs = bgrj.a(ServerConfigManager.ConfigType.common, bgoa.q());
    ...
    if ((l2 != 0L) && (SystemClock.uptimeMillis() >= l2))
    {
      ...
      localHashMap.put("param_DeviceType", String.valueOf(akgm.a()));
      paramVarArgs = null;
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      localHashMap.put("param_NetType", String.valueOf(bgnt.a(BaseApplication.getContext())));
      if (i != 0)
      {
        paramVarArgs = this.jdField_a_of_type_JavaLangString;
        bctj.a(BaseApplication.getContext()).a(bgrj.a(), paramVarArgs, bgoa.a(this.jdField_a_of_type_JavaLangString), this.jdField_a_of_type_Int, 0L, localHashMap, bgoa.o());
        if (i == 0) {
          break label631;
        }
