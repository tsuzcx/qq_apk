  ...
  extends Dialog
{
  ...
  private HashMap<CharSequence, bgoa> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private HashSet<Integer> jdField_a_of_type_JavaUtilHashSet;
  public boolean a;
  private int jdField_b_of_type_Int = 300;
  private View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new bgoe(this);
  private CharSequence jdField_b_of_type_JavaLangCharSequence;
  private HashMap<Integer, Drawable> jdField_b_of_type_JavaUtilHashMap = new HashMap();
  protected boolean b;
  private View.OnClickListener jdField_c_of_type_AndroidViewView$OnClickListener = new bgof(this);
  ...
  protected bgob(Context paramContext, boolean paramBoolean1, boolean paramBoolean2)
  {
    this(paramContext, paramBoolean1, paramBoolean2, true);
  }
  
  @TargetApi(14)
  protected bgob(Context paramContext, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131559334, null));
  ...
  public static bgob a(Context paramContext)
  {
    paramContext = new bgob(paramContext, false, false);
  ...
  private void a(TextView paramTextView, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      paramTextView.setContentDescription(getContext().getString(2131694329) + paramTextView.getText());
      return;
    }
    paramTextView.setContentDescription(getContext().getString(2131694330) + paramTextView.getText());
  }
  ...
  private void b()
  {
    ...
    {
      localObject1 = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131559337, null);
      ((View)localObject1).setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130840809));
      ((View)localObject1).setOnClickListener(new bgoc(this));
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if (this.jdField_a_of_type_JavaUtilArrayList != null)
      {
        ...
        if (i < k)
        {
          localObject2 = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131559336, null);
          ...
          bgkg.a(localTextView, Button.class.getName());
          if ((this.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_JavaUtilHashMap.size() > 0))
          {
            localObject3 = (bgoa)this.jdField_a_of_type_JavaUtilHashMap.get(((Pair)localObject1).first);
            if ((localObject3 != null) && (((bgoa)localObject3).jdField_a_of_type_Int != 0)) {
              localTextView.setId(((bgoa)localObject3).jdField_a_of_type_Int);
            }
          }
  ...
  public Drawable a(int paramInt)
  {
    ...
    case 2: 
    default: 
      return this.jdField_a_of_type_AndroidContentResResources.getDrawable(2130840808);
    case 0: 
      return this.jdField_a_of_type_AndroidContentResResources.getDrawable(2130840805);
    case 3: 
      return this.jdField_a_of_type_AndroidContentResResources.getDrawable(2130840808);
    }
    return this.jdField_a_of_type_AndroidContentResResources.getDrawable(2130840812);
  }
  ...
  public void a(bgog parambgog)
  {
    this.jdField_a_of_type_Bgog = parambgog;
  }
  
  public void a(bgoi parambgoi)
  {
