  ...
  extends bkea
{
  ...
  bkeb jdField_a_of_type_Bkeb = null;
  ...
  public bkdz(TraeAudioManager paramTraeAudioManager)
  {
  ...
  void a(Context paramContext, Intent paramIntent)
  {
    ...
    do
    {
      do
      {
        this.jdField_a_of_type_Bkeb.a("DEVICE_BLUETOOTHHEADSET", true);
        do
        {
          return;
        } while (k != 0);
        this.jdField_a_of_type_Bkeb.a("DEVICE_BLUETOOTHHEADSET", false);
        return;
  ...
  public boolean a(Context paramContext, bkeb parambkeb)
  {
    ...
    this.jdField_a_of_type_Bkeb = parambkeb;
    if ((this.jdField_a_of_type_AndroidContentContext == null) || (this.jdField_a_of_type_Bkeb == null)) {}
    for (;;)
    {
      return false;
      try
      ...
      catch (Exception parambkeb)
      {
        ...
        catch (Exception parambkeb)
        {
          ...
          catch (NoSuchMethodException parambkeb)
          {
            try
            {
              do
              {
                for (;;)
                {
                  ...
                  this.jdField_a_of_type_Bkeb.a("DEVICE_BLUETOOTHHEADSET", a());
                  if (!a()) {
                    break label337;
                  }
                  this.jdField_a_of_type_Bkeb.a("DEVICE_BLUETOOTHHEADSET", true);
                  ...
                  if (QLog.isColorLevel())
                  {
                    ...
                    parambkeb = parambkeb;
                    if (QLog.isColorLevel()) {
                      QLog.e("TraeAudioManager", 2, "BTLooperThread BluetoothHeadset.ServiceListener class not found:" + parambkeb);
                    }
                  }
                }
                parambkeb = parambkeb;
