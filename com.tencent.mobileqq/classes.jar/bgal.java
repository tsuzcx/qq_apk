...
{
  public int a;
  private LinkedHashMap<String, List<ajvr>> jdField_a_of_type_JavaUtilLinkedHashMap = new LinkedHashMap();
  ...
  public bgal(List<ajvr> paramList)
  {
    this.jdField_a_of_type_JavaUtilList = paramList;
    this.jdField_c_of_type_JavaUtilList = new ArrayList();
  }
  
  private bgam a(QQAppInterface paramQQAppInterface, TroopInfo paramTroopInfo, String paramString, bgam parambgam, boolean paramBoolean)
  {
    if (((bfzz.a(paramQQAppInterface, paramTroopInfo)) || (bfzz.b(paramQQAppInterface, paramTroopInfo))) && (!paramBoolean))
    {
      paramQQAppInterface = bgak.a();
      if ((TextUtils.isEmpty(paramString)) || (bgak.a(paramString, paramQQAppInterface))) {
        parambgam.jdField_a_of_type_JavaUtilList.add(0, paramQQAppInterface);
      }
    }
    return parambgam;
  }
  
  private bgam a(String paramString, boolean paramBoolean, TroopInfo paramTroopInfo)
  {
  ...
  private List<ajvr> a(LinkedHashMap<String, List<ajvr>> paramLinkedHashMap)
  {
  ...
  private Object[] a(String paramString, TroopInfo paramTroopInfo)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((localajvr.jdField_a_of_type_Boolean) || ((!TextUtils.isEmpty(paramString)) && (bfzz.a(localajvr.jdField_a_of_type_JavaLangString, paramTroopInfo)))) {
          break label664;
        }
        if ((TextUtils.isEmpty(paramString)) || (!bfzz.b(localajvr.jdField_a_of_type_JavaLangString, paramTroopInfo))) {
          break label228;
        }
      }
      finally {}
      ...
      ((List)localLinkedHashMap.get(localObject2)).add(localajvr);
      continue;
      label228:
      localObject1 = localajvr.x;
      if ((localObject1 == null) || (((String)localObject1).length() == 0)) {
        break label688;
      }
      localObject1 = ((String)localObject1).substring(0, 1);
    }
    paramTroopInfo = new bgad(paramTroopInfo);
  ...
  public bgam a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean1, SessionInfo paramSessionInfo, boolean paramBoolean2)
  {
    TroopInfo localTroopInfo = null;
    if (paramSessionInfo != null)
    {
      paramSessionInfo = paramSessionInfo.curFriendUin;
      localTroopInfo = ((TroopManager)paramQQAppInterface.getManager(QQManagerFactory.TROOP_MANAGER)).b(paramSessionInfo);
    }
    if (TextUtils.isEmpty(paramString)) {}
    for (this.jdField_b_of_type_JavaUtilList = bgak.a(paramQQAppInterface, this.jdField_a_of_type_JavaUtilList, paramBoolean1);; this.jdField_b_of_type_JavaUtilList = new ArrayList(bgak.a(paramString, bgak.a(paramQQAppInterface, this.jdField_a_of_type_JavaUtilList, paramBoolean1), paramQQAppInterface, localTroopInfo))) {
