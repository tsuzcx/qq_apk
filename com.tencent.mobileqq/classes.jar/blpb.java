  ...
  implements babv, bnug
{
  ...
  private bljy jdField_a_of_type_Bljy = (bljy)this.mPartManager.a(65537, new Object[0]);
  private bloc jdField_a_of_type_Bloc;
  private blou jdField_a_of_type_Blou = new blox();
  ...
  private AtomicReference<babv> jdField_a_of_type_JavaUtilConcurrentAtomicAtomicReference = new AtomicReference();
  ...
  public blpb(Activity paramActivity, View paramView, bmas parambmas)
  {
  ...
  private void a(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      this.jdField_b_of_type_AndroidWidgetTextView.setText(amtj.a(2131715429) + paramString + amtj.a(2131715428));
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidViewView.postDelayed(new VideoStoryAIScenePart.9(this), 2500L);
      localAlphaAnimation1.setAnimationListener(new blpd(this, localAlphaAnimation2));
      localAlphaAnimation2.setAnimationListener(new blpe(this));
      return;
      label423:
      paramString = null;
    }
  ...
  private void a(AEMaterialPanel paramAEMaterialPanel)
  {
    ...
    if ((this.jdField_a_of_type_AndroidViewView != null) && (this.jdField_b_of_type_AndroidWidgetTextView != null) && (this.jdField_a_of_type_AndroidWidgetTextView != null) && ((this.jdField_a_of_type_AndroidViewView.getVisibility() == 0) || (this.jdField_a_of_type_AndroidWidgetTextView.getVisibility() == 0) || (this.jdField_a_of_type_AndroidViewView.getVisibility() == 0) || (this.jdField_b_of_type_AndroidWidgetTextView.getVisibility() == 0)))
    {
      ...
      this.jdField_a_of_type_AndroidViewView.post(new VideoStoryAIScenePart.19(this, paramAEMaterialPanel, i));
    }
  }
  ...
  private void a(AEVideoStoryTopBarViewModel.Ratio paramRatio)
  {
    ...
    if (paramRatio == AEVideoStoryTopBarViewModel.Ratio.R_1_1)
    {
      ...
      localLayoutParams.addRule(6, 2131364156);
    ...
    for (;;)
    {
      if (i == 0)
      {
        ...
        i = -bnnl.a(this.mActivity, f1 / 2.0F);
        continue;
        label215:
        if (paramRatio != AEVideoStoryTopBarViewModel.Ratio.FULL) {
          continue;
  ...
  private void a(AtomicReference<babv> paramAtomicReference, AEFilterManager paramAEFilterManager)
  {
    if (paramAtomicReference.get() == null) {
      ayde.a("Q.videostory", "Q.videostory.capture", "requestAIScene()", "sceneCallback is null");
    }
    do
    {
      do
      {
        do
        {
          do
          {
            ...
            ((babv)paramAtomicReference.get()).a("mQQFilterRenderManager is null");
            return;
            ayde.a("Q.videostory", "Q.videostory.capture", "requestAIScene()", "start");
        ...
        if (localObject2 != null)
        {
          ...
          while (((Iterator)localObject2).hasNext())
          {
            ...
            localObject3 = new blov();
            ((blov)localObject3).jdField_b_of_type_Int = ((int)(f3 - f4));
            ((blov)localObject3).jdField_a_of_type_Int = ((int)(f1 - f2));
        ...
        try
        {
          ...
          this.jdField_a_of_type_Blou.a((Bitmap)localObject2, (ArrayList)localObject1, new blpf(this, paramAtomicReference));
          return;
        }
        catch (Exception paramAEFilterManager) {}
      } while ((babv)paramAtomicReference.get() == null);
      ((babv)paramAtomicReference.get()).a(paramAEFilterManager.toString());
      return;
    } while ((babv)paramAtomicReference.get() == null);
    ((babv)paramAtomicReference.get()).a("no bitmap");
  }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      zxp.a("mystatus_shoot", "cam_reverse", 0, 0, new String[0]);
      return;
      label85:
      if (!paramBoolean)
      {
  ...
  private void e()
  {
    ((blkr)blks.a(this.jdField_a_of_type_Bljy).get(blkr.class)).b.observe(this.jdField_a_of_type_Bljy, new blph(this));
    ((bmap)blks.a(this.jdField_a_of_type_Bljy).get(bmap.class)).a.observe(this.jdField_a_of_type_Bljy, new blpi(this));
    if (this.jdField_d_of_type_Boolean) {
      ((AEVideoStoryTopBarViewModel)blks.a(this.jdField_a_of_type_Bljy).get(AEVideoStoryTopBarViewModel.class)).a.observe(this.jdField_a_of_type_Bljy, new blpj(this));
    }
  }
  
  private void f()
  {
    if (bmbk.a().a("ai_guide_shown", false, 0)) {}
  ...
  private void h()
  {
    if ((this.jdField_a_of_type_Bljy.a() != null) && (this.jdField_d_of_type_Boolean))
    {
    ...
    if ((this.jdField_a_of_type_AndroidViewView != null) && (this.jdField_b_of_type_AndroidWidgetTextView != null) && (this.jdField_a_of_type_AndroidWidgetTextView != null)) {
      this.jdField_a_of_type_AndroidViewView.post(new VideoStoryAIScenePart.21(this));
    }
  }
  
  public void a()
  {
    this.jdField_a_of_type_AndroidWidgetTextView.setText(amtj.a(2131715409));
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    a();
    if (this.jdField_a_of_type_AndroidViewAnimationAnimationSet != null) {
  ...
  public void a(int paramInt, QIMFilterCategoryItem paramQIMFilterCategoryItem)
  {
    ...
    if (paramQIMFilterCategoryItem != null)
    {
      ...
      ayde.a("Q.videostory", "Q.videostory.capture", "onFilterSelect", str);
      if (paramInt != 0) {
        a(null);
      }
    ...
    for (;;)
    {
      ...
      zxp.a("mystatus_shoot", "filter_change", 0, 0, new String[0]);
      return;
      str = "no filter";
      break;
      label102:
  ...
  public void a(int paramInt, String paramString, boolean paramBoolean)
  {
    if ((this.jdField_a_of_type_AndroidWidgetTextView != null) && (this.jdField_a_of_type_AndroidWidgetTextView.getVisibility() == 0) && (!this.jdField_a_of_type_Boolean) && (!this.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()))
    {
      ...
      localAnimationSet.setAnimationListener(new blpk(this, paramBoolean, paramInt, paramString));
    }
  }
  
  public void a(babv parambabv)
  {
    this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicReference.set(parambabv);
  }
  ...
  public void a(blpa paramblpa)
  {
    ...
    if ((paramblpa.jdField_a_of_type_Int == -1) || ((this.jdField_a_of_type_Bljy != null) && (!this.jdField_a_of_type_Bljy.l())))
    {
      b();
      return;
    }
    Object localObject2 = paramblpa.b;
    Object localObject1 = bnub.a().c(0);
    Bundle localBundle;
    bmrr localbmrr;
    if (localObject1 != null)
    {
      ...
      ayde.a("Q.videostory", "Q.videostory.capture", "onAISceneSuccess", (String)localObject2 + " " + (String)localObject1);
      localBundle = new Bundle();
      localBundle.putInt("apply_source", bmrr.jdField_a_of_type_Int);
      ...
      paramblpa = new ArrayList();
      b();
    }
    for (;;)
    {
      ayde.a("Q.videostory", "Q.videostory.capture", "onAISceneSuccess", "filterLister is empty:" + paramblpa.size());
      return;
      localObject1 = "";
      break;
      label243:
      localObject1 = localbmrr.a().c;
      ...
      while (((Iterator)localObject3).hasNext())
      {
        ...
        if (localQIMFilterCategoryItem.b.equals(localObject2))
        {
          ...
          ((Bundle)localObject3).putString("sceneName", paramblpa.jdField_a_of_type_JavaLangString);
          ((Bundle)localObject3).putInt("sceneLvOne", paramblpa.jdField_a_of_type_Int);
          ...
          for (;;)
          {
            ...
            this.mRootView.postDelayed(new VideoStoryAIScenePart.14(this, localQIMFilterCategoryItem, localBundle, localbmrr), 500L);
            paramblpa = (blpa)localObject1;
            break;
          }
          label419:
          b();
  ...
  public void a(String paramString)
  {
    ...
    ayde.a("Q.videostory", "Q.videostory.capture", "onAISceneFail", paramString);
  }
  ...
  protected void initView()
  {
    ...
    this.jdField_a_of_type_AndroidViewView = this.mRootView.findViewById(2131362323);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.mRootView.findViewById(2131362327));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.mRootView.findViewById(2131362326));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.mRootView.findViewById(2131362324));
    this.jdField_b_of_type_AndroidViewView = this.mRootView.findViewById(2131362325);
    ...
    a(this);
    this.jdField_a_of_type_DovComQqImAeCameraCoreAECameraGLSurfaceView.setSceneListener(new blpc(this));
    this.jdField_a_of_type_AndroidOsHandler = new blpg(this, Looper.getMainLooper());
    d();
    e();
  }
