  ...
  implements asbx
{
  ...
  public String a()
  {
    ...
    if (this.jdField_a_of_type_Ascl.jdField_a_of_type_ArrayOfJavaLangString == null)
    {
      this.jdField_a_of_type_Boolean = true;
      return this.jdField_a_of_type_Ascl.jdField_a_of_type_JavaLangString;
    }
    int i = this.jdField_a_of_type_Int + 1;
    if (i >= this.jdField_a_of_type_Ascl.jdField_a_of_type_ArrayOfJavaLangString.length)
    {
      ascl localascl = this.jdField_a_of_type_Ascl;
      localascl.jdField_a_of_type_Int -= 1;
      if (this.jdField_a_of_type_Ascl.jdField_a_of_type_Int <= 0)
      {
        this.jdField_a_of_type_Boolean = true;
        return this.jdField_a_of_type_Ascl.jdField_a_of_type_JavaLangString;
      }
      ...
      return this.jdField_a_of_type_Ascl.jdField_a_of_type_ArrayOfJavaLangString[(i + 1)];
    }
    return this.jdField_a_of_type_Ascl.jdField_a_of_type_ArrayOfJavaLangString[i];
  }
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Ascl == null) {
  ...
  public void a(Message paramMessage)
  {
    ...
    if (this.jdField_a_of_type_Ascl.jdField_a_of_type_Asby != null) {
      this.jdField_a_of_type_Ascl.jdField_a_of_type_Asby.a((Bitmap)paramMessage.obj);
    }
    this.jdField_a_of_type_Int += 1;
    ThreadManager.post(this.jdField_a_of_type_JavaLangRunnable, 5, null, true);
  }
  
  public void a(ascl paramascl)
  {
    this.jdField_a_of_type_Ascl = paramascl;
  }
  
  public void a(String paramString)
  {
    if (this.jdField_a_of_type_Ascl != null) {
      this.jdField_a_of_type_Ascl.jdField_a_of_type_JavaLangString = paramString;
    }
  }
