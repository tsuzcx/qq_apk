  ...
  extends aoxv
{
  ...
  private azva jdField_a_of_type_Azva = new aoxz(this);
  ...
  private aoxy(aowx paramaowx, String paramString1, String paramString2)
  {
    super(paramaowx);
  ...
  void a(String paramString, int paramInt)
  {
    ...
    azuw.a().a(this.jdField_a_of_type_JavaUtilUUID, null);
  }
  ...
  void a(String paramString, int paramInt, aoxt paramaoxt)
  {
    ...
    this.jdField_a_of_type_Aoxt = paramaoxt;
    ...
    azuw.a().a(this.jdField_a_of_type_JavaUtilUUID, this.jdField_b_of_type_Long, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Azva);
  }
}
