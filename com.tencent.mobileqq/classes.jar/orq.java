...
public class orq
{
  ...
  {
    long l = ((Long)bnrf.a("family_comment_card_hide_timestamp", Long.valueOf(-1L))).longValue();
    if (l == -1L)
    {
  ...
  public ReadInJoyCommentListFragment a(String paramString, osf paramosf, oru paramoru)
  {
    ...
    try
    {
      ...
      localReadInJoyCommentListFragment.a(paramosf);
      localReadInJoyCommentListFragment.a(paramoru);
