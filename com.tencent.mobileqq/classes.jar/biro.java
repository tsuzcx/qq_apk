...
{
  public biro(ProfileCardNewPhotoWallView paramProfileCardNewPhotoWallView, ProfilePhotoWall paramProfilePhotoWall, int paramInt) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqDataProfilePhotoWall instanceof NowShowVideoInfo))
    {
      ...
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqWidgetProfileCardNewPhotoWallView.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "NOW", "", "qq_zlk", "replay_click", 0, 0, this.jdField_a_of_type_ComTencentMobileqqWidgetProfileCardNewPhotoWallView.jdField_a_of_type_JavaLangString, "", "", "");
    }
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqWidgetProfileCardNewPhotoWallView.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin().equals(this.jdField_a_of_type_ComTencentMobileqqWidgetProfileCardNewPhotoWallView.jdField_a_of_type_JavaLangString)) {
        bdla.b(this.jdField_a_of_type_ComTencentMobileqqWidgetProfileCardNewPhotoWallView.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006A80", "0X8006A80", 0, 0, "", "", "", "");
      } else {
        bdla.b(this.jdField_a_of_type_ComTencentMobileqqWidgetProfileCardNewPhotoWallView.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006A94", "0X8006A94", 0, 0, "", "", "", "");
      }
    }
  }
}
