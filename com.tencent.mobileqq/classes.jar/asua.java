  ...
  implements Comparator<ChatMessage>
{
  ...
  private static asua jdField_a_of_type_Asua;
  public static final String a;
  private static byte[] jdField_a_of_type_ArrayOfByte = new byte[0];
  public int a;
  private bfnj<Integer> jdField_a_of_type_Bfnj;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajsd.aW + "fight/pic_expire.png";
  }
  ...
  {
    if (jdField_a_of_type_Asua == null) {}
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      if (jdField_a_of_type_Asua == null) {
        jdField_a_of_type_Asua = new asua();
      }
      return jdField_a_of_type_Asua;
    }
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      bbdx.a(paramQQAppInterface.getApp(), 2130841056, jdField_a_of_type_JavaLangString);
      paramQQAppInterface = bbdx.c(jdField_a_of_type_JavaLangString);
      paramQQAppInterface = ayoi.d("chatthumb:" + paramQQAppInterface);
      bbdx.d(jdField_a_of_type_JavaLangString, paramQQAppInterface);
    }
  ...
  private void a(long paramLong, int paramInt)
  {
    ...
    //   42: aload_0
    //   43: getfield 159	asua:jdField_a_of_type_Bfnj	Lbfnj;
    //   46: ifnull +40 -> 86
    //   49: aload_0
    //   50: getfield 159	asua:jdField_a_of_type_Bfnj	Lbfnj;
    //   53: lload_1
    //   54: iconst_0
    //   55: invokestatic 165	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   58: invokevirtual 170	bfnj:a	(JLjava/lang/Object;)Ljava/lang/Object;
    ...
    //   71: ifeq +18 -> 89
    //   74: aload_0
    //   75: getfield 159	asua:jdField_a_of_type_Bfnj	Lbfnj;
    //   78: lload_1
    //   79: iload_3
    //   80: invokestatic 165	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   83: invokevirtual 177	bfnj:a	(JLjava/lang/Object;)V
    //   86: aload_0
    //   87: monitorexit
    //   88: return
    //   89: aload_0
    //   90: getfield 159	asua:jdField_a_of_type_Bfnj	Lbfnj;
    //   93: lload_1
    //   94: invokevirtual 180	bfnj:b	(J)V
    //   97: goto -11 -> 86
    //   100: astore 4
    //   102: aload_0
    //   103: monitorexit
  ...
  private void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, MessageRecord paramMessageRecord, ArrayList<MessageRecord> paramArrayList, int paramInt2, @Nullable Bundle paramBundle)
  {
    ...
    localaywc.jdField_b_of_type_JavaLangString = paramQQAppInterface.getAccount();
    localaywc.c = paramString;
    localaywc.jdField_a_of_type_Int = paramInt1;
    localaywc.jdField_b_of_type_Int = 2;
    localaywc.jdField_a_of_type_Long = ((MessageRecord)paramArrayList.get(0)).uniseq;
    ...
    {
      localaywc.n = k;
      localaywc.jdField_a_of_type_ComTencentMobileqqDataMessageRecord = ((MessageRecord)paramArrayList.get(0));
      localMessageForPtt.mInputContent = "";
      localaywc.jdField_a_of_type_Auoq = new asuf(paramMessageRecord, paramArrayList, paramQQAppInterface, paramString, paramInt1, paramInt2, this, null);
  ...
  private void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, akat paramakat, ArrayList<MessageRecord> paramArrayList, boolean paramBoolean, int paramInt2)
  {
    ...
    paramakat = paramQQAppInterface.a().a().a(paramArrayList, paramHashMap, paramBoolean);
    if (paramakat == null)
    {
    ...
    do
    {
      ...
      if (paramInt2 == 0) {
        paramHashMap = new asue(paramQQAppInterface, paramMessageRecord, paramString, paramInt1);
      }
      for (;;)
      {
        if (a(paramQQAppInterface, paramakat, paramQQAppInterface.getCurrentAccountUin(), paramString, paramString, paramInt1, paramMessageRecord.uniseq, 1035, paramHashMap))
        {
          if (!QLog.isColorLevel()) {
            break;
          }
          ...
          if (paramInt2 == 2)
          {
            paramHashMap = new asud(paramQQAppInterface, paramMessageRecord, paramString, paramInt1, paramArrayList, paramHashMap);
          }
          else if (paramInt2 == 5)
          {
            paramHashMap = new avph(paramQQAppInterface, paramMessageRecord, paramString, paramInt1);
          }
          else
          {
  ...
  private void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, ArrayList<MessageRecord> paramArrayList, ArrayList<aunp> paramArrayList1, int paramInt2)
  {
    aunv localaunv = aunl.a(8, 7);
    localaunv.a(paramArrayList1);
    localaunv.a(new asub(this, paramInt2, paramMessageRecord, paramArrayList, paramQQAppInterface, paramString, paramInt1, paramHashMap));
    aunl.a(localaunv, paramQQAppInterface);
  }
  
  private void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, ArrayList<MessageRecord> paramArrayList, ArrayList<axdv> paramArrayList1, axei paramaxei, int paramInt2)
  {
    ...
    localaxei.a(new asuc(this, paramArrayList, paramMessageRecord, paramQQAppInterface, paramString, paramInt1, paramHashMap, paramInt2));
    axdq.a(localaxei, paramQQAppInterface);
  }
  ...
  private boolean a(long paramLong)
  {
    for (;;)
    {
      try
      {
        ...
        boolean bool1;
        if (((Integer)this.jdField_a_of_type_Bfnj.a(paramLong, Integer.valueOf(0))).intValue() == 0)
        {
          bool1 = true;
          bool2 = bool1;
          if (QLog.isColorLevel())
  ...
  public MessageForStructing a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt, String paramString2, AbsStructMsg paramAbsStructMsg)
  {
    ...
    paramQQAppInterface = axas.a(paramQQAppInterface, paramString2, paramString1, paramString2, paramInt, 0L, paramAbsStructMsg);
  ...
  public List<ChatMessage> a(QQAppInterface paramQQAppInterface, long paramLong, String paramString, int paramInt)
  {
    ...
    if (paramString != null) {
      akpx.a(paramString, paramInt, (List)localObject, paramQQAppInterface);
    }
    ...
    while (paramString.hasNext())
    {
      ...
      if ((localObject instanceof MessageForStructing))
      {
        ...
        if (localMessageForStructing.structingMsg == null) {
          localMessageForStructing.structingMsg = axva.a(((MessageRecord)localObject).msgData);
        }
      }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (paramQQAppInterface != null)
    {
      ...
      k = bbkb.a(paramQQAppInterface.c(), "multimsg_config");
      if (k > 0) {
    ...
    catch (NumberFormatException paramQQAppInterface)
    {
      try
      {
        ...
        if (!TextUtils.isEmpty(paramQQAppInterface))
        {
          ...
          if (DeviceProfileManager.a(paramQQAppInterface, (Object[])localObject, new ajve()) >= localObject.length)
          {
  ...
  public void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, ArrayList<ChatMessage> paramArrayList, int paramInt)
  {
    ...
    ((awap)paramQQAppInterface.getManager(326)).a(paramSessionInfo.jdField_a_of_type_JavaLangString, paramArrayList);
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt1, String paramString2, AbsStructMsg paramAbsStructMsg, long paramLong, boolean paramBoolean, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      break;
      if (k != 0) {
        axqy.b(paramQQAppInterface, "CliOper", "", "", "0X800662C", "0X800662C", 0, 1, 0, "", "", "", "");
      }
      ArrayList localArrayList = new ArrayList();
      ...
      if (paramInt2 == 2)
      {
        ...
        k = awyn.jdField_a_of_type_Int;
        awyn.jdField_a_of_type_Int = k + 1;
        localObject1 = axas.a(paramQQAppInterface, (String)localObject1, paramString1, (String)localObject1, 1040, k, paramAbsStructMsg);
        ((MessageRecord)localObject1).msg = aanz.a(localArrayList, (Map)localObject2);
      }
      for (;;)
      {
        ...
        if (localObject1 == null)
        {
          ...
          localObject3 = bbjx.a(paramQQAppInterface, paramString1, paramInt1, paramAbsStructMsg);
        }
        if (localObject3 == null) {
          break;
        }
        ((MessageRecord)localObject3).isReMultiMsg = true;
        adgc.a().a(((MessageRecord)localObject3).uniseq, 0L, paramInt3);
        if (paramBoolean) {
        ...
        if ((paramInt2 == 0) || (paramInt2 == 2))
        {
          ...
          ((asug)localObject1).jdField_a_of_type_Int = 0;
          ((asug)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo = ((SessionInfo)localObject4);
          ((asug)localObject1).jdField_a_of_type_JavaUtilList = localArrayList;
          ((asug)localObject1).jdField_a_of_type_JavaUtilMap = ((Map)localObject2);
          ((asug)localObject1).jdField_b_of_type_Int = paramInt2;
          ((asug)localObject1).jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg = paramAbsStructMsg;
          ((asug)localObject1).jdField_a_of_type_ComTencentMobileqqDataMessageForStructing = ((MessageForStructing)localObject3);
          paramQQAppInterface.a().e((asug)localObject1);
          if (!QLog.isColorLevel()) {
            break;
          }
  ...
  public void a(QQAppInterface paramQQAppInterface, List<ChatMessage> paramList, boolean paramBoolean)
  {
    ...
    for (int k = 0;; k = 1)
    {
      ...
      axrn.a(BaseApplication.getContext()).a(paramQQAppInterface.getCurrentAccountUin(), "multiMsgReceive", paramBoolean, 0L, 0L, localHashMap, "");
      return;
    }
    axrn.a(BaseApplication.getContext()).a(paramQQAppInterface.getCurrentAccountUin(), "multiMsgReceive", paramBoolean, 0L, 0L, localHashMap, "");
  }
  ...
  public void a(MessageForStructing paramMessageForStructing, QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      {
        return;
      } while ((this.h != 0) && (auns.a(paramQQAppInterface, paramMessageForStructing.istroop, paramMessageForStructing.frienduin) == 1));
  ...
  public void a(HashMap<String, String> paramHashMap, long paramLong, QQAppInterface paramQQAppInterface)
  {
    ...
    //   111: goto -81 -> 30
    //   114: aload 4
    //   116: invokevirtual 554	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Laukq;
    //   119: invokevirtual 560	aukq:createEntityManager	()Laukp;
    //   122: astore 4
    //   124: aload 4
    //   126: invokevirtual 961	aukp:a	()Laukr;
    //   129: astore_1
    //   130: aload_1
    //   131: invokevirtual 965	aukr:a	()V
    //   134: aload 5
    ...
    //   163: invokevirtual 968	aukp:b	(Lauko;)V
    //   166: goto -25 -> 141
    //   169: astore 5
    //   171: aload 5
    //   173: invokevirtual 971	java/lang/Exception:printStackTrace	()V
    //   176: aload_1
    //   177: invokevirtual 972	aukr:b	()V
    //   180: aload 4
    //   182: invokevirtual 973	aukp:a	()V
    //   185: return
    //   186: aload_1
    //   187: invokevirtual 975	aukr:c	()V
    //   190: aload_1
    //   191: invokevirtual 972	aukr:b	()V
    //   194: goto -14 -> 180
    //   197: astore 4
    //   199: aload_1
    //   200: invokevirtual 972	aukr:b	()V
    //   203: aload 4
    //   205: athrow
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  {
    axqy.b(paramQQAppInterface, "CliOper", "", "", "0X8006628", "0X8006628", 0, 1, 0, "", "", "", "");
    return a(paramQQAppInterface, paramLong).size() > 0;
  }
  
  public boolean a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt1, long paramLong, int paramInt2, auna paramauna)
  {
    ...
    localaywc.jdField_b_of_type_Int = 131078;
    localaywc.jdField_l_of_type_JavaLangString = paramString1;
    localaywc.jdField_b_of_type_JavaLangString = paramString2;
    localaywc.c = paramString3;
    localaywc.d = paramString4;
    localaywc.jdField_a_of_type_Int = paramInt1;
    localaywc.jdField_a_of_type_Long = paramLong;
    localaywc.jdField_e_of_type_Int = paramInt2;
  ...
  {
    if ((paramList != null) && (paramList.size() > 0)) {
      Collections.sort(paramList, jdField_a_of_type_Asua);
    }
  }
  ...
  public boolean b(QQAppInterface paramQQAppInterface, long paramLong)
  {
    ...
    if ((paramQQAppInterface != null) && (paramQQAppInterface.size() > 0))
    {
      ...
      if (localIterator1.hasNext())
      {
        ...
        for (;;)
        {
          if ((paramQQAppInterface != null) && (!aywm.a(null, paramQQAppInterface, 65537)))
          {
            if (QLog.isColorLevel()) {
        ...
        for (paramQQAppInterface = (MessageForPic)paramQQAppInterface;; paramQQAppInterface = (QQAppInterface)localObject)
        {
          ...
          for (;;)
          {
            ...
            if ((paramQQAppInterface != null) && ((paramQQAppInterface instanceof StructMsgForImageShare)))
            {
              ...
              if ((localObject != null) && (((axwv)localObject).jdField_a_of_type_ComTencentMobileqqDataMessageForPic == null))
              {
                if (((axwv)localObject).jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForImageShare == null) {
                  ((axwv)localObject).jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForImageShare = ((StructMsgForImageShare)paramQQAppInterface);
                }
                ((axwv)localObject).jdField_a_of_type_ComTencentMobileqqDataMessageForPic = ((axwv)localObject).a();
                paramQQAppInterface = ((axwv)localObject).jdField_a_of_type_ComTencentMobileqqDataMessageForPic;
                break label99;
              }
            }
  ...
  public int c()
  {
    ...
    {
      break;
      m = asuh.a(localChatMessage);
      break label64;
      asuh.b("checkMap.size = %d,count= %d", new Object[] { Integer.valueOf(this.jdField_a_of_type_JavaUtilHashMap.size()), Integer.valueOf(k) });
      return k;
    }
  }
}
