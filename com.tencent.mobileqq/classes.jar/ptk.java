...
public class ptk
{
  private static volatile ptk jdField_a_of_type_Ptk;
  private HashMap<Integer, WeakReference<slt>> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private ptl jdField_a_of_type_Ptl = new ptl(this, 1);
  ...
  public static ptk a()
  {
    if (jdField_a_of_type_Ptk == null) {}
    try
    {
      if (jdField_a_of_type_Ptk == null) {
        jdField_a_of_type_Ptk = new ptk();
      }
      return jdField_a_of_type_Ptk;
    }
    finally {}
  }
  ...
  {
    twp.a("AdDataLink", "on async data refresh , channelID  : " + paramInt);
    Object localObject = (WeakReference)this.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(paramInt));
    if (localObject == null) {}
    do
    {
      return;
      localObject = (slt)((WeakReference)localObject).get();
    } while ((localObject == null) || (((slt)localObject).isEmpty()));
    ThreadManager.getUIHandler().post(new ReadinjoyFixPosArticleManager.1(this, (slt)localObject, paramInt));
  }
  
  public ArticleInfo a(int paramInt, long paramLong)
  {
    return (ArticleInfo)this.jdField_a_of_type_Ptl.a(paramInt, a(paramLong));
  }
  ...
  public List<BaseArticleInfo> a(int paramInt1, List<BaseArticleInfo> paramList1, List<BaseArticleInfo> paramList2, int paramInt2)
  {
    ...
    this.jdField_a_of_type_Ptl.a(paramInt1);
    if (!this.jdField_a_of_type_Ptl.a(paramInt1))
    {
    ...
    if (paramInt2 == 2)
    {
      ...
      if (paramInt2 < paramList2.size())
      {
        ...
        for (;;)
        {
          ...
          i = a(l);
          j = paramInt2 - i;
          localArrayList1 = (ArrayList)this.jdField_a_of_type_Ptl.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(paramInt1));
          localArrayList2 = (ArrayList)this.jdField_a_of_type_Ptl.b.get(Integer.valueOf(paramInt1));
    ...
    paramList2 = (ArrayList)this.jdField_a_of_type_Ptl.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(paramInt1));
    ArrayList localArrayList1 = (ArrayList)this.jdField_a_of_type_Ptl.b.get(Integer.valueOf(paramInt1));
    Object localObject = (ArrayList)this.jdField_a_of_type_Ptl.c.get(Integer.valueOf(paramInt1));
    ...
    if (paramInt2 < i)
    {
      ...
      if (paramList1.size() + paramList2.size() < j + 1) {
        twp.a("ReadinjoyFixPosArticleManager", "expect insert into " + j + ", but article size is not enougharticle size:" + paramList1.size() + " sp size: " + paramList2.size());
      }
      for (;;)
      {
        paramInt2 += 1;
        ...
        else
        {
          ...
          localObject = pkm.a().a(paramInt1, l);
          if (localObject != null) {
  ...
  public void a(int paramInt)
  {
    ...
    this.jdField_a_of_type_Ptl.c(paramInt);
  }
  ...
  public void a(int paramInt, long paramLong)
  {
    ...
    int i = a(paramLong);
    this.jdField_a_of_type_Ptl.a(paramInt, i);
  }
  
  public void a(int paramInt, slt paramslt)
  {
    if (paramslt == null) {
      return;
    }
    this.jdField_a_of_type_JavaUtilHashMap.put(Integer.valueOf(paramInt), new WeakReference(paramslt));
    this.jdField_a_of_type_Ptl.c(paramInt);
  }
  ...
  public void b(int paramInt)
  {
    ...
    this.jdField_a_of_type_Ptl.d(paramInt);
  }
}
