  ...
  extends BaseShortVideoOprerator
{
  ...
  public zqg(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
  }
  
  private void b(azae paramazae)
  {
    ThreadManager.getSubThreadHandler().post(new DevShortVideoOperator.1(this, paramazae));
  }
  ...
  public int a()
  {
    ...
    //   12: aconst_null
    //   13: aload_0
    //   14: getfield 47	zqg:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   147: putfield 80	zqg:jdField_b_of_type_Int	I
    //   150: aload_0
    //   151: aload 9
    //   153: invokevirtual 83	android/graphics/Bitmap:getHeight	()I
    //   156: putfield 85	zqg:jdField_c_of_type_Int	I
    //   159: new 87	java/io/File
    //   162: dup
    //   163: aload_0
    //   164: getfield 47	zqg:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   167: invokespecial 90	java/io/File:<init>	(Ljava/lang/String;)V
    //   170: astore_2
    //   171: aload_0
    //   172: aload_2
    //   173: invokevirtual 94	java/io/File:length	()J
    //   176: putfield 96	zqg:jdField_a_of_type_Long	J
    ...
    //   189: aload_3
    //   190: aload_0
    //   191: getfield 96	zqg:jdField_a_of_type_Long	J
    ...
    //   200: putfield 115	zqg:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   203: aload_0
    //   204: getfield 115	zqg:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   234: aload_0
    //   235: getfield 115	zqg:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   281: ireturn
    //   282: aload_0
    //   283: getfield 115	zqg:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   286: ldc 139
    ...
    //   314: invokestatic 150	bdcs:c	(Ljava/lang/String;)V
    ...
    //   433: putfield 186	zqg:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   436: aload_0
    //   437: getfield 186	zqg:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   467: aload_0
    //   468: getfield 186	zqg:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   511: aload_0
    //   512: aload_0
    //   513: getfield 186	zqg:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   516: ldc 139
    ...
    //   521: putfield 191	zqg:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    //   524: aload 8
    //   526: aload_0
    //   527: getfield 191	zqg:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    //   530: invokestatic 194	bdcs:c	(Ljava/lang/String;Ljava/lang/String;)Z
    //   533: istore_1
    //   534: iload_1
    //   535: ifne +34 -> 569
    //   538: aload_3
    ...
    //   568: ireturn
    //   569: aload_0
    //   570: getfield 196	zqg:jdField_b_of_type_Long	J
    //   573: lconst_0
    //   574: lcmp
    //   575: ifne +14 -> 589
    //   578: aload_0
    //   579: aload_0
    //   580: getfield 47	zqg:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   583: invokestatic 199	com/tencent/mobileqq/shortvideo/ShortVideoUtils:a	(Ljava/lang/String;)J
    //   586: putfield 196	zqg:jdField_b_of_type_Long	J
    //   589: aload_3
    //   590: ifnull +7 -> 597
    //   593: aload_3
    ...
    //   291	803	8	localObject21	Object
    //   81	312	9	localBitmap2	android.graphics.Bitmap
    //   326	97	10	localFile2	java.io.File
    // Exception table:
    //   from	to	target	type
  ...
  public azae a(Object paramObject, ayzo paramayzo)
  {
    ...
    {
      a();
      localObject = new azae();
      ((azae)localObject).jdField_c_of_type_JavaLangString = this.jdField_b_of_type_JavaLangString;
      ((azae)localObject).h = this.jdField_a_of_type_JavaLangString;
      ((azae)localObject).j = this.jdField_d_of_type_JavaLangString;
      ((azae)localObject).jdField_b_of_type_Int = this.jdField_a_of_type_Int;
      ((azae)localObject).jdField_d_of_type_JavaLangString = "";
      ((azae)localObject).jdField_e_of_type_Int = ((int)this.jdField_a_of_type_Long);
      ((azae)localObject).f = ((int)this.jdField_b_of_type_Long / 1000);
      ((azae)localObject).jdField_e_of_type_JavaLangString = this.jdField_c_of_type_JavaLangString;
      ((azae)localObject).jdField_c_of_type_Int = this.jdField_b_of_type_Int;
      ((azae)localObject).jdField_d_of_type_Int = this.jdField_c_of_type_Int;
      ((azae)localObject).jdField_g_of_type_Int = paramayzo.jdField_a_of_type_Int;
      ((azae)localObject).jdField_a_of_type_JavaLangObject = paramObject;
      ((azae)localObject).jdField_g_of_type_JavaLangString = this.jdField_e_of_type_JavaLangString;
      ((azae)localObject).l = "";
  ...
  public MessageRecord a(azae paramazae)
  {
    ...
    MessageForDevShortVideo localMessageForDevShortVideo = (MessageForDevShortVideo)ayvw.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramazae.jdField_c_of_type_JavaLangString, paramazae.jdField_d_of_type_JavaLangString, paramazae.jdField_b_of_type_Int);
    localMessageForDevShortVideo.videoFileName = paramazae.h;
    if (paramazae.jdField_a_of_type_JavaLangString == null) {
      paramazae.jdField_a_of_type_JavaLangString = "";
    }
    localMessageForDevShortVideo.uuid = paramazae.jdField_a_of_type_JavaLangString;
    if (paramazae.jdField_e_of_type_JavaLangString == null) {
      paramazae.jdField_e_of_type_JavaLangString = "";
    }
    localMessageForDevShortVideo.md5 = paramazae.jdField_e_of_type_JavaLangString;
    localMessageForDevShortVideo.videoFileFormat = 2;
    localMessageForDevShortVideo.videoFileSize = paramazae.jdField_e_of_type_Int;
    localMessageForDevShortVideo.videoFileTime = paramazae.f;
    localMessageForDevShortVideo.thumbWidth = paramazae.jdField_c_of_type_Int;
    localMessageForDevShortVideo.thumbHeight = paramazae.jdField_d_of_type_Int;
    ...
    localMessageForDevShortVideo.thumbMD5 = paramazae.jdField_g_of_type_JavaLangString;
    localMessageForDevShortVideo.extraflag = 32772;
    if (paramazae.l == null) {
      paramazae.l = "";
    }
    localMessageForDevShortVideo.fileSource = paramazae.l;
    ...
    if (i != 0)
    {
      localMessageForDevShortVideo.msgseq = paramazae.jdField_a_of_type_Azaf.jdField_a_of_type_Long;
      localMessageForDevShortVideo.shmsgseq = paramazae.jdField_a_of_type_Azaf.jdField_b_of_type_Long;
      localMessageForDevShortVideo.msgUid = paramazae.jdField_a_of_type_Azaf.c;
    }
    localMessageForDevShortVideo.msg = localMessageForDevShortVideo.getSummary();
    localMessageForDevShortVideo.serial();
    paramazae.jdField_a_of_type_Long = localMessageForDevShortVideo.uniseq;
    awen.a(this.jdField_g_of_type_JavaLangString, this.f, "packmsg", "cost:" + (System.currentTimeMillis() - l));
    awen.a(this.jdField_g_of_type_JavaLangString, this.f, "packMsg", "mr: " + localMessageForDevShortVideo.toLogString() + "-" + localMessageForDevShortVideo.toString());
    return localMessageForDevShortVideo;
  }
  
  public MessageRecord a(im_msg_body.RichText paramRichText)
  {
    awen.a(this.jdField_g_of_type_JavaLangString, this.f, "attachRichText2Msg", "");
  ...
  {
    awen.a(this.jdField_g_of_type_JavaLangString, this.f, "updateMsg", "resut:" + paramawfz);
    if (paramawfz != null)
    {
