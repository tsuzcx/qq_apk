  ...
  extends ltl
{
  ...
  void a(String paramString)
  {
    ...
    if ((1 == this.jdField_a_of_type_Int) && (this.jdField_a_of_type_OrgJsonJSONObject != null))
    {
      ...
      this.c = bhml.a(this.jdField_a_of_type_OrgJsonJSONObject.optString("peer_ennick", null));
      this.d = bhml.a(this.jdField_a_of_type_OrgJsonJSONObject.optString("ensessionname", null));
    ...
    {
      return;
      this.jdField_b_of_type_JavaLangString = ChatActivityUtils.a(RandomWebProtocol.a(), bhml.a(this.jdField_a_of_type_OrgJsonJSONObject.optString("peer_enuin", null)));
      this.jdField_a_of_type_ArrayOfByte = bhml.a(this.jdField_a_of_type_OrgJsonJSONObject.optString("vaskey", null));
      return;
    }
