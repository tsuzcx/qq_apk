  ...
  implements mnu
{
  ...
  private boolean d()
  {
    ...
    DownloadInfo localDownloadInfo = lzp.a().a();
    if (localDownloadInfo == null)
    {
      QLog.i("AVVoiceRecog", 1, "initRecognizer. init failed. downloadInfo == null.");
      return false;
    }
    String str1 = lzw.b() + localDownloadInfo.filename_so_wxvoiceembedqqegg;
    String str2 = lzw.a() + localDownloadInfo.filename_model_wxvoiceembed;
    if (!lzp.a().a())
    {
      lzp.a().b();
  ...
  public boolean c()
  {
    ...
    if (!b())
    {
      ...
      String str = lzw.b() + ((DownloadInfo)localObject).filename_so_wxvoiceembedqqegg;
      localObject = lzw.a() + ((DownloadInfo)localObject).filename_model_wxvoiceembed;
      if (!lzp.a().a())
      {
        lzp.a().b();
