...
public final class allc
  implements alcw, alcx, alcy, TVK_SDKMgr.InstallListener
{
  ...
  public allc(Activity paramActivity, aldg paramaldg)
  {
    this.jdField_a_of_type_Aldg = paramaldg;
  ...
  private void j()
  {
    ...
    while ((this.jdField_b_of_type_Boolean) || (this.jdField_d_of_type_Boolean) || (this.jdField_a_of_type_Alld == null)) {
      return;
    }
  ...
  private void k()
  {
    ...
    if (this.jdField_a_of_type_Alld != null) {
      this.jdField_a_of_type_Alld.a(k / 2);
    }
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_Alle != null) {
        this.jdField_a_of_type_Alle.a((this.jdField_c_of_type_Int + this.jdField_d_of_type_Int) / 2);
      }
      return;
  ...
  public void a(long paramLong, alld paramalld, alle paramalle)
  {
    if (paramLong == 0L) {
      return;
    }
  ...
  public void a(ARCommonConfigInfo paramARCommonConfigInfo)
  {
    ...
    try
    {
      ...
      TVK_SDKMgr.setOnLogListener(new alli());
      if (this.jdField_a_of_type_Allf != null) {
        this.jdField_a_of_type_Allf.a(paramARCommonConfigInfo);
      }
      this.i = true;
      return;
    }
  ...
  public void c(int paramInt)
  {
    ...
    try
    {
      this.jdField_a_of_type_Aldg.b(paramInt);
      return;
    }
    catch (Exception localException)
    {
  ...
  public void e()
  {
    ...
    a(this.jdField_a_of_type_Long, this.jdField_a_of_type_Alld, this.jdField_a_of_type_Alle);
  }
  ...
  public void f()
  {
    ...
    this.jdField_a_of_type_Alle = null;
  }
  ...
  public void g()
  {
    try
    {
      this.jdField_a_of_type_Boolean = this.jdField_a_of_type_Aldg.b();
      if (!this.jdField_a_of_type_Boolean)
      {
        this.jdField_b_of_type_Boolean = true;
        this.jdField_a_of_type_Aldg.c();
      }
      for (;;)
      {
  ...
  public void i()
  {
    ...
    {
      this.h = true;
      this.jdField_a_of_type_Aldg.a(1);
      this.e = alco.a();
      if (this.e) {
        break label156;
      }
      this.g = true;
      this.jdField_a_of_type_Aldg.a(0);
  ...
  public void j_(int paramInt)
  {
    ...
    for (;;)
    {
      if ((this.e) && (this.f) && (this.jdField_a_of_type_Alle != null)) {
        this.jdField_a_of_type_Alle.a();
      }
      return;
      this.e = true;
      this.g = false;
