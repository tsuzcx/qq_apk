  ...
  implements aaim
{
  ...
  private bkqy jdField_a_of_type_Bkqy;
  ...
  public aadj(Bundle paramBundle)
  {
    super(paramBundle);
  ...
  {
    this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView = ((VideoPlayerView)paramView.findViewById(2131381067));
    this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131370087);
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131369689);
    ...
    this.jdField_a_of_type_Bkqy = new bkqy(getActivity(), new aadq(this, null));
  ...
  {
    if (bgsp.a(paramStFeed.video.fileId.get())) {
      QLog.w(jdField_a_of_type_JavaLangString, 1, "video fileId is empty");
    }
    do
    {
      return;
      if (bgsp.a(paramStFeed.video.playUrl.get()))
      {
  ...
  private void n()
  {
    this.jdField_c_of_type_AndroidWidgetImageView.setOnClickListener(new aadk(this));
    this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView.setPreviewVideoClickListener(new aadl(this));
    this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView.setNextVideoClickListener(new aadm(this));
    if (a() != null) {
      a().a(new aadn(this));
    }
    getParentRecyclerView().addOnItemTouchListener(new aado(this));
    this.jdField_a_of_type_ComTencentBizSubscribeWidgetSubscribeFollowInfoView.setOnTouchListener(new aadp(this));
  }
  ...
  public aacp a()
  {
    return (aacp)getBlockMerger().a("RELATIVE_ADAPTER_UNIQUE_KEY");
  }
  ...
  protected void a(CertifiedAccountRead.StGetFeedDetailRsp paramStGetFeedDetailRsp, boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView != null) && (paramStGetFeedDetailRsp != null) && (aaae.a(paramStGetFeedDetailRsp.type.get())))
    {
  ...
  public void d(CertifiedAccountMeta.StFeed paramStFeed)
  {
    ...
    do
    {
      do
      {
        ...
        aaxb.a(paramStFeed.poster.id.get(), "auth_" + aakz.a(getExtraTypeInfo()), "clk_recom", 0, 0, new String[] { "", "", paramStFeed.id.get(), paramStFeed.title.get() });
      ...
      setShareData("share_key_subscribe_feeds_update", new zxs(paramStFeed, true));
  ...
  {
    if (("share_key_continue_feeds".equals(paramString)) && (paramzxs != null) && (this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView != null)) {
      this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView.setContinueFeeds((List)paramzxs.a);
    }
  }
  ...
  public void onInitBlock(Bundle paramBundle)
  {
    ...
    if ((!bcnj.b()) && (this.jdField_a_of_type_ComTencentWidgetImmersiveSystemBarCompact != null)) {
    ...
    this.jdField_a_of_type_ComTencentBizSubscribeWidgetSubscribeFollowInfoView = ((SubscribeFollowInfoView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131370024));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131369046));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131369269));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131369330));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131369113));
    if (getActivity() != null)
    {
      bqcd.a(getActivity());
      bqcd.c(getActivity());
