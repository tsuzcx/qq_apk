  ...
  public void a(String paramString)
  {
    ...
    try
    {
      ...
      if (((File)localObject1).exists())
      {
        ...
        Object localObject4 = bdcs.c(paramString);
        ...
        if (QLog.isColorLevel()) {
          QLog.d(zbj.jdField_a_of_type_JavaLangString, 2, "queryImage, ret=" + ((Pair)localObject1).first + ",cost=" + l1 + ",url=" + (String)((Pair)localObject1).second);
        }
        ...
        bfdq.a().a((Bundle)localObject2, "", str2, false);
        m = 1;
        ...
        paramString.putString("intext_3", "" + bfdw.b(this.a.a.jdField_a_of_type_Int));
        paramString.putString("intext_2", "" + j);
        paramString.putString("stringext_1", this.a.a.jdField_a_of_type_JavaLangString);
        bfdq.a().a(paramString, "", this.a.a.this$0.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount(), false);
        if (QLog.isColorLevel()) {
          QLog.e("shareWebPage", 2, "WebView screenshot END. thumb=" + this.a.a.this$0.i);
        }
        zbj.a(this.a.a.this$0, this.a.a.jdField_a_of_type_JavaLangString, this.a.a.jdField_a_of_type_Int, this.a.a.jdField_a_of_type_Boolean);
      }
    }
    catch (OutOfMemoryError localOutOfMemoryError)
    {
      ...
      for (;;)
      {
        ...
        if (QLog.isColorLevel())
        {
          ...
          paramString.putString("stringext_1", this.a.a.jdField_a_of_type_JavaLangString);
          bfdq.a().a(paramString, "", str2, false);
          ...
          for (;;)
          {
            ...
            if (QLog.isColorLevel())
            {
              QLog.d(zbj.jdField_a_of_type_JavaLangString, 2, paramString.getMessage());
              i = j;
              k = m;
              continue;
              i = 1;
