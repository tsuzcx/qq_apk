...
public class zbk
{
  ...
  public zbk(String paramString, boolean paramBoolean)
  {
  ...
  private BufferedInputStream a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 30	zbk:jdField_a_of_type_JavaIoBufferedInputStream	Ljava/io/BufferedInputStream;
    //   6: ifnonnull +54 -> 60
    //   9: aload_0
    //   10: getfield 32	zbk:jdField_a_of_type_JavaNetURLConnection	Ljava/net/URLConnection;
    //   13: astore_1
    //   14: aload_1
    //   15: ifnull +45 -> 60
    //   18: aload_0
    //   19: getfield 32	zbk:jdField_a_of_type_JavaNetURLConnection	Ljava/net/URLConnection;
    //   22: invokevirtual 38	java/net/URLConnection:getInputStream	()Ljava/io/InputStream;
    //   25: astore_1
    //   26: ldc 40
    //   28: aload_0
    //   29: getfield 32	zbk:jdField_a_of_type_JavaNetURLConnection	Ljava/net/URLConnection;
    ...
    //   57: putfield 30	zbk:jdField_a_of_type_JavaIoBufferedInputStream	Ljava/io/BufferedInputStream;
    //   60: aload_0
    //   61: getfield 30	zbk:jdField_a_of_type_JavaIoBufferedInputStream	Ljava/io/BufferedInputStream;
    //   64: astore_1
    //   65: aload_0
    //   66: monitorexit
    //   67: aload_1
    ...
    //   78: putfield 30	zbk:jdField_a_of_type_JavaIoBufferedInputStream	Ljava/io/BufferedInputStream;
    //   81: goto -21 -> 60
    //   84: astore_1
    //   85: ldc 60
    //   87: iconst_2
  ...
  private URLConnection a()
  {
    ...
    //   8: astore 4
    //   10: aload_0
    //   11: getfield 24	zbk:jdField_a_of_type_Boolean	Z
    //   14: ifeq +76 -> 90
    //   17: aload_0
    //   18: getfield 22	zbk:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   93: dup
    //   94: aload_0
    //   95: getfield 22	zbk:jdField_a_of_type_JavaLangString	Ljava/lang/String;
  ...
  public int a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 32	zbk:jdField_a_of_type_JavaNetURLConnection	Ljava/net/URLConnection;
    //   6: ifnonnull +68 -> 74
    //   9: aload_0
    //   10: aload_0
    //   11: invokespecial 187	zbk:a	()Ljava/net/URLConnection;
    //   14: putfield 32	zbk:jdField_a_of_type_JavaNetURLConnection	Ljava/net/URLConnection;
    //   17: aload_0
    //   18: getfield 32	zbk:jdField_a_of_type_JavaNetURLConnection	Ljava/net/URLConnection;
    //   21: instanceof 144
    //   24: ifeq +50 -> 74
    //   27: aload_0
    //   28: getfield 32	zbk:jdField_a_of_type_JavaNetURLConnection	Ljava/net/URLConnection;
  ...
  public zbm a(AtomicBoolean paramAtomicBoolean, ByteArrayOutputStream paramByteArrayOutputStream)
  {
    boolean bool = true;
  ...
  public void a()
  {
    ...
    if ((this.jdField_a_of_type_JavaNetURLConnection instanceof HttpURLConnection))
    {
      ...
      if (Looper.myLooper() == Looper.getMainLooper()) {
        ThreadManager.executeOnSubThread(new zbl(this, localHttpURLConnection));
      }
    }
    else
    {
