  ...
  implements Parcelable.Creator<FastWebArticleInfo>
{
  public FastWebArticleInfo a(Parcel paramParcel)
  {
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      while (i < k)
      {
        rjw localrjw = new rjw();
        localrjw.jdField_a_of_type_JavaLangString = paramParcel.readString();
        localrjw.jdField_a_of_type_Long = paramParcel.readLong();
        localrjw.jdField_b_of_type_JavaLangString = paramParcel.readString();
        ((List)localObject).add(localrjw);
        i += 1;
      }
      bool1 = false;
      break;
    ...
    for (localFastWebArticleInfo.jdField_a_of_type_JavaUtilList = ((List)localObject);; localFastWebArticleInfo.jdField_a_of_type_JavaUtilList = null)
    {
      ...
      {
        localObject = new rka();
        ((rka)localObject).jdField_a_of_type_JavaLangString = paramParcel.readString();
        ((rka)localObject).jdField_b_of_type_JavaLangString = paramParcel.readString();
        ((rka)localObject).jdField_a_of_type_Float = paramParcel.readFloat();
        ((rka)localObject).jdField_c_of_type_JavaLangString = paramParcel.readString();
        ((rka)localObject).jdField_a_of_type_Int = paramParcel.readInt();
        i += 1;
      }
    }
