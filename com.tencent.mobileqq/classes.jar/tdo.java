...
{
  public tdo(ProfileCardMoreActivity paramProfileCardMoreActivity, String paramString, ActionSheet paramActionSheet) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityProfileCardMoreActivity.a(2131433243, 1);
        continue;
        if (Utils.b(this.jdField_a_of_type_JavaLangString)) {
