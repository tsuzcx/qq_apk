  ...
  extends bkoy
{
  ...
  private static final String jdField_a_of_type_JavaLangString = bkov.class.getSimpleName();
  private static String jdField_b_of_type_JavaLangString;
  private static boolean jdField_b_of_type_Boolean;
  private static int o;
  private static int p;
  private bkwb jdField_a_of_type_Bkwb = new bkwb();
  private bkxl jdField_a_of_type_Bkxl;
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3)
  {
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Bkox != null) {
        this.jdField_a_of_type_Bkox.a(localBitmap);
      }
      return;
      label126:
      continue;
  ...
  private void f()
  {
    try
    {
      ...
      if (this.jdField_a_of_type_Bkxl == null) {
        this.jdField_a_of_type_Bkxl = new bkxl();
      }
      return;
    }
    finally {}
  ...
  {
    if (this.jdField_a_of_type_ComTencentAekitApiStandardFilterAEFilterManager == null) {}
    while ((!bngq.a().b()) || (!e()) || (!this.jdField_a_of_type_ComTencentAekitApiStandardFilterAEFilterManager.canUseLargeImage())) {
      return false;
    }
    return true;
  }
  ...
  private void g()
  {
    ...
    if (this.jdField_a_of_type_Bkxl != null) {
      this.jdField_a_of_type_Bkxl.a();
    }
    this.jdField_a_of_type_Bkwb.a();
  }
  ...
  private void i()
  {
    ...
    int j = 100;
    Object localObject = blev.a().a("app_alg_filter_timeout_id", "", 4);
    int i = j;
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentAekitApiStandardFilterAEFilterManager.setOnMaterialLoadFinishListener(new bkow(this));
  ...
  public int a(int paramInt)
  {
    ...
    return this.jdField_a_of_type_Bkxl.a(localFrame).getTextureId();
  }
  ...
  public int[] a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (bkwb.jdField_a_of_type_Boolean)
    {
      if (!this.jdField_a_of_type_Bkwb.a())
      {
        this.jdField_a_of_type_Bkwb.c();
        this.g = this.jdField_a_of_type_Bkwb.a();
        this.h = this.jdField_a_of_type_Bkwb.b();
      }
      localObject = this.jdField_b_of_type_ComTencentFilterBaseFilter.RenderProcess(this.jdField_a_of_type_Bkwb.c(), this.e, this.f);
    }
    for (;;)
    {
      int i;
      ...
      if ((bool) && (f()))
      {
        bkse.a.jdField_a_of_type_Boolean = true;
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Bkxl != null)
    {
      this.jdField_a_of_type_Bkxl.b();
      this.jdField_a_of_type_Bkxl = null;
    }
    this.jdField_a_of_type_Bkwb.b();
  }
