...
public class xmt
  implements View.OnClickListener, bdeg
{
  ...
  public xmt(AppInterface paramAppInterface, Activity paramActivity)
  {
    ...
    this.jdField_a_of_type_MqqObserverBusinessObserver = new xmw(this);
    this.jdField_a_of_type_AndroidOsHandler = new xmx(this);
    ...
    if ((paramActivity instanceof bcci)) {
      this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference((bcci)paramActivity);
    }
    while (this.jdField_a_of_type_JavaLangRefWeakReference == null)
    {
      QLog.e(jdField_a_of_type_JavaLangString, 2, "Error! mWebUiUtils still null! " + paramActivity.toString());
      return;
      if ((paramActivity instanceof bcce))
      {
        paramAppInterface = ((bcce)paramActivity).b();
    ...
    paramAppInterface = (bcci)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if ((paramAppInterface != null) && ((paramAppInterface instanceof bchv)))
    {
      this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView = ((bchv)paramAppInterface).getWebView();
      if (QLog.isColorLevel())
      {
  ...
  public static final String a(List<xmy> paramList, int paramInt)
  {
    ...
    label270:
    label276:
    for (localObject2 = (xmy)paramList.get(i1);; localObject3 = localObject1)
    {
      try
      {
        int i3 = Integer.valueOf(((xmy)localObject2).b.get()).intValue();
        if (i3 >= paramInt)
        {
          localObject2 = ((xmy)localObject2).a.get();
          localObject1 = localObject2;
          if (!TextUtils.isEmpty((CharSequence)localObject2))
          {
            ...
            if (localObject2 == null)
            {
              ...
              localObject2 = (xmy)paramList.get(i1);
            }
          }
          i1 += 1;
        }
      ...
      catch (NumberFormatException localNumberFormatException1)
      {
        try
        {
          i2 = Integer.valueOf(((xmy)localObject2).b.get()).intValue();
          if (i2 >= paramInt) {
            break label267;
          }
          localObject2 = ((xmy)localObject2).a.get();
  ...
  public static List<xmy> a(PBRepeatMessageField<GetAppInfoProto.MsgIconsurl> paramPBRepeatMessageField)
  {
    if ((paramPBRepeatMessageField != null) && (!paramPBRepeatMessageField.isEmpty()))
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        paramPBRepeatMessageField.add(new xmy(localMsgIconsurl.url, localMsgIconsurl.size));
      }
  ...
  private void a(int paramInt, String paramString1, String paramString2, String paramString3, String paramString4, Bitmap paramBitmap)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        ((Bundle)localObject2).putString("intext_3", "" + bdej.b(paramInt));
        ((Bundle)localObject2).putString("intext_2", "" + i2);
        ((Bundle)localObject2).putString("stringext_1", paramString3);
        bded.a().a((Bundle)localObject2, "", this.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount(), false);
      }
      ...
      ((Bundle)localObject1).putLong("share_begin_time", bcet.jdField_b_of_type_Long);
      if (!(this.jdField_a_of_type_AndroidAppActivity instanceof bcce)) {
        break label3691;
      }
      paramString1 = ((bcce)this.jdField_a_of_type_AndroidAppActivity).b();
    ...
    for (;;)
    {
      if ((paramInt != 0) || (!bgyu.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_b_of_type_AndroidAppActivity, (Bundle)localObject1, null))) {
        wim.a(1, 2131689512);
      }
      return;
      ...
      if (paramInt == 1)
      {
        ...
        paramBitmap = (bcet)((bcce)this.jdField_a_of_type_AndroidAppActivity).b().b().a(4);
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            ...
            catch (Exception paramBitmap)
            {
              ...
              localObject4 = ((Resources)localObject9).getString(2131696713);
              continue;
              paramBitmap = "plugin";
            ...
            if ((this.jdField_a_of_type_AndroidAppActivity instanceof PublicAccountBrowser))
            {
              ...
              if ((TextUtils.isEmpty(str2)) || (TextUtils.isEmpty((CharSequence)localObject4))) {
                if (jdField_f_of_type_Boolean)
                {
                  ...
                  if (paramInt != 0)
                  {
                    localObject4 = this.jdField_b_of_type_AndroidAppActivity.getString(2131696717);
                  ...
                  bbjj.a(this.jdField_a_of_type_AndroidAppActivity, 1001, 146, "web_share", str2, paramString4, paramString1, paramString2, String.format(((Resources)localObject9).getString(2131696697), new Object[] { paramString1 }), paramString3, "web", null, null, null, paramBitmap, null, (String)localObject1, (String)localObject2, (String)localObject3, (String)localObject4, "", localIntent, -1, null, -1L);
                  i1 = 0;
                  if (TextUtils.isEmpty(paramString4)) {
                    i1 = 1;
                  }
                  ...
                  bded.a().a(paramString1, "", this.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount(), false);
                  return;
            ...
            for (;;)
            {
              ...
              for (localObject1 = "http://qzonestyle.gtimg.cn/qzone/phone/n/QQ-Qzone-Android/logo_16.png";; localObject1 = paramBitmap)
              {
                ...
                if ((this.jdField_a_of_type_AndroidAppActivity instanceof bcce))
                {
                  localObject8 = ((bcce)this.jdField_a_of_type_AndroidAppActivity).b();
                  paramBitmap = (Bitmap)localObject6;
                ...
                if (ayfv.a(paramString3))
                {
                  localObject7 = "web";
                  localObject4 = ajyc.a(2131713870);
                  if (TextUtils.isEmpty(anbl.a().h()))
                  {
                    localObject1 = ayfv.jdField_b_of_type_JavaLangString;
                    localObject2 = ayfv.jdField_d_of_type_JavaLangString;
                    paramInt = 95;
                    l1 = ayfv.jdField_a_of_type_Long;
                ...
                for (;;)
                {
                  if ((bool2) || (bool1))
                  {
                    ...
                    localObject8 = this.jdField_b_of_type_AndroidAppActivity.getString(2131696697, new Object[] { paramString1 });
                  ...
                  for (i2 = -1;; i2 = 1001)
                  {
                    bbjj.a((Context)localObject7, i1, paramInt, "web_share", paramBitmap, paramString4, paramString1, paramString2, (String)localObject8, paramString3, "web", null, null, null, (String)localObject1, null, (String)localObject5, (String)localObject3, (String)localObject2, (String)localObject4, "", localIntent, i2, (String)localObject6, l1);
                    break;
                    localObject2 = this.jdField_b_of_type_AndroidAppActivity.getString(2131696713);
                  ...
                  if ((paramInt == 3) || (paramInt == 4)) {
                    if (paramInt == 3)
                    {
                      ...
                      {
                        this.jdField_a_of_type_Bcwh = new xmv(this, paramString3);
                        WXShareHelper.a().a(this.jdField_a_of_type_Bcwh);
                      }
                      this.o = String.valueOf(System.currentTimeMillis());
                      if ((TextUtils.isEmpty(this.jdField_f_of_type_JavaLangString)) || (!ayfv.jdField_b_of_type_JavaUtilMap.containsKey(this.jdField_f_of_type_JavaLangString))) {
                        break label2567;
                      }
                      paramString4 = (Integer)ayfv.jdField_b_of_type_JavaUtilMap.get(this.jdField_f_of_type_JavaLangString);
                  ...
                  for (;;)
                  {
                    if ((paramString3 != null) && (paramString3.contains("docs.qq.com/")))
                    {
                      if (paramInt == 3)
                      {
                        ...
                        if ((a() != null) && (a().l != null))
                        {
                          ...
                          paramString1 = ayfv.a(this.jdField_g_of_type_JavaLangString);
                          if ((TextUtils.isEmpty(this.jdField_g_of_type_JavaLangString)) || (!ayfv.d(this.jdField_g_of_type_JavaLangString))) {
                            break label2645;
                          }
                          if (paramString1 == null) {
                            break label2636;
                    ...
                    if (paramInt == 5)
                    {
                      ...
                      {
                        axqw.b(null, "CliOper", "", "", "0X8006277", "0X8006277", 0, 0, "", "", "", "");
                      ...
                      if (bhvn.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_b_of_type_AndroidAppActivity, (Bundle)localObject1, null, 0)) {
                        break;
                      }
                      wim.a(1, 2131689512);
                      return;
                    ...
                    {
                      bdto.a(this.jdField_a_of_type_AndroidAppActivity, paramInt, paramString1, paramString2, paramString3, paramString4, "", 0, false);
                      return;
                    }
                    if (paramInt == 8)
                    {
                      ...
                      catch (PackageManager.NameNotFoundException paramString2)
                      {
                        for (;;)
                        {
                          ...
                          {
                            Toast.makeText(BaseApplicationImpl.getContext(), ajyc.a(2131713871), 1).show();
                    ...
                    if ((this.jdField_a_of_type_AndroidAppActivity instanceof FastWebActivity))
                    {
                      ...
                      oze.a().a(this.jdField_a_of_type_AndroidAppActivity, null, 1, this.w, this.jdField_e_of_type_JavaLangString, this.h, this.i, this.v, paramString3);
                      bgpr.a(paramString2, 42, 2);
                      return;
                    }
                    if ((this.jdField_a_of_type_AndroidAppActivity instanceof bcce))
                    {
  ...
  {
    Bundle localBundle = bbga.a(paramString2, paramString3, "0.0.0.1", paramString4, this.jdField_a_of_type_AndroidContentContext.getResources().getDisplayMetrics().scaledDensity, null, null);
  ...
  public static final void a(AppInterface paramAppInterface, Context paramContext, String paramString1, long paramLong1, long paramLong2, BusinessObserver paramBusinessObserver, String paramString2)
  {
    ...
    localGetAppinfoRequest.qqv.set("8.2.8");
    ...
    paramContext = new NewIntent(paramContext, bdfa.class);
  ...
  public static List<xmy> b(PBRepeatMessageField<appType.MsgIconsurl> paramPBRepeatMessageField)
  {
    if ((paramPBRepeatMessageField != null) && (!paramPBRepeatMessageField.isEmpty()))
    {
      Object localObject = paramPBRepeatMessageField.get();
  ...
  private void b(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    if (paramInt == 1)
    {
      if (((paramString.length() > 180) || ((!(this.jdField_a_of_type_AndroidAppActivity instanceof PublicAccountBrowser)) && (paramString.length() > 60))) && (!(this.jdField_a_of_type_AndroidAppActivity instanceof TeamWorkDocEditBrowserActivity)) && (!ayfv.a(paramString))) {
  ...
  public aydx a()
  {
    return this.jdField_a_of_type_Aydx;
  }
  ...
  public bcpq a()
  {
    ...
    if (this.jdField_a_of_type_Bcpq == null)
    {
      ...
      localbcci = (bcci)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if ((localbcci == null) || (!(localbcci instanceof bchu)) || (this.jdField_a_of_type_AndroidAppActivity.isFinishing())) {
        break label134;
      }
      i1 = ((bchu)localbcci).b();
    }
    for (;;)
    {
      this.jdField_a_of_type_Bcpq = new bcpq(this.jdField_a_of_type_AndroidAppActivity, i1);
      this.jdField_a_of_type_Bcpq.c(2131689506);
  ...
  public String a()
  {
    ...
    for (;;)
    {
      if (TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
        {
          localObject = (bcci)this.jdField_a_of_type_JavaLangRefWeakReference.get();
          if ((localObject != null) && ((localObject instanceof bchv))) {
            localObject = ((bchv)localObject).b();
          }
        }
      }
      else
      {
        return nax.a((String)localObject, new String[0]);
      }
      localObject = "";
    }
  }
  ...
  void a()
  {
    ...
    do
    {
      do
      {
        ...
        a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_a_of_type_AndroidAppActivity, this.n, bbbo.b(this.jdField_a_of_type_Long), 0L, this.jdField_a_of_type_MqqObserverBusinessObserver);
        ...
        localObject1 = new LinearLayout.LayoutParams((int)muf.a(this.jdField_a_of_type_AndroidContentContext, 19.0F), (int)muf.a(this.jdField_a_of_type_AndroidContentContext, 19.0F));
        this.jdField_b_of_type_AndroidWidgetLinearLayout = new LinearLayout(this.jdField_a_of_type_AndroidContentContext);
        localObject2 = new LinearLayout.LayoutParams(-2, -2);
        this.jdField_b_of_type_AndroidWidgetLinearLayout.setPadding((int)muf.a(this.jdField_a_of_type_AndroidContentContext, 10.0F), 0, (int)muf.a(this.jdField_a_of_type_AndroidContentContext, 10.0F), 0);
        ...
        localObject1 = new LinearLayout.LayoutParams((int)muf.a(this.jdField_a_of_type_AndroidContentContext, 30.0F), (int)muf.a(this.jdField_a_of_type_AndroidContentContext, 30.0F));
        ...
        this.jdField_a_of_type_AndroidWidgetTextView.setPadding((int)muf.a(this.jdField_a_of_type_AndroidContentContext, 8.0F), 0, (int)muf.a(this.jdField_a_of_type_AndroidContentContext, 8.0F), 0);
        ...
        this.jdField_b_of_type_AndroidWidgetTextView.setBackgroundResource(2130841355);
        ...
        localObject1 = new LinearLayout.LayoutParams((int)muf.a(this.jdField_a_of_type_AndroidContentContext, 56.0F), (int)muf.a(this.jdField_a_of_type_AndroidContentContext, 30.0F));
        ((LinearLayout.LayoutParams)localObject1).rightMargin = ((int)muf.a(this.jdField_a_of_type_AndroidContentContext, 10.0F));
        ...
        localObject1 = new FrameLayout.LayoutParams(-1, (int)muf.a(this.jdField_a_of_type_AndroidContentContext, 44.0F));
        ((FrameLayout.LayoutParams)localObject1).gravity = 80;
        ((FrameLayout.LayoutParams)localObject1).bottomMargin = ((int)muf.a(this.jdField_a_of_type_AndroidContentContext, 50.0F));
      } while (!(this.jdField_a_of_type_AndroidAppActivity instanceof bcce));
      localObject2 = ((bcce)this.jdField_a_of_type_AndroidAppActivity).b();
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    try
    {
      ...
      for (;;)
      {
        if ((paramInt3 == 1) && ((paramInt2 == 0) || (paramInt2 == 1)) && (this.jdField_a_of_type_Aydx != null)) {
  ...
  public void a(Context paramContext, GetAppInfoProto.GetAppinfoResponse paramGetAppinfoResponse)
  {
    ...
    try
    {
      if ((paramGetAppinfoResponse.has()) && (paramGetAppinfoResponse.ret.get() == 0))
      {
        ...
        {
          arrayOfByte = nam.a(paramContext, paramGetAppinfoResponse, "GET", null, null);
          if (arrayOfByte == null)
          {
            if (!QLog.isColorLevel()) {
              return;
    ...
    catch (Exception paramContext)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        catch (OutOfMemoryError localOutOfMemoryError)
        {
          ...
          paramContext = nam.a(paramContext, String.format("http://openmobile.qq.com/api/get_app_info_by_id?appid=%d", new Object[] { Long.valueOf(bbbo.b(this.jdField_a_of_type_Long)) }), "GET", null, null);
        ...
        if (bbfd.a(paramContext, localAndroidInfo.packName.get()))
        {
          paramContext = this.jdField_a_of_type_AndroidOsHandler.obtainMessage(1001);
          try
          {
  ...
  public void a(aydx paramaydx)
  {
    this.jdField_a_of_type_Aydx = paramaydx;
  }
  ...
  public void a(bcci parambcci)
  {
    ...
    if (this.jdField_a_of_type_JavaLangRefWeakReference == null) {
      this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambcci);
    }
    parambcci = (bcci)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if ((parambcci != null) && ((parambcci instanceof bchv)))
    {
      this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView = ((bchv)parambcci).getWebView();
      if (QLog.isColorLevel())
      {
        parambcci = jdField_a_of_type_JavaLangString;
        localObject = new StringBuilder().append(" Share secret webview is null?");
        if (this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView != null) {
          break label122;
        }
        bool = true;
        QLog.d(parambcci, 2, bool);
      }
    }
    label122:
    while (!QLog.isColorLevel()) {
  ...
  public boolean a()
  {
    ...
    for (Object localObject = null;; localObject = this.h)
    {
      ...
      localQZoneShareData.jdField_b_of_type_Long = bcet.jdField_b_of_type_Long;
      ...
      bgyu.a(this.jdField_b_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), localQZoneShareData, null, -1);
      return true;
      this.jdField_b_of_type_AndroidAppActivity = this.jdField_a_of_type_AndroidAppActivity;
      break;
      localObject = this.jdField_e_of_type_JavaLangString;
  ...
  public boolean a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Bdel.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_Bdel.jdField_b_of_type_Int = bdej.b(paramInt);
      localBundle = new Bundle();
      localBundle.putString("report_type", "102");
      localBundle.putString("act_type", "90");
      localStringBuilder = new StringBuilder().append("");
      if (this.jdField_a_of_type_Bdel.jdField_a_of_type_Int != 0) {
        break label407;
      }
    }
    label407:
    for (int i1 = 0;; i1 = 1)
    {
      ...
      localBundle.putString("intext_3", "" + this.jdField_a_of_type_Bdel.jdField_b_of_type_Int);
      localBundle.putString("intext_2", "" + this.jdField_a_of_type_Bdel.jdField_a_of_type_Int);
      localBundle.putString("stringext_1", "" + paramString);
      bded.a().a(localBundle, "", this.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount(), false);
      this.jdField_a_of_type_Bdel.jdField_a_of_type_Boolean = false;
      ...
      paramString.putString("intext_1", "" + bdej.a(1));
      paramString.putString("intext_3", "1");
      paramString.putString("intext_4", "0");
      bded.a().a(paramString, "", this.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount(), false);
      return false;
    }
    ...
    if ((!this.jdField_a_of_type_Bcpq.isShowing()) && (bool)) {
  ...
  public boolean a(String paramString1, String paramString2, String paramString3, String paramString4, Bundle paramBundle)
  {
    ...
    //   7: aload_0
    //   8: aload_3
    //   9: invokevirtual 1679	xmt:a	(Ljava/lang/String;)Z
    //   12: ifne +5 -> 17
    //   15: iconst_0
    //   16: ireturn
    //   17: aload_0
    //   18: aload_1
    //   19: putfield 375	xmt:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   22: aload_0
    //   23: aload_2
    //   24: putfield 379	xmt:h	Ljava/lang/String;
    //   27: aload_0
    //   28: aload 4
    //   30: putfield 383	xmt:i	Ljava/lang/String;
    //   33: aload_0
    //   34: getfield 383	xmt:i	Ljava/lang/String;
    //   37: ifnull +43 -> 80
    //   40: aload_0
    //   41: getfield 383	xmt:i	Ljava/lang/String;
    //   44: ldc_w 1681
    ...
    //   67: aload_0
    //   68: getfield 383	xmt:i	Ljava/lang/String;
    ...
    //   77: putfield 383	xmt:i	Ljava/lang/String;
    //   80: aload_0
    //   81: iconst_1
    //   82: putfield 1137	xmt:jdField_e_of_type_Boolean	Z
    //   85: aload 5
    //   87: ifnull +173 -> 260
    //   90: aload 5
    //   92: ldc_w 1688
    ...
    //   125: aload_0
    //   126: getfield 375	xmt:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   138: aload_0
    //   139: getfield 379	xmt:h	Ljava/lang/String;
    ...
    //   151: aload_0
    //   152: getfield 383	xmt:i	Ljava/lang/String;
    ...
    //   174: aload_0
    //   175: getfield 76	xmt:jdField_a_of_type_Bdel	Lbdel;
    //   178: iconst_1
    //   179: putfield 1630	bdel:jdField_a_of_type_Boolean	Z
    //   182: aload_0
    //   183: getfield 76	xmt:jdField_a_of_type_Bdel	Lbdel;
    //   186: iconst_0
    //   187: putfield 1634	bdel:jdField_a_of_type_Int	I
    //   190: aload 4
    //   192: invokestatic 280	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   195: ifeq +430 -> 625
    //   198: aload_0
    //   199: getfield 76	xmt:jdField_a_of_type_Bdel	Lbdel;
    //   202: astore 4
    //   204: aload 4
    //   206: aload 4
    //   208: getfield 1634	bdel:jdField_a_of_type_Int	I
    //   211: iconst_1
    //   212: ior
    //   213: putfield 1634	bdel:jdField_a_of_type_Int	I
    //   216: aload_2
    //   217: invokestatic 280	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   220: ifeq +18 -> 238
    //   223: aload_0
    //   224: getfield 76	xmt:jdField_a_of_type_Bdel	Lbdel;
    //   227: astore_2
    //   228: aload_2
    //   229: aload_2
    //   230: getfield 1634	bdel:jdField_a_of_type_Int	I
    //   233: iconst_2
    //   234: ior
    //   235: putfield 1634	bdel:jdField_a_of_type_Int	I
    //   238: aload_1
    //   239: invokestatic 280	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   242: ifeq +18 -> 260
    //   245: aload_0
    //   246: getfield 76	xmt:jdField_a_of_type_Bdel	Lbdel;
    //   249: astore_1
    //   250: aload_1
    //   251: aload_1
    //   252: getfield 1634	bdel:jdField_a_of_type_Int	I
    //   255: iconst_4
    //   256: ior
    //   257: putfield 1634	bdel:jdField_a_of_type_Int	I
    //   260: aload_0
    //   261: aconst_null
    //   262: putfield 1135	xmt:jdField_a_of_type_JavaLangRefSoftReference	Ljava/lang/ref/SoftReference;
    //   265: aload 5
    //   267: ifnull +263 -> 530
    //   270: getstatic 62	xmt:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   273: iconst_1
    //   274: ldc_w 1698
    ...
    //   435: putfield 71	xmt:jdField_a_of_type_Int	I
    //   438: aload_0
    //   439: aload 5
    //   441: ldc_w 1725
    //   444: invokevirtual 1712	android/os/Bundle:getBoolean	(Ljava/lang/String;)Z
    //   447: putfield 1727	xmt:jdField_c_of_type_Boolean	Z
    //   450: aload_0
    //   451: getfield 127	xmt:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   454: ifnull +76 -> 530
    //   457: aload_0
    //   458: getfield 127	xmt:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   461: instanceof 1131
    //   464: ifeq +66 -> 530
    //   467: aload_0
    //   468: getfield 127	xmt:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    ...
    //   485: aload_1
    //   486: aload_0
    //   487: getfield 69	xmt:jdField_a_of_type_Boolean	Z
    //   490: aload_0
    //   491: getfield 71	xmt:jdField_a_of_type_Int	I
    ...
    //   497: aload_1
    //   498: aload_0
    //   499: getfield 1718	xmt:jdField_d_of_type_Boolean	Z
    ...
    //   510: iconst_1
    //   511: aload_0
    //   512: getfield 1723	xmt:j	Ljava/lang/String;
    //   515: aconst_null
    ...
    //   567: ldc_w 1756
    //   570: aload_0
    //   571: getfield 80	xmt:jdField_d_of_type_Int	I
    //   574: invokestatic 1757	cooperation/qzone/LocalMultiProcConfig:putInt	(Ljava/lang/String;I)V
    //   577: aload_0
    //   578: getfield 222	xmt:jdField_a_of_type_ComTencentBizPubaccountCustomWebView	Lcom/tencent/biz/pubaccount/CustomWebView;
    //   581: ifnull +16 -> 597
    //   584: ldc_w 1759
    //   587: aload_0
    //   588: getfield 222	xmt:jdField_a_of_type_ComTencentBizPubaccountCustomWebView	Lcom/tencent/biz/pubaccount/CustomWebView;
    ...
    //   607: astore_1
    //   608: aload_0
    //   609: getfield 127	xmt:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   612: ifnull +11 -> 623
    //   615: aload_0
    //   616: getfield 127	xmt:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   619: aload_1
    ...
    //   625: aload_0
    //   626: iconst_2
    //   627: putfield 1766	xmt:jdField_b_of_type_Int	I
    //   630: goto -414 -> 216
    //   633: astore_1
    //   634: getstatic 62	xmt:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   637: iconst_1
    //   638: ldc_w 1768
    //   641: invokestatic 179	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   644: aload_0
    //   645: iconst_m1
    //   646: putfield 78	xmt:jdField_c_of_type_Int	I
    //   649: goto -281 -> 368
    //   652: astore_1
    //   653: getstatic 62	xmt:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   656: iconst_1
    //   657: ldc_w 1770
    ...
    //   667: aload_0
    //   668: aconst_null
    //   669: putfield 1723	xmt:j	Ljava/lang/String;
    //   672: getstatic 62	xmt:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   675: iconst_1
    //   676: ldc_w 1772
    ...
    //   686: aload_0
    //   687: iconst_m1
    //   688: putfield 71	xmt:jdField_a_of_type_Int	I
    //   691: goto -253 -> 438
  ...
  public boolean a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8)
  {
    ...
    if (this.jdField_a_of_type_Bcpq == null)
    {
      paramString7 = (bcci)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if ((paramString7 == null) || (!(paramString7 instanceof bchu))) {
        break label456;
      }
    }
    label139:
    ...
    label192:
    label456:
    for (int i1 = ((bchu)paramString7).b();; i1 = 0)
    {
      this.jdField_a_of_type_Bcpq = new bcpq(this.jdField_a_of_type_AndroidAppActivity, i1);
      this.jdField_a_of_type_Bcpq.c(2131689506);
      boolean bool;
      ...
      for (;;)
      {
        ...
        String str = String.format(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131696697), new Object[] { paramString2 });
        bbjj.a(this.jdField_a_of_type_AndroidAppActivity, 1001, 146, "struct_msg_from_h5", paramString1, paramString5, paramString2, paramString3, str, paramString4, "web", null, null, null, "plugin", null, paramString7, paramString8, "http://url.cn/JS8oE7", paramString6, null);
        int i2 = 0;
  ...
  public void b()
  {
    ...
    this.m = null;
    this.p = null;
    this.jdField_a_of_type_Aabm = null;
    this.q = null;
    this.r = null;
    this.s = null;
    this.t = null;
  ...
  public void onClick(View paramView)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentProtofileGetappinfoGetAppInfoProto$GetAppinfoResponse != null) && (this.jdField_a_of_type_ComTencentProtofileGetappinfoGetAppInfoProto$GetAppinfoResponse.androidInfo != null))
    {
      ...
      if (!bbfd.a(this.jdField_a_of_type_AndroidAppActivity, localAndroidInfo.packName.get())) {
        break label97;
      }
      bbfd.a(this.jdField_a_of_type_AndroidAppActivity, localAndroidInfo.packName.get(), null);
      paramView = "run";
      nax.a(null, "", "webviewsourceclick", bbbo.b(this.jdField_a_of_type_Long), 0L, paramView);
    }
    label97:
    do
    {
      for (;;)
      {
        ...
        bdev.a(this.jdField_a_of_type_AndroidAppActivity, String.valueOf(bbbo.b(this.jdField_a_of_type_Long)), 2470, paramView);
        paramView = "setup";
        break;
        ...
        {
          bbfd.a(this.jdField_a_of_type_AndroidAppActivity, localAndroidInfo.packName.get(), null);
          bdjo.a().a(this.n, String.valueOf(bbbo.b(this.jdField_a_of_type_Long)), "ANDROIDQQ.SHAREBAR", "203", false);
        }
        while (this.jdField_a_of_type_AndroidWidgetLinearLayout != null)
        {
          ...
          paramView.putBoolean("autoDownload", true);
          paramView.putString("packageName", localAndroidInfo.packName.get());
          paramView.putString("appId", String.valueOf(bbbo.b(this.jdField_a_of_type_Long)));
          bdev.b(this.jdField_a_of_type_AndroidAppActivity, paramView);
          bdjo.a().a(this.n, String.valueOf(bbbo.b(this.jdField_a_of_type_Long)), "ANDROIDQQ.SHAREBAR", "202", false);
        }
      }
