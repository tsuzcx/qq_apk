...
public class bdyv
{
  ...
  static
  {
    jdField_a_of_type_JavaUtilComparator = new bdyx();
    jdField_b_of_type_JavaUtilComparator = new bdyw();
  ...
  public static String b(String paramString)
  {
    try
    {
      paramString = bdyq.a(a(paramString.getBytes("UTF-8")));
      return paramString;
    }
  ...
  public static String c(String paramString)
  {
    ...
    paramString = new bdyv().b(paramString);
