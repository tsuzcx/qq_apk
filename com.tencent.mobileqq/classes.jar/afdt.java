  ...
  extends ArkViewModel
{
  ...
  protected static ArrayList<WeakReference<afdt>> a;
  ...
  public String b;
  protected boolean b;
  protected WeakReference<afdt> c;
  boolean c;
  protected WeakReference<afdw> d;
  protected boolean d;
  ...
  static
  {
    ...
    jdField_a_of_type_ComTencentArkArk$ApplicationCallback = new afdu();
  }
  
  public afdt() {}
  
  public afdt(boolean paramBoolean) {}
  ...
  public static WeakReference<afdt> a(ark.Container paramContainer)
  {
    int i = 0;
    while (i < jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      afdt localafdt = (afdt)localWeakReference.get();
      if ((localafdt != null) && (localafdt.getContainer() == paramContainer)) {
  ...
  public void a(afdw paramafdw)
  {
    this.d = new WeakReference(paramafdw);
  }
  ...
  {
    afdw localafdw = (afdw)this.d.get();
    if (localafdw != null) {
      localafdw.a(this, paramString1, paramString2);
    }
  }
  ...
  public boolean onLoadApp(ArkViewModelBase.AppInfo paramAppInfo)
  {
    ...
    for (Object localObject2 = str2;; localObject2 = str2)
    {
      ...
      ArkAppMgr.getInstance().getAppPathByName(paramAppInfo.name, paramAppInfo.view, paramAppInfo.appMinVersion, null, new afdv(this.jdField_c_of_type_JavaLangRefWeakReference));
      return false;
      bool = false;
    }
  }
  ...
  public void onLoadReport(int paramInt)
  {
    if (this.mAppInfo != null) {
      anjv.a(a(), this.mAppInfo.name, "ArkAppLoadState", paramInt, 0, 0L, 0L, 0L, this.mAppInfo.view, "");
    }
  }
  ...
  public void onRunAppFailed()
  {
    ...
    if (localObject != null)
    {
      ...
      localObject = ((ArkViewImplement)localObject).getView().getContext().getString(2131693914);
    ...
    for (this.mErrorInfo.canRetry = true;; this.mErrorInfo.canRetry = false)
    {
      ...
      return;
      label72:
      localObject = ((ArkViewImplement)localObject).getView().getContext().getString(2131693919);
      this.mErrorInfo.msg = a((String)localObject);
    }
  }
}
