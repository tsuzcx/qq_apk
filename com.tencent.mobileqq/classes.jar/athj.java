  ...
  extends WebViewPlugin
{
  ...
  public static CopyOnWriteArrayList<WeakReference<athj>> a;
  public static AtomicBoolean a;
  String jdField_a_of_type_JavaLangString = "";
  WeakReference<athj> jdField_a_of_type_JavaLangRefWeakReference = null;
  ...
  {
    jdField_a_of_type_AndroidContentBroadcastReceiver = new athk();
    if (QLog.isColorLevel()) {
  ...
  public void a(android.content.Context paramContext, Intent paramIntent)
  {
    ...
    //   6: ifnull +20 -> 26
    //   9: aload_0
    //   10: getfield 31	athj:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    //   13: ifnull +13 -> 26
    //   16: aload_0
    //   17: getfield 31	athj:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    ...
    //   50: aload_1
    //   51: aload_0
    //   52: invokevirtual 286	athj:a	()Ljava/lang/String;
    ...
    //   135: astore_2
    //   136: aload_0
    //   137: getfield 227	athj:mRuntime	Lbegz;
    //   140: invokevirtual 298	begz:a	()Lcom/tencent/biz/pubaccount/CustomWebView;
    //   143: astore 5
    //   145: aload 5
    //   147: ifnull -121 -> 26
    //   150: aload 5
    ...
    //   175: ifeq +68 -> 243
    //   178: aload_0
    //   179: getfield 31	athj:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    ...
    //   262: ifeq +48 -> 310
    //   265: invokestatic 334	myl:a	()Lmyl;
    //   268: aload 8
    //   270: ldc_w 336
    //   273: invokevirtual 339	myl:a	(Ljava/lang/String;Ljava/lang/String;)Z
    //   276: ifne +17 -> 293
    //   279: invokestatic 334	myl:a	()Lmyl;
    //   282: aload 8
    //   284: ldc_w 341
    //   287: invokevirtual 339	myl:a	(Ljava/lang/String;Ljava/lang/String;)Z
    //   290: ifeq +20 -> 310
    //   293: aload_0
    //   294: aload 6
    //   296: aload_1
    //   297: aload_2
    //   298: invokevirtual 345	athj:dispatchJsEvent	(Ljava/lang/String;Lorg/json/JSONObject;Lorg/json/JSONObject;)V
    //   301: return
    //   302: ldc_w 347
    //   305: astore 5
    //   307: goto -110 -> 197
    ...
    //   332: aload 9
    //   334: invokestatic 357	myl:b	(Ljava/lang/String;Ljava/lang/String;)Z
    //   337: ifeq +12 -> 349
    //   340: aload_0
    //   341: aload 6
    //   343: aload_1
    //   344: aload_2
    //   345: invokevirtual 345	athj:dispatchJsEvent	(Ljava/lang/String;Lorg/json/JSONObject;Lorg/json/JSONObject;)V
    //   348: return
    //   349: iload_3
    //   350: iconst_1
    //   351: iadd
