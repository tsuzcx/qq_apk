...
{
  uaz(BarrageItemView paramBarrageItemView, ValueAnimator paramValueAnimator) {}
  ...
  public void onAnimationEnd(@Nullable Animator paramAnimator)
  {
    ...
    if (i != 0)
    {
      this.jdField_a_of_type_Uas.a().removeView((View)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaVideonewBarrageBarrageItemView);
      paramAnimator = uas.b(this.jdField_a_of_type_Uas).iterator();
      ...
      while (paramAnimator.hasNext())
      {
        ...
        if (Intrinsics.areEqual(((uat)localObject).a(), this.jdField_a_of_type_AndroidAnimationValueAnimator)) {
