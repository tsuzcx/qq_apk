  ...
  extends alpd
{
  ...
  public amfu(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(int paramInt1, int paramInt2, ListenChangeVoicePanel paramListenChangeVoicePanel)
  {
    ...
    localvoiceChangeReq.str_qq_version.set("8.3.5");
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        QLog.e("VoiceChangeHandler", 1, "onReceive~ isSuccess=false ,data=" + bdqa.a((byte[])paramObject));
        bfhz.a().a("voiceChange.Auth", 100, paramFromServiceMsg.getBusinessFailCode(), this.app.getCurrentAccountUin(), 0, alud.a(2131717236), true);
