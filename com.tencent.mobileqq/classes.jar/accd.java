  ...
  implements apsy
{
  private static int a(int paramInt)
  {
    ...
    acho.d("GdtInterstitialNotifyReg", String.format("getError arkScriptError:%d not working", new Object[] { Integer.valueOf(paramInt) }));
    return 1;
  }
  ...
  private static int a(String paramString)
  {
    ...
    {
      acho.d("GdtInterstitialNotifyReg", String.format("getReasonForClose params:%s", new Object[] { paramString }), localThrowable);
    }
    return -2147483648;
  }
  ...
  private static GdtAd a(String paramString)
  {
    try
    {
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        if ((localObject != null) && (!JSONObject.NULL.equals(localObject)))
        {
          ...
          if ((localObject != null) && (!JSONObject.NULL.equals(localObject)))
          {
            localObject = (qq_ad_get.QQAdGetRsp.AdInfo)qq_ad_get.QQAdGetRsp.AdInfo.class.cast(achn.a(new qq_ad_get.QQAdGetRsp.AdInfo(), localObject));
            if (localObject != null)
            {
    ...
    {
      acho.b("GdtInterstitialNotifyReg", String.format("getAd params:%s", new Object[] { paramString }), localThrowable);
    }
    return null;
  }
  ...
  private static JSONObject a(String paramString)
  {
    ...
    {
      acho.b("GdtInterstitialNotifyReg", String.format("getAntiSpamParamsOnCGI params:%s", new Object[] { paramString }), localThrowable);
    }
    return null;
  }
  ...
  private boolean a(String paramString)
  {
    ...
    for (;;)
    {
      acho.b("GdtInterstitialNotifyReg", String.format("receiveHTTPGet %b %s", new Object[] { Boolean.valueOf(bool), paramString }));
      return bool;
  ...
  private static int b(String paramString)
  {
    ...
    {
      acho.d("GdtInterstitialNotifyReg", String.format("getError params:%s", new Object[] { paramString }), localThrowable);
    }
    return -2147483648;
  }
  ...
  private static String b(String paramString)
  {
    ...
    {
      acho.d("GdtInterstitialNotifyReg", String.format("getUrl params:%s", new Object[] { paramString }), localThrowable);
    }
    return null;
  }
  ...
  private static JSONObject b(String paramString)
  {
    ...
    {
      acho.b("GdtInterstitialNotifyReg", String.format("getAntiSpamParamsOnReportServer params:%s", new Object[] { paramString }), localThrowable);
    }
    return null;
  }
  ...
  private boolean b(String paramString)
  {
    ...
    for (;;)
    {
      acho.b("GdtInterstitialNotifyReg", String.format("receiveClick %b", new Object[] { Boolean.valueOf(bool) }));
      return bool;
      paramString = a(paramString);
  ...
  private static String c(String paramString)
  {
    ...
    {
      acho.d("GdtInterstitialNotifyReg", String.format("getKey params:%s", new Object[] { paramString }), localThrowable);
    }
    return null;
  }
  ...
  private boolean c(String paramString)
  {
    ...
    for (;;)
    {
      acho.b("GdtInterstitialNotifyReg", String.format("receiveClose %b", new Object[] { Boolean.valueOf(bool) }));
      return bool;
  ...
  private boolean d(String paramString)
  {
    ...
    for (;;)
    {
      acho.b("GdtInterstitialNotifyReg", String.format("receiveLoaded %b", new Object[] { Boolean.valueOf(bool) }));
      return bool;
  ...
  private boolean e(String paramString)
  {
    int i = b(paramString);
    int j = a(i);
    acho.d("GdtInterstitialNotifyReg", String.format("receiveError error:%d arkScriptError:%d params:%s", new Object[] { Integer.valueOf(j), Integer.valueOf(i), paramString }));
    if ((j != 4) && (j != 207)) {}
    do
    {
      return true;
  ...
  private boolean f(String paramString)
  {
    ...
    {
      acho.d("GdtInterstitialNotifyReg", "receiveReportForAntiSpamOnReportServer error, antiSpamParams is null");
      return false;
    }
    paramString = b(paramString);
    ...
    for (Object localObject = ((GdtInterstitialFragment)paramString.get()).a();; localObject = null)
    {
      ...
      acho.d("GdtInterstitialNotifyReg", "receiveReportForAntiSpamOnReportServer error, antiSpamParamsFromPosition is null");
      return false;
    }
    acho.b("GdtInterstitialNotifyReg", String.format("receiveReportForAntiSpamOnReportServer ark:%s position:%s", new Object[] { localJSONObject.toString(), paramString.toString() }));
    ...
    while (((Iterator)localObject).hasNext()) {
      ...
      {
        acho.d("GdtInterstitialNotifyReg", "receiveReportForAntiSpamOnReportServer", localThrowable);
      }
    }
  ...
  {
    int i = 0;
    acho.b("GdtInterstitialNotifyReg", String.format("notify appName:%s eventName:%s params:%s", new Object[] { paramString1, paramString2, paramString3 }));
    boolean bool;
    if (accc.a().a().a.equals(paramString1)) {
    ...
    for (;;)
    {
      ...
      {
        acid.a(BaseApplicationImpl.getApplication(), paramString3, (GdtInterstitialStatus)localObject, paramString2, paramString1);
        return bool;
