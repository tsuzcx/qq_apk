  ...
  implements Runnable
{
  ...
  public ampq(TroopHWJsPlugin paramTroopHWJsPlugin, ampr paramampr, HashMap paramHashMap)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        try
        {
          ...
          localObject = this.jdField_a_of_type_CooperationTroop_homeworkJspTroopHWJsPlugin.a(this.jdField_a_of_type_CooperationTroop_homeworkJspTroopHWJsPlugin, i, (String)localObject, localBitmap, this.jdField_a_of_type_Ampr, 2);
        ...
        {
          localUploadMediaEntry = this.jdField_a_of_type_CooperationTroop_homeworkJspTroopHWJsPlugin.a(this.jdField_a_of_type_CooperationTroop_homeworkJspTroopHWJsPlugin, i, str, localBitmap, this.jdField_a_of_type_Ampr, 2);
        ...
        else
        {
          ...
          localUploadMediaEntry = this.jdField_a_of_type_CooperationTroop_homeworkJspTroopHWJsPlugin.a(this.jdField_a_of_type_CooperationTroop_homeworkJspTroopHWJsPlugin, i, localUploadMediaEntry, localBitmap, this.jdField_a_of_type_Ampr, 2);
          this.jdField_a_of_type_CooperationTroop_homeworkJspTroopHWJsPlugin.b.put(Integer.valueOf(i), localUploadMediaEntry);
          localUploadMediaEntry.a();
        }
      }
