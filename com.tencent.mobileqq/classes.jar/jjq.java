...
{
  public jjq(GuildMultiActivity paramGuildMultiActivity) {}
  ...
  protected void a(String paramString, Bitmap paramBitmap)
  {
    ...
    this.a.runOnUiThread(new jjt(this));
  }
  ...
  protected void c(int paramInt)
  {
    ...
    if (paramInt == 3)
    {
      localObject = this.a.getResources().getString(2131429199);
      String str = this.a.getResources().getString(2131429201);
      localObject = DialogUtil.a(this.a, 230).setMessage((CharSequence)localObject).setTitle(str).setNegativeButton(2131432998, new jjs(this));
      if (!UITools.a(this.a)) {
        break label93;
      }
    }
    label93:
    for (paramInt = 2131429202;; paramInt = 2131429203)
    {
      ((QQCustomDialog)localObject).setPositiveButton(paramInt, new jjr(this)).show();
      return;
    }
  }
}
