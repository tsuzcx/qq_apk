  ...
  implements ViewTreeObserver.OnGlobalLayoutListener
{
  ...
  private bcdt jdField_a_of_type_Bcdt;
  private int b = 1;
  private int c;
  
  public bcds(Activity paramActivity)
  {
  ...
  public void a()
  {
    ...
    {
      this.b = 1;
      this.jdField_a_of_type_Bcdt = null;
      this.c = 0;
      return;
  ...
  public void onGlobalLayout()
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_AndroidViewView != null)
      {
        ...
        if ((m != this.c) && (this.jdField_a_of_type_Bcdt != null)) {
          this.jdField_a_of_type_Bcdt.b(this.b, j, this.c);
        }
        this.c = m;
      }
    } while (j == this.c);
    if (k > i / 4)
    {
      ...
      if (this.jdField_a_of_type_Bcdt != null) {
        this.jdField_a_of_type_Bcdt.a(this.b, j, k);
      }
    }
    for (;;)
    {
