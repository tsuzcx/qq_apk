...
{
  public static int a;
  private static bckg jdField_a_of_type_Bckg;
  ...
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new bckh(this);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = anhk.ba + "VideoRedbagRes" + File.separator;
  ...
  public bckg(AppInterface paramAppInterface)
  {
  ...
  private RelativeLayout.LayoutParams a(CustomFrameAnimationDrawable paramCustomFrameAnimationDrawable)
  {
    if ((paramCustomFrameAnimationDrawable != null) && (this.jdField_a_of_type_AndroidAppActivity != null))
    {
      ...
      paramCustomFrameAnimationDrawable = new RelativeLayout.LayoutParams(afur.a(j / 2, this.jdField_a_of_type_AndroidAppActivity.getResources()), afur.a(k / 2, this.jdField_a_of_type_AndroidAppActivity.getResources()));
  ...
  public static bckg a(AppInterface paramAppInterface)
  {
    if (jdField_a_of_type_Bckg == null) {}
    try
    {
      if (jdField_a_of_type_Bckg == null) {
        jdField_a_of_type_Bckg = new bckg(paramAppInterface);
      }
  ...
  private CustomFrameAnimationDrawable a(String paramString)
  {
    ...
    //   11: getstatic 57	bckg:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   154: aload_1
    //   155: invokestatic 229	bgmo:a	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   158: astore_1
    ...
    //   169: aload_1
    //   170: aload_0
    //   171: getfield 235	bckg:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
  ...
  public static void a(Intent paramIntent, Activity paramActivity)
  {
    ...
    aldk.a(paramActivity, paramIntent);
  }
  
  public static void a(View paramView, ahin paramahin, ChatMessage paramChatMessage, Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (j != 0)
        {
          if (paramView.findViewById(2131374170) != null)
          {
            paramView.findViewById(2131374169).setVisibility(0);
            paramahin = (ImageView)paramView.findViewById(2131374170);
            if (j == 1) {
              paramahin.setImageResource(2130849734);
            }
            for (;;)
            {
              paramahin.setVisibility(0);
              paramView = (RelativeLayout.LayoutParams)((ImageView)paramView.findViewById(2131374169)).getLayoutParams();
              if (!paramChatMessage.isSend()) {
                break label213;
              }
              paramView.rightMargin = afur.a(6.0F, paramContext.getResources());
              ...
              break;
              if (j == 2) {
                paramahin.setImageResource(2130849735);
              } else if (j == 3) {
                paramahin.setImageResource(2130849733);
              }
            }
            paramView.rightMargin = 0;
            paramView.leftMargin = afur.a(6.0F, paramContext.getResources());
            return;
          }
          paramahin = new ImageView(paramContext);
          paramahin.setBackgroundDrawable(paramContext.getResources().getDrawable(2130849732));
          paramahin.setId(2131374169);
          paramahin.setVisibility(0);
          RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, afur.a(70.0F, paramContext.getResources()));
          localLayoutParams.addRule(7, 2131372517);
          localLayoutParams.addRule(8, 2131372517);
          if (paramChatMessage.isSend())
          {
            localLayoutParams.rightMargin = afur.a(6.0F, paramContext.getResources());
            localLayoutParams.leftMargin = 0;
            ((RelativeLayout)paramView).addView(paramahin, localLayoutParams);
            paramahin = new ImageView(paramContext);
            if (j != 1) {
              break label441;
            }
          ...
          for (;;)
          {
            paramahin.setId(2131374170);
            paramahin.setVisibility(0);
            paramChatMessage = new RelativeLayout.LayoutParams(-2, -2);
            paramChatMessage.addRule(8, 2131372517);
            paramChatMessage.addRule(14);
            ((RelativeLayout)paramView).addView(paramahin, paramChatMessage);
            return;
            localLayoutParams.rightMargin = 0;
            localLayoutParams.leftMargin = afur.a(6.0F, paramContext.getResources());
            break;
            if (j == 2) {
              paramahin.setImageResource(2130849735);
            } else if (j == 3) {
        ...
        paramView.findViewById(2131374170).setVisibility(4);
        paramView.findViewById(2131374169).setVisibility(4);
        return;
        j = 0;
      }
    }
  ...
  {
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApp(), bckq.class);
  ...
  private void b(AIOShortVideoData paramAIOShortVideoData)
  {
    ...
    if (paramAIOShortVideoData.h == 0)
    {
      ...
      new bcko(this).execute(new String[] { paramAIOShortVideoData.jdField_c_of_type_JavaLangString });
    }
    for (;;)
    {
  ...
  private static boolean b(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    if (bgsg.c(paramQQAppInterface.getApp()))
    {
      if (QLog.isColorLevel()) {
    ...
    if ((paramQQAppInterface.exists()) && (!paramQQAppInterface.isDirectory()))
    {
      try
      {
        paramQQAppInterface = bgmg.b(paramQQAppInterface);
  ...
  public static void c()
  {
    try
    {
      if (!jdField_a_of_type_Boolean) {
        bgsg.e(BaseApplication.getContext(), true);
      }
      return;
    }
    finally {}
  ...
  private void c(AIOShortVideoData paramAIOShortVideoData)
  {
    ...
    {
      this.jdField_c_of_type_AndroidWidgetImageView.setBackgroundResource(2130849736);
    ...
    if (paramAIOShortVideoData.h == 0)
    {
      ...
      {
        this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130849745);
        this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      }
    ...
    for (;;)
    {
      ...
      break;
      label207:
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130849746);
      c();
    }
  }
  ...
  private void d()
  {
    ...
    do
    {
      for (;;)
      {
        ...
        if (!anni.a(2131712060).trim().equals(localObject)) {
          break;
        }
    ...
    } while (!anni.a(2131712058).trim().equals(localObject));
    alio.b("", "0X80088E6");
    j();
    a();
  }
  ...
  private void g()
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(anni.a(2131712057));
      this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(0);
      this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColorStateList(2131166947));
      this.jdField_a_of_type_AndroidWidgetTextView.setTextSize(14.0F);
      this.jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130849737, 0);
  ...
  private void h()
  {
    if ((this.jdField_a_of_type_AndroidWidgetTextView != null) && (this.jdField_a_of_type_AndroidAppActivity != null))
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(anni.a(2131712061));
      this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(0);
  ...
  private void i()
  {
    ...
    if (localCustomFrameAnimationDrawable != null)
    {
      ...
      localCustomFrameAnimationDrawable.c();
      localCustomFrameAnimationDrawable.a(new bckn(this));
      if (this.jdField_a_of_type_AndroidOsHandler == null) {
        this.jdField_a_of_type_AndroidOsHandler = new Handler();
      }
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      return;
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130849740);
      k();
      c();
    }
  }
  ...
  private void k()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(anni.a(2131712059));
    this.jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
    this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColorStateList(2131166948));
    this.jdField_a_of_type_AndroidWidgetTextView.setTextSize(16.0F);
    this.jdField_a_of_type_AndroidWidgetTextView.setPadding(afur.a(12.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), afur.a(5.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), afur.a(12.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), afur.a(5.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()));
    this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130849741);
    this.jdField_a_of_type_AndroidWidgetTextView.bringToFront();
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    ObjectAnimator.ofFloat(this.jdField_a_of_type_AndroidWidgetTextView, "alpha", new float[] { 0.0F, 1.0F }).setDuration(180L).start();
  }
  ...
  private void l()
  {
    ...
    if (localCustomFrameAnimationDrawable != null)
    {
      ...
      localCustomFrameAnimationDrawable.a(new bcki(this, localCustomFrameAnimationDrawable));
      return;
    }
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130849740);
    c();
  ...
  private void n()
  {
    ...
    for (;;)
    {
      ...
      h();
      return;
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130849744);
      c();
    }
  }
  ...
  public ImageView a(Activity paramActivity, ViewGroup paramViewGroup, String paramString)
  {
    ...
    paramString.setId(2131374222);
    Object localObject = new RelativeLayout.LayoutParams(-1, afur.a(180.0F, paramActivity.getResources()));
    ...
    ((TextView)localObject).setId(2131374223);
    localLayoutParams = new RelativeLayout.LayoutParams(-2, -2);
    localLayoutParams.addRule(12);
    localLayoutParams.addRule(14);
    localLayoutParams.bottomMargin = afur.a(10.0F, paramActivity.getResources());
    paramViewGroup.addView((View)localObject, localLayoutParams);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localObject);
    ((TextView)localObject).bringToFront();
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new bckm(this));
    e();
    return paramString;
  }
  ...
  public void a(int paramInt)
  {
    if (paramInt == -1)
    {
      ...
      localCustomFrameAnimationDrawable.c();
      localCustomFrameAnimationDrawable.a(new bckj(this));
    }
    for (;;)
    {
  ...
  public void a(Activity paramActivity)
  {
    if (a())
    {
      ...
      Bundle localBundle = bnbe.a(null, paramActivity.getClass().getName(), 10004, 8);
      ziv.a().a(paramActivity, localBundle, 9010);
    }
  }
