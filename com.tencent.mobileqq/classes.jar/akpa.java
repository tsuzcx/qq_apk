  ...
  extends akov
{
  ...
  public akpa(QQAppInterface paramQQAppInterface)
  {
  ...
  public int a(akxc paramakxc, int paramInt, AppInterface paramAppInterface, Context paramContext)
  {
    ...
    if (this.jdField_b_of_type_Int > 0)
    {
      if (ApolloUtil.c(5, this.jdField_b_of_type_Int))
      {
        ...
        akwt.a(paramakxc, 6, paramContext);
        this.d = true;
      ...
      super.a(paramakxc, paramInt, paramAppInterface, paramContext);
  ...
  {
    paramakxc = new Intent();
    paramakxc.putExtra("extra_key_url_append", "&tab=interactive&suin=" + paramQQAppInterface.getCurrentAccountUin());
    ApolloUtil.a(paramContext, paramakxc, "drawer", alef.ai, null);
  ...
  public void a(akxc paramakxc, Context paramContext, QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    akwt.a(paramakxc, this.jdField_a_of_type_JavaLangString, 7, 0);
