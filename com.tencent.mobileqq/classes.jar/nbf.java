...
public class nbf
  extends mxw
{
  public nbf(AppInterface paramAppInterface)
  {
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (528 == i)
      {
        paramToServiceMsg = abxc.a(((MsgInfo)localObject).vMsg);
    ...
    label230:
    label241:
    for (paramToServiceMsg = mzo.a(((AvGameNotify.NotifyMsg)localObject).type.get());; paramToServiceMsg = "null")
    {
      QLog.d("avgame_logic.GameRoomPushHandler", 1, new Object[] { "handleOnlinePush type=", paramToServiceMsg });
      if (localObject == null) {
        break label75;
      }
      mzs.a((AVGameAppInterface)this.mApp, (AvGameNotify.NotifyMsg)localObject);
      break label75;
      break;
