...
public class wla
{
  ...
  public wla(qqstory_struct.QimVideoInfo paramQimVideoInfo)
  {
  ...
  public static wla a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return new wla(localQimVideoInfo);
    }
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      ykq.c("QimVideoInfoItem", "Error: parse db bytes error.", paramArrayOfByte);
    }
    return null;
  }
