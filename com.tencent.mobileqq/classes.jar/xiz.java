...
public class xiz
  extends RecyclerView.Adapter<xjc>
  implements Handler.Callback
{
  ...
  public xjc a(ViewGroup paramViewGroup, int paramInt)
  {
    return new xjc(this, LayoutInflater.from(paramViewGroup.getContext()).inflate(2131562594, null));
  }
  ...
  {
    VSNetworkHelper.a().a(new BatchGetMusicInfoRequest(paramArrayList), new xjb(this, paramBoolean));
  }
  ...
  public void a(xjc paramxjc, int paramInt)
  {
    ...
    for (;;)
    {
      vzl.a(xjc.a(paramxjc), localVsMusicItemInfo.mAlbumUrl, vzl.a(paramxjc.itemView.getContext(), 60.0F), vzl.a(paramxjc.itemView.getContext(), 60.0F), vzl.a(paramxjc.itemView.getContext(), 30.0F), paramxjc.itemView.getContext().getResources().getDrawable(2130838555), null);
      paramxjc.itemView.setOnClickListener(new xja(this, paramInt, localVsMusicItemInfo));
      return;
      i = a(paramInt);
      break;
      paramxjc.b(false);
  ...
  public void onAttachedToRecyclerView(RecyclerView paramRecyclerView)
  {
    ...
    this.jdField_a_of_type_Xio = this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewSmartMusicRecyclerView.a();
  }
