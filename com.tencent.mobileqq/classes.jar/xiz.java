...
public class xiz
{
  private static SparseArray<xjh> a;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = wnu.a("StorySvc.report_comment");
    b = wnu.a(2131698599);
  ...
  {
    Object localObject2 = zqr.a(a(), paramStoryVideoItem.mVid, paramStoryVideoItem.mVideoWidth, paramStoryVideoItem.mVideoHeight, paramInt);
    if (TextUtils.isEmpty((CharSequence)localObject2)) {
      QLog.i("Q.qqstory.player.PlayModeUtils", 1, "get download water mark failed, logoMarkPath is null!");
    }
    Object localObject3 = zqr.b(paramStoryVideoItem);
    Object localObject1 = zqr.a(paramStoryVideoItem);
    String str = zqr.a(paramStoryVideoItem.getInteractLayout(), paramStoryVideoItem.mVideoWidth, paramStoryVideoItem.mVideoHeight);
    ...
    while ((!TextUtils.isEmpty((CharSequence)localObject3)) && (!TextUtils.isEmpty((CharSequence)localObject1)))
    {
      ...
      if (!zqr.a((String)localObject3, (String)localObject1, str))
      {
    ...
    while ((!TextUtils.isEmpty((CharSequence)localObject1)) && (!TextUtils.isEmpty((CharSequence)localObject2)))
    {
      ...
      if (zqr.a((String)localObject1, (String)localObject2, (String)localObject2)) {
        break label236;
      }
    ...
    for (;;)
    {
      ...
      localObject1 = new bbkn(2000000, (PublishVideoEntry)localObject1);
      ((bbkn)localObject1).b(0);
      localObject2 = new bbkl();
      localObject3 = win.k + paramStoryVideoItem.mVid + ".mp4";
      paramInt = ((bbkl)localObject2).a(paramStoryVideoItem.mLocalVideoPath, (String)localObject3, (bbkn)localObject1);
      if (paramInt == 0) {
        break label481;
      }
      if (paramInt == -1) {
      ...
      yuk.b("Q.qqstory.player.PlayModeUtils", new Throwable("MergeVideoError"), "watermarkVideoByMediaCodec() error after mergeVideo() return, errorCode=%d", new Object[] { Integer.valueOf(paramInt) });
      return paramInt;
      localObject1 = localObject2;
    }
    zom.c(paramStoryVideoItem.mLocalVideoPath, paramString);
    label481:
    for (paramInt = 0;; paramInt = zrl.a((String)localObject3, paramStoryVideoItem.mLocalVideoPath, paramString, 0))
    {
      if (paramInt == 0) {
        zom.a(BaseApplication.getContext(), new File(paramString));
      }
  ...
  {
    paramString = ((wtt)wth.a(2)).b(paramString);
    if (paramString == null)
    {
  ...
  public static final String a(String paramString, boolean paramBoolean)
  {
    ...
    for (String str = ".png";; str = ".mp4") {
      return zqr.a(paramString, str);
    }
  }
  
  @NonNull
  public static xjh a(int paramInt)
  {
    xjh localxjh2 = (xjh)jdField_a_of_type_AndroidUtilSparseArray.get(paramInt);
    xjh localxjh1 = localxjh2;
    if (localxjh2 == null)
    {
      localxjh1 = new xjh();
      jdField_a_of_type_AndroidUtilSparseArray.put(paramInt, localxjh1);
    }
    return localxjh1;
  }
  ...
  public static void a(Context paramContext, CommentEntry paramCommentEntry)
  {
    ...
    do
    {
      do
      {
        ...
        QQToast.a(BaseApplicationImpl.getContext(), 1, anzj.a(2131707090), 0).a();
        yup.b("story_net", jdField_a_of_type_JavaLangString, 0, 99980, new String[] { "", "0", yup.a(BaseApplication.getContext()) });
      } while (!QLog.isColorLevel());
      QLog.w("Q.qqstory.player.PlayModeUtils", 2, "reportVideoCommemt - isNetSupport is false----");
      return;
      paramContext = (blir)blji.b(paramContext, null);
      paramContext.a(anzj.a(2131707082), 5);
      paramContext.a(anzj.a(2131707101), 5);
      paramContext.a(anzj.a(2131707098), 5);
      paramContext.a(anzj.a(2131707086), 5);
      paramContext.c(2131690580);
      paramContext.a(new xjf(paramCommentEntry, paramContext));
  ...
  {
    if (!bhnv.d(BaseApplicationImpl.getContext())) {
      QQToast.a(BaseApplicationImpl.getContext(), 1, anzj.a(2131707099), 0).a();
    }
    do
    {
      return;
      paramContext = (blir)blji.b(paramContext, null);
      paramContext.a(anzj.a(2131707097), 5);
      paramContext.a(anzj.a(2131707091), 5);
      paramContext.a(anzj.a(2131707104), 5);
      paramContext.a(anzj.a(2131707081), 5);
      paramContext.c(2131690580);
      paramContext.a(new xje(paramQQUserUIItem, paramContext));
  ...
  {
    if (!bhnv.d(BaseApplicationImpl.getContext())) {
      QQToast.a(BaseApplicationImpl.getContext(), 1, anzj.a(2131707084), 0).a();
    }
    do
    {
      return;
      paramContext = (blir)blji.b(paramContext, null);
      paramContext.a(anzj.a(2131707080), 5);
      paramContext.a(anzj.a(2131707083), 5);
      paramContext.a(anzj.a(2131707102), 5);
      paramContext.a(anzj.a(2131707103), 5);
      paramContext.c(2131690580);
      paramContext.a(new xjg(paramStoryVideoItem, paramContext));
      paramContext.setOnDismissListener(paramOnDismissListener);
    } while (paramContext.isShowing());
    paramContext.show();
  }
  ...
  {
    boolean bool = false;
    if ((paramResources == null) || (paramTextView == null) || (!nnr.a(paramString))) {
      if (QLog.isColorLevel())
      {
    ...
    do
    {
      ...
      try
      {
        ...
        int i = agej.a(paramFloat1, paramResources);
        ...
        paramTextView.setCompoundDrawablePadding(agej.a(paramFloat2, paramResources));
  ...
  public static void a(Resources paramResources, QQUserUIItem paramQQUserUIItem, ImageView paramImageView, float paramFloat1, TextView paramTextView, float paramFloat2, float paramFloat3, boolean paramBoolean, String paramString)
  {
    ...
    if (wnz.a())
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        i = agej.a(paramFloat1, paramResources);
        ...
        paramTextView.setText(((wtp)wth.a(23)).a(paramQQUserUIItem, paramString, false, true));
      }
    }
    for (;;)
    {
      ...
      localObject = paramResources.getDrawable(2130846840);
      i = agej.a(paramFloat2, paramResources);
      int j = agej.a(paramFloat3, paramResources);
      if (localObject == null) {
        break;
      }
    ...
    {
      paramResources = aoot.a(a(), 1, paramQQUserUIItem.qq, 3, localDrawable, localDrawable);
    ...
    for (;;)
    {
      ...
      return;
      break;
      if (nnr.a(paramQQUserUIItem.headUrl)) {
        a(paramImageView, paramQQUserUIItem.headUrl, true, i);
      } else {
        paramImageView.setImageDrawable(localDrawable);
      }
  ...
  public static final void a(ImageView paramImageView, QQUserUIItem paramQQUserUIItem)
  {
    ...
    paramQQUserUIItem = wnz.a(paramQQUserUIItem);
  ...
  {
    Drawable localDrawable = bhmq.a();
    paramImageView.setImageDrawable(aoot.a(a(), 1, paramString, 3, localDrawable, localDrawable));
  }
  ...
  protected static void a(ImageView paramImageView, String paramString1, int paramInt1, int paramInt2, boolean paramBoolean, Drawable paramDrawable, DownloadParams.DecodeHandler paramDecodeHandler, Object paramObject, String paramString2, xjl paramxjl)
  {
    for (;;)
    {
      try
    ...
    paramString1.setURLDrawableListener(new xja(System.currentTimeMillis(), paramxjl));
  }
  ...
  protected static void a(ImageView paramImageView, String paramString1, int paramInt1, int paramInt2, boolean paramBoolean, DownloadParams.DecodeHandler paramDecodeHandler, Object paramObject, String paramString2, xjl paramxjl)
  {
    a(paramImageView, paramString1, paramInt1, paramInt2, paramBoolean, new ColorDrawable(0), paramDecodeHandler, paramObject, paramString2, paramxjl);
  }
  ...
  public static void a(ImageView paramImageView, String paramString1, String paramString2, boolean paramBoolean, xjl paramxjl)
  {
    String str = null;
    boolean bool = auog.a(paramString1);
    DownloadParams.DecodeHandler localDecodeHandler;
    int[] arrayOfInt;
    if (paramBoolean)
    {
      localDecodeHandler = bhez.s;
      if (!paramBoolean) {
        break label73;
      }
    ...
    for (;;)
    {
      a(paramImageView, paramString1, bdep.jdField_a_of_type_Int / 2, bdep.b / 2, bool, localDecodeHandler, arrayOfInt, str, paramxjl);
      return;
      localDecodeHandler = null;
      break;
      label73:
  ...
  public static void a(ShareFromMemoryPlayInfo paramShareFromMemoryPlayInfo, xjk paramxjk)
  {
    xck localxck = new xck();
    localxck.jdField_c_of_type_JavaLangString = paramShareFromMemoryPlayInfo.uid;
    localxck.d = "";
    localxck.jdField_c_of_type_Int = 20;
    localxck.jdField_e_of_type_Int = paramShareFromMemoryPlayInfo.shareTimeZone;
    localxck.jdField_e_of_type_JavaLangString = paramShareFromMemoryPlayInfo.feedId;
    localxck.f = paramShareFromMemoryPlayInfo.identify;
    localxck.g = paramShareFromMemoryPlayInfo.videoListOrder;
    wow.a().a(localxck, new xjd(paramxjk));
  }
  
  public static void a(QQAppInterface paramQQAppInterface, String paramString, xjm paramxjm)
  {
    ...
    nkm.a(paramQQAppInterface, paramxjm, localReqBatchGetVideoFullInfoList.toByteArray(), xdo.jdField_a_of_type_JavaLangString, paramString);
  }
  
  protected static final void a(zqi paramzqi, String paramString1, StoryVideoItem paramStoryVideoItem, String paramString2, int paramInt, String paramString3)
  {
    try
    {
      xjj localxjj = new xjj(paramString2, paramStoryVideoItem, paramString3);
      paramzqi.a(paramString2);
      paramzqi.a(zqr.a(a(), paramStoryVideoItem.mVid, paramStoryVideoItem.mVideoWidth, paramStoryVideoItem.mVideoHeight, paramInt), paramString1, paramString2, paramStoryVideoItem.mVideoWidth, paramStoryVideoItem.mVideoHeight, localxjj);
      return;
    }
    catch (Exception paramzqi)
    {
      paramString1 = new xji(paramString3, 3, paramStoryVideoItem);
      wjj.a().dispatch(paramString1);
      QLog.e("Q.qqstory.player.PlayModeUtils", 2, paramzqi.getMessage());
    }
  }
  ...
  public static boolean a(StoryVideoItem paramStoryVideoItem, Context paramContext)
  {
    ...
    yuk.a("Q.qqstory.player.PlayModeUtils", "onClickRetryUploadBtn=%s", paramStoryVideoItem);
    yup.a("mystory", "clk_retry", 0, 0, new String[0]);
    if (wmd.a(paramStoryVideoItem.mUpLoadFailedError))
    {
      yuk.d("Q.qqstory.player.PlayModeUtils", "video file not exist, vid:%s", new Object[] { paramStoryVideoItem.mVid });
      String str = paramStoryVideoItem.mVid;
      paramContext = bhlq.a(paramContext, 230);
      paramContext.setTitle(anzj.a(2131707089));
      if (wmd.b(paramStoryVideoItem.mUpLoadFailedError)) {
        paramContext.setMessage(anzj.a(2131707096));
      }
      for (;;)
      {
        paramContext.setPositiveButton(anzj.a(2131707095), new xjc(paramStoryVideoItem, str));
        paramContext.setCancelable(false);
        paramContext.getWindow().setBackgroundDrawable(new ColorDrawable(0));
        paramContext.show();
        return false;
        paramContext.setMessage(anzj.a(2131707092));
      }
    }
    return wlt.a(paramStoryVideoItem, paramContext);
  }
  
  public static final String b(QQUserUIItem paramQQUserUIItem)
  {
    return wnz.b(paramQQUserUIItem);
  }
  ...
  {
    a(paramImageView, paramString1, paramInt1, paramInt2, paramBoolean, bhmq.b(), paramDecodeHandler, paramObject, paramString2);
  }
  ...
  public static void b(ImageView paramImageView, String paramString1, String paramString2, boolean paramBoolean, xjl paramxjl)
  {
    String str = null;
    boolean bool = auog.a(paramString1);
    DownloadParams.DecodeHandler localDecodeHandler;
    ...
    for (;;)
    {
      a(paramImageView, paramString1, bdep.jdField_a_of_type_Int, bdep.b, bool, localDecodeHandler, arrayOfInt, str, paramxjl);
      return;
      localDecodeHandler = null;
      break;
      label69:
  ...
  public static void b(StoryVideoItem paramStoryVideoItem, int paramInt, String paramString)
  {
    ...
    {
      paramStoryVideoItem = new xji(paramString, 3, paramStoryVideoItem);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i == 0)
        {
          paramString = new xji(paramString, 2, paramStoryVideoItem);
          paramString.b = str2;
          wjj.a().dispatch(paramString);
          long l2 = paramStoryVideoItem.mVideoDuration;
          yup.a("play_video", "down_watermark_time", 1, 0, new String[] { String.valueOf(SystemClock.uptimeMillis() - l1), String.valueOf(l2) });
          yup.a("play_video", "down_watermark", 1, 0, new String[0]);
          yup.a("play_video", "down_suc", 1, 0, new String[] { "", "", "", paramStoryVideoItem.mVid });
          return;
        }
      }
      catch (IllegalStateException localIllegalStateException)
      {
        ...
        Object localObject1 = win.k + paramStoryVideoItem.mVid + ".mp4";
        zqi localzqi = zqi.a(a());
        if (localzqi.a())
        {
          if (!localzqi.a(str2))
          {
            paramStoryVideoItem = new xji(paramString, 1, paramStoryVideoItem);
            wjj.a().dispatch(paramStoryVideoItem);
          }
        }
        else
        {
          if (zom.c(str2))
          {
            paramStoryVideoItem = new xji(paramString, 2, paramStoryVideoItem);
            paramStoryVideoItem.b = str2;
            wjj.a().dispatch(paramStoryVideoItem);
            return;
          }
          if (zom.c((String)localObject1))
          {
            a(localzqi, (String)localObject1, paramStoryVideoItem, str2, paramInt, paramString);
            return;
          }
          if ((paramStoryVideoItem.getVideoMaskType() == 0) && (!paramStoryVideoItem.isPollVideo()) && (!paramStoryVideoItem.isInteractVideo()))
          {
            a(localzqi, paramStoryVideoItem.mLocalVideoPath, paramStoryVideoItem, str2, paramInt, paramString);
            return;
          }
          Object localObject3 = zqr.a(a(), paramStoryVideoItem.mVid, paramStoryVideoItem.mVideoWidth, paramStoryVideoItem.mVideoHeight, paramInt);
          if (TextUtils.isEmpty((CharSequence)localObject3)) {
            QLog.i("Q.qqstory.player.PlayModeUtils", 1, "get download water mark failed, logoMarkPath is null!");
          }
          Object localObject2 = zqr.b(paramStoryVideoItem);
          localObject1 = zqr.a(paramStoryVideoItem);
          String str1 = zqr.a(paramStoryVideoItem.getInteractLayout(), paramStoryVideoItem.mVideoWidth, paramStoryVideoItem.mVideoHeight);
          if (!TextUtils.isEmpty((CharSequence)localObject1)) {}
          while ((!TextUtils.isEmpty((CharSequence)localObject2)) && (!TextUtils.isEmpty((CharSequence)localObject1)))
          {
            ...
            if (!zqr.a((String)localObject2, (String)localObject1, str1))
            {
              paramStoryVideoItem = new xji(paramString, 3, paramStoryVideoItem);
              wjj.a().dispatch(paramStoryVideoItem);
              QLog.e("Q.qqstory.player.PlayModeUtils", 2, "combineTwoImg maxMask videoVote failed");
          ...
          while ((!TextUtils.isEmpty((CharSequence)localObject1)) && (!TextUtils.isEmpty((CharSequence)localObject3))) {
            if (!zqr.a((String)localObject1, (String)localObject3, (String)localObject3))
            {
              paramStoryVideoItem = new xji(paramString, 3, paramStoryVideoItem);
              wjj.a().dispatch(paramStoryVideoItem);
          ...
          for (;;)
          {
            try
            {
              localObject1 = new xjj(str2, paramStoryVideoItem, paramString);
              localzqi.a(str2);
              paramInt = zqb.b(paramStoryVideoItem.mLocalVideoPath);
              if ((paramInt != 0) && (paramInt != -1)) {
                break;
              }
              localzqi.a((String)localObject2, paramStoryVideoItem.mLocalVideoPath, str2, paramStoryVideoItem.mVideoWidth, paramStoryVideoItem.mVideoHeight, (zqq)localObject1);
              return;
            }
          ...
          str1 = win.k + "hflip" + paramStoryVideoItem.mVid + ".mp4";
          if (!zom.c(str1))
          {
            localObject4 = new zqo();
            ((zqo)localObject4).jdField_a_of_type_Int = 10;
            ((zqo)localObject4).jdField_a_of_type_JavaUtilArrayList = new PlayModeUtils.3(paramStoryVideoItem, str1);
            ((zqo)localObject4).jdField_a_of_type_Zqq = new zra(localException);
            ((ArrayList)localObject3).add(localObject4);
            localObject4 = new xji(paramString, 0, paramStoryVideoItem);
            wjj.a().dispatch((Dispatcher.Dispatchable)localObject4);
          }
          Object localObject4 = new zqo();
          ((zqo)localObject4).jdField_a_of_type_Int = 1;
          ((zqo)localObject4).jdField_a_of_type_JavaUtilArrayList = new PlayModeUtils.4((String)localObject2, str1, str2, paramStoryVideoItem);
          ((zqo)localObject4).jdField_a_of_type_Zqq = localException;
          ((ArrayList)localObject3).add(localObject4);
          localzqi.a((ArrayList)localObject3);
        }
      }
    }
  }
  ...
  {
    xji localxji = new xji(paramString, 0, paramStoryVideoItem);
