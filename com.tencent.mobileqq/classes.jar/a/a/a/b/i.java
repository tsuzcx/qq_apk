...
public class i
{
  ...
  public static i.b a(DataInputStream paramDataInputStream)
  {
    i.b localb = new i.b(null);
    try
    {
  ...
  public static PublicKey a(String paramString)
  {
    ...
    try
    {
      paramString = KeyFactory.getInstance(h.a(c)).generatePublic(paramString);
      return paramString;
    }
  ...
  public static boolean a(DataInputStream paramDataInputStream, int paramInt, byte[] paramArrayOfByte, PublicKey paramPublicKey)
  {
    for (;;)
    {
      ...
      try
      {
        localSignature = Signature.getInstance(h.a(b));
  ...
  public static boolean a(java.io.File paramFile, String paramString)
  {
    ...
    //   1: astore 6
    //   3: aload_0
    //   4: invokevirtual 107	java/io/File:exists	()Z
    //   7: ifne +5 -> 12
    //   10: iconst_0
    //   11: ireturn
    //   12: new 28	java/io/DataInputStream
    //   15: dup
    //   16: new 109	java/io/FileInputStream
    //   19: dup
    //   20: aload_0
    //   21: invokespecial 112	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   24: invokespecial 115	java/io/DataInputStream:<init>	(Ljava/io/InputStream;)V
    //   27: astore 5
    //   29: aload 5
    //   31: invokevirtual 118	java/io/DataInputStream:available	()I
    //   34: istore_2
    //   35: iload_2
    //   36: sipush 140
    //   39: if_icmpgt +17 -> 56
    //   42: aload 5
    //   44: invokevirtual 121	java/io/DataInputStream:close	()V
    //   47: iconst_0
    //   48: ireturn
    //   49: astore_0
    //   50: aload_0
    ...
    //   62: aload 5
    //   64: iload_2
    //   65: invokevirtual 125	java/io/DataInputStream:skipBytes	(I)I
    //   68: pop
    //   69: aload 5
    //   71: invokestatic 127	a/a/a/b/i:a	(Ljava/io/DataInputStream;)La/a/a/b/i$b;
    //   74: astore 7
    //   76: aload 7
    //   78: ifnonnull +17 -> 95
    //   81: aload 5
    //   83: invokevirtual 121	java/io/DataInputStream:close	()V
    //   86: iconst_0
    //   87: ireturn
    //   88: astore_0
    //   89: aload_0
    ...
    //   94: ireturn
    //   95: aload 7
    //   97: getfield 35	a/a/a/b/i$b:a	I
    //   100: istore_3
    //   101: iload_3
    //   102: ldc 128
    //   104: if_icmpeq +17 -> 121
    //   107: aload 5
    //   109: invokevirtual 121	java/io/DataInputStream:close	()V
    //   112: iconst_0
    //   113: ireturn
    //   114: astore_0
    //   115: aload_0
    ...
    //   120: ireturn
    //   121: aload 7
    //   123: getfield 37	a/a/a/b/i$b:b	I
    //   126: istore_3
    //   127: iload_3
    //   128: ifle +9 -> 137
    //   131: iload_3
    ...
    //   137: aload 5
    //   139: invokevirtual 121	java/io/DataInputStream:close	()V
    //   142: iconst_0
    //   143: ireturn
    //   144: astore_0
    //   145: aload_0
    //   146: invokevirtual 49	java/io/IOException:printStackTrace	()V
    //   149: iconst_0
    //   150: ireturn
    //   151: iload_2
    //   152: iload_3
    ...
    //   156: aload 5
    //   158: invokevirtual 121	java/io/DataInputStream:close	()V
    //   161: iconst_0
    //   162: ireturn
    //   163: astore_0
    //   164: aload_0
    //   165: invokevirtual 49	java/io/IOException:printStackTrace	()V
    //   168: iconst_0
    //   169: ireturn
    //   170: aload_1
    //   171: invokestatic 131	a/a/a/b/i:a	(Ljava/lang/String;)Ljava/security/PublicKey;
    //   174: astore_1
    //   175: aload_1
    //   176: ifnonnull +17 -> 193
    //   179: aload 5
    //   181: invokevirtual 121	java/io/DataInputStream:close	()V
    //   184: iconst_0
    //   185: ireturn
    //   186: astore_0
    //   187: aload_0
    ...
    //   191: iconst_0
    //   192: ireturn
    //   193: new 28	java/io/DataInputStream
    //   196: dup
    //   197: new 109	java/io/FileInputStream
    //   200: dup
    //   201: aload_0
    //   202: invokespecial 112	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   205: invokespecial 115	java/io/DataInputStream:<init>	(Ljava/io/InputStream;)V
    //   208: astore_0
    //   209: aload_0
    //   210: aload 7
    //   212: getfield 37	a/a/a/b/i$b:b	I
    //   215: aload 7
    //   217: getfield 42	a/a/a/b/i$b:d	[B
    //   220: aload_1
    //   221: invokestatic 133	a/a/a/b/i:a	(Ljava/io/DataInputStream;I[BLjava/security/PublicKey;)Z
    //   224: istore 4
    //   226: aload 5
    //   228: invokevirtual 121	java/io/DataInputStream:close	()V
    //   231: aload_0
    //   232: invokevirtual 121	java/io/DataInputStream:close	()V
    //   235: iload 4
    //   237: ireturn
    //   238: astore_0
    //   239: aload_0
    //   240: invokevirtual 49	java/io/IOException:printStackTrace	()V
    //   243: iload 4
    //   245: ireturn
    //   246: astore_1
    //   247: aload_1
    //   248: invokevirtual 49	java/io/IOException:printStackTrace	()V
    //   251: goto -20 -> 231
    //   254: astore 6
    //   256: aload 5
    //   258: astore_1
    ...
    //   261: astore 5
    //   263: aload 5
    //   265: invokevirtual 49	java/io/IOException:printStackTrace	()V
    //   268: aload_1
    //   269: ifnull +7 -> 276
    //   272: aload_1
    //   273: invokevirtual 121	java/io/DataInputStream:close	()V
    //   276: aload_0
    //   277: ifnull -267 -> 10
    //   280: aload_0
    //   281: invokevirtual 121	java/io/DataInputStream:close	()V
    //   284: iconst_0
    //   285: ireturn
    //   286: astore_0
    //   287: aload_0
    ...
    //   316: ifnull +8 -> 324
    //   319: aload 5
    //   321: invokevirtual 121	java/io/DataInputStream:close	()V
    //   324: aload_1
    //   325: ifnull +7 -> 332
    //   328: aload_1
    //   329: invokevirtual 121	java/io/DataInputStream:close	()V
    //   332: aload_0
    //   333: athrow
    //   334: astore 5
    //   336: aconst_null
    ...
    //   343: astore_1
    //   344: aload_1
    //   345: invokevirtual 49	java/io/IOException:printStackTrace	()V
    //   348: goto -72 -> 276
    //   351: astore 6
    //   353: aload 5
    //   355: astore_1
    ...
    //   375: astore 5
    //   377: aload 5
    //   379: invokevirtual 49	java/io/IOException:printStackTrace	()V
    //   382: goto -58 -> 324
    //   385: astore_1
    //   386: aload_1
    //   387: invokevirtual 49	java/io/IOException:printStackTrace	()V
    //   390: goto -58 -> 332
    //   393: astore 5
    //   395: goto -35 -> 360
    //   398: astore_0
  ...
  public static boolean a(byte[] paramArrayOfByte, String paramString)
  {
    ...
    //   7: iconst_0
    //   8: ireturn
    //   9: new 28	java/io/DataInputStream
    //   12: dup
    //   13: new 136	java/io/ByteArrayInputStream
    //   16: dup
    //   17: aload_0
    //   18: invokespecial 137	java/io/ByteArrayInputStream:<init>	([B)V
    //   21: invokespecial 115	java/io/DataInputStream:<init>	(Ljava/io/InputStream;)V
    //   24: astore 5
    //   26: aload 5
    //   28: invokevirtual 118	java/io/DataInputStream:available	()I
    //   31: istore_2
    //   32: iload_2
    //   33: sipush 140
    //   36: if_icmpgt +17 -> 53
    //   39: aload 5
    //   41: invokevirtual 121	java/io/DataInputStream:close	()V
    //   44: iconst_0
    //   45: ireturn
    //   46: astore_0
    //   47: aload_0
    //   48: invokevirtual 49	java/io/IOException:printStackTrace	()V
    //   51: iconst_0
    //   52: ireturn
    //   53: iload_2
    //   54: sipush 140
    ...
    //   59: aload 5
    //   61: iload_2
    //   62: invokevirtual 125	java/io/DataInputStream:skipBytes	(I)I
    //   65: pop
    //   66: aload 5
    //   68: invokestatic 127	a/a/a/b/i:a	(Ljava/io/DataInputStream;)La/a/a/b/i$b;
    //   71: astore 7
    //   73: aload 7
    //   75: ifnonnull +17 -> 92
    //   78: aload 5
    //   80: invokevirtual 121	java/io/DataInputStream:close	()V
    //   83: iconst_0
    //   84: ireturn
    //   85: astore_0
    //   86: aload_0
    ...
    //   91: ireturn
    //   92: aload 7
    //   94: getfield 35	a/a/a/b/i$b:a	I
    //   97: istore_3
    //   98: iload_3
    //   99: ldc 128
    //   101: if_icmpeq +17 -> 118
    //   104: aload 5
    //   106: invokevirtual 121	java/io/DataInputStream:close	()V
    //   109: iconst_0
    //   110: ireturn
    //   111: astore_0
    //   112: aload_0
    //   113: invokevirtual 49	java/io/IOException:printStackTrace	()V
    //   116: iconst_0
    //   117: ireturn
    //   118: aload 7
    //   120: getfield 37	a/a/a/b/i$b:b	I
    //   123: istore_3
    //   124: iload_3
    //   125: ifle +9 -> 134
    //   128: iload_3
    ...
    //   134: aload 5
    //   136: invokevirtual 121	java/io/DataInputStream:close	()V
    //   139: iconst_0
    //   140: ireturn
    //   141: astore_0
    //   142: aload_0
    ...
    //   153: aload 5
    //   155: invokevirtual 121	java/io/DataInputStream:close	()V
    //   158: iconst_0
    //   159: ireturn
    //   160: astore_0
    //   161: aload_0
    //   162: invokevirtual 49	java/io/IOException:printStackTrace	()V
    //   165: iconst_0
    //   166: ireturn
    //   167: aload_1
    //   168: invokestatic 131	a/a/a/b/i:a	(Ljava/lang/String;)Ljava/security/PublicKey;
    //   171: astore_1
    //   172: aload_1
    //   173: ifnonnull +17 -> 190
    //   176: aload 5
    //   178: invokevirtual 121	java/io/DataInputStream:close	()V
    //   181: iconst_0
    //   182: ireturn
    //   183: astore_0
    //   184: aload_0
    //   185: invokevirtual 49	java/io/IOException:printStackTrace	()V
    //   188: iconst_0
    //   189: ireturn
    //   190: new 28	java/io/DataInputStream
    //   193: dup
    //   194: new 136	java/io/ByteArrayInputStream
    //   197: dup
    //   198: aload_0
    //   199: invokespecial 137	java/io/ByteArrayInputStream:<init>	([B)V
    //   202: invokespecial 115	java/io/DataInputStream:<init>	(Ljava/io/InputStream;)V
    //   205: astore_0
    //   206: aload_0
    //   207: aload 7
    //   209: getfield 37	a/a/a/b/i$b:b	I
    //   212: aload 7
    //   214: getfield 42	a/a/a/b/i$b:d	[B
    //   217: aload_1
    //   218: invokestatic 133	a/a/a/b/i:a	(Ljava/io/DataInputStream;I[BLjava/security/PublicKey;)Z
    //   221: istore 4
    //   223: aload 5
    //   225: invokevirtual 121	java/io/DataInputStream:close	()V
    //   228: aload_0
    //   229: invokevirtual 121	java/io/DataInputStream:close	()V
    //   232: iload 4
    //   234: ireturn
    //   235: astore_0
    //   236: aload_0
    //   237: invokevirtual 49	java/io/IOException:printStackTrace	()V
    //   240: iload 4
    //   242: ireturn
    //   243: astore_1
    //   244: aload_1
    //   245: invokevirtual 49	java/io/IOException:printStackTrace	()V
    //   248: goto -20 -> 228
    //   251: astore 6
    //   253: aload 5
    //   255: astore_1
    ...
    //   258: astore 5
    //   260: aload 5
    //   262: invokevirtual 49	java/io/IOException:printStackTrace	()V
    //   265: aload_1
    //   266: ifnull +7 -> 273
    //   269: aload_1
    //   270: invokevirtual 121	java/io/DataInputStream:close	()V
    //   273: aload_0
    //   274: ifnull -267 -> 7
    //   277: aload_0
    //   278: invokevirtual 121	java/io/DataInputStream:close	()V
    //   281: iconst_0
    //   282: ireturn
    //   283: astore_0
    //   284: aload_0
    //   285: invokevirtual 49	java/io/IOException:printStackTrace	()V
    //   288: iconst_0
    //   289: ireturn
    //   290: astore 6
    //   292: aload 5
    ...
    //   313: ifnull +8 -> 321
    //   316: aload 5
    //   318: invokevirtual 121	java/io/DataInputStream:close	()V
    //   321: aload_1
    //   322: ifnull +7 -> 329
    //   325: aload_1
    //   326: invokevirtual 121	java/io/DataInputStream:close	()V
    //   329: aload_0
    //   330: athrow
    //   331: astore 5
    //   333: aconst_null
    ...
    //   340: astore_1
    //   341: aload_1
    //   342: invokevirtual 49	java/io/IOException:printStackTrace	()V
    //   345: goto -72 -> 273
    //   348: astore 6
    //   350: aload 5
    //   352: astore_1
    ...
    //   382: astore_1
    //   383: aload_1
    //   384: invokevirtual 49	java/io/IOException:printStackTrace	()V
    //   387: goto -58 -> 329
    //   390: astore 5
    //   392: goto -35 -> 357
    //   395: astore_0
