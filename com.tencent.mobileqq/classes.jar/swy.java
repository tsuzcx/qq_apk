...
public class swy
{
  private static Map<String, swz> jdField_a_of_type_JavaUtilMap = new HashMap();
  ...
  public static pbg a(ArticleInfo paramArticleInfo)
  {
    ...
    localpbg.b("folder_status", pay.d);
    localpbg.b("feeds_source", paramArticleInfo.mSubscribeID);
    localpbg.b("feeds_type", paramArticleInfo.mFeedType);
    localpbg.b("kandian_mode", pay.e());
    localpbg.b("tab_source", pay.d());
    localpbg.b("rowkey", paramArticleInfo.innerUniqueID);
    localpbg.a("channel_id", paramArticleInfo.mChannelID);
    return localpbg;
  }
  
  public static pbg a(ArticleInfo paramArticleInfo, boolean paramBoolean, long paramLong, int paramInt)
  {
    pbg localpbg = pay.a();
    localpbg.b("algorithm_id", "" + paramArticleInfo.mAlgorithmID);
    localpbg.b("strategy_id", "" + paramArticleInfo.mStrategyId);
    if (paramBoolean) {}
    for (String str = "2";; str = "1")
    {
      localpbg.b("feeds_channel_entrance", str);
      localpbg.b("mp_article_id", "" + paramArticleInfo.mArticleID);
      localpbg.b("rowkey", paramArticleInfo.innerUniqueID);
      localpbg.b("channel_id", "" + a(paramBoolean, paramLong));
      if (paramInt != -1) {
        localpbg.b("source_extratype", paramInt);
      }
      return localpbg;
    }
  }
  
  private static swz a(String paramString)
  {
    swz localswz2 = (swz)jdField_a_of_type_JavaUtilMap.get(paramString);
    swz localswz1 = localswz2;
    if (localswz2 == null)
    {
      localswz1 = new swz(pbm.a(paramString));
      jdField_a_of_type_JavaUtilMap.put(paramString, localswz1);
    }
    return localswz1;
  }
  ...
  public static void a(Context paramContext, AppInterface paramAppInterface, ArticleInfo paramArticleInfo, int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2, JSONObject paramJSONObject)
  {
    ...
    paramContext = ozb.a(paramContext, paramAppInterface.getCurrentAccountUin(), i, paramArticleInfo.mArticleID, paramArticleInfo.innerUniqueID, paramInt1, paramInt2, paramBoolean1, null);
    if (paramBoolean2) {
      paramInt1 = 1;
    }
    try
    {
      for (;;)
      {
        ...
        ozw.a(paramContext, paramJSONObject);
        odq.a(null, "", "0X8009544", "0X8009544", 0, 0, "", String.valueOf(paramArticleInfo.mArticleID), String.valueOf(paramArticleInfo.mAlgorithmID), paramContext.toString(), false);
        return;
        paramInt1 = 0;
      }
    }
  ...
  public static void a(Context paramContext, AppInterface paramAppInterface, ArticleInfo paramArticleInfo, int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    int i = a((int)paramArticleInfo.mChannelID, paramArticleInfo.mFeedType);
    paramContext = ozb.a(paramContext, paramAppInterface.getCurrentAccountUin(), i, paramArticleInfo.mArticleID, paramArticleInfo.innerUniqueID, paramInt1, paramInt2, paramBoolean1, Boolean.valueOf(paramBoolean2));
    if (paramBoolean3) {
      paramInt1 = 1;
    }
    try
    {
      ...
      {
        paramContext.put("is_redpack", paramInt1);
        odq.a(null, "", "0X800979D", "0X800979D", 0, 0, "", String.valueOf(paramArticleInfo.mArticleID), String.valueOf(paramArticleInfo.mAlgorithmID), paramContext.toString(), false);
  ...
  public static void a(VideoInfo paramVideoInfo, boolean paramBoolean)
  {
    ...
    paramVideoInfo = new sie(paramVideoInfo).i(paramVideoInfo.g).n(3);
    if (paramBoolean) {}
    for (int i = 1;; i = 2)
    {
      odq.a(null, null, "0X800A731", "0X800A731", 0, 0, "", "", "", paramVideoInfo.o(i).a().a(), false);
      return;
    }
  }
  ...
  private static void a(ArticleInfo paramArticleInfo)
  {
    ...
    try
    {
      ...
      odq.a(null, "CliOper", "", "", "0X800B554", "0X800B554", 0, 0, "", "", "", localJSONObject.toString(), false);
      return;
    }
    catch (Exception paramArticleInfo)
    {
  ...
  public static void a(ArticleInfo paramArticleInfo, int paramInt1, int paramInt2, pbg parampbg)
  {
    int j = BaseApplicationImpl.getApplication().getResources().getDisplayMetrics().widthPixels;
    int i = Utils.px2dp(paramInt1);
    j = Utils.px2dp(j);
    parampbg.b("read_area", "" + j * i);
    parampbg.b("article_page", "" + Utils.px2dp(paramInt2));
    parampbg.b("read_page", "" + Utils.px2dp(paramInt1));
    odq.a(null, "CliOper", "", "", "0X8009782", "0X8009782", 0, 0, "" + paramArticleInfo.mArticleID, "", "", parampbg.a(), false);
  }
  ...
  public static void a(ArticleInfo paramArticleInfo, int paramInt1, int paramInt2, boolean paramBoolean, long paramLong, int paramInt3)
  {
    ...
    pbg localpbg = a(paramArticleInfo, paramBoolean, paramLong, paramInt3);
    a(paramArticleInfo, paramInt2, localpbg);
    a(paramArticleInfo, localpbg);
    a(paramArticleInfo, paramInt1, paramInt2, localpbg);
    b(paramArticleInfo, localpbg);
    c(paramArticleInfo, a(paramArticleInfo, paramBoolean, paramLong, paramInt3));
  }
  
  public static void a(ArticleInfo paramArticleInfo, int paramInt, pbg parampbg)
  {
    ArrayList localArrayList = new ArrayList();
    oidb_cmd0x80a.AttributeList localAttributeList = new oidb_cmd0x80a.AttributeList();
    localAttributeList.att_id.set(1);
    localAttributeList.att_name.set("body_show_time");
    long l3 = pbm.b(a(paramArticleInfo, 0));
    ...
    for (;;)
    {
      if (((oidb_cmd0x80a.AttributeList)localObject1).att_value.get() != null)
      {
        ...
        ugf.a(201, localArrayList);
      }
      try
      {
        parampbg.a("body_show_time", String.valueOf(l3));
        parampbg.a("body_height", String.valueOf(paramInt));
        parampbg.a("scroll_time", String.valueOf(l2));
        parampbg.a("scroll_list", localStringBuilder.toString());
        odq.a(null, "", "0X800A467", "0X800A467", 0, 0, "", "", "", parampbg.a(), false);
        return;
        label666:
  ...
  public static void a(ArticleInfo paramArticleInfo, long paramLong1, long paramLong2, pbg parampbg)
  {
    if (paramArticleInfo == null) {
      return;
    }
    parampbg.b("read_duration", "" + paramLong1 / 1000L);
    parampbg.b("read_begin_timestamp", "" + paramLong2 / 1000L);
    parampbg.b("read_end_timestamp", "" + NetConnInfoCenter.getServerTime());
    odq.a(null, "CliOper", "", "" + paramArticleInfo.mSubscribeID, "0X8009781", "0X8009781", 0, 0, "" + paramArticleInfo.mArticleID, "", "", parampbg.a(), false);
  }
  ...
  {
    odq.a(null, "CliOper", "", paramArticleInfo.mSubscribeID, paramString1, paramString1, 0, 0, paramArticleInfo.mArticleID + "", paramArticleInfo.mAlgorithmID + "", paramArticleInfo.innerUniqueID, paramString2, false);
  }
  ...
  public static void a(ArticleInfo paramArticleInfo, String paramString, JSONObject paramJSONObject)
  {
    ...
    odq.a(null, "", paramString, paramString, 0, 0, String.valueOf(paramArticleInfo.mArticleID), String.valueOf(paramArticleInfo.mStrategyId), paramArticleInfo.innerUniqueID, paramJSONObject.toString(), false);
  }
  ...
  public static void a(ArticleInfo paramArticleInfo, pbg parampbg)
  {
    if (paramArticleInfo != null)
    {
      a(paramArticleInfo, pbm.b(paramArticleInfo.innerUniqueID), pbm.a(paramArticleInfo.innerUniqueID), parampbg);
      pbm.a(paramArticleInfo.innerUniqueID);
    }
  }
  ...
  public static void a(BaseData paramBaseData, String paramString)
  {
    ...
    pbg localpbg = new pbg();
    localpbg.b("card_source", localProteusBookData.c);
    localpbg.b("topic_id", localProteusBookData.d);
    localpbg.b("source_id", localProteusBookData.e);
    odq.a(null, "CliOper", "", "" + localFastWebArticleInfo.d, paramString, paramString, 0, 0, localFastWebArticleInfo.o + "", paramBaseData.mAlgorithmID + "", paramBaseData.innerUniqueID, localpbg.a(), false);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, AdData paramAdData)
  {
    ...
    {
      obb.b(paramQQAppInterface, paramAdData);
      QLog.d("Q.readinjoy.fast_web", 2, " doReportAdShow " + paramAdData.b + "  : " + paramAdData.c);
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, AdData paramAdData, float paramFloat, long paramLong)
  {
    if ((paramQQAppInterface != null) && (paramAdData != null))
    {
      ...
      tqk.a(false, paramQQAppInterface.getApp().getApplicationContext(), tws.a(paramAdData), obb.Y, obb.jdField_b_of_type_Int, 3);
    }
    for (;;)
    {
      ...
      return;
      label111:
      obb.a(paramQQAppInterface, paramAdData, paramFloat, paramLong);
    }
  }
  ...
  public static void a(ColorNote paramColorNote)
  {
    ...
    if (paramColorNote.mSubType.startsWith(aplx.a))
    {
      d(paramColorNote);
      return;
    }
  ...
  public static void a(String paramString, JSONObject paramJSONObject1, JSONObject paramJSONObject2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramString = new pbg(localJSONObject2);
        paramString.e();
        odq.a(null, "", str, str, 0, 0, "", "", "", paramString.a(), false);
  ...
  public static void a(JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        Object localObject2 = new pbg((JSONObject)localObject1);
        ((pbg)localObject2).e();
        odq.a(null, "", str, str, 0, 0, "", "", "", ((pbg)localObject2).a(), false);
        ...
        try
        {
          ...
          else
          {
            ...
            bbda.a(null, new ReportModelDC02528().module("all_search").action("exp_jingtan_list").obj1("2049").ver2("kandian").ver4(str).ver6(localJSONObject.getString("articleRowKey")).ver7("{\"title\":\"" + localJSONObject.getString("articleTitle") + "\"}").session_id(paramJSONObject.getString("kdschSessionId")));
            return;
          }
        }
  ...
  public static void b(ArticleInfo paramArticleInfo, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        pbg localpbg = a(paramArticleInfo);
        localpbg.b("source_from", paramString2);
        if (!pay.p()) {
          continue;
        }
        i = 1;
      ...
      odq.a(null, paramArticleInfo.mSubscribeID, paramString1, paramString1, 0, 0, String.valueOf(paramArticleInfo.mFeedId), String.valueOf(paramArticleInfo.mArticleID), "", paramString2, false);
      return;
      i = 0;
    }
  }
  
  public static void b(ArticleInfo paramArticleInfo, pbg parampbg)
  {
    swz localswz = a(paramArticleInfo.innerUniqueID);
    if (localswz.a.isEmpty()) {
      return;
    }
    parampbg.i();
    parampbg.b("read_begin_timestamp", "" + localswz.jdField_b_of_type_Long / 1000L);
    parampbg.b("read_end_timestamp", "" + localswz.c / 1000L);
    String str1 = "";
    Iterator localIterator = localswz.a.iterator();
    long l = 0L;
    ...
    parampbg.b("read_speed_array", str1);
    parampbg.b("avg_speed", "" + l / localswz.a.size());
    odq.a(null, "CliOper", "", "", "0X8009783", "0X8009783", 0, 0, "" + paramArticleInfo.mArticleID, "", "", parampbg.a(), false);
  ...
  public static void b(QQAppInterface paramQQAppInterface, AdData paramAdData)
  {
    ...
    for (;;)
    {
      ...
      return;
      label91:
      obb.c(paramQQAppInterface, paramAdData);
    }
  }
  
  public static void b(ColorNote paramColorNote)
  {
    paramColorNote = tgl.b(paramColorNote);
    if ((paramColorNote == null) || (paramColorNote.length() == 0)) {
      return;
    }
    odq.a(null, null, "0X800A731", "0X800A731", 0, 0, "", "", "", new sie(paramColorNote.toString()).a().a(), false);
  }
  ...
  public static void b(JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      paramJSONObject = new pbg(localJSONObject);
      paramJSONObject.e();
      odq.a(null, "", "0X8009A7D", "0X8009A7D", 0, 0, "", "", "", paramJSONObject.a(), false);
      return;
    }
    catch (Exception paramJSONObject) {}
  }
  ...
  private static void c(ArticleInfo paramArticleInfo, pbg parampbg)
  {
    int i = 0;
    try
    {
      ...
      while (i < j)
      {
        ...
        long l = pbm.b(str);
        parampbg.a(jdField_a_of_type_ArrayOfJavaLangString[localInteger.intValue()] + "_duration_millis", l);
        pbm.a(str);
        i += 1;
      }
      odq.a(null, "CliOper", "", "" + paramArticleInfo.mSubscribeID, "0X80099D2", "0X80099D2", 0, 0, "", "" + paramArticleInfo.mArticleID, "", parampbg.a(), false);
      return;
    }
    catch (Exception paramArticleInfo)
    {
