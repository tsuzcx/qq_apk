...
public class swy
{
  ...
  private static QQHashMap<Integer, swz> jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap;
  ...
  {
    swz localswz = a(paramQQAppInterface, paramContext, paramInt);
    if (localswz != null) {
      return localswz.a();
    }
  ...
  public static swz a(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt)
  {
    int i1 = paramInt;
    if (paramInt == 3) {
      i1 = 2;
    ...
    return (swz)jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.get(Integer.valueOf(i1));
  }
  ...
  private static void a(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      return;
      paramQQAppInterface = new swz(paramQQAppInterface, paramContext, 2, (String)localObject, str);
      jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.put(Integer.valueOf(2), paramQQAppInterface);
    }
  }
  ...
  public static void a(ArrayList<swz> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      {
        swz localswz = (swz)paramArrayList.next();
        jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.put(Integer.valueOf(localswz.jdField_a_of_type_Int), localswz);
      }
    }
  }
    ...
    try
    {
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        while (i1 < i2)
        {
          ...
          localObject = new swz(paramQQAppInterface, paramContext, i3, ((Element)localObject).getElementsByTagName("name").item(0).getFirstChild().getNodeValue(), ((Element)localObject).getElementsByTagName("icon").item(0).getFirstChild().getNodeValue());
          if (jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap == null) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          ...
          bool = true;
          suk.a(paramQQAppInterface, bool, (String)localObject1);
          suk.b(paramQQAppInterface, i1);
          if (i3 == 1)
          {
        ...
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          ...
          bool = true;
          suk.a(paramQQAppInterface, bool);
          suk.c(paramQQAppInterface, i1);
          if (QLog.isColorLevel()) {
