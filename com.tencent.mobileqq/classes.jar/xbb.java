  ...
  extends WebViewPlugin
{
  ...
  private SparseArray<WeakReference<xbd>> jdField_a_of_type_AndroidUtilSparseArray;
  ...
  xbd a(int paramInt)
  {
    ...
    Object localObject = new xbd(this, null);
    ((xbd)localObject).jdField_a_of_type_Int = paramInt;
    localObject = new WeakReference(localObject);
    this.jdField_a_of_type_AndroidUtilSparseArray.put(paramInt, localObject);
    return (xbd)((WeakReference)localObject).get();
  }
  ...
  boolean a(int paramInt)
  {
    ...
    localObject = (xbd)((WeakReference)localObject).get();
    if (localObject == null) {
      return false;
    }
    try
  ...
  public void onDestroy()
  {
    ...
    if ((this.jdField_a_of_type_AndroidUtilSparseArray != null) && (this.jdField_a_of_type_AndroidUtilSparseArray.size() > 0))
    {
      ...
      {
        xbd localxbd = (xbd)((WeakReference)this.jdField_a_of_type_AndroidUtilSparseArray.get(i)).get();
        if (localxbd != null) {
          a(localxbd.jdField_a_of_type_Int);
        }
        i += 1;
      }
    }
