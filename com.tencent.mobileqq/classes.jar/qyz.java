  ...
  implements oqy
{
  ...
  public void a(boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      paramString = obz.a(localContext, localArticleInfo, 0, paramString);
      if (paramBoolean) {
        paramInt = 1;
      }
      try
      {
        for (;;)
        {
          ...
          raz.a(this.a.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataBaseData.b, "0X800898B", paramString.toString());
          return;
          paramString = "1";
          break;
          paramInt = 2;
