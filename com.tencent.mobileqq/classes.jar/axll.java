  ...
  implements awkh
{
  ...
  public axll(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, String paramString, int paramInt)
  {
  ...
  public void b(awki paramawki)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ReceiptMsgManager", 2, "upload receipt msg pack failed, result.errStr=" + paramawki.b + ",result.errStr=" + paramawki.jdField_a_of_type_JavaLangString + " uniseq=" + this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.uniseq);
    }
