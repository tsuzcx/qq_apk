...
public class ajfx
{
  public static CopyOnWriteArrayList<ajgc> a;
  protected int a;
  ...
  public ajfx(MqqHandler paramMqqHandler, Activity paramActivity)
  {
  ...
  {
    bdel.a(null, " pubAcc_follow_cancel", paramRecentBaseData.a());
    ...
    if (localObject != null) {}
    for (localObject = ((aluw)localObject).a(paramRecentBaseData.a());; localObject = null)
    {
      if ((localObject != null) && (syb.a(((AccountDetail)localObject).accountFlag) == -4))
      {
        ...
        ((NewIntent)localObject).setObserver(new ajfy(this, paramRecentBaseData, paramQQAppInterface));
      ...
      for (;;)
      {
        ...
        return;
        localObject = new amnh(new ajfz(this, paramRecentBaseData, paramQQAppInterface), paramQQAppInterface);
        paramQQAppInterface.removeObserver((alkr)localObject);
        paramQQAppInterface.addObserver((alkr)localObject);
        amnm.a(paramQQAppInterface, false, paramRecentBaseData.a(), 0);
      }
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt1, int paramInt2, int paramInt3, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      azmj.b(paramQQAppInterface, "dc00898", "", paramString1, "0X8009A31", "0X8009A31", 0, 0, String.valueOf(i), String.valueOf(paramInt3), paramString2, "");
      return;
      i = 1;
      continue;
      i = 2;
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, long paramLong, String paramString2)
  {
    ...
    azmj.b(paramQQAppInterface, "dc00898", "", paramString1, "0X8009A32", "0X8009A32", 0, 0, String.valueOf(paramLong), "", paramString2, "");
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    azmj.b(paramQQAppInterface, "dc00898", "", paramString1, "0X8009A34", "0X8009A34", 0, 0, "", "", paramString2, "");
  }
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          localObject = (aluw)((QQAppInterface)localObject).getManager(56);
        } while (localObject == null);
        localAccountDetail = ((aluw)localObject).b(paramString);
      ...
      if (((aluw)localObject).c(paramString) != null) {
        return true;
      }
  ...
  public static void b(QQAppInterface paramQQAppInterface)
  {
    ...
    if (jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() > 0)
    {
      ...
      {
        ajgc localajgc = (ajgc)localIterator.next();
        long l = System.currentTimeMillis() - localajgc.jdField_a_of_type_Long;
        if (l <= 3600000L) {
          a(paramQQAppInterface, localajgc.jdField_a_of_type_JavaLangString, l, localajgc.b);
        }
      }
    }
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString1, int paramInt1, int paramInt2, int paramInt3, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      azmj.b(paramQQAppInterface, "dc00898", "", paramString1, "0X8009A33", "0X8009A33", 0, 0, String.valueOf(i), String.valueOf(paramInt3), paramString2, "");
      return;
      i = 1;
      continue;
      i = 2;
  ...
  private void c(RecentBaseData paramRecentBaseData, QQAppInterface paramQQAppInterface)
  {
    ...
    {
      ajgk.a(paramQQAppInterface, paramRecentBaseData, localRecentUser);
      ajgm.a(paramQQAppInterface, localRecentUser, i);
    }
  }
  ...
  {
    bhpy localbhpy = bhpy.a(paramActivity);
    localbhpy.a(String.format(paramActivity.getResources().getString(2131695777), new Object[] { paramRecentBaseData.mTitleName }));
    localbhpy.a(2131696917, 3);
    localbhpy.c(2131690648);
    localbhpy.setOnDismissListener(new ajga(this));
    localbhpy.a(new ajgb(this, paramQQAppInterface, paramRecentBaseData, localbhpy));
