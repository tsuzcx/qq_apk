  ...
  implements bieh
{
  ...
  private bmfk jdField_a_of_type_Bmfk = new bmfk(this);
  private JsBridgeListener jdField_a_of_type_ComTencentMobileqqWebviewSwiftJsBridgeListener;
  private ReaderJsCallback jdField_a_of_type_CooperationQqreaderProxyReaderJsCallback = new bmfi(this);
  ...
  private void a(JsBridgeListener paramJsBridgeListener, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramJsBridgeListener))
    {
      ...
      paramString.put("graylevel", bmey.a());
      paramString.put("is_update_newstyle", bmey.a());
  ...
  private void b(String paramString)
  {
    ...
    localIntent.putExtras(bmea.a(localIntent, 2));
  ...
  private void b(String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    if (bmef.a().a())
    {
      bmgm.e("ReaderJsPlugin", "pluginHandleJS ->  handleJsCall");
      a(paramString1, paramString2, paramString3, paramVarArgs);
      return;
    }
    bmgm.e("ReaderJsPlugin", "js plugin is not ready...");
    ...
    this.jdField_a_of_type_Bmfk.a(paramString1, paramString2, paramString3, paramVarArgs);
  }
  ...
  public bmfh a(Handler paramHandler)
  {
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    this.b = paramString2;
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new bmfj(this));
  }
  ...
  void a(String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    {
      bmgm.d("ReaderJsPlugin", "create a new js plugin");
      this.jdField_a_of_type_CooperationQqreaderProxyReaderJsPluginProxy = bmef.a().a(this.jdField_a_of_type_CooperationQqreaderProxyReaderJsCallback);
    }
    if (this.jdField_a_of_type_CooperationQqreaderProxyReaderJsPluginProxy != null)
    {
      ...
      bmgm.d("ReaderJsPlugin", "create a new js ,method=" + paramString3);
    }
    do
    {
      return;
      bmgm.a("ReaderJsPlugin", "handleJsCall mJsPlugin is null!");
  ...
  {
    bmgm.e("ReaderJsPlugin", "handleJsRequest, url=" + paramString1 + " ,pakName=" + paramString2 + " ,method=" + paramString3);
    ...
    else if ("JSContent".equals(paramString2))
    {
      if ("registerWebSearch".equals(paramString3))
      {
        ...
        catch (JSONException paramJsBridgeListener)
        {
          for (;;)
          {
            bmgm.a("ReaderJsPlugin", "Failed to parse json str,json=" + paramVarArgs[0]);
          }
        }
      }
      ...
      if ("JSbookshelf".equals(paramString2))
      {
        if ("getGrayUpdateData".equals(paramString3))
        {
          ...
          catch (Exception paramJsBridgeListener)
          {
            for (;;)
            {
              bmgm.e("ReaderJsPlugin", paramJsBridgeListener.getMessage());
            }
          }
        }
