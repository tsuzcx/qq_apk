  ...
  extends EffectConfigBase<FilterItem>
{
  ...
  public ljs(VideoAppInterface paramVideoAppInterface)
  {
  ...
  public static boolean a()
  {
    ...
    {
      lek.c("EffectFilterTools", "isSupportGesture false");
      return false;
    }
    b = true;
    return b;
  ...
  public static boolean a(Context paramContext)
  {
    ...
    do
    {
      do
      {
        ...
        if (!lsa.e())
        {
          lek.c("EffectFilterTools", "isSupport Error: 1");
          return false;
        }
        bool1 = bool2;
      } while (!lsa.a(4, 1400000L));
      if (paramContext == null) {
        break;
      }
      bool1 = bool2;
    } while (TextUtils.isEmpty(lex.b(132).a));
    paramContext = lrg.a();
    if ((paramContext != null) && (!paramContext.a()))
    {
      lek.c("EffectFilterTools", "  isSupportFilter false");
      return false;
    }
