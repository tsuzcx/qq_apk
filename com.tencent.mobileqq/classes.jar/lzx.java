  ...
  extends mcx
{
  ...
  protected void a()
  {
    if (this.a.jdField_a_of_type_Maa != null) {
      this.a.jdField_a_of_type_Maa.a(0, 0, true);
    }
  }
  ...
  protected void a(long paramLong)
  {
    ...
    do
    {
      ...
      } while (((lfe)localObject).i == 11);
      if (this.a.jdField_a_of_type_Maa != null) {
        this.a.jdField_a_of_type_Maa.a(((lfe)localObject).jdField_d_of_type_JavaLangString, 1, false, false, false);
      }
      ...
      this.a.c = ((lfe)localObject).jdField_d_of_type_Int;
      this.a.jdField_d_of_type_Int = ((lfe)localObject).f;
      if (!llq.e())
      {
    ...
    return;
    ((lfe)localObject).h = Long.valueOf(((lfe)localObject).jdField_d_of_type_JavaLangString).longValue();
    long l = ((lfe)localObject).g;
    if (((lfe)localObject).j == 3000) {
      ((lfe)localObject).a = this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(String.valueOf(l));
    }
    ((lfe)localObject).d("onChangeUI_DobuleAudio2MultiAudio", 0);
    this.a.jdField_a_of_type_ComTencentAvVideoController.l(false);
    this.a.jdField_a_of_type_ComTencentAvVideoController.m(false);
    this.a.e = ((lfe)localObject).j;
    if (this.a.c == 4) {
    ...
    lhg.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, (String)localObject);
  ...
  protected void a(long paramLong, ArrayList<lob> paramArrayList)
  {
    ...
    String str2;
    boolean bool1;
    if ((this.a.jdField_a_of_type_Maa != null) && (paramArrayList != null))
    {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        this.a.jdField_a_of_type_Maa.a(str1, m, this.a.jdField_a_of_type_AndroidGraphicsBitmap, ((lob)localObject).jdField_b_of_type_Boolean, ((lob)localObject).jdField_a_of_type_Boolean);
        if (!this.a.jdField_a_of_type_ComTencentAvVideoController.a().J)
        {
          float f = mvk.a(this.a.jdField_a_of_type_AndroidContentContext, 12.0F);
          if (!str1.equals(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin())) {
            this.a.jdField_a_of_type_Maa.a(str1, m, str2, f, -1);
          }
          this.a.jdField_a_of_type_Maa.a(str1, m);
        }
        j += 1;
        break;
        if (this.a.e == 1)
        ...
        this.a.jdField_a_of_type_Maa.a(true, bool2);
        i = 1;
        break label277;
        label542:
        bdla.b(null, "CliOper", "", "", "0X8004F5C", "0X8004F5C", 0, 0, "", "", "", "");
      }
      paramArrayList = this.a.jdField_a_of_type_Maa;
      i = this.a.g;
      if (this.a.jdField_a_of_type_Mch == null) {}
      for (bool1 = true;; bool1 = this.a.jdField_a_of_type_Mch.jdField_a_of_type_Boolean)
      {
  ...
  protected void a(ArrayList<lob> paramArrayList)
  {
    if ((this.a.jdField_a_of_type_Maa != null) && (paramArrayList != null))
    {
      ...
      if (i < paramArrayList.size())
      {
        ...
        {
          if (this.a.jdField_a_of_type_Maa.b(str, j))
          {
            mbf.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1036);
            mbf.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1037);
          }
          localmaa = this.a.jdField_a_of_type_Maa;
          if ((((lob)localObject).jdField_b_of_type_Long != 5L) && (((lob)localObject).jdField_b_of_type_Long != 14L)) {
            break label219;
          }
        }
        ...
        {
          localmaa.a(str, j, false, bool2, bool1);
          i += 1;
          break;
        }
      }
  ...
  protected void a(boolean paramBoolean, long paramLong)
  {
    ...
    } while (this.a.jdField_a_of_type_Maa == null);
    this.a.jdField_a_of_type_Maa.a(true, paramBoolean);
  ...
  protected void b(long paramLong)
  {
    ...
    do
    {
      ...
      if (this.a.jdField_a_of_type_Maa != null) {
        this.a.jdField_a_of_type_Maa.a(locallfe.jdField_d_of_type_JavaLangString, 1, false, false, false);
      }
      if (this.a.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI != null)
      {
        this.a.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI.a(paramLong);
      ...
      locallfe.e("onChangeUI_Normal2Meeting", true);
      this.a.jdField_d_of_type_Boolean = true;
      this.a.c = 1;
      this.a.jdField_d_of_type_Int = locallfe.f;
      if (!llq.e())
      {
        this.a.jdField_a_of_type_Maa.a(false, false);
    ...
    return;
    locallfe.f("SmallScreen.onChangeUI_Normal2Meeting", false);
    this.a.e = 0;
  ...
  public void d()
  {
    ...
    for (;;)
    {
      ...
      break;
      label67:
      localObject1 = ((SmallScreenRelativeLayout)localObject1).findViewById(2131376387);
      ...
      Object localObject2 = new mjl();
      ((mjl)localObject2).setDuration(1000L);
      ((mjl)localObject2).setRepeatCount(-1);
      ((View)localObject1).findViewById(2131376391).startAnimation((Animation)localObject2);
      int i;
      if ((this.a.jdField_a_of_type_ComTencentAvVideoController.a().B) && (this.a.jdField_a_of_type_ComTencentAvVideoController.a().C))
      {
        ((TextView)((View)localObject1).findViewById(2131376399)).setText(2131695517);
        i = 1;
      }
      for (;;)
      {
        ...
        ((TextView)((View)localObject1).findViewById(2131376399)).setTextSize(1, 8.0F);
        return;
        if (this.a.jdField_a_of_type_ComTencentAvVideoController.a().B)
        {
          ((TextView)((View)localObject1).findViewById(2131376399)).setText(2131695518);
          i = 0;
        }
        else
        {
          ((TextView)((View)localObject1).findViewById(2131376399)).setText(2131695516);
          i = 1;
        }
      }
    }
