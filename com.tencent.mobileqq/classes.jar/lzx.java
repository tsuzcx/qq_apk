...
class lzx
{
      ...
      else
      {
        if (this.jdField_a_of_type_Ayrv != null)
        {
          ...
          if ((localObject instanceof AppInterface))
          {
            ...
            if (localObject != null)
            {
              QLog.d("QavSo", 2, String.format("DownloadContrl, cancelReq[%s]", new Object[] { (String)this.jdField_a_of_type_Ayrv.a() }));
        ...
        this.b = 0;
        if (!mab.b(this.jdField_a_of_type_ComTencentAvSoDownloadInfo))
        {
          this.jdField_c_of_type_Int |= 0x1;
          this.jdField_a_of_type_Int += 1;
        }
        if (!mab.a(this.jdField_a_of_type_ComTencentAvSoDownloadInfo))
        {
  ...
  boolean a(DownloadInfo paramDownloadInfo, int paramInt)
  {
    ...
    while (paramInt < 0)
    {
      ...
      bool2 = false;
      return bool2;
      if ((paramDownloadInfo.enable) && (!mab.a(paramDownloadInfo)))
      {
    ...
    localayrv.jdField_a_of_type_Aysa = new lzy(this, str1, i, paramDownloadInfo, paramInt);
    localayrv.a(i + "_" + str1);
    localayrv.jdField_a_of_type_JavaLangString = str3;
    localayrv.jdField_a_of_type_Int = 0;
    localayrv.jdField_c_of_type_JavaLangString = new File(str2).getPath();
