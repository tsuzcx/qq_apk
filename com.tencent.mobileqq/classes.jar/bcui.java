  ...
  extends aauq
{
  ...
  public bcui(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_Bcux = new bcux(paramAppInterface);
    this.jdField_a_of_type_Bcpw = new bcpw(paramAppInterface);
  }
  ...
  private boolean e(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    if (bool)
    {
      ...
      while (paramToServiceMsg.hasNext())
      {
        ...
        localObject = (bcug)((Map.Entry)localObject).getValue();
        if ((((bcug)localObject).a() & i) != 0)
        {
          localObject = ((bcug)localObject).a(i);
          if (localObject != null)
          {
            if (QLog.isColorLevel()) {
    ...
    paramToServiceMsg = (bcug)((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface).mAutomator.a().get(Integer.valueOf(101));
  ...
  private boolean p(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    anvk localanvk = (anvk)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER);
  ...
  public Object a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    return this.jdField_a_of_type_Bcpw.a(paramToServiceMsg, paramFromServiceMsg);
  }
  ...
  public boolean b(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    return this.jdField_a_of_type_Bcpw.a(paramToServiceMsg, paramUniPacket);
  }
}
