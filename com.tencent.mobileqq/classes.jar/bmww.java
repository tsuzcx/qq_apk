...
public class bmww
{
  ...
  public static Fragment a(@NonNull Activity paramActivity, @NonNull QQAppInterface paramQQAppInterface, @NonNull String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((paramString instanceof bmxd))
        {
          try
          {
            ((bmxd)paramString).attachQQContext(paramActivity, paramQQAppInterface);
            i = 1;
          }
  ...
  @Nullable
  public static bmwv a(@NonNull Activity paramActivity)
  {
    if (!c) {
    ...
    for (;;)
    {
      ...
      catch (Throwable localThrowable)
      {
        try
        {
          paramActivity = (bmwv)((Constructor)localObject1).newInstance(new Object[] { paramActivity });
  ...
  public static String a(Context paramContext)
  {
    ...
    if (TextUtils.isEmpty(str)) {
      paramContext = anzj.a(2131718521);
    }
    return paramContext;
  }
  ...
  {
    PublicFragmentActivity.a("com.qzone.feed.ui.activity.QQSchoolExtendFeedsListView", new bmxa(null));
  }
  ...
  public static boolean b(@Nullable Activity paramActivity, @Nullable QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          paramActivity.getLayoutInflater().inflate(2131561177, null);
          i = 1;
        }
        catch (Throwable paramActivity)
        {
  ...
  public static boolean b(@NonNull Context paramContext, @NonNull QQAppInterface paramQQAppInterface)
  {
    ...
    ((bmgk)paramQQAppInterface.getManager(27)).a("qzone_plugin.apk");
  ...
  public static boolean b(@Nullable bmwz parambmwz)
  {
    ...
    if (localPluginManagerClient != null)
    {
      ...
      for (bool1 = true;; bool1 = false)
      {
        ...
        parambmwz.onLoadOver(bool1);
        return bool1;
      }
    }
    long l = System.nanoTime();
    PluginManagerHelper.getPluginInterface(BaseApplicationImpl.getApplication(), new bmwx(l, parambmwz));
    return false;
  }
  ...
  public static boolean e()
  {
    ...
    jdField_b_of_type_Boolean = true;
    return bool2;
    PluginManagerHelper.getPluginInterface(BaseApplicationImpl.getApplication(), new bmwy());
    return false;
  }
