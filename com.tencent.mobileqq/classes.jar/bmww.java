  ...
  extends DynamicTextItem
{
  ...
  public bmww(int paramInt, Typeface paramTypeface, @NonNull List<String> paramList, @NonNull List<Bitmap> paramList1)
  {
  ...
  private boolean a(int paramInt1, int paramInt2, int paramInt3, String paramString, Point paramPoint)
  {
    ...
    while (i >= 16)
    {
      this.jdField_a_of_type_AndroidTextTextPaint.setTextSize(AIOUtils.dp2px(i, this.jdField_a_of_type_AndroidContentResResources));
      StaticLayout localStaticLayout = bmwz.a(paramString, 0, paramString.length(), this.jdField_a_of_type_AndroidTextTextPaint, paramInt1, Layout.Alignment.ALIGN_NORMAL, 1.0F, 0.0F, false, null, 0, 2);
  ...
  public InputFilter a()
  {
    if (this.jdField_a_of_type_AndroidTextInputFilter == null) {
      this.jdField_a_of_type_AndroidTextInputFilter = new bmwx(this, 20);
    }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    while (paramInt < 3)
    {
      ...
      f1 = AIOUtils.dp2px(jdField_a_of_type_ArrayOfFloat[(paramInt * 4)], this.jdField_a_of_type_AndroidContentResResources);
      f2 = AIOUtils.dp2px(jdField_a_of_type_ArrayOfFloat[(paramInt * 4 + 1)], this.jdField_a_of_type_AndroidContentResResources);
  ...
  public void a(Canvas paramCanvas)
  {
    ...
    {
      float f1 = AIOUtils.dp2px(jdField_a_of_type_ArrayOfFloat[(this.jdField_b_of_type_Int * 4 + 2)], this.jdField_a_of_type_AndroidContentResResources);
      float f2 = AIOUtils.dp2px(jdField_a_of_type_ArrayOfFloat[(this.jdField_b_of_type_Int * 4 + 3)], this.jdField_a_of_type_AndroidContentResResources);
      float f3 = AIOUtils.dp2px(jdField_a_of_type_ArrayOfFloat[(this.jdField_b_of_type_Int * 4)], this.jdField_a_of_type_AndroidContentResResources);
      float f4 = AIOUtils.dp2px(jdField_a_of_type_ArrayOfFloat[(this.jdField_b_of_type_Int * 4 + 1)], this.jdField_a_of_type_AndroidContentResResources);
      ...
      this.jdField_a_of_type_Float = AIOUtils.dp2px(2.0F, this.jdField_a_of_type_AndroidContentResResources);
