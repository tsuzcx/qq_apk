...
public class awfy
{
  ...
  public static awfs a(Spannable paramSpannable, int paramInt)
  {
    if ((paramInt < 0) || (paramInt >= paramSpannable.length())) {
      return null;
    }
    awfs[] arrayOfawfs = (awfs[])paramSpannable.getSpans(paramInt, paramInt, awfs.class);
    int i = 0;
    while (i < arrayOfawfs.length)
    {
      int j = paramSpannable.getSpanStart(arrayOfawfs[i]);
      int k = paramSpannable.getSpanEnd(arrayOfawfs[i]);
      if ((paramInt >= j) && (paramInt < k)) {
        return arrayOfawfs[i];
      }
      i += 1;
    }
    return null;
  ...
  public static List<Pair<Integer, String>> a(Editable paramEditable)
  {
    ...
    if (i < paramEditable.length())
    {
      Object localObject2 = (awfs[])paramEditable.getSpans(i, i, awfs.class);
      ...
      localObject1 = ((awfs)localObject2).a();
  ...
  public static void a(ETTextView paramETTextView, CharSequence paramCharSequence, int paramInt)
  {
    ...
    for (paramETTextView = paramETTextView.getText();; paramETTextView = paramCharSequence)
    {
      ...
      paramETTextView = (awfs[])paramETTextView.getSpans(0, paramETTextView.length(), awfs.class);
      paramInt = 0;
  ...
  public static List<Pair<Integer, Integer>> b(Editable paramEditable)
  {
    ...
    if (i < paramEditable.length())
    {
      arrayOfawfs = (awfs[])paramEditable.getSpans(i, i, awfs.class);
      if ((arrayOfawfs == null) || (arrayOfawfs.length <= 0)) {
        break label184;
      }
      if (arrayOfawfs.length > 1)
      {
        int k = arrayOfawfs.length;
        j = 0;
        localObject1 = null;
        label66:
        if (j < k)
        {
          awfs localawfs = arrayOfawfs[j];
          if (localawfs == localObject2) {
            break label194;
          }
          localObject1 = localawfs;
        }
      }
    }
    label184:
    ...
    for (;;)
    {
      ...
      if (localObject1 == null) {
        localObject1 = arrayOfawfs[(arrayOfawfs.length - 1)];
      }
      for (;;)
      {
        label110:
        ...
        {
          localObject2 = ((awfs)localObject1).a();
