...
public class aigu
  implements aisr, Manager
{
  int jdField_a_of_type_Int = 0;
  aigy jdField_a_of_type_Aigy;
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new aigv(this);
  ...
  Comparator<ApolloActionData> jdField_a_of_type_JavaUtilComparator = new aigw(this);
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentWidgetListView != null)
    {
      ...
      this.jdField_a_of_type_Aigy = null;
    }
    this.jdField_a_of_type_AndroidWidgetFrameLayout = null;
    this.jdField_a_of_type_AndroidWidgetTextView = null;
  }
  
  public void a(aisk paramaisk, long paramLong)
  {
    ...
    do
    {
      do
      {
        return;
        i = paramaisk.f;
        localApolloActionData = ((aiyu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155)).b(i);
      } while ((localApolloActionData == null) || ((localApolloActionData.pkIds == null) && (localApolloActionData.pk3DIds == null)) || (paramaisk.jdField_a_of_type_Boolean) || (paramaisk.g != 1));
    ...
    localMessage.arg1 = i;
    localMessage.getData().putString("senderUin", paramaisk.jdField_a_of_type_JavaLangString);
    localMqqHandler.sendMessageDelayed(localMessage, 500L);
    localMqqHandler.sendEmptyMessageDelayed(83, 4000L);
  }
  
  public void a(aisk paramaisk, long paramLong, int paramInt) {}
  ...
  public void a(BaseChatPie paramBaseChatPie, ApolloActionData paramApolloActionData, int paramInt, String paramString)
  {
    ...
    if (aifg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
      if (aifg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c()) == 1) {
    ...
    for (;;)
    {
      ...
      paramBaseChatPie = (RelativeLayout)paramBaseChatPie.a().findViewById(2131298518);
      int i;
      if (this.jdField_a_of_type_ComTencentWidgetListView == null)
      {
        ...
        this.jdField_a_of_type_ComTencentWidgetListView.setSelector(localBaseActivity.getResources().getDrawable(2130849314));
        this.jdField_a_of_type_ComTencentWidgetListView.setCacheColorHint(2131099855);
        ...
        i = aciy.a(9.0F, localBaseActivity.getResources());
        this.jdField_a_of_type_AndroidWidgetTextView.setPadding(0, 0, 0, i);
        this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(localBaseActivity.getResources().getColor(2131101267));
        ...
        this.jdField_a_of_type_Aigy = new aigy(this, localBaseActivity);
        this.jdField_a_of_type_ComTencentWidgetListView.setAdapter(this.jdField_a_of_type_Aigy);
        localObject = new RelativeLayout.LayoutParams(aciy.a(99.0F, localBaseActivity.getResources()), -2);
        ((RelativeLayout.LayoutParams)localObject).addRule(11);
        ((RelativeLayout.LayoutParams)localObject).addRule(2, 2131302567);
        ((RelativeLayout.LayoutParams)localObject).rightMargin = aciy.a(10.0F, localBaseActivity.getResources());
      ...
      try
      {
        for (;;)
        {
          ...
          if (paramBaseChatPie.getBoolean("first_show_resp", true))
          {
            ...
            this.jdField_a_of_type_AndroidWidgetTextView.setText(ajjy.a(2131634721));
            this.jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130838254, 0);
          }
          else
          {
            this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
            continue;
            paramBaseChatPie = babh.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, true);
            paramBaseChatPie = String.format(ajjy.a(2131634723), new Object[] { paramBaseChatPie });
        ...
        this.jdField_a_of_type_Aigy.a(paramBaseChatPie, paramInt);
        return;
      }
