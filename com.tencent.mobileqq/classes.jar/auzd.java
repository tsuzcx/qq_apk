  ...
  implements Manager
{
  ...
  public auzd(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a()
  {
    ...
    do
    {
      ...
      do
      {
        ...
        ((HttpNetReq)localObject).mCallback = new auze(this);
        ...
        ((HttpNetReq)localObject).mBreakDownFix = new auzf(this);
        localObject = new HttpEngineTask(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.b, new auzg(this), (HttpNetReq)localObject);
