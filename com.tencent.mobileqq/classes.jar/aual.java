  ...
  extends BaseAdapter
{
  ...
  private aual(ProfileLabelPanelAdapter paramProfileLabelPanelAdapter) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramView.setBackgroundResource(2130849169);
      paramViewGroup = (ToggleButton)paramView;
      paramViewGroup.setGravity(17);
      paramViewGroup.setTextSize(this.jdField_a_of_type_ComTencentMobileqqProfileViewProfileLabelPanelAdapter.jdField_a_of_type_AndroidContentContext.getResources().getInteger(2131361798));
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (localProfileLabelInfo.labelStatus == ProfileLabelInfo.STATUS_CHECKED) {
        this.jdField_a_of_type_ComTencentMobileqqProfileViewProfileLabelPanelAdapter.jdField_a_of_type_Auaj.a(localProfileLabelInfo, paramViewGroup);
      }
      return paramView;
      paramViewGroup = (ToggleButton)paramView;
      break;
