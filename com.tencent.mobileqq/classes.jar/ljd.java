  ...
  implements lha
{
  ...
  {
    ((ljd)paramVideoAppInterface.a(0)).b();
  ...
  private boolean b(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString)) {
      try
      {
        ...
        lbd.f("EffectZimuManager", "parse ZIMU:" + paramString);
  ...
  protected void a(long paramLong, int paramInt, String paramString1, String paramString2)
  {
    ...
    ((lge)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(1)).a();
    new mdd(paramLong, "onSessionStatusChanged", 2, null).a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
  }
  ...
  public void a(String paramString, long paramLong)
  {
    if (this.b)
    {
      lgh locallgh = (lgh)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(0);
      locallgh.a(paramString, paramLong, "TransInfo.ExitSession", null);
      locallgh.onDestroy();
      ((lge)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(1)).a();
    }
    this.b = false;
  ...
  public void a(String paramString1, boolean paramBoolean, long paramLong, String paramString2)
  {
    ...
    if (!this.b)
    {
      lge locallge = (lge)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(1);
      locallge.a(paramString1, "TransInfoCreate.CreateSession", paramLong, paramString2);
      locallge.onDestroy();
      this.c = paramBoolean;
    }
    this.b = true;
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      ...
      if ((!ljc.a(localZimuItem.getId())) || (localZimuItem.isUsable() == paramBoolean)) {
        break label82;
      }
  ...
  public boolean a(long paramLong, ZimuItem paramZimuItem)
  {
    ...
    for (int i = 4;; i = 5)
    {
      ...
      if (paramZimuItem != null)
      {
        ...
        if (localObject != null) {
          ((lgz)localObject).a(3001, paramZimuItem.getId());
        }
      }
      return bool;
  ...
  public void b(String paramString, long paramLong)
  {
    ...
    {
      lgh locallgh = (lgh)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(0);
      locallgh.a(paramString, paramLong, "TransInfo.ChangeSession", null);
      locallgh.onDestroy();
    }
  }
