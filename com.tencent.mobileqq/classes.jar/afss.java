...
public class afss
  implements Runnable
{
  public afss(ScanTorchActivity paramScanTorchActivity, ARTarget paramARTarget, int paramInt, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    do
    {
      ...
      if ((ScanTorchActivity.a(this.jdField_a_of_type_ComTencentMobileqqOlympicActivityScanTorchActivity) != null) && (!ScanTorchActivity.a(this.jdField_a_of_type_ComTencentMobileqqOlympicActivityScanTorchActivity).a.c())) {
    ...
    ScanTorchActivity.l(this.jdField_a_of_type_ComTencentMobileqqOlympicActivityScanTorchActivity);
  }
}
