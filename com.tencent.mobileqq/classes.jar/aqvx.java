  ...
  implements VoiceRecognizerListener
{
  ...
  public aqvx(WebViewPlugin paramWebViewPlugin)
  {
  ...
  private Activity a()
  {
    ...
    for (bgve localbgve = null; localbgve == null; localbgve = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime) {
      return null;
    }
    return localbgve.a();
  }
  ...
  public static void a(AppInterface paramAppInterface)
  {
    ...
    do
    {
      do
      {
        ...
        new bena(paramAppInterface.getApplication().getApplicationContext(), "3171", "libWXVoice.so", "WXVoice").a();
  ...
  private void a(boolean paramBoolean)
  {
    ...
    localAppActivity.requestPermissions(new aqvy(this, paramBoolean), 1818, new String[] { "android.permission.RECORD_AUDIO" });
    if (this.jdField_a_of_type_AndroidOsHandler == null) {
      this.jdField_a_of_type_AndroidOsHandler = new aqvz(this, Looper.getMainLooper());
    }
  ...
  private boolean d()
  {
    if (!bena.a(this.jdField_a_of_type_AndroidContentContext, "libWXVoice.so"))
    {
      QLog.e("VoiceInputHelper", 1, "setup error, so lib not exists");
      return false;
    }
    int i = VoiceRecognizer.shareInstance().init(this.jdField_a_of_type_AndroidContentContext, "wxcd8072f67d2d78d4", bena.a(this.jdField_a_of_type_AndroidContentContext, "libWXVoice.so"));
    if (i < 0)
    {
