  ...
  implements Manager
{
  ...
  private final bdfj jdField_a_of_type_Bdfj;
  private final QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private QQCustomDialog jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog;
  private final String jdField_a_of_type_JavaLangString;
  private final List<bdvf> jdField_a_of_type_JavaUtilList;
  ...
  public bdve(@NotNull QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Bdfj = ((bdfj)new bdvk(this));
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver((BusinessObserver)this.jdField_a_of_type_Bdfj);
  }
  ...
  private final void a(int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      if (((bdfe)localObject).a(bool1, paramInt1, paramBoolean, bool2)) {
        break label165;
      }
      if (QLog.isColorLevel()) {
        QLog.d(this.jdField_a_of_type_JavaLangString, 2, "doChangeMode switching");
      }
      QQToast.a((Context)BaseApplication.getContext(), 0, 2131718614, 0).a();
      localObject = ((Iterable)this.jdField_a_of_type_JavaUtilList).iterator();
      while (((Iterator)localObject).hasNext()) {
        ((bdvf)((Iterator)localObject).next()).d(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      }
      bool1 = false;
      break;
      label159:
    ...
    localObject = ((Iterable)this.jdField_a_of_type_JavaUtilList).iterator();
    while (((Iterator)localObject).hasNext()) {
      ((bdvf)((Iterator)localObject).next()).b(paramInt2, paramInt3);
    }
  }
  ...
  private final void a(boolean paramBoolean, String paramString)
  {
    ...
    while (localIterator.hasNext()) {
      ((bdvf)localIterator.next()).a(paramBoolean, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, paramString);
    }
    if ((paramBoolean) && ((this.jdField_a_of_type_Int == 2) || (this.jdField_b_of_type_Int == 2))) {
      bhhr.a((Context)BaseApplicationImpl.context, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), true, "study_mode_has_change", Boolean.valueOf(true));
    }
  }
  ...
  private final void b()
  {
    ...
    for (int i = 1;; i = 2)
    {
      ...
      bhhr.a((Context)BaseApplicationImpl.context, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), true, "study_mode_last_report_time", localSimpleDateFormat.format(new Date()));
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800AD6C", "0X800AD6C", 0, i, "", "", "", "");
      return;
    }
  }
  ...
  {
    Object localObject1 = (String)bhhr.b((Context)BaseApplicationImpl.context, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "study_mode_last_report_time", "");
  ...
  private final void d(boolean paramBoolean)
  {
    ...
    for (String str = BaseApplicationImpl.getContext().getString(2131694025, new Object[] { str });; str = BaseApplicationImpl.getContext().getString(2131694027, new Object[] { str }))
    {
  ...
  private final void e(boolean paramBoolean)
  {
    if (!paramBoolean)
    {
      String str = BaseApplicationImpl.getContext().getString(2131694026);
  ...
  @NotNull
  public final bdvh a(@NotNull Activity paramActivity, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if ((!this.jdField_a_of_type_Boolean) && ((i != paramInt1) || (paramInt2 != this.c)))
    {
      ...
      {
        QQToast.a((Context)BaseApplication.getContext(), 1, 2131694305, 0).a();
        paramActivity = ((Iterable)this.jdField_a_of_type_JavaUtilList).iterator();
        while (paramActivity.hasNext()) {
          ((bdvf)paramActivity.next()).c(paramInt1, i);
        }
        return new bdvh(false, paramInt1, i);
      }
      if (paramInt1 == 1)
      {
        ...
        if (((SharedPreferences)localObject).getBoolean("key_simple_should_show_switch_dialog", true))
        {
          ...
          localObject = (DialogInterface.OnClickListener)new bdvj(this, paramInt2, paramInt1, i, paramBoolean);
          QQCustomDialog localQQCustomDialog = this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog;
          if (localQQCustomDialog != null) {
            localQQCustomDialog.dismiss();
          }
          this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = bhdj.a(paramActivity, BaseApplicationImpl.getContext().getString(2131718609), 0, 2131718607, (DialogInterface.OnClickListener)localObject, null);
          paramActivity = this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog;
          if (paramActivity == null) {
            Intrinsics.throwNpe();
          }
          paramActivity.setOnDismissListener((DialogInterface.OnDismissListener)new bdvi(this, paramInt1, i));
          paramActivity = this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog;
          if (paramActivity == null) {
            Intrinsics.throwNpe();
          }
      ...
      for (;;)
      {
        return new bdvh(true, paramInt1, i);
        a(paramInt2, paramInt1, i, paramBoolean);
        continue;
        a(paramInt2, paramInt1, i, paramBoolean);
      }
    }
    return new bdvh(this.jdField_a_of_type_Boolean, paramInt1, i);
  }
  ...
  public final void a(@Nullable bdvf parambdvf)
  {
    if (parambdvf != null) {
      this.jdField_a_of_type_JavaUtilList.add(parambdvf);
    }
  }
  ...
  public final void a(@NotNull BaseActivity paramBaseActivity)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((this.d == 2) && (this.e == 1) && (bdvn.c()) && (!((Boolean)bhhr.b((Context)paramBaseActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "study_mode_has_change", Boolean.valueOf(false))).booleanValue()) && (!((Boolean)bhhr.b((Context)paramBaseActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "study_mode_change_dialog_has_show", Boolean.valueOf(false))).booleanValue()))
      {
        new bdvs(paramBaseActivity).show();
        bhhr.a((Context)BaseApplicationImpl.context, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), true, "study_mode_change_dialog_has_show", Boolean.valueOf(true));
      }
      return;
    }
  }
  ...
  public final void b(@Nullable bdvf parambdvf)
  {
    if ((parambdvf != null) && (this.jdField_a_of_type_JavaUtilList.contains(parambdvf))) {
      this.jdField_a_of_type_JavaUtilList.remove(parambdvf);
    }
  }
  ...
  public final void b(boolean paramBoolean)
  {
    ...
    bduv.a("INIT", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    if (paramBoolean) {
      i = 1;
    }
    this.d = i;
    ...
    ((azbv)localManager).a(paramBoolean);
  }
  ...
  public void onDestroy()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver((BusinessObserver)this.jdField_a_of_type_Bdfj);
    a();
