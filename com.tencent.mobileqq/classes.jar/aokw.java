...
public abstract class aokw
{
  ...
  public aokw(int paramInt)
  {
    this.jdField_c_of_type_JavaLangString = aola.jdField_a_of_type_JavaLangString;
    ...
    this.jdField_j_of_type_JavaLangString = aola.jdField_b_of_type_JavaLangString;
    this.jdField_k_of_type_JavaLangString = aola.jdField_c_of_type_JavaLangString;
    this.jdField_l_of_type_JavaLangString = aola.jdField_d_of_type_JavaLangString;
    this.jdField_a_of_type_JavaLangString = "precision mediump float;\nuniform mat4 uSTMatrix;\nattribute vec4 aPosition;\nattribute vec4 aTextureCoord;\nvarying vec2 vTextureCoord;\nuniform mat4 uMVPMatrix;\nvoid main() {\n   gl_Position = uMVPMatrix * aPosition;\n   vTextureCoord = (uSTMatrix * aTextureCoord).xy;\n}";
    this.o = paramInt;
  }
  
  private final int a(aokz paramaokz, boolean paramBoolean)
  {
    int i1 = 0;
    a(paramaokz);
    if (this.jdField_a_of_type_Aokx != null) {
      this.jdField_a_of_type_Aokx.a();
    }
    if (this.n == 1) {
      this.jdField_a_of_type_Aoks.a(this.jdField_e_of_type_Int, this.jdField_f_of_type_Int);
    }
    for (;;)
    {
      GLES20.glBindTexture(3553, 0);
      GLES20.glBindFramebuffer(36160, 0);
      aola.a("keyingHandleAfter");
      if (paramBoolean) {
        i1 = this.jdField_a_of_type_Aokt.a();
      }
      return i1;
  ...
  private final void a(aokz paramaokz, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    if (paramBoolean)
    {
      this.jdField_a_of_type_Aokt.a(paramInt1, paramInt2);
    ...
    for (;;)
    {
      ...
      if (this.m != -1) {
        GLES20.glUniform4f(this.m, paramaokz.jdField_a_of_type_Float, paramaokz.jdField_b_of_type_Float, paramaokz.jdField_c_of_type_Float, 1.0F);
      }
      aola.a("keyingHandleBefore");
      return;
      this.jdField_a_of_type_Aolc.a(this.jdField_e_of_type_Int, this.jdField_f_of_type_Int);
    }
  }
  
  public final int a(int[] paramArrayOfInt, aokz paramaokz, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2)
  {
    return a(paramArrayOfInt, paramaokz, paramArrayOfFloat1, paramArrayOfFloat2, false, 0, 0);
  }
  
  public final int a(int[] paramArrayOfInt, aokz paramaokz, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    if (paramArrayOfInt == null) {
      throw new IllegalArgumentException("textureIds can not be null!");
    }
    a(paramaokz, paramArrayOfFloat1, paramArrayOfFloat2, paramBoolean, paramInt1, paramInt2);
    switch (this.o)
    {
    }
    for (;;)
    {
      aola.a("keyingTexture");
      return a(paramaokz, paramBoolean);
  ...
  protected String a()
  {
    this.jdField_c_of_type_JavaLangString = aola.a(this.o);
  ...
  public final void a(int paramInt, float paramFloat1, float paramFloat2, float paramFloat3)
  {
    ...
    if (this.n == 1) {
      this.jdField_a_of_type_Aoks = new aoks(1.0F, this.jdField_a_of_type_Float, this.jdField_b_of_type_Float, this.jdField_c_of_type_Float);
    }
    for (;;)
    {
      this.jdField_a_of_type_Aokt = new aokt();
      this.jdField_d_of_type_Int = aola.a(this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString);
      aola.a("createProgram");
      if (this.jdField_d_of_type_Int == 0) {
        break;
      }
      this.jdField_e_of_type_Int = GLES20.glGetAttribLocation(this.jdField_d_of_type_Int, "aPosition");
      aola.a("glGetAttribLocation aPosition");
      if (this.jdField_e_of_type_Int != -1) {
        break label303;
      }
      throw new RuntimeException("Could not get attrib location for aPosition");
      if ((this.jdField_b_of_type_ArrayOfFloat != null) && (this.jdField_a_of_type_ArrayOfShort != null)) {
        this.jdField_a_of_type_Aolc = new aolc(this.jdField_b_of_type_ArrayOfFloat, this.jdField_a_of_type_ArrayOfShort);
      } else {
  ...
  public void b()
  {
    ...
    } while (this.jdField_a_of_type_Aokt == null);
    this.jdField_a_of_type_Aokt.a();
    this.jdField_a_of_type_Aokt = null;
  }
}
