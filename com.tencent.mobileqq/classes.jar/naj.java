...
public class naj
{
  ...
  public void a(naj paramnaj)
  {
    if (paramnaj == null) {
      return;
    }
    this.jdField_a_of_type_Int = paramnaj.jdField_a_of_type_Int;
    this.b = paramnaj.b;
    this.c = paramnaj.c;
    this.d = paramnaj.d;
    this.e = paramnaj.e;
    ...
    this.g = paramnaj.g;
    this.h = paramnaj.h;
    this.jdField_a_of_type_JavaLangString = paramnaj.jdField_a_of_type_JavaLangString;
  }
  ...
  public final void a(AvGameCommon.GameInfo paramGameInfo)
  {
    ...
    this.b = mzo.a(this.jdField_a_of_type_Int);
