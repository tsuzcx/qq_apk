  ...
  implements QQRecorder.OnQQRecorderListener, VoicePlayer.VoicePlayerListener
{
  ...
  protected adoh a;
  private Handler jdField_a_of_type_AndroidOsHandler = new adof(this, Looper.getMainLooper());
  ...
  public adoe(WebRecordApiPlugin paramWebRecordApiPlugin, AppInterface paramAppInterface, BaseActivity paramBaseActivity)
  {
  ...
  {
    String str1 = AppConstants.aJ + "webrecord/";
  ...
  private void e(String paramString)
  {
    ...
    ThreadManager.post(new adog(this, paramString), 8, null, false);
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      if (paramInt1 != 0)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqJspWebRecordApiPlugin.callJs(WebRecordApiPlugin.b(this.jdField_a_of_type_ComTencentMobileqqJspWebRecordApiPlugin), new String[] { "{'code':-1,'recordID':'-1','msg':'" + this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131433421) + "'}" });
        return;
      }
    }
    this.jdField_a_of_type_ComTencentMobileqqJspWebRecordApiPlugin.callJs(WebRecordApiPlugin.b(this.jdField_a_of_type_ComTencentMobileqqJspWebRecordApiPlugin), new String[] { "{'code':-1,'recordID':'-1','msg':'" + this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131433420) + "'}" });
  }
    ...
    if (i < paramJSONArray.length())
    {
      ...
      if ((localFile.exists()) && (!TextUtils.isEmpty(str)))
      {
        ...
        if (localFile.exists())
        {
          ...
          this.jdField_a_of_type_Adoh = new adoh(this.jdField_a_of_type_ComTencentMobileqqJspWebRecordApiPlugin, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_AndroidOsHandler, paramString1, paramString2, (AudioInfo)localObject);
          ThreadManager.post(this.jdField_a_of_type_Adoh, 5, null, true);
        }
      }
      for (;;)
      {
