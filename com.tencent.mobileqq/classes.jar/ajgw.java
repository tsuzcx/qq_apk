...
public class ajgw
{
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject1))
        {
          ...
          awrn.a(paramContext).a("", "actDeviceAbility", true, 0L, 0L, localHashMap, "");
          return;
          i = 0;
          break;
          label735:
  ...
  {
    int i2 = (int)(bace.b() / 1024.0F / 1024.0F);
    ...
    if (bace.a())
    {
      k = (int)(bace.b() / 1024.0F / 1024.0F);
      j = (int)(bace.a() / 1024.0F / 1024.0F);
      if (Build.VERSION.SDK_INT < 9) {
        break label377;
      }
      localObject = bace.a(paramContext);
      n = ((List)localObject).size();
      localObject = ((List)localObject).iterator();
      i = -1;
      while (((Iterator)localObject).hasNext())
      {
        if (!((bacf)((Iterator)localObject).next()).a) {
          break label374;
        }
        i += 1;
      }
    ...
    for (k = n;; k = n)
    {
      ...
      awrn.a(paramContext).a("", "actStorageStats", true, 0L, 0L, (HashMap)localObject, "");
      return;
      label374:
      break;
      label377:
