...
public class ajgw
  extends anmu
{
  private ajgw(AlphabetFriendFragment paramAlphabetFriendFragment) {}
    ...
    if ((paramBoolean) && (this.a.isResumed())) {
      try
      {
        ...
        if ((paramArrayOfObject != null) && (paramArrayOfObject.length > 0))
        {
          ...
          {
            QQToast.a(this.a.getActivity(), 2, anni.a(2131699038), 0).a();
            return;
          }
          QQToast.a(this.a.getActivity(), 2, anni.a(2131699039), 0).a();
          return;
        }
      }
