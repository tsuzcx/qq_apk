  ...
  implements Handler.Callback
{
  ...
  public static aznp a()
  {
    if (QLog.isColorLevel()) {
      QLog.i("AutoMonitor", 2, "onApplicationCreate ");
    }
    aznp localaznp = new aznp();
    localaznp.a(0);
    azpf.b(0, localaznp, jdField_b_of_type_ArrayOfInt).step();
    ...
    jdField_a_of_type_Boolean = false;
    azpf.b(12, localaznp, null).step();
    if (BaseApplicationImpl.sProcessId == 2)
    {
      azpf.b(10, localaznp, null).step();
      azpf.b(39, localaznp, null).step();
      ThreadManager.post(azpf.b(0, localaznp, l), 10, null, false);
      azpf.b(0, localaznp, jdField_k_of_type_ArrayOfInt).step();
    }
    for (;;)
    {
      return null;
      ...
      {
        azpf.b(0, localaznp, r).step();
      }
      else if ((BaseApplicationImpl.sProcessId == 5) || (BaseApplicationImpl.sProcessId == 7))
      {
        azpf.b(10, localaznp, null).step();
        azpf.b(7, localaznp, null).step();
        azpf.b(0, localaznp, jdField_i_of_type_ArrayOfInt).step();
        azpf.b(11, localaznp, null).step();
        azpf.b(46, localaznp, null).step();
        if (BaseApplicationImpl.sProcessId == 7) {
          azpf.b(48, localaznp, null).step();
        }
      }
      ...
      else if (!BaseApplicationImpl.processName.endsWith(":qqfav"))
      {
        ...
        {
          ThreadManager.excute(azpf.b(0, localaznp, jdField_a_of_type_ArrayOfInt), 16, null, false);
        }
        else
        {
    ...
    if (BaseApplicationImpl.processName.endsWith(":troopbar"))
    {
      azpf.b(11, localaznp, null).step();
      azpf.b(10, localaznp, null).step();
      azpf.b(13, localaznp, null).step();
    }
    for (;;)
    {
      if (BaseApplicationImpl.processName.endsWith(":troophomework")) {
        azpf.b(37, localaznp, null).step();
      }
      if (!BaseApplicationImpl.processName.endsWith(":live")) {
        break;
      }
      azpf.b(47, localaznp, null).step();
      break;
      azpf.b(0, localaznp, jdField_j_of_type_ArrayOfInt).step();
    }
  }
        ...
        if (!str1.isEmpty())
        {
          ...
          if (arrayOfString.length > 0)
          {
            ...
            if (i1 < i3)
            {
              ...
              amhg.jdField_a_of_type_JavaUtilSet.add(Integer.valueOf(Integer.parseInt(str2)));
              i1 += 1;
              continue;
            }
          }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ThreadManager.getSubThreadHandler().postAtFrontOfQueue(azpf.b(9, this, null));
      if (jdField_a_of_type_Int == 1) {
        ThreadManager.getSubThreadHandler().post(azpf.b(21, this, null));
      }
    }
    ...
    if (paramBoolean)
    {
      ...
      if ((BaseApplicationImpl.sShowTime <= 0L) || (!bdin.g(BaseApplicationImpl.sApplication))) {
        break label314;
      }
    }
    label314:
    for (BaseApplicationImpl.sShowTime = -l1;; BaseApplicationImpl.sShowTime = 0L)
    {
      ...
      if (this.jdField_a_of_type_Aznq != null)
      {
  ...
  private void a(int[] paramArrayOfInt1, int[] paramArrayOfInt2, int paramInt)
  {
    ...
    paramArrayOfInt1 = azpf.b(0, this, paramArrayOfInt1);
    if (paramArrayOfInt2 != null)
    {
      this.jdField_f_of_type_Int = 2;
      this.jdField_g_of_type_Int = paramInt;
      paramArrayOfInt1.setResultListener(this.jdField_b_of_type_AndroidOsHandler, 10);
      paramArrayOfInt2 = azpf.b(0, this, paramArrayOfInt2);
  ...
  private void b(AppActivity paramAppActivity, boolean paramBoolean)
  {
    ...
    if (!paramBoolean) {
      localTextView.setText(2131693685);
    }
    for (;;)
    {
      ...
      return;
      localTextView.setText(alud.a(2131714742));
    }
  }
  ...
  public void a(aznq paramaznq)
  {
    this.jdField_a_of_type_Aznq = paramaznq;
  }
  ...
  public void a(AppActivity paramAppActivity, boolean paramBoolean)
  {
    ...
    if (Build.VERSION.SDK_INT >= 23)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqStartupStepCheckPermission == null) {
        this.jdField_a_of_type_ComTencentMobileqqStartupStepCheckPermission = ((CheckPermission)azpf.b(3, this, null));
      }
    ...
    if (this.jdField_e_of_type_Int == 2)
    {
      if (1 == BaseApplicationImpl.sProcessId) {
        ThreadManager.getFileThreadHandler().postDelayed(azpf.b(13, this, null), 1000L);
      }
      a(11, 1, 5L);
      a(3);
    }
    ...
    for (paramObject = (AppActivity)paramObject;; paramObject = null)
    {
      ...
      if (paramObject == null)
      {
        ...
        if (this.jdField_e_of_type_Int == 1)
        {
          ...
          {
            paramObject = o;
            azpf.b(0, this, paramObject).step();
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          paramIntent = (SetSplash)azpf.b(2, this, null);
          paramIntent.step();
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      for (;;)
      {
        return true;
        a(4, 0, 300L);
        bool1 = azpf.b(12, this, null).step();
        ...
        if (this.jdField_a_of_type_MqqAppAppActivity != null)
        {
          ...
          if (this.jdField_a_of_type_MqqAppAppActivity != null)
          {
            bdng.a(this.jdField_a_of_type_MqqAppAppActivity, "com.tencent.mobileqq.activity.MainActivity");
            bdng.a(this.jdField_a_of_type_MqqAppAppActivity, SplashActivity.class.getName());
            return true;
            ...
            this.jdField_a_of_type_Aznq.a(this);
            if (this.jdField_a_of_type_Long > 0L) {
      ...
      azpf.b(28, this, null).step();
      return true;
    } while (this.jdField_a_of_type_Aznq.jdField_a_of_type_Boolean);
    this.jdField_a_of_type_Aznq.a();
