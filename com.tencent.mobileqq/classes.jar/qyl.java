  ...
  implements qxs, qxu
{
  ...
  private void a(Container paramContainer, RecommendAdData paramRecommendAdData)
  {
    ...
    {
      return;
      if (nbe.a(BaseApplicationImpl.getContext(), paramRecommendAdData.p)) {
      ...
      for (;;)
      {
        ...
        paramContainer.getComLayoutParams().mLayoutMarginLeft = aciy.a(16.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
        return;
  ...
  public qxr a(Context paramContext, BaseData paramBaseData, ViewGroup paramViewGroup)
  {
    ...
    return new qym(this, paramViewGroup, localProteusItemData);
  }
