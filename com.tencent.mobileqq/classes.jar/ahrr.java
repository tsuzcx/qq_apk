...
public class ahrr
{
  ...
  public static int a(MessageRecord paramMessageRecord)
  {
    ...
    do
    {
      ...
      return 11;
    } while (annt.a(paramMessageRecord));
    return 7;
  }
      ...
      do
      {
        do
        {
          ...
          if (paramMessageRecord.msgtype == -2005) {
            return aszt.a(paramQQAppInterface, paramMessageRecord);
          }
  ...
  private static int b(MessageRecord paramMessageRecord)
  {
    ...
    {
      if (aszt.a(((MessageForFile)paramMessageRecord).fileName) != 0) {}
    }
    else {
      do
      {
    ...
    while ((!(paramMessageRecord instanceof MessageForTroopFile)) || (aszt.a(((MessageForTroopFile)paramMessageRecord).fileName) != 0)) {
      return 5;
    }
    return 2;
  }
