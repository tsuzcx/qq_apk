...
public class qbg
{
  ...
  private static qbg a(String paramString, int paramInt)
  {
    if (TextUtils.isEmpty(paramString)) {
      return null;
    }
    return a(bbmx.a(paramString), paramInt);
  }
  
  private static qbg a(qbg paramqbg)
  {
    SharedPreferences localSharedPreferences = bhvy.a(onh.a(), true, false);
    if ((localSharedPreferences == null) || (paramqbg == null)) {
      return paramqbg;
    }
    paramqbg.jdField_d_of_type_Long = localSharedPreferences.getLong("kandian_push_0x210_c5_msg_time", 0L);
    return paramqbg;
  }
  
  public static qbg a(byte[] paramArrayOfByte)
  {
    return a(paramArrayOfByte, 1);
  }
  
  public static qbg a(byte[] paramArrayOfByte, int paramInt)
  {
    int i1 = 0;
    ...
    for (;;)
    {
      try
      {
        submsgtype0xc5.MsgBody localMsgBody = new submsgtype0xc5.MsgBody();
        localMsgBody.mergeFrom(paramArrayOfByte);
        localqbg.jdField_a_of_type_Int = paramInt;
        localqbg.jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
        localqbg.jdField_b_of_type_Int = localMsgBody.uint32_source.get();
        if (QLog.isColorLevel()) {
          QLog.d("KandianOx210MsgInfo", 2, "receive push 0xc5, bid = " + localqbg.jdField_b_of_type_Int);
        }
        localqbg.jdField_c_of_type_Int = localMsgBody.uint32_bid.get();
        if (QLog.isColorLevel()) {
          QLog.d("KandianOx210MsgInfo", 2, "receive push 0xc5, realbid = " + localqbg.jdField_c_of_type_Int);
        }
        localqbg.jdField_a_of_type_Long = localMsgBody.uint64_article_id.get();
        localqbg.jdField_b_of_type_Long = localMsgBody.uint64_seq.get();
        if (localMsgBody.bytes_diandian_cookie.has()) {
          localqbg.jdField_c_of_type_JavaLangString = localMsgBody.bytes_diandian_cookie.get().toStringUtf8();
        }
        if ((localMsgBody.msg_notify_infos.has()) && (localMsgBody.msg_notify_infos.get() != null) && (((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.has()) && (((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.get() != null))
        {
          ...
          {
            localqbg.jdField_a_of_type_JavaUtilArrayList.clear();
            ...
            if (paramInt < paramArrayOfByte.size())
            {
              ...
              localqbg.jdField_a_of_type_JavaUtilArrayList.add(localObject2);
              paramInt += 1;
              continue;
            }
          }
          ...
          if (((submsgtype0xc5.StyleSheet)localObject1).uint32_show_folder.has())
          {
            ...
            localqbg.jdField_e_of_type_Int = paramInt;
            ...
            localqbg.jdField_g_of_type_Int = paramInt;
            ...
            localqbg.jdField_a_of_type_JavaLangString = paramArrayOfByte;
            ...
            localqbg.jdField_b_of_type_JavaLangString = paramArrayOfByte;
            if (((!((submsgtype0xc5.StyleSheet)((submsgtype0xc5.StyleSheet)localObject1).get()).msg_tip_body.has()) || (((submsgtype0xc5.StyleSheet)((submsgtype0xc5.StyleSheet)localObject1).get()).msg_tip_body.get() == null)) && (localqbg.jdField_a_of_type_JavaUtilArrayList.size() == 0)) {
              return null;
            }
            if (((!((submsgtype0xc5.StyleSheet)((submsgtype0xc5.StyleSheet)localObject1).get()).msg_tip_body.has()) || (((submsgtype0xc5.StyleSheet)((submsgtype0xc5.StyleSheet)localObject1).get()).msg_tip_body.get() == null)) && (localqbg.jdField_a_of_type_JavaUtilArrayList.size() > 0)) {
              return localqbg;
            ...
            if (((submsgtype0xc5.StyleSheet)localObject1).uint32_show_lock_screen.has())
            {
              ...
              localqbg.jdField_f_of_type_Int = paramInt;
              paramInt = i1;
              ...
              localqbg.jdField_h_of_type_Int = paramInt;
              if (((submsgtype0xc5.TipsBody)localObject2).uint64_uin.has())
              {
                ...
                localqbg.jdField_e_of_type_Long = l1;
                ...
                localqbg.jdField_e_of_type_JavaLangString = paramArrayOfByte;
                ...
                localqbg.jdField_d_of_type_JavaLangString = paramArrayOfByte;
                ...
                localqbg.jdField_f_of_type_JavaLangString = paramArrayOfByte;
                ...
                localqbg.jdField_g_of_type_JavaLangString = paramArrayOfByte;
                if ((localMsgBody.msg_notify_infos.has()) && (localMsgBody.msg_notify_infos.get() != null) && (((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.has()) && (((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.get() != null) && (((submsgtype0xc5.StyleSheet)((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.get()).msg_type.has())) {
                  localqbg.i = ((submsgtype0xc5.StyleSheet)((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.get()).msg_type.get();
                }
                if ((((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_bb_info.has()) && (((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_bb_info.get() != null))
                {
                  ...
                  localqbg.jdField_c_of_type_Long = paramArrayOfByte.uint64_bb_uin.get();
                  localqbg.jdField_d_of_type_Int = paramArrayOfByte.uint32_src.get();
                }
                localqbg.jdField_h_of_type_JavaLangString = localMsgBody.str_msgid.get();
                return localqbg;
              }
            }
            else
  ...
  public static qbg b()
  {
    return a(a(bhvy.a(onh.a(), true, false).getString("kandian_push_0x210_msg_for_follow", ""), 1));
  }
  ...
  public static qbg c()
  {
    return a(a(bhvy.a(onh.a(), true, false).getString("kandian_push_0x210_msg_for_follow_show_in_folder", ""), 1));
  }
  ...
  public String a()
  {
    return bbmx.a(this.jdField_a_of_type_ArrayOfByte);
  }
