...
public class rno
{
  ...
  private rmz jdField_a_of_type_Rmz = new rnp(this);
  rnq jdField_a_of_type_Rnq;
  private boolean jdField_a_of_type_Boolean;
  
  public rno(AppInterface paramAppInterface, int paramInt)
  {
  ...
  {
    rmu localrmu = (rmu)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.READ_INJOY_REFRESH_MANAGER);
    RefreshData localRefreshData;
    if (paramRefreshInfo.has())
    {
      paramRefreshInfo = new RefreshData(paramRefreshInfo);
      localRefreshData = localrmu.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApplication(), paramInt2);
      ...
      if (localRefreshData != null)
      {
        bhhr.f(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApplication(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), null, paramInt2);
        FileUtils.deleteFilesInDirectory(rns.a());
        localrmu.a(0, "", -1L, paramInt2);
      }
    }
    for (;;)
    {
      if (paramRefreshInfo != null)
      {
        ...
        bhhr.f(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApplication(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), paramRefreshInfo.toJson().toString(), paramInt2);
      }
      ...
      {
        FileUtils.deleteFilesInDirectory(rns.a());
        localrmu.a(paramRefreshInfo, this.jdField_a_of_type_Int);
      }
    }
  }
  ...
  private void a(int paramInt1, RefreshData paramRefreshData, oidb_0x5bd.SkinInfo paramSkinInfo, oidb_0x5bd.GuideInfo paramGuideInfo, int paramInt2)
  {
    ...
    if (paramSkinInfo.has())
    {
      ...
      paramGuideInfo = (rna)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.READ_INJOY_SKIN_MANAGER);
      ...
      bhhr.s(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApplication(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), null);
      if ((paramRefreshData != null) && (paramInt1 <= paramRefreshData.endTime))
      {
        paramRefreshData.isShown = true;
        bhhr.f(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApplication(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), paramRefreshData.toJson().toString(), paramInt2);
      }
    }
    label215:
    ...
    label259:
    bhhr.s(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApplication(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), paramSkinInfo.toJson().toString());
  ...
  {
    if (this.jdField_a_of_type_Rnq != null) {
      this.jdField_a_of_type_Rnq.a(paramInt, paramString, paramBaseResData);
    }
  }
  
  private void a(int paramInt1, oidb_0x5bd.GuideInfo paramGuideInfo, int paramInt2)
  {
    rmt localrmt = (rmt)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.READ_IN_JOY_OPERATION_MANAGER);
    Object localObject;
    int i;
  ...
  public void a(rnq paramrnq)
  {
    this.jdField_a_of_type_Rnq = paramrnq;
  }
  
  public void b()
  {
    this.jdField_a_of_type_Rnq = null;
    this.jdField_a_of_type_ComTencentCommonAppAppInterface.removeObserver(this.jdField_a_of_type_Rmz);
  }
}
