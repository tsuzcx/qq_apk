...
public class rno
{
  private static Map<String, rnp> jdField_a_of_type_JavaUtilMap = new HashMap();
  ...
  public static ono a(ArticleInfo paramArticleInfo)
  {
    ...
    localono.b("folder_status", onh.d);
    localono.b("feeds_source", paramArticleInfo.mSubscribeID);
    localono.b("feeds_type", paramArticleInfo.mFeedType);
    localono.b("kandian_mode", onh.e());
    localono.b("tab_source", onh.d());
    localono.b("rowkey", paramArticleInfo.innerUniqueID);
    localono.a("channel_id", paramArticleInfo.mChannelID);
    return localono;
  }
  
  public static ono a(ArticleInfo paramArticleInfo, boolean paramBoolean, long paramLong, int paramInt)
  {
    ono localono = onh.a();
    localono.b("algorithm_id", "" + paramArticleInfo.mAlgorithmID);
    localono.b("strategy_id", "" + paramArticleInfo.mStrategyId);
    if (paramBoolean) {}
    for (String str = "2";; str = "1")
    {
      localono.b("feeds_channel_entrance", str);
      localono.b("mp_article_id", "" + paramArticleInfo.mArticleID);
      localono.b("rowkey", paramArticleInfo.innerUniqueID);
      localono.b("channel_id", "" + a(paramBoolean, paramLong));
      if (paramInt != -1) {
        localono.b("source_extratype", paramInt);
      }
      return localono;
    }
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if (NetworkState.isWifiConn())
        {
          ...
          localJSONObject.put("net_type", naj.a() + "");
  ...
  private static rnp a(String paramString)
  {
    rnp localrnp2 = (rnp)jdField_a_of_type_JavaUtilMap.get(paramString);
    rnp localrnp1 = localrnp2;
    if (localrnp2 == null)
    {
      localrnp1 = new rnp(onz.a(paramString));
      jdField_a_of_type_JavaUtilMap.put(paramString, localrnp1);
    }
    return localrnp1;
  }
  ...
  public static void a(Context paramContext, AppInterface paramAppInterface, ArticleInfo paramArticleInfo, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    paramContext = old.a(paramContext, paramAppInterface.getCurrentAccountUin(), i, paramArticleInfo.mArticleID, paramArticleInfo.innerUniqueID, paramInt1, paramInt2, paramBoolean);
    nol.a(null, "", "0X8009544", "0X8009544", 0, 0, "", String.valueOf(paramArticleInfo.mArticleID), String.valueOf(paramArticleInfo.mAlgorithmID), paramContext, false);
  }
  ...
  public static void a(Context paramContext, AppInterface paramAppInterface, ArticleInfo paramArticleInfo, int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    int i = a((int)paramArticleInfo.mChannelID, paramArticleInfo.mFeedType);
    paramContext = old.a(paramContext, paramAppInterface.getCurrentAccountUin(), i, paramArticleInfo.mArticleID, paramArticleInfo.innerUniqueID, paramInt1, paramInt2, paramBoolean1, Boolean.valueOf(paramBoolean2));
    nol.a(null, "", "0X800979D", "0X800979D", 0, 0, "", String.valueOf(paramArticleInfo.mArticleID), String.valueOf(paramArticleInfo.mAlgorithmID), paramContext, false);
  }
  
  public static void a(ArticleInfo paramArticleInfo, int paramInt1, int paramInt2, ono paramono)
  {
    int j = BaseApplicationImpl.getApplication().getResources().getDisplayMetrics().widthPixels;
    int i = Utils.px2dp(paramInt1);
    j = Utils.px2dp(j);
    paramono.b("read_area", "" + j * i);
    paramono.b("article_page", "" + Utils.px2dp(paramInt2));
    paramono.b("read_page", "" + Utils.px2dp(paramInt1));
    nol.a(null, "CliOper", "", "", "0X8009782", "0X8009782", 0, 0, "" + paramArticleInfo.mArticleID, "", "", paramono.a(), false);
  }
  ...
  public static void a(ArticleInfo paramArticleInfo, int paramInt1, int paramInt2, boolean paramBoolean, long paramLong, int paramInt3)
  {
    ...
    ono localono = a(paramArticleInfo, paramBoolean, paramLong, paramInt3);
    a(paramArticleInfo, paramInt2, localono);
    a(paramArticleInfo, localono);
    a(paramArticleInfo, paramInt1, paramInt2, localono);
    b(paramArticleInfo, localono);
    c(paramArticleInfo, a(paramArticleInfo, paramBoolean, paramLong, paramInt3));
  }
  
  public static void a(ArticleInfo paramArticleInfo, int paramInt, ono paramono)
  {
    ArrayList localArrayList = new ArrayList();
    oidb_cmd0x80a.AttributeList localAttributeList = new oidb_cmd0x80a.AttributeList();
    localAttributeList.att_id.set(1);
    localAttributeList.att_name.set("body_show_time");
    long l3 = onz.b(a(paramArticleInfo, 0));
    ...
    for (;;)
    {
      if (((oidb_cmd0x80a.AttributeList)localObject1).att_value.get() != null)
      {
        ...
        sgg.a(201, localArrayList);
      }
      try
      {
        paramono.a("body_show_time", String.valueOf(l3));
        paramono.a("body_height", String.valueOf(paramInt));
        paramono.a("scroll_time", String.valueOf(l2));
        paramono.a("scroll_list", localStringBuilder.toString());
        nol.a(null, "", "0X800A467", "0X800A467", 0, 0, "", "", "", paramono.a(), false);
        return;
        label666:
  ...
  public static void a(ArticleInfo paramArticleInfo, long paramLong1, long paramLong2, ono paramono)
  {
    if (paramArticleInfo == null) {
      return;
    }
    paramono.b("read_duration", "" + paramLong1 / 1000L);
    paramono.b("read_begin_timestamp", "" + paramLong2 / 1000L);
    paramono.b("read_end_timestamp", "" + NetConnInfoCenter.getServerTime());
    nol.a(null, "CliOper", "", "" + paramArticleInfo.mSubscribeID, "0X8009781", "0X8009781", 0, 0, "" + paramArticleInfo.mArticleID, "", "", paramono.a(), false);
  }
  ...
  {
    nol.a(null, "CliOper", "", paramArticleInfo.mSubscribeID, paramString1, paramString1, 0, 0, paramArticleInfo.mArticleID + "", paramArticleInfo.mAlgorithmID + "", paramArticleInfo.innerUniqueID, paramString2, false);
  }
  ...
  public static void a(ArticleInfo paramArticleInfo, List<BaseData> paramList)
  {
    ...
    paramList.put("param_uin", onh.a());
    axrn.a(BaseApplicationImpl.getApplication()).a(null, "actKandianFastWebItemCount", true, 0L, 0L, paramList, null);
  }
  
  public static void a(ArticleInfo paramArticleInfo, ono paramono)
  {
    if (paramArticleInfo != null)
    {
      a(paramArticleInfo, onz.b(paramArticleInfo.innerUniqueID), onz.a(paramArticleInfo.innerUniqueID), paramono);
      onz.a(paramArticleInfo.innerUniqueID);
    }
  }
  ...
  public static void a(BaseData paramBaseData, String paramString)
  {
    ...
    ono localono = new ono();
    localono.b("card_source", localProteusBookData.c);
    localono.b("topic_id", localProteusBookData.d);
    localono.b("source_id", localProteusBookData.e);
    nol.a(null, "CliOper", "", "" + localFastWebArticleInfo.d, paramString, paramString, 0, 0, localFastWebArticleInfo.o + "", paramBaseData.mAlgorithmID + "", paramBaseData.innerUniqueID, localono.a(), false);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, AdData paramAdData)
  {
    ...
    {
      nmc.a(paramQQAppInterface, paramAdData);
  ...
  public static void a(QQAppInterface paramQQAppInterface, AdData paramAdData, float paramFloat, long paramLong)
  {
    if ((paramQQAppInterface != null) && (paramAdData != null))
    {
      nmc.a(paramQQAppInterface, paramAdData, paramFloat, paramLong);
  ...
  public static void a(String paramString, JSONObject paramJSONObject1, JSONObject paramJSONObject2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramString = new ono(localJSONObject2);
        paramString.e();
        nol.a(null, "", str, str, 0, 0, "", "", "", paramString.a(), false);
  ...
  public static void a(JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        Object localObject2 = new ono((JSONObject)localObject1);
        ((ono)localObject2).e();
        nol.a(null, "", str, str, 0, 0, "", "", "", ((ono)localObject2).a(), false);
        ...
        try
        {
          ...
          else
          {
            ...
            awsq.a(null, new ReportModelDC02528().module("all_search").action("exp_jingtan_list").obj1("2049").ver2("kandian").ver4(str).ver6(localJSONObject.getString("articleRowKey")).ver7("{\"title\":\"" + localJSONObject.getString("articleTitle") + "\"}").session_id(paramJSONObject.getString("kdschSessionId")));
            return;
          }
        }
  ...
  public static void b(ArticleInfo paramArticleInfo, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ono localono = a(paramArticleInfo);
        localono.b("source_from", paramString2);
        if (!onh.n()) {
          continue;
        }
        i = 1;
      ...
      nol.a(null, paramArticleInfo.mSubscribeID, paramString1, paramString1, 0, 0, String.valueOf(paramArticleInfo.mFeedId), String.valueOf(paramArticleInfo.mArticleID), "", paramString2, false);
      return;
      i = 0;
    }
  }
  
  public static void b(ArticleInfo paramArticleInfo, ono paramono)
  {
    rnp localrnp = a(paramArticleInfo.innerUniqueID);
    if (localrnp.a.isEmpty()) {
      return;
    }
    paramono.i();
    paramono.b("read_begin_timestamp", "" + localrnp.jdField_b_of_type_Long / 1000L);
    paramono.b("read_end_timestamp", "" + localrnp.c / 1000L);
    String str1 = "";
    Iterator localIterator = localrnp.a.iterator();
    long l = 0L;
    ...
    paramono.b("read_speed_array", str1);
    paramono.b("avg_speed", "" + l / localrnp.a.size());
    nol.a(null, "CliOper", "", "", "0X8009783", "0X8009783", 0, 0, "" + paramArticleInfo.mArticleID, "", "", paramono.a(), false);
  ...
  public static void b(QQAppInterface paramQQAppInterface, AdData paramAdData)
  {
    if ((paramQQAppInterface != null) && (paramAdData != null))
    {
      nmc.b(paramQQAppInterface, paramAdData);
  ...
  public static void b(JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      paramJSONObject = new ono(localJSONObject);
      paramJSONObject.e();
      nol.a(null, "", "0X8009A7D", "0X8009A7D", 0, 0, "", "", "", paramJSONObject.a(), false);
      return;
    }
    catch (Exception paramJSONObject) {}
  }
  ...
  private static void c(ArticleInfo paramArticleInfo, ono paramono)
  {
    paramono.b().e();
    ...
    while (i < j)
    {
      ...
      long l = onz.b(str);
      paramono.a(jdField_a_of_type_ArrayOfJavaLangString[localInteger.intValue()] + "_duration_millis", l);
      onz.a(str);
      i += 1;
    }
    nol.a(null, "CliOper", "", "" + paramArticleInfo.mSubscribeID, "0X80099D2", "0X80099D2", 0, 0, "", "" + paramArticleInfo.mArticleID, "", paramono.a(), false);
  }
}
