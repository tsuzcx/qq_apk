  ...
  implements rek
{
  ...
  private ImageView a(ListView paramListView)
  {
    if ((paramListView != null) && (paramListView.getOverScrollFooterView() != null)) {
      return (ImageView)paramListView.getOverScrollFooterView().findViewById(2131368635);
    }
    return null;
  }
  ...
  {
    return (String)bhvy.a("kandian_daily_wrapper_default_text", paramContext.getResources().getString(2131718388));
  }
  
  public static void a(int paramInt)
  {
    ono localono = onh.a();
    localono.b("jump_src", oou.b());
    localono.b("entrance", "" + paramInt);
    localono.b("cmd", bhvy.g());
    nol.a(null, "", "0X8009883", "0X8009883", 0, 0, "", "", "", localono.a(), false);
  }
  ...
  public static void a(Activity paramActivity, Bundle paramBundle)
  {
    ...
    List localList = osg.a().a(Integer.valueOf(oou.b()));
    if ((localList != null) && (!localList.isEmpty()))
    {
      KandianMergeManager localKandianMergeManager = (KandianMergeManager)onh.a().getManager(162);
      orw localorw = new orw();
      localorw.jdField_a_of_type_Long = ((Long)localList.get(localList.size() - 1)).longValue();
      localorw.jdField_a_of_type_Int = 13;
      localKandianMergeManager.a(localorw);
    }
    paramActivity.finish();
    paramActivity.overridePendingTransition(2130771990, 2130772317);
    localBundle.putString("folder_status", olj.a());
    localBundle.putBoolean("force_refresh", true);
    if (paramBundle != null) {
      localBundle.putAll(paramBundle);
    }
    nuq.a((QQAppInterface)onh.a(), paramActivity, 13, 0, localBundle);
  }
  ...
  private void b(ListView paramListView)
  {
    ...
    onh.a(paramListView.getContext(), str);
    a(1);
  }
  ...
  public void c(int paramInt, View paramView, ListView paramListView)
  {
    ...
    do
    {
      return;
      a(paramListView);
    } while (this.jdField_a_of_type_Float <= oou.a());
