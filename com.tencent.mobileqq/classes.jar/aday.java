...
class aday
  extends ntf
{
  aday(adax paramadax, awxt paramawxt) {}
  
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    if (QLog.isColorLevel()) {
      QLog.i("DoraemonOpenAPI.permissionHelper.jobApiPermission", 2, "onResult type=" + this.jdField_a_of_type_Awxt.jdField_a_of_type_Int + ", appid=" + this.jdField_a_of_type_Awxt.jdField_a_of_type_JavaLangString + ", code=" + paramInt);
    }
    if ((paramInt != 0) || (paramArrayOfByte == null))
    {
      adax.a(this.jdField_a_of_type_Adax, new AppInfoError(6, "jobApiPermission req error"));
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        adax.b(this.jdField_a_of_type_Adax, new AppInfoError(6, "jobApiPermission rsp invalid"));
        if (!QLog.isColorLevel()) {
          continue;
        }
      ...
      {
        adax.c(this.jdField_a_of_type_Adax, new AppInfoError(6, "jobApiPermission parse rsp error"));
      }
      if (QLog.isColorLevel())
      {
        ...
        paramArrayOfByte = adap.a();
        paramArrayOfByte.a(paramBundle.get_privilege_rsp.api_groups.get(), this.jdField_a_of_type_Awxt.jdField_a_of_type_JavaUtilSet);
        if (paramBundle.get_privilege_rsp.api_names.size() > 0)
        {
          ...
          while (((Iterator)localObject).hasNext())
          {
            ...
            if (adap.a(paramArrayOfByte, str)) {
              this.jdField_a_of_type_Awxt.jdField_a_of_type_JavaUtilSet.add(str);
            }
          }
        }
        this.jdField_a_of_type_Awxt.c = (NetConnInfoCenter.getServerTimeMillis() + Math.max(paramBundle.get_privilege_rsp.next_req_duration.get() * 1000L, 300000L));
        awxy.a().a(this.jdField_a_of_type_Awxt);
        adax.a(this.jdField_a_of_type_Adax, this.jdField_a_of_type_Awxt);
        return;
        label513:
        paramBundle = "";
      }
