  ...
  implements Manager
{
  ...
  public aqkj(QQAppInterface paramQQAppInterface)
  {
  ...
  public IntimateInfo a(String paramString)
  {
    ...
    while ((this.jdField_a_of_type_Aukp == null) || (!this.jdField_a_of_type_Aukp.a())) {
      return null;
    }
    return (IntimateInfo)this.jdField_a_of_type_Aukp.a(IntimateInfo.class, paramString);
  }
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          b(str);
        } while (this.jdField_a_of_type_Ayxs == null);
        Object localObject = new ayrx();
        ((ayrx)localObject).jdField_a_of_type_Aysc = new aqkk(this);
        ((ayrx)localObject).jdField_a_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
        ((ayrx)localObject).jdField_a_of_type_Int = 0;
        ((ayrx)localObject).c = str;
        ((ayrx)localObject).e = 0;
        ((ayrx)localObject).jdField_a_of_type_Aysb = new aqkl(this);
        localObject = new ayxq(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.b, new aqkm(this), (ayrx)localObject);
        this.jdField_a_of_type_Ayxs.a(10089, "prd", this.b, 0, this.jdField_a_of_type_JavaLangString, str, 2, 0, false, (ayxp)localObject);
        return;
      } while (c());
      bool1 = b(str, a());
      bool2 = c();
  ...
  public void a(IntimateInfo paramIntimateInfo)
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_Aukp != null) && (this.jdField_a_of_type_Aukp.a())) {
        this.jdField_a_of_type_Aukp.a(paramIntimateInfo);
      }
    } while (!QLog.isColorLevel());
  ...
  public void a(String paramString)
  {
    ...
    do
    {
      ...
      paramString = (IntimateInfo)this.jdField_a_of_type_Aukp.a(IntimateInfo.class, paramString);
      if (paramString != null) {
  ...
  public void a(String paramString, IntimateInfo paramIntimateInfo)
  {
    ...
    do
    {
      return;
      if ((this.jdField_a_of_type_Aukp != null) && (this.jdField_a_of_type_Aukp.a())) {
        this.jdField_a_of_type_Aukp.b(paramIntimateInfo);
      }
    } while (!QLog.isColorLevel());
