...
{
  public vpe(TroopGiftMsgItemBuilder paramTroopGiftMsgItemBuilder, URLDrawable paramURLDrawable, MessageForTroopGift paramMessageForTroopGift, vpk paramvpk) {}
  ...
  public void onFileDownloadSucceed(long paramLong)
  {
    ...
    for (;;)
    {
      if (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqDataMessageForTroopGift.interactId)) {
        this.jdField_a_of_type_ComTencentMobileqqActivityAioItemTroopGiftMsgItemBuilder.a(((RegionDrawable)this.jdField_a_of_type_ComTencentImageURLDrawable.getCurrDrawable()).getBitmap(), i, this.jdField_a_of_type_Vpk.a, this.jdField_a_of_type_ComTencentMobileqqDataMessageForTroopGift.giftPicId + "");
      }
      do
      {
        return;
