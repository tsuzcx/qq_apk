...
public class akwm
{
  ...
  public static void a(LaunchParam paramLaunchParam, int paramInt, OnUpdateListener paramOnUpdateListener)
  {
    ...
    localBundle.putParcelable("receiver", aksh.a(new ComIPCUtils.2(null, paramOnUpdateListener)));
    QIPCClientHelper.getInstance().callServer("QWalletIPCModule", "ComIPCUtils", localBundle, null);
  }
  ...
  public static void a(LoadParam paramLoadParam, LoadParam.LoadItem paramLoadItem, bcoa parambcoa)
  {
    Bundle localBundle = new Bundle();
    localBundle.putInt("oper_type", 17);
    ...
    localBundle.putSerializable("load_param", paramLoadParam);
    localBundle.putSerializable("load_item", paramLoadItem);
    QIPCClientHelper.getInstance().callServer("QWalletIPCModule", "ComIPCUtils", localBundle, new akwn(parambcoa));
  }
  ...
  public static void a(String paramString, akph paramakph)
  {
    ...
    localBundle.putInt("code", paramakph.hashCode());
    localBundle.putParcelable("receiver", aksh.a(new ComIPCUtils.3(null, paramakph, paramString)));
    QIPCClientHelper.getInstance().callServer("QWalletIPCModule", "ComIPCUtils", localBundle, null);
  }
