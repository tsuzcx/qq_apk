...
public class aguc
  extends agsl
{
  protected aguc(NewPhotoListActivity paramNewPhotoListActivity)
  {
  ...
  public static agse b(NewPhotoListActivity paramNewPhotoListActivity)
  {
    ...
    {
      if ((jdField_a_of_type_Agse == null) || (jdField_a_of_type_Agse.jdField_a_of_type_MqqUtilWeakReference.get() != paramNewPhotoListActivity)) {
        jdField_a_of_type_Agse = new aguc(paramNewPhotoListActivity);
      }
  ...
  protected String a(LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    if (this.jdField_a_of_type_Agsd.b == 6) {
      return ((NewPhotoListActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).getResources().getString(2131695098, new Object[] { Integer.valueOf(i) });
    }
    if (this.jdField_a_of_type_Agsd.b == 2) {
  ...
  protected void a(View paramView)
  {
    ...
    {
      i = this.jdField_a_of_type_Agsb.jdField_a_of_type_JavaUtilArrayList.size();
      agqf.b(paramView, i);
  ...
  public void b(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    {
      paramAdapterView = bbcv.a((Activity)this.jdField_a_of_type_MqqUtilWeakReference.get(), "请选择不超过" + (float)this.jdField_a_of_type_Agsb.jdField_b_of_type_Long / 1024.0F / 1024.0F / 1024.0F + "G的视频");
    ...
    {
      paramAdapterView = bbcv.a((Activity)this.jdField_a_of_type_MqqUtilWeakReference.get(), "请选择不超过" + this.jdField_a_of_type_Agsb.jdField_c_of_type_Long / 60L / 1000L + "分钟的视频");
      paramAdapterView.setPositiveButton(2131694793, new bbdf());
      paramAdapterView.show();
      return;
    }
