  ...
  extends BaseAdapter
{
  ...
  List<azwu<TroopInfo, Boolean>> jdField_a_of_type_JavaUtilList;
  
  public azwq(Activity paramActivity, List<TroopInfo> paramList, TroopInfo paramTroopInfo, List<String> paramList1)
  {
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    if (paramTroopInfo != null)
    {
      this.jdField_a_of_type_JavaUtilList.add(new azwu(paramTroopInfo, Boolean.valueOf(true)));
    ...
    if (paramList != null)
    {
      ...
      while (paramActivity.hasNext())
      {
        ...
        if (paramList != null)
        {
          ...
          {
            this.jdField_a_of_type_JavaUtilList.add(new azwu(paramList, Boolean.valueOf(bool)));
            break;
          }
        }
      }
  ...
  {
    azwu localazwu = (azwu)getItem(paramInt);
    Object localObject1;
    if (paramView != null)
    {
      localObject1 = (azwt)paramView.getTag();
      ...
      paramView.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(((Boolean)localazwu.b).booleanValue());
      localObject1 = paramView.jdField_a_of_type_AndroidWidgetCheckBox;
      if (((TroopInfo)localazwu.a).troopuin.equals(this.jdField_a_of_type_JavaLangString)) {
        break label458;
      }
    }
    label458:
    for (boolean bool = true;; bool = false)
    {
      ...
      paramView.jdField_a_of_type_AndroidWidgetCheckBox.setOnCheckedChangeListener(new azwr(this, localazwu));
      paramViewGroup.setOnClickListener(new azws(this, paramView.jdField_a_of_type_AndroidWidgetCheckBox));
      paramView.jdField_a_of_type_AndroidWidgetTextView.setText(((TroopInfo)localazwu.a).troopname);
      return paramViewGroup;
      paramView = new azwt();
      paramViewGroup = new LinearLayout(this.jdField_a_of_type_AndroidAppActivity);
      paramViewGroup.setMinimumHeight(axli.a(48.0F));
      ...
      ((LinearLayout.LayoutParams)localObject1).setMargins(axli.a(12.0F), 0, 0, 0);
      ...
      ((LinearLayout.LayoutParams)localObject2).setMargins(axli.a(12.0F), 0, axli.a(12.0F), 0);
