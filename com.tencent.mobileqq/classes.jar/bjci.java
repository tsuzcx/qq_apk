...
public class bjci
  implements bjlh
{
  public bjci(ChallengeBragBase paramChallengeBragBase) {}
  ...
  protected void a(Intent paramIntent)
  {
    ...
    if (i != 0)
    {
      ...
      bjko.e("qqBaseActivity", "onSendChallengeComplete error:{KEY_ERROR_CODE:" + i + "; KEY_ERROR_MSG:" + paramIntent.getStringExtra("key_error_msg") + "}");
    }
  ...
  {
    this.a.d();
    bjko.c("qqBaseActivity", "SendChallenge exception." + paramException.getMessage(), paramException);
    ...
    for (;;)
    {
      ...
      else if ((paramException instanceof IOException))
      {
        ...
        localIntent.putExtra("key_error_msg", bjlp.a);
      }
      else
      {
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        if (localObject != null)
        {
          bjlu.a("400", (String)localObject, this.a.c, true);
    ...
    {
      bjko.c("qqBaseActivity", "SendChallenge exception." + paramJSONObject.getMessage(), paramJSONObject);
      paramJSONObject = new Intent();
      paramJSONObject.putExtra("key_error_code", -4);
      paramJSONObject.putExtra("key_error_msg", bjlp.b);
      a(paramJSONObject);
      return;
    }
