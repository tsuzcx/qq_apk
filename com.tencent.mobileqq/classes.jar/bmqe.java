  ...
  extends bmqg
{
  ...
  public bmqe(DoodleView paramDoodleView)
  {
  ...
  public static Drawable a(String paramString)
  {
    ...
    //   5: areturn
    //   6: aload_0
    //   7: invokestatic 20	xqw:a	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   10: astore_1
    //   11: aload_1
    //   12: ifnull +74 -> 86
      ...
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.b())
      {
        ...
        for (;;)
        {
          if (localIterator.hasNext())
          {
            ...
            localDynamicStickerData.centerP = localbmqk.jdField_b_of_type_AndroidGraphicsPointF;
            localDynamicStickerData.scale = localbmqk.q;
            localDynamicStickerData.rotate = localbmqk.r;
            localDynamicStickerData.translateX = (localbmqk.s + paramInt1);
            localDynamicStickerData.translateY = (localbmqk.t + paramInt2);
            localDynamicStickerData.height = localbmqk.v;
            localDynamicStickerData.width = localbmqk.u;
            localDynamicStickerData.path = localbmqk.jdField_f_of_type_JavaLangString;
            localDynamicStickerData.type = localbmqk.h;
            localDynamicStickerData.data = localbmqk.jdField_g_of_type_JavaLangString;
            localDynamicStickerData.layerWidth = j;
            localDynamicStickerData.layerHeight = i;
            localDynamicStickerData.mapMotionTrack = localbmqk.jdField_a_of_type_JavaUtilMap;
            localDynamicStickerData.setSegmentList(localbmqk.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper.getSegmentList());
        ...
        if (((ArrayList)localObject).size() > 0)
        {
          ...
          return bmyh.a((ArrayList)localObject);
        }
      }
      return null;
      j = m;
  ...
  public void a(ArrayList<PasterParcelData> paramArrayList, boolean paramBoolean, JSONArray paramJSONArray)
  {
    ...
    if (i < paramArrayList.size())
    {
      ...
      if ((localPasterParcelData.jdField_d_of_type_Int == 3) && (!TextUtils.isEmpty(localPasterParcelData.jdField_e_of_type_JavaLangString)))
      {
        ...
        j = 1;
        localbmxt = bmwa.a(BaseApplicationImpl.getContext(), localPasterParcelData.jdField_e_of_type_JavaLangString);
        if (j == 0) {
          break label443;
        }
        paramJSONArray = localbmxt;
      }
    }
    for (;;)
    {
      ...
      if (paramJSONArray != null)
      {
        ...
        localbmqk = new bmqk(this, paramJSONArray, new bmqo(localPasterParcelData.jdField_a_of_type_AndroidGraphicsPointF.x, localPasterParcelData.jdField_a_of_type_AndroidGraphicsPointF.y, localPasterParcelData.jdField_a_of_type_Float, localPasterParcelData.jdField_b_of_type_Float, localPasterParcelData.jdField_c_of_type_Float, localPasterParcelData.jdField_d_of_type_Float, (int)localPasterParcelData.jdField_e_of_type_Float, (int)localPasterParcelData.f), localPasterParcelData.jdField_a_of_type_JavaLangString, localPasterParcelData.jdField_b_of_type_JavaLangString, localPasterParcelData.jdField_c_of_type_JavaLangString, localPasterParcelData.jdField_d_of_type_Int);
        localbmqk.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper.set(localPasterParcelData.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper);
        localbmqk.jdField_g_of_type_JavaLangString = localPasterParcelData.jdField_e_of_type_JavaLangString;
        localbmqk.jdField_g_of_type_Int = localPasterParcelData.jdField_e_of_type_Int;
        localbmqk.jdField_e_of_type_Int = 0;
        localbmqk.jdField_f_of_type_Int = 1;
        localbmqk.jdField_b_of_type_Boolean = bmwa.a(localbmxt.a());
        localbmqk.c = bmwa.b(localbmxt.a());
        if (localbmqk.jdField_b_of_type_Boolean)
        {
          this.jdField_b_of_type_JavaUtilList.add(localbmqk);
          if (!TextUtils.isEmpty(localPasterParcelData.jdField_d_of_type_JavaLangString))
          {
            localbmqk.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarPOI = new TroopBarPOI("-1", "", localPasterParcelData.jdField_d_of_type_JavaLangString, 0, "", 0, "");
            localbmqk.jdField_a_of_type_Long = System.currentTimeMillis();
          }
        }
        if ((this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams == null) || (!this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.b())) {
          break label471;
        ...
        this.jdField_a_of_type_JavaUtilList.add(localbmqk);
      }
      for (;;)
      {
        i += 1;
        ...
        paramJSONArray = new BitmapDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), localbmxt.a());
        break label90;
        label471:
        localbmqk.h = 0;
        paramJSONArray = (bmqg)this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.a(bmqg.jdField_a_of_type_JavaLangString);
        if (paramJSONArray != null) {
          paramJSONArray.jdField_a_of_type_JavaUtilList.add(localbmqk);
        }
      }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_JavaUtilList != null) && (!this.jdField_a_of_type_JavaUtilList.isEmpty()))
      {
        ...
        {
          Object localObject = (bmqk)localIterator.next();
          if ((((bmqk)localObject).jdField_a_of_type_AndroidGraphicsDrawableDrawable != null) && ((((bmqk)localObject).jdField_a_of_type_AndroidGraphicsDrawableDrawable instanceof URLDrawable)))
          {
            localObject = (URLDrawable)((bmqk)localObject).jdField_a_of_type_AndroidGraphicsDrawableDrawable;
            if (localObject != null)
            {
  ...
  public void b()
  {
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      ...
      while (localIterator.hasNext())
      {
        Drawable localDrawable = ((bmqk)localIterator.next()).jdField_a_of_type_AndroidGraphicsDrawableDrawable;
        if ((localDrawable instanceof bmye)) {
          ((bmye)localDrawable).a();
        }
      }
    }
    super.b();
  ...
  public void c(Canvas paramCanvas)
  {
    ...
    {
      bmqk localbmqk = (bmqk)localIterator.next();
      Object localObject2 = a(a(localbmqk.jdField_f_of_type_JavaLangString));
      if (localObject2 != null) {
        ((Drawable)localObject2).setBounds(0, 0, (int)localbmqk.u, (int)localbmqk.v);
      }
      Object localObject1 = localObject2;
      if (localbmqk.h == 3)
      {
        localObject1 = localObject2;
        if (localbmqk.jdField_a_of_type_AndroidGraphicsDrawableDrawable != null)
        {
          localObject1 = localObject2;
          if (!(localbmqk.jdField_a_of_type_AndroidGraphicsDrawableDrawable instanceof bmxt)) {}
        }
      }
      for (;;)
      {
        try
        {
          localObject1 = (bmxt)localbmqk.jdField_a_of_type_AndroidGraphicsDrawableDrawable;
          localObject1 = new BitmapDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), ((bmxt)localObject1).a());
        }
        catch (Exception localException2)
        {
          try
          {
            ...
            paramCanvas.save();
            paramCanvas.translate(-localbmqk.u / 2.0F, -localbmqk.v / 2.0F);
