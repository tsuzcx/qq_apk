...
public class afqp
  extends ajxl
{
  private afqp(AlphabetFriendFragment paramAlphabetFriendFragment) {}
    ...
    if ((paramBoolean) && (this.a.isResumed())) {
      try
      {
        ...
        if ((paramArrayOfObject != null) && (paramArrayOfObject.length > 0))
        {
          ...
          {
            bcpw.a(this.a.getActivity(), 2, ajyc.a(2131700220), 0).a();
            return;
          }
          bcpw.a(this.a.getActivity(), 2, ajyc.a(2131700221), 0).a();
          return;
        }
      }
