...
public class qog
{
  ...
  private static volatile qog jdField_a_of_type_Qog;
  private List<String> jdField_a_of_type_JavaUtilList = new ArrayList();
  private boolean jdField_a_of_type_Boolean;
  
  public static qog a()
  {
    if (jdField_a_of_type_Qog == null) {}
    try
    {
      if (jdField_a_of_type_Qog == null) {
        jdField_a_of_type_Qog = new qog();
      }
      return jdField_a_of_type_Qog;
    }
    finally {}
  }
  ...
  private void b(String paramString)
  {
    ...
    boolean bool2 = bgmg.a(str1);
    boolean bool3 = qom.a(str1, paramString);
    String str2 = str1 + "/" + "pts_app_config.json";
    boolean bool4 = qom.a(str2);
    boolean bool1;
    ...
    for (;;)
    {
      ...
      jdField_a_of_type_JavaLangString = qom.b(str2);
  ...
  public String a(String paramString)
  {
    ...
    String str = nku.a(paramString) + paramString;
