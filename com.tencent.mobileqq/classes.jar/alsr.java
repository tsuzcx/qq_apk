...
public class alsr
{
  ...
  public static ColorNote a(ColorNote paramColorNote)
  {
    ...
    String str = BaseApplicationImpl.getContext().getString(2131625304);
    int i = paramColorNote.getServiceType();
    return new alsl().a(i | 0x80000000).a(paramColorNote.getSubType()).b(paramColorNote.getMainTitle()).c(str).d(paramColorNote.getPicUrl()).a(paramColorNote.getReserve()).a();
  }
  ...
  public static ColorNote b(ColorNote paramColorNote)
  {
    ...
    return new alsl().a(i).a(paramColorNote.getSubType()).b(paramColorNote.getMainTitle()).c(paramColorNote.getSubTitle()).a(paramColorNote.getReserve()).a();
  }
