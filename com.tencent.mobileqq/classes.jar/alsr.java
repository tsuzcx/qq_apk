...
public class alsr
  extends ankx
{
  public alsr(SelectMemberActivity paramSelectMemberActivity) {}
  ...
  protected void a(boolean paramBoolean, int paramInt, long paramLong, String paramString)
  {
    ...
    if (paramInt == 1000)
    {
      QQToast.a(this.a, this.a.getString(2131696897), 2000).b(this.a.jdField_c_of_type_AndroidViewView.getHeight());
      bcst.b(this.a.app, "dc00899", "Grp_set", "", "Grp_data", "forbid_discuss", 0, 0, "", "", "", "");
      return;
    }
    QQToast.a(this.a, this.a.getString(2131691589), 2000).b(this.a.jdField_c_of_type_AndroidViewView.getHeight());
  }
  ...
  protected void a(boolean paramBoolean, int paramInt, long paramLong, ArrayList<String> paramArrayList)
  {
    ...
    QQToast.a(this.a, this.a.getString(2131691587), 2000).b(this.a.jdField_c_of_type_AndroidViewView.getHeight());
  }
  ...
  protected void a(Object[] paramArrayOfObject)
  {
    ...
    QQToast.a(this.a, this.a.getString(2131691587), 0).b(this.a.getTitleBarHeight());
  }
}
