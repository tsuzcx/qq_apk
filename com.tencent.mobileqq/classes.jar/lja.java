...
public class lja
  implements mcy
{
  private static volatile lja jdField_a_of_type_Lja;
  public int a;
  ...
  private ljc jdField_a_of_type_Ljc = new ljc(this);
  ...
  public static lja a()
  {
    if (jdField_a_of_type_Lja == null) {}
    try
    {
      if (jdField_a_of_type_Lja == null) {
        jdField_a_of_type_Lja = new lja();
      }
      return jdField_a_of_type_Lja;
    }
    finally {}
  }
  ...
  {
    return lpj.a(lpc.a().a()) == 1;
  }
  
  private boolean d()
  {
    VoiceRecognizer.shareInstance().setListener(this.jdField_a_of_type_Ljc);
    ...
    DownloadInfo localDownloadInfo = lpc.a().a();
    if (localDownloadInfo == null)
    {
      QLog.i("AVVoiceRecog", 1, "initRecognizer. init failed. downloadInfo == null.");
      return false;
    }
    String str1 = lpj.b() + localDownloadInfo.filename_so_wxvoiceembedqqegg;
    String str2 = lpj.a() + localDownloadInfo.filename_model_wxvoiceembed;
    if (!lpc.a().a())
    {
      lpc.a().b();
  ...
  public void a(VideoAppInterface paramVideoAppInterface, ljb paramljb)
  {
  ...
  public boolean c()
  {
    ...
    if (!b())
    {
      ...
      String str = lpj.b() + ((DownloadInfo)localObject).filename_so_wxvoiceembedqqegg;
      localObject = lpj.a() + ((DownloadInfo)localObject).filename_model_wxvoiceembed;
      if (!lpc.a().a())
      {
        lpc.a().b();
