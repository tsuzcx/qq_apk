...
public final class bljn
{
  ...
  public static FileManagerEntity a(Bundle paramBundle, String paramString, int paramInt)
  {
    ...
    return atvo.a(str1, str2, paramBundle, str3, l, bgmj.a(arrayOfByte), paramString, paramInt);
  }
  ...
  public static FileManagerEntity a(FavFileInfo paramFavFileInfo, String paramString, int paramInt)
  {
    ...
    return atvo.a(str1, str2, str4, str3, l, paramFavFileInfo.n, paramString, paramInt);
  }
  ...
  {
    a(paramContext, paramString1, paramBoolean1, paramString2, paramBoolean2, 2131691987);
  }
  ...
  public static void a(Context paramContext, String paramString1, boolean paramBoolean1, String paramString2, boolean paramBoolean2, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        paramString2 = paramContext.getString(2131692028);
        if (!paramBoolean2) {
          continue;
        }
        paramString1 = paramContext.getString(2131692023);
        paramString1 = bglp.a(paramContext, 230, paramString2, paramString1, 2131690582, 2131692026, new bljo(), null);
      ...
      localQQToast.b(paramContext.getResources().getDimensionPixelSize(2131298998) - (int)(5.0F * paramContext.getResources().getDisplayMetrics().density));
      return;
      paramString1 = paramContext.getString(2131692027);
      continue;
  ...
  public static boolean a(ChatMessage paramChatMessage)
  {
    ...
    return (paramChatMessage != null) && ((aqlt.c.equals(paramChatMessage.ark_app_message.appName)) || ("com.tencent.structmsg".equals(paramChatMessage.ark_app_message.appName)));
  }
  ...
  public static boolean a(boolean paramBoolean)
  {
    ...
    {
      PluginManagerHelper.getPluginInterface(BaseApplicationImpl.getApplication(), new bljp((Runnable)localObject2));
