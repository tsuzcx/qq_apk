...
public class aifn
  extends Handler
{
  public aifn(AbsPublishActivity paramAbsPublishActivity) {}
      ...
      do
      {
        do
        {
          ...
          if ((this.a.jdField_a_of_type_ComTencentMobileqqTroopWidgetTribeHotPicPanel != null) && (this.a.jdField_a_of_type_ComTencentMobileqqTroopWidgetTribeHotPicPanel.isShown()))
          {
            ...
            this.a.h();
            this.a.jdField_a_of_type_AndroidOsHandler.postDelayed(new aifo(this), 200L);
            return;
          }
          this.a.jdField_a_of_type_ComTencentMobileqqTroopWidgetPublishItemBar.a(5, 1);
          this.a.jdField_a_of_type_AndroidWidgetImageButton.setImageResource(2130841175);
          this.a.jdField_a_of_type_AndroidWidgetImageButton.setContentDescription(this.a.getString(2131430324));
          this.a.jdField_a_of_type_ComTencentMobileqqEmoticonviewSystemEmoticonPanel.setVisibility(8);
          InputMethodUtil.b(this.a.b);
          this.a.jdField_a_of_type_AndroidOsHandler.postDelayed(new aifp(this), 200L);
