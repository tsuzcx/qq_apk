...
public class aifn
{
  private static aifn jdField_a_of_type_Aifn;
  public static String a;
  private static final String jdField_b_of_type_JavaLangString = antf.cS + "icons/";
  private static final String jdField_c_of_type_JavaLangString = antf.cS + "zip/";
  private static final String jdField_d_of_type_JavaLangString = anzj.a(2131708730);
  ...
  private int a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString2.mkdirs();
        paramString1 = new bihu(paramString1, new File(jdField_c_of_type_JavaLangString + "android_qim_theme_icons.zip"));
        paramString1.f = "profileCardDownload";
        paramString1.e = "VIP_profilecard";
        return bihw.a(paramString1, null);
      }
      ...
      bhmi.b(jdField_b_of_type_JavaLangString);
      continue;
      label183:
      bhmi.b(jdField_c_of_type_JavaLangString);
    }
  }
  
  public static aifn a()
  {
    if (jdField_a_of_type_Aifn == null) {
      jdField_a_of_type_Aifn = new aifn();
    }
    return jdField_a_of_type_Aifn;
  }
  ...
  private boolean a(String paramString)
  {
    ...
    //   11: getstatic 49	aifn:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   42: invokestatic 316	bhmi:c	(Ljava/lang/String;)Ljava/lang/String;
    //   45: astore_3
    //   46: aload_3
    ...
    //   58: ifeq -22 -> 36
    //   61: getstatic 45	aifn:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   64: invokestatic 143	bhmi:b	(Ljava/lang/String;)V
    //   67: aload_2
    //   68: getstatic 45	aifn:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   71: invokestatic 324	nof:a	(Ljava/io/File;Ljava/lang/String;)V
    //   74: iconst_1
    //   75: ireturn
    //   76: astore_1
  ...
  public Drawable a(int paramInt)
  {
    ...
    localObject = bhmq.a(jdField_b_of_type_JavaLangString + "skin_header_bar.png", localOptions);
    if (localObject != null)
    {
  ...
  public void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    if (localObject != null)
    {
      localObject = ((anyw)localObject).e(paramSessionInfo.jdField_a_of_type_JavaLangString);
  ...
  public void a(ArrayList<aifo> paramArrayList, ArrayList<int[]> paramArrayList1)
  {
  ...
  {
    if ((!paramBoolean) && ((!(paramObject instanceof ahtp)) || ((paramObject instanceof ahtz)))) {}
    do
    {
      return false;
  ...
  public Drawable b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (localObject2 == null)
      {
        localBitmap = bhmq.a(jdField_b_of_type_JavaLangString + "skin_aio_qim_header_flag.png", (BitmapFactory.Options)localObject3);
        localObject1 = localObject2;
        if (localBitmap != null)
        {
          ...
          if (localBitmap == null)
          {
            localObject1 = bhmq.a(jdField_b_of_type_JavaLangString + "title_bg_round.9.png", (BitmapFactory.Options)localObject3);
          ...
          if (localObject2 == null)
          {
            localBitmap = bhmq.a(jdField_b_of_type_JavaLangString + "aio_qim_online_icon.png", (BitmapFactory.Options)localObject3);
            localObject1 = localObject2;
            if (localBitmap != null)
            {
              localObject1 = new BitmapDrawable(localBitmap);
              ...
              {
                localObject2 = bhmq.a(jdField_b_of_type_JavaLangString + "qim_title_immersive_bar.png", (BitmapFactory.Options)localObject3);
                localObject1 = localBitmap;
                if (localObject2 != null)
                {
                  ...
                  if (localObject2 == null)
                  {
                    localObject1 = bhmq.a(jdField_b_of_type_JavaLangString + "aio_qim_user_online_title_icon.png", (BitmapFactory.Options)localObject3);
                    localObject1 = new BitmapDrawable(BaseApplicationImpl.getContext().getResources(), (Bitmap)localObject1);
                    ((Drawable)localObject1).setBounds(0, 0, bdep.a(13.0F), bdep.a(13.0F));
                    continue;
                    label501:
                    localObject1 = null;
                  }
