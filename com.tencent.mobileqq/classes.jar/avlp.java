  ...
  implements bdrm
{
  ...
  public avlp(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      if (localSingChangePushInfo != null)
      {
        ...
        for (paramObject = localSingChangePushInfo.bytes_gray_tips.get().toStringUtf8();; paramObject = null)
        {
          ...
          long l4 = ((bdrb)paramQQAppInterface.getManager(339)).a(4, 1, l2);
          if (QLog.isColorLevel()) {
        ...
        SingTogetherSession localSingTogetherSession = (SingTogetherSession)bdro.a(4, 1, String.valueOf(l2));
        if (i == 1) {
          if (l3 != -1L) {
            break label542;
          }
        ...
        for (String str = "";; str = String.valueOf(l3))
        {
          ...
          avmu.a(paramQQAppInterface, l2, 1, paramObject, i, paramLong1, paramLong2, 131087);
          return;
        }
      }
  ...
  public void a(QQAppInterface paramQQAppInterface, SingTogetherSession paramSingTogetherSession, int paramInt, long paramLong1, String paramString, long paramLong2, long paramLong3, TroopTips0x857.SingChangePushInfo paramSingChangePushInfo)
  {
    ...
    bdrb localbdrb = (bdrb)paramQQAppInterface.getManager(339);
    localbdrb.a(4, paramSingTogetherSession.jdField_e_of_type_Int, paramSingTogetherSession.jdField_e_of_type_JavaLangString, paramLong2);
    Object localObject = (SingTogetherSession)localbdrb.a(paramSingTogetherSession.jdField_d_of_type_Int, paramSingTogetherSession.jdField_e_of_type_Int, paramSingTogetherSession.jdField_e_of_type_JavaLangString);
    if (localObject != null)
    {
    ...
    for (;;)
    {
      if (paramInt == 1)
      {
        bdro.a(paramQQAppInterface, paramSingTogetherSession.jdField_e_of_type_JavaLangString, true, paramSingTogetherSession.jdField_e_of_type_Int, 16777216);
        label164:
        if (paramSingTogetherSession.jdField_e_of_type_Int != 2) {
          break label306;
        }
        localObject = ((anmw)paramQQAppInterface.getManager(51)).b(paramSingTogetherSession.jdField_e_of_type_JavaLangString);
      ...
      {
        return;
        localbdrb.a(paramSingTogetherSession.jdField_d_of_type_Int, paramSingTogetherSession.jdField_e_of_type_Int, paramSingTogetherSession.jdField_e_of_type_JavaLangString, paramSingTogetherSession);
        break;
        if (paramInt == 2)
        {
          paramSingTogetherSession.g = 3;
          paramSingTogetherSession.h = 3;
          bdro.a(paramQQAppInterface, paramSingTogetherSession.jdField_e_of_type_JavaLangString, false, paramSingTogetherSession.jdField_e_of_type_Int, 16777216);
          break label164;
        }
      ...
      localObject = localbdrb.a(4, paramSingTogetherSession.jdField_e_of_type_Int, paramSingTogetherSession.jdField_e_of_type_JavaLangString, 1003);
      ((bdrh)localObject).jdField_a_of_type_AndroidOsBundle.putInt("action_type", paramInt);
      ((bdrh)localObject).jdField_a_of_type_AndroidOsBundle.putString("tips", paramString);
      ((bdrh)localObject).jdField_a_of_type_AndroidOsBundle.putLong("seq", paramLong2);
      ((bdrh)localObject).jdField_a_of_type_AndroidOsBundle.putLong("msgSeq", paramLong3);
      ((bdrh)localObject).jdField_a_of_type_JavaLangObject = paramSingChangePushInfo;
      ...
      localbdrb.a(4, paramSingTogetherSession.jdField_e_of_type_Int, paramSingTogetherSession.jdField_e_of_type_JavaLangString, 1003);
      return;
      label451:
      paramSingTogetherSession = (SingTogetherSession)localObject;
    }
  ...
  public void a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, long paramLong1, long paramLong2, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      l4 = ((bdrb)paramQQAppInterface.getManager(339)).a(4, 2, l2);
      if (l3 >= l4) {
        break label673;
      }
    } while (!QLog.isColorLevel());
    ...
    return;
    label673:
    SingTogetherSession localSingTogetherSession = (SingTogetherSession)bdro.a(4, 2, String.valueOf(l2));
    if (j == 1) {
      if (l1 == 0L)
      {
        localObject = "";
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        avmu.a(paramQQAppInterface, l2, 0, paramArrayOfByte, j, paramLong1, paramLong2, 131087);
        return;
  ...
  public void a(ToServiceMsg paramToServiceMsg, aio_media.RspLatestPlayingState paramRspLatestPlayingState)
  {
    ...
    label131:
    boolean bool2 = false;
    Object localObject3 = (bdrb)this.a.getManager(339);
    paramToServiceMsg = (SingTogetherSession)((bdrb)localObject3).a(4, j, (String)localObject2);
    Object localObject1 = paramToServiceMsg;
    if (paramToServiceMsg == null)
    {
      localObject1 = (SingTogetherSession)bdro.a(4, j, (String)localObject2);
      ((bdrb)localObject3).a(4, j, (String)localObject2, (bdrn)localObject1);
    }
    boolean bool1;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localObject2 != null)
        {
          ...
          if (!TextUtils.isEmpty(((SingTogetherSession)localObject1).jdField_f_of_type_JavaLangString))
          {
            ...
            bglf.p(this.a, ((SingTogetherSession)localObject1).jdField_f_of_type_JavaLangString);
            bool2 = bool1;
            paramRspLatestPlayingState = paramToServiceMsg;
          }
          label815:
      ...
      for (paramToServiceMsg = ((aio_media.ResultInfo)localObject2).bytes_errmsg.get().toStringUtf8();; paramToServiceMsg = "")
      {
        ...
        bglf.h(this.a, ((SingTogetherSession)localObject1).jdField_e_of_type_JavaLangString, ((SingTogetherSession)localObject1).jdField_f_of_type_JavaLangString);
        paramRspLatestPlayingState = paramToServiceMsg;
        bool2 = bool1;
        break label815;
        break label958;
  ...
  public void a(Object paramObject)
  {
    ...
    {
      return;
      paramObject = ((bdrb)this.a.getManager(339)).a(4, 2, String.valueOf(paramObject));
    } while (!(paramObject instanceof SingTogetherSession));
    paramObject.g = 3;
    paramObject.h = 3;
    bdro.a(this.a, paramObject.jdField_e_of_type_JavaLangString, false, paramObject.jdField_e_of_type_Int, 16777216);
    a(true, (SingTogetherSession)paramObject, 1007, "");
  }
  
  public void a(String paramString, int paramInt)
  {
    paramString = ((bdrb)this.a.getManager(339)).a(4, 1, paramString);
    if ((paramString instanceof SingTogetherSession))
    {
      paramString.g = 3;
      paramString.h = 3;
      bdro.a(this.a, paramString.jdField_e_of_type_JavaLangString, false, paramString.jdField_e_of_type_Int, 16777216);
  ...
  {
    bdrb localbdrb = (bdrb)this.a.getManager(339);
    bdrh localbdrh = localbdrb.a(4, paramSingTogetherSession.jdField_e_of_type_Int, paramSingTogetherSession.jdField_e_of_type_JavaLangString, paramInt);
    if ((paramBoolean) && (paramInt == 1003))
    {
      int i = localbdrh.jdField_a_of_type_AndroidOsBundle.getInt("action_type");
      String str = localbdrh.jdField_a_of_type_AndroidOsBundle.getString("tips");
      long l1 = localbdrh.jdField_a_of_type_AndroidOsBundle.getLong("seq");
      long l2 = localbdrh.jdField_a_of_type_AndroidOsBundle.getLong("msgSeq");
      localbdrb.a(paramSingTogetherSession, i, str, l1, l2, localbdrh.jdField_a_of_type_JavaLangObject);
      localbdrb.b(paramSingTogetherSession, i, str, l1, l2, localbdrh.jdField_a_of_type_JavaLangObject);
    }
    if (paramSingTogetherSession.g == 3) {
      bdro.a(this.a, paramSingTogetherSession.jdField_e_of_type_JavaLangString, false, paramSingTogetherSession.jdField_e_of_type_Int, 16777216);
    }
    for (;;)
    {
      localbdrb.a(paramBoolean, paramSingTogetherSession, paramInt, paramString);
      localbdrb.b(4, paramSingTogetherSession.jdField_e_of_type_Int, paramSingTogetherSession.jdField_e_of_type_JavaLangString, paramInt);
      return;
      bdro.a(this.a, paramSingTogetherSession.jdField_e_of_type_JavaLangString, true, paramSingTogetherSession.jdField_e_of_type_Int, 16777216);
    }
  }
}
