  ...
  extends BaseAdapter
{
  ...
  public avlp(Context paramContext, Drawable paramDrawable, int paramInt1, int paramInt2, int paramInt3)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (i == 0)
    {
      ...
      if (paramView == null)
      {
        paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131561085, null);
        localavlq = new avlq();
        localavlq.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)paramViewGroup.findViewById(2131368042));
        localavlq.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131377884));
        paramViewGroup.setTag(localavlq);
      ...
      for (;;)
      {
        ...
        if (localInterestTagInfo != null)
        {
          ...
          if (localavlq != null)
          {
            ...
            localavlq.jdField_a_of_type_ComTencentImageURLImageView.setImageResource(2130841094);
            if ((localInterestTagInfo.tagType == 10) || (localInterestTagInfo.tagType == 11) || (localInterestTagInfo.tagType == 9)) {
              localavlq.jdField_a_of_type_ComTencentImageURLImageView.setImageResource(2130841095);
            }
            localavlq.jdField_a_of_type_AndroidWidgetTextView.setText(localInterestTagInfo.tagName);
            localObject = paramViewGroup;
          }
        }
        label203:
        return localObject;
        localavlq = (avlq)paramView.getTag();
    ...
    for (;;)
    {
      try
      {
        ...
        paramView = URLDrawable.getDrawable(baqq.a(paramView), (URLDrawable.URLDrawableOptions)localObject);
      }
      catch (Exception localException1)
      {
        for (;;)
        {
          try
          {
            if (this.e == 7)
            {
              paramView.setTag(bcuq.b(this.jdField_a_of_type_Int, this.b, (int)(10.0F * this.jdField_a_of_type_Float)));
              paramView.setDecodeHandler(bcuq.c);
            }
            paramView.setDownloadListener(new aupv(this.jdField_a_of_type_AndroidContentContext, "actInterestTagPicDownload"));
          }
          ...
          try
          {
            ...
            localURLImageView = localavlq.jdField_a_of_type_ComTencentImageURLImageView;
