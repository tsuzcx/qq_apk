  ...
  extends bebf
{
  ...
  public void a(bdxf parambdxf, bdxe parambdxe)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        parambdxe = new cmd0x346.RspBody();
        parambdxe.mergeFrom((byte[])localObject1);
        localObject3 = (cmd0x346.ApplyDownloadRsp)parambdxe.msg_apply_download_rsp.get();
        parambdxf = (becn)localbeck.jdField_a_of_type_JavaUtilList.get(0);
        if (parambdxf != null) {
          parambdxf.d = ((Boolean)((FromServiceMsg)localObject2).getAttribute("_attr_send_by_quickHttp", Boolean.valueOf(false))).booleanValue();
        }
        if (QLog.isColorLevel()) {
          QLog.e("http_sideway", 2, "C2CPttDownHandler.onProtoResp:isSendByQuickHttp=" + parambdxf.d);
        }
        i = ((cmd0x346.ApplyDownloadRsp)localObject3).int32_ret_code.get();
        parambdxe = (cmd0x346.ExtensionRsp)parambdxe.msg_extension_rsp.get();
        if (i != 0) {
          break label637;
        }
        ...
        {
          parambdxf.jdField_a_of_type_JavaLangString = ((cmd0x346.DownloadInfo)localObject2).str_download_url.get();
          ...
          while (((Iterator)localObject2).hasNext())
          {
            ...
            localbdyf = new bdyf();
            localbdyf.jdField_a_of_type_JavaLangString = ((String)localObject3);
            parambdxf.jdField_a_of_type_JavaUtilArrayList.add(localbdyf);
          }
        }
      }
      ...
      label477:
      if ((parambdxe != null) && (parambdxe.server_addr_ipv6_list.has()))
      {
        parambdxe = (cmd0x346.AddrList)parambdxe.server_addr_ipv6_list.get();
        if (parambdxe != null)
        {
          localObject2 = parambdxe.rpt_str_ip.get();
          i = parambdxe.uint32_port.get();
          if ((localObject2 != null) && (((List)localObject2).size() > 0))
          {
            localObject2 = ((List)localObject2).iterator();
            while (((Iterator)localObject2).hasNext())
            {
              ...
              localbdyf = new bdyf();
              localbdyf.jdField_a_of_type_JavaLangString = ((String)localObject3);
              localbdyf.jdField_a_of_type_Int = i;
              localbdyf.jdField_a_of_type_Boolean = true;
              parambdxf.jdField_b_of_type_JavaUtilArrayList.add(localbdyf);
            }
          }
          parambdxf.jdField_b_of_type_JavaLangString = parambdxe.rpt_str_domain.get();
        }
      }
      a(0, 0, "", "", localanqe, parambdxf);
      continue;
      label637:
      if ((parambdxe != null) && (parambdxe.uint32_allow_retry.get() == 1))
      {
        if (QLog.isColorLevel()) {
  ...
  public void a(bebv parambebv)
  {
    if ((parambebv != null) && (parambebv.jdField_a_of_type_JavaUtilList != null) && (parambebv.jdField_a_of_type_ComTencentMobileqqTransfileProtoReqManager != null))
    {
      ...
      localbdxe.jdField_a_of_type_JavaLangString = "PttCenterSvr.pb_pttCenter_CMD_REQ_APPLY_DOWNLOAD-1200";
      if (this.jdField_a_of_type_Int == 3) {
        localbdxe.jdField_a_of_type_JavaLangString = "OfflineFilleHandleSvr.pb_ftnPtt_CMD_REQ_APPLY_DOWNLOAD-1200";
      }
  ...
  byte[] a(List<becg> paramList)
  {
    ...
    if (paramList.size() == 1)
    {
      paramList = (bebx)paramList.get(0);
      Object localObject;
  ...
  void b(bebv parambebv)
  {
    ...
    while (i < parambebv.jdField_a_of_type_JavaUtilList.size())
    {
      ...
      localbeck.jdField_a_of_type_JavaUtilList.add(i, localbecn);
      i += 1;
    }
  }
}
