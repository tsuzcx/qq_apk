...
public class amuo
{
  ...
  {
    return amhd.b(paramQQAppInterface);
  }
  
  public static amlc a(String paramString1, QQAppInterface paramQQAppInterface, int paramInt, String paramString2)
  {
    for (;;)
    {
      try
  ...
  public static amtx a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface == null) {
      return null;
    }
    return (amtx)((amul)paramQQAppInterface.getManager(249)).a().a(0);
  }
  
  public static amud a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface == null) {}
    do
    {
  ...
  public static amug a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface == null) {
      return null;
    }
    return ((amul)paramQQAppInterface.getManager(249)).a();
  }
  
  public static amuh a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface == null) {
      return null;
    }
  ...
  public static amul a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface == null) {
      return null;
    }
    return (amul)paramQQAppInterface.getManager(249);
  }
  ...
  public static ApolloActionData a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    return ((ancd)paramQQAppInterface.getManager(155)).d(paramInt);
  }
  
  public static MessageForApollo a(String paramString, amug paramamug)
  {
    for (;;)
    {
      try
      {
        ...
        if (!TextUtils.isEmpty(paramString)) {
          ((ApolloMessage)localObject).name = bgku.decode(paramString.getBytes("utf-8"), 0);
        }
        ...
        if (!paramString.isEmpty()) {
          ((ApolloMessage)localObject).text = bgku.decode(paramString.getBytes("utf-8"), 0);
        }
        ...
        if (paramString == null)
        {
          ...
          paramamug = bbzh.a(paramamug.a(), paramamug.a().a.jdField_a_of_type_JavaLangString, paramamug.a().a.jdField_b_of_type_JavaLangString, paramamug.jdField_a_of_type_Int, (ApolloMessage)localObject);
          paramamug.inputText = paramString.optString("inputText");
          paramamug.audioId = paramString.optInt("audioID");
          if (paramString.has("audioStartTime")) {
            paramamug.audioStartTime = ((float)paramString.optDouble("audioStartTime"));
          }
          paramamug.actionType = paramString.optInt("actionType");
          if (localJSONObject != null) {
            paramamug.extendJson = localJSONObject.toString();
          }
          if (paramString.has("mApollo3DMessage"))
          {
            ...
            paramamug.mApollo3DMessage = ((Apollo3DMessage)localObject);
          }
          return paramamug;
        }
      }
  ...
  public static String a(QQAppInterface paramQQAppInterface, int paramInt, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    String str = "";
    if (-1 == paramInt) {
      paramString2 = bglf.c(paramQQAppInterface, paramString1, true);
    }
    label253:
    do
    {
      for (;;)
      {
        ...
        if (paramBoolean) {}
        for (str = bglf.f(paramQQAppInterface, paramString2, paramString1);; str = bglf.e(paramQQAppInterface, paramString2, paramString1))
        {
          ...
          paramString2 = ((anmw)paramQQAppInterface.getManager(51)).e(paramString1);
    ...
    label272:
    if (paramBoolean) {}
    for (str = bglf.p(paramQQAppInterface, paramString1);; str = bglf.c(paramQQAppInterface, paramString1, true))
    {
      paramString2 = str;
  ...
  public static void a(int paramInt, Object... paramVarArgs)
  {
    ...
    ((amul)localObject).a(i, paramVarArgs);
  }
  
  public static void a(amug paramamug, List<SpriteTaskParam> paramList)
  {
    if ((paramamug == null) || (paramList == null) || (paramList.size() == 0)) {}
    do
    {
      return;
      paramamug = a(paramamug.a());
    } while (paramamug == null);
    paramamug.a().a(paramList);
  }
  
  public static void a(amux paramamux, int paramInt, ApolloActionData paramApolloActionData)
  {
    if (paramamux == null) {
      return;
    }
    ...
    paramApolloActionData = paramamux.a();
    ...
    paramamux.a().a(localSpriteTaskParam);
  }
  
  public static void a(amux paramamux, String paramString, int paramInt1, int paramInt2)
  {
    if ((paramamux == null) || (paramamux.a() == null)) {
      return;
    }
    amtx localamtx = paramamux.a();
    paramamux.a().a(paramInt1);
    paramamux = paramamux.a();
    int i = 1;
    if (paramamux != null) {
      i = amhd.a(paramamux, paramamux.c());
    }
    localamtx.a("", paramString, a(paramInt1, paramInt2, paramString, i));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, SpriteTaskParam paramSpriteTaskParam)
  {
    ...
    do
    {
      ...
      {
        return;
        localamug = a(paramQQAppInterface);
      } while (localamug == null);
      k = localamug.jdField_a_of_type_Int;
      if ((1 == k) || (3000 == k))
      {
        i = 0;
        int j;
        ...
        {
          VipUtils.a(paramQQAppInterface, "cmshow", "Apollo", "g_msg_clk", j, k, new String[] { str, paramSpriteTaskParam, String.valueOf(i), String.valueOf(System.currentTimeMillis() / 1000L), localamug.jdField_a_of_type_JavaLangString });
          return;
          i = 1;
          break;
          j = 1;
    ...
    for (int i = 0;; i = 1)
    {
      VipUtils.a(paramQQAppInterface, "cmshow", "Apollo", "msg_clk", i, 0, new String[] { Integer.toString(paramSpriteTaskParam.f), str, "", String.valueOf(System.currentTimeMillis() / 1000L), localamug.jdField_a_of_type_JavaLangString });
      return;
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, int paramInt, String paramString)
  {
    ...
    if ((paramInt == 0) && (bgjw.b(paramString)))
    {
      if (QLog.isColorLevel()) {
    ...
    if ((paramInt != 1) && (paramInt != 0) && ((paramInt != 3000) || (amhd.c("discuss") != 1)))
    {
      if (QLog.isColorLevel()) {
  ...
  public static boolean a(String paramString, SpriteTaskParam paramSpriteTaskParam, amug paramamug, boolean paramBoolean)
  {
    boolean bool2 = true;
    boolean bool1;
    if ((TextUtils.isEmpty(paramString)) || (paramamug == null) || (paramamug.a() == null)) {
      bool1 = false;
    }
    label111:
    do
    {
      do
      {
        ...
        {
          return bool1;
          paramamug = paramamug.a().getCurrentAccountUin();
          ...
          if ((!paramString.equals(paramSpriteTaskParam.jdField_b_of_type_JavaLangString)) || (!paramString.equals(paramamug))) {
            break;
          }
          bool1 = bool2;
      ...
      bool1 = bool2;
    } while (paramString.equals(paramamug));
    return false;
    return false;
  }
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          localSharedPreferences = localamug.jdField_a_of_type_AndroidContentSharedPreferences;
        } while (localSharedPreferences == null);
        i = localSharedPreferences.getInt("audio_tips_times" + localamug.jdField_b_of_type_JavaLangString, 0);
        if (QLog.isColorLevel()) {
          QLog.d("cmshow_scripted_SpriteUtil", 2, "totalTimes:" + i);
        }
      } while (3 == i);
      localSharedPreferences.edit().putInt("audio_tips_times" + localamug.jdField_b_of_type_JavaLangString, i + 1).commit();
  ...
  public static boolean b(QQAppInterface paramQQAppInterface, int paramInt, String paramString)
  {
    ...
    {
      anaw.a(i, 10, 102, new Object[] { "not meet basic case" });
    ...
    do
    {
      ...
      {
        return false;
        if (2 == amzq.a(paramQQAppInterface.c(), paramQQAppInterface))
        {
          anaw.a(i, 10, 101, new Object[] { "cmshow switch NOT opend CLOSED_STATUS" });
          QLog.i("cmshow_scripted_SpriteUtil", 1, "cmshow switch NOT opend.");
          return false;
        }
        if (!njo.a().a(paramString)) {
          break;
        }
        anaw.a(i, 10, 104, new Object[] { "aio anonymous" });
  ...
  public static boolean c(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      {
        return false;
        if (amhd.b(BaseApplicationImpl.getContext())) {
          break;
        }
      } while (!QLog.isColorLevel());
  ...
  public static boolean d(QQAppInterface paramQQAppInterface)
  {
    ...
    if (1 != amzq.a(paramQQAppInterface.c(), paramQQAppInterface))
    {
      QLog.i("cmshow_scripted_SpriteUtil", 1, "cmshow switch NOT opend.");
      return false;
    }
