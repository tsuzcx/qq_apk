...
public class baol
{
  public static baom a;
  public static final String a;
  public static HashMap<String, baom> a;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = AppConstants.SDCARD_PATH + "qbosssplahAD/";
    b = AppConstants.SDCARD_PATH + "qbdownres";
  ...
  public static HashMap<String, baom> a(String paramString, SharedPreferences paramSharedPreferences, Set<String> paramSet)
  {
    ...
    try
    {
      ...
      while (paramSet.hasNext())
      {
        ...
        localbaon.h(paramString).b(str1).c(str2).d(str3).c(i).e(str4).e(k).g(str6).f(str5).d(j).b(bool1).a(bool2).b(m).i(str7).j(str8).a(n).a(str9);
        QLog.i("QSplash@QbossSplashUtil", 1, "buildADEntryFromSP  adid =" + str1);
        jdField_a_of_type_JavaUtilHashMap.put(str1, localbaon.a());
      }
      return jdField_a_of_type_JavaUtilHashMap;
    }
    catch (Exception paramString)
  ...
  public static boolean a(long paramLong)
  {
    ...
    //   9: lload_0
    //   10: invokestatic 481	baol:a	(Landroid/content/Context;J)Ljava/util/List;
    //   13: astore 7
    //   15: iload 4
    //   17: istore_3
    //   18: aload 7
    ...
    //   55: ldc2_w 485
    //   58: lrem
    //   59: invokevirtual 128	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   62: invokevirtual 33	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   65: invokestatic 165	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   68: invokestatic 113	com/tencent/common/app/BaseApplicationImpl:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   71: new 15	java/lang/StringBuilder
    //   74: dup
    //   75: invokespecial 18	java/lang/StringBuilder:<init>	()V
    //   78: lload_0
    //   79: invokevirtual 128	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   82: ldc 91
    ...
    //   90: invokestatic 176	baol:a	(Landroid/content/Context;Ljava/lang/String;)Landroid/content/SharedPreferences;
    //   93: astore 9
    //   95: invokestatic 113	com/tencent/common/app/BaseApplicationImpl:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   98: new 15	java/lang/StringBuilder
    //   101: dup
    //   102: invokespecial 18	java/lang/StringBuilder:<init>	()V
    //   105: lload_0
    //   106: invokevirtual 128	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   109: ldc 91
    //   111: invokevirtual 27	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   114: invokevirtual 33	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   117: invokestatic 489	bmll:a	(Landroid/content/Context;Ljava/lang/String;)Landroid/content/SharedPreferences;
    //   120: astore 6
    //   122: invokestatic 113	com/tencent/common/app/BaseApplicationImpl:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   125: new 15	java/lang/StringBuilder
    //   128: dup
    //   129: invokespecial 18	java/lang/StringBuilder:<init>	()V
    //   132: lload_0
    //   133: invokevirtual 128	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   136: ldc 91
    //   138: invokevirtual 27	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   141: invokevirtual 33	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   144: invokestatic 491	baol:a	(Landroid/content/Context;Ljava/lang/String;)Ljava/util/Set;
    //   147: astore 10
    //   149: invokestatic 113	com/tencent/common/app/BaseApplicationImpl:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   152: new 15	java/lang/StringBuilder
    //   155: dup
    //   156: invokespecial 18	java/lang/StringBuilder:<init>	()V
    //   159: lload_0
    //   160: invokevirtual 128	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   163: ldc 91
    //   165: invokevirtual 27	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   168: invokevirtual 33	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   171: invokestatic 492	bmll:a	(Landroid/content/Context;Ljava/lang/String;)Ljava/util/Set;
    //   174: astore 8
    //   176: new 15	java/lang/StringBuilder
    //   179: dup
    //   180: invokespecial 18	java/lang/StringBuilder:<init>	()V
    //   183: lload_0
    //   184: invokevirtual 128	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   187: ldc 91
    //   189: invokevirtual 27	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   192: invokevirtual 33	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   195: aload 9
    //   197: aload 10
    //   199: invokestatic 494	baol:a	(Ljava/lang/String;Landroid/content/SharedPreferences;Ljava/util/Set;)Ljava/util/HashMap;
    //   202: astore 9
    //   204: aload 9
    //   206: new 15	java/lang/StringBuilder
    //   209: dup
    //   210: invokespecial 18	java/lang/StringBuilder:<init>	()V
    //   213: lload_0
    //   214: invokevirtual 128	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   217: ldc 91
    //   219: invokevirtual 27	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   222: invokevirtual 33	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   225: aload 6
    //   227: aload 8
    //   229: invokestatic 494	baol:a	(Ljava/lang/String;Landroid/content/SharedPreferences;Ljava/util/Set;)Ljava/util/HashMap;
    //   232: invokevirtual 498	java/util/HashMap:putAll	(Ljava/util/Map;)V
    //   235: aconst_null
    //   236: astore 6
    //   238: aload 7
    //   240: invokeinterface 499 1 0
    //   245: astore 10
    //   247: aload 10
    //   249: invokeinterface 196 1 0
    //   254: ifeq +107 -> 361
    //   257: aload 10
    //   259: invokeinterface 200 1 0
    //   264: checkcast 139	java/lang/String
    //   267: astore 7
    //   269: aload 9
    //   271: aload 7
    //   273: invokevirtual 502	java/util/HashMap:containsKey	(Ljava/lang/Object;)Z
    //   276: ifeq +145 -> 421
    //   279: aload 9
    //   281: aload 7
    //   283: invokevirtual 505	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   286: checkcast 507	baom
    //   289: astore 8
    //   291: ldc 61
    //   293: iconst_1
    //   294: new 15	java/lang/StringBuilder
    //   297: dup
    //   298: invokespecial 18	java/lang/StringBuilder:<init>	()V
    //   301: ldc_w 509
    //   304: invokevirtual 27	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   307: aload 8
    //   309: invokevirtual 510	baom:toString	()Ljava/lang/String;
    //   312: invokevirtual 27	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   315: invokevirtual 33	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   318: invokestatic 165	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   321: aload 8
    //   323: invokevirtual 512	baom:a	()Z
    //   326: ifeq +95 -> 421
    //   329: aload 6
    ...
    //   343: astore 7
    //   345: aload 8
    //   347: getfield 515	baom:d	I
    //   350: aload 6
    //   352: getfield 515	baom:d	I
    //   355: if_icmpgt +59 -> 414
    //   358: goto +63 -> 421
    //   361: aload 6
    //   363: putstatic 517	baol:jdField_a_of_type_Baom	Lbaom;
    //   366: iconst_1
    //   367: istore_3
    //   368: iload_3
    //   369: ireturn
    ...
    //   375: ldc 61
    //   377: iconst_1
    //   378: new 15	java/lang/StringBuilder
    //   381: dup
    //   382: invokespecial 18	java/lang/StringBuilder:<init>	()V
    //   385: ldc_w 519
    //   388: invokevirtual 27	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   391: aload 6
    //   393: invokevirtual 64	java/lang/Exception:toString	()Ljava/lang/String;
    //   396: invokevirtual 27	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   399: invokevirtual 33	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   402: invokestatic 70	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   405: iload_3
    //   406: ireturn
    //   407: astore 6
    //   409: iconst_1
