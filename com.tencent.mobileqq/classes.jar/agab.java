  ...
  extends bggc
{
  ...
  protected void onPokeAuth(boolean paramBoolean, Object paramObject)
  {
    ...
    if (4 == i)
    {
      ...
      acvv.a(this.a.b, BaseApplicationImpl.getContext(), this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, 126, j, paramObject, (String)localObject);
      if (true == agkg.a) {
        agkg.a = false;
      }
      label107:
    ...
    for (i = 0;; i = 1)
    {
      ...
      for (;;)
      {
        ...
        agkg.a(this.a.b, (Activity)this.a.jdField_a_of_type_AndroidContentContext, paramObject, (String)localObject, this.a.c, this.a.d);
        VasWebviewUtil.reportCommercialDrainage("", "poke", "vipTip", "", 0, 0, 0, "", String.valueOf(j), str1, "", "", "", "", 0, 0, 0, 0);
        break;
        if (l == 5002L)
        {
          this.a.d = 4;
          paramObject = amtj.a(2131704403);
          localObject = str2;
        }
        else
        {
          this.a.d = 1;
          str2 = amtj.a(2131704402);
