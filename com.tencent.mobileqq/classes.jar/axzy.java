...
public class axzy
{
  ...
  private static final String jdField_a_of_type_JavaLangString = axzy.class.getName() + "Q.nearby.video_chat.gift";
  public static long[] a;
  ...
  public axzy(AppInterface paramAppInterface, Context paramContext, SessionInfo paramSessionInfo, TroopGiftPanel paramTroopGiftPanel, ViewGroup paramViewGroup, boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  private void b()
  {
    ...
    aawm localaawm = aawm.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Int);
    if (localaawm != null)
    {
      this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel.setGiftData(localaawm, true);
      return;
    }
  ...
  public void a(int paramInt1, boolean paramBoolean, int paramInt2)
  {
    ...
    bgot localbgot = (bgot)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(223);
    bgsu localbgsu = (bgsu)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(113);
    String str = this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString;
    if (paramBoolean) {}
    for (int i = 4;; i = 3)
    {
      localbgsu.a("OidbSvc.0x7f8", 2040, paramInt2, str, 2, i, 0, new axzz(this, localbgsu, l, localbgot, paramInt1));
      return;
    }
  }
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, int paramInt)
  {
    if (this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel != null)
    {
      ...
      if (paramBoolean1)
      {
        ...
        localObject = aawm.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Int);
        if (localObject == null) {
          break label172;
        }
        this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel.setGiftData((aawm)localObject, true);
    ...
    {
      if (paramInt == 0) {
        SosoInterface.a(new ayab(3, true, true, 60000L, true, false, "NearbyTroopsView"));
      }
      return;
      label172:
      this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel.d();
