...
{
  public koe(NowVideoView paramNowVideoView) {}
  ...
  public void onStateChange(String paramString, QQLiveDrawable.QQLiveDrawableParams paramQQLiveDrawableParams, int paramInt, Object paramObject)
  {
    ...
    if (paramInt == 3)
    {
      ...
      if (paramString != null)
      {
        ...
        paramString.setImageResource(2130840918);
        paramString.clearAnimation();
        this.a.jdField_a_of_type_AndroidOsHandler.post(new kof(this, paramString));
      }
    }
    for (;;)
    {
      ...
      if (paramInt == 0)
      {
        ...
        {
          paramString.clearAnimation();
          paramString.setImageResource(2130840920);
          paramString.setVisibility(0);
        }
      }
      else if (paramInt == 4)
      ...
      else if (paramInt == 5)
      {
        if (paramString != null)
        {
          paramString.clearAnimation();
          paramString.setVisibility(0);
          paramString.setImageResource(2130840916);
        }
        if (!NetworkUtil.g(this.a.getContext()))
        {
          QQToast.a(this.a.getContext(), 1, 2131434843, 0).b(NowVideoView.g);
          return;
        }
