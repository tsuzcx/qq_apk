...
{
  private akpe jdField_a_of_type_Akpe;
  ...
  public akpf(NewStyleCountryActivity paramNewStyleCountryActivity, Context paramContext)
  {
    super(paramContext);
    ...
    this.jdField_a_of_type_Akpe = new akpe(paramNewStyleCountryActivity, null);
    this.jdField_a_of_type_ComTencentWidgetListView.setAdapter(this.jdField_a_of_type_Akpe);
  ...
  void a(String paramString)
  {
    ...
    this.jdField_a_of_type_Akpe.a(paramString);
    if (this.jdField_a_of_type_Akpe.getCount() == 0) {
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    }
    for (;;)
    {
      this.jdField_a_of_type_Akpe.notifyDataSetChanged();
      return;
  ...
  public void dismiss()
  {
    ...
    //   4: aload_0
    //   5: invokestatic 208	adkm:a	(Landroid/app/Dialog;)V
    //   8: return
    //   9: astore_1
    //   10: aload_0
    //   11: invokestatic 208	adkm:a	(Landroid/app/Dialog;)V
    //   14: return
    //   15: astore_1
    //   16: aload_0
    //   17: invokestatic 208	adkm:a	(Landroid/app/Dialog;)V
    //   20: aload_1
    //   21: athrow
