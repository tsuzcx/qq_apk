  ...
  implements akpp
{
  ...
  private void a(DataLineMsgRecord paramDataLineMsgRecord, aukp paramaukp)
  {
    a().b(paramDataLineMsgRecord);
    paramaukp = a().a(paramDataLineMsgRecord.groupId);
    ...
    label290:
    while ((paramaukp != null) && (paramaukp.getComeCount() != 1)) {
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(localMessage.frienduin, localMessage.istroop, 1);
  }
  ...
  public int a(DataLineMsgSet paramDataLineMsgSet)
  {
    ...
    if (Thread.currentThread() == ((Looper)localObject).getThread())
    {
      ...
      if (i > 0)
      {
        paramDataLineMsgSet = akpx.a(String.valueOf(this.jdField_a_of_type_JavaLangString), this.jdField_a_of_type_Int);
        ...
        if (l > 0L)
        {
          ...
          if (paramDataLineMsgSet != null)
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqAppMessageQQMessageFacade.a.put(akpx.a(String.valueOf(this.jdField_a_of_type_JavaLangString), this.jdField_a_of_type_Int), localObject);
          }
        }
      ...
      if (Thread.currentThread() == ((Looper)localObject2).getThread())
      {
        ...
        try
        {
          if (paramDataLineMsgRecord.time == 0L) {
            paramDataLineMsgRecord.time = awzy.a();
          }
          ...
          RecentUser localRecentUser = ((aktf)localObject2).a(String.valueOf(this.jdField_a_of_type_JavaLangString), this.jdField_a_of_type_Int);
          localRecentUser.setType(this.jdField_a_of_type_Int);
          localRecentUser.lastmsgtime = paramDataLineMsgRecord.time;
          ((aktf)localObject2).a(localRecentUser);
          a(paramDataLineMsgRecord, (aukp)localObject1);
  ...
  public void b()
  {
    ...
    try
    {
      ...
      RecentUser localRecentUser = localaktf.a(String.valueOf(this.jdField_a_of_type_JavaLangString), this.jdField_a_of_type_Int);
      localRecentUser.setType(this.jdField_a_of_type_Int);
      localRecentUser.lastmsgtime = awzy.a();
  ...
  public void e()
  {
    if (!LiteActivity.class.getName().equals(ajud.a(BaseApplication.getContext()))) {}
    do
    {
      return;
      if (QLog.isColorLevel()) {
