  ...
  extends acka
{
  ...
  private ackh jdField_a_of_type_Ackh = new ackh(this, null);
  public Calendar a;
  Context b;
  public Calendar b;
  
  public acke(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner, BaseChatPie paramBaseChatPie, ackg paramackg)
  {
    super(paramQQAppInterface, paramContext, paramSessionInfo, paramAIOAnimationConatiner, paramBaseChatPie);
    this.jdField_a_of_type_Int = -1;
    this.jdField_b_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Ackg = paramackg;
  }
  ...
  public int a(List<ChatMessage> paramList, int paramInt1, Calendar paramCalendar1, Calendar paramCalendar2, int paramInt2, MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      ...
      if (i < this.jdField_a_of_type_JavaUtilList.size())
      {
        ...
        boolean bool2 = awbk.b(paramCalendar1.msgtype);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    paramView = localackk.a(paramInt, this.jdField_a_of_type_JavaUtilList.size(), localChatMessage, paramView, paramViewGroup, this.jdField_a_of_type_Ackh);
    if (paramView != null) {
    ...
    for (;;)
    {
      ...
      {
        if ((localackk instanceof ApolloItemBuilder))
        {
        ...
        else if ((localackk instanceof aczr))
        {
          ((aczr)localackk).a(false);
        }
      }
