  ...
  implements Manager
{
  ...
  public uhj(QQAppInterface paramQQAppInterface)
  {
  ...
  @NonNull
  public static uhj a(QQAppInterface paramQQAppInterface)
  {
    return (uhj)paramQQAppInterface.getManager(253);
  }
  ...
  public void a(ConfigurationService.Config paramConfig)
  {
    ...
    int j = bdiv.aD(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    String str;
    if (i != j)
    {
    ...
    {
      return;
      bdiv.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramConfig.version.get(), str);
      try
      {
        b(str);
        return;
  ...
  public void a(@NonNull MessageForQQStoryFeed paramMessageForQQStoryFeed)
  {
    ...
    wta.a("aio_msg", "aio_push", 0, 0, new String[] { paramMessageForQQStoryFeed.frienduin });
    aely localaely = (aely)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(282);
    Object localObject = localaely.a(paramMessageForQQStoryFeed.frienduin, 0, 5);
    int i;
    if (localObject != null)
    {
    ...
    for (;;)
    {
      ...
      bdiv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), paramMessageForQQStoryFeed.frienduin, i);
      return;
