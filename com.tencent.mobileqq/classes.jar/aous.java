...
public class aous
  extends aouc
{
  public aous(QQAppInterface paramQQAppInterface, Context paramContext)
  {
  ...
  public boolean e()
  {
    ...
    catch (UnsupportedEncodingException localUnsupportedEncodingException1)
    {
      try
      {
        ...
        ((avwp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.ODPROXY_MGR)).a(this.jdField_a_of_type_AndroidContentContext, l1, "launcher", (String)localObject1, (String)localObject3, i);
        return true;
