...
public abstract class mkk
{
  ...
  public mkk(VideoInviteActivity paramVideoInviteActivity)
  {
    ...
    this.jdField_b_of_type_Int = mue.a(this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity);
    this.jdField_b_of_type_Int = mue.b(this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity);
  }
  ...
  {
    bcst.b(null, "CliOper", "", "", paramString, paramString, 0, 0, Integer.toString(this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.d), Integer.toString(this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.h), Integer.toString(this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.i), "");
  }
  ...
  public void a(mkk parammkk)
  {
    if (parammkk != null)
    {
      this.jdField_b_of_type_Long = parammkk.jdField_b_of_type_Long;
      this.c = parammkk.c;
    }
  }
