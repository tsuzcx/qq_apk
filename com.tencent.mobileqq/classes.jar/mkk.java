  ...
  implements AbsListView.OnScrollListener
{
  ...
  public mkk(ReadInJoyBaseAdapter paramReadInJoyBaseAdapter) {}
  ...
  public void a(AbsListView paramAbsListView, int paramInt)
  {
      ...
      default: 
        ...
        if (this.jdField_a_of_type_Boolean)
        {
          ...
          if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyBaseAdapter.getCount() - this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyBaseAdapter.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyXListView.getLastVisiblePosition() < ReadInJoyBaseAdapter.c()) {
            ReadInJoyBaseAdapter.c(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyBaseAdapter);
          }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyBaseAdapter.jdField_a_of_type_ComTencentBizPubaccountUtilFeedExposureHelper.a(paramAbsListView, paramInt);
        return;
        ...
        ReadInJoyBaseAdapter.d(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyBaseAdapter);
      }
