  ...
  extends BaseBubbleBuilder
{
  ...
  public afdo(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo, paramAIOAnimationConatiner);
    this.jdField_b_of_type_Float = paramContext.getResources().getDisplayMetrics().density;
  }
  
  private void a(afdp paramafdp)
  {
    if (paramafdp.jdField_a_of_type_ComTencentMobileqqDataMessageForPic.isMixed)
    {
      Object localObject = paramafdp.jdField_a_of_type_ComTencentMobileqqDataMessageForPic;
      if (((MessageForPic)localObject).msgtype == -1032)
      {
        paramafdp.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
        return;
      }
      String str2 = this.jdField_a_of_type_AndroidContentContext.getString(2131721196);
      String str1;
      if (((MessageForPic)localObject).shareAppID != 0L)
      {
        localObject = bdaw.a(((MessageForPic)localObject).shareAppID);
      ...
      for (;;)
      {
        paramafdp.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
        paramafdp.jdField_a_of_type_AndroidWidgetTextView.setText(str1);
        return;
        str1 = str2;
        if (!this.jdField_b_of_type_JavaUtilHashSet.contains(localObject))
        {
          ayuf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), (String)localObject);
          this.jdField_b_of_type_JavaUtilHashSet.add(localObject);
          str1 = str2;
          continue;
          str1 = str2;
          if (((MessageForPic)localObject).msgtype == -3001) {
            str1 = this.jdField_a_of_type_AndroidContentContext.getString(2131692296);
          }
        }
      }
    }
  ...
  {
    paramBaseChatItemLayout = (afdp)paramaelt;
    paramaelt = paramView;
    if (paramView == null)
    {
    ...
    {
      paramView = baul.a(paramChatMessage, 1);
      ...
      {
        paramChatMessage = afsf.a(this.jdField_a_of_type_AndroidContentContext, paramChatMessage, paramBaseChatItemLayout.jdField_a_of_type_ComTencentMobileqqActivityAioItemChatThumbView);
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          localObject = (afdp)aekt.a(paramView);
          paramView = (MessageForPic)((afdp)localObject).jdField_a_of_type_ComTencentMobileqqDataChatMessage;
          localObject = ((afdp)localObject).jdField_a_of_type_ComTencentImageURLDrawable;
