  ...
  implements View.OnClickListener, bgbo
{
  ...
  public bgbp(PublishHomeWorkFragment paramPublishHomeWorkFragment, String paramString)
  {
  ...
  public void a()
  {
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkEntryUiPublishHomeWorkFragment.a(2131373202);
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkEntryUiPublishHomeWorkFragment.a(2131379412));
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setOnClickListener(this);
      if (!this.jdField_a_of_type_JavaLangBoolean.booleanValue()) {
        this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
      }
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkEntryUiPublishHomeWorkFragment.a(2131379418));
      this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkEntryUiPublishHomeWorkFragment.a(2131379539);
  ...
  public void a(int paramInt)
  {
    ...
    {
      bhju.a("Grp_edu", "homework", "createHW_lele", 0, 0, new String[] { str, localBundle.getString("reportIdentity", ""), localBundle.getString("reportCourse", "") });
      return;
    }
  }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    catch (JSONException paramIntent)
    {
      ...
      localObject = anzj.a(2131696751) + " (" + this.jdField_a_of_type_Int + anzj.a(2131696752) + ")\n" + anzj.a(2131696753) + "\n" + this.jdField_b_of_type_JavaLangString;
  ...
  protected void a(View paramView)
  {
    ...
    StringBuilder localStringBuilder = new StringBuilder(((bfzm)aran.a().a(605)).a());
