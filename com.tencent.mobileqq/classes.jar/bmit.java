...
public class bmit
  extends bmiv
  implements bmet, IEventReceiver
{
  ...
  public bmit(@NonNull bmix parambmix)
  {
    super(parambmix);
  }
  ...
  private void b(long paramLong, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (this.jdField_a_of_type_AndroidOsHandler != null)
    {
      ...
      if (localObject != null)
      {
        ...
        ((bmjh)localObject).b(paramLong, paramBoolean1);
      }
    }
    for (;;)
    {
      ...
      if (localObject != null) {
        ((bmeu)localObject).a(paramLong);
      }
      return;
      label340:
      ((bmjh)localObject).a(paramLong, paramBoolean1);
    }
  }
  ...
  public void a()
  {
    ...
    {
      long l = ((EditLocalVideoSource)this.jdField_a_of_type_Bmix.a.a).a * -1;
  ...
  public void b()
  {
    Object localObject = (bmjh)a(bmjh.class);
    if (localObject != null) {
      ((bmjh)localObject).k();
    }
    localObject = (bmeu)a(bmeu.class);
    if (localObject != null) {
      ((bmeu)localObject).aj_();
    }
  }
  ...
  public boolean i_()
  {
    ...
    bmjh localbmjh = (bmjh)a(bmjh.class);
    if (localbmjh != null) {
      this.jdField_b_of_type_Boolean = localbmjh.a(this.c);
    }
