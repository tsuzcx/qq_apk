  ...
  implements Manager
{
  ...
  protected HashMap<Long, aurn> a;
  protected HashSet<String> a;
  protected boolean a;
  protected boolean b = true;
  
  public auri(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Aurp = new aurp();
  ...
  {
    azmj.b(paramQQAppInterface, "dc00899", "grp_lbs", paramString2, "pay_like", paramString1, 0, 0, paramString3, paramString4, paramString5, paramString6);
  ...
  {
    if ((this.jdField_a_of_type_Aurp == null) || (this.jdField_a_of_type_Aurp.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg == null)) {
      return null;
    }
    return a(this.jdField_a_of_type_Aurp.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg.rpt_msg_first_info.get());
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3)
  {
    try
    {
      ...
      {
        this.jdField_a_of_type_Aurp.jdField_a_of_type_Int = paramInt1;
        this.jdField_a_of_type_Aurp.c = paramInt2;
        this.jdField_a_of_type_Aurp.d = paramInt3;
        if (QLog.isColorLevel()) {
  ...
  public void a(long paramLong, int paramInt1, int paramInt2)
  {
    for (;;)
    {
      try
      {
        ...
        aurn localaurn = (aurn)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramLong));
        if (localaurn == null)
        {
          if ((paramInt1 > 0) || (paramInt2 > 0))
          {
            localaurn = new aurn();
            localaurn.jdField_a_of_type_Long = paramLong;
            localaurn.jdField_a_of_type_Int += paramInt1;
            localaurn.b += paramInt2;
            localaurn.c += this.jdField_a_of_type_Aurp.b * paramInt2;
            this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(paramLong), localaurn);
            localObject2 = this.jdField_a_of_type_Aurp;
            ((aurp)localObject2).f += 1;
            localObject2 = this.jdField_a_of_type_Aurp;
            ((aurp)localObject2).e -= this.jdField_a_of_type_Aurp.b * paramInt2;
          }
          if (QLog.isColorLevel())
          {
      ...
      localObject1.c += this.jdField_a_of_type_Aurp.b * paramInt2;
      this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(paramLong), localObject1);
      Object localObject2 = this.jdField_a_of_type_Aurp;
      ((aurp)localObject2).e -= this.jdField_a_of_type_Aurp.b * paramInt2;
      continue;
      label377:
      boolean bool = false;
  ...
  public void a(Activity paramActivity, QQAppInterface paramQQAppInterface, String paramString1, aurq paramaurq, String paramString2)
  {
    for (;;)
    {
      try
      {
        if (QLog.isColorLevel()) {
          QLog.d("NearbyLikeLimitManager", 2, "checkCanDoVote, uin=" + paramString1 + ", from=" + paramString2 + ", mLimitInfo=" + this.jdField_a_of_type_Aurp);
        }
        ...
        if ((bool1) && (c()))
        {
          ...
          if (i != 0)
          {
            paramActivity = bdcd.a(paramActivity, 0, null, localSpannableString, alpo.a(2131707585), alpo.a(2131707581), alpo.a(2131707580), new aurj(this, bool1, paramString1, paramaurq, paramQQAppInterface, paramString2, paramActivity), new aurk(this, paramActivity, paramQQAppInterface, paramString2));
        ...
        if (a())
        {
          ...
          paramaurq.a(paramString1, false);
  ...
  {
    bdcd.a(paramActivity, 230).setTitle(alpo.a(2131707586)).setMessage(alpo.a(2131707582)).setNegativeButton(alpo.a(2131707584), new aurm(this)).setPositiveButton(alpo.a(2131707583), new aurl(this, paramActivity)).show();
  }
  
  public void a(aurp paramaurp, List<aurn> paramList, int paramInt)
  {
    try
    {
      this.jdField_a_of_type_Aurp = paramaurp;
      if (paramInt == 511) {
        this.jdField_a_of_type_JavaUtilHashMap.clear();
      }
      paramaurp = new StringBuilder();
      if ((paramList != null) && (paramList.size() > 0))
      {
        paramList = paramList.iterator();
        while (paramList.hasNext())
        {
          aurn localaurn = (aurn)paramList.next();
          this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(localaurn.jdField_a_of_type_Long), localaurn);
          if (QLog.isColorLevel()) {
            paramaurp.append(localaurn).append(" | ");
          }
        }
      }
      if (!QLog.isColorLevel()) {
    ...
    QLog.d("NearbyLikeLimitManager", 2, "updateFromServer, mLimitInfo=" + this.jdField_a_of_type_Aurp + ", mLikeItemMap=[" + paramaurp + "]");
    label165:
  }
  ...
  public boolean a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Aurp.e >= this.jdField_a_of_type_Aurp.b)
        {
          bool1 = bool2;
          bool2 = bool1;
          if (QLog.isColorLevel())
  ...
  public boolean a(long paramLong)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Aurp.f < this.jdField_a_of_type_Aurp.c) {
          break label165;
        }
        bool1 = true;
      }
      ...
      if (QLog.isColorLevel())
      {
        ...
        bool1 = false;
        break label219;
        if ((this.jdField_a_of_type_Aurp.f >= this.jdField_a_of_type_Aurp.c) && (localObject.b > 0))
        {
  ...
  public boolean a(String paramString)
  {
    ...
    //   56: ireturn
    //   57: aload_0
    //   58: getfield 35	auri:jdField_a_of_type_JavaUtilHashSet	Ljava/util/HashSet;
    //   61: aload_1
  ...
  public SpannableString b()
  {
    ...
    return a(this.jdField_a_of_type_Aurp.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg.rpt_msg_user_num_limit_info.get());
  }
  ...
  public boolean b(long paramLong)
  {
    ...
    for (;;)
    {
      try
      {
        aurn localaurn = (aurn)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramLong));
        boolean bool1;
        if ((this.jdField_a_of_type_Aurp == null) || (localaurn == null))
        {
          if (QLog.isColorLevel())
          {
        ...
        if (localaurn.jdField_a_of_type_Int >= this.jdField_a_of_type_Aurp.d)
        {
          bool1 = true;
          bool2 = bool1;
          if (QLog.isColorLevel())
  ...
  public SpannableString c()
  {
    ...
    return a(this.jdField_a_of_type_Aurp.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg.rpt_msg_zan_limit_info.get());
  }
  ...
  public boolean c()
  {
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Aurp != null) && (this.jdField_a_of_type_Aurp.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg != null)) {}
    for (boolean bool = true;; bool = false)
    {
      if (QLog.isColorLevel()) {
  ...
  public boolean c(long paramLong)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 30	auri:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   6: lload_1
    ...
    //   13: checkcast 335	aurn
    //   16: astore 5
    //   18: aload_0
    //   19: getfield 25	auri:jdField_a_of_type_Aurp	Laurp;
    //   22: astore 6
    //   24: aload 6
    //   26: ifnull +8 -> 34
    //   29: aload 5
    ...
    //   16	27	5	localaurn	aurn
    //   64	5	5	localObject	Object
    //   22	3	6	localaurp	aurp
    // Exception table:
    //   from	to	target	type
    //   2	24	64	finally
    //   42	48	64	finally
  ...
  public boolean d()
  {
    if ((this.b) && (this.jdField_a_of_type_Aurp != null) && (this.jdField_a_of_type_Aurp.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg != null)) {}
    for (boolean bool = true;; bool = false)
    {
      if (QLog.isColorLevel()) {
  ...
  public void onDestroy()
  {
    try
    {
      this.jdField_a_of_type_Aurp = null;
      this.jdField_a_of_type_JavaUtilHashMap.clear();
      if (QLog.isColorLevel()) {
