...
{
  private auri(PortalManager paramPortalManager) {}
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    case 1011: 
      ...
      localObject = aurl.b(paramIntent);
      localObject = bbcl.l(PortalManager.a(this.a), (String)localObject);
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(paramContext))
      {
        paramIntent = aurl.b(paramContext);
        localObject = PortalManager.a(this.a).a(paramIntent, false);
        if (localObject != null)
        {
          paramIntent = aurl.a((Bitmap)localObject);
        ...
        localObject = new aurh();
        ((aurh)localObject).jdField_a_of_type_JavaLangString = paramContext;
        ((aurh)localObject).b = k;
        ((aurh)localObject).jdField_a_of_type_Int = m;
        this.a.a.put(paramIntent, localObject);
        if ((PortalManager.a(this.a).a(paramIntent, true) != null) || (!QLog.isColorLevel())) {
          break;
        }
        paramIntent = bbcl.j(PortalManager.a(this.a), String.valueOf(paramIntent));
