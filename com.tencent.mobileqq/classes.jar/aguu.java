  ...
  implements agvy
{
  ...
  public aguu(QQAppInterface paramQQAppInterface, agwa paramagwa, Activity paramActivity, SessionInfo paramSessionInfo, aelz paramaelz)
  {
  ...
  {
    paramVarArgs = LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2131560806, null);
    ((TextView)paramVarArgs.findViewById(2131373397)).setText(2131691891);
    ((ImageView)paramVarArgs.findViewById(2131373395)).setImageResource(2130849218);
    paramVarArgs.findViewById(2131373394).setOnClickListener(new aguv(this));
    return paramVarArgs;
  }
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (aouu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, 1)) {
          return;
        }
        paramVarArgs = this.jdField_a_of_type_Aelz.a();
        ...
        if (j >= 0)
        {
          ...
          {
            i = paramInt;
            if (abot.p(((ChatMessage)localObject2).msgtype))
            {
              i = paramInt;
