...
public class azfh
{
  ...
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new azfi(this);
  private Bitmap jdField_a_of_type_AndroidGraphicsBitmap;
  private AdapterView.OnItemClickListener jdField_a_of_type_AndroidWidgetAdapterView$OnItemClickListener = new azfj(this);
  ...
  public azfh(Activity paramActivity, QQAppInterface paramQQAppInterface, int paramInt, azfk paramazfk)
  {
  ...
  private List<ShareActionSheetBuilder.ActionSheetItem>[] a()
  {
    ...
    localActionSheetItem.label = this.jdField_a_of_type_AndroidAppActivity.getString(2131695695);
    ...
    localActionSheetItem.label = this.jdField_a_of_type_AndroidAppActivity.getString(2131695715);
  ...
  private void e()
  {
    ...
    for (;;)
    {
      ...
      String str3 = anni.a(2131707207);
      String str4 = anni.a(2131707253) + this.jdField_a_of_type_JavaLangString;
      String str5 = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131717269);
      localObject1 = ((bcvp)localObject1).c(14).a(anni.a(2131707236) + this.b).a(2).a(1).a("plugin", "", str2, str1, str1).d(str5).a();
      Object localObject2 = new bczv();
      ((bcvt)localObject2).b(1);
      ((bcvt)localObject2).a(str3);
      bcyl localbcyl = new bcyl();
      localbcyl.b(1);
      localbcyl.a(new bcxv(str1));
      localbcyl.a(new StructMsgItemTitle(this.b));
      localbcyl.a(new bdaq(str4));
      ((AbsShareMsg)localObject1).addItem((bcvs)localObject2);
      ((AbsShareMsg)localObject1).addItem(localbcyl);
      ...
      while (QLog.isColorLevel())
      {
        ...
        ((Intent)localObject1).putExtras((Bundle)localObject2);
        aufz.a(this.jdField_a_of_type_AndroidAppActivity, (Intent)localObject1, 21);
      }
    }
  }
  ...
  protected void b()
  {
    if ((this.jdField_a_of_type_AndroidAppActivity != null) && (!this.jdField_a_of_type_AndroidAppActivity.isFinishing()))
    {
      ...
      this.jdField_a_of_type_Biau.a(anni.a(2131707237));
