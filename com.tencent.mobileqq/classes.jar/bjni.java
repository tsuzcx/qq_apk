  ...
  implements Handler.Callback
{
  ...
  private HashMap<String, bjnj> jdField_a_of_type_JavaUtilHashMap;
  private boolean jdField_a_of_type_Boolean;
  private boolean b;
  
  public bjni(QQAppInterface paramQQAppInterface)
  {
      ...
      try
      {
        ...
        if (i < j)
        {
          ...
          if (!TextUtils.isEmpty((CharSequence)localObject4))
          {
            ...
            localObject4 = new bjnj(this, localObject3[0], Integer.valueOf(localObject3[1]).intValue(), Integer.valueOf(localObject3[2]).intValue(), Long.valueOf(localObject3[3]).longValue(), Integer.valueOf(localObject3[4]).intValue());
            localHashMap2.put(localObject3[0], localObject4);
            if (QLog.isColorLevel()) {
              QLog.d("NCtr", 2, "LimitEntry:[" + ((bjnj)localObject4).toString() + "]");
            }
          }
  ...
  private void a(Context paramContext, String paramString)
  {
    ...
    {
      bjnj localbjnj = (bjnj)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
      paramContext = paramContext.getSharedPreferences("config_prefile", 0).edit();
      paramContext.putString("extra_limit_entry_" + this.mApp.getAccount() + "_" + paramString, localbjnj.toString());
      paramContext.apply();
    }
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        if (localObject != null)
        {
          ...
          {
            l = a().longValue();
            localObject = (bjnj)((HashMap)localObject).get(paramString);
            if (QLog.isColorLevel()) {
              QLog.d("NCtr", 2, "todayBeginTime = " + new Date(l) + "----" + l + " ，entry.mBaseLineTime = " + new Date(((bjnj)localObject).jdField_a_of_type_Long) + "----" + ((bjnj)localObject).jdField_a_of_type_Long);
            }
            if (((bjnj)localObject).jdField_a_of_type_Long >= 1L) {
              continue;
            }
            if (((bjnj)localObject).b <= 0) {
              continue;
            }
            ((bjnj)localObject).jdField_a_of_type_Long = l;
            ((bjnj)localObject).c += 1;
            paramInt = 1;
            bool2 = bool1;
            if (paramInt != 0)
            {
      ...
      if (!bool2) {
        bcef.b(this.app, "dc00898", "", paramString, "0X8009995", "0X8009995", 0, 0, "" + System.currentTimeMillis(), "", "", "");
      }
      bcef.b(this.app, "dc00898", "", paramString, "0X8009996", "0X8009996", 0, 0, "" + System.currentTimeMillis(), "", "", "");
      if (QLog.isColorLevel()) {
      ...
      bool1 = false;
      continue;
      if ((int)((l - ((bjnj)localObject).jdField_a_of_type_Long) / 86400000L) >= ((bjnj)localObject).jdField_a_of_type_Int)
      {
        ((bjnj)localObject).jdField_a_of_type_Long = l;
        ((bjnj)localObject).c = 0;
        paramInt = 1;
        if ((((bjnj)localObject).b > 0) && (((bjnj)localObject).c < ((bjnj)localObject).b))
        {
          ((bjnj)localObject).c += 1;
          paramInt = 1;
        }
  ...
  public void b(String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject3 = (bjnj)((HashMap)localObject1).get(paramString);
        ((HashMap)localObject1).remove(paramString);
        if ((j == ((bjnj)localObject3).jdField_a_of_type_Int) && (k == ((bjnj)localObject3).b))
        {
          localHashMap.put(paramString, localObject3);
          break label935;
        }
        localHashMap.put(paramString, new bjnj(this, paramString, j, k, 0L, 0));
        break label935;
      }
      localHashMap.put(paramString, new bjnj(this, paramString, j, k, 0L, 0));
      break label935;
    ...
    for (;;)
    {
      ...
      if (localHashMap.size() > 0)
      {
        ...
        {
          str = (String)((Iterator)localObject1).next();
          bjnj localbjnj = (bjnj)localHashMap.get(str);
          ((SharedPreferences.Editor)localObject2).putString("extra_limit_entry_" + (String)localObject3 + "_" + str, localbjnj.toString());
          paramString.append(str).append(",");
          if (QLog.isColorLevel()) {
            QLog.d("NCtr", 2, "LimitEntry:[" + localbjnj.toString() + "]");
          }
        }
