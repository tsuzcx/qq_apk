...
public class aqlk
{
  ...
  private final Map<Integer, aqkz> jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  private final Object jdField_b_of_type_JavaLangObject = new Object();
  private final Map<Integer, aqll> jdField_b_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  static
  {
    jdField_a_of_type_ArrayOfInt = new int[] { 390, 26, 76, 95, 455, 524, 409, 469, 412, 359, 413, 563, 648, 427, 428, 465, 477, 491, 542, 414, 419, 416, 445, 418, 424, 411, 423, 406, 417, 425, 426, 613, 632, 67, 430, 68, 526, 612, 463, 595, 380, 159, 170, 186, 250, 92, 368, 158, 361, 207, 585, 292, 168, 433, 432, 434, 456, 460, 435, 438, 441, 106, 132, 172, 176, 192, 216, 249, 263, 270, 276, 287, 367, 370, 382, 298, 431, 543, 591, 623, 439, 442, 488, 444, 362, 396, 637, 449, 626, 625, 85, 606, 645, 32, 35, 70, 81, 383, 346, 294, 334, 335, 338, 342, 344, 348, 377, 429, 437, 440, 525, 569, 164, 325, 252, 304, 305, 306, 307, 309, 310, 446, 447, 15, 458, 572, 453, 454, 452, 457, 547, 462, 451, 261, 467, 466, 490, 470, 478, 479, 473, 474, 485, 483, 484, 487, 489, 486, 492, 498, 493, 500, 251, 616, 587, 521, 495, 496, 502, 503, 504, 505, 506, 507, 508, 560, 509, 520, 516, 515, 519, 518, 517, 514, 512, 511, 513, 510, 600, 641, 493, 500, 251, 616, 587, 521, 482, 501, 497, 522, 529, 499, 528, 527, 541, 562, 628, 580, 534, 532, 535, 537, 538, 545, 546, 544, 590, 609, 659, 550, 530, 561, 575, 551, 607, 552, 553, 531, 549, 554, 555, 556, 557, 559, 564, 581, 566, 578, 567, 568, 576, 579, 583, 574, 573, 586, 577, 589, 592, 593, 598, 614, 597, 605, 617, 649, 608, 610, 615, 611, 619, 634, 638, 652, 624, 643, 630, 618, 651, 662, 621, 620, 622, 631, 633, 635, 255, 640, 642, 654, 647, 660, 657, 661, 655, 663 };
  }
  ...
  private int a(aqkz paramaqkz, int paramInt, long paramLong)
  {
    int i = a(paramLong).getInt(String.valueOf(paramInt), -1);
    paramInt = i;
    if (i == -1) {
      paramInt = paramaqkz.migrateOldVersion();
    }
    return paramInt;
  }
  ...
  private <T> T a(aqkz<T> paramaqkz, int paramInt)
  {
    Object localObject2 = paramaqkz.migrateOldOrDefaultContent(paramInt);
    Object localObject1 = localObject2;
    if (localObject2 == null) {
      localObject1 = a(paramaqkz.clazz());
    }
    return localObject1;
  }
  
  private Object a(aqkz paramaqkz, long paramLong, int paramInt)
  {
    Object localObject2 = a(paramaqkz.type());
    if (localObject2 != null)
    {
      int i = paramaqkz.type();
      int j = a(paramaqkz, i, paramLong);
      localObject1 = localObject2;
      if (paramaqkz.isNeedStoreLargeFile())
      {
    ...
    for (Object localObject1 = localObject2;; localObject1 = paramaqkz.migrateOldOrDefaultContent(0))
    {
      if (QLog.isColorLevel()) {
        QLog.d("QConfigManager", 2, "loadNewConfigFailBackport, version=" + paramInt + ", type" + paramaqkz.type() + ", conf=" + localObject1);
      }
      return localObject1;
    }
  }
  
  private Object a(aqkz paramaqkz, aqlg[] paramArrayOfaqlg, int paramInt)
  {
    try
    {
      Object localObject = paramaqkz.onParsed(paramArrayOfaqlg);
      return localObject;
    }
    catch (Exception localException)
    {
      aqln.a().a(paramaqkz, paramArrayOfaqlg, paramInt, localException);
    }
    return null;
  }
  ...
  private void a(aqkz paramaqkz, ConfigurationService.Config paramConfig, long paramLong, String paramString, int paramInt1, int paramInt2)
  {
    int i = paramConfig.msg_content_list.size();
    if (i == 0) {
      paramConfig = paramaqkz.migrateOldOrDefaultContent(1);
    }
    label312:
    for (;;)
    {
      ...
      {
        a(paramaqkz, paramConfig, paramInt2, paramLong, bool);
        return;
        ...
        if (paramInt1 < i)
        {
          ...
          if ((localContent != null) && (localContent.content.has()))
          {
            ...
            localObject1 = ayma.a(localContent.content.get().toByteArray());
            if (localObject1 == null) {
              break label193;
            }
          }
          for (;;)
          {
            try
            {
              ...
              if (!TextUtils.isEmpty((CharSequence)localObject1)) {
                localArrayList.add(new aqlg(localContent.task_id.get(), (String)localObject1));
              }
              paramInt1 += 1;
            }
        ...
        Object localObject2 = new aqlg[localArrayList.size()];
        localArrayList.toArray((Object[])localObject2);
        paramConfig = a(paramaqkz, (aqlg[])localObject2, paramInt2);
        if (paramConfig != null)
        {
          a(paramaqkz, (aqlg[])localObject2, paramLong, paramString);
          if (!QLog.isColorLevel()) {
            break label312;
          }
        ...
        paramConfig = a(paramaqkz, paramLong, paramInt2);
        break;
      }
    }
  }
  
  private void a(aqkz paramaqkz, Object paramObject, int paramInt, long paramLong, boolean paramBoolean)
  {
    if (paramObject != null)
    {
      a(paramLong).edit().putInt(String.valueOf(paramaqkz.type()), paramInt).putBoolean(paramaqkz.type() + "_" + paramInt + "_defualt", paramBoolean).apply();
      this.jdField_b_of_type_JavaUtilMap.put(Integer.valueOf(paramaqkz.type()), new aqll(paramLong, paramInt, paramObject));
      paramaqkz.onUpdate(paramObject);
    }
  }
  
  private void a(aqkz paramaqkz, aqlg[] paramArrayOfaqlg, long paramLong, String paramString)
  {
    int j = 0;
    int i = 0;
    if (paramaqkz.isNeedStoreLargeFile())
    {
      ...
      {
        paramaqkz = a(paramString, String.valueOf(paramArrayOfaqlg[i].jdField_a_of_type_Int));
        if (paramaqkz != null) {
          a(paramArrayOfaqlg[i].jdField_a_of_type_JavaLangString, paramaqkz);
        }
        i += 1;
      }
    }
    ...
    while (i < paramArrayOfaqlg.length)
    {
      localHashSet.add(String.valueOf(paramArrayOfaqlg[i].jdField_a_of_type_Int));
      paramString.putString(paramaqkz.type() + "_" + paramArrayOfaqlg[i].jdField_a_of_type_Int, paramArrayOfaqlg[i].jdField_a_of_type_JavaLangString);
      i += 1;
    }
    a(paramLong).edit().putStringSet(paramaqkz.type() + "_ids", localHashSet).apply();
    paramString.apply();
  }
  ...
  private aqlg[] a(int paramInt, long paramLong)
  {
    ...
    Object localObject = new aqlg[arrayOfFile.length];
    paramInt = 0;
    while (paramInt < arrayOfFile.length)
    {
      File localFile = arrayOfFile[paramInt];
      localObject[paramInt] = new aqlg(a(localFile), a(localFile));
      paramInt += 1;
    }
    return localObject;
  }
  ...
  private void b(aqkz paramaqkz, ConfigurationService.Config paramConfig, long paramLong, String paramString, int paramInt1, int paramInt2)
  {
    if (paramConfig.content_list.isEmpty()) {
      paramString = paramaqkz.migrateOldOrDefaultContent(1);
    }
    for (;;)
    {
      a(paramaqkz, paramString, paramInt2, paramLong, paramConfig.content_list.isEmpty());
      return;
      int i = paramConfig.content_list.size();
      aqlg[] arrayOfaqlg = new aqlg[i];
      paramInt1 = 0;
      while (paramInt1 < i)
      {
        arrayOfaqlg[paramInt1] = new aqlg(paramInt1, (String)paramConfig.content_list.get(paramInt1));
        paramInt1 += 1;
      }
      Object localObject = a(paramaqkz, arrayOfaqlg, paramInt2);
      if (localObject != null)
      {
        a(paramaqkz, arrayOfaqlg, paramLong, paramString);
        if (QLog.isColorLevel())
        {
      ...
      {
        paramString = a(paramaqkz, paramLong, paramInt2);
        continue;
      }
      paramString = localObject;
    }
  ...
  private aqlg[] b(int paramInt, long paramLong)
  {
    if (a(paramInt) == null)
    {
      if (QLog.isColorLevel()) {
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      localObject1[i] = new aqlg(Integer.valueOf(str).intValue(), localSharedPreferences.getString(paramInt + "_" + str, null));
      i += 1;
    }
    return localObject1;
  }
  ...
  private aqkz c(int paramInt)
  {
    aqkz localaqkz = a(paramInt);
    if (localaqkz == null) {}
    return localaqkz;
  }
  ...
  public int a(int paramInt, long paramLong)
  {
    ...
    return a(localaqkz, paramInt, paramLong);
  }
  ...
  public int a(int paramInt, String paramString)
  {
    ...
    return a(localaqkz, paramInt, a(paramString, localaqkz.isAccountRelated()));
  }
  
  public aqkz a(int paramInt)
  {
    Object localObject1 = (aqkz)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
    if (localObject1 == null) {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        aqkz localaqkz2 = (aqkz)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
        localObject1 = localaqkz2;
        if (localaqkz2 == null)
        {
          localaqkz2 = b(paramInt);
          localObject1 = localaqkz2;
          if (localaqkz2 != null)
          {
            this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(paramInt), localaqkz2);
            localObject1 = localaqkz2;
          }
        }
        return localObject1;
  ...
  {
    aqkz localaqkz = c(paramInt);
    if (localaqkz == null) {
      return null;
    }
    Object localObject1;
    if (localaqkz.isAccountRelated())
    {
      localObject1 = MobileQQ.sMobileQQ.getFirstSimpleAccount();
      if (localObject1 == null) {}
    }
    int i;
    for (long l = a(((SimpleAccount)localObject1).getUin(), localaqkz.isAccountRelated());; l = 0L)
    {
      localObject1 = a(l);
      ...
      return a(localaqkz, 0);
      if (QLog.isColorLevel()) {
        QLog.d("QConfigManager", 2, "Can not get an runtime.May be in a process of none appRuntime.");
      }
      return a(localaqkz, 1);
    }
    ??? = (aqll)this.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
    if ((??? != null) && (((aqll)???).jdField_a_of_type_Int == i) && (((aqll)???).jdField_a_of_type_Long == l) && (((aqll)???).jdField_a_of_type_JavaLangObject != null)) {
      return ((aqll)???).jdField_a_of_type_JavaLangObject;
    }
    if (((SharedPreferences)localObject1).getBoolean(localaqkz.type() + "_" + i + "_defualt", false)) {
      return a(localaqkz, 0);
    }
    Object localObject3;
    for (;;)
    {
      ...
      {
        if (localaqkz.isNeedStoreLargeFile())
        {
          localObject1 = a(paramInt, l);
          if (localObject1 != null) {
            break;
          }
          localObject1 = a(localaqkz.clazz());
          return localObject1;
        }
      }
    ...
    try
    {
      Object localObject5 = localaqkz.onParsed((aqlg[])localObject3);
      this.jdField_b_of_type_JavaUtilMap.put(Integer.valueOf(paramInt), new aqll(l, i, localObject5));
      return localObject5;
    }
    catch (Exception localException)
    {
      aqln.a().a(localaqkz, (aqlg[])localObject3, i, localException);
      localObject3 = a(localaqkz.clazz());
    }
    return localObject3;
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    {
      l1 = l2;
      if (((aqkz)localObject).isAccountRelated())
      {
        AppRuntime localAppRuntime = MobileQQ.sMobileQQ.waitAppRuntime(null);
        l1 = l2;
        if (localAppRuntime != null) {
          l1 = a(localAppRuntime.getAccount(), ((aqkz)localObject).isAccountRelated());
        }
      }
    }
    localObject = a(l1);
  ...
  public void a(int paramInt1, int paramInt2, ConfigurationService.Config paramConfig, String arg4)
  {
    ...
    if (localaqkz.isNeedCompressed()) {
      a(localaqkz, paramConfig, l, str, i, paramInt2);
    }
    for (;;)
    {
      aqlh.a().a(paramInt1, l, localaqkz.isNeedStoreLargeFile());
      return;
      b(localaqkz, paramConfig, l, str, i, paramInt2);
    }
  }
  ...
  public void a(int[] paramArrayOfInt)
  {
    ...
    arcj.jdField_a_of_type_JavaLangString = str;
    NewIntent localNewIntent = new NewIntent(BaseApplicationImpl.getApplication(), arcj.class);
  ...
  public boolean a(int paramInt)
  {
    ...
    return localaqkz.isNeedCompressed();
  }
  ...
  public boolean a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    do
    {
      ...
      {
        return false;
      } while (!localaqkz.isNeedUpgradeReset());
  ...
  public int b(int paramInt, long paramLong)
  {
    ...
    aqkz localaqkz = a(paramInt);
    if ((localaqkz != null) && (localaqkz.isNeedUpgradeReset()) && (i == 0)) {
