...
{
  public aiel(SelectMemberActivity paramSelectMemberActivity) {}
  
  public void onClick(View paramView)
  {
    if (this.a.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("show_invite_entry", false))
    {
      lyi.a(this.a.app, this.a, paramView, this.a.jdField_a_of_type_AndroidContentIntent);
      return;
    }
    Object localObject1;
    Object localObject2;
    if (this.a.d == 11)
    {
      if (this.a.jdField_a_of_type_ComTencentCommonAppInnerFrameManager.a() == 0) {
        axqy.b(this.a.app, "CliOper", "", "", "0X8005527", "0X8005527", 0, 0, "", "", "", "");
      }
    }
    else if (this.a.b == 3)
    {
      localObject1 = this.a.getIntent().getStringExtra("group_uin");
      localObject2 = mua.a(this.a.app, this.a.app.getCurrentAccountUin(), (String)localObject1) + "";
    ...
    {
      axqy.b(null, "dc00899", "Grp_video", "", "invite", "Clk_call", 0, 0, (String)localObject1, (String)localObject2, paramView, "");
      if (this.a.d != 33) {
        break label290;
      }
      agya.a(this.a, this.a.jdField_e_of_type_JavaUtilArrayList);
      return;
      if (this.a.jdField_a_of_type_ComTencentCommonAppInnerFrameManager.a() != 1) {
        break;
      }
      axqy.b(this.a.app, "CliOper", "", "", "0X8005526", "0X8005526", 0, 0, "", "", "", "");
      break;
    }
    label290:
    if ((this.a.d == 32) && (this.a.jdField_e_of_type_JavaUtilArrayList.size() > this.a.g))
    {
      paramView = MessageFormat.format(this.a.getString(2131719231), new Object[] { Integer.valueOf(this.a.g) });
      bcql.a(this.a, paramView, 0).b(this.a.jdField_c_of_type_AndroidViewView.getHeight());
      return;
    }
    if (!bbfj.d(this.a))
    {
      bcql.a(this.a, this.a.getString(2131692321), 0).b(this.a.jdField_c_of_type_AndroidViewView.getHeight());
      return;
    }
    if ((this.a.v) && (this.a.jdField_e_of_type_JavaUtilArrayList.size() == 1) && (this.a.jdField_e_of_type_JavaUtilArrayList.get(0) != null))
    {
      ...
      {
        bcql.a(this.a, this.a.getString(2131719229), 0).b(this.a.jdField_c_of_type_AndroidViewView.getHeight());
        return;
      }
    }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      {
        bbdj.a(this.a, 230, this.a.getString(2131695995), this.a.getString(2131720400), 2131695732, 2131691035, new aiem(this), new aien(this)).show();
        axqy.b(null, "CliOper", "", "", "0X8004CED", "0X8004CED", 0, 0, "", "", "", "");
        return;
      }
      int i;
      ...
      for (paramView = this.a.a(((ResultRecord)localObject1).jdField_c_of_type_JavaLangString);; paramView = null)
      {
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            Object localObject3 = ((ajxl)this.a.app.getManager(51)).e(((ResultRecord)localObject1).jdField_a_of_type_JavaLangString);
            int j = i;
            ...
            this.a.finish();
            axqy.b(this.a.app, "CliOper", "", "", "0X8006664", "0X8006664", 0, 0, "", "", "", "");
            if (this.a.b == 1)
            {
              paramView = this.a.jdField_e_of_type_JavaUtilArrayList.iterator();
              i = 0;
            ...
            for (;;)
            {
              ...
              if (this.a.d == 24)
              {
                ...
                this.a.setResult(-1, paramView);
                if (this.a.s) {
                  vei.a("set_notsee", "clk_done", 0, 0, new String[] { "", "", "", "" });
                }
                for (;;)
                {
                  this.a.finish();
                  break;
                  vei.a("set_notletsee", "clk_done", 0, 0, new String[] { "", "", "", "" });
                }
              }
              if (this.a.d == 37)
              {
              ...
              for (;;)
              {
                axqy.b(this.a.app, "dc00899", "invite_friend", "", "friend_list", "invite_friend", 0, 0, this.a.jdField_c_of_type_JavaLangString, String.valueOf(j), String.valueOf(i), "");
                return;
