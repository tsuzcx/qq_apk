  ...
  extends akpv
{
  ...
  public azno(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager)
  {
    super(paramQQAppInterface, paramProxyManager);
    this.jdField_a_of_type_JavaUtilComparator = new aznp(this);
  }
  ...
  protected int a(String paramString, int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    aukv localaukv = a();
    String str = "( msgtype " + akpy.b() + " and isValid=1 ) and shmsgseq <= ?";
    long l = paramMessageRecord.shmsgseq;
    paramString = localaukv.a(false, paramString, new String[] { "_id" }, str, new String[] { String.valueOf(l) }, null, null, null, null);
    paramInt = i;
    if (paramString != null)
    {
  ...
  public MessageRecord a(String paramString, int paramInt, MessageRecord paramMessageRecord, List<MessageRecord> paramList)
  {
    ...
    label43:
    if (paramInt >= 0) {
      if (akpy.a((MessageRecord)paramList.get(paramInt), paramMessageRecord, true, true)) {
  ...
  public List<MessageRecord> a(String paramString, int paramInt1, long paramLong1, int paramInt2, long paramLong2, int paramInt3, int[] paramArrayOfInt)
  {
    ...
    paramString = bbep.a(MessageRecord.getOldTableName(paramString, paramInt1), MessageRecord.getTableName(paramString, paramInt1), paramLong1, paramInt2, paramLong2, (String)localObject1, paramInt3, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.b());
    if (paramString == null) {
  ...
  protected List<MessageRecord> a(String paramString1, int paramInt1, long paramLong, int paramInt2, String paramString2)
  {
    ...
    if (bbep.a(MessageRecord.getTableName(paramString1, paramInt1), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.b()))
    {
  ...
  protected List<MessageRecord> a(String paramString, int paramInt, long paramLong1, long paramLong2)
  {
    ...
    if (localObject != null)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if ((localMessageRecord.shmsgseq == paramLong1) && ((!localMessageRecord.isSendFromLocal()) || (localMessageRecord.extraflag == 0)) && (!akpy.a(localMessageRecord))) {
  ...
  protected List<MessageRecord> a(String paramString, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject1 = (List)akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).b().get(a(paramString, paramInt));
        ...
        localObject1 = new axrr();
        if (Looper.myLooper() == Looper.getMainLooper())
        {
          i = 1;
          ((axrr)localObject1).jdField_a_of_type_Int = i;
          ((axrr)localObject1).jdField_a_of_type_JavaLangString = "select";
          ((axrr)localObject1).jdField_b_of_type_JavaLangString = "AIO";
          localObject4 = a(paramString, paramInt, (axrr)localObject1);
          if ((((axrr)localObject1).jdField_b_of_type_Int != 0) && (axrl.a()) && (axrl.a(1)))
          {
            localObject2 = new HashMap();
            ((HashMap)localObject2).put("param_IsMainThread", String.valueOf(((axrr)localObject1).jdField_a_of_type_Int));
            ((HashMap)localObject2).put("param_OptType", ((axrr)localObject1).jdField_a_of_type_JavaLangString);
            ((HashMap)localObject2).put("param_OptTotalCost", String.valueOf(((axrr)localObject1).jdField_a_of_type_Long));
            ((HashMap)localObject2).put("param_OptCount", String.valueOf(((axrr)localObject1).jdField_b_of_type_Int));
            ((HashMap)localObject2).put("param_OptMsgCount", String.valueOf(((axrr)localObject1).c));
            ((HashMap)localObject2).put("param_OptOneCost", String.valueOf(((axrr)localObject1).jdField_b_of_type_Long));
            ((HashMap)localObject2).put("param_OptScene", ((axrr)localObject1).jdField_b_of_type_JavaLangString);
            ((HashMap)localObject2).put("param_WalSwitch", String.valueOf(akfv.a));
            axrl.a(BaseApplication.getContext()).a(null, "actSqliteOptCost", true, ((axrr)localObject1).c, 0L, (HashMap)localObject2, null, false);
          }
          if ((localObject4 == null) || (((List)localObject4).isEmpty())) {
            break label1254;
          }
          if ((!QLog.isColorLevel()) || (!bbjv.a())) {
            break label541;
          }
    ...
    label541:
    new ArrayList();
    Object localObject2 = akpy.a((List)localObject4, false);
    ...
    if ((!akpy.a(paramString, paramInt, (List)localObject2)) && (akpy.b((List)localObject2)))
    {
      localObject1 = localObject2;
      if (!akpy.c((List)localObject2)) {}
    }
    else
    {
      if (QLog.isColorLevel()) {
      ...
      localObject1 = akpy.a((List)localObject4, false, 30);
    }
    if ((!akpy.a((List)localObject1)) && (localObject1 != null) && (!((List)localObject1).isEmpty()))
    {
      ...
      if ((localObject2 != null) && (!((List)localObject2).isEmpty()))
      {
        ...
        akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).b().put(a(paramString, paramInt), localObject2);
        label942:
        paramString = (List)akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).b().get(a(paramString, paramInt));
      }
    }
    for (;;)
    {
      ...
      try
      {
        ...
        if ((((MessageRecord)localObject1).frienduin.equals("927334240")) && (((MessageRecord)localObject1).shmsgseq == 798L) && (((MessageRecord)localObject1).msgtype == -1012))
        {
          if (i - 3 >= 0)
          {
            ...
            localObject1 = akpy.a((List)localObject2, true);
            break label852;
            label1254:
            localObject1 = d(paramString, paramInt, 15);
            break label852;
            label1267:
            akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).b().remove(a(paramString, paramInt));
            if (QLog.isColorLevel()) {
  ...
  protected void a(SessionInfo paramSessionInfo, String paramString, int paramInt, Set<String> paramSet)
  {
    ...
    paramSessionInfo = ((ajvk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).a(paramString);
    paramString = paramSessionInfo.iterator();
    while (paramString.hasNext()) {
  ...
  protected void a(String paramString, int paramInt, long paramLong)
  {
    ...
    if ((akpy.a(paramInt)) && (akpy.d() != null))
    {
      a(paramString, paramInt, str2, localContentValues, String.format("isread=? and %s<=? and " + akpy.d(), new Object[] { "shmsgseq" }), new String[] { "0", str1 }, null);
      return;
    }
    a(paramString, paramInt, str2, localContentValues, String.format("isread=? and %s<=?", new Object[] { "shmsgseq" }), new String[] { "0", str1 }, null);
  }
  
  public void a(String paramString, int paramInt, MessageRecord paramMessageRecord, akte paramakte, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    a(paramString, paramInt, paramMessageRecord, paramakte, paramBoolean1, paramBoolean2);
  }
  ...
  protected void a(String paramString, int paramInt, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      synchronized (akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a(paramString, paramInt))
      {
        ...
        if ((paramMessageRecord.isSendFromLocal()) || ((akpy.a(paramMessageRecord)) && (paramMessageRecord.msgtype != -4012) && (paramMessageRecord.msgtype != -4009) && (paramMessageRecord.msgtype != -5001) && (paramMessageRecord.msgtype != -5021)) || (akpy.f(paramMessageRecord)))
        {
          if ((localObject3 == null) || (((List)localObject3).isEmpty()) || (((MessageRecord)((List)localObject3).get(((List)localObject3).size() - 1)).shmsgseq <= 0L)) {
            break label618;
          }
          if ((!akpy.i(paramMessageRecord.msgtype)) || (paramMessageRecord.shmsgseq <= 0L)) {}
        }
        else
        {
          akpy.a((List)localObject3, paramMessageRecord, true);
          if ((localObject3 != null) && (((List)localObject3).size() > 40) && (!akpy.a(paramString)))
          {
            ((List)localObject3).remove(0);
            localObject3 = akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a();
            if ((akrz.a) && (((MsgLruCache)localObject3).getCacheType(localObject1) == akrz.d)) {
              ((MsgLruCache)localObject3).changeCacheType(localObject1, akrz.c);
            }
          }
          if ((akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).b().containsKey(localObject1)) && (paramBoolean))
          {
            localObject1 = (List)akpu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).b().get(localObject1);
            if (localObject1 != null) {
              break label626;
            }
            ...
            akpy.a((List)localObject1, paramMessageRecord, true);
            if ((paramMessageRecord.msgtype == -2006) && (agvz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt, paramString)) && ((paramMessageRecord instanceof MessageForFoldMsg)) && (!paramMessageRecord.isSend()))
            {
              if (this.jdField_a_of_type_Agvz == null) {
                this.jdField_a_of_type_Agvz = ((agvz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(125));
              }
              this.jdField_a_of_type_Agvz.a((List)localObject1, (MessageForFoldMsg)paramMessageRecord);
            }
          }
          return;
  ...
  protected void e()
  {
    ...
    aulz localaulz = (aulz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(201);
    int i = 0;
    label62:
    String str1;
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.TroopMsgProxy", 2, "queryMessagesByShmsgseqFromDB, peerUin[" + apue.e(paramString) + "] type[" + paramInt + "] shmsgseq[" + paramLong1 + "] msgUid[" + paramLong2 + "]");
    }
    ...
    paramString = localaukv.a(paramString, new String[] { String.valueOf(paramLong1) }, localQQAppInterface);
    if (paramString != null) {
      return paramString;
    }
    return new ArrayList();
