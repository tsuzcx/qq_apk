  ...
  extends MessageMicro<StUser>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 34, 40, 48, 56, 64, 74, 90, 98, 104, 112, 120, 130, 136, 146, 154 }, new String[] { "id", "nick", "icon", "desc", "followState", "type", "sex", "birthday", "school", "location", "busiData", "frdState", "relationState", "blackState", "medal", "constellation", "jumpUrl", "locationCode" }, new Object[] { "", "", null, "", localInteger, localInteger, localInteger, Long.valueOf(0L), "", "", localByteStringMicro, localInteger, localInteger, localInteger, null, localInteger, "", "" }, StUser.class);
  }
}
