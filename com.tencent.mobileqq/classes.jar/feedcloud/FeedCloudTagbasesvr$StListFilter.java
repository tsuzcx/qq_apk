  ...
  extends MessageMicro<StListFilter>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 34, 42, 50, 800 }, new String[] { "tagStatuss", "tagCategorys", "tagTypes", "startDay", "endDay", "search", "appid" }, new Object[] { localInteger, "", localInteger, "", "", "", localInteger }, StListFilter.class);
  }
}
