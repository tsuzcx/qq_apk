  ...
  extends MessageMicro<StDoBatchFollowReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 26, 32, 40 }, new String[] { "extInfo", "followType", "userList", "from", "followMethod" }, new Object[] { null, localInteger, null, localInteger, localInteger }, StDoBatchFollowReq.class);
  }
}
