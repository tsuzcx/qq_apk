  ...
  extends MessageMicro<StVideoUrl>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 40, 50 }, new String[] { "levelType", "playUrl", "videoPrior", "videoRate", "transStatus", "busiData" }, new Object[] { localInteger, "", localInteger, localInteger, localInteger, localByteStringMicro }, StVideoUrl.class);
  }
}
