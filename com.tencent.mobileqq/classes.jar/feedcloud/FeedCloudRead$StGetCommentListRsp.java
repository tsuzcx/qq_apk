  ...
  extends MessageMicro<StGetCommentListRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 32, 42, 50 }, new String[] { "extInfo", "vecComment", "totalNum", "isFinish", "feedAttchInfo", "busiRspData" }, new Object[] { null, null, localInteger, localInteger, "", localByteStringMicro }, StGetCommentListRsp.class);
  }
}
