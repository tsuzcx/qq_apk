  ...
  extends MessageMicro<StGetMainPageRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 32, 40, 50, 56, 66, 74, 82, 90, 96, 106, 112, 120, 130, 138 }, new String[] { "extInfo", "user", "feedCount", "fansCount", "followCount", "vecFeed", "isFinish", "share", "feedAttchInfo", "busiRspData", "pmBeginShow", "fansValueStyle", "guidePublishBubble", "isFirstLogin", "pushRocketCount", "followRecomInfo", "medalWall" }, new Object[] { null, null, localInteger, localInteger, localInteger, null, localInteger, null, "", localByteStringMicro, "", localInteger, null, Boolean.valueOf(false), localInteger, null, null }, StGetMainPageRsp.class);
  }
}
