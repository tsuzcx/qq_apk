...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 32, 40 }, new String[] { "tagCategory", "infos", "pageSize", "pageCurrent", "pageTotal" }, new Object[] { "", null, Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0) }, StCategoryTag.class);
