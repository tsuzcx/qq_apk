...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16 }, new String[] { "pollingInterval", "sceneSwitchInterval" }, new Object[] { Integer.valueOf(0), Integer.valueOf(0) }, IntervalControl.class);
