  ...
  extends MessageMicro<StEeveeBusiInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34 }, new String[] { "appid", "msgMainType", "msgSubType", "busiData" }, new Object[] { Integer.valueOf(0), Integer.valueOf(101), Integer.valueOf(1010001), localByteStringMicro }, StEeveeBusiInfo.class);
  }
}
