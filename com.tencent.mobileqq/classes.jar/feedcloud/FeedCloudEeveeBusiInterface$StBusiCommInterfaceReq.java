...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 32, 40, 50 }, new String[] { "appid", "uid", "clientInfo", "visitScene", "visitPage", "bizAsks" }, new Object[] { Integer.valueOf(0), "", null, Integer.valueOf(0), Integer.valueOf(0), null }, StBusiCommInterfaceReq.class);
