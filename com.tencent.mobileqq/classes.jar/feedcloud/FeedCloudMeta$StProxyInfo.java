  ...
  extends MessageMicro<StProxyInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34 }, new String[] { "cmdId", "subCmdId", "appProtocol", "reqBody" }, new Object[] { localInteger, localInteger, "", localByteStringMicro }, StProxyInfo.class);
  }
}
