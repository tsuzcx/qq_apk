  ...
  extends MessageMicro<StPushList>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 34, 42, 50, 56, 64, 74 }, new String[] { "id", "count", "status", "vecUser", "busiData", "postUser", "hasClickCount", "totalClickCount", "jumpUrl" }, new Object[] { "", localInteger, localInteger, null, localByteStringMicro, null, localInteger, localInteger, "" }, StPushList.class);
  }
}
