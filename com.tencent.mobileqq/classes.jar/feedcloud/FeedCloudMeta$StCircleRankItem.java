...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 42 }, new String[] { "rankNo", "circleName", "fuelValue", "feedNum", "circleID" }, new Object[] { Integer.valueOf(0), "", Long.valueOf(0L), Long.valueOf(0L), "" }, StCircleRankItem.class);
