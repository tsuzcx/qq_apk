...
public final class bdem
  implements beuq
{
  public bdem(RecentDanceConfigMgr.DItemInfo paramDItemInfo, String paramString) {}
  
  public void onResp(bevm parambevm)
  {
    if (parambevm.jdField_a_of_type_Int == 0)
    {
      parambevm = parambevm.jdField_a_of_type_Bevl;
      if (new File(parambevm.c).exists())
      {
        str = RecentDanceConfigMgr.a(parambevm.c);
      ...
      while (!QLog.isColorLevel())
      {
        ...
        bhmi.c(parambevm.c, this.jdField_a_of_type_JavaLangString);
      ...
      QLog.i("RecentDanceConfigMgr", 2, "processNetWork onResp[not exists]: mOutPath" + parambevm.c);
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.i("RecentDanceConfigMgr", 2, "processNetWork onResp: resp.mResult=" + parambevm.jdField_a_of_type_Int);
    }
