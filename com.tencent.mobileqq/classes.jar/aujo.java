...
public class aujo
{
  ...
  private static HashMap<String, String> a()
  {
    ...
    if (a != null)
    {
      aujq.a("MsgBackup_MsgBackupReporter", "mReportContainer = %s", new Object[] { a });
  ...
  public static void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    azqs.b(null, "dc00898", "", "", paramString, paramString, paramInt1, 0, String.valueOf(paramInt2), "", "", "");
  }
  ...
  public static void c()
  {
    if (a != null)
    {
      ...
      azri.a(BaseApplicationImpl.getContext()).a(str, "MsgBackup_MsgBackupReporter", true, 0L, 0L, localHashMap, null);
      b();
    }
  }
}
