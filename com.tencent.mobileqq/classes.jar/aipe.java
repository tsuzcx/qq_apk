  ...
  extends aimu
{
  ...
  aipe(NewPhotoPreviewActivity paramNewPhotoPreviewActivity)
  {
  ...
  public void initUI()
  {
    ...
    do
    {
      for (;;)
      {
        ...
        {
          ((NewPhotoPreviewActivity)this.mActivity).findViewById(2131365087).setVisibility(0);
          ((NewPhotoPreviewActivity)this.mActivity).findViewById(2131365087).setOnClickListener(new aipf(this));
        }
        if (((this.jdField_a_of_type_Aimr.g) || (this.jdField_a_of_type_Aimr.isSingleMode)) && (!this.jdField_a_of_type_Boolean)) {
        ...
        if ((this.jdField_a_of_type_Aimr.paths.size() > 1) && (this.mPhotoCommonData.selectedPhotoList.size() > 1)) {
          break;
        }
  ...
  public void onMagicStickClick(View paramView, int paramInt1, Bundle paramBundle, int paramInt2, Intent paramIntent)
  {
    ...
    if (this.jdField_a_of_type_Aimr.a != null)
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        if (paramInt1 < this.jdField_a_of_type_Aimr.paths.size()) {
          this.jdField_a_of_type_Aimr.a = ((String)this.jdField_a_of_type_Aimr.paths.get(paramInt1));
        }
      }
      paramView = EditPicActivity.a(this.mActivity, this.jdField_a_of_type_Aimr.a, true, true, true, true, true, 8);
      ...
      if ((needShowMultiPhoto()) && (this.jdField_a_of_type_Aimr.e > 0))
      {
        paramInt2 = this.jdField_a_of_type_Aimr.e;
    ...
    for (paramInt1 = this.mPhotoCommonData.selectedPhotoList.size();; paramInt1 = 0)
    {
      ...
      paramView = EditPicActivity.a(this.mActivity, this.jdField_a_of_type_Aimr.a, true, true, true, true, true, paramInt2, 99, 4, paramView);
      break;
      label509:
      paramView = new Bundle();
      paramView = EditPicActivity.a(this.mActivity, this.jdField_a_of_type_Aimr.a, true, true, true, true, true, 2, 99, 4, paramView);
      break;
  ...
  public void updateButton()
  {
    ...
    for (int i = 1;; i = 0)
    {
      if ((i != 0) && (!this.jdField_a_of_type_Aimr.g) && (!this.jdField_a_of_type_Aimr.isSingleMode) && (this.jdField_a_of_type_Boolean)) {
        ((NewPhotoPreviewActivity)this.mActivity).magicStickBtn.setEnabled(true);
      }
      return;
    }
