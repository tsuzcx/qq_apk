  ...
  extends j
{
  ...
  public o(HiBoomTextView paramHiBoomTextView)
  {
  ...
  {
    i.a("HiBoomFont.FounderHiBoomLayout", "drawMissingWord....char:" + String.valueOf((char)paramInt1) + "  code:" + paramInt1 + "  x:" + paramInt2 + "  y:" + paramInt3 + "  width:" + paramInt4 + "  height:" + paramInt5);
  ...
  {
    super.a();
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new p(this));
  }
  ...
  {
    this.f = g.a().a(this.jdField_a_of_type_ComEtrumpMixlayoutETFont.mFontId, this.jdField_a_of_type_ArrayOfInt, this.jdField_b_of_type_ArrayOfInt, this.jdField_e_of_type_ArrayOfInt, this.jdField_a_of_type_ComEtrumpMixlayoutETFont.mAnimationId, this.i);
    if (a())
    {
      a("onDraw.....");
      ...
      d();
      System.nanoTime();
      g.a().a(this.jdField_a_of_type_ComEtrumpMixlayoutETFont.mFontId, this.jdField_a_of_type_ArrayOfInt, this.jdField_a_of_type_ComEtrumpMixlayoutETFont.mAnimationId, this.jdField_e_of_type_Int, this.jdField_a_of_type_AndroidGraphicsBitmap, this.c);
      ...
      int j;
      switch (q.jdField_a_of_type_ArrayOfInt[this.jdField_a_of_type_ComTencentMobileqqHiboomHiBoomTextView.getScaleType().ordinal()])
      {
      default: 
  ...
  public int[] a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      if (g.a().a(this.jdField_a_of_type_ComEtrumpMixlayoutETFont.mFontId, this.jdField_a_of_type_ArrayOfInt, this.jdField_b_of_type_ArrayOfInt) != 0) {
        break label287;
      }
      this.d[0] = 0;
      this.d[1] = 0;
  ...
  public void b()
  {
    ...
    {
      i.b("HiBoomFont.FounderHiBoomLayout", "动画执行中....");
      return;
    }
    ...
    g.a().a(this.jdField_a_of_type_ComEtrumpMixlayoutETFont.mFontId, this.jdField_a_of_type_ArrayOfInt, this.jdField_b_of_type_ArrayOfInt, this.jdField_e_of_type_ArrayOfInt, this.jdField_a_of_type_ComEtrumpMixlayoutETFont.mAnimationId, this.i);
    if ((this.i[0] > 0) && (this.i[1] > 0))
    {
      h();
      return;
    }
    i.a("HiBoomFont.FounderHiBoomLayout", "该字体不支持动画....animInfo:" + Arrays.toString(this.i) + "  ttf path:" + this.jdField_a_of_type_ComEtrumpMixlayoutETFont.mFontPath);
  }
  
  public void e()
  {
    super.e();
    i.a("HiBoomFont.FounderHiBoomLayout", "release....");
