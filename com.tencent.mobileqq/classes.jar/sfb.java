...
{
  private static final String jdField_d_of_type_JavaLangString = amtj.a(2131715934);
  private WeishiRedDotInfo jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructWeishiRedDotInfo;
  private plv jdField_a_of_type_Plv = (plv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(274);
  private boolean jdField_d_of_type_Boolean;
  private boolean e;
  
  public sfb(rsp paramrsp, Bundle paramBundle, QQAppInterface paramQQAppInterface, FragmentActivity paramFragmentActivity, String paramString1, String paramString2, String paramString3, boolean paramBoolean, int paramInt)
  {
  ...
  private void a(WeishiRedDotInfo paramWeishiRedDotInfo)
  {
    ...
    this.jdField_a_of_type_Ofc.a(this.jdField_a_of_type_Ofd, l1, a(), i, null, str1, l3, true, 0, str2, str3, paramWeishiRedDotInfo, 0, null, null, 0, null);
  }
  ...
  public boolean a(Bundle paramBundle)
  {
    if (this.jdField_d_of_type_Boolean)
    {
      ...
      if (this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo != null)
      {
        ...
        this.jdField_a_of_type_Plv.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity);
        return true;
      }
    }
  ...
  public void b()
  {
    ...
    ColorDrawable localColorDrawable = new ColorDrawable(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getColor(2131165351));
  ...
  {
    if ((paramVideoInfo != null) && (this.jdField_a_of_type_Plv != null))
    {
      if (paramVideoInfo.a == null) {
        rwv.a(paramVideoInfo);
      }
      long l = NetConnInfoCenter.getServerTime();
      this.jdField_a_of_type_Plv.a(ugf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramVideoInfo.a), l);
    }
  }
