  ...
  extends BaseAdapter
{
  ...
  private bkwv jdField_a_of_type_Bkwv;
  private List<bbje> jdField_a_of_type_JavaUtilList;
  
  public bkwu(Context paramContext, List<bbje> paramList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (this.jdField_a_of_type_Bkwv == null) {
      this.jdField_a_of_type_Bkwv = new bkwv(paramViewGroup.getContext());
    }
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131558827, paramViewGroup, false);
      paramViewGroup = new bkww();
    ...
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = (bkww)paramView.getTag();
    }
    paramView.setId(paramViewGroup.jdField_a_of_type_Bbje.jdField_a_of_type_Int);
    paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setText(bkws.a(paramViewGroup.jdField_a_of_type_Bbje.jdField_a_of_type_JavaLangString, 6));
    paramInt = -8947849;
    ...
    if (paramViewGroup.jdField_a_of_type_Bbje.c)
    {
      ...
      localObject = this.jdField_a_of_type_Bkwv.a((Drawable)localObject, paramInt, i);
      if (!paramViewGroup.jdField_a_of_type_Bbje.c) {
        break label421;
      }
      Drawable localDrawable = bkwv.a(this.jdField_a_of_type_Bkwv, (Drawable)localObject);
      localObject = this.jdField_a_of_type_Bkwv.a((Drawable)localObject, localDrawable);
    ...
    for (;;)
    {
      ...
      break label294;
      label421:
      localObject = bkwv.b(this.jdField_a_of_type_Bkwv, (Drawable)localObject);
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
    }
    label444:
