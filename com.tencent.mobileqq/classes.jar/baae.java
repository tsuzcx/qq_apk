...
public class baae
{
  ...
  public baae(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
  ...
  private void a(JSONObject paramJSONObject)
  {
    ...
    String str = mzk.b(this.jdField_a_of_type_JavaLangString);
    boolean bool2;
    ...
    for (;;)
    {
      baah localbaah = new baah(this, str, bool2, bool1);
      if (!TextUtils.isEmpty(str)) {
        ThreadManager.post(new SoLibraryChecker.4(this, paramJSONObject, str, localbaah), 8, null, false);
      }
      return;
      if ((i == 3) || (i == 2))
      {
  ...
  private void b()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((!new File(mzk.a(this.jdField_a_of_type_JavaLangString) + this.jdField_a_of_type_JavaLangString + "/" + this.b).exists()) && (!TextUtils.isEmpty(str)) && (!"0".equals(str))) {
    ...
    mze.a(this.jdField_a_of_type_JavaLangString, localQQAppInterface, new baaf(this), false);
  }
  ...
  private void c()
  {
    ...
    long l = System.currentTimeMillis();
    if ((!mze.a(BaseApplicationImpl.getContext(), str, new baag(this, l))) && (QLog.isColorLevel())) {
