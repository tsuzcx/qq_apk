...
public class aoae
{
  private static aoai jdField_a_of_type_Aoai;
  private static boolean jdField_a_of_type_Boolean;
  
  private static SpannableString a(Context paramContext, String paramString)
  {
    SpannableString localSpannableString = new SpannableString(paramContext.getString(2131698730));
    localSpannableString.setSpan(new aoah(paramContext, paramString, "https://ti.qq.com/agreement/index.html"), 114, 120, 33);
    localSpannableString.setSpan(new ForegroundColorSpan(-12541697), 114, 120, 17);
    localSpannableString.setSpan(new aoah(paramContext, paramString, "https://ti.qq.com/agreement/privacy/index.html"), 121, 127, 33);
    localSpannableString.setSpan(new ForegroundColorSpan(-12541697), 121, 127, 17);
    localSpannableString.setSpan(new aoah(paramContext, paramString, "https://ti.qq.com/agreement/privateProtocal.html"), 128, 136, 33);
  ...
  {
    if (jdField_a_of_type_Aoai == null) {
      jdField_a_of_type_Aoai = new aoai();
    }
    return jdField_a_of_type_Aoai;
  }
  ...
  public static QQCustomDialog a(Context paramContext, String paramString, DialogInterface.OnClickListener paramOnClickListener1, DialogInterface.OnClickListener paramOnClickListener2)
  {
    ...
    paramOnClickListener1 = new aoaf(paramOnClickListener1);
    paramOnClickListener2 = new aoag(paramOnClickListener2);
    paramContext = bhdj.a(paramContext, 0, paramContext.getString(2131698735), paramString.toString(), 2131698733, 2131698729, paramOnClickListener2, paramOnClickListener1);
