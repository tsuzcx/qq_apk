  ...
  implements Handler.Callback
{
  ...
  private oidb_cmd0xb77.ImageInfo a(auop paramauop)
  {
    if (paramauop == null) {
      return null;
    }
    if (!(paramauop.a instanceof int[])) {
      return null;
    }
    int[] arrayOfInt = (int[])paramauop.a;
    if (arrayOfInt.length != 5) {
      return null;
    }
    oidb_cmd0xb77.ImageInfo localImageInfo = new oidb_cmd0xb77.ImageInfo();
    localImageInfo.md5.set(paramauop.d);
    localImageInfo.uuid.set(paramauop.c);
    ...
    localImageInfo.file_id.set((int)paramauop.b);
    return localImageInfo;
  }
  
  private oidb_cmd0xdc2.ReqBody a(String paramString1, String paramString2, Map<ResultRecord, auop> paramMap)
  {
    oidb_cmd0xdc2.ReqBody localReqBody = new oidb_cmd0xdc2.ReqBody();
    localReqBody.msg_body.set(aqft.a(this.jdField_a_of_type_AndroidOsBundle, paramString1, paramString2, null));
    ...
    if (paramList.size() == 1)
    {
      ...
      if (((oidb_cmd0xdc2.BatchSendRsp)localObject1).err_code.get() == 901503)
      {
        ...
        if (TextUtils.isEmpty((CharSequence)localObject1)) {
          paramList = aqft.jdField_a_of_type_JavaLangString;
        }
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    aqft.a(this.jdField_a_of_type_ComTencentMobileqqMiniShareOpensdkOpenSdkShareModel, this.jdField_a_of_type_AndroidOsBundle, paramString1.msg_body);
    ...
    aqgh.a("KEY_STAGE_2_NORMAL_DC2");
    mxi.a(paramString2, new aqda(this), paramString1.toByteArray(), "OidbSvc.0xdc2_9", 3522, 9, localBundle, 0L);
  }
  
  private void a(Map<ResultRecord, auop> paramMap)
  {
    ...
    aqgh.a("KEY_STAGE_2_IMAGE_DC2");
    mxi.a(localAppRuntime, new aqcz(this), paramMap.toByteArray(), "OidbSvc.0xdc2_9", 3522, 9, localBundle, 0L);
  }
  
  private void a(Map<ResultRecord, auop> paramMap, ResultRecord paramResultRecord, oidb_cmd0xdc2.BatchSendReq paramBatchSendReq)
  {
    if (paramMap != null)
    {
      paramMap = a((auop)paramMap.get(paramResultRecord));
      if (paramMap != null) {
  ...
  private void b()
  {
    ...
    WeakReference localWeakReference = new WeakReference(new aqcx(this));
    ...
    aqgh.a("KEY_STAGE_2_SEND_MSG_BY_SERVER");
    AbsShareMsg.sendSdkShareMessageByServer(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg, str1, i, str2, (auoo)localWeakReference.get());
  }
  ...
  private void b(List<oidb_cmd0xdc2.BatchSendRsp> paramList)
  {
    ...
    {
      paramList = actn.a(localIntent, new int[] { 2 });
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Aqbx.b(this.jdField_a_of_type_AndroidAppActivity);
      ForwardUtils.a(this.jdField_a_of_type_AndroidAppActivity);
      return;
      paramList = actn.a(localIntent, null);
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_MqqOsMqqHandler.removeMessages(93);
    this.jdField_a_of_type_Aqbx.b(this.jdField_a_of_type_AndroidAppActivity);
    ForwardUtils.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidOsBundle, aqft.jdField_a_of_type_JavaLangString);
  }
  ...
  private void d()
  {
    ...
    aqgh.a("KEY_STAGE_2_UPLOAD_IMAGE_MULT");
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
  ...
  void a(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    this.jdField_a_of_type_Aqbx = new aqbx();
  }
  ...
  void a(List<ResultRecord> paramList)
  {
    ...
    paramList = axuy.a(this.jdField_a_of_type_AndroidOsBundle);
    ...
    if (!bbev.d(this.jdField_a_of_type_AndroidAppActivity))
    {
      ...
      ForwardUtils.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidOsBundle, ajyc.a(2131704791));
      return;
    }
    a();
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Aqbx.a(this.jdField_a_of_type_AndroidAppActivity);
      ...
      {
        this.jdField_a_of_type_Aqbx.b(this.jdField_a_of_type_AndroidAppActivity);
        ForwardUtils.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidOsBundle, ajyc.a(2131704790));
      }
      else
      {
        e();
