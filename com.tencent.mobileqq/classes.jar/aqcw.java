...
public class aqcw
  implements aqct<FontRecommendRsp>
{
  public int a()
  {
    return 3;
  ...
  {
    return bant.a(paramContext, "font", "mvip.gexinghua.mobile.font.client_tab_store");
  }
  
  public String a(FontBubble paramFontBubble)
  {
    return bant.a("fontPreview").replace("[id]", Integer.toString(paramFontBubble.fontId));
  }
  
  public List<FontBubble> a(QQAppInterface paramQQAppInterface, FontRecommendRsp paramFontRecommendRsp)
  {
    int j = ((ajrm)paramQQAppInterface.a(13)).b();
