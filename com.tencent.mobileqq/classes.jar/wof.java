...
public class wof
{
  private static final String jdField_a_of_type_JavaLangString = wof.class.getSimpleName();
  ...
  public static String a(long paramLong)
  {
    ...
    try
    {
      str = BaseApplicationImpl.getContext().getString(2131720914);
      localObject2 = BaseApplicationImpl.getContext().getString(2131720915);
      localObject1 = BaseApplicationImpl.getContext().getString(2131720913);
