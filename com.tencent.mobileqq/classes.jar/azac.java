  ...
  extends BaseAdapter
{
  ...
  private azal jdField_a_of_type_Azal;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private ArrayList<AutoReplyText> jdField_a_of_type_JavaUtilArrayList;
  private boolean jdField_a_of_type_Boolean;
  private boolean b;
  
  public azac(QQAppInterface paramQQAppInterface, Context paramContext, Drawable paramDrawable)
  {
  ...
  {
    paramLayoutInflater = paramLayoutInflater.inflate(2131558425, paramViewGroup, false);
    paramViewGroup = (TextView)paramLayoutInflater.findViewById(2131365157);
    ViewGroup.MarginLayoutParams localMarginLayoutParams = (ViewGroup.MarginLayoutParams)paramViewGroup.getLayoutParams();
    if (getItemViewType(paramInt) == 0)
    {
      localMarginLayoutParams.topMargin = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298444);
      localMarginLayoutParams.bottomMargin = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298441);
      paramViewGroup.setText(2131690252);
      paramViewGroup.setContentDescription(this.jdField_a_of_type_AndroidContentContext.getString(2131690252));
    }
    for (;;)
    {
      paramViewGroup.setLayoutParams(localMarginLayoutParams);
      return paramLayoutInflater;
      localMarginLayoutParams.bottomMargin = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298444);
      localMarginLayoutParams.topMargin = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298441);
      paramViewGroup.setText(2131690254);
      paramViewGroup.setContentDescription(this.jdField_a_of_type_AndroidContentContext.getString(2131690254));
    }
  }
  
  private azam a(LayoutInflater paramLayoutInflater, int paramInt, View paramView, ViewGroup paramViewGroup, AutoReplyText paramAutoReplyText)
  {
    if ((paramView == null) || (paramView.getTag() == null) || (paramView.getVisibility() == 8))
    {
      paramView = paramLayoutInflater.inflate(2131558421, paramViewGroup, false);
      ...
      if (ThemeUtil.isDefaultTheme())
      {
        ...
        if ((!ThemeUtil.isDefaultTheme()) && (!ThemeUtil.isNowThemeIsNight(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false, null))) {
          paramView.findViewById(2131376540).setBackgroundResource(2130839506);
        }
        paramView.findViewById(2131370012).setPadding(0, 0, 0, 0);
        paramView.findViewById(2131376724).setVisibility(8);
        paramViewGroup = (TextView)paramView.findViewById(2131370039);
        paramViewGroup.setEditableFactory(new azae(this, paramViewGroup));
        paramLayoutInflater = new azam(null);
        ...
        paramLayoutInflater.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131376696));
        paramLayoutInflater.b = paramView.findViewById(2131365895);
        paramLayoutInflater.c = paramView.findViewById(2131365896);
        paramLayoutInflater.d = paramView.findViewById(2131378688);
        paramLayoutInflater.jdField_a_of_type_AndroidViewView.setTag(paramLayoutInflater);
        label200:
        paramLayoutInflater.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new azaf(this, paramAutoReplyText));
        paramLayoutInflater.b.setOnClickListener(new azag(this, paramAutoReplyText));
        ...
        paramLayoutInflater.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(new QQText(anvx.a(2131700359) + paramView, 3, i));
        paramLayoutInflater.c.setOnClickListener(new azah(this, paramAutoReplyText, bool));
        paramLayoutInflater.jdField_a_of_type_AndroidViewView.findViewById(2131376540).setOnClickListener(new azai(this, paramAutoReplyText));
    ...
    for (paramInt = 0;; paramInt = ScreenUtil.dip2px(200.0F))
    {
      ...
      paramInt = 8;
      break;
      paramLayoutInflater = (azam)paramView.getTag();
      paramLayoutInflater.jdField_a_of_type_AndroidViewView = paramView;
      break label200;
      paramInt = 0;
      break label259;
  ...
  private void a(View paramView, int paramInt)
  {
    ...
    azaj localazaj = new azaj(this, paramView, paramView.getMeasuredHeight());
    localazaj.setAnimationListener(new azak(this, paramInt));
    localazaj.setDuration(150L);
    paramView.startAnimation(localazaj);
  }
  
  private View b(LayoutInflater paramLayoutInflater, int paramInt, ViewGroup paramViewGroup)
  {
    paramLayoutInflater = paramLayoutInflater.inflate(2131558419, paramViewGroup, false);
    paramLayoutInflater.setOnClickListener(new azad(this));
    return paramLayoutInflater;
  }
  ...
  private void b(int paramInt)
  {
    ...
    if (((Iterator)localObject).hasNext())
    {
      ...
      if (localAutoReplyText.getTextId() == paramInt)
      {
        ...
        {
          azal localazal = this.jdField_a_of_type_Azal;
          if (localAutoReplyText.getTextId() == 2147483647)
          {
            bool = true;
            localazal.a(localAutoReplyText, bool);
          }
        }
        else
        {
  ...
  public void a(int paramInt)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      this.b = bool;
      if (this.jdField_a_of_type_Azal != null) {
        this.jdField_a_of_type_Azal.a(localObject2, localObject1);
      }
      notifyDataSetChanged();
      return;
    }
  ...
  public void a(@Nullable azal paramazal)
  {
  ...
  public void a(@Nullable AutoReplyText paramAutoReplyText)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Azal != null) {
        this.jdField_a_of_type_Azal.a(paramAutoReplyText);
      }
      a();
      this.b = true;
      notifyDataSetChanged();
