  ...
  extends xhf
{
  ...
  public void a(Canvas paramCanvas, xhg paramxhg, float paramFloat)
  {
    if (paramxhg.jdField_a_of_type_Int == 103) {}
    do
    {
      return;
      if (paramxhg.jdField_a_of_type_Int == 104)
      {
        ...
        this.jdField_a_of_type_AndroidGraphicsPaint.setStrokeWidth(45.0F);
        this.jdField_a_of_type_AndroidGraphicsPaint.setShader(this.jdField_a_of_type_AndroidGraphicsBitmapShader);
        paramCanvas.drawPath(paramxhg.jdField_a_of_type_AndroidGraphicsPath, this.jdField_a_of_type_AndroidGraphicsPaint);
        return;
      }
    } while (paramxhg.jdField_a_of_type_Int != 105);
    ...
    this.jdField_a_of_type_AndroidGraphicsPaint.setColor(jdField_a_of_type_Int);
    this.jdField_a_of_type_AndroidGraphicsCanvas.drawPath(paramxhg.jdField_a_of_type_AndroidGraphicsPath, this.jdField_a_of_type_AndroidGraphicsPaint);
  ...
  public void a(xdy paramxdy, float paramFloat, Bitmap paramBitmap, Rect paramRect)
  {
  ...
  public void a(xhg paramxhg)
  {
    if (paramxhg.jdField_a_of_type_Int == 103)
    {
      ...
      wxk.a("0X80076C2");
      List localList = paramxhg.jdField_a_of_type_JavaUtilList;
      paramxhg = paramxhg.b;
      int k = 0;
      while ((k < localList.size()) && (k < paramxhg.size()))
      {
        e(((Integer)localList.get(k)).intValue(), ((Integer)paramxhg.get(k)).intValue());
        k += 1;
      }
      c();
    }
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Xhg = new xhg(new Path(), this.g);
      if (this.jdField_a_of_type_Xhb != null) {
        this.jdField_a_of_type_Xhb.a(this.jdField_a_of_type_Xhg);
      }
      int k;
      int m;
      if (this.g == 103)
      {
        ...
        if ((k >= 0) && (m >= 0))
        {
          this.jdField_a_of_type_Xhg.jdField_a_of_type_JavaUtilList.add(Integer.valueOf(k));
          this.jdField_a_of_type_Xhg.b.add(Integer.valueOf(m));
          d(k, m);
          c();
        }
      }
      ...
      {
        this.jdField_a_of_type_Xhg.jdField_a_of_type_AndroidGraphicsPath.reset();
        this.jdField_a_of_type_Xhg.jdField_a_of_type_AndroidGraphicsPath.moveTo(f1, f2);
        this.jdField_a_of_type_Xhg.jdField_a_of_type_AndroidGraphicsPath.lineTo(f1 + 1.0F, f2 + 1.0F);
      }
      else if (this.g == 105)
      {
        this.jdField_a_of_type_Xhg.jdField_a_of_type_AndroidGraphicsPath.reset();
        ...
        if (this.g == 103)
        {
          k = ((Integer)this.jdField_a_of_type_Xhg.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_Xhg.jdField_a_of_type_JavaUtilList.size() - 1)).intValue();
          m = ((Integer)this.jdField_a_of_type_Xhg.b.get(this.jdField_a_of_type_Xhg.b.size() - 1)).intValue();
          ...
          {
            this.jdField_a_of_type_Xhg.jdField_a_of_type_JavaUtilList.add(Integer.valueOf(n));
            this.jdField_a_of_type_Xhg.b.add(Integer.valueOf(i1));
            d(n, i1);
            c();
          }
        }
        ...
        {
          this.jdField_a_of_type_Xhg.jdField_a_of_type_AndroidGraphicsPath.quadTo(this.jdField_d_of_type_Float, this.jdField_e_of_type_Float, (this.jdField_d_of_type_Float + f1) / 2.0F, (this.jdField_e_of_type_Float + f2) / 2.0F);
          this.jdField_d_of_type_Float = f1;
          this.jdField_e_of_type_Float = f2;
        }
        else if (this.g == 105)
  ...
  public void c()
  {
    if (this.jdField_a_of_type_Xdy != null)
    {
      ...
      this.jdField_a_of_type_Xdy.a(this.jdField_b_of_type_AndroidGraphicsBitmap, this.jdField_b_of_type_Boolean);
    }
    for (;;)
    {
      ...
      return;
      label50:
      this.jdField_a_of_type_Xdy.a(this.jdField_a_of_type_ArrayOfByte, this.jdField_e_of_type_Int, this.f);
    }
  }
