  ...
  implements RecogCallback
{
  ...
  private CopyOnWriteArrayList<WeakReference<aokf>> jdField_b_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  private boolean jdField_b_of_type_Boolean;
  private boolean c;
  private boolean h;
  private boolean i;
  private boolean j;
  private boolean k = aoel.a().f;
  private boolean l = aoel.a().g;
  ...
  private aoee a()
  {
    try
    {
      ...
      aoee localaoee = this.jdField_a_of_type_Aoee;
      return localaoee;
    }
    finally {}
  }
  ...
  {
    if (jdField_a_of_type_Aokb == null) {}
    try
    {
      if (jdField_a_of_type_Aokb == null) {
        jdField_a_of_type_Aokb = new aokb();
      }
      return jdField_a_of_type_Aokb;
    }
    finally {}
  }
  ...
  public void a()
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        try
        {
          int m = aokm.b("QMCF_qr");
          int n = aokm.b("yuvutil");
          if ((m != 0) || (n != 0)) {
            continue;
          }
          bool3 = true;
        ...
        try
        {
          ...
          localObject1 = aokl.a() + File.separator + aokl.a("qr_detection_model.bin");
          localObject3 = aokl.a() + File.separator + aokl.a("qr_detection_model.txt");
          str1 = aokl.a() + File.separator + aokl.a("qr_anchor.bin");
  ...
  public void a(android.content.Context paramContext, long paramLong, String paramString)
  {
    ...
    //   8: return
    //   9: aload_0
    //   10: getfield 68	aokb:k	Z
    //   13: ifne +10 -> 23
    //   16: aload_0
    //   17: getfield 72	aokb:l	Z
    //   20: ifeq -14 -> 6
    //   23: aload_1
    //   24: invokevirtual 367	android/content/Context:getApplicationContext	()Landroid/content/Context;
    //   27: astore_1
    //   28: aload_0
    //   29: getfield 59	aokb:jdField_a_of_type_JavaUtilSet	Ljava/util/Set;
    //   32: lload_2
    ...
    //   84: ifeq -78 -> 6
    //   87: aload_0
    //   88: invokespecial 374	aokb:a	()Laoee;
    //   91: astore 4
    //   93: aload_0
    //   94: getfield 153	aokb:i	Z
    //   97: ifne +80 -> 177
    //   100: aload_0
    //   101: getfield 172	aokb:j	Z
    //   104: istore 5
    //   106: iload 5
    //   108: ifne +69 -> 177
    //   111: aload_0
    //   112: iconst_1
    //   113: putfield 172	aokb:j	Z
    //   116: aload 4
    //   118: aload_1
    //   119: new 376	aokd
    //   122: dup
    //   123: aload_0
    //   124: aload 4
    //   126: invokespecial 379	aokd:<init>	(Laokb;Laoee;)V
    //   129: new 381	aoke
    //   132: dup
    //   133: aload_0
    //   134: aconst_null
    //   135: invokespecial 384	aoke:<init>	(Laokb;Lcom/tencent/mobileqq/ar/codeEngine/MiniCodeController$1;)V
    //   138: invokevirtual 387	aoee:a	(Landroid/content/Context;Laodu;Laodx;)V
    //   141: getstatic 150	aokb:d	Z
    //   144: ifeq +7 -> 151
    //   147: aload_0
    //   148: invokespecial 329	aokb:c	()V
    //   151: aload_0
    //   152: invokevirtual 388	aokb:a	()V
    //   155: goto -149 -> 6
    //   158: astore_1
    //   159: aload_0
    //   160: monitorexit
    ...
    //   174: goto -33 -> 141
    //   177: aload_0
    //   178: invokevirtual 393	aokb:b	()V
    //   181: goto -40 -> 141
  ...
  public void a(aokf paramaokf)
  {
    Iterator localIterator = this.jdField_b_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
    while (localIterator.hasNext())
    {
      aokf localaokf = (aokf)((WeakReference)localIterator.next()).get();
      if ((localaokf != null) && (localaokf == paramaokf)) {
        return;
      }
    }
    this.jdField_b_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(new WeakReference(paramaokf));
  }
  ...
  public boolean a(Bitmap paramBitmap, long paramLong, Rect paramRect)
  {
    ...
    for (;;)
    {
      ...
      paramRect = new aokc(this, paramRect, paramLong, localObject, localMiniCodeDetector, arrayOfBoolean, paramBitmap);
      boolean bool1;
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Int >= 0)
        {
          ...
          return;
          if (this.jdField_a_of_type_Aoee != null) {
            this.jdField_a_of_type_Aoee.c(0);
          }
          if (!QLog.isColorLevel()) {
            continue;
          }
      ...
      label224:
      if (this.jdField_a_of_type_Aoee != null) {
        this.jdField_a_of_type_Aoee.c(1);
      }
      if (QLog.isColorLevel())
      {
        ...
        label256:
        if (this.jdField_a_of_type_Aoee != null) {
          this.jdField_a_of_type_Aoee.c(2);
        }
        if (QLog.isColorLevel()) {
  ...
  public void c(RecogCallback paramRecogCallback)
  {
    ...
    {
      WeakReference localWeakReference = (WeakReference)localIterator.next();
      aokf localaokf = (aokf)localWeakReference.get();
      if ((localaokf != null) && (localaokf == paramRecogCallback)) {
