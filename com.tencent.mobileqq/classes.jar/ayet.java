  ...
  extends aygb
{
  ...
  public ayet(Context paramContext, aybt paramaybt, QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(RelativeLayout paramRelativeLayout, VideoData paramVideoData, ayeu paramayeu)
  {
    ...
    this.jdField_a_of_type_Ayeu = paramayeu;
    if (paramVideoData.a == 1)
    {
      ...
      d();
      ayej.a().a(this.jdField_a_of_type_AndroidWidgetImageView, paramVideoData.c, new ColorDrawable(0), new ColorDrawable(0), null);
      this.jdField_a_of_type_AndroidOsHandler.post(new MagazinePlayerView.1(this));
      return;
    }
    super.a(paramRelativeLayout, paramVideoData, paramayeu);
  }
