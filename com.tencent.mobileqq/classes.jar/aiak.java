...
public class aiak
{
  public final int a;
  public aiag a;
  allb jdField_a_of_type_Allb = new aiau(this);
  private alls jdField_a_of_type_Alls = new aiam(this);
  private alsi jdField_a_of_type_Alsi = new aibe(this);
  private alsp jdField_a_of_type_Alsp = new aibj(this);
  private alti jdField_a_of_type_Alti = new aibk(this);
  alxa jdField_a_of_type_Alxa = new aiay(this);
  private amks jdField_a_of_type_Amks = new aibh(this);
  private amkt jdField_a_of_type_Amkt = new aibg(this);
  protected Bundle a;
  public Handler a;
  private apxc jdField_a_of_type_Apxc = new aian(this);
  private avqr jdField_a_of_type_Avqr = new aibi(this);
  private avqs jdField_a_of_type_Avqs = new aiat(this);
  private avqu jdField_a_of_type_Avqu = new aibf(this);
  private avqv jdField_a_of_type_Avqv = new aial(this);
  ...
  public aiak(SplashActivity paramSplashActivity)
  {
    this.jdField_a_of_type_Int = 0;
    this.jdField_b_of_type_Int = 1;
    this.jdField_c_of_type_Int = 3;
    this.jdField_a_of_type_AndroidOsHandler = new aiap(this, Looper.getMainLooper());
    this.jdField_a_of_type_Ndm = new aiax(this);
    this.jdField_a_of_type_Aiag = new aiag(paramSplashActivity);
    this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity = paramSplashActivity;
  }
  
  private bdfq a(String paramString)
  {
    return bdcd.a(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity, 230).setTitle(null).setMessage(paramString).setPositiveButton(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.getString(2131690626), new aibb(this));
  }
  
  private bdfq a(String paramString1, String paramString2)
  {
    return bdcd.a(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity, 230).setTitle(null).setMessage(paramString1).setPositiveButton(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.getString(2131719910), new aibd(this)).setNegativeButton(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.getString(2131719909) + paramString2, new aibc(this));
  }
  ...
  private void a(Bundle paramBundle)
  {
    ...
    if (bool1)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.getIntent().putExtra("key_action", alnx.class.getSimpleName());
      i();
      return;
    }
    if (bool2)
    {
      ...
      for (this.jdField_c_of_type_Bdfq = a(paramBundle, str4);; this.jdField_c_of_type_Bdfq = a(paramBundle))
      {
        this.jdField_c_of_type_Bdfq.show();
        return;
      }
    }
    alnx.a(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity, str1, str2, str3);
  }
  ...
  {
    bdcd.a(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity, 230).setTitle(null).setMessage(String.format(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.getString(2131699929), new Object[] { paramString })).setPositiveButton(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.getString(2131691112), new aiba(this, paramString)).setNegativeButton(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.getString(2131690624), new aiaz(this)).show();
  }
  ...
  private void b(Bundle paramBundle)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.getIntent().removeExtra("pull_app_not_privilege");
      this.jdField_c_of_type_Bdfq = a(str1);
      this.jdField_c_of_type_Bdfq.show();
    }
    do
    {
      ...
      if (bool2)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.getIntent().putExtra("is_change_account", true);
        this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.getIntent().putExtra("if_check_account_same", true);
        this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.getIntent().putExtra("key_action", arvx.class.getSimpleName());
        i();
        return;
      }
    } while (!bool3);
  ...
  {
    int i = ((avod)paramQQAppInterface.getManager(160)).a();
    String str = null;
    switch (i)
    {
    }
    ...
    {
      if (str != null) {
        azmj.b(paramQQAppInterface, "dc00898", "", "", str, str, 0, 0, "", "", "", "");
      }
      return;
      str = "0X80073B0";
      continue;
  ...
  public void a()
  {
    ...
    try
    {
      this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.registObserver(this.jdField_a_of_type_Avqv);
      this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.registObserver(this.jdField_a_of_type_Avqu);
      this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.registObserver(this.jdField_a_of_type_Avqr);
      this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.addObserver(this.jdField_a_of_type_Alls);
      this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.addObserver(this.jdField_a_of_type_Alsi);
      this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.addObserver(this.jdField_a_of_type_Avqs);
      this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.a(this.jdField_a_of_type_Alsp);
      this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.addObserver(this.jdField_a_of_type_Amks);
      VSNetworkHelper.a().a();
      VSNetworkHelper.a();
      ((altc)this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.getManager(34)).a(this.jdField_a_of_type_Alti);
      ((nag)this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.a(43)).a();
      this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.addObserver(this.jdField_a_of_type_Allb);
      this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.addObserver(this.jdField_a_of_type_Ndm);
      this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.addObserver(this.jdField_a_of_type_Alxa);
      this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.addObserver(this.jdField_a_of_type_Apxc);
      ...
      ((KandianMergeManager)localObject).a(this.jdField_a_of_type_Amkt);
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.unRegistObserver(this.jdField_a_of_type_Avqu);
    this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.removeObserver(this.jdField_a_of_type_Alsi);
    this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.removeObserver(this.jdField_a_of_type_Avqs);
    this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.unRegistObserver(this.jdField_a_of_type_Avqr);
    this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.a(null);
    this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.removeObserver(this.jdField_a_of_type_Alls);
    this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.removeObserver(this.jdField_a_of_type_Amks);
    ((altc)this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.getManager(34)).b(this.jdField_a_of_type_Alti);
    this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.removeObserver(this.jdField_a_of_type_Alxa);
    this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.unRegistObserver(this.jdField_a_of_type_Avqv);
    ((nag)this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.a(43)).b();
    VSNetworkHelper.a().a();
    ((KandianMergeManager)this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.getManager(162)).b(this.jdField_a_of_type_Amkt);
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.removeObserver(this.jdField_a_of_type_Allb);
    this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.removeObserver(this.jdField_a_of_type_Ndm);
    this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.removeObserver(this.jdField_a_of_type_Apxc);
  }
  ...
  public void g()
  {
    ...
    a(this.jdField_a_of_type_Aiag.a(new aiao(this)));
  }
  ...
  public void h()
  {
    ...
    altc localaltc = (altc)this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.getManager(34);
    if ((localObject != null) && (localaltc != null)) {
  ...
  protected void i()
  {
    ...
    {
      this.jdField_b_of_type_Bdfq = bdcd.a(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity, 230);
      this.jdField_b_of_type_Bdfq.setMessage(2131695720);
      this.jdField_b_of_type_Bdfq.setTitle(2131692310);
      this.jdField_b_of_type_Bdfq.setNegativeButton(2131690648, new aiav(this));
      this.jdField_b_of_type_Bdfq.setPositiveButton(2131695690, new aiaw(this));
    }
  ...
  protected void j()
  {
    ...
    {
      this.jdField_a_of_type_Bepp = new bepp(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity, this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.getTitleBarHeight());
      this.jdField_a_of_type_Bepp.a(alpo.a(2131706796));
    }
    ...
    for (;;)
    {
      ...
      {
        bclo.a(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity, this.jdField_a_of_type_AndroidOsBundle, this.jdField_a_of_type_AndroidOsBundle.getInt("vistor_type", 1));
      }
      ...
      {
        Object localObject2;
        if (arvx.class.getSimpleName().equals(this.jdField_c_of_type_JavaLangString))
        {
          localObject2 = (aloz)this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.getManager(51);
          localObject1 = this.jdField_a_of_type_AndroidOsBundle.getString("uin", "");
          if (((aloz)localObject2).b((String)localObject1))
          {
            if (this.jdField_a_of_type_AndroidOsBundle.getBoolean("thridparty_pull_aio", false))
            {
              ...
              localObject1 = bdbt.a(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app, (String)localObject1);
              if (localObject1 != null) {
                ((Intent)localObject2).putExtra("uinname", (String)localObject1);
              }
              localObject1 = aekt.a((Intent)localObject2, new int[] { 2 });
              this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.startActivity((Intent)localObject1);
            }
          }
          else {
        ...
        else if (alnx.class.getSimpleName().equals(this.jdField_c_of_type_JavaLangString))
        {
          ...
          alnx.a(this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity, (String)localObject1, (String)localObject2, str);
        }
      }
    }
  }
