  ...
  implements bidf
{
  ...
  public bidu(VipDownloadInterface paramVipDownloadInterface, String paramString)
  {
    bhzm.b(paramVipDownloadInterface.jdField_a_of_type_JavaLangString, "new  JsCheckUpdateCallback");
  ...
  public void onException(String paramString)
  {
    ...
    bhzm.e(this.jdField_a_of_type_ComTencentOpenExportJsVipDownloadInterface.jdField_a_of_type_JavaLangString, "JsCheckUpdateCallback onException >>> " + paramString);
  ...
  public void onResult(ArrayList<ApkUpdateDetail> paramArrayList)
  {
    ...
    bhzm.a(this.jdField_a_of_type_ComTencentOpenExportJsVipDownloadInterface.jdField_a_of_type_JavaLangString, "JsCheckUpdateCallback onResult >>> " + paramArrayList.size());
    ...
    bhzm.b(this.jdField_a_of_type_ComTencentOpenExportJsVipDownloadInterface.jdField_a_of_type_JavaLangString, ">>checkUpdate jsUrl:" + paramArrayList);
