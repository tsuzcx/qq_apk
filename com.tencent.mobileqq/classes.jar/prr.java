...
import com.tencent.biz.pubaccount.readinjoy.decoupling.uilayer.push.RIJMergeKanDianMessage.1;
import com.tencent.biz.pubaccount.readinjoy.decoupling.uilayer.push.RIJMergeKanDianMessage.2;
...
public class prr
{
      ...
      try
      {
        ...
        else
        {
          ...
          if (((Iterator)localObject2).hasNext())
          {
            ...
            if ((((RecentUserBaseData)localObject3).mUser == null) || (((RecentUserBaseData)localObject3).mUser.getType() != 1008) || (!uot.b(paramQQAppInterface, ((RecentUserBaseData)localObject3).mUser.uin))) {
              continue;
            }
  ...
  public static String a(int paramInt)
  {
    ...
    int j = Math.max(10, pnk.a);
    if (localObject == null) {
      return "";
    }
    List localList = a();
    StringBuilder localStringBuilder = new StringBuilder(pnk.a + ":");
    ...
    for (;;)
    {
      acmw localacmw = ((QQAppInterface)localObject).getConversationFacade();
      j = 0;
      if (j < i)
      {
        ...
        if (localObject != null)
        {
          ...
          {
            k = localacmw.a(localRecentUserBaseData.getRecentUserUin(), localRecentUserBaseData.mUser.getType());
    ...
    for (;;)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if (localObject2 != null)
        {
          ...
          if ((((RecentUserBaseData)localObject2).mUser != null) && (((RecentUserBaseData)localObject2).mUser.getType() == 1008) && (uot.b(localException, ((RecentUserBaseData)localObject2).mUser.uin))) {
  ...
  public static void a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    } while ((localObject == null) || (((acmw)localObject).a(paramString, 1008) <= 0));
  ...
  public static int b()
  {
    ...
    try
    {
      ...
      k = Math.min(localException.size(), pnk.a);
    }
    catch (Exception localException)
    {
  ...
  public static boolean b(QQAppInterface paramQQAppInterface)
  {
    ...
    try
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        {
          localObject2 = (RecentUserBaseData)localObject2;
          if ((((RecentUserBaseData)localObject2).mUser != null) && (((RecentUserBaseData)localObject2).mUser.getType() == 1008) && (uot.b(paramQQAppInterface, ((RecentUserBaseData)localObject2).mUser.uin)))
          {
            ((Iterator)localObject1).remove();
            continue;
            return false;
  ...
  public static boolean c(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      if (((SplashActivity)localObject).a() != MainFragment.b)
      {
    ...
    localObject = bmhv.a(paramQQAppInterface);
