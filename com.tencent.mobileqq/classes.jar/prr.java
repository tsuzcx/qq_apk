...
public class prr
  implements bhuq
{
  public prr(ReadInJoySelfFragment paramReadInJoySelfFragment) {}
    ...
    do
    {
      ...
      if (paramInt1 >= ReadInJoySelfFragment.a(this.a))
      {
        ...
        for (float f = 1.0F;; f = paramInt1 * 0.33F / ReadInJoySelfFragment.a(this.a))
        {
          ...
          ReadInJoySelfFragment.a(this.a).setBackgroundResource(2130842933);
      ...
      ReadInJoySelfFragment.a(this.a).setBackgroundResource(2130842934);
