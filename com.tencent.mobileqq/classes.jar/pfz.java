  ...
  implements phs
{
  ...
  public JSONObject a(int paramInt, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    qbi localqbi2 = paramBaseArticleInfo.mKdLiveInfo;
    qbi localqbi1 = localBaseArticleInfo.mKdLiveInfo;
    String str2 = " ";
    String str1 = str2;
    ...
    localJSONObject.put("left_live_status_bg_url", localqbi2.a);
    if (!TextUtils.isEmpty(localqbi2.b)) {
      localJSONObject.put("left_live_status_icon_url", localqbi2.b);
    }
    localJSONObject.put("left_live_status_text", localqbi2.c);
    if (!TextUtils.isEmpty(localqbi2.d)) {
      localJSONObject.put("left_live_hot_icon_url", localqbi2.d);
    }
    localJSONObject.put("left_live_hot_text", localqbi2.e);
    str2 = " ";
    str1 = str2;
    ...
    for (str1 = str1 + "...";; str1 = localBaseArticleInfo.mSubscribeName)
    {
      ...
      localJSONObject.put("right_live_status_bg_url", localqbi1.a);
      if (!TextUtils.isEmpty(localqbi1.b)) {
        localJSONObject.put("right_live_status_icon_url", localqbi1.b);
      }
      localJSONObject.put("right_live_status_text", localqbi1.c);
      if (!TextUtils.isEmpty(localqbi1.d)) {
        localJSONObject.put("right_live_hot_icon_url", localqbi1.d);
      }
      localJSONObject.put("right_live_hot_text", localqbi1.e);
