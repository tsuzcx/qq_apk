...
public class bhol
{
  ...
  public static final int[] g = { 107, 2130843628, 2130843628, 2131307100 };
  public static final int[] h = { 112, 2130843632, 2130843632, 2131307103 };
  ...
  static
  {
    jdField_a_of_type_ArrayOfInt = new int[] { 108, 2130848367, 2130848367, 2131307097 };
    jdField_b_of_type_ArrayOfInt = new int[] { 101, 2130848368, 2130848368, 2131307098 };
    jdField_c_of_type_ArrayOfInt = new int[] { 102, 2130848370, 2130848370, 2131307102 };
    jdField_d_of_type_ArrayOfInt = new int[] { 103, 2130848371, 2130848371, 2131307101 };
    jdField_e_of_type_ArrayOfInt = new int[] { 104, 2130848369, 2130848369, 2131307099 };
    jdField_f_of_type_ArrayOfInt = new int[] { 105, 2130848366, 2130848366, 2131307096 };
  }
  
  public bhol(int paramInt)
  {
  ...
  public ProviderView a(Context paramContext, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_e_of_type_Boolean)
      {
        ...
        ((ProviderView)localObject1).setId(2131298326);
        continue;
        localObject1 = localObject2;
        if (this.jdField_c_of_type_Boolean)
        {
          localObject1 = new QIMFilterProviderView(paramContext);
          ((ProviderView)localObject1).setId(2131298328);
          continue;
          localObject1 = new StaticStickerProviderView(paramContext);
          ((ProviderView)localObject1).setId(2131298337);
          continue;
          ...
          if (this.jdField_f_of_type_Boolean)
          {
            ...
            ((ProviderView)localObject1).setId(2131298336);
            continue;
            localObject1 = localObject2;
