...
public class bnvs
{
  ...
  public bnvs(Activity paramActivity, View paramView, int paramInt)
  {
    this.jdField_a_of_type_JavaLangString = "";
    this.jdField_b_of_type_JavaLangString = "";
    this.jdField_a_of_type_Bnwp = new bnvt(this);
  ...
  public void a(TianShuAccess.AdItem paramAdItem, int paramInt)
  {
    ...
    localbnwr.jdField_e_of_type_JavaLangString = "tianshu.99";
    localbnwr.jdField_f_of_type_JavaLangString = "tianshu.99";
    localbnwr.g = (i + "");
    localbnwr.h = "";
  ...
  public void b()
  {
    if (!TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
      try
      {
        ...
        localURLDrawable.setURLDrawableListener(new bnvu(this));
