  ...
  extends URLDrawableParams
{
  ...
  public bdht(Application paramApplication)
  {
  ...
  public ProtocolDownloader doGetDownloader(String paramString, Object paramObject)
  {
    ...
    if ("pubaccountimage".equals(paramString)) {
      return new usq(BaseApplicationImpl.getApplication());
    }
    ...
    if (("file".equals(paramString)) && (BaseApplicationImpl.sApplication.getQQProcessName().endsWith(":peak"))) {
      return new ahuc(BaseApplicationImpl.getApplication());
    }
    ...
    if ("redtouchpicdownloadprotoc".equals(paramString)) {
      return new bbbs(BaseApplicationImpl.getApplication());
    }
    ...
    if ("pubaccountimage_gifplaytime".equals(paramString)) {
      return new urq(BaseApplicationImpl.getApplication());
    }
  ...
  public Drawable getDefaultLoadingDrawable()
  {
    try
    {
      Drawable localDrawable = BaseApplicationImpl.getApplication().getResources().getDrawable(2130838108);
  ...
  public Drawable getDefualtFailedDrawable()
  {
    try
    {
      Drawable localDrawable = BaseApplicationImpl.getApplication().getResources().getDrawable(2130838111);
      return localDrawable;
    }
    catch (Throwable localThrowable) {}
    return new ColorDrawable(0);
