  ...
  implements View.OnClickListener
{
  ...
  public azga(Context paramContext, ExtendGridView paramExtendGridView)
  {
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_Int = 9;
    this.jdField_a_of_type_AndroidViewLayoutInflater = LayoutInflater.from(paramContext);
    this.jdField_a_of_type_ComTencentMobileqqTroopActivityExtendGridView = paramExtendGridView;
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = paramContext.getResources().getDrawable(2130846920);
    this.jdField_a_of_type_JavaLangCharSequence = BaseApplication.getContext().getText(2131696533);
    this.jdField_b_of_type_JavaLangCharSequence = BaseApplication.getContext().getResources().getText(2131718297);
  ...
  {
    int i = (int)bbdh.a(paramContext, 60.0F);
    int j = (int)bbdh.a(paramContext, 5.0F);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      localazgb = new azgb();
      localazgb.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localView.findViewById(2131378713));
      localazgb.b = ((ImageView)localView.findViewById(2131367975));
      localazgb.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131375524));
      localView.setTag(localazgb);
      ...
      localazgb.jdField_a_of_type_ComTencentImageURLImageView.setScaleType(ImageView.ScaleType.FIT_XY);
      localazgb.jdField_a_of_type_ComTencentImageURLImageView.setImageResource(2130841988);
      localazgb.jdField_a_of_type_ComTencentImageURLImageView.setContentDescription(this.jdField_a_of_type_JavaLangCharSequence);
      localazgb.b.setVisibility(8);
    }
    label245:
    String str;
    label260:
    do
    {
      ...
      return localView;
      localazgb = (azgb)paramView.getTag();
      localView = paramView;
      break;
      paramView.width = i;
      paramView.height = i;
    ...
    if (i < 0)
    {
      ...
      label306:
      i = Math.min(100, i);
      localazgb.jdField_a_of_type_ComTencentImageURLImageView.setAdjustViewBounds(false);
    ...
    for (;;)
    {
      ...
      localazgb.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable(paramView);
      localazgb.jdField_a_of_type_ComTencentImageURLImageView.setContentDescription(this.jdField_b_of_type_JavaLangCharSequence);
      localazgb.b.setVisibility(0);
      localazgb.b.setTag(Integer.valueOf(paramInt));
      localazgb.b.setOnClickListener(this);
      localazgb.jdField_a_of_type_AndroidWidgetImageView.setImageBitmap(this.jdField_a_of_type_AndroidGraphicsBitmap);
      break;
      j = i;
      break label288;
      label469:
