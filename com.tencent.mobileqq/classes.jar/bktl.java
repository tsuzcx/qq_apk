  ...
  extends SSOAccountObserver
{
  ...
  public void onFailed(String paramString, int paramInt1, int paramInt2, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      bjvn.a().a("agent_login", this.a.jdField_a_of_type_Long, 0L, 0L, i, Long.parseLong(paramString), "1000069", "ret: " + paramInt2 + " | error: " + str);
      label72:
      ...
      for (;;)
      {
        ...
        QLog.d("Login", 1, "rec | cmd:  | uin : *" + bjqq.a(paramString) + " | ret : " + paramInt2 + " - error: " + str + " | code: " + paramInt1);
        return;
        localMessage.what = 2;
        ...
        for (;;)
        {
          ...
          break;
          localBundle.putString("OTHER_ERROR", this.a.getResources().getString(2131694160));
        }
        label322:
  ...
  public void onGetTicketNoPasswd(String paramString, byte[] paramArrayOfByte, int paramInt, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      QLog.d("Login", 1, "rec | cmd: g_t_n_p | uin : *" + bjqq.a(paramString) + " | ret : success | code: " + paramInt);
      try
      {
        paramBundle = bjvn.a();
  ...
  public void onLoginSuccess(String paramString, byte[] paramArrayOfByte, int paramInt, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      this.a.a(paramString, paramArrayOfByte, paramBundle);
      paramInt = paramBundle.getInt("code");
      QLog.d("Login", 1, "rec | cmd: s_s_o_l | uin : *" + bjqq.a(paramString) + " | ret : success | code: " + paramInt);
      try
      {
        paramBundle = bjvn.a();
        long l2 = this.a.jdField_a_of_type_Long;
  ...
  public void onUserCancel(String paramString, int paramInt, Bundle paramBundle)
  {
    ...
    this.a.d();
    paramInt = paramBundle.getInt("code");
    QLog.d("Login", 1, "rec | cmd:  | uin : *" + bjqq.a(paramString) + " | ret : on_user_cancel | code: " + paramInt);
  }
}
