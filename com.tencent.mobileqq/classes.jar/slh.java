  ...
  implements sll
{
  ...
  public slh(Activity paramActivity)
  {
  ...
  private static void b(boolean paramBoolean, int paramInt, KandianMsgBoxRedPntInfo paramKandianMsgBoxRedPntInfo)
  {
    ...
    for (;;)
    {
      try
      {
        localpaa.k(1037);
        localpaa.a(0);
        localpaa.a("message_type", String.valueOf(paramKandianMsgBoxRedPntInfo.messageType));
        localpaa.a("feedsid", String.valueOf(paramKandianMsgBoxRedPntInfo.feedsID));
        localpaa.a("feedstype", String.valueOf(paramKandianMsgBoxRedPntInfo.feedsType));
        if (paramKandianMsgBoxRedPntInfo.mMsgType == 2)
        {
          localpaa.a("sys_msg_id", String.valueOf(paramKandianMsgBoxRedPntInfo.sysMsgID));
          localpaa.a("sys_msg_from", String.valueOf(paramKandianMsgBoxRedPntInfo.sysMsgFrom));
        }
        localpaa.a("reddot_num", String.valueOf(paramKandianMsgBoxRedPntInfo.mMsgCnt));
        localpaa.b("msgbox1000000000");
        if (paramBoolean) {
          break label220;
        }
        localpaa.a("behavior_type", String.valueOf(paramInt));
      }
      ...
      ocd.a(null, "CliOper", "", String.valueOf(paramKandianMsgBoxRedPntInfo.mUin), str, str, 0, 0, String.valueOf(paramKandianMsgBoxRedPntInfo.mUin), "", "", localpaa.a(), false);
      return;
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setOnClickListener(new sli(this));
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (TextUtils.isEmpty((CharSequence)localObject2)) {
          localObject1 = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131693838);
        }
        localJSONObject.put("msgbox_redpoint_content", new begp(bcsa.b((String)localObject1), 7, 17));
        ...
        localJSONObject.put("msgbox_redpoint_count", String.format(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131693839), new Object[] { bnrf.b(paramKandianMsgBoxRedPntInfo.mMsgCnt) }));
        ...
        {
          localTemplateBean = ProteusParser.getTemplateBean(suz.a("default_feeds", true), localJSONObject);
        }
