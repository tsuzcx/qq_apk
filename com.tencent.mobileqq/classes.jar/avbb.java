...
public class avbb
  ...
  implements Handler.Callback, bmqs
{
  ...
  public avbb(Context paramContext, QQAppInterface paramQQAppInterface, QQGamePubAccountFragment paramQQGamePubAccountFragment)
  {
  ...
  public void a()
  {
    RelativeLayout localRelativeLayout = (RelativeLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559238, null, false);
    localRelativeLayout.setLayoutParams(new RecyclerView.LayoutParams(-1, 0));
    this.jdField_a_of_type_Avbs = new avbs(localRelativeLayout, this.jdField_a_of_type_AndroidContentContext);
  ...
  public void a(String paramString1, String paramString2, String paramString3, JSONObject paramJSONObject, String paramString4)
  {
    ...
    Object localObject = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131559246, null);
    ...
    ((ImageView)((View)localObject).findViewById(2131368756)).setImageDrawable(URLDrawable.getDrawable("https://cmshow.gtimg.cn/client/gameCenter/gameCenter_popView_card@2x.png"));
    TextView localTextView1 = (TextView)((View)localObject).findViewById(2131380229);
    if ((!TextUtils.isEmpty(paramString2)) && (!TextUtils.isEmpty(paramString3)))
    {
      localTextView1.setText(paramString2);
      localTextView1.setTextColor(aver.a(-16733441, 1593879295));
      ((ImageView)((View)localObject).findViewById(2131361947)).setImageDrawable(URLDrawable.getDrawable("https://cmshow.gtimg.cn/client/gameCenter/gameCenter_arrow@2x.png"));
      paramString2 = (CheckBox)((View)localObject).findViewById(2131364602);
      TextView localTextView2 = (TextView)((View)localObject).findViewById(2131379833);
      TextView localTextView3 = (TextView)((View)localObject).findViewById(2131379993);
      localTextView3.setTextColor(aver.a(-16733441, 1593879295));
      ...
      paramString2.setOnCheckedChangeListener(new avbe(this, paramString1));
      localTextView2.setOnClickListener(new avbf(this, paramString4));
      localTextView1.setOnClickListener(new avbg(this, paramString4, paramString3));
      localTextView3.setOnClickListener(new avbh(this, paramString4, paramJSONObject, (String)localObject));
      this.jdField_a_of_type_AndroidAppDialog.show();
      paramString1 = new HashMap();
      abuf.a(paramString1, paramString4);
    ...
    for (;;)
    {
      ...
      abuf.a(amwn.a(), "769", "205710", a().gameAppId, "76905", "1", "160", paramString1);
      return;
      localTextView1.setText(anvx.a(2131709777));
      break;
      label410:
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean1)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setText(anvx.a(2131709761));
      return;
    }
    if (paramBoolean2)
    {
    ...
    this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
    this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
    this.jdField_b_of_type_AndroidWidgetTextView.setText(anvx.a(2131709763));
  }
  ...
  public void b()
  {
    if (this.jdField_b_of_type_AndroidWidgetLinearLayout == null)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setText(anvx.a(2131709764));
      ...
      ((URLDrawable.URLDrawableOptions)localObject1).mFailedDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130847183);
      ((URLDrawable.URLDrawableOptions)localObject1).mLoadingDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130847183);
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setText(anvx.a(2131709754));
      ...
      this.jdField_c_of_type_AndroidWidgetTextView.setText(anvx.a(2131709779));
    ...
    this.jdField_b_of_type_AndroidWidgetImageView.clearAnimation();
    this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
    this.jdField_b_of_type_AndroidWidgetTextView.setText(anvx.a(2131709771));
  ...
  {
    bmqt.a().b(this);
    if (this.jdField_a_of_type_Bmqi != null) {
      bmqk.b(this.jdField_a_of_type_Bmqi);
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.arg1 == 0)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setText(anvx.a(2131709772));
      return false;
    }
    this.jdField_a_of_type_AndroidWidgetImageView.clearAnimation();
  ...
  {
    if (a(paramInt)) {
      if ((paramViewHolder instanceof avbs)) {
        ((avbs)paramViewHolder).a(this.jdField_a_of_type_ComTencentMobileqqGamecenterDataFeedsItemData$TopCardInfo, this);
      }
    }
    do
    {
      do
      {
        do
        {
          do
          {
            ...
            if ((!(paramViewHolder instanceof avbk)) && (!(paramViewHolder instanceof avbi))) {
              break;
            }
          ...
          {
            localObject2 = (avbk)paramViewHolder;
            ((avbk)localObject2).a(this, (FeedsItemData)localObject1, paramInt);
            ((avbk)localObject2).d.setTag(a().gameAppId);
            localObject2 = new HashMap();
            abuf.a((Map)localObject2, ((FeedsItemData)localObject1).msgId);
            ...
            {
              abuf.a(amwn.a(), "769", "205021", (String)localObject1, "76902", "1", "160", (Map)localObject2);
              break;
            }
          }
        } while (((FeedsItemData)localObject1).type != 4);
        ((avbi)paramViewHolder).a(this, (FeedsItemData)localObject1, paramInt);
        localObject2 = new HashMap();
        abuf.a((Map)localObject2, ((FeedsItemData)localObject1).msgId);
        ((Map)localObject2).put(Integer.valueOf(2), ((FeedsItemData)localObject1).msgId);
        ((Map)localObject2).put(Integer.valueOf(4), "8");
      ...
      } while (!(paramViewHolder instanceof avch));
      localObject1 = a(paramInt);
    } while (localObject1 == null);
    ((avch)paramViewHolder).a((FeedsItemData)localObject1);
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    if (this.jdField_a_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt) != null)
    {
      if (paramInt == this.jdField_a_of_type_Int) {
        return this.jdField_a_of_type_Avbs;
      }
      return new avbc(this, (View)this.jdField_a_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt));
    }
    if (this.jdField_b_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt) != null) {
      return new avbd(this, (View)this.jdField_b_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt));
    }
    if (paramInt == 4)
    {
      ...
      ((TextView)localObject3).setId(2131379001);
      ...
      ((TextView)localObject4).setId(2131363087);
      ...
      localLayoutParams2.addRule(3, 2131379001);
      ((RelativeLayout)localObject2).addView((View)localObject4, localLayoutParams2);
      localObject4 = new TextView(this.jdField_a_of_type_AndroidContentContext);
      ((TextView)localObject4).setTextColor(-6052957);
      ((TextView)localObject4).setTextSize(12.0F);
      ((TextView)localObject4).setMaxLines(1);
      ((TextView)localObject4).setId(2131372158);
      ((TextView)localObject4).setEllipsize(TextUtils.TruncateAt.END);
      ...
      localLayoutParams2.addRule(6, 2131363087);
      localLayoutParams2.addRule(1, 2131363087);
      ((RelativeLayout)localObject2).addView((View)localObject4, localLayoutParams2);
      localObject4 = new TextView(this.jdField_a_of_type_AndroidContentContext);
      ((TextView)localObject4).setTextColor(-6052957);
      ((TextView)localObject4).setTextSize(10.0F);
      ((TextView)localObject4).setMaxLines(1);
      ((TextView)localObject4).setId(2131367540);
      ...
      ((RelativeLayout.LayoutParams)localObject3).addRule(6, 2131363087);
      ...
      ((CornerImageView)localObject2).setId(2131368633);
      ...
      ((ImageView)localObject1).setId(2131365759);
      ...
      paramViewGroup.addView((View)localObject1, localLayoutParams1);
      return new avbi(paramViewGroup);
    }
    if ((paramInt == 5) || (paramInt == 7) || (paramInt == 6)) {
      return avcm.a(this.jdField_a_of_type_AndroidContentContext, paramInt, paramViewGroup);
    }
    return new avbk(LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559237, paramViewGroup, false));
  }
  
  public void onViewDetachedFromWindow(RecyclerView.ViewHolder paramViewHolder)
  {
    super.onViewDetachedFromWindow(paramViewHolder);
    if ((paramViewHolder instanceof avbk))
    {
      paramViewHolder = (avbk)paramViewHolder;
      if ((paramViewHolder.a != null) && (avdj.a().a() == paramViewHolder.a))
      {
