  ...
  extends aydh
{
  ...
  String b()
  {
    ...
    {
      localObject = new ayeb();
      ((ayeb)localObject).jdField_b_of_type_Int = this.jdField_b_of_type_Int;
      ((ayeb)localObject).d = this.d;
      ((ayeb)localObject).jdField_a_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
      ((ayeb)localObject).f = this.f;
      localObject = URLDrawableHelper.getURL((ayeb)localObject, n, null);
      if (localObject == null) {
        break label129;
      }
