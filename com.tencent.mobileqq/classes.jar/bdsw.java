  ...
  implements IEventReceiver
{
  ...
  public bdsw(MiniAppActivity paramMiniAppActivity, String paramString, int paramInt)
  {
  ...
  private String a(String paramString)
  {
    ...
    try
    {
      paramString = new JSONObject(bbdj.b(paramString)).optString("version");
      return paramString;
    }
  ...
  private void a(int paramInt)
  {
    ...
    localasit.jdField_a_of_type_Int = 4;
    localasit.jdField_a_of_type_Asiu = this.jdField_a_of_type_Asiu;
  ...
  private boolean a(boolean paramBoolean, String paramString)
  {
    ...
    do
    {
      ...
      bbdj.b(str2);
      paramBoolean = bool;
    } while (bbdj.a(str1, str2, false) < 0);
    return bbdj.d(a(paramString, "", "libsconfig.json"), a(this.jdField_a_of_type_ComTencentMobileqqMiniappUiMiniAppActivity, "qgamelibs", "libsconfig.json"));
  }
  
  private String[] a()
  {
    String str3 = this.jdField_a_of_type_Asiu.a.getString("unzipped_path");
    String str2 = a(this.jdField_a_of_type_ComTencentMobileqqMiniappUiMiniAppActivity, "qgamelibs", "ejecta.js");
    String str1 = null;
    if (!TextUtils.isEmpty(str3)) {
      str1 = a(str3, this.jdField_a_of_type_Asiu.h, "index.js");
    }
  ...
  private boolean b()
  {
    ...
    if (!jdField_a_of_type_Boolean)
    {
      ...
      {
        return false;
        localObject = ((File)localObject).listFiles(new bdsx(this));
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_Bdsy = new bdsy(this);
      ste.a().registerSubscriber(this.jdField_a_of_type_Bdsy);
      asis localasis = asiz.a().a("ak:3214");
      if (localasis != null) {
        localasis.a("ak:3214", "QGameApp", this.jdField_a_of_type_Asiu.h);
      }
    }
  }
  ...
  {
    super.c();
    if (this.jdField_a_of_type_Bdsy != null) {
      ste.a().unRegisterSubscriber(this.jdField_a_of_type_Bdsy);
    }
  }
