  ...
  extends PopupWindow
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new asjm(this);
  private ImageView jdField_a_of_type_AndroidWidgetImageView;
  private TextView jdField_a_of_type_AndroidWidgetTextView;
  private asjn jdField_a_of_type_Asjn;
  private String jdField_a_of_type_JavaLangString;
  
  public asjl(Context paramContext, int paramInt1, int paramInt2)
  {
    super(paramContext);
    ...
    View localView = LayoutInflater.from(paramContext).inflate(2131493828, null);
  ...
  {
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131312688));
    this.jdField_a_of_type_AndroidWidgetTextView.getTextSize();
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131297969));
    RelativeLayout.LayoutParams localLayoutParams = (RelativeLayout.LayoutParams)paramView.findViewById(2131302409).getLayoutParams();
    ...
    for (;;)
    {
      ...
      setBackgroundDrawable(paramContext.getResources().getDrawable(2130849314));
      return;
  ...
  public void a(asjn paramasjn)
  {
    this.jdField_a_of_type_Asjn = paramasjn;
  }
