  ...
  extends ReplacementSpan
{
  ...
  private TextPaint a(Paint paramPaint)
  {
    ...
    paramPaint.setTextSize(bbll.d(9.0F));
    return paramPaint;
  }
  ...
  public void draw(@NotNull Canvas paramCanvas, CharSequence paramCharSequence, int paramInt1, int paramInt2, float paramFloat, int paramInt3, int paramInt4, int paramInt5, @NotNull Paint paramPaint)
  {
    ...
    paramPaint.setTextSize(bbll.b(9.0F));
    ...
    oif.a(paramCanvas, paramPaint, (int)a(paramPaint, paramCharSequence, paramInt1, paramInt2), i, bbll.b(1.0F), bbll.b(1.0F), bbll.b(1.0F), bbll.b(1.0F), bbll.b(1.0F), paramFloat, paramInt4 - i);
  }
