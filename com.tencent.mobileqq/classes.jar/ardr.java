...
public class ardr
  implements adih
{
  private static final String jdField_a_of_type_JavaLangString = ardr.class.getSimpleName();
  ...
  public ardr(BaseChatPie paramBaseChatPie)
  {
  ...
  private ardv a()
  {
    if (this.jdField_a_of_type_Ardv == null)
    {
      ...
      if ((localManager instanceof ardv)) {
        this.jdField_a_of_type_Ardv = ((ardv)localManager);
      }
    }
    return this.jdField_a_of_type_Ardv;
  }
  
  private boolean a()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null) && ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aequ))) {
      return c();
    }
    return b();
  }
  ...
  private void b(int paramInt)
  {
    ...
    try
    {
      ...
      ardq localardq = (ardq)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(150);
      if (localardq != null) {
        localardq.a(paramInt, l);
      }
      return;
    }
  ...
  private boolean b()
  {
    try
    {
      ...
      if (localardp != null)
      {
        boolean bool = localardp.jdField_a_of_type_Boolean;
        return bool;
      }
    }
    catch (Exception localException)
  ...
  private boolean c()
  {
    try
    {
      ...
      if (localardp != null)
      {
        boolean bool = localardp.jdField_b_of_type_Boolean;
        return bool;
      }
    }
    catch (Exception localException)
  ...
  public void a(int paramInt)
  {
    ...
    case 6: 
      do
      {
        ...
        if (this.jdField_a_of_type_Ardu == null) {
          this.jdField_a_of_type_Ardu = new ardt(this, null);
        }
        this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Ardu);
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Ardu);
    }
    if (this.jdField_a_of_type_AndroidOsHandler != null)
    {
