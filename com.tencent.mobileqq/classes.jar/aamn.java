...
public class aamn
{
  ...
  {
    return ImageLoader.getInstance().loadImage(paramString, new aamo(this, paramView));
  }
  ...
  private AnimationSet a()
  {
    ...
    localScaleAnimation.setAnimationListener(new aamp(this));
  ...
  private AnimationSet b()
  {
    ...
    localScaleAnimation.setAnimationListener(new aamq(this));
    localAnimationSet.addAnimation(localScaleAnimation);
    return localAnimationSet;
  }
  ...
  private AnimationSet c()
  {
    if (this.b != null)
    {
      ...
      localScaleAnimation.setAnimationListener(new aamr(this));
      localAnimationSet.addAnimation(localScaleAnimation);
  ...
  public void a(FrameLayout paramFrameLayout, View paramView, String paramString)
  {
    ...
    paramFrameLayout = aamv.a().a(paramString);
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131364242));
    ...
    this.b = ((ImageView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131381450));
