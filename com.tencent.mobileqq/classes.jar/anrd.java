...
public class anrd
{
  ...
  private anke jdField_a_of_type_Anke = new anre(this);
  ...
  public anrd(QQAppInterface paramQQAppInterface)
  {
  ...
  public int a()
  {
    ...
    if (aonc.a((ProxyManager)localObject2, "mr_dataline_printer")) {
  ...
  {
    if (!anjx.a(paramSession, "printer")) {}
    Object localObject;
    do
    {
      do
      {
        ...
        ((PrinterItemMsgRecord)localObject).time = bbyp.a();
  ...
  public void a(anjx paramanjx)
  {
    Object localObject = (antz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(10);
    if ((((antz)localObject).a() == 0) || (((antz)localObject).e() != 1))
    {
      paramanjx.a(12, false, null);
      if (this.jdField_a_of_type_JavaUtilHashMap.size() > 0)
      {
        localObject = new Timer();
        ((Timer)localObject).schedule(new PrinterHandler.1(this, paramanjx, (Timer)localObject), 5000L);
      }
    }
  }
  
  public void a(anjx paramanjx, msg_comm.Msg paramMsg, C2CType0x211_SubC2CType0x9.MsgBody paramMsgBody)
  {
    boolean bool = false;
    int j;
    int i;
    ...
    case 2: 
      do
      {
        ...
        paramMsg = (anrg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(74);
        paramMsg.a(false);
      ...
      if ((((antz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(10)).a() != 0) && (this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.size() > 0)) {
        paramMsg.a(true);
      }
      paramanjx.a(12, false, null);
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004022", "0X8004022", 0, 0, "", "", "", "");
      return;
    case 3: 
      j = -1;
    ...
    for (;;)
    {
      ...
      paramanjx.a(18, bool, Long.valueOf(l));
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004021", "0X8004021", (int)l, i, "", "", "", "");
      return;
      ...
      else
      {
        ...
        paramanjx.notifyUI(19, true, new Object[] { Long.valueOf(paramMsg.uint64_printer_din.get()), paramMsg.str_printer_qr_pic_url.get(), paramMsg.str_printer_qr_open_url.get(), paramMsg.str_printer_tip_url.get() });
        return;
      }
      label579:
      l = 0L;
  ...
  public void a(BaseActivity paramBaseActivity, String paramString)
  {
    if (atvo.a())
    {
      if (bgmg.a(paramString) > atgz.a())
      {
        atvb.a(paramBaseActivity, 2131692321, 2131692326, new anrf(this, paramBaseActivity, paramString));
        return;
      }
      ...
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004059", "0X8004059", 0, 0, "", "", "", "");
      return;
    }
  ...
  public void a(PrinterItemMsgRecord paramPrinterItemMsgRecord)
  {
    ...
    bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004021", "0X8004021", (int)paramPrinterItemMsgRecord.uSessionID, -2, "", "", "", "");
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().addMsgQueue(String.valueOf(0), 0, paramPrinterItemMsgRecord.getTableName(), "msgId=?", new String[] { String.valueOf(paramPrinterItemMsgRecord.msgId) }, 2, null);
  }
  ...
  public String[] a()
  {
    if ((((anrg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(74)).a()) && (this.b != null))
    {
