...
public class alyc
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajjy.a(2131636610);
  }
  ...
  public static im_msg_body.Elem a(MessageRecord paramMessageRecord)
  {
    ...
    do
    {
      ...
      localC2CConfessContext.uint64_confessor_uin.set(Long.parseLong(((alxz)localObject2).jdField_c_of_type_JavaLangString));
      localC2CConfessContext.uint64_confess_to_uin.set(Long.parseLong(((alxz)localObject2).jdField_b_of_type_JavaLangString));
      localC2CConfessContext.uint64_send_uin.set(Long.parseLong(paramMessageRecord.senderuin));
      localC2CConfessContext.bytes_confess.set(ByteStringMicro.copyFromUtf8(((alxz)localObject2).jdField_d_of_type_JavaLangString));
      localC2CConfessContext.bytes_confessor_nick.set(ByteStringMicro.copyFromUtf8(((alxz)localObject2).jdField_e_of_type_JavaLangString));
      localC2CConfessContext.uint64_confess_time.set(((alxz)localObject2).jdField_a_of_type_Long);
      localC2CConfessContext.uint32_bg_type.set(((alxz)localObject2).jdField_b_of_type_Int);
      localC2CConfessContext.uint32_topic_id.set(((alxz)localObject2).jdField_a_of_type_Int);
      localC2CConfessContext.uint32_confessor_sex.set(((alxz)localObject2).jdField_c_of_type_Int);
      localC2CConfessContext.uint32_confess_num.set(((alxz)localObject2).jdField_d_of_type_Int);
      localC2CConfessContext.uint32_biz_type.set(((alxz)localObject2).f);
      localC2CConfessContext.uint32_confess_to_sex.set(((alxz)localObject2).jdField_e_of_type_Int);
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if ((paramQQAppInterface != null) && (alxu.a(paramQQAppInterface, "redpoint_leba_show"))) {
      alxu.a(paramQQAppInterface, "redpoint_leba_show", 0L);
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt1, String paramString1, int paramInt2, String paramString2)
  {
    ...
    paramQQAppInterface = (alxy)paramQQAppInterface.getManager(269);
    ...
    {
      paramString1 = String.format("&topicId=%d&fromEncodeUin=%s&fromGender=%d&toUin=%s", new Object[] { Integer.valueOf(paramInt1), asfj.a(paramString1), Integer.valueOf(paramInt2), asfj.a(paramString2) });
  ...
  public static void a(QQAppInterface paramQQAppInterface, RecentItemConfessMsg paramRecentItemConfessMsg, boolean paramBoolean)
  {
    ...
    {
      return;
      if ((paramRecentItemConfessMsg.mType == 1032) && (TextUtils.equals(paramRecentItemConfessMsg.mUin, ajed.aM))) {
      ...
      while (QLog.isDevelopLevel())
      {
        ...
        if (paramBoolean) {
          paramQQAppInterface.a().a(ajed.aL, 1032, paramRecentItemConfessMsg.a(), paramQQAppInterface.getCurrentAccountUin(), paramRecentItemConfessMsg.mType, paramRecentItemConfessMsg.mConfessInfo.topicId);
        }
        if (i > 0) {
  ...
  {
    if ((paramInt2 <= 0) || (akbm.a(paramInt1) != 1032)) {
      if (QLog.isColorLevel()) {
    ...
    {
      return;
      localConfessInfo = ((alxy)paramQQAppInterface.getManager(269)).a().a(paramString, paramInt1, paramInt2);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2, ConfessInfo paramConfessInfo)
  {
    ...
    Object localObject1 = ((alxy)paramQQAppInterface.getManager(269)).b();
    int i;
    long l;
    if (localObject1 == null)
    {
      i = 24;
      Object localObject2 = String.format(alxu.jdField_d_of_type_JavaLangString, new Object[] { Integer.valueOf(i) });
      localObject1 = ajjy.a(2131636608);
      i = ((String)localObject2).indexOf((String)localObject1);
      int j = ((String)localObject1).length();
      localObject1 = new aqax(paramString, paramString, (String)localObject2, paramInt1, -5020, 655369, awao.a());
      ((aqax)localObject1).jdField_c_of_type_JavaLangString = ((String)localObject2);
      localObject2 = new Bundle();
      ((Bundle)localObject2).putInt("key_action", 31);
      ((aqax)localObject1).a(i, j + i, (Bundle)localObject2);
      ...
      paramString.initGrayTipMsg(paramQQAppInterface, (aqax)localObject1);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    aqax localaqax = new aqax(paramString1, paramString1, paramString2, paramInt1, -5040, 655377, awao.a());
    localaqax.jdField_c_of_type_JavaLangString = paramString2;
    String str = ajjy.a(2131636605);
    int i = paramString2.indexOf(str);
    int j = str.length();
    paramString2 = new Bundle();
    paramString2.putInt("key_action", 34);
    localaqax.a(i, j + i, paramString2);
    ...
    if ((paramString1 != null) && (!paramString1.isEmpty()))
    {
      ...
      paramString1.initGrayTipMsg(paramQQAppInterface, localaqax);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt1, int paramInt2, ConfessInfo paramConfessInfo)
  {
    if (QLog.isColorLevel())
    {
      localObject = azzz.a(paramString2);
      if (paramConfessInfo != null) {
        break label75;
      }
    }
    ...
    Object localObject = new aqax(paramString1, paramString1, paramString2, paramInt1, -5020, 655376, awao.a());
    ((aqax)localObject).jdField_c_of_type_JavaLangString = paramString2;
    paramString1 = paramQQAppInterface.a().a(paramString1, paramInt1);
    long l;
    if ((paramString1 != null) && (!paramString1.isEmpty()))
    {
      l = ((ChatMessage)paramString1.get(paramString1.size() - 1)).shmsgseq;
      paramString1 = new MessageForUniteGrayTip();
      paramString1.initGrayTipMsg(paramQQAppInterface, (aqax)localObject);
      paramString1.isread = true;
      paramString1.shmsgseq = l;
      paramString1.mNeedTimeStamp = true;
      paramString1.updateUniteGrayTipMsgData(paramQQAppInterface);
  ...
  public static void a(QQAppInterface paramQQAppInterface, List<MessageRecord> paramList)
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      if ((localMessageRecord.isSend()) || (akbm.a(localMessageRecord.istroop) != 1032) || (!a(localMessageRecord))) {
        break label429;
      }
      ...
      if (((MessageRecord)((List)localObject2).get(j)).getConfessTopicId() == localMessageRecord.getConfessTopicId())
      {
        ...
        if (i == 0)
        {
          ...
          {
            localObject2 = awbi.a(paramQQAppInterface, paramQQAppInterface.c(), localMessageRecord.senderuin, null, localMessageRecord.istroop, (byte)0, (byte)0, (short)0, (String)localObject1);
  ...
  {
    alxu.a(paramQQAppInterface, "redpoint_box_show", 0L);
    alxu.a(paramQQAppInterface, "redpoint_clear_time", awao.a());
  }
  ...
  {
    if ((paramMessageRecord != null) && (paramMessageRecord.istroop == 1032) && (ajed.aL.equals(paramMessageRecord.frienduin)))
    {
      if (QLog.isColorLevel()) {
  ...
  public static void a(msg_comm.Msg paramMsg, im_msg_body.Elem paramElem, List<MessageRecord> paramList, QQAppInterface paramQQAppInterface)
  {
      ...
      do
      {
        do
        {
          ...
          for (;;)
          {
            ...
            paramList = (alxy)paramQQAppInterface.getManager(269);
            if (paramList.a(paramElem, (String)localObject3, str1, i) != 1) {
              break;
            }
            localObject1 = new alxz();
            ((alxz)localObject1).jdField_a_of_type_Int = i;
            ((alxz)localObject1).jdField_b_of_type_Int = ((hummer_commelem.MsgElemInfo_servtype21.C2CConfessContext)localObject2).uint32_bg_type.get();
            ((alxz)localObject1).jdField_b_of_type_JavaLangString = ((String)localObject3);
            ((alxz)localObject1).jdField_c_of_type_JavaLangString = str1;
            ((alxz)localObject1).jdField_d_of_type_JavaLangString = ((hummer_commelem.MsgElemInfo_servtype21.C2CConfessContext)localObject2).bytes_confess.get().toStringUtf8();
            ((alxz)localObject1).jdField_e_of_type_JavaLangString = ((hummer_commelem.MsgElemInfo_servtype21.C2CConfessContext)localObject2).bytes_confessor_nick.get().toStringUtf8();
            ((alxz)localObject1).jdField_a_of_type_JavaLangString = paramQQAppInterface.getCurrentNickname();
            ...
            ((alxz)localObject1).jdField_c_of_type_Int = i;
            ...
            ((alxz)localObject1).jdField_a_of_type_Long = l1;
            ...
            ((alxz)localObject1).jdField_d_of_type_Int = i;
            ...
            ((alxz)localObject1).jdField_e_of_type_Int = i;
            l1 = ((msg_comm.MsgHead)paramMsg.msg_head.get()).msg_time.get() - 1L;
            l2 = ((msg_comm.MsgHead)paramMsg.msg_head.get()).msg_seq.get() - 1L;
            paramList.a(paramElem, (alxz)localObject1, l1, l2);
            if (!QLog.isColorLevel()) {
              break;
            }
            l3 = awao.a();
            QLog.i("ConfessMsgUtil", 2, "decodeConfessMsgElem strConfessorDesc:" + ((alxz)localObject1).jdField_d_of_type_JavaLangString + " msgTime:" + l1 + " msgSeq:" + l2 + " nowTime" + l3);
            return;
    ...
    Object localObject1 = (alxy)paramQQAppInterface.getManager(269);
    int k = ((alxy)localObject1).a(paramElem, paramList, str1, str2, j);
    if ((i == 0) && (k == 1))
    {
      localObject2 = new alya();
      ((alya)localObject2).jdField_a_of_type_JavaLangString = paramElem;
      ((alya)localObject2).jdField_a_of_type_Int = j;
      ((alya)localObject2).jdField_b_of_type_Int = (j % 4);
      ((alya)localObject2).jdField_d_of_type_JavaLangString = paramList;
      ((alya)localObject2).jdField_e_of_type_JavaLangString = str2;
      ...
      label1784:
      ((alya)localObject2).jdField_c_of_type_Int = i;
      ...
      if (TextUtils.isEmpty(paramList)) {
        if (((alya)localObject2).jdField_c_of_type_Int == 1)
        {
          paramList = ajjy.a(2131636606);
          label1837:
          ((alya)localObject2).g = paramList;
          label1843:
          ...
          label1866:
          ((alya)localObject2).jdField_c_of_type_JavaLangString = paramList;
          ...
          label1893:
          ((alya)localObject2).jdField_a_of_type_Long = l1;
    ...
    {
      ((alya)localObject2).jdField_d_of_type_Int = i;
      ((alya)localObject2).jdField_b_of_type_JavaLangString = str1;
      ...
      if ((l4 < l1 - 5L) && (l1 >= 0L))
      {
        ...
        ThreadManager.getSubThreadHandler().postDelayed(new ConfessMsgUtil.1((alxy)localObject1, paramElem, (alya)localObject2, l3, l4), 250L);
        return;
        paramList = ajjy.a(2131636609);
        break label1837;
        ((alya)localObject2).g = paramList;
        break label1843;
      }
      ((alxy)localObject1).a(paramElem, (alya)localObject2, l3, l3, l4);
      if (!QLog.isColorLevel()) {
        break;
      }
      l1 = awao.a();
      QLog.i("ConfessMsgUtil", 2, "decodeConfessMsgElem 2 strConfessorDesc:" + ((alya)localObject2).f + " msgTime:" + l3 + " msgSeq:" + l4 + " nowTime" + l1);
      return;
      if ((!paramMsg.msg_head.has()) || (!((msg_comm.MsgHead)paramMsg.msg_head.get()).msg_seq.has())) {
        break;
      }
      ((alxy)localObject1).a(paramElem, paramList, str1, str2, j, ((msg_comm.MsgHead)paramMsg.msg_head.get()).msg_seq.get());
      return;
      i = 0;
      paramElem = "";
      break label1558;
  ...
  {
    if ((akbm.a(paramInt1) == 1032) || (akbm.a(paramInt3) == 1032)) {}
  ...
  public static im_msg_body.Elem b(MessageRecord paramMessageRecord)
  {
    ...
    do
    {
      ...
      localGroupConfessContext.uint64_confessor_uin.set(Long.parseLong(((alya)localObject2).jdField_e_of_type_JavaLangString));
      localGroupConfessContext.uint64_confess_to_uin.set(Long.parseLong(((alya)localObject2).jdField_d_of_type_JavaLangString));
      localGroupConfessContext.uint64_send_uin.set(Long.parseLong(paramMessageRecord.senderuin));
      localGroupConfessContext.bytes_topic.set(ByteStringMicro.copyFromUtf8(((alya)localObject2).f));
      localGroupConfessContext.bytes_confess_to_nick.set(ByteStringMicro.copyFromUtf8(((alya)localObject2).jdField_c_of_type_JavaLangString));
      localGroupConfessContext.uint64_confess_time.set(((alya)localObject2).jdField_a_of_type_Long);
      localGroupConfessContext.uint32_topic_id.set(((alya)localObject2).jdField_a_of_type_Int);
      localGroupConfessContext.uint32_confessor_sex.set(((alya)localObject2).jdField_c_of_type_Int);
      localGroupConfessContext.uint32_confess_to_nick_type.set(((alya)localObject2).jdField_d_of_type_Int);
      localGroupConfessContext.bytes_confessor_nick.set(ByteStringMicro.copyFromUtf8(((alya)localObject2).g));
  ...
  public static void b(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, String paramString)
  {
    ...
    do
    {
      ...
      alya localalya = paramQQAppInterface.a();
      if (localalya != null)
      {
        paramMessageRecord.saveExtInfoToExtStr("ext_key_group_chat_confess_info", localalya.a());
        paramQQAppInterface.a(paramString, localalya.jdField_d_of_type_JavaLangString, localalya.jdField_b_of_type_JavaLangString, localalya.jdField_e_of_type_JavaLangString, localalya.jdField_a_of_type_Int);
      }
    } while (!QLog.isColorLevel());
  ...
  public static void b(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    {
      return;
      localObject = (atax)paramQQAppInterface.getManager(160);
      RedTouchItem localRedTouchItem = ((atax)localObject).a(10018);
      if ((paramBoolean) && (localRedTouchItem != null)) {
        localRedTouchItem.extMsgs = null;
      }
      ((atax)localObject).a(10018);
      localObject = ((alxy)paramQQAppInterface.getManager(269)).a();
      if ((localObject != null) && (((alyk)localObject).jdField_a_of_type_Int > 0)) {
        break;
      }
    } while (!QLog.isDevelopLevel());
    ...
    boolean bool2;
    if (localObject != null) {
      if (((alyk)localObject).jdField_a_of_type_Int != 0)
      {
        bool1 = true;
        ((alyk)localObject).jdField_a_of_type_Int = 0;
        bool2 = bool1;
        if (paramBoolean)
        {
          bool2 = bool1 | ((alyk)localObject).a();
          ((alyk)localObject).jdField_a_of_type_JavaLangString = "";
          ((alyk)localObject).jdField_c_of_type_JavaLangString = "";
          ((alyk)localObject).jdField_b_of_type_JavaLangString = "";
          ((alyk)localObject).jdField_b_of_type_Int = 0;
        }
        ThreadManager.post(new ConfessMsgUtil.2((alyk)localObject), 8, null, false);
      }
    }
    for (;;)
    {
      if (bool2) {
        ((alxv)paramQQAppInterface.a(125)).a((alyk)localObject);
      }
