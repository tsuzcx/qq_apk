...
public class swh
{
        ...
        else if (((String)localObject3).equals("url"))
        {
          ...
          catch (Exception localException)
          {
            for (;;)
            {
              ...
              {
                QLog.d(swh.class.getSimpleName(), 2, localException.getMessage(), localException);
                l1 = l2;
              }
            }
          }
  ...
  public static com.tencent.mobileqq.data.PAMessage a(String paramString)
  {
    ...
    //   120: astore 5
    //   122: aload 5
    //   124: invokestatic 37	swh:a	(Lorg/w3c/dom/Node;)Ljava/lang/String;
    //   127: astore 7
    //   129: aload 5
    ...
    //   248: aload 7
    //   250: invokestatic 365	swh:a	(Lorg/w3c/dom/Node;)Lcom/tencent/mobileqq/data/PAMessage$Item;
    //   253: astore 7
    //   255: aload_0
    ...
    //   322: astore 8
    //   324: aload 8
    //   326: invokestatic 37	swh:a	(Lorg/w3c/dom/Node;)Ljava/lang/String;
    //   329: astore 7
    //   331: aload 8
