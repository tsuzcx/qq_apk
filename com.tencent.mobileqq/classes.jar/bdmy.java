...
public class bdmy
{
  ...
  public static bdnc[] a;
  public static bdnc b;
  public static bdnc c;
  public static bdnc d;
  public static bdnc e;
  public static bdnc f;
  public static bdnc g;
  public static bdnc h;
  public static bdnc i;
  
  static
  {
    jdField_a_of_type_Bdnc = new bdnc("recommendEmotion.json", "https://i.gtimg.cn/qqshow/admindata/comdata/vipData_emoji_aioPanal/", "https://i.gtimg.cn/qqshow/admindata/comdata/vipData_emoji_aioPanal/xydata.json", "recommendEmotionVersion", "vipData_emoji_aio_recommend.json");
    b = new bdnc("IndividuationUrls.json", "", "https://i.gtimg.cn/qqshow/admindata/comdata/vipData_individuation_url/android.json", "individuationUrlJsonNewVersion", "vipData_individuation_url_json");
    c = new bdnc("Individuation.json", "https://i.gtimg.cn/qqshow/admindata/comdata/vipData_individuation/", "https://i.gtimg.cn/qqshow/admindata/comdata/vipData_individuation/xydata.json", "IndividuationVersion", "individ_json");
    d = new bdnc("EmoticonWording.json", "", "https://i.gtimg.cn/club/item/parcel/client_wording.json", "EmoticonWordingVersion", "wording_json");
    e = new bdnc("WebviewCrashReport.json", "", "https://i.gtimg.cn/qqshow/admindata/comdata/vip_crash_report/WebviewCrashReport.json", "WebviewCrashJSONVersion", "WebviewCrashReport.json");
    f = new bdnc("Qutu_xydata.json", "", "https://i.gtimg.cn/qqshow/admindata/comdata/vipQutu_release_zip/xydata.json", "QutuXYDataJsonVersion", "xydata.json");
    g = new bdnc("iRedPacket_v2.json", "https://i.gtimg.cn/qqshow/admindata/comdata/vipRedPacketDataV2/", "https://i.gtimg.cn/qqshow/admindata/comdata/vipRedPacketDataV2/xydata.mobile.v1.json", "vipRedPacketData_json_v2", "vipRedPacketData_json_v2");
    h = new bdnc("UrlIntercept.json", "https://i.gtimg.cn/qqshow/admindata/comdata/vipData_url_to_api", "https://i.gtimg.cn/qqshow/admindata/comdata/vipData_url_to_api/android.json", "UrlIntercept_json", "UrlIntercept_json");
    i = new bdnc("font_info.json", "https://i.gtimg.cn/qqshow/admindata/comdata/vipList_font_data", "https://i.gtimg.cn/qqshow/admindata/comdata/vipList_font_data/version.json", "FontInfoList_json", "FontInfoList_json");
    jdField_a_of_type_ArrayOfBdnc = new bdnc[] { jdField_a_of_type_Bdnc, c, d };
    jdField_a_of_type_JavaLangString = "https://i.gtimg.cn/xydata";
    jdField_a_of_type_JavaUtilHashMap = new HashMap();
    jdField_a_of_type_Bdvu = new bdmz();
  }
  ...
  public static JSONObject a(QQAppInterface paramQQAppInterface, bdnc parambdnc, boolean paramBoolean)
  {
    Object localObject = paramQQAppInterface.getApplication().getApplicationContext();
    String str = parambdnc.jdField_a_of_type_JavaLangString;
    localObject = new File(((Context)localObject).getFilesDir(), str);
    if (((File)localObject).exists()) {
      try
      {
        paramQQAppInterface = bdcs.a((File)localObject, -1);
    ...
    for (;;)
    {
      ...
      if (paramBoolean) {
        a(paramQQAppInterface, parambdnc);
      }
    }
  }
  ...
  public static void a(AppInterface paramAppInterface, bdnc parambdnc, String paramString, File paramFile, Bundle paramBundle)
  {
    if (paramFile == null) {}
    String str1;
    do
    {
      return;
      str1 = paramString;
    } while ((paramString == null) && (parambdnc == null));
    label427:
    label435:
    label441:
    label444:
    for (;;)
    {
      try
      {
        for (;;)
        {
          ...
          parambdnc = parambdnc.jdField_a_of_type_JavaLangString;
          ...
          String str3 = parambdnc + "_" + j;
          if (QLog.isColorLevel()) {
            QLog.d("ClubContentJsonTask", 2, "club_downloadFile,method:" + paramString + ",key:" + parambdnc + ", server version:" + j + ",ifromet:" + str2);
          }
          ...
          paramFile = new bdvv(str1, paramFile);
          paramFile.n = true;
          paramFile.jdField_a_of_type_JavaLangString = parambdnc;
          ((bdvx)paramAppInterface.getManager(47)).a(1).a(paramFile, jdField_a_of_type_Bdvu, paramBundle);
          if (QLog.isColorLevel()) {
          ...
          try
          {
            ...
            paramString.put("param_key", parambdnc);
            paramString.put("param_ifromet", str2);
            azmz.a(paramAppInterface.getApplication().getApplicationContext()).a(paramAppInterface.getAccount(), "VipClubContentJsonTaskLoad", true, 1L, 0L, paramString, "", false);
          }
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    int j = 0;
    while (j < jdField_a_of_type_ArrayOfBdnc.length)
    {
      a(paramQQAppInterface, jdField_a_of_type_ArrayOfBdnc[j]);
      j += 1;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, bdnc parambdnc)
  {
    int j = 10;
    int k = 0;
    if ((paramQQAppInterface == null) || (parambdnc == null)) {}
    do
    {
      return;
      File localFile = new File(paramQQAppInterface.getApplication().getApplicationContext().getFilesDir(), parambdnc.jdField_a_of_type_JavaLangString);
      if (!localFile.exists())
      {
        if (QLog.isColorLevel()) {
          QLog.d("ClubContentJsonTask", 2, "downloadIfNotExist, not exist: " + parambdnc.jdField_a_of_type_JavaLangString);
        }
        for (;;)
        {
          try
          ...
          ((Bundle)localObject).putString("version_key", parambdnc.d);
          ((Bundle)localObject).putString("method", "downloadIfNotExist");
          ((Bundle)localObject).putString("ifromet", "null1");
          a(paramQQAppInterface, parambdnc, apih.a("VIP_emosm", parambdnc.b), localFile, (Bundle)localObject);
          return;
  ...
  public static void a(QQAppInterface paramQQAppInterface, bdnc parambdnc, int paramInt, boolean paramBoolean)
  {
    File localFile = new File(paramQQAppInterface.getApplication().getApplicationContext().getFilesDir(), parambdnc.jdField_a_of_type_JavaLangString);
    Bundle localBundle = new Bundle();
    localBundle.putInt("version", paramInt);
    localBundle.putString("version_key", parambdnc.d);
    localBundle.putString("method", "updateJson");
    localBundle.putString("ifromet", String.valueOf(paramBoolean));
    a(paramQQAppInterface, parambdnc, null, localFile, localBundle);
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface)
  {
    ...
    //   24: new 473	bdna
    //   27: dup
    //   28: invokespecial 474	bdna:<init>	()V
    //   31: putstatic 476	bdmy:jdField_a_of_type_Bdna	Lbdna;
    //   34: aload 6
    //   36: ldc_w 478
    ...
    //   55: invokestatic 491	bdra:a	(Lmqq/app/AppRuntime;Ljava/lang/String;Ljava/lang/String;)Z
    //   58: pop
    //   59: aload 6
    //   61: ldc_w 493
    ...
    //   178: astore 5
    //   180: getstatic 476	bdmy:jdField_a_of_type_Bdna	Lbdna;
    //   183: aload 4
    //   185: putfield 516	bdna:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   188: getstatic 476	bdmy:jdField_a_of_type_Bdna	Lbdna;
    //   191: aload 5
    //   193: putfield 517	bdna:b	Ljava/lang/String;
    ...
    //   515: getstatic 595	afyl:a	Lcom/tencent/util/LRULinkedHashMap;
    //   518: astore 4
    //   520: aload 4
    //   522: monitorenter
    //   523: getstatic 595	afyl:a	Lcom/tencent/util/LRULinkedHashMap;
    //   526: invokevirtual 600	com/tencent/util/LRULinkedHashMap:clear	()V
    //   529: aload 4
    //   531: monitorexit
    //   532: aload_0
    //   533: invokestatic 605	bdkd:a	(Lcom/tencent/common/app/AppInterface;)V
    //   536: aload 6
    //   538: ldc_w 607
    ...
    //   625: putstatic 627	asnx:jdField_a_of_type_Int	I
    //   628: aload 6
    //   630: ldc_w 629
    ...
    //   715: aload_0
    //   716: ifnull -700 -> 16
    //   719: getstatic 660	bdnm:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   722: astore 4
    //   724: aload_0
    //   725: ldc_w 531
