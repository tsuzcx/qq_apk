  ...
  implements axbz
{
  ...
  public void a()
  {
    ...
    if ((this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie == null) && (this.a.jdField_a_of_type_AndroidAppActivity == null) && (!azfo.jdField_a_of_type_JavaLangString.equals(this.a.jdField_b_of_type_JavaLangString))) {}
    String str1;
    List localList;
    do
    {
    ...
    } while ((azkd.a(localList)) || (localList == null));
    if (localList != null) {}
    for (;;)
    {
      try
      {
        Object localObject3 = (azgc)localList.remove(0);
        if ((localObject3 instanceof MessageForDeliverGiftTips))
        {
          localObject3 = (MessageForDeliverGiftTips)localObject3;
          String str2 = azkd.b((MessageForDeliverGiftTips)localObject3);
          ...
          if (this.a.jdField_a_of_type_Azgd != null) {
            this.a.jdField_a_of_type_Azgd.a(str1, str2);
          }
        }
        if (localList.size() == 0) {
          break label250;
      ...
      break;
      label250:
      this.a.jdField_a_of_type_Azpw.a(null);
      azfo.a(this.a, false);
      ...
      if ((azfo.jdField_a_of_type_Boolean) && (localObject2 != null) && (-1 == ((Integer)localObject2).intValue()) && (this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null)) {
        azfo.jdField_a_of_type_Boolean = false;
      }
    }
  }
}
