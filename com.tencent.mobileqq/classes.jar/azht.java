...
public class azht
{
  ...
  public azht(@NonNull BaseActivity paramBaseActivity, @NonNull azhu paramazhu)
  {
  ...
  private Friends a(boolean paramBoolean)
  {
    ...
    Friends localFriends = ((anyw)localQQAppInterface.getManager(51)).c(localQQAppInterface.c());
  ...
  private void a(QQAppInterface paramQQAppInterface)
  {
    ...
    ThreadManager.getSubThreadHandler().post(new OnLineStatusPresenter.1(this, localanyw, paramQQAppInterface));
  }
  
  private void a(Friends paramFriends, AppRuntime.Status paramStatus, long paramLong)
  {
    paramFriends = azhq.a().a(paramLong, paramStatus, 0, paramFriends);
    String str = anzj.a(2131703757) + azhq.a().a(paramLong, paramStatus);
    this.jdField_a_of_type_Azhu.a(paramFriends, str);
    if (QLog.isColorLevel()) {
      QLog.d("OnLineStatusPresenter", 2, "user head updateOnlineStatus: " + paramStatus);
    }
  }
  
  private void a(Friends paramFriends, AppRuntime.Status paramStatus, long paramLong, azib paramazib)
  {
    Drawable localDrawable = azhq.a().a(paramLong, paramStatus, 0, paramFriends);
    TextView localTextView = this.jdField_a_of_type_Azhu.a();
    if (localTextView == null) {}
    do
    {
      return;
      paramFriends = azhq.a().a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, paramazib, paramStatus, paramFriends, localTextView, 4);
    } while (TextUtils.isEmpty(paramFriends));
    this.jdField_a_of_type_Azhu.a(paramFriends, localDrawable);
  }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    long l = azhq.a().a((QQAppInterface)localObject);
    b((QQAppInterface)localObject, paramString, l);
    localObject = a(paramBoolean);
    if (localObject == null) {
      return;
    }
    azib localazib = azhq.a().a(paramString, l);
    if (!azhq.a().a(localazib, (Friends)localObject, true))
    {
      l = 0L;
      paramString = AppRuntime.Status.online;
    }
    a((Friends)localObject, paramString, l, localazib);
