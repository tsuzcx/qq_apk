  ...
  implements anui
{
  ...
  public abstract void a(long paramLong1, long paramLong2, String paramString, int paramInt1, int paramInt2, myp parammyp, Player paramPlayer, long paramLong3);
  ...
  public abstract void a(long paramLong1, long paramLong2, String paramString1, String paramString2, myp parammyp);
  
  public abstract void a(long paramLong1, long paramLong2, String paramString, myp parammyp);
  
  public abstract void a(long paramLong1, long paramLong2, String paramString, myp parammyp, Player paramPlayer);
  
  public abstract void a(long paramLong1, long paramLong2, String paramString1, myp parammyp, String paramString2);
  
  public abstract void a(long paramLong1, long paramLong2, String paramString, mzi parammzi, Player paramPlayer, myp parammyp);
  
  public abstract void a(long paramLong1, String paramString, long paramLong2, myp parammyp);
  ...
  public abstract void a(String paramString1, long paramLong1, int paramInt, long paramLong2, String paramString2, mzi parammzi, Player paramPlayer, myp parammyp);
  ...
  public abstract void b(long paramLong1, String paramString, long paramLong2, myp parammyp);
  ...
  public void onUpdate(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    if (paramInt == 0) {
      if (paramBoolean)
      {
        a((String)paramObject[0], ((Long)paramObject[1]).longValue(), ((Integer)paramObject[2]).intValue(), ((Long)paramObject[3]).longValue(), (String)paramObject[4], (mzi)paramObject[5], (Player)paramObject[6], (myp)paramObject[7]);
        l1 = 0L;
    ...
    for (long l1 = l2 - l1;; l1 = 0L)
    {
      ...
      if (paramInt == 1)
      {
        if (paramBoolean)
        {
          a(((Long)paramObject[0]).longValue(), (String)paramObject[1], ((Long)paramObject[2]).longValue(), (myp)paramObject[3]);
          l1 = 0L;
          break;
        }
      ...
      if (paramInt == 2)
      {
        ...
        a(((Long)paramObject[0]).longValue(), ((Long)paramObject[1]).longValue(), (String)paramObject[2], (mzi)paramObject[3], (Player)paramObject[4], (myp)paramObject[5]);
        break;
      }
      if (paramInt == 3)
      {
      ...
      {
        l1 = ((Long)paramObject[5]).longValue();
        a(((Long)paramObject[0]).longValue(), ((Long)paramObject[1]).longValue(), (String)paramObject[2], (myp)paramObject[3], (Player)paramObject[4]);
        break;
      }
      if (paramInt == 5)
      {
        l1 = ((Long)paramObject[5]).longValue();
        a(((Long)paramObject[0]).longValue(), ((Long)paramObject[1]).longValue(), (String)paramObject[2], (myp)paramObject[3], (String)paramObject[4]);
        break;
      }
      if (paramInt == 7)
      {
        l1 = ((Long)paramObject[8]).longValue();
        a(((Long)paramObject[0]).longValue(), ((Long)paramObject[1]).longValue(), (String)paramObject[2], ((Integer)paramObject[3]).intValue(), ((Integer)paramObject[4]).intValue(), (myp)paramObject[5], (Player)paramObject[6], ((Long)paramObject[7]).longValue());
        break;
      }
      if (paramInt == 8)
      {
        l1 = ((Long)paramObject[4]).longValue();
        a(((Long)paramObject[0]).longValue(), ((Long)paramObject[1]).longValue(), (String)paramObject[2], (myp)paramObject[3]);
        break;
      }
      if (paramInt == 9)
      {
        l1 = ((Long)paramObject[5]).longValue();
        a(((Long)paramObject[0]).longValue(), ((Long)paramObject[1]).longValue(), (String)paramObject[2], (String)paramObject[3], (myp)paramObject[4]);
        break;
      }
      if (paramInt == 10)
      {
      ...
      if (paramInt == 13)
      {
        if (paramBoolean)
        {
          b(((Long)paramObject[0]).longValue(), (String)paramObject[1], ((Long)paramObject[2]).longValue(), (myp)paramObject[3]);
          l1 = 0L;
          break;
        }
