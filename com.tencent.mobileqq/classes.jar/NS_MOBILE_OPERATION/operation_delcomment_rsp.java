...
public final class operation_delcomment_rsp
  extends JceStruct
{
  public int iRet;
  public String strErrMsg = "";
  
  public operation_delcomment_rsp() {}
  
  public operation_delcomment_rsp(int paramInt, String paramString)
  {
    this.iRet = paramInt;
 ...
 * Qualified Name:     NS_MOBILE_OPERATION.operation_delcomment_rsp
