...
public class bhle
{
  private static ConcurrentHashMap<String, bhlf> a = new ConcurrentHashMap();
  ...
  public static void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    if (paramFromServiceMsg != null)
    {
      ...
      localObject = (bhlf)a.get(localObject);
      if (localObject != null) {
        ((bhlf)localObject).a(paramToServiceMsg, paramFromServiceMsg, paramObject);
      }
    }
  }
  
  public static void a(String paramString, bhlf parambhlf)
  {
    if ((paramString != null) && (parambhlf != null)) {
      a.put(paramString, parambhlf);
    }
  }
