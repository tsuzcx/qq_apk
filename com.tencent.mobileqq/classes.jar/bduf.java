  ...
  implements Manager
{
  ...
  public bduf(AppInterface paramAppInterface)
  {
  ...
  {
    String str = bbcz.m(paramQQAppInterface, paramString);
    if ((TextUtils.isEmpty(str)) || (str.equals(paramString)))
    {
      paramQQAppInterface = ((bduf)paramQQAppInterface.getManager(165)).a(String.valueOf(paramString));
  ...
  public static void a(Context paramContext, ArrayList<bbjs> paramArrayList)
  {
    paramContext = paramContext.getPackageManager();
    if (new Intent().setPackage("com.tencent.qidian").setData(Uri.parse("qdapi://")).resolveActivity(paramContext) != null) {
      paramArrayList.add(bbjs.a(19));
    }
  }
  
  private void a(aukp paramaukp)
  {
    paramaukp = paramaukp.a(QidianExternalInfo.class);
    if (paramaukp != null)
    {
      paramaukp = paramaukp.iterator();
      while (paramaukp.hasNext())
      {
        QidianExternalInfo localQidianExternalInfo = (QidianExternalInfo)paramaukp.next();
        if (QLog.isColorLevel()) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, String paramString)
  {
    for (;;)
    {
      try
      {
        ...
        if (!myv.a(paramString)) {
          return;
        }
        bduf localbduf = (bduf)paramQQAppInterface.getManager(165);
        ...
        if (bool1)
        {
          ...
          localbduf.a(localBmqqAccountType);
          if (!bool1) {
            continue;
          }
          QidianExternalInfo localQidianExternalInfo = localbduf.a(paramString);
          paramString = localbduf.a(paramString);
          if ((localQidianExternalInfo != null) && (paramString != null)) {
            continue;
          }
          if (bfny.a()) {
            ThreadManager.post(new QidianManager.10(localbduf, paramQQAppInterface, localBmqqAccountType), 5, null, true);
          }
        }
        else
        {
        ...
        localbduf.b(paramQQAppInterface.getApp().getBaseContext(), localBmqqAccountType);
        return;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    try
    {
      ...
      if (!myv.a(paramString1)) {
        return;
      }
      ((bduf)paramQQAppInterface.getManager(165)).h.put(paramString1, paramString2);
      return;
    }
    catch (Exception paramQQAppInterface) {}
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Friends[] paramArrayOfFriends)
  {
    ...
    {
      localbduf = (bduf)paramQQAppInterface.getManager(165);
      if (bfny.a()) {
        ThreadManager.postImmediately(new QidianManager.9(localbduf, paramQQAppInterface, paramArrayOfFriends), null, false);
      }
    }
    else
    {
    ...
    localbduf.b(paramQQAppInterface, paramArrayOfFriends);
  }
  ...
  private void a(String paramString1, int paramInt1, int paramInt2, String paramString2)
  {
    if ((!TextUtils.isEmpty(paramString1)) && (paramString1.contains("isNeedReply=")) && (paramString1.contains("QidianKfUin=")))
    {
      ...
      if (bool2)
      {
        ...
        SosoInterface.a(new bdug(this, 1, true, true, 0L, true, false, "QidianManager", paramString1, paramInt1, str3, paramInt2, str2, str1, paramString2));
      }
    }
    label364:
    while (!QLog.isColorLevel())
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    return ((((bduf)paramQQAppInterface.getManager(165)).a(paramMessageRecord.frienduin)) || (paramMessageRecord.istroop == 1024)) && (!TextUtils.isEmpty(paramMessageRecord.getExtInfoFromExtStr("is_eman_sc_message")));
  }
  
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString)
  {
    return ((bduf)paramQQAppInterface.getManager(165)).e(paramString);
  }
  
  private boolean a(String paramString, int paramInt)
  {
    Object localObject = (ajxl)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(51);
    if (localObject != null)
    {
      localObject = ((ajxl)localObject).b(paramString);
  ...
  {
    paramaukp = paramaukp.a(QidianInternalInfo.class);
    if (paramaukp != null)
    {
      paramaukp = paramaukp.iterator();
      while (paramaukp.hasNext())
      {
        QidianInternalInfo localQidianInternalInfo = (QidianInternalInfo)paramaukp.next();
        if (QLog.isColorLevel()) {
  ...
  private void b(QQAppInterface paramQQAppInterface, Friends[] paramArrayOfFriends)
  {
    ...
    //   36: pop2
    //   37: aload 10
    //   39: invokestatic 367	myv:a	(Ljava/lang/String;)Z
    //   42: ifne +4 -> 46
    //   45: return
    //   46: iload 5
    //   48: invokestatic 370	bduf:b	(I)Z
    //   51: istore 6
    //   53: iload 5
    //   55: invokestatic 372	bduf:a	(I)Z
    //   58: istore 7
    //   60: iload 5
    //   62: invokestatic 374	bduf:c	(I)Z
    //   65: istore 8
    //   67: iload 6
    //   69: ifne +60 -> 129
    //   72: iload 7
    ...
    //   155: aload_0
    //   156: aload 10
    //   158: invokevirtual 591	bduf:a	(Ljava/lang/String;)I
    //   161: aload 9
    //   163: invokevirtual 595	com/tencent/qidian/data/BmqqAccountType:getAccountType	()I
    //   166: if_icmpeq +119 -> 285
    //   169: aload_0
    //   170: getfield 50	bduf:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   173: aload 10
    //   175: aload 9
    ...
    //   194: aload_0
    //   195: aload 10
    //   197: invokevirtual 126	bduf:a	(Ljava/lang/String;)Lcom/tencent/qidian/data/QidianExternalInfo;
    //   200: astore 11
    //   202: aload_0
    //   203: aload 10
    //   205: invokevirtual 393	bduf:a	(Ljava/lang/String;)Lcom/tencent/qidian/data/QidianProfileUiInfo;
    //   208: astore 10
    //   210: aload 11
    //   212: ifnull +8 -> 220
    //   215: aload 10
    ...
    //   228: aload 9
    //   230: invokevirtual 414	bduf:b	(Landroid/content/Context;Lcom/tencent/qidian/data/BmqqAccountType;)Z
    //   233: pop
    //   234: goto +51 -> 285
    //   237: astore_1
    //   238: aload_1
  ...
  private void b(BmqqUserSimpleInfo paramBmqqUserSimpleInfo)
  {
    ...
    while (!QLog.isColorLevel()) {
      for (;;)
      {
        try
        {
          localaukp.b(paramBmqqUserSimpleInfo);
          if (QLog.isColorLevel()) {
  ...
  private void b(QidianExternalInfo paramQidianExternalInfo, QidianInternalInfo paramQidianInternalInfo, QidianCorpInfo paramQidianCorpInfo, QidianProfileUiInfo paramQidianProfileUiInfo)
  {
    ...
    while (!QLog.isColorLevel())
    {
      try
      {
        localaukp.b(paramQidianExternalInfo);
        if (paramQidianInternalInfo == null) {
          break label124;
        }
        localaukp.b(paramQidianInternalInfo);
      }
      ...
      {
        localaukp.b(paramQidianCorpInfo);
        if (paramQidianProfileUiInfo == null) {
          break label168;
        }
        localaukp.b(paramQidianProfileUiInfo);
      }
      for (;;)
      {
        if (QLog.isColorLevel()) {
  ...
  {
    return ((bduf)paramQQAppInterface.getManager(165)).f(paramString);
  }
  ...
  private void c(aukp paramaukp)
  {
    paramaukp = paramaukp.a(BmqqUserSimpleInfo.class);
    if (paramaukp != null)
    {
      paramaukp = paramaukp.iterator();
      while (paramaukp.hasNext())
      {
        BmqqUserSimpleInfo localBmqqUserSimpleInfo = (BmqqUserSimpleInfo)paramaukp.next();
        if (QLog.isColorLevel()) {
  ...
  private void d(aukp paramaukp)
  {
    paramaukp = paramaukp.a(QidianCorpInfo.class);
    if (paramaukp != null)
    {
      paramaukp = paramaukp.iterator();
      while (paramaukp.hasNext())
      {
        QidianCorpInfo localQidianCorpInfo = (QidianCorpInfo)paramaukp.next();
        if (QLog.isColorLevel()) {
  ...
  private void e(aukp paramaukp)
  {
    paramaukp = paramaukp.a(QidianProfileUiInfo.class);
    if (paramaukp != null)
    {
      paramaukp = paramaukp.iterator();
      while (paramaukp.hasNext())
      {
        QidianProfileUiInfo localQidianProfileUiInfo = (QidianProfileUiInfo)paramaukp.next();
        if (QLog.isColorLevel()) {
  ...
  private void f(aukp paramaukp)
  {
    paramaukp = paramaukp.a(QidianPAForWpa.class);
    if (paramaukp != null)
    {
      paramaukp = paramaukp.iterator();
      while (paramaukp.hasNext())
      {
        QidianPAForWpa localQidianPAForWpa = (QidianPAForWpa)paramaukp.next();
  ...
  public int a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      if (naz.b(paramQQAppInterface, paramString, 0)) {
        return 3;
      }
    } while (a(paramString));
  ...
  public String a(Context paramContext, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString)) {
      return String.format(paramContext.getString(2131698582), new Object[] { paramString });
    }
    return paramContext.getString(2131698581);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        localObject2 = axva.a(paramString.getBytes(), 0);
    ...
    paramString = (MessageForStructing)axas.a(-2011);
    ...
    for (;;)
    {
      ...
      if (akas.a(paramQQAppInterface, paramString, false)) {
        break;
      }
  ...
  {
    ((bdvn)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(85)).a(paramString1, paramInt1, paramBoolean, 0.0D, 0.0D, paramString2, paramInt2, paramString3, paramString4, paramString5);
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ((bdvn)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(85)).a(paramString1, paramString2, paramString3);
      return;
  ...
  {
    if ((!myv.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) || (myv.a(null, paramString))) {
      ((ajti)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(2)).a(paramString, paramBoolean);
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    while (localIterator.hasNext()) {
      ((bduh)localIterator.next()).a(paramBoolean);
    }
  }
      ...
      try
      {
        ...
        if (myv.a(paramContext))
        {
          ...
          default: 
            return false;
          case 1: 
            ((bdvn)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(85)).b(l);
            return true;
          }
          ((bdvn)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(85)).d(l);
          return true;
        }
      }
  ...
  public boolean a(String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      Long.parseLong(paramString);
      if (!myv.a(paramString)) {}
      while ((myv.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) && (!myv.a(null, paramString))) {
        return false;
      }
  ...
  {
    ((ajti)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(2)).f(paramString);
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (myv.a(paramContext))
        {
          ...
          case 0: 
          case 2: 
            ((mys)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(37)).a(paramContext);
            return true;
          case 1: 
            ((bdvn)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(85)).a(l);
            return true;
          }
          ((bdvn)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(85)).c(l);
          return true;
        }
      }
      catch (Exception paramContext) {}
