...
class bduf
{
  ...
  {
    if (!bdud.a(this.jdField_a_of_type_Bdud).a()) {}
    for (int i = 2;; i = 5)
    {
      if (paramArrayOfInt != null)
      {
  ...
  FileStorageServerListInfo a()
  {
    ...
    ArrayList localArrayList = bdud.c(this.jdField_a_of_type_Bdud, 16);
    ...
    if (localArrayList != null)
    {
      ...
      if (localArrayList.size() > 0)
      {
        int i = b(bdud.a(this.jdField_a_of_type_Bdud).a(bdud.a(this.jdField_a_of_type_Bdud).b()));
        localObject1 = localObject2;
        if (i > -1)
        {
          localObject1 = localObject2;
  ...
  {
    Object localObject2 = null;
    ArrayList localArrayList = bdud.c(this.jdField_a_of_type_Bdud, paramInt);
    Object localObject1 = localObject2;
    if (localArrayList != null)
    {
      localObject1 = localObject2;
  ...
  void a(FileStoragePushFSSvcList paramFileStoragePushFSSvcList)
  {
    ...
    if (paramFileStoragePushFSSvcList != null)
    {
      ...
      if (i <= 10)
      {
        paramFileStoragePushFSSvcList = bdud.a(this.jdField_a_of_type_Bdud, bdud.a(this.jdField_a_of_type_Bdud, i));
        if (paramFileStoragePushFSSvcList != null) {}
      ...
      if (i <= 15)
      {
        paramFileStoragePushFSSvcList = bdud.b(this.jdField_a_of_type_Bdud, bdud.b(this.jdField_a_of_type_Bdud, i));
        if (paramFileStoragePushFSSvcList != null) {}
        for (j = paramFileStoragePushFSSvcList.size();; j = 0)
        {
          this.jdField_a_of_type_Array2dOfInt[i] = new int[j];
      ...
      paramFileStoragePushFSSvcList = bdud.b(this.jdField_a_of_type_Bdud, bdud.b(this.jdField_a_of_type_Bdud, 17));
      i = k;
      if (paramFileStoragePushFSSvcList != null) {
    ...
    bdud.a(this.jdField_a_of_type_Bdud).a();
  }
