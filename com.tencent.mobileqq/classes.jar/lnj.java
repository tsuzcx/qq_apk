...
{
  public lnj(ReadInJoyAtlasFragment paramReadInJoyAtlasFragment) {}
  ...
  public void onPageSelected(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt == 1)
      {
        ...
        ((Bundle)localObject).putSerializable("lastShowImageModel", this.a.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommonReadInJoyAtlasViewPagerAdapter.a());
