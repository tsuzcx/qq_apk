...
public class lnj
  extends Handler
{
  public lnj(QQGAudioCtrl paramQQGAudioCtrl, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      {
        n = paramMessage.what;
        paramMessage = (lnk)paramMessage.obj;
        if (paramMessage == null)
        {
          if (QLog.isColorLevel()) {
                                    ...
                                    if ((paramMessage.jdField_a_of_type_ArrayOfByte != null) && (paramMessage.jdField_a_of_type_ArrayOfByte.length == 16))
                                    {
                                      ...
                                      if (m == 3)
                                      {
                                        ...
                                        else
                                        {
                                          ...
                                          localObject1 = lme.a((byte[])localObject1, i2);
                                          ...
                                          if (((k == 10) || (k == 1)) && (localObject1 != null))
                                          {
                                            ...
                                            while (((Iterator)localObject1).hasNext()) {
                                              paramMessage.add(new lnh(((lme)((Iterator)localObject1).next()).jdField_a_of_type_Long, l3));
                                            }
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        break;
        bcst.b(null, "CliOper", "", "", "0X800A7A6", "0X800A7A6", 0, (int)l3, "", "", "", "");
        break;
        bcst.b(null, "CliOper", "", "", "0X800A7A7", "0X800A7A7", 0, (int)l3, "", "", "", "");
        break;
