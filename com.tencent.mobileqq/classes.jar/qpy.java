...
public final class qpy
{
  ...
  static
  {
    jdField_a_of_type_Qpz = new qpz(null);
  }
  
  public qpy(int paramInt1, boolean paramBoolean1, @NotNull String paramString1, @NotNull String paramString2, int paramInt2, boolean paramBoolean2, @NotNull Function3<? super Boolean, ? super Boolean, ? super Integer, Unit> paramFunction3)
  {
