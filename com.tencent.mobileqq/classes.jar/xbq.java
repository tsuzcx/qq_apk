...
final class xbq
  extends wzx
{
  xbq(String paramString1, String paramString2, int paramInt, Context paramContext) {}
  ...
  public void a(int paramInt, String paramString, StoryVideoItem paramStoryVideoItem)
  {
    if ((paramInt == 0) && (paramStoryVideoItem != null))
    {
      ...
      for (paramInt = 1;; paramInt = 2)
      {
        ...
        xbp.a(this.jdField_a_of_type_AndroidContentContext, paramString, null);
        return;
      }
    }
    if (paramInt == 10100)
    {
      QQToast.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 1, anvx.a(2131713927), 0).a();
      return;
    }
    ...
    QQToast.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 1, anvx.a(2131713928) + paramInt, 0).a();
  }
}
