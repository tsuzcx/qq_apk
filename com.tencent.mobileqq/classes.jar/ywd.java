...
public class ywd
{
  ...
  public ywd(String paramString, int paramInt1, int paramInt2, int paramInt3, long paramLong, boolean paramBoolean, int paramInt4)
  {
  ...
  @TargetApi(17)
  @RequiresApi(api=17)
  public void a(List<Bitmap> paramList, yvx paramyvx)
  {
    yvy localyvy = new yvy(0, "success");
    this.jdField_a_of_type_Axrn = new axrn();
    axqz localaxqz = new axqz(this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_Int, this.jdField_a_of_type_Int, this.c, 1, false, 0);
    ...
    this.jdField_a_of_type_Axrn.a(localaxqz, new ywe(this, paramList, paramyvx, localyvy));
    try
    {
      try
      {
