  ...
  extends CharDividedFacePreloadBaseAdapter
{
  ...
  public xys(DiscussionMemberListInnerFrame paramDiscussionMemberListInnerFrame)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberDiscussionMemberListInnerFrame.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130971560, paramViewGroup, false);
      paramView = new xyt(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberDiscussionMemberListInnerFrame, null);
    ...
    paramView = (xyt)localView.getTag();
    if (i < 0)
    {
      i = -(i + 1) - 1;
