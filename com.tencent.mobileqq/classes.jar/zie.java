...
public class zie
  implements alwm, amkd, IMemoryManager, IAppStateChangeListener
{
  private static zie jdField_a_of_type_Zie;
  ...
  private Vector<zif> jdField_a_of_type_JavaUtilVector;
  public boolean a;
  ...
  public static zie a()
  {
    if (jdField_a_of_type_Zie == null) {}
    try
    {
      if (jdField_a_of_type_Zie == null) {
        jdField_a_of_type_Zie = new zie();
      }
      return jdField_a_of_type_Zie;
    }
    finally {}
  }
  ...
  public static void a(String paramString, int paramInt)
  {
    ...
    for (Object localObject = ((AppRuntime)localObject).getAccount();; localObject = null)
    {
      ...
      {
        if (paramString != null) {
          azri.a(BaseApplicationImpl.getApplication()).a((String)localObject, paramString, true, 0L, 0L, localHashMap, "", true);
        }
        return;
        if (paramInt == l)
        {
  ...
  {
    a(2);
    zic.a(BaseApplicationImpl.class.getClassLoader());
  }
    ...
    for (String str2 = "low_mem_report_rdm_time";; str2 = "bg_mem_report_rdm_time")
    {
      ...
      if (l1 > 0L) {
        if (Math.abs(l2 - l1) > 3600000L)
        {
          ...
          if (!alwk.a().a.jdField_a_of_type_Boolean) {
            break label531;
          }
          str1 = "1";
          localHashMap.put("ClearEnable", str1);
          localHashMap.put("DpcConfigId", alwk.a().a.jdField_a_of_type_JavaLangString);
          ...
          label396:
          azri.a(BaseApplicationImpl.getApplication()).a(null, str1, true, 0L, 0L, localHashMap, null);
  ...
  {
    zia localzia = alwk.a().a;
    if (QLog.isColorLevel()) {
      QLog.d("MemoryClearManagerNew", 2, "onNeedTrimMemory|clear= " + localzia.jdField_a_of_type_Boolean + "configId" + localzia.jdField_a_of_type_JavaLangString);
    }
    if ((a(paramzib.jdField_b_of_type_Int * localzia.jdField_b_of_type_Int * 1000)) && (localzia.jdField_a_of_type_Boolean)) {}
    try
    {
      b(paramInt, paramzib);
      return;
    }
    catch (Exception paramzib)
    {
      while (!QLog.isColorLevel()) {}
      QLog.d("MemoryClearManagerNew", 2, "clearMemory Exception= " + paramzib);
    }
  }
  ...
  public void a(zif paramzif)
  {
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      this.jdField_a_of_type_JavaUtilVector.add(paramzif);
      return;
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if ((i1 > 600) && (i1 - this.n > 250) && (this.jdField_a_of_type_Boolean))
    {
      ...
      if (Math.abs(l1 - l2) >= 3600000L)
      {
        ...
        localHashMap.put("topActivity", alzk.a());
        ...
        localHashMap.put("sProcessId", String.valueOf(BaseApplicationImpl.sProcessId));
        azri.a(BaseApplicationImpl.getApplication()).a(null, "MemoryIncreaseInfo", true, 0L, 0L, localHashMap, "", true);
  ...
  public void b()
  {
    try
    {
      ...
      ((SharedPreferences.Editor)localObject).putString("topActivity", alzk.a());
      ((SharedPreferences.Editor)localObject).putString("key_mem_info", azrd.a().a());
      ((SharedPreferences.Editor)localObject).putInt("hackArtResult", HackVm.jdField_d_of_type_Int);
      ((SharedPreferences.Editor)localObject).putString("clear_config_id", alwk.a().a.jdField_a_of_type_JavaLangString);
      ((SharedPreferences.Editor)localObject).putBoolean("clear_config_enable", alwk.a().a.jdField_a_of_type_Boolean);
  ...
  public void b(int paramInt, zib paramzib)
  {
    long l6;
    Object localObject3;
    int i1;
    ...
    for (;;)
    {
      try
      {
        ...
        synchronized (this.jdField_a_of_type_JavaUtilVector)
        {
          ...
          {
            i1 += ((zif)((Iterator)localObject3).next()).a();
            continue;
          }
          l2 = i1;
          l1 = i1;
          ...
          i2 = (int)(i1 * paramzib.jdField_b_of_type_Float);
          l3 = i1;
          BaseApplicationImpl.sImageCache.trimToSize(i2);
          if ((paramzib.a > 0.0F) && (paramzib.a < 1.0F))
          {
            l4 = MemoryManager.a() * 1L / 32L;
            if (BaseApplicationImpl.sImageCache.maxSize() >= l4) {
              BaseApplicationImpl.sImageCache.resetMaxSize(paramzib.a);
            }
          }
          i10 = 0 + (i1 - i2);
          l4 = i10;
    ...
    if (((Iterator)???).hasNext())
    {
      ...
      if (localObject3 != null)
      {
        ...
        if (localObject4 != null)
        {
          ...
          ((QQLruCache)localObject4).clearOnLowMemory((int)(((QQLruCache)localObject4).size() * paramzib.jdField_b_of_type_Float));
        ...
        else
        {
          ...
          if (((Iterator)localObject3).hasNext())
          {
            ...
            {
              localLruCache.trimToSize((int)(localLruCache.size() * paramzib.jdField_b_of_type_Float));
          ...
          if (paramInt == 1)
          {
            paramzib = this.jdField_b_of_type_JavaUtilList.iterator();
            if (!paramzib.hasNext()) {
              break label1449;
            }
            ??? = (WeakReference)paramzib.next();
            if (??? == null) {
              break label1446;
            }
            ...
            if (paramInt == 1)
            {
              paramzib = this.jdField_a_of_type_JavaUtilList.iterator();
              if (!paramzib.hasNext()) {
                break label1468;
              }
              ??? = (WeakReference)paramzib.next();
              ...
              break label1465;
              label842:
              paramzib = SkinEngine.getInstances().releasePreloadDrawableCache();
              Object localObject1;
              l2 = localObject1;
              i1 = i9;
              if (paramzib.length < 2) {
                break label1522;
              }
              if ((paramzib[0] instanceof Integer)) {
                i2 = Integer.parseInt(paramzib[0].toString());
              }
              l2 = localObject1;
              i1 = i2;
              if (!(paramzib[1] instanceof Long)) {
                break label1522;
              }
              l2 = Long.parseLong(paramzib[1].toString());
              i1 = i2;
              break label1522;
            }
          }
  ...
  public void b(zif paramzif)
  {
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      this.jdField_a_of_type_JavaUtilVector.remove(paramzif);
      return;
    }
  }
  ...
  public final void d()
  {
    ...
    for (String str = "1";; str = "0")
    {
      ...
      localHashMap.put("sProcessId", String.valueOf(BaseApplicationImpl.sProcessId));
      azri.a(BaseApplicationImpl.getApplication()).a(null, "memory_oom_Info", true, 0L, 0L, localHashMap, null);
