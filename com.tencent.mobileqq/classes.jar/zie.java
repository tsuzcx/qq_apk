...
public abstract class zie
  extends blfn
{
  public zie(int paramInt1, int paramInt2, int[] paramArrayOfInt1, int paramInt3, int[] paramArrayOfInt2, int[] paramArrayOfInt3, int[] paramArrayOfInt4)
  {
  ...
  public int a(Context paramContext, View paramView, int paramInt, Object paramObject, blfl paramblfl, View.OnClickListener paramOnClickListener)
  {
    ...
    if (n < this.b)
    {
      ...
      for (;;)
      {
        ...
        if (i1 != 0)
        {
          a(localLinearLayout, (View)localObject1, paramblfl.jdField_a_of_type_ArrayOfBlfm[n], j);
          k = i;
          m = j;
        }
        label532:
  ...
  protected void a(ViewGroup paramViewGroup, View paramView, blfm paramblfm, int paramInt)
  {
    ...
    {
      paramblfm = new LinearLayout.LayoutParams(paramblfm.c, paramblfm.d);
      paramView.setLayoutParams(paramblfm);
    }
    for (;;)
    {
      paramblfm.gravity = 16;
      paramViewGroup.addView(paramView, paramInt);
      return;
      localLayoutParams.width = paramblfm.c;
      localLayoutParams.height = paramblfm.d;
      paramblfm = localLayoutParams;
    }
  }
}
