...
public class bgyd
{
  static final int jdField_a_of_type_Int = bglq.a("qqminiapp", "mini_app_report_max_time_cost", 120000);
  ...
  public static HashMap<String, bgyf> a;
  private static final Map<String, List<String>> jdField_a_of_type_JavaUtilMap = new HashMap();
  private static SparseArray<bgye> jdField_b_of_type_AndroidUtilSparseArray = new SparseArray();
  ...
  static
  {
    ...
    jdField_b_of_type_AndroidUtilSparseArray.put(2, new bgye("launch_result", 1));
    jdField_b_of_type_AndroidUtilSparseArray.put(5, new bgye("basejs_download_result", 4));
    jdField_b_of_type_AndroidUtilSparseArray.put(617, new bgye("basejs_download_result", 4));
    jdField_b_of_type_AndroidUtilSparseArray.put(7, new bgye("basejs_unzip_result", 6));
    jdField_b_of_type_AndroidUtilSparseArray.put(618, new bgye("basejs_unzip_result", 6));
    jdField_b_of_type_AndroidUtilSparseArray.put(620, new bgye("app_download_result", 619));
    jdField_b_of_type_AndroidUtilSparseArray.put(614, new bgye("sub_download_result", 613));
    jdField_b_of_type_AndroidUtilSparseArray.put(622, new bgye("app_unzip_result", 621));
    jdField_b_of_type_AndroidUtilSparseArray.put(627, new bgye("preload_result", 626));
    jdField_b_of_type_AndroidUtilSparseArray.put(1022, new bgye("game_first_launch_result", 1));
    jdField_b_of_type_AndroidUtilSparseArray.put(1023, new bgye("game_twice_launch_result", 1));
    jdField_b_of_type_AndroidUtilSparseArray.put(201, new bgye("runtime_create_task", 200));
    jdField_b_of_type_AndroidUtilSparseArray.put(203, new bgye("runtime_init_task", 202));
    jdField_b_of_type_AndroidUtilSparseArray.put(205, new bgye("base_lib_load_async_task", 204));
    jdField_b_of_type_AndroidUtilSparseArray.put(207, new bgye("apkg_load_async_task", 206));
    jdField_b_of_type_AndroidUtilSparseArray.put(209, new bgye("service_init_task", 208));
    jdField_b_of_type_AndroidUtilSparseArray.put(211, new bgye("preload_flag_task", 210));
    jdField_b_of_type_AndroidUtilSparseArray.put(213, new bgye("flutter_view_create", 212));
    jdField_b_of_type_AndroidUtilSparseArray.put(214, new bgye("flutter_view_channel_init", 212));
    jdField_b_of_type_AndroidUtilSparseArray.put(216, new bgye("flutter_launch_app", 215));
  ...
  public static bgyf a(String paramString)
  {
    bgyf localbgyf2 = (bgyf)jdField_a_of_type_JavaUtilHashMap.get(paramString);
    bgyf localbgyf1 = localbgyf2;
    if (localbgyf2 == null)
    {
      localbgyf1 = new bgyf();
      localbgyf1.jdField_a_of_type_JavaLangString = paramString;
      jdField_a_of_type_JavaUtilHashMap.put(paramString, localbgyf1);
    }
    return localbgyf1;
  }
  ...
  {
    bgyf localbgyf = a(paramString);
    paramString = new JSONArray();
    try
    {
      JSONObject localJSONObject;
      if (localbgyf.jdField_b_of_type_JavaUtilMap.size() > 0)
      {
        localJSONObject = new JSONObject();
        localJSONObject.put("navigationStart", localbgyf.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(1)));
        localJSONObject.put("serviceStart", localbgyf.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(100)));
        localJSONObject.put("serviceEnd", localbgyf.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(101)));
        localJSONObject.put("viewStart", localbgyf.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(102)));
        localJSONObject.put("viewEnd", localbgyf.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(103)));
        localJSONObject.put("fetchPkgStart", localbgyf.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(619)));
        localJSONObject.put("fetchPkgEnd", localbgyf.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(620)));
        localJSONObject.put("fetchSdkStart", localbgyf.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(4)));
        localJSONObject.put("fetchSdkEnd", localbgyf.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(5)));
        localJSONObject.put("loadSdkServiceStart", localbgyf.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(14)));
        localJSONObject.put("loadSdkServiceEnd", localbgyf.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(15)));
        localJSONObject.put("loadSdkViewStart", localbgyf.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(18)));
        localJSONObject.put("loadSdkViewEnd", localbgyf.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(19)));
        localJSONObject.put("loadAppServiceStart", localbgyf.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(104)));
        localJSONObject.put("loadAppServiceEnd", localbgyf.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(105)));
        localJSONObject.put("loadAppViewStart", localbgyf.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(106)));
        localJSONObject.put("loadAppViewEnd", localbgyf.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(107)));
        paramString.put(localJSONObject);
      }
      if (localbgyf.jdField_a_of_type_JavaUtilMap.size() > 0)
      {
        localJSONObject = new JSONObject();
        localJSONObject.put("navigationStart", localbgyf.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(1)));
        localJSONObject.put("serviceStart", localbgyf.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(100)));
        localJSONObject.put("serviceEnd", localbgyf.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(101)));
        localJSONObject.put("viewStart", localbgyf.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(102)));
        localJSONObject.put("viewEnd", localbgyf.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(103)));
        localJSONObject.put("fetchPkgStart", localbgyf.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(619)));
        localJSONObject.put("fetchPkgEnd", localbgyf.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(620)));
        localJSONObject.put("fetchSdkStart", localbgyf.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(4)));
        localJSONObject.put("fetchSdkEnd", localbgyf.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(5)));
        localJSONObject.put("loadSdkServiceStart", localbgyf.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(14)));
        localJSONObject.put("loadSdkServiceEnd", localbgyf.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(15)));
        localJSONObject.put("loadSdkViewStart", localbgyf.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(18)));
        localJSONObject.put("loadSdkViewEnd", localbgyf.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(19)));
        localJSONObject.put("loadAppServiceStart", localbgyf.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(104)));
        localJSONObject.put("loadAppServiceEnd", localbgyf.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(105)));
        localJSONObject.put("loadAppViewStart", localbgyf.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(106)));
        localJSONObject.put("loadAppViewEnd", localbgyf.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(107)));
        paramString.put(localJSONObject);
      }
    }
  ...
  public static void a(MiniAppInfo paramMiniAppInfo, int paramInt1, String paramString1, String paramString2, String paramString3, int paramInt2, String paramString4, long paramLong, String paramString5, String paramString6, String paramString7, String paramString8, String paramString9)
  {
    ...
    {
      bgyf localbgyf = a((String)localObject1);
      long l1;
      Object localObject2;
      if (paramInt1 == 1)
      {
        ...
        for (int i = 1;; i = 0)
        {
          ...
          localbgyf.jdField_a_of_type_Boolean = false;
          if (localbgyf.jdField_b_of_type_Boolean) {
            break label355;
          }
          localObject2 = a("0000000000");
          if ((localObject2 == null) || (((bgyf)localObject2).jdField_a_of_type_JavaUtilMap.size() <= 0)) {
            break label315;
          }
          Iterator localIterator = ((bgyf)localObject2).jdField_a_of_type_JavaUtilMap.entrySet().iterator();
          while (localIterator.hasNext())
          {
            Map.Entry localEntry = (Map.Entry)localIterator.next();
            localbgyf.jdField_a_of_type_JavaUtilMap.put(localEntry.getKey(), localEntry.getValue());
        ...
        ((bgyf)localObject2).jdField_a_of_type_JavaUtilMap.clear();
      }
      for (;;)
      {
        label315:
        if ((paramInt1 == 611) && (!localbgyf.jdField_a_of_type_Boolean)) {
          paramInt1 = 2;
        }
        for (;;)
        {
          if (paramInt1 == 2) {
            if (localbgyf.jdField_a_of_type_Boolean) {
          ...
          for (;;)
          {
            ...
            label355:
            if (localbgyf.jdField_b_of_type_JavaUtilMap.size() == 0) {
              localbgyf.jdField_b_of_type_JavaUtilMap.putAll(localbgyf.jdField_a_of_type_JavaUtilMap);
            }
            break;
            localbgyf.jdField_a_of_type_Boolean = true;
            localbgyf.jdField_b_of_type_Boolean = true;
            if (jdField_a_of_type_JavaUtilArrayList.contains(Integer.valueOf(paramInt1))) {
              localbgyf.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(paramInt1), Long.valueOf(l1));
            }
            localObject2 = "";
            ...
            bgxr.a(paramMiniAppInfo, paramInt1, paramString1, paramString2, paramString3, paramInt2, paramString4, paramLong, paramString5, l1, paramString6, paramString7, paramString8, paramString9, (String)localObject1);
            paramString2 = (bgye)jdField_b_of_type_AndroidUtilSparseArray.get(paramInt1);
            if (paramString2 != null)
            {
              paramString3 = (Long)localbgyf.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramString2.jdField_a_of_type_Int));
              ...
              if (paramLong > 0L)
              {
                ...
                paramString3 = (String)localbgyf.c.get(Integer.valueOf(paramInt1));
                if (l2 < 0L) {
                  break label754;
                }
                paramLong = l2;
                ...
                bgxr.a(paramMiniAppInfo, paramString2, paramString3, paramInt2, paramLong, l1, paramString6, paramString7, paramString8, paramString9, (String)localObject1);
              }
            }
            for (;;)
            {
              ...
              bgxr.a(paramMiniAppInfo, 630, paramString1, "0", null, 0, paramString4, 0L, null, l1, "", "", "", "", (String)localObject1);
              return;
              label748:
              paramLong = 0L;
              break;
