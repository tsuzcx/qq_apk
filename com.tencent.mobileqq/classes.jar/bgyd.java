...
public class bgyd
{
  ...
  static
  {
    ...
    jdField_a_of_type_JavaUtilHashMap.put("1", new bgyf(2, true, 1, 1));
    jdField_a_of_type_JavaUtilHashMap.put("2", new bgyf(2, false, 1, 2));
    jdField_a_of_type_JavaUtilHashMap.put("3", new bgyf(3, true, 2, 3));
    jdField_a_of_type_JavaUtilHashMap.put("4", new bgyf(3, true, 1, 4));
    jdField_a_of_type_JavaUtilHashMap.put("5", new bgyf(3, true, 1, 5));
  }
