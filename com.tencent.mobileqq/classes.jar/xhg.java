  ...
  extends AbstractImageAdapter
{
  ...
  protected void a(View paramView, URLDrawable paramURLDrawable)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      {
        paramURLDrawable = axoa.a(str);
        if ((paramURLDrawable != null) && (paramURLDrawable.exists())) {
          paramView.setTag(2131296389, Integer.valueOf(bacm.d(paramURLDrawable.getAbsolutePath())));
        }
      }
      return;
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    do
    {
      ...
      localxhf = (xhf)getItem(paramInt);
      paramView = localURLImageView;
    } while (localxhf == null);
    URLDrawable localURLDrawable = a(localxhf.a(), paramViewGroup);
    if (localURLDrawable == null) {
      localURLDrawable = (URLDrawable)localxhf.b();
    }
    for (;;)
    {
      ...
      {
        int i = localURLDrawable.getProgress();
        localURLImageView.setURLDrawableDownListener(new xhh(this, paramInt, paramViewGroup));
        a(paramInt, i / 100);
        return localURLImageView;
      }
      paramView = localURLImageView;
