  ...
  extends bcvt
{
  ...
  private void a(Context paramContext, Resources paramResources, RelativeLayout paramRelativeLayout, View paramView, LinearLayout paramLinearLayout, TextView paramTextView1, TextView paramTextView2)
  {
    ...
    paramResources.setId(2131377675);
    paramView = new ImageView(paramContext);
    paramView.setImageResource(2130850452);
    ...
    paramTextView2.setId(2131377676);
    ...
    paramResources.addRule(3, 2131377675);
    ...
    paramResources.setId(2131377677);
    paramResources.setImageResource(2130850454);
    paramView = new RelativeLayout.LayoutParams(-2, -2);
    paramView.addRule(14);
    paramView.addRule(3, 2131377676);
    paramRelativeLayout.addView(paramResources, paramView);
    paramResources = new RelativeLayout(paramContext);
    paramView = new ImageView(paramContext);
    paramView.setId(2131377679);
    paramView.setImageResource(2130850455);
    ...
    paramContext.setImageResource(2130850451);
    paramView = new RelativeLayout.LayoutParams(-2, -2);
    paramView.addRule(15);
    paramView.addRule(0, 2131377679);
    ...
    paramContext.addRule(1, 2131377679);
    ...
    paramContext.addRule(3, 2131377677);
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if ((paramView != null) && ((paramView instanceof LinearLayout)))
    {
      ...
      localRelativeLayout.setLayoutParams(new LinearLayout.LayoutParams(-1, afur.a(290.0F, localResources)));
      ...
      paramView = (bcvs)localIterator.next();
      localObject5 = paramView.a;
      if ((!"type".equals(localObject5)) || (!(paramView instanceof bday))) {
        break label264;
      }
      j = ((bday)paramView).o;
      i = j;
    ...
    for (;;)
    {
      ...
      else
      {
        if (("picture".equals(localObject5)) && (localObject4 == null))
        {
          ...
          {
            float f = localResources.getDimensionPixelSize(2131296391);
        ...
        {
          if (("head".equals(localObject5)) && ((paramView instanceof bcxo)) && (localObject2 == null))
          {
            ((bcxo)paramView).o = i;
            ...
            continue;
            label531:
            paramView = new bdae(paramContext.getString(2131718164)).a(paramContext, null, null);
            paramBundle = new LinearLayout.LayoutParams(-1, -2);
            j = afur.a(15.0F, localResources);
            paramView.setLayoutParams(paramBundle);
            paramView.setPadding(j, j, j, j);
            paramBundle = (TextView)paramView.findViewById(2131377942);
            ...
            paramBundle.setImageResource(2130850445);
            ...
            ((RelativeLayout.LayoutParams)localObject4).rightMargin = afur.a(7.0F, localResources);
            paramView.addView(paramBundle, (ViewGroup.LayoutParams)localObject4);
            paramContext = new ImageView(paramContext);
            paramContext.setImageResource(2130850446);
            paramBundle = new RelativeLayout.LayoutParams(-2, -2);
            paramBundle.addRule(1, localObject1.getId());
            paramBundle.addRule(15);
            paramBundle.leftMargin = afur.a(7.0F, localResources);
            paramView.addView(paramContext, paramBundle);
            paramContext = new RelativeLayout.LayoutParams(-1, -2);
            paramContext.topMargin = afur.a(5.0F, localResources);
            paramContext.addRule(3, 2131377678);
            paramView.setLayoutParams(paramContext);
            paramView.setId(2131377676);
            localRelativeLayout.addView(paramView);
            paramContext = new RelativeLayout.LayoutParams(-2, -2);
            paramContext.addRule(14);
            paramContext.addRule(3, 2131377676);
            paramContext.topMargin = afur.a(10.0F, localResources);
            if (localObject2 != null)
            {
              localObject2.setId(2131377675);
