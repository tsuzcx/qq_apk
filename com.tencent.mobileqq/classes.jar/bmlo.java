  ...
  extends bmmk
{
  ...
  private static final String b = anni.a(2131711098);
  bihh jdField_a_of_type_Bihh = new bmlr(this);
  bmgl jdField_a_of_type_Bmgl = new bmlq(this);
  ...
  private String a(byte[] paramArrayOfByte)
  {
    ...
    //   10: getstatic 79	bmgk:b	Ljava/lang/String;
    ...
    //   37: dup
    //   38: getstatic 79	bmgk:b	Ljava/lang/String;
  ...
  private void a(bhod parambhod, String... paramVarArgs)
  {
    QLog.i("QZoneSharePictureJsPlugin", 1, "saxon handleGenerateGif start");
    if ((parambhod == null) || (paramVarArgs == null) || (paramVarArgs.length < 1))
    {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = PhotoUtils.a(bhgg.a(anhk.bg), "IMG", ".gif");
        ...
        if (!bool1)
        {
          ...
          parambhod = a(new File((String)localObject1));
      ...
      {
        QLog.e("QZoneSharePictureJsPlugin", 1, "handleGenerateGif fail, compressGIFTask exception.", parambhod);
        return;
      }
      boolean bool1 = false;
    }
    ...
    if (!bool3)
    {
      ...
      a(this.jdField_a_of_type_JavaLangString, i, paramVarArgs, 1, 0, parambhod, parambhod.length());
      return;
    }
    if (parambhod.length() <= k)
    {
      QLog.i("QZoneSharePictureJsPlugin", 1, "saxon 不分片callback len=" + parambhod.length());
      a(this.jdField_a_of_type_JavaLangString, i, paramVarArgs, 1, 0, parambhod, parambhod.length());
      return;
    }
    int m = parambhod.length() / k;
    if (parambhod.length() % k == 0) {
      j = 0;
    }
    for (;;)
    {
      m += j;
      QLog.i("QZoneSharePictureJsPlugin", 1, "saxon 分片callback pcount＝" + m + ",filelen=" + parambhod.length());
      j = 0;
      label612:
      if (j < m - 1)
      {
        a(this.jdField_a_of_type_JavaLangString, i, paramVarArgs, m, j, parambhod.substring(j * k, (j + 1) * k), parambhod.length());
    ...
    a(this.jdField_a_of_type_JavaLangString, i, paramVarArgs, m, m - 1, parambhod.substring((m - 1) * k), parambhod.length());
    ...
    paramVarArgs = blsi.a();
    blsb.a(parambhod.a(), paramVarArgs, (String)localObject1, anni.a(2131711111), localInterruptedException, -1);
  }
  ...
  private void a(BaseResp paramBaseResp)
  {
    ...
    {
      i = 0;
      paramBaseResp = anni.a(2131711119);
      a(paramBaseResp);
    }
    for (;;)
    {
      ...
      if (j == -2)
      {
        paramBaseResp = anni.a(2131711110);
        a(paramBaseResp);
      }
      else
      {
        paramBaseResp = anni.a(2131711107);
    ...
    for (;;)
    {
      ...
      catch (OutOfMemoryError paramString2)
      {
        ...
        try
        {
          ...
          paramString2.put("msg", anni.a(2131711100));
  ...
  private void a(JSONObject paramJSONObject, String paramString, bhod parambhod)
  {
    ThreadManager.getSubThreadHandler().post(new QZoneSharePictureJsPlugin.7(this, paramJSONObject, paramString, parambhod));
  }
  
  private void a(String... paramVarArgs)
  {
    bmic.a().a(new bmlp(this, paramVarArgs));
  }
  ...
  {
    Bitmap localBitmap1 = bisu.a(paramString, 120, 120, false);
  ...
  private void b(bhod parambhod, String... paramVarArgs)
  {
    int i = 0;
    Object localObject2;
    Object localObject3;
    label220:
    int j;
    if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin != null) && (parambhod != null) && (paramVarArgs != null) && (paramVarArgs.length > 0))
    {
      String str;
      try
      {
        ...
        {
          QLog.w("QZoneSharePictureJsPlugin", 1, "Base64.decode Exception: " + parambhod.toString());
          a(anni.a(2131711087));
          return;
        }
      ...
      {
        QLog.w("QZoneSharePictureJsPlugin", 1, "handleSharePicture catch an exception in disPatchMethod", parambhod);
        return;
      }
      QLog.d("QZoneSharePictureJsPlugin", 1, "the filePath is " + (String)localObject3);
      if ((!TextUtils.isEmpty(str)) && (parambhod != null) && (parambhod.a() != null)) {
      ...
      catch (NumberFormatException localNumberFormatException)
      {
        ...
        i = blsb.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin, parambhod, 21);
      ...
      default: 
        ...
        if ((parambhod != null) && ((parambhod instanceof bhst)))
        {
          parambhod = ((bhst)parambhod).getShare().a();
          if ((parambhod != null) && (parambhod.isShowing())) {
            parambhod.dismiss();
          }
        }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        aufz.a(parambhod.a(), (Intent)localObject1, paramVarArgs, i, -1, "");
      }
      ...
      a((JSONObject)localObject2, (String)localObject3, parambhod);
      break;
      if (bmgk.a().a())
      {
        ...
        bmgk.a().a(this.jdField_a_of_type_Bmgl);
        bmgk.a().a(BaseApplicationImpl.getContext(), (String)localObject3, (byte[])localObject1, 0);
        break;
      }
      if (parambhod.a() == null) {
        break;
      }
      parambhod.a().post(new QZoneSharePictureJsPlugin.5(this, parambhod));
      break;
      if (bmgk.a().a())
      {
        if (TextUtils.equals(paramVarArgs, "wezone"))
        ...
        bmgk.a().a(this.jdField_a_of_type_Bmgl);
        bmgk.a().a(BaseApplicationImpl.getContext(), (String)localObject3, null, 1);
        break;
      }
      if (parambhod.a() == null) {
        break;
      }
      parambhod.a().post(new QZoneSharePictureJsPlugin.6(this, parambhod));
      break;
      if (parambhod == null)
      {
  ...
  private void b(String paramString)
  {
    ...
    localObject2 = localObject1;
    label113:
    paramString = blwf.b().a();
    if (TextUtils.isEmpty(paramString))
    {
      a(localObject2, -1, anni.a(2131711096));
      return;
    }
    try
    {
      localObject1 = new File(paramString);
      if ((!atwl.a(paramString)) && (!((File)localObject1).mkdirs()))
      {
    ...
    catch (Exception paramString)
    {
      ...
      for (;;)
      {
        ...
        localObject1 = blwf.b().a(paramString);
        try
        {
        ...
        long l = bgjw.a((File)localObject1);
      ...
      a(localObject2, -1, anni.a(2131711117));
      return;
    }
  }
  ...
  private void c(String paramString)
  {
    ...
    a(paramString, -1, anni.a(2131711103));
  }
  ...
  {
    super.a();
    if (this.jdField_a_of_type_Bmgl != null) {
      bmgk.a().b(this.jdField_a_of_type_Bmgl);
    }
  }
  ...
  public void a(Intent paramIntent, byte paramByte, int paramInt)
  {
    ...
    for (paramIntent = anni.a(2131711125);; paramIntent = anni.a(2131711091))
    {
