...
{
  public static int a;
  private SparseArray<ancm> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
  public WeakReference<ande> a;
  ...
  private void a(long paramLong, String paramString1, String paramString2)
  {
    if ((TextUtils.isEmpty(paramString1)) && (paramString2 != null)) {
      anbd.a().callbackFromRequest(paramLong, 0, paramString1, paramString2);
    }
  }
  ...
  public amww a(long paramLong, String paramString1, String paramString2)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        Object localObject = (ande)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        if (localObject != null)
        {
          ...
          if ((localObject != null) && (((ApolloSurfaceView)localObject).getLuaState() == paramLong))
          {
            ...
            {
              localObject = (ancm)this.jdField_a_of_type_AndroidUtilSparseArray.get(i);
              paramString2.put("N_R_CMD", paramString1);
              paramString2.put("N_R_STATE", paramLong);
              if (localObject != null)
              {
                paramString1 = ((ancm)localObject).a(this, paramString2);
                if (paramString2.optBoolean("N_R_SYNC"))
                {
                  if (paramString1 != null) {
                    paramString1.put("code", 0);
                  }
                  localObject = new amww();
                  ((amww)localObject).b = true;
                  if (paramString1 == null)
                  {
                    paramString1 = paramString2.toString();
                    ((amww)localObject).a = paramString1;
                    return localObject;
                  }
              ...
              else
              {
                ...
                if (i < j)
                {
                  ...
                  paramString1 = (ancm)this.jdField_a_of_type_AndroidUtilSparseArray.get(k);
                  if (paramString1 == null) {
                    break label327;
                  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_AndroidUtilSparseArray != null)
    {
      ...
      {
        int k = this.jdField_a_of_type_AndroidUtilSparseArray.keyAt(i);
        ancm localancm = (ancm)this.jdField_a_of_type_AndroidUtilSparseArray.get(k);
        if (localancm != null) {
          localancm.a();
        }
        i += 1;
  ...
  public void a(ancm paramancm)
  {
    if (paramancm != null)
    {
      ...
      if (this.jdField_a_of_type_AndroidUtilSparseArray.get(i) == null) {
        this.jdField_a_of_type_AndroidUtilSparseArray.put(i, paramancm);
      }
    }
  }
  ...
  public void a(JSONObject paramJSONObject)
  {
    if (paramJSONObject != null) {
      try
      {
        ...
        {
          anbd.a().callbackFromRequest(l, 0, str, paramJSONObject.toString());
          return;
        }
