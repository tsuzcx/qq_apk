...
public class bhac
{
  ...
  public static Bitmap a(int paramInt, Bitmap.Config paramConfig, Bitmap[] paramArrayOfBitmap)
  {
    ...
    Object localObject = new bhae[j];
    i = 0;
    while (i < j)
    {
      localObject[i] = new bhae(null);
      i += 1;
    }
  ...
  public static Bitmap a(int paramInt, Bitmap[] paramArrayOfBitmap)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        arrayOfbhae = new bhae[i];
        j = 0;
        while (j < i)
        {
          arrayOfbhae[j] = new bhae(null);
          j += 1;
        }
        ...
        arrayOfbhae[0].a = 0;
        arrayOfbhae[0].b = 0;
        arrayOfbhae[0].c = (paramInt / 2 - 1);
        arrayOfbhae[0].d = paramInt;
        arrayOfbhae[0].e = 1;
        arrayOfbhae[1].a = (paramInt / 2 + 1);
        arrayOfbhae[1].b = 0;
        arrayOfbhae[1].c = paramInt;
        arrayOfbhae[1].d = paramInt;
        arrayOfbhae[1].e = 1;
        paramInt = 0;
    ...
    if (arrayOfbhae[paramInt].e == 1) {
      localRect.set(j / 4, 0, j / 4 * 3, k);
    }
    for (;;)
    {
      localRectF.set(arrayOfbhae[paramInt].a, arrayOfbhae[paramInt].b, arrayOfbhae[paramInt].c, arrayOfbhae[paramInt].d);
      ...
      if (i == 3)
      {
        ...
        arrayOfbhae[1].b = 0;
        arrayOfbhae[1].c = paramInt;
        arrayOfbhae[1].d = (paramInt / 2 - 1);
        arrayOfbhae[1].e = 2;
        arrayOfbhae[2].a = (paramInt / 2 + 1);
        arrayOfbhae[2].b = (paramInt / 2 + 1);
        arrayOfbhae[2].c = paramInt;
        arrayOfbhae[2].d = paramInt;
        arrayOfbhae[2].e = 2;
        break;
      }
      if (i < 4) {
      ...
      arrayOfbhae[2].e = 2;
      arrayOfbhae[3].a = 0;
      arrayOfbhae[3].b = (paramInt / 2 + 1);
      arrayOfbhae[3].c = (paramInt / 2 - 1);
      arrayOfbhae[3].d = paramInt;
      arrayOfbhae[3].e = 2;
      break;
