  ...
  implements View.OnClickListener
{
  ...
  protected String a;
  private List<bhag> jdField_a_of_type_JavaUtilList = new ArrayList();
  protected View b;
  protected boolean b;
  ...
  public bhac(Activity paramActivity)
  {
  ...
  private void b()
  {
    ...
    for (View localView = View.inflate(BaseApplicationImpl.getContext(), 2131561529, null);; localView = View.inflate(BaseApplicationImpl.getContext(), 2131561531, null))
    {
      ...
      this.jdField_a_of_type_Asdw = ((asdw)localView.findViewById(2131369716));
      this.jdField_a_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView = ((MagicfaceContainerView)localView.findViewById(2131369718));
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131369717));
  ...
  private void c()
  {
    if ((this.jdField_a_of_type_Bgzz != null) && (this.jdField_a_of_type_AndroidAppActivity != null))
    {
    ...
    try
    {
      ...
      label109:
      if (this.jdField_a_of_type_Bgzz.a())
      {
        bgzz localbgzz = this.jdField_a_of_type_Bgzz;
        localbgzz.a(new bhad(this, localbgzz));
        return;
      }
  ...
  public View a(String paramString1, String paramString2, bhaf parambhaf)
  {
    return a(paramString1, paramString2, false, parambhaf);
  }
  
  public View a(String paramString1, String paramString2, boolean paramBoolean, bhaf parambhaf)
  {
    ...
    try
    {
      ...
      {
        localObject1 = new bhag(this);
        ((bhag)localObject1).jdField_a_of_type_JavaLangString = paramString1;
        ((bhag)localObject1).jdField_a_of_type_Boolean = paramBoolean;
        ((bhag)localObject1).b = paramString2;
        ((bhag)localObject1).jdField_a_of_type_Bhaf = parambhaf;
        this.jdField_a_of_type_JavaUtilList.add(localObject1);
        return null;
      }
      if ((this.jdField_a_of_type_Bgzz != null) && (this.jdField_a_of_type_Bgzz.a())) {
        return null;
      }
      if (this.jdField_a_of_type_AndroidAppActivity == null) {
        return null;
      }
      this.jdField_a_of_type_Ascr = bgzz.a(paramString1, paramString2);
      if (this.jdField_a_of_type_Ascr == null) {
        return null;
      }
      this.jdField_a_of_type_JavaLangString = paramString1;
      b();
      this.jdField_a_of_type_Bgzz = new bgzz(this);
      ...
      this.jdField_a_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView.updateViewLayout((View)this.jdField_a_of_type_Asdw, (ViewGroup.LayoutParams)localObject2);
      if (!paramBoolean) {
        a(0);
      }
      ...
      if (paramBoolean)
      {
        ...
        ((FrameLayout.LayoutParams)localObject1).topMargin = bbll.a(75.0F);
        ((FrameLayout.LayoutParams)localObject1).bottomMargin = bbll.a(75.0F);
        ((FrameLayout.LayoutParams)localObject1).leftMargin = bbll.a(15.0F);
        ((FrameLayout.LayoutParams)localObject1).rightMargin = bbll.a(15.0F);
        this.jdField_a_of_type_Asdw.setIsFullScreen(false);
        this.jdField_a_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView.setTouchEffect(true);
        ((View)this.jdField_a_of_type_Asdw).setClickable(false);
        ((View)this.jdField_a_of_type_Asdw).setFocusable(false);
      ...
      this.jdField_a_of_type_Asdw.setIsFullScreen(this.jdField_a_of_type_Ascr.jdField_b_of_type_Boolean);
      this.jdField_a_of_type_AndroidViewView.setVisibility(0);
      localObject1 = this.jdField_a_of_type_Asdw;
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      ((View)localObject1).setVisibility(0);
      ((SurfaceView)localObject1).setZOrderOnTop(true);
      ((SurfaceView)localObject1).getHolder().setFormat(-2);
      localObject2 = new asdr();
      ((asdr)localObject2).a((asdd)localObject1);
      this.jdField_a_of_type_Bgzz.a((asdr)localObject2);
      this.jdField_a_of_type_Bgzz.a(new bhae(this, l, parambhaf));
      this.jdField_a_of_type_Bgzz.a(paramString1, paramString2);
    }
  ...
  public boolean b()
  {
    if ((this.jdField_a_of_type_Bgzz != null) && (this.jdField_a_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView.getVisibility() != 8))
    {
      c();
      return true;
    }
