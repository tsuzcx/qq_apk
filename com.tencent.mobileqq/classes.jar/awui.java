...
public abstract class awui
{
  ...
  public awui(long paramLong, String paramString, byte[] paramArrayOfByte)
  {
    ...
    this.jdField_b_of_type_ComTencentUploadUinterfaceIUploadTaskCallback = new awuj(this);
    this.jdField_a_of_type_Long = paramLong;
    this.g = paramString;
    this.h = awug.a(paramString);
