...
public class aijq
{
  private static aijq jdField_a_of_type_Aijq;
  ...
  private static final String jdField_d_of_type_JavaLangString = anvx.a(2131714364);
  ...
  private int a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString2.mkdirs();
        paramString1 = new bhyo(paramString1, new File(jdField_c_of_type_JavaLangString + "android_tim_theme_icons.zip"));
  ...
  {
    if (jdField_a_of_type_Aijq == null) {
      jdField_a_of_type_Aijq = new aijq();
    }
    return jdField_a_of_type_Aijq;
  }
  ...
  private boolean a(String paramString)
  {
    ...
    //   11: getstatic 49	aijq:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   58: ifeq -22 -> 36
    //   61: getstatic 45	aijq:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   64: invokestatic 144	com/tencent/mobileqq/utils/FileUtils:deleteFilesInDirectory	(Ljava/lang/String;)V
    //   67: aload_2
    //   68: getstatic 45	aijq:jdField_b_of_type_JavaLangString	Ljava/lang/String;
        ...
        if (localBitmap != null)
        {
          ...
          if (localObject2 == null)
          {
            ...
            if (localBitmap != null)
            {
              ...
              {
                localObject2 = bheg.a(jdField_b_of_type_JavaLangString + "tim_title_immersive_bar.png", (BitmapFactory.Options)localObject3);
                localObject1 = localBitmap;
                if (localObject2 != null)
                {
                  ...
                  if (localObject2 == null)
                  {
                    localObject1 = bheg.a(jdField_b_of_type_JavaLangString + "aio_tim_user_online_title_icon.png", (BitmapFactory.Options)localObject3);
