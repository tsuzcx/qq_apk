  ...
  extends bjts
{
  ...
  private static final String b = alpo.a(2131712707);
  bjnu jdField_a_of_type_Bjnu = new bjsy(this);
  ...
  private String a(byte[] paramArrayOfByte)
  {
    ...
    //   10: getstatic 76	bjnt:b	Ljava/lang/String;
    ...
    //   37: dup
    //   38: getstatic 76	bjnt:b	Ljava/lang/String;
  ...
  private void a(becq parambecq, String... paramVarArgs)
  {
    QLog.i("QZoneSharePictureJsPlugin", 1, "saxon handleGenerateGif start");
    if ((parambecq == null) || (paramVarArgs == null) || (paramVarArgs.length < 1))
    {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = PhotoUtils.a(bduw.a(aljq.bd), "IMG", ".gif");
        ...
        if (!bool1)
        {
          ...
          parambecq = a(new File((String)localObject1));
      ...
      {
        QLog.e("QZoneSharePictureJsPlugin", 1, "handleGenerateGif fail, compressGIFTask exception.", parambecq);
        return;
      }
      boolean bool1 = false;
    }
    ...
    if (!bool3)
    {
      ...
      a(this.jdField_a_of_type_JavaLangString, i, paramVarArgs, 1, 0, parambecq, parambecq.length());
      return;
    }
    if (parambecq.length() <= k)
    {
      QLog.i("QZoneSharePictureJsPlugin", 1, "saxon 不分片callback len=" + parambecq.length());
      a(this.jdField_a_of_type_JavaLangString, i, paramVarArgs, 1, 0, parambecq, parambecq.length());
      return;
    }
    int m = parambecq.length() / k;
    if (parambecq.length() % k == 0) {
      j = 0;
    }
    for (;;)
    {
      m += j;
      QLog.i("QZoneSharePictureJsPlugin", 1, "saxon 分片callback pcount＝" + m + ",filelen=" + parambecq.length());
      j = 0;
      label578:
      if (j < m - 1)
      {
        a(this.jdField_a_of_type_JavaLangString, i, paramVarArgs, m, j, parambecq.substring(j * k, (j + 1) * k), parambecq.length());
    ...
    a(this.jdField_a_of_type_JavaLangString, i, paramVarArgs, m, m - 1, parambecq.substring((m - 1) * k), parambecq.length());
    ...
    paramVarArgs = bizt.a();
    bizm.a(parambecq.a(), paramVarArgs, (String)localObject1, alpo.a(2131712720), localInterruptedException, -1);
  }
    ...
    for (;;)
    {
      ...
      catch (OutOfMemoryError paramString2)
      {
        ...
        try
        {
          ...
          paramString2.put("msg", alpo.a(2131712709));
  ...
  private void a(JSONObject paramJSONObject, String paramString, becq parambecq)
  {
    ThreadManager.getSubThreadHandler().post(new QZoneSharePictureJsPlugin.7(this, paramJSONObject, paramString, parambecq));
  }
  
  private void a(String... paramVarArgs)
  {
    bjpl.a().a(new bjsz(this, paramVarArgs));
  }
  ...
  {
    Bitmap localBitmap1 = bfhc.a(paramString, 120, 120, false);
  ...
  private void b(becq parambecq, String... paramVarArgs)
  {
    int i = 0;
    Object localObject;
    if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin != null) && (parambecq != null) && (paramVarArgs != null) && (paramVarArgs.length > 0))
    {
      String str;
      try
      {
        ...
        {
          QLog.w("QZoneSharePictureJsPlugin", 1, "Base64.decode Exception: " + parambecq.toString());
          a(alpo.a(2131712696));
          return;
        }
      ...
      {
        QLog.w("QZoneSharePictureJsPlugin", 1, "handleSharePicture catch an exception in disPatchMethod", parambecq);
        return;
      }
      QLog.d("QZoneSharePictureJsPlugin", 1, "the filePath is " + (String)localObject);
      label206:
      if ((!TextUtils.isEmpty(str)) && (parambecq != null) && (parambecq.a() != null)) {
      ...
      catch (NumberFormatException localNumberFormatException)
      {
        for (;;)
        {
          ...
          i = bizm.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin, parambecq, 21);
          arum.a(parambecq.a(), localIntent, i);
          continue;
          a(paramVarArgs, (String)localObject, parambecq);
          continue;
          if (bjnt.a().a())
          {
            bjnt.a().a(this.jdField_a_of_type_Bjnu);
            paramVarArgs = a((String)localObject);
            bjnt.a().a(BaseApplicationImpl.getContext(), (String)localObject, paramVarArgs, 0);
          }
          else if (parambecq.a() != null)
          {
            parambecq.a().post(new QZoneSharePictureJsPlugin.5(this, parambecq));
            continue;
            if (bjnt.a().a())
            {
              bjnt.a().a(this.jdField_a_of_type_Bjnu);
              bjnt.a().a(BaseApplicationImpl.getContext(), (String)localObject, null, 1);
            }
            else if (parambecq.a() != null)
            {
              parambecq.a().post(new QZoneSharePictureJsPlugin.6(this, parambecq));
            }
          }
        }
      }
      ...
      default: 
        ...
        if ((parambecq != null) && ((parambecq instanceof behg)))
        {
          parambecq = ((behg)parambecq).a().a();
          if ((parambecq != null) && (parambecq.isShowing())) {
            parambecq.dismiss();
          }
        }
  ...
  private void b(String paramString)
  {
    ...
    localObject2 = localObject1;
    label113:
    paramString = bjdq.b().a();
    if (TextUtils.isEmpty(paramString))
    {
      a(localObject2, -1, alpo.a(2131712705));
      return;
    }
    try
    {
      localObject1 = new File(paramString);
      if ((!arof.a(paramString)) && (!((File)localObject1).mkdirs()))
      {
    ...
    catch (Exception paramString)
    {
      ...
      for (;;)
      {
        ...
        localObject1 = bjdq.b().a(paramString);
        try
        {
        ...
        long l = bdal.a((File)localObject1);
      ...
      a(localObject2, -1, alpo.a(2131712726));
      return;
    }
  }
  ...
  private void c(String paramString)
  {
    ...
    a(paramString, -1, alpo.a(2131712712));
  }
  ...
  String a(File paramFile)
  {
    ...
    //   0: aconst_null
    //   1: astore 4
    //   3: new 876	java/io/BufferedInputStream
    //   6: dup
    //   7: new 878	java/io/FileInputStream
    //   10: dup
    //   11: aload_1
    //   12: invokespecial 879	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   15: invokespecial 882	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   18: astore_2
    //   19: aload_2
    //   20: astore_1
    //   21: aload_2
    //   22: invokevirtual 885	java/io/BufferedInputStream:available	()I
    //   25: newarray byte
    //   27: astore_3
    //   28: aload_2
    //   29: astore_1
    //   30: aload_2
    //   31: aload_3
    //   32: invokevirtual 889	java/io/BufferedInputStream:read	([B)I
    //   35: pop
    //   36: aload_2
    //   37: astore_1
    //   38: aload_3
    //   39: iconst_0
    //   40: invokestatic 893	android/util/Base64:encodeToString	([BI)Ljava/lang/String;
    //   43: astore_3
    //   44: aload_3
    //   45: astore_1
    //   46: aload_2
    //   47: ifnull +9 -> 56
    //   50: aload_2
    //   51: invokevirtual 894	java/io/BufferedInputStream:close	()V
    //   54: aload_3
    //   55: astore_1
    //   56: aload_1
    //   57: areturn
    //   58: astore_1
    //   59: aload_1
    //   60: invokevirtual 897	java/io/IOException:printStackTrace	()V
    //   63: aload_3
    //   64: areturn
    //   65: astore_3
    //   66: aconst_null
    ...
    //   73: ldc_w 803
    //   76: aload_3
    //   77: invokestatic 899	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   80: aload 4
    //   82: astore_1
    //   83: aload_2
    //   84: ifnull -28 -> 56
    //   87: aload_2
    //   88: invokevirtual 894	java/io/BufferedInputStream:close	()V
    //   91: aconst_null
    //   92: areturn
    //   93: astore_1
    //   94: aload_1
    //   95: invokevirtual 897	java/io/IOException:printStackTrace	()V
    //   98: aconst_null
    //   99: areturn
    //   100: astore_3
    //   101: aconst_null
    ...
    //   108: ldc_w 803
    //   111: aload_3
    //   112: invokestatic 899	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   115: aload 4
    //   117: astore_1
    //   118: aload_2
    //   119: ifnull -63 -> 56
    //   122: aload_2
    //   123: invokevirtual 894	java/io/BufferedInputStream:close	()V
    //   126: aconst_null
    //   127: areturn
    //   128: astore_1
    //   129: aload_1
    ...
    //   143: ldc_w 803
    //   146: aload_3
    //   147: invokestatic 899	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   150: aload 4
    //   152: astore_1
    //   153: aload_2
    //   154: ifnull -98 -> 56
    //   157: aload_2
    //   158: invokevirtual 894	java/io/BufferedInputStream:close	()V
    //   161: aconst_null
    //   162: areturn
    //   163: astore_1
    //   164: aload_1
    //   165: invokevirtual 897	java/io/IOException:printStackTrace	()V
    //   168: aconst_null
    //   169: areturn
    //   170: astore_2
    //   171: aconst_null
    ...
    //   174: ifnull +7 -> 181
    //   177: aload_1
    //   178: invokevirtual 894	java/io/BufferedInputStream:close	()V
    //   181: aload_2
    //   182: athrow
    //   183: astore_1
    //   184: aload_1
    //   185: invokevirtual 897	java/io/IOException:printStackTrace	()V
    //   188: goto -7 -> 181
    //   191: astore_2
    //   192: goto -19 -> 173
    //   195: astore_3
  ...
  {
    super.a();
    if (this.jdField_a_of_type_Bjnu != null) {
      bjnt.a().b(this.jdField_a_of_type_Bjnu);
    }
  }
  ...
  public void a(Intent paramIntent, byte paramByte, int paramInt)
  {
    ...
    for (paramIntent = alpo.a(2131712734);; paramIntent = alpo.a(2131712700))
    {
