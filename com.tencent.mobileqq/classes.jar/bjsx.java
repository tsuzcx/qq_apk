...
{
  private static volatile bjsx jdField_a_of_type_Bjsx;
  ...
  private bjsx(Context paramContext)
  {
  ...
  {
    if (jdField_a_of_type_Bjsx == null) {}
    try
    {
      if (jdField_a_of_type_Bjsx == null)
      {
        jdField_a_of_type_Bjsx = new bjsx(bjjo.a().a());
        jdField_a_of_type_Bjsx.a();
      }
      return jdField_a_of_type_Bjsx;
    }
    finally {}
  }
  ...
  private DownloadInfo a(String paramString, String[] paramArrayOfString)
  {
    ...
    //   7: astore 6
    //   9: aload_0
    //   10: getfield 107	bjsx:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   13: astore 7
    //   15: aload 7
    //   17: monitorenter
    //   18: aload_0
    //   19: invokevirtual 264	bjsx:getReadableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   22: astore_3
    //   23: aload_3
    //   24: ldc_w 266
    //   27: getstatic 93	bjsx:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   30: aload_1
    //   31: aload_2
    //   32: aconst_null
    //   33: aconst_null
    ...
    //   58: aload_0
    //   59: aload_2
    //   60: invokespecial 282	bjsx:a	(Landroid/database/Cursor;)Lcom/tencent/open/downloadnew/DownloadInfo;
    //   63: astore_1
    //   64: aload_2
    //   65: ifnull +9 -> 74
    //   68: aload_2
    ...
    //   99: ldc_w 290
    //   102: aload_3
    //   103: invokestatic 295	bjtx:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   106: aload_2
    //   107: ifnull +9 -> 116
    //   110: aload_2
  ...
  private String a()
  {
    if (this.jdField_a_of_type_Long == 0L)
    {
      ...
      if (this.jdField_a_of_type_Long == 0L) {
        bjtx.e("DownloadInfoDB", "getUin() is empty!");
      }
    }
  ...
  private List<DownloadInfo> a(String paramString, String[] paramArrayOfString)
  {
    ...
    //   13: astore 8
    //   15: aload_0
    //   16: getfield 107	bjsx:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   19: astore 7
    //   21: aload 7
    //   23: monitorenter
    //   24: aload_0
    //   25: invokevirtual 264	bjsx:getReadableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   28: astore 4
    //   30: aload 4
    //   32: ldc_w 266
    //   35: getstatic 93	bjsx:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   38: aload_1
    //   39: aload_2
    //   40: aconst_null
    //   41: aconst_null
    ...
    //   65: aload_0
    //   66: aload_1
    //   67: invokespecial 282	bjsx:a	(Landroid/database/Cursor;)Lcom/tencent/open/downloadnew/DownloadInfo;
    ...
    //   139: invokestatic 342	bjtx:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   142: aload 8
    //   144: areturn
    //   145: astore 4
    //   147: aconst_null
    ...
    //   155: ldc_w 344
    //   158: aload 4
    //   160: invokestatic 295	bjtx:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   163: aload_2
    //   164: ifnull +9 -> 173
    //   167: aload_2
  ...
  private void a()
  {
    if (this.jdField_a_of_type_Long == 0L)
    {
      this.jdField_a_of_type_Long = bjjo.a().a();
      if (this.jdField_a_of_type_Long == 0L) {
        this.jdField_a_of_type_Long = bjjo.a().b();
      }
    }
  }
  ...
  public java.util.concurrent.ConcurrentHashMap<String, DownloadInfo> a()
  {
    ...
    //   5: ldc_w 288
    //   8: ldc_w 382
    //   11: invokestatic 384	bjtx:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   14: new 386	java/util/concurrent/ConcurrentHashMap
    //   17: dup
    //   18: invokespecial 387	java/util/concurrent/ConcurrentHashMap:<init>	()V
    //   21: astore 7
    //   23: aload_0
    //   24: getfield 107	bjsx:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   27: astore 6
    //   29: aload 6
    //   31: monitorenter
    //   32: aload_0
    //   33: invokevirtual 264	bjsx:getReadableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   36: astore_2
    //   37: aload_2
    //   38: ldc_w 266
    //   41: getstatic 93	bjsx:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   44: aconst_null
    //   45: aconst_null
    //   46: aconst_null
    //   47: aconst_null
    ...
    //   74: aload 4
    //   76: ldc 15
    //   78: invokestatic 141	bjsx:a	(Landroid/database/Cursor;Ljava/lang/String;)I
    ...
    //   110: invokestatic 384	bjtx:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   113: aload_0
    //   114: aload 4
    //   116: invokespecial 282	bjsx:a	(Landroid/database/Cursor;)Lcom/tencent/open/downloadnew/DownloadInfo;
    //   119: astore 5
    //   121: ldc_w 288
    ...
    //   148: invokestatic 384	bjtx:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   151: aload 7
    //   153: aload_3
    //   154: aload 5
    ...
    //   211: ldc_w 398
    //   214: aload 4
    //   216: invokestatic 295	bjtx:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   219: aload_3
    //   220: ifnull +9 -> 229
    //   223: aload_3
  ...
  public void a(DownloadInfo paramDownloadInfo, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramDownloadInfo.jdField_c_of_type_Boolean)
        {
          ...
          localObject1 = localSQLiteDatabase;
          localObject2 = localSQLiteDatabase;
          bjtx.a("DownloadInfoDB", "addDownloadInfo>>>update affected rowNum=" + i);
          if (i == 0)
          {
            localObject1 = localSQLiteDatabase;
            localObject2 = localSQLiteDatabase;
            ...
            localObject1 = localSQLiteDatabase;
            localObject2 = localSQLiteDatabase;
            bjtx.a("DownloadInfoDB", "addDownloadInfo>>>insert rowID = " + l);
          }
          localObject1 = localSQLiteDatabase;
          localObject2 = localSQLiteDatabase;
      ...
      catch (Exception paramDownloadInfo)
      {
        ...
        bjtx.c("DownloadInfoDB", "addDownloadExceptionInfo>>>", paramDownloadInfo);
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        bjtx.c("DownloadInfoDB", "addDownloadExceptionInfo>>>", localException);
      }
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    {
      bjtx.e("DownloadInfoDB", "[deleteInfoByTicket] ticket is empty");
      return;
    }
    Object localObject3 = this.jdField_a_of_type_JavaLangObject;
    localObject2 = null;
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = localSQLiteDatabase;
        localObject2 = localSQLiteDatabase;
        bjtx.c("DownloadInfoDB", "[deleteInfoByTicket]ticket = ?" + Arrays.toString(new String[] { paramString }));
        localObject1 = localSQLiteDatabase;
        localObject2 = localSQLiteDatabase;
      ...
      catch (Exception paramString)
      {
        SQLiteDatabase localSQLiteDatabase;
        localObject2 = localObject1;
        bjtx.c("DownloadInfoDB", "[deleteInfoByTicket]>>>", paramString);
        if (localObject1 == null) {
          continue;
        }
        localObject1.close();
  ...
  {
    bjtx.b("DownloadInfoDB", "onDowngrade oldVersion=" + paramInt1 + " newVersion=" + paramInt2);
    a(paramSQLiteDatabase, paramInt1, paramInt2);
  }
  
  public void onUpgrade(SQLiteDatabase paramSQLiteDatabase, int paramInt1, int paramInt2)
  {
    bjtx.b("DownloadInfoDB", "onUpgrade oldVersion=" + paramInt1 + " newVersion=" + paramInt2);
    a(paramSQLiteDatabase, paramInt1, paramInt2);
  }
}
