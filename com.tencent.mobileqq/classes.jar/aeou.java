...
public class aeou
{
  ...
  public static void a(Activity paramActivity, String paramString)
  {
    ...
    if (bifz.a.containsKey("PublicAccountJs")) {
    ...
    localIntent.putExtra("leftViewText", paramActivity.getString(2131694937));
    localIntent.putExtra("assignBackText", paramActivity.getString(2131694937));
    if (TextUtils.isEmpty(paramString)) {
      localIntent.putExtra("url", usu.b);
    }
    for (;;)
    {
