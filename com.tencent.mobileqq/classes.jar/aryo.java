...
public class aryo
{
  ...
  {
    return a(auyu.a(paramRichText), paramInt);
  }
  ...
  public static String a(String paramString)
  {
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          if (((JSONObject)localObject5).has("audio_list"))
          {
            ...
            {
              localObject4 = localObject3;
              localObject1 = (String)localObject3 + anvx.a(2131706413);
            }
          ...
          if (((JSONObject)localObject5).has("video_list"))
          {
            ...
            {
              localObject4 = localObject3;
              localObject1 = (String)localObject3 + anvx.a(2131706414);
            }
          }
          else
          {
            ...
            if (((JSONObject)localObject5).has("pic_list"))
            {
              ...
              {
                localObject4 = localObject3;
                localObject1 = (String)localObject3 + anvx.a(2131706412);
              }
            }
            else
            {
      ...
      if (i < ((JSONArray)localObject5).length())
      {
        ...
        {
          localObject4 = localObject3;
          localObject1 = (String)localObject3 + anvx.a(2131706410);
          break label450;
        }
        localObject4 = localObject3;
        localObject1 = localObject3;
        ...
        localObject4 = localObject3;
        localObject1 = (String)localObject3 + anvx.a(2131706411);
        break label450;
