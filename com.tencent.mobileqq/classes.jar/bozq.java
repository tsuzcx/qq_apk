  ...
  extends bpcg
{
  ...
  private static final String jdField_b_of_type_JavaLangString = anni.a(2131702269);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bozq.class.getSimpleName();
  }
  
  public bozq(bpep parambpep, long paramLong)
  {
  ...
  private void a(String paramString)
  {
    ...
    for (int i = 1;; i = 2)
    {
      bcst.b(null, "dc00899", "Grp_tribe", "", "video_edit", paramString, i, 0, "", "", "", "");
      return;
    }
  }
  ...
  private void b(String paramString)
  {
    ...
    for (;;)
    {
      paramString.setSpan(new zqh(a(), 2130842546), 0, 1, 33);
  ...
  private void j()
  {
    ...
    for (;;)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setOnClickListener(new bozr(this));
      return;
      b(jdField_b_of_type_JavaLangString);
    }
  }
  ...
  {
    super.a();
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)a(2131364036));
    this.jdField_a_of_type_AndroidViewView = ((ImageView)a(2131379018));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)a(2131365060));
    this.jdField_a_of_type_AndroidViewView.setVisibility(8);
    this.jdField_c_of_type_AndroidWidgetTextView.setText(anni.a(2131702268));
    this.jdField_b_of_type_AndroidWidgetTextView = new TextView(a());
    this.jdField_b_of_type_AndroidWidgetTextView.setGravity(17);
    this.jdField_b_of_type_AndroidWidgetTextView.setMaxWidth(bggq.a(a(), 192.0F));
    ...
    int i = bggq.a(a(), 10.0F);
    this.jdField_b_of_type_AndroidWidgetTextView.setPadding(i, 0, i, 0);
    this.jdField_b_of_type_AndroidWidgetTextView.setBackgroundResource(2130842547);
    Object localObject = new RelativeLayout.LayoutParams(-2, bggq.a(a(), 28.0F));
    ((RelativeLayout.LayoutParams)localObject).addRule(11);
    ((RelativeLayout.LayoutParams)localObject).addRule(15);
    ((RelativeLayout.LayoutParams)localObject).rightMargin = bggq.a(a(), 10.0F);
    ...
    localObject = befl.a(((EditVideoParams)((Activity)a()).getIntent().getParcelableExtra(EditVideoParams.class.getName())).a);
    if (localObject != null)
    {
