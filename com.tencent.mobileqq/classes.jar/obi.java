  ...
  extends apcq
{
  ...
  private obi(PublicAccountJavascriptInterface paramPublicAccountJavascriptInterface, int paramInt1, long paramLong1, long paramLong2, boolean paramBoolean1, boolean paramBoolean2, int paramInt2, boolean paramBoolean3, String paramString) {}
  
  public obi(PublicAccountJavascriptInterface paramPublicAccountJavascriptInterface, int paramInt, String paramString, long paramLong)
  {
    this(paramPublicAccountJavascriptInterface, paramInt, -1L, paramLong, false, false, 0, false, paramString);
  }
  
  public obi(PublicAccountJavascriptInterface paramPublicAccountJavascriptInterface, int paramInt1, boolean paramBoolean1, int paramInt2, boolean paramBoolean2, String paramString, long paramLong)
  {
  ...
  public void onConsecutiveFailure(int paramInt1, int paramInt2)
  {
    ...
    bdll.b(null, "P_CliOper", "BizTechReport", "", "getlocation", "getdata", 0, 3, this.jdField_a_of_type_ComTencentBizPubaccountPublicAccountJavascriptInterface.getNetworkType(), str, "", "");
    ...
    if (!this.jdField_c_of_type_Boolean)
    {
      if (paramInt == 0)
      {
        ...
        for (;;)
        {
          ...
          bdll.b(null, "P_CliOper", "BizTechReport", "", "getlocation", "getloc", 0, 0, this.jdField_a_of_type_ComTencentBizPubaccountPublicAccountJavascriptInterface.getNetworkType(), paramSosoLbsInfo, "", "");
          return;
      ...
      paramSosoLbsInfo = Long.toString(System.currentTimeMillis() - this.jdField_a_of_type_Long);
      bdll.b(null, "P_CliOper", "BizTechReport", "", "getlocation", "getloc", 0, 1, this.jdField_a_of_type_ComTencentBizPubaccountPublicAccountJavascriptInterface.getNetworkType(), paramSosoLbsInfo, "", "");
      return;
    }
    ...
    for (byte[] arrayOfByte = paramSosoLbsInfo.jdField_a_of_type_ArrayOfByte;; arrayOfByte = null)
    {
      ...
      if (arrayOfByte != null)
      {
        ...
        for (;;)
        {
          try
          {
            paramSosoLbsInfo = blhj.a(PublicAccountJavascriptInterface.a(this.jdField_a_of_type_ComTencentBizPubaccountPublicAccountJavascriptInterface, arrayOfByte), "nbyvie");
            ...
            paramSosoLbsInfo = Long.toString(System.currentTimeMillis() - this.jdField_a_of_type_Long);
            bdll.b(null, "P_CliOper", "BizTechReport", "", "getlocation", "getdata", 0, 0, this.jdField_a_of_type_ComTencentBizPubaccountPublicAccountJavascriptInterface.getNetworkType(), paramSosoLbsInfo, "", "");
            if (arrayOfByte == null) {
              break;
            }
            ...
            nnc.a(null, 81, "", 0, 0, bhkv.encodeToString(arrayOfByte, 2), "", "", "");
            return;
          }
          ...
          try
          {
            ...
            {
              paramSosoLbsInfo = bhkv.encodeToString(twy.a(bool, twy.a(arrayOfByte), "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCrkUA+dDEQT52svdheRw04+xrExuTvNj3g7pjcyUkH3+86FiYNhHtyWJc11BywUZ2Ey3RomCyTb/szl5qQEJqR7UC5z4mhLrhgXlbRI0BgmI/LhaMRsfskGM7ziyQ2ZpS0qbHX2xoum6ou/541/VePIwmcnIk6eWUx6GYnA4euZQIDAQAB"), 2);
              break;
            }
            paramSosoLbsInfo = this.jdField_a_of_type_ComTencentBizPubaccountPublicAccountJavascriptInterface.mRuntime.a();
          }
      ...
      {
        if (paramSosoLbsInfo != null) {
          bdll.b(null, "P_CliOper", "BizTechReport", "", "getlocation", "getdata", 0, 0, paramSosoLbsInfo.getAccount(), localException.getMessage(), "", "");
        }
        paramSosoLbsInfo = "";
        break;
        label691:
        if ((this.jdField_b_of_type_Boolean) && (paramInt != -10000) && (paramInt != 2))
        {
          ...
          if (l3 > 0L)
          {
            ...
            SosoInterface.a(new obi(this.jdField_a_of_type_ComTencentBizPubaccountPublicAccountJavascriptInterface, 0, l3, l1, false, false, 0, true, this.jdField_a_of_type_JavaLangString));
          }
          for (;;)
          {
            paramSosoLbsInfo = Long.toString(System.currentTimeMillis() - this.jdField_a_of_type_Long);
            bdll.b(null, "P_CliOper", "BizTechReport", "", "getlocation", "getdata", 0, 2, this.jdField_a_of_type_ComTencentBizPubaccountPublicAccountJavascriptInterface.getNetworkType(), paramSosoLbsInfo, "", "");
            return;
            this.jdField_a_of_type_ComTencentBizPubaccountPublicAccountJavascriptInterface.callJs(this.jdField_a_of_type_JavaLangString, new String[] { "-1", "{}" });
          }
        }
        ...
        this.jdField_a_of_type_ComTencentBizPubaccountPublicAccountJavascriptInterface.callJs(this.jdField_a_of_type_JavaLangString, new String[] { "-1", "{}" });
        paramSosoLbsInfo = Long.toString(System.currentTimeMillis() - this.jdField_a_of_type_Long);
        bdll.b(null, "P_CliOper", "BizTechReport", "", "getlocation", "getdata", 0, 1, this.jdField_a_of_type_ComTencentBizPubaccountPublicAccountJavascriptInterface.getNetworkType(), paramSosoLbsInfo, "", "");
        return;
        label931:
        bool = false;
        break label363;
