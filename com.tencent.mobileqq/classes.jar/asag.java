...
public class asag
{
  ...
  private amab jdField_a_of_type_Amab = new asah(this);
  private Context jdField_a_of_type_AndroidContentContext;
  private GridLayoutManager jdField_a_of_type_AndroidSupportV7WidgetGridLayoutManager;
  private RecyclerView.OnScrollListener jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$OnScrollListener = new asaj(this);
  private RecyclerView jdField_a_of_type_AndroidSupportV7WidgetRecyclerView;
  private RelativeLayout jdField_a_of_type_AndroidWidgetRelativeLayout;
  private TextView jdField_a_of_type_AndroidWidgetTextView;
  private asak jdField_a_of_type_Asak;
  private bcws jdField_a_of_type_Bcws;
  private bcwt jdField_a_of_type_Bcwt = new asai(this);
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private String jdField_a_of_type_JavaLangString = "";
  
  public asag(Context paramContext)
  {
  ...
  private void d()
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetTextView == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setText(alpo.a(2131705232));
    ...
    if (this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView == null)
    {
      ...
      i = aekt.a(i, this.jdField_a_of_type_AndroidContentContext.getResources());
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, float paramFloat)
  {
    ...
    this.jdField_a_of_type_Asak = new asak(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Bcws, this.jdField_a_of_type_Float);
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.setAdapter(this.jdField_a_of_type_Asak);
