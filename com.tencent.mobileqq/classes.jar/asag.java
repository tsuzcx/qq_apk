...
public class asag
  extends ajtq
{
  public asag(LoginWelcomeManager paramLoginWelcomeManager) {}
  ...
  protected void onCardDownload(boolean paramBoolean, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        akhq localakhq = (akhq)LoginWelcomeManager.a(this.a).a(20);
        paramObject = localakhq.a((Card)paramObject);
        localakhq.a(str, paramObject, 1, null, (String)localObject, localakhq.a(paramObject, l1, l2), null);
