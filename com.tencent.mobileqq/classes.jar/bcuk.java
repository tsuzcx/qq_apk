...
public class bcuk
  extends bcup
{
  private asdv jdField_a_of_type_Asdv = new bcul(this);
  FileManagerEntity jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity;
  
  public bcuk(TeamWorkFileImportInfo paramTeamWorkFileImportInfo, QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    for (int i = 1;; i = 0)
    {
      if (i == 0)
      {
        ...
        this.jdField_a_of_type_Bcum.i(this.jdField_a_of_type_ComTencentMobileqqTeamworkTeamWorkFileImportInfo);
      }
