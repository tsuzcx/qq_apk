...
public class bcuk
{
  ...
  public static JceStruct a(byte[] paramArrayOfByte, QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    try
    {
      localObject1 = ((WNSStream)localObject1).unpack(bhuf.b(paramArrayOfByte));
  ...
  private static void a(QQAppInterface paramQQAppInterface, mobile_get_config_rsp parammobile_get_config_rsp)
  {
    ...
    try
    {
      abji.a(parammobile_get_config_rsp.config, true);
      label32:
      ...
      abjj.a(parammobile_get_config_rsp.config, parammobile_get_config_rsp.cookies, str1, paramQQAppInterface);
      return;
    }
  ...
  public static byte[] a(JceStruct paramJceStruct, String paramString, long paramLong, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    //   41: aload 7
    //   43: getstatic 13	bcuk:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   46: lload_2
    ...
    //   131: invokestatic 262	bmsv:a	()Lbmsv;
    //   134: invokevirtual 265	bmsv:c	()Ljava/lang/String;
    //   137: invokevirtual 59	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   140: pop
    //   141: ldc_w 267
    //   144: invokestatic 272	bcvp:a	(Ljava/lang/String;)Lcooperation/qzone/LbsDataV2$GpsInfo;
    //   147: astore 11
    //   149: ldc 110
    //   151: astore 7
    //   153: ldc 110
    ...
    //   161: ldc_w 267
    //   164: invokestatic 274	bcvp:a	(Ljava/lang/String;)V
    //   167: aload 10
    //   169: bipush 38
    ...
    //   245: dup
    //   246: ldc 101
    //   248: invokestatic 284	bmtd:a	()Ljava/lang/String;
    //   251: lload_2
    //   252: iconst_0
    //   253: newarray byte
    //   255: aload_0
    ...
    //   268: iload 6
    //   270: lload_2
    //   271: invokestatic 289	bcuk:a	(IJ)Lcom/qq/taf/jce/JceStruct;
    //   274: astore 7
    //   276: aload 7
    //   278: astore_0
    //   279: aload 8
    //   281: getstatic 38	bcuk:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger	Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    //   314: invokestatic 300	bhuf:a	([B)[B
    //   317: areturn
    //   318: dconst_1
    //   319: aload 11
