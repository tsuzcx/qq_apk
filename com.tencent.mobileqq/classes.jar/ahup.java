  ...
  implements ahuo
{
  ...
  public static ahuo a(IBinder paramIBinder)
  {
    ...
    if ((localIInterface != null) && ((localIInterface instanceof ahuo))) {
      return (ahuo)localIInterface;
    }
    return new ahuq(paramIBinder);
  }
