  ...
  implements View.OnClickListener, View.OnLongClickListener
{
  ...
  public phh(VafContext paramVafContext)
  {
  ...
  private void a()
  {
    ...
    if ((this.jdField_a_of_type_Pdp == null) || (this.jdField_a_of_type_Pdp.a == null)) {}
    View localView;
    do
    {
      do
      {
        return;
      } while (!this.jdField_a_of_type_Pdp.a.isAnchor);
    ...
    this.jdField_a_of_type_Pdp.a.isAnchor = false;
    ...
    localValueAnimator.addUpdateListener(new phj(this, localView));
  ...
  private void b()
  {
    this.mNative.setBackgroundResource(2130849376);
    this.jdField_a_of_type_Pcf.a(this.jdField_a_of_type_Pdp);
  }
  
  public void a(pcf parampcf, View paramView)
  {
  ...
  public void a(pdp parampdp)
  {
    ...
    if ((this.jdField_a_of_type_Pdp == null) || (this.jdField_a_of_type_Pdp.a == null) || (this.mNative == null)) {
      return;
    }
  ...
  {
    if ((this.jdField_a_of_type_Pcf == null) || (this.mNative == null)) {}
    for (;;)
    {
      ...
      if (this.mNative.isHyperLinkClick()) {
        ...
        ((pau)this.jdField_a_of_type_Pcf).a(this.jdField_a_of_type_Pdp, ozx.a(this.jdField_a_of_type_Pdp, this.c), 2);
      }
    }
  }
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    if (this.c == -1)
    {
      ...
      this.jdField_a_of_type_Pcf.a(this.jdField_a_of_type_Pcf.a(), this.mNative, this.jdField_a_of_type_Pdp, new phi(this));
    }
    return true;
  }
