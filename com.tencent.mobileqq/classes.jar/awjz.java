  ...
  implements ajti, ajwd
{
  ...
  MqqHandler jdField_a_of_type_MqqOsMqqHandler = new MqqHandler(Looper.getMainLooper(), new awka(this));
  private boolean jdField_a_of_type_Boolean;
  
  public awjz(Activity paramActivity)
  {
    super(paramActivity);
  ...
  public static boolean a()
  {
    ...
    return (localarfc != null) && (localarfc.f());
  }
  ...
  public void a(View paramView)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsPullrefreshContactRefreshHeader.setRefreshHeaderUpdateListener(new awkb(this));
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsPullrefreshCommonRefreshLayout.setOnRefreshListener(this);
    this.jdField_a_of_type_ComTencentWidgetListView = ((ListView)paramView.findViewById(2131369827));
