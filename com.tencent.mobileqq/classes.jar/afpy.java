...
public class afpy
{
  ...
  public afpy(QQAppInterface paramQQAppInterface, afqb paramafqb)
  {
    ...
    this.jdField_a_of_type_Afqb = paramafqb;
    this.jdField_a_of_type_Ajxj = new afpz(this);
  ...
  private long a()
  {
    long l = this.jdField_a_of_type_Akaa.a(2);
    if (QLog.isColorLevel()) {
  ...
  private void a(ArrayList<MayKnowRecommend> paramArrayList)
  {
    if ((paramArrayList != null) && (paramArrayList.size() > 0))
    {
      ...
      this.jdField_a_of_type_Akaa.a((List)???, l2, l1, true);
  ...
  private void a(List<MayKnowRecommend> paramList)
  {
    ...
    for (String str = "NULL";; str = paramList.toString())
    {
      ...
      this.jdField_a_of_type_Afqb.a(paramList);
      return;
    }
  }
  ...
  private boolean a()
  {
    ...
    return this.jdField_a_of_type_Akaa.b(2);
  }
  ...
  private boolean a(Bundle paramBundle)
  {
    ...
    return this.jdField_a_of_type_Akaa.a(2, paramBundle);
  }
  ...
  private boolean a(MayKnowRecommend paramMayKnowRecommend)
  {
    ...
    {
      if (!this.jdField_a_of_type_Ajxl.b(paramMayKnowRecommend.uin))
      {
        boolean bool = this.jdField_a_of_type_Ajxl.a(paramMayKnowRecommend.uin, false, true);
        if (bool) {}
        for (int i = 1;; i = 0)
        {
  ...
  private ArrayList<MayKnowRecommend> c()
  {
    ...
    Collections.sort(localArrayList, new afqa(this));
    if (QLog.isColorLevel()) {
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Afqb.a())
    {
      if (a())
      {
        int i;
