...
public class bris
{
  ...
  /* Error */
  public brit a(long paramLong)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 165	bris:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   4: ifnonnull +5 -> 9
    //   7: aconst_null
    //   8: areturn
    //   9: new 174	brit
    //   12: dup
    //   13: aload_0
    //   14: invokespecial 177	brit:<init>	(Lbris;)V
    //   17: astore 4
    //   19: aload_0
    //   20: getfield 165	bris:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   23: lload_1
    ...
    //   42: aload 4
    //   44: iload_3
    //   45: putfield 182	brit:jdField_a_of_type_Int	I
    //   48: aload 4
    //   50: aload_0
    //   51: getfield 184	bris:jdField_a_of_type_ArrayOfJavaNioByteBuffer	[Ljava/nio/ByteBuffer;
    //   54: iload_3
    //   55: aaload
    //   56: putfield 187	brit:jdField_a_of_type_JavaNioByteBuffer	Ljava/nio/ByteBuffer;
    //   59: aload_0
    //   60: monitorexit
    //   61: aload 4
    //   63: areturn
    ...
    //   73: aload 4
    //   75: iload_3
    //   76: putfield 182	brit:jdField_a_of_type_Int	I
    //   79: aload 4
    //   81: getstatic 146	bris:jdField_a_of_type_JavaLangReflectMethod	Ljava/lang/reflect/Method;
    //   84: aload_0
    //   85: getfield 165	bris:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   88: iconst_1
    ...
    //   105: putfield 187	brit:jdField_a_of_type_JavaNioByteBuffer	Ljava/nio/ByteBuffer;
    //   108: aload_0
    //   109: monitorexit
    //   110: aload 4
    //   112: areturn
    ...
    //   120: aload 4
    //   122: iconst_0
    //   123: putfield 203	brit:jdField_a_of_type_Boolean	Z
    //   126: goto -18 -> 108
    //   129: astore 4
    //   131: aload_0
    //   132: monitorexit
    ...
    //   143: aload 4
    //   145: iconst_0
    //   146: putfield 203	brit:jdField_a_of_type_Boolean	Z
    //   149: goto -41 -> 108
    //   152: astore 5
    //   154: aload 5
    ...
    //   159: aload 4
    //   161: iconst_0
    //   162: putfield 203	brit:jdField_a_of_type_Boolean	Z
    //   165: goto -57 -> 108
    //   168: aload 4
    //   170: iload_3
    //   171: putfield 182	brit:jdField_a_of_type_Int	I
    //   174: aload 4
    //   176: areturn
    ...
    //   27	144	3	i	int
    //   17	45	4	localbrit1	brit
    //   64	57	4	localbrit2	brit
    //   129	46	4	localbrit3	brit
  ...
  public void a(brit parambrit)
  {
    try
    {
      if (this.jdField_a_of_type_AndroidMediaMediaCodec != null)
      {
        this.jdField_a_of_type_AndroidMediaMediaCodec.releaseOutputBuffer(parambrit.jdField_a_of_type_Int, false);
        if (QLog.isColorLevel()) {
          QLog.d(jdField_c_of_type_JavaLangString, 2, "releaseOutputBuffer index = " + parambrit.jdField_a_of_type_Int);
        }
      }
      return;
    }
  ...
  public void a(brit parambrit, int paramInt1, long paramLong, int paramInt2)
  {
    try
    {
      if (this.jdField_a_of_type_AndroidMediaMediaCodec != null) {
        this.jdField_a_of_type_AndroidMediaMediaCodec.queueInputBuffer(parambrit.jdField_a_of_type_Int, 0, paramInt1, paramLong, paramInt2);
      }
      return;
    }
    finally
  ...
  public brit b(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject5 = new brit(this);
        i = this.jdField_a_of_type_AndroidMediaMediaCodec.dequeueOutputBuffer(((brit)localObject5).jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo, paramLong);
        switch (i)
        {
        case -3: 
          if (i < 0) {
          ...
          if (QLog.isColorLevel()) {
            QLog.d(jdField_c_of_type_JavaLangString, 2, "dequeueOutputBuffer ok,index = " + i + ",BufferInfo[flags = " + ((brit)localObject5).jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo.flags + ",offset=" + ((brit)localObject5).jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo.offset + ",size= " + ((brit)localObject5).jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo.size + ",TimeUs=" + ((brit)localObject5).jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo.presentationTimeUs + "]");
          }
          if (Build.VERSION.SDK_INT > 20) {
            break label444;
          }
          ((brit)localObject5).jdField_a_of_type_JavaNioByteBuffer = this.jdField_b_of_type_ArrayOfJavaNioByteBuffer[i];
          ((brit)localObject5).jdField_a_of_type_Int = i;
          ((brit)localObject5).jdField_a_of_type_AndroidMediaMediaFormat = this.jdField_b_of_type_AndroidMediaMediaFormat;
          ...
          this.jdField_b_of_type_ArrayOfJavaNioByteBuffer = this.jdField_a_of_type_AndroidMediaMediaCodec.getOutputBuffers();
          ((brit)localObject5).jdField_a_of_type_Int = -3;
        }
      }
      finally {}
      ((brit)localObject5).jdField_a_of_type_Int = -2;
      ...
      if (this.jdField_b_of_type_AndroidMediaMediaFormat != null)
      {
        ...
        else if (QLog.isColorLevel())
        {
          ...
          ((brit)localObject5).jdField_a_of_type_Int = -1;
          ...
          try
          {
            ((brit)localObject5).jdField_a_of_type_JavaNioByteBuffer = ((ByteBuffer)jdField_b_of_type_JavaLangReflectMethod.invoke(this.jdField_a_of_type_AndroidMediaMediaCodec, new Object[] { Integer.valueOf(i) }));
            ((brit)localObject5).jdField_a_of_type_AndroidMediaMediaFormat = ((MediaFormat)jdField_c_of_type_JavaLangReflectMethod.invoke(this.jdField_a_of_type_AndroidMediaMediaCodec, new Object[] { Integer.valueOf(i) }));
          ...
          catch (IllegalAccessException localIllegalAccessException)
          {
            for (;;)
            {
              ...
              ((brit)localObject5).jdField_a_of_type_Boolean = false;
            }
          }
