  ...
  extends banb
{
  ...
  alsi jdField_a_of_type_Alsi = new baqg(this);
  ...
  public baqf(bamu parambamu, baub parambaub)
  {
    super(parambamu, parambaub);
    this.jdField_b_of_type_JavaUtilArrayList = new ArrayList();
    this.jdField_b_of_type_JavaUtilMap = new HashMap();
    parambamu = parambaub.jdField_b_of_type_JavaLangObject;
    if ((parambamu != null) && ((parambamu instanceof axtg))) {
      this.jdField_a_of_type_Axtg = ((axtg)parambaub.jdField_b_of_type_JavaLangObject);
    }
    if ((this.jdField_a_of_type_Bamu != null) && (this.jdField_a_of_type_Bamu.a != null)) {
      this.jdField_a_of_type_AndroidOsHandler = this.jdField_a_of_type_Bamu.a;
    }
    this.jdField_a_of_type_ComTencentMobileqqDataMessageForLightVideo = ((MessageForLightVideo)parambaub.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
  ...
  private baxc a()
  {
    ...
    for (;;)
    {
      ...
      localbaxc.jdField_a_of_type_JavaLangString = ((File)localObject).getName();
      ...
      localbaxc.jdField_b_of_type_ArrayOfByte = this.d;
      localbaxc.e = this.jdField_c_of_type_Int;
      localbaxc.jdField_d_of_type_Int = this.jdField_b_of_type_Int;
      localbaxc.h = this.x;
      localbaxc.jdField_b_of_type_Long = this.jdField_b_of_type_Long;
      localObject = this.jdField_a_of_type_Baoj;
      long l = localbaxc.jdField_a_of_type_Long + this.jdField_b_of_type_Long;
      this.q = l;
      ((baoj)localObject).jdField_a_of_type_Long = l;
      localbaxc.g = 3;
      localbaxc.k = 3;
      localbaxc.jdField_j_of_type_Int = this.jdField_a_of_type_ComTencentMobileqqDataMessageForLightVideo.busiType;
      return localbaxc;
  ...
  private im_msg_body.RichText a()
  {
    for (;;)
    {
      try
      {
        ...
        Object localObject1 = (MessageForLightVideo)this.jdField_a_of_type_Baub.jdField_a_of_type_ComTencentMobileqqDataMessageRecord;
        Object localObject3;
        if (localObject1 != null)
        {
          ...
          localVideoFile.bytes_file_md5.set(ByteStringMicro.copyFrom(HexUtil.hexStr2Bytes(this.jdField_a_of_type_Baub.f)));
        ...
        if (this.x == 0)
        {
          if ((this.jdField_a_of_type_Axtg != null) && (this.jdField_a_of_type_Axtg.jdField_b_of_type_Int != 0))
          {
            localVideoFile.uint32_file_time.set(this.jdField_a_of_type_Axtg.jdField_b_of_type_Int / 1000);
            ...
            localObject1 = alpo.a(2131706422);
            ((im_msg_body.Text)localObject3).str.set(ByteStringMicro.copyFromUtf8(BaseApplication.getContext().getString(2131691347)));
  ...
  private void t()
  {
    ...
    //   21: lstore_2
    //   22: aload_0
    //   23: getfield 175	baqf:d	[B
    //   26: arraylength
    //   27: aload_0
    //   28: getfield 172	baqf:jdField_a_of_type_ArrayOfByte	[B
    //   31: arraylength
    //   32: iadd
    //   33: newarray byte
    //   35: astore 5
    //   37: aload_0
    //   38: getfield 175	baqf:d	[B
    //   41: iconst_0
    //   42: aload 5
    //   44: iconst_0
    //   45: aload_0
    //   46: getfield 175	baqf:d	[B
    //   49: arraylength
    //   50: invokestatic 497	java/lang/System:arraycopy	(Ljava/lang/Object;ILjava/lang/Object;II)V
    //   53: aload_0
    //   54: getfield 172	baqf:jdField_a_of_type_ArrayOfByte	[B
    //   57: iconst_0
    //   58: aload 5
    //   60: aload_0
    //   61: getfield 175	baqf:d	[B
    //   64: arraylength
    //   65: aload_0
    //   66: getfield 172	baqf:jdField_a_of_type_ArrayOfByte	[B
    //   69: arraylength
    ...
    //   176: astore 6
    //   178: aload_0
    //   179: invokespecial 529	baqf:a	()Z
    //   182: ifne +642 -> 824
    //   185: aload 5
    //   187: astore 8
    //   189: aload 7
    ...
    //   194: sipush 9303
    //   197: ldc_w 531
    //   200: invokevirtual 534	baqf:b	(ILjava/lang/String;)V
    //   203: aload 5
    //   205: astore 8
    //   207: aload 7
    //   209: astore 6
    //   211: aload_0
    //   212: invokevirtual 536	baqf:d	()V
    //   215: aload 7
    //   217: ifnull +8 -> 225
    //   220: aload 7
    ...
    //   284: aload_0
    //   285: invokespecial 543	baqf:a	()Lbaxc;
    //   288: astore 5
    ...
    //   310: aload 5
    //   312: getfield 139	baxc:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   326: aload 5
    //   328: getfield 142	baxc:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   342: aload 5
    //   344: getfield 151	baxc:jdField_a_of_type_Int	I
    ...
    //   355: aload 5
    //   357: getfield 153	baxc:jdField_b_of_type_Int	I
    //   360: invokevirtual 282	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   363: aload 5
    //   365: getfield 150	baxc:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   368: ifnull +821 -> 1189
    //   371: aload 6
    ...
    //   376: aload 5
    //   378: getfield 150	baxc:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   405: aload 5
    //   407: getfield 213	baxc:jdField_j_of_type_Int	I
    ...
    //   445: aload 5
    //   447: getfield 165	baxc:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   458: aload 5
    //   460: getfield 173	baxc:jdField_a_of_type_ArrayOfByte	[B
    ...
    //   474: aload 5
    //   476: getfield 177	baxc:jdField_b_of_type_ArrayOfByte	[B
    ...
    //   490: aload 5
    //   492: getfield 170	baxc:jdField_a_of_type_Long	J
    ...
    //   503: aload 5
    //   505: getfield 184	baxc:jdField_d_of_type_Int	I
    ...
    //   555: aload 5
    //   557: getfield 192	baxc:jdField_b_of_type_Long	J
    ...
    //   587: aload 5
    //   589: aload_0
    //   590: getfield 621	baqf:jdField_b_of_type_ArrayOfByte	[B
    ...
    //   603: aload 10
    //   605: lload_2
    //   606: invokespecial 630	baqh:<init>	(Lbaqf;Ljava/lang/String;J)V
    //   609: astore 6
    //   611: aload_0
    //   612: new 632	com/tencent/mobileqq/highway/transaction/Transaction
    //   615: dup
    //   616: aload_0
    //   617: getfield 69	baqf:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   620: invokevirtual 635	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   623: bipush 12
    //   625: aload 10
    //   627: aload_0
    //   628: getfield 637	baqf:r	J
    //   631: l2i
    //   632: aload_0
    //   633: getfield 639	baqf:jdField_c_of_type_ArrayOfByte	[B
    //   636: aload_0
    //   637: getfield 172	baqf:jdField_a_of_type_ArrayOfByte	[B
    //   640: aload 6
    //   642: aload 5
    ...
    //   647: putfield 645	baqf:jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction	Lcom/tencent/mobileqq/highway/transaction/Transaction;
    //   650: aload_0
    //   651: getfield 69	baqf:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   654: invokevirtual 649	com/tencent/mobileqq/app/QQAppInterface:getHwEngine	()Lcom/tencent/mobileqq/highway/HwEngine;
    //   657: aload_0
    //   658: getfield 645	baqf:jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction	Lcom/tencent/mobileqq/highway/transaction/Transaction;
    ...
    //   697: aload_0
    //   698: getfield 645	baqf:jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction	Lcom/tencent/mobileqq/highway/transaction/Transaction;
    ...
    //   713: aload_0
    //   714: getfield 131	baqf:jdField_a_of_type_Baub	Lbaub;
    //   717: getfield 133	baub:jdField_a_of_type_Long	J
    ...
    //   729: aload_0
    //   730: getfield 668	baqf:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   742: aload_0
    //   743: getfield 673	baqf:l	Ljava/lang/String;
    ...
    //   755: aload_0
    //   756: getfield 645	baqf:jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction	Lcom/tencent/mobileqq/highway/transaction/Transaction;
    ...
    //   791: ldc_w 684
    //   794: aload_0
    //   795: getfield 687	baqf:jdField_b_of_type_Bamy	Lbamy;
    //   798: invokevirtual 690	baqf:a	(ILjava/lang/String;Ljava/lang/String;Lbamy;)V
    //   801: aload_0
    //   802: invokevirtual 536	baqf:d	()V
    //   805: return
    //   806: astore 6
    //   808: aload 6
    ...
    //   830: astore 6
    //   832: aload_0
    //   833: getfield 468	baqf:jdField_b_of_type_JavaIoRandomAccessFile	Ljava/io/RandomAccessFile;
    ...
    //   850: astore 6
    //   852: aload_0
    //   853: getfield 468	baqf:jdField_b_of_type_JavaIoRandomAccessFile	Ljava/io/RandomAccessFile;
    //   856: aload 9
    ...
    //   898: astore 6
    //   900: aload_0
    //   901: getfield 470	baqf:jdField_a_of_type_JavaIoRandomAccessFile	Ljava/io/RandomAccessFile;
    //   904: aload 9
  ...
  public int a()
  {
    ...
    this.jdField_a_of_type_Axtg = null;
    return super.a();
  }
  ...
  /* Error */
  void a(baqj parambaqj)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_1
    //   3: getfield 748	baqj:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   6: astore 5
    //   8: aload_1
    //   9: getfield 749	baqj:jdField_a_of_type_ArrayOfByte	[B
    //   12: astore 6
    //   14: aload_1
    //   15: getfield 750	baqj:jdField_b_of_type_ArrayOfByte	[B
    //   18: astore 7
    //   20: aload_1
    //   21: getfield 751	baqj:jdField_c_of_type_ArrayOfByte	[B
    //   24: astore 8
    //   26: aload_1
    //   27: getfield 752	baqj:jdField_a_of_type_Int	I
    //   30: istore_2
    //   31: aload_1
    //   32: getfield 753	baqj:d	[B
    //   35: astore 9
    //   37: aload_1
    //   38: getfield 755	baqj:jdField_a_of_type_Axtf	Laxtf;
    //   41: astore 9
    //   43: aload_1
    //   44: getfield 756	baqj:jdField_a_of_type_Long	J
    //   47: lstore_3
    //   48: new 758	baqk
    //   51: dup
    //   52: aload_0
    //   53: invokespecial 759	baqk:<init>	(Lbaqf;)V
    //   56: astore_1
    //   57: new 632	com/tencent/mobileqq/highway/transaction/Transaction
    //   60: dup
    //   61: aload_0
    //   62: getfield 69	baqf:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   83: astore 5
    //   85: aload_0
    //   86: getfield 106	baqf:y	I
    //   89: ifeq +12 -> 101
    //   92: aload 5
    //   94: aload_0
    //   95: getfield 106	baqf:y	I
    //   98: putfield 762	com/tencent/mobileqq/highway/transaction/Transaction:cacheIp	I
    //   101: aload_1
    //   102: aload 5
    //   104: putfield 764	baqk:jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction	Lcom/tencent/mobileqq/highway/transaction/Transaction;
    //   107: aload_1
    //   108: iload_2
    //   109: putfield 765	baqk:jdField_a_of_type_Int	I
    //   112: aload_1
    //   113: aload 9
    //   115: putfield 766	baqk:jdField_a_of_type_Axtf	Laxtf;
    //   118: aload_0
    //   119: getfield 69	baqf:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   135: aload_0
    //   136: iload_2
    //   137: invokevirtual 768	baqf:f	(I)V
    //   140: aload_0
    //   141: monitorexit
    //   142: return
    //   143: aload_0
    //   144: getfield 44	baqf:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   147: aload 5
  ...
  public void a(bawo parambawo, baxd parambaxd)
  {
    ...
    if (parambaxd != null)
    {
      ...
      if (i < parambaxd.jdField_a_of_type_JavaUtilList.size())
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("LightVideoUploadProcessor", 2, "onBusiProtoResp()------response.result = " + parambawo.jdField_c_of_type_Int);
        }
        this.f = parambawo.jdField_a_of_type_JavaLangString;
        if (parambawo.jdField_c_of_type_Int == 0)
        {
          if (QLog.isColorLevel()) {
            QLog.d("LightVideoUploadProcessor", 2, "onBusiProtoResp()------response.isExist = " + parambawo.jdField_a_of_type_Boolean);
          }
        ...
        for (;;)
        {
          ...
          else
          {
            d();
            continue;
            b(parambawo.jdField_c_of_type_Int, "onBusiProtoResp error");
            d();
          }
        }
      }
  ...
  {
    long l;
    if ((this.jdField_a_of_type_Axtg != null) && (this.jdField_a_of_type_Axtg.jdField_b_of_type_Long != 0L))
    {
      l = System.currentTimeMillis() - this.jdField_a_of_type_Axtg.jdField_b_of_type_Long;
      if (QLog.isColorLevel()) {
    ...
    while ((this.jdField_a_of_type_Int == 0) || (this.jdField_a_of_type_Int == 1))
    {
      ...
      azmz.a(BaseApplication.getContext()).a(null, "LightVideoSend", paramBoolean, l, this.q, this.jdField_a_of_type_JavaUtilHashMap, null);
      return;
      label197:
      this.jdField_a_of_type_JavaUtilHashMap.put("param_FailCode", String.valueOf(this.jdField_j_of_type_Int));
    }
    this.jdField_a_of_type_JavaUtilHashMap.put("upload_type", String.valueOf(this.jdField_a_of_type_Int));
    azmz.a(BaseApplication.getContext()).a(null, "LightVideoSendComplete", paramBoolean, l, this.q, this.jdField_a_of_type_JavaUtilHashMap, null);
  }
  
  public void aS_()
  {
    super.aS_();
    this.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_Baub.jdField_j_of_type_JavaLangString;
    this.jdField_a_of_type_Long = this.jdField_a_of_type_Baub.jdField_a_of_type_Long;
    if (this.jdField_a_of_type_Baub.k == null) {
      this.d = HexUtil.hexStr2Bytes(aycl.a(this.jdField_b_of_type_JavaLangString));
    }
    this.d = HexUtil.hexStr2Bytes(this.jdField_a_of_type_Baub.k);
    Object localObject;
    ...
    o();
    if (g()) {
      if (this.jdField_a_of_type_Axtg != null) {
        if (this.jdField_a_of_type_Baub.jdField_i_of_type_Boolean)
        {
          this.jdField_a_of_type_Int = 0;
          this.jdField_a_of_type_Axtg.a(this);
          label234:
          d(1001);
        }
      }
    ...
    for (;;)
    {
      ...
      break;
      this.jdField_a_of_type_Int = 2;
      this.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_Baub.jdField_i_of_type_JavaLangString;
      if (this.jdField_a_of_type_Baub.f == null) {
        this.jdField_a_of_type_Baub.f = aycl.a(this.jdField_a_of_type_JavaLangString);
      }
      localObject = this.jdField_a_of_type_Baoj;
      String str = this.jdField_a_of_type_Baub.f;
      ((baoj)localObject).f = str;
      this.jdField_c_of_type_JavaLangString = str;
      this.jdField_a_of_type_ArrayOfByte = HexUtil.hexStr2Bytes(this.jdField_a_of_type_Baub.f);
      if ((this.jdField_a_of_type_ComTencentMobileqqDataMessageForLightVideo.videoFileSize == 0) || (this.jdField_a_of_type_ComTencentMobileqqDataMessageForLightVideo.videoFileTime == 0))
      {
        ...
        azgb.a(this.jdField_a_of_type_JavaLangString, (azgc)localObject);
      ...
      f();
      break label234;
      HwServlet.getConfig(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Baub.jdField_b_of_type_JavaLangString);
      this.jdField_a_of_type_Int = 2;
      this.jdField_a_of_type_Axtg.a(this);
    }
  }
  
  void b(axtf paramaxtf)
  {
    String str = paramaxtf.jdField_a_of_type_JavaLangString;
    ...
    if (QLog.isColorLevel()) {
      QLog.d("LightVideoUploadProcessor", 2, "<BDH_LOG>sendVideoThumbByBDH  filePath:" + str + " index :" + paramaxtf.jdField_d_of_type_Int + " md5:" + HexUtil.bytes2HexStr(arrayOfByte2) + " fileSize:" + i);
    }
    ...
    for (;;)
    {
      ...
      localObject = new baqj(this);
      ((baqj)localObject).jdField_a_of_type_JavaLangString = str;
      ((baqj)localObject).jdField_a_of_type_ArrayOfByte = arrayOfByte1;
      ((baqj)localObject).jdField_b_of_type_ArrayOfByte = arrayOfByte2;
      ((baqj)localObject).jdField_c_of_type_ArrayOfByte = arrayOfByte3;
      ((baqj)localObject).jdField_a_of_type_Int = 0;
      ((baqj)localObject).d = arrayOfByte2;
      ((baqj)localObject).jdField_a_of_type_Axtf = paramaxtf;
      ((baqj)localObject).jdField_a_of_type_Long = i;
      a((baqj)localObject);
      return;
  ...
  public void b(boolean paramBoolean)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("LightVideoUploadProcessor", 2, "confirm send:" + this.jdField_a_of_type_Axtg.b());
      }
      if (!this.jdField_a_of_type_Axtg.b()) {
        return;
      }
    }
    if (QLog.isColorLevel()) {
    ...
    ((axso)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(326)).a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForLightVideo, this.jdField_a_of_type_Alsi);
  }
  
  void c(axtf paramaxtf)
  {
    String str = paramaxtf.jdField_a_of_type_JavaLangString;
    int i = (int)new File(str).length();
    byte[] arrayOfByte1 = this.d;
    byte[] arrayOfByte2 = HexUtil.hexStr2Bytes(paramaxtf.jdField_b_of_type_JavaLangString);
    int j = paramaxtf.jdField_d_of_type_Int;
    int k = paramaxtf.jdField_b_of_type_Int;
    int m = paramaxtf.jdField_a_of_type_Int;
    int n = paramaxtf.e;
    long l = paramaxtf.jdField_b_of_type_Long;
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      localObject2 = new baqj(this);
      ((baqj)localObject2).jdField_a_of_type_JavaLangString = str;
      ((baqj)localObject2).jdField_a_of_type_ArrayOfByte = this.jdField_c_of_type_ArrayOfByte;
      ((baqj)localObject2).jdField_b_of_type_ArrayOfByte = arrayOfByte1;
      ((baqj)localObject2).jdField_c_of_type_ArrayOfByte = ((byte[])localObject1);
      ((baqj)localObject2).jdField_a_of_type_Int = j;
      ((baqj)localObject2).d = arrayOfByte2;
      ((baqj)localObject2).jdField_a_of_type_Axtf = paramaxtf;
      ((baqj)localObject2).jdField_a_of_type_Long = i;
      a((baqj)localObject2);
      return;
  ...
  void e()
  {
    ...
    localawfz.jdField_a_of_type_Long = (this.q - this.jdField_b_of_type_Long);
    ...
    for (String str = this.l;; str = this.f)
    {
      ...
      localawfz.jdField_c_of_type_Long = this.jdField_b_of_type_Long;
      if (QLog.isColorLevel()) {
        QLog.d("LightVideoUploadProcessor", 2, "onSuccess uuid = " + localawfz.jdField_c_of_type_JavaLangString);
      }
      if (this.jdField_a_of_type_Baub.jdField_a_of_type_Awfy == null) {
        break;
      }
    ...
    this.jdField_a_of_type_ComTencentMobileqqDataMessageForLightVideo.uuid = localawfz.jdField_c_of_type_JavaLangString;
    this.jdField_a_of_type_ComTencentMobileqqDataMessageForLightVideo.md5 = localawfz.jdField_d_of_type_JavaLangString;
    d(1003);
  }
  
  public void e(axtf paramaxtf)
  {
    if (QLog.isColorLevel()) {
      QLog.d("VideoSend", 2, "addToSendQuene, info:" + paramaxtf + " mSendingInfos:" + this.jdField_b_of_type_JavaUtilMap.size() + " mReadyToSendInfos:" + this.jdField_b_of_type_JavaUtilArrayList.size() + " mUploadType" + this.jdField_a_of_type_Int);
    }
    if (paramaxtf.c())
    {
    ...
    localbaoj.jdField_a_of_type_Long += paramaxtf.jdField_a_of_type_Long;
    this.q += paramaxtf.jdField_a_of_type_Long;
    this.jdField_b_of_type_JavaUtilArrayList.add(paramaxtf);
    s();
  }
  ...
  public void f(axtf paramaxtf)
  {
    this.jdField_a_of_type_AndroidOsHandler.post(new LightVideoUploadProcessor.5(this, paramaxtf));
  }
  ...
  public void h()
  {
    int j = 1;
    if (QLog.isColorLevel()) {
      QLog.d("VideoSend", 2, "checkNeedSendCompleteFile check, mUploadType:" + this.jdField_a_of_type_Int + " mSendFileSliceFailed:" + this.jdField_b_of_type_Boolean + " mCombineInfo:" + this.jdField_a_of_type_Axtf);
    }
    int i;
    if (this.jdField_a_of_type_Int == 0) {
    ...
    for (;;)
    {
      if ((i != 0) && (this.jdField_a_of_type_Axtf != null))
      {
        this.jdField_a_of_type_Baub.jdField_i_of_type_JavaLangString = this.jdField_a_of_type_Axtf.jdField_a_of_type_JavaLangString;
        this.jdField_a_of_type_Baub.f = this.jdField_a_of_type_Axtf.jdField_b_of_type_JavaLangString;
        this.jdField_a_of_type_Baub.jdField_i_of_type_Boolean = false;
        this.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_Axtf.jdField_a_of_type_JavaLangString;
        this.jdField_a_of_type_ArrayOfByte = HexUtil.hexStr2Bytes(this.jdField_a_of_type_Axtf.jdField_b_of_type_JavaLangString);
        baoj localbaoj = this.jdField_a_of_type_Baoj;
        String str = this.jdField_a_of_type_Axtf.jdField_b_of_type_JavaLangString;
        localbaoj.f = str;
        this.jdField_c_of_type_JavaLangString = str;
        this.q = this.jdField_a_of_type_Axtf.jdField_a_of_type_Long;
        this.x = (this.jdField_a_of_type_Axtf.e / 1000);
        g();
      }
      return;
      if ((this.jdField_a_of_type_Axtf != null) && (!this.jdField_a_of_type_Axtf.jdField_a_of_type_Boolean))
      {
  ...
  protected void i()
  {
    super.i();
    if (QLog.isColorLevel()) {
      QLog.d("LightVideoUploadProcessor", 2, "sendProgressMessage,progress;" + this.n + " transferedSize:" + this.jdField_a_of_type_Baoj.e + " fileSize:" + this.jdField_a_of_type_Baoj.jdField_a_of_type_Long);
    }
  }
  ...
  public void r()
  {
    ...
    if (jdField_a_of_type_Boolean)
    {
      ...
      l1 = Long.parseLong(this.jdField_a_of_type_Baub.jdField_b_of_type_JavaLangString);
      l2 = Long.parseLong(this.jdField_a_of_type_Baub.jdField_c_of_type_JavaLangString);
    ...
    for (;;)
    {
      j = ((MessageForLightVideo)this.jdField_a_of_type_Baub.jdField_a_of_type_ComTencentMobileqqDataMessageRecord).busiType;
      ...
      if (1 == this.jdField_a_of_type_Baub.jdField_a_of_type_Int) {
        i = 1;
      } else if (3000 == this.jdField_a_of_type_Baub.jdField_a_of_type_Int) {
        i = 2;
      } else {
        i = 3;
      }
  ...
  public void s()
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        axtf localaxtf = (axtf)this.jdField_b_of_type_JavaUtilArrayList.remove(0);
        if (localaxtf == null) {
          break;
        }
        if (QLog.isColorLevel()) {
          QLog.d("VideoSend", 2, "sendSlice, info:" + localaxtf + " mSendingInfos:" + this.jdField_b_of_type_JavaUtilMap.size() + " mReadyToSendInfos:" + this.jdField_b_of_type_JavaUtilArrayList.size());
        }
        this.jdField_b_of_type_JavaUtilMap.put(Integer.valueOf(localaxtf.jdField_d_of_type_Int), localaxtf);
        a(localaxtf);
      }
    }
  }
