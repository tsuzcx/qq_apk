  ...
  extends SpannableStringBuilder
{
  ...
  static
  {
    jdField_a_of_type_AndroidTextEditable$Factory = new axko();
    jdField_b_of_type_AndroidTextEditable$Factory = new axkp();
  }
  
  public axkn(CharSequence paramCharSequence, int paramInt)
  {
    this(paramCharSequence, paramInt, 32);
  }
  
  public axkn(CharSequence paramCharSequence, int paramInt1, int paramInt2)
  {
  ...
  private static final CharSequence a(CharSequence paramCharSequence, int paramInt1, int paramInt2)
  {
    if ((paramCharSequence instanceof axkd)) {
      return ((axkd)paramCharSequence).a();
    }
    return new axkd(paramCharSequence, paramInt1, paramInt2).a();
  }
  ...
  public String a()
  {
    ...
    int k = "[emoji]".length();
    localObject1 = (axkk[])getSpans(0, i, axkk.class);
    i = 0;
    if (j < localObject1.length)
    {
      ...
      for (;;)
      {
        ...
        continue;
        localObject2 = axjs.a[(localObject2.jdField_a_of_type_Int & 0x7FFFFFFF)];
        localStringBuffer.replace(m + i, n + i, (String)localObject2);
        i += ((String)localObject2).length() - (n - m);
      }
    }
  ...
  public SpannableStringBuilder replace(int paramInt1, int paramInt2, CharSequence paramCharSequence, int paramInt3, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      i = paramInt2;
      localObject = new axkd(paramCharSequence, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int).a();
  ...
  public CharSequence subSequence(int paramInt1, int paramInt2)
  {
    ...
    localObject2 = (axkk[])getSpans(i, paramInt1, axkk.class);
    if (paramInt1 - i > 0)
    {
      paramInt2 = 0;
      if (paramInt2 < localObject2.length)
      {
        ...
        for (;;)
        {
          ...
          try
          {
            ((StringBuilder)localObject1).replace(j - i, k - i, axku.a(localObject3.jdField_a_of_type_Int));
          }
          ...
          continue;
          Object localObject4 = (axkm)localException;
          localObject4 = anam.a(((axkm)localObject4).e, ((axkm)localObject4).f);
          ...
          continue;
          ((StringBuilder)localObject1).replace(j - i, k - i, axku.c(((axkk)localObject4).jdField_a_of_type_Int));
        }
      }
    }
    return localObject1;
  ...
  public String toString()
  {
    ...
    if (i < localObject1.length)
    {
      ...
      for (;;)
      {
        i += 1;
        break;
        localStringBuilder.replace(k, m, axku.a(((axkk)localObject2).jdField_a_of_type_Int));
        continue;
        localObject2 = (axkm)localObject2;
        localObject2 = anam.a(((axkm)localObject2).e, ((axkm)localObject2).f);
        ...
        if (QLog.isColorLevel())
        {
          ...
          continue;
          localStringBuilder.replace(k, m, axku.c(((axkk)localObject2).jdField_a_of_type_Int));
          continue;
          if (QLog.isColorLevel()) {
