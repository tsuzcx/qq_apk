  ...
  implements FaceDecoder.DecodeTaskCompletionListener
{
  ...
  private RecyclerView.OnScrollListener jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$OnScrollListener = new ahfd(this);
  private RecyclerView jdField_a_of_type_AndroidSupportV7WidgetRecyclerView;
  private FaceDecoder jdField_a_of_type_ComTencentMobileqqUtilFaceDecoder;
  private List jdField_a_of_type_JavaUtilList;
  private Map jdField_a_of_type_JavaUtilMap;
  
  private ahfc(Context paramContext, FaceDecoder paramFaceDecoder, RecyclerView paramRecyclerView)
  {
  ...
  private void a()
  {
    ...
    while (i < j)
    {
      ...
      localObject = (ahff)this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.getChildViewHolder((View)localObject);
      Bitmap localBitmap = (Bitmap)this.jdField_a_of_type_JavaUtilMap.get(ahff.a((ahff)localObject));
      if (localBitmap != null) {
        ahff.a((ahff)localObject).setImageBitmap(localBitmap);
      }
      i += 1;
    }
  }
  
  public ahff a(ViewGroup paramViewGroup, int paramInt)
  {
    return new ahff(LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130971484, paramViewGroup, false), null);
  }
  
  public void a(ahff paramahff, int paramInt)
  {
    ...
    ahff.a(paramahff, localMemberInfo.a);
    ahff.a(paramahff).setText(localMemberInfo.b);
    ahff.a(paramahff).setImageBitmap(a(localMemberInfo.a));
  }
