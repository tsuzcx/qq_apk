...
public class phy
{
  static phy jdField_a_of_type_Phy;
  ...
  public static phy a()
  {
    try
    {
      if (jdField_a_of_type_Phy == null) {
        jdField_a_of_type_Phy = new phy();
      }
      return jdField_a_of_type_Phy;
    }
    finally {}
  }
  ...
  public Fragment a(TabChannelCoverInfo paramTabChannelCoverInfo)
  {
    ...
    if (paramTabChannelCoverInfo.mChannelCoverId == pox.a()) {
    ...
    for (;;)
    {
      ...
      {
      default: 
        if (tbz.a(paramTabChannelCoverInfo.mChannelJumpUrl))
        {
      ...
      case 41450: 
        ...
        if (paramTabChannelCoverInfo.bid > 0L)
        {
          ...
          if (localObject2 != null)
          {
            ...
            if (!TextUtils.isEmpty(((pdc)localObject2).b("cgi"))) {}
