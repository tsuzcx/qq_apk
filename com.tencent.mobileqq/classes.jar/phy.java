  ...
  extends AladdinRequestHandler
{
  ...
  private static void b(Bundle paramBundle)
  {
    ...
    paramBundle = bctj.a(pha.a().getApplication());
    String str = pha.a();
    if (i == 0) {}
  ...
  private static byte[] c(byte[] paramArrayOfByte)
  {
    ...
    bgva.a(arrayOfByte, 4, paramArrayOfByte, (int)l);
    return arrayOfByte;
  }
  ...
  public void onSend(byte[] paramArrayOfByte, Bundle paramBundle, AladdinResponseHandler paramAladdinResponseHandler)
  {
    ...
    NewIntent localNewIntent = new NewIntent(localAppRuntime.getApplication(), phz.class);
    ...
    localNewIntent.putParcelableArrayListExtra("key_aladdin_listeners", phu.a);
