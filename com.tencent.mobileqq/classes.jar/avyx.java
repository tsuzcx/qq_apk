      ...
      if (i < j)
      {
        ...
        for (;;)
        {
          ...
          if ((!Modifier.isStatic(k)) || (!Modifier.isFinal(k)))
          {
            ...
            localObject4 = (avyw)localField.getAnnotation(avyw.class);
            if (localObject4 != null) {
              paramClass = ((avyw)localObject4).a();
            }
  ...
  public static <T> JSONObject a(T paramT)
  {
    ...
    if (i < j)
    {
      ...
      for (;;)
      {
        i += 1;
        break;
        Object localObject2 = (avyw)((Field)localObject1).getAnnotation(avyw.class);
        if (localObject2 != null)
        {
          localObject2 = ((avyw)localObject2).a();
