...
public class mne
{
  ...
  private LruCache<String, mng> jdField_a_of_type_AndroidUtilLruCache = new mnf(this, 4194304);
  private LinkedList<mnh> jdField_a_of_type_JavaUtilLinkedList = new LinkedList();
  private mnh jdField_a_of_type_Mnh;
  private byte[] jdField_a_of_type_ArrayOfByte;
  private byte[] b;
  
  public mne(int paramInt)
  {
  ...
  public void a()
  {
    try
    {
      this.jdField_a_of_type_Mnh = null;
      return;
    }
    finally
    {
  ...
  public void a(String paramString)
  {
    for (;;)
    {
      try
      {
        ...
        mng localmng = (mng)this.jdField_a_of_type_AndroidUtilLruCache.get(paramString);
        if (localmng != null)
        {
          this.jdField_a_of_type_Mnh = new mnh(localmng, true);
          continue;
        }
        if (!QLog.isColorLevel()) {
          break label96;
      ...
      label96:
      a(paramString);
      paramString = (mng)this.jdField_a_of_type_AndroidUtilLruCache.get(paramString);
      if (paramString != null) {
        this.jdField_a_of_type_Mnh = new mnh(paramString, true);
      }
    }
  }
  ...
  public void a(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    try
    {
      ...
      mnh localmnh = this.jdField_a_of_type_Mnh;
      if (localmnh != null) {
        localmnh.a(this.jdField_a_of_type_ArrayOfByte, 0, paramInt);
      }
      Arrays.fill(this.b, (byte)0);
      if ((this.jdField_a_of_type_JavaUtilLinkedList.size() > 0) && (i < paramInt))
      {
        localmnh = (mnh)this.jdField_a_of_type_JavaUtilLinkedList.get(0);
        if (localmnh != null)
        {
          int j = i + localmnh.a(this.b, i, paramInt);
          i = j;
          if (!localmnh.a()) {
            break label229;
          }
      ...
      {
        mni.a(paramArrayOfByte, this.jdField_a_of_type_ArrayOfByte, this.b, paramInt);
        return;
      }
    }
    finally {}
  ...
  public boolean a(String paramString)
  {
    ...
    do
    {
      ...
      if (arrayOfByte != null)
      {
        localObject = new mng(paramString, arrayOfByte);
  ...
  public void b(String paramString)
  {
    for (;;)
    {
      try
      {
        ...
        if (localmng != null)
        {
          paramString = new mnh(localmng, false);
      ...
      if (paramString != null)
      {
        paramString = new mnh(paramString, false);
        this.jdField_a_of_type_JavaUtilLinkedList.add(paramString);
      }
    }
  }
