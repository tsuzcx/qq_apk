  ...
  implements alub
{
  ...
  private GestureDetector.OnGestureListener jdField_a_of_type_AndroidViewGestureDetector$OnGestureListener = new alue(this);
  ...
  public alud(aluc paramaluc, String paramString, int paramInt1, int paramInt2, float paramFloat1, float paramFloat2, int paramInt3, float paramFloat3, int paramInt4)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetScroller = new Scroller(this.jdField_a_of_type_Aluc.getContext());
    this.jdField_a_of_type_AndroidViewGestureDetector = new GestureDetector(this.jdField_a_of_type_Aluc.getContext(), this.jdField_a_of_type_AndroidViewGestureDetector$OnGestureListener);
    this.jdField_a_of_type_Alua = new alua(this);
    ...
    for (this.jdField_a_of_type_Aluh = new VideoFramesRetriever(paramString, paramFloat1);; this.jdField_a_of_type_Aluh = new VideoFramesFetcher())
    {
      this.jdField_a_of_type_Aluh.a(paramInt4, paramInt1, this.jdField_a_of_type_Alua);
      this.jdField_a_of_type_Aluh.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      return;
    }
  }
  ...
  private void c()
  {
    if ((this.jdField_a_of_type_Alua == null) || (this.jdField_a_of_type_Alua.a())) {}
    int j;
    do
    {
      return;
  ...
  private void d()
  {
    ...
    label157:
    while (this.jdField_a_of_type_Alug == null)
    {
      return;
      this.jdField_a_of_type_Aluh.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      break;
    }
    this.jdField_a_of_type_Alug.a(this.jdField_d_of_type_Float, -this.jdField_d_of_type_Float, this.f - this.jdField_d_of_type_Float);
  }
  
  public void a()
  {
    this.jdField_a_of_type_Aluc.postInvalidate();
  }
  ...
  public void a(Canvas paramCanvas)
  {
    ...
    while (j < m)
    {
      aluf localaluf = this.jdField_a_of_type_Alua.a(j);
      if (localaluf != null)
      {
        ...
        this.jdField_a_of_type_AndroidGraphicsCanvas.drawBitmap(localaluf.jdField_a_of_type_AndroidGraphicsBitmap, this.jdField_c_of_type_AndroidGraphicsRect, this.jdField_c_of_type_AndroidGraphicsRect, this.jdField_a_of_type_AndroidGraphicsPaint);
      }
