...
{
  protected int a;
  View.OnTouchListener jdField_a_of_type_AndroidViewView$OnTouchListener = new ahbt(this);
  private List<String> jdField_a_of_type_JavaUtilList;
  
  public ahbs()
  {
    this.jdField_a_of_type_Int = 2131496725;
  }
  ...
  public View a(int paramInt, Object paramObject, ahbe paramahbe, View paramView, ViewGroup paramViewGroup, Context paramContext, View.OnClickListener paramOnClickListener, View.OnLongClickListener paramOnLongClickListener, ahdb paramahdb)
  {
    ...
    label71:
    Object localObject2;
    if ((paramView != null) && ((paramView.getTag() instanceof ahbu)))
    {
      paramViewGroup = (ahbu)paramView.getTag();
    ...
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = new ahbu();
      paramView = a(paramContext, this.jdField_a_of_type_Int, paramViewGroup);
      paramViewGroup.jdField_a_of_type_ComTencentWidgetRecentDynamicAvatarView = ((RecentDynamicAvatarView)paramView.findViewById(2131296259));
      paramViewGroup.jdField_a_of_type_ComTencentWidgetSingleLineTextView = ((SingleLineTextView)paramView.findViewById(2131305159));
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131309443));
      ...
      paramViewGroup.d = ((TextView)paramView.findViewById(2131309210));
      paramViewGroup.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131309223));
      paramViewGroup.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131309211));
      ...
      paramViewGroup.e = ((TextView)paramView.findViewById(2131304161));
      localObject2 = paramContext.getResources();
      float f = babp.a();
      paramahdb = ((Resources)localObject2).getColorStateList(2131101336);
      localObject1 = ((Resources)localObject2).getColorStateList(2131101267);
      ...
      for (;;)
      {
        ...
        paramViewGroup.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setExtendTextColor(paramahdb, 2);
        paramViewGroup.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setExtendTextSize(17.0F, 2);
        paramView.setTag(paramViewGroup);
        break;
        paramViewGroup.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setExtendTextColor(paramahdb, 0);
      }
      label636:
      paramViewGroup.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setExtendTextColor(paramahdb, 0);
      break label71;
      ...
      paramahdb = null;
      if (paramahbe != null) {
        paramahdb = paramahbe.a((RecentBaseData)localObject1);
      }
      if ((((RecentUser)localObject2).extraInfo instanceof MayKnowRecommend))
      {
        paramahbe = (MayKnowRecommend)((RecentUser)localObject2).extraInfo;
        a(paramView, (RecentBaseData)localObject1, paramContext, paramahdb, paramahbe);
        if (paramahbe != null) {
          if (paramahbe.friendStatus == 0)
          {
            paramViewGroup.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(paramOnClickListener);
            ...
            paramViewGroup.jdField_a_of_type_AndroidWidgetButton.setTag(paramahbe);
            paramahbe = paramContext.getResources().getColorStateList(2131101292);
            if (paramahbe != null) {
              paramViewGroup.jdField_a_of_type_AndroidWidgetButton.setTextColor(paramahbe);
            }
            paramViewGroup.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130839032);
            paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
            if (AppSetting.c) {
              paramViewGroup.jdField_a_of_type_AndroidWidgetButton.setContentDescription(ajjy.a(2131624088));
            }
          }
          else if (paramahbe.friendStatus == 1)
          {
            ...
            if (AppSetting.c) {
              paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(ajjy.a(2131647405));
            }
          }
          else
          {
            ...
            if (AppSetting.c) {
              paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(ajjy.a(2131647404));
            }
          }
        }
      }
      ...
      {
        a(paramView, (RecentBaseData)localObject1, paramContext, paramahdb);
        continue;
        label977:
  ...
  public void a(View paramView, RecentBaseData paramRecentBaseData, Context paramContext, Drawable paramDrawable)
  {
    ...
    if ((paramView.getTag() instanceof ahbu)) {}
    for (ahbu localahbu = (ahbu)paramView.getTag();; localahbu = null) {
      for (;;)
      {
        if (localahbu == null)
        {
        ...
        if (a(paramRecentBaseData))
        {
          ...
          int j = ((Integer)ahbe.a(localQQAppInterface, paramRecentBaseData.a(), paramRecentBaseData.a()).first).intValue();
          i = j;
          if (j == 103) {
            i = 1;
          }
          RecentDynamicAvatarView localRecentDynamicAvatarView = localahbu.jdField_a_of_type_ComTencentWidgetRecentDynamicAvatarView;
          ...
          if (localQQAppInterface.a.a() == 1)
          {
            ...
            a(localahbu.jdField_a_of_type_ComTencentWidgetRecentDynamicAvatarView);
            f = babp.a();
            if (paramRecentBaseData.mAuthenIconId == 0) {
              break label459;
            }
            localahbu.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setCompoundDrawablePadding((int)(f * 3.0F));
            localahbu.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setCompoundDrawablesWithIntrinsicBounds(0, paramRecentBaseData.mAuthenIconId);
            if (QLog.isColorLevel()) {
            ...
            localahbu.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setExtendText(paramContext, 2);
            localahbu.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setExtendText(paramRecentBaseData.mShowTime, 0);
            localahbu.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setText(paramRecentBaseData.mTitleName);
            if (!TextUtils.isEmpty(paramRecentBaseData.mTitleName_cs)) {
              localahbu.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setText(paramRecentBaseData.mTitleName_cs);
            }
            localahbu.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setIconDrawablesWithIntrinsicBounds(null);
          }
        }
        try
        {
          localahbu.c.setText(paramRecentBaseData.mLastMsg);
          aeyf.a(localahbu.jdField_b_of_type_AndroidWidgetTextView, ((RecentItemMayKnowFriendVerticalListData)paramRecentBaseData).gender, ((RecentItemMayKnowFriendVerticalListData)paramRecentBaseData).age, null);
          if (!AppSetting.c) {
            break;
          }
          ...
          bool = false;
          break label205;
          localahbu.jdField_a_of_type_ComTencentWidgetRecentDynamicAvatarView.setImageDrawable(paramDrawable);
          break label224;
          label459:
          if (a(paramRecentBaseData))
          {
            i = bajr.a(((BaseActivity)paramContext).app, paramRecentBaseData.a(), false);
            if (QLog.isColorLevel()) {
              QLog.d("RecentMayKnowFriendVerticalListItemBuilder", 2, "bindView: vip=" + i);
            }
            if (i == 3)
            {
              localahbu.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setCompoundDrawablePadding((int)(f * 5.0F));
              localahbu.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setCompoundDrawablesWithIntrinsicBounds(0, 2130845971);
              break label308;
            }
            localahbu.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0);
            break label308;
          }
          if (QLog.isColorLevel()) {
  ...
  public void a(View paramView, RecentBaseData paramRecentBaseData, Context paramContext, Drawable paramDrawable, MayKnowRecommend paramMayKnowRecommend)
  {
    ...
    for (ahbu localahbu = (ahbu)paramView.getTag();; localahbu = null) {
      for (;;)
      {
        ...
        try
        {
          localahbu.e.setText(paramRecentBaseData.mLastMsg);
          localahbu.jdField_a_of_type_ComTencentMobileqqTroopWidgetTroopLabelLayout.a(paramMayKnowRecommend);
          if (!AppSetting.c) {
            break;
          }
          paramView.setContentDescription(paramRecentBaseData.mContentDesc);
