  ...
  extends zeo
{
  ...
  public avfd(Context paramContext, PicInfo paramPicInfo)
  {
  ...
  public View a(int paramInt, Handler paramHandler, avff paramavff)
  {
    ...
    else
    {
      ...
      localURLImageView.setURLDrawableDownListener(new avfe(this, paramavff, paramInt));
      if (!bool1) {
        break label619;
      }
      l = 1000L;
      paramHandler.postDelayed(new PicBrowserImage.3(this, (URLDrawable)localObject1, paramavff, paramInt), l);
    }
    for (;;)
    {
      label441:
      ...
      for (;;)
      {
        ...
        if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.a))
        {
          ...
          try
          {
            localObject2 = baqq.a(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.a);
            localObject1 = localFile;
            ...
            ((URLDrawable)localObject2).setDownloadListener(new aupv(this.jdField_a_of_type_AndroidContentContext, "actNearbyPicBrowser"));
            localObject1 = localObject2;
            localURLImageView.setImageDrawable((Drawable)localObject2);
            localObject1 = localObject2;
            bool1 = bame.b(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.a);
            localObject1 = localObject2;
          }
  ...
  public void a()
  {
    ...
    try
    {
      localObject = baqq.a((String)localObject);
      if (localObject != null)
      {
        ...
        ((URLDrawable)localObject).setDownloadListener(new aupv(this.jdField_a_of_type_AndroidContentContext));
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.b)) {
        try
        {
          ...
          if (bame.b(((URL)localObject4).toString()))
          {
