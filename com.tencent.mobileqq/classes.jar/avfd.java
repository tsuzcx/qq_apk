...
public class avfd
{
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new avfe(this);
  protected Handler a;
  public avfa a;
  protected QQAppInterface a;
  Runnable jdField_a_of_type_JavaLangRunnable = new QzonePhotoGuideNotifyService.1(this);
  
  public avfd(QQAppInterface paramQQAppInterface, avfa paramavfa)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Avfa = paramavfa;
    if (paramQQAppInterface != null) {}
    try
    {
      paramavfa = new IntentFilter("com.qzonex.localalbum.new_photo_notification_feedback_action");
      paramQQAppInterface.getApp().registerReceiver(this.jdField_a_of_type_AndroidContentBroadcastReceiver, paramavfa);
      return;
    }
