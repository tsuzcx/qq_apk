  ...
  public static void a(ark.ModuleRegister paramModuleRegister, ark.Application paramApplication)
  {
    ...
    for (long l = 1L;; l = 0L)
    {
      ...
      for (localObject1 = ((ArkAppCenter)localObject1).a();; localObject1 = null)
      {
        ...
        ((List)localObject2).add(new aoqa(paramApplication, l));
        ((List)localObject2).add(new aonx(paramApplication, l));
        ((List)localObject2).add(new aool(paramApplication, l));
        if (1 == BaseApplicationImpl.sProcessId) {
          ((List)localObject2).add(new aoqz(paramApplication, l));
        }
        if (l == 0L) {
          ((List)localObject2).add(new aopt(paramApplication, l));
        }
        paramApplication = ((List)localObject2).iterator();
        while (paramApplication.hasNext())
        {
          localObject2 = (aopk)paramApplication.next();
          if (localObject1 != null) {
            ((aopk)localObject2).a((List)aoth.a.get(((aopk)localObject2).GetTypeName()));
          }
