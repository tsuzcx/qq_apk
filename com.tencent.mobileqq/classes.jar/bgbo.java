...
public class bgbo
{
  ...
  public static Pair<CharSequence, CharSequence> a(bayp parambayp)
  {
    if ((parambayp instanceof baxe)) {
      return ((baxe)parambayp).a();
    }
    if ((parambayp instanceof baxd)) {
      return ((baxd)parambayp).a();
    }
    return null;
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, int paramInt, String paramString2)
  {
    ...
    do
    {
      ...
      if (AppConstants.SYSTEM_MSG_UIN.equals(paramString1)) {
        return paramContext.getString(2131718751);
      }
      if (AppConstants.QQBROADCAST_MSG_UIN.equals(paramString1)) {
        return paramContext.getString(2131718750);
      }
  ...
  public static String a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localatvf = new atvf(new StringReader(paramString), paramString.length());
        paramString = null;
      }
  ...
  public static ArrayList<bgbq> a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (j >= 3)
    {
      ...
      if (j >= 3)
      {
        ...
        ((SpannableStringBuilder)localObject2).setSpan(new ForegroundColorSpan(BaseApplicationImpl.sApplication.getResources().getColor(2131167157)), 0, paramString.length(), 17);
        localArrayList.add(new bgbq((String)localObject1, 0, new Pair(localObject2, null)));
        i = m + 1;
      }
      label193:
      paramQQAppInterface = new bbee(paramQQAppInterface, 10001, 29, null);
      paramQQAppInterface.a();
      paramQQAppInterface = paramQQAppInterface.a(new bbfs(paramString));
    ...
    for (;;)
    {
      ...
      {
        paramString = (bayp)((Iterator)localObject1).next();
        if ((paramString.b() & 0xFFFFFFFF & 0xFF000000) >> 24 != 2L) {
          if (localArrayList.size() < i)
          {
            if ((paramString.d() == 0) || (paramString.d() == 1004))
            {
              ...
              localArrayList.add(new bgbq(paramString.b(), paramString.d(), paramQQAppInterface));
              j = m;
              if (!QLog.isColorLevel()) {
                continue;
              }
            ...
            for (paramString = "null";; paramString = paramString.a())
            {
              ...
              if (((String)localObject1).toLowerCase().startsWith(paramString.toLowerCase()))
              {
                ...
                ((SpannableStringBuilder)localObject3).setSpan(new ForegroundColorSpan(BaseApplicationImpl.sApplication.getResources().getColor(2131167157)), 1, paramString.length() + 1, 17);
                localArrayList.add(new bgbq((String)localObject1, 0, new Pair(localObject2, localObject3)));
                i = m + 1;
                break label193;
              }
              Object localObject3 = bbgk.a((String)localObject2, paramString, 1);
              if (localObject3[0] == 0)
              {
                i = localObject3[1];
                localObject2 = new SpannableStringBuilder((CharSequence)localObject2);
                ((SpannableStringBuilder)localObject2).setSpan(new ForegroundColorSpan(BaseApplicationImpl.sApplication.getResources().getColor(2131167157)), 0, i, 17);
                localArrayList.add(new bgbq((String)localObject1, 0, new Pair(localObject2, null)));
                i = m + 1;
                break label193;
              }
              localObject3 = bbgk.a((String)localObject2, paramString, 2);
              i = m;
              if (localObject3[0] != 0) {
                break label193;
              }
              ...
              i = m + 1;
              break label193;
              localArrayList.add(new bgbq(paramString.b(), paramString.d(), null));
              m = j;
              break label349;
              label767:
  ...
  public static void a(View paramView)
  {
    ...
    bgbp.jdField_c_of_type_Int = a(paramView.getContext());
    paramView = (Integer)paramView.getTag(2131380832);
    if (paramView != null) {}
    for (int i = paramView.intValue();; i = -1)
    {
      bgbp.jdField_e_of_type_Int = i + 1;
      if (bgbp.jdField_f_of_type_Int == 1)
      {
        bgbp.jdField_a_of_type_Long = bgbp.jdField_d_of_type_Long + (System.nanoTime() - bgbp.jdField_c_of_type_Long) / 1000000L;
        bgbp.jdField_b_of_type_Long = bgbp.jdField_f_of_type_Long + (System.nanoTime() - bgbp.jdField_e_of_type_Long) / 1000000L;
      }
      if (bgbp.jdField_d_of_type_Int == 1)
      {
        bgbp.h = -1;
        bgbp.i = -1;
        bgbp.j = -1;
      }
      localHashMap.put("keyNum", String.valueOf(bgbp.jdField_a_of_type_Int));
      localHashMap.put("firstKeyLen", String.valueOf(bgbp.jdField_b_of_type_Int));
      localHashMap.put("itemPage", String.valueOf(bgbp.jdField_c_of_type_Int));
      localHashMap.put("itemSearchStrategy", String.valueOf(bgbp.jdField_d_of_type_Int));
      localHashMap.put("itemPosition", String.valueOf(bgbp.jdField_e_of_type_Int));
      localHashMap.put("itemType", String.valueOf(bgbp.jdField_f_of_type_Int));
      localHashMap.put("itemUinType", String.valueOf(bgbp.g));
      if (bgbp.jdField_f_of_type_Int == 1)
      {
        localHashMap.put("totalCost", String.valueOf(bgbp.jdField_a_of_type_Long));
        localHashMap.put("searchCost", String.valueOf(bgbp.jdField_b_of_type_Long));
      }
      localHashMap.put("senderNum", String.valueOf(bgbp.h));
      localHashMap.put("friendNum", String.valueOf(bgbp.i));
      localHashMap.put("friendIndex", String.valueOf(bgbp.j));
      StatisticCollector.getInstance(BaseApplicationImpl.getApplication()).collectPerformance(null, "actFtsItemClickEvent", true, bgbp.jdField_a_of_type_Long, bgbp.jdField_b_of_type_Long, localHashMap, "", false);
      if ((bgbp.jdField_f_of_type_Int == 1) && (QLog.isColorLevel())) {
        QLog.d("Q.fts.utils", 2, "actFtsItemClickEvent: totalCost = " + bgbp.jdField_a_of_type_Long + ", searchCost = " + bgbp.jdField_b_of_type_Long);
      }
      return;
    }
  }
  ...
  public static String[] b(String paramString)
  {
    ...
    paramString = new atvg(new StringReader(paramString));
    try
    {
      for (;;)
      {
        atvc localatvc = paramString.a();
        if (localatvc == null) {
          break;
        }
        if (!TextUtils.isEmpty(localatvc.a()))
        {
          ((StringBuilder)localObject).append(localatvc.a());
