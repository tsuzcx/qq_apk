...
public class wey
{
  ...
  private void a(TextureView paramTextureView, wez paramwez)
  {
    a().postDelayed(new VideoFrameCheckHelper.1(this, paramTextureView, paramwez), 20L);
  }
  ...
  private boolean a(TextureView paramTextureView)
  {
    ...
    if (paramTextureView.isAvailable())
    {
      ...
      for (this.jdField_a_of_type_AndroidGraphicsBitmap = Bitmap.createBitmap(paramTextureView.getResources().getDisplayMetrics(), i, j, Bitmap.Config.ARGB_8888);; this.jdField_a_of_type_AndroidGraphicsBitmap = Bitmap.createBitmap(i, j, Bitmap.Config.ARGB_8888))
      {
        ...
        if (!tin.a(this.jdField_a_of_type_AndroidGraphicsBitmap, 4, 16)) {
          break;
        }
  ...
  public void a(View paramView, wez paramwez)
  {
    if ((paramView == null) || (paramwez == null)) {}
    do
    {
      return;
      paramView = tin.a(paramView);
    } while (paramView == null);
    this.jdField_a_of_type_Long = System.currentTimeMillis();
    a(paramView, paramwez);
  }
}
