  ...
  implements aeyt, View.OnClickListener
{
  ...
  public aeym(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, aeyv paramaeyv, BaseChatPie paramBaseChatPie, MqqHandler paramMqqHandler)
  {
  ...
  public static aeyn a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (localSharedPreferences != null)
    {
      ...
      if (!TextUtils.isEmpty(paramQQAppInterface)) {
        try
        {
          paramQQAppInterface = new aeyn(new JSONObject(paramQQAppInterface));
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, aeyn paramaeyn, String paramString2)
  {
    if (QLog.isColorLevel()) {
    ...
    if (paramaeyn != null)
    {
      paramQQAppInterface.a().b(paramString1, 1008, paramaeyn.jdField_d_of_type_Long, true);
      if (QLog.isColorLevel()) {
        QLog.i("PubAccountTips", 2, "removeMsgByUniseq. uniqSeqno:" + paramaeyn.jdField_d_of_type_Long);
      }
    }
    paramaeyn = localSharedPreferences.edit();
    paramQQAppInterface = "selfuin_" + paramQQAppInterface.getCurrentAccountUin() + "_puin_" + paramString1 + "_msgdata";
    if (paramString2 != null) {
      paramaeyn.putString(paramQQAppInterface, paramString2);
    }
    for (;;)
    {
      paramaeyn.commit();
      return;
      paramaeyn.remove(paramQQAppInterface);
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte)
  {
    ...
    //   152: dup
    //   153: aload_1
    //   154: invokespecial 90	aeyn:<init>	(Lorg/json/JSONObject;)V
    //   157: astore_3
    //   158: aload_3
    //   159: invokevirtual 221	aeyn:a	()Z
    //   162: ifeq -158 -> 4
    //   165: aload_3
    //   166: getfield 224	aeyn:jdField_b_of_type_Int	I
    //   169: iconst_1
    //   170: if_icmpne +145 -> 315
    //   173: sipush -2011
    //   176: invokestatic 229	axas:a	(I)Lcom/tencent/mobileqq/data/MessageRecord;
    ...
    //   202: aload_3
    //   203: getfield 235	aeyn:jdField_a_of_type_Long	J
    ...
    //   212: astore 7
    //   214: aload_3
    //   215: getfield 238	aeyn:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   218: astore 6
    //   220: aload 4
    //   222: aload 5
    //   224: aload 7
    ...
    //   241: invokestatic 247	axva:a	()Lcom/tencent/mobileqq/structmsg/StructMsgForGeneralShare;
    //   244: astore 7
    //   246: aload 7
    //   248: aload 6
    ...
    //   253: aload 7
    //   255: aload_3
    //   256: getfield 255	aeyn:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   337: aload_3
    //   338: getfield 289	aeyn:jdField_a_of_type_Int	I
    ...
    //   388: aload_3
    //   389: getfield 235	aeyn:jdField_a_of_type_Long	J
    ...
    //   398: invokestatic 292	aeym:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;)Laeyn;
    //   401: astore 4
    //   403: aload_0
    ...
    //   416: aload_3
    //   417: getfield 235	aeyn:jdField_a_of_type_Long	J
    ...
    //   432: invokestatic 294	aeym:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Laeyn;Ljava/lang/String;)V
    //   435: aload_0
    //   436: ldc_w 296
  ...
  public View a(Object... paramVarArgs)
  {
    ...
    {
      if (this.jdField_a_of_type_Aeyn.jdField_a_of_type_Int != 1) {
        break label106;
      }
      paramVarArgs.setBackgroundResource(2131165784);
      ((TextView)paramVarArgs.findViewById(2131362406)).setText(this.jdField_a_of_type_Aeyn.jdField_a_of_type_JavaLangString);
      localImageView = (ImageView)paramVarArgs.findViewById(2131362402);
      String str = this.jdField_a_of_type_Aeyn.jdField_b_of_type_JavaLangString;
      if (TextUtils.isEmpty(str)) {
        break label127;
      }
      localImageView.setImageDrawable(aywm.a(str, null, null));
    }
    for (;;)
    {
      ...
      return paramVarArgs;
      label106:
      if (this.jdField_a_of_type_Aeyn.jdField_a_of_type_Int != 2) {
        break;
      }
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Aeyn = paramVarArgs;
    } while (!this.jdField_a_of_type_Aeyv.a(this, new Object[0]));
    axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "school", "school.aio.tips.show", 0, 0, "" + paramVarArgs.jdField_d_of_type_Int, "", "", "");
    return;
    if (QLog.isColorLevel()) {
  ...
  {
    Object localObject;
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1008) && (this.jdField_a_of_type_Aeyn != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_Aeyn.jdField_c_of_type_JavaLangString)))
    {
      ...
      if (localObject != null)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("PubAccountTips", 2, "clickedTimes:" + (this.jdField_a_of_type_Aeyn.e + 1));
        }
        aeyn localaeyn = this.jdField_a_of_type_Aeyn;
        int i = localaeyn.e + 1;
        localaeyn.e = i;
        if (i < this.jdField_a_of_type_Aeyn.jdField_c_of_type_Int) {
          break label313;
        }
        a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "" + this.jdField_a_of_type_Aeyn.jdField_a_of_type_Long, this.jdField_a_of_type_Aeyn, null);
    ...
    for (;;)
    {
      ...
      ((Intent)localObject).putExtra("url", this.jdField_a_of_type_Aeyn.jdField_c_of_type_JavaLangString);
      paramView.startActivity((Intent)localObject);
      axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "school", "school.aio.tips.click", 0, 0, "" + this.jdField_a_of_type_Aeyn.jdField_d_of_type_Int, "", "", "");
      return;
      label313:
      localObject = ((SharedPreferences)localObject).edit();
      try
      {
        this.jdField_a_of_type_Aeyn.jdField_a_of_type_OrgJsonJSONObject.put("clicked", this.jdField_a_of_type_Aeyn.e);
        ((SharedPreferences.Editor)localObject).putString(paramView, this.jdField_a_of_type_Aeyn.jdField_a_of_type_OrgJsonJSONObject.toString()).commit();
      }
