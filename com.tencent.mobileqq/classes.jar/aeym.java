...
public class aeym
  implements afak, bhye
{
  private Activity jdField_a_of_type_AndroidAppActivity;
  private bccy jdField_a_of_type_Bccy;
  private TroopChatPie jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie;
  
  public aeym(TroopChatPie paramTroopChatPie)
  {
  ...
  private boolean a(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if ((paramInt3 == 1) && ((paramCharSequence.charAt(paramInt1) == 65312) || (paramCharSequence.charAt(paramInt1) == '@')))
    {
      ...
      if ((bool1) || (bool2))
      {
        ...
        if (this.jdField_a_of_type_Bccy == null)
        {
          if (this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie.a().findViewById(2131362249) == null)
          {
            ...
            ((RelativeLayout)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131364137)).addView(paramCharSequence, 3, (ViewGroup.LayoutParams)localObject);
          }
          this.jdField_a_of_type_Bccy = new bccy(this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie);
      ...
      j = bcde.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx);
      paramInt3 = bcde.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx);
      if (i - 1 < 0) {
        break label596;
      }
    }
    ...
    for (paramCharSequence = this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx.getText().toString().substring(i - 1, i);; paramCharSequence = null)
    {
      if ((paramInt3 >= 0) && (paramInt3 == i))
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("AIOAtHelper", 2, "selectIndex =" + i + " isFirstAddAt=" + bool1 + " isFirstBackAt=" + bool2 + " max=" + paramInt1 + " lastSpanAt=" + j + " mAtPanel=" + this.jdField_a_of_type_Bccy);
        }
        if ((j >= paramInt1) || (paramInt1 < 0) || (this.jdField_a_of_type_Bccy == null)) {
          break label569;
        }
        ...
        bool1 = bcde.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx, this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        localObject = this.jdField_a_of_type_AndroidAppActivity.findViewById(2131362249);
        this.jdField_a_of_type_Bccy.a((View)localObject, paramCharSequence, bool1);
      }
      for (;;)
      {
        return false;
        ...
        paramInt3 = 0;
        break label378;
        if ((this.jdField_a_of_type_Bccy != null) && (paramInt3 == 0) && (paramInt2 == 0)) {
          this.jdField_a_of_type_Bccy.a();
        }
      }
    }
  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Bccy != null)
    {
      ...
      this.jdField_a_of_type_Bccy = null;
    }
  }
  ...
  public void a(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if ((this.jdField_a_of_type_Bccy != null) && (this.jdField_a_of_type_Bccy.b())) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      do
      {
        ...
        paramCharSequence = bcde.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx);
        paramInt2 = bcde.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx);
    ...
    } while (this.jdField_a_of_type_Bccy == null);
    this.jdField_a_of_type_Bccy.a(paramCharSequence.a());
  }
  
  public boolean a()
  {
    return (this.jdField_a_of_type_Bccy != null) && (this.jdField_a_of_type_Bccy.a());
  }
  
  public boolean a(KeyEvent paramKeyEvent)
  {
    return (paramKeyEvent.getKeyCode() == 4) && (this.jdField_a_of_type_Bccy != null) && (this.jdField_a_of_type_Bccy.a());
  }
