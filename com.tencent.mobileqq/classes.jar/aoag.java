...
public class aoag
{
  ...
  public void a(aoaf paramaoaf)
  {
    try
    {
      aoaf.a(paramaoaf, true);
      if (this.jdField_a_of_type_Aoaf == paramaoaf) {
  ...
  public void a(javax.microedition.khronos.opengles.GL10 paramGL10)
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 50	aoag:b	Z
    //   8: ifne +65 -> 73
    //   11: aload_0
    //   12: invokespecial 52	aoag:a	()V
    //   15: aload_1
    //   16: sipush 7937
    //   19: invokeinterface 58 2 0
    //   24: astore_1
    //   25: aload_0
    //   26: getfield 33	aoag:jdField_a_of_type_Int	I
    //   29: ldc 34
    //   31: if_icmpge +23 -> 54
    //   34: aload_1
    //   35: ldc 60
    ...
    //   45: aload_0
    //   46: iload_2
    //   47: putfield 36	aoag:c	Z
    //   50: aload_0
    //   51: invokevirtual 47	java/lang/Object:notifyAll	()V
    //   54: aload_0
    //   55: getfield 36	aoag:c	Z
    //   58: ifne +23 -> 81
    //   61: iload_3
    //   62: istore_2
    //   63: aload_0
    //   64: iload_2
    //   65: putfield 68	aoag:d	Z
    //   68: aload_0
    //   69: iconst_1
    //   70: putfield 50	aoag:b	Z
    //   73: aload_0
    //   74: monitorexit
    //   75: return
    //   76: iconst_0
  ...
  public boolean a(aoaf paramaoaf)
  {
    if ((this.jdField_a_of_type_Aoaf == paramaoaf) || (this.jdField_a_of_type_Aoaf == null))
    {
      this.jdField_a_of_type_Aoaf = paramaoaf;
      notifyAll();
    }
    do
    {
    ...
    if (this.jdField_a_of_type_Aoaf != null) {
      this.jdField_a_of_type_Aoaf.e();
    }
    return false;
  }
  
  public void b(aoaf paramaoaf)
  {
    if (this.jdField_a_of_type_Aoaf == paramaoaf) {
      this.jdField_a_of_type_Aoaf = null;
    }
  ...
  public boolean b()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: invokespecial 52	aoag:a	()V
    //   6: aload_0
    //   7: getfield 36	aoag:c	Z
    //   10: istore_1
    //   11: iload_1
    //   12: ifne +9 -> 21
    //   15: iconst_1
