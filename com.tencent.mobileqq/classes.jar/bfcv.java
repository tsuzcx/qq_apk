...
public class bfcv
{
  public static Intent a(Activity paramActivity, String paramString1, String paramString2)
  {
    ...
    paramString1.putExtra("custom_title_name", paramActivity.getString(2131697210));
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2, QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      bcef.b(paramQQAppInterface, "P_CliOper", "Grp_flower", "", "mber", "exp", 0, 0, paramString1, i + "", "", "");
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramQQAppInterface != null)
        {
          ...
          String str2 = aqhd.a().troopGiftUrl;
          localObject = str2;
          if (!TextUtils.isEmpty(str2))
          {
            localObject = new bfcy();
            ((bfcy)localObject).a = paramString1;
            ((bfcy)localObject).c = paramString4;
            ((bfcy)localObject).b = paramString2;
            ((bfcy)localObject).e = paramString3;
            localObject = localbfcx.a(str2, (bfcy)localObject);
          }
        }
      ...
      catch (UnsupportedEncodingException localUnsupportedEncodingException)
      {
        ...
        if (paramQQAppInterface != null)
        {
          ...
          if (paramActivity != null)
          {
            ...
            i = 0;
            bcef.b(paramQQAppInterface, "P_CliOper", "Grp_flower", "", "mber", "send_page", 0, 0, paramString1, i + "", "", "");
          }
        }
      }
      if (!QLog.isColorLevel()) {
  ...
  {
    String str = b(paramMessageForDeliverGiftTips);
    if ((aqhd.a().isEnable()) && (!TextUtils.isEmpty(paramMessageForDeliverGiftTips.animationPackageUrl))) {
