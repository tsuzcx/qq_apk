  ...
  extends MSFServlet
{
  ...
  private static mobile_monitor_report.UserCommReport a()
  {
    ...
    localUserCommReport.imei.set(String.valueOf(bjve.c()));
    String str = apch.b();
    ...
    if (i == 1000) {
      try
      {
        ...
        if (i == 0)
        {
          ...
          notifyObserver(paramIntent, 1000, true, new Bundle(), bnwf.class);
          return;
        }
        QLog.d("MonitorServlet", 2, "onReceive ret " + i);
        notifyObserver(paramIntent, 1000, false, new Bundle(), bnwf.class);
        return;
      }
  ...
  public static void a(List<mobile_monitor_report.ExceptionReport> paramList)
  {
    ...
    paramList = new NewIntent(localAppRuntime.getApplication(), bnwg.class);
    ...
    paramList.putExtra("data", bhuf.a(localUniSsoServerReq.toByteArray()));
