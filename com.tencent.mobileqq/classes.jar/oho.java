...
{
  private static oho jdField_a_of_type_Oho;
  private BackgroundColorSpan jdField_a_of_type_AndroidTextStyleBackgroundColorSpan;
  
  public static oho a()
  {
    if (jdField_a_of_type_Oho == null) {
      jdField_a_of_type_Oho = new oho();
    }
    return jdField_a_of_type_Oho;
  }
  ...
  public boolean onTouchEvent(TextView paramTextView, Spannable paramSpannable, MotionEvent paramMotionEvent)
  {
    ...
    if ((i == 1) || (i == 0) || (i == 2) || (i == 3))
    {
      ...
      if ((paramTextView.getTag(2131374827) != null) && ((paramTextView.getTag(2131374827) instanceof Boolean)) && (((Boolean)paramTextView.getTag(2131374827)).booleanValue()))
      {
        ...
        {
          return true;
          ((LinearLayout)paramTextView.getParent()).setBackgroundDrawable(paramTextView.getResources().getDrawable(2130848383));
          continue;
          ((LinearLayout)paramTextView.getParent()).setBackgroundDrawable(paramTextView.getResources().getDrawable(2130848385));
        }
      }
    }
    return false;
