  ...
  extends arcp
{
  ...
  public arcu(Intent paramIntent, arcz paramarcz)
  {
  ...
  public int a(android.content.Context paramContext, String paramString)
  {
    ...
    //   345: aload_2
    //   346: astore 7
    //   348: invokestatic 135	ardb:a	()Lardb;
    //   351: aload 9
    ...
    //   361: invokevirtual 138	ardb:a	(Ljava/lang/String;Ljava/lang/String;)I
    //   364: pop
    //   365: aload 6
    //   367: astore 8
    //   369: aload_2
    //   370: astore 7
    //   372: aload_0
    //   373: getfield 29	arcu:jdField_a_of_type_ComTencentMobileqqJspFaceDetectForThirdPartyManager$AppConf	Lcom/tencent/mobileqq/jsp/FaceDetectForThirdPartyManager$AppConf;
    //   376: ifnull +540 -> 916
    //   379: aload 6
    //   381: astore 8
    //   383: aload_2
    //   384: astore 7
    //   386: aload_0
    //   387: getfield 29	arcu:jdField_a_of_type_ComTencentMobileqqJspFaceDetectForThirdPartyManager$AppConf	Lcom/tencent/mobileqq/jsp/FaceDetectForThirdPartyManager$AppConf;
    ...
    //   400: aload_2
    //   401: astore 7
    //   403: invokestatic 135	ardb:a	()Lardb;
    //   406: iconst_5
    //   407: invokevirtual 145	ardb:a	(I)Lorg/json/JSONObject;
    //   410: astore 9
    //   412: aload 9
    ...
    //   536: astore 7
    //   538: aload_0
    //   539: getfield 29	arcu:jdField_a_of_type_ComTencentMobileqqJspFaceDetectForThirdPartyManager$AppConf	Lcom/tencent/mobileqq/jsp/FaceDetectForThirdPartyManager$AppConf;
    ...
    //   617: ldc 165
    //   619: aload_0
    //   620: getfield 29	arcu:jdField_a_of_type_ComTencentMobileqqJspFaceDetectForThirdPartyManager$AppConf	Lcom/tencent/mobileqq/jsp/FaceDetectForThirdPartyManager$AppConf;
  ...
  public void a(boolean paramBoolean, Activity paramActivity)
  {
    ...
    if (paramBoolean)
    {
      ...
      localObject = axhr.a().jdField_a_of_type_AndroidHardwareCamera;
      i = axhr.a().jdField_a_of_type_Int;
    ...
    localYtSDKPlatformContex.reflectListener = new arcv(this);
    ...
    JSONObject localJSONObject = ardb.a().a(5);
    ...
    QLog.d("qq_Identification.Model", 1, new Object[] { "YtSDKKitFramework init result : ", Integer.valueOf(YtSDKKitFramework.getInstance().init(localYtSDKPlatformContex, localJSONObject, (YtSDKKitFramework.YtSDKKitFrameworkWorkMode)localObject, localArrayList, new arcw(this))) });
  }
