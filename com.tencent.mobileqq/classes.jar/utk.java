  ...
  implements View.OnClickListener
{
  ...
  public utk(Context paramContext)
  {
    super(paramContext);
  }
  
  public utk(Context paramContext, WSVerticalPageFragment paramWSVerticalPageFragment)
  {
    this(paramContext);
  ...
  private void a(stSimpleMetaPerson paramstSimpleMetaPerson)
  {
    ...
    upe.d("WSVerticalItemTopController", "followStatus:" + i + ",personInfo hashCode:" + paramstSimpleMetaPerson.hashCode());
  ...
  {
    uut.c(this.jdField_a_of_type_ComTencentBizPubaccountWeishi_newVerticalvideoWSVerticalPageFragment.a(), this.jdField_a_of_type_ComTencentBizPubaccountWeishi_newVerticalvideoWSVerticalPageFragment.b(), paramInt, this.jdField_a_of_type_UserGrowthStSimpleMetaFeed);
  }
  ...
  private void b(stSimpleMetaPerson paramstSimpleMetaPerson)
  {
    ...
    for (;;)
    {
      upe.b("WSVerticalItemTopController", "Jump to personal page.");
      return;
      Object localObject = paramstSimpleMetaPerson.miniAppSchema;
      upe.d("weishi", "miniShema is :" + (String)localObject);
      ujd.a().a(this.jdField_a_of_type_AndroidContentContext, paramstSimpleMetaPerson.miniAppSchema);
      b(1000001);
      continue;
      ...
      {
        upg.a(this.jdField_a_of_type_AndroidContentContext, "biz_src_jc_gzh_weishi", paramstSimpleMetaPerson, 1, i, 1);
        b(1000003);
      }
      for (;;)
      {
        upe.d("weishi", "schema is :" + paramstSimpleMetaPerson);
        break;
        ...
        ((WSDownloadParams)localObject).mTestId = ups.a(2);
        ...
        ugx.a(this.jdField_a_of_type_ComTencentBizPubaccountWeishi_newVerticalvideoWSVerticalPageFragment.getActivity(), (WSDownloadParams)localObject, false);
        b(1000002);
      }
      paramstSimpleMetaPerson = paramstSimpleMetaPerson.H5Url;
      uee.a(this.jdField_a_of_type_AndroidContentContext, paramstSimpleMetaPerson);
      upe.d("weishi", "h5Url is :" + paramstSimpleMetaPerson);
      b(1000004);
    }
  }
  ...
  private void f()
  {
    ...
    do
    {
      do
      {
        ...
        upe.b("WSVerticalItemTopController", "Follow user.");
      } while (!(((uru)localObject).a() instanceof stSimpleMetaFeed));
      localObject = ((stSimpleMetaFeed)((uru)localObject).a()).poster;
    } while (localObject == null);
    if (uov.a(((stSimpleMetaPerson)localObject).followStatus))
    {
      uov.a(a(), new utl(this, (stSimpleMetaPerson)localObject), null);
      return;
    }
    this.jdField_a_of_type_Ugn.b(((stSimpleMetaPerson)localObject).id, 1);
    ((stSimpleMetaPerson)localObject).followStatus = 1;
    this.b.setText("已关注");
    upe.a("WSVerticalItemTopController", "---> followStatus:" + ((stSimpleMetaPerson)localObject).followStatus + ",personInfo hashCode:" + localObject.hashCode());
    this.b.setVisibility(8);
  }
  ...
  protected void b()
  {
    upe.a("WSVerticalItemTopController", "onUpdateUI hashcode******************************" + hashCode() + ",position:" + a());
    ...
    ups.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentBizPubaccountWeishi_newViewRoundImageView, ((stSimpleMetaPerson)localObject).avatar);
  ...
  {
    stSimpleMetaPerson localstSimpleMetaPerson = ((stSimpleMetaFeed)((uru)a()).a()).poster;
