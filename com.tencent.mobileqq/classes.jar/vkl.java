  ...
  extends AsyncTask<Void, Void, Integer>
{
  ...
  public vkl(Activity paramActivity, String paramString1, String paramString2, int paramInt1, WeakReference<AppInterface> paramWeakReference, int paramInt2)
  {
  ...
  {
    if (!axlj.d((AppInterface)this.jdField_a_of_type_MqqUtilWeakReference.get())) {
      return -1002;
    }
    axlj.d(null);
    ...
    ((axkf)localObject).jdField_b_of_type_JavaLangString = paramString1;
    ...
    for (;;)
    {
      ...
      {
        i = axkm.a(paramString3, paramString1, paramString4, 0);
        paramString2.delete();
        if (i != 0)
        {
  ...
  protected void a(Integer paramInteger)
  {
    ...
    a(ajyc.a(2131716359) + paramInteger, null);
  }
  
  protected void onPreExecute()
  {
    a(this.jdField_a_of_type_AndroidAppActivity, 2131695125);
  }
}
