...
public class bbae
{
  ...
  public static Bitmap a(int paramInt, Bitmap.Config paramConfig, Bitmap[] paramArrayOfBitmap)
  {
    ...
    Object localObject = new bbag[j];
    i = 0;
    while (i < j)
    {
      localObject[i] = new bbag(null);
      i += 1;
    }
  ...
  public static Bitmap a(int paramInt, Bitmap[] paramArrayOfBitmap)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        arrayOfbbag = new bbag[i];
        j = 0;
        while (j < i)
        {
          arrayOfbbag[j] = new bbag(null);
          j += 1;
        }
        ...
        arrayOfbbag[0].a = 0;
        arrayOfbbag[0].b = 0;
        arrayOfbbag[0].c = (paramInt / 2 - 1);
        arrayOfbbag[0].d = paramInt;
        arrayOfbbag[0].e = 1;
        arrayOfbbag[1].a = (paramInt / 2 + 1);
        arrayOfbbag[1].b = 0;
        arrayOfbbag[1].c = paramInt;
        arrayOfbbag[1].d = paramInt;
        arrayOfbbag[1].e = 1;
        paramInt = 0;
    ...
    if (arrayOfbbag[paramInt].e == 1) {
      localRect.set(j / 4, 0, j / 4 * 3, k);
    }
    for (;;)
    {
      localRectF.set(arrayOfbbag[paramInt].a, arrayOfbbag[paramInt].b, arrayOfbbag[paramInt].c, arrayOfbbag[paramInt].d);
      ...
      if (i == 3)
      {
        ...
        arrayOfbbag[1].b = 0;
        arrayOfbbag[1].c = paramInt;
        arrayOfbbag[1].d = (paramInt / 2 - 1);
        arrayOfbbag[1].e = 2;
        arrayOfbbag[2].a = (paramInt / 2 + 1);
        arrayOfbbag[2].b = (paramInt / 2 + 1);
        arrayOfbbag[2].c = paramInt;
        arrayOfbbag[2].d = paramInt;
        arrayOfbbag[2].e = 2;
        break;
      }
      if (i < 4) {
      ...
      arrayOfbbag[2].e = 2;
      arrayOfbbag[3].a = 0;
      arrayOfbbag[3].b = (paramInt / 2 + 1);
      arrayOfbbag[3].c = (paramInt / 2 - 1);
      arrayOfbbag[3].d = paramInt;
      arrayOfbbag[3].e = 2;
      break;
