  ...
  extends bdsh
{
  ...
  {
    paramString = "_data='" + bdtx.a(paramString) + "' COLLATE NOCASE";
  ...
  {
    return AlbumThumbManager.getInstance(BaseApplicationImpl.getContext()).getThumb(paramDownloadParams.url, new beaf(this));
  }
}
