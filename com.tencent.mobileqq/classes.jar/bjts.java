...
public class bjts
{
  private static bjts jdField_a_of_type_Bjts;
  ...
  public static bjts a()
  {
    try
    {
      if (jdField_a_of_type_Bjts == null) {
        jdField_a_of_type_Bjts = new bjts();
      }
      bjts localbjts = jdField_a_of_type_Bjts;
      return localbjts;
    }
    finally {}
  }
  ...
  public void a(String paramString1, String paramString2, Downloader.DownloadListener paramDownloadListener)
  {
    ...
    paramDownloadListener = new bjtt(this, paramString2, paramDownloadListener, paramString1);
    paramString2 = jdField_a_of_type_JavaIoFile.getAbsolutePath() + "/tmp" + paramString2;
    this.jdField_a_of_type_Bjgf.a(paramString1, paramString2, paramDownloadListener);
  }
  ...
  public boolean a(String paramString, boolean paramBoolean)
  {
    ...
    if (localFile.length() == a(paramString)) {
      if (paramBoolean)
      {
        String str1 = bflr.a(b(paramString));
  ...
  public void b()
  {
    QzoneModuleManager.getInstance().downloadModule("pictureMarkerSo.zip", new bjtu(this));
  }
  ...
  public void c()
  {
    QzoneModuleManager.getInstance().downloadModule("libandroidndkbeauty.so", new bjtv(this));
  }
}
