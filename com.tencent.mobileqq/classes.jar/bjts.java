  ...
  extends bjxl
{
  ...
  ThreadExcutor.IThreadListener jdField_a_of_type_ComTencentMobileqqAppThreadExcutor$IThreadListener = new bjtt(this);
  ...
  public bjts(@NonNull bjxn parambjxn)
  {
    super(parambjxn);
  ...
  {
    if ((this.jdField_a_of_type_Bjyv.getActivity() == null) || (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))) {}
  ...
  private void j()
  {
    bkld localbkld = new bkld(this.jdField_a_of_type_Bjxn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams);
    localbkld.b = bklw.a(2);
    localbkld.a = new bklj(this.jdField_a_of_type_Bjxn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a.a());
    Iterator localIterator = this.jdField_a_of_type_Bjxn.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
      ((bjxl)localIterator.next()).a(0, localbkld);
    }
    ved.d("EditPicSave", "PUBLISH start ...");
    a(ajya.a(2131703697), false, 0);
    a(20);
    Stream.of(localbkld).map(new bklg((bjsu)a(bjsu.class), null)).map(new ThreadOffFunction("EditPicSave", 2)).map(new bklu(bjtm.jdField_a_of_type_JavaLangString + "qq_pic_merged_" + System.currentTimeMillis() + ".jpg", true, null)).map(new UIThreadOffFunction(this)).subscribe(new bjtu(this));
  }
  
  public void a(int paramInt)
  {
    if (this.jdField_b_of_type_Boolean) {}
    while (this.jdField_a_of_type_Bcpu == null) {
      return;
    }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Bjyv.a().postDelayed(new EditPicSave.4(this), 1000L);
  }
