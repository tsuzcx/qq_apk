  ...
  implements bghq, bgvx
{
  ...
  private bgwh jdField_a_of_type_Bgwh;
  ...
  private MiniGameInfo a(MiniAppInfo paramMiniAppInfo)
  {
    ...
    for (localObject1 = new GameDebugInfo(paramMiniAppInfo.debugInfo.wsUrl, paramMiniAppInfo.debugInfo.roomId, 8507);; localObject1 = null)
    {
      ...
      for (localObject2 = Collections.singletonList(new GamePluginInfo(((MiniGamePluginInfo)localObject2).name, ((MiniGamePluginInfo)localObject2).id, ((MiniGamePluginInfo)localObject2).version, bgrb.a((MiniGamePluginInfo)localObject2) + File.separator + "plugin.js"));; localObject2 = null)
      {
        localObject1 = new MiniGameInfo(paramMiniAppInfo.appId, bgrb.a(paramMiniAppInfo), null, (GameDebugInfo)localObject1, (List)localObject2);
        return localObject1;
      }
    }
  }
  ...
  private VConsoleDragView a()
  {
    ...
    localVConsoleDragView.setImageResource(2130840895);
  ...
  private String b(bgid parambgid)
  {
    ...
    for (;;)
    {
      ...
      {
        QMLog.e("GamePage", parambgid.a + " error.", localJSONException);
        return "";
      }
  ...
  private void c(ViewGroup paramViewGroup)
  {
    ...
    do
    {
      ...
      bgux.a().a(this.jdField_a_of_type_AndroidAppActivity, (ViewGroup)this.jdField_a_of_type_AndroidViewView);
  ...
  private void e()
  {
    Object localObject = bgtp.a(this.jdField_a_of_type_Bgho);
    label39:
    int j;
    int i;
    int k;
  ...
  {
    return new bgka().b(this.jdField_a_of_type_Int).c(this.b).a();
  }
  ...
  public String a()
  {
    ...
    label50:
    for (localObject = ((bgun)localObject).a;; localObject = null)
    {
      if (localObject != null) {
  ...
  {
    if ("getMenuButtonBoundingClientRect".equals(parambgid.a)) {
      return b(parambgid);
    }
    return "";
  }
  ...
  public void a(bgho parambgho)
  {
    ...
    this.jdField_a_of_type_ComTencentQqminiSdkMinigameWidgetGameNavigationBar = new GameNavigationBar(parambgho.a());
    this.jdField_a_of_type_ComTencentQqminiSdkMinigameWidgetGameNavigationBar.setContentDescription("NavigationBar");
    this.jdField_a_of_type_ComTencentQqminiSdkMinigameWidgetGameNavigationBar.setId(2131370585);
    this.jdField_a_of_type_ComTencentQqminiSdkMinigameWidgetGameNavigationBar.a(parambgho);
    this.jdField_a_of_type_ComTencentQqminiSdkMinigameWidgetGameNavigationBar.a(a());
    this.jdField_a_of_type_Bgwh = new bgwh();
    bgwk.a().a(Process.myPid(), this.jdField_a_of_type_Bgwh);
  }
  ...
  public void c()
  {
    ...
    ((KingCardProxy)ProxyManager.get(KingCardProxy.class)).showKingCardTips(new bghp(this.jdField_a_of_type_Bgho), localImageView);
  }
  ...
  {
    f();
    this.jdField_a_of_type_Bgwh.a(this.jdField_a_of_type_ComTencentQqminiSdkMinigameUiVConsoleView, this.jdField_a_of_type_ComTencentQqminiSdkMinigameUiVConsoleDragView, true);
  }
