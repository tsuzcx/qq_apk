...
public class bgbf
{
  ...
  public static PluginRecord a(File paramFile)
  {
    ...
    //   33: aload_0
    //   34: iconst_0
    //   35: invokestatic 112	baaw:decode	([BI)[B
  ...
  public static void a(Context paramContext, Map<String, PluginRecord> paramMap)
  {
    ...
    boolean bool = bfdr.a((File)localObject);
  ...
  public static void a(Context paramContext, Map<String, PluginRecord> paramMap, bgat parambgat)
  {
      ...
      if (i < j)
      {
        ...
        if (localFile.exists())
        {
          ...
          if (localPluginRecord != null)
          {
            boolean bool = true;
            if (parambgat != null) {
              bool = parambgat.a(localPluginRecord, localFile);
            }
            if (!bool) {
              break label98;
            }
  ...
  private static boolean a(File paramFile, PluginRecord paramPluginRecord)
  {
    ...
    //   51: iconst_0
    //   52: invokestatic 355	baaw:encode	([BI)[B
    //   55: astore_1
  ...
  {
    return paramFile.listFiles(new bgbg());
  }
