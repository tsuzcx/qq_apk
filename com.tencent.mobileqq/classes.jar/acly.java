...
public class acly
{
  public static aclx a(Context paramContext, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        if (TextUtils.isEmpty(paramContext))
        {
          ...
          if (i < paramContext.length())
          {
            ...
            paramString.add(new aclx(localJSONObject));
            break label130;
          }
        }
        else
      ...
      catch (JSONException paramContext)
      {
        ...
        if (paramString.size() > 1) {
          Collections.sort(paramString, new aclz());
        }
        if (paramString.size() > 0) {
          return (aclx)paramString.get(0);
        }
        return null;
      }
      label125:
  ...
  public static void a(Context paramContext, aclx paramaclx)
  {
    int i = 0;
    if (paramaclx == null) {
      return;
    ...
    for (;;)
    {
      try
      {
        ...
        if (TextUtils.isEmpty((CharSequence)localObject))
        {
          ...
          ((JSONArray)localObject).put(new JSONObject(paramaclx.e()));
      ...
      {
        localObject = new aclx(((JSONArray)localObject).getJSONObject(0));
        if (localObject != null)
        {
          int j = ((aclx)localObject).a();
          int k = paramaclx.a();
          if (j >= k) {}
        }
        else
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (TextUtils.isEmpty(paramString))
        {
          ...
          localObject3 = new aclx((JSONObject)localObject2).a();
