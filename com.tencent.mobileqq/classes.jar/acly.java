...
{
  private AdIPCManager.Callback jdField_a_of_type_ComTencentAdTangramIpcAdIPCManager$Callback = new aclz(this);
  private GdtInterstitialParams jdField_a_of_type_ComTencentGdtadApiInterstitialGdtInterstitialParams;
  private boolean jdField_a_of_type_Boolean;
  private boolean b;
  private boolean c;
  
  public acly(Context paramContext, GdtInterstitialParams paramGdtInterstitialParams)
  {
    this.jdField_a_of_type_ComTencentGdtadApiInterstitialGdtInterstitialParams = paramGdtInterstitialParams;
    acsb.a().a(paramContext, null);
    if (acmb.a().a(paramContext)) {
      acme.a().b(paramContext);
    }
  }
  ...
  public void a(Activity paramActivity)
  {
    ...
    for (;;)
    {
      acqy.b("GdtInterstitialAd", String.format("close %b", new Object[] { Boolean.valueOf(bool) }));
      Object localObject = a();
      if (bool) {}
      for (;;)
      {
        acrl.b(paramActivity, (GdtInterstitialParams)localObject, i);
        return;
  ...
  {
    acqy.b("GdtInterstitialAd", "onClose");
    if (paramIntent == null) {}
    ...
    {
      return;
      acrl.b(paramActivity, a(), paramIntent, paramInt);
    } while (this.c);
    try
    {
      if (this.c) {
    ...
    this.c = true;
    acrl.c(paramActivity, a(), paramIntent, paramInt);
  }
  ...
  public boolean a(Activity paramActivity)
  {
    ...
    for (;;)
    {
      acqy.b("GdtInterstitialAd", String.format("show %d", new Object[] { Integer.valueOf(i) }));
      acrl.a(paramActivity, a(), i);
      if (i != 0) {
        break;
      }
      return true;
