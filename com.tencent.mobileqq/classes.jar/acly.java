...
public class acly
{
  ...
  public acly(Activity paramActivity)
  {
  ...
  public bguj a()
  {
    ...
    {
      localActivity = a();
      if (!(localActivity instanceof bguj)) {
        break label45;
      }
    }
    label45:
    for (this.d = new WeakReference((bguj)localActivity);; this.d = new WeakReference(a())) {
  ...
  public WebViewFragment a()
  {
    ...
    {
      localActivity = a();
      if (!(localActivity instanceof bguf)) {
        break label50;
      }
    }
    label50:
    for (this.e = new WeakReference(((bguf)localActivity).a());; this.e = new WeakReference(null)) {
