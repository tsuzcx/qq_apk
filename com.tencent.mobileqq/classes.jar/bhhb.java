...
public class bhhb
{
  ...
  public static bhhc a(String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    bhhc localbhhc = new bhhc();
    localbhhc.jdField_a_of_type_JavaLangString = a(paramString);
    String str;
    if (!localSharedPreferences.getBoolean("guideEnable", false))
    {
      ...
      localbhhc.jdField_a_of_type_Int = 4;
      switch (localbhhc.jdField_a_of_type_Int)
      {
      case 3: 
      default: 
        str = "P3";
    ...
    for (;;)
    {
      ...
      if (localSharedPreferences.getInt("guideToastOpen", 0) == 1)
      {
        ...
        for (;;)
        {
          ...
          localbhhc.jdField_a_of_type_Int = 1;
          break;
          label258:
      ...
      if (localSharedPreferences.getInt("guidePopupOpen", 0) == 1)
      {
        ...
        if ((i == 0) || (i == 1))
        {
          ...
          {
            localbhhc.jdField_a_of_type_Int = 3;
          ...
          for (str = "lastTipTime_";; str = "lastDialogTime_")
          {
            ...
            if (localbhhc.jdField_a_of_type_Int == 4) {
              break;
            }
            localSharedPreferences.edit().putLong(str, l).commit();
            break;
            localbhhc.jdField_a_of_type_Int = 2;
            break label365;
          }
        }
        localbhhc.jdField_a_of_type_Int = 4;
  ...
  public static void a(TrafficResultInfo paramTrafficResultInfo, Bundle paramBundle)
  {
    ...
    boolean bool1 = paramBundle.getBoolean(anyj.i);
    boolean bool3 = paramBundle.getBoolean(anyj.j);
    String str2 = paramBundle.getString(anyj.k);
    String str1 = paramBundle.getString(anyj.l);
  ...
  public static boolean a(Activity paramActivity, int paramInt, bhhd parambhhd, String paramString)
  {
    boolean bool = true;
    ...
    {
      return bool;
      localbhhc = a(paramString, false, true);
      if (QLog.isColorLevel()) {
        QLog.i("CUKingCardHelper", 2, "shouldOverrideDialog, popUpType: " + localbhhc.jdField_a_of_type_Int);
      }
    } while (localbhhc.jdField_a_of_type_Int == 4);
    if (localbhhc.jdField_a_of_type_Int == 1)
    {
      if (parambhhd != null) {
        parambhhd.callback(2);
      }
      return false;
    }
    new bhha(paramActivity, parambhhd, paramInt, paramString, localbhhc.jdField_a_of_type_Int).show();
    return false;
  }
