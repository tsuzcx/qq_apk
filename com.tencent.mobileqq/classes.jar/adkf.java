...
{
  adkf(adke paramadke, IntimateInfo.DNAInfo paramDNAInfo) {}
  ...
  public void onClick(View paramView)
  {
    ...
    paramView = bbex.a(this.jdField_a_of_type_Adke.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Adke.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqDataIntimateInfo$DNAInfo.linkUrl);
    if (paramView != null)
    {
      paramView.c();
      return;
    ...
    {
      bgyp.c(this.jdField_a_of_type_Adke.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqDataIntimateInfo$DNAInfo.linkUrl);
      return;
    }
    adjy.a(this.jdField_a_of_type_Adke.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqDataIntimateInfo$DNAInfo.linkUrl);
  }
