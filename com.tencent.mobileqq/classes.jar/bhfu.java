  ...
  implements DialogInterface.OnCancelListener, View.OnClickListener
{
  ...
  private bhfw jdField_a_of_type_Bhfw;
  ...
  public bhfu(@NonNull Context paramContext)
  {
  ...
  public void a(int paramInt1, int paramInt2, bhfw parambhfw)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTimePicker.setOnTimeChangedListener(new bhfv(this));
    this.jdField_a_of_type_Bhfw = parambhfw;
  }
  ...
  {
    if (this.jdField_a_of_type_Bhfw != null) {
      this.jdField_a_of_type_Bhfw.onTimeCancel();
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    if (this.jdField_a_of_type_Bhfw != null)
    {
      ...
      this.jdField_a_of_type_Bhfw.onTimeConfirm(paramView, (String)localObject);
    }
    a();
  }
}
