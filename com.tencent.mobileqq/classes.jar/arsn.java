...
public class arsn
{
  ...
  private arsn(QQAppInterface paramQQAppInterface, List<ContentProviderOperation> paramList)
  {
  ...
  private arsn(QQAppInterface paramQQAppInterface, List<ContentProviderOperation> paramList, long paramLong)
  {
  ...
  private arsn(QQAppInterface paramQQAppInterface, List<ContentProviderOperation> paramList, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt1, int paramInt2)
  {
    this(paramQQAppInterface, paramList);
  ...
  public static arsn a(QQAppInterface paramQQAppInterface, List<ContentProviderOperation> paramList, long paramLong)
  {
    return new arsn(paramQQAppInterface, paramList, paramLong);
  }
  
  public static arsn a(QQAppInterface paramQQAppInterface, List<ContentProviderOperation> paramList, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt1, int paramInt2)
  {
    return new arsn(paramQQAppInterface, paramList, paramString1, paramString2, paramString3, paramString4, paramInt1, paramInt2);
  }
  ...
  public arsn a(String paramString)
  {
  ...
  public arsn a(String paramString, Uri paramUri)
  {
    this.jdField_a_of_type_AndroidContentContentValues.clear();
    this.jdField_a_of_type_AndroidContentContentValues.put("data1", paramString);
    a(paramUri);
  ...
  public arsn b(String paramString)
  {
    this.jdField_a_of_type_AndroidContentContentValues.clear();
    ...
    this.jdField_a_of_type_AndroidContentContentValues.put("data3", anzj.a(2131701420));
    a();
    return this;
  }
}
