...
public class aeqc
{
  private static volatile aeqc jdField_a_of_type_Aeqc;
  public static final String a;
  public static final String b = jdField_a_of_type_JavaLangString + "eggs.xml";
  private ArrayList<aeqf> jdField_a_of_type_JavaUtilArrayList;
  ...
  {
    if (jdField_a_of_type_Aeqc == null) {}
    try
    {
      if (jdField_a_of_type_Aeqc == null) {
        jdField_a_of_type_Aeqc = new aeqc();
      }
      return jdField_a_of_type_Aeqc;
    }
    finally {}
  }
  
  private ArrayList<aeqf> a(XmlPullParser paramXmlPullParser)
  {
    ...
    if (i != 1) {
      if (i == 2)
      {
        ...
        if (str1.equalsIgnoreCase("Item"))
        {
          ...
          localObject2 = new aeqf();
          ((aeqf)localObject2).jdField_a_of_type_Int = Integer.valueOf((String)localObject3).intValue();
    ...
    for (;;)
    {
      ...
      localObject2 = new aeqh();
      if (str1 != null) {
        ((aeqh)localObject2).jdField_b_of_type_Int = aeqh.a(str1);
      }
      ((aeqh)localObject2).jdField_a_of_type_JavaLangString = str2;
      if (localObject4 != null)
      {
      ...
      localObject4.jdField_a_of_type_Aeqg = new aeqg();
      ...
      localObject4.jdField_a_of_type_Aeqg.jdField_a_of_type_Int = Integer.parseInt((String)localObject2);
      localObject4.jdField_a_of_type_Aeqg.jdField_b_of_type_Int = Integer.parseInt((String)localObject3);
      localObject4.jdField_a_of_type_Aeqg.c = Integer.parseInt(str1);
      localObject4.jdField_a_of_type_Aeqg.e = Integer.parseInt(str3);
      localObject4.jdField_a_of_type_Aeqg.d = Integer.parseInt(str2);
      localObject2 = localObject4;
      localObject3 = localObject1;
      break;
      localObject2 = localObject4;
  ...
  private boolean a(String paramString)
  {
    ...
    //   163: aload_0
    //   164: aload_2
    //   165: invokespecial 277	aeqc:a	(Lorg/xmlpull/v1/XmlPullParser;)Ljava/util/ArrayList;
    //   168: astore_2
    //   169: aload_1
    //   170: ifnull +7 -> 177
    //   173: aload_1
    ...
    //   181: aload_0
    //   182: aload_2
    //   183: putfield 281	aeqc:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   186: iconst_1
    //   187: ireturn
    //   188: astore_2
    //   189: aload_3
  ...
  public void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString)
  {
    ...
    try
    {
      ...
      bdcs.a(paramString, jdField_a_of_type_JavaLangString, false);
      if (i != 0)
      {
        boolean bool = a(b);
        if (QLog.isColorLevel()) {
