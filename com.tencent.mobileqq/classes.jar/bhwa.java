...
{
  public bhwa(HealthBusinessPlugin paramHealthBusinessPlugin, bhwi parambhwi, IVideoViewBase paramIVideoViewBase, FrameLayout paramFrameLayout) {}
  ...
  public void onClick(View paramView)
  {
    ...
    {
      this.jdField_a_of_type_Bhwi.c.setImageResource(2130841819);
      ((View)this.jdField_a_of_type_ComTencentQqliveMediaplayerViewIVideoViewBase).setOnTouchListener(new bhwb(this));
      this.jdField_a_of_type_ComTencentMobileqqVashealthHealthBusinessPlugin.mRuntime.a().findViewById(2131376760).setVisibility(8);
    ...
    for (this.jdField_a_of_type_ComTencentMobileqqVashealthHealthBusinessPlugin.d = true;; this.jdField_a_of_type_ComTencentMobileqqVashealthHealthBusinessPlugin.d = false)
    {
      ...
      return;
      this.jdField_a_of_type_ComTencentMobileqqVashealthHealthBusinessPlugin.mRuntime.a().findViewById(2131376760).setVisibility(0);
      if (((ViewGroup)this.jdField_a_of_type_ComTencentMobileqqVashealthHealthBusinessPlugin.mRuntime.a().findViewById(16908290).getParent().getParent()).getChildAt(1) != null) {
      ...
      this.jdField_a_of_type_Bhwi.c.setImageResource(2130841818);
