...
public class bipu
{
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, Context paramContext, Intent paramIntent, int paramInt)
  {
    ...
    biqn localbiqn = (biqn)paramQQAppInterface.getManager(27);
    if (localbiqn == null) {
      return false;
    }
    if (localbiqn.isPlugininstalled("group_video_plugin.apk")) {
