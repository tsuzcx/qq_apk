...
public class pkn
  implements bivl
{
  public pkn(ReadInJoySelfFragment paramReadInJoySelfFragment) {}
    ...
    do
    {
      ...
      if (paramInt1 >= ReadInJoySelfFragment.a(this.a))
      {
        ...
        for (float f = 1.0F;; f = paramInt1 * 0.33F / ReadInJoySelfFragment.a(this.a))
        {
          ...
          ReadInJoySelfFragment.a(this.a).setBackgroundResource(2130842953);
      ...
      ReadInJoySelfFragment.a(this.a).setBackgroundResource(2130842954);
