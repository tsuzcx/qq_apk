...
public class pkn
{
  private static final Map<String, pkn> jdField_a_of_type_JavaUtilMap = new HashMap();
  ...
  public static pkn a(String paramString)
  {
    if (paramString == null) {
      return null;
    }
    return (pkn)jdField_a_of_type_JavaUtilMap.get(paramString);
  }
  
  private static pkn a(String paramString, boolean paramBoolean)
  {
    pkn localpkn2 = a(paramString);
  ...
  public static void a(String paramString, pkn parampkn)
  {
    if ((paramString == null) || (parampkn == null)) {
      return;
    }
    jdField_a_of_type_JavaUtilMap.put(paramString, parampkn);
  }
  ...
  public void b()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 99	pkn:jdField_a_of_type_Boolean	Z
    //   6: ifeq +37 -> 43
    //   9: aload_0
    //   10: iconst_0
    //   11: putfield 99	pkn:jdField_a_of_type_Boolean	Z
    //   14: invokestatic 104	android/os/SystemClock:elapsedRealtime	()J
    //   17: aload_0
    //   18: getfield 34	pkn:b	J
    //   21: lsub
    //   22: lstore_1
    //   23: lload_1
    //   24: lconst_0
    ...
    //   26: iflt +20 -> 46
    //   29: aload_0
    //   30: getfield 32	pkn:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   33: lload_1
    ...
    //   57: invokestatic 164	com/tencent/mobileqq/activity/aio/AIOUtils:catchedExceptionInReleaseV2	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/RuntimeException;)V
    //   60: goto -17 -> 43
    //   63: astore_3
    //   64: aload_0
    //   65: monitorexit
