...
public class sez
{
  private static final String jdField_a_of_type_JavaLangString = "Q.readinjoy.video." + sez.class.getSimpleName();
  private static final sez jdField_a_of_type_Sez = new sez();
  ...
  {
    return bmhv.a(pnn.a(), true, true).getInt(paramString, 0);
  }
  
  public static sez a()
  {
    return jdField_a_of_type_Sez;
  }
  ...
  {
    if (bmhv.a(pnn.a(), true, true) == null)
    {
      a("writeToSP() failed");
      return;
    }
    bmhv.a(paramString, Integer.valueOf(paramInt));
  }
  ...
  private static boolean a()
  {
    ...
    localObject1 = i + j + k;
    Object localObject2 = bmhv.a(pnn.a(), true, true);
    ...
    for (;;)
    {
      try
      {
        ...
        if (bool)
        {
          ...
          if ((paramtso instanceof VideoInfo.EntranceDownloadInfo))
          {
            if (bool)
            {
              this.b += 1;
