...
public class aabi
  implements Runnable
{
  public aabi(AREngine paramAREngine, boolean paramBoolean, ArCloudConfigInfo paramArCloudConfigInfo) {}
  ...
  public void run()
  {
    ...
    else
    {
      ...
      ThreadManager.getUIHandler().post(new aabj(this));
    }
    for (;;)
    {
      return;
      ...
      else
      {
        ...
        catch (Exception localException)
        {
          ...
          {
            if ((this.jdField_a_of_type_ComTencentMobileqqArAidlArCloudConfigInfo.f()) && (this.jdField_a_of_type_ComTencentMobileqqArAidlArCloudConfigInfo.i())) {
