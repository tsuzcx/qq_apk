...
public class aabi
  extends ajjh
{
  public aabi(AuthDevActivity paramAuthDevActivity) {}
  ...
  protected void onDelAuthDevResult(boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    {
      bbmy.a(this.a.getApplicationContext(), 1, this.a.getString(2131626537), 0).b(this.a.getTitleBarHeight());
      return;
    }
  ...
  protected void onGetAuthDevResult(boolean paramBoolean, SvcRspGetDevLoginInfo paramSvcRspGetDevLoginInfo)
  {
    ...
    for (;;)
    {
      ...
      bbmy.a(this.a, 1, this.a.getString(2131626554), 0).b(this.a.getTitleBarHeight());
      return;
      label312:
