...
class bhej
  extends ntf
{
  bhej(bheh parambheh, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6) {}
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    {
      auuv.a("KEY_STAGE_2_CONNECT_MINI_D55", bool);
      if (this.jdField_a_of_type_Bheh.i)
      {
        this.jdField_a_of_type_Bheh.i = false;
    ...
    paramBundle = bheh.a(this.jdField_a_of_type_Bheh);
    if (paramInt == 0)
    {
      bdla.b(this.jdField_a_of_type_Bheh.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc01160", "", "", "0X800A51A", "0X800A51A", 0, 0, "", "", this.jdField_a_of_type_JavaLangString, this.b);
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        bdla.b(this.jdField_a_of_type_Bheh.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc01160", "", "", "0X800A51B", "0X800A51B", 0, paramInt, "", "", this.jdField_a_of_type_JavaLangString, this.b);
        if (paramInt == 25601)
        {
