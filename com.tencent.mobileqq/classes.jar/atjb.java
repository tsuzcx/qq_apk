  ...
  extends BaseAdapter
{
  ...
  private atlr jdField_a_of_type_Atlr;
  ...
  public atjb(Context paramContext, Comments paramComments, VideoData paramVideoData, atlr paramatlr, Paint paramPaint, int paramInt)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewLayoutInflater = LayoutInflater.from(paramContext);
    this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments = paramComments;
    this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelVideoData = paramVideoData;
    this.jdField_a_of_type_Atlr = paramatlr;
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    Object localObject;
    if ((this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments.a != null) && (this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments.a.size() > 0)) {
      if ((paramView == null) || (!(paramView.getTag() instanceof atjf)))
      {
        paramView = new atjf();
        localObject = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131560877, paramViewGroup, false);
        paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject).findViewById(2131368541));
        paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)((View)localObject).findViewById(2131378265));
        paramView.jdField_b_of_type_AndroidWidgetTextView = ((TextView)((View)localObject).findViewById(2131378112));
        paramView.jdField_c_of_type_AndroidWidgetTextView = ((TextView)((View)localObject).findViewById(2131378296));
        paramView.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject).findViewById(2131367595));
        paramView.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject).findViewById(2131365909));
        paramView.d = ((ImageView)((View)localObject).findViewById(2131377566));
        ((View)localObject).setTag(2131364482, paramView);
        ...
        localObject = bayh.a((AppInterface)localObject, 32, str2, 3, paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.getResources().getDrawable(2130844586), paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.getResources().getDrawable(2130844586));
        ...
        paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new atjc(this, l1, l2, l3));
        ...
        paramView.setTag(2131364473, this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments.a.get(paramInt));
        paramView.setTag(2131364523, this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments);
    ...
    {
      return localObject;
      paramViewGroup = (atjf)paramView.getTag();
      break;
      ...
      break label318;
      atiw.a().a(paramViewGroup.jdField_a_of_type_AndroidWidgetImageView, ((Comments.Comment)this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments.a.get(paramInt)).jdField_c_of_type_JavaLangString, paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.getResources().getDrawable(2130844586), paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.getResources().getDrawable(2130844586), null, true);
      break label469;
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        for (;;)
        {
          ...
          paramView.findViewById(2131369433).setOnClickListener(new atjd(this));
          paramView.setTag("badnet");
          return paramView;
          paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131560867, paramViewGroup, false);
        }
      }
    ...
    label910:
    paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131560868, paramViewGroup, false);
