...
public class alll
{
  private static alll jdField_a_of_type_Alll;
  public static final String a;
  public static final String b;
  private static boolean jdField_b_of_type_Boolean;
  public static final String c;
  private static final String d = alkn.jdField_a_of_type_JavaLangString + "/qav" + File.separator + "beauty" + File.separator;
  private static final String e = d + "SKINCOLOR" + File.separator;
  private int jdField_a_of_type_Int;
  private allp jdField_a_of_type_Allp;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = alkn.jdField_a_of_type_JavaLangString + "/qsvf" + File.separator;
  ...
  public static int a(Context paramContext)
  {
    ...
    if ((j > 0) && (!new File(jdField_a_of_type_JavaLangString + "filter_config.xml").exists())) {
      lbc.c("VideoFilterTools", "getQQShortVideoFilterConfigVersion config file don't exist!");
    }
    for (;;)
    {
      lbc.c("VideoFilterTools", "getQQShortVideoFilterConfigVersion:" + i);
      return i;
      i = j;
    }
  }
  
  public static alll a()
  {
    if (jdField_a_of_type_Alll == null) {
      jdField_a_of_type_Alll = new alll();
    }
    return jdField_a_of_type_Alll;
  }
  
  private static allq a(String paramString)
  {
    if (TextUtils.isEmpty(paramString))
    {
      lbc.c("VideoFilterTools", "parseConfig|content is empty.");
      return null;
    }
    for (;;)
    {
      ...
      try
      {
        ...
        localallq = new allq(i, str1, str2);
        try
        {
          lbc.c("VideoFilterTools", "parseConfig:" + i + "|" + str1 + "|" + str2);
          return localallq;
        }
      ...
      try
      {
        ...
        lbc.c("VideoFilterTools", "parseConfig failed. info = " + localJSONObject);
        return localallq;
      }
      catch (JSONException localJSONException2)
      {
        localJSONException2.printStackTrace();
        lbc.c("VideoFilterTools", "parseConfig|parse failed.context = " + paramString);
        return localallq;
      }
    }
  }
  ...
  public static String a(Context paramContext)
  {
    try
    {
      ...
      lbc.c("VideoFilterTools", "getQQShortVideoFilterConfig:" + jdField_a_of_type_JavaLangString + "filter_config.xml" + "|" + localFile.exists());
      if (localFile.exists()) {
  ...
  {
    lbc.c("VideoFilterTools", "setQQShortVideoFilterConfigVersion:" + paramInt);
    paramContext = PreferenceManager.getDefaultSharedPreferences(paramContext).edit();
  ...
  public static void a(Context paramContext, String paramString, int paramInt)
  {
    if (paramString == null)
    {
      lbc.c("VideoFilterTools", "updateQQShortVideoFilterConfig error ");
      return;
    }
  ...
  static void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        lbc.c("VideoFilterTools", "compareContent :" + (l2 - l1));
        return;
        ...
        if (paramString1 != null)
        {
          ...
          while (paramString1.hasNext())
          {
            ...
            while (localIterator.hasNext())
            {
              ...
              {
                lbc.c("VideoFilterTools", "compareContent res:" + localFilterDesc.name + "|" + localFilterDesc.resMD5 + "|" + paramString2.resMD5);
                ...
                lbc.c("VideoFilterTools", "compareContent iconMD5:" + localFilterDesc.name + "|" + localFilterDesc.iconMD5 + "|" + paramString2.iconMD5);
  ...
  {
    if (paramString == null) {
      lbc.c("VideoFilterTools", "handleQQSvCommonConfig empty content!");
    }
    do
    {
      for (;;)
      ...
      try
      {
        ...
        while (i < localJSONArray.length())
        {
          ...
          try
          {
            ...
            lbc.c("VideoFilterTools", "parseConfig:" + k + "|" + m + "|" + n + "|" + str5 + "|" + str1 + "|" + str4 + "|" + str2 + "|" + str3);
            i += 1;
          }
  ...
  public static boolean a(int paramInt1, long paramLong1, long paramLong2, int paramInt2)
  {
    ...
    if (i < paramInt2)
    {
      lbc.c("VideoFilterTools", "isSupportOfDevice error OSversion: " + i);
      return false;
    }
    paramInt2 = lkw.e();
    if (paramInt2 < paramInt1)
    {
      lbc.c("VideoFilterTools", "isSupportOfDevice error cpucount: " + paramInt2);
      return false;
    }
    long l = lkw.d();
    if (l < paramLong1)
    {
      lbc.c("VideoFilterTools", "isSupportOfDevice error cpuFrequency: " + l);
      return false;
    }
    paramLong1 = bgln.d();
    if (paramLong1 < paramLong2)
    {
      lbc.c("VideoFilterTools", "isSupportOfDevice error memory: " + paramLong1);
      return false;
    }
    return true;
  }
  ...
  public static String b(Context paramContext)
  {
    try
    {
      ...
      lbc.c("VideoFilterTools", "getVideoEffectBeautyConfig:" + d + "beauty_config.json" + "|" + localFile.exists());
      if (localFile.exists()) {
        return bgmg.b(localFile);
      }
      b(paramContext, 0);
  ...
  public static void b(Context paramContext)
  {
    try
    {
      ...
      if ((paramContext != null) && (!TextUtils.isEmpty(paramContext.jdField_a_of_type_JavaLangString)))
      {
        ...
        lbc.c("VideoFilterTools", "preDownloadResource :" + ((File)localObject).exists());
        if (!((File)localObject).exists())
        {
          localObject = new bdvs();
          ((bdvs)localObject).jdField_a_of_type_Bdvw = new alln();
          ...
          ((bdvs)localObject).jdField_c_of_type_JavaLangString = (d + "skin_color.zip");
  ...
  {
    lbc.c("VideoFilterTools", "setVideoEffectBeautyConfigVersion:" + paramInt);
    paramContext = PreferenceManager.getDefaultSharedPreferences(paramContext).edit();
  ...
  public static boolean b(Context paramContext)
  {
    ...
    lbc.c("VideoFilterTools", "getIsFirstLauncher:" + i);
    if (i == 0) {
      bool = true;
    }
    return bool;
  ...
  public FilterRender a(int paramInt1, int paramInt2)
  {
    ...
    {
      lbc.c("VideoFilterTools", "getFilter|init texture.");
    ...
    {
      lbc.c("VideoFilterTools", "getFilterRender|destroy current filterRender.");
  ...
  public List<FilterDesc> a()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        lbc.c("VideoFilterTools", "getFilterDescs " + str1 + " exist: " + bool);
        if (bool)
        {
          ...
          lbc.c("VideoFilterTools", "getFilterDescs " + str2 + " exist: " + bool);
    ...
    while (((Iterator)???).hasNext())
    {
      ...
      lbc.c("VideoFilterTools", "getFilterDescs " + (String)localObject3 + " exist: " + bool);
      if (bool)
      {
  ...
  public void a()
  {
    this.jdField_a_of_type_Allp = null;
    if (this.jdField_c_of_type_Int != -1) {
      this.jdField_c_of_type_Int = -1;
    }
    if (this.jdField_a_of_type_ArrayOfInt[0] != -1) {
  ...
  public void a(Context paramContext, allp arg2)
  {
    if (QLog.isColorLevel()) {
      com.tencent.av.video.effect.QavVideoEffect.DEBUG_MODE = true;
    }
    lbc.c("VideoFilterTools", "init");
    if (this.jdField_a_of_type_JavaUtilArrayList == null) {
      this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
    }
    this.jdField_a_of_type_Allp = ???;
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      a(a(paramContext), this.jdField_a_of_type_JavaUtilArrayList);
      a(this.jdField_a_of_type_JavaUtilArrayList);
      lbc.c("VideoFilterTools", "filter list size:" + this.jdField_a_of_type_JavaUtilArrayList.size());
  ...
  void a(List<FilterDesc> paramList)
  {
    if ((paramList == null) || (paramList.size() == 0)) {
      lbc.c("VideoFilterTools", "preDownloadResource list is empty!");
    }
    do
    {
      return;
      lbc.c("VideoFilterTools", "preDownloadResource list size: " + paramList.size());
      this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(0);
      paramList = paramList.iterator();
      while (paramList.hasNext())
      {
        FilterDesc localFilterDesc = (FilterDesc)paramList.next();
        lbc.c("VideoFilterTools", "preDownloadResource predownload: " + localFilterDesc.predownload + ", iconurl: " + localFilterDesc.iconurl + ", resurl:" + localFilterDesc.resurl);
        if (localFilterDesc.predownload == 1)
        {
          ...
          if (!TextUtils.isEmpty(localFilterDesc.iconurl))
          {
            ...
            lbc.c("VideoFilterTools", "preDownloadResource " + (String)localObject1 + " exist: " + ((File)localObject2).exists());
            if (!((File)localObject2).exists())
            {
              localObject2 = new bdvs();
              ((bdvs)localObject2).jdField_a_of_type_Bdvw = new allo(this);
              ((bdvs)localObject2).jdField_a_of_type_JavaLangString = localFilterDesc.iconurl;
              ((bdvs)localObject2).jdField_a_of_type_Int = 0;
              ((bdvs)localObject2).jdField_c_of_type_JavaLangString = ((String)localObject1);
          ...
          if ((!TextUtils.isEmpty(localFilterDesc.resurl)) && (!TextUtils.isEmpty((CharSequence)localObject1)))
          {
            ...
            lbc.c("VideoFilterTools", "preDownloadResource " + (String)localObject1 + "params.json" + " exist: " + ((File)localObject2).exists());
            if (!((File)localObject2).exists())
            {
              localObject1 = new bdvs();
              ((bdvs)localObject1).jdField_a_of_type_Bdvw = new allm(this);
              ((bdvs)localObject1).jdField_a_of_type_JavaLangString = localFilterDesc.resurl;
              ((bdvs)localObject1).jdField_a_of_type_Int = 0;
              ((bdvs)localObject1).jdField_c_of_type_JavaLangString = (jdField_b_of_type_JavaLangString + localFilterDesc.name + ".zip");
              ((bdvs)localObject1).a(localFilterDesc);
    ...
    } while ((this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 0) || (this.jdField_a_of_type_Allp == null));
    this.jdField_a_of_type_Allp.a(false);
  }
  ...
  public void b()
  {
    lbc.c("VideoFilterTools", "destroy");
  ...
  public void c(Context paramContext)
  {
    if (new File(d + "beauty_config.json").exists())
    {
      ...
      {
        lbc.c("VideoFilterTools", "!JasonFile.exists()");
        b(paramContext);
      }
      return;
    }
    lbc.c("VideoFilterTools", "BEAUTY_CONFIG  is not exsit");
  }
