  ...
  extends Drawable
{
  ...
  public bmth(Context paramContext, String paramString)
  {
    this.jdField_a_of_type_Bmsv = new bmsv();
  ...
  public Bitmap a()
  {
    return a(this.jdField_a_of_type_Bmsv.a());
  }
  ...
  protected void c()
  {
    this.jdField_a_of_type_AndroidAnimationValueAnimator = ValueAnimator.ofObject(this.jdField_a_of_type_Bmsv, new Object[] { this.jdField_a_of_type_Bmsv.b(), this.jdField_a_of_type_Bmsv.a() });
    this.jdField_a_of_type_AndroidAnimationValueAnimator.setInterpolator(new DecelerateInterpolator());
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new bmti(this));
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new bmtj(this));
    this.jdField_a_of_type_AndroidAnimationValueAnimator.setDuration(this.jdField_a_of_type_Bmsv.a());
