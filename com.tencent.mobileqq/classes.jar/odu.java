  ...
  extends anii
{
  ...
  public odu(AppInterface paramAppInterface)
  {
    super(paramAppInterface);
    this.jdField_a_of_type_Anqd = new odv(this);
  }
  ...
  public void a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        oda.b = localArrayList;
        if ((localJSONArray2 != null) && (localJSONArray2.length() > 0))
        {
          i = 0;
          if (i < localJSONArray2.length())
          {
            oda.c.add(String.valueOf(localJSONArray2.getLong(i)));
            i += 1;
            continue;
          }
        }
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    {
      return;
      oda localoda = (oda)this.app.getManager(88);
      ...
      localObject = localoda.a(paramMessageRecord.senderuin);
      ...
      localoda.a((EcShopData)localObject);
  ...
  public void a(boolean paramBoolean, MessageRecord paramMessageRecord, int paramInt, String paramString)
  {
    try
    {
      ...
      if ("1".equals(paramMessageRecord.getExtInfoFromExtStr("is_AdArrive_Msg")))
      {
        paramString = new odk();
        paramString.a = 3;
        paramString = odh.a(paramString, paramMessageRecord);
        paramString.f = paramInt;
        ((odh)this.app.a(139)).a(paramString, null);
        if ((paramMessageRecord instanceof MessageForStructing))
        {
          ...
          if ((paramMessageRecord instanceof StructMsgForGeneralShare))
          {
            ...
            if ((paramMessageRecord.mStructMsgItemLists != null) && (paramMessageRecord.mStructMsgItemLists.size() > 0)) {
              acre.a(1, 2, oda.a((bcvs)paramMessageRecord.mStructMsgItemLists.get(0)));
            }
          }
        }
      }
  ...
  public void b(MessageRecord paramMessageRecord)
  {
    ...
    try
    {
      ...
      {
        localObject1 = new odk();
        ((odk)localObject1).a = 1;
        localObject1 = odh.a((odk)localObject1, paramMessageRecord);
        ((odh)this.app.a(139)).a((odk)localObject1, null);
        if ((paramMessageRecord instanceof MessageForStructing))
        {
          paramMessageRecord = ((MessageForStructing)paramMessageRecord).structingMsg;
          if (!(paramMessageRecord instanceof StructMsgForGeneralShare)) {
          ...
          paramMessageRecord = (bcvs)paramMessageRecord.mStructMsgItemLists.get(0);
          acre.a(0, 2, oda.a(paramMessageRecord));
          if ((paramMessageRecord == null) || (paramMessageRecord.c != 100) || (!(paramMessageRecord.a instanceof StructMsgForGeneralShare))) {
            return;
          }
          oer.a(paramMessageRecord.g, false);
          oev.a(this.app, "qgg.push.arrive", ((StructMsgForGeneralShare)paramMessageRecord.a).mContentTitle, NetConnInfoCenter.getServerTimeMillis() + "", "");
          oev.b(this.app, "qgg_push_arrive", ((StructMsgForGeneralShare)paramMessageRecord.a).mContentTitle, NetConnInfoCenter.getServerTimeMillis() + "", "");
          return;
        }
        ...
        localObject3 = new JSONObject(((ArkAppMessage)localObject2).metaList).optJSONObject("gdt");
        if (localObject3 != null)
        {
          long l = ((JSONObject)localObject3).optLong("aid");
          Object localObject4 = ((JSONObject)localObject3).optJSONObject("thirdparty_monitor_urls");
          if (localObject4 != null)
          {
            localObject3 = new qq_ad_get.QQAdGetRsp.AdInfo.ReportInfo();
            ((qq_ad_get.QQAdGetRsp.AdInfo.ReportInfo)localObject3).trace_info.aid.set(l);
            qq_ad_get.QQAdGetRsp.AdInfo.ReportInfo.ThirdPartyMonitorUrls localThirdPartyMonitorUrls = new qq_ad_get.QQAdGetRsp.AdInfo.ReportInfo.ThirdPartyMonitorUrls();
            JSONArray localJSONArray = ((JSONObject)localObject4).optJSONArray("api_click_monitor_url");
            localThirdPartyMonitorUrls.api_click_monitor_url.set(a(localJSONArray));
            localJSONArray = ((JSONObject)localObject4).optJSONArray("api_exposure_monitor_url");
            localThirdPartyMonitorUrls.api_exposure_monitor_url.set(a(localJSONArray));
            localThirdPartyMonitorUrls.sdk_click_monitor_url.set(a(((JSONObject)localObject4).optJSONArray("sdk_click_monitor_url")));
            localThirdPartyMonitorUrls.sdk_exposure_monitor_url.set(a(((JSONObject)localObject4).optJSONArray("sdk_exposure_monitor_url")));
            ((qq_ad_get.QQAdGetRsp.AdInfo.ReportInfo)localObject3).thirdparty_monitor_urls.set(localThirdPartyMonitorUrls);
            localObject4 = new qq_ad_get.QQAdGetRsp.AdInfo();
            ((qq_ad_get.QQAdGetRsp.AdInfo)localObject4).report_info.set((MessageMicro)localObject3);
            acre.a(0, 2, (qq_ad_get.QQAdGetRsp.AdInfo)localObject4);
          }
        }
        localObject2 = new JSONObject(((ArkAppMessage)localObject2).mSourceAd);
        if ((!"gw".equals(((JSONObject)localObject2).optString("from"))) || (!"100".equals(((JSONObject)localObject2).optString("action_type")))) {
          return;
        }
        paramMessageRecord = oev.a(this.app, paramMessageRecord);
        oev.a(this.app, "qgg.push.arrive", ((MessageForArkApp)localObject1).msg, NetConnInfoCenter.getServerTimeMillis() + "", paramMessageRecord);
        oev.b(this.app, "qgg_push_arrive", ((MessageForArkApp)localObject1).msg, NetConnInfoCenter.getServerTimeMillis() + "", paramMessageRecord);
        return;
      }
    }
    catch (Throwable paramMessageRecord)
    ...
    if ((paramMessageRecord instanceof MessageForArkApp))
    {
      ...
      if (localObject3 != null)
      {
        ...
        {
          oer.a(((JSONObject)localObject3).optInt("tab_id"), false);
          localObject3 = oev.a(this.app, paramMessageRecord);
          oev.a(this.app, "qgg.push.arrive", ((MessageForArkApp)localObject2).msg, NetConnInfoCenter.getServerTimeMillis() + "", (String)localObject3);
          oev.b(this.app, "qgg_push_arrive", ((MessageForArkApp)localObject2).msg, NetConnInfoCenter.getServerTimeMillis() + "", (String)localObject3);
        }
      }
    ...
    do
    {
      do
      {
        do
        {
          ...
          paramToServiceMsg = (oda)this.app.getManager(88);
