...
public class bfih
{
  ...
  protected static HttpURLConnection a(bfii parambfii)
  {
    for (;;)
    {
      try
      {
        localObject1 = MsfSdkUtils.insertMtype("yingyongbao", parambfii.jdField_b_of_type_JavaLangString);
        if (bfhb.a(bexd.a().a()))
        {
          i = "http://".length();
          localObject3 = bfhb.c(bexd.a().a());
          String str = bfhb.d(bexd.a().a());
          j = ((String)localObject1).indexOf('/', i);
          if (j < 0)
          {
            localObject2 = ((String)localObject1).substring(i);
            localObject1 = "";
            bfhg.c(jdField_a_of_type_JavaLangString, "http://" + (String)localObject3 + ":" + str + (String)localObject1);
            localObject3 = (HttpURLConnection)new URL("http://" + (String)localObject3 + ":" + str + (String)localObject1).openConnection();
            localObject1 = localObject3;
          }
        }
      }
      catch (Exception parambfii)
      {
        int j;
        Object localObject2;
        localObject3 = null;
        bfhg.c(jdField_a_of_type_JavaLangString, "--getHttpConnection-- Exception!!!", parambfii);
      ...
      try
      {
        ...
        localObject3 = localObject1;
        if (parambfii.jdField_c_of_type_Long > 0L)
        {
          localObject3 = localObject1;
          ...
          localObject3 = localObject1;
          ((HttpURLConnection)localObject1).setRequestProperty("If-Modified-Since", ((SimpleDateFormat)localObject2).format(new Date(parambfii.jdField_c_of_type_Long)));
        }
        localObject3 = localObject1;
        i = ((HttpURLConnection)localObject1).getResponseCode();
        localObject3 = localObject1;
        bfhg.c(jdField_a_of_type_JavaLangString, "--getHttpConnection-- reponseCode=" + i);
        if ((i == 302) || (i == 301))
        {
          localObject3 = localObject1;
          parambfii = ((HttpURLConnection)localObject1).getHeaderField("Location");
          localObject3 = localObject1;
          bfhg.c(jdField_a_of_type_JavaLangString, "--getHttpConnection-- loc=" + parambfii);
          localObject3 = localObject1;
          a((HttpURLConnection)localObject1);
          parambfii = null;
          localObject1 = parambfii;
          bfhg.c(jdField_a_of_type_JavaLangString, "--getHttpConnection-- uc=" + parambfii);
          return parambfii;
      ...
      if (localObject2 != null)
      {
        ...
        parambfii.jdField_a_of_type_Long = (a((HttpURLConnection)localObject2) * 1000L);
        localObject3 = localObject2;
        if (parambfii.jdField_a_of_type_Long == 0L)
        {
          localObject3 = localObject2;
          parambfii.jdField_a_of_type_Long = 86400000L;
        }
      }
      localObject3 = localObject2;
      parambfii.jdField_b_of_type_Long = System.currentTimeMillis();
      parambfii = (bfii)localObject2;
      continue;
      localObject3 = localObject1;
      ...
      {
        localObject3 = localObject1;
        bfhg.c(jdField_a_of_type_JavaLangString, "--getimg-- " + parambfii.jdField_b_of_type_JavaLangString + " not modified");
        localObject3 = localObject1;
        parambfii.jdField_a_of_type_Long = (a((HttpURLConnection)localObject1) * 1000L);
        localObject3 = localObject1;
        parambfii.jdField_b_of_type_Long = System.currentTimeMillis();
        localObject3 = localObject1;
        a((HttpURLConnection)localObject1);
  ...
  protected static void a(HttpURLConnection paramHttpURLConnection)
  {
    ...
    {
      bfhg.c("", "", paramHttpURLConnection);
    }
  }
  
  /* Error */
  public static boolean a(bfii parambfii)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 12
    ...
    //   7: istore 4
    //   9: aload_0
    //   10: invokestatic 274	bfih:a	(Lbfii;)Ljava/net/HttpURLConnection;
    //   13: astore 7
    //   15: aload 7
    //   17: ifnonnull +88 -> 105
    //   20: getstatic 14	bfih:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   36: aload_0
    //   37: getfield 72	bfii:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   52: invokestatic 131	bfhg:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   55: iconst_0
    //   56: ifeq +11 -> 67
    ...
    //   84: ifnull +11 -> 95
    //   87: aload 7
    //   89: invokevirtual 271	java/net/HttpURLConnection:disconnect	()V
    //   92: iload 4
    //   94: istore_3
    //   95: iload_3
    //   96: ireturn
    //   97: astore_0
    //   98: aload_0
    //   99: invokevirtual 284	java/lang/Exception:printStackTrace	()V
    //   102: goto -23 -> 79
    //   105: aload 7
    //   107: invokevirtual 287	java/net/HttpURLConnection:getContentLength	()I
    //   110: i2l
    //   111: lstore 5
    //   113: invokestatic 291	bfel:a	()J
    //   116: lload 5
    //   118: lcmp
    //   119: ifge +85 -> 204
    //   122: getstatic 14	bfih:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   138: aload_0
    //   139: getfield 72	bfii:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   142: invokevirtual 121	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   145: ldc_w 293
    ...
    //   154: invokestatic 131	bfhg:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   157: iconst_0
    //   158: ifeq +11 -> 169
    //   161: new 280	java/lang/NullPointerException
    //   164: dup
    //   165: invokespecial 281	java/lang/NullPointerException:<init>	()V
    //   168: athrow
    //   169: iconst_0
    //   170: ifeq +11 -> 181
    //   173: new 280	java/lang/NullPointerException
    //   176: dup
    //   177: invokespecial 281	java/lang/NullPointerException:<init>	()V
    //   180: athrow
    //   181: iload 4
    //   183: istore_3
    //   184: aload 7
    //   186: ifnull -91 -> 95
    //   189: aload 7
    //   191: invokevirtual 271	java/net/HttpURLConnection:disconnect	()V
    //   194: iconst_0
    //   195: ireturn
    //   196: astore_0
    //   197: aload_0
    //   198: invokevirtual 284	java/lang/Exception:printStackTrace	()V
    //   201: goto -20 -> 181
    //   204: aload 7
    //   206: invokevirtual 297	java/net/HttpURLConnection:getInputStream	()Ljava/io/InputStream;
    //   209: astore 8
    //   211: lconst_0
    //   212: lstore 5
    //   214: getstatic 16	bfih:jdField_a_of_type_Int	I
    //   217: newarray byte
    //   219: astore 9
    //   221: new 299	java/io/ByteArrayOutputStream
    //   224: dup
    ...
    //   232: aload 9
    //   234: iconst_0
    //   235: getstatic 16	bfih:jdField_a_of_type_Int	I
    //   238: invokevirtual 306	java/io/InputStream:read	([BII)I
    //   241: istore_1
    //   242: iload_1
    //   243: ifle +79 -> 322
    //   246: getstatic 19	bfih:b	I
    //   249: istore_2
    //   250: lload 5
    //   252: iload_2
    //   253: i2l
    ...
    //   285: ifnull -190 -> 95
    //   288: aload 7
    //   290: invokevirtual 271	java/net/HttpURLConnection:disconnect	()V
    //   293: iconst_0
    //   294: ireturn
    //   295: astore_0
    //   296: aload_0
    //   297: invokevirtual 284	java/lang/Exception:printStackTrace	()V
    //   300: goto -20 -> 280
    //   303: aload 13
    //   305: aload 9
    //   307: iconst_0
    //   308: iload_1
    //   309: invokevirtual 313	java/io/ByteArrayOutputStream:write	([BII)V
    //   312: lload 5
    //   314: iload_1
    //   315: i2l
    //   316: ladd
    ...
    //   329: invokestatic 316	bfel:e	()Ljava/lang/String;
    //   332: invokevirtual 121	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   335: getstatic 319	com/tencent/open/base/img/ImageCache:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   338: invokevirtual 121	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   341: aload_0
    //   342: getfield 321	bfii:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   354: aload_0
    //   355: getfield 72	bfii:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   358: invokestatic 330	bfhd:a	(Ljava/lang/String;)Ljava/lang/String;
    //   361: invokevirtual 121	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   364: invokevirtual 126	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   367: astore 14
    ...
    //   380: aload 14
    //   382: invokevirtual 121	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   385: ldc_w 332
    ...
    //   458: aload 14
    //   460: invokevirtual 121	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   463: ldc_w 332
    //   466: invokevirtual 121	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   469: invokevirtual 126	java/lang/StringBuilder:toString	()Ljava/lang/String;
    ...
    //   525: ldc_w 372
    //   528: aload_0
    //   529: getfield 373	bfii:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   532: invokestatic 131	bfhg:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   535: aload_0
    //   536: aload 7
    //   538: invokevirtual 376	java/net/HttpURLConnection:getLastModified	()J
    //   541: putfield 169	bfii:jdField_c_of_type_Long	J
    //   544: iconst_1
    //   545: istore_3
    //   546: aload 9
    //   548: ifnull +8 -> 556
    ...
    //   596: aconst_null
    //   597: astore 8
    //   599: getstatic 14	bfih:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   602: ldc_w 379
    //   605: aload 9
    //   607: invokestatic 268	bfhg:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   610: aload 10
    //   612: ifnull +17 -> 629
    //   615: aload 10
    ...
    //   671: ifnull -576 -> 95
    //   674: aload 8
    //   676: invokevirtual 271	java/net/HttpURLConnection:disconnect	()V
    //   679: iconst_0
    //   680: ireturn
    //   681: astore_0
    //   682: aload_0
    //   683: invokevirtual 284	java/lang/Exception:printStackTrace	()V
    //   686: goto -20 -> 666
    //   689: astore_0
    //   690: aconst_null
    //   691: astore 8
    ...
    //   712: ifnull +8 -> 720
    //   715: aload 8
    //   717: invokevirtual 309	java/io/InputStream:close	()V
    //   720: aload 7
    //   722: ifnull +8 -> 730
    //   725: aload 7
    //   727: invokevirtual 271	java/net/HttpURLConnection:disconnect	()V
    //   730: aload_0
    //   731: athrow
    //   732: astore 8
    //   734: aload 8
    //   736: invokevirtual 284	java/lang/Exception:printStackTrace	()V
    //   739: goto -19 -> 720
    //   742: astore_0
    //   743: aconst_null
    //   744: astore 8
