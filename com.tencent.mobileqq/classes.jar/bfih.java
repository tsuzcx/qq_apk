...
{
  public bfih(FavoriteSearchFragment paramFavoriteSearchFragment, ListView paramListView, azwg paramazwg)
  {
  ...
  {
    return new bfil(FavoriteSearchFragment.a(this.a));
  }
  
  protected avwx a(int paramInt, ViewGroup paramViewGroup)
  {
    return new avym(paramViewGroup, 2131496783);
  }
  
  public int getCount()
  {
    int i = super.getCount();
    if ((i > 0) && (((bfik)super.a(i - 1)).a == -2L)) {
      return i - 1;
    }
    return i;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (getItemViewType(paramInt) == 1)
    {
      ...
      if (paramView == null)
      {
        ...
        ((TextView)localObject).setTextColor(paramViewGroup.getResources().getColor(2131101271));
      ...
      do
      {
        ...
        break;
        paramViewGroup.setText(2131632402);
  ...
  public void onClick(View paramView)
  {
    ...
    Animatable localAnimatable = (Animatable)BaseApplicationImpl.sApplication.getResources().getDrawable(2130839113);
