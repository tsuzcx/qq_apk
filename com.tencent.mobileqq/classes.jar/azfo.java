  ...
  implements Manager
{
  ...
  axbz jdField_a_of_type_Axbz = new azfs(this);
  public azgd a;
  public azpw a;
  azqh jdField_a_of_type_Azqh = new azfr(this);
  protected azqt a;
  azrz jdField_a_of_type_Azrz;
  batl jdField_a_of_type_Batl = new azfv(this);
  AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface = null;
  BaseChatPie jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie;
  public Comparator<azgc> a;
  HashMap<String, Integer> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  String jdField_b_of_type_JavaLangString;
  HashMap<String, List<azgc>> jdField_b_of_type_JavaUtilHashMap = new HashMap();
  ...
  public azfo(AppInterface paramAppInterface)
  {
    this.jdField_a_of_type_Int = 1;
    this.jdField_c_of_type_JavaUtilHashMap = new HashMap();
    this.jdField_b_of_type_Boolean = true;
    this.jdField_a_of_type_JavaUtilComparator = new azfu(this);
    this.jdField_a_of_type_ComTencentCommonAppAppInterface = paramAppInterface;
    a(paramAppInterface);
    this.jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
  }
  
  private void a(azgc paramazgc)
  {
    int i = 0;
    Object localObject = (List)this.jdField_b_of_type_JavaUtilHashMap.get(paramazgc.getFriendUin());
    if (localObject == null)
    {
      localObject = new ArrayList();
      this.jdField_b_of_type_JavaUtilHashMap.put(paramazgc.getFriendUin(), localObject);
    }
    for (;;)
    {
      int j;
      try
      {
        ((List)localObject).add(paramazgc);
        int m = paramazgc.getLimitType();
        int k = -1;
        j = 0;
        if (i < ((List)localObject).size())
        {
          paramazgc = (azgc)((List)localObject).get(i);
          if ((paramazgc == null) || (paramazgc.getLimitType() != m)) {
            break label158;
          }
          if (k == -1)
          {
  ...
  private void a(String paramString, MessageForDeliverGiftTips paramMessageForDeliverGiftTips)
  {
    ...
    {
      Object localObject = new File(azkd.a(paramString, paramMessageForDeliverGiftTips.animationType, paramMessageForDeliverGiftTips.isInteract()));
      ...
      localObject = new batm(azkd.c(paramMessageForDeliverGiftTips), (File)localObject);
      ((batm)localObject).jdField_b_of_type_Int = 2;
      ...
      if (QLog.isColorLevel()) {
        QLog.d("AIOAnimationControlManager", 2, "start Download PackageId:" + azkd.b(paramMessageForDeliverGiftTips));
      }
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    if (i < localList.size())
    {
      paramString1 = (azgc)localList.get(i);
      if (!(paramString1 instanceof MessageForDeliverGiftTips)) {
        break label87;
      }
      paramString1 = azkd.b((MessageForDeliverGiftTips)paramString1);
    }
    for (;;)
    {
  ...
  public static boolean a(BaseChatPie paramBaseChatPie, QQAppInterface paramQQAppInterface, Object paramObject)
  {
    ...
    for (;;)
    {
      if (agsu.a(paramObject, paramQQAppInterface)) {
        paramBaseChatPie.o(false);
      }
      return false;
      label37:
      ...
      ((azfo)paramQQAppInterface.getManager(223)).a(paramBaseChatPie);
    }
  }
  ...
  private void b(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      {
        if (paramString2.equals(azkd.b((MessageForDeliverGiftTips)paramString1.get(i)))) {
  ...
  private void h()
  {
    Object localObject = new File(ajed.cs);
    ...
    {
      label111:
      if (azkd.a((String)localObject, i, bool))
      {
      ...
      for (;;)
      {
        ...
        bool = true;
        break label111;
        bace.a(arrayOfFile[j].getAbsolutePath());
      }
      return;
      label270:
      i = 0;
  ...
  public batr a()
  {
    return ((bato)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(47)).a(1);
  }
      ...
      if (i < localObject.length)
      {
        if (localObject[i].exists())
        {
          ...
          try
          {
            ...
            if (azkd.a(Integer.parseInt(str))) {
              this.jdField_a_of_type_JavaUtilHashMap.put(str, Integer.valueOf(3));
            } else {
              bace.d(localObject[i].getAbsolutePath());
            }
          }
  ...
  {
    if (this.jdField_a_of_type_Azpw == null) {
      this.jdField_a_of_type_Azpw = new azpw(null, paramActivity, this.jdField_a_of_type_ComTencentCommonAppAppInterface);
    }
    this.jdField_a_of_type_Azpw.a(4);
    this.jdField_a_of_type_AndroidAppActivity = this.jdField_a_of_type_Azpw.a();
  ...
  public void a(BaseChatPie paramBaseChatPie)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != paramBaseChatPie)
    {
      ...
      this.jdField_a_of_type_Azpw = paramBaseChatPie.a();
      if (!(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aejb)) {
        break label114;
      }
      this.jdField_a_of_type_Azpw.a(1);
      this.jdField_a_of_type_Azqt = ((aejb)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).a();
      this.jdField_a_of_type_Azrz = ((aejb)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).a();
    }
    label114:
    do
    {
      return;
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aefe))
      {
        this.jdField_a_of_type_Azpw.a(4);
        return;
      }
    } while (!(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aego));
    ...
    {
      this.jdField_a_of_type_Azpw.a(8);
      return;
    }
    this.jdField_a_of_type_Azpw.a(6);
  }
  ...
  {
    azgb.a().addObserver(paramObserver);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      do
      {
        do
        {
          do
          {
            do
            {
              do
              {
                ...
                } while ((!b()) && (azkd.a((List)localObject3)));
                if ((this.jdField_a_of_type_Azqt == null) || (azkd.a((List)localObject3))) {
                  break label397;
                }
              } while ((this.jdField_a_of_type_Azqt.b()) && (this.jdField_a_of_type_Azqt.a()));
              this.jdField_a_of_type_Int = 2;
              localObject5 = (MessageForDeliverGiftTips)((List)localObject3).get(0);
              localObject6 = azkd.b((MessageForDeliverGiftTips)localObject5);
            ...
            ((azjq)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(113)).a(((MessageForDeliverGiftTips)localObject5).frienduin, ((MessageForDeliverGiftTips)localObject5).interactId, ((MessageForDeliverGiftTips)localObject5).giftId, new azfw(this, (MessageForDeliverGiftTips)localObject5, (List)localObject3, paramBoolean, (List)localObject4, (String)localObject6));
            return;
            ...
            return;
          } while ((this.jdField_a_of_type_Azpw == null) || (azkd.a((List)localObject4)));
          this.jdField_a_of_type_Int = 2;
          localObject3 = (azgc)((List)localObject4).get(0);
          ...
          {
            localObject3 = ((azjq)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(113)).a((String)localObject1, ((MessageForDeliverGiftTips)localObject5).bagId, new azfy(this, (MessageForDeliverGiftTips)localObject5, (String)localObject1, paramBoolean));
          ...
          for (;;)
          {
            if ((this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof QQAppInterface)) {
              ((MessageForDeliverGiftTips)localObject5).senderName = babh.h((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, (String)localObject1, "" + ((MessageForDeliverGiftTips)localObject5).senderUin);
            }
            localObject6 = azkd.b((MessageForDeliverGiftTips)localObject5);
            if ((!this.jdField_a_of_type_JavaUtilHashMap.containsKey(localObject6)) || (((Integer)this.jdField_a_of_type_JavaUtilHashMap.get(localObject6)).intValue() != 3)) {
              break label1241;
            }
            this.jdField_a_of_type_Azpw.a(this.jdField_a_of_type_Axbz);
            if (QLog.isColorLevel()) {
              QLog.d("AIOAnimationControlManager", 2, "Playing! playMaigface id:" + azkd.b((MessageForDeliverGiftTips)localObject5));
            }
            if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie == null) || (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a() == null) || (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a().a == null) || (!this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a().a.a())) {
              break;
            }
        ...
        } while (this.jdField_a_of_type_Azqt == null);
        this.jdField_a_of_type_Azqt.a((MessageForDeliverGiftTips)localObject5, (String)localObject6, false, new azfz(this, paramBoolean));
        return;
        if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null)
        {
          localObject3 = "0";
          ...
          awqx.b((QQAppInterface)localObject4, "P_CliOper", "Grp_flower", "", "cartoon", "show", 0, 0, (String)localObject1, (String)localObject6, (String)localObject3, "" + mje.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), (String)localObject1));
          if (QLog.isColorLevel())
          {
        ...
        this.jdField_a_of_type_Azpw.a((MessageForDeliverGiftTips)localObject5);
        this.jdField_a_of_type_Azpw.jdField_a_of_type_Azqh = this.jdField_a_of_type_Azqh;
        return;
        if ((this.jdField_a_of_type_JavaUtilHashMap.containsKey(localObject6)) && (((Integer)this.jdField_a_of_type_JavaUtilHashMap.get(localObject6)).intValue() == 4))
        {
        ...
        this.jdField_a_of_type_Int = 3;
        return;
        if ((localObject3 instanceof agsu))
        {
          localObject1 = (agsu)localObject3;
          this.jdField_a_of_type_Azpw.a((agsu)localObject1);
          ((agsu)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, new azfp(this, paramBoolean));
          ((List)localObject4).remove(localObject3);
          return;
        }
      } while ((!(localObject3 instanceof MessageForTroopEffectPic)) || (this.jdField_a_of_type_Azrz == null));
      ...
      if ((!this.jdField_a_of_type_JavaUtilHashMap.containsKey(localObject3)) || (((Integer)this.jdField_a_of_type_JavaUtilHashMap.get(localObject3)).intValue() != 3) || (!azkd.a(((MessageForTroopEffectPic)localObject5).effectId))) {
        break;
      }
      Object localObject1 = ((MessageForTroopEffectPic)localObject5).getPicDownloadInfo();
      ((atpn)localObject1).e = "chatimg";
      Object localObject6 = ((atpn)localObject1).c();
      ...
      for (;;)
      {
        ...
        try
        {
          if (localFile.exists())
          {
            ...
            localOptions.inSampleSize = ((int)bacm.a((InputStream)localObject1, 720, 1080));
            ((BufferedInputStream)localObject1).close();
            localObject6 = bacm.a((String)localObject6, localOptions);
            localObject1 = localObject3;
        ...
        if ((localObject1 == null) || (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie == null) || (!(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aejb))) {
          break label1829;
        }
        localObject3 = (aejb)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie;
        this.jdField_a_of_type_Azrz.a(((MessageForTroopEffectPic)localObject5).effectId, (Bitmap)localObject1, ((aejb)localObject3).s, new azfq(this, paramBoolean));
        ((List)localObject4).remove(localObject5);
        return;
        i = 90;
        continue;
    ...
    } while ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie == null) || (!(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aejb)));
    label1209:
    label1215:
    label1220:
    label1241:
    ...
    label1297:
    label1829:
    this.jdField_a_of_type_Azrz.a((aejb)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, (MessageForTroopEffectPic)localObject5, false);
    return;
  ...
  public boolean a(azgc paramazgc, boolean paramBoolean)
  {
    if (paramazgc == null) {
      return false;
    }
    if (((paramazgc instanceof MessageForDeliverGiftTips)) && (!azkd.a((MessageForDeliverGiftTips)paramazgc))) {
      return false;
    }
    a(paramazgc);
    if (paramBoolean)
  ...
  public boolean a(MessageForDeliverGiftTips paramMessageForDeliverGiftTips, boolean paramBoolean)
  {
    ...
    while (!azkd.a(paramMessageForDeliverGiftTips)) {
      return false;
    }
    ...
    {
      return true;
      ((azjq)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(113)).a(paramMessageForDeliverGiftTips.frienduin, paramMessageForDeliverGiftTips.interactId, paramMessageForDeliverGiftTips.giftId, new azft(this, paramMessageForDeliverGiftTips, paramBoolean));
    }
  }
  ...
  public boolean a(MessageForTroopEffectPic paramMessageForTroopEffectPic, boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_JavaUtilHashMap.containsKey(str)) && (((Integer)this.jdField_a_of_type_JavaUtilHashMap.get(str)).intValue() == 3)) {
      if (!azkd.a(paramMessageForTroopEffectPic.effectId))
      {
        this.jdField_a_of_type_JavaUtilHashMap.remove(str);
        bace.d(azkd.a(paramMessageForTroopEffectPic.effectId));
  ...
  public long[] a(String paramString)
  {
    ...
    if (localObject != null)
    {
      ...
      {
        azgc localazgc = (azgc)((Iterator)localObject).next();
        if ((localazgc instanceof MessageForDeliverGiftTips)) {
          paramString.add(Long.valueOf(((MessageForDeliverGiftTips)localazgc).getId()));
        }
      }
    }
  ...
  public void b()
  {
    ...
    for (Object localObject = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString;; localObject = this.jdField_b_of_type_JavaLangString)
    {
      ...
      if ((!this.jdField_b_of_type_Boolean) || (azkd.a((List)localObject))) {
        break label135;
      }
      int j;
      for (int i = 0; i < ((List)localObject).size(); i = j + 1)
      {
        azgc localazgc = (azgc)((List)localObject).get(i);
        j = i;
        if (localazgc.isReaded())
        {
          j = i;
          if (localazgc.getSenderUin() != this.jdField_a_of_type_ComTencentCommonAppAppInterface.getLongAccountUin())
          {
  ...
  {
    azgb.a().deleteObserver(paramObserver);
  }
  ...
  {
    if (!azkd.a(paramMessageForDeliverGiftTips)) {
      return false;
    }
    String str = azkd.b(paramMessageForDeliverGiftTips);
    int i;
    boolean bool;
    if ((this.jdField_a_of_type_JavaUtilHashMap.containsKey(str)) && (((Integer)this.jdField_a_of_type_JavaUtilHashMap.get(str)).intValue() == 3)) {
      if (!azkd.a(str, paramMessageForDeliverGiftTips.animationType, paramMessageForDeliverGiftTips.isInteract()))
      {
        this.jdField_a_of_type_JavaUtilHashMap.remove(str);
        bace.a(azkd.a(paramMessageForDeliverGiftTips));
        a(str, paramMessageForDeliverGiftTips);
        i = 2;
        if (QLog.isColorLevel()) {
          QLog.d("AIOAnimationControlManager", 2, "giftRealAnimationId:" + azkd.b(paramMessageForDeliverGiftTips) + ",state:" + i);
        }
        if ((a()) && (i != 3)) {
          break label188;
        }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Azpw = null;
    this.jdField_a_of_type_Int = 1;
    this.jdField_a_of_type_Azqt = null;
  }
  ...
  public void g()
  {
    ...
    if ((this.jdField_a_of_type_Azpw != null) && (this.jdField_a_of_type_Azpw.a())) {
      this.jdField_a_of_type_Azpw.c();
    }
    if ((this.jdField_a_of_type_Azqt != null) && (!this.jdField_a_of_type_Azqt.a())) {
