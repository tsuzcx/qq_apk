...
public class azfo
  extends auud
{
  public azfo(TroopAvatarWallPreviewActivity paramTroopAvatarWallPreviewActivity) {}
  ...
  public void a(boolean paramBoolean, String paramString, long paramLong1, long paramLong2)
  {
    ...
    do
    {
      ...
      {
        return;
      } while ((this.a.jdField_a_of_type_Int < 0) || (this.a.jdField_a_of_type_Int > this.a.jdField_a_of_type_Baop.getCount() - 1) || (this.a.jdField_b_of_type_JavaUtilArrayList == null) || (this.a.jdField_a_of_type_Int > this.a.jdField_b_of_type_JavaUtilArrayList.size() - 1));
    ...
    if (paramBoolean) {}
    for (paramString = this.a.getResources().getString(2131692786);; paramString = this.a.getResources().getString(2131691512))
    {
      ...
      if (this.a.jdField_a_of_type_Int >= this.a.jdField_a_of_type_Baop.getCount())
      {
        paramString = this.a;
      ...
      this.a.jdField_a_of_type_Baop.notifyDataSetChanged();
      return;
    }
  }
}
