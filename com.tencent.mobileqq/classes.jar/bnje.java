...
public class bnje
{
  private static bnje jdField_a_of_type_Bnje;
  ...
  public static bnje a()
  {
    try
    {
      if (jdField_a_of_type_Bnje == null) {
        jdField_a_of_type_Bnje = new bnje();
      }
      bnje localbnje = jdField_a_of_type_Bnje;
      return localbnje;
    }
    finally {}
  }
  ...
  public void a(String paramString1, String paramString2, Downloader.DownloadListener paramDownloadListener)
  {
    ...
    paramDownloadListener = new bnjf(this, paramString2, paramDownloadListener, paramString1);
    paramString2 = jdField_a_of_type_JavaIoFile.getAbsolutePath() + "/tmp" + paramString2;
    this.jdField_a_of_type_Bmvo.a(paramString1, paramString2, paramDownloadListener);
  }
  ...
  public boolean a(String paramString, boolean paramBoolean)
  {
    ...
    if (localFile.length() == a(paramString)) {
      if (paramBoolean)
      {
        String str1 = bjtz.a(b(paramString));
  ...
  public void b()
  {
    QzoneModuleManager.getInstance().downloadModule("pictureMarkerSo.zip", new bnjg(this));
  }
  ...
  public void c()
  {
    QzoneModuleManager.getInstance().downloadModule("libandroidndkbeauty.so", new bnjh(this));
  }
}
