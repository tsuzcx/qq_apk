...
public class acki
  extends alxo
{
  public acki(ChatSettingActivity paramChatSettingActivity) {}
  ...
  public void a(boolean paramBoolean, GetRoamToastRsp paramGetRoamToastRsp)
  {
    ...
    Object localObject1;
    Object localObject2;
    if ((paramBoolean) && (paramGetRoamToastRsp != null) && (!TextUtils.isEmpty(paramGetRoamToastRsp.sToast)) && (((alxl)this.a.app.a(13)).a(paramGetRoamToastRsp)))
    {
    ...
    for (;;)
    {
      ...
      azmj.b(this.a.app, "dc00898", "", "", "0X8009E31", "0X8009E31", 0, 0, "", "", "", "");
      return;
