...
public class arxd
{
  ...
  arxd(BaseActivity paramBaseActivity, TencentMap paramTencentMap, LatLng paramLatLng, String paramString)
  {
  ...
  void a(arxf paramarxf)
  {
    this.jdField_a_of_type_Arxf = paramarxf;
  }
