...
public class befo
{
  private static befo jdField_a_of_type_Befo;
  public static final Object a;
  public int a;
  final beff jdField_a_of_type_Beff = new beff(new befp(this));
  public boolean a;
  public int b = 0;
  ...
  {
    if (jdField_a_of_type_Befo == null) {}
    try
    {
      if (jdField_a_of_type_Befo == null) {
        jdField_a_of_type_Befo = new befo();
      }
      return jdField_a_of_type_Befo;
    }
    finally {}
  }
  ...
  public int a(Bundle paramBundle)
  {
    ...
    for (boolean bool = BaseApplicationImpl.sApplication.getSharedPreferences("sp_x5_config_" + (String)localObject, 4).getBoolean("key_x5_init_sub_thread", true);; bool = true)
    {
      ...
      befq.b();
      beep.X = System.currentTimeMillis() - l;
      QLog.i("WebLog_SwiftWebAccelerator", 1, "initX5Environment on main thread, cost " + beep.X + "ms.");
      return 1;
    }
  }
  ...
  public void a(Bundle paramBundle)
  {
    if (Looper.getMainLooper() == Looper.myLooper())
    {
      if (!this.jdField_a_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_Beff.b();
        this.jdField_a_of_type_Beff.a(localBundle);
  ...
  public int b(Bundle paramBundle)
  {
    ...
    beep.Y = System.currentTimeMillis() - l;
    QLog.i("WebLog_SwiftWebAccelerator", 1, "doMainStep_CreateWebView:create webview cost " + beep.Y + "ms.");
    return 1;
  }
  ...
  public int c(Bundle paramBundle)
  {
    ...
    beep.Z = System.currentTimeMillis() - l;
    QLog.i("WebLog_SwiftWebAccelerator", 1, "tendocpreload doMainStep_WarnUpWebView:load " + paramBundle + ", cost " + beep.Z + "ms.");
    return 1;
  }
  ...
  public int e(Bundle paramBundle)
  {
    ...
    if (WebAccelerateHelper.preloadBrowserView == null)
    {
      ...
      beep.aa = System.currentTimeMillis() - l;
      QLog.i("WebLog_SwiftWebAccelerator", 1, "doMainStep_CreateBrowserView, cost = " + beep.aa + "ms.");
      return 1;
    }
    return 0;
  }
