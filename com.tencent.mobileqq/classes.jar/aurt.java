  ...
  implements aurs, Manager
{
  ...
  private aurp[] jdField_a_of_type_ArrayOfAurp = new aurp[jdField_a_of_type_JavaUtilSet.size()];
  ...
  public aurt(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Aukn = paramQQAppInterface.getEntityManagerFactory().createEntityManager();
    this.jdField_a_of_type_Aurv = new aurv(paramQQAppInterface, this);
    this.jdField_a_of_type_Aurr = aurr.a();
  ...
  private PrecoverRetryInfo a(PrecoverResource paramPrecoverResource)
  {
    ...
    try
    {
      paramPrecoverResource = this.jdField_a_of_type_Aukn.a(PrecoverRetryInfo.class, false, "pk = ?", new String[] { paramPrecoverResource.businessId + "_" + paramPrecoverResource.md5 }, null, null, null, null);
  ...
  private void a(aukm paramaukm)
  {
    ...
    label37:
    for (Object localObject = "null";; localObject = paramaukm)
    {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("PrecoverManager", 2, new Object[] { "insertEntity, entity.Name=", paramaukm.getClass().getSimpleName() });
    }
    localObject = this.jdField_a_of_type_Aukn.a();
    try
    {
      ((aukp)localObject).a();
    ...
    catch (Exception paramaukm)
    {
      if (QLog.isColorLevel())
      {
        QLog.d("PrecoverManager", 2, new Object[] { "insertEntity, exception=", paramaukm.getMessage() });
        paramaukm.printStackTrace();
      }
      return;
    }
    finally
  ...
  private boolean a(Class<? extends aukm> paramClass)
  {
    return a("delete_all", paramClass);
  }
  
  /* Error */
  private boolean a(String paramString, Class<? extends aukm> paramClass)
  {
    // Byte code:
    ...
    //   83: goto -70 -> 13
    //   86: aload_0
    //   87: getfield 82	aurt:jdField_a_of_type_Aukn	Laukn;
    //   90: invokevirtual 241	aukn:a	()Laukp;
    //   93: astore_3
    //   94: aload_3
    //   95: invokevirtual 245	aukp:a	()V
    //   98: aload_2
    ...
    //   154: aload_0
    //   155: getfield 82	aurt:jdField_a_of_type_Aukn	Laukn;
    //   158: aload_1
    //   159: invokevirtual 298	aukn:b	(Ljava/lang/String;)Z
    //   162: pop
    //   163: aload_3
    //   164: invokevirtual 250	aukp:c	()V
    //   167: aload_3
    //   168: invokevirtual 251	aukp:b	()V
    //   171: iconst_1
    //   172: ireturn
    //   173: ldc_w 300
    //   176: iconst_2
    ...
    //   229: aload_3
    //   230: invokevirtual 251	aukp:b	()V
    //   233: iconst_0
    //   234: ireturn
    //   235: astore_1
    //   236: aload_3
    //   237: invokevirtual 251	aukp:b	()V
    //   240: aload_1
    //   241: athrow
    ...
    //   0	242	2	paramClass	Class<? extends aukm>
  ...
  private boolean b()
  {
    ...
    int i = this.jdField_a_of_type_Aurr.a;
    if (i == 2)
    {
      if (QLog.isColorLevel()) {
  ...
  public int a()
  {
    if (this.jdField_a_of_type_Aurr != null) {
      return this.jdField_a_of_type_Aurr.a;
    }
    return 0;
  }
  ...
  public aurr a()
  {
    return this.jdField_a_of_type_Aurr;
  }
  
  public auru a()
  {
    return this.jdField_a_of_type_Auru;
  }
  
  public aurv a()
  {
    return this.jdField_a_of_type_Aurv;
  }
  ...
  protected <T extends aukm> List<T> a(String paramString, String[] paramArrayOfString, Class<T> paramClass)
  {
    String str;
    if (QLog.isColorLevel())
    {
    ...
    {
      label123:
      paramString = this.jdField_a_of_type_Aukn.a(paramClass, false, paramString, paramArrayOfString, null, null, null, null);
      return paramString;
    }
  ...
  public void a(int paramInt, String paramString, PrecoverResource paramPrecoverResource, Object paramObject)
  {
    ...
    this.jdField_a_of_type_Aurv.b(this);
  ...
  protected void a(PrecoverResource paramPrecoverResource)
  {
    ...
    paramPrecoverResource = this.jdField_a_of_type_Aukn.a();
    try
    {
      paramPrecoverResource.a();
      this.jdField_a_of_type_Aukn.b(localPrecoverRetryInfo);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (???.hasNext())
        {
          ...
          localObject5 = aurz.a((String)((Pair)localObject4).second);
          if ((localObject5 == null) || (((Pair)localObject5).first == null) || (((Pair)localObject5).second == null)) {
            continue;
          }
          if (QLog.isColorLevel()) {
            QLog.d("PrecoverManager", 2, new Object[] { "onHandleConfigs, businessid=", ((aurq)((Pair)localObject5).first).a, ", name=", ((aurq)((Pair)localObject5).first).b, ", list.size=", Integer.valueOf(((List)((Pair)localObject5).second).size()) });
          }
          if (TextUtils.isEmpty(((aurq)((Pair)localObject5).first).a)) {
            continue;
          }
          String str = ((aurq)((Pair)localObject5).first).a;
  ...
  {
    boolean bool = aurz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + "_config_cover");
    if (QLog.isColorLevel()) {
      QLog.d("PrecoverManager", 2, new Object[] { "checkReportConfigCover, succ=", Boolean.valueOf(paramBoolean), ", need=", Boolean.valueOf(bool) });
    }
    if (bool)
    {
      aurz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + "_config_cover");
      this.jdField_a_of_type_Auru.a(paramBoolean);
    }
  }
  
  public boolean a()
  {
    boolean bool = aurz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "get_config_time");
    int j = aurz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "get_config_count", 0);
    if (bool)
    {
      aurz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "get_config_time");
      aurz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "get_config_count", 1);
      return true;
    }
    if (a() != null) {}
    ...
    aurz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "get_config_count", j + 1);
    return true;
  }
  ...
  protected boolean a(PrecoverResource paramPrecoverResource)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        if (localPrecoverRetryInfo.totalRetryCount <= this.jdField_a_of_type_Aurr.c) {
          break;
        }
      } while (!QLog.isColorLevel());
      ...
      if (localPrecoverRetryInfo.itemRetryCount < this.jdField_a_of_type_Aurr.b)
      {
        localPrecoverRetryInfo.itemRetryCount += 1;
        localPrecoverRetryInfo.totalRetryCount += 1;
        localPrecoverRetryInfo.retryUpdateTime = l;
