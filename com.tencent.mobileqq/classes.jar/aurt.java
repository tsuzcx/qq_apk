...
public class aurt
{
  private static volatile aurt jdField_a_of_type_Aurt;
  ...
  private WeakReference<aurw> jdField_a_of_type_MqqUtilWeakReference;
  ...
  private int a(Context paramContext, float paramFloat)
  {
    ...
    for (int i = 1;; i = 2)
    {
      ...
      aurn.a(paramContext, 4, this.jdField_a_of_type_ComTencentMobileqqIntervideoYiqikanWatchTogetherFloatingData.getCurUin());
      return i;
    }
    this.jdField_b_of_type_MqqUtilWeakReference = new WeakReference(localFloatingScreenManager.setFloatingVideoListener(new auru(this), 2));
    localFloatingScreenManager.setWindowClickListener(2, new aurv(this, paramContext));
    return 0;
  }
  
  public static aurt a()
  {
    if (jdField_a_of_type_Aurt == null) {}
    try
    {
      if (jdField_a_of_type_Aurt == null) {
        jdField_a_of_type_Aurt = new aurt();
      }
      return jdField_a_of_type_Aurt;
    }
    finally {}
  }
  ...
  public int a(Context paramContext, @Nonnull WatchTogetherFloatingData paramWatchTogetherFloatingData)
  {
    ...
    {
      QQToast.a(BaseApplicationImpl.getContext(), 2131694064, 0).a();
    ...
    this.jdField_a_of_type_Bguy = new bguy(localIntent, paramContext);
    this.jdField_a_of_type_Bguy.a();
    aurn.a(true, paramWatchTogetherFloatingData.getCurUin(), paramWatchTogetherFloatingData.getCurType(), true);
  ...
  public void a(aurw paramaurw)
  {
    this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(paramaurw);
  }
  ...
  public void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_MqqUtilWeakReference != null) && (this.jdField_a_of_type_MqqUtilWeakReference.get() != null)) {
        ((aurw)this.jdField_a_of_type_MqqUtilWeakReference.get()).a(paramInt2);
      }
  ...
  public void a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqIntervideoYiqikanWatchTogetherFloatingData = null;
    this.jdField_b_of_type_ComTencentMobileqqIntervideoYiqikanWatchTogetherFloatingData = null;
    if (this.jdField_a_of_type_Bguy != null)
    {
      this.jdField_a_of_type_Bguy.e();
      this.jdField_a_of_type_Bguy.c();
      this.jdField_a_of_type_Bguy = null;
    }
    ...
    aurn.a(false, paramString, paramInt, paramBoolean);
    if (this.jdField_a_of_type_Aurx != null)
    {
      avpf.a().a(this.jdField_a_of_type_Aurx);
      this.jdField_a_of_type_Aurx = null;
    }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    aurw localaurw = (aurw)this.jdField_a_of_type_MqqUtilWeakReference.get();
    if (paramBoolean) {}
    for (int i = 1;; i = 2)
    {
      localaurw.b(i);
  ...
  public boolean a()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqIntervideoYiqikanWatchTogetherFloatingView == null) || (this.jdField_a_of_type_Bguy == null)) {}
    TouchWebView localTouchWebView;
    do
    {
      return false;
      localTouchWebView = this.jdField_a_of_type_Bguy.a;
  ...
  public void b(int paramInt)
  {
    ...
    do
    {
      ...
      bcef.b(null, "dc00899", "Grp_AIO", "", "video_tab", "clk_refresh_error", 0, 0, this.jdField_a_of_type_ComTencentMobileqqIntervideoYiqikanWatchTogetherFloatingData.getCurUin(), "", "", "");
      return;
      if (QLog.isColorLevel()) {
      ...
      if (paramInt == 1)
      {
        ...
        if (this.jdField_a_of_type_Aurx == null)
        {
          this.jdField_a_of_type_Aurx = new aurx(this.jdField_b_of_type_MqqUtilWeakReference);
          avpf.a().a(1, this.jdField_a_of_type_Aurx);
          return;
        }
        this.jdField_a_of_type_Aurx.a(this.jdField_b_of_type_MqqUtilWeakReference);
        return;
      }
    } while (paramInt != 2);
    bcef.b(null, "dc00899", "Grp_AIO", "", "video_tab", "clk_refresh_error", 0, 0, this.jdField_a_of_type_ComTencentMobileqqIntervideoYiqikanWatchTogetherFloatingData.getCurUin(), "", "", "");
  ...
  public void b(aurw paramaurw)
  {
    if ((this.jdField_a_of_type_MqqUtilWeakReference != null) && (this.jdField_a_of_type_MqqUtilWeakReference.get() != null) && (this.jdField_a_of_type_MqqUtilWeakReference.get() == paramaurw)) {
