...
{
  public uyv(ApolloItemBuilder paramApolloItemBuilder) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if ((paramView instanceof TextView))
    {
      ...
      if (ApolloManager.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication()))
      {
        ...
        paramView = "1";
        localObject1 = ((ApolloManager)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(152)).a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
