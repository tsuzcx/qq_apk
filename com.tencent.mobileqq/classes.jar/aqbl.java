...
{
  aqbl(aqbe paramaqbe, String paramString, aqbq paramaqbq) {}
  
  public void onClick(View paramView)
  {
    axqy.b(this.jdField_a_of_type_Aqbe.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800514A", "0X800514A", 0, 0, "", "", "", "");
    paramView = this.jdField_a_of_type_Aqbe.jdField_a_of_type_AndroidOsBundle.getParcelable("FORWARD_MSG_FOR_PIC");
    if ((paramView instanceof MessageForPic))
    {
      ...
      if (((localFile == null) || (!localFile.exists()) || (localFile.length() != paramView.size)) || (paramView != null)) {
        aqbe.a(this.jdField_a_of_type_Aqbe, paramView, this.jdField_a_of_type_JavaLangString);
      }
    }
    do
    {
      ...
      paramView = this.jdField_a_of_type_Aqbe.jdField_a_of_type_AndroidOsBundle.getString("forward_filepath");
      if (paramView != null)
      {
        aqbe.a(this.jdField_a_of_type_Aqbe, paramView, this.jdField_a_of_type_JavaLangString);
        return;
      }
      if (this.jdField_a_of_type_Aqbe.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("key_flag_from_plugin", false))
      {
        if (QLog.isColorLevel()) {
          QLog.d("ForwardOption.ForwardBaseOption", 2, "Edit Forward Image: from QZone");
        }
        this.jdField_a_of_type_Aqbe.jdField_a_of_type_AndroidOsBundle.putBoolean("FORWARD_IS_QZONE_SHARE", true);
        aqbe.a(this.jdField_a_of_type_Aqbe, this.jdField_a_of_type_Aqbe.b, this.jdField_a_of_type_JavaLangString);
        return;
      }
    } while (!QLog.isColorLevel());
