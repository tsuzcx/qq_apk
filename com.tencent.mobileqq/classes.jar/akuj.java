  ...
  extends aktf
{
  ...
  public akuj(NewPhotoListActivity paramNewPhotoListActivity)
  {
  ...
  private void f()
  {
    bpkq.a(this.jdField_a_of_type_Int, this.mActivity, this.mPhotoCommonData, false);
  ...
  public boolean addAndRemovePhotoByGesture(LocalMediaInfo paramLocalMediaInfo, boolean paramBoolean)
  {
    ...
    if (((NewPhotoListActivity)this.mActivity).isGif(paramLocalMediaInfo)) {
      QQToast.a(this.mActivity, anzj.a(2131689736), 0).b(((NewPhotoListActivity)this.mActivity).mTitleBarHeight);
    }
    long l;
    do
    {
      ...
      do
      {
        ...
        } while ((!this.jdField_a_of_type_Akte.isSupportVideoCheckbox) && (arrayOfString != null) && (!"image".equals(arrayOfString[0])));
    ...
    } while (l - this.jdField_a_of_type_Akte.lastTimeShowToast < 700L);
    paramLocalMediaInfo = BaseApplicationImpl.sApplication.getResources().getString(2131689737, new Object[] { Integer.valueOf(9 - this.e) });
    ...
    this.jdField_a_of_type_Akte.hasShownMaxSelectToast = true;
    return false;
    this.jdField_a_of_type_Akte.hasShownMaxSelectToast = false;
    if (paramBoolean) {
  ...
  public void caseVideo(View paramView, int paramInt)
  {
    ...
    if ((this.mPhotoCommonData.selectedPhotoList.size() == 0) && (this.jdField_a_of_type_Boolean))
    {
      ...
      case 0: 
        ...
        paramView = (LinkedHashMap)bhkd.sSelectItemPosMap.get(this.mPhotoCommonData.albumId);
        if (paramView == null)
        {
          paramView = new LinkedHashMap();
          bhkd.sSelectItemPosMap.put(this.mPhotoCommonData.albumId, paramView);
        }
        break;
      }
    }
    for (;;)
    {
      ...
      f();
      return;
      QQToast.a(this.mActivity, String.format(anzj.a(2131689732), new Object[] { Integer.valueOf(2) }), 0).b(((NewPhotoListActivity)this.mActivity).mTitleBarHeight);
      return;
      QQToast.a(this.mActivity, anzj.a(2131689741), 0).b(((NewPhotoListActivity)this.mActivity).mTitleBarHeight);
      return;
      QQToast.a(this.mActivity, anzj.a(2131689742), 0).b(((NewPhotoListActivity)this.mActivity).mTitleBarHeight);
      return;
      QQToast.a(this.mActivity, anzj.a(2131689740), 0).b(((NewPhotoListActivity)this.mActivity).mTitleBarHeight);
      return;
      QQToast.a(this.mActivity, anzj.a(2131689743), 0).b(((NewPhotoListActivity)this.mActivity).mTitleBarHeight);
      return;
      QQToast.a(this.mActivity, anzj.a(2131689738), 0).b(((NewPhotoListActivity)this.mActivity).mTitleBarHeight);
      return;
    }
  }
  ...
  public void initData(Intent paramIntent)
  {
    ...
    int i = born.y.a();
    if (born.k(((NewPhotoListActivity)this.mActivity).getIntent())) {
      i = born.A.a();
    }
    for (;;)
    {
      ...
      bpam.a("PhotoListLogicAECircle", "[AdditionalPick] initData---initialHasPickedNum=" + this.e + ", canPickVideo=" + this.jdField_a_of_type_Boolean);
      this.b = 3000;
      this.c = 3000;
      this.d = 60000;
      if (!TextUtils.isEmpty(paramIntent.getStringExtra("qq_camera_from_qcircle_scheme"))) {
        QQToast.a(this.mActivity, 0, anzj.a(2131689670), 1).a();
      }
      return;
    }
  }
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Int == 0)
      {
        if (i == 0)
        {
          ...
          {
            QQToast.a(this.mActivity, anzj.a(2131689733), 0).b(((NewPhotoListActivity)this.mActivity).mTitleBarHeight);
            return;
          }
          if (this.mPhotoCommonData.selectedPhotoList.size() + this.e >= 9)
          {
            paramView = BaseApplicationImpl.sApplication.getResources().getString(2131689737, new Object[] { Integer.valueOf(9 - this.e) });
  ...
  public void onTitleBtnCancelClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if ("qzone_plugin.apk".equals(str2))
      {
        ...
        bmtd.a(this.mActivity, str3, paramView, 2);
      }
    }
  }
