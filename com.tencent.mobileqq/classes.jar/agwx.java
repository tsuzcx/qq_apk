...
public class agwx
  implements bahf, bahh
{
  private static agwx jdField_a_of_type_Agwx;
  public int a;
  ...
  public WeakReference<agxf> a;
  public HashMap<MessageForPtt, MessageForQQWalletMsg> a;
  public Map<MessageForPtt, agxh> a;
  ...
  public static agwx a()
  {
    try
    {
      if (jdField_a_of_type_Agwx == null) {
        jdField_a_of_type_Agwx = new agwx();
      }
      agwx localagwx = jdField_a_of_type_Agwx;
      return localagwx;
    }
    finally {}
  }
  
  private agxg a(byte[] paramArrayOfByte)
  {
    boolean bool = true;
    agxg localagxg = new agxg();
    if ((paramArrayOfByte == null) || (paramArrayOfByte.length == 0)) {
      return localagxg;
    }
    agww.a().a();
    if (agww.a().a(paramArrayOfByte, paramArrayOfByte.length) == 1) {}
    for (;;)
    {
      localagxg.jdField_a_of_type_Boolean = bool;
      localagxg.jdField_a_of_type_Float = agww.a().a();
      localagxg.jdField_a_of_type_JavaLangString = a(localagxg.jdField_a_of_type_Float);
      agww.a().b();
  ...
  private agxg a(byte[] paramArrayOfByte, MessageForQQWalletMsg paramMessageForQQWalletMsg)
  {
  ...
  private void a(int paramInt1, long paramLong, int paramInt2, MessageForQQWalletMsg paramMessageForQQWalletMsg, float paramFloat)
  {
    ...
    for (;;)
    {
      ...
      return;
      if (agww.a().a(localQQAppInterface)) {
        paramInt1 = 1;
      } else {
        paramInt1 = 0;
      }
  ...
  {
    agxf localagxf = (agxf)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if ((localagxf != null) && (!localagxf.c())) {
      localagxf.a(paramInt, paramString);
    }
    if (QLog.isColorLevel()) {
  ...
  private void a(MessageRecord paramMessageRecord, long paramLong, byte[] paramArrayOfByte, String paramString)
  {
    ...
    try
    {
      MessageForPtt localMessageForPtt = aael.a(agwj.a(), paramMessageRecord.getLocalFilePath(), this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, -2, paramMessageRecord.voiceType);
      if (localMessageForPtt != null)
      {
        this.jdField_a_of_type_JavaUtilMap.put(localMessageForPtt, new agxh(paramMessageRecord, paramLong, paramArrayOfByte, paramString));
        paramArrayOfByte = new QQRecorder.RecorderParam(bahn.jdField_b_of_type_Int, 16000, 1);
        if (a(this.jdField_a_of_type_ArrayOfByte, this.jdField_a_of_type_JavaLangString, paramMessageRecord.getLocalFilePath(), paramArrayOfByte))
        {
          ...
          if ((paramString != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo != null) && (localMessageForPtt != null))
          {
            ...
            paramArrayOfByte = (agxf)this.jdField_a_of_type_JavaLangRefWeakReference.get();
  ...
  public static void a(String paramString, MessageForPtt paramMessageForPtt, axox paramaxox)
  {
    b(paramString, paramMessageForPtt);
    if (paramaxox != null)
    {
      if (!(paramaxox instanceof axpg)) {
        break label38;
      }
      paramString = ((axpg)paramaxox).a();
    ...
    do
    {
      do
      {
        ...
        {
          return;
          if (!(paramaxox instanceof axqw)) {
            break;
          }
          paramString = ((axqw)paramaxox).a(paramMessageForPtt);
        } while ((paramString == null) || (paramMessageForPtt == null));
        paramMessageForPtt.richText = paramString;
        return;
      } while (!(paramaxox instanceof axra));
      paramString = ((axra)paramaxox).a(paramMessageForPtt);
    } while ((paramString == null) || (paramMessageForPtt == null));
    paramMessageForPtt.richText = paramString;
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if (!((File)localObject).exists())
        {
          ...
          localmce = new mce(paramRecorderParam.jdField_a_of_type_Int, 16, 1);
          localmce.a(new agwy(this));
          l = System.currentTimeMillis();
        }
        try
        {
          localmce.a(paramString1, str);
          if (QLog.isColorLevel()) {
          ...
          aucl.a(paramString2);
          paramRecorderParam = bahn.a(paramRecorderParam.jdField_c_of_type_Int, paramRecorderParam.jdField_a_of_type_Int);
          aucl.a(paramString2, paramRecorderParam, paramRecorderParam.length);
          ...
          aucl.a(paramString2, ((audm)localObject).jdField_a_of_type_ArrayOfByte, ((audm)localObject).jdField_a_of_type_Int);
        }
  ...
  public int a(String paramString, QQRecorder.RecorderParam paramRecorderParam)
  {
    ...
    paramString = (agxf)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if (paramString != null) {
  ...
  public String a(float paramFloat)
  {
    ...
    if (localObject1 != null)
    {
      ...
      if (localObject1 != null)
      {
        localObject1 = ((agmq)localObject1).a("voice_pwd", new String[] { "scoreIdMap" });
        if (localObject1 == null) {}
      }
    }
    int i;
  ...
  public void a(agxe paramagxe)
  {
    Object localObject = agwj.a();
    if ((localObject == null) || (paramagxe == null)) {}
    do
    {
      return;
      localObject = ((TicketManager)((QQAppInterface)localObject).getManager(2)).GetSkey(((QQAppInterface)localObject).getCurrentAccountUin(), 16L, new agxd(this, paramagxe));
    } while ((localObject == null) || (((Ticket)localObject)._sig == null) || (((Ticket)localObject)._sig.length == 0));
    paramagxe.a(new String(((Ticket)localObject)._sig));
  }
  
  public void a(agxf paramagxf)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramagxf);
  }
  ...
  public void a(SessionInfo paramSessionInfo, MessageForQQWalletMsg paramMessageForQQWalletMsg, String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      i = aeas.a(paramMessageForQQWalletMsg.messageType);
      str1 = paramString;
      if (TextUtils.isEmpty(paramString)) {
      ...
      localRecorderParam = new QQRecorder.RecorderParam(bahn.jdField_b_of_type_Int, 16000, 1);
      if (!bace.a())
      {
        b(2131629029);
        c("no sdcard");
    ...
    boolean bool2 = true;
    long l1 = agkn.a(localQQAppInterface.getCurrentAccountUin(), "voice_recognieze_in_phone", 0L);
    ...
    if ((!this.jdField_c_of_type_Boolean) && (!bool1)) {
      a(2, agkn.a(localQQAppInterface.getCurrentAccountUin(), "voice_recognieze_in_phone_tips", BaseApplicationImpl.getContext().getResources().getString(2131629962)));
    }
    if (paramBoolean)
    {
    ...
    for (;;)
    {
      ...
      do
      {
        str1 = axoy.a(localQQAppInterface.getCurrentAccountUin(), null, 2, null, false);
        ...
        paramSessionInfo = aael.a(localQQAppInterface, paramString, paramSessionInfo, -2, localRecorderParam.jdField_c_of_type_Int);
  ...
  public void a(MessageRecord paramMessageRecord, ajmm paramajmm, long paramLong, byte[] paramArrayOfByte, String paramString, axox paramaxox)
  {
    QQAppInterface localQQAppInterface;
    Object localObject1;
    Object localObject2;
    ...
    {
      localQQAppInterface = agwj.a();
      localObject1 = (agxf)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      i = 0;
      if (localObject1 != null) {
        i = localObject1.hashCode();
      }
      if ((localQQAppInterface == null) || (paramMessageRecord == null) || (!(paramMessageRecord instanceof MessageForPtt)) || (localObject1 == null) || (((agxf)localObject1).c()) || (this.jdField_b_of_type_Boolean) || (i != this.jdField_a_of_type_Int)) {
        return;
      }
      ...
      if (i == 1)
      {
        paramMessageRecord = (agxf)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        ...
        localQQAppInterface.a().a((MessageRecord)localObject2, paramajmm);
        return;
      }
      if (i != 2) {
        break label307;
    ...
    for (;;)
    {
      a(new agwz(this, localQQAppInterface, (MessageForQQWalletMsg)localObject1, i, paramLong, paramArrayOfByte, paramString, (MessageForPtt)localObject2, paramaxox, paramajmm));
      return;
    ...
    if (i == 3)
    {
      ...
      {
        paramMessageRecord = (MessageForPtt)paramMessageRecord;
        localObject2 = (agxh)this.jdField_a_of_type_JavaUtilMap.get(paramMessageRecord);
        ...
        for (;;)
        {
          a(new agxb(this, localMessageForQQWalletMsg, localQQAppInterface, i, (agxh)localObject2, paramLong, paramArrayOfByte, paramString, (MessageForQQWalletMsg)localObject1, paramMessageRecord, paramaxox, paramajmm));
          return;
  ...
  public void a(String paramString, QQRecorder.RecorderParam paramRecorderParam, double paramDouble)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      bool = ((agxg)localObject2).jdField_a_of_type_Boolean;
      if (bool) {
        b(((agxg)localObject2).jdField_a_of_type_JavaLangString, (MessageRecord)localObject1);
      }
      localObject2 = (agxf)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if ((localObject2 == null) || (((agxf)localObject2).c()) || (bool)) {
        break label679;
      }
      ((agxf)localObject2).a(false, "");
      break label679;
      localObject2 = (MessageForQQWalletMsg)this.jdField_a_of_type_JavaUtilHashMap.get(localObject1);
      ...
      j = aeas.a(((MessageForQQWalletMsg)localObject2).messageType);
      if (j == 8) {
        if (((MessageForQQWalletMsg)localObject2).mQQWalletRedPacketMsg.elem.songFlag == 0) {
          if (this.jdField_d_of_type_Int == -1) {
            if (!agwj.a(BaseApplicationImpl.getContext())) {
              break label682;
            }
          }
        }
  ...
  public void b(int paramInt)
  {
    ...
    localQQAppInterface.runOnUiThread(new VoiceRedPacketHelper.1(this, localBaseApplication, paramInt, localBaseApplication.getResources().getDimensionPixelSize(2131167766)));
  }
  
  public void b(audl paramaudl, audm paramaudm)
  {
    if (((paramaudl instanceof WechatNsWrapper)) && (this.jdField_a_of_type_JavaIoByteArrayOutputStream != null) && (paramaudm != null) && (this.jdField_d_of_type_Boolean)) {
      this.jdField_a_of_type_JavaIoByteArrayOutputStream.write(paramaudm.jdField_a_of_type_ArrayOfByte, 0, paramaudm.jdField_a_of_type_Int);
    }
  }
