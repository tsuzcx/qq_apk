...
public class zaq
{
  ...
  private zau jdField_a_of_type_Zau;
  ...
  public zaq(long paramLong1, long paramLong2)
  {
  ...
  private boolean a()
  {
    try
    {
      ...
      this.jdField_a_of_type_Zav = new zav(null, "MediaCodecGLFrameFetcher");
    }
    ...
    this.jdField_a_of_type_Zav.b(new MediaCodecGLFrameFetcher.2(this));
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_Zau = new zau();
    this.jdField_a_of_type_Zau.a(true);
    this.jdField_a_of_type_Zau.a();
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture = new SurfaceTexture(this.jdField_a_of_type_Zau.a());
    this.f = zap.a(this.c, this.d);
  }
  
  private void d()
  {
    f();
    this.jdField_a_of_type_Zav.b(new MediaCodecGLFrameFetcher.3(this));
  }
  ...
  private void g()
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture.setOnFrameAvailableListener(new zar(this));
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_Zav.b(new MediaCodecGLFrameFetcher.1(this));
      this.jdField_a_of_type_Zav.a();
      this.jdField_a_of_type_Zav = null;
    }
    h();
