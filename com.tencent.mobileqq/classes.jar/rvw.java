  ...
  implements ohx
{
  ...
  private static void a(String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      ndn.a(null, "CliOper", "", "", "0X8009C0F", "0X8009C0F", 0, 0, "", "", paramString1, paramString2);
      return;
    }
  ...
  private boolean a(int paramInt, SneakyParams paramSneakyParams)
  {
    ...
    long l1 = ((Long)bgmq.a(str1, Long.valueOf(0L))).longValue();
    ...
    int j = ((Integer)bgmq.a(str2, Integer.valueOf(paramSneakyParams.getMaximumWakeUpTimes(paramInt)))).intValue();
    if ((l2 - l1) * 1.0D / 86400000.0D > 1.0D)
    {
      ...
      bgmq.a(str2, Integer.valueOf(paramSneakyParams.getMaximumWakeUpTimes(paramInt) - 1));
    }
    for (;;)
    {
      bgmq.a(str1, Long.valueOf(l2));
      return true;
      i = 0;
      break;
      label397:
      ...
      bgmq.a(str2, Integer.valueOf(j - 1));
    }
    label417:
    return false;
  }
  ...
  private boolean a(AladdinConfig paramAladdinConfig)
  {
    try
    {
      ...
      while (paramAladdinConfig.hasNext())
      {
        ...
        String str = TextUtils.join(".", psg.a(localSneakyRule.getProps(), new rvx(this)));
  ...
  private boolean a(SneakyParams paramSneakyParams)
  {
    try
    {
      boolean bool = amom.a(paramSneakyParams.getPackageName(), BaseApplicationImpl.getContext());
      if (bool) {
        return true;
      }
    }
