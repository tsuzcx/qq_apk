...
public class absl
{
  public static int a(Context paramContext, AdAppBtnData paramAdAppBtnData)
  {
    ...
    do
    {
      ...
      paramContext = bhyo.a().b(paramAdAppBtnData);
  ...
  public static int a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      {
        return -1;
        paramContext = bhyo.a().b(paramString2);
  ...
  {
    anbg.a("scheme", paramString1, paramString2, "4", "gdtAppAd", paramContext.getClass().getName());
  }
  ...
  public static void a(Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        Object localObject5 = bhwr.a(str);
        localObject4 = (String)((HashMap)localObject5).get("appid");
        localObject1 = localObject4;
        localObject3 = str;
        if (TextUtils.isEmpty((CharSequence)localObject4))
        {
          localObject1 = (String)((HashMap)localObject5).get(bibw.b);
          localObject3 = str;
        }
        str = bhwr.g() + File.separator + "qapp_center_detail.htm";
        ...
        if ("1".equals((String)bhwr.a(paramBundle.getString("schemaUrl")).get("auto_download")))
        {
          localObject3 = localObject1;
      ...
      continue;
      label456:
      localObject2 = bhwr.m() + File.separator + "qapp_center_detail.htm";
      continue;
      label487:
  ...
  public static boolean b(Context paramContext, GdtBaseAdItem paramGdtBaseAdItem)
  {
    ...
    try
    {
      ...
      bool2 = true;
      bool1 = bool3;
      absb.a(138, paramGdtBaseAdItem.d, paramGdtBaseAdItem.e);
      bool1 = bool3;
      a(paramContext, paramGdtBaseAdItem.b, paramGdtBaseAdItem.jdField_a_of_type_JavaLangString);
      bool1 = bool3;
      abrl.a("GdtAppOpenUtil", "launchAPPMain report " + paramGdtBaseAdItem.toString());
      bool1 = bool2;
      return bool1;
    }
    catch (Exception paramContext)
    {
      abrl.d("GdtAppOpenUtil", "launchApp failed", paramContext);
    }
    return bool1;
  }
  ...
  private static boolean c(Context paramContext, GdtBaseAdItem paramGdtBaseAdItem)
  {
    ...
    if (a(paramContext, paramGdtBaseAdItem.jdField_a_of_type_JavaLangString, paramGdtBaseAdItem.c))
    {
      ...
      try
      {
        ...
        bool2 = true;
        bool1 = bool3;
        absb.a(137, paramGdtBaseAdItem.d, paramGdtBaseAdItem.e);
        bool1 = bool3;
        a(paramContext, paramGdtBaseAdItem.b, paramGdtBaseAdItem.jdField_a_of_type_JavaLangString);
        bool1 = bool3;
        abrl.a("GdtAppOpenUtil", "launchAPPDeepLink report " + paramGdtBaseAdItem.toString());
        bool1 = bool2;
        return bool1;
      }
      catch (Exception paramContext)
      {
        abrl.d("GdtAppOpenUtil", "launchAPPDeepLink failed", paramContext);
        return bool1;
      }
    }
    abrl.a("GdtAppOpenUtil", "launchAPPDeepLink isDLURISupported false");
    return false;
  }
}
