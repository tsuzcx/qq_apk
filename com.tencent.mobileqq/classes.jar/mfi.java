...
public class mfi
  extends ldy
{
  public mfi(MultiVideoCtrlLayerUIBase paramMultiVideoCtrlLayerUIBase) {}
  ...
  protected void a(long paramLong1, int paramInt1, long paramLong2, long paramLong3, long paramLong4, int paramInt2)
  {
    if (QLog.isColorLevel()) {
      QLog.w(this.a.jdField_d_of_type_JavaLangString, 1, "onGaOperationResult, result[" + paramInt1 + "], uin[" + paramLong2 + "], info[" + paramLong3 + "], groupId[" + paramLong4 + "], relationType[" + paramInt2 + "], mCameraNum[" + this.a.o + "], seq[" + paramLong1 + "]");
    }
    lnn locallnn;
    switch (paramInt1)
    {
    ...
    {
      this.a.jdField_b_of_type_Mbx.update(null, new Object[] { Integer.valueOf(105), Boolean.valueOf(bool), Long.valueOf(paramLong1) });
      this.a.C(paramLong1);
      ...
      for (;;)
      {
        ...
        if (paramLong3 == 2L)
        {
          maf.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1029);
        }
        else if (paramLong3 == 4L)
        {
          if ((paramLong2 == this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getLongAccountUin()) && (!this.a.jdField_a_of_type_ComTencentAvVideoController.a().j))
          {
            ...
            maf.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1031);
          }
          for (;;)
          {
            ...
            bcst.b(null, "CliOper", "", "", "0X8004CFD", "0X8004CFD", 0, 0, "", "", "", "");
            break;
            paramInt1 = 0;
            break label485;
            if (QLog.isColorLevel()) {
        ...
        else if (paramLong3 == 8L)
        {
          ...
          {
            MultiVideoCtrlLayerUIBase.a(this.a, false);
            maf.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1033, this.a.jdField_a_of_type_AndroidContentResResources.getString(2131695061));
          }
        }
        else if ((paramLong3 == 9L) && (MultiVideoCtrlLayerUIBase.a(this.a)))
        {
          MultiVideoCtrlLayerUIBase.a(this.a, false);
          maf.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1033, this.a.jdField_a_of_type_AndroidContentResResources.getString(2131695062));
        }
      }
      this.a.u(paramLong3);
      return;
  ...
  protected void a(long paramLong1, long paramLong2, long paramLong3, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      this.a.jdField_b_of_type_Mbx.update(null, new Object[] { Integer.valueOf(104), localArrayList });
      if (paramInt == 2)
      {
        this.a.i(1036);
  ...
  protected void a(long paramLong, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    do
    {
      ...
      if ((this.a.jdField_a_of_type_ComTencentAvVideoController.a() != null) && (this.a.jdField_a_of_type_ComTencentAvVideoController.a().H != 1))
      {
        ...
        str = this.a.jdField_a_of_type_AndroidContentResResources.getString(2131694902);
        float f = mrc.a(str, this.a.jdField_d_of_type_AndroidWidgetTextView.getPaint());
        f = Math.min(this.a.jdField_a_of_type_AndroidContentResResources.getDisplayMetrics().widthPixels - f - this.a.jdField_a_of_type_AndroidContentResResources.getDimensionPixelSize(2131297867) * 2, this.a.jdField_a_of_type_AndroidContentResResources.getDimensionPixelSize(2131297091));
        mrc.b(localStringBuilder, (String)localObject, this.a.jdField_d_of_type_AndroidWidgetTextView.getPaint(), f);
        localStringBuilder.append(str);
      }
      maf.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1033, localStringBuilder.toString());
    ...
    for (int i = 1;; i = 0)
    {
      ((ley)localObject).e("setRoomMicOff", i);
      return;
      ...
      localStringBuilder.append(this.a.jdField_a_of_type_AndroidContentResResources.getString(2131694899));
      break;
    }
  }
  ...
  protected void a(ArrayList<Long> paramArrayList, int paramInt)
  {
    if (paramInt == 0)
    {
      maf.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1034);
      maf.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1035);
    ...
    {
      maf.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1034, 2131694886);
      maf.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1035, this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131695228), new mfj(this));
      return;
    }
    Object localObject;
    long l;
    ...
    else
    {
      ...
      float f = this.a.jdField_a_of_type_AndroidContentResResources.getDimensionPixelSize(2131297091);
      localObject = new StringBuilder();
      mrc.b((StringBuilder)localObject, paramArrayList, this.a.jdField_d_of_type_AndroidWidgetTextView.getPaint(), f);
      if (paramInt != 1) {
        break label419;
      }
      ((StringBuilder)localObject).append(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131694887));
      maf.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1035, this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131695229), new mfk(this));
    }
    for (;;)
    {
      paramArrayList = ((StringBuilder)localObject).toString();
      maf.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1034, paramArrayList);
      return;
      l = this.a.jdField_a_of_type_ComTencentAvVideoController.c;
      break;
      label419:
      ((StringBuilder)localObject).append(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131694888)).append(paramInt);
      ((StringBuilder)localObject).append(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131694889));
      maf.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1035, this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131695230), new mfl(this));
    }
  }
  ...
  protected void d(long paramLong, int paramInt)
  {
    ...
    if (paramInt == 1)
    {
      ...
      float f = this.a.jdField_a_of_type_AndroidContentResResources.getDimensionPixelSize(2131297091);
      localStringBuilder.append(this.a.jdField_a_of_type_AndroidContentResResources.getString(2131694905));
      mrc.b(localStringBuilder, (String)localObject, this.a.jdField_d_of_type_AndroidWidgetTextView.getPaint(), f);
      localStringBuilder.append(this.a.jdField_a_of_type_AndroidContentResResources.getString(2131694904));
      maf.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1033, localStringBuilder.toString());
      localObject = this.a;
      if (paramInt != 1) {
        break label287;
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      localStringBuilder.append(this.a.jdField_a_of_type_AndroidContentResResources.getString(2131694906));
      break;
    }
  }
}
