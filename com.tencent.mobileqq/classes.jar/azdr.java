  ...
  implements SensorEventListener, Handler.Callback
{
  ...
  protected volatile azcn a;
  private azda jdField_a_of_type_Azda;
  private azdd jdField_a_of_type_Azdd = new azdd("step", azcv.B);
  private azdt jdField_a_of_type_Azdt;
  protected String a;
  private double b;
  protected int b;
  protected long b;
  ...
  azdr(int paramInt)
  {
    ...
    this.jdField_a_of_type_Azcn = new azcn(40001);
    this.jdField_a_of_type_Azdd.a(new azds(this));
    this.d = paramInt;
  ...
  private void e()
  {
    ...
    int i = c();
    if (QLog.isColorLevel()) {
      QLog.d(this.jdField_a_of_type_JavaLangString, 2, new Object[] { "[status][step] notifyCheckStatus notmoving:", Boolean.valueOf(bool), " status:", azcv.a(i) });
    }
    if ((bool) || (i == 41042)) {
  ...
  public int a()
  {
    ...
    if ((this.jdField_a_of_type_Double > 0.0D) && (d1 > azcv.y * azcv.B))
    {
      if (QLog.isColorLevel()) {
    ...
    return this.jdField_a_of_type_Azcn.jdField_a_of_type_Int;
  }
  ...
  protected void a()
  {
    try
    {
      ...
      if (this.jdField_a_of_type_Double > 0.0D)
      {
        ...
        this.jdField_a_of_type_Azdd.a(d1);
  ...
  void a(Application paramApplication)
  {
    ...
    this.jdField_a_of_type_Azcn.a("step");
  ...
  void a(azdt paramazdt)
  {
    this.jdField_a_of_type_Azdt = paramazdt;
  }
  ...
  public boolean a()
  {
    ...
    return (this.jdField_b_of_type_Int < azcv.M) && (System.currentTimeMillis() - this.jdField_b_of_type_Long > 60000L) && (this.jdField_a_of_type_Int < azcv.M) && (this.jdField_b_of_type_Long > 0L);
  }
  ...
  public int b()
  {
    ...
    } while ((this.jdField_a_of_type_Int < azcv.M) && (this.jdField_b_of_type_Int < azcv.M) && (this.jdField_c_of_type_Int < azcv.M));
    return 0;
  }
  
  boolean b()
  {
    if ((this.jdField_a_of_type_Azcn.jdField_a_of_type_Int == 41012) || (this.jdField_a_of_type_Azcn.jdField_a_of_type_Int == 41013)) {
      if (this.jdField_c_of_type_Long <= 0L)
      {
        if (QLog.isColorLevel()) {
          QLog.d(this.jdField_a_of_type_JavaLangString, 2, "[status][step] recordStepStartTime. start step mStatus: " + this.jdField_a_of_type_Azcn);
        }
    ...
    {
      return false;
      if ((this.jdField_a_of_type_Azdt != null) && (this.jdField_a_of_type_Azdt.a()))
      {
        long l = System.currentTimeMillis() - this.jdField_c_of_type_Long;
        if (l >= this.jdField_a_of_type_Azdt.a())
        {
          if (QLog.isColorLevel()) {
          ...
          this.jdField_a_of_type_Azdt.a(this.jdField_c_of_type_Long, l);
          return true;
          if (QLog.isColorLevel()) {
            QLog.d(this.jdField_a_of_type_JavaLangString, 2, "[status][step] recordStepStartTime. stop status: " + this.jdField_a_of_type_Azcn);
          }
          this.jdField_c_of_type_Long = 0L;
        }
      }
  ...
  public int c()
  {
    ...
    {
      return j;
      if (this.jdField_a_of_type_Int < azcv.M)
      {
        i = j;
        if (this.jdField_b_of_type_Int < azcv.M) {}
      }
      else
      {
        i = j;
