...
{
  private static bjxx jdField_a_of_type_Bjxx;
  ...
  private bimp jdField_b_of_type_Bimp;
  private String jdField_b_of_type_JavaLangString;
  private String c;
  
  public static bjxx a()
  {
    if (jdField_a_of_type_Bjxx == null) {
      jdField_a_of_type_Bjxx = new bjxx();
    }
    return jdField_a_of_type_Bjxx;
  }
  ...
  private void a(int paramInt)
  {
    ...
    this.jdField_a_of_type_Bimp = null;
    this.jdField_a_of_type_AndroidAppActivity = null;
    this.jdField_b_of_type_Bimp = null;
    this.jdField_a_of_type_AndroidContentContext = null;
    b(paramInt);
    String str = alpo.a(2131714596);
    if (-4 == paramInt) {
      str = alpo.a(2131714591);
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
  ...
  private void a(String paramString, PluginBaseInfo paramPluginBaseInfo)
  {
    ...
    if ((-2 != paramPluginBaseInfo.mState) && (4 != paramPluginBaseInfo.mState) && (!bdee.g(BaseApplicationImpl.getContext())) && (System.currentTimeMillis() - this.jdField_a_of_type_Long > 5000L))
    {
      a(-4);
      return;
    }
  ...
  private void b()
  {
    if ((this.c != null) && (this.c.compareToIgnoreCase("openActivity") == 0))
    {
      ...
      this.jdField_a_of_type_Bhoe.sendEmptyMessageDelayed(1002, 2000L);
    }
    if ((this.jdField_b_of_type_JavaLangString != null) && (this.jdField_b_of_type_JavaLangString.compareToIgnoreCase("launchService") == 0))
    {
      ...
      if ((this.jdField_a_of_type_AndroidContentContext != null) && (this.jdField_b_of_type_Bimp != null))
      {
        if (QLog.isColorLevel()) {
          QLog.d(jdField_a_of_type_JavaLangString, 2, "[SmartDevicePluginLoader]  launchPluginService:");
        }
        bimg.c(this.jdField_a_of_type_AndroidContentContext, this.jdField_b_of_type_Bimp);
        this.jdField_b_of_type_Bimp = null;
        this.jdField_a_of_type_AndroidContentContext = null;
      }
    }
  ...
  public void a(Activity paramActivity, AppRuntime paramAppRuntime, String paramString1, Intent paramIntent, String paramString2, int paramInt, DialogInterface.OnDismissListener paramOnDismissListener, Class<? extends Activity> paramClass)
  {
    ...
    paramAppRuntime = new bepp(paramActivity, paramActivity.getResources().getDimensionPixelSize(2131298914));
    if ((!bool) || (paramOnDismissListener != null))
    {
      paramAppRuntime.a(alpo.a(2131714589));
      paramAppRuntime.setOnDismissListener(new bjxy(this, paramOnDismissListener));
      if (bool) {
        paramAppRuntime.setOnShowListener(new bjxz(this, paramAppRuntime));
      }
    }
    for (;;)
    {
      paramOnDismissListener = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
      ((zpa)paramOnDismissListener.a(51)).b();
      paramIntent.putExtra("userQqResources", 2);
      paramIntent.putExtra("useSkinEngine", true);
      paramIntent.putExtra("param_plugin_gesturelock", true);
      this.jdField_a_of_type_Bimp = new bimp(this.jdField_a_of_type_Int);
      this.jdField_a_of_type_Bimp.jdField_b_of_type_JavaLangString = "qqsmartdevice.apk";
      this.jdField_a_of_type_Bimp.d = PluginInfo.e;
      this.jdField_a_of_type_Bimp.jdField_a_of_type_JavaLangString = paramString1;
      this.jdField_a_of_type_Bimp.e = paramString2;
      this.jdField_a_of_type_Bimp.jdField_a_of_type_JavaLangClass = paramClass;
      this.jdField_a_of_type_Bimp.jdField_a_of_type_AndroidContentIntent = paramIntent;
      this.jdField_a_of_type_Bimp.jdField_b_of_type_Int = paramInt;
      this.jdField_a_of_type_Bimp.jdField_a_of_type_AndroidAppDialog = paramAppRuntime;
      this.jdField_a_of_type_Bimp.c = 10000;
      this.jdField_a_of_type_Bimp.f = null;
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d(jdField_a_of_type_JavaLangString, 2, "[SmartDevicePluginLoader] launchPluginActivity: plugin is installed " + this.jdField_a_of_type_Bimp.e);
        }
        if (bool)
        {
          bimg.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Bimp);
          this.jdField_a_of_type_AndroidAppActivity = null;
          this.jdField_a_of_type_Bimp = null;
          return;
        }
        ...
        {
          this.jdField_a_of_type_Bepp = new bepp(paramActivity, paramActivity.getResources().getDimensionPixelSize(2131298914));
          this.jdField_a_of_type_Bepp.a(alpo.a(2131714590));
        }
      ...
      if (QLog.isColorLevel()) {
        QLog.d(jdField_a_of_type_JavaLangString, 2, "[SmartDevicePluginLoader] launchPluginActivity: waiting for plugin to install " + this.jdField_a_of_type_Bimp.e);
      }
      this.c = "openActivity";
      PluginManagerHelper.getPluginInterface(BaseApplicationImpl.getContext(), this);
      return;
  ...
  public void a(AppRuntime paramAppRuntime, ServiceConnection paramServiceConnection)
  {
    ...
    this.jdField_b_of_type_Bimp = new bimp(this.jdField_a_of_type_Int);
    this.jdField_b_of_type_Bimp.jdField_b_of_type_JavaLangString = "qqsmartdevice.apk";
    this.jdField_b_of_type_Bimp.d = PluginInfo.e;
    this.jdField_b_of_type_Bimp.jdField_a_of_type_JavaLangString = paramAppRuntime.getAccount();
    this.jdField_b_of_type_Bimp.e = "com.tencent.device.ipc.QQSmartDeviceService";
    this.jdField_b_of_type_Bimp.jdField_a_of_type_AndroidContentIntent = localIntent;
    this.jdField_b_of_type_Bimp.jdField_a_of_type_AndroidContentServiceConnection = paramServiceConnection;
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      bimg.c(paramAppRuntime.getApplication(), this.jdField_b_of_type_Bimp);
      this.jdField_b_of_type_Bimp = null;
      this.jdField_a_of_type_AndroidContentContext = null;
      return;
    }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      continue;
      b(0);
      if ((this.jdField_a_of_type_AndroidAppActivity != null) && (this.jdField_a_of_type_Bimp != null))
      {
        if (QLog.isColorLevel()) {
          QLog.d(jdField_a_of_type_JavaLangString, 2, "[SmartDevicePluginLoader]  launchPluginActivity:" + this.jdField_a_of_type_Bimp.e);
        }
        bimg.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Bimp);
      }
      this.jdField_a_of_type_AndroidAppActivity = null;
      this.jdField_a_of_type_Bimp = null;
      this.jdField_a_of_type_Bhoe.sendEmptyMessageDelayed(1003, 600L);
      continue;
      if (this.jdField_a_of_type_Bepp != null)
      {
