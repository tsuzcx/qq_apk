  ...
  implements auez
{
  ...
  public audm(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    paramString5 = bgjh.a(this.a, Long.parseLong(paramString2));
    ...
    try
    {
      ...
      l1 = l2;
      paramString5 = bgjh.a(this.a, l2).a(paramString3);
      l1 = l2;
    }
    ...
    if ((paramString5 != null) && (FileUtil.fileExistsAndNotEmpty(paramString5.l)))
    {
      paramString4 = new BitmapFactory.Options();
      paramString4.inJustDecodeBounds = true;
      aues.a(paramString5.l, paramString4);
    ...
    paramString4 = bcsa.a(-1000);
    agfe.a().a(paramString4.uniseq, paramLong2, paramInt4);
    ...
    if (paramInt1 == 0)
    {
      ...
      localFileManagerEntity.peerNick = auea.a(this.a, paramString1, null, paramInt1);
      ...
      this.a.getFileManagerDataCenter().a(paramString1, paramString2, true, "", paramLong1, true, paramInt1, str, localFileManagerEntity.msgSeq, localFileManagerEntity.msgSeq, paramString3, 1, paramLong2, localFileManagerEntity.msgUid, -1L, bcrg.a());
  ...
  public void a(boolean paramBoolean, long paramLong, int paramInt, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    if (localFileManagerEntity.nOpType == 24)
    {
      ...
      paramString2 = "1";
      label283:
      bdla.b(paramString4, "P_CliOper", "Grp_files", "", "transfer", "Clk_fri", 0, 0, paramString3, str, paramString2, localFileManagerEntity.peerUin);
      label315:
    ...
    for (paramBoolean = true;; paramBoolean = false)
    {
      ...
      if (localFileManagerEntity.peerType == 3000)
      {
        ...
        if (auea.a(localFileManagerEntity.fileName) == 0) {
      ...
      for (;;)
      {
        ...
        break;
        if (auea.a(localFileManagerEntity.fileName) == 2)
        {
          ...
          if (auea.a(localFileManagerEntity.fileName) == 0) {
            paramString2 = this.a.getFileManagerEngine().a(localFileManagerEntity, 5);
          } else if (auea.a(localFileManagerEntity.fileName) == 2) {
      ...
      break label214;
      label793:
      audr.c(BaseApplicationImpl.getContext().getString(2131692474));
      break label232;
      label808:
      paramString2 = "2";
      break label283;
      ...
      {
        bdla.b(paramString4, "P_CliOper", "Grp_files", "", "transfer", "Clk_talk", 0, 0, paramString3, str, paramString2, "");
        break;
      }
    }
  }
