...
public class aljb
  implements bhrh, bhrj
{
  private static aljb jdField_a_of_type_Aljb;
  public int a;
  ...
  public WeakReference<aljj> a;
  public HashMap<MessageForPtt, MessageForQQWalletMsg> a;
  public Map<MessageForPtt, aljl> a;
  ...
  public static aljb a()
  {
    try
    {
      if (jdField_a_of_type_Aljb == null) {
        jdField_a_of_type_Aljb = new aljb();
      }
      aljb localaljb = jdField_a_of_type_Aljb;
      return localaljb;
    }
    finally {}
  }
  
  private aljk a(byte[] paramArrayOfByte)
  {
    boolean bool = true;
    aljk localaljk = new aljk();
    if ((paramArrayOfByte == null) || (paramArrayOfByte.length == 0)) {
      return localaljk;
    }
    alja.a().a();
    if (alja.a().a(paramArrayOfByte, paramArrayOfByte.length) == 1) {}
    for (;;)
    {
      localaljk.jdField_a_of_type_Boolean = bool;
      localaljk.jdField_a_of_type_Float = alja.a().a();
      localaljk.jdField_a_of_type_JavaLangString = a(localaljk.jdField_a_of_type_Float);
      alja.a().b();
  ...
  private aljk a(byte[] paramArrayOfByte, MessageForQQWalletMsg paramMessageForQQWalletMsg)
  {
  ...
  private void a(int paramInt1, long paramLong, int paramInt2, MessageForQQWalletMsg paramMessageForQQWalletMsg, float paramFloat)
  {
    ...
    for (;;)
    {
      ...
      return;
      if (alja.a().a(localQQAppInterface)) {
        paramInt1 = 1;
      } else {
        paramInt1 = 0;
      }
  ...
  {
    aljj localaljj = (aljj)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if ((localaljj != null) && (!localaljj.c())) {
      localaljj.a(paramInt, paramString);
    }
    if (QLog.isColorLevel()) {
  ...
  private void a(MessageRecord paramMessageRecord, long paramLong, byte[] paramArrayOfByte, String paramString)
  {
    ...
    try
    {
      MessageForPtt localMessageForPtt = aean.a(alil.a(), paramMessageRecord.getLocalFilePath(), this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, -2, paramMessageRecord.voiceType);
      if (localMessageForPtt != null)
      {
        this.jdField_a_of_type_JavaUtilMap.put(localMessageForPtt, new aljl(paramMessageRecord, paramLong, paramArrayOfByte, paramString));
        paramArrayOfByte = new QQRecorder.RecorderParam(bhrp.jdField_b_of_type_Int, 16000, 1);
        if (a(this.jdField_a_of_type_ArrayOfByte, this.jdField_a_of_type_JavaLangString, paramMessageRecord.getLocalFilePath(), paramArrayOfByte))
        {
          ...
          if ((paramString != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo != null) && (localMessageForPtt != null))
          {
            ...
            paramArrayOfByte = (aljj)this.jdField_a_of_type_JavaLangRefWeakReference.get();
  ...
  public static void a(String paramString, MessageForPtt paramMessageForPtt, beru paramberu)
  {
    b(paramString, paramMessageForPtt);
    if (paramberu != null)
    {
      if (!(paramberu instanceof bese)) {
        break label38;
      }
      paramString = ((bese)paramberu).a();
    ...
    do
    {
      ...
      {
        return;
      } while (!(paramberu instanceof betz));
      paramString = ((betz)paramberu).a(paramMessageForPtt);
    ...
    for (;;)
    {
      try
      {
        ...
        if (!((File)localObject).exists())
        {
          ...
          localmnw = new mnw(paramRecorderParam.jdField_a_of_type_Int, 16, 1);
          localmnw.a(new aljc(this));
          l = System.currentTimeMillis();
        }
        try
        {
          localmnw.a(paramString1, str);
          if (QLog.isColorLevel()) {
          ...
          balu.a(paramString2);
          paramRecorderParam = bhrp.a(paramRecorderParam.jdField_c_of_type_Int, paramRecorderParam.jdField_a_of_type_Int);
          balu.a(paramString2, paramRecorderParam, paramRecorderParam.length);
          ...
          balu.a(paramString2, ((bamv)localObject).jdField_a_of_type_ArrayOfByte, ((bamv)localObject).jdField_a_of_type_Int);
        }
  ...
  public int a(String paramString, QQRecorder.RecorderParam paramRecorderParam)
  {
    ...
    paramString = (aljj)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if (paramString != null) {
  ...
  public String a(float paramFloat)
  {
    ...
    {
      localObject1 = (alao)((QQAppInterface)localObject1).getManager(245);
      if (localObject1 != null)
      {
        localObject1 = ((alao)localObject1).a("voice_pwd", new String[] { "scoreIdMap" });
        if (localObject1 == null) {}
      }
    }
    int i;
  ...
  public void a(alji paramalji)
  {
    ...
    if ((localObject == null) || (paramalji == null)) {}
    do
    {
      return;
      localObject = ((TicketManager)((QQAppInterface)localObject).getManager(2)).getSkey(((QQAppInterface)localObject).getCurrentAccountUin(), 16L, new aljh(this, paramalji));
    } while ((localObject == null) || (((Ticket)localObject)._sig == null) || (((Ticket)localObject)._sig.length == 0));
    paramalji.a(new String(((Ticket)localObject)._sig));
  }
  
  public void a(aljj paramaljj)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramaljj);
  }
  ...
  public void a(SessionInfo paramSessionInfo, MessageForQQWalletMsg paramMessageForQQWalletMsg, String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      i = aigp.a(paramMessageForQQWalletMsg.messageType);
      str1 = paramString;
      if (TextUtils.isEmpty(paramString)) {
      ...
      localRecorderParam = new QQRecorder.RecorderParam(bhrp.jdField_b_of_type_Int, 16000, 1);
      if (!bhmi.a())
      {
        b(2131694020);
        c("no sdcard");
    ...
    boolean bool2 = true;
    long l1 = akyd.a(localQQAppInterface.getCurrentAccountUin(), "voice_recognieze_in_phone", 0L);
    ...
    if ((!this.jdField_c_of_type_Boolean) && (!bool1)) {
      a(2, akyd.a(localQQAppInterface.getCurrentAccountUin(), "voice_recognieze_in_phone_tips", BaseApplicationImpl.getContext().getResources().getString(2131694723)));
    }
    if (paramBoolean)
    {
    ...
    for (;;)
    {
      ...
      do
      {
        str1 = berv.a(localQQAppInterface.getCurrentAccountUin(), null, 2, null, false);
        ...
        paramSessionInfo = aean.a(localQQAppInterface, paramString, paramSessionInfo, -2, localRecorderParam.jdField_c_of_type_Int);
  ...
  public void a(MessageRecord paramMessageRecord, aocj paramaocj, long paramLong, byte[] paramArrayOfByte, String paramString, beru paramberu)
  {
    QQAppInterface localQQAppInterface;
    Object localObject1;
    Object localObject2;
    ...
    {
      localQQAppInterface = alil.a();
      localObject1 = (aljj)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      i = 0;
      if (localObject1 != null) {
        i = localObject1.hashCode();
      }
      if ((localQQAppInterface == null) || (paramMessageRecord == null) || (!(paramMessageRecord instanceof MessageForPtt)) || (localObject1 == null) || (((aljj)localObject1).c()) || (this.jdField_b_of_type_Boolean) || (i != this.jdField_a_of_type_Int)) {
        return;
      }
      ...
      if (i == 1)
      {
        paramMessageRecord = (aljj)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        ...
        localQQAppInterface.a().a((MessageRecord)localObject2, paramaocj);
        return;
      }
      if (i != 2) {
        break label307;
    ...
    for (;;)
    {
      a(new aljd(this, localQQAppInterface, (MessageForQQWalletMsg)localObject1, i, paramLong, paramArrayOfByte, paramString, (MessageForPtt)localObject2, paramberu, paramaocj));
      return;
    ...
    if (i == 3)
    {
      ...
      {
        paramMessageRecord = (MessageForPtt)paramMessageRecord;
        localObject2 = (aljl)this.jdField_a_of_type_JavaUtilMap.get(paramMessageRecord);
        ...
        for (;;)
        {
          a(new aljf(this, localMessageForQQWalletMsg, localQQAppInterface, i, (aljl)localObject2, paramLong, paramArrayOfByte, paramString, (MessageForQQWalletMsg)localObject1, paramMessageRecord, paramberu, paramaocj));
          return;
  ...
  public void a(String paramString, QQRecorder.RecorderParam paramRecorderParam, double paramDouble)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      bool = ((aljk)localObject2).jdField_a_of_type_Boolean;
      if (bool) {
        b(((aljk)localObject2).jdField_a_of_type_JavaLangString, (MessageRecord)localObject1);
      }
      localObject2 = (aljj)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if ((localObject2 == null) || (((aljj)localObject2).c()) || (bool)) {
        break label679;
      }
      ((aljj)localObject2).a(false, "");
      break label679;
      localObject2 = (MessageForQQWalletMsg)this.jdField_a_of_type_JavaUtilHashMap.get(localObject1);
      ...
      j = aigp.a(((MessageForQQWalletMsg)localObject2).messageType);
      if (j == 8) {
        if (((MessageForQQWalletMsg)localObject2).mQQWalletRedPacketMsg.elem.songFlag == 0) {
          if (this.jdField_d_of_type_Int == -1) {
            if (!alil.a(BaseApplicationImpl.getContext())) {
              break label682;
            }
          }
        }
  ...
  public void b(int paramInt)
  {
    ...
    localQQAppInterface.runOnUiThread(new VoiceRedPacketHelper.1(this, localBaseApplication, paramInt, localBaseApplication.getResources().getDimensionPixelSize(2131299011)));
  }
  
  public void b(bamu parambamu, bamv parambamv)
  {
    if (((parambamu instanceof WechatNsWrapper)) && (this.jdField_a_of_type_JavaIoByteArrayOutputStream != null) && (parambamv != null) && (this.jdField_d_of_type_Boolean)) {
      this.jdField_a_of_type_JavaIoByteArrayOutputStream.write(parambamv.jdField_a_of_type_ArrayOfByte, 0, parambamv.jdField_a_of_type_Int);
    }
  }
