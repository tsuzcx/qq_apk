...
public class aljb
  extends bdqc
  implements aequ, akmo, View.OnClickListener
{
  ...
  public aljb(BaseChatPie paramBaseChatPie)
  {
  ...
  public void a()
  {
    ...
    ((bdpx)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(71)).a(localntw.b);
  }
  ...
  public void a(String paramString)
  {
    ...
    do
    {
      ...
      {
        return;
        Object localObject = (ImageView)localLinearLayout.findViewById(2131368964);
        TextView localTextView = (TextView)localLinearLayout.findViewById(2131368804);
        ((ImageView)localObject).setOnClickListener(this);
        localTextView.setOnClickListener(this);
        localObject = (URLImageView)localLinearLayout.findViewById(2131368679);
  ...
  protected void onChangeUserApolloStatus(boolean paramBoolean, Object paramObject)
  {
    ...
    do
    {
      ...
      {
        akwk.a(localBaseChatPie.a(), "cmshow_status", true);
        return;
      }
    } while (1 != ((Integer)paramObject.second).intValue());
    akwk.a(localBaseChatPie.a(), "cmshow_status", false);
    ...
    ((akje)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(211)).e();
  }
        ...
        do
        {
          ...
          case 2131367716: 
            if (localBaseChatPie.c == null)
            {
              ...
              localBaseChatPie.c = new bepp(localBaseChatPie.jdField_a_of_type_AndroidContentContext, i);
            }
            localBaseChatPie.c.a(alpo.a(2131701954));
            ...
            localObject = (bdpx)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(71);
          }
        } while ((paramView == null) || (localObject == null));
        ((bdpx)localObject).a(paramView.b, localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.b);
    ...
    do
    {
      ...
      do
      {
        do
        {
            ...
            do
            {
              do
              {
                do
                {
                  ...
                  {
                    QQToast.a(BaseApplicationImpl.getContext(), alpo.a(2131701956), 1).a();
                    return;
                  }
          ...
          QQToast.a(BaseApplicationImpl.getContext(), alpo.a(2131701955), 1).a();
          return;
  ...
  {
    if ((TextUtils.isEmpty(paramString)) || (!bcgh.b(paramString))) {
    ...
    do
    {
      do
      {
        do
        {
          ...
          localBaseChatPie = (BaseChatPie)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        } while ((localBaseChatPie == null) || (localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null) || (localBaseChatPie.jdField_a_of_type_Aklj == null) || (!localBaseChatPie.jdField_a_of_type_Aklj.a()) || (localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo == null));
        if (!bdee.g(localBaseChatPie.jdField_a_of_type_AndroidContentContext))
        {
        ...
        localObject = akwt.a(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        if (localObject == null) {
          break;
        }
        localObject = ((akwq)localObject).a();
      } while ((localObject != null) && (((akwr)localObject).a()));
      localObject = (akji)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153);
      ...
      if (((akji)localObject).b(paramString) != 1)
      {
    ...
    } while (akji.a(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString) == 2);
    if (localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 0) {
      localObject = bdbt.m(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString);
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
      ...
      localBaseChatPie.jdField_a_of_type_Aklj.b();
      ...
      if (localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1) {
        localObject = bdbt.e(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, paramString);
      } else if (localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 3000) {
        localObject = bdbt.b(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, true);
      } else {
        localObject = "";
      }
    }
      ...
      do
      {
        do
        {
          do
          {
            ...
            if (paramInt == 7)
            {
              localObject = (akje)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(211);
              if (((akje)localObject).jdField_a_of_type_Int != -1)
              {
                ApolloGameUtil.a(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((akje)localObject).jdField_a_of_type_Int, 0L, 0, "", 321, null);
                return;
              }
              if (((akje)localObject).jdField_a_of_type_Albw != null)
              {
                localObject = ((akje)localObject).jdField_a_of_type_Albw.a();
                if ((localObject != null) && ((((DrawerPushItem)localObject).msg_type == 10) || (((DrawerPushItem)localObject).msg_type == 7))) {
                  akji.a(102, String.valueOf(((DrawerPushItem)localObject).tianshuAdId), ((DrawerPushItem)localObject).tianshuTraceInfo);
                }
              }
            }
            Object localObject = akwt.a(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
            if (localObject != null) {
              ((akwc)localObject).a(akwt.a(paramInt), null, paramString);
            }
            paramString = (akwq)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(249);
          } while (paramString == null);
  ...
  protected void onQueryUserApolloAction(boolean paramBoolean, Object paramObject)
  {
    if (this.jdField_a_of_type_JavaLangRefWeakReference == null)
    {
      akji.jdField_a_of_type_Boolean = true;
      if (QLog.isColorLevel()) {
  ...
  public void onSurfaceReady(int paramInt1, int paramInt2)
  {
    ...
    akwq localakwq = (akwq)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(249);
    if (localakwq.a() != null) {
      alda.a(akwt.b(localakwq.a().e), 100, 0, new Object[] { "onSurfaceReady" });
    }
    if (!localBaseChatPie.jdField_a_of_type_Aklj.jdField_a_of_type_Boolean)
    {
      algf.a("TraceReport_initApolloSurfaceView_PreLoadJS");
