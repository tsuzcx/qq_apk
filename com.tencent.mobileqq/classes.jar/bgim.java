  ...
  extends bgix
{
  ...
  public bgim()
  {
    this.jdField_a_of_type_JavaLangString = bgim.class.getSimpleName();
  }
  ...
  public boolean a(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    {
      paramString1 = paramJsBridgeListener.getTag(2131302107);
      if ((paramString1 != null) && ((paramString1 instanceof bgin)))
      {
        paramString1 = (bgin)paramString1;
    ...
    for (;;)
    {
      ...
      if (i == 1) {
        ...
        paramString1.setBannerHeight((int)bajq.a((float)d));
      } else if (i == 3) {
        paramString1.setBannerHeight((int)(d * bajq.a()));
      } else {
