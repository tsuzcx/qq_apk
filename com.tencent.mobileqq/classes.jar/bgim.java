...
public final class bgim
{
  ...
  public static <T> void a(WebView paramWebView, bgir<T> parambgir)
  {
    ...
    if (paramWebView == null)
    {
      ...
      parambgir.a(new NullPointerException("mWebView is null"));
      return;
    }
    ...
    if (localObject1 == null)
    {
      ...
      parambgir.a(new NullPointerException("context is null"));
      return;
    }
    AtomicBoolean localAtomicBoolean = new AtomicBoolean(false);
    localObject1 = new ayjb((Context)localObject1);
    ((ayjb)localObject1).a(anni.a(2131698220));
    ((ayjb)localObject1).a(true);
    ((ayjb)localObject1).a(new bgin(localAtomicBoolean, (ayjb)localObject1));
    ((ayjb)localObject1).show();
    ...
    Object localObject2 = new bgio((ayjb)localObject1);
    ...
    ((ayjb)localObject1).setOnDismissListener(new bgip((AnimatorSet)localObject2));
    a(paramWebView, new bgiq(localAtomicBoolean, (ayjb)localObject1, parambgir, paramWebView, (AnimatorSet)localObject2));
  }
  
  public static void a(WebView paramWebView, bgis parambgis)
  {
    if ((paramWebView == null) || (parambgis == null)) {}
    int i;
    int j;
    Bitmap localBitmap;
    do
            ...
            try
            {
              ...
              try
              {
                if (jdField_a_of_type_JavaLangReflectMethod != null) {
                  jdField_a_of_type_JavaLangReflectMethod.invoke(paramWebView.getX5WebViewExtension(), new Object[] { localBitmap, Boolean.valueOf(true), Boolean.valueOf(true), Boolean.valueOf(true), Boolean.valueOf(true), Integer.valueOf(1), Integer.valueOf(1), new ScreenShotUtil.1(parambgis, localBitmap) });
                }
                i = 1;
              }
  ...
  public static <T> boolean a(WebView paramWebView, bgir<T> parambgir)
  {
    ...
    for (;;)
    {
      ...
      if ((i <= 0) || (k <= 0) || (j <= 0))
      {
        ...
        parambgir.a(new IllegalStateException("measuredWidth <= 0 || contentWidth <= 0 || contentHeight <= 0"));
        return false;
      }
      float f = i / k;
      j = (int)(j * f);
      if (j > 20000)
      {
        ...
        parambgir.a(new IllegalStateException(anni.a(2131717580)));
        return false;
      }
      try
      {
        ...
        if (localBitmap != null)
        {
          Canvas localCanvas = new Canvas(localBitmap);
          localCanvas.scale(f, f);
          ThreadManagerV2.executeOnNetWorkThread(new ScreenShotUtil.2(paramWebView, localCanvas, parambgir, localBitmap));
          return true;
        }
      }
