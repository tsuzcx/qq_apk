  ...
  extends actm
{
  ...
  public aduu(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo)
  {
  ...
  private View a(View paramView, adux paramadux)
  {
    View localView = paramView;
    if (paramView == null)
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558738, null);
      paramadux.c = ((TextView)paramView.findViewById(2131370647));
      paramadux.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)paramView.findViewById(2131367679));
      paramadux.d = ((TextView)paramView.findViewById(2131365017));
      paramadux.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131377350));
      paramadux.e = ((TextView)paramView.findViewById(2131377315));
      paramadux.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131364779));
      paramadux.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelCornerImageView = ((CornerImageView)paramView.findViewById(2131364780));
    }
    try
    {
      paramadux.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelCornerImageView.setImageResource(2130844560);
      paramadux.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelCornerImageView.setRadius(actj.a(3.0F, paramadux.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelCornerImageView.getResources()));
      paramadux.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelCornerImageView.setPressMask(true);
      Object localObject = paramadux.jdField_b_of_type_AndroidWidgetTextView.getCompoundDrawables();
      ...
      {
        paramadux.jdField_b_of_type_JavaLangStringBuilder = new StringBuilder();
        localView = paramView;
      }
      if (jdField_e_of_type_Boolean)
      {
        localView.setContentDescription(null);
        paramadux.jdField_b_of_type_JavaLangStringBuilder.replace(0, paramadux.jdField_b_of_type_JavaLangStringBuilder.length(), "");
        paramadux.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelCornerImageView.setContentDescription(null);
      }
      return localView;
    }
  ...
  private void a(String paramString1, String paramString2, int paramInt1, int paramInt2, long paramLong1, long paramLong2)
  {
    if ((paramLong1 == 0L) || (paramLong2 == 0L)) {
      a(bbbr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramString1), paramString1);
    }
    String str;
    do
    {
      ...
      paramString2 = asge.a(new String[] { paramInt2 + "", paramInt1 + "", paramString1, str });
    ...
    for (;;)
    {
      try
      {
        paramString1 = asge.a(Long.valueOf(1000L * paramLong1)).substring(0, 4);
  ...
  {
    paramacxj = (MessageForMedalNews)paramMessageRecord;
    paramLinearLayout = (adux)paramactn;
    paramView = a(paramView, paramLinearLayout);
    paramLinearLayout.jdField_a_of_type_Long = paramacxj.uniseq;
    paramLinearLayout.jdField_a_of_type_JavaLangString = paramacxj.frienduin;
    int n = paramacxj.level;
    paramMessageRecord = paramacxj.name;
    paramactn = paramacxj.desc;
    String str = paramacxj.icon;
    int i = 1;
    int k = 1;
    int m = 1;
    ...
    if (j != 0)
    {
      ...
      localObject = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131699122, new Object[] { localObject });
    ...
    {
      label378:
      if (!paramLinearLayout.d.getText().equals(paramactn)) {
        paramLinearLayout.d.setText(paramactn);
      }
      if (k != 0) {
    ...
    try
    {
      paramactn = URLDrawable.URLDrawableOptions.obtain();
      paramactn.mRequestWidth = this.c;
      paramactn.mRequestHeight = this.c;
      paramactn.mLoadingDrawable = aywm.a;
      paramactn.mFailedDrawable = aywm.a;
      paramactn = URLDrawable.getDrawable(str, paramactn);
    ...
    paramactn = paramMessageRecord;
    if (paramMessageRecord == null) {
      paramactn = aywm.a;
    }
    ((URLImageView)localObject).setImageDrawable(paramactn);
    ...
    default: 
      ...
      paramactn = paramLinearLayout.jdField_b_of_type_AndroidWidgetTextView.getCompoundDrawables();
      paramMessageRecord = paramactn[0];
      paramactn = paramactn[2];
      paramMessageRecord.setColorFilter(this.jdField_a_of_type_AndroidGraphicsColorFilter);
      paramactn.setColorFilter(this.jdField_a_of_type_AndroidGraphicsColorFilter);
      ...
      if (n <= 3)
      {
        ...
        paramLinearLayout.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelCornerImageView.setOnClickListener(new aduv(this, paramacxj));
        if (paramacxj.myLevel != 0) {
          break label968;
        }
      }
      break;
    ...
    for (i = 0;; i = 8)
    {
      ...
      paramMessageRecord = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131699123);
      if (!paramMessageRecord.equalsIgnoreCase(paramLinearLayout.e.getText().toString()))
      {
        ...
        paramMessageRecord.setSpan(new annk(new aduw(this), this.jdField_a_of_type_AndroidContentResColorStateList), 11, 14, 33);
