  ...
  implements Handler.Callback
{
  ...
  private bgdv jdField_a_of_type_Bgdv;
  ...
  public void a(int paramInt1, int paramInt2, bgwl parambgwl)
  {
    ...
    } while (parambgwl == null);
    parambgwl.a("");
    return;
    ThreadManager.post(new SwiftBrowserMiscHandler.3(this, bfrx.a(localCustomWebView, paramInt1, paramInt2), parambgwl), 8, null, true);
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.mRootView != null))
      {
        ...
        {
          RelativeLayout localRelativeLayout = (RelativeLayout)this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.mRootView.findViewById(2131363709);
          this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)LayoutInflater.from(BaseApplicationImpl.getContext()).inflate(2131561847, null));
          RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, -2);
          localLayoutParams.addRule(12);
          localRelativeLayout.addView(this.jdField_a_of_type_AndroidViewViewGroup, localLayoutParams);
          this.jdField_a_of_type_AndroidViewViewGroup.setOnTouchListener(new bgwk(this));
        }
        if (this.jdField_a_of_type_Bgdv == null) {
          this.jdField_a_of_type_Bgdv = new bgdv(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity, this.jdField_a_of_type_AndroidViewViewGroup);
        }
        this.jdField_a_of_type_Bgdv.h();
        paramMessage = (Bundle)paramMessage.obj;
        this.jdField_a_of_type_Bgdv.a(paramMessage.getLong("id"), paramMessage.getString("type"), paramMessage.getString("callbackId"));
        continue;
        paramMessage = (Bundle)paramMessage.obj;
        if (this.jdField_a_of_type_Bgdv != null)
        {
          this.jdField_a_of_type_Bgdv.a(paramMessage.getLong("id"), paramMessage.getString("type"), paramMessage.getInt("status"), paramMessage.getString("callbackId"));
          continue;
          if (this.jdField_a_of_type_Bgdv != null)
          {
            paramMessage = (Bundle)paramMessage.obj;
            this.jdField_a_of_type_Bgdv.a(paramMessage.getString("callbackId"));
          }
        }
      }
    }
  ...
  public void onLifeCycleStateChanged(int paramInt, Bundle paramBundle)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
        } while (this.jdField_a_of_type_Bgdv == null);
        this.jdField_a_of_type_Bgdv.f();
        return;
      } while (this.jdField_a_of_type_Bgdv == null);
      this.jdField_a_of_type_Bgdv.g();
      return;
      if (this.jdField_a_of_type_Bgdv != null) {
        this.jdField_a_of_type_Bgdv.e();
      }
