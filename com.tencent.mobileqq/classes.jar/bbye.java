...
public class bbye
  extends bbxz
{
  public bbye(Activity paramActivity, JSONObject paramJSONObject, auuy paramauuy)
  {
    super(paramActivity, paramJSONObject, paramauuy);
    this.d = vzl.a(paramActivity, 4.0F);
  }
  ...
  public View a(JSONObject paramJSONObject, View paramView)
  {
    ...
    TextView localTextView = (TextView)paramView.findViewById(2131377185);
    ImageView localImageView = (ImageView)paramView.findViewById(2131367815);
    String str = localTextView.getText().toString();
    if ((this.jdField_a_of_type_Auuy.a.a != 0) && (str.length() > 4) && (str.substring(str.length() - 4, str.length()).equals("QQ空间"))) {
      localTextView.setText(str.substring(0, str.length() - 4) + ajya.a(2131714823));
    }
