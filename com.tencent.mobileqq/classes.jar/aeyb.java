  ...
  implements Manager
{
  ...
  public aeyb(QQAppInterface paramQQAppInterface)
  {
  ...
  private void b(MessageRecord paramMessageRecord, AppGuideTipsConfig paramAppGuideTipsConfig)
  {
    ...
    paramMessageRecord = new aucf(str, (String)localObject, paramAppGuideTipsConfig.tipsMsg, paramMessageRecord.istroop, -5022, 2621441, l);
  ...
  public void a(BaseChatPie paramBaseChatPie, MessageRecord paramMessageRecord)
  {
    ...
    label22:
    while (apse.a(paramMessageRecord)) {
      return;
    }
    ...
    for (;;)
    {
      ...
      bcef.b(null, "dc00898", "", "", "0X8008947", "0X8008947", 0, 0, "", "", "", "");
      return;
      localAppGuideTipsConfig.allow = false;
      break label92;
      label277:
  ...
  public void a(java.util.List<AppGuideTipsConfig> paramList)
  {
    ...
    //   15: astore_3
    //   16: aload_0
    //   17: getfield 50	aeyb:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    ...
    //   32: aload_0
    //   33: getfield 32	aeyb:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   36: invokeinterface 414 1 0
    //   41: aload_0
    //   42: iconst_0
    //   43: putfield 95	aeyb:jdField_a_of_type_Boolean	Z
    //   46: iconst_0
    //   47: istore_2
    //   48: iload_2
    //   49: aload_1
    ...
    //   72: ifnull +234 -> 306
    //   75: aload_0
    //   76: getfield 50	aeyb:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   79: ldc 97
    //   81: aload 4
    ...
    //   139: aload_0
    //   140: getfield 50	aeyb:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   143: aload 4
    //   145: ldc_w 427
    //   148: iconst_1
    ...
    //   190: aload_0
    //   191: aload 4
    //   193: invokevirtual 385	aeyb:a	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   196: pop
    //   197: goto +116 -> 313
    //   200: aload_3
    ...
    //   227: ifeq +33 -> 260
    //   230: getstatic 22	aeyb:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   233: iconst_2
