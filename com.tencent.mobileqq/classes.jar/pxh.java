...
public class pxh
{
  ...
  /* Error */
  public static pxh a(VideoAdInfo paramVideoAdInfo)
  {
    // Byte code:
    //   0: aload_0
    //   1: ifnonnull +5 -> 6
    ...
    //   25: new 2	pxh
    //   28: dup
    //   29: invokespecial 78	pxh:<init>	()V
    //   32: astore_2
    //   33: aload_2
    //   34: aload_1
    //   35: ldc 80
    //   37: invokevirtual 52	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   40: putfield 82	pxh:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   43: aload_2
    //   44: aload_0
    //   45: getfield 84	com/tencent/biz/pubaccount/VideoAdInfo:f	Ljava/lang/String;
    //   48: putfield 86	pxh:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   51: aload_2
    //   52: aload_1
    //   53: ldc 48
    //   55: invokevirtual 52	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   58: putfield 88	pxh:d	Ljava/lang/String;
    //   61: aload_2
    //   62: aload_1
    //   63: ldc 90
    //   65: invokevirtual 52	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   68: putfield 92	pxh:e	Ljava/lang/String;
    //   71: aload_2
    //   72: aconst_null
    //   73: putfield 94	pxh:c	Ljava/lang/String;
    //   76: aload_2
    //   77: iconst_0
    //   78: putfield 96	pxh:jdField_b_of_type_Int	I
    //   81: aload_2
    //   82: iconst_0
    //   83: putfield 26	pxh:jdField_a_of_type_Int	I
    //   86: aload_2
    //   87: astore_1
    //   88: aload_0
    ...
    //   103: putfield 106	pxh:f	Ljava/lang/String;
    //   106: aload_2
    //   107: astore_1
    //   108: aload_1
    //   109: areturn
  ...
  /* Error */
  public static pxh a(VideoInfo.GameAdComData paramGameAdComData)
  {
    // Byte code:
    //   0: aload_0
    //   1: ifnonnull +5 -> 6
    ...
    //   37: new 2	pxh
    //   40: dup
    //   41: invokespecial 78	pxh:<init>	()V
    //   44: astore_1
    //   45: aload_1
    //   46: aload_0
    //   47: getfield 121	com/tencent/biz/pubaccount/VideoInfo$GameAdComData:g	Ljava/lang/String;
    //   50: putfield 82	pxh:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   53: aload_1
    //   54: aload_0
    ...
    //   66: putfield 92	pxh:e	Ljava/lang/String;
    //   69: aload_1
    //   70: aload_2
    //   71: ldc 125
    //   73: invokevirtual 52	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   76: putfield 94	pxh:c	Ljava/lang/String;
    //   79: aload_1
    //   80: iconst_0
    //   81: putfield 96	pxh:jdField_b_of_type_Int	I
    //   84: aload_1
    //   85: iconst_0
    //   86: putfield 26	pxh:jdField_a_of_type_Int	I
    //   89: aload_1
    //   90: iconst_1
    //   91: putfield 127	pxh:jdField_a_of_type_Boolean	Z
    //   94: aload_1
    //   95: aload_0
    //   96: putfield 129	pxh:jdField_a_of_type_ComTencentBizPubaccountVideoInfo$GameAdComData	Lcom/tencent/biz/pubaccount/VideoInfo$GameAdComData;
  ...
  public static pxh a(AdvertisementInfo paramAdvertisementInfo)
  {
    return a(paramAdvertisementInfo, false);
  }
  
  public static pxh a(AdvertisementInfo paramAdvertisementInfo, boolean paramBoolean)
  {
    ...
    try
    {
      ((pxh)localObject2).jdField_a_of_type_Boolean = true;
      localObject1 = localObject2;
      ((pxh)localObject2).jdField_a_of_type_JavaLangString = ((JSONObject)localObject3).optString("game_app_id");
      localObject1 = localObject2;
      ((pxh)localObject2).d = ((JSONObject)localObject3).optString("game_pkg_name");
      localObject1 = localObject2;
      ((pxh)localObject2).e = ((JSONObject)localObject3).optString("game_app_name");
      localObject1 = localObject2;
      ((pxh)localObject2).c = ((JSONObject)localObject3).optString("game_apk_url");
      localObject1 = localObject2;
      ((pxh)localObject2).g = ((JSONObject)localObject3).optString("game_adtag");
      localObject1 = localObject2;
      ((pxh)localObject2).h = ((JSONObject)localObject3).optString("__ADSTR__");
      localObject1 = localObject2;
      ((pxh)localObject2).jdField_b_of_type_Int = 0;
      localObject1 = localObject2;
      ((pxh)localObject2).jdField_a_of_type_Int = 0;
      localObject1 = localObject2;
      ((pxh)localObject2).jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo = paramAdvertisementInfo;
      return localObject2;
    }
    catch (JSONException paramAdvertisementInfo)
    {
    ...
    if (paramAdvertisementInfo.mAdExt != null)
    {
      ...
      localObject3 = new pxh();
      localObject1 = localObject3;
      ((pxh)localObject3).jdField_a_of_type_JavaLangString = localJSONObject.optString("appid");
      if (paramBoolean) {
        localObject1 = localObject3;
      }
      ...
      {
        localObject1 = localObject3;
        ((pxh)localObject3).jdField_b_of_type_JavaLangString = ((String)localObject2);
        localObject1 = localObject3;
        ((pxh)localObject3).d = localJSONObject.optString("pkg_name");
        localObject1 = localObject3;
        ((pxh)localObject3).e = localJSONObject.optString("appname");
        localObject1 = localObject3;
        ((pxh)localObject3).c = "";
        localObject1 = localObject3;
        ((pxh)localObject3).jdField_b_of_type_Int = 0;
        localObject1 = localObject3;
        ((pxh)localObject3).jdField_a_of_type_Int = 0;
        localObject1 = localObject3;
        ((pxh)localObject3).jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo = paramAdvertisementInfo;
        localObject1 = localObject3;
        ...
        localObject1 = localObject3;
        ((pxh)localObject3).f = paramAdvertisementInfo.mAdVia;
        localObject2 = localObject3;
        break;
        localObject1 = localObject3;
      }
  ...
  public static pxh a(AdData paramAdData)
  {
    if ((paramAdData == null) || (paramAdData.a == null)) {
      return null;
    }
    pxh localpxh = new pxh();
    localpxh.jdField_a_of_type_JavaLangString = paramAdData.a.c;
    localpxh.jdField_b_of_type_JavaLangString = paramAdData.a.jdField_a_of_type_JavaLangString;
    localpxh.d = paramAdData.a.jdField_b_of_type_JavaLangString;
    localpxh.e = paramAdData.a.d;
    localpxh.c = paramAdData.a.e;
    localpxh.jdField_b_of_type_Int = 0;
    localpxh.jdField_a_of_type_Int = 0;
    localpxh.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataAdData = paramAdData;
    if (!TextUtils.isEmpty(paramAdData.A)) {
      localpxh.f = paramAdData.A;
    }
    if (npa.a(paramAdData)) {
      localpxh.jdField_a_of_type_Boolean = true;
    }
    localpxh.g = paramAdData.S;
    localpxh.h = paramAdData.R;
    localpxh.i = paramAdData.Q;
    return localpxh;
  }
  
  public static pxh a(nmx paramnmx)
  {
    if (paramnmx == null) {
      return null;
    }
    pxh localpxh = new pxh();
    localpxh.jdField_a_of_type_JavaLangString = paramnmx.o;
    localpxh.jdField_b_of_type_JavaLangString = paramnmx.q;
    localpxh.d = paramnmx.n;
    localpxh.e = paramnmx.p;
    localpxh.c = paramnmx.q;
    localpxh.g = paramnmx.u;
    localpxh.h = paramnmx.v;
    localpxh.jdField_b_of_type_Int = 0;
    localpxh.jdField_a_of_type_Int = 0;
    localpxh.jdField_a_of_type_Boolean = true;
    return localpxh;
  ...
  {
    return (parampxh != null) && (parampxh.jdField_a_of_type_JavaLangString.equals(this.jdField_a_of_type_JavaLangString)) && (parampxh.d.equals(this.d)) && (parampxh.jdField_b_of_type_JavaLangString.equals(this.jdField_b_of_type_JavaLangString));
  }
