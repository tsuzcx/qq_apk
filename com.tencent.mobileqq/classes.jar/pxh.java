  ...
  extends pxz
{
  ...
  public pxh(AppInterface paramAppInterface, EntityManager paramEntityManager, ExecutorService paramExecutorService, qnd paramqnd, Handler paramHandler)
  {
  ...
  public static void a(String paramString)
  {
    ...
    for (;;)
    {
      oat.a(null, "", paramString, paramString, 0, 0, "" + i, pha.a(), "0", null, false);
      return;
      i = 1;
      continue;
      i = 0;
  ...
  {
    Object localObject = anni.a(2131703651);
    int i = ((String)localObject).indexOf("领取1G流量");
    localObject = new SpannableString((CharSequence)localObject);
    ((SpannableString)localObject).setSpan(new pxi(), i, i + 6, 33);
    return localObject;
  }
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0) {
      ...
      {
        if (this.jdField_a_of_type_Pxj == null) {
          this.jdField_a_of_type_Pxj = new pxj();
        }
        if (paramToServiceMsg.uint32_receive_status.has()) {
          this.jdField_a_of_type_Pxj.jdField_a_of_type_Int = paramToServiceMsg.uint32_receive_status.get();
        }
        if (paramToServiceMsg.bytes_jump_url.has()) {
          this.jdField_a_of_type_Pxj.jdField_a_of_type_JavaLangString = paramToServiceMsg.bytes_jump_url.get().toStringUtf8();
        }
        if (paramToServiceMsg.uint32_flag.has())
        {
          paramFromServiceMsg = this.jdField_a_of_type_Pxj;
        ...
        if (QLog.isColorLevel()) {
          QLog.d("FreeNetFlowInfoModule", 2, "free netflow, status: " + this.jdField_a_of_type_Pxj.jdField_a_of_type_Int + ", jumpUrl: " + this.jdField_a_of_type_Pxj.jdField_a_of_type_JavaLangString + ", isActive: " + this.jdField_a_of_type_Pxj.jdField_a_of_type_Boolean);
        }
      }
    }
    label223:
  ...
  public String a()
  {
    ...
    if (this.jdField_a_of_type_Pxj != null)
    {
      String str = this.jdField_a_of_type_Pxj.jdField_a_of_type_JavaLangString;
      localObject = str;
      if (QLog.isColorLevel())
      {
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Pxj != null)) {
  ...
  public boolean a()
  {
    return (!this.b) && (this.jdField_a_of_type_Pxj != null) && (this.jdField_a_of_type_Pxj.a());
  }
