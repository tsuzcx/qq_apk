...
{
  adbd(adbc paramadbc, View paramView) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if ((localObject instanceof ImageHolder))
    {
      ...
      paramView = (ActionSheet)ActionSheetHelper.a(this.jdField_a_of_type_Adbc.a.a, null);
      paramView.a("删除文件记录及云端记录");
      paramView.a("删除", 3);
      paramView.d("取消");
      paramView.a(new adbe(this, (FileManagerEntity)localObject, paramView));
      paramView.show();
    }
    label105:
    while (paramView.getId() != 2131375656)
    {
      return;
      localObject = (FileManagerEntity)((QfileRecentFileBaseExpandableListAdapter.RecentItemHolder)localObject).a;
      break;
    }
    ApolloUtil.a(paramView, (FileManagerEntity)localObject, QfileBaseRecentFileTabView.r(this.jdField_a_of_type_Adbc.a));
  }
}
