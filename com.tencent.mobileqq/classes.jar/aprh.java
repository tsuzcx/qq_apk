...
public final class aprh
{
  ...
  public static Bitmap a(String paramString, int paramInt)
  {
    ...
    do
    {
      ...
      localBitmap = bawu.a(BaseApplicationImpl.sApplication.getResources(), 2130843516);
  ...
  public static String a(FileManagerEntity paramFileManagerEntity, String paramString)
  {
    ...
    {
      paramFileManagerEntity = apvb.a(str);
  ...
  public static void a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    {
      bcpw.a(localBaseApplicationImpl, paramInt1, str, paramInt2).b(localBaseApplicationImpl.getResources().getDimensionPixelSize(2131298865));
      return;
    }
  }
  ...
  public static void a(int paramInt, String paramString, boolean paramBoolean)
  {
    ...
    for (int i = 1;; i = 0)
    {
      bcpw.a(localBaseApplicationImpl, paramInt, paramString, i).b(localBaseApplicationImpl.getResources().getDimensionPixelSize(2131298865));
      return;
    }
  }
  ...
  public static boolean a(FileManagerEntity paramFileManagerEntity, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      int i = apue.a(paramFileManagerEntity);
      if (i == 2)
      {
      ...
      else if (i == 4)
      {
        ...
        if ((localAppRuntime instanceof QQAppInterface)) {
          try
          {
            paramFileManagerEntity = bakj.a((QQAppInterface)localAppRuntime, paramFileManagerEntity);
            if (paramFileManagerEntity != null)
            {
