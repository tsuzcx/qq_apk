  ...
  extends aprj
{
  ...
  protected void a()
  {
    ...
    aprn.a("glGetAttribLocation u_threshold");
    this.b = GLES20.glGetUniformLocation(this.d, "u_clipBlack");
    aprn.a("glGetAttribLocation u_clipBlack");
    this.c = GLES20.glGetUniformLocation(this.d, "u_clipWhite");
    aprn.a("glGetAttribLocation u_clipWhite");
  }
  ...
  protected void a(aprm paramaprm)
  {
    ...
    GLES20.glUniform1f(this.a, paramaprm.f);
    GLES20.glUniform1f(this.b, paramaprm.g);
    GLES20.glUniform1f(this.c, paramaprm.h);
  }
}
