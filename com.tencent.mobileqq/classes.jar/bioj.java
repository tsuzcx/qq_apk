...
public class bioj
{
  ...
  public bioj(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
  }
  
  private void a(Activity paramActivity, int paramInt, String paramString, xwj paramxwj)
  {
    if (paramActivity == null) {
      return;
    }
    String str = alpo.a(2131711082);
    if (1 == paramInt) {
      paramString = str + alpo.a(2131711085) + paramString + alpo.a(2131711080);
    }
    for (;;)
    {
      bdcd.a(paramActivity, 230, paramActivity.getString(2131698676), paramString, 2131698670, 2131698670, new bios(this, paramxwj), null).show();
      return;
      if (2 == paramInt) {
        paramString = str + alpo.a(2131711084) + paramString + alpo.a(2131711079);
      } else {
        paramString = alpo.a(2131711081);
      }
    }
  }
  ...
  public static void a(Context paramContext, int paramInt, Bundle paramBundle)
  {
    if (paramContext == null)
    {
      ...
      Toast.makeText(BaseApplication.getContext(), alpo.a(2131711083), 0).show();
      return;
    }
    ...
    if ((paramContext instanceof yxx)) {
  ...
  private void h()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 161	bioj:jdField_a_of_type_JavaUtilTimer	Ljava/util/Timer;
    //   6: astore_1
    //   7: aload_1
    //   8: ifnull +6 -> 14
    //   11: aload_0
    ...
    //   30: putfield 161	bioj:jdField_a_of_type_JavaUtilTimer	Ljava/util/Timer;
    //   33: aload_0
    //   34: getfield 161	bioj:jdField_a_of_type_JavaUtilTimer	Ljava/util/Timer;
    //   37: new 170	cooperation/qlink/QQProxyForQlink$9
    //   40: dup
    //   41: aload_0
    //   42: invokespecial 172	cooperation/qlink/QQProxyForQlink$9:<init>	(Lbioj;)V
    //   45: lconst_0
    //   46: ldc2_w 173
  ...
  private void j()
  {
    ...
    {
      this.jdField_b_of_type_AndroidContentBroadcastReceiver = new biok(this);
  ...
  private void l()
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 223	bioj:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   8: ifnonnull +58 -> 66
    //   11: aload_0
    //   12: new 225	biol
    //   15: dup
    //   16: aload_0
    //   17: invokespecial 226	biol:<init>	(Lbioj;)V
    //   20: putfield 223	bioj:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    ...
    //   37: aload_0
    //   38: getfield 28	bioj:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   41: ifnull +11 -> 52
    //   44: aload_0
    //   45: getfield 28	bioj:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   56: aload_1
    //   57: aload_0
    //   58: getfield 223	bioj:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   61: aload_2
    ...
    //   77: aload_0
    //   78: aconst_null
    //   79: putfield 223	bioj:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   82: goto -16 -> 66
    //   85: astore_1
    //   86: aload_0
    //   87: monitorexit
  ...
  private void m()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 223	bioj:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   6: ifnull +28 -> 34
    //   9: aload_0
    //   10: getfield 28	bioj:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   13: ifnull +13 -> 26
    //   16: aload_0
    //   17: getfield 28	bioj:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   44: aload_0
    //   45: getfield 223	bioj:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    ...
    //   51: aload_0
    //   52: aconst_null
    //   53: putfield 223	bioj:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   56: goto -22 -> 34
    //   59: astore_1
    //   60: aload_0
    //   61: monitorexit
  ...
  public void a(Activity paramActivity, DialogInterface.OnClickListener paramOnClickListener1, DialogInterface.OnClickListener paramOnClickListener2, DialogInterface.OnClickListener paramOnClickListener3, String paramString)
  {
    ...
    {
      return;
      String str2 = bdbt.j(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mPeerUin);
      String str1;
      if (str2 != null)
      {
        str1 = str2;
      ...
      {
        a("0X8004854", 1);
        paramOnClickListener3 = paramActivity.getResources().getString(2131698716) + str1 + paramActivity.getResources().getString(2131698717);
        ...
        {
          this.jdField_a_of_type_Bdfq = bdcd.a(paramActivity, 230, paramActivity.getResources().getString(2131698677), paramOnClickListener3, paramActivity.getResources().getString(2131698718), paramActivity.getResources().getString(2131698718), paramOnClickListener2, null);
          label194:
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_Bdfq.setOnDismissListener(new biop(this));
        return;
        label224:
        str1 = this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mPeerUin;
        break;
        this.jdField_a_of_type_Bdfq = bdcd.a(paramActivity, 230, paramActivity.getResources().getString(2131698677), paramOnClickListener3, paramActivity.getResources().getString(2131698718), paramActivity.getResources().getString(2131698719), paramOnClickListener1, paramOnClickListener2);
        break label194;
        if (this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mMode == 2)
        {
          a("0X8004856", 1);
          paramOnClickListener1 = str1 + paramActivity.getResources().getString(2131698715);
          this.jdField_a_of_type_Bdfq = bdcd.a(paramActivity, 230, paramActivity.getResources().getString(2131698677), paramOnClickListener1, paramActivity.getResources().getString(2131698714), paramActivity.getResources().getString(2131698714), paramOnClickListener3, null);
          this.jdField_a_of_type_Bdfq.show();
        }
  ...
  public void a(Activity paramActivity, ArrayList<String> paramArrayList, int paramInt1, int paramInt2, boolean paramBoolean, String paramString)
  {
    ...
    paramActivity.finish();
    return;
    a(paramActivity, new biom(this, paramArrayList, paramActivity, paramInt1, paramBoolean), new bion(this), new bioo(this), paramString);
  }
  ...
  public void a(QlAndQQInterface.InsertFMFileInfo paramInsertFMFileInfo)
  {
    ...
    String str = arni.a(paramInsertFMFileInfo.filePath);
    long l1 = arni.a(paramInsertFMFileInfo.filePath);
    long l2 = ayvw.a(-1000).uniseq;
    ...
    localFileManagerEntity.nFileType = arni.a(paramInsertFMFileInfo.filePath);
    ...
    if (localaloz.e(String.valueOf(localFileManagerEntity.peerUin)) != null)
    {
      localFileManagerEntity.peerType = 0;
      localFileManagerEntity.peerNick = arni.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInsertFMFileInfo.uin, null, 0);
      localFileManagerEntity.status = 1;
      if ((!localaloz.b(paramInsertFMFileInfo.uin)) && (!paramInsertFMFileInfo.bSend)) {
        break label356;
      }
      localFileManagerEntity.nOpType = 0;
      localFileManagerEntity.bSend = true;
      bauj.a(paramInsertFMFileInfo.filePath, 0L, 0, true);
    ...
    for (;;)
    {
      ...
      bauj.a(paramInsertFMFileInfo.filePath, l1, 0, false, null);
      banc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), str, 0, null);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(localFileManagerEntity);
    }
  }
  ...
  {
    String str = bdbt.i(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString);
    aloz localaloz = (aloz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", paramString, paramString, 0, paramInt, 0, "", "", "", "");
  }
  ...
  public void a(String paramString1, String paramString2, boolean paramBoolean, long paramLong1, long paramLong2, HashMap<String, String> paramHashMap)
  {
    ...
    bipb.a(paramString1, paramString2, paramBoolean, paramLong1, paramLong2, paramHashMap);
  }
  
  public void a(AppActivity paramAppActivity, String paramString, xwj paramxwj)
  {
    if ((paramAppActivity == null) || (paramString == null)) {
      return;
    }
    biow localbiow = biov.a(paramString);
    if (localbiow == null)
    {
      bdcd.a(paramAppActivity, 230, paramAppActivity.getString(2131698676), paramAppActivity.getString(2131698696), 2131698670, 2131698670, new bioq(this, paramxwj), null).show();
      return;
    }
    if (this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mWorking)
    {
      a(paramAppActivity, this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mMode, this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mPeerNick, paramxwj);
      return;
    }
    ...
    paramxwj = new Bundle();
    paramxwj.putString("url", paramString);
    paramxwj.putString("key", localbiow.a);
    paramxwj.putString("peerUin", localbiow.b);
    paramxwj.putString("peerNick", localbiow.c);
    paramxwj.putString("peerOS", localbiow.d);
    paramxwj.putString("apSSID", localbiow.e);
    paramxwj.putString("preSharedKey", localbiow.f);
    paramxwj.putBoolean("fromqlink", bool);
    paramString = paramAppActivity.getIntent().getStringExtra("subfrom");
    if (paramString != null) {
      paramxwj.putString("subfrom", paramString);
    }
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
    a(paramAppActivity, 11, paramxwj);
    paramAppActivity.finish();
  }
  
  public void a(AppActivity paramAppActivity, xwj paramxwj)
  {
    if (paramAppActivity == null) {
      return;
    }
    bdcd.a(paramAppActivity, 230, paramAppActivity.getString(2131698694), paramAppActivity.getString(2131698695), 2131698670, 2131698670, new bior(this, paramxwj), null).show();
  }
  ...
  public boolean a(String paramString, List<String> paramList)
  {
    ...
    while (paramString.hasNext())
    {
      ...
      localSendFileInfo.sessionid = arni.a().longValue();
      localSendFileInfo.filePath = paramList;
      localSendFileInfo.fileSize = arni.a(paramList);
  ...
  {
    if (1 == paramInt) {
      arni.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext());
    }
  }
