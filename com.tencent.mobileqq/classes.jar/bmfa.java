...
public class bmfa
{
  ...
  private bmfq jdField_a_of_type_Bmfq = new bmfc(this);
  private INetInfoHandler jdField_a_of_type_ComTencentMobileqqMsfSdkHandlerINetInfoHandler = new bmfb(this);
  private String jdField_a_of_type_JavaLangString = "#FDFDFD";
  private ArrayList<bmfp> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  private ArrayList<bmfp> jdField_b_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public bmfa(Activity paramActivity)
  {
  ...
  private String a(String paramString)
  {
    ...
    for (paramString = "&";; paramString = "?")
    {
      ...
      bmgm.e("ReaderTabConfigDataHelper", " url=" + (String)localObject);
      return localObject;
    }
  }
  ...
  private void a(ArrayList<bmfp> paramArrayList)
  {
    ...
    while (i < j)
    {
      ...
      this.jdField_c_of_type_ArrayOfJavaLangString[i] = localbmfp.jdField_c_of_type_JavaLangString;
      int k = localbmfp.jdField_a_of_type_Int;
  ...
  private boolean a(ArrayList<bmfp> paramArrayList1, ArrayList<bmfp> paramArrayList2)
  {
    ...
    if (paramArrayList1.size() == paramArrayList2.size())
    {
      ...
      while (i < j)
      {
        if (!((bmfp)paramArrayList1.get(i)).equals(paramArrayList2.get(i))) {
          return false;
        }
        i += 1;
      }
  ...
  private boolean a(JSONObject paramJSONObject, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      localObject1 = new bmfp(((JSONObject)localObject1).optInt("tabID", -1), ((JSONObject)localObject1).optString("tabName"), ((JSONObject)localObject1).optString("n_tabIcon"), ((JSONObject)localObject1).optString("h_tabIcon"), localArrayList, k);
      if (k != 0) {
        break label397;
      }
    ...
    {
      bmgk.d(paramJSONObject, paramBoolean);
  ...
  private void e()
  {
    ...
    for (;;)
    {
      ...
      return;
      bmgm.d("ReaderTabConfigDataHelper", "tab url from local");
      a(4);
      this.jdField_a_of_type_JavaUtilArrayList.clear();
      bmfp localbmfp = new bmfp();
      localbmfp.jdField_a_of_type_Int = 100;
      localbmfp.jdField_a_of_type_JavaLangString = "书城";
      localbmfp.jdField_b_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_ELPT79nUxC.png";
      localbmfp.jdField_c_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_AXwBTwpLm8.png";
      ...
      localbmfp.jdField_a_of_type_JavaUtilArrayList = localArrayList;
      this.jdField_a_of_type_JavaUtilArrayList.add(localbmfp);
      localbmfp = new bmfp();
      localbmfp.jdField_a_of_type_Int = 101;
      localbmfp.jdField_a_of_type_JavaLangString = "分类";
      localbmfp.jdField_b_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_u3wddLskp6.png";
      localbmfp.jdField_c_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_xYKQeprMCg.png";
      localArrayList = new ArrayList(1);
      localArrayList.add(a("https://cdn.vip.qq.com/club/client/read/6/rel/category_index.html?configfrom=local&_bid=2036"));
      localbmfp.jdField_a_of_type_JavaUtilArrayList = localArrayList;
      this.jdField_a_of_type_JavaUtilArrayList.add(localbmfp);
      localbmfp = new bmfp();
      localbmfp.jdField_a_of_type_Int = 102;
      localbmfp.jdField_a_of_type_JavaLangString = "书架";
      localbmfp.jdField_b_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_G6VUELHdgC.png";
      localbmfp.jdField_c_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_f9xtLKYkBV.png";
      localArrayList = new ArrayList(2);
      ...
      this.jdField_a_of_type_JavaUtilArrayList.add(localbmfp);
      localbmfp = new bmfp();
      localbmfp.jdField_a_of_type_Int = 104;
      localbmfp.jdField_a_of_type_JavaLangString = "我的";
      localbmfp.jdField_b_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190604150617_XAeQPgB9Z8.png";
      localbmfp.jdField_c_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_wdBlMCyKuS.png";
      localArrayList = new ArrayList(1);
  ...
  private void f()
  {
    ...
    {
      bmgm.a("ReaderTabConfigDataHelper", "getTabConfigDataFromDB," + localJSONException.getMessage());
    }
  }
  ...
  public String d()
  {
    ...
    return "&height=" + (DisplayUtil.px2dip(this.jdField_a_of_type_AndroidContentContext, i) + 50);
  }
}
