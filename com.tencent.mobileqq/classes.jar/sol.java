  ...
  extends BaseAdapter
{
  ...
  private son jdField_a_of_type_Son;
  ...
  public void a(BaseAdapter paramBaseAdapter)
  {
    ...
    paramBaseAdapter.registerDataSetObserver(new som(this));
  }
  
  public void a(son paramson)
  {
    this.jdField_a_of_type_Son = paramson;
  }
  
  public void a(soo paramsoo)
  {
    this.jdField_a_of_type_Soo = paramsoo;
  }
    ...
    if (localIterator.hasNext())
    {
      ...
      if (i < j)
      {
        ...
        if (this.jdField_a_of_type_Soo != null) {
          this.jdField_a_of_type_Soo.a(paramInt, (View)localObject);
        }
      }
    }
    for (;;)
