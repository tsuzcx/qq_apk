...
public class bezf
{
  ...
  public static ArrayList<bezg> a(long paramLong, DataInputStream paramDataInputStream, int paramInt1, int paramInt2)
  {
                ...
                if (!TextUtils.isEmpty(localObject4))
                {
                  ...
                  if (l != -1L)
                  {
                    ...
                    if (localObject1 == null) {
                      localObject3 = new bezg();
                    }
                    ((bezg)localObject3).jdField_a_of_type_Long = paramLong;
                    ((bezg)localObject3).jdField_a_of_type_Int = paramInt2;
                    ((bezg)localObject3).b = l;
                    ((bezg)localObject3).jdField_a_of_type_JavaLangString = localObject4;
  ...
  public static ArrayList<bezg> a(long paramLong, byte[] paramArrayOfByte, int paramInt)
  {
    ...
    while (i < paramInt)
    {
      ...
      while (j < k)
      {
        bezg localbezg = (bezg)localArrayList2.get(j);
        if (!localHashMap.containsKey(Long.valueOf(localbezg.b)))
        {
          localArrayList1.add(localbezg);
          localHashMap.put(Long.valueOf(localbezg.b), Boolean.valueOf(true));
        }
        j += 1;
      }
      i += 1;
