...
public class oke
{
  ...
  private syz jdField_a_of_type_Syz;
  
  public oke(Activity paramActivity, FrameLayout paramFrameLayout)
  {
    ...
    this.jdField_a_of_type_Syz = syz.a("default_feeds", true);
    ozp.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, "default_feeds");
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext.setTemplateFactory(this.jdField_a_of_type_Syz);
  ...
  private void a()
  {
    try
    {
      String str = (String)bkwm.a("readinjoy_follow_subscribed_list_data_key", "");
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      try
      {
        if (this.jdField_a_of_type_Syz != null)
        {
          localTemplateBean = this.jdField_a_of_type_Syz.getTemplateBean(paramJSONObject);
          ...
          if (this.jdField_a_of_type_OrgJsonJSONObject == null)
          {
            ...
            localContainer.setBackgroundResource(2130841733);
          ...
          ozp.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewContainerContainer, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, localTemplateBean);
          ViewFactory.findClickableViewListener(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewContainerContainer.getVirtualView(), new okf(this, localTemplateBean));
          ozp.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewContainerContainer, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusBeanTemplateBean, localTemplateBean);
          this.jdField_a_of_type_OrgJsonJSONObject = paramJSONObject;
          this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusBeanTemplateBean = localTemplateBean;
          ozp.a(localTemplateBean, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewContainerContainer.getVirtualView(), "expose_T");
