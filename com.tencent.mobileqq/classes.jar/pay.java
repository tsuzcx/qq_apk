...
public class pay
{
  ...
  public pay(int paramInt1, int paramInt2, BaseCommentData paramBaseCommentData, ArticleInfo paramArticleInfo)
  {
  ...
  public pay(int paramInt, BaseCommentData paramBaseCommentData, ArticleInfo paramArticleInfo)
  {
  ...
  private CharSequence a(SubCommentData paramSubCommentData)
  {
    ...
    if (paramSubCommentData.hasTarget())
    {
      ...
      if (!TextUtils.isEmpty(paramSubCommentData.repliedUserNickname))
      {
        ...
        localSpannableStringBuilder.setSpan(new pbb(this, paramSubCommentData), i, localSpannableStringBuilder.length(), 33);
        localSpannableStringBuilder.append("：");
      }
    }
    String str = bbzj.b(paramSubCommentData.commentContent);
  ...
  private String a(int paramInt)
  {
    ...
    default: 
      return "";
    case 1: 
      return anni.a(2131701020);
    }
    return anni.a(2131701022);
  }
  ...
  private void a(SpannableStringBuilder paramSpannableStringBuilder)
  {
    ...
    paramSpannableStringBuilder.setSpan(new pbd(this, BaseActivity.sTopActivity, 2130849341, 2, DpUtil.dip2px(BaseActivity.sTopActivity, 32.0F), DpUtil.dip2px(BaseActivity.sTopActivity, 15.0F)), i, paramSpannableStringBuilder.length(), 17);
  }
  ...
  private void a(SpannableStringBuilder paramSpannableStringBuilder, String paramString1, String paramString2, String paramString3, BaseCommentData paramBaseCommentData)
  {
    ...
    paramSpannableStringBuilder.setSpan(new pbc(this, paramBaseCommentData, paramString2, paramString3), i, paramSpannableStringBuilder.length(), 33);
  }
  ...
  private void b()
  {
    ...
    do
    {
      ...
      if (!TextUtils.isEmpty(localAdvertisementInfo.mAdTxt)) {
        this.jdField_a_of_type_JavaLangCharSequence = new bdnt(bbzj.b(localAdvertisementInfo.mAdTxt), 3, this.d);
      }
      if (this.c != null) {
        this.c.clear();
      }
  ...
  private void b(SpannableStringBuilder paramSpannableStringBuilder)
  {
    int i = paramSpannableStringBuilder.length();
    paramSpannableStringBuilder.append(" ");
    paramSpannableStringBuilder.setSpan(new pbd(this, BaseActivity.sTopActivity, 2130849346, 2, DpUtil.dip2px(BaseActivity.sTopActivity, 51.0F), DpUtil.dip2px(BaseActivity.sTopActivity, 15.0F)), i, paramSpannableStringBuilder.length(), 17);
  }
  ...
  public void a()
  {
    ...
    label269:
    label281:
    for (this.jdField_a_of_type_JavaLangCharSequence = new bdnt(bbzj.b(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData.commentContent), 3, this.d);; this.jdField_a_of_type_JavaLangCharSequence = new bdnt(a((SubCommentData)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData), 3, this.d))
    {
      int j;
      if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData instanceof CommentData))
      {
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(((SubCommentData)localObject1).nickName))
      {
        ...
        ((SpannableStringBuilder)localObject2).setSpan(new paz(this, (SubCommentData)localObject1), 0, ((SpannableStringBuilder)localObject2).length(), 33);
      }
      if ((((SubCommentData)localObject1).hasTarget()) && (!TextUtils.isEmpty(((SubCommentData)localObject1).repliedUserNickname)))
      {
        ...
        ((SpannableStringBuilder)localObject2).setSpan(new pba(this, (SubCommentData)localObject1), k, ((SpannableStringBuilder)localObject2).length(), 33);
      }
      ...
      if (!TextUtils.isEmpty(((SubCommentData)localObject1).commentContent))
      {
        ...
        localObject1 = new bdnt(bbzj.b(((SubCommentData)localObject1).commentContent) + (String)localObject2, 7, this.d);
    ...
    if (!TextUtils.isEmpty(((SubCommentData)localObject1).nickName)) {
      a((SpannableStringBuilder)localObject2, ((SubCommentData)localObject1).nickName, ((SubCommentData)localObject1).uin, new oyn(this).a().a(), (BaseCommentData)localObject1);
    }
    ...
    for (;;)
    {
      ...
      {
        ((SpannableStringBuilder)localObject2).append(" 回复 ");
        a((SpannableStringBuilder)localObject2, ((SubCommentData)localObject1).repliedUserNickname, ((SubCommentData)localObject1).repliedUserUin, new oyn(this).a().b(((SubCommentData)localObject1).repliedUserUin).a(), (BaseCommentData)localObject1);
      }
      if (!TextUtils.isEmpty(((SubCommentData)localObject1).commentContent))
      {
        ((SpannableStringBuilder)localObject2).append(": ");
        String str = a(((SubCommentData)localObject1).getCommentMediaType());
        ((SpannableStringBuilder)localObject2).append(new bdnt(bbzj.b(((SubCommentData)localObject1).commentContent) + str, 7, this.d));
