...
public abstract class bkrh
{
  ...
  private static final Interpolator sDragScrollInterpolator = new bkri();
  private static final Interpolator sDragViewScrollCapInterpolator = new bkrj();
  private static final bkro sUICallback = new bkrq();
  ...
  public static bkro getDefaultUIUtil()
  {
    return sUICallback;
  }
  ...
  private int getMaxDragScroll(RecyclerView paramRecyclerView)
  {
    if (this.mCachedMaxScrollSpeed == -1) {
      this.mCachedMaxScrollSpeed = paramRecyclerView.getResources().getDimensionPixelSize(2131297192);
    }
  ...
  void onDraw(Canvas paramCanvas, RecyclerView paramRecyclerView, RecyclerView.ViewHolder paramViewHolder, List<bkrl> paramList, int paramInt, float paramFloat1, float paramFloat2)
  {
    int j = paramList.size();
    int i = 0;
    while (i < j)
    {
      bkrl localbkrl = (bkrl)paramList.get(i);
      localbkrl.c();
      int k = paramCanvas.save();
      onChildDraw(paramCanvas, paramRecyclerView, localbkrl.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder, localbkrl.e, localbkrl.f, localbkrl.jdField_b_of_type_Int, false);
  ...
  void onDrawOver(Canvas paramCanvas, RecyclerView paramRecyclerView, RecyclerView.ViewHolder paramViewHolder, List<bkrl> paramList, int paramInt, float paramFloat1, float paramFloat2)
  {
    int j = paramList.size();
    int i = 0;
    while (i < j)
    {
      bkrl localbkrl = (bkrl)paramList.get(i);
      int k = paramCanvas.save();
      onChildDrawOver(paramCanvas, paramRecyclerView, localbkrl.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder, localbkrl.e, localbkrl.f, localbkrl.jdField_b_of_type_Int, false);
      paramCanvas.restoreToCount(k);
      i += 1;
    }
    if (paramViewHolder != null)
    ...
    if (i >= 0)
    {
      paramCanvas = (bkrl)paramList.get(i);
  ...
  public void onMoved(RecyclerView paramRecyclerView, RecyclerView.ViewHolder paramViewHolder1, int paramInt1, RecyclerView.ViewHolder paramViewHolder2, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if ((localLayoutManager instanceof bkrn)) {
      ((bkrn)localLayoutManager).a(paramViewHolder1.itemView, paramViewHolder2.itemView, paramInt3, paramInt4);
    }
    do
    {
      do
