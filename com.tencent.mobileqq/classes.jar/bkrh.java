...
public class bkrh
{
  ...
  public static void a(Activity paramActivity, MiniAppInfo paramMiniAppInfo, bkrm parambkrm)
  {
    ...
    do
    {
      ...
      paramActivity = bkrn.a(paramActivity, anvx.a(2131713459), anvx.a(2131713472), anvx.a(2131713474), new bkri(paramActivity), new bkrj());
      paramActivity.a(false);
      paramActivity.show();
    } while (parambkrm == null);
    parambkrm.a(2, anvx.a(2131713453));
    return;
    b(paramActivity, paramMiniAppInfo, parambkrm);
  }
  ...
  {
    paramMiniAppInfo = bheg.b(URLDrawable.getDrawable(URLDecoder.decode(paramMiniAppInfo.iconUrl), null));
    ...
    for (;;)
    {
      return bheg.a(a(paramMiniAppInfo, i, i), (int)(i * 0.15D));
    }
  }
  
  public static void b(Activity paramActivity, MiniAppInfo paramMiniAppInfo, bkrm parambkrm)
  {
    ThreadManagerV2.executeOnSubThread(new ShortcutUtils.3(paramActivity, paramMiniAppInfo, parambkrm));
  }
  ...
  public static int c(@NonNull Context paramContext)
  {
    ...
    localObject = ((ContentResolver)localObject).query(Uri.parse("content://com.bbk.launcher2.settings/favorites"), null, null, null, null);
    if (localObject == null)
    {
    ...
    try
    {
      ...
      {
        String str = ((Cursor)localObject).getString(((Cursor)localObject).getColumnIndexOrThrow("title"));
        QLog.i("Shortcut", 1, "title by query is " + str);
        if ((!TextUtils.isEmpty(str)) && (str.equals(a(paramContext))))
        {
          int i = ((Cursor)localObject).getInt(((Cursor)localObject).getColumnIndexOrThrow("shortcutPermission"));
