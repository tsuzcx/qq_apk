...
{
  protected String a;
  protected List<wbb> a;
  protected AtomicBoolean a;
  protected wba a;
  protected boolean a;
  protected List<wbb> b;
  protected AtomicBoolean b;
  protected List<wbb> c = new ArrayList();
  protected List<wbb> d = new ArrayList();
  
  public waz(List<wbb> paramList)
  {
    ...
    while (localIterator.hasNext()) {
      ((wbb)localIterator.next()).a(this);
    }
    this.jdField_a_of_type_JavaUtilList = new ArrayList(paramList);
  }
  
  public static waz a(ArrayList<String> paramArrayList)
  {
    ...
    for (int i = 0;; i = j)
    {
      ...
      {
        return new waz(localArrayList1);
      }
      ...
      {
        localArrayList2.add(new vwe("", (String)localList.get(i)));
        i += 1;
      }
      localArrayList1.add(new wcg(1, localArrayList2));
    }
  }
  
  public static waz a(@NonNull List<String> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      {
        StoryVideoItem localStoryVideoItem = localvuu.a(str);
    ...
    for (int i = 0;; i = j)
    {
      ...
      {
        return new waz(paramList);
      }
      paramList.add(new wdf(localArrayList.subList(i, j)));
    }
  }
  ...
  public void a()
  {
    try
    {
      ...
      this.jdField_a_of_type_Wba = null;
      return;
    }
    finally
    {
  ...
  /* Error */
  public void a(wbb paramwbb)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 30	waz:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   6: aload_1
    //   7: invokeinterface 170 2 0
    //   12: pop
    //   13: aload_0
    //   14: getfield 32	waz:c	Ljava/util/List;
    //   17: aload_1
    //   18: invokeinterface 116 2 0
    //   23: pop
    //   24: aload_0
    //   25: getfield 43	waz:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   28: astore_1
    //   29: aload_0
    //   30: getfield 30	waz:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   33: invokeinterface 49 1 0
    //   38: ifne +105 -> 143
    //   41: aload_0
    //   42: getfield 34	waz:d	Ljava/util/List;
    ...
    //   60: aload_0
    //   61: getfield 30	waz:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   64: invokeinterface 49 1 0
    //   69: ifne +71 -> 140
    //   72: aload_0
    //   73: getfield 151	waz:jdField_a_of_type_Wba	Lwba;
    //   76: ifnull +19 -> 95
    //   79: aload_0
    //   80: getfield 151	waz:jdField_a_of_type_Wba	Lwba;
    //   83: aload_0
    //   84: getfield 43	waz:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   87: invokevirtual 172	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   90: invokeinterface 176 2 0
    //   95: aload_0
    //   96: getfield 23	waz:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   99: astore_3
    ...
    //   112: astore 4
    //   114: aload_0
    //   115: getfield 43	waz:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   137: invokestatic 184	xvv:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   140: aload_0
    //   141: monitorexit
    //   142: return
    //   143: iconst_0
    ...
    //   155: aload_0
    //   156: getfield 34	waz:d	Ljava/util/List;
  ...
  public void b()
  {
    for (;;)
    {
      try
      {
        ...
        {
          xvv.d(this.jdField_a_of_type_JavaLangString, "Task list is empty , return result now");
          if (this.jdField_a_of_type_Wba == null) {
            continue;
          }
          this.jdField_a_of_type_Wba.a(this.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get());
          continue;
        }
      ...
      while (localIterator.hasNext())
      {
        wbb localwbb = (wbb)localIterator.next();
        this.jdField_b_of_type_JavaUtilList.add(localwbb);
        localwbb.a();
        i += 1;
      }
      this.jdField_a_of_type_JavaUtilList.clear();
      xvv.d(this.jdField_a_of_type_JavaLangString, "Run! Request count = %d", new Object[] { Integer.valueOf(i) });
    }
  }
  
  /* Error */
  public void b(wbb paramwbb)
  {
    // Byte code:
    //   0: iconst_0
    //   1: istore_2
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 41	waz:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   8: invokevirtual 172	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   11: ifeq +8 -> 19
    //   14: aload_1
    //   15: invokevirtual 209	wbb:a	()Z
    //   18: istore_2
    //   19: iload_2
    //   20: ifne +135 -> 155
    //   23: aload_0
    //   24: getfield 30	waz:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   27: aload_1
    //   28: invokeinterface 170 2 0
    //   33: pop
    //   34: aload_0
    //   35: getfield 34	waz:d	Ljava/util/List;
    //   38: aload_1
    //   39: invokeinterface 116 2 0
    //   44: pop
    //   45: aload_0
    //   46: getfield 43	waz:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   49: iconst_0
    //   50: invokevirtual 54	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   53: aload_0
    //   54: getfield 30	waz:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   57: invokeinterface 49 1 0
    //   62: ifne +73 -> 135
    //   65: aload_0
    //   66: getfield 151	waz:jdField_a_of_type_Wba	Lwba;
    //   69: ifnull +19 -> 88
    //   72: aload_0
    //   73: getfield 151	waz:jdField_a_of_type_Wba	Lwba;
    //   76: aload_0
    //   77: getfield 43	waz:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   80: invokevirtual 172	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   83: invokeinterface 176 2 0
    //   88: aload_0
    //   89: getfield 23	waz:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   92: astore 4
    ...
    //   106: astore 5
    //   108: aload_0
    //   109: getfield 43	waz:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   132: invokestatic 184	xvv:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   135: aload_0
    //   136: getfield 23	waz:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   139: ldc 211
    //   141: iconst_1
    ...
    //   152: invokestatic 184	xvv:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   155: aload_0
    //   156: monitorexit
    //   157: return
    ...
    //   165: aload_0
    //   166: getfield 34	waz:d	Ljava/util/List;
