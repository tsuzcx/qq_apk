  ...
  extends bbyo
{
  protected void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, int paramInt)
  {
    ...
    Iterator localIterator = ((Iterable)bcof.a(this.a)).iterator();
    while (localIterator.hasNext()) {
      ((bcog)localIterator.next()).a(paramBoolean1, paramBoolean2, paramBoolean3, paramInt);
    }
  }
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, int paramInt, @Nullable String paramString)
  {
    Iterator localIterator = ((Iterable)bcof.a(this.a)).iterator();
    while (localIterator.hasNext()) {
      ((bcog)localIterator.next()).a(paramBoolean1, paramBoolean2, paramBoolean3, paramInt, paramString);
    }
  }
}
