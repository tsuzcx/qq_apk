  ...
  implements aaea
{
  public void callback(Bundle paramBundle)
  {
    ...
    {
      paramBundle = acir.a(this.jdField_a_of_type_Acir, str1, str2, paramBundle, this.jdField_a_of_type_JavaUtilList);
      if (Looper.myLooper() == Looper.getMainLooper())
      {
        acir.a(this.jdField_a_of_type_Acir, this.jdField_a_of_type_AndroidAppActivity, bool1, paramBundle, this.jdField_a_of_type_Acit, this.jdField_a_of_type_JavaUtilList);
        return;
      }
