...
public class ajrn
{
  ...
  private ajro jdField_a_of_type_Ajro;
  ...
  public ajrn(ajrh paramajrh, float paramFloat1, float paramFloat2, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    this.jdField_a_of_type_Ajrh = paramajrh;
    Object localObject = this.jdField_a_of_type_Ajrh.getContext();
    this.jdField_a_of_type_Float = (bdkf.a() * 0.0375F);
    this.jdField_b_of_type_Float = paramFloat2;
    this.jdField_c_of_type_Float = (this.jdField_a_of_type_Float * 0.5F);
    this.d = paramInt3;
    paramajrh = a(((Context)localObject).getResources(), 2130848591, (int)this.jdField_a_of_type_Float, (int)this.jdField_b_of_type_Float);
    localObject = a(((Context)localObject).getResources(), 2130848593, (int)this.jdField_a_of_type_Float, (int)this.jdField_b_of_type_Float);
    ...
    if (paramajrh != null) {
      localCanvas.drawBitmap(paramajrh, (this.jdField_a_of_type_Float - paramajrh.getWidth()) / 2.0F, (this.jdField_b_of_type_Float - paramajrh.getHeight()) / 2.0F, this.jdField_a_of_type_AndroidGraphicsPaint);
    }
  ...
  public void a(ajro paramajro)
  {
    this.jdField_a_of_type_Ajro = paramajro;
  }
  ...
  public void a(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Ajro.a(this.e, this.f);
      return;
      label148:
      if (this.f - f1 < this.g)
      {
