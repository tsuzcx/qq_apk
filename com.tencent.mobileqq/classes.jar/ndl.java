  ...
  extends ndi
{
  ...
  protected ndl(AppInterface paramAppInterface)
  {
  ...
  {
    return nqf.a(String.format("pkAvatar/avgame_pk_avatar%d@2x.png", new Object[] { Integer.valueOf(new Random().nextInt(50) % 50 + 1) }));
  }
  ...
  private Bitmap a(boolean paramBoolean)
  {
    ...
    for (int i = 2130840349;; i = 2130840348)
    {
      ...
      for (Bitmap localBitmap1 = (Bitmap)BaseApplicationImpl.sImageCache.get(str);; localBitmap1 = null)
      {
        ...
        {
          localBitmap1 = bgyo.b(BaseApplicationImpl.getApplication().getResources(), i);
  ...
  private nmv a()
  {
    ...
    if ((this.mApp instanceof AVGameAppInterface)) {
      localnmv = ((AVGameAppInterface)this.mApp).a();
    }
    return localnmv;
  }
  ...
  private void a(int paramInt, List<String> arg2, HashMap<String, String> paramHashMap)
  {
    ...
    if (localObject != null)
    {
      ...
      ((nmv)localObject).a(paramInt, ???, paramHashMap);
  ...
  public static UserInfo b(String paramString)
  {
    ...
    if (localObject != null)
    {
      localObject = (ndl)((AVGameAppInterface)localObject).a(2);
      if (localObject != null) {
        return ((ndl)localObject).a(paramString);
      }
    }
    return null;
  }
  ...
  public Bitmap b(int paramInt1, String paramString, byte paramByte, int paramInt2)
  {
    Object localObject = a();
    if (localObject == null) {}
    for (localObject = null;; localObject = ((nmv)localObject).a(paramInt1, paramString, paramByte, paramInt2))
    {
      if (localObject != null) {}
      try
      {
  ...
  public UserInfo b(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      ...
      return localObject1;
      localObject1 = ((nmv)localObject2).a(paramInt, paramString);
    }
  }
