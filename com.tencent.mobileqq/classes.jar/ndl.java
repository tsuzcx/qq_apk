...
public class ndl
{
  ...
  private static String a(String paramString1, String paramString2)
  {
    ...
    //   74: invokestatic 103	ndl:a	([B)Ljava/lang/String;
    //   77: areturn
    //   78: astore_0
    //   79: goto -9 -> 70
    //   82: astore_1
  ...
  private static boolean a(String paramString)
  {
    ...
    //   81: astore_3
    //   82: aload_3
    //   83: invokestatic 188	ndl:a	(Ljava/io/BufferedInputStream;)[B
    //   86: astore 4
    //   88: aload_3
    //   89: ifnull +7 -> 96
    //   92: aload_3
    ...
    //   161: iconst_1
    //   162: invokestatic 197	ndl:a	(I)V
    //   165: aload_0
    ...
    //   199: iconst_2
    //   200: invokestatic 197	ndl:a	(I)V
    //   203: aload_0
    ...
    //   224: astore_0
    //   225: aload_0
    //   226: invokestatic 188	ndl:a	(Ljava/io/BufferedInputStream;)[B
    //   229: astore_2
    //   230: aload_0
    //   231: ifnull +7 -> 238
    //   234: aload_0
    //   235: invokevirtual 189	java/io/BufferedInputStream:close	()V
    //   238: getstatic 14	ndl:b	Ljava/lang/String;
    //   241: aload 4
    //   243: aload_2
    //   244: invokestatic 204	ndl:a	(Ljava/lang/String;[B[B)Z
    //   247: istore_1
    //   248: iload_1
    //   249: ireturn
    //   250: astore_0
  ...
  private static boolean b(String paramString)
  {
    ...
    //   61: dup
    //   62: aload_1
    //   63: invokestatic 283	ndl:a	(Ljava/io/BufferedInputStream;)Ljava/lang/String;
    ...
    //   131: invokestatic 306	ndl:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   172: bipush 6
    //   174: invokestatic 197	ndl:a	(I)V
    //   177: iconst_0
    //   178: ireturn
    //   179: astore_0
    //   180: aconst_null
    ...
    //   202: astore_2
    //   203: iconst_1
    //   204: invokestatic 197	ndl:a	(I)V
    //   207: aload_1
    //   208: astore_2
    //   209: aload_0
    ...
    //   249: astore_2
    //   250: iconst_3
    //   251: invokestatic 197	ndl:a	(I)V
    //   254: aload_0
    //   255: astore_2
    //   256: aload_1
    ...
    //   297: astore_2
    //   298: iconst_2
    //   299: invokestatic 197	ndl:a	(I)V
    //   302: aload_0
    //   303: astore_2
    //   304: aload_1
    ...
    //   339: iconst_5
    //   340: invokestatic 197	ndl:a	(I)V
  ...
  private static boolean c(String paramString1, String paramString2)
  {
    ...
    //   140: dup
    //   141: aload 4
    //   143: invokestatic 283	ndl:a	(Ljava/io/BufferedInputStream;)Ljava/lang/String;
    ...
    //   245: astore_0
    //   246: iconst_1
    //   247: invokestatic 197	ndl:a	(I)V
    //   250: aload_0
    ...
    //   256: astore_0
    //   257: iconst_3
    //   258: invokestatic 197	ndl:a	(I)V
    //   261: aload_0
    ...
    //   267: astore_0
    //   268: iconst_2
    //   269: invokestatic 197	ndl:a	(I)V
    //   272: aload_0
    ...
    //   283: iconst_5
    //   284: invokestatic 197	ndl:a	(I)V
    ...
    //   406: invokestatic 306	ndl:a	(Ljava/lang/String;)Ljava/lang/String;
    //   409: astore_1
    //   410: aload_3
    ...
    //   637: invokestatic 306	ndl:a	(Ljava/lang/String;)Ljava/lang/String;
    //   640: astore 7
    //   642: aload 6
    ...
    //   732: iconst_5
    //   733: invokestatic 197	ndl:a	(I)V
    ...
    //   779: iconst_5
    //   780: invokestatic 197	ndl:a	(I)V
  ...
  public static boolean c(String paramString1, String paramString2, String paramString3)
  {
    ...
    //   13: invokestatic 172	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   16: aload_2
    //   17: invokestatic 209	ndl:a	(Ljava/lang/String;)V
    //   20: aload_0
    ...
    //   70: aload 11
    //   72: astore_3
    //   73: getstatic 410	nbv:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   76: ifnull +123 -> 199
    //   79: aload 8
    //   81: astore 5
    //   83: aload 9
    ...
    //   91: aload 11
    //   93: astore_3
    //   94: getstatic 410	nbv:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   97: aload_2
    ...
    //   116: aload 11
    //   118: astore_3
    //   119: getstatic 410	nbv:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   122: aload_2
    ...
    //   247: astore 4
    //   249: aload 4
    //   251: invokestatic 283	ndl:a	(Ljava/io/BufferedInputStream;)Ljava/lang/String;
    //   254: astore_3
    //   255: getstatic 410	nbv:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   258: aload_2
    //   259: aload_3
    ...
    //   312: astore_3
    //   313: iconst_1
    //   314: invokestatic 197	ndl:a	(I)V
    //   317: aload 5
    //   319: astore_3
    //   320: aload_0
    ...
    //   375: astore_3
    //   376: iconst_3
    //   377: invokestatic 197	ndl:a	(I)V
    //   380: aload 6
    //   382: astore_3
    //   383: aload_0
    ...
    //   438: astore_3
    //   439: iconst_2
    //   440: invokestatic 197	ndl:a	(I)V
    //   443: aload 7
    //   445: astore_3
    //   446: aload_0
    ...
    //   526: invokestatic 306	ndl:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   567: bipush 6
    //   569: invokestatic 197	ndl:a	(I)V
    //   572: iconst_0
    //   573: ireturn
    //   574: iconst_1
    //   575: ireturn
