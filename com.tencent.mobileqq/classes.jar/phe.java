  ...
  implements View.OnClickListener
{
  ...
  public View getView(int paramInt, @Nullable View paramView, @NotNull ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = LayoutInflater.from(this.a.getContext()).inflate(2131560149, paramViewGroup, false);
      Intrinsics.checkExpressionValueIsNotNull(localView, "contentView");
      localObject = new phf(this, localView);
      ((phf)localObject).a().setOnClickListener((View.OnClickListener)this);
      localView.setTag(localObject);
      BaseCommentData.CommentLinkData localCommentLinkData = a(paramInt);
      ((phf)localObject).a().setTag(localCommentLinkData);
      ((phf)localObject).a().setText((CharSequence)localCommentLinkData.wording);
      ...
      default: 
        i = 2130842857;
        label168:
        ((phf)localObject).a().setImageResource(i);
      }
    }
    for (;;)
    {
      ...
      break label168;
      label256:
      ((phf)localObject).a().setImageSrc(str);
    }
  }
