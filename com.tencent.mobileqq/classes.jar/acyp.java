...
public class acyp
{
  private static volatile acyp jdField_a_of_type_Acyp;
  public static final String a;
  public static final String b = jdField_a_of_type_JavaLangString + "eggs.xml";
  private ArrayList<acyr> jdField_a_of_type_JavaUtilArrayList;
  ...
  {
    if (jdField_a_of_type_Acyp == null) {}
    try
    {
      if (jdField_a_of_type_Acyp == null) {
        jdField_a_of_type_Acyp = new acyp();
      }
      return jdField_a_of_type_Acyp;
    }
    finally {}
  }
  
  private ArrayList<acyr> a(XmlPullParser paramXmlPullParser)
  {
    ...
    if (i != 1) {
      if (i == 2)
      {
        ...
        if (str1.equalsIgnoreCase("Item"))
        {
          ...
          localObject2 = new acyr();
          ((acyr)localObject2).jdField_a_of_type_Int = Integer.valueOf((String)localObject3).intValue();
    ...
    for (;;)
    {
      ...
      localObject2 = new acyt();
      if (str1 != null) {
        ((acyt)localObject2).jdField_b_of_type_Int = acyt.a(str1);
      }
      ((acyt)localObject2).jdField_a_of_type_JavaLangString = str2;
      if (localObject4 != null)
      {
      ...
      localObject4.jdField_a_of_type_Acys = new acys();
      ...
      localObject4.jdField_a_of_type_Acys.jdField_a_of_type_Int = Integer.parseInt((String)localObject2);
      localObject4.jdField_a_of_type_Acys.jdField_b_of_type_Int = Integer.parseInt((String)localObject3);
      localObject4.jdField_a_of_type_Acys.c = Integer.parseInt(str1);
      localObject4.jdField_a_of_type_Acys.e = Integer.parseInt(str3);
      localObject4.jdField_a_of_type_Acys.d = Integer.parseInt(str2);
      localObject2 = localObject4;
      localObject3 = localObject1;
      break;
      localObject2 = localObject4;
  ...
  private boolean a(String paramString)
  {
    ...
    //   163: aload_0
    //   164: aload_2
    //   165: invokespecial 277	acyp:a	(Lorg/xmlpull/v1/XmlPullParser;)Ljava/util/ArrayList;
    //   168: astore_2
    //   169: aload_1
    //   170: ifnull +7 -> 177
    //   173: aload_1
    ...
    //   181: aload_0
    //   182: aload_2
    //   183: putfield 281	acyp:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   186: iconst_1
    //   187: ireturn
    //   188: astore_2
    //   189: aload_3
