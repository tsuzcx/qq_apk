...
public class avlf
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = avln.jdField_a_of_type_JavaLangString + "GameMsgUtil";
  ...
  public static Intent a(Context paramContext, QQMessageFacade.Message paramMessage, QQAppInterface paramQQAppInterface)
  {
    ...
    try
    {
      ...
      localObject = (avld)paramQQAppInterface.getManager(358);
      paramContext = ((avld)localObject).a(str3);
      if (paramContext == null) {
        break label401;
      }
      paramContext = ((avld)localObject).a(paramContext.c);
    ...
    paramContext = ((avld)localObject).b();
    if (i == 0)
    {
      localObject = ((avld)localObject).a(str1);
      if (localObject != null)
      {
  ...
  public static Bitmap a(QQMessageFacade.Message paramMessage, QQAppInterface paramQQAppInterface)
  {
    ...
    paramMessage = avlg.b(paramMessage);
    Object localObject;
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      paramQQAppInterface = ((avld)paramQQAppInterface.getManager(358)).a(paramMessage);
      if (paramQQAppInterface != null) {
        break;
      }
    ...
    paramMessage = beqz.a(paramQQAppInterface.mFaceUrl);
    ...
    for (;;)
    {
      ...
      return paramMessage;
      paramMessage = BaseApplicationImpl.getApplication().getResources().getDrawable(2130840347);
      ...
      catch (MalformedURLException paramQQAppInterface)
      {
        for (;;)
        {
          try
          {
            paramMessage.setTag(bhez.b(100, 100, 6));
            paramMessage.setDecodeHandler(bhez.a);
  ...
  public static URLDrawable a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    paramQQAppInterface = ((avld)paramQQAppInterface.getManager(358)).a(paramString);
    if (paramQQAppInterface == null)
    {
    ...
    localURLDrawableOptions.mRequestWidth = agej.a(60.0F, paramContext.getResources());
    localURLDrawableOptions.mRequestHeight = agej.a(60.0F, paramContext.getResources());
    try
    {
      paramContext = URLDrawable.getDrawable(new URL(paramQQAppInterface.mFaceUrl), localURLDrawableOptions);
      try
      {
        paramContext.setTag(bhez.b(100, 100, 6));
        paramContext.setDecodeHandler(bhez.a);
        return paramContext;
      }
      catch (MalformedURLException paramQQAppInterface) {}
    }
  ...
  public static CharSequence a(QQAppInterface paramQQAppInterface, RecentBaseData paramRecentBaseData, CharSequence paramCharSequence)
  {
    ...
    try
    {
      paramQQAppInterface = a(paramQQAppInterface, paramQQAppInterface.a().a(paramRecentBaseData.getRecentUserUin(), paramRecentBaseData.getRecentUserType()), paramCharSequence);
  ...
  {
    paramCharSequence = BaseApplicationImpl.getContext().getString(2131692547) + paramCharSequence;
    if (paramQQAppInterface == null) {
      return paramCharSequence;
    }
    paramMessageRecord = avlg.a(paramMessageRecord);
    if (TextUtils.isEmpty(paramMessageRecord)) {
      return paramCharSequence;
    }
    paramQQAppInterface = (avld)paramQQAppInterface.getManager(358);
    ...
    return BaseApplicationImpl.getContext().getString(2131692548) + paramMessageRecord.i;
  }
  ...
  public static String a(MessageRecord paramMessageRecord, QQAppInterface paramQQAppInterface)
  {
    ...
    {
      String str = avlg.b(paramMessageRecord);
      paramQQAppInterface = ((avld)paramQQAppInterface.getManager(358)).a(str);
    ...
    return BaseApplicationImpl.getApplication().getResources().getString(2131692544);
  }
  ...
  public static String a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    {
      localObject = ((avld)paramQQAppInterface.getManager(358)).a(((ConversationInfo)localObject).tinyInfo.fromRoleId);
  ...
  public static void a(Context paramContext, avlc paramavlc)
  {
    ...
    QLog.i(jdField_a_of_type_JavaLangString, 1, "appId:" + paramavlc.c);
    String str2 = paramavlc.l;
    String str1 = str2;
    if (TextUtils.isEmpty(str2)) {
      str1 = GameBasicInfo.getDefaultGameLaunchUrl(paramavlc.c);
    }
    paramavlc = new Intent(paramContext, QQBrowserActivity.class);
    paramavlc.putExtra("url", str1);
    paramContext.startActivity(paramavlc);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString)
  {
    ...
    try
    {
      ...
      if (localObject != null)
      {
        ...
        GameCenterSessionInfo localGameCenterSessionInfo = ((avld)paramQQAppInterface.getManager(358)).a(paramString);
  ...
  public static void a(QQAppInterface paramQQAppInterface, QQMessageFacade.Message paramMessage, MsgSummary paramMsgSummary, RecentItemPublicAccountChatMsgData paramRecentItemPublicAccountChatMsgData)
  {
    ...
    avld localavld = (avld)paramQQAppInterface.getManager(358);
    if (!localavld.c()) {}
          ...
          do
          {
            do
            {
              do
              {
                ...
                paramMessage = (RecentUser)paramQQAppInterface.findRecentUserByUin("2747277822", 1008);
              } while (paramMessage == null);
              paramQQAppInterface.delRecentUser(paramMessage);
              localavld.a(0);
              return;
              paramMessage = paramQQAppInterface.a();
              localRecentUser = (RecentUser)paramMessage.findRecentUserByUin("2747277822", 1008);
              paramRecentItemPublicAccountChatMsgData.mUnreadNum += localavld.c();
            ...
            return;
            localGameCenterSessionInfo = localavld.a();
          } while ((localGameCenterSessionInfo == null) || ((a((MessageRecord)localObject)) && ((((MessageRecord)localObject).time > localGameCenterSessionInfo.a()) || ((localavld.c() == 0) && (localGameCenterSessionInfo.a() == 1)))));
          if (QLog.isColorLevel()) {
    ...
    {
      paramMsgSummary.strContent = new begp("[" + localGameCenterSessionInfo.b() + "位好友请求] 来自" + localGameCenterSessionInfo.f(), 3, 16, -1);
    ...
    for (int i = 0;; i = 1)
    {
      ...
      paramMsgSummary.strContent = new begp(paramQQAppInterface + " " + (String)localObject + ": " + localGameCenterSessionInfo.i(), 3, 16, -1);
      localRecentUser.lastmsgtime = localGameCenterSessionInfo.a();
      paramRecentItemPublicAccountChatMsgData.mDisplayTime = localGameCenterSessionInfo.a();
      break label510;
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2)
  {
    ...
    bdll.b(null, "dc00898", "", "", str, str, paramInt2, 0, String.valueOf(new TinyInfo(paramString, paramQQAppInterface.isSend()).gameAppId), "", "", "");
  }
  ...
  public static void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, String paramString9, String paramString10, String paramString11, String paramString12, String paramString13)
  {
    ...
    try
    {
      ...
      localJSONObject3.put("sq_ver", "8.4.5");
      ...
      localJSONObject3.put("ext6", paramString11);
      ...
      {
        bnyy.a().a(localAppRuntime, "dc_qqgame", localJSONObject1.toString());
        return;
      }
      bdkl.a(null, "dc_qqgame", localJSONObject1.toString());
      return;
    }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    int i = paramQQAppInterface.getApp().getSharedPreferences("public_account_detail_setting_status", 0).getInt("setting_status_2747277822_" + paramQQAppInterface.getCurrentAccountUin(), -1);
    AccountDetail localAccountDetail = ((aody)paramQQAppInterface.getManager(56)).a("2747277822");
    boolean bool;
    if (localAccountDetail == null)
    {
      tzq.a(paramQQAppInterface, paramQQAppInterface.getApplication(), "2747277822");
      bool = false;
    }
    for (;;)
    {
      if (QLog.isColorLevel())
      {
        ...
        QLog.d(jdField_a_of_type_JavaLangString, 2, "[isPubAccountReceiveMsg] state:" + i + ",detail:" + paramQQAppInterface + "ret:" + bool);
      }
      return bool;
      if ((localAccountDetail.followType == 1) && (i == 0)) {
        bool = true;
      } else {
        bool = false;
      }
