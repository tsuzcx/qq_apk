...
{
  public akcm(TroopGiftAnimationController paramTroopGiftAnimationController) {}
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    do
    {
      ...
      str1 = TroopGiftAnimationController.a(this.a).getResources().getString(2131430756);
    ...
    for (paramString = "0";; paramString = "1")
    {
      ...
      break label546;
      label497:
      paramString = TroopGiftAnimationController.a(this.a).getResources().getString(2131430757);
      break label299;
