...
public class aoqk
  extends aoqf
{
  public aoqk(QQAppInterface paramQQAppInterface, FriendListHandler paramFriendListHandler)
  {
  ...
  private void a(ToServiceMsg paramToServiceMsg, MovGroupMemResp paramMovGroupMemResp)
  {
    ...
    {
      ((anyw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).a(str, b1);
    ...
    for (;;)
    {
      ...
      case 0: 
        ...
        if (bool)
        {
          ...
          localObject1 = localanyw.a(((AddGroupResp)localObject2).cGroupId + "");
      ...
      case 1: 
        ...
        if (bool)
        {
          ...
          paramToServiceMsg = localanyw.a(String.valueOf(i));
      ...
      case 3: 
        ...
        if (bool)
        {
          ...
          localanyw.a(paramToServiceMsg.extraData.getByteArray("group_id_list"), paramToServiceMsg.extraData.getByteArray("sort_id_list"));
        }
