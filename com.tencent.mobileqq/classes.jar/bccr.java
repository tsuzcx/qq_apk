...
public class bccr
  ...
  implements biec
{
  public bccr(Context paramContext, Activity paramActivity, AppInterface paramAppInterface, TouchWebView paramTouchWebView)
  {
  ...
  public void buildWebView(AppInterface paramAppInterface)
  {
    ...
    this.mWebview.setWebViewClient(new bccs(this, this.mWebview.getPluginEngine()));
  }
