...
public class acik
{
  public static int a(Context paramContext, AdAppBtnData paramAdAppBtnData)
  {
    ...
    do
    {
      ...
      paramContext = bjjq.a().b(paramAdAppBtnData);
  ...
  public static int a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      {
        return -1;
        paramContext = bjjq.a().b(paramString2);
  ...
  {
    aodv.a("scheme", paramString1, paramString2, "4", "gdtAppAd", paramContext.getClass().getName());
  }
  ...
  public static void a(Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        Object localObject5 = bjht.a(str);
        localObject4 = (String)((HashMap)localObject5).get("appid");
        localObject1 = localObject4;
        localObject3 = str;
        if (TextUtils.isEmpty((CharSequence)localObject4))
        {
          localObject1 = (String)((HashMap)localObject5).get(bjmy.b);
          localObject3 = str;
        }
        str = bjht.g() + File.separator + "qapp_center_detail.htm";
        ...
        if ("1".equals((String)bjht.a(paramBundle.getString("schemaUrl")).get("auto_download")))
        {
          localObject3 = localObject1;
  ...
  public static boolean a(Context paramContext, String paramString)
  {
    ...
    {
      localTMAssistantDownloadTaskInfo2 = bjjq.a().a(localDownloadInfo.d);
      ...
      {
        localTMAssistantDownloadTaskInfo1 = bjjq.a().a(localDownloadInfo);
        localObject = paramContext;
      }
    }
    for (;;)
    {
      ...
      localObject = paramContext;
      break;
      localTMAssistantDownloadTaskInfo2 = bjjq.a().a(localDownloadInfo);
      paramContext = (Context)localObject;
      if (localTMAssistantDownloadTaskInfo2 != null)
      {
        paramContext = (Context)localObject;
      ...
      if (TextUtils.isEmpty(paramContext))
      {
        localTMAssistantDownloadTaskInfo1 = bjjq.a().a(localDownloadInfo.d);
        localObject = paramContext;
      }
    }
  }
  ...
  public static boolean b(Context paramContext, GdtBaseAdItem paramGdtBaseAdItem)
  {
    ...
    try
    {
      ...
      bool2 = true;
      bool1 = bool3;
      acie.a(138, paramGdtBaseAdItem.d, paramGdtBaseAdItem.e);
      bool1 = bool3;
      a(paramContext, paramGdtBaseAdItem.b, paramGdtBaseAdItem.jdField_a_of_type_JavaLangString);
      bool1 = bool3;
      acho.a("GdtAppOpenUtil", "launchAPPMain report " + paramGdtBaseAdItem.toString());
      bool1 = bool2;
      return bool1;
    }
    catch (Exception paramContext)
    {
      acho.d("GdtAppOpenUtil", "launchApp failed", paramContext);
    }
    return bool1;
  }
  ...
  private static boolean c(Context paramContext, GdtBaseAdItem paramGdtBaseAdItem)
  {
    ...
    if (a(paramContext, paramGdtBaseAdItem.jdField_a_of_type_JavaLangString, paramGdtBaseAdItem.c))
    {
      ...
      try
      {
        ...
        bool2 = true;
        bool1 = bool3;
        acie.a(137, paramGdtBaseAdItem.d, paramGdtBaseAdItem.e);
        bool1 = bool3;
        a(paramContext, paramGdtBaseAdItem.b, paramGdtBaseAdItem.jdField_a_of_type_JavaLangString);
        bool1 = bool3;
        acho.a("GdtAppOpenUtil", "launchAPPDeepLink report " + paramGdtBaseAdItem.toString());
        bool1 = bool2;
        return bool1;
      }
      catch (Exception paramContext)
      {
        acho.d("GdtAppOpenUtil", "launchAPPDeepLink failed", paramContext);
        return bool1;
      }
    }
    acho.a("GdtAppOpenUtil", "launchAPPDeepLink isDLURISupported false");
    return false;
  }
}
