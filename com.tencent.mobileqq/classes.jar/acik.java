...
public class acik
{
  ...
  public static long a()
  {
    ...
    bkad.c("GameCenterUtils", "getResAvilTime ts" + l);
    return l;
  }
  ...
  public static long a(String paramString)
  {
    ...
    {
      bkad.b("GameCenterUtils", "readFromSpLong exception", paramString);
    }
  }
  ...
  {
    String str = bigv.a("com.tencent.gamecenter.wadl/dlapks");
    if (QLog.isColorLevel()) {
  ...
  public static String a(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      paramString = bigv.a("com.tencent.gamecenter.wadl/" + (String)localObject + "/" + paramString);
      if (QLog.isColorLevel()) {
  ...
  public static void a()
  {
    ...
    //   74: new 278	anwm
    //   77: dup
    //   78: invokespecial 279	anwm:<init>	()V
    //   81: invokestatic 282	com/tencent/mobileqq/app/DeviceProfileManager:a	(Ljava/lang/String;[Ljava/lang/Object;Lanwl;)I
    //   84: istore_0
    //   85: aload 4
    //   87: iconst_0
    //   88: aaload
    ...
    //   97: istore_1
    //   98: iload_1
    //   99: putstatic 17	acik:jdField_a_of_type_Boolean	Z
    //   102: aload 4
    //   104: iconst_1
    //   105: aaload
    ...
    //   204: getstatic 17	acik:jdField_a_of_type_Boolean	Z
  ...
  public static void a(AppInterface paramAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, Map<Integer, String> paramMap)
  {
    ...
    label302:
    Object localObject1 = nnr.a();
    paramString1 = Arrays.asList(new String[] { NetConnInfoCenter.getServerTime() + "", "1", "8.4.5", "1.0", "2", Build.BRAND, localObject1, jdField_a_of_type_JavaLangString, "0", "0", "1", paramString1, paramString2, "0", paramString3, paramString4, "", "", "", "", "", "", "", "", "", paramString5, paramString6, "", Build.MODEL, Build.VERSION.RELEASE, "1", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "" });
    ...
    {
      bmbt.a(paramAppInterface, "dc00087", paramString1);
      return;
    }
  }
  ...
  public static void a(AppInterface paramAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      {
        String str = nnr.a();
        paramString1 = Arrays.asList(new String[] { String.valueOf(NetConnInfoCenter.getServerTime()), "1", "8.4.5", "1.0", "2", Build.BRAND, str, jdField_a_of_type_JavaLangString, "0", "0", "1", paramString1, paramString2, "0", paramString3, paramString4, "", "", "", "", "", "", "", "", "", paramString5, paramString6, "", Build.MODEL, Build.VERSION.RELEASE, "1", acil.b(), String.valueOf(bhlo.b()[1]), "", "", "", "", "", "", "", "", "", "", "", "", "" });
    ...
    for (;;)
    {
      try
      {
        ...
        if (localObject != null)
        {
          ...
          bkad.c("GameCenterUtils", "writeToSpLong " + paramString + " :" + paramLong);
      ...
      {
        bkad.b("GameCenterUtils", "writeToSpLong exception", paramString);
        return;
      }
      Object localObject = "";
    }
  ...
  {
    bkad.c("GameCenterUtils", "startDownload delay task pParamsJson=" + paramString + ",autoInstallBySdk=" + paramBoolean + ",from=" + paramInt + ",isWifi=" + AppNetConnInfo.isWifiConn());
    try
    {
    ...
    {
      bkad.a("GameCenterUtils", "startDownload exception", paramString);
    }
  }
  ...
  public static void a(Map<Integer, String> paramMap, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        if ((TextUtils.isEmpty(paramString)) || (avmd.a == null)) {
          break;
        }
        ...
        localObject = (String)avmd.a.get(paramString + "_orted_configs");
  ...
  public static boolean a(int paramInt, String paramString1, String paramString2)
  {
    ...
    return auog.a(paramString1 + "/" + paramString2);
  }
  ...
  public static boolean a(long paramLong)
  {
    ...
    bkad.c("GameCenterUtils", "saveResAvilTime: ts=" + paramLong + ",flag:" + bool);
    return bool;
  }
  ...
  {
    int i = a(paramString);
    bkad.c("GameCenterUtils", "checkVersion packageName=" + paramString + ",versionCode=" + paramInt + ",localVersion=" + i);
  ...
  {
    int i = a(paramString);
    bkad.c("GameCenterUtils", "checkVersion packageName=" + paramString + ",updateVersion=" + paramInt1 + ",qgameMinVersion=" + paramInt2 + ",localVersion=" + i);
  ...
  public static boolean a(String paramString1, String paramString2)
  {
    ...
    for (localObject = ((AppRuntime)localObject).getAccount();; localObject = "")
    {
      ...
      bkad.c("GameCenterUtils", "writeToSp " + paramString1 + " :" + paramString2);
  ...
  public static boolean a(String paramString1, String paramString2, String paramString3)
  {
    ...
    bkad.c("GameCenterUtils", "yuyue:saveAppDetail,appid:" + paramString1 + ",detail:" + paramString2 + ",keyPre:" + paramString3);
  ...
  public static boolean a(String paramString, boolean paramBoolean)
  {
    ...
    for (localObject = ((AppRuntime)localObject).getAccount();; localObject = "")
    {
      ...
      bkad.c("GameCenterUtils", "writeToSp " + paramString + " :" + paramBoolean);
      return ((SharedPreferences.Editor)localObject).commit();
    }
  }
  ...
  public static boolean c(String paramString1, String paramString2)
  {
    ...
    bkad.c("GameCenterUtils", "yuyue:addAppidToList,appid:" + paramString1 + ",key:" + paramString2);
  ...
  public static String d(String paramString)
  {
    ...
    //   22: invokestatic 149	bkad:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   25: aload_0
    ...
    //   54: ifeq +316 -> 370
    //   57: aload_0
    //   58: invokevirtual 733	java/io/File:length	()J
    //   61: lconst_0
    //   62: lcmp
    //   63: ifle +307 -> 370
    //   66: aload_0
    //   67: invokevirtual 733	java/io/File:length	()J
    //   70: lstore_1
    //   71: new 735	java/io/BufferedInputStream
    //   74: dup
    //   75: new 737	java/io/FileInputStream
    //   78: dup
    //   79: aload_0
    //   80: invokespecial 740	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   83: invokespecial 743	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   86: astore_0
    //   87: aload 4
    //   89: astore_3
    //   90: aload_0
    ...
    //   92: ldc2_w 744
    //   95: lsub
    //   96: invokevirtual 749	java/io/BufferedInputStream:skip	(J)J
    //   99: pop2
    //   100: aload 4
    //   102: astore_3
    //   103: bipush 50
    ...
    //   115: iconst_0
    //   116: bipush 50
    //   118: invokevirtual 753	java/io/BufferedInputStream:read	([BII)I
    //   121: pop
    //   122: aload 4
    //   124: astore_3
    ...
    //   128: dup
    //   129: aload 5
    //   131: invokespecial 756	java/lang/String:<init>	([B)V
    //   134: astore 6
    //   136: aload 4
    //   138: astore_3
    //   139: ldc 89
    ...
    //   154: aload 5
    //   156: invokestatic 763	bleb:b	([B)Ljava/lang/String;
    ...
    //   165: invokestatic 149	bkad:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   168: aload 4
    //   170: astore_3
    //   171: aload 6
    ...
    //   182: aload 6
    //   184: ldc_w 765
    //   187: invokevirtual 768	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   190: ifeq +174 -> 364
    //   193: aload 4
    //   195: astore_3
    //   196: aload 6
    //   198: aload 6
    //   200: ldc_w 765
    //   203: invokevirtual 771	java/lang/String:indexOf	(Ljava/lang/String;)I
    //   206: bipush 10
    //   208: iadd
    //   209: invokevirtual 775	java/lang/String:substring	(I)Ljava/lang/String;
    //   212: astore 4
    //   214: aload 4
    //   216: astore_3
    //   217: aload 4
    ...
    //   270: invokestatic 149	bkad:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   273: aload_0
    //   274: invokestatic 785	com/tencent/mobileqq/pluginsdk/IOUtil:closeStream	(Ljava/io/Closeable;)V
    //   277: aload_3
    //   278: areturn
    //   279: ldc 33
    //   281: astore_3
    ...
    //   318: invokestatic 789	bkad:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   321: aload_0
    //   322: invokestatic 785	com/tencent/mobileqq/pluginsdk/IOUtil:closeStream	(Ljava/io/Closeable;)V
    //   325: aload_3
    //   326: areturn
    //   327: astore_0
    //   328: aload_3
    //   329: invokestatic 785	com/tencent/mobileqq/pluginsdk/IOUtil:closeStream	(Ljava/io/Closeable;)V
    //   332: aload_0
    //   333: athrow
    //   334: astore 4
    //   336: aload_0
