...
{
  private static final String jdField_a_of_type_JavaLangString = ajya.a(2131701151);
  ...
  public adnh(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo);
  }
  
  private View a(View paramView, adni paramadni)
  {
    View localView = paramView;
    if (paramView == null)
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558729, null);
      paramadni.jdField_b_of_type_AndroidViewView = paramView;
      paramadni.jdField_c_of_type_AndroidViewView = paramView.findViewById(2131362233);
      paramadni.d = paramView.findViewById(2131362232);
      paramadni.a = ((URLImageView)paramView.findViewById(2131362235));
      paramadni.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362236));
      paramadni.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362234));
      localView = paramView;
      if (e)
      {
        paramadni.jdField_b_of_type_JavaLangStringBuilder = new StringBuilder();
        localView = paramView;
      }
    }
    if (e)
    {
      ...
      paramadni.jdField_b_of_type_JavaLangStringBuilder.replace(0, paramadni.jdField_b_of_type_JavaLangStringBuilder.length(), "");
    }
    return localView;
  }
  ...
  {
    long l1;
    if ((paramMessageRecord != null) && (!bbbt.a().a(paramMessageRecord, "aio_msg|birthday_notice")))
    {
      bbbt.a().a(paramMessageRecord, "aio_msg|birthday_notice");
      l1 = 0L;
    }
    try
    {
  ...
  protected View a(MessageRecord paramMessageRecord, actn paramactn, View paramView, LinearLayout paramLinearLayout, acxj paramacxj)
  {
    ...
    paramactn = (adni)paramactn;
    paramView = a(paramView, paramactn);
    try
    {
      paramactn.a.setBackgroundURL(paramMessageRecord.icon);
      paramactn.d.setBackgroundColor(Color.parseColor(paramMessageRecord.background));
      paramactn.jdField_b_of_type_AndroidWidgetTextView.setText(paramMessageRecord.birthday);
      ...
      if (i >= 0)
      {
        ...
        paramactn.jdField_c_of_type_AndroidWidgetTextView.setText(paramLinearLayout);
        paramactn.jdField_c_of_type_AndroidViewView.setTag(paramMessageRecord);
        paramactn.jdField_c_of_type_AndroidViewView.setOnClickListener(this);
        a(paramMessageRecord);
        if (e)
        {
          paramactn.jdField_b_of_type_JavaLangStringBuilder.append("生日");
          paramactn.jdField_b_of_type_JavaLangStringBuilder.append(paramMessageRecord.birthday);
          paramactn.jdField_b_of_type_JavaLangStringBuilder.append(paramMessageRecord.blessing);
          paramactn.jdField_b_of_type_AndroidViewView.setContentDescription(paramactn.jdField_b_of_type_JavaLangStringBuilder.toString());
        }
        return paramView;
      }
    }
    catch (Exception paramLinearLayout)
    {
      for (;;)
      {
        ...
        continue;
        paramactn.jdField_c_of_type_AndroidWidgetTextView.setText(paramMessageRecord.blessing);
      }
    }
  }
