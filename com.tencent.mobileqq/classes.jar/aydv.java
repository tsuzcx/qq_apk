...
public class aydv
  extends ayeh
{
  private aydv(SignatureHistoryFragment paramSignatureHistoryFragment) {}
  ...
  protected void a(boolean paramBoolean, List<byte[]> paramList, List<Integer> paramList1)
  {
    ...
    SignatureHistoryFragment.a(this.a).setText(2131720190);
    SignatureHistoryFragment.b(this.a, false);
