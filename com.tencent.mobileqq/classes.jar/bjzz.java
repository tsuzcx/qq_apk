  ...
  extends annv
{
  ...
  public bjzz(QQAppInterface paramQQAppInterface, View paramView)
  {
    super(paramView);
  ...
  public void a()
  {
    try
    {
      ...
      j = aekt.a(375.0F, this.jdField_a_of_type_AndroidViewView.getResources());
      a(i - j - 0, 0, j, aekt.a(30.0F, this.jdField_a_of_type_AndroidViewView.getResources()), this.jdField_a_of_type_AndroidViewView);
      return;
    }
  ...
  public void a(TianShuAccess.AdItem paramAdItem)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localObject2 = baul.jdField_a_of_type_AndroidGraphicsDrawableDrawable;
        this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = bdpt.a(paramAdItem, new int[] { 2 }, (Drawable)localObject2, (Bundle)localObject1, null);
