...
public class axek
{
  ...
  private static String a(android.graphics.Bitmap paramBitmap)
  {
    ...
    //   6: dup
    //   7: getstatic 30	anhk:cj	Ljava/lang/String;
    //   10: invokestatic 35	bhgg:a	(Ljava/lang/String;)Ljava/lang/String;
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, bdzm parambdzm)
  {
    parambdzm.addFilter(new Class[] { bdwp.class });
    paramQQAppInterface.a().a(parambdzm);
  ...
  {
    new bcsy(null).a("dc00899").b("grp_lbs").c(paramString1).d(paramString2).a(paramInt1).b(paramInt2).a(paramVarArgs).a();
  }
  ...
  public static boolean a(Activity paramActivity, QQAppInterface paramQQAppInterface)
  {
    ...
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, afur.a(150.0F, paramActivity.getResources()));
    new aybg(paramActivity).a(localImageView, localLayoutParams).b(anni.a(2131706177)).a(new ayba(anni.a(2131706179), new axel(paramActivity, paramQQAppInterface))).show();
