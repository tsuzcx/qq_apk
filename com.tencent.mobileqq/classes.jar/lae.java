...
class lae
  extends kzj
{
  lae(lac paramlac, List paramList, lao paramlao, Long paramLong) {}
  ...
  public void a(int paramInt, Header[] paramArrayOfHeader, String paramString)
  {
    ...
    try
    {
      localObject = this.jdField_a_of_type_Lac.a.parse(new InputSource(new StringReader(paramString)));
    ...
    catch (IOException localIOException)
    {
      ...
      this.jdField_a_of_type_Lao.a(localIOException, paramString, this.jdField_a_of_type_JavaLangLong);
    }
