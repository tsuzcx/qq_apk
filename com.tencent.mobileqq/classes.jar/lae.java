...
public class lae
{
  ...
  public lae(Context paramContext, int paramInt, long paramLong)
  {
  ...
  private File a(Context paramContext)
  {
    ...
    Object localObject = laj.a(paramContext);
    if ((("mounted".equals(Environment.getExternalStorageState())) || (!laj.a())) && (localObject != null)) {
  ...
  private String b(String paramString)
  {
    ...
    //   1: astore 4
    //   3: aload_1
    //   4: invokestatic 115	laj:a	(Ljava/lang/String;)Ljava/lang/String;
    //   7: astore_1
    //   8: aload_0
    //   9: getfield 32	lae:a	Lcom/jakewharton/disklrucache/DiskLruCache;
    //   12: aload_1
  ...
  public lah a(String paramString1, long paramLong, String paramString2)
  {
    String str = a(laj.a(paramString2, paramString1));
    if (str == null) {
      return null;
    }
    paramString2 = a(laj.a(paramString2, paramString1, paramLong));
    paramString1 = Boolean.valueOf(false);
    if (paramString2 != null) {
      paramString1 = Boolean.valueOf(paramString2);
    }
    return new lah(str, paramString1.booleanValue());
  }
  ...
  {
    a(laj.a(paramString1, paramString2, paramLong), paramBoolean.toString());
  }
  
  public void a(String paramString1, String paramString2, long paramLong, Boolean paramBoolean, String paramString3)
  {
    a(laj.a(paramString3, paramString1, paramLong), paramBoolean.toString());
    a(laj.a(paramString3, paramString1), paramString2);
  }
}
