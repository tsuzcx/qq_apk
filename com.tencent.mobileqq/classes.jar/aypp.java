  ...
  extends ayou
{
  ...
  private ViewPager.OnPageChangeListener jdField_a_of_type_AndroidSupportV4ViewViewPager$OnPageChangeListener = new aypq(this);
  ...
  public aypp(FragmentActivity paramFragmentActivity, RecyclerView paramRecyclerView, View paramView)
  {
    super(paramView);
    this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity = paramFragmentActivity;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramFragmentActivity.app;
    this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie = new aido(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.app, this.jdField_a_of_type_ComTencentMobileqqNowWidgetDecoratorViewPager, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity);
    this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.sessionInfo.curType = 1008;
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370925));
    this.jdField_a_of_type_ComTencentMobileqqNowWidgetDecoratorViewPager = ((DecoratorViewPager)paramView.findViewById(2131381152));
    ...
    this.jdField_a_of_type_ComTencentMobileqqNowWidgetSimpleCircleIndicator = ((SimpleCircleIndicator)paramView.findViewById(2131364640));
  ...
  private void a(ChatMessage paramChatMessage)
  {
    if (paramChatMessage != null) {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(bhid.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 3, paramChatMessage.time * 1000L, true));
    }
  }
  ...
  private void b()
  {
    List localList = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getAIOList(ayoq.a, 1008, -1L, true);
    ...
    if (localList != null)
    {
      ...
      if (i >= 0)
      {
        ...
        if (!TextUtils.isEmpty(aypm.a(localChatMessage))) {
  ...
  private void c()
  {
    ...
    for (localObject = ((aoan)localObject).a(ayoq.a);; localObject = null)
    {
