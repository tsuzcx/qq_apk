  ...
  extends axur
{
  ...
  public axwm()
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new axwp(this);
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    paramContext.setBackgroundResource(2130838131);
    if (i > 1) {
      if (j == 0)
      {
    ...
    for (;;)
    {
      paramContext.setTag(2131376557, Integer.valueOf(i));
      ...
      if ((!b()) || ((b()) && (a())))
      {
        ...
        paramContext.setOnLongClickListener(new axwn(this));
        paramContext.setOnTouchListener(new axwo(this));
        return paramContext;
        if (j == i - 1)
        {
          paramContext.setBackgroundResource(2130838128);
          i = 2;
        }
        else
        {
          paramContext.setBackgroundResource(2130838126);
          i = 1;
        }
      }
      else
  ...
  public void a(String paramString, MessageRecord paramMessageRecord, StructMsgForGeneralShare paramStructMsgForGeneralShare)
  {
    ...
    try
    {
      ...
      if ((i != 23001027) && (i != 0) && (i != -4) && (i != -6))
      {
        ...
        if (!((agzd)paramString.getManager(245)).a(paramMessageRecord.frienduin))
        {
          j = 1;
          i = -4;
          if (j != 0) {
  ...
  public boolean a(axwg paramaxwg)
  {
    ...
    this.d = paramaxwg.a("actionData");
    this.e = paramaxwg.a("a_actionData");
    this.f = paramaxwg.a("i_actionData");
