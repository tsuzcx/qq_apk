  ...
  extends atxd
{
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Atwy.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(localFileManagerEntity.uniseq, localFileManagerEntity.nSessionId, localFileManagerEntity.peerUin, localFileManagerEntity.peerType, 12, null, 6, null);
  ...
  protected boolean a(int paramInt, String paramString, long paramLong)
  {
    ...
    {
      QLog.i("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + this.jdField_a_of_type_Atwy.jdField_a_of_type_Long + "]. start make progress pass to 100% directly");
      this.b = true;
      this.jdField_a_of_type_Atwy.a(1.0F);
      return true;
    }
    f();
    return true;
  ...
  protected void b(int paramInt)
  {
    ...
    if (localFileManagerEntity == null)
    {
      QLog.e("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + this.jdField_a_of_type_Atwy.jdField_a_of_type_Long + "]. onFailedOfLocalSomeThingHappen entity is null");
      return;
    }
    atwy.b(this.jdField_a_of_type_Atwy, 9, 10);
    atwy.c(this.jdField_a_of_type_Atwy, 9, 10);
  ...
  protected void c()
  {
    if (this.jdField_a_of_type_Atwy.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity == null)
    {
      QLog.e("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + this.jdField_a_of_type_Atwy.jdField_a_of_type_Long + "]. onPauseTrans entity is null");
      return;
    }
    atwy.b(this.jdField_a_of_type_Atwy, 10, -2);
    atwy.c(this.jdField_a_of_type_Atwy, 10, 15);
    QLog.i("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + this.jdField_a_of_type_Atwy.jdField_a_of_type_Long + "] state change :(" + this.jdField_a_of_type_Atxd.a() + "->StateWaitResultWhenPause)");
    this.jdField_a_of_type_Atxd = new atyi(this.jdField_a_of_type_Atwy);
  }
  ...
  protected void e()
  {
    ...
    {
      atwy.a(this.jdField_a_of_type_Atwy, 9, 10, true);
      a("StateChangeToOffFailedWhenRecv");
      this.jdField_a_of_type_Atxd = new atxi(this.jdField_a_of_type_Atwy);
      this.jdField_a_of_type_Atwy.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(localFileManagerEntity.uniseq, localFileManagerEntity.nSessionId, localFileManagerEntity.peerUin, localFileManagerEntity.peerType, 12, null, 15, null);
      return;
    }
    atwy.a(this.jdField_a_of_type_Atwy, 9, 12, true);
  ...
  protected void f()
  {
    ...
    atwy.c(this.jdField_a_of_type_Atwy, 1, 2);
    QLog.i("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + this.jdField_a_of_type_Atwy.jdField_a_of_type_Long + "] state change :(" + this.jdField_a_of_type_Atxd.a() + ". doSomeThingOnUploadDone start recv offline file....)");
    this.jdField_a_of_type_Atwy.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_Atwy.jdField_a_of_type_Long, localFileManagerEntity.uniseq, localFileManagerEntity.peerUin, localFileManagerEntity.peerType, 1);
