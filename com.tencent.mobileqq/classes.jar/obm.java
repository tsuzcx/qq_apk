  ...
  implements ohx
{
  ...
  private static obm jdField_a_of_type_Obm;
  ...
  private Map<Pair<Long, Pair<View, BaseArticleInfo>>, Long> jdField_a_of_type_JavaUtilMap = new TreeMap(new obn(this));
  private obq jdField_a_of_type_Obq;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = "https://oa.m.tencent.com/an:kandiandata/api/kd_proteus_card?version=0";
    ...
    jdField_b_of_type_JavaUtilMap = new TreeMap(new obo());
  }
  ...
  {
    return qoe.a(paramArticleInfo, paramInt);
  }
  ...
  public static List<BaseArticleInfo> a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = localJSONObject.getString(paramString);
        localStringBuilder.append(paramString + ",");
        localObject2 = baaw.decode(((String)localObject1).getBytes(), 0);
        i1 = localObject2[0];
        localObject1 = null;
        if (i1 != 0) {
          continue;
        ...
        paramString = pdb.a(paramString, 0, 0, null);
      }
      catch (JSONException paramString)
      {
        ...
        Object localObject3 = new oidb_cmd0x68b.RspGetFollowTabFeeds();
        ...
        Object localObject1 = pdb.a((articlesummary.ArticleSummary)((oidb_cmd0x68b.RspGetFollowTabFeeds)localObject3).msg_article_summary.get(), 70, 0, null);
        ...
        Object localObject2 = (articlesummary.PosAdInfo)((articlesummary.FeedsInfo)((articlesummary.ArticleSummary)localObject3).msg_feeds_info.get()).msg_pos_ad_info.get();
        paramString = (String)localObject1;
        ...
        int i1 = ((articlesummary.PosAdInfo)localObject2).enum_pos_layout.get();
        ...
        pdb.a((articlesummary.ArticleSummary)localObject3, 0, 0, paramString);
        ((AdvertisementInfo)paramString).mAdPosLayout = i1;
      ...
      if ((paramString != null) && (!TextUtils.isEmpty(b(paramString, 8888))))
      {
        ...
        QLog.d(jdField_b_of_type_JavaLangString, 2, "convert2ArticleInfoList  | itemtype :" + a(paramString, 8888) + " article title: " + paramString.mTitle);
      }
    }
  }
  ...
  public static obm a()
  {
    if (jdField_a_of_type_Obm == null) {}
    try
    {
      if (jdField_a_of_type_Obm == null) {
        jdField_a_of_type_Obm = new obm();
      }
      return jdField_a_of_type_Obm;
    }
    finally {}
  }
  ...
  private void a(List<BaseArticleInfo> paramList)
  {
    ...
    for (;;)
    {
      ...
      while (paramList.hasNext())
      {
        ...
        {
          localBaseArticleInfo.articleViewModel = rix.a(localBaseArticleInfo);
  ...
  {
    return String.valueOf(a(paramArticleInfo, paramInt));
  }
  ...
  private static String c(String paramString)
  {
    try
    {
      ...
      for (;;)
      {
        ...
        paramString = mpl.a(BaseApplicationImpl.getContext(), str, "GET", localBundle, a());
        if (paramString != null) {
          break;
        }
        return "";
    ...
    if ((paramString != null) && (Integer.parseInt(paramString.getString(d)) > 0))
    {
      ...
      bgmq.a(d, Integer.valueOf(jdField_a_of_type_Int));
  ...
  private void c()
  {
    jdField_a_of_type_Int = ((Integer)bgmq.a(d, Integer.valueOf(0))).intValue();
    QLog.d(jdField_b_of_type_JavaLangString, 2, "local version " + jdField_a_of_type_Int);
    try
    {
      jdField_a_of_type_OrgJsonJSONObject = new JSONObject((String)bgmq.a(f, ""));
      jdField_b_of_type_OrgJsonJSONObject = new JSONObject((String)bgmq.a(g, ""));
      jdField_c_of_type_OrgJsonJSONObject = new JSONObject((String)bgmq.a(e, ""));
      return;
    }
  ...
  private static void e()
  {
    ...
    {
      return;
      bgmq.a(f, jdField_a_of_type_OrgJsonJSONObject.toString());
    } while ((jdField_c_of_type_OrgJsonJSONObject == null) || (jdField_c_of_type_OrgJsonJSONObject.length() == 0));
    bgmq.a(e, jdField_c_of_type_OrgJsonJSONObject.toString());
  }
  
  private static String f()
  {
    Object localObject2 = qoe.a();
    if (localObject2 == null)
    {
    ...
    if (localObject1 != null)
    {
      ...
      localObject2 = new obp((TicketManager)localObject1, (QQAppInterface)localObject2);
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Obq == null) {
      return;
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i1 < i2)
        {
          ...
          localObject = new String(baaw.encode(arrayOfByte, 0));
  ...
  public void a(obq paramobq)
  {
    this.jdField_a_of_type_Obq = paramobq;
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (a(str))
        {
          ...
          paramArticleSummary = new String(baaw.encode(paramArticleInfo, 0));
          if (jdField_c_of_type_OrgJsonJSONObject != null)
          {
  ...
  public void b()
  {
    this.jdField_a_of_type_Obq = null;
  }
