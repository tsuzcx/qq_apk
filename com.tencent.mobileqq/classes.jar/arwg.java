  ...
  implements Handler.Callback
{
  ...
  private oidb_cmd0xb77.ImageInfo a(awfz paramawfz)
  {
    if (paramawfz == null) {
      return null;
    }
    if (!(paramawfz.a instanceof int[])) {
      return null;
    }
    int[] arrayOfInt = (int[])paramawfz.a;
    if (arrayOfInt.length != 5) {
      return null;
    }
    oidb_cmd0xb77.ImageInfo localImageInfo = new oidb_cmd0xb77.ImageInfo();
    localImageInfo.md5.set(paramawfz.d);
    localImageInfo.uuid.set(paramawfz.c);
    ...
    localImageInfo.file_id.set((int)paramawfz.b);
    return localImageInfo;
  }
  
  private oidb_cmd0xdc2.ReqBody a(String paramString1, String paramString2, Map<ResultRecord, awfz> paramMap)
  {
    oidb_cmd0xdc2.ReqBody localReqBody = new oidb_cmd0xdc2.ReqBody();
    localReqBody.msg_body.set(arzk.a(this.jdField_a_of_type_AndroidOsBundle, paramString1, paramString2, null));
    ...
    if (paramList.size() == 1)
    {
      ...
      if (((oidb_cmd0xdc2.BatchSendRsp)localObject1).err_code.get() == 901503)
      {
        ...
        if (TextUtils.isEmpty((CharSequence)localObject1)) {
          paramList = arzk.jdField_a_of_type_JavaLangString;
        }
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    arzk.a(this.jdField_a_of_type_ComTencentMobileqqMiniShareOpensdkOpenSdkShareModel, this.jdField_a_of_type_AndroidOsBundle, paramString1.msg_body);
    ...
    arzy.a("KEY_STAGE_2_NORMAL_DC2");
    mzy.a(paramString2, new arwk(this), paramString1.toByteArray(), "OidbSvc.0xdc2_9", 3522, 9, localBundle, 0L);
  }
  
  private void a(Map<ResultRecord, awfz> paramMap)
  {
    ...
    arzy.a("KEY_STAGE_2_IMAGE_DC2");
    mzy.a(localAppRuntime, new arwj(this), paramMap.toByteArray(), "OidbSvc.0xdc2_9", 3522, 9, localBundle, 0L);
  }
  
  private void a(Map<ResultRecord, awfz> paramMap, ResultRecord paramResultRecord, oidb_cmd0xdc2.BatchSendReq paramBatchSendReq)
  {
    if (paramMap != null)
    {
      paramMap = a((awfz)paramMap.get(paramResultRecord));
      if (paramMap != null) {
  ...
  private void b()
  {
    ...
    WeakReference localWeakReference = new WeakReference(new arwh(this));
    ...
    AbsShareMsg.sendSdkShareMessageByServer(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg, str1, i, str2, (awfy)localWeakReference.get());
  }
  ...
  private void b(List<oidb_cmd0xdc2.BatchSendRsp> paramList)
  {
    ...
    {
      paramList = aekt.a(localIntent, new int[] { 2 });
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Arvh.b(this.jdField_a_of_type_AndroidAppActivity);
      ForwardUtils.a(this.jdField_a_of_type_AndroidAppActivity);
      return;
      paramList = aekt.a(localIntent, null);
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_MqqOsMqqHandler.removeMessages(93);
    this.jdField_a_of_type_Arvh.b(this.jdField_a_of_type_AndroidAppActivity);
    ForwardUtils.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidOsBundle, arzk.jdField_a_of_type_JavaLangString);
  }
  ...
  private void d()
  {
    ...
    arzy.a("KEY_STAGE_2_UPLOAD_IMAGE_MULT");
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
  ...
  void a(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    this.jdField_a_of_type_Arvh = new arvh();
  }
  ...
  void a(List<ResultRecord> paramList)
  {
    ...
    paramList = azqu.a(this.jdField_a_of_type_AndroidOsBundle);
    ...
    if (!bdee.d(this.jdField_a_of_type_AndroidAppActivity))
    {
      ...
      ForwardUtils.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidOsBundle, alpo.a(2131705174));
      return;
    }
    a();
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Arvh.a(this.jdField_a_of_type_AndroidAppActivity);
      ...
      {
        this.jdField_a_of_type_Arvh.b(this.jdField_a_of_type_AndroidAppActivity);
        ForwardUtils.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidOsBundle, alpo.a(2131705173));
      }
      else
      {
        e();
