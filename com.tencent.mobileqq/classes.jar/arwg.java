  ...
  extends apqw
{
  ...
  protected void a(boolean paramBoolean, long paramLong, ArrayList<Long> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      if ((paramLong == arwc.a(this.a)) && (arwc.d(this.a) != null)) {
        if (paramArrayList != null) {
          synchronized (arwc.a(this.a))
          {
            arwc.a(this.a).put(Long.valueOf(paramLong), (ArrayList)paramArrayList.clone());
          }
        }
      }
      synchronized (arwc.d(this.a))
      {
        localObject2 = (WeakReference)arwc.d(this.a).get(Long.valueOf(paramLong));
        if (localObject2 != null)
        {
          ??? = (arwf)((WeakReference)localObject2).get();
          if (??? != null)
          {
            if (paramBoolean) {
              break;
            }
            arwc.a(this.a, paramLong, (arwf)???);
          }
        }
        return;
        label200:
    ...
    ((arwf)???).a(paramLong, paramArrayList);
  }
  ...
  protected void a(boolean paramBoolean, HashMap<Long, IntimateInfo> paramHashMap, Object arg3)
  {
    ...
    for (paramHashMap = paramHashMap.size() + paramHashMap.toString();; paramHashMap = "null")
    {
      ...
      synchronized (arwc.e(this.a))
      {
        ...
        arwc.e(this.a).remove(localObject2);
      }
    }
    label387:
    label393:
    ...
    {
      label297:
      if ((l2 == arwc.a(this.a)) && (arwc.f(this.a) != null)) {}
      synchronized (arwc.f(this.a))
      {
        ??? = (WeakReference)arwc.f(this.a).get(Long.valueOf(l2));
        if (??? != null)
        {
          ??? = (arwd)((WeakReference)???).get();
          if (??? != null) {
            arwc.a(this.a, l2, paramHashMap, ???);
          }
        }
        return;
      }
