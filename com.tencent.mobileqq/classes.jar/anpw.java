  ...
  extends anrh
{
  ...
  public anpw(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    super(paramQQAppInterface, paramActivity);
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
  }
  
  public anpw(QQAppInterface paramQQAppInterface, Context paramContext)
  {
  ...
  public void a(int paramInt)
  {
    ...
    do
    {
      ...
      try
      {
        localmxn.a(this.jdField_a_of_type_AndroidAppActivity, paramInt, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), Integer.parseInt(str));
        return;
      }
    ...
    return;
    QQToast.a(this.jdField_a_of_type_AndroidAppActivity, 2, 2131690395, 0).a();
  }
  ...
  public boolean a()
  {
    try
    {
      Intent localIntent = anha.a().a(this.jdField_a_of_type_AndroidContentContext);
      if (localIntent == null)
      {
