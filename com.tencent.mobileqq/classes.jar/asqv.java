...
public class asqv
{
  static ArrayList<WeakReference<asqv>> a;
  public static boolean a;
  public Context a;
  public ArrayMap<HotVideoData, asqh> a;
  boolean b = false;
  ...
  /* Error */
  public static asqv a(Context paramContext)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: iconst_0
    //   4: invokestatic 37	asqv:a	(Z)V
    //   7: aload_0
    //   8: ifnonnull +10 -> 18
    //   11: aconst_null
    //   12: astore_0
    ...
    //   21: dup
    //   22: aload_0
    //   23: invokespecial 39	asqv:<init>	(Landroid/content/Context;)V
    //   26: astore_1
    //   27: aload_1
    //   28: astore_0
    //   29: getstatic 21	asqv:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   32: invokevirtual 43	java/util/ArrayList:size	()I
    //   35: iconst_3
    //   36: if_icmpge -23 -> 13
    //   39: getstatic 21	asqv:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
  ...
  public static void a(asqv paramasqv)
  {
    for (;;)
    {
      try
      {
        ...
        if (jdField_a_of_type_JavaUtilArrayList.size() < 3)
        {
          ...
          if (localIterator.hasNext())
          {
            ...
            if (localObject != null)
            {
              localObject = (asqv)((WeakReference)localObject).get();
              if ((localObject != null) && (paramasqv.equals(localObject)))
              {
                i = 1;
                if (i == 0) {
                  jdField_a_of_type_JavaUtilArrayList.add(new WeakReference(paramasqv));
                }
              }
            }
          }
  ...
  public static void a(boolean paramBoolean)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        localasqv = (asqv)localWeakReference.get();
      }
      finally {}
      asqv localasqv;
      if (localasqv == null) {
        localObject.add(localWeakReference);
      } else if ((paramBoolean) && (!localasqv.b)) {
        localasqv.a();
      }
    }
  }
  ...
  /* Error */
  public static void b(asqv paramasqv)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    ...
    //   13: monitorexit
    //   14: return
    //   15: getstatic 21	asqv:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   62: ifeq -40 -> 22
    //   65: getstatic 21	asqv:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   68: aload_2
  ...
  public void a(asqh paramasqh, HotVideoData paramHotVideoData)
  {
    if ((paramasqh == null) || (paramHotVideoData == null)) {
      return;
    }
    for (;;)
    {
      try
      {
        if (this.jdField_a_of_type_AndroidSupportV4UtilArrayMap.containsKey(paramHotVideoData))
        {
          ...
          this.jdField_a_of_type_AndroidSupportV4UtilArrayMap.setValueAt(i, paramasqh);
          if (QLog.isColorLevel()) {
      ...
      this.jdField_a_of_type_AndroidSupportV4UtilArrayMap.put(paramHotVideoData, paramasqh);
    }
  }
