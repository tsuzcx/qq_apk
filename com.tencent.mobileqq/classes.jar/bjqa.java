...
public class bjqa
{
  ...
  private ConcurrentHashMap<String, bjpl> jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  private ConcurrentHashMap<String, Bundle> c = new ConcurrentHashMap();
  private ConcurrentHashMap<String, List<bjcg>> d = new ConcurrentHashMap();
  private ConcurrentHashMap<String, aupn> e = new ConcurrentHashMap();
  ...
  private void a(bjpl parambjpl, String paramString, JSONObject paramJSONObject, bjgg parambjgg)
  {
    ...
    paramString = new bjqe(this, parambjpl, parambjgg, paramString, paramJSONObject);
    bjqk.a("oidb_0xc7f_25", parambjpl, paramJSONObject.toString(), paramString);
  }
  ...
  private void a(preAuth.PreAuthResponse paramPreAuthResponse)
  {
    ...
    if (paramPreAuthResponse.auth_items.has())
    {
      ...
      if (((Iterator)localObject2).hasNext())
      {
        ...
        localObject4 = new bjcg();
        ((bjcg)localObject4).jdField_b_of_type_JavaLangString = ((appType.AuthItem)localObject3).api_list.get();
        ((bjcg)localObject4).jdField_a_of_type_Int = ((appType.AuthItem)localObject3).default_flag.get();
        ((bjcg)localObject4).jdField_b_of_type_Int = ((appType.AuthItem)localObject3).id.get();
        if (((appType.AuthItem)localObject3).is_new.get() != 0) {}
        for (boolean bool = true;; bool = false)
        {
          ((bjcg)localObject4).jdField_a_of_type_Boolean = bool;
          ((bjcg)localObject4).jdField_a_of_type_JavaLangString = ((appType.AuthItem)localObject3).title.get();
          QLog.d("SDK_LOGIN.OpenSdkVirtualManager", 1, new Object[] { "onPreAuthResponse Permission=", ((bjcg)localObject4).toString() });
    ...
    if (paramPreAuthResponse.android_info.has()) {
      this.e.put(str, aupn.a(paramPreAuthResponse, paramPreAuthResponse.android_info));
    }
  ...
  public aupn a(String paramString)
  {
    if (TextUtils.isEmpty(paramString)) {
      return null;
    }
    return (aupn)this.e.get(paramString);
  }
  
  public bjpl a(String paramString)
  {
    if (TextUtils.isEmpty(paramString)) {
      return null;
    }
    return (bjpl)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
  }
  ...
  public preAuth.PreAuthRequest a(bjpl parambjpl, String paramString, long paramLong1, long paramLong2, Bundle paramBundle)
  {
    preAuth.PreAuthRequest localPreAuthRequest = new preAuth.PreAuthRequest();
    localPreAuthRequest.appid.set(paramLong1);
    localPreAuthRequest.sdkp.set(bjhh.a(paramBundle, "sdkp", "android"));
    localPreAuthRequest.sdkv.set(bjhh.a(paramBundle, "sdkv", "1.5.9"));
    localPreAuthRequest.qqv.set(bizw.a().d());
    ...
    if (Build.VERSION.RELEASE == null)
    {
      ...
      localPreAuthRequest.scope.set(bjhh.a(paramBundle, "scope", ""));
      localPreAuthRequest.skey.set(parambjpl.jdField_b_of_type_JavaLangString);
    ...
    for (;;)
    {
      if (paramLong2 != 0L)
      {
        parambjpl = new preAuth.PreAuthProxyRequest();
        parambjpl.appid.set(paramLong2);
        localPreAuthRequest.proxy_req.set(parambjpl);
      }
  ...
  public List<bjcg> a(String paramString)
  {
    if (TextUtils.isEmpty(paramString)) {
      return null;
    }
  ...
  public SSOAccountObserver a(OpenSDKAppInterface paramOpenSDKAppInterface, String paramString1, String paramString2, int paramInt, bjqi parambjqi)
  {
    QLog.d("SDK_LOGIN.OpenSdkVirtualManager", 1, "getTicketNoPasswd uin=" + bjhh.a(paramString1));
    new bjpl().jdField_a_of_type_JavaLangString = paramString1;
    paramOpenSDKAppInterface = new bjqg(this, paramOpenSDKAppInterface, parambjqi);
    bjpm.a().a(paramString1, paramOpenSDKAppInterface, paramString2, paramInt);
    return paramOpenSDKAppInterface;
  }
  
  public void a(long paramLong, String paramString1, String paramString2, bjgg parambjgg)
  {
    bjpl localbjpl = (bjpl)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(paramLong));
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)) || (localbjpl == null))
    {
      QLog.d("SDK_LOGIN.OpenSdkVirtualManager", 1, "OpenVirtual.createVirtual.return for params error");
      if (parambjgg != null) {
        parambjgg.a(false, null, -1);
      }
      return;
    }
    ...
    try
    {
      ...
      QLog.d("SDK_LOGIN.OpenSdkVirtualManager", 1, new Object[] { "OpenVirtual.createVirtual.start:", bjqk.a(localJSONObject.toString(), localbjpl.jdField_a_of_type_JavaLangString) });
      ThreadManagerV2.executeOnSubThread(new OpenSdkVirtualManager.1(this, localbjpl, localJSONObject, parambjgg));
      return;
    }
  ...
  public void a(preAuth.PreAuthRequest paramPreAuthRequest, Activity paramActivity, bjpl parambjpl, bjqj parambjqj, int paramInt)
  {
    if (paramActivity == null)
    {
      QLog.d("SDK_LOGIN.OpenSdkVirtualManager", 1, new Object[] { "preAuthWithRetry activity==null, preAuthCallback=", parambjqj });
      if (parambjqj != null) {
        parambjqj.a(-1, "");
      }
      return;
    ...
    {
      localObject = bjqk.a(paramActivity, paramPreAuthRequest.appUniqueIdentifier.get());
    ...
    NewIntent localNewIntent = new NewIntent(BaseApplicationImpl.getApplication(), bjhv.class);
    localNewIntent.putExtra("uin", parambjpl.jdField_a_of_type_JavaLangString);
    String str = bjhh.a(BaseApplicationImpl.getApplication().getRuntime(), parambjpl, paramPreAuthRequest.login_sig, "QQConnectLogin.pre_auth", "QQConnectLogin.pre_auth_emp");
    boolean bool = "QQConnectLogin.pre_auth_emp".equals(str);
    byte[] arrayOfByte = paramPreAuthRequest.toByteArray();
    Object localObject = arrayOfByte;
    if (bool) {
      localObject = bjqk.a(arrayOfByte, parambjpl);
    }
    QLog.d("SDK_LOGIN.OpenSdkVirtualManager", 1, new Object[] { "preAuthWithRetry cmd=", str });
    b(parambjpl.jdField_a_of_type_JavaLangString);
    ...
    auuv.a("KEY_PRE_AUTH");
    localNewIntent.setObserver(new bjqh(this, parambjpl, bool, parambjqj, paramInt, paramPreAuthRequest, paramActivity));
    BaseApplicationImpl.getApplication().getRuntime().startServlet(localNewIntent);
  }
  
  public void a(String paramString)
  {
    QLog.d("SDK_LOGIN.OpenSdkVirtualManager", 1, "addForce540Account uin=" + bjhh.a(paramString));
  ...
  public void a(String paramString, long paramLong, bjgg parambjgg)
  {
    bjpl localbjpl = (bjpl)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(paramString));
    if (localbjpl == null)
    {
    ...
    try
    {
      ...
      ThreadManagerV2.executeOnSubThread(new OpenSdkVirtualManager.2(this, localbjpl, localJSONObject, parambjgg));
      return;
    }
  ...
  public void a(String paramString, bjpl parambjpl)
  {
    if ((!TextUtils.isEmpty(paramString)) && (parambjpl != null)) {
      this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString, parambjpl);
    }
  }
  
  public void a(String paramString1, String paramString2, Activity paramActivity, String paramString3, Bundle paramBundle, bjqj parambjqj)
  {
    paramString2 = (bjpl)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(paramString2));
    ...
    a(a(paramString2, paramString3, ForwardUtils.parseLong(paramString1), l, paramBundle), paramActivity, paramString2, new bjqd(this, parambjqj), 2);
  }
  
  public void a(String paramString1, String paramString2, bjgg parambjgg)
  {
    bjpl localbjpl = (bjpl)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(paramString1));
    if ((TextUtils.isEmpty(paramString2)) || (localbjpl == null))
    {
      QLog.d("SDK_LOGIN.OpenSdkVirtualManager", 1, "OpenVirtual.uploadAvatarImage.return for params error");
      if (parambjgg != null) {
        parambjgg.a(false, paramString2, null, -1);
      }
      return;
    }
    ThreadManagerV2.executeOnSubThread(new OpenSdkVirtualManager.4(this, paramString2, paramString1, localbjpl, parambjgg));
  }
  
  public void a(boolean paramBoolean, String paramString1, String paramString2, List<bjcg> paramList, long paramLong, bjgg parambjgg, String paramString3, Activity paramActivity)
  {
    ...
    {
      localbjpl = (bjpl)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(localObject1);
      localObject1 = (Bundle)this.c.get(localObject1);
      if ((localAppRuntime != null) && (localObject1 != null) && (localbjpl != null)) {
        break;
      }
    ...
    if (!TextUtils.isEmpty(paramString2))
    {
      new bjgl().a(paramBoolean, paramString1, paramString2, paramList, paramLong, parambjgg, paramString3, paramActivity, localbjpl, (Bundle)localObject1);
      return;
    }
    ...
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      {
        localObject4 = (bjcg)((Iterator)localObject2).next();
        if (((bjcg)localObject4).jdField_b_of_type_Boolean)
        {
          localAuthorizeRequest.openapi.add(Integer.valueOf(((bjcg)localObject4).jdField_b_of_type_Int));
          ((StringBuilder)localObject1).append(((bjcg)localObject4).jdField_b_of_type_Int).append(",");
        }
      }
    }
    ...
    for (localObject1 = localObject1.toString();; localObject1 = "")
    {
      ...
      break;
      localObject2 = bjqk.a(paramActivity, paramString3);
    ...
    localAuthorizeRequest.skey.set(localbjpl.jdField_b_of_type_JavaLangString);
    if (paramBoolean) {
    ...
    for (;;)
    {
      ...
      ((NewIntent)localObject3).putExtra("uin", localbjpl.jdField_a_of_type_JavaLangString);
      localObject4 = bjhh.a(localAppRuntime, localbjpl, localAuthorizeRequest.login_sig, "ConnAuthSvr.sdk_auth_api", "ConnAuthSvr.sdk_auth_api_emp");
      boolean bool = "ConnAuthSvr.sdk_auth_api_emp".equals(localObject4);
      localObject2 = localAuthorizeRequest.toByteArray();
      localObject1 = localObject2;
      if (bool) {
        localObject1 = bjqk.a((byte[])localObject2, localbjpl);
      }
      ...
      ((NewIntent)localObject3).setObserver(new bjqf(this, System.currentTimeMillis(), localbjpl, paramString1, paramBoolean, paramString2, paramList, paramLong, parambjgg, paramString3, paramActivity, bool, (String)localObject4));
      localAppRuntime.startServlet((NewIntent)localObject3);
      QLog.d("SDK_LOGIN.OpenSdkVirtualManager", 1, new Object[] { "OpenVirtual.doAuthorize.send | cmd: " + (String)localObject4, " | uin : *" + bjhh.a(localbjpl.jdField_a_of_type_JavaLangString) });
      return;
  ...
  public boolean a(String paramString)
  {
    ...
    QLog.d("SDK_LOGIN.OpenSdkVirtualManager", 1, "isForceTo540 uin=" + bjhh.a(paramString) + ", force540=" + bool);
    return bool;
  }
}
