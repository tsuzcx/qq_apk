  ...
  extends atab
{
  ...
  public atcn(atcq paramatcq, BaseFileAssistantActivity paramBaseFileAssistantActivity, Object paramObject, View.OnClickListener paramOnClickListener1, View.OnClickListener paramOnClickListener2, View.OnClickListener paramOnClickListener3, View.OnLongClickListener paramOnLongClickListener, View.OnClickListener paramOnClickListener4)
  {
    ...
    this.jdField_a_of_type_Atcq = paramatcq;
  ...
  private View a(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (FavFileInfo localFavFileInfo = (FavFileInfo)paramViewGroup;; localFavFileInfo = null)
    {
      ...
      if (localFavFileInfo == null)
      {
        ...
        while (this.jdField_a_of_type_Atcq.b()) {
          return null;
        }
        paramView = new ataa();
        ...
        paramViewGroup.setOnClickListener(this.jdField_a_of_type_Atcq.a(paramView.jdField_a_of_type_AndroidWidgetTextView));
        paramViewGroup.setTag(paramView);
        if (this.jdField_b_of_type_JavaUtilLinkedHashMap.size() == 0) {
          paramViewGroup.setVisibility(8);
        }
        while (this.jdField_a_of_type_Atcq.a())
        {
      ...
      for (;;)
      {
        try
        {
          ...
          localataa = new ataa();
          paramViewGroup = paramView;
          localataa.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView = ((AsyncImageView)paramView.findViewById(2131368501));
          paramViewGroup = paramView;
          localataa.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368518));
          paramViewGroup = paramView;
          localataa.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368515));
          paramViewGroup = paramView;
          ...
          paramViewGroup = paramView;
          localataa.jdField_a_of_type_Boolean = false;
          paramViewGroup = paramView;
          paramView.setTag(localataa);
        }
        ...
        try
        {
          localataa.jdField_a_of_type_JavaLangObject = localFavFileInfo;
          ...
          localataa.jdField_a_of_type_Boolean = false;
          a(localFavFileInfo, localataa.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView);
          paramViewGroup = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131692304) + localFavFileInfo.c;
          if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.f())
          {
            ...
            localataa.jdField_a_of_type_AndroidWidgetImageView.setClickable(true);
            if (this.jdField_a_of_type_Atcq.a(localFavFileInfo))
            {
              paramViewGroup = paramViewGroup + this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131692303);
              localataa.jdField_b_of_type_AndroidWidgetImageView.setVisibility(4);
              localataa.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130845671);
              localataa.jdField_a_of_type_AndroidWidgetImageView.setClickable(false);
              localataa.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(paramViewGroup);
              localataa.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setContentDescription(paramViewGroup);
              return paramView;
              paramViewGroup = paramView;
              localataa = (ataa)paramView.getTag();
              paramViewGroup = paramView;
              if (!localataa.jdField_a_of_type_Boolean) {
                continue;
              }
              paramViewGroup = paramView;
              paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131560829, null);
            ...
            {
              paramViewGroup = paramViewGroup + this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131692305);
        ...
        catch (Exception localException1)
        {
          ...
          continue;
          paramViewGroup = paramViewGroup + anvx.a(2131709184);
          localException1.jdField_b_of_type_AndroidWidgetImageView.setVisibility(4);
          localException1.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130845669);
  ...
  private LinearLayout a(ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup.setTag(new atcp(null));
    return paramViewGroup;
  }
  
  private void a(FavFileInfo paramFavFileInfo, AsyncImageView paramAsyncImageView)
  {
    if ((!TextUtils.isEmpty(paramFavFileInfo.e)) && (FileUtil.fileExistsAndNotEmpty(paramFavFileInfo.e)))
    {
    ...
    int i = 0;
    String str = "";
    if ((!TextUtils.isEmpty(paramFavFileInfo.k)) && (FileUtil.fileExistsAndNotEmpty(paramFavFileInfo.k))) {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.app.getFileManagerEngine().a().a(paramFavFileInfo, 2);
      paramFavFileInfo.a(2, l);
      return;
      if ((!TextUtils.isEmpty(paramFavFileInfo.j)) && (FileUtil.fileExistsAndNotEmpty(paramFavFileInfo.j)))
      {
        str = paramFavFileInfo.j;
      }
      else if ((!TextUtils.isEmpty(paramFavFileInfo.i)) && (FileUtil.fileExistsAndNotEmpty(paramFavFileInfo.i)))
      {
        str = paramFavFileInfo.i;
      }
      else if ((!TextUtils.isEmpty(paramFavFileInfo.h)) && (FileUtil.fileExistsAndNotEmpty(paramFavFileInfo.h)))
      {
        str = paramFavFileInfo.h;
      }
      else if ((!TextUtils.isEmpty(paramFavFileInfo.g)) && (FileUtil.fileExistsAndNotEmpty(paramFavFileInfo.g)))
      {
        str = paramFavFileInfo.g;
        i = 1;
      }
      else if ((!TextUtils.isEmpty(paramFavFileInfo.f)) && (FileUtil.fileExistsAndNotEmpty(paramFavFileInfo.f)))
      {
  ...
  private View b(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    atcp localatcp = (atcp)paramView.getTag();
    int i = 0;
    for (;;)
    {
      View localView;
      if (i < 4)
      {
        localView = a(paramInt1, paramInt2 * 4 + i, paramBoolean, localatcp.a[i], paramViewGroup);
        if (localView != null) {}
      }
      else
      {
