  ...
  extends wxr
{
  ...
  private final String jdField_a_of_type_JavaLangString = wxv.class.getName();
  ...
  public wxv(String paramString1, String paramString2)
  {
  ...
  private void b()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: invokevirtual 57	wxv:a	()Lcom/jakewharton/disklrucache/DiskLruCache;
    //   6: ifnull +13 -> 19
    //   9: aload_0
    //   10: invokevirtual 57	wxv:a	()Lcom/jakewharton/disklrucache/DiskLruCache;
    //   13: invokevirtual 63	com/jakewharton/disklrucache/DiskLruCache:isClosed	()Z
    //   16: ifeq +88 -> 104
    //   19: invokestatic 67	baht:c	()Z
    //   22: ifne +10 -> 32
    //   25: aload_0
    //   26: getfield 48	wxv:jdField_b_of_type_Long	J
    //   29: putstatic 20	wxv:jdField_a_of_type_Long	J
    //   32: aload_0
    //   33: invokevirtual 69	wxv:b	()Ljava/lang/String;
    //   36: astore_1
    ...
    //   50: ifne +57 -> 107
    //   53: aload_0
    //   54: getfield 35	wxv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   78: getstatic 20	wxv:jdField_a_of_type_Long	J
    //   81: invokestatic 93	baip:b	(J)Ljava/lang/String;
    ...
    //   90: invokestatic 100	urk:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   93: aload_2
    //   94: invokevirtual 103	java/io/File:mkdirs	()Z
    //   97: pop
    //   98: aload_0
    //   99: aload_2
    //   100: invokevirtual 106	wxv:a	(Ljava/io/File;)Z
    //   103: pop
    //   104: aload_0
    //   105: monitorexit
    //   106: return
    //   107: aload_0
    //   108: getfield 35	wxv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   132: getstatic 20	wxv:jdField_a_of_type_Long	J
    //   135: invokestatic 93	baip:b	(J)Ljava/lang/String;
    ...
    //   144: invokestatic 110	urk:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   147: goto -49 -> 98
    //   150: astore_1
    //   151: aload_0
    //   152: monitorexit
  ...
  public wxs a(String paramString)
  {
    b();
    ...
    if ((a() != null) && (str != null))
    {
      ...
      catch (IOException localIOException)
      {
        for (;;)
        {
          urk.d(this.jdField_a_of_type_JavaLangString, "Get cache error: Cache name: " + str + ", Url: " + paramString);
        }
        urk.c(this.jdField_a_of_type_JavaLangString, "Get cache success: Cache name: " + str + ", Url: " + paramString);
        return localwxs;
      }
      if (localObject != null)
      {
        localwxs.a(localObject);
        localwxs.a(localObject.getInputStream(0));
        if (localwxs.a() == null)
        {
          urk.d(this.jdField_a_of_type_JavaLangString, "Get cache error: InputStream is null. Cache name: " + str + ", Url: " + paramString);
          return localwxs;
        }
      }
      urk.d(this.jdField_a_of_type_JavaLangString, "Get cache error: snapshot is null. Cache name: " + str + ", Url: " + paramString);
      return localwxs;
    }
    urk.d(this.jdField_a_of_type_JavaLangString, "Get cache error: DiskCache or cacheName is null. Cache name: " + str + ", Url: " + paramString);
    return localwxs;
  }
  ...
  {
    urk.b(this.jdField_a_of_type_JavaLangString, "Open cache dir.");
    try
    {
  ...
  public boolean a(String paramString)
  {
    ...
    //   9: istore_3
    //   10: aload_0
    //   11: invokespecial 54	wxv:b	()V
    //   14: aload_0
    //   15: invokevirtual 57	wxv:a	()Lcom/jakewharton/disklrucache/DiskLruCache;
    //   18: ifnull +183 -> 201
    //   21: aload_0
    //   22: aload_1
    //   23: invokevirtual 123	wxv:a	(Ljava/lang/String;)Ljava/lang/String;
    //   26: astore 6
    //   28: aload_0
    //   29: getfield 112	wxv:jdField_a_of_type_ComJakewhartonDisklrucacheDiskLruCache	Lcom/jakewharton/disklrucache/DiskLruCache;
    //   32: astore 7
    //   34: aload 7
    //   36: monitorenter
    //   37: iload 4
    //   39: istore_2
    //   40: aload_0
    //   41: invokevirtual 57	wxv:a	()Lcom/jakewharton/disklrucache/DiskLruCache;
    //   44: aload 6
    ...
    //   58: istore_2
    //   59: aload 8
    //   61: invokevirtual 173	com/jakewharton/disklrucache/DiskLruCache$Snapshot:close	()V
    //   64: iconst_1
    //   65: istore_3
    //   66: iload_3
    //   67: istore_2
    ...
    //   75: istore_2
    //   76: aload_0
    //   77: getfield 35	wxv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   109: invokestatic 100	urk:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   112: goto -46 -> 66
    //   115: astore 6
    //   117: aload 7
    //   119: monitorexit
    ...
    //   123: astore 6
    //   125: aload_0
    //   126: getfield 35	wxv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   148: invokestatic 100	urk:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   151: iload_2
    //   152: ireturn
    //   153: astore 6
    //   155: iload 5
    //   157: istore_2
    //   158: aload_0
    //   159: getfield 35	wxv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   181: invokestatic 100	urk:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   184: iload_2
    //   185: ireturn
    //   186: astore 6
    //   188: goto -30 -> 158
  ...
  public boolean a(String arg1, java.io.InputStream paramInputStream)
  {
    ...
    //   7: istore 5
    //   9: aload_0
    //   10: getfield 40	wxv:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   13: astore 7
    //   15: aload 7
    //   17: monitorenter
    //   18: aload_0
    //   19: iconst_1
    //   20: putfield 182	wxv:jdField_a_of_type_Boolean	Z
    //   23: aload_0
    //   24: aload_1
    //   25: putfield 44	wxv:d	Ljava/lang/String;
    //   28: aload 7
    //   30: monitorexit
    //   31: aload_0
    //   32: invokespecial 54	wxv:b	()V
    //   35: aload_0
    //   36: aload_1
    //   37: invokevirtual 123	wxv:a	(Ljava/lang/String;)Ljava/lang/String;
    //   40: astore 11
    //   42: aload_0
    //   43: invokevirtual 57	wxv:a	()Lcom/jakewharton/disklrucache/DiskLruCache;
    //   46: ifnull +465 -> 511
    //   49: aload 11
    //   51: ifnull +460 -> 511
    //   54: aload_2
    //   55: ifnull +456 -> 511
    //   58: aload_0
    //   59: getfield 112	wxv:jdField_a_of_type_ComJakewhartonDisklrucacheDiskLruCache	Lcom/jakewharton/disklrucache/DiskLruCache;
    //   62: astore 10
    //   64: aload 10
    //   66: monitorenter
    //   67: aload_0
    //   68: invokevirtual 57	wxv:a	()Lcom/jakewharton/disklrucache/DiskLruCache;
    //   71: aload 11
    //   73: invokevirtual 186	com/jakewharton/disklrucache/DiskLruCache:edit	(Ljava/lang/String;)Lcom/jakewharton/disklrucache/DiskLruCache$Editor;
    //   76: astore 9
    //   78: aload 9
    //   80: ifnull +392 -> 472
    //   83: new 188	java/io/BufferedOutputStream
    //   86: dup
    //   87: aload 9
    //   89: iconst_0
    //   90: invokevirtual 194	com/jakewharton/disklrucache/DiskLruCache$Editor:newOutputStream	(I)Ljava/io/OutputStream;
    //   93: getstatic 22	wxv:jdField_b_of_type_Int	I
    //   96: invokespecial 197	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;I)V
    //   99: astore 8
    //   101: aload 8
    //   103: astore 7
    //   105: getstatic 22	wxv:jdField_b_of_type_Int	I
    //   108: newarray byte
    //   110: astore 12
    //   112: aload 8
    //   114: astore 7
    //   116: aload_2
    //   117: aload 12
    //   119: invokevirtual 203	java/io/InputStream:read	([B)I
    //   122: istore_3
    //   123: iload_3
    //   124: iconst_m1
    ...
    //   130: astore 7
    //   132: aload_0
    //   133: getfield 182	wxv:jdField_a_of_type_Boolean	Z
    //   136: ifne +186 -> 322
    //   139: aload 8
    //   141: astore 7
    //   143: aload_0
    //   144: getfield 35	wxv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   147: ldc 205
    //   149: invokestatic 208	urk:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   152: aload 8
    //   154: astore 7
    //   156: aload 8
    //   158: invokevirtual 213	java/io/OutputStream:flush	()V
    //   161: aload 8
    //   163: astore 7
    //   165: aload 9
    //   167: invokevirtual 216	com/jakewharton/disklrucache/DiskLruCache$Editor:commit	()V
    //   170: aload 8
    //   172: ifnull +401 -> 573
    //   175: aload 8
    //   177: invokevirtual 217	java/io/OutputStream:close	()V
    //   180: iconst_1
    //   181: istore 4
    //   183: aload_0
    //   184: getfield 35	wxv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   216: invokestatic 152	urk:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   219: aload_0
    //   220: getfield 112	wxv:jdField_a_of_type_ComJakewhartonDisklrucacheDiskLruCache	Lcom/jakewharton/disklrucache/DiskLruCache;
    //   223: invokevirtual 224	java/lang/Object:notifyAll	()V
    //   226: aload 10
    //   228: monitorexit
    //   229: iload 4
    //   231: istore 5
    //   233: aload_0
    //   234: getfield 182	wxv:jdField_a_of_type_Boolean	Z
    //   237: ifne +12 -> 249
    //   240: aload_0
    //   241: aload_1
    //   242: invokevirtual 226	wxv:a	(Ljava/lang/String;)V
    //   245: iload 4
    //   247: istore 5
    //   249: aload_0
    //   250: getfield 40	wxv:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   253: astore_1
    //   254: aload_1
    //   255: monitorenter
    //   256: aload_0
    //   257: iconst_0
    //   258: putfield 182	wxv:jdField_a_of_type_Boolean	Z
    //   261: aload_0
    //   262: ldc 42
    //   264: putfield 44	wxv:d	Ljava/lang/String;
    //   267: aload_1
    //   268: monitorexit
    //   269: iload 5
    //   271: ireturn
    ...
    //   278: astore 7
    //   280: aload_0
    //   281: getfield 35	wxv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   313: invokestatic 100	urk:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   316: aconst_null
    //   317: astore 9
    //   319: goto -241 -> 78
    //   322: aload 8
    //   324: astore 7
    //   326: aload_0
    //   327: getfield 35	wxv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   347: iload_3
    //   348: invokevirtual 233	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   351: invokevirtual 96	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   354: invokestatic 110	urk:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   357: aload 8
    //   359: astore 7
    //   361: aload 8
    //   363: aload 12
    //   365: iconst_0
    //   366: iload_3
    //   367: invokevirtual 237	java/io/OutputStream:write	([BII)V
    //   370: goto -258 -> 112
    //   373: astore_2
    //   374: aload 8
    //   376: astore_2
    ...
    //   378: astore 7
    //   380: aload_0
    //   381: getfield 35	wxv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   413: invokestatic 100	urk:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   416: iload 5
    //   418: istore 4
    //   420: aload_2
    //   421: ifnull -238 -> 183
    //   424: aload_2
    //   425: invokevirtual 217	java/io/OutputStream:close	()V
    //   428: iload 5
    //   430: istore 4
    //   432: goto -249 -> 183
    //   435: astore_2
    ...
    //   456: ifnull +8 -> 464
    //   459: aload 7
    //   461: invokevirtual 217	java/io/OutputStream:close	()V
    //   464: aload_1
    //   465: athrow
    //   466: astore_1
    //   467: aload 10
    ...
    //   471: athrow
    //   472: aload_0
    //   473: getfield 35	wxv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   505: invokestatic 100	urk:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   508: goto -289 -> 219
    //   511: aload_0
    //   512: getfield 35	wxv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   544: invokestatic 100	urk:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   547: iload 6
    //   549: istore 5
    //   551: goto -302 -> 249
    //   554: astore_2
  ...
  public boolean a(String paramString1, String paramString2)
  {
    ...
    if ((a() != null) && (str != null))
    {
      ...
      catch (IOException localIOException)
      {
        for (;;)
        {
          urk.d(this.jdField_a_of_type_JavaLangString, "Set cache error: Exception ");
        }
      }
      finally {}
      bool1 = bool2;
      if (localObject != null) {
        urk.c(this.jdField_a_of_type_JavaLangString, "name: " + paramString1 + ", Cache name: " + str + ", value length: " + paramString2.length());
      }
      try
      {
        localObject.set(0, rra.a(paramString2));
        localObject.commit();
        bool1 = true;
      }
      catch (IOException paramString1)
      {
        for (;;)
        {
          urk.d(this.jdField_a_of_type_JavaLangString, "Commit cache error: Exception ");
          bool1 = bool2;
        }
      }
  ...
  {
    if (baht.c()) {}
    for (String str = baht.a() + File.separator + "Android" + File.separator + "data" + File.separator + jdField_b_of_type_JavaLangString + File.separator + a();; str = c + File.separator + a())
    {
      urk.b(this.jdField_a_of_type_JavaLangString, "Init cache dir: " + str);
      return str;
    }
  }
