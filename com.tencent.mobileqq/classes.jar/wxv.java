  ...
  implements wxt
{
  ...
  wyt jdField_a_of_type_Wyt = null;
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          ...
          {
            this.jdField_a_of_type_Wxr.b(paramString, (String)localObject);
            return;
          }
        }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if ("anonymousNickChanged".equals(paramString3)) {
      try
      {
        ...
        this.jdField_a_of_type_Wxr.a(paramString1, l, i, paramString2, j, paramString3, this);
        return true;
      }
    ...
    for (;;)
    {
      ...
      if ("cleanDynamicRedPoint".equals(paramString3)) {
        try
        {
          ...
          this.jdField_a_of_type_Wxr.c(paramJsBridgeListener, this);
          return true;
        }
        catch (JSONException paramJsBridgeListener)
        {
      ...
      else if ("getTroopBarPublishInfo".equals(paramString3))
      {
        try
        {
          ...
          this.jdField_a_of_type_Wxr.a(new wxw(this, paramJsBridgeListener));
        }
        catch (JSONException paramJsBridgeListener)
        {
          paramJsBridgeListener.printStackTrace();
      ...
      else
      {
        if (("createVideoAndSend".equals(paramString3)) || ("prepareVideoResources".equals(paramString3))) {
          try
          {
            ...
            if (this.jdField_a_of_type_Wyt == null) {
              this.jdField_a_of_type_Wyt = new wyt((BaseActivity)this.mRuntime.a());
            }
            localObject2 = this.jdField_a_of_type_Wyt;
            localObject2.getClass();
            localObject2 = new wzd((wyt)localObject2);
            ((wzd)localObject2).jdField_a_of_type_JavaLangString = paramString1;
            ((wzd)localObject2).b = ((String)localObject1);
            ((wzd)localObject2).c = paramString2;
            ((wzd)localObject2).jdField_a_of_type_Int = i;
            i = 0;
            while (i < paramVarArgs.length())
            {
              paramString1 = paramVarArgs.getString(i);
              ((wzd)localObject2).jdField_a_of_type_JavaUtilArrayList.add(paramString1);
              i += 1;
            }
            if ("createVideoAndSend".equals(paramString3)) {
              this.jdField_a_of_type_Wyt.a((wzd)localObject2, new wxx(this, paramJsBridgeListener));
            } else {
              this.jdField_a_of_type_Wyt.a((wzd)localObject2, new wxy(this, paramJsBridgeListener));
            }
          }
        ...
        else if (("enableShortVideoPublish".equals(paramString3)) && (paramVarArgs.length == 1))
        {
          try
          {
            ...
            paramJsBridgeListener.put("enableShortVideoPublish", avte.a());
            if (QLog.isColorLevel()) {
  ...
  public void onDestroy()
  {
    ...
    this.jdField_a_of_type_Wyt = null;
  }
}
