  ...
  extends BaseAdapter
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      localView = LayoutInflater.from(paramViewGroup.getContext()).inflate(2131561484, paramViewGroup, false);
    }
    paramView = (ColorSelectView)localView.findViewById(2131364387);
    paramViewGroup = (ImageView)localView.findViewById(2131364385);
    if (paramInt == 0)
    {
      paramView.setVisibility(8);
      paramViewGroup.setVisibility(0);
      if (this.jdField_a_of_type_Int == paramInt) {}
      for (paramInt = 2130846159;; paramInt = 2130846158)
      {
