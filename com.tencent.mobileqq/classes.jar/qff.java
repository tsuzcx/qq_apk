  ...
  extends BaseAdapter
{
  ...
  public qff(Context paramContext, List<ReadInJoyDraftboxItem> paramList)
  {
  ...
  private URLDrawable.URLDrawableOptions a()
  {
    ...
    localURLDrawableOptions.mRequestWidth = bbkx.b(100.0F);
    localURLDrawableOptions.mRequestHeight = bbkx.b(100.0F);
  ...
  private URLDrawable a(HotPicData paramHotPicData)
  {
    ...
    if (paramHotPicData.getDataType() != 2)
    {
      ...
      localURLDrawableOptions.mRequestWidth = bbkx.a(50.0F);
      localURLDrawableOptions.mRequestHeight = bbkx.a(50.0F);
      if (paramHotPicData.getDataType() != 2) {
        break label69;
      }
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    Object localObject2 = (TextView)paramViewGroup.findViewById(2131378144);
    MiddleBracketsTitleTextView localMiddleBracketsTitleTextView = (MiddleBracketsTitleTextView)paramViewGroup.findViewById(2131378142);
    paramView = (TextView)paramViewGroup.findViewById(2131378143);
    ImageView localImageView = (ImageView)paramViewGroup.findViewById(2131368558);
    TextView localTextView = (TextView)paramViewGroup.findViewById(2131378121);
    ((TextView)localObject2).setEditableFactory(ayks.a);
    localMiddleBracketsTitleTextView.setEditableFactory(ayks.a);
    ...
    if ((this.jdField_a_of_type_JavaUtilList != null) && (paramInt >= 0) && (paramInt < this.jdField_a_of_type_JavaUtilList.size()))
    {
      ...
      paramView.setText(onj.a(localReadInJoyDraftboxItem.time, false));
      paramView = localReadInJoyDraftboxItem.title;
      if (localReadInJoyDraftboxItem.type == 3) {
        paramView = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131718526);
      }
      ...
      if (localReadInJoyDraftboxItem.type == 2) {
        localObject1 = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131718522) + ": " + paramView;
      }
      ((TextView)localObject2).setText(new ayki((CharSequence)localObject1, 7, 16));
      ...
      localMiddleBracketsTitleTextView.setText(new ayki(paramView, 7, 16));
    ...
    for (;;)
    {
      paramViewGroup.setOnClickListener(new qfg(this, localReadInJoyDraftboxItem));
      localTextView.setOnClickListener(new qfh(this, localReadInJoyDraftboxItem, paramInt));
      paramViewGroup.setTag(-3, Integer.valueOf(bbkx.a(66.0F)));
