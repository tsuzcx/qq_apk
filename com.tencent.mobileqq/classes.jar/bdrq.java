...
public class bdrq
{
  ...
  public bdrq(bdnv parambdnv, Context paramContext, int paramInt)
  {
  ...
  public static boolean a(bdnv parambdnv, int paramInt)
  {
    ...
    label14:
    String str;
    if (parambdnv.hasNext())
    {
      str = ((bdnu)parambdnv.next()).a;
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      localObject1 = (FrameLayout)localLinearLayout.findViewById(2131378248);
      if (localObject1 == null) {
        break label381;
      }
      localObject2 = this.jdField_a_of_type_Bdnv.a.iterator();
      paramView = null;
      if (((Iterator)localObject2).hasNext())
      {
        ...
        if ("title".equals(str)) {
          paramView = ((StructMsgItemTitle)localbdnu).b();
        }
        for (;;)
        {
          break;
          if ("picture".equals(str)) {
            this.jdField_a_of_type_AndroidViewView = a(localbdnu, (View)localObject1, paramBundle);
          }
        }
      }
      ...
      paramBundle = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378263);
    ...
    for (;;)
    {
      if (localLinearLayout == null)
      {
        ...
        localLinearLayout.setId(2131378264);
      }
      for (;;)
      {
        localObject1 = this.jdField_a_of_type_Bdnv.a.iterator();
        label331:
        if (((Iterator)localObject1).hasNext())
        {
          paramContext = (bdnu)((Iterator)localObject1).next();
        ...
        for (;;)
        {
          ...
          if ((!TextUtils.isEmpty(paramView)) && (paramView.trim().length() > 0))
          {
            ...
            this.jdField_a_of_type_AndroidWidgetTextView.setId(2131378266);
  ...
  public View a(bdnu parambdnu, View paramView, Bundle paramBundle)
  {
    ...
    {
      PAImageView localPAImageView = (PAImageView)parambdnu;
      localPAImageView.setUseRadiusRound(true, localResources.getDimensionPixelSize(2131296448));
      localPAImageView.setTag(2131373330, Integer.valueOf(1));
    }
