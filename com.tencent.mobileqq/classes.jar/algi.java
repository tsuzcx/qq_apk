...
public class algi
{
  ...
  public algi(String paramString1, String paramString2)
  {
    this.b = paramString1;
    this.a = paramString2;
  }
  ...
  public static boolean a(byte[] paramArrayOfByte1, String paramString, byte[] paramArrayOfByte2)
  {
    ...
    do
    {
      ...
      try
      {
        paramString = KeyFactory.getInstance("RSA").generatePublic(new X509EncodedKeySpec(bdbi.decode(paramString.getBytes("UTF-8"), 0)));
  ...
  public boolean a(int paramInt)
  {
    ...
    try
    {
      if ((bdcs.a(this.a)) && (bdcs.a(this.b)))
      {
        byte[] arrayOfByte1 = bdcs.a(this.a);
        byte[] arrayOfByte2 = bdcs.a(this.b);
