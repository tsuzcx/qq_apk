...
{
  public algi(LoginView paramLoginView) {}
  ...
  public void onLoginFailed(String paramString1, String paramString2, String paramString3, int paramInt1, byte[] paramArrayOfByte1, int paramInt2, byte[] paramArrayOfByte2)
  {
    ...
    catch (Exception localException)
    {
      ...
      bgsg.a(BaseApplicationImpl.sApplication, this.a.jdField_a_of_type_JavaLangString, true);
      label250:
      if ((paramString2 == null) || (paramString2.equals(""))) {
        QQToast.a(this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 2131693946, 0).a();
      }
      Intent localIntent;
      do
      {
        ...
        bcst.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800AC0B", "0X800AC0B", 0, 0, "", "", "", "");
        LoginView.a(this.a, new aobn(this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity));
      } while (aobl.a().a(paramArrayOfByte2, this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.a.jdField_a_of_type_AndroidWidgetAutoCompleteTextView.getText().toString(), this.a.jdField_a_of_type_ComTencentMobileqqWidgetCustomSafeEditText.getText().toString(), LoginView.a(this.a)));
      ...
      if (paramInt1 == 2008)
      {
        bglp.a(this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 230, anni.a(2131705147), anni.a(2131705142), "OK", null, new algj(this), null).show();
        QQToast.a(this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 2131692729, 0).a();
        return;
      }
      bglp.a(this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 230, anni.a(2131705135), paramString2, new algk(this), null).show();
    }
  }
  ...
  public void onLoginSuccess(String paramString1, String paramString2)
  {
    ...
    {
      bcst.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007365", "0X8007365", 0, 0, "", "", "", "");
      bcst.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007365", "0X8007365", 1, 0, "", "", "", "");
    }
    awcu.a(this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
