  ...
  implements Manager, BusinessObserver
{
  ...
  public algi(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    if ((amvi.c()) && (!this.jdField_a_of_type_Boolean))
    {
      if (QLog.isColorLevel()) {
        QLog.d("weatherManager", 2, "updateWeatherInfo  from  LocaleManager.isLocaleUpdatedByUser()");
      }
      this.jdField_a_of_type_Boolean = true;
      algk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramAppActivity);
    }
    Long localLong;
    do
    {
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    {
      localEditor.commit();
      if (this.jdField_a_of_type_Algj == null) {
        break;
      }
      this.jdField_a_of_type_Algj.a(paramInt, paramBoolean, paramBundle);
      return;
      label421:
      if (j == 0) {
