...
public class bhxg
{
  public static int a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    if (ShortVideoTrimmer.a(paramContext, 0, 0))
    {
      ...
      {
        i = j;
        if (((axlq)localObject).jdField_a_of_type_Boolean)
        {
          if (Build.VERSION.SDK_INT < 18) {
            break label347;
          }
          i = axhn.a(paramContext);
          if (((i & 0x1) <= 0) || ((i & 0x2) <= 0)) {
            break label333;
          }
          bool = true;
          ...
          localObject = new bhxh(paramString2, (int)(((axlq)localObject).b * 1024L), (int)((axlq)localObject).jdField_a_of_type_Long);
          if ((!new axmf().a(localFile, (axmg)localObject, true)) || (((bhxh)localObject).a != null)) {
            break label339;
          }
          if (QLog.isColorLevel()) {
  ...
  public static String a(String paramString)
  {
    ...
    //   1: astore 5
    //   3: aload_0
    //   4: invokestatic 293	bhxg:b	(Ljava/lang/String;)Ljava/lang/String;
    //   7: astore 6
  ...
  public static JSONObject a(AppRuntime paramAppRuntime, String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ...
      localBundle.putString("bkn", String.valueOf(banb.b((String)localObject)));
      try
      {
        paramString1 = new Bundle();
        paramString1.putString("Cookie", "uin=" + str + ";skey=" + (String)localObject);
        paramAppRuntime = paramAppRuntime.getApplication().getApplicationContext();
        if (bhxe.a().a()) {}
        for (paramAppRuntime = nah.a(paramAppRuntime, "https://qun.qq.com/cgi-bin/grouphw/upload_auth/put", localBundle, paramString1);; paramAppRuntime = naj.a(paramAppRuntime, "https://qun.qq.com/cgi-bin/grouphw/upload_auth/put", "GET", localBundle, paramString1))
        {
  ...
  public static String b(String paramString)
  {
    ...
    for (;;)
    {
      return bbvj.a(((StringBuilder)localObject).toString());
  ...
  public static JSONObject b(AppRuntime paramAppRuntime, String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramAppRuntime = paramAppRuntime.getApplication().getApplicationContext();
        if (bhxe.a().a()) {}
        for (paramAppRuntime = nah.a(paramAppRuntime, "https://qun.qq.com/cgi-bin/grouphw/upload_append", localBundle, paramString1);; paramAppRuntime = naj.a(paramAppRuntime, "https://qun.qq.com/cgi-bin/grouphw/upload_append", "GET", localBundle, paramString1))
        {
          paramString1 = paramAppRuntime;
          if (paramAppRuntime == null) {
            paramString1 = "";
