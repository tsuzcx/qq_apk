  ...
  implements bbik, bbll
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new bhxh(this);
  private bblk jdField_a_of_type_Bblk;
  private bhxi jdField_a_of_type_Bhxi;
  ...
  public bhxg(Context paramContext, bhxi parambhxi)
  {
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    for (int i = 0;; i = 1)
    {
      this.jdField_a_of_type_Bblk = new bblk(paramString, localHandler, i);
      this.jdField_a_of_type_Bblk.a(BaseApplication.getContext());
  ...
  public void a(int paramInt1, String paramString, int paramInt2)
  {
    ...
    {
      this.jdField_a_of_type_Bhxi.b(this.jdField_b_of_type_Int, paramString);
      this.jdField_b_of_type_Int = 0;
      return;
    }
    this.jdField_a_of_type_Bhxi.a(3, this.e);
  }
  ...
  {
    avbr.b(paramString);
    this.jdField_a_of_type_Bhxi.a(paramString, paramDouble);
  }
  
  public void a(String paramString1, QQRecorder.RecorderParam paramRecorderParam, String paramString2)
  {
    avbr.a(paramString1);
    this.jdField_a_of_type_Bhxi.c();
  }
  ...
  public void b(String paramString)
  {
    ...
    if ((this.jdField_a_of_type_Bhxi != null) && (!TextUtils.isEmpty(str1)))
    {
      this.jdField_a_of_type_Bhxi.a(1, paramString);
      d(str1);
      return;
    }
    ...
    for (;;)
    {
      if (i != 0)
      {
        if (new StatFs(Environment.getExternalStorageDirectory().getAbsolutePath()).getAvailableBlocks() > 1)
        {
          ...
          paramString = aypf.a(paramString, null, 2, null);
        ...
        bcpw.a(BaseApplication.getContext(), 2131719049, 0).a();
        return;
      }
    }
    bcpw.a(BaseApplication.getContext(), 2131694693, 0).a();
  }
}
