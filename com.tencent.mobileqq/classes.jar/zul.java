    ...
    if (this.jdField_a_of_type_AndroidContentBroadcastReceiver == null) {
      try
      {
        if (this.jdField_a_of_type_AndroidContentBroadcastReceiver == null)
        {
          ...
          zum localzum = new zum(this);
          BaseApplicationImpl.getContext().registerReceiver(localzum, localIntentFilter, "com.tencent.msg.permission.pushnotify", null);
          this.jdField_a_of_type_AndroidContentBroadcastReceiver = localzum;
        }
        return;
      }
      finally {}
