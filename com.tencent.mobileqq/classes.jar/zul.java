  ...
  implements Handler.Callback
{
  ...
  public zul(Context paramContext, abdt paramabdt)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Abdt = paramabdt;
    this.jdField_a_of_type_Apcy = apcy.a();
    this.jdField_a_of_type_Apcy.a(paramContext, hashCode(), "QrImageScan");
  }
  ...
  public void a()
  {
    try
    {
      ...
      if (this.jdField_a_of_type_Apcy != null) {
        this.jdField_a_of_type_Apcy.a(hashCode(), "QrImageScan");
      }
      this.jdField_a_of_type_Abdt = null;
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (int i = zuc.a((Uri)paramMessage.obj, this.jdField_a_of_type_AndroidContentContext, j, (SparseArray)localObject);; i = 0)
    {
      boolean bool1 = zuc.a(i);
      boolean bool2 = zuc.b(i);
      if ((bool1) || (bool2))
      {
        if (bool1)
        {
      ...
      for (;;)
      {
        try
        {
          ...
          if ((!zuc.a(k)) || (paramMessage == null)) {
            break label350;
          }
          i = 1;
          if ((!zuc.b(k)) || (paramMessage == null)) {
            break label355;
          }
          j = 1;
          if ((i == 0) && (j == 0)) {
      ...
      i = paramMessage.arg1;
      j = paramMessage.arg2;
      if (this.jdField_a_of_type_Abdt == null) {
        break;
      }
      this.jdField_a_of_type_Abdt.a(String.valueOf(paramMessage.obj), i, j);
      return true;
      i = paramMessage.arg1;
      if (this.jdField_a_of_type_Abdt == null) {
        break;
      }
      this.jdField_a_of_type_Abdt.a(i);
      return true;
    }
  }
}
