  ...
  extends BaseAdapter
{
  ...
  public static final int c = bhtq.b(10.0F);
  float jdField_a_of_type_Float;
  private Context jdField_a_of_type_AndroidContentContext;
  private ArrayList<bpmi> jdField_a_of_type_JavaUtilArrayList = new ArrayList(10);
  ...
  static
  {
    jdField_a_of_type_Int = bhtq.b(40.0F);
    jdField_b_of_type_Int = bhtq.b(5.0F);
  }
  
  public bpmh(Context paramContext, int paramInt)
  {
  ...
  private View a()
  {
    ...
    for (;;)
    {
      ...
      ((URLImageView)localObject1).setId(2131368212);
      ...
      localObject3 = new bpmi();
      ((bpmi)localObject3).jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localObject1);
      ((bpmi)localObject3).jdField_a_of_type_AndroidViewView = localFrameLayout;
      ((bpmi)localObject3).jdField_a_of_type_AndroidWidgetTextView = ((TextView)localObject2);
      ((bpmi)localObject3).jdField_a_of_type_Boolean = this.jdField_a_of_type_Boolean;
  ...
  public void a()
  {
    TransitionCategoryItem localTransitionCategoryItem = bqzz.a().a();
    ...
    {
      localbpmi = (bpmi)localIterator.next();
      if (localbpmi.jdField_a_of_type_DovComQqImCaptureDataTransitionCategoryItem == null) {
        break label116;
      }
      if (localTransitionCategoryItem == null) {
        break label111;
      }
      bool2 = TextUtils.equals(localTransitionCategoryItem.a, localbpmi.jdField_a_of_type_DovComQqImCaptureDataTransitionCategoryItem.a);
      bool1 = bool2;
      if (!bool2)
      {
        if (((localTransitionCategoryItem != null) && (!localTransitionCategoryItem.c())) || (!localbpmi.jdField_a_of_type_DovComQqImCaptureDataTransitionCategoryItem.c())) {
          break label105;
        }
        bool1 = true;
      }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      if ((paramView.getTag() == null) || (!(paramView.getTag() instanceof bpmi)))
      {
        if (QLog.isColorLevel()) {
      ...
      bpmi localbpmi = (bpmi)paramView.getTag();
      TextView localTextView = localbpmi.jdField_a_of_type_AndroidWidgetTextView;
      URLImageView localURLImageView = localbpmi.jdField_a_of_type_ComTencentImageURLImageView;
      ...
      localbpmi.jdField_a_of_type_DovComQqImCaptureDataTransitionCategoryItem = localTransitionCategoryItem;
      ...
      for (boolean bool1 = TextUtils.equals(((QIMFilterCategoryItem)localObject).a, localTransitionCategoryItem.a);; bool1 = false) {
        for (;;)
        {
          ...
          try
          {
            ...
            paramView.setContentDescription(localTransitionCategoryItem.b + anzj.a(2131713849));
          }
