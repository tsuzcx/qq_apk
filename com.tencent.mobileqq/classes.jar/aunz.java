...
public class aunz
{
  ...
  {
    paramString1 = aunj.a(paramString1);
    aunj.a(paramString1);
    ...
    paramString1 = new File(aunj.b(localFile.getAbsolutePath() + "/" + paramString1 + paramString2));
    try
    {
  ...
  public static String a(String paramString)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        {
          localObject3 = localObject4;
          localObject1 = "." + bhmi.b(paramString);
      ...
      catch (Exception localException)
      {
        ...
        str2 = bezl.a((Context)localObject3, str1);
  ...
  public static String b(String paramString)
  {
    ...
    {
      return null;
      localObject4 = aunj.a(paramString);
      str2 = "";
      String str1 = str2;
      localObject3 = localObject4;
      localObject2 = str2;
      ...
      catch (Exception localException)
      {
        ...
        str2 = bezl.a((Context)localObject2, (String)localObject3);
        j = ff.a(paramString);
    ...
    for (;;)
    {
      if (auoo.a((Context)localObject2, paramString, (Uri)localObject1))
      {
        paramString = ((File)localObject4).getAbsolutePath();
        localObject1 = new auoa();
