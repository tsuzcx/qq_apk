...
public class agcd
{
  ...
  public agcd(SplashActivity paramSplashActivity)
  {
  ...
  private int a()
  {
    ...
    axcj localaxcj = (axcj)this.a.app.getManager(10);
    if (localaxcj != null)
    {
      int j = localaxcj.a(1);
      i = j;
      ...
      {
        QLog.d("UndealCount.MainAssistObserver", 2, "getQZoneMsgCount TYPE_PASSIVE_FEED: " + localaxcj.a(1));
        i = j;
      }
    }
    return i;
  ...
  private boolean a()
  {
    ...
    if (localaxcj != null)
    {
      ...
      if (QLog.isColorLevel())
      {
        QLog.d("UndealCount.MainAssistObserver", 2, "isNewQzoneMsgExist TYPE_ACTIVE_FEED: " + localaxcj.a(2) + " TYPE_ZEBRA_ALBUM:" + localaxcj.a(17));
        bool2 = bool1;
      }
    }
  ...
  private boolean b()
  {
    ...
    Iterator localIterator = ((avps)this.a.app.getManager(36)).a().iterator();
  ...
  public Runnable a(agce paramagce)
  {
    return new LebaTabRedTouch.1(this, paramagce);
  }
