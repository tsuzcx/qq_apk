...
{
  private static SparseArray<aizq> b;
  private aizl jdField_a_of_type_Aizl;
  private aizm jdField_a_of_type_Aizm;
  private SparseArray<Long> jdField_a_of_type_AndroidUtilSparseArray;
  private bfob jdField_a_of_type_Bfob = new bfob(ThreadManager.getSubThreadLooper(), this);
  public QQLruCache<String, String> a;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private List<Integer> jdField_a_of_type_JavaUtilList = new ArrayList();
  private CopyOnWriteArrayList<aizk> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  ...
  public static aizq a(int paramInt)
  {
    return (aizq)jdField_b_of_type_AndroidUtilSparseArray.get(paramInt);
  }
      ...
      if (paramBoolean)
      {
        ...
        try
        {
          ...
          if ("apollo_router_game.apl_audio_linkcmd_save_audio_data".equals(localObject1))
          {
            ...
            paramBundle = (aizk)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(paramInt);
            if (paramBundle == null) {
              break label2956;
            }
          ...
          if ("apollo_router_game.apl_audio_linkcmd_query_status".equals(localObject1))
          {
            if (l1 == 0L)
            {
              ...
              localObject1 = (aizk)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(paramInt);
              ...
              paramBoolean = false;
              ((aizk)localObject1).a(str, paramBoolean);
              break label2963;
            }
            i = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size();
            paramInt = 0;
        ...
        if ("ltgame_gamepanel.query_top_gamelist".equals(localObject1))
        {
          ...
          this.jdField_a_of_type_Aizm = new aizm(this);
          this.jdField_a_of_type_Aizm.jdField_a_of_type_JavaLangString = str;
          ...
          this.jdField_a_of_type_Aizm.jdField_b_of_type_JavaLangString = ((JSONObject)localObject2).optString("description", ajya.a(2131702122));
          if ((localJSONArray != null) && (localJSONArray.length() > 0))
          {
            ...
            if (paramInt < j)
            {
              ...
              this.jdField_a_of_type_Aizm.jdField_a_of_type_JavaUtilList.add(Integer.valueOf(k));
              this.jdField_a_of_type_Aizm.c.add(localObject1);
              if (localJSONObject.optInt("isGameApp") != 1) {
                break label3024;
              }
              i = 1;
              label1082:
              localObject2 = localajmu.a(k);
              ...
              if (localObject1 != null)
              {
                this.jdField_a_of_type_Aizm.jdField_b_of_type_JavaUtilList.add(localObject1);
                break label3017;
              }
            ...
            if (((List)localObject3).size() > 0) {
              ((ajmu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155)).e((List)localObject3);
            }
            if (localArrayList.size() > 0)
            {
              localObject1 = (bbrd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(71);
              localObject2 = new Bundle();
              ((Bundle)localObject2).putInt("key_get_game_detail_from", 1);
              ((Bundle)localObject2).putString("key_get_game_detail_friuin", str);
              ((bbrd)localObject1).a(localArrayList, paramBundle);
              return;
            }
            i = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size();
            paramInt = 0;
            ...
            paramBundle.a(str, this.jdField_a_of_type_Aizm);
            break label3030;
          }
        ...
        if ("ltgame_gamepanel.query_self_gamelist".equals(localObject1))
        {
          ...
          if ((localJSONArray != null) && (localJSONArray.length() > 0))
          {
            ...
            if (localArrayList.size() > 0) {
              ((ajmu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155)).e(localArrayList);
            }
            if (((ArrayList)localObject3).size() > 0)
            {
              paramBundle = (bbrd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(71);
            ...
            Collections.sort((List)localObject2, this.jdField_a_of_type_Aizl);
            i = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size();
            paramInt = 0;
            if (paramInt >= i) {
              break label3055;
        ...
        if ("ltgame_playmate.get_playmate_info".equals(localObject1))
        {
          ...
          if (!TextUtils.isEmpty(paramBundle))
          {
            ...
            ((aizk)localObject1).a(str, paramBundle);
            break label3057;
          }
        ...
        if ("ltgame_msg_auth.get_sign".equals(localObject1))
        {
          ...
          if (l1 == -10002L)
          {
            ...
            ApolloItemBuilder.a(ajya.a(2131702121), 1, BaseApplicationImpl.getContext());
            return;
          }
          if (l1 == -10000L)
          {
          ...
          if (l1 == -10001L)
          {
            ...
            ApolloItemBuilder.a(ajya.a(2131702127), 1, BaseApplicationImpl.getContext());
            return;
          }
          if (!QLog.isColorLevel()) {
            continue;
          }
          ApolloItemBuilder.a(ajya.a(2131702123) + l1, 1, BaseApplicationImpl.getContext());
          return;
        }
        long l2;
  ...
  private void a(long paramLong)
  {
    ...
    while (i < j)
    {
      aizk localaizk = (aizk)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i);
      if (localaizk != null) {
        localaizk.d(String.valueOf(paramLong));
      }
      i += 1;
    }
  }
  ...
  private void a(String paramString, int paramInt1, long paramLong, int paramInt2)
  {
    ...
    {
      return;
      List localList = aize.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, paramInt2, paramInt1, paramLong);
      ...
      while (paramInt1 < i)
      {
        aizk localaizk = (aizk)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(paramInt1);
        if (localaizk != null) {
          localaizk.a(paramString, paramInt2, localList);
        }
        paramInt1 += 1;
      }
    }
  ...
  private void a(String paramString1, String paramString2, boolean paramBoolean, String paramString3)
  {
    ...
    localIntent.putExtra("leftViewText", ajya.a(2131702124));
  ...
  public static void a(JSONArray paramJSONArray)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        i = actj.a(7.0F, BaseApplicationImpl.getContext().getResources());
        if (bbdh.a() > 2.0F) {
          break label201;
        }
        i = actj.a(9.0F, BaseApplicationImpl.getContext().getResources());
      }
      ...
      if (j < k)
      {
        ...
        {
          localaizq = new aizq();
          localaizq.jdField_a_of_type_JavaLangCharSequence = localJSONObject.optString("tips");
          localaizq.jdField_a_of_type_Int = localJSONObject.optInt("id");
          localaizq.jdField_b_of_type_Int = localJSONObject.optInt("tipsType");
          if (!TextUtils.isEmpty(localaizq.jdField_a_of_type_JavaLangCharSequence))
          {
            if (localaizq.jdField_b_of_type_Int == 1) {
              localaizq.jdField_a_of_type_JavaLangCharSequence = new aykk(aylc.c(localJSONObject.optInt("tips")), 3, i);
            }
            jdField_b_of_type_AndroidUtilSparseArray.put(localaizq.jdField_a_of_type_Int, localaizq);
          }
        }
        j += 1;
      }
  ...
  private void b(long paramLong)
  {
    ...
    while (i < j)
    {
      aizk localaizk = (aizk)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i);
      if (localaizk != null) {
        localaizk.e(String.valueOf(paramLong));
      }
      i += 1;
    }
  }
  ...
  private void b(boolean paramBoolean, String paramString, int paramInt, long paramLong)
  {
    ...
    while (i < j)
    {
      aizk localaizk = (aizk)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i);
      if (localaizk != null) {
        localaizk.b(paramBoolean, paramString, paramInt, paramLong);
      }
      i += 1;
    }
  }
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_Aizl = new aizl(this.jdField_a_of_type_AndroidUtilSparseArray);
  }
  ...
  private void c(String paramString, int paramInt, long paramLong)
  {
    ...
    while (i < j)
    {
      aizk localaizk = (aizk)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i);
      if (localaizk != null) {
        localaizk.a(paramString, paramInt, paramLong);
      }
      i += 1;
    }
  }
  ...
  private void c(String paramString1, String paramString2)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        {
          paramString1 = aize.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1, 1036);
          if ((paramString1 == null) || (paramString1.isEmpty()))
          {
            QLog.e("CmGameTemp_CmGameTempSessionHandler", 2, "onQueryTempGameStatusRsp msgList == null || msgList.isEmpty()");
            return;
          }
          airr localairr = ((airt)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(211)).a();
          int i = 0;
          if (i < paramString2.length())
          {
            ...
            if (localObject2 != null)
            {
              ...
              if ((k >= 4) && (l > 0L) && (j > 0))
              {
                MessageForApollo localMessageForApollo = aize.a(paramString1, j, l);
                if (localMessageForApollo != null)
                {
                  ...
                  localairr.a(localMessageForApollo);
                }
              }
            }
            i += 1;
  ...
  private void i(String paramString)
  {
    ...
    try
    {
      ...
      localObject2 = aize.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, 1036);
    ...
    if ((j >= 4) && (l > 0L) && (i > 0))
    {
      localObject2 = aize.a((List)localObject2, i, l);
      if (localObject2 != null)
      {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        do
        {
          ...
          ((airt)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(211)).a().a((MessageForApollo)localObject2);
          return;
  ...
  public void a()
  {
    this.jdField_a_of_type_Bfob.removeMessages(255);
  ...
  public void a(int paramInt)
  {
    ...
    if ((BaseActivity.sTopActivity instanceof FragmentActivity))
    {
      ...
      if (localObject1 != null)
      {
        ...
        if (!(localObject1 instanceof aemy)) {}
      }
    }
    for (localObject1 = (aemy)localObject1;; localObject1 = null)
    {
      if (localObject1 != null)
      {
        localObject2 = ((aemy)localObject1).b();
        if (localObject2 != null) {
          break label285;
        }
      }
      ...
      do
      {
        return;
        Collections.sort((List)localObject2, this.jdField_a_of_type_Aizl);
        ((aemy)localObject1).b((List)localObject2);
      } while (((aemy)localObject1).a == null);
      ((aemy)localObject1).a.m();
      return;
    }
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    try
    {
      ...
      localObject = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), aiwg.class);
  ...
  public void a(int paramInt1, String paramString1, int paramInt2, String paramString2, int paramInt3)
  {
    ...
    try
    {
      ...
      localUniSsoServerReq.reqdata.set(((JSONObject)localObject).toString());
      paramString1 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), aiwg.class);
  ...
  public void a(aizk paramaizk)
  {
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.remove(paramaizk);
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(paramaizk);
    QLog.i("CmGameTemp_CmGameTempSessionHandler", 1, "addMsgUIHandler size:" + this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() + " cmGameMsgUIHandler:" + paramaizk);
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ("close_aio".equals(str))
        {
          ...
          paramTunnelMsgStream = (aizk)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i);
          if (paramTunnelMsgStream == null) {
            break label741;
          }
        ...
        if ("mphone_status".equals(str))
        {
          ...
          paramTunnelMsgStream = (aizk)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(j);
          if (paramTunnelMsgStream == null) {
            break label748;
          }
      ...
      else
      {
        ...
        {
          aize.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1), l3, j);
          return;
        }
      ...
      for (int i = 1;; i = 0)
      {
        ...
        if ("robot_send_arkmsg".equals(str))
        {
          ...
          aize.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l2), paramTunnelMsgStream, l1, i);
          return;
        }
  ...
  public void a(String paramString)
  {
    try
    {
      ...
      localObject2 = aize.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, 1036, 1);
      if ((localObject2 == null) || (((List)localObject2).isEmpty()))
      {
        if (!QLog.isColorLevel()) {
          return;
    ...
    Object localObject1 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), aiwg.class);
  ...
  public void a(String paramString1, String paramString2)
  {
    try
    {
      ...
      localUniSsoServerReq.reqdata.set(((JSONObject)localObject).toString());
      paramString2 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), aiwg.class);
  ...
  public void a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = new NewIntent(BaseApplicationImpl.getContext(), aiwg.class);
        ((NewIntent)localObject).putExtra("timeout", 10000L);
  ...
  public void a(List<ApolloGameData> paramList, Bundle paramBundle)
  {
    ...
    if (i == 1)
    {
      this.jdField_a_of_type_Aizm.jdField_b_of_type_JavaUtilList.clear();
      k = this.jdField_a_of_type_Aizm.jdField_b_of_type_JavaUtilList.size();
      i = 0;
      while (i < k)
      {
        int m = ((Integer)this.jdField_a_of_type_Aizm.jdField_a_of_type_JavaUtilList.get(i)).intValue();
        paramBundle = ((ajmu)localObject).a(m);
        if (paramBundle != null)
        {
          this.jdField_a_of_type_Aizm.jdField_b_of_type_JavaUtilList.add(paramBundle);
          i += 1;
        }
        else
        {
    ...
    for (;;)
    {
      ...
      while (i < k)
      {
        paramBundle = (aizk)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i);
        if (paramBundle != null) {
          paramBundle.a(paramList, this.jdField_a_of_type_Aizm);
        }
        i += 1;
      }
      continue;
      if (i == 2)
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          ApolloGameData localApolloGameData = ((ajmu)localObject).a(i);
        ...
        Collections.sort(paramBundle, this.jdField_a_of_type_Aizl);
        j = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size();
        i = 0;
        while (i < j)
        {
          localObject = (aizk)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(0);
          if (localObject != null) {
            ((aizk)localObject).a(paramList, paramBundle);
          }
          i += 1;
        }
      }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        while (i < k)
        {
          aizk localaizk = (aizk)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i);
          if (localaizk != null) {
            localaizk.a(paramBoolean, paramString1, j, l, paramString2);
          }
          i += 1;
        }
        return;
  ...
  public void b(aizk paramaizk)
  {
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.remove(paramaizk);
    QLog.i("CmGameTemp_CmGameTempSessionHandler", 1, "removeMsgUIHandler size:" + this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() + " cmGameMsgUIHandler:" + paramaizk);
  }
      ...
      try
      {
        if ((BaseActivity.sTopActivity instanceof FragmentActivity))
        {
          ...
          if (localObject1 != null)
          {
            ...
            if ((localObject1 instanceof aemy))
            {
              localObject1 = (aemy)localObject1;
              ...
              if ((localObject1 == null) || (!((aemy)localObject1).D()))
              {
                a(str, (String)localObject2, true, paramString);
                return;
              }
              aemy.U = true;
              ((aemy)localObject1).a(j, i, paramString);
              return;
            }
          }
        }
