...
public class bfnv
{
  ...
  {
    bfnq.a("WadlJsBridgeCall", 2, "dispatch wadlParams:" + paramWadlParams);
    ...
    case 3: 
    case 10: 
      bkel.a().a(paramWadlParams.d, paramWadlParams.jdField_a_of_type_JavaLangString);
      return;
    case 4: 
      bkel.a().b(paramWadlParams.d, paramWadlParams.jdField_a_of_type_JavaLangString);
      return;
    }
  ...
  {
    bfnq.c("WadlJsBridgeCall", "doDownloadAction params:" + paramString1 + ",fromWeb:" + paramBoolean + ",from:" + paramInt + ",weburl:" + paramString2);
    ...
    try
    {
      ...
      {
        aact.c(paramString2, "DELAY_LIST");
        aact.a(paramString2, paramString1, "DELAY_APPID_DETAIL_");
        aacp.a();
        return 0;
      }
      if (!localWadlParams.jdField_b_of_type_Boolean)
      {
        aact.b(paramString2, "DELAY_LIST");
        aact.d(paramString2, "DELAY_APPID_DETAIL_");
      }
      if (localWadlParams.jdField_b_of_type_Boolean)
      {
        if (a(localWadlParams.g))
        {
          bfnq.c("WadlJsBridgeCall", "##@Operation for wadlParams.resName:" + localWadlParams.g + " is not returned! The opertion of action: " + paramInt + " is ignored!");
          return 1;
        }
        a(localWadlParams.g);
      }
      ...
      {
        aact.a(null, "558", "202982", paramString2, "55801", "4", "430");
        bfnq.c("WadlJsBridgeCall", "invalid url:" + localWadlParams);
        return -1;
        if (a(paramString2))
        {
          bfnq.c("WadlJsBridgeCall", "##@Operation for appid:" + paramString2 + " is not returned! The opertion of action: " + paramInt + " is ignored!");
          return 1;
        }
        a(paramString2);
      }
    ...
    {
      bfnq.a("WadlJsBridgeCall", "doDownloadAction:", paramString1);
      return -1;
    }
    return 0;
  }
  ...
  public void a()
  {
    ...
    {
      bfnq.a("WadlJsBridgeCall", "getQueryAllTask()>>>", localException);
    }
  }
  ...
  public void a(int paramInt, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      bkel.a().c(paramInt, paramString1);
      return;
    }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    {
      bfnq.a("WadlJsBridgeCall", "getQueryDownloadAction(String,String)>>>", paramString1);
    }
  }
  
  public void a(String paramString, boolean paramBoolean, int paramInt)
  {
    bfnq.c("WadlJsBridgeCall", "startDownload delay task" + paramString + " ," + paramBoolean + "," + paramInt + ",isWiFi=" + AppNetConnInfo.isWifiConn());
    if (1 == paramInt) {
  ...
  public void d(String paramString)
  {
    ...
    {
      bfnq.a("WadlJsBridgeCall", "query getQueryDownloadAction>>>", paramString);
    }
  }
  ...
  public void e(String paramString)
  {
    ...
    {
      bfnq.a("WadlJsBridgeCall", "query getQueryDownloadActionByVia>>>", paramString);
    }
  }
}
