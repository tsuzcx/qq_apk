...
public class aaae
{
  ...
  {
    zzk.a("1001" + paramString);
    zzk.a("1001" + paramString, new aahu(paramString));
  ...
  private static boolean a(Context paramContext, CertifiedAccountMeta.StFeed paramStFeed, ExtraTypeInfo paramExtraTypeInfo, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      if (i != 0)
      {
        zzk.a("1002" + paramStFeed.id.get());
        zzk.a("1002" + paramStFeed.id.get(), new aahs(paramStFeed));
      }
      if (bool2)
      {
        ...
        paramContext.startActivity(paramIntent, aaid.a());
