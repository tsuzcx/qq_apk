  ...
  extends BaseAdapter
{
  ...
  public bclv(DraggableGridView paramDraggableGridView, int paramInt)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    paramView = new bclt(this.jdField_a_of_type_ComTencentMobileqqWidgetDraggableGridView, this.jdField_a_of_type_Int, paramInt);
