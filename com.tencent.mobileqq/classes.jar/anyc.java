  ...
  implements Manager
{
  ...
  public anyc(QQAppInterface paramQQAppInterface)
  {
  ...
  private List<EmosmPb.SmallYellowItem> a(List<EmosmPb.SmallYellowItem> paramList)
  {
    ...
    for (;;)
    {
      if (anwr.a().a(i).a(j))
      {
        ...
        m = n;
        break;
        j = ayjy.jdField_a_of_type_AndroidUtilSparseIntArray.get(i);
        i = j;
  ...
  private List<EmosmPb.SmallYellowItem> a(List<EmosmPb.SmallYellowItem> paramList1, List<EmosmPb.SmallYellowItem> paramList2)
  {
    List<EmosmPb.SmallYellowItem> localList = null;
    int j = 0;
    if (QLog.isColorLevel()) {
    ...
    for (localList = paramList2;; localList = null)
    {
      ...
      for (;;)
      {
        ...
        Collections.sort(localList, new anyd(this));
        if (QLog.isColorLevel())
        {
        ...
        while (paramList2.hasNext())
        {
          ...
          if ((paramList1.contains(localObject2)) || (anwr.a().a(((EmosmPb.SmallYellowItem)localObject1).type.get()).a(((EmosmPb.SmallYellowItem)localObject1).id.get()))) {
            paramList2.remove();
          } else {
  ...
  private List<EmosmPb.SmallYellowItem> c()
  {
    if (QLog.isColorLevel()) {
  ...
  public List<EmosmPb.SmallYellowItem> a()
  {
    ...
    if ((this.jdField_a_of_type_JavaUtilList == null) || (this.jdField_a_of_type_JavaUtilList.size() < 1))
    {
      ...
      if (i < this.jdField_a_of_type_ArrayOfInt.length)
      {
        ...
        if (j > axau.b.length)
        {
          ...
          k = ayjy.jdField_a_of_type_AndroidUtilSparseIntArray.get(j);
          j = k;
          ...
          label187:
          if (!anwr.a().a(((EmosmPb.SmallYellowItem)localObject2).type.get()).a(((EmosmPb.SmallYellowItem)localObject2).id.get())) {
            break label315;
          }
          if (QLog.isColorLevel()) {
    ...
    if ((!this.jdField_a_of_type_Boolean) && (localList != null))
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        if (anwr.a().a(localSmallYellowItem.type.get()).a(localSmallYellowItem.id.get())) {
  ...
  public void a(File paramFile1, File paramFile2)
  {
    ...
    {
      localObject2 = bbdx.a(paramFile1);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (((Iterator)localObject2).hasNext())
        {
          ...
          if (localSmallYellowItem.id.get() == ayjy.c[i]) {
            ((Iterator)localObject2).remove();
          }
        }
        else
        {
          ...
          bbdx.a(paramFile2.getAbsolutePath(), paramFile1.toByteArray(), false);
          return;
        }
      }
  ...
  public void a(List<EmosmPb.SmallYellowItem> paramList)
  {
    ...
    this.jdField_a_of_type_Boolean = aocw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false);
    Object localObject2;
    if (QLog.isColorLevel())
    {
      ??? = new StringBuilder("updateItemInfo backList size = ");
      ((StringBuilder)???).append(paramList.size());
      if (paramList != null)
      {
        ((StringBuilder)???).append(", before convert: ");
        i = 0;
        while (i < paramList.size())
        {
          localObject2 = (EmosmPb.SmallYellowItem)paramList.get(i);
          ((StringBuilder)???).append("type = " + ((EmosmPb.SmallYellowItem)localObject2).type.get()).append(";id = " + ((EmosmPb.SmallYellowItem)localObject2).id.get()).append(";ts = " + ((EmosmPb.SmallYellowItem)localObject2).ts.get());
          i += 1;
        }
      }
      QLog.d("CommonUsedSystemEmojiManager", 2, ((StringBuilder)???).toString());
    }
    ??? = new ArrayList();
    int i = j;
    if (i < paramList.size())
    {
      ...
      if (j == 1) {
        if ((m >= 0) && (m < axau.b.length))
        {
          ...
          if ((j >= ayjy.jdField_a_of_type_Int) || (j < 0))
          {
      ...
      for (;;)
      {
        ...
        if (j == 2)
        {
          k = ayjy.jdField_a_of_type_AndroidUtilSparseIntArray.get(m);
          j = k;
          if (jdField_a_of_type_JavaUtilHashMap.containsKey(Integer.valueOf(k)))
          {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      bbdx.a(((File)localObject2).getAbsolutePath(), localSubCmd0x13Rsp.toByteArray(), false);
      try
      {
  ...
  public List<EmosmPb.SmallYellowItem> b()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      localObject3 = bbdx.a((File)localObject3);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((k >= 0) && (k < ayjy.jdField_a_of_type_Int)) {
          break label776;
        }
