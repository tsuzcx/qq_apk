...
public class awai
{
  ...
  {
    switch (awaj.a[paramStatus.ordinal()])
    {
    default: 
  ...
  public static String a(AppRuntime.Status paramStatus)
  {
    if (paramStatus != null)
    {
      ...
      default: 
        ...
        return "";
      case 1: 
        return BaseApplicationImpl.getContext().getString(2131720302);
      case 2: 
        return BaseApplicationImpl.getContext().getString(2131720303);
      case 3: 
        return BaseApplicationImpl.getContext().getString(2131720286);
      case 4: 
        return BaseApplicationImpl.getContext().getString(2131720289);
      case 5: 
        return BaseApplicationImpl.getContext().getString(2131720295);
      }
