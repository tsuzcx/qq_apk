...
public class blvv
{
  ...
  private static Bundle a(@Nullable Bundle paramBundle)
  {
    ...
    if (!localBundle.containsKey("VIDEO_STORY_FROM_TYPE")) {
      localBundle.putInt("VIDEO_STORY_FROM_TYPE", blvr.x.a());
    }
    localBundle.putInt("VIDEO_STORY_JUMP_TO_TYPE", 1);
    Object localObject = localBundle.getString("qq_camera_from_qcircle_scheme");
    bmbx.d("AECameraLauncher", "[setDataForCircleAECamera] scheme:" + (String)localObject);
    ...
    if (!TextUtils.isEmpty((CharSequence)localObject))
    {
      ...
      if (localObject != null)
      {
        ...
        localBundle = bnxs.a(localBundle, ((Uri)localObject).getQueryParameter("widgetinfo"));
  ...
  public static void a(Activity paramActivity, int paramInt1, int paramInt2, autb paramautb)
  {
    if (b()) {
      return;
    }
    ...
    if (paramautb != null)
    {
      localBundle.putBoolean("key_camera_prefer_id", paramautb.jdField_a_of_type_Boolean);
      localBundle.putBoolean("key_has_countdown", paramautb.b);
      localBundle.putBoolean("key_disable_face_detect", paramautb.d);
      localBundle.putBoolean("key_need_check_sensitive", paramautb.c);
      localBundle.putString("key_guide_image", paramautb.jdField_a_of_type_JavaLangString);
    }
    QIMCameraCaptureActivity.a(paramActivity, localBundle, paramInt1);
    paramActivity.overridePendingTransition(2130772240, 2130772041);
  }
  ...
  public static void a(Activity paramActivity, int paramInt, Bundle paramBundle)
  {
    ...
    bmau.a().a("AECameraLauncher---launchAECameraUnit-begin");
    ynm localynm = ynm.a();
    Bundle localBundle = paramBundle;
    if (paramBundle == null) {
      localBundle = new Bundle();
    ...
    babb.a();
    localynm.a(paramActivity, localBundle, 20000);
    paramActivity.overridePendingTransition(2130772240, 2130772041);
    xwa.a("video_shoot", "clk_shoot", 0, 0, new String[0]);
    bmau.a().a("AECameraLauncher---launchAECameraUnit-end");
    bmau.a().a(false);
    bmau.a().e();
  }
  ...
  private static boolean a(boolean paramBoolean)
  {
    ...
    {
      bmbx.d("AECameraLauncher", "[isResReady] isCheckAVCodec soIsExist:" + paramBoolean);
      bool2 = paramBoolean;
      if (bool2) {
        break label103;
      }
  ...
  public static void b(Context paramContext, @Nullable Bundle paramBundle)
  {
    ...
    ynm localynm = ynm.a();
    a(paramBundle);
    localynm.a((Activity)paramContext, paramBundle, 20000);
  ...
  private static boolean b(Bundle paramBundle)
  {
    boolean bool2 = false;
    boolean bool1;
    if (((babb.a()) || (paramBundle.getInt("VIDEO_STORY_JUMP_TO_TYPE", 0) == 0)) && ((paramBundle.getInt("AECAMERA_MODE") != 202) || (!apju.d())))
    {
      bool1 = bool2;
  ...
  public static void c(Context paramContext, @Nullable Bundle paramBundle)
  {
    ...
    bmbz.a(paramContext, new Intent().putExtras(paramBundle));
  }
}
