  ...
  implements rdq
{
  ...
  public rdp(Context paramContext, String paramString)
  {
  ...
  public List<String> a()
  {
    try
    {
      localList = rdz.a(this.jdField_a_of_type_AndroidContentResAssetManager, this.jdField_a_of_type_JavaLangString);
      if (localList == null) {
        break label28;
      }
    }
