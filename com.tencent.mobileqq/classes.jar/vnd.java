...
import com.tencent.biz.pubaccount.weishi_new.util.WeishiUtils.6;
...
public class vnd
{
  ...
  private static Bitmap a(URL paramURL, ImageView paramImageView)
  {
    if ((paramURL != null) && (paramImageView.getWidth() > 0))
    {
      ...
      localtlw.jdField_a_of_type_JavaNetURL = paramURL;
      localtlw.jdField_a_of_type_Int = paramImageView.getWidth();
      localtlw.jdField_b_of_type_Int = paramImageView.getHeight();
      paramURL = bhdb.a(localtlw.a());
      if (paramURL != null) {
        return paramURL.a();
      }
    }
  ...
  {
    Object localObject = a();
    if (a((pws)localObject))
    {
      localObject = ((pws)localObject).a();
      vmp.d("WSPushLog", "WSRedDotPushMsg = " + (String)localObject);
  ...
  public static String a(stSimpleMetaFeed paramstSimpleMetaFeed, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      vmp.b("WeishiUtils", "使用webp图片资源：" + (String)localObject1);
    ...
    {
      vmp.b("WeishiUtils", "使用服务器默认的图片格式资源：" + (String)localObject3);
  ...
  public static pws a()
  {
    ...
    {
      localObject = (QQAppInterface)localObject;
      if ((((QQAppInterface)localObject).getManager(QQManagerFactory.WEISHI_MANAGER) instanceof pws)) {
        return (pws)((QQAppInterface)localObject).getManager(QQManagerFactory.WEISHI_MANAGER);
      }
    }
    return null;
  }
  ...
  public static void a()
  {
    ...
    if (localpws != null)
    {
      ...
      localstSimpleMetaFeed.id = localpws.c();
      localstSimpleMetaFeed.feed_desc = localpws.d();
  ...
  public static void a(Context paramContext, KandianUrlImageView paramKandianUrlImageView, URL paramURL, Drawable paramDrawable, String paramString)
  {
    ...
    if (paramDrawable == null) {
      localObject = paramContext.getResources().getDrawable(2130841740);
    }
    if (paramURL == null)
    {
    ...
    paramKandianUrlImageView.setPublicAccountImageDownListener(new vne(paramString, paramKandianUrlImageView));
  }
  
  public static void a(Context paramContext, RoundImageView paramRoundImageView, String paramString)
  {
    vmp.b("AvatarImageLog", "WeishiUtils loadAvatarImage url:" + paramString + ", imageView:" + paramRoundImageView);
    if ((paramContext != null) && (paramRoundImageView != null))
    {
      paramContext = paramContext.getResources().getDrawable(2130840348);
      Observable.just(paramString).map(new vni(paramString, paramContext)).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new vnf(paramRoundImageView, paramString), new vnh(paramRoundImageView, paramContext));
    }
  }
  
  public static void a(Context paramContext, String paramString1, String paramString2, String paramString3, int paramInt, vnn paramvnn)
  {
    if (paramvnn == null) {
    ...
    if (zfn.a(paramContext))
    {
      ...
      {
        vmp.c("815", "走打开shemeUrl:" + paramString1);
        paramvnn.a(paramString1, paramInt);
        return;
      }
      if (!TextUtils.isEmpty(paramString3))
      {
        vmp.c("833", "走打开小程序:" + paramString3);
        paramvnn.d(paramString3, paramInt);
        return;
      }
      if (!TextUtils.isEmpty(paramString2))
      {
        vmp.c("815", "走打开h5Url:" + paramString2);
        paramvnn.b(paramString2, paramInt);
        return;
      }
      vmp.c("815", "走打开兜底:" + paramString1);
      paramvnn.a("weishi://main", paramInt);
      return;
    }
    if (!TextUtils.isEmpty(paramString3))
    {
    ...
    if (!TextUtils.isEmpty(paramString2))
    {
      vmp.c("815", "走跳转h5Url:" + paramString2);
      paramvnn.b(paramString2, paramInt);
      return;
    }
    vmp.c("815", "走下载，shemeUrl:" + paramString1);
    paramvnn.c(paramString1, paramInt);
  }
  ...
  public static void a(Context paramContext, ArrayList<stSimpleMetaFeed> paramArrayList, int paramInt1, String paramString, stGlobalConfig paramstGlobalConfig, WSRedDotPushMsg paramWSRedDotPushMsg, int paramInt2)
  {
    ...
    try
    {
      ...
      if (paramArrayList != null)
      {
        ...
        if (paramArrayList.size() > 0)
        {
          ...
          paramString = vkc.a().a(paramArrayList.traceId);
        }
      }
      ...
      uyu.jdField_a_of_type_Boolean = true;
    ...
    catch (NumberFormatException paramString)
    {
      for (;;)
      {
        vmp.b("openVerticalVideoLayerPage parseLong posterId : " + paramString);
      }
    }
  }
  ...
  public static void a(View paramView, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      if (paramInt1 == 0)
      {
        ...
        localAlphaAnimation.setAnimationListener(new vnl(paramView));
    ...
    localAlphaAnimation.setDuration(paramInt2);
    localAlphaAnimation.setFillAfter(true);
    localAlphaAnimation.setAnimationListener(new vnm(paramView));
    paramView.clearAnimation();
    paramView.startAnimation(localAlphaAnimation);
  }
  ...
  public static void a(ImageView paramImageView, String paramString1, Drawable paramDrawable1, Drawable paramDrawable2, String paramString2)
  {
    ...
    paramImageView.setImageDrawable(paramDrawable1);
    paramDrawable1.setURLDrawableListener(new vnj(paramString2, paramImageView, paramString1));
  ...
  public static void a(KandianUrlImageView paramKandianUrlImageView, String paramString)
  {
    if ((paramKandianUrlImageView != null) && (!TextUtils.isEmpty(paramString)))
    {
      ...
      paramKandianUrlImageView.setImagePlaceHolder(BaseApplicationImpl.getApplication().getApplicationContext().getResources().getDrawable(2130841843)).setImage(paramString);
    }
  }
  ...
  public static void a(BusinessInfoCheckUpdate.AppInfo paramAppInfo, boolean paramBoolean)
  {
    ...
    {
      vmp.b("WSRedDotLog", "saveRedDotAppInfo appInfo = " + paramAppInfo.iNewFlag.get());
      vmp.b("WSRedDotLog", "saveRedDotAppInfo hasWsRedDot = " + paramBoolean);
  ...
  public static void a(String paramString)
  {
    paramString = a(paramString);
    tlw localtlw = new tlw();
    localtlw.jdField_a_of_type_JavaNetURL = paramString;
    localtlw.jdField_b_of_type_Boolean = true;
    tlv.a().a(localtlw, new vnk());
  }
  ...
  public static void a(List<stSimpleMetaFeed> paramList, boolean paramBoolean)
  {
    ...
    vmp.b("PreloadCoverImgLog", "preloadImg size = " + paramList.size());
    ThreadManager.post(new WeishiUtils.6(new ArrayList(paramList), paramBoolean), 5, null, true);
  }
  ...
  private static boolean a(MessageForStructing paramMessageForStructing)
  {
    ...
    {
      return false;
      vmp.d("WSPushLog", "isMsgFromWeishiPush structMsg.frienduin: " + paramMessageForStructing.frienduin);
    } while ((!TextUtils.equals(AppConstants.WEISHI_UIN, paramMessageForStructing.frienduin)) || (paramMessageForStructing.issend != 0));
    return true;
  }
  
  public static boolean a(pws parampws)
  {
    if (parampws == null) {
      return false;
    }
  ...
  {
    return paramString + "&idx=" + vau.a().e();
  }
  ...
  public static void b(String paramString)
  {
    ...
    if ((localClipboardManager != null) && (!TextUtils.isEmpty(paramString)))
    {
      ...
      vmp.d("WeishiUtils", "Clipboard copyScheme: " + paramString + ", clip: " + localClipData);
  ...
  public static boolean b()
  {
    ...
    {
      vmp.f("WeishiUtils", "click too fast");
  ...
  {
    vay localvay = vay.a();
    if ((localvay == null) || (localvay.a == null)) {
      return false;
    }
    return localvay.a.jdField_a_of_type_Boolean;
  }
  ...
  public static void d(String paramString)
  {
    ...
    {
      vki.b = "";
      vki.jdField_a_of_type_JavaLangString = "";
      LocalMultiProcConfig.putString("weishi_usergrowth", "key_ref_page_id", "");
      return;
    }
    vki.b = vki.jdField_a_of_type_JavaLangString;
    LocalMultiProcConfig.putString("weishi_usergrowth", "key_ref_page_id", vki.b);
    vki.jdField_a_of_type_JavaLangString = paramString;
  }
  ...
  public static String e()
  {
    ...
    {
      vmp.d("WeishiUtils", "getWifiBssid : " + localException.toString());
    }
    return "";
  }
  ...
  public static String f()
  {
    ...
    vmp.f("WeishiUtils", "[qq_connect_person_id]" + str);
    return str;
  }
}
