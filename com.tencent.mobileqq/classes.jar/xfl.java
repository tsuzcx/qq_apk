...
public class xfl
{
  ...
  {
    ykq.b("Q.qqstory.playernew.AnimationUtils", "doExitAnimation");
    View localView = paramViewGroup.findViewById(2131376947);
    ImageView localImageView2 = (ImageView)paramViewGroup.findViewById(2131362708);
    ViewGroup localViewGroup = (ViewGroup)paramViewGroup.findViewById(2131381122);
    ...
    paramViewGroup.addUpdateListener(new xfm(localViewGroup, localDrawable, localImageView1, localImageView2));
    paramViewGroup.addListener(new xfn(paramAnimatorListener));
  ...
  {
    ykq.b("Q.qqstory.playernew.AnimationUtils", "doEnterAnimation");
    Object localObject = paramViewGroup.findViewById(2131376947);
    ImageView localImageView = (ImageView)paramViewGroup.findViewById(2131362708);
    ViewGroup localViewGroup = (ViewGroup)paramViewGroup.findViewById(2131381122);
    ...
    ((ValueAnimator)localObject).addUpdateListener(new xfo(localViewGroup, paramViewGroup, localImageView));
    ((ValueAnimator)localObject).addListener(new xfp(paramAnimatorListener, localViewGroup, paramViewGroup));
