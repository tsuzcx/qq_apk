  ...
  extends bdnv
{
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (((Iterator)localObject2).hasNext())
    {
      ...
      if (!"live".equals(localbdnu.a)) {
        break label255;
      }
      paramBundle = (bdpd)localbdnu;
    }
    label247:
    label255:
    for (;;)
    {
      ...
      if (paramView != null)
      {
        paramContext = (bdql)paramView.getTag();
        localObject2 = null;
        ...
        paramView = new bdql();
        paramView.jdField_a_of_type_Bdpd = paramBundle;
        paramView.jdField_a_of_type_ComTencentBizNowNowVideoLayout = paramContext;
      }
      for (;;)
      {
        ((View)localObject1).setTag(paramView);
        paramView = ((View)localObject1).findViewById(2131378155);
        if (paramView != null) {
        ...
        paramContext = (NowVideoLayout)((View)localObject2).findViewById(2131378155);
        paramContext.a();
