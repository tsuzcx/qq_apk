  ...
  implements bcpk
{
  ...
  public bcow(bcot parambcot, WheelPickerLayout paramWheelPickerLayout)
  {
    ...
    if (i >= bcot.a(parambcot))
    {
      paramWheelPickerLayout.add(5, 1);
      paramWheelPickerLayout.set(11, bcot.b(parambcot));
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        paramWheelPickerLayout.add(12, bcot.c(parambcot) - i % bcot.c(parambcot));
      }
    }
  }
  ...
  private String b(int paramInt)
  {
    ...
    default: 
      return "";
    case 1: 
      return alpo.a(2131716079);
    case 2: 
      return alpo.a(2131716092);
    case 3: 
      return alpo.a(2131716083);
    case 4: 
      return alpo.a(2131716077);
    case 5: 
      return alpo.a(2131716075);
    case 6: 
      return alpo.a(2131716091);
    }
    return alpo.a(2131716093);
  }
  ...
  public int a(int paramInt)
  {
    ...
    default: 
      return 0;
    case 0: 
      return bcot.d(this.jdField_a_of_type_Bcot);
    case 1: 
      paramInt = a(new int[] { this.jdField_a_of_type_ComTencentMobileqqTroopWidgetWheelPickerLayout.a(0) }).get(11);
      return bcot.a(this.jdField_a_of_type_Bcot) - paramInt + 1;
    }
    return (60 - a(new int[] { this.jdField_a_of_type_ComTencentMobileqqTroopWidgetWheelPickerLayout.a(0), this.jdField_a_of_type_ComTencentMobileqqTroopWidgetWheelPickerLayout.a(1) }).get(12)) / bcot.c(this.jdField_a_of_type_Bcot);
  }
  ...
  public int a(Calendar paramCalendar, int paramInt1, int paramInt2)
  {
    ...
    paramInt1 = (int)((paramCalendar.get(12) - l) / bcot.c(this.jdField_a_of_type_Bcot));
    if (paramInt1 > 0) {
      return paramInt1;
    }
    return 0;
  ...
  public Calendar a(int... paramVarArgs)
  {
    ...
    if (paramVarArgs[0] > 0)
    {
      ...
      localCalendar.set(11, bcot.b(this.jdField_a_of_type_Bcot));
    ...
    if (paramVarArgs.length > 2) {
      localCalendar.add(12, paramVarArgs[2] * bcot.c(this.jdField_a_of_type_Bcot));
    }
  ...
  public int[] a(long paramLong)
  {
    ...
    arrayOfInt[2] = ((localCalendar1.get(12) - localCalendar2.get(12)) / bcot.c(this.jdField_a_of_type_Bcot));
    return arrayOfInt;
  }
}
