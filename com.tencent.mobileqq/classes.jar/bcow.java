  ...
  implements View.OnClickListener
{
  ...
  public bcow(Context paramContext)
  {
  ...
  private void b(String paramString)
  {
    ...
    aflm.a(this.jdField_a_of_type_AndroidContentContext, localIntent, paramString);
  }
  ...
  void a(View paramView)
  {
    if (paramView != null)
    {
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368385));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131363488));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131371808));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131365546));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370710));
      this.jdField_a_of_type_ArrayOfAndroidWidgetTextView[0] = ((TextView)paramView.findViewById(2131364130));
      this.jdField_a_of_type_ArrayOfAndroidWidgetTextView[1] = ((TextView)paramView.findViewById(2131364131));
      this.jdField_a_of_type_ArrayOfAndroidWidgetTextView[2] = ((TextView)paramView.findViewById(2131364132));
      this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131363489);
      this.jdField_a_of_type_ArrayOfAndroidViewView[0] = paramView.findViewById(2131363670);
      this.jdField_a_of_type_ArrayOfAndroidViewView[1] = paramView.findViewById(2131363672);
      this.jdField_a_of_type_ArrayOfAndroidViewView[2] = paramView.findViewById(2131363671);
      this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131364133);
      if ((this.jdField_a_of_type_AndroidWidgetImageView instanceof ThemeImageView)) {
        ((ThemeImageView)this.jdField_a_of_type_AndroidWidgetImageView).setMaskShape(blfw.jdField_c_of_type_Int);
      }
      if ((this.jdField_b_of_type_AndroidWidgetImageView instanceof ThemeImageView)) {
        ((ThemeImageView)this.jdField_b_of_type_AndroidWidgetImageView).setMaskShape(blfw.jdField_c_of_type_Int);
      }
      this.jdField_b_of_type_AndroidWidgetImageView.getViewTreeObserver().addOnGlobalLayoutListener(new bcox(this));
      paramView.setOnClickListener(new bcoy(this));
    }
  }
  ...
  void b()
  {
    ...
    if (this.jdField_b_of_type_JavaLangString != null)
    {
      ...
      this.jdField_a_of_type_ArrayOfAndroidViewView[i].setBackgroundColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166961));
    }
    for (;;)
    {
      i += 1;
    ...
    label363:
    this.jdField_b_of_type_AndroidViewView.setOnClickListener(new bcoz(this));
  }
  ...
  public void onClick(View paramView)
  {
    ...
    default: 
      ...
      {
        bcjs.a(null, this.jdField_c_of_type_Int, 0, "0X8009D2D", this.jdField_b_of_type_Int, i, this.g);
        label81:
        if (str != null)
        {
          if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      i = 3;
      break;
      bcjs.a(null, this.jdField_c_of_type_Int, 0, "0X8009D41", this.jdField_b_of_type_Int, i, this.g);
      break label81;
      label210:
      bheh localbheh = bhey.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), this.jdField_a_of_type_AndroidContentContext, str);
      if (localbheh != null)
      {
        localbheh.a();
      }
