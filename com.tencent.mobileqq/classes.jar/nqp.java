  ...
  implements View.OnClickListener
{
  ...
  private nqt jdField_a_of_type_Nqt;
  ...
  private nqt jdField_b_of_type_Nqt;
  ...
  public nqp(VafContext paramVafContext)
  {
  ...
  {
    this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)paramContext.getSystemService("layout_inflater")).inflate(2131496701, null);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131312933));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131302248));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131302247));
    this.jdField_b_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131302358));
    this.jdField_c_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131302359));
    this.jdField_d_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131302360));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131296439));
    this.jdField_e_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131301508));
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131301505));
    this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131312920));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131296439));
    this.jdField_f_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131301503));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131301506));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131301512));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131301504));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131296507));
    this.jdField_f_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131296504));
    this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131303469));
    this.jdField_b_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131309554));
    this.jdField_c_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131303434));
    this.jdField_d_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131309515));
    this.jdField_e_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131301510));
    this.jdField_f_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131301514));
    this.jdField_g_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131301509));
    this.jdField_h_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131301513));
    ...
    this.jdField_a_of_type_AndroidViewView.setOnClickListener(new nqq(this));
  }
  ...
  private void a(RelativeLayout.LayoutParams paramLayoutParams, float paramFloat1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, float paramFloat2)
  {
    ...
    float f1 = this.jdField_a_of_type_Nqt.jdField_a_of_type_Int - paramInt5 * paramFloat1;
    ...
    this.jdField_e_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView.setScaleX(this.jdField_a_of_type_Nqt.jdField_a_of_type_Float + paramFloat2 * paramFloat1);
    this.jdField_e_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView.setScaleY(this.jdField_a_of_type_Nqt.jdField_a_of_type_Float + paramFloat2 * paramFloat1);
  ...
  private void a(JSONObject paramJSONObject)
  {
    ...
    paramJSONObject = new nqt();
    paramJSONObject.jdField_a_of_type_Float = (m / 100.0F);
    paramJSONObject.jdField_a_of_type_Int = i1;
    paramJSONObject.jdField_b_of_type_Int = aciy.a(i3 / 2, this.jdField_a_of_type_AndroidContentContext.getResources());
    paramJSONObject.jdField_c_of_type_Int = aciy.a(i4 / 2, this.jdField_a_of_type_AndroidContentContext.getResources());
    localObject = new nqt();
    ((nqt)localObject).jdField_a_of_type_Float = (n / 100.0F);
    ((nqt)localObject).jdField_a_of_type_Int = i2;
    ((nqt)localObject).jdField_b_of_type_Int = aciy.a(i5 / 2, this.jdField_a_of_type_AndroidContentContext.getResources());
    ((nqt)localObject).jdField_c_of_type_Int = aciy.a(i6 / 2, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.jdField_a_of_type_Nqt = paramJSONObject;
    this.jdField_b_of_type_Nqt = ((nqt)localObject);
  }
  ...
  {
    if ((this.jdField_a_of_type_Nqt == null) || (this.jdField_b_of_type_Nqt == null) || (this.jdField_c_of_type_Boolean)) {
      return;
    }
    ...
    int i1 = a(this.k, this.jdField_b_of_type_Nqt.jdField_b_of_type_Int, this.jdField_d_of_type_Int);
    int i2 = a(this.j, this.jdField_b_of_type_Nqt.jdField_c_of_type_Int, this.jdField_e_of_type_Int);
    i1 -= m;
    i2 -= n;
    int i3 = -this.jdField_b_of_type_Nqt.jdField_a_of_type_Int + this.jdField_a_of_type_Nqt.jdField_a_of_type_Int;
    float f1 = this.jdField_b_of_type_Nqt.jdField_a_of_type_Float - this.jdField_a_of_type_Nqt.jdField_a_of_type_Float;
    if (paramBoolean)
    {
      a(localLayoutParams2, 1.0F, m, n, i1, i2, i3, f1);
      a(localLayoutParams1, 1.0F, this.jdField_c_of_type_Int);
      a(this.jdField_b_of_type_AndroidWidgetTextView, 1.0F, 0.2F, 1.7F, aciy.a(34.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      a(this.jdField_c_of_type_AndroidWidgetTextView, 1.0F, 0.2F, 2.0F, aciy.a(34.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      a(this.jdField_d_of_type_AndroidWidgetTextView, 1.0F, 0.2F, 2.0F, aciy.a(34.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      return;
    }
    this.jdField_a_of_type_AndroidAnimationValueAnimator = ValueAnimator.ofFloat(new float[] { 0.0F, 1.0F });
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new nqr(this, localLayoutParams2, m, n, i1, i2, i3, f1, localLayoutParams1));
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new nqs(this));
  ...
  private void c()
  {
    this.jdField_c_of_type_Int = aciy.a(84.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.jdField_e_of_type_Int = aciy.a(60.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.jdField_f_of_type_Int = aciy.a(60.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.jdField_d_of_type_Int = aciy.a(60.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.jdField_a_of_type_Int = aciy.a(52.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.jdField_b_of_type_Int = aciy.a(135.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
  }
  ...
  private void e()
  {
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.getLayoutParams().height = aciy.a(128.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.jdField_b_of_type_Int = aciy.a(128.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.jdField_d_of_type_AndroidWidgetTextView.setTextColor(Color.parseColor("#40A0FF"));
    int m = aciy.a(4.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
  ...
  private void f()
  {
    ...
    localLayoutParams.leftMargin = a(this.i, this.jdField_a_of_type_Nqt.jdField_b_of_type_Int, this.jdField_d_of_type_Int);
    localLayoutParams.topMargin = a(this.jdField_h_of_type_Int, this.jdField_a_of_type_Nqt.jdField_c_of_type_Int, this.jdField_e_of_type_Int);
    ...
    this.jdField_e_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView.setRotation(this.jdField_a_of_type_Nqt.jdField_a_of_type_Int);
    this.jdField_e_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView.setScaleX(this.jdField_a_of_type_Nqt.jdField_a_of_type_Float);
    this.jdField_e_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView.setScaleY(this.jdField_a_of_type_Nqt.jdField_a_of_type_Float);
  ...
  protected void a()
  {
    ...
    for (;;)
    {
      ...
      ((URLDrawable.URLDrawableOptions)localObject1).mRequestWidth = aciy.a(28.0F, this.jdField_a_of_type_AndroidViewView.getResources());
      ((URLDrawable.URLDrawableOptions)localObject1).mRequestHeight = aciy.a(28.0F, this.jdField_a_of_type_AndroidViewView.getResources());
      ...
      ((URLDrawable)localObject3).setTag(azue.b(((URLDrawable.URLDrawableOptions)localObject1).mRequestWidth, ((URLDrawable.URLDrawableOptions)localObject1).mRequestHeight, aciy.a(25.0F, this.jdField_a_of_type_AndroidViewView.getResources())));
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      npj.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo, m, null);
      rvb.a((Activity)this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo, this.jdField_a_of_type_Opw.a(), this.jdField_a_of_type_Opw.e(), false, npi.b(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo), paramView);
      return;
      m = 2;
      continue;
      m = 3;
  ...
  public void onComMeasure(int paramInt1, int paramInt2)
  {
    ...
    if ((!this.jdField_a_of_type_Boolean) && (!this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.isShowBrandAnimate) && (this.jdField_a_of_type_Nqt != null) && (this.jdField_b_of_type_Nqt != null))
    {
      this.jdField_g_of_type_Int = this.jdField_a_of_type_AndroidWidgetTextView.getMeasuredHeight();
      this.jdField_h_of_type_Int = (this.jdField_a_of_type_Int + this.jdField_g_of_type_Int + aciy.a(8.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      this.i = 0;
      this.j = (this.jdField_a_of_type_Int + this.jdField_g_of_type_Int + this.jdField_b_of_type_Int + aciy.a(12.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      this.k = aciy.a(12.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      f();
    }
  }
