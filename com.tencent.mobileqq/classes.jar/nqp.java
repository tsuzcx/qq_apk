...
{
  nqp(QQAppInterface paramQQAppInterface, nyl paramnyl, int paramInt, String paramString) {}
      ...
      try
      {
        ...
        if (paramBundle != null)
        {
          ...
          if (((mobileqq_mp.RetInfo)((mobileqq_mp.SetFunctionFlagResponse)localObject).ret_info.get()).ret_code.get() == 0)
          {
            ...
            if (localObject != null) {
              paramBundle = ((anrs)localObject).a(this.jdField_a_of_type_JavaLangString);
            }
            if (paramBundle != null)
            {
              if (this.jdField_a_of_type_Nyl.e == 6)
              {
                ...
                localPublicAccountHandler.notifyUI(109, true, this.jdField_a_of_type_Nyl);
                return;
              }
              if (this.jdField_a_of_type_Nyl.e != 3) {
                continue;
              }
              paramBundle.isSyncLbs = true;
              if (this.jdField_a_of_type_Nyl.d != 1) {
                break label315;
              }
              paramBoolean = true;
          ...
          {
            localPublicAccountHandler.notifyUI(109, false, this.jdField_a_of_type_Nyl);
          }
        }
        else
        {
