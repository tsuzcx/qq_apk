...
public class brci
  extends MqqHandler
{
  public brci(ShortVideoPlayActivity paramShortVideoPlayActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
          QQToast.a(this.a, 2131718205, 0).a();
          return;
          String str = this.a.getString(2131718206);
          paramMessage = (String)paramMessage.obj;
          QQToast.a(this.a.jdField_a_of_type_AndroidContentContext, 2, str + paramMessage, 0).a();
          bhmq.a(this.a, paramMessage);
          return;
          paramMessage = bhlq.a(this.a.jdField_a_of_type_AndroidContentContext, 232, this.a.jdField_a_of_type_AndroidContentContext.getResources().getString(2131718237), this.a.jdField_a_of_type_AndroidContentContext.getResources().getString(2131718236), 2131718220, 2131717445, new brcj(this), new brck(this));
