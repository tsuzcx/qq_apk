  ...
  implements amuk, amwd, Handler.Callback, View.OnKeyListener
{
  ...
  private anbv jdField_b_of_type_Anbv;
  ...
  public ande(int paramInt)
  {
    ...
    if (localandn != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel = localandn.a();
    ...
    this.jdField_a_of_type_Ands = new ands(paramInt);
    this.jdField_e_of_type_Int = paramInt;
    andx.a();
    this.jdField_a_of_type_Anee = new anee(paramInt);
    this.jdField_a_of_type_Anbg = new anbg(paramInt);
  }
  ...
  private void c(CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Andi.g = localJSONObject.optString("payParam");
      ...
      this.jdField_a_of_type_Andi.jdField_a_of_type_Int = localJSONObject.optInt("score", -1);
      this.jdField_a_of_type_Andi.jdField_c_of_type_JavaLangString = localJSONObject.optString("baseUrl");
      this.jdField_a_of_type_Andi.b = localJSONObject.optString("listId");
      this.jdField_a_of_type_Andi.jdField_c_of_type_Int = this.jdField_e_of_type_Int;
      if (anbd.a() != null) {
        this.jdField_a_of_type_Andi.jdField_a_of_type_Long = Long.parseLong(anbd.a().getCurrentAccountUin());
      }
      this.jdField_a_of_type_Andi.e = localJSONObject.optString("nickName", String.valueOf(this.jdField_a_of_type_Andi.jdField_a_of_type_Long));
      if (QLog.isColorLevel()) {
        QLog.d("cmgame_process.CmGameLauncher", 1, "[setRedPacketInfo] " + this.jdField_a_of_type_Andi.toString());
      }
      return;
    }
  ...
  private void n()
  {
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      anbd.a(new Object[] { "[startGameEngine], game is not ready, so status:", Boolean.valueOf(this.k) });
    }
    for (;;)
    {
      return;
      Object localObject1;
      if ((this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameInitParams == null) || (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameInitParams.mGamePath)) || (!bhmi.a(this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameInitParams.mGamePath)))
      {
        if (QLog.isColorLevel()) {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null)
      {
        ...
        this.i = true;
        this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.callbackFromRequest(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView.getLuaState(), 0, "sc.init_global_var.local", anbd.b(this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameInitParams));
      ...
      {
        if (b()) {
          anbd.a().callbackFromRequest(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView.getLuaState(), 0, "cs.xy_life_cycle_event_activity.local", "{}");
        }
        for (;;)
        {
          o();
          ...
          anbd.a(new Object[] { "[startGameEngine] cost:", Long.valueOf(l) });
          if (l <= 0L) {
            break;
          }
          ...
          bdmc.a(((AppInterface)localObject2).getApp()).a(((AppInterface)localObject2).getCurrentAccountUin(), "cmgame_open_to_start_engine", true, l, 0L, (HashMap)localObject1, "", false);
          return;
          label516:
          localObject1 = String.valueOf(amzf.a(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.extendJson));
          break label241;
          anbd.a().callbackFromRequest(a(), 0, "cs.xy_life_cycle_event_activity.local", "{}");
        }
      }
  ...
  public adnb a(long paramLong, Activity paramActivity)
  {
    if (this.jdField_a_of_type_Adnb != null) {
      return this.jdField_a_of_type_Adnb;
    }
    adng.a();
    this.jdField_a_of_type_Adnb = adng.a(paramActivity, 5, String.valueOf(paramLong));
  ...
  public anbg a()
  {
    return this.jdField_a_of_type_Anbg;
  }
  ...
  public ands a()
  {
    return this.jdField_a_of_type_Ands;
  }
  
  public andw a()
  {
    if ((this.jdField_a_of_type_Andw == null) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameInitParams != null)) {
      this.jdField_a_of_type_Andw = new andw(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView, this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameInitParams, (Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get());
    }
    return this.jdField_a_of_type_Andw;
  }
  
  public anee a()
  {
    return this.jdField_a_of_type_Anee;
  }
  
  public anex a()
  {
    return this.jdField_a_of_type_Anex;
  }
  ...
  public ansi a()
  {
    return this.jdField_a_of_type_Ansi;
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null))
        {
          ...
          localObject = new andz();
          ((andz)localObject).jdField_e_of_type_Int = paramInt1;
          ((andz)localObject).jdField_a_of_type_Long = System.currentTimeMillis();
          ((andz)localObject).jdField_a_of_type_Int = this.jdField_e_of_type_Int;
          ((andz)localObject).d = paramInt2;
          ((andz)localObject).jdField_c_of_type_Int = paramInt3;
          ((andz)localObject).jdField_a_of_type_JavaLangString = paramString;
          ((andz)localObject).jdField_b_of_type_Int = this.jdField_b_of_type_Int;
          if (QLog.isColorLevel()) {
          ...
          andx.a().a((andz)localObject);
        }
        if ((this.jdField_a_of_type_Anda == null) || (!this.jdField_a_of_type_Anda.a())) {
          break label430;
        }
        paramInt3 = 1;
      }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localApolloFloatActivity.a != null)
        {
          ...
          paramString = "window.mqq && mqq.execEventCallback && mqq.execEventCallback(" + noe.a("apolloGameWebMessage") + "," + String.valueOf(paramString) + "," + String.valueOf("") + ");";
  ...
  public void a(int paramInt, String paramString1, String paramString2)
  {
    if (this.jdField_a_of_type_Amzm != null) {
      this.jdField_a_of_type_Amzm.a(paramInt, paramString1, paramString2);
    }
  }
  ...
  public void a(amzm paramamzm)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel != null) {
      this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.addRenderRunner(paramamzm);
    }
  }
  ...
  public void a(Activity paramActivity)
  {
    ...
    if (this.jdField_a_of_type_Anee != null) {
      this.jdField_a_of_type_Anee.a(paramActivity);
    }
    this.jdField_a_of_type_Anda = new anda(a(), anbd.a());
    this.jdField_a_of_type_Anda.a(null, this.jdField_e_of_type_Int);
  }
  ...
  public void a(Activity paramActivity, CmGameInitParams paramCmGameInitParams)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
      this.jdField_a_of_type_Blhq.sendEmptyMessage(204);
  ...
  public void a(Activity paramActivity, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        if (!anpq.a())
        {
          ...
          anpq.a(this.jdField_a_of_type_Anps);
          anpq.a("CmGameLauncher");
          return;
        }
        anpq.b(this.jdField_a_of_type_Anps);
        a(paramActivity);
        a(paramActivity);
        this.jdField_a_of_type_Anop = new anop(this.jdField_e_of_type_Int);
        if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null) {
          break label562;
        }
        if (this.jdField_a_of_type_JavaLangRefWeakReference != null) {
      ...
      if (this.jdField_a_of_type_Anex == null) {
        this.jdField_a_of_type_Anex = new anex((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), this.jdField_e_of_type_Int);
      }
    ...
    {
      QLog.e("cmgame_process.CmGameLauncher", 1, localThrowable, new Object[0]);
      bool2 = anbd.a(this.jdField_e_of_type_Int);
      if (!bool2) {}
    }
    label562:
    label755:
      ...
      for (;;)
      {
        try
        {
          if ((paramActivity instanceof ApolloGameActivity))
          {
            ...
            if (this.jdField_a_of_type_Ancn != null) {
              this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.removeCmdHandler(this.jdField_a_of_type_Ancn);
            }
            if (this.jdField_a_of_type_Anbz != null) {
              this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.removeCmdHandler(this.jdField_a_of_type_Anbz);
            }
            this.jdField_a_of_type_Ancn = new ancn(this.jdField_e_of_type_Int, paramActivity);
            this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.addCmdHandler(this.jdField_a_of_type_Ancn);
            this.jdField_a_of_type_Anbz = new anbz(this.jdField_e_of_type_Int);
            this.jdField_a_of_type_Ancl = new ancl(this);
            this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.addCmdHandler(this.jdField_a_of_type_Anbz);
            this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.addCmdHandler(this.jdField_a_of_type_Ancl);
  ...
  public void a(Bitmap paramBitmap)
  {
    if (this.jdField_a_of_type_Anda != null) {
      this.jdField_a_of_type_Anda.a(paramBitmap, this.jdField_e_of_type_Int);
    }
    if (QLog.isColorLevel()) {
  ...
  public void a(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        b(paramBundle);
        anbd.a(new Object[] { "[checkFinish], loading from main process and tool process is on, before cost:", Long.valueOf(l1) });
  ...
  public void a(anfd paramanfd)
  {
    ...
    do
    {
      return;
      localanfj = a();
    } while (localanfj == null);
    localanfj.a(paramanfd);
  }
  ...
  public void b(int paramInt)
  {
    if (this.jdField_a_of_type_Anbv == null)
    {
      ...
      this.jdField_a_of_type_Anbv = new anbh(anbd.a(), this.jdField_e_of_type_Int);
    }
    for (;;)
    {
      if (this.jdField_b_of_type_Anbv == null) {
        this.jdField_b_of_type_Anbv = new anbk(this.jdField_a_of_type_Ancl);
      }
      return;
      label52:
      if (1 == paramInt) {
        this.jdField_a_of_type_Anbv = new anbs(this.jdField_e_of_type_Int);
      }
    }
  }
  ...
  public void b(Activity paramActivity, CmGameInitParams paramCmGameInitParams)
  {
    ...
    for (;;)
    {
      ...
      break label152;
      label230:
      str = String.valueOf(amzf.a(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.extendJson));
      break label164;
  ...
  public void b(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      this.jdField_a_of_type_Blhq.removeMessages(203);
      Message localMessage = this.jdField_a_of_type_Blhq.obtainMessage(203);
      localMessage.obj = paramString;
      this.jdField_a_of_type_Blhq.sendMessageDelayed(localMessage, 1000L);
  ...
  {
    this.jdField_a_of_type_Blhq.removeMessages(203);
    if (((!this.jdField_b_of_type_Boolean) || ((!TextUtils.isEmpty(paramString)) && (paramString.contains("inner")))) && (this.jdField_a_of_type_Anda != null))
    {
      boolean bool = this.jdField_e_of_type_Boolean;
      this.jdField_a_of_type_Blhq.post(new CmGameLauncher.9(this, paramString, bool));
    }
  ...
  public void f()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        AppNetConnInfo.unregisterNetInfoHandler(this.jdField_a_of_type_Andr);
        if (this.jdField_a_of_type_Anop != null) {
          this.jdField_a_of_type_Anop.b();
        }
        if (this.jdField_a_of_type_Anda != null) {
          this.jdField_a_of_type_Anda.a();
        }
        if (this.jdField_a_of_type_Adnb != null) {
          this.jdField_a_of_type_Adnb.b();
        }
        if (this.jdField_a_of_type_Anex != null) {
          this.jdField_a_of_type_Anex.a();
        }
        if (this.jdField_a_of_type_Anbg != null) {
          this.jdField_a_of_type_Anbg.a();
        }
        if (QLog.isColorLevel()) {
          QLog.d("cmgame_process.CmGameLauncher", 2, "onDestroy");
        }
        return;
        this.jdField_a_of_type_Blhq.obtainMessage(202).sendToTarget();
        if (!QLog.isColorLevel()) {
          continue;
        }
  ...
  public void g()
  {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        {
          if (this.jdField_a_of_type_Amzm != null) {
            this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.removeRenderRunner(this.jdField_a_of_type_Amzm);
          }
          if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null) {
          ...
          if (this.jdField_a_of_type_Anbz != null) {
            this.jdField_a_of_type_Anbz.d();
          }
          if (this.jdField_a_of_type_Ancl != null)
          {
            this.jdField_a_of_type_Ancl.a();
            this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.removeCmdHandler(this.jdField_a_of_type_Ancl);
          }
        }
        return;
        label231:
  ...
  public void h()
  {
    ...
    {
      if (this.jdField_a_of_type_Anbz != null) {
        this.jdField_a_of_type_Anbz.a(false);
      }
      if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null)
      {
    ...
    anct.a("cs.make_room_min.local", "{}", false, null, this.jdField_e_of_type_Int);
    if ((anbd.a() != null) && (this.jdField_a_of_type_JavaLangRefWeakReference != null)) {
      anbd.a(this.jdField_e_of_type_Int, (Context)this.jdField_a_of_type_JavaLangRefWeakReference.get());
    }
    if (QLog.isColorLevel()) {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    {
      if ((this.jdField_a_of_type_Anda == null) || (!this.jdField_a_of_type_Anda.a(this.jdField_e_of_type_Int))) {
        break label271;
      }
      this.jdField_a_of_type_Anda.a((String)paramMessage.obj, this.jdField_e_of_type_Int, this.jdField_e_of_type_Boolean);
    ...
    for (;;)
    {
      ...
      return false;
      label271:
      anog.a(this.jdField_e_of_type_Int, (String)paramMessage.obj, a());
    }
  }
  ...
  public void i()
  {
    ...
    anct.a("cs.close_room.local", "{}", false, null, this.jdField_e_of_type_Int);
  }
  ...
  public void j()
  {
    ...
    QIPCClientHelper.getInstance().callServer("cm_game_module", "action_query_check_game_data", localBundle, new andg(this));
  }
  ...
  public void onSurfaceReady(int paramInt1, int paramInt2)
  {
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      {
        this.jdField_a_of_type_Blhq.sendEmptyMessage(200);
        this.jdField_f_of_type_Boolean = false;
      }
      if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null) {
        this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView.mIsGameReady = true;
      }
      this.jdField_a_of_type_Andr = new andr(this.jdField_e_of_type_Int);
      AppNetConnInfo.registerConnectionChangeReceiver(BaseApplicationImpl.getContext(), this.jdField_a_of_type_Andr);
    }
  }
}
