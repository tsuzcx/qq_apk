  ...
  implements View.OnClickListener
{
  ...
  public apvp(EmoticonPanelController paramEmoticonPanelController)
  {
  ...
  private apyy a()
  {
    ...
    {
      localObject = localEmotionPanelViewPagerAdapter.a((apwv)((List)localObject).get(0));
      if ((localObject instanceof apyy)) {
        return (apyy)localObject;
      }
    }
    return null;
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    if (EmoticonPanelController.jdField_b_of_type_Int == this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonPanelController.a(7))
    {
      apyy localapyy = a();
      if (localapyy != null) {
        localapyy.a(paramInt1, paramInt2);
      }
      return;
    }
  ...
  public void f()
  {
    ...
    if (localObject != null)
    {
      localObject = (apty)((QQAppInterface)localObject).getManager(172);
      if (localObject != null) {
        ((apty)localObject).b();
      }
    }
  ...
  void i()
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetImageView == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130837905);
    }
    ...
    localLayoutParams.bottomMargin = aepi.a(52.0F, localContext.getResources());
    localLayoutParams.rightMargin = aepi.a(15.0F, localContext.getResources());
  ...
  public void l()
  {
    BusinessInfoCheckUpdate.AppInfo localAppInfo = ((axlx)this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonPanelController.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36)).a(String.valueOf("100610.100611"));
    if ((localAppInfo != null) && (localAppInfo.iNewFlag.get() != 0))
    {
      if (QLog.isColorLevel()) {
        QLog.d("EmoticonPanelSystemAndEmojiHelper", 2, "emoji mall has redpoint.");
      }
      azqs.b(this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonPanelController.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", "0X80057B8", 0, 0, "", "", "", "");
