  ...
  extends LinearLayout
{
  ...
  public bmso(Context paramContext, int paramInt1, int paramInt2, float paramFloat, View.OnClickListener paramOnClickListener, bmrx parambmrx)
  {
    super(paramContext);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = paramOnClickListener;
    this.jdField_a_of_type_Int = paramInt1;
    this.b = paramInt2;
    this.jdField_a_of_type_Bmrx = parambmrx;
    paramInt1 /= this.b;
  ...
  private void a()
  {
    ...
    while (i < this.b)
    {
      ...
      if (i == 0) {
        localLayoutParams.leftMargin = bmtu.b(getContext(), 7.0F);
      }
      if (i == this.b - 1) {
        localLayoutParams.rightMargin = bmtu.b(getContext(), 7.0F);
      }
  ...
  public void a(bmrt parambmrt, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (paramInt1 == paramInt2 - 1)
    {
      ...
      localObject = parambmrt.a(paramInt2);
      localImageView.setTag(2131377396, localObject);
      localImageView.setTag(2131377387, Integer.valueOf(paramInt2));
      if (parambmrt.a(paramInt2) != 1) {
        break label252;
      }
      if (!(getContext() instanceof EditPicActivity)) {
        break label158;
      }
      localObject = parambmrt.b(paramInt2);
      localImageView.setTag(2131377396, localObject);
      bmnh.a().a(localImageView, (String)localObject, this.d, this.d, paramBoolean);
    }
    for (;;)
    {
      paramInt2 += 1;
      ...
      localObject = bdpt.a(BaseApplicationImpl.sApplication.getRuntime(), (String)localObject, "-Dynamic-", null, new int[] { 13 }, "-Dynamic-", null);
      if (localObject != null)
      {
