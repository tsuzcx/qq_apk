  ...
  extends bcgx
{
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if ((paramView != null) && ((paramView instanceof LinearLayout)))
    {
      ...
      localLinearLayout.setId(2131370682);
      localBubbleViewLayout = new BubbleViewLayout(paramContext);
      localBubbleViewLayout.setId(2131370681);
      ...
      ((RelativeLayout)localObject3).setId(2131370675);
      ...
      ((RelativeLayout)localObject3).setBackgroundResource(2130844637);
      ...
      localObject2 = (bcgw)((Iterator)localObject4).next();
      localObject5 = ((bcgw)localObject2).a;
      if (!"title".equals(localObject5)) {
        break label685;
      }
      localObject2 = (TextView)((bcgw)localObject2).a(paramContext, null, paramBundle);
      ((TextView)localObject2).setSingleLine();
      localObject5 = new RelativeLayout.LayoutParams(-1, -2);
      i = localResources.getDimensionPixelSize(2131296893);
    ...
    for (;;)
    {
      ...
      ((RelativeLayout.LayoutParams)localObject5).addRule(3, 2131370675);
      ...
      ((TextView)localObject2).setBackgroundColor(localResources.getColor(2131167337));
      ...
      break label101;
      label467:
      ((RelativeLayout)localObject3).setBackgroundResource(2130844638);
      break label203;
      label477:
      if (bool)
      {
        ...
        ((RelativeLayout.LayoutParams)localObject4).addRule(0, 2131370675);
        paramView.setLayoutParams((ViewGroup.LayoutParams)localObject4);
        paramView.setId(2131373954);
        ...
        ((RelativeLayout)localObject3).setBackgroundResource(2130844630);
        paramView.setImageDrawable(localResources.getDrawable(2130844633));
      }
      for (;;)
      {
        label536:
        ...
        ((RelativeLayout.LayoutParams)localObject4).addRule(1, 2131370675);
        break label536;
        label652:
        ((RelativeLayout)localObject3).setBackgroundResource(2130844631);
        paramView.setImageDrawable(localResources.getDrawable(2130844632));
      }
      label673:
      ((RelativeLayout.LayoutParams)localObject5).setMargins(0, 0, 0, 0);
    }
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.o == 1)
        {
          ((TextView)localObject5).setTextColor(localResources.getColor(2131165279));
        }
        else
        {
      ...
      if (("head".equals(localObject5)) && ((localException instanceof bcis)))
      {
        ...
        if (BaseApplicationImpl.sApplication.getRuntime().getAccount().equalsIgnoreCase(((bcis)localException).ac))
        {
        ...
        localRelativeLayout.setId(2131363161);
        ...
        {
          paramBundle.addRule(3, 2131378611);
