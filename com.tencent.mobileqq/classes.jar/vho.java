...
public class vho
{
  ...
  private static vho jdField_a_of_type_Vho;
  ...
  private EntityManager a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 103	vho:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   6: ifnull +12 -> 18
    //   9: aload_0
    //   10: getfield 103	vho:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   13: astore_1
    //   14: aload_0
    //   15: monitorexit
    //   16: aload_1
    ...
    //   88: putfield 103	vho:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   91: aload_0
    //   92: getfield 103	vho:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   95: astore_1
    //   96: goto -82 -> 14
    //   99: astore_1
    //   100: ldc 113
  ...
  public static vho a()
  {
    if (jdField_a_of_type_Vho == null) {}
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (jdField_a_of_type_Vho == null) {
        jdField_a_of_type_Vho = new vho();
      }
      return jdField_a_of_type_Vho;
    }
  }
  
  private void a(QCirclePluginInfo paramQCirclePluginInfo)
  {
    ??? = this.jdField_a_of_type_JavaLangString + "/" + paramQCirclePluginInfo.version + "/qcirle-plugin.jpg";
    ...
    if ((!localFile.exists()) || (localFile.length() != paramQCirclePluginInfo.zipFileLength))
    {
      ...
      vhl.a().a(paramQCirclePluginInfo.zipFileUrl, (String)???, new vhq(this, paramQCirclePluginInfo, (String)???));
      ??? = this.jdField_a_of_type_JavaLangString + "/" + paramQCirclePluginInfo.version + "/qcirle-pluginmanager.jpg";
      ...
      vhl.a().a(paramQCirclePluginInfo.managerFileUrl, (String)???, new vhr(this, paramQCirclePluginInfo, (String)???));
    }
    label264:
    do
    {
  ...
  public void a()
  {
    ...
    localObject = new QCircleGetRainBowRequest((String)localObject, QUA.getQUA3(), "PUBLIC", BaseApplicationImpl.getApplication().getRuntime().getAccount(), "8.4.8");
    VSNetworkHelper.getInstance().sendRequest((VSBaseRequest)localObject, new vhp(this, (QCircleGetRainBowRequest)localObject));
  }
  ...
  public void b()
  {
    ...
    localEditor.putString("9b16ced79b", vgw.a().a());
    localEditor.commit();
  }
}
