...
public class bghz
{
    ...
    do
    {
      ...
      if (!new File(a() + "libqgplayer_765.so").exists())
      {
        ...
        try
        {
          ...
          axpy.a(paramQQAppInterface, "sendtdbank|b_sng_qqvip_qqcomic|soDownload", "1|" + a + "|0", true);
          return;
        }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    if (bblj.a(a() + "libQGamePlayer.zip", a(), "libqgplayer_765.so")) {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      try
      {
        ...
        long l2 = a;
        axpy.a(paramQQAppInterface, "sendtdbank|b_sng_qqvip_qqcomic|soDownload", "2|" + (l1 - l2) + "|" + paramInt, true);
        return;
      }
      catch (Throwable paramQQAppInterface)
      {
