  ...
  implements algj
{
  ...
  public aebg(QQSettingMe paramQQSettingMe)
  {
  ...
  public void a(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    return;
    localQQSettingMe.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.requestPermissions(new aebh(this, localQQSettingMe), 1, new String[] { "android.permission.ACCESS_FINE_LOCATION" });
