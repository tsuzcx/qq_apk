...
class alfr
  extends akuo
{
  alfr(alfn paramalfn, int paramInt, boolean paramBoolean1, boolean paramBoolean2, long paramLong, boolean paramBoolean3, boolean paramBoolean4, String paramString)
  {
  ...
  public void onLocationFinish(int paramInt, SosoInterface.SosoLbsInfo paramSosoLbsInfo)
  {
    ...
    if ((paramInt == 0) && (paramSosoLbsInfo != null) && (paramSosoLbsInfo.a != null))
    {
      ...
      paramSosoLbsInfo = algn.a(this.a.a.recognitions, alfn.a(this.a));
      alfn.a(this.a, paramSosoLbsInfo, paramInt, i);
      return;
    }
    QLog.i("AREngine_ARCloudControl", 1, "GetLBSLocation. onLocationFinish. gps info failed. errCode = " + paramInt);
    paramSosoLbsInfo = new alfv();
    paramSosoLbsInfo.a = 2;
    algn.a(this.a.a.recognitions, alfn.a(this.a), paramSosoLbsInfo);
    if (alfn.a(this.a) != null) {
