  ...
  extends ajtb
{
  ...
  private CopyOnWriteArrayList<anwe> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  ...
  public ajvn(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        case 1: 
          ...
          if (this.app != null)
          {
            localObject3 = (askf)this.app.getManager(14);
            if (localObject3 != null)
            {
              localObject1 = ((askf)localObject3).a((String)localObject1);
              ((EmoticonPackage)localObject1).ipSiteInfo = ((VipIPSiteInfo)localObject2);
              ((EmoticonPackage)localObject1).ipSiteInfoBytes = ((askf)localObject3).a((VipIPSiteInfo)localObject2);
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    localReqBody.str_app_version.set("8.3.0");
  ...
  public void a(int paramInt, ArrayList<Emoticon> paramArrayList, String paramString)
  {
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      try
      {
        localObject3 = ByteStringMicro.copyFrom(anzr.a(((Emoticon)localObject3).eId));
  ...
  {
    if (paramanwe != null) {
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.addIfAbsent(paramanwe);
    }
  }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    paramString.str_app_version.set("8.3.0");
  ...
  public void a(String paramString, List<String> paramList1, List<String> paramList2)
  {
    ...
    paramList2.str_app_version.set("8.3.0");
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    localModuleReq.mqqver.set("8.3.0");
  ...
  public void a(List<String> paramList, boolean paramBoolean, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramList)
      {
        ...
        paramList.str_app_version.set("8.3.0");
  ...
  public void b()
  {
    ...
    localReqBody.str_app_version.set("8.3.0");
    Object localObject1 = ((anyc)this.app.getManager(172)).b();
  ...
  {
    if (paramanwe != null) {
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.remove(paramanwe);
    }
  }
    ...
    if (localObject1 != null)
    {
      ...
      if ((localJSONArray != null) && (localJSONArray.length() > 0))
      {
        ...
        if (i < localJSONArray.length())
        {
          ...
          localObject1 = "";
          if (k == 3) {
            localObject1 = anzr.k.replace("[epId]", String.valueOf(j)).replace("[mod]", String.valueOf(j % 10));
          }
          for (;;)
          {
            String str2 = bbqd.a(BaseApplicationImpl.context, "emojiDetail", String.valueOf(j), "") + "&sceneType=1";
            ...
            break;
            if (k == 6) {
              localObject1 = anzr.l.replace("[epId]", String.valueOf(j));
            }
          }
        }
        ...
        localObject2 = (askf)this.app.getManager(14);
        if (localObject2 != null) {
          ((askf)localObject2).a((EmosmPb.SubCmd0x5RspBQRecommend)localObject1, 1);
        }
      }
    }
  }
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
            ...
            for (;;)
            {
              try
              {
                ...
                if (m != 0)
                {
                  ...
                  bool2 = bool1;
                  j = i;
                  paramToServiceMsg = (askf)this.app.getManager(14);
                  if (j != 2) {
                    break label3782;
                  }
                  if (!bool2) {
              ...
              catch (Exception paramObject)
              {
                ...
                paramObject = null;
                continue;
                localObject1 = (askf)this.app.getManager(14);
                switch (i)
                {
                }
              }
              ...
              do
              {
                  ...
                  do
                  {
                    do
                    {
                      do
                      {
                        do
                        {
                          do
                          {
                            ...
                            ((askf)localObject1).g(paramToServiceMsg, k);
                            paramToServiceMsg = ((askf)localObject1).a(paramToServiceMsg, k);
                            anvw.a().b(paramToServiceMsg);
                            break;
                          ...
                          while (paramToServiceMsg.hasNext())
                          {
                            ...
                            ((askf)localObject1).g(paramObject, k);
                            paramObject = ((askf)localObject1).a(paramObject, k);
                            anvw.a().b(paramObject);
                          }
                          break;
                      ...
                      if (bool2)
                      {
                        ...
                        ((askf)localObject1).a(paramToServiceMsg, k);
                      }
                    } while (!QLog.isColorLevel());
                ...
                localObject2 = (askf)this.app.getManager(14);
                localObject3 = ((askf)localObject2).a(String.valueOf(j), k);
              ...
              if (TextUtils.isEmpty(paramObject)) {
                paramToServiceMsg = ajya.a(2131704094);
              }
              ...
              for (l = 86400L;; l = ((EmosmPb.SubCmd0x19Rsp)localObject1).fixed32_time.get())
              {
                ...
                ((askf)localObject2).a((EmoticonPackage)localObject3);
                break;
              }
              localEmoticonResp.resultcode = -1;
              if (QLog.isColorLevel()) {
      ...
      if (j == 3)
      {
        ...
        while (paramToServiceMsg.hasNext()) {
          ((anwe)paramToServiceMsg.next()).a(bool2, j, localEmoticonResp);
        }
      }
      notifyUI(j, bool2, localEmoticonResp);
      return;
