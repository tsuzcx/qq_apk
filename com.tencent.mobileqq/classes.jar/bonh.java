...
public class bonh
{
  ...
  {
    zmn localzmn = zmn.a(BaseApplicationImpl.getApplication().getApplicationContext());
    ArrayList localArrayList = new ArrayList();
    localArrayList.add("-formats");
    localzmn.a((String[])localArrayList.toArray(new String[0]), new bonj());
  }
  
  public static void a(String paramString1, String paramString2, bonv parambonv)
  {
    a();
    zmn localzmn = zmn.a(BaseApplicationImpl.getApplication().getApplicationContext());
    ArrayList localArrayList = new ArrayList();
    ...
    localzmn.a((String[])localArrayList.toArray(new String[0]), new boni(paramString2, parambonv));
  }
  
  public static boolean a()
  {
    File localFile = new File(bonu.a);
    if (!localFile.exists()) {
      localFile.mkdir();
    }
    try
    {
      new bonf(BaseApplicationImpl.getContext()).a("svm_snr15_random_noise", localFile);
      return true;
    }
