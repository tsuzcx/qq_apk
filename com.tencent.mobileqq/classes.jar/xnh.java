  ...
  extends WebViewPlugin
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new xni(this, Looper.getMainLooper());
  public String a;
  private xnj jdField_a_of_type_Xnj = new xnj();
  private xnk jdField_a_of_type_Xnk;
  ...
  private void a(Bundle paramBundle)
  {
    ...
    for (CustomWebView localCustomWebView = this.mRuntime.a();; localCustomWebView = null)
    {
      ...
      for (int i = 1;; i = 0)
      {
        ...
        QLog.e("WebSoPlugin", 1, "QZoneWebViewPlugin onReceive 503, now it reload url! " + nax.c(str2, new String[0]));
      ...
      {
        QLog.d("WebSoPlugin", 1, bool1 + ") currentUrl(" + str3 + ") cache hit(" + bool4 + ") hasLoadCache(" + this.jdField_b_of_type_Boolean + ") load Url: " + nax.c(str2, new String[0]) + ",silent_mode:" + paramBundle.getBoolean("is_silent_mode", false) + ",isLocalData:" + bool2);
        if ((localWebSo3 == null) || (!localWebSo3.jdField_a_of_type_Boolean)) {
          break;
        }
        this.jdField_a_of_type_Xnj.a(this, localWebSo3);
        return;
      }
      ...
      if ((!bool3) && (Build.VERSION.SDK_INT >= 17))
      {
        ...
        if (this.jdField_a_of_type_Xnk == null)
        {
          this.jdField_a_of_type_Xnk = new xnk(this, localCustomWebView);
          localCustomWebView.addJavascriptInterface(this.jdField_a_of_type_Xnk, "_webso");
          if (QLog.isColorLevel()) {
            QLog.d("WebSoPlugin", 1, "js method : " + Arrays.toString(this.jdField_a_of_type_Xnk.getClass().getDeclaredMethods()));
          }
        }
      }
      label424:
      if ((!this.jdField_b_of_type_Boolean) && (!bool3) && (i != 0))
      {
        ...
        if (bool2) {}
        for (paramBundle = bche.a(str2, str1);; paramBundle = bche.b(str2, str1))
        {
          ...
          this.jdField_a_of_type_Xnk.a(str1);
          return;
        }
      }
      if (bool4)
      {
        ...
        if (this.jdField_a_of_type_Xnk != null) {
          this.jdField_a_of_type_Xnk.a("{\"code\":0,\"data\":null}");
        }
      ...
      label768:
      for (paramBundle = bche.b(str2, str1);; paramBundle = str1)
      {
        a(localCustomWebView, str2, paramBundle);
        return;
  ...
  public static void a(CustomWebView paramCustomWebView, String paramString1, String paramString2)
  {
    ...
    {
      paramCustomWebView.setTag(2131373143, paramString2);
      paramCustomWebView.setTag(2131373144, Long.valueOf(System.currentTimeMillis()));
  ...
  private void a(boolean paramBoolean)
  {
    ...
    if ((localObject instanceof FragmentActivity))
    {
      ...
      if ((localObject != null) && (((WebViewFragment)localObject).a != null))
      {
        ...
        {
          bcfj localbcfj = ((WebViewFragment)localObject).a;
          if (!paramBoolean) {}
        ...
        {
          ((bcfj)localObject).d = paramBoolean;
          return;
        }
      }
      b(paramBoolean);
  ...
  private boolean a(String paramString, long paramLong, Map<String, Object> paramMap)
  {
    ...
    do
    {
      ...
      {
        QLog.e("WebSoPlugin", 1, "now onHandleEventBeforeLoaded current url is not null! so return! " + nax.c(paramMap, new String[0]));
        return false;
      }
      a(paramString);
    } while ((!bche.b(paramString)) || (bche.e(paramString)));
  ...
  {
    if ((this.mRuntime == null) || (this.mRuntime.a() == null) || (this.mRuntime.a().getRootView() == null) || (this.mRuntime.a().getRootView().findViewById(2131379407) == null)) {}
    View localView;
    do
    {
      return;
      localView = this.mRuntime.a().getRootView().findViewById(2131379407).findViewById(2131372005);
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    if ((paramString2 != null) && ("WebSo".equals(paramString2)))
    {
      ...
      do
      {
        ...
        {
          bche.a("js call getData");
          this.jdField_a_of_type_Xnj.a(this, paramJsBridgeListener);
          return true;
        }
        if ("updateWebsoCache".equals(paramString3)) {}
        try
        {
          bche.a("js call updateWebsoCache");
          if (this.jdField_a_of_type_Xnj.a() != null)
          {
            if (this.mRuntime != null) {
        ...
        if ("updateScreenshot".equals(paramString3)) {
          try
          {
            bche.a("js call updateScreenshot");
            if (this.mRuntime != null)
            {
              paramString1 = this.mRuntime.a();
              paramString2 = paramString1.getUrl();
              if (bche.b(paramString2)) {
