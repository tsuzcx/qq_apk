...
public class xnh
{
  ...
  public xnh(xne paramxne, CustomWebView paramCustomWebView)
  {
  ...
  {
    paramString = bchs.g(paramString);
    bchs.a("catchHtml");
    WebSoService.WebSoState.WebSo3 localWebSo3 = xne.a(this.jdField_a_of_type_Xne).a();
    if (localWebSo3 != null)
    {
      WebSoService.a(paramString, localWebSo3.jdField_a_of_type_JavaLangString, localWebSo3.b, Uri.parse(localWebSo3.d));
      return;
    }
    bchs.a("return webSo3 == null");
  }
