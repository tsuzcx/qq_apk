  ...
  extends amno
{
  ...
  awgn jdField_a_of_type_Awgn = null;
  private Object jdField_a_of_type_JavaLangObject = new Object();
  
  public amlb(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager)
  {
      ...
      else
      {
        ...
        for (Object localObject = localArrayList;; localObject = null)
        {
          ...
          while (paramMessageForStructing.hasNext())
          {
            ...
            if (aupn.a((ChatMessage)localObject))
            {
              if (QLog.isColorLevel()) {
  ...
  private void a(MessageForStructing paramMessageForStructing, HashMap<String, ArrayList<MessageRecord>> paramHashMap1, HashMap<String, ArrayList<MessageRecord>> paramHashMap2, int paramInt, amnx paramamnx, boolean paramBoolean1, boolean paramBoolean2, ArrayList<MessageRecord> paramArrayList)
  {
    if (paramInt > 3) {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        for (;;)
        {
          ...
          paramMessageForStructing = a(paramMessageForStructing, (ArrayList)localObject, paramamnx, paramBoolean1, paramBoolean2, paramArrayList);
          ...
          while (paramMessageForStructing.hasNext())
          {
            localObject = (MessageRecord)paramMessageForStructing.next();
            if (aupn.a((ChatMessage)localObject)) {
              a((MessageForStructing)localObject, paramHashMap1, paramHashMap2, paramInt + 1, paramamnx, paramBoolean1, paramBoolean2, paramArrayList);
            }
          }
          break;
        }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage)
  {
    ...
    } while (!arrr.a(paramQQAppInterface, (MessageForFile)paramChatMessage).sendCloudUnsuccessful());
    return false;
    return false;
  }
  ...
  private void b(MessageForStructing paramMessageForStructing, HashMap<String, ArrayList<MessageRecord>> paramHashMap, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (paramMessageForStructing.hasNext())
      {
        ...
        if (!aupn.a((ChatMessage)localMessageRecord1)) {
          continue;
        }
        if (paramInt != 2) {
          break label214;
        }
        MessageRecord localMessageRecord2 = a(localMessageRecord1, aupe.jdField_a_of_type_JavaLangString, false);
  ...
  public ArrayList<MessageRecord> a(MessageRecord paramMessageRecord, ArrayList<? extends MessageRecord> paramArrayList, amnx paramamnx, boolean paramBoolean1, boolean paramBoolean2)
  {
    paramMessageRecord = a(paramMessageRecord, paramArrayList, paramamnx, paramBoolean1, paramBoolean2, new ArrayList(0));
    if (paramBoolean1) {
  ...
  public ArrayList<MessageRecord> a(MessageRecord paramMessageRecord, ArrayList<? extends MessageRecord> paramArrayList, amnx paramamnx, boolean paramBoolean1, boolean paramBoolean2, ArrayList<MessageRecord> paramArrayList1)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (paramBoolean2)
      {
          ...
          else if (localMessageRecord.msgtype == -1035)
          {
            ...
            if (((MessageForMixedMsg)localObject1).getReplyMessage(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) != null)
            {
              ...
              if ((localObject1 != null) && (localObject2 != null)) {
                arsx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((MessageForReplyText)localObject1).getSourceMessage(), ((MessageForReplyText)localObject2).getSourceMessage());
              }
            }
          }
        ...
        if ((nav.a(paramArrayList)) && (nav.b(paramArrayList))) {
      ...
      arsx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord, paramArrayList);
      ...
      if (paramBoolean1) {
        if (paramArrayList.getStatus() == 1000) {
          this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.c(paramArrayList.frienduin, paramArrayList.istroop, paramArrayList.getTableName(), paramArrayList, 0, paramamnx);
        } else {
  ...
  public ArrayList<MessageRecord> a(msg_comm.Msg paramMsg, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, bbpd parambbpd)
  {
    ...
    Object localObject2 = azad.a((MessageHandler)localObject3, paramMsg, String.valueOf(l3), String.valueOf(l3));
    long l1;
    ...
    for (long l2 = 0L;; l2 = l1)
    {
      ...
      int i;
      if (((azah.c(j)) || (j == 208) || (j == 529)) && (localMsgHead.c2c_cmd.has()))
      {
        ...
        if ((j == 529) && (i == 4))
        {
          ...
          parambbpd = localMsgHead.from_nick.get();
          paramHashMap.put(String.valueOf(l3), localMsgHead.from_nick.get());
        }
      }
      for (paramHashMap = parambbpd;; paramHashMap = (HashMap<String, String>)localObject1)
      {
        if (((paramMessageRecord instanceof MessageForStructing)) && (((MessageForStructing)paramMessageRecord).structingMsg != null) && (((MessageForStructing)paramMessageRecord).structingMsg.mMsgServiceID == 107)) {
          azad.a((MessageHandler)localObject3, (List)localObject2, paramMsg);
        }
        l1 = l3;
        int k = azad.a(paramMsg);
        localObject1 = ((ArrayList)localObject2).iterator();
        i = 0;
        if (((Iterator)localObject1).hasNext())
        {
          parambbpd = (MessageRecord)((Iterator)localObject1).next();
          paramMsg = parambbpd;
          if (!axln.a(paramMessageRecord))
          {
            paramMsg = parambbpd;
            if (!aupn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)parambbpd))
            {
              paramMsg = parambbpd;
              if (!(parambbpd instanceof MessageForArkApp))
              {
                if (QLog.isColorLevel()) {
                  QLog.d("MultiMsg_TAG", 2, "not support multi forward msg! " + parambbpd.toString());
                }
                paramMsg = azaf.a(-1000);
          ...
          paramMsg.vipBubbleID = amca.a((int)l2, k);
          aupn.a(paramMsg, paramHashMap, paramMessageRecord);
          if ((j == 82) || (j == 43)) {
            paramMsg.istroop = 1;
          }
          for (;;)
          {
            ...
            azad.a((MessageHandler)localObject3, (List)localObject2, paramMsg, true, false, parambbpd);
            break label328;
            if (((j == 82) || (j == 43)) && (localMsgHead.group_info.has()))
            {
              ...
              if (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a((ArrayList)localObject2, paramMsg)) {
                azad.a((MessageHandler)localObject3, (List)localObject2, paramMsg, false, false, parambbpd);
              }
              parambbpd = (bbpd)localObject1;
              ...
              if (((paramMessageRecord instanceof MessageForStructing)) && (((MessageForStructing)paramMessageRecord).structingMsg != null) && (((MessageForStructing)paramMessageRecord).structingMsg.mMsgServiceID == 107)) {
                azad.a((MessageHandler)localObject3, paramMsg, (List)localObject2);
              }
                      ...
                      if (((im_msg_body.Elem)localObject1).anon_group_msg.has())
                      {
                        ...
                        for (;;)
                        {
                          try
                          {
                            ...
                            localObject1 = "";
                            localMessageRecord.saveExtInfoToExtStr("anonymous", nav.a(i, paramHashMap, (String)localObject1, k, m, str));
  ...
  public ArrayList<MessageRecord> a(byte[] paramArrayOfByte, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, bbpd parambbpd)
  {
    ...
    localObject2 = azad.a(localMessageHandler, (msg_comm.Msg)localObject3, String.valueOf(l3), String.valueOf(l3));
    long l1;
    if (((Long)((Pair)localObject2).first).longValue() != 4294967295L)
    {
      l1 = ((Long)((Pair)localObject2).first).longValue();
    ...
    for (long l2 = 0L;; l2 = l1)
    {
      localObject2 = new ArrayList();
      int k;
      if (((azah.c(j)) || (j == 208)) && (((msg_comm.MsgHead)localObject4).c2c_cmd.has()))
      {
        ...
        else
        {
          ...
          if (((paramMessageRecord instanceof MessageForStructing)) && (((MessageForStructing)paramMessageRecord).structingMsg != null) && (((MessageForStructing)paramMessageRecord).structingMsg.mMsgServiceID == 107)) {
            azad.a(localMessageHandler, (List)localObject2, (msg_comm.Msg)localObject3);
          }
          l1 = l3;
          k = azad.a((msg_comm.Msg)localObject3);
      ...
      for (;;)
      {
        ...
        ((MessageRecord)localObject4).vipBubbleID = amca.a((int)l2, k);
        if ((j == 82) || (j == 43))
        {
          ...
          l1 = ((Long)((Pair)localObject2).second).longValue();
          break;
          azad.a(localMessageHandler, (List)localObject2, (msg_comm.Msg)localObject3, true, false, parambbpd);
          break label497;
          if (((j == 82) || (j == 43)) && (((msg_comm.MsgHead)localObject4).group_info.has()))
          {
            ...
            if (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a((ArrayList)localObject2, (msg_comm.Msg)localObject3)) {
              azad.a(localMessageHandler, (List)localObject2, (msg_comm.Msg)localObject3, false, false, parambbpd);
            }
            ...
            if (((paramMessageRecord instanceof MessageForStructing)) && (((MessageForStructing)paramMessageRecord).structingMsg != null) && (((MessageForStructing)paramMessageRecord).structingMsg.mMsgServiceID == 107)) {
              azad.a(localMessageHandler, (msg_comm.Msg)localObject3, (List)localObject2);
            }
            break label575;
          }
  ...
  public HashMap<String, ArrayList<MessageRecord>> a(MessageRecord paramMessageRecord, HashMap<String, ArrayList<MessageRecord>> paramHashMap, amnx paramamnx, boolean paramBoolean1, boolean paramBoolean2)
  {
    HashMap localHashMap = new HashMap();
    ArrayList localArrayList = new ArrayList();
    ...
    do
    {
      ...
      {
        return localHashMap;
        if (aupn.a((ChatMessage)paramMessageRecord)) {
          break;
        }
      } while (!QLog.isColorLevel());
      QLog.d("MultiMsg_TAG", 2, "preAddMultiMsgWithNest error before of not structMsg");
      return localHashMap;
      a((MessageForStructing)paramMessageRecord, paramHashMap, localHashMap, 0, paramamnx, paramBoolean1, paramBoolean2, localArrayList);
  ...
  public HashMap<String, ArrayList<MessageRecord>> a(byte[] paramArrayOfByte, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, bbpd parambbpd)
  {
    ...
    try
    {
      ...
      if (paramArrayOfByte.msg.has())
      {
        ...
        {
          localObject3 = a((msg_comm.Msg)paramArrayOfByte.msg.get(i), paramHashMap, paramMessageRecord, parambbpd);
    ...
    if (!a(paramMessageRecord, (HashMap)localObject1, null))
    {
      ...
      if (i < paramArrayOfByte.pbItemList.size())
      {
        ...
        try
        {
          ...
          {
            ArrayList localArrayList = a((msg_comm.Msg)((msg_transmit.PbMultiMsgNew)localObject3).msg.get(j), paramHashMap, paramMessageRecord, parambbpd);
  ...
  public msg_comm.MsgHead a(MessageRecord paramMessageRecord, HashMap<String, String> paramHashMap, boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
    ...
    localMsgHead.from_uin.set(Long.valueOf(abti.c(paramMessageRecord)).longValue());
    ...
    if (paramBoolean1)
    {
      ...
      String str = abti.c(paramMessageRecord);
      ...
      aupn.a("step:packPb.getMsgHead.nickName = %s", new Object[] { localObject1 });
  ...
  public im_msg_body.MsgBody a(MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    if ((paramMessageRecord.msgtype == -1000) || (paramMessageRecord.msgtype == -10000)) {
      if (!TextUtils.isEmpty(paramMessageRecord.getExtInfoFromExtStr("sens_msg_source_msg_info"))) {
        localObject1 = azad.a(paramMessageRecord);
      }
    }
    for (;;)
    {
      if ((localObject1 != null) && (!((im_msg_body.RichText)localObject1).elems.isEmpty()))
      {
        ...
        if (nav.a(paramMessageRecord))
        {
          ...
          ((im_msg_body.AnonymousGroupMsg)localObject4).uint32_flags.set(localnaw.jdField_a_of_type_Int);
          if (!TextUtils.isEmpty(localnaw.jdField_a_of_type_JavaLangString)) {
            ((im_msg_body.AnonymousGroupMsg)localObject4).str_anon_id.set(ByteStringMicro.copyFrom(localnaw.jdField_a_of_type_JavaLangString.getBytes()));
          }
          if (!TextUtils.isEmpty(localnaw.jdField_b_of_type_JavaLangString)) {
            ((im_msg_body.AnonymousGroupMsg)localObject4).str_anon_nick.set(ByteStringMicro.copyFrom(localnaw.jdField_b_of_type_JavaLangString.getBytes()));
          }
          ((im_msg_body.AnonymousGroupMsg)localObject4).uint32_head_portrait.set(localnaw.jdField_b_of_type_Int);
          ((im_msg_body.AnonymousGroupMsg)localObject4).uint32_expire_time.set(localnaw.jdField_c_of_type_Int);
          if (!TextUtils.isEmpty(localnaw.jdField_c_of_type_JavaLangString)) {
            ((im_msg_body.AnonymousGroupMsg)localObject4).str_rank_color.set(ByteStringMicro.copyFrom(localnaw.jdField_c_of_type_JavaLangString.getBytes()));
          }
        ...
        return paramMessageRecord;
        localObject1 = azad.a((MessageForText)paramMessageRecord);
        continue;
        if (paramMessageRecord.msgtype == -1049)
        {
          localObject1 = azad.a((MessageForReplyText)paramMessageRecord);
          continue;
        }
        if (paramMessageRecord.msgtype == -2005)
        {
          if (paramBoolean)
          {
            localObject1 = alud.a(2131707406);
            if ((paramMessageRecord instanceof MessageForFile)) {
              localObject1 = ((MessageForFile)paramMessageRecord).getSummaryMsg();
            }
            localObject1 = azad.a((MessageForText)a(paramMessageRecord, (String)localObject1, false));
            continue;
          }
        ...
        if (paramMessageRecord.msgtype == -2017)
        {
          if (paramBoolean)
          {
            localObject1 = alud.a(2131707404);
        ...
        {
          localObject1 = azad.a((MessageForQQStoryComment)paramMessageRecord);
          continue;
        }
        if (paramMessageRecord.msgtype == -2000)
        {
          localObject1 = azad.a((MessageForPic)paramMessageRecord);
          continue;
        }
        if (paramMessageRecord.msgtype == -5008)
        {
          localObject1 = azad.a((MessageForArkApp)paramMessageRecord, true);
          continue;
        }
        if (paramMessageRecord.msgtype == -5016)
        {
          localObject1 = azad.c((MessageForArkBabyqReply)paramMessageRecord, true);
          continue;
        }
        if (paramMessageRecord.msgtype == -5017)
        {
          localObject1 = azad.b((MessageForArkApp)paramMessageRecord, true);
          continue;
        }
        if (paramMessageRecord.msgtype == -5013)
        {
          localObject1 = azad.c((MessageForArkFlashChat)paramMessageRecord);
          continue;
        }
        if (paramMessageRecord.msgtype == -5014)
        {
          localObject1 = azad.d((MessageForHiBoom)paramMessageRecord);
          continue;
        }
        if (paramMessageRecord.msgtype == -2011)
        {
          localObject3 = azad.a((MessageForStructing)paramMessageRecord);
          if (localObject3 == null) {
            return null;
          }
          ...
          try
          {
            ...
            localObject1 = ((azwy)localObject4).a.richText;
            if (localObject1 == null) {
              return null;
            }
        ...
        if (paramMessageRecord.msgtype == -1035)
        {
          ...
          if (i < k)
          {
            ...
            {
              localObject3 = azad.a((MessageForText)localObject3);
              if (localObject3 == null) {
                return null;
              }
              j = 0;
            ...
            for (;;)
            {
              ...
              {
                localObject3 = azad.a((MessageForReplyText)localObject3);
                if (localObject3 != null)
                {
                  j = 0;
                  while (j < ((im_msg_body.RichText)localObject3).elems.size())
        ...
        {
          localObject2 = azad.a((MessageForLongTextMsg)paramMessageRecord, false);
          continue;
        }
  ...
  protected void a(MessageRecord paramMessageRecord, List<MessageRecord> paramList, amnx paramamnx)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.c(localMessageRecord1.frienduin, localMessageRecord1.istroop, localMessageRecord1.getTableName(), localMessageRecord1, 0, paramamnx);
    }
  }
  ...
  public boolean a(MessageRecord paramMessageRecord, amnx paramamnx)
  {
  ...
  public boolean a(MessageRecord paramMessageRecord, HashMap<String, ArrayList<MessageRecord>> paramHashMap, amnx paramamnx)
  {
    if ((paramMessageRecord == null) || (paramHashMap == null)) {
      if (QLog.isColorLevel()) {
  ...
  protected boolean a(MessageRecord paramMessageRecord, List<MessageRecord> paramList, amnx paramamnx)
  {
    a(paramMessageRecord, paramList, paramamnx);
    this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.d();
    return true;
  }
  ...
  public boolean a(List<MessageRecord> paramList, amnx paramamnx)
  {
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      paramamnx = (MessageRecord)paramList.next();
      if (paramamnx.getStatus() == 1000) {
        this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.c(paramamnx.frienduin, paramamnx.istroop, paramamnx.getTableName(), paramamnx, 3, null);
      } else {
        this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.c(paramamnx.frienduin, paramamnx.istroop, paramamnx.getTableName(), paramamnx, 4, null);
      }
    }
    this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.d();
    return true;
    ...
    for (;;)
    {
      ...
      if ((paramHashMap != null) && (paramHashMap.size() > 0))
      {
        ...
        if (((Iterator)localObject1).hasNext())
        {
          ...
          if (!aupn.a((ChatMessage)paramHashMap)) {
            break label610;
          }
          paramHashMap = a(paramHashMap, aupe.jdField_b_of_type_JavaLangString, false);
        }
      }
      for (;;)
      {
