...
public class amlb
  ...
  implements amla
{
  private static volatile amlb a;
  ...
  public void a(long paramLong1, long paramLong2, String paramString1, String paramString2, long paramLong3, SpannableString paramSpannableString)
  {
    ...
    for (;;)
    {
      paramSpannableString = (QQAppInterface)bjal.a();
      str = bbcz.h(paramSpannableString, String.valueOf(paramString2), paramSpannableString.getAccount());
      paramString1 = new DanmuItemBean(Long.parseLong(paramSpannableString.c()), 0L, paramLong1, paramLong2, paramString1, str);
      paramString1.jdField_a_of_type_Boolean = myb.a().a(paramString2);
      if (paramString1.jdField_a_of_type_Boolean)
      {
        if (QLog.isColorLevel()) {
          QLog.d("DanmuDataIPCServer", 2, "notifyDanmuSendResult, anonymousFlag true");
        }
        paramSpannableString = myb.a().a(paramString2);
  ...
  public void a(amku paramamku, boolean paramBoolean1, boolean paramBoolean2, int paramInt, ArrayList<DanmuItemBean> paramArrayList, List<Long> paramList)
  {
    ...
    localBundle.putLong("key_barrage_msg_seq", paramamku.jdField_a_of_type_Long);
    localBundle.putLong("key_barrage_grp_uin", paramamku.b);
    localBundle.putInt("key_barrage_topic_type", paramamku.jdField_a_of_type_Int);
    localBundle.putInt("key_barrage_interval_time", paramInt);
    localBundle.putBoolean("key_barrage_is_success", paramBoolean1);
    if (paramamku.c > 0L)
    {
      localBundle.putLong("key_barrage_req_time", paramamku.c);
      localBundle.putLong("key_barrage_net_req_time", paramamku.d);
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if ("qipc_action_get_barrage".equals(paramString))
    {
      ...
      localObject = amkv.a().a(amkv.a().a(l2, l1));
      if ((localObject != null) && (!((amkw)localObject).jdField_a_of_type_Boolean))
      {
    ...
    label262:
    for (Object localObject = new amku(l2, l1, i, bool);; localObject = ((amkw)localObject).jdField_a_of_type_Amku)
    {
      ((amku)localObject).c = paramBundle.getLong("key_barrage_req_time");
      ((amku)localObject).d = System.currentTimeMillis();
      ((amku)localObject).jdField_a_of_type_Boolean = bool;
      amkv.a().a((amku)localObject, this);
