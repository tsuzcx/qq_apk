  ...
  extends lko
{
  ...
  {
    this.jdField_c_of_type_ArrayOfLla = new lla[5];
    int i = 0;
    while (i < this.jdField_c_of_type_ArrayOfLla.length)
    {
      this.jdField_c_of_type_ArrayOfLla[i] = new lla(paramAVRedPacketManager.a("qav_redpacket_gold_" + i * 2 + ".png"));
      i += 1;
    }
  }
