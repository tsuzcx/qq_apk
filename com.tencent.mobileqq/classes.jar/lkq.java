...
{
  public lkq(ReadInJoyAtlasViewPagerAdapter paramReadInJoyAtlasViewPagerAdapter) {}
  
  public void onClick(View paramView)
  {
    Object localObject = paramView.getTag(2131362465);
    if ((localObject instanceof gallery.GalleryInfo))
    {
      ...
      int j = ((Integer)paramView.getTag(2131362466)).intValue();
