  ...
  implements Manager
{
  ...
  public akmh(QQAppInterface paramQQAppInterface) {}
  ...
  private QWalletPubAdReport.TerminalInfor a(Context paramContext)
  {
    ...
    localTerminalInfor.qq_version.set("8.4.1");
  ...
  private void a(ackd paramackd)
  {
    ...
    } while (paramackd.a().jdField_a_of_type_TencentGdtQq_ad_get$QQAdGetRsp.ret.get() == 0);
    QLog.i("QWalletGdtAdManager", 2, "reqAds onResponse ret fail,loader.getSession().response.ret.get " + paramackd.a().jdField_a_of_type_TencentGdtQq_ad_get$QQAdGetRsp.ret.get());
  }
  
  private void a(Context paramContext, String paramString, int paramInt, acke paramacke)
  {
    ackf localackf = new ackf();
    localackf.jdField_a_of_type_TencentGdtQq_ad_get$QQAdGet = a(BaseApplicationImpl.getApplication().getRuntime().getLongAccountUin(), paramString, paramInt);
    new ackd(localackf, new WeakReference(paramacke)).a(new WeakReference(paramContext));
    if (QLog.isColorLevel()) {
  ...
  private void a(BaseActivity paramBaseActivity)
  {
    ...
    blqo.a(localQQAppInterface, "tenpay.com", new akmj(this, paramBaseActivity, localQQAppInterface, NetConnInfoCenter.getServerTimeMillis()));
  }
  ...
  public static void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    bcst.b(localQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", paramString1, 0, 0, paramString2, paramString3, paramString4, paramString5);
  }
  ...
  public static void a(im_msg_body.GeneralFlags paramGeneralFlags, MessageForStructing paramMessageForStructing)
  {
    if ((paramGeneralFlags != null) && (paramGeneralFlags.bytes_pb_reserve.has())) {
      try
      {
        ...
        while (((Iterator)localObject).hasNext()) {
          if (((bcvs)((Iterator)localObject).next() instanceof bczi))
          {
    ...
    Object localObject = bcwc.a(0);
    ((bcvt)localObject).a(new bcxx());
    ((bcvt)localObject).a = paramMessageForStructing.structingMsg;
    paramGeneralFlags.add(localObject);
    localObject = bcwc.a(31);
    ((bcvt)localObject).a = paramMessageForStructing.structingMsg;
    paramGeneralFlags.add(localObject);
  ...
  {
    paramBaseChatPie = new akmi(this, NetConnInfoCenter.getServerTimeMillis(), paramBaseChatPie);
    this.jdField_a_of_type_Acke = paramBaseChatPie;
  ...
  public void a()
  {
    Iterator localIterator = bczi.b.iterator();
  ...
  public void a(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Acke = null;
    paramContext = bczi.b.iterator();
  ...
  public void a(Context paramContext, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        blqo.a(localQQAppInterface, "tenpay.com", new akml(this, paramInt, paramContext, localQQAppInterface, l));
        return;
      }
  ...
  public void a(BaseActivity paramBaseActivity, BaseChatPie paramBaseChatPie)
  {
    ...
    {
      localObject = (akpd)paramBaseActivity.app.getManager(245);
      i1 = ((akpd)localObject).a("common", 1, new String[] { "pub_ad_control", "gdt_day_freq" });
      n = ((akpd)localObject).a("common", 4, new String[] { "pub_ad_control", "gdt_week_freq" });
    }
    int i2 = 0;
    int i5 = 0;
    int i4 = 0;
  ...
  public void a(List<ChatMessage> paramList)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("QWalletGdtAdManager", 2, "list,time:" + bgsu.b(localChatMessage.time * 1000L) + ",isShowQWalletPubAd:" + localChatMessage.isShowQWalletPubAd);
      }
      i -= 1;
      break label22;
      break;
  ...
  public boolean a()
  {
    ...
    if (((akpd)localQQAppInterface.getManager(245)).a("common", 0, new String[] { "pub_ad_control", "gdt_switch" }) == 0) {}
