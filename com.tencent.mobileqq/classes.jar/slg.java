  ...
  implements bcmt
{
  ...
  slg(slf paramslf, String paramString, int paramInt1, int paramInt2, long paramLong1, long paramLong2)
  {
  ...
  public bcmu a(int paramInt1, int paramInt2)
  {
    ...
    long l = sli.a(paramInt1, paramInt2);
    int j = sli.a(paramInt1, paramInt2);
    localbcmu.jdField_a_of_type_Int = ((int)l);
    paramInt2 = Math.min(paramInt1, paramInt2);
    localbcmu.jdField_a_of_type_Float = (j / paramInt2);
    paramInt1 = i;
    if (this.jdField_b_of_type_Int <= 30) {
      paramInt1 = this.jdField_b_of_type_Int;
    }
    localbcmu.jdField_b_of_type_Int = paramInt1;
    ...
    if (QLog.isColorLevel()) {
      QLog.d("VideoCompressTask", 2, "CompressTask, step: getEncodeConfig()\n  sourceShortEdge:" + paramInt2 + ", dstResolution:" + j + ", scaleRate:" + localbcmu.jdField_a_of_type_Float + "\n  targetVideoBitRate:" + localbcmu.jdField_a_of_type_Int + ", videoFrameRate:" + localbcmu.jdField_b_of_type_Int + "\n setRotation:" + localbcmu.jdField_b_of_type_Boolean + ", beginTime:" + localbcmu.jdField_a_of_type_Long + ", endTime:" + localbcmu.jdField_b_of_type_Long);
    }
    return localbcmu;
  }
  ...
  {
    if ((slf.a(this.jdField_a_of_type_Slf) != null) && (!this.jdField_a_of_type_Slf.isCancelled())) {
      slf.a(this.jdField_a_of_type_Slf).a(paramInt / 100.0F);
    }
  }
  ...
  public void b()
  {
    ...
    c();
    if (slf.a(this.jdField_a_of_type_Slf) != null) {
      slf.a(this.jdField_a_of_type_Slf).a(6, null, null);
    }
  }
}
