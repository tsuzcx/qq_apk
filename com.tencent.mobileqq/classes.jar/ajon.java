  ...
  implements View.OnClickListener
{
  ...
  public ajon(boyn paramboyn, boym paramboym)
  {
  ...
  private void l()
  {
    ...
    this.jdField_d_of_type_AndroidWidgetButton.setText(2131698003);
  ...
  public View a()
  {
    ...
    ((TextView)localView.findViewById(2131364112)).setOnClickListener(this);
    ...
    this.jdField_d_of_type_AndroidWidgetButton = ((Button)localView.findViewById(2131373952));
    this.jdField_c_of_type_Int = 0;
    this.jdField_d_of_type_AndroidWidgetButton.setEnabled(false);
    this.jdField_d_of_type_AndroidWidgetButton.setText(2131698003);
    this.jdField_d_of_type_AndroidWidgetButton.setOnClickListener(this);
    this.jdField_d_of_type_Int = 0;
    this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localView.findViewById(2131366786));
    this.jdField_d_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localView.findViewById(2131366223));
    int i = afur.a(this.e, a().getResources());
    this.jdField_a_of_type_Bhwt = new bhwt();
    this.jdField_a_of_type_Bhwt.a(afur.a(this.e + this.f, a().getResources()));
    this.jdField_a_of_type_Bhwt.a(i);
    this.jdField_a_of_type_Bhwt.b(1);
    if (Build.VERSION.SDK_INT > 15) {
      this.jdField_d_of_type_AndroidWidgetRelativeLayout.setBackground(this.jdField_a_of_type_Bhwt);
    }
    for (;;)
    {
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131377802));
      this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)localView.findViewById(2131376293));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131366226));
      this.jdField_c_of_type_AndroidWidgetTextView.setText(this.jdField_c_of_type_JavaLangString);
      return localView;
      this.jdField_d_of_type_AndroidWidgetRelativeLayout.setBackgroundDrawable(this.jdField_a_of_type_Bhwt);
    }
  }
  ...
  public void a(Bundle paramBundle)
  {
    ...
    super.a(paramBundle);
    this.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_Boyn.a().getIntent().getStringExtra("key_face_unlock_code");
    ...
    for (;;)
    {
      ...
      case 2131373952: 
        if (this.jdField_c_of_type_Int == 0)
        {
          ...
          this.jdField_d_of_type_AndroidWidgetButton.setText(2131698005);
