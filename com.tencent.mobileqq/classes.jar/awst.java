  ...
  implements HookMethodCallback
{
  ...
  public awst(awso paramawso, String paramString)
  {
  ...
  public void a(String paramString, Object[] paramArrayOfObject)
  {
    ...
    {
      return;
      str3 = awso.a().toString();
      if (QLog.isColorLevel()) {
        awso.a(this.jdField_b_of_type_Awso, "onGPSScan: " + str3);
      }
    ...
    if ("requestLocationUpdates".equals(paramString)) {
      if (paramArrayOfObject.length == 5) {
        if ((paramArrayOfObject[2] instanceof Criteria))
        {
          ...
          awsj.a().a(paramString);
        }
      }
    }
    for (;;)
    {
      paramString = this.jdField_a_of_type_Awtd.a(str3);
      if ((paramString != null) && (paramString.size() > 0))
      {
        awso.a(this.jdField_b_of_type_Awso, 6, 0, 0, "GPS request update is too frequently(" + this.jdField_a_of_type_Int + " in " + this.jdField_a_of_type_Long / 60L / 1000L + " seconds", awtd.a(paramString));
        this.jdField_a_of_type_Awtd.a();
      }
      paramString = this.jdField_b_of_type_Awtd.a(str3);
      if ((paramString == null) || (paramString.size() <= 0)) {
        break;
      }
      awso.a(this.jdField_b_of_type_Awso, 6, 0, 0, "Wifi scan is too frequently(" + this.jdField_b_of_type_Int + " in " + this.jdField_b_of_type_Long / 60L / 1000L + " seconds", awtd.a(paramString));
      this.jdField_b_of_type_Awtd.a();
      return;
      if ((paramArrayOfObject[0] instanceof String))
      {
        awso.a(this.jdField_b_of_type_Awso, new String[] { str4, "0", "|", "1", "|", "{", paramArrayOfObject[0].toString(), "#", paramArrayOfObject[1].toString(), "#", paramArrayOfObject[2].toString(), "}", "|", str3 });
        break label321;
      }
      awso.a(this.jdField_b_of_type_Awso, new String[] { str4, "0", "|", "-1", "|", "{}", "|", str3 });
      break label321;
      ...
      if ((paramArrayOfObject[2] instanceof Criteria))
      {
        awso.a(this.jdField_b_of_type_Awso, new String[] { str4, "0", "|", "2", "|", "{", paramArrayOfObject[0].toString(), "#", paramArrayOfObject[1].toString(), "#", "[", this.jdField_a_of_type_AndroidLocationLocationManager.getBestProvider((Criteria)paramArrayOfObject[2], true), ",", String.valueOf(((Criteria)paramArrayOfObject[2]).getAccuracy()), ",", String.valueOf(((Criteria)paramArrayOfObject[2]).getPowerRequirement()), "]", "}", "|", str3 });
        break label321;
      }
      if ((paramArrayOfObject[0] instanceof String))
      {
        awso.a(this.jdField_b_of_type_Awso, new String[] { str4, "0", "|", "3", "|", "{", paramArrayOfObject[0].toString(), "#", paramArrayOfObject[1].toString(), "#", paramArrayOfObject[2].toString(), "}", "|", str3 });
        break label321;
      }
      awso.a(this.jdField_b_of_type_Awso, new String[] { str4, "0", "|", "-1", "|", "{}", "|", str3 });
      break label321;
      ...
      {
        if ((paramArrayOfObject[0] instanceof String)) {
          awso.a(this.jdField_b_of_type_Awso, new String[] { str4, "1", "|", "0", "|", "{", paramArrayOfObject[0].toString(), "}", "|", str3 });
        }
        for (;;)
        {
          paramString = new Bundle();
          ...
          if ((paramArrayOfObject[0] instanceof Criteria)) {
            awso.a(this.jdField_b_of_type_Awso, new String[] { str4, "1", "|", "1", "|", "{", "[", this.jdField_a_of_type_AndroidLocationLocationManager.getBestProvider((Criteria)paramArrayOfObject[0], true), ",", String.valueOf(((Criteria)paramArrayOfObject[0]).getAccuracy()), ",", String.valueOf(((Criteria)paramArrayOfObject[0]).getPowerRequirement()), "]", "}", "|", str3 });
          } else {
            awso.a(this.jdField_b_of_type_Awso, new String[] { str4, "1", "|", "-1", "|", "{}", "|", str3 });
          }
        }
        label1437:
        a(paramString);
      ...
      else if ("requestSoso".equals(paramString))
      {
        ...
        {
          paramString = "none";
          localawso = this.jdField_b_of_type_Awso;
        ...
        {
          awso.a(localawso, new String[] { str4, "2", "|", "0", "|", "{", str5, "#", str6, "#", paramString, "#", str1, "#", str2, "#", paramArrayOfObject[5].toString(), "}", "|", str3 });
  ...
  {
    super.e();
    if ((this.jdField_a_of_type_Boolean) && (awso.a())) {}
    label518:
    for (;;)
    {
      String str;
      ...
      synchronized (this.jdField_a_of_type_JavaUtilMap)
      {
        ...
        awso.b(this.jdField_b_of_type_Awso, new String[] { "fg30SdkCount", "|", String.valueOf(i) });
        if (awso.b(this.jdField_b_of_type_Awso)) {
          awso.b(this.jdField_b_of_type_Awso, new String[] { "fg30SysCount", "|", String.valueOf(j) });
        }
        ...
        if (localIterator1.hasNext())
        {
          ...
          awso.b(this.jdField_b_of_type_Awso, new String[] { "fg30SdkDetail", "|", str, "|", ((StringBuilder)localObject3).toString() });
        }
      }
      ...
      while (localIterator2.hasNext())
      {
        ...
        awso.b(this.jdField_b_of_type_Awso, new String[] { "fg30SysDetail", "|", str, "|", ((StringBuilder)localObject2).toString() });
      }
  ...
  public void f()
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaUtilMap)
      {
        ...
        awso.b(this.jdField_b_of_type_Awso, new String[] { "bg5SdkCount", "|", String.valueOf(i) });
        if (awso.b(this.jdField_b_of_type_Awso)) {
          awso.b(this.jdField_b_of_type_Awso, new String[] { "bg5SysCount", "|", String.valueOf(j) });
        }
        ...
        if (localIterator1.hasNext())
        {
          ...
          awso.b(this.jdField_b_of_type_Awso, new String[] { "bg5SdkDetail", "|", str, "|", ((StringBuilder)localObject3).toString() });
        }
      }
      ...
      while (localIterator2.hasNext())
      {
        ...
        awso.b(this.jdField_b_of_type_Awso, new String[] { "bg5SysDetail", "|", str, "|", ((StringBuilder)localObject2).toString() });
      }
      this.jdField_c_of_type_JavaUtilMap.clear();
      this.jdField_d_of_type_JavaUtilMap.clear();
      return;
