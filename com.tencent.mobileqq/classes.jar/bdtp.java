  ...
  extends bdtz
{
  ...
  public bdtp(String paramString, int paramInt)
  {
  ...
  public JSONObject a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      bdnw.b("GetNewBaseLibRequest", "[MiniEng] GetNewBaseLib interval:" + i);
      long l1 = i * 1000;
      long l2 = System.currentTimeMillis();
      bdzf.a().edit().putLong("baselib_min_update_time", l1 + l2).apply();
      ...
      while (localIterator.hasNext())
      {
        ...
        bdnw.b("GetNewBaseLibRequest", "[MiniEng] GetNewBaseLib " + localBaseLibInfo);
      }
