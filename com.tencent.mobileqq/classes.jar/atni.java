...
public class atni
{
  ...
  public static Drawable a(Bitmap paramBitmap)
  {
    ...
    Bitmap localBitmap = bfvo.a(paramBitmap, paramBitmap.getWidth(), paramBitmap.getHeight());
  ...
  {
    Object localObject = null;
    Bitmap localBitmap = bfvo.a(paramBitmap, a(0, paramDouble));
    paramBitmap = localObject;
    if (localBitmap != null) {
      paramBitmap = new BitmapDrawable(BaseApplicationImpl.getApplication().getResources(), localBitmap);
    }
  ...
  {
    return a(bfsm.a(paramDrawable), paramDouble);
  }
      ...
      else
      {
        ...
        if (l != -1L)
        {
          ...
          else
          {
            ...
            localMessageForArkApp.saveExtInfoToExtStr(bbkv.w, Integer.toString(0));
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageForArkApp paramMessageForArkApp, int paramInt, String paramString)
  {
    ...
    if (TextUtils.isEmpty(paramMessageForArkApp.getExtInfoFromExtStr(bbkv.y)))
    {
      QLog.d("SDK_SHARE.ForwardOptionUtils", 1, "updateFailFakeMsg fakeShareInfo empty，return");
      return;
    }
    paramMessageForArkApp.extraflag = 32768;
    paramMessageForArkApp.saveExtInfoToExtStr(bbkv.w, String.valueOf(paramInt));
    paramMessageForArkApp.saveExtInfoToExtStr(bbkv.x, paramString);
