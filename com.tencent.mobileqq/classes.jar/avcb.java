...
public class avcb
{
  ...
  private avcd jdField_a_of_type_Avcd;
  private String jdField_a_of_type_JavaLangString;
  private HashSet<String> jdField_a_of_type_JavaUtilHashSet;
  
  public avcb(String paramString, avcd paramavcd)
  {
  ...
  {
    if (azzu.a()) {
      return new File(ajed.aU + "status_ic");
    }
    return null;
  }
  ...
  private boolean a(String paramString, File paramFile)
  {
    ...
    paramFile = awrn.a(BaseApplication.getContext());
  ...
  public Bitmap a(String paramString1, String paramString2, String paramString3)
  {
    ...
    if (localBitmap == null)
    {
      ...
      if (!this.jdField_a_of_type_JavaUtilHashSet.contains(paramString1))
      {
        ...
        new avcc(this, paramString1, paramString2, paramString3).execute((Void[])null);
      }
    }
    return localBitmap;
  }
