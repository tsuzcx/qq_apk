...
class apvw
{
  ...
  private ArrayList<apvy> jdField_a_of_type_JavaUtilArrayList;
  
  public apvw(String paramString)
  {
  ...
  public Object a(Map<String, Object> paramMap)
  {
    ...
    for (;;)
    {
      ...
      paramMap = ((apvy)localIterator.next()).a(paramMap);
    }
  }
  
  public ArrayList<apvy> a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        if (i < localArrayList.size())
        {
          ...
          if (str1.charAt(0) == '.')
          {
            paramString.add(new apvz(str1.substring(1)));
          }
          else
          {
            String str2 = apwa.a().b(str1);
            if (!TextUtils.isEmpty(str2)) {
              paramString.add(new apvz(str2));
            }
          }
        }
      }
      ...
      return paramString;
      String str1 = apwa.a().a(str1);
      if (!TextUtils.isEmpty(str1)) {
        paramString.add(new apvx(Integer.parseInt(str1)));
      } else {
        return null;
      }
      i += 1;
