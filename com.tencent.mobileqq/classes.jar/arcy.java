...
public class arcy
{
  ...
  private arcy(QQAppInterface paramQQAppInterface, List<ContentProviderOperation> paramList)
  {
  ...
  private arcy(QQAppInterface paramQQAppInterface, List<ContentProviderOperation> paramList, long paramLong)
  {
  ...
  private arcy(QQAppInterface paramQQAppInterface, List<ContentProviderOperation> paramList, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt1, int paramInt2)
  {
    this(paramQQAppInterface, paramList);
  ...
  public static arcy a(QQAppInterface paramQQAppInterface, List<ContentProviderOperation> paramList, long paramLong)
  {
    return new arcy(paramQQAppInterface, paramList, paramLong);
  }
  
  public static arcy a(QQAppInterface paramQQAppInterface, List<ContentProviderOperation> paramList, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt1, int paramInt2)
  {
    return new arcy(paramQQAppInterface, paramList, paramString1, paramString2, paramString3, paramString4, paramInt1, paramInt2);
  }
  ...
  public arcy a(String paramString)
  {
  ...
  public arcy a(String paramString, Uri paramUri)
  {
    this.jdField_a_of_type_AndroidContentContentValues.clear();
    this.jdField_a_of_type_AndroidContentContentValues.put("data1", paramString);
    a(paramUri);
  ...
  public arcy b(String paramString)
  {
    this.jdField_a_of_type_AndroidContentContentValues.clear();
    ...
    this.jdField_a_of_type_AndroidContentContentValues.put("data3", anni.a(2131701313));
    a();
    return this;
  }
}
