...
public class akyx
{
  ...
  public static akyq a(AppInterface paramAppInterface)
  {
    if ((paramAppInterface instanceof QQAppInterface)) {
      return (akyq)((QQAppInterface)paramAppInterface).getManager(279);
    }
    if (AudioHelper.d()) {
      throw new IllegalArgumentException(ajya.a(2131708528));
    }
    return null;
  }
  
  public static akyz a(AppInterface paramAppInterface)
  {
    if (((paramAppInterface instanceof QQAppInterface)) && (AudioHelper.d())) {
      throw new IllegalArgumentException(ajya.a(2131708526));
    }
    if (jdField_a_of_type_Akyz == null) {}
    try
    {
      if (jdField_a_of_type_Akyz == null) {
        jdField_a_of_type_Akyz = new akyz(paramAppInterface);
      }
      return jdField_a_of_type_Akyz;
    }
    finally {}
  }
