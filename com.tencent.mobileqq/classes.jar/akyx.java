  ...
  extends alif
{
  ...
  public akyx(ContactsInnerFrame paramContactsInnerFrame, Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, boolean paramBoolean)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    int i = Arrays.binarySearch(this.jdField_a_of_type_ArrayOfInt, paramInt);
    if (paramView == null) {
      paramView = alaf.a(paramViewGroup, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberContactsInnerFrame.jdField_a_of_type_AndroidViewLayoutInflater, 2131562780);
    }
    for (;;)
    {
      ...
      if (i < 0)
      {
        ...
        alaf.a(this, localalaf, localPhoneContact2);
        if (i - 1 < 0)
        {
          localObject = null;
          ...
          localalaf.d.setText(localPhoneContact2.mobileNo);
          label192:
          localalaf.b.setText(localPhoneContact2.name);
          if (!this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberContactsInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.isResultListContainFriend(localalaf.jdField_a_of_type_JavaLangString)) {
            break label415;
          }
          ...
          localalaf.jdField_a_of_type_AndroidWidgetCheckBox.setEnabled(false);
          label275:
          if ((AppSetting.c) && (localalaf.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
          {
            ...
            paramView.setContentDescription(localPhoneContact2.name + amtj.a(2131701698));
          }
          label333:
          localalaf.jdField_a_of_type_ComTencentMobileqqDataPhoneContact = localPhoneContact2;
      ...
      for (;;)
      {
        ...
        break label275;
        label439:
        paramView.setContentDescription(localPhoneContact2.name + amtj.a(2131701670));
        break label333;
