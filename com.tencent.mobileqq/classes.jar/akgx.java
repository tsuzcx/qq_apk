  ...
  extends ajfb
{
  ...
  {
    return BaseApplicationImpl.getApplication().getSharedPreferences("apollo_sp", 0).getLong("apollo_client_script_" + aiys.ax, 0L);
  }
  
  public static String a()
  {
    return "client_script_config_" + aiys.au;
  }
  
  public static void a(long paramLong)
  {
    BaseApplicationImpl.getApplication().getSharedPreferences("apollo_sp", 0).edit().putLong("apollo_client_script_" + aiys.ax, paramLong).commit();
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface != null)
    {
      ...
      b(0L);
      akgx localakgx = (akgx)paramQQAppInterface.a(115);
      if (localakgx == null) {
        break label49;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    if (i == 0) {
      ((aifg)paramQQAppInterface.getManager(153)).a(true, "checkApolloPanelJsonVer : local ver==0", paramInt);
    }
    for (;;)
    {
  ...
  {
    return BaseApplicationImpl.getApplication().getSharedPreferences("apollo_sp", 0).getLong("apollo_client_script_" + aiys.au, 0L);
  }
  
  public static String b()
  {
    return "client_script_config_" + aiys.ax;
  }
  
  public static void b(long paramLong)
  {
    BaseApplicationImpl.getApplication().getSharedPreferences("apollo_sp", 0).edit().putLong("apollo_client_script_" + aiys.au, paramLong).commit();
    QLog.i("ApolloContentUpdateHandler", 1, "updateApolloBaseResVersion version: " + paramLong);
  }
  
  private static void b(QQAppInterface paramQQAppInterface)
  {
    aitw.a(paramQQAppInterface, aiys.av + "base.zip", aiys.at, null, new akgz());
  }
  ...
  protected ClubContentUpdateInfoPb.ReqAppInfo a()
  {
    ...
    if (i == 0)
    {
      ((aifg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a(true, "login : local ver==0", 1);
      return null;
    }
    ((aifg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a(false, "login : check action", 1);
  ...
  protected void a(ClubContentUpdateInfoPb.RspAppInfo paramRspAppInfo)
  {
    ...
    if ((paramRspAppInfo.rpt_msg_rspiteminfo.has()) && (paramRspAppInfo.rpt_msg_rspiteminfo.size() > 0))
    {
      ...
      ((aifg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a(true, "12h update...", 1);
    }
    for (;;)
    {
      ...
      try
      {
        ...
        ((aifg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).b();
      }
  ...
  public void a(ArrayList<ClubContentUpdateInfoPb.ReqAppInfo> paramArrayList)
  {
    ...
    if (paramArrayList == null)
    {
      ...
      if (aifg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()))
      {
        i = ((aifg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
    ...
    for (;;)
    {
      ...
      break;
      if (apdh.a(ApolloUtil.a)) {
        aifg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
  ...
  protected void b(ClubContentUpdateInfoPb.RspAppInfo paramRspAppInfo)
  {
    ...
    {
      aivr.a(null, (AppInterface)localObject, i, bool);
  ...
  {
    if (!aifg.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
    {
  ...
  public ClubContentUpdateInfoPb.ReqAppInfo c()
  {
    ...
    Object localObject2 = new File(aiys.c, "/def/role/0/config.json");
    ...
    for (;;)
    {
      try
      {
        long l = new JSONObject(bace.a((File)localObject2)).optLong("version");
        ...
        localObject2 = new File(aiys.g);
        if ((((File)localObject2).exists()) && (((File)localObject2).isDirectory())) {
          ((File)localObject2).listFiles(new akgy(this, (SparseArray)localObject1));
        }
        localObject2 = new ArrayList();
        i = 0;
  ...
  public void d(ClubContentUpdateInfoPb.RspAppInfo paramRspAppInfo)
  {
    ...
    for (;;)
    {
      localObject = aiys.av + "base.zip";
      Bundle localBundle;
      if ((1 == (j & 0x1)) || (bool))
      {
        localBundle = new Bundle();
        localBundle.putLong("version", i);
        aitw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject, aiys.at, localBundle, new akgz());
      }
      ...
      if ((((File)localObject).list() == null) || (((File)localObject).list().length == 0))
      {
        ...
        for (;;)
        {
          localObject = aiys.ay + "base.zip";
          if ((1 == (j & 0x1)) || (bool))
          {
            localBundle = new Bundle();
            localBundle.putLong("version", i);
            aitw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject, aiys.aw, localBundle, new akha());
          }
