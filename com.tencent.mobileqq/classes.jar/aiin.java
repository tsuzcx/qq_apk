  ...
  implements Manager
{
  ...
  private aiiq jdField_a_of_type_Aiiq;
  ...
  private final aiiq jdField_b_of_type_Aiiq = new aiio(this);
  private File jdField_b_of_type_JavaIoFile;
  private List<aihr> jdField_b_of_type_JavaUtilList;
  private boolean jdField_b_of_type_Boolean = true;
  private File c;
  private File d;
  
  public aiin(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaUtilList = new CopyOnWriteArrayList();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager = paramQQAppInterface.getEntityManagerFactory().createEntityManager();
    this.jdField_a_of_type_Awyr = ((awyr)paramQQAppInterface.getManager(QQManagerFactory.EMOTICON_MANAGER));
    a(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin());
    d();
    if (this.jdField_b_of_type_JavaUtilList != null) {
      this.jdField_b_of_type_JavaUtilList.clear();
    }
    a(new aiim(paramQQAppInterface));
    this.jdField_a_of_type_Aiic = new aiic(paramQQAppInterface);
    a(this.jdField_a_of_type_Aiic);
    this.jdField_a_of_type_Aiik = new aiik(paramQQAppInterface);
    a(this.jdField_a_of_type_Aiik);
    a(new aije(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
  }
  
  private int a()
  {
    boolean bool = anck.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  ...
  public static aiin a(QQAppInterface paramQQAppInterface)
  {
    return (aiin)paramQQAppInterface.getManager(QQManagerFactory.STICKER_RECOMMEND_MANAGER);
  }
  ...
  public static File a(String paramString)
  {
    try
    {
      ...
      paramString = new File(aiif.jdField_a_of_type_JavaLangString + paramString);
      return paramString;
    }
  ...
  private Object a(String paramString)
  {
    ...
    //   1: astore 6
    //   3: aload_1
    //   4: invokestatic 354	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   7: ifeq +8 -> 15
    //   10: aload 6
    //   12: astore_3
    //   13: aload_3
    //   14: areturn
    //   15: new 356	java/io/ObjectInputStream
    //   18: dup
    //   19: new 358	java/io/BufferedInputStream
    //   22: dup
    //   23: new 360	java/io/FileInputStream
    //   26: dup
    //   27: aload_1
    //   28: invokespecial 361	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   31: invokespecial 364	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   34: invokespecial 365	java/io/ObjectInputStream:<init>	(Ljava/io/InputStream;)V
    //   37: astore 4
    //   39: aload 4
    //   41: astore_3
    //   42: aload 4
    //   44: invokevirtual 368	java/io/ObjectInputStream:readObject	()Ljava/lang/Object;
    //   47: astore 5
    //   49: aload 5
    //   51: astore_1
    //   52: aload_1
    ...
    //   56: ifnull -43 -> 13
    //   59: aload 4
    //   61: invokevirtual 371	java/io/ObjectInputStream:close	()V
    //   64: aload_1
    //   65: areturn
    //   66: astore_3
    //   67: aload_1
    ...
    //   74: aload 4
    //   76: astore_3
    //   77: invokestatic 145	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   80: ifeq +46 -> 126
    //   83: aload 4
    //   85: astore_3
    //   86: ldc 147
    //   88: iconst_2
    //   89: new 149	java/lang/StringBuilder
    //   92: dup
    //   93: invokespecial 150	java/lang/StringBuilder:<init>	()V
    //   96: ldc_w 373
    //   99: invokevirtual 156	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   102: aload_1
    ...
    //   112: aload 5
    //   114: invokevirtual 376	java/lang/Exception:toString	()Ljava/lang/String;
    ...
    //   123: invokestatic 379	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   126: aload 4
    //   128: astore_3
    //   129: aload 5
    //   131: instanceof 381
    ...
    //   137: ifnull +8 -> 145
    //   140: aload 4
    //   142: invokevirtual 371	java/io/ObjectInputStream:close	()V
    //   145: aload 6
    //   147: astore_3
    //   148: iload_2
    //   149: ifeq -136 -> 13
    //   152: aload_1
    //   153: invokestatic 387	com/tencent/mobileqq/utils/FileUtils:deleteFile	(Ljava/lang/String;)Z
    //   156: pop
    //   157: aconst_null
    //   158: areturn
    //   159: astore_1
    ...
    //   163: aload 4
    //   165: astore_3
    //   166: invokestatic 145	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   169: ifeq +15 -> 184
    //   172: aload 4
    //   174: astore_3
    //   175: ldc 147
    //   177: iconst_2
    //   178: ldc_w 389
    //   181: invokestatic 379	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   184: aload 6
    //   186: astore_3
    //   187: aload 4
    //   189: ifnull -176 -> 13
    //   192: aload 4
    //   194: invokevirtual 371	java/io/ObjectInputStream:close	()V
    //   197: aconst_null
    //   198: areturn
    //   199: astore_1
    //   200: aconst_null
    ...
    //   206: ifnull +7 -> 213
    //   209: aload_3
    //   210: invokevirtual 371	java/io/ObjectInputStream:close	()V
    //   213: aload_1
    //   214: athrow
    //   215: astore_3
    //   216: goto -71 -> 145
  ...
  private List<aihq> a(List<aihq> paramList, StickerRecommendSortEntity paramStickerRecommendSortEntity)
  {
    int i2 = 0;
    int j;
    int m;
    ...
    if (paramStickerRecommendSortEntity != null)
    {
      try
      {
        ...
        arrayOfaihq[i] = ((aihq)paramList.get(i1));
        i += 1;
      }
      ...
      if (n < m)
      {
        ...
        arrayOfaihq[i] = ((aihq)paramList.get(j));
        i += 1;
        break label461;
      }
    }
    for (;;)
    {
      if (i1 < k)
      {
        ...
        if ((i < i3) && (j < i3))
        {
          arrayOfaihq[j] = ((aihq)paramList.get(i));
          i = j + 1;
          break label470;
        }
      }
      ...
      {
        paramList = Arrays.asList(arrayOfaihq);
        return paramList;
        return null;
      }
      i = j;
  ...
  private void a(String paramString, Object paramObject)
  {
    ...
    //   4: ifeq +4 -> 8
    //   7: return
    //   8: new 513	java/io/ObjectOutputStream
    //   11: dup
    //   12: new 515	java/io/BufferedOutputStream
    //   15: dup
    //   16: new 517	java/io/FileOutputStream
    //   19: dup
    //   20: aload_1
    //   21: invokespecial 518	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   24: invokespecial 521	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   27: invokespecial 522	java/io/ObjectOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   30: astore 4
    //   32: aload 4
    //   34: astore_3
    //   35: aload 4
    //   37: aload_2
    //   38: invokevirtual 526	java/io/ObjectOutputStream:writeObject	(Ljava/lang/Object;)V
    //   41: aload 4
    //   43: astore_3
    //   44: aload 4
    //   46: invokevirtual 529	java/io/ObjectOutputStream:flush	()V
    //   49: aload 4
    //   51: ifnull -44 -> 7
    //   54: aload 4
    //   56: invokevirtual 530	java/io/ObjectOutputStream:close	()V
    //   59: return
    //   60: astore_1
    //   61: aload_1
    //   62: invokevirtual 531	java/io/IOException:printStackTrace	()V
    //   65: return
    //   66: astore 5
    //   68: aconst_null
    //   69: astore_2
    ...
    //   80: ldc 147
    //   82: iconst_2
    //   83: new 149	java/lang/StringBuilder
    //   86: dup
    //   87: invokespecial 150	java/lang/StringBuilder:<init>	()V
    //   90: ldc_w 533
    //   93: invokevirtual 156	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   96: aload_1
    //   97: invokevirtual 156	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   100: ldc_w 375
    //   103: invokevirtual 156	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   106: aload 5
    //   108: invokevirtual 376	java/lang/Exception:toString	()Ljava/lang/String;
    //   111: invokevirtual 156	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   114: invokevirtual 162	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   117: invokestatic 379	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   120: aload_2
    //   121: ifnull -114 -> 7
    //   124: aload_2
    //   125: invokevirtual 530	java/io/ObjectOutputStream:close	()V
    //   128: return
    //   129: astore_1
    //   130: aload_1
    //   131: invokevirtual 531	java/io/IOException:printStackTrace	()V
    //   134: return
    //   135: astore_1
    //   136: aconst_null
    //   137: astore_3
    ...
    //   139: ifnull +7 -> 146
    //   142: aload_3
    //   143: invokevirtual 530	java/io/ObjectOutputStream:close	()V
    //   146: aload_1
    //   147: athrow
    //   148: astore_2
    //   149: aload_2
    //   150: invokevirtual 531	java/io/IOException:printStackTrace	()V
    //   153: goto -7 -> 146
    //   156: astore_1
    //   157: goto -19 -> 138
    //   160: astore 5
  ...
  private void a(String paramString1, String paramString2, int paramInt, String paramString3)
  {
    ...
    for (boolean bool = true;; bool = false) {
      for (;;)
      {
        ...
        ((HttpNetReq)localObject).mCallback = new aiip(this, paramString2, bool, paramString3);
  ...
  private void a(boolean paramBoolean, String paramString, SessionInfo paramSessionInfo)
  {
    ...
    if ((paramBoolean) && (this.jdField_b_of_type_JavaUtilList != null))
    {
      ...
      {
        Object localObject = (aihr)localIterator.next();
        if (((aihr)localObject).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString))
        {
          localObject = ((aihr)localObject).a(paramString, paramSessionInfo);
          if ((localObject != null) && (!((List)localObject).isEmpty())) {
            localArrayList.addAll((Collection)localObject);
          }
        }
      }
      paramString = aihs.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localArrayList);
      ...
      {
        ((aihq)this.jdField_a_of_type_JavaUtilList.get(i)).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, i);
        i += 1;
      }
      if (QLog.isColorLevel()) {
  ...
  private void a(byte[] paramArrayOfByte)
  {
    try
    {
      ...
      else
      {
        ...
        localObject = bhhr.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "words_version_key805_gray_one", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin());
    ...
    catch (Exception paramArrayOfByte)
    {
      ...
      if (QLog.isColorLevel())
      {
        QLog.d("StickerRecManager", 2, bkym.a(paramArrayOfByte));
        return;
        if (QLog.isColorLevel()) {
  ...
  private void a(byte[] paramArrayOfByte, String paramString1, String paramString2, boolean paramBoolean, StickerRecommendSortEntity paramStickerRecommendSortEntity, int paramInt1, int paramInt2)
  {
    ...
    if (((PicSearchSvr.RspBody)localObject1).bytes_rsp_other.has())
    {
      ...
      while (i < localList.size())
      {
        ...
        localaiig.f(i);
        localaiig.c(((PicSearchSvr.ImgInfo)localObject2).uint64_img_size.get());
        localaiig.a(((PicSearchSvr.ImgInfo)localObject2).uint32_img_width.get());
        localaiig.b(((PicSearchSvr.ImgInfo)localObject2).uint32_img_height.get());
        localaiig.e(((PicSearchSvr.ImgInfo)localObject2).bytes_img_md5.get().toStringUtf8());
        localaiig.c(((PicSearchSvr.ImgInfo)localObject2).bytes_img_down_url.get().toStringUtf8());
        localaiig.d(((PicSearchSvr.ImgInfo)localObject2).uint64_thumb_size.get());
        localaiig.d(((PicSearchSvr.ImgInfo)localObject2).uint32_thumb_img_height.get());
        localaiig.c(((PicSearchSvr.ImgInfo)localObject2).uint32_thumb_img_width.get());
        localaiig.d(((PicSearchSvr.ImgInfo)localObject2).bytes_thumb_down_url.get().toStringUtf8());
        localaiig.f(((PicSearchSvr.ImgInfo)localObject2).bytes_thumb_img_md5.get().toStringUtf8());
        localaiig.g(((PicSearchSvr.ImgInfo)localObject2).uint32_src_type.get());
        localaiig.g(((PicSearchSvr.ImgInfo)localObject2).bytes_src_desc.get().toStringUtf8());
        localaiig.h(((PicSearchSvr.ImgInfo)localObject2).bytes_web_url.get().toStringUtf8());
        localaiig.i("");
        localaiig.j(((PicSearchSvr.ImgInfo)localObject2).bytes_pack_name.get().toStringUtf8());
        localaiig.h(((PicSearchSvr.ImgInfo)localObject2).uint32_pack_id.get());
        if (((PicSearchSvr.ImgInfo)localObject2).bytes_img_other.has()) {
          localaiig.k(((PicSearchSvr.ImgInfo)localObject2).bytes_img_other.get().toStringUtf8());
        }
        localaiig.l(paramArrayOfByte);
        localaiig.e(paramInt1);
        if (((PicSearchSvr.ImgInfo)localObject2).msg_emotion_info.has())
        {
          ...
          if (((PicSearchSvr.EmotionInfo)localObject2).bytes_url.has()) {
            localaiig.a(((PicSearchSvr.EmotionInfo)localObject2).bytes_url.get().toStringUtf8());
          }
        }
        if ((localaiig.e() == 3) && (QLog.isColorLevel())) {
          QLog.i("StickerRecManager", 2, "reveice cmsEmo  from:" + localaiig.e() + ", CmShowinfo:" + localaiig.e());
        }
        localArrayList.add(localaiig);
        i += 1;
      }
      ...
      {
        label713:
        paramStickerRecommendSortEntity = a(paramArrayOfByte, paramInt2, paramBoolean, anck.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
        label788:
        if (paramStickerRecommendSortEntity != null)
        {
    ...
    for (paramString2 = ((PicSearchSvr.RspBody)localObject1).bytes_rsp_other.get().toStringUtf8();; paramString2 = "999")
    {
      if (paramBoolean)
      {
        this.jdField_b_of_type_Aiiq.a(paramArrayOfByte, paramString1, paramString2, 0, null);
        return;
      }
      if (this.jdField_a_of_type_Aiiq != null)
      {
        localArrayList = null;
        ...
        if (paramInt1 == 1)
        {
          ...
          if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
          {
            ...
            if (localObject1 != null) {
              paramStickerRecommendSortEntity = ((aijh)localObject1).b();
            }
          }
        }
        this.jdField_a_of_type_Aiiq.a(paramArrayOfByte, paramString1, paramString2, paramInt1, paramStickerRecommendSortEntity);
        return;
        break label788;
        break label739;
  ...
  private boolean a(File paramFile1, File paramFile2)
  {
    ...
    try
    {
      ...
      nwp.a(paramFile1, localFile.getAbsolutePath() + File.separator);
  ...
  public static boolean b(aihq paramaihq)
  {
    return !a(paramaihq);
  }
  ...
  public static String d(String paramString)
  {
    ...
    {
      paramString = Utils.Crc64String(paramString);
      paramString = aiif.jdField_a_of_type_JavaLangString + paramString;
      return paramString;
    }
    catch (Exception paramString)
    {
  ...
  {
    Object localObject = new File(aiif.jdField_a_of_type_JavaLangString);
  ...
  public List<aihq> a(List<aihq> paramList, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    if (paramList != null) {
      try
      {
        if (paramList.size() != 0)
        {
          ...
          while (paramList.hasNext())
          {
            ...
            if ((!(localaihq instanceof aiig)) || (((aiig)localaihq).e() != 3) || ((paramBoolean2) && (!paramBoolean1) && (paramInt != 4))) {
              localArrayList.add(localaihq);
            }
          }
  ...
  public void a()
  {
    ...
    if (QLog.isColorLevel())
    {
      QLog.d("StickerRecManager", 2, bkym.a(localException1));
    ...
    l2 = bhhr.o(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin());
    if ((!FileUtils.fileExists(this.jdField_b_of_type_JavaIoFile.getAbsolutePath())) || ((l2 != 0L) && (System.currentTimeMillis() - l2 >= 86400000L)))
    {
      bhhr.m(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin(), 0L);
      localObject1 = new HashSet();
      localObject2 = this.jdField_a_of_type_Awyr.b();
      localList = this.jdField_a_of_type_Awyr.jdField_a_of_type_JavaUtilList;
    ...
    for (;;)
    {
      ...
      if (localObject1 != null) {
        this.jdField_a_of_type_ComTencentMobileqqDataCard = ((anvk)localObject1).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      }
  ...
  public void a(aihr paramaihr)
  {
    ...
    } while (this.jdField_b_of_type_JavaUtilList.contains(paramaihr));
    this.jdField_b_of_type_JavaUtilList.add(paramaihr);
  }
  
  public void a(aiiq paramaiiq)
  {
    this.jdField_a_of_type_Aiiq = paramaiiq;
  }
  ...
  protected void a(Context paramContext, String paramString)
  {
    try
    {
      this.jdField_b_of_type_Boolean = bhhr.B(paramContext, paramString);
      return;
    }
  ...
  public void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        QLog.d("StickerRecManager", 2, bkym.a(paramIntent));
        continue;
      }
      finally {}
      label131:
      ...
      {
        ((bbdh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.ICE_BREAKING_MNG)).a(paramFromServiceMsg);
      }
  ...
  public void a(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 65	aiin:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   6: astore 5
    //   8: aload 5
    //   10: ifnonnull +6 -> 16
    //   13: aload_0
    //   14: monitorexit
    //   15: return
    //   16: new 1316	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody
    //   19: dup
    //   20: invokespecial 1317	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody:<init>	()V
    //   23: astore 5
    //   25: aload 5
    //   27: iconst_1
    //   28: invokevirtual 1318	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody:setHasFlag	(Z)V
    //   31: new 149	java/lang/StringBuilder
    //   34: dup
    //   35: invokespecial 150	java/lang/StringBuilder:<init>	()V
    //   38: aload_1
    //   39: invokevirtual 156	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   42: invokestatic 1321	android/os/SystemClock:uptimeMillis	()J
    //   45: invokevirtual 634	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   48: invokevirtual 162	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   51: astore 6
    //   53: invokestatic 1322	com/tencent/common/config/AppSetting:a	()I
    //   56: invokestatic 1324	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   59: astore 7
    //   61: aload_0
    //   62: getfield 65	aiin:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   65: invokevirtual 96	com/tencent/mobileqq/app/QQAppInterface:getApp	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   68: invokestatic 1329	arqj:a	(Landroid/content/Context;)Ljava/lang/String;
    //   71: astore 8
    //   73: invokestatic 145	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   76: ifeq +82 -> 158
    //   79: ldc 147
    //   81: iconst_2
    //   82: new 149	java/lang/StringBuilder
    //   85: dup
    //   86: invokespecial 150	java/lang/StringBuilder:<init>	()V
    //   89: ldc_w 1331
    //   92: invokevirtual 156	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   95: aload 6
    //   97: invokevirtual 156	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   100: ldc_w 1333
    //   103: invokevirtual 156	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   106: aload_1
    //   107: invokevirtual 156	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   110: ldc_w 1335
    //   113: invokevirtual 156	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   116: iload_2
    //   117: invokevirtual 426	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   120: ldc_w 1337
    ...
    //   137: aload 8
    //   139: invokevirtual 156	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   142: ldc_w 1341
    //   145: invokevirtual 156	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   148: iload_3
    //   149: invokevirtual 426	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   152: invokevirtual 162	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   155: invokestatic 165	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   158: aload 5
    //   160: getfield 1342	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody:bytes_session_id	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   163: aload 6
    //   165: invokestatic 226	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   168: invokevirtual 232	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   171: aload 5
    //   173: getfield 1343	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody:uint64_src_uin	Lcom/tencent/mobileqq/pb/PBUInt64Field;
    //   176: aload_1
    //   177: invokestatic 242	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   180: invokevirtual 247	com/tencent/mobileqq/pb/PBUInt64Field:set	(J)V
    //   183: aload 5
    //   185: getfield 1344	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody:uint32_src_term	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   188: iload_2
    //   189: invokevirtual 256	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   192: aload 5
    //   194: getfield 1347	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody:bytes_appid	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   197: aload 7
    //   199: invokestatic 226	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   202: invokevirtual 232	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   205: aload 5
    //   207: getfield 1350	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody:bytes_version	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   210: aload 8
    //   212: invokestatic 226	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   215: invokevirtual 232	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   218: aload 5
    //   220: getfield 1353	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody:uin32_gender	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   223: iload_3
    //   224: invokevirtual 256	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   227: aload 5
    //   229: getfield 1354	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody:uint32_age	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   232: iload 4
    //   234: invokevirtual 256	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   237: aload 5
    //   239: invokevirtual 1357	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody:toByteArray	()[B
    //   242: astore_1
    //   243: aload_1
    //   244: arraylength
    //   245: iconst_4
    //   246: iadd
    //   247: invokestatic 1363	java/nio/ByteBuffer:allocate	(I)Ljava/nio/ByteBuffer;
    //   250: astore 5
    //   252: aload 5
    //   254: aload_1
    //   255: arraylength
    //   256: iconst_4
    //   257: iadd
    //   258: invokevirtual 1365	java/nio/ByteBuffer:putInt	(I)Ljava/nio/ByteBuffer;
    //   261: aload_1
    //   262: invokevirtual 1368	java/nio/ByteBuffer:put	([B)Ljava/nio/ByteBuffer;
    //   265: pop
    //   266: aload 5
    //   268: invokevirtual 1371	java/nio/ByteBuffer:array	()[B
    //   271: astore_1
    //   272: new 1373	mqq/app/NewIntent
    //   275: dup
    //   276: aload_0
    //   277: getfield 65	aiin:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   280: invokevirtual 96	com/tencent/mobileqq/app/QQAppInterface:getApp	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   283: ldc_w 1375
    //   286: invokespecial 1378	mqq/app/NewIntent:<init>	(Landroid/content/Context;Ljava/lang/Class;)V
    //   289: astore 5
    //   291: aload 5
    //   293: ldc_w 1380
    //   296: aload_1
    //   297: invokevirtual 1384	mqq/app/NewIntent:putExtra	(Ljava/lang/String;[B)Landroid/content/Intent;
    //   300: pop
    //   301: aload 5
    //   303: ldc_w 1386
    //   306: ldc_w 1286
    //   309: invokevirtual 1389	mqq/app/NewIntent:putExtra	(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    //   312: pop
    //   313: aload_0
    //   314: getfield 65	aiin:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   317: aload 5
    //   319: invokevirtual 1393	com/tencent/mobileqq/app/QQAppInterface:startServlet	(Lmqq/app/NewIntent;)V
    //   322: goto -309 -> 13
    //   325: astore_1
    //   326: aload_0
    //   327: monitorexit
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2, aijh paramaijh)
  {
    if (paramaijh != null) {}
    for (;;)
    {
      try
      {
        String str = paramaijh.a();
        if (str == null) {
          return;
        }
        str = paramString1 + SystemClock.uptimeMillis();
        Object localObject1 = a(str, paramString1, paramInt1, paramInt2, paramString2, paramaijh.a()).toByteArray();
        ...
        localObject1 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), aiiu.class);
        ((NewIntent)localObject1).putExtra("key_body", (byte[])localObject2);
        ((NewIntent)localObject1).putExtra("key_cmd", "SceneFaceRec.PullFaces");
        paramaijh = paramaijh.a();
        ((NewIntent)localObject1).putExtra("REQUEST_SCENES_ID", paramaijh);
        ((NewIntent)localObject1).putExtra("USER_KEYWORD", paramaijh);
        boolean bool;
        if (paramInt1 == 4)
        {
          bool = true;
          ...
          if (QLog.isColorLevel()) {
            QLog.d("StickerRecManager", 2, "send pull pics args:sessionId = " + str + " uin=" + paramString1 + " termType=" + paramInt1 + " aioType : " + paramInt2 + " toUin : " + paramString2 + "  scenesID: " + paramaijh);
          }
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2, List<String> paramList)
  {
    ...
    //   9: aload_1
    //   10: invokevirtual 156	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   13: invokestatic 1321	android/os/SystemClock:uptimeMillis	()J
    //   16: invokevirtual 634	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   19: invokevirtual 162	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   22: astore 7
    //   24: aload_0
    //   25: aload 7
    //   27: aload_1
    ...
    //   30: aload 4
    //   32: aload 5
    //   34: invokespecial 1399	aiin:a	(Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/util/List;)Lcom/tencent/pb/emosm/PicSearchSvr$ReqBody;
    //   37: invokevirtual 1400	com/tencent/pb/emosm/PicSearchSvr$ReqBody:toByteArray	()[B
    //   40: astore 8
    //   42: aload 8
    //   44: arraylength
    //   45: iconst_4
    //   46: iadd
    //   47: invokestatic 1363	java/nio/ByteBuffer:allocate	(I)Ljava/nio/ByteBuffer;
    //   50: astore 9
    //   52: aload 9
    //   54: aload 8
    //   56: arraylength
    //   57: iconst_4
    //   58: iadd
    //   59: invokevirtual 1365	java/nio/ByteBuffer:putInt	(I)Ljava/nio/ByteBuffer;
    //   62: aload 8
    //   64: invokevirtual 1368	java/nio/ByteBuffer:put	([B)Ljava/nio/ByteBuffer;
    //   67: pop
    //   68: aload 9
    //   70: invokevirtual 1371	java/nio/ByteBuffer:array	()[B
    //   73: astore 9
    //   75: new 1373	mqq/app/NewIntent
    //   78: dup
    //   79: aload_0
    //   80: getfield 65	aiin:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   83: invokevirtual 96	com/tencent/mobileqq/app/QQAppInterface:getApp	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   86: ldc_w 1375
    //   89: invokespecial 1378	mqq/app/NewIntent:<init>	(Landroid/content/Context;Ljava/lang/Class;)V
    //   92: astore 8
    //   94: aload 8
    //   96: ldc_w 1380
    //   99: aload 9
    //   101: invokevirtual 1384	mqq/app/NewIntent:putExtra	(Ljava/lang/String;[B)Landroid/content/Intent;
    //   104: pop
    //   105: aload 8
    //   107: ldc_w 1386
    //   110: ldc_w 1290
    //   113: invokevirtual 1389	mqq/app/NewIntent:putExtra	(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    //   116: pop
    //   117: aload 5
    //   119: iconst_0
    //   120: invokeinterface 434 2 0
    //   125: checkcast 294	java/lang/String
    //   128: astore 5
    //   130: aload 8
    //   132: ldc_w 1274
    //   135: aload 5
    //   137: invokevirtual 1389	mqq/app/NewIntent:putExtra	(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    //   140: pop
    //   141: iload_2
    //   142: iconst_4
    ...
    //   151: ldc_w 1294
    //   154: iload 6
    //   156: invokevirtual 1405	mqq/app/NewIntent:putExtra	(Ljava/lang/String;Z)Landroid/content/Intent;
    //   159: pop
    //   160: aload 8
    //   162: ldc_w 1281
    //   165: iload_3
    //   166: invokevirtual 1408	mqq/app/NewIntent:putExtra	(Ljava/lang/String;I)Landroid/content/Intent;
    //   169: pop
    ...
    //   213: iload_2
    //   214: invokevirtual 426	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   217: ldc_w 1412
    //   220: invokevirtual 156	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   223: iload_3
    //   224: invokevirtual 426	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   227: ldc_w 1414
    ...
    //   244: aload 5
    //   246: invokestatic 1421	aiin:c	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   255: invokestatic 165	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   258: aload_0
    //   259: getfield 65	aiin:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   262: aload 8
    //   264: invokevirtual 1393	com/tencent/mobileqq/app/QQAppInterface:startServlet	(Lmqq/app/NewIntent;)V
    //   267: aload_0
    //   268: monitorexit
    //   269: return
    //   270: iconst_0
  ...
  public void a(String paramString, boolean paramBoolean, SessionInfo paramSessionInfo)
  {
    ...
    if ((this.jdField_a_of_type_Aiiq != null) && (!this.jdField_a_of_type_JavaUtilList.isEmpty())) {
      this.jdField_a_of_type_Aiiq.a(this.jdField_a_of_type_JavaUtilList, paramString, "999", 0, null);
    }
  }
  ...
  public void a(List<aiiv> paramList, boolean paramBoolean, int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject4 = (aiiv)localIterator1.next();
        if (localObject4 != null)
        {
          str = ((aiiv)localObject4).jdField_a_of_type_JavaLangString;
          localObject2 = ((aiiv)localObject4).jdField_a_of_type_JavaUtilList;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        {
          localObject3 = (aihq)localIterator2.next();
          ((aihq)localObject3).b(System.currentTimeMillis());
          if (((aihq)localObject3).c() != null)
          {
            localObject2 = ((aihq)localObject3).d();
            if (!android.text.TextUtils.isEmpty((CharSequence)localObject2)) {
              ((StringBuilder)localObject6).append((String)localObject2);
            }
            ((StringBuilder)localObject6).append(((aihq)localObject3).c());
            ((StringBuilder)localObject6).append(";");
            if (((aihq)localObject3).a() != null)
            {
              ((StringBuilder)localObject5).append(((aihq)localObject3).a());
              ((StringBuilder)localObject5).append(";");
            }
            localObject2 = localObject1;
            if (((aihq)localObject3).b()) {
              localObject2 = localObject3;
            }
            localObject1 = localObject2;
            if (((aihq)localObject3).a() != 0L)
            {
              aiir.a(true, str, paramInt, paramString, (aihq)localObject3);
              localObject1 = localObject2;
              continue;
              if (paramInt == 1)
              {
      ...
      if (((aiiv)localObject4).jdField_a_of_type_Int == 1)
      {
        localObject2 = new aijg();
        ((aijg)localObject2).l = "dc05550";
        ((aijg)localObject2).c = str;
        ((aijg)localObject2).jdField_a_of_type_JavaLangString = String.valueOf(l);
        ((aijg)localObject2).jdField_b_of_type_JavaLangString = paramString;
        ((aijg)localObject2).d = paramList;
      }
      for (paramList = (List<aiiv>)localObject2;; paramList = (List<aiiv>)localObject2)
      {
        paramList.k = ((aiiv)localObject4).jdField_b_of_type_JavaLangString;
        paramList.e = String.valueOf(AppSetting.a());
        if (localObject1 != null)
        {
          localObject3 = ((aihq)localObject1).c();
          localObject4 = ((aihq)localObject1).d();
          localObject2 = localObject3;
          ...
          paramList.i = ((aihq)localObject1).a();
          aiir.a(false, str, paramInt, paramString, (aihq)localObject1);
        }
        paramList.f = ((String)localObject6);
        paramList.g = ((String)localObject5);
        paramList.j = "android";
        localObject1 = paramList.a();
        localObject2 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), aiiu.class);
        ((NewIntent)localObject2).putExtra("key_cmd", "MQInference.CommonReport");
        ((NewIntent)localObject2).putExtra("key_body", bhjl.a(((JSONObject)localObject1).toString().getBytes()));
        if (QLog.isColorLevel()) {
        ...
        break label22;
        break;
        localObject2 = new aiis();
        ((aiis)localObject2).l = "dc04577";
        ((aiis)localObject2).jdField_b_of_type_JavaLangString = str;
        if (QLog.isColorLevel()) {
          ((aiis)localObject2).jdField_b_of_type_JavaLangString = c(((aiis)localObject2).jdField_b_of_type_JavaLangString);
        }
        ((aiis)localObject2).jdField_a_of_type_JavaLangString = String.valueOf(l);
        ((aiis)localObject2).d = paramString;
        ((aiis)localObject2).c = paramList;
      }
      label715:
      paramList = "";
    }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    bhhr.u(BaseApplication.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin(), paramBoolean);
  }
  ...
  public boolean a(aijh paramaijh, int paramInt, String paramString)
  {
    if (!a()) {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      try
      {
        if ((paramaijh.a() == null) || (StringUtil.isEmpty(paramaijh.a())))
        {
          if (!QLog.isColorLevel()) {
            continue;
          }
      ...
      catch (Exception paramaijh)
      {
        if (QLog.isColorLevel()) {
          QLog.d("StickerRecManager", 2, bkym.a(paramaijh));
        }
      }
    }
    for (;;)
    {
      return true;
      String str = paramaijh.a();
      this.jdField_a_of_type_MqqOsMqqHandler.post(new StickerRecManager.4(this, str, paramInt, paramString, paramaijh));
    }
  }
  ...
  public boolean a(String paramString1, int paramInt, String paramString2, boolean paramBoolean1, boolean paramBoolean2, SessionInfo paramSessionInfo)
  {
    ...
    try
    {
      ...
      if (!bool)
      {
        ...
        if ((!paramBoolean2) || (this.jdField_a_of_type_Aiiq == null)) {
          break label255;
        }
    ...
    catch (Exception paramString1)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("StickerRecManager", 2, bkym.a(paramString1));
        }
      }
    }
    return true;
  ...
  public Collection<String> b()
  {
    ...
    Object localObject1 = ((asfk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.FAVROAMING_DB_MANAGER)).a();
    if (localObject1 != null)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if (("isUpdate".equals(((CustomEmotionData)localObject2).RomaingType)) || ("needDownload".equals(((CustomEmotionData)localObject2).RomaingType)) || ("overflow".equals(((CustomEmotionData)localObject2).RomaingType)) || ("overflow_downloaded".equals(((CustomEmotionData)localObject2).RomaingType))) {
          ...
          {
            localObject2 = localawyr.a(((CustomEmotionData)localObject2).emoPath, ((CustomEmotionData)localObject2).eId);
  ...
  public void b(List<aiiv> paramList)
  {
    Iterator localIterator = new ArrayList(paramList).iterator();
    while (localIterator.hasNext())
    {
      Object localObject1 = (aiiv)localIterator.next();
      if (localObject1 != null)
      {
        Object localObject2 = ((aiiv)localObject1).jdField_a_of_type_JavaLangString;
        int i = ((aiiv)localObject1).jdField_a_of_type_Int;
        label103:
        Object localObject3;
        if (i == 1)
        {
          ...
          localObject1 = ((aiiv)localObject1).jdField_a_of_type_JavaUtilList.iterator();
          do
          {
            if (!((Iterator)localObject1).hasNext()) {
              break;
            }
            localObject2 = (aihq)((Iterator)localObject1).next();
          } while (((aihq)localObject2).a());
          localObject2 = (aiig)localObject2;
          localObject3 = Integer.valueOf(((aiig)localObject2).d());
          if (!((aiig)localObject2).b()) {
            break label224;
          }
        ...
        localObject2 = ((aiiv)localObject1).jdField_a_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject2).hasNext())
        {
          localObject3 = (aihq)((Iterator)localObject2).next();
          if (!((aihq)localObject3).a())
          {
            localObject3 = (aiig)localObject3;
            if (((aiig)localObject3).b()) {
              paramList.addClicked(Integer.valueOf(((aiig)localObject3).d()));
            } else {
              paramList.addExposed(Integer.valueOf(((aiig)localObject3).d()));
            }
          }
        }
        localObject1 = ((aiiv)localObject1).jdField_b_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject1).hasNext())
        {
          localObject2 = (aihq)((Iterator)localObject1).next();
          if (!((aihq)localObject2).a()) {
            paramList.addNoExpose(Integer.valueOf(((aiig)localObject2).d()));
          }
        }
        if ((paramList.noExposeList != null) && (paramList.noExposeList.size() == 0))
        {
