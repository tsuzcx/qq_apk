  ...
  implements ahoj, ahrg
{
  ...
  MqqHandler jdField_a_of_type_MqqOsMqqHandler = new MqqHandler(Looper.getMainLooper(), new atgj(this));
  private boolean jdField_a_of_type_Boolean;
  
  public atgi(Activity paramActivity)
  {
    super(paramActivity);
  ...
  public static boolean a()
  {
    ...
    return (localaokc != null) && (localaokc.f());
  }
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewPullrefreshCommonRefreshLayout = ((CommonRefreshLayout)paramView.findViewById(2131377256));
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewPullrefreshContactRefreshHeader.setRefreshHeaderUpdateListener(new atgk(this));
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewPullrefreshCommonRefreshLayout.setOnRefreshListener(this);
    this.jdField_a_of_type_ComTencentWidgetListView = ((ListView)paramView.findViewById(2131369322));
