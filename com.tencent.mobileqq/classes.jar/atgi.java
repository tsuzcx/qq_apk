...
public class atgi
{
  ...
  atha jdField_a_of_type_Atha = null;
  ...
  List<Integer> jdField_f_of_type_JavaUtilList = Arrays.asList(new Integer[] { Integer.valueOf(2131367148), Integer.valueOf(2131367150), Integer.valueOf(2131367151), Integer.valueOf(2131367152), Integer.valueOf(2131367153), Integer.valueOf(2131367154), Integer.valueOf(2131367155), Integer.valueOf(2131367156), Integer.valueOf(2131367157), Integer.valueOf(2131367149) });
  int g;
  int h = 0;
  int i = 0;
  int j = 0;
  ...
  public atgi(QQAppInterface paramQQAppInterface, Context paramContext)
  {
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    ...
    for (long l = a(800, 1500);; l = 750L)
    {
      ...
      localRotateAnimation.setInterpolator(new atgn(this));
      this.jdField_a_of_type_AndroidWidgetImageView.startAnimation(localRotateAnimation);
      localRotateAnimation.setAnimationListener(new atgl(this, paramInt, paramBoolean));
      return;
    }
  }
  
  public void a(atha paramatha, boolean paramBoolean)
  {
    if ((paramatha == null) || (this.jdField_a_of_type_AndroidContentContext == null))
    {
      if (QLog.isColorLevel()) {
        QLog.d(Face2FaceAddFriendActivity.a, 2, "startFriendDisappearAnimation disappear data is " + paramatha + " mContext " + this.jdField_a_of_type_AndroidContentContext);
      }
      return;
    }
    Object localObject = paramatha.e;
    if ((paramatha instanceof atgx)) {
      localObject = paramatha.e + "_" + ((atgx)paramatha).b;
    }
    ...
    for (int m = ((Integer)this.jdField_a_of_type_JavaUtilMap.get(localObject)).intValue();; m = -1)
    {
      if (m == -1)
      {
        ...
        QLog.d(Face2FaceAddFriendActivity.a, 2, "startFriendDisappearAnimation disappear uin " + paramatha.e.substring(0, 4) + " is not in the hole");
        QLog.d(Face2FaceAddFriendActivity.b, 2, "startFriendDisappearAnimation disappear uin " + paramatha.e.substring(0, 4) + " is not in the hole");
        this.h += 1;
        return;
      }
      ...
      if (paramBoolean)
      {
        ...
        localAnimationSet.setInterpolator(new atgo(this));
        localAnimationSet.setAnimationListener(new atgk(this));
        if (localObject != null) {
      ...
      if (QLog.isColorLevel()) {
        QLog.d(Face2FaceAddFriendActivity.a, 2, "startFriendDisappearAnimation disappear uin " + paramatha.e.substring(0, 4));
      }
      ...
      a(m);
      ((Face2FaceAddFriendActivity)this.jdField_a_of_type_AndroidContentContext).c(paramatha);
  ...
  public void a(atha paramatha, boolean paramBoolean1, int paramInt, boolean paramBoolean2, boolean paramBoolean3)
  {
    if ((paramatha == null) || (this.jdField_a_of_type_AndroidContentContext == null)) {
      if (QLog.isColorLevel()) {
        QLog.d(Face2FaceAddFriendActivity.a, 2, "startFriendInAnimation  data is " + paramatha + " mContext " + this.jdField_a_of_type_AndroidContentContext);
      }
    }
    int n;
    int m;
    ...
    ((Face2FaceFriendBubbleView)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramatha);
    ...
    if (QLog.isColorLevel())
    {
      if (!TextUtils.isEmpty(paramatha.e)) {
        QLog.d(Face2FaceAddFriendActivity.a, 2, "startFriendInAnimation get ( currentUin= " + paramatha.e.substring(0, 4) + " , index = " + m + " )");
      }
    }
    else
    {
    ...
    for (;;)
    {
      ...
      default: 
        ...
        ((TranslateAnimation)localObject2).setInterpolator(new atgo(this));
        ((TranslateAnimation)localObject2).setAnimationListener(new atgj(this, paramatha, m, d1, bool, paramBoolean3, paramatha, paramBoolean1, paramBoolean2, (Face2FaceFriendBubbleView)localObject1, paramInt));
        ((Face2FaceFriendBubbleView)localObject1).startAnimation((Animation)localObject2);
        localObject1 = paramatha.e;
        if ((paramatha instanceof atgx)) {
          localObject1 = paramatha.e + "_" + ((atgx)paramatha).b;
        }
        break;
      }
      for (;;)
      {
        ...
        ((Face2FaceAddFriendActivity)this.jdField_a_of_type_AndroidContentContext).a(paramatha, paramBoolean1, paramBoolean2);
        if (QLog.isColorLevel()) {
        ...
        {
          QLog.d(Face2FaceAddFriendActivity.a, 2, "startFriendInAnimation currentUIn= " + paramatha.e.substring(0, 4) + " startAnimation OK");
          return;
          m = n;
          if (this.jdField_c_of_type_JavaUtilList.size() <= 1) {
            break label91;
  ...
  public void a(QQAppInterface paramQQAppInterface, View paramView, int paramInt, String paramString)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131364919));
    if ((paramInt == 1) && (!TextUtils.isEmpty(paramString)))
    {
      ((ImageView)paramView.findViewById(2131364920)).setVisibility(4);
      ...
      paramQQAppInterface = bhmq.f();
    }
    label476:
    for (;;)
    {
      paramString = (ImageView)paramView.findViewById(2131379385);
  ...
  public void b()
  {
    ...
    for (this.jdField_b_of_type_Float = (this.jdField_a_of_type_Float - m);; this.jdField_b_of_type_Float = (m + f2))
    {
      ...
      this.jdField_a_of_type_AndroidViewAnimationRotateAnimation.setInterpolator(new atgn(this));
      this.jdField_a_of_type_AndroidWidgetImageView.startAnimation(this.jdField_a_of_type_AndroidViewAnimationRotateAnimation);
      this.jdField_a_of_type_AndroidViewAnimationRotateAnimation.setAnimationListener(new atgm(this));
      return;
