  ...
  extends DynamicTextItem
{
  ...
  public borq(Context paramContext, int paramInt, List<String> paramList, Typeface paramTypeface)
  {
    ...
    this.jdField_a_of_type_AndroidTextTextPaint.setTextSize(afur.a(28.0F, paramContext.getResources()));
  ...
  public InputFilter a()
  {
    if (this.jdField_a_of_type_AndroidTextInputFilter == null) {
      this.jdField_a_of_type_AndroidTextInputFilter = new bors(this, 20);
    }
  ...
  public CharSequence a(String[] paramArrayOfString)
  {
    ...
    while (i < j - 1)
    {
      ((SpannableString)localObject).setSpan(new AbsoluteSizeSpan(afur.a(((Integer)paramArrayOfString.get(i)).intValue(), this.jdField_a_of_type_AndroidContentContext.getResources())), i, i + 1, 33);
      i += 1;
    }
    return localObject;
  }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    paramString = super.a(paramInt, new borr(this));
    this.jdField_a_of_type_JavaLangString = paramString;
    if (0 == 0) {}
    for (paramString = a(paramString);; paramString = null)
    {
      paramString = a(paramString);
      this.jdField_a_of_type_AndroidTextStaticLayout = bory.a(paramString, 0, paramString.length(), this.jdField_a_of_type_AndroidTextTextPaint, this.jdField_b_of_type_Int, Layout.Alignment.ALIGN_CENTER, 1.0F, 0.0F, false, null, 0, 3);
