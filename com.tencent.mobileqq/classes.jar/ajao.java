...
public class ajao
  implements ajbp
{
  public static List<ajao> a;
  private int jdField_a_of_type_Int;
  private ajav jdField_a_of_type_Ajav;
  private AudioManager.OnAudioFocusChangeListener jdField_a_of_type_AndroidMediaAudioManager$OnAudioFocusChangeListener = new ajau(this);
  ...
  public ajao(int paramInt1, int paramInt2, String arg3)
  {
    this.jdField_a_of_type_Int = paramInt1;
    this.jdField_b_of_type_Int = paramInt2;
    ajch localajch = ajae.a(paramInt2);
    if (localajch != null) {
      localajch.b(0);
    }
    if ("effect".equals(???)) {
      if (localajch != null) {
        this.jdField_a_of_type_Ajav = new ajav(paramInt2);
      }
    }
    for (;;)
    {
      ...
      synchronized (jdField_a_of_type_JavaUtilList)
      {
        ...
        a(1);
        this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnErrorListener(new ajap(this));
      }
    }
  }
  
  private void a(ajbo paramajbo, JSONObject paramJSONObject)
  {
    if (paramajbo != null) {
    ...
    try
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_Ajav != null)
        {
          ...
          this.jdField_a_of_type_Ajav = null;
          return null;
        }
      }
  ...
  public JSONObject a(int paramInt, JSONObject paramJSONObject, ajbo paramajbo)
  {
    int i;
    if (this.jdField_a_of_type_AndroidMediaMediaPlayer != null)
    {
      ...
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnSeekCompleteListener(new ajaq(this, paramJSONObject, paramajbo));
  ...
  public JSONObject a(ajbo paramajbo, JSONObject paramJSONObject)
  {
    if (paramJSONObject != null) {
      try
      {
        if (paramJSONObject.optInt("N_R_OBJ") == this.jdField_a_of_type_Int)
        {
          ...
          if ("cs.audio_play.local".equals(str)) {
            return b(paramJSONObject, paramajbo);
          }
          ...
          if ("cs.audio_load.local".equals(str)) {
            return c(paramJSONObject, paramajbo);
          }
          ...
          if ("cs.audio_seek.local".equals(str)) {
            return a(paramJSONObject.optInt("seek"), paramJSONObject, paramajbo);
          }
          if ("cs.audio_src.local".equals(str)) {
            return a(paramJSONObject.optString("src"), paramJSONObject, paramajbo);
          }
          ...
          if ("cs.audio_destroy.local".equals(str)) {
            return b(paramajbo, paramJSONObject);
          }
          if ("cs.audio_onend.local".equals(str)) {
            return e(paramJSONObject, paramajbo);
          }
          ...
          {
            paramajbo = a(paramJSONObject, paramajbo);
            return paramajbo;
          }
        }
      }
      ...
      {
        QLog.e("CmGameAudioPlayer", 1, "audio failed", paramajbo);
      }
    }
    return null;
  }
  
  public JSONObject a(String paramString, JSONObject paramJSONObject, ajbo paramajbo)
  {
      ...
      try
      {
        ...
        if (localajch != null)
        {
          ...
          for (;;)
          {
            ...
            a(2);
            return paramJSONObject;
            paramString = aiyg.a(paramString, localajch.a(), str1, false);
          }
        }
  ...
  public JSONObject a(JSONObject paramJSONObject, ajbo paramajbo)
  {
    try
    {
      if (paramJSONObject.has("src")) {
        a(paramJSONObject.optString("src"), paramJSONObject, paramajbo);
      }
      ...
      if (paramJSONObject.has("currentTime")) {
        d(paramJSONObject, paramajbo);
      }
      return paramJSONObject;
    }
    catch (Throwable paramajbo)
    {
      QLog.e("CmGameAudioPlayer", 1, paramajbo, new Object[0]);
    }
    return paramJSONObject;
  }
  ...
  public JSONObject a(boolean paramBoolean, float paramFloat1, float paramFloat2, JSONObject paramJSONObject)
  {
    ...
    } while (this.jdField_a_of_type_Ajav == null);
    Object localObject = this.jdField_a_of_type_Ajav;
    if ((paramBoolean) || ((Float.compare(paramFloat1, 0.0F) == 0) && (Float.compare(paramFloat2, 0.0F) == 0))) {}
    for (int i = 0;; i = 1)
    {
      ((ajav)localObject).a(i, BaseActivity.sTopActivity.getAppInterface());
      return paramJSONObject;
    }
  }
  ...
  public JSONObject b(ajbo arg1, JSONObject paramJSONObject)
  {
    try
    {
      if (this.jdField_a_of_type_AndroidMediaMediaPlayer != null) {
  ...
  public JSONObject b(JSONObject paramJSONObject)
  {
    for (;;)
    {
      ...
      if (paramJSONObject.optBoolean("auto", true)) {
        this.jdField_a_of_type_Ajav.a();
      } else {
        this.jdField_a_of_type_Ajav.a(i, null);
      }
    }
  }
  
  public JSONObject b(JSONObject paramJSONObject, ajbo paramajbo)
  {
    if (this.jdField_a_of_type_AndroidMediaMediaPlayer != null)
    {
      i = a();
    ...
    while (this.jdField_a_of_type_Ajav == null) {
      for (;;)
      {
        ...
        try
        {
          ...
          this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnCompletionListener(new ajar(this));
        }
    ...
    a(true);
    return this.jdField_a_of_type_Ajav.a(paramajbo, paramJSONObject);
  }
  ...
  public JSONObject c(JSONObject paramJSONObject, ajbo paramajbo)
  {
    if ((this.jdField_a_of_type_AndroidMediaMediaPlayer != null) && ((a() == 2) || (a() == 6)))
    {
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnPreparedListener(new ajas(this, paramJSONObject, paramajbo));
  ...
  public JSONObject d(JSONObject paramJSONObject, ajbo paramajbo)
  {
    int i;
  ...
  public JSONObject e(JSONObject paramJSONObject)
  {
    if (this.jdField_a_of_type_Ajav != null)
    {
      this.jdField_a_of_type_Ajav.c(paramJSONObject.optInt("id"), null);
      this.jdField_a_of_type_Ajav.a(paramJSONObject);
    }
    if (this.jdField_a_of_type_AndroidMediaMediaPlayer != null)
    {
  ...
  public JSONObject e(JSONObject paramJSONObject, ajbo paramajbo)
  {
    if (this.jdField_a_of_type_AndroidMediaMediaPlayer != null) {
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnCompletionListener(new ajat(this, paramajbo, paramJSONObject));
    }
    return null;
  }
  ...
  public JSONObject f(JSONObject paramJSONObject)
  {
    if (this.jdField_a_of_type_Ajav != null)
    {
      if (paramJSONObject.optBoolean("audo", true)) {
        this.jdField_a_of_type_Ajav.b();
      }
    }
    else {
      return paramJSONObject;
    }
    this.jdField_a_of_type_Ajav.b(paramJSONObject.optInt("id"), null);
    return paramJSONObject;
  }
}
