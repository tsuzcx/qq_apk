  ...
  implements bnok
{
  ...
  public bnoq(Context paramContext, boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  private Bitmap a(Context paramContext, Bitmap paramBitmap, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      label26:
      int k = bnzv.jdField_a_of_type_Int;
      if (j <= k) {
        break label226;
      }
      i = (int)(i * k / j);
    ...
    for (;;)
    {
      ...
      {
        localObject = bfvo.a(paramContext, bfvo.c(paramBitmap), 0.4F, 25.0F);
      ...
      for (;;)
      {
        paramContext = yoy.a(yoy.a(paramContext, i, j, true), paramBitmap);
  ...
  public boolean a(String paramString, long paramLong1, long paramLong2, int paramInt, bnor parambnor)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambnor);
  ...
  public void c()
  {
    ...
    if (this.jdField_a_of_type_Boac != null) {
      this.jdField_a_of_type_Boac.a();
    }
  }
}
