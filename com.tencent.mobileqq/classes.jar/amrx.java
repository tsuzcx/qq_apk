...
public class amrx
{
  ...
  public final CopyOnWriteArrayList<amry> a;
  ...
  public static amrx a()
  {
    if (jdField_a_of_type_Amrx == null) {}
    try
    {
      if (jdField_a_of_type_Amrx == null) {
        jdField_a_of_type_Amrx = new amrx();
      }
      return jdField_a_of_type_Amrx;
    }
    finally {}
  }
  ...
  private void c(String paramString)
  {
    ...
    if (localObject2.length == 3)
    {
      ...
      {
        localObject1 = new File(bhkt.c((String)localObject1));
        if (((File)localObject1).exists())
        {
          ...
          localObject1 = bhgm.a(((File)localObject1).getAbsolutePath());
  ...
  public Bitmap a(amru paramamru, int paramInt)
  {
    if ((paramamru == null) || (TextUtils.isEmpty(paramamru.jdField_a_of_type_JavaLangString))) {
      return null;
    }
    if (this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.containsKey(paramamru.jdField_a_of_type_JavaLangString))
    {
      Object localObject = (DiyPendantEntity)this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.get(paramamru.jdField_a_of_type_JavaLangString);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(paramamru);
      paramamru = BaseApplicationImpl.getApplication().getRuntime();
      if ((paramamru instanceof QQAppInterface)) {
        a((QQAppInterface)paramamru, 500);
      }
      return null;
      if (QLog.isColorLevel()) {
        QLog.i("DiyPendantFetcher", 2, "can not found cache in DiyPendantCache! " + paramamru.jdField_a_of_type_JavaLangString);
      }
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArraySet.add(paramamru.jdField_a_of_type_JavaLangString);
    }
  }
  
  public Bitmap a(amry paramamry, String paramString, int paramInt1, int paramInt2, float paramFloat, int paramInt3, int paramInt4, int paramInt5, Paint paramPaint)
  {
    ...
    Object localObject = bhkt.a(String.valueOf(paramInt1));
    if (!this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_isFontLoaded(paramInt1))
    {
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(paramamry);
      if (bhkt.a(String.valueOf(paramInt1)))
      {
        if (QLog.isColorLevel()) {
    ...
    paramamry = new ETFont(paramInt1, (String)localObject, paramFloat);
    paramamry.setColor(paramInt3);
    try
    {
      localObject = Bitmap.createBitmap(paramInt4, paramInt5, Bitmap.Config.ARGB_8888);
      if (!this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_isPaintableChar(paramString.charAt(0), paramamry)) {
        break label590;
      }
      for (paramInt1 = this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_spaceMeasureText(paramString, 0, paramString.length(), paramamry, paramPaint); paramInt1 > paramInt4; paramInt1 = this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_spaceMeasureText(paramString, 0, paramString.length(), paramamry, paramPaint)) {
        paramamry.mFontSize -= 1;
      }
      paramInt2 = (paramInt4 - paramInt1) / 2;
    }
    catch (OutOfMemoryError paramamry)
    {
      QLog.d("DiyPendantFetcher", 1, "fetchTextWithFont Bitmap.createBitmap OutOfMemoryError: " + paramamry.getMessage());
      return null;
    }
    paramInt1 = 0;
    paramPaint = new Paint.FontMetrics();
    if (this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_getFontMetrics(paramPaint, paramamry))
    {
      paramFloat = paramPaint.bottom;
      float f = paramPaint.top;
      paramInt1 = (int)((paramInt5 - (paramFloat - f)) / 2.0F);
    }
    if (!this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_drawText(paramString, (Bitmap)localObject, paramInt2, paramInt1, paramamry))
    {
  ...
  public Typeface a(amry paramamry, int paramInt1, int paramInt2)
  {
    if ((paramamry == null) || (paramInt1 <= 0)) {
      return null;
    }
  ...
  public DiyPendantEntity a(QQAppInterface paramQQAppInterface, String paramString, anui paramanui)
  {
    ...
    ((amrz)paramQQAppInterface.a(114)).a((List)localObject, paramanui);
    return null;
  }
  ...
  public List<DiyPendantSticker> a(amru paramamru)
  {
    if ((paramamru == null) || (TextUtils.isEmpty(paramamru.jdField_a_of_type_JavaLangString))) {
      return null;
    }
    if (this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.containsKey(paramamru.jdField_a_of_type_JavaLangString)) {
      return ((DiyPendantEntity)this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.get(paramamru.jdField_a_of_type_JavaLangString)).getStickerInfoList();
    }
    if (QLog.isColorLevel()) {
      QLog.i("DiyPendantFetcher", 2, "can not found cache in DiyPendantCache! " + paramamru.jdField_a_of_type_JavaLangString);
    }
  ...
  {
    String str = bhkt.a(String.valueOf(paramInt1));
  ...
  public void a(QQAppInterface paramQQAppInterface, boolean paramBoolean, List<DiyPendantEntity> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if (paramBoolean)
      {
        ...
        ExtensionInfo localExtensionInfo = localanyw.a(localDiyPendantEntity.uinAndDiyId.split("_")[0]);
