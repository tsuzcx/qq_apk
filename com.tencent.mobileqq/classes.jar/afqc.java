...
public class afqc
  extends afpx
  implements afqs, afth, afto
{
  private int jdField_a_of_type_Int;
  private afow jdField_a_of_type_Afow;
  private afrv jdField_a_of_type_Afrv;
  private ajxj jdField_a_of_type_Ajxj = new afqj(this);
  ...
  MqqHandler jdField_a_of_type_MqqOsMqqHandler = new MqqHandler(Looper.getMainLooper(), new afqd(this));
  ...
  public afqc(Activity paramActivity)
  {
    super(paramActivity);
    ...
    this.jdField_a_of_type_Afow = new afow(localakaa.b("sp_mayknow_entry_list_recommend"));
    int i;
    if (localakaa.b())
    {
      i = 2;
    ...
    label189:
    for (paramActivity = new afsn(paramActivity);; paramActivity = new afsg(paramActivity))
    {
      this.jdField_a_of_type_Afrv = paramActivity;
      this.jdField_a_of_type_Afrv.a(new afqe(this));
  ...
  {
    int i = this.jdField_a_of_type_Afow.b(1);
    if (this.jdField_a_of_type_Afow.a())
    {
      int m = bbkb.ag(a(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
      int j = 0;
      ...
      {
        i = this.jdField_a_of_type_Afow.b(1);
        k = i;
        if (QLog.isColorLevel()) {
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (this.jdField_c_of_type_Boolean)
    {
      ...
      int i = this.jdField_a_of_type_Afow.a(this.jdField_b_of_type_Int);
      if (a())
      {
        i = this.jdField_a_of_type_Afow.b(i);
        if ((i == -1) || (paramBoolean2)) {
          i = a(paramBoolean1);
        }
        c(i);
        this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewContactsViewPager.setOffscreenPageLimit(this.jdField_a_of_type_Afow.jdField_a_of_type_JavaUtilArrayList.size());
      }
  ...
  private boolean a()
  {
    ...
    akaa localakaa = (akaa)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159);
    if (localakaa != null) {
      bool1 = localakaa.b("sp_mayknow_entry_list_recommend");
    }
    for (boolean bool1 = this.jdField_a_of_type_Afow.a(bool1);; bool1 = false)
    {
      if (bool1)
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsViewPagerAdapter.a(this.jdField_a_of_type_Afow.jdField_a_of_type_JavaUtilArrayList);
        this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator.setTabData(this.jdField_a_of_type_Afow.jdField_a_of_type_ArrayOfJavaLangString, this.jdField_a_of_type_Afow.jdField_a_of_type_ArrayOfInt);
      }
      bool2 = bool1;
      if (!QLog.isColorLevel()) {
        break;
      }
      QLog.i("ContactsViewController", 2, "checkAndUpdateRecommendTabShow. mCurrentTabPos:" + this.jdField_b_of_type_Int + " isShowRecommendTab:" + this.jdField_a_of_type_Afow.a() + " changed:" + bool1);
      return bool1;
    }
  }
  ...
  private void b(int paramInt)
  {
    ...
    this.jdField_a_of_type_Afrv.d();
    this.jdField_d_of_type_Int = paramInt;
    if (this.jdField_d_of_type_Int == 2) {}
    for (Object localObject = new afsn(this.jdField_a_of_type_AndroidAppActivity);; localObject = new afsg(this.jdField_a_of_type_AndroidAppActivity))
    {
      this.jdField_a_of_type_Afrv = ((afrv)localObject);
      this.jdField_a_of_type_Afrv.a(new afqf(this));
      this.jdField_a_of_type_Afrv.b();
      this.jdField_a_of_type_Afrv.a(this.jdField_a_of_type_AndroidViewView);
      if (!this.jdField_c_of_type_Boolean) {
        break;
      }
      this.jdField_a_of_type_Afrv.a(false);
      return;
    }
  }
  ...
  private static boolean b()
  {
    ...
    return (localamta != null) && (localamta.e());
  }
  ...
  public int a(int paramInt, boolean paramBoolean)
  {
    ...
    {
      str = "";
      switch (this.jdField_a_of_type_Afow.a(paramInt))
      {
      }
    }
    for (;;)
  ...
  public void a(View paramView)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator = ((SimpleSlidingIndicator)paramView.findViewById(2131376283));
    k();
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewHeaderScrollView = ((HeaderScrollView)paramView.findViewById(2131364640));
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewContactsViewPager = ((ContactsViewPager)paramView.findViewById(2131364643));
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsViewPagerAdapter = new ContactsViewPagerAdapter(((SplashActivity)a()).getSupportFragmentManager(), ((SplashActivity)a()).app, (BaseActivity)a(), this.jdField_a_of_type_Afow.jdField_a_of_type_JavaUtilArrayList);
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewContactsViewPager.setOffscreenPageLimit(this.jdField_a_of_type_Afow.jdField_a_of_type_JavaUtilArrayList.size());
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewContactsViewPager.setOnPageChangeListener(new afqg(this));
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator.setTabData(this.jdField_a_of_type_Afow.jdField_a_of_type_ArrayOfJavaLangString, this.jdField_a_of_type_Afow.jdField_a_of_type_ArrayOfInt);
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewPullrefreshContactRefreshHeader.setRefreshHeaderUpdateListener(new afqh(this));
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewPullrefreshCommonRefreshLayout.setOnRefreshListener(this);
    this.jdField_a_of_type_Afrv.a(paramView);
    if (b()) {
      n();
    }
    c(a(false));
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewHeaderScrollView.setOnScrollListener(new afqi(this));
  }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface != null)
    {
      ...
      akaa localakaa = (akaa)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159);
      if ((localakaa == null) || (localakaa.b("sp_mayknow_entry_list_recommend") == this.jdField_a_of_type_Afow.a())) {
        break label251;
      }
    }
    label251:
    for (boolean bool = true;; bool = false)
    {
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_Afrv.a(paramQQAppInterface);
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Afrv.a(paramBoolean);
  ...
  public void f()
  {
    try
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator.a(2131364652, sfe.a());
  ...
  public void h()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsViewPagerAdapter != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewContactsViewPager != null))
    {
      ...
      if ((i == this.jdField_a_of_type_Afow.b(1)) || (i == this.jdField_a_of_type_Afow.b(2)) || (i == this.jdField_a_of_type_Afow.b(0))) {
        this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewHeaderScrollView.scrollTo(0, 0);
      }
    }
    this.h = false;
  ...
  public void i()
  {
    ...
    this.jdField_a_of_type_Afrv.c(bool);
    if (this.jdField_a_of_type_ComTencentMobileqqMiniEntryContactsMiniAppEntryManager != null) {
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator != null) {
      this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator.setCurrentPosition(this.jdField_a_of_type_Afow.b(3), false);
    }
  }
