...
{
  public azou(CustomCoverFragment paramCustomCoverFragment) {}
  
  public void onClick(View paramView)
  {
    int i = 1;
    if (paramView.getId() == 2131369347) {
      if (CustomCoverFragment.a(this.a) != null)
      {
        ...
        localObject = (aocy)CustomCoverFragment.a(this.a).getBusinessHandler(BusinessHandlerFactory.SVIP_HANDLER);
        if (!CustomCoverFragment.b(this.a)) {
          break label172;
        }
        i = 1;
        ((aocy)localObject).h(i);
        CustomCoverFragment.a(this.a).a(0, this.a.getString(2131698574), 0, CustomCoverFragment.a(this.a));
    ...
    for (int j = ((Integer)localObject).intValue();; j = 0)
    {
      if ((paramView instanceof Button))
      {
        if (CustomCoverFragment.c(this.a))
        {
          QQToast.a(this.a.getActivity(), 0, 2131690713, 0).a();
          break;
        }
      ...
      for (i = 2;; i = 0)
      {
        ...
        aeow.a(this.a.getActivity(), (Intent)localObject, PublicFragmentActivity.class, CoverDetailFragment.class, 2001);
        break;
      }
    }
  }
