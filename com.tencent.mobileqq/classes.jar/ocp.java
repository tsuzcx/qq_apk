...
public class ocp
{
  ...
  public static Pair<List<GiftServiceBean>, List<GiftServiceBean>> a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramString = ndd.a(BaseApplicationImpl.getContext(), paramString, "GET", null, (Bundle)localObject1);
        if (paramString != null)
        {
  ...
  public static Pair<Boolean, String> a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    paramString1 = ors.a();
    paramString1 = ((TicketManager)((QQAppInterface)ors.a()).getManager(2)).getSkey(paramString1);
    ...
    for (paramString1 = "";; paramString1 = a(paramString1))
    {
      ...
      try
      {
        paramString1 = ndd.a(BaseApplicationImpl.getContext(), localStringBuilder.toString(), "GET", null, paramString1);
        if (paramString1 == null) {
          break;
        }
        bool2 = bool5;
  ...
  public static JSONObject a(int paramInt1, String paramString1, String paramString2, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    localJSONObject.put("net_type", String.valueOf(nmh.a()));
    localJSONObject.put("plat_id", 1);
    localJSONObject.put("imei", ods.a());
    if (!TextUtils.isEmpty(ors.a())) {
      localJSONObject.put("uin", Long.valueOf(ors.a()));
    }
