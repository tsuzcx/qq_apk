  ...
  implements aiqy
{
  ...
  aiqx jdField_a_of_type_Aiqx = aiqx.a();
  String jdField_a_of_type_JavaLangString;
  List<aiqw> jdField_a_of_type_JavaUtilList;
  Paint b = new Paint();
  int c;
  int d;
  
  public aiqu(Resources paramResources)
  {
  ...
  public List<aiqw> a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        List localList1 = this.jdField_a_of_type_Aiqx.a(this);
        ...
        if (i < localList1.size())
        {
          ...
          this.jdField_a_of_type_JavaUtilList.add(new aiqv(this, i, localDiyPendantSticker.angle, localDiyPendantSticker.text, localDiyPendantSticker.fontId, localDiyPendantSticker.fontType, j));
          i += 1;
          continue;
        }
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    if ((localObject != null) && (!((List)localObject).isEmpty()))
    {
      ...
      while (((Iterator)localObject).hasNext()) {
        ((aiqw)((Iterator)localObject).next()).a(paramCanvas, this.jdField_a_of_type_AndroidGraphicsPaint);
      }
    }
  }
