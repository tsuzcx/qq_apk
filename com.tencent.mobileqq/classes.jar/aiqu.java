  ...
  extends Handler
{
  ...
  public aiqu(NewPhotoListActivity paramNewPhotoListActivity)
  {
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      QQToast.a((Context)localObject2, ((NewPhotoListActivity)localObject2).getResources().getString(2131695264), 0).a();
      return;
    ...
    for (;;)
    {
      ...
      return;
      QQToast.a((Context)localObject2, String.format(((NewPhotoListActivity)localObject2).getResources().getString(2131695260), new Object[] { Integer.valueOf(aiqy.getInstance().maxSelectNum) }), 0).a();
    }
  }
}
