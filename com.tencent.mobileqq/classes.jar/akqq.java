...
public class akqq
{
  ...
  public static android.graphics.drawable.Drawable a(Context paramContext, int paramInt1, int paramInt2, String paramString)
  {
    ...
    //   22: iload_1
    //   23: iload_2
    //   24: invokespecial 38	apgh:<init>	(IFII)V
    //   27: astore 5
    //   29: new 27	apgh
    //   32: dup
    //   33: ldc 29
    ...
    //   42: iload_1
    //   43: iload_2
    //   44: invokespecial 38	apgh:<init>	(IFII)V
    //   47: astore_0
    //   48: new 27	apgh
    //   51: dup
    //   52: aload_3
    ...
    //   60: iload_1
    //   61: iload_2
    //   62: invokespecial 38	apgh:<init>	(IFII)V
    //   65: astore 4
    //   67: new 27	apgh
    //   70: dup
    ...
    //   108: iload_1
    //   109: iload_2
    //   110: invokespecial 38	apgh:<init>	(IFII)V
    //   113: astore_3
    //   114: aload_3
    //   115: sipush 204
        ...
        if (paramInt1 >= 0)
        {
          ...
          for (;;)
          {
            ...
            if ((((MessageForApollo)localObject2).gameId == paramInt2) && (((MessageForApollo)localObject2).roomId == paramLong))
            {
              ...
              if (a()) {
                localakje.a().a((MessageForApollo)localObject2);
              }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, ApolloGameData paramApolloGameData, int paramInt)
  {
    ...
    if (!bdem.a(paramContext, paramApolloGameData.gameAppPkgName))
    {
    ...
    ((akji)paramQQAppInterface.getManager(153)).a().a(paramApolloGameData.gameId, paramApolloGameData.gameAppid, 0, paramSessionInfo.jdField_a_of_type_JavaLangString, paramInt);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localaliq.e = 1;
        localaliq.d = 3;
        a(paramQQAppInterface, paramString, localaliq);
        return;
        localaliq.jdField_b_of_type_JavaLangString = alpo.a(2131702488);
        i = 0;
      }
    }
  }
  
  public static void a(QQAppInterface paramQQAppInterface, String paramString, aliq paramaliq)
  {
    if ((paramaliq == null) || (paramQQAppInterface == null))
    {
      QLog.e("CmGameTemp_CmGameSessionUtil", 1, "[sendGameMsg], errInfo->param is null.");
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.d("CmGameTemp_CmGameSessionUtil", 2, new Object[] { "[sendGameMsg], gameId:", Integer.valueOf(paramaliq.jdField_a_of_type_Int), ",roomId:", Long.valueOf(paramaliq.jdField_a_of_type_Long), ",extendInfo:", paramaliq.jdField_c_of_type_JavaLangString });
    }
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramaliq.jdField_a_of_type_Int == 1)
        {
          ...
          ((JSONObject)localObject).put("gameStatus", paramaliq.e);
          if (localObject != null) {
          ...
          paramString = ayvw.a(paramQQAppInterface, paramString, paramQQAppInterface.getCurrentAccountUin(), 1036, localApolloMessage);
          if (paramaliq.jdField_a_of_type_Int == 1)
          {
            paramString.msgType = 2;
            paramString.gameId = paramaliq.jdField_a_of_type_Int;
            paramString.mGameMode = paramaliq.jdField_c_of_type_Int;
            paramString.roomId = paramaliq.jdField_a_of_type_Long;
            paramString.mApolloMessage.id = paramaliq.jdField_b_of_type_Int;
            paramString.gameName = paramaliq.jdField_b_of_type_JavaLangString;
            paramString.gameExtendJson = paramaliq.jdField_c_of_type_JavaLangString;
            paramString.gameStatus = paramaliq.e;
            paramString.extendJson = ("{\"gameStatus\":" + paramaliq.e + "}");
        ...
        paramString.msgType = paramaliq.d;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    ((akji)paramQQAppInterface.getManager(153)).a().b(paramString1, paramString2);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, long paramLong, int paramInt)
  {
    ...
    ApolloGameData localApolloGameData = ((aleh)localObject2).a(paramInt);
    Object localObject1 = alpo.a(2131702487);
    if ((localApolloGameData != null) && (!TextUtils.isEmpty(localApolloGameData.name)))
    {
      localObject2 = ((aleh)localObject2).a(localApolloGameData.actionId);
    ...
    for (;;)
    {
      int i = localApolloGameData.actionId;
      localaliq.jdField_b_of_type_JavaLangString = localApolloGameData.name;
      localaliq.jdField_a_of_type_JavaLangString = ((String)localObject1);
      localaliq.jdField_b_of_type_Int = i;
      localaliq.jdField_a_of_type_Int = paramInt;
      localaliq.jdField_a_of_type_Long = paramLong;
      localaliq.e = 0;
      ...
      if (!TextUtils.isEmpty(localaliq.jdField_a_of_type_JavaLangString)) {
        ((ApolloMessage)localObject2).name = localaliq.jdField_a_of_type_JavaLangString.getBytes();
      }
      localObject1 = null;
      if (0 == 0) {}
      for (;;)
      {
        try
        {
          ...
          ((JSONObject)localObject1).put("gameId", localaliq.jdField_a_of_type_Int);
          ((JSONObject)localObject1).put("gameMode", localaliq.jdField_c_of_type_Int);
          ((JSONObject)localObject1).put("roomid", localaliq.jdField_a_of_type_Long);
          if (localaliq.jdField_a_of_type_Int == 1)
          {
            ((JSONObject)localObject1).put("msgTyep", 2);
            ((JSONObject)localObject1).put("gameName", localaliq.jdField_b_of_type_JavaLangString);
            if (!TextUtils.isEmpty(localaliq.jdField_c_of_type_JavaLangString)) {
              ((JSONObject)localObject1).put("gameExtendJson", localaliq.jdField_c_of_type_JavaLangString);
            }
            ((JSONObject)localObject1).put("gameStatus", localaliq.e);
            if (localObject1 != null) {
              ((ApolloMessage)localObject2).extStr = ((JSONObject)localObject1).toString();
            }
            localObject1 = ((akji)paramQQAppInterface.getManager(153)).b(paramQQAppInterface.getCurrentAccountUin());
            ((ApolloMessage)localObject2).sender_ts = bdal.a(((ApolloBaseInfo)localObject1).apolloServerTS);
            ...
            localObject1 = ayvw.a(paramQQAppInterface, paramString1, paramQQAppInterface.getCurrentAccountUin(), 1036, (ApolloMessage)localObject2);
            if (localaliq.jdField_a_of_type_Int != 1) {
              break label698;
            }
            ((MessageForApollo)localObject1).msgType = 2;
            ((MessageForApollo)localObject1).gameId = localaliq.jdField_a_of_type_Int;
            ((MessageForApollo)localObject1).mGameMode = localaliq.jdField_c_of_type_Int;
            ((MessageForApollo)localObject1).roomId = localaliq.jdField_a_of_type_Long;
            ((MessageForApollo)localObject1).mApolloMessage.id = localaliq.jdField_b_of_type_Int;
            ((MessageForApollo)localObject1).gameName = localaliq.jdField_b_of_type_JavaLangString;
            ((MessageForApollo)localObject1).gameExtendJson = localaliq.jdField_c_of_type_JavaLangString;
            ((MessageForApollo)localObject1).gameStatus = localaliq.e;
            ((MessageForApollo)localObject1).extendJson = ("{\"gameStatus\":" + localaliq.e + ",\"robotOpenId\":" + paramString2 + "}");
            ...
            jdField_a_of_type_Long = System.currentTimeMillis();
            return;
            localaliq.jdField_b_of_type_JavaLangString = alpo.a(2131702489);
            i = 0;
            break;
          }
          ((JSONObject)localObject1).put("msgTyep", localaliq.d);
          continue;
          ((MessageForApollo)localObject1).msgType = localaliq.d;
        }
        catch (Throwable paramQQAppInterface)
        {
          QLog.d("CmGameTemp_CmGameSessionUtil", 2, paramQQAppInterface, new Object[0]);
  ...
  public static boolean a()
  {
    if ((BaseActivity.sTopActivity instanceof FragmentActivity))
    {
      ...
      if (localObject != null)
      {
        ...
        if (!(localObject instanceof agjp)) {}
      }
    }
    for (Object localObject = (agjp)localObject;; localObject = null) {
      return (localObject != null) && (((agjp)localObject).E());
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      acex.b(paramQQAppInterface, localSessionInfo, (ArkAppMessage)localObject);
      return true;
    }
