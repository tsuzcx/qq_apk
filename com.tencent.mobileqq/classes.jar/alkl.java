...
{
  public static int a;
  ajgy jdField_a_of_type_Ajgy = new alko(this);
  private alkb jdField_a_of_type_Alkb;
  public alkc a;
  private alke jdField_a_of_type_Alke = new alkn(this);
  private alkk jdField_a_of_type_Alkk = new alkm(this);
  private Resources jdField_a_of_type_AndroidContentResResources;
  public SparseArray<ArrayList<String>> a;
  private AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface;
  public Runnable a;
  public String a;
  public ArrayList<WeakReference<azvw>> a;
  public ConcurrentHashMap<String, DynamicAvatar> a;
  public volatile boolean a;
  public String b;
  public ArrayList<WeakReference<azvw>> b;
  public ArrayList<WeakReference<azvw>> c;
  public ArrayList<WeakReference<azvw>> d;
  ...
  public alkl(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_ComTencentCommonAppAppInterface.addObserver(this.jdField_a_of_type_Alkk, true);
    this.d = new ArrayList();
    this.c = new ArrayList();
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
    this.b = new ArrayList();
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
    this.jdField_a_of_type_Alkc = new alkc(paramAppInterface);
    this.jdField_a_of_type_Alkc.a(this.jdField_a_of_type_Alke);
    this.jdField_a_of_type_AndroidContentResResources = BaseApplicationImpl.getContext().getResources();
    a();
    jdField_a_of_type_Int = this.jdField_a_of_type_Alkb.jdField_a_of_type_Int;
  ...
  private Setting a(int paramInt, String paramString)
  {
    ...
    if (paramInt == 18)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof NearbyAppInterface)) {
        localObject1 = ((azwz)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(216)).a(paramString);
      }
    }
    do
    {
    ...
    paramString = (Setting)((atmp)localObject1).a(Setting.class, paramString);
    ((atmp)localObject1).a();
    return paramString;
  }
  ...
  public static String a(azvw paramazvw, boolean paramBoolean)
  {
    if (paramazvw == null) {
      return "";
    }
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append(paramazvw.jdField_b_of_type_Int).append("_").append(paramazvw.jdField_c_of_type_Int).append("_").append(paramazvw.jdField_a_of_type_JavaLangString);
    if ((paramBoolean) || ((paramazvw.jdField_e_of_type_Boolean) && (!TextUtils.isEmpty(paramazvw.jdField_b_of_type_JavaLangString)))) {
      localStringBuilder.append("_").append(paramazvw.jdField_b_of_type_JavaLangString);
    }
    return localStringBuilder.toString();
  }
  ...
  private void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    synchronized (this.c)
    {
      ...
      if (j >= 0)
      {
        ...
        {
          azvw localazvw = (azvw)localWeakReference.get();
          if (localazvw == null) {
            this.c.remove(j);
          } else if (paramString1.equals(localazvw.jdField_d_of_type_JavaLangString)) {
            if (TextUtils.isEmpty(paramString2))
            {
              localazvw.jdField_a_of_type_ComTencentImageURLDrawable = null;
              localazvw.a();
              this.c.remove(j);
            }
            else
            {
              localazvw.jdField_b_of_type_JavaLangString = paramString2;
              localazvw.jdField_c_of_type_JavaLangString = paramString3;
              if ((localazvw.jdField_a_of_type_MqqUtilWeakReference == null) || (localazvw.jdField_a_of_type_MqqUtilWeakReference.get() == null) || (!paramString2.equals(((DynamicAvatarView)localazvw.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_JavaLangString))) {
                break label225;
              }
  ...
  public alkb a()
  {
    if (this.jdField_a_of_type_Alkb == null) {
      a();
    }
    if (QLog.isColorLevel()) {
      QLog.d("Q.dynamicAvatar", 2, "getConfig DynamicAvatarConfig|" + this.jdField_a_of_type_Alkb);
    }
    return this.jdField_a_of_type_Alkb;
  }
  
  public alkc a()
  {
    return this.jdField_a_of_type_Alkc;
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Alkb = new alkb();
    if (QLog.isColorLevel()) {
      QLog.d("Q.dynamicAvatar", 2, "DynamicAvatarConfig|init config:" + this.jdField_a_of_type_Alkb + ",costTime:" + (System.currentTimeMillis() - l));
    }
  }
  
  public void a(alkf paramalkf)
  {
    if (paramalkf == null) {}
    while (!(this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof QQAppInterface)) {
      return;
    }
    atmp localatmp = this.jdField_a_of_type_ComTencentCommonAppAppInterface.getEntityManagerFactory().createEntityManager();
    localatmp.a().a();
    for (;;)
    {
      try
      {
        localCursor = localatmp.a(false, DynamicAvatar.class.getSimpleName(), null, null, null, null, null, null, null);
        if (localCursor != null) {}
        try
        {
          ...
          if (i >= 1000)
          {
            ...
            ((StringBuilder)localObject1).append(";");
            localatmp.b(((StringBuilder)localObject1).toString());
          }
          if ((paramalkf == null) || (paramalkf.jdField_a_of_type_JavaUtilArrayList == null) || (paramalkf.jdField_a_of_type_JavaUtilArrayList.isEmpty())) {
            continue;
          }
          paramalkf = paramalkf.jdField_a_of_type_JavaUtilArrayList.iterator();
          if (!paramalkf.hasNext()) {
            continue;
          }
          localObject1 = DynamicAvatar.convertFrom((alkg)paramalkf.next());
          if (localObject1 == null) {
            continue;
          }
          ??? = (DynamicAvatar)localatmp.a(DynamicAvatar.class, "uin=?", new String[] { String.valueOf(((DynamicAvatar)localObject1).uin) });
          if (??? != null)
          {
  ...
  public void a(azvw paramazvw)
  {
    ...
    synchronized (this.d)
    {
      this.d.remove(paramazvw.jdField_b_of_type_MqqUtilWeakReference);
    }
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      this.jdField_a_of_type_JavaUtilArrayList.remove(paramazvw.jdField_b_of_type_MqqUtilWeakReference);
      this.b.remove(paramazvw.jdField_b_of_type_MqqUtilWeakReference);
      synchronized (this.c)
      {
        this.c.remove(paramazvw.jdField_b_of_type_MqqUtilWeakReference);
        return;
      }
      paramazvw = finally;
      throw paramazvw;
  ...
  public void a(azvw paramazvw, boolean paramBoolean)
  {
    if (paramazvw == null) {
      return;
    }
    if (paramBoolean)
    {
      String str = a(paramazvw, false);
      ArrayList localArrayList2 = (ArrayList)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramazvw.jdField_e_of_type_Int);
      ArrayList localArrayList1 = localArrayList2;
      if (localArrayList2 == null)
      {
        localArrayList1 = new ArrayList();
        this.jdField_a_of_type_AndroidUtilSparseArray.put(paramazvw.jdField_e_of_type_Int, localArrayList1);
      }
      localArrayList1.add(str);
      localArrayList1.add(a(paramazvw, true));
      if ((paramazvw.jdField_e_of_type_Int == 1) || (paramazvw.jdField_e_of_type_Int == 0)) {
        ThreadManager.post(new DynamicAvatarManager.6(this, paramazvw, System.currentTimeMillis()), 5, null, true);
      }
      if (paramazvw.jdField_a_of_type_MqqUtilWeakReference.get() != null) {
        ((DynamicAvatarView)paramazvw.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_JavaLangString = "";
      }
    }
    ThreadManager.postImmediately(new DynamicAvatarManager.7(this, paramazvw), null, true);
  }
  
  public void a(azvw paramazvw, boolean paramBoolean1, boolean paramBoolean2)
  {
    if ((this.c.size() < jdField_a_of_type_Int) || (paramBoolean1))
    {
      ??? = paramazvw.jdField_d_of_type_JavaLangString;
      synchronized (this.c)
      {
        this.c.add(paramazvw.jdField_b_of_type_MqqUtilWeakReference);
        if (paramBoolean1) {}
      }
      for (;;)
      {
        ...
        {
          this.d.remove(paramazvw.jdField_b_of_type_MqqUtilWeakReference);
          ??? = new DynamicAvatarManager.3(this, paramazvw, (String)???);
          if (!paramBoolean2)
          {
            l1 = 0L;
            long l2 = l1;
        ...
        if (paramazvw.jdField_e_of_type_Int == 0) {
          l1 = 1500L;
        } else {
          l1 = 400L;
        }
    ...
    synchronized (this.d)
    {
      this.d.add(paramazvw.jdField_b_of_type_MqqUtilWeakReference);
      return;
    }
  }
  ...
  public void a(DynamicAvatar paramDynamicAvatar)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof QQAppInterface))
    {
      localatmp = this.jdField_a_of_type_ComTencentCommonAppAppInterface.getEntityManagerFactory().createEntityManager();
      localDynamicAvatar = (DynamicAvatar)localatmp.a(DynamicAvatar.class, "uin=?", new String[] { String.valueOf(paramDynamicAvatar.uin) });
      ...
      localatmp.b(paramDynamicAvatar);
    }
    for (;;)
    {
      localatmp.a();
      ...
      return;
      label120:
      localatmp.a(paramDynamicAvatar);
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(paramString.basicSmallUrl)) {
        localObject = alkc.a(paramString.basicSmallUrl);
      }
      try
      {
        ...
        if (!TextUtils.isEmpty(paramString.basicMiddleUrl)) {
          localObject = alkc.a(paramString.basicMiddleUrl);
        }
      }
      catch (Exception localException1)
      {
        try
        {
          do
          {
            ...
            paramString = alkc.a(paramString.basicBigUrl);
            try
            {
  ...
  {
    if ((paramBoolean) && (this.jdField_a_of_type_Alkb != null) && (this.jdField_a_of_type_Alkb.jdField_a_of_type_Boolean)) {}
    synchronized (this.jdField_a_of_type_Alkb)
    {
      this.jdField_a_of_type_Alkb.a();
      if (QLog.isColorLevel()) {
        QLog.d("Q.dynamicAvatar", 2, "---onDpcPullFinished---|mDynamicAvatarConfig:" + this.jdField_a_of_type_Alkb);
      }
      if (QLog.isColorLevel()) {
  ...
  public boolean a(int paramInt)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("Q.dynamicAvatar", 2, "isPlayDynamicAvatar|source:" + paramInt + ",isPlay:" + bool1 + "\n" + this.jdField_a_of_type_Alkb);
      }
      return bool1;
      bool1 = this.jdField_a_of_type_Alkb.jdField_c_of_type_Boolean;
      continue;
      bool1 = this.jdField_a_of_type_Alkb.d;
      continue;
      bool1 = this.jdField_a_of_type_Alkb.f;
      continue;
      bool1 = this.jdField_a_of_type_Alkb.g;
      continue;
      bool1 = this.jdField_a_of_type_Alkb.jdField_e_of_type_Boolean;
      continue;
      bool1 = this.jdField_a_of_type_Alkb.h;
      continue;
      bool1 = true;
      continue;
      bool1 = this.jdField_a_of_type_Alkb.f;
  ...
  @TargetApi(11)
  public boolean a(azvw paramazvw)
  {
    int i = 640;
    Object localObject1;
    Object localObject2;
    ...
    if (!paramazvw.f)
    {
      localObject1 = a(paramazvw, false);
      localObject2 = (ArrayList)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramazvw.jdField_e_of_type_Int);
    ...
    File localFile = alkc.a(paramazvw.jdField_b_of_type_JavaLangString);
    if (paramazvw.jdField_d_of_type_Int == 640) {}
    for (;;)
    {
      URLDrawable.URLDrawableOptions localURLDrawableOptions = URLDrawable.URLDrawableOptions.obtain();
      localURLDrawableOptions.mRequestWidth = i;
      localURLDrawableOptions.mRequestHeight = i;
      localObject2 = paramazvw.jdField_a_of_type_AndroidGraphicsDrawableDrawable;
      localObject1 = localObject2;
      if ((localObject2 instanceof azwp)) {
        localObject1 = ((azwp)localObject2).a();
      }
      ...
      ((VideoDrawable.VideoDrawableParams)localObject1).mRequestedFPS = this.jdField_a_of_type_Alkb.jdField_c_of_type_Int;
      int j = i;
      if (awnu.b()) {
        j = bacm.a(i);
      }
      ...
      boolean bool2 = paramazvw.a(URLDrawable.getDrawable(localFile, localURLDrawableOptions));
      bool1 = bool2;
      if (!bool2) {
        break;
      }
      ...
      bool1 = bool2;
      if (azvw.jdField_a_of_type_ArrayOfInt.length <= paramazvw.jdField_e_of_type_Int) {
        break;
      }
      bool1 = bool2;
      ...
      alkx.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, "0X800711C", azvw.jdField_a_of_type_ArrayOfInt[paramazvw.jdField_e_of_type_Int]);
      return bool2;
      if (paramazvw.jdField_d_of_type_Int == 200) {
        i = 200;
      } else {
        i = 100;
      }
  ...
  public DynamicAvatar b(int paramInt, String paramString)
  {
    ...
    if (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null)
    {
      ...
      {
        localObject = "tinyId=?";
        localObject = (DynamicAvatar)localatmp.a(DynamicAvatar.class, (String)localObject, new String[] { paramString });
        localatmp.a();
      }
    }
  ...
  public void b(azvw paramazvw)
  {
    ...
    do
    {
      ...
      ??? = a(paramazvw, false);
      localArrayList = (ArrayList)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramazvw.jdField_e_of_type_Int);
    ...
    a(paramazvw, true, true);
  }
  
  public void b(String paramString)
  {
    if (TextUtils.isEmpty(paramString)) {}
    while (this.jdField_a_of_type_Alkc == null) {
      return;
    }
    this.jdField_a_of_type_Alkc.a(paramString);
  }
    ...
    synchronized (this.d)
    {
      ...
      if (i >= 0)
      {
        ...
        if ((localWeakReference1 != null) && (localWeakReference1.get() != null)) {
          ((azvw)localWeakReference1.get()).a();
        } else {
          this.d.remove(i);
        }
      }
      ...
      synchronized (this.c)
      {
        ...
        if (m >= jdField_a_of_type_Int)
        {
          ...
          if (j >= k - i)
          {
            ...
            ((ArrayList)localObject2).add(((azvw)localWeakReference2.get()).jdField_b_of_type_JavaLangString);
            break label434;
          }
        }
        else
        ...
        if (this.jdField_a_of_type_Alkc != null) {
          this.jdField_a_of_type_Alkc.a((ArrayList)localObject2);
        }
      }
      synchronized (this.d)
      {
        ...
        while (i >= 0)
        {
          ...
          {
            a((azvw)((WeakReference)localObject2).get(), false, false);
            i -= 1;
            continue;
  ...
  public void onDestroy()
  {
    ...
    this.jdField_a_of_type_ComTencentCommonAppAppInterface.removeObserver(this.jdField_a_of_type_Alkk);
    this.jdField_a_of_type_Alkc.b();
    this.jdField_a_of_type_Alkc = null;
    this.jdField_a_of_type_Alkk = null;
