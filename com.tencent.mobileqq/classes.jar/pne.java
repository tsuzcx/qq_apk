  ...
  implements Manager
{
  ...
  protected ArrayList<batl> a;
  protected HashMap<String, String> a;
  protected ConcurrentHashMap<String, String> a;
  
  public pne(AppInterface paramAppInterface)
  {
  ...
  {
    String str2 = ajed.aU + ".readInjoy/resource/";
    String str1 = str2;
  ...
  {
    this.jdField_a_of_type_JavaUtilArrayList.add(parambatl);
  }
  
  public void a(String paramString, batm parambatm) {}
  ...
  public boolean a(String paramString, BaseResData paramBaseResData, int paramInt)
  {
    ...
    do
    {
      ...
      localObject = new batm(paramBaseResData.url, localFile);
      ((batm)localObject).b = paramInt;
      ((batm)localObject).d = 60L;
      this.jdField_a_of_type_Batr.a((batm)localObject, new pnf(this, str, paramBaseResData, paramString), localBundle);
    } while (!QLog.isColorLevel());
  ...
  public void b(batl parambatl)
  {
    this.jdField_a_of_type_JavaUtilArrayList.remove(parambatl);
  }
