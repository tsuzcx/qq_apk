...
public class pne
{
  ...
  private pnh jdField_a_of_type_Pnh;
  szi jdField_a_of_type_Szi;
  
  public pne(pnh parampnh)
  {
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_a_of_type_ComTencentWidgetAbsListView$OnScrollListener = new png(this);
    this.jdField_a_of_type_Pnh = parampnh;
    this.jdField_a_of_type_AndroidOsHandler = new Handler();
    this.jdField_a_of_type_Szi = new pni(this, this);
  }
  ...
  public ArticleInfo a(Activity paramActivity)
  {
    ...
    ArticleInfo localArticleInfo2 = pvj.a().a(0, l);
  ...
  public pnh a()
  {
    return this.jdField_a_of_type_Pnh;
  }
  
  public qhk a(ArticleInfo paramArticleInfo, int paramInt1, int paramInt2)
  {
    ArticleInfo localArticleInfo = null;
    if (paramInt2 < a() - 1) {
      localArticleInfo = (ArticleInfo)a(paramInt2 + 1);
    }
    return new qhk(this.jdField_a_of_type_Pnh.a(), paramArticleInfo, paramInt1, this.jdField_a_of_type_Pnh.b(), this.jdField_a_of_type_Pnh.a(), paramInt2, this.jdField_a_of_type_Pnh.d(), a(), localArticleInfo, this.jdField_a_of_type_Pnh.a());
  }
  
  public szi a()
  {
    return this.jdField_a_of_type_Szi;
  }
  ...
  public void a(int paramInt, ArrayList<BaseArticleInfo> paramArrayList, ArrayList<DislikeInfo> paramArrayList1, Object paramObject, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if ((a().a() instanceof BaseActivity))
    {
      ...
      if (AdvertisementInfo.isAdvertisementInfo(localBaseArticleInfo))
      {
        ...
        pvj.a().a(a().a(), paramArrayList, l1, paramArrayList1, paramBoolean1);
      }
    }
    for (;;)
    {
      try
      {
        ...
        paramArrayList.put("folder_status", prp.a);
        paramArrayList.put("kandian_mode", pqu.a());
        if (localBaseArticleInfo != null)
        {
          paramArrayList.put("feeds_type", "" + pqw.a(localBaseArticleInfo));
          paramArrayList.put("rowkey", uvs.a(localBaseArticleInfo));
        }
        paramArrayList = paramArrayList.toString();
        olh.a(null, "", "0X8007059", "0X8007059", 0, 0, "", "", ppr.a(paramArrayList1), paramArrayList, false);
      }
      ...
      if ((a().a() instanceof PluginBaseActivity))
      {
        ...
        bdla.b(null, "CliOper", "", "", "0X8007060", "0X8007060", 0, 0, "", "", "", paramArrayList.toString());
      }
    }
  }
  ...
  public void a(AdvertisementInfo paramAdvertisementInfo, ReadInJoyXListView paramReadInJoyXListView)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        } while (localObject != ((qfw)paramReadInJoyXListView.getChildAt(j).getTag(2131381183)).a());
        for (paramAdvertisementInfo = paramReadInJoyXListView.getChildAt(j);; paramAdvertisementInfo = null)
        {
          ...
          for (;;)
          {
            paramReadInJoyXListView = new pnf(this, (BaseArticleInfo)localObject, i);
            localObject = (Animation)paramAdvertisementInfo.getTag(2131369656);
            if (localObject == null) {
              break;
            }
  ...
  public void a(BaseArticleInfo paramBaseArticleInfo1, BaseArticleInfo paramBaseArticleInfo2, boolean paramBoolean)
  {
    if ((a() != null) && (a().contains(paramBaseArticleInfo1)))
    {
      ...
      this.jdField_a_of_type_Pnh.a().notifyDataSetChanged();
    }
  }
  ...
  public void a(List<BaseArticleInfo> paramList)
  {
    if ((paramList != null) && (this.jdField_a_of_type_JavaUtilList.getClass().isInstance(paramList)) && (paramList.size() > 0))
    {
      ...
      this.jdField_a_of_type_Pnh.e(true);
    }
    ...
    for (int i = 0;; i = paramList.size())
    {
      ...
      this.jdField_a_of_type_Pnh.a().a(System.nanoTime());
      sgg.a().a(this.jdField_a_of_type_Pnh.a(), a());
      return;
    }
  }
  ...
  public void a(List<ArticleInfo> paramList, int paramInt)
  {
    ...
    if (i < paramList.size())
    {
      ...
      for (;;)
      {
        ...
        if (qeh.a(l)) {
          qeh.a().a(this.jdField_a_of_type_Pnh.b(), l);
        } else {
          pvj.a().a(this.jdField_a_of_type_Pnh.b(), localArticleInfo);
        }
      }
    }
    a(this.jdField_a_of_type_Pnh.b(), paramInt);
  }
  
  public void b()
  {
    QLog.d("RIJDataManager", 1, "invalidAllArticles");
    piv.a(a().a(), "default_feeds");
    if (a() != null)
    {
