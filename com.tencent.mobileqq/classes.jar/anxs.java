...
{
  private static anxs jdField_a_of_type_Anxs;
  ...
  private anxs()
  {
    ...
    this.jdField_a_of_type_Anxr = new anxr(localQQAppInterface, localQQAppInterface.a().a());
    a(localQQAppInterface);
    this.jdField_a_of_type_Boolean = true;
  }
  
  public static anxs a()
  {
    if (jdField_a_of_type_Anxs == null) {}
    try
    {
      if (jdField_a_of_type_Anxs == null) {
        jdField_a_of_type_Anxs = new anxs();
      }
      return jdField_a_of_type_Anxs;
    }
    finally {}
  }
  ...
  {
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new anxt(this);
  ...
  private void c()
  {
    ...
    if (localQQAppInterface != null)
    {
      ...
      this.jdField_a_of_type_Anxr.a(localanyf);
    }
  }
  
  private void d()
  {
    this.jdField_a_of_type_Anxr.a(null);
    this.jdField_a_of_type_Anxr.a(null);
  }
  ...
  EIPCResult c(Bundle paramBundle)
  {
    ...
    boolean bool = this.jdField_a_of_type_Anxr.b(str, i);
    paramBundle = new Bundle();
  ...
  {
    boolean bool = this.jdField_a_of_type_Anxr.c();
    paramBundle = new Bundle();
  ...
  EIPCResult e(Bundle paramBundle)
  {
    ...
    return EIPCResult.createResult(0, this.jdField_a_of_type_Anxr.a(str, bool));
  }
  ...
  EIPCResult f(Bundle paramBundle)
  {
    ...
    boolean bool = this.jdField_a_of_type_Anxr.b(str1, str2, paramBundle);
    paramBundle = new Bundle();
  ...
  EIPCResult g(Bundle paramBundle)
  {
    ...
    boolean bool = this.jdField_a_of_type_Anxr.c(paramBundle);
    paramBundle = new Bundle();
  ...
  {
    boolean bool = anzv.a(paramBundle.getInt("color_note_service_type"));
    paramBundle = new Bundle();
