  ...
  extends anii
{
  ...
  private bbnh a(int paramInt1, String paramString, long paramLong, List<String> paramList, UnifySearchCommon.ResultItem paramResultItem, int paramInt2)
  {
    switch (paramInt1)
    {
    case 5: 
    ...
    default: 
      return null;
    case 2: 
      return new bbnf(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 3: 
      return new bbob(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 4: 
      return new bbng(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 7: 
      return new bbno(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 6: 
      return new bbnx(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 8: 
      return new bbnu(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 9: 
      return new bbnv(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 11: 
      return new bbnl(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 12: 
      return new bbnj(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 13: 
      return new bbnm(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 14: 
      return new bbnw(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 15: 
      return new bbnt(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 16: 
      return new bbnr(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 17: 
      return new bbns(paramString, paramLong, paramList, paramResultItem, paramInt2);
    }
    return new bbnq(paramString, paramLong, paramList, paramResultItem, paramInt2);
  }
  ...
  private List<BusinessGroupWord> a(List<UnifySearchBusiHotWord.GroupWord> paramList)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      bblb localbblb = new bblb(((UnifySearchBusiHotWord.GroupID)((UnifySearchBusiHotWord.GroupWord)localObject1).group_id.get()).rpt_group_mask.get());
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        localArrayList2.add(new bblc(localHotWordItem.word_id.get().toStringUtf8(), localHotWordItem.word.get().toStringUtf8()));
      }
      bbfi.a.put(bbfi.a(localbblb.a), localArrayList2);
      ...
      localObject1 = new bbla((String)localObject1, (String)localObject2);
      bbfi.b.put(bbfi.a(localbblb.a), localObject2);
      localArrayList1.add(new BusinessGroupWord(localbblb, localArrayList2, (bbla)localObject1));
    }
  ...
  {
    return (bdch.a()) && ((paramLong == 1100L) || (paramLong == 1012L) || (paramLong == 1003L));
  }
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      if (localRspBody.search_ver.has()) {
        bbup.a("UnifySearch.Unite", (long[])localObject2, localRspBody.search_ver.get().toStringUtf8());
      }
    ...
    {
      ((List)localObject2).add(new bbms((UnifySearchUnite.TabItemGroup)paramObject.get(i)));
      i += 1;
    }
    i = localRspBody.trigger_netword_num.get();
    if (i >= 0) {
      bgsg.r(BaseApplicationImpl.getContext(), i);
    }
  ...
  public List<bbmx> a(Object... paramVarArgs)
  {
    ...
    label202:
    for (boolean bool1 = bbum.b(i);; bool1 = true)
    {
  ...
  public void a()
  {
    ...
    localReqBody.version.set(ByteStringMicro.copyFromUtf8("8.4.1"));
  ...
  public void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    if (!bgsg.b(paramQQAppInterface.getCurrentAccountUin(), paramInt))
    {
      if (QLog.isColorLevel()) {
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localRspBody.search_ver.has()) {
          bbup.a("UnifySearch.Tab", arrayOfLong, localRspBody.search_ver.get().toStringUtf8());
        }
        ...
        Object localObject2 = new bbox();
        if (bool2) {
          ((bbox)localObject2).a(true);
        }
        paramToServiceMsg = ((bbox)localObject2).a(new Object[] { str1, paramObject, Integer.valueOf(paramToServiceMsg.extraData.getInt("fromType")) });
  ...
  public void a(String paramString1, long paramLong1, long paramLong2, String paramString2)
  {
    ...
    new bcsy(this.app).a("dc00899").b("grp_search_engineer").c("search_net").d(paramString1).a(new String[] { paramLong2 + "", "" + (l - paramLong1), "" + paramString2, yqu.a(null) }).a();
  }
    ...
    for (;;)
    {
      ...
      if (paramInt3 == 1)
      {
        ...
        if (!paramBoolean1)
        {
          ...
          ((UnifySearchCommon.RootSearcherRequest)localObject1).rpt_busi_mask.set(bbup.a(jdField_a_of_type_ArrayOfLong));
        ...
        i = 2;
        localObject2 = bgsg.b(this.app.getCurrentAccountUin());
        ...
        paramList2.extraData.putLongArray("masks", bbhd.a(paramList1));
  ...
  public void a(String paramString1, String paramString2, int paramInt1, List<Long> paramList1, List<Long> paramList2, byte[] paramArrayOfByte, int paramInt2, double paramDouble1, double paramDouble2, Bundle paramBundle, String paramString3)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (bbfi.a.isEmpty())
        {
          ...
          if (paramBundle != null)
          {
            ...
            if (!bool) {
              bbup.a("sub_result", "active_search", new String[] { paramString1, bbup.a(paramList1), "" + paramInt1, "" });
            }
      ...
      catch (UnsupportedEncodingException paramString3)
      {
        ...
        continue;
        localObject = bbfi.a.values().iterator();
        paramInt1 = 2;
      }
      label566:
      int i = paramInt1;
      if (((Iterator)localObject).hasNext())
      {
        ...
        while (localIterator.hasNext()) {
          if (paramString1.equals((bblc)localIterator.next())) {
            paramInt1 = 1;
          }
        }
      }
  ...
  public void a(UnifySearchCommon.ResultItemGroup paramResultItemGroup, long paramLong, String paramString, int paramInt, List<bbmx> paramList)
  {
    ...
    {
      localObject1 = new bboe(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
      ((bboe)localObject1).a(((UnifySearchCommon.ResultItem)localObject3).layout_id.get());
      ((bboe)localObject1).c(null);
      ((bboe)localObject1).a(bool2);
      label445:
      if ((localObject1 != null) && (((bbnh)localObject1).b()))
      {
        ((bbnh)localObject1).s = ((UnifySearchCommon.ResultItem)localObject3).seporator_type.get();
        ((bbnh)localObject1).a = bool1;
      ...
      for (;;)
      {
        ...
        {
          localObject1 = new bboh(paramString, str7, -4, str5);
          ((bboh)localObject1).s = ((UnifySearchCommon.ResultItem)localObject3).seporator_type.get();
          localArrayList2.add(localObject1);
          l2 = l1;
        }
        else
        {
          localObject1 = new bblw(paramString, (String)localObject1, str4, str5, str6, str7, l2, localArrayList1, paramInt);
          l2 = l1;
          if (localObject1 != null)
          {
            ((bblw)localObject1).s = ((UnifySearchCommon.ResultItem)localObject3).seporator_type.get();
            ((bblw)localObject1).c = bool1;
            ((bblw)localObject1).h = i;
            ((bblw)localObject1).a = paramInt;
            localArrayList2.add(localObject1);
            l2 = l1;
          }
        }
      ...
      for (boolean bool3 = true;; bool3 = false)
      {
        ...
        paramList.add(new bbmr(paramString, paramLong, str1, localArrayList2, l1, (String)localObject1, (String)localObject2, localArrayList1, bool1, bool2, bool3, str2, str3));
        return;
        bool2 = false;
        break;
      }
      label875:
      paramList.add(new bblv(paramString, paramLong, str1, localArrayList2, l1, (String)localObject1, (String)localObject2, localArrayList1, bool1, bool2, bool3, str2, str3));
      return;
    }
  }
  ...
  {
    return bgmg.a(BaseApplication.getContext().getFileStreamPath(paramString));
  }
  ...
  public void b(ToServiceMsg paramToServiceMsg, int paramInt, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        bgsg.b(this.app.getCurrentAccountUin(), i, paramInt);
        paramToServiceMsg = localRspBody.result_items.get();
        paramToServiceMsg = bbof.b(this.app, paramToServiceMsg, i);
        if (QLog.isColorLevel()) {
