  ...
  extends LinearLayout
{
  ...
  public bpbz(Context paramContext, int paramInt1, int paramInt2, float paramFloat, View.OnClickListener paramOnClickListener, bpbj parambpbj)
  {
    super(paramContext);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = paramOnClickListener;
    this.jdField_a_of_type_Int = paramInt1;
    this.b = paramInt2;
    this.jdField_a_of_type_Bpbj = parambpbj;
    paramInt1 /= this.b;
  ...
  private void a()
  {
    ...
    while (i < this.b)
    {
      ...
      if (i == 0) {
        localLayoutParams.leftMargin = bpdd.b(getContext(), 7.0F);
      }
      if (i == this.b - 1) {
        localLayoutParams.rightMargin = bpdd.b(getContext(), 7.0F);
      }
  ...
  public void a(bpbf parambpbf, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (paramInt1 == paramInt2 - 1)
    {
      ...
      localObject = parambpbf.a(paramInt2);
      localImageView.setTag(2131378495, localObject);
      localImageView.setTag(2131378482, Integer.valueOf(paramInt2));
      if (parambpbf.a(paramInt2) != 1) {
        break label252;
      }
      if (!(getContext() instanceof EditPicActivity)) {
        break label158;
      }
      localObject = parambpbf.b(paramInt2);
      localImageView.setTag(2131378495, localObject);
      bowy.a().a(localImageView, (String)localObject, this.d, this.d, paramBoolean);
    }
    for (;;)
    {
      paramInt2 += 1;
