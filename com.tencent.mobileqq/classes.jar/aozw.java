...
public class aozw
  extends aozu
{
  public aozw(QQAppInterface paramQQAppInterface)
  {
  ...
  private String a(long paramLong, String paramString1, String paramString2, int paramInt)
  {
    ...
    {
      return paramString1;
      paramString2 = ajed.bm + apdq.a(paramLong, paramInt, paramString2);
  ...
  private boolean a(MessageRecord paramMessageRecord, List<MsgBackupResEntity> paramList)
  {
    ...
    for (Object localObject1 = (MessageForTroopFile)apck.a((ChatMessage)paramMessageRecord); localObject1 == null; localObject1 = (MessageForTroopFile)paramMessageRecord)
    {
    ...
    TroopFileTransferManager.Item localItem = localTroopFileTransferManager.a(((ayqd)localObject1).jdField_a_of_type_JavaUtilUUID);
    Object localObject2;
    String str;
    if (localItem != null) {
        ...
        for (;;)
        {
          if (localIterator.hasNext())
          {
            ...
            if ((a((MsgBackupResEntity)localObject2)) && (b(paramMessageRecord, (MsgBackupResEntity)localObject2)))
            {
              ...
              {
                if (bace.b(localItem.largeThumbnailFile)) {
                  continue;
                }
  ...
  private void c(MessageRecord paramMessageRecord, List<MsgBackupResEntity> paramList)
  {
    ...
    ayoq localayoq = azih.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, l).b(((MessageForTroopFile)localObject1).url, ((MessageForTroopFile)localObject1).fileName, ((MessageForTroopFile)localObject1).fileSize, ((MessageForTroopFile)localObject1).bisID);
    Object localObject2;
    String str;
    if ((localayoq != null) && (paramList != null) && (!paramList.isEmpty()))
    {
      localObject1 = "";
      localObject2 = "";
      Iterator localIterator = paramList.iterator();
      ...
      for (;;)
      {
        if (localIterator.hasNext())
        {
          ...
          if ((a((MsgBackupResEntity)localObject2)) && (b(paramMessageRecord, (MsgBackupResEntity)localObject2)))
          {
            ...
            if (((MsgBackupResEntity)localObject2).msgSubType == 12) {
              localObject1 = a(l, str, UUID.nameUUIDFromBytes(localayoq.b.getBytes()).toString(), 640);
            }
          }
        }
      }
    ...
    for (;;)
    {
      ...
      if (((MsgBackupResEntity)localObject2).msgSubType == 11)
      {
        paramList = a(str, localayoq.c);
        continue;
        if (bace.b(paramList))
        {
          localayoq.h = paramList;
          localayoq.e = 11;
        ...
        if (bace.b((String)localObject1))
        {
          localayoq.j = ((String)localObject1);
        ...
        TroopFileTransferManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, l).a(localayoq);
        return;
      }
    }
  }
  ...
  protected String a(MessageRecord paramMessageRecord, int paramInt)
  {
    ...
    try
    {
      ...
      localObject = azjg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForTroopFile);
      if ((localObject != null) && (((ayqd)localObject).e > 0) && (((ayqd)localObject).f > 0))
      {
        localJSONObject.put("uint32_img_width", ((ayqd)localObject).e);
        localJSONObject.put("uint32_img_height", ((ayqd)localObject).f);
      }
  ...
  public void a(MessageRecord paramMessageRecord, List<MsgBackupResEntity> paramList)
  {
    ...
    if (paramMessageRecord.isMultiMsg)
    {
      localObject1 = (MessageForTroopFile)apck.a((ChatMessage)paramMessageRecord);
      localObject1 = azjg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForTroopFile)localObject1);
    ...
    for (;;)
    {
      ...
      break;
      label145:
      int i = apck.a(((ayqd)localObject1).g);
      if ((i == 0) || (i == 2))
      {
        Object localObject2 = ((ayqd)localObject1).c;
      ...
      localObject1 = ((ayqd)localObject1).jdField_a_of_type_JavaLangString;
      if (bace.b((String)localObject1))
      {
  ...
  public boolean a(MessageRecord paramMessageRecord, MsgBackupResEntity paramMsgBackupResEntity)
  {
    ...
    do
    {
      ...
      if (paramMsgBackupResEntity.msgSubType == 12)
      {
        bool1 = bace.b(paramMessageRecord.c);
    ...
    boolean bool2 = bace.b(paramMessageRecord.jdField_a_of_type_JavaLangString);
