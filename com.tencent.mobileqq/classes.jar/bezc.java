...
public class bezc
  extends amab
{
  public bezc(BindGroupFragment paramBindGroupFragment) {}
  ...
  protected void a(boolean paramBoolean, int paramInt, long paramLong)
  {
    ...
    if (paramBoolean)
    {
      BindGroupFragment.c(this.a, alpo.a(2131701485));
      BindGroupFragment.a(this.a, String.valueOf(paramLong), 1);
      BindGroupFragment.a(this.a).finish();
      return;
    }
    BindGroupFragment.b(this.a, alpo.a(2131701491));
  }
  ...
  protected void c(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    BindGroupFragment.a(this.a);
    BindGroupFragment.b(this.a, alpo.a(2131701494));
  }
  ...
  protected void g(boolean paramBoolean, String paramString)
  {
    ...
    if (paramBoolean)
    {
      ...
      localIntent.putExtra("url", bhos.a(paramString, "gname", BindGroupFragment.c(this.a)));
      this.a.startActivity(localIntent);
      return;
    }
    BindGroupFragment.b(this.a, alpo.a(2131701480));
  }
}
