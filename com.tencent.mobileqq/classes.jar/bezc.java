...
public class bezc
  extends bhzx<HashMap<String, Object>, Void, JSONObject>
{
  protected int a;
  protected Bundle a;
  protected bezd a;
  ...
  public bezc(String paramString1, String paramString2, bezd parambezd, int paramInt, Bundle paramBundle)
  {
    super(paramString1, paramString2);
    this.jdField_a_of_type_Bezd = parambezd;
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_AndroidOsBundle = paramBundle;
  }
  
  public bezc(String paramString1, String paramString2, bezd parambezd, int paramInt, Bundle paramBundle, boolean paramBoolean)
  {
    super(paramString1, paramString2);
    this.jdField_a_of_type_Bezd = parambezd;
    this.jdField_a_of_type_Int = paramInt;
  ...
  {
    if (isCancelled()) {}
    while (this.jdField_a_of_type_Bezd == null) {
      return;
    }
    this.jdField_a_of_type_Bezd.a(paramJSONObject, this.jdField_a_of_type_Int, this.jdField_a_of_type_AndroidOsBundle);
  }
}
