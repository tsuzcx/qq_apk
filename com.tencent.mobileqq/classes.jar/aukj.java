  ...
  implements agma, Handler.Callback
{
  ...
  final ayyt jdField_a_of_type_Ayyt = new aukk(this);
  ...
  private final MqqHandler jdField_a_of_type_MqqOsMqqHandler = new bkfv(Looper.getMainLooper(), this);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = anni.a(2131717869);
  }
  
  public aukj(BaseChatPie paramBaseChatPie)
  {
    this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener = new aukn(this);
  ...
  public static bgpa a(Activity paramActivity, bgpa parambgpa, BaseChatPie paramBaseChatPie, long paramLong, int paramInt, String paramString)
  {
    ...
    String str = ((QQAppInterface)localObject).getApplication().getString(2131717865);
    if (paramString != null) {}
    for (paramString = str + paramString;; paramString = str)
    {
      str = ((QQAppInterface)localObject).getApplication().getString(2131717871);
      localObject = ((QQAppInterface)localObject).getApplication().getString(2131717866);
      aukl localaukl = new aukl(paramLong, paramInt, paramActivity);
      aukm localaukm = new aukm(paramLong, paramInt, paramActivity, paramBaseChatPie);
      paramBaseChatPie = parambgpa;
      if (parambgpa == null) {
        paramBaseChatPie = bglp.a(paramActivity, 232, null, str, paramString, (String)localObject, localaukl, localaukm);
      }
      paramBaseChatPie.setNegativeButton(paramString, localaukm);
      paramBaseChatPie.setPositiveButton((String)localObject, localaukl);
      try
      {
        paramBaseChatPie.show();
        return paramBaseChatPie;
      }
      catch (Throwable parambgpa)
      {
      ...
      QLog.e("SDK_SHARE.ForwardShareByServerHelper", 2, "qbShowShareResultDialog: failed. ", parambgpa);
      return paramBaseChatPie;
    }
  }
  ...
  private AbsStructMsg a()
  {
    ...
    return bcwd.a(localIntent.getByteArrayExtra("stuctmsg_bytes"));
  }
  ...
  public static String a(Context paramContext, String paramString)
  {
    try
    {
      ...
      paramContext = bgmj.a(paramString.digest());
  ...
  public static oidb_cmd0xb77.ReqBody a(Bundle paramBundle, String paramString1, String paramString2, oidb_cmd0xb77.ImageInfo paramImageInfo, long paramLong)
  {
    ...
    if (i == 0)
    {
      ...
      {
        paramBundle = str1;
        if (str1.contains(anni.a(2131703598))) {
          paramBundle = str1.replace(anni.a(2131703625), "");
        }
  ...
  public static void a(long paramLong, int paramInt, Activity paramActivity)
  {
    ...
    nmj.a((QQAppInterface)localObject1, "", "choose", paramLong, paramInt, "stay");
    bipi.a().a(((QQAppInterface)localObject1).getAccount(), "", String.valueOf(paramLong), "1000", "52", "0", false);
  ...
  public static void a(long paramLong, int paramInt, Activity paramActivity, BaseChatPie paramBaseChatPie)
  {
    ...
    nmj.a(localQQAppInterface, "", "choose", paramLong, paramInt, "back");
    bipi.a().a(localQQAppInterface.getAccount(), "", String.valueOf(paramLong), "1000", "51", "0", false);
    nmj.a(paramActivity, 0, "", "");
  ...
  private void a(Bundle paramBundle)
  {
    ...
    paramBundle = bcwd.a(paramBundle);
    if ((paramBundle != null) && ((paramBundle instanceof AbsShareMsg))) {}
    for (paramBundle = (AbsShareMsg)paramBundle;; paramBundle = null)
    {
      this.jdField_a_of_type_Bgpa = a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Bgpa, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, paramBundle.mSourceAppid, paramBundle.mMsgServiceID, str);
      return;
    }
  }
  ...
  public static void a(Bundle paramBundle, int paramInt, long paramLong, boolean paramBoolean)
  {
    if ((paramBundle != null) && (paramBundle.getBoolean("forward_mini_program_ark_from_sdk", false))) {
      bcst.b((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "dc00898", "", "", "0X8009F7C", "0X8009F7C", 0, 0, "1", "", "", "");
    }
    if (paramBundle != null) {}
    for (;;)
    {
      ...
      try
      {
        ...
        {
        default: 
          biur.a().a(0, "SHARE_TO_QQ", ((QQAppInterface)localObject).getCurrentAccountUin(), String.valueOf(paramLong), String.valueOf(i), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, null);
          if (paramInt != 1) {
            break label334;
          }
          paramBundle = "1";
      ...
      {
        localObject = "0";
        localbipi.a(str3, "", str4, "10", "12", (String)localObject, paramBundle, str2, str1, false);
  ...
  private void a(Bundle paramBundle, String paramString1, String paramString2)
  {
    ...
    aukw.a("KEY_STAGE_2_NORMAL_B77");
    nir.a(paramString2, new aukq(this, paramBundle), paramString1.toByteArray(), "OidbSvc.0xb77_9", 2935, 9, localBundle, 0L);
  }
  
  private void a(ayyt paramayyt, AbsStructMsg paramAbsStructMsg)
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
    Object localObject = new WeakReference(paramayyt);
    ...
    paramayyt = this.jdField_a_of_type_AndroidOsBundle.getString("uin");
    ...
    localObject = (ayyt)((WeakReference)localObject).get();
    this.jdField_a_of_type_MqqOsMqqHandler.sendMessageDelayed(this.jdField_a_of_type_MqqOsMqqHandler.obtainMessage(93), 500L);
    aukw.a("KEY_STAGE_2_SEND_MSG_BY_SERVER");
    AbsShareMsg.sendSdkShareMessageByServer(localQQAppInterface, (AbsShareMsg)paramAbsStructMsg, paramayyt, i, str, (ayyt)localObject);
  }
  ...
  public static boolean a()
  {
    aqql localaqql = aqqm.a();
    if (localaqql != null) {}
    for (boolean bool = localaqql.a();; bool = false)
    {
  ...
  private void b(int paramInt, String paramString1, String paramString2)
  {
    ...
    if ((localBundle != null) && (localBundle.getBoolean("forward_mini_program_ark_from_sdk", false))) {
      bcst.b((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "dc00898", "", "", "0X8009F7C", "0X8009F7C", 0, 0, "2", String.valueOf(paramInt), "", "");
    }
  ...
  private void c(String paramString)
  {
    ...
    while (!QLog.isColorLevel()) {
      try
      {
        ...
        njo.a().jdField_a_of_type_Boolean = true;
        adrm.b(localQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, localSessionInfo, paramString);
        return;
      }
  ...
  private void d()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("SDK_SHARE.ForwardShareByServerHelper", 2, " updateCurrentInfo mActivity = " + this.jdField_a_of_type_AndroidAppActivity + ", mExtra=" + this.jdField_a_of_type_AndroidOsBundle + ", mBaseChatPie =" + this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie);
    }
  }
  ...
  private void e()
  {
    ...
    if (this.jdField_a_of_type_AndroidOsBundle != null)
    {
      ...
      {
        localObject = bcwd.a(this.jdField_a_of_type_AndroidOsBundle);
    ...
    {
      this.jdField_a_of_type_Bgpa = a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Bgpa, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, ((AbsShareMsg)localObject).mSourceAppid, ((AbsShareMsg)localObject).mMsgServiceID, str);
  ...
  private void f()
  {
    ...
    {
      this.jdField_a_of_type_AndroidContentBroadcastReceiver = new aukp(this);
  ...
  protected void a(int paramInt, String paramString1, String paramString2)
  {
    ...
    paramString1 = new auko(this, paramInt, paramString2);
    this.jdField_b_of_type_Bgpa.setPositiveButton(2131694081, paramString1);
    ...
    for (boolean bool = ((Bundle)localObject).getBoolean("share_send_msg_by_server", false);; bool = false)
    {
      ...
      if (bool)
      {
        ...
        if ((localObject instanceof AbsShareMsg))
        {
          ...
          bcst.b(null, "dc00898", "", "", "0X8009C93", "0X8009C93", 0, 0, "", str1, str2, paramIntent);
          d();
          a(this.jdField_a_of_type_Ayyt, (AbsStructMsg)localObject);
        }
      }
      do
      {
      ...
      localObject = auhn.a((String)localObject);
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_AndroidAppDialog == null)
    {
      ...
      if (!this.jdField_a_of_type_AndroidAppActivity.isFinishing())
      {
        ...
        ((TextView)this.jdField_a_of_type_AndroidAppDialog.findViewById(2131372466)).setText(2131694295);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    bcst.b(null, "dc00898", "", "", "0X8009CF9", "0X8009CF9", 0, 0, "", "", "", "");
