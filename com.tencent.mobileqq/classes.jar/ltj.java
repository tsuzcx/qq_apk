  ...
  implements lfo
{
  ...
  public lnw a()
  {
    for (;;)
    {
      ...
      if (QLog.isColorLevel()) {}
      localObject2 = new lnw((short)5, (short)localObject2.length, (byte[])localObject2);
      return localObject2;
      label412:
      i -= 1;
    }
  ...
  public void a(String paramString, lnw paramlnw)
  {
    boolean bool;
    if ((!QLog.isColorLevel()) || (paramlnw != null))
    {
      try
      {
        if (paramlnw.a() == null) {
      ...
      try
      {
        localFrameSyncInfo.mergeFrom(paramlnw.a());
        paramlnw = lth.a(this.a, localFrameSyncInfo);
        paramString = paramlnw;
        bool = true;
      }
      catch (Exception paramlnw)
      {
        bool = false;
        break label78;
      }
