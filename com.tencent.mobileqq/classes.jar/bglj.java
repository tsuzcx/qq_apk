...
public class bglj
{
  ...
  public ArrayList<TroopMemberCardInfo> a(QQAppInterface paramQQAppInterface, String paramString, ArrayList<friendlist.stUinInfo> paramArrayList)
  {
    ...
    //   5: ifnull +10 -> 15
    //   8: aload_3
    //   9: invokevirtual 166	java/util/ArrayList:size	()I
    //   12: ifne +5 -> 17
    //   15: aconst_null
    //   16: areturn
    //   17: new 163	java/util/ArrayList
    //   20: dup
    //   21: invokespecial 167	java/util/ArrayList:<init>	()V
    //   24: astore 8
    //   26: aload_1
    //   27: invokevirtual 137	com/tencent/mobileqq/app/QQAppInterface:a	()Lcom/tencent/mobileqq/data/QQEntityManagerFactory;
    //   30: invokevirtual 143	com/tencent/mobileqq/data/QQEntityManagerFactory:createEntityManager	()Lcom/tencent/mobileqq/persistence/EntityManager;
    //   33: astore 6
    //   35: aload 6
    //   37: invokevirtual 171	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   40: astore 7
    //   42: aload 7
    //   44: invokevirtual 176	com/tencent/mobileqq/persistence/EntityTransaction:begin	()V
    //   47: iconst_0
    //   48: istore 4
    //   50: iload 4
    //   52: aload_3
    //   53: invokevirtual 166	java/util/ArrayList:size	()I
    //   56: if_icmpge +249 -> 305
    //   59: aload_3
    //   60: iload 4
    //   62: invokevirtual 180	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   65: checkcast 182	friendlist/stUinInfo
    //   68: astore 9
    //   70: aload 6
    //   72: ldc 145
    //   74: iconst_2
    ...
    //   83: iconst_1
    //   84: aload 9
    //   86: getfield 186	friendlist/stUinInfo:dwuin	J
    //   89: invokestatic 190	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   92: aastore
    //   93: invokevirtual 151	com/tencent/mobileqq/persistence/EntityManager:find	(Ljava/lang/Class;[Ljava/lang/String;)Lcom/tencent/mobileqq/persistence/Entity;
    //   96: checkcast 145	com/tencent/mobileqq/data/TroopMemberCardInfo
    //   99: astore_1
    //   100: aload_1
    //   101: ifnull +164 -> 265
    //   104: iconst_1
    ...
    //   107: aload_1
    //   108: aload 9
    //   110: getfield 186	friendlist/stUinInfo:dwuin	J
    //   113: invokestatic 190	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   116: putfield 194	com/tencent/mobileqq/data/TroopMemberCardInfo:memberuin	Ljava/lang/String;
    //   119: aload_1
    //   120: aload_2
    //   121: putfield 197	com/tencent/mobileqq/data/TroopMemberCardInfo:troopuin	Ljava/lang/String;
    //   124: aload 9
    //   126: getfield 200	friendlist/stUinInfo:dwFlag	J
    //   129: lconst_1
    //   130: land
    //   131: lconst_0
    //   132: lcmp
    ...
    //   136: aload_1
    //   137: aload 9
    //   139: getfield 203	friendlist/stUinInfo:sName	Ljava/lang/String;
    //   142: putfield 206	com/tencent/mobileqq/data/TroopMemberCardInfo:name	Ljava/lang/String;
    //   145: aload 9
    //   147: getfield 200	friendlist/stUinInfo:dwFlag	J
    //   150: ldc2_w 207
    //   153: land
    //   154: lconst_0
    //   155: lcmp
    ...
    //   159: aload_1
    //   160: aload 9
    //   162: getfield 212	friendlist/stUinInfo:cGender	B
    //   165: putfield 215	com/tencent/mobileqq/data/TroopMemberCardInfo:sex	B
    //   168: aload 9
    //   170: getfield 200	friendlist/stUinInfo:dwFlag	J
    //   173: ldc2_w 216
    //   176: land
    //   177: lconst_0
    //   178: lcmp
    ...
    //   182: aload_1
    //   183: aload 9
    //   185: getfield 220	friendlist/stUinInfo:sPhone	Ljava/lang/String;
    //   188: putfield 223	com/tencent/mobileqq/data/TroopMemberCardInfo:tel	Ljava/lang/String;
    //   191: aload 9
    //   193: getfield 200	friendlist/stUinInfo:dwFlag	J
    //   196: ldc2_w 224
    //   199: land
    //   200: lconst_0
    //   201: lcmp
    ...
    //   205: aload_1
    //   206: aload 9
    //   208: getfield 228	friendlist/stUinInfo:sEmail	Ljava/lang/String;
    //   211: putfield 231	com/tencent/mobileqq/data/TroopMemberCardInfo:email	Ljava/lang/String;
    //   214: aload 9
    //   216: getfield 200	friendlist/stUinInfo:dwFlag	J
    //   219: ldc2_w 232
    //   222: land
    //   223: lconst_0
    //   224: lcmp
    ...
    //   228: aload_1
    //   229: aload 9
    //   231: getfield 236	friendlist/stUinInfo:sRemark	Ljava/lang/String;
    //   234: putfield 239	com/tencent/mobileqq/data/TroopMemberCardInfo:memo	Ljava/lang/String;
    //   237: iload 5
    //   239: ifeq +40 -> 279
    //   242: aload 6
    //   244: aload_1
    //   245: invokevirtual 243	com/tencent/mobileqq/persistence/EntityManager:update	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   248: pop
    //   249: aload 8
    //   251: aload_1
    //   252: invokevirtual 247	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   255: pop
    //   256: iload 4
    //   258: iconst_1
    //   259: iadd
    //   260: istore 4
    //   262: goto -212 -> 50
    //   265: new 145	com/tencent/mobileqq/data/TroopMemberCardInfo
    //   268: dup
    //   269: invokespecial 248	com/tencent/mobileqq/data/TroopMemberCardInfo:<init>	()V
    //   272: astore_1
    //   273: iconst_0
    //   274: istore 5
    //   276: goto -169 -> 107
    //   279: aload 6
    //   281: aload_1
    //   282: invokevirtual 252	com/tencent/mobileqq/persistence/EntityManager:persist	(Lcom/tencent/mobileqq/persistence/Entity;)V
    //   285: goto -36 -> 249
    //   288: astore_1
    //   289: aload_1
    //   290: invokevirtual 157	java/lang/Exception:printStackTrace	()V
    //   293: aload 7
    //   295: invokevirtual 255	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   298: aload 6
    //   300: invokevirtual 154	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   303: aconst_null
    //   304: areturn
    //   305: aload 7
    //   307: invokevirtual 257	com/tencent/mobileqq/persistence/EntityTransaction:commit	()V
    //   310: aload 7
    //   312: invokevirtual 255	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   315: aload 6
    //   317: invokevirtual 154	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   320: aload 8
    //   322: areturn
    //   323: astore_1
    //   324: aload 7
    //   326: invokevirtual 255	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   329: aload 6
    //   331: invokevirtual 154	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   334: aload_1
    //   335: athrow
  ...
  public Map<String, Integer> a(List<String> paramList, int paramInt, QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localanuj = (anuj)paramQQAppInterface.getManager(40);
      ...
      RoamSetting localRoamSetting = localanuj.a(str2);
    ...
    if (localArrayList.size() > 0) {
      this.a.a(new DBUtils.1(this, localArrayList, localanuj));
    }
    return localHashMap;
  }
  ...
  public void a(int paramInt, QQAppInterface paramQQAppInterface)
  {
    ...
    ((anuj)paramQQAppInterface.getManager(40)).a(paramInt);
  }
  
  public void a(Context paramContext)
  {
    int i = ardl.a(paramContext);
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, Context paramContext)
  {
    ...
    paramString2.commit();
    ((anuj)paramQQAppInterface.getManager(40)).a(paramString1);
  }
  ...
  public void a(ArrayList<Setting> paramArrayList, QQAppInterface paramQQAppInterface)
  {
    ...
    anuj localanuj = (anuj)paramQQAppInterface.getManager(40);
    ...
    {
      label223:
      RoamSetting localRoamSetting = localanuj.a(str, paramQQAppInterface);
      if (localRoamSetting != null) {
      ...
      if (("message.ring.switch".equals(str)) || ("message.vibrate.switch".equals(str)) || ("message.ring.care".equals(str)))
      {
        ...
        for (;;)
        {
          for (;;)
          {
            ...
            {
              ThreadManager.post(new DBUtils.2(this, localanuj, localArrayList), 5, null, false);
              if (localObject == null) {}
            }
            try
            {
      ...
      try
      {
        if (i < paramArrayList.size())
        {
          ...
          if (localObject != null)
          {
            ...
            ((TroopMemberCardInfo)localObject).colorNick = bgwv.a(localstTroopRemarkInfo.sName.getBytes());
            if (((TroopMemberCardInfo)localObject).colorNick == null) {
              ((TroopMemberCardInfo)localObject).colorNick = localstTroopRemarkInfo.sName;
            }
            ((TroopMemberCardInfo)localObject).name = bgwv.b(((TroopMemberCardInfo)localObject).colorNick);
            ...
            if (j != 0)
            {
              ...
              j = bfnl.a(localstTroopRemarkInfo.vecGroupHonor);
