  ...
  extends aqyy
{
  ...
  public aqzf(String paramString, int paramInt)
  {
  ...
  {
    return ayrd.a(((FileManagerEntity)this.jdField_a_of_type_JavaUtilList.get(0)).fileName.toLowerCase(), this.jdField_a_of_type_JavaLangString);
  }
  ...
  public List<ayjl> a(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    while (paramContext.hasNext())
    {
      ...
      aqzf localaqzf = new aqzf(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int);
      localaqzf.a(this.jdField_a_of_type_AndroidOsBundle);
      ArrayList localArrayList = new ArrayList(1);
      localArrayList.add(localFileManagerEntity);
      localaqzf.a(localArrayList);
      paramQQAppInterface.add(localaqzf);
    }
  ...
  public void a(List<FileManagerEntity> paramList)
  {
    ...
    {
      if ((!TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) && (this.jdField_b_of_type_JavaLangString.equals(aljq.z)))
      {
  ...
  protected void b(View paramView)
  {
    ...
    {
      badt.a(localFileManagerEntity.Uuid, paramView, this.jdField_a_of_type_Int, localFileManagerEntity, paramView.app);
      return;
    }
    arhh localarhh = new arhh(paramView.app, paramView, localFileManagerEntity, 10001);
    ...
    localarhh.a(localBundle);
    paramView = new arhj(paramView, localarhh);
    paramView.a(7);
    if (this.jdField_a_of_type_Int != 0) {
      paramView.a(this.jdField_a_of_type_Int);
    }
    paramView.a(alpo.a(2131704887));
    paramView.a();
  }
  ...
  public boolean b()
  {
    ...
    if (localFileManagerEntity != null) {
      return aqxj.a(localFileManagerEntity);
    }
    return false;
  }
  ...
  public String c()
  {
    ...
    {
      if (localFileManagerEntity.nFileType == 13) {
        localObject1 = badt.f(localFileManagerEntity.Uuid);
      }
      return localObject1;
      if (i == 5) {
  ...
  protected void c(View paramView)
  {
    FileManagerEntity localFileManagerEntity = (FileManagerEntity)this.jdField_a_of_type_JavaUtilList.get(0);
    paramView = (BaseActivity)paramView.getContext();
    if (aqxj.a(localFileManagerEntity)) {
      aqxj.b(localFileManagerEntity);
    }
    for (;;)
    {
      if ((localFileManagerEntity.cloudType == 3) && (!arof.b(localFileManagerEntity.strFilePath)))
      {
        armz.a(arni.d(localFileManagerEntity.fileName) + alpo.a(2131709996));
        aqxj.b(localFileManagerEntity);
      }
      return;
      aqxj.a(localFileManagerEntity);
      azmj.b(null, "dc00898", "", "", "0X800AA91", "0X800AA91", 1, 0, "0", "0", "", "");
    }
  }
  ...
  public CharSequence d()
  {
    ...
    if (j > 1)
    {
      ...
      ((SpannableStringBuilder)localObject1).append("\"").append(alpo.a(2131692539));
    ...
    if (str.indexOf(alpo.a(2131692531)) == 0) {
      localSpannableStringBuilder.append(alpo.a(2131692531) + " ");
    }
    for (;;)
    {
      localObject1 = str;
      ...
      try
      {
        ...
        return this.jdField_b_of_type_JavaLangCharSequence;
        if (str.indexOf(alpo.a(2131692535)) == 0)
        {
          localSpannableStringBuilder.append(alpo.a(2131692535) + " ");
        }
        else if (str.indexOf(alpo.a(2131692532)) == 0)
        {
          localSpannableStringBuilder.append(alpo.a(2131692532) + " ");
          i = 4;
        }
        else if (str.indexOf(alpo.a(2131692536)) == 0)
        {
          localSpannableStringBuilder.append(alpo.a(2131692536) + " ");
          i = 4;
        }
        else if (str.indexOf(alpo.a(2131692530)) == 0)
        {
          localSpannableStringBuilder.append(alpo.a(2131692530) + " ");
          i = 2;
        }
        else if (str.indexOf(alpo.a(2131692534)) == 0)
        {
          localSpannableStringBuilder.append(alpo.a(2131692534) + "  ");
          i = 2;
        }
        else if (str.indexOf(alpo.a(2131692533)) == 0)
        {
          localSpannableStringBuilder.append(alpo.a(2131692533));
          i = 2;
        }
      }
  ...
  public int e()
  {
    ...
    if (localFileManagerEntity != null)
    {
      ...
      return arni.a(localFileManagerEntity.fileName);
    }
    return 11;
  }
}
