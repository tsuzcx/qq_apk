...
public class aqzf
{
  ...
  public ArrayList<aqzd> f = new ArrayList();
  ...
  private Rect a()
  {
    ...
    {
      return localObject;
      Collections.sort(this.jdField_b_of_type_JavaUtilArrayList, new aqzg(this));
      localRect = (Rect)this.jdField_b_of_type_JavaUtilArrayList.get(aqzc.jdField_a_of_type_JavaUtilRandom.nextInt(Math.min(this.jdField_b_of_type_JavaUtilArrayList.size(), 3)));
  ...
  private Rect a(Rect paramRect)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        k = aqzc.jdField_a_of_type_JavaUtilRandom.nextInt(this.jdField_a_of_type_JavaUtilArrayList.size());
        if (k != 0)
        {
          localObject = (aqzk)this.jdField_a_of_type_JavaUtilArrayList.get(0);
        ...
        do
        {
          ...
          localRect = a((aqzk)((Iterator)localObject).next(), paramRect, m, n, i, j);
    ...
    for (;;)
    {
      ...
      if (localRect.top == paramRect.bottom)
      {
        ...
        if (paramRect.width() < paramRect.height())
        {
          ...
          j = k;
          break;
          k = aqzc.jdField_a_of_type_JavaUtilRandom.nextInt(Math.min(this.jdField_a_of_type_JavaUtilArrayList.size(), 3));
          break label136;
          return null;
        }
        bool = false;
  ...
  private Rect a(Rect paramRect, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8)
  {
    if ((paramInt4 <= paramInt2) && (paramInt3 <= paramInt1)) {
      if (paramRect.width() - paramInt3 >= aqzc.jdField_a_of_type_Int + 8) {}
    }
    for (;;)
    {
      if (paramRect.height() - paramInt4 < aqzc.jdField_a_of_type_Int + 8) {}
      for (;;)
      {
  ...
  private Rect a(Rect paramRect, boolean paramBoolean)
  {
    ...
    {
      aqzd localaqzd = (aqzd)localIterator.next();
      int i = localaqzd.jdField_a_of_type_AndroidGraphicsRect.width();
      int j = localaqzd.jdField_a_of_type_AndroidGraphicsRect.height();
      if (((paramBoolean) || (k * 5 < i * j) || (k <= 576)) && (a(paramRect, localaqzd.jdField_a_of_type_AndroidGraphicsRect)))
      {
        localaqzd.jdField_a_of_type_AndroidGraphicsRect.union(paramRect);
        a(localaqzd, localaqzd.jdField_a_of_type_AndroidGraphicsRect);
        return paramRect;
      }
      if (paramBoolean)
      {
        ...
        j = 0;
        if ((localRect.left <= localaqzd.jdField_a_of_type_AndroidGraphicsRect.left) && (localRect.right >= localaqzd.jdField_a_of_type_AndroidGraphicsRect.right))
        {
          localRect.left = localaqzd.jdField_a_of_type_AndroidGraphicsRect.left;
          localRect.right = localaqzd.jdField_a_of_type_AndroidGraphicsRect.right;
          i = 1;
        }
        while ((i != 0) && (a(localRect, localaqzd.jdField_a_of_type_AndroidGraphicsRect)))
        {
          localaqzd.jdField_a_of_type_AndroidGraphicsRect.union(localRect);
          a(localaqzd, localaqzd.jdField_a_of_type_AndroidGraphicsRect);
          return localRect;
          i = j;
          if (paramRect.top <= localaqzd.jdField_a_of_type_AndroidGraphicsRect.top)
          {
            i = j;
            if (paramRect.bottom >= localaqzd.jdField_a_of_type_AndroidGraphicsRect.bottom)
            {
              localRect.top = localaqzd.jdField_a_of_type_AndroidGraphicsRect.top;
              localRect.bottom = localaqzd.jdField_a_of_type_AndroidGraphicsRect.bottom;
              i = 1;
            }
          }
        }
  ...
  private Rect a(aqzk paramaqzk, Rect paramRect, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    int j = paramaqzk.c;
    int i = j;
    if (paramaqzk.jdField_a_of_type_Int >= 1) {
      i = Math.max(24, (int)(j * (0.95F - aqzc.jdField_a_of_type_JavaUtilRandom.nextInt(10) / 100.0F))) / 4 * 4;
    }
    ...
    if (n < 10)
    {
      ...
      if (m >= 24)
      {
        k = (int)(m * paramaqzk.jdField_a_of_type_Float);
        localObject1 = localObject2;
        i = j;
        if (paramInt1 * paramInt2 >= m * k)
        {
          localObject3 = paramaqzk.jdField_a_of_type_JavaUtilSet.iterator();
          i = j;
          localObject1 = localObject2;
          label142:
    ...
    for (;;)
    {
      if (paramRect == null)
      {
        ...
        m = Math.max(24, (int)(m * (0.95F - aqzc.jdField_a_of_type_JavaUtilRandom.nextInt(6) / 100.0F))) / 4 * 4;
        n += 1;
      ...
      {
        paramaqzk = new aqzd(paramaqzk, -1, paramRect, m, true, i);
        a(paramaqzk, paramRect);
        this.f.add(paramaqzk);
        return paramRect;
      }
      return null;
      label324:
  ...
  private void a(aqzd paramaqzd, Rect paramRect)
  {
    paramaqzd.jdField_a_of_type_JavaUtilArrayList.clear();
    int i4 = paramaqzd.e;
    int i5 = paramaqzd.b;
    float f2 = paramaqzd.jdField_a_of_type_Aqzk.jdField_a_of_type_Float;
    int i3 = 0;
    int i;
    label75:
    int j;
    ...
    for (int m = j;; m = j)
    {
      ...
      for (;;)
      {
        ...
        {
          float f1 = 0.0F;
          i2 = paramaqzd.jdField_a_of_type_Aqzk.b / i4;
          ...
          if (i2 <= 1)
          {
            ...
            i = Math.max(m, 0);
            Math.max(k, 0);
            bool = aqzc.jdField_a_of_type_JavaUtilRandom.nextBoolean();
            f1 = i + paramRect.top;
            i = 0;
          }
          for (;;)
          {
            ...
            if (k < i2)
            {
              ...
              for (j = i;; j = i4 + i)
              {
                localObject1 = (Pair)paramaqzd.jdField_a_of_type_Aqzk.jdField_a_of_type_JavaUtilArrayList.get(j);
                j = Math.round(f2);
                m = Math.round(f1);
                float f5 = i5;
                localObject2 = new aqze(new Rect(j, m, Math.round(((Float)((Pair)localObject1).second).floatValue() * f5 + f2), Math.round(i5 + f1)), (String)((Pair)localObject1).first);
                paramaqzd.jdField_a_of_type_JavaUtilArrayList.add(localObject2);
                f5 = i5;
  ...
  private void a(ArrayList<aqzk> paramArrayList, boolean paramBoolean)
  {
    Collections.sort(paramArrayList, new aqzj(this, paramBoolean, paramArrayList));
  }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        Collections.sort(this.jdField_b_of_type_JavaUtilArrayList, new aqzh(this));
  ...
  private boolean a(Rect paramRect1, Rect paramRect2, int paramInt)
  {
    ...
    while (localIterator.hasNext()) {
      if (a((aqzk)localIterator.next(), paramRect1, paramInt)) {
        return true;
      }
    }
  ...
  private boolean a(aqzk paramaqzk, Rect paramRect, int paramInt)
  {
    Iterator localIterator = paramaqzk.jdField_a_of_type_JavaUtilSet.iterator();
    while (localIterator.hasNext())
    {
      Integer localInteger = (Integer)localIterator.next();
      if (((paramRect.width() + 8) * localInteger.intValue() >= paramaqzk.jdField_a_of_type_Float * paramInt) && (paramRect.height() + 8 >= localInteger.intValue() * paramInt)) {
        return true;
      }
    }
    return false;
  ...
  private void c()
  {
    ...
    {
      Collections.sort(this.jdField_b_of_type_JavaUtilArrayList, new aqzi(this));
      int i4 = this.jdField_b_of_type_JavaUtilArrayList.size();
      localObject2 = null;
      i = 0;
      localObject1 = null;
      j = -1;
      k = aqzc.jdField_a_of_type_Int;
      int i3 = 0;
      while (i3 < i4)
      {
        ...
        localObject3 = localObject1;
        i1 = i;
        if (localRect.width() >= aqzc.jdField_a_of_type_Int)
        {
          if (localRect.height() < aqzc.jdField_a_of_type_Int)
          {
            i1 = i;
            localObject3 = localObject1;
            n = j;
        ...
        {
          localObject3 = (aqzk)localIterator1.next();
          Iterator localIterator2 = ((aqzk)localObject3).jdField_a_of_type_JavaUtilSet.iterator();
          i1 = i;
          localObject2 = localObject1;
          n = j;
          m = k;
          ...
          if (localIterator2.hasNext())
          {
            ...
            if ((localRect.width() * ((Integer)localObject1).intValue() < ((aqzk)localObject3).jdField_a_of_type_Float * aqzc.jdField_a_of_type_Int) || (localRect.height() < aqzc.jdField_a_of_type_Int * ((Integer)localObject1).intValue())) {
              break label639;
            }
            float f1 = ((aqzk)localObject3).jdField_a_of_type_Float / ((Integer)localObject1).intValue();
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localRect = a(localObject2, localObject2.width(), localObject2.height(), (int)(k * ((aqzk)localObject1).jdField_a_of_type_Float / j), k * j, -1, -1, k, aqzc.jdField_a_of_type_Int);
        if (localRect == null) {
          break;
        }
        a(localObject2, localRect, true);
        localObject1 = new aqzd((aqzk)localObject1, -1, localRect, k, false, j);
        a((aqzd)localObject1, localRect);
  ...
  public ArrayList<aqzd> a(ArrayList<aqzk> paramArrayList, Rect paramRect, ArrayList<Rect> paramArrayList1)
  {
    a();
    ...
    for (int i = 1;; i = 0)
    {
      ...
      else
      {
        ...
        paramRect = (aqzk)paramArrayList.next();
        paramRect.a();
        if (paramRect.b == 13) {
          break label365;
        }
