...
public class aqgk
  extends aqbe
{
  private URLDrawableDownListener.Adapter jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new aqgl(this);
  AbsShareMsg jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg;
  String h = "";
  boolean i = false;
  
  public aqgk(Intent paramIntent)
  {
    super(paramIntent);
  }
  ...
  private void a(boolean paramBoolean, String paramString, long paramLong)
  {
    ...
    {
      if (str2.startsWith(ajya.a(2131704841))) {
    ...
    for (;;)
    {
      ...
      abtq.a(this.jdField_a_of_type_AndroidAppActivity, localIntent, MiniChatActivity.class, MiniMultiForwardFragment.class);
      return;
      str1 = str2;
      if (!str2.startsWith(ajya.a(2131704812))) {
        break;
      }
  ...
  private boolean a(AbsShareMsg paramAbsShareMsg)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject = (axup)paramAbsShareMsg.get(j);
        if (!(localObject instanceof axyg)) {
          break label139;
        }
        localObject = ((axyg)localObject).a;
        if (localObject == null) {
          break label179;
        }
        k = 0;
        ...
        axup localaxup = (axup)((List)localObject).get(k);
        if ((!(localaxup instanceof axzs)) || (((axzs)localaxup).a())) {
          break label132;
        }
        bool1 = true;
      }
      ...
      do
      {
        do
        {
          ...
          paramAbsShareMsg = (axxi)localObject;
          bool1 = bool2;
  ...
  private View b()
  {
    ...
    for (;;)
    {
      ...
      if (j != 0)
      {
        ...
        localFrameLayout.addView((View)localObject, new FrameLayout.LayoutParams(-1, bbll.a(33.0F), 16));
        ((View)localObject).setOnClickListener(new aqgm(this));
        ((View)localObject).setContentDescription(ajya.a(2131704813));
      }
  ...
  private void b(bbgu parambbgu)
  {
    ...
    {
      localObject3 = URLDrawable.getDrawable((String)localObject3, -1, actj.a(165.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), localDrawable, localDrawable, true);
  ...
  private View c()
  {
    Object localObject1 = ajya.a(2131704830);
    ...
    if (k == 1) {
      localObject1 = ajya.a(2131704829) + (String)localObject2;
    }
    int j;
    if ((k == 0) || (k == -1))
    {
      localObject1 = (axup)this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mStructMsgItemLists.get(0);
      if ((localObject1 instanceof axuq))
      {
        localObject1 = (axup)((axuq)localObject1).a.get(0);
        if ((localObject1 instanceof StructMsgItemTitle))
        {
          localObject1 = ((StructMsgItemTitle)localObject1).Y;
          if ((!TextUtils.isEmpty((CharSequence)localObject1)) && (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.hasTSum()) && (((String)localObject1).endsWith(ajya.a(2131704810))))
          {
            j = 1;
            if (j == 0) {
              break label565;
            ...
            label183:
            localObject2 = ajya.a(2131704799) + (String)localObject1;
          }
        }
      }
    }
    for (;;)
    {
      ...
      ((EllipsizingTextView)localObject4).setText(new aykk((CharSequence)localObject2, 3, 16));
      ...
      localObject4 = new LinearLayout.LayoutParams(bbll.a(8.0F), bbll.a(14.0F));
      ((LinearLayout.LayoutParams)localObject4).gravity = 17;
      ((LinearLayout.LayoutParams)localObject4).setMargins(bbll.a(3.0F), 0, 0, 0);
      ...
      if (k == 1)
      {
        bool = true;
        label450:
        ((View)localObject2).setOnClickListener(new aqgn(this, bool, (String)localObject1, l));
      ...
      while ((k != 0) && (k != -1))
      {
        ...
        j = 0;
        break;
        localObject1 = ajya.a(2131704807);
        break label183;
        bool = false;
        break label450;
      }
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg != null)
    {
      ...
      for (;;)
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForAudioShare)) {
          ...
          localLayoutParams.setMargins(actj.a(-10.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0, actj.a(-7.5F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0);
        }
      }
  ...
  protected void b()
  {
    ...
    {
      ViewGroup.LayoutParams localLayoutParams = ((LinearLayout)this.jdField_a_of_type_Bbgu.findViewById(2131363314)).getLayoutParams();
  ...
  protected boolean c()
  {
    ...
    if (f())
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForImageShare))
      {
        ...
        {
          localObject2 = actj.a(new Intent(this.jdField_a_of_type_AndroidAppActivity, ChatActivity.class), null);
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForImageShare))
      {
        ...
        if (!this.jdField_a_of_type_AndroidOsBundle.getBoolean("k_back", true))
        {
          localObject1 = actj.a(new Intent(this.jdField_a_of_type_AndroidAppActivity, ChatActivity.class), null);
  ...
  protected int d()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForImageShare))
    {
      localObject1 = bgqm.a((StructMsgForImageShare)this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg);
      if ((localObject1 == null) || (!bgpu.b(((axwv)localObject1).S).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), -1, null))) {}
    }
    else
    {
      for (j = 0;; j = 0)
  ...
  protected void d()
  {
    ...
    axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800567B", "0X800567B", 0, 0, j + "", "", "", "");
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForGeneralShare))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        {
          localObject2 = ((axyg)localObject2).a.iterator();
          while (((Iterator)localObject2).hasNext())
          {
            Object localObject3 = (axup)((Iterator)localObject2).next();
            if ((localObject3 instanceof axzs))
            {
              localObject3 = (axzs)localObject3;
              if (((axzs)localObject3).a()) {
                npu.a("0X80065FF", ((StructMsgForGeneralShare)localObject1).uinType, npu.a(((axzs)localObject3).r, ((StructMsgForGeneralShare)localObject1).mSourceName), ((axzs)localObject3).U, "");
              }
            }
          }
        }
    ...
    for (;;)
    {
      ...
      localObject1 = "";
      if (j != 0) {
        localObject1 = this.jdField_a_of_type_Bbgu.getInputValue();
      }
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForImageShare))
      {
        if (aeht.b(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgActionData))
        {
          localObject1 = aeht.b(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgActionData);
          if ((localObject1 != null) && (localObject1.length > 3))
          {
            localObject1 = localObject1[3];
            if ((localObject1 != null) && (((String)localObject1).equals("1")))
            {
              nol.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "", "0X80072A5", "0X80072A5", 0, 0, "", "", "", "");
              nol.a("0X80072A5", "", "", "", "", "");
            }
          }
        }
  ...
  protected void y()
  {
    ((yer)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(49)).a().a(this.jdField_a_of_type_AndroidOsBundle.getString("uin"), this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg);
    this.jdField_a_of_type_AndroidAppActivity.finish();
  }
}
