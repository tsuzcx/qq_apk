...
public class avhg
  extends Handler
{
  public avhg(ScribbleResMgr paramScribbleResMgr, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      {
        Object localObject = (avhk)localIterator.next();
        if (localObject != null)
        {
          View localView = ((avhk)localObject).a();
          localObject = ((avhk)localObject).a();
          if ((localView != null) && (localObject != null)) {
            ((avhl)localObject).a(localView, paramMessage.arg1, (ScribbleResMgr.ResInfo)paramMessage.obj, paramMessage.what);
          } else {
