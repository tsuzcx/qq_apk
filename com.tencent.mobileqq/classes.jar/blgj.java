  ...
  implements Handler.Callback
{
  ...
  private final blgk jdField_a_of_type_Blgk;
  private final ReleaseLooperHandler jdField_a_of_type_ComTencentWeiyunTransmissionUtilsHandlerReleaseLooperHandler;
  
  public blgj(blgk paramblgk, ReleaseLooperHandler paramReleaseLooperHandler)
  {
    this.jdField_a_of_type_Blgk = paramblgk;
  ...
  private blfr a(Cursor paramCursor)
  {
    Object localObject = blfn.a(paramCursor.getInt(2), paramCursor.getString(6), paramCursor.getString(3), paramCursor.getString(7), paramCursor.getLong(8), paramCursor.getInt(9), paramCursor.getString(4), paramCursor.getString(5), null);
    ((blfn)localObject).f = paramCursor.getString(11);
    blfs localblfs = new blfs();
    localblfs.jdField_a_of_type_Int = paramCursor.getInt(12);
    localblfs.jdField_b_of_type_Int = paramCursor.getInt(13);
    localblfs.jdField_a_of_type_JavaLangString = paramCursor.getString(14);
    localblfs.jdField_a_of_type_Long = paramCursor.getLong(15);
    localblfs.jdField_b_of_type_Long = paramCursor.getLong(16);
    localblfs.jdField_b_of_type_JavaLangString = paramCursor.getString(17);
    localblfs.c = ((blfn)localObject).jdField_a_of_type_JavaLangString;
    localblfs.d = paramCursor.getString(10);
    localObject = blfr.a(paramCursor.getString(1), (blfn)localObject, paramCursor.getString(18), localblfs);
    ((blfr)localObject).a(paramCursor.getLong(0));
    return localObject;
  }
  
  private void a(ContentValues paramContentValues, blfs paramblfs, boolean paramBoolean)
  {
    boolean bool = false;
    ...
    {
      i = 0;
      paramContentValues = this.jdField_a_of_type_Blgk;
      if (i > 0) {
        bool = true;
      }
      paramContentValues.a(l, bool, paramblfs, paramBoolean);
      return;
    }
    if (l >= 0L) {}
  ...
  /* Error */
  private void b(int paramInt, blfr paramblfr)
  {
    // Byte code:
    //   0: aload_2
    //   1: ifnonnull +4 -> 5
    //   4: return
    //   5: aload_2
    //   6: invokevirtual 184	blfr:a	()Lblfn;
    //   9: astore 12
    //   11: aload_2
    //   12: invokevirtual 187	blfr:a	()Lblfs;
    //   15: astore 13
    ...
    //   28: ifnull -24 -> 4
    //   31: aload_2
    //   32: invokevirtual 190	blfr:a	()Ljava/lang/String;
    //   35: astore 8
    //   37: aload 12
    //   39: getfield 114	blfn:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   42: astore 10
    //   44: aload_2
    //   45: invokevirtual 192	blfr:b	()Ljava/lang/String;
    //   48: astore 14
    ...
    //   92: aload 11
    //   94: ldc 162
    //   96: getstatic 23	blgj:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   99: aload 15
    ...
    //   187: astore 8
    //   189: aload 12
    //   191: getfield 222	blfn:c	Ljava/lang/String;
    //   194: astore 10
    ...
    //   290: ldc 37
    //   292: aload 12
    //   294: getfield 243	blfn:jdField_a_of_type_Long	J
    ...
    //   305: ldc 39
    //   307: aload 12
    //   309: getfield 250	blfn:jdField_b_of_type_Int	I
    ...
    //   320: ldc 55
    //   322: aload_2
    //   323: invokevirtual 192	blfr:b	()Ljava/lang/String;
    ...
    //   379: aload 13
    //   381: getfield 113	blfs:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   384: invokestatic 270	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   387: ifne +15 -> 402
    //   390: aload 14
    //   392: ldc 21
    //   394: aload 13
    //   396: getfield 113	blfs:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   482: aload_2
    //   483: lload 6
    //   485: invokevirtual 128	blfr:a	(J)V
    //   488: aload_0
    //   489: getfield 64	blgj:jdField_a_of_type_Blgk	Lblgk;
    //   492: iload_1
    //   493: aload_2
    //   494: aload 8
    ...
    //   548: ldc 45
    //   550: aload 13
    //   552: getfield 102	blfs:jdField_a_of_type_Int	I
    ...
    //   563: ldc 47
    //   565: aload 13
    //   567: getfield 104	blfs:jdField_b_of_type_Int	I
    ...
    //   578: ldc 49
    //   580: aload 13
    //   582: getfield 106	blfs:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   585: invokevirtual 227	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   588: aload 14
    //   590: ldc 51
    //   592: aload 13
    //   594: getfield 109	blfs:jdField_a_of_type_Long	J
    ...
    //   605: ldc 53
    //   607: aload 13
    //   609: getfield 111	blfs:jdField_b_of_type_Long	J
    ...
    //   9	351	12	localblfn	blfn
    //   15	593	13	localblfs	blfs
  ...
  private void b(long paramLong, boolean paramBoolean)
  {
    ...
    //   34: astore 6
    //   36: aload_0
    //   37: getfield 64	blgj:jdField_a_of_type_Blgk	Lblgk;
    //   40: astore 7
    //   42: iload 5
    //   44: istore_3
    //   45: iload 4
    ...
    //   70: aload 10
    //   72: ldc 162
    //   74: getstatic 57	blgj:b	[Ljava/lang/String;
    //   77: ldc 164
    //   79: iconst_1
    ...
    //   113: aload_0
    //   114: aload 7
    //   116: invokespecial 296	blgj:a	(Landroid/database/Cursor;)Lblfr;
    //   119: astore 6
    //   121: aload 7
  ...
  private void b(String paramString)
  {
    ...
    //   15: ifnonnull +15 -> 30
    //   18: aload_0
    //   19: getfield 64	blgj:jdField_a_of_type_Blgk	Lblgk;
    //   22: aload_1
    //   23: aload_2
    ...
    //   77: aload 5
    //   79: ldc 162
    //   81: getstatic 57	blgj:b	[Ljava/lang/String;
    //   84: aload 4
    ...
    //   143: aload_0
    //   144: aload_2
    //   145: invokespecial 296	blgj:a	(Landroid/database/Cursor;)Lblfr;
  ...
  public void a(int paramInt, blfr paramblfr)
  {
    if (paramblfr == null) {
      return;
    }
    this.jdField_a_of_type_ComTencentWeiyunTransmissionUtilsHandlerReleaseLooperHandler.sendMessage(Message.obtain(null, 1, paramInt, 0, paramblfr));
  }
  ...
  public void a(blfr paramblfr, boolean paramBoolean)
  {
    if (paramblfr == null) {
      return;
    }
    blfs localblfs = paramblfr.b();
    ContentValues localContentValues = new ContentValues();
    localContentValues.put("_id", Long.valueOf(paramblfr.a()));
    localContentValues.put("state", Integer.valueOf(localblfs.jdField_a_of_type_Int));
    localContentValues.put("error_code", Integer.valueOf(localblfs.jdField_b_of_type_Int));
    localContentValues.put("error_msg", localblfs.jdField_a_of_type_JavaLangString);
    localContentValues.put("total_size", Long.valueOf(localblfs.jdField_a_of_type_Long));
    localContentValues.put("cur_size", Long.valueOf(localblfs.jdField_b_of_type_Long));
    if (!TextUtils.isEmpty(localblfs.jdField_b_of_type_JavaLangString)) {
      localContentValues.put("local_path", localblfs.jdField_b_of_type_JavaLangString);
    }
    if (!TextUtils.isEmpty(paramblfr.c())) {
      localContentValues.put("file_version", paramblfr.c());
    }
    paramblfr = this.jdField_a_of_type_ComTencentWeiyunTransmissionUtilsHandlerReleaseLooperHandler;
    if (paramBoolean) {}
    for (int i = 1;; i = 0)
    {
      paramblfr.sendMessage(Message.obtain(null, 2, i, 0, new Object[] { localContentValues, localblfs }));
      return;
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    default: 
      return false;
    case 1: 
      b(paramMessage.arg1, (blfr)paramMessage.obj);
      return true;
    case 2: 
      ContentValues localContentValues = (ContentValues)((Object[])(Object[])paramMessage.obj)[0];
      blfs localblfs = (blfs)((Object[])(Object[])paramMessage.obj)[1];
      if (paramMessage.arg1 == 1) {
        bool1 = true;
      }
      a(localContentValues, localblfs, bool1);
      return true;
    case 3: 
