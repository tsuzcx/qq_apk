...
public class anpx
  extends anpn
{
  public anpx(QQAppInterface paramQQAppInterface)
  {
  ...
  public boolean h()
  {
    ...
    int i = llw.f();
    if (QLog.isColorLevel()) {
      QLog.d("PttSilkAndChangeVoiceSoHandler", 2, "isUserNeedDownload cpuArch = " + i + " isUserNeedDownload try match version=" + "8.3.0" + " data.version=" + ((PttSilkAndChangeVoiceSoData)localObject).version);
    }
