...
{
  public static int a;
  almm jdField_a_of_type_Almm = new anqa(this);
  private Resources jdField_a_of_type_AndroidContentResResources;
  public SparseArray<ArrayList<String>> a;
  private anpn jdField_a_of_type_Anpn;
  public anpo a;
  private anpq jdField_a_of_type_Anpq = new anpz(this);
  private anpw jdField_a_of_type_Anpw = new anpy(this);
  private AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface;
  public Runnable a;
  public String a;
  public ArrayList<WeakReference<bcwi>> a;
  public ConcurrentHashMap<String, DynamicAvatar> a;
  public volatile boolean a;
  public String b;
  public ArrayList<WeakReference<bcwi>> b;
  public ArrayList<WeakReference<bcwi>> c;
  public ArrayList<WeakReference<bcwi>> d;
  ...
  public anpx(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_ComTencentCommonAppAppInterface.addObserver(this.jdField_a_of_type_Anpw, true);
    this.d = new ArrayList();
    this.c = new ArrayList();
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
    this.b = new ArrayList();
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
    this.jdField_a_of_type_Anpo = new anpo(paramAppInterface);
    this.jdField_a_of_type_Anpo.a(this.jdField_a_of_type_Anpq);
    this.jdField_a_of_type_AndroidContentResResources = BaseApplicationImpl.getContext().getResources();
    a();
    jdField_a_of_type_Int = this.jdField_a_of_type_Anpn.jdField_a_of_type_Int;
  ...
  private Setting a(int paramInt, String paramString)
  {
    ...
    if (paramInt == 18)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof NearbyAppInterface)) {
        localObject1 = ((bcxl)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(216)).a(paramString);
      }
    }
    do
    {
    ...
    paramString = (Setting)((awbw)localObject1).a(Setting.class, paramString);
    ((awbw)localObject1).a();
    return paramString;
  }
  ...
  public static String a(bcwi parambcwi, boolean paramBoolean)
  {
    if (parambcwi == null) {
      return "";
    }
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append(parambcwi.jdField_b_of_type_Int).append("_").append(parambcwi.jdField_c_of_type_Int).append("_").append(parambcwi.jdField_a_of_type_JavaLangString);
    if ((paramBoolean) || ((parambcwi.jdField_e_of_type_Boolean) && (!TextUtils.isEmpty(parambcwi.jdField_b_of_type_JavaLangString)))) {
      localStringBuilder.append("_").append(parambcwi.jdField_b_of_type_JavaLangString);
    }
    return localStringBuilder.toString();
  }
  ...
  private void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    synchronized (this.c)
    {
      ...
      if (j >= 0)
      {
        ...
        {
          bcwi localbcwi = (bcwi)localWeakReference.get();
          if (localbcwi == null) {
            this.c.remove(j);
          } else if (paramString1.equals(localbcwi.jdField_d_of_type_JavaLangString)) {
            if (TextUtils.isEmpty(paramString2))
            {
              localbcwi.jdField_a_of_type_ComTencentImageURLDrawable = null;
              localbcwi.a();
              this.c.remove(j);
            }
            else
            {
              localbcwi.jdField_b_of_type_JavaLangString = paramString2;
              localbcwi.jdField_c_of_type_JavaLangString = paramString3;
              if ((localbcwi.jdField_a_of_type_MqqUtilWeakReference == null) || (localbcwi.jdField_a_of_type_MqqUtilWeakReference.get() == null) || (!paramString2.equals(((DynamicAvatarView)localbcwi.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_JavaLangString))) {
                break label225;
              }
  ...
  public anpn a()
  {
    if (this.jdField_a_of_type_Anpn == null) {
      a();
    }
    if (QLog.isColorLevel()) {
      QLog.d("Q.dynamicAvatar", 2, "getConfig DynamicAvatarConfig|" + this.jdField_a_of_type_Anpn);
    }
    return this.jdField_a_of_type_Anpn;
  }
  
  public anpo a()
  {
    return this.jdField_a_of_type_Anpo;
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Anpn = new anpn();
    if (QLog.isColorLevel()) {
      QLog.d("Q.dynamicAvatar", 2, "DynamicAvatarConfig|init config:" + this.jdField_a_of_type_Anpn + ",costTime:" + (System.currentTimeMillis() - l));
    }
  }
  
  public void a(anpr paramanpr)
  {
    if (paramanpr == null) {}
    while (!(this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof QQAppInterface)) {
      return;
    }
    awbw localawbw = this.jdField_a_of_type_ComTencentCommonAppAppInterface.getEntityManagerFactory().createEntityManager();
    localawbw.a().a();
    for (;;)
    {
      try
      {
        localCursor = localawbw.a(false, DynamicAvatar.class.getSimpleName(), null, null, null, null, null, null, null);
        if (localCursor != null) {}
        try
        {
          ...
          if (i >= 1000)
          {
            ...
            ((StringBuilder)localObject1).append(";");
            localawbw.b(((StringBuilder)localObject1).toString());
          }
          if ((paramanpr == null) || (paramanpr.jdField_a_of_type_JavaUtilArrayList == null) || (paramanpr.jdField_a_of_type_JavaUtilArrayList.isEmpty())) {
            continue;
          }
          paramanpr = paramanpr.jdField_a_of_type_JavaUtilArrayList.iterator();
          if (!paramanpr.hasNext()) {
            continue;
          }
          localObject1 = DynamicAvatar.convertFrom((anps)paramanpr.next());
          if (localObject1 == null) {
            continue;
          }
          ??? = (DynamicAvatar)localawbw.a(DynamicAvatar.class, "uin=?", new String[] { String.valueOf(((DynamicAvatar)localObject1).uin) });
          if (??? != null)
          {
  ...
  public void a(bcwi parambcwi)
  {
    ...
    synchronized (this.d)
    {
      this.d.remove(parambcwi.jdField_b_of_type_MqqUtilWeakReference);
    }
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      this.jdField_a_of_type_JavaUtilArrayList.remove(parambcwi.jdField_b_of_type_MqqUtilWeakReference);
      this.b.remove(parambcwi.jdField_b_of_type_MqqUtilWeakReference);
      synchronized (this.c)
      {
        this.c.remove(parambcwi.jdField_b_of_type_MqqUtilWeakReference);
        return;
      }
      parambcwi = finally;
      throw parambcwi;
  ...
  public void a(bcwi parambcwi, boolean paramBoolean)
  {
    if (parambcwi == null) {
      return;
    }
    if (paramBoolean)
    {
      String str = a(parambcwi, false);
      ArrayList localArrayList2 = (ArrayList)this.jdField_a_of_type_AndroidUtilSparseArray.get(parambcwi.jdField_e_of_type_Int);
      ArrayList localArrayList1 = localArrayList2;
      if (localArrayList2 == null)
      {
        localArrayList1 = new ArrayList();
        this.jdField_a_of_type_AndroidUtilSparseArray.put(parambcwi.jdField_e_of_type_Int, localArrayList1);
      }
      localArrayList1.add(str);
      localArrayList1.add(a(parambcwi, true));
      if ((parambcwi.jdField_e_of_type_Int == 1) || (parambcwi.jdField_e_of_type_Int == 0)) {
        ThreadManager.post(new DynamicAvatarManager.6(this, parambcwi, System.currentTimeMillis()), 5, null, true);
      }
      if (parambcwi.jdField_a_of_type_MqqUtilWeakReference.get() != null) {
        ((DynamicAvatarView)parambcwi.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_JavaLangString = "";
      }
    }
    ThreadManager.postImmediately(new DynamicAvatarManager.7(this, parambcwi), null, true);
  }
  
  public void a(bcwi parambcwi, boolean paramBoolean1, boolean paramBoolean2)
  {
    if ((this.c.size() < jdField_a_of_type_Int) || (paramBoolean1))
    {
      ??? = parambcwi.jdField_d_of_type_JavaLangString;
      synchronized (this.c)
      {
        this.c.add(parambcwi.jdField_b_of_type_MqqUtilWeakReference);
        if (paramBoolean1) {}
      }
      for (;;)
      {
        ...
        {
          this.d.remove(parambcwi.jdField_b_of_type_MqqUtilWeakReference);
          ??? = new DynamicAvatarManager.3(this, parambcwi, (String)???);
          if (!paramBoolean2)
          {
            l1 = 0L;
            long l2 = l1;
        ...
        if (parambcwi.jdField_e_of_type_Int == 0) {
          l1 = 1500L;
        } else {
          l1 = 400L;
        }
    ...
    synchronized (this.d)
    {
      this.d.add(parambcwi.jdField_b_of_type_MqqUtilWeakReference);
      return;
    }
  }
  ...
  public void a(DynamicAvatar paramDynamicAvatar)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof QQAppInterface))
    {
      localawbw = this.jdField_a_of_type_ComTencentCommonAppAppInterface.getEntityManagerFactory().createEntityManager();
      localDynamicAvatar = (DynamicAvatar)localawbw.a(DynamicAvatar.class, "uin=?", new String[] { String.valueOf(paramDynamicAvatar.uin) });
      ...
      localawbw.b(paramDynamicAvatar);
    }
    for (;;)
    {
      localawbw.a();
      ...
      return;
      label120:
      localawbw.a(paramDynamicAvatar);
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(paramString.basicSmallUrl)) {
        localObject = anpo.a(paramString.basicSmallUrl);
      }
      try
      {
        ...
        if (!TextUtils.isEmpty(paramString.basicMiddleUrl)) {
          localObject = anpo.a(paramString.basicMiddleUrl);
        }
      }
      catch (Exception localException1)
      {
        try
        {
          do
          {
            ...
            paramString = anpo.a(paramString.basicBigUrl);
            try
            {
  ...
  {
    if ((paramBoolean) && (this.jdField_a_of_type_Anpn != null) && (this.jdField_a_of_type_Anpn.jdField_a_of_type_Boolean)) {}
    synchronized (this.jdField_a_of_type_Anpn)
    {
      this.jdField_a_of_type_Anpn.a();
      if (QLog.isColorLevel()) {
        QLog.d("Q.dynamicAvatar", 2, "---onDpcPullFinished---|mDynamicAvatarConfig:" + this.jdField_a_of_type_Anpn);
      }
      if (QLog.isColorLevel()) {
  ...
  public boolean a(int paramInt)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("Q.dynamicAvatar", 2, "isPlayDynamicAvatar|source:" + paramInt + ",isPlay:" + bool1 + "\n" + this.jdField_a_of_type_Anpn);
      }
      return bool1;
      bool1 = this.jdField_a_of_type_Anpn.jdField_c_of_type_Boolean;
      continue;
      bool1 = this.jdField_a_of_type_Anpn.d;
      continue;
      bool1 = this.jdField_a_of_type_Anpn.f;
      continue;
      bool1 = this.jdField_a_of_type_Anpn.g;
      continue;
      bool1 = this.jdField_a_of_type_Anpn.jdField_e_of_type_Boolean;
      continue;
      bool1 = this.jdField_a_of_type_Anpn.h;
      continue;
      bool1 = true;
      continue;
      bool1 = this.jdField_a_of_type_Anpn.f;
  ...
  @TargetApi(11)
  public boolean a(bcwi parambcwi)
  {
    int i = 640;
    Object localObject1;
    Object localObject2;
    ...
    if (!parambcwi.f)
    {
      localObject1 = a(parambcwi, false);
      localObject2 = (ArrayList)this.jdField_a_of_type_AndroidUtilSparseArray.get(parambcwi.jdField_e_of_type_Int);
    ...
    File localFile = anpo.a(parambcwi.jdField_b_of_type_JavaLangString);
    if (parambcwi.jdField_d_of_type_Int == 640) {}
    for (;;)
    {
      URLDrawable.URLDrawableOptions localURLDrawableOptions = URLDrawable.URLDrawableOptions.obtain();
      localURLDrawableOptions.mRequestWidth = i;
      localURLDrawableOptions.mRequestHeight = i;
      localObject2 = parambcwi.jdField_a_of_type_AndroidGraphicsDrawableDrawable;
      localObject1 = localObject2;
      if ((localObject2 instanceof bcxb)) {
        localObject1 = ((bcxb)localObject2).a();
      }
      ...
      ((VideoDrawable.VideoDrawableParams)localObject1).mRequestedFPS = this.jdField_a_of_type_Anpn.jdField_c_of_type_Int;
      int j = i;
      if (azib.b()) {
        j = bdda.a(i);
      }
      ...
      boolean bool2 = parambcwi.a(URLDrawable.getDrawable(localFile, localURLDrawableOptions));
      bool1 = bool2;
      if (!bool2) {
        break;
      }
      ...
      bool1 = bool2;
      if (bcwi.jdField_a_of_type_ArrayOfInt.length <= parambcwi.jdField_e_of_type_Int) {
        break;
      }
      bool1 = bool2;
      ...
      anqj.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, "0X800711C", bcwi.jdField_a_of_type_ArrayOfInt[parambcwi.jdField_e_of_type_Int]);
      return bool2;
      if (parambcwi.jdField_d_of_type_Int == 200) {
        i = 200;
      } else {
        i = 100;
      }
  ...
  public DynamicAvatar b(int paramInt, String paramString)
  {
    ...
    if (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null)
    {
      ...
      {
        localObject = "tinyId=?";
        localObject = (DynamicAvatar)localawbw.a(DynamicAvatar.class, (String)localObject, new String[] { paramString });
        localawbw.a();
      }
    }
  ...
  public void b(bcwi parambcwi)
  {
    ...
    do
    {
      ...
      ??? = a(parambcwi, false);
      localArrayList = (ArrayList)this.jdField_a_of_type_AndroidUtilSparseArray.get(parambcwi.jdField_e_of_type_Int);
    ...
    a(parambcwi, true, true);
  }
  
  public void b(String paramString)
  {
    if (TextUtils.isEmpty(paramString)) {}
    while (this.jdField_a_of_type_Anpo == null) {
      return;
    }
    this.jdField_a_of_type_Anpo.a(paramString);
  }
    ...
    synchronized (this.d)
    {
      ...
      if (i >= 0)
      {
        ...
        if ((localWeakReference1 != null) && (localWeakReference1.get() != null)) {
          ((bcwi)localWeakReference1.get()).a();
        } else {
          this.d.remove(i);
        }
      }
      ...
      synchronized (this.c)
      {
        ...
        if (m >= jdField_a_of_type_Int)
        {
          ...
          if (j >= k - i)
          {
            ...
            ((ArrayList)localObject2).add(((bcwi)localWeakReference2.get()).jdField_b_of_type_JavaLangString);
            break label434;
          }
        }
        else
        ...
        if (this.jdField_a_of_type_Anpo != null) {
          this.jdField_a_of_type_Anpo.a((ArrayList)localObject2);
        }
      }
      synchronized (this.d)
      {
        ...
        while (i >= 0)
        {
          ...
          {
            a((bcwi)((WeakReference)localObject2).get(), false, false);
            i -= 1;
            continue;
  ...
  public void onDestroy()
  {
    ...
    this.jdField_a_of_type_ComTencentCommonAppAppInterface.removeObserver(this.jdField_a_of_type_Anpw);
    this.jdField_a_of_type_Anpo.b();
    this.jdField_a_of_type_Anpo = null;
    this.jdField_a_of_type_Anpw = null;
