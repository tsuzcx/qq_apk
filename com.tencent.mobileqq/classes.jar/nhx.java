...
public class nhx
  extends nhw
  implements View.OnClickListener, View.OnKeyListener, pnj, poa, qhm, qhs, qjd, qje
{
  ...
  public nhx(Activity paramActivity)
  {
    super(paramActivity);
    this.jdField_c_of_type_Int = -1;
    this.jdField_a_of_type_Ohe = new nhz(this);
  }
  ...
  public qik a()
  {
    return this.jdField_a_of_type_Qik;
  }
  
  public void a()
  {
    super.a();
    this.jdField_a_of_type_Qik = new qik(this.jdField_a_of_type_AndroidAppActivity);
    this.jdField_a_of_type_Qhp = new qhp(this.jdField_a_of_type_AndroidAppActivity);
    this.jdField_a_of_type_Qhp.a(this.jdField_a_of_type_Qik);
    ...
    ((ReadInJoyListViewGroup)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyBaseListViewGroup).setNotifyEndRefresh(new nhy(this));
    ...
    {
      localObject = new.b();
      new.a.put(ReadInJoyVideoChannelFragment.class, localObject);
    }
    for (;;)
    {
      this.jdField_a_of_type_Qhp.a((String)localObject);
      this.jdField_a_of_type_Qik.a((String)localObject);
      ...
      b();
      return;
      String str = (String)new.a.get(ReadInJoyChannelActivity.class);
      localObject = str;
  ...
  public void a(pxn parampxn1, pxn parampxn2, int paramInt, boolean paramBoolean)
  {
    ...
    {
      parampxn1 = ((qht)parampxn1).a;
      localBaseArticleInfo = ((qht)parampxn2).a;
      if ((parampxn1 != null) && (localBaseArticleInfo != null))
      {
    ...
    {
      localqoe.a(parampxn1, localBaseArticleInfo, paramBoolean);
      if (!this.jdField_a_of_type_Qiy.a()) {
        this.jdField_a_of_type_Qoe.a((qht)parampxn2, 1);
      }
      return;
    }
  }
  ...
  public void c(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Qoe != null) {
      this.jdField_a_of_type_Qoe.a(paramInt);
    }
  }
  ...
  public void d()
  {
    ...
    if (this.jdField_a_of_type_Qiy != null) {
      this.jdField_a_of_type_Qiy.a(null);
    }
  }
  ...
  public void k()
  {
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyBaseListViewGroup != null) && ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyBaseListViewGroup instanceof ReadInJoyListViewGroup)))
    {
      ...
      Map localMap2 = rvf.a(b());
      ThreadManager.executeOnSubThread(new ReadInJoyChannelViewController.3(this, localMap1, a(Integer.valueOf(b())), localMap2, obz.e(b())));
  ...
  public void n()
  {
    if (vnd.a(a()))
    {
      rwb.a(a(), "video_type_videopublic");
      ndn.a(null, "", "0X8009338", "0X8009338", 0, 0, "", "", "", new.a("0"), false);
      return;
    }
    bbmy.a(a(), -1, ajjy.a(2131647284), 0).b(a().getResources().getDimensionPixelSize(2131167766));
    rwb.b(a(), "video_type_videopublic");
    ndn.a(null, "", "0X8009338", "0X8009338", 0, 0, "", "", "", new.a("1"), false);
  }
  ...
  public void onClick(View paramView)
  {
    ...
    ndn.a(null, null, "0X800932E", "0X800932E", 0, 0, "", "", "", new.a(null), false);
  }
