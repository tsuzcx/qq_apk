...
public class aojs
  implements anui, BusinessObserver
{
  ...
  private void O(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    a(paramBoolean, (bhbw)paramObject);
  }
  ...
  private void Q(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    if ((paramObject instanceof Object[]))
    {
      ...
      if (paramObject.length > 0) {
        localObject1 = (bfyk)paramObject[0];
      }
    }
    a(paramBoolean, (bfyk)localObject1);
  }
  ...
  private void bA(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    a(paramBoolean, (String)paramObject[0], ((Boolean)paramObject[1]).booleanValue(), (String)paramObject[2]);
  }
  ...
  private void bG(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    if ((paramObject != null) && ((paramObject instanceof Object[])))
    {
      ...
      if (paramObject.length == 3)
      {
        b(paramBoolean, paramObject[0], paramObject[1], ((Integer)paramObject[2]).intValue());
        return;
      }
      b(false, null, null, -1);
      return;
  ...
  private void ba(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    f((String)((Object[])(Object[])paramObject)[0]);
  }
  ...
  private void bg(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    a(paramBoolean, ((Integer)paramObject[0]).intValue(), ((Long)paramObject[1]).longValue(), (bgtw)paramObject[2]);
  }
  ...
  protected void b(boolean paramBoolean, Object paramObject1, Object paramObject2, int paramInt) {}
