  ...
  extends WebChromeClient
{
  ...
  private String a(Context paramContext, String paramString)
  {
    ...
    if (paramString.startsWith("data:")) {
      return paramContext.getString(2131693157);
    }
    try
    {
  ...
  public boolean onJsAlert(WebView paramWebView, String paramString1, String paramString2, JsResult paramJsResult)
  {
    ...
    if (((localContext instanceof Activity)) && (!((Activity)localContext).isFinishing()) && ((!(paramWebView instanceof CustomWebView)) || (!((CustomWebView)paramWebView).isPaused)))
    {
      ...
      this.jdField_a_of_type_Bgpa = bglp.a(localContext, 0);
      this.jdField_a_of_type_Bgpa.setTitle(a(localContext, paramString1));
      this.jdField_a_of_type_Bgpa.setMessage(paramString2);
      this.jdField_a_of_type_Bgpa.setPositiveButton(2131694081, new nvv(this, paramJsResult));
      if (this.jdField_a_of_type_Int > 2) {
        this.jdField_a_of_type_Bgpa.setNegativeButton(localContext.getString(2131690555), localContext.getResources().getColor(2131165368), new nvy(this, paramJsResult, localContext));
      }
      this.jdField_a_of_type_Bgpa.setOnCancelListener(new nvz(this, paramJsResult, localContext));
  ...
  public boolean onJsBeforeUnload(WebView paramWebView, String paramString1, String paramString2, JsResult paramJsResult)
  {
    ...
    if (((paramString1 instanceof Activity)) && (!((Activity)paramString1).isFinishing()) && ((!(paramWebView instanceof CustomWebView)) || (!((CustomWebView)paramWebView).isPaused)))
    {
      ...
      this.jdField_a_of_type_Bgpa = bglp.a(paramString1, 0);
      this.jdField_a_of_type_Bgpa.setTitle(2131693156);
      this.jdField_a_of_type_Bgpa.setMessage(paramString2);
      this.jdField_a_of_type_Bgpa.setPositiveButton(2131690490, new nwe(this, paramJsResult));
      if (this.jdField_a_of_type_Int > 2) {
        this.jdField_a_of_type_Bgpa.setNegativeButton(paramString1.getString(2131690555), paramString1.getResources().getColor(2131165368), new nwf(this, paramJsResult, paramString1));
      }
      for (;;)
      {
        this.jdField_a_of_type_Bgpa.setOnCancelListener(new nvx(this, paramJsResult, paramString1));
        this.jdField_a_of_type_Bgpa.show();
        return true;
        this.jdField_a_of_type_Bgpa.setNegativeButton(2131690489, new nvw(this, paramJsResult));
      }
    }
    paramJsResult.cancel();
    return true;
  ...
  public boolean onJsConfirm(WebView paramWebView, String paramString1, String paramString2, JsResult paramJsResult)
  {
    ...
    if (((localContext instanceof Activity)) && (!((Activity)localContext).isFinishing()) && ((!(paramWebView instanceof CustomWebView)) || (!((CustomWebView)paramWebView).isPaused)))
    {
      ...
      this.jdField_a_of_type_Bgpa.setTitle(a(localContext, paramString1));
      this.jdField_a_of_type_Bgpa.setMessage(paramString2);
      this.jdField_a_of_type_Bgpa.setPositiveButton(2131694081, new nwa(this, paramJsResult));
      if (this.jdField_a_of_type_Int > 2) {
        this.jdField_a_of_type_Bgpa.setNegativeButton(localContext.getString(2131690555), localContext.getResources().getColor(2131165368), new nwb(this, paramJsResult, localContext));
      }
      for (;;)
      {
        this.jdField_a_of_type_Bgpa.setOnCancelListener(new nwd(this, paramJsResult, localContext));
        this.jdField_a_of_type_Bgpa.show();
        return true;
        this.jdField_a_of_type_Bgpa.setNegativeButton(2131690582, new nwc(this, paramJsResult));
      }
    }
    paramJsResult.cancel();
    return true;
