...
public class nvu
  extends BaseAdapter
{
  public nvu(nvt paramnvt) {}
  
  public obr a(int paramInt)
  {
    return (obr)this.a.jdField_a_of_type_JavaUtilArrayList.get(paramInt);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      paramView.jdField_a_of_type_ComTencentImageURLImageView.setBackgroundDrawable(URLDrawable.getDrawable(((obr)localObject2).e, null, null, true));
      paramView.jdField_a_of_type_AndroidWidgetTextView.setText(((obr)localObject2).a);
      EventCollector.getInstance().onListGetView(paramInt, (View)localObject1, paramViewGroup, getItemId(paramInt));
      return localObject1;
      localObject2 = (nvv)paramView.getTag();
