...
class athz
{
  ...
  public athz(atht paramatht, msg_comm.Msg paramMsg, msg_comm.MsgHead paramMsgHead, int paramInt1, int paramInt2)
  {
  ...
  {
    Object localObject;
    if ((bcsc.c(this.jdField_a_of_type_Int)) && (this.jdField_a_of_type_MsfMsgcommMsg_comm$MsgHead.c2c_cmd.has()) && (this.b == 169))
    {
