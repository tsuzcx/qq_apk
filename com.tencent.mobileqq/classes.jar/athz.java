...
public class athz
{
  ...
  public athz(AppInterface paramAppInterface)
  {
  ...
  public void a(long paramLong1, long paramLong2, int paramInt1, int paramInt2, boolean paramBoolean, atig paramatig)
  {
    ...
    for (paramInt2 = 1;; paramInt2 = 2)
    {
      ...
      mxi.a(this.a, new atie(this, paramatig), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
      return;
    }
  }
  
  public void a(long paramLong, String paramString, atig paramatig)
  {
    oidb_0xada.ReqBody localReqBody = new oidb_0xada.ReqBody();
    if (a(localReqBody))
    {
      ...
      mxi.a(this.a, new atif(this, paramatig), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
    }
  }
  
  public void a(String paramString, atig paramatig)
  {
    oidb_0xada.ReqBody localReqBody = new oidb_0xada.ReqBody();
    if (a(localReqBody))
    {
      ...
      mxi.a(this.a, new atib(this, paramatig), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
    }
  }
  
  public void a(String paramString, atig paramatig, Bundle paramBundle)
  {
    oidb_0xada.ReqBody localReqBody = new oidb_0xada.ReqBody();
    if (a(localReqBody))
    {
      ...
      mxi.a(this.a, new atia(this, paramatig), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, paramBundle, 0L);
    }
  }
  
  public void b(String paramString, atig paramatig)
  {
    ...
    if (a(localReqBody))
    {
      ...
      mxi.a(this.a, new atid(this, paramString, paramatig), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
    }
  }
  
  public void b(String paramString, atig paramatig, Bundle paramBundle)
  {
    oidb_0xada.ReqBody localReqBody = new oidb_0xada.ReqBody();
    if (a(localReqBody))
    {
      ...
      mxi.a(this.a, new atic(this, paramatig), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, paramBundle, 0L);
    }
  }
}
