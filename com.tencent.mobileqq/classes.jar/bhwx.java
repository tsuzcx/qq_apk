  ...
  extends RemoteCommand
{
  ...
  public bhwx(QQAppInterface paramQQAppInterface)
  {
  ...
  protected Bundle a()
  {
    ...
    localBundle.putString("param_rsp_upgrade_troop_url", bbqd.a("vipUpGroupLimit"));
    return localBundle;
  }
  ...
  protected Bundle a(Bundle paramBundle)
  {
    ...
    Bundle localBundle = new Bundle();
    localBundle.putString("param_rsp_troop_owmer_field", ((baky)this.a.getManager(48)).a(paramBundle.getString("req_troop_uin")));
    return localBundle;
  }
  ...
  protected Bundle a(Bundle paramBundle, int paramInt)
  {
    ...
    Bundle localBundle = new Bundle();
    if (paramInt == 5) {
      str = bbcz.h(this.a, paramBundle.getString("req_troop_uin"), paramBundle.getString("memUin"));
    }
    for (;;)
    {
      ...
      return localBundle;
      if (paramInt == 6) {
        str = bbcz.h(this.a, paramBundle.getString("memUin"));
      }
    }
  }
  ...
  public Bundle invoke(Bundle paramBundle, RemoteCommand.OnInvokeFinishLinstener paramOnInvokeFinishLinstener)
  {
    ...
    catch (Exception paramBundle)
    {
      ...
      axqy.b(this.a, "P_CliOper", "BizTechReport", "", "troop_manage_plugin", "plugin_cmd_exp", 0, 0, paramBundle.getClass().getName(), null, null, null);
      return null;
    }
