...
public class ayjt
{
  public static final String a = bbuv.a(ajsf.aY + "emojiindex");
  public static final String b = bbuv.a(ajsf.aY + "emojis");
  ...
  public static boolean a(java.io.File paramFile)
  {
    ...
    //   15: iconst_2
    //   16: ldc 78
    //   18: invokestatic 82	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   21: iconst_0
    //   22: ireturn
    //   23: new 65	java/io/File
    //   26: dup
    //   27: getstatic 19	ajsf:aY	Ljava/lang/String;
    //   30: invokestatic 34	bbuv:a	(Ljava/lang/String;)Ljava/lang/String;
    //   33: invokespecial 85	java/io/File:<init>	(Ljava/lang/String;)V
    //   36: astore 5
    //   38: aload 5
    //   40: invokevirtual 69	java/io/File:exists	()Z
    //   43: ifne +9 -> 52
    //   46: aload 5
    //   48: invokevirtual 88	java/io/File:mkdirs	()Z
    //   51: pop
    //   52: invokestatic 94	android/os/SystemClock:uptimeMillis	()J
    //   55: lstore_3
    //   56: aconst_null
    //   57: astore 9
    //   59: aconst_null
    ...
    //   65: aconst_null
    //   66: astore 8
    //   68: new 96	com/tencent/commonsdk/zip/QZipInputStream
    //   71: dup
    //   72: new 98	java/io/BufferedInputStream
    //   75: dup
    //   76: new 100	java/io/FileInputStream
    //   79: dup
    //   80: aload_0
    //   81: invokespecial 103	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   84: invokespecial 106	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   87: invokespecial 107	com/tencent/commonsdk/zip/QZipInputStream:<init>	(Ljava/io/InputStream;)V
    //   90: astore 6
    //   92: new 109	java/io/BufferedOutputStream
    //   95: dup
    //   96: new 111	java/io/FileOutputStream
    //   99: dup
    //   100: getstatic 40	ayjt:b	Ljava/lang/String;
    //   103: invokespecial 112	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   106: invokespecial 115	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   109: astore 5
    //   111: aload 10
    //   113: astore 7
    //   115: new 117	java/util/HashMap
    //   118: dup
    //   119: aload_0
    //   120: invokevirtual 120	java/io/File:length	()J
    //   123: l2i
    //   124: sipush 1024
    //   127: idiv
    ...
    //   181: aload 9
    //   183: ldc 143
    //   185: invokevirtual 149	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   188: ifeq +25 -> 213
    //   191: aload_0
    //   192: astore 7
    //   194: aload 9
    //   196: aload 9
    //   198: bipush 47
    //   200: invokevirtual 153	java/lang/String:lastIndexOf	(I)I
    //   203: iconst_1
    //   204: iadd
    //   205: invokevirtual 157	java/lang/String:substring	(I)Ljava/lang/String;
    //   208: invokevirtual 160	java/lang/String:trim	()Ljava/lang/String;
    //   211: astore 8
    //   213: aload 8
    //   215: ifnull -66 -> 149
    //   218: aload_0
    ...
    //   266: aload 5
    //   268: iload_2
    //   269: invokestatic 183	ayjt:a	(Ljava/io/OutputStream;I)V
    //   272: iload_1
    //   273: iconst_4
    //   274: iadd
    //   275: istore_1
    ...
    //   279: aload 6
    //   281: aload_0
    //   282: invokevirtual 185	com/tencent/commonsdk/zip/QZipInputStream:read	([B)I
    //   285: istore_2
    //   286: iload_2
    //   287: iconst_m1
    ...
    //   297: iconst_0
    //   298: iload_2
    //   299: invokevirtual 188	java/io/BufferedOutputStream:write	([BII)V
    //   302: iload_1
    //   303: iload_2
    //   304: iadd
    //   305: istore_1
    ...
    //   310: astore 7
    //   312: aload 5
    //   314: invokevirtual 191	java/io/BufferedOutputStream:flush	()V
    //   317: goto -168 -> 149
    //   320: aload_0
    //   321: astore 7
    ...
    //   326: aload_0
    //   327: invokevirtual 195	com/tencent/commonsdk/pool/ByteArrayPool:returnBuf	([B)V
    //   330: aconst_null
    //   331: astore 8
    //   333: aconst_null
    //   334: astore 11
    ...
    //   337: astore 7
    //   339: aload 5
    //   341: invokevirtual 198	java/io/BufferedOutputStream:close	()V
    //   344: invokestatic 74	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   347: ifeq +11 -> 358
    //   350: ldc 76
    //   352: iconst_2
    //   353: ldc 200
    //   355: invokestatic 82	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   358: new 109	java/io/BufferedOutputStream
    //   361: dup
    //   362: new 111	java/io/FileOutputStream
    //   365: dup
    //   366: getstatic 36	ayjt:a	Ljava/lang/String;
    //   369: invokespecial 112	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   372: invokespecial 115	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   375: astore_0
    //   376: aload 11
    //   378: astore 10
    //   380: aload_0
    ...
    //   385: astore 8
    //   387: aload 12
    //   389: invokeinterface 204 1 0
    //   394: invokeinterface 210 1 0
    //   399: astore 5
    //   401: aload 11
    //   403: astore 10
    //   405: aload_0
    ...
    //   479: iconst_2
    //   480: aload 13
    //   482: invokevirtual 223	java/lang/String:length	()I
    //   485: iconst_4
    //   486: isub
    //   487: invokevirtual 226	java/lang/String:substring	(II)Ljava/lang/String;
    //   490: astore 14
    //   492: aload 11
    //   494: astore 10
    //   496: aload_0
    ...
    //   503: aload 12
    //   505: aload 13
    //   507: invokeinterface 230 2 0
    //   512: checkcast 168	java/lang/Integer
    //   515: invokevirtual 233	java/lang/Integer:intValue	()I
    //   518: istore_1
    //   519: aload 11
    //   521: astore 10
    //   523: aload_0
    ...
    //   530: aload 14
    //   532: bipush 16
    //   534: invokestatic 237	java/lang/Integer:parseInt	(Ljava/lang/String;I)I
    //   537: istore_2
    //   538: aload 11
    //   540: astore 10
    //   542: aload_0
    ...
    //   549: aload_0
    //   550: iconst_1
    //   551: invokevirtual 238	java/io/BufferedOutputStream:write	(I)V
    //   554: aload 11
    //   556: astore 10
    //   558: aload_0
    //   559: astore 9
    ...
    //   565: aload_0
    //   566: iload_2
    //   567: invokestatic 183	ayjt:a	(Ljava/io/OutputStream;I)V
    //   570: aload 11
    //   572: astore 10
    //   574: aload_0
    //   575: astore 9
    ...
    //   581: aload_0
    //   582: iload_1
    //   583: invokestatic 183	ayjt:a	(Ljava/io/OutputStream;I)V
    //   586: goto -185 -> 401
    //   589: astore 14
    //   591: aload 11
    //   593: astore 10
    ...
    //   602: ldc 76
    //   604: iconst_1
    //   605: invokestatic 243	actn:a	()Ljava/lang/StringBuilder;
    //   608: ldc 245
    ...
    //   621: aload 14
    //   623: invokestatic 249	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   626: goto -225 -> 401
    //   629: astore 8
    //   631: aconst_null
    //   632: astore 5
    ...
    //   640: aload 8
    //   642: astore 6
    //   644: invokestatic 74	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   647: ifeq +13 -> 660
    //   650: ldc 76
    //   652: iconst_2
    //   653: ldc 251
    //   655: aload 6
    //   657: invokestatic 249	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   660: aload_0
    //   661: ifnull +7 -> 668
    //   664: aload_0
    //   665: invokevirtual 252	com/tencent/commonsdk/zip/QZipInputStream:close	()V
    //   668: aload 7
    //   670: ifnull +8 -> 678
    //   673: aload 7
    //   675: invokevirtual 198	java/io/BufferedOutputStream:close	()V
    //   678: aload 5
    //   680: ifnull -659 -> 21
    //   683: invokestatic 128	com/tencent/commonsdk/pool/ByteArrayPool:getGenericInstance	()Lcom/tencent/commonsdk/pool/ByteArrayPool;
    //   686: aload 5
    //   688: invokevirtual 195	com/tencent/commonsdk/pool/ByteArrayPool:returnBuf	([B)V
    //   691: iconst_0
    //   692: ireturn
    //   693: astore_0
    //   694: aload_0
    //   695: invokevirtual 255	java/io/IOException:printStackTrace	()V
    //   698: iconst_0
    //   699: ireturn
    //   700: aload 11
    //   702: astore 10
    ...
    //   713: iconst_0
    //   714: aload 13
    //   716: invokevirtual 223	java/lang/String:length	()I
    //   719: iconst_4
    //   720: isub
    //   721: invokevirtual 226	java/lang/String:substring	(II)Ljava/lang/String;
    //   724: ldc 221
    //   726: invokevirtual 259	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   729: astore 14
    //   731: aload 11
    //   733: astore 10
    //   735: aload_0
    ...
    //   742: aload 12
    //   744: aload 13
    //   746: invokeinterface 230 2 0
    //   751: checkcast 168	java/lang/Integer
    //   754: invokevirtual 233	java/lang/Integer:intValue	()I
    //   757: istore_2
    //   758: aload 14
    //   760: ifnull -359 -> 401
    //   763: aload 11
    ...
    //   818: aaload
    //   819: iconst_2
    //   820: invokevirtual 157	java/lang/String:substring	(I)Ljava/lang/String;
    //   823: bipush 16
    //   825: invokestatic 237	java/lang/Integer:parseInt	(Ljava/lang/String;I)I
    //   828: iastore
    //   829: iload_1
    //   830: iconst_1
    //   831: iadd
    ...
    //   848: aload 14
    //   850: arraylength
    //   851: invokevirtual 238	java/io/BufferedOutputStream:write	(I)V
    //   854: iconst_0
    //   855: istore_1
    //   856: aload 11
    //   858: astore 10
    ...
    //   888: iload_1
    //   889: iaload
    //   890: invokestatic 183	ayjt:a	(Ljava/io/OutputStream;I)V
    //   893: iload_1
    //   894: iconst_1
    //   895: iadd
    //   896: istore_1
    ...
    //   911: aload_0
    //   912: iload_2
    //   913: invokestatic 183	ayjt:a	(Ljava/io/OutputStream;I)V
    //   916: goto -515 -> 401
    //   919: astore 5
    //   921: aload 7
    //   923: astore 10
    ...
    //   928: aload 6
    //   930: astore 8
    //   932: invokestatic 74	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   935: ifeq +25 -> 960
    //   938: aload 7
    //   940: astore 10
    //   942: aload_0
    ...
    //   952: ldc_w 261
    //   955: aload 5
    //   957: invokestatic 249	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   960: aload 6
    //   962: ifnull +8 -> 970
    //   965: aload 6
    //   967: invokevirtual 252	com/tencent/commonsdk/zip/QZipInputStream:close	()V
    //   970: aload_0
    //   971: ifnull +7 -> 978
    //   974: aload_0
    //   975: invokevirtual 198	java/io/BufferedOutputStream:close	()V
    //   978: aload 7
    //   980: ifnull -959 -> 21
    //   983: invokestatic 128	com/tencent/commonsdk/pool/ByteArrayPool:getGenericInstance	()Lcom/tencent/commonsdk/pool/ByteArrayPool;
    //   986: aload 7
    //   988: invokevirtual 195	com/tencent/commonsdk/pool/ByteArrayPool:returnBuf	([B)V
    //   991: iconst_0
    //   992: ireturn
    //   993: astore_0
    //   994: aload_0
    //   995: invokevirtual 255	java/io/IOException:printStackTrace	()V
    //   998: iconst_0
    //   999: ireturn
    //   1000: aload 11
    //   1002: astore 10
    ...
    //   1009: astore 8
    //   1011: aload_0
    //   1012: invokevirtual 191	java/io/BufferedOutputStream:flush	()V
    //   1015: aload 11
    //   1017: astore 10
    //   1019: aload_0
    //   1020: astore 9
    //   1022: aload 6
    //   1024: astore 8
    //   1026: invokestatic 267	com/tencent/common/app/BaseApplicationImpl:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   1029: astore 12
    //   1031: aload 11
    //   1033: astore 10
    //   1035: aload_0
    ...
    //   1038: aload 6
    //   1040: astore 8
    //   1042: getstatic 273	android/os/Build$VERSION:SDK_INT	I
    //   1045: bipush 24
    ...
    //   1059: astore 8
    //   1061: aload 12
    //   1063: invokestatic 279	android/preference/PreferenceManager:getDefaultSharedPreferencesName	(Landroid/content/Context;)Ljava/lang/String;
    //   1066: astore 5
    //   1068: aload 11
    //   1070: astore 10
    //   1072: aload_0
    ...
    //   1081: aload 5
    //   1083: iconst_4
    //   1084: invokevirtual 285	android/content/Context:getSharedPreferences	(Ljava/lang/String;I)Landroid/content/SharedPreferences;
    //   1087: invokeinterface 291 1 0
    //   1092: ldc_w 293
    //   1095: iconst_1
    //   1096: invokeinterface 299 3 0
    //   1101: invokeinterface 302 1 0
    //   1106: pop
    //   1107: aload 11
    //   1109: astore 10
    //   1111: aload_0
    ...
    //   1114: aload 6
    //   1116: astore 8
    //   1118: invokestatic 74	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   1121: ifeq +23 -> 1144
    //   1124: aload 11
    //   1126: astore 10
    //   1128: aload_0
    ...
    //   1137: iconst_2
    //   1138: ldc_w 304
    //   1141: invokestatic 82	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   1144: aload 11
    //   1146: astore 10
    //   1148: aload_0
    //   1149: astore 9
    //   1151: aload 6
    //   1153: astore 8
    //   1155: new 65	java/io/File
    //   1158: dup
    //   1159: getstatic 36	ayjt:a	Ljava/lang/String;
    //   1162: invokespecial 85	java/io/File:<init>	(Ljava/lang/String;)V
    //   1165: astore 5
    //   1167: aload 11
    //   1169: astore 10
    //   1171: aload_0
    ...
    //   1174: aload 6
    //   1176: astore 8
    //   1178: new 65	java/io/File
    //   1181: dup
    //   1182: getstatic 40	ayjt:b	Ljava/lang/String;
    //   1185: invokespecial 85	java/io/File:<init>	(Ljava/lang/String;)V
    //   1188: astore 12
    //   1190: aload 11
    //   1192: astore 10
    //   1194: aload_0
    ...
    //   1199: astore 8
    //   1201: aload 5
    //   1203: invokevirtual 69	java/io/File:exists	()Z
    //   1206: ifeq +40 -> 1246
    //   1209: aload 11
    //   1211: astore 10
    //   1213: aload_0
    ...
    //   1218: astore 8
    //   1220: aload 12
    //   1222: invokevirtual 69	java/io/File:exists	()Z
    //   1225: ifeq +21 -> 1246
    //   1228: aload 11
    //   1230: astore 10
    //   1232: aload_0
    ...
    //   1239: aload 5
    //   1241: aload 12
    //   1243: invokestatic 309	ayjw:a	(Ljava/io/File;Ljava/io/File;)V
    //   1246: aload 11
    //   1248: astore 10
    //   1250: aload_0
    //   1251: astore 9
    //   1253: aload 6
    //   1255: astore 8
    //   1257: invokestatic 74	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   1260: ifeq +62 -> 1322
    //   1263: aload 11
    //   1265: astore 10
    //   1267: aload_0
    ...
    //   1290: getstatic 314	ayjw:jdField_a_of_type_AndroidUtilSparseIntArray	Landroid/util/SparseIntArray;
    //   1293: invokevirtual 319	android/util/SparseIntArray:size	()I
    //   1296: invokevirtual 322	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   1299: ldc_w 324
    //   1302: invokevirtual 23	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   1305: getstatic 327	ayjw:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   1308: invokeinterface 328 1 0
    //   1313: invokevirtual 322	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   1316: invokevirtual 29	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   1319: invokestatic 82	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   1322: aload 6
    //   1324: ifnull +8 -> 1332
    //   1327: aload 6
    //   1329: invokevirtual 252	com/tencent/commonsdk/zip/QZipInputStream:close	()V
    //   1332: aload_0
    //   1333: ifnull +7 -> 1340
    //   1336: aload_0
    //   1337: invokevirtual 198	java/io/BufferedOutputStream:close	()V
    //   1340: iconst_0
    //   1341: ifeq +10 -> 1351
    //   1344: invokestatic 128	com/tencent/commonsdk/pool/ByteArrayPool:getGenericInstance	()Lcom/tencent/commonsdk/pool/ByteArrayPool;
    //   1347: aconst_null
    //   1348: invokevirtual 195	com/tencent/commonsdk/pool/ByteArrayPool:returnBuf	([B)V
    //   1351: invokestatic 74	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   1354: ifeq +33 -> 1387
    //   1357: ldc 76
    //   1359: iconst_2
    ...
    //   1373: invokestatic 94	android/os/SystemClock:uptimeMillis	()J
    //   1376: lload_3
    //   1377: lsub
    //   1378: invokevirtual 333	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   1381: invokevirtual 29	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   1384: invokestatic 82	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   1387: iconst_1
    //   1388: ireturn
    //   1389: aload 11
    //   1391: astore 10
    ...
    //   1407: aload 12
    //   1409: invokevirtual 336	android/content/Context:getPackageName	()Ljava/lang/String;
    ...
    //   1429: astore_0
    //   1430: aload_0
    //   1431: invokevirtual 255	java/io/IOException:printStackTrace	()V
    //   1434: goto -83 -> 1351
    //   1437: astore_0
    //   1438: aconst_null
    //   1439: astore 7
    ...
    //   1449: ifnull +8 -> 1457
    //   1452: aload 6
    //   1454: invokevirtual 252	com/tencent/commonsdk/zip/QZipInputStream:close	()V
    //   1457: aload 7
    //   1459: ifnull +8 -> 1467
    //   1462: aload 7
    //   1464: invokevirtual 198	java/io/BufferedOutputStream:close	()V
    //   1467: aload 5
    //   1469: ifnull +11 -> 1480
    //   1472: invokestatic 128	com/tencent/commonsdk/pool/ByteArrayPool:getGenericInstance	()Lcom/tencent/commonsdk/pool/ByteArrayPool;
    //   1475: aload 5
    //   1477: invokevirtual 195	com/tencent/commonsdk/pool/ByteArrayPool:returnBuf	([B)V
    //   1480: aload_0
    //   1481: athrow
    //   1482: astore 5
    //   1484: aload 5
    //   1486: invokevirtual 255	java/io/IOException:printStackTrace	()V
    //   1489: goto -9 -> 1480
    //   1492: astore_0
    //   1493: aconst_null
    //   1494: astore 7
