  ...
  implements View.OnClickListener, View.OnLongClickListener
{
  ...
  public void onClick(View paramView)
  {
    if (this.jdField_a_of_type_Yku != null) {
      this.jdField_a_of_type_Yku.a(this.jdField_b_of_type_Int, paramView, this.jdField_a_of_type_JavaLangObject, this);
    }
  ...
  {
    if (this.jdField_a_of_type_Yku != null) {
      this.jdField_a_of_type_Yku.b(this.jdField_b_of_type_Int, paramView, this.jdField_a_of_type_JavaLangObject, this);
    }
    return true;
  }
}
