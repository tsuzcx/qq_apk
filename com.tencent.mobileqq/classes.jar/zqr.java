...
public class zqr
{
  ...
  private static zqr jdField_a_of_type_Zqr;
  private SQLiteDatabase jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase;
  private zqs jdField_a_of_type_Zqs;
  
  private zqr(Context paramContext)
  {
    this.jdField_a_of_type_Zqs = zqs.a(paramContext);
    try
    {
      this.jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase = this.jdField_a_of_type_Zqs.getWritableDatabase();
      return;
    }
  ...
  private JSONObject a(HashMap<String, zqo> paramHashMap)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      localJSONObject.put(str, a((zqo)paramHashMap.get(str)));
    }
    return localJSONObject;
  }
  
  private JSONObject a(zqo paramzqo)
  {
    JSONObject localJSONObject1 = new JSONObject();
    JSONObject localJSONObject2 = new JSONObject();
    JSONArray localJSONArray = new JSONArray();
    localJSONObject2.put("dropDuration", (float)paramzqo.b / 1000.0F);
    int i = 0;
    while (i < 6)
    {
      localJSONArray.put(i, paramzqo.jdField_a_of_type_ArrayOfLong[i]);
      i += 1;
    }
    localJSONObject2.put("dropTimes", localJSONArray);
    localJSONObject1.put(String.valueOf(paramzqo.jdField_a_of_type_Int), localJSONObject2);
    return localJSONObject1;
  }
  
  public static zqr a(Context paramContext)
  {
    if (jdField_a_of_type_Zqr == null) {}
    try
    {
      if (jdField_a_of_type_Zqr == null) {
        jdField_a_of_type_Zqr = new zqr(paramContext);
      }
      return jdField_a_of_type_Zqr;
    }
    finally {}
  }
  ...
  private java.util.List<ResultObject> b(boolean paramBoolean)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 39	zqr:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   4: ifnull +13 -> 17
    //   7: aload_0
    //   8: getfield 39	zqr:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   11: invokevirtual 59	android/database/sqlite/SQLiteDatabase:isOpen	()Z
    //   14: ifne +5 -> 19
    //   17: aconst_null
    //   18: areturn
    //   19: bipush 101
    //   21: invokestatic 197	zqg:a	(I)V
    //   24: new 199	java/util/ArrayList
    //   27: dup
    //   28: invokespecial 200	java/util/ArrayList:<init>	()V
    //   31: astore 27
    //   33: new 125	java/util/HashMap
    //   36: dup
    ...
    //   44: if_icmpne +40 -> 84
    //   47: aload_0
    //   48: getfield 39	zqr:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   51: ldc 203
    //   53: aconst_null
    //   54: ldc 205
    //   56: aconst_null
    ...
    //   83: areturn
    //   84: aload_0
    //   85: getfield 39	zqr:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   88: ldc 203
    //   90: aconst_null
    //   91: aconst_null
    //   92: aconst_null
    ...
    //   124: aload 25
    //   126: ldc 220
    //   128: invokeinterface 85 2 0
    //   133: invokeinterface 101 2 0
    //   138: astore 28
    //   140: aload 25
    //   142: aload 25
    //   144: ldc 222
    //   146: invokeinterface 85 2 0
    ...
    //   176: invokeinterface 119 2 0
    //   181: lstore 9
    //   183: aload 25
    //   185: aload 25
    //   187: ldc 230
    //   189: invokeinterface 85 2 0
    //   194: invokeinterface 119 2 0
    //   199: lstore 11
    //   201: aload 25
    //   203: aload 25
    //   205: ldc 232
    //   207: invokeinterface 85 2 0
    //   212: invokeinterface 89 2 0
    //   217: istore_3
    //   218: aload 25
    //   220: aload 25
    //   222: ldc 234
    //   224: invokeinterface 85 2 0
    //   229: invokeinterface 89 2 0
    //   234: istore 4
    //   236: aload 25
    //   238: aload 25
    //   240: ldc 236
    //   242: invokeinterface 85 2 0
    //   247: invokeinterface 89 2 0
    //   252: istore 5
    //   254: aload 25
    //   256: aload 25
    //   258: ldc 238
    //   260: invokeinterface 85 2 0
    //   265: invokeinterface 89 2 0
    //   270: istore 6
    //   272: aload 25
    //   274: aload 25
    //   276: ldc 240
    //   278: invokeinterface 85 2 0
    //   283: invokeinterface 89 2 0
    //   288: istore 7
    //   290: aload 25
    //   292: aload 25
    //   294: ldc 242
    //   296: invokeinterface 85 2 0
    ...
    //   518: lload 23
    //   520: lastore
    //   521: invokespecial 273	zqo:<init>	(JJ[J)V
    //   524: invokevirtual 276	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   527: pop
    //   528: new 95	org/json/JSONObject
    //   531: dup
    //   532: invokespecial 123	org/json/JSONObject:<init>	()V
    //   535: astore 28
    //   537: new 95	org/json/JSONObject
    //   540: dup
    //   541: invokespecial 123	org/json/JSONObject:<init>	()V
    //   544: astore 29
    //   546: aload 29
    //   548: ldc_w 278
    //   551: iconst_1
    //   552: invokestatic 186	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   555: invokevirtual 159	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   558: pop
    //   559: aload 29
    //   561: ldc_w 280
    //   564: iload_2
    //   565: invokestatic 186	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   568: invokevirtual 159	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   571: pop
    //   572: aload 28
    //   574: ldc_w 282
    //   577: aload_0
    //   578: aload 26
    //   580: invokespecial 284	zqr:a	(Ljava/util/HashMap;)Lorg/json/JSONObject;
    //   583: invokevirtual 159	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   586: pop
    //   587: aload 28
    //   589: ldc_w 286
    //   592: aload 29
    //   594: invokevirtual 159	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   597: pop
    //   598: aload 28
    //   600: ldc_w 288
    //   603: bipush 101
    ...
    //   608: pop
    //   609: aload 27
    //   611: new 76	com/tencent/mfsdk/collector/ResultObject
    //   614: dup
    //   615: iconst_0
    //   616: ldc_w 293
    //   619: iconst_1
    ...
    //   677: aconst_null
    //   678: aconst_null
    //   679: invokespecial 316	zqr:a	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    //   682: pop
    //   683: aload 25
    //   685: ifnull +10 -> 695
    //   688: aload 25
    ...
    //   701: aconst_null
    //   702: aconst_null
    //   703: invokespecial 316	zqr:a	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    //   706: pop
    //   707: aload 25
    //   709: ifnull -14 -> 695
    //   712: aload 25
  ...
  public long a(long paramLong, String paramString, zqo paramzqo)
  {
    if ((this.jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase == null) || (!this.jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase.isOpen())) {
      return -2L;
    }
    ...
    localContentValues.put("state", Integer.valueOf(paramzqo.jdField_a_of_type_Int));
    localContentValues.put("drop_duration", Long.valueOf(paramzqo.b));
    localContentValues.put("drop_count", Long.valueOf(paramzqo.jdField_a_of_type_Long));
    localContentValues.put("range_0", Long.valueOf(paramzqo.jdField_a_of_type_ArrayOfLong[0]));
    localContentValues.put("range_1", Long.valueOf(paramzqo.jdField_a_of_type_ArrayOfLong[1]));
    localContentValues.put("range_2_4", Long.valueOf(paramzqo.jdField_a_of_type_ArrayOfLong[2]));
    localContentValues.put("range_4_8", Long.valueOf(paramzqo.jdField_a_of_type_ArrayOfLong[3]));
    localContentValues.put("range_8_15", Long.valueOf(paramzqo.jdField_a_of_type_ArrayOfLong[4]));
    localContentValues.put("range_over_15", Long.valueOf(paramzqo.jdField_a_of_type_ArrayOfLong[5]));
    localContentValues.put("status", Integer.valueOf(1));
    if (QLog.isColorLevel()) {
      QLog.d("Magnifier_DBHandler", 2, new Object[] { "insertDropFrame", ",scene = ", paramString, ",duration=", Long.valueOf(paramzqo.b), ",range_0=", Long.valueOf(paramzqo.jdField_a_of_type_ArrayOfLong[0]), ",range_1_2=", Long.valueOf(paramzqo.jdField_a_of_type_ArrayOfLong[1]), ",range_2_4=", Long.valueOf(paramzqo.jdField_a_of_type_ArrayOfLong[2]), ",range_4_8=", Long.valueOf(paramzqo.jdField_a_of_type_ArrayOfLong[3]), ",range_8_15=", Long.valueOf(paramzqo.jdField_a_of_type_ArrayOfLong[4]), ",range_bigegr=", Long.valueOf(paramzqo.jdField_a_of_type_ArrayOfLong[5]) });
    }
    try
    {
  ...
  public long a(SparseArray<zpz> paramSparseArray)
  {
    if ((this.jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase == null) || (!this.jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase.isOpen())) {
      return -2L;
    }
    ...
    for (;;)
    {
      if (i < j)
      {
        ...
        zpz localzpz = (zpz)paramSparseArray.get(k);
        localContentValues.put("plugin", Integer.valueOf(k));
        localContentValues.put("user_sample_ratio", Float.valueOf(localzpz.jdField_a_of_type_Float));
        localContentValues.put("threshold", Integer.valueOf(localzpz.jdField_a_of_type_Int));
        localContentValues.put("max_report_num", Integer.valueOf(localzpz.jdField_b_of_type_Int));
        localContentValues.put("event_sample_ratio", Float.valueOf(localzpz.jdField_b_of_type_Float));
        localContentValues.put("stack_depth", Integer.valueOf(localzpz.c));
        try
        {
  ...
  /* Error */
  public SparseArray<zpz> a()
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_3
    //   2: aload_0
    //   3: getfield 39	zqr:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   6: ifnull +13 -> 19
    //   9: aload_0
    //   10: getfield 39	zqr:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    ...
    //   24: areturn
    //   25: aload_0
    //   26: getfield 39	zqr:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   29: ldc_w 382
    //   32: aconst_null
    //   33: aconst_null
    //   34: aconst_null
    ...
    //   199: invokeinterface 89 2 0
    //   204: invokespecial 469	zpz:<init>	(FIIFI)V
    ...
    //   20	3	4	localSparseArray	SparseArray<zpz>
  ...
  public java.util.List<ResultObject> a(boolean paramBoolean)
  {
    ...
    //   14: astore 7
    //   16: aload_0
    //   17: getfield 39	zqr:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   20: ifnull +13 -> 33
    //   23: aload_0
    //   24: getfield 39	zqr:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    ...
    //   38: if_icmpne +64 -> 102
    //   41: aload_0
    //   42: getfield 39	zqr:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   45: ldc_w 320
    //   48: aconst_null
    //   49: ldc_w 475
    //   52: iconst_2
    //   53: anewarray 146	java/lang/String
    //   56: dup
    //   57: iconst_0
    //   58: iconst_1
    //   59: invokestatic 186	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   62: aastore
    //   63: dup
    //   64: iconst_1
    //   65: lload_2
    ...
    //   101: areturn
    //   102: aload_0
    //   103: getfield 39	zqr:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   106: ldc_w 320
    //   109: aconst_null
    //   110: aconst_null
    //   111: aconst_null
    ...
    //   153: aload_0
    //   154: aload 4
    //   156: invokespecial 477	zqr:a	(Landroid/database/Cursor;)Lcom/tencent/mfsdk/collector/ResultObject;
    //   159: astore 6
    //   161: aload 6
    //   163: ifnull +17 -> 180
    //   166: aload 4
    ...
    //   235: aload_0
    //   236: iload_1
    //   237: invokespecial 479	zqr:b	(Z)Ljava/util/List;
    //   240: astore 4
    //   242: aload 4
    //   244: ifnull +23 -> 267
    //   247: aload 4
