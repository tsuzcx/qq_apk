  ...
  extends zxu<E>
{
  ...
  public zyv(Bundle paramBundle)
  {
    super(paramBundle);
  }
  
  private VSBaseRequest getRequestWithLoadInfo(zxz paramzxz)
  {
    if (paramzxz.c())
    {
      paramzxz = getRequest(null);
      if (paramzxz != null)
      {
  ...
  public abstract List<zxj> getCustomParts();
  ...
  public abstract void getListDataAsync(zza<E> paramzza, String paramString);
  ...
  public void loadData(zxz paramzxz)
  {
    ...
    Object localObject2 = getRequestWithLoadInfo(paramzxz);
    if ((localObject2 != null) && (getParentFragment() != null))
    {
      boolean bool1 = paramzxz.e();
      boolean bool2 = ((VSBaseRequest)localObject2).isEnableCache();
      paramzxz = ((VSBaseRequest)localObject2).getCmdName();
      VSNetworkHelper.a().a(getParentFragment().hashCode(), (VSBaseRequest)localObject2, new zyw(this, paramzxz, (VSBaseRequest)localObject2, bool1, bool2));
    }
    do
    {
      return;
      ...
      {
        getListDataAsync(new zyx(this), null);
        return;
      }
    } while (!paramzxz.e());
    localObject2 = new zyy(this);
    paramzxz = localObject1;
    if (getDataList() != null)
    {
      paramzxz = localObject1;
      if (getDataList().size() > 0) {
        paramzxz = getAttachInfoFromItemData(getDataList().get(getDataList().size() - 1));
      }
    }
    if (paramzxz != null)
    {
      getListDataAsync((zza)localObject2, paramzxz);
      return;
    }
    handleLoadMoreData();
  }
  ...
  {
    if ((getHostFragment() != null) && (getHostFragment().a() != null)) {
      getHostFragment().a().a().c(getEmptyHint());
    }
  }
  ...
  protected void showErrorView(String paramString, long paramLong)
  {
    ...
    getHostFragment().a().a().c(paramString);
  }
}
