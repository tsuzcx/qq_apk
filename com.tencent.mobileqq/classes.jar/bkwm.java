  ...
  extends AdProxy.AbsRewardVideoAdView
{
  ...
  public void showAD(Context paramContext, String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMotiveVideoPageData.antiSpamParams = bkxw.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherCoreIMiniAppContext, this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMotiveVideoPageData.adId + "", System.currentTimeMillis(), bool);
        ...
        return;
        paramString = new bkwa(this, null);
        localObject = bkwa.a(paramString);
        QLog.i("AdProxyImpl", 1, "mvBrowing dataKey = " + (String)localObject + ", data =" + bkwa.a(paramString));
