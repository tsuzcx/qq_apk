  ...
  implements Cloneable
{
  ...
  public bkwm(long paramLong)
  {
    this.a = paramLong;
  }
  
  public bkwm(byte[] paramArrayOfByte)
  {
    this(paramArrayOfByte, 0);
  }
  
  public bkwm(byte[] paramArrayOfByte, int paramInt)
  {
  ...
  {
    if ((paramObject == null) || (!(paramObject instanceof bkwm))) {}
    while (this.a != ((bkwm)paramObject).a()) {
      return false;
    }
    return true;
  }
