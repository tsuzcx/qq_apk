...
public class atuf
{
  ...
  public static int a(QQAppInterface paramQQAppInterface, atpq paramatpq)
  {
    if (paramatpq == null) {}
    do
    {
      ...
      {
        return 0;
        paramQQAppInterface = atpw.a(paramQQAppInterface).a(paramatpq);
  ...
  public static void a()
  {
    ...
    {
      jdField_a_of_type_Int = bdne.H(localBaseApplicationImpl);
      c = bdne.e(localBaseApplicationImpl);
      if (QLog.isColorLevel()) {
    ...
    bdne.a(localBaseApplicationImpl, false, 0);
  }
  ...
  public static void b()
  {
    ...
    boolean bool = atpw.a((QQAppInterface)localAppRuntime).a.a();
  ...
  public static void c()
  {
    if ((jdField_a_of_type_Boolean) && (jdField_a_of_type_Int != 0))
    {
      ...
      if ((localObject instanceof QQAppInterface))
      {
        ...
        azri.a(BaseApplication.getContext()).a(localQQAppInterface.getCurrentAccountUin(), "actLocationBgReportSampling", true, jdField_a_of_type_Int, 0L, localHashMap, "");
        if (QLog.isColorLevel()) {
  ...
  public static void e()
  {
    ...
    azqs.b(null, "CliOper", "", "", "0X800A976", "0X800A976", 0, 0, String.valueOf(l), "0", "0", "");
  }
