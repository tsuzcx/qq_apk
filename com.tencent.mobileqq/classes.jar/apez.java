  ...
  extends apey
{
  ...
  public apez(QQAppInterface paramQQAppInterface, asue paramasue, HashMap<String, ArrayList<MessageRecord>> paramHashMap, astr paramastr)
  {
    ...
    if ((this.jdField_a_of_type_JavaUtilHashMap != null) && (!this.jdField_a_of_type_JavaUtilHashMap.isEmpty()))
    {
      ...
      do
      {
        ...
        paramasue = (String)paramQQAppInterface.next();
        paramHashMap = ((ArrayList)this.jdField_a_of_type_JavaUtilHashMap.get(paramasue)).iterator();
        while (paramHashMap.hasNext())
        {
          paramastr = (MessageRecord)paramHashMap.next();
          if ((paramastr instanceof MessageForReplyText))
          {
            this.jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText = ((MessageForReplyText)paramastr);
            this.jdField_a_of_type_JavaLangString = paramasue;
          }
        }
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText != null) && (this.jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText.getSourceMessage() != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)))
      {
        ...
        if ((localObject1 instanceof MessageForFile))
        {
          ...
          if ((localObject2 != null) && (((FileManagerEntity)localObject2).getCloudType() == 0))
          {
            ...
            localObject2 = ajyc.a(2131713399) + ((MessageRecord)localObject1).getExtInfoFromExtStr("_m_ForwardFileName");
        ...
        if (apue.a((MessageRecord)localObject1))
        {
          int i = a();
          if ((i != 0) && (i != 3000) && (i != 1))
          {
            QLog.i("ReplyMsgForwardRequest<QFile>", 1, "getForwardMessageList. init UploadSourceMsgList, find unsupport chatType file.");
            localObject2 = ajyc.a(2131713396) + ((MessageRecord)localObject1).getExtInfoFromExtStr("_m_ForwardFileName");
  ...
  public void a(int paramInt, List<MessageRecord> paramList1, List<MessageRecord> paramList2)
  {
    ...
    if (paramInt == 1)
    {
      ...
      paramList2 = ajyc.a(2131713398) + paramList1.getExtInfoFromExtStr("_m_ForwardFileName");
  ...
  public void a(String paramString, List<MessageRecord> paramList, MessageRecord paramMessageRecord, int paramInt)
  {
    ...
    paramList = ajyc.a(2131713397) + paramMessageRecord.getExtInfoFromExtStr("_m_ForwardFileName");
