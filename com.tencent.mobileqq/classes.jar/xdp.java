...
public class xdp
  extends wpa
{
  public static final String a = wnu.a("StorySvc.feed_visitor_list");
  public String b;
  ...
  public wov a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return new xfa(this.b, localRspGetFeedVisitor);
    }
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      yuk.d("Q.qqstory:GetVideoWatcherListRequest", "" + paramArrayOfByte);
    }
    return null;
  }
