...
public class atcl
{
  public static void a(Context paramContext, String paramString, List<Object> paramList)
  {
    ...
    bace.a(paramString + "v5.8.nbr", new Object[] { paramList });
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (a(paramQQAppInterface))
    {
      ...
      if (i <= Math.abs(l3 - l1) / 1000L)
      {
        ...
        localObject = paramQQAppInterface.b(ajed.H, 1001).iterator();
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong)
  {
    ...
    MessageForNearbyRecommenderTips localMessageForNearbyRecommenderTips = (MessageForNearbyRecommenderTips)awbi.a(-4011);
    long l = awao.a();
    localMessageForNearbyRecommenderTips.init(paramQQAppInterface.getCurrentAccountUin(), ajed.ar, ajed.ar, "", l, -4011, 1001, l);
    localMessageForNearbyRecommenderTips.isread = true;
    akbm.a(localMessageForNearbyRecommenderTips, false);
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("NearbyRecommenderUtils", 2, "-----addGrayTipsMessage  frienduin:" + paramString1 + " istroop：" + paramInt + " msg:" + azzz.a(paramString3));
    }
    long l = awao.a();
    MessageForGrayTips localMessageForGrayTips = (MessageForGrayTips)awbi.a(-5007);
    ...
    if ((!paramBoolean1) || (!ajml.a(paramQQAppInterface, localMessageForGrayTips, false))) {
  ...
  {
    paramQQAppInterface = paramQQAppInterface.a().b(ajed.H, 1001);
