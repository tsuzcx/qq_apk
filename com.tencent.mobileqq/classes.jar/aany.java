...
{
  private static aany jdField_a_of_type_Aany = new aany();
  ...
  public static aany a()
  {
    try
    {
      aany localaany = jdField_a_of_type_Aany;
      return localaany;
    }
    finally
    {
  ...
  {
    aanp.a("GdtImpressionPolicy", "report view: " + paramView.hashCode());
    GdtAd localGdtAd = a(paramView);
    if (localGdtAd == null)
    {
      aanp.a("GdtImpressionPolicy", "break: statistics == null");
      return;
    }
    if (localGdtAd.reportState == 2)
    {
      aanp.a("GdtImpressionPolicy", "break: already report " + localGdtAd.getTraceId());
      return;
    }
    if (!a(paramView))
    {
      aanp.a("GdtImpressionPolicy", "break: isVisibleAreaSatisfied not");
      return;
    }
    ...
    if (!b(paramView))
    {
      aanp.a("GdtImpressionPolicy", "inCountingMap not " + localGdtAd.getTraceId());
  ...
  {
    aanp.a("GdtImpressionPolicy", "handleMessage : ");
    ...
    for (;;)
    {
      ...
      if (paramMessage.get() != null)
      {
        ...
        {
          aanp.a("GdtImpressionPolicy", "break: statistics.reportState != 1 " + localGdtAd.getTraceId());
        }
        else if (!a(paramMessage))
        {
          aanp.a("GdtImpressionPolicy", "break: isVisibleAreaSatisfied not " + localGdtAd.getTraceId());
          localGdtAd.reportState = -1;
        }
        else if (!b(paramMessage))
        {
          aanp.a("GdtImpressionPolicy", "break: inCountingMap not " + localGdtAd.getTraceId());
        }
        else
        {
          localObject = paramMessage.getTag(2131379910);
          if (localObject == null)
          {
            aanp.a("GdtImpressionPolicy", "break: o2 == null " + localGdtAd.getTraceId());
          }
          else if (!(localObject instanceof aanz))
          {
            aanp.a("GdtImpressionPolicy", "break: o2 instanceof ReportListener not " + localGdtAd.getTraceId());
          }
          else
          {
            ...
            aanp.a("GdtImpressionPolicy", "break: already reported " + localGdtAd.getTraceId());
          }
        }
      }
    }
    ((aanz)localObject).reportImpression(paramMessage);
    localGdtAd.reportState = 2;
    a(localGdtAd.getTraceId(), true);
    aanp.a("GdtImpressionPolicy", "report " + localGdtAd.getTraceId());
