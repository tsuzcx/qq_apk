...
public class wzq
  extends wlf<xbd>
{
  private static final String jdField_a_of_type_JavaLangString = wjz.a("StorySvc.get_label_list");
  ...
  public wzq(int paramInt1, long paramLong, String paramString, int paramInt2)
  {
    this.c = paramInt1;
  ...
  public wzq(String paramString, int paramInt)
  {
    this.jdField_b_of_type_JavaLangString = paramString;
    this.d = paramInt;
  ...
  public wla a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return new xbd(localRspGetTagList);
    }
