...
public class ayjr
{
  ...
  public View a(String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    localLinearLayout.addView((View)localObject, DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 18.0F), DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 15.0F));
    ((LinearLayout.LayoutParams)((View)localObject).getLayoutParams()).leftMargin = DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 4.0F);
    ...
    paramString1.rightMargin = DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 6.0F);
    paramString1.leftMargin = DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 2.0F);
    localLinearLayout.setBackgroundResource(2130845532);
    ...
    localLinearLayout.setOnClickListener(new ayjs(this));
  ...
  public void a(QQAppInterface paramQQAppInterface, View paramView, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131379100);
    this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardLabelContainer = ((LabelContainer)paramView.findViewById(2131369939));
    this.b = paramView.findViewById(2131370139);
  ...
  public void a(cmd0xac5.NearbyNowData paramNearbyNowData)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardLabelContainer.setSpace(DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 6.0F), DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 8.0F));
    ...
    for (paramNearbyNowData = paramNearbyNowData.label_info.get();; paramNearbyNowData = null)
    {
      if ((paramNearbyNowData != null) && (paramNearbyNowData.size() > 0))
      {
        ...
        while (i < paramNearbyNowData.size())
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardLabelContainer.addView((View)localObject, -2, DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 24.0F));
          i += 1;
        }
