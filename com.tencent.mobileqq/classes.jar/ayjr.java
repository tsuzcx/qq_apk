...
class ayjr
  extends QIPCModule
{
  ayjr(ayjq paramayjq, String paramString)
  {
    super(paramString);
  }
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          if (ayjp.a.equals(paramString)) {
            return ayjq.a(this.a, paramBundle, paramInt);
          }
          if (ayjp.b.equals(paramString))
          {
            paramString = ayjq.a(this.a, paramBundle, paramInt);
            if (paramString.isSuccess())
            {
              ...
              if (ayjq.a(this.a).a().a((PrecoverResource)localObject, new Object[] { "PrecoverIPCServer_MODEL", Integer.valueOf(paramInt) })) {
              ...
              ayjq.a(this.a).callbackResult(paramInt, EIPCResult.createResult(-2, paramBundle));
            }
            return paramString;
          }
        } while (!ayjp.c.equals(paramString));
      ...
      paramString = ayjq.a(this.a).a().a((String)localObject);
