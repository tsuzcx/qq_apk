  ...
  implements ykp
{
  ...
  public ykf(@NonNull Context paramContext)
  {
  ...
  private void b()
  {
    this.jdField_a_of_type_Ykn = new ykn();
    this.jdField_a_of_type_Yko = new yko(this, this.jdField_a_of_type_Ykn);
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_AndroidViewView = getLayoutInflater().inflate(2131493531, (ViewGroup)localObject, false);
    setContentView(this.jdField_a_of_type_AndroidViewView);
    setOnDismissListener(new ykg(this));
    this.jdField_a_of_type_AndroidWidgetGridLayout = ((GridLayout)((FrameLayout)localObject).findViewById(2131301492));
    a();
    localObject = findViewById(2131312973);
    ((View)localObject).setOnClickListener(new ykh(this));
    ((View)localObject).setContentDescription(ajjy.a(2131625271));
  ...
  {
    Object localObject1 = this.jdField_a_of_type_Ykd.a().getAds();
    ...
    ImageView localImageView = (ImageView)paramLinearLayout.findViewById(2131302061);
    Object localObject2 = ((GdtAd)localObject1).info.display_info.basic_info.img.get();
    yny.a("GdtAdBoxDialog", "bindView() i = [" + paramInt7 + "], j = [" + paramInt8 + "], url = [" + (String)localObject2 + "]");
    try
    {
      localImageView.setImageDrawable(MiniAppUtils.getIcon(localImageView.getContext(), (String)localObject2, true, 2130847244, 65));
      localObject2 = (TextView)paramLinearLayout.findViewById(2131304981);
      ...
      localImageView.setOnClickListener(new yki(this));
      localImageView.setTag(2131301336, localObject1);
      localImageView.setTag(2131313371, localObject1);
      localImageView.setTag(2131313370, new ykj(this));
      localImageView.getViewTreeObserver().addOnGlobalLayoutListener(new ykk(this, localImageView));
      return;
    }
    catch (Exception localException)
    {
      for (;;)
      {
        yny.d("GdtAdBoxDialog", "bad url params", localException);
      }
    }
  }
  
  public void a(ykd paramykd)
  {
  ...
  protected void a(ykn paramykn)
  {
    ...
    int i = this.jdField_a_of_type_Ykd.a().getAds().size();
    if (i == 0)
    {
    ...
    for (;;)
    {
      ...
      int n = ypk.a(23.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
      int i1 = ypk.a(21.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
      int i2 = ypk.a(5.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
      int i3 = ypk.a(0.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
      int i4 = ypk.a(65.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
      int i5 = i4 + ypk.a(24.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
      int i6 = ypk.a(22.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
      ...
      if (j < m)
      {
        ...
        for (;;)
        {
          ...
          LinearLayout localLinearLayout = (LinearLayout)paramykn.inflate(2131493528, null);
  ...
  {
    if (this.jdField_a_of_type_Yko.a()) {
      return;
    }
    super.onBackPressed();
  }
  ...
  {
    super.onStop();
    this.jdField_a_of_type_Yko.c();
  }
  
  public void onWindowFocusChanged(boolean paramBoolean)
  {
    super.onWindowFocusChanged(paramBoolean);
    yny.a("GdtAdBoxDialog", "onWindowFocusChanged() called with: hasFocus = [" + paramBoolean + "]");
  }
}
