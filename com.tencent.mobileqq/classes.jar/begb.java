...
public class begb
  ...
  implements Handler.Callback, bear
{
  public static int d;
  public static int e;
  public int a;
  ...
  public begb(Activity paramActivity, View paramView, QQAppInterface paramQQAppInterface, long paramLong)
  {
    super(paramActivity, 2131755340);
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_JavaLangObject = new Object();
    this.jdField_a_of_type_JavaLangString = "";
    this.jdField_a_of_type_Befm = new begk(this);
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Beeu = ((beeu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.GROUP_TEAM_WORK_HANDLER));
    ...
    this.jdField_a_of_type_AndroidViewView = findViewById(2131364662);
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Befm);
    a(paramView);
  }
  
  private void e()
  {
    this.jdField_a_of_type_AndroidWidgetImageButton.setOnClickListener(new begi(this));
    Button localButton = (Button)findViewById(2131363845);
    localButton.setVisibility(0);
    localButton.setOnClickListener(new begj(this));
  }
  ...
  protected String a(int paramInt)
  {
    ...
    return this.jdField_a_of_type_AndroidAppActivity.getString(2131697087, new Object[] { Integer.valueOf(paramInt) });
  }
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.setHint(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131718372));
    this.jdField_a_of_type_AndroidWidgetEditText.setImeOptions(3);
    this.jdField_a_of_type_AndroidWidgetEditText.setOnEditorActionListener(new begg(this));
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new begh(this));
  ...
  public final void a(long paramLong, String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Beeu != null) {
        this.jdField_a_of_type_Beeu.a(paramLong, paramString, paramInt1, paramInt2, paramInt3);
      }
    }
  }
  ...
  protected void a(Activity paramActivity)
  {
    ...
    for (;;)
    {
      ...
      findViewById(2131370488).setOnClickListener(new begc(this));
      ...
      if (ImmersiveUtils.isSupporImmersive() == 1)
      {
        ...
        int i = paramActivity.getResources().getColor(2131167084);
        if (ImmersiveUtils.a(getWindow(), true)) {
          i = paramActivity.getResources().getColor(2131167254);
        }
        new SystemBarCompact(this, true, i).init();
        localObject = (LinearLayout)findViewById(2131370488);
  ...
  protected void a(Activity paramActivity, QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqTeamworkforgroupGroupTeamWordkMoreView.setBackgroundResource(2130838911);
    this.jdField_a_of_type_ComTencentMobileqqTeamworkforgroupGroupTeamWordkMoreView.setTextColor(paramActivity.getResources().getColor(2131167026));
    ...
    this.jdField_a_of_type_Bees = new bees(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, this, this.jdField_a_of_type_AndroidOsHandler);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Bees);
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnScrollListener(new begd(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnTouchListener(new bege(this));
    this.jdField_a_of_type_Bees.a(new begf(this));
  }
  ...
  public void a(String paramString)
  {
    ...
    //   13: return
    //   14: aload_0
    //   15: getfield 134	begb:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   18: iconst_1
    //   19: invokevirtual 541	android/os/Handler:sendEmptyMessage	(I)Z
    //   22: pop
    //   23: aload_0
    //   24: aload_0
    //   25: getfield 89	begb:jdField_a_of_type_Long	J
    //   28: aload_1
    //   29: iconst_0
    //   30: bipush 50
    //   32: iconst_0
    //   33: invokevirtual 542	begb:a	(JLjava/lang/String;III)V
    //   36: goto -25 -> 11
    //   39: astore_1
    //   40: aload_0
    //   41: monitorexit
  ...
  protected void c(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      this.jdField_a_of_type_ComTencentMobileqqTeamworkforgroupGroupTeamWordkMoreView.setText(2131719000);
      this.jdField_a_of_type_ComTencentMobileqqTeamworkforgroupGroupTeamWordkMoreView.a();
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqTeamworkforgroupGroupTeamWordkMoreView.setText(2131694653);
    this.jdField_a_of_type_ComTencentMobileqqTeamworkforgroupGroupTeamWordkMoreView.setTextLeftDrawable(2130839466);
  }
  ...
  public void dismiss()
  {
    ...
    {
      this.jdField_a_of_type_Bees.a();
      this.jdField_a_of_type_Bees = null;
    }
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Befm);
    try
    {
      super.dismiss();
      return;
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Bees.a(this.jdField_a_of_type_JavaUtilList);
      this.jdField_a_of_type_Bees.notifyDataSetChanged();
      if (this.jdField_b_of_type_Boolean) {
