  ...
  implements biee
{
  ...
  public biec(@NonNull bigb parambigb, int paramInt)
  {
    super(parambigb);
    ...
    {
      sob.a().a("EditVideoDTextFace.mSrcFrom", this.jdField_a_of_type_JavaLangString);
      return;
    }
  }
  ...
  private void j()
  {
    ...
    bbmy.a(a(), a().getString(2131632580), 0).a();
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_JavaUtilList = bhlz.a(0);
    if (TextUtils.isEmpty(this.b)) {
      this.b = ajjy.a(2131638037);
    }
    bhlz.a(0, Collections.singletonList(this.b));
    this.jdField_a_of_type_Bigb.a().a().postDelayed(new EditVideoDTextFace.1(this, localDynamicTextConfigManager), 1000L);
  }
      ...
      do
      {
        do
        {
          do
          {
            ...
            paramObject = (bibg)a(bibg.class);
          } while (paramObject == null);
          paramObject = paramObject.a();
        } while (paramObject == null);
        localbijo = paramObject.a();
      } while (localbijo == null);
      paramInt1 = 0;
      if (localbijo.a != null) {
  ...
  public void a(int paramInt, @NonNull bitz parambitz)
  {
    ...
    parambitz = ((bibg)a(bibg.class)).a().a();
    int i = parambitz.a.size();
    StringBuilder localStringBuilder = new StringBuilder();
    paramInt = 0;
    while (paramInt < i)
    {
      localStringBuilder.append(((bijr)parambitz.a.get(paramInt)).a.c() + 1);
      if (paramInt < i - 1) {
        localStringBuilder.append(",");
      }
      paramInt += 1;
    }
    urp.a("video_edit_text", "pub_withText", 0, 0, new String[] { this.jdField_a_of_type_JavaLangString, localStringBuilder.toString(), String.valueOf(i), "" });
  }
  ...
  public void g()
  {
    ...
    {
      InputMethodManager localInputMethodManager = (InputMethodManager)this.jdField_a_of_type_Bihj.getActivity().getSystemService("input_method");
      if ((localInputMethodManager != null) && (localInputMethodManager.isActive())) {
        localInputMethodManager.hideSoftInputFromWindow(this.jdField_a_of_type_Bihj.a().getWindowToken(), 0);
      }
    }
    super.g();
    bhlz.a(0, this.jdField_a_of_type_JavaUtilList);
  }
  ...
  public void i()
  {
    if ((this.jdField_a_of_type_AndroidViewView != null) && (this.jdField_a_of_type_AndroidViewView.getVisibility() == 8))
    {
      ...
      urp.a("video_edit_text", "exp_textWording", 0, 0, new String[] { this.jdField_a_of_type_JavaLangString, "", "", "" });
