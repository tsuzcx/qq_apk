...
public class aziw
{
  ...
  private aziz jdField_a_of_type_Aziz = new aziz(this, null);
  private boolean jdField_a_of_type_Boolean;
  public final int b;
  private PointF jdField_b_of_type_AndroidGraphicsPointF = new PointF();
  private aziz jdField_b_of_type_Aziz = new aziz(this, null);
  ...
  private aziz a(int paramInt)
  {
    aziz localaziz = null;
    VideoEnvironment.a("GameplayEngine.GameEvent", String.format("id=%d,pointerId0=%d,pointerId1=%d", new Object[] { Integer.valueOf(paramInt), Integer.valueOf(this.jdField_a_of_type_Aziz.jdField_a_of_type_Int), Integer.valueOf(this.jdField_b_of_type_Aziz.jdField_a_of_type_Int) }), null);
    VideoEnvironment.a("GameplayEngine.GameEvent", String.format("id=%d,pressed0=%b,pressed1=%b", new Object[] { Integer.valueOf(paramInt), Boolean.valueOf(this.jdField_a_of_type_Aziz.jdField_a_of_type_Boolean), Boolean.valueOf(this.jdField_b_of_type_Aziz.jdField_a_of_type_Boolean) }), null);
    if (paramInt == this.jdField_a_of_type_Aziz.jdField_a_of_type_Int) {
      localaziz = this.jdField_a_of_type_Aziz;
    }
    do
    {
      return localaziz;
      if (paramInt == this.jdField_b_of_type_Aziz.jdField_a_of_type_Int) {
        return this.jdField_b_of_type_Aziz;
      }
      if (this.jdField_a_of_type_Aziz.jdField_a_of_type_Boolean) {
        return this.jdField_a_of_type_Aziz;
      }
    } while (!this.jdField_b_of_type_Aziz.jdField_a_of_type_Boolean);
    return this.jdField_b_of_type_Aziz;
  }
  ...
  private void a()
  {
    this.x = ((int)Math.sqrt(Math.pow(this.jdField_a_of_type_Aziz.jdField_a_of_type_Float - this.jdField_b_of_type_Aziz.jdField_a_of_type_Float, 2.0D) + Math.pow(this.jdField_a_of_type_Aziz.b - this.jdField_b_of_type_Aziz.b, 2.0D)) + 5);
  }
  ...
  private void a(long paramLong, int paramInt, float paramFloat1, float paramFloat2, float paramFloat3)
  {
    ...
    if (this.jdField_a_of_type_Aziy != null) {
      this.jdField_a_of_type_Aziy.a(paramLong, paramInt, paramFloat1, paramFloat2, paramFloat3);
    }
  }
  ...
  private void a(long paramLong, int paramInt1, float paramFloat1, float paramFloat2, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Aziy != null) {
      this.jdField_a_of_type_Aziy.a(paramLong, paramInt1, paramFloat1, paramFloat2, paramInt2);
    }
  }
  ...
  {
    aziz localaziz = a(paramInt);
    if (localaziz == null) {}
    do
    {
      return false;
      float f2 = localaziz.jdField_a_of_type_Float;
      float f1 = localaziz.b;
  ...
  {
    if (this.jdField_a_of_type_Aziy != null) {
      return this.jdField_a_of_type_Aziy.a(paramLong, paramInt);
    }
    return false;
  }
  ...
  private void b()
  {
    this.jdField_a_of_type_Aziz.jdField_a_of_type_Boolean = false;
    this.jdField_b_of_type_Aziz.jdField_a_of_type_Boolean = false;
  ...
  void a(long paramLong1, int paramInt1, float paramFloat1, float paramFloat2, int paramInt2, long paramLong2)
  {
    ...
    if (paramInt2 == 0)
    {
      ...
      if (bool)
      {
        this.jdField_a_of_type_Aziz.jdField_a_of_type_Boolean = true;
        this.jdField_a_of_type_Aziz.jdField_a_of_type_Long = paramLong2;
        this.jdField_a_of_type_Aziz.jdField_a_of_type_Int = paramInt1;
        this.jdField_a_of_type_Aziz.jdField_a_of_type_Float = paramFloat1;
        this.jdField_a_of_type_Aziz.b = paramFloat2;
    ...
    do
    {
      ...
      if (bool)
      {
        this.jdField_b_of_type_Aziz.jdField_a_of_type_Boolean = true;
        this.jdField_b_of_type_Aziz.jdField_a_of_type_Long = paramLong2;
        this.jdField_b_of_type_Aziz.jdField_a_of_type_Int = paramInt1;
        this.jdField_b_of_type_Aziz.jdField_a_of_type_Float = paramFloat1;
        this.jdField_b_of_type_Aziz.b = paramFloat2;
        ...
        a();
        this.jdField_e_of_type_AndroidGraphicsPointF.set((this.jdField_a_of_type_Aziz.jdField_a_of_type_Float + this.jdField_b_of_type_Aziz.jdField_a_of_type_Float) / 2.0F, (this.jdField_a_of_type_Aziz.b + this.jdField_b_of_type_Aziz.b) / 2.0F);
      }
  ...
  void a(long paramLong1, int[] paramArrayOfInt, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, long paramLong2)
  {
    ...
    if (i2 < i4)
    {
      ...
      if ((!this.jdField_b_of_type_Aziz.jdField_a_of_type_Boolean) || ((i5 != this.jdField_a_of_type_Aziz.jdField_a_of_type_Int) && (i5 != this.jdField_b_of_type_Aziz.jdField_a_of_type_Int))) {
        break label1070;
      }
      if (this.jdField_a_of_type_Aziz.jdField_a_of_type_Int == this.jdField_b_of_type_Aziz.jdField_a_of_type_Int) {
        c();
      }
    }
    else
    ...
    if (a(paramLong1, 2))
    {
      if (this.jdField_a_of_type_Aziz.jdField_a_of_type_Int != i5) {
        break label776;
      }
      ...
      this.v = ((int)Math.sqrt(Math.pow(f2 - this.jdField_a_of_type_Aziz.jdField_a_of_type_Float, 2.0D) + Math.pow(f3 - this.jdField_a_of_type_Aziz.b, 2.0D)));
      ...
      if (this.jdField_b_of_type_Boolean)
      {
        ...
        if (i5 != this.jdField_a_of_type_Aziz.jdField_a_of_type_Int) {
          break label844;
        }
        f1 = i1 / i6;
        label559:
    ...
    for (;;)
    {
      ...
      this.w = ((int)Math.sqrt(Math.pow(f2 - this.jdField_b_of_type_Aziz.jdField_a_of_type_Float, 2.0D) + Math.pow(f3 - this.jdField_b_of_type_Aziz.b, 2.0D)));
      break label197;
      label844:
      f1 = i7 / i8;
      break label559;
      ...
      if (this.jdField_e_of_type_Boolean)
      {
        ...
        if (a())
        {
          ...
          if (i5 == this.jdField_a_of_type_Aziz.jdField_a_of_type_Int)
          {
            ...
            if (a(paramLong1, 5))
            {
              i6 = (int)Math.sqrt(Math.pow(f2 - this.jdField_a_of_type_Aziz.jdField_a_of_type_Float, 2.0D) + Math.pow(f3 - this.jdField_a_of_type_Aziz.b, 2.0D));
              ...
              {
                i1 = i3;
                if (paramLong2 - this.jdField_a_of_type_Aziz.jdField_a_of_type_Long >= 200L)
                {
                  i1 = i3;
                  if (i6 >= 30)
                  {
  ...
  void b(long paramLong1, int paramInt1, float paramFloat1, float paramFloat2, int paramInt2, long paramLong2)
  {
    ...
    do
    {
      do
      {
        ...
        float f1;
        float f2;
        if (localaziz.jdField_a_of_type_Boolean)
        {
          f1 = paramFloat1 - localaziz.jdField_a_of_type_Float;
          f2 = paramFloat2 - localaziz.b;
          if (!this.jdField_b_of_type_Boolean) {
            break label114;
          }
          c();
        ...
        for (;;)
        {
          localaziz.jdField_a_of_type_Boolean = false;
          ...
          {
            if ((a(paramLong1, 1)) && (paramLong2 - localaziz.jdField_a_of_type_Long < 400L) && ((Math.abs(f1) > 50.0F) || (Math.abs(f2) > 50.0F)))
            {
              paramInt2 = 0;
            ...
            if ((a(paramLong1, 0)) && (a((int)f1, (int)f2)) && (paramLong2 - localaziz.jdField_a_of_type_Long < 200L))
            {
            ...
            else
            {
              ...
              if (a(paramLong1, 3))
              {
                ...
                {
                  paramInt2 = i1;
                  if (paramLong2 - localaziz.jdField_a_of_type_Long >= 200L)
                  {
                    a(paramLong1, 3, paramFloat1, paramFloat2, (float)(paramLong2 - localaziz.jdField_a_of_type_Long));
                    paramInt2 = 1;
                  }
                }
              }
      ...
      i1 = 0;
      localaziz = a(paramInt1);
    } while (localaziz == null);
    paramInt2 = i1;
    int i3;
    if (localaziz.jdField_a_of_type_Boolean)
    {
      i3 = (int)(paramFloat1 - localaziz.jdField_a_of_type_Float);
      i2 = (int)(paramFloat2 - localaziz.b);
      if ((!this.jdField_a_of_type_Boolean) || (!a(paramLong1, 1)) || (paramLong2 - localaziz.jdField_a_of_type_Long >= 400L) || ((Math.abs(i3) <= 50) && (Math.abs(i2) <= 50))) {
        break label646;
      }
      paramInt2 = 0;
      if (i3 <= 0) {
    ...
    for (;;)
    {
      ...
      break label550;
      label646:
      if ((this.jdField_a_of_type_Boolean) && (a(paramLong1, 0)) && (a(i3, i2)) && (paramLong2 - localaziz.jdField_a_of_type_Long < 200L))
      {
        a(paramLong1, 0, paramFloat1, paramFloat2, 0.0F);
        paramInt2 = 1;
      }
