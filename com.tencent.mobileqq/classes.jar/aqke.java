...
public class aqke
{
  ...
  aqkw jdField_a_of_type_Aqkw = null;
  ...
  List<Integer> jdField_f_of_type_JavaUtilList = Arrays.asList(new Integer[] { Integer.valueOf(2131366829), Integer.valueOf(2131366831), Integer.valueOf(2131366832), Integer.valueOf(2131366833), Integer.valueOf(2131366834), Integer.valueOf(2131366835), Integer.valueOf(2131366836), Integer.valueOf(2131366837), Integer.valueOf(2131366838), Integer.valueOf(2131366830) });
  int g;
  int h = 0;
  int i = 0;
  int j = 0;
  ...
  public aqke(QQAppInterface paramQQAppInterface, Context paramContext)
  {
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    ...
    for (long l = a(800, 1500);; l = 750L)
    {
      ...
      localRotateAnimation.setInterpolator(new aqkj(this));
      this.jdField_a_of_type_AndroidWidgetImageView.startAnimation(localRotateAnimation);
      localRotateAnimation.setAnimationListener(new aqkh(this, paramInt, paramBoolean));
      return;
    }
  }
  
  public void a(aqkw paramaqkw, boolean paramBoolean)
  {
    if ((paramaqkw == null) || (this.jdField_a_of_type_AndroidContentContext == null))
    {
      if (QLog.isColorLevel()) {
        QLog.d(Face2FaceAddFriendActivity.a, 2, "startFriendDisappearAnimation disappear data is " + paramaqkw + " mContext " + this.jdField_a_of_type_AndroidContentContext);
      }
      return;
    }
    Object localObject = paramaqkw.e;
    if ((paramaqkw instanceof aqkt)) {
      localObject = paramaqkw.e + "_" + ((aqkt)paramaqkw).b;
    }
    ...
    for (int m = ((Integer)this.jdField_a_of_type_JavaUtilMap.get(localObject)).intValue();; m = -1)
    {
      if (m == -1)
      {
        ...
        QLog.d(Face2FaceAddFriendActivity.a, 2, "startFriendDisappearAnimation disappear uin " + paramaqkw.e.substring(0, 4) + " is not in the hole");
        QLog.d(Face2FaceAddFriendActivity.b, 2, "startFriendDisappearAnimation disappear uin " + paramaqkw.e.substring(0, 4) + " is not in the hole");
        this.h += 1;
        return;
      }
      ...
      if (paramBoolean)
      {
        ...
        localAnimationSet.setInterpolator(new aqkk(this));
        localAnimationSet.setAnimationListener(new aqkg(this));
        if (localObject != null) {
      ...
      if (QLog.isColorLevel()) {
        QLog.d(Face2FaceAddFriendActivity.a, 2, "startFriendDisappearAnimation disappear uin " + paramaqkw.e.substring(0, 4));
      }
      ...
      a(m);
      ((Face2FaceAddFriendActivity)this.jdField_a_of_type_AndroidContentContext).c(paramaqkw);
  ...
  public void a(aqkw paramaqkw, boolean paramBoolean1, int paramInt, boolean paramBoolean2, boolean paramBoolean3)
  {
    if ((paramaqkw == null) || (this.jdField_a_of_type_AndroidContentContext == null)) {
      if (QLog.isColorLevel()) {
        QLog.d(Face2FaceAddFriendActivity.a, 2, "startFriendInAnimation  data is " + paramaqkw + " mContext " + this.jdField_a_of_type_AndroidContentContext);
      }
    }
    int n;
    int m;
    ...
    ((Face2FaceFriendBubbleView)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramaqkw);
    ...
    if (QLog.isColorLevel())
    {
      if (!TextUtils.isEmpty(paramaqkw.e)) {
        QLog.d(Face2FaceAddFriendActivity.a, 2, "startFriendInAnimation get ( currentUin= " + paramaqkw.e.substring(0, 4) + " , index = " + m + " )");
      }
    }
    else
    {
    ...
    for (;;)
    {
      ...
      default: 
        ...
        ((TranslateAnimation)localObject2).setInterpolator(new aqkk(this));
        ((TranslateAnimation)localObject2).setAnimationListener(new aqkf(this, paramaqkw, m, d1, bool, paramBoolean3, paramaqkw, paramBoolean1, paramBoolean2, (Face2FaceFriendBubbleView)localObject1, paramInt));
        ((Face2FaceFriendBubbleView)localObject1).startAnimation((Animation)localObject2);
        localObject1 = paramaqkw.e;
        if ((paramaqkw instanceof aqkt)) {
          localObject1 = paramaqkw.e + "_" + ((aqkt)paramaqkw).b;
        }
        break;
      }
      for (;;)
      {
        ...
        ((Face2FaceAddFriendActivity)this.jdField_a_of_type_AndroidContentContext).a(paramaqkw, paramBoolean1, paramBoolean2);
        if (QLog.isColorLevel()) {
        ...
        {
          QLog.d(Face2FaceAddFriendActivity.a, 2, "startFriendInAnimation currentUIn= " + paramaqkw.e.substring(0, 4) + " startAnimation OK");
          return;
          m = n;
          if (this.jdField_c_of_type_JavaUtilList.size() <= 1) {
            break label91;
  ...
  public void a(QQAppInterface paramQQAppInterface, View paramView, int paramInt, String paramString)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131364657));
    if ((paramInt == 1) && (!TextUtils.isEmpty(paramString)))
    {
      ((ImageView)paramView.findViewById(2131364658)).setVisibility(4);
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130839673);
      paramQQAppInterface = paramQQAppInterface.a(paramString, (byte)3, false, false);
      if (paramQQAppInterface != null) {
        break label476;
      }
      paramQQAppInterface = bdhj.f();
    }
    label476:
    for (;;)
    {
      paramString = (ImageView)paramView.findViewById(2131378369);
  ...
  public void b()
  {
    ...
    for (this.jdField_b_of_type_Float = (this.jdField_a_of_type_Float - m);; this.jdField_b_of_type_Float = (m + f2))
    {
      ...
      this.jdField_a_of_type_AndroidViewAnimationRotateAnimation.setInterpolator(new aqkj(this));
      this.jdField_a_of_type_AndroidWidgetImageView.startAnimation(this.jdField_a_of_type_AndroidViewAnimationRotateAnimation);
      this.jdField_a_of_type_AndroidViewAnimationRotateAnimation.setAnimationListener(new aqki(this));
      return;
