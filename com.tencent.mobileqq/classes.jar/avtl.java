...
public class avtl
{
  ...
  static
  {
    jdField_a_of_type_ArrayOfInt = new int[] { 101, 2130845078 };
    jdField_b_of_type_ArrayOfInt = new int[] { 102, 2130845081 };
    jdField_c_of_type_ArrayOfInt = new int[] { 103, 2130845077 };
    jdField_d_of_type_ArrayOfInt = new int[] { 104, 2130845084 };
  }
  
  public avtl(int paramInt)
  {
