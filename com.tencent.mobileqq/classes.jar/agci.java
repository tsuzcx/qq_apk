...
public class agci
{
  public static final int[] A = { 9, 2131698801, 2130844347, 2131373353, 0 };
  public static final int[] B = { 10, 2131698788, 2130838033, 2131373336, 0, 2130849255, 2130849256 };
  public static final int[] C = { 10, 2131698788, 2130844350, 2131373336, 0 };
  public static final int[] D = { 12, 2131698780, 2130838090, 2131373323, 0 };
  public static final int[] E = { 13, 2131698781, 2130838087, 2131373324, 0 };
  public static final int[] F = { 14, 2131698790, 2130838028, 2131373341, 0 };
  public static final int[] G = { 14, 2131698790, 2130844349, 2131373341, 0 };
  public static final int[] H = { 19, 2131698792, 2130838069, 2131373343, 0 };
  public static final int[] I = { 19, 2131698792, 2130844354, 2131373343, 0 };
  public static final int[] J = { 16, 2131698786, 2130838025, 2131373333, 0 };
  public static final int[] K = { 17, 2131698795, 2130838066, 2131373347, 0 };
  public static int[] L = { 23, 2131698797, 2130838078, 2131373352, 0, 2130849300, 2130849301 };
  public static final int[] M = { 26, 2131698808, 2130838078, 2131373367, 0 };
  public static final int[] N = { 24, 2131698789, 2130838034, 2131373337, 2130837958, 2130838054, 2130838056 };
  public static final int[] O = { 24, 2131698789, 2130844347, 2131373337, 0 };
  public static final int[] P = { 31, 2131698796, 2130838070, 2131373348, 0 };
  public static final int[] Q = { 32, 2131698787, 2130838032, 2131373335, 0 };
  public static final int[] R = { 24, 2131698789, 2130838036, 2131373338, 0 };
  public static final int[] S = { 24, 2131698789, 2130838035, 2131373338, 0 };
  public static final int[] T = { 29, 2131695117, 2130849220, 2131373319, 0 };
  public static final int[] U = { 29, 2131695117, 2130844346, 2131373319, 0 };
  public static final int[] V = { 21, 2131690379, 2130838294, 2131373318, 0 };
  public static final int[] W = { 21, 2131690379, 2130844344, 2131373318, 0 };
  public static final int[] X = { 21, 2131690379, 2130838335, 2131373322, 0 };
  ...
  static
  {
    ...
    jdField_a_of_type_ArrayOfInt = new int[] { 2, 2131698802, 2130838080, 2131373354, 2130837962, 2130849317, 2130849318 };
    b = new int[] { 2, 2131698802, 2130838084, 2131373355, 0 };
    c = new int[] { 2, 2131698802, 2130838082, 2131373355, 0 };
    d = new int[] { 2, 2131698802, 2130844357, 2131373354, 0 };
    e = new int[] { 3, 2131698783, 2130838016, 2131373326, 2130837956, 2130849245, 2130849246 };
    f = new int[] { 3, 2131698783, 2130838020, 2131373327, 0 };
    g = new int[] { 3, 2131698783, 2130838018, 2131373327, 0 };
    h = new int[] { 3, 2131698783, 2130844348, 2131373326, 0 };
    i = new int[] { 3, 2131698783, 2130838023, 2131373326, 2130837957, 2130849243, 2130849244 };
    j = new int[] { 3, 2131698783, 2130838021, 2131373327, 0 };
    k = new int[] { 3, 2131698783, 2130838019, 2131373327, 0 };
    l = new int[] { 4, 2131698793, 2130838058, 2131373344, 2130837959, 2130849274, 2130849275 };
    m = new int[] { 4, 2131698793, 2130838063, 2131373345, 0 };
    n = new int[] { 4, 2131698793, 2130838060, 2131373345, 0 };
    o = new int[] { 4, 2131698793, 2130844353, 2131373344, 0 };
    p = new int[] { 4, 2131698793, 2130838065, 2131373344, 2130837960, 2130849272, 2130849273 };
    q = new int[] { 4, 2131698793, 2130838064, 2131373345, 0 };
    r = new int[] { 4, 2131698793, 2130838061, 2131373345, 0 };
    s = new int[] { 5, 2131698779, 2130838010, 2131373320, 0, 2130849225, 2130849226 };
    t = new int[] { 5, 2131698779, 2130838014, 2131373321, 0 };
    u = new int[] { 5, 2131698779, 2130838012, 2131373321, 0 };
    v = new int[] { 6, 2131698803, 2130838087, 2131373357, 0, 2130849323, 2130849324 };
    w = new int[] { 8, 2131698798, 2130838073, 2131373349, 2130837961, 2130849294, 2130849295 };
    x = new int[] { 8, 2131698798, 2130838075, 2131373350, 0 };
    y = new int[] { 8, 2131698798, 2130844355, 2131373349, 0 };
    z = new int[] { 9, 2131698801, 2130838079, 2131373353, 0 };
  }
  ...
  {
    PhotoListPanel localPhotoListPanel = (PhotoListPanel)View.inflate(paramBaseChatPie.jdField_a_of_type_AndroidContentContext, 2131560804, null);
    Intent localIntent;
    if (!paramBoolean)
    {
    ...
    Object localObject = ((aloz)paramQQAppInterface.getManager(51)).e(str);
    paramIntent = "";
    if (localObject != null) {
    ...
    localIntent.putExtra("PhotoConst.PHOTOLIST_KEY_SHOW_MEDIA", aepf.a(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo));
    if (paramBoolean)
    {
      ...
      paramIntent = (alzf)paramQQAppInterface.a(20);
    ...
    localPhotoListPanel.setOnSwipeUpAndDragListener(new aggy(paramBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, paramBaseChatPie.d, paramQQAppInterface, paramBaseChatPie.a(), null, localPhotoListPanel));
  ...
  public static void a(QQAppInterface paramQQAppInterface, FragmentActivity paramFragmentActivity)
  {
    ...
    aepf.a(paramQQAppInterface, paramFragmentActivity);
    paramFragmentActivity.setCanLock(false);
    azmj.b(paramQQAppInterface, "CliOper", "", "", "0X800407F", "0X800407F", 0, 0, "", "", "", "");
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, int paramInt1, String paramString, int paramInt2)
  {
    ...
    paramString = localaxho.a(paramInt1, paramString);
    if (paramString != null)
    {
      if (paramString.iNewFlag.get() == 1) {
        localaxho.a(paramString, "");
      }
    }
    else {
      return;
    ...
    for (;;)
    {
      azmj.b(paramQQAppInterface, "dc00898", "", "", "0X800A46A", "0X800A46A", paramInt2, paramString.iNewFlag.get(), String.valueOf(paramInt1), "", "", "");
      return;
      paramInt1 = 0;
      break;
      label150:
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      azmj.b(paramQQAppInterface, "CliOper", "", "", paramString, paramString, paramInt, 0, "", "", "", "");
      return;
      if (paramInt == 3000) {
        paramInt = 2;
      } else if (paramInt == 1) {
  ...
  {
    if (((bfua)paramQQAppInterface.getManager(165)).f(paramSessionInfo.jdField_a_of_type_JavaLangString)) {
      azmj.b(paramQQAppInterface, "dc00899", "Qidian", paramSessionInfo.jdField_a_of_type_JavaLangString, paramString1, paramString2, 0, 0, "", "", "", "");
    }
  }
  ...
  {
    if (((bfua)paramQQAppInterface.getManager(165)).f(paramSessionInfo.jdField_a_of_type_JavaLangString)) {
      azmj.b(paramQQAppInterface, "dc00899", "Qidian", paramSessionInfo.jdField_a_of_type_JavaLangString, paramString1, paramString2, 0, 0, paramInt1 + "", paramInt2 + "", "", "");
    }
  }
}
