  ...
  implements bkgy
{
  ...
  public bmsr(QQAppInterface paramQQAppInterface, View paramView)
  {
    super(paramView);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    if (this.jdField_b_of_type_AndroidGraphicsDrawableDrawable == null) {
      this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130838334);
    }
  }
  ...
  private void f()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (this.jdField_a_of_type_CooperationVipPbTianShuAccess$AdItem != null)) {
      bmsk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 122, String.valueOf(this.jdField_a_of_type_CooperationVipPbTianShuAccess$AdItem.iAdId.get()), this.jdField_a_of_type_CooperationVipPbTianShuAccess$AdItem.traceinfo.get());
    }
  }
  
  private void g()
  {
    bmsk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString, 4004);
    if ((this.jdField_a_of_type_AndroidViewView != null) && ((this.jdField_a_of_type_AndroidViewView instanceof ARMapHongBaoListView)))
    {
      ((ARMapHongBaoListView)this.jdField_a_of_type_AndroidViewView).setPendantHolder(null);
  ...
  {
    float f = -afur.a(20.0F, this.jdField_a_of_type_AndroidViewView.getResources());
  ...
  public void a()
  {
    try
    {
      ...
      j = afur.a(160.0F, this.jdField_a_of_type_AndroidViewView.getResources());
      a(i - j - 0, 0, j, afur.a(c, this.jdField_a_of_type_AndroidViewView.getResources()), this.jdField_a_of_type_AndroidViewView);
      this.jdField_a_of_type_AndroidGraphicsRect = new Rect(this.f + j - afur.a(23.0F, this.jdField_a_of_type_AndroidViewView.getResources()), this.g + afur.a(22.0F, this.jdField_a_of_type_AndroidViewView.getResources()), this.f + j - afur.a(8.0F, this.jdField_a_of_type_AndroidViewView.getResources()), this.g + afur.a(37.0F, this.jdField_a_of_type_AndroidViewView.getResources()));
      this.jdField_b_of_type_AndroidGraphicsRect = new Rect(this.f + j - afur.a(23.0F, this.jdField_a_of_type_AndroidViewView.getResources()), this.g, j + this.f, this.g + afur.a(37.0F, this.jdField_a_of_type_AndroidViewView.getResources()));
      return;
    }
    catch (Throwable localThrowable)
    {
  ...
  public void a(TianShuAccess.AdItem paramAdItem)
  {
    ...
    do
    {
      do
      {
        ...
        localObject = bdzx.jdField_a_of_type_AndroidGraphicsDrawableDrawable;
      ...
      this.jdField_a_of_type_Bmss = new bmss(this, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidViewView, this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
