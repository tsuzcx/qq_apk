  ...
  implements View.OnClickListener
{
  ...
  public bmsr(View paramView, arsg paramarsg)
  {
    super(paramView);
    this.jdField_a_of_type_Arsg = paramarsg;
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131365615));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131365616));
    this.c = ((ImageView)paramView.findViewById(2131365618));
    this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131365617);
    this.jdField_a_of_type_DovComQqImCaptureViewQIMCommonLoadingView = ((QIMCommonLoadingView)paramView.findViewById(2131369768));
    this.d = ((ImageView)paramView.findViewById(2131368194));
    paramView.setOnClickListener(this);
    paramarsg = (RelativeLayout.LayoutParams)this.jdField_a_of_type_DovComQqImCaptureViewQIMCommonLoadingView.getLayoutParams();
    RelativeLayout.LayoutParams localLayoutParams = (RelativeLayout.LayoutParams)this.c.getLayoutParams();
    paramView = (ViewGroup.MarginLayoutParams)paramView.getLayoutParams();
    paramarsg.width = paramView.width;
    paramarsg.height = paramView.height;
    paramarsg.addRule(10);
    paramarsg.addRule(9);
    paramarsg.addRule(12);
    paramarsg.addRule(11);
    this.jdField_a_of_type_DovComQqImCaptureViewQIMCommonLoadingView.setLayoutParams(paramarsg);
  ...
  public void onClick(View paramView)
  {
    if (paramView == this.jdField_a_of_type_AndroidViewView)
    {
      if (this.jdField_a_of_type_Arsg != null) {
        this.jdField_a_of_type_Arsg.a(paramView, getAdapterPosition(), -1);
      }
      wta.a("video_edit_text", "clk_textIcon", 0, 0, new String[] { (String)upm.a().a("EditVideoDTextFace.mSrcFrom"), String.valueOf(getAdapterPosition() + 1), "", "" });
    }
  }
}
