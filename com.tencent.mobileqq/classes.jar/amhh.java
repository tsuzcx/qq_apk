...
public class amhh
{
  ...
  public static ColorNote a(ColorNote paramColorNote)
  {
    ...
    return new amhb().a(i | 0x80000000).a(paramColorNote.getSubType()).b(0).b(paramColorNote.getMainTitle()).c(str).d(paramColorNote.getPicUrl()).a(paramColorNote.getReserve()).a();
  }
  ...
  public static void a(Context paramContext)
  {
    ...
    localbbgu.setTitle(paramContext.getString(2131690864));
    localbbgu.setNegativeButton(paramContext.getString(2131690863), new amhi(localbbgu, paramContext));
    localbbgu.show();
    paramContext = localbbgu.getTitleTextView();
    paramContext.setClickable(true);
    paramContext.setFocusable(true);
    paramContext.setFocusableInTouchMode(true);
    baww.a(paramContext, true);
  }
  ...
  public static ColorNote b(ColorNote paramColorNote)
  {
    ...
    return new amhb().a(i).a(paramColorNote.getSubType()).b(paramColorNote.getMainTitle()).c(paramColorNote.getSubTitle()).a(paramColorNote.getReserve()).a();
  }
