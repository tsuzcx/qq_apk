...
public class ahia
{
  ...
  public static void a(int paramInt)
  {
    try
    {
      ...
      if (!str1.equals(str2))
      {
        ahif.a(ahhz.d, 1, paramInt, null, false);
  ...
  public static void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, boolean paramBoolean, String... paramVarArgs)
  {
    try
    {
      ...
      ahif.a(ahhz.b, paramInt1, paramInt2, localHashMap, paramBoolean);
      return;
    }
  ...
  private static void a(int paramInt, AppInterface paramAppInterface)
  {
    ...
    for (;;)
    {
      ...
      if (localObject != null) {
        ThreadManagerV2.executeOnFileThread(new SpringHbMonitorReporter.1((ahib)localObject));
      }
    }
  }
  ...
  public static void a(PreloadModule paramPreloadModule, int paramInt1, String paramString, int paramInt2)
  {
    ...
    do
    {
      ...
      paramPreloadModule = ahiw.c(paramString);
      if (!TextUtils.isEmpty(paramPreloadModule))
      {
        ...
        ahif.a(ahhz.jdField_a_of_type_JavaLangString, 2, paramInt1, localHashMap);
      }
      if (paramInt1 == 0)
      {
        a();
  ...
  public static void a(SpringHbReportManager.ReportInfo paramReportInfo)
  {
    ...
    paramReportInfo = (ahfx)((QQAppInterface)localObject).getManager(342);
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      a(1, (AppInterface)localObject);
      a(2, (AppInterface)localObject);
      return;
    }
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramBoolean)
        {
          ...
          {
            i = 0;
            ahif.a((String)localObject3, 2, i, (Map)localObject2, false);
          }
        }
        else
        {
      ...
      {
        ahif.a(paramString, 1, paramInt1, (Map)localObject3, true);
  ...
  public static void a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    ahif.a(ahhz.jdField_a_of_type_JavaLangString, 4, paramInt, localHashMap);
  }
  ...
  public static void a(boolean paramBoolean1, int paramInt, AppInterface paramAppInterface, boolean paramBoolean2)
  {
    ...
    for (int i = 0;; i = 1)
    {
      ahif.a((String)localObject2, 1, i, (Map)localObject1, false);
    ...
    String str = ahhz.jdField_a_of_type_JavaLangString;
    if (paramBoolean1) {}
    for (paramInt = j;; paramInt = 1)
    {
      ahif.a(str, 1, paramInt, (Map)localObject2, true);
  ...
  @NonNull
  private static ahib b(AppRuntime paramAppRuntime)
  {
    ahib localahib = new ahib(null);
    Object localObject = "";
    int k = 0;
    int m = -1;
    int j;
    ...
    {
      localObject = (ahfq)((QQAppInterface)paramAppRuntime).getManager(343);
      if (localObject == null) {
        break label232;
      }
      if (((ahfq)localObject).a() != null)
      {
        paramAppRuntime = ((ahfq)localObject).a().bids;
        j = ((ahfq)localObject).a();
        i = ((ahfq)localObject).b();
      }
    }
    for (;;)
    {
      ...
      for (;;)
      {
        localahib.jdField_a_of_type_JavaLangString = ((String)localObject);
        localahib.b = i;
        localahib.jdField_a_of_type_Int = j;
        return localahib;
        paramAppRuntime = "";
        break;
  ...
  private static int c(int paramInt)
  {
    ...
    return ampl.a().a(paramInt, localQQAppInterface.getCurrentAccountUin());
  }
