...
public class bgrt
{
  ...
  private List<bgrw> b = new ArrayList();
  ...
  private static List<InstalledEngine> a()
  {
    ...
    //   22: astore 7
    //   24: invokestatic 159	bgrt:a	()Ljava/io/File;
    //   27: astore 8
    //   29: aload 8
    ...
    //   250: iconst_0
    //   251: invokestatic 200	bgkv:a	(Ljava/lang/String;Z)V
    //   254: iload_1
    //   255: iconst_1
    //   256: iadd
    //   257: istore_1
    ...
    //   271: aload 11
    //   273: aload 11
    //   275: invokestatic 205	bgrt:a	(Lcom/tencent/qqmini/sdk/manager/InstalledEngine;)Z
    ...
    //   323: aload 11
    //   325: aload 10
    //   327: invokestatic 215	bgrt:a	(Ljava/io/File;)Z
  ...
  private void a(float paramFloat, String paramString)
  {
    ...
    while (localIterator.hasNext())
    {
      bgrw localbgrw = (bgrw)localIterator.next();
      if (localbgrw != null) {
        localbgrw.a(paramFloat, paramString);
      }
    }
  }
  ...
  private void a(BaseLibInfo paramBaseLibInfo, String paramString, long paramLong, File paramFile, EngineVersion paramEngineVersion, boolean paramBoolean)
  {
    ...
    ((DownloaderProxy)ProxyManager.get(DownloaderProxy.class)).download(paramString, null, str, 60, new bgru(this, paramString, paramBaseLibInfo, paramLong, paramFile, paramEngineVersion, paramBoolean));
    ...
    if (paramFile != null)
    {
      ...
      if (paramFile.exists())
      {
        ...
        if (paramFile.isDirectory())
        {
          ...
          {
            paramFile = paramFile.listFiles(new bgrv());
            if (paramFile != null)
            {
              bool1 = bool2;
  ...
  private boolean a(File paramFile, String paramString1, EngineVersion paramEngineVersion, String paramString2, boolean paramBoolean)
  {
    ...
    //   8: aload_1
    //   9: aload_3
    //   10: invokestatic 356	bgrt:a	(Ljava/io/File;Lcom/tencent/qqmini/sdk/manager/EngineVersion;)Ljava/lang/String;
    //   13: astore_1
    //   14: aload_1
    //   15: ifnonnull +26 -> 41
    //   18: aload_0
    //   19: invokespecial 274	bgrt:d	()V
    //   22: aload 4
    //   24: iconst_1
    //   25: invokestatic 200	bgkv:a	(Ljava/lang/String;Z)V
    //   28: aload_0
    //   29: invokespecial 274	bgrt:d	()V
    //   32: iload 9
    //   34: istore 7
    //   36: aload_0
    //   37: monitorexit
    ...
    //   55: aload_1
    //   56: iconst_0
    //   57: invokestatic 200	bgkv:a	(Ljava/lang/String;Z)V
    //   60: aload_0
    //   61: fconst_1
    //   62: ldc_w 358
    //   65: invokespecial 276	bgrt:a	(FLjava/lang/String;)V
    //   68: aload 4
    //   70: aload_1
    //   71: invokestatic 363	bglr:a	(Ljava/lang/String;Ljava/lang/String;)I
    //   74: istore 6
    //   76: iload 6
    //   78: ifne +325 -> 403
    //   81: ldc2_w 364
    ...
    //   88: fconst_1
    //   89: ldc_w 373
    //   92: invokespecial 276	bgrt:a	(FLjava/lang/String;)V
    //   95: ldc2_w 364
    //   98: invokestatic 371	java/lang/Thread:sleep	(J)V
    //   101: aload_0
    //   102: aload 4
    //   104: aload_1
    //   105: invokespecial 376	bgrt:a	(Ljava/lang/String;Ljava/lang/String;)Z
    //   108: istore 8
    //   110: iload 6
    //   112: ifne +101 -> 213
    //   115: iload 8
    ...
    //   165: invokestatic 118	bgrt:a	()V
    //   168: iconst_1
    //   169: istore 7
    //   171: aload 4
    //   173: iconst_1
    //   174: invokestatic 200	bgkv:a	(Ljava/lang/String;Z)V
    //   177: iload 7
    //   179: ifeq +22 -> 201
    //   182: iload 5
    //   184: ifeq +194 -> 378
    ...
    //   188: fconst_1
    //   189: ldc_w 384
    //   192: invokespecial 276	bgrt:a	(FLjava/lang/String;)V
    //   195: ldc2_w 364
    //   198: invokestatic 371	java/lang/Thread:sleep	(J)V
    //   201: aload_0
    //   202: invokespecial 274	bgrt:d	()V
    //   205: goto -169 -> 36
    //   208: astore_1
    //   209: aload_0
    //   210: monitorexit
    ...
    //   258: aload_1
    //   259: iconst_0
    //   260: invokestatic 200	bgkv:a	(Ljava/lang/String;Z)V
    //   263: iload 6
    //   265: ifeq +76 -> 341
    //   268: aload_0
    //   269: fconst_0
    //   270: ldc_w 388
    //   273: invokespecial 276	bgrt:a	(FLjava/lang/String;)V
    //   276: iload 10
    //   278: istore 7
    //   280: goto -109 -> 171
    //   283: astore_1
    ...
    //   317: fconst_0
    //   318: ldc_w 392
    //   321: invokespecial 276	bgrt:a	(FLjava/lang/String;)V
    //   324: aload 4
    //   326: iconst_1
    //   327: invokestatic 200	bgkv:a	(Ljava/lang/String;Z)V
    //   330: aload_0
    //   331: invokespecial 274	bgrt:d	()V
    //   334: iload 9
    //   336: istore 7
    //   338: goto -302 -> 36
    //   341: iload 10
    ...
    //   351: fconst_0
    //   352: ldc_w 394
    //   355: invokespecial 276	bgrt:a	(FLjava/lang/String;)V
    //   358: iload 10
    //   360: istore 7
    //   362: goto -191 -> 171
    //   365: astore_1
    //   366: aload 4
    //   368: iconst_1
    //   369: invokestatic 200	bgkv:a	(Ljava/lang/String;Z)V
    //   372: aload_0
    //   373: invokespecial 274	bgrt:d	()V
    //   376: aload_1
    //   377: athrow
    //   378: aload_0
    //   379: fconst_1
    //   380: ldc_w 396
    //   383: invokespecial 276	bgrt:a	(FLjava/lang/String;)V
    //   386: goto -191 -> 195
    //   389: astore 11
    //   391: goto -304 -> 87
    //   394: astore 11
  ...
  public static void b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      for (EngineVersion localEngineVersion = bgtd.a().jdField_a_of_type_ComTencentQqminiSdkManagerEngineVersion;; localEngineVersion = null)
      {
  ...
  private static boolean b(File paramFile)
  {
    ...
    return (localEngineVersion != null) && (localEngineVersion.equals(bgtd.a().jdField_a_of_type_ComTencentQqminiSdkManagerEngineVersion)) && (a(paramFile));
  }
  ...
  public void a(BaseLibInfo paramBaseLibInfo, bgrw parambgrw)
  {
    ...
    for (;;)
    {
      ...
      finally
      {
        ...
        catch (Exception parambgrw)
        {
          QMLog.w("EngineInstaller", "[MiniEng] refuse installEngine " + paramBaseLibInfo.baseLibDesc + ":" + paramBaseLibInfo.baseLibVersion + paramBaseLibInfo.baseLibUrl + DebugUtil.getPrintableStackTrace(parambgrw));
          b();
        }
      ...
      {
        bool1 = false;
        QMLog.i("EngineInstaller", "[MiniEng] installWithCallback callback=" + parambgrw);
        if ((paramBaseLibInfo.baseLibType == 2) && (!bgtd.a().a()) && (!paramBaseLibInfo.baseLibUrl.startsWith("assets://")))
        {
          parambgrw = bgtd.a().jdField_a_of_type_ComTencentQqminiSdkManagerEngineVersion;
          if (parambgrw.a(localEngineVersion) >= 0)
          {
            QMLog.i("EngineInstaller", "[MiniEng] refuse install remote baselib:" + localEngineVersion + ",local:" + parambgrw);
            b();
            continue;
          }
        }
        parambgrw = a(paramBaseLibInfo.baseLibType);
        QMLog.i("EngineInstaller", "[MiniEng] engineForType " + paramBaseLibInfo.baseLibType + ", size=" + parambgrw.size());
        if (parambgrw.size() <= 0) {
          break;
        }
        parambgrw = (InstalledEngine)parambgrw.get(0);
        QMLog.i("EngineInstaller", "[MiniEng]latest engine for type " + paramBaseLibInfo.baseLibType + "," + parambgrw);
        if (parambgrw.jdField_a_of_type_ComTencentQqminiSdkManagerEngineVersion.a(localEngineVersion) < 0) {
          break label1100;
        }
        QMLog.i("EngineInstaller", "[MiniEng]engine type " + paramBaseLibInfo.baseLibType + " has no update, remote:" + localEngineVersion + ",latest:" + parambgrw);
        b();
      }
    }
    for (;;)
    {
      ...
      bgrl.a().a();
      QMLog.i("EngineInstaller", "[MiniEng] installLocalEngine finish copied " + parambgrw[0] + "<>" + l);
      if ((parambgrw[0] == l) || (l < 0L))
      {
  ...
  public void b(bgrw parambgrw)
  {
    try
    {
      this.b.remove(parambgrw);
      return;
    }
    finally
    {
