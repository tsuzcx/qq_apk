...
public class mui
{
  ...
  public Activity a;
  BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new mun(this);
  ...
  public mui(Activity paramActivity, muo parammuo)
  {
  ...
  void a(nbt paramnbt)
  {
    if (this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer == null)
    {
      ...
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnVideoPreparedListener(new muj(this));
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnCompletionListener(new muk(this));
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnErrorListener(new mul(this));
    }
    for (int i = 1;; i = 0)
    {
      if (i != 0)
      {
        ...
        if (paramnbt.a != null)
        {
          ...
          if (paramnbt.a.size() != 0) {
            localObject1 = ((nbu)paramnbt.a.get(0)).j;
          }
        }
        if ((localObject1 != null) && (!TextUtils.isEmpty((CharSequence)localObject1)))
        {
          ...
          paramnbt = new HashMap();
          paramnbt.put("shouq_bus_type", "bus_type_account_detail");
          this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_PlayerVideoInfo.setReportInfoMap(paramnbt);
  ...
  public void a(nbt paramnbt, FrameLayout paramFrameLayout)
  {
  ...
  public void a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer != null)
    {
      ...
      this.jdField_a_of_type_Muo.f();
    }
    label86:
    while (!paramBoolean) {
      return;
    }
    this.jdField_a_of_type_Muo.g();
  }
