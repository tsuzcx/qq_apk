...
public class birz
{
  ...
  {
    if ((bisb.jdField_a_of_type_Boolean) || (bisb.b))
    {
      StringBuilder localStringBuilder = new StringBuilder("_tcvassp_0_=");
      if ((bisb.jdField_a_of_type_Int != -1) && (bisb.jdField_a_of_type_JavaUtilArrayList.size() != 0))
      {
        localStringBuilder.append(bisb.jdField_a_of_type_Int);
        if (bisb.b) {}
        for (Object localObject = "shp";; localObject = "webp")
        {
          ...
          ((Bundle)localObject).putStringArrayList("domains", bisb.jdField_a_of_type_JavaUtilArrayList);
          if (QLog.isColorLevel())
          {
            QLog.i("SwiftWebViewUtils", 2, "getCDNExtensionData, arg: " + localStringBuilder.toString());
            QLog.i("SwiftWebViewUtils", 2, "getCDNExtensionData, domainList: " + TextUtils.join(", ", bisb.jdField_a_of_type_JavaUtilArrayList));
          }
          return localObject;
        }
      }
  ...
  public static Bundle a(WebViewFragment paramWebViewFragment, Intent paramIntent)
  {
    ...
    if (localObject != null)
    {
      ...
      if (Build.VERSION.SDK_INT >= 19) {
        ...
        {
          paramWebViewFragment.webView.evaluateJavascript("document.querySelector(\"meta[itemprop='name']\").getAttribute('content')", new bisa(paramWebViewFragment));
          paramIntent = null;
        }
      }
    }
  ...
  public static String a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    default: 
      ...
      if (WebpSoLoader.b())
      {
        ...
        if (!TextUtils.isEmpty(str2)) {
          bisb.jdField_a_of_type_Boolean = true;
        }
        bisb.b = paramBoolean;
    ...
    for (int k = 1;; k = 0)
    {
      ...
      localObject = localStringBuilder.append((String)localObject).append(" ").append(bmtd.a());
      if (!TextUtils.isEmpty(paramString2)) {
        break label492;
      }
      paramString1 = "";
      return paramString1 + " QQ/" + "8.4.5" + "." + "4745" + str1 + str2 + " Pixel/" + n + " StatusBarHeight/" + i1 + " SimpleUISwitch/" + k + " QQTheme/" + ThemeUtil.getCurrentThemeId() + " InMagicWin/" + i;
  ...
  {
    int j = 0;
    if ((bisb.jdField_a_of_type_JavaUtilArrayList.size() != 0) && (bisb.jdField_a_of_type_Int != -1)) {}
    Object localObject1;
    do
    {
      return;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          bisb.jdField_a_of_type_JavaUtilArrayList.clear();
          k = localObject2.length;
          i = 0;
          if (i < k)
          {
            arrayOfString = localObject2[i];
            bisb.jdField_a_of_type_JavaUtilArrayList.add(arrayOfString.trim());
            i += 1;
            continue;
          }
        }
    ...
    if ((!TextUtils.isEmpty(paramString)) && (paramString.equalsIgnoreCase(paramJSONObject.optString("business", ""))))
    {
      ...
      if (bool2)
      {
        ...
        if (paramJSONObject.has("minVersion"))
        {
          ...
          {
            bool1 = bool2;
            if (!bhyk.a(paramString, "8.4.5.4745")) {
              bool1 = false;
            }
          }
        }
      ...
      if (bool1)
      {
        ...
        if (paramJSONObject.has("maxVersion"))
        {
          ...
          {
            bool2 = bool1;
            if (!bhyk.a("8.4.5.4745", paramString)) {
              bool2 = false;
            }
          }
        }
  ...
  public static void b()
  {
    ...
    bisc.jdField_a_of_type_JavaLangString = localSharedPreferences.getString("http_proxy_address", "");
    bisc.jdField_a_of_type_Boolean = localSharedPreferences.contains("need_set_proxy");
