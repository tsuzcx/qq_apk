  ...
  implements View.OnClickListener
{
  ...
  public birz(ProfileCardMoreInfoView paramProfileCardMoreInfoView)
  {
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      localObject1 = ((ProfileCardMoreInfoView)localObject1).jdField_a_of_type_Azrb;
      if ((localBaseActivity == null) || (localQQAppInterface == null) || (localObject1 != null))
      {
        Object localObject2 = paramView.getTag();
        if ((localObject2 instanceof azpb)) {
          switch (((azpb)localObject2).a)
          {
          default: 
            break;
          case 66: 
            bhaa.a((azrb)localObject1, localQQAppInterface, localBaseActivity);
            int i = j;
            if (((azrb)localObject1).a != null)
            {
              i = j;
              if (((azrb)localObject1).a.a == 0) {
                i = 1;
              }
            }
            bdla.b(localQQAppInterface, "dc00898", "", "", "0X8009999", "0X8009999", i, 0, "", "", "", "");
          }
        }
      }
    }
