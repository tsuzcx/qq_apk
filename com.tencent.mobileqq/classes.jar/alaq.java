  ...
  implements SurfaceTexture.OnFrameAvailableListener, GLSurfaceView.Renderer
{
  ...
  alak jdField_a_of_type_Alak;
  alap jdField_a_of_type_Alap = new alap();
  ...
  private alar[] jdField_a_of_type_ArrayOfAlar = new alar[300];
  ...
  public alaq(alaf paramalaf)
  {
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_Alaf = paramalaf;
    this.jdField_a_of_type_Alak = paramalaf.a();
  }
  ...
  protected void a()
  {
    ...
    try
    {
      ...
      localObject = BitmapFactory.decodeResource(BaseApplicationImpl.getApplication().getResources(), 2130844069, (BitmapFactory.Options)localObject);
      if (localObject != null)
      {
    ...
    try
    {
      localObject = new BitmapFactory.Options();
      ((BitmapFactory.Options)localObject).inPreferredConfig = Bitmap.Config.ARGB_8888;
      localObject = BitmapFactory.decodeResource(this.jdField_a_of_type_Alaf.a().getResources(), 2130844070, (BitmapFactory.Options)localObject);
      if (localObject != null)
      {
        GLUtils.texImage2D(3553, 0, (Bitmap)localObject, 0);
        ((Bitmap)localObject).recycle();
  ...
  {
    this.u = 1;
    this.jdField_a_of_type_Alak.jdField_a_of_type_Long = 0L;
    this.jdField_a_of_type_Alak.c = 0L;
    this.jdField_a_of_type_Alak.jdField_b_of_type_Long = 0L;
  ...
  public void a(FloatBuffer paramFloatBuffer, Size paramSize)
  {
    ...
    if ((this.jdField_a_of_type_AndroidUtilSize == null) && (this.jdField_a_of_type_Alap != null))
    {
      this.jdField_a_of_type_AndroidUtilSize = paramSize;
      this.jdField_a_of_type_Alap.a(paramSize.getHeight(), paramSize.getWidth(), allh.jdField_a_of_type_Int, allh.jdField_b_of_type_Int);
    }
  }
  ...
  public void c()
  {
    ...
    if (i4 < 300)
    {
      localalar2 = this.jdField_a_of_type_ArrayOfAlar[i4];
      if ((localalar2 != null) && (!localalar2.jdField_a_of_type_Boolean))
      {
        if (this.jdField_a_of_type_JavaUtilRandom.nextFloat() > 0.7F - localalar2.jdField_b_of_type_Float * 0.35F - Math.abs(localalar2.jdField_a_of_type_Float * 0.3F - 0.15F)) {
          localalar2.jdField_a_of_type_Boolean = true;
        }
      }
      else
      {
        if (localalar2 != null)
        {
          localalar1 = localalar2;
          i3 = i2;
          if (!localalar2.jdField_a_of_type_Boolean) {
            break label370;
          }
        }
        if (i2 <= i7) {
    ...
    for (;;)
    {
      ...
      float f4 = localalar2.jdField_b_of_type_Float;
      localalar2.jdField_b_of_type_Float = (f3 * 0.3F + 0.2F * localalar2.jdField_b_of_type_Float + f2 + f4);
      if (localalar2.jdField_b_of_type_Float <= 1.0D) {
        break label184;
      }
      localalar2.jdField_a_of_type_Boolean = true;
      break label184;
      ...
      if (localalar2 == null)
      {
        localalar1 = new alar(this);
        this.jdField_a_of_type_ArrayOfAlar[i4] = localalar1;
      }
      f3 = this.jdField_a_of_type_JavaUtilRandom.nextFloat();
      if (f3 < 0.4D) {
        localalar1.jdField_a_of_type_Float = (f3 * 2.35F + 0.02F);
      }
      for (;;)
      {
        localalar1.jdField_b_of_type_Float = (this.jdField_a_of_type_JavaUtilRandom.nextFloat() * 0.05F + f1);
        localalar1.jdField_a_of_type_Boolean = false;
        i3 = i2 + 1;
        label370:
        if ((localalar1 == null) || (localalar1.jdField_a_of_type_Boolean) || (localalar1.jdField_b_of_type_Float >= 1.0D)) {
          break label542;
        }
        this.jdField_c_of_type_ArrayOfFloat[(i1 * 2)] = (this.jdField_a_of_type_ArrayOfAlar[i4].jdField_a_of_type_Float * i5);
        this.jdField_c_of_type_ArrayOfFloat[(i1 * 2 + 1)] = (this.jdField_a_of_type_ArrayOfAlar[i4].jdField_b_of_type_Float * i6);
        i1 += 1;
        i2 = i3;
        break;
        if (f3 > 0.6F) {
          localalar1.jdField_a_of_type_Float = ((1.0F - f3) * 2.35F + 0.02F);
        }
      }
  ...
  public void onDrawFrame(GL10 paramGL10)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Alak.jdField_a_of_type_Long == 0L) {
        break;
      }
      while (this.jdField_a_of_type_Alak.c > this.jdField_a_of_type_Alak.jdField_b_of_type_Long)
      {
        paramGL10 = this.jdField_a_of_type_Alak;
      ...
      continue;
      label318:
      if ((this.jdField_a_of_type_Alap != null) && (this.u == 2)) {
        this.jdField_a_of_type_Alap.a(this.jdField_a_of_type_JavaNioFloatBuffer);
      }
    }
  }
  ...
  public void onSurfaceCreated(GL10 paramGL10, EGLConfig paramEGLConfig)
  {
    ...
    a();
    if (alfb.a() != null) {
      this.jdField_a_of_type_Alap.a(BaseApplicationImpl.getContext());
    }
  }
}
