  ...
  implements Runnable
{
  ...
  public ypd(SpriteContext paramSpriteContext, boolean paramBoolean1, boolean paramBoolean2, String paramString)
  {
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ThreadManager.getUIHandler().post(new ype(this, (IApolloRenderView)localObject1));
      return;
