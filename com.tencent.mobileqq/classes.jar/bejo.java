  ...
  extends bejg
{
  ...
  {
    if (!new birs(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, null).a(13)) {}
  ...
  protected void a(@Nullable TofuItem paramTofuItem)
  {
    ...
    if (paramTofuItem != null)
    {
      ...
      ((afqy)localManager).a(String.valueOf(paramTofuItem.frdUin), 0, a());
    }
  }
