  ...
  implements Handler.Callback, Manager
{
  ...
  awxb<bejl, QQAppInterface> jdField_a_of_type_Awxb;
  bejr jdField_a_of_type_Bejr = new bejp(this);
  ...
  public bejo(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper(), this);
    this.jdField_a_of_type_Awxb = new bejq(this);
    this.jdField_a_of_type_JavaUtilSet = Collections.synchronizedSet(new HashSet());
    this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager = paramQQAppInterface.a().createEntityManager();
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Bejr, true);
  }
  ...
  private void a(String paramString, int paramInt)
  {
    ...
    if ((bhnv.a()) && (a(paramString, localList))) {}
  ...
  private void a(boolean paramBoolean, String paramString, List<oidb_0xe61.BeancurdCubeInfoResult> paramList)
  {
    ...
    try
    {
      ...
      a(paramList, new bejh(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localaggr, this.jdField_a_of_type_Awxb));
  ...
  protected List<TofuItem> a(String paramString, int paramInt)
  {
    ...
    ArrayList localArrayList = new ArrayList(bejj.a.length);
    long l = System.currentTimeMillis() / 1000L;
    int i = 0;
    while (i < bejj.a.length)
    {
      beji localbeji = ((bejl)this.jdField_a_of_type_Awxb.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)).a(i);
      ...
      localTofuItem1 = localbeji.a(localTofuItem1, l, paramInt);
  ...
  protected void a(String paramString, List<TofuItem> paramList, boolean paramBoolean)
  {
    ...
    //   3: lstore 4
    //   5: aload_0
    //   6: getfield 82	bejo:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    ...
    //   49: aload_0
    //   50: aload_0
    //   51: getfield 82	bejo:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   54: aload 8
    //   56: invokespecial 346	bejo:a	(Lcom/tencent/mobileqq/persistence/EntityManager;Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   59: pop
    //   60: goto -33 -> 27
    //   63: astore 7
    //   65: ldc 136
    ...
    //   103: ifeq +25 -> 128
    //   106: aload_0
    //   107: getfield 31	bejo:jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache	Lcom/tencent/commonsdk/cache/QQLruCache;
    //   110: astore 6
    //   112: aload 6
    //   114: monitorenter
    //   115: aload_0
    //   116: getfield 31	bejo:jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache	Lcom/tencent/commonsdk/cache/QQLruCache;
    //   119: aload_1
    //   120: aload_2
  ...
  protected boolean a(String paramString, List<TofuItem> paramList)
  {
    ...
    {
      TofuItem localTofuItem = (TofuItem)paramList.next();
      localArrayList.add(((bejl)this.jdField_a_of_type_Awxb.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)).a(localTofuItem.busId).a(localTofuItem));
    }
    ((bejm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(177)).a(paramString, localArrayList);
    return true;
  }
  ...
  protected boolean a(String paramString, List<oidb_0xe61.BeancurdCubeInfoResult> paramList, List<TofuItem> paramList1)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      int i = bejj.b((int)((oidb_0xe61.BeancurdCubeInfo)localBeancurdCubeInfoResult.beancurdCubeInfo.get()).uint64_busi_id.get());
      if (i != -1)
      {
        ...
        bool = true;
        label145:
        ((bejl)this.jdField_a_of_type_Awxb.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)).a(i).a(paramList, localBeancurdCubeInfoResult, l);
      }
    }
    label180:
    label183:
  ...
  public void onDestroy()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Bejr);
    this.jdField_a_of_type_AndroidOsHandler.removeCallbacksAndMessages(null);
    ((bejl)this.jdField_a_of_type_Awxb.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)).a();
  }
}
