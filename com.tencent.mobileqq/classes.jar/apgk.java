  ...
  extends MSFServlet
{
  private void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      notifyObserver(paramIntent, 1, bool1, localBundle, apgj.class);
      return;
      boolean bool1 = false;
      continue;
      bool1 = bool2;
  ...
  private void a(apgi paramapgi, ArrayList<BusinessCard> paramArrayList, Oidb_0x43c.ResponseCardList paramResponseCardList)
  {
  ...
  {
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApp(), apgk.class);
  ...
  private void b(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramFromServiceMsg = (apgi)((QQAppInterface)getAppRuntime()).getManager(112);
      ...
      notifyObserver(paramIntent, 2, bool1, localBundle, apgj.class);
      return;
      bool1 = false;
    }
  }
  ...
  private void c(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      notifyObserver(paramIntent, 3, bool1, localBundle, apgj.class);
      return;
      bool1 = false;
    }
  }
  ...
  private void d(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (bool2)
    {
      try
      {
        ...
        paramFromServiceMsg = (QQAppInterface)getAppRuntime();
        localObject1 = (apgi)paramFromServiceMsg.getManager(112);
        ...
        if (((Oidb_0x43c.CardInfo)localObject2).ocr_info.has()) {
          ((apgi)localObject1).b((BusinessCard)localObject3);
        }
        if (TextUtils.isEmpty(((BusinessCard)localObject3).bindUin)) {
          break label366;
        }
        if (!((amsw)paramFromServiceMsg.getManager(51)).b(((BusinessCard)localObject3).bindUin)) {
          break label446;
        }
        ((apgi)localObject1).a(((BusinessCard)localObject3).bindUin, (BusinessCard)localObject3);
      }
      catch (Exception paramFromServiceMsg)
      {
        for (;;)
        {
          ...
          bool1 = false;
          continue;
          ((apgi)localObject1).b(((BusinessCard)localObject3).bindUin);
          continue;
          bool1 = false;
        }
      }
      if (paramIntent.getIntExtra("key_get_detail_type", 3) == 1) {
        ((apgi)localObject1).a(1, true);
      }
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      notifyObserver(paramIntent, 5, bool1, localBundle, apgj.class);
      return;
      label416:
      ...
      try
      {
        ...
        if ((j == 0) && (((oidb_sso.OIDBSSOPkg)localObject2).bytes_bodybuffer.has()) && (((oidb_sso.OIDBSSOPkg)localObject2).bytes_bodybuffer.get() != null))
        {
          ...
          if (j == i)
          {
            ...
            notifyObserver(paramIntent, 4, false, null, apgj.class);
            return;
          }
          ...
          if (bool)
          {
            ...
            if (((Oidb_0x43c.ResponseCardList)localObject2).mine.has())
            {
              ...
              localBusinessCard.cardType = 1;
              ((apgi)localObject1).a(localBusinessCard);
              ((ArrayList)localObject3).add(localBusinessCard);
            }
          }
          a((apgi)localObject1, (ArrayList)localObject3, (Oidb_0x43c.ResponseCardList)localObject2);
          ((apgi)localObject1).a((List)localObject3, false);
          ...
          ((apgi)localObject1).a(j);
          notifyObserver(paramIntent, 4, true, null, apgj.class);
          return;
        }
      }
      catch (Exception paramFromServiceMsg)
