  ...
  extends pvq
{
  ...
  {
    this.a.b(true);
    raw.a(this.a).a().invoke(Boolean.valueOf(false), Boolean.valueOf(raw.a(this.a)), Integer.valueOf(0));
  }
  
  public void a(boolean paramBoolean, @NotNull String paramString)
  {
    Intrinsics.checkParameterIsNotNull(paramString, "uin");
    if ((Intrinsics.areEqual(paramString, raw.a(this.a).b())) || (Intrinsics.areEqual(paramString, "MATCH_ALL_UIN")))
    {
