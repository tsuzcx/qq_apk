...
{
  swk(swi paramswi, Intent paramIntent, Activity paramActivity) {}
  
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    swi.a(this.jdField_a_of_type_Swi).dismiss();
    if (paramBoolean) {}
    for (;;)
    {
      try
      ...
      catch (Exception paramBundle)
      {
        ...
        QLog.e(swi.a(), 2, paramBundle.getMessage());
        continue;
      ...
      QLog.e(swi.a(), 2, "build struct msg fail");
      return;
