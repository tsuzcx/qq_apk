...
public class anzr
{
  ...
  {
    azmj.b(null, "dc00898", "", "", "0X800AA80", "0X800AA80", anyi.b(this.jdField_a_of_type_Int), 0, String.valueOf(paramInt), "", "", "");
    ...
    if (paramInt == 17039360)
    {
      ...
      if (!TextUtils.isEmpty(paramColorNote.getSubType()))
      {
        i = paramInt;
        str1 = str2;
        if (aroo.a(paramColorNote.getSubType()) == 4)
        {
          str1 = "0X800AA83";
          i = 1;
        }
      }
      switch (arni.a(paramColorNote.getMainTitle()))
      {
      case 5: 
      case 8: 
      default: 
        ...
        azmj.b(null, "dc00898", "", "", str1, str1, paramInt, 0, "", "", "", "");
      }
    }
    do
    {
      ...
      if (paramInt == 17104896)
      {
        ...
        azmj.b(null, "dc00898", "", "", "0X800AA83", "0X800AA83", paramInt, 0, "", "", "", "");
        return;
      }
  ...
  {
    Object localObject = new aoab();
    ArrayList localArrayList = new ArrayList();
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
      localArrayList.add(((aoab)localObject).a(paramContext, (ColorNote)localIterator.next()));
    }
    ...
    while (paramContext.hasNext())
    {
      ...
      ((HistoryFormItem)localObject).setItemOnClickListener(new anzs(this, (HistoryFormItem)localObject));
      ((HistoryFormItem)localObject).setOnIconClickListener(new anzt(this, (HistoryFormItem)localObject));
      i += 1;
    }
  ...
  {
    this.jdField_a_of_type_Anzu = paramanzu;
  }
