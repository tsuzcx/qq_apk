  ...
  extends BusinessHandler
{
  ...
  public anzr(AppInterface paramAppInterface)
  {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, int paramInt, mqq.observer.BusinessObserver paramBusinessObserver)
  {
    ...
    try
    {
      ...
      if ("1".equals(paramString2))
      {
        ...
        if (arrayOfByte != null) {
          localJSONObject.put("chat_sig", new String(bhcu.encode(arrayOfByte, 0)));
        }
      }
      ...
      for (;;)
      {
        ...
        paramString1 = new NewIntent(paramQQAppInterface.getApplication().getApplicationContext(), nta.class);
  ...
  public static void a(NearbyAppInterface paramNearbyAppInterface, long[] paramArrayOfLong, mqq.observer.BusinessObserver paramBusinessObserver)
  {
    ...
    try
    {
      ...
      paramArrayOfLong = new NewIntent(paramNearbyAppInterface.getApplication().getApplicationContext(), nta.class);
  ...
  private void a(Oidb_0x66b.RspBody paramRspBody, NearbyMyTabCard paramNearbyMyTabCard)
  {
    ...
    for (;;)
    {
      ayob.a(this.a, paramNearbyMyTabCard);
    ...
    try
    {
      ...
      if ((paramRspBody1.rpt_msg_uin_data.has()) && (paramRspBody1.rpt_msg_uin_data.size() > 0))
      {
        ...
        if ((paramNearbyMyTabCard.gender == 1) || (paramNearbyMyTabCard.gender == 2)) {
          axqc.a(paramNearbyMyTabCard.uin + "", "self_gender", Integer.valueOf(paramNearbyMyTabCard.gender));
        }
  ...
  private boolean a(oidb_0xada.ReqBody paramReqBody)
  {
    ...
    if ((!TextUtils.isEmpty(str)) && (!TextUtils.isEmpty((CharSequence)localObject)))
    {
      ...
      paramReqBody.version_code.set(arqj.a(BaseApplicationImpl.sApplication));
    ...
    if (paramRspBody.stConfigList.has())
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        else
        {
          ...
          localNearbyMyTabConfig.extraVal = ((NearbyMyTabCard.NearbyMyTabConfigExtraVal)ayob.a.get(Integer.valueOf(localNearbyMyTabConfig.configId)));
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      ...
      paramObject = axqc.a("nearby_visitor_file", this.a.getAccount(), 0).edit();
      if (l1 > 0L)
      {
  ...
  cmd0x77f.VisitProfRec a(axqb paramaxqb)
  {
    cmd0x77f.VisitProfRec localVisitProfRec = new cmd0x77f.VisitProfRec();
    localVisitProfRec.uint64_tinyid.set(paramaxqb.jdField_a_of_type_Long);
    localVisitProfRec.uint32_seq.set(paramaxqb.jdField_a_of_type_Int);
    if (paramaxqb.c > 0) {
      localVisitProfRec.uint32_enter_count.set(paramaxqb.c);
    }
    if (paramaxqb.d > 0) {
      localVisitProfRec.uint32_visit_duration.set(paramaxqb.d);
    }
    if (paramaxqb.e > 0) {
      localVisitProfRec.uint32_visit_pic_count.set(paramaxqb.e);
    }
    if (paramaxqb.f > 0) {
      localVisitProfRec.uint32_opflag.set(paramaxqb.f);
    }
    if (QLog.isColorLevel()) {
      QLog.d("NearbyHandler", 2, "convert2VisitRec ,record =" + paramaxqb);
    }
  ...
  public void a(FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      ...
      if (paramToServiceMsg.msg_self_info.has())
      {
        ...
        ((aqww)this.a.getManager(axoc.f)).a(this.a, paramObject);
        if (QLog.isColorLevel()) {
  ...
  public void a(String paramString)
  {
    ...
    localQueryRecommendReq.uint32_client_version.set(arqj.a(BaseApplicationImpl.sApplication));
  ...
  public void a(List<axqb> paramList, boolean paramBoolean)
  {
    int j = 0;
    ...
    if (k <= 200)
    {
      ...
      for (int i = 1;; i = 0)
      {
        ...
        ((cmd0x77f.ReqBody)localObject1).uint32_list_ruleid.set(((axqb)paramList.get(0)).b);
        i = j;
        while (i < k)
        {
          localObject2 = a((axqb)paramList.get(i));
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (paramFromServiceMsg = "0";; paramFromServiceMsg = "-1")
    {
      ...
      paramObject.put("param_DeviceType", String.valueOf(aklj.a()));
    ...
    do
    {
      do
      {
        ...
        if ("NeighborSvc.ReqGetPoint".equals(str))
        {
          ...
          for (int i = 5;; i = 6)
          {
            anzn.a(this, i, paramToServiceMsg, paramFromServiceMsg, paramObject);
            return;
          }
        }
        if ("OidbSvc.0x9c7_0".equals(str))
        {
          anzn.c(this, 10, paramToServiceMsg, paramFromServiceMsg, paramObject);
          return;
        }
        if ("OidbSvc.0x686".equals(str))
        {
          anzn.b(this, 8, paramToServiceMsg, paramFromServiceMsg, paramObject);
          return;
        }
