  ...
  extends BaseJsPlugin
{
  ...
  {
    MiniAppController.getInstance().setActivityResultListener(new bkul(this, paramRequestEvent));
    ...
    paramRequestEvent.fail(anzj.a(2131704254));
  }
  ...
  public void getMultiMemList(RequestEvent paramRequestEvent)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramRequestEvent)
      {
        ...
        return;
        paramRequestEvent.fail(anzj.a(2131704255));
        return;
        if (localJSONObject != null) {
          continue;
        }
      ...
      {
        paramRequestEvent.fail(anzj.a(2131704256));
        return;
