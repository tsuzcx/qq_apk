...
public class bkuk
{
  ...
  private CopyOnWriteArrayList<bkum> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  
  public bkuk()
  {
    bkvm.a("MobileQQprotect.QSecCb", new bkul(this));
    a();
  }
  ...
  private String a()
  {
    return bkst.a() + File.separator + "QSecCb.dat";
  }
  
  private void a()
  {
    byte[] arrayOfByte = new bkvi().a(a(), null, 1);
    if (arrayOfByte != null) {
      a(arrayOfByte);
    }
  }
  ...
  private void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramString)
      {
        ...
        ((bkum)paramString.next()).a(localLinkedList);
        continue;
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    //   37: astore_1
    //   38: aload_0
    //   39: getfield 18	bkuk:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   42: iload_3
  ...
  private byte[] a()
  {
    ...
    //   16: astore 4
    //   18: aload_0
    //   19: getfield 18	bkuk:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
  ...
  private void b()
  {
    byte[] arrayOfByte = a();
    if (arrayOfByte != null) {
      new bkvi().a(a(), arrayOfByte, null, 1);
    }
  }
  ...
  public void a(bkum parambkum)
  {
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(parambkum);
  }
  ...
  public void a(boolean paramBoolean)
  {
    try
    {
      ...
      bkvm.a("MobileQQprotect.QSecCb", localQSecCbQuery.toByteArray());
      return;
    }
