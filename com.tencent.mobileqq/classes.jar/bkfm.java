  ...
  extends BroadcastReceiver
{
  ...
  public bkfm(VipComicJumpActivity paramVipComicJumpActivity) {}
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if (((!TextUtils.isEmpty(str)) && ("com.tencent.mobileqq.PreLoadComicProcess".equals(str))) || ((paramContext != null) && (paramContext.equals("com.qqcomic.app.VipPreloadComicProcess")))) {
      if (!this.jdField_a_of_type_CooperationComicVipComicJumpActivity.b)
      {
        ...
        this.jdField_a_of_type_CooperationComicVipComicJumpActivity.jdField_a_of_type_Bjng.removeMessages(1000);
        ...
        this.jdField_a_of_type_CooperationComicVipComicJumpActivity.c(this.jdField_a_of_type_CooperationComicVipComicJumpActivity.jdField_a_of_type_Bkfk);
      }
    }
    ...
    if ((this.b != null) && ("success".equals(this.b))) {
      this.jdField_a_of_type_CooperationComicVipComicJumpActivity.a(this.jdField_a_of_type_CooperationComicVipComicJumpActivity.jdField_a_of_type_Bkfk, 0);
    }
    for (;;)
    {
      ...
      return;
      this.jdField_a_of_type_CooperationComicVipComicJumpActivity.a(this.jdField_a_of_type_CooperationComicVipComicJumpActivity.jdField_a_of_type_Bkfk, -2);
      if (QLog.isColorLevel()) {
