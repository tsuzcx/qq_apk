  ...
  implements Manager
{
  ...
  public anxm(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_ArrayOfInt = new int[] { 0, 1 };
  }
  
  public static anxm a(QQAppInterface paramQQAppInterface)
  {
    return (anxm)paramQQAppInterface.getManager(371);
  }
  ...
  {
    this.jdField_a_of_type_AndroidWidgetCompoundButton$OnCheckedChangeListener = new anxn(this, paramBaseActivity, paramFormSwitchItem);
