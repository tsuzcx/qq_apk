...
public class asjh
{
  private static volatile asjh jdField_a_of_type_Asjh;
  ...
  public static asjh a()
  {
    if (jdField_a_of_type_Asjh == null) {}
    try
    {
      if (jdField_a_of_type_Asjh == null) {
        jdField_a_of_type_Asjh = new asjh();
      }
      return jdField_a_of_type_Asjh;
    }
    finally {}
  }
  ...
  public boolean a()
  {
    ...
    for (;;)
    {
      try
      {
        bool1 = bhgk.a(this.jdField_a_of_type_ComTencentMobileqqMinigameManagerInstalledEngine.engineDir + File.separator + "liteavsdk.jar", BaseApplicationImpl.getApplication().getApplicationContext(), getClass().getClassLoader(), "com.tencent.rtmp.ui.TXCloudVideoView", null, false);
        if (bool1)
        {
      ...
      catch (Exception localException)
      {
        ...
        if ((bool1) && (this.jdField_a_of_type_ComTencentMobileqqMinigameManagerInstalledEngine != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqMinigameManagerInstalledEngine.engineDir)))
        {
          ...
          bhnv.a("com.tencent.rtmp.TXLiveBase", "setLibraryPath", false, bhnv.a(new Class[] { String.class }), new Object[] { this.jdField_a_of_type_ComTencentMobileqqMinigameManagerInstalledEngine.engineDir });
        }
        return bool1;
      }
      boolean bool3 = false;
