  ...
  extends aafe
{
  ...
  private bbod jdField_a_of_type_Bbod;
  private final AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface;
  
  public bbno(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_Bbod = new bbod(paramAppInterface);
    this.jdField_a_of_type_Bbje = new bbje(paramAppInterface);
  }
  ...
  private boolean e(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    if (bool)
    {
      ...
      while (paramToServiceMsg.hasNext())
      {
        ...
        localObject = (bbnm)((Map.Entry)localObject).getValue();
        if ((((bbnm)localObject).a() & i) != 0)
        {
          localObject = ((bbnm)localObject).a(i);
          if (localObject != null)
          {
            if (QLog.isColorLevel()) {
    ...
    paramToServiceMsg = (bbnm)((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface).mAutomator.a().get(Integer.valueOf(101));
  ...
  private boolean p(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    amsw localamsw = (amsw)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(51);
  ...
  public Object a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    case 30: 
      return this.jdField_a_of_type_Bbod.a(paramToServiceMsg, paramFromServiceMsg);
    }
    return this.jdField_a_of_type_Bbje.a(paramToServiceMsg, paramFromServiceMsg);
  }
  ...
  public boolean b(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    case 30: 
      return this.jdField_a_of_type_Bbod.a(paramToServiceMsg, paramUniPacket);
    }
    return this.jdField_a_of_type_Bbje.a(paramToServiceMsg, paramUniPacket);
  }
}
