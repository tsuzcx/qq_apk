  ...
  extends bbnk
{
  ...
  public void onDestroy()
  {
    ...
    if ((this.jdField_a_of_type_AndroidGraphicsBitmap != null) && (!this.jdField_a_of_type_AndroidGraphicsBitmap.isRecycled()))
    {
      ...
      ykq.b("Q.qqstory.publish.edit GPULordKelvinFilter", "mosaic bitmap recycle");
    }
  }
  ...
  public void onInitialized()
  {
    ...
    for (;;)
    {
      try
      {
        localInputStream = BaseApplicationImpl.getContext().getResources().openRawResource(2130846108);
      ...
      catch (OutOfMemoryError localOutOfMemoryError)
      {
        ...
        ykq.e("Q.qqstory.publish.edit GPULordKelvinFilter", "OutOfMemoryError:%s", new Object[] { localOutOfMemoryError.getMessage() });
