...
public class ayex
  extends ayer
{
  public ayex(TeamWorkFileImportInfo paramTeamWorkFileImportInfo, QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    Object localObject1;
    Object localObject2;
    if ((this.jdField_a_of_type_ComTencentMobileqqTeamworkTeamWorkFileImportInfo != null) && (paramQQAppInterface != null) && (this.jdField_a_of_type_Ayeo != null))
    {
      localObject3 = ayec.a(this.jdField_a_of_type_ComTencentMobileqqTeamworkTeamWorkFileImportInfo);
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          catch (JSONException localJSONException)
          {
            ...
            this.jdField_a_of_type_Ayeo.b(paramQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTeamworkTeamWorkFileImportInfo);
            return;
            this.jdField_a_of_type_Ayeo.a(paramQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTeamworkTeamWorkFileImportInfo);
            return;
          }
          ...
          this.jdField_a_of_type_Ayeo.b(this.jdField_a_of_type_ComTencentMobileqqTeamworkTeamWorkFileImportInfo);
          this.jdField_a_of_type_Ayeo.c(paramQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTeamworkTeamWorkFileImportInfo);
          return;
          if (!TextUtils.isEmpty((CharSequence)localObject2)) {
            break label596;
          }
          if (TextUtils.isEmpty(str2))
          {
            ...
            localObject1 = ayfh.a((String)localObject1);
            break;
          }
          localObject1 = str2;
          break;
