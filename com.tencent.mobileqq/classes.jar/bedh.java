  ...
  extends bedi
{
  ...
  public bedh(TraeAudioManager paramTraeAudioManager)
  {
  ...
  public boolean a(Context paramContext, bedj parambedj)
  {
    ...
    if ((this.jdField_a_of_type_AndroidContentContext == null) || (this.jdField_a_of_type_Bedj == null)) {}
    for (;;)
    {
      return false;
      try
      ...
      catch (Exception parambedj)
      {
        ...
        catch (Exception parambedj)
        {
          ...
          catch (NoSuchMethodException parambedj)
          {
            try
            {
              do
              {
                for (;;)
                {
                  ...
                  this.jdField_a_of_type_Bedj.a("DEVICE_BLUETOOTHHEADSET", a());
                  if (!a()) {
                    break label337;
                  }
                  this.jdField_a_of_type_Bedj.a("DEVICE_BLUETOOTHHEADSET", true);
                  ...
                  if (QLog.isColorLevel())
                  {
                    ...
                    parambedj = parambedj;
                    if (QLog.isColorLevel()) {
                      QLog.e("TraeAudioManager", 2, "BTLooperThread BluetoothHeadset.ServiceListener class not found:" + parambedj);
                    }
                  }
                }
                parambedj = parambedj;
