  ...
  implements baxl, scl
{
  ...
  public sbx(Activity paramActivity, QQAppInterface paramQQAppInterface, XListView paramXListView, LayoutInflater paramLayoutInflater)
  {
  ...
  private void a(sbz paramsbz, String paramString)
  {
    Bitmap localBitmap = (Bitmap)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    if (localBitmap == null)
    {
      paramsbz.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.jdField_a_of_type_Ahnt.a(1008, paramString));
      return;
    }
    paramsbz.jdField_a_of_type_AndroidWidgetImageView.setImageBitmap(localBitmap);
  }
  ...
  public void a()
  {
    ...
    if (this.j > 0) {
      axqw.b(null, "CliOper", "", "", "0X8006154", "0X8006154", 0, this.j, 0, "", "", "", "");
    }
    ...
    this.jdField_a_of_type_Scu = null;
  ...
  public void a(sci paramsci)
  {
    this.jdField_a_of_type_Sci = paramsci;
  }
  
  public void a(scu paramscu)
  {
  ...
  {
    if (paramImageView.getTag(2131376687).equals(Integer.valueOf(jdField_b_of_type_Int))) {
      return true;
    }
    if (paramImageView.getTag(2131376687).equals(Integer.valueOf(jdField_a_of_type_Int)))
    {
      ...
      if (k < m)
      {
        ...
        if ((localObject == null) || (!(localObject instanceof sbz))) {}
        while (!((sbz)localObject).jdField_a_of_type_JavaLangString.equals(paramImageView.getTag(2131376688)))
        {
          k += 1;
          break;
        }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      ...
      {
        paramViewGroup = new sbz(this);
        paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131560108, null);
        paramViewGroup.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)paramView.findViewById(2131376676));
        paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131376690));
        paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131376695));
        paramViewGroup.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131375097));
        paramViewGroup.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView = ((DragTextView)paramView.findViewById(2131378645));
        ...
        paramViewGroup.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131369932));
        paramViewGroup.jdField_b_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131369938));
        paramViewGroup.jdField_c_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131369937));
        paramViewGroup.d = ((Button)paramView.findViewById(2131369916));
    ...
    for (Object localObject1 = paramView;; localObject1 = paramView)
    {
      if (localObject1 == null)
      {
        ...
        {
          paramViewGroup = new sca(this, null);
          ...
          for (k = 2131165980;; k = 2131165981)
          {
            ...
            while (k < n)
            {
              ...
              ((TextView)((ViewGroup)localObject1).findViewById(2131362828)).setTextColor(i1);
              k += 1;
            }
            k = 2130842623;
            break;
        ...
        paramViewGroup = new scb(this, null);
        paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131560112, null);
        this.jdField_a_of_type_Scu.a(paramView);
        this.jdField_a_of_type_Scu.b();
      ...
      if (m == jdField_a_of_type_Int)
      {
        ((View)localObject1).setTag(2131376682, Integer.valueOf(paramInt));
        paramView = (sbz)((View)localObject1).getTag();
        paramViewGroup = (sdd)getItem(paramInt);
        ...
        localObject2 = sdf.a().a(paramViewGroup.jdField_a_of_type_JavaLangString);
        if (TextUtils.isEmpty((CharSequence)localObject2))
        {
          paramView.jdField_a_of_type_AndroidWidgetTextView.setText(paramViewGroup.jdField_a_of_type_JavaLangString);
          paramView.jdField_b_of_type_AndroidWidgetTextView.setText(ahpl.a().a(paramViewGroup.jdField_a_of_type_JavaLangString, paramViewGroup.jdField_a_of_type_Long));
          if (paramViewGroup.jdField_b_of_type_Int <= 0) {
            break label1304;
          }
          k = 3;
          bfqb.a(paramView.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView, k, paramViewGroup.jdField_b_of_type_Int, 2130849292, 99, null);
          if (paramViewGroup.jdField_a_of_type_JavaUtilList.size() <= 0) {
            break label1659;
          }
          localObject3 = (sde)paramViewGroup.jdField_a_of_type_JavaUtilList.get(0);
          if (((sde)localObject3).jdField_a_of_type_Int != 0) {
            break label1310;
          }
          paramView.jdField_c_of_type_AndroidWidgetTextView.setMaxLines(1);
          paramView.jdField_c_of_type_AndroidWidgetTextView.setText(new ayki(((sde)localObject3).c.replaceFirst("^\\s+", ""), 3, 20));
          ...
          label1080:
          paramView.jdField_a_of_type_AndroidViewViewGroup.setTag(2131376679, Integer.valueOf(paramViewGroup.jdField_b_of_type_Int));
          paramView.jdField_a_of_type_AndroidViewViewGroup.setTag(2131376688, paramViewGroup.jdField_a_of_type_JavaLangString);
          paramView.jdField_a_of_type_AndroidViewViewGroup.setTag(2131376681, localObject2);
          paramView.jdField_a_of_type_AndroidViewViewGroup.setTag(2131376680, Integer.valueOf(jdField_d_of_type_Int));
          paramView.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setTag(2131376679, paramViewGroup);
          paramView.jdField_a_of_type_AndroidWidgetButton.setTag(2131376688, paramViewGroup.jdField_a_of_type_JavaLangString);
          paramView.jdField_b_of_type_AndroidWidgetButton.setTag(2131376688, paramViewGroup.jdField_a_of_type_JavaLangString);
          paramView.jdField_c_of_type_AndroidWidgetButton.setTag(2131376688, paramViewGroup.jdField_a_of_type_JavaLangString);
          paramView.jdField_c_of_type_AndroidWidgetButton.setTag(2131376681, localObject2);
          paramView.d.setTag(2131376688, paramViewGroup.jdField_a_of_type_JavaLangString);
          if (sdf.a().a(paramViewGroup.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
            break label1697;
          }
          if (this.jdField_c_of_type_Boolean) {
            break label1684;
          }
          paramView.jdField_a_of_type_AndroidViewViewGroup.setBackgroundResource(2130842618);
          label1247:
      ...
      for (;;)
      {
        ...
        if (((sde)localObject3).jdField_a_of_type_Int == 1)
        {
          paramView.jdField_c_of_type_AndroidWidgetTextView.setMaxLines(2);
          paramView.jdField_c_of_type_AndroidWidgetTextView.setText(((sde)localObject3).b.replaceFirst("^\\s+", ""));
          paramView.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
          if (TextUtils.isEmpty(((sde)localObject3).g)) {
            paramView.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
          }
          for (;;)
          {
            paramView.jdField_b_of_type_AndroidWidgetImageView.setTag(2131376688, paramView.jdField_a_of_type_JavaLangString);
            paramView.jdField_b_of_type_AndroidWidgetImageView.setTag(2131376687, Integer.valueOf(jdField_a_of_type_Int));
            localLayoutParams = paramView.jdField_b_of_type_AndroidWidgetImageView.getLayoutParams();
            this.jdField_a_of_type_Sci.a(sfd.a(((sde)localObject3).jdField_a_of_type_JavaLangString, 1, paramViewGroup.jdField_a_of_type_JavaLangString), paramView.jdField_b_of_type_AndroidWidgetImageView, localLayoutParams.width, localLayoutParams.height, this);
        ...
        if (((sde)localObject3).jdField_a_of_type_Int == 2)
        {
          paramView.jdField_c_of_type_AndroidWidgetTextView.setMaxLines(1);
          paramView.jdField_c_of_type_AndroidWidgetTextView.setText(2131696798);
          paramView.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
          paramView.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
          paramView.jdField_b_of_type_AndroidWidgetImageView.setTag(2131376688, paramView.jdField_a_of_type_JavaLangString);
          paramView.jdField_b_of_type_AndroidWidgetImageView.setTag(2131376687, Integer.valueOf(jdField_a_of_type_Int));
          localLayoutParams = paramView.jdField_b_of_type_AndroidWidgetImageView.getLayoutParams();
          this.jdField_a_of_type_Sci.a(sfd.a(((sde)localObject3).jdField_a_of_type_JavaNetURL.toString(), 1, paramViewGroup.jdField_a_of_type_JavaLangString), paramView.jdField_b_of_type_AndroidWidgetImageView, localLayoutParams.width, localLayoutParams.height, this);
          break label1080;
        }
        paramView.jdField_c_of_type_AndroidWidgetTextView.setMaxLines(1);
        ...
        if (m == jdField_b_of_type_Int)
        {
          ((View)localObject1).setTag(2131376682, Integer.valueOf(paramInt));
          this.j += 1;
          paramView = (sca)((View)localObject1).getTag();
          ...
          while (paramInt < k)
          {
            ...
            paramViewGroup = (TextView)((ViewGroup)localObject2).findViewById(2131362828);
            localObject2 = (ImageView)((ViewGroup)localObject2).findViewById(2131362827);
            if (paramInt < this.jdField_b_of_type_JavaUtilList.size())
            {
              ...
              ((ImageView)localObject2).setTag(2131376687, Integer.valueOf(jdField_b_of_type_Int));
              paramViewGroup = (WindowManager)this.jdField_a_of_type_AndroidAppActivity.getSystemService("window");
              this.jdField_a_of_type_Sci.a(sfd.a(((ReadInJoyArticle)localObject3).mFirstPagePicUrl, 1), (ImageView)localObject2, paramViewGroup.getDefaultDisplay().getWidth(), paramViewGroup.getDefaultDisplay().getHeight(), this);
            }
            paramInt += 1;
          }
        }
  ...
  public void onDecodeTaskCompleted(int paramInt1, int paramInt2, String paramString, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      ...
      while (paramInt1 < paramInt2)
      {
        ...
        if ((paramBitmap != null) && ((paramBitmap instanceof sbz)))
        {
          paramBitmap = (sbz)paramBitmap;
