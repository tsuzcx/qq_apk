...
public final class azkz
{
  ...
  public azkz(@NotNull String paramString, @NotNull List<String> paramList)
  {
  ...
  @NotNull
  public final azkz a(@Nullable String paramString)
  {
  ...
  public boolean equals(@Nullable Object paramObject)
  {
    if (this != paramObject)
    {
      if ((paramObject instanceof azkz))
      {
        paramObject = (azkz)paramObject;
