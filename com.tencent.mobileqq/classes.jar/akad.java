...
public class akad
{
  private static final String jdField_a_of_type_JavaLangString = amtj.a(2131704564);
  private int jdField_a_of_type_Int = -1;
  private akaa jdField_a_of_type_Akaa = akac.a(jdField_a_of_type_JavaLangString);
  private amuo jdField_a_of_type_Amuo;
  private AdapterView.OnItemClickListener jdField_a_of_type_AndroidWidgetAdapterView$OnItemClickListener = new akag(this);
  private SendHbActivity jdField_a_of_type_ComTencentMobileqqActivityQwalletSendHbActivity;
  private IRedPacket.OnGetSkinListener jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketIRedPacket$OnGetSkinListener = new akaf(this);
  private QwAdapter jdField_a_of_type_CooperationQwalletPluginQwAdapter;
  List<akak> jdField_a_of_type_JavaUtilList = new ArrayList();
  private BusinessObserver jdField_a_of_type_MqqObserverBusinessObserver = new akae(this);
  private boolean jdField_a_of_type_Boolean;
  private int jdField_b_of_type_Int = -1;
  private List<akaa> jdField_b_of_type_JavaUtilList = new ArrayList();
  private boolean jdField_b_of_type_Boolean;
  private List<LinearLayout> c = new ArrayList();
  
  public akad(SendHbActivity paramSendHbActivity)
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletSendHbActivity = paramSendHbActivity;
    d();
  }
  
  private void a(List<akaa> paramList)
  {
    paramList.add(akac.b(jdField_a_of_type_JavaLangString));
    if ((b()) && (!paramList.contains(this.jdField_a_of_type_Akaa)))
    {
      QLog.d("HbSkinLogic", 2, "add vip info to list!");
      paramList.add(this.jdField_a_of_type_Akaa);
    }
  }
  
  private void b(List<akaa> paramList)
  {
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      SkinInfo localSkinInfo = ((akaa)paramList.next()).jdField_a_of_type_WalletSkinInfo;
      ...
      localRedPacketInfoBase.isCache = akaa.jdField_a_of_type_Boolean;
  ...
  private boolean b()
  {
    if (this.jdField_a_of_type_Amuo != null) {
      return this.jdField_a_of_type_Amuo.a();
    }
    return false;
  }
  ...
  private void d()
  {
    ...
    a(localArrayList);
    this.jdField_a_of_type_CooperationQwalletPluginQwAdapter = new QwAdapter(this.jdField_a_of_type_ComTencentMobileqqActivityQwalletSendHbActivity, localArrayList, 2131560496, new akaj(this));
    this.jdField_a_of_type_Amuo = ((amuo)this.jdField_a_of_type_ComTencentMobileqqActivityQwalletSendHbActivity.getAppRuntime().getManager(131));
  ...
  public int a()
  {
    return akaa.a(this.jdField_a_of_type_CooperationQwalletPluginQwAdapter.getList());
  }
  ...
  {
    this.jdField_a_of_type_JavaUtilList.add(paramakak);
  }
  ...
  public void b()
  {
    ...
    if (-2 != i)
    {
      ...
      if (this.jdField_a_of_type_Amuo != null) {
        this.jdField_a_of_type_Amuo.a(0, 0, true);
      }
    }
  }
  ...
  public void c()
  {
    ...
    if (b()) {
      if (!localList.contains(this.jdField_a_of_type_Akaa))
      {
        QLog.d("HbSkinLogic", 2, "add vip info to list!");
        localList.add(this.jdField_a_of_type_Akaa);
        akaa.c = this.jdField_a_of_type_Akaa.jdField_a_of_type_WalletSkinInfo.skin_id;
        akaa.a(localList);
        this.jdField_a_of_type_CooperationQwalletPluginQwAdapter.notifyDataSetChanged();
      }
    }
    while (!localList.contains(this.jdField_a_of_type_Akaa)) {
      return;
    }
    QLog.d("HbSkinLogic", 2, "remove vip info to list!");
    localList.remove(this.jdField_a_of_type_Akaa);
    akaa.c = 0;
    akaa.a(localList);
    this.jdField_a_of_type_CooperationQwalletPluginQwAdapter.notifyDataSetChanged();
  }
