  ...
  extends LinearLayout
{
  ...
  public oow(Context paramContext, int paramInt1, int paramInt2, float paramFloat, View.OnClickListener paramOnClickListener)
  {
    super(paramContext);
  ...
  private void a()
  {
    ...
    while (i < this.b)
    {
      View localView = LayoutInflater.from(getContext()).inflate(2130970778, null);
  ...
  public void a(LocationFacePackage paramLocationFacePackage, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 == paramInt2 - 1)
    {
      ...
      localURLImageView = (URLImageView)((View)localObject3).findViewById(2131364412);
      localTextView = (TextView)((View)localObject3).findViewById(2131364411);
      localObject2 = (ProgressBar)((View)localObject3).findViewById(2131364413);
    ...
    for (;;)
    {
      ...
      localObject3 = (Boolean)localURLImageView.getTag(2131362364);
      if ((localObject3 != null) && (((Boolean)localObject3).booleanValue()) && (((String)localObject1).equals(localURLImageView.getTag(2131362363))))
      {
      ...
      else
      {
        ...
        localObject2 = new oox((String)localObject1, localURLImageView, (ProgressBar)localObject2);
        ...
        if (((URLDrawable)localObject1).getStatus() == 1) {
          ((oox)localObject2).onLoadSuccessed(localURLImageView, (URLDrawable)localObject1);
        }
