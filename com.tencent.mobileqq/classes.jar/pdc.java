...
public class pdc
{
  private static pdc jdField_a_of_type_Pdc;
  private int jdField_a_of_type_Int;
  private DecimalFormat jdField_a_of_type_JavaTextDecimalFormat = new DecimalFormat("0.00");
  private ConcurrentHashMap<Integer, WeakReference<oqg>> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  
  public static pdc a()
  {
    if (jdField_a_of_type_Pdc == null) {
      jdField_a_of_type_Pdc = new pdc();
    }
    return jdField_a_of_type_Pdc;
  }
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      ...
      localObject = (oqg)((WeakReference)localObject).get();
    } while (localObject == null);
    ((oqg)localObject).a(paramToServiceMsg, paramFromServiceMsg, paramObject);
  }
  ...
  private boolean a(ToServiceMsg paramToServiceMsg)
  {
    int i;
    int k;
    if (paramToServiceMsg.getAttribute(oqg.f) != null)
    {
      i = ((Integer)paramToServiceMsg.getAttribute(oqg.f)).intValue();
      if (i == 2)
      {
        k = 1;
  ...
  public void a(ToServiceMsg paramToServiceMsg)
  {
    ...
    obz.a().post(paramToServiceMsg);
  }
  
  public final void a(ToServiceMsg paramToServiceMsg, oqg paramoqg)
  {
    if ((paramToServiceMsg == null) || (paramoqg == null)) {
      return;
    }
    paramToServiceMsg.extraData.putBoolean("req_pb_protocol_flag", true);
    paramoqg = new WeakReference(paramoqg);
    obz.a().post(new ReadInJoyMSFService.1(this, paramToServiceMsg, paramoqg));
    a(paramToServiceMsg);
  }
    ...
    for (;;)
    {
      ...
      if (paramFromServiceMsg.getResultCode() == 2008)
      {
        ...
        if (paramFromServiceMsg == null) {
          paramToServiceMsg = obz.a().getApplication();
        }
