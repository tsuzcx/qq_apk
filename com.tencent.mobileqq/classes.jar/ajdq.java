...
public class ajdq
  extends ajtd
{
  public ajdq(AppInterface paramAppInterface)
  {
  ...
  public void a(int paramInt, String paramString, ArrayList<ajcy> paramArrayList)
  {
    if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      {
        ajcy localajcy = (ajcy)paramArrayList.next();
        STCommon.STLocalCVerInfo localSTLocalCVerInfo = new STCommon.STLocalCVerInfo();
        localSTLocalCVerInfo.busId.set(localajcy.jdField_a_of_type_Int);
        localSTLocalCVerInfo.itemId.set(localajcy.jdField_a_of_type_JavaLangString);
        localSTLocalCVerInfo.localVer.set(localajcy.jdField_b_of_type_Int);
    ...
    paramArrayList = new NewIntent(this.mApp.getApp(), ajdr.class);
  ...
  public void a(ReportInfoManager.ReportChannlInfo paramReportChannlInfo)
  {
    ...
    try
    {
      ...
      paramReportChannlInfo = new NewIntent(this.mApp.getApp(), ajdr.class);
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, long paramLong1, String paramString2, byte[] paramArrayOfByte, long paramLong2)
  {
    ...
    try
    {
      ...
      paramString2 = new NewIntent(this.mApp.getApp(), ajdr.class);
  ...
  public void a(String paramString, int paramInt, long paramLong)
  {
    ...
    try
    {
      ...
      localObject = new NewIntent(this.mApp.getApp(), ajdr.class);
      ...
      if (("apollo_game_av.get_usraccinfo".equals(paramString)) && (paramArrayOfByte != null) && (paramFromServiceMsg.isSuccess()))
      {
        ...
        try
        {
          ...
          if ((paramArrayOfByte != null) && (paramArrayOfByte.size() > 0))
          {
            ...
            paramIntent = ajae.a(paramIntent.getIntExtra("gameId", -1));
            if (paramIntent != null)
            {
  ...
  public void a(String paramString1, String paramString2, long paramLong, int paramInt, boolean paramBoolean, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        paramArrayOfByte = new NewIntent(this.mApp.getApp(), ajdr.class);
  ...
  public void b(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      {
        ((ajdh)localObject1).c(paramFromServiceMsg.getResultCode(), paramIntent);
        return;
      }
    }
    ...
    {
      ((ajdh)localObject1).c(paramArrayOfByte.subCode.get(), paramIntent);
      return;
    }
    Object localObject2 = new ajdg();
    if (paramArrayOfByte.updateFlag.get() == 1)
    {
      bool = true;
      ((ajdg)localObject2).jdField_a_of_type_Boolean = bool;
    ...
    {
      ((ajdg)localObject2).jdField_b_of_type_Boolean = bool;
      ((ajdg)localObject2).jdField_a_of_type_Int = paramArrayOfByte.svrVer.get();
      ((ajdg)localObject2).jdField_b_of_type_Int = i;
      ((ajdg)localObject2).jdField_d_of_type_JavaLangString = paramArrayOfByte.url.get();
      ((ajdg)localObject2).c = paramArrayOfByte.md5.get();
      ((ajdg)localObject2).jdField_a_of_type_ArrayOfByte = paramArrayOfByte.patchContent.get().toByteArray();
      ((ajdg)localObject2).e = paramArrayOfByte.patchUrl.get();
      ((ajdg)localObject2).jdField_b_of_type_Long = paramArrayOfByte.packageSize.get();
      ((ajdg)localObject2).jdField_a_of_type_Long = paramArrayOfByte.tipsSize.get();
      ((ajdg)localObject2).jdField_a_of_type_JavaLangString = paramArrayOfByte.itemId.get();
      ((ajdg)localObject2).jdField_b_of_type_JavaLangString = paramIntent;
      ((ajdg)localObject2).jdField_d_of_type_Int = 1;
      ((ajdh)localObject1).a((ajdg)localObject2);
      return;
      bool = false;
      break;
    }
  ...
  public void c(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    if ((localajcq == null) || (localajcq.a() == null))
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramFromServiceMsg.isSuccess())
        {
          ...
          if (i < paramFromServiceMsg.length())
          {
            ...
            localObject1 = new aiyq(((JSONObject)localObject1).optString("icon"), (String)localObject2, paramArrayOfByte);
            localajcq.a().updateUserInfo((aiyq)localObject1);
            if (j == ajbq.jdField_a_of_type_Int) {
              localajcq.a().getOpenApiHead(l, paramArrayOfByte);
            } else if (j == ajbq.jdField_b_of_type_Int) {
              localajcq.a().getOpenApiNick(l, paramArrayOfByte);
            }
          }
        }
      }
      ...
      for (;;)
      {
        try
        {
          ...
          localajcq.a().nativeOpenApiGetHeadCallBack(l, paramFromServiceMsg.getString(0), -1, 0, 0, null);
        ...
        localajcq.a().callbackFromRequest(l, 0, "cs.preload_userInfoList.local", paramFromServiceMsg.toString());
        return;
        if (j == ajbq.jdField_a_of_type_Int)
        {
          paramIntent = new JSONObject(str).optJSONArray("uidList");
          localajcq.a().nativeOpenApiGetHeadCallBack(l, paramIntent.getString(0), paramFromServiceMsg.getResultCode(), 0, 0, null);
          QLog.e("cmgame_process.CmGameSSoHandler", 1, "GET_OPENID_INFO_FROM_HEAD error openid=" + paramIntent.getString(0));
          return;
        }
        if (j == ajbq.jdField_b_of_type_Int)
        {
          paramIntent = new JSONObject(str).optJSONArray("uidList");
          localajcq.a().nativeOpenApiGetNickCallBack(l, paramIntent.getString(0), paramFromServiceMsg.getResultCode(), null);
        ...
        localajcq.a().callbackFromRequest(l, paramFromServiceMsg.getResultCode(), "cs.preload_userInfoList.local", paramIntent.toString());
        ...
        {
          paramFromServiceMsg = new JSONObject(str).optJSONArray("uidList");
          localajcq.a().nativeOpenApiGetNickCallBack(l, paramFromServiceMsg.getString(0), -1, null);
          QLog.e("cmgame_process.CmGameSSoHandler", 1, "GET_OPENID_INFO_FROM_NICK error openid=" + paramFromServiceMsg.getString(0));
        }
        else if (j == ajbq.c)
        {
          localajcq.a().callbackFromRequest(l, -1, "cs.preload_userInfoList.local", "{}");
          QLog.e("cmgame_process.CmGameSSoHandler", 1, "GET_OPENID_INFO_FROM_PRELOAD error ");
        }
      }
      label859:
  ...
  public void d(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        do
        {
          for (;;)
          {
            ...
            try
            {
              ...
              if (i == 4)
              {
                localajcq.a().callbackFromRequest(l, (int)localUniSsoServerRsp.ret.get(), str3, paramArrayOfByte);
                return;
              }
            }
            catch (Throwable paramArrayOfByte)
            {
              ...
              try
              {
                ...
                if (i == 4)
                {
                  localajcq.a().callbackFromRequest(l, paramFromServiceMsg.getResultCode(), paramIntent, "{}");
                  return;
                }
              }
        ...
        paramArrayOfByte = ajae.a(localJSONObject1.optInt("gameId"));
    ...
    localajcq.a().callbackFromRequest(l, paramFromServiceMsg.getResultCode(), str3, "{}");
  }
