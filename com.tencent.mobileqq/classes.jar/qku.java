...
public class qku
{
  ...
  public static long a(qxs paramqxs)
  {
    if (!a())
    {
    ...
    QLog.d("FeedsPreloadHelper", 1, new Object[] { "updateRequestVersionAndGet, channelID = ", Integer.valueOf(paramqxs.b), ", beginSeq = ", Long.valueOf(paramqxs.a) });
    if ((paramqxs.b == 0) && (paramqxs.a == -1L))
    {
  ...
  public static void a()
  {
    ...
    bmhv.a("sp_key_readinjoy_feeds_preload_last_enter_kd_millisecond", Long.valueOf(l));
  }
  ...
  public static boolean a()
  {
    ...
    if (!((Boolean)bmhv.a("sp_key_readinjoy_feeds_preload_switch", Boolean.valueOf(false))).booleanValue())
    {
  ...
  public static boolean a(qxs paramqxs)
  {
    if ((paramqxs != null) && (a()) && (paramqxs.b == 0) && (paramqxs.a == -1L))
    {
  ...
  public static boolean a(boolean paramBoolean)
  {
    ...
    long l1 = ((Long)bmhv.a("sp_key_readinjoy_feeds_preload_last_enter_kd_millisecond", Long.valueOf(-1L))).longValue();
    if (l1 == -1L)
    {
    ...
    long l3 = ((Long)bmhv.a("sp_key_readinjoy_feeds_preload_last_enter_kd_day", Long.valueOf(90L))).longValue();
    ...
    l2 = ((Long)bmhv.a("sp_key_readinjoy_feeds_preload_last_preload_millisecond", Long.valueOf(-1L))).longValue();
    if (l2 != -1L)
    {
      l3 = System.currentTimeMillis();
      l1 = ((Long)bmhv.a("sp_key_readinjoy_feeds_preload_interval", Long.valueOf(30L))).longValue();
      l2 = (l3 - l2) / 1000L / 60L;
  ...
  public static void b()
  {
    ...
    bmhv.a("sp_key_readinjoy_feeds_preload_last_preload_millisecond", Long.valueOf(l));
  }
  ...
  public static boolean b(qxs paramqxs)
  {
    if (paramqxs != null)
    {
      if ((paramqxs.i & 0x100) != 0) {}
