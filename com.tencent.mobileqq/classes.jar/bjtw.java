...
public class bjtw
{
  ...
  {
    boolean bool = true;
    jdField_a_of_type_JavaLangString = bjtw.class.getSimpleName();
  ...
  public static boolean b()
  {
    ...
    QzoneModuleManager.getInstance().downloadModule("animatedWebp.so", new bjtx());
    return false;
  }
  ...
  {
    String str = bfny.a().getString("PREFERENCE_SO_MD5_KEY", null);
    if (TextUtils.isEmpty(str)) {}
