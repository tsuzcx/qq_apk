  ...
  implements View.OnClickListener
{
  ...
  private tyd jdField_a_of_type_Tyd;
  ...
  public txz(Context paramContext, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131379828));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131379461));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131379812));
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131379797));
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)findViewById(2131363796));
      this.e = ((TextView)findViewById(2131379877));
      ...
      this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131370427));
      this.jdField_b_of_type_AndroidWidgetLinearLayout.setOnClickListener(this);
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setOnClickListener(this);
      ugs.a(this.jdField_a_of_type_AndroidWidgetButton, AIOUtils.dp2px(6.0F, paramContext.getResources()), Color.parseColor("#EBEDF5"));
      ugs.a(this.jdField_a_of_type_AndroidWidgetTextView, AIOUtils.dp2px(4.0F, paramContext.getResources()), Color.parseColor("#F2F3F7"));
      ugs.a(this.jdField_b_of_type_AndroidWidgetTextView, AIOUtils.dp2px(4.0F, paramContext.getResources()), Color.parseColor("#F2F3F7"));
      ugs.a(this.jdField_c_of_type_AndroidWidgetTextView, AIOUtils.dp2px(4.0F, paramContext.getResources()), Color.parseColor("#F2F3F7"));
  ...
  private void a()
  {
    ...
    {
      this.jdField_a_of_type_Tyf = new tyf(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidWidgetLinearLayout.getHeight());
      String str2 = "";
      String str1 = str2;
      ...
      this.jdField_a_of_type_Tyf.a(this.jdField_a_of_type_JavaUtilList, new tya(this), str1);
      this.jdField_a_of_type_Tyf.show();
    }
  }
  ...
  private void b()
  {
    if ((this.jdField_c_of_type_JavaUtilList != null) && (this.jdField_c_of_type_JavaUtilList.size() > 0))
    {
      ...
      this.jdField_a_of_type_Tyf.a(this.jdField_c_of_type_JavaUtilList, new tyb(this), str1);
      this.jdField_a_of_type_Tyf.show();
    }
  }
  ...
  private void c()
  {
    if ((this.jdField_d_of_type_JavaUtilList != null) && (this.jdField_d_of_type_JavaUtilList.size() > 0))
    {
      ...
      this.jdField_a_of_type_Tyf.a(this.jdField_d_of_type_JavaUtilList, new tyc(this), str1);
      this.jdField_a_of_type_Tyf.show();
    }
  }
  ...
  private void e()
  {
    ...
    {
      ugs.a(this.jdField_a_of_type_AndroidWidgetButton, AIOUtils.dp2px(6.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), Color.parseColor("#00CAFC"));
      this.jdField_a_of_type_AndroidWidgetButton.setClickable(true);
      return;
    }
    ugs.a(this.jdField_a_of_type_AndroidWidgetButton, AIOUtils.dp2px(6.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), Color.parseColor("#EBEDF5"));
  ...
  public void a(Configuration paramConfiguration)
  {
    ...
    if (this.jdField_a_of_type_Tyf != null) {
      this.jdField_a_of_type_Tyf.dismiss();
    }
  }
  ...
  public void a(List<GiftServiceBean> paramList1, List<GiftServiceBean> paramList2, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      this.jdField_c_of_type_ComTencentBizPubaccountReadinjoyAdAdDataGiftServiceBean.t = amtj.a(2131704393);
  ...
  public void a(tyd paramtyd)
  {
    this.jdField_a_of_type_Tyd = paramtyd;
  }
  
  public void a(tye paramtye)
  {
    this.jdField_a_of_type_Tye = paramtye;
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      d();
      continue;
      tqj.b(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo, 3, a());
      dismiss();
      continue;
      dismiss();
