  ...
  extends acyl
{
  ...
  public acyx(int paramInt, AIOAnimationConatiner paramAIOAnimationConatiner, ListView paramListView)
  {
  ...
  protected boolean a(Object... paramVarArgs)
  {
    ...
    if (i > 0)
    {
      ...
      this.jdField_a_of_type_ArrayOfAndroidGraphicsDrawableDrawable[3] = this.jdField_a_of_type_ComTencentWidgetListView.getResources().getDrawable(2130837688);
      ...
      this.jdField_a_of_type_AndroidViewView = new aczc(this, this.jdField_a_of_type_ComTencentWidgetListView.getContext());
      this.jdField_b_of_type_AndroidViewView = new aczc(this, this.jdField_a_of_type_ComTencentWidgetListView.getContext());
      ...
      if (a(this.jdField_a_of_type_Long))
      {
        ...
        ((AnimatorSet)localObject3).addListener(new acyy(this));
    ...
    for (;;)
    {
      ...
      paramVarArgs.setAnimationListener(new acza(this));
      paramVarArgs = new aczb(this);
      paramVarArgs.setDuration(1000L);
      paramVarArgs.setFillAfter(true);
