...
public class acyx
{
  ...
  private static int a(aczh paramaczh)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 30	aczh:b	()Ljava/lang/String;
    ...
    //   557: aload 8
    //   559: invokestatic 134	acyx:a	(Ljava/io/InputStream;Ljava/io/File;)V
    //   562: aload 6
    //   564: astore 4
    //   566: aload 8
  ...
  private static String a()
  {
    try
    {
      if ((Build.VERSION.SDK_INT <= 28) && ((Build.VERSION.SDK_INT < 23) || (BaseApplicationImpl.getApplication().checkSelfPermission("android.permission.READ_PHONE_STATE") == 0)) && (Build.VERSION.SDK_INT >= 23))
      {
  ...
  private static void a(aczh paramaczh)
  {
    long l = System.currentTimeMillis();
    try
    {
      paramaczh = paramaczh.b();
      String str = PatchCommonUtil.getPatchPath(paramaczh);
      if ("Success".equals(aoic.a(BaseApplicationImpl.sApplication, str, null, false)))
      {
        jdField_a_of_type_Int = 500;
        jdField_a_of_type_JavaLangString = paramaczh;
      }
      for (;;)
      {
    ...
    catch (Throwable paramaczh)
    {
      for (;;)
      {
        jdField_a_of_type_Int = 502;
        QLog.d("PatchLogTag", 1, "DexPatchInstaller injectDexPatch throwable=" + paramaczh);
      }
    }
  }
  ...
  {
    long l = System.currentTimeMillis();
    aczh localaczh = aczi.a(paramContext, "dex");
    if ((jdField_a_of_type_Int == 0) && (a(paramContext, localaczh)))
    {
      String str = a();
      ...
      if (jdField_a_of_type_Int == 500) {
        if ((localaczh.b()) && (PatchCommonUtil.isArtGeN()) && (!SoLoadUtil.a()))
        {
          j = a(localaczh);
          i = j;
          if (j != 800)
          {
            str = aoic.a(BaseApplicationImpl.sApplication, 0);
      ...
      for (int i = j;; i = 0)
      {
        a(paramContext, localaczh);
        PatchReporter.reportPatchEvent(paramContext, "", "actPatchInstall", jdField_a_of_type_Int, localaczh.b(), i);
        ...
        if (PatchCommonUtil.isDalvik()) {
          PatchResolveForDalvik.a(paramContext, localaczh);
        }
      }
    }
  ...
  private static void a(Context paramContext, aczh paramaczh)
  {
    paramContext = new DexPatchInstaller.1(paramaczh, paramContext);
  ...
  public static void a(java.io.InputStream paramInputStream, File paramFile)
  {
    // Byte code:
    //   0: aload_1
    //   1: invokevirtual 333	java/io/File:getParentFile	()Ljava/io/File;
    //   4: invokevirtual 336	java/io/File:mkdirs	()Z
    //   7: pop
    //   8: new 338	java/io/FileOutputStream
    //   11: dup
    //   12: aload_1
    //   13: invokespecial 339	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   16: astore_3
    //   17: sipush 4096
    //   20: newarray byte
    //   22: astore_1
    //   23: aload_0
    //   24: aload_1
    //   25: invokevirtual 345	java/io/InputStream:read	([B)I
    //   28: istore_2
    //   29: iload_2
    //   30: ifle +32 -> 62
    //   33: aload_3
    ...
    //   35: iconst_0
    //   36: iload_2
    //   37: invokevirtual 351	java/io/OutputStream:write	([BII)V
    //   40: goto -17 -> 23
    //   43: astore_1
    //   44: aload_0
    //   45: ifnull +7 -> 52
    //   48: aload_0
    //   49: invokevirtual 352	java/io/InputStream:close	()V
    //   52: aload_3
    //   53: ifnull +7 -> 60
    //   56: aload_3
    //   57: invokevirtual 353	java/io/OutputStream:close	()V
    //   60: aload_1
    //   61: athrow
    //   62: aload_0
    //   63: ifnull +7 -> 70
    ...
    //   71: ifnull +7 -> 78
    //   74: aload_3
    //   75: invokevirtual 353	java/io/OutputStream:close	()V
    //   78: return
    //   79: astore_0
    //   80: goto -10 -> 70
    //   83: astore_0
  ...
  private static boolean a(Context paramContext, aczh paramaczh)
  {
    if (paramaczh == null) {
      QLog.d("PatchLogTag", 1, "DexPatchInstaller checkDexPatchConfigAndStatus patch config is null");
    }
    while (!paramaczh.a(paramContext, BaseApplicationImpl.processName)) {
      return false;
    }
    String str = paramaczh.b();
    ...
    if (localFile.length() != paramaczh.b())
    {
