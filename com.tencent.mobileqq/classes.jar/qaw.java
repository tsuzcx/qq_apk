...
class qaw
  implements Runnable
{
  qaw(qav paramqav, BluetoothDevice paramBluetoothDevice, byte[] paramArrayOfByte) {}
  ...
  public void run()
  {
    ...
    if ((localBlePeerInfo.jdField_a_of_type_JavaUtilList != null) && (localBlePeerInfo.jdField_a_of_type_JavaUtilList.contains("0000feba-0000-1000-8000-00805f9b34fb")))
    {
      ...
      if ((localBlePeerInfo.jdField_a_of_type_Int == 0) || (localBlePeerInfo.jdField_a_of_type_ArrayOfByte == null) || (!this.jdField_a_of_type_Qav.a.b.contains(new Long(localBlePeerInfo.jdField_a_of_type_Int)))) {}
    }
    for (;;)
    {
      try
      {
        QFindBLEScanMgr.b(this.jdField_a_of_type_Qav.a);
        boolean bool1 = QFindBLEScanMgr.a(this.jdField_a_of_type_Qav.a, localBlePeerInfo);
        bool2 = QFindBLEScanMgr.a(this.jdField_a_of_type_Qav.a, localBlePeerInfo, bool1);
        if (QLog.isColorLevel()) {
        ...
        QFindBLEScanMgr.a(this.jdField_a_of_type_Qav.a, localBlePeerInfo.jdField_a_of_type_Int, localBlePeerInfo.a());
      }
      ...
      this.jdField_a_of_type_Qav.a.a.postDelayed(new qax(this), this.jdField_a_of_type_Qav.a.i);
      return;
      if (bool2) {
        QFindBLEScanMgr.a(this.jdField_a_of_type_Qav.a, localBlePeerInfo, null, false);
      }
    }
  }
}
