...
{
  public qaw(ReadInJoySelfFragment paramReadInJoySelfFragment, ImageView paramImageView, orr paramorr) {}
      ...
      try
      {
        if (Build.VERSION.SDK_INT >= 16)
        {
          ...
          if (ReadInJoySelfFragment.b(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoySelfFragment))
          {
            ...
            double d1 = this.jdField_a_of_type_Orr.c / this.jdField_a_of_type_Orr.d;
            double d2 = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoySelfFragment.d;
            i = (int)(j - i - d1 * d2);
            if (i <= 0) {
              break;
            }
            Drawable localDrawable = DrawableUtil.getDrawable(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoySelfFragment.getActivity(), this.jdField_a_of_type_Orr.b, null, null);
            ...
            this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoySelfFragment.jdField_a_of_type_ComTencentImageURLImageView.setTag(this.jdField_a_of_type_Orr);
            ...
            pnp.a(this.jdField_a_of_type_Orr);
