...
public class bfgl
{
  ...
  public static void a(Window paramWindow)
  {
    ...
    {
      betc.b("DisplayUtil", "反射修改状态栏颜色失败");
    }
  }
  ...
  public static void a(Window paramWindow, boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      betc.b("DisplayUtil", "MANUFACTURER = " + Build.MANUFACTURER + ", MODEL = " + Build.MODEL);
  ...
  public static boolean a(Context paramContext)
  {
    ...
    for (;;)
    {
      betc.a("XPanelContainer", "hasNavbar=" + bool);
      if (bool) {}
  ...
  private static boolean a(Window paramWindow, boolean paramBoolean)
  {
    ...
    if (paramWindow != null) {
      for (;;)
      {
        ...
        {
          int j;
          betc.d("DisplayUtil", "setStatusBarDarkModeForFlyme: failed");
          bool = false;
          continue;
          int i = j & 0xFFFFDFFF;
          continue;
  ...
  public static int b(Context paramContext)
  {
    ...
    try
    {
      ...
      {
        betc.d("DisplayUtil", paramContext.getMessage());
        return -1;
      }
  ...
  private static void b(Window paramWindow)
  {
    ...
    {
      betc.d("DisplayUtil", "", paramWindow);
    }
  }
  ...
  private static boolean b(Activity paramActivity)
  {
    try
    {
      ...
      if (betc.a()) {
        betc.b("Window", "enableXiaoMiNotch true");
      }
      return true;
    }
    ...
    {
      if (betc.a()) {
        betc.d("Window", "enableXiaoMiNotch Exception", paramActivity);
      }
    }
    return false;
  }
