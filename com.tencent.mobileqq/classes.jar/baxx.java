  ...
  extends FaceDecodeTask
{
  ...
  public baxx(QQAppInterface paramQQAppInterface, FaceInfo paramFaceInfo, baxv parambaxv)
  {
    super(paramQQAppInterface, paramFaceInfo, parambaxv);
  ...
  public void a()
  {
    ...
    try
    {
      ...
      localajvg = (ajvg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6);
      if (this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo.jdField_a_of_type_Int != 1001) {
        break label119;
      }
      this.jdField_a_of_type_AndroidGraphicsBitmap = localajvg.a(GroupIconHelper.a(this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo.jdField_a_of_type_JavaLangString), false);
    }
    catch (OutOfMemoryError localOutOfMemoryError)
    {
          ...
          if ((this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo.jdField_a_of_type_Int == 4) || (this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo.jdField_a_of_type_Int == 113))
          {
            if (((HotChatManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(60)).b(this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo.jdField_a_of_type_JavaLangString))
            {
              ...
              if (this.jdField_a_of_type_AndroidGraphicsBitmap == null)
              {
                ...
                this.jdField_a_of_type_AndroidGraphicsBitmap = bbef.a(BaseApplicationImpl.sApplication.getResources(), i);
            ...
            if (!banb.a(this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo.jdField_a_of_type_JavaLangString))
            {
              this.jdField_a_of_type_AndroidGraphicsBitmap = ((akhp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo.jdField_a_of_type_JavaLangString, false);
      ...
      baxy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo);
      for (;;)
      {
        for (;;)
        {
        ...
        {
          localalyy = (alyy)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(180);
          if (localalyy.a(localalyy.b(this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo.jdField_b_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo.jdField_a_of_type_JavaLangString), (Setting)localException7.second, this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo.jdField_a_of_type_Int))
          {
            if (QLog.isColorLevel()) {
