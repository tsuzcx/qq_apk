...
public class axaz
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, ahzy paramahzy)
  {
    ThreadManager.post(new OldMutualMarkLogicHelper.1(paramQQAppInterface, paramSessionInfo, paramahzy), 5, null, false);
  }
    ...
    for (;;)
    {
      ...
      if (d(paramMessageForUniteGrayTip.subType))
      {
        if (!TextUtils.isEmpty(paramMessageForUniteGrayTip.caidanAnimUrl)) {
          agbc.a().a(paramQQAppInterface, false, true, paramAIOAnimationConatiner, 0, new awzv(BaseApplicationImpl.getContext(), paramMessageForUniteGrayTip.caidanAnimUrl), 4);
        }
      }
      else
      {
        paramMqqHandler = agbc.a();
        if (paramInt == 3) {
          paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850181);
        }
        while (paramMessageForUniteGrayTip != null)
        {
          ...
          if (paramInt == 26)
          {
            paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850182);
          }
          else if (paramInt == 27)
          {
            paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850183);
          }
          else if (paramInt == 4)
          {
            paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850140);
          }
          else if (paramInt == 28)
          {
            paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850141);
          }
          else if (paramInt == 29)
          {
            paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850142);
          }
          else if (paramInt == 1)
          {
            paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850185);
          }
          else if (paramInt == 2)
          {
            paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850144);
          }
          else if (paramInt == 5)
          {
            paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850184);
          }
          else if (paramInt == 30)
          {
            paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850186);
          }
          else if (paramInt == 31)
          {
            paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850187);
          }
          else if (paramInt == 7)
          {
          ...
          else
          {
            ...
            if (paramInt != 11) {
              if (paramInt == 12)
              {
                paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850155);
              }
              else if (paramInt == 13)
              {
              ...
              {
                paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850163);
              }
              else if (paramInt == 15)
              {
                paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850164);
              }
              else if (paramInt == 16)
              {
                paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850165);
              }
              else if (paramInt == 17)
              {
                paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850157);
              }
              else if (paramInt == 18)
              {
                paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850158);
              }
              else if (paramInt == 19)
              {
                paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850159);
              }
              else if (paramInt == 20)
              {
                paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850160);
              }
              else if (paramInt == 21)
              {
                paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850161);
              }
              else if (paramInt == 22)
              {
                paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850162);
              }
              else if (paramInt == 23)
              {
                paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850166);
              }
              else if (paramInt == 24)
              {
              ...
              else
              {
                ...
                if (awzy.a(paramInt))
                {
                  ...
                  {
                    paramInt = awzn.a(paramQQAppInterface, paramSessionInfo.jdField_a_of_type_JavaLangString, String.valueOf(paramInt));
                    paramMessageForUniteGrayTip = localObject;
                    if (paramInt != 0) {
  ...
  private static void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, List<ChatMessage> paramList, ahzy paramahzy)
  {
    if ((aool.a().a()) && (a(paramQQAppInterface, paramSessionInfo, paramList)))
    {
      paramahzy.V = true;
      aool.a().a();
      if (QLog.isColorLevel()) {
  ...
  public static void b(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, ahzy paramahzy)
  {
    if (paramahzy.V) {}
    for (;;)
    {
      ...
      ExtensionInfo localExtensionInfo = localanmw.a(paramSessionInfo.jdField_a_of_type_JavaLangString, false);
      if (localExtensionInfo != null)
      {
        int i = axav.a(1, paramSessionInfo.jdField_a_of_type_JavaLangString, localExtensionInfo, localanmw.a(false));
        long l = localExtensionInfo.loverLastChatTime;
        boolean bool = axav.a(axav.b(), l * 1000L, localExtensionInfo.loverTransFlag);
        if ((i != 0) && (bool)) {}
        for (i = 1; i != 0; i = 0)
        {
          a(paramQQAppInterface, paramSessionInfo, paramQQAppInterface.a().a(paramSessionInfo.jdField_a_of_type_JavaLangString, paramSessionInfo.jdField_a_of_type_Int), paramahzy);
          return;
        }
      }
    }
