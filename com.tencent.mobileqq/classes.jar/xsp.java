...
public class xsp
  extends xsw
{
  private final axvs jdField_a_of_type_Axvs = new xsq(this, Looper.getMainLooper());
  private final ArrayList<xsr> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private Set<Long> jdField_a_of_type_JavaUtilSet = new HashSet(10);
  private ConcurrentHashMap<String, xsu> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap(20);
  xsl jdField_a_of_type_Xsl = new xsl();
  xso jdField_a_of_type_Xso = new xso();
  ...
  private void a(long paramLong1, String paramString, long paramLong2, int paramInt)
  {
    ...
    {
      paramString = new xsu(this, paramString, paramLong2, paramInt, "", 0L);
  ...
  {
    xsu localxsu = (xsu)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(paramSession.uSessionID));
    if (localxsu == null) {
      return;
    }
    Object localObject1;
    ...
    {
      this.jdField_a_of_type_Xso.a(paramSession, localxsu.jdField_a_of_type_JavaLangString, localxsu.jdField_a_of_type_Long, localxsu.jdField_a_of_type_Int, paramBoolean);
      localObject1 = BaseApplicationImpl.getApplication().getRuntime();
      if ((localObject1 instanceof QQAppInterface))
      {
        localObject1 = (QQAppInterface)localObject1;
        localObject2 = ((xrh)((QQAppInterface)localObject1).a(51)).a(Long.parseLong(localxsu.jdField_a_of_type_JavaLangString));
    ...
    for (int i = ((DeviceInfo)localObject2).productId;; i = 0)
    {
      ...
      {
        int j;
        if (paramSession.actionInfo.strServiceName.compareTo(xvq.f) == 0) {
          if (paramBoolean)
          {
            j = 0;
            yds.a((AppRuntime)localObject1, l, "Net_SendMsg_Audio", 0, j, i);
            localObject1 = ((QQAppInterface)localObject1).getHandler(Conversation.class);
            if (localObject1 != null) {
              ((MqqHandler)localObject1).sendEmptyMessage(1009);
            }
            localObject1 = this.jdField_a_of_type_Axvs.obtainMessage();
            localObject2 = new xst(this);
            if (!paramBoolean) {
              break label364;
            }
          }
        ...
        for (i = 1003;; i = 1005)
        {
          ((xst)localObject2).jdField_a_of_type_Int = i;
          ((xst)localObject2).jdField_a_of_type_Long = localxsu.jdField_a_of_type_Long;
          ((Message)localObject1).obj = localObject2;
          this.jdField_a_of_type_Axvs.sendMessageDelayed((Message)localObject1, 0L);
          this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(String.valueOf(paramSession.uSessionID));
          return;
          if (!paramSession.actionInfo.strServiceName.equalsIgnoreCase(xvq.f)) {
            break;
          }
          this.jdField_a_of_type_Xsl.a(paramSession, localxsu.jdField_a_of_type_JavaLangString, localxsu.jdField_a_of_type_Long, localxsu.jdField_a_of_type_Int, paramBoolean);
          break;
          j = 1;
          break label157;
          if (paramSession.actionInfo.strServiceName.compareTo(xvq.e) != 0) {
            break label170;
          }
          if (paramBoolean) {}
          for (j = 0;; j = 1)
          {
            yds.a((AppRuntime)localObject1, l, "Net_SendMsg_Video", 0, j, i);
            break;
          }
        }
      }
  ...
  private void c(Session paramSession)
  {
    ...
    if ((localObject instanceof QQAppInterface))
    {
      ...
      MessageForDevShortVideo localMessageForDevShortVideo = (MessageForDevShortVideo)awbi.a(-4503);
  ...
  public String a(DataPoint paramDataPoint)
  {
    for (;;)
    {
      try
      {
        ...
        long l1 = ((JSONObject)localObject1).optLong("msg_time", awao.a());
        ...
        if (TextUtils.isEmpty(str1))
        {
          ...
          if ((localObject2 instanceof QQAppInterface))
          {
            ...
            MessageForDevPtt localMessageForDevPtt = (MessageForDevPtt)awbi.a(-4501);
  ...
  public void a(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      paramBundle = (xsu)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(i));
    } while (paramBundle == null);
    this.jdField_a_of_type_Xsl.a((Session)localObject, paramBundle.jdField_a_of_type_JavaLangString, paramBundle.jdField_a_of_type_Long, paramBundle.jdField_a_of_type_Int, f);
    Object localObject = this.jdField_a_of_type_Axvs.obtainMessage();
    xst localxst = new xst(this);
    localxst.jdField_a_of_type_Int = 1002;
    localxst.jdField_a_of_type_Float = f;
    localxst.jdField_a_of_type_Long = paramBundle.jdField_a_of_type_Long;
    ((Message)localObject).obj = localxst;
    this.jdField_a_of_type_Axvs.sendMessageDelayed((Message)localObject, 0L);
  }
  
  void a(Message paramMessage)
  {
    if (QLog.isColorLevel()) {
      QLog.d("DeviceAVFileMsgObserver", 2, "handleMessage" + ((xst)paramMessage.obj).jdField_a_of_type_Long + " status " + paramMessage.what + "retCode " + paramMessage.arg1);
    }
    int i = 0;
    if (i < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      Object localObject = (xsr)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      View localView = ((xsr)localObject).a();
      localObject = ((xsr)localObject).a();
      if ((localView != null) && (localObject != null)) {
        ((xss)localObject).a(localView, (xst)paramMessage.obj);
      }
      for (;;)
      {
        i += 1;
  ...
  public void a(View paramView, xss paramxss)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (localIterator.hasNext())
    {
      xsr localxsr = (xsr)localIterator.next();
      if (localxsr.a() == paramView)
      {
        localxsr.b = new WeakReference(paramxss);
        return;
      }
    }
    this.jdField_a_of_type_JavaUtilArrayList.add(new xsr(this, paramView, paramxss));
  }
  ...
  public void a(MessageForDevPtt paramMessageForDevPtt)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        {
          paramMessageForDevPtt = new xsu(this, paramMessageForDevPtt.frienduin, paramMessageForDevPtt.uniseq, paramMessageForDevPtt.istroop, "", 0L);
  ...
  public void a(Session paramSession)
  {
    ...
    if ((!paramSession.bSend) && (paramSession.actionInfo.strServiceName.equalsIgnoreCase(xvq.e))) {
      c(paramSession);
    }
  }
  ...
  public void a(Session paramSession, float paramFloat)
  {
    ...
    if (localxsu != null)
    {
      ...
      this.jdField_a_of_type_Xso.a(paramSession, localxsu.jdField_a_of_type_JavaLangString, localxsu.jdField_a_of_type_Long, localxsu.jdField_a_of_type_Int, paramFloat);
      localMessage = this.jdField_a_of_type_Axvs.obtainMessage();
      localxst = new xst(this);
    ...
    label165:
    label205:
    for (localxst.jdField_a_of_type_Int = 1002;; localxst.jdField_a_of_type_Int = 2002)
    {
      localxst.jdField_a_of_type_Float = paramFloat;
      localxst.jdField_a_of_type_Long = localxsu.jdField_a_of_type_Long;
      localMessage.obj = localxst;
      this.jdField_a_of_type_Axvs.sendMessageDelayed(localMessage, 0L);
      return;
      if (!paramSession.actionInfo.strServiceName.equalsIgnoreCase(xvq.f)) {
        break;
      }
      this.jdField_a_of_type_Xsl.a(paramSession, localxsu.jdField_a_of_type_JavaLangString, localxsu.jdField_a_of_type_Long, localxsu.jdField_a_of_type_Int, paramFloat);
      break;
    }
  }
  ...
  public void a(Session paramSession, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      localxsu = (xsu)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(paramSession.uSessionID));
    } while (localxsu == null);
    label135:
    Object localObject1;
    Object localObject2;
    ...
    for (int i = 2003;; i = 2005)
    {
      ...
      this.jdField_a_of_type_Axvs.sendMessageDelayed((Message)localObject1, 0L);
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(String.valueOf(paramSession.uSessionID));
      this.jdField_a_of_type_JavaUtilSet.remove(Long.valueOf(localxsu.jdField_a_of_type_Long));
      if (!paramBoolean) {
        break label439;
      }
      this.b.remove(Long.valueOf(localxsu.jdField_a_of_type_Long));
      return;
      if ((paramSession.actionInfo.strServiceName.equalsIgnoreCase(xvq.f)) || (!paramSession.actionInfo.strServiceName.equalsIgnoreCase(xvq.g))) {
        break label135;
      }
      localObject1 = BaseApplicationImpl.getApplication().getRuntime();
      if (!(localObject1 instanceof QQAppInterface)) {
      ...
      localObject1 = (QQAppInterface)localObject1;
      localObject2 = ((QQAppInterface)localObject1).a().a(localxsu.jdField_a_of_type_JavaLangString, localxsu.jdField_a_of_type_Int, localxsu.jdField_a_of_type_Long);
      if (localObject2 == null) {
        break;
      }
      ...
      if (paramBoolean) {}
      for (localMessageForDevPtt.fileSize = apck.a(paramSession.strFilePathSrc);; localMessageForDevPtt.fileSize = -1L)
      {
        localMessageForDevPtt.msg = localMessageForDevPtt.getSummary();
        localMessageForDevPtt.serial();
    ...
    label439:
    this.b.put(Long.valueOf(localxsu.jdField_a_of_type_Long), Long.valueOf(awao.a()));
  }
  
  public void a(MessageRecord paramMessageRecord, float paramFloat)
  {
    Message localMessage = this.jdField_a_of_type_Axvs.obtainMessage();
    xst localxst = new xst(this);
    localxst.jdField_a_of_type_Int = 1002;
    localxst.jdField_a_of_type_Long = paramMessageRecord.uniseq;
    localxst.jdField_a_of_type_Float = paramFloat;
    localMessage.obj = localxst;
    this.jdField_a_of_type_Axvs.sendMessageDelayed(localMessage, 0L);
  }
  ...
  public void a(MessageRecord paramMessageRecord, Boolean paramBoolean)
  {
    ...
    {
      i = 1003;
      localxst.jdField_a_of_type_Int = i;
      localxst.jdField_a_of_type_Long = paramMessageRecord.uniseq;
      if (!paramBoolean.booleanValue()) {
        break label89;
      }
  ...
  public void a(String paramString1, String paramString2, long paramLong1, long paramLong2, int paramInt1, int paramInt2)
  {
    ...
    {
      localObject1 = (QQAppInterface)localObject1;
      localObject2 = (xrh)((QQAppInterface)localObject1).a(51);
      if ((!paramString1.equalsIgnoreCase(xvq.f)) || (localObject2 == null) || (!((xrh)localObject2).b(paramLong1))) {
        break label192;
      }
      localObject1 = new Session();
      ((Session)localObject1).uSessionID = ((xrh)localObject2).a(paramLong1, paramString2, paramInt2);
      ((Session)localObject1).strFilePathSrc = paramString2;
      ((Session)localObject1).uFileSizeSrc = apck.a(paramString2);
      ...
      paramString2 = new xsu(this, String.valueOf(paramLong1), paramLong2, paramInt1, paramString2, ((Session)localObject1).uFileSizeSrc);
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(localObject2, paramString2);
      label154:
      if (!badq.d(BaseApplication.getContext()))
      {
        if (!paramString1.equalsIgnoreCase(xvq.e)) {
          break label238;
        }
        this.jdField_a_of_type_Xso.a((Session)localObject1, String.valueOf(paramLong1), paramLong2, paramInt1, false);
      }
    }
    label192:
    label221:
    label238:
    while (!paramString1.equalsIgnoreCase(xvq.f))
    {
      return;
    ...
    this.jdField_a_of_type_Xsl.a((Session)localObject1, String.valueOf(paramLong1), paramLong2, paramInt1, false);
  }
  ...
  public boolean a(long paramLong)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (((xsu)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).jdField_a_of_type_Long == paramLong) {
        return true;
      }
    }
    return false;
  ...
  public void b(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      localxsu = (xsu)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(paramBundle.uSessionID));
    } while (localxsu == null);
    paramBundle.strFilePathSrc = localxsu.jdField_b_of_type_JavaLangString;
    paramBundle.uFileSizeSrc = localxsu.jdField_b_of_type_Long;
    Object localObject1 = this.jdField_a_of_type_Xsl;
    Object localObject2 = localxsu.jdField_a_of_type_JavaLangString;
    long l = localxsu.jdField_a_of_type_Long;
    int j = localxsu.jdField_a_of_type_Int;
    if (i == 0)
    {
      ((xsl)localObject1).a(paramBundle, (String)localObject2, l, j, bool);
      localObject1 = BaseApplicationImpl.getApplication().getRuntime();
      if ((localObject1 instanceof QQAppInterface))
      {
        localObject1 = (QQAppInterface)localObject1;
  ...
  public void b(Session paramSession)
  {
    ...
    xst localxst = new xst(this);
    if (paramSession.bSend) {}
    for (localxst.jdField_a_of_type_Int = 1001;; localxst.jdField_a_of_type_Int = 2001)
    {
      localxst.jdField_a_of_type_Long = localxsu.jdField_a_of_type_Long;
      localMessage.obj = localxst;
      this.jdField_a_of_type_Axvs.sendMessageDelayed(localMessage, 0L);
