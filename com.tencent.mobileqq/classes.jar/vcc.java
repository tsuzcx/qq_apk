  ...
  implements View.OnClickListener
{
  ...
  public vcc(Context paramContext, vct paramvct)
  {
    super(paramContext);
    if (paramvct != null) {
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    if ((paramBoolean1) && (this.jdField_a_of_type_UserGrowthStNewIconStyle != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_UserGrowthStNewIconStyle.title)))
    {
      ...
      if (!TextUtils.isEmpty(this.jdField_a_of_type_UserGrowthStNewIconStyle.iconUrl)) {
        this.c.setImage(uyo.a(this.jdField_a_of_type_UserGrowthStNewIconStyle.iconUrl));
      }
      for (;;)
      {
        if (paramBoolean2) {
          this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView.setImageResource(2130842706);
        }
        return;
        this.c.setImageResource(2130843221);
      }
    }
  ...
  protected void a()
  {
    ...
    if ((localvaq != null) && ((localvaq.a() instanceof stSimpleMetaFeed)))
    {
      ...
      if (this.jdField_a_of_type_UserGrowthStNewIconStyle != null) {
        uwc.a(this.jdField_a_of_type_UserGrowthStNewIconStyle.tag_type, this.jdField_a_of_type_UserGrowthStNewIconStyle.id);
      }
    }
  }
  ...
  protected void b()
  {
    if ((this.jdField_a_of_type_UserGrowthStNewIconStyle != null) && ((this.jdField_a_of_type_UserGrowthStNewIconStyle.tag_type == 1) || (this.jdField_a_of_type_UserGrowthStNewIconStyle.tag_type == 2)))
    {
      ...
      {
        this.jdField_b_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView.setImage(uyo.a(str));
        return;
      }
      this.jdField_b_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView.setImage(uyo.a("https://isee.weishi.qq.com/qq/doudi_ban.png"));
      return;
    }
  ...
  protected void e()
  {
    this.jdField_b_of_type_AndroidViewView = a(2131380434);
    this.jdField_b_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView = ((KandianUrlImageView)a(2131380416));
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView = ((KandianUrlImageView)a(2131380433));
    this.c = ((KandianUrlImageView)a(2131380436));
