  ...
  implements Handler.Callback
{
  ...
  public bptm a;
  private bptn jdField_a_of_type_Bptn;
  bpto jdField_a_of_type_Bpto;
  ...
  private bptt a()
  {
    bptt localbptt = this.jdField_a_of_type_Bptm.a.b();
    if (localbptt != null) {
      return localbptt;
    }
    localbptt = this.jdField_a_of_type_Bptm.a.a();
    if (localbptt != null)
    {
      this.jdField_a_of_type_Bpto.a(localbptt.jdField_a_of_type_Int, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      return localbptt;
    }
    return null;
  }
  ...
  {
    this.jdField_a_of_type_Bptn.jdField_a_of_type_Int = paramAVIOStruct.pFrameIndex;
    paramAVIOStruct.pFrameIndex = 0;
    this.jdField_a_of_type_Bptn.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Bptn.jdField_b_of_type_Int = 0;
    bplk.a("handleMessage:writeVideoFrame[false]  mThumbPicControl.mSendThumbOKIndex=" + this.jdField_a_of_type_Bptn.jdField_a_of_type_Int);
  }
  ...
  private boolean a()
  {
    boolean bool2 = true;
    bool1 = false;
    synchronized (bptm.a(this.jdField_a_of_type_Bptm))
    {
      Object localObject2 = bptm.a(this.jdField_a_of_type_Bptm);
  ...
  private void f()
  {
    if (this.jdField_a_of_type_Bpto != null) {
      this.jdField_a_of_type_Bpto.c();
    }
    this.jdField_a_of_type_Bpto = null;
    a();
  ...
  {
    b(false);
    bpii.a("destroy OffScreenGLSurface");
  }
  
  public void a(int paramInt1, int paramInt2, bpkc parambpkc)
  {
    this.jdField_c_of_type_Int = paramInt1;
    this.jdField_d_of_type_Int = paramInt2;
    this.jdField_a_of_type_Int = parambpkc.jdField_c_of_type_Int;
    this.jdField_b_of_type_Int = parambpkc.jdField_d_of_type_Int;
  ...
  public void a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_DovComTencentMobileqqShortvideoUtilOffScreenInputSurface != null)
    {
      if (paramBoolean)
      {
        this.jdField_a_of_type_Bpto = new bpto();
        this.jdField_a_of_type_Bpto.a(false, false);
        b();
      }
      bpta.b();
      return;
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.what == -16716524)
    {
      ...
      a(paramMessage.arg1, paramMessage.arg2, (bpkc)paramMessage.obj);
      this.h = true;
      if (this.i)
      {
        a(a());
        bpii.a("SETPREVIEW OffScreenGLSurface");
      }
    }
    do
    {
      do
      {
        ...
        bpii.a("RANDER_DATA_INIT OffScreenGLSurface");
        return true;
        if (paramMessage.what != -16716522) {
          break;
        }
        d();
        this.jdField_a_of_type_Bptm.a();
        this.jdField_a_of_type_Bptm.a = null;
        this.jdField_a_of_type_Bptn.jdField_b_of_type_Int = 0;
        this.jdField_a_of_type_Bptn.jdField_a_of_type_Boolean = false;
        this.jdField_a_of_type_Bptn.jdField_a_of_type_Int = -1;
        f();
      } while (!QLog.isColorLevel());
    ...
    for (StringBuilder localStringBuilder = new StringBuilder("CAMERA_OPENGL_RANDER_DATA");; localStringBuilder = null)
    {
      ...
      if (j != 0)
      {
        bplk.a("handleMessage:[RenderModeCheck-Recorder][May Lost Frame] mode=" + j);
        return true;
      }
      if (this.jdField_a_of_type_Bpto != null) {
        bpta.a(PtvFilterUtils.a() / 1000L);
      }
      Object localObject;
      ...
      for (;;)
      {
        ...
        bpta.d((PtvFilterUtils.a() - l) / 1000L);
        ...
        if (this.jdField_a_of_type_Bpto != null)
        {
          if (this.jdField_a_of_type_Bptm.a == null)
          {
            bplk.a("handleMessage:[RenderModeCheck-Recorder][May Lost Frame] mode=" + j);
            return true;
            ...
            localObject = ((bpsk)paramMessage.obj).jdField_a_of_type_ArrayOfByte;
            continue;
          }
          l = PtvFilterUtils.a();
          bptt localbptt = a();
          if (localbptt != null)
          {
            this.jdField_a_of_type_Bpto.a(localbptt.jdField_a_of_type_Int);
            if ((QLog.isColorLevel()) && (localStringBuilder != null))
            {
              localStringBuilder.append("bind t=").append(localbptt.jdField_a_of_type_Int).append("|");
            ...
            for (boolean bool1 = true;; bool1 = false)
            {
              ...
              localAVIOStruct = ((bpsk)paramMessage.obj).jdField_a_of_type_ComTencentMaxvideoCommonAVIOStruct;
            ...
            {
              this.jdField_a_of_type_Bptn.jdField_a_of_type_Boolean = true;
              localObject = localAVIOStruct;
            }
            label752:
            ...
            localbptt.a(j, localObject, bool1);
            localbptt.d();
            bool1 = this.jdField_a_of_type_Bptm.a.a();
            if ((QLog.isColorLevel()) && (localStringBuilder != null))
            {
              localStringBuilder.append("write ns=").append(this.jdField_a_of_type_Bptn.jdField_a_of_type_Boolean).append("|");
            ...
            if (!bool1)
            {
              if (this.jdField_a_of_type_Bptn.jdField_a_of_type_Boolean) {
                a((AVIOStruct)localObject);
              }
              localbptt.a();
            }
            label905:
            bpta.c((PtvFilterUtils.a() - l) / 1000L);
          }
        }
        for (;;)
        {
          ...
          break label752;
          bplk.a("handleMessage:byteBufferProcessFrame: no texture");
          break label905;
          bplk.a("handleMessage:byteBufferProcessFrame  framebuffer=null");
        }
        label1133:
        localObject = null;
      }
