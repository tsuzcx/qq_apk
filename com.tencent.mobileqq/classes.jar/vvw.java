...
class vvw
  implements Runnable
{
  vvw(vvr paramvvr, String paramString1, String paramString2, String paramString3) {}
  ...
  public void run()
  {
    ...
    if (this.jdField_a_of_type_JavaLangString.equals("input")) {
      if ((BaseActivity.sTopActivity instanceof FragmentActivity))
      {
        ...
        if (localObject1 != null)
        {
          ...
          if (localObject1 != null)
          {
            localObject2 = ((ArkAppCenter)this.jdField_a_of_type_Vvr.a.a.a.getManager(120)).a().a(ArkDebugChatPie.a(this.jdField_a_of_type_Vvr.a.a), null);
            ArrayList localArrayList = new ArrayList();
            ArkAiInfo localArkAiInfo = new ArkAiInfo();
            localArkAiInfo.jdField_a_of_type_JavaLangString = ArkDebugChatPie.a(this.jdField_a_of_type_Vvr.a.a);
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_JavaLangString.equals("popup"))
      {
        ...
        localObject2 = QQCustomArkDialog.AppInfo.a(ArkDebugChatPie.a(this.jdField_a_of_type_Vvr.a.a), this.c, "0.0.0.1", this.b, ((BaseActivity)localObject1).getResources().getDisplayMetrics().scaledDensity, null, null);
        ArkDebugChatPie.a(this.jdField_a_of_type_Vvr.a.a, DialogUtil.a((Context)localObject1, null, (Bundle)localObject2));
        ArkDebugChatPie.a(this.jdField_a_of_type_Vvr.a.a).setNegativeButton(2131433029, null);
        ArkDebugChatPie.a(this.jdField_a_of_type_Vvr.a.a).setPositiveButton(2131433030, null);
        ArkDebugChatPie.a(this.jdField_a_of_type_Vvr.a.a).show();
        return;
      }
      if (this.jdField_a_of_type_JavaLangString.equals("card"))
      {
        ...
        ((ArkAppMessage)localObject1).appName = ArkDebugChatPie.a(this.jdField_a_of_type_Vvr.a.a);
      ...
      try
      {
        ...
        localObject2 = this.jdField_a_of_type_Vvr.a.a.a();
        if (localObject2 == null) {
          continue;
        }
        ArkDebugChatPie.a(this.jdField_a_of_type_Vvr.a.a, (QQAppInterface)BaseApplicationImpl.sApplication.getRuntime(), (SessionInfo)localObject2, (ArkAppMessage)localObject1);
        return;
        if (this.jdField_a_of_type_JavaLangString.equals("fullscreen"))
        {
          ...
          ArkAppDataReport.k(null, ArkDebugChatPie.a(this.jdField_a_of_type_Vvr.a.a));
          ArkFullScreenAppActivity.a((Context)localObject1, ArkDebugChatPie.a(this.jdField_a_of_type_Vvr.a.a), this.c, "0.0.0.1", this.b, ((FragmentActivity)localObject1).getResources().getDisplayMetrics().scaledDensity, null, 0);
          return;
        }
        if (!this.jdField_a_of_type_JavaLangString.equals("default")) {
          continue;
        }
        localObject1 = new ArkAppMessage();
        ((ArkAppMessage)localObject1).appMinVersion = "0.0.0.1";
