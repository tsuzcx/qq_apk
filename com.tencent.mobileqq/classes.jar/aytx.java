  ...
  implements ITransactionCallback
{
  ...
  public void onFailed(int paramInt, byte[] paramArrayOfByte, HashMap<String, String> paramHashMap)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("QIMWebVideoUploaderFirstFrame", 2, "<BDH_LOG> Transaction End : Failed. New : SendTotalCost:" + (l - aytw.a(this.a)) + "ms");
    }
    aytw.a(this.a).put("serverip", paramHashMap.get("ip"));
    aytw.a(this.a).put("param_bdhSrv", paramHashMap.get("ip"));
    aytw.a(this.a).put("param_bdhPort", paramHashMap.get("port"));
    aytw.a(this.a).put("X-piccachetime", paramArrayOfByte);
    aytw.a(this.a).put("param_BdhTrans", str1);
    aytw.a(this.a).put("param_segspercnt", str2);
    aytw.a(this.a).put("param_conf_segSize", str3);
    aytw.a(this.a).put("param_conf_segNum", str4);
    aytw.a(this.a).put("param_conf_connNum", str5);
    aytw.a(this.a).put("param_fin_lost", str6);
    aytw.a(this.a).put("param_retry_seg_count", paramHashMap.get("param_retry_seg_count"));
    aytw.a(this.a).put("param_max_retry_times", paramHashMap.get("param_max_retry_times"));
    aytw.a(this.a).put("param_total_retry_times", paramHashMap.get("param_total_retry_times"));
    aytw.a(this.a).put("param_retry_code", paramHashMap.get("param_retry_code"));
    aytw.a(this.a).put("param_heart_resp", paramHashMap.get("param_heart_resp"));
    aytw.a(this.a).put("param_ip_index", paramHashMap.get("param_ip_index"));
    aytw.a(this.a).put("param_Ip_ConnCost", paramHashMap.get("param_Ip_ConnCost"));
    if (((String)paramHashMap.get("param_BDH_Cache_Diff")).equals(String.valueOf(true))) {
      aytw.a(this.a, true);
    }
    aytw.a(this.a, paramInt);
    aytw.b(this.a, "sessionKey or sigSession is null");
    aytw.a(this.a).b(paramInt, aytw.b(this.a));
  }
  ...
  public void onSuccess(byte[] paramArrayOfByte, HashMap<String, String> paramHashMap)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramArrayOfByte)
      {
        ...
        String str2;
        String str3;
        aytw.a(this.a).b(i, "mergeFrom respData Exception");
      ...
      aytw.a(this.a, (String)paramHashMap.get("rep_bdhTrans"));
      ...
      if (QLog.isColorLevel()) {
        QLog.d("QIMWebVideoUploaderFirstFrame", 2, "<BDH_LOG> Transaction End : Success. New : SendTotalCost:" + (l3 - aytw.a(this.a)) + "ms transInfo:" + aytw.a(this.a));
      }
      aytw.a(this.a).put("serverip", paramHashMap.get("ip"));
      aytw.a(this.a).put("param_bdhSrv", paramHashMap.get("ip"));
      aytw.a(this.a).put("param_bdhPort", paramHashMap.get("port"));
      aytw.a(this.a).put("X-piccachetime", String.valueOf(aytw.a(this.a).mTransReport.timeCost_Cache));
      aytw.a(this.a).put("param_BdhTrans", aytw.a(this.a));
      aytw.a(this.a).put("param_segspercnt", paramArrayOfByte);
      aytw.a(this.a).put("param_conf_segSize", localObject);
      aytw.a(this.a).put("param_conf_segNum", str1);
      aytw.a(this.a).put("param_conf_connNum", str2);
      aytw.a(this.a).put("param_fin_lost", str3);
      aytw.a(this.a).put("param_retry_seg_count", paramHashMap.get("param_retry_seg_count"));
      aytw.a(this.a).put("param_max_retry_times", paramHashMap.get("param_max_retry_times"));
      aytw.a(this.a).put("param_total_retry_times", paramHashMap.get("param_total_retry_times"));
      aytw.a(this.a).put("param_retry_code", paramHashMap.get("param_retry_code"));
      ...
      aytw.a(this.a).b(i, paramArrayOfByte);
    }
  }
