  ...
  extends ayog
{
  public File a(OutputStream paramOutputStream, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    paramDownloadParams = bhbp.a(BaseApplication.getContext(), paramOutputStream);
    if (QLog.isColorLevel())
    {
      QLog.i("Q.qzonecover.", 2, "downloadImage|path = " + paramDownloadParams);
      if (!bbdj.b(paramDownloadParams)) {
        break label198;
      }
    ...
    if ((paramURLDrawableHandler.exists()) || ((paramOutputStream.startsWith("http://")) && (bbwi.a(new bbwg(paramOutputStream, paramURLDrawableHandler), null) == 0) && (paramURLDrawableHandler.exists()))) {
