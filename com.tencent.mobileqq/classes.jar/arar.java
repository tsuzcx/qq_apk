...
public class arar
{
  private static arar jdField_a_of_type_Arar;
  ...
  private arar()
  {
    try
    {
      ...
      this.jdField_a_of_type_Arat = new arat(this, BaseApplicationImpl.getContext());
  ...
  {
    if (jdField_a_of_type_Arar == null) {
      jdField_a_of_type_Arar = new arar();
    }
    return jdField_a_of_type_Arar;
  }
  ...
  public int a(artu paramartu, Bundle paramBundle, long paramLong, int paramInt)
  {
    if (-1 == paramInt)
    {
      paramInt = a();
    ...
    while (paramartu != null)
    {
      paramartu.a(new aras(this, ThreadManager.getSubThreadHandler().getLooper(), paramInt, paramBundle, paramLong), false);
      return paramInt;
  ...
  public Notification a(Bundle paramBundle)
  {
    ...
    if (paramBundle != null)
    {
      ...
      ((Notification)localObject1).icon = 2130843980;
      paramBundle = new RemoteViews(BaseApplication.getContext().getPackageName(), 2131560690);
      paramBundle.setImageViewResource(2131371279, 2130843976);
      paramBundle.setTextViewText(2131371288, (CharSequence)localObject2);
      paramBundle.setProgressBar(2131371273, 100, 0, false);
      paramBundle.setViewVisibility(2131371278, 8);
      paramBundle.setViewVisibility(2131371274, 8);
      paramBundle.setTextColor(2131371288, -7829368);
      paramBundle.setTextColor(2131371278, -7829368);
      paramBundle.setTextColor(2131371275, -7829368);
      float f1 = this.jdField_a_of_type_Arat.a();
      if (this.jdField_a_of_type_Arat.a() <= 0.0F)
      {
        QLog.w(jdField_a_of_type_JavaLangString, 1, "[UniformDL]. initNotification param error. getTextSize failed. set defualt value:14");
        f1 = 14.0F;
      }
      paramBundle.setFloat(2131371278, "setTextSize", f1);
      paramBundle.setFloat(2131371275, "setTextSize", f1);
      float f2 = this.jdField_a_of_type_Arat.b();
      f1 = f2;
      if (f2 <= 0.0F)
      {
      ...
      paramBundle.setFloat(2131371288, "setTextSize", f1);
      ...
      try
      {
        int i = this.jdField_a_of_type_Arat.a().intValue();
        paramBundle.setInt(2131371280, "setBackgroundColor", (i & 0xFF000000) + (-1 - i));
  ...
  protected void a(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    {
      return;
      paramNotification.tickerText = (BaseApplication.getContext().getString(2131721182) + " " + paramBundle1.getString("_notify_param_Filename"));
      paramNotification.contentView.setImageViewResource(2131371279, 2130843976);
      int i = paramBundle2.getInt("_START_WAITING_");
      if (1 == i)
      {
        paramNotification.contentView.setTextViewText(2131371275, BaseApplication.getContext().getString(2131721183));
        paramNotification.contentView.setViewVisibility(2131371274, 0);
        paramNotification.contentView.setViewVisibility(2131371278, 8);
        paramNotification.contentView.setProgressBar(2131371273, 100, 0, false);
      ...
      for (;;)
      {
        ...
        paramNotification.contentView.setTextViewText(2131371275, "0%");
        break;
        paramNotification.when = a(3);
        break label243;
        paramNotification.contentView.setOnClickPendingIntent(2131371280, paramBundle1);
      }
    }
  }
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    ...
    if (localNotification != null)
    {
      ...
      araj.a().b(paramBundle.getString("_notify_param_Url"));
      return;
    }
  ...
  protected void a(int paramInt, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    localNotification.tickerText = (BaseApplication.getContext().getString(2131721176) + " " + paramBundle1.getString("_notify_param_Filename"));
    ...
    localObject = BaseApplication.getContext().getString(2131721178);
    if (artp.a(str1) != null)
    {
      localBitmap = artp.a(str1);
      localObject = BaseApplication.getContext().getString(2131721177);
    }
    if (localBitmap == null)
    {
      int j = arrr.b(str1);
      if (j != 0)
      {
        localNotification.contentView.setImageViewResource(2131371279, j);
        label236:
        localNotification.contentView.setImageViewResource(2131371279, 2130843978);
      }
    }
    for (;;)
    {
      localNotification.contentView.setViewVisibility(2131371278, 0);
      localNotification.contentView.setViewVisibility(2131371274, 8);
      localNotification.contentView.setTextViewText(2131371278, (CharSequence)localObject);
      ...
      localNotification.contentView.setImageViewResource(2131371279, 2130843978);
      break label236;
      localNotification.contentView.setImageViewBitmap(2131371279, localBitmap);
    }
  }
  ...
  protected void b(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    for (;;)
    {
      ...
      paramNotification.contentView.setProgressBar(2131371273, 100, i, false);
      paramNotification.contentView.setTextViewText(2131371275, "" + i + "%");
      paramNotification.flags = 34;
      paramBundle2 = new Intent("com.tencent.mobileqq.UniformDownloadNfn.PAUSE");
      paramBundle2.setPackage(MobileQQ.getContext().getPackageName());
      paramBundle2.putExtra("_PARAM_EXTRA", paramBundle1);
  ...
  public void b(int paramInt, Bundle paramBundle)
  {
    ...
    if (localNotification != null)
    {
      ...
      araj.a().a(paramBundle.getString("_notify_param_Url"), paramBundle.getString("_notify_param_Filename"), paramBundle.getString("_notify_param_ContentTitle", ""), paramBundle.getLong("_notify_param_Filesize"), paramBundle.getBundle("_notify_param_userdata"), paramInt, true);
      return;
    }
  ...
  protected void c(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    paramNotification.tickerText = null;
    int i = paramBundle2.getInt("_FILE_PROGRESS_");
    paramNotification.contentView.setImageViewResource(2131371279, 2130843979);
    paramNotification.contentView.setViewVisibility(2131371278, 0);
    paramNotification.contentView.setViewVisibility(2131371274, 8);
    paramNotification.contentView.setTextViewText(2131371278, BaseApplication.getContext().getString(2131721181));
    paramNotification.contentView.setProgressBar(2131371273, 100, i, false);
    paramNotification.contentView.setTextViewText(2131371275, "" + i + "%");
    ...
    for (;;)
    {
      ...
      paramNotification.contentView.setOnClickPendingIntent(2131371280, paramBundle2);
    }
  }
  ...
  protected void d(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    if (2 == i)
    {
      paramNotification.tickerText = BaseApplication.getContext().getString(2131721180);
      paramNotification.contentView.setTextViewText(2131371278, BaseApplication.getContext().getString(2131721180));
      label115:
      paramNotification.contentView.setImageViewResource(2131371279, 2130843977);
      paramNotification.contentView.setViewVisibility(2131371278, 0);
      paramNotification.contentView.setTextViewText(2131371275, " ");
      paramNotification.flags = 16;
    ...
    for (;;)
    {
      ...
      paramNotification.tickerText = (BaseApplication.getContext().getString(2131721179) + " " + paramBundle1.getString("_notify_param_Filename"));
      paramNotification.contentView.setTextViewText(2131371278, artu.a(i) + alud.a(2131716277));
      break label115;
      label397:
      paramNotification.contentView.setOnClickPendingIntent(2131371280, paramBundle2);
    }
