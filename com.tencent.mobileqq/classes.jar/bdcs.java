...
public class bdcs
{
  private static volatile bdcs jdField_a_of_type_Bdcs;
  public static boolean a;
  private long jdField_a_of_type_Long;
  private String jdField_a_of_type_JavaLangString;
  private WeakReference<View> jdField_a_of_type_JavaLangRefWeakReference;
  private WtloginObserver jdField_a_of_type_MqqObserverWtloginObserver = new bdcu(this);
  ...
  {
    if (jdField_a_of_type_Bdcs == null) {}
    try
    {
      if (jdField_a_of_type_Bdcs == null) {
        jdField_a_of_type_Bdcs = new bdcs();
      }
      return jdField_a_of_type_Bdcs;
    }
    finally {}
  }
  ...
  private void a()
  {
    ...
    {
      if (i != 0) {
        QIPCServerHelper.getInstance().register(new bdct(this, "QR_LOGIN_QIPC_MODULE_NAME"));
      }
      return;
      i = 0;
    }
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    for (paramArrayOfByte = new String(paramArrayOfByte);; paramArrayOfByte = ajyc.a(2131711186))
    {
  ...
  public void a(Bundle paramBundle, boolean paramBoolean)
  {
    ...
    if ((!TextUtils.isEmpty("")) && (!"".equals(localObject1)))
    {
      ...
      localByteBuffer.put(arrayOfByte);
      arrayOfByte = localByteBuffer.array();
      ((ArrayList)localObject2).add(bbdm.a((byte[])localObject3));
      ((ArrayList)localObject2).add(bbdm.a(arrayOfByte));
    ...
    for (int i = 1;; i = 0)
    {
      ...
      ((ArrayList)localObject2).add(bbdm.a(((ByteBuffer)localObject3).array()));
