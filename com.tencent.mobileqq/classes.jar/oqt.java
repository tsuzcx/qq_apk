...
public class oqt
  extends oql<DynamicChannelDataModel>
{
  ...
  protected TemplateBean a(DynamicChannelDataModel paramDynamicChannelDataModel)
  {
    ...
    if ((paramDynamicChannelDataModel.mTemplateBean != null) && (!((rpr)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext.getTemplateFactory()).a(paramDynamicChannelDataModel.mTemplateBean))) {
    ...
    {
      localJSONObject = oqn.a(paramDynamicChannelDataModel.proteusData);
      localTemplateBean = oqn.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, localJSONObject, ReadInJoyDynamicChannelBaseFragment.a(paramDynamicChannelDataModel.channelID));
  ...
  public void a(ProteusItemView paramProteusItemView, int paramInt1, DynamicChannelDataModel paramDynamicChannelDataModel, VafContext paramVafContext, int paramInt2)
  {
    ...
    if (localObject != null)
    {
      ...
      if (localTemplateBean != null)
      {
        ...
        if (!localTemplateBean.equals(localObject))
        {
          ...
          if (paramDynamicChannelDataModel != null)
          {
            paramDynamicChannelDataModel.setBackgroundDrawable(paramVafContext.getContext().getResources().getDrawable(2130841262));
    ...
    if (localTemplateBean != null) {
      olo.a((Container)localObject, paramDynamicChannelDataModel, localTemplateBean);
    }
    olo.a((Container)localObject, paramVafContext, localTemplateBean);
    bfwu.a();
  }
