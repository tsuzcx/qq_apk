...
public class axan
{
  ...
  public static MessageForQQWalletMsg a(String paramString1, String paramString2)
  {
    try
    {
      ...
      {
        MessageForQQWalletMsg localMessageForQQWalletMsg = (MessageForQQWalletMsg)axas.a(-2025);
  ...
  public static MessageForVIPDonate a(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        MessageForVIPDonate localMessageForVIPDonate = (MessageForVIPDonate)axas.a(-2047);
        ...
        if (localJSONObject.has("title"))
        {
          ...
          localMessageForVIPDonate.msgData = akwa.a(localVIPDonateMsg);
    ...
    for (;;)
    {
      ...
      if (paramList != null)
      {
        ...
        if (paramList.str.has())
        {
          ...
          if (paramBoolean)
          {
            str = axau.a(paramList, false);
            localObject = paramList;
            if (str.length() > 0)
            {
              localObject = (MessageForText)axas.a(-1000);
  ...
  private void a(im_msg_body.Elem paramElem, List<MessageRecord> paramList, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, axaw paramaxaw)
  {
    ...
    if (localObject != null)
    {
      ...
      if (i == 1)
      {
        ...
        {
          paramStringBuilder = (bduf)this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getManager(165);
          if (!paramStringBuilder.a.containsKey(paramElem)) {
            paramStringBuilder.a(new BmqqAccountType(paramElem, 1));
          }
        }
        if ((paramaxaw != null) && (paramaxaw.jdField_a_of_type_Int == 1024)) {
          paramaxaw.jdField_a_of_type_Int = 1025;
        }
      }
    ...
    while (!QLog.isColorLevel()) {
      try
      {
        ...
        if ((i == 8) && (paramElem.qidian_group_msg.has()))
        {
          ...
          axaq.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, l1, k, l2, m);
          if (j != 0)
          {
            paramStringBuilder = (bdvn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(85);
        ...
        if ((i == 11) && (paramElem.msg_gray_msg.has()))
        {
          ...
          bdwa.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1), paramStringBuilder, 1024, ((StringBuilder)localObject).toString());
        }
        if (paramElem.str_check_id.has()) {
          bdwa.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramList, paramMsg, paramaxaw, paramElem);
        }
        if ((paramaxaw != null) && (paramaxaw.jdField_a_of_type_Int == 1024) && (paramElem.str_ext_nick_name.has()))
        {
  ...
  {
    BaseApplication.getContext().getString(2131694856);
    boolean bool;
          ...
          for (int k = paramNotOnlineImage.uint32_file_id.get();; k = 0)
          {
            ...
            for (;;)
            {
                ...
                if (paramNotOnlineImage.pic_md5.has())
                {
                  ...
                  if (localObject2 != null)
                  {
                    ...
                    if (localObject2.length > 0) {
                      paramMsg = bbea.a((byte[])localObject2);
                    }
                  }
                }
                Object localObject2 = aywk.a(paramElem, j, 1, false, paramElem, paramMsg, "picplatform", str1, str2, str3, str4, i5, 0);
              ...
              for (;;)
              {
                ...
                paramElem = (MessageForPic)axas.a(-2000);
                if (bool) {
                  ajwb.a(paramElem, false);
                }
                ...
                axrn.a(BaseApplication.getContext()).a(paramNotOnlineImage, "actMessageEvent", false, 0L, 0L, paramElem, "");
                return;
                label1192:
                j = n;
                k = m;
  ...
  public axao a(List<im_msg_body.Elem> paramList, StringBuilder paramStringBuilder, long paramLong, azml paramazml)
  {
    axao localaxao = new axao(this);
    localaxao.jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText$SourceMsgInfo = a(paramList, paramStringBuilder);
    axap localaxap = new axap();
    ArrayList localArrayList = localaxap.jdField_a_of_type_JavaUtilArrayList;
    StringBuilder localStringBuilder = a(null, paramList, paramStringBuilder, paramLong, paramazml, localaxap, null);
    if ((localArrayList != null) && (localArrayList.size() == 2)) {
      if (localArrayList.get(0) != null)
      {
        ...
        if (localArrayList.get(1) != null) {
          localaxao.jdField_a_of_type_ArrayOfByte = ((byte[])localArrayList.get(1));
        }
      }
    }
    for (paramStringBuilder = paramList;; paramStringBuilder = null)
    {
      if ((localStringBuilder.length() > 0) && (localaxao.jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText$SourceMsgInfo != null))
      {
        localaxao.jdField_a_of_type_JavaLangString = localStringBuilder.toString();
        if ((TextUtils.isEmpty(localaxao.jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText$SourceMsgInfo.mAnonymousNickName)) && (paramStringBuilder != null) && (!TextUtils.isEmpty(localaxao.jdField_a_of_type_JavaLangString)) && (localaxao.jdField_a_of_type_JavaLangString.length() > paramStringBuilder.textLen + 1))
        {
          localaxao.jdField_a_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo = paramStringBuilder;
          localaxao.b = localaxao.jdField_a_of_type_JavaLangString.substring(0, paramStringBuilder.textLen + 1);
          localaxao.jdField_a_of_type_JavaLangString = localaxao.jdField_a_of_type_JavaLangString.substring(paramStringBuilder.textLen + 1);
          if ((paramStringBuilder.isIncludingMe(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getLongAccountUin())) && (localaxap.jdField_a_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo == null)) {
            paramazml.jdField_a_of_type_Azmm.a = -1L;
          }
        }
      }
      return localaxao;
    ...
    if (localMarketFace != null)
    {
      ...
      catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
      {
        try
        {
          for (;;)
          {
            paramStringBuilder.msgData = akwa.a(paramElem);
      ...
      if (localResvAttr.uint32_has_ip_product.get() == 1)
      {
        ...
        paramStringBuilder = (MessageForMarketFace)axas.a(-2007);
        ...
        if ((paramElem.mobileparam != null) && (paramElem.mobileparam.length > 0)) {
          axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app, "CliOper", "", "", "MbJieshou", "MbXiaoxi", 0, 0, "", "", "", "");
        }
      }
    }
    label593:
  ...
  public MessageForDeliverGiftTips a(String paramString1, String paramString2, im_msg_body.DeliverGiftMsg paramDeliverGiftMsg, List<MessageRecord> paramList, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg)
  {
    ...
    {
      paramStringBuilder = (MessageForDeliverGiftTips)axas.a(-2035);
    ...
    for (;;)
    {
      ...
      paramString1 = (bamx)this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getManager(81);
      if (paramString1 != null)
      {
        ...
        if (paramStringBuilder.grayTipsEntity.highlightNum != 0) {
          bamx.a(paramStringBuilder, paramStringBuilder.grayTipsEntity.highlightItems);
        }
        if ((paramStringBuilder instanceof MessageForTroopGift)) {
      ...
      {
        paramDeliverGiftMsg = Pattern.compile(ajya.a(2131706657));
      ...
      paramStringBuilder = (MessageForTroopGift)axas.a(-2038);
  ...
  public String a(List<im_msg_body.Elem> paramList)
  {
    ...
    for (;;)
    {
      ...
      if (((im_msg_body.Text)localObject).str.has()) {
        localStringBuilder1.append(axau.a(((im_msg_body.Text)localObject).str.get().toStringUtf8(), false));
      }
      continue;
      int m;
  ...
  public StringBuilder a(StringBuilder paramStringBuilder1, List<im_msg_body.Elem> paramList, StringBuilder paramStringBuilder2, long paramLong, azml paramazml, axap paramaxap, ArrayList<MessageForText.AtTroopMemberInfo> paramArrayList)
  {
    axap localaxap = paramaxap;
    if (paramaxap == null) {
      localaxap = new axap();
    }
    Object localObject2 = null;
    Object localObject1 = localaxap.jdField_a_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo;
    paramaxap = null;
    ...
    if (((im_msg_body.Text)localObject1).str.has()) {
      localStringBuilder.append(axau.a(((im_msg_body.Text)localObject1).str.get().toStringUtf8(), false));
    }
    label219:
    int k;
    int j;
    ...
    if (((im_msg_body.Text)localObject1).attr_6_buf.has())
    {
      ...
      if (localObject1 != null)
      {
        ...
        if ((paramazml != null) && ((paramazml.jdField_a_of_type_Int == 3000) || (paramazml.jdField_a_of_type_Int == 1)) && (paramArrayList != null) && (localObject2 != null) && (localObject2.length != 0))
        {
          n = bbmx.a((byte[])localObject2, 0);
          k = 2;
          j = 0;
          if ((j < n) && (k < 2048))
          {
        ...
        if ((paramazml == null) || ((!paramazml.jdField_a_of_type_Azmm.a(paramLong)) && (!paramazml.f.a(paramLong)) && (paramList != null)) || (localObject2 == null) || (localObject2.length == 0)) {
          break label1358;
        }
        int n = bbmx.a((byte[])localObject2, 0);
        k = 2;
        j = 0;
    ...
    for (;;)
    {
      localObject1 = paramaxap;
      paramaxap = paramList;
      paramList = paramStringBuilder1;
      paramStringBuilder1 = (StringBuilder)localObject1;
      label448:
      localObject1 = paramaxap;
      paramaxap = paramStringBuilder1;
      paramStringBuilder1 = (StringBuilder)localObject1;
      break;
      localObject2 = null;
      break label219;
      ...
      if (localAtTroopMemberInfo.isIncludingAll()) {
        paramazml.f.a = paramLong;
      }
      if ((localAtTroopMemberInfo.isIncludingMe(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getLongAccountUin())) && (paramazml.jdField_a_of_type_Azmm != null))
      {
        paramazml.jdField_a_of_type_Azmm.a = paramLong;
      ...
      for (;;)
      {
        ...
        if (((im_msg_body.Elem)localObject1).face.has())
        {
          ...
          localObject1 = paramStringBuilder1;
          paramStringBuilder1 = paramaxap;
          paramaxap = (axap)localObject1;
          break label448;
        }
        ...
        if (((im_msg_body.Elem)localObject1).online_image.has())
        {
          ...
          localStringBuilder.append(BaseApplication.getContext().getString(2131694856));
          localObject1 = paramStringBuilder1;
          paramStringBuilder1 = paramaxap;
          paramaxap = (axap)localObject1;
          break label448;
        ...
        if (((im_msg_body.Elem)localObject1).bankcode_ctrl_info.has())
        {
          ...
          break label448;
          label1207:
          localaxap.jdField_a_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo = paramList;
          paramList = localaxap.jdField_a_of_type_JavaUtilArrayList;
          if ((paramList != null) && ((paramStringBuilder1 != null) || (paramaxap != null)))
          {
            if (!paramList.isEmpty()) {
              break label1255;
            }
            paramList.add(paramStringBuilder1);
            paramList.add(paramaxap);
          }
          label1255:
  ...
  public void a(MessageHandler paramMessageHandler, List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, azml paramazml)
  {
    paramList = a(paramList, paramStringBuilder, paramMsg.msg_head.msg_seq.get(), paramazml);
    ...
    {
      paramStringBuilder = (ChatMessage)axas.a(-1049);
      paramStringBuilder.msg = paramList.jdField_a_of_type_JavaLangString;
      paramazml = (MessageForReplyText)paramStringBuilder;
    }
    try
    {
      paramazml.extLong |= 0x1;
      if (paramMsg.getSourceMsg() != null)
      {
        paramazml.setSourceMessageRecord(paramMsg.unPackSourceMsg(paramMessageHandler.app));
        if ((paramazml.getSourceMessage() != null) && (apug.a(paramazml.getSourceMessage())))
        {
          paramMessageHandler = paramazml.getSourceMessage().getExtInfoFromExtStr("_m_ForwardFileType");
          ChatMessage localChatMessage = apug.a((ChatMessage)paramazml.getSourceMessage());
          apvm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localChatMessage, paramazml.getSourceMessage());
          if ((!TextUtils.isEmpty(paramMessageHandler)) && (localChatMessage != null))
          {
            ...
            if ((i == 1) || (i == 2))
            {
              ...
              apug.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localChatMessage.uniseq, localChatMessage.frienduin, localChatMessage.istroop, (ChatMessage)paramazml.getSourceMessage());
            }
          }
        }
      }
      paramMessageHandler = bbea.a(akwa.a(paramMsg));
      paramazml.mSourceMsgInfo = paramMsg;
      paramazml.saveExtInfoToExtStr("sens_msg_source_msg_info", paramMessageHandler);
      if (QLog.isColorLevel()) {
        QLog.d("SendMsgBtn", 2, "reply:" + paramazml + " sourceMsg=" + paramazml.getSourceMessage());
      }
    }
    ...
    if (paramList.jdField_a_of_type_ArrayOfByte != null) {
      paramStringBuilder.saveExtInfoToExtStr("sens_msg_ctrl_info", bbea.a(paramList.jdField_a_of_type_ArrayOfByte));
    }
    paramList1.add(paramStringBuilder);
    if (QLog.isColorLevel()) {
      QLog.d("DecodeMsg", 2, "reply msgRand = " + axau.a(paramStringBuilder.msgUid) + ", msgUid = " + paramStringBuilder.msgUid);
    }
  }
  
  public void a(MessageHandler paramMessageHandler, List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, azml paramazml, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      if (localIterator.hasNext())
      {
        ...
        if (localElem.custom_face.has())
        {
          ...
          {
            localMessageForText = (MessageForText)axas.a(-1000);
          ...
          a(localElem, null, localArrayList, paramStringBuilder, paramMsg, paramBoolean, paramazml);
        }
    ...
    for (;;)
    {
      ...
      localObject1 = a((StringBuilder)localObject1, (List)localObject3, paramStringBuilder, paramMsg.msg_head.msg_seq.get(), paramazml, localaxap, (ArrayList)localObject2);
      break;
      if (localElem.general_flags.has())
      {
        ...
        if (((StringBuilder)localObject1).length() > 0)
        {
          localObject3 = (MessageForText)axas.a(-1000);
          ...
          if (paramazml != null) {
            bafv.a(paramazml.jdField_a_of_type_Int, (ArrayList)localObject2, (ChatMessage)localObject3);
          }
          localArrayList.add(localObject3);
          ((StringBuilder)localObject1).delete(0, ((StringBuilder)localObject1).length());
        }
        localObject2 = localaxap.jdField_a_of_type_JavaUtilArrayList;
        ...
        for (;;)
        {
          ...
          if (paramList != null) {
            paramStringBuilder = (MessageForReplyText)axas.a(-1049);
          }
          try
          {
            ...
            if (paramList.getSourceMsg() != null)
            {
              ...
              if ((paramStringBuilder.getSourceMessage() != null) && (apug.a(paramStringBuilder.getSourceMessage())))
              {
                localObject3 = paramStringBuilder.getSourceMessage().getExtInfoFromExtStr("_m_ForwardFileType");
                localChatMessage = apug.a((ChatMessage)paramStringBuilder.getSourceMessage());
                apvm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localChatMessage, paramStringBuilder.getSourceMessage());
                if ((!TextUtils.isEmpty((CharSequence)localObject3)) && (localChatMessage != null))
                {
                  ...
                  if ((i == 1) || (i == 2))
                  {
                    ...
                    apug.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localChatMessage.uniseq, localChatMessage.frienduin, localChatMessage.istroop, (ChatMessage)paramStringBuilder.getSourceMessage());
                  }
                }
              }
            }
            paramStringBuilder.saveExtInfoToExtStr("sens_msg_source_msg_info", bbea.a(akwa.a(paramList)));
          }
          ...
          if (TextUtils.isEmpty(paramStringBuilder.mSourceMsgInfo.mAnonymousNickName))
          {
            ...
            if (localObject2 != null)
            {
              ...
              localObject3 = (MessageForReplyText)axas.a(-1049);
              ...
              if ((!TextUtils.isEmpty(((MessageForReplyText)localObject3).msg)) && (((MessageForReplyText)localObject3).msg.length() >= ((MessageForText.AtTroopMemberInfo)localObject2).textLen + 1))
              {
                ...
                if ((((MessageForText.AtTroopMemberInfo)localObject2).isIncludingMe(paramMessageHandler.app.getLongAccountUin())) && (localaxap.jdField_a_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo == null)) {
                  paramazml.jdField_a_of_type_Azmm.a = -1L;
                }
              }
          ...
          try
          {
            if (localArrayList.size() > 0)
            {
              ...
              localObject3 = bbbr.a(paramStringBuilder);
              if (QLog.isColorLevel()) {
              ...
              ((ajsi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(53)).a(paramStringBuilder);
            }
          }
          catch (Exception paramList)
          {
                  ...
                  if (j != 0)
                  {
                    ...
                    while (paramStringBuilder.hasNext())
                    {
                      ...
                      if ((paramMsg.msgtype != -1000) && (paramMsg.msgtype != -1049) && (paramMsg.msgtype != -2000))
                      {
                        ...
                        {
                          paramList1.add(axaq.a(paramList, paramMessageHandler, paramazml));
                          paramList.clear();
                    ...
                    if (paramList.size() > 0)
                    {
                      ...
                      paramMessageHandler = axaq.a(paramList, (byte[])localObject1, paramazml);
                  ...
                  for (;;)
                  {
                    ...
                    while (paramMessageHandler.hasNext())
                    {
                      ...
                      if (((paramList instanceof MessageForText)) && (k == 0)) {
                        paramList.saveExtInfoToExtStr("sens_msg_ctrl_info", bbea.a((byte[])localObject1));
                      }
  ...
  public void a(ArrayList<String> paramArrayList, List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, azml paramazml, axaw paramaxaw)
  {
    if (paramArrayList.contains("lifeOnline")) {
      a(paramList, paramList1, paramStringBuilder, paramMsg, paramazml);
    }
    ...
    if (paramArrayList.hasNext())
    {
      ...
      if (paramList.crm_elem.has()) {
        a(paramList, paramList1, paramStringBuilder, paramMsg, paramaxaw);
      }
      if (paramList.general_flags.has())
      {
        ...
        {
          paramazml = new generalflags.ResvAttr();
          j = n;
        }
      }
      try
      {
        paramazml.mergeFrom(paramList.general_flags.bytes_pb_reserve.get().toByteArray());
        j = n;
        if (paramazml.float_sticker_x.has())
        {
          j = n;
          localObject1 = new EmojiStickerManager.StickerInfo();
          j = n;
          ((EmojiStickerManager.StickerInfo)localObject1).x = paramazml.float_sticker_x.get();
          j = n;
          if (!paramazml.float_sticker_y.has()) {
            break label2550;
          }
          j = n;
          f = paramazml.float_sticker_y.get();
          label519:
          j = n;
          ((EmojiStickerManager.StickerInfo)localObject1).y = f;
          j = n;
          if (!paramazml.float_sticker_width.has()) {
            break label2556;
          }
          j = n;
          f = paramazml.float_sticker_width.get();
          label559:
          j = n;
          ((EmojiStickerManager.StickerInfo)localObject1).width = f;
          j = n;
          if (!paramazml.float_sticker_height.has()) {
            break label2562;
          }
          j = n;
          f = paramazml.float_sticker_height.get();
          label599:
          j = n;
          ((EmojiStickerManager.StickerInfo)localObject1).height = f;
          j = n;
          if (!paramazml.uint32_sticker_rotate.has()) {
            break label2568;
          }
          j = n;
          i = paramazml.uint32_sticker_rotate.get();
          label639:
          j = n;
          ((EmojiStickerManager.StickerInfo)localObject1).rotate = i;
          j = n;
          if (!paramazml.uint64_sticker_host_msgseq.has()) {
            break label2574;
          }
          j = n;
          l = paramazml.uint64_sticker_host_msgseq.get();
          label679:
          j = n;
          ((EmojiStickerManager.StickerInfo)localObject1).hostMsgSeq = l;
          j = n;
          if (!paramazml.uint64_sticker_host_msguid.has()) {
            break label2580;
          }
          j = n;
          l = paramazml.uint64_sticker_host_msguid.get();
          label719:
          j = n;
          ((EmojiStickerManager.StickerInfo)localObject1).hostMsgUid = l;
          j = n;
          if (!paramazml.uint64_sticker_host_time.has()) {
            break label2586;
          }
          j = n;
          l = paramazml.uint64_sticker_host_time.get();
          label759:
          j = n;
        ...
        j = n;
        if (!paramazml.uint32_mobile_custom_font.has()) {
          break label2592;
        }
        j = n;
        l = paramazml.uint32_mobile_custom_font.get() & 0xFFFFFFFF;
        j = n;
        if (!paramList1.isEmpty())
        {
          j = n;
        ...
        j = n;
        QLog.d("DecodeMsg", 2, "vip_font_id = " + l + " fontId = " + ho.a(l) + " type = " + ho.b(l));
      }
      catch (InvalidProtocolBufferMicroException paramazml)
      {
        for (;;)
        {
          Object localObject1;
      ...
      j = i;
      if (paramazml.uint64_subfont_id.has())
      {
        j = i;
        l = paramazml.uint64_subfont_id.get();
        j = i;
        if (!paramList1.isEmpty())
        {
          j = i;
      ...
      j = i;
      if (paramazml.uint32_diy_font_timestamp.has())
      {
        j = i;
        l = paramazml.uint32_diy_font_timestamp.get();
        j = i;
        if (!paramList1.isEmpty())
        {
          j = i;
        ...
        j = i;
        if (paramazml.uint32_tail_key.has())
        {
          j = i;
          if (2 == paramazml.uint32_tail_key.get())
          {
            j = i;
            if (paramazml.uint32_show_tail_flag.has())
            {
              j = i;
              if (1 != paramazml.uint32_show_tail_flag.get())
              {
                j = i;
                paramazml.uint32_tail_key.clear();
                j = i;
                if (QLog.isColorLevel())
                {
                  j = i;
        ...
        {
          j = i;
          k = paramazml.uint32_tail_key.get();
          j = i;
          if (!paramList1.isEmpty())
          {
            j = i;
        ...
        j = i;
        if (paramazml.uint32_bot_message_class_id.has())
        {
          j = i;
          k = paramazml.uint32_bot_message_class_id.get();
          j = i;
          if (!paramList1.isEmpty())
          {
            j = i;
        ...
        j = i;
        if (paramazml.uint32_holiday_flag.has())
        {
          j = i;
          k = paramazml.uint32_holiday_flag.get();
          if (k == 1)
          {
            j = i;
            if (!paramList1.isEmpty())
            {
              j = i;
              ((MessageRecord)paramList1.get(0)).saveExtInfoToExtStr(axaf.c, String.valueOf(k));
            }
          }
          j = i;
          if (QLog.isColorLevel())
        ...
        j = i;
        if (paramazml.uint32_service_msg_type.has())
        {
          j = i;
          k = paramazml.uint32_service_msg_type.get();
          j = i;
          if (!paramList1.isEmpty())
          {
            j = i;
            ((MessageRecord)paramList1.get(0)).saveExtInfoToExtStr(axaf.w, String.valueOf(k));
          }
          j = i;
          ((StringBuilder)localObject1).append("---uint32_service_msg_type = ").append(k).append("---");
        }
        j = i;
        if (paramazml.uint32_service_msg_remind_type.has())
        {
          j = i;
          k = paramazml.uint32_service_msg_remind_type.get();
          j = i;
          if (!paramList1.isEmpty())
          {
            j = i;
            ((MessageRecord)paramList1.get(0)).saveExtInfoToExtStr(axaf.x, String.valueOf(k));
          }
          j = i;
          ((StringBuilder)localObject1).append("---uint32_service_msg_remind_type = ").append(k).append("---");
        }
        j = i;
        if (paramazml.bytes_service_msg_name.has())
        {
          j = i;
          localObject2 = paramazml.bytes_service_msg_name.get().toStringUtf8();
          j = i;
          if (!paramList1.isEmpty())
          {
            j = i;
            ((MessageRecord)paramList1.get(0)).saveExtInfoToExtStr(axaf.y, (String)localObject2);
          }
          j = i;
    ...
    try
    {
      if (paramazml.uint32_msg_info_flag.has())
      {
        j = i;
        k = paramazml.uint32_msg_info_flag.get();
        j = i;
        if (!paramList1.isEmpty())
        {
          j = i;
    ...
    int k = i;
    int j = i;
    if (paramazml.uint32_comment_flag.has())
    {
      k = i;
      j = i;
      if (paramazml.uint64_comment_location.has())
      {
        k = i;
        j = i;
        if (!paramList1.isEmpty())
        {
          j = i;
          if (paramazml.uint32_comment_flag.get() != 1) {
            break label2715;
          }
        }
      }
    ...
    {
      j = i;
      l = paramazml.uint64_comment_location.get();
      j = i;
      ...
      try
      {
        ...
        j = i;
        ((oidb_0xdea.PassThrough)localObject2).mergeFrom(paramazml.bytes_pass_through.get().toByteArray());
        j = i;
        ((MessageForReplyText)localObject1).barrageSourceMsgType = ((oidb_0xdea.PassThrough)localObject2).entrance.get();
      }
      catch (Exception paramazml)
      {
        for (;;)
        {
          j = i;
          QLog.i("DecodeMsg", 1, "handleGeneralSettingFlags fail, " + paramazml);
        }
      }
      k = i;
      j = i;
      ...
      if (k == 0)
      {
        ...
        if (l >= 0L)
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.d("DecodeMsg", 2, "old vip_font_id = " + l + " fontId = " + ho.a(l) + " type = " + ho.b(l));
          }
        }
      }
      ...
      amnr.a(paramMsg, paramList, paramList1, this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app);
      break;
      label2550:
      f = 0.0F;
      break label519;
            ...
            catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
            {
              try
              {
                do
                {
                  ...
                  localObject1 = (MessageForShortVideo)axas.a(-2022);
                  ...
                  ((MessageForShortVideo)localObject1).msg = axds.b;
                  ...
                  try
                  {
                    ...
                    {
                      String str = bbbr.a((byte[])localObject3);
                      if (QLog.isColorLevel()) {
                    ...
                    ((ajsi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(53)).a((byte[])localObject3);
                  }
                  catch (Exception paramList)
                  {
                    for (;;)
                  ...
                  if (((MessageForShortVideo)localObject1).redBagType == LocalMediaInfo.REDBAG_TYPE_GET)
                  {
                    ...
                    axjs.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false);
              ...
              catch (Exception localException)
              {
                for (;;)
                {
                  if (QLog.isColorLevel())
                  {
                    ...
                    continue;
                    label1277:
                    localException.msg = axds.jdField_a_of_type_JavaLangString;
                  }
                }
              }
            }
  ...
  public void a(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg)
  {
    ...
    for (;;)
    {
      ...
      if (akas.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app, 3000, String.valueOf(l1), String.valueOf(l4), l6, l7)) {
        continue;
      }
      paramStringBuilder = "";
      try
      {
        ...
        if (paramMsg.msg_body.has())
        {
          ...
          if (paramMsg.rich_text.attr.has()) {
            l2 = axau.a(((im_msg_body.Attr)paramMsg.rich_text.attr.get()).random.get());
          }
        }
        paramMsg = (MessageForFile)axas.a(-2005);
      ...
      catch (UnsupportedEncodingException localInvalidProtocolBufferMicroException)
      {
        try
        {
          ...
          {
            bool = true;
            paramMsg.msg = aywk.a(paramStringBuilder, l1, 0, bool);
            paramMsg.doParse();
          }
        }
        catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
        {
          try
          {
            for (;;)
            {
              paramMsg.fileName = apug.a(new String(paramList.bytes_filename.get().toByteArray(), "UTF-8"));
              paramList1.add(paramMsg);
              ((aygx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(272)).a(paramMsg);
              if (!QLog.isColorLevel()) {
                break;
              }
  ...
  public void a(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, azml paramazml)
  {
    ...
    for (;;)
    {
      ...
      if ((localElem.life_online.has()) && (localElem.life_online.uint32_ack.has()) && (localElem.life_online.uint32_ack.get() == 1))
      {
        if (localElem.life_online.uint64_unique_id.has())
        {
          ...
          nnu.a().a(BaseApplication.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app, l1, l2, l3, l4, 1, null);
        }
      }
      else
      {
        ...
        paramazml = localElem.life_online.gdt_cli_data.get().toStringUtf8();
        ...
        if (paramazml.length() <= 100) {
          break label1714;
        }
        paramStringBuilder = paramazml.substring(0, 100);
        i2 = j;
      }
      for (;;)
      {
          ...
          if ((localElem.life_online.uint64_bitmap.get() & 0x1000) == 4096L)
          {
            ...
            if (i1 != 0)
            {
              ...
              if (QLog.isColorLevel())
              {
                ...
                paramazml = Long.valueOf(localElem.life_online.uint64_bitmap.get());
                QLog.d("DecodeMsg", 2, paramazml);
              }
              ThreadManager.getSubThreadHandler().postDelayed(new MessagePBElemDecoder.1(this), 1000L);
            }
            if (!paramList1.isEmpty())
            {
              paramazml = (MessageRecord)paramList1.get(0);
              paramazml.extLong |= 0x1;
              ...
              if (m != 0)
              {
                ...
                label1132:
                paramazml.saveExtInfoToExtStr("gdt_singleAd", paramStringBuilder);
                paramazml = (MessageRecord)paramList1.get(0);
                if (i2 == 0) {
                  break label1591;
                }
                paramStringBuilder = "1";
                paramazml.saveExtInfoToExtStr("gdt_mulAd", paramStringBuilder);
                paramazml = (MessageRecord)paramList1.get(0);
                if (k == 0) {
                  break label1598;
                }
                paramStringBuilder = "1";
                paramazml.saveExtInfoToExtStr("gdt_followAd", paramStringBuilder);
  ...
  public void a(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, azml paramazml, boolean paramBoolean)
  {
    int i = 0;
    im_msg_body.Elem localElem = null;
    ArrayList localArrayList = new ArrayList();
    ...
    if (localIterator.hasNext())
    {
      ...
      if (localElem.market_face.has())
      {
        ...
        {
          a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, localArrayList, paramList1, paramStringBuilder, paramMsg, paramazml, paramBoolean);
      ...
      for (;;)
      {
        for (;;)
        {
          ...
          if ((i != 0) && (localElem.text.has()) && (paramList != null))
          {
            ...
            try
            {
              ((MessageRecord)paramList1.get(paramList1.size() - 1)).msgData = akwa.a(paramList);
              if (QLog.isColorLevel()) {
  ...
  public void a(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      localObject = (MessageForShakeWindow)axas.a(-2020);
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if ((paramStringBuilder.uint32_sys_head_id.has()) && (paramStringBuilder.uint32_head_flag.has()))
          {
            ...
            paramList = (akvq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(199);
  ...
  public void a(im_msg_body.Elem paramElem, im_msg_body.CustomFace paramCustomFace, List<MessageRecord> paramList, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, boolean paramBoolean, azml paramazml)
  {
    if (paramElem != null) {}
    for (boolean bool1 = paramElem.hc_flash_pic.has();; bool1 = false)
    {
      ...
      for (boolean bool2 = true;; bool2 = false)
      {
        ...
        if (paramBoolean)
        {
          ...
          axrn.a(BaseApplication.getContext()).a(paramCustomFace, "actMessageEvent", false, 0L, 0L, paramElem, "");
          if (QLog.isColorLevel()) {
        ...
        bbea.a((byte[])localObject1);
        bbea.a((byte[])localObject3);
        int i3 = paramCustomFace.uint32_origin.get();
        localObject3 = ayvw.a(paramElem, 0L, 1, false, paramElem, (String)localObject2, "picplatform", str3, str4, str1, str2, i3, 0);
        localObject1 = new RichMsg.PicRec();
        ((RichMsg.PicRec)localObject1).localPath.set(paramElem);
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            try
            {
              ...
              {
                paramElem = (MessageForPic)axas.a(-5015);
                ...
                paramElem.istroop = 1;
                paramCustomFace = (bahf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(223);
                if (paramCustomFace != null) {
                  paramCustomFace.a((baht)paramElem, false);
                }
                i = 1;
                if (i == 0)
                {
                ...
                if (bool1) {
                  ajyi.a(paramElem, false);
                }
                if (bool2) {
                  ajwb.a(paramElem, false);
                }
                if (paramazml != null) {
                  paramElem.istroop = paramazml.jdField_a_of_type_Int;
                }
                paramElem.msgData = ((RichMsg.PicRec)localObject1).toByteArray();
                paramElem.parse();
                paramList.add(paramElem);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          paramList1 = (bahf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(223);
          if (paramList1 != null) {
  ...
  public void b(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder)
  {
    ...
    for (;;)
    {
      ...
      paramList = (MessageForLightVideo)axas.a(-2071);
      paramList.msgtype = -2071;
      paramList.msgData = localVideoFile.toByteArray();
      paramList.msg = BaseApplication.getContext().getString(2131691294);
      paramList.parse();
      paramList1.add(paramList);
      if (!QLog.isColorLevel()) {
        break;
  ...
  public void b(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg)
  {
    ...
    for (;;)
    {
        ...
        do
        {
          do
          {
            ...
            default: 
              return;
            case 3: 
              paramList = BaseApplication.getContext().getString(2131694856);
              paramStringBuilder = (MessageForText)axas.a(-1000);
          ...
          i = bbmx.a((byte[])localObject3, 1);
          j = localObject3[3];
          localObject2 = new byte[i - 1];
          bbmx.a((byte[])localObject2, 0, (byte[])localObject3, 4, i - 1);
      ...
      paramMsg = (MessageForPubAccount)axas.a(-3006);
      ...
      for (;;)
      {
        for (;;)
        {
          try
          {
            paramMsg.msgData = sen.a(paramStringBuilder);
          ...
          for (;;)
          {
            ...
            int i1 = bbmx.a(localStringBuilder, i + 1);
            j = k - (i1 + 3);
            k = i1 + 3 + i;
            if (n != 1)
            {
            ...
            else
            {
              ...
              bbmx.a(paramList, 0, localStringBuilder, i + 3, i1);
          ...
          try
          {
            ...
            paramStringBuilder.dspFileName = apug.a(paramStringBuilder.dspFileName);
            paramStringBuilder.dspFileSize = new String(((ByteStringMicro)paramList.rpt_bytes_abstact.get(0)).toByteArray());
            bajs.a(paramMsg.msg_head.group_info.group_code.get()).a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app, paramStringBuilder.fileUrl, paramStringBuilder);
            ...
            if (paramList != null)
            {
              ...
              localObject2 = (MessageForTroopFile)axas.a(-2017);
              ((MessageForTroopFile)localObject2).msgtype = -2017;
              ((MessageForTroopFile)localObject2).msg = ajya.a(2131706660);
            }
          }
          catch (Exception localException1)
          {
            try
            {
              ((MessageForTroopFile)localObject2).msgData = akwa.a(paramStringBuilder);
  ...
  public void b(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, azml paramazml)
  {
    int j = 0;
    Object localObject1 = null;
    ...
    for (;;)
    {
      ...
      for (int i = ((im_msg_body.CommonElem)localObject1).uint32_business_type.get();; i = 0)
      {
        ...
        try
        {
          ...
          {
            g(paramList, paramList1, paramStringBuilder, paramMsg, paramazml);
            return;
          }
        }
        catch (InvalidProtocolBufferMicroException paramList)
        ...
        localObject1 = null;
        localObject2 = axwj.a((byte[])localObject2, -1);
        if (localObject2 != null)
        {
          ...
          if (i > 0)
          {
            ...
            localObject3 = (MessageForArkFlashChat)axas.a(-5013);
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          try
          {
            ...
            f1 = f2;
            i2 = i5;
            localArrayList.add(Long.valueOf(bbbr.a(((Integer)localIterator.next()).intValue())));
            continue;
          ...
          localApolloMessage.peer_uin = bbbr.a(localApolloActMsg.uint32_peer_uin.get());
          localApolloMessage.sender_ts = bbbr.a(localApolloActMsg.uint32_sender_ts.get());
          localApolloMessage.peer_ts = bbbr.a(localApolloActMsg.uint32_peer_ts.get());
  ...
  public void c(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder)
  {
    ...
    for (;;)
    {
      ...
      localObject1 = axva.a(((im_msg_body.MarketTrans)localObject1).bytes_xml.get().toByteArray(), i);
      if (localObject1 == null)
      {
        if (QLog.isColorLevel()) {
          paramStringBuilder.append("c2cMsgContent.data:null;\n");
      ...
      paramList = (MessageForStructing)axas.a(-2011);
  ...
  public void c(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg)
  {
    ...
    for (paramList = (im_msg_body.CommonElem)paramMsg.common_elem.get();; paramList = null)
    {
      ...
      {
        paramStringBuilder.mergeFrom(paramList.bytes_pb_elem.get().toByteArray());
        paramList = (MessageForScribble)axas.a(-7001);
  ...
  public void c(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, azml paramazml)
  {
    Object localObject1 = null;
    Object localObject2 = paramList.iterator();
    Object localObject3;
    ...
    if (((hummer_commelem.MsgElemInfo_servtype19)localObject2).bytes_data.has())
    {
      ...
      if (localObject2 != null)
      {
        ...
        if (i > 0)
        {
          ...
          localObject3 = (MessageForArkBabyqReply)axas.a(-5016);
  ...
  public void d(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder)
  {
    ...
    do
    {
      ...
      localMessageForIncompatibleGrayTips = (MessageForIncompatibleGrayTips)axas.a(-5002);
  ...
  public void d(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, azml paramazml)
  {
    Object localObject2 = null;
    Object localObject1 = null;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          {
            return;
            paramList = (MessageForText)axas.a(-1000);
            paramList.msgtype = -1000;
            paramList.msg = BaseApplication.getContext().getString(2131693796);
            paramList1.add(paramList);
            return;
            if (ArkAppCenter.b())
            {
            ...
            localObject4 = (MessageForArkApp)axas.a(-5008);
  ...
  public void e(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder)
  {
    ...
    for (paramList = (im_msg_body.CommonElem)localElem.common_elem.get();; paramList = null)
    {
      ...
      {
        paramStringBuilder.mergeFrom(paramList.bytes_pb_elem.get().toByteArray());
        paramList = (MessageForQQStoryComment)axas.a(-2052);
  ...
  public void e(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, azml paramazml)
  {
    Object localObject2 = null;
    Object localObject3 = paramList.iterator();
    Object localObject1 = null;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localObject3 = axwj.a((byte[])localObject3, -1);
        if (localObject3 != null)
        {
  ...
  public void f(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, azml paramazml)
  {
    ...
    for (localObject1 = (im_msg_body.QQWalletMsg)((im_msg_body.Elem)localObject2).qqwallet_msg.get();; localObject1 = null)
    {
      ...
      if (n > 2000)
      {
        ...
        localMessageForQQWalletMsg = (MessageForQQWalletMsg)axas.a(-2025);
        localMessageForQQWalletMsg.msgtype = -2025;
      ...
      for (int i = 1;; i = 0)
      {
        if ((i != 0) && (paramazml != null) && (paramazml.c != null))
        {
          paramazml.c.a(paramMsg.msg_head.msg_seq.get(), localMessageForQQWalletMsg.msgseq);
          localMessageForQQWalletMsg.mMessageInfo = paramazml;
        }
        ...
        for (;;)
        {
          ...
          localObject2 = (agvx)this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getManager(125);
          if (localObject2 != null) {
            ((agvx)localObject2).a((im_msg_body.QQWalletAioBody)((im_msg_body.QQWalletMsg)localObject1).aio_body.get(), j, l, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_time.get(), i, str1);
          }
          label766:
          localMessageForQQWalletMsg.msg = localMessageForQQWalletMsg.getMsgSummary();
          localMessageForQQWalletMsg.msgData = localMessageForQQWalletMsg.getBytes();
        ...
        for (localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getCurrentAccountUin();; localObject2 = "")
        {
          if ((n == 10) && (localMessageForQQWalletMsg.mQQWalletTransferMsg.elem != null) && (!TextUtils.isEmpty(localMessageForQQWalletMsg.mQQWalletTransferMsg.elem.nativeAndroid)))
          {
            ...
            {
              agws.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)((HashMap)localObject3).get("tokenid"), ((im_msg_body.QQWalletMsg)localObject1).aio_body.uint64_senduin.get());
              if ((l == 0L) || (TextUtils.isEmpty((CharSequence)localObject2)) || (((String)localObject2).compareTo("" + l) == 0)) {
                break;
              }
              axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "friendpay.payaio.buyershow", 0, 0, "", "", "", "");
              break;
            }
          }
          ...
          axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "friendpay.askaio.payershow", 0, 0, "", "", "", "");
          break label766;
          label1423:
          ...
          if (paramList1.isEmpty())
          {
            i(paramList, paramList1, paramStringBuilder, paramMsg, paramazml);
            return;
          }
          paramList1.add(localMessageForQQWalletMsg);
          return;
    ...
    for (;;)
    {
      ...
      for (paramList = new hummer_commelem.MsgElemInfo_servtype16();; paramList = ((im_msg_body.Text)localObject).str.get().toStringUtf8()) {
        try
        {
          ...
          paramStringBuilder = (MessageForTroopStory)axas.a(-2057);
  ...
  public void g(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, azml paramazml)
  {
    if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          for (String str = ((ByteStringMicro)localObject1).toStringUtf8();; str = "")
          {
            ...
            {
              if ((!bbkk.a((String)localObject4)) && (!bbkk.a((String)localObject1)) && (!bbkk.a(str)))
              {
              ...
              for (boolean bool = true;; bool = false)
              {
                ...
                if ((((axaw)localObject1).jdField_a_of_type_Int == 1008) && (QLog.isColorLevel()))
                {
                ...
                for (i = 0;; i = localObject6.length)
                {
                  ...
                  try
                  {
                    ...
                    localObject7 = bbbr.a((byte[])localObject4);
                    if (QLog.isColorLevel()) {
                    ...
                    ((ajsi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(53)).a((byte[])localObject4);
                  }
                  catch (Exception localException2)
                  {
                    for (;;)
                    {
                      if (QLog.isColorLevel())
                      {
                        ...
                        {
                          if ((((axaw)localObject1).jdField_a_of_type_Int == 1008) && (!TextUtils.isEmpty(str)))
                          {
                            if (QLog.isColorLevel()) {
                              QLog.d("PaOldLongMsg", 2, "msgId=" + localMessageForStructing.uniseq + ", begin getEmptyGeneralStructMsg for PA oldLongMsg!");
                            }
                            localMessageForStructing.structingMsg = ((StructMsgForGeneralShare)axva.a());
                        ...
                        else
                        {
                          ...
                          localMessageForStructing.structingMsg = axva.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app, m, l2, (byte[])localObject6, -1);
                          if (QLog.isColorLevel()) {
                ...
                {
                  paramList = (MessageForTroopFee)axas.a(-2036);
                  paramStringBuilder = MessageForTroopFee.decodeMsgFromXmlBuff(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app, m, l2, (byte[])localObject6, -1);
                  if (paramStringBuilder != null) {
                ...
                {
                  if (QLog.isColorLevel()) {
                    QLog.d(akbj.class.getSimpleName(), 2, "Received flower message");
                  }
                ...
                {
                  if (QLog.isColorLevel()) {
                    QLog.i(akbj.class.getSimpleName(), 2, "decodePBMsgElems, groupCode:" + l2);
                  }
                  l3 = l1;
                  if (l2 <= 0L)
                  {
                    ...
                    paramList1.add(((akbj)this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getManager(124)).a(Long.toString(l1), Long.toString(l2), localMessageForStructing.istroop, localMessageForStructing.structingMsg));
                    l3 = l1;
                  }
                  label2239:
                  label2281:
                  do
                  {
                    for (;;)
                    {
                      ...
                      {
                        if (2171946401L == l3) {
                          sgg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForStructing, 11);
                        }
                      ...
                      if ((localMessageForStructing.structingMsg.mMsgServiceID == 80) && ((localMessageForStructing.structingMsg instanceof StructMsgForGeneralShare)))
                      {
                        if (sst.i())
                        {
                          paramList = (MessageForQQStory)axas.a(-2051);
                        ...
                        if (localObject3 != null)
                        {
                          ((im_msg_body.Text)localObject3).str.set(ByteStringMicro.copyFromUtf8(sst.a()));
                          return;
                        }
                        l3 = l1;
                        if (QLog.isColorLevel())
                      ...
                      else
                      {
                        ...
                        {
                          paramList = (MessageForTribeShortVideo)axas.a(-7002);
                        ...
                        {
                          paramList = (MessageForTroopPobing)axas.a(-2059);
                          ...
                          try
                          {
                            ...
                            paramList1.add(paramList);
                            localMessageForStructing.structingMsg = null;
                            new axrc(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_AIO").c("newman_join").d("exp_obj").a(new String[] { l2 + "" }).a();
                            new axrc(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_AIO").c("newman_join").d("exp_welcome").a(new String[] { l2 + "", "", "" + banb.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l2)) }).a();
                            return;
                          }
                        ...
                        {
                          paramList = (MessageForTroopSign)axas.a(-2054);
                        ...
                        if (localMessageForStructing.structingMsg.mMsgServiceID != 43)
                        {
                          if (((localMessageForStructing.structingMsg.mMsgServiceID == 83) || (localMessageForStructing.structingMsg.mMsgServiceID == 108) || (localMessageForStructing.structingMsg.mMsgServiceID == 114) || (localMessageForStructing.structingMsg.mMsgServiceID == 116)) && (!TextUtils.isEmpty(localMessageForStructing.structingMsg.mMsgActionData)))
                          {
                            ...
                            nol.a(null, "", "0X8007238", "0X8007238", 0, 0, (String)localObject1, "", "", "");
                            nol.a("0X8007238", "", (String)localObject1, "", "", "");
                          ...
                          else
                          {
                            ...
                            if ((localMessageForStructing.structingMsg instanceof StructMsgForGeneralShare))
                            {
                              ...
                              bafm.a().a((String)localObject3, null);
                              bafm.a().a(((StructMsgForGeneralShare)localObject2).atMembers);
                              l3 = l1;
                            }
                          }
                        }
                  ...
                  label3774:
                  label4065:
                  paramList = MessageForStarLeague.decodeMsgFromXmlBuff(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app, m, l2, (byte[])localObject6, -1);
                  paramList.msgData = paramList.getBytes();
                  paramList.msg = paramList.getSummaryMsg();
                  paramList1.add(paramList);
                  return;
                  ...
                  {
                    paramazml = new generalflags.ResvAttr();
                    paramazml.mergeFrom(localGeneralFlags.bytes_pb_reserve.get().toByteArray());
                    paramStringBuilder = paramMsg;
                    j = m;
                    if (paramazml.bytes_kpl_info.has())
                    {
                      paramStringBuilder = paramMsg;
                      j = m;
                      if (paramazml.bytes_kpl_info.has())
                      {
                        j = 1;
                        paramStringBuilder = paramazml.bytes_kpl_info.get().toStringUtf8();
                      }
                    }
                    paramList = paramStringBuilder;
                    i = j;
                    if (paramazml.bytes_oac_msg_extend.has())
                    {
                      localMessageForStructing.saveExtInfoToExtStr("report_key_bytes_oac_msg_extend", paramazml.bytes_oac_msg_extend.get().toStringUtf8());
                      i = j;
                      paramList = paramStringBuilder;
                    }
                  }
                  ...
                  if (k != 0)
                  {
                    ...
                    try
                    {
                      ...
                      {
                        paramList = (ChatMessage)axas.a(-1051);
                        ...
                        if (paramStringBuilder != null)
                        {
                          ...
                          for (;;)
                          {
                            if (paramStringBuilder.hasNext())
                            {
                              paramMsg = (axup)paramStringBuilder.next();
                              if ((paramMsg instanceof axuq))
                              {
                                paramMsg = ((axuq)paramMsg).jdField_a_of_type_JavaUtilArrayList;
                                if (paramMsg != null)
                                {
                                  paramMsg = paramMsg.iterator();
                                  if (paramMsg.hasNext())
                                  {
                                    paramazml = (axup)paramMsg.next();
                                    if (!(paramazml instanceof StructMsgItemTitle)) {
                                      break;
                                    }
                                    paramList.msg = ((StructMsgItemTitle)paramazml).b();
                                    if (QLog.isDevelopLevel())
                                    {
  ...
  public void h(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, azml paramazml)
  {
    Object localObject2 = null;
    ...
    for (localObject1 = (im_msg_body.GeneralFlags)((im_msg_body.Elem)localObject7).general_flags.get();; localObject1 = localObject2)
    {
      ...
      localObject1 = null;
      int i = 0;
      localObject7 = (MessageForPubAccount)axas.a(-3006);
      ...
      if (localIterator.hasNext())
      {
        ...
        if ((((im_msg_body.Elem)localObject3).text.has()) && (((im_msg_body.Elem)localObject3).text.str.has()))
        {
          ...
          ((MessageForPubAccount)localObject7).msgData = sen.a((PAMessage)localObject3);
        }
      }
      for (;;)
      {
        ...
        if (((im_msg_body.Elem)localObject3).trans_elem_info.has())
        {
          ...
          if (localObject3[0] == 1)
          {
            ...
            bbmx.a((byte[])localObject6, 0, (byte[])localObject3, 4, i - 1);
          ...
          for (;;)
          {
            ...
            if (localObject1 != null)
            {
              ...
              ((MessageForPubAccount)localObject7).msgData = sen.a((PAMessage)localObject1);
            }
            if (i != 0)
            {
  ...
  public void i(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, azml paramazml)
  {
    String str = null;
    int k = 0;
    Object localObject1 = paramList.iterator();
    ...
    if (((Iterator)localObject1).hasNext())
    {
      ...
      {
        str = bbea.a(localElem.text.str.get().toByteArray());
        label264:
        n = k;
        if (localElem.text.has())
        {
    ...
    for (;;)
    {
      ...
      break label264;
      Object localObject2 = null;
      localObject1 = new axap();
      ArrayList localArrayList1 = ((axap)localObject1).jdField_a_of_type_JavaUtilArrayList;
      ArrayList localArrayList2 = new ArrayList(2);
      Object localObject3 = a(null, paramList, paramStringBuilder, paramMsg.msg_head.msg_seq.get(), paramazml, (axap)localObject1, localArrayList2);
      localObject1 = localObject2;
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (localGeneralFlags.uint32_prp_fold.get() == 1)
          {
            ...
            bool1 = agvx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
            if ((j == 0) || (!agvx.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app))) {
              break label1894;
            }
            ...
            bool1 = true;
            if (QLog.isColorLevel()) {
              QLog.d("msgFold", 2, String.format("Recv, recv foldMsg, redBagSender: %s, foldFlag: %s, redBagId: %s, index: %s, foldSwitch: %s, isValidFoldMsg: %s", new Object[] { Long.valueOf(l1), Boolean.valueOf(bool2), paramList, paramStringBuilder, Boolean.valueOf(agvx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)), Boolean.valueOf(bool1) }));
            }
            ...
            paramazml = new MessageForFoldMsg();
            ((MessageForFoldMsg)paramazml).init(bool1, paramList, paramStringBuilder, l1, true);
            paramList = paramazml;
        ...
        {
          paramStringBuilder = localGeneralFlags.babyq_guide_msg_cookie.get().toByteArray();
          paramMsg = bbbr.a(paramStringBuilder);
          if (QLog.isColorLevel()) {
        ...
        if ((!TextUtils.isEmpty(paramStringBuilder)) && (bool1))
        {
          ...
          {
            paramList = (ChatMessage)axas.a(-1000);
            if ((paramazml != null) && (localArrayList2 != null)) {
              bafv.a(paramazml.jdField_a_of_type_Int, localArrayList2, paramList);
            }
            if (localArrayList1.size() > 0)
            {
              paramStringBuilder = new ArrayList(localArrayList1.size());
              paramazml = localArrayList1.iterator();
              while (paramazml.hasNext())
              {
                localObject2 = paramazml.next();
  ...
  public void j(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder)
  {
    ...
    for (;;)
    {
      ...
      {
        paramStringBuilder.mergeFrom(paramList.bytes_pb_elem.get().toByteArray());
        localMessageForLimitChatConfirm = (MessageForLimitChatConfirm)axas.a(-7005);
