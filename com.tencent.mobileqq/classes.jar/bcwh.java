...
public class bcwh
{
  ...
  public static final String a = Environment.getExternalStorageDirectory() + "/Tencent/com/tencent/mobileqq/debugDecodeShortVideo";
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, Intent paramIntent, SessionInfo paramSessionInfo, int paramInt1, int paramInt2)
  {
    if (paramInt2 == 1)
    {
      ...
      AIOUtils.setOpenAIOIntent(paramIntent, null);
      paramIntent.putExtra("camera_type", paramInt1);
      if (bhbx.b(paramSessionInfo.curFriendUin)) {
        paramIntent.putExtra("babyq_ability", ((anqn)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.BABY_Q_HANDLER)).a());
      }
