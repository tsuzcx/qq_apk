...
public class aniz
{
  ...
  public static aniz a(String paramString, boolean paramBoolean)
  {
    ...
    do
    {
      try
      {
        paramString = new aniz().a(new JSONObject(paramString));
        return paramString;
      }
    ...
    paramString = new aniz();
    paramString.jdField_a_of_type_Boolean = true;
    return paramString;
  }
  
  private aniz a(JSONObject paramJSONObject)
  {
