...
public abstract class bkzr
{
  ...
  private void a(bkzx parambkzx, String paramString)
  {
    if (parambkzx != null)
    {
      parambkzx.jdField_a_of_type_Int = 2;
      parambkzx.jdField_a_of_type_JavaLangString = paramString;
    }
  ...
  public int a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    Object localObject1 = (njg)paramQQAppInterface.getManager(70);
    int m;
    if (localObject1 != null) {
      m = ((njg)localObject1).a(paramQQAppInterface);
    }
    for (int k = ((njg)localObject1).a();; k = 0)
    {
      ...
      {
        n = ((baif)localObject2).b(0);
        localObject1 = ((baif)localObject2).b(0);
        localObject2 = ((baif)localObject2).a();
      ...
      for (;;)
      {
        paramString = (bccv)paramQQAppInterface.getManager(10);
        int i2 = 0;
        i1 = 0;
        if (paramString != null)
        {
  ...
  public boolean a(bkzt parambkzt, String paramString1, QQAppInterface paramQQAppInterface, String paramString2, int paramInt, long paramLong, int[] paramArrayOfInt, bkzx parambkzx)
  {
    if (parambkzt == null) {
      return false;
    }
    if ((parambkzt.jdField_h_of_type_Boolean) && (!a(paramString2)))
    {
      a(parambkzx, "preload:fail:notinleba");
      return false;
    }
    if (parambkzt.jdField_b_of_type_Boolean)
    {
      int i = a(paramQQAppInterface, paramString1);
      if ((parambkzt.jdField_c_of_type_Boolean) && (i == 4))
      {
        a(parambkzx, "preload:ok:reddotonly");
        return true;
      }
      if ((parambkzt.jdField_d_of_type_Boolean) && ((i == 1) || (i == 4)))
      {
        a(parambkzx, "preload:ok:reddot");
        return true;
      }
      if ((parambkzt.jdField_e_of_type_Boolean) && (i == 2))
      {
        a(parambkzx, "preload:fail:lebareddot");
        return false;
      }
    }
    if ((parambkzt.a) && (!a(parambkzt.jdField_b_of_type_Int, parambkzt.jdField_c_of_type_Int)))
    {
      a(parambkzx, "preload:fail:timecontrol");
      return false;
    }
    if ((parambkzt.j) && (paramInt < parambkzt.jdField_f_of_type_Int))
    {
      a(parambkzx, "preload:fail:usedtimeslimit");
      return false;
    }
    if (parambkzt.jdField_i_of_type_Boolean)
    {
      long l = parambkzt.jdField_e_of_type_Int * 60 * 60 * 1000;
      if (System.currentTimeMillis() - paramLong > l)
      {
        a(parambkzx, "preload:fail:notactive");
        return false;
      }
    }
    if (parambkzt.jdField_f_of_type_Boolean)
    {
      if ((System.currentTimeMillis() - paramLong) / 1000L <= parambkzt.jdField_d_of_type_Int) {
        paramInt = 1;
      }
      while (paramInt != 0) {
        if (parambkzt.jdField_g_of_type_Boolean)
        {
          a(parambkzx, "preload:ok:cdperiod");
          return true;
          paramInt = 0;
        }
        else
        {
          a(parambkzx, "preload:fail:cdperiod");
          return false;
        }
      }
    }
    if ((parambkzt.k) && (parambkzt.jdField_g_of_type_Int > 0) && (!a(paramString1, paramQQAppInterface.getCurrentAccountUin(), parambkzt.jdField_g_of_type_Int, paramArrayOfInt, parambkzt.jdField_h_of_type_Int, parambkzt.jdField_i_of_type_Int)))
    {
      a(parambkzx, "preload:fail:notinuserlearn");
      return false;
    }
    a(parambkzx, "preload:ok:normal");
    return true;
  }
  
  public abstract boolean a(bkzx parambkzx);
  
  public boolean a(String paramString)
  {
    Object localObject = ajvi.a().b();
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      if ((localarcs != null) && (localarcs.a != null) && (localarcs.a.strPkgName != null) && (localarcs.a.strPkgName.contains(paramString))) {
        return true;
      }
    }
    return false;
  ...
  public boolean a(String paramString1, String paramString2, int paramInt1, int[] paramArrayOfInt, int paramInt2, int paramInt3)
  {
    ...
    SharedPreferences localSharedPreferences = BaseApplicationImpl.getApplication().getSharedPreferences("ppp_profile", bgrv.a());
  ...
  public int[] a(int[] paramArrayOfInt, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      return null;
      localObject = new bkzs(this, paramInt3);
      switch (paramInt2)
      {
      default: 
        return null;
      case 1: 
        paramInt2 = ((bkzs)localObject).a(paramArrayOfInt, paramInt1);
      }
    } while (paramInt2 == -1);
    ...
    return localObject;
    return ((bkzs)localObject).a(paramArrayOfInt, paramInt1);
  }
  
  public boolean b(bkzx parambkzx)
  {
    return true;
  }
}
