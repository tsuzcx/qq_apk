...
public class bkzr
  extends bkzq
  implements bkzi, QGRenderer.QGEventListener
{
  private volatile int jdField_a_of_type_Int = 1;
  private aoay jdField_a_of_type_Aoay;
  private bilb jdField_a_of_type_Bilb = new bkzs(this);
  private bkzt jdField_a_of_type_Bkzt;
  ...
  public bkzr(Context paramContext, ViewGroup paramViewGroup)
  {
    super(paramContext, paramViewGroup);
    if (this.jdField_a_of_type_AndroidViewViewGroup != null) {
      this.jdField_b_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131369734));
    }
    b();
  }
  ...
  private boolean a()
  {
    if ((this.jdField_a_of_type_AndroidContentContext == null) || (this.jdField_b_of_type_AndroidViewViewGroup == null) || (this.jdField_a_of_type_Bkzv == null) || (!bilc.b.get()))
    {
      QZLog.i("VipARQGThreeController", 1, "checkInValid mVipQGViewConfig = " + this.jdField_a_of_type_Bkzv + " so status = " + bilc.b.get());
      return true;
    }
    return false;
  }
  ...
  public void a(bkzv parambkzv)
  {
    ...
    if ((this.jdField_a_of_type_Bkzv != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_Bkzv.jdField_a_of_type_JavaLangString)))
    {
      if (QLog.isColorLevel()) {
        QLog.i("VipARQGThreeController", 2, " setVipQGViewConfig config = " + parambkzv.toString());
      }
      localObject = new aqdq();
      ((aqdq)localObject).b = parambkzv.jdField_a_of_type_JavaLangString;
      ((aqdq)localObject).c = parambkzv.c;
      blad.a().a((aqdq)localObject, this);
      return;
    }
  ...
  public void a(String paramString)
  {
    if (this.jdField_a_of_type_Bkzv != null) {
      this.jdField_a_of_type_Bkzv.b = paramString;
    }
    QZLog.i("VipARQGThreeController", 1, "qg resources load success path = " + paramString + " soStatus = " + bilc.b.get());
  }
  ...
  {
    QZLog.i("VipARQGThreeController", 1, "qg resources load fail error = " + paramString + " soStatus = " + bilc.b.get());
    if (this.jdField_a_of_type_Bkzv != null) {
      this.jdField_a_of_type_Bkzv.b = "";
    }
  }
  ...
  public void f()
  {
    ...
    {
      this.jdField_a_of_type_CooperationVipArWidgetVipQGGLSurfaceView.getModuleEngine().unRegisterJsModule(this.jdField_a_of_type_Bkzt);
      this.jdField_a_of_type_CooperationVipArWidgetVipQGGLSurfaceView.b();
    }
    if (this.jdField_a_of_type_Aoay != null) {
      this.jdField_a_of_type_Aoay.c();
    }
  }
  ...
  public void onDrawFrame(GL10 paramGL10)
  {
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            ...
            return;
          } while ((this.jdField_a_of_type_Bkzv == null) || (TextUtils.isEmpty(this.jdField_a_of_type_Bkzv.b)) || (this.jdField_a_of_type_CooperationVipArWidgetVipQGGLSurfaceView == null));
      ...
      } while (!this.jdField_a_of_type_Bkzv.jdField_a_of_type_Boolean);
      this.jdField_a_of_type_Int = 4;
      return;
    } while ((this.jdField_a_of_type_CooperationVipArWidgetVipQGGLSurfaceView == null) || (!this.jdField_a_of_type_Boolean) || (this.jdField_a_of_type_Aoay == null) || (paramGL10 == null));
    int i = this.jdField_a_of_type_CooperationVipArWidgetVipQGGLSurfaceView.getCanvasTexture("offScreen");
    if (i != 0)
    {
      GLES20.glEnable(3042);
      GLES20.glBlendFunc(1, 771);
      this.jdField_a_of_type_Aoay.a(i, null, null);
      if (this.c)
      {
        bkzx.a("ar_qg_show", "1");
        this.c = false;
  ...
  {
    if (this.jdField_a_of_type_Aoay != null) {
      this.jdField_a_of_type_Aoay.a(paramInt1, paramInt2);
    }
  }
  
  public void onSurfaceCreated(GL10 paramGL10, EGLConfig paramEGLConfig)
  {
    this.jdField_a_of_type_Aoay = new aoay();
    this.jdField_a_of_type_Aoay.a();
  }
}
