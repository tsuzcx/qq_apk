...
{
  public static final pfy a;
  @Nullable
  private Function1<? super String, Unit> jdField_a_of_type_KotlinJvmFunctionsFunction1;
  @NotNull
  private final pgo jdField_a_of_type_Pgo;
  @Nullable
  private Function1<? super Boolean, Unit> b;
  
  static
  {
    jdField_a_of_type_Pfy = new pfy(null);
  }
  
  public pfx(@NotNull pgo parampgo)
  {
    this.jdField_a_of_type_Pgo = parampgo;
  }
  ...
  public final oidb_0xd1e.ReqBody a()
  {
    ...
    pgo localpgo = this.jdField_a_of_type_Pgo;
    localAuthorCommentDeleteReq.article_id.set(localpgo.a().c());
    localAuthorCommentDeleteReq.comment_type.set(localpgo.a());
    localAuthorCommentDeleteReq.content_src.set(localpgo.a().d());
    localAuthorCommentDeleteReq.first_comment_id.set(localpgo.a());
    localAuthorCommentDeleteReq.sub_comment_id.set(localpgo.b());
    localAuthorCommentDeleteReq.src.set(localpgo.a().c());
    localAuthorCommentDeleteReq.business_info.set(localpgo.a().d());
  ...
  public final void a()
  {
    ...
    ntb.a(pnn.a(), (ntf)new pfz(this), localReqBody.toByteArray(), "OidbSvc.0xd1e", 3358, 9);
  }
