  ...
  implements ailp, View.OnClickListener
{
  ...
  public aikw(QQAppInterface paramQQAppInterface, ailr paramailr, SessionInfo paramSessionInfo, Activity paramActivity)
  {
  ...
  public View a(Object... paramVarArgs)
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2131558633, null);
      paramVarArgs = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370074);
      if (this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable != null)
      {
        paramVarArgs.setImageDrawable(this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable);
        paramVarArgs = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370077);
        ...
        paramVarArgs.setContentDescription(this.jdField_a_of_type_JavaLangString + anvx.a(2131705512));
        paramVarArgs.setOnClickListener(this);
        paramVarArgs = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370076);
        if (AppSetting.c) {
          paramVarArgs.setContentDescription(anvx.a(2131705511));
        }
        paramVarArgs.setOnClickListener(this);
      }
    }
    for (;;)
    {
      for (;;)
      {
        ...
        File localFile = new File(aikx.c);
        if ((localFile != null) && (localFile.exists())) {}
        try
        {
          this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable = new BitmapDrawable(this.jdField_a_of_type_AndroidAppActivity.getResources(), bgyo.a(aikx.c));
        ...
        catch (Throwable localThrowable)
        {
          for (;;)
          {
            ...
            this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable = ((BitmapDrawable)this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130844796));
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    ...
    do
    {
      do
      {
        ...
        } while (!(this.jdField_a_of_type_Ailr.a() instanceof aikw));
        this.jdField_a_of_type_Ailr.a();
        return;
      } while (!this.jdField_a_of_type_Ailr.a(this, new Object[0]));
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800510F", "0X800510F", 0, 0, "" + (paramInt + 1), "", "", "");
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005111", "0X8005111", 0, 0, "", "", "", "");
      continue;
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005110", "0X8005110", 0, 0, "", "", "", "");
    }
  }
}
