  ...
  extends ahzi
{
  ...
  public ahqp(FriendListInnerFrame paramFriendListInnerFrame)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberFriendListInnerFrame.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131496808, paramViewGroup, false);
      paramView = new ahqq(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberFriendListInnerFrame, null);
    ...
    paramView = (ahqq)localView.getTag();
    if (i < 0)
    {
      i = -(i + 1) - 1;
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberFriendListInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.b(paramViewGroup.uin))
      {
        ...
        if ((AppSetting.c) && (paramView.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
        {
          ...
          localView.setContentDescription(paramViewGroup.getFriendNick() + ajjy.a(2131639085));
        }
      }
      for (;;)
      {
        ...
        break label299;
        label390:
        localView.setContentDescription(paramViewGroup.getFriendNick() + ajjy.a(2131639088));
      }
    }
