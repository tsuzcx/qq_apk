...
{
  public acxw(ForwardRecentActivity paramForwardRecentActivity) {}
  ...
  public void onChanged()
  {
    ...
    if ((6000 == k) && (TextUtils.equals(alof.z, str)) && (ForwardRecentActivity.a(this.a) != null))
    {
    ...
    if (i < j)
    {
      ...
      if ((localObject2 instanceof akiy)) {
        break label227;
      }
    }
    label227:
    do
    {
      ...
      break label197;
      break;
      localObject2 = (akiy)localObject2;
    } while ((((akiy)localObject2).a == null) || (!TextUtils.equals(((akiy)localObject2).a.uin, str)) || (k != ((akiy)localObject2).a.getType()));
