...
public class gx
{
  ...
  public static long a(ETFont paramETFont, String paramString)
  {
    ...
    try
    {
      ...
      i4 = new gx().a((JSONObject)localObject1);
      if (i4 < a) {
        break label635;
      }
  ...
  public static String a(java.io.File paramFile)
  {
    ...
    //   10: aload_3
    //   11: areturn
    //   12: new 150	java/io/InputStreamReader
    //   15: dup
    //   16: new 152	java/io/FileInputStream
    //   19: dup
    //   20: aload_0
    //   21: invokespecial 155	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   24: ldc 157
    //   26: invokespecial 160	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;Ljava/lang/String;)V
    //   29: astore_2
    //   30: aload_2
    //   31: astore_0
    //   32: new 162	java/lang/StringBuffer
    //   35: dup
    //   36: invokespecial 163	java/lang/StringBuffer:<init>	()V
    //   39: astore_3
    //   40: aload_2
    //   41: astore_0
    //   42: aload_2
    //   43: invokevirtual 166	java/io/InputStreamReader:read	()I
    //   46: istore_1
    //   47: iload_1
    //   48: iconst_m1
    //   49: if_icmpeq +39 -> 88
    ...
    //   55: iload_1
    //   56: i2c
    //   57: invokevirtual 169	java/lang/StringBuffer:append	(C)Ljava/lang/StringBuffer;
    //   60: pop
    //   61: goto -21 -> 40
    //   64: astore_3
    //   65: aload_2
    ...
    //   67: ldc 171
    //   69: aload_3
    //   70: invokevirtual 172	java/io/IOException:getMessage	()Ljava/lang/String;
    //   73: invokestatic 177	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;)I
    //   76: pop
    //   77: aload_2
    //   78: ifnull +7 -> 85
    //   81: aload_2
    //   82: invokevirtual 180	java/io/InputStreamReader:close	()V
    //   85: ldc 148
    //   87: areturn
    //   88: aload_2
    //   89: astore_0
    //   90: aload_3
    //   91: invokevirtual 181	java/lang/StringBuffer:toString	()Ljava/lang/String;
    //   94: astore_3
    //   95: aload_3
    //   96: astore_0
    //   97: aload_0
    ...
    //   100: ifnull -90 -> 10
    //   103: aload_2
    //   104: invokevirtual 180	java/io/InputStreamReader:close	()V
    //   107: aload_0
    //   108: areturn
    //   109: astore_2
    //   110: ldc 171
    //   112: aload_2
    //   113: invokevirtual 172	java/io/IOException:getMessage	()Ljava/lang/String;
    //   116: invokestatic 177	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;)I
    //   119: pop
    //   120: aload_0
    //   121: areturn
    //   122: astore_0
    //   123: ldc 171
    //   125: aload_0
    //   126: invokevirtual 172	java/io/IOException:getMessage	()Ljava/lang/String;
    //   129: invokestatic 177	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;)I
    //   132: pop
    //   133: goto -48 -> 85
    //   136: astore_2
    //   137: aconst_null
    ...
    //   140: ifnull +7 -> 147
    //   143: aload_0
    //   144: invokevirtual 180	java/io/InputStreamReader:close	()V
    //   147: aload_2
    //   148: athrow
    //   149: astore_0
    //   150: ldc 171
    //   152: aload_0
    //   153: invokevirtual 172	java/io/IOException:getMessage	()Ljava/lang/String;
    //   156: invokestatic 177	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;)I
    //   159: pop
    //   160: goto -13 -> 147
    //   163: astore_2
    //   164: goto -25 -> 139
