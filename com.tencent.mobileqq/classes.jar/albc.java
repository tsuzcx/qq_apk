...
@TargetApi(11)
public class albc
  implements alac, allk, SurfaceTexture.OnFrameAvailableListener, TVK_IMediaPlayer.OnCompletionListener, TVK_IMediaPlayer.OnDownloadCallbackListener, TVK_IMediaPlayer.OnErrorListener, TVK_IMediaPlayer.OnInfoListener, TVK_IMediaPlayer.OnVideoPreparedListener
{
  ...
  private alke jdField_a_of_type_Alke = new albd(this);
  ...
  private alkd jdField_b_of_type_Alkd;
  ...
  public albc(alae paramalae, albe paramalbe)
  {
    this.jdField_a_of_type_ArrayOfFloat = new float[16];
    this.jdField_a_of_type_Alae = paramalae;
    this.jdField_a_of_type_Albe = paramalbe;
    this.jdField_e_of_type_Int = paramalbe.jdField_e_of_type_Int;
    this.jdField_d_of_type_Int = paramalbe.jdField_d_of_type_Int;
    this.jdField_a_of_type_Alkg = paramalbe.jdField_a_of_type_Alkg;
    this.jdField_a_of_type_JavaLangString = paramalbe.jdField_b_of_type_JavaLangString;
    this.jdField_a_of_type_Long = paramalbe.jdField_b_of_type_Long;
    boolean bool2 = albk.a();
    if ((bool2) || (this.jdField_a_of_type_Albe.jdField_a_of_type_Boolean)) {
      bool1 = true;
    }
    this.k = bool1;
    if (QLog.isColorLevel()) {
      QLog.d("AREngine_OnlineVideoARRenderable", 2, "Construction mSoftwarePlayConfig:" + this.k + "  isRubbishDevice:" + bool2 + "  isSoftPlay:" + this.jdField_a_of_type_Albe.jdField_a_of_type_Boolean);
    }
  }
  ...
  {
    if (paramBoolean) {
      if (this.jdField_b_of_type_Alkd == null)
      {
        this.jdField_b_of_type_Alkd = alkf.a(this.jdField_a_of_type_Alkg, 3);
        this.jdField_b_of_type_Alkd.a(albk.jdField_b_of_type_ArrayOfFloat, albk.jdField_a_of_type_ArrayOfShort);
        this.jdField_b_of_type_Alkd.a("uniform int uDisplayType;\n", null, "    if(uDisplayType == 1){\n        // 需要渲染成圆形\n        float x = vTextureCoord.x;\n        float y = vTextureCoord.y;\n        // 圆心(0.5, 0.5), 0.25=0.5*0.5\n        if(pow(abs(x-0.5), 2.0) + pow(abs(y-0.5), 2.0) >= 0.25) {\n            gl_FragColor[3] = 0.0;\n        }\n    }\n", this.jdField_a_of_type_Alke);
        this.jdField_b_of_type_Alkd.a(this.jdField_a_of_type_Albe.jdField_c_of_type_Int, this.jdField_a_of_type_Albe.jdField_a_of_type_Float, this.jdField_a_of_type_Albe.jdField_b_of_type_Float, this.jdField_a_of_type_Albe.jdField_c_of_type_Float);
      }
    }
    while (this.jdField_a_of_type_Alkd != null) {
      return;
    }
    ...
    this.jdField_a_of_type_Alkd.a(this.jdField_a_of_type_Albe.jdField_c_of_type_Int, this.jdField_a_of_type_Albe.jdField_a_of_type_Float, this.jdField_a_of_type_Albe.jdField_b_of_type_Float, this.jdField_a_of_type_Albe.jdField_c_of_type_Float);
  }
  ...
  public void a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, int paramInt1, int paramInt2, int paramInt3, int paramInt4, float paramFloat, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Alae.a(paramArrayOfByte1);
    } while (!this.l);
    this.l = false;
  }
  ...
  {
    if ((!this.jdField_d_of_type_Boolean) || (paramArrayOfFloat2 == null) || (this.jdField_a_of_type_Albe == null)) {
      return;
    }
    ...
    label54:
    int m;
    if (this.jdField_a_of_type_Albe.jdField_b_of_type_Int == 1)
    {
      ...
      if (this.jdField_a_of_type_Alkd != null)
      {
        ...
        paramArrayOfFloat3 = this.jdField_a_of_type_Alkg;
    ...
    for (;;)
    {
      ...
      if (this.jdField_b_of_type_Alkd != null)
      {
        paramArrayOfFloat2 = this.jdField_b_of_type_Alkd;
  ...
  public float[] a(float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, float[] paramArrayOfFloat3)
  {
    ...
    if (c() == 2) {
      if (this.jdField_a_of_type_Albe.jdField_a_of_type_Aldy != null)
      {
        Matrix.scaleM(this.jdField_a_of_type_ArrayOfFloat, 0, this.jdField_a_of_type_Albe.jdField_a_of_type_Aldy.jdField_a_of_type_Float * paramArrayOfFloat1[0], this.jdField_a_of_type_Albe.jdField_a_of_type_Aldy.jdField_b_of_type_Float * paramArrayOfFloat1[1], 1.0F);
        Matrix.translateM(this.jdField_a_of_type_ArrayOfFloat, 0, this.jdField_a_of_type_Albe.jdField_a_of_type_Aldy.jdField_c_of_type_Float, this.jdField_a_of_type_Albe.jdField_a_of_type_Aldy.d, this.jdField_a_of_type_Albe.jdField_a_of_type_Aldy.e);
      }
    }
    for (;;)
    {
    ...
    if (this.jdField_a_of_type_Albe.jdField_c_of_type_Int == 1) {}
    for (;;)
    {
  ...
  public int b()
  {
    if (this.jdField_a_of_type_Albe != null) {
      return this.jdField_a_of_type_Albe.jdField_a_of_type_Int;
    }
    return 4;
  }
  ...
  {
    if (this.jdField_a_of_type_Albe != null) {
      return this.jdField_a_of_type_Albe.jdField_b_of_type_Int;
    }
    return 0;
  }
  ...
  public String c()
  {
    return this.jdField_a_of_type_Albe.jdField_a_of_type_JavaLangString;
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer = this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IProxyFactory.createMediaPlayer(BaseApplicationImpl.getContext(), this.jdField_a_of_type_Allj);
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("AREngine_OnlineVideoARRenderable", 2, "start, arResourceInfo=" + this.jdField_a_of_type_Albe);
    }
    ...
    String str2 = alli.a(this.jdField_a_of_type_JavaLangString);
    ...
    for (String str1 = "true";; str1 = "false")
    {
      ...
      localTVK_PlayerVideoInfo.setVid(bdik.d(this.jdField_a_of_type_JavaLangString));
  ...
  public void f()
  {
    ...
    try
    {
      ...
      if (this.jdField_b_of_type_Alkd != null)
      {
        this.jdField_b_of_type_Alkd.b();
        this.jdField_b_of_type_Alkd = null;
      }
      HashMap localHashMap = new HashMap();
      localHashMap.put("decode_type", String.valueOf(this.jdField_f_of_type_Int));
      axrn.a(BaseApplicationImpl.getContext()).a("", "immersed_ar_decode_type", true, 0L, 0L, localHashMap, "", false);
      return;
    }
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_Alae != null) {
          this.jdField_a_of_type_Alae.a(this.jdField_a_of_type_Albe.jdField_a_of_type_JavaLangString);
        }
      }
    }
  }
  ...
  public void onCompletion(TVK_IMediaPlayer paramTVK_IMediaPlayer)
  {
    ...
    if (this.jdField_a_of_type_Alae != null) {
      this.jdField_a_of_type_Alae.b(2, this.jdField_e_of_type_Int - this.jdField_c_of_type_Int);
    }
    ...
    } while (this.jdField_a_of_type_Alae == null);
    this.jdField_a_of_type_Alae.a(paramTVK_IMediaPlayer);
  }
  ...
  public void onVideoPrepared(TVK_IMediaPlayer paramTVK_IMediaPlayer)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_Alae != null)
        {
          this.jdField_a_of_type_Alae.b(0, this.jdField_e_of_type_Int);
          return;
        }
      }
