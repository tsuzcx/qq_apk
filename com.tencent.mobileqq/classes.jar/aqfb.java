  ...
  extends aqeq
{
  ...
  private aqbw jdField_a_of_type_Aqbw = new aqfc(this);
  private aqcw jdField_a_of_type_Aqcw = new aqcw(this.jdField_a_of_type_AndroidOsBundle);
  protected nat a;
  ...
  static
  {
    jdField_l_of_type_JavaLangString = ajyc.a(2131704792);
  }
  
  public aqfb(Intent paramIntent)
  {
    super(paramIntent);
    this.jdField_d_of_type_Long = -1L;
    this.jdField_b_of_type_AndroidOsHandler = new aqfi(this);
    this.jdField_a_of_type_Nat = new aqfk(this);
  }
  ...
  private void N()
  {
    ...
    if (!this.jdField_i_of_type_Boolean) {
      if ((!TextUtils.isEmpty(this.jdField_i_of_type_JavaLangString)) && (!this.jdField_i_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount())))
      {
        ...
        nax.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, null, "connect_sharepic", "pageview", this.jdField_b_of_type_Long, i, "");
        axrl.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "sha_pageview", 1, "", "", str2);
    ...
    for (;;)
    {
      bded.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), this.jdField_h_of_type_JavaLangString, str2, "10", "11", "0", (String)localObject, "0", "0", false);
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005A0F", "0X8005A0F", 0, 0, "1", "", "", "");
      return;
      if (!TextUtils.isEmpty(this.jdField_h_of_type_JavaLangString))
      {
        ...
        for (;;)
        {
          try
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(l1, this.jdField_h_of_type_JavaLangString, this.jdField_b_of_type_Long, new aqfj(this));
            i = 0;
          }
      ...
      break;
      label413:
      nax.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, null, "pageview", this.jdField_b_of_type_Long, i, "");
      break label150;
      label434:
      String str1;
  ...
  private void a(long paramLong, String paramString1, String paramString2, int paramInt, String paramString3, boolean paramBoolean)
  {
    ...
    if (i == 11)
    {
      ...
      {
        paramString1 = axur.a(str1);
        if (!TextUtils.isEmpty(paramString1)) {
          axqw.b(null, "CliOper", "", "", "0X8005F53", "0X8005F53", 0, 0, axur.a(paramInt) + "", "", paramString1, "");
        }
      }
    }
    paramString1 = axuy.a(this.jdField_a_of_type_AndroidOsBundle);
    if ((paramString1 != null) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null))
    {
      ...
      axqw.b(null, "dc00898", "", "", "0X8009C93", "0X8009C93", 0, 0, "", "4", str1, str2);
      ...
      paramString1 = actn.a(localIntent, new int[] { 2 });
    ...
    for (;;)
    {
      ...
      break;
      label491:
      paramString1 = actn.a(localIntent, null);
      paramString1.putExtra("share_from_aio", true);
    }
  }
  
  private void a(Bundle paramBundle, auop paramauop, String paramString1, String paramString2, String paramString3)
  {
    Object localObject;
    if ((paramauop.jdField_a_of_type_JavaLangObject instanceof int[]))
    {
      int[] arrayOfInt = (int[])paramauop.jdField_a_of_type_JavaLangObject;
      if (arrayOfInt.length == 5)
      {
        localObject = new oidb_cmd0xb77.ImageInfo();
        ((oidb_cmd0xb77.ImageInfo)localObject).md5.set(paramauop.d);
        ((oidb_cmd0xb77.ImageInfo)localObject).uuid.set(paramauop.c);
        ...
        ((oidb_cmd0xb77.ImageInfo)localObject).file_id.set((int)paramauop.jdField_b_of_type_Long);
      }
    }
    for (paramauop = (auop)localObject;; paramauop = null)
    {
      paramBundle = aqft.a(paramBundle, null, null, paramauop);
      paramauop = BaseApplicationImpl.getApplication().getRuntime();
      if (paramauop == null)
      {
      ...
      aqgh.a("KEY_STAGE_2_IMAGE_B77");
      mxi.a(paramauop, new aqfh(this, paramString2, paramString1, paramString3), paramBundle.toByteArray(), "OidbSvc.0xb77_9", 2935, 9, (Bundle)localObject, 0L);
      return;
    }
  }
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    aqcq.a().a(paramString2, paramString1);
  }
  ...
  private boolean p()
  {
    ...
    aqbu localaqbu = ((aqfm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(350)).a();
    if (localaqbu.b())
    {
    ...
    if (localaqbu.c())
    {
      ...
      this.jdField_a_of_type_Aqaq = localaqbu.a(this.jdField_b_of_type_Long);
      return false;
    }
    if (localaqbu.a())
    {
      QLog.d("ForwardOption.ForwardSdkShareOption", 1, "--> hasValidAppInfo");
      this.jdField_a_of_type_Aqaq = localaqbu.a();
      e();
      return false;
    }
    QLog.d("ForwardOption.ForwardSdkShareOption", 1, "--> waiting d55 back");
    localaqbu.a(this.jdField_a_of_type_Aqbw);
    a(2131718881);
    return true;
  }
  ...
  private boolean q()
  {
    ...
    if ((TextUtils.isEmpty(this.jdField_a_of_type_AndroidOsBundle.getString("image_url_remote"))) || (!aqft.a())) {
      bool = true;
    }
    return bool;
  }
  ...
  protected void L()
  {
    ...
    axrl.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "", "multi_account", "push_login_window", 0, 1, 0);
    ...
    aqfl localaqfl = new aqfl(this);
    this.jdField_b_of_type_Bbgg.setNegativeButton(2131690596, localaqfl);
    this.jdField_b_of_type_Bbgg.setPositiveButton(2131719420, localaqfl);
    this.jdField_b_of_type_Bbgg.show();
  }
  ...
  public String a()
  {
    ...
    {
      str1 = str2;
      if (naw.a(str2, "UTF-8") > 105) {
        str1 = naw.a(str2, 105, "UTF-8", "...");
      }
    }
    if (QLog.isColorLevel()) {
  ...
  public void a(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    this.jdField_a_of_type_Aqcw.a(paramQQAppInterface, paramActivity);
  }
  ...
  public boolean a()
  {
    ...
    for (;;)
    {
      ...
      if (q())
      {
        H();
        if (bool2) {
          bdjo.a().a(0, "SHARE_CHECK_AGENT", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), String.valueOf(this.jdField_b_of_type_Long), null, Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, null);
        }
      }
      try
      {
  ...
  protected boolean a(bbgg parambbgg)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg == null)
    {
      ...
      if (!AbsShareMsg.class.isInstance(localObject))
      {
        ...
        a(-1, ajyc.a(2131704789), ajyc.a(2131704816));
      }
    }
    try
    {
      bdjo.a().a(1, "SHARE_CHECK_AGENT", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), String.valueOf(this.jdField_b_of_type_Long), null, Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "类型错误");
      label145:
      return false;
      ...
      if (!this.jdField_a_of_type_AndroidOsBundle.getBoolean("key_sdk_share_pure_text"))
      {
        ...
        ((LinearLayout.LayoutParams)localObject).setMargins(actn.a(-15.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0, actn.a(-15.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), actn.a(5.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()));
        if (QLog.isColorLevel()) {
        ...
        parambbgg.addView(this.jdField_a_of_type_Aqez.a(), (LinearLayout.LayoutParams)localObject);
      ...
      for (;;)
      {
        ...
        parambbgg.adjustMessageTopBottomMargin(0.0F, 0.0F);
        break;
        label400:
        if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForAudioShare))
        {
          ((LinearLayout.LayoutParams)localObject).setMargins(0, actn.a(5.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0, actn.a(10.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()));
          break;
        }
        if (!(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForImageShare)) {
          break;
        }
        ((LinearLayout.LayoutParams)localObject).setMargins(actn.a(-10.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0, actn.a(-7.5F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0);
        break;
        label490:
  ...
  protected boolean a(AbsStructMsg paramAbsStructMsg, String paramString1, int paramInt, String paramString2)
  {
    ...
    paramString1 = (ArkAppMessage)alsx.a(2, paramString1, this.jdField_a_of_type_AndroidOsBundle, localObject1);
    ...
    for (;;)
    {
      ...
      for (paramString2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();; paramString2 = localSessionInfo.b)
      {
        ...
        paramString1.containStructMsg = axaq.a((QQAppInterface)localObject2, str1, str2, paramString2, paramInt, i, paramAbsStructMsg);
        if ((!TextUtils.isEmpty(((ArkAppMessage)localObject1).appName)) && (!TextUtils.isEmpty(((ArkAppMessage)localObject1).appView)) && (!TextUtils.isEmpty(((ArkAppMessage)localObject1).metaList))) {
          altd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((ArkAppMessage)localObject1).appName, "AIOArkSdkSendMessage", 1, 0, 0L, 0L, 0L, ((ArkAppMessage)localObject1).appView, "");
        }
        aaod.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localSessionInfo, paramString1);
        return true;
      }
    }
  }
  ...
  public void b(int paramInt)
  {
    ...
    if (paramInt == k.intValue())
    {
      ...
      default: 
        ...
        localIntent.putExtra("dataline_forward_text", ajyc.a(2131704794));
      }
    }
    Bundle localBundle;
    for (;;)
    {
      ...
      localBundle.putLong("res_share_id", bbbo.a(this.jdField_b_of_type_Long));
      ...
      else
      {
        ...
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004931", "0X8004931", 0, 0, "", "", "", "");
        if (QLog.isColorLevel())
        {
    ...
    for (;;)
    {
      ...
      continue;
      label1243:
      localObject = this.jdField_a_of_type_Aqaq.b();
      break label373;
      label1255:
      localObject = this.jdField_a_of_type_Aqaq.a();
      break label397;
      label1267:
      localObject = this.jdField_a_of_type_Aqaq.c();
      break label421;
      label1279:
      localObject = this.jdField_a_of_type_Aqaq.d();
      break label445;
      label1291:
      localIntent.putExtras(localBundle);
  ...
  {
    if ((this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("qqfav_extra_from_sdk_share", false)) || (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("qqfav_extra_from_system_share", false))) {
      return this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131698088);
    }
  ...
  protected boolean c()
  {
    ...
    try
    {
      bdjo.a().a(0, "SHARE_TO_QQ", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), String.valueOf(this.jdField_b_of_type_Long), String.valueOf(i), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, null);
      label99:
      String str1;
      label110:
      String str2;
      ...
      if (this.jdField_c_of_type_Int == 1)
      {
        ...
        str2 = "1";
        bded.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "", this.jdField_b_of_type_Long + "", "10", "12", "0", str1, str3, str2, false);
        if ((QSecFramework.a().a(1003).booleanValue()) && (this.jdField_c_of_type_Boolean))
        {
          ...
          if ((!TextUtils.isEmpty(str2)) && (!bcwv.a().a())) {
            bcwv.a().a(null, str2);
          }
          if (this.jdField_c_of_type_Int != 1) {
            break label383;
          }
          bcwv.a().a(2, str3, i, str1);
        }
      }
      for (;;)
      {
  ...
  protected int d()
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForImageShare))
        {
          ...
          localObject2 = bgpv.a((StructMsgForImageShare)this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg);
          m = k;
          ArrayList localArrayList;
          if (localObject2 != null)
          {
            localArrayList = new ArrayList();
            localArrayList.add(((axwt)localObject2).S);
            m = a(localArrayList);
            if (m == 0) {
              break label357;
            }
        ...
        for (;;)
        {
          ...
          {
            break;
            if (!bgpd.a((ArrayList)localObject2, bool, this.jdField_a_of_type_AndroidContentIntent.getStringExtra("qqfav_extra_richmedia_title"), this.jdField_a_of_type_AndroidContentIntent.getStringExtra("qqfav_extra_mixed_msg"), true, this.jdField_b_of_type_Long, (String)localObject1).a(l2, str2).b(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), -1, null)) {
              break label763;
            }
            k = 0;
            break label508;
    ...
    if (this.jdField_a_of_type_AndroidOsBundle.getBoolean("key_sdk_share_pure_text"))
    {
      ...
      if (TextUtils.isEmpty(this.jdField_a_of_type_AndroidOsBundle.getString("qqfav_extra_richmedia_title")))
      {
        ...
        if (!bgpd.a(null, false, this.jdField_a_of_type_AndroidOsBundle.getString("qqfav_extra_richmedia_title"), this.jdField_a_of_type_AndroidOsBundle.getString("qqfav_extra_mixed_msg"), true, this.jdField_b_of_type_Long, (String)localObject1).a(l2, str1).b(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), -1, null)) {
          break label765;
        }
        i = 0;
        j = 0;
        ...
        i = m;
        if (k == 0) {
          bgpr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "User_AddFav", i, 0, 69, j, "", "");
        }
        return k;
      }
    }
  ...
  protected void d()
  {
    ...
    Object localObject2 = this.jdField_a_of_type_Bbgg.getInputValue();
    ...
    boolean bool = axuy.a(this.jdField_a_of_type_AndroidOsBundle) instanceof StructMsgForImageShare;
    if (bool)
    {
      this.jdField_a_of_type_AndroidOsBundle.putString("share_comment_message", this.jdField_a_of_type_Bbgg.getInputValue());
    ...
    if (f()) {
      if (TextUtils.isEmpty((CharSequence)localObject2))
      {
        ...
        this.jdField_a_of_type_Aqcw.a(b());
      }
    }
    for (;;)
    {
      if (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("forward_mini_program_ark_from_sdk", false)) {
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009F7B", "0X8009F7B", 0, 0, "1", "", "", "");
      }
      return;
      localObject1 = "1";
      break;
      ...
      break label260;
      label341:
      this.jdField_j_of_type_JavaLangString = this.jdField_a_of_type_Bbgg.getInputValue();
      super.d();
      continue;
      label359:
      ...
      else
      {
        ...
        else
        {
          ...
          ((Bundle)localObject1).putString("intext_1", "" + bdej.a(this.jdField_c_of_type_Int));
          ((Bundle)localObject1).putString("intext_2", "" + bdej.a(this.jdField_a_of_type_AndroidOsBundle.getInt("uintype"), this.jdField_a_of_type_AndroidOsBundle.getString("uin")));
          ((Bundle)localObject1).putString("intext_3", "0");
          bded.a().a((Bundle)localObject1, "", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false);
        }
      }
    }
  }
  ...
  protected void d(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt == 0)
      {
        ...
        if (!bool) {
          bgpv.a(this.jdField_a_of_type_AndroidAppActivity, 2131698176, 2);
        }
      }
      while (!bool)
      {
        ...
        localObject = this.jdField_a_of_type_AndroidAppActivity.getString(2131698175);
        ...
        localObject = str;
        if (TextUtils.isEmpty(str)) {
          localObject = this.jdField_a_of_type_AndroidAppActivity.getString(2131698167);
        }
        localObject = (String)localObject;
        localObject = bbcv.a(this.jdField_a_of_type_AndroidAppActivity, 230, this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131719499), this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131698169), (String)localObject, this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131694894), new aqfd(this), new aqfe(this));
        ((bbgg)localObject).setOnDismissListener(new aqff(this));
        if (!this.jdField_a_of_type_AndroidAppActivity.isFinishing())
        {
          ...
          continue;
          if (2 == paramInt) {
            bgpv.a(this.jdField_a_of_type_AndroidAppActivity, 2131695191, 1);
          } else if (3 == paramInt) {
            bgpv.a(this.jdField_a_of_type_AndroidAppActivity, 2131698174, 1);
          } else {
            bgpv.a(this.jdField_a_of_type_AndroidAppActivity, 2131698168, 1);
          }
        }
      }
    }
  ...
  protected boolean d()
  {
    for (;;)
    {
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        if (this.jdField_l_of_type_Boolean)
        {
          ...
          try
          {
            ...
            if ((this.jdField_a_of_type_Aqaq == null) && (QLog.isColorLevel())) {
      ...
      if (this.jdField_a_of_type_Aqaq == null)
      {
        ...
        aqgh.a("KEY_GET_APP_INFO");
        xmt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_b_of_type_Long, str2, l1, this.jdField_a_of_type_MqqObserverBusinessObserver, str1);
        try
        {
          jdField_a_of_type_JavaLangObject.wait(20000L);
        }
  ...
  protected void r()
  {
    ...
    try
    {
      ...
      if ((!TextUtils.isEmpty(str1)) && (!TextUtils.isEmpty(str2)) && (!TextUtils.isEmpty((CharSequence)localObject))) {
        altd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str1, "AIOArkSdkSendClosed", 1, 0, 0L, 0L, 0L, str2, "");
      }
      label95:
      if (f()) {
      ...
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007C3A", "0X8007C3A", 0, 0, "2", "", "", "");
      if (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("forward_mini_program_ark_from_sdk", false)) {
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009F7B", "0X8009F7B", 0, 0, "2", "", "", "");
      }
      if ((this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("qqfav_extra_from_sdk_share", false)) || (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("qqfav_extra_from_system_share", false))) {
  ...
  public void w()
  {
    ...
    if ((this.jdField_b_of_type_Xoc != null) && (this.jdField_b_of_type_Xoc.isShowing())) {
      this.jdField_b_of_type_Xoc.dismiss();
    }
  ...
  protected void y()
  {
    AbsStructMsg localAbsStructMsg = axuy.a(this.jdField_a_of_type_AndroidOsBundle);
    if (localAbsStructMsg != null) {
      ((yeu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(49)).a().a(this.jdField_a_of_type_AndroidOsBundle.getString("uin"), localAbsStructMsg);
    }
  ...
  public void z()
  {
    ...
    localBundle.putString("text_filter_default_screen_touch_tips", ajyc.a(2131704805));
    localvwm.a(this.jdField_a_of_type_AndroidAppActivity, localBundle, 20004);
    this.jdField_a_of_type_AndroidAppActivity.overridePendingTransition(2130772217, 2130772038);
    vel.a("share", "clk_videoclips", 0, 0, new String[0]);
  }
}
