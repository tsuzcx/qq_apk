  ...
  implements TextWatcher
{
  ...
  public aohq(ExtendFriendProfileEditFragment paramExtendFriendProfileEditFragment) {}
  ...
  public void afterTextChanged(Editable paramEditable)
  {
    ...
    for (;;)
    {
      if (ExtendFriendProfileEditFragment.a(this.jdField_a_of_type_ComTencentMobileqqExtendfriendFragmentExtendFriendProfileEditFragment) == null) {
        ExtendFriendProfileEditFragment.a(this.jdField_a_of_type_ComTencentMobileqqExtendfriendFragmentExtendFriendProfileEditFragment, bcpw.a(this.jdField_a_of_type_ComTencentMobileqqExtendfriendFragmentExtendFriendProfileEditFragment.getActivity(), "输入文字不要超过30行", 0));
      }
