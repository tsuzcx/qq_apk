  ...
  extends DynamicDrawableSpan
{
  ...
  private azei(Context paramContext, MessageForReplyText.SourceMsgInfo paramSourceMsgInfo, int paramInt, Paint paramPaint, View.OnClickListener paramOnClickListener)
  {
    super(0);
  ...
  public static azei a(QQAppInterface paramQQAppInterface, Context paramContext, MessageForReplyText.SourceMsgInfo paramSourceMsgInfo, int paramInt, Paint paramPaint, View.OnClickListener paramOnClickListener)
  {
    ...
    return new azei(paramContext, paramSourceMsgInfo, paramInt, paramPaint, paramOnClickListener);
  }
  ...
  private void a(Paint paramPaint)
  {
    ...
    do
    {
      do
      {
        ...
        paramPaint.append(bami.a(this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, ChatTextSizeSettingActivity.a(), null, 7));
        localObject = new TextView(this.jdField_a_of_type_AndroidContentContext);
        ((TextView)localObject).setSingleLine();
        ((TextView)localObject).setEllipsize(TextUtils.TruncateAt.END);
        ((TextView)localObject).setBackgroundDrawable(((TextView)localObject).getResources().getDrawable(2130838083));
        ((TextView)localObject).setGravity(16);
        i = ((TextView)localObject).getResources().getColor(2131101352);
        ...
        i = (int)bacc.a(this.jdField_a_of_type_AndroidContentContext, 6.0F);
        j = (int)bacc.a(this.jdField_a_of_type_AndroidContentContext, 23.0F);
        ...
        ((TextView)localObject).setTypeface(gh.a(Long.toString(this.jdField_b_of_type_Long)));
