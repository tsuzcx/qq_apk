...
public class azei
{
  ...
  public aiqq a;
  private azek jdField_a_of_type_Azek = new azek(null);
  ...
  {
    a().setBeautyLevel(azfz.a() * paramFloat);
    if (QLog.isColorLevel()) {
      QLog.i("FilterBeauty", 2, "setBeautyLevel " + paramFloat + "rate : " + azfz.a());
    }
  }
  ...
  private void h()
  {
    ...
    if ((!this.k) && (bool))
    {
      YTCommonInterface.initAuth(BaseApplicationImpl.getContext(), "youtusdk_mqq.licence", 0);
      str = azgk.c(VideoEnvironment.a());
    ...
    catch (OutOfMemoryError localOutOfMemoryError)
    {
      for (;;)
      {
        ...
        axsh.a(new RuntimeException("initFaceDetector failed"));
        this.k = false;
      }
    }
  }
  ...
  public int a(int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4, FramePerformanceMonitor paramFramePerformanceMonitor, boolean paramBoolean5)
  {
    ...
    FilterRender localFilterRender = ajog.a().a(this.jdField_c_of_type_Int, this.jdField_d_of_type_Int);
    azeu.jdField_a_of_type_Boolean = paramBoolean4;
    ...
    {
      h();
      if (((this.jdField_a_of_type_ComTencentAekitApiStandardFilterAESticker != null) && (paramBoolean2)) || (this.jdField_a_of_type_Aiqq != null))
      {
        if (paramBoolean4) {
          break label1905;
        }
      ...
      for (;;)
      {
        ...
        {
          this.jdField_a_of_type_ComTencentTtpicOpenapiPTFaceAttr = this.jdField_a_of_type_ComTencentTtpicOpenapiPTFaceDetector.detectFrame(this.jdField_c_of_type_ComTencentAekitOpenrenderInternalFrame, 0L, 0, false, this.jdField_c_of_type_Double, 90.0F, false, new StarParam());
          if (this.jdField_a_of_type_ComTencentTtpicOpenapiPTFaceAttr.getFaceCount() > 0)
          {
            ...
            if (this.jdField_e_of_type_Boolean)
            {
              ...
              {
                azem.a(this.jdField_f_of_type_Boolean);
            ...
            this.jdField_a_of_type_Long = SystemClock.elapsedRealtimeNanos();
            if ((this.jdField_a_of_type_Aiqq != null) && (this.jdField_c_of_type_Int != 0) && (localObject != null)) {
              this.jdField_a_of_type_Aiqq.a(i1, paramInt1, paramInt2, paramInt1 * 1.0F / this.jdField_c_of_type_Int / this.jdField_c_of_type_Double, (List)localObject);
            }
            this.jdField_b_of_type_Long = SystemClock.elapsedRealtimeNanos();
        ...
        for (;;)
        {
          ...
          if (paramInt1 >= 20)
          {
            ...
            localObject = "back";
            label1604:
            ajnh.a((String)localObject, paramBoolean1, paramFramePerformanceMonitor, l1 / 1000L);
          }
          return paramInt3;
          n = paramInt3;
  ...
  public azhb a()
  {
    return this.jdField_a_of_type_Azhb;
  }
  
  public BeautyRender a()
  {
    if (this.jdField_a_of_type_ComTencentAvVideoEffectBeautyBeautyRender == null) {
      this.jdField_a_of_type_ComTencentAvVideoEffectBeautyBeautyRender = new BeautyRender(BaseApplicationImpl.context, len.h());
    }
