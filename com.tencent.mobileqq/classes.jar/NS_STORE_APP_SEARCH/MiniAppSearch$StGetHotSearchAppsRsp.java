...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 34, 42, 50, 56, 66, 74, 80 }, new String[] { "extInfo", "title", "appList", "watchTitle", "watchingList", "sort", "guessYouList", "guessTitle", "sortList" }, new Object[] { null, "", null, "", null, Integer.valueOf(0), null, "", Integer.valueOf(0) }, StGetHotSearchAppsRsp.class);
