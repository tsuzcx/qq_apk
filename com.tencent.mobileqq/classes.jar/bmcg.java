...
public class bmcg
  implements View.OnClickListener, axmi, ayzw, ayzy, bmcw
{
  ...
  public bmcg(bmcv parambmcv, bmcu parambmcu)
  {
  ...
  private void c()
  {
    ...
    if (bool)
    {
      VideoEnvironment.a("LightWeightSoDownloadUnit", alpo.a(2131706451), null);
  ...
  {
    a(alpo.a(2131706457));
    VideoEnvironment.a("LightWeightSoDownloadUnit", alpo.a(2131706463), null);
    ayyy.a(3, -1500);
  }
  ...
  public View a()
  {
    ...
    localObject = this.jdField_a_of_type_Bmcv.a().getLayoutInflater().inflate(a(), (ViewGroup)localObject, false);
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetCircleProgress = ((CircleProgress)((View)localObject).findViewById(2131364906));
    Resources localResources = this.jdField_a_of_type_Bmcv.a().getResources();
    this.jdField_a_of_type_ComTencentMobileqqWidgetCircleProgress.setBgAndProgressColor(100, localResources.getColor(2131167192), 100, localResources.getColor(2131165332));
    ...
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)((View)localObject).findViewById(2131366597));
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = ((QQAppInterface)this.jdField_a_of_type_Bmcv.a());
    if (!VideoEnvironment.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
      QQToast.a(VideoEnvironment.a(), alpo.a(2131706465), 1);
    }
    for (;;)
    {
      return this.jdField_a_of_type_AndroidViewView;
      boolean bool = VideoEnvironment.e(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (azgk.a(this.jdField_a_of_type_Bmcv.a()) != 2) {}
      for (int i = 1;; i = 0)
      {
        if ((bool) && (i != 0)) {
          break label398;
  ...
  public void a()
  {
    ...
    {
      bmcj localbmcj = (bmcj)this.jdField_a_of_type_Bmcv.a();
      if (localbmcj != null) {
        localbmcj.b();
      }
    }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if ((paramInt1 == 1) || (paramInt1 == 0))
    {
      if (paramInt2 != 0)
      {
        VideoEnvironment.a("LightWeightSoDownloadUnit", alpo.a(2131706458) + paramInt2 + "]", null);
        ShortVideoResourceManager.a(alpo.a(2131706450));
        ayyy.a(1, paramInt2);
        return;
      }
      ...
      if (paramInt1 == 0)
      {
        VideoEnvironment.a("LightWeightSoDownloadUnit", alpo.a(2131706446), null);
      ...
      VideoEnvironment.a("LightWeightSoDownloadUnit", alpo.a(2131706453) + paramInt1 + "]", null);
      ShortVideoResourceManager.a(alpo.a(2131706447));
      ayyy.a(1, paramInt1);
      return;
    }
    VideoEnvironment.a("LightWeightSoDownloadUnit", alpo.a(2131706462) + paramInt2 + "]", null);
    ShortVideoResourceManager.a(alpo.a(2131706473));
    ayyy.a(1, paramInt2);
  }
  ...
  public void a(String paramString1, int paramInt, String paramString2)
  {
    if (paramString1.startsWith("new_qq_android_native_short_video_")) {
      if (paramInt != 0)
      {
        VideoEnvironment.a("LightWeightSoDownloadUnit", alpo.a(2131706455) + paramInt + "]", null);
        ShortVideoResourceManager.a(alpo.a(2131706461));
        ayyy.a(2, paramInt);
      }
    }
    for (;;)
    {
      ...
      if (paramString1.startsWith("new_qq_android_native_short_filter_")) {
        if (paramInt != 0)
        {
          VideoEnvironment.a("LightWeightSoDownloadUnit", alpo.a(2131706480) + paramInt + "]", null);
          ShortVideoResourceManager.a(alpo.a(2131706469));
          ayyy.a(2, paramInt);
        }
        else
        {
  ...
  public void denied()
  {
    ...
    for (;;)
    {
      ...
      label83:
      if (i != 0) {
        localObject = alpo.a(2131706477);
      } else {
        localObject = alpo.a(2131706452);
      }
    }
  }
