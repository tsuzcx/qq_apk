  ...
  extends VasWebviewJsPlugin
{
  ...
  public int a;
  bmcf jdField_a_of_type_Bmcf = new bmch(this);
  public bmcj a;
  public String a;
  ...
  private void b()
  {
    if (this.jdField_a_of_type_OrgJsonJSONObject != null) {
      bmbh.jdField_a_of_type_Bmbl.b(this.jdField_a_of_type_OrgJsonJSONObject);
    }
    if (QLog.isColorLevel()) {
      QLog.d("QQComicJsPlugin", 2, "setContainerInfo success on Resume extrasParams: " + bmbh.jdField_a_of_type_Bmbl.toString());
    }
  }
  
  private void b(JSONObject paramJSONObject)
  {
    bmbh.a(paramJSONObject.optInt("useWebBundle"));
  }
  ...
  private static String c()
  {
    ...
    return bigv.a("tencent/MobileQQ/qqcomic/cache/");
  }
  ...
  private void c(JSONObject paramJSONObject)
  {
    ...
    bmdj.a(str1, false, bmdj.b);
    for (;;)
    {
      a(localIntent.getExtras());
      bmbh.a(paramJSONObject, localIntent, 100);
      return;
      label126:
      bmdj.a(str1, false, bmdj.e);
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    //   1: monitorenter
    //   2: aload_1
    //   3: putstatic 121	bmcg:f	Ljava/lang/String;
    //   6: getstatic 28	bmcg:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   18: monitorexit
    //   19: return
    //   20: getstatic 28	bmcg:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   23: iconst_1
    //   24: invokevirtual 315	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   27: new 317	cooperation/comic/jsp/QQComicJsPlugin$4
    //   30: dup
    //   31: aload_0
    //   32: invokespecial 318	cooperation/comic/jsp/QQComicJsPlugin$4:<init>	(Lbmcg;)V
    //   35: iconst_5
    //   36: aconst_null
    //   37: iconst_1
  ...
  public void a(String paramString1, JSONObject paramJSONObject, String paramString2)
  {
    if (this.jdField_a_of_type_Bmcj == null)
    {
      ...
      this.jdField_a_of_type_Bmcj = bmcx.a(this.mRuntime, this.jdField_a_of_type_Bmcf);
    }
    if (this.jdField_a_of_type_Bmcj != null) {
      this.jdField_a_of_type_Bmcj.a(paramString1, paramJSONObject);
    }
    do
    {
      return;
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      {
        paramJsBridgeListener = (String)bmbh.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicReference.get();
        paramString1 = new JSONObject();
        ...
        for (;;)
        {
          ...
          paramString1.put("message", anzj.a(2131709051));
    ...
    else
    {
      ...
      if ("setSwitchChannel".equals(paramString3))
      {
        ...
        if ((paramString3 != null) && (paramString3.length() > 0))
        {
          ...
          paramVarArgs.mSwiftTitleUI.a(new binx(m, k, paramString1, paramString2, paramJsBridgeListener));
          break label2202;
        }
      }
      else
      {
        ...
        else
        {
          ...
          if ("setTabRedPoint".equals(paramString3))
          {
            ...
            break label2202;
            label1074:
            paramVarArgs.mSwiftTitleUI.a(new biny(paramJsBridgeListener, j, paramString2));
            break label2202;
          }
          ...
          if ("openQQBrowser".equals(paramString3))
          {
            ...
            bmbh.a(paramString1, paramString2, -1);
            break label2202;
          }
          ...
          if ("setTitleAndBottomBar".equals(paramString3))
          {
            ...
            paramJsBridgeListener = (binz)paramString1;
            bool1 = bool2;
            if (!bool3) {
              bool1 = true;
            }
          ...
          if ("getReporterInfo".equals(paramString3))
          {
            paramJsBridgeListener = new JSONObject();
            paramString1 = new JSONObject();
            paramString1.put("mod", bmbh.jdField_a_of_type_JavaLangString);
            paramString1.put("land_page", bmbh.c);
            paramString1.put("obj_ownerid", bmbh.b);
            paramJsBridgeListener.put("data", paramString1);
    ...
    for (i = 1;; i = 2)
    {
      ...
      else if ("setContainerInfo".equals(paramString3))
      {
        ...
        bmbh.jdField_a_of_type_Bmbl.b(this.jdField_a_of_type_OrgJsonJSONObject);
        if (QLog.isColorLevel()) {
          QLog.d("QQComicJsPlugin", 2, "setContainerInfo success extrasParams: " + bmbh.jdField_a_of_type_Bmbl.toString());
        }
      }
      else if (bmcx.a)
      {
