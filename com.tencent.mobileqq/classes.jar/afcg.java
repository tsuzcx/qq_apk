...
public class afcg
  extends aofu
{
  public afcg(TroopDisbandActivity paramTroopDisbandActivity) {}
  ...
  protected void onGetMutilTroopInfoResult(boolean paramBoolean, ArrayList<TroopInfo> paramArrayList)
  {
    ...
    label56:
    while (!bhbx.a(localTroopInfo.troopuin, this.a.jdField_a_of_type_JavaLangString))
    {
      i += 1;
      break label21;
      break;
  ...
  protected void onGetTroopInfoResult(boolean paramBoolean, String paramString)
  {
    ...
    if ((paramBoolean) && (bhbx.a(paramString, this.a.jdField_a_of_type_JavaLangString)))
    {
  ...
  {
    if (!bhbx.a(String.valueOf(paramLong1), this.a.jdField_a_of_type_JavaLangString)) {}
    Object localObject;
    label132:
    label190:
    label320:
    ...
    do
    {
      do
      {
        ...
        case 4: 
          if (paramBoolean)
          {
            ...
            } while ((this.a.jdField_a_of_type_JavaUtilArrayList.contains(localObject)) || (localObject == null) || ("".equals(((String)localObject).trim())) || (bhbx.a(this.a.d, localObject)));
          ...
          paramList = (aoep)this.a.app.getBusinessHandler(BusinessHandlerFactory.TROOP_HANDLER);
      ...
      paramList.putExtra("leftViewText", this.a.getString(2131716593));
      ...
      if (paramBoolean)
      {
        ...
        this.a.jdField_a_of_type_Biso.b(2, 2131719529, 1500);
        return;
      }
      paramList = this.a;
      paramList.jdField_b_of_type_Int &= 0xFFFFFFFD;
      ...
      this.a.jdField_a_of_type_Biso.b(2, 2131719524, 1500);
      return;
    } while (!paramBoolean);
    label419:
    if (paramList == null)
    ...
    for (paramString = null;; paramString = paramString.b(this.a.jdField_a_of_type_JavaLangString))
    {
      ...
      this.a.a(this.a.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo, false);
      this.a.jdField_a_of_type_Afck.b(paramList);
      return;
      paramInt1 = paramList.size();
      break;
    }
  ...
  protected void onTroopManagerFailed(int paramInt1, int paramInt2)
  {
    if (paramInt1 == 9)
    {
      ...
      if (paramInt2 == 8)
      {
        ...
        localObject = bhdj.a(this.a, 230);
        ((QQCustomDialog)localObject).setTitle(this.a.getString(2131695865));
        ((QQCustomDialog)localObject).setMessage(this.a.getString(2131695866));
        ((QQCustomDialog)localObject).setNegativeButton(this.a.getString(2131695897), new afch(this, (QQCustomDialog)localObject));
        ((QQCustomDialog)localObject).setPositiveButton(this.a.getString(2131718822), new afci(this, (QQCustomDialog)localObject));
  ...
  {
    if (!bhbx.a(paramString, this.a.jdField_a_of_type_JavaLangString)) {}
    while (paramInt1 != 9) {
      return;
    }
    paramString = this.a;
    ...
    if (paramInt2 == 0)
    {
      ...
      paramString.putExtra("fin_tip_msg", this.a.getString(2131692038));
