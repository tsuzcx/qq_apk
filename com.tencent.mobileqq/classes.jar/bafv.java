  ...
  extends DynamicDrawableSpan
{
  ...
  private bafv(Context paramContext, String paramString1, String paramString2, int paramInt, Paint paramPaint)
  {
    super(0);
    this.jdField_a_of_type_JavaLangString = paramString1;
    this.jdField_b_of_type_JavaLangString = a(String.format("%s%s", new Object[] { "@", new ayjw(paramString2, 32).a() }));
    this.jdField_b_of_type_Int = paramInt;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    a(paramPaint);
  }
  
  private bafv(Context paramContext, String paramString1, String paramString2, int paramInt, Paint paramPaint, String paramString3)
  {
    this(paramContext, paramString1, paramString2, paramInt, paramPaint);
    this.d = a(String.format("%s%s", new Object[] { "@", new ayjw(paramString3, 32).a() }));
  }
  ...
  public static SpannableString a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, EditText paramEditText)
  {
    ...
    try
    {
      paramQQAppInterface = new bafv(paramContext, paramString2, paramString3, i - j - k, paramEditText.getPaint(), paramString4);
    ...
    catch (OutOfMemoryError paramQQAppInterface)
    {
      ...
      paramString1 = new SpannableString(new ayjw(paramContext + " ", 16).a());
  ...
  public static SpannableString a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, String paramString3, boolean paramBoolean1, EditText paramEditText, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    bafv[] arrayOfbafv = (bafv[])paramEditText.getEditableText().getSpans(0, paramEditText.getEditableText().toString().length(), bafv.class);
    int i = paramEditText.getWidth();
    int j = paramEditText.getPaddingLeft();
    int k = paramEditText.getPaddingRight();
    try
  ...
  private static bafv a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, String paramString3, boolean paramBoolean1, int paramInt, Paint paramPaint, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean2) {
        ...
        {
          paramString1 = bbcz.e(paramQQAppInterface, paramString1, paramString2);
      ...
      while (!TextUtils.isEmpty(paramQQAppInterface))
      {
        if (QLog.isColorLevel()) {
          QLog.d("_At_Me_DISC", 2, " memUin:" + paramString2 + " troopMemName:" + bbbr.a(paramQQAppInterface) + " isTroop:" + paramBoolean2);
        }
        return new bafv(paramContext, paramString2, paramQQAppInterface, paramInt, paramPaint);
        paramQQAppInterface = paramString3;
        continue;
        if (!paramString2.equalsIgnoreCase("0"))
        {
          paramString1 = bbcz.c(paramQQAppInterface, paramString2, true);
          paramQQAppInterface = paramString1;
  ...
  public static String a(Spannable paramSpannable, ArrayList<MessageForText.AtTroopMemberInfo> paramArrayList)
  {
    ...
    bafv[] arrayOfbafv = (bafv[])paramSpannable.getSpans(0, m - 1, bafv.class);
    if (arrayOfbafv.length == 0) {
      return localStringBuffer.toString();
    }
    if (arrayOfbafv.length > 1) {
      Arrays.sort(arrayOfbafv, new bafw(paramSpannable));
    }
    int j = 0;
    int i = 0;
    int n;
    ...
    for (;;)
    {
      if (i >= arrayOfbafv.length) {
        break label345;
      }
      bafv localbafv = arrayOfbafv[i];
      n = paramSpannable.getSpanStart(localbafv) + j;
      i1 = paramSpannable.getSpanEnd(localbafv) + j;
      String str = localbafv.jdField_b_of_type_JavaLangString;
      if (!TextUtils.isEmpty(localbafv.d)) {
        str = localbafv.d;
      }
      try
      {
        ...
        localAtTroopMemberInfo.uin = Long.valueOf(localbafv.jdField_a_of_type_JavaLangString).longValue();
        if ((localbafv.jdField_a_of_type_JavaLangString != null) && (localbafv.jdField_a_of_type_JavaLangString.equalsIgnoreCase("0"))) {
      ...
      catch (JSONException paramQQAppInterface)
      {
        try
        {
          ...
          if (i1 == 0)
          {
            paramString1 = paramStringBuilder;
            localStringBuilder = paramStringBuilder;
            str = "@" + bbcz.c(paramQQAppInterface, paramString2, str);
            paramString1 = paramStringBuilder;
            localStringBuilder = paramStringBuilder;
  ...
  private List<bckp> a(Paint paramPaint)
  {
    int i = (int)Math.ceil(paramPaint.measureText(" "));
    List localList = bbos.a(this.jdField_b_of_type_Int - i * 2, this.jdField_b_of_type_JavaLangString, paramPaint, this.jdField_a_of_type_Bckq, 16);
    localList.add(new bckp(1, 0, 0, "  ", null));
    this.jdField_a_of_type_Int = bbos.a(localList, paramPaint, new Rect());
    return localList;
  }
  ...
  private void a(Paint paramPaint)
  {
    ...
    {
      localObject3 = (bckp)((Iterator)localObject2).next();
      switch (((bckp)localObject3).c)
      {
      default: 
        break;
      case 1: 
        localCanvas.drawText(((bckp)localObject3).jdField_a_of_type_JavaLangString, f1, f2, paramPaint);
        f1 += paramPaint.measureText(((bckp)localObject3).jdField_a_of_type_JavaLangString);
        break;
      case 2: 
        localObject3 = (aykr)((bckp)localObject3).jdField_a_of_type_AndroidTextStyleCharacterStyle;
        j = ((aykr)localObject3).a().getBounds().height();
        ((aykr)localObject3).draw(localCanvas, "", 0, 0, f1, (i - j) / 2, (i + j) / 2, (j + i) / 2, paramPaint);
        f1 += ((aykr)localObject3).a().getBounds().width();
      }
    }
    localCanvas.save();
    localCanvas.restore();
