...
{
  public aixy(TroopFeedsCenterLogic paramTroopFeedsCenterLogic) {}
  ...
  public void onAnimationEnd(Animation paramAnimation)
  {
    ...
    if (this.a.jdField_b_of_type_AndroidViewAnimationTranslateAnimation == paramAnimation)
    {
      ...
      {
        if (this.a.j) {
          this.a.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130841206);
        }
      }
      else if (this.a.e)
      {
    ...
    for (;;)
    {
      ...
      {
        this.a.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130841192);
        break;
      }
      this.a.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130841191);
      break;
      ...
      if (!TextUtils.isEmpty(str))
      {
        ...
        if (this.a.jdField_a_of_type_AndroidViewAnimationTranslateAnimation == paramAnimation)
        {
          ...
          if ((!this.a.k) && (this.a.jdField_b_of_type_AndroidWidgetImageView != null))
          {
            ...
            this.a.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130841207);
          }
          for (;;)
          {
            if (this.a.jdField_a_of_type_AndroidViewView == null) {
            ...
            break;
            if (ThemeUtil.isNowThemeIsDefault(null, false, null)) {
              this.a.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130841194);
            } else {
              this.a.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130841193);
            }
          }
        }
      }
