...
public class let
{
  ...
  ServiceConnection jdField_a_of_type_AndroidContentServiceConnection = new lev(this);
  ...
  lwc jdField_a_of_type_Lwc = new leu(this);
  public lwe a;
  boolean jdField_a_of_type_Boolean = false;
  public boolean b;
  
  public let(VideoAppInterface paramVideoAppInterface)
  {
    this.jdField_a_of_type_Lwe = null;
  ...
  public int a(int paramInt, String paramString)
  {
    ...
    try
    {
      i = this.jdField_a_of_type_Lwe.a(paramInt, paramString);
      return i;
    }
  ...
  public int a(String paramString)
  {
    if (this.jdField_a_of_type_Lwe != null) {
      try
      {
        int i = this.jdField_a_of_type_Lwe.c(paramString);
        return i;
      }
      catch (RemoteException paramString)
      {
  ...
  public long a(String paramString)
  {
    ...
    try
    {
      l1 = this.jdField_a_of_type_Lwe.a(paramString);
      return l1;
    }
    catch (RemoteException paramString)
    {
  ...
  public Bitmap a(int paramInt, String paramString1, String paramString2, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      try
      {
        Bitmap localBitmap = this.jdField_a_of_type_Lwe.a(paramInt, paramString1, paramString2, paramBoolean1, paramBoolean2);
  ...
  public Bundle a(int paramInt1, int paramInt2, int paramInt3, Bundle paramBundle, ResultReceiver paramResultReceiver)
  {
    if (this.jdField_a_of_type_Lwe != null) {
      try
      {
        paramBundle = this.jdField_a_of_type_Lwe.a(paramInt1, paramInt2, paramInt3, null, paramBundle, paramResultReceiver);
        return paramBundle;
      }
  ...
  public String a()
  {
    ...
    while (!QLog.isColorLevel())
    {
      try
      {
        String str = this.jdField_a_of_type_Lwe.a();
        localObject = str;
      }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    try
    {
      this.jdField_a_of_type_Lwe.a(paramInt, paramString);
      return;
    }
    catch (RemoteException paramString)
    {
  ...
  public void a(int paramInt, String paramString1, String paramString2)
  {
    ...
    try
    {
      this.jdField_a_of_type_Lwe.a(paramInt, paramString1, paramString2);
      return;
    }
  ...
  public void a(long paramLong)
  {
    ...
    try
    {
      this.jdField_a_of_type_Lwe.a(paramLong);
      return;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public void a(long paramLong1, String paramString, long paramLong2)
  {
    ...
    while (!QLog.isColorLevel()) {
      try
      {
        this.jdField_a_of_type_Lwe.a(paramLong1, paramString, paramLong2);
        return;
      }
      catch (RemoteException paramString)
      {
  ...
  public void a(boolean paramBoolean)
  {
    ...
    try
    {
      this.jdField_a_of_type_Lwe.d(paramBoolean);
      return;
    }
  ...
  public boolean a(int paramInt, long paramLong)
  {
    ...
    try
    {
      bool1 = this.jdField_a_of_type_Lwe.a(paramInt, paramLong);
      return bool1;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public boolean a(long paramLong)
  {
    ...
    try
    {
      bool = this.jdField_a_of_type_Lwe.a(paramLong);
      return bool;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public boolean a(String paramString)
  {
    ...
    try
    {
      bool = this.jdField_a_of_type_Lwe.a(paramString);
      return bool;
    }
    catch (RemoteException paramString)
    {
  ...
  public boolean a(String paramString, int paramInt)
  {
    ...
    try
    {
      bool = this.jdField_a_of_type_Lwe.b(paramString, paramInt);
      return bool;
    }
    catch (RemoteException paramString)
    {
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("QQServiceProxy", 2, "getAVRedPacketConfig start mQQServiceForAV = " + this.jdField_a_of_type_Lwe);
    }
    if (this.jdField_a_of_type_Lwe != null) {
      try
      {
        this.jdField_a_of_type_Lwe.a(paramlvs);
        return true;
      }
      catch (RemoteException paramlvs)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("QQServiceProxy", 2, "getAVRedPacketConfig error", paramlvs);
        }
      }
    }
    return false;
  ...
  public long[] a(String paramString)
  {
    ...
    try
    {
      localObject1 = this.jdField_a_of_type_Lwe.a(paramString);
      return localObject1;
    }
    catch (RemoteException paramString)
    {
  ...
  public String b(int paramInt, String paramString1, String paramString2)
  {
    ...
    try
    {
      String str1 = this.jdField_a_of_type_Lwe.a(paramInt, paramString1, paramString2);
      localObject2 = str1;
  ...
  public void b(int paramInt, String paramString)
  {
    ...
    try
    {
      this.jdField_a_of_type_Lwe.b(paramInt, paramString);
      return;
    }
    catch (RemoteException paramString)
    {
  ...
  public void b(String paramString)
  {
    ...
    {
      if (this.jdField_a_of_type_Lwe != null) {
        this.jdField_a_of_type_Lwe.d(paramString);
      }
      return;
    }
  ...
  public boolean b()
  {
    ...
    try
    {
      bool1 = this.jdField_a_of_type_Lwe.a();
      return bool1;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public boolean b(String paramString)
  {
    ...
    try
    {
      this.jdField_a_of_type_Lwe.a(paramString);
      bool1 = true;
    }
    catch (RemoteException paramString)
    {
  ...
  public boolean b(lvs paramlvs)
  {
    ...
    if (this.jdField_a_of_type_Lwe != null) {
      try
      {
        this.jdField_a_of_type_Lwe.b(paramlvs);
        return true;
      }
      catch (RemoteException paramlvs)
      {
        paramlvs.printStackTrace();
        if (QLog.isColorLevel()) {
          QLog.d("QQServiceProxy", 2, "startDownloadAVRedPacketRes error", paramlvs);
        }
      }
    }
    return false;
  ...
  public String c(String paramString)
  {
    ...
    try
    {
      localObject1 = this.jdField_a_of_type_Lwe.d(paramString);
      return localObject1;
    }
    catch (RemoteException paramString)
    {
  ...
  public void c()
  {
    ...
    if ((this.jdField_a_of_type_Lwe == null) && (!this.jdField_a_of_type_Boolean))
    {
  ...
  public void c(String paramString)
  {
    ...
    {
      if (this.jdField_a_of_type_Lwe != null) {
        this.jdField_a_of_type_Lwe.e(paramString);
      }
      return;
    }
    catch (Exception paramString)
  ...
  public boolean c()
  {
    ...
    try
    {
      bool1 = this.jdField_a_of_type_Lwe.g();
      return bool1;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public boolean c(String paramString)
  {
    if (this.jdField_a_of_type_Lwe != null) {
      try
      {
        boolean bool = this.jdField_a_of_type_Lwe.a(paramString, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin());
        return bool;
      }
      catch (RemoteException paramString)
      {
  ...
  public void d()
  {
    lbc.d("QQServiceProxy", "unbindQQService");
    if (this.jdField_a_of_type_Lwe != null) {}
    try
    {
      this.jdField_a_of_type_Lwe.a();
      this.jdField_a_of_type_Lwe.a(this.jdField_a_of_type_Lwc);
    }
    catch (RemoteException localRemoteException)
    {
      for (;;)
  ...
  public boolean d()
  {
    ...
    try
    {
      bool1 = this.jdField_a_of_type_Lwe.h();
      return bool1;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public boolean e()
  {
    ...
    try
    {
      bool1 = this.jdField_a_of_type_Lwe.b();
      return bool1;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public boolean f()
  {
    if ((this.jdField_a_of_type_Int == -1) && (this.jdField_a_of_type_Lwe != null)) {}
    for (;;)
    {
      try
      {
        if (!this.jdField_a_of_type_Lwe.c()) {
          continue;
        }
        i = 1;
  ...
  public boolean g()
  {
    ...
    try
    {
      bool1 = this.jdField_a_of_type_Lwe.d();
      if (QLog.isColorLevel()) {
        QLog.e("EffectEnable", 2, "getEffectsSoLoadIsOk  result " + this.jdField_a_of_type_Lwe + "   " + bool1);
      }
      return bool1;
    }
    catch (RemoteException localRemoteException)
    ...
    catch (NullPointerException localNullPointerException)
    {
      for (;;)
      {
        lbc.e("EffectEnable", localNullPointerException.getMessage());
        bool1 = bool2;
      }
    }
  }
  ...
  public boolean h()
  {
    ...
    try
    {
      bool1 = this.jdField_a_of_type_Lwe.e();
      if (QLog.isColorLevel()) {
        QLog.e("getEffectLibPagSoLoadIsOk", 2, "getEffectLibPagSoLoadIsOk  result " + this.jdField_a_of_type_Lwe + "   " + bool1);
      }
      return bool1;
    }
    catch (RemoteException localRemoteException)
  ...
  public boolean i()
  {
    ...
    {
      if (this.jdField_a_of_type_Lwe != null) {
        bool1 = this.jdField_a_of_type_Lwe.i();
      }
      for (;;)
      {
