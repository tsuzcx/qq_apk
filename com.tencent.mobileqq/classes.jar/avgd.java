...
{
  public avgd(QQGameFeedWebFragment paramQQGameFeedWebFragment) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (localObject1 = "";; localObject1 = ((QQGameMsgInfo)localObject2).paMsgid)
    {
      ...
      abuf.a(amwn.a(), "769", "205037", str, "76901", "1", "160", (Map)localObject2);
      localObject1 = new Intent(BaseApplication.getContext(), GameCenterActivity.class);
      ((Intent)localObject1).putExtra("url", aveq.b());
