  ...
  implements auzh
{
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    if (paramInt != 0)
    {
      ...
      if (avgk.a(this.a)) {}
      for (paramArrayOfByte = alpo.a(2131707755);; paramArrayOfByte = alpo.a(2131707692))
      {
        for (;;)
        {
          QQToast.a(paramBundle, 2, paramArrayOfByte, 1).a();
          if (!TextUtils.isEmpty(avgk.a(this.a).uin)) {
          ...
          {
            paramArrayOfByte = (Button)avgk.a(this.a).getChildAt(1).findViewById(2131379049);
            paramArrayOfByte.setTextColor(this.a.a.getResources().getColor(2131166932));
            paramArrayOfByte.setBackgroundDrawable(this.a.a.getResources().getDrawable(2130845050));
          }
          if (avgk.a(this.a))
          {
            paramArrayOfByte = (Button)avgk.a(this.a).getChildAt(1).findViewById(2131379049);
            paramArrayOfByte.setTextColor(this.a.a.getResources().getColor(2131166934));
            paramArrayOfByte.setBackgroundDrawable(this.a.a.getResources().getDrawable(2130845051));
          }
          return;
          bool = false;
          break;
