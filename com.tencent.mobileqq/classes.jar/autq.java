...
public class autq
{
  ...
  HashMap<bdnu, View> jdField_a_of_type_JavaUtilHashMap = new HashMap(1);
  
  public autq(ForwardSdkBaseOption paramForwardSdkBaseOption, Context paramContext)
  {
  ...
  public View a()
  {
    ...
    ((View)localObject2).setOnClickListener(new autr(this));
    ((View)localObject2).setContentDescription(anvx.a(2131704303));
  ...
  void a()
  {
    ...
    for (;;)
    {
      ...
      if (localIterator.hasNext())
      {
        ...
        View localView1 = (View)this.jdField_a_of_type_JavaUtilHashMap.get(localbdnu);
        View localView2 = localbdnu.a(this.jdField_a_of_type_AndroidContentContext, localView1, (Bundle)localObject1);
        if ((localView2 != null) && ((localbdnu instanceof bdqn)))
        {
          TextView localTextView = (TextView)localView2.findViewById(2131380210);
          if (localTextView != null)
          {
            localTextView.setGravity(16);
            localTextView.setMaxLines(2);
            localTextView.setTextSize(14.0F);
            localTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131165674));
          }
        }
        if ((localView2 == null) || (localView2 == localView1)) {
          break label325;
        }
        this.jdField_a_of_type_JavaUtilHashMap.put(localbdnu, localView2);
