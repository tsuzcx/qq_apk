  ...
  implements bhon
{
  ...
  public bhot(bhoo parambhoo)
  {
    bhol localbhol = parambhoo.a;
    if (localbhol != null) {
      localbhol.setNetTransportEventListener("sig_check", this);
    }
    this.jdField_a_of_type_Bhoo = parambhoo;
  }
  
  public void a(bhou parambhou)
  {
  ...
  {
    if (this.jdField_a_of_type_Bhou == null) {}
    label7:
    do
    {
      do
      {
        do
        {
          ...
          {
            return;
          } while (this.jdField_a_of_type_Bhoo == null);
          paramObject1 = this.jdField_a_of_type_Bhoo.a;
    ...
    try
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_Bhou.a(paramObject1.toString());
        return;
      }
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        ...
        l2 = l1;
        continue;
        localObject2 = this.jdField_a_of_type_Bhoo.a;
        if (localObject2 == null) {
          continue;
        }
        localObject1 = paramString.toByteArray();
        localObject4 = ((bhol)localObject2).getCodec("sig_check");
        paramString = (String)localObject1;
        if (localObject4 != null) {
          paramString = ((bhom)localObject4).encode(localObject1);
        }
        ((bhol)localObject2).send(paramString);
        return;
      }
      try
      {
