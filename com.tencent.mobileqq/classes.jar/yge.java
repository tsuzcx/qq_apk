  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    if (paramView.getId() == 2131363967)
    {
      ...
      DialogUtil.a(this.a.a.jdField_a_of_type_AndroidContentContext, paramView, (String)localObject1, (String)localObject2, new ygf(this), this.a.a.jdField_a_of_type_AndroidContentContext.getString(2131429558), new ygg(this)).show();
    }
    do
    {
      do
    ...
    for (;;)
    {
      ...
      paramView.setContentDescription(((SelectActivityViewHolder)localObject1).b.getText() + this.a.a.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getString(2131436019));
      return;
