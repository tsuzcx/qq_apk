...
public class bgme
  extends Dialog
{
  public bgme(Context paramContext, String paramString)
  {
  ...
  private void a(Context paramContext, String paramString)
  {
    ...
    try
    {
      Object localObject2 = ((LayoutInflater)localObject1).inflate(2131561454, (ViewGroup)localView, false);
      localObject1 = (RelativeLayout)localView.findViewById(2131377452);
      Object localObject3 = new RelativeLayout.LayoutParams(-1, -1);
      ((RelativeLayout.LayoutParams)localObject3).addRule(3, 2131375327);
      ...
      if (localObject2 != null) {
        ((TextView)localObject2).setText(ajyc.a(2131708280));
      }
    ...
    catch (InflateException paramContext)
    {
      ...
      super.setContentView(2131561454);
