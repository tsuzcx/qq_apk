  ...
  extends DynamicDrawableSpan
{
  ...
  private bgme(Context paramContext, String paramString1, String paramString2, int paramInt, Paint paramPaint)
  {
    super(0);
    this.jdField_a_of_type_JavaLangString = paramString1;
    this.jdField_b_of_type_JavaLangString = a(String.format("%s%s", new Object[] { "@", new begb(paramString2, 32).a() }));
    this.jdField_b_of_type_Int = paramInt;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    a(paramPaint);
  }
  
  private bgme(Context paramContext, String paramString1, String paramString2, int paramInt, Paint paramPaint, String paramString3)
  {
    this(paramContext, paramString1, paramString2, paramInt, paramPaint);
    this.d = a(String.format("%s%s", new Object[] { "@", new begb(paramString3, 32).a() }));
  }
  ...
  public static Spannable a(Spannable paramSpannable, ArrayList<MessageForText.AtTroopMemberInfo> paramArrayList)
  {
    ...
    bgme[] arrayOfbgme = (bgme[])paramSpannable.getSpans(0, m - 1, bgme.class);
    if (arrayOfbgme.length == 0) {
      return localSpannableStringBuilder;
    }
    if (arrayOfbgme.length > 1) {
      Arrays.sort(arrayOfbgme, new bgmf(paramSpannable));
    }
    int j = 0;
    int i = 0;
    int n;
    ...
    for (;;)
    {
      if (i >= arrayOfbgme.length) {
        break label342;
      }
      bgme localbgme = arrayOfbgme[i];
      n = paramSpannable.getSpanStart(localbgme) + j;
      i1 = paramSpannable.getSpanEnd(localbgme) + j;
      String str = localbgme.jdField_b_of_type_JavaLangString;
      if (!TextUtils.isEmpty(localbgme.d)) {
        str = localbgme.d;
      }
      try
      {
        ...
        localAtTroopMemberInfo.uin = Long.valueOf(localbgme.jdField_a_of_type_JavaLangString).longValue();
        if ((localbgme.jdField_a_of_type_JavaLangString != null) && (localbgme.jdField_a_of_type_JavaLangString.equalsIgnoreCase("0"))) {
  ...
  public static SpannableString a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, EditText paramEditText)
  {
    ...
    try
    {
      paramQQAppInterface = new bgme(paramContext, paramString2, paramString3, i - j - k, paramEditText.getPaint(), paramString4);
    ...
    catch (OutOfMemoryError paramQQAppInterface)
    {
      ...
      paramString1 = new SpannableString(new begb(paramContext + " ", 16).a());
  ...
  public static SpannableString a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, String paramString3, boolean paramBoolean1, EditText paramEditText, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    bgme[] arrayOfbgme = (bgme[])paramEditText.getEditableText().getSpans(0, paramEditText.getEditableText().toString().length(), bgme.class);
    int i = paramEditText.getWidth();
    int j = paramEditText.getPaddingLeft();
    int k = paramEditText.getPaddingRight();
    try
  ...
  private static bgme a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, String paramString3, boolean paramBoolean1, int paramInt, Paint paramPaint, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean2) {
        ...
        {
          paramString1 = bhlg.e(paramQQAppInterface, paramString1, paramString2);
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("_At_Me_DISC", 2, " memUin:" + paramString2 + " troopMemName:" + bhjx.a(paramQQAppInterface) + " isTroop:" + paramBoolean2);
        }
        return new bgme(paramContext, paramString2, paramQQAppInterface, paramInt, paramPaint);
        paramQQAppInterface = paramString3;
        continue;
        if (!paramString2.equalsIgnoreCase("0"))
        {
          paramString1 = bhlg.c(paramQQAppInterface, paramString2, true);
          paramQQAppInterface = paramString1;
      ...
      catch (JSONException paramQQAppInterface)
      {
        try
        {
          ...
          if (i1 == 0)
          {
            paramString1 = paramStringBuilder;
            localStringBuilder = paramStringBuilder;
            str = "@" + bhlg.c(paramQQAppInterface, paramString2, str);
            paramString1 = paramStringBuilder;
            localStringBuilder = paramStringBuilder;
  ...
  private List<biwb> a(Paint paramPaint)
  {
    int i = (int)Math.ceil(paramPaint.measureText(" "));
    List localList = bhwz.a(this.jdField_b_of_type_Int - i * 2, this.jdField_b_of_type_JavaLangString, paramPaint, this.jdField_a_of_type_Biwc, 16);
    localList.add(new biwb(1, 0, 0, "  ", null));
    this.jdField_a_of_type_Int = bhwz.a(localList, paramPaint, new Rect());
    return localList;
  }
  ...
  private void a(Paint paramPaint)
  {
    ...
    {
      localObject3 = (biwb)((Iterator)localObject2).next();
      switch (((biwb)localObject3).c)
      {
      default: 
        break;
      case 1: 
        localCanvas.drawText(((biwb)localObject3).jdField_a_of_type_JavaLangString, f1, f2, paramPaint);
        f1 += paramPaint.measureText(((biwb)localObject3).jdField_a_of_type_JavaLangString);
        break;
      case 2: 
        localObject3 = (begw)((biwb)localObject3).jdField_a_of_type_AndroidTextStyleCharacterStyle;
        j = ((begw)localObject3).a().getBounds().height();
        ((begw)localObject3).draw(localCanvas, "", 0, 0, f1, (i - j) / 2, (i + j) / 2, (j + i) / 2, paramPaint);
        f1 += ((begw)localObject3).a().getBounds().width();
      }
    }
    localCanvas.save();
    localCanvas.restore();
