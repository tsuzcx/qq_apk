...
public class biip
{
  ...
  public static biip a()
  {
    try
    {
      if (jdField_a_of_type_Biip == null) {
        jdField_a_of_type_Biip = new biip();
      }
      biip localbiip = jdField_a_of_type_Biip;
      return localbiip;
    }
    finally {}
  }
  ...
  public long a()
  {
    try
    {
      ...
      bisy.b("CommonDataAdapter", "get uin from app runtim succ:" + this.jdField_a_of_type_Long);
      label46:
  ...
  protected void a()
  {
    ...
    {
      bisy.e("AppUpdate", "getPackageInfo NameNotFoundException : " + localNameNotFoundException.toString());
      return;
    }
    catch (Exception localException)
    {
      bisy.e("AppUpdate", "getPackageInfo exception : " + localException.toString());
    }
  }
  ...
  public void a(String paramString, Context paramContext, WebView paramWebView)
  {
    try
    {
      ...
      localJSONObject2.put("imei", biuf.c());
      localJSONObject2.put("imsi", biuf.d());
      localJSONObject2.put("mac_addr", biuf.a());
      localJSONObject2.put("model_info", Build.MODEL);
      localJSONObject2.put("network_type", bist.a(a().a()));
      localJSONObject2.put("network_operater", "");
      localJSONObject2.put("location", biuf.f());
    ...
    {
      bisy.e("AppUpdate", "getUpdateApp parse H5 params error : " + localJSONException.toString());
      if (!paramContext.getSharedPreferences("appcenter_app_report", 0).getBoolean("is_app_last_fullReport_success", false))
      {
        bisy.c("AppUpdate", "getUpdateApp will do full report");
        biui.a(paramContext, paramString, paramWebView, String.valueOf(a().a()), false);
        return;
      ...
      {
        bisy.c("AppUpdate", "getUpdateApp will do incremental report");
        biui.a(paramContext, null, 0, paramString, paramWebView, String.valueOf(a().a()));
        return;
      }
      bisy.c("AppUpdate", "getUpdateApp will get update app directly");
      biuj.a(paramContext, paramWebView, paramString, true, String.valueOf(a().a()));
    }
  }
