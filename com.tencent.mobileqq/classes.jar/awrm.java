  ...
  implements awry
{
  ...
  public void a()
  {
    if (QLog.isColorLevel()) {
      QLog.d("Action", 2, "fun startMagicPlay begins, sumPlayTimes:" + this.a.jdField_c_of_type_Int + ",actionGlobalData.openSound:" + this.a.jdField_a_of_type_Awrn.d);
    }
    Object localObject;
    if (this.a.jdField_c_of_type_Int == 0)
    {
      this.a.b();
      if ((this.a.jdField_a_of_type_Awsb.c != null) && (this.a.jdField_a_of_type_Awsb.c.length() > 0) && (this.a.jdField_a_of_type_Awrn.d))
      {
        if (this.a.jdField_a_of_type_Awsb.e > 0)
        {
          localObject = this.a.jdField_a_of_type_Awsb;
          ((awsb)localObject).e -= 1;
        }
        if (QLog.isColorLevel()) {
          QLog.d("Action", 2, "fun startMagicPlay begins, start play Sound.");
        }
        this.a.jdField_a_of_type_Awsn.a(this.a.jdField_a_of_type_Awsb.c, this.a.jdField_a_of_type_Awsb.e);
      }
      if (this.a.jdField_a_of_type_Awsb.a)
      {
        this.a.jdField_a_of_type_AndroidOsVibrator = ((Vibrator)BaseApplicationImpl.getContext().getSystemService("vibrator"));
        if (this.a.jdField_a_of_type_Awsb.h != -1) {
          break label311;
        }
    ...
    {
      localObject = this.a;
      ((awrl)localObject).jdField_c_of_type_Int += 1;
      if (QLog.isColorLevel()) {
        QLog.d("Action", 2, "fun startMagicPlay ends, sumPlayTimes:" + this.a.jdField_c_of_type_Int);
      }
      return;
      label311:
      this.a.jdField_a_of_type_AndroidOsVibrator.vibrate(this.a.jdField_a_of_type_Awsb.h * 1000);
    }
  }
  ...
  public void b()
  {
    ...
    do
    {
      ...
      if (this.a.jdField_a_of_type_Int == -1)
      {
        ...
        {
          this.a.jdField_a_of_type_Awsn.a(this.a.jdField_a_of_type_Awsb);
          return;
        }
