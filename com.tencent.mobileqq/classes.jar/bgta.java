  ...
  implements ValueAnimator.AnimatorUpdateListener
{
  ...
  public void onAnimationUpdate(ValueAnimator paramValueAnimator)
  {
    ...
    if (paramValueAnimator.intValue() <= -bgsy.jdField_a_of_type_Int + this.a.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131299080))
    {
      if (this.a.jdField_a_of_type_Bfgl != null) {
        this.a.jdField_a_of_type_Bfgl.a(false);
      }
