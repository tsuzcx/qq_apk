...
class bgta
  extends nmf
{
  bgta(bgsw parambgsw, bgtc parambgtc, int paramInt) {}
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramArrayOfByte == null)
        {
          ...
          if (this.jdField_a_of_type_Bgtc != null)
          {
            ...
            this.jdField_a_of_type_Bgtc.a(paramBundle);
          }
          return;
        }
      }
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          paramBundle = paramArrayOfByte;
          localObject = new bgtb(null);
          paramBundle = paramArrayOfByte;
          ((bgtb)localObject).jdField_a_of_type_Long = (l2 * 1000L + l1);
          paramBundle = paramArrayOfByte;
          ((bgtb)localObject).jdField_a_of_type_Int = localUrlCheckResult.result.get();
          paramBundle = paramArrayOfByte;
          ((bgtb)localObject).jdField_b_of_type_Int = localUrlCheckResult.jump_result.get();
          paramBundle = paramArrayOfByte;
          ((bgtb)localObject).jdField_a_of_type_JavaLangString = localUrlCheckResult.jump_url.get();
          paramBundle = paramArrayOfByte;
          ((bgtb)localObject).c = localUrlCheckResult.uint32_level.get();
          paramBundle = paramArrayOfByte;
          ((bgtb)localObject).d = localUrlCheckResult.uint32_sub_level.get();
          paramBundle = paramArrayOfByte;
          ((bgtb)localObject).e = localUrlCheckResult.uint32_umrtype.get();
          paramBundle = paramArrayOfByte;
          ((bgtb)localObject).f = localUrlCheckResult.ret_from.get();
          paramBundle = paramArrayOfByte;
          ((bgtb)localObject).jdField_b_of_type_Long = localUrlCheckResult.operation_bit.get();
          if (paramInt == 0) {
            paramArrayOfByte = (byte[])localObject;
          }
          paramBundle = paramArrayOfByte;
          this.jdField_a_of_type_Bgsw.a.put(str, localObject);
          paramInt += 1;
        }
