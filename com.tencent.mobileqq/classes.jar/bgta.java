...
public class bgta<T>
  extends Animation
{
  static final bgth jdField_a_of_type_Bgth = new bgtb();
  static final bgth b;
  static final bgth c;
  static final bgth d;
  static final bgth e = new bgtf();
  ...
  static
  {
    jdField_b_of_type_Bgth = new bgtc();
    jdField_c_of_type_Bgth = new bgtd();
    jdField_d_of_type_Bgth = new bgte();
  }
  
  public bgta(T paramT1, T paramT2, bgtg<T> parambgtg)
  {
    this(paramT1, paramT2, parambgtg, false, false, null);
  }
  
  public bgta(T paramT1, T paramT2, bgtg<T> parambgtg, boolean paramBoolean1, boolean paramBoolean2)
  {
    this(paramT1, paramT2, parambgtg, paramBoolean1, paramBoolean2, null);
  }
  
  public bgta(T paramT1, T paramT2, bgtg<T> parambgtg, boolean paramBoolean1, boolean paramBoolean2, bgth<T> parambgth)
  {
    ...
    for (;;)
    {
      ...
      {
        this.f = jdField_a_of_type_Bgth;
      }
      else if (Float.class == localClass)
      {
        this.f = jdField_b_of_type_Bgth;
      }
      else if (Rect.class == localClass)
      {
        this.f = jdField_c_of_type_Bgth;
      }
      else if (Point.class == localClass)
      {
        this.f = jdField_d_of_type_Bgth;
      }
      else
      {
  ...
  public void a(bgtg<T> parambgtg)
  {
    this.jdField_a_of_type_Bgtg = parambgtg;
  }
  
  protected void applyTransformation(float paramFloat, Transformation paramTransformation)
  {
    if (this.jdField_a_of_type_Bgtg != null) {
      this.jdField_a_of_type_Bgtg.a(this, paramFloat, this.f.a(paramFloat, this.jdField_a_of_type_JavaLangObject, this.jdField_b_of_type_JavaLangObject), paramTransformation);
    }
  }
