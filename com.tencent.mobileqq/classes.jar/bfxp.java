  ...
  extends WebViewPlugin
{
  ...
  public static String a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7)
  {
    ...
    //   0: aload_2
    //   1: sipush 640
    //   4: invokestatic 85	nwh:a	(Ljava/lang/String;I)Landroid/graphics/Bitmap;
    //   7: astore 9
    //   9: aload 9
    //   11: ifnonnull +15 -> 26
    //   14: aload 9
    ...
    //   36: getstatic 98	com/tencent/mobileqq/app/AppConstants:SDCARD_FILE_SAVE_TROOPTMP_PATH	Ljava/lang/String;
    ...
    //   50: invokestatic 112	com/tencent/mobileqq/vfs/VFSAssistantUtils:getSDKPrivatePath	(Ljava/lang/String;)Ljava/lang/String;
    //   53: astore 10
    //   55: aload 9
    //   57: astore_2
    //   58: aload 9
    //   60: new 114	java/io/File
    //   63: dup
    //   64: aload 10
    //   66: invokespecial 117	java/io/File:<init>	(Ljava/lang/String;)V
    //   69: invokestatic 122	bheg:a	(Landroid/graphics/Bitmap;Ljava/io/File;)V
    //   72: aload 9
    //   74: ifnull +8 -> 82
    //   77: aload 9
    //   79: invokevirtual 90	android/graphics/Bitmap:recycle	()V
    //   82: new 124	java/util/HashMap
    //   85: dup
    //   86: invokespecial 125	java/util/HashMap:<init>	()V
    //   89: astore_2
    //   90: aload_2
    //   91: ldc 127
    //   93: aload 5
    //   95: invokestatic 129	bfxp:a	(Ljava/lang/String;)Ljava/lang/String;
    //   98: invokeinterface 135 3 0
    //   103: pop
    //   104: aload_3
    //   105: invokestatic 53	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   108: ifne +62 -> 170
    //   111: new 137	org/json/JSONObject
    //   114: dup
    //   115: aload_3
    //   116: invokespecial 138	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   119: astore_3
    //   120: aload_3
    //   121: invokevirtual 142	org/json/JSONObject:keys	()Ljava/util/Iterator;
    //   124: astore 9
    //   126: aload 9
    //   128: invokeinterface 148 1 0
    //   133: ifeq +37 -> 170
    //   136: aload 9
    //   138: invokeinterface 152 1 0
    ...
    //   151: aload_3
    //   152: aload 11
    //   154: invokevirtual 156	org/json/JSONObject:get	(Ljava/lang/String;)Ljava/lang/Object;
    //   157: invokevirtual 159	java/lang/Object:toString	()Ljava/lang/String;
    //   160: invokeinterface 135 3 0
    //   165: pop
    //   166: goto -40 -> 126
    //   169: astore_3
    //   170: new 124	java/util/HashMap
    //   173: dup
    //   174: invokespecial 125	java/util/HashMap:<init>	()V
    //   177: astore_3
    //   178: aload_3
    //   179: aload 6
    //   181: aload 10
    //   183: invokeinterface 135 3 0
    //   188: pop
    //   189: aload_0
    //   190: invokevirtual 60	java/lang/String:length	()I
    //   193: istore 8
    //   195: new 161	java/lang/StringBuffer
    //   198: dup
    //   199: ldc 163
    //   201: invokespecial 164	java/lang/StringBuffer:<init>	(Ljava/lang/String;)V
    //   204: astore 6
    //   206: iconst_0
    //   207: istore 7
    //   209: iload 7
    ...
    //   219: aload 6
    //   221: ldc 166
    //   223: invokevirtual 169	java/lang/StringBuffer:append	(Ljava/lang/String;)Ljava/lang/StringBuffer;
    //   226: pop
    //   227: iload 7
    //   229: iconst_1
    //   230: iadd
    ...
    //   242: astore_2
    //   243: aload_0
    //   244: invokevirtual 172	java/lang/OutOfMemoryError:printStackTrace	()V
    //   247: aload 9
    //   249: ifnull +8 -> 257
    //   252: aload 9
    ...
    //   265: astore_2
    //   266: aload_0
    //   267: invokevirtual 173	java/io/IOException:printStackTrace	()V
    //   270: aload 9
    //   272: ifnull +8 -> 280
    //   275: aload 9
    ...
    //   295: aload 6
    //   297: aload_0
    //   298: invokevirtual 169	java/lang/StringBuffer:append	(Ljava/lang/String;)Ljava/lang/StringBuffer;
    //   301: pop
    //   302: new 124	java/util/HashMap
    //   305: dup
    //   306: invokespecial 125	java/util/HashMap:<init>	()V
    //   309: astore_0
    //   310: aload_0
    //   311: ldc 175
    //   313: new 177	java/net/URL
    //   316: dup
    //   317: aload_1
    //   318: invokespecial 178	java/net/URL:<init>	(Ljava/lang/String;)V
    //   321: invokevirtual 181	java/net/URL:getRef	()Ljava/lang/String;
    //   324: invokeinterface 135 3 0
    //   329: pop
    //   330: aload 4
    //   332: invokestatic 53	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   335: ifne +67 -> 402
    //   338: new 137	org/json/JSONObject
    //   341: dup
    //   342: aload 4
    //   344: invokespecial 138	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   347: astore 4
    //   349: aload 4
    //   351: invokevirtual 142	org/json/JSONObject:keys	()Ljava/util/Iterator;
    //   354: astore 9
    //   356: aload 9
    //   358: invokeinterface 148 1 0
    //   363: ifeq +39 -> 402
    //   366: aload 9
    ...
    //   381: aload 4
    //   383: aload 10
    //   385: invokevirtual 156	org/json/JSONObject:get	(Ljava/lang/String;)Ljava/lang/Object;
    //   388: invokevirtual 159	java/lang/Object:toString	()Ljava/lang/String;
    //   391: invokeinterface 135 3 0
    //   396: pop
    //   397: goto -41 -> 356
    //   400: astore 4
    //   402: aload_1
    //   403: aload 6
    //   405: invokevirtual 182	java/lang/StringBuffer:toString	()Ljava/lang/String;
    //   408: aload 5
    //   410: aload_2
    //   411: aload_3
    //   412: aload_0
    //   413: invokestatic 188	com/tencent/biz/common/util/HttpUtil:uploadImage	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;)Ljava/lang/String;
    //   416: areturn
    //   417: astore_0
    //   418: aload_0
    //   419: invokevirtual 189	java/net/MalformedURLException:printStackTrace	()V
    //   422: aconst_null
    //   423: areturn
    //   424: astore_0
    //   425: goto -140 -> 285
  ...
  {
    a(paramActivity, paramInt1, paramArrayList1, paramArrayOfBoolean, paramArrayList2, paramBoolean1, paramBoolean2, paramString1, paramInt2, paramPublicAccountShowPictureReport, paramArticleInfo, null, null, paramString2, true, "", null);
  }
  
  public static void a(Activity paramActivity, int paramInt1, ArrayList<String> paramArrayList1, boolean[] paramArrayOfBoolean, ArrayList<String> paramArrayList2, boolean paramBoolean1, boolean paramBoolean2, String paramString1, int paramInt2, PublicAccountShowPictureReport paramPublicAccountShowPictureReport, ArticleInfo paramArticleInfo, ArrayList<String> paramArrayList3, ArrayList<String> paramArrayList4, String paramString2, boolean paramBoolean3, String paramString3, HashMap<String, Object> paramHashMap)
  {
    ThreadManager.post(new TroopNoticeJsHandler.2(paramActivity, paramInt1, paramArrayList1, paramArrayList2, paramArrayOfBoolean, paramPublicAccountShowPictureReport, paramArrayList3, paramArrayList4, paramString3, paramHashMap, paramBoolean1, paramBoolean2, paramBoolean3, paramArticleInfo, paramString1, paramString2, paramInt2), 8, null, true);
  }
  ...
  public static void a(Activity paramActivity, int paramInt1, ArrayList<String> paramArrayList1, boolean[] paramArrayOfBoolean, ArrayList<String> paramArrayList2, boolean paramBoolean1, boolean paramBoolean2, String paramString1, int paramInt2, PublicAccountShowPictureReport paramPublicAccountShowPictureReport, String paramString2, String paramString3, ArticleInfo paramArticleInfo, String paramString4)
  {
    ...
    if (paramArticleInfo != null)
    {
      ...
      pqb.a(paramArticleInfo, "", paramInt1, localBundle);
    }
    ...
    if ((pkh.a(paramArticleInfo)) && (!TextUtils.isEmpty(paramString2))) {
      localBundle.putString("btntext", paramActivity.getString(2131717777));
    }
    localIntent.putExtras(localBundle);
    paramActivity.startActivityForResult(localIntent, paramInt2);
  }
  ...
  protected void a(String paramString)
  {
    try
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject8))
      {
        ...
        ((PhotoInfo)localObject7).videodata.height = j;
      ...
      for (;;)
      {
        ...
        localObject5 = bhcu.encodeToString(((JSONObject)localObject6).optString("title", "").getBytes(), 0);
        ...
        if (bool1)
        {
          if (localObject8 != null)
          {
            ...
            {
              this.jdField_a_of_type_AndroidContentBroadcastReceiver = new bfxq(this);
    ...
    try
    {
      ...
      if (localAppInterface != null)
      {
        ...
        if (localActivity != null)
        {
          ...
          String str5 = bkki.a(localAppInterface);
