...
public class bdkt
{
  ...
  public static void a()
  {
    ...
    for (;;)
    {
      ...
      if ((localObject == null) || (((agdw)localObject).f != 1)) {
        continue;
      }
      b = true;
      ...
      try
      {
        ...
        bdmc.a(BaseApplicationImpl.getContext()).a(str3, "FightReporter_deviceid", true, 0L, 0L, localHashMap, null);
  ...
  public static void a(AbsStructMsg paramAbsStructMsg)
  {
    ...
    do
    {
      try
      {
        ...
        agdw localagdw2 = agdx.a;
        localagdw1 = localagdw2;
        if (!a) {
          continue;
        }
        localagdw1 = localagdw2;
      ...
      return;
    } while (localagdw1 != null);
  }
  
  public static void a(String paramString)
  {
    bdkh.a(new Throwable(paramString));
  }
  
  public static void a(String paramString1, String paramString2)
  {
    bdkh.a(new Throwable(paramString1), paramString2);
  }
  ...
  public static void b()
  {
    ...
    for (Object localObject = Build.SUPPORTED_ABIS[0];; localObject = Build.CPU_ABI)
    {
      ...
      bdmc.a(BaseApplicationImpl.getContext()).a(str, "FightReporter_cpu_abi", true, 0L, 0L, localHashMap, null);
      if (!QLog.isDevelopLevel()) {
        break;
      }
  ...
  {
    agdw localagdw = agdx.a;
    if ((localagdw != null) && (localagdw.e == 1)) {
