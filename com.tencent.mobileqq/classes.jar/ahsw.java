  ...
  extends AsyncTask<Integer, Integer, Integer>
{
  ...
  ahtm jdField_a_of_type_Ahtm;
  boolean jdField_a_of_type_Boolean = true;
  ahtm[] jdField_a_of_type_ArrayOfAhtm;
  
  public ahsw(ArrayList<ahtm> paramArrayList)
  {
    Object localObject;
    this.jdField_a_of_type_ArrayOfAhtm = ((ahtm[])localObject.toArray(new ahtm[0]));
  }
  
  private int a(ahtm[] paramArrayOfahtm, boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, Integer... paramVarArgs)
  {
    int i;
    ...
    do
    {
      ...
      paramInt1 = 0;
      if (paramInt1 >= paramArrayOfahtm.length) {
        break label267;
      }
      localObject = paramArrayOfahtm[paramInt1];
      if (!paramBoolean) {
        return 1;
      }
      ...
      localObject = (AIOImageData)((ahtm)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
      publishProgress(new Integer[] { Integer.valueOf(paramInt2 * 100 / paramVarArgs.length + paramInt1 * 100 / paramVarArgs.length / paramArrayOfahtm.length & 0xFFFF | paramInt3 << 16) });
      j = ahso.a(this.jdField_a_of_type_Ahso, null, (AIOImageData)localObject, localFile);
      i = j;
    } while (j != 20);
    do
    {
      ...
      publishProgress(new Integer[] { Integer.valueOf(paramInt2 * 100 / paramVarArgs.length + paramInt1 * 100 / paramVarArgs.length / paramArrayOfahtm.length & 0xFFFF | paramInt3 << 16) });
      i = ahso.a(this.jdField_a_of_type_Ahso, null, (AIOFilePicData)localObject, localFile);
    } while (i == 20);
    return i;
    label267:
    if (QLog.isColorLevel()) {
  ...
  protected Integer a(Integer... paramVarArgs)
  {
    ...
    //   46: istore 4
    //   48: aload_0
    //   49: getfield 20	ahsw:jdField_a_of_type_Boolean	Z
    //   52: ifne +8 -> 60
    //   55: iconst_1
    ...
    //   90: aastore
    //   91: invokevirtual 102	ahsw:publishProgress	([Ljava/lang/Object;)V
    //   94: iload 4
    //   96: tableswitch	default:+439 -> 535, 0:+446->542, 1:+400->496, 2:+446->542
    //   125: aload_0
    //   126: getfield 31	ahsw:jdField_a_of_type_ArrayOfAhtm	[Lahtm;
    //   129: arraylength
    //   130: if_icmpge +424 -> 554
    //   133: aload_0
    //   134: getfield 20	ahsw:jdField_a_of_type_Boolean	Z
    //   137: ifne +8 -> 145
    //   140: iconst_1
    ...
    //   165: idiv
    //   166: aload_0
    //   167: getfield 31	ahsw:jdField_a_of_type_ArrayOfAhtm	[Lahtm;
    //   170: arraylength
    //   171: idiv
    //   172: iadd
    //   173: ldc 94
    ...
    //   185: aastore
    //   186: invokevirtual 102	ahsw:publishProgress	([Ljava/lang/Object;)V
    //   189: aload_0
    //   190: getfield 31	ahsw:jdField_a_of_type_ArrayOfAhtm	[Lahtm;
    //   193: iload_2
    //   194: aaload
    //   195: astore 7
    //   197: ldc 82
    //   199: aload 7
    //   201: getfield 85	ahtm:jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData	Lcom/tencent/mobileqq/activity/aio/photo/AIORichMediaData;
    //   204: invokevirtual 91	java/lang/Class:isInstance	(Ljava/lang/Object;)Z
    //   207: ifeq +340 -> 547
    //   210: aload 7
    //   212: getfield 85	ahtm:jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData	Lcom/tencent/mobileqq/activity/aio/photo/AIORichMediaData;
    ...
    //   240: aload_0
    //   241: aload 7
    //   243: putfield 148	ahsw:jdField_a_of_type_Ahtm	Lahtm;
    //   246: aload_0
    //   247: getfield 20	ahsw:jdField_a_of_type_Boolean	Z
    //   250: ifeq +164 -> 414
    //   253: aload 8
    //   255: ifnull +18 -> 273
    ...
    //   270: ifne +144 -> 414
    //   273: aload_0
    //   274: getfield 148	ahsw:jdField_a_of_type_Ahtm	Lahtm;
    //   277: iconst_1
    //   278: putfield 149	ahtm:jdField_a_of_type_Boolean	Z
    //   281: aload_0
    //   282: getfield 15	ahsw:jdField_a_of_type_Ahso	Lahso;
    //   285: getfield 152	ahso:jdField_a_of_type_Ahtp	Lahtp;
    //   288: aload 6
    ...
    //   304: aload_0
    //   305: getfield 148	ahsw:jdField_a_of_type_Ahtm	Lahtm;
    //   308: astore 7
    //   310: aload 7
    //   312: monitorenter
    //   313: aload_0
    //   314: getfield 148	ahsw:jdField_a_of_type_Ahtm	Lahtm;
    //   317: getfield 149	ahtm:jdField_a_of_type_Boolean	Z
    //   320: ifeq +10 -> 330
    //   323: aload_0
    //   324: getfield 148	ahsw:jdField_a_of_type_Ahtm	Lahtm;
    ...
    //   385: aload_0
    //   386: aload_0
    //   387: getfield 31	ahsw:jdField_a_of_type_ArrayOfAhtm	[Lahtm;
    //   390: arraylength
    //   391: iload_2
    //   392: isub
    //   393: putfield 179	ahsw:jdField_a_of_type_Int	I
    //   396: bipush 11
    ...
    //   413: areturn
    //   414: aload_0
    //   415: getfield 20	ahsw:jdField_a_of_type_Boolean	Z
    //   418: ifne +8 -> 426
    //   421: iconst_1
    ...
    //   479: aload_0
    //   480: aload_0
    //   481: getfield 31	ahsw:jdField_a_of_type_ArrayOfAhtm	[Lahtm;
    //   484: arraylength
    //   485: iload_2
    //   486: isub
    //   487: putfield 179	ahsw:jdField_a_of_type_Int	I
    //   490: bipush 11
    //   492: invokestatic 98	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   495: areturn
    //   496: aload_0
    //   497: aload_0
    //   498: getfield 31	ahsw:jdField_a_of_type_ArrayOfAhtm	[Lahtm;
    //   501: aload_0
    //   502: getfield 20	ahsw:jdField_a_of_type_Boolean	Z
    //   505: iload 5
    //   507: iload_3
    //   508: iload 4
    //   510: aload_1
    //   511: invokespecial 186	ahsw:a	([Lahtm;ZIII[Ljava/lang/Integer;)I
  ...
  {
    this.jdField_a_of_type_Ahso.b(paramInteger.intValue(), this.jdField_a_of_type_Int);
    this.jdField_a_of_type_Ahso.jdField_a_of_type_Ahsw = null;
  }
  
  protected void a(Integer... paramVarArgs)
  {
    int i = paramVarArgs[(paramVarArgs.length - 1)].intValue();
    this.jdField_a_of_type_Ahso.c(i >> 16, 0xFFFF & i);
  }
}
