...
public class aaeh
  implements Runnable
{
  public aaeh(ScanningSurfaceView paramScanningSurfaceView, ScanningData paramScanningData1, ScanningData paramScanningData2) {}
  ...
  public void run()
  {
    ...
    if (this.b != null)
    {
      ...
      this.b.c = true;
      this.jdField_a_of_type_ComTencentMobileqqArScanningSurfaceView.a.a.a(3, this.b.g, this.b.h, new aaei(this));
