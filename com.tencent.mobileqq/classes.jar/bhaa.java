...
public class bhaa
{
  ...
  public void a(TroopChatPie paramTroopChatPie)
  {
    ...
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie.c.findViewById(2131364389));
  }
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie != null) {
      ((bgsu)this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(113)).a(paramString1, paramString2, paramInt1, paramInt2, new bhan(this, paramInt2, paramString2, paramMessageForDeliverGiftTips, paramBoolean));
    }
    this.jdField_a_of_type_Int = 0;
  }
  
  public void a(MessageForDeliverGiftTips paramMessageForDeliverGiftTips, String paramString, boolean paramBoolean, bdyi parambdyi)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie == null) {
      return;
    }
    ...
    if (this.jdField_a_of_type_AndroidMediaSoundPool != null) {
      this.b = this.jdField_a_of_type_AndroidMediaSoundPool.load(bgth.a(paramString) + "sound.wav", 1);
    }
    ThreadManager.post(new TroopInteractGiftAnimationController.1(this, paramString, paramMessageForDeliverGiftTips, paramBoolean, parambdyi, (bgsu)this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(113)), 8, null, true);
  }
