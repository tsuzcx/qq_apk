...
public class akpl
{
  public static int a(MessageRecord paramMessageRecord, int paramInt)
  {
    ...
    if (paramMessageRecord != null)
    {
      ...
      akpm localakpm = (akpm)paramMessageRecord.next();
      if (localakpm.a != paramInt) {
        break label64;
      }
      i = localakpm.b + i;
    }
  ...
  public static List<akpm> a(MessageRecord paramMessageRecord)
  {
    ...
    if (((paramMessageRecord instanceof MessageForStructing)) && ((((MessageForStructing)paramMessageRecord).structingMsg instanceof AbsShareMsg)) && (((MessageForStructing)paramMessageRecord).structingMsg.mMsgServiceID == 52))
    {
      ...
      for (;;)
      {
        ...
        {
          paramMessageRecord = (axun)localIterator.next();
          if (paramMessageRecord != null)
          {
            str = ajyc.a(2131705265);
            j = 1;
            if ((paramMessageRecord instanceof axwz))
            {
              i = ((axwz)paramMessageRecord).a.getInt("count");
              j = 1;
    ...
    for (;;)
    {
      localArrayList.add(new akpm(paramMessageRecord, j, i));
      break;
