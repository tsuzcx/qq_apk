  ...
  implements Manager
{
  ...
  private axuv jdField_a_of_type_Axuv;
  private NearbyAppInterface jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface;
  private final List<axuu> jdField_a_of_type_JavaUtilList = new ArrayList();
  private MqqHandler jdField_a_of_type_MqqOsMqqHandler;
  private boolean[] jdField_a_of_type_ArrayOfBoolean;
  private final List<axuu> jdField_b_of_type_JavaUtilList = new ArrayList();
  private MqqHandler jdField_b_of_type_MqqOsMqqHandler;
  
  public axut(NearbyAppInterface paramNearbyAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface = paramNearbyAppInterface;
    this.jdField_a_of_type_Axuv = new axuv(paramNearbyAppInterface, this);
  ...
  {
    return this.jdField_a_of_type_Axuv.a(paramInt);
  }
  
  private Message b(Message paramMessage)
  {
    return this.jdField_a_of_type_Axuv.a(paramMessage);
  }
  
  private Object[] b(int paramInt, Object... paramVarArgs)
  {
    return this.jdField_a_of_type_Axuv.a(paramInt, paramVarArgs);
  }
  
  public int a()
  {
    Object[] arrayOfObject = this.jdField_a_of_type_Axuv.a(4156);
  ...
  public Message a(Message paramMessage)
  {
    ...
    ((aoke)this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.getManager(axoc.k)).a(FaceInfo.a(i, (String)localObject, j, 3, 0));
    return null;
  }
  ...
  public aymi a()
  {
    ...
    try
    {
      localaymi.jdField_a_of_type_Int = ((Integer)arrayOfObject[0]).intValue();
      localaymi.b = ((Integer)arrayOfObject[1]).intValue();
      localaymi.c = ((Integer)arrayOfObject[2]).intValue();
      localaymi.d = ((Integer)arrayOfObject[3]).intValue();
      return localaymi;
    }
    catch (Exception localException)
    {
  ...
  public String a()
  {
    ...
    ((Message)localObject1).what = 4137;
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    ...
    //   1: istore 4
    //   3: aload_0
    //   4: getfield 28	axut:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   7: astore 5
    //   9: aload 5
    //   11: monitorenter
    //   12: iconst_0
    ...
    //   14: iload_3
    //   15: aload_0
    //   16: getfield 28	axut:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   19: invokeinterface 297 1 0
    //   24: if_icmpge +45 -> 69
    //   27: aload_0
    //   28: getfield 28	axut:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   31: iload_3
    //   32: invokeinterface 300 2 0
    //   37: checkcast 302	axuu
    //   40: astore 6
    //   42: aload_0
    //   43: getfield 45	axut:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   46: new 304	com/tencent/mobileqq/nearby/ipc/NearbyProcManager$1
    //   49: dup
    //   50: aload_0
    //   51: aload 6
    //   53: iload_1
    //   54: aload_2
    //   55: invokespecial 307	com/tencent/mobileqq/nearby/ipc/NearbyProcManager$1:<init>	(Laxut;Laxuu;I[Ljava/lang/Object;)V
    //   58: invokevirtual 313	mqq/os/MqqHandler:post	(Ljava/lang/Runnable;)Z
    //   61: pop
    //   62: iload_3
    //   63: iconst_1
    //   64: iadd
    ...
    //   71: monitorexit
    //   72: aload_0
    //   73: getfield 26	axut:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   76: astore 5
    //   78: aload 5
    //   80: monitorenter
    //   81: iload 4
    ...
    //   84: iload_3
    //   85: aload_0
    //   86: getfield 26	axut:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   89: invokeinterface 297 1 0
    //   94: if_icmpge +51 -> 145
    //   97: aload_0
    //   98: getfield 26	axut:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   101: iload_3
    //   102: invokeinterface 300 2 0
    //   107: checkcast 302	axuu
    //   110: astore 6
    //   112: aload_0
    //   113: getfield 50	axut:jdField_b_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   116: new 315	com/tencent/mobileqq/nearby/ipc/NearbyProcManager$2
    //   119: dup
    //   120: aload_0
    //   121: aload 6
    //   123: iload_1
    //   124: aload_2
    //   125: invokespecial 316	com/tencent/mobileqq/nearby/ipc/NearbyProcManager$2:<init>	(Laxut;Laxuu;I[Ljava/lang/Object;)V
    //   128: invokevirtual 313	mqq/os/MqqHandler:post	(Ljava/lang/Runnable;)Z
    //   131: pop
    //   132: iload_3
    //   133: iconst_1
    //   134: iadd
  ...
  public void a(axuu paramaxuu)
  {
    a(paramaxuu, false);
  }
  
  public void a(axuu paramaxuu, boolean paramBoolean)
  {
    if (paramaxuu == null) {
      return;
    }
    if (paramBoolean) {
      ...
      {
        if (!this.jdField_a_of_type_JavaUtilList.contains(paramaxuu)) {
          this.jdField_a_of_type_JavaUtilList.add(paramaxuu);
        }
        return;
      }
    }
    ...
    {
      if (!this.jdField_b_of_type_JavaUtilList.contains(paramaxuu)) {
        this.jdField_b_of_type_JavaUtilList.add(paramaxuu);
      }
      return;
    }
  }
  ...
  public void a(oidb_0x8dd.SelfInfo paramSelfInfo)
  {
    ...
    try
    {
      ...
      {
        localObject1 = localObject2;
        axql.a("Q.nearby", "updateSelfCard", new Object[] { paramSelfInfo, localObject1 });
        return;
      }
    }
    catch (Exception localException)
  ...
  public boolean a()
  {
    return this.jdField_a_of_type_Axuv.a();
  }
  ...
  public boolean a(int paramInt, boolean paramBoolean)
  {
    boolean bool1 = false;
    Object localObject = null;
    SharedPreferences localSharedPreferences = axqc.a("nearby_event_file", this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.getAccount(), 4);
      ...
      for (;;)
      {
        for (;;)
        {
          try
          {
            ...
            if (QLog.isColorLevel()) {
              axql.a("onGetMyTabConfig", new Object[] { Boolean.valueOf(bool2), Integer.valueOf(paramInt), Boolean.valueOf(paramBoolean) });
            }
            return bool1;
          }
          ...
          catch (Exception localException)
          {
            ...
            {
              localException.printStackTrace();
              axql.a("onGetMyTabConfig", new Object[] { "save config", Integer.valueOf(paramInt), localException.toString() });
            }
            bool1 = true;
          }
        }
  ...
  public Object[] a(int paramInt, Object... paramVarArgs)
  {
    ...
    case 4146: 
      do
      {
        do
        {
          do
          {
            do
            {
              for (;;)
              {
                ...
                if ((paramVarArgs != null) && (paramVarArgs.length == 1) && ((paramVarArgs[0] instanceof Integer)))
                {
                  ...
                  if (QLog.isColorLevel())
                  {
                    axql.a("MSG_NOTIFY_HAS_UNREAD_MSG", new Object[] { Integer.valueOf(paramInt) });
                    return null;
                        ...
                        if ((paramVarArgs != null) && (paramVarArgs.length == 2))
                        {
                          ...
                          if ((paramVarArgs != null) && (paramVarArgs.length == 1))
                          {
                            ...
                            if ((paramVarArgs != null) && (paramVarArgs.length == 1))
                            {
                              a(4116, paramVarArgs);
                              return null;
                              ayob.a(this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface, 0, true);
                              return null;
            ...
            return null;
            ((aqww)this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.getManager(axoc.f)).a();
            return null;
        ...
        try
        {
          ...
          ((axqa)this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.getManager(axoc.m)).a(l, paramInt, i, j);
          return null;
        }
        catch (Exception paramVarArgs)
        {
      ...
      ((anzr)this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.a(axoc.c)).a(paramInt, i);
      return null;
    case 4159: 
      a(4159, new Object[0]);
      return null;
  ...
  public int b()
  {
    Object[] arrayOfObject = b(4163, new Object[] { AppConstants.NEARBY_LBS_HELLO_UIN });
    try
    {
      int i = ((Integer)arrayOfObject[0]).intValue();
      if (QLog.isColorLevel()) {
  ...
  public aymi b()
  {
    ...
    try
    {
      ...
      localaymi.c = ((Integer)arrayOfObject[2]).intValue();
      localaymi.d = ((Integer)arrayOfObject[3]).intValue();
      localaymi.jdField_a_of_type_JavaLangString = ((String)arrayOfObject[4]);
      return localaymi;
    }
    catch (Exception localException)
    {
  ...
  public String b()
  {
    Object localObject2 = null;
    Object localObject1 = Message.obtain();
    ((Message)localObject1).what = 4138;
    Message localMessage = b((Message)localObject1);
    localObject1 = localObject2;
    if (localMessage != null)
    {
  ...
  public void b()
  {
    this.jdField_a_of_type_Axuv.b();
  }
  
  public void b(axuu paramaxuu)
  {
    synchronized (this.jdField_b_of_type_JavaUtilList)
    {
      if (this.jdField_b_of_type_JavaUtilList.contains(paramaxuu)) {
        this.jdField_b_of_type_JavaUtilList.remove(paramaxuu);
      }
    }
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      if (this.jdField_a_of_type_JavaUtilList.contains(paramaxuu)) {
        this.jdField_a_of_type_JavaUtilList.remove(paramaxuu);
      }
      return;
      paramaxuu = finally;
      throw paramaxuu;
  ...
  {
    b();
    this.jdField_a_of_type_Axuv = null;
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
