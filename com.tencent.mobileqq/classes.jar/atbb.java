...
public class atbb
{
  private static Map<String, atbb> jdField_a_of_type_JavaUtilMap = new HashMap();
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private final Context jdField_a_of_type_AndroidContentContext;
  private Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new atbc(this);
  ...
  private final List<atbd> jdField_a_of_type_JavaUtilList = new LinkedList();
  ...
  private atbb(Context paramContext, InstalledPlugin paramInstalledPlugin)
  {
  ...
  private Intent a()
  {
    ...
    for (int i = 1;; i = 2)
    {
      ...
      localIntent.putExtra("qqVersion", "8.3.5");
      return localIntent;
    }
  }
  
  public static atbb a(Context paramContext, InstalledPlugin paramInstalledPlugin)
  {
    try
    {
      atbb localatbb2 = (atbb)jdField_a_of_type_JavaUtilMap.get(paramInstalledPlugin.pluginFile.getName());
      atbb localatbb1 = localatbb2;
      if (localatbb2 == null)
      {
        localatbb1 = new atbb(paramContext, paramInstalledPlugin);
        jdField_a_of_type_JavaUtilMap.put(paramInstalledPlugin.pluginFile.getName(), localatbb1);
      }
      return localatbb1;
    }
    finally {}
  ...
  private RunningPlugin a()
  {
    ...
    a("HuayangPluginLauncher", alud.a(2131706026));
    try
    {
      ...
      {
        a("HuayangPluginLauncher", alud.a(2131706036) + (System.currentTimeMillis() - l));
    ...
    catch (Exception localException2)
    {
      ...
      a(80);
      a("HuayangPluginLauncher", alud.a(2131706040) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile + alud.a(2131706035) + (System.currentTimeMillis() - l));
    }
  ...
  private void a(int paramInt)
  {
    ...
    a("HuayangPluginLauncher", alud.a(2131706034) + paramInt);
  ...
  private void a(RunningPlugin paramRunningPlugin)
  {
    ...
    long l = System.currentTimeMillis();
    a("HuayangPluginLauncher", alud.a(2131706024) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile);
    ...
    for (;;)
    {
      try
      {
        ...
        a(true, null);
        if (!atav.a(this.jdField_a_of_type_ComTencentMobileqqIntervideoIVPluginInfo.jdField_c_of_type_JavaLangString)) {
          continue;
        }
        atbh.a("2691707");
      ...
      a("HuayangPluginLauncher", alud.a(2131706039) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile + alud.a(2131706032) + (System.currentTimeMillis() - l));
      return;
      if (atav.b(this.jdField_a_of_type_ComTencentMobileqqIntervideoIVPluginInfo.jdField_c_of_type_JavaLangString)) {
        atbh.a("2597725");
      }
    }
  }
  ...
  {
    long l = System.currentTimeMillis();
    a("HuayangPluginLauncher", alud.a(2131706030) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile);
    Intent localIntent = a();
    try
    {
      paramRunningPlugin.startInitActivity(localIntent).get();
      a("HuayangPluginLauncher", alud.a(2131706028) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile + alud.a(2131706025) + (System.currentTimeMillis() - l));
      return;
    }
    catch (Throwable paramRunningPlugin)
    {
      for (;;)
      {
        ...
        ataq.a(paramRunningPlugin);
      }
    }
  }
  
  public void a(atbd paramatbd)
  {
    if (paramatbd != null) {
      this.jdField_a_of_type_JavaUtilList.add(paramatbd);
    }
  }
  ...
  public void b(atbd paramatbd)
  {
    if (paramatbd != null) {
      this.jdField_a_of_type_JavaUtilList.remove(paramatbd);
    }
  }
}
