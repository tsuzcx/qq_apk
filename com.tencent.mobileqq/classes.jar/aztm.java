...
public class aztm
  implements View.OnClickListener, aztp
{
  private int jdField_a_of_type_Int;
  private View jdField_a_of_type_AndroidViewView;
  private aztn jdField_a_of_type_Aztn;
  ...
  public aztm(boolean paramBoolean)
  {
    this.c = paramBoolean;
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramCommTaskInfo.getAccount().equalsIgnoreCase(paramCard.uin))
        {
          ...
          bdla.b(null, "dc00898", "", "", "qq_vip", "0X800A7D6", i, 0, "", "", "", "");
          return;
        }
        ...
        {
          i = k;
          bdla.b(null, "dc00898", "", paramCommTaskInfo, "qq_vip", "0X800A7DC", i, 0, "", "", "", "");
          return;
        }
      }
  ...
  public static boolean a(azrb paramazrb)
  {
    ...
    do
    {
      ...
      {
        int i;
        if (paramazrb.jdField_a_of_type_ComTencentMobileqqDataCard.switch_musicbox == 0)
        {
          i = 1;
          bdla.b(null, "dc00898", "", "", "0X800A7DB", "qq_vip", i, 0, "", "", "", "");
          if (paramazrb.jdField_a_of_type_ComTencentMobileqqDataCard.switch_musicbox != 0) {
            break label74;
          }
        }
      ...
      bool1 = paramazrb.jdField_a_of_type_ComTencentMobileqqDataCard.isVipOpen(EVIPSPEC.E_SP_SUPERVIP);
      bool2 = paramazrb.jdField_a_of_type_ComTencentMobileqqDataCard.isVipOpen(EVIPSPEC.E_SP_BIGCLUB);
    } while ((paramazrb.jdField_a_of_type_ComTencentMobileqqDataCard.switch_musicbox != 0) || (TextUtils.isEmpty(paramazrb.jdField_a_of_type_ComTencentMobileqqDataCard.songId)) || ((!bool1) && (!bool2)));
    return true;
  }
  ...
  public static void b(Context paramContext, String paramString)
  {
    ...
    paramString = bkyp.a(arky.a().jdField_b_of_type_JavaLangString, "uin", paramString);
  ...
  public View a(Context paramContext, String paramString)
  {
    ...
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(paramContext).inflate(2131562049, null);
    this.jdField_a_of_type_AndroidViewView.setOnClickListener(this);
    if (this.c)
    {
      this.jdField_a_of_type_AndroidViewView.findViewById(2131368840).setOnClickListener(this);
      this.jdField_a_of_type_AndroidViewView.findViewById(2131378021).setOnClickListener(this);
      this.jdField_a_of_type_ComTencentWidgetAlphaClickableImageView = ((AlphaClickableImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378021));
      this.jdField_a_of_type_AndroidViewView.findViewById(2131377885).setVisibility(8);
    }
    for (;;)
    {
      a(2);
      this.jdField_a_of_type_Int = AIOUtils.dp2px(35.0F, paramContext.getResources());
      if (this.jdField_a_of_type_Aztn == null) {
        this.jdField_a_of_type_Aztn = ListenTogetherManager.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a();
      }
      this.jdField_a_of_type_Aztn.a(this);
      return this.jdField_a_of_type_AndroidViewView;
      this.jdField_a_of_type_AndroidViewView.findViewById(2131377885).setOnClickListener(this);
      this.jdField_a_of_type_AndroidViewView.findViewById(2131368840).setVisibility(8);
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    TextView localTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131377885);
    localTextView.setCompoundDrawablePadding(ViewUtils.dpToPx(4.0F));
    if (paramInt == 1)
    {
      localTextView.setCompoundDrawablesWithIntrinsicBounds(2130850295, 0, 0, 0);
      return;
    }
    localTextView.setCompoundDrawablesWithIntrinsicBounds(2130850296, 0, 0, 0);
  }
  
  public void a(Context paramContext, String paramString)
  {
    Intent localIntent = new Intent(paramContext, QQBrowserActivity.class);
    localIntent.putExtra("url", bkyp.a(arky.a().jdField_a_of_type_JavaLangString, "uin", paramString));
    paramContext.startActivity(localIntent);
    int i = 2;
    if (a()) {
      if (!this.d) {}
    ...
    for (;;)
    {
      bdla.b(null, "dc00898", "", "", "qq_vip", "0X800A7D7", i, 0, "", "", "", "");
      return;
      i = 1;
      continue;
      i = 3;
  ...
  {
    Object localObject = paramazrb.jdField_a_of_type_ComTencentMobileqqDataCard;
    ...
    for (bool1 = true;; bool1 = false)
    {
      ...
      a(true);
      localObject = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378815);
      if (paramazrb.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Int != 0)
      {
        this.e = false;
        ((TextView)localObject).setText(ProfileCardMoreInfoView.a(paramazrb) + ((TextView)localObject).getContext().getResources().getString(2131694915));
      }
      return;
    }
    a(false);
    ...
    for (;;)
    {
      a(this.jdField_a_of_type_ComTencentMobileqqMusicSongInfo, aztn.a(Long.parseLong(this.jdField_a_of_type_JavaLangString)));
      break;
  ...
  public void a(SongInfo paramSongInfo, boolean paramBoolean)
  {
    ...
    if (this.c)
    {
      ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131377884)).setText(paramSongInfo.c);
      ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131377883)).setText(paramSongInfo.h);
      a(paramSongInfo.e);
      return;
    }
    ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131377885)).setText(paramSongInfo.c + "-" + paramSongInfo.h);
  ...
  public void a(String paramString)
  {
    ...
    localURLDrawableOptions.mLoadingDrawable = this.jdField_a_of_type_AndroidViewView.getContext().getResources().getDrawable(2130844759);
    localURLDrawableOptions.mFailedDrawable = this.jdField_a_of_type_AndroidViewView.getContext().getResources().getDrawable(2130844759);
    paramString = URLDrawable.getDrawable(paramString, localURLDrawableOptions);
    paramString.setTag(new int[] { this.jdField_a_of_type_Int / 2 });
    paramString.setDecodeHandler(bgxc.A);
    paramString.startDownload();
    this.jdField_a_of_type_AndroidViewView.findViewById(2131378021).setBackgroundDrawable(paramString);
    if (this.jdField_a_of_type_Boolean) {}
    for (;;)
    {
      a(i);
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      this.jdField_a_of_type_AndroidViewView.findViewById(2131366173).setVisibility(0);
      this.jdField_a_of_type_AndroidViewView.findViewById(2131378021).setVisibility(8);
      this.jdField_a_of_type_AndroidViewView.findViewById(2131371706).setVisibility(8);
      return;
    }
    this.jdField_a_of_type_AndroidViewView.findViewById(2131366173).setVisibility(8);
    this.jdField_a_of_type_AndroidViewView.findViewById(2131378021).setVisibility(0);
    this.jdField_a_of_type_AndroidViewView.findViewById(2131371706).setVisibility(0);
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      case 2131378021: 
        if (this.e)
        {
          bdla.b(null, "dc00898", "", "", "qq_vip", "0X800A7D8", 0, 0, "", "", "", "");
        ...
        else
        {
          ...
          for (int i = 1;; i = 2)
          {
            bdla.b(null, "dc00898", "", str, "qq_vip", "0X800A7DD", i, 0, "", "", "", "");
            break;
          }
        }
        if (aztn.a(Long.parseLong(this.jdField_a_of_type_JavaLangString)))
        {
          this.jdField_a_of_type_Aztn.n();
          a(2);
        }
        else
        {
          this.jdField_a_of_type_Aztn.a(Long.parseLong(this.jdField_a_of_type_JavaLangString), this.jdField_a_of_type_ComTencentMobileqqMusicSongInfo);
        }
        break;
      }
    }
