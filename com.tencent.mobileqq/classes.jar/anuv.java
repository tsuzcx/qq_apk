  ...
  extends anii
{
  ...
  public anuv(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_JavaLangString = paramQQAppInterface.getApplication().getString(2131718053);
    this.jdField_b_of_type_JavaLangString = paramQQAppInterface.getApplication().getString(2131718054);
    this.c = paramQQAppInterface.getApplication().getString(2131718051);
    this.d = paramQQAppInterface.getApplication().getString(2131718055);
    this.f = paramQQAppInterface.getApplication().getString(2131718049);
    this.g = paramQQAppInterface.getApplication().getString(2131718047);
    this.h = paramQQAppInterface.getApplication().getString(2131718050);
    this.e = paramQQAppInterface.getApplication().getString(2131718052);
    this.i = paramQQAppInterface.getApplication().getString(2131718048);
  }
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, sso2sns_0x3_blocklist.RspBody paramRspBody)
  {
    ...
    ((awhl)this.app.getManager(16)).a(paramFromServiceMsg);
  ...
  private void a(boolean paramBoolean, int paramInt, long[] paramArrayOfLong)
  {
    ...
    if (j < m)
    {
      ...
      if (k != 1006) {
        if (paramBoolean)
        {
          ...
          if (k == 1024)
          {
            localbjft = (bjft)this.app.getManager(165);
            if (localbjft != null)
            {
              localObject1 = localObject2;
              if (!localbjft.a((String)localObject3))
              {
                localObject1 = localObject2;
                if (localbjft.f((String)localObject3)) {}
              }
            }
            else
            {
          ...
          if ((localObject1 == null) || (((List)localObject1).size() <= 0) || (!acwh.a((MessageRecord)((List)localObject1).get(((List)localObject1).size() - 1), (MessageRecord)localObject3, false))) {
            break label610;
          }
          if (QLog.isColorLevel()) {
    ...
    for (int k = 1;; k = 0)
    {
      ...
      do
      {
        ...
        localObject2 = bglf.f(this.app, String.valueOf(l1));
  ...
  private boolean a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    long l1 = bgva.a(arrayOfByte1, 0);
    long l2 = bgva.a(arrayOfByte1, 4);
  ...
  private boolean a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, sso2sns_0x3_blocklist.RspBody paramRspBody)
  {
    ...
    paramToServiceMsg = (awhl)this.app.getManager(16);
    int j = 0;
  ...
  private byte[] a(sso2sns_comm_info.Sso2SnsCommInfo paramSso2SnsCommInfo, sso2sns_0x3_blocklist.ReqBody paramReqBody)
  {
    ...
    bgva.a(arrayOfByte1, 0, l1);
    bgva.a(arrayOfByte2, 0, l2);
  ...
  private void d()
  {
    ...
    ((awhl)this.app.getManager(16)).a(localArrayList);
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    if (paramInt == 1006)
    {
      paramString = bglf.e(this.app, paramString);
