  ...
  implements AdapterView.OnItemClickListener
{
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    if (this.a.jdField_a_of_type_Bbjq.a()) {
      this.a.jdField_a_of_type_Bbjq.b();
    }
    paramInt = ((bbjv)paramAdapterView).a.c;
    int i = nol.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.d, this.a.jdField_a_of_type_ComTencentMobileqqDataAccountDetail);
    if (paramInt == 11)
    {
      this.a.E();
      paramInt = 7;
    ...
    {
      nol.a(null, paramView, "0X8007CA6", "0X8007CA6", 0, 0, paramAdapterView, paramInt + "", i + "", null);
      return;
      if (paramInt == 2)
      {
        xbi.b(this.a, this.a.a(), this.a.a(), this.a.b());
        paramInt = 1;
        break;
      }
      if (paramInt == 3)
      {
        xbi.a(this.a, this.a.a(), this.a.a(), this.a.b());
        paramInt = 2;
        break;
      }
      if ((paramInt == 9) || (paramInt == 10))
      {
        xbi.a(this.a, this.a.a(), this.a.a(), this.a.b(), paramInt);
        if (paramInt == 9)
        {
          paramInt = 3;
          break;
