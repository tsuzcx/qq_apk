...
class abxi
{
  ...
  public abxi(FromServiceMsg paramFromServiceMsg, SvcReqPushMsg paramSvcReqPushMsg, String paramString, ArrayList<MessageRecord> paramArrayList, ArrayList<MsgInfo> paramArrayList1, ArrayList<DelMsgInfo> paramArrayList2, long paramLong, ArrayList<String> paramArrayList3, MsgInfo paramMsgInfo, boolean paramBoolean)
  {
  ...
  private void a()
  {
    if ((!this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_OnlinePushPackMsgInfo.uAppShareID > 0L)) {
      this.d.add(bftp.a(this.jdField_a_of_type_OnlinePushPackMsgInfo.uAppShareID));
    }
  }
  ...
  private void a(int paramInt)
  {
    if ((42 != paramInt) && (83 != paramInt) && (127 != paramInt) && (QLog.isColorLevel())) {
      amwh.a("Q.msg.BaseMessageProcessor", this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_OnlinePushPackMsgInfo.shMsgSeq, String.valueOf(this.jdField_a_of_type_Long), String.valueOf(this.jdField_a_of_type_OnlinePushPackMsgInfo.lFromUin));
    }
  ...
  private void a(ArrayList<MessageRecord> paramArrayList, long paramLong1, MsgInfo paramMsgInfo, int paramInt1, int paramInt2, String paramString, byte[] paramArrayOfByte, int paramInt3, long paramLong2, long paramLong3, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramInt1 == 1006)
    {
      String str = ContactUtils.getPhoneNumByUin(this.jdField_a_of_type_Abxc.a, String.valueOf(paramLong2));
      localMessageRecord.init(String.valueOf(paramLong1), ContactUtils.getPhoneNumByUin(this.jdField_a_of_type_Abxc.a, String.valueOf(paramLong3)), str, paramString, paramMsgInfo.uRealMsgTime, paramInt2, paramInt1, paramMsgInfo.uMsgTime);
    }
    for (;;)
    {
      ...
      if (!amwh.a(this.jdField_a_of_type_Abxc.a, localMessageRecord, true)) {
        paramArrayList.add(localMessageRecord);
      }
      if (!QLog.isColorLevel()) {
        break;
      }
      QLog.d("Q.msg.BaseMessageProcessor", 2, "----------handleC2COnlinePushMsgResp after analysis friendUin: " + paramLong3 + " msgType: " + paramInt2 + " friendType: " + paramInt1 + " shMsgSeq: " + paramMsgInfo.shMsgSeq + " msgContent: " + bftf.a(paramString));
      return;
  ...
  {
    paramMsgInfo = abxc.a(this.jdField_a_of_type_Abxc, paramMsgInfo, paramLong);
    if ((paramMsgInfo != null) && (!amwh.a(this.jdField_a_of_type_Abxc.a, paramMsgInfo, true))) {
  ...
  private void a(ArrayList<MsgInfo> paramArrayList, ArrayList<DelMsgInfo> paramArrayList1, long paramLong1, MsgInfo paramMsgInfo, int paramInt, long paramLong2, long paramLong3, boolean paramBoolean, DelMsgInfo paramDelMsgInfo)
  {
    ...
    if (amwh.a(this.jdField_a_of_type_Abxc.a, paramInt, String.valueOf(paramLong3), String.valueOf(paramLong2), paramMsgInfo.uMsgTime, paramMsgInfo.shMsgSeq)) {}
    do
    {
      return;
      paramArrayList1.remove(paramDelMsgInfo);
      paramArrayList = new String(paramMsgInfo.vMsg) + paramMsgInfo.uMsgTime;
      if (!this.jdField_a_of_type_Abxc.a.getMsgHandler().a().a(paramArrayList))
      {
        ...
        abxc.a(this.jdField_a_of_type_Abxc, String.valueOf(paramLong3), paramLong1, paramArrayList, paramMsgInfo.vMsg, paramMsgInfo.uMsgTime, paramMsgInfo.shMsgSeq, paramBoolean);
  ...
  {
    paramSvcReqPushMsg = abxc.a(this.jdField_a_of_type_Abxc, paramInt, paramMsgInfo, paramSvcReqPushMsg);
  ...
  private boolean a(ArrayList<MessageRecord> paramArrayList, MsgInfo paramMsgInfo)
  {
    ...
    do
    {
      do
      {
        ...
        do
        {
          ...
          localObject = (bfdz)this.jdField_a_of_type_Abxc.a.getManager(81);
          ...
          paramMsgInfo = ((bfdz)localObject).a(this.jdField_a_of_type_Abxc.a, arrayOfByte, paramMsgInfo.shMsgSeq, paramMsgInfo.uRealMsgTime, false, false, null);
          bool1 = bool2;
        ...
        if ((i == 12) || (i == 14))
        {
          ((bfbz)this.jdField_a_of_type_Abxc.a.getManager(48)).a((byte[])localObject, paramMsgInfo.shMsgSeq);
          return false;
        }
        if (i == 15)
        {
          abxc.a(this.jdField_a_of_type_Abxc, (byte[])localObject, paramMsgInfo.shMsgSeq);
          return true;
        }
        if (i == 6)
        {
          abxc.a(this.jdField_a_of_type_Abxc, (byte[])localObject);
          return false;
        }
        if (i == 11) {
          break;
    ...
    abxc.a(this.jdField_a_of_type_Abxc, paramArrayList, i);
    return false;
  }
  ...
  public abxi a()
  {
    ...
    try
    {
      ...
      for (Object localObject1 = Long.valueOf(this.jdField_a_of_type_Abxc.a.getAccount());; localObject1 = Long.valueOf(this.jdField_a_of_type_ComTencentQphoneBaseRemoteFromServiceMsg.getUin()))
      {
        l3 = ((Long)localObject1).longValue();
        localObject1 = new DelMsgInfo();
        ((amsw)this.jdField_a_of_type_Abxc.a.getManager(51)).a(this.jdField_a_of_type_OnlinePushPackMsgInfo.lFromUin);
        ...
        a(i);
        if (!anls.a().containsKey(Integer.valueOf(i))) {
          break;
        }
    ...
    if (8 == i)
    {
      localObject3 = new abxd(this.jdField_a_of_type_Abxc, this.jdField_a_of_type_OnlinePushPackMsgInfo, null).a();
      i = ((abxd)localObject3).a();
      j = ((abxd)localObject3).b();
      localObject2 = ((abxd)localObject3).a();
      l1 = ((abxd)localObject3).a();
      bool = false;
      k = -1;
      localObject3 = null;
    }
    for (;;)
    {
      ...
      if (132 == i)
      {
        localObject3 = new abxe(this.jdField_a_of_type_Abxc, this.jdField_a_of_type_OnlinePushPackMsgInfo, null).a();
        i = ((abxe)localObject3).a();
        j = ((abxe)localObject3).b();
        localObject2 = ((abxe)localObject3).a();
        l1 = ((abxe)localObject3).a();
        bool = false;
        k = -1;
        localObject3 = null;
      }
      ...
      {
        abxf localabxf = new abxf(this.jdField_a_of_type_Abxc, this.jdField_a_of_type_OnlinePushPackMsgInfo, l1, l2).a();
        i = localabxf.a();
        j = localabxf.b();
        localObject2 = localabxf.a();
        localObject3 = localabxf.a();
        bool = localabxf.a();
        k = -1;
      }
      else if (SystemMsg.isSystemMessage(i))
      {
        localObject2 = new abxg(this.jdField_a_of_type_Abxc, this.jdField_a_of_type_Long, this.jdField_a_of_type_OnlinePushPackMsgInfo, i).a();
        j = ((abxg)localObject2).a();
        l2 = ((abxg)localObject2).a();
        bool = false;
        i = 0;
        localObject2 = null;
        localObject3 = null;
      ...
      {
        localObject2 = new abxh(this.jdField_a_of_type_Abxc, this.jdField_a_of_type_OnlinePushPackMsgInfo, i, -1000, -1, l1, l2).a();
        j = ((abxh)localObject2).a();
        k = ((abxh)localObject2).b();
        l2 = ((abxh)localObject2).a();
        bool = false;
        i = 0;
        localObject2 = null;
        localObject3 = null;
