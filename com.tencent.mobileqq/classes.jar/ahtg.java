...
public class ahtg
{
  ...
  public ahtg(int paramInt, long paramLong1, long paramLong2)
  {
  ...
  public int a(float paramFloat)
  {
    ...
    if (i >= 6)
    {
      ahsv localahsv1 = (ahsv)this.jdField_a_of_type_JavaUtilList.get(0);
      ahsv localahsv2 = (ahsv)this.jdField_a_of_type_JavaUtilList.get(i - 1);
      float f = (float)(localahsv2.b() - localahsv1.b()) * 1000.0F / (i - 1);
      paramFloat = (float)(Math.abs(localahsv2.a()) - Math.abs(localahsv1.a())) / ((i - 1) * paramFloat);
      f = 1.1F * f;
      if (f < paramFloat) {
        return 1;
      }
