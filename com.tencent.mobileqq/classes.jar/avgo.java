  ...
  implements PluginManagerUpdater
{
  ...
  avgn jdField_a_of_type_Avgn;
  private avgr jdField_a_of_type_Avgr;
  ...
  public avgo(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    this.e = paramString3;
    ...
    this.jdField_a_of_type_Avgn = new avgn(paramContext, paramString1, paramString3);
  ...
  public File a()
  {
    ...
    avjg localavjg = new avjg();
    localavjg.a(BaseApplicationImpl.getContext());
    localavjg.a(this.jdField_a_of_type_JavaLangString, new avgq(this, localFile, arrayOfException, l, localCountDownLatch));
    localavjg.b(avji.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaIoFile.getAbsolutePath()));
  ...
  public void a(avgr paramavgr)
  {
    this.jdField_a_of_type_Avgr = paramavgr;
  }
  ...
  public Future<File> update()
  {
    ...
    this.jdField_a_of_type_JavaUtilConcurrentFuture = anvy.a(192).submit(new avgp(this));
    return this.jdField_a_of_type_JavaUtilConcurrentFuture;
  }
