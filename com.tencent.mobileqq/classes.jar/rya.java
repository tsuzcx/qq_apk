...
public class rya
{
  ...
  private rxz jdField_a_of_type_Rxz;
  private ryb jdField_a_of_type_Ryb;
  private boolean jdField_a_of_type_Boolean;
  private int[] jdField_a_of_type_ArrayOfInt;
  private URLDrawable[] jdField_a_of_type_ArrayOfComTencentImageURLDrawable;
  
  public rya(Activity paramActivity, int paramInt)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          jdField_a_of_type_Int = AIOUtils.dp2px(28.0F, paramActivity.getResources());
          this.jdField_a_of_type_AndroidViewViewGroup.getLocationInWindow(this.jdField_a_of_type_ArrayOfInt);
          this.jdField_a_of_type_JavaUtilRandom = new Random();
          paramActivity = a();
          if (paramActivity != null)
          {
            this.jdField_a_of_type_Rxz = ((rxz)paramActivity.getBusinessHandler(138));
            this.jdField_a_of_type_Ryb = new ryb(this);
            paramActivity.addObserver(this.jdField_a_of_type_Ryb);
          }
          this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoLikeAnimationInfo = bkwm.a();
          if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoLikeAnimationInfo == null) {
            break label236;
          }
          if ((this.jdField_a_of_type_Rxz == null) || (!bkwm.b(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoLikeAnimationInfo.jdField_a_of_type_Int))) {
            break;
          }
          this.jdField_a_of_type_Rxz.a(paramInt);
          bkwm.a(System.currentTimeMillis());
      ...
      return;
    } while (this.jdField_a_of_type_Rxz == null);
    this.jdField_a_of_type_Rxz.a(paramInt);
    bkwm.a(System.currentTimeMillis());
  }
  ...
  public void a()
  {
    ...
    if (localQQAppInterface != null) {
      localQQAppInterface.removeObserver(this.jdField_a_of_type_Ryb);
    }
  }
