...
public class bdpa
  extends bhoe
{
  public bdpa(PendantInfo paramPendantInfo, Looper paramLooper, Handler.Callback paramCallback)
  {
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if (PendantInfo.g == l)
      {
        ...
        {
          localObject = (Drawable)paramMessage.next();
          if ((localObject != null) && ((localObject instanceof aera))) {
            this.a.a((aera)localObject, l);
          }
        }
        break;
      }
      paramMessage = (Drawable)this.a.jdField_a_of_type_ComTencentMobileqqVasPendantInfo$AnimationLruCache.get(Long.valueOf(l));
      if ((paramMessage == null) || (!(paramMessage instanceof aera))) {
        break;
      }
      this.a.a((aera)paramMessage, l);
      return;
    }
  }
}
