...
{
  public uxh(WSFollowFragment paramWSFollowFragment) {}
  ...
  public void onScrolled(RecyclerView paramRecyclerView, int paramInt1, int paramInt2)
  {
    ...
    if (WSFollowFragment.a(this.a).a == null)
    {
      ...
      vmp.d("WSFollowContinuePlayLog", "mAdapter.mPlayingHolder is null. startPosition:" + paramInt1 + ", lastOrNextVideoHolder:" + paramRecyclerView);
      if (WSFollowFragment.a(this.a, paramRecyclerView))
      {
        if (!WSFollowFragment.a(this.a)) {
          break label149;
        }
        vmp.d("WSFollowContinuePlayLog", "[WSFollowFragment.java][onScrolled] mIsHandlingBackFromVertical true.");
      }
    }
    else
    {
      ...
      {
        paramRecyclerView = paramRecyclerView.a((vdq)localObject, bool1, false);
        break;
      }
    }
    label149:
    vmp.g("WSFollowContinuePlayLog", "[WSFollowFragment.java][onScrolled] playVideo title:" + paramRecyclerView.a.d + ", mPlayingHolder:" + paramRecyclerView);
    ...
    vmp.a("WS_VIDEO_PRE_PLAY", "[WSFollowFragment.java][onScrolled] setPrePlayingHolder prePlayHolder:" + paramRecyclerView);
