...
public class bily
  extends anxg
{
  public bily(JoinTroopPreVerificationFragment paramJoinTroopPreVerificationFragment) {}
  ...
  protected void e(boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    if (paramBoolean)
    {
      ...
      bfup.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, paramString2, 2);
      this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.finish();
      return;
    }
    this.a.a(anni.a(2131704672));
    this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.finish();
  }
}
