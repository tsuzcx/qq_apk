  ...
  implements Manager
{
  ...
  public bily(AppInterface paramAppInterface)
  {
  ...
  public static String a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    {
      paramQQAppInterface = ((bily)paramQQAppInterface.getManager(165)).a(String.valueOf(paramString));
    ...
    for (;;)
    {
      try
      {
        ...
        if (bool1)
        {
          ...
          localbily.a(localBmqqAccountType);
          if (!bool1) {
            continue;
          }
          QidianExternalInfo localQidianExternalInfo = localbily.a(paramString);
          paramString = localbily.a(paramString);
          if ((localQidianExternalInfo != null) && (paramString != null)) {
            continue;
          }
          if (bjne.a()) {
            ThreadManager.post(new QidianManager.10(localbily, paramQQAppInterface, localBmqqAccountType), 5, null, true);
          }
        }
        else
        {
        ...
        localbily.b(paramQQAppInterface.getApp().getBaseContext(), localBmqqAccountType);
        return;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    try
    {
      ...
      if (!nns.a(paramString1)) {
        return;
      }
      ((bily)paramQQAppInterface.getManager(165)).h.put(paramString1, paramString2);
      return;
    }
    catch (Exception paramQQAppInterface) {}
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Friends[] paramArrayOfFriends)
  {
    ...
    {
      localbily = (bily)paramQQAppInterface.getManager(165);
      if (bjne.a()) {
        ThreadManager.postImmediately(new QidianManager.9(localbily, paramQQAppInterface, paramArrayOfFriends), null, false);
      }
    }
    else
    {
    ...
    localbily.b(paramQQAppInterface, paramArrayOfFriends);
  }
  ...
  private void a(String paramString1, int paramInt1, int paramInt2, String paramString2)
  {
    if ((!TextUtils.isEmpty(paramString1)) && (paramString1.contains("isNeedReply=")) && (paramString1.contains("QidianKfUin=")))
    {
      ...
      if (bool2)
      {
        ...
        SosoInterface.startLocation(new bilz(this, 1, true, true, 0L, true, false, "QidianManager", paramString1, paramInt1, str3, paramInt2, str2, str1, paramString2));
      }
    }
    label364:
    while (!QLog.isColorLevel())
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    return ((((bily)paramQQAppInterface.getManager(165)).a(paramMessageRecord.frienduin)) || (paramMessageRecord.istroop == 1024)) && (!TextUtils.isEmpty(paramMessageRecord.getExtInfoFromExtStr("is_eman_sc_message")));
  }
  
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString)
  {
    return ((bily)paramQQAppInterface.getManager(165)).e(paramString);
  }
  
  private boolean a(String paramString, int paramInt)
  {
    Object localObject = (amsw)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(51);
    if (localObject != null)
    {
      localObject = ((amsw)localObject).b(paramString);
  ...
  private void b(QQAppInterface paramQQAppInterface, Friends[] paramArrayOfFriends)
  {
    ...
    //   36: pop2
    //   37: aload 10
    //   39: invokestatic 338	nns:a	(Ljava/lang/String;)Z
    //   42: ifne +4 -> 46
    //   45: return
    //   46: iload 5
    //   48: invokestatic 341	bily:b	(I)Z
    //   51: istore 6
    //   53: iload 5
    //   55: invokestatic 343	bily:a	(I)Z
    //   58: istore 7
    //   60: iload 5
    //   62: invokestatic 345	bily:c	(I)Z
    //   65: istore 8
    //   67: iload 6
    //   69: ifne +60 -> 129
    //   72: iload 7
    ...
    //   155: aload_0
    //   156: aload 10
    //   158: invokevirtual 592	bily:a	(Ljava/lang/String;)I
    //   161: aload 9
    //   163: invokevirtual 596	com/tencent/qidian/data/BmqqAccountType:getAccountType	()I
    //   166: if_icmpeq +119 -> 285
    //   169: aload_0
    //   170: getfield 50	bily:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   173: aload 10
    //   175: aload 9
    ...
    //   194: aload_0
    //   195: aload 10
    //   197: invokevirtual 126	bily:a	(Ljava/lang/String;)Lcom/tencent/qidian/data/QidianExternalInfo;
    //   200: astore 11
    //   202: aload_0
    //   203: aload 10
    //   205: invokevirtual 364	bily:a	(Ljava/lang/String;)Lcom/tencent/qidian/data/QidianProfileUiInfo;
    //   208: astore 10
    //   210: aload 11
    //   212: ifnull +8 -> 220
    //   215: aload 10
    ...
    //   228: aload 9
    //   230: invokevirtual 385	bily:b	(Landroid/content/Context;Lcom/tencent/qidian/data/BmqqAccountType;)Z
    //   233: pop
    //   234: goto +51 -> 285
    //   237: astore_1
    //   238: aload_1
  ...
  {
    return ((bily)paramQQAppInterface.getManager(165)).f(paramString);
  }
  ...
  public int a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      if (npt.b(paramQQAppInterface, paramString, 0)) {
        return 3;
      }
    } while (a(paramString));
  ...
  public String a(Context paramContext, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString)) {
      return String.format(paramContext.getString(2131697989), new Object[] { paramString });
    }
    return paramContext.getString(2131697988);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        localObject2 = bchh.a(paramString.getBytes(), 0);
    ...
    for (;;)
    {
      ...
      if (amwh.a(paramQQAppInterface, paramString, false)) {
        break;
      }
  ...
  {
    ((bing)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(85)).a(paramString1, paramInt1, paramBoolean, 0.0D, 0.0D, paramString2, paramInt2, paramString3, paramString4, paramString5);
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ((bing)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(85)).a(paramString1, paramString2, paramString3);
      return;
  ...
  {
    if ((!nns.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) || (nns.a(null, paramString))) {
      ((amov)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(2)).a(paramString, paramBoolean);
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    while (localIterator.hasNext()) {
      ((bima)localIterator.next()).a(paramBoolean);
    }
  }
      ...
      try
      {
        ...
        if (nns.a(paramContext))
        {
          ...
          default: 
            return false;
          case 1: 
            ((bing)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(85)).b(l);
            return true;
          }
          ((bing)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(85)).d(l);
          return true;
        }
      }
  ...
  public boolean a(String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      Long.parseLong(paramString);
      if (!nns.a(paramString)) {}
      while ((nns.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) && (!nns.a(null, paramString))) {
        return false;
      }
  ...
  {
    ((amov)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(2)).d(paramString);
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (nns.a(paramContext))
        {
          ...
          case 0: 
          case 2: 
            ((nnp)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(37)).a(paramContext);
            return true;
          case 1: 
            ((bing)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(85)).a(l);
            return true;
          }
          ((bing)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(85)).c(l);
          return true;
        }
      }
      catch (Exception paramContext) {}
