...
public class acgr
  extends akil
{
  public acgr(TroopDisbandActivity paramTroopDisbandActivity) {}
  ...
  protected void a(int paramInt1, int paramInt2)
  {
    if (paramInt1 == 9)
    {
      ...
      if (paramInt2 == 8)
      {
        ...
        localObject = bbdj.a(this.a, 230);
        ((bbgu)localObject).setTitle(this.a.getString(2131696430));
        ((bbgu)localObject).setMessage(this.a.getString(2131696431));
        ((bbgu)localObject).setNegativeButton(this.a.getString(2131696462), new acgs(this, (bbgu)localObject));
        ((bbgu)localObject).setPositiveButton(this.a.getString(2131719551), new acgt(this, (bbgu)localObject));
    ...
    this.a.jdField_a_of_type_Bcqi.b(2, 2131692212, 1500);
  }
  
  protected void a(int paramInt1, int paramInt2, String paramString)
  {
    if (!bbbr.a(paramString, this.a.jdField_a_of_type_JavaLangString)) {}
    while (paramInt1 != 9) {
      return;
    }
    paramString = this.a;
  ...
  {
    if (!bbbr.a(String.valueOf(paramLong1), this.a.jdField_a_of_type_JavaLangString)) {}
    Object localObject;
    label132:
    label190:
    label320:
    ...
    do
    {
      do
      {
        ...
        case 4: 
          if (paramBoolean)
          {
            ...
            } while ((this.a.jdField_a_of_type_JavaUtilArrayList.contains(localObject)) || (localObject == null) || ("".equals(((String)localObject).trim())) || (bbbr.a(this.a.d, localObject)));
          ...
          paramList = (akhp)this.a.app.a(20);
      ...
      paramList.putExtra("leftViewText", this.a.getString(2131717280));
      ...
      if (paramBoolean)
      {
        ...
        this.a.jdField_a_of_type_Bcqi.b(2, 2131720450, 1500);
        return;
      }
      paramList = this.a;
      paramList.jdField_b_of_type_Int &= 0xFFFFFFFD;
      ...
      this.a.jdField_a_of_type_Bcqi.b(2, 2131720445, 1500);
      return;
    } while (!paramBoolean);
    label418:
    if (paramList == null)
    ...
    for (paramString = null;; paramString = paramString.b(this.a.jdField_a_of_type_JavaLangString))
    {
      ...
      this.a.jdField_a_of_type_Acgv.b(paramList);
      return;
      paramInt1 = paramList.size();
      break;
    }
  ...
  protected void a(boolean paramBoolean, String paramString)
  {
    ...
    if ((paramBoolean) && (bbbr.a(paramString, this.a.jdField_a_of_type_JavaLangString)))
    {
      paramString = (TroopManager)this.a.app.getManager(52);
  ...
  protected void b(boolean paramBoolean, ArrayList<TroopInfo> paramArrayList)
  {
    ...
    label56:
    while (!bbbr.a(localTroopInfo.troopuin, this.a.jdField_a_of_type_JavaLangString))
    {
      i += 1;
      break label21;
      break;
