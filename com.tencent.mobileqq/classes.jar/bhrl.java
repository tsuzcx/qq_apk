...
public class bhrl
  implements biaf
{
  public bhrl(ChallengeBragBase paramChallengeBragBase) {}
  ...
  protected void a(Intent paramIntent)
  {
    ...
    if (i != 0)
    {
      ...
      bhzm.e("qqBaseActivity", "onSendChallengeComplete error:{KEY_ERROR_CODE:" + i + "; KEY_ERROR_MSG:" + paramIntent.getStringExtra("key_error_msg") + "}");
    }
  ...
  {
    this.a.d();
    bhzm.c("qqBaseActivity", "SendChallenge exception." + paramException.getMessage(), paramException);
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        if (localObject != null)
        {
          bias.a("400", (String)localObject, this.a.c);
    ...
    {
      bhzm.c("qqBaseActivity", "SendChallenge exception." + paramJSONObject.getMessage(), paramJSONObject);
