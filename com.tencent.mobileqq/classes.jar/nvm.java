  ...
  implements View.OnClickListener
{
  ...
  public nvm(BaseActivity paramBaseActivity, View.OnClickListener paramOnClickListener, ViewGroup paramViewGroup)
  {
  ...
  private void b()
  {
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131369909));
    ...
    for (int i = (int)(4.0F * this.jdField_a_of_type_Float);; i = (int)(25.0F * this.jdField_a_of_type_Float))
    {
      ...
      this.d = ((ImageView)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131369908));
      this.d.setOnClickListener(this);
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131369073));
      this.jdField_b_of_type_AndroidWidgetTextView.setText("");
      this.e = ((ImageView)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131369056));
      this.e.setImageResource(2130843670);
      this.e.setContentDescription(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131696848));
      this.e.setVisibility(0);
      this.e.setOnClickListener(this);
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131368254));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131368225));
      this.c = ((ImageView)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131364336));
      ...
      this.d.setImageResource(2130850106);
      this.e.setImageResource(2130842430);
      return;
  ...
  public void a(AccountDetail paramAccountDetail)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setBackgroundDrawable(aoot.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, 1, this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.uin));
      ...
      if ((!TextUtils.isEmpty(str)) && (str.contains(":")))
      {
        ...
        if (str.length() > i + 1)
        {
          ...
          this.jdField_a_of_type_AndroidViewViewGroup.addView(new nvn(paramAccountDetail, null, (String)localObject, str).a());
        }
      }
      if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.summary)) {
        this.jdField_a_of_type_AndroidViewViewGroup.addView(new nvn(paramAccountDetail, null, "信息简介", this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.summary).a());
      }
      if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.certifiedEnterprise)) {
        this.jdField_a_of_type_AndroidViewViewGroup.addView(new nvn(paramAccountDetail, null, "认证来源", this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.certifiedEnterprise).a());
      }
      localObject = tzq.a(this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail);
    } while (TextUtils.isEmpty((CharSequence)localObject));
    this.jdField_a_of_type_AndroidViewViewGroup.addView(new nvn(paramAccountDetail, null, "联系电话", (String)localObject).a());
  }
  
  public void onClick(View paramView)
  {
    if (paramView.getId() == 2131369908) {
