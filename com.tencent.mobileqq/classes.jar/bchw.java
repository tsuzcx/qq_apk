  ...
  implements bcgn
{
  ...
  public static bchw a()
  {
    if (jdField_a_of_type_Bchw == null) {
      jdField_a_of_type_Bchw = new bchw();
    }
    return jdField_a_of_type_Bchw;
  }
  ...
  protected String a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, String paramString3, int paramInt4, int paramInt5)
  {
    ...
    catch (JSONException paramString1)
    {
      for (;;)
      {
        bcds.c("WebViewDownloadListener", "getCallBackJsonObject >>> ", paramString1);
      }
    }
  }
  ...
  {
    bcey localbcey = bcey.a();
    for (;;)
    {
      int i;
      try
      {
        int j = localbcey.a().size();
        i = 0;
        if (i < j)
        {
          Object localObject = (bcex)localbcey.a().get(i);
          ...
          if (localWebView != null) {
            if (TextUtils.isEmpty(((bcex)localObject).getJsCallbackMethod()))
            {
              ...
              bcds.a("WebViewDownloadListener", " commonJsCallBack >>> " + (String)localObject);
      ...
      {
        bcds.c("WebViewDownloadListener", "doJsCallback >>> ", paramString);
      }
      i += 1;
    }
  }
