  ...
  extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
  ...
  private ahwu jdField_a_of_type_Ahwu = new ahwr(this);
  ...
  public ahwo(QQAppInterface paramQQAppInterface, EmoticonGroupStoreFragment paramEmoticonGroupStoreFragment, int paramInt, View paramView, ViewPager paramViewPager, Button paramButton)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131363603));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368099));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379136));
    ...
    this.jdField_a_of_type_AndroidSupportV4ViewViewPager.setOnPageChangeListener(new ahwp(this));
    this.jdField_b_of_type_AndroidWidgetButton = paramButton;
    this.jdField_a_of_type_Apob = ((apob)paramQQAppInterface.getManager(259));
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    while (this.jdField_a_of_type_ComTencentMobileqqActivityEmogroupstoreEmoticonGroupStoreFragment.a.size() > 0)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetButton.setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130844010));
      this.jdField_b_of_type_AndroidWidgetButton.setEnabled(true);
      return;
      label234:
      paramInt1 = this.jdField_a_of_type_ComTencentMobileqqActivityEmogroupstoreEmoticonGroupStoreFragment.a.size();
      if (this.jdField_a_of_type_Apob.jdField_b_of_type_Int <= paramInt1)
      {
        if (300 == apol.jdField_a_of_type_Int)
        {
          QQToast.a(this.jdField_a_of_type_AndroidContentContext, 2131689690, 0).b(2131298914);
        }
        else if (144 == apol.jdField_a_of_type_Int)
        {
          localObject = new ahwq(this);
          localObject = bdgm.a(this.jdField_a_of_type_AndroidContentContext, 0, alud.a(2131708553), this.jdField_a_of_type_AndroidContentContext.getString(2131689689), alud.a(2131708554), alud.a(2131708556), (DialogInterface.OnClickListener)localObject, (DialogInterface.OnClickListener)localObject);
          if (localObject != null) {
    ...
    this.jdField_b_of_type_AndroidWidgetButton.setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130844011));
  ...
  private void a(EmoticonFromGroupEntity paramEmoticonFromGroupEntity)
  {
    ...
    if (1 == paramEmoticonFromGroupEntity.fromType)
    {
      ...
      paramEmoticonFromGroupEntity = bdgc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramEmoticonFromGroupEntity.troopUin, true);
    }
    for (;;)
    {
      ...
      if (3000 == paramEmoticonFromGroupEntity.fromType)
      {
        ...
        paramEmoticonFromGroupEntity = bdgc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, paramEmoticonFromGroupEntity.troopUin);
      }
      else
      {
  ...
  private void a(EmoticonFromGroupEntity paramEmoticonFromGroupEntity, int paramInt1, int paramInt2)
  {
    ...
    if (-1 != paramEmoticonFromGroupEntity.status)
    {
      ...
      {
        this.jdField_a_of_type_AndroidWidgetButton.setText(alud.a(2131708550));
        this.jdField_a_of_type_AndroidWidgetButton.setTextColor(Color.parseColor("#FFBBBBBB"));
        this.jdField_a_of_type_AndroidWidgetButton.setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130844011));
    ...
    for (;;)
    {
      j += 1;
      break label138;
      this.jdField_a_of_type_AndroidWidgetButton.setText(alud.a(2131708551));
      this.jdField_a_of_type_AndroidWidgetButton.setTextColor(Color.parseColor("#FFFFFFFF"));
      this.jdField_a_of_type_AndroidWidgetButton.setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130844010));
  ...
  private void b(EmoticonFromGroupEntity paramEmoticonFromGroupEntity)
  {
    if (paramEmoticonFromGroupEntity.status == 0)
    {
      this.jdField_a_of_type_AndroidWidgetButton.setText(alud.a(2131708557));
      this.jdField_a_of_type_AndroidWidgetButton.setTextColor(Color.parseColor("#FFBBBBBB"));
      this.jdField_a_of_type_AndroidWidgetButton.setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130844011));
      this.jdField_a_of_type_AndroidWidgetButton.setEnabled(false);
      return;
    }
    this.jdField_a_of_type_AndroidWidgetButton.setText(alud.a(2131708555));
    this.jdField_a_of_type_AndroidWidgetButton.setTextColor(Color.parseColor("#FFFFFFFF"));
    this.jdField_a_of_type_AndroidWidgetButton.setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130844010));
    this.jdField_a_of_type_AndroidWidgetButton.setEnabled(true);
  }
  ...
  public void a(Map<String, List<EmoticonFromGroupEntity>> paramMap, List<EmoticonFromGroupEntity> paramList)
  {
    ...
    while (paramMap.hasNext())
    {
      ...
      String str = (String)((Map.Entry)localObject).getKey();
      localObject = (List)((Map.Entry)localObject).getValue();
      this.jdField_b_of_type_JavaUtilMap.put(str, this.jdField_a_of_type_Apod.a(str, ((List)localObject).size(), "  "));
    }
    notifyDataSetChanged();
  ...
  {
    if ((paramViewHolder instanceof ahwv))
    {
      ahwv localahwv = (ahwv)paramViewHolder;
      List localList = (List)this.e.get(Integer.valueOf(paramInt));
      int j = localList.size();
      int i = 0;
      if (i < 3)
      {
        RelativeLayout localRelativeLayout = (RelativeLayout)localahwv.jdField_a_of_type_ArrayOfAndroidWidgetImageView[i].getParent();
        if (i < j)
        {
          localRelativeLayout.setVisibility(0);
          localahwv.jdField_a_of_type_ArrayOfAndroidWidgetImageView[i].setImageDrawable(this.jdField_a_of_type_Apod.a((EmoticonFromGroupEntity)localList.get(i), 65537, this.jdField_a_of_type_Int, null));
          this.jdField_b_of_type_Int = ((EmoticonFromGroupEntity)((List)this.e.get(Integer.valueOf(paramInt))).get(i)).status;
          if (this.jdField_b_of_type_Int == 0)
          {
            ((ahwv)paramViewHolder).jdField_a_of_type_ArrayOfComTencentMobileqqWidgetNumberCheckBox[i].setVisibility(4);
            ((ahwv)paramViewHolder).b[i].setVisibility(0);
        ...
        for (;;)
        {
          ...
          {
            ((ahwv)paramViewHolder).b[i].setVisibility(4);
            if (this.jdField_b_of_type_Int > 0)
            {
              ((ahwv)paramViewHolder).jdField_a_of_type_ArrayOfComTencentMobileqqWidgetNumberCheckBox[i].setVisibility(0);
              ((ahwv)paramViewHolder).jdField_a_of_type_ArrayOfComTencentMobileqqWidgetNumberCheckBox[i].setCheckedNumber(this.jdField_b_of_type_Int);
            }
            else
            {
              ((ahwv)paramViewHolder).jdField_a_of_type_ArrayOfComTencentMobileqqWidgetNumberCheckBox[i].setChecked(false);
              ((ahwv)paramViewHolder).jdField_a_of_type_ArrayOfComTencentMobileqqWidgetNumberCheckBox[i].setVisibility(0);
            }
          }
          else
    ...
    {
      return;
      if ((paramViewHolder instanceof ahws))
      {
        ((ahws)paramViewHolder).jdField_a_of_type_AndroidWidgetTextView.setText((CharSequence)this.jdField_b_of_type_JavaUtilMap.get(this.d.get(Integer.valueOf(paramInt))));
        return;
      }
    } while (!(paramViewHolder instanceof ahwt));
    ((ahwt)paramViewHolder).jdField_a_of_type_AndroidWidgetTextView.setText("仅保留最新的300个聊天表情，\n更多表情请在消息记录中查找哦～");
  }
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    default: 
      return null;
    case 0: 
      return new ahws(this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561707, paramViewGroup, false));
    case 1: 
      paramViewGroup = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561708, paramViewGroup, false);
      ...
      paramViewGroup = new ahwv(paramViewGroup);
      paramViewGroup.a(this.jdField_a_of_type_Ahwu);
      return paramViewGroup;
    }
    return new ahwt(this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561711, paramViewGroup, false));
  }
}
