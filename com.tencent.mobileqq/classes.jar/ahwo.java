...
public class ahwo
  extends Handler
{
  public ahwo(ChatHistoryTroopFileFragment paramChatHistoryTroopFileFragment) {}
    ...
    for (;;)
    {
      ...
      while (i <= ChatHistoryTroopFileFragment.a(this.a).getLastVisiblePosition())
      {
        ...
        if (paramMessage != null)
        {
          ...
          if ((paramMessage != null) && ((paramMessage instanceof bbrf))) {
            ((bbrf)paramMessage).a(this.a.a, ChatHistoryTroopFileFragment.a(this.a));
          }
        }
        i += 1;
      }
