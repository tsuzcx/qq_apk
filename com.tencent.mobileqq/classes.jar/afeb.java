  ...
  implements affa, affn
{
  ...
  public afeb(afev paramafev, BaseChatPie paramBaseChatPie)
  {
  ...
  public void a(int paramInt)
  {
    ...
    for (paramInt = i;; paramInt = 0)
    {
      ...
      alar localalar = albi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (localalar != null) {
        localalar.a(this.jdField_a_of_type_Long, this.b, albi.b(), albi.a());
      }
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Akpy == null) {
        this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Akpy = new akpy();
      }
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Akpy.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie);
      return;
    }
  }
        ...
        for (;;)
        {
          ...
          if (paramInt1 == 9999)
          {
            if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
            {
              ...
              ((bdug)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(71)).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 128, "apolloPanel");
            }
          }
          else if (paramInt1 == 14003)
          {
            if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
            {
              ...
              ((aknx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a().a(null);
            }
          }
    ...
    for (int i = Integer.parseInt((String)((Map)localObject1).get("textType"));; i = 0)
    {
      ...
      for (int j = Integer.parseInt(paramObject);; j = 0)
      {
        ...
        for (float f = Float.parseFloat(paramObject);; f = 0.0F)
        {
          ...
          {
            paramObject = (aliw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
            Object localObject3 = (aknx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153);
            ...
            default: 
              ...
              this.jdField_a_of_type_Bdjz = bdgm.a(this.jdField_a_of_type_AndroidAppActivity, 0, paramObject, (CharSequence)localObject1, this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131695511), (String)localObject3, (DialogInterface.OnClickListener)localObject2, new afed(this));
            ...
            for (;;)
            {
              ...
              localObject2 = new afec(this, (String)localObject1, m);
