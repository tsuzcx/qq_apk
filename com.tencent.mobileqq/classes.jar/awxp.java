...
public class awxp
  extends awkv
{
  public awxp(NearbyPeopleProfileActivity paramNearbyPeopleProfileActivity) {}
  ...
  protected void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, String paramString)
  {
    ...
    bfyg.a(this.a, str, paramString, paramInt3 - paramInt1).show();
  }
  ...
  public void a(boolean paramBoolean1, long paramLong, boolean paramBoolean2, boolean paramBoolean3, byte[] paramArrayOfByte, String paramString)
  {
    ...
    aquj.c("profileCard", new Object[] { ((StringBuilder)localObject).toString() });
    localObject = this.a;
    ...
    if (paramBoolean1) {
      if (paramBoolean2)
      {
        aquj.c(NearbyPeopleProfileActivity.class.getSimpleName(), new Object[] { "onGetShowLoveLimit , can chat, someting is wrong" });
    ...
    for (;;)
    {
      ...
      if (paramBoolean3)
      {
        if (NearbyPeopleProfileActivity.a(this.a) != null)
        {
          ...
          bfrj.a(this.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne);
          QLog.d("Q.nearby_people_card.", 1, "ShowLoveEditorActivity 已在725下架");
        }
      }
      else
      {
        aquj.c(NearbyPeopleProfileActivity.class.getSimpleName(), new Object[] { "cant show love, wording is " + paramString });
        paramArrayOfByte = paramString;
        if (TextUtils.isEmpty(paramString)) {
          paramArrayOfByte = ((Activity)localObject).getResources().getString(2131698476);
        }
        aquj.a(this.a, paramArrayOfByte);
        continue;
        aquj.a((Activity)localObject, ((Activity)localObject).getString(2131698475));
      }
    }
  }
  ...
  protected void a(boolean paramBoolean1, NearbyPeopleCard paramNearbyPeopleCard, boolean paramBoolean2)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        this.a.b();
        localObject = bjmr.a;
        if ((localObject != null) && (((bjmr)localObject).a())) {
          ((bjmr)localObject).b(6);
        }
        ...
        ((awiz)this.a.app.getManager(207)).a(paramNearbyPeopleCard.uin, false);
  ...
  public void a(boolean paramBoolean1, NearbyPeopleCard paramNearbyPeopleCard, boolean paramBoolean2, String paramString)
  {
    ...
    if (paramBoolean1)
    {
      ...
      if (this.a.t)
      {
        this.a.jdField_a_of_type_Awkr.a(true);
        this.a.t = false;
      }
  ...
  protected void a(boolean paramBoolean, String paramString)
  {
    if (paramBoolean)
    {
      paramString = (awiz)this.a.app.getManager(207);
      if (NearbyPeopleProfileActivity.a(this.a) != null) {
    ...
    return;
    label157:
    this.a.jdField_a_of_type_ComTencentImageURLDrawable.setURLDrawableListener(new awxq(this, paramString));
  ...
  {
    if ((NearbyPeopleProfileActivity.a(this.a) == null) || (TextUtils.isEmpty(NearbyPeopleProfileActivity.a(this.a).uin)) || (TextUtils.isEmpty(paramString2)) || (TextUtils.isEmpty(paramString1)) || (bftf.a(paramString2, paramString1))) {}
    do
    {
      do
      {
        return;
      } while ((!bftf.a(paramString2, NearbyPeopleProfileActivity.a(this.a).uin)) || (!bftf.a(paramString1, this.a.app.getCurrentAccountUin())));
      if (!paramBoolean)
      {
        this.a.b(this.a.getResources().getString(2131693099));
  ...
  public void a(boolean paramBoolean, String paramString1, List<awoe> paramList, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    {
      this.a.b();
      this.a.a(2, amtj.a(2131706362));
      return;
    }
    this.a.b();
    this.a.a(1, amtj.a(2131706353) + paramString2);
  }
  ...
  protected void a(boolean paramBoolean, UpdatePhotoList.HeadInfo paramHeadInfo)
  {
    ...
    else
    {
      ...
      bfre.a(this.a.jdField_a_of_type_Awkr, this.a.app, this.a.jdField_a_of_type_Long, null, this.a.jdField_d_of_type_Int, paramHeadInfo, l, true, this.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Long, NearbyPeopleProfileActivity.a(this.a.j), NearbyPeopleProfileActivity.a(this.a), NearbyPeopleProfileActivity.a(this.a));
    }
    label190:
    ...
    bfre.a(this.a.jdField_a_of_type_Awkr, this.a.app, 0L, this.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_JavaLangString, this.a.jdField_d_of_type_Int, paramHeadInfo, l, true, this.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Long, NearbyPeopleProfileActivity.a(this.a.j), NearbyPeopleProfileActivity.a(this.a), NearbyPeopleProfileActivity.a(this.a));
  }
}
