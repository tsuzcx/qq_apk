  ...
  extends awum
{
  ...
  private void a(Context paramContext, Resources paramResources, RelativeLayout paramRelativeLayout, View paramView, LinearLayout paramLinearLayout, TextView paramTextView1, TextView paramTextView2)
  {
    ...
    paramResources.setId(2131310511);
    paramView = new ImageView(paramContext);
    paramView.setImageResource(2130849114);
    ...
    paramTextView2.setId(2131310512);
    ...
    paramResources.addRule(3, 2131310511);
    ...
    paramResources.setId(2131310513);
    paramResources.setImageResource(2130849116);
    paramView = new RelativeLayout.LayoutParams(-2, -2);
    paramView.addRule(14);
    paramView.addRule(3, 2131310512);
    paramRelativeLayout.addView(paramResources, paramView);
    paramResources = new RelativeLayout(paramContext);
    paramView = new ImageView(paramContext);
    paramView.setId(2131310515);
    paramView.setImageResource(2130849117);
    ...
    paramContext.setImageResource(2130849113);
    paramView = new RelativeLayout.LayoutParams(-2, -2);
    paramView.addRule(15);
    paramView.addRule(0, 2131310515);
    ...
    paramContext.addRule(1, 2131310515);
    ...
    paramContext.addRule(3, 2131310513);
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if ((paramView != null) && ((paramView instanceof LinearLayout)))
    {
      ...
      localRelativeLayout.setLayoutParams(new LinearLayout.LayoutParams(-1, aciy.a(290.0F, localResources)));
      ...
      if ((!"type".equals(localObject5)) || (!(paramView instanceof awzn))) {
        break label264;
      }
      j = ((awzn)paramView).i;
      i = j;
    ...
    for (;;)
    {
      ...
      else
      {
        if (("picture".equals(localObject5)) && (localObject4 == null))
        {
          ...
          {
            float f = localResources.getDimensionPixelSize(2131165279);
        ...
        {
          if (("head".equals(localObject5)) && ((paramView instanceof awwh)) && (localObject2 == null))
          {
            ((awwh)paramView).i = i;
            ...
            continue;
            label531:
            paramView = new awyt(paramContext.getString(2131653800)).a(paramContext, null, null);
            paramBundle = new LinearLayout.LayoutParams(-1, -2);
            j = aciy.a(15.0F, localResources);
            paramView.setLayoutParams(paramBundle);
            paramView.setPadding(j, j, j, j);
            paramBundle = (TextView)paramView.findViewById(2131310783);
            ...
            paramBundle.setImageResource(2130849107);
            ...
            ((RelativeLayout.LayoutParams)localObject4).rightMargin = aciy.a(7.0F, localResources);
            paramView.addView(paramBundle, (ViewGroup.LayoutParams)localObject4);
            paramContext = new ImageView(paramContext);
            paramContext.setImageResource(2130849108);
            paramBundle = new RelativeLayout.LayoutParams(-2, -2);
            paramBundle.addRule(1, localObject1.getId());
            paramBundle.addRule(15);
            paramBundle.leftMargin = aciy.a(7.0F, localResources);
            paramView.addView(paramContext, paramBundle);
            paramContext = new RelativeLayout.LayoutParams(-1, -2);
            paramContext.topMargin = aciy.a(5.0F, localResources);
            paramContext.addRule(3, 2131310514);
            paramView.setLayoutParams(paramContext);
            paramView.setId(2131310512);
            localRelativeLayout.addView(paramView);
            paramContext = new RelativeLayout.LayoutParams(-2, -2);
            paramContext.addRule(14);
            paramContext.addRule(3, 2131310512);
            paramContext.topMargin = aciy.a(10.0F, localResources);
            if (localObject2 != null)
            {
              localObject2.setId(2131310511);
