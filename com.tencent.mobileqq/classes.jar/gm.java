...
public class gm
{
  ...
  private static WifiConfiguration a(go paramgo)
  {
    ...
    localWifiConfiguration.SSID = a(paramgo.b(), new int[0]);
    localWifiConfiguration.hiddenSSID = paramgo.a();
  ...
  private static boolean a(WifiManager paramWifiManager, go paramgo)
  {
    WifiConfiguration localWifiConfiguration = a(paramgo);
    localWifiConfiguration.wepKeys[0] = a(paramgo.d(), new int[] { 10, 26, 58 });
  ...
  private static boolean b(WifiManager paramWifiManager, go paramgo)
  {
    WifiConfiguration localWifiConfiguration = a(paramgo);
    localWifiConfiguration.preSharedKey = a(paramgo.d(), new int[] { 64 });
  ...
  private static boolean c(WifiManager paramWifiManager, go paramgo)
  {
    paramgo = a(paramgo);
    paramgo.allowedKeyManagement.set(0);
    return a(paramWifiManager, paramgo);
  }
  
  public boolean a(go paramgo)
  {
    int i;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        i += 1;
        continue;
        String str = paramgo.c();
        if ((TextUtils.isEmpty(str)) || (str.equals("nopass"))) {
          return c(this.jdField_a_of_type_AndroidNetWifiWifiManager, paramgo);
        }
        if (TextUtils.isEmpty(paramgo.d())) {
          break label84;
        }
        if ("WEP".equals(str)) {
          return a(this.jdField_a_of_type_AndroidNetWifiWifiManager, paramgo);
        }
        if (!"WPA".equals(str)) {
          break label84;
        }
        return b(this.jdField_a_of_type_AndroidNetWifiWifiManager, paramgo);
      }
