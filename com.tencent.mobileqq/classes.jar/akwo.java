  ...
  implements akrb, akur, akvd
{
  ...
  private void a()
  {
    ...
    float f1 = this.jdField_e_of_type_Int / akxg.jdField_a_of_type_Int;
    float f2 = this.jdField_d_of_type_Int / akxg.jdField_b_of_type_Int;
    ...
    if (QLog.isColorLevel()) {
      QLog.d("QRSession", 2, String.format("initScanRect [mScanRect,qRRecogRect,qRRecogRectExt,rotateQRRecogRectExt]=[%s, %s, %s, %s] [w,h]=[%d,%d]", new Object[] { this.jdField_a_of_type_AndroidGraphicsRect.toShortString(), localRect1.toShortString(), localRect2.toShortString(), localRect4.toShortString(), Integer.valueOf(akxg.jdField_a_of_type_Int), Integer.valueOf(akxg.jdField_b_of_type_Int) }));
    }
  ...
  private void a(Rect paramRect1, Rect paramRect2, boolean paramBoolean)
  {
    ...
    if ((localRect.width() > 0) && (localRect.height() > 0))
    {
      ...
      float f1 = akxg.jdField_a_of_type_Int / this.jdField_e_of_type_Int;
      float f2 = akxg.jdField_b_of_type_Int / this.jdField_d_of_type_Int;
      if (QLog.isColorLevel()) {
        QLog.i("QRSession", 2, String.format("getScreenRect [%.2f,%.2f, %d,%d,%d,%d]", new Object[] { Float.valueOf(f1), Float.valueOf(f2), Integer.valueOf(akxg.jdField_a_of_type_Int), Integer.valueOf(akxg.jdField_b_of_type_Int), Integer.valueOf(this.jdField_e_of_type_Int), Integer.valueOf(this.jdField_d_of_type_Int) }));
      }
  ...
  private void a(List<akut> paramList)
  {
    if (paramList.size() <= 0) {
      return;
    }
    if (this.jdField_e_of_type_Long > 0L)
    {
      ...
      akvj.f(this.jdField_a_of_type_Akvc.b(), (int)(l1 - l2));
    }
    Object localObject;
    int i;
    if (QLog.isColorLevel())
    {
      ...
      {
        ((StringBuilder)localObject).append(((akut)paramList.get(i)).toString()).append("\n");
        i += 1;
      }
    ...
    if (a(this.jdField_a_of_type_ArrayOfByte, this.jdField_d_of_type_Int, this.jdField_e_of_type_Int))
    {
      ...
      if (i < paramList.size())
      {
        localObject = (akut)paramList.get(i);
        bool8 = bool6;
        bool9 = bool5;
        bool10 = bool7;
        bool11 = bool2;
        if (((akut)localObject).jdField_a_of_type_AndroidGraphicsRect.width() > 0)
        {
          bool8 = bool6;
          bool9 = bool5;
          bool10 = bool7;
          bool11 = bool2;
          if (((akut)localObject).jdField_a_of_type_AndroidGraphicsRect.height() > 0)
          {
            localRect = ((akut)localObject).jdField_a_of_type_AndroidGraphicsRect;
            if (((akut)localObject).jdField_a_of_type_Int == 2)
            {
              bool6 = true;
              bool7 = a(localRect);
              bool4 = bool6;
    ...
    for (;;)
    {
      ...
      try
      {
        if (((akut)paramList.get(0)).jdField_a_of_type_AndroidGraphicsRect.width() <= 0) {
          break label1041;
        }
        f2 = f4;
        f1 = f3;
        if (((akut)paramList.get(0)).jdField_a_of_type_AndroidGraphicsRect.height() <= 0) {
          break label1041;
        }
        ...
        f4 = ((akut)paramList.get(0)).jdField_a_of_type_AndroidGraphicsRect.width() / this.jdField_c_of_type_AndroidGraphicsRect.width();
        f3 = ((akut)paramList.get(0)).jdField_a_of_type_AndroidGraphicsRect.height() / this.jdField_c_of_type_AndroidGraphicsRect.height();
        if ((f4 >= 0.7F) || (f3 >= 0.7F)) {
          break label1029;
        }
        bool5 = true;
        ...
        paramList = new Rect(((akut)paramList.get(0)).jdField_a_of_type_AndroidGraphicsRect);
      ...
      return;
      if (((akut)localObject).jdField_a_of_type_Int == 1)
      {
        bool5 = true;
        bool8 = b(localRect);
        bool4 = bool6;
      ...
      bool3 = bool5;
      bool1 = bool7;
      if (((akut)localObject).jdField_a_of_type_Int != 3) {
        break label324;
      }
      bool8 = b(localRect);
      bool4 = bool6;
  ...
  private boolean a(int paramInt1, int paramInt2)
  {
    ...
    for (bool1 = true;; bool1 = false)
    {
      ...
      if ((this.jdField_a_of_type_Akur != null) && (this.jdField_a_of_type_Int == 2) && (i >= 0)) {
        this.jdField_a_of_type_Akur.a(i);
      }
      return bool1;
    }
  }
  ...
  private boolean a(Rect paramRect)
  {
    try
    {
      boolean bool = this.jdField_a_of_type_Akvc.a(this.jdField_a_of_type_ArrayOfByte, this.jdField_d_of_type_Int, this.jdField_e_of_type_Int, paramRect.left, paramRect.top, paramRect.width(), paramRect.height(), true);
      return bool;
    }
  ...
  private void b()
  {
    this.jdField_a_of_type_Akvl.a();
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_Akvc.a();
  ...
  private boolean b(Rect paramRect)
  {
    ...
    if (ImgProcessScan.gray_rotate_crop_sub(this.jdField_c_of_type_ArrayOfByte, arrayOfInt, this.jdField_a_of_type_ArrayOfByte, this.jdField_d_of_type_Int, this.jdField_e_of_type_Int, paramRect.left, paramRect.top, paramRect.width(), paramRect.height(), 90, 0) == 1) {
      bool = this.jdField_a_of_type_Akvl.a(this.jdField_c_of_type_ArrayOfByte, arrayOfInt[0], arrayOfInt[1], true);
    }
    return bool;
  }
  ...
  private void d()
  {
    ...
    for (StringBuilder localStringBuilder = new StringBuilder("doRecognizeInternal ");; localStringBuilder = null)
    {
      ...
      if (a(this.jdField_a_of_type_ArrayOfByte, this.jdField_d_of_type_Int, this.jdField_e_of_type_Int))
      {
        ...
        bool1 = this.jdField_a_of_type_Akvc.a();
        ...
        int[] arrayOfInt = new int[2];
        if (ImgProcessScan.gray_rotate_crop_sub(this.jdField_b_of_type_ArrayOfByte, arrayOfInt, this.jdField_a_of_type_ArrayOfByte, this.jdField_d_of_type_Int, this.jdField_e_of_type_Int, i, j, k, m, 90, 0) == 1)
        {
          i = arrayOfInt[0];
          j = arrayOfInt[1];
          long l2 = System.currentTimeMillis();
          boolean bool4 = this.jdField_a_of_type_Akvl.a(this.jdField_b_of_type_ArrayOfByte, i, j, false);
          long l3 = System.currentTimeMillis();
          if ((bool4) || (!this.jdField_a_of_type_Akvc.a(this.jdField_b_of_type_ArrayOfByte, i, j, false))) {
            break label469;
          }
          bool2 = true;
      ...
      for (;;)
      {
        ...
        break label290;
        label481:
        this.jdField_d_of_type_Long = this.jdField_a_of_type_Akvc.a(this.jdField_a_of_type_ArrayOfByte, this.jdField_d_of_type_Int, this.jdField_e_of_type_Int, this.jdField_d_of_type_AndroidGraphicsRect);
        this.jdField_f_of_type_Int = 0;
  ...
  {
    if (this.jdField_a_of_type_Akvd != null) {
      this.jdField_a_of_type_Akvd.a(paramLong);
    }
  }
  
  public void a(akur paramakur, akvd paramakvd)
  {
    this.jdField_a_of_type_Akur = paramakur;
    this.jdField_a_of_type_Akvd = paramakvd;
  }
  ...
  public void a(Context paramContext, AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new akwp(this, this.jdField_a_of_type_AndroidOsHandlerThread.getLooper());
    this.jdField_a_of_type_Akvl = new akvl(this.jdField_a_of_type_AndroidOsHandler);
    this.jdField_a_of_type_Akvl.a(this);
    this.jdField_a_of_type_Akvc = new akvc(this.jdField_a_of_type_AndroidOsHandler, paramContext);
    this.jdField_a_of_type_Akvc.a(this);
    this.jdField_a_of_type_Long = 250L;
    if (akpb.a().jdField_a_of_type_Boolean) {
      this.jdField_a_of_type_Long = 120L;
    }
    this.jdField_c_of_type_Int = akpb.a().jdField_c_of_type_Int;
  ...
  public void a(String paramString1, String paramString2, boolean paramBoolean)
  {
    int i = 2;
    this.jdField_e_of_type_Long = 0L;
    if ((this.jdField_a_of_type_Akur != null) && (this.jdField_a_of_type_Int == 2) && (!this.jdField_f_of_type_Boolean)) {
      this.jdField_a_of_type_Akur.a(paramString1.toString(), paramString2.toString(), paramBoolean);
    }
    if (paramBoolean) {}
    for (;;)
    {
  ...
  {
    if ((this.jdField_a_of_type_Akvd != null) && (!this.jdField_f_of_type_Boolean) && (this.jdField_a_of_type_Int == 2) && (paramLong == this.jdField_d_of_type_Long))
    {
      ...
      while (i < paramList.size())
      {
        akut localakut1 = new akut();
        akut localakut2 = new akut();
        localakut1.jdField_a_of_type_Int = ((akut)paramList.get(i)).jdField_a_of_type_Int;
        localakut2.jdField_a_of_type_Int = ((akut)paramList.get(i)).jdField_a_of_type_Int;
        localakut1.jdField_a_of_type_Float = ((akut)paramList.get(i)).jdField_a_of_type_Float;
        localakut2.jdField_a_of_type_Float = ((akut)paramList.get(i)).jdField_a_of_type_Float;
        localakut1.jdField_a_of_type_AndroidGraphicsRect = ((akut)paramList.get(i)).jdField_a_of_type_AndroidGraphicsRect;
        Rect localRect = ((akut)paramList.get(i)).jdField_a_of_type_AndroidGraphicsRect;
        if ((localRect.width() > 0) && (localRect.height() > 0)) {
          a(localRect, localakut2.jdField_a_of_type_AndroidGraphicsRect, true);
        }
        localArrayList1.add(localakut1);
        localArrayList2.add(localakut2);
        i += 1;
      }
      if (this.jdField_a_of_type_Akvd != null) {
        this.jdField_a_of_type_Akvd.a(localArrayList2, paramLong);
      }
      a(localArrayList1);
    }
    ...
    {
      this.jdField_a_of_type_AndroidOsHandler.removeMessages(102);
      akvj.a((int)(System.currentTimeMillis() - paramLong), 2);
    }
  }
  ...
  {
    int i;
    if ((this.jdField_a_of_type_Akvc != null) && (this.jdField_a_of_type_Akvc.b()))
    {
      i = 1;
      if (QLog.isColorLevel()) {
        if (i == 0) {
    ...
    for (int j = 1;; j = 0)
    {
      ...
      if ((this.jdField_a_of_type_Akur != null) && (this.jdField_a_of_type_Int == 2))
      {
        ...
        this.jdField_a_of_type_Akur.a(paramBoolean, paramFloat);
      }
      return;
      i = 0;
      break;
  ...
  public void a(boolean paramBoolean1, String paramString, boolean paramBoolean2)
  {
    ...
    if ((this.jdField_a_of_type_Akvd != null) && (this.jdField_a_of_type_Int == 2) && (!this.jdField_f_of_type_Boolean)) {
      this.jdField_a_of_type_Akvd.a(paramBoolean1, paramString, paramBoolean2);
    }
    int i;
    if (paramBoolean1)
    {
  ...
  public boolean a(byte[] paramArrayOfByte)
  {
    if (this.jdField_a_of_type_Int == 2)
    {
      a(paramArrayOfByte, akwj.a().a(), akwj.a().b(), this.jdField_d_of_type_Boolean);
      if (akvj.a()) {
        akvj.b();
      }
    }
