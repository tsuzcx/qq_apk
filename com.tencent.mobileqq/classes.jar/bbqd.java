  ...
  extends bbpz
{
  ...
  public bbqd()
  {
    this.jdField_a_of_type_MqqOsMqqHandler = new bbqe(this);
  }
  
  public long a()
  {
    if ((this.jdField_a_of_type_Bbrg != null) && (this.jdField_a_of_type_Bbrg.a != null)) {
      return this.jdField_a_of_type_Bbrg.a.getCurPlayingPos();
    }
    return 0L;
  }
  ...
  public void a(long paramLong, int paramInt1, int paramInt2, int paramInt3, String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      if (paramInt2 == 269484034)
      {
        ...
        if ((paramString != null) && ((paramString.baseData instanceof AIOBrowserBaseData)) && (((AIOBrowserBaseData)paramString.baseData).jdField_a_of_type_Long == paramLong)) {
          if (paramBoolean)
          {
            ...
            QQToast.a(this.jdField_a_of_type_Bbrg.mContext, 2, this.jdField_a_of_type_Bbrg.mContext.getString(2131718157), 0).a();
          }
        }
      }
      for (;;)
      {
        ...
        label283:
        if (paramInt3 == 2) {
          QQToast.a(this.jdField_a_of_type_Bbrg.mContext, 1, this.jdField_a_of_type_Bbrg.mContext.getString(2131718172), 0).a();
        }
      }
      paramBoolean = false;
    }
  ...
  {
    this.jdField_a_of_type_Bbrg.a(paramLong, paramInt1, paramInt2, paramString1, paramArrayOfString, paramString2, paramMessageForShortVideo, paramInt3, paramBundle);
  }
  ...
  public void b()
  {
    if ((this.jdField_a_of_type_Bbqa != null) && (this.jdField_a_of_type_Bbqa.a != null) && (this.jdField_a_of_type_Bbqa.a() != null))
    {
      ...
      if (bool)
      {
        ...
        this.jdField_a_of_type_Bbqa.a().a((int)AIOUtils.px2dp(LiuHaiUtils.jdField_a_of_type_Int, this.jdField_a_of_type_Bbrg.mContext.getResources()) + 46);
      }
    }
    for (;;)
    {
  ...
  public boolean b()
  {
    if (QLog.isColorLevel()) {
      QLog.d("AIOFileVideoPresenterXOXO", 2, "isImmersionOpen, ImmersiveConfProcessor.isVideoEnable() = " + aqsp.b());
    }
    return aqsp.b();
  }
  ...
  public void setGalleryView(BrowserBaseView paramBrowserBaseView)
  {
    ...
    if ((paramBrowserBaseView instanceof bbrg)) {
      this.jdField_a_of_type_Bbrg = ((bbrg)paramBrowserBaseView);
    }
  }
}
