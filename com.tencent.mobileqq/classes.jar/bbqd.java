  ...
  implements Animation.AnimationListener
{
  ...
  protected static final int m = (int)BaseApplicationImpl.getApplication().getResources().getDimension(2131297372);
  protected float a;
  protected Handler a;
  ...
  public bbqd()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new bbqe(this);
  }
  ...
  private void a(TextView paramTextView, int paramInt)
  {
    ...
    if (paramInt == e)
    {
      paramTextView.setText(2131698037);
      paramTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130842022, 0);
