...
public abstract class vui
{
  ...
  public void a(Context paramContext, RecyclerView paramRecyclerView, vbl paramvbl, vut paramvut)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView = paramRecyclerView;
    this.jdField_a_of_type_Vbl = paramvbl;
    this.jdField_a_of_type_Vut = paramvut;
  }
  ...
  public void a(RecyclerView paramRecyclerView)
  {
    ...
    {
      paramRecyclerView = ((aabj)paramRecyclerView.getAdapter()).getDataList().iterator();
      while (paramRecyclerView.hasNext())
      {
        aabp localaabp = (aabp)paramRecyclerView.next();
        if ((localaabp instanceof vbl)) {
          this.jdField_a_of_type_Vbl = ((vbl)localaabp);
        }
      }
    }
  }
  ...
  public boolean a()
  {
    if (((this.jdField_a_of_type_Vbl.getInteractor() instanceof var)) && (((var)this.jdField_a_of_type_Vbl.getInteractor()).a() == this.jdField_a_of_type_Int))
    {
      QLog.d(vut.a, 4, hashCode() + ":isCurrentPage :" + true);
      return true;
    }
    QLog.d(vut.a, 4, hashCode() + ":isCurrentPage :" + false);
    return false;
  }
  ...
  protected boolean a(View paramView)
  {
    ...
    if (paramView != null)
    {
      ...
      if (localRect.bottom > bdep.b) {
        localRect.bottom = bdep.b;
      }
    }
    label147:
    ...
    {
      float f = i / j;
      QLog.d(vut.a, 4, f + "  " + localRect.bottom + "  " + localRect.top);
      return (f >= 0.5D) && (a());
    }
  }
