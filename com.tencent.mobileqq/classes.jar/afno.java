  ...
  implements Manager
{
  ...
  private afnx jdField_a_of_type_Afnx;
  ...
  public afno(AppInterface paramAppInterface)
  {
    a(paramAppInterface);
  }
  ...
  private void a(int paramInt)
  {
    ...
    {
      aoxz localaoxz = ((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface).getProxyManager().a();
      RecentUser localRecentUser = (RecentUser)localaoxz.findRecentUser(AppConstants.ACTIVATE_FRIENDS_UIN, 9002);
  ...
  {
    if (((paramAcsMsg.type == 0) && (!afmj.a(paramAcsMsg.notice_time * 1000L))) || ((paramAcsMsg.type == 1) && (paramAcsMsg.notice_time - NetConnInfoCenter.getServerTime() > 86400L))) {
      if (QLog.isColorLevel()) {
    ...
    {
      return;
      Object localObject1 = afmn.a(paramAcsMsg);
  ...
  private void a(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_Afnl = ((afnl)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.QQ_REMINDER_ALARM_MANAGER));
  ...
  private void a(boolean paramBoolean, afnt paramafnt)
  {
    try
    {
      str1 = afmj.a(NetConnInfoCenter.getServerTimeMillis(), "yyyyMMdd");
      if (QLog.isColorLevel()) {
    ...
    catch (Throwable paramafnt)
    {
      String str1;
      String str2;
      long l2;
      label153:
      QLog.e("ReminderDataManagerNew", 1, "checkTodayReminder throw an exception: " + paramafnt);
    }
    try
    {
    ...
    l1 += afmj.a(NetConnInfoCenter.getServerTimeMillis());
    if (QLog.isColorLevel()) {
      QLog.i("ReminderDataManagerNew", 2, "pullTodayMsgList currentDelayTs: " + afmj.a(l1, "yyyy-MM-dd HH:mm:ss"));
    }
    ...
    {
      a(str1, new afnp(this, str1, paramafnt));
      return;
    }
  }
  ...
  private boolean a(String paramString, @Nullable AcsMsg paramAcsMsg)
  {
    ...
    for (int i = 1;; i = 0)
    {
      if ((paramAcsMsg != null) && (i != 0) && (a(afmn.a(paramAcsMsg)))) {
        a(paramAcsMsg, 0);
      }
      if (j <= 0) {
        break;
  ...
  private void b()
  {
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      {
        if (!afmj.a(localAcsMsg.notice_time * 1000L)) {
    ...
    if (!str1.equals(str2))
    {
      this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putString("sp_key_cache_list_time", afmj.a(NetConnInfoCenter.getServerTimeMillis(), "yyyyMMdd")).apply();
      if (Looper.myLooper() == Looper.getMainLooper()) {
  ...
  private void b(List<AcsMsg> paramList)
  {
    ...
    {
      localObject = (afnl)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.QQ_REMINDER_ALARM_MANAGER);
    ...
    for (;;)
    {
      if (paramList.hasNext())
      {
        ...
        {
          if (localObject != null) {
            ((afnl)localObject).a(localAcsMsg);
          }
        }
        else
        {
          ...
          for (boolean bool1 = true;; bool1 = false)
          {
            ...
            boolean bool2 = ((aohe)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.MGR_ACTVATE_FRIENDS)).a(true);
            if (QLog.isColorLevel()) {
            ...
            a(localAcsMsg.title, afmn.a(localAcsMsg));
            break;
          }
          if (QLog.isColorLevel())
          {
  ...
  private void c(String paramString1, String paramString2)
  {
    ...
    bdla.b((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, "P_CliOper", "QQnotice", "", "", "QQnotice.list.show", 0, 0, "", "", paramString2, "");
  ...
  private void d(AcsMsg paramAcsMsg)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentCommonAppAppInterface != null) && (paramAcsMsg != null))
    {
      ...
      this.jdField_a_of_type_Afnl.a(str.hashCode());
    }
  ...
  public void a(afnv paramafnv)
  {
    a(new ReminderDataManager.4(this, paramafnv));
  }
  
  public void a(afnv paramafnv, boolean paramBoolean)
  {
    ArrayList localArrayList = new ArrayList();
    if (QLog.isColorLevel()) {
      QLog.d("ReminderDataManagerNew", 1, "getTodayReminderMsgAsync...");
    }
    a(new ReminderDataManager.5(this, paramBoolean, localArrayList, paramafnv));
  }
  
  public void a(afnx paramafnx)
  {
    this.jdField_a_of_type_Afnx = paramafnx;
  }
  
  public void a(String paramString, afnu paramafnu)
  {
    a(new ReminderDataManager.6(this, paramString, paramafnu));
  }
  
  public void a(String paramString, afnw paramafnw)
  {
    try
    {
      afnn.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, paramString, new afnr(this, paramafnw));
      return;
    }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    do
    {
      try
      {
        bool = ((aohe)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.MGR_ACTVATE_FRIENDS)).a(true);
        if (!QLog.isColorLevel()) {
          continue;
        }
  ...
  public void b(AcsMsg paramAcsMsg)
  {
    ...
    if ((paramAcsMsg.type == 0) && (paramAcsMsg.notice_time > NetConnInfoCenter.getServerTime()))
    {
      ...
      afnl localafnl = (afnl)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.QQ_REMINDER_ALARM_MANAGER);
      if (localafnl != null) {
        localafnl.a(paramAcsMsg);
      }
      return;
    }
    if (QLog.isColorLevel()) {
    ...
    if (paramAcsMsg.type == 1)
    {
      ...
      if (this.jdField_a_of_type_Afnx != null) {
        this.jdField_a_of_type_Afnx.a(paramAcsMsg);
      }
    }
    a(paramAcsMsg.title, afmn.a(paramAcsMsg));
  }
