  ...
  extends BusinessHandler
{
  ...
  public anwk(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    return BaseApplicationImpl.getApplication().getSharedPreferences("apollo_sp", 0).getLong("apollo_client_script_" + amip.ax, 0L);
  }
  
  public static String a()
  {
    return "client_script_config_" + amip.au;
  }
  
  public static void a(long paramLong)
  {
    BaseApplicationImpl.getApplication().getSharedPreferences("apollo_sp", 0).edit().putLong("apollo_client_script_" + amip.ax, paramLong).commit();
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface != null)
    {
      ...
      b(0L);
      anwk localanwk = (anwk)paramQQAppInterface.getBusinessHandler(115);
      if (localanwk == null) {
        break label49;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    if (i == 0) {
      ((alnr)paramQQAppInterface.getManager(153)).a(true, "checkApolloPanelJsonVer : local ver==0", paramInt);
    }
    for (;;)
    {
  ...
  {
    return BaseApplicationImpl.getApplication().getSharedPreferences("apollo_sp", 0).getLong("apollo_client_script_" + amip.au, 0L);
  }
  
  public static String b()
  {
    return "client_script_config_" + amip.ax;
  }
  
  public static void b(long paramLong)
  {
    BaseApplicationImpl.getApplication().getSharedPreferences("apollo_sp", 0).edit().putLong("apollo_client_script_" + amip.au, paramLong).commit();
    QLog.i("ApolloContentUpdateHandler", 1, "updateApolloBaseResVersion version: " + paramLong);
  }
  
  private static void b(QQAppInterface paramQQAppInterface)
  {
    amdp.a(paramQQAppInterface, amip.av + "base.zip", amip.at, null, new anwm());
  }
  ...
  protected ClubContentUpdateInfoPb.ReqAppInfo a()
  {
    ...
    if (i == 0)
    {
      ((alnr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a(true, "login : local ver==0", 1);
      return null;
    }
    ((alnr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a(false, "login : check action", 1);
  ...
  protected void a(ClubContentUpdateInfoPb.RspAppInfo paramRspAppInfo)
  {
    ...
    if ((paramRspAppInfo.rpt_msg_rspiteminfo.has()) && (paramRspAppInfo.rpt_msg_rspiteminfo.size() > 0))
    {
      ...
      ((alnr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a(true, "12h update...", 1);
    }
    for (;;)
    {
      ...
      try
      {
        ...
        ((alnr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).b();
      }
  ...
  public void a(ArrayList<ClubContentUpdateInfoPb.ReqAppInfo> paramArrayList)
  {
    ...
    if (paramArrayList == null)
    {
      ...
      if (alnr.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()))
      {
        i = ((alnr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin());
        if (2 != i)
        {
    ...
    for (;;)
    {
      ...
      break;
      if (FileUtil.isFileExists(ApolloUtil.a)) {
        alnr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
  ...
  protected void b(ClubContentUpdateInfoPb.RspAppInfo paramRspAppInfo)
  {
    ...
    {
      amfn.a(null, (AppInterface)localObject, i, bool);
  ...
  {
    if (!alnr.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
    {
  ...
  public ClubContentUpdateInfoPb.ReqAppInfo c()
  {
    ...
    Object localObject2 = new File(amip.c, "/def/role/0/config.json");
    ...
    for (;;)
    {
      try
      {
        ...
        localObject2 = new File(amip.g);
        if ((((File)localObject2).exists()) && (((File)localObject2).isDirectory())) {
          ((File)localObject2).listFiles(new anwl(this, (SparseArray)localObject1));
        }
        localObject2 = new ArrayList();
        i = 0;
  ...
  public void d(ClubContentUpdateInfoPb.RspAppInfo paramRspAppInfo)
  {
    ...
    for (;;)
    {
      localObject = amip.av + "base.zip";
      Bundle localBundle;
      if ((1 == (j & 0x1)) || (bool))
      {
        localBundle = new Bundle();
        localBundle.putLong("version", i);
        amdp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject, amip.at, localBundle, new anwm());
      }
      ...
      if ((((File)localObject).list() == null) || (((File)localObject).list().length == 0))
      {
        ...
        for (;;)
        {
          localObject = amip.ay + "base.zip";
          if ((1 == (j & 0x1)) || (bool))
          {
            localBundle = new Bundle();
            localBundle.putLong("version", i);
            amdp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject, amip.aw, localBundle, new anwn());
          }
