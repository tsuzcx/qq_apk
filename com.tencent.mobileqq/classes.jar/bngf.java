...
public class bngf
{
  ...
  private bngh jdField_a_of_type_Bngh;
  private bngk jdField_a_of_type_Bngk;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajni.jdField_d_of_type_JavaLangString + "pddata/prd/dov_capture_qsvf" + File.separator;
    jdField_b_of_type_JavaLangString = jdField_a_of_type_JavaLangString + "capture_res" + File.separator;
    e = ajni.jdField_d_of_type_JavaLangString + "qav" + File.separator + "beauty" + File.separator;
  ...
  private boolean a()
  {
    String str = bdcs.d("filter_template.cfg");
    boolean bool = a(str);
  ...
  private boolean a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Bngh != null) {
        this.jdField_a_of_type_Bngh.a();
      }
      return true;
      label334:
      i += 1;
  ...
  public void a()
  {
    this.jdField_a_of_type_Bngh = null;
  }
  ...
  public void a(bngh parambngh)
  {
    this.jdField_a_of_type_Bngh = parambngh;
  }
  ...
  public void a(bngk parambngk)
  {
    ...
    {
      return;
      this.jdField_a_of_type_Bngk = parambngk;
      ...
      parambngk = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
      while (parambngk.hasNext())
      {
        Object localObject1 = (FilterCategory)parambngk.next();
              ...
              if (localFilterDesc.predownload == 1)
              {
                ...
                if (!TextUtils.isEmpty(localFilterDesc.iconurl))
                {
                  ...
                  if (!((File)localObject3).exists())
                  {
                    ...
                    ((baps)localObject3).jdField_a_of_type_Bapx = new bngj(this);
                    ((baps)localObject3).jdField_a_of_type_JavaLangString = localFilterDesc.iconurl;
                    ((baps)localObject3).jdField_a_of_type_Int = 0;
                    ((baps)localObject3).jdField_c_of_type_JavaLangString = ((String)localObject2);
                    ((baps)localObject3).a(localFilterDesc);
                    lel.a().a((baqv)localObject3);
                ...
                if ((!TextUtils.isEmpty(localFilterDesc.resurl)) && (!TextUtils.isEmpty((CharSequence)localObject2)))
                {
                  ...
                  if (!((File)localObject3).exists())
                  {
                    ...
                    ((baps)localObject2).jdField_a_of_type_Bapx = new bngi(this);
                    ((baps)localObject2).jdField_a_of_type_JavaLangString = localFilterDesc.resurl;
                    ((baps)localObject2).jdField_a_of_type_Int = 0;
                    ((baps)localObject2).jdField_c_of_type_JavaLangString = (jdField_b_of_type_JavaLangString + localFilterDesc.name + ".zip");
    ...
    } while ((this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 0) || (this.jdField_a_of_type_Bngk == null));
    this.jdField_a_of_type_Bngk.a(false);
  }
  ...
  public void d()
  {
    this.jdField_a_of_type_Bngk = null;
  }
}
