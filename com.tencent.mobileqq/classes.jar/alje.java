  ...
  extends Thread
{
  ...
  public alje(TraeAudioManager arg1, TraeAudioManager paramTraeAudioManager2)
  {
  ...
  void a(int paramInt)
  {
    ...
    do
    {
      do
      {
        ...
        this.jdField_a_of_type_AndroidMediaAudioManager$OnAudioFocusChangeListener = new aljh(this);
  ...
  void a(HashMap paramHashMap)
  {
    ...
    if (this.jdField_a_of_type_ComTencentSharpJniTraeMediaPlayer == null) {
      this.jdField_a_of_type_ComTencentSharpJniTraeMediaPlayer = new TraeMediaPlayer(this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_AndroidContentContext, new aljf(this));
    }
  ...
  void b()
  {
    ...
    for (;;)
    {
      if (this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_Aljm != null)
      {
        if (QLog.isColorLevel()) {
          QLog.w("TRAE", 2, "_switchThread:" + this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_Aljm.a());
        }
        this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_Aljm.f();
        this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_Aljm = null;
      }
      if (this.jdField_a_of_type_ComTencentSharpJniTraeMediaPlayer != null) {
  ...
  void c()
  {
    ...
    try
    {
      ...
      this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_Aljd = this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.a(this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_AndroidContentContext, this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_ComTencentSharpJniTraeAudioManager$DeviceConfigManager);
      IntentFilter localIntentFilter = new IntentFilter();
      localIntentFilter.addAction("android.intent.action.HEADSET_PLUG");
      localIntentFilter.addAction("android.media.AUDIO_BECOMING_NOISY");
      this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_Aljd.b(localIntentFilter);
  ...
  void d()
  {
    ...
    {
      this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_AndroidMediaAudioManager = ((AudioManager)this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_AndroidContentContext.getSystemService("audio"));
      if (this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_Aljd == null) {
        this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_Aljd = this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.a(this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_AndroidContentContext, this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_ComTencentSharpJniTraeAudioManager$DeviceConfigManager);
      }
  ...
  void e()
  {
    ...
    {
      if (this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_Aljd != null) {
        this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_Aljd.a();
      }
      this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_Aljd = null;
      if (this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_AndroidContentContext != null)
      {
        this.jdField_b_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_AndroidContentContext.unregisterReceiver(this.jdField_a_of_type_ComTencentSharpJniTraeAudioManager);
        IntentFilter localIntentFilter = new IntentFilter();
  ...
  public void run()
  {
    AudioDeviceInterface.LogTraceEntry("");
    Looper.prepare();
    this.jdField_a_of_type_AndroidOsHandler = new aljg(this);
    c();
    synchronized (this.jdField_a_of_type_ArrayOfBoolean)
    {
