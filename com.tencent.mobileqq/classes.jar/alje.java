...
public class alje
{
  ...
  public static String a(String[] paramArrayOfString)
  {
    ...
    for (;;)
    {
      ...
      str2 = paramArrayOfString[atxu.a(paramArrayOfString.length)];
    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          ...
          ((JSONObject)localObject).put("atlas", algj.a(paramInt + "/role", 1));
          ((JSONObject)localObject).put("json", algj.a(paramInt + "/role", 1));
          continue;
      ...
      localJSONObject2.put("atlas", algj.a(localInteger + "/dress", 2));
      localJSONObject2.put("json", algj.a(localInteger + "/dress", 2));
    }
    localJSONObject1.put("dressPath", localException1);
    return localJSONObject1;
  }
  
  public static void a(int paramInt1, QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt2, String paramString3, aljk paramaljk)
  {
    aknx localaknx = (aknx)paramQQAppInterface.getManager(153);
    Object localObject = localaknx.b(paramString1);
    if (localObject != null)
    {
      ...
      if ((localObject != null) && (localObject.length > 0))
      {
        ...
        if (paramInt2 < j)
        {
          aksm localaksm = localObject[paramInt2];
          i = localaksm.jdField_b_of_type_Int;
          int[] arrayOfInt = localaksm.a();
          if ((algj.a(paramString1, localaksm.jdField_a_of_type_Int, arrayOfInt, paramQQAppInterface, new alji(paramaljk, paramInt1, paramQQAppInterface, paramString2, paramString3, localaksm, arrayOfInt))) && (localaksm.jdField_a_of_type_Int != 0))
          {
            if (QLog.isColorLevel()) {
              QLog.d("ApolloGameBasicEventUtil", 2, "valid role and dress RSC.");
            }
            if (paramaljk != null) {
              paramaljk.a(paramInt1, paramQQAppInterface, paramString1, paramString2, paramString3, localaksm.jdField_a_of_type_Int, arrayOfInt, 3);
            }
          }
        }
      }
      ...
      for (;;)
      {
        ...
        if (paramaljk != null)
        {
          ...
          {
            paramInt2 = 2;
            paramaljk.a(paramInt1, paramQQAppInterface, paramString1, paramString2, paramString3, paramInt2, aldv.a(paramInt2), 1);
          }
        }
        else
        {
          aknx.a(paramQQAppInterface, paramString1, "apllo_game");
          paramQQAppInterface = (alto)paramQQAppInterface.getManager(51);
          if ((paramQQAppInterface == null) || (paramQQAppInterface.b(paramString1))) {
            continue;
          }
          paramQQAppInterface = localaknx.b(paramString1);
        ...
        for (long l = paramQQAppInterface.apolloUpdateTime;; l = 0L)
        {
          ...
          paramaljk.a(paramInt1, paramQQAppInterface, paramString1, paramString2, paramString3, 1, aldv.a(1), 1);
          break label282;
        }
      }
    }
  ...
  public static void a(int paramInt, String paramString, Activity paramActivity)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localalnf = new alnf();
        localObject1 = akwd.a(paramInt);
        if (localObject1 != null)
        {
          localObject1 = ((akyg)localObject1).a();
          if ((localObject1 != null) && (((CmGameStartChecker.StartCheckParam)localObject1).game != null))
          {
            localalnf.jdField_b_of_type_Int = ((CmGameStartChecker.StartCheckParam)localObject1).game.actionId;
            localalnf.jdField_b_of_type_JavaLangString = ((CmGameStartChecker.StartCheckParam)localObject1).game.name;
          }
        }
        if (localalnf.jdField_b_of_type_Int <= 0) {
          localalnf.jdField_b_of_type_Int = 439;
        }
        localalnf.jdField_a_of_type_Int = paramInt;
        localalnf.jdField_a_of_type_JavaLangString = alud.a(2131700751);
        localalnf.jdField_c_of_type_Int = i;
        ...
        ((JSONObject)localObject1).put("xyRootSrc", akuf.a(paramInt));
        i = paramString.optInt("activityId");
        int j = paramString.optInt("reqCode");
        localObject2 = akwd.a(paramInt);
        if (localObject2 != null)
        {
          ((akyg)localObject2).jdField_b_of_type_Int = i;
          ((akyg)localObject2).jdField_c_of_type_Int = j;
        }
        localalnf.jdField_c_of_type_JavaLangString = ((JSONObject)localObject1).toString();
        if (localalnf.jdField_c_of_type_JavaLangString.length() >= 500)
        {
          QLog.w("cmgame.sendmsg", 1, "extendInfo is too long, len:" + localalnf.jdField_c_of_type_JavaLangString.length() + ",content:" + localalnf.jdField_c_of_type_JavaLangString);
          return;
        }
      }
      ...
      Object localObject1 = akyn.a();
      if ((localObject1 != null) && (((akyn)localObject1).a != null) && (0L != l)) {
        ((akyn)localObject1).a.roomId = l;
      }
      if (i == 0)
      {
        paramString.put("msgType", 4);
        akxv.a("cs.send_game_msg.local", paramString.toString(), true, null, paramInt);
        return;
      }
    } while (1 != i);
    a(localalnf, paramActivity, 3);
  }
  ...
  public static void a(long paramLong, QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    Object localObject1 = (aknx)paramQQAppInterface.getManager(153);
    Object localObject2 = aknx.jdField_c_of_type_JavaLangString;
    localObject1 = aknx.jdField_b_of_type_JavaLangString;
  ...
  public static void a(long paramLong, QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        a(paramLong, paramQQAppInterface, paramString2, "", 1, paramString1, new aljf());
        return;
  ...
  public static void a(long paramLong, QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt, String paramString3, aljj paramaljj)
  {
    aknx localaknx = (aknx)paramQQAppInterface.getManager(153);
    Object localObject = localaknx.b(paramString1);
    if (localObject != null)
    {
      ...
      if ((localObject != null) && (localObject.length > 0))
      {
        ...
        if (paramInt < j)
        {
          aksm localaksm = localObject[paramInt];
          i = localaksm.jdField_b_of_type_Int;
          int[] arrayOfInt = localaksm.a();
          if ((algj.a(paramString1, localaksm.jdField_a_of_type_Int, arrayOfInt, paramQQAppInterface, new aljh(paramaljj, paramLong, paramQQAppInterface, paramString2, paramString3, localaksm, arrayOfInt))) && (localaksm.jdField_a_of_type_Int != 0))
          {
            if (QLog.isColorLevel()) {
              QLog.d("ApolloGameBasicEventUtil", 2, "valid role and dress RSC.");
            }
            if (paramaljj != null) {
              paramaljj.a(paramLong, paramQQAppInterface, paramString1, paramString2, paramString3, localaksm.jdField_a_of_type_Int, arrayOfInt, 3);
            }
          }
        }
      }
      ...
      for (;;)
      {
        ...
        if (paramaljj != null)
        {
          ...
          {
            paramInt = 2;
            paramaljj.a(paramLong, paramQQAppInterface, paramString1, paramString2, paramString3, paramInt, aldv.a(paramInt), 1);
          }
        }
        else
        {
        ...
        for (paramLong = paramQQAppInterface.apolloUpdateTime;; paramLong = 0L)
        {
          ...
          paramaljj.a(paramLong, paramQQAppInterface, paramString1, paramString2, paramString3, 1, aldv.a(1), 1);
          break label285;
        }
      }
    }
  ...
  public static void a(alnf paramalnf, Activity paramActivity, int paramInt)
  {
    if (paramalnf == null)
    {
    ...
    localBundle.putInt("forward.apollo.gameid", paramalnf.jdField_a_of_type_Int);
    localBundle.putInt("forward.apollo.gameMode", paramalnf.jdField_c_of_type_Int);
    localBundle.putInt("forward_type", 34);
    if (QLog.isColorLevel()) {
      QLog.d("ApolloGameBasicEventUtil", 2, "[forwardGameMsg] gameId:" + paramalnf.jdField_a_of_type_Int + ";fromtype:" + paramInt);
    }
    if (paramInt == 2)
    {
      localIntent.putExtras(localBundle);
      aryv.a(paramActivity, localIntent, 99999);
      return;
    }
    localBundle.putInt("forward.apollo.actionid", paramalnf.jdField_b_of_type_Int);
    localBundle.putLong("forward.apollo.roomid", paramalnf.jdField_a_of_type_Long);
    localBundle.putString("forward.apollo.gamename", paramalnf.jdField_b_of_type_JavaLangString);
    localBundle.putString("forward.apollo.actionname", paramalnf.jdField_a_of_type_JavaLangString);
    localBundle.putInt("forward.apollo.msgtype", paramalnf.d);
    localBundle.putString("forward.apollo.sharejson", paramalnf.jdField_c_of_type_JavaLangString);
    localIntent.putExtras(localBundle);
    aryv.a(paramActivity, localIntent, 20180426);
  }
    ...
    if (localJSONObject1.has("param"))
    {
      ...
      if (localJSONObject2 != null)
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          paramString = bhsz.a(paramString, str, localJSONObject2.getString(str));
        }
      }
    }
    for (;;)
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, Activity paramActivity)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localalnf = new alnf();
        ApolloGameData localApolloGameData = ((aliw)localObject).a(k);
        paramString = alud.a(2131700733);
        if ((localApolloGameData != null) && (!TextUtils.isEmpty(localApolloGameData.name)))
        {
          ...
          localalnf.jdField_a_of_type_JavaLangString = paramString;
          localalnf.jdField_b_of_type_Int = i;
          localalnf.jdField_c_of_type_Int = j;
          localalnf.jdField_a_of_type_Long = l;
          localalnf.jdField_a_of_type_Int = k;
      ...
      localalnf.jdField_b_of_type_JavaLangString = alud.a(2131700752);
      int i = 0;
      continue;
      localalnf.d = 3;
      continue;
      ...
      ApolloGameUtil.a(paramQQAppInterface, localalnf, paramString.a());
      return;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          QLog.i("ApolloGameBasicEventUtil", 1, "pass uin.");
          a(paramInt, paramQQAppInterface, paramString2, str, 1, paramString1, new aljg(i));
          return;
        }
      }
      catch (Exception paramQQAppInterface)
  ...
  public static boolean a(Context paramContext, String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt1 == 2)
      {
        ...
        String str = String.format("https://cmshow.qq.com/apollo/html/game-platform/buy-props.html?_wv=3&adtag=inside_game&gameId=%s&gameOrientation=%s&itemList=%s", new Object[] { Integer.valueOf(localakyg.a()), Integer.valueOf(i), URLEncoder.encode(paramString.optString("itemList"), "UTF-8") });
        ...
        VipUtils.a(null, "cmshow", "Apollo", "open_webpage", 0, 0, new String[] { localakyg.a().mGameName });
        if (QLog.isColorLevel())
        {
          ...
          VipUtils.a(null, "cmshow", "Apollo", "open_webpage", 1, 0, new String[] { localakyg.a().mGameName });
        }
      }
      else
      {
  ...
  private static String b()
  {
    ...
    {
      if ((alud.a(2131700760).equals(str)) || (str.contains(alud.a(2131700745)))) {
        return a(b);
      }
      if ((alud.a(2131700758).equals(str)) || (str.contains(alud.a(2131700719)))) {
        return a(c);
      }
      if ((alud.a(2131700731).equals(str)) || (str.contains(alud.a(2131700725)))) {
  ...
  public static void b(long paramLong, QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    paramString = b(aknx.jdField_c_of_type_JavaLangString.getBytes(), paramString.getBytes());
    try
    {
    ...
    if (localJSONObject.has("param"))
    {
      ...
      if (localJSONObject != null)
      {
        ...
        for (;;)
        {
          ...
          paramString = bhsz.a(paramString, str, localJSONObject.getString(str));
        }
      }
    }
  ...
  public static void c(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    int j = bdin.b(paramQQAppInterface.getApp());
    long l1 = 0L;
    label199:
    label204:
    label210:
