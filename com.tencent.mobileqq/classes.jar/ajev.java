  ...
  extends ajrw
{
  public void a()
  {
    ...
    if (i > 10)
    {
      ...
      {
        bool1 = SettingCloneUtil.readValue(BaseApplicationImpl.sApplication, null, BaseApplicationImpl.sApplication.getString(2131629602), "qqsetting_screenshot_key", false);
        boolean bool2 = azyx.a(BaseApplication.getContext());
        if ((bool1) && (bool2))
        {
    ...
    for (;;)
    {
      ...
      while (QLog.isColorLevel())
      {
        ...
        if ((!balh.g) && (Build.VERSION.SDK_INT < 11)) {
          bale.a().a(BaseActivity2.jdField_a_of_type_ComTencentMobileqqAppBaseActivity2.getWindow());
        }
      }
    }
  }
