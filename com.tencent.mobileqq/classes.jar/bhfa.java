...
public class bhfa
{
  ...
  bheh jdField_a_of_type_Bheh = null;
  ...
  public void a(Intent paramIntent)
  {
    ...
    return;
    String str;
    if (this.jdField_a_of_type_Bheh != null)
    {
      str = this.jdField_a_of_type_Bheh.jdField_b_of_type_JavaLangString;
      paramIntent = this.jdField_a_of_type_Bheh.jdField_c_of_type_JavaLangString;
    }
    for (;;)
    {
  ...
  public void a(QQAppInterface paramQQAppInterface, Activity paramActivity, Intent paramIntent)
  {
        ...
        do
        {
          do
          {
            do
            {
              ...
              Object localObject = bhex.a(paramActivity);
    ...
    this.jdField_a_of_type_Bheh = bhey.a(paramQQAppInterface, paramActivity, this.g);
  }
