  ...
  extends bici
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new ahov(this);
  protected View a;
  ...
  private View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new ahow(this);
  View jdField_b_of_type_AndroidViewView;
  protected List<RecommendTroopItem> b;
  public boolean b;
  private final int jdField_c_of_type_Int = 1;
  private View.OnClickListener jdField_c_of_type_AndroidViewView$OnClickListener = new ahox(this);
  ...
  public ahot(QQAppInterface paramQQAppInterface, Context paramContext, ahoe paramahoe, ahld paramahld)
  {
  ...
  private void a(RecommendTroopItem paramRecommendTroopItem)
  {
    ...
    do
    {
      ...
      bdes.a("Grp_contacts_news", "notice", "recom_exp_grp", 0, 0, new String[] { str1, paramRecommendTroopItem });
  ...
  {
    Object localObject;
    if ((paramView == null) || (!(paramView.getTag() instanceof ahok)))
    {
      ...
      localObject = (Button)paramView.findViewById(2131378472);
  ...
  public void a(ambh paramambh)
  {
    ArrayList localArrayList;
    int i;
    Object localObject;
    if ((this.jdField_a_of_type_JavaUtilList != null) && (paramambh != null))
    {
  ...
  public void a(LinearLayout paramLinearLayout)
  {
    ...
    localURLDrawableOptions.mRequestWidth = aepi.a(238.0F, (Resources)localObject);
    localURLDrawableOptions.mRequestHeight = aepi.a(161.0F, (Resources)localObject);
    ...
    ((ImageView)paramLinearLayout.findViewById(2131367597)).setImageDrawable((Drawable)localObject);
  }
  ...
  public void b()
  {
    ...
    bdes.a("Grp_contacts_news", "notice", "verify_clk", 3, 0, new String[0]);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (i == 1)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface instanceof QQAppInterface))) {
        paramViewGroup = bdbk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 4, localRecommendTroopItem.uin);
      }
    }
    for (;;)
    {
      ...
      {
        localView = ahes.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_b_of_type_AndroidViewView$OnClickListener, this.jdField_a_of_type_AndroidViewView$OnClickListener, this.jdField_c_of_type_AndroidViewView$OnClickListener);
      }
      ahes.a((ahev)localView.getTag(), localRecommendTroopItem, paramViewGroup);
      a(localRecommendTroopItem);
      return localView;
      if (this.jdField_a_of_type_Bcle != null)
      {
        paramViewGroup = this.jdField_a_of_type_Bcle.a(localRecommendTroopItem.uin, true);
        if (paramViewGroup != null)
        {
          ...
          if (i == 2)
          {
            localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131562784, null);
            paramViewGroup = (TextView)localView.findViewById(2131376324);
            if (this.jdField_g_of_type_Boolean) {
              paramView = this.jdField_a_of_type_AndroidContentContext.getString(2131699997);
            }
            for (;;)
            {
              paramViewGroup.setText(paramView);
              localView.setOnClickListener(new ahou(this));
              paramViewGroup = localView;
              if (this.jdField_c_of_type_Boolean) {
                break;
              }
              bdes.a("Grp_contacts_news", "notice", "verify_exp", 2, 0, new String[0]);
              this.jdField_c_of_type_Boolean = true;
              return localView;
              if (this.jdField_a_of_type_Int > c() - 2) {
                paramView = alud.a(2131708027) + this.jdField_a_of_type_Int + alud.a(2131708029);
              } else {
                paramView = alud.a(2131708026);
              }
            }
          }
          if (i == 4)
          {
            ...
            this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560497, null);
            this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371032));
            this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131371018);
            if (paramInt != 0)
            {
          ...
          if (i == 5)
          {
            paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131562785, null);
            ((TextView)paramView.findViewById(2131367609)).setText(alud.a(2131708025));
            ((LinearLayout)paramView.findViewById(2131371268)).setVisibility(8);
            return paramView;
          }
          if (i == 6)
          {
            paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131562785, null);
            ((TextView)paramView.findViewById(2131367609)).setText(alud.a(2131708024));
            ((LinearLayout)paramView.findViewById(2131371268)).setVisibility(8);
            return paramView;
          }
          if (i == 3)
          {
            paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131562785, null);
            paramViewGroup = (TextView)paramView.findViewById(2131367609);
            paramViewGroup.setText(alud.a(2131708028));
            paramViewGroup.setVisibility(8);
            paramViewGroup = (LinearLayout)paramView.findViewById(2131371268);
