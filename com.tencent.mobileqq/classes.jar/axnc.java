...
public class axnc
{
  public static SpannableStringBuilder a(Context paramContext, SpannableStringBuilder paramSpannableStringBuilder)
  {
    ...
    try
    {
      ...
      localObject2 = axma.a((String)localObject1);
    ...
    {
      localObject5 = (axmc)((Iterator)localObject4).next();
      if (!TextUtils.isEmpty(((axmc)localObject5).jdField_b_of_type_JavaLangString))
      {
        localaxmd = new axmd(paramContext, 0, ((axmc)localObject5).jdField_b_of_type_JavaLangString, ViewUtils.dpToPx(16.0F), null);
        localObject2 = "[icon]";
        if (!TextUtils.isEmpty(((axmc)localObject5).c)) {
          localObject2 = ((axmc)localObject5).c;
        }
        ((axmc)localObject5).jdField_a_of_type_Int += i;
        ((axmc)localObject5).jdField_b_of_type_Int += i;
        paramSpannableStringBuilder.replace(((axmc)localObject5).jdField_a_of_type_Int, ((axmc)localObject5).jdField_b_of_type_Int, (CharSequence)localObject2);
        paramSpannableStringBuilder.setSpan(localaxmd, ((axmc)localObject5).jdField_a_of_type_Int, ((axmc)localObject5).jdField_a_of_type_Int + ((String)localObject2).length(), 33);
        i = ((axmc)localObject5).jdField_a_of_type_Int + ((String)localObject2).length() - ((axmc)localObject5).jdField_b_of_type_Int + i;
        break label607;
      }
    }
    else
    {
      ...
      for (;;)
      {
        ...
        if ((j == 0) && (axma.b.containsKey(localObject3)))
        {
          localObject4 = (Integer)axma.b.get(localObject3);
  ...
  public static String a(String paramString)
  {
    ...
    Iterator localIterator = axma.a(paramString).iterator();
    while (localIterator.hasNext()) {
      paramString = paramString.replaceAll(((axmc)localIterator.next()).jdField_a_of_type_JavaLangString, "");
    }
    localIterator = axma.a().iterator();
    while (localIterator.hasNext())
    {
  ...
  private static void a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, String paramString)
  {
    ...
    bhhr.e(BaseApplicationImpl.getContext(), paramQQAppInterface.getCurrentUin(), str, paramString);
  }
  ...
  private static void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString)
  {
    ...
    bhhr.a(BaseApplicationImpl.getContext(), paramQQAppInterface.getCurrentUin(), paramString, paramLong);
  }
  
  private static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, int paramInt1, String paramString4, aooq paramaooq, int paramInt2, int paramInt3, long paramLong, String paramString5)
  {
    if (QLog.isColorLevel()) {
    ...
    paramString2 = axlu.a(paramQQAppInterface, paramString5, paramString3);
    paramString3 = paramString3.toString();
    paramString5 = new avhz(paramString5, paramString5, paramString3, 0, paramInt1, paramInt2, bcrg.a());
    ...
    for (((MessageForUniteGrayTip)localObject).tipParam.d = paramString4;; ((MessageForUniteGrayTip)localObject).tipParam.d = (paramString1 + "_reactive_" + paramaooq.b + "_" + paramLong))
    {
      axlu.a(paramQQAppInterface, paramString3, paramString5, paramString2);
      ...
      bdla.b(paramQQAppInterface, "dc00898", "", "", "0X800A1BC", "0X800A1BC", 0, 0, "", "", "", "");
      ...
      bdla.b(paramQQAppInterface, "dc00898", "", "", "0X800A1BE", "0X800A1BE", 1, 0, "", "", "", "");
  ...
  {
    QLog.i("ReactivePushHelper", 1, "decodeC2CMsgPkgSubMsgType0xc7 app:" + paramQQAppInterface + "  changeInfo:" + paramRelationalChainChange + "  msginfo:" + paramaooq);
    ...
    a(paramQQAppInterface, paramRelationalChainChange, str, paramaooq);
  }
  
  private static void a(QQAppInterface paramQQAppInterface, submsgtype0xc7.RelationalChainChange paramRelationalChainChange, String paramString, aooq paramaooq)
  {
    Object localObject;
    ...
    for (;;)
    {
      ...
      {
        if ((!TextUtils.isEmpty((CharSequence)localObject)) && (!axma.a(paramQQAppInterface))) {
          a(paramQQAppInterface, paramString, (String)localObject, paramRelationalChainChange, i, str, paramaooq, 2097155, 0, l, paramString);
        }
  ...
  private static boolean a(QQAppInterface paramQQAppInterface, long paramLong, String paramString)
  {
    ...
    {
      return false;
      l = bhhr.a(BaseApplicationImpl.getContext(), paramQQAppInterface.getCurrentUin(), paramString);
      if (QLog.isColorLevel()) {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, QQMessageFacade.Message paramMessage)
  {
    ...
    catch (Exception paramQQAppInterface)
    {
      ...
      if ((paramQQAppInterface.tipParam != null) && (axma.b(paramQQAppInterface.tipParam.jdField_b_of_type_Int)))
      {
