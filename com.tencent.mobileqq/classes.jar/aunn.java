...
public class aunn
{
  ...
  public aunn(QQAppInterface paramQQAppInterface, long paramLong)
  {
    this(paramQQAppInterface, paramLong, "OnlineDating", "Group");
  }
  
  public aunn(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2)
  {
  ...
  private CommProtocolProto.commRequest a(int paramInt)
  {
    ...
    localcommRequest.network.set(aunr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()));
    ...
    localcommRequest.client_release.set("8.4.8");
  ...
  private void a(int paramInt, CommProtocolProto.commResponse paramcommResponse, Bundle paramBundle, aunq paramaunq)
  {
    ...
    for (paramcommResponse = "null";; paramcommResponse = paramBundle.toString())
    {
      ...
      if (paramaunq != null)
      {
        ...
        paramaunq.a(paramInt, (byte[])localObject, paramBundle);
      }
      return;
    ...
    label287:
    ThreadManager.getUIHandler().post(new ODCsChannel.4(this, paramaunq, paramInt, (byte[])localObject, paramBundle));
  }
  ...
  private void b(int paramInt1, byte[] paramArrayOfByte, boolean paramBoolean, int paramInt2, aunq paramaunq)
  {
    ThreadManagerV2.excute(new ODCsChannel.1(this, paramInt2, paramInt1, paramArrayOfByte, paramBoolean, paramaunq), 128, null, true);
  }
  ...
  private void c(int paramInt1, byte[] paramArrayOfByte, boolean paramBoolean, int paramInt2, aunq paramaunq)
  {
    ...
    nmb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new aunp(this, paramInt2, paramInt1, paramBoolean, paramaunq), localcommRequest.toByteArray(), this.jdField_a_of_type_JavaLangString + "." + localcommRequest.cmd);
  }
  
  public void a(int paramInt1, byte[] paramArrayOfByte, int paramInt2, aunq paramaunq)
  {
    ...
    nmb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new auno(this, paramInt2, paramInt1, paramaunq), localcommRequest.toByteArray(), this.jdField_a_of_type_JavaLangString + "." + 10401);
  }
  
  public void a(int paramInt1, byte[] paramArrayOfByte, boolean paramBoolean, int paramInt2, aunq paramaunq)
  {
    if (this.jdField_a_of_type_AndroidOsBundle == null)
    {
      b(paramInt1, paramArrayOfByte, paramBoolean, paramInt2, paramaunq);
      return;
    }
    if ((this.jdField_a_of_type_ComTencentJungleVideohubProtoCommonUserProto$LoginCheckRsp == null) && (paramBoolean))
    {
      a(paramInt1, paramArrayOfByte, paramInt2, paramaunq);
      return;
    }
    c(paramInt1, paramArrayOfByte, paramBoolean, paramInt2, paramaunq);
  }
  
  public void a(int paramInt, byte[] paramArrayOfByte, boolean paramBoolean, aunq paramaunq)
  {
    a(paramInt, paramArrayOfByte, paramBoolean, 0, paramaunq);
  }
}
