...
public class mrv
{
  private static volatile mrv jdField_a_of_type_Mrv;
  BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new mrw(this);
  Context jdField_a_of_type_AndroidContentContext = null;
  VideoController jdField_a_of_type_ComTencentAvVideoController = null;
  VideoAppInterface jdField_a_of_type_ComTencentAvAppVideoAppInterface = null;
  String jdField_a_of_type_JavaLangString = null;
  List<String> jdField_a_of_type_JavaUtilList = new ArrayList();
  mrx jdField_a_of_type_Mrx = null;
  
  private mrv(VideoAppInterface paramVideoAppInterface)
  {
  ...
  public static mrv a(VideoAppInterface paramVideoAppInterface)
  {
    if (jdField_a_of_type_Mrv == null) {}
    try
    {
      if (jdField_a_of_type_Mrv == null) {
        jdField_a_of_type_Mrv = new mrv(paramVideoAppInterface);
      }
      return jdField_a_of_type_Mrv;
    }
    finally {}
  }
  ...
  public void a(VideoAppInterface paramVideoAppInterface, String paramString)
  {
    ...
    //   0: aload_0
    //   1: monitorenter
    //   2: invokestatic 89	lcx:a	()Llcx;
    //   5: aload_0
    //   6: getfield 34	mrv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   9: invokevirtual 93	lcx:b	(Ljava/lang/String;)Llga;
    //   12: astore_3
    //   13: aload_3
    //   14: ifnonnull +6 -> 20
    //   17: aload_0
    ...
    //   19: return
    //   20: aload_0
    //   21: getfield 32	mrv:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   24: aload_2
    ...
    //   69: ifeq -52 -> 17
    //   72: aload_0
    //   73: getfield 32	mrv:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   76: aload_2
