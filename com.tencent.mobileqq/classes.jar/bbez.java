...
public class bbez
{
  ...
  bbeg jdField_a_of_type_Bbeg = null;
  ...
  public void a(Intent paramIntent)
  {
    ...
    do
    {
      ...
      axrn.a(BaseApplicationImpl.getApplication()).a(null, "jump_act_system_report", true, 0L, 0L, paramIntent, null);
    ...
    return;
    String str;
    if (this.jdField_a_of_type_Bbeg != null)
    {
      str = this.jdField_a_of_type_Bbeg.jdField_b_of_type_JavaLangString;
      paramIntent = this.jdField_a_of_type_Bbeg.jdField_c_of_type_JavaLangString;
    }
    for (;;)
    {
      ...
      axrn.a(BaseApplicationImpl.getApplication()).a(null, "jump_act_business_report", true, 0L, 0L, (HashMap)localObject, null);
  ...
  public void a(QQAppInterface paramQQAppInterface, Activity paramActivity, Intent paramIntent)
  {
        ...
        do
        {
          do
          {
            do
            {
              ...
              Object localObject = bbew.a(paramActivity);
    ...
    this.jdField_a_of_type_Bbeg = bbex.a(paramQQAppInterface, paramActivity, this.g);
  }
