  ...
  implements zac
{
  ...
  public yzx()
  {
    ...
    this.jdField_a_of_type_JavaLangString = amtj.a(2131701416);
    this.jdField_b_of_type_JavaLangString = amtj.a(2131701490);
    this.jdField_c_of_type_JavaLangString = amtj.a(2131701489);
    this.jdField_d_of_type_JavaLangString = amtj.a(2131697419);
    this.jdField_e_of_type_JavaLangString = amtj.a(2131707970);
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (d())
    {
      ...
      if ((StringUtil.isEmpty(this.jdField_f_of_type_JavaLangString)) && ((!paramBoolean2) || (this.jdField_a_of_type_AndroidViewView == null))) {
        break label180;
      }
      bool = true;
  ...
  protected RecyclerView.ViewHolder b(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    return new zaa(this.jdField_a_of_type_ComTencentBizRichframeworkPartBlockBaseRefreshHeaderView);
  }
  ...
  {
    if ((paramViewHolder instanceof yzz))
    {
      paramViewHolder = (yzz)paramViewHolder;
      if (!this.jdField_f_of_type_Boolean)
      {
        yzz.a(paramViewHolder).setVisibility(8);
    ...
    {
      bool = true;
      yzz.a(paramViewHolder).setIndeterminate(bool);
      localProgressBar = yzz.a(paramViewHolder);
      if (!bool) {
        break label146;
      }
    }
    ...
    for (paramInt = 0;; paramInt = 8)
    {
      ...
      yzz.a(paramViewHolder).setVisibility(8);
      yzz.a(paramViewHolder).setVisibility(0);
    ...
    label152:
    yzz.a(paramViewHolder).setVisibility(0);
    yzz.a(paramViewHolder).setText(this.jdField_f_of_type_JavaLangString);
    if (this.jdField_a_of_type_AndroidViewView != null) {
      yzz.a(paramViewHolder).setVisibility(8);
    }
  ...
  {
    paramViewGroup = new yzz(LayoutInflater.from(paramViewGroup.getContext()).inflate(2131560698, paramViewGroup, false));
    if (this.jdField_a_of_type_AndroidViewView != null) {
      yzz.a(paramViewGroup).addView(this.jdField_a_of_type_AndroidViewView);
    }
  ...
  public void onAttachedToRecyclerView(RecyclerView paramRecyclerView)
  {
    ...
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.addOnScrollListener(new yzy(this));
  }
