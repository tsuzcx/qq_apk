...
public class jje
  extends Handler
{
  public jje(QQGAudioCtrl paramQQGAudioCtrl, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      {
        m = paramMessage.what;
        localObject = (jjf)paramMessage.obj;
        label647:
        if (localObject == null)
        {
          if (QLog.isColorLevel()) {
        ...
        {
          paramMessage = ((jjf)localObject).jdField_a_of_type_ArrayOfByte;
          l3 = ((jjf)localObject).jdField_a_of_type_Long;
          l1 = ((jjf)localObject).jdField_b_of_type_Long;
          j = ((jjf)localObject).jdField_a_of_type_Int;
          n = ((jjf)localObject).jdField_b_of_type_Int;
          k = ((jjf)localObject).c;
          i = ((jjf)localObject).d;
                      ...
                      if (j != 10)
                      {
                        ...
                        else
                        {
                          ...
                          else
                          {
                            ...
                            continue;
                            if ((((jjf)localObject).jdField_a_of_type_ArrayOfByte == null) || (((jjf)localObject).jdField_a_of_type_ArrayOfByte.length != 16))
                            {
                              if (QLog.isColorLevel()) {
                            ...
                            {
                              paramMessage = this.a.getAVInfoFromByte(((jjf)localObject).jdField_a_of_type_ArrayOfByte, ((jjf)localObject).jdField_a_of_type_ArrayOfByte.length);
                              if (m != 140) {
                                break label4008;
                              }
                              bool = true;
                              ...
                              continue;
                              l2 = 0L;
                              if ((((jjf)localObject).jdField_a_of_type_ArrayOfByte == null) || (((jjf)localObject).jdField_a_of_type_ArrayOfByte.length != 8))
                              {
                                l1 = l2;
                                if (!QLog.isColorLevel()) {
                                  break label4014;
                              ...
                              {
                                l1 = this.a.getLongFromByte(((jjf)localObject).jdField_a_of_type_ArrayOfByte);
                                break label4014;
                                label1814:
                                if ((((jjf)localObject).jdField_a_of_type_ArrayOfByte == null) || (((jjf)localObject).jdField_a_of_type_ArrayOfByte.length != 8))
                                {
                                ...
                                for (l1 = 0L;; l1 = this.a.getLongFromByte(((jjf)localObject).jdField_a_of_type_ArrayOfByte))
                                {
                                  label1873:
                                  if (QLog.isColorLevel()) {
                                ...
                                i = (int)l3;
                                if ((((jjf)localObject).jdField_a_of_type_ArrayOfByte == null) || (((jjf)localObject).jdField_a_of_type_ArrayOfByte.length != i << 4))
                                {
                                  if (QLog.isColorLevel()) {
                                    QLog.e("QQGAudioCtrl", 2, "eventId = " + m + ", p.detail buf length incorrect ");
                                  }
                                ...
                                {
                                  paramMessage = QQGAudioCtrl.access$100(this.a, ((jjf)localObject).jdField_a_of_type_ArrayOfByte, 16);
                                  if ((paramMessage != null) && (paramMessage.size() == i))
                                  {
                                    ...
                                    else
                                    {
                                      ...
                                      System.arraycopy(((jjf)localObject).jdField_a_of_type_ArrayOfByte, 12, paramMessage, 0, 4);
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        break;
        this.a.mVideoController.a(k, l1, 17, (int)((jjf)localObject).jdField_a_of_type_Long);
        break;
        this.a.mVideoController.a(k, l1, 16, (int)((jjf)localObject).jdField_a_of_type_Long);
        break;
        this.a.mVideoController.a(k, l1, 15, (int)((jjf)localObject).jdField_a_of_type_Long);
        break;
        paramMessage = QQGAudioCtrl.access$000(this.a, paramMessage);
        if (paramMessage == null) {}
        ...
        break;
        i = (int)((jjf)localObject).jdField_a_of_type_Long;
        if (QLog.isColorLevel()) {
