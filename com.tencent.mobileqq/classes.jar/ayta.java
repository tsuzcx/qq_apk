  ...
  extends wma
{
  ...
  public void a(boolean paramBoolean, int paramInt, oidb_0x6d6.DownloadFileRspBody paramDownloadFileRspBody, Bundle paramBundle)
  {
    ...
    {
      aysb.a("TroopFileDownloadWorker", aysb.a, "[" + this.a.jdField_a_of_type_JavaLangString + "] onReqDownloadResult isSuccess:false  errCode:" + paramInt);
    ...
    aysb.c("TroopFileDownloadWorker", aysb.a, "[" + this.a.jdField_a_of_type_JavaLangString + "] onReqDownloadResult isSuccess:true  errCode:" + paramInt + " retCode:" + i);
    if (i < 0) {
      switch (i)
      {
      case -134: 
      ...
      case -102: 
        ...
        this.a.jdField_a_of_type_Ayrn.d = i;
        this.a.c = true;
        this.a.a(true, azle.c, i, 101);
        return;
      case -302: 
      case -301: 
      case -103: 
        ayrl.b(this.a.jdField_b_of_type_Long, this.a.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, 301);
        ...
        this.a.jdField_a_of_type_Ayrn.d = i;
        this.a.c = true;
        this.a.a(true, azle.c, i);
        return;
      }
    }
    this.a.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.cookieValue = bach.a(paramDownloadFileRspBody.bytes_cookie_val.get().toByteArray());
    ...
    this.a.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.DownloadUrl = bach.a(paramDownloadFileRspBody.bytes_download_url.get().toByteArray());
