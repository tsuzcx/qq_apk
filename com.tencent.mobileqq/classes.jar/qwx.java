...
public class qwx
  extends BaseAdapter
{
  private qwx(ComponentPolymericView paramComponentPolymericView) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      i = 1;
      localObject2 = new pwe((Context)localObject1, (ArticleInfo)localObject2, j, k, i, paramInt, false, getCount(), null, ComponentPolymericView.a(this.a).a.a());
      localObject1 = qph.a(paramInt, localObject2, getItemViewType(paramInt), paramView, ComponentPolymericView.a(this.a), ComponentPolymericView.a(this.a).a.a(), ComponentPolymericView.a(this.a).a.a().a());
      if (localObject1 != null)
      {
        ((View)localObject1).setTag(2131380831, localObject2);
        ComponentPolymericView.a(this.a).a.a().a(localBaseArticleInfo, (pvc)localObject2, System.currentTimeMillis(), paramInt);
      }
      ...
      if (((pay.o(localBaseArticleInfo)) || (pay.p(localBaseArticleInfo))) && (!ComponentPolymericView.a(this.a)[paramInt].booleanValue())) {
    ...
    for (;;)
    {
      try
      {
        localObject3 = (rdn)localBaseArticleInfo.mNewPolymericInfo.jdField_a_of_type_JavaUtilList.get(0);
        ((JSONObject)localObject2).put("channel_id", localBaseArticleInfo.mChannelID);
        if (((rdn)localObject3).jdField_a_of_type_Rdo == null) {
          continue;
        }
        paramView = ((rdn)localObject3).jdField_a_of_type_Rdo.a;
        ((JSONObject)localObject2).put("rowkey", paramView);
        if (((rdn)localObject3).jdField_a_of_type_Rdp == null) {
          continue;
        }
        i = ((rdn)localObject3).jdField_a_of_type_Rdp.b;
      ...
      paramView = "1";
      odq.a(null, "CliOper", "", "", "0X8009829", "0X8009829", 0, 0, (String)localObject3, paramView, localBaseArticleInfo.mStrategyId + "", ((JSONObject)localObject2).toString(), false);
      ComponentPolymericView.a(this.a)[paramInt] = Boolean.valueOf(true);
      if ((pay.i(localBaseArticleInfo)) && (localBaseArticleInfo.mPolymericInfo != null)) {
