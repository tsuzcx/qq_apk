  ...
  implements PolymericContainer
{
  ...
  private EventCallback jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewContainerPolymericEventCallback = new qxd(this);
  ...
  {
    QLog.d("RecycleViewAdapterHelper", 1, "addExportItem curPosition: " + paramInt + "  model :" + this.jdField_a_of_type_Qfw);
    ...
    if ((this.jdField_a_of_type_Qfw != null) && (this.jdField_a_of_type_Qfw.a() != null) && (localTemplateBean != null)) {}
    try
    {
      if ((this.jdField_a_of_type_Qfw.a().mGroupSubArticleList != null) && (this.jdField_a_of_type_Qfw.a().mGroupSubArticleList.size() > paramInt) && (pqw.g(this.jdField_a_of_type_Qfw.a())) && (this.jdField_a_of_type_Qfw.a().mNewPolymericInfo.jdField_a_of_type_Boolean)) {
        a((BaseArticleInfo)this.jdField_a_of_type_Qfw.a().mGroupSubArticleList.get(paramInt), paramInt);
      }
      for (;;)
      {
        ...
        {
          return;
          localObject2 = (List)c.get(Long.valueOf(this.jdField_a_of_type_Qfw.a().mArticleID));
          localObject1 = localObject2;
          if (localObject2 == null)
          {
            localObject1 = new ArrayList();
            c.put(Long.valueOf(this.jdField_a_of_type_Qfw.a().mArticleID), localObject1);
          }
        } while (paramInt < ((List)localObject1).size());
        Object localObject2 = this.jdField_a_of_type_Qfw.a().clone();
  ...
  private void a(BaseArticleInfo paramBaseArticleInfo, int paramInt)
  {
    ...
    {
      localObject = this.jdField_a_of_type_Qfw.a().getContext();
    ...
    for (int i = 1;; i = 0)
    {
      localObject = new qhk((Context)localObject, localArticleInfo, j, k, i, paramInt, false, a(), null, this.jdField_a_of_type_Qfw.a());
      this.jdField_a_of_type_Qfw.a().a(paramBaseArticleInfo, (qfw)localObject, System.currentTimeMillis(), paramInt);
      return;
    }
  }
  ...
  {
    if ((this.jdField_a_of_type_Ujy != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext != null)) {
      this.jdField_a_of_type_Ujy.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext.getContext(), this.jdField_a_of_type_Qfw, paramInt, 2);
    }
  }
  
  private void b(qfw paramqfw)
  {
    if ((this.jdField_a_of_type_Qfw != null) && (this.jdField_a_of_type_Qfw != paramqfw) && (this.jdField_a_of_type_Qfw.a() != null) && (this.jdField_a_of_type_Qfw.a().getId() != paramqfw.a().getId()) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView != null)) {
  ...
  public void a(qfw paramqfw)
  {
    ...
    } while (this.jdField_a_of_type_Qfw.a() == null);
    a(this.jdField_a_of_type_Qfw.a().mGroupSubArticleList);
  }
  ...
  public void a(qxg paramqxg)
  {
    this.jdField_a_of_type_Qxg = paramqxg;
  ...
  public void onBindViewHolder(RecyclerView.ViewHolder paramViewHolder, int paramInt)
  {
    int i = a(paramInt);
    Object localObject1;
    if ((paramViewHolder instanceof qxh))
    {
    ...
    for (;;)
    {
      ...
      a(i);
      b(i);
      Object localObject2 = (qxh)paramViewHolder;
      Container localContainer = (Container)((qxh)localObject2).itemView;
      BindDataUtil.bindDynamicValueWithoutRecursion(localContainer, ((qxh)localObject2).a, (TemplateBean)localObject1);
      ...
      ViewFactory.findClickableViewListener(((Container)((qxh)localObject2).itemView).getVirtualView(), new qwy(this, i, (TemplateBean)localObject1));
      continue;
      if ((paramViewHolder instanceof qxe))
      {
        localObject1 = (qxe)paramViewHolder;
        localObject2 = ((qxe)localObject1).itemView.getLayoutParams();
        if (localObject2 != null)
        {
          ((ViewGroup.LayoutParams)localObject2).width = 0;
          ((ViewGroup.LayoutParams)localObject2).height = 0;
          ((qxe)localObject1).itemView.setLayoutParams((ViewGroup.LayoutParams)localObject2);
        }
      }
    }
  }
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    if (localObject == null)
    {
      ...
      usp.a("error", "", paramViewGroup);
      a(new RecycleViewAdapterHelper.2(this));
      return new qxe(this, a());
    }
    ...
    return new qxh(this, (Container)localObject, null);
  }
