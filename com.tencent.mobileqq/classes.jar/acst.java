...
public class acst
{
  ...
  private URLDrawable a(Context paramContext, String paramString)
  {
    ...
    localURLDrawableOptions.mLoadingDrawable = paramContext.getDrawable(2130845496);
    localURLDrawableOptions.mFailedDrawable = paramContext.getDrawable(2130845496);
    paramString = URLDrawable.getDrawable(paramString, localURLDrawableOptions);
    int i = agej.a(50.0F, paramContext);
    paramString.setTag(bhez.b(i, i, agej.a(12.0F, paramContext)));
    paramString.setDecodeHandler(bhez.c);
    return paramString;
  }
  
  private boolean a(acsg paramacsg)
  {
    paramacsg = paramacsg.a();
    return (paramacsg.productType == 12) || (paramacsg.productType == 19);
  }
  ...
  public Drawable a(Context paramContext, GdtMotiveVideoPageData paramGdtMotiveVideoPageData)
  {
    if ((paramGdtMotiveVideoPageData == null) || (TextUtils.isEmpty(paramGdtMotiveVideoPageData.bannerLogo))) {
      return paramContext.getResources().getDrawable(2130845496);
    }
  ...
  public String a(Context paramContext, acsg paramacsg)
  {
    ...
    if (localObject != null)
    {
      ...
      if (!((qq_ad_get.QQAdGetRsp.AdInfo)localObject).display_info.button_info.get().isEmpty())
      {
        ...
        {
          str1 = str2;
          if (nzq.a(paramContext, (String)localObject))
          {
      ...
      try
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject3))
        {
          ...
          if (!TextUtils.isEmpty(paramString))
          {
            ...
            paramWebView.evaluateJavascript(((StringBuffer)localObject1).toString(), new acsu(this));
            return;
          }
        }
      }
