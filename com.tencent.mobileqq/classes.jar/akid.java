...
public class akid
  extends akhx
{
  private static final int[] jdField_a_of_type_ArrayOfInt = { 2131693300 };
  private static final int[] jdField_b_of_type_ArrayOfInt = { 2130839329 };
  private static final int[] c = { 2131370195 };
  private almv jdField_a_of_type_Almv;
  private int jdField_b_of_type_Int;
  
  public akid(QQAppInterface paramQQAppInterface, Context paramContext, awbv paramawbv, int paramInt)
  {
  ...
  {
    Object localObject;
    if ((paramView == null) || (!(paramView.getTag() instanceof akie)))
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559029, null);
      paramViewGroup = new akie();
      paramView = this.jdField_a_of_type_Bhxa.a(this.jdField_a_of_type_AndroidContentContext, paramView, paramViewGroup, -1);
      ...
      ((RelativeLayout.LayoutParams)paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.getLayoutParams()).leftMargin = aekt.a(12.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      paramViewGroup.b = ((TextView)paramView.findViewById(2131377555));
      paramView.setTag(paramViewGroup);
      paramViewGroup.g.setBackgroundResource(2130839216);
      if (this.jdField_b_of_type_Int != 2) {
        break label279;
      }
      localObject = (DiscussionInfo)this.jdField_a_of_type_Awbv;
      ...
      paramViewGroup.b.setText(String.format("(%d)", new Object[] { Integer.valueOf(this.jdField_a_of_type_Almv.a(((DiscussionInfo)localObject).uin)) }));
    }
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = (akie)paramView.getTag();
      break;
      label279:
      localObject = (TroopInfo)this.jdField_a_of_type_Awbv;
