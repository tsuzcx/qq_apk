  ...
  extends BaseAdapter
{
  ...
  private ArrayList<bhfu> jdField_a_of_type_JavaUtilArrayList = this.jdField_a_of_type_ComTencentMobileqqActivityPhoneCountryActivity.jdField_a_of_type_JavaUtilArrayList;
  
  private akid(CountryActivity paramCountryActivity) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      CountryActivity.a(paramView, (bhfu)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt));
