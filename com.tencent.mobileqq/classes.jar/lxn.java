  ...
  extends ajxl
{
  ...
  protected void onUpdateCustomHead(boolean paramBoolean, String paramString)
  {
    ...
    if (this.a.b()) {
      localQQAppInterface.removeObserver(this.a.jdField_a_of_type_Ajxl);
    }
  }
  ...
  protected void onUpdateFriendInfo(String paramString, boolean paramBoolean)
  {
    ...
    if ((paramBoolean) && (paramString != null))
    {
      ...
      localIntent.putExtra("uin", paramString);
      localObject = (ajxn)QQServiceForAV.m(this.a).getManager(51);
      if (localObject == null) {
        break label205;
      }
    ...
    label205:
    for (Object localObject = bbcl.a((Friends)localObject);; localObject = paramString)
    {
