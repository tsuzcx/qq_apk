...
public class bggs
{
  private static volatile bggs jdField_a_of_type_Bggs;
  ...
  private Vector<bggu> jdField_a_of_type_JavaUtilVector = new Vector();
  ...
  public static bggs a()
  {
    if (jdField_a_of_type_Bggs == null) {}
    try
    {
      if (jdField_a_of_type_Bggs == null) {
        jdField_a_of_type_Bggs = new bggs();
      }
      return jdField_a_of_type_Bggs;
    }
    finally {}
  }
  ...
  private void a()
  {
    ...
    if (Build.VERSION.SDK_INT > 16)
    {
      if (this.jdField_a_of_type_AndroidViewChoreographer$FrameCallback == null) {
        this.jdField_a_of_type_AndroidViewChoreographer$FrameCallback = new bggt(this);
      }
  ...
  private void a(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          ((bggu)this.jdField_a_of_type_JavaUtilVector.get(i)).onInfo(this.jdField_a_of_type_Long, d);
          i += 1;
        }
      }
      finally {}
  ...
  public void a(bggu parambggu)
  {
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      if (!this.jdField_a_of_type_JavaUtilVector.contains(parambggu)) {
        this.jdField_a_of_type_JavaUtilVector.add(parambggu);
      }
  ...
  public void b(bggu parambggu)
  {
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      if (this.jdField_a_of_type_JavaUtilVector.contains(parambggu)) {
        this.jdField_a_of_type_JavaUtilVector.remove(parambggu);
      }
      if (this.jdField_a_of_type_JavaUtilVector.size() <= 0) {
        b();
      }
