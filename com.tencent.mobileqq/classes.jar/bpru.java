...
public class bpru
{
  ...
  public int a(int paramInt)
  {
    ...
    paramInt = agej.a(100.0F, BaseApplicationImpl.getApplication().getResources());
    for (;;)
    {
      localTextPaint.setTextSize(paramInt);
      StaticLayout localStaticLayout = bptt.a(localStringBuilder, 0, localStringBuilder.length(), localTextPaint, this.c, Layout.Alignment.ALIGN_NORMAL, 1.0F, 0.0F, false, null, 0, 1);
