...
{
  public aocr(QQAppInterface paramQQAppInterface)
  {
  ...
  protected String a(MarkFaceMessage paramMarkFaceMessage)
  {
    ...
    return asdi.a(paramMarkFaceMessage.sbufID, paramMarkFaceMessage.mediaType);
  }
  ...
  protected void a(List<String> paramList, MarkFaceMessage paramMarkFaceMessage, String paramString1, String paramString2)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        paramMarkFaceMessage = ((awyr)this.app.getManager(QQManagerFactory.EMOTICON_MANAGER)).a(paramString2, paramString1);
        if (paramMarkFaceMessage != null) {
  ...
  public void b(ChatMessage paramChatMessage, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      paramChatMessage.str_client_ver.set("8.4.10");
      ...
      {
        localObject1 = ((anvk)localObject1).b(this.app.getCurrentAccountUin());
        if (localObject1 != null) {
