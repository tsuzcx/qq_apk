  ...
  extends anyc
{
  ...
  public static List<anyc> a(int[] paramArrayOfInt)
  {
    ...
    {
      aocr localaocr = new aocr();
      localaocr.jdField_a_of_type_Int = paramArrayOfInt[i];
      localaocr.jdField_c_of_type_Int = 1;
      localArrayList.add(localaocr);
      i += 1;
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (j < m)
        {
          ...
          if ((n < 0) || (n >= ayjw.jdField_a_of_type_Int)) {
            break label218;
          }
          int k = i + 1;
          paramAppRuntime[i] = n;
  ...
  {
    return ayla.a(this.jdField_a_of_type_Int, false);
  }
  
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, EditText paramEditText, SessionInfo paramSessionInfo)
  {
    if (this.d == 1) {
      axqw.b(null, "CliOper", "", "", "0X8005507", "0X8005507", 0, 0, "", "", "", "");
    }
    for (;;)
    {
      int i = paramEditText.getSelectionStart();
      int j = paramEditText.getSelectionEnd();
      paramEditText.getEditableText().replace(i, j, ayla.c(this.jdField_a_of_type_Int));
      paramEditText.requestFocus();
      return;
      if (this.d == 2) {
        axqw.b(null, "CliOper", "", "", "0X8005508", "0X8005508", 0, 0, "", "", "", "");
      }
    }
  }
  ...
  {
    return ayla.a(this.jdField_a_of_type_Int, true);
  }
}
