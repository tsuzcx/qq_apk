...
public abstract class ugb<T>
{
  ...
  private String a(long[] paramArrayOfLong, List<List<List<T>>> paramList, List<List<T>> paramList1)
  {
    ...
    wsv.d("Q.qqstory.recommendAlbum.logic.StoryScanManager.K_means", "kmeans run k=" + paramList1.size() + " sse : " + paramArrayOfLong + " temp=" + Arrays.toString(arrayOfString));
    paramList1 = "(k=" + paramList1.size() + " " + paramArrayOfLong + ");";
    paramArrayOfLong = (String)((urk)urr.a(10)).b("key_album_debug_sse", "");
  ...
  private List<T> a(List<List<T>> paramList)
  {
    ...
    if (i < paramList.size())
    {
      ...
      for (;;)
      {
        i += 1;
        break;
        wsv.e("Q.qqstory.recommendAlbum.logic.StoryScanManager.kmeans", "点位置相同时，有空的堆出现");
      }
    }
