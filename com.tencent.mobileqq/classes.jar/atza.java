...
public class atza
  extends aqxa
  implements ajfe, arzq
{
  public static int j = 3;
  private long jdField_a_of_type_Long;
  private atzc jdField_a_of_type_Atzc;
  ...
  public atza(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_Aqwy.jdField_b_of_type_Boolean = true;
    paramQQAppInterface.removeObserver(this.jdField_a_of_type_Aqvp);
  }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    axlp.a().a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout, paramString, j);
  ...
  {
    new batt("VIP.ProfileMusicBoxServer.ProfileMusicBoxObj", "ProfileMusicBox.getMusicList").a("getMusicList", new GetMusicListReq(paramLong, "", 100L, new SourceInfo(3, "8.2.6"), 0), new GetMusicListRsp(), this, false);
  }
  ...
  {
    new batt("VIP.ProfileMusicBoxServer.ProfileMusicBoxObj", "ProfileMusicBox.getQzoneMusicInfo").a("getQzoneMusicInfo", new GetQzoneMusicInfoReq(paramLong, paramArrayList, new SourceInfo(3, "8.2.6")), new GetQzoneMusicInfoRsp(), new atzb(this), false);
  }
  ...
  public void a(Context paramContext, SongInfo paramSongInfo)
  {
    ...
    {
      return;
      new Intent(paramContext, QQBrowserActivity.class).putExtra("url", befm.a(amjm.a().jdField_b_of_type_JavaLangString, "uin", String.valueOf(this.jdField_a_of_type_Long)));
  ...
  public void a(atzc paramatzc)
  {
    this.jdField_a_of_type_Atzc = paramatzc;
  }
  ...
  public void a(SongInfo paramSongInfo)
  {
    ...
    this.jdField_a_of_type_Aqwy.jdField_a_of_type_JavaLangString = paramSongInfo.jdField_d_of_type_JavaLangString;
    if (a()) {
  ...
  public void a(String paramString)
  {
    ...
    if (localaqxa != null)
    {
      this.jdField_a_of_type_Aqwy.jdField_a_of_type_Int = localaqxa.a().jdField_a_of_type_Int;
      this.jdField_a_of_type_Aqwy.jdField_b_of_type_Int = localaqxa.a().jdField_b_of_type_Int;
      this.jdField_a_of_type_Aqwy.jdField_a_of_type_Boolean = localaqxa.a().jdField_a_of_type_Boolean;
      if (localaqxa.a()) {
        localaqxa.b(localaqxa.a().e, localaqxa.a().jdField_b_of_type_JavaLangString);
      }
    }
    if (QLog.isColorLevel()) {
      QLog.d("ProfileMusicBoxController", 2, "showLyrics");
    }
    if ((TextUtils.isEmpty(paramString)) && (!TextUtils.isEmpty(this.jdField_a_of_type_Aqwy.jdField_b_of_type_JavaLangString)))
    {
      super.a(j, this.jdField_a_of_type_Aqwy.jdField_b_of_type_JavaLangString);
      return;
    }
  ...
  public void c()
  {
    atyz.b(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.getContext(), this.jdField_a_of_type_Aqwy.jdField_b_of_type_JavaLangString);
    String str;
    if (this.i)
    {
      str = "";
    ...
    for (int k = 1;; k = 2)
    {
      awqx.b(null, "dc00898", "", str, "qq_vip", "0X800A7DF", k, 0, "", "", "", "");
      return;
  ...
  public void d()
  {
    ...
    for (int k = 1;; k = 2)
    {
      awqx.b(null, "dc00898", "", str, "qq_vip", "0X800A7E0", k, 0, "", "", "", "");
      return;
      str = String.valueOf(this.jdField_a_of_type_Long);
      break;
    }
  ...
  public void e()
  {
    ...
    this.jdField_a_of_type_Atzc = null;
    super.e();
    axlp.a().b();
  }
  ...
  public void j()
  {
    super.b(j, this.jdField_a_of_type_Aqwy.jdField_b_of_type_JavaLangString);
    this.jdField_a_of_type_Aqwy.e = 0;
    b(j, this.jdField_a_of_type_Aqwy.jdField_b_of_type_JavaLangString, true);
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      aqxa localaqxa = ListenTogetherManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a();
      if (localaqxa != null)
      {
        localaqxa.a().jdField_a_of_type_Int = this.jdField_a_of_type_Aqwy.jdField_a_of_type_Int;
        localaqxa.a().jdField_b_of_type_Int = this.jdField_a_of_type_Aqwy.jdField_b_of_type_Int;
        localaqxa.a().jdField_a_of_type_Boolean = this.jdField_a_of_type_Aqwy.jdField_a_of_type_Boolean;
      }
      if (QLog.isColorLevel()) {
  ...
  public void m()
  {
    ...
    if ((localaqxa != null) && (!ListenTogetherManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b())) {
      localJSONObject = new JSONObject();
    }
    try
    {
      localJSONObject.put("type", "musicboxResume");
      localJSONObject.put("uin", localaqxa.a().jdField_b_of_type_JavaLangString);
      localJSONObject.put("uinType", localaqxa.a().e);
  ...
  public void onPlaySongChanged(SongInfo paramSongInfo)
  {
    ...
    {
      if (this.jdField_a_of_type_Atzc != null) {
        this.jdField_a_of_type_Atzc.a(paramSongInfo, this.h);
      }
      n();
      if (QLog.isColorLevel()) {
  ...
  public void onPlayStateChanged(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        if (this.jdField_a_of_type_Atzc != null) {
          this.jdField_a_of_type_Atzc.a((SongInfo)localObject, true);
        }
      ...
      else
      {
        ...
        continue;
        if (this.jdField_a_of_type_Atzc != null) {
          this.jdField_a_of_type_Atzc.a(2);
        }
        d(false);
        this.h = false;
        ...
        for (;;)
        {
          awqx.b(null, "dc00898", "", String.valueOf(l), "qq_vip", (String)localObject, k, 0, String.valueOf((System.currentTimeMillis() - this.jdField_b_of_type_Long) / 1000L), "", "", "");
          break;
