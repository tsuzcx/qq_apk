...
public class jpj
  extends TimerTask
{
  public jpj(SmallScreenVideoController paramSmallScreenVideoController) {}
  ...
  public void run()
  {
    ...
    this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.runOnUiThread(new jpk(this, l2, l1));
  }
}
