...
public class kxx
{
  public static boolean a()
  {
    ...
    label132:
    long l;
    if ((!awlw.g()) || (AIManager.installDetector(PTSegmenter.class, (String)localObject2, (String)localObject1)))
    {
      bool1 = true;
      bool2 = kya.a().a();
      boolean bool4 = kxy.a();
    ...
    {
      localObject2 = (kxz)((Iterator)localObject1).next();
      if (localObject2 != null)
      {
        if (QLog.isColorLevel()) {
          QLog.d("PanoramaAccessManager", 2, "checkPanoramaAccessEnable CPUinfo = " + ((kxz)localObject2).b + "|" + ((kxz)localObject2).a);
        }
        if ((bool1) || (lfi.a(((kxz)localObject2).b, ((kxz)localObject2).a * 10000, l * 100000000L))) {}
