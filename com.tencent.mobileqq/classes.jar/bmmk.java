  ...
  extends bmmw
{
  ...
  public bmmn a;
  public bmtw a;
  public ArrayList<bmmn> a;
  private Paint jdField_b_of_type_AndroidGraphicsPaint;
  bmmn jdField_b_of_type_Bmmn;
  public int g;
  public int h;
  public int i;
  public int j = c;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bmmk.class.getSimpleName();
    jdField_b_of_type_Int = bnao.a[1];
    c = Color.parseColor("#80000000");
    e = 270;
    f = 5;
  }
  
  public bmmk(DoodleView paramDoodleView)
  {
  ...
  /* Error */
  private String a(String paramString, bmmn parambmmn)
  {
    // Byte code:
    //   0: aload_1
    ...
    //   14: areturn
    //   15: aload_0
    //   16: invokevirtual 111	bmmk:c	()I
    //   19: aload_0
    //   20: invokevirtual 113	bmmk:d	()I
    ...
    //   50: aload 6
    //   52: aload_0
    //   53: getfield 132	bmmk:jdField_a_of_type_Bmtw	Lbmtw;
    //   56: aload_2
    //   57: invokevirtual 137	bmtw:a	(Lbmtx;)Landroid/graphics/Matrix;
    //   60: invokevirtual 141	android/graphics/Canvas:concat	(Landroid/graphics/Matrix;)V
    //   63: aload 4
    //   65: astore 5
    //   67: aload_2
    //   68: getfield 146	bmmn:jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem	Ldov/com/qq/im/capture/text/DynamicTextItem;
    //   71: aload 6
    ...
    //   80: aload_1
    //   81: ldc 153
    //   83: invokestatic 156	bmmk:a	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   86: astore_1
    //   87: aload 4
    //   89: astore 5
    //   91: aload_0
    ...
    //   97: bipush 100
    //   99: aload_1
    //   100: invokevirtual 165	bmmk:a	(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap$CompressFormat;ILjava/lang/String;)Z
    //   103: istore_3
    //   104: aload 4
    //   106: astore 5
    //   108: getstatic 42	bmmk:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   154: invokestatic 193	wsv:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   157: iload_3
    //   158: ifne +23 -> 181
    //   161: aload 4
    //   163: ifnull +16 -> 179
    ...
    //   211: aload 4
    //   213: astore 5
    //   215: getstatic 42	bmmk:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   218: ldc 202
    //   220: aload_2
    //   221: invokestatic 205	wsv:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   224: aload_1
    //   225: astore_2
    //   226: aload 4
    //   228: ifnull -215 -> 13
  ...
  private void a(bmmn parambmmn)
  {
    boolean bool1 = this.jdField_a_of_type_Bmtw.a(parambmmn, StoryGuideLineView.jdField_a_of_type_Int, true);
    boolean bool2 = this.jdField_a_of_type_Bmtw.a(parambmmn, StoryGuideLineView.jdField_b_of_type_Int, false);
    boolean bool3 = this.jdField_a_of_type_Bmtw.b(parambmmn, StoryGuideLineView.d, false);
    if (this.jdField_a_of_type_Bmml != null) {
      this.jdField_a_of_type_Bmml.a(bool1, bool2, false, bool3, parambmmn.l);
    }
    if (parambmmn != null)
    {
      if (parambmmn.k) {
        this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.a(parambmmn.l, parambmmn.r, parambmmn.s, parambmmn.t, parambmmn.jdField_b_of_type_AndroidGraphicsPointF, parambmmn.m, 2);
      }
    }
    else {
      return;
    }
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.a(parambmmn.l, parambmmn.r, parambmmn.s, parambmmn.t, parambmmn.jdField_b_of_type_AndroidGraphicsPointF, parambmmn.m, 1);
  }
  ...
  private boolean e()
  {
    ...
    wsv.b(jdField_a_of_type_JavaLangString, "isRubbish:" + bool + " brand:" + str);
    return bool;
  }
  
  private void o()
  {
    this.k = aekt.a(50.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.i = bmtu.a(this.jdField_a_of_type_AndroidContentContext);
    this.h = 1;
    this.g = 1;
  ...
  public Bundle a()
  {
    ...
    {
      localArrayList.add(new TextParcelData((bmmn)this.jdField_a_of_type_JavaUtilArrayList.get(i1)));
      i1 += 1;
    }
  ...
  public bmmn a()
  {
    ...
    {
      this.jdField_a_of_type_JavaUtilArrayList.remove(this.jdField_a_of_type_Bmmn);
      return this.jdField_a_of_type_Bmmn;
    }
    return null;
  }
  ...
  {
    if (this.jdField_a_of_type_Bmmn != null) {
      return this.jdField_a_of_type_Bmmn.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem;
    }
    return null;
  }
  ...
  public DynamicTextItem a(bmmm parambmmm, SegmentKeeper paramSegmentKeeper, int paramInt)
  {
    ...
    label87:
    for (parambmmm = new bmmn(this, parambmmm);; parambmmm = new bmmn(this))
    {
      parambmmm.jdField_a_of_type_Int = paramInt;
      parambmmm.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper = new SegmentKeeper(paramSegmentKeeper);
      if (parambmmm.jdField_a_of_type_Int == 0) {
        SegmentKeeper.adjustTime(-1L * System.currentTimeMillis());
      }
      this.jdField_a_of_type_JavaUtilArrayList.add(parambmmm);
      localDynamicTextItem = parambmmm.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem;
      this.jdField_a_of_type_Bmmn = parambmmm;
  ...
  public ArrayList<TrackerStickerParam> a(String paramString)
  {
    ...
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0))
    {
      ...
      {
        bmmn localbmmn = (bmmn)localIterator.next();
        if ((localbmmn.c()) || (localbmmn.d()))
        {
          Object localObject = a(paramString, localbmmn);
          localObject = new TrackerStickerParam(c() / 2, d() / 2, 1.0F, 0.0F, 0.0F, 0.0F, c(), d(), c(), d(), (String)localObject, localbmmn.jdField_a_of_type_JavaUtilMap);
          ((TrackerStickerParam)localObject).setSegmentList(localbmmn.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper.getSegmentList());
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Bmmn = null;
  ...
  public void a(int paramInt)
  {
    ...
    {
      bmmn localbmmn = (bmmn)localIterator.next();
      if (localbmmn.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper != null) {
        localbmmn.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper.setMode(paramInt);
      }
    }
  }
  ...
  protected void a(Canvas paramCanvas)
  {
    ...
    if (this.g == 6)
    {
      if (this.jdField_b_of_type_Bmmn != null) {
        this.jdField_b_of_type_Bmmn.a(paramCanvas);
      }
      localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
      while (localIterator.hasNext())
      {
        localbmmn = (bmmn)localIterator.next();
        if ((this.jdField_b_of_type_Bmmn != null) && (localbmmn.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem != this.jdField_b_of_type_Bmmn.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem)) {
          localbmmn.a(paramCanvas);
        }
      }
    }
    ...
    while (localIterator.hasNext())
    {
      ((bmmn)localIterator.next()).a(paramCanvas);
      continue;
      if (this.g == 5)
      {
        localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
        ...
        {
          localbmmn = (bmmn)localIterator.next();
          if (localbmmn.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem != this.jdField_a_of_type_Bmmn.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem) {
            localbmmn.a(paramCanvas);
          }
        }
      }
  ...
  public void a(Canvas paramCanvas, float paramFloat, boolean paramBoolean)
  {
    ...
    {
      bmmn localbmmn = (bmmn)localIterator.next();
      if (((!localbmmn.c()) && (!localbmmn.d())) || (paramBoolean)) {
        localbmmn.a(paramCanvas);
      }
    }
    paramCanvas.restore();
  ...
  public void a(DynamicTextItem paramDynamicTextItem)
  {
    ...
    if ((paramDynamicTextItem != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0))
    {
      ...
      {
        bmmn localbmmn = (bmmn)localIterator.next();
        if (!paramDynamicTextItem.equals(localbmmn.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem)) {
          break label72;
        }
        localObject = localbmmn;
      }
    }
    label72:
    for (;;)
  ...
  public void a(ArrayList<TextParcelData> paramArrayList, boolean paramBoolean)
  {
    if ((paramArrayList != null) && (!paramArrayList.isEmpty()))
    {
      ...
      do
      {
        ...
        bmmn localbmmn = ((TextParcelData)paramArrayList.next()).a(this);
        if (!paramBoolean)
        {
          localbmmn.c(true);
          localbmmn.jdField_a_of_type_Int = 1;
        }
        this.jdField_a_of_type_JavaUtilArrayList.add(localbmmn);
  ...
  {
    wsv.b(jdField_a_of_type_JavaLangString, "setKeyboardState:" + paramBoolean);
    if (paramBoolean) {}
    for (;;)
    {
      super.k();
  ...
  public boolean a(long paramLong)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (localIterator.hasNext()) {
      if (((bmmn)localIterator.next()).jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper.isSegmentChanged(paramLong)) {
        return false;
      }
    }
    return true;
  ...
  public boolean a(android.graphics.Bitmap paramBitmap, android.graphics.Bitmap.CompressFormat paramCompressFormat, int paramInt, String paramString)
  {
    ...
    //   0: iconst_0
    //   1: istore 5
    //   3: getstatic 42	bmmk:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   27: invokestatic 193	wsv:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   30: aload_1
    //   31: ifnonnull +15 -> 46
    //   34: getstatic 42	bmmk:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   37: ldc_w 584
    //   40: invokestatic 193	wsv:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   43: iload 5
    //   45: ireturn
    //   46: aconst_null
    //   47: astore 8
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      bool = true;
      return bool;
      this.jdField_a_of_type_Bmtw.a(this.jdField_a_of_type_Bmmn);
      j();
      this.jdField_a_of_type_Bmmn.b();
      this.l = i1;
      break;
      this.jdField_a_of_type_Bmmn.c();
      break;
      if (this.g == 3) {
        this.jdField_a_of_type_Bmmn.c();
      }
  ...
  public boolean a(JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      while (((Iterator)localObject).hasNext()) {
        localJSONArray.put(new TextParcelData((bmmn)((Iterator)localObject).next()).a());
      }
  ...
  {
    wsv.b(jdField_a_of_type_JavaLangString, "setMode:" + paramInt + ",preMode:" + this.h);
    this.h = this.g;
    this.g = paramInt;
    if (paramInt == 4) {
      n();
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    {
      wsv.e(jdField_a_of_type_JavaLangString, "setTextOffset x:" + paramInt1 + "y=" + paramInt2);
      return;
    }
    wsv.b(jdField_a_of_type_JavaLangString, "setTextTop:" + paramInt1 + "y=" + paramInt2);
    this.n = paramInt1;
    this.o = paramInt2;
  }
  ...
  public void b(DynamicTextItem paramDynamicTextItem)
  {
    if (this.jdField_a_of_type_Bmmn != null)
    {
      this.jdField_a_of_type_Bmmn.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem = paramDynamicTextItem;
      this.jdField_a_of_type_Bmmn.u = paramDynamicTextItem.a();
      this.jdField_a_of_type_Bmmn.v = paramDynamicTextItem.b();
    }
    if (this.jdField_b_of_type_Bmmn != null)
    {
      this.jdField_b_of_type_Bmmn.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem = paramDynamicTextItem;
      if (this.jdField_a_of_type_Bmmn != null)
      {
        this.jdField_b_of_type_Bmmn.q = this.jdField_a_of_type_Bmmn.q;
        this.jdField_b_of_type_Bmmn.jdField_b_of_type_Float = this.jdField_a_of_type_Bmmn.q;
      }
    }
  }
  ...
  public boolean b(MotionEvent paramMotionEvent)
  {
    if (b())
    {
      ...
      if (i1 >= 0)
      {
        paramMotionEvent = (bmmn)this.jdField_a_of_type_JavaUtilArrayList.get(i1);
        ...
        while (!this.jdField_a_of_type_Bmtw.a(paramMotionEvent, f1, f2, false))
        {
          i1 -= 1;
          break;
        }
        this.jdField_a_of_type_Bmmn = paramMotionEvent;
      }
    }
    for (boolean bool = true;; bool = false)
    {
      ...
      {
        this.jdField_a_of_type_JavaUtilArrayList.remove(this.jdField_a_of_type_Bmmn);
        this.jdField_a_of_type_JavaUtilArrayList.add(this.jdField_a_of_type_Bmmn);
      }
      return bool;
    }
  }
  ...
  public void c()
  {
    if ((this.jdField_a_of_type_Bmml != null) && (this.jdField_a_of_type_Bmmn != null))
    {
      if (this.jdField_a_of_type_Bmml.a(this.jdField_a_of_type_Bmmn)) {
        this.jdField_a_of_type_JavaUtilArrayList.remove(this.jdField_a_of_type_Bmmn);
      }
    }
    else {
    ...
    this.jdField_a_of_type_Bmml.a(this.jdField_a_of_type_Bmmn.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem);
  }
  ...
  public void c(int paramInt)
  {
    if (paramInt < 0)
    {
      wsv.e(jdField_a_of_type_JavaLangString, "setTextTop:" + paramInt);
      return;
    }
    wsv.b(jdField_a_of_type_JavaLangString, "setTextTop:" + paramInt);
    this.m = paramInt;
  }
  ...
  public void d()
  {
    if (!a())
    {
      ...
      if (this.jdField_a_of_type_Bmmn != null)
      {
        this.jdField_b_of_type_Bmmn = new bmmn(this, this.jdField_a_of_type_Bmmn);
        this.jdField_b_of_type_Bmmn.a();
        bmmn.a(this.jdField_b_of_type_Bmmn);
      }
    }
    while (this.jdField_a_of_type_Bmml == null) {
      return;
    }
    this.jdField_a_of_type_Bmml.a(1.0F);
  }
  ...
  public void f()
  {
    ...
    if (this.jdField_a_of_type_JavaUtilArrayList.size() > 0)
    {
      ...
      {
        bmmn localbmmn = (bmmn)((Iterator)localObject2).next();
        if ((localbmmn.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem != null) && (localbmmn.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.e())) {
          ((List)localObject1).add(localbmmn);
        }
      }
    }
    ...
    {
      localObject2 = (bmmn)((Iterator)localObject1).next();
      this.jdField_a_of_type_JavaUtilArrayList.remove(localObject2);
    }
    if ((this.jdField_a_of_type_Bmmn != null) && (this.jdField_a_of_type_Bmmn.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem != null) && (this.jdField_a_of_type_Bmmn.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.e())) {
      this.jdField_a_of_type_Bmmn = null;
    }
  }
  ...
  public void g()
  {
    ...
    {
      b(6);
      bmmn.b(this.jdField_b_of_type_Bmmn);
    }
  }
  ...
  public void h()
  {
    if (this.jdField_a_of_type_Bmmn != null)
    {
      this.jdField_a_of_type_JavaUtilArrayList.remove(this.jdField_a_of_type_Bmmn);
      this.jdField_a_of_type_Bmmn.c();
      wsv.b(jdField_a_of_type_JavaLangString, "delete " + this.jdField_a_of_type_Bmmn);
      this.jdField_a_of_type_Bmmn = null;
    }
    if (this.jdField_a_of_type_JavaUtilArrayList.size() == 0)
    {
  ...
  public void i()
  {
    if ((this.jdField_a_of_type_Bmmn != null) && (this.jdField_a_of_type_Bmmn.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem != null)) {
      this.jdField_a_of_type_Bmmn.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.a(-1, false);
    }
    if (this.jdField_a_of_type_JavaUtilArrayList != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (localbmmn.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem != null) {
          localbmmn.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.a(-1, false);
        }
      }
    }
    k();
  ...
  public void j()
  {
    if ((this.jdField_a_of_type_Bmmn != null) && (!this.jdField_a_of_type_Bmmn.a())) {
      this.jdField_a_of_type_Bmmn.d();
    }
  }
}
