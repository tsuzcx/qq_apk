...
public class alkx
{
  ...
  public alkx(String paramString1, String paramString2)
  {
    this.b = paramString1;
    this.a = paramString2;
  }
  ...
  public static boolean a(byte[] paramArrayOfByte1, String paramString, byte[] paramArrayOfByte2)
  {
    ...
    do
    {
      ...
      try
      {
        paramString = KeyFactory.getInstance("RSA").generatePublic(new X509EncodedKeySpec(bdfr.decode(paramString.getBytes("UTF-8"), 0)));
  ...
  public boolean a(int paramInt)
  {
    ...
    try
    {
      if ((bdhb.a(this.a)) && (bdhb.a(this.b)))
      {
        byte[] arrayOfByte1 = bdhb.a(this.a);
        byte[] arrayOfByte2 = bdhb.a(this.b);
