...
public class ainl
{
  ...
  aino jdField_a_of_type_Aino = new aino(this);
  ...
  ainl(Context paramContext)
  {
    this.jdField_a_of_type_ComTencentMobileqqConditionsearchWidgetTimeSelectView = ((TimeSelectView)LayoutInflater.from(paramContext).inflate(2131561216, null));
    this.jdField_a_of_type_ComTencentMobileqqConditionsearchWidgetTimeSelectView.a(this.jdField_a_of_type_Aino);
    this.jdField_a_of_type_Bkho = bkho.c(paramContext);
    this.jdField_a_of_type_Bkho.e(true);
    this.jdField_a_of_type_Bkho.a(this.jdField_a_of_type_ComTencentMobileqqConditionsearchWidgetTimeSelectView, null);
    this.jdField_a_of_type_ComTencentMobileqqConditionsearchWidgetTimeSelectView.setPickListener(new ainm(this));
    a();
  }
  ...
  void a(ainn paramainn)
  {
    this.jdField_a_of_type_Ainn = paramainn;
  }
}
