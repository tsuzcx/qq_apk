...
public class ljf
  implements Runnable
{
  public ljf(ReadInJoyCommentComponentFragment paramReadInJoyCommentComponentFragment, String paramString) {}
  ...
  public void run()
  {
    if (!new File(this.jdField_a_of_type_JavaLangString).exists())
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentComponentFragment.a(1, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentComponentFragment.getString(2131438866));
