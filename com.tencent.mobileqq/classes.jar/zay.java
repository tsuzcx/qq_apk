  ...
  extends WebViewPlugin
{
  ...
  private static long a(becq parambecq)
  {
    if (parambecq == null) {
      return 0L;
    }
    try
    {
      long l = parambecq.a().getIntent().getLongExtra("preAct_time", 0L);
      return l;
    }
    catch (Exception parambecq)
    {
      QLog.w("QzoneWebViewOfflinePlugin", 2, "can not get click time", parambecq);
    }
    return 0L;
  }
  ...
  private Object a(String paramString)
  {
    ...
    for (AppInterface localAppInterface = this.mRuntime.a();; localAppInterface = null)
    {
      ...
      return bjtw.a(localAppInterface, localCustomWebView, paramString, (String)localObject);
      localObject = null;
      break;
      localObject = null;
      break label27;
  ...
  private void a(begh parambegh, String paramString)
  {
    if (TextUtils.isEmpty(paramString)) {}
    while (parambegh == null) {
      return;
    }
    QLog.i("QzoneWebViewOfflinePlugin", 1, "state is " + parambegh);
    for (;;)
    {
      ...
      try
      {
        ...
        switch (parambegh.jdField_a_of_type_Int)
        {
        case 1: 
          if (!TextUtils.isEmpty(parambegh.jdField_b_of_type_JavaLangString)) {
            localJSONObject.put("url", parambegh.jdField_b_of_type_JavaLangString);
          }
          localJSONObject.put("code", parambegh.jdField_c_of_type_Int);
          if (!TextUtils.isEmpty(parambegh.f)) {
            localJSONObject.put("msg", parambegh.f);
          }
          localJSONObject.put("dataIsBase64", parambegh.jdField_a_of_type_Boolean);
          if (TextUtils.isEmpty(parambegh.d)) {
            break label392;
          }
          if (!parambegh.jdField_a_of_type_Boolean) {
            break label383;
          }
          str = bdbi.encodeToString(parambegh.d.getBytes(), 0);
          localJSONObject.put("data", str);
          if (parambegh.jdField_b_of_type_Int > 0) {
            localJSONObject.put("httpStatusCode", parambegh.jdField_b_of_type_Int);
          }
          if (!TextUtils.isEmpty(parambegh.jdField_c_of_type_JavaLangString)) {
            localJSONObject.put("header", new JSONObject(parambegh.jdField_c_of_type_JavaLangString));
          }
          if (parambegh.jdField_a_of_type_JavaLangObject != null) {
            localJSONObject.put("userinfo", parambegh.jdField_a_of_type_JavaLangObject);
          }
          callJs(paramString, new String[] { localJSONObject.toString() });
          long l1 = System.currentTimeMillis();
          long l2 = parambegh.jdField_a_of_type_Long;
          QLog.i("QzoneWebViewOfflinePlugin", 1, "wnscgi@ status=" + parambegh.jdField_a_of_type_Int + ",total cost " + (l1 - l2) + " ms");
          return;
        }
      }
      catch (Exception parambegh)
      {
        parambegh.printStackTrace();
        return;
      }
  ...
  private void a(String... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.mRuntime != null) {}
        for (paramVarArgs = this.mRuntime.a(); QzoneZipCacheHelper.checkAndDownLoadFileIfNeeded(paramVarArgs, str1, str2, str3, i, new zba(this, str2, str3, str4)); paramVarArgs = null)
        {
  ...
  private static void b(String paramString, long paramLong, becq parambecq)
  {
    int i;
    long l;
    try
    ...
    label205:
    String str1;
    if ((!TextUtils.isEmpty(paramString)) && (parambecq != null) && ((8589934594L == paramLong) || (8589934593L == paramLong)) && (paramString.equals(QzoneConfig.getInstance().getConfig("H5Url", "GameBar", "https://h5.qzone.qq.com/h5plus/homeV2/index/alpha?_proxy=1&_wv=3&via=qqnavigation.2017"))))
    {
      l = a(parambecq);
      if (l <= 0L)
      {
      ...
      if (QzoneOfflineCacheHelper.getSmallGameLastCacheTime(parambecq.a().getLongAccountUin()) <= 0L) {
        break label367;
      }
      i = 1;
    ...
    for (;;)
    {
      ...
      azly.a(localBaseApplication).reportTimeKVEvent(str1, localProperties, (int)l);
      if (8589934594L == paramLong) {}
      for (paramString = alpo.a(2131713002);; paramString = alpo.a(2131713003))
      {
        QLog.i("QzoneWebViewOfflinePlugin", 2, paramString + l + "ms,mta key=" + str1);
        if (8589934594L != paramLong) {
          break;
        }
        QzoneOfflineCacheHelper.updataSmallGameLastCacheFinishTime(parambecq.a().getLongAccountUin(), System.currentTimeMillis());
        return;
      }
      while (i == 0)
      {
  ...
  private void c(String... paramVarArgs)
  {
    ...
    try
    {
      ...
      localbegg.f = ((JSONObject)localObject2).optString("callback");
      localbegg.jdField_a_of_type_JavaLangString = ((JSONObject)localObject2).optString("url");
    ...
    catch (Exception localException)
    {
      ...
      paramVarArgs = new begh();
      paramVarArgs.jdField_b_of_type_JavaLangString = localbegg.jdField_a_of_type_JavaLangString;
      paramVarArgs.jdField_a_of_type_Int = 3;
      paramVarArgs.jdField_c_of_type_Int = 101;
      paramVarArgs.f = localException.getMessage();
      paramVarArgs.e = localbegg.f;
      a(paramVarArgs, localbegg.f);
      return;
    }
    if (!a(a(), localbegg.jdField_a_of_type_JavaLangString))
    {
      localObject1 = a(a());
      localObject2 = a(localbegg.jdField_a_of_type_JavaLangString);
      throw new Exception("not support for cross-domain request!!! current host=" + (String)localObject1 + ",req host=" + (String)localObject2);
    }
    localbegg.jdField_b_of_type_JavaLangString = ((JSONObject)localObject2).optString("method");
    if ((!"GET".equalsIgnoreCase(localbegg.jdField_b_of_type_JavaLangString)) && (!"POST".equalsIgnoreCase(localbegg.jdField_b_of_type_JavaLangString))) {
      throw new Exception("no such method support!!!");
    }
    Object localObject1 = ((JSONObject)localObject2).opt("body");
    if ((localObject1 instanceof JSONObject)) {
      localbegg.e = "application/x-www-form-urlencoded";
    }
    for (localbegg.d = a((JSONObject)localObject1);; localbegg.d = localObject1.toString())
    {
    ...
    {
      localbegg.jdField_c_of_type_JavaLangString = ((String)localObject1);
      localbegg.jdField_a_of_type_Boolean = ((JSONObject)localObject2).optBoolean("dataNeedBase64", false);
      localbegg.jdField_a_of_type_Int = ((int)(((JSONObject)localObject2).optDouble("timeout", 0.0D) * 1000.0D));
      localbegg.jdField_a_of_type_JavaLangObject = ((JSONObject)localObject2).opt("userinfo");
      if (this.jdField_b_of_type_AndroidOsHandler == null) {
        this.jdField_b_of_type_AndroidOsHandler = new zbb(this, Looper.getMainLooper());
      }
      if (begf.a().a(localbegg, this.jdField_b_of_type_AndroidOsHandler)) {
        break;
      }
      paramVarArgs = new begh();
      paramVarArgs.jdField_b_of_type_JavaLangString = localbegg.jdField_a_of_type_JavaLangString;
  ...
  protected void a(begh parambegh)
  {
    a(parambegh, parambegh.e);
  }
  ...
  public Object handleEvent(String paramString, long paramLong)
  {
    if (paramLong == 8L)
    {
      if (this.mRuntime != null)
      {
        bjtw.a = new WeakReference(this.mRuntime.a());
        bjtw.b = new WeakReference(this.mRuntime.a());
      }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      if ((paramJsBridgeListener.has("proxyUrl")) && (paramJsBridgeListener.has("isCheckCache")))
      {
        ...
        if ((bool) && (!TextUtils.isEmpty(begt.d(this.jdField_a_of_type_JavaLangString))))
        {
        ...
        if (this.jdField_a_of_type_AndroidOsHandler == null) {
          this.jdField_a_of_type_AndroidOsHandler = new zaz(this, Looper.getMainLooper());
        }
