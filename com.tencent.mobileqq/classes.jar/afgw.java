  ...
  implements View.OnClickListener
{
  ...
  {
    localMessageForDeviceSingleStruct = (MessageForDeviceSingleStruct)aekt.a(paramView);
    ...
    do
    {
      ...
      if ((TextUtils.isEmpty(localMessageForDeviceSingleStruct.strMediaFileName)) && (localMessageForDeviceSingleStruct.nMediaChannelType == 2) && (!TextUtils.isEmpty(localMessageForDeviceSingleStruct.strMediaKey))) {
        localMessageForDeviceSingleStruct.strMediaFileName = (bfhi.d(localMessageForDeviceSingleStruct.strMediaKey) + localMessageForDeviceSingleStruct.strMediaKey.substring(localMessageForDeviceSingleStruct.strMediaKey.lastIndexOf(".")));
      }
      localDeviceInfo = ((zpa)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51)).a(Long.parseLong(localMessageForDeviceSingleStruct.senderuin));
    ...
    for (;;)
    {
      ...
      catch (JSONException paramView)
      {
        ...
        continue;
        Object localObject = bdds.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_AndroidContentContext, localMessageForDeviceSingleStruct.url);
        if ((localObject == null) || (!"openLightApp".equals(((bddb)localObject).b)) || (!"url".equals(((bddb)localObject).c))) {
          continue;
        }
        Bundle localBundle = new Bundle();
        localBundle.putString("param_meta_data", paramView);
        aabn.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_AndroidContentContext, localDeviceInfo, ((bddb)localObject).b("url_prefix"), localBundle);
        continue;
        if ((i == 0) || (TextUtils.isEmpty(localMessageForDeviceSingleStruct.faceRect)) || (!afgv.a(this.a, localMessageForDeviceSingleStruct.faceRect)) || (TextUtils.isEmpty(localMessageForDeviceSingleStruct.strCoverPath))) {
          continue;
        }
        ...
        bjxx.a().a((Activity)this.a.jdField_a_of_type_AndroidContentContext, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), (Intent)localObject, "com.tencent.device.face.FaceRegisterActivity", -1, null, SmartDevicePluginProxyActivity.class);
        continue;
        paramView = localMessageForDeviceSingleStruct.strCoverPath;
        continue;
        if ((bdcs.b(localMessageForDeviceSingleStruct.strMediaPath)) || (!bdee.b(bexd.a().a()))) {
          continue;
        }
        paramView = this.a.jdField_a_of_type_AndroidContentContext.getString(2131692752);
        localObject = this.a.jdField_a_of_type_AndroidContentContext.getString(2131692754);
        armv.a(this.a.jdField_a_of_type_AndroidContentContext, paramView, (CharSequence)localObject, new afgx(this, localMessageForDeviceSingleStruct));
        continue;
        afgv.a(this.a, localMessageForDeviceSingleStruct);
        continue;
        i = 3;
        continue;
      }
      ...
      bjxx.a().a((Activity)this.a.jdField_a_of_type_AndroidContentContext, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), (Intent)localObject, "com.tencent.device.lightapp.DeviceWebViewActivity", -1, null, SmartDevicePluginProxyActivity.class);
      ...
      aabm.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, l, "Usr_AIO_ReceiveMsg_Click", i, 0, j);
      return;
      i = 0;
      continue;
      paramView = localMessageForDeviceSingleStruct.strCoverPath;
