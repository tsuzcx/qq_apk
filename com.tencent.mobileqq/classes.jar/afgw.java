...
public class afgw
{
  ...
  private Set<afha> jdField_a_of_type_JavaUtilSet;
  ...
  private void a(Animator paramAnimator, int paramInt)
  {
    ...
    {
      afha localafha = (afha)localIterator.next();
      if (localafha != null) {
        localafha.a(paramAnimator, paramInt);
      }
    }
  }
  ...
  private void a(LottieDrawable paramLottieDrawable, int paramInt)
  {
    ...
    while (localIterator.hasNext())
    {
      afha localafha = (afha)localIterator.next();
      if (localafha != null) {
        localafha.a(paramLottieDrawable, paramInt);
      }
    }
  }
  ...
  {
    this.jdField_a_of_type_JavaUtilSet.add(paramafha);
  }
  ...
  public void a(LottieDrawable paramLottieDrawable, int paramInt, ImageView paramImageView, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      paramLottieDrawable.addAnimatorListener(new afgy(this, paramLottieDrawable, paramInt, paramImageView));
    } while (!paramBoolean);
