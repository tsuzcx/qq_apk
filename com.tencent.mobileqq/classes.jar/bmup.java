...
public class bmup
{
  private static bmup jdField_a_of_type_Bmup;
  ...
  private bmup()
  {
    ...
    for (int i = 4;; i = 0)
    {
      ...
      if (this.jdField_a_of_type_AndroidContentSharedPreferences != null) {
        this.jdField_a_of_type_AndroidContentSharedPreferences.registerOnSharedPreferenceChangeListener(new bmuq(this));
      }
      return;
    }
  }
  ...
  {
    if (jdField_a_of_type_Bmup == null) {}
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (jdField_a_of_type_Bmup == null) {
        jdField_a_of_type_Bmup = new bmup();
      }
      return jdField_a_of_type_Bmup;
    }
  }
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2)
  {
    ...
    String str = paramActivity.getResources().getString(2131716938);
  ...
  public static void b(Activity paramActivity, String paramString1, String paramString2)
  {
    ...
    for (paramString1 = str.replace("{actionId}", paramString1);; paramString1 = str)
    {
      ...
      paramActivity = bhni.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramActivity, str);
      if (paramActivity != null)
      {
        paramActivity.a();
        return;
