  ...
  implements Runnable
{
  ...
  public akjy(PathTraceManager paramPathTraceManager, long paramLong, String paramString)
  {
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        ((NewIntent)localObject2).setObserver(new akjz(this, localJSONObject, localList, localThrowable, localSharedPreferences, localOrbitReq));
