...
public class vsl
{
  ...
  public QCircleWebViewTitleStyle a(Context paramContext)
  {
    ...
    localQCircleWebViewTitleStyle.b = paramContext.getResources().getColor(2131166233);
    localQCircleWebViewTitleStyle.c = paramContext.getResources().getColor(2131166233);
