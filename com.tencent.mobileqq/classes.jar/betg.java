...
public class betg
{
  private static final int jdField_a_of_type_Int = belj.a("MiniApp", "mini_game_judge_timing_request_begin_delay", 1000);
  private static long jdField_a_of_type_Long;
  private static Runnable jdField_a_of_type_JavaLangRunnable;
  private static final String jdField_a_of_type_JavaLangString = belj.a("MiniApp", "enable_heart_beat_scene_whitelist", "");
  private static final String b = belj.a("MiniApp", "enable_heart_beat_appid_whitelist", "");
  private static final String c = belj.a("MiniApp", "enable_heart_beat_via_whitelist", "");
  
  public static void a(Context paramContext, MiniAppInfo paramMiniAppInfo)
  {
    beiw.c().postDelayed(new GameGrowthGuardianManager.1(paramContext, paramMiniAppInfo), jdField_a_of_type_Int);
  }
  ...
  private static boolean a(MiniAppInfo paramMiniAppInfo)
  {
    ...
    for (;;)
    {
      ...
      {
        besl.d("GameGrowthGuardianManager", "enableHeartBeatForLaunchScene", paramMiniAppInfo);
        return false;
      }
      continue;
      label260:
  ...
  public static void b(Context paramContext, MiniAppInfo paramMiniAppInfo)
  {
    ...
    {
      beiw.c().removeCallbacks(jdField_a_of_type_JavaLangRunnable);
  ...
  private static void b(Context paramContext, MiniAppInfo paramMiniAppInfo, int paramInt)
  {
    ...
    String str2 = beyn.a(paramMiniAppInfo);
    String str1;
    int i;
    label44:
    int j;
    ...
    {
      localChannelProxy.JudgeTiming(str1, i, j, paramInt, l, k, str2, 0, str3, new beth(paramContext, paramMiniAppInfo, paramInt));
      return;
      str1 = "";
      break;
      i = 0;
  ...
  private static void b(MiniAppInfo paramMiniAppInfo, INTERFACE.StJudgeTimingRsp paramStJudgeTimingRsp, INTERFACE.GuardInstruction paramGuardInstruction)
  {
    ...
    {
      localChannelProxy.ReportExecute(str, i, paramStJudgeTimingRsp, paramMiniAppInfo, new beti());
      return;
