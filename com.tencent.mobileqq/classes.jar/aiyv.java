...
public final class aiyv
  implements aizf, Handler.Callback, INetInfoHandler
{
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private aiyw jdField_a_of_type_Aiyw;
  ...
  {
    if (this.jdField_a_of_type_Aiyw == null)
    {
    ...
    ((CmGameMsgTunnel.TunnelMsgStream)localObject).mqqver.set("8.3.0");
    ...
    ((CmGameMsgTunnel.TunnelMsgStream)localObject).distribute_ts.set(this.jdField_a_of_type_Aiyw.jdField_a_of_type_Long);
    ...
    ((CmGameMsgTunnel.TunnelMsgStream)localObject).sign.set(this.jdField_a_of_type_Aiyw.b);
    ...
    try
    {
      paramString = ajac.a(paramString, this.jdField_a_of_type_Aiyw.jdField_a_of_type_JavaLangString);
  ...
  {
    ((airx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a().a(paramTunnelMsgStream);
  }
  ...
  private boolean b()
  {
    ...
    if ((this.jdField_a_of_type_Aiyw.jdField_a_of_type_JavaUtilList == null) || (this.jdField_a_of_type_Aiyw.jdField_a_of_type_JavaUtilList.size() == 0))
    {
      QLog.e("CmGameConnManager", 1, "[createConnection] no connection host");
      return false;
    }
    aizh localaizh = new aizh();
    localaizh.jdField_a_of_type_JavaUtilList = this.jdField_a_of_type_Aiyw.jdField_a_of_type_JavaUtilList;
    localaizh.jdField_a_of_type_Int = this.jdField_a_of_type_Aiyw.jdField_a_of_type_Int;
    localaizh.b = 10000;
    localaizh.c = 3000;
    if (this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection == null) {
      this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection = new CmGameSocketConnection(localaizh);
    }
    for (;;)
    {
      ...
      return true;
      this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection.a(localaizh);
    }
  }
  ...
  private void f()
  {
    for (;;)
    {
      try
      {
        ...
        this.b = true;
        if (!bbfj.e(BaseApplicationImpl.getApplication().getApplicationContext()))
        {
        ...
        {
          ((bbrd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(71)).e();
        }
      }
      finally {}
    }
  ...
  public void a(aiyw paramaiyw)
  {
    ...
    for (;;)
    {
      return;
      if (this.jdField_a_of_type_Boolean) {
        this.jdField_a_of_type_Aiyw = paramaiyw;
      }
  ...
  public void a(MsfSocketInputBuffer paramMsfSocketInputBuffer)
  {
    ...
    if (s == 6)
    {
      ...
      paramMsfSocketInputBuffer = this.jdField_a_of_type_Bfob.obtainMessage(5);
      paramMsfSocketInputBuffer.obj = Boolean.valueOf(true);
      this.jdField_a_of_type_Bfob.sendMessage(paramMsfSocketInputBuffer);
      return;
    }
    ...
    try
    {
      paramMsfSocketInputBuffer = ajac.b((byte[])localObject, this.jdField_a_of_type_Aiyw.jdField_a_of_type_JavaLangString);
  ...
  {
    boolean bool = bbfj.e(BaseApplicationImpl.getApplication().getApplicationContext());
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean1)
    {
      this.jdField_a_of_type_Bfob.removeMessages(7);
      this.jdField_a_of_type_Bfob.sendEmptyMessageDelayed(7, 130000L);
      a("page_tag_match");
      if ((a()) && (paramBoolean2)) {
        a();
      }
  ...
  public void b()
  {
    QLog.d("CmGameConnManager", 1, new Object[] { "[onGetConnInfoFailed] mShouldKeepConnect=", Boolean.valueOf(this.jdField_a_of_type_Boolean), ", mConnInfo=", this.jdField_a_of_type_Aiyw });
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Aiyw != null)) {}
  ...
  public void b(String paramString)
  {
    try
    {
      ...
      if (this.jdField_a_of_type_JavaUtilList.size() == 0)
      {
        this.jdField_a_of_type_Bfob.removeMessages(1);
        this.jdField_a_of_type_Bfob.removeMessages(2);
        this.jdField_a_of_type_Bfob.sendEmptyMessageDelayed(2, 2000L);
      }
      return;
    }
    finally
  ...
  public void d()
  {
    ...
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Int <= 2))
    {
      ...
      this.jdField_a_of_type_Bfob.removeMessages(1);
      this.jdField_a_of_type_Bfob.sendEmptyMessageDelayed(1, 10000L);
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 5: 
      ...
      if ((paramMessage.obj != null) && (((Boolean)paramMessage.obj).booleanValue()))
      {
        ...
        this.jdField_a_of_type_Aiyw = null;
      }
      i();
      return false;
    case 7: 
    ...
    bcql.a(BaseApplicationImpl.getContext(), (String)paramMessage.obj, 0).a();
    return false;
  }
