  ...
  extends axox
{
  ...
  public axoi(axos paramaxos, axvt paramaxvt, String paramString)
  {
    super(paramaxos, paramaxvt);
    this.jdField_c_of_type_Long = 0L;
    this.jdField_d_of_type_Long = 0L;
    this.jdField_a_of_type_Uxe = uxe.a();
  ...
  public int a()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ArtFilterUploadProcessor", 2, "cancelTask taskId:" + this.jdField_c_of_type_Int + " mRichProtoReq:" + this.jdField_a_of_type_Axyg + " mTrans:" + this.jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction + " mNetReq:" + this.jdField_a_of_type_Axsp);
    }
  ...
  public void a()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      localaxyp.jdField_b_of_type_Boolean = this.jdField_l_of_type_Boolean;
      localaxyg.jdField_a_of_type_Axzn = this;
      localaxyg.jdField_a_of_type_JavaLangString = "art_filter_up";
      ...
      if (QLog.isColorLevel()) {
        QLog.d("ArtFilterUploadProcessor", 2, "sendTransferRequest:" + localaxyg);
      }
  ...
  public void a(int paramInt1, int paramInt2, String paramString, int paramInt3, uxg paramuxg, boolean paramBoolean)
  {
    this.x = paramInt1;
    this.jdField_b_of_type_Int = paramInt2;
    this.jdField_b_of_type_JavaLangString = paramString;
    this.jdField_c_of_type_Int = paramInt3;
    this.jdField_a_of_type_Uxg = paramuxg;
    this.jdField_b_of_type_Boolean = paramBoolean;
    if (QLog.isColorLevel()) {
      QLog.d("ArtFilterUploadProcessor", 2, "FilterUploadInfo:" + paramuxg);
    }
    if (paramuxg == null) {
      return;
    }
    this.jdField_q_of_type_Long = paramuxg.jdField_a_of_type_Long;
    this.jdField_a_of_type_ArrayOfByte = paramuxg.jdField_a_of_type_ArrayOfByte;
    this.jdField_d_of_type_JavaLangString = paramuxg.jdField_b_of_type_JavaLangString;
    this.jdField_a_of_type_JavaLangString = (EditVideoArtFilter.jdField_a_of_type_JavaLangString + paramuxg.jdField_b_of_type_Long + "_" + paramInt2 + ".png");
    this.jdField_q_of_type_Int = paramuxg.jdField_a_of_type_Int;
    this.p = paramuxg.jdField_b_of_type_Int;
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    if (paramInt == 0)
    {
      ...
      ((Bundle)localObject).putString("param_art_filter_resource_path", this.jdField_a_of_type_Uxg.jdField_a_of_type_JavaLangString);
      ...
      this.jdField_a_of_type_Uxe.callbackResult(this.x, EIPCResult.createSuccessResult((Bundle)localObject));
      this.jdField_a_of_type_Uxe.jdField_a_of_type_AndroidUtilSparseArray.remove(this.jdField_b_of_type_Int);
    ...
    label604:
    awrn.a(BaseApplication.getContext()).a(null, "afCosttimeAndFlowReport", bool, this.j - this.i, this.jdField_q_of_type_Long, this.jdField_a_of_type_JavaUtilHashMap, "");
  }
  ...
  public void a(axyg paramaxyg, axyv paramaxyv)
  {
    ...
    } while (paramaxyv == null);
    int k = 0;
    label26:
    if (k < paramaxyv.jdField_a_of_type_JavaUtilList.size())
    {
      paramaxyg = (axyx)paramaxyv.jdField_a_of_type_JavaUtilList.get(k);
      if (QLog.isColorLevel()) {
        QLog.d("ArtFilterUploadProcessor", 2, "getTransferResp:" + paramaxyg);
      }
      if (paramaxyg.jdField_c_of_type_Int != 0) {
        break label142;
      }
      this.jdField_l_of_type_JavaLangString = paramaxyg.jdField_c_of_type_JavaLangString;
      if (this.jdField_a_of_type_Uxe.jdField_b_of_type_JavaLangString.equals(this.jdField_a_of_type_Uxg.jdField_a_of_type_JavaLangString))
      {
        this.jdField_a_of_type_Uxe.jdField_a_of_type_JavaLangString = paramaxyg.jdField_c_of_type_JavaLangString;
        aS_();
      }
    }
    for (;;)
    {
      ...
      break;
      label142:
      a(paramaxyg.jdField_c_of_type_Int, "getTransferError");
    }
  }
  ...
  public final void aS_()
  {
    ...
    do
    {
      ...
      this.jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction = new Transaction(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), 1, this.jdField_a_of_type_Uxg.jdField_a_of_type_JavaLangString, (int)this.r, arrayOfByte, this.jdField_a_of_type_ArrayOfByte, localaxoj, (byte[])localObject);
      ...
      if (QLog.isColorLevel()) {
        QLog.d("ArtFilterUploadProcessor", 2, "<BDH_LOG> Transaction submit RetCode:" + k + " T_ID:" + this.jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction.getTransationId() + " MD5:" + this.jdField_a_of_type_Uxg.jdField_a_of_type_ArrayOfByte + " uuid:" + this.k + " Path:" + this.jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction.filePath);
      }
    } while (k == 0);
  ...
  void aT_()
  {
    ...
    Object localObject1 = new axok(this);
    ...
    localFilterStyle.style_name.set(ByteStringMicro.copyFrom(bach.a(this.jdField_b_of_type_JavaLangString)));
  ...
  public void b(String paramString)
  {
    ...
    localaxro.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
    localaxro.e = 0;
    localaxro.jdField_a_of_type_Axrs = jdField_a_of_type_Axrs;
    if (QLog.isColorLevel()) {
      QLog.d("ArtFilterUploadProcessor", 2, "sendDownLoadRequest req:" + localaxro);
    }
  ...
  public void onResp(axsq paramaxsq)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ArtFilterUploadProcessor", 2, "getDownLoadResponse: " + paramaxsq);
    }
    this.jdField_a_of_type_JavaUtilHashMap.put("downloadFileSize", String.valueOf(paramaxsq.jdField_a_of_type_Long));
    ...
    if (paramaxsq.jdField_a_of_type_JavaLangString != null) {
      QLog.d("ArtFilterUploadProcessor", 1, "download dailed, mErrCode" + paramaxsq.jdField_b_of_type_Int + "mErrDesc:" + paramaxsq.jdField_a_of_type_JavaLangString);
    }
    a(paramaxsq.jdField_b_of_type_Int, paramaxsq.jdField_a_of_type_JavaLangString);
  }
}
