...
public abstract class qzu
{
  ...
  pfh jdField_a_of_type_Pfh = new qzv(this);
  ...
  private void a(Bundle paramBundle, rki paramrki, int paramInt)
  {
    ...
    try
    {
      ...
      ((JSONObject)localObject).put("video_bit_rate", Long.valueOf(paramrki.b()).toString());
      ((JSONObject)localObject).put("video_capacity", Long.valueOf(paramrki.a()).toString());
      ...
      ocd.a(null, "", "0X80093D4", "0X80093D4", 0, 0, "", "", "", ((JSONObject)localObject).toString(), false);
      return;
    }
  ...
  private void b(int paramInt)
  {
    ...
    {
      localbdmc.a(str, "actReadInJoyDeliverVideoSendRequest", bool, this.jdField_f_of_type_Long - this.jdField_c_of_type_Long, 0L, localHashMap, "");
      return;
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      localbdmc.a(str, "actReadInJoyDeliverUGCVideo", bool, this.jdField_e_of_type_Long - this.jdField_a_of_type_Long, 0L, localHashMap, "");
      return;
    }
  }
  
  public void a(boolean paramBoolean, Context paramContext, Bundle paramBundle, rki paramrki, qzw paramqzw)
  {
    String str1 = paramrki.a();
    String str2 = paramrki.b();
    String str3 = paramrki.c();
    String str4 = paramrki.d();
    String str5 = paramrki.e();
