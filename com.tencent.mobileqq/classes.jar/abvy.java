...
public class abvy
{
  public static void a(Activity paramActivity)
  {
    ...
    while (lju.b(BaseApplicationImpl.getContext())) {
      return;
    }
    if (!bhjx.a())
    {
    ...
    Object localObject = antf.ba + "shortvideo/" + System.currentTimeMillis() + ".mp4";
      ...
      do
      {
        ...
        if ((localMessageRecord instanceof MessageForDevShortVideo))
        {
          ...
          if (!paramSession.bSend) {
            ...
            {
              Object localObject3 = new abvx();
              ((abvx)localObject3).a = paramSession.strFilePathSrc;
              ((abvx)localObject3).a();
              ((MessageForDevShortVideo)localObject2).md5 = ((abvx)localObject3).jdField_c_of_type_JavaLangString;
              ((MessageForDevShortVideo)localObject2).videoFileTime = ((int)(((abvx)localObject3).jdField_b_of_type_Long / 1000L));
              ((MessageForDevShortVideo)localObject2).thumbWidth = ((abvx)localObject3).jdField_b_of_type_Int;
              ((MessageForDevShortVideo)localObject2).thumbHeight = ((abvx)localObject3).jdField_c_of_type_Int;
              ((MessageForDevShortVideo)localObject2).thumbMD5 = ((abvx)localObject3).e;
              if (!paramBoolean) {
                break label282;
              }
              ...
              bhmi.b(paramSession.strFilePathSrc, (String)localObject3);
            }
          }
          for (;;)
          {
