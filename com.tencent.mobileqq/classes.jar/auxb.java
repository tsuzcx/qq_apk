...
public class auxb
  extends auxk
{
  public auxb(Context paramContext)
  {
    super(paramContext);
  }
  ...
  public void a(AppInterface paramAppInterface, int paramInt1, int paramInt2, String paramString, auxe paramauxe)
  {
    paramauxe.f = paramInt1;
    if (paramInt2 == 0) {
      paramauxe.b = 0;
    }
    for (;;)
    {
      paramAppInterface = (ascz)paramAppInterface.getManager(106);
      if (paramAppInterface != null)
      {
        paramauxe.d = paramAppInterface.a();
        paramauxe.e = paramAppInterface.b();
      }
      paramauxe.g = Calendar.getInstance().get(11);
      paramauxe.h = badq.a(BaseApplication.getContext());
      return;
      if (paramInt2 == 3000)
      {
        paramauxe.b = 3000;
      ...
      else
      {
        if (paramInt2 == 1)
        {
          ...
          for (;;)
          {
            ...
            paramauxe.c = paramString.wMemberNum;
            break;
            paramauxe.b = 1;
            continue;
            paramauxe.b = 3;
