...
public class auxb
  extends QIPCModule
{
  private static volatile auxb a;
  
  private auxb(String paramString)
  {
    super(paramString);
  }
  
  public static auxb a()
  {
    if (a == null) {}
    try
    {
      if (a == null) {
        a = new auxb("FlutterMainQIPCModule");
      }
      return a;
    }
    finally {}
  ...
  {
    auwu.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), new auxc(this, paramString1, paramString2));
  }
