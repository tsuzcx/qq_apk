  ...
  implements ajte, asvw
{
  ...
  public auxb(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_Arsq.jdField_b_of_type_Boolean = true;
    paramQQAppInterface.removeObserver(this.jdField_a_of_type_Arrh);
  }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    aylx.a().a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout, paramString, j);
  ...
  {
    new bbxb("VIP.ProfileMusicBoxServer.ProfileMusicBoxObj", "ProfileMusicBox.getMusicList").a("getMusicList", new GetMusicListReq(paramLong, "", 100L, new SourceInfo(3, "8.3.0"), 0), new GetMusicListRsp(), this, false);
  }
  ...
  {
    new bbxb("VIP.ProfileMusicBoxServer.ProfileMusicBoxObj", "ProfileMusicBox.getQzoneMusicInfo").a("getQzoneMusicInfo", new GetQzoneMusicInfoReq(paramLong, paramArrayList, new SourceInfo(3, "8.3.0")), new GetQzoneMusicInfoRsp(), new auxc(this), false);
  }
  ...
  public void a(Context paramContext, SongInfo paramSongInfo)
  {
    ...
    {
      return;
      new Intent(paramContext, QQBrowserActivity.class).putExtra("url", bfnx.a(amzx.a().jdField_b_of_type_JavaLangString, "uin", String.valueOf(this.jdField_a_of_type_Long)));
  ...
  {
    this.jdField_a_of_type_Auxd = paramauxd;
  }
  ...
  public void a(SongInfo paramSongInfo)
  {
    ...
    this.jdField_a_of_type_Arsq.jdField_a_of_type_JavaLangString = paramSongInfo.jdField_d_of_type_JavaLangString;
    if (a()) {
      this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_Arsq);
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    if (localarss != null)
    {
      this.jdField_a_of_type_Arsq.jdField_a_of_type_Int = localarss.a().jdField_a_of_type_Int;
      this.jdField_a_of_type_Arsq.jdField_b_of_type_Int = localarss.a().jdField_b_of_type_Int;
      this.jdField_a_of_type_Arsq.jdField_a_of_type_Boolean = localarss.a().jdField_a_of_type_Boolean;
      if (localarss.a()) {
        localarss.b(localarss.a().e, localarss.a().jdField_b_of_type_JavaLangString);
      }
    }
    if (QLog.isColorLevel()) {
      QLog.d("ProfileMusicBoxController", 2, "showLyrics");
    }
    if ((TextUtils.isEmpty(paramString)) && (!TextUtils.isEmpty(this.jdField_a_of_type_Arsq.jdField_b_of_type_JavaLangString)))
    {
      super.a(j, this.jdField_a_of_type_Arsq.jdField_b_of_type_JavaLangString);
      return;
    }
  ...
  public void c()
  {
    auxa.b(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.getContext(), this.jdField_a_of_type_Arsq.jdField_b_of_type_JavaLangString);
    String str;
    if (this.i)
    {
      str = "";
    ...
    for (int k = 1;; k = 2)
    {
      axqy.b(null, "dc00898", "", str, "qq_vip", "0X800A7DF", k, 0, "", "", "", "");
      return;
  ...
  public void d()
  {
    ...
    for (int k = 1;; k = 2)
    {
      axqy.b(null, "dc00898", "", str, "qq_vip", "0X800A7E0", k, 0, "", "", "", "");
      return;
      str = String.valueOf(this.jdField_a_of_type_Long);
      break;
    }
  ...
  public void j()
  {
    super.b(j, this.jdField_a_of_type_Arsq.jdField_b_of_type_JavaLangString);
    this.jdField_a_of_type_Arsq.e = 0;
    b(j, this.jdField_a_of_type_Arsq.jdField_b_of_type_JavaLangString, true);
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      arss localarss = ListenTogetherManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a();
      if (localarss != null)
      {
        localarss.a().jdField_a_of_type_Int = this.jdField_a_of_type_Arsq.jdField_a_of_type_Int;
        localarss.a().jdField_b_of_type_Int = this.jdField_a_of_type_Arsq.jdField_b_of_type_Int;
        localarss.a().jdField_a_of_type_Boolean = this.jdField_a_of_type_Arsq.jdField_a_of_type_Boolean;
      }
      if (QLog.isColorLevel()) {
  ...
  public void m()
  {
    ...
    if ((localarss != null) && (!ListenTogetherManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b())) {
      localJSONObject = new JSONObject();
    }
    try
    {
      localJSONObject.put("type", "musicboxResume");
      localJSONObject.put("uin", localarss.a().jdField_b_of_type_JavaLangString);
      localJSONObject.put("uinType", localarss.a().e);
  ...
  public void onPlaySongChanged(SongInfo paramSongInfo)
  {
    ...
    if (paramSongInfo.jdField_b_of_type_Int == 10)
    {
      if (this.jdField_a_of_type_Auxd != null) {
        this.jdField_a_of_type_Auxd.a(paramSongInfo, this.h);
      }
      n();
      if (QLog.isColorLevel()) {
  ...
  public void onPlayStateChanged(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        if (this.jdField_a_of_type_Auxd != null) {
          this.jdField_a_of_type_Auxd.a((SongInfo)localObject, true);
        }
      ...
      else
      {
        ...
        continue;
        if (this.jdField_a_of_type_Auxd != null) {
          this.jdField_a_of_type_Auxd.a(2);
        }
        d(false);
        this.h = false;
        ...
        for (;;)
        {
          axqy.b(null, "dc00898", "", String.valueOf(l), "qq_vip", (String)localObject, k, 0, String.valueOf((System.currentTimeMillis() - this.jdField_b_of_type_Long) / 1000L), "", "", "");
          break;
