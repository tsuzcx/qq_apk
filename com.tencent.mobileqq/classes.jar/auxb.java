...
public class auxb
{
  ...
  private static String a(android.graphics.Bitmap paramBitmap)
  {
    ...
    //   6: dup
    //   7: getstatic 30	alof:cg	Ljava/lang/String;
    //   10: invokestatic 35	bdzf:a	(Ljava/lang/String;)Ljava/lang/String;
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, bayj parambayj)
  {
    parambayj.addFilter(new Class[] { bavb.class });
    paramQQAppInterface.a().a(parambayj);
  ...
  {
    new azqx(null).a("dc00899").b("grp_lbs").c(paramString1).d(paramString2).a(paramInt1).b(paramInt2).a(paramVarArgs).a();
  }
  ...
  public static boolean a(Activity paramActivity, QQAppInterface paramQQAppInterface)
  {
    ...
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, aepi.a(150.0F, paramActivity.getResources()));
    new avtr(paramActivity).a(localImageView, localLayoutParams).b(alud.a(2131707786)).a(new avtl(alud.a(2131707788), new auxc(paramActivity, paramQQAppInterface))).show();
