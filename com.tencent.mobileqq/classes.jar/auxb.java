...
public class auxb
  implements ayny
{
  public auxb(NearbyHybridFragment paramNearbyHybridFragment) {}
  ...
  public boolean a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    try
    {
      ...
      if (this.a.jdField_a_of_type_Auxc != null) {
        this.a.jdField_a_of_type_Auxc.mWebview.callJs(str, new String[] { localJSONObject.toString() });
      }
      return false;
    }
