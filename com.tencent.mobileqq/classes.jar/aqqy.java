  ...
  implements HookMethodCallback
{
  public void afterHookedMethod(MethodHookParam paramMethodHookParam)
  {
    ...
    if (aqqw.a().containsKey(Long.valueOf(l)))
    {
      l = SystemClock.uptimeMillis() - ((Long)aqqw.a().remove(Long.valueOf(l))).longValue();
    ...
    for (paramMethodHookParam = "1";; paramMethodHookParam = "0")
    {
      ...
      awrn.a(BaseApplicationImpl.getContext()).a(null, "actFriendSqliteOpt", true, l, 0L, localHashMap, null, false);
      return;
    }
  }
  ...
  public void beforeHookedMethod(MethodHookParam paramMethodHookParam)
  {
    long l = Thread.currentThread().getId();
    if (aqqw.a().containsKey(Long.valueOf(l))) {
      aqqw.a().put(Long.valueOf(l), Long.valueOf(SystemClock.uptimeMillis()));
    }
  }
}
