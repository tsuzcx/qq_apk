  ...
  extends BaseAdapter
{
  ...
  public bfsg(ReciteDisplayView paramReciteDisplayView, Context paramContext, List<ParagraphInfo> paramList, int paramInt1, int paramInt2)
  {
    this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkReciteUiReciteDisplayView = paramReciteDisplayView;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.b = mvk.b(paramContext);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      localbfsf = new bfsf();
      localbfsf.a = new PinyinTextView(this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkReciteUiReciteDisplayView, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Int);
      paramView = localbfsf.a;
      paramView.setTag(localbfsf);
    }
    for (;;)
    {
      localbfsf = (bfsf)paramView.getTag();
      ParagraphInfo localParagraphInfo = (ParagraphInfo)this.jdField_a_of_type_JavaUtilList.get(paramInt);
      if (this.e == d) {
        if (paramInt == getCount() - 1) {
          localbfsf.a.setWordInfos(localParagraphInfo, this.g, true);
        }
      }
      for (;;)
      {
        ...
        return paramView;
        localbfsf.a.setWordInfos(localParagraphInfo, this.g, false);
        continue;
        localbfsf.a.setWordInfos(localParagraphInfo, this.g, false);
      }
    }
