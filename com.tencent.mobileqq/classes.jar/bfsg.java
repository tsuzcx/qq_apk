...
public class bfsg
{
  ...
  public void a(TroopFileTransferManager.Task paramTask)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 24	bfsg:jdField_a_of_type_JavaUtilLinkedList	Ljava/util/LinkedList;
    //   6: aload_1
    //   7: invokevirtual 32	java/util/LinkedList:add	(Ljava/lang/Object;)Z
    //   10: pop
    //   11: aload_0
    //   12: getfield 19	bfsg:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger	Ljava/util/concurrent/atomic/AtomicInteger;
    //   15: invokevirtual 36	java/util/concurrent/atomic/AtomicInteger:incrementAndGet	()I
    //   18: aload_0
    //   19: getfield 26	bfsg:jdField_a_of_type_Int	I
    //   22: if_icmple +14 -> 36
    //   25: aload_0
    //   26: getfield 19	bfsg:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger	Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    //   39: dup
    //   40: aload_0
    //   41: invokespecial 44	com/tencent/mobileqq/troop/utils/TroopFileTransferManager$TaskPool$1:<init>	(Lbfsg;)V
    //   44: iconst_5
    //   45: aconst_null
    //   46: iconst_1
