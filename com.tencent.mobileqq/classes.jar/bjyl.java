  ...
  extends RequestProxy
{
  ...
  {
    paramArrayOfByte = MiniOkHttpClientFactory.getRequestClient().newCall(bjwi.a(paramString1, paramMap, paramString2.toUpperCase(), null, paramArrayOfByte));
    paramArrayOfByte.enqueue(new bjym(this, paramString1, paramRequestListener));
