...
public class bfwf
{
  private static bfwf jdField_a_of_type_Bfwf;
  ...
  public static bfwf a()
  {
    if (jdField_a_of_type_Bfwf == null) {}
    try
    {
      if (jdField_a_of_type_Bfwf == null) {
        jdField_a_of_type_Bfwf = new bfwf();
      }
      return jdField_a_of_type_Bfwf;
    }
    finally {}
  }
  ...
  private static String a()
  {
    ...
    try
    {
      localObject = audi.b((String)localObject);
      return localObject;
    }
    ...
    for (;;)
    {
      ...
      try
      {
        if (a().a())
        {
          ...
          {
            if (paramBoolean) {
              QQToast.a(paramActivity, 1, str, 1000).b(paramActivity.getResources().getDimensionPixelSize(2131299076));
            }
