  ...
  extends BaseAdapter
{
  ...
  protected List<asac> a;
  protected Map<Integer, ArrayList<View>> a;
  public int b;
  protected List<asac> b;
  protected int c;
  protected List<asac> c;
  public int d;
  protected int e;
  ...
  public arwf(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, arxd paramarxd)
  {
    ...
    this.e = paramContext.getResources().getColor(2131166500);
    this.jdField_a_of_type_Float = paramContext.getResources().getDisplayMetrics().density;
  }
  
  public abstract View a(arwg paramarwg, int paramInt, View paramView, ViewGroup paramViewGroup);
  ...
  public RelativeLayout a()
  {
    ...
    try
    {
      ...
      localLayoutParams.addRule(2, 2131365907);
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localObject != null) && (((ArrayList)localObject).size() > 0))
        {
          ...
          while (i < ((ArrayList)localObject).size())
          {
            ...
            Integer localInteger = (Integer)localView.getTag(2131365950);
            if (asak.jdField_a_of_type_Int == localInteger.intValue()) {
              asak.a().a(j, localView);
            }
            i += 1;
          }
        }
  ...
  public void a(int paramInt, View paramView)
  {
    ...
    do
    {
      ...
      paramView.setTag(2131365950, Integer.valueOf(this.d));
  ...
  public void a(View paramView, asac paramasac)
  {
    if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      paramasac = (URLImageView)paramView.findViewById(2131365902);
      long l = System.currentTimeMillis();
      localObject2 = ((arxg)localObject1).a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Float);
      if (QLog.isColorLevel()) {
        QLog.d(jdField_a_of_type_JavaLangString, 2, "getDrawable cost = " + (System.currentTimeMillis() - l));
      }
      paramasac.setImageDrawable((Drawable)localObject2);
      paramasac.setVisibility(0);
    } while (!(localObject1 instanceof asbq));
    paramasac = (asbq)localObject1;
    Object localObject1 = (TextView)paramView.findViewById(2131365907);
    if (paramasac.a != null)
    {
      localObject2 = paramasac.a.name;
  ...
  {
    if (paramView == null) {}
    for (Object localObject = a();; localObject = (arwg)paramView.getTag())
    {
      localObject = a((arwg)localObject, paramInt, paramView, paramViewGroup);
