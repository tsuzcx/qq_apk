...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24 }, new String[] { "jumpType", "jumpLink", "redPointSources" }, new Object[] { Integer.valueOf(0), "", Integer.valueOf(0) }, RedPointJumpInfo.class);
