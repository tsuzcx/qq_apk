  ...
  extends MessageMicro<StaffInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 34, 42, 48, 58, 66, 72, 80 }, new String[] { "name", "companyName", "position", "email", "evidencePicturies", "optime", "id", "companyLogo", "onboardingTime", "leaveTime" }, new Object[] { "", "", "", "", "", Long.valueOf(0L), "", "", localInteger, localInteger }, StaffInfo.class);
  }
}
