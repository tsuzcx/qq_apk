  ...
  extends MessageMicro<StHeartbeatSignalReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 410, 418, 426 }, new String[] { "uin", "interval_time_ms", "sig_optype", "app_info", "network_info", "byteExtinfo" }, new Object[] { localLong, localLong, Integer.valueOf(0), null, null, null }, StHeartbeatSignalReq.class);
  }
}
