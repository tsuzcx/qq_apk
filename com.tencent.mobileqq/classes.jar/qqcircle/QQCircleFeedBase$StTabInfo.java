  ...
  extends MessageMicro<StTabInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 26, 32, 42, 50 }, new String[] { "tabName", "tabType", "tagId", "status", "attachInfo", "urlInfo" }, new Object[] { "", localInteger, "", localInteger, "", null }, StTabInfo.class);
  }
}
