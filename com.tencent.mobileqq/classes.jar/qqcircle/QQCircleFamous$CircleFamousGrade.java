...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "start", "end", "grade" }, new Object[] { Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0) }, CircleFamousGrade.class);
