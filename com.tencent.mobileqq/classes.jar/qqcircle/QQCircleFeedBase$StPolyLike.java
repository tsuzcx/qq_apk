...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 34, 40 }, new String[] { "polyLikeID", "polyName", "polySource", "polyIconUrl", "count" }, new Object[] { "", "", "", "", Integer.valueOf(0) }, StPolyLike.class);
