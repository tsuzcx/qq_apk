...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 26, 34, 40, 48 }, new String[] { "extInfo", "infoTypes", "sign", "showTagList", "pattonType", "groupIDList" }, new Object[] { null, Integer.valueOf(0), "", null, Integer.valueOf(0), Long.valueOf(0L) }, SetProfileReq.class);
