  ...
  extends MessageMicro<CertificationDetail>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34 }, new String[] { "circleType", "circleStatue", "studentInfo", "staffInfo" }, new Object[] { localInteger, localInteger, null, null }, CertificationDetail.class);
  }
}
