...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 26, 32 }, new String[] { "extInfo", "isLimit", "strErr", "isVip" }, new Object[] { null, Integer.valueOf(0), "", Integer.valueOf(0) }, CheckActInviteCircleCountRsp.class);
