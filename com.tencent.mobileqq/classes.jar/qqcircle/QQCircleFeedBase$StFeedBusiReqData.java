...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24 }, new String[] { "allPushList", "pushList", "uninterest_buttons" }, new Object[] { null, null, Integer.valueOf(0) }, StFeedBusiReqData.class);
