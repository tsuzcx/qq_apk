...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 34 }, new String[] { "uid", "relation", "certification", "giftInfos" }, new Object[] { "", Integer.valueOf(0), Integer.valueOf(0), null }, UserPMGiftInfo.class);
