  ...
  extends MessageMicro<TempMsgCommToken>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26 }, new String[] { "uint32_time_stamp", "uint32_expire_time", "bytes_srv_data" }, new Object[] { Integer.valueOf(0), Integer.valueOf(0), localByteStringMicro }, TempMsgCommToken.class);
  }
}
