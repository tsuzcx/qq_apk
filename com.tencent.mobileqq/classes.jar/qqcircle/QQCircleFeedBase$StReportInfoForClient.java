  ...
  extends MessageMicro<StReportInfoForClient>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "feedtype1", "feedtype2", "feedtype3" }, new Object[] { localInteger, localInteger, localInteger }, StReportInfoForClient.class);
  }
}
