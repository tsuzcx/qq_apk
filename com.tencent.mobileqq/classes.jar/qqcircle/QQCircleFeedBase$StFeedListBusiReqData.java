...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 34, 42 }, new String[] { "tabAttachInfo", "gpsInfo", "isReqLayer", "tagId", "tagName" }, new Object[] { "", null, Boolean.valueOf(false), "", "" }, StFeedListBusiReqData.class);
