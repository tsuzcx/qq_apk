...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34 }, new String[] { "uint64_from_uin", "uint64_to_uin", "source", "extInfos" }, new Object[] { Long.valueOf(0L), Long.valueOf(0L), "", null }, AddFriendAuthReqBody.class);
