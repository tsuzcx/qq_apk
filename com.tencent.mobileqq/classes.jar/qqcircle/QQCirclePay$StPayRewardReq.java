...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 34, 40, 50, 56 }, new String[] { "extInfo", "giftData", "toUID", "feed", "opTime", "retryDetail", "opTimeNs" }, new Object[] { null, null, "", null, Long.valueOf(0L), null, Long.valueOf(0L) }, StPayRewardReq.class);
