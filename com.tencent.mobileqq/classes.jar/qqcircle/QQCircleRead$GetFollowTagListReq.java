  ...
  extends MessageMicro<GetFollowTagListReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 32, 40 }, new String[] { "extInfo", "hostUin", "attachInfo", "count", "from" }, new Object[] { null, "", "", localInteger, localInteger }, GetFollowTagListReq.class);
  }
}
