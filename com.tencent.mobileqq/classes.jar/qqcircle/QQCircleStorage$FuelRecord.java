  ...
  extends MessageMicro<FuelRecord>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "optTime", "behaviorType", "fuelValue", "leftFuelValue" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, localInteger }, FuelRecord.class);
  }
}
