...
public final class QQCircleRelation$AddFriendCheckReqBody
  extends MessageMicro<AddFriendCheckReqBody>
{
  static final MessageMicro.FieldMap __fieldMap__;
  public final PBBytesField bytes_msg = PBField.initBytes(ByteStringMicro.EMPTY);
  public final PBRepeatMessageField<QQCircleRelation.AddFriendTagValue> rpt_tag_list = PBField.initRepeatMessage(QQCircleRelation.AddFriendTagValue.class);
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48, 56, 64, 74, 82, 88, 96, 104, 112 }, new String[] { "uint64_friend", "uint32_source", "uint32_subsource", "uint32_from_cmd", "uint32_from_service", "uint32_from_version", "uint32_locale_id", "uint32_req_type", "rpt_tag_list", "bytes_msg", "uint32_verifyed", "uint32_common_friend", "uint32_common_group", "uint32_contact_relaton" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, null, localByteStringMicro, localInteger, localInteger, localInteger, localInteger }, AddFriendCheckReqBody.class);
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes16.jar
 * Qualified Name:     qqcircle.QQCircleRelation.AddFriendCheckReqBody
