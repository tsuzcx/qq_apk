  ...
  extends MessageMicro<StLikeBusiData>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 32, 42 }, new String[] { "polyLikeInfo", "curPolyLikeInfo", "rewardstatus", "likestatus", "likeIDs" }, new Object[] { null, null, localInteger, localInteger, "" }, StLikeBusiData.class);
  }
}
