  ...
  extends MessageMicro<CircleRankingData>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 34, 40, 48 }, new String[] { "rankDesc", "rankIconUrl", "rankJumpUrl", "backIconUrl", "rankingType", "reportValue" }, new Object[] { "", "", "", "", localInteger, localInteger }, CircleRankingData.class);
  }
}
