...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18 }, new String[] { "simulate_date", "kuolie_data" }, new Object[] { null, null }, StImageBusiData.class);
