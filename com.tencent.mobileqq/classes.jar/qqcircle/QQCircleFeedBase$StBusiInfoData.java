...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 34, 42, 48, 58 }, new String[] { "tabInfos", "busiMap", "allPolyInfo", "schoolInfos", "companyInfos", "defaultTabIndex", "rewardData" }, new Object[] { null, null, null, null, null, Integer.valueOf(0), null }, StBusiInfoData.class);
