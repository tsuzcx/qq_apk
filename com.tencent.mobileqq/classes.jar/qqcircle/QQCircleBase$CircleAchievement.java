...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 32, 42, 50, 58, 66 }, new String[] { "rocket", "rocketTitle", "rocketDesc", "rocketToast", "rocketIconUrl", "rocketToastUrl", "rocketButtonDesc", "rocketButtonUrl" }, new Object[] { Integer.valueOf(0), "", "", Integer.valueOf(0), "", "", "", "" }, CircleAchievement.class);
