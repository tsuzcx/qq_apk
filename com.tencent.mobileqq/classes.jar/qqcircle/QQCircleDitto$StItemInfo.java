...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 34, 42, 50, 58, 66 }, new String[] { "id", "name", "des", "images", "buttonInfo", "urlInfo", "busiInfo", "relateIds" }, new Object[] { "", "", "", null, null, null, null, "" }, StItemInfo.class);
