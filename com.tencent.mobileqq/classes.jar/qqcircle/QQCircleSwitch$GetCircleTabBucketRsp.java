...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24 }, new String[] { "sws", "isNewRegUid", "expId" }, new Object[] { null, Boolean.valueOf(false), Integer.valueOf(0) }, GetCircleTabBucketRsp.class);
