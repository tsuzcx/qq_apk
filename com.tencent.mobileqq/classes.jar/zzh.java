...
public class zzh
{
  ...
  public zzh(SharedPreferences paramSharedPreferences, String paramString)
  {
  ...
  public static zzh a(JSONObject paramJSONObject)
  {
    zzh localzzh = new zzh();
    try
    {
      localzzh.a = paramJSONObject.getString("name").trim();
      localzzh.b = paramJSONObject.getString("ver").trim();
      localzzh.c = paramJSONObject.getString("system").trim();
      localzzh.d = paramJSONObject.getString("driver").trim();
      localzzh.e = paramJSONObject.getString("url").trim();
      localzzh.f = paramJSONObject.getString("type").trim();
      localzzh.h = paramJSONObject.getString("enabled").trim();
      localzzh.k = paramJSONObject.optString("previousPatch", "").trim();
      return localzzh;
    }
    catch (Exception paramJSONObject)
    {
      zyw.a("PatchInfo", "Parse PatchInfo from JSON exception " + paramJSONObject);
    }
    return null;
  }
  ...
  public JSONObject a()
  {
    ...
    {
      zyw.a("PatchInfo", "Get JSON String failed " + localJSONException);
    }
