...
public class aoec
  extends aods
{
  public aoec(QQAppInterface paramQQAppInterface, FriendListHandler paramFriendListHandler)
  {
  ...
  private void a(FromServiceMsg paramFromServiceMsg, DelFriendResp paramDelFriendResp)
  {
    ...
    ((anmw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).d(String.valueOf(paramDelFriendResp.deluin));
    bajn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramDelFriendResp.deluin + "");
    bdqr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramDelFriendResp.deluin + "");
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a(String.valueOf(paramDelFriendResp.deluin), true);
    paramFromServiceMsg = (axby)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(106);
    if (paramFromServiceMsg != null) {
  ...
  private void a(ToServiceMsg paramToServiceMsg, boolean paramBoolean)
  {
    ...
    bgle.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext(), paramToServiceMsg, i);
    ...
    if (paramAddFriendResp.result == 0)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          for (;;)
          {
            ((anmw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).a().a((String)localObject);
            if (QLog.isColorLevel())
            {
