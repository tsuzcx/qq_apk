...
public class bmxh
{
  private static bmxl jdField_a_of_type_Bmxl;
  private static Object jdField_a_of_type_JavaLangObject;
  private static String jdField_a_of_type_JavaLangString = "";
  private static final HashMap<String, bmxj> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  public static bmxj a(String paramString, int paramInt1, int paramInt2)
  {
    boolean bool = true;
    ...
    for (;;)
    {
      ...
      {
        bmxj localbmxj2 = (bmxj)jdField_a_of_type_JavaUtilHashMap.get(paramString);
        bmxj localbmxj1 = localbmxj2;
        if (localbmxj2 == null)
        {
          localbmxj1 = new bmxj(paramString, 1, paramInt1, paramInt2);
          localbmxj1.a(a());
          jdField_a_of_type_JavaUtilHashMap.put(paramString, localbmxj1);
        }
        return localbmxj1;
      }
      bool = false;
  ...
  public static bmxl a()
  {
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (jdField_a_of_type_Bmxl == null) {
        jdField_a_of_type_Bmxl = new bmxl(new bmxi());
      }
      return jdField_a_of_type_Bmxl;
    }
  }
  ...
  static void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      jdField_b_of_type_JavaLangString = bmxr.jdField_b_of_type_JavaLangString;
    }
  }
  ...
  {
    Object localObject = bmxr.jdField_b_of_type_JavaLangString;
    if (localObject != null)
    {
  ...
  {
    return bigv.a(antf.bg + UUID.randomUUID().toString() + ".jpg");
  }
