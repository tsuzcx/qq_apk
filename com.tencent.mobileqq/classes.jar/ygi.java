  ...
  extends BaseAdapter
{
  ...
  public ygi(SpecailCareListActivity paramSpecailCareListActivity)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (getItemViewType(paramInt) == 1)
    {
      ...
      if (paramView == null)
      {
        localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130970627, paramViewGroup, false);
      ...
      for (;;)
      {
        ...
        paramView = (Button)localView.findViewById(2131370948);
        if (QLog.isColorLevel()) {
          QLog.d("SpecialCare", 2, "getView  friends count = " + paramInt);
        }
        paramViewGroup = (TextView)localView.findViewById(2131364485);
        localObject1 = (TextView)localView.findViewById(2131364492);
        if (paramInt > 0) {
          break;
        }
      ...
      paramViewGroup.setText(2131436883);
    ...
    if (paramView != null)
    {
      ...
      {
        localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130970631, paramViewGroup, false);
        localObject2 = new SpecailCareListActivity.ViewHolder();
        localView.setTag(localObject2);
        ((SpecailCareListActivity.ViewHolder)localObject2).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131362719));
        ((SpecailCareListActivity.ViewHolder)localObject2).jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131363896));
        ((SpecailCareListActivity.ViewHolder)localObject2).jdField_c_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131363898));
        ((SpecailCareListActivity.ViewHolder)localObject2).jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131363901));
        ((SpecailCareListActivity.ViewHolder)localObject2).jdField_b_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131363885));
        ((SpecailCareListActivity.ViewHolder)localObject2).jdField_c_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131371503));
        ((SpecailCareListActivity.ViewHolder)localObject2).jdField_d_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131363799));
        ((SpecailCareListActivity.ViewHolder)localObject2).e = ((ImageView)localView.findViewById(2131363899));
        ((SpecailCareListActivity.ViewHolder)localObject2).f = ((ImageView)localView.findViewById(2131363900));
        ((SpecailCareListActivity.ViewHolder)localObject2).jdField_a_of_type_AndroidViewView = localView.findViewById(2131371504);
        ((SpecailCareListActivity.ViewHolder)localObject2).jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)localView.findViewById(2131363886));
        ((SpecailCareListActivity.ViewHolder)localObject2).jdField_d_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131363894));
        ((SpecailCareListActivity.ViewHolder)localObject2).g = ((ImageView)localView.findViewById(2131363893));
        ((SpecailCareListActivity.ViewHolder)localObject2).h = ((ImageView)localView.findViewById(2131363891));
        ((SpecailCareListActivity.ViewHolder)localObject2).i = ((ImageView)localView.findViewById(2131363887));
        ((SpecailCareListActivity.ViewHolder)localObject2).j = ((ImageView)localView.findViewById(2131363889));
      ...
      default: 
        ...
        if (paramView == null) {
          paramView = this.jdField_a_of_type_ComTencentMobileqqActivitySpecialcareSpecailCareListActivity.getString(2131436026);
        }
        break;
      }
    }
    ...
    for (;;)
    {
      ...
      for (int i = ((Friends)localObject1).netTypeIconId;; i = 0)
      {
        ...
        {
          ((SpecailCareListActivity.ViewHolder)localObject2).jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_ComTencentMobileqqActivitySpecialcareSpecailCareListActivity.getResources().getColorStateList(2131494302));
          ...
          ((SpecailCareListActivity.ViewHolder)localObject2).jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130846110, 0);
          ...
          localLayoutParams1.addRule(1, 2131362719);
          localLayoutParams1.addRule(10);
          localLayoutParams2 = new RelativeLayout.LayoutParams(-2, -2);
          localLayoutParams2.addRule(1, 2131362719);
        ...
        for (;;)
        {
          ...
          break label679;
          paramView = this.jdField_a_of_type_ComTencentMobileqqActivitySpecialcareSpecailCareListActivity.getString(2131436029);
          break label781;
          paramView = this.jdField_a_of_type_ComTencentMobileqqActivitySpecialcareSpecailCareListActivity.getString(2131436030);
          break label781;
          paramView = ContactUtils.a(((Friends)localObject1).netTypeIconId);
          break label781;
          paramInt = 0;
          break label793;
          ((SpecailCareListActivity.ViewHolder)localObject2).jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_ComTencentMobileqqActivitySpecialcareSpecailCareListActivity.getResources().getColorStateList(2131494214));
          break label918;
          if (((Friends)localObject1).isServiceEnabled(EVIPSPEC.E_SP_QQVIP))
          {
            ((SpecailCareListActivity.ViewHolder)localObject2).jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablePadding(this.jdField_a_of_type_ComTencentMobileqqActivitySpecialcareSpecailCareListActivity.jdField_a_of_type_Int);
            ((SpecailCareListActivity.ViewHolder)localObject2).jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130846338, 0);
            break label958;
          }
