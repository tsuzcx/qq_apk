...
public class aiza
  extends aiwj
{
  public aiza(CmGameLoadingFragment paramCmGameLoadingFragment, AppInterface paramAppInterface)
  {
  ...
  public void onDownloadConfirm(CmGameStartChecker.StartCheckParam paramStartCheckParam, aiwk paramaiwk, long paramLong)
  {
    ...
    CmGameLoadingFragment.a(this.a).a(paramStartCheckParam, paramaiwk, paramLong);
  }
  ...
  {
    aizw.a().a(paramStartCheckParam, paramLong, null);
    if (CmGameLoadingFragment.a(this.a) != null) {
    ...
    do
    {
      do
      {
        do
        {
          ...
          aizw.a().a(paramStartCheckParam, paramLong, paramCmGameInitParams);
