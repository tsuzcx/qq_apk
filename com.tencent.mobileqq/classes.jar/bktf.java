...
public abstract class bktf
{
  ...
  protected double b;
  protected int b;
  private long jdField_b_of_type_Long = ((Long)yyw.a().a("SmartCutPicSpacing", Long.valueOf(500L))).longValue();
  ...
  public void a(boolean paramBoolean, int paramInt, bkte parambkte)
  {
    this.jdField_a_of_type_Boolean = paramBoolean;
    this.l = paramInt;
    this.jdField_a_of_type_Bkte = parambkte;
  }
  ...
  public void c(int paramInt)
  {
    if (this.jdField_a_of_type_Bksn != null)
    {
      ...
      {
        this.jdField_a_of_type_Bksn.a(GlUtil.captureFrame(paramInt, this.e, this.f, 0));
