...
public class bfoc
{
  private bfod jdField_a_of_type_Bfod = new bfod();
  private WadlJsBridge jdField_a_of_type_ComTencentOpenWadlWadlJsBridge = new WadlJsBridge(null, null, this.jdField_a_of_type_Bfod);
  
  public void a()
  {
    this.jdField_a_of_type_ComTencentOpenWadlWadlJsBridge.doOnDestroy();
    this.jdField_a_of_type_Bfod = null;
  }
  
  public void a(bfoe parambfoe)
  {
    this.jdField_a_of_type_Bfod.a(parambfoe);
  }
  ...
  public boolean a(String paramString1, String paramString2, int paramInt, ArrayList<WadlResult> paramArrayList)
  {
    ...
    if ((paramString1.equals(localWadlParams.a)) && (paramString2.equals(localWadlParams.b)) && (paramInt == localWadlParams.f) && (!TextUtils.isEmpty(localWadlResult.b)) && (arof.a(localWadlResult.b))) {
      bool1 = false;
    }
    for (;;)
    {
