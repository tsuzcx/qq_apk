  ...
  implements AbsListView.OnScrollListener
{
  ...
  protected Bitmap a(Bitmap paramBitmap)
  {
    ...
    j = (int)(j * f1);
    i = (int)(f1 * i);
    return bfvo.a(paramBitmap, j, j, i);
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Int == 0)
        {
          ...
          this.jdField_a_of_type_Bezl.sendMessage((Message)localObject);
          if (QLog.isColorLevel()) {
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      break;
      label131:
      if ((localObject instanceof rvv))
      {
        localObject = (rvv)localObject;
        if ((((rvv)localObject).a != null) && (((rvv)localObject).a.a != null) && ((((rvv)localObject).a.a.jdField_a_of_type_Int == 1) || (((rvv)localObject).a.a.jdField_a_of_type_Int == 6)) && (!TextUtils.isEmpty(((rvv)localObject).a.a.j)) && (((rvv)localObject).b != null)) {
          ((rvv)localObject).b.setImageBitmap(a(((rvv)localObject).a.a.j, paramBoolean));
        }
      }
    }
  }
