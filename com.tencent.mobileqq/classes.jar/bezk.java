...
public class bezk
  implements bfic
{
  public bezk(ChallengeBragBase paramChallengeBragBase) {}
  ...
  protected void a(Intent paramIntent)
  {
    ...
    if (i != 0)
    {
      ...
      bfhg.e("qqBaseActivity", "onGetNickNameError{KEY_ERROR_CODE:" + i + "; KEY_ERROR_MSG:" + paramIntent.getStringExtra("key_error_msg") + "}");
    }
  ...
  {
    this.a.d();
    bfhg.c("qqBaseActivity", "GetNickNameCallback exception." + paramException.getMessage(), paramException);
    ...
    for (;;)
    {
      ...
      else if ((paramException instanceof IOException))
      {
        ...
        localIntent.putExtra("key_error_msg", bfik.a);
      }
      else
      {
  ...
  public void a(JSONObject paramJSONObject)
  {
    try
    {
      ...
      if (paramJSONObject.length() == 0)
      {
        ...
        paramJSONObject.putExtra("key_error_msg", bfik.c);
        paramJSONObject.putExtra("key_error_detail", alpo.a(2131701883));
        a(paramJSONObject);
        return;
      }
    }
    ...
    {
      bfhg.c("qqBaseActivity", "GetNickNameCallback exception." + paramJSONObject.getMessage(), paramJSONObject);
      paramJSONObject = new Intent();
      paramJSONObject.putExtra("key_error_code", -4);
      paramJSONObject.putExtra("key_error_msg", bfik.b);
      a(paramJSONObject);
      return;
      paramJSONObject = bfhm.a(bfhm.a(paramJSONObject.getJSONObject(0).getString("nick")), 12, true, true);
