  ...
  implements Handler.Callback, Manager
{
  ...
  private avok jdField_a_of_type_Avok;
  avol jdField_a_of_type_Avol;
  ...
  private ConcurrentHashMap<Integer, avok> b = new ConcurrentHashMap();
  ...
  public avod(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Avol = new avoc(paramQQAppInterface, this);
    d();
  }
  ...
  private void a(RedTouchItem paramRedTouchItem, int paramInt)
  {
    ...
    if (localRedTouchItem == null)
    {
      ...
      avom.a(localRedTouchItem, paramRedTouchItem);
    ...
    do
    {
      ...
      j = avom.a(localRedTouchItem.redtouchType);
      k = avom.a(paramRedTouchItem.redtouchType);
      if (k > j)
      {
        localRedTouchItem = new RedTouchItem();
        avom.a(localRedTouchItem, paramRedTouchItem);
  ...
  private void a(RedTouchItem paramRedTouchItem, boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Avol.a(paramRedTouchItem, localRedPointConfig1.redPointId);
  ...
  private void d()
  {
    this.jdField_a_of_type_Avok = new avok();
    this.jdField_a_of_type_Avok.jdField_a_of_type_Int = -1;
    this.b.put(Integer.valueOf(this.jdField_a_of_type_Avok.jdField_a_of_type_Int), this.jdField_a_of_type_Avok);
    avok localavok1 = new avok();
    localavok1.jdField_a_of_type_Int = 10018;
    localavok1.jdField_a_of_type_Avok = this.jdField_a_of_type_Avok;
    this.b.put(Integer.valueOf(localavok1.jdField_a_of_type_Int), localavok1);
    localavok1 = new avok();
    localavok1.jdField_a_of_type_Int = -3;
    localavok1.jdField_a_of_type_Avok = this.jdField_a_of_type_Avok;
    this.b.put(Integer.valueOf(localavok1.jdField_a_of_type_Int), localavok1);
    localavok1.jdField_a_of_type_JavaUtilList = new ArrayList();
    Object localObject1 = new avok();
    ((avok)localObject1).jdField_a_of_type_Int = -7;
    this.b.put(Integer.valueOf(((avok)localObject1).jdField_a_of_type_Int), localObject1);
    ((avok)localObject1).jdField_a_of_type_Avok = localavok1;
    localavok1.jdField_a_of_type_JavaUtilList.add(localObject1);
    ((avok)localObject1).jdField_a_of_type_JavaUtilList = new ArrayList();
    avok localavok2 = new avok();
    localavok2.jdField_a_of_type_Int = -4;
    this.b.put(Integer.valueOf(localavok2.jdField_a_of_type_Int), localavok2);
    localavok2.jdField_a_of_type_Avok = localavok1;
    localavok1.jdField_a_of_type_JavaUtilList.add(localavok2);
    localavok2.jdField_a_of_type_JavaUtilList = new ArrayList();
    Object localObject2 = new avok();
    ((avok)localObject2).jdField_a_of_type_Int = 10015;
    this.b.put(Integer.valueOf(((avok)localObject2).jdField_a_of_type_Int), localObject2);
    ((avok)localObject2).jdField_a_of_type_Avok = ((avok)localObject1);
    ((avok)localObject1).jdField_a_of_type_JavaUtilList.add(localObject2);
    localObject2 = new avok();
    ((avok)localObject2).jdField_a_of_type_Int = 10016;
    this.b.put(Integer.valueOf(((avok)localObject2).jdField_a_of_type_Int), localObject2);
    ((avok)localObject2).jdField_a_of_type_Avok = ((avok)localObject1);
    ((avok)localObject1).jdField_a_of_type_JavaUtilList.add(localObject2);
    localObject2 = new avok();
    ((avok)localObject2).jdField_a_of_type_Int = 100601;
    ((avok)localObject2).jdField_a_of_type_Avok = ((avok)localObject1);
    ((avok)localObject1).jdField_a_of_type_JavaUtilList.add(localObject2);
    this.b.put(Integer.valueOf(100601), localObject2);
    localObject1 = new avok();
    ((avok)localObject1).jdField_a_of_type_Int = 10019;
    this.b.put(Integer.valueOf(((avok)localObject1).jdField_a_of_type_Int), localObject1);
    ((avok)localObject1).jdField_a_of_type_Avok = localavok2;
    localavok2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new avok();
    ((avok)localObject1).jdField_a_of_type_Int = 10020;
    this.b.put(Integer.valueOf(((avok)localObject1).jdField_a_of_type_Int), localObject1);
    ((avok)localObject1).jdField_a_of_type_Avok = localavok2;
    localavok2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new avok();
    ((avok)localObject1).jdField_a_of_type_Int = 10022;
    this.b.put(Integer.valueOf(((avok)localObject1).jdField_a_of_type_Int), localObject1);
    ((avok)localObject1).jdField_a_of_type_Avok = localavok2;
    localavok2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new avok();
    ((avok)localObject1).jdField_a_of_type_Int = 10021;
    this.b.put(Integer.valueOf(((avok)localObject1).jdField_a_of_type_Int), localObject1);
    ((avok)localObject1).jdField_a_of_type_Avok = localavok2;
    localavok2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new avok();
    ((avok)localObject1).jdField_a_of_type_Int = 10023;
    ((avok)localObject1).jdField_a_of_type_Avok = localavok2;
    this.b.put(Integer.valueOf(((avok)localObject1).jdField_a_of_type_Int), localObject1);
    localavok2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new avok();
    ((avok)localObject1).jdField_a_of_type_Int = 10024;
    ((avok)localObject1).jdField_a_of_type_Avok = localavok2;
    this.b.put(Integer.valueOf(((avok)localObject1).jdField_a_of_type_Int), localObject1);
    localavok2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new avok();
    ((avok)localObject1).jdField_a_of_type_Int = 10025;
    ((avok)localObject1).jdField_a_of_type_Avok = localavok2;
    this.b.put(Integer.valueOf(((avok)localObject1).jdField_a_of_type_Int), localObject1);
    localavok2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new avok();
    ((avok)localObject1).jdField_a_of_type_Int = 10026;
    ((avok)localObject1).jdField_a_of_type_Avok = localavok2;
    this.b.put(Integer.valueOf(((avok)localObject1).jdField_a_of_type_Int), localObject1);
    localavok2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localavok2 = new avok();
    localavok2.jdField_a_of_type_Int = -2;
    localavok2.jdField_a_of_type_Avok = this.jdField_a_of_type_Avok;
    this.b.put(Integer.valueOf(localavok2.jdField_a_of_type_Int), localavok2);
    this.jdField_a_of_type_Avok.jdField_a_of_type_JavaUtilList = Arrays.asList(new avok[] { localavok1, localavok2 });
    localavok2.jdField_a_of_type_JavaUtilList = new ArrayList();
    localObject1 = new avok();
    ((avok)localObject1).jdField_a_of_type_Int = 100510;
    this.b.put(Integer.valueOf(((avok)localObject1).jdField_a_of_type_Int), localObject1);
    ((avok)localObject1).jdField_a_of_type_Avok = localavok2;
    localavok2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localavok1 = new avok();
    localavok1.jdField_a_of_type_Int = 10011;
    localavok1.jdField_a_of_type_Avok = ((avok)localObject1);
    this.b.put(Integer.valueOf(localavok1.jdField_a_of_type_Int), localavok1);
    localObject2 = new ArrayList();
    ((List)localObject2).add(localavok1);
    ((avok)localObject1).jdField_a_of_type_JavaUtilList = ((List)localObject2);
    localObject1 = new ArrayList();
    localObject2 = new avok();
    ((avok)localObject2).jdField_a_of_type_Int = 100523;
    ((avok)localObject2).jdField_a_of_type_Avok = localavok1;
    this.b.put(Integer.valueOf(((avok)localObject2).jdField_a_of_type_Int), localObject2);
    ((List)localObject1).add(localObject2);
    localObject2 = new avok();
    ((avok)localObject2).jdField_a_of_type_Int = 100517;
    ((avok)localObject2).jdField_a_of_type_Avok = localavok1;
    this.b.put(Integer.valueOf(((avok)localObject2).jdField_a_of_type_Int), localObject2);
    ((List)localObject1).add(localObject2);
    localavok1.jdField_a_of_type_JavaUtilList = ((List)localObject1);
    localavok1 = new avok();
    localavok1.jdField_a_of_type_Int = -5;
    localavok1.jdField_a_of_type_Avok = localavok2;
    localavok2.jdField_a_of_type_JavaUtilList.add(localavok1);
    localavok1.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.b.put(Integer.valueOf(localavok1.jdField_a_of_type_Int), localavok1);
    localavok1 = new avok();
    localavok1.jdField_a_of_type_Int = -6;
    localavok1.jdField_a_of_type_Avok = localavok2;
    localavok2.jdField_a_of_type_JavaUtilList.add(localavok1);
    localavok1.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.b.put(Integer.valueOf(localavok1.jdField_a_of_type_Int), localavok1);
    localObject1 = new avok();
    ((avok)localObject1).jdField_a_of_type_Int = 10014;
    ((avok)localObject1).jdField_a_of_type_Avok = localavok1;
    localavok1.jdField_a_of_type_JavaUtilList.add(localObject1);
    this.b.put(Integer.valueOf(((avok)localObject1).jdField_a_of_type_Int), localObject1);
    localavok1 = new avok();
    localavok1.jdField_a_of_type_Int = 10013;
    localavok1.jdField_a_of_type_Avok = localavok2;
    localavok2.jdField_a_of_type_JavaUtilList.add(localavok1);
    this.b.put(Integer.valueOf(localavok1.jdField_a_of_type_Int), localavok1);
  }
  ...
  private void e()
  {
    ...
    a();
    ??? = (ConcurrentHashMap)bdcs.a("red_point_configs_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    if (??? != null)
    {
    ...
    try
    {
      ??? = (ConcurrentHashMap)bdcs.a("red_point_info_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      if (??? != null)
      {
        this.c.clear();
        this.c.putAll((Map)???);
  ...
  private void e(int paramInt)
  {
    ...
    if ((localRedTouchItem1 != null) && (localRedTouchItem1.passThroughLevel > 0))
    {
      ...
      {
        avok localavok = (avok)this.b.get(Integer.valueOf(i));
        if ((localavok == null) || (localavok.jdField_a_of_type_Avok == null)) {
          break;
        }
        RedTouchItem localRedTouchItem2 = (RedTouchItem)this.c.get(Integer.valueOf(localavok.jdField_a_of_type_Avok.jdField_a_of_type_Int));
        if (localRedTouchItem2 != null) {
          localRedTouchItem2.unReadFlag = false;
        }
        if (localavok.jdField_a_of_type_Avok.jdField_a_of_type_JavaUtilList != null)
        {
          i = 0;
          while (i < localavok.jdField_a_of_type_Avok.jdField_a_of_type_JavaUtilList.size())
          {
            j = ((avok)localavok.jdField_a_of_type_Avok.jdField_a_of_type_JavaUtilList.get(i)).jdField_a_of_type_Int;
            ...
            if ((localRedTouchItem2 != null) && (localRedTouchItem2.unReadFlag) && (!localRedTouchItem2.isClosed) && (localRedTouchItem2.passThroughLevel > 0)) {
              a(localRedTouchItem2, localavok.jdField_a_of_type_Avok.jdField_a_of_type_Int);
            }
            i += 1;
          }
        }
        i = localavok.jdField_a_of_type_Avok.jdField_a_of_type_Int;
        paramInt += 1;
      }
    }
  }
  ...
  private void f()
  {
    bdcs.a("red_point_info_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.c);
  }
  ...
  private void g()
  {
    ...
    if ((localConcurrentHashMap != null) && (localConcurrentHashMap.size() > 0))
    {
      ...
      {
        ((avon)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(91)).a(localArrayList, false);
        long l = SystemClock.elapsedRealtime();
        aush.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "pull_red_touch_time2", Long.valueOf(l));
      }
      return;
    }
    if (QLog.isColorLevel()) {
    ...
    ((avon)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(91)).a();
  }
  ...
  public String a()
  {
    if (this.jdField_a_of_type_JavaLangString == null) {
      this.jdField_a_of_type_JavaLangString = ((String)aush.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "red_point_config_version", ""));
    }
    if (QLog.isColorLevel()) {
  ...
  public void a()
  {
    if (this.jdField_a_of_type_JavaUtilVector.size() > 0)
    {
      ...
      f();
      this.jdField_a_of_type_Avol.a(this.jdField_a_of_type_JavaUtilVector);
  ...
  public void a(int paramInt, boolean paramBoolean1, long paramLong, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (paramBoolean2 = true;; paramBoolean2 = false)
    {
      ...
      ((avon)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(91)).a(localArrayList);
      return;
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      aush.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "red_point_config_version", paramString);
    }
  }
  ...
  public void a(cmd0x6f5.RspBody paramRspBody)
  {
    ...
    if ((paramRspBody != null) && (paramRspBody.rpt_task_info != null) && (paramRspBody.rpt_task_info.has()))
    {
      ...
      bdcs.a("red_point_configs_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), localConcurrentHashMap);
    }
  }
  ...
  public void a(short paramShort)
  {
    ...
    long l1 = ((Long)aush.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "pull_red_touch_time2", Long.valueOf(0L))).longValue();
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      ...
      for (int i = 0;; i = localRedPointConfig.redPointId)
      {
        ...
        alwx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        this.jdField_a_of_type_Avol.a(Collections.singletonList(paramArrayOfByte));
        return;
      }
