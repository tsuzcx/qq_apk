  ...
  implements avnu, avpb, avpg
{
  ...
  public avod(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Avor = avor.a(paramContext, 1);
    this.jdField_a_of_type_Avor.a(this);
  ...
  private void n()
  {
    TVK_SDKMgr.installPlugin(BaseApplicationImpl.getApplication(), new avol(this));
  }
  ...
  public void a()
  {
    ...
    this.c = true;
    this.h = false;
    this.jdField_a_of_type_Avor.a();
    avpd.a(this.jdField_a_of_type_ComTencentMobileqqHotpicHotVideoMongoliaRelativeLayout.getContext()).b(this);
  ...
  {
    if (paramInt == 1) {
      if (this.jdField_a_of_type_Avor.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer != null)
      {
        this.jdField_a_of_type_Avor.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setDownloadNetworkChange(2);
        localQQAppInterface = (QQAppInterface)BaseApplicationImpl.sApplication.getRuntime();
        if ((this.jdField_a_of_type_Avor.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.isPlaying()) && (!a(localQQAppInterface)))
        {
          b();
          m();
        }
    ...
    while ((paramInt != 4) || (this.jdField_a_of_type_Avor.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer == null))
    {
      QQAppInterface localQQAppInterface;
      return;
    }
    this.jdField_a_of_type_Avor.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setDownloadNetworkChange(1);
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    while (this.jdField_a_of_type_Avor.a() != 6) {
      return;
    }
  ...
  public void a(int paramInt, View paramView)
  {
    ...
    case 0: 
      ...
      for (paramInt = 1;; paramInt = 0)
      {
        ...
        bhdj.a(paramView.getContext(), 232, null, anvx.a(2131707859), new avoh(this, (QQAppInterface)localObject), new avoi(this, (QQAppInterface)localObject)).show();
        return;
      }
    ...
    case 1: 
      if (!this.f)
      {
        this.jdField_a_of_type_Avor.a(null);
        label245:
    ...
    {
      this.jdField_a_of_type_Avor.a(this.jdField_a_of_type_ComTencentMobileqqHotpicHotVideoMongoliaRelativeLayout.jdField_a_of_type_Avnv.jdField_a_of_type_Long, bool);
      this.f = false;
      break label245;
      if (!this.h) {
        break;
      ...
      paramView.append(avny.a(this.jdField_a_of_type_Avor.jdField_a_of_type_Long));
      paramView.append(" / ");
      paramView.append(this.jdField_a_of_type_ComTencentMobileqqHotpicHotVideoMongoliaRelativeLayout.jdField_a_of_type_Avnv.b);
      this.jdField_a_of_type_ComTencentMobileqqHotpicHotVideoMongoliaRelativeLayout.a(paramView.toString());
      return;
      bool = this.jdField_a_of_type_Avor.a();
      if (bool)
      {
        paramView = "0X8007ED7";
        label412:
      ...
      for (bool = true;; bool = false)
      {
        ...
        bdla.b((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "dc00898", "", "", paramView, paramView, 0, 0, "", "", "", "");
      ...
      if ((!this.h) || ((!this.jdField_a_of_type_Avor.b()) && (!this.f))) {
        break;
      }
      paramView = new StringBuilder();
      long l = this.jdField_a_of_type_Avor.a();
      this.jdField_a_of_type_Avor.a();
      this.jdField_a_of_type_ComTencentMobileqqHotpicHotVideoMongoliaRelativeLayout.b(4);
      if (this.jdField_a_of_type_Avor.c == 4) {
        paramView.append(this.jdField_a_of_type_ComTencentMobileqqHotpicHotVideoMongoliaRelativeLayout.jdField_a_of_type_Avnv.b);
      }
      for (;;)
      {
        ...
        c();
        e();
        QLog.d("PresenceInterfaceImpl", 2, "current position is mVideoPlayControl.getCurrentPosition()" + this.jdField_a_of_type_Avor.a());
        return;
        paramView.append(avny.a(l));
      }
      g();
      this.jdField_a_of_type_ComTencentMobileqqHotpicHotVideoMongoliaRelativeLayout.b(3);
      d();
      return;
      this.jdField_a_of_type_ComTencentMobileqqHotpicHotVideoMongoliaRelativeLayout.jdField_a_of_type_ComTencentMobileqqHotpicCircleProgressView.setProgress(this.jdField_a_of_type_Avor.b());
      f();
      this.jdField_a_of_type_ComTencentMobileqqHotpicHotVideoMongoliaRelativeLayout.b(6);
      c();
      e();
      return;
      if ((!this.h) || (!this.jdField_a_of_type_Avor.b())) {
        break;
      }
      this.jdField_a_of_type_Avor.a();
  ...
  public void a(int paramInt1, TVK_IMediaPlayer paramTVK_IMediaPlayer, int paramInt2, int paramInt3, int paramInt4, String paramString, Object paramObject)
  {
    ...
    new bisy(this.jdField_a_of_type_AndroidContentContext).a(HotVideoMongoliaRelativeLayout.jdField_a_of_type_JavaLangString, 100, 0, 1);
  ...
  public void a(View paramView)
  {
    ...
    avpd.a(this.jdField_a_of_type_ComTencentMobileqqHotpicHotVideoMongoliaRelativeLayout.getContext()).a(this);
  }
  ...
  {
    this.jdField_a_of_type_Avor.a(paramBoolean);
  }
  
  boolean a()
  {
    long l = this.jdField_a_of_type_Avor.b();
    if (QLog.isColorLevel()) {
  ...
  public void b()
  {
    if (this.jdField_a_of_type_Avor.a() == 2) {
  ...
  public boolean b()
  {
    return (this.jdField_a_of_type_Avor != null) && (this.jdField_a_of_type_Avor.b());
  }
  ...
  public void c()
  {
    ...
    do
    {
      ...
      {
        return;
      } while (this.jdField_a_of_type_Avor == null);
      this.jdField_a_of_type_Long = this.jdField_a_of_type_Avor.a();
  ...
  public void d(boolean paramBoolean)
  {
    if (!paramBoolean)
    {
      File localFile = new File(avny.a(this.jdField_a_of_type_ComTencentMobileqqHotpicHotVideoMongoliaRelativeLayout.jdField_a_of_type_Avnv.d));
  ...
  public void i()
  {
    ...
    Object localObject;
    boolean bool;
    if ((this.jdField_a_of_type_Avor != null) && (this.jdField_a_of_type_Avor.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer != null))
    {
  ...
  public void k()
  {
    if (this.jdField_a_of_type_Avor.a() == 3) {
  ...
  public void l()
  {
    ...
    bhdj.a(this.jdField_a_of_type_AndroidContentContext, 232, null, this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131697475), new avoj(this), new avok(this)).show();
  }
  
  void m()
  {
    a(bhdj.a(this.jdField_a_of_type_AndroidContentContext, 232, null, this.jdField_a_of_type_AndroidContentContext.getString(2131718853), new avof(this), new avog(this)));
  }
}
