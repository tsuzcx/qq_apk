  ...
  implements Handler.Callback
{
  ...
  public azti(Conversation paramConversation, ViewGroup paramViewGroup)
  {
    ...
    this.jdField_a_of_type_Blmd = new aztl(this);
  ...
  private void a(View paramView1, View paramView2, View paramView3)
  {
    ...
    if (this.jdField_a_of_type_ComNineoldandroidsAnimationValueAnimator == null)
    {
      ...
      this.jdField_a_of_type_ComNineoldandroidsAnimationValueAnimator.addUpdateListener(new aztq(this, paramView2, paramView1, paramView3));
      this.jdField_a_of_type_ComNineoldandroidsAnimationAnimator$AnimatorListener = new aztr(this, paramView3);
    }
  ...
  private void b(View paramView1, View paramView2, View paramView3)
  {
    ...
    if (this.jdField_b_of_type_ComNineoldandroidsAnimationValueAnimator == null)
    {
      ...
      this.jdField_b_of_type_ComNineoldandroidsAnimationValueAnimator.addUpdateListener(new aztj(this, paramView2, paramView1, paramView3));
      this.jdField_b_of_type_ComNineoldandroidsAnimationAnimator$AnimatorListener = new aztk(this, paramView3, paramView1);
    }
  ...
  private void o()
  {
    ...
    do
    {
      ...
      if (this.jdField_d_of_type_Int == 3)
      {
        int j = agej.a(100.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
  ...
  public void b(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidOsCountDownTimer = new aztm(this, arrayOfLong[1], 40L, arrayOfLong);
  ...
  public boolean c()
  {
    ...
    localAlphaAnimation.setAnimationListener(new aztn(this));
    ...
    localTranslateAnimation.setAnimationListener(new azto(this));
    localAnimationSet.addAnimation(localTranslateAnimation);
    localAnimationSet.addAnimation(localAlphaAnimation);
    localAlphaAnimation = new AlphaAnimation(1.0F, 0.0F);
    localAlphaAnimation.setDuration(500L);
    localAlphaAnimation.setStartOffset(1000L);
    localAlphaAnimation.setAnimationListener(new aztp(this));
    localAnimationSet.addAnimation(localAlphaAnimation);
