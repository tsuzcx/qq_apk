...
public class udo
{
  ...
  private udq jdField_a_of_type_Udq = new udq(this.jdField_a_of_type_Udp);
  private udu jdField_a_of_type_Udu = new udu();
  
  public udo(@NonNull Context paramContext)
  {
  ...
  {
    veg.d("StoryPlayerTVKWrapper", "createPlayerVideoInfo, %s", new Object[] { paramString2 });
  ...
  private void b()
  {
    TVK_SDKMgr.setOnLogListener(this.jdField_a_of_type_Udu);
    ...
    veg.d("StoryPlayerTVKWrapper", "TVK version: %s", new Object[] { TVK_SDKMgr.getSdkVersion() });
  }
