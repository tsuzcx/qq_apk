  ...
  implements Handler.Callback, Manager
{
  ...
  private atba jdField_a_of_type_Atba;
  atbb jdField_a_of_type_Atbb;
  ...
  private ConcurrentHashMap<Integer, atba> b = new ConcurrentHashMap();
  ...
  public atax(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Atbb = new ataw(paramQQAppInterface, this);
    d();
  }
  ...
  private void a(RedTouchItem paramRedTouchItem, int paramInt)
  {
    ...
    if (localRedTouchItem == null)
    {
      ...
      atbc.a(localRedTouchItem, paramRedTouchItem);
    ...
    do
    {
      ...
      j = atbc.a(localRedTouchItem.redtouchType);
      k = atbc.a(paramRedTouchItem.redtouchType);
      if (k > j)
      {
        localRedTouchItem = new RedTouchItem();
        atbc.a(localRedTouchItem, paramRedTouchItem);
  ...
  private void a(RedTouchItem paramRedTouchItem, boolean paramBoolean)
  {
    if (paramRedTouchItem != null) {
      QLog.i("LocalRedTouchManager", 1, "handleRedPoint, taskId=" + paramRedTouchItem.taskId + ", saveToFile=" + paramBoolean + " seq=" + paramRedTouchItem.curSeq + ", count=" + paramRedTouchItem.count);
    }
    ...
    {
      this.jdField_a_of_type_Atbb.a(paramRedTouchItem, localRedPointConfig1.redPointId);
  ...
  private void d()
  {
    this.jdField_a_of_type_Atba = new atba();
    this.jdField_a_of_type_Atba.jdField_a_of_type_Int = -1;
    this.b.put(Integer.valueOf(this.jdField_a_of_type_Atba.jdField_a_of_type_Int), this.jdField_a_of_type_Atba);
    atba localatba1 = new atba();
    localatba1.jdField_a_of_type_Int = 10018;
    localatba1.jdField_a_of_type_Atba = this.jdField_a_of_type_Atba;
    this.b.put(Integer.valueOf(localatba1.jdField_a_of_type_Int), localatba1);
    atba localatba2 = new atba();
    localatba2.jdField_a_of_type_Int = -3;
    localatba2.jdField_a_of_type_Atba = this.jdField_a_of_type_Atba;
    this.b.put(Integer.valueOf(localatba2.jdField_a_of_type_Int), localatba2);
    localatba2.jdField_a_of_type_JavaUtilList = new ArrayList();
    Object localObject1 = new atba();
    ((atba)localObject1).jdField_a_of_type_Int = -7;
    this.b.put(Integer.valueOf(((atba)localObject1).jdField_a_of_type_Int), localObject1);
    ((atba)localObject1).jdField_a_of_type_Atba = localatba2;
    localatba2.jdField_a_of_type_JavaUtilList.add(localObject1);
    ((atba)localObject1).jdField_a_of_type_JavaUtilList = new ArrayList();
    localatba1 = new atba();
    localatba1.jdField_a_of_type_Int = -4;
    this.b.put(Integer.valueOf(localatba1.jdField_a_of_type_Int), localatba1);
    localatba1.jdField_a_of_type_Atba = localatba2;
    localatba2.jdField_a_of_type_JavaUtilList.add(localatba1);
    localatba1.jdField_a_of_type_JavaUtilList = new ArrayList();
    Object localObject2 = new atba();
    ((atba)localObject2).jdField_a_of_type_Int = 10015;
    this.b.put(Integer.valueOf(((atba)localObject2).jdField_a_of_type_Int), localObject2);
    ((atba)localObject2).jdField_a_of_type_Atba = ((atba)localObject1);
    ((atba)localObject1).jdField_a_of_type_JavaUtilList.add(localObject2);
    localObject2 = new atba();
    ((atba)localObject2).jdField_a_of_type_Int = 10016;
    this.b.put(Integer.valueOf(((atba)localObject2).jdField_a_of_type_Int), localObject2);
    ((atba)localObject2).jdField_a_of_type_Atba = ((atba)localObject1);
    ((atba)localObject1).jdField_a_of_type_JavaUtilList.add(localObject2);
    localObject2 = new atba();
    ((atba)localObject2).jdField_a_of_type_Int = 100601;
    ((atba)localObject2).jdField_a_of_type_Atba = ((atba)localObject1);
    ((atba)localObject1).jdField_a_of_type_JavaUtilList.add(localObject2);
    this.b.put(Integer.valueOf(100601), localObject2);
    localObject1 = new atba();
    ((atba)localObject1).jdField_a_of_type_Int = 10019;
    this.b.put(Integer.valueOf(((atba)localObject1).jdField_a_of_type_Int), localObject1);
    ((atba)localObject1).jdField_a_of_type_Atba = localatba1;
    localatba1.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new atba();
    ((atba)localObject1).jdField_a_of_type_Int = 10020;
    this.b.put(Integer.valueOf(((atba)localObject1).jdField_a_of_type_Int), localObject1);
    ((atba)localObject1).jdField_a_of_type_Atba = localatba1;
    localatba1.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new atba();
    ((atba)localObject1).jdField_a_of_type_Int = 10022;
    this.b.put(Integer.valueOf(((atba)localObject1).jdField_a_of_type_Int), localObject1);
    ((atba)localObject1).jdField_a_of_type_Atba = localatba1;
    localatba1.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new atba();
    ((atba)localObject1).jdField_a_of_type_Int = 10021;
    this.b.put(Integer.valueOf(((atba)localObject1).jdField_a_of_type_Int), localObject1);
    ((atba)localObject1).jdField_a_of_type_Atba = localatba1;
    localatba1.jdField_a_of_type_JavaUtilList.add(localObject1);
    localatba1 = new atba();
    localatba1.jdField_a_of_type_Int = -2;
    localatba1.jdField_a_of_type_Atba = this.jdField_a_of_type_Atba;
    this.b.put(Integer.valueOf(localatba1.jdField_a_of_type_Int), localatba1);
    this.jdField_a_of_type_Atba.jdField_a_of_type_JavaUtilList = Arrays.asList(new atba[] { localatba2, localatba1 });
    localatba1.jdField_a_of_type_JavaUtilList = new ArrayList();
    localObject1 = new atba();
    ((atba)localObject1).jdField_a_of_type_Int = 100510;
    this.b.put(Integer.valueOf(((atba)localObject1).jdField_a_of_type_Int), localObject1);
    ((atba)localObject1).jdField_a_of_type_Atba = localatba1;
    localatba1.jdField_a_of_type_JavaUtilList.add(localObject1);
    localatba2 = new atba();
    localatba2.jdField_a_of_type_Int = 10011;
    localatba2.jdField_a_of_type_Atba = ((atba)localObject1);
    this.b.put(Integer.valueOf(localatba2.jdField_a_of_type_Int), localatba2);
    localObject2 = new ArrayList();
    ((List)localObject2).add(localatba2);
    ((atba)localObject1).jdField_a_of_type_JavaUtilList = ((List)localObject2);
    localObject1 = new ArrayList();
    localObject2 = new atba();
    ((atba)localObject2).jdField_a_of_type_Int = 100523;
    ((atba)localObject2).jdField_a_of_type_Atba = localatba2;
    this.b.put(Integer.valueOf(((atba)localObject2).jdField_a_of_type_Int), localObject2);
    ((List)localObject1).add(localObject2);
    localObject2 = new atba();
    ((atba)localObject2).jdField_a_of_type_Int = 100517;
    ((atba)localObject2).jdField_a_of_type_Atba = localatba2;
    this.b.put(Integer.valueOf(((atba)localObject2).jdField_a_of_type_Int), localObject2);
    ((List)localObject1).add(localObject2);
    localatba2.jdField_a_of_type_JavaUtilList = ((List)localObject1);
    localatba2 = new atba();
    localatba2.jdField_a_of_type_Int = -5;
    localatba2.jdField_a_of_type_Atba = localatba1;
    localatba1.jdField_a_of_type_JavaUtilList.add(localatba2);
    localatba2.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.b.put(Integer.valueOf(localatba2.jdField_a_of_type_Int), localatba2);
    localatba2 = new atba();
    localatba2.jdField_a_of_type_Int = -6;
    localatba2.jdField_a_of_type_Atba = localatba1;
    localatba1.jdField_a_of_type_JavaUtilList.add(localatba2);
    localatba2.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.b.put(Integer.valueOf(localatba2.jdField_a_of_type_Int), localatba2);
    localObject1 = new atba();
    ((atba)localObject1).jdField_a_of_type_Int = 10014;
    ((atba)localObject1).jdField_a_of_type_Atba = localatba2;
    localatba2.jdField_a_of_type_JavaUtilList.add(localObject1);
    this.b.put(Integer.valueOf(((atba)localObject1).jdField_a_of_type_Int), localObject1);
    localatba2 = new atba();
    localatba2.jdField_a_of_type_Int = 10013;
    localatba2.jdField_a_of_type_Atba = localatba1;
    localatba1.jdField_a_of_type_JavaUtilList.add(localatba2);
    this.b.put(Integer.valueOf(localatba2.jdField_a_of_type_Int), localatba2);
  }
  ...
  private void e()
  {
    ...
    a();
    ??? = (ConcurrentHashMap)bace.a("red_point_configs_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    if (??? != null)
    {
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.clear();
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.putAll((Map)???);
    }
    ??? = (ConcurrentHashMap)bace.a("red_point_info_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    if (??? != null)
    {
      this.c.clear();
      this.c.putAll((Map)???);
  ...
  private void e(int paramInt)
  {
    ...
    if ((localRedTouchItem1 != null) && (localRedTouchItem1.passThroughLevel > 0))
    {
      ...
      {
        atba localatba = (atba)this.b.get(Integer.valueOf(i));
        if ((localatba == null) || (localatba.jdField_a_of_type_Atba == null)) {
          break;
        }
        RedTouchItem localRedTouchItem2 = (RedTouchItem)this.c.get(Integer.valueOf(localatba.jdField_a_of_type_Atba.jdField_a_of_type_Int));
        if (localRedTouchItem2 != null) {
          localRedTouchItem2.unReadFlag = false;
        }
        if (localatba.jdField_a_of_type_Atba.jdField_a_of_type_JavaUtilList != null)
        {
          i = 0;
          while (i < localatba.jdField_a_of_type_Atba.jdField_a_of_type_JavaUtilList.size())
          {
            j = ((atba)localatba.jdField_a_of_type_Atba.jdField_a_of_type_JavaUtilList.get(i)).jdField_a_of_type_Int;
            ...
            if ((localRedTouchItem2 != null) && (localRedTouchItem2.unReadFlag) && (!localRedTouchItem2.isClosed) && (localRedTouchItem2.passThroughLevel > 0)) {
              a(localRedTouchItem2, localatba.jdField_a_of_type_Atba.jdField_a_of_type_Int);
            }
            i += 1;
          }
        }
        i = localatba.jdField_a_of_type_Atba.jdField_a_of_type_Int;
        paramInt += 1;
      }
    }
  }
  ...
  private void f()
  {
    bace.a("red_point_info_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.c);
  }
  ...
  private void g()
  {
    ...
    if ((localConcurrentHashMap != null) && (localConcurrentHashMap.size() > 0))
    {
      ...
      {
        ((atbd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(91)).a(localArrayList, false);
        long l = SystemClock.elapsedRealtime();
        asfc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "pull_red_touch_time2", Long.valueOf(l));
      }
      return;
    }
    if (QLog.isColorLevel()) {
    ...
    ((atbd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(91)).a();
  }
  ...
  public String a()
  {
    if (this.jdField_a_of_type_JavaLangString == null) {
      this.jdField_a_of_type_JavaLangString = ((String)asfc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "red_point_config_version", ""));
    }
    if (QLog.isColorLevel()) {
  ...
  public void a()
  {
    if (this.jdField_a_of_type_JavaUtilVector.size() > 0)
    {
      ...
      f();
      this.jdField_a_of_type_Atbb.a(this.jdField_a_of_type_JavaUtilVector);
  ...
  public void a(int paramInt, boolean paramBoolean1, long paramLong, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (paramBoolean2 = true;; paramBoolean2 = false)
    {
      ...
      ((atbd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(91)).a(localArrayList);
      return;
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      asfc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "red_point_config_version", paramString);
    }
  }
  ...
  public void a(cmd0x6f5.RspBody paramRspBody)
  {
    ...
    if ((paramRspBody != null) && (paramRspBody.rpt_task_info != null) && (paramRspBody.rpt_task_info.has()))
    {
      ...
      bace.a("red_point_configs_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), localConcurrentHashMap);
    }
  }
  ...
  public void a(short paramShort)
  {
    ...
    long l1 = ((Long)asfc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "pull_red_touch_time2", Long.valueOf(0L))).longValue();
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      ...
      for (int i = 0;; i = localRedPointConfig.redPointId)
      {
        ...
        ajqy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        this.jdField_a_of_type_Atbb.a(Collections.singletonList(paramArrayOfByte));
        return;
      }
