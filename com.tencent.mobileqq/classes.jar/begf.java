...
public class begf
  implements bege
{
  private bege jdField_a_of_type_Bege;
  
  public begf(AbsListView paramAbsListView) {}
  
  public void a(ActionMode paramActionMode, int paramInt, long paramLong, boolean paramBoolean)
  {
    this.jdField_a_of_type_Bege.a(paramActionMode, paramInt, paramLong, paramBoolean);
    if (this.jdField_a_of_type_ComTencentWidgetAbsListView.getCheckedItemCount() == 0) {
      paramActionMode.finish();
    }
  }
  
  public void a(bege parambege)
  {
    this.jdField_a_of_type_Bege = parambege;
  }
  
  public boolean onActionItemClicked(ActionMode paramActionMode, MenuItem paramMenuItem)
  {
    return this.jdField_a_of_type_Bege.onActionItemClicked(paramActionMode, paramMenuItem);
  }
  
  public boolean onCreateActionMode(ActionMode paramActionMode, Menu paramMenu)
  {
    boolean bool = false;
    if (this.jdField_a_of_type_Bege.onCreateActionMode(paramActionMode, paramMenu))
    {
  ...
  {
    this.jdField_a_of_type_Bege.onDestroyActionMode(paramActionMode);
  ...
  {
    return this.jdField_a_of_type_Bege.onPrepareActionMode(paramActionMode, paramMenu);
  }
}
