  ...
  extends SpannableStringBuilder
{
  ...
  static
  {
    jdField_a_of_type_AndroidTextEditable$Factory = new begg();
  }
  
  public begf(CharSequence paramCharSequence, int paramInt)
  {
  ...
  {
    if ((paramCharSequence instanceof begb)) {
      return ((begb)paramCharSequence).a();
    }
    return new begb(paramCharSequence, paramInt).a();
  }
  ...
  public SpannableStringBuilder replace(int paramInt1, int paramInt2, CharSequence paramCharSequence, int paramInt3, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      i = paramInt2;
      localObject = new begb(paramCharSequence, this.jdField_a_of_type_Int).a();
