  ...
  extends bgyv
{
  ...
  public bgyx(bgys parambgys, int paramInt)
  {
    super(parambgys, paramInt);
    this.jdField_b_of_type_ComTencentMobileqqHighwayApiITransactionCallback = new bgyy(this);
  }
  
  public void a()
  {
    String str1 = this.jdField_a_of_type_Bgys.jdField_b_of_type_JavaLangString;
    String str2 = this.jdField_a_of_type_Bgys.jdField_a_of_type_JavaLangString;
  ...
  protected boolean b(String paramString)
  {
    ...
    {
      arrayOfByte = apmf.a(paramString);
    ...
    do
    {
      ...
      localPttShortVideoFileInfo.uint32_file_time.set((int)this.jdField_a_of_type_Bgys.jdField_a_of_type_Long);
