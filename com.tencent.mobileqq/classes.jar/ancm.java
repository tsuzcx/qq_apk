...
public class ancm
{
  public static void a(anca paramanca, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((!paramFromServiceMsg.isSuccess()) || (paramObject == null))
    {
      ...
      paramanca.notifyUI(121, false, new Object[] { null, null });
      return;
    }
    try
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d(".troop.troopManagerTroopHandler", 2, new Object[] { "handleTroopBulkSendMessageRespond, ", yps.a(localRspSend1V1Msg) });
      }
      paramanca.notifyUI(121, true, new Object[] { localRspSend1V1Msg, localReqSend1V1Msg });
      return;
    }
  ...
  public static void a(@NonNull anca paramanca, @NonNull homework.ReqSend1V1Msg paramReqSend1V1Msg)
  {
    if (QLog.isColorLevel()) {
      QLog.i(".troop.troopManagerTroopHandler", 2, "sendTroopBulkSendMessageRequest");
    }
    ToServiceMsg localToServiceMsg = paramanca.createToServiceMsg("HwSvc.send_msg");
    localToServiceMsg.putWupBuffer(paramReqSend1V1Msg.toByteArray());
    paramanca.a(localToServiceMsg);
  }
}
