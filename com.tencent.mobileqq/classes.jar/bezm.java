...
public class bezm
{
  ...
  private static void a(Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4, bezx parambezx, int paramInt)
  {
    paramActivity = new FreeWifiHelper.5(paramActivity, paramString1, paramString2, paramString3, paramString4, new bezq(paramInt, paramActivity, parambezx), new bezr(parambezx, paramInt), new bezs(parambezx, paramInt), paramInt);
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      do
      {
        ...
        localObject = bfac.a(localBaseApplication, str);
        if (QLog.isColorLevel()) {
      ...
      return;
      long l = bfac.c(localBaseApplication, str);
    ...
    Object localObject = new amfw(paramQQAppInterface);
    amfx localamfx = new amfx(paramQQAppInterface);
    localamfx.a(new bezo(paramQQAppInterface, localamfx));
    paramQQAppInterface.addObserver(localamfx);
    ((amfw)localObject).a(2);
    bfac.c(localBaseApplication, str, System.currentTimeMillis());
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, ConfigurationService.Config paramConfig)
  {
    ...
    int j = bdne.a(paramQQAppInterface.getApp(), "wifi_connect_config_version", str);
    if (QLog.isColorLevel()) {
    ...
    if (i != j)
    {
      bdne.a(paramQQAppInterface.getApp(), "wifi_connect_config_version", str, i);
      paramConfig = aozj.b(paramConfig, j, paramInt);
      if (!TextUtils.isEmpty(paramConfig))
      {
        ...
        try
        {
          ...
          {
            e = bool;
            bdne.a(paramQQAppInterface.getApp(), paramQQAppInterface.c(), c, d, e);
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    try
    {
      if (((d) || (e)) && (Conversation.b > 0L))
      {
        ...
        long l2 = bfac.a((Context)localObject, str);
        long l3 = bfac.b((Context)localObject, str) * 60 * 60 * 1000L;
        if (QLog.isColorLevel()) {
        ...
        bfac.a((Context)localObject, str, l1);
        amfw localamfw = new amfw(paramQQAppInterface);
        amfx localamfx = new amfx(paramQQAppInterface);
        localamfx.a(new bezn((Context)localObject, str, paramQQAppInterface, localamfx));
        paramQQAppInterface.addObserver(localamfx);
        localamfw.a(1);
      }
    }
  ...
  public static boolean a(Activity paramActivity, int paramInt, bezx parambezx)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt == 1)
      {
        str1 = paramActivity.getString(2131692802);
        str2 = paramActivity.getString(2131692805);
        i = 1;
      }
      while (i != 0)
      {
        String str5 = paramActivity.getString(2131692808);
        String str4 = bfac.a(paramActivity);
        String str3 = str4;
        if (TextUtils.isEmpty(str4)) {
          str3 = paramActivity.getString(2131692801);
        }
        QLog.i("WifiSdk", 2, "shouldOverrideDialog btn1Text: " + str3);
        a(paramActivity, str5, str1, str3, str2, parambezx, paramInt);
        return false;
        if ((paramInt == 2) || (paramInt == 4))
        {
          str1 = paramActivity.getString(2131692804);
          str2 = paramActivity.getString(2131692807);
          i = 1;
        }
        else if (paramInt == 3)
        {
          str1 = paramActivity.getString(2131692803);
          str2 = paramActivity.getString(2131692806);
          i = 1;
        }
        else if (paramInt == 5)
        {
          str1 = paramActivity.getString(2131692757);
          str2 = paramActivity.getString(2131692807);
          i = 1;
        }
        else
  ...
  public static boolean a(Context paramContext)
  {
    ...
    try
    {
      ...
      if (!TMSDKWifiManager.init(paramContext.getApplicationContext(), new TMSDKCustomConfig().setCustomToast(new bezw()).setCustomInstaller(new bezv()).setCustomThreadPool(new bezu()).setCustomReporter(new bezt()))) {
        bool = true;
      }
      b = bool;
      WifiSDKUIApi.init(new bezz(), new bfaa());
    }
  ...
  public static void b(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      str = paramQQAppInterface.getCurrentAccountUin();
      localBaseApplication = paramQQAppInterface.getApp();
      long l = bfac.b(localBaseApplication, str);
      if ((l == -1L) || (System.currentTimeMillis() - l >= 86400000L)) {
        break;
      }
    } while (!QLog.isColorLevel());
    ...
    amfw localamfw = new amfw(paramQQAppInterface);
    amfx localamfx = new amfx(paramQQAppInterface);
    localamfx.a(new bezp(paramQQAppInterface, localamfx));
    paramQQAppInterface.addObserver(localamfx);
    localamfw.a(3);
    bfac.b(localBaseApplication, str, System.currentTimeMillis());
  }
  ...
  public static void c(Context paramContext, int paramInt)
  {
    ...
    bfab localbfab = bfab.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime());
    if (QLog.isColorLevel()) {
      QLog.i("WifiSdk", 2, "dialog click, jumpType: " + localbfab.jdField_a_of_type_Int + " jumpUrl: " + localbfab.jdField_a_of_type_JavaLangString);
    }
    if (WifiSDKUIApi.isWiFiManagerExist())
    {
      if (localbfab.jdField_a_of_type_Int == 4)
      {
    ...
    switch (localbfab.jdField_a_of_type_Int)
    {
    case 4: 
    default: 
      a(paramContext, paramInt);
      ...
      return;
    case 1: 
      a(paramContext, localbfab.jdField_a_of_type_JavaLangString);
