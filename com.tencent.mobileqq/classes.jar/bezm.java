...
public class bezm
{
  ...
  private static Map<String, bezn> b;
  ...
  public static List<bezn> a()
  {
    ...
    if ((localObject != null) && (!((Map)localObject).isEmpty()))
    {
      ...
      {
        bezn localbezn = (bezn)((Iterator)localObject).next();
        if (localbezn.jdField_a_of_type_Int >= 0) {
          localArrayList.add(localbezn);
        }
      }
  ...
  public static Map<String, bezn> a()
  {
    if (b == null) {
      a();
    }
  ...
  {
    String str = bace.a(new File(a(), "vipComic_nav_config.json"));
      ...
      try
      {
        ...
        if (localJSONObject1 != null)
        {
          ...
          if (localIterator.hasNext())
          {
            ...
            if ((localJSONObject2 == null) || (!bbdc.a(localJSONObject2, str))) {
              break label247;
            }
            localObject = new bezn();
            ((bezn)localObject).jdField_a_of_type_JavaLangString = localJSONObject2.optString("tabKey");
            if ((TextUtils.isEmpty(((bezn)localObject).jdField_a_of_type_JavaLangString)) && (jdField_a_of_type_JavaUtilMap.containsKey(str))) {
              ((bezn)localObject).jdField_a_of_type_JavaLangString = ((String)jdField_a_of_type_JavaUtilMap.get(str));
            }
            ((bezn)localObject).jdField_a_of_type_Int = localJSONObject2.optInt("sequence");
            ((bezn)localObject).b = localJSONObject2.optString("tabName");
            ((bezn)localObject).c = localJSONObject2.optString("tabUrl");
            ((bezn)localObject).d = localJSONObject2.optString("tabIcon");
    ...
    if ((localObject1 != null) && (!((Map)localObject1).isEmpty()))
    {
      ...
      if ((localObject2 != null) && (localObject2.length > 0))
      {
        ...
        while (((Iterator)localObject1).hasNext()) {
          if (!((List)localObject2).contains(((bezn)((Iterator)localObject1).next()).d)) {
            return false;
          }
        }
        return true;
