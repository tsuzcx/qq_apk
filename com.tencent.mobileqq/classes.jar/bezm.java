...
public class bezm
  extends Handler
{
  public bezm(TroopBarReplyActivity paramTroopBarReplyActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
        ...
        do
        {
          do
          {
            ...
            case 1001: 
              ...
              QQToast.a(this.a, 2131696003, 1).b(this.a.getTitleBarHeight());
            }
    ...
    {
      this.a.requestPermissions(new bezn(this), 1, new String[] { "android.permission.RECORD_AUDIO" });
      return;
    }
