...
{
  private agad(PersonalityLabelGalleryActivity paramPersonalityLabelGalleryActivity) {}
  
  private void a(agac paramagac, PersonalityLabelInfo paramPersonalityLabelInfo)
  {
    if (this.a.jdField_b_of_type_Boolean)
    {
      if (paramagac.jdField_a_of_type_AndroidWidgetImageView.getVisibility() != 8) {
        paramagac.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      }
      if (paramagac.jdField_b_of_type_AndroidWidgetImageView.getVisibility() != 0) {
        paramagac.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
      }
      if (paramagac.jdField_d_of_type_AndroidWidgetImageView.getVisibility() != 8) {
        paramagac.jdField_d_of_type_AndroidWidgetImageView.setVisibility(8);
      }
      if (paramagac.jdField_c_of_type_AndroidWidgetImageView.getVisibility() != 0) {
        paramagac.jdField_c_of_type_AndroidWidgetImageView.setVisibility(0);
      }
      paramagac.jdField_b_of_type_AndroidViewView.setTag(paramPersonalityLabelInfo);
      paramagac.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
      paramagac.jdField_b_of_type_AndroidViewView.setTag(2131370801, Integer.valueOf(4));
      paramagac.jdField_b_of_type_AndroidViewView.setTag(2131362722, paramagac);
      paramagac = paramagac.jdField_b_of_type_AndroidWidgetImageView;
      if (!this.a.jdField_b_of_type_Boolean) {
        break label384;
      }
    }
    ...
    {
      paramagac.setImageResource(i);
      return;
      if (PersonalityLabelGalleryActivity.a(this.a))
      {
        if (paramagac.jdField_a_of_type_AndroidWidgetImageView.getVisibility() != 0) {
          paramagac.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
        }
        if (paramagac.jdField_b_of_type_AndroidWidgetImageView.getVisibility() != 0) {
          paramagac.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
        }
        ...
        if (paramagac.jdField_c_of_type_AndroidWidgetImageView.getVisibility() != 8) {
          paramagac.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
        }
        paramagac.jdField_b_of_type_AndroidViewView.setTag(paramPersonalityLabelInfo);
        paramagac.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
        paramagac.jdField_b_of_type_AndroidViewView.setTag(2131370801, Integer.valueOf(1));
        break;
      }
      if (paramagac.jdField_a_of_type_AndroidWidgetImageView.getVisibility() != 8) {
        paramagac.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      }
      if (paramagac.jdField_b_of_type_AndroidWidgetImageView.getVisibility() != 8) {
        paramagac.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
      }
      if (paramagac.jdField_d_of_type_AndroidWidgetImageView.getVisibility() != 0) {
        paramagac.jdField_d_of_type_AndroidWidgetImageView.setVisibility(0);
      }
      if (paramagac.jdField_c_of_type_AndroidWidgetImageView.getVisibility() != 8) {
        paramagac.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
      }
      paramagac.jdField_b_of_type_AndroidViewView.setTag(paramPersonalityLabelInfo);
      paramagac.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
      paramagac.jdField_b_of_type_AndroidViewView.setTag(2131370801, Integer.valueOf(3));
      break;
    }
  }
  ...
  public void a(PersonalityLabelInfo paramPersonalityLabelInfo)
  {
    ...
    localBundle.putString("key_title", this.a.getString(2131432688));
  ...
  void a(PersonalityLabelInfo paramPersonalityLabelInfo, agac paramagac)
  {
    String str = paramagac.jdField_b_of_type_AndroidWidgetTextView.getText().toString();
    if (paramPersonalityLabelInfo.praiseCount > 0L)
    {
      ...
      if (!TextUtils.equals(paramPersonalityLabelInfo, str)) {
        paramagac.jdField_b_of_type_AndroidWidgetTextView.setText(paramPersonalityLabelInfo);
      }
      paramPersonalityLabelInfo = paramagac.jdField_b_of_type_AndroidWidgetTextView;
      if (!this.a.jdField_b_of_type_Boolean) {
        break label375;
      }
    }
    ...
    for (float f = 0.5F;; f = 1.0F)
    {
      ...
      return;
      paramPersonalityLabelInfo = this.a.getResources().getString(2131439057);
      break;
    }
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = this.a.getLayoutInflater().inflate(2130970469, paramViewGroup, false);
      paramViewGroup = new agac(null);
      paramViewGroup.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131370806);
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370796));
      paramViewGroup.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131370800);
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131370801));
      paramViewGroup.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131370802));
      paramViewGroup.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131362722));
      paramViewGroup.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131370803));
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelGlowCountRecyclerView = ((GlowCountRecyclerView)paramView.findViewById(2131362990));
      paramViewGroup.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370805));
      paramViewGroup.jdField_c_of_type_AndroidViewView = paramView.findViewById(2131370389);
      paramViewGroup.jdField_d_of_type_AndroidViewView = paramView.findViewById(2131362823);
      paramViewGroup.jdField_c_of_type_AndroidViewView.setOnClickListener(this);
      paramViewGroup.jdField_c_of_type_AndroidViewView.setTag(2131370801, Integer.valueOf(5));
      if (!PersonalityLabelGalleryActivity.a(this.a)) {
      ...
      localObject1 = new agab(this.a, null);
      ...
      localObject2 = (Integer)paramViewGroup.jdField_a_of_type_AndroidViewView.getTag(2131370796);
      if ((localObject2 == null) || (((Integer)localObject2).intValue() != ((PersonalityLabelInfo)localObject1).bgColor))
      {
        ...
        paramViewGroup.jdField_a_of_type_AndroidViewView.setTag(2131370796, Integer.valueOf(((PersonalityLabelInfo)localObject1).bgColor));
      }
      ...
      paramViewGroup.jdField_b_of_type_AndroidViewView.setTag(2131370805, paramViewGroup);
      if (!PersonalityLabelGalleryActivity.a(this.a))
      {
        if (((PersonalityLabelInfo)localObject1).praiseFlag <= 0) {
          break label820;
        }
        paramViewGroup.jdField_d_of_type_AndroidWidgetImageView.setImageResource(2130842873);
      }
      if (PersonalityLabelGalleryActivity.a(this.a))
      {
        ...
        paramViewGroup.jdField_b_of_type_AndroidWidgetTextView.setTag(2131370801, Integer.valueOf(2));
      }
      ...
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelGlowCountRecyclerView.setAdapter(new agaj(this.a, ((PersonalityLabelInfo)localObject1).id));
      ...
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelGlowCountRecyclerView.setOnScrollListener(new agae(this, (PersonalityLabelInfo)localObject1));
      label684:
    ...
    for (paramInt = i;; paramInt = -2)
    {
      ...
      if (this.a.jdField_a_of_type_JavaUtilHashSet.size() > 0) {
        this.a.jdField_b_of_type_AndroidOsHandler.post(new agaf(this));
      }
      return paramView;
      paramViewGroup = (agac)paramView.getTag();
      break;
      paramViewGroup.jdField_d_of_type_AndroidWidgetImageView.setImageResource(2130842861);
      break label435;
      bool1 = false;
      break label524;
      paramInt = 8;
  ...
  {
    Object localObject1 = paramView.getTag(2131370801);
    int i;
    if ((localObject1 != null) && ((localObject1 instanceof Integer)))
    {
      ...
      if (localObject1 != null)
      {
        ...
        paramView.c("从空间相册选择");
        paramView.d("取消");
        paramView.a(new agag(this, (PersonalityLabelInfo)localObject1, paramView));
        paramView.show();
    ...
    for (;;)
    {
      ...
      for (localObject1 = ((PersonalityLabelZan)localObject2).nick;; localObject1 = ContactUtils.a(this.a.app, this.a.app.getCurrentAccountUin()))
      {
        ...
        a(localPersonalityLabelInfo, (agac)paramView.getTag(2131370805));
        ((ImageView)paramView.findViewById(2131370803)).setImageResource(2130842873);
      ...
      if (i == 4)
      {
        ...
        {
          DialogUtil.a(this.a, (String)localObject1, 2131432998, 2131434722, new agah(this, paramView, (PersonalityLabelInfo)localObject2), new agai(this)).show();
          return;
        }
      }
      if (i != 5) {
