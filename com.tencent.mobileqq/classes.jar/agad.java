      ...
      do
      {
        do
        {
          ...
          do
          {
            do
            {
              ...
              do
              {
                do
                {
                  ...
                  {
                    if (this.a.jdField_a_of_type_Agau.jdField_b_of_type_JavaUtilList.contains(str)) {
                      this.a.jdField_a_of_type_Agau.jdField_b_of_type_JavaUtilList.remove(str);
                    }
                    for (;;)
                    {
                      ChatHistoryTroopMemberFragment.a(this.a);
                      this.a.jdField_a_of_type_Agau.notifyDataSetChanged();
                      return;
                      if (i != 0) {
                        this.a.jdField_a_of_type_Agau.jdField_b_of_type_JavaUtilList.add(str);
                      }
                    }
                  }
                  if (!bool1) {
            ...
            this.a.u = "";
            return;
          } while ((j != 2131363571) || (!this.a.jdField_f_of_type_Boolean));
          if (QLog.isColorLevel()) {
        ...
        bcql.a(this.a.getActivity(), this.a.getString(2131694610), 0).b(this.a.getActivity().getTitleBarHeight());
        return;
