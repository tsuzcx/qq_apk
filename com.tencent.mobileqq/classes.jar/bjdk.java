public class bjdk<T>
{
  ...
  public int a()
  {
    ...
    //   18: ireturn
    //   19: aload_0
    //   20: getfield 50	bjdk:d	I
    //   23: aload_0
    //   24: getfield 52	bjdk:c	I
    //   27: if_icmple +16 -> 43
    //   30: aload_0
    //   31: getfield 50	bjdk:d	I
    //   34: aload_0
    //   35: getfield 52	bjdk:c	I
    //   38: isub
    //   39: istore_1
    //   40: goto -25 -> 15
    //   43: aload_0
    //   44: getfield 19	bjdk:b	I
    //   47: istore_1
    //   48: aload_0
    //   49: getfield 52	bjdk:c	I
    //   52: istore_2
    //   53: aload_0
    //   54: getfield 50	bjdk:d	I
    //   57: istore_3
    //   58: iload_1
    //   59: iload_2
    //   60: iload_3
  ...
  public T a()
  {
    ...
    {
      if (b()) {
        throw new IndexOutOfBoundsException(alud.a(2131706779));
      }
    }
    finally {}
  ...
  public void a(T paramT)
  {
    try
    {
      if ((this.d == this.c) && (this.jdField_a_of_type_ArrayOfJavaLangObject[this.c] != null)) {
        throw new IndexOutOfBoundsException(alud.a(2131706778));
      }
    }
    finally {}
    if (paramT == null) {
  ...
  public boolean a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: invokevirtual 71	bjdk:a	()I
    //   6: istore_1
    //   7: aload_0
    //   8: getfield 19	bjdk:b	I
    //   11: istore_2
    //   12: iload_1
    //   13: iload_2
    //   14: if_icmpne +9 -> 23
  ...
  public boolean b()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 50	bjdk:d	I
    //   6: aload_0
    //   7: getfield 52	bjdk:c	I
    //   10: if_icmpne +23 -> 33
    //   13: aload_0
    //   14: getfield 21	bjdk:jdField_a_of_type_ArrayOfJavaLangObject	[Ljava/lang/Object;
    //   17: aload_0
    //   18: getfield 50	bjdk:d	I
    //   21: aaload
    //   22: astore_2
    //   23: aload_2
    //   24: ifnonnull +9 -> 33
