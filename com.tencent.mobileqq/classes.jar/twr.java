...
public class twr
{
  ...
  public static int a(AdvertisementInfo paramAdvertisementInfo)
  {
    ...
    if (paramAdvertisementInfo.gameAdComData != null) {
      return obg.a(paramAdvertisementInfo.gameAdComData.s, 0);
    }
    return ((Integer)twq.a(paramAdvertisementInfo.mAdExtInfo, "game_button_type", Integer.valueOf(0))).intValue();
  }
  ...
  public static long a(rvi paramrvi, boolean paramBoolean)
  {
    if (!a(paramrvi)) {}
    for (;;)
    {
      return -1L;
      if ((paramrvi != null) && (paramrvi.jdField_a_of_type_Ryo != null) && (paramrvi.jdField_a_of_type_Ryo.jdField_a_of_type_ComTencentBizPubaccountVideoInfo != null) && (paramrvi.jdField_a_of_type_Ryo.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.a != null))
      {
        paramrvi = paramrvi.jdField_a_of_type_Ryo.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.a;
        try
        {
          paramrvi = new JSONObject(paramrvi.v);
          if (paramrvi != null)
          {
            paramrvi = paramrvi.optJSONObject("GesturesAd_info");
            if (paramrvi != null)
            {
              if (paramBoolean) {
                return paramrvi.optInt("showGesturesAd_beginTime");
              }
              int i = paramrvi.optInt("showGesturesAd_endTime");
              return i;
            }
          }
        }
  ...
  public static String a(Context paramContext, VideoInfo paramVideoInfo, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (bfwv.a(paramContext, ((JSONObject)localObject).optString("pkg_name")))
        {
          if (paramInt != 1) {
            break;
          }
        ...
        if (oau.a(BaseApplicationImpl.getContext(), ((JSONObject)localObject).optString("pkg_name")))
        {
          str1 = "安装";
          localObject = amtj.a(2131699074);
        }
      }
    ...
    do
    {
      do
      {
        for (;;)
        {
          ...
          if (paramVideoInfo != null)
          {
            ...
            if (paramVideoInfo.a != null)
            {
              ...
              if (a(paramVideoInfo.a)) {
                localObject1 = paramResources.getText(2131717387).toString();
              }
            }
          }
          ...
          try
          {
            paramVideoInfo = new JSONObject(paramVideoInfo.a.jdField_r_of_type_JavaLangString);
            if (bfwv.a(paramContext, paramVideoInfo.optString("pkg_name"))) {
              return paramResources.getText(2131717385).toString();
            }
            if (oau.a(BaseApplicationImpl.getContext(), paramVideoInfo.optString("pkg_name"))) {
              return amtj.a(2131699074);
            }
            paramContext = (Context)localObject1;
            if (TextUtils.isEmpty((CharSequence)localObject1))
            {
              paramContext = paramResources.getText(2131717384).toString();
              return paramContext;
            }
          }
          catch (JSONException paramContext)
      ...
      return paramResources.getText(2131717384).toString();
      paramContext = (Context)localObject1;
    } while (!TextUtils.isEmpty((CharSequence)localObject1));
    return paramResources.getText(2131717435).toString();
  }
  ...
  public static String a(Context paramContext, AdvertisementInfo paramAdvertisementInfo)
  {
    ...
    if ((paramAdvertisementInfo != null) && (paramAdvertisementInfo.mAdProductType == 12))
    {
      try
      {
        if (bfwv.a(paramContext, new JSONObject(paramAdvertisementInfo.mAdExt).optString("pkg_name"))) {
          return "打开";
        }
        paramContext = str;
  ...
  public static String a(AdvertisementInfo paramAdvertisementInfo)
  {
    ...
    return (String)twq.a(paramAdvertisementInfo.mAdExtInfo, "game_pkg_name", "");
  }
  ...
  public static JSONObject a(Context paramContext, AdvertisementInfo paramAdvertisementInfo, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      try
      {
        if (!obb.a(paramContext, new JSONObject(paramAdvertisementInfo.mAdExt).optString("pkg_name"))) {
          break label103;
        }
        i = 2;
  ...
  public static void a()
  {
    ...
    if ((localObject != null) && ((localObject instanceof trr))) {
      try
      {
        localObject = (trr)localObject;
        int i;
        JSONObject localJSONObject1;
        JSONObject localJSONObject2;
        if (((trr)localObject).a())
        {
          i = obb.N;
          if (((trr)localObject).jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mOrigin > 0) {
            i = ((trr)localObject).jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mOrigin;
          }
          localJSONObject1 = new JSONObject();
          localJSONObject2 = new JSONObject();
          localJSONObject2.put("stat_type", obb.ba);
          localJSONObject2.put("webview_click", ((trr)localObject).jdField_a_of_type_Long);
          localJSONObject2.put("webview_start", ((trr)localObject).b);
          localJSONObject2.put("webview_head", ((trr)localObject).c);
          localJSONObject2.put("webview_body", ((trr)localObject).d);
          localJSONObject2.put("webview_close", System.currentTimeMillis());
          if (!((trr)localObject).jdField_a_of_type_Boolean) {
            break label203;
          }
        ...
        for (;;)
        {
          ...
          obb.a(new trn().a(obb.B).b(i).a(((trr)localObject).jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo).e(localJSONObject1).a());
          txf.a(2);
          return;
          label203:
  ...
  public static void a(Activity paramActivity, int paramInt)
  {
    ...
    txf.a(paramInt, localBitmap);
  }
  
  public static void a(VideoAdInfo paramVideoAdInfo)
  {
    a(txa.a(paramVideoAdInfo));
  }
  
  public static void a(VideoInfo paramVideoInfo, rvi paramrvi)
  {
    if ((paramVideoInfo == null) || (!paramVideoInfo.c) || (paramrvi == null) || (paramVideoInfo.a == null) || (TextUtils.isEmpty(paramVideoInfo.a.v))) {
      return;
    }
    for (;;)
    {
      try
      {
        ...
        {
          if (paramrvi.a() != null) {
            paramrvi.a().setText(paramVideoInfo.optString("AdsIconText"));
          }
          if (!QLog.isColorLevel()) {
            break;
          }
      ...
      if (paramrvi.jdField_a_of_type_Int == 4)
      {
        if (paramrvi.a() != null) {
          paramrvi.a().setVisibility(8);
        }
      }
      else if (paramrvi.a() != null) {
        paramrvi.a().setVisibility(8);
      }
    }
  }
  ...
  public static void a(AdvertisementInfo paramAdvertisementInfo)
  {
    ...
    do
    {
      ...
      try
      {
        paramAdvertisementInfo = new GdtAd(uhs.a(paramAdvertisementInfo));
        abkw.a().a(paramAdvertisementInfo);
        return;
      }
  ...
  public static void a(AdvertisementInfo paramAdvertisementInfo, int paramInt, VideoFeedsPlayManager paramVideoFeedsPlayManager)
  {
    ...
    if (paramVideoFeedsPlayManager != null) {
      localryo = paramVideoFeedsPlayManager.a();
    }
    if (paramAdvertisementInfo != null)
    {
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramArticleInfo.mSmallMiniGameInfo != null) {
          obb.a(paramContext, paramArticleInfo, paramInt, obb.jdField_a_of_type_Int);
        }
        ...
        i = 0;
        String str = pay.d(paramArticleInfo);
        odq.a(null, "CliOper", "", paramArticleInfo.mSubscribeID, "0X8007625", "0X8007625", 0, 0, Long.toString(paramArticleInfo.mFeedId), Long.toString(paramArticleInfo.mArticleID), Integer.toString(paramArticleInfo.mStrategyId), pay.a(paramArticleInfo.mAlgorithmID, pay.a(paramArticleInfo), 0, paramInt, i, NetworkUtil.isWifiConnected(paramContext), str, paramArticleInfo.mStrCircleId, paramArticleInfo.innerUniqueID, pay.f(paramArticleInfo), paramArticleInfo), false);
      }
      catch (Exception paramContext)
      {
        int i;
      ...
      paramContext = new rdz();
      paramContext.d = 0;
      paramContext.e = 0;
      paramContext.c = 1;
      ofe.a(paramArticleInfo, (int)paramArticleInfo.mChannelID, 25, -1L, paramContext);
      return;
      paramInt = 0;
      continue;
      i = 1;
  ...
  public static void a(JSONObject paramJSONObject, tro paramtro)
  {
    if (paramtro == null) {}
    do
    {
      for (;;)
      {
        ...
        {
          Object localObject;
          if (!TextUtils.isEmpty(paramtro.b))
          {
            localObject = new JSONObject();
            ((JSONObject)localObject).put("iconUrl", paramtro.b);
            paramJSONObject.put("id_pk_icon", localObject);
          }
          if ((paramtro.a != null) && (paramtro.b.length() >= 2))
          {
            localObject = (trk)paramtro.a.get(0);
            JSONObject localJSONObject;
            if (!TextUtils.isEmpty(((trk)localObject).d))
            {
              localJSONObject = new JSONObject();
              localJSONObject.put("iconUrl", ((trk)localObject).d);
              paramJSONObject.put("id_pk_image_bg_left", localJSONObject);
            }
            if (!TextUtils.isEmpty(((trk)localObject).c))
            {
              localJSONObject = new JSONObject();
              localJSONObject.put("text", ((trk)localObject).c);
              paramJSONObject.put("id_pk_label_left", localJSONObject);
            }
            paramtro = (trk)paramtro.a.get(1);
            if (!TextUtils.isEmpty(paramtro.d))
            {
              localObject = new JSONObject();
              ((JSONObject)localObject).put("iconUrl", paramtro.d);
              paramJSONObject.put("id_pk_image_bg_right", localObject);
            }
            if (!TextUtils.isEmpty(paramtro.c))
            {
              localObject = new JSONObject();
              ((JSONObject)localObject).put("text", paramtro.c);
  ...
  public static void a(ryo paramryo)
  {
    if ((paramryo != null) && (paramryo.jdField_a_of_type_Rds != null)) {
      paramryo.jdField_a_of_type_Rds.e = false;
    }
  }
  
  public static void a(ryo paramryo, boolean paramBoolean)
  {
    if ((paramryo != null) && (paramryo.jdField_a_of_type_Rds != null)) {
      paramryo.jdField_a_of_type_Rds.e = paramBoolean;
    }
  }
  
  public static void a(txm paramtxm, ruw paramruw, rvv paramrvv)
  {
    if ((paramtxm == null) || (paramruw == null) || (paramrvv == null)) {}
    while ((!(paramrvv instanceof rvi)) || (!a((rvi)paramrvv)) || (((rvi)paramrvv).a() == null) || (!((rvi)paramrvv).a().a())) {
      return;
    }
    paramtxm.e();
    paramruw.a(paramrvv);
  ...
  {
    return (a.contains(Integer.valueOf(paramInt))) || (pcl.b(paramInt));
  }
  ...
  public static boolean a(Context paramContext, String paramString, int paramInt)
  {
    if ((HippyQQEngine.getModuleOnlineConfig("TKDMiniGame") == 1) && (paramInt == 41708) && (!TextUtils.isEmpty(paramString)) && (paramString.contains("h5GameSource")))
    {
      ...
      Intent localIntent = okj.b(paramContext, 0, paramInt);
  ...
  {
    return d(obb.a(paramVideoAdInfo));
  }
  ...
  public static boolean a(ArticleInfo paramArticleInfo)
  {
    ...
    if ((paramArticleInfo instanceof AdvertisementInfo))
    {
      ...
      if (paramArticleInfo.mChannelID == 0L)
      {
        ...
        {
          bool1 = bool2;
          if (TextUtils.isEmpty(uhs.a(paramArticleInfo, "AdsIconText"))) {
            bool1 = true;
          }
        }
      }
  ...
  public static boolean a(rvi paramrvi)
  {
    if ((paramrvi != null) && (paramrvi.jdField_a_of_type_Ryo != null) && (paramrvi.jdField_a_of_type_Ryo.jdField_a_of_type_ComTencentBizPubaccountVideoInfo != null) && (paramrvi.jdField_a_of_type_Ryo.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.a != null))
    {
      paramrvi = paramrvi.jdField_a_of_type_Ryo.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.a;
      try
      {
        ...
        if (paramrvi != null)
        {
          int i = paramrvi.optInt("showGesturesAdType");
          if (i > 0) {
            return true;
          }
        }
  ...
  public static boolean a(ryo paramryo)
  {
    if ((paramryo != null) && (paramryo.jdField_a_of_type_Rds != null)) {
      return paramryo.jdField_a_of_type_Rds.e;
    }
    return false;
  }
  
  public static boolean a(tse paramtse)
  {
    String str = bkwm.a("sp_key_ad_soft_total_area");
    ...
    {
      return true;
      i = obg.a(bkwm.a("sp_key_ad_soft_ad_max"), 25);
      j = paramtse.b();
      if (QLog.isColorLevel()) {
  ...
  public static void b(AdvertisementInfo paramAdvertisementInfo)
  {
    ...
    try
    {
      trr localtrr = new trr();
      localtrr.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo = paramAdvertisementInfo;
      localtrr.jdField_a_of_type_JavaLangString = String.valueOf(paramAdvertisementInfo.mAdAid);
      if (!TextUtils.isEmpty(paramAdvertisementInfo.mAdLandingPage))
      {
        ...
        if (!TextUtils.isEmpty(paramAdvertisementInfo))
        {
          ...
          if ((i > 0) && (i < paramAdvertisementInfo.length() - 1)) {
            localtrr.jdField_a_of_type_JavaLangString = paramAdvertisementInfo.substring(i + 1);
          }
        }
      }
      localtrr.jdField_a_of_type_Long = System.currentTimeMillis();
      txf.a(2, localtrr);
  ...
  public static void c(BaseArticleInfo paramBaseArticleInfo, JSONObject paramJSONObject)
  {
    ...
    try
    {
      twn.a(new JSONObject(paramBaseArticleInfo.mAdExtInfo), paramJSONObject);
      return;
    }
  ...
  public static boolean c(AdvertisementInfo paramAdvertisementInfo)
  {
    ...
    try
    {
      ...
      boolean bool3 = bfwv.a(BaseApplicationImpl.getContext(), paramAdvertisementInfo);
      bool1 = bool2;
      if (bool3) {
        bool1 = true;
      }
  ...
  public static void d(BaseArticleInfo paramBaseArticleInfo, JSONObject paramJSONObject)
  {
    ...
    {
      twp.a("bindAdSourceTag", "adExtInfo is empty");
      return;
    }
    JSONObject localJSONObject = new JSONObject();
    try
    {
      ...
      {
        twp.a("bindAdSourceTag", "JSONArray is empty");
        return;
      }
    }
  ...
  {
    if (paramAdvertisementInfo == null) {}
    while ((TextUtils.isEmpty(paramAdvertisementInfo.mPopFormH5Url)) || (!twq.d(paramAdvertisementInfo))) {
      return false;
    }
    return true;
  }
  ...
  {
    return (paramAdvertisementInfo != null) && (paramAdvertisementInfo.mAdvertisementExtInfo != null) && ((1014 == paramAdvertisementInfo.mAdvertisementExtInfo.i) || (1015 == paramAdvertisementInfo.mAdvertisementExtInfo.i)) && (paramAdvertisementInfo.mAdvertisementExtInfo.s == 1);
  }
