  ...
  extends MSFServlet
{
  ...
  {
    Object localObject = new NewIntent(paramQQAppInterface.getApp(), bdul.class);
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          paramLong = bdmc.a(BaseApplication.getContext());
          ...
          if (paramMessageForPtt.istroop == 0)
          {
            ...
            ((HashMap)localObject).put("appversion", "8.4.5");
        ...
        catch (Exception paramQQAppInterface)
        {
          try
          {
            ...
            for (;;)
            {
              paramQQAppInterface = bdmc.a(BaseApplication.getContext());
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (bool2 = true;; bool2 = false)
    {
      ...
      notifyObserver(paramIntent, k, bool2, paramFromServiceMsg, bduh.class);
      return;
      break;
    }
  }
