  ...
  extends bbgg
{
  ...
  public bbhq(Context paramContext, int paramInt)
  {
  ...
  public void setContentView(int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetClearableEditText = ((ClearableEditText)findViewById(2131368186));
  }
  ...
  public bbgg setPositiveButton(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.rBtn.setOnClickListener(new bbhr(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
