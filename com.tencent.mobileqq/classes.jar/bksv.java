...
public class bksv
{
  ...
  public static String a(int paramInt)
  {
    try
    {
      ...
      localbksy.a((byte[])localObject).a(str2).a(str3).a(str4).a(str5).a(str6).a(str7).a(str8);
      if (paramInt >= 2) {
        localbksy.a(bksu.c()).a(AppSetting.a()).a(DeviceInfoUtil.getAndroidID()).a("").a("");
      }
      localObject = localbksy.toString();
    }
  ...
  private static void b(QQAppInterface paramQQAppInterface, SafeReport.ReqBody paramReqBody)
  {
    ...
    for (;;)
    {
      ntb.a(paramQQAppInterface, new bksw(), paramReqBody.toByteArray(), "MqqSafeDataRpt.MQDun");
      return;
    }
  }
