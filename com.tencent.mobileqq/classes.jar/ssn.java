...
public class ssn
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ssn.class.getSimpleName();
  }
  ...
  public static Bundle a(Intent paramIntent)
  {
    ...
    try
    {
      ...
      localJSONObject3.put("stickySpeed", plw.a());
      localJSONObject3.put("maskLighteness", plw.a());
      localJSONObject3.put("topBarTitle", plw.a());
      ...
      localJSONObject4.put("rewardPrivilegeConfig", qgx.a().a(5));
      localJSONObject3.put("videoRewardConfig", localJSONObject4);
      localJSONObject3.put("barrageConfig", bmhv.c());
      localJSONObject3.put("resumeEnable", sqb.a.a());
      localJSONObject4 = new JSONObject();
      localJSONObject4.put("from", paramIntent.getIntExtra("VIDEO_FROM_TYPE", -1));
      localJSONObject4.put("kandian_mode_new", omx.a());
      localJSONObject4.put("kandian_mode", pqu.a());
      ...
      localJSONObject1.put("dynamicAladdinConfig", pmh.b());
      localJSONObject1.put("xgAladdinConfig", pmh.a());
      localJSONObject1.put("protocolExtralParam", paramIntent);
      localJSONObject1.put("autoPlayDisable", bmhv.i());
  ...
  public static VideoInfo a(Bundle paramBundle)
  {
    ...
    {
      return paramBundle;
      localVideoInfo = six.a(paramBundle);
      six.a(localVideoInfo);
      paramBundle = localVideoInfo;
  ...
  private static String a()
  {
    try
    {
      String str = ReadInJoyUserInfoModule.a(ReadInJoyUserInfoModule.a(pkh.a(), null));
      return str;
    }
  ...
  {
    if (pmq.a(paramInt)) {}
    for (String str1 = tto.a();; str1 = "https://viola.qq.com/js/VideoFeeds.js?_rij_violaUrl=1&v_tid=15&v_bundleName=VideoFeeds&hideNav=1&v_nav_immer=1&statusColor=1&v_bid=3811&statusBarStyle=1&v_bg_color=000000&v_present_titleHeight=44&v_old_modal=1&_ckey=rij_video_feeds_cache_key")
    {
      String str2 = str1;
  ...
  private static JSONObject a()
  {
    ...
    localJSONObject.put("uint32_youngster_status", bmhv.a("key_sp_is_readinjoy_youngster", Integer.valueOf(0)));
    localJSONObject.put("uint32_req_recommend_flag", omv.a());
    localJSONObject.put("bytes_req_recommend_json", prh.a());
  ...
  private static JSONObject a(Intent paramIntent)
  {
    ...
    if (k == 11)
    {
      ...
      {
        localJSONObject1.put("videoType", plw.a(localVideoInfo.jdField_b_of_type_Int, localVideoInfo.jdField_c_of_type_Int, localVideoInfo.jdField_d_of_type_Int));
  ...
  public static JSONObject a(VideoInfo paramVideoInfo, Intent paramIntent)
  {
    ...
    {
      i = 1;
      localObject = ((JSONObject)localObject).put("is_ugc", i).put("like_count", paramVideoInfo.t);
      ...
      label119:
      localJSONObject2 = localJSONObject2.put("thirdIcon", localObject).put("thirdName", paramVideoInfo.jdField_q_of_type_JavaLangString).put("third_uin", paramVideoInfo.j).put("third_uin_name", paramVideoInfo.k);
    ...
    {
      ((JSONObject)localObject).put("commonData", paramIntent).put("biu_count", paramVideoInfo.jdField_f_of_type_Int).put("biu_count_str", six.a(paramVideoInfo.jdField_f_of_type_Int, "Biu")).put("like_count_str", six.a(paramVideoInfo.t, "赞")).put("video_comment_count_str", six.a(paramVideoInfo.e, "评论"));
      if (!TextUtils.isEmpty(paramVideoInfo.j)) {
        i = j;
      }
      try
      {
        if (six.a(pnn.a(), Long.parseLong(paramVideoInfo.j))) {
          i = 1;
        }
  ...
  public static void a(Activity paramActivity, Intent paramIntent, int paramInt)
  {
    ...
    tto.a(paramActivity, null, paramIntent, localBundle, true);
  }
  ...
  public static void a(Context paramContext, Intent paramIntent)
  {
    ...
    tto.a(paramContext, null, paramIntent, localBundle, true);
  }
  ...
  public static void a(BaseArticleInfo paramBaseArticleInfo, Context paramContext)
  {
    ...
    try
    {
      paramContext = six.a((Activity)paramContext, paramBaseArticleInfo.mVideoJsonWidth, paramBaseArticleInfo.mVideoJsonHeight);
      ...
      localtlw.jdField_a_of_type_JavaNetURL = paramContext;
      localtlw.jdField_b_of_type_Int = paramBaseArticleInfo.getFirstFrameHeight();
      localtlw.jdField_a_of_type_Int = paramBaseArticleInfo.getFirstFrameWidth();
      localtlw.jdField_b_of_type_Boolean = true;
      tlv.a().a(localtlw, new sso(paramBaseArticleInfo, paramContext));
      return;
    }
