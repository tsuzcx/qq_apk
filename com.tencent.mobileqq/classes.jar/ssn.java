...
public class ssn
{
  ...
  private static BaseData a(int paramInt, sss paramsss)
  {
    paramsss = paramsss.b(paramInt);
    try
    {
      if (!TextUtils.isEmpty(paramsss))
      {
        paramsss = new JSONObject(paramsss);
        if (srz.a(paramsss))
        {
          if (!qhv.a().a()) {
            return null;
          }
          return srz.a(paramsss);
        }
        paramsss = a(paramsss);
        return paramsss;
      }
    }
    catch (Exception paramsss)
    {
      QLog.d(jdField_a_of_type_JavaLangString, 1, "parseProteusData error!  msg=" + paramsss);
    }
    return null;
  }
  
  public static BaseData a(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, sss paramsss, SparseArray<Float> paramSparseArray)
  {
    Object localObject2 = "";
    Object localObject3 = "";
    Object localObject1 = "";
    ...
    if (i1 != 1)
    {
      ...
      case 2: 
        for (;;)
        {
          ...
          if (i1 < i2)
          {
            String str = paramsss.a(i1);
            if (str.equals("src"))
            {
              localObject1 = paramsss.b(i1);
              localObject5 = localObject3;
    ...
    label404:
    return srw.a(paramArticleInfo, paramFastWebArticleInfo, (String)localObject2, (String)localObject3, (String)localObject1, paramSparseArray);
  }
  
  public static BaseData a(sss paramsss)
  {
  ...
  private static BaseData a(sss paramsss, SparseArray<Float> paramSparseArray)
  {
    ...
    if (i1 != 1)
    {
      ...
      case 4: 
        for (;;)
        {
          ...
          localObject1 = localObject2;
          break;
          localObject2 = paramsss.b();
          if (!((String)localObject2).equals(i)) {
            throw new IllegalArgumentException(anzj.a(2131704528));
          }
          ...
          localXmlSerializer.text(paramsss.a());
          localObject2 = localObject1;
        }
      }
      if (i.equals(paramsss.b())) {
    ...
    else
    {
      ...
      return srw.a(localStringWriter.toString(), (String)localObject1, paramSparseArray);
    }
  ...
  private static ProteusBookData a(JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      Object localObject = suz.a("native_article", true);
      if (localObject != null) {}
      for (localObject = ((suz)localObject).getTemplateBean(paramJSONObject);; localObject = null)
      {
  ...
  public static List<BaseData> a(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, SparseArray<Float> paramSparseArray)
  {
    ...
    ssr localssr = new ssr(null);
    sss localsss = new sss(Xml.newPullParser(), localssr);
    localsss.a(new StringReader((String)localObject));
    int i1 = localsss.c();
    while (i1 != 1)
    {
      switch (i1)
      ...
      for (;;)
      {
        if (localsss.c() != 2)
        {
          i1 = localsss.d();
          break;
          localObject = localsss.b();
          if ((((String)localObject).equals(b)) || (((String)localObject).equals(c)))
          {
            a(paramArticleInfo, paramFastWebArticleInfo, localsss, localArrayList, localssr, paramSparseArray);
          }
          else if (((String)localObject).equals(i))
          {
            localArrayList.add(a(localsss, paramSparseArray));
          }
          else
          {
            if (((String)localObject).equals(d))
            {
              a(localsss, localssr, localArrayList, paramSparseArray);
              if (2 != localsss.c()) {
                continue;
              }
              i1 = localsss.c();
            ...
            {
              localsss.d();
              c(paramArticleInfo, paramFastWebArticleInfo, localsss, localArrayList, localssr, paramSparseArray);
            }
            else if (((String)localObject).equals(g))
            {
              localObject = a(paramArticleInfo, paramFastWebArticleInfo, localsss, paramSparseArray);
              if (localObject != null) {
            ...
            {
              localArrayList.add(b(paramArticleInfo, paramFastWebArticleInfo, localsss, paramSparseArray));
            }
            else if (((String)localObject).equals(j))
            {
              localObject = a(localsss);
              if (localObject != null) {
                localArrayList.add(localObject);
              }
            }
            ...
            {
              b(paramArticleInfo, paramFastWebArticleInfo, localsss, localArrayList, localssr, paramSparseArray);
            }
            else
            {
              throw new IllegalArgumentException(anzj.a(2131704527) + (String)localObject);
              a(localsss, localssr, localArrayList, paramSparseArray);
              if (2 == localsss.c())
              {
                i1 = localsss.c();
  ...
  private static void a(SpannableString paramSpannableString, SparseArray<Object> paramSparseArray)
  {
    ...
    for (;;)
    {
      ...
      if ((localObject1 instanceof ArrayList))
      {
        ...
        {
          Object localObject2 = ((ssq)((ArrayList)localObject1).get(i2)).a();
          if ((localObject2 instanceof ssp)) {
            ((ssp)localObject2).a(paramSpannableString.toString());
          }
      ...
      {
        localObject1 = ((ssq)localObject1).a();
        if ((localObject1 instanceof ssp)) {
          ((ssp)localObject1).a(paramSpannableString.toString());
        }
  ...
  public static void a(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, sss paramsss, List<BaseData> paramList, ssr paramssr, SparseArray<Float> paramSparseArray)
  {
    int i1 = paramsss.c();
    int i3 = paramsss.a();
    for (;;)
      ...
      case 3: 
        do
        {
          ...
          do
          {
            i1 = paramsss.d();
            break;
            localObject = paramsss.b();
            if (a((String)localObject))
            {
              a(paramsss, paramssr, paramList, paramSparseArray);
              i1 = i2;
              break;
            }
            if (((String)localObject).equals(g))
            {
              localObject = a(paramArticleInfo, paramFastWebArticleInfo, paramsss, paramSparseArray);
              i1 = i2;
              if (localObject == null) {
                break;
              }
            ...
            {
              paramList.add(b(paramArticleInfo, paramFastWebArticleInfo, paramsss, paramSparseArray));
              i1 = i2;
              break;
            }
            if (((String)localObject).equals(i))
            {
              paramList.add(a(paramsss, paramSparseArray));
              i1 = i2;
              break;
            }
            if ((((String)localObject).equals(l)) || (((String)localObject).equals(n)))
            {
              b(paramArticleInfo, paramFastWebArticleInfo, paramsss, paramList, paramssr, paramSparseArray);
              i1 = i2;
              break;
            }
            if (((String)localObject).equals(o))
            {
              paramsss.d();
              c(paramArticleInfo, paramFastWebArticleInfo, paramsss, paramList, paramssr, paramSparseArray);
              i1 = i2;
              break;
            }
          } while ((((String)localObject).equals(b)) || (((String)localObject).equals(c)));
          return;
        } while (((!paramsss.b().equals(b)) && (!paramsss.b().equals(c))) || (i3 != paramsss.a()));
        return;
      }
      a(paramsss, paramssr, paramList, paramSparseArray);
      i1 = i2;
  ...
  public static void a(sss paramsss, ssr paramssr, List<BaseData> paramList, SparseArray<Float> paramSparseArray)
  {
    int i4 = paramssr.a();
    int i5 = paramssr.b();
    ...
    for (;;)
    {
      ...
      if (!a(paramsss.b()))
      {
        do
        {
          paramsss = localSpannableStringBuilder.toString();
          if (!TextUtils.isEmpty(paramsss.replaceAll(" ", "").trim())) {
            paramList.add(srw.a(paramsss, localSpannableStringBuilder, i4, i5, paramSparseArray));
          }
          return;
          SpannableString localSpannableString = new SpannableString(paramsss.a().replaceAll(" +", " ").replaceAll("\t+", " "));
          a(localSpannableString, paramssr.b);
  ...
  public static BaseData b(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, sss paramsss, SparseArray<Float> paramSparseArray)
  {
    int i7 = paramsss.c();
    Object localObject5 = "";
    Object localObject3 = "";
    ...
    if (i7 != 1)
    {
      ...
      case 2: 
        for (;;)
        {
          ...
          if (i4 < i7)
          {
            String str = paramsss.a(i4);
            if (str.equals("vid"))
            {
              localObject10 = paramsss.b(i4);
            ...
            for (;;)
            {
              ...
              if (str.equals("width"))
              {
                i6 = Integer.valueOf(paramsss.b(i4)).intValue();
                i5 = i2;
                localObject6 = localObject4;
                localObject7 = localObject2;
                localObject8 = localObject5;
              ...
              {
                i5 = Integer.valueOf(paramsss.b(i4)).intValue();
                i6 = i1;
                localObject6 = localObject4;
                localObject7 = localObject2;
                localObject8 = localObject5;
              ...
              else
              {
                ...
                {
                  i3 = Integer.valueOf(paramsss.b(i4)).intValue();
                  i5 = i2;
                  i6 = i1;
                  localObject6 = localObject4;
                  localObject7 = localObject2;
      ...
      if (!h.equals(paramsss.b())) {}
    }
    else
    {
      return srw.a(paramArticleInfo, paramFastWebArticleInfo, (String)localObject3, (String)localObject5, i2, i3, (String)localObject1, (String)localObject2, (String)localObject4, i1, paramSparseArray);
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i2 < arrayOfString.length)
        {
          ...
          localArrayList.add(ssq.a(3, new Object[0]));
        }
      }
      ...
      {
        localArrayList.add(ssq.a(5, new Object[0]));
        break label399;
        label172:
        if ((q.equals(paramString)) || (r.equals(paramString)))
        {
          ...
          while (i1 != -1)
          {
            ...
            for (paramString = ssq.a(2, new Object[] { Integer.valueOf(i1) });; paramString = ssq.a(1, new Object[] { Integer.valueOf(i1) }))
            {
  ...
  public static void b(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, sss paramsss, List<BaseData> paramList, ssr paramssr, SparseArray<Float> paramSparseArray)
  {
    int i1 = paramsss.c();
    int i3 = paramsss.a();
    for (;;)
    {
      ...
      case 3: 
        ...
        do
        {
          ...
          a(paramArticleInfo, paramFastWebArticleInfo, paramsss, paramList, paramssr, paramSparseArray);
        } while (i3 != paramsss.a());
        return;
  ...
  public static void c(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, sss paramsss, List<BaseData> paramList, ssr paramssr, SparseArray<Float> paramSparseArray)
  {
    int i1 = paramsss.c();
    switch (i1)
    {
