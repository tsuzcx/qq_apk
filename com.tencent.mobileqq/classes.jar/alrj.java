...
public class alrj
  extends Handler
{
  public alrj(CreateFaceToFaceDiscussionActivity paramCreateFaceToFaceDiscussionActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      this.a.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130845231);
      this.a.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130845231);
      this.a.jdField_c_of_type_AndroidWidgetImageView.setImageResource(2130845231);
      this.a.d.setImageResource(2130845231);
