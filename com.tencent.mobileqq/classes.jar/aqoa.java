...
public abstract class aqoa<DATA, CONFIG extends aqou>
{
  ...
  protected final PriorityQueue<aqoe> a;
  protected boolean a;
  protected float b;
  protected int b;
  protected long b;
  ...
  private void j()
  {
    try
    {
      this.jdField_a_of_type_Aqou = this.jdField_a_of_type_Aqoj.a(a());
      return;
    }
  ...
  private void k()
  {
    ...
    if (this.jdField_a_of_type_JavaUtilHashMap != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localObject instanceof aqoc)) {
          ((aqoc)localObject).a();
        }
      }
  ...
  public long a()
  {
    return this.jdField_a_of_type_Aqps.a();
  }
  ...
  public final void a(long paramLong1, long paramLong2)
  {
    ...
    if (!this.jdField_a_of_type_JavaUtilPriorityQueue.isEmpty())
    {
      ...
      while (localIterator.hasNext())
      {
        aqoe localaqoe = (aqoe)localIterator.next();
        localaqoe.jdField_a_of_type_Long -= paramLong1;
        if (localaqoe.jdField_a_of_type_Long <= 0L)
        {
          localIterator.remove();
          localaqoe.jdField_a_of_type_Aqod.a(this);
        }
      }
    }
  }
  ...
  {
    this.jdField_a_of_type_Aqps = paramaqps;
  }
  
  public void a(DATA paramDATA)
  {
    if ((aqnj.a().a().a()) && (paramDATA == null)) {
  ...
  public boolean a(long paramLong)
  {
    ...
    while (paramLong - this.jdField_b_of_type_Long < this.jdField_a_of_type_Aqps.a()) {
      return false;
    }
    return true;
  }
  ...
  {
    return (this.jdField_a_of_type_Long > 0L) && (paramLong - this.jdField_a_of_type_Long >= this.jdField_a_of_type_Aqps.a());
  }
  ...
  {
    this.jdField_a_of_type_Aqps.a(paramFloat);
  }
  ...
  public boolean e()
  {
    return (this.jdField_a_of_type_Boolean) && (aqoz.a());
  }
  ...
  public void f()
  {
    ...
    {
      aqqb.c("BaseDanmaku", "onFirstExposure, danmaku = " + toString());
      i();
      this.jdField_d_of_type_Boolean = true;
    }
    if ((this.jdField_a_of_type_Aqob != null) && (f1 <= 0.0F))
    {
      this.jdField_a_of_type_Aqob.a(this);
      this.jdField_a_of_type_Aqob = null;
    }
  }
  ...
  protected void i()
  {
    if (this.jdField_a_of_type_Aqoj != null) {
      this.jdField_a_of_type_Aqoj.a(this);
    }
  }
  
  public String toString()
  {
    return "BaseDanmaku" + this.jdField_a_of_type_Int + "[left:" + b() + ",top:" + c() + ",right:" + d() + ",bottom:" + e() + ", time:" + this.jdField_b_of_type_Long + ", mData=" + String.valueOf(this.jdField_a_of_type_JavaLangObject) + ", mType=" + a() + ", playerTime=" + this.jdField_a_of_type_Aqoj.a() + "]";
  }
}
