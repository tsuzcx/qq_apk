  ...
  implements CompoundButton.OnCheckedChangeListener
{
  ...
  {
    Object localObject;
    if (((paramCompoundButton == this.a.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem.a()) || (paramCompoundButton == PermisionPrivacyActivity.b(this.a)) || (paramCompoundButton == PermisionPrivacyActivity.a(this.a)) || (paramCompoundButton == this.a.b.a()) || (paramCompoundButton == this.a.c.a()) || (paramCompoundButton == this.a.e.a())) && (!bbev.d(this.a.getActivity())))
    {
      this.a.a(2131694670, 1);
      localObject = this.a;
      if (!paramBoolean)
      {
        paramBoolean = true;
    ...
    do
    {
      ...
      {
        if (AppSetting.d) {
          this.a.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem.setContentDescription(this.a.getResources().getString(2131694606));
        }
        if (paramBoolean) {}
        for (i = 1;; i = 0)
        {
          axqw.b(this.a.app, "CliOper", "", "", "Setting_tab", "Nearby_likeme", 0, i, String.valueOf(i), "", "", "");
      ...
      {
        ((ajtk)this.a.app.a(2)).o(paramBoolean);
        if (paramBoolean)
        {
          axqw.b(this.a.app, "dc00898", "", "", "0X8009E81", "0X8009E81", 0, 0, "", "", "", "");
          return;
        }
        axqw.b(this.a.app, "dc00898", "", "", "0X8009E80", "0X8009E80", 0, 0, "", "", "", "");
        return;
      }
      if (paramCompoundButton == this.a.i.a())
      {
        ...
        {
          bcpw.a(this.a.getApplicationContext(), 2131719375, 1).a();
          localObject = this.a;
          if (!paramBoolean)
          {
            bool = true;
        ...
        {
          paramCompoundButton = (ajtk)this.a.app.a(2);
          if (paramBoolean) {
            break label426;
          }
        }
      ...
      if (paramCompoundButton == this.a.jdField_a_of_type_AndroidWidgetCompoundButton)
      {
        if (!bbev.d(this.a.app.getApplication().getApplicationContext()))
        {
          bcpw.a(this.a.getApplicationContext(), 2131694609, 1).a();
        ...
        {
          i = 1;
          axqw.b(this.a.app, "CliOper", "", "", "Setting_tab", "Latest_chatlog_syn", 0, i, String.valueOf(i), "", "", "");
          this.a.a(this.a.getApplication().getResources().getString(2131719307));
          if (!paramBoolean) {
            break label624;
          }
        }
      ...
      if (paramCompoundButton == PermisionPrivacyActivity.b(this.a))
      {
        ...
        for (i = 1;; i = 0)
        {
          axqw.b(this.a.app, "CliOper", "", "", "Setting_tab", "Visible_same", 0, i, String.valueOf(i), "", "", "");
      ...
      if (paramCompoundButton == PermisionPrivacyActivity.a(this.a))
      {
        ...
        for (i = 1;; i = 0)
        {
          axqw.b(this.a.app, "CliOper", "", "", "Setting_tab", "Same_likeme", 0, i, String.valueOf(i), "", "", "");
      ...
      if (paramCompoundButton == this.a.h.a())
      {
        ...
        for (i = 1;; i = 0)
        {
          axqw.b(this.a.app, "CliOper", "", "", "Setting_tab", "Clk_signature_qzone", 0, i, String.valueOf(i), "", "", "");
          if ((!bbev.d(this.a.getActivity())) || (PermisionPrivacyActivity.a(this.a) == null)) {
            break;
          }
          if (AppSetting.d) {
            this.a.h.setContentDescription(ajyc.a(2131707917));
          }
      ...
      if (paramCompoundButton == this.a.g.a())
      {
        ...
        paramCompoundButton = new PermisionPrivacyActivity.16.1(this, (aneh)this.a.app.getManager(41), paramBoolean);
        ...
        if (paramBoolean)
        {
          if ((anec.a()) && (bfni.l()))
          {
            ...
            anee localanee = new anee();
            localanee.jdField_a_of_type_JavaLangRunnable = paramCompoundButton;
            localanee.b = ((Runnable)localObject);
            localanee.jdField_a_of_type_Int = 7;
            localPhoneContactManagerImp.a().a(this.a, localanee, this.a, new String[] { "android.permission.READ_CONTACTS", "android.permission.WRITE_CONTACTS", "android.permission.GET_ACCOUNTS" });
            return;
          }
      ...
      {
        if (AppSetting.d) {
          this.a.b.setContentDescription(ajyc.a(2131707919));
        }
        PermisionPrivacyActivity.a(this.a, this.a.b.a(), paramBoolean);
        this.a.app.c(paramBoolean, true);
        if (paramBoolean)
        {
          axqw.b(this.a.app, "CliOper", "", "", "0X8009C08", "0X8009C08", 0, 0, "", "", "", "");
          return;
        }
        axqw.b(this.a.app, "CliOper", "", "", "0X8009C09", "0X8009C09", 0, 0, "", "", "", "");
        return;
      }
      if (paramCompoundButton == this.a.c.a())
      {
        if (AppSetting.d) {
          this.a.c.setContentDescription(ajyc.a(2131707910));
        }
      ...
      if (paramCompoundButton == this.a.d.a())
      {
        ...
        for (i = 1;; i = 0)
        {
          axqw.b(paramCompoundButton, "CliOper", "", "", "0X800487E", "0X800487E", 0, 0, String.valueOf(i), "", "", "");
          if (!bbev.d(this.a.getActivity())) {
            break;
          }
          if (AppSetting.d) {
            this.a.d.setContentDescription(ajyc.a(2131707920));
          }
          ((ajtk)this.a.app.a(2)).i(paramBoolean);
          return;
        }
        paramCompoundButton = this.a;
        if (PermisionPrivacyActivity.a(this.a) != null)
    ...
    this.a.jdField_a_of_type_Akhq.a(paramBoolean);
    ...
    {
      axqw.b((QQAppInterface)localObject, "dc00899", "Grp_invite_friend", "", "auto_pass", paramCompoundButton, 0, 0, "", "", "", "");
      return;
      i = 2131693197;
      break;
    }
