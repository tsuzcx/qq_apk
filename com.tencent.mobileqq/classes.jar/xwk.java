  ...
  implements Handler.Callback
{
  ...
  private zcl jdField_a_of_type_Zcl;
  private Handler b;
  
  public xwk(Context paramContext, zcl paramzcl)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Zcl = paramzcl;
    this.jdField_a_of_type_Amzy = amzy.a();
    this.jdField_a_of_type_Amzy.a(paramContext, hashCode(), "QrImageScan");
  }
  ...
  public void a()
  {
    try
    {
      ...
      if (this.jdField_a_of_type_Amzy != null) {
        this.jdField_a_of_type_Amzy.a(hashCode(), "QrImageScan");
      }
      this.jdField_a_of_type_Zcl = null;
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (int i = xwb.a((Uri)paramMessage.obj, this.jdField_a_of_type_AndroidContentContext, j, (SparseArray)localObject);; i = 0)
    {
      boolean bool1 = xwb.a(i);
      boolean bool2 = xwb.b(i);
      if ((bool1) || (bool2))
      {
        if (bool1)
        {
      ...
      for (;;)
      {
        try
        {
          ...
          if ((!xwb.a(k)) || (paramMessage == null)) {
            break label350;
          }
          i = 1;
          if ((!xwb.b(k)) || (paramMessage == null)) {
            break label355;
          }
          j = 1;
          if ((i == 0) && (j == 0)) {
      ...
      i = paramMessage.arg1;
      j = paramMessage.arg2;
      if (this.jdField_a_of_type_Zcl == null) {
        break;
      }
      this.jdField_a_of_type_Zcl.a(String.valueOf(paramMessage.obj), i, j);
      return true;
      i = paramMessage.arg1;
      if (this.jdField_a_of_type_Zcl == null) {
        break;
      }
      this.jdField_a_of_type_Zcl.a(i);
      return true;
    }
  }
}
