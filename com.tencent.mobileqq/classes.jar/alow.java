...
public class alow
{
  ...
  private final afpx jdField_a_of_type_Afpx = new alox(this);
  private final altb jdField_a_of_type_Altb = new aloy(this);
  ...
  private alow(Activity paramActivity, FixedSizeVideoView paramFixedSizeVideoView, ImageButton paramImageButton, QzoneVerticalVideoTopicInfo paramQzoneVerticalVideoTopicInfo)
  {
  ...
  public static alow a(Activity paramActivity, FixedSizeVideoView paramFixedSizeVideoView, QzoneVerticalVideoTopicInfo paramQzoneVerticalVideoTopicInfo, ImageButton paramImageButton)
  {
    return new alow(paramActivity, paramFixedSizeVideoView, paramImageButton, paramQzoneVerticalVideoTopicInfo);
  }
  ...
  private yxk a()
  {
    ...
    {
      yxk localyxk = new yxk();
      localyxk.jdField_d_of_type_JavaLangString = this.jdField_a_of_type_CooperationQzoneVideoQzoneVerticalVideoTopicInfo.getMusicUrl();
      localyxk.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_CooperationQzoneVideoQzoneVerticalVideoTopicInfo.getTopicId();
      localyxk.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_CooperationQzoneVideoQzoneVerticalVideoTopicInfo.getMusicName();
      localyxk.jdField_b_of_type_Int = 3;
      return localyxk;
    }
    return null;
  }
  ...
  private boolean c()
  {
    return (this.jdField_a_of_type_Yxk != null) && (a() - this.jdField_a_of_type_Yxk.f > 0L);
  }
  ...
  private void f()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioAudioPlayer == null)
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityAioAudioPlayer = new AudioPlayer(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Afpx);
    ...
    if (this.jdField_a_of_type_Yxk != null)
    {
      ...
      str = this.jdField_a_of_type_Yxk.g;
      if (this.jdField_a_of_type_Int == 0) {
        break label108;
      }
    }
    label108:
    for (int i = this.jdField_a_of_type_Int;; i = this.jdField_a_of_type_Yxk.jdField_d_of_type_Int)
    {
    ...
    label119:
    QZLog.e("EditLocalVideoMusicMixe", 2, new Object[] { "startAudioPlayback: music not downloaded " + this.jdField_a_of_type_Yxk.jdField_d_of_type_JavaLangString });
  }
  
  public void a()
  {
    P2VEditMusicDialog localP2VEditMusicDialog = new P2VEditMusicDialog(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Altb, (int)a(), true);
  ...
  {
    if (this.jdField_a_of_type_Yxk != null) {
      new P2VEditMusicDialog(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Altb, (int)paramLong, true);
    }
  }
  ...
  public void a(alpa paramalpa)
  {
    QzoneHandlerThreadFactory.getHandlerThread("Normal_HandlerThread").post(new EditLocalVideoMusicMixRunnable(this.jdField_a_of_type_Long, this.b, this.c, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Yxk, new aloz(this, paramalpa)));
  }
  ...
  public boolean b()
  {
    return (this.jdField_a_of_type_Yxk != null) && ((this.jdField_a_of_type_Yxk.jdField_b_of_type_Int == 0) || (this.jdField_a_of_type_Yxk.jdField_b_of_type_Int == 3) || (this.jdField_a_of_type_Yxk.jdField_b_of_type_Int == 2)) && (!this.jdField_a_of_type_Boolean);
  }
