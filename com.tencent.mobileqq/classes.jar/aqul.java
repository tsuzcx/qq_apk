...
class aqul
  implements aqum
{
  aqul(aqui paramaqui, long paramLong1, SubMsgType0xaa.GameTeam_StartGameMessage paramGameTeam_StartGameMessage, long paramLong2, boolean paramBoolean) {}
  
  public void a(String paramString)
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)aqui.a(this.jdField_a_of_type_Aqui).get();
    ...
    for (;;)
    {
      ...
      catch (JSONException paramString)
      {
        try
        {
          ...
          if (this.jdField_a_of_type_Long < j)
          {
            ...
            if ((i > 0) && (i < 5))
            {
              ...
              bdes.a().a(localQQAppInterface.getCurrentAccountUin(), "", "", "2000", "2044", "0", false);
              return;
          ...
          if (this.jdField_a_of_type_Boolean)
          {
            bdes.a().a(localQQAppInterface.getCurrentAccountUin(), "", "", "2000", "2044", "1", false);
            return;
          }
        }
        catch (JSONException localJSONException)
        {
          ...
          bdes.a().a(localQQAppInterface.getCurrentAccountUin(), "", "", "2000", "2043", "0", false);
          return;
        }
        bdes.a().a(localQQAppInterface.getCurrentAccountUin(), "", "", "2000", "2043", "1", false);
      }
    }
  }
}
