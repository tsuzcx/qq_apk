  ...
  implements ViewTreeObserver.OnGlobalLayoutListener
{
  ...
  public arxt(Intent paramIntent)
  {
    super(paramIntent);
  }
  ...
  protected void a(String paramString1, String paramString2, Context paramContext)
  {
    ...
    try
    {
      paramString2 = bdds.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramContext, paramString2);
      paramContext = "";
      str = "";
      for (;;)
      {
      ...
      wta.a("share", paramString1, i, j, new String[] { paramContext, paramString2, "", "" });
      if (QLog.isColorLevel())
      {
  ...
  protected boolean a(bdfq parambdfq)
  {
    // Byte code:
    //   0: aload_1
    //   1: invokevirtual 126	bdfq:getWindow	()Landroid/view/Window;
    //   4: bipush 19
    //   6: invokevirtual 132	android/view/Window:setSoftInputMode	(I)V
    //   9: aload_0
    //   10: getfield 135	arxt:jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg	Lcom/tencent/mobileqq/structmsg/AbsShareMsg;
    //   13: ifnull +644 -> 657
    //   16: aload_0
    //   17: getfield 138	arxt:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   20: ldc 139
    //   22: invokestatic 144	bcwh:a	(Landroid/content/Context;F)I
    //   25: istore_2
    //   26: aload_0
    //   27: getfield 138	arxt:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   30: ldc 145
    //   32: invokestatic 144	bcwh:a	(Landroid/content/Context;F)I
    //   35: istore_3
    //   36: aload_0
    //   37: getfield 138	arxt:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   40: ldc 146
    //   42: invokestatic 144	bcwh:a	(Landroid/content/Context;F)I
    //   45: istore 4
    //   47: aload_0
    //   48: getfield 138	arxt:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   51: ldc 147
    //   53: invokestatic 144	bcwh:a	(Landroid/content/Context;F)I
    //   56: istore 5
    //   58: aload_0
    //   59: getfield 138	arxt:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   62: ldc 148
    //   64: invokestatic 144	bcwh:a	(Landroid/content/Context;F)I
    //   67: istore 6
    //   69: ldc 150
    ...
    //   79: dup
    //   80: aload_0
    //   81: getfield 138	arxt:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    ...
    //   117: dup
    //   118: aload_0
    //   119: getfield 138	arxt:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    ...
    //   142: dup
    //   143: aload_0
    //   144: getfield 138	arxt:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    ...
    //   174: dup
    //   175: aload_0
    //   176: getfield 138	arxt:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    ...
    //   225: aload 15
    //   227: aload_0
    //   228: getfield 138	arxt:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   231: ldc 201
    //   233: invokestatic 144	bcwh:a	(Landroid/content/Context;F)I
    //   236: putfield 204	android/widget/RelativeLayout$LayoutParams:topMargin	I
    //   239: new 206	android/widget/TextView
    //   242: dup
    //   243: aload_0
    //   244: getfield 138	arxt:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    ...
    //   280: aload 17
    //   282: aload_0
    //   283: getfield 138	arxt:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   286: ldc 216
    //   288: invokestatic 144	bcwh:a	(Landroid/content/Context;F)I
    ...
    //   337: aload 8
    //   339: aload 9
    //   341: invokevirtual 225	bdfq:addView	(Landroid/view/View;Landroid/widget/LinearLayout$LayoutParams;)Lbdfq;
    //   344: pop
    //   345: aload 16
    //   347: aload_0
    //   348: getfield 135	arxt:jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg	Lcom/tencent/mobileqq/structmsg/AbsShareMsg;
    ...
    //   364: dup
    //   365: aload_0
    //   366: getfield 135	arxt:jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg	Lcom/tencent/mobileqq/structmsg/AbsShareMsg;
    ...
    //   420: aload_0
    //   421: getfield 135	arxt:jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg	Lcom/tencent/mobileqq/structmsg/AbsShareMsg;
    ...
    //   601: aload_0
    //   602: aload_1
    //   603: invokevirtual 126	bdfq:getWindow	()Landroid/view/Window;
    ...
    //   618: putfield 308	arxt:jdField_a_of_type_AndroidWidgetScrollView	Landroid/widget/ScrollView;
    //   621: aload_0
    //   622: getfield 308	arxt:jdField_a_of_type_AndroidWidgetScrollView	Landroid/widget/ScrollView;
    //   625: ifnull +14 -> 639
    //   628: aload_0
    //   629: getfield 308	arxt:jdField_a_of_type_AndroidWidgetScrollView	Landroid/widget/ScrollView;
    ...
    //   640: ldc_w 320
    //   643: aload_0
    //   644: getfield 135	arxt:jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg	Lcom/tencent/mobileqq/structmsg/AbsShareMsg;
    //   647: getfield 323	com/tencent/mobileqq/structmsg/AbsShareMsg:mMsgAction	Ljava/lang/String;
    //   650: aload_0
    //   651: getfield 138	arxt:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   654: invokevirtual 325	arxt:a	(Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;)V
    //   657: iconst_1
    //   658: ireturn
    //   659: astore 11
    //   661: ldc 26
  ...
  protected void d()
  {
    ...
    String str = "";
    if (i != 0) {
      str = this.jdField_a_of_type_Bdfq.getInputValue();
    }
