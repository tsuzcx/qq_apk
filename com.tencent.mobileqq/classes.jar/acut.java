  ...
  implements baxl
{
  ...
  public acut(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner, BaseChatPie paramBaseChatPie)
  {
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_a_of_type_JavaLangBoolean = Boolean.valueOf(true);
    this.jdField_a_of_type_AndroidSupportV4UtilArraySet = new ArraySet();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Adtg = new adtg(paramContext, paramQQAppInterface, paramSessionInfo, paramAIOAnimationConatiner, paramBaseChatPie);
    ...
    {
      this.b = l;
      this.jdField_a_of_type_Aibt = new aibt(this, paramQQAppInterface);
      this.jdField_a_of_type_Aibv = new aibv(paramBaseChatPie);
      this.jdField_a_of_type_Acuu = new acuu(this);
      return;
    }
  }
  ...
  protected static void a(MessageForStructing paramMessageForStructing, acun paramacun, View paramView, boolean paramBoolean)
  {
    int i = 2130848933;
    int j = 2130848757;
    int k = 2130838146;
    ...
    for (paramChatMessage1 = ((MessageForMarketFace)paramChatMessage1).mMarkFaceMessage;; paramChatMessage1 = (ChatMessage)localObject)
    {
      ...
      if (paramChatMessage1 != null)
      {
        ...
        if (localObject != null)
        {
          ...
          {
            bool1 = bool2;
            if (anqu.a(paramChatMessage1.sbufID, paramChatMessage1.mediaType).equals(anqu.a(((MarkFaceMessage)localObject).sbufID, ((MarkFaceMessage)localObject).mediaType)))
            {
              axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", "Ep_show_follow", 0, 0, "", paramChatMessage1.dwTabID + "", "", "");
              bool1 = true;
            }
          }
        }
  ...
  {
    this.jdField_a_of_type_Adtg.a(paramChatMessage, this).a(paramView, paramChatMessage, paramInt);
  }
  ...
  public void a(ChatMessage paramChatMessage, int paramInt)
  {
    ...
    if (i >= 0)
    {
      ...
      localChatMessage = (ChatMessage)localView.getTag(2131364123);
  ...
  public void a(List<ChatMessage> paramList)
  {
    ...
    if (paramList.size() > 0)
    {
      ...
      for (;;)
      {
        if ((axas.a(localChatMessage1.msgtype)) || (akpy.i(localChatMessage1.msgtype)))
        {
          i += 1;
          ...
          else
          {
            ...
            if (paramList.size() - k >= 0)
            {
              ...
              {
                if (!axas.a(localChatMessage3.msgtype))
                {
                  localChatMessage2 = localChatMessage3;
                  localChatMessage4 = localChatMessage1;
                  i = j;
                  if (!akpy.i(localChatMessage3.msgtype)) {
                    break label216;
                  }
                }
                k += 1;
  ...
  public void a(List<ChatMessage> paramList, CharSequence paramCharSequence, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      paramCharSequence = (ajxn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 3000) || (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1) || ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 0) && (paramCharSequence != null) && (paramCharSequence.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)))) {
        ((anod)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(214)).a(paramList, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, paramInt);
      }
  ...
  public void c()
  {
    ...
    label295:
    if (this.jdField_a_of_type_Adtg != null) {
      this.jdField_a_of_type_Adtg.a();
    }
    ...
    this.jdField_a_of_type_Aibv.c();
  }
  
  public void d()
  {
    if (this.jdField_a_of_type_Acuu.a != null)
    {
      aicg localaicg = this.jdField_a_of_type_Acuu.a.a();
      if ((localaicg == null) || (!localaicg.c())) {
        break label41;
      }
      localaicg.d();
    }
    label41:
    while (!this.jdField_a_of_type_Acuu.a.a()) {
      return;
    }
    this.jdField_a_of_type_Acuu.a.a();
  }
  ...
  public int getItemViewType(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      return adtg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localChatMessage);
    }
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    bbjv.a(null, "AIO_ChatAdapter_getView" + " | " + localChatMessage1.getClass().getName());
    acvd localacvd = this.jdField_a_of_type_Adtg.a(localChatMessage1, this);
    if (paramInt != 0)
    {
    ...
    paramView = localacvd.a(paramInt, this.jdField_a_of_type_JavaUtilList.size(), localChatMessage1, paramView, paramViewGroup, this.jdField_a_of_type_Acuu);
    if (paramView != null)
    {
      paramView.setTag(2131364123, localChatMessage1);
      if (((localacvd instanceof actq)) && ((paramView instanceof agfw))) {
        paramViewGroup = (agfw)paramView;
      }
    }
    bbjv.a("AIO_ChatAdapter_getView" + " | " + localChatMessage1.getClass().getName(), null);
    return paramView;
  }
