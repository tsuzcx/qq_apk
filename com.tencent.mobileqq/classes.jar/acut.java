...
public class acut
{
  ...
  private static int a(acvd paramacvd)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 30	acvd:b	()Ljava/lang/String;
    ...
    //   557: aload 8
    //   559: invokestatic 134	acut:a	(Ljava/io/InputStream;Ljava/io/File;)V
    //   562: aload 6
    //   564: astore 4
    //   566: aload 8
  ...
  private static void a(acvd paramacvd)
  {
    long l = System.currentTimeMillis();
    try
    {
      paramacvd = paramacvd.b();
      String str = PatchCommonUtil.getPatchPath(paramacvd);
      if ("Success".equals(anvq.a(BaseApplicationImpl.sApplication, str, null, false)))
      {
        jdField_a_of_type_Int = 500;
        jdField_a_of_type_JavaLangString = paramacvd;
      }
      for (;;)
      {
    ...
    catch (Throwable paramacvd)
    {
      for (;;)
      {
        jdField_a_of_type_Int = 502;
        QLog.d("PatchLogTag", 1, "DexPatchInstaller injectDexPatch throwable=" + paramacvd);
      }
    }
  }
  ...
  public static void a(Context paramContext)
  {
    ...
    if ((!TextUtils.isEmpty(((bkga)localObject).jdField_a_of_type_JavaLangString)) && (((bkga)localObject).jdField_a_of_type_JavaLangString.startsWith("66666")))
    {
      QLog.w("PatchLogTag", 1, "running on a game assist vbox, skip patching");
      return;
    }
    long l = System.currentTimeMillis();
    localObject = acve.a(paramContext, "dex");
    if ((jdField_a_of_type_Int == 0) && (a(paramContext, (acvd)localObject)))
    {
      a((acvd)localObject);
      int j;
      if (jdField_a_of_type_Int == 500) {
        if ((((acvd)localObject).b()) && (PatchCommonUtil.isArtGeN()) && (!SoLoadUtil.a()))
        {
          j = a((acvd)localObject);
          i = j;
          if (j != 800)
          {
            String str = anvq.a(BaseApplicationImpl.sApplication, 0);
      ...
      for (int i = j;; i = 0)
      {
        a(paramContext, (acvd)localObject);
        PatchReporter.reportPatchEvent(paramContext, "", "actPatchInstall", jdField_a_of_type_Int, ((acvd)localObject).b(), i);
        ...
        if (PatchCommonUtil.isDalvik()) {
          PatchResolveForDalvik.a(paramContext, (acvd)localObject);
        }
      }
    }
  ...
  private static void a(Context paramContext, acvd paramacvd)
  {
    paramContext = new DexPatchInstaller.1(paramacvd, paramContext);
  ...
  public static void a(java.io.InputStream paramInputStream, File paramFile)
  {
    // Byte code:
    //   0: aload_1
    //   1: invokevirtual 306	java/io/File:getParentFile	()Ljava/io/File;
    //   4: invokevirtual 309	java/io/File:mkdirs	()Z
    //   7: pop
    //   8: new 311	java/io/FileOutputStream
    //   11: dup
    //   12: aload_1
    //   13: invokespecial 312	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   16: astore_3
    //   17: sipush 4096
    //   20: newarray byte
    //   22: astore_1
    //   23: aload_0
    //   24: aload_1
    //   25: invokevirtual 318	java/io/InputStream:read	([B)I
    //   28: istore_2
    //   29: iload_2
    //   30: ifle +32 -> 62
    //   33: aload_3
    ...
    //   35: iconst_0
    //   36: iload_2
    //   37: invokevirtual 324	java/io/OutputStream:write	([BII)V
    //   40: goto -17 -> 23
    //   43: astore_1
    //   44: aload_0
    //   45: ifnull +7 -> 52
    //   48: aload_0
    //   49: invokevirtual 325	java/io/InputStream:close	()V
    //   52: aload_3
    //   53: ifnull +7 -> 60
    //   56: aload_3
    //   57: invokevirtual 326	java/io/OutputStream:close	()V
    //   60: aload_1
    //   61: athrow
    //   62: aload_0
    //   63: ifnull +7 -> 70
    //   66: aload_0
    //   67: invokevirtual 325	java/io/InputStream:close	()V
    //   70: aload_3
    //   71: ifnull +7 -> 78
    //   74: aload_3
    //   75: invokevirtual 326	java/io/OutputStream:close	()V
    //   78: return
    //   79: astore_0
    //   80: goto -10 -> 70
    //   83: astore_0
  ...
  private static boolean a(Context paramContext, acvd paramacvd)
  {
    if (paramacvd == null) {
      QLog.d("PatchLogTag", 1, "DexPatchInstaller checkDexPatchConfigAndStatus patch config is null");
    }
    while (!paramacvd.a(paramContext, BaseApplicationImpl.processName)) {
      return false;
    }
    String str = paramacvd.b();
    ...
    if (localFile.length() != paramacvd.b())
    {
