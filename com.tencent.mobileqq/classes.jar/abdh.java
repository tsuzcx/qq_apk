  ...
  extends TransProcessorHandler
{
  ...
  public abdh(QQAppInterface paramQQAppInterface, SelectCoverActivity paramSelectCoverActivity)
  {
    ...
    do
    {
      ...
      case 1003: 
        ...
        if (((FileMsg)localObject).b == 36)
        {
          ...
          ThreadManager.post(new abdi(this, localSelectCoverActivity, localQQAppInterface), 8, null, true);
          return;
        }
        if (((FileMsg)localObject).b == 37)
        {
          ...
          ThreadManager.post(new abdj(this, localSelectCoverActivity, localQQAppInterface), 8, null, true);
          return;
        }
        break;
      }
