...
public class arhj
{
  ...
  private arhm jdField_a_of_type_Arhm;
  ...
  public arhj(Context paramContext, arhm paramarhm)
  {
  ...
  private void b()
  {
    if ((this.jdField_a_of_type_Arhm.d()) && (b())) {}
    do
    {
      return;
      Intent localIntent = this.jdField_a_of_type_Arhm.a();
      if (localIntent == null)
      {
      ...
      this.jdField_a_of_type_Arhm.b(localBundle);
  ...
  private boolean b()
  {
    ...
    do
    {
      do
      {
        ...
        {
          return false;
          localChatMessage = this.jdField_a_of_type_Arhm.a();
        ...
        return false;
        localSessionInfo = this.jdField_a_of_type_Arhm.a();
      ...
      return false;
      if (this.jdField_a_of_type_Arhm.c())
      {
        if (QLog.isColorLevel()) {
      ...
      if (this.jdField_a_of_type_Arhm.d()) {
        break;
      }
    } while (!QLog.isColorLevel());
    ...
    return false;
    afhq.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidGraphicsRect, localChatMessage, localSessionInfo, this.jdField_a_of_type_Arhm.a(), this.jdField_a_of_type_Arhm.e(), this.jdField_a_of_type_Arhm.f(), null);
    return true;
  }
  
  private void c()
  {
    arhl localarhl = new arhl(this);
    String str1 = this.jdField_a_of_type_AndroidContentContext.getString(2131692752);
    String str2 = this.jdField_a_of_type_AndroidContentContext.getString(2131692754);
    armv.a(this.jdField_a_of_type_AndroidContentContext, str1, str2, localarhl);
  }
  
  public void a()
  {
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Arhm.b()))
    {
      if (aroo.a(this.jdField_a_of_type_AndroidContentContext, false, new arhk(this))) {
        c();
      }
      return;
    }
