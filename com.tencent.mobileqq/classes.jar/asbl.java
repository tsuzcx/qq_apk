...
public class asbl
{
  ...
  WeakReference<axxj> jdField_a_of_type_MqqUtilWeakReference;
  boolean jdField_a_of_type_Boolean = false;
  ArrayList<asbp> b = new ArrayList();
  ...
  private void a(String paramString1, String arg2, boolean paramBoolean, asbq paramasbq)
  {
    ...
    synchronized (this.b)
    {
      ...
      while (i >= 0)
      {
        paramasbq = (asbp)this.b.get(i);
        if ((paramasbq != null) && (TextUtils.equals(paramString1, paramasbq.jdField_a_of_type_JavaLangString)))
        {
          if (paramasbq.jdField_a_of_type_Asbq != null) {
            paramasbq.jdField_a_of_type_Asbq.a(paramBoolean);
          }
          this.b.remove(i);
        }
        i -= 1;
  ...
  public void a(QQAppInterface arg1, int paramInt, String paramString1, String paramString2, String paramString3, String[] paramArrayOfString, asbq paramasbq)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ZipResourcesDownloader", 2, String.format("downloadResource url=%s md5=%s callback=%s", new Object[] { paramString2, paramString3, paramasbq }));
    }
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_MqqUtilWeakReference != null) {
          localObject1 = (axxj)this.jdField_a_of_type_MqqUtilWeakReference.get();
        }
        localObject2 = localObject1;
        if (localObject1 == null)
        {
          localObject2 = (axxj)???.getManager(193);
        ...
        if (localObject2 != null)
        {
          ...
          synchronized (this.jdField_a_of_type_JavaUtilArrayList)
          {
            ...
            if (i != 0)
            {
              ...
              synchronized (this.b)
              {
                this.b.add(new asbp(this, paramString2, paramasbq));
                return;
              }
            }
          }
      ...
      ??? = new axro();
      ((axro)???).jdField_a_of_type_Axrt = new asbm(this);
      ((axro)???).jdField_a_of_type_JavaLangString = paramString2;
      ((axro)???).jdField_a_of_type_Int = 0;
      ((axro)???).c = ((String)localObject1);
      ((axro)???).e = 0;
      ((axro)???).jdField_a_of_type_Axrs = new asbn(this);
      ((axxj)localObject2).a(paramInt, paramString1, paramString3, 0, paramString2, (String)localObject1, 2, 0, false, new axxh(???, paramString3, new asbo(this, paramString3, paramArrayOfString, paramasbq), (axro)???));
      synchronized (this.jdField_a_of_type_JavaUtilArrayList)
      {
