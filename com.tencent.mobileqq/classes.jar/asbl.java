...
public class asbl
{
  public static void a(NearbyAppInterface paramNearbyAppInterface)
  {
    ...
    aush.a(paramNearbyAppInterface.getAccount(), "nearby_enter_time", Long.valueOf(0L));
    if ((alta)paramNearbyAppInterface.a(3) != null)
    {
      oidb_0x91f.ReqBody localReqBody = new oidb_0x91f.ReqBody();
      localReqBody.uint32_state.set(0);
      mzy.a(paramNearbyAppInterface, new asbm(paramNearbyAppInterface), localReqBody.toByteArray(), "OidbSvc.0x91f", 2335, 5, null, 0L);
    }
    aush.a(paramNearbyAppInterface.getAccount(), false);
    aush.a(paramNearbyAppInterface.getAccount(), "nearby_people_disclaimer_ok_5.8.0", Boolean.valueOf(false));
  ...
  public static void b(NearbyAppInterface paramNearbyAppInterface)
  {
    ...
    {
      localFile.delete();
      ausq.a("Q.nearby", "clearNearbyCache", new Object[0]);
    }
    aush.a(paramNearbyAppInterface.getAccount(), "history_valid", Boolean.valueOf(false));
  }
}
