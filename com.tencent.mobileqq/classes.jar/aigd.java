...
public class aigd
  extends Handler
{
  public aigd(TroopMemberListInnerFrame paramTroopMemberListInnerFrame) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        this.a.d.setText(String.format(ajyc.a(2131715612), new Object[] { Integer.valueOf(Math.min((int)(this.a.jdField_a_of_type_Int * this.a.jdField_a_of_type_Double / 100.0D), this.a.jdField_a_of_type_Int)), Integer.valueOf(this.a.jdField_a_of_type_Int) }));
