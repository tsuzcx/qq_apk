...
public class bler
{
  ...
  private bleu jdField_a_of_type_Bleu = new bleu();
  ...
  private HashMap<String, String> a(String paramString1, int paramInt, String paramString2)
  {
    ...
    if ((this.jdField_d_of_type_Int == 4) || (this.jdField_d_of_type_Int == 5) || (this.jdField_d_of_type_Int == 6) || (this.jdField_d_of_type_Int == 7) || (this.jdField_d_of_type_Int == 2))
    {
      ...
      localHashMap.put("cameraId", bleq.a(ajli.jdField_a_of_type_Int));
      if (jdField_g_of_type_JavaLangLong.longValue() != 1L) {
        break label427;
      }
      localHashMap.put("resolution", bkse.a.d());
    }
    for (;;)
    {
      ...
      if (jdField_g_of_type_JavaLangLong.longValue() == 2L) {
        localHashMap.put("resolution", bkse.a.g());
      } else {
  ...
  public bleu a()
  {
    return this.jdField_a_of_type_Bleu;
  }
  ...
  public String a()
  {
    ...
    return bfhh.a(localStringBuilder.toString());
  }
  ...
  public HashMap<String, String> a(int paramInt)
  {
    ...
    localHashMap.put("content_type", String.valueOf(this.jdField_a_of_type_Bleu.jdField_b_of_type_Long));
    localHashMap.put("MD5", this.jdField_a_of_type_Bleu.jdField_a_of_type_JavaLangString);
    localHashMap.put("filter_id", this.jdField_a_of_type_Bleu.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(paramInt)));
    localHashMap.put("filter_value", String.valueOf(this.jdField_a_of_type_Bleu.jdField_b_of_type_JavaUtilHashMap.get(Integer.valueOf(paramInt))));
    localHashMap.put("music_id", "");
    localHashMap.put("sound_type", "");
    localHashMap.put("text_count", String.valueOf(this.jdField_a_of_type_Bleu.jdField_c_of_type_JavaUtilHashMap.get(Integer.valueOf(paramInt))));
    return localHashMap;
  }
  ...
  public HashMap<String, String> a(long paramLong)
  {
    ...
    for (;;)
    {
      localHashMap.put("duration", bleq.a(Long.valueOf(System.currentTimeMillis() - paramLong)));
      localHashMap.put("cameraId", bleq.a(ajli.jdField_a_of_type_Int));
      if (jdField_g_of_type_JavaLangLong.longValue() != 1L) {
        break label242;
      }
  ...
  public HashMap<String, String> a(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      if ((this.jdField_h_of_type_JavaLangString == null) || (!this.jdField_h_of_type_JavaLangString.equals(paramString)))
      {
        ...
        this.jdField_i_of_type_JavaLangString = bfhi.d(QQStoryContext.a().getAccount() + bleq.a());
      }
  ...
  public void a()
  {
    ...
    blfg.b("AEBaseReportParam", "【operation_time】:" + str);
  }
  ...
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("content_type", this.jdField_a_of_type_Bleu.jdField_b_of_type_Long + "");
    localHashMap.put("MD5", this.jdField_a_of_type_Bleu.jdField_a_of_type_JavaLangString);
  ...
  public HashMap<String, String> b(long paramLong)
  {
    ...
    if ((this.jdField_d_of_type_Int == 4) || (this.jdField_d_of_type_Int == 5) || (this.jdField_d_of_type_Int == 6) || (this.jdField_d_of_type_Int == 7) || (this.jdField_d_of_type_Int == 2))
    {
      ...
      localHashMap.put("face_uin", this.jdField_d_of_type_JavaLangString + UserAction.getQIMEI());
      label333:
      localHashMap.put("preview_view_size", bkse.a.a());
      localHashMap.put("configed_preview_resolution", bkse.a.b());
      localHashMap.put("configed_capture_resolution", bkse.a.c());
      localHashMap.put("render_resolution", bkse.a.e());
      if (jdField_g_of_type_JavaLangLong.longValue() != 1L) {
        break label528;
      }
      localHashMap.put("resolution", bkse.a.d());
      ...
      if (!bkse.a.jdField_b_of_type_Boolean) {
        break label571;
      }
    }
    label528:
  ...
  public HashMap<String, String> e()
  {
    ...
    localHashMap.put("face_id", blev.a().a("camera_ad_op_id", "", 4));
    return localHashMap;
  }
  
  public HashMap<String, String> e(String paramString)
  {
    return bleq.a(g(), a(paramString, "3"));
  }
  ...
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("duration", bleq.a(Long.valueOf(a())));
    return localHashMap;
  }
  ...
  public HashMap<String, String> g()
  {
    ...
    for (String str = bfhi.d(QQStoryContext.a().getAccount() + bleq.a());; str = this.jdField_i_of_type_JavaLangString) {
      return a(str, 1, "-1");
    }
  }
  ...
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("duration", String.valueOf(this.jdField_a_of_type_Bleu.jdField_a_of_type_Long));
    localHashMap.put("content_type", String.valueOf(this.jdField_a_of_type_Bleu.jdField_b_of_type_Long));
    localHashMap.put("MD5", this.jdField_a_of_type_Bleu.jdField_a_of_type_JavaLangString);
    localHashMap.put("filter_id", this.jdField_a_of_type_Bleu.jdField_b_of_type_JavaLangString);
    localHashMap.put("filter_value", String.valueOf(this.jdField_a_of_type_Bleu.jdField_a_of_type_Float));
    localHashMap.put("music_id", this.jdField_a_of_type_Bleu.jdField_c_of_type_JavaLangString);
    localHashMap.put("sound_type", String.valueOf(this.jdField_a_of_type_Bleu.jdField_a_of_type_Int));
    localHashMap.put("text_count", String.valueOf(this.jdField_a_of_type_Bleu.jdField_b_of_type_Int));
    return localHashMap;
  }
  ...
  public void j()
  {
    ...
    localStringBuilder.append(" ");
    localStringBuilder.append(str);
    this.n = bfhh.a(localStringBuilder.toString());
  }
  ...
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("duration_first_frame", bleq.a(Long.valueOf(this.jdField_d_of_type_Long - this.jdField_c_of_type_Long)));
    localHashMap.put("duration_bottom_bar", bleq.a(Long.valueOf(this.jdField_e_of_type_Long - this.jdField_c_of_type_Long)));
    localHashMap.put("duration_photo_btn", bleq.a(Long.valueOf(this.jdField_f_of_type_Long - this.jdField_c_of_type_Long)));
    String str;
    if (bleq.b()) {
      str = "first_launch";
    }
  ...
  public HashMap<String, String> n()
  {
    ...
    HashMap localHashMap = new HashMap();
    localHashMap.put("duration", bleq.a(Long.valueOf(l1 - l2)));
    return localHashMap;
  }
  ...
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("duration", bleq.a(Long.valueOf(this.jdField_i_of_type_Long)));
