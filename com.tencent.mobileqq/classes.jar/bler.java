...
public class bler
{
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, Activity paramActivity, int paramInt, List<ChatMessage> paramList, MqqHandler paramMqqHandler)
  {
    ...
    bleg.a(localChatMessage.frienduin, localChatMessage.senderuin, localChatMessage.istroop);
    int i = 0;
    if (i < paramList.size())
    {
      ...
      for (;;)
      {
        ...
        else if (anlo.b(localChatMessage)) {
    ...
    if (((ArrayList)localObject2).size() > 0)
    {
      ...
      paramList = bfby.a(paramQQAppInterface, (MessageForTroopFile)paramList);
      if ((paramList == null) || (paramList.e == null)) {
        return false;
      }
      bfby.a(paramActivity, paramQQAppInterface, (List)localObject2);
    }
    boolean bool = false;
    if (((ArrayList)localObject1).size() > 0)
    {
      ...
      for (i = 0; paramList.hasNext(); i = j)
      {
        ...
        localObject2 = aszt.a(paramQQAppInterface, (MessageForFile)localObject1);
        ...
        {
          j = i;
          if (asyq.a((FileManagerEntity)localObject2).a(false)) {
            j = 1;
          }
        }
      ...
      if (i != 0) {
        aszg.a(BaseActivity.sTopActivity, 2131692374, 2131692379, new bles(paramActivity, paramQQAppInterface, localArrayList1, localArrayList2, localArrayList3, paramMqqHandler, paramInt));
      }
    }
    while (bool)
    {
      QQToast.a(paramQQAppInterface.getApp(), 2131692493, 0).b(paramInt);
      return true;
      paramActivity = paramActivity.iterator();
      for (bool = false; paramActivity.hasNext(); bool = aszt.a(paramQQAppInterface, (MessageForFile)paramActivity.next(), BaseActivity.sTopActivity, true)) {}
      bool |= a(paramQQAppInterface, localArrayList1, localArrayList2, localArrayList3, paramMqqHandler, paramInt);
      continue;
      bool = a(paramQQAppInterface, localArrayList1, localArrayList2, localArrayList3, paramMqqHandler, paramInt);
    }
    QQToast.a(paramQQAppInterface.getApp(), 2131692545, 0).b(paramInt);
    return false;
  }
  ...
  {
    bcef.b(paramQQAppInterface, "CliOper", "", "", "0X80067F8", "0X80067F8", 0, 0, "", "", "", "");
    if (!NetworkUtil.isNetSupport(paramActivity))
    {
      QQToast.a(paramQQAppInterface.getApp(), 2131692035, 0).b(paramInt);
      return false;
    }
    List localList = awcm.a().a();
    if (localList.size() == 0)
    {
      QQToast.a(paramQQAppInterface.getApp(), 2131697898, 0).b(paramInt);
      return false;
    }
    if (localList.size() == 1) {
    ...
    if (((paramArrayList != null) && (paramArrayList.size() > 0)) || ((paramArrayList1 != null) && (paramArrayList1.size() > 0)) || ((paramArrayList2 != null) && (paramArrayList2.size() > 0)))
    {
      ...
      if ((paramArrayList2 != null) && (paramArrayList2.size() > 0))
      {
        ...
        if (paramArrayList2.hasNext())
        {
          ...
          for (;;)
          {
            ...
            if (!bcgx.class.isInstance(localObject1)) {
              break;
            }
            localObject1 = ((bcgx)localObject1).a.iterator();
            while (((Iterator)localObject1).hasNext())
            {
              Object localObject2 = (bcgw)((Iterator)localObject1).next();
              if (bcjc.class.isInstance(localObject2))
              {
                localObject2 = (bcjc)localObject2;
                if ((!a(((bcjc)localObject2).a)) && (!ahtj.a(((bcjc)localObject2).a))) {
                  localArrayList.add(((bcjc)localObject2).a);
                }
              }
            }
          }
      ...
      if ((paramArrayList != null) && (paramArrayList.size() > 0))
      {
        ...
        while (paramArrayList.hasNext())
        {
          ...
          if ((!a(paramArrayList2)) && (!ahtj.a(paramArrayList2))) {
      ...
      paramQQAppInterface.getFileManagerEngine().a().a(localArrayList, paramArrayList1, new blev(paramMqqHandler, paramQQAppInterface.getApp(), paramQQAppInterface, paramInt));
      return true;
    }
    return false;
  }
  ...
  {
    return (amtr.a(paramChatMessage)) || (amrp.a(paramChatMessage));
  }
  ...
  public static boolean b(QQAppInterface paramQQAppInterface, Activity paramActivity, int paramInt, List<ChatMessage> paramList, MqqHandler paramMqqHandler)
  {
    ...
    bleg.a(paramList.frienduin, paramList.senderuin, paramList.istroop);
    if ((paramList instanceof MessageForTroopFile)) {
      bfby.b(paramActivity, paramQQAppInterface, paramList);
    }
    for (;;)
    {
      return true;
      ...
      {
        paramActivity = aszt.a(paramQQAppInterface, (MessageForFile)paramList);
        ...
        if (asyq.a((MessageForFile)paramList).a(false))
        {
          if (bhnb.a(BaseActivity.sTopActivity, 5, new blet(paramQQAppInterface, paramList))) {
            aszg.a(BaseActivity.sTopActivity, 2131692374, 2131692377, new bleu(paramQQAppInterface, paramList));
          }
        }
        else {
          aszt.a(paramQQAppInterface, paramList, BaseActivity.sTopActivity);
        }
      }
      else if (((paramList instanceof MessageForPic)) || ((paramList instanceof MessageForShortVideo)))
      {
        ...
        paramQQAppInterface.getFileManagerEngine().a().a(paramList, new blev(paramMqqHandler, paramActivity, paramQQAppInterface, paramInt));
      ...
      else
      {
        ...
        {
          Object localObject1 = (bcgw)paramList.next();
          if (bcgx.class.isInstance(localObject1))
          {
            localObject1 = ((bcgx)localObject1).a.iterator();
            while (((Iterator)localObject1).hasNext())
            {
              ...
              {
                localObject2 = (bcjc)localObject2;
                if (!a(((bcjc)localObject2).a)) {
                  paramActivity.add(((bcjc)localObject2).a);
                }
              }
            }
          }
