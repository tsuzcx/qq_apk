...
public class bnxr
  implements bnvc
{
  public bnxr(AEEditorImageEditFragment paramAEEditorImageEditFragment) {}
  ...
  public void a(int paramInt, bnwd parambnwd)
  {
    if (this.a.jdField_a_of_type_DovComQqImAeeditorModuleAifilterAEEditorAILoadingView != null) {
      ThreadManager.getUIHandler().post(new AEEditorImageEditFragment.17.1(this, parambnwd));
    }
    if (paramInt == 0)
    {
    ...
    if (parambnwd != null)
    {
      ...
      if (paramInt < AEEditorImageEditFragment.b(this.a))
      {
        ...
        for (;;)
        {
          paramInt += 1;
          break;
          if ((AEEditorImageEditFragment.a(this.a).a((String)AEEditorImageEditFragment.b(this.a).get(paramInt)) != null) && (((bnwm)parambnwd.a.get(paramInt)).a))
          {
          ...
          {
            AEEditorImageEditFragment.a(this.a).a((String)AEEditorImageEditFragment.b(this.a).get(paramInt), (bnwd)parambnwd.a.get(paramInt));
            AEEditorImageEditFragment.a(this.a).put(String.valueOf(paramInt), this.a.a((bnwd)parambnwd.a.get(paramInt)));
            AEEditorImageEditFragment.a(this.a).a(paramInt, (bnwd)parambnwd.a.get(paramInt));
            localStringBuilder.append(((bnwm)parambnwd.a.get(paramInt)).a() + "|");
          }
        }
      }
