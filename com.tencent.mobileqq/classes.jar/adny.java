...
{
  public adny(AuthDevActivity paramAuthDevActivity) {}
  ...
  public void OnCheckDevLockSms(WUserSigInfo paramWUserSigInfo, int paramInt, ErrMsg paramErrMsg)
  {
    ...
    do
    {
      ...
      paramWUserSigInfo = (anus)this.a.app.a(34);
      if (paramWUserSigInfo != null) {
        paramWUserSigInfo.a();
      }
  ...
  public void OnCloseDevLock(WUserSigInfo paramWUserSigInfo, int paramInt, ErrMsg paramErrMsg)
  {
    ...
    do
    {
      ...
      AuthDevActivity.a(this.a).setVisibility(8);
      asfr.a().a(this.a.app, this.a, this.a.app.getCurrentAccountUin(), false);
      QQToast.a(this.a.getApplicationContext(), 2, this.a.getString(2131691804), 0).b(this.a.getTitleBarHeight());
      paramWUserSigInfo = this.a.app.getHandler(LoginInfoActivity.class);
      if (paramWUserSigInfo != null) {
    ...
    QQToast.a(this.a.getApplicationContext(), 1, this.a.getString(2131691803), 0).b(this.a.getTitleBarHeight());
  }
}
