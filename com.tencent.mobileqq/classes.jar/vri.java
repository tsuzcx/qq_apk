...
public class vri
{
  private static volatile vri jdField_a_of_type_Vri;
  ...
  private void a(FeedCloudCommon.StCommonExt paramStCommonExt, int paramInt)
  {
    ...
    VSNetworkHelper.a().a(paramStCommonExt, new vrj(this, paramInt));
  }
  ...
  private void a(FeedCloudRead.StGetSessionInfoRsp paramStGetSessionInfoRsp, int paramInt)
  {
    ...
    do
    {
      do
      {
        ...
        vrl.a().a(this.jdField_b_of_type_ArrayOfByte);
        return;
      } while (1 != paramStGetSessionInfoRsp.sessionType.get());
      this.jdField_b_of_type_ArrayOfByte = paramStGetSessionInfoRsp.sessonID.get().toByteArray();
      this.jdField_a_of_type_Int = paramStGetSessionInfoRsp.expireTime.get();
  ...
  private void e(int paramInt)
  {
    if (this.d != null)
    {
      ...
      {
        vre.a(this.jdField_b_of_type_Long, System.currentTimeMillis() - localLong.longValue(), paramInt, paramInt);
  ...
  private void f(int paramInt)
  {
    if (this.jdField_a_of_type_Long != 0L)
    {
      ...
      for (Object localObject = this.jdField_a_of_type_ArrayOfByte;; localObject = this.jdField_b_of_type_ArrayOfByte)
      {
        ...
        VSNetworkHelper.a().a((VSBaseRequest)localObject, new vrk(this, (QCircleHeartbeatSignalReportRequest)localObject));
        h();
        return;
      }
    }
  ...
  private void h()
  {
    ...
    vra.a(this.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, this.jdField_b_of_type_Long, this.jdField_b_of_type_Int);
  ...
  public String a()
  {
    return (String)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(uxx.a()));
  }
  
  public List<FeedCloudCommon.Entry> a()
  {
    i();
    return new ArrayList(Arrays.asList(new FeedCloudCommon.Entry[] { a("uin", String.valueOf(biip.a().a())), a("network_type", b()), a("app_version", "8.4.1.4680"), a("qua", blru.a()), a("platform", "android"), a("report_from", "1"), a("os_version", Build.VERSION.RELEASE), a("mobile_type", Build.MODEL), a("respond_type", biuf.e()), a("device_info", Build.DEVICE), a("imei", biuf.c()), a("idfa", ""), a("idfv", "") }));
  }
  ...
  public void a(int paramInt, Intent paramIntent)
  {
    if (paramIntent != null)
    {
      ...
      if (paramIntent != null)
      {
        ...
        this.jdField_c_of_type_JavaLangString = paramIntent.getString("key_to_uin", "");
  ...
  public void a(String paramString)
  {
    ...
    {
      this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.remove(Long.valueOf(uxx.a()));
      return;
    }
    this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.put(Long.valueOf(uxx.a()), paramString);
  }
  ...
  public void b(String paramString)
  {
    if (TextUtils.isEmpty(paramString))
    {
      this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.remove(Long.valueOf(uxx.a()));
      return;
    }
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put(Long.valueOf(uxx.a()), paramString);
  }
