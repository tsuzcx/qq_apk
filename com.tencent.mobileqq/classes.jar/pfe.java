...
public class pfe
{
  ...
  public static int a(int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      paramInt2 = i;
    } while (!pha.a(paramInt1));
    return 3;
  }
  
  public static String a()
  {
    return (int)Math.ceil(Float.valueOf((float)bgln.d()).floatValue() / 1024.0F / 1024.0F / 1024.0F) + "";
  }
  
  public static String a(Context paramContext)
  {
    paramContext = bgln.a(paramContext).a;
  ...
  public static JSONObject a(Context paramContext, int paramInt1, int paramInt2, int paramInt3, ArticleInfo paramArticleInfo)
  {
    ...
    try
    {
      ...
      localJSONObject.put("rowkey", ube.a(paramArticleInfo));
  ...
  public static void a(int paramInt1, long paramLong1, int paramInt2, int paramInt3, long paramLong2, int paramInt4, String paramString1, String paramString2)
  {
    ...
    if (!TextUtils.isEmpty("8.4.1")) {
      localGalleryExpReported.client_ver.set(ByteStringMicro.copyFromUtf8("8.4.1"));
    }
  ...
  public static void a(Context paramContext, ArticleInfo paramArticleInfo, String paramString, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramContext = a(paramContext, pha.a() + "", i, paramArticleInfo.mArticleID, 0, paramArticleInfo.innerUniqueID, paramArticleInfo.galleryReprotExdData, a(pha.a(paramArticleInfo)), 0, (int)paramArticleInfo.mChannelID, paramJSONObject);
        oat.a(null, "" + paramArticleInfo.publishUin, paramString, paramString, 0, 0, "", paramArticleInfo.mArticleID + "", paramArticleInfo.mAlgorithmID + "", paramContext, false);
        return;
      }
  ...
  public static void a(Context paramContext, ArticleInfo paramArticleInfo, snh paramsnh)
  {
    if ((pha.d(paramArticleInfo)) || (pha.d(paramArticleInfo)) || (pha.b(paramArticleInfo)))
    {
      paramContext = a(paramContext, pha.a() + "", ComponentContentGalleryBiu.a(paramArticleInfo, paramsnh), paramArticleInfo.mArticleID, paramsnh.a().indexOf(paramArticleInfo), paramArticleInfo.innerUniqueID, paramArticleInfo.galleryReprotExdData, a(pha.a(paramArticleInfo)), 0, (int)paramArticleInfo.mChannelID, null);
      oat.a(null, "" + paramArticleInfo.publishUin, "0X8008E2F", "0X8008E2F", 0, 0, "", paramArticleInfo.mArticleID + "", paramArticleInfo.mAlgorithmID + "", paramContext, false);
    }
  }
  ...
  public static void a(Context paramContext, String paramString, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      ...
      oat.a(null, "", paramString, paramString, 0, 0, "", "", "", localJSONObject.toString(), false);
      return;
    }
    catch (JSONException paramContext)
    {
  ...
  public static void a(pfg parampfg)
  {
    oat.a(null, parampfg.a, parampfg.b, parampfg.c, 0, 0, "", parampfg.e, parampfg.f, parampfg.g, false);
  }
  ...
  public static String b()
  {
    ...
    if (!a)
    {
      ...
      a = true;
      SosoInterface.a(new pff(3, true, true, 300000L, false, false, "GalleryReportedUtils"));
    }
    return "";
  }
}
