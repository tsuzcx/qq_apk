  ...
  extends Dialog
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131373687));
    ...
    ((RelativeLayout)findViewById(2131373686)).setOnClickListener(new xqk(this));
    ...
    for (;;)
    {
      this.jdField_b_of_type_AndroidWidgetImageView.setOnClickListener(new xqn(this));
      return;
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      break;
      label207:
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
      if (this.jdField_a_of_type_AndroidWidgetTextView.getPaint().measureText(this.jdField_a_of_type_JavaLangString) > xod.a(getContext(), 280.0F)) {
      ...
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new xql(this));
      break label160;
      label335:
      ...
      if (this.jdField_b_of_type_AndroidViewView$OnClickListener != null) {
        ...
        this.jdField_b_of_type_AndroidWidgetButton.setOnClickListener(new xqm(this));
      }
    }
  }
}
