...
public class pro
{
  ...
  public pro(int paramInt)
  {
    this.jdField_a_of_type_Int = paramInt;
  }
  
  public static pro a(oidb_cmd0xbc9.BannerItem paramBannerItem)
  {
    pro localpro = null;
    if (paramBannerItem.uint32_banner_type.has())
    {
      if (paramBannerItem.uint32_banner_type.get() == 2) {
        localpro = prs.b(paramBannerItem);
      }
    }
    else {
      return localpro;
    }
    return prq.b(paramBannerItem);
  }
  
  protected static void a(pro parampro, oidb_cmd0xbc9.BannerItem paramBannerItem)
  {
    boolean bool = true;
    if (parampro != null)
    {
      ...
      for (;;)
      {
        parampro.jdField_a_of_type_Boolean = bool;
        parampro.jdField_a_of_type_Long = paramBannerItem.uint64_banner_id.get();
        localObject = paramBannerItem.msg_ad_click_report.get();
        if ((localObject == null) || (((List)localObject).size() <= 0)) {
          break;
        }
        parampro.jdField_a_of_type_JavaUtilList = new ArrayList();
        localObject = ((List)localObject).iterator();
        while (((Iterator)localObject).hasNext())
        {
          oidb_cmd0xbc9.AdReport localAdReport = (oidb_cmd0xbc9.AdReport)((Iterator)localObject).next();
          parampro.jdField_a_of_type_JavaUtilList.add(prm.a(localAdReport));
        }
        bool = false;
      }
      ...
      {
        parampro.jdField_b_of_type_JavaUtilList = new ArrayList();
        ...
        while (paramBannerItem.hasNext())
        {
          ...
          parampro.jdField_b_of_type_JavaUtilList.add(prm.a((oidb_cmd0xbc9.AdReport)localObject));
        }
      }
    }
  }
  
  public static void a(oidb_cmd0xbc9.BannerItem paramBannerItem, pro parampro)
  {
    if (paramBannerItem.bytes_superscript_color.has()) {
      parampro.jdField_a_of_type_JavaLangString = paramBannerItem.bytes_superscript_color.get().toStringUtf8();
    }
    if (paramBannerItem.bytes_superscript_text.has()) {
      parampro.jdField_b_of_type_JavaLangString = paramBannerItem.bytes_superscript_text.get().toStringUtf8();
    }
    if (paramBannerItem.bytes_banner_title.has()) {
      parampro.d = paramBannerItem.bytes_banner_title.get().toStringUtf8();
    }
  }
  
  public List<String> a(List<prm> paramList)
  {
    ...
    while (paramList.hasNext()) {
      localArrayList.add(((prm)paramList.next()).jdField_a_of_type_JavaLangString);
    }
  ...
  protected void a(oidb_cmd0xbc9.BannerItem paramBannerItem)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      while (localIterator.hasNext()) {
        ((List)localObject).add(((prm)localIterator.next()).a());
      }
    }
