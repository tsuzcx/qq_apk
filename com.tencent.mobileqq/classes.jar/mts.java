...
public class mts
{
  static mts jdField_a_of_type_Mts;
  ...
  public mts(Context paramContext, VideoController paramVideoController, Button paramButton)
  {
    ...
    b(paramButton);
    this.jdField_a_of_type_Mua = new mua(this);
    c();
  ...
  private Drawable a(Resources paramResources, int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean)
      {
        paramResources = mrb.a(paramResources, 2130842011, false);
      }
      else
      {
        paramResources = mtr.a(paramResources, 2130841961, 2131165963);
        continue;
        if (paramBoolean)
        {
          paramResources = mrb.a(paramResources, 2130842010, false);
        }
        else
        {
          paramResources = mtr.a(paramResources, 2130841960, 2131165963);
          continue;
          if (paramBoolean)
          {
            paramResources = mrb.a(paramResources, 2130841959);
          }
          else
          {
            paramResources = mtr.a(paramResources, 2130842233, 2131166000);
            continue;
            if (paramBoolean)
            {
              paramResources = mrb.a(paramResources, 2130841963);
            }
            else
            {
              paramResources = mtr.a(paramResources, 2130842240, 2131166000);
              continue;
              if (paramBoolean)
              {
                paramResources = mrb.a(paramResources, 2130841962);
              }
              else
              {
                paramResources = mtr.a(paramResources, 2130842235, 2131166000);
                continue;
                if (paramBoolean) {
                  paramResources = mrb.a(paramResources, 2130842010, false);
                } else {
                  paramResources = mtr.a(paramResources, 2130842238, 2131166000);
                }
              }
            }
          }
  ...
  public static mts a()
  {
    try
    {
      mts localmts = jdField_a_of_type_Mts;
      return localmts;
    }
    finally
    {
  ...
  public static mts a(Context paramContext, VideoController paramVideoController)
  {
    if (jdField_a_of_type_Mts == null) {}
    try
    {
      if (jdField_a_of_type_Mts == null) {
        jdField_a_of_type_Mts = new mts(paramContext, paramVideoController, null);
      }
      return jdField_a_of_type_Mts;
    }
    finally {}
  }
  ...
  private void a(String[] paramArrayOfString)
  {
    ...
    for (this.jdField_e_of_type_Boolean = Arrays.asList(paramArrayOfString).contains("DEVICE_BLUETOOTHHEADSET");; this.jdField_e_of_type_Boolean = false)
    {
      if ((this.jdField_e_of_type_Boolean != bool) && (this.jdField_e_of_type_Boolean))
      {
        ...
        bcst.b(null, "CliOper", "", "", "0X8008D1D", "0X8008D1D", 0, 0, "", "", "", "");
      }
      return;
    }
  }
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          bool1 = localSharedPreferences.getBoolean(paramVideoAppInterface.getApp().getString(2131694396), true);
          String str = paramVideoAppInterface.getCurrentAccountUin();
          if (str != null) {
            bool1 = localSharedPreferences.getBoolean(paramVideoAppInterface.getApp().getString(2131694396) + str, true);
          }
          bool2 = bool1;
        } while (bgkl.a() == 0);
        bool2 = bool1;
          ...
          do
          {
            do
            {
              ...
              if (paramVideoAppInterface.getCurrentAccountUin() != null)
              {
                ...
                bool1 = bool2;
                if (str != null) {
                  bool1 = localSharedPreferences.getBoolean(paramVideoAppInterface.getApp().getString(2131694395) + str, true);
                }
              }
              bool2 = bool1;
            } while (bgkl.a() == 0);
  ...
  public int a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentSharpJniTraeAudioSession == null) {
      this.jdField_a_of_type_ComTencentSharpJniTraeAudioSession = new TraeAudioSession((Context)this.jdField_a_of_type_MqqUtilWeakReference.get(), this.jdField_a_of_type_Mua);
    }
  ...
  public void a(int paramInt)
  {
    ...
    {
      long l = AudioHelper.b();
      QLog.w("TraeSessionHelper", 1, "pressHandFreeBtn, isSpeakerOn[" + ((ley)localObject2).P + "], seq[" + l + "]", (Throwable)localObject1);
      Object localObject3 = ((ley)localObject2).a;
      ...
      for (;;)
      {
        ...
        localObject3 = new mty((String[])localObject3);
        if (!TextUtils.isEmpty(((ley)localObject2).r)) {
          ((mty)localObject3).a(((ley)localObject2).r);
        }
        localObject2 = (bkho)bkif.a((Context)localObject1, null);
        ((bkho)localObject2).a(2131694966);
        ListView localListView = new ListView((Context)localObject1);
        if (this.jdField_a_of_type_Mtw == null) {
          this.jdField_a_of_type_Mtw = new mtw((Context)localObject1, (mty)localObject3);
        }
        for (;;)
        {
          localListView.setAdapter(this.jdField_a_of_type_Mtw);
          ...
          localListView.setOnItemClickListener(new mtt(this, localButton, l, (bkho)localObject2));
          ((bkho)localObject2).a(localListView);
          ((bkho)localObject2).c(2131690582);
          ((bkho)localObject2).a(new mtu(this));
          ((bkho)localObject2).setOnShowListener(new mtv(this));
          ((bkho)localObject2).show();
          return;
          this.jdField_a_of_type_Mtw.a((Context)localObject1, (mty)localObject3);
        }
        int k;
        if (((ley)localObject2).P)
        {
          int i = 0;
          do
          {
  ...
  public void a(long paramLong, ley paramley)
  {
    if (paramley == null) {
      if (QLog.isColorLevel()) {
    ...
    if (QLog.isColorLevel()) {
      QLog.w("TraeSessionHelper", 1, "switchButton_handFree, isSpeakerOn[" + paramley.P + "], seq[" + paramLong + "]");
    }
  ...
  public boolean a(long paramLong, VideoAppInterface paramVideoAppInterface, int paramInt1, int paramInt2, MediaPlayer.OnCompletionListener paramOnCompletionListener)
  {
    if ((b(paramVideoAppInterface)) && (a(paramVideoAppInterface.getApp().getApplicationContext())))
    {
      ...
      for (;;)
      {
        ...
        bgkl.a(paramInt1, paramInt2, paramOnCompletionListener);
      }
    }
    return false;
  }
