  ...
  extends abwa
{
  ...
  public anld(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
  ...
  private MessageRecord a(MsgInfo paramMsgInfo, long paramLong)
  {
    ...
    long l1 = PkgTools.getLongData((byte[])localObject6, 0);
    byte b = localObject6[4];
    Object localObject5 = new ArrayList();
    Object localObject4 = (amqx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(6);
    Object localObject1 = (amsw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
    Object localObject7 = (amrb)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53);
    ...
    case 9: 
      do
      {
        ...
        {
          return null;
          paramLong = PkgTools.getLongData((byte[])localObject6, 5);
          l2 = PkgTools.getLongData((byte[])localObject6, 9);
          ...
          ((amqx)localObject4).a(l1);
          i = ((amrb)localObject7).a(l1 + "");
        } while (((amrb)localObject7).a(String.valueOf(l1), String.valueOf(l2)));
        if (QLog.isColorLevel()) {
        ...
        if ((TextUtils.isEmpty((CharSequence)localObject1)) || (ContactUtils.isDiscussionMeeting(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1))))
        {
          if (QLog.isColorLevel()) {
            QLog.d("Q.msg.DiscMsgPc.discuss", 2, "coptype 2 server memberName empty");
          }
          localObject1 = ContactUtils.getDiscussionMemberShowName(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1), (String)localObject6);
        }
        localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691678, new Object[] { localObject1 });
        ((List)localObject5).add(localObject6);
        ((amqx)localObject4).a(l1, (String)localObject6, (List)localObject5, 10009);
        if (((String)localObject6).equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))
        {
          ((amrb)localObject7).a(String.valueOf(l1), String.valueOf(l3));
          a(b, l1, l3);
          ((amqx)localObject4).a(String.valueOf(l1));
          return null;
        }
        ((amqx)localObject4).a(l1);
        ((amrb)localObject7).a(String.valueOf(l1), String.valueOf(l3));
        ...
        l2 = PkgTools.getLongData((byte[])localObject6, 5);
        k = PkgTools.getShortData((byte[])localObject6, 13);
        localObject3 = new ArrayList();
        j = 15;
        for (i = 1; i < k + 1; i = (short)(i + 1))
        {
          localObject7 = (String)((ArrayList)localObject1).get(i);
          l3 = PkgTools.getLongData((byte[])localObject6, j);
          j += 4;
          ((List)localObject5).add(String.valueOf(l3));
          ((ArrayList)localObject3).add(new Pair(String.valueOf(l3), localObject7));
        }
        localObject6 = new amra();
        ((amra)localObject6).jdField_b_of_type_Int = ((ArrayList)localObject1).size();
        ((amra)localObject6).jdField_a_of_type_JavaLangString = String.valueOf(l1);
        ((amqx)localObject4).a((amra)localObject6);
        ((amqx)localObject4).a(l1, String.valueOf(l2), (List)localObject5, 10004);
        localObject4 = new Pair(Long.valueOf(l2), ((ArrayList)localObject1).get(0));
        localObject6 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProxyManager().a();
        if ((RecentUser)((anuz)localObject6).findRecentUser(Long.toString(l1), 3000) != null)
        {
          if (QLog.isColorLevel()) {
            QLog.d("Q.msg.DiscMsgPc.discuss", 2, "handleDiscussionMemchangeMsg ru alreadyintab");
          }
          if (ContactUtils.isDiscussionMeeting(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1)))
          {
        ...
        localObject5 = (RecentUser)((anuz)localObject6).findRecentUserByUin(Long.toString(l1), 3000);
        akms.a((RecentUser)localObject5, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade());
        ...
        ((anuz)localObject6).saveRecentUser((BaseRecentUser)localObject5);
        if (QLog.isColorLevel()) {
        ...
        for (;;)
        {
          ...
          if (TextUtils.equals((CharSequence)localObject6, String.valueOf(l2)))
          {
            ...
            bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Multi_call", "Show_discuss_tips", 0, 0, "", "", "", "");
          }
          else
          {
            b((Pair)localObject4, paramMsgInfo, (ArrayList)localObject3, paramLong, String.valueOf(l1), b, true);
        ...
        l2 = PkgTools.getLongData((byte[])localObject6, 5);
        l3 = PkgTools.getLongData((byte[])localObject6, 9);
        PkgTools.getLongData((byte[])localObject6, 13);
        i = PkgTools.getShortData((byte[])localObject6, 17);
        localObject1 = new byte[i];
        PkgTools.getBytesData((byte[])localObject6, 19, (byte[])localObject1, i);
        ...
        if (l2 == paramLong)
        {
          localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691642, new Object[] { localObject5 });
          ((amqx)localObject4).a(String.valueOf(l1), (String)localObject5);
          a(paramMsgInfo, paramLong, l1, l2, (String)localObject1);
          return null;
        }
        localObject3 = "";
        localObject1 = ((amrb)localObject7).a(String.valueOf(l1));
        if ((localObject1 != null) && (((DiscussionInfo)localObject1).isDiscussHrMeeting())) {
          localObject1 = bfxn.a((amrb)localObject7, ((DiscussionInfo)localObject1).uin, String.valueOf(l2));
        }
        for (;;)
        {
          ...
          if (TextUtils.isEmpty((CharSequence)localObject1))
          {
            ...
            localObject3 = ContactUtils.getDiscussionMemberShowName(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1), String.valueOf(l2));
          }
          localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691643, new Object[] { localObject3, localObject5 });
          break;
          localObject1 = localObject3;
          if (paramMsgInfo.vNickName != null)
          {
      ...
      } while (PkgTools.getShortData((byte[])localObject6, 5) == 0);
      k = PkgTools.getShortData((byte[])localObject6, 7);
      localObject4 = new ArrayList();
      i = 9;
      j = 0;
      while (j < k)
      {
        l3 = PkgTools.getLongData((byte[])localObject6, i);
        localObject3 = "";
        localObject1 = localObject3;
        if (paramMsgInfo.vNickName != null)
        {
      ...
      j = PkgTools.getShortData((byte[])localObject6, i);
      localObject1 = new byte[j];
      PkgTools.getBytesData((byte[])localObject6, i + 2, (byte[])localObject1, j);
    ...
    case 22: 
      l3 = PkgTools.getLongData((byte[])localObject6, 5);
      PkgTools.getLongData((byte[])localObject6, 9);
      l4 = PkgTools.getLongData((byte[])localObject6, 13);
      l5 = PkgTools.getLongData((byte[])localObject6, 17);
      if (l5 == 0L) {
        break;
      }
    }
    for (int i = 1;; i = 0)
    {
      ...
      default: 
        ...
        if ((RecentUser)((anuz)localObject1).findRecentUser(Long.toString(l1), 3000) != null) {
          return null;
        }
        break;
      case 0: 
      case 1: 
      case 2: 
        k = PkgTools.getShortData((byte[])localObject6, 25);
        j = 27;
        localObject3 = "";
        localObject1 = localObject3;
        if (i != 0)
        ...
        localObject1 = new amra();
        ((amra)localObject1).jdField_b_of_type_Int = k;
        ((amra)localObject1).jdField_a_of_type_JavaLangString = String.valueOf(l1);
        ((amqx)localObject4).a((amra)localObject1);
        ...
        for (i = 1;; i = 0)
        {
          ...
          while (i < k)
          {
            String str = String.valueOf(PkgTools.getLongData((byte[])localObject6, j));
            localObject3 = "";
            localObject1 = localObject3;
            if (paramMsgInfo.vNickName != null)
            {
        ...
        for (;;)
        {
          ((amqx)localObject4).a(l1, String.valueOf(l3), (List)localObject5, i);
          if (this.jdField_a_of_type_AndroidOsHandler == null) {
            this.jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper());
          }
      ...
      localObject3 = (RecentUser)((anuz)localObject1).findRecentUserByUin(Long.toString(l1), 3000);
      ...
      ((anuz)localObject1).saveRecentUser((BaseRecentUser)localObject3);
      return null;
      i = localObject6.length - 5;
      localObject1 = new byte[i];
      PkgTools.getBytesData((byte[])localObject6, 5, (byte[])localObject1, i);
      localObject3 = new oidb_0x858.NotifyMsgBody();
      paramMsgInfo = (MessageForQQWalletTips)bbli.a(-2029);
      try
      {
        ...
        paramMsgInfo.init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), l2 + "", "", "[QQWallet Tips]", bbko.a(), -2029, 3000, bbko.a());
      ...
      return null;
      PkgTools.getLongData((byte[])localObject6, 5);
      PkgTools.getLongData((byte[])localObject6, 9);
      i = localObject6[13];
      return null;
      l3 = PkgTools.getLongData((byte[])localObject6, 5);
      l4 = PkgTools.getLongData((byte[])localObject6, 9);
      i = PkgTools.getUnsignedByte(localObject6[13]);
      PkgTools.getUTFString((byte[])localObject6, 14, i);
      i += 14;
      k = PkgTools.getShortData((byte[])localObject6, i);
      j = i + 2;
      Object localObject2 = new HashSet();
      i = 0;
      while (i < k)
      {
        l5 = PkgTools.getLongData((byte[])localObject6, j);
        j += 4;
      ...
      localObject3 = (amqx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(6);
      ...
      if (((HashSet)localObject2).contains(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))
      {
        ...
        for (;;)
        {
          ((amqx)localObject3).a(l1, String.valueOf(l3), (List)localObject5, 10005);
          return null;
          ((amqx)localObject3).a((String)localObject4);
          a(paramMsgInfo, paramLong, l2, l2, amtj.a(2131702463));
        }
      }
      ((amqx)localObject3).a((String)localObject4, (HashSet)localObject2);
      if (Long.getLong((String)localObject4) != null) {}
      for (paramLong = Long.getLong((String)localObject4).longValue();; paramLong = 0L)
      {
        ((amqx)localObject3).a(paramLong);
        break;
      }
      l4 = PkgTools.getLongData((byte[])localObject6, 5);
      l3 = PkgTools.getLongData((byte[])localObject6, 9);
      if (QLog.isColorLevel()) {
      ...
      if (TextUtils.isEmpty((CharSequence)localObject2))
      {
        ...
        localObject2 = ContactUtils.getDiscussionMemberShowName(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1), (String)localObject7);
      }
      for (;;)
      {
        k = PkgTools.getShortData((byte[])localObject6, 13);
        ...
        while (i < k)
        {
          l4 = PkgTools.getLongData((byte[])localObject6, j);
          if (QLog.isColorLevel()) {
        ...
        if (((HashSet)localObject8).size() > 0)
        {
          ...
          while (((Iterator)localObject6).hasNext())
          {
            ...
            ((StringBuffer)localObject3).append(ContactUtils.getDiscussionMemberShowName(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1), (String)localObject9)).append("、");
          }
        }
        ...
        {
          localObject6 = (amqx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(6);
          ((amqx)localObject6).a(l1, (String)localObject7, (List)localObject5, 10005);
          localObject3 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691675, new Object[] { localObject3 });
          if (((HashSet)localObject8).contains(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))
          {
            ...
            ((amqx)localObject6).a(String.valueOf(l1));
            a(paramMsgInfo, paramLong, l2, l2, amtj.a(2131702462));
            return null;
          }
          localObject2 = (String)localObject2 + amtj.a(2131702461) + (String)localObject3;
          ((amqx)localObject6).a(String.valueOf(l1), (HashSet)localObject8);
          ((amqx)localObject4).a(l1);
          a(paramMsgInfo, paramLong, l2, l2, (String)localObject2);
          return null;
          i = (int)PkgTools.getLongData((byte[])localObject6, 5);
          paramMsgInfo = new byte[i];
          PkgTools.getBytesData((byte[])localObject6, 9, paramMsgInfo, i);
          ...
          try
          {
            ...
            case 2: 
              ...
              if (((amrb)localObject7).jdField_a_of_type_JavaUtilMap != null)
              {
                ((amrb)localObject7).jdField_a_of_type_JavaUtilMap.put(localObject3, new String[] { localObject2, paramMsgInfo });
                ((amrb)localObject7).jdField_a_of_type_JavaUtilSet.add(localObject2);
              }
              if (QLog.isColorLevel()) {
              ...
              ((amqx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(6)).a(String.valueOf(l1));
              if ((BaseActivity.sTopActivity instanceof SplashActivity)) {}
              ((amoo)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(22)).notifyUI(41, true, new Object[] { Integer.valueOf(2131695623), localObject3, localObject2, Boolean.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin().equals(paramMsgInfo)) });
            }
          }
  ...
  private MessageRecord a(MsgInfo paramMsgInfo, SvcReqPushMsg paramSvcReqPushMsg)
  {
    ...
    if ((paramMsgInfo != null) && (!amwh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMsgInfo, true))) {
      return paramMsgInfo;
    }
    return null;
  }
  ...
  {
    MessageRecord localMessageRecord = bbli.a(-1004);
    ...
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.DiscMsgPc", 2, "----------handleC2COnlinePushMsgResp after analysis friendUin: " + paramLong2 + " msgType: " + -1004 + " friendType: " + 3000 + " shMsgSeq: " + paramMsgInfo.shMsgSeq + " msgContent: " + bftf.a(paramString));
    }
  ...
  private void a(Pair<Long, String> paramPair1, MsgInfo paramMsgInfo, long paramLong1, long paramLong2, long paramLong3, byte paramByte, long paramLong4, Pair<Long, String> paramPair2)
  {
    ...
    for (;;)
    {
      ...
      if (paramLong4 == 0L) {
        paramPair1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691676, new Object[] { paramPair1 });
      }
      for (;;)
      {
        ...
        return;
        if (paramLong4 == 1L) {
          paramPair1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691677, new Object[] { paramPair1, paramPair2 });
        } else if (paramLong4 == 2L) {
          paramPair1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131692032, new Object[] { paramPair1 });
        } else {
          paramPair1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691672, new Object[] { paramPair1 });
        }
      }
    }
  }
  ...
  private void a(Pair<Long, String> paramPair, MsgInfo paramMsgInfo, ArrayList<Pair<String, String>> paramArrayList, long paramLong1, String paramString, byte paramByte, long paramLong2, boolean paramBoolean)
  {
    ...
    if (m > 50)
    {
      ...
      paramPair = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691681);
    ...
    Object localObject = bbli.a(i);
    paramPair = "";
    if (paramByte == 11) {
      paramPair = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691679);
    }
    if (paramByte == 22)
    {
      if (paramLong2 == 0L) {
      ...
      for (;;)
      {
        ...
        return;
        if (paramLong2 == 1L) {
          paramPair = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691680);
        } else if (paramLong2 == 2L) {
          paramPair = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131692033, new Object[] { localStringBuffer.toString() });
        }
      }
    }
    if (l == paramLong1)
    {
      ...
      paramPair = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691660);
    }
    for (;;)
    {
      paramPair = paramPair + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691672, new Object[] { localStringBuffer.toString() });
      break;
      j = 0;
      break label644;
      label721:
      ...
      if (TextUtils.isEmpty(str))
      {
        ...
        paramPair = ContactUtils.getDiscussionMemberShowName(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, String.valueOf(l));
      }
      if (ContactUtils.isDiscussionMeeting(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString)) {
        paramPair = ContactUtils.getDiscussionMemberShowName(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, String.valueOf(l));
      }
      paramPair = paramPair + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691659);
      continue;
      label841:
      paramPair = "";
    }
  ...
  private void a(ToServiceMsg paramToServiceMsg, ArrayList<msg_comm.Msg> paramArrayList, msg_svc.PbGetDiscussMsgResp paramPbGetDiscussMsgResp)
  {
    ...
    long l1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().h(str);
    ...
    if ((paramPbGetDiscussMsgResp.result.get() == 104) && (((ArrayList)localObject).size() == 0))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().c(str, l1);
    }
    for (int i = 1;; i = 0)
    {
      int j;
      ...
      {
        paramToServiceMsg = (amqx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(6);
        ...
        if (j >= 0)
        {
          ...
          {
            paramPbGetDiscussMsgResp = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getSendingTroopMsgItem(paramArrayList.frienduin, 3000, paramArrayList);
            if (paramPbGetDiscussMsgResp != null)
            {
              ...
              if (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().d()) {
                this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().a(paramPbGetDiscussMsgResp.frienduin, paramPbGetDiscussMsgResp.istroop, paramPbGetDiscussMsgResp.uniseq);
              }
              ...
              this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().h(str, paramArrayList.shmsgseq);
            }
          }
          for (;;)
          {
        ...
        while (j < k)
        {
          ...
          if ((paramArrayList instanceof MessageForMarketFace)) {
            avsp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForMarketFace)paramArrayList);
          }
          j += 1;
        }
        j = 0;
        l1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().h(str);
        if (paramToServiceMsg.size() > 0)
        {
          ...
          paramArrayList = (abvw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getBaseMessageManager(3000);
          ...
          paramPbGetDiscussMsgResp = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().a(str);
          ...
          j = abwz.a(paramToServiceMsg, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          paramPbGetDiscussMsgResp = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade();
          localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
          if ((bool2) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackgroundStop))
          {
            bool1 = true;
            paramPbGetDiscussMsgResp.addMessage(paramToServiceMsg, (String)localObject, bool1, false);
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().h(str, l1);
        if ((this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a(bool1)) && (!abwz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str, 3000)))
        {
          bool1 = true;
          ...
          ((bgga)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(235)).a.a(paramToServiceMsg);
        }
        for (;;)
        {
          if ((i != 0) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().b(str) == 1))
          {
            ...
            if (paramToServiceMsg != null)
            {
              ...
              ((abvw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getBaseMessageManager(3000)).b(str, 3000, l1);
            }
          }
          return;
          bool1 = false;
  ...
  private void a(ToServiceMsg paramToServiceMsg, ArrayList<msg_comm.Msg> paramArrayList, msg_svc.PbGetDiscussMsgResp paramPbGetDiscussMsgResp, String paramString)
  {
    ...
    for (paramArrayList = ((msg_comm.DiscussInfo)localObject3).discuss_remark.get().toByteArray();; paramArrayList = null)
    {
      for (;;)
      {
        ...
        bbll localbbll = new bbll();
        localbbll.jdField_e_of_type_Long = l5;
        localbbll.jdField_e_of_type_Int = 3000;
        localbbll.f = m;
        ...
        try
        {
          a((msg_comm.Msg)localObject2, localArrayList3, localbbll, true, localbdyi);
          ...
          amwh.a((List)localObject3);
          localArrayList1.addAll((Collection)localObject3);
          amwh.a("Q.msg.DiscMsgPc", paramString, l3, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), String.valueOf(l5));
          if ((paramArrayList == null) || (paramArrayList.length <= 0)) {
            break;
          }
          localObject3 = String.valueOf(l1);
          localObject2 = HexUtil.bytes2HexStr(paramArrayList) + ":" + (String)localObject3;
          if (((HashSet)localObject1).contains(localObject2)) {
            break;
          }
          paramArrayList = ((amrb)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).a(paramArrayList, String.valueOf(l5), (String)localObject3, false);
          if (paramArrayList == null) {
            break;
          }
      ...
      if (localArrayList2.size() > 0) {
        ((amrb)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).b(localArrayList2);
      }
      paramArrayList = (amqx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(6);
      ...
      ((avtd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(37)).a(paramArrayList + "&" + 3000, localbdyi);
      paramArrayList = new ArrayList();
      if (paramToServiceMsg != null)
      {
      ...
      ((bgga)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(235)).a.a(localArrayList1);
      return;
    }
  }
  ...
  {
    MessageRecord localMessageRecord = bbli.a(-1016);
    long l = bbko.a();
    if ((paramArrayList != null) && (paramArrayList.size() > 1))
    {
      ...
      paramArrayList = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131691188, new Object[] { localStringBuilder });
      localMessageRecord.init(paramString2, paramString1, paramString3, paramArrayList + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131693979), l, -1016, 3000, l);
  ...
  private void a(ArrayList<msg_comm.Msg> paramArrayList, ArrayList<MessageRecord> paramArrayList1)
  {
    ...
    for (paramArrayList = ((msg_comm.DiscussInfo)localObject2).discuss_remark.get().toByteArray();; paramArrayList = null)
    {
      ...
      ArrayList localArrayList2 = new ArrayList();
      bbll localbbll = new bbll();
      localbbll.jdField_e_of_type_Long = l1;
      localbbll.jdField_e_of_type_Int = 3000;
      localbbll.f = m;
      ...
      for (;;)
      {
        try
        {
          a(localMsg, localArrayList2, localbbll, true, (bdyi)localObject1);
          if (!QLog.isColorLevel()) {
            break label1003;
          }
        ...
        catch (Exception localException)
        {
          ...
          continue;
          amwh.a((List)localObject2);
          paramArrayList1.addAll((Collection)localObject2);
          if ((paramArrayList != null) && (paramArrayList.length > 0))
          {
            localObject1 = String.valueOf(l4);
            String str = HexUtil.bytes2HexStr(paramArrayList) + ":" + (String)localObject1;
            if (!localHashSet.contains(str))
            {
              paramArrayList = ((amrb)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).a(paramArrayList, String.valueOf(l1), (String)localObject1, false);
              if (paramArrayList != null)
              {
        ...
        if (localArrayList1.size() > 0) {
          ((amrb)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).b(localArrayList1);
        }
        if (!QLog.isColorLevel()) {
          break;
        }
  ...
  private void a(msg_comm.Msg paramMsg, FromServiceMsg paramFromServiceMsg, msg_onlinepush.PbPushMsg paramPbPushMsg, boolean paramBoolean)
  {
    ...
    for (localObject1 = ((msg_comm.DiscussInfo)localObject2).discuss_remark.get().toByteArray();; localObject1 = null)
    {
      ...
      for (;;)
      {
        ...
        if (!MessageHandler.b)
        {
          if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().b(String.valueOf(l2)) != 2)
          {
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().d(String.valueOf(l2), new Object[] { paramMsg, paramFromServiceMsg, paramPbPushMsg });
            if (QLog.isColorLevel()) {
        ...
        if (QLog.isColorLevel())
        {
          ...
          paramFromServiceMsg.append(" fromUin:").append(l1).append(" toUin").append(l4).append(" msgTime:").append(m).append(" msgSeq:").append(l5).append(" msgUid:").append(l6).append(" userActive:").append(n).append(" fromInstid:").append(i1).append(" disUin:").append(l2).append(" disType:").append(i2).append(" disSeq:").append(l7).append(" remarkSender:").append(HexUtil.bytes2HexStr((byte[])localObject1)).append(" divSeq:").append(k).append(" pkgIndex:").append(j).append(" pkgNum:").append(i).append(" hasShare:").append(paramMsg.appshare_info.has());
          QLog.d("Q.msg.DiscMsgPc", 2, paramFromServiceMsg.toString());
        }
        ((amqx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(6)).a(l2, l1);
        ((amsw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).a(l1);
        paramFromServiceMsg = (amrb)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53);
        localObject2 = new bbll();
        ((bbll)localObject2).jdField_e_of_type_Long = l2;
        ((bbll)localObject2).jdField_e_of_type_Int = 3000;
        ((bbll)localObject2).f = i2;
        ...
        if ((paramMsg != null) && (paramMsg.size() > 0))
        {
          ...
          if (i < j)
          {
            ...
            {
              localObject6 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getSendingTroopMsgItem(((MessageRecord)localObject5).frienduin, 3000, (MessageRecord)localObject5);
              if (localObject6 != null)
              {
                ...
                blbw.a().a(((MessageRecord)localObject6).getExtInfoFromExtStr("report_key_bytes_oac_msg_extend"));
                a((MessageRecord)localObject6);
                this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().h(((MessageRecord)localObject5).frienduin, ((MessageRecord)localObject5).shmsgseq);
                afoa.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((MessageRecord)localObject6).uniseq);
              }
            }
            for (;;)
            {
              ...
              this.jdField_a_of_type_ComTencentImcoreMessageQQMessageFacade.setReadFrom(((MessageRecord)localObject5).frienduin, 3000, ((MessageRecord)localObject5).shmsgseq);
              if ((localObject5 instanceof MessageForMarketFace)) {
                avsp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForMarketFace)localObject5);
              }
              ((ArrayList)localObject2).add(localObject5);
              if ((i == 0) && (localObject1 != null) && (localObject1.length > 0))
              {
                String str = ((MessageRecord)localObject5).senderuin;
                localObject6 = HexUtil.bytes2HexStr((byte[])localObject1) + ":" + str;
        ...
        if (paramFromServiceMsg.size() > 0)
        {
          ...
          boolean bool2 = amwh.a(paramFromServiceMsg);
          i = abwz.a(paramFromServiceMsg, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade();
          if ((bool2) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackgroundStop))
          {
            bool1 = true;
            ((QQMessageFacade)localObject1).addMessage(paramFromServiceMsg, String.valueOf(l3), bool1);
          ...
          for (;;)
          {
            ...
            if (((MessageRecord)localObject3).istroop == 3000)
            {
              ...
              ((Map)localObject1).put(((MessageRecord)localObject3).frienduin, Long.valueOf(Math.max(((MessageRecord)localObject3).shmsgseq, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().h(((MessageRecord)localObject3).frienduin))));
            }
          }
          ...
          while (((Iterator)localObject2).hasNext())
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().h((String)localObject3, ((Long)((Map)localObject1).get(localObject3)).longValue());
          }
          if ((!this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a(bool2)) || (abwz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, Long.toString(l2), 3000))) {
            break label1838;
          }
        }
        for (boolean bool1 = true;; bool1 = false)
        {
          ...
          ((bgga)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(235)).a.a(paramMsg);
          return;
        }
        i = 0;
        j = 0;
  ...
  private boolean a(long paramLong1, long paramLong2, short paramShort)
  {
    ...
    //   9: lload_1
    //   10: invokevirtual 87	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   13: ldc_w 1628
    //   16: invokevirtual 79	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   19: lload_3
    //   20: invokevirtual 87	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   23: ldc_w 1628
    //   26: invokevirtual 79	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   29: iload 5
    //   31: invokevirtual 82	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   34: invokevirtual 91	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   37: astore 7
    //   39: aload_0
    //   40: getfield 24	anld:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   43: invokevirtual 1035	com/tencent/mobileqq/app/QQAppInterface:getMsgCache	()Lbbko;
    //   46: invokevirtual 1630	bbko:a	()Ljava/util/ArrayList;
    //   49: aload 7
    //   51: invokevirtual 1631	java/util/ArrayList:contains	(Ljava/lang/Object;)Z
    //   54: ifeq +45 -> 99
    //   57: invokestatic 68	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   60: ifeq +31 -> 91
    //   63: ldc_w 602
    //   66: iconst_2
    //   67: new 72	java/lang/StringBuilder
    //   70: dup
    //   71: invokespecial 73	java/lang/StringBuilder:<init>	()V
    //   74: ldc_w 1633
    ...
    //   88: invokestatic 1635	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   91: iconst_1
    //   92: istore 6
    //   94: aload_0
    //   95: monitorexit
    ...
    //   98: ireturn
    //   99: aload_0
    //   100: getfield 24	anld:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   103: invokevirtual 1035	com/tencent/mobileqq/app/QQAppInterface:getMsgCache	()Lbbko;
    //   106: aload 7
    //   108: invokevirtual 1636	bbko:a	(Ljava/lang/String;)V
    //   111: iconst_0
    //   112: istore 6
    //   114: goto -20 -> 94
    //   117: astore 7
  ...
  public static void b(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, int paramInt, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      if (paramInt == 11)
      {
        ...
        ((alnn)paramQQAppInterface.getManager(211)).a(0, 3000, Long.toString(l), paramArrayOfByte);
        return;
      }
      if (paramInt == 12)
      {
        ...
        ((alom)paramQQAppInterface.getManager(227)).a(3000, paramArrayOfByte);
        return;
      }
    }
    catch (Exception paramQQAppInterface)
    ...
    if (paramInt == 13)
    {
      ...
      if (paramArrayOfByte.opt_msg_goldtips.has())
      {
        ...
        if ((paramQQAppInterface.type.has()) && (paramQQAppInterface.type.get() == 3)) {
          akat.a(3000, null, (oidb_0x858.GoldMsgTipsElem)paramArrayOfByte.opt_msg_goldtips.get());
        }
      }
    }
  }
      ...
      if ((paramInt == 9) && (paramArrayOfByte.opt_msg_obj_update.has()))
      {
        ...
        if (paramMessageRecord.bytes_ext_msg.has())
        {
          ...
          try
          {
            ...
            ((aubl)paramQQAppInterface.getManager(156)).a(paramArrayOfByte, false);
            return;
          }
  ...
  public abxj a(int paramInt, MsgInfo paramMsgInfo, SvcReqPushMsg paramSvcReqPushMsg)
  {
    ...
    for (;;)
    {
      ...
      if ((paramMsgInfo != null) && (paramSvcReqPushMsg != null)) {
        return new abxj(a(paramMsgInfo, paramSvcReqPushMsg), false);
      }
  ...
  public List<MessageRecord> a(msg_comm.Msg paramMsg, bbll parambbll)
  {
    ...
    try
    {
      a(paramMsg, localArrayList1, parambbll, true, localbdyi);
      long l = paramMsg.msg_head.discuss_info.discuss_uin.get();
      ((avtd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(37)).a(String.valueOf(l) + "&" + 3000, localbdyi);
