...
public final class biyx
{
  ...
  public static void a(Bitmap paramBitmap, bizb parambizb)
  {
    a(paramBitmap, parambizb, false);
  }
  
  public static void a(Bitmap paramBitmap, bizb parambizb, boolean paramBoolean)
  {
    if (parambizb == null) {
      return;
    }
    ...
    a(new FaceChangeUtils.5(paramBitmap, parambizb), paramBoolean, "GLThread-cropFace");
  }
  
  public static void a(Bitmap paramBitmap, List<String> paramList, biyy parambiyy)
  {
    if ((paramBitmap == null) || (paramList == null) || (paramList.isEmpty()))
    {
      ...
      parambiyy.a(new ArrayList());
      return;
    }
    a(new FaceChangeUtils.2(paramList, paramBitmap, parambiyy), false, "GLThread-changeFaceBatch");
  }
  ...
  private static biyz b(Bitmap paramBitmap, String paramString)
  {
    if ((paramBitmap == null) || (paramString == null))
    {
      bjah.d("FaceChangeUtils", "changeFaceInternal---null parameters: userFace, materialDir");
      return biyz.a(-1, "null parameters, material=" + paramString);
    }
    ...
    {
      bjah.d("FaceChangeUtils", "changeFaceInternal---failed to parse CrazyFace: " + paramString);
      return biyz.a(-2, "failed to parse material, material=" + paramString);
    }
    ...
    {
      bjah.d("FaceChangeUtils", "changeFaceInternal---failed to detect face");
      return biyz.a(-3, "failed to detect face");
    }
    Object localObject3 = a(((PTFaceAttr)localObject1).getAllFacePoints(), ((PTFaceAttr)localObject1).getFaceDetectScale());
    if (((List)localObject3).isEmpty())
    {
      bjah.d("FaceChangeUtils", "changeFaceInternal---userFacePointsList is empty");
      return biyz.a(-4, "no face points");
    }
    ...
    bjah.b("FaceChangeUtils", "success : + result");
    return biyz.a(paramString);
  }
  
  private static void c(Bitmap paramBitmap, bizb parambizb)
  {
    ...
    parambizb.a((Bitmap)localObject2);
  }
}
