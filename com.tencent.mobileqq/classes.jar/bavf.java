...
import java.util.HashMap<Ljava.lang.String;Lbave;>;
...
public class bavf
  extends QIPCModule
{
  public static volatile bavf a;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new bavi(this);
  private String jdField_a_of_type_JavaLangString;
  private HashMap<String, HashMap<String, bave>> jdField_a_of_type_JavaUtilHashMap;
  ...
  private bavf()
  {
    ...
    return;
    label105:
    QIPCClientHelper.getInstance().getClient().connect(new bavg(this));
    QIPCClientHelper.getInstance().getClient().addListener(new bavh(this));
  ...
  {
    if (jdField_a_of_type_Bavf == null) {}
    try
    {
      if (jdField_a_of_type_Bavf == null) {
        jdField_a_of_type_Bavf = new bavf();
      }
      return jdField_a_of_type_Bavf;
    }
    finally {}
  }
  ...
  private String a()
  {
    ...
    String str2 = String.valueOf(bdee.a(localContext));
    String str1 = str2;
    if (!bdje.a(str2))
    {
      str1 = str2;
      if (str2.equals(String.valueOf(1))) {
        str1 = awtj.a(localContext);
      }
    }
    return str1;
  }
  ...
  public static String a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      localObject1 = basj.a(paramString1, (String)localObject1);
      return localObject1;
      label68:
  ...
  public static String a(HashMap<String, HashMap<String, bave>> paramHashMap)
  {
    ...
    try
    {
      ...
      while (paramHashMap.hasNext())
      {
        ...
        localJSONObject.put("domain_map", bave.a((HashMap)localObject));
  ...
  private ArrayList<bavj> a(ArrayList<bavj> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          if (((bavj)((Iterator)localObject).next()).b <= 0) {
            continue;
          }
  ...
  public static HashMap<String, HashMap<String, bave>> a(String paramString)
  {
    if (paramString == null) {}
    do
    {
      ...
      try
      {
        ...
        while (i < paramString.length())
        {
          ...
          localObject = bave.a(((JSONObject)localObject).getString("domain_map"));
          if (localObject != null) {
  ...
  private static HashMap<String, bave> a(List<DomainIp.iplistInfo> paramList, HashMap<String, bave> paramHashMap)
  {
    if (paramList == null) {}
    Object localObject1;
    String str;
    ...
    do
    {
      ...
      for (;;)
      {
        paramHashMap = (HashMap<String, bave>)localObject1;
    ...
    {
      paramList = (bave)((HashMap)localObject1).get(str);
      if (paramList.a != null) {
        break label392;
      }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (paramHashMap.hasNext())
        {
          ...
          bavj localbavj = new bavj();
          localbavj.jdField_a_of_type_JavaLangString = ((DomainIp.ServerList)localObject2).string_IP.get();
          localbavj.jdField_a_of_type_Int = ((DomainIp.ServerList)localObject2).uint32_Port.get();
          localbavj.c = i;
          paramList.a.add(localbavj);
          if (QLog.isColorLevel())
          {
            QLog.d("InnerDns", 2, "onDomainServerListUpdate type=" + i + " d:" + str + " " + localbavj.jdField_a_of_type_JavaLangString + " " + localbavj.jdField_a_of_type_Int);
            continue;
            paramList = new bave(str, new ArrayList());
            break;
          }
        }
      }
  ...
  public ArrayList<String> a(String paramString, int paramInt1, boolean paramBoolean, int paramInt2)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localObject = a(((bave)((HashMap)localObject).get(paramString)).a);
        if ((localObject != null) && (((ArrayList)localObject).size() > 0))
        {
          if (((bavj)((ArrayList)localObject).get(0)).b <= 0) {
            break label716;
          }
          i = 1;
          continue;
          ...
          azmz.a(BaseApplication.getContext()).a(null, "actDnsReq", paramBoolean, BaseApplicationImpl.sProcessId, 0L, (HashMap)localObject, "");
      ...
      do
      {
        ...
        localbavj = (bavj)localIterator.next();
      } while (localbavj.c != paramInt2);
      String str = localbavj.jdField_a_of_type_JavaLangString;
      if ((localbavj.c == 1) && (localbavj.jdField_a_of_type_Int != 80)) {
        localObject = str + ":" + localbavj.jdField_a_of_type_Int;
      }
      for (;;)
      {
  ...
  public void a()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 44	bavf:jdField_a_of_type_Boolean	Z
    //   4: ifeq +43 -> 47
    //   7: ldc 2
    //   9: monitorenter
    ...
    //   24: ldc 56
    //   26: aload_0
    //   27: getfield 72	bavf:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   30: invokestatic 418	bavf:a	(Ljava/util/HashMap;)Ljava/lang/String;
    ...
    //   50: aload_0
    //   51: getfield 36	bavf:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
  ...
  public void a(String paramString1, String paramString2, int paramInt)
  {
    ...
    int i;
    boolean bool1;
    if ((bdje.a(paramString1)) || (bdje.a(paramString2)) || (paramString1.equals(paramString2)))
    {
      i = 40;
      bool1 = false;
    }
    ...
    for (;;)
    {
      ...
      ((HashMap)localObject).put("param_FailCode", String.valueOf(i));
      azmz.a(BaseApplication.getContext()).a(null, "actDnsBadIp", bool1, BaseApplicationImpl.sProcessId, 0L, (HashMap)localObject, "");
      return;
      localObject = a();
      if ((this.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_JavaUtilHashMap.containsKey(localObject)))
      {
        try
        {
          ...
          {
            localObject = (bave)((HashMap)localObject).get(paramString1);
            if (((bave)localObject).a != null)
            {
              localObject = ((bave)localObject).a.iterator();
              while (((Iterator)localObject).hasNext())
              {
                bavj localbavj = (bavj)((Iterator)localObject).next();
                if (paramString2.equals(localbavj.jdField_a_of_type_JavaLangString)) {
                  localbavj.b += 1;
                }
              }
            }
  ...
  public void b()
  {
    if ((BaseApplicationImpl.sProcessId == 1) && (!this.c))
    {
      ...
      localQQAppInterface.startServlet(new NewIntent(localQQAppInterface.getApp(), ayxd.class));
      this.c = true;
    }
  }
