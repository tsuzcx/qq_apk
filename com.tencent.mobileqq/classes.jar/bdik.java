...
public class bdik
{
  ...
  static
  {
    jdField_a_of_type_JavaUtilComparator = new bdim();
    jdField_b_of_type_JavaUtilComparator = new bdil();
  ...
  {
    return bbea.a(a(paramString));
  }
  
  public static String a(byte[] paramArrayOfByte)
  {
    return bbea.a(a(paramArrayOfByte));
  }
  ...
  public static String b(String paramString)
  {
    try
    {
      paramString = bbea.a(a(paramString.getBytes("UTF-8")));
      return paramString;
    }
  ...
  public static String d(String paramString)
  {
    ...
    paramString = new bdik().b(paramString);
