  ...
  implements aiqy
{
  ...
  aiqx(aiqw paramaiqw, int paramInt1, double paramDouble, String paramString, int paramInt2, int paramInt3, int paramInt4)
  {
  ...
  {
    Object localObject = this.jdField_a_of_type_Aiqw.jdField_a_of_type_Aiqz.a(this.jdField_a_of_type_Aiqw, this.d);
    float f;
    if (localObject != null)
    {
      Rect localRect1 = this.jdField_a_of_type_Aiqw.getBounds();
      int i = localRect1.width();
      int j = localRect1.height();
      i = (int)(i / 2 + Math.sin(this.jdField_a_of_type_Double) * this.jdField_a_of_type_Aiqw.d);
      j = (int)(j / 2 - Math.cos(this.jdField_a_of_type_Double) * this.jdField_a_of_type_Aiqw.d);
      int k = (int)(((Bitmap)localObject).getWidth() * this.jdField_a_of_type_Aiqw.jdField_a_of_type_Double);
      int m = (int)(((Bitmap)localObject).getHeight() * this.jdField_a_of_type_Aiqw.jdField_a_of_type_Double);
      this.jdField_a_of_type_AndroidGraphicsRect.set(i - k / 2, j - m / 2 + this.jdField_a_of_type_Aiqw.c / 2, k / 2 + i, m / 2 + j + this.jdField_a_of_type_Aiqw.c / 2);
      Rect localRect2;
      ...
      if (QLog.isColorLevel()) {
        QLog.d("DiyPendantDrawable", 2, "draw sticker index = " + this.d + "scaleFactor=" + this.jdField_a_of_type_Aiqw.jdField_a_of_type_Double + ", x=" + i + ", y=" + j + ", w=" + k + ", h=" + m);
      }
      if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
      {
        i = (int)(10.0D * this.jdField_a_of_type_Aiqw.jdField_a_of_type_Double);
        ...
        f = bbby.a(this.jdField_a_of_type_Aiqw.b, this.jdField_b_of_type_AndroidGraphicsRect, this.jdField_a_of_type_JavaLangString);
        ...
        j = (int)Math.min(f + 10.0D * this.jdField_a_of_type_Aiqw.jdField_a_of_type_Double, this.jdField_b_of_type_AndroidGraphicsRect.height());
        localObject = this.jdField_a_of_type_Aiqw.jdField_a_of_type_Aiqz.a(this.jdField_a_of_type_Aiqw, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, f, this.c, i, j, paramPaint);
        if (localObject != null)
        {
    ...
    do
    {
      ...
      bool = false;
      break;
      paramPaint = this.jdField_a_of_type_Aiqw.jdField_a_of_type_Aiqz.a(this.jdField_a_of_type_Aiqw, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      if (paramPaint != null) {
        this.jdField_a_of_type_Aiqw.b.setTypeface(paramPaint);
      }
      this.jdField_a_of_type_Aiqw.b.setColor(this.c);
      this.jdField_a_of_type_Aiqw.b.setTextAlign(Paint.Align.CENTER);
      this.jdField_a_of_type_Aiqw.b.setTextSize(f);
      localObject = this.jdField_a_of_type_Aiqw.b.getFontMetrics();
      ...
      paramCanvas.drawText(this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_AndroidGraphicsRect.centerX(), f, this.jdField_a_of_type_Aiqw.b);
