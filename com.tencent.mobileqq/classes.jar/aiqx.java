  ...
  extends BaseChatPie
{
  private boolean S;
  private boolean T;
  private anyu jdField_a_of_type_Anyu = new airc(this);
  Comparator<MessageRecord> jdField_a_of_type_JavaUtilComparator = new aira(this);
  private Long[] jdField_a_of_type_ArrayOfJavaLangLong;
  private aggs jdField_b_of_type_Aggs;
  Comparator<MessageRecord> jdField_b_of_type_JavaUtilComparator = new airb(this);
  private List<ChatMessage> jdField_b_of_type_JavaUtilList;
  private RelativeLayout f;
  private TextView l;
  private View n;
  
  public aiqx(QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, FragmentActivity paramFragmentActivity, Context paramContext)
  {
  ...
  private void a(View paramView, int paramInt, blir paramblir)
  {
    ...
    if (str.equals(paramView.getResources().getString(2131689962)))
    {
      bo();
      bdll.b(null, "dc00898", "", "", "0X800AE92", "0X800AE92", 0, 0, "", "", "", "");
    }
    for (;;)
    {
      paramblir.dismiss();
      ...
      {
        bp();
        bdll.b(null, "dc00898", "", "", "0X800AE93", "0X800AE93", 0, 0, "", "", "", "");
      }
    }
  }
  ...
  private void bo()
  {
    ((aiwv)this.jdField_a_of_type_Aguw.a(59)).a(this.jdField_b_of_type_JavaUtilList);
  }
  ...
  private void bp()
  {
    if ((this.jdField_b_of_type_JavaUtilList != null) && (this.jdField_b_of_type_JavaUtilList.size() > 0))
    {
      ...
      ((aixd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(365)).a(a(), localChatMessage, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.d);
    }
  }
  ...
  private void bq()
  {
    if ((this.jdField_a_of_type_ArrayOfJavaLangLong != null) && (this.jdField_a_of_type_ArrayOfJavaLangLong.length > 0))
    {
      ...
      if (i < j)
      {
        ...
        if (((localMessageRecord instanceof ChatMessage)) && (aixg.a(localMessageRecord))) {
  ...
  private void br()
  {
    ...
    label240:
    for (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.d = bhlg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_b_of_type_JavaLangString, bhlg.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int), 3);; this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.d = localIntent.getStringExtra("uinname"))
    {
  ...
  private void d(View paramView)
  {
    ...
    paramView.b(2131689962);
    paramView.b(2131689963);
    paramView.c(2131690580);
    paramView.a(new aiqz(this, paramView));
    paramView.show();
  }
  ...
  public boolean a(boolean paramBoolean)
  {
    ...
    Object localObject2 = this.jdField_c_of_type_AndroidViewViewGroup.findViewById(2131362541);
    if (localObject2 != null) {
      ((ViewGroup)localObject1).removeView((View)localObject2);
    }
    this.jdField_f_of_type_AndroidWidgetRelativeLayout = new UpComingRelativeLayout(a());
    this.jdField_f_of_type_AndroidWidgetRelativeLayout.setId(2131362541);
    ...
    this.jdField_l_of_type_AndroidWidgetTextView.setText(a().getResources().getString(2131689964));
    ...
    this.e = ((TextView)this.jdField_c_of_type_AndroidViewViewGroup.findViewById(2131378936));
    ...
    this.jdField_b_of_type_Aggs = new aggs(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqActivityAioAnimAIOAnimationConatiner, this);
    this.jdField_b_of_type_Aggs.a = Boolean.valueOf(false);
    if (this.m == null)
    {
    ...
    this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.setAdapter(this.jdField_b_of_type_Aggs);
    ...
    if (aggu.a(BaseApplicationImpl.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, true, 7, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Aggu)) {
      this.jdField_f_of_type_AndroidWidgetRelativeLayout.setBackgroundDrawable(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Aggu.a);
    }
    ...
    this.e.setText(a().getResources().getString(2131689961));
    if (!this.H)
    {
      ...
      ((ImageView)localObject1).setOnClickListener(new aiqy(this));
      ap();
      return true;
    }
    ...
    for (;;)
    {
      ...
      if ((paramMessage.obj instanceof List))
      {
        ...
        if (this.jdField_b_of_type_JavaUtilList.size() <= 0)
        {
          ...
          bdll.b(null, "dc00898", "", "", "0X800AE95", "0X800AE95", 1, 0, "", "", "", "");
        }
        for (;;)
        {
          if (!QLog.isColorLevel()) {
          ...
          if (this.S)
          {
            QQToast.a(a(), 0, 2131689965, 3000).a();
            bdll.b(null, "dc00898", "", "", "0X800AE95", "0X800AE95", 2, 0, "", "", "", "");
          }
          this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
          this.jdField_b_of_type_Aggs.a(localList, null);
        }
      }
    }
  }
  ...
  {
    ambz localambz = (ambz)a(4);
    return (localambz != null) && (localambz.a());
  }
  
  public void o(int paramInt)
  {
    bdll.b(null, "dc00898", "", "", "0X800AE91", "0X800AE91", 0, 0, "", "", "", "");
  }
