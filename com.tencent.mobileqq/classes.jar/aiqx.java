...
public class aiqx
{
  ...
  private static ArrayList<aiqy> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public static int a()
  {
    ...
    {
      aiqy localaiqy = (aiqy)jdField_a_of_type_JavaUtilArrayList.get(i);
      k = j;
      if (localaiqy != null)
      {
        k = j;
        if (localaiqy.jdField_c_of_type_Int == 0) {
          k = j + 1;
        }
      }
      i += 1;
  ...
  private static aiqy a()
  {
    ...
    for (;;)
    {
      ...
      if (localaiqy != null)
      {
        localObject = localaiqy;
        if (localaiqy.jdField_c_of_type_Int == 1) {
          break;
        }
      }
      i += 1;
  ...
  public static aiqy a(boolean paramBoolean)
  {
    Object localObject;
    if (jdField_a_of_type_JavaUtilArrayList == null)
    {
    ...
    if (paramBoolean)
    {
      ...
      for (;;)
      {
        ...
        localaiqy = (aiqy)jdField_a_of_type_JavaUtilArrayList.get(i);
        if (localaiqy != null)
        {
          localObject = localaiqy;
          if (localaiqy.jdField_c_of_type_Int == 0) {
  ...
  public static void a()
  {
    ...
    for (;;)
    {
      ...
      {
        aiqy localaiqy = (aiqy)jdField_a_of_type_JavaUtilArrayList.get(i);
        if ((localaiqy == null) || (localaiqy.jdField_c_of_type_Int == 1)) {
  ...
  private static void a(QQAppInterface paramQQAppInterface, aiqy paramaiqy)
  {
    if ((paramQQAppInterface == null) || (jdField_a_of_type_JavaUtilArrayList == null) || (paramaiqy == null) || (paramaiqy.jdField_b_of_type_Int < 1) || (paramaiqy.jdField_b_of_type_Int > 7) || (TextUtils.isEmpty(paramaiqy.jdField_a_of_type_JavaLangString)))
    {
      if (QLog.isColorLevel()) {
        QLog.d("Q.qwallet.push", 2, "params error, pcPayDatas=" + jdField_a_of_type_JavaUtilArrayList + ",app=" + paramQQAppInterface + ",pcPayData=" + paramaiqy);
      }
      return;
    }
    if (paramaiqy.jdField_b_of_type_Int == 1) {
    ...
    for (;;)
    {
      ...
      {
        jdField_a_of_type_JavaUtilArrayList.add(paramaiqy);
        if (b(paramQQAppInterface))
        {
          ...
          b(paramQQAppInterface, paramaiqy);
          return;
        }
      }
      if (jdField_a_of_type_Long != 0L) {
      ...
      c(paramQQAppInterface, paramaiqy);
    }
  }
  ...
  private static void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (k == 1)
      {
        ...
        if ((k == 1) && (m == 2))
        {
          bdcs.d(paramQQAppInterface.getApp().getFilesDir() + "/" + QWalletHelper.getRecommendFileName(paramQQAppInterface.getCurrentAccountUin()));
          bdcs.d(paramQQAppInterface.getApp().getFilesDir() + "/" + QWalletHelper.getRecommendFileName(paramQQAppInterface.getCurrentAccountUin()) + "_");
          i = 1;
          continue;
        }
        if ((k == 2) && (m == 1))
        ...
        if ((k == 2) && (m == 2))
        {
          bdcs.d(paramQQAppInterface.getApp().getFilesDir() + "/" + QWalletHelper.getPersonalInfoFileName(paramQQAppInterface.getCurrentAccountUin()));
          i = 1;
          continue;
        }
        if ((k != 8) || (m != 1)) {
        ...
        ((aitd)paramQQAppInterface.getManager(245)).b(0);
        break label462;
      }
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          aivh.a(0, paramQQAppInterface, null);
          return;
        }
        catch (Exception paramQQAppInterface) {}
      }
  ...
  private static void b(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      return;
      boolean bool2 = bdhy.a(paramQQAppInterface.getApp());
      if (QLog.isColorLevel()) {
      ...
      if (!bool2)
      {
        ...
        if (localaiqy == null)
        {
          ...
          localaiqy = (aiqy)jdField_a_of_type_JavaUtilArrayList.get(0);
          if (localaiqy == null)
          {
          ...
          i = a(localaiqy.jdField_b_of_type_Int);
          if (i == 0)
          {
            jdField_a_of_type_JavaUtilArrayList.remove(0);
            b(paramQQAppInterface);
        ...
        for (;;)
        {
          ...
          {
            localaiqy.jdField_c_of_type_Int = 2;
          }
          if (!QLog.isColorLevel()) {
            break;
          }
          ...
          if (bool1)
          {
            ...
            bool2 = bool1;
            if (43200L * 1000L + localaiqy.jdField_c_of_type_Long > l) {
              bool2 = false;
            }
          }
          if (bool2) {
  ...
  private static void b(QQAppInterface paramQQAppInterface, aiqy paramaiqy)
  {
    String str1;
    boolean bool1;
    if (bdhy.a(paramQQAppInterface.getApp()))
    {
      ((PowerManager)paramQQAppInterface.getApp().getSystemService("power")).newWakeLock(268435462, "Q.qwallet.push").acquire(10000L);
      String str2 = String.format(BaseApplication.getContext().getString(2131717773), new Object[] { Integer.valueOf(a()) });
      if (!TextUtils.isEmpty(paramaiqy.jdField_b_of_type_JavaLangString))
      {
        str1 = paramaiqy.jdField_b_of_type_JavaLangString;
        ...
        localIntent.putExtra("time", bdjj.b(BaseApplication.getContext(), paramaiqy.jdField_b_of_type_Long));
    ...
    else
    {
      ...
      bool2 = muz.d(paramQQAppInterface.getApp());
      boolean bool3 = paramQQAppInterface.c();
      boolean bool4 = paramQQAppInterface.q();
      boolean bool5 = bcys.a(paramQQAppInterface.getApp().getApplicationContext(), paramQQAppInterface);
      if (QLog.isColorLevel()) {
    ...
    for (boolean bool2 = false;; bool2 = true)
    {
      ...
      if (bool1)
      {
        ...
        bdaz.a(Uri.fromFile(paramQQAppInterface), false, true);
      }
      return;
      str1 = BaseApplication.getContext().getString(2131717772);
      break;
      bool1 = true;
      break label327;
    }
    label495:
    bdaz.a(2131230759, false);
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, long paramLong1, int paramInt1, long paramLong2, int paramInt2)
  {
    ...
    //   23: lload 5
    //   25: iload 7
    //   27: invokestatic 267	aiqx:a	(JIJI)Z
    //   30: ifeq +19 -> 49
    ...
    //   48: return
    //   49: new 655	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$MsgBody
    //   52: dup
    //   53: invokespecial 656	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$MsgBody:<init>	()V
    //   56: aload_1
    //   57: invokevirtual 657	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$MsgBody:mergeFrom	([B)Lcom/tencent/mobileqq/pb/MessageMicro;
    //   60: checkcast 655	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$MsgBody
    //   63: astore_1
    //   64: aload_1
    //   65: getfield 661	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$MsgBody:msg_online_push	Ltencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush;
    //   68: invokevirtual 664	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:has	()Z
    //   71: ifeq -52 -> 19
    //   74: aload_1
    //   75: getfield 661	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$MsgBody:msg_online_push	Ltencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush;
    //   78: invokevirtual 667	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:get	()Lcom/tencent/mobileqq/pb/MessageMicro;
    //   81: checkcast 663	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush
    //   84: astore 12
    //   86: aload 12
    //   88: ifnull -69 -> 19
    //   91: iconst_m1
    ...
    //   107: istore 8
    //   109: aload 12
    //   111: getfield 670	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:uint32_action	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   114: invokevirtual 283	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   117: ifeq +13 -> 130
    //   120: aload 12
    //   122: getfield 670	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:uint32_action	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   125: invokevirtual 285	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   128: istore 4
    //   130: aload 12
    //   132: getfield 673	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:uint32_timestamp	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   135: invokevirtual 283	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   138: ifeq +13 -> 151
    //   141: aload 12
    //   143: getfield 673	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:uint32_timestamp	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   146: invokevirtual 285	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   149: istore 7
    //   151: aload 11
    //   153: astore 10
    //   155: aload 12
    //   157: getfield 676	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:bytes_extend	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   160: invokevirtual 292	com/tencent/mobileqq/pb/PBBytesField:has	()Z
    //   163: ifeq +39 -> 202
    //   166: aload 12
    //   168: getfield 676	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:bytes_extend	Lcom/tencent/mobileqq/pb/PBBytesField;
    ...
    //   200: astore 10
    //   202: aload 12
    //   204: getfield 680	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:str_serialno	Lcom/tencent/mobileqq/pb/PBStringField;
    //   207: invokevirtual 683	com/tencent/mobileqq/pb/PBStringField:has	()Z
    //   210: ifeq +12 -> 222
    //   213: aload 12
    //   215: getfield 680	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:str_serialno	Lcom/tencent/mobileqq/pb/PBStringField;
    //   218: invokevirtual 685	com/tencent/mobileqq/pb/PBStringField:get	()Ljava/lang/String;
    //   221: astore_1
    //   222: aload 12
    //   224: getfield 688	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:str_billno	Lcom/tencent/mobileqq/pb/PBStringField;
    //   227: invokevirtual 683	com/tencent/mobileqq/pb/PBStringField:has	()Z
    //   230: ifeq +12 -> 242
    //   233: aload 12
    //   235: getfield 688	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:str_billno	Lcom/tencent/mobileqq/pb/PBStringField;
    //   238: invokevirtual 685	com/tencent/mobileqq/pb/PBStringField:get	()Ljava/lang/String;
    //   241: astore_1
    //   242: aload 12
    //   244: getfield 691	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:str_appinfo	Lcom/tencent/mobileqq/pb/PBStringField;
    //   247: invokevirtual 683	com/tencent/mobileqq/pb/PBStringField:has	()Z
    //   250: ifeq +12 -> 262
    //   253: aload 12
    //   255: getfield 691	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:str_appinfo	Lcom/tencent/mobileqq/pb/PBStringField;
    //   258: invokevirtual 685	com/tencent/mobileqq/pb/PBStringField:get	()Ljava/lang/String;
    //   261: astore_1
    //   262: aload 12
    //   264: getfield 694	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:uint32_amount	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   267: invokevirtual 283	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   270: ifeq +13 -> 283
    //   273: aload 12
    //   275: getfield 694	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:uint32_amount	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   278: invokevirtual 285	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   281: istore 8
    //   283: aload 12
    //   285: getfield 697	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:str_jumpurl	Lcom/tencent/mobileqq/pb/PBStringField;
    //   288: invokevirtual 683	com/tencent/mobileqq/pb/PBStringField:has	()Z
    //   291: ifeq +12 -> 303
    //   294: aload 12
    //   296: getfield 697	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:str_jumpurl	Lcom/tencent/mobileqq/pb/PBStringField;
    //   299: invokevirtual 685	com/tencent/mobileqq/pb/PBStringField:get	()Ljava/lang/String;
    //   302: astore_1
    ...
    //   494: lconst_0
    //   495: invokeinterface 712 4 0
    //   500: lstore_2
    //   501: invokestatic 717	com/tencent/mobileqq/msf/core/NetConnInfoCenter:getServerTimeMillis	()J
    //   504: ldc2_w 507
    //   507: ldiv
    //   508: lstore 5
    //   510: lload 5
    ...
    //   544: lconst_0
    //   545: invokeinterface 721 4 0
    //   550: pop
    //   551: new 723	android/os/Bundle
    //   554: dup
    //   555: invokespecial 724	android/os/Bundle:<init>	()V
    //   558: astore_0
    //   559: aload_0
    //   560: ldc_w 473
    //   563: aload 11
    //   565: invokevirtual 357	org/json/JSONObject:toString	()Ljava/lang/String;
    //   568: invokevirtual 728	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   571: aload_0
    //   572: ldc_w 479
    //   575: ldc_w 481
    //   578: invokevirtual 728	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   605: aload 12
    //   607: aload_0
    //   608: invokevirtual 732	android/content/Intent:putExtras	(Landroid/os/Bundle;)Landroid/content/Intent;
    //   611: pop
    //   612: aload 12
    //   614: ldc_w 488
    //   617: iconst_5
    ...
    //   630: invokestatic 735	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   633: ifeq -614 -> 19
    //   636: ldc 78
    //   638: iconst_4
    ...
    //   753: invokestatic 756	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   756: return
    //   757: astore_0
    //   758: aload_0
    ...
    //   777: return
    //   778: astore 13
    //   780: invokestatic 735	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   783: ifeq +8 -> 791
    //   786: aload 13
    ...
    //   877: invokespecial 773	awbh:<init>	(IILjava/lang/String;)V
    //   880: astore_0
    //   881: invokestatic 779	com/tencent/mobileqq/openapi/OpenApiManager:getInstance	()Lcom/tencent/mobileqq/openapi/OpenApiManager;
    //   884: aload_0
    //   885: invokevirtual 783	com/tencent/mobileqq/openapi/OpenApiManager:onPayMsgRsp	(Lawbh;)V
    //   888: goto -337 -> 551
    //   891: astore 12
    //   893: invokestatic 735	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   896: ifeq -29 -> 867
    //   899: aload 12
  ...
  private static void c(QQAppInterface paramQQAppInterface, aiqy paramaiqy)
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.qwallet.push", 2, "startBackgroundPay");
    }
    if ((paramQQAppInterface == null) || (paramQQAppInterface.getApp() == null) || (paramaiqy == null)) {}
    for (;;)
    {
      return;
      String str = String.format(BaseApplication.getContext().getString(2131717773), new Object[] { Integer.valueOf(a()) });
      Object localObject = paramaiqy.jdField_b_of_type_JavaLangString;
      paramaiqy = (aiqy)localObject;
      if (TextUtils.isEmpty((CharSequence)localObject)) {
        paramaiqy = BaseApplication.getContext().getString(2131717772);
      }
      ...
      try
      {
        paramQQAppInterface = NotificationFactory.createNotificationCompatBuilder("CHANNEL_ID_SHOW_BADGE").setSmallIcon(2130841130).setWhen(System.currentTimeMillis()).setAutoCancel(true).setContentTitle(str).setContentText(paramaiqy).setContentIntent(paramQQAppInterface).build();
        paramaiqy = QQNotificationManager.getInstance();
        if (paramaiqy != null)
        {
          paramaiqy.cancel("Q.qwallet.push", 238);
          paramaiqy.notify("Q.qwallet.push", 238, paramQQAppInterface);
          return;
        }
      }
