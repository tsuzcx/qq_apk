...
public class aiqx
{
  ...
  public final CopyOnWriteArrayList<aiqy> a;
  public final CopyOnWriteArraySet<String> a;
  AtomicBoolean a;
  public final LRULinkedHashMap<Integer, hn> b;
  ...
  public static aiqx a()
  {
    if (jdField_a_of_type_Aiqx == null) {}
    try
    {
      if (jdField_a_of_type_Aiqx == null) {
        jdField_a_of_type_Aiqx = new aiqx();
      }
      return jdField_a_of_type_Aiqx;
    }
    finally {}
  }
  ...
  private void c(String paramString)
  {
    ...
    if (localObject2.length == 3)
    {
      ...
      {
        localObject1 = new File(bbcm.c((String)localObject1));
        if (((File)localObject1).exists())
        {
          ...
          localObject1 = baxi.a(((File)localObject1).getAbsolutePath());
  ...
  public Bitmap a(aiqu paramaiqu, int paramInt)
  {
    if ((paramaiqu == null) || (TextUtils.isEmpty(paramaiqu.jdField_a_of_type_JavaLangString))) {
      return null;
    }
    if (this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.containsKey(paramaiqu.jdField_a_of_type_JavaLangString))
    {
      Object localObject = (DiyPendantEntity)this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.get(paramaiqu.jdField_a_of_type_JavaLangString);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(paramaiqu);
      paramaiqu = BaseApplicationImpl.getApplication().getRuntime();
      if ((paramaiqu instanceof QQAppInterface)) {
        a((QQAppInterface)paramaiqu, 500);
      }
      return null;
      if (QLog.isColorLevel()) {
        QLog.i("DiyPendantFetcher", 2, "can not found cache in DiyPendantCache! " + paramaiqu.jdField_a_of_type_JavaLangString);
      }
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArraySet.add(paramaiqu.jdField_a_of_type_JavaLangString);
    }
  }
  
  public Bitmap a(aiqy paramaiqy, String paramString, int paramInt1, int paramInt2, float paramFloat, int paramInt3, int paramInt4, int paramInt5, Paint paramPaint)
  {
    ...
    Object localObject = bbcm.a(String.valueOf(paramInt1));
    if (!this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_isFontLoaded(paramInt1))
    {
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(paramaiqy);
      if (bbcm.a(String.valueOf(paramInt1)))
      {
        if (QLog.isColorLevel()) {
    ...
    paramaiqy = new ETFont(paramInt1, (String)localObject, paramFloat);
    paramaiqy.setColor(paramInt3);
    try
    {
      localObject = Bitmap.createBitmap(paramInt4, paramInt5, Bitmap.Config.ARGB_8888);
      if (!this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_isPaintableChar(paramString.charAt(0), paramaiqy)) {
        break label590;
      }
      for (paramInt1 = this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_spaceMeasureText(paramString, 0, paramString.length(), paramaiqy, paramPaint); paramInt1 > paramInt4; paramInt1 = this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_spaceMeasureText(paramString, 0, paramString.length(), paramaiqy, paramPaint)) {
        paramaiqy.mFontSize -= 1;
      }
      paramInt2 = (paramInt4 - paramInt1) / 2;
    }
    catch (OutOfMemoryError paramaiqy)
    {
      QLog.d("DiyPendantFetcher", 1, "fetchTextWithFont Bitmap.createBitmap OutOfMemoryError: " + paramaiqy.getMessage());
      return null;
    }
    paramInt1 = 0;
    paramPaint = new Paint.FontMetrics();
    if (this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_getFontMetrics(paramPaint, paramaiqy))
    {
      paramFloat = paramPaint.bottom;
      float f = paramPaint.top;
      paramInt1 = (int)((paramInt5 - (paramFloat - f)) / 2.0F);
    }
    if (!this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_drawText(paramString, (Bitmap)localObject, paramInt2, paramInt1, paramaiqy))
    {
  ...
  public Typeface a(aiqy paramaiqy, int paramInt1, int paramInt2)
  {
    if ((paramaiqy == null) || (paramInt1 <= 0)) {
      return null;
    }
    hn localhn = (hn)this.jdField_b_of_type_ComTencentUtilLRULinkedHashMap.get(Integer.valueOf(paramInt1));
    if ((localhn != null) && (localhn.jdField_a_of_type_AndroidGraphicsTypeface != null)) {
      return localhn.jdField_a_of_type_AndroidGraphicsTypeface;
    }
    if (QLog.isColorLevel()) {
  ...
  public DiyPendantEntity a(QQAppInterface paramQQAppInterface, String paramString, ajte paramajte)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.containsKey(paramString))
      {
        ...
        if (paramajte != null) {
          paramajte.onUpdate(1, true, paramQQAppInterface);
        }
    ...
    } while (paramajte == null);
    paramajte.onUpdate(1, true, paramString);
    return localObject;
    if (QLog.isColorLevel()) {
    ...
    ((aiqz)paramQQAppInterface.a(114)).a((List)localObject, paramajte);
    return null;
  }
  ...
  public List<DiyPendantSticker> a(aiqu paramaiqu)
  {
    if ((paramaiqu == null) || (TextUtils.isEmpty(paramaiqu.jdField_a_of_type_JavaLangString))) {
      return null;
    }
    if (this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.containsKey(paramaiqu.jdField_a_of_type_JavaLangString)) {
      return ((DiyPendantEntity)this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.get(paramaiqu.jdField_a_of_type_JavaLangString)).getStickerInfoList();
    }
    if (QLog.isColorLevel()) {
      QLog.i("DiyPendantFetcher", 2, "can not found cache in DiyPendantCache! " + paramaiqu.jdField_a_of_type_JavaLangString);
    }
  ...
  {
    String str = bbcm.a(String.valueOf(paramInt1));
    if (!this.jdField_b_of_type_ComTencentUtilLRULinkedHashMap.containsKey(Integer.valueOf(paramInt1)))
    {
      hn localhn = new hn(paramInt1, str);
      localhn.b = paramInt2;
      this.jdField_b_of_type_ComTencentUtilLRULinkedHashMap.put(Integer.valueOf(paramInt1), localhn);
    }
  ...
  public void a(QQAppInterface paramQQAppInterface, boolean paramBoolean, List<DiyPendantEntity> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if (paramBoolean)
      {
        ...
        ExtensionInfo localExtensionInfo = localajxl.a(localDiyPendantEntity.uinAndDiyId.split("_")[0]);
  ...
  public void b(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      localhn = (hn)this.jdField_b_of_type_ComTencentUtilLRULinkedHashMap.get(Integer.valueOf(Integer.parseInt(paramString)));
      if (localhn != null)
      {
        if (localhn.b != 1) {
          break label128;
        ...
        if ((this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) && (this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_loadFont(localhn.jdField_a_of_type_JavaLangString, Integer.parseInt(paramString), true))) {
          d();
        }
      }
    }
    label128:
    while (!new File(localhn.jdField_a_of_type_JavaLangString).exists()) {
      return;
    }
    localhn.jdField_a_of_type_AndroidGraphicsTypeface = Typeface.createFromFile(localhn.jdField_a_of_type_JavaLangString);
  }
  ...
  public void c(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      while (i < j)
      {
        DiyPendantEntity localDiyPendantEntity = (DiyPendantEntity)((aukp)localObject2).a(DiyPendantEntity.class, (String)((ArrayList)localObject1).get(i));
