...
public abstract class bauo<M extends bayq, V extends bbgz>
  extends baun<M, V>
{
  ...
  private List<bayw> jdField_a_of_type_JavaUtilList;
  ...
  public bauo(ListView paramListView, FaceDecoder paramFaceDecoder, FullMessageSearchResult.SearchResultItem paramSearchResultItem, String paramString, QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(MessageRecord paramMessageRecord)
  {
    ...
    {
      AbsStructMsg localAbsStructMsg = bchh.a(paramMessageRecord.msgData);
    ...
    for (;;)
    {
      try
      {
        ...
        if (j + 50 < this.jdField_a_of_type_ComTencentMobileqqAppFmsFullMessageSearchResult$SearchResultItem.secondPageMessageUniseq.size())
        {
          ...
          if (j < i)
          {
            MessageRecord localMessageRecord = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().queryMsgItemByUniseq(this.jdField_a_of_type_JavaLangString, this.e, ((Long)this.jdField_a_of_type_ComTencentMobileqqAppFmsFullMessageSearchResult$SearchResultItem.secondPageMessageUniseq.get(j)).longValue());
            ...
            this.jdField_a_of_type_JavaUtilList.add(new bayw(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqAppFmsFullMessageSearchResult$SearchResultItem.user, localMessageRecord));
            break label177;
          }
        }
        else
