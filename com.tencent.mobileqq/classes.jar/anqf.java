  ...
  extends anpn
{
  ...
  public anqf(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a()
  {
    ...
    if ((localObject instanceof QQAppInterface))
    {
      ...
      if (localObject != null)
      {
        localObject = (anqf)((anpc)localObject).a(jdField_a_of_type_JavaLangString);
        if (localObject != null)
        {
          ((anqf)localObject).a(true);
