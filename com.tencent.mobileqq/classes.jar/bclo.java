...
public class bclo
{
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, StringBuilder paramStringBuilder)
  {
    ...
    do
    {
      do
      {
        ...
        localStringBuilder.append(abot.b());
        localStringBuilder.append(" and isValid=1 ");
        paramString = bddy.a(MessageRecord.getOldTableName(paramString, paramInt), MessageRecord.getTableName(paramString, paramInt), paramQQAppInterface, localStringBuilder.toString());
  ...
  {
    return a(paramResources, paramInt, paramResources.getDrawable(2130849075));
  }
  ...
  public static Pair<String, ArrayList<MessageForText.AtTroopMemberInfo>> a(Editable paramEditable)
  {
    ...
    paramEditable = bceh.a(paramEditable, localArrayList);
  ...
  public static bctc a(BaseActivity paramBaseActivity, TroopInfoData paramTroopInfoData, QQAppInterface paramQQAppInterface)
  {
    if ((paramBaseActivity == null) || (paramBaseActivity.isFinishing()) || (paramTroopInfoData == null) || (paramQQAppInterface == null)) {
      return null;
    }
    paramBaseActivity = new bctc(paramBaseActivity, paramTroopInfoData, new bclp(paramTroopInfoData));
    paramBaseActivity.a(paramTroopInfoData);
    azmj.b(paramQQAppInterface, "P_CliOper", "Grp_set", "", "Grp_Admin_data", "Clk_share", 0, 0, paramTroopInfoData.troopUin, "", "", "");
    if (paramTroopInfoData.isMember) {
      bdaj.a("Grp_set_new", "grpData_admin", "clk_share", 0, 0, new String[] { paramTroopInfoData.troopUin, bdaj.a(paramTroopInfoData) });
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (l > 0L)
        {
          ...
          {
            localTroopInfoData.mRichFingerMemo = ndd.c(localTroopInfoData.mRichFingerMemo);
            localTroopInfoData.mRichFingerMemo = ndd.b(localTroopInfoData.mRichFingerMemo);
          }
          localTroopInfoData.cGroupOption = ((short)paramBundle.getByte("troop_info_opt"));
          localTroopInfoData.mStrJoinQuestion = bdak.b(paramContext, localTroopInfoData.troopUin);
          localTroopInfoData.nTroopGrade = paramBundle.getInt("TROOP_INFO_TROOP_GRADE");
          localTroopInfoData.mStrJoinAnswer = bdak.c(paramContext, localTroopInfoData.troopUin);
  ...
  public static String a(Context paramContext, long paramLong)
  {
    ...
    if (paramLong > 0L)
    {
      ...
      localObject = paramContext.getResources().getString(2131696602) + ((SimpleDateFormat)localObject).format(Long.valueOf(1000L * paramLong));
    }
    return localObject;
  }
  ...
  public static String a(View paramView, oidb_0xaf4.TabInfo paramTabInfo)
  {
    // Byte code:
    //   0: aload_1
    //   1: getfield 767	tencent/im/oidb/cmd0xaf4/oidb_0xaf4$TabInfo:url	Lcom/tencent/mobileqq/pb/PBStringField;
    //   4: invokevirtual 771	com/tencent/mobileqq/pb/PBStringField:get	()Ljava/lang/String;
    //   7: invokestatic 777	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   10: astore 4
    //   12: iconst_0
    //   13: istore_2
    //   14: aload 4
    ...
    //   19: aload 4
    //   21: ldc_w 779
    //   24: invokevirtual 782	android/net/Uri:getQueryParameter	(Ljava/lang/String;)Ljava/lang/String;
    //   27: astore_1
    //   28: aload 4
    //   30: ldc_w 757
    //   33: invokevirtual 782	android/net/Uri:getQueryParameter	(Ljava/lang/String;)Ljava/lang/String;
    //   36: astore 4
    //   38: aload_1
    //   39: ifnull +21 -> 60
    //   42: aload_1
    //   43: invokestatic 785	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   46: istore_3
    //   47: iload_3
    //   48: istore_2
    //   49: aload_0
    //   50: ldc_w 786
    //   53: iload_2
    //   54: invokestatic 789	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   57: invokevirtual 795	android/view/View:setTag	(ILjava/lang/Object;)V
    //   60: aload 4
    //   62: ifnull +105 -> 167
    //   65: aload_0
    //   66: ldc_w 796
    //   69: aload 4
    //   71: invokevirtual 795	android/view/View:setTag	(ILjava/lang/Object;)V
    //   74: new 646	org/json/JSONObject
    //   77: dup
    //   78: aload 4
    //   80: invokespecial 797	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   83: astore_0
    //   84: aload_0
    //   85: ldc_w 799
    //   88: invokevirtual 802	org/json/JSONObject:has	(Ljava/lang/String;)Z
    //   91: ifeq +76 -> 167
    //   94: aload_0
    //   95: ldc_w 799
    //   98: invokevirtual 805	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   101: astore_0
    //   102: aload_0
    //   103: areturn
    //   104: astore_1
  ...
  public static String a(String paramString, long paramLong, int paramInt, TroopInfoData paramTroopInfoData, QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    {
      str = "0";
      paramQQAppInterface = paramString.replace("$GCODE$", paramTroopInfoData.troopUin).replace("$CLIENTVER$", "android8.3.3").replace("$UIN$", paramQQAppInterface.getCurrentAccountUin()).replace("$LANG$", "zh_CN").replace("$GROUPAPPID$", Long.toString(paramLong)).replace("$ROLE$", str);
      if (!paramBoolean) {
        break label169;
      }
    }
  ...
  public static void a(long paramLong1, String paramString, long paramLong2)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      localObject = (alzf)localQQAppInterface.a(20);
      ((alzf)localObject).notifyUI(2, false, null);
      ((alkk)localQQAppInterface.a(22)).notifyUI(43, true, new Object[] { str, paramString, null });
      if (i != 0)
      {
        if (QLog.isColorLevel()) {
          QLog.d("TroopUtils", 2, "TroopUtils handleModifyName :" + localTroopInfo.troopname);
        }
        ((alzf)localObject).b(str, String.valueOf(paramLong2), paramString);
      }
      return;
    }
  }
  ...
  {
    beqa localbeqa = new beqa(paramActivity);
    int i = paramActivity.getResources().getDimensionPixelSize(2131298914);
    switch (paramInt)
    {
    case 6: 
    case 7: 
    ...
    case 10: 
    default: 
      localbeqa.a(2131693803, i, 0, 1);
      return;
    case 2: 
      localbeqa.a(alpo.a(2131716196), i, 0, 1);
      return;
    case 3: 
      localbeqa.a(alpo.a(2131716185), i, 0, 1);
      return;
    case 4: 
      localbeqa.a(alpo.a(2131716191), i, 0, 1);
      return;
    case 5: 
      localbeqa.a(alpo.a(2131716186), i, 0, 1);
      return;
    }
    localbeqa.a(2131721044, i, 0, 1);
  }
  ...
  public static void a(Activity paramActivity, QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    VasWebviewUtil.openQQBrowserWithoutAD(paramActivity, bdox.a(paramActivity, "background", ""), 33554432L, localIntent, true, paramInt);
    azmj.b(paramQQAppInterface, "CliOper", "", "", "0X8004E0E", "0X8004E0E", 0, 0, "", "", "", "");
  }
  ...
  {
    new beqa(paramContext).a(paramInt2, paramInt1, 0, paramInt3);
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if (TextUtils.isEmpty(paramRecommendTroopItem.recommendReason))
        {
          ...
          ArrayList localArrayList = nau.a(paramRecommendTroopItem);
  ...
  public static void a(Context paramContext, String paramString, boolean paramBoolean)
  {
    ...
    paramContext = bdbt.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramString, false);
    Intent localIntent = aekt.a(new Intent((Context)localObject, SplashActivity.class), null);
    localIntent.putExtra("uin", paramString);
    localIntent.putExtra("uintype", 1);
  ...
  public static void a(View paramView, CharSequence paramCharSequence1, CharSequence paramCharSequence2, CharSequence paramCharSequence3, boolean paramBoolean, String paramString1, String paramString2, awni paramawni)
  {
    ...
    while (TextUtils.isEmpty(paramCharSequence2))
    {
      ...
      if (paramBoolean) {
        awnh.a(paramView, paramString1, paramString2, paramawni);
      }
    }
  ...
  public static void a(BaseActivity paramBaseActivity, TroopInfoData paramTroopInfoData, QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      bdaj.a("Grp_set_new", "grpData_admin", "clk_report", 0, 0, new String[] { paramTroopInfoData.troopUin, bdaj.a(paramTroopInfoData) });
      paramTroopInfoData = yzg.a(str1, 1);
      yzg.a(paramBaseActivity, str1, null, null, str1, paramQQAppInterface.getAccount(), i, null, paramTroopInfoData);
      return;
      if (paramTroopInfoData.isMember) {
        i = 22000;
      } else {
    ...
    {
      bdaj.a("Grp_set_new", "grpData_visitor", "clk_report", 0, 0, new String[] { str2, paramTroopInfoData });
  ...
  {
    if (bdbx.a(paramQQAppInterface.getCurrentAccountUin(), "troop_file_new", paramString) != 0) {}
    for (int i = 1;; i = 0)
    {
      if (i != 0) {
        bdbx.a(paramQQAppInterface.getCurrentAccountUin(), "troop_file_new", paramString, 0);
      }
      Intent localIntent = new Intent();
      ...
      azmj.b(paramQQAppInterface, "P_CliOper", "Grp_set", "", "Grp", "Clk_grpinfo_files", 0, 0, paramString, "0", "", "");
      if (QLog.isDevelopLevel()) {
        QLog.d("Clk_grpinfo_files", 4, "troopUin :" + paramString);
      }
      nco.a(paramQQAppInterface, 67);
      return;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString1, String paramString2)
  {
    ...
    paramString2 = (bchl)paramQQAppInterface.getManager(109);
    ...
    for (int i = 32;; i = 0)
    {
      ...
      for (paramString2 = paramString2.url.replace("$GCODE$", paramString1);; paramString2 = null)
      {
        ...
        azmj.b(paramQQAppInterface, "P_CliOper", "Grp_set", "", "Grp_app", "Clk_grpapp", 0, 0, paramString1, "", "", "");
        return;
      }
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString1, String paramString2, int paramInt)
  {
    ...
    if (paramInt != 0)
    {
      ...
      localbizt.b = paramQQAppInterface.getCurrentNickname();
      alzf localalzf = (alzf)paramQQAppInterface.a(20);
      if (!TextUtils.isEmpty(paramString1)) {
        localalzf.e(paramString1, true);
      }
      if (bdbx.a(paramQQAppInterface.getCurrentAccountUin(), "troop_photo_message", paramString1) <= 0) {
        break label123;
      }
      bizm.d(paramActivity, localbizt, paramString1, 7);
    }
    for (;;)
    {
      azmj.b(paramQQAppInterface, "P_CliOper", "Grp_set", "", "Grp_Admin_data", "Clk_album", 0, 0, paramString1, "", "", "");
      nco.a(paramQQAppInterface, 66);
      return;
      bool = false;
      break;
      label123:
      bizm.a(paramActivity, localbizt, paramString1, paramString2, bool, 7);
    }
  }
  
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, Intent paramIntent, bcgo parambcgo)
  {
    ...
    if (str1.length() < 10)
    {
      ...
      a(paramQQAppInterface, paramContext, str3, parambcgo, 0, null);
    ...
    for (;;)
    {
      ...
      new bcgp(localStringBuilder.toString(), "GET", parambcgo, 1, null).a(paramQQAppInterface);
      return;
      ((StringBuilder)localObject1).append("0");
      ((StringBuilder)localObject1).append(str1);
      break;
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, Bundle paramBundle)
  {
    ...
    localIntent.putExtras(paramBundle);
    paramContext.startActivity(localIntent);
    azmj.b(paramQQAppInterface, "P_CliOper", "Grp_set", "", "Grp_app", "Clk_grpapp", 0, 0, str, "", "", "");
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, MessageRecord paramMessageRecord, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      ((alzf)paramQQAppInterface.a(20)).c(paramString1, 2, i);
      azmj.b(paramQQAppInterface, "dc00898", "", "", "0X800AD4F", "0X800AD4F", (int)l, 0, String.valueOf(j), "", "", "");
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString)
  {
    ...
    if (localTroopManager != null)
    {
      ...
      if (paramString != null)
      {
        ...
        {
          paramQQAppInterface = new bctc((BaseActivity)paramContext, localTroopInfoData);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, int paramInt, String paramString2)
  {
    if (paramContext != null)
    {
      ...
      awnk.a(paramContext, paramQQAppInterface, localIntent, paramInt);
    }
  }
  
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, bcgo parambcgo, int paramInt, Bundle paramBundle)
  {
    Bundle localBundle = new Bundle();
    StringBuilder localStringBuilder = new StringBuilder();
    ...
    new bcgp(localStringBuilder.toString(), "GET", parambcgo, paramInt, paramBundle).a(paramQQAppInterface);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageForUniteGrayTip paramMessageForUniteGrayTip)
  {
    ...
    try
    {
      ...
      if ((paramMessageForUniteGrayTip != null) && (paramMessageForUniteGrayTip.length > 1))
      {
        ...
        azmj.b(paramQQAppInterface, "dc00898", "", "", "0X800AD4E", "0X800AD4E", (int)Long.parseLong(paramMessageForUniteGrayTip[1]), 0, String.valueOf(i), "", "", "");
      }
      return;
    }
    catch (Exception paramQQAppInterface)
  ...
  {
    paramQQAppInterface = (aubr)paramQQAppInterface.getManager(37);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt1, List<oidb_0xe3b.HighlightTitle> paramList, int paramInt2, long paramLong)
  {
    ...
    {
      localaslp = new aslp(paramString1, paramString1, paramString2, 1, -5020, 131088, ayvc.a());
      if (paramList != null)
      {
    ...
    for (;;)
    {
      ...
      paramString2.initGrayTipMsg(paramQQAppInterface, localaslp);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, List<ChatMessage> paramList)
  {
        ...
        if (i < paramList.size())
        {
          ...
          if ((!(localChatMessage instanceof MessageForGrayTips)) && ((!(localChatMessage instanceof MessageForUniteGrayTip)) || (localChatMessage.time == l)))
          {
            ...
            if ((localChatMessage instanceof MessageForSplitLineTips))
            {
              ...
              if (!alpo.a(2131716188).equalsIgnoreCase(((MessageForSplitLineTips)localObject2).msgContent)) {
                break;
              }
            }
          }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localObject2 = (MessageForSplitLineTips)ayvw.a(-4012);
        ((MessageForSplitLineTips)localObject2).init(paramQQAppInterface.getCurrentAccountUin(), paramString, paramQQAppInterface.getCurrentAccountUin(), alpo.a(2131716193), l, -4012, 1, l);
        ...
        ((MessageForSplitLineTips)localObject2).msgContent = alpo.a(2131716194);
  ...
  {
    // Byte code:
    //   0: invokestatic 205	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   3: ifeq +29 -> 32
    //   6: ldc 147
    //   8: iconst_2
    //   9: new 75	java/lang/StringBuilder
    //   12: dup
    //   13: invokespecial 173	java/lang/StringBuilder:<init>	()V
    //   16: ldc_w 1847
    ...
    //   29: invokestatic 220	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   32: aload_0
    //   33: ifnull +91 -> 124
    //   36: aload_1
    //   37: ifnull +87 -> 124
    ...
    //   47: dup
    //   48: invokespecial 173	java/lang/StringBuilder:<init>	()V
    //   51: aload_0
    //   52: invokevirtual 165	com/tencent/mobileqq/app/QQAppInterface:getApp	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   55: invokevirtual 171	com/tencent/qphone/base/util/BaseApplication:getBaseContext	()Landroid/content/Context;
    //   58: invokevirtual 1851	android/content/Context:getFilesDir	()Ljava/io/File;
    //   61: invokevirtual 1856	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   64: invokevirtual 89	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   67: getstatic 1859	java/io/File:separator	Ljava/lang/String;
    ...
    //   86: astore_0
    //   87: new 1863	java/io/FileOutputStream
    //   90: dup
    //   91: new 1853	java/io/File
    //   94: dup
    //   95: aload_0
    //   96: invokespecial 1864	java/io/File:<init>	(Ljava/lang/String;)V
    //   99: invokespecial 1867	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   102: astore_1
    //   103: aload_1
    //   104: astore_0
    //   105: aload_1
    //   106: aload_2
    //   107: invokevirtual 1870	java/io/FileOutputStream:write	([B)V
    //   110: aload_1
    //   111: astore_0
    //   112: aload_1
    //   113: invokevirtual 1873	java/io/FileOutputStream:flush	()V
    //   116: aload_1
    //   117: ifnull +7 -> 124
    //   120: aload_1
    //   121: invokevirtual 1874	java/io/FileOutputStream:close	()V
    //   124: return
    //   125: astore_0
    //   126: invokestatic 205	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   129: ifeq -5 -> 124
    //   132: ldc 147
    //   134: iconst_2
    //   135: new 75	java/lang/StringBuilder
    //   138: dup
    //   139: invokespecial 173	java/lang/StringBuilder:<init>	()V
    //   142: ldc_w 1876
    //   145: invokevirtual 89	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   148: aload_0
    //   149: invokevirtual 983	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   152: invokevirtual 103	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   155: invokestatic 220	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   158: return
    //   159: astore_2
    //   160: aconst_null
    //   161: astore_1
    //   162: aload_1
    //   163: astore_0
    //   164: invokestatic 205	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   167: ifeq +31 -> 198
    //   170: aload_1
    //   171: astore_0
    //   172: ldc 147
    ...
    //   178: dup
    //   179: invokespecial 173	java/lang/StringBuilder:<init>	()V
    //   182: ldc_w 1878
    //   185: invokevirtual 89	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   188: aload_2
    //   189: invokevirtual 983	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   192: invokevirtual 103	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   195: invokestatic 220	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   198: aload_1
    //   199: ifnull -75 -> 124
    //   202: aload_1
    //   203: invokevirtual 1874	java/io/FileOutputStream:close	()V
    //   206: return
    //   207: astore_0
    //   208: invokestatic 205	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   211: ifeq -87 -> 124
    //   214: ldc 147
    //   216: iconst_2
    //   217: new 75	java/lang/StringBuilder
    //   220: dup
    //   221: invokespecial 173	java/lang/StringBuilder:<init>	()V
    //   224: ldc_w 1876
    //   227: invokevirtual 89	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   230: aload_0
    //   231: invokevirtual 983	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   234: invokevirtual 103	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   237: invokestatic 220	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   240: return
    //   241: astore_1
    //   242: aconst_null
    //   243: astore_0
    ...
    //   245: ifnull +7 -> 252
    //   248: aload_0
    //   249: invokevirtual 1874	java/io/FileOutputStream:close	()V
    //   252: aload_1
    //   253: athrow
    //   254: astore_0
    //   255: invokestatic 205	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   258: ifeq -6 -> 252
    //   261: ldc 147
    //   263: iconst_2
    //   264: new 75	java/lang/StringBuilder
    //   267: dup
    //   268: invokespecial 173	java/lang/StringBuilder:<init>	()V
    //   271: ldc_w 1876
    //   274: invokevirtual 89	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   277: aload_0
    //   278: invokevirtual 983	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   281: invokevirtual 103	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   284: invokestatic 220	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   287: goto -35 -> 252
    //   290: astore_1
    //   291: goto -47 -> 244
    //   294: astore_2
  ...
  public static void a(TroopInfoData paramTroopInfoData, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      azmj.b(null, "P_CliOper", "Grp_nearby", "", "recom", "Clk_joingrp", 0, 0, paramTroopInfoData.troopUin, "", "", "");
      return;
    }
    if (paramTroopInfoData.pa == 18)
    {
      azmj.b(null, "P_CliOper", "Grp_join", "", "join_page", "Clk_join", 0, 0, paramTroopInfoData.troopUin, "", "", "");
      return;
    }
    if (paramTroopInfoData.pa == 24)
    {
      azmj.b(null, "P_CliOper", "Grp_nearby", "", "search", "Clk_joingrp", 0, 0, "", "", "", "");
      return;
    }
    if (paramTroopInfoData.pa == 17)
    {
      azmj.b(null, "CliOper", "", "", "Grp_recommend", "viewinfor_joingrp", 0, 0, paramTroopInfoData.troopUin, "", "", "");
      return;
    }
    int i = -1;
    int j;
    ...
    for (;;)
    {
      ...
      azmj.b(null, "P_CliOper", "Grp_set", "", "Grp_data", "Clk_joingrp", j, 0, paramTroopInfoData.troopUin, paramInt1 + "", "" + i, paramInt2 + "");
      azmj.b(null, "P_CliOper", "Grp_set", "", "Grp_data", "Clk_joingrp1", j, 0, paramTroopInfoData.troopUin, paramInt1 + "", paramInt3 + "", "");
      return;
      i = 0;
      break;
      i = 1;
  ...
  public static void a(String paramString)
  {
    ...
    do
    {
      ...
      bczr.a(BaseApplicationImpl.getApplication(), paramString, paramString);
    } while (!QLog.isColorLevel());
  ...
  public static void a(List<String> paramList)
  {
    ...
    {
      bckx localbckx = (bckx)((QQAppInterface)localObject).getManager(203);
      localObject = null;
      Iterator localIterator = paramList.iterator();
      if (localIterator.hasNext())
      {
  ...
  public static void a(AppRuntime paramAppRuntime, TroopInfo paramTroopInfo, Activity paramActivity, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    paramActivity.setTitle(alpo.a(2131716189)).setMessage(alpo.a(2131716187)).setPositiveButton(alpo.a(2131716195), paramOnClickListener);
    paramActivity.show();
    bdaj.a("Grp_manage_new", "gainUin_msgBox", "exp", 0, 0, new String[] { String.valueOf(paramTroopInfo.troopuin), "", bdaj.a(paramTroopInfo, paramAppRuntime) });
  }
  ...
  public static void a(boolean paramBoolean, TextView paramTextView)
  {
    if (paramBoolean)
    {
      ...
      paramTextView.setCompoundDrawablePadding(aekt.a(10.0F, BaseApplicationImpl.getApplication().getResources()));
      paramTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130841116, 0);
      return;
    }
  ...
  public static boolean a(Context paramContext, String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        return false;
        if (!TextUtils.equals("4515", paramContext)) {
          break;
        }
      } while (!QLog.isColorLevel());
      QLog.i("TroopUtils", 2, String.format("isUpdateBeforeSomeVersion pre: %s, cur: %s", new Object[] { "4515", paramContext }));
      return false;
  ...
  {
    if ((paramTabInfo != null) && (paramTabInfo.appid.get() == 1106837471L) && ((paramView.getTag(2131377393) instanceof Integer))) {
      return ((Integer)paramView.getTag(2131377393)).intValue() == 1;
    }
    return false;
  }
  ...
  public static boolean a(String paramString)
  {
    ...
    return (alzf.jdField_a_of_type_Boolean) && (localTroopManager.b());
  }
  ...
  public static byte[] a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    //   29: aload_0
    //   30: invokevirtual 165	com/tencent/mobileqq/app/QQAppInterface:getApp	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   33: invokevirtual 171	com/tencent/qphone/base/util/BaseApplication:getBaseContext	()Landroid/content/Context;
    //   36: invokevirtual 1851	android/content/Context:getFilesDir	()Ljava/io/File;
    //   39: invokevirtual 1856	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   42: invokevirtual 89	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   45: getstatic 1859	java/io/File:separator	Ljava/lang/String;
    ...
    //   64: astore_0
    //   65: new 1853	java/io/File
    //   68: dup
    //   69: aload_0
    //   70: invokespecial 1864	java/io/File:<init>	(Ljava/lang/String;)V
    //   73: astore_0
    //   74: aload_0
    //   75: invokevirtual 2235	java/io/File:exists	()Z
    //   78: ifeq +241 -> 319
    //   81: new 2237	java/io/FileInputStream
    //   84: dup
    //   85: aload_0
    //   86: invokespecial 2238	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   89: astore_0
    //   90: aload_0
    //   91: astore_2
    //   92: aload_0
    //   93: invokevirtual 2241	java/io/FileInputStream:available	()I
    //   96: newarray byte
    //   98: astore_1
    //   99: aload_0
    //   100: astore_2
    //   101: aload_0
    //   102: aload_1
    //   103: invokevirtual 2245	java/io/FileInputStream:read	([B)I
    //   106: pop
    //   107: aload_1
    //   108: astore_2
    //   109: aload_0
    ...
    //   116: ifnull +9 -> 125
    //   119: aload_1
    //   120: invokevirtual 2246	java/io/FileInputStream:close	()V
    //   123: aload_0
    //   124: astore_2
    //   125: aload_2
    //   126: areturn
    ...
    //   128: aload_0
    //   129: astore_2
    //   130: invokestatic 205	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   133: ifeq -8 -> 125
    //   136: ldc 147
    //   138: iconst_2
    //   139: new 75	java/lang/StringBuilder
    //   142: dup
    //   143: invokespecial 173	java/lang/StringBuilder:<init>	()V
    //   146: ldc_w 2248
    //   149: invokevirtual 89	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   152: aload_1
    //   153: invokevirtual 983	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   156: invokevirtual 103	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   159: invokestatic 220	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   162: aload_0
    //   163: areturn
    //   164: astore_3
    //   165: aconst_null
    ...
    //   170: aload_0
    //   171: astore_2
    //   172: invokestatic 205	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   175: ifeq +31 -> 206
    //   178: aload_0
    //   179: astore_2
    //   180: ldc 147
    ...
    //   196: aload_3
    //   197: invokevirtual 983	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   200: invokevirtual 103	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   203: invokestatic 220	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   206: aload_1
    //   207: astore_2
    //   208: aload_0
    //   209: ifnull -84 -> 125
    //   212: aload_0
    //   213: invokevirtual 2246	java/io/FileInputStream:close	()V
    //   216: aload_1
    //   217: areturn
    //   218: astore_0
    //   219: aload_1
    //   220: astore_2
    //   221: invokestatic 205	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   224: ifeq -99 -> 125
    //   227: ldc 147
    //   229: iconst_2
    //   230: new 75	java/lang/StringBuilder
    //   233: dup
    //   234: invokespecial 173	java/lang/StringBuilder:<init>	()V
    //   237: ldc_w 2248
    //   240: invokevirtual 89	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   243: aload_0
    //   244: invokevirtual 983	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   247: invokevirtual 103	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   250: invokestatic 220	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   253: aload_1
    //   254: areturn
    //   255: astore_0
    //   256: aconst_null
    ...
    //   259: ifnull +7 -> 266
    //   262: aload_2
    //   263: invokevirtual 2246	java/io/FileInputStream:close	()V
    //   266: aload_0
    //   267: athrow
    //   268: astore_1
    //   269: invokestatic 205	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   272: ifeq -6 -> 266
    //   275: ldc 147
    //   277: iconst_2
    //   278: new 75	java/lang/StringBuilder
    //   281: dup
    //   282: invokespecial 173	java/lang/StringBuilder:<init>	()V
    //   285: ldc_w 2248
    //   288: invokevirtual 89	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   291: aload_1
    //   292: invokevirtual 983	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   295: invokevirtual 103	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   298: invokestatic 220	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   301: goto -35 -> 266
    //   304: astore_0
    //   305: goto -47 -> 258
    //   308: astore_3
  ...
  {
    String str = bczr.a(BaseApplicationImpl.getApplication(), paramString);
    if (QLog.isColorLevel()) {
