...
public class aais
  extends ajto
{
  public aais(AssistantSettingActivity paramAssistantSettingActivity) {}
  ...
  {
    if ((paramBoolean) && (AssistantSettingActivity.a(this.a) != null) && (this.a.jdField_a_of_type_Aajt != null) && (this.a.jdField_a_of_type_Aajt.a(paramArrayOfShort)))
    {
  ...
  protected void onGetConnectionsSwitch(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    if (paramBoolean)
    {
      ...
      if (this.a.jdField_a_of_type_Afry.c()) {
        break label81;
      }
    }
    label81:
  ...
  {
    boolean bool2 = true;
    if (this.a.jdField_a_of_type_Aajt == null) {}
    for (afru localafru = null; localafru == null; localafru = this.a.jdField_a_of_type_Aajt.a(paramShort1)) {
      return;
    }
    if (com.tencent.TMG.utils.QLog.isColorLevel()) {
    ...
    if (paramShort2 == 1)
    {
      bool1 = true;
      label91:
      if ((paramBoolean) || (bool1 != localafru.e)) {
        break label148;
      }
      if (localafru.e) {
        break label150;
  ...
  protected void onSetConnectionsSwitch(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    if (!paramBoolean)
    {
      AssistantSettingActivity.a(this.a, 2131719386, 1);
      localAssistantSettingActivity = this.a;
      if (this.a.jdField_a_of_type_Afry.c()) {
        break label95;
      }
  ...
  protected void onSetEmotionRecSwitch(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      AssistantSettingActivity.a(this.a, 2131719386, 1);
      AssistantSettingActivity.a(this.a, aexb.a(this.a.app).b(), AssistantSettingActivity.a(this.a));
      return;
    }
    ...
    {
      axqy.b(localQQAppInterface, "dc00898", "", "", "0X800A223", "0X800A223", 0, 0, str, "", "", "");
      return;
    }
  }
  ...
  protected void onSetPttAutoToTxtSwitch(boolean paramBoolean, Object paramObject)
  {
    if (!paramBoolean)
    {
      bcql.a(BaseApplication.getContext(), 1, ajya.a(2131700781), 0).b(this.a.getTitleBarHeight());
