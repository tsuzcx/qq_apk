  ...
  extends LinearLayout
{
  ...
  public skp(TabLayoutCompat paramTabLayoutCompat, Context paramContext)
  {
    super(paramContext);
  ...
  private void a(@Nullable TextView paramTextView, @Nullable ImageView paramImageView)
  {
    ...
    {
      localDrawable = this.jdField_a_of_type_Sko.a();
      if (this.jdField_a_of_type_Sko == null) {
        break label176;
      }
      localCharSequence1 = this.jdField_a_of_type_Sko.a();
      if (this.jdField_a_of_type_Sko == null) {
        break label182;
      }
      localCharSequence2 = this.jdField_a_of_type_Sko.b();
      label48:
  ...
  public void a(@Nullable sko paramsko)
  {
    if (paramsko != this.jdField_a_of_type_Sko)
    {
  ...
  public boolean performClick()
  {
    ...
    if (this.jdField_a_of_type_Sko != null)
    {
      ...
      sko localsko = TabLayoutCompat.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetTabLayoutCompat);
      if (TabLayoutCompat.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetTabLayoutCompat) == this.jdField_a_of_type_Sko) {
        i = 1;
      }
      this.jdField_a_of_type_Sko.a();
      if ((TabLayoutCompat.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetTabLayoutCompat) != null) && (i == 0)) {
        TabLayoutCompat.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetTabLayoutCompat).a(this.jdField_a_of_type_Sko, localsko, 1);
      }
      return true;
    }
    return bool;
