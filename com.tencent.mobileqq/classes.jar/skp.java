...
{
  public skp(DiscussionInfoCardActivity paramDiscussionInfoCardActivity, ActionSheet paramActionSheet) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityDiscussionInfoCardActivity, 2, this.jdField_a_of_type_ComTencentMobileqqActivityDiscussionInfoCardActivity.getString(2131434485), 0).a();
      if (this.jdField_a_of_type_ComTencentMobileqqActivityDiscussionInfoCardActivity.a != null) {
        ((TextView)this.jdField_a_of_type_ComTencentMobileqqActivityDiscussionInfoCardActivity.a.findViewById(2131363378)).setTextColor(Color.parseColor("#cccccc"));
      }
    }
  }
}
