...
public class algd
{
  private static volatile algd jdField_a_of_type_Algd;
  private static boolean jdField_b_of_type_Boolean;
  public float a;
  private int jdField_a_of_type_Int = 5;
  private alhb jdField_a_of_type_Alhb;
  ...
  private void a(String paramString1, algh paramalgh, String paramString2)
  {
    ...
    PreloadManager.a().a((DownloadParam)localObject, new algg(this, paramalgh));
  }
  ...
  private void b(agpd paramagpd, algi paramalgi)
  {
    if (QLog.isColorLevel()) {
      QLog.d("DrawClassifier", 2, "recognize called");
    }
    if ((!this.jdField_a_of_type_Boolean) || (paramagpd == null))
    {
      if (paramalgi != null) {
        paramalgi.a(false);
      }
    ...
    ThreadManager.excute(new DrawClassifier.4(this, paramalgi, paramagpd), 16, null, true);
  }
  ...
  public void a()
  {
    ...
    //   23: aload_0
    //   24: getfield 145	algd:jdField_a_of_type_Boolean	Z
    ...
    //   36: aload_0
    //   37: getfield 145	algd:jdField_a_of_type_Boolean	Z
    //   40: istore_1
    //   41: iload_1
    //   42: ifne +6 -> 48
    //   45: aload_0
    ...
    //   48: aload_0
    //   49: iconst_0
    //   50: putfield 145	algd:jdField_a_of_type_Boolean	Z
    //   53: aload_0
    //   54: getfield 44	algd:jdField_a_of_type_Alhb	Lalhb;
    //   57: ifnull -12 -> 45
    //   60: aload_0
    //   61: getfield 44	algd:jdField_a_of_type_Alhb	Lalhb;
    //   64: invokevirtual 213	alhb:a	()V
    //   67: goto -22 -> 45
    //   70: astore_2
    //   71: aload_0
    //   72: monitorexit
  ...
  public void a(agpd paramagpd, algi paramalgi)
  {
    b(paramagpd, paramalgi);
  }
  
  public void a(Context paramContext, String paramString1, String paramString2, algh paramalgh)
  {
    for (;;)
    {
      try
      ...
      continue;
      label430:
      alhf.a().a(new algf(this, paramalgh));
    }
  }
}
