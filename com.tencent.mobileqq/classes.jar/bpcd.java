...
public class bpcd
  implements bolg
{
  public bpcd(EditTextPanel paramEditTextPanel) {}
  ...
  public void a(boolean paramBoolean, String paramString)
  {
    ...
    for (;;)
    {
      ...
      while (i < j)
      {
        ...
        localObject = (bpcc)this.a.a.getChildViewHolder((View)localObject);
        if (((bpcc)localObject).a.isContainsResUrl(paramString)) {
          ThreadManager.getUIHandler().post(new EditTextPanel.2.2(this, paramBoolean, (bpcc)localObject, localDynamicTextConfigManager));
        }
        i += 1;
      }
    }
