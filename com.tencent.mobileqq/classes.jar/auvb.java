...
public class auvb
{
  ...
  private AdapterView.OnItemClickListener jdField_a_of_type_AndroidWidgetAdapterView$OnItemClickListener = new auvd(this);
  ...
  public auvb(Activity paramActivity, QQAppInterface paramQQAppInterface, int paramInt, auve paramauve)
  {
  ...
  private void e()
  {
    ...
    for (;;)
    {
      ...
      String str3 = ajya.a(2131708447);
      String str4 = ajya.a(2131708493) + this.jdField_a_of_type_JavaLangString;
      String str5 = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131718649);
      localObject1 = ((axum)localObject1).c(14).a(ajya.a(2131708476) + this.jdField_b_of_type_JavaLangString).a(2).a(1).a("plugin", "", str2, str1, str1).d(str5).a();
      Object localObject2 = new axyo();
      ((axuq)localObject2).b(1);
      ((axuq)localObject2).a(str3);
      axxi localaxxi = new axxi();
      localaxxi.b(1);
      localaxxi.a(new axws(str1));
      localaxxi.a(new StructMsgItemTitle(this.jdField_b_of_type_JavaLangString));
      localaxxi.a(new axzj(str4));
      ((AbsShareMsg)localObject1).addItem((axup)localObject2);
      ((AbsShareMsg)localObject1).addItem(localaxxi);
      ...
      while (QLog.isColorLevel())
      {
        ...
        ((Intent)localObject1).putExtras((Bundle)localObject2);
        aqbe.a(this.jdField_a_of_type_AndroidAppActivity, (Intent)localObject1, 21);
      }
    }
  }
  ...
  private void f()
  {
    ...
    for (;;)
    {
      if (i != -1)
      {
        bcql.a(this.jdField_a_of_type_AndroidAppActivity, 1, i, 1).a();
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    } while (this.jdField_a_of_type_Bbjq.a());
  ...
  protected void b()
  {
    if ((this.jdField_a_of_type_AndroidAppActivity != null) && (!this.jdField_a_of_type_AndroidAppActivity.isFinishing()))
    {
      ...
      this.jdField_a_of_type_Bcqf.a(ajya.a(2131708477));
