  ...
  extends afdk
{
  ...
  public afee(int paramInt, AIOAnimationConatiner paramAIOAnimationConatiner, ListView paramListView)
  {
  ...
  private BaseChatItemLayout a(long paramLong)
  {
    ...
    if (paramLong == 0L)
    {
      ...
      while (k < this.jdField_a_of_type_ComTencentWidgetListView.getChildCount())
      {
        ...
        {
          localObject2 = (aezf)AIOUtils.getHolder((View)localObject1);
          if ((((aezf)localObject2).jdField_a_of_type_Int != 0) && (((aezf)localObject2).jdField_a_of_type_AndroidViewView.getTop() + ((View)localObject1).getTop() + BaseChatItemLayout.h > 0)) {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          if (((localObject2 instanceof BaseChatItemLayout)) && (((aezf)AIOUtils.getHolder((View)localObject2)).jdField_a_of_type_Int != 0)) {
  ...
  private void a(afdr paramafdr, ChatMessage paramChatMessage)
  {
    afed.a(null, "0X800B072", paramChatMessage.frienduin, paramafdr);
  }
  
  private void a(Object[] paramArrayOfObject)
  {
    if ((paramArrayOfObject.length < 5) || (!(paramArrayOfObject[3] instanceof afdr)) || (!(paramArrayOfObject[4] instanceof ChatMessage))) {}
    afdr localafdr;
    do
    {
      return;
      localafdr = (afdr)paramArrayOfObject[3];
    } while (!a(localafdr.a));
    paramArrayOfObject = (ChatMessage)paramArrayOfObject[4];
    if (QLog.isColorLevel()) {
      QLog.d("FloorJumper", 2, "set jump url, url = " + localafdr.a);
    }
    this.jdField_a_of_type_AndroidViewView.setOnClickListener(new afef(this, localafdr, paramArrayOfObject));
  }
  ...
  int a(int paramInt, aezf paramaezf)
  {
    int k;
    int m;
    int n;
    if (paramaezf.jdField_a_of_type_ComTencentMobileqqDataChatMessage.isSend())
    {
      k = paramaezf.jdField_a_of_type_AndroidViewView.getLeft() + BaseChatItemLayout.k + BaseChatItemLayout.p;
      m = paramaezf.jdField_a_of_type_AndroidViewView.getRight() - BaseChatItemLayout.j - BaseChatItemLayout.o;
      if (paramInt > k) {
        break label135;
      }
    ...
    {
      return n;
      k = paramaezf.jdField_a_of_type_AndroidViewView.getLeft() + BaseChatItemLayout.j + BaseChatItemLayout.o;
      m = paramaezf.jdField_a_of_type_AndroidViewView.getRight() - BaseChatItemLayout.k - BaseChatItemLayout.k;
      break;
      d1 = Math.random();
  ...
  public long a()
  {
    ...
    case 3: 
      ...
      if (this.jdField_b_of_type_Int == 1)
      {
        ...
        {
          localaezf = (aezf)AIOUtils.getHolder(localBaseChatItemLayout);
          if (localaezf != null)
          {
            this.jdField_b_of_type_Int = 2;
            this.jdField_a_of_type_Long = 0L;
            this.jdField_b_of_type_Long = localaezf.jdField_a_of_type_ComTencentMobileqqDataChatMessage.uniseq;
            this.jdField_d_of_type_Long = 0L;
            this.jdField_e_of_type_Int = 0;
            k = localaezf.jdField_a_of_type_AndroidViewView.getTop();
            this.jdField_f_of_type_Int = (localBaseChatItemLayout.getTop() + k + BaseChatItemLayout.h - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY());
            this.jdField_g_of_type_Int = a((localaezf.jdField_a_of_type_AndroidViewView.getLeft() + localaezf.jdField_a_of_type_AndroidViewView.getRight()) / 2, localaezf);
            this.h = 0;
      ...
      if (localBaseChatItemLayout != null)
      {
        ...
        if (localaezf != null)
        {
          ...
          k = localaezf.jdField_a_of_type_AndroidViewView.getTop();
          this.jdField_f_of_type_Int = (localBaseChatItemLayout.getTop() + k + BaseChatItemLayout.h - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - this.h);
          ...
          this.jdField_e_of_type_Int = (a(this.i, localaezf) - this.i);
  ...
  public boolean a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      while ((this.jdField_a_of_type_ComTencentMobileqqActivityAioAnimAIOAnimationConatiner == null) || (this.jdField_a_of_type_AndroidViewView == null))
      {
        ...
        return false;
        k = AIOUtils.findMessagePosition(this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentWidgetListView.getAdapter());
        ...
        {
          aezf localaezf = (aezf)AIOUtils.getHolder(AIOUtils.getViewByPostion(this.jdField_a_of_type_ComTencentWidgetListView, k));
          if (localaezf != null)
          {
            k = localaezf.jdField_a_of_type_AndroidViewView.getTop();
            k = localaezf.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() + k + BaseChatItemLayout.h - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - (this.h + this.jdField_f_of_type_Int);
            if (k != 0)
            {
              this.h += k;
              this.j += k;
          ...
          else
          {
            ...
            return false;
            k = AIOUtils.findMessagePosition(this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentWidgetListView.getAdapter());
            int m = AIOUtils.findMessagePosition(this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentWidgetListView.getAdapter());
            ...
            {
              localaezf = (aezf)AIOUtils.getHolder(AIOUtils.getViewByPostion(this.jdField_a_of_type_ComTencentWidgetListView, k));
              if (localaezf != null)
              {
                k = localaezf.jdField_a_of_type_AndroidViewView.getTop();
                k = localaezf.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() + k + BaseChatItemLayout.h - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - (this.h + this.jdField_f_of_type_Int);
            ...
            {
              localaezf = (aezf)AIOUtils.getHolder(AIOUtils.getViewByPostion(this.jdField_a_of_type_ComTencentWidgetListView, m));
              if (localaezf != null)
              {
                k = localaezf.jdField_a_of_type_AndroidViewView.getTop();
                k = localaezf.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() + k + BaseChatItemLayout.h - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - (this.h + this.jdField_f_of_type_Int);
  ...
  public boolean a(Object... paramVarArgs)
  {
    ...
    label308:
    for (Object localObject = paramVarArgs[1];; localObject = Integer.valueOf(0))
    {
