  ...
  implements Manager
{
  ...
  protected HashMap<Long, atao> a;
  protected HashSet<String> a;
  protected boolean a;
  protected boolean b = true;
  
  public ataj(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Ataq = new ataq();
  ...
  {
    axqy.b(paramQQAppInterface, "dc00899", "grp_lbs", paramString2, "pay_like", paramString1, 0, 0, paramString3, paramString4, paramString5, paramString6);
  ...
  {
    if ((this.jdField_a_of_type_Ataq == null) || (this.jdField_a_of_type_Ataq.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg == null)) {
      return null;
    }
    return a(this.jdField_a_of_type_Ataq.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg.rpt_msg_first_info.get());
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3)
  {
    try
    {
      ...
      {
        this.jdField_a_of_type_Ataq.jdField_a_of_type_Int = paramInt1;
        this.jdField_a_of_type_Ataq.c = paramInt2;
        this.jdField_a_of_type_Ataq.d = paramInt3;
        if (QLog.isColorLevel()) {
  ...
  public void a(long paramLong, int paramInt1, int paramInt2)
  {
    for (;;)
    {
      try
      {
        ...
        atao localatao = (atao)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramLong));
        if (localatao == null)
        {
          if ((paramInt1 > 0) || (paramInt2 > 0))
          {
            localatao = new atao();
            localatao.jdField_a_of_type_Long = paramLong;
            localatao.jdField_a_of_type_Int += paramInt1;
            localatao.b += paramInt2;
            localatao.c += this.jdField_a_of_type_Ataq.b * paramInt2;
            this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(paramLong), localatao);
            localObject2 = this.jdField_a_of_type_Ataq;
            ((ataq)localObject2).f += 1;
            localObject2 = this.jdField_a_of_type_Ataq;
            ((ataq)localObject2).e -= this.jdField_a_of_type_Ataq.b * paramInt2;
          }
          if (QLog.isColorLevel())
          {
      ...
      localObject1.c += this.jdField_a_of_type_Ataq.b * paramInt2;
      this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(paramLong), localObject1);
      Object localObject2 = this.jdField_a_of_type_Ataq;
      ((ataq)localObject2).e -= this.jdField_a_of_type_Ataq.b * paramInt2;
      continue;
      label377:
      boolean bool = false;
  ...
  public void a(Activity paramActivity, QQAppInterface paramQQAppInterface, String paramString1, atar paramatar, String paramString2)
  {
    for (;;)
    {
      try
      {
        if (QLog.isColorLevel()) {
          QLog.d("NearbyLikeLimitManager", 2, "checkCanDoVote, uin=" + paramString1 + ", from=" + paramString2 + ", mLimitInfo=" + this.jdField_a_of_type_Ataq);
        }
        ...
        if ((bool1) && (c()))
        {
          ...
          if (i != 0)
          {
            paramActivity = bbdj.a(paramActivity, 0, null, localSpannableString, ajya.a(2131707213), ajya.a(2131707209), ajya.a(2131707208), new atak(this, bool1, paramString1, paramatar, paramQQAppInterface, paramString2, paramActivity), new atal(this, paramActivity, paramQQAppInterface, paramString2));
        ...
        if (a())
        {
          ...
          paramatar.a(paramString1, false);
  ...
  {
    bbdj.a(paramActivity, 230).setTitle(ajya.a(2131707214)).setMessage(ajya.a(2131707210)).setNegativeButton(ajya.a(2131707212), new atan(this)).setPositiveButton(ajya.a(2131707211), new atam(this, paramActivity)).show();
  }
  
  public void a(ataq paramataq, List<atao> paramList, int paramInt)
  {
    try
    {
      ...
      paramataq = new StringBuilder();
      if ((paramList != null) && (paramList.size() > 0))
      {
        paramList = paramList.iterator();
        while (paramList.hasNext())
        {
          atao localatao = (atao)paramList.next();
          this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(localatao.jdField_a_of_type_Long), localatao);
          if (QLog.isColorLevel()) {
            paramataq.append(localatao).append(" | ");
          }
        }
      }
      if (!QLog.isColorLevel()) {
    ...
    QLog.d("NearbyLikeLimitManager", 2, "updateFromServer, mLimitInfo=" + this.jdField_a_of_type_Ataq + ", mLikeItemMap=[" + paramataq + "]");
    label165:
  }
  ...
  public boolean a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Ataq.e >= this.jdField_a_of_type_Ataq.b)
        {
          bool1 = bool2;
          bool2 = bool1;
          if (QLog.isColorLevel())
  ...
  public boolean a(long paramLong)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Ataq.f < this.jdField_a_of_type_Ataq.c) {
          break label165;
        }
        bool1 = true;
      }
      ...
      if (QLog.isColorLevel())
      {
        ...
        bool1 = false;
        break label219;
        if ((this.jdField_a_of_type_Ataq.f >= this.jdField_a_of_type_Ataq.c) && (localObject.b > 0))
        {
  ...
  public boolean a(String paramString)
  {
    ...
    //   56: ireturn
    //   57: aload_0
    //   58: getfield 35	ataj:jdField_a_of_type_JavaUtilHashSet	Ljava/util/HashSet;
    //   61: aload_1
  ...
  public SpannableString b()
  {
    ...
    return a(this.jdField_a_of_type_Ataq.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg.rpt_msg_user_num_limit_info.get());
  }
  ...
  public boolean b(long paramLong)
  {
    ...
    for (;;)
    {
      try
      {
        atao localatao = (atao)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramLong));
        boolean bool1;
        if ((this.jdField_a_of_type_Ataq == null) || (localatao == null))
        {
          if (QLog.isColorLevel())
          {
        ...
        if (localatao.jdField_a_of_type_Int >= this.jdField_a_of_type_Ataq.d)
        {
          bool1 = true;
          bool2 = bool1;
          if (QLog.isColorLevel())
  ...
  public SpannableString c()
  {
    ...
    return a(this.jdField_a_of_type_Ataq.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg.rpt_msg_zan_limit_info.get());
  }
  ...
  public boolean c()
  {
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Ataq != null) && (this.jdField_a_of_type_Ataq.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg != null)) {}
    for (boolean bool = true;; bool = false)
    {
      if (QLog.isColorLevel()) {
  ...
  public boolean c(long paramLong)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 30	ataj:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   6: lload_1
    ...
    //   13: checkcast 335	atao
    //   16: astore 5
    //   18: aload_0
    //   19: getfield 25	ataj:jdField_a_of_type_Ataq	Lataq;
    //   22: astore 6
    //   24: aload 6
    //   26: ifnull +8 -> 34
    //   29: aload 5
    ...
    //   16	27	5	localatao	atao
    //   64	5	5	localObject	Object
    //   22	3	6	localataq	ataq
    // Exception table:
    //   from	to	target	type
    //   2	24	64	finally
    //   42	48	64	finally
  ...
  public boolean d()
  {
    if ((this.b) && (this.jdField_a_of_type_Ataq != null) && (this.jdField_a_of_type_Ataq.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg != null)) {}
    for (boolean bool = true;; bool = false)
    {
      if (QLog.isColorLevel()) {
  ...
  public void onDestroy()
  {
    try
    {
      this.jdField_a_of_type_Ataq = null;
      this.jdField_a_of_type_JavaUtilHashMap.clear();
      if (QLog.isColorLevel()) {
