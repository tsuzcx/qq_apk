...
public class ataj
{
  ...
  {
    paramString1 = aszt.a(paramString1);
    aszt.a(paramString1);
    ...
    paramString1 = new File(aszt.b(localFile.getAbsolutePath() + "/" + paramString1 + paramString2));
    try
    {
  ...
  private static String a(Uri paramUri)
  {
    // Byte code:
    //   0: iconst_1
    //   1: anewarray 74	java/lang/String
    //   4: astore_2
    //   5: aload_2
    //   6: iconst_0
    //   7: ldc 76
    //   9: aastore
    //   10: invokestatic 82	com/tencent/common/app/BaseApplicationImpl:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   13: invokevirtual 88	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   16: aload_0
    //   17: aload_2
    //   18: aconst_null
    //   19: aconst_null
    ...
    //   79: iconst_1
    //   80: aload_2
    //   81: invokevirtual 112	java/lang/Exception:toString	()Ljava/lang/String;
    //   84: invokestatic 118	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   87: aload_0
    //   88: ifnull +34 -> 122
    //   91: aload_0
  ...
  public static String a(String paramString)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        {
          localObject3 = localObject4;
          localObject1 = "." + FileUtils.estimateFileType(paramString);
      ...
      catch (Exception localException)
      {
        ...
        str2 = MimeTypesTools.getMimeType((Context)localObject3, str1);
  ...
  public static String b(String paramString)
  {
    ...
    {
      return null;
      localObject4 = aszt.a(paramString);
      str2 = "";
      String str1 = str2;
      localObject3 = localObject4;
      localObject2 = str2;
      try
      {
        ...
        {
          localObject2 = str2;
          str1 = "." + FileUtils.estimateFileType(paramString);
          localObject2 = str1;
      ...
      catch (Exception localException)
      {
        ...
        str2 = MimeTypesTools.getMimeType((Context)localObject2, (String)localObject3);
        j = ff.a(paramString);
    ...
    for (;;)
    {
      if (ataw.a((Context)localObject2, paramString, (Uri)localObject1))
      {
        paramString = ((File)localObject4).getAbsolutePath();
        localObject1 = new atak();
  ...
  {
    return FileUtils.fileExists(c(paramString));
  }
