  ...
  extends QIPCModule
{
  ...
  private alye jdField_a_of_type_Alye = new alye();
  ...
  public alvp(String paramString)
  {
    super(paramString);
  }
  
  public static alvp a()
  {
    return alvw.a();
  }
  ...
  public static void b()
  {
    ...
    {
      QIPCServerHelper.getInstance().register(localalvp);
  ...
  public int a()
  {
    if (this.jdField_a_of_type_Alye != null) {
      return this.jdField_a_of_type_Alye.a();
    }
  ...
  {
    if (this.jdField_a_of_type_Alye != null) {
      return this.jdField_a_of_type_Alye.a(paramInt);
    }
    return null;
  }
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Alye != null)
    {
      List localList = this.jdField_a_of_type_Alye.a();
      if (localList != null)
      {
        int i = 0;
        while (i < localList.size())
        {
          alyd localalyd = (alyd)localList.get(i);
          if ((localalyd != null) && (!alvx.a(localalyd.a())) && (!alvx.a(localalyd.a())))
          {
            alvn.a(localalyd.a());
            QLog.i("cmgame_process.CmGameServerQIPCModule", 1, "closeAllGame gameId:" + localalyd.a());
          }
          i += 1;
        }
      }
  ...
  public void a(CmGameStartChecker.StartCheckParam paramStartCheckParam, long paramLong, CmGameInitParams paramCmGameInitParams)
  {
    ...
    this.c = true;
    if ((this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null) && (alvx.a(BaseApplicationImpl.getContext())))
    {
  ...
  public void a(ArrayList<String> paramArrayList)
  {
    ...
    for (int i = paramArrayList.size();; i = 0)
    {
      ...
      QIPCServerHelper.getInstance().callClient(LocalMultiProcConfig.PROCESS_NAME, "cm_game_client_module", "action_dress_changed", (Bundle)localObject, new alvv(this));
      return;
    }
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    try
    {
      if ("action_aduio_query_voice_status".equals(paramString))
      {
        ...
        paramBundle = (alnr)((QQAppInterface)localObject1).getManager(153);
        localObject1 = new Bundle();
        ((Bundle)localObject1).putBoolean("isOpen", paramBundle.a().a(paramString));
        ((Bundle)localObject1).putBoolean("display", aluk.b);
      ...
      {
        paramString = paramBundle.getString("key_game_friUin");
        ((alnr)((QQAppInterface)localObject1).getManager(153)).a().c(paramString, 318);
      }
    }
    ...
    if ("action_aduio_enter_room".equals(paramString))
    {
      ...
      paramBundle = ((alnr)((QQAppInterface)localObject1).getManager(153)).a();
      if ((bool) || ((aluk.jdField_a_of_type_Boolean) && (!paramBundle.b()))) {
    ...
    {
      paramString = paramBundle.getString("key_game_friUin");
      ((alnr)((QQAppInterface)localObject1).getManager(153)).a().a(paramString, 318);
    }
    ...
    else if ("action_loadyoutu".equals(paramString))
    {
      ...
      if ((paramString != null) && ((paramString instanceof QQAppInterface)))
      {
        ...
        break label2282;
        paramString = new opf(paramString, BaseApplicationImpl.getContext());
        b = true;
        paramString.a(new alvq(this, paramInt));
        paramString.a();
        break label2280;
      }
    }
    else
    {
      ...
      if ("game_activity_lifecycle".equals(paramString))
      {
        ...
        if ((paramString != null) && ((paramString instanceof CmGameStartChecker.StartCheckParam)))
        {
          ...
          this.jdField_a_of_type_Alye.a(paramInt, i, j, paramString);
          break label2280;
        }
      }
    ...
    while (paramString != null)
    {
      ...
      if ("action_update_game_push".equals(paramString))
      {
        ...
        paramString = (QQAppInterface)alvx.a();
        if (paramString == null) {
          return null;
        }
        paramBundle = (CmGamePushItem)paramBundle.getSerializable("CmGamePushItem");
        if (paramBundle != null) {
          ((alnr)paramString.getManager(153)).a().a(paramBundle);
        }
      }
      ...
      {
        if ((localObject1 instanceof QQAppInterface)) {
          amge.a((QQAppInterface)localObject1);
        }
        paramString = new Bundle();
        paramString.putString("sApolloBaseScriptId", amip.au);
        paramString.putBoolean("sDisableCreateRenderThread", alnr.q);
        paramString.putBoolean("sApolloEngineLockEnable", alnr.r);
      ...
      else
      {
        ...
        if ("action_init_cmshow_data".equals(paramString))
        {
          ...
          if ((localObject1 instanceof QQAppInterface))
          {
            Object localObject3 = (alnr)((QQAppInterface)localObject1).getManager(153);
            localObject1 = (VasExtensionHandler)((QQAppInterface)localObject1).getBusinessHandler(71);
            localObject2 = ((alnr)localObject3).b(paramString);
            ApolloBaseInfo localApolloBaseInfo = ((alnr)localObject3).b(paramBundle);
            ...
            if (!((List)localObject3).isEmpty())
            {
              ...
              ((VasExtensionHandler)localObject1).a(new alvr(this, (List)localObject3, paramString, paramBundle, paramInt));
              ((VasExtensionHandler)localObject1).a((String[])localObject2);
            }
            else
            {
              i = alnr.a(ApolloUtil.a(), paramString, true);
              j = alnr.a(ApolloUtil.a(), paramBundle, true);
              paramString = new Bundle();
        ...
        else if ("action_render_view_preload_res".equals(paramString))
        {
          ...
          else
          {
            ...
            {
              localObject1 = ambc.a(ApolloUtil.a(), paramString[i]);
              localObject2 = new amdx(3, paramString[i]);
              ((amdx)localObject2).c = ((ApolloActionData)localObject1).actionType;
              paramBundle.add(localObject2);
              i += 1;
            }
            amdp.a(ApolloUtil.a(), "", new alvt(this, paramInt), paramBundle, false);
          }
        }
        else if ("action_cmshow_tracereport".equals(paramString))
        {
          amht.a(paramBundle.getString("action"), paramBundle.getBundle("bundle"));
        }
        else
        {
          ...
          if ("action_render_view_change_mode".equals(paramString))
          {
            ...
            paramString = (VasExtensionHandler)((QQAppInterface)localObject1).getBusinessHandler(71);
            paramString.a(new alvu(this, paramString, paramInt));
            if (i == 2) {}
