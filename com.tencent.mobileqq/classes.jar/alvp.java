...
public class alvp
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = "mqqapi://forward/url?src_type=internal&plg_auth=1&version=1&style=home&url_prefix=" + bdfr.encodeToString("https://buluo.qq.com/mobile/v2/buluoindex.html?_wv=16778243&_bid=128&from=dongtai&target=hot&_nav_txtclr=000000&_wwv=265&sonic=1".getBytes(), 0);
  }
  ...
  private void a(int paramInt1, List<alvq> paramList, int paramInt2, int paramInt3)
  {
    int j = alvr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    if (paramList == null) {}
    for (int i = -1;; i = paramList.size())
    {
      ...
      {
        alvr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt1);
        alvr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramList);
        alvr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt2, paramInt3);
      }
      return;
    }
  }
  ...
  private void f()
  {
    ...
    try
    {
      List localList = LebaPluginInfo.getAll((awgf)localObject1);
      if (localList != null)
      {
        int i = 0;
        while (i < localList.size())
        {
          ...
          if ((localLebaPluginInfo != null) && (localLebaPluginInfo.cDataType == 1)) {
            LebaPluginInfo.remove((awgf)localObject1, localLebaPluginInfo.uiResId);
          }
          i += 1;
        }
      }
  ...
  private void g()
  {
    ...
    localLebaPluginInfo.strResName = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131718266);
  ...
  private void h()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 60	alvp:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   4: ifnull +13 -> 17
    //   7: aload_0
    //   8: getfield 60	alvp:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   32: return
    //   33: aload_0
    //   34: getfield 67	alvp:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   37: astore_1
    //   38: aload_1
    //   39: monitorenter
    //   40: aload_0
    //   41: getfield 67	alvp:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   44: invokeinterface 269 1 0
    //   49: aload_1
    //   50: monitorexit
    //   51: aload_0
    //   52: invokespecial 271	alvp:g	()V
    //   55: aload_0
    //   56: invokespecial 273	alvp:i	()V
    //   59: aload_0
    //   60: getfield 54	alvp:jdField_a_of_type_ArrayOfByte	[B
    //   63: astore_1
    //   64: aload_1
    //   65: monitorenter
    //   66: aload_0
    //   67: getfield 65	alvp:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   70: invokeinterface 269 1 0
    //   75: aload_0
    //   76: getfield 65	alvp:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   79: aload_0
    //   80: getfield 67	alvp:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   113: aload_0
    //   114: getfield 65	alvp:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   131: aload_0
    //   132: iconst_1
    //   133: putfield 284	alvp:jdField_b_of_type_Boolean	Z
    //   136: return
    //   137: astore_2
  ...
  private void i()
  {
    ...
    Map localMap = alvr.a(alvr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
    if (localMap == null)
    {
      if (QLog.isColorLevel()) {
    ...
    List localList = LebaPluginInfo.getAll((awgf)???);
    ((awgf)???).a();
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_b_of_type_JavaUtilList)
      {
        ...
        {
          LebaPluginInfo localLebaPluginInfo = (LebaPluginInfo)localList.get(i);
          alvq localalvq = (alvq)localMap.get(Long.valueOf(localLebaPluginInfo.uiResId));
          if (localalvq == null)
          {
          ...
          else
          {
            ...
            localLebaPluginInfo.sPriority = alvr.a(localalvq);
          }
        }
      }
  ...
  public PluginConfig.GetResourceReq a()
  {
    ...
    if (alvr.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))
    {
      QLog.i("LebaHelper", 1, "getLebaPluginInfoReq ，isAppUpgrade");
      alvr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0);
      alvr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    }
    if (alvw.c())
    {
    ...
    try
    {
      ((awgf)localObject).a(LebaPluginInfo.class);
    }
    ...
    if (alvr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))
    {
      QLog.i("LebaHelper", 1, "getLebaPluginInfoReq ，isChangeModel");
      alvr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0);
    }
    int k = alvr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  ...
  public void a(boolean paramBoolean, int paramInt1, List<alvq> arg3, List<LebaPluginInfo> paramList1, int paramInt2, int paramInt3)
  {
    ...
    if (??? != null)
    {
      ...
      {
        localObject3 = (alvq)((Iterator)localObject2).next();
        if (localObject3 != null) {
          ((StringBuilder)localObject1).append(((alvq)localObject3).toString());
        }
      }
    }
    ...
    if (paramBoolean)
    {
      ...
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getEntityManagerFactory().createEntityManager();
      localObject2 = ((awgf)localObject1).a();
      bool2 = false;
      bool1 = false;
      bool5 = false;
      paramBoolean = false;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramList1.hasNext())
        {
          ...
          if (((LebaPluginInfo)localObject3).state == 3)
          {
            bool3 = paramBoolean;
            bool4 = bool1;
            LebaPluginInfo.persistOrReplace((awgf)localObject1, (LebaPluginInfo)localObject3);
            bool5 = true;
            bool2 = true;
          }
          bool3 = bool2;
      ...
      try
      {
        ...
        LebaPluginInfo.remove((awgf)localObject1, ((LebaPluginInfo)localObject3).uiResId);
        bool1 = true;
      }
      catch (Exception paramList1)
      {
      ...
      j();
      if (bool3) {
        ((ambm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(87)).a(1);
      }
      if (bool1)
      {
  ...
  public boolean a()
  {
    return alvr.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) == 1;
  }
  ...
  public void b()
  {
    ...
    {
      this.jdField_a_of_type_Boolean = false;
      ((atko)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(128)).a();
