...
public final class bahy
{
  ...
  public bahy(@Nullable String paramString1, int paramInt, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float paramFloat5, float paramFloat6, float paramFloat7, @Nullable String paramString2)
  {
  ...
  public boolean equals(@Nullable Object paramObject)
  {
    if (this != paramObject)
    {
      if ((paramObject instanceof bahy))
      {
        paramObject = (bahy)paramObject;
