...
public class blda
{
  ...
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new bldb(this);
  ...
  public blda(Context paramContext, int paramInt1, int paramInt2, int paramInt3, GdtAppReceiver paramGdtAppReceiver)
  {
  ...
  public void a(int paramInt1, String paramString, int paramInt2)
  {
    ...
    {
      localObject = new blai();
      ((blai)localObject).a(this.jdField_c_of_type_Int).a(l).b(paramInt1).a(paramString).c(paramInt2).d(1);
      paramString = ((blai)localObject).a();
      blbc.a().a(paramString);
      return;
  ...
  public void a(View paramView, bldd parambldd)
  {
    if (paramView == null) {
      return;
    }
    this.jdField_a_of_type_Bldd = parambldd;
    QZLog.i("VipGeneralGdtShowView", " @getGdtInfo initAdvView");
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131367501));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131367510));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367511));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367513));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367509));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367514));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367515));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131367512));
  ...
  public void a(AlumBasicData paramAlumBasicData, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject1 = this.jdField_a_of_type_AndroidWidgetTextView.getResources().getDrawable(2130840312);
        ...
        if ((this.jdField_c_of_type_Int == 3) && (!bbyp.b()))
        {
          ((URLDrawable)localObject1).setTag(bfol.a(ViewUtils.dip2px(40.0F), ViewUtils.dip2px(40.0F)));
          ((URLDrawable)localObject1).setDecodeHandler(bfol.p);
          if (localURLDrawable != null)
          {
            this.jdField_e_of_type_Int = paramAlumBasicData.jdField_a_of_type_Int;
            this.f = paramAlumBasicData.jdField_b_of_type_Int;
            int j = this.jdField_a_of_type_AndroidContentContext.getResources().getDisplayMetrics().widthPixels - ViewUtils.dpToPx(56.0F);
            paramInt = i;
      ...
      ((URLDrawable)localObject1).setTag(bfol.b(ViewUtils.dip2px(40.0F), ViewUtils.dip2px(40.0F), ViewUtils.dip2px(3.5F)));
