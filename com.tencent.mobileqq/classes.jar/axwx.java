...
import java.util.HashMap<Ljava.lang.String;Laxww;>;
...
public class axwx
  extends QIPCModule
{
  public static volatile axwx a;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new axxa(this);
  private String jdField_a_of_type_JavaLangString;
  private HashMap<String, HashMap<String, axww>> jdField_a_of_type_JavaUtilHashMap;
  ...
  private axwx()
  {
    ...
    return;
    label105:
    QIPCClientHelper.getInstance().getClient().connect(new axwy(this));
    QIPCClientHelper.getInstance().getClient().addListener(new axwz(this));
  ...
  public static axwx a()
  {
    if (jdField_a_of_type_Axwx == null) {}
    try
    {
      if (jdField_a_of_type_Axwx == null) {
        jdField_a_of_type_Axwx = new axwx();
      }
      return jdField_a_of_type_Axwx;
    }
    finally {}
  }
  ...
  private String a()
  {
    ...
    String str2 = String.valueOf(badq.a(localContext));
    String str1 = str2;
    if (!baip.a(str2))
    {
      str1 = str2;
      if (str2.equals(String.valueOf(1))) {
        str1 = auco.a(localContext);
      }
    }
    return str1;
  }
  ...
  public static String a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      localObject1 = axub.a(paramString1, (String)localObject1);
      return localObject1;
      label68:
  ...
  public static String a(HashMap<String, HashMap<String, axww>> paramHashMap)
  {
    ...
    try
    {
      ...
      while (paramHashMap.hasNext())
      {
        ...
        localJSONObject.put("domain_map", axww.a((HashMap)localObject));
  ...
  private ArrayList<axxb> a(ArrayList<axxb> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          if (((axxb)((Iterator)localObject).next()).b <= 0) {
            continue;
          }
  ...
  public static HashMap<String, HashMap<String, axww>> a(String paramString)
  {
    if (paramString == null) {}
    do
    {
      ...
      try
      {
        ...
        while (i < paramString.length())
        {
          ...
          localObject = axww.a(((JSONObject)localObject).getString("domain_map"));
          if (localObject != null) {
  ...
  private static HashMap<String, axww> a(List<DomainIp.iplistInfo> paramList, HashMap<String, axww> paramHashMap)
  {
    if (paramList == null) {}
    Object localObject1;
    String str;
    ...
    do
    {
      ...
      for (;;)
      {
        paramHashMap = (HashMap<String, axww>)localObject1;
    ...
    {
      paramList = (axww)((HashMap)localObject1).get(str);
      if (paramList.a != null) {
        break label392;
      }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (paramHashMap.hasNext())
        {
          ...
          axxb localaxxb = new axxb();
          localaxxb.jdField_a_of_type_JavaLangString = ((DomainIp.ServerList)localObject2).string_IP.get();
          localaxxb.jdField_a_of_type_Int = ((DomainIp.ServerList)localObject2).uint32_Port.get();
          localaxxb.c = i;
          paramList.a.add(localaxxb);
          if (QLog.isColorLevel())
          {
            QLog.d("InnerDns", 2, "onDomainServerListUpdate type=" + i + " d:" + str + " " + localaxxb.jdField_a_of_type_JavaLangString + " " + localaxxb.jdField_a_of_type_Int);
            continue;
            paramList = new axww(str, new ArrayList());
            break;
          }
        }
      }
  ...
  public ArrayList<String> a(String paramString, int paramInt1, boolean paramBoolean, int paramInt2)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localObject = a(((axww)((HashMap)localObject).get(paramString)).a);
        if ((localObject != null) && (((ArrayList)localObject).size() > 0))
        {
          if (((axxb)((ArrayList)localObject).get(0)).b <= 0) {
            break label696;
          }
          i = 1;
          continue;
          localObject = new HashMap();
          ((HashMap)localObject).put("param_FailCode", String.valueOf(paramInt2));
          ((HashMap)localObject).put("domain", paramString);
          ((HashMap)localObject).put("businessType", String.valueOf(paramInt1));
          awrn.a(BaseApplication.getContext()).a(null, "actDnsReq", paramBoolean, BaseApplicationImpl.sProcessId, 0L, (HashMap)localObject, "");
          paramString = localArrayList;
          if (!QLog.isColorLevel()) {
            break;
          }
          QLog.d("InnerDns", 2, "reqDnsForIpList succeeded:" + paramBoolean + " retList=" + localArrayList + " error=" + paramInt2);
      ...
      do
      {
        ...
        localaxxb = (axxb)localIterator.next();
      } while (localaxxb.c != paramInt2);
      String str = localaxxb.jdField_a_of_type_JavaLangString;
      if ((localaxxb.c == 1) && (localaxxb.jdField_a_of_type_Int != 80)) {
        localObject = str + ":" + localaxxb.jdField_a_of_type_Int;
      }
      for (;;)
      {
  ...
  public void a()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 44	axwx:jdField_a_of_type_Boolean	Z
    //   4: ifeq +43 -> 47
    //   7: ldc 2
    //   9: monitorenter
    ...
    //   24: ldc 56
    //   26: aload_0
    //   27: getfield 72	axwx:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   30: invokestatic 418	axwx:a	(Ljava/util/HashMap;)Ljava/lang/String;
    ...
    //   50: aload_0
    //   51: getfield 36	axwx:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   54: invokevirtual 558	com/tencent/common/app/BaseApplicationImpl:unregisterReceiver	(Landroid/content/BroadcastReceiver;)V
    //   57: return
    //   58: astore_1
    //   59: ldc 2
    //   61: monitorexit
  ...
  public void a(String paramString1, String paramString2, int paramInt)
  {
    ...
    Object localObject;
    if ((baip.a(paramString1)) || (baip.a(paramString2)) || (paramString1.equals(paramString2)))
    {
      bool = false;
      i = 40;
      if (QLog.isColorLevel()) {
      ...
      awrn.a(BaseApplication.getContext()).a(null, "actDnsBadIp", bool, BaseApplicationImpl.sProcessId, 0L, (HashMap)localObject, "");
      return;
    }
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if (this.jdField_a_of_type_JavaUtilHashMap.containsKey(localObject)) {
        try
        {
          ...
          {
            localObject = (axww)((HashMap)localObject).get(paramString1);
            if (((axww)localObject).a != null)
            {
              localObject = ((axww)localObject).a.iterator();
              while (((Iterator)localObject).hasNext())
              {
                axxb localaxxb = (axxb)((Iterator)localObject).next();
                if (paramString2.equals(localaxxb.jdField_a_of_type_JavaLangString)) {
                  localaxxb.b += 1;
                }
              }
            }
  ...
  public void b()
  {
    if ((BaseApplicationImpl.sProcessId == 1) && (!this.c))
    {
      ...
      localQQAppInterface.startServlet(new NewIntent(localQQAppInterface.getApp(), awcp.class));
      this.c = true;
    }
  }
