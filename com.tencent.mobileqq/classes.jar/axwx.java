...
public class axwx
  implements afal, awau
{
  public static int a;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new axwy(this);
  ...
  public axwx(BaseChatPie paramBaseChatPie)
  {
  ...
  private Friends a()
  {
    return ((aloz)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).e(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a);
  }
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2, String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean2) {
        awaf.a().a(a(), this.jdField_a_of_type_AndroidWidgetTextView, false);
      }
      if (QLog.isColorLevel()) {
  ...
  protected void a(String paramString)
  {
    ...
    this.jdField_b_of_type_AndroidWidgetTextView.setText(new baig(paramString, 3, 12));
  ...
  public void b(String paramString)
  {
    ...
    awaf.a().a(a(), this.jdField_a_of_type_AndroidWidgetTextView, true);
  }
  
  public boolean b()
  {
    Friends localFriends = ((aloz)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).c(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a);
    if (localFriends == null)
    {
      ThreadManager.post(new AioFriendTitleHelper.4(this), 8, null, true);
      return false;
    }
    int i = bdbt.a(localFriends.detalStatusFlag, localFriends.iTermType);
    if (QLog.isColorLevel()) {
  ...
  protected void c()
  {
    RichStatus localRichStatus = ((axzt)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(15)).a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, false);
  ...
  public boolean c()
  {
    ...
    atla localatla = (atla)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(32);
    int i = j;
    if (localatla != null)
    {
      i = j;
    ...
    return ((afbq)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(43)).c();
  }
