  ...
  implements SensorEventListener
{
  ...
  public void onSensorChanged(SensorEvent paramSensorEvent)
  {
    ...
    if ((bhwk.jdField_b_of_type_Int == 1) && (bhwk.jdField_b_of_type_Boolean))
    {
      this.a.c = ((int)paramSensorEvent.values[0]);
      bhwk.jdField_b_of_type_Boolean = false;
    }
    if (bhwk.jdField_b_of_type_Int == 3)
    {
      bhwk.jdField_b_of_type_Int = 0;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        bhwk.jdField_b_of_type_Boolean = true;
        return;
      }
