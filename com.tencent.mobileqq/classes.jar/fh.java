...
public class fh
{
  ...
  private ArrayList<fk> jdField_a_of_type_JavaUtilArrayList = new ArrayList(16);
  public AtomicBoolean a;
  public boolean a;
  private fl[] jdField_a_of_type_ArrayOfFl;
  public int b;
  public ETFont b;
  private ArrayList<CharacterStyle> b;
  public boolean b;
  public int c;
  private ArrayList<fm> jdField_c_of_type_JavaUtilArrayList = new ArrayList(16);
  ...
  private String a()
  {
    ...
    if ((this.jdField_a_of_type_ArrayOfFl == null) || (this.jdField_a_of_type_ArrayOfFl.length == 0)) {
      return null;
    }
    ...
    {
      Object localObject = ((fk)localIterator.next()).a();
      if (localObject == null) {
        return null;
      }
      ...
      for (;;)
      {
        ...
        ff localff = (ff)((Iterator)localObject).next();
        if (localff == null) {
          return null;
        }
        String str = localff.a();
        if (str != null)
        {
          localff.a(j);
          j += str.length();
  ...
  {
    paramCharacterStyle = new fk(paramCharacterStyle, paramInt1, paramInt2, paramInt3, paramBoolean);
  ...
  {
    if (this.jdField_a_of_type_ArrayOfFl != null) {
      this.jdField_a_of_type_ArrayOfFl = null;
    }
    ...
    while (i < m)
    {
      localObject1 = (fk)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      k = ((fk)localObject1).a(paramETEngine, paramInt, j, k);
      j = ((fk)localObject1).a();
      i += 1;
    }
    k += 1;
    this.jdField_a_of_type_ArrayOfFl = new fl[k];
    paramInt = 0;
    while (paramInt < k)
    {
      this.jdField_a_of_type_ArrayOfFl[paramInt] = new fl();
      paramInt += 1;
    }
    paramInt = 0;
    Object localObject2;
    while (paramInt < m)
    {
      localObject1 = ((fk)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).a();
      i = 0;
      while (i < ((ArrayList)localObject1).size())
      {
        localObject2 = (ff)((ArrayList)localObject1).get(i);
        j = ((ff)localObject2).e();
        if ((j >= 0) && (j < k)) {
          this.jdField_a_of_type_ArrayOfFl[j].a((ff)localObject2);
        }
        i += 1;
      }
      paramInt += 1;
    ...
    while (paramInt < k)
    {
      localObject1 = this.jdField_a_of_type_ArrayOfFl[paramInt];
      ((fl)localObject1).a(paramETEngine, 0, i, this.jdField_a_of_type_Int);
      localObject2 = ((fl)localObject1).a().iterator();
      j = 0;
      while (((Iterator)localObject2).hasNext())
      {
        ff localff = (ff)((Iterator)localObject2).next();
        fm[] arrayOffm = localff.a(paramETEngine, j, i, ((fl)localObject1).a(), paramInt);
        if ((arrayOffm != null) && (arrayOffm.length > 0)) {
          Collections.addAll(this.jdField_c_of_type_JavaUtilArrayList, arrayOffm);
        }
        j += localff.c();
      }
      i += ((fl)localObject1).a();
  ...
  {
    paramString = new fk(paramString, paramInt1, paramInt2, paramETFont, paramBoolean);
  ...
  {
    paramString = new fk(paramString, paramInt1, paramInt2, paramETFont, paramBoolean1);
    paramString.a(this.g);
  ...
  private int b()
  {
    ...
    int i = this.jdField_a_of_type_ArrayOfFl.length;
    return this.jdField_a_of_type_ArrayOfFl[(i - 1)].b();
  }
  ...
  private void b()
  {
    ...
    fj[] arrayOffj = new fj[arrayOfCharacterStyle.length];
    if ((arrayOffj == null) || (arrayOffj.length == 0))
    {
      a(this.jdField_a_of_type_JavaLangCharSequence.toString(), 0, this.jdField_a_of_type_JavaLangCharSequence.length(), this.jdField_a_of_type_ComEtrumpMixlayoutETFont, false);
      return;
    }
    ...
    {
      arrayOffj[i] = new fj();
      arrayOffj[i].jdField_a_of_type_Int = ((Spanned)localObject).getSpanStart(arrayOfCharacterStyle[i]);
      arrayOffj[i].jdField_b_of_type_Int = ((Spanned)localObject).getSpanEnd(arrayOfCharacterStyle[i]);
      arrayOffj[i].jdField_a_of_type_AndroidTextStyleCharacterStyle = arrayOfCharacterStyle[i];
      i += 1;
    }
    Arrays.sort(arrayOffj, new fi());
    i = 0;
    int j = 0;
    label176:
    int m;
    ...
    {
      m = arrayOffj[i].jdField_a_of_type_Int;
      k = arrayOffj[i].jdField_b_of_type_Int;
      if (m - j > 0) {
        a(a(this.jdField_a_of_type_JavaLangCharSequence, j, m).toString(), j, m, this.jdField_a_of_type_ComEtrumpMixlayoutETFont, false);
      }
      if (k - m > 0)
      {
        if (!(arrayOffj[i].jdField_a_of_type_AndroidTextStyleCharacterStyle instanceof ClickableSpan)) {
          break label379;
        }
    ...
    for (j = m + 1;; j = m)
    {
      ...
      for (;;)
      {
        ...
        break;
        label379:
        if ((arrayOffj[i].jdField_a_of_type_AndroidTextStyleCharacterStyle instanceof axkk))
        {
          localObject = (axkk)arrayOffj[i].jdField_a_of_type_AndroidTextStyleCharacterStyle;
          this.jdField_b_of_type_JavaUtilArrayList.add(localObject);
          a((CharacterStyle)localObject, this.jdField_b_of_type_JavaUtilArrayList.indexOf(localObject), m, k, false);
        }
        else if ((arrayOffj[i].jdField_a_of_type_AndroidTextStyleCharacterStyle instanceof RelativeSizeSpan))
        {
          localObject = a(this.jdField_a_of_type_JavaLangCharSequence, m, k);
          RelativeSizeSpan localRelativeSizeSpan = (RelativeSizeSpan)arrayOffj[i].jdField_a_of_type_AndroidTextStyleCharacterStyle;
        ...
        else if ((arrayOffj[i].jdField_a_of_type_AndroidTextStyleCharacterStyle instanceof avdg))
        {
          localObject = (avdg)arrayOffj[i].jdField_a_of_type_AndroidTextStyleCharacterStyle;
          this.jdField_b_of_type_JavaUtilArrayList.add(localObject);
          a((CharacterStyle)localObject, this.jdField_b_of_type_JavaUtilArrayList.indexOf(localObject), m, k, false);
        }
      }
  ...
  {
    if (this.jdField_a_of_type_ArrayOfFl != null) {
      return this.jdField_a_of_type_ArrayOfFl.length;
    }
    return 0;
  }
  ...
  int a(int paramInt)
  {
    int j = this.jdField_a_of_type_ArrayOfFl.length;
    int i = 0;
    while (i < j)
    {
      fl localfl = this.jdField_a_of_type_ArrayOfFl[i];
      int k = localfl.d();
      if (paramInt < localfl.a() + k) {
        return i;
      }
      i += 1;
    }
  ...
  int a(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt2 < k)
    {
      fm localfm = (fm)this.jdField_c_of_type_JavaUtilArrayList.get(paramInt2);
      if (localfm.jdField_a_of_type_Int == j)
      {
        if (paramInt1 > localfm.jdField_a_of_type_AndroidGraphicsRect.right) {
          break label87;
        }
        return paramInt2;
      }
  ...
  Rect a(int paramInt)
  {
    if ((paramInt < 0) || (paramInt >= this.jdField_a_of_type_ArrayOfFl.length)) {
      return null;
    }
    fl localfl = this.jdField_a_of_type_ArrayOfFl[paramInt];
    paramInt = localfl.c();
    int i = localfl.d();
    return new Rect(paramInt, i, this.jdField_b_of_type_Int + paramInt, i + localfl.a());
  }
  
  public axkk a(int paramInt1, int paramInt2)
  {
    int i = 0;
    Rect localRect = new Rect(0, 0, 0, 0);
    fl[] arrayOffl = this.jdField_a_of_type_ArrayOfFl;
    int j = arrayOffl.length;
    if (i < j)
    {
      Object localObject = arrayOffl[i];
      localRect.left = ((fl)localObject).c();
      localRect.top = ((fl)localObject).d();
      localRect.right = (localRect.left + ((fl)localObject).b());
      localRect.bottom = (localRect.top + ((fl)localObject).a());
      if (!localRect.contains(paramInt1, paramInt2)) {}
      do
      {
        i += 1;
        break;
        localObject = ((fl)localObject).a(paramInt1);
      } while (localObject == null);
      return ((ff)localObject).a();
    }
    return null;
  }
  ...
  public ETDecoration a(ETEngine paramETEngine, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        if (((CharacterStyle)this.jdField_b_of_type_JavaUtilArrayList.get(i) instanceof avdg)) {
          this.d = i;
        }
      }
      else {
  ...
  fm a(int paramInt)
  {
    ...
    return (fm)this.jdField_c_of_type_JavaUtilArrayList.get(paramInt);
  }
  ...
  public final void a(Canvas paramCanvas, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      return;
      fl[] arrayOffl = this.jdField_a_of_type_ArrayOfFl;
      int k = arrayOffl.length;
      int j = 0;
      int i = paramInt2;
      paramInt2 = j;
      while (paramInt2 < k)
      {
        fl localfl = arrayOffl[paramInt2];
        localfl.a(paramCanvas, paramInt1, i);
        i += localfl.a();
        paramInt2 += 1;
      }
    }
  ...
  public final void a(ETEngine paramETEngine, Bitmap paramBitmap, ETDecoration paramETDecoration, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_b_of_type_Int > 0) && (this.jdField_c_of_type_Int > 0))
      {
        ...
        paramETDecoration = this.jdField_a_of_type_ArrayOfFl;
        ...
        for (;;)
        {
          ...
          ((fl)localObject1).a(paramETEngine, paramBitmap, null, j, k);
          k += ((fl)localObject1).a();
          if (k >= n) {
            break;
          }
    ...
    for (;;)
    {
      ...
      {
        j = 0;
        localObject1 = this.jdField_a_of_type_ArrayOfFl;
  ...
  public boolean a(ETEngine paramETEngine, int paramInt1, CharSequence paramCharSequence, ETFont paramETFont, int paramInt2, boolean paramBoolean, int paramInt3)
  {
    ...
    if (paramInt2 < j)
    {
      int i = this.jdField_a_of_type_ArrayOfFl[paramInt2].b();
      k = this.jdField_a_of_type_ArrayOfFl[paramInt2].a();
      if (i <= paramInt1) {
        break label254;
      }
      paramInt1 = i;
  ...
  public ETSegment[] a(ETEngine paramETEngine)
  {
    ...
    if (k < n)
    {
      ...
      {
        localff = (ff)((Iterator)localObject1).next();
        if (localff == null) {
          return null;
        }
        ...
        i2 = localff.d();
        int i3 = localfl.e();
        int i4 = localff.a(paramETEngine);
        localETSegment.x = m;
    ...
    for (;;)
    {
      ...
      if (i1 > -1)
      {
        ...
        localETSegment.y = (i1 - i2 + j);
        localObject2 = localff.a();
        if ((localObject2 instanceof avdg))
        {
          localObject2 = (avdg)localObject2;
          ((avdg)localObject2).jdField_a_of_type_Float = m;
          ((avdg)localObject2).b = localETSegment.y;
        }
      }
      localETSegment.textSize = localff.a();
      localETSegment.lineNum = localff.e();
  ...
  public void b(Canvas paramCanvas, int paramInt1, int paramInt2)
  {
    ...
    {
      localObject1 = (avdg)this.jdField_b_of_type_JavaUtilArrayList.get(this.d);
      ...
      i = ((avdg)localObject1).b();
      k = (int)((avdg)localObject1).b;
      ((avdg)localObject1).jdField_a_of_type_Boolean = false;
      ((avdg)localObject1).draw(paramCanvas, null, 0, 0, ((avdg)localObject1).jdField_a_of_type_Float, (int)((avdg)localObject1).b, 0, i + k, this.jdField_a_of_type_AndroidGraphicsPaint);
    }
    if (this.jdField_a_of_type_ArrayOfFl == null) {}
    for (;;)
    {
