  ...
  implements BusinessObserver
{
  ...
  private amgl jdField_a_of_type_Amgl = new amgl();
  private FrameLayout jdField_a_of_type_AndroidWidgetFrameLayout;
  private bhuf jdField_a_of_type_Bhuf = new bhuf();
  ...
  private void a(int paramInt)
  {
    try
    {
      bcst.b(null, "P_CliOper", "Safe_Antiphishing", "", "AlertDialog", "UserChoose", 0, paramInt, "", "", "", "");
      return;
    }
  ...
  private boolean a(Context paramContext, String paramString, int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_AndroidWidgetFrameLayout == null) && (this.mRuntime != null) && (this.mRuntime.a() != null)) {
      this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)this.mRuntime.a().findViewById(2131362699));
    }
    if ((this.jdField_a_of_type_Bhuf != null) && (this.jdField_a_of_type_AndroidWidgetFrameLayout != null))
    {
      this.jdField_a_of_type_Bhuf.a(2131718624, 3000, this.jdField_a_of_type_AndroidWidgetFrameLayout);
  ...
  private boolean a(String paramString)
  {
    ...
    try
    {
      ...
      if (QLog.isColorLevel()) {
        a(this.jdField_a_of_type_JavaLangString, 2, " Is QQ Domain, input url  : " + nmj.b(paramString, new String[0]) + " Domain = " + str1);
      }
      if ((str1.endsWith("qq.com")) || (str1.endsWith("tencent.com")) || (str1.endsWith("imqq.com")) || (str1.endsWith("wanggou.com")) || (str1.endsWith("paipai.com")) || (str1.endsWith("tenpay.com")) || (str1.endsWith("yixun.com")) || (str1.endsWith("weiyun.com")) || (str1.endsWith("soso.com")) || (str1.endsWith("myapp.com")) || (str1.endsWith("wechat.com")) || (str1.endsWith("gaopeng.com")) || (str1.endsWith("pengyou.com")) || (str1.endsWith("51buy.com")) || (str1.endsWith("weishi.com")) || (str1.endsWith("qqumall.com")) || (str1.endsWith("vip.surex.cn")))
      {
        ...
        if (!a())
        {
          ...
          if (!bool1)
          {
            ...
            {
              ArrayList localArrayList = this.jdField_a_of_type_Amgl.a();
              bool2 = bool1;
  ...
  private boolean a(String paramString, amgk paramamgk)
  {
    if (paramString == null) {
      return false;
    }
    ...
    for (int i = 1;; i = 0)
    {
      ...
      do
      {
        ...
        {
          paramamgk.jdField_a_of_type_JavaLangString = ((String)localObject);
          paramamgk.jdField_a_of_type_Int = 1;
          return true;
        }
      } while ((i != 1) || (!str.contains((CharSequence)localObject)));
      paramamgk.jdField_a_of_type_JavaLangString = ((String)localObject);
      paramamgk.jdField_a_of_type_Int = 2;
      return true;
    }
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, String paramString, Long paramLong, int paramInt5)
  {
    ...
    for (;;)
    {
      ...
      {
        paramLong = new NewIntent(this.mRuntime.a().getApplicationContext(), niq.class);
  ...
  public void a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    label121:
    for (Object localObject2 = null;; localObject2 = new amgj(this))
    {
      bglp.a(localActivity, 230, paramString1, paramString2, paramString3, paramString4, (DialogInterface.OnClickListener)localObject1, (DialogInterface.OnClickListener)localObject2).show();
      return;
      localObject1 = new amgi(this);
      break;
    }
  }
  ...
  public boolean a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    do
    {
      ...
      localamgk = new amgk(this);
      if (a(paramString1, localamgk)) {
        break;
      }
    ...
    try
    {
      long l = Long.parseLong(localamgk.jdField_a_of_type_JavaLangString);
      ...
      a(i, j, k, (int)f, paramString2, Long.valueOf(l), localamgk.jdField_a_of_type_Int);
      return true;
    }
  ...
  {
    amgl localamgl = this.jdField_a_of_type_Amgl;
    String str = a();
    ...
    {
      localamgl.a(str, (Context)localObject);
      return;
    }
  }
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      str = localContext.getString(2131717657);
      localObject1 = localContext.getString(2131717656);
      localObject3 = localContext.getString(2131717655);
      localObject2 = localContext.getString(2131717654);
    ...
    for (;;)
    {
      try
      {
        ...
        if (i == 2)
        {
          ...
          this.jdField_a_of_type_Amgl.a(paramInt, paramBundle, (String)localObject1, localContext);
          return;
        }
      }
