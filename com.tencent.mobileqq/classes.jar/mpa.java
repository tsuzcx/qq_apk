  ...
  extends moz
{
  ...
  Handler jdField_a_of_type_AndroidOsHandler = new mpb(this.jdField_a_of_type_JavaLangString, this);
  ...
  public mpa(Context paramContext, WeakReference<ZimuView> paramWeakReference, int paramInt1, int paramInt2, float paramFloat)
  {
    super(paramContext, paramWeakReference, paramInt1, paramInt2, paramFloat);
    this.m = ((int)paramContext.getResources().getDimension(2131297718));
  ...
  private void a(Canvas paramCanvas, int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsPaint.setColor(this.jdField_a_of_type_Moy.b);
    this.jdField_a_of_type_AndroidGraphicsPaint.setStrokeWidth(this.jdField_a_of_type_Moy.jdField_a_of_type_Float);
    float f = -this.jdField_a_of_type_AndroidGraphicsPaint.getFontMetrics().ascent;
    paramCanvas.drawText((String)this.jdField_a_of_type_Lgo.a, paramInt, f, this.jdField_a_of_type_AndroidGraphicsPaint);
    this.jdField_a_of_type_AndroidGraphicsPaint.setStyle(Paint.Style.FILL_AND_STROKE);
    this.jdField_a_of_type_AndroidGraphicsPaint.setColor(this.jdField_a_of_type_Moy.jdField_a_of_type_Int);
  ...
  private void d(Canvas paramCanvas, int paramInt1, int paramInt2)
  {
    ...
    this.jdField_c_of_type_AndroidGraphicsPaint.setColor(this.jdField_b_of_type_Moy.b);
    this.jdField_c_of_type_AndroidGraphicsPaint.setStrokeWidth(this.jdField_b_of_type_Moy.jdField_a_of_type_Float);
    ...
    paramCanvas.drawText((String)this.jdField_a_of_type_Lgo.b, paramInt1, f, this.jdField_c_of_type_AndroidGraphicsPaint);
    this.jdField_c_of_type_AndroidGraphicsPaint.setStyle(Paint.Style.FILL_AND_STROKE);
    this.jdField_c_of_type_AndroidGraphicsPaint.setColor(this.jdField_b_of_type_Moy.jdField_a_of_type_Int);
  ...
  protected void a(Canvas paramCanvas, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      lbd.f(this.jdField_a_of_type_JavaLangString, "onDraw film:|" + (l2 - l1));
      return;
      i1 = 0;
      break;
      label76:
  ...
  {
    super.a(paramlgo);
    if (this.jdField_a_of_type_Lgo != null) {}
    for (paramlgo = this.jdField_a_of_type_Lgo.b;; paramlgo = null)
    {
      paramlgo = (String)paramlgo;
      this.j = a(this.jdField_c_of_type_AndroidGraphicsPaint, paramlgo);
      int i1 = c();
      this.e = ((this.g - i1) / 2);
      if ((this.jdField_a_of_type_Lgo != null) && (this.jdField_a_of_type_Lgo.a()))
      {
        paramlgo = this.jdField_a_of_type_AndroidOsHandler.obtainMessage(0);
        this.jdField_a_of_type_AndroidOsHandler.sendMessageDelayed(paramlgo, 2000L);
      }
      return;
    }
  }
  ...
  public void b(Typeface paramTypeface, int paramInt, moy parammoy)
  {
    if (paramTypeface != null) {
      this.jdField_c_of_type_AndroidGraphicsPaint.setTypeface(paramTypeface);
    }
    this.jdField_b_of_type_Moy = parammoy;
    this.jdField_c_of_type_AndroidGraphicsPaint.setTextSize(paramInt);
    if (this.jdField_a_of_type_Lgo != null) {}
    for (paramTypeface = this.jdField_a_of_type_Lgo.b;; paramTypeface = null)
    {
  ...
  public int d()
  {
    return (int)this.jdField_a_of_type_AndroidContentContext.getResources().getDimension(2131297716);
  }
  
  Bitmap d()
  {
    if ((this.jdField_a_of_type_Lgo == null) || (TextUtils.isEmpty(this.jdField_a_of_type_Lgo.b))) {
      return null;
    }
    try
    {
  ...
  int g()
  {
    ...
    label48:
    for (Object localObject = this.jdField_a_of_type_Lgo.b;; localObject = null)
    {
