...
public class axoa
{
  ...
  public axoa(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Axoe = new axoe();
  ...
  protected View a()
  {
    ...
    this.jdField_a_of_type_Axoe.a((RelativeLayout)localView.findViewById(2131362143));
    ...
    for (int j = 0;; j = 1)
    {
      ...
      for (int k = 0;; k = 1)
      {
        ...
        for (;;)
        {
          ...
          ((GridView)localObject4).setAdapter(new axoc(this.jdField_a_of_type_AndroidContentContext, (List)localObject1));
          ...
          for (;;)
          {
            ...
            ((GridView)localObject1).setNumColumns(i);
            ((GridView)localObject1).setAdapter(new axoc(this.jdField_a_of_type_AndroidContentContext, (List)localObject2));
            ...
            ((TextView)localObject1).setOnClickListener(new axob(this));
            if (j == 0) {
