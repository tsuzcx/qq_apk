...
public class bjtz
{
  ...
  static
  {
    jdField_a_of_type_JavaUtilComparator = new bjub();
    jdField_b_of_type_JavaUtilComparator = new bjua();
  ...
  {
    return bhml.a(a(paramString));
  }
  
  public static String a(byte[] paramArrayOfByte)
  {
    return bhml.a(a(paramArrayOfByte));
  }
  ...
  public static String b(String paramString)
  {
    try
    {
      paramString = bhml.a(a(paramString.getBytes("UTF-8")));
      return paramString;
    }
  ...
  public static String d(String paramString)
  {
    ...
    paramString = new bjtz().b(paramString);
