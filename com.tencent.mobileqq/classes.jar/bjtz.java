  ...
  implements loa
{
  ...
  public bjtz(Context paramContext, long paramLong, bjtt parambjtt)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Long = paramLong;
    this.jdField_a_of_type_Bjtt = parambjtt;
    this.jdField_a_of_type_Bjtu = new bjtu(paramContext, parambjtt);
    a();
    a();
  }
  ...
  private void a()
  {
    bjuc.c("MultiOperatorBase", "initGAudioCtrl");
    try
    {
      if (this.jdField_a_of_type_ComTencentAvGaudioQQGAudioCtrl == null)
      {
        ...
        if (this.jdField_a_of_type_ComTencentAvGaudioQQGAudioCtrl != null)
        {
          ...
          this.jdField_a_of_type_ComTencentAvGaudioQQGAudioCtrl.setNetChannel(this.jdField_a_of_type_Bjtu);
          ...
          this.jdField_a_of_type_ComTencentAvGaudioQQGAudioCtrl.init(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Long, 1, "8.4.10", new llm().a());
          ClientLogReport.instance().init(this.jdField_a_of_type_AndroidContentContext, AppSetting.a());
          GAClientLogReport.instance();
          return;
        }
        bjuc.a("MultiOperatorBase", "initGAudioCtrl create instance fail.");
        return;
      }
    }
    catch (Exception localException)
    {
      bjuc.a("MultiOperatorBase", "initGAudioCtrl  fail.", localException);
  ...
  private boolean a()
  {
    bjuc.c("MultiOperatorBase", "loadLibrary");
    try
    {
    ...
    {
      bjuc.a("MultiOperatorBase", "loadLibrary fail.", localThrowable);
    }
    return false;
  }
  ...
  private void b()
  {
    bjuc.c("MultiOperatorBase", "unInitGAudioCtrl");
    try
    {
      if (this.jdField_a_of_type_ComTencentAvGaudioQQGAudioCtrl != null)
      {
    ...
    {
      bjuc.a("MultiOperatorBase", "unInitGAudioCtrl  fail.", localException);
    }
  }
