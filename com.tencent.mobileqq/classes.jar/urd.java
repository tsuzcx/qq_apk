...
{
  public urd(PlusPanel paramPlusPanel, Context paramContext, String paramString1, long paramLong, String paramString2) {}
  ...
  public void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    ...
    boolean bool = ((FormSwitchItem)((QQCustomDialog)localObject1).findViewById(2131364109)).a().isChecked();
    if (bool) {}
    ...
    localObject2 = (FormEditItem)((QQCustomDialog)localObject1).findViewById(2131364110);
    ...
    for (;;)
    {
      ...
      catch (NumberFormatException paramDialogInterface)
      {
        ...
        QQToast.a(this.jdField_a_of_type_AndroidContentContext, 2131432299, 0).a();
        return;
      }
