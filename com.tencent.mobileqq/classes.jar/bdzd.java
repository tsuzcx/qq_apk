    ...
    if (paramURLDrawableHandler.startsWith(File.separator))
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          localObject3 = (bdpu)((QQAppInterface)BaseApplicationImpl.sApplication.getAppRuntime((String)localObject1)).getManager(185);
          localObject1 = paramOutputStream;
          ResData localResData;
          if (((bdpu)localObject3).a != null)
          {
            ...
            paramDownloadParams = ((bdpu)localObject3).a;
            if (i == 0) {
              break label728;
            }
          }
          ...
          for (i = 4;; i = 8)
          {
            ...
            {
              return localObject1;
              paramOutputStream = new File(bkdi.a((File)localObject1));
            ...
            paramOutputStream = new bhhf(paramURLDrawableHandler, (File)localObject1);
            paramOutputStream.k = bool;
            if (bhhh.a(paramOutputStream, BaseApplicationImpl.sApplication.getRuntime()) == 0)
            {
              ...
              for (;;)
              {
                ...
                paramOutputStream = bkdi.a((File)localObject1);
                break label498;
                i = 0;
              }
            }
            paramOutputStream = new File(anhk.ba);
