...
public class awdu
{
  ...
  {
    return awlw.a(VideoEnvironment.a()) + "final_ptu_res_file" + File.separator;
  }
  ...
  private static ArrayList<String> a(File paramFile)
  {
    ...
    //   2: aconst_null
    //   3: astore_1
    //   4: new 111	java/util/ArrayList
    //   7: dup
    //   8: iconst_1
    //   9: invokespecial 114	java/util/ArrayList:<init>	(I)V
    //   12: astore 4
    //   14: new 116	java/io/FileReader
    //   17: dup
    //   18: aload_0
    //   19: invokespecial 119	java/io/FileReader:<init>	(Ljava/io/File;)V
    //   22: astore_0
    //   23: new 121	java/io/BufferedReader
    //   26: dup
    //   27: aload_0
    //   28: invokespecial 124	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   31: astore_2
    //   32: aload_2
    //   33: invokevirtual 127	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   36: astore_1
    //   37: aload_1
    //   38: ifnull +18 -> 56
    //   41: aload 4
    //   43: aload_1
    //   44: invokevirtual 131	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   47: pop
    //   48: aload_2
    //   49: invokevirtual 127	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   52: astore_1
    //   53: goto -16 -> 37
    //   56: aload_2
    //   57: ifnull +7 -> 64
    ...
    //   65: ifnull +7 -> 72
    //   68: aload_0
    //   69: invokevirtual 135	java/io/FileReader:close	()V
    //   72: aload 4
    //   74: areturn
    //   75: astore_1
    //   76: aload_1
    ...
    //   83: astore_0
    //   84: aload_0
    //   85: invokevirtual 138	java/io/IOException:printStackTrace	()V
    //   88: aload 4
    //   90: areturn
    //   91: astore_0
    //   92: aconst_null
    ...
    //   107: ifnull +7 -> 114
    //   110: aload_2
    //   111: invokevirtual 134	java/io/BufferedReader:close	()V
    //   114: aload_1
    //   115: ifnull -43 -> 72
    //   118: aload_1
    //   119: invokevirtual 135	java/io/FileReader:close	()V
    //   122: aload 4
    //   124: areturn
    //   125: astore_0
    //   126: aload_0
    ...
    //   133: astore_0
    //   134: aload_0
    //   135: invokevirtual 138	java/io/IOException:printStackTrace	()V
    //   138: goto -24 -> 114
    //   141: astore_0
    //   142: aconst_null
    //   143: astore_3
    ...
    //   149: ifnull +7 -> 156
    //   152: aload_2
    //   153: invokevirtual 134	java/io/BufferedReader:close	()V
    //   156: aload_1
    //   157: ifnull +7 -> 164
    //   160: aload_1
    //   161: invokevirtual 135	java/io/FileReader:close	()V
    //   164: aload_0
    //   165: athrow
    //   166: astore_2
    //   167: aload_2
    //   168: invokevirtual 138	java/io/IOException:printStackTrace	()V
    //   171: goto -15 -> 156
    //   174: astore_1
    //   175: aload_1
    //   176: invokevirtual 138	java/io/IOException:printStackTrace	()V
    //   179: goto -15 -> 164
    //   182: astore_3
    //   183: aconst_null
    //   184: astore_2
  ...
  public static void a()
  {
    ...
    bace.d(str1 + "libartfilter.so");
    bace.d(str1 + "262_8_model");
    bace.d(str1 + "262_8_md04_reshape");
    str1 = str1 + "bakcup/";
    if (bace.a(str1))
    {
      arrayOfString = b;
  ...
  public static boolean a(String paramString)
  {
    ...
    {
      return bool;
      i = bace.a(paramString, a(VideoEnvironment.a()), false, true, QLog.isColorLevel());
  ...
  static boolean b(String paramString1, String paramString2)
  {
    ...
    if (i < paramString2.size())
    {
      ...
      do
      {
        ...
        localObject = awfl.a(str);
        j = ((awfm)localObject).a('|');
        if (j != 0) {
          break label407;
        }
        str = paramString1 + ((awfm)localObject).c();
        File localFile = new File(str);
        if (!localFile.exists())
        {
        ...
        j = Integer.parseInt(((awfm)localObject).d());
        l = localFile.length();
      } while (j == l);
