...
public class arvo
{
  ...
  private static NativeMonitorConfig a(SharedPreferences paramSharedPreferences, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramSharedPreferences)) {
      try
      {
        ...
        return (NativeMonitorConfig)avyx.a(paramSharedPreferences, NativeMonitorConfig.class);
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, ConfigurationService.Config paramConfig)
  {
    ...
    int i = bhhr.aG(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount());
    int k = bhhr.aH(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount());
    int m = AppSetting.a();
    if (QLog.isColorLevel()) {
    ...
    if (k != m)
    {
      bhhr.Y(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), m);
      i = 0;
    }
    String str;
    if (j != i)
    {
      str = arph.b(paramConfig, i, paramInt);
    ...
    for (;;)
    {
      try
      {
        ...
        paramConfig = (NativeMonitorConfig)avyx.a(paramConfig, NativeMonitorConfig.class);
        if (paramConfig == null)
        {
          a(new NativeMonitorConfig());
          bhhr.e(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), j, "");
          bhhr.s(paramQQAppInterface.getApp(), 0);
      ...
      catch (JSONException paramConfig)
      {
        ...
        a(paramConfig);
        bhhr.e(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), j, str);
        bhhr.s(paramQQAppInterface.getApp(), paramConfig.soHook);
        continue;
      }
      a(new NativeMonitorConfig());
      bhhr.e(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), j, "");
  ...
  public static void b()
  {
    ...
    //   59: new 433	arvp
    //   62: dup
    //   63: invokespecial 434	arvp:<init>	()V
