...
public class birw
{
  private static birw jdField_a_of_type_Birw;
  public static final Object a;
  public int a;
  final birn jdField_a_of_type_Birn = new birn(new birx(this));
  public boolean a;
  public int b = 0;
  ...
  public static birw a()
  {
    if (jdField_a_of_type_Birw == null) {}
    try
    {
      if (jdField_a_of_type_Birw == null) {
        jdField_a_of_type_Birw = new birw();
      }
      return jdField_a_of_type_Birw;
    }
    finally {}
  }
  ...
  public int a(Bundle paramBundle)
  {
    ...
    for (boolean bool = BaseApplicationImpl.sApplication.getSharedPreferences("sp_x5_config_" + (String)localObject, 4).getBoolean("key_x5_init_sub_thread", true);; bool = true)
    {
      ...
      biry.b();
      biqx.X = System.currentTimeMillis() - l;
      QLog.i("WebLog_SwiftWebAccelerator", 1, "initX5Environment on main thread, cost " + biqx.X + "ms.");
      return 1;
    }
  }
  ...
  public void a(Bundle paramBundle)
  {
    if (Looper.getMainLooper() == Looper.myLooper())
    {
      if (!this.jdField_a_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_Birn.b();
        this.jdField_a_of_type_Birn.a(localBundle);
  ...
  public int b(Bundle paramBundle)
  {
    ...
    biqx.Y = System.currentTimeMillis() - l;
    QLog.i("WebLog_SwiftWebAccelerator", 1, "doMainStep_CreateWebView:create webview cost " + biqx.Y + "ms.");
    return 1;
  }
  ...
  public int c(Bundle paramBundle)
  {
    ...
    biqx.Z = System.currentTimeMillis() - l;
    QLog.i("WebLog_SwiftWebAccelerator", 1, "tendocpreload doMainStep_WarnUpWebView:load " + paramBundle + ", cost " + biqx.Z + "ms.");
    return 1;
  }
  ...
  public int e(Bundle paramBundle)
  {
    ...
    if (WebAccelerateHelper.preloadBrowserView == null)
    {
      ...
      biqx.aa = System.currentTimeMillis() - l;
      QLog.i("WebLog_SwiftWebAccelerator", 1, "doMainStep_CreateBrowserView, cost = " + biqx.aa + "ms.");
      return 1;
    }
    return 0;
  }
