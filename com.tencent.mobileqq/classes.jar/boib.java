  ...
  extends ReportDialog
{
  ...
  private boif jdField_a_of_type_Boif;
  ...
  public boib(@NonNull Context paramContext, int paramInt, boif paramboif)
  {
    super(paramContext, paramInt);
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(paramContext).inflate(2131558560, null);
    this.jdField_a_of_type_Boif = paramboif;
    f();
  ...
  private void b()
  {
    this.jdField_a_of_type_JavaLangString = getContext().getResources().getString(2131693468);
    this.jdField_b_of_type_JavaLangString = getContext().getResources().getString(2131691299);
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131369081);
    this.c = this.jdField_a_of_type_AndroidViewView.findViewById(2131379663);
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)this.jdField_a_of_type_AndroidViewView.findViewById(2131366091));
    this.jdField_a_of_type_OrgLibpagPAGView = ((PAGView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378305));
    this.jdField_a_of_type_OrgLibpagPAGView.play();
    this.jdField_a_of_type_OrgLibpagPAGView.setRepeatCount(0);
    this.jdField_b_of_type_AndroidViewView.setOnClickListener(new boic(this));
    this.c.setOnClickListener(new boid(this));
    e();
  ...
  private void b(TextEditorData paramTextEditorData)
  {
    if (paramTextEditorData == null)
    {
      bnzb.d("AEEditorTextEditDialog", "render PAV data null.");
      return;
    }
    ...
    {
      bnzb.d("AEEditorTextEditDialog", "render PAGFile null.");
      return;
    }
    PAGText localPAGText = localPAGFile.getTextData(0);
    if (localPAGText == null)
    {
      bnzb.d("AEEditorTextEditDialog", "pagText is null.");
      return;
    }
  ...
  private static void b(Map<String, Integer> paramMap, PAGView paramPAGView)
  {
    ...
    if (paramPAGView != null)
    {
      ...
      if (localPAGComposition == null) {
        bnzb.d("AEEditorTextEditDialog", "pagComposition null.");
      }
    }
    else
    {
  ...
  private void c()
  {
    if (this.jdField_a_of_type_ComTencentTavcutBeanTextEditorData == null)
    {
      bnzb.d("AEEditorTextEditDialog", "originTextData is null.");
      return;
    }
  ...
  private void d()
  {
    ...
    while (this.jdField_a_of_type_Boif == null) {
      return;
    }
    this.jdField_a_of_type_Boif.a(this.jdField_a_of_type_ComTencentTavcutBeanTextEditorData);
  }
  
  private void e()
  {
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new boie(this));
  }
