  ...
  implements BusinessObserver
{
  ...
  public bapq(TroopMoreDetailView paramTroopMoreDetailView)
  {
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      localStringBuffer = new StringBuffer(localTroopMoreDetailView.getResources().getString(2131720525));
    ...
    paramBundle = localView.findViewById(2131377839);
    ...
    if (i < ((List)localObject2).size())
    {
      ...
      case 0: 
        ...
        localRoundProgressBar = (RoundProgressBar)paramBundle.findViewById(2131375527);
    ...
    for (Object localObject1 = "#FF1F1F1F";; localObject1 = "#FFDDDDDD")
    {
      ...
      localRoundProgressBar.setRoundWidth(actn.a(2.0F, localTroopMoreDetailView.getResources()));
      ...
      i += 1;
      break;
      localObject1 = localView.findViewById(2131377839);
      if (paramBoolean)
      {
        ...
        break label300;
        localObject1 = localView.findViewById(2131377840);
        if (!paramBoolean) {
          break label605;
        }
        ...
        paramBundle = (Bundle)localObject1;
        break label300;
        localObject1 = localView.findViewById(2131377841);
        if (!paramBoolean) {
          break label611;
        }
        ...
        paramBundle = (Bundle)localObject1;
        break label300;
        localObject1 = localView.findViewById(2131377842);
        if (!paramBoolean) {
          break label618;
        }
      }
