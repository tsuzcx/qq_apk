  ...
  extends BaseChatPie
{
  ...
  private ahkq jdField_a_of_type_Ahkq;
  ...
  private XListView.DrawFinishedListener jdField_a_of_type_ComTencentWidgetXListView$DrawFinishedListener = new ahkh(this);
  ...
  private BusinessObserver jdField_a_of_type_MqqObserverBusinessObserver = new ahjm(this);
  public ocw a;
  public ofj a;
  ogc jdField_a_of_type_Ogc = new ahkd(this);
  ...
  private anxp jdField_b_of_type_Anxp;
  ...
  public ahiu(QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, FragmentActivity paramFragmentActivity, Context paramContext)
  {
    ...
    this.jdField_e_of_type_Int = 2130837994;
    this.jdField_f_of_type_Int = 2130837993;
    this.jdField_q_of_type_Int = -1;
    this.jdField_a_of_type_Aufo = new aufo("web_public_account", "com.tencent.mobileqq:tool");
    this.jdField_a_of_type_AndroidOsHandler = new ahiv(this);
    this.jdField_a_of_type_Amwl = new ahiw(this);
    this.jdField_a_of_type_Amyh = new ahkc(this);
    this.jdField_a_of_type_Binf = new ahki(this);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new ahkm(this);
  }
  
  private void A()
  {
    PublicAccountInfo localPublicAccountInfo = ((amxz)this.app.getManager(56)).b(this.sessionInfo.curFriendUin);
    if ((localPublicAccountInfo != null) && (ugf.a(localPublicAccountInfo.accountFlag) == -2))
    {
      this.H = true;
      e();
      this.jdField_a_of_type_Beaj.f();
      if (this.jdField_a_of_type_Beaj.jdField_b_of_type_Int <= 0)
      {
        this.jdField_a_of_type_Beaj.a(Long.valueOf(this.sessionInfo.curFriendUin).longValue(), 1);
        return;
      }
      int i2 = ((bfas)this.app.getManager(132)).a(this.sessionInfo.curFriendUin);
      if (i2 == -1)
      {
        this.jdField_a_of_type_Beaj.a(Long.valueOf(this.sessionInfo.curFriendUin).longValue(), 2);
        return;
      }
      int i1;
      if ((i2 & 0xF) == 0)
  ...
  private void B()
  {
    if ((NetworkUtil.getNetworkType(this.mActivity.getApplicationContext()) == 1) && (this.sessionInfo.curFriendUin != null) && (this.sessionInfo.curFriendUin.equals("2632129500"))) {
      nny.b("108", this.app, true, new ahkk(this));
    }
  }
  ...
  private void C()
  {
    ...
    {
      bkew localbkew = (bkew)this.app.getManager(142);
      if (localbkew != null) {
        bket.a(localbkew.a(5));
      }
      if (QLog.isColorLevel()) {
        QLog.d(this.tag, 2, "the public account is boodo comic");
      }
      akfp.a().a("com.tencent.qqcomic.care");
      akfp.a().a("com.tencent.carecomic.normal");
      akfp.a().a("com.tencent.carecomic.update");
    }
  }
  
  private void D()
  {
    if (ugf.a(this.sessionInfo.curFriendUin))
    {
  ...
  private void E()
  {
    if (this.jdField_h_of_type_Boolean) {
      if (this.jdField_i_of_type_Boolean) {
        odq.a(this.app, "P_CliOper", "Pb_account_lifeservice", "", "0X8005A22", "0X8005A22", 0, 0, this.sessionInfo.curFriendUin, "new", "", "", false);
      }
    }
    for (;;)
    {
      ple.a().a(this.sessionInfo.curFriendUin);
      if (((amxz)this.app.getManager(56)).a(this.sessionInfo.curFriendUin)) {
        this.jdField_d_of_type_Boolean = true;
      }
      return;
      odq.a(this.app, "P_CliOper", "Pb_account_lifeservice", "", "0X8005A22", "0X8005A22", 0, 0, this.sessionInfo.curFriendUin, "old", "", "", false);
      continue;
      odq.a(this.app, "P_CliOper", "Pb_account_lifeservice", "", "0X8005A22", "0X8005A22", 0, 0, this.sessionInfo.curFriendUin, "", "", "", false);
      if ("2290230341".equals(this.sessionInfo.curFriendUin))
      {
        bcef.b(this.app, "CliOper", "", "", "0X80090E2", "0X80090E2", 0, 0, "", "", "", "");
        bcec.a(2);
      }
    }
  }
  ...
  private void G()
  {
    if (agjp.a(this.sessionInfo.curFriendUin)) {
      algh.a().a(this.app, "aio_page_arrive");
    }
  }
  ...
  private void L()
  {
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.mActivity.getBaseContext()).inflate(2131558635, this.mContent, false);
    if (this.jdField_a_of_type_AndroidViewView == null) {
      return;
    }
    this.jdField_a_of_type_AndroidViewView.setClickable(true);
    this.jdField_a_of_type_AndroidViewView.findViewById(2131368236).setOnClickListener(new ahjc(this));
    if (this.jdField_a_of_type_Int == 2)
    {
      this.jdField_a_of_type_AndroidViewView.findViewById(2131373106).setVisibility(8);
      this.jdField_a_of_type_AndroidViewView.findViewById(2131373092).setVisibility(8);
    }
    for (;;)
    {
  ...
  private void M()
  {
    this.jdField_a_of_type_ComTencentMobileqqWidgetPublicMenuBar = ((PublicMenuBar)this.jdField_a_of_type_AndroidViewView.findViewById(2131373089));
    this.jdField_a_of_type_ComTencentMobileqqWidgetPublicMenuBar.setOnMenuItemClickListener(new ahje(this));
    ...
    if (!this.v)
    {
      ...
      {
        i1 = 2131691689;
        localObject = new zvc("DO_NOT_FOLLOW", ((FragmentActivity)localObject).getString(i1), getActivity().getResources().getDrawable(2130841768), 0);
        localzvc1 = new zvc("DO_FOLLOW", this.mActivity.getString(2131691687), getActivity().getResources().getDrawable(2130841661), 1);
        this.jdField_a_of_type_ComTencentMobileqqWidgetPublicMenuBar.a((zvc)localObject, 2131559991);
        this.jdField_a_of_type_ComTencentMobileqqWidgetPublicMenuBar.a(localzvc1, 2131559991);
      }
    }
    for (;;)
    {
      ...
      i1 = 2131691688;
      break;
      localObject = new zvc("DO_CANCEL", this.mActivity.getString(2131690622), getActivity().getResources().getDrawable(2130841768), 0);
      localzvc1 = new zvc("DO_FOLLOW", this.mActivity.getString(2131691687), getActivity().getResources().getDrawable(2130841661), 1);
      zvc localzvc2 = new zvc("DO_NOT_FOLLOW", this.mActivity.getString(2131691689), getActivity().getResources().getDrawable(2130841768), 0);
      this.jdField_d_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqWidgetPublicMenuBar.a((zvc)localObject, 2131559991);
      this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqWidgetPublicMenuBar.a(localzvc2, 2131559991);
      this.jdField_e_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqWidgetPublicMenuBar.a(localzvc1, 2131559991);
    }
    label338:
  ...
  private void N()
  {
    ...
    for (localObject = ((TicketManager)localObject).getSkey(str);; localObject = null)
    {
      ...
      new beze("https://buluo.qq.com/cgi-bin/bar/extra/clean_temp_follow_state", "", new ahjj(this), 1000, null).a(localHashMap);
      c();
      return;
    }
  }
  ...
  private void O()
  {
    this.jdField_a_of_type_ComTencentBizUiCustomMenuBar.setOnMenuItemClickListener(new ahjp(this));
  }
  
  private void P()
  {
    this.jdField_a_of_type_ComTencentBizUiCustomMenuBar.setOnBackClickListner(new ahjq(this));
  }
  ...
  private void Q()
  {
    ...
    if ((localPublicAccountInfo != null) && ((localPublicAccountInfo.accountFlag & 0x10000) != 0)) {
      this.jdField_a_of_type_Ocw.a(this.mActivity, this.app, this.sessionInfo.curFriendUin, "0x9e370001hd", false, 0.0D, 0.0D, null);
    }
  ...
  private void S()
  {
    bcef.b(this.app, "CliOper", "", "", "0X8004EFD", "0X8004EFD", 0, 0, "", "", "", "");
    bcef.b(this.app, "P_CliOper", "Pb_account_lifeservice", "", "0X8004F08", "0X8004F08", 0, 0, "", "", "", "");
    bfwu.a(null, "pubAcc_profile_display", "");
  }
  
  private void T()
  {
    if (this.K) {
      bcef.b(null, "dc00898", "", this.sessionInfo.curFriendUin, "auth_aio", "clk_return", 0, 0, "", "", this.sessionInfo.curFriendNick, "");
    }
  }
  ...
  private void U()
  {
    if (this.root.a() == 2)
    {
      ...
      if (this.jdField_c_of_type_AndroidWidgetImageView != null)
      {
        ...
        this.jdField_c_of_type_AndroidWidgetImageView.setContentDescription(this.app.getApp().getString(2131689945));
      }
    }
    do
    {
    ...
    this.jdField_c_of_type_AndroidWidgetImageView.setContentDescription(this.app.getApp().getString(2131689944));
  }
  ...
  private void V()
  {
    ...
    if (this.root.a() == 8)
    {
      if (this.jdField_b_of_type_AndroidWidgetImageView != null) {
        this.jdField_b_of_type_AndroidWidgetImageView.setContentDescription(this.app.getApplication().getString(2131689928));
      }
      localafqg.b(true);
      this.root.a(1);
      return;
    ...
    if (this.jdField_b_of_type_AndroidWidgetImageView != null) {
      this.jdField_b_of_type_AndroidWidgetImageView.setContentDescription(this.app.getApplication().getString(2131689852));
    }
    setInputStat(0);
  }
  ...
  private void X()
  {
    ...
    if ((this.input.getText().length() > 0) && (this.root.a() != 2) && (this.jdField_c_of_type_AndroidWidgetImageView != null) && (this.jdField_c_of_type_AndroidWidgetImageView.getVisibility() != 0))
    {
      ...
      if (agjp.a(this.sessionInfo.curFriendUin))
      {
        ...
        algh.a().a(this.app, "aio_search_push");
      }
    }
    if (QLog.isColorLevel())
    {
      ...
      odq.a(this.app, "P_CliOper", "Pb_account_lifeservice", "", "0X800584F", "0X800584F", 0, 0, "", "", "", "", false);
    }
    if (this.jdField_h_of_type_Boolean) {
      bcef.b(this.app, "P_CliOper", "Pb_account_lifeservice", this.sessionInfo.curFriendUin, "0X8005C9C", "0X8005C9C", 0, 1, 0, "", "", "", "");
    }
  }
  ...
  private void Y()
  {
    ...
    Object localObject = new NewIntent(this.mActivity.getApplicationContext(), odw.class);
    ...
    try
    {
      ...
      ((NewIntent)localObject).setObserver(new ahjr(this));
  ...
  private void Z()
  {
    ...
    if (localObject != null)
    {
      localObject = ((amxz)localObject).a(this.sessionInfo.curFriendUin);
      if (localObject != null)
      {
  ...
  private void a(Intent paramIntent)
  {
    try
    {
      if (oge.a(this.sessionInfo))
      {
        akfp.a().a("com.tencent.gouwu.video");
        akfp.a().a("com.tencent.gwh.video");
        ArkAppNotifyCenter.registVolumnReceiver();
        if (j())
        {
          if (ohk.b()) {
            akfp.a().a("com.tencent.qqshop");
          }
          b(paramIntent);
          return;
        }
        paramIntent = (oge)this.app.getBusinessHandler(139);
        if (paramIntent != null)
        {
  ...
  private void a(Message paramMessage)
  {
    ...
    {
      this.jdField_a_of_type_Beaj.jdField_a_of_type_JavaUtilMap.put(paramMessage.getString("troopUin"), Integer.valueOf(this.app.getConversationFacade().a(paramMessage.getString("troopUin"), 1)));
      this.jdField_a_of_type_Beaj.d();
      this.jdField_a_of_type_Beaj.e();
      this.jdField_a_of_type_Beaj.c();
    }
  }
  ...
  private void a(View paramView, int paramInt1, int paramInt2, Animator.AnimatorListener paramAnimatorListener)
  {
    ...
    localValueAnimator.addUpdateListener(new ahix(this, paramView, paramInt1, paramInt2));
  ...
  private void a(RelativeLayout paramRelativeLayout)
  {
    ...
    if (localSharedPreferences.getBoolean("firstIntoAIO", true))
    {
      ...
      localLinearLayout.setOnClickListener(new ahkb(this, paramRelativeLayout, localLinearLayout));
      ...
      ((TextView)localObject).setText(amtj.a(2131707909));
  ...
  private void a(MessageForArkApp paramMessageForArkApp)
  {
    try
    {
      ...
      if (paramMessageForArkApp != null)
      {
        ...
        if (!StringUtil.isEmpty(paramMessageForArkApp))
        {
          ...
          {
            paramMessageForArkApp.report_info.thirdparty_monitor_urls.api_click_monitor_url.set(ogr.a(localJSONObject.optJSONArray("api_click_monitor_url")));
            paramMessageForArkApp.report_info.thirdparty_monitor_urls.api_exposure_monitor_url.set(ogr.a(localJSONObject.optJSONArray("api_exposure_monitor_url")));
            paramMessageForArkApp.report_info.thirdparty_monitor_urls.sdk_click_monitor_url.set(ogr.a(localJSONObject.optJSONArray("sdk_click_monitor_url")));
            paramMessageForArkApp.report_info.thirdparty_monitor_urls.sdk_exposure_monitor_url.set(ogr.a(localJSONObject.optJSONArray("sdk_exposure_monitor_url")));
            abrs.a(1, 2, paramMessageForArkApp);
          }
        }
      }
      return;
  ...
  private void a(MessageForStructing paramMessageForStructing)
  {
    ...
    if ((paramMessageForStructing instanceof StructMsgForGeneralShare))
    {
      ...
      if ((paramMessageForStructing != null) && (!paramMessageForStructing.isEmpty()))
      {
        ...
        for (;;)
        {
          ...
          {
            Object localObject = (bcgw)paramMessageForStructing.next();
            ...
            if ((localThrowable instanceof bckt)) {
              paramMessageForStructing = (bckt)localThrowable;
            }
          }
        }
      }
    ...
    try
    {
      abrs.a(1, 2, ofx.a(paramMessageForStructing));
      return;
    }
      ...
      for (;;)
      {
        ...
        try
        {
          if ((!paramChatMessage.getExtInfoFromExtStr("pa_msgHasRead").equals("")) && (!paramChatMessage.getExtInfoFromExtStr("pa_msgHasRead").equals("true")))
          {
            ...
            odq.a(this.app, "P_CliOper", "Pb_account_lifeservice", this.sessionInfo.curFriendUin, "0X80057C4", "0X80057C4", 0, 0, this.sessionInfo.curFriendUin, String.valueOf(l1), paramList1, "", false);
          }
  ...
  private boolean a(Intent paramIntent, String paramString)
  {
    ...
    {
      ocw.a(this.mActivity, this.app, paramIntent.getStringExtra("starhomeurl"), paramIntent.getStringExtra("uin"), paramString);
      return true;
    }
    return false;
  }
  ...
  {
    boolean bool = false;
    paramView = (amsw)this.app.getManager(51);
    String str;
    if (uaw.e(this.app, this.sessionInfo.curFriendUin))
    {
      str = (String)ofx.jdField_a_of_type_JavaUtilHashMap.get(this.sessionInfo.curFriendUin);
    ...
    for (;;)
    {
      ...
      bcef.b(this.app, "CliOper", "", "", "Shop_customservice", "Clk_shopcustomservice", 0, 0, "", "", this.sessionInfo.curFriendUin, this.app.getCurrentAccountUin());
      return false;
      localIntent.putExtra("uintype", 1005);
      localIntent.putExtra("uinname", this.sessionInfo.curFriendNick + amtj.a(2131707890));
  ...
  public static boolean a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    if (localObject != null) {}
    for (localObject = ((amxz)localObject).b(paramString);; localObject = null)
    {
      if (localObject == null)
      {
  ...
  private boolean a(List<mobileqq_mp.ButtonInfo> paramList)
  {
    ...
    if (this.sessionInfo != null) {
      this.jdField_a_of_type_ComTencentBizUiCustomMenuBar.setMenuType(this.jdField_a_of_type_Ocw.b(getCurFriendUin()));
    }
  ...
  private boolean a(boolean paramBoolean, int paramInt)
  {
    if (paramInt == 0)
    {
      odq.a(this.app, "P_CliOper", "Pb_account_lifeservice", "", "0x8005750", "0x8005750", 0, 0, this.sessionInfo.curFriendUin, "", "", "", false);
      Object localObject = (amxz)this.app.getManager(56);
      if (localObject != null)
      {
        localObject = ((amxz)localObject).a(this.sessionInfo.curFriendUin);
  ...
  private void aa()
  {
    this.app.removeObserver(this.jdField_a_of_type_Anxp);
    this.jdField_a_of_type_Anxp = new anxp(new ahjx(this));
    this.app.addObserver(this.jdField_a_of_type_Anxp);
    anxu.a(this.app, true, this.sessionInfo.curFriendUin, 0);
  }
  ...
  private void ab()
  {
    ...
    this.jdField_c_of_type_MqqAppNewIntent = new NewIntent(this.mActivity.getApplicationContext(), odw.class);
  ...
  private void ac()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo == null)
    {
      ...
      if (localamxz != null) {
        this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo = localamxz.c(this.sessionInfo.curFriendUin);
      }
    }
  ...
  private void ad()
  {
    ...
    if (Build.VERSION.SDK_INT >= 23)
    {
      ...
      {
        this.mActivity.requestPermissions(new ahjz(this), 1, new String[] { "android.permission.ACCESS_FINE_LOCATION" });
        return;
      }
      ae();
      return;
  ...
  private void ae()
  {
    SosoInterface.startLocation(new ahka(this, 1, true, true, 0L, false, false, "PublicAccountChatPie"));
  }
  ...
  private void ag()
  {
    ...
    if (localObject != null)
    {
      localObject = ((amxz)localObject).b(this.sessionInfo.curFriendUin);
      if ((localObject != null) && (ugf.a(((PublicAccountInfo)localObject).accountFlag2) == -10L))
      {
        this.K = true;
  ...
  private void ah()
  {
    ...
    if (localPublicAccountInfo != null) {
      akmc.a(this.app, localPublicAccountInfo.uin + "", l1 - l2, localPublicAccountInfo.name + "");
    }
  ...
  private void ai()
  {
    ...
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new ahko(this);
  ...
  private void b(int paramInt1, int paramInt2)
  {
    if (((paramInt2 > 5) && (this.jdField_n_of_type_Boolean)) || ((paramInt1 == this.listView.getHeaderViewsCount()) && (paramInt2 > 0) && (this.jdField_n_of_type_Boolean) && (!this.jdField_e_of_type_Boolean)))
    {
      ...
      localTranslateAnimation.setAnimationListener(new ahjb(this));
  ...
  private void b(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if (((paramInt4 < -5) && (this.jdField_n_of_type_Boolean)) || (((this.jdField_f_of_type_Boolean) || ((paramInt1 + paramInt2 == paramInt3) && (paramInt4 < 0) && (this.jdField_n_of_type_Boolean))) && (!this.jdField_e_of_type_Boolean)))
    {
      ...
      localTranslateAnimation.setFillAfter(true);
      localTranslateAnimation.setDuration(250L);
      localTranslateAnimation.setAnimationListener(new ahja(this));
      this.jdField_a_of_type_AndroidViewView.startAnimation(localTranslateAnimation);
    }
  }
  ...
  private void b(Intent paramIntent)
  {
    try
    {
      ...
      if (this.B)
      {
        this.jdField_a_of_type_Ohf = new ohc();
        if (this.jdField_a_of_type_Ohf.a(this.mContext, this.mContent)) {
          H();
        }
      }
      else
      {
        this.jdField_a_of_type_Ohf = new ohe();
        if ((!this.C) && (this.jdField_a_of_type_Ohf.a(this.mContext, this.mContent)))
        {
          H();
  ...
  private void b(Message paramMessage)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = bfur.a(this.mContext, 230, null, String.format(amtj.a(2131707864), new Object[] { (String)paramMessage.obj }), amtj.a(2131707878), amtj.a(2131707874), new ahjd(this, i1), null);
  ...
  private void b(String paramString)
  {
    ...
    this.jdField_a_of_type_Bhht = new bhht(this.mContent.getContext(), this.mActivity.getTitleBarHeight());
    ...
    if ("DO_FOLLOW".equals(paramString)) {
      if (this.I)
      {
        ...
        {
          paramString = str1;
          if (this.jdField_a_of_type_Beaj.jdField_a_of_type_JavaUtilList != null)
          {
            paramString = str1;
            if (this.jdField_a_of_type_Beaj.jdField_a_of_type_JavaUtilList.size() > 0) {
              paramString = ((TroopInfo)this.jdField_a_of_type_Beaj.jdField_a_of_type_JavaUtilList.get(0)).troopuin;
            }
          }
        }
        bcef.b(this.app, "dc00899", "Grp_public", "", "oper", "Clk_close_temp", 0, 0, paramString, "" + str2, "", "");
        this.jdField_a_of_type_Ocw.a(this.mActivity, this.app, this.app.getAccount(), this.sessionInfo.curFriendUin, new ahjf(this));
      }
    }
    do
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg != null) {
        odq.a(this.app, "CliOper", "", str2, "0X8004EF5", "0X8004EF5", 0, 0, Long.toString(l1), "", "" + this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.msgId, this.jdField_j_of_type_JavaLangString, false);
      }
      a(2131694821);
      i();
      return;
      ...
      {
        if (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg != null) {
          odq.a(this.app, "CliOper", "", str2, "0X8004EF7", "0X8004EF7", 0, 0, Long.toString(l1), "", "" + this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.msgId, "" + this.jdField_j_of_type_JavaLangString, false);
        }
        if (this.I)
        {
          c(str2);
          ...
          bcef.b(this.app, "dc00899", "Grp_public", "", "oper", "Clk_focus_temp", 0, 0, paramString, "" + str2, "", "");
          return;
        }
        f();
        return;
    ...
    a(2131694821);
    this.jdField_b_of_type_MqqAppNewIntent = ocw.a().a(this.sessionInfo.curFriendUin, 0, false, BaseApplication.getContext(), this.app, new ahjg(this));
  }
  ...
  private boolean b(View paramView)
  {
    ...
    {
      bool1 = bool2;
      if (ofj.a.equals(paramView.getTag()))
      {
        bool1 = bool2;
    ...
    this.mContext.startActivity(localIntent);
    bcef.b(this.app, "P_CliOper", "Shop_lifeservice", "", "Shop_nearbyiconClk", "Clk_shopnearbyicon", 0, 0, "", "", "", "");
    return false;
  }
  ...
  private void c(AccountDetail paramAccountDetail)
  {
    ...
    Object localObject1 = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131380107);
    Object localObject2 = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131380106);
    ImageView localImageView = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368236);
    if (this.I) {
      if ((this.jdField_a_of_type_Beaj != null) && (this.jdField_a_of_type_Beaj.jdField_b_of_type_Int > 0) && (this.jdField_a_of_type_Beaj.jdField_a_of_type_JavaUtilList.size() > 0))
      {
        TroopInfo localTroopInfo = (TroopInfo)this.jdField_a_of_type_Beaj.jdField_a_of_type_JavaUtilList.get(0);
        ((TextView)localObject1).setText(localTroopInfo.troopname);
        ((TextView)localObject2).setText(String.format(this.mContext.getString(2131694755), new Object[] { paramAccountDetail.name }));
        localImageView.setImageDrawable(FaceDrawable.getFaceDrawable(this.app, 4, localTroopInfo.troopuin));
        localObject1 = "";
        if (this.jdField_a_of_type_Beaj.jdField_a_of_type_JavaUtilList.size() > 0) {
          localObject1 = ((TroopInfo)this.jdField_a_of_type_Beaj.jdField_a_of_type_JavaUtilList.get(0)).troopuin;
        }
        if (this.sessionInfo != null) {
          break label318;
        }
        localObject2 = "";
        bcef.b(this.app, "dc00899", "Grp_public", "", "oper", "exp_temp", 0, 0, (String)localObject1, "" + (String)localObject2, "", "");
      }
    }
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_Amsu = new ahjv(this, localImageView);
        this.mActivity.addObserver(this.jdField_a_of_type_Amsu);
      }
      localObject1 = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364353);
  ...
  private void c(String paramString)
  {
    ...
    if (localObject != null)
    {
      ...
      localObject = new NewIntent(BaseApplicationImpl.getContext(), odw.class);
      ...
      this.jdField_b_of_type_MqqObserverBusinessObserver = new ahjk(this, paramString);
    ...
    {
      this.t += 1;
      ugf.a(this.app, paramString);
      if (QLog.isColorLevel()) {
        QLog.d(this.tag, 2, "unfollow exit");
      }
      return;
      label191:
      this.app.removeObserver(this.jdField_b_of_type_Anxp);
      this.jdField_b_of_type_Anxp = new anxp(new ahjl(this, paramString));
      this.app.addObserver(this.jdField_b_of_type_Anxp);
      anxu.a(this.app, false, this.sessionInfo.curFriendUin, 0);
    }
  }
  
  private void c(List<mobileqq_mp.ButtonInfo> paramList)
  {
    this.jdField_a_of_type_MqqAppNewIntent = this.jdField_a_of_type_Ocw.a(this.mActivity, this.app, getCurFriendUin(), this.jdField_a_of_type_MqqObserverBusinessObserver, false);
    if ((paramList != null) && (!paramList.isEmpty())) {
      a(true);
    }
    this.E = true;
    if (this.jdField_a_of_type_Ofj == null) {
      this.jdField_a_of_type_Ofj = new ofj(this.mContext);
    }
    ...
    if ((((Intent)localObject).hasExtra("pub_account_type")) && ("type_ecshop_account".equals(((Intent)localObject).getStringExtra("pub_account_type"))))
    {
      ...
      localObject = this.jdField_a_of_type_Ofj.a((String)localObject, this);
      this.jdField_a_of_type_Ofj.a(this.mContent, (View)localObject);
      bcef.b(this.app, "P_CliOper", "Shop_lifeservice", "", "Shop_nearbyiconPv", "Pv_shopnearbyicon", 0, 0, "", "", "", "");
    }
    if ((i()) && (atzb.a()))
    {
      hideBottomBar();
    ...
    if ((this.jdField_a_of_type_ComTencentBizUiCustomMenuBar != null) && (this.jdField_a_of_type_ComTencentBizUiCustomMenuBar.getVisibility() == 0) && (paramList != null))
    {
      ...
      while (paramList.hasNext())
      {
        ...
        if (localObject != null) {
          nsf.a.a(getCurFriendUin(), ((mobileqq_mp.ButtonInfo)localObject).id.get(), ((mobileqq_mp.ButtonInfo)localObject).name.get());
        }
      }
    }
  }
  ...
  private void d(List<mobileqq_mp.ButtonInfo> paramList)
  {
    ...
    for (;;)
    {
      ...
      if (((mobileqq_mp.ButtonInfo)localObject2).key.has())
      {
        ...
        localzvc = new zvc((String)localObject1, str, null, i2);
        localzvc.a((mobileqq_mp.ButtonInfo)localObject2);
      ...
      {
        localObject1 = new zvc((String)localObject1, str, null, i2);
        ((zvc)localObject1).a(localButtonInfo);
        localzvc.a((zvc)localObject1);
        break label163;
        localObject1 = "";
        break;
        str = "";
  ...
  private boolean e()
  {
    ...
    ugf.a();
    if (this.jdField_a_of_type_Ahkq != null) {}
    try
    {
      this.mContext.unregisterReceiver(this.jdField_a_of_type_Ahkq);
      label62:
      this.jdField_a_of_type_Ahkq = null;
      if (this.jdField_b_of_type_MqqAppNewIntent != null) {
        ocw.a().a(this.jdField_b_of_type_MqqAppNewIntent);
      }
      if (this.jdField_c_of_type_MqqAppNewIntent != null) {
        this.jdField_c_of_type_MqqAppNewIntent.setObserver(null);
      }
      if (this.jdField_a_of_type_Amsu != null)
      {
        this.mActivity.removeObserver(this.jdField_a_of_type_Amsu);
  ...
  private boolean g()
  {
    this.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)this.mAIORootView.findViewById(2131366233));
    if (this.jdField_d_of_type_AndroidWidgetImageView != null) {
      this.jdField_d_of_type_AndroidWidgetImageView.setContentDescription(this.mActivity.getText(2131695911));
    }
    ...
    if (this.listView != null)
    {
      ...
      if ((localObject2 != null) && (localObject1 != null) && ((localObject2 instanceof RelativeLayout.LayoutParams)) && ((localObject1 instanceof RelativeLayout.LayoutParams)))
      {
        ...
        if ((arrayOfInt.length > 2) && (arrayOfInt[2] == 2131368751))
        {
          ((RelativeLayout.LayoutParams)localObject2).addRule(2, 2131366232);
  ...
  private void v()
  {
    if ((!this.mActivity.isFinishing()) && (this.jdField_a_of_type_Bhht != null) && (this.jdField_a_of_type_Bhht.isShowing()))
    {
      this.jdField_a_of_type_Bhht.dismiss();
      QQToast.a(this.mActivity, 2131697901, 0).b(this.mActivity.getTitleBarHeight());
    }
  }
  ...
  private void x()
  {
    List localList = this.jdField_a_of_type_Ocw.a(this.app, getCurFriendUin());
    b(localList);
  ...
  private void y()
  {
    ...
    while (((j()) && ((!this.C) || (this.B)) && (this.jdField_a_of_type_Ohf != null) && (this.jdField_a_of_type_Ohf.a(this.mContent))) || (this.mActivity.isFinishing())) {
      do
      {
        return;
      } while (((amxz)this.app.getManager(56)).c(this.sessionInfo.curFriendUin) == null);
    }
    try
    {
      g();
  ...
  private void z()
  {
    ...
    do
    {
      ...
      localogr = (ogr)this.app.getBusinessHandler(88);
      localObject1 = this.app.getMessageFacade().getAIOList(this.sessionInfo.curFriendUin, this.sessionInfo.curType);
    } while ((localObject1 == null) || (((List)localObject1).isEmpty()) || (localogr == null));
    ...
    if ("1".equals(str))
    {
      localObject2 = new ogh();
      ((ogh)localObject2).jdField_a_of_type_Int = 2;
      localObject2 = oge.a((ogh)localObject2, (MessageRecord)localObject1);
      ((oge)this.app.getBusinessHandler(139)).a((ogh)localObject2, null);
    ...
    for (;;)
    {
      ...
      localogr.a(134243865, this.sessionInfo.curFriendUin, null, null, null, i1, false);
      return;
      if ((localObject1 instanceof MessageForArkApp))
      {
        ...
        continue;
        if ((localObject1 instanceof MessageForArkApp)) {
          localogr.a(134243863, ((ChatMessage)localObject1).senderuin, (String)localObject2, null, null, 0L, false);
        } else {
          localogr.a(134243857, ((ChatMessage)localObject1).senderuin, (String)localObject2, null, null, 0L, false);
        }
      }
    }
  }
    ...
    if (paramAbsStructMsg != null) {
      try
      {
        if ((paramAbsStructMsg instanceof StructMsgForGeneralShare))
        {
          ...
          {
            paramAbsStructMsg = bjnd.b(paramAbsStructMsg.substring(paramAbsStructMsg.indexOf("?") + 1));
  ...
  public void a()
  {
    ...
    catch (Exception localException)
    {
      ...
      bcef.b(this.app, "P_CliOper", "Pb_account_lifeservice", this.sessionInfo.curFriendUin, "0X8005D17", "0X8005D17", 0, 1, 0, "old", String.valueOf(l1 - this.jdField_b_of_type_Long), "", "");
    }
    Object localObject = localChatMessage.getExtInfoFromExtStr("pa_msgId");
    bcef.b(this.app, "P_CliOper", "Pb_account_lifeservice", "" + localChatMessage.frienduin, "0X8005C38", "0X8005C38", 0, 1, 0, (String)localObject, String.valueOf(NetConnInfoCenter.getServerTime() * 1000L), "", str1);
    if (this.jdField_h_of_type_Boolean)
    {
      l1 = NetConnInfoCenter.getServerTime() * 1000L;
      if (this.jdField_i_of_type_Boolean) {
        bcef.b(this.app, "P_CliOper", "Pb_account_lifeservice", this.sessionInfo.curFriendUin, "0X8005D17", "0X8005D17", 0, 1, 0, "new", String.valueOf(l1 - this.jdField_b_of_type_Long), "", "");
      }
    }
    else
    {
  ...
  public void a(int paramInt)
  {
    ...
    if ((!this.mActivity.isFinishing()) && (this.jdField_a_of_type_Bhht != null))
    {
  ...
  {
    amri localamri = (amri)this.app.getBusinessHandler(21);
    if (localamri != null) {
      localamri.a(this.sessionInfo.curFriendUin, 3, paramInt, 1, paramBusinessObserver);
    }
  }
  ...
  public void a(PublicAccountInfo paramPublicAccountInfo)
  {
    ...
    for (;;)
    {
      ...
      {
        String str1 = this.mActivity.getString(2131691926);
        String str2 = String.format(this.mActivity.getString(2131691924), new Object[] { this.sessionInfo.curFriendNick });
        this.jdField_a_of_type_AndroidAppDialog = bfur.a(this.mActivity, 230, str1, str2, 2131691923, 2131691925, new ahjs(this, paramPublicAccountInfo, localamxz), new ahjt(this, paramPublicAccountInfo, localamxz));
        this.jdField_a_of_type_AndroidAppDialog.setOnDismissListener(new ahju(this));
  ...
  void a(AbsListView paramAbsListView)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Ocw.a(BaseApplication.getContext(), this.app, 0L, 0L, l1, l2, 2, localArrayList4);
      ...
      while (paramAbsListView.hasNext()) {
        if ("1".equals(((ChatMessage)paramAbsListView.next()).getExtInfoFromExtStr("is_AdArrive_Msg")))
        {
          ...
          uei.a(this.app, "", "", this.sessionInfo.curFriendUin, localArrayList2, localArrayList1, localArrayList3);
        }
      }
      return;
    }
  ...
  {
    boolean bool = true;
    if ((!TextUtils.isEmpty(paramString)) && (this.jdField_a_of_type_Ofj != null) && (this.mActivity != null)) {
      if (QLog.isColorLevel()) {
  ...
  public void a(Map<String, String> paramMap)
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_Ocw.a(this.mActivity, this.sessionInfo.curFriendUin, paramMap, (String)localObject, null, new ahkl(this));
      return;
      localObject = null;
      paramMap = null;
    }
  ...
  {
    bcef.b(this.app, "CliOper", "", "", "0X8004EF8", "0X8004EF8", 0, 0, Integer.toString(paramInt), "", "", "");
    if (this.jdField_b_of_type_MqqAppNewIntent != null)
    {
      ocw.a().a(this.jdField_b_of_type_MqqAppNewIntent);
      this.jdField_b_of_type_MqqAppNewIntent = null;
    }
    this.jdField_b_of_type_MqqAppNewIntent = ocw.a().a(this.sessionInfo.curFriendUin, paramInt, paramBoolean, BaseApplication.getContext(), this.app, new ahjw(this));
  }
  ...
  public boolean a()
  {
    Object localObject = (amxz)this.app.getManager(56);
    if (localObject != null) {}
    for (localObject = ((amxz)localObject).b(this.sessionInfo.curFriendUin);; localObject = null)
    {
      if ((localObject == null) && (ugf.a(this.app, this.sessionInfo.curFriendUin) == null))
      {
        ugf.a();
        ugf.a(this.app, BaseApplication.getContext(), this.uiHandler, this.sessionInfo.curFriendUin);
        return true;
      }
      return false;
    }
  ...
  public boolean a(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      localObject = ((amxz)this.app.getManager(56)).b(this.sessionInfo.curFriendUin);
      if (localObject != null) {
  ...
  public void addBusinessObservers()
  {
    ...
    if (uaw.e(this.app, this.sessionInfo.curFriendUin)) {
      this.app.addObserver(this.jdField_a_of_type_Ogc);
    }
  ...
  public void afterTextChanged(Editable paramEditable)
  {
    ...
    if (this.mInputStat == 0)
    {
      ...
      this.jdField_a_of_type_ComTencentWidgetPatchedButton.setText(2131690709);
  ...
  void b(List<mobileqq_mp.ButtonInfo> paramList)
  {
    ...
    if ((paramList != null) && (agjp.a(this.sessionInfo.curFriendUin)))
    {
      mobileqq_mp.ButtonInfo localButtonInfo = new mobileqq_mp.ButtonInfo();
      localButtonInfo.id.set(0);
      localButtonInfo.name.set(amtj.a(2131712942));
  ...
  protected void b(boolean paramBoolean)
  {
    ...
    for (int i1 = 4;; i1 = 0)
    {
      ...
      {
        localObject = new ImageSpan(this.mContext, 2130838108);
        SpannableString localSpannableString = new SpannableString(amtj.a(2131707881));
  ...
  void c()
  {
    ...
    a(this.jdField_g_of_type_AndroidViewView, this.jdField_g_of_type_AndroidViewView.getHeight(), 0, new ahiy(this));
    ...
    localTranslateAnimation.setFillAfter(true);
    localTranslateAnimation.setAnimationListener(new ahiz(this));
    this.jdField_a_of_type_AndroidViewView.startAnimation(localTranslateAnimation);
  }
  ...
  void d()
  {
    ...
    do
    {
      return;
      L();
      this.jdField_g_of_type_AndroidViewView = LayoutInflater.from(this.mActivity.getBaseContext()).inflate(2131558634, this.listView, false);
    } while (this.jdField_g_of_type_AndroidViewView == null);
    Object localObject;
    if (this.jdField_a_of_type_Int == 2)
    {
      this.jdField_g_of_type_AndroidViewView.getLayoutParams().height = ((int)this.mActivity.getResources().getDimension(2131297576));
      if ((!this.v) && (!this.A)) {
        break label222;
      }
      localObject = (RelativeLayout.LayoutParams)this.listView.getLayoutParams();
      ((RelativeLayout.LayoutParams)localObject).topMargin = this.mContext.getResources().getDimensionPixelSize(2131299076);
  ...
  public void d(int paramInt)
  {
    try
    {
      ...
      for (;;)
      {
        ...
        return;
        this.jdField_b_of_type_AndroidWidgetTextView.setText(2131718610);
        continue;
        this.jdField_b_of_type_AndroidWidgetTextView.setText(2131718604);
        continue;
        this.jdField_b_of_type_AndroidWidgetTextView.setText(2131694777);
      }
      return;
    }
    catch (Exception localException) {}
  ...
  public boolean doOnCreate(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Ahkq = new ahkq(this, null);
    Object localObject = new IntentFilter();
    ((IntentFilter)localObject).addAction("android.intent.action.CLOSE_SYSTEM_DIALOGS");
    ((IntentFilter)localObject).addAction("android.intent.action.SCREEN_OFF");
    this.mContext.registerReceiver(this.jdField_a_of_type_Ahkq, (IntentFilter)localObject);
    this.hasDestory = false;
    this.needAutoInput = false;
    K();
    this.jdField_a_of_type_Ocw = ocw.a();
    m();
    ...
    this.jdField_a_of_type_Beaj = new beaj();
    this.jdField_a_of_type_Beaj.a(this.app, getActivity(), this, this.sessionInfo, this.mContent, this.listAdapter, this.listView);
    this.jdField_a_of_type_Beaj.addObserver(this);
    ...
    ugf.jdField_a_of_type_Boolean = ((Intent)localObject).getBooleanExtra("is_come_from_readinjoy", false);
    ...
    this.jdField_h_of_type_Boolean = ugf.a(this.app, this.sessionInfo.curFriendUin);
    if (QLog.isColorLevel()) {
  ...
  public void doOnCreate_initUI()
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetPatchedButton = ((PatchedButton)this.mAIORootView.findViewById(2131367352));
    this.jdField_a_of_type_ComTencentWidgetPatchedButton.setContentDescription(amtj.a(2131707914));
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.mAIORootView.findViewById(2131367353));
    ...
    for (;;)
    {
      this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidWidgetLinearLayout.findViewById(2131363032));
      this.jdField_c_of_type_AndroidWidgetImageView.setOnClickListener(this);
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidWidgetLinearLayout.findViewById(2131372779));
      this.jdField_b_of_type_AndroidWidgetImageView.setOnClickListener(this);
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidWidgetLinearLayout.findViewById(2131365953));
      this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this);
      if (!CustomMenuBar.a())
      {
        this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130847816);
        this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130838053);
      }
      if (this.input != null)
      {
        ...
        if (CustomMenuBar.a())
        {
          this.input.setBackgroundResource(2130849901);
  ...
  {
    ple.a().a(this.sessionInfo.curFriendUin, this.jdField_f_of_type_Long, this.jdField_k_of_type_Boolean, this.listAdapter.a());
    if (e()) {
      return;
    }
    super.doOnDestroy();
    ...
    {
      this.jdField_a_of_type_Ocw.a(getCurFriendUin());
      this.jdField_a_of_type_Ocw.a(this.mContext);
    }
    J();
    a();
    R();
    if (this.jdField_f_of_type_Long != 0L)
    {
      ...
      bcef.b(this.app, "dc00899", "Pb_account_lifeservice", "" + this.sessionInfo.curFriendUin, "0X80064D5", "0X80064D5", 0, 0, "", "" + this.jdField_f_of_type_Long, "" + this.jdField_u_of_type_Int, "");
    ...
    n();
    ugf.jdField_a_of_type_Boolean = false;
    try
    {
      if (oge.a(this.sessionInfo))
      {
        ArkAppNotifyCenter.unRegistVolumnReceiver();
        akfp.a().b("com.tencent.gouwu.video");
        akfp.a().b("com.tencent.gwh.video");
        akfp.a().b("com.tencent.qqshop");
      }
      label272:
      aj();
      return;
  ...
  public void doOnNewIntent(Intent paramIntent)
  {
    ...
    {
      if ((this.app != null) && (!this.app.getAccount().equals(this.jdField_a_of_type_Ocw.a()))) {
        this.jdField_a_of_type_Ocw.a(getCurFriendUin());
      }
      localObject = this.jdField_a_of_type_Ocw.a(this.app, getCurFriendUin());
      b((List)localObject);
      this.jdField_a_of_type_MqqAppNewIntent = this.jdField_a_of_type_Ocw.a(this.mActivity, this.app, getCurFriendUin(), this.jdField_a_of_type_MqqObserverBusinessObserver, false);
    ...
    if ((localObject != null) && (((String)localObject).equals("starShortcut"))) {
      ocw.a(this.mActivity, this.app, paramIntent.getStringExtra("starhomeurl"), paramIntent.getStringExtra("uin"), (String)localObject);
    }
    this.J = false;
  }
  ...
  public void doOnPause()
  {
    if ((this.app != null) && (this.sessionInfo != null)) {
      ((ofx)this.app.getManager(88)).jdField_i_of_type_JavaLangString = this.sessionInfo.curFriendUin;
    }
    super.doOnPause();
    this.jdField_a_of_type_Aufo.d();
    PublicAccountInfo localPublicAccountInfo = ((amxz)this.app.getManager(56)).b(this.sessionInfo.curFriendUin);
    if (localPublicAccountInfo != null) {
      switch (ugf.a(localPublicAccountInfo.accountFlag))
      {
      }
    }
    for (;;)
    {
      if (j())
      {
        ...
        ohq.a(this.app, "gouwu.aio.stay", "1", NetConnInfoCenter.getServerTimeMillis() + "", NetConnInfoCenter.getServerTimeMillis() - this.jdField_h_of_type_Long + "");
        ohq.b(this.app, "gouwu_aio_stay", "1", NetConnInfoCenter.getServerTimeMillis() + "", NetConnInfoCenter.getServerTimeMillis() - this.jdField_h_of_type_Long + "");
      }
      nsf.a.a(getCurFriendUin());
      return;
      anxs.a(this.app, this.sessionInfo.curFriendUin, this.jdField_q_of_type_Int, 2, System.currentTimeMillis() - this.jdField_h_of_type_Long);
      continue;
      anxs.a(this.app, this.sessionInfo.curFriendUin, this.jdField_q_of_type_Int, 3, System.currentTimeMillis() - this.jdField_h_of_type_Long);
      continue;
      anxs.a(this.app, this.sessionInfo.curFriendUin, this.jdField_q_of_type_Int, 4, System.currentTimeMillis() - this.jdField_h_of_type_Long);
    }
  }
  ...
  public void doOnResume()
  {
    ...
    try
    {
      ...
      bcef.b(null, "dc00898", "", this.sessionInfo.curFriendUin, "auth_aio", "exp", 0, 0, "", "", this.sessionInfo.curFriendNick, "");
      nsf.a.a();
      return;
    }
  ...
  public void doOnResume_updateUI()
  {
    ...
    if (this.jdField_a_of_type_Beaj.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_Beaj.a(this.app);
      this.jdField_a_of_type_Beaj.c();
    }
    if ((agjp.a(this.sessionInfo.curFriendUin)) && (this.input != null)) {
      this.input.setHint(amtj.a(2131707855));
    }
    if ((!this.E) && (this.F))
    {
      this.F = false;
    ...
    for (;;)
    {
      ogb localogb = (ogb)this.app.getBusinessHandler(68);
      if (uaw.e(this.app, this.sessionInfo.curFriendUin))
      {
        long l1 = 0L;
        if (ofx.b.get(this.sessionInfo.curFriendUin) != null) {
          l1 = ((Long)ofx.b.get(this.sessionInfo.curFriendUin)).longValue();
        }
        if ((!TextUtils.isEmpty((String)ofx.jdField_a_of_type_JavaUtilHashMap.get(this.sessionInfo.curFriendUin))) && (System.currentTimeMillis() - l1 <= ofx.jdField_a_of_type_Int)) {
          break;
        }
        ofx.b.put(this.sessionInfo.curFriendUin, Long.valueOf(System.currentTimeMillis()));
        localogb.a(this.sessionInfo.curFriendUin);
      }
      return;
    ...
    if (maq.a().a(this.app.getCurrentAccountUin()))
    {
      this.mTitleBtnCall.setVisibility(0);
      this.mTitleBtnCall.setOnClickListener(this);
      this.mCustomTitleView.setRight2Icon(2130846999);
      return;
    }
    this.mTitleBtnCall.setVisibility(8);
  }
  ...
  public void doOnStop()
  {
    ...
    if (!this.jdField_a_of_type_JavaUtilList.isEmpty())
    {
      ...
      bcef.b(this.app, "P_CliOper", "Pb_account_lifeservice", this.sessionInfo.curFriendUin, "0X8005C35", "0X8005C35", 0, 1, 0, (String)this.jdField_a_of_type_JavaUtilList.get(i1), String.valueOf(this.jdField_a_of_type_Long), String.valueOf(l1), (String)this.jdField_b_of_type_JavaUtilList.get(i1));
    }
    if (this.jdField_h_of_type_Boolean)
    {
      if (this.jdField_i_of_type_Boolean) {
        odq.a(this.app, "P_CliOper", "Pb_account_lifeservice", this.sessionInfo.curFriendUin, "0X8005D16", "0X8005D16", 0, 0, "new", String.valueOf(l1 - this.jdField_c_of_type_Long), "", "", false);
      }
    }
    else {
      return;
    }
    odq.a(this.app, "P_CliOper", "Pb_account_lifeservice", this.sessionInfo.curFriendUin, "0X8005D16", "0X8005D16", 0, 0, "old", String.valueOf(l1 - this.jdField_c_of_type_Long), "", "", false);
  }
  ...
  public void doPanelChanged(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt2 == 8) {
      if (this.jdField_b_of_type_AndroidWidgetImageView != null)
      {
        ...
        this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130849847);
      }
    }
    for (;;)
    {
      if (!this.isSimpleBar)
      {
        ...
        {
          localObject = new ImageSpan(this.mContext, 2130838108);
          localSpannableString = new SpannableString(amtj.a(2131707908));
          localSpannableString.setSpan(localObject, 0, localSpannableString.length(), 33);
          this.jdField_a_of_type_AndroidTextSpannableString = localSpannableString;
        }
        if (this.jdField_b_of_type_AndroidTextSpannableString == null)
        {
          localObject = new ImageSpan(this.mContext, 2130838403);
          localSpannableString = new SpannableString(amtj.a(2131707904));
          localSpannableString.setSpan(localObject, 0, localSpannableString.length(), 33);
        ...
        if ((this.mAudioPanel != null) && (paramInt1 != 2) && (aews.a(this.app))) {
          this.mAudioPanel.a(false);
        }
      }
      return;
      label295:
      this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130849769);
      continue;
      if (this.jdField_b_of_type_AndroidWidgetImageView != null) {
        if (CustomMenuBar.a()) {
          this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130849846);
        } else {
          this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130849768);
        }
      }
    }
  ...
  public void e(int paramInt)
  {
    ...
    {
      this.jdField_b_of_type_AndroidAppDialog = new ReportDialog(getActivity(), 2131755826);
      this.jdField_b_of_type_AndroidAppDialog.setContentView(2131560837);
    }
    TextView localTextView1 = (TextView)this.jdField_b_of_type_AndroidAppDialog.findViewById(2131378707);
    TextView localTextView2 = (TextView)this.jdField_b_of_type_AndroidAppDialog.findViewById(2131361937);
    switch (paramInt)
    {
    }
    for (;;)
    {
      this.jdField_b_of_type_AndroidAppDialog.setOnCancelListener(new ahkj(this));
      this.jdField_b_of_type_AndroidAppDialog.show();
      return;
      localTextView1.setText(2131697713);
      localTextView2.setText(2131697719);
      continue;
      localTextView1.setText(2131697714);
      localTextView2.setText(2131697715);
      continue;
      localTextView1.setText(2131697717);
      localTextView2.setText(2131697715);
    }
  }
  ...
  void f()
  {
    ...
    {
      this.jdField_a_of_type_Bjnw = ((bjnw)bjon.a(this.mActivity, null));
      this.jdField_a_of_type_Bjnw.a(amtj.a(2131707902));
      this.jdField_a_of_type_Bjnw.a(amtj.a(2131707898), 3);
      this.jdField_a_of_type_Bjnw.c(2131690620);
      this.jdField_a_of_type_Bjnw.setOnDismissListener(new ahjh(this));
      this.jdField_a_of_type_Bjnw.a(new ahji(this));
    }
  ...
  void g()
  {
    ...
    if (this.jdField_g_of_type_Boolean)
    {
      ...
      ((TranslateAnimation)localObject).setAnimationListener(new ahjn(this));
    ...
    ((View)localObject).setOnClickListener(new ahjo(this));
    this.jdField_a_of_type_ComTencentBizUiCustomMenuBar.setCoverView((View)localObject);
    this.jdField_f_of_type_AndroidViewView = this.mContent.findViewById(2131372166);
    Q();
  ...
  public void handleScrollOutScreen(View paramView)
  {
    ...
    ((aftq)this.helperProvider.a(22)).a(paramView);
  }
  ...
  void i()
  {
    ...
    for (;;)
    {
      odq.a(this.app, this.sessionInfo.curFriendUin, 4);
  ...
  {
    ahqf localahqf = new ahqf(this.app, this.sessionInfo, this.mTipsMgr, this, this.uiHandler);
    this.mTipsMgr.a(localahqf);
  }
  ...
  protected void k()
  {
    ...
    if (this.mInputStat == 2)
    {
      ...
      {
        if (CustomMenuBar.a()) {
          this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130849798);
        }
        for (;;)
        {
          this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(this.mContext.getString(2131697893));
          return;
          this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130850234);
        }
      }
      if (CustomMenuBar.a()) {
      ...
      for (;;)
      {
        this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(this.mContext.getString(2131697892));
        return;
        this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130850235);
      }
    }
    this.jdField_a_of_type_AndroidWidgetImageView.setEnabled(true);
    if (this.root.a() == 3)
  ...
  public void l()
  {
    this.jdField_h_of_type_AndroidViewView = LayoutInflater.from(this.mContext).inflate(2131559636, null);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_h_of_type_AndroidViewView.findViewById(2131376218));
    if (!this.jdField_i_of_type_Boolean) {
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
    }
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_h_of_type_AndroidViewView.findViewById(2131376212));
    this.jdField_e_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_h_of_type_AndroidViewView.findViewById(2131376210));
    this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)this.jdField_h_of_type_AndroidViewView.findViewById(2131376213));
  }
  ...
  public void leftBackEvent(boolean paramBoolean)
  {
    try
    {
      if ((j()) && (this.jdField_a_of_type_Ohf != null)) {
        this.jdField_a_of_type_Ohf.a(getActivity());
      }
      label27:
  ...
  void m()
  {
    ...
    if (!TextUtils.isEmpty(this.jdField_d_of_type_JavaLangString))
    {
      ...
      this.jdField_a_of_type_Bily.a(str, this.jdField_e_of_type_JavaLangString);
      return;
    }
    this.jdField_e_of_type_JavaLangString = this.jdField_a_of_type_Bily.b(str);
  ...
  public void messageTips(QQMessageFacade.Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Beaj != null)
      {
        Iterator localIterator = this.jdField_a_of_type_Beaj.jdField_a_of_type_JavaUtilList.iterator();
        do
        {
  ...
  public void onPostSetReadConfirm(QQAppInterface paramQQAppInterface)
  {
    ...
    if ((this.sessionInfo.curType == 1008) && (uaw.b(paramQQAppInterface, this.sessionInfo.curFriendUin)) && (uaw.a().a(this.sessionInfo.curFriendUin))) {
      uaw.a().a(paramQQAppInterface, this.sessionInfo.curFriendUin);
    }
  }
  ...
  public void onScroll(AbsListView paramAbsListView, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    ((aftq)this.helperProvider.a(22)).a(paramAbsListView, paramInt1, paramInt2, paramInt3);
    if ((j()) && (this.B) && (ohk.b()))
    {
      ohq.a().a(this.listView, this.listAdapter);
  ...
  public void onScrollStateChanged(AbsListView paramAbsListView, int paramInt)
  {
    ...
    if ((j()) && (this.B) && (ohk.b()) && (paramInt == 0))
    {
      this.jdField_k_of_type_Int = a();
      if (this.jdField_s_of_type_Int > 100)
      {
        ohq.a(null, "qgg.index.up", "", NetConnInfoCenter.getServerTimeMillis() + "", "");
        ohq.b(null, "qgg_index_up", "", NetConnInfoCenter.getServerTimeMillis() + "", "");
        if (QLog.isColorLevel()) {
          QLog.i(this.tag, 2, "report qgg_index_up");
        }
      }
    }
    ((aftq)this.helperProvider.a(22)).a(paramAbsListView, paramInt);
  }
  
  public void onShow()
  {
    if ((this.H) && (uda.a().a(this.app, this.sessionInfo.curFriendUin) > 0)) {
      uda.a().a(this.app, this.sessionInfo.curFriendUin);
    }
    super.onShow();
    if (agjp.a(this.sessionInfo.curFriendUin))
    {
    ...
    {
      ofx localofx = (ofx)this.app.getManager(88);
      if ((localofx != null) && (localofx.a(this.sessionInfo.curFriendUin))) {
      ...
      if (("3026775809".equals(this.sessionInfo.curFriendUin)) && (Build.VERSION.SDK_INT >= 19) && (((SensorManager)this.app.getApplication().getApplicationContext().getSystemService("sensor")).getDefaultSensor(19) != null)) {
        ((bgmp)this.app.getManager(260)).a("public account");
      }
    }
  }
  ...
  public void openOptionActivity()
  {
    if (this.K)
    {
      ...
      zbh.a(getActivity(), this.sessionInfo.curFriendUin);
      bcef.b(null, "dc00898", "", this.sessionInfo.curFriendUin, "auth_aio", "clk_head", 0, 0, "", "", this.sessionInfo.curFriendNick, "");
      return;
    }
    ...
    ugf.a(localIntent, this.app, this.mActivity.getActivity(), this.sessionInfo.curFriendUin, -1, 2000, 1, ugf.jdField_a_of_type_Boolean);
  }
  ...
  public void q()
  {
    ...
    if (this.w) {
      if (((amxz)this.app.getManager(56)).c(this.sessionInfo.curFriendUin) == null) {
        break label292;
      }
    }
    label292:
  ...
  public void r()
  {
    ...
    do
    {
      ...
      {
        anky.a(this.app, this.sessionInfo.curFriendUin, this.app.getApp().getResources().getString(2131697716), this.sessionInfo.curType, false, true);
        return;
      }
  ...
  public void removeBusinessObservers()
  {
    ...
    this.app.removeObserver(this.jdField_a_of_type_Ogc);
  ...
  public void setInputStat(int paramInt)
  {
    ...
    if (paramInt != this.mInputStat)
    {
      ...
      if (this.jdField_a_of_type_AndroidTextSpannableString == null)
      {
        localImageSpan = new ImageSpan(this.mContext, 2130838108);
        localSpannableString = new SpannableString(amtj.a(2131707920));
    ...
    for (;;)
    {
      ...
      if (paramInt == 2)
      {
        if (this.jdField_b_of_type_AndroidTextSpannableString == null)
        {
          localImageSpan = new ImageSpan(this.mContext, 2130838403);
          localSpannableString = new SpannableString(amtj.a(2131707849));
          localSpannableString.setSpan(localImageSpan, 0, localSpannableString.length(), 33);
          this.jdField_b_of_type_AndroidTextSpannableString = localSpannableString;
        }
      ...
      else
      {
        ...
        {
          localImageSpan = new ImageSpan(this.mContext, 2130838403);
          localSpannableString = new SpannableString(amtj.a(2131707895));
          localSpannableString.setSpan(localImageSpan, 0, localSpannableString.length(), 33);
          this.jdField_b_of_type_AndroidTextSpannableString = localSpannableString;
        }
        if (this.input.getText().length() > 0) {
  ...
  public void setList(List<ChatMessage> paramList, CharSequence paramCharSequence)
  {
    ...
    for (;;)
    {
      bcef.b(this.app, "dc00899", "Pb_account_lifeservice", "" + this.sessionInfo.curFriendUin, "0X80064D4", "0X80064D4", 0, 0, "", "" + i1, "" + l1, "");
      return;
      label174:
      continue;
      label177:
    ...
    try
    {
      if (j())
      {
        if (this.B)
        {
          ...
          this.jdField_a_of_type_Ohf.a(paramList, new ahkf(this, paramCharSequence, paramInt));
          return;
        }
        if (this.jdField_a_of_type_Ohf == null) {
          return;
        }
        this.jdField_a_of_type_Ohf.a(paramList, new ahkg(this, paramCharSequence, paramInt));
      }
    }
    catch (Throwable localThrowable1)
    {
      QLog.e(this.tag, 1, QLog.getStackTraceString(localThrowable1));
      if (ugf.a(this.sessionInfo)) {}
      try
      {
        ((ajvj)this.app.getManager(341)).a(paramList);
  ...
  public void startDelAnimAndDelMsg(ChatMessage paramChatMessage)
  {
    ...
    if (uda.a().a(this.app, (String)localObject, i1))
    {
      anuz localanuz = this.app.getProxyManager().a();
      localObject = (RecentUser)localanuz.findRecentUserByUin((String)localObject, i1);
      if (localObject != null) {
        localanuz.delRecentUser((BaseRecentUser)localObject);
      }
    }
    if ((j()) && (this.jdField_a_of_type_Ohf != null)) {
      this.jdField_a_of_type_Ohf.a(paramChatMessage);
    }
  }
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    ...
    if ((bkwm.a(this.app)) && ((paramObject instanceof MessageRecord))) {
      ((KandianMergeManager)this.app.getManager(162)).a(this.sessionInfo.curFriendUin);
    }
    super.update(paramObservable, paramObject);
    int i1;
    if ((paramObservable instanceof beaj)) {
  ...
  public void updateSession(Intent paramIntent)
  {
    ...
    s();
    ag();
    this.refreshMessageContext.msgRefresher = new abxk(this.app.getMessageFacade().getC2CMessageManager());
  }
  ...
  public void updateSession_updateTitleLeftView(Intent paramIntent)
  {
    ...
    if (this.mDefaultLeftBack != null) {
      this.mDefaultLeftBack.setContentDescription(this.app.getApplication().getString(2131690424));
    }
  ...
  public void updateSession_updateTitleRightView()
  {
    if (this.mTitleBtnRight != null)
    {
      if ("2277373213".equals(this.sessionInfo.curFriendUin)) {
        this.mCustomTitleView.setRight1Icon(2130847257);
      }
    }
    else {
      return;
    ...
    if (k()) {
      this.mCustomTitleView.findViewById(2131369082).setVisibility(8);
    }
    for (;;)
    {
