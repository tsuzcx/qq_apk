  ...
  implements aenz
{
  ...
  public int a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = localObject2;
        localObject3 = ((ajjj)paramQQAppInterface.getManager(51)).e(paramString);
        if (localObject3 == null) {
          continue;
        }
        localObject1 = localObject2;
      ...
      finally
      {
        try
        {
          ...
          int n;
          int i1;
          awqx.b(paramQQAppInterface, "CliOper", "", "", "Free_call", "Free_call_tips", 0, 0, "", "", "", "");
          int i = 1;
          if (!QLog.isColorLevel()) {
            continue;
          }
        ...
        if (QLog.isColorLevel())
        {
          ...
          if (QLog.isColorLevel())
          {
            ...
            else
            {
              ...
              localObject1 = localObject2;
              localObject4 = a(paramQQAppInterface, (String)localObject3, awao.a());
              if (localObject4 == null)
              {
                ...
                if (paramBoolean)
                {
                  ...
                  localObject2 = new NewIntent(paramQQAppInterface.getApp(), awdk.class);
                  localObject1 = paramString;
  ...
  public View a(Object... paramVarArgs)
  {
    ...
    paramVarArgs.findViewById(2131307243).setOnClickListener(new aenc(this));
    return paramVarArgs;
  }
  ...
  public void a()
  {
    ...
    do
    {
      ...
      {
        return;
        localamnb = amnb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        if (!localamnb.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, 1)) {
          break;
        }
      } while (!QLog.isColorLevel());
      QLog.d("FriendHotTipsBar", 2, "hasNetTipShow today");
      return;
    } while ((a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, true) != 1) || (!this.jdField_a_of_type_Aeob.a(this, new Object[0])));
    ...
    localamnb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, 1);
  }
