  ...
  extends awfx
{
  ...
  aulg(aulf paramaulf, ArrayList paramArrayList, HashMap paramHashMap, MessageRecord paramMessageRecord, aukq paramaukq, auld paramauld) {}
  
  private int a(MessageForPic paramMessageForPic, awfd paramawfd)
  {
    ...
    for (;;)
    {
      ...
      paramMessageForPic.md5 = bdcs.c(aukx.a);
      ...
      for (;;)
      {
        if (i != 0)
        {
          ...
          if (paramawfd.jdField_a_of_type_Int == 0)
          {
            ...
            if (QLog.isColorLevel()) {
              QLog.e("PicMultiMsgProcessor", 2, "WTF, picResult.mExtraObj is " + paramawfd.jdField_a_of_type_JavaLangObject.getClass().getSimpleName());
            }
            i = 0;
            continue;
          }
      ...
      label591:
      for (int j = paramawfd.jdField_a_of_type_Awey.jdField_a_of_type_Int;; j = -1)
      {
        i = j;
        if (!QLog.isColorLevel()) {
          break;
  ...
  private boolean a(ArrayList<awfd> paramArrayList)
  {
    ...
    if (n < this.b.size())
    {
      ...
      {
        i = k;
        if (((awfd)paramArrayList.get(j)).b) {
          i = 1;
        }
      }
      if (((localObject1 instanceof MessageForPic)) || (((localObject1 instanceof MessageForReplyText)) && (((MessageForReplyText)localObject1).getSourceMessage() != null) && ((((MessageForReplyText)localObject1).getSourceMessage() instanceof MessageForPic))))
      {
        ...
        if ((localObject1 instanceof MessageForReplyText))
        {
          ...
          m = a((MessageForPic)localObject1, (awfd)paramArrayList.get(j));
          k = i;
          bool2 = bool1;
          if (m != 0)
          {
            b(m);
            if (!this.jdField_a_of_type_Aulf.a(m)) {
              break label288;
            }
            bool2 = true;
            k = i;
        ...
        for (;;)
        {
          ...
          break label152;
          localObject2 = this.jdField_a_of_type_Aulf.a.a().a((MessageRecord)localObject1, aulf.a(), false);
          ...
          bool2 = this.jdField_a_of_type_Aulf.a.a().a(this.jdField_a_of_type_JavaUtilHashMap, (MessageRecord)localObject2);
          if (QLog.isColorLevel()) {
      ...
      if (((localObject1 instanceof MessageForMixedMsg)) || (((localObject1 instanceof MessageForReplyText)) && (((MessageForReplyText)localObject1).getSourceMessage() != null) && ((((MessageForReplyText)localObject1).getSourceMessage() instanceof MessageForMixedMsg)))) {
        if ((localObject1 instanceof MessageForReplyText))
        {
          ...
          m = a((MessageForPic)localObject2, (awfd)paramArrayList.get(j));
          k = i;
          bool2 = bool1;
          if (m != 0)
          {
    ...
    for (;;)
    {
      ...
      break label483;
      label724:
      localObject2 = this.jdField_a_of_type_Aulf.a.a().a((MessageRecord)localObject2, alpo.a(2131708534), false);
      ...
      for (;;)
      {
        ...
        if (((Iterator)localObject1).hasNext())
        {
          ...
          i1 = a((MessageForPic)localObject3, (awfd)paramArrayList.get(j));
          k = i;
          bool2 = bool1;
          if (i1 != 0)
          {
            b(i1);
            if (this.jdField_a_of_type_Aulf.a(i1))
            {
              bool2 = true;
              k = i;
            }
        ...
        for (;;)
        {
          ...
          break label905;
          localObject3 = this.jdField_a_of_type_Aulf.a.a().a((MessageRecord)localObject3, alpo.a(2131708535), false);
          ...
          if (((localObject1 instanceof MessageForStructing)) || (((localObject1 instanceof MessageForReplyText)) && (((MessageForReplyText)localObject1).getSourceMessage() != null) && ((((MessageForReplyText)localObject1).getSourceMessage() instanceof MessageForMixedMsg))))
          {
            ...
            for (;;)
            {
              if ((localObject2 != null) && ((localObject2 instanceof StructMsgForImageShare)))
              {
                ...
                if ((localObject2 != null) && (((azsp)localObject2).a != null))
                {
                  ...
                  k = a((MessageForPic)localObject2, (awfd)paramArrayList.get(j));
                  bool2 = bool1;
                  if (k != 0)
                  {
                    b(k);
                    bool2 = bool1;
                    if (this.jdField_a_of_type_Aulf.a(k)) {
                      bool2 = true;
                    }
                  }
                  k = j + 1;
                  ...
                  if (k != 0)
                  {
                    if (this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.isReMultiMsg) {
                      azmj.b(this.jdField_a_of_type_Aulf.a, "CliOper", "", "", "0X800662B", "0X800662B", 0, 1, 0, "", "", "", "");
                    }
                    if (QLog.isColorLevel()) {
                      QLog.e("PicMultiMsgProcessor", 2, "requestUploadPics isPicMsgModify");
                    }
                    this.jdField_a_of_type_Aulf.a.a().a().a(this.b, null);
                  }
                  if (this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.isReMultiMsg) {
                    azmj.b(this.jdField_a_of_type_Aulf.a, "CliOper", "", "", "0X800662A", "0X800662A", 0, 1, 0, "", "", "", "");
                  }
                  return bool1;
                }
              }
  ...
  public void a(int paramInt, ArrayList<awfd> paramArrayList)
  {
    if ((paramInt == 0) && (paramArrayList != null) && (paramArrayList.size() > 0))
    {
      ...
      {
        localazmz.a(null, "MultiMsgPicSendResult", bool1, 0L, paramArrayList.size(), localHashMap, null);
        bool1 = bool2;
        if (!bool1) {
          break label317;
        }
        this.jdField_a_of_type_Aukq.a(1, 1, this.jdField_a_of_type_Auld);
        return;
    ...
    label317:
    this.jdField_a_of_type_Aukq.a(0, 1, this.jdField_a_of_type_Auld);
  }
}
