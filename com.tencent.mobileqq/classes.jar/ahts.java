  ...
  extends AsyncTask<Integer, Integer, Integer>
{
  ...
  ahui[] jdField_a_of_type_ArrayOfAhui;
  
  public ahts(ArrayList<ahui> paramArrayList)
  {
    Object localObject;
    this.jdField_a_of_type_ArrayOfAhui = ((ahui[])localObject.toArray(new ahui[0]));
  }
  
  private int a(ahui[] paramArrayOfahui, boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, Integer... paramVarArgs)
  {
    int i;
    ...
    {
      return i;
      localFile = new File(anhk.bg);
      if (!localFile.exists()) {
        localFile.mkdirs();
      }
      paramInt1 = 0;
      if (paramInt1 >= paramArrayOfahui.length) {
        break label267;
      }
      localObject = paramArrayOfahui[paramInt1];
      if (!paramBoolean) {
        return 1;
      }
      ...
      publishProgress(new Integer[] { Integer.valueOf(paramInt2 * 100 / paramVarArgs.length + paramInt1 * 100 / paramVarArgs.length / paramArrayOfahui.length & 0xFFFF | paramInt3 << 16) });
      j = ahtk.a(this.jdField_a_of_type_Ahtk, null, (AIOImageData)localObject, localFile);
      i = j;
    } while (j != 20);
    do
    {
      ...
      publishProgress(new Integer[] { Integer.valueOf(paramInt2 * 100 / paramVarArgs.length + paramInt1 * 100 / paramVarArgs.length / paramArrayOfahui.length & 0xFFFF | paramInt3 << 16) });
      i = ahtk.a(this.jdField_a_of_type_Ahtk, null, (AIOFilePicData)localObject, localFile);
    } while (i == 20);
    return i;
    label267:
    if (QLog.isColorLevel()) {
  ...
  protected Integer a(Integer... paramVarArgs)
  {
    ...
    //   46: istore 4
    //   48: aload_0
    //   49: getfield 20	ahts:jdField_a_of_type_Boolean	Z
    //   52: ifne +8 -> 60
    //   55: iconst_1
    ...
    //   90: aastore
    //   91: invokevirtual 102	ahts:publishProgress	([Ljava/lang/Object;)V
    //   94: iload 4
    //   96: tableswitch	default:+439 -> 535, 0:+446->542, 1:+400->496, 2:+446->542
    //   125: aload_0
    //   126: getfield 31	ahts:jdField_a_of_type_ArrayOfAhui	[Lahui;
    //   129: arraylength
    //   130: if_icmpge +424 -> 554
    //   133: aload_0
    //   134: getfield 20	ahts:jdField_a_of_type_Boolean	Z
    //   137: ifne +8 -> 145
    //   140: iconst_1
    ...
    //   165: idiv
    //   166: aload_0
    //   167: getfield 31	ahts:jdField_a_of_type_ArrayOfAhui	[Lahui;
    //   170: arraylength
    //   171: idiv
    //   172: iadd
    //   173: ldc 94
    ...
    //   185: aastore
    //   186: invokevirtual 102	ahts:publishProgress	([Ljava/lang/Object;)V
    //   189: aload_0
    //   190: getfield 31	ahts:jdField_a_of_type_ArrayOfAhui	[Lahui;
    //   193: iload_2
    //   194: aaload
    //   195: astore 7
    //   197: ldc 82
    //   199: aload 7
    //   201: getfield 85	ahui:jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData	Lcom/tencent/mobileqq/activity/aio/photo/AIORichMediaData;
    //   204: invokevirtual 91	java/lang/Class:isInstance	(Ljava/lang/Object;)Z
    //   207: ifeq +340 -> 547
    //   210: aload 7
    //   212: getfield 85	ahui:jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData	Lcom/tencent/mobileqq/activity/aio/photo/AIORichMediaData;
    ...
    //   240: aload_0
    //   241: aload 7
    //   243: putfield 148	ahts:jdField_a_of_type_Ahui	Lahui;
    //   246: aload_0
    //   247: getfield 20	ahts:jdField_a_of_type_Boolean	Z
    //   250: ifeq +164 -> 414
    //   253: aload 8
    //   255: ifnull +18 -> 273
    ...
    //   270: ifne +144 -> 414
    //   273: aload_0
    //   274: getfield 148	ahts:jdField_a_of_type_Ahui	Lahui;
    //   277: iconst_1
    //   278: putfield 149	ahui:jdField_a_of_type_Boolean	Z
    //   281: aload_0
    //   282: getfield 15	ahts:jdField_a_of_type_Ahtk	Lahtk;
    //   285: getfield 152	ahtk:jdField_a_of_type_Ahul	Lahul;
    //   288: aload 6
    ...
    //   304: aload_0
    //   305: getfield 148	ahts:jdField_a_of_type_Ahui	Lahui;
    //   308: astore 7
    //   310: aload 7
    //   312: monitorenter
    //   313: aload_0
    //   314: getfield 148	ahts:jdField_a_of_type_Ahui	Lahui;
    //   317: getfield 149	ahui:jdField_a_of_type_Boolean	Z
    //   320: ifeq +10 -> 330
    //   323: aload_0
    //   324: getfield 148	ahts:jdField_a_of_type_Ahui	Lahui;
    ...
    //   385: aload_0
    //   386: aload_0
    //   387: getfield 31	ahts:jdField_a_of_type_ArrayOfAhui	[Lahui;
    //   390: arraylength
    //   391: iload_2
    //   392: isub
    //   393: putfield 179	ahts:jdField_a_of_type_Int	I
    //   396: bipush 11
    ...
    //   413: areturn
    //   414: aload_0
    //   415: getfield 20	ahts:jdField_a_of_type_Boolean	Z
    //   418: ifne +8 -> 426
    //   421: iconst_1
    ...
    //   479: aload_0
    //   480: aload_0
    //   481: getfield 31	ahts:jdField_a_of_type_ArrayOfAhui	[Lahui;
    //   484: arraylength
    //   485: iload_2
    //   486: isub
    //   487: putfield 179	ahts:jdField_a_of_type_Int	I
    //   490: bipush 11
    //   492: invokestatic 98	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   495: areturn
    //   496: aload_0
    //   497: aload_0
    //   498: getfield 31	ahts:jdField_a_of_type_ArrayOfAhui	[Lahui;
    //   501: aload_0
    //   502: getfield 20	ahts:jdField_a_of_type_Boolean	Z
    //   505: iload 5
    //   507: iload_3
    //   508: iload 4
    //   510: aload_1
    //   511: invokespecial 186	ahts:a	([Lahui;ZIII[Ljava/lang/Integer;)I
  ...
  {
    this.jdField_a_of_type_Ahtk.b(paramInteger.intValue(), this.jdField_a_of_type_Int);
    this.jdField_a_of_type_Ahtk.jdField_a_of_type_Ahts = null;
  }
  
  protected void a(Integer... paramVarArgs)
  {
    int i = paramVarArgs[(paramVarArgs.length - 1)].intValue();
    this.jdField_a_of_type_Ahtk.c(i >> 16, 0xFFFF & i);
  }
}
