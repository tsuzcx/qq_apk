...
public class adwj
  extends MqqHandler
{
  public adwj(ChatSettingActivity paramChatSettingActivity) {}
        ...
        do
        {
          do
          {
            ...
            if ((ChatSettingActivity.a(this.a) != 1001) && (ChatSettingActivity.a(this.a) != 10002)) {
              ...
              {
                paramMessage = (awhl)this.a.app.getManager(16);
            ...
            for (;;)
            {
              ...
              return;
              paramMessage = bglf.e(this.a.app, ChatSettingActivity.c(this.a));
              ...
              bool1 = false;
              break label308;
              paramMessage = (anmw)this.a.app.getManager(51);
              if (paramMessage != null)
              {
