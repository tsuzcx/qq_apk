...
public class bmos
{
  ...
  public static android.graphics.Bitmap a(String paramString, android.graphics.BitmapFactory.Options paramOptions)
  {
    ...
    //   108: aload_1
    //   109: aload_0
    //   110: invokevirtual 89	android/graphics/Bitmap:getHeight	()I
    //   113: putfield 93	android/graphics/BitmapFactory$Options:outHeight	I
    //   116: aload 6
    //   118: astore_2
    //   119: aload_1
    //   120: aload_0
    //   121: invokevirtual 96	android/graphics/Bitmap:getWidth	()I
    //   124: putfield 99	android/graphics/BitmapFactory$Options:outWidth	I
    //   127: aload 5
    //   129: astore_2
    //   130: goto -72 -> 58
    //   133: aload 6
    //   135: astore_2
    //   136: invokestatic 105	com/tencent/common/app/BaseApplicationImpl:getApplication	()Lcom/tencent/common/app/BaseApplicationImpl;
    //   139: invokevirtual 109	com/tencent/common/app/BaseApplicationImpl:getRuntime	()Lmqq/app/AppRuntime;
    //   142: instanceof 111
    //   145: ifeq +33 -> 178
    //   148: aload 6
    //   150: astore_2
    //   151: invokestatic 117	com/tencent/component/media/image/ImageManager:getInstance	()Lcom/tencent/component/media/image/ImageManager;
    //   154: invokevirtual 121	com/tencent/component/media/image/ImageManager:getDecoder	()Lcom/tencent/component/media/image/IDecoder;
    //   157: new 13	java/io/File
    //   160: dup
    //   161: aload_0
    //   162: invokespecial 74	java/io/File:<init>	(Ljava/lang/String;)V
    //   165: aload_1
    //   166: invokeinterface 127 3 0
    //   171: astore_0
    //   172: aload 5
    //   174: astore_2
    //   175: goto -117 -> 58
    ...
    //   181: aload_0
    //   182: aload_1
    //   183: invokestatic 131	com/tencent/image/SafeBitmapFactory:decodeFile	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   186: astore_0
    //   187: aload 5
    //   189: astore_2
    //   190: goto -132 -> 58
    ...
    //   196: aload_3
    //   197: astore_2
    //   198: invokestatic 137	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   201: ifeq +14 -> 215
    //   204: aload_3
    //   205: astore_2
    //   206: ldc 139
    ...
    //   209: ldc 141
    //   211: aload_1
    //   212: invokestatic 145	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   215: aload_0
    //   216: astore_1
    //   217: aload_3
    //   218: ifnull -148 -> 70
    //   221: aload_3
    //   222: invokevirtual 73	java/io/InputStream:close	()V
    //   225: aload_0
    //   226: areturn
    //   227: astore_1
    //   228: aload_0
    ...
    //   249: ldc 141
    //   251: aload_1
    //   252: invokestatic 145	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   255: aload_0
    //   256: astore_1
    //   257: aload_3
    //   258: ifnull -188 -> 70
    //   261: aload_3
    //   262: invokevirtual 73	java/io/InputStream:close	()V
    //   265: aload_0
    //   266: areturn
    //   267: astore_1
    //   268: aload_0
    ...
    //   272: ifnull +7 -> 279
    //   275: aload_2
    //   276: invokevirtual 73	java/io/InputStream:close	()V
    //   279: aload_0
    //   280: athrow
    //   281: astore_1
    //   282: aload_0
