...
public class aftr
{
  ...
  public static int a(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo, ArrayList<String> paramArrayList, Intent paramIntent1, Intent paramIntent2)
  {
    ...
    if ((paramIntent1 == null) || (!paramIntent1.hasExtra("showFlashPic")))
    {
      ...
      paramIntent2.putExtra("showFlashPic", anud.a(paramSessionInfo.curType, (HotChatManager)localObject, paramSessionInfo.troopUin));
    }
    ...
    for (;;)
    {
      ...
      paramIntent2.putExtra("is_anonymous", nty.a().a(paramSessionInfo.curFriendUin));
      ...
      if ((paramIntent1 != null) && (paramIntent1.getBooleanExtra("ReceiptMsgManager.EXTRA_KEY_IS_RECEIPT", false)))
      {
        ...
        paramIntent2.putExtra("PhotoConst.MAXUM_SELECTED_NUM", Math.min(bbbf.b(paramQQAppInterface), j));
      }
      paramIntent2.putExtra("session_info", paramSessionInfo);
      ...
      if (paramSessionInfo.curType == 9501)
      {
        ...
        paramIntent2 = (abgm)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.DEVICEPROXYMGR_HANDLER);
        long l1;
  ...
  private static afua a(akym paramakym)
  {
    int i;
    String str;
    if (RedPacketManager.TYPEHBINFOMAP.get(Integer.valueOf(paramakym.jdField_a_of_type_Int)) == null)
    {
      i = 1;
      str = String.valueOf(2);
      switch (paramakym.jdField_a_of_type_Int)
      {
      case 4: 
      case 5: 
      default: 
    ...
    for (;;)
    {
      afua localafua = new afua(null);
      localafua.jdField_a_of_type_JavaLangString = str;
      localafua.jdField_a_of_type_Int = i;
      localafua.jdField_b_of_type_JavaLangString = paramakym;
      return localafua;
      i = ((Integer)RedPacketManager.TYPEHBINFOMAP.get(Integer.valueOf(paramakym.jdField_a_of_type_Int))).intValue();
      break;
  ...
  private static afub a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    int i = 1;
    int j = 1;
    Object localObject2 = "";
    Object localObject1 = (akqe)paramQQAppInterface.getManager(QQManagerFactory.PASSWD_RED_BAG_MANAGER);
    if (localObject1 != null) {}
    for (localObject1 = ((akqe)localObject1).a();; localObject1 = "")
    {
      ...
      for (;;)
      {
        localObject2 = new afub(null);
        ((afub)localObject2).jdField_b_of_type_JavaLangString = paramQQAppInterface;
        ((afub)localObject2).jdField_a_of_type_Int = j;
        ((afub)localObject2).jdField_b_of_type_Int = i;
        ((afub)localObject2).jdField_a_of_type_JavaLangString = paramSessionInfo;
        ((afub)localObject2).c = ((String)localObject1);
        return localObject2;
        if (paramSessionInfo.curType == 3000)
        {
          j = ((antp)paramQQAppInterface.getManager(QQManagerFactory.DISCUSSION_MANAGER)).a(paramSessionInfo.curFriendUin);
        ...
        else
        {
          ...
          {
            Object localObject3 = ((TroopManager)paramQQAppInterface.getManager(QQManagerFactory.TROOP_MANAGER)).b(paramSessionInfo.curFriendUin);
            j = i;
            ...
            try
            {
              ...
              localObject3 = (aoep)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.TROOP_HANDLER);
              if (jdField_a_of_type_Aofu == null) {
                jdField_a_of_type_Aofu = new aftt(paramSessionInfo);
              }
              paramQQAppInterface.addObserver(jdField_a_of_type_Aofu);
              ((aoep)localObject3).b(l, 32, 0);
            }
            ...
            {
              bdla.b(paramQQAppInterface, "CliOper", "", "", "0X8005B9C", "0X8005B9C", 0, 0, "", "", "", "");
              i = 6;
          ...
          else
          {
            if ((paramSessionInfo.curType == 1001) || (paramSessionInfo.curType == 10002) || (paramSessionInfo.curType == 10004))
            {
              ...
              label579:
              for (paramSessionInfo = bhcu.encodeToString(paramSessionInfo, 2);; paramSessionInfo = "")
              {
                bdla.b(paramQQAppInterface, "CliOper", "", "", "0X8005B9D", "0X8005B9D", 0, 0, "", "", "", "");
                paramQQAppInterface = "entrance.click.c2c";
                i = 7;
                break;
  ...
  private static Intent a(akym paramakym)
  {
    ...
    if ((paramakym != null) && (paramakym.jdField_a_of_type_Int == 3)) {
      if (paramakym.jdField_a_of_type_OrgJsonJSONObject == null) {
        break label96;
      }
    }
    label96:
    for (paramakym = paramakym.jdField_a_of_type_OrgJsonJSONObject.optString("theme_id", "");; paramakym = "")
    {
      localIntent.putExtra("theme_type", paramakym);
  ...
  private static void a(Activity paramActivity, Intent paramIntent, afub paramafub, afua paramafua, SessionInfo paramSessionInfo)
  {
    paramIntent.putExtra("vacreport_key_seq", VACDReportUtil.a(null, "qqwallet", "makeHongbao", "click", "groupType=" + paramafub.jdField_b_of_type_Int, 0, null));
    JSONObject localJSONObject = new JSONObject();
    try
    {
      localJSONObject.put("recv_type", paramafub.jdField_b_of_type_Int);
      localJSONObject.put("recv_uin", paramSessionInfo.curFriendUin);
      localJSONObject.put("channel", paramafua.jdField_a_of_type_Int);
      localJSONObject.put("bus_type", paramafua.jdField_a_of_type_JavaLangString);
      if (paramafub.jdField_a_of_type_Int > 0) {
        localJSONObject.put("people_num", paramafub.jdField_a_of_type_Int);
      }
      if (!TextUtils.isEmpty(paramafub.jdField_a_of_type_JavaLangString)) {
        localJSONObject.put("session_token", paramafub.jdField_a_of_type_JavaLangString);
      }
      if (!TextUtils.isEmpty(paramafub.c)) {
        localJSONObject.put("placeholder", paramafub.c);
      }
    }
    catch (JSONException paramafub)
    {
      for (;;)
      {
        paramafub.printStackTrace();
      }
    }
    if (QLog.isColorLevel()) {
  ...
  public static void a(Intent paramIntent, SessionInfo paramSessionInfo, QQAppInterface paramQQAppInterface)
  {
    if (a(paramSessionInfo, paramQQAppInterface.isLBSFriendNewClient(paramSessionInfo.curFriendUin)))
    {
      ...
      paramIntent.putExtra("binder_presendService", new BinderWarpper(new azkt(paramSessionInfo.curType, paramSessionInfo.curFriendUin, paramSessionInfo.troopUin, paramQQAppInterface.getAccount(), paramSessionInfo.topicId).asBinder()));
    }
  }
  ...
  public static void a(AppInterface paramAppInterface, Activity paramActivity, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      if (!bhbx.a())
      {
        QQToast.a(paramActivity, paramActivity.getResources().getString(2131718340), 0).a();
        return;
      }
      ...
      catch (Exception paramAppInterface)
      {
        for (;;)
        {
          ...
          QQToast.a(paramActivity, 2131690695, 0).a();
        }
      }
    }
  }
  ...
  private static void a(QQAppInterface paramQQAppInterface, int paramInt, SessionInfo paramSessionInfo, afub paramafub, afua paramafua)
  {
    if (paramInt == 0)
    {
      ahpt.a(paramQQAppInterface, "0X8005CAF", paramSessionInfo.curType);
      if (jdField_a_of_type_Int != 0) {
        break label104;
      }
      paramafub.jdField_b_of_type_JavaLangString += ".plus";
    }
    for (;;)
    {
      bdla.b(paramQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", paramafub.jdField_b_of_type_JavaLangString, 0, 0, paramafua.jdField_b_of_type_JavaLangString, "", "", "");
      return;
      if (paramInt != 1) {
        break;
      }
      ahpt.a(paramQQAppInterface, "0X8005FC9", paramSessionInfo.curType);
      break;
      label104:
      if (jdField_a_of_type_Int == 1) {
        paramafub.jdField_b_of_type_JavaLangString += ".quick";
      }
    }
  }
  ...
  {
    bmhg.a(paramQQAppInterface, "tenpay.com", new aftu(paramInt1, paramSessionInfo, paramQQAppInterface, paramInt2, paramString, paramActivity));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo, akym paramakym, List<akym> paramList, int paramInt)
  {
    if (paramakym == null) {
      return;
    }
    ...
    if (a(paramQQAppInterface, paramActivity, paramakym, paramSessionInfo, paramList))
    {
      QLog.i("PlusPanelUtils", 2, "---doSendHbJumpNoEnterSendHbActivity---");
      return;
    }
    afua localafua = a(paramakym);
    a(paramActivity, a(paramakym), paramList, localafua, paramSessionInfo);
    a(paramQQAppInterface, paramInt, paramSessionInfo, paramList, localafua);
  }
  ...
  {
    bdla.b(paramQQAppInterface, "CliOper", "", paramSessionInfo.curFriendUin, "Music_gene", "Music_gene_AIO", 0, 0, String.valueOf(a(paramSessionInfo.curType)), "", "", "");
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo, ArrayList<String> paramArrayList, Intent paramIntent, HashMap<LocalMediaInfo, LocalMediaInfo> paramHashMap)
  {
    ...
    for (;;)
    {
      ...
      paramIntent.putExtra("KEY_IS_ANONYMOUS", nty.a().a(paramSessionInfo.curFriendUin));
      localIntent.putExtra("enter_from", 1);
      ...
      for (;;)
      {
        ...
        return;
        paramQQAppInterface = akkq.a(paramHashMap);
  ...
  {
    new aftw(paramSessionInfo, paramQQAppInterface, paramContext, bheg.b(paramContext, paramUri)).execute(new Void[0]);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, boolean paramBoolean, String paramString, BaseChatPie paramBaseChatPie)
  {
    ...
    if (((paramSessionInfo.curType == 1025) || (paramSessionInfo.curType == 0) || (paramSessionInfo.curType == 1000) || (paramSessionInfo.curType == 1004)) && (((bjxa)paramQQAppInterface.getManager(QQManagerFactory.QIDIAN_MANAGER)).d(paramSessionInfo.curFriendUin)))
    {
      arrayOfInt[0] = 5;
      localmvn.b(2131697987);
    }
    for (int i = 1;; i = 0)
    {
      arrayOfInt[i] = 1;
      ...
      localmvn.a(new afts(paramQQAppInterface));
      localmvn.a(new aftv(localmvn, arrayOfInt, paramSessionInfo, paramQQAppInterface, paramBaseChatPie, paramContext, paramString));
      localmvn.show();
      bdla.b(paramQQAppInterface, "CliOper", "", "", "0X8004D68", "0X8004D68", 0, 0, "", "", "", "");
      return;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, boolean paramBoolean, String paramString, Map<String, String> paramMap)
  {
    ...
    for (;;)
    {
      bdla.b(paramQQAppInterface, "CliOper", "", "", (String)localObject2, (String)localObject2, 0, 0, (String)localObject1, "", "", "");
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, BaseActivity paramBaseActivity, SessionInfo paramSessionInfo, int paramInt1, int paramInt2)
  {
    ...
    if (AudioHelper.b(0))
    {
      bhdj.a(paramContext, 230, paramContext.getString(2131698169), paramContext.getString(2131698170), new aftx(), null).show();
      return;
    }
    if (AudioHelper.a(0))
    {
      bhdj.a(paramContext, 230, paramContext.getString(2131698169), paramContext.getString(2131698171), new afty(), null).show();
      return;
    }
    if (paramQQAppInterface.getApp().checkPermission("android.permission.CAMERA", Process.myPid(), Process.myUid()) != 0)
    {
      bhdj.a(paramContext, 230, paramContext.getString(2131698169), anvx.a(2131707764), new aftz(), null).show();
      return;
    }
    if (paramInt2 == 0) {}
    for (int i = 1;; i = 17000)
    {
      ...
      absy.a(paramQQAppInterface, Long.parseLong(paramSessionInfo.curFriendUin), "Usr_AIO_SendMsg", 2, 0, paramInt1);
      return;
    }
  }
  
  private static void a(List<akym> paramList)
  {
  ...
  private static boolean a(QQAppInterface paramQQAppInterface, Activity paramActivity, akym paramakym, SessionInfo paramSessionInfo, afub paramafub)
  {
    switch (paramakym.jdField_a_of_type_Int)
    {
    default: 
    ...
    case 5: 
      ...
      paramakym = new Intent(paramActivity, QrcodeHbGuiderActivity.class);
      paramakym.putExtra("appInfo", "");
      paramakym.putExtra("vacreport_key_seq", l);
      paramActivity.startActivity(paramakym);
      bdla.b(paramQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "plus.hongbao.click", 0, 0, "", "", "", "");
      return true;
    case 4: 
      if (paramakym.jdField_a_of_type_OrgJsonJSONObject != null)
      {
        localObject = paramakym.jdField_a_of_type_OrgJsonJSONObject.optString("url", "");
        QLog.i("PlusPanelUtils", 2, (String)localObject);
        if (TextUtils.isEmpty((CharSequence)localObject)) {
          return true;
        }
        paramQQAppInterface = (QQAppInterface)localObject;
        if (paramakym.jdField_a_of_type_OrgJsonJSONObject.optInt("subtype", 0) == 1) {
          if (((String)localObject).indexOf("?") != -1) {
            break label262;
          }
        }
      }
      for (paramQQAppInterface = (String)localObject + "?recv_uin=" + paramSessionInfo.curFriendUin + "&recv_type=" + paramafub.jdField_b_of_type_Int;; paramQQAppInterface = (String)localObject + "&recv_uin=" + paramSessionInfo.curFriendUin + "&recv_type=" + paramafub.jdField_b_of_type_Int)
      {
    ...
    case 12: 
      label262:
      paramakym = paramakym.jdField_a_of_type_OrgJsonJSONObject.optString("schema");
      QLog.i("PlusPanelUtils", 2, paramakym);
      if (TextUtils.isEmpty(paramakym)) {
        return true;
      }
      a(paramQQAppInterface, paramActivity, paramSessionInfo, paramafub.jdField_b_of_type_Int, paramafub.jdField_a_of_type_Int, paramakym);
      return true;
    }
    paramakym = paramakym.jdField_a_of_type_OrgJsonJSONObject.optString("schema", "");
    QLog.i("PlusPanelUtils", 2, paramakym);
    ...
    ((Map)localObject).put("recv_group_type", paramafub.jdField_b_of_type_Int + "");
    ...
    paramQQAppInterface = bmhg.a(paramakym, (Map)localObject, true);
    if (QLog.isColorLevel()) {
      QLog.i("PlusPanelUtils", 2, "[go to miniapp] finalSchame: " + paramQQAppInterface);
    }
    albv.a(paramActivity, paramQQAppInterface);
    return true;
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo)
  {
    ...
    bmaf.a(paramActivity, paramQQAppInterface.getAccount(), localIntent, -1, false);
    bman.b(paramQQAppInterface, 3, paramSessionInfo.curType);
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, boolean paramBoolean, String paramString, Map<String, String> paramMap)
  {
    ...
    for (localObject = paramSessionInfo.curFriendUin; paramString == null; localObject = ((awyz)localObject).b(str))
    {
  ...
  public static void c(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo)
  {
    ...
    paramQQAppInterface.putExtra(bhcc.h, 84);
