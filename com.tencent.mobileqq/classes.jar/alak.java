...
public class alak
{
  ...
  public long a;
  private alal jdField_a_of_type_Alal = new alal();
  ...
  public alal a(int paramInt1, int paramInt2)
  {
    if (this.jdField_f_of_type_Boolean)
    {
      ...
      localObject2 = new alal();
      ((alal)localObject2).a("TARGET_SIZE", new float[] { 1.0F, 1.0F });
      ((alal)localObject2).a("CAMERA_MATRIX", arrayOfFloat2);
      ((alal)localObject2).a("CAMERA_POSITION", localObject1);
      ((alal)localObject2).a("POSE", arrayOfFloat1);
      return localObject2;
    }
    if (paramInt1 == 100)
    {
      ...
      ((alal)localObject2).a("CAMERA_POSITION", localObject1);
      ((alal)localObject2).a("POSE", arrayOfFloat1);
      ((alal)localObject2).jdField_a_of_type_ArrayOfFloat = this.jdField_e_of_type_ArrayOfFloat;
      return localObject2;
    }
    if (paramInt1 == 8)
    {
      localObject1 = new alal();
      this.jdField_b_of_type_Int = 1;
      arrayOfFloat1 = new float[jdField_a_of_type_Int];
      arrayOfFloat2 = new float[jdField_a_of_type_Int];
      ...
      Matrix.setIdentityM(arrayOfFloat1, 0);
      ((alal)localObject1).a("TARGET_SIZE", new float[] { 1.0F, 1.0F });
      ((alal)localObject1).a("CAMERA_MATRIX", localObject2);
      ((alal)localObject1).a("CAMERA_POSITION", arrayOfFloat1);
      ((alal)localObject1).a("POSE", arrayOfFloat2);
      ((alal)localObject1).jdField_a_of_type_ArrayOfFloat = this.jdField_e_of_type_ArrayOfFloat;
      return localObject1;
    }
    ...
    if ((this.jdField_h_of_type_Boolean) && (((paramInt2 == 0) && (!this.jdField_c_of_type_Boolean)) || (paramInt2 == 2) || ((paramInt2 == 1) && (!this.jdField_d_of_type_Boolean))))
    {
      ...
      localalal = new alal();
      localalal.a("TARGET_SIZE", localObject1);
      localalal.a("CAMERA_MATRIX", localObject2);
      localalal.a("CAMERA_POSITION", arrayOfFloat1);
      localalal.a("POSE", arrayOfFloat2);
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Alal.a("TARGET_SIZE", new float[] { 1.0F, 1.0F });
    this.jdField_a_of_type_Alal.a("POSE", arrayOfFloat1);
    this.jdField_a_of_type_Alal.a("CAMERA_MATRIX", arrayOfFloat2);
    this.jdField_a_of_type_Alal.a("CAMERA_POSITION", arrayOfFloat3);
    this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.unlock();
  }
  
  public void a(int paramInt1, int paramInt2, aldz paramaldz)
  {
    ...
    float f3;
    if (paramInt2 == 0) {
      if ((paramaldz.jdField_a_of_type_Int == 0) || (paramaldz.jdField_b_of_type_Int == 0))
      {
        this.k[0] = allh.jdField_a_of_type_Int;
        this.k[1] = allh.jdField_b_of_type_Int;
        paramaldz = new float[jdField_a_of_type_Int];
        Matrix.setIdentityM(paramaldz, 0);
        Matrix.perspectiveM(paramaldz, 0, 45.0F, 1.0F * allh.jdField_b_of_type_Int / allh.jdField_a_of_type_Int, 100.0F, 8000.0F);
        float[] arrayOfFloat = new float[16];
        Matrix.setRotateM(arrayOfFloat, 0, 270.0F, 0.0F, 0.0F, 1.0F);
        Matrix.multiplyMM(this.l, 0, arrayOfFloat, 0, paramaldz, 0);
        if (paramInt2 != 0) {
          break label659;
        }
        f1 = 1.25F;
        if (this.k[0] <= allh.jdField_a_of_type_Int) {
          break label665;
        }
        f2 = this.k[0];
        if (this.k[0] == 0.0F) {
        ...
        f3 = this.k[1] / this.k[0] / (1.0F * allh.jdField_b_of_type_Int / allh.jdField_a_of_type_Int);
        label233:
        if ((f3 <= 1.0F) || (this.k[1] <= allh.jdField_b_of_type_Int)) {
          break label680;
        }
        f1 *= f3;
      }
    ...
    for (;;)
    {
      ...
      paramaldz = new float[jdField_a_of_type_Int];
      Matrix.setIdentityM(paramaldz, 0);
      Matrix.translateM(paramaldz, 0, this.k[1] / 2.0F, -this.k[0] / 2.0F, -f2 / 2.0F * 2.414214F * f1);
      Matrix.rotateM(paramaldz, 0, 90.0F, 0.0F, 0.0F, 1.0F);
      System.arraycopy(paramaldz, 0, this.m, 0, jdField_a_of_type_Int);
      ...
      System.arraycopy(this.n, 0, this.j, 0, jdField_a_of_type_Int);
      return;
      this.k[0] = paramaldz.jdField_a_of_type_Int;
      this.k[1] = paramaldz.jdField_b_of_type_Int;
      break;
  ...
  public void a(alai paramalai)
  {
    ...
    paramalai = (alag)paramalai;
    this.jdField_c_of_type_Int = paramalai.jdField_a_of_type_Int;
    this.jdField_g_of_type_ArrayOfFloat[0] = paramalai.jdField_a_of_type_Float;
    this.jdField_g_of_type_ArrayOfFloat[1] = paramalai.jdField_b_of_type_Float;
    System.arraycopy(paramalai.jdField_b_of_type_ArrayOfFloat, 0, this.jdField_h_of_type_ArrayOfFloat, 0, jdField_a_of_type_Int);
    this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.lock();
    System.arraycopy(paramalai.jdField_a_of_type_ArrayOfFloat, 0, this.jdField_i_of_type_ArrayOfFloat, 0, jdField_a_of_type_Int);
    this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.unlock();
    System.arraycopy(paramalai.jdField_a_of_type_ArrayOfFloat, 0, this.j, 0, jdField_a_of_type_Int);
  }
  
  public void a(boolean paramBoolean, alah paramalah)
  {
    QLog.i("AREngine_ARRenerArumentManager", 1, "start. trackMode = " + paramalah.jdField_b_of_type_Int + ", arType = " + paramalah.jdField_a_of_type_Int + ", isObjectAnim = " + paramBoolean);
    this.jdField_f_of_type_Boolean = paramBoolean;
    this.jdField_b_of_type_Int = paramalah.jdField_b_of_type_Int;
    this.jdField_c_of_type_Int = paramalah.jdField_c_of_type_Int;
    this.jdField_h_of_type_Boolean = false;
    if ((this.jdField_f_of_type_Boolean) || (paramalah.jdField_a_of_type_Int == 100) || (paramalah.jdField_a_of_type_Int == 8))
    {
      this.jdField_g_of_type_Boolean = true;
      return;
    }
    Object localObject;
    if (paramalah.jdField_a_of_type_Int == 0)
    {
      localObject = (alat)paramalah;
      a(this.jdField_b_of_type_Int, paramalah.jdField_a_of_type_Int, ((alat)localObject).a);
    }
    for (;;)
    {
      this.jdField_g_of_type_Boolean = true;
      return;
      if ((paramalah.jdField_a_of_type_Int == 2) || (paramalah.jdField_a_of_type_Int == 3))
      {
        localObject = (albc)paramalah;
        a(this.jdField_b_of_type_Int, paramalah.jdField_a_of_type_Int, ((albc)localObject).a);
      }
      else if (paramalah.jdField_a_of_type_Int == 4)
      {
        localObject = (albf)paramalah;
        a(this.jdField_b_of_type_Int, paramalah.jdField_a_of_type_Int, ((albf)localObject).a);
      }
    }
  }
