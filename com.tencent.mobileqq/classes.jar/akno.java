...
import com.tencent.mobileqq.app.icebreaking.AIOIceBreakShow.1;
import com.tencent.mobileqq.app.icebreaking.AIOIceBreakShow.2;
import com.tencent.mobileqq.app.icebreaking.AIOIceBreakShow.5;
...
public class akno
  implements aknt, Handler.Callback
{
  private static int jdField_a_of_type_Int;
  private acyq jdField_a_of_type_Acyq;
  private aknv jdField_a_of_type_Aknv;
  private Animator.AnimatorListener jdField_a_of_type_AndroidAnimationAnimator$AnimatorListener = new aknq(this);
  private ValueAnimator.AnimatorUpdateListener jdField_a_of_type_AndroidAnimationValueAnimator$AnimatorUpdateListener = new aknp(this);
  ...
  public akno(BaseChatPie paramBaseChatPie, Context paramContext, String paramString)
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie = paramBaseChatPie;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_Aknv = ((aknv)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(285));
    this.jdField_a_of_type_Bfmt = new bfmt(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a().getLooper(), this);
    jdField_a_of_type_Int = actn.a(150.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.jdField_a_of_type_Acyq = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Acyq;
  }
  
  private void a(int paramInt, String paramString)
  {
    ThreadManager.getSubThreadHandler().postDelayed(new AIOIceBreakShow.1(this, paramInt, paramString), this.jdField_a_of_type_Aknv.jdField_a_of_type_Int * 1000L);
  }
  ...
  private boolean a()
  {
    ...
    for (Object localObject = (ViewGroup)localObject;; localObject = null) {
      return ((ViewGroup)localObject).getId() == 2131362314;
    }
  }
  
  private void b(int paramInt, String paramString)
  {
    ThreadManager.getFileThreadHandler().post(new AIOIceBreakShow.2(this, paramInt, paramString));
  }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetLinearLayout == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setTag(2131362261, Integer.valueOf(this.c));
    ...
    ajfa.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "ice_break", true);
    c();
    ...
    if (paramBoolean)
    {
      ...
      this.jdField_a_of_type_Acyq.a(3, 0);
      this.jdField_a_of_type_Acyq.a(0, false, "icebreak_showFooter", 0);
      ...
      if (QLog.isColorLevel()) {
        QLog.d("AIOIceBreakShow", 2, "real show duration = " + this.jdField_a_of_type_Aknv.jdField_a_of_type_Int);
      }
    ...
    for (;;)
    {
      axqw.b((QQAppInterface)localObject, "dc00898", "", "", "0X8009B95", "0X8009B95", i, 0, "", "", "", "");
      return;
      this.jdField_a_of_type_Acyq.a(3, jdField_a_of_type_Int);
      this.jdField_a_of_type_Acyq.a(jdField_a_of_type_Int, false, "icebreak_showFooter", 0);
      break;
      label606:
      i = 2;
    }
  ...
  private void c()
  {
    ...
    if (localObject1 != null)
    {
      ...
      if (((View)localObject1).getId() == 2131362314) {
        i = ((Rect)localObject2).top;
      }
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a().findViewById(2131368187);
      localObject2 = new Rect();
      ((View)localObject1).getGlobalVisibleRect((Rect)localObject2);
    ...
    for (;;)
    {
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Acyq;
      if (this.jdField_a_of_type_AndroidWidgetLinearLayout.getParent() != null)
      {
        if (!(a() ^ i))
        {
      ...
      if (i != 0)
      {
        ((acyq)localObject1).a(this.jdField_a_of_type_AndroidWidgetLinearLayout, (FrameLayout.LayoutParams)localObject2);
      ...
      ((FrameLayout)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a().findViewById(2131371906)).addView(this.jdField_a_of_type_AndroidWidgetLinearLayout, (ViewGroup.LayoutParams)localObject2);
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  private void d()
  {
    ...
    ajfa.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "ice_break", false);
  }
  ...
  {
    if (akny.d(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int))
    {
      if (QLog.isColorLevel()) {
        QLog.i("IceBreak.IceBreakingUtil", 2, "onImageClick remove matchChat Ice show");
      }
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aequ)) {
        ((aequ)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).bp();
      }
  ...
  {
    int i = this.jdField_a_of_type_Aknv.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int);
    if (QLog.isColorLevel()) {
    ...
    if (i != -1)
    {
      ...
      paramList = this.jdField_a_of_type_Bfmt.obtainMessage(0, 1, 0);
      this.jdField_a_of_type_Bfmt.sendMessage(paramList);
      return;
    }
    this.c = i;
    this.jdField_a_of_type_JavaUtilList = paramList;
    this.jdField_a_of_type_Bfmt.sendEmptyMessage(2);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_Boolean ^ paramBoolean))
    {
      ...
      if ((this.jdField_b_of_type_Int == 0) && (!this.jdField_b_of_type_Boolean))
      {
        ...
        localMessage = this.jdField_a_of_type_Bfmt.obtainMessage(1, 0, 0);
    ...
    this.jdField_a_of_type_Bfmt.removeMessages(0);
    this.jdField_a_of_type_Bfmt.removeMessages(1);
    Message localMessage = this.jdField_a_of_type_Bfmt.obtainMessage(0, 0, 0);
    this.jdField_a_of_type_Bfmt.sendMessage(localMessage);
  }
