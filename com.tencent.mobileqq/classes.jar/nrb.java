...
public class nrb
{
  ...
  public boolean a(Context paramContext, MessageRecord paramMessageRecord, TextView paramTextView, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        boolean bool = bbjw.a(paramString);
        if (bool) {
          return false;
        }
        try
        {
          ...
          {
            paramTextView.setBackgroundResource(2130846190);
            paramTextView.setVisibility(0);
            paramTextView.setText(ajyc.a(2131703611));
            localObject1 = paramContext.getResources().getDrawable(2130846193);
            ((Drawable)localObject1).setBounds(0, 0, 24, 16);
            paramTextView.setCompoundDrawables(null, null, (Drawable)localObject1, null);
            i = vzo.a(paramContext, 6.0F);
            paramTextView.setPadding(i, 0, i, 0);
            paramTextView.setCompoundDrawablePadding(vzo.a(paramContext, 2.0F));
            ...
            LinearLayout localLinearLayout = (LinearLayout)((View)localObject1).findViewById(2131369372);
            ...
            if (i < paramString.length())
            {
              ...
              ((LinearLayout)localObject3).setOnClickListener(new nrc(this, j, (JSONObject)localObject2, paramContext, paramMessageRecord));
              ...
              ((LinearLayout.LayoutParams)localObject4).height = vzo.a(paramContext, 50.0F);
              ...
              ((LinearLayout.LayoutParams)localObject5).width = vzo.a(paramContext, 20.0F);
              ((LinearLayout.LayoutParams)localObject5).height = vzo.a(paramContext, 18.0F);
              ((LinearLayout.LayoutParams)localObject5).leftMargin = vzo.a(paramContext, 15.0F);
              localObject5 = ((JSONObject)localObject2).optString("icon_url", "");
              if (!bbjw.a((String)localObject5))
              {
                URLDrawable.URLDrawableOptions localURLDrawableOptions = URLDrawable.URLDrawableOptions.obtain();
                localURLDrawableOptions.mRequestHeight = vzo.a(paramContext, 20.0F);
                localURLDrawableOptions.mRequestWidth = vzo.a(paramContext, 18.0F);
              ...
              ((LinearLayout.LayoutParams)localObject3).leftMargin = vzo.a(paramContext, 10.0F);
              ...
              ((LinearLayout.LayoutParams)localObject3).height = vzo.a(paramContext, 1.0F);
        ...
        catch (JSONException paramString)
        {
          ...
          paramTextView.setOnClickListener(new nrd(this, paramContext, paramTextView, paramMessageRecord));
          return true;
        }
        return false;
      }
