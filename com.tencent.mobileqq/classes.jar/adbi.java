...
public class adbi
{
  ...
  public adbi(SharedPreferences paramSharedPreferences, String paramString)
  {
  ...
  public static adbi a(JSONObject paramJSONObject)
  {
    adbi localadbi = new adbi();
    try
    {
      localadbi.a = paramJSONObject.getString("name").trim();
      localadbi.b = paramJSONObject.getString("ver").trim();
      localadbi.c = paramJSONObject.getString("system").trim();
      localadbi.d = paramJSONObject.getString("driver").trim();
      localadbi.e = paramJSONObject.getString("url").trim();
      localadbi.f = paramJSONObject.getString("type").trim();
      localadbi.h = paramJSONObject.getString("enabled").trim();
      localadbi.k = paramJSONObject.optString("previousPatch", "").trim();
      return localadbi;
    }
    catch (Exception paramJSONObject)
    {
      adax.a("PatchInfo", "Parse PatchInfo from JSON exception " + paramJSONObject);
    }
    return null;
  }
  ...
  public JSONObject a()
  {
    ...
    {
      adax.a("PatchInfo", "Get JSON String failed " + localJSONException);
    }
