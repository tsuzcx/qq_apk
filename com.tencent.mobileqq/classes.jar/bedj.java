...
public class bedj
  extends beci
{
  public bedj(TeamWorkAuthorizeSettingFragment paramTeamWorkAuthorizeSettingFragment) {}
  
  public void a(boolean paramBoolean, String paramString, int paramInt)
  {
    this.a.stopTitleProgress();
    if (!paramBoolean) {
      audr.a(anvx.a(2131714183));
    }
  ...
  public void a(boolean paramBoolean, String paramString, int paramInt, List<TimDocSSOMsg.UinRightInfo> paramList)
  {
    ...
    while (paramString.hasNext())
    {
      ...
      localbeax.jdField_a_of_type_JavaLangString = String.valueOf(paramList.uint64_uin.get());
      localbeax.jdField_a_of_type_ComTencentPbTeamworkTimDocSSOMsg$UinRightInfo = paramList;
      this.a.jdField_a_of_type_Beav.a(localbeax);
    }
    this.a.b = paramInt;
    TeamWorkAuthorizeSettingFragment.a(this.a, this.a.b);
    TeamWorkAuthorizeSettingFragment.a(this.a);
  ...
  public void b(boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    this.a.stopTitleProgress();
    if (!paramBoolean) {
      audr.a(anvx.a(2131714126));
    }
    Intent localIntent;
    do
    {
      return;
      audr.b(anvx.a(2131714128));
      this.a.stopTitleProgress();
