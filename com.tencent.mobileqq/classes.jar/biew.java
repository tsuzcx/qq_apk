  ...
  implements View.OnTouchListener
{
  ...
  public biew(biev parambiev)
  {
    this.jdField_a_of_type_Biev = parambiev;
  }
  
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    if (this.jdField_a_of_type_Biev == null) {}
    do
    {
      do
      {
        ...
        do
        {
          ...
          {
            this.jdField_a_of_type_Biev.a(paramMotionEvent);
            return true;
          }
          this.jdField_b_of_type_AndroidViewMotionEvent = MotionEvent.obtain(paramMotionEvent);
          this.jdField_b_of_type_Boolean = this.jdField_a_of_type_Biev.a(this.jdField_a_of_type_AndroidViewMotionEvent, this.jdField_b_of_type_AndroidViewMotionEvent);
    ...
    if (!this.jdField_a_of_type_Boolean) {
      this.jdField_a_of_type_Biev.onClick(paramView);
    }
