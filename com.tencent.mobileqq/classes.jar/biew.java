  ...
  implements View.OnClickListener
{
  ...
  public void a(int paramInt1, int paramInt2)
  {
    if (Build.VERSION.SDK_INT >= 21)
    {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer.setOutlineProvider(new bied(paramInt2));
      ...
      {
        this.jdField_a_of_type_AndroidWidgetFrameLayout.setOutlineProvider(new bied(paramInt1));
  ...
  public void a(Context paramContext)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer.setBackgroundColor(paramContext.getResources().getColor(2131167224));
    this.jdField_a_of_type_AndroidWidgetFrameLayout = new FrameLayout(paramContext);
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setId(2131374368);
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setBackgroundColor(paramContext.getResources().getColor(2131167224));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate(paramContext, 2131561632, null));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131374355));
    this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(anni.a(2131703415));
  ...
  {
    this.jdField_a_of_type_Bieu = parambieu;
  }
  ...
  {
    if ((paramInt != 1) || (this.jdField_a_of_type_Bieu == null) || (!this.jdField_a_of_type_Bieu.a()))
    {
      this.jdField_a_of_type_Bieu = null;
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      if ((i == 2131374361) && (this.jdField_a_of_type_Bieu != null)) {
        this.jdField_a_of_type_Bieu.a(this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer.a(), this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer.b());
      }
    }
  }
}
