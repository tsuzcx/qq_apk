...
public class alxd
{
  private static alxd jdField_a_of_type_Alxd;
  public static final String a;
  public static final String b;
  private static boolean jdField_b_of_type_Boolean;
  public static final String c;
  private static final String d = alwf.jdField_a_of_type_JavaLangString + "/qav" + File.separator + "beauty" + File.separator;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = alwf.jdField_a_of_type_JavaLangString + "/qsvf" + File.separator;
  ...
  public static int a(Context paramContext)
  {
    ...
    if ((j > 0) && (!new File(jdField_a_of_type_JavaLangString + "filter_config.xml").exists())) {
      lbj.c("VideoFilterTools", "getQQShortVideoFilterConfigVersion config file don't exist!");
    }
    for (;;)
    {
      lbj.c("VideoFilterTools", "getQQShortVideoFilterConfigVersion:" + i);
      return i;
      i = j;
    }
  }
  ...
  {
    if (jdField_a_of_type_Alxd == null) {
      jdField_a_of_type_Alxd = new alxd();
    }
    return jdField_a_of_type_Alxd;
  }
  
  private static alxi a(String paramString)
  {
    if (TextUtils.isEmpty(paramString))
    {
      lbj.c("VideoFilterTools", "parseConfig|content is empty.");
      return null;
    }
    for (;;)
    {
      ...
      try
      {
        ...
        localalxi = new alxi(i, str1, str2);
        try
        {
          lbj.c("VideoFilterTools", "parseConfig:" + i + "|" + str1 + "|" + str2);
          return localalxi;
        }
      ...
      try
      {
        ...
        lbj.c("VideoFilterTools", "parseConfig failed. info = " + localJSONObject);
        return localalxi;
      }
      catch (JSONException localJSONException2)
      {
        localJSONException2.printStackTrace();
        lbj.c("VideoFilterTools", "parseConfig|parse failed.context = " + paramString);
        return localalxi;
      }
    }
  }
  ...
  public static String a(Context paramContext)
  {
    try
    {
      ...
      lbj.c("VideoFilterTools", "getQQShortVideoFilterConfig:" + jdField_a_of_type_JavaLangString + "filter_config.xml" + "|" + localFile.exists());
      if (localFile.exists()) {
  ...
  {
    lbj.c("VideoFilterTools", "setQQShortVideoFilterConfigVersion:" + paramInt);
    paramContext = PreferenceManager.getDefaultSharedPreferences(paramContext).edit();
  ...
  public static void a(Context paramContext, String paramString, int paramInt)
  {
    if (paramString == null)
    {
      lbj.c("VideoFilterTools", "updateQQShortVideoFilterConfig error ");
      return;
    }
  ...
  static void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        lbj.c("VideoFilterTools", "compareContent :" + (l2 - l1));
        return;
        ...
        if (paramString1 != null)
        {
          ...
          while (paramString1.hasNext())
          {
            ...
            while (localIterator.hasNext())
            {
              ...
              {
                lbj.c("VideoFilterTools", "compareContent res:" + localFilterDesc.name + "|" + localFilterDesc.resMD5 + "|" + paramString2.resMD5);
                ...
                lbj.c("VideoFilterTools", "compareContent iconMD5:" + localFilterDesc.name + "|" + localFilterDesc.iconMD5 + "|" + paramString2.iconMD5);
  ...
  {
    if (paramString == null) {
      lbj.c("VideoFilterTools", "handleQQSvCommonConfig empty content!");
    }
    do
    {
      for (;;)
      ...
      try
      {
        ...
        while (i < localJSONArray.length())
        {
          ...
          try
          {
            ...
            lbj.c("VideoFilterTools", "parseConfig:" + k + "|" + m + "|" + n + "|" + str5 + "|" + str1 + "|" + str4 + "|" + str2 + "|" + str3);
            i += 1;
          }
  ...
  public static boolean a(int paramInt1, long paramLong1, long paramLong2, int paramInt2)
  {
    ...
    if (i < paramInt2)
    {
      lbj.c("VideoFilterTools", "isSupportOfDevice error OSversion: " + i);
      return false;
    }
    paramInt2 = llk.e();
    if (paramInt2 < paramInt1)
    {
      lbj.c("VideoFilterTools", "isSupportOfDevice error cpucount: " + paramInt2);
      return false;
    }
    long l = llk.d();
    if (l < paramLong1)
    {
      lbj.c("VideoFilterTools", "isSupportOfDevice error cpuFrequency: " + l);
      return false;
    }
    paramLong1 = bhlo.d();
    if (paramLong1 < paramLong2)
    {
      lbj.c("VideoFilterTools", "isSupportOfDevice error memory: " + paramLong1);
      return false;
    }
    return true;
  }
  ...
  public static String b(Context paramContext)
  {
    try
    {
      ...
      lbj.c("VideoFilterTools", "getVideoEffectBeautyConfig:" + d + "beauty_config.json" + "|" + localFile.exists());
      if (localFile.exists()) {
        return bhmi.b(localFile);
      }
      b(paramContext, 0);
  ...
  public static void b(Context paramContext)
  {
    try
    {
      ...
      if ((paramContext != null) && (!TextUtils.isEmpty(paramContext.jdField_a_of_type_JavaLangString)))
      {
        ...
        lbj.c("VideoFilterTools", "preDownloadResource :" + ((File)localObject).exists());
        if (!((File)localObject).exists())
        {
          localObject = new beum();
          ((beum)localObject).jdField_a_of_type_Beuq = new alxf();
          ...
          ((beum)localObject).jdField_c_of_type_JavaLangString = (d + "skin_color.zip");
  ...
  {
    lbj.c("VideoFilterTools", "setVideoEffectBeautyConfigVersion:" + paramInt);
    paramContext = PreferenceManager.getDefaultSharedPreferences(paramContext).edit();
  ...
  public static boolean b(Context paramContext)
  {
    ...
    lbj.c("VideoFilterTools", "getIsFirstLauncher:" + i);
    if (i == 0) {
      bool = true;
    }
    return bool;
  ...
  public FilterRender a(int paramInt1, int paramInt2)
  {
    ...
    {
      lbj.c("VideoFilterTools", "getFilter|init texture.");
    ...
    {
      lbj.c("VideoFilterTools", "getFilterRender|destroy current filterRender.");
  ...
  public List<FilterDesc> a()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        lbj.c("VideoFilterTools", "getFilterDescs " + str1 + " exist: " + bool);
        if (bool)
        {
          ...
          lbj.c("VideoFilterTools", "getFilterDescs " + str2 + " exist: " + bool);
    ...
    while (((Iterator)???).hasNext())
    {
      ...
      lbj.c("VideoFilterTools", "getFilterDescs " + (String)localObject3 + " exist: " + bool);
      if (bool)
      {
  ...
  public void a()
  {
    this.jdField_a_of_type_Alxh = null;
    if (this.jdField_c_of_type_Int != -1) {
      this.jdField_c_of_type_Int = -1;
    }
    if (this.jdField_a_of_type_ArrayOfInt[0] != -1) {
  ...
  public void a(Context paramContext, alxh arg2)
  {
    if (QLog.isColorLevel()) {
      com.tencent.av.video.effect.QavVideoEffect.DEBUG_MODE = true;
    }
    lbj.c("VideoFilterTools", "init");
    if (this.jdField_a_of_type_JavaUtilArrayList == null) {
      this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
    }
    this.jdField_a_of_type_Alxh = ???;
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      a(a(paramContext), this.jdField_a_of_type_JavaUtilArrayList);
      a(this.jdField_a_of_type_JavaUtilArrayList);
      lbj.c("VideoFilterTools", "filter list size:" + this.jdField_a_of_type_JavaUtilArrayList.size());
  ...
  void a(List<FilterDesc> paramList)
  {
    if ((paramList == null) || (paramList.size() == 0)) {
      lbj.c("VideoFilterTools", "preDownloadResource list is empty!");
    }
    do
    {
      return;
      lbj.c("VideoFilterTools", "preDownloadResource list size: " + paramList.size());
      this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(0);
      paramList = paramList.iterator();
      while (paramList.hasNext())
      {
        FilterDesc localFilterDesc = (FilterDesc)paramList.next();
        lbj.c("VideoFilterTools", "preDownloadResource predownload: " + localFilterDesc.predownload + ", iconurl: " + localFilterDesc.iconurl + ", resurl:" + localFilterDesc.resurl);
        if (localFilterDesc.predownload == 1)
        {
          ...
          if (!TextUtils.isEmpty(localFilterDesc.iconurl))
          {
            ...
            lbj.c("VideoFilterTools", "preDownloadResource " + (String)localObject1 + " exist: " + ((File)localObject2).exists());
            if (!((File)localObject2).exists())
            {
              localObject2 = new beum();
              ((beum)localObject2).jdField_a_of_type_Beuq = new alxg(this);
              ((beum)localObject2).jdField_a_of_type_JavaLangString = localFilterDesc.iconurl;
              ((beum)localObject2).jdField_a_of_type_Int = 0;
              ((beum)localObject2).jdField_c_of_type_JavaLangString = ((String)localObject1);
          ...
          if ((!TextUtils.isEmpty(localFilterDesc.resurl)) && (!TextUtils.isEmpty((CharSequence)localObject1)))
          {
            ...
            lbj.c("VideoFilterTools", "preDownloadResource " + (String)localObject1 + "params.json" + " exist: " + ((File)localObject2).exists());
            if (!((File)localObject2).exists())
            {
              localObject1 = new beum();
              ((beum)localObject1).jdField_a_of_type_Beuq = new alxe(this);
              ((beum)localObject1).jdField_a_of_type_JavaLangString = localFilterDesc.resurl;
              ((beum)localObject1).jdField_a_of_type_Int = 0;
              ((beum)localObject1).jdField_c_of_type_JavaLangString = (jdField_b_of_type_JavaLangString + localFilterDesc.name + ".zip");
              ((beum)localObject1).a(localFilterDesc);
    ...
    } while ((this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 0) || (this.jdField_a_of_type_Alxh == null));
    this.jdField_a_of_type_Alxh.a(false);
  }
  ...
  public void b()
  {
    lbj.c("VideoFilterTools", "destroy");
  ...
  public void c(Context paramContext)
  {
    if (new File(d + "beauty_config.json").exists())
    {
      ...
      {
        lbj.c("VideoFilterTools", "!JasonFile.exists()");
        b(paramContext);
      }
      return;
    }
    lbj.c("VideoFilterTools", "BEAUTY_CONFIG  is not exsit");
  }
