...
public class ywb
{
  ...
  private ywf jdField_a_of_type_Ywf;
  ...
  public ywb(long paramLong1, long paramLong2)
  {
  ...
  private boolean a()
  {
    try
    {
      ...
      this.jdField_a_of_type_Ywg = new ywg(null, "MediaCodecGLFrameFetcher");
    }
    ...
    this.jdField_a_of_type_Ywg.b(new MediaCodecGLFrameFetcher.2(this));
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_Ywf = new ywf();
    this.jdField_a_of_type_Ywf.a(true);
    this.jdField_a_of_type_Ywf.a();
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture = new SurfaceTexture(this.jdField_a_of_type_Ywf.a());
    this.f = ywa.a(this.c, this.d);
  }
  
  private void d()
  {
    f();
    this.jdField_a_of_type_Ywg.b(new MediaCodecGLFrameFetcher.3(this));
  }
  ...
  private void g()
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture.setOnFrameAvailableListener(new ywc(this));
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_Ywg.b(new MediaCodecGLFrameFetcher.1(this));
      this.jdField_a_of_type_Ywg.a();
