...
public class nxs
  implements nxi
{
  public nxs(SensorAPIJavaScript paramSensorAPIJavaScript) {}
  ...
  public void a(int paramInt, SvcRespPushMsg paramSvcRespPushMsg)
  {
    if (this.a.jdField_a_of_type_AndroidAppActivity != null)
    {
      ...
      if (localAppInterface != null)
      {
        ...
        paramSvcRespPushMsg = new NewIntent(this.a.jdField_a_of_type_AndroidAppActivity.getApplicationContext(), aqte.class);
  ...
  {
    String str = SensorAPIJavaScript.jdField_a_of_type_Nxf.a(String.valueOf(paramInt));
