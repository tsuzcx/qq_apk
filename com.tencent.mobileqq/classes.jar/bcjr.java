  ...
  implements bckx
{
  ...
  public void a(JSONObject paramJSONObject, int paramInt, Bundle paramBundle)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        if (paramJSONObject != null)
        {
          ...
          return;
          if ((bcjl.a(this.a) != null) && (paramJSONObject != null)) {
            try
            {
            ...
            {
              bcjl.a(this.a).d(bcjl.a(this.a).getString(2131721032));
            }
          }
        }
      }
    ...
    return;
    label921:
    paramJSONObject = bcjl.a(this.a).getString(2131721032);
    switch (paramInt)
    {
    }
    for (;;)
    {
      bcjl.a(this.a).d(paramJSONObject);
      break label820;
      paramJSONObject = bcjl.a(this.a).getString(2131721027);
      continue;
      paramJSONObject = bcjl.a(this.a).getString(2131721033);
      continue;
      label1008:
      paramInt += 1;
      break;
