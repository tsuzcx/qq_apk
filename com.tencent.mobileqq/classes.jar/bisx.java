...
public class bisx
{
  ...
  public Frame a(Frame paramFrame, int paramInt1, int paramInt2, List<List<PointF>> paramList, List<float[]> paramList1)
  {
    ...
    for (;;)
    {
      if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Bisy != null))
      {
        GLES20.glEnable(3042);
        GLES20.glBlendFunc(770, 771);
        float f1 = -1.0F + this.jdField_a_of_type_Bisy.jdField_a_of_type_Float * 2.0F;
        float f2 = -1.0F + this.jdField_a_of_type_Bisy.b * 2.0F;
        float f3 = this.jdField_a_of_type_Bisy.c * 2.0F + f1;
        float f4 = this.jdField_a_of_type_Bisy.d * 2.0F + f2;
        this.jdField_a_of_type_ComTencentFilterBaseFilter.setPositions(new float[] { f1, f2, f1, f4, f3, f4, f3, f2 });
        this.jdField_a_of_type_ComTencentFilterBaseFilter.RenderProcess(this.jdField_a_of_type_Bisy.jdField_a_of_type_Int, paramFrame.width, paramFrame.height, -1, 0.0D, paramFrame);
  ...
  public void a(String paramString1, int paramInt1, String paramString2, String paramString3, int paramInt2, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    ...
    bite localbite = new bite((int)(320.0F * paramFloat3), (int)(320.0F * paramFloat4));
    localbite.a(paramString1);
    localbite.a(paramInt1);
    localbite.b(paramString2);
    localbite.c(paramString3);
    localbite.a(paramInt2);
    localbite.b();
    paramString1 = localbite.a();
    this.jdField_a_of_type_Bisy.jdField_a_of_type_Int = RendererUtils.createTexture(paramString1);
    localbite.c();
    this.jdField_a_of_type_Bisy.jdField_a_of_type_Float = paramFloat1;
    this.jdField_a_of_type_Bisy.b = paramFloat2;
    this.jdField_a_of_type_Bisy.c = paramFloat3;
    this.jdField_a_of_type_Bisy.d = paramFloat4;
  }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Bisy != null)
    {
      ...
      arrayOfInt[0] = this.jdField_a_of_type_Bisy.jdField_a_of_type_Int;
