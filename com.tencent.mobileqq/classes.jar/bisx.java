  ...
  implements SurfaceTexture.OnFrameAvailableListener
{
  ...
  public bisx(int paramInt1, int paramInt2)
  {
  ...
  private void e()
  {
    this.jdField_a_of_type_Bisy = new bisy();
    this.jdField_a_of_type_Bisy.a();
    Log.d("CodecOutputSurface", "textureID=" + this.jdField_a_of_type_Bisy.a());
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture = new SurfaceTexture(this.jdField_a_of_type_Bisy.a());
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Bisy = null;
  ...
  {
    this.jdField_a_of_type_Bisy.a(this.jdField_a_of_type_AndroidGraphicsSurfaceTexture, paramBoolean);
  }
  ...
  public void d()
  {
    this.jdField_a_of_type_Bisy.a("before updateTexImage");
