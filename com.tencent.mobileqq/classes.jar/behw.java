  ...
  implements behv
{
  ...
  public static behv asInterface(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("com.tencent.mobileqq.theme.ISwitchCallback");
    if ((localIInterface != null) && ((localIInterface instanceof behv))) {
      return (behv)localIInterface;
    }
    return new behx(paramIBinder);
  }
