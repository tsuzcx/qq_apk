  ...
  extends BaseJsModule
{
  ...
  {
    yuk.b("TextEffectModule", "handleJsRequest method = " + paramString);
    try
    {
      if ("wordSplit".equals(paramString))
      {
        ...
        paramJSONObject = aqaf.a((AppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), paramJSONObject);
      ...
      {
        paramJSONObject = ((bpmw)bplq.a(5)).a.b;
        if (!TextUtils.isEmpty(paramJSONObject)) {
          paramInvokeCallback.exec(0, "success", new JSONObject(paramJSONObject));
        }
        while (this.jdField_a_of_type_Bkfz != null)
        {
          this.jdField_a_of_type_Bkfz.a();
          break;
