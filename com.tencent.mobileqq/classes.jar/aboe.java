  ...
  implements View.OnTouchListener
{
  ...
  private abog jdField_a_of_type_Abog;
  ...
  public String a(int paramInt, String paramString1, String paramString2)
  {
    ...
    Map localMap = bjnd.a(paramString1);
    ...
    paramString1 = bjnd.a(paramString1, "s", paramString2);
  ...
  {
    return a(4, paramString, ScreenUtil.getInstantScreenWidth(BaseApplicationImpl.getContext()), ScreenUtil.getInstantScreenHeight(BaseApplicationImpl.getContext()), 0, 0);
  }
  ...
  String a(String paramString1, long paramLong, boolean paramBoolean1, boolean paramBoolean2, String paramString2)
  {
    ...
    {
      i = 1;
      j = ScreenUtil.getInstantScreenWidth(BaseApplicationImpl.getContext());
      k = ScreenUtil.getInstantScreenHeight(BaseApplicationImpl.getContext());
      str = paramString2;
    ...
    for (;;)
    {
      ...
      {
        abrl.d("GdtMotiveVideoClickCoordinateReportHelper", "getReportString error", localException);
        continue;
      }
  ...
  public String a(String paramString, abof paramabof)
  {
    if (paramabof == null)
    {
    ...
    try
    {
      ...
      localJSONObject.put("aa", String.valueOf(this.jdField_a_of_type_Int - paramabof.c));
      localJSONObject.put("ab", String.valueOf(this.jdField_b_of_type_Int - paramabof.d));
      localJSONObject.put("ba", String.valueOf(this.c - paramabof.c));
      localJSONObject.put("bb", String.valueOf(this.d - paramabof.d));
      localJSONObject.put("d", "0");
      localJSONObject.put("p", "0");
      localJSONObject.put("f", "0");
      localJSONObject.put("x", "1");
      localJSONObject.put("db", String.valueOf(paramabof.jdField_b_of_type_Int));
      localJSONObject.put("da", String.valueOf(paramabof.jdField_a_of_type_Int));
      localJSONObject.put("px", String.valueOf(paramabof.c));
      localJSONObject.put("py", String.valueOf(paramabof.d));
      return a(1, paramString, localJSONObject.toString());
    }
    catch (Exception paramabof)
    {
      for (;;)
      {
        abrl.d("GdtMotiveVideoClickCoordinateReportHelper", "getReportString error", paramabof);
      }
    }
  }
  ...
  public void a()
  {
    this.jdField_a_of_type_Abog = null;
  ...
  public String b(String paramString, abof paramabof)
  {
    if (paramabof == null)
    {
    ...
    return a(2, paramString, paramabof.jdField_a_of_type_Int, paramabof.jdField_b_of_type_Int, paramabof.c, paramabof.d);
  }
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Abog != null) {
        this.jdField_a_of_type_Abog.a(this.jdField_a_of_type_Long, this.jdField_b_of_type_Long, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, this.c, this.d);
      }
    }
  }
}
