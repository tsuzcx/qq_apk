  ...
  implements Manager
{
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, apct paramapct)
  {
    QLog.i("TeleScreen|CheckForwardManager", 1, "dl src: " + paramString1 + ", refId: " + paramString4);
    BaseApplicationImpl localBaseApplicationImpl = BaseApplicationImpl.getApplication();
    NewIntent localNewIntent = new NewIntent(localBaseApplicationImpl.getApplicationContext(), audq.class);
    ...
    if (paramapct != null)
    {
      int i = paramString1.a(paramContext, paramapct);
      localNewIntent.putExtra("req_id", i);
      if (QLog.isColorLevel()) {
        QLog.d("TeleScreen|CheckForwardManager", 2, "add req with id: " + i);
      }
    }
    localNewIntent.setObserver(apdm.a());
    localBaseApplicationImpl.getRuntime().startServlet(localNewIntent);
  }
  
  public static void a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, List<ResolveInfo> paramList, String paramString6, apcy paramapcy)
  {
    ...
    for (;;)
    {
      ...
      int i = apdm.a().a(paramContext, paramapcy);
      localNewIntent.putExtra("req_id", i);
      if (QLog.isColorLevel()) {
        QLog.d("TeleScreen|CheckForwardManager", 2, "add req with id: " + i);
      }
  ...
  public void a(QQAppInterface paramQQAppInterface, oidb_cmd0xc78.CheckShareExtensionReq paramCheckShareExtensionReq, String paramString, audr paramaudr)
  {
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApp(), audq.class);
