  ...
  implements View.OnClickListener
{
  ...
  public athd(Context paramContext)
  {
    this.jdField_a_of_type_AndroidViewLayoutInflater = ((LayoutInflater)paramContext.getSystemService("layout_inflater"));
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = paramContext.getResources().getDrawable(2130844866);
    this.jdField_a_of_type_Int = paramContext.getResources().getDisplayMetrics().densityDpi;
    paramContext = paramContext.getResources();
    this.f = 3;
    this.jdField_b_of_type_Int = aekt.a(1.0F, paramContext);
    this.c = this.jdField_b_of_type_Int;
    this.e = bdkf.b(16.0F);
    this.d = aekt.a(114.0F, paramContext);
  }
  ...
  private aovj a(View paramView)
  {
    int i = paramView.getId();
    if ((i >= 0) && (i < this.jdField_a_of_type_JavaUtilList.size())) {
      return (aovj)this.jdField_a_of_type_JavaUtilList.get(i);
    }
    return null;
  }
  ...
  private void a(float paramFloat1, float paramFloat2, int paramInt1, int paramInt2, String paramString, View paramView, StringBuilder paramStringBuilder1, StringBuilder paramStringBuilder2)
  {
    ...
    {
      return;
      paramView = paramView.findViewById(2131374583);
      if (paramView == null)
      {
    ...
    paramStringBuilder2.append(10000L).append("_").append(0).append("_").append(paramInt1).append("_").append(0).append("_").append(athb.a(paramInt2)).append("_").append(paramString).append(";");
  }
  ...
  private void a(float paramFloat1, float paramFloat2, int paramInt, boolean paramBoolean, String paramString, View paramView, StringBuilder paramStringBuilder1, StringBuilder paramStringBuilder2)
  {
    ...
    {
      return;
      paramView = paramView.findViewById(2131373588);
      if (paramView == null)
      {
  ...
  {
    paramView = paramView.findViewById(2131377345);
    if (paramView == null)
    {
    ...
    label259:
    aovj localaovj = a((View)localObject);
    ...
    paramStringBuilder1.append(localaovj.jdField_a_of_type_ComTencentMobileqqDataLebaPluginInfo.uiResId).append(",");
    ...
    {
      localObject = (atha)this.jdField_a_of_type_Atgx.a().get(Long.valueOf(localaovj.jdField_a_of_type_ComTencentMobileqqDataLebaPluginInfo.uiResId));
      if (localObject != null)
      {
        m = ((atha)localObject).jdField_a_of_type_Int;
        k = ((atha)localObject).jdField_b_of_type_Int;
      }
    }
    for (;;)
    {
  ...
  private void a(int paramInt, LinearLayout paramLinearLayout)
  {
    for (;;)
    {
      try
      {
        ...
        localObject = new athe(paramLinearLayout.getContext(), this.jdField_a_of_type_AndroidViewLayoutInflater);
        paramLinearLayout = ((athe)localObject).jdField_a_of_type_AndroidViewView;
        paramLinearLayout.setTag(localObject);
        paramLinearLayout.setId(paramInt);
        localObject = ((athe)localObject).jdField_a_of_type_ComTencentMobileqqLebaWidgetLebaRoundLayout;
        if (localObject != null)
        {
  ...
  private void b(LinearLayout paramLinearLayout)
  {
    ...
    if (("1000".equals(localObject1)) || ("2105".equals(localObject1)) || ("1103".equals(localObject1)) || ("2101".equals(localObject1)))
    {
      ...
      localObject1 = (aovj)this.jdField_a_of_type_JavaUtilList.get(i);
    ...
    for (;;)
    {
      ...
      {
        localObject2 = (athe)((View)localObject2).getTag();
        athf localathf = new athf();
        localathf.jdField_a_of_type_Aovj = ((aovj)localObject1);
        localathf.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
        localathf.jdField_a_of_type_AndroidContentContext = paramLinearLayout.getContext();
        localathf.jdField_a_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_AndroidGraphicsDrawableDrawable;
        localathf.jdField_a_of_type_Int = this.jdField_a_of_type_Int;
        localathf.jdField_a_of_type_AndroidViewView$OnClickListener = this;
        localathf.jdField_a_of_type_Atgx = this.jdField_a_of_type_Atgx;
        localathf.jdField_a_of_type_Boolean = bool2;
        localathf.jdField_b_of_type_Int = i;
        localathf.jdField_b_of_type_Boolean = bool1;
        ((athe)localObject2).a(localathf);
      }
    }
  }
  
  private void b(List<aovj> paramList)
  {
    if (this.jdField_a_of_type_JavaUtilList == null) {
    ...
    while (paramList != null)
    {
      ...
      while (paramList.hasNext())
      {
        ...
        if ((localaovj != null) && (TextUtils.isEmpty(localaovj.jdField_a_of_type_JavaLangString))) {
          this.jdField_a_of_type_JavaUtilList.add(localaovj);
        }
      }
    ...
    if (!this.jdField_a_of_type_JavaUtilList.isEmpty())
    {
      ...
      if ((j > 0) && (j < this.f))
      {
        ...
        while (i < this.f - j)
        {
          this.jdField_a_of_type_JavaUtilList.add(new aovj());
          i += 1;
        }
      }
    }
  ...
  public void a(float paramFloat1, float paramFloat2, View paramView1, View paramView2, int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3)
  {
    ...
    paramView1 = athb.a("plugin_exp");
    paramView1.jdField_a_of_type_JavaLangString = localStringBuilder2.toString();
    azlk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramView1);
  ...
  public void onClick(View paramView)
  {
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      aovj localaovj = a(paramView);
      if ((localaovj != null) && (this.jdField_a_of_type_Atgp != null))
      {
        atgz localatgz = new atgz();
        localatgz.jdField_a_of_type_Boolean = true;
        localatgz.jdField_a_of_type_Long = localaovj.jdField_a_of_type_Long;
        localatgz.jdField_a_of_type_Int = (paramView.getId() + 1);
        if ((paramView instanceof RedTouch))
        {
          localatgz.jdField_b_of_type_Int = athb.a((RedTouch)paramView);
          localatgz.c = athb.b((RedTouch)paramView);
        }
        this.jdField_a_of_type_Atgp.a(paramView, localaovj, localatgz);
      }
    }
  }
}
