...
{
  public static final String a = abgo.class.getSimpleName();
  private static final String b = abgo.class.getName();
  ...
  public boolean handleEvent(String paramString, long paramLong, Map<String, Object> paramMap)
  {
    if ((paramLong == 32L) && (a()))
    {
      ...
      if ((paramString != null) && ((paramString instanceof bits))) {
        ((bits)paramString).hideQQBrowserButton();
      }
