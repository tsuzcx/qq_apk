...
public class aorg
{
  public static Intent a(Context paramContext, String paramString1, boolean paramBoolean, long paramLong, MessageForArkApp paramMessageForArkApp, String paramString2, int paramInt, String paramString3, String paramString4)
  {
    ...
    if (!TextUtils.isEmpty(paramString3))
    {
      ...
      if (paramString1 != null)
      {
        ...
        if (paramString1 != null)
        {
          ...
          localIntent.putExtra("h5_ark_url_web_sender_uin", afvi.c);
          if (bool2) {
            localIntent.putExtra("puin", afvi.c);
          }
          QLog.d("ArkApp.ArkCommonUtil", 1, new Object[] { "ArkSafe.UrlCheck.launchQQBrowser,appname=", paramString3, ", enableCheck=", Boolean.valueOf(paramBoolean), ", appEnableCheck=", Boolean.valueOf(bool1), ", isPublicAccount=", Boolean.valueOf(bool2), ", senderUin=", afvi.c, ", mUrlChecker=", paramString1.toString() });
          aoxw.a().a(new aorh());
        }
      }
    }
    paramString1 = apvq.b(186).a();
    if (!TextUtils.isEmpty(paramString1)) {
    ...
    if (paramMessageForArkApp != null)
    {
      ...
      if (paramString1 != null)
      {
        ...
        aovl.a(a(), paramString1.appName, "AIOArkSdkCardClick", 1, 0, 0L, 0L, 0L, paramString1.appView, "");
      }
    }
    for (;;)
    {
      ...
      if (paramString1.from == 1) {
        aovl.a(a(), paramString1.appName, "AIOArkMapCardClick ", 1, 0, 0L, 0L, 0L, paramString1.appView, "");
      }
    }
  }
  ...
  public static String a()
  {
    ...
    if (localQQAppInterface != null) {
      return ((avsy)localQQAppInterface.getManager(11)).a().nationCode;
    }
    return "";
  }
  ...
  public static String a(boolean paramBoolean)
  {
    ...
    if (localObject != null)
    {
      localObject = ((avsy)((QQAppInterface)localObject).getManager(11)).a();
  ...
  public static boolean a(String paramString1, int paramInt, String paramString2)
  {
    ...
    if (((localObject2 instanceof FragmentActivity)) && (!TextUtils.isEmpty(paramString1)))
    {
      ...
      if ((!(localObject3 instanceof ahiu)) || (!"biz_src_ads".equals("biz_src_jc_ark"))) {
        break label848;
      }
      localObject1 = ugf.b(((BaseChatPie)localObject3).sessionInfo.curFriendUin);
    ...
    for (;;)
    {
      if (aoqp.a(paramString1, "", new JSONObject(), paramInt, paramString2))
      {
        aovl.a(null, paramString2, "FullScreenOrH5ShowForAI", 0, 0, 0L, 0L, 0L, "", "");
        Log.d("ark.OpenUrl ", paramString1);
        aovl.a(null, paramString2, "FullScreenOrH5Show", 0, 0, 0L, 0L, 0L, "", "");
        return true;
      }
      int j;
      int i;
      ...
      if ((paramString1.startsWith("http://")) || (paramString1.startsWith("https://")))
      {
        ...
        if (localObject3 != null)
        {
          ...
          QLog.e("ArkApp.ArkCommonUtil", 1, new Object[] { "ArkSafe.UrlCheck.setDisable.OpenUrl.http appName=", paramString2, ",url=", npn.b(paramString1, new String[0]), ", isValid set=true" });
          paramInt = 1;
          i = 2;
        }
      }
      ...
      for (;;)
      {
        aoys.b(paramString2, paramString1, j, i, afvi.c);
        if (paramInt == 0)
        {
          QLog.d("ArkApp.ArkCommonUtil", 1, new Object[] { "ArkSafe.OpenUrl check url invalid!, url=", npn.b(paramString1, new String[0]), ", app=", paramString2 });
          return false;
          label466:
          paramInt = 0;
          break label259;
        ...
        localObject1 = bfwg.a(a(), (Context)localObject2, paramString1);
        ...
        if (localObject2 != null)
        {
          ...
          QLog.e("ArkApp.ArkCommonUtil", 1, new Object[] { "ArkSafe.UrlCheck.setDisable.OpenUrl.jump appName=", paramString2, ",url=", npn.b(paramString1, new String[0]), ", isValid set=true" });
          paramInt = 1;
          i = 2;
        }
        for (;;)
        {
          ...
          QLog.e("ArkApp.ArkCommonUtil", 1, new Object[] { "ArkSafe.OpenUrl check url invalid, url=", npn.b(paramString1, new String[0]), ", app=", paramString2 });
          break;
        }
      }
      label641:
