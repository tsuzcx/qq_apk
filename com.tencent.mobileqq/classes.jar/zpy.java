...
public class zpy
{
  ...
  {
    paramString = new ArrayList(Arrays.asList(new FeedCloudCommon.Entry[] { QCircleReportHelper.newEntry("host_uin", String.valueOf(bizw.a().a())), QCircleReportHelper.newEntry("qua", QUA.getQUA3()), QCircleReportHelper.newEntry("network_type", QCircleReportHelper.getNetworkType()), QCircleReportHelper.newEntry("client_time", String.valueOf(System.currentTimeMillis())), QCircleReportHelper.newEntry("event_id", paramString), QCircleReportHelper.newEntry("mobile_type", Build.MODEL + "_" + Build.VERSION.RELEASE), QCircleReportHelper.newEntry("version", "8.4.10.4875"), QCircleReportHelper.newEntry("platform", "AND"), QCircleReportHelper.newEntry("video_play_id", String.valueOf(paramLong)), QCircleReportHelper.newEntry("unique_id", String.valueOf(b())) }));
