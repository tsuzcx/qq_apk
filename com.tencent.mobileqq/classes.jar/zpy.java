...
{
  public static int a;
  public static SparseArray<zpz> a;
  ...
  static
  {
    ...
    jdField_a_of_type_AndroidUtilSparseArray.put(1, new zpz(0.001F, 100, 10, 0.1F, 6));
    jdField_a_of_type_AndroidUtilSparseArray.put(4, new zpz(0.001F, 100, 10, 0.01F, 0));
    jdField_a_of_type_AndroidUtilSparseArray.put(6, new zpz(0.001F, 100, 10, 0.1F, 6));
    jdField_a_of_type_AndroidUtilSparseArray.put(7, new zpz(0.001F, 100, 10, 0.1F, 6));
    jdField_a_of_type_AndroidUtilSparseArray.put(14, new zpz(0.001F, 100, 10, 0.1F, 6));
    jdField_a_of_type_AndroidUtilSparseArray.put(9, new zpz(0.001F, 85, 10, 0.1F, 6));
    jdField_a_of_type_AndroidUtilSparseArray.put(16, new zpz(0.001F, 100, 10, 0.1F, 6));
  ...
  public static void a()
  {
    ...
    {
      SparseArray localSparseArray = MagnifierSDK.jdField_a_of_type_Zqr.a();
    ...
    while (localIterator.hasNext())
    {
      ...
      else
      {
        ...
        if (((String)localObject).startsWith("p_"))
        {
          ...
          zpz localzpz = (zpz)jdField_a_of_type_AndroidUtilSparseArray.get(n);
          f1 = localzpz.jdField_a_of_type_Float;
          j = localzpz.jdField_a_of_type_Int;
          k = localzpz.jdField_b_of_type_Int;
          f2 = localzpz.jdField_b_of_type_Float;
          m = localzpz.c;
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            ...
            for (;;)
            {
              localObject = new zpz(f1, j, k, f2, m);
              ...
              MagnifierSDK.jdField_a_of_type_Zqr.a(jdField_a_of_type_AndroidUtilSparseArray);
              return;
            }
          }
        }
