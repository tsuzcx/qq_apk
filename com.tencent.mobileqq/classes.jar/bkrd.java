  ...
  implements RecyclerView.OnChildAttachStateChangeListener
{
  ...
  public bkrh mCallback;
  private RecyclerView.ChildDrawingOrderCallback mChildDrawingOrderCallback;
  private List<Integer> mDistances;
  private long mDragScrollStartTimeInMs;
  float mDx;
  float mDy;
  bkqy mGestureDetector;
  float mInitialTouchX;
  float mInitialTouchY;
  float mMaxSwipeVelocity;
  private final RecyclerView.OnItemTouchListener mOnItemTouchListener = new bkre(this);
  View mOverdrawChild = null;
  int mOverdrawChildPosition = -1;
  final List<View> mPendingCleanup = new ArrayList();
  List<bkrl> mRecoverAnimations = new ArrayList();
  ...
  public bkrd(bkrh parambkrh)
  {
    this.mCallback = parambkrh;
  }
  ...
  private void addChildDrawingOrderCallback()
  {
    ...
    if (this.mChildDrawingOrderCallback == null) {
      this.mChildDrawingOrderCallback = new bkrg(this);
    }
  ...
  private void destroyCallbacks()
  {
    ...
    while (i >= 0)
    {
      bkrl localbkrl = (bkrl)this.mRecoverAnimations.get(0);
      this.mCallback.clearView(this.mRecyclerView, localbkrl.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder);
      i -= 1;
    }
  ...
  private void initGestureDetector()
  {
    ...
    this.mGestureDetector = new bkqy(this.mRecyclerView.getContext(), new bkrk(this));
  }
  ...
  private int swipeIfNecessary(RecyclerView.ViewHolder paramViewHolder)
  {
    ...
    do
    {
      do
      {
        ...
        {
          if ((j & k) == 0) {
            return bkrh.convertToRelativeDirection(k, ViewCompat.getLayoutDirection(this.mRecyclerView));
          }
          return k;
        }
    ...
    if ((j & i) == 0) {
      return bkrh.convertToRelativeDirection(i, ViewCompat.getLayoutDirection(this.mRecyclerView));
    }
    return i;
  }
  ...
  public void attachToRecyclerView(@Nullable RecyclerView paramRecyclerView)
  {
    ...
    this.mSwipeEscapeVelocity = paramRecyclerView.getDimension(2131297194);
    this.mMaxSwipeVelocity = paramRecyclerView.getDimension(2131297193);
    setupCallbacks();
  }
  ...
  int endRecoverAnimation(RecyclerView.ViewHolder paramViewHolder, boolean paramBoolean)
  {
    ...
    while (i >= 0)
    {
      bkrl localbkrl = (bkrl)this.mRecoverAnimations.get(i);
      if (localbkrl.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder == paramViewHolder)
      {
        localbkrl.jdField_b_of_type_Boolean |= paramBoolean;
        if (!localbkrl.jdField_c_of_type_Boolean) {
          localbkrl.b();
        }
        this.mRecoverAnimations.remove(i);
        return localbkrl.jdField_c_of_type_Int;
      }
      i -= 1;
    }
    return 0;
  ...
  bkrl findAnimation(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      bkrl localbkrl = (bkrl)this.mRecoverAnimations.get(i);
      paramMotionEvent = localbkrl;
      if (localbkrl.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder.itemView == localView) {
        break;
      }
      i -= 1;
    }
  ...
  View findChildView(MotionEvent paramMotionEvent)
  {
    ...
    while (i >= 0)
    {
      paramMotionEvent = (bkrl)this.mRecoverAnimations.get(i);
  ...
  public boolean hasRunningRecoverAnim()
  {
    ...
    while (i < j)
    {
      if (!((bkrl)this.mRecoverAnimations.get(i)).jdField_c_of_type_Boolean) {
        return true;
      }
      i += 1;
    }
  ...
  void postDispatchSwipe(bkrl parambkrl, int paramInt)
  {
    this.mRecyclerView.post(new ItemTouchHelper.4(this, parambkrl, paramInt));
  }
    ...
    else
    {
      ...
      default: 
        ...
        if (k == 2)
        {
          ...
          localObject = new bkrf(this, (RecyclerView.ViewHolder)localObject, i, k, f3, f4, f1, f2, j, (RecyclerView.ViewHolder)localObject);
          ((bkrl)localObject).a(this.mCallback.getAnimationDuration(this.mRecyclerView, i, f1 - f3, f2 - f4));
