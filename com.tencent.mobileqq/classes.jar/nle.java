...
public class nle
{
  ...
  public nle(QQAppInterface paramQQAppInterface)
  {
  ...
  private userinfo.UserInfo a(SosoInterface.SosoLbsInfo paramSosoLbsInfo)
  {
    ...
    try
    {
      ...
      paramSosoLbsInfo.str_app_version.set(bhlo.c());
      localUserInfo.app_info.set(paramSosoLbsInfo);
      localUserInfo.bytes_client_version.set(ByteStringMicro.copyFromUtf8("8.4.5"));
  ...
  private void a(String paramString, byte[] paramArrayOfByte, BusinessObserver paramBusinessObserver)
  {
    ...
    NewIntent localNewIntent = new NewIntent(this.a.getApplication(), nkl.class);
  ...
  private void a(userinfo.UserInfo paramUserInfo, nlf paramnlf)
  {
    ...
    a("SearchAsmTab.GetPopClassific", localReqBody.toByteArray(), new nlg(paramnlf, this.a, 1));
  }
  
  public void a(nlf paramnlf)
  {
    try
    {
      a(a(null), paramnlf);
