...
public class qhx
  extends qhj
{
  private aoav jdField_a_of_type_Aoav = new qhy(this);
  private List<uqv> jdField_a_of_type_JavaUtilList;
  private volatile boolean jdField_a_of_type_Boolean;
  private Handler b = new qhz(this, ThreadManager.getSubThreadLooper());
  
  public qhx(AppInterface paramAppInterface, EntityManager paramEntityManager, ExecutorService paramExecutorService, qxn paramqxn, Handler paramHandler)
  {
  ...
  public int a()
  {
    ...
    Iterator localIterator = uqx.a().b((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface).iterator();
    for (;;)
    {
      j = i;
  ...
  public void a(String paramString)
  {
    int j;
    uqv localuqv;
    if (!uqx.a().a(paramString, (QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface))
    {
      uqx.a().b(paramString, (QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface);
      ...
      do
      {
        ...
        localuqv = (uqv)localIterator.next();
      } while ((localuqv.a == null) || (!localuqv.a.equals(paramString)));
    }
    for (int i = localuqv.b;; i = 0)
    {
      f();
      bdla.b(null, "dc00899", "Pb_account_lifeservice", paramString, "0X80064CD", "0X80064CD", 0, 0, "" + i, "" + j, "", "");
      return;
    }
  }
  ...
  public void a(String paramString, Context paramContext)
  {
    ...
    do
    {
      ...
      localuqv = (uqv)paramContext.next();
    } while ((localuqv.a == null) || (!localuqv.a.equals(paramString)));
    for (int i = localuqv.b;; i = 0)
    {
      bdla.b(null, "dc00899", "Pb_account_lifeservice", paramString, "0X80064CF", "0X80064CF", 0, 0, "" + i, "", "", "");
      return;
    }
  }
  ...
  {
    uqx.a().c(paramString, (QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface);
    int j = uqx.a().a();
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    uqv localuqv;
    do
    ...
    {
      f();
      bdla.b(null, "dc00899", "Pb_account_lifeservice", paramString, "0X80064CE", "0X80064CE", 0, 0, "" + i, "" + j, "", "");
      return;
    }
  }
  ...
  public void c(String paramString)
  {
    ...
    uqx.a().a(paramString, (QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface);
    f();
    ...
    do
    {
      ...
      localuqv = (uqv)((Iterator)localObject).next();
    } while ((localuqv.a == null) || (!localuqv.a.equals(paramString)));
    for (int i = localuqv.b;; i = 0)
    {
      bdla.b(null, "dc00899", "Pb_account_lifeservice", paramString, "0X80064D0", "0X80064D0", 0, 0, "" + i, "", "", "");
      return;
    }
  }
