...
public class qhx
{
  ...
  private TemplateBean a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        if ((paramBaseArticleInfo.mProteusTemplateBean != null) && (!((teh)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusFactoryBaseTemplateFactory).a(paramBaseArticleInfo.mProteusTemplateBean))) {
          return paramBaseArticleInfo.mProteusTemplateBean;
        }
        if (this.jdField_a_of_type_Qdv == null) {
          return null;
        }
        JSONObject localJSONObject = this.jdField_a_of_type_Qdv.a(147, paramBaseArticleInfo);
        localTemplateBean = this.jdField_a_of_type_Qdv.a(147, localJSONObject);
        try
        {
  ...
  private void a(pxk parampxk, VafContext paramVafContext)
  {
    paramVafContext = parampxk.a();
    if (paramVafContext != null)
    {
      parampxk = paramVafContext.b(parampxk.h() + 1);
      if ((parampxk != null) && (parampxk.mProteusTemplateBean == null)) {
        parampxk.mProteusTemplateBean = a(parampxk);
      }
    }
  }
  ...
  private static void b(ProteusItemView paramProteusItemView)
  {
    ...
    do
    {
      ...
      if ((localContainer != null) && (localContainer.getVisibility() == 8))
      {
        ...
        afur.a(jdField_a_of_type_JavaLangString, "", new IllegalArgumentException("container.getVisibility() == View.GONE"));
      }
    ...
    afur.a(jdField_a_of_type_JavaLangString, "", new IllegalArgumentException("proteusItemView.getVisibility() == View.GONE"));
  }
  ...
  public int a()
  {
    if (b == 2147483647)
    {
      afur.a(jdField_a_of_type_JavaLangString, "", new IllegalArgumentException(anni.a(2131702363)));
  ...
  public int a(ArticleInfo paramArticleInfo)
  {
    ...
    {
      afur.a(jdField_a_of_type_JavaLangString, "", new IllegalArgumentException(anni.a(2131702364)));
      return 147;
    }
  ...
  public ProteusItemView a(VafContext paramVafContext, int paramInt, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = localObject2;
        ttf.a(str, (String)localObject3, "DynamicPTS.getView", l2 - l1);
        localObject1 = localObject2;
      }
      catch (Exception localException)
      {
        ...
        afur.a(jdField_a_of_type_JavaLangString, "getView:", new IllegalArgumentException(paramBaseArticleInfo.proteusItemsData, localException));
        continue;
      }
  ...
  public ProteusItemView a(VafContext paramVafContext, JSONObject paramJSONObject)
  {
    ...
    //   0: ldc_w 342
    //   3: iconst_1
    //   4: invokestatic 345	teh:a	(Ljava/lang/String;Z)Lteh;
    //   7: astore_3
    //   8: aload_3
    //   9: ifnull +64 -> 73
    //   12: aload_3
    //   13: aload_2
    //   14: invokevirtual 349	teh:getTemplateBean	(Lorg/json/JSONObject;)Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/bean/TemplateBean;
    //   17: astore_2
    //   18: aload_1
    ...
    //   54: aconst_null
    //   55: aload_2
    //   56: invokestatic 354	pfr:a	(Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/virtualview/container/Container;Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/bean/TemplateBean;Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/bean/TemplateBean;)V
    //   59: aload_3
    //   60: aload_2
    ...
    //   66: aload_1
    //   67: aload_2
    //   68: invokestatic 361	pfr:a	(Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/virtualview/container/Container;Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/virtualview/core/VafContext;Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/bean/TemplateBean;)V
    //   71: aload_3
    //   72: areturn
    //   73: aconst_null
    //   74: astore_2
    ...
    //   79: aconst_null
    //   80: astore_1
    //   81: getstatic 18	qhx:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   84: iconst_1
    //   85: aload_2
    //   86: iconst_0
  ...
  public void a(ProteusItemView paramProteusItemView, int paramInt1, BaseArticleInfo paramBaseArticleInfo, VafContext paramVafContext, aobu paramaobu, snh paramsnh, pxk parampxk, int paramInt2)
  {
    bkpj.a("DynamicPTS.bindData");
    long l1 = System.currentTimeMillis();
    ...
    if (qhz.a()) {
      qhz.a(jdField_a_of_type_JavaLangString, "[bindData] " + paramBaseArticleInfo + " adapterViewType: " + paramInt1);
    }
    Object localObject1 = localObject2;
    if (localObject2 != null)
    {
      ...
      if (localTemplateBean != null)
      {
        ...
        {
          bkpj.a("DynamicPTS.bindData.reuseView");
          localObject1 = paramVafContext.getViewFactory().inflate(paramVafContext, localTemplateBean);
          if (localObject1 != null)
          {
            ((Container)localObject1).setBackgroundDrawable(paramVafContext.getContext().getResources().getDrawable(2130841683));
            paramProteusItemView.d();
            paramProteusItemView.a((Container)localObject1);
            pfr.a((Container)localObject1, null, localTemplateBean);
          }
          paramBaseArticleInfo.mProteusTemplateBean = localTemplateBean;
          localObject1 = null;
          bkpj.a();
    ...
    if (localTemplateBean != null)
    {
      bkpj.a("DynamicPTS.bindData.compareWithOldTemplateBean");
      pfr.a((Container)localObject2, (TemplateBean)localObject1, localTemplateBean);
      bkpj.a();
    }
    bkpj.a("DynamicPTS.bindData.bindView");
    this.jdField_a_of_type_Qdv.a(paramInt1, (Container)localObject2, parampxk, paramInt2);
    bkpj.a();
    pfr.a(paramInt1, paramProteusItemView, paramVafContext, paramaobu, paramsnh, parampxk, paramBaseArticleInfo);
    a(parampxk, paramVafContext);
    pfr.a((Container)localObject2, parampxk, localTemplateBean);
    long l2 = System.currentTimeMillis();
    ...
    {
      ttf.a(paramBaseArticleInfo, paramProteusItemView, "DynamicPTS.bindData", l2 - l1);
      bkpj.a();
      return;
    }
  }
