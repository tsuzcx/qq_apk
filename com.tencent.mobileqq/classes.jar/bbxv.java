  ...
  extends WtloginObserver
{
  ...
  bbxv(Intent paramIntent, String paramString, bbxw parambbxw)
  {
  ...
  public void OnRegGetSMSVerifyLoginAccountWithLhSig(int paramInt, long paramLong, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, byte[] paramArrayOfByte4)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramArrayOfByte1 = BaseApplicationImpl.getContext().getString(2131717132);
        ...
        if (QLog.isDevelopLevel()) {
          bbxx.a("LHLoginMng -- OnRegGetSMSVerifyLoginAccountWithLhSig", localIntent);
        }
        if (this.jdField_a_of_type_Bbxw != null) {
          this.jdField_a_of_type_Bbxw.a(localIntent, bool, this.jdField_a_of_type_JavaLangString, paramArrayOfByte4, paramArrayOfByte1);
        }
