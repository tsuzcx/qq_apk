...
public class ayzu
{
  ...
  private Object c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    return new ayzw(this, localRespGetSign.vKey, localRespGetSign.vSign);
  }
  ...
  private Object d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    return new ayzx(azuj.a(paramFromServiceMsg.iMsgId, 0), paramToServiceMsg.shResetSeq, paramFromServiceMsg.shFlowLayer, paramFromServiceMsg, paramToServiceMsg.result);
  }
  ...
  private Object o(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramToServiceMsg != null)
    {
      atvd.a("Video", "Receive message packet: seq = " + paramFromServiceMsg.getRequestSsoSeq() + " size = " + paramToServiceMsg.vMsgInfos.size());
      return paramToServiceMsg;
    }
    return null;
  }
  ...
  private Object q(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    long l1 = bdqa.a(localRespOffFilePack.vBody, 1);
    int i = bdqa.a(localRespOffFilePack.vBody, 5);
    paramFromServiceMsg = new byte[i];
    bdqa.a(paramFromServiceMsg, 0, localRespOffFilePack.vBody, 7, i);
    paramFromServiceMsg = bdqa.a(paramFromServiceMsg, 0, i);
    i += 7;
    if (QLog.isColorLevel()) {
    ...
    default: 
      return null;
    case 1: 
      l2 = bdqa.b(localRespOffFilePack.vBody, i);
      i += 8;
      l3 = bdqa.b(localRespOffFilePack.vBody, i);
      i += 8;
      l4 = bdqa.a(localRespOffFilePack.vBody, i);
      i += 4;
      l5 = bdqa.a(localRespOffFilePack.vBody, i);
      i += 4;
      short s = bdqa.a(localRespOffFilePack.vBody, i);
      j = i + 2;
      i = bdqa.a(localRespOffFilePack.vBody, j);
      j += 2;
      paramToServiceMsg = new byte[i];
      bdqa.a(paramToServiceMsg, 0, localRespOffFilePack.vBody, j, paramToServiceMsg.length);
      j += paramToServiceMsg.length;
      i = bdqa.a(localRespOffFilePack.vBody, j);
      j += 2;
      arrayOfByte = new byte[i];
      bdqa.a(arrayOfByte, 0, localRespOffFilePack.vBody, j, arrayOfByte.length);
      i = j + arrayOfByte.length;
      byte b3 = localRespOffFilePack.vBody[i];
      i += 1;
      long l6 = bdqa.a(localRespOffFilePack.vBody, i);
      if (QLog.isColorLevel()) {
        QLog.d("wk", 2, "" + l1 + "|" + l5 + "|" + s + "|" + paramToServiceMsg + "|" + arrayOfByte + "|" + b3);
      }
      return new ayzv(this, l1, paramFromServiceMsg, b2, b1, l2, l3, l4, l5, s, paramToServiceMsg, arrayOfByte, b3, l6);
    case 2: 
      return new ayzv(this, l1, paramFromServiceMsg, b2, b1);
    case 3: 
      j = localRespOffFilePack.vBody[i];
      i += 1;
      bdqa.a(localRespOffFilePack.vBody, i);
      i += 2;
      bdqa.a(localRespOffFilePack.vBody, i);
      i += 2;
      bdqa.a(localRespOffFilePack.vBody, i);
      ...
      j = localRespOffFilePack.vBody[i];
      i += 1;
      l2 = bdqa.a(localRespOffFilePack.vBody, i);
      j = i + 4;
      i = bdqa.a(localRespOffFilePack.vBody, j);
      j += 2;
      bdqa.a(new byte[i], 0, localRespOffFilePack.vBody, j, i);
      j += i;
      i = bdqa.a(localRespOffFilePack.vBody, j);
      j += 2;
      arrayOfByte = new byte[i];
      bdqa.a(arrayOfByte, 0, localRespOffFilePack.vBody, j, i);
      j += i;
      ...
      bdqa.a((byte[])localObject, 0, localRespOffFilePack.vBody, j, i);
      localObject = bdqa.a((byte[])localObject, 0, i);
      i = j + i;
      j = localRespOffFilePack.vBody[i];
      i += 1;
      l3 = bdqa.a(localRespOffFilePack.vBody, i);
      i += 4;
      l4 = bdqa.a(localRespOffFilePack.vBody, i);
      i += 4;
      bdqa.a(localRespOffFilePack.vBody, i);
      ...
      return new ayzv(this, l1, paramFromServiceMsg, b2, b1, l2, HexUtil.bytes2HexStr(arrayOfByte), l4, paramToServiceMsg.extraData.getLong("msgTime"), paramToServiceMsg.extraData.getShort("msgSeq"), l3, (String)localObject, paramToServiceMsg.extraData.getLong("delUin"));
    }
    int j = bdqa.a(localRespOffFilePack.vBody, i);
    paramToServiceMsg = new byte[j];
    bdqa.a(paramToServiceMsg, 0, localRespOffFilePack.vBody, i + 2, j);
    return new ayzv(this, l1, paramFromServiceMsg, b2, b1, paramToServiceMsg);
  }
