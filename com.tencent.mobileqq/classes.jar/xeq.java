  ...
  implements begw
{
  ...
  public xeq(Context paramContext)
  {
    ...
    this.jdField_a_of_type_JavaUtilLinkedHashMap.put("com.tencent.map", ajjy.a(2131644661));
    this.jdField_a_of_type_JavaUtilLinkedHashMap.put("com.google.android.apps.maps", "Google地图");
    this.jdField_a_of_type_JavaUtilLinkedHashMap.put("com.autonavi.minimap", ajjy.a(2131644659));
    this.jdField_a_of_type_JavaUtilLinkedHashMap.put("com.baidu.BaiduMap", ajjy.a(2131644660));
  ...
  public static String a(double paramDouble)
  {
    if (paramDouble < 1000.0D) {
      return String.format(ajjy.a(2131644667), new Object[] { Double.valueOf(paramDouble) });
    }
    return String.format(ajjy.a(2131644666), new Object[] { Double.valueOf(paramDouble / 1000.0D) });
  }
  ...
  {
    awqx.b(null, "dc00899", "Pb_account_lifeservice", "", "rec_locate_android", paramString1, 0, 0, paramString2, paramString3, "", "");
    if (QLog.isColorLevel()) {
  ...
  {
    awqx.b(null, "P_CliOper", "Pb_account_lifeservice", "", "rec_locate", paramString1, 0, 0, paramString2, "", "", "");
    if (QLog.isColorLevel()) {
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Xes != null) {
        if (!this.jdField_a_of_type_Xes.b())
        {
  ...
  public void a(GeoPoint paramGeoPoint1, GeoPoint paramGeoPoint2)
  {
    if (!badq.g(this.jdField_a_of_type_AndroidContentContext))
    {
      ...
      bbmy.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 1, paramGeoPoint1.getString(2131628948), 1).b(paramGeoPoint1.getDimensionPixelSize(2131167766));
      return;
    }
    ...
    for (;;)
    {
      ...
      new azgk(str, "GET", new xer(this), 1000, localBundle2, true).execute(new HashMap[] { paramGeoPoint1 });
      return;
  ...
  public void a(GeoPoint paramGeoPoint1, GeoPoint paramGeoPoint2, String paramString1, String paramString2)
  {
    ...
    {
      bbmy.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 0, ajjy.a(2131644664), 1).b(this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131167766));
      return;
    }
    ...
    if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
      this.jdField_a_of_type_JavaLangString = ajjy.a(2131644662);
    }
    if (TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
      this.jdField_b_of_type_JavaLangString = ajjy.a(2131644658);
    }
    ...
    if (d > 1000.0D)
    {
      ...
      if ((this.jdField_a_of_type_Xes == null) || (this.jdField_a_of_type_Xes.b())) {
        break label469;
      }
      this.jdField_a_of_type_Begr.c(ajjy.a(2131644665));
      label295:
      this.jdField_a_of_type_ArrayOfInt[0] = 0;
      this.jdField_a_of_type_Begr.c(ajjy.a(2131644663));
      this.jdField_a_of_type_ArrayOfInt[1] = 1;
      this.jdField_a_of_type_Begr.c((CharSequence)this.jdField_a_of_type_JavaUtilLinkedHashMap.get("com.tencent.map"));
      ...
      this.jdField_a_of_type_Begr.c(paramString1);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Int = 0;
      break;
      this.jdField_a_of_type_Begr.c(ajjy.a(2131644657));
      break label295;
  ...
  public void a(JSONObject paramJSONObject, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Xes != null) {
        this.jdField_a_of_type_Xes.a(paramJSONObject, paramInt);
      }
      return;
      if (paramInt == 1)
      {
