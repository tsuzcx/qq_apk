...
public class qsj
{
  ...
  {
    paramString = bhey.a(pnn.a(), BaseApplicationImpl.getContext(), paramString);
    if (paramString != null)
    {
  ...
  public static void a(Context paramContext, ArticleInfo paramArticleInfo, boolean paramBoolean)
  {
    ...
    if (paramArticleInfo.isCardJumpUrlAvailable == 1)
    {
      ...
      pqx.a(paramContext, paramArticleInfo.getCardJumpUrl());
      return;
    }
    paramArticleInfo.clickJumpTarget = a(pjj.e, "-1");
    pqx.a(paramContext, paramArticleInfo, paramBoolean);
  }
  ...
  public static void a(KandianUrlImageView paramKandianUrlImageView, Context paramContext, URL paramURL1, URL paramURL2, Runnable paramRunnable)
  {
    ...
    paramKandianUrlImageView.setPublicAccountImageDownListener(new qsk(paramRunnable));
    pjr.a(paramKandianUrlImageView, paramURL2, paramContext);
  }
  ...
  public static boolean a(String paramString)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      Object localObject = bhey.a(pnn.a(), BaseApplicationImpl.getContext(), paramString);
      if (localObject != null)
      {
        localObject = ((bheh)localObject).a;
        if ((localObject != null) && ("6".equals((String)((Map)localObject).get("target"))) && (((Map)localObject).containsKey("v_url_base64"))) {
          return true;
        }
      }
      return tto.b(tto.b(paramString));
    }
    return false;
  }
}
