...
public class zev
  extends zez<RMVideoStateMgr, Void>
{
  /* Error */
  protected void a(com.tribe.async.async.JobContext paramJobContext, RMVideoStateMgr paramRMVideoStateMgr)
  {
    ...
    //   0: ldc 18
    //   2: ldc 20
    //   4: invokestatic 26	yqp:b	(Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   23: aload_0
    //   24: aload_2
    //   25: invokespecial 45	com/tencent/biz/qqstory/takevideo/publish/GenerateVideoManifestSegment$1:<init>	(Lzev;Lcom/tencent/mobileqq/activity/richmedia/state/RMVideoStateMgr;)V
    ...
    //   69: ldc 18
    //   71: ldc 63
    //   73: invokestatic 26	yqp:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   76: lload 6
    //   78: lstore 4
    ...
    //   137: invokestatic 26	yqp:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   140: lload 6
    //   142: lstore 4
    //   144: aload_1
    //   145: monitorexit
    //   146: ldc 18
    //   148: ldc 95
    //   150: invokestatic 26	yqp:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   153: lload 4
    //   155: ldc2_w 96
    //   158: lcmp
    //   159: ifge +30 -> 189
    ...
    //   177: invokestatic 108	yqp:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    //   180: iload_3
    //   181: i2l
    //   182: lstore 4
    //   184: lload 4
    ...
    //   189: aload_0
    //   190: aconst_null
    //   191: invokespecial 117	zez:notifyResult	(Ljava/lang/Object;)V
    //   194: return
    //   195: invokestatic 122	bcjg:a	()Lbcjg;
    //   198: invokevirtual 125	bcjg:a	()Lcom/tencent/maxvideo/mediadevice/AVCodec;
    //   201: invokevirtual 131	com/tencent/maxvideo/mediadevice/AVCodec:recordSubmit	()I
    //   204: pop
    //   205: ldc 18
    //   207: ldc 133
    //   209: invokestatic 26	yqp:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   212: goto -181 -> 31
    //   215: astore_1
    //   216: ldc 18
    //   218: ldc 135
    //   220: aload_1
    //   221: invokestatic 138	yqp:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   224: goto -193 -> 31
    //   227: astore_2
    //   228: ldc 18
    ...
    //   252: invokestatic 26	yqp:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   255: goto -111 -> 144
    //   258: astore_2
    //   259: aload_1
    //   260: monitorexit
