  ...
  extends atog
{
  ...
  {
    aroh localaroh = (aroh)this.a.a.getManager(11);
    int i = localaroh.d();
    String str1 = this.a.a.getCurrentAccountUin();
    String str2 = this.a.a();
    if (QLog.isColorLevel()) {
      QLog.d("ContactSync.Manager", 2, "onQueryBindState | state = " + i + " | syncUin = " + amoa.b(str2) + " | currentUin = " + amoa.b(str1));
    }
    if (localaroh.c()) {
      if (TextUtils.isEmpty(str2)) {
        amoa.a(this.a).removeCallbacksAndMessages(null);
      }
    }
    do
    {
      do
      {
        amoa.a(this.a).sendEmptyMessage(1);
        do
        {
          return;
        } while (str1.equals(str2));
        amoa.a(this.a).removeCallbacksAndMessages(null);
        amoa.a(this.a).sendEmptyMessage(2);
        amoa.a(this.a).sendEmptyMessage(1);
        return;
      } while ((i != 5) && (i != 1) && ((i != 6) || (localaroh.a() == null) || (localaroh.a().lastUsedFlag != 3L)) && ((i != 7) || (localaroh.a() == null) || (!localaroh.a().isStopFindMatch)));
      if ((i == 5) || (i == 1)) {
