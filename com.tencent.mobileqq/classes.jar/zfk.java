...
{
  public zfk(PhoneContactManagerImp paramPhoneContactManagerImp) {}
  ...
  protected void a(int paramInt1, int paramInt2)
  {
    if (PhoneContactManagerImp.a(this.a) == null) {
      PhoneContactManagerImp.a(this.a, new zgc(this.a, null));
    }
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean1)
    {
      ...
      if (this.a.jdField_a_of_type_Boolean) {
        ThreadManager.getSubThreadHandler().post(new zfm(this));
      }
  ...
  protected void c(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    do
    {
      ThreadManager.getSubThreadHandler().post(new zfl(this));
      do
      {
        return;
