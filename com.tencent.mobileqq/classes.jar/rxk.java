...
public class rxk
{
  private static rxk jdField_a_of_type_Rxk;
  private QIPCModule jdField_a_of_type_ComTencentMobileqqQipcQIPCModule = new rxl(this, "Module_VideoFeedsIPCServer");
  private List<rxm> jdField_a_of_type_JavaUtilList = new Vector();
  ...
  public static rxk a()
  {
    if (jdField_a_of_type_Rxk == null) {}
    try
    {
      jdField_a_of_type_Rxk = new rxk();
      return jdField_a_of_type_Rxk;
    }
    finally {}
  }
  ...
  public void a(rxm paramrxm)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      this.jdField_a_of_type_JavaUtilList.add(paramrxm);
      return;
    }
  }
  
  public void b(rxm paramrxm)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      this.jdField_a_of_type_JavaUtilList.remove(paramrxm);
      return;
    }
  }
}
