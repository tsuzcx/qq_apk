...
public class aqas
{
  ...
  public static void a(int paramInt, aqau paramaqau)
  {
    try
    {
      c();
      jdField_a_of_type_Aqau = paramaqau;
  ...
  private static void b(int paramInt)
  {
    if (jdField_a_of_type_Aqau != null) {
      jdField_a_of_type_Aqau.a(paramInt);
    }
  }
              ...
              if (localapxp != null)
              {
                ...
                for (;;)
                {
                  synchronized (jdField_a_of_type_JavaLangObject)
                  {
                    ...
                    {
                      b(1);
                      localapxp.b((String)((Pair)localObject5).first, 0L, new aqat(str3, str2, str4, str1));
  ...
  private static boolean b(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    if ((!TextUtils.isEmpty(paramString1)) && (!TextUtils.isEmpty(paramString2)) && (!TextUtils.isEmpty(paramString3)) && (!TextUtils.isEmpty(paramString4))) {
      try
      {
        ...
        {
          String str = bkvq.a(paramString2);
          if ((!TextUtils.isEmpty(str)) && (str.equals(paramString3)))
          {
            ...
            if (FileUtils.copyFile(paramString1 + "libarkDebuggerJSImpl.so", paramString4 + "libarkDebuggerJSImpl.so")) {
            ...
            for (i = 0;; i = 1)
            {
              ...
              if (!FileUtils.copyFile(paramString1 + "libjsc_ark.so", paramString4 + "libjsc_ark.so")) {
                break;
              }
  ...
  {
    Object localObject1 = aqyt.b(186).a();
    ...
    {
      return;
      localObject1 = ((aqyp)localObject1).a();
      if (localObject1 == null)
      {
        ArkAppCenter.c("JSDebuggerSoLoader", String.format("updateJSDebuggerConfig, aiKeywordConfig is null", new Object[0]));
        return;
      }
      localObject1 = ((aqzg)localObject1).d;
    } while (localObject1 == null);
    jdField_a_of_type_JavaUtilMap.clear();
    localObject1 = ((ArrayList)localObject1).iterator();
    while (((Iterator)localObject1).hasNext())
    {
      Object localObject2 = (aqzj)((Iterator)localObject1).next();
      if (localObject2 != null)
      {
        String str1 = ((aqzj)localObject2).jdField_a_of_type_JavaLangString;
        String str2 = ((aqzj)localObject2).b;
        localObject2 = ((aqzj)localObject2).c;
