...
public class nha
  extends nfr
{
  public nha(Context paramContext, ArrayList<nmv> paramArrayList, nfb paramnfb, String paramString1, String paramString2)
  {
  ...
  public static View a(Context paramContext, View paramView, ViewGroup paramViewGroup, nmu paramnmu, int paramInt, nfb paramnfb, String paramString1, String paramString2)
  {
    ...
    if (paramnmu.size() % 2 != 0)
    {
      paramnmu.remove(paramnmu.size() - 1);
    ...
    for (;;)
    {
      ...
      if ((paramViewGroup == null) || (!(paramViewGroup instanceof nha)) || (!((nha)paramViewGroup).a(paramnmu))) {
        break label162;
      }
      paramContext = paramView;
      if (!QLog.isDevelopLevel()) {
    ...
    paramContext = new nha(paramContext, paramnmu, paramnfb, paramString1, paramString2);
  ...
  private void a(LinearLayout paramLinearLayout)
  {
    ...
    int m = actn.a(2.0F, (Resources)localObject1);
    int n = (((Resources)localObject1).getDisplayMetrics().widthPixels - m) / 2;
    int i1 = actn.a(125.0F, (Resources)localObject1);
    int i = 0;
    if (i < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      for (;;)
      {
        localObject2 = (nmv)this.jdField_a_of_type_JavaUtilArrayList.get(i);
        ...
        ((URLImageView)localObject1).setBackgroundDrawable(URLDrawable.getDrawable(((nmv)localObject2).e, null, null, true));
        ...
        ((RelativeLayout.LayoutParams)localObject3).setMargins(actn.a(20.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0, actn.a(20.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
        ((TextView)localObject1).setLayoutParams((ViewGroup.LayoutParams)localObject3);
        ((TextView)localObject1).setGravity(17);
        ((TextView)localObject1).setText(((nmv)localObject2).a);
