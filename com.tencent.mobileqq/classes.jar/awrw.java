...
public class awrw
{
  ...
  public awrw(int paramInt1, int paramInt2, Map<Integer, String> paramMap)
  {
  ...
  {
    boolean bool = false;
    if ((paramObject instanceof awrw)) {
      bool = bdal.a(((awrw)paramObject).jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString);
    }
    return bool;
  }
}
