  ...
  implements View.OnClickListener
{
  ...
  private ort jdField_a_of_type_Ort;
  private oru jdField_a_of_type_Oru;
  ...
  public oro(Context paramContext, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131379898));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131379509));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131379879));
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131379864));
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)findViewById(2131363743));
      this.e = ((TextView)findViewById(2131379957));
      ...
      this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131370357));
      this.jdField_b_of_type_AndroidWidgetLinearLayout.setOnClickListener(this);
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setOnClickListener(this);
      uab.a(this.jdField_a_of_type_AndroidWidgetButton, afur.a(6.0F, paramContext.getResources()), Color.parseColor("#EBEDF5"));
      uab.a(this.jdField_a_of_type_AndroidWidgetTextView, afur.a(4.0F, paramContext.getResources()), Color.parseColor("#F2F3F7"));
      uab.a(this.jdField_b_of_type_AndroidWidgetTextView, afur.a(4.0F, paramContext.getResources()), Color.parseColor("#F2F3F7"));
      uab.a(this.jdField_c_of_type_AndroidWidgetTextView, afur.a(4.0F, paramContext.getResources()), Color.parseColor("#F2F3F7"));
  ...
  private void a()
  {
    ...
    {
      this.jdField_a_of_type_Oru = new oru(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidWidgetLinearLayout.getHeight());
      String str2 = "";
      String str1 = str2;
      ...
      this.jdField_a_of_type_Oru.a(this.jdField_a_of_type_JavaUtilList, new orp(this), str1);
      this.jdField_a_of_type_Oru.show();
    }
  }
  ...
  private void b()
  {
    if ((this.jdField_c_of_type_JavaUtilList != null) && (this.jdField_c_of_type_JavaUtilList.size() > 0))
    {
      ...
      this.jdField_a_of_type_Oru.a(this.jdField_c_of_type_JavaUtilList, new orq(this), str1);
      this.jdField_a_of_type_Oru.show();
    }
  }
    ...
    if ((this.jdField_d_of_type_JavaUtilList != null) && (this.jdField_d_of_type_JavaUtilList.size() > 0))
    {
      ...
      if (this.jdField_c_of_type_ComTencentBizPubaccountReadinjoyAdDataGiftServiceBean != null)
      {
        ...
        if (!TextUtils.isEmpty(this.jdField_c_of_type_ComTencentBizPubaccountReadinjoyAdDataGiftServiceBean.t)) {
          str1 = this.jdField_c_of_type_ComTencentBizPubaccountReadinjoyAdDataGiftServiceBean.t;
        }
      }
      this.jdField_a_of_type_Oru.a(this.jdField_d_of_type_JavaUtilList, new orr(this), str1);
      this.jdField_a_of_type_Oru.show();
    }
  }
  ...
  private void e()
  {
    ...
    {
      uab.a(this.jdField_a_of_type_AndroidWidgetButton, afur.a(6.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), Color.parseColor("#00CAFC"));
      this.jdField_a_of_type_AndroidWidgetButton.setClickable(true);
      return;
    }
    uab.a(this.jdField_a_of_type_AndroidWidgetButton, afur.a(6.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), Color.parseColor("#EBEDF5"));
  ...
  public void a(Configuration paramConfiguration)
  {
    ...
    if (this.jdField_a_of_type_Oru != null) {
      this.jdField_a_of_type_Oru.dismiss();
    }
  }
  ...
  public void a(List<GiftServiceBean> paramList1, List<GiftServiceBean> paramList2, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      this.jdField_c_of_type_ComTencentBizPubaccountReadinjoyAdDataGiftServiceBean.t = anni.a(2131704057);
  ...
  public void a(ort paramort)
  {
    this.jdField_a_of_type_Ort = paramort;
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      d();
      continue;
      oll.b(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo, 3, a());
      dismiss();
      continue;
      dismiss();
      if (this.jdField_a_of_type_Ort != null) {
        this.jdField_a_of_type_Ort.a();
      }
    }
  }
