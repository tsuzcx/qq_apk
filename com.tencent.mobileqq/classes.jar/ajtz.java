  ...
  implements View.OnClickListener
{
  ...
  public boolean a;
  protected ArrayList<ajsm> b;
  protected boolean b;
  private boolean c;
  private boolean d;
  
  public ajtz(Context paramContext, QQAppInterface paramQQAppInterface, ListView paramListView, int paramInt, boolean paramBoolean)
  {
  ...
  private void a(View paramView)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if (bnrt.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
        break label134;
      }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (bool)
        {
          achd.a(null, "Usr_NewDevice_Click", i, 0, 0);
      ...
      catch (Exception localException2)
      {
        for (;;)
        {
          try
          {
            ...
            bnrt.a().a((Activity)this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), localIntent2, str1, 0, null, SmartDevicePluginProxyActivity.class);
            achd.a(null, "Usr_NewDevice_Click", i, 0, 0);
          }
  ...
  private void a(View paramView, Friends paramFriends)
  {
    ...
    paramFriends = localabur.a(paramFriends.signature, paramFriends.iTermType);
    localabur.a((Activity)this.jdField_a_of_type_AndroidContentContext, paramFriends, false);
    ...
    if (paramFriends == null)
    {
      ...
      i = 1;
      achd.a(null, l, "Usr_LiteApp_Open", i, 0, paramFriends.productId);
      l = paramFriends.din;
    ...
    for (int i = 1;; i = 2)
    {
      achd.a(null, l, "Usr_LiteApp_Open_Online", i, 0, paramFriends.productId);
      return;
      i = 2;
      break;
    }
  ...
  {
    aogj localaogj = (aogj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(10);
    int i;
    if (paramString.equals(antf.z)) {
      i = localaogj.a();
    }
    for (;;)
    {
  ...
  private void f()
  {
    ...
    localFriends.uin = antf.z;
    localFriends.remark = anzj.a(2131693921);
    localFriends.name = anzj.a(2131693921);
    if (a(antf.z))
    {
      i = 10;
      localFriends.status = ((byte)i);
      localFriends.groupid = 1001;
      localArrayList.add(ajsl.a(5, localFriends, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext));
      ...
      if ((a(antf.A)) || (this.c))
      {
        ...
        localFriends.uin = antf.A;
        localFriends.remark = this.jdField_a_of_type_AndroidContentContext.getString(2131693392);
        localFriends.name = this.jdField_a_of_type_AndroidContentContext.getString(2131693392);
        if (!a(antf.A)) {
          break label523;
        }
        i = 10;
        ...
        if (!this.d)
        {
          bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005D18", "0X8005D18", 0, 0, "", "", "", "");
          this.d = true;
      ...
      if (((aodm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(74)).a())
      {
        localFriends = new Friends();
        localFriends.uin = antf.B;
        localFriends.remark = this.jdField_a_of_type_AndroidContentContext.getString(2131691216);
        localFriends.name = this.jdField_a_of_type_AndroidContentContext.getString(2131691216);
        if (!a(antf.A)) {
          break label528;
        }
      }
    ...
    for (int i = 10;; i = 0)
    {
      ...
      {
        localFriends = new Friends();
        localFriends.uin = antf.y;
        localFriends.remark = this.jdField_a_of_type_AndroidContentContext.getString(2131691214);
        localFriends.name = this.jdField_a_of_type_AndroidContentContext.getString(2131691214);
  ...
  public int a()
  {
    ...
    while (i < getCount())
    {
      ...
      if ((localObject1 != null) && ((localObject1 instanceof ajtx)))
      {
        localObject1 = (Friends)((ajtx)localObject1).a;
        Object localObject2 = (abur)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51);
        if (localObject2 != null)
        {
          localObject2 = ((abur)localObject2).b();
  ...
  public void a(boolean paramBoolean, String paramString)
  {
    ...
    {
      Friends localFriends = (Friends)((ajsm)((Iterator)localObject).next()).a;
      if (((localFriends.uin.equals(antf.z)) || (localFriends.uin.equals(antf.B))) && ((paramString.equals(antf.z)) || (paramString.equals(antf.B))))
      {
        if (paramBoolean)
        {
          j = 10;
  ...
  public void b()
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localFriends.remark = ache.a(localDeviceInfo);
        ...
        localArrayList1.add(ajsl.a(5, localFriends, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext));
        this.jdField_a_of_type_Int += 1;
        break;
        i = 0;
        break label170;
        ...
        {
          localObject = localabur.a(localDeviceInfo.productId);
      ...
      label479:
      localArrayList2.add(ajsl.a(5, localFriends, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext));
      break;
  ...
  public void d()
  {
    ...
    if (i < localArrayList.size()) {
      if (!((Friends)((ajsm)localArrayList.get(i)).a).uin.equals(antf.B)) {}
    }
    for (;;)
    {
      if (((aodm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(74)).a()) {
  ...
  public void e()
  {
    ...
    for (;;)
    {
      ...
      int i = 0;
      if (i < localArrayList.size()) {
        if (!((Friends)((ajsm)localArrayList.get(i)).a).uin.equals(antf.A)) {}
      }
      for (;;)
      {
        if (i != -1) {
        ...
        for (i = 1;; i = 0)
        {
          ...
          ((aogj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(10)).d(1);
          return;
          i += 1;
          break;
          i = 0;
  ...
  public Object getItem(int paramInt)
  {
    ...
    return (ajsm)this.jdField_b_of_type_JavaUtilArrayList.get(paramInt);
  }
  ...
  {
    View localView = ((ajsm)this.jdField_b_of_type_JavaUtilArrayList.get(paramInt)).a(0, paramInt, paramView, paramViewGroup, null);
    if (localView != null)
    {
      a((ajsp)localView.getTag(), null);
  ...
  public void onClick(View paramView)
  {
    ...
    if (localajsp != null)
    {
      ...
      if ((localajsp.a instanceof Friends)) {
        localObject = (Friends)localajsp.a;
      }
    }
    if (localObject == null) {}
    for (;;)
    {
      ...
      return;
      if (antf.y.equals(((Friends)localObject).uin)) {
        if (QLog.isColorLevel()) {
      ...
      try
      {
        ((bbav)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36)).b("100701.100702");
        label118:
        if ((this.jdField_a_of_type_AndroidContentContext instanceof BaseActivity))
        {
          ...
          if (apdr.a(localBaseActivity)) {
            break label262;
          }
          localBaseActivity.requestPermissions(new ajua(this, paramView, localBaseActivity), 3, new String[] { "android.permission.READ_EXTERNAL_STORAGE", "android.permission.WRITE_EXTERNAL_STORAGE" });
        }
        for (;;)
        {
          if (!antf.z.equals(((Friends)localObject).uin)) {
            break label278;
          }
          ...
          bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800603C", "0X800603C", 0, 0, "", "", "", "");
          break;
          label262:
          a(paramView);
          continue;
        ...
        label278:
        if (antf.A.equals(((Friends)localObject).uin))
        {
          localObject = new Intent(this.jdField_a_of_type_AndroidContentContext, LiteActivity.class);
          ((Intent)localObject).putExtra("targetUin", antf.A);
          this.jdField_a_of_type_AndroidContentContext.startActivity((Intent)localObject);
          bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006041", "0X8006041", 0, 0, "", "", "", "");
          continue;
        }
        if (antf.B.equals(((Friends)localObject).uin))
        {
          localObject = new Intent(this.jdField_a_of_type_AndroidContentContext, PrinterActivity.class);
          this.jdField_a_of_type_AndroidContentContext.startActivity((Intent)localObject);
          continue;
        }
        if ((!antf.aa.equals(((Friends)localObject).uin)) || (!this.jdField_a_of_type_Boolean)) {
          continue;
        }
        if ((this.jdField_a_of_type_AndroidContentContext instanceof BaseActivity))
        {
          ...
          if (!apdr.a(localBaseActivity))
          {
            localBaseActivity.requestPermissions(new ajub(this, paramView, (Friends)localObject, localBaseActivity), 3, new String[] { "android.permission.READ_EXTERNAL_STORAGE", "android.permission.WRITE_EXTERNAL_STORAGE" });
            continue;
          }
