...
{
  public ajtz(VasQuickUpdateManager paramVasQuickUpdateManager) {}
  ...
  public void onCompleted(long paramLong, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
            ...
            do
            {
              do
              {
                ...
                do
                {
                  ...
                  if ("xydata.qim.hifont.recommend.json".equals(paramString1))
                  {
                    if (paramInt1 != 0) {
                      break;
                    }
                    ((HiBoomManager)this.a.a.getManager(218)).a(false);
                    break;
                  }
                  ...
                  if (paramLong == 5L)
                  {
                    ...
                    if (paramString1.startsWith("font.hifont.android."))
                    {
                      ...
                      localObject = paramString1.substring("font.hifont.android.".length(), paramString1.length());
                      if (!TextUtils.isDigitsOnly((CharSequence)localObject)) {
                        break;
                      }
                      i = Integer.parseInt((String)localObject);
      ...
      else if (paramLong == 1004L)
      {
        ...
        label2281:
        if (paramString1.equals("libVipFont_735")) {
        ...
        } else if (paramString1.equals("libqgplayer_760")) {
