...
public class anxw
  implements affa, Handler.Callback, anxs
{
  ...
  private anxz jdField_a_of_type_Anxz;
  private bepm jdField_a_of_type_Bepm = new anxx(this);
  ...
  public anxw(BaseChatPie paramBaseChatPie)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetScroller = new Scroller(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext, new bibc());
  ...
  {
    float f1 = 0.0F;
    float f2 = (Math.abs(paramFloat) - (BaseChatItemLayout.U + BaseChatItemLayout.V)) / aepi.a(20.0F, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getResources());
    if (f2 < 0.0F) {}
    for (;;)
    {
  ...
  private int a()
  {
    return aepi.a(59.0F, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getResources());
  }
  ...
  private int a(ChatMessage paramChatMessage)
  {
    ...
    for (;;)
    {
      ...
      {
        paramChatMessage = new bamp(((MessageForText)paramChatMessage).sb, 8);
        if ((paramChatMessage.a != null) && (paramChatMessage.a.length > 0))
        {
          ...
          while (i < j)
          {
            if ((paramChatMessage[i] instanceof bamx)) {
              return 7;
            }
            i += 1;
          }
  ...
  private void a(float paramFloat1, float paramFloat2)
  {
    ...
    if ((f1 > this.jdField_a_of_type_Int) || (paramFloat2 > this.jdField_a_of_type_Int))
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getAdapter() instanceof bhxm))
      {
        ListAdapter localListAdapter = ((bhxm)this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getAdapter()).getWrappedAdapter();
        if ((localListAdapter instanceof aeqo)) {
          ((aeqo)localListAdapter).d();
        }
      }
  ...
  private void a(MotionEvent paramMotionEvent)
  {
    ...
    if (((localView instanceof BaseChatItemLayout)) && (a(((BaseChatItemLayout)localView).findViewById(2131364173), paramMotionEvent)))
    {
      this.jdField_a_of_type_AndroidViewView = localView;
      this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131364196);
    }
    if (QLog.isColorLevel()) {
  ...
  private void a(View paramView, int paramInt)
  {
    ...
    if (!this.jdField_d_of_type_Boolean) {
      if (paramInt >= i)
      {
        ...
        this.jdField_a_of_type_AndroidAnimationAnimatorSet.addListener(new anxy(this));
  ...
  private void b()
  {
    if (!b())
    {
      ...
      if (localObject != null)
      {
        azqs.b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A92F", "0X800A92F", a((ChatMessage)localObject), b((ChatMessage)localObject), "", "", "", "");
        ...
        if ((localObject instanceof MessageForStructing))
        {
          ...
          if ((((MessageForStructing)localObject).structingMsg != null) && (((MessageForStructing)localObject).structingMsg.mMsgServiceID == 81) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)) {
            wxj.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext, (MessageForStructing)localObject, "reply");
          }
        }
      }
    }
  ...
  private void b(int paramInt)
  {
    ...
    if (paramInt >= a())
    {
      ...
      {
        bool = bddb.b(BaseApplicationImpl.getApplication().getApplicationContext(), this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  ...
  private boolean b()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1) && (((bcnu)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(48)).a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, true).jdField_a_of_type_Boolean))
    {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131697834, 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298914));
      return true;
    }
    return false;
  }
  ...
  private int c()
  {
    return aepi.a(89.0F, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getResources());
  }
  ...
  private boolean c()
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_Anxz != null) && (anxz.a(this.jdField_a_of_type_Anxz, localChatMessage))) {
        return anxz.b(this.jdField_a_of_type_Anxz, localChatMessage);
      }
  ...
  private boolean c(MotionEvent paramMotionEvent)
  {
    ...
    if (k < this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getWidth() - BaseChatItemLayout.i - aepi.a(5.0F, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext.getResources()) - BaseChatItemLayout.Q) {}
    for (int i = 1; i != 0; i = 0)
    {
      i = j;
      ...
      boolean bool = a(((BaseChatItemLayout)localView).findViewById(2131364173), paramMotionEvent);
      if (QLog.isColorLevel()) {
  ...
  public void a(int paramInt)
  {
    ...
    do
    {
      ...
      if (((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof agps)) || ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof TroopChatPie)) || ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof agpi))) {
        bool = true;
      }
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
        this.jdField_a_of_type_Anxz = new anxz(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, null);
      }
  ...
  public void a(View paramView)
  {
    ...
    {
      paramView = (aeqi)paramView.getTag();
