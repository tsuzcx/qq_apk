...
public class aohb
  implements Manager
{
  private static final aohb jdField_a_of_type_Aohb;
  public static final String a;
  private static final CopyOnWriteArrayList<aohd> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList;
  private static final AtomicBoolean jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean;
  public static boolean a;
  
  static
  {
    if (!aohb.class.desiredAssertionStatus()) {}
    for (boolean bool = true;; bool = false)
    {
      b = bool;
      jdField_a_of_type_JavaLangString = aohb.class.getSimpleName();
      jdField_a_of_type_Aohb = new aohb();
      jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(((Boolean)bnrf.a("SearchWordHistoryManager.spkey_has_migrate_from_old_version", Boolean.valueOf(true))).booleanValue());
  ...
  {
    return jdField_a_of_type_Aohb;
  }
  
  @NonNull
  private String a()
  {
    return (String)bnrf.a("search_keyword_list", "");
  }
  ...
  public static void a(@NonNull aohd paramaohd)
  {
    jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(paramaohd);
  }
  ...
  private void a(@NonNull List<TKDSearchHistoryBean> paramList)
  {
    ...
    bnrf.a("search_keyword_list", a((List)localObject));
    c();
  }
  ...
  public static void b(@NonNull aohd paramaohd)
  {
    jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.remove(paramaohd);
  }
  ...
  private void c()
  {
    ...
    while (localIterator.hasNext()) {
      ((aohd)localIterator.next()).onHistoryChanged();
    }
  }
  ...
  public List<TKDSearchHistoryBean> a()
  {
    ...
    {
      b();
      bnrf.a("SearchWordHistoryManager.spkey_has_migrate_from_old_version", Boolean.valueOf(false));
    }
    return a(a());
  }
