  ...
  implements DownloadParams.DecodeHandler
{
  ...
  WeakReference<aswc> jdField_a_of_type_JavaLangRefWeakReference;
  
  public aswb(String paramString, aswc paramaswc, Object paramObject)
  {
    if (paramaswc != null) {
      this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramaswc);
    }
  ...
  public Bitmap run(DownloadParams paramDownloadParams, Bitmap paramBitmap)
  {
    ...
    for (paramDownloadParams = null;; paramDownloadParams = (aswc)this.jdField_a_of_type_JavaLangRefWeakReference.get())
    {
      if (paramDownloadParams != null)
      {
        int[] arrayOfInt = aswe.a(Bitmap.createBitmap(paramBitmap, 0, paramBitmap.getHeight() / 2, paramBitmap.getWidth(), paramBitmap.getHeight() / 2));
