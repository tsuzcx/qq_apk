  ...
  extends xsw
{
  ...
  public xvp(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
  }
  
  private long a(MessageForDeviceFile paramMessageForDeviceFile, View paramView, amsl paramamsl)
  {
    long l1;
  ...
  private MessageRecord a(long paramLong1, long paramLong2, JSONObject paramJSONObject)
  {
    ...
    MessageForDevPtt localMessageForDevPtt = (MessageForDevPtt)awbi.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, Long.toString(paramLong2), null, 9501);
    ...
    localMessageForDevPtt.time = awao.a();
    localMessageForDevPtt.msg = (babh.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForDevPtt.senderuin, true) + ": " + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131625722));
  ...
  private MessageRecord b(long paramLong1, long paramLong2, JSONObject paramJSONObject)
  {
    ...
    localMessageForDeviceFile.msg = (babh.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForDeviceFile.senderuin, true) + ": " + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131626019));
    ...
    if (i < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      if ((localView != null) && (localObject != null))
      {
        ...
        if ((paramMessageRecord instanceof MessageForDeviceFile)) {
          ((amsl)localObject).a(localView, (MessageForDeviceFile)paramMessageRecord);
        }
      }
      for (int j = i;; j = i - 1)
      {
  ...
  public long a(MessageRecord paramMessageRecord, View paramView, amsl paramamsl)
  {
    if ((paramMessageRecord instanceof MessageForDeviceFile)) {
      return a((MessageForDeviceFile)paramMessageRecord, paramView, paramamsl);
    }
    return 0L;
  }
  ...
  {
    Object localObject1 = (xsy)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong));
    ...
    do
    {
      ...
      localObject2 = ((QQAppInterface)localObject2).a().a(((xsy)localObject1).jdField_a_of_type_JavaLangString, ((xsy)localObject1).jdField_a_of_type_Int, ((xsy)localObject1).jdField_a_of_type_Long);
  ...
  public void a(Session paramSession, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        this.b.put(Long.valueOf(localMessageRecord.uniseq), Long.valueOf(awao.a()));
      }
    } while (!QLog.isColorLevel());
