...
public class bdbb
{
  ...
  public bdbb(Context paramContext, AppInterface paramAppInterface)
  {
    this(paramAppInterface);
  }
  
  public bdbb(AppInterface paramAppInterface)
  {
    if ((paramAppInterface instanceof QQAppInterface)) {
      this.a = new bdbf((QQAppInterface)paramAppInterface);
    }
    while (this.a == null)
    {
      throw new NullPointerException("can not Instantiation FaceDecoder");
      if ((paramAppInterface instanceof NearbyAppInterface)) {
        this.a = new bdcz((NearbyAppInterface)paramAppInterface);
      }
    }
  }
