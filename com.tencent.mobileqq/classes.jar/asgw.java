...
{
  public asgw(EmoticonFromGroupManager.5 param5, URLDrawable paramURLDrawable, CustomEmotionData paramCustomEmotionData, ashd paramashd, ashc paramashc) {}
  
  public void onLoadCanceled(URLDrawable paramURLDrawable)
  {
    asgs.a(this.jdField_a_of_type_ComTencentMobileqqEmosmFavroamingEmoticonFromGroupManager$5.this$0).a.remove(this.jdField_a_of_type_ComTencentImageURLDrawable);
  }
  ...
  public void onLoadSuccessed(URLDrawable paramURLDrawable)
  {
    ...
    do
    {
      ...
      {
        return;
        str = asgs.a(this.jdField_a_of_type_ComTencentMobileqqEmosmFavroamingEmoticonFromGroupManager$5.this$0, paramURLDrawable);
      } while ("".equals(str));
    ...
    try
    {
      ...
      this.jdField_a_of_type_Ashd.d(this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData);
      this.jdField_a_of_type_Ashc.c(this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData);
      return;
    }
