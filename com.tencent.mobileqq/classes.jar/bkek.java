...
public class bkek
  implements bkbn<bkaw>
{
  int jdField_a_of_type_Int;
  long jdField_a_of_type_Long;
  int b;
  
  private bkek(DoodleLayout paramDoodleLayout) {}
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    ((AlphaAnimation)localObject).setAnimationListener(new bkel(this));
    ...
    localAlphaAnimation.setAnimationListener(new bkem(this));
    if (paramBoolean2) {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.jdField_a_of_type_Bkee != null) {
        this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.jdField_a_of_type_Bkee.b((Animation)localObject);
      }
      return;
    }
  }
  
  public boolean a(bkaw parambkaw, MotionEvent paramMotionEvent)
  {
    bkpe localbkpe = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.jdField_a_of_type_DovComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout.a();
    if (localbkpe != null) {}
    int i;
    int j;
    switch (localbkpe.jdField_a_of_type_Int)
    {
    default: 
    ...
    do
    {
      do
      {
        do
        {
          return false;
          i = localbkpe.b;
          if (i != bkfx.jdField_a_of_type_Int) {
          ...
          for (;;)
          {
            localObject = (bkfx)parambkaw.a(101);
            if (localObject != null) {
              ((bkfx)localObject).a(i);
            }
            if (parambkaw.b()) {
              break;
            }
          ...
          parambkaw.a((AppInterface)localObject, 2, localbkpe.b);
          break;
