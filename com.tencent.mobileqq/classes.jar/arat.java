  ...
  implements IExcitingTransferSendListener
{
  ...
  public arat(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, int paramInt, araw paramaraw, araz paramaraz)
  {
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.d = paramLong1;
    this.jdField_a_of_type_Araw = paramaraw;
    this.jdField_a_of_type_Araz = paramaraz;
  ...
  private ExcitingTransferEngine.ExcitingSendInfo a()
  {
    ...
    localExcitingSendInfo.mFileEntry.strLocalFilePath = this.jdField_a_of_type_Araw.a();
    localExcitingSendInfo.mFileEntry.strFileName = this.jdField_a_of_type_Araw.b();
    localExcitingSendInfo.mFileEntry.uFileSize = this.jdField_a_of_type_Araw.a();
    localExcitingSendInfo.mFileEntry.buf10MMd5 = this.jdField_a_of_type_Araw.b();
    localExcitingSendInfo.mFileEntry.bufMd5 = this.jdField_a_of_type_Araw.a();
    localExcitingSendInfo.mFileEntry.bufSha = this.jdField_a_of_type_Araw.d();
    localExcitingSendInfo.mFileEntry.bufSha3 = this.jdField_a_of_type_Araw.c();
    ...
    Object localObject = this.jdField_a_of_type_Araz.a();
    ...
    localObject = this.jdField_a_of_type_Araz.b();
    if (localObject != null)
    {
      i = ((List)localObject).size();
      if (i > 0)
    ...
    localExcitingSendInfo.mReqInfo.bSupportHttps = this.jdField_a_of_type_Araz.b();
    localExcitingSendInfo.mReqInfo.strSSLCName = this.jdField_a_of_type_Araz.a();
  ...
  public void a(long paramLong1, long paramLong2, long paramLong3)
  {
    if (this.jdField_a_of_type_Arba != null) {
      this.jdField_a_of_type_Arba.a(paramLong1, paramLong2, paramLong3);
    }
  }
  
  public void a(arba paramarba)
  {
    this.jdField_a_of_type_Arba = paramarba;
  }
  ...
  public void a(ExcitingTransferUploadResultRp paramExcitingTransferUploadResultRp)
  {
    ...
    if (this.jdField_a_of_type_Arba != null) {
      this.jdField_a_of_type_Arba.a(0, paramExcitingTransferUploadResultRp);
    }
  }
  ...
  public void b(int paramInt, ExcitingTransferUploadResultRp paramExcitingTransferUploadResultRp)
  {
    ...
    if (this.jdField_a_of_type_Arba != null) {
      this.jdField_a_of_type_Arba.a(paramInt, paramExcitingTransferUploadResultRp);
    }
  }
  ...
  public void onExcitingSendResult(boolean paramBoolean, int paramInt, ExcitingTransferUploadResultRp paramExcitingTransferUploadResultRp)
  {
    ...
    if (paramExcitingTransferUploadResultRp != null)
    {
      ...
      if (paramBoolean) {
        this.c = this.jdField_a_of_type_Araw.a();
      }
      this.jdField_b_of_type_Long = 0L;
      if (paramExcitingTransferUploadResultRp != null)
      {
        ...
        if (this.jdField_a_of_type_Araw.a() - paramExcitingTransferUploadResultRp.m_u64StartSize <= 0L) {
          break label308;
        }
      }
    }
    ...
    label302:
    label308:
    for (long l = this.jdField_a_of_type_Araw.a() - paramExcitingTransferUploadResultRp.m_u64StartSize;; l = 0L)
    {
  ...
  public void onExcitingSendStart()
  {
    ...
    } while (this.jdField_a_of_type_Arba == null);
    this.jdField_a_of_type_Arba.aF_();
  }
  ...
  public void onExcitingSubSenderResult(int paramInt, ExcitingTransferUploaderRp paramExcitingTransferUploaderRp)
  {
    ...
    for (String str = paramExcitingTransferUploaderRp.toString();; str = "")
    {
      QLog.i("ExcitingTransfer.BaseUploader<FileAssistant>", 1, str);
      if (this.jdField_a_of_type_Arba != null) {
        this.jdField_a_of_type_Arba.a(paramInt, paramExcitingTransferUploaderRp);
      }
      return;
    }
  }
