  ...
  implements ajto
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = abha.class.getSimpleName();
  }
  
  public abha(BaseActivity paramBaseActivity, abhc paramabhc)
  {
    this.jdField_a_of_type_JavaLangRunnable = new FriendProfilePhotoHelper.2(this);
    this.jdField_a_of_type_AndroidOsHandler$Callback = new abhb(this);
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity = paramBaseActivity;
    this.jdField_a_of_type_Abhc = paramabhc;
    ...
    paramBaseActivity = (ajtk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(2);
    if (paramBaseActivity != null) {
      this.jdField_a_of_type_Ajtn = paramBaseActivity.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this);
    }
  }
  ...
  public void a()
  {
    ...
    {
      ((ajtk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(2)).a(this.jdField_a_of_type_Ajtn);
  ...
  public void a(int paramInt, Intent paramIntent)
  {
    if (!bbev.d(BaseApplication.getContext())) {
      this.jdField_a_of_type_Abhc.a(2131694672, 1);
    }
    do
    {
      do
    ...
    ((ajtk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(2)).a(paramIntent);
    b();
  }
  ...
  protected void a(String paramString)
  {
    ...
    PhotoUtils.a(localIntent, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getClass().getName(), bazo.c(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity), bazo.d(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity), bazo.c(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity), bazo.d(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity), paramString, bazo.c());
  }
  ...
  public void a(ArrayList<String> paramArrayList)
  {
    ...
    ((ajtk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(2)).a(paramArrayList);
    b();
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    abtu.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, localIntent, PublicFragmentActivity.class, CustomCoverFragment.class, 1024);
  }
  ...
  public void b(int paramInt, Intent paramIntent)
  {
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            ...
            if (paramIntent.getBooleanExtra("action_cover_pick_gallery", false))
            {
              localajtk.b((String)localArrayList.get(0));
              b();
              this.jdField_a_of_type_Bfnk.postDelayed(this.jdField_a_of_type_JavaLangRunnable, 30000L);
              return;
            }
            localajtk.a(localArrayList);
            b();
            return;
            if (i != 1020) {
              break;
      ...
      a(bbdr.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_AndroidNetUri));
      return;
    } while ((i != 2002) || (paramInt != -1));
    paramIntent = auux.a(paramIntent.getStringExtra("card_url_key"));
    this.jdField_a_of_type_Abhc.a(paramIntent);
  }
  ...
  public void b(ArrayList<String> paramArrayList)
  {
    ...
    ((ajtk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(2)).b((String)paramArrayList.get(0));
    b();
    this.jdField_a_of_type_Bfnk.postDelayed(this.jdField_a_of_type_JavaLangRunnable, 30000L);
  }
  ...
  {
    int k = 0;
    this.jdField_a_of_type_Bfnk.removeCallbacks(this.jdField_a_of_type_JavaLangRunnable);
    c();
    this.jdField_a_of_type_Abhc.a(2131720680, 2);
    if (paramArrayOfByte != null)
    {
      ...
      do
      {
        ...
        {
          j = (int)bahq.a(arrayOfByte2);
        }
        if (QLog.isColorLevel()) {
          QLog.d(jdField_a_of_type_JavaLangString, 2, "len:" + j + " bLength:" + bbdm.a(arrayOfByte1) + " bFlipLength:" + bbdm.a(arrayOfByte2));
        }
      ...
      this.jdField_a_of_type_Abhc.b((byte[])localObject);
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 2, "send finish extraInfo is null");
    }
    this.jdField_a_of_type_Abhc.b(null);
  }
  ...
  public void d()
  {
    ...
    this.jdField_a_of_type_Bfnk.removeCallbacks(this.jdField_a_of_type_JavaLangRunnable);
    c();
    this.jdField_a_of_type_Abhc.a(2131720682, 1);
  }
}
