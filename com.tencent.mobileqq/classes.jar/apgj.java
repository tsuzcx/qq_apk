...
public class apgj
{
  public static int a(String paramString)
  {
    try
    {
      int i = apga.a("arsdk2", a(), apga.b("arsdk2", a(), "arsdk2"), paramString);
      return i;
    }
    finally
    {
  ...
  public static int a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        apga.a("arsdk2", a(), "arsdk2", paramString2);
        try
        {
          apfw.a(paramString1, apga.a("arsdk2", a(), apga.b("arsdk2", a(), "arsdk2")));
          paramString2 = apga.a("arsdk2", a(), apga.b("arsdk2", a(), "arsdk2")) + File.separator + "md5_config.xml";
        ...
        catch (IOException paramString2)
        {
          ...
          String str;
          i = -6;
          FileUtils.delete(apga.a("arsdk2", a(), apga.b("arsdk2", a(), "arsdk2")), false);
      ...
      try
      {
        ...
        {
          paramString1 = apga.a("arsdk2", a(), apga.b("arsdk2", a(), "arsdk2")) + File.separator + (String)((Map.Entry)localObject).getKey() + ".so";
          apga.a("arsdk2", a(), "libAlphaAR", (String)((Map.Entry)localObject).getValue());
        }
  ...
  {
    return new File(apga.a("arsdk2", a(), apga.b("arsdk2", a(), "arsdk2")) + File.separator + "libAlphaAR" + ".so").exists();
  }
  ...
  public static boolean a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        String str = apga.a("arsdk2", a(), apga.b("arsdk2", a(), "arsdk2")) + File.separator + paramString + ".so";
        ...
        if (((File)localObject).exists())
        {
          paramString = apga.b("arsdk2", a(), paramString);
          localObject = aznv.a(str);
