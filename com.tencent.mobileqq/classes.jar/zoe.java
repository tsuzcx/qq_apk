...
{
  public static final zog a;
  private final Map<String, zoh> a;
  
  static
  {
    jdField_a_of_type_Zog = new zog(null);
  }
  
  public zoe()
  {
    this.jdField_a_of_type_JavaUtilMap = MapsKt.mapOf(TuplesKt.to("showShareMenu", new zoh(this)));
  }
  ...
  public boolean handleJsRequest(@Nullable JsBridgeListener paramJsBridgeListener, @Nullable String paramString1, @Nullable String paramString2, @Nullable String paramString3, @NotNull String... paramVarArgs)
  {
    ...
    if ((localObject == null) || (((CharSequence)localObject).length() == 0))
    {
      ...
      localObject = (zoh)this.jdField_a_of_type_JavaUtilMap.get(paramString3);
      if (localObject == null) {
        break label129;
      }
    ...
    {
      ((zoh)localObject).a(paramJsBridgeListener);
      return true;
      i = 0;
      break;
      i = 0;
