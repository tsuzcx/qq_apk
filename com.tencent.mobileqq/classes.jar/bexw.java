    ...
    if (paramURLDrawableHandler.startsWith(File.separator))
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          localObject3 = (beiq)((QQAppInterface)BaseApplicationImpl.sApplication.getAppRuntime((String)localObject1)).getManager(185);
          localObject1 = paramOutputStream;
          ResData localResData;
          if (((beiq)localObject3).a != null)
          {
            ...
            paramDownloadParams = ((beiq)localObject3).a;
            if (i == 0) {
              break label728;
            }
          }
          ...
          for (i = 4;; i = 8)
          {
            ...
            {
              return localObject1;
              paramOutputStream = new File(blem.a((File)localObject1));
            ...
            paramOutputStream = new bihu(paramURLDrawableHandler, (File)localObject1);
            paramOutputStream.k = bool;
            if (bihw.a(paramOutputStream, BaseApplicationImpl.sApplication.getRuntime()) == 0)
            {
              ...
              for (;;)
              {
                ...
                paramOutputStream = blem.a((File)localObject1);
                break label498;
                i = 0;
              }
            }
            paramOutputStream = new File(antf.ba);
