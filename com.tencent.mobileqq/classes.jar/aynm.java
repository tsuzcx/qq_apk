  ...
  implements View.OnClickListener
{
  ...
  public aynm(Context paramContext)
  {
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqNearbyNowViewWidgetRoundRelativeLayout = ((RoundRelativeLayout)findViewById(2131365183));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)findViewById(2131363813));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131363496));
    ...
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131371538));
  ...
  {
    new bdlf(null).a("dc00899").b("grp_lbs").c("home").d(paramString).e(this.jdField_a_of_type_Axnl.g).a(new String[] { this.jdField_a_of_type_Axnl.f }).a();
  }
  
  public boolean a(axnl paramaxnl)
  {
    this.jdField_a_of_type_Axnl = paramaxnl;
    if (QLog.isColorLevel()) {
      QLog.d("NearbyAppDownloadDialog", 2, "initContent=" + paramaxnl.toString());
    }
    a(this.jdField_a_of_type_AndroidWidgetImageView, paramaxnl.a);
    if (!TextUtils.isEmpty(paramaxnl.c))
    {
      this.jdField_a_of_type_AndroidWidgetButton.setText(paramaxnl.c);
      this.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
      if (TextUtils.isEmpty(paramaxnl.b)) {
        break label141;
      }
      this.jdField_a_of_type_AndroidWidgetTextView.setText(paramaxnl.b);
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    }
    for (;;)
    {
      if (TextUtils.isEmpty(paramaxnl.e)) {
        break label153;
      }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("NearbyAppDownloadDialog", 2, "btn onClick, jumpUrl=" + this.jdField_a_of_type_Axnl.d);
        }
        aynv.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Axnl.d);
        dismiss();
        a("pop_new_clk");
      }
      else if (i == 2131371538)
      {
        if (QLog.isColorLevel()) {
          QLog.d("NearbyAppDownloadDialog", 2, "more onClick, jumpUrl=" + this.jdField_a_of_type_Axnl.e);
        }
        aynv.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Axnl.e);
      }
    }
  }
