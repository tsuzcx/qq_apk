...
public class aynm
  extends ajtb
{
  public aynm(QQAppInterface paramQQAppInterface)
  {
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
      ...
      if ("QQAIOMediaSvc.get_latest_playing_state".equals(paramFromServiceMsg.getServiceCmd()))
      {
        ...
        else
        {
          ...
          else
          {
            ...
            paramObject = ((aync)this.mApp.getManager(339)).a(i);
            if (paramObject == null)
            {
              if (QLog.isColorLevel()) {
    ...
    return;
    aync.a(this.app).a(paramFromServiceMsg);
    label443:
