  ...
  implements View.OnClickListener
{
  ...
  public bagn(Context paramContext, int paramInt)
  {
    super(paramContext, paramInt);
    this.jdField_b_of_type_Float = 45.5F;
    this.jdField_c_of_type_Float = 39.0F;
    this.jdField_c_of_type_Boolean = true;
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new bagp(this);
  ...
  public void a(int paramInt)
  {
    if (this.jdField_a_of_type_AndroidWidgetEditText != null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new bagq(this, paramInt));
    }
  }
  
  void a(Context paramContext)
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletWidgetMyLinearLayout = ((MyLinearLayout)View.inflate(paramContext, 2131493361, null));
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletWidgetMyLinearLayout.findViewById(2131303602).setOnClickListener(this);
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletWidgetMyLinearLayout.setDispatchKeyEventListener(new bagr(this));
  }
  ...
  public void a(ArrayList<String> paramArrayList)
  {
    ...
    LinearLayout localLinearLayout = (LinearLayout)this.jdField_a_of_type_ComTencentMobileqqActivityQwalletWidgetMyLinearLayout.findViewById(2131303599);
    localLinearLayout.removeAllViews();
    int i = 0;
    while (i < paramArrayList.size())
    {
      View localView = View.inflate(getContext(), 2131493362, null);
      localView.setTag(Integer.valueOf(i));
      localView.setClickable(true);
      localView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
      ((TextView)localView.findViewById(2131303598)).setText((CharSequence)paramArrayList.get(i));
  ...
  public void onClick(View paramView)
  {
    if (paramView.getId() == 2131302576)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqActivityQwalletWidgetMyLinearLayout != null)
      {
        ...
        {
          a();
          this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130846195);
          this.jdField_a_of_type_AndroidWidgetImageView.setTag(Integer.valueOf(2130846195));
      ...
      if ((paramView != null) && ((paramView instanceof Integer)) && (((Integer)paramView).intValue() == 2130846793))
      {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130846793);
      this.jdField_a_of_type_AndroidWidgetImageView.setTag(Integer.valueOf(2130846793));
      this.jdField_a_of_type_AndroidOsHandler.postDelayed(new QQCustomDialogWtihInputAndChoose.6(this), 200L);
      return;
    }
    if (paramView.getId() == 2131303602)
    {
      a();
      return;
    }
  ...
  public void setContentView(int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131302576));
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.setOnTouchListener(new bago(this));
    Context localContext = (Context)this.jdField_a_of_type_JavaLangRefSoftReference.get();
    if (localContext == null) {
      return;
    }
    yes.a(localContext, this.jdField_a_of_type_AndroidWidgetEditText);
    a(localContext);
  }
  ...
  {
    TextView localTextView = (TextView)findViewById(2131299556);
  ...
  public bafb setNegativeButton(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.lBtn.setOnClickListener(new bags(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
  ...
  public bafb setPositiveButton(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.rBtn.setOnClickListener(new bagt(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
