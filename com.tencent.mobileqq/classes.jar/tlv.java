...
public class tlv
{
  ...
  {
    Object localObject = a();
    if (a((oye)localObject))
    {
      localObject = ((oye)localObject).a();
      tlo.d("WSPushLog", "WSRedDotPushMsg = " + (String)localObject);
  ...
  public static String a(stSimpleMetaFeed paramstSimpleMetaFeed, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      tlo.b("WeishiUtils", "使用webp图片资源：" + (String)localObject1);
    ...
    {
      tlo.b("WeishiUtils", "使用服务器默认的图片格式资源：" + (String)localObject3);
  ...
  public static oye a()
  {
    ...
    {
      localObject = (QQAppInterface)localObject;
      if ((((QQAppInterface)localObject).getManager(274) instanceof oye)) {
        return (oye)((QQAppInterface)localObject).getManager(274);
      }
    }
    return null;
  }
  ...
  public static void a()
  {
    ...
    if (localoye != null)
    {
      ...
      localstSimpleMetaFeed.id = localoye.c();
      localstSimpleMetaFeed.feed_desc = localoye.d();
      localoye.a(localstSimpleMetaFeed);
    }
  }
  ...
  public static void a(Context paramContext, KandianUrlImageView paramKandianUrlImageView, URL paramURL, Drawable paramDrawable)
  {
    ...
    paramKandianUrlImageView.a((Drawable)localObject).a(paramURL);
    paramKandianUrlImageView.setPublicAccountImageDownListener(new tlw(paramKandianUrlImageView));
  }
  
  public static void a(Context paramContext, RoundImageView paramRoundImageView, String paramString)
  {
    tlo.b("AvatarImageLog", "WeishiUtils loadAvatarImage url:" + paramString + ", imageView:" + paramRoundImageView);
    URL localURL;
    ...
    paramRoundImageView.setImageDrawable(paramContext);
    paramContext.setURLDrawableListener(new tlx(paramString, paramRoundImageView));
  }
  
  public static void a(Context paramContext, String paramString1, String paramString2, String paramString3, int paramInt, tmc paramtmc)
  {
    if (paramtmc == null) {
    ...
    if (xsx.a(paramContext))
    {
      ...
      {
        tlo.c("815", "走打开shemeUrl:" + paramString1);
        paramtmc.a(paramString1, paramInt);
        return;
      }
      if (!TextUtils.isEmpty(paramString3))
      {
        tlo.c("833", "走打开小程序:" + paramString3);
        paramtmc.d(paramString3, paramInt);
        return;
      }
      if (!TextUtils.isEmpty(paramString2))
      {
        tlo.c("815", "走打开h5Url:" + paramString2);
        paramtmc.b(paramString2, paramInt);
        return;
      }
      tlo.c("815", "走打开兜底:" + paramString1);
      paramtmc.a("weishi://main", paramInt);
      return;
    }
    if (!TextUtils.isEmpty(paramString3))
    {
    ...
    if (!TextUtils.isEmpty(paramString2))
    {
      tlo.c("815", "走跳转h5Url:" + paramString2);
      paramtmc.b(paramString2, paramInt);
      return;
    }
    tlo.c("815", "走下载，shemeUrl:" + paramString1);
    paramtmc.c(paramString1, paramInt);
  }
  ...
  public static void a(Context paramContext, ArrayList<stSimpleMetaFeed> paramArrayList, int paramInt1, String paramString, stGlobalConfig paramstGlobalConfig, WSRedDotPushMsg paramWSRedDotPushMsg, int paramInt2)
  {
    ...
    try
    {
      ...
      if (paramArrayList != null)
      {
        ...
        if (paramArrayList.size() > 0)
        {
          ...
          paramString = tee.a().a(paramArrayList.traceId);
        }
      }
      ...
      tci.jdField_a_of_type_Boolean = true;
      c("fullscreen_videoPlay");
      return;
    }
    catch (NumberFormatException paramString)
    {
      for (;;)
      {
        tlo.b("openVerticalVideoLayerPage parseLong posterId : " + paramString);
      }
    }
  }
  ...
  public static void a(View paramView, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      if (paramInt1 == 0)
      {
        ...
        localAlphaAnimation.setAnimationListener(new tma(paramView));
    ...
    localAlphaAnimation.setDuration(paramInt2);
    localAlphaAnimation.setFillAfter(true);
    localAlphaAnimation.setAnimationListener(new tmb(paramView));
    paramView.clearAnimation();
    paramView.startAnimation(localAlphaAnimation);
  }
  ...
  public static void a(ImageView paramImageView, String paramString1, Drawable paramDrawable1, Drawable paramDrawable2, String paramString2)
  {
    ...
    paramImageView.setImageDrawable(paramDrawable1);
    paramDrawable1.setURLDrawableListener(new tly(paramString2, paramImageView, paramString1));
    ...
    tlo.a("815", "onLoad ~~~~~~" + paramString2);
  }
  
  public static void a(KandianUrlImageView paramKandianUrlImageView, stSimpleMetaFeed paramstSimpleMetaFeed, Drawable paramDrawable)
  {
    paramstSimpleMetaFeed = a(a(paramstSimpleMetaFeed, false));
    a(BaseApplicationImpl.getApplication(), paramKandianUrlImageView, paramstSimpleMetaFeed, paramDrawable);
  }
  
  public static void a(KandianUrlImageView paramKandianUrlImageView, stSimpleMetaFeed paramstSimpleMetaFeed, boolean paramBoolean)
  {
    paramstSimpleMetaFeed = a(a(paramstSimpleMetaFeed, paramBoolean));
    a(BaseApplicationImpl.getApplication(), paramKandianUrlImageView, paramstSimpleMetaFeed, null);
  }
  ...
  public static void a(KandianUrlImageView paramKandianUrlImageView, String paramString, Drawable paramDrawable)
  {
    ...
    paramKandianUrlImageView.a(paramDrawable).a(paramString);
  }
  ...
  public static void a(BusinessInfoCheckUpdate.AppInfo paramAppInfo, boolean paramBoolean)
  {
    ...
    {
      tlo.b("WSRedDotLog", "saveRedDotAppInfo appInfo = " + paramAppInfo.iNewFlag.get());
      tlo.b("WSRedDotLog", "saveRedDotAppInfo hasWsRedDot = " + paramBoolean);
  ...
  public static void a(String paramString)
  {
    ...
    if ((localClipboardManager != null) && (!TextUtils.isEmpty(paramString)))
    {
      ...
      tlo.d("WeishiUtils", "Clipboard copyScheme: " + paramString + ", clip: " + localClipData);
  ...
  public static void a(List<stSimpleMetaFeed> paramList, boolean paramBoolean)
  {
    ...
    tlo.b("PreloadCoverImgLog", "preloadImg size = " + paramList.size());
  ...
  public static boolean a(oye paramoye)
  {
    if (paramoye == null) {
      return false;
    }
  ...
  {
    return paramString + "&idx=" + tee.a().e();
  }
  ...
  public static boolean b()
  {
    ...
    {
      tlo.f("WeishiUtils", "click too fast");
  ...
  public static void c(String paramString)
  {
    ...
    {
      tjx.b = "";
      tjx.jdField_a_of_type_JavaLangString = "";
      LocalMultiProcConfig.putString("weishi_usergrowth", "key_ref_page_id", "");
      return;
    }
    tjx.b = tjx.jdField_a_of_type_JavaLangString;
    LocalMultiProcConfig.putString("weishi_usergrowth", "key_ref_page_id", tjx.b);
    tjx.jdField_a_of_type_JavaLangString = paramString;
  }
  ...
  public static String e()
  {
    ...
    {
      tlo.d("WeishiUtils", "getWifiBssid : " + localException.toString());
    }
    return "";
  }
  ...
  public static String f()
  {
    ...
    tlo.f("WeishiUtils", "[qq_connect_person_id]" + str);
    return str;
  }
}
