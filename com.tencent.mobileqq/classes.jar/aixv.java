...
public class aixv
  implements Runnable
{
  public aixv(HomeworkTroopController paramHomeworkTroopController, int paramInt) {}
  ...
  public void run()
  {
    ...
    if (i != 0) {}
    for (int i = 2131430707;; i = 2131430708)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqTroopLogicHomeworkTroopController.jdField_a_of_type_ComTencentWidgetCalloutpopupwindowCalloutPopupWindow.a(new aixw(this));
