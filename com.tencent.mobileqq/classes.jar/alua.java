...
public class alua
{
  ...
  public alua(String paramString)
  {
    this.jdField_a_of_type_Alug = new ApolloGameInterfaceProxy(this, paramString);
  ...
  {
    if (altz.a(this.jdField_a_of_type_JavaLangString))
    {
      paramString2 = altz.b(paramString2);
      if (QLog.isColorLevel()) {
        QLog.d("ApolloJSContext", 1, "[notifyJSEVent] " + paramString1 + " " + paramString2);
      }
      a(String.format("if(window.__dispatchEvent){window.__dispatchEvent(%s,'%s','%s')}", new Object[] { Integer.valueOf(paramInt), paramString1, paramString2 }), new alub(this));
      return;
    }
  ...
  {
    if ((paramCustomWebView != null) && (this.jdField_a_of_type_Alug != null))
    {
      if (QLog.isColorLevel()) {
      ...
      {
        paramCustomWebView.addJavascriptInterface(this.jdField_a_of_type_Alug, "__browserMsg");
        return;
      }
  ...
  {
    if ((this.jdField_a_of_type_Alug != null) && ((this.jdField_a_of_type_Alug instanceof ApolloGameInterfaceProxy))) {
      ((ApolloGameInterfaceProxy)this.jdField_a_of_type_Alug).send(paramString2, paramString1);
    }
  }
  ...
  public void b()
  {
    ...
    if ((this.jdField_a_of_type_Alug != null) && ((this.jdField_a_of_type_Alug instanceof ApolloGameInterfaceProxy))) {
      ((ApolloGameInterfaceProxy)this.jdField_a_of_type_Alug).h();
    }
  ...
  public void b(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Alug != null)
    {
      ...
      for (;;)
      {
        this.jdField_a_of_type_Alug.a(this);
        return;
        label36:
        d();
      }
