  ...
  extends aqvi
{
  ...
  public void a(boolean paramBoolean1, long paramLong1, long paramLong2, int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean1)
      {
        aqvm localaqvm = this.a.app.getProxyManager().a();
        ConfessConvInfo localConfessConvInfo = localaqvm.a(this.a.sessionInfo.curFriendUin, this.a.sessionInfo.curType, this.a.sessionInfo.topicId);
        if ((localConfessConvInfo != null) && ((localConfessConvInfo.holmesCurCount != paramInt3) || (localConfessConvInfo.holmesTolCount != paramInt4))) {
          localaqvm.a(str, paramInt2, paramInt1, paramInt3, paramInt4);
        }
        ahzq.a(this.a, true);
      }
  ...
  {
    String str;
    if ((this.a.sessionInfo != null) && (bhbx.a(paramString1, this.a.sessionInfo.curFriendUin)) && (paramInt1 == this.a.sessionInfo.curType) && (paramInt2 == this.a.sessionInfo.topicId)) {
      if (QLog.isColorLevel())
      {
        str = this.a.tag;
