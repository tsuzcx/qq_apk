  ...
  extends ContextThemeWrapper
{
  ...
  public xje(Context paramContext, int paramInt, String paramString, ClassLoader paramClassLoader)
  {
    this(paramContext, paramInt, paramString, paramClassLoader, null, true);
  }
  
  public xje(Context paramContext, int paramInt, String paramString, ClassLoader paramClassLoader, Resources paramResources, boolean paramBoolean)
  {
  ...
  public xje(Context paramContext, int paramInt, xje paramxje)
  {
    super(paramContext, paramInt);
    this.jdField_a_of_type_JavaLangClassLoader = paramxje.jdField_a_of_type_JavaLangClassLoader;
    this.jdField_a_of_type_AndroidContentResAssetManager = paramxje.jdField_a_of_type_AndroidContentResAssetManager;
    this.jdField_a_of_type_AndroidContentResResources$Theme = paramxje.jdField_a_of_type_AndroidContentResResources$Theme;
    this.jdField_a_of_type_AndroidContentResResources = paramxje.jdField_a_of_type_AndroidContentResResources;
    this.jdField_a_of_type_Int = paramxje.jdField_a_of_type_Int;
  }
