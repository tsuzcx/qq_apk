  ...
  implements bkmq
{
  ...
  protected bkms(bkmk parambkmk)
  {
    super(parambkmk);
    this.jdField_a_of_type_Bkmq = this;
    this.a = new aima();
    this.jdField_a_of_type_Aima = ((aima)this.a);
  }
  
  public static bkmp a(bkmk parambkmk)
  {
    if ((jdField_a_of_type_Bkmp == null) || (jdField_a_of_type_Bkmp.jdField_a_of_type_MqqUtilWeakReference.get() != parambkmk)) {}
    try
    {
      if ((jdField_a_of_type_Bkmp == null) || (jdField_a_of_type_Bkmp.jdField_a_of_type_MqqUtilWeakReference.get() != parambkmk)) {
        jdField_a_of_type_Bkmp = new bkms(parambkmk);
      }
      return jdField_a_of_type_Bkmp;
    }
    finally {}
  }
  ...
  public View a(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      localObject = paramViewGroup.jdField_a_of_type_AndroidContentResResources.getDrawable(2130847117);
    ...
    localTextView.setTextColor(paramViewGroup.jdField_a_of_type_AndroidContentResResources.getColor(2131167192));
  ...
  protected bklw a()
  {
    return new bklx((bkmk)this.jdField_a_of_type_MqqUtilWeakReference.get());
  }
  ...
  {
    super.a(paramIntent);
    this.jdField_a_of_type_Aima.jdField_a_of_type_Avqu = new bkmt(this);
    this.jdField_a_of_type_Aima.jdField_a_of_type_Boolean = paramIntent.getBooleanExtra("PhotoConst.IS_FINISH_RESTART_INIT_ACTIVITY", false);
    ...
    if (str1 != null) {
      this.jdField_a_of_type_Aimj.myUin = str1;
    }
    if (this.jdField_a_of_type_Aimj.myUin == null) {
      throw new RuntimeException("must set MY_UIN");
    }
    a().a(this.jdField_a_of_type_Aimj.isShowQzoneAlbum);
    a().a(this.jdField_a_of_type_Aimj.jdField_a_of_type_Long);
    this.jdField_a_of_type_Aimj.mIsDisableTroopAlbum = paramIntent.getBooleanExtra("PhotoConst.DISABLE_UPLOAD_TO_TROOP_ALBUM", this.jdField_a_of_type_Aimj.mIsDisableTroopAlbum);
    if (this.jdField_a_of_type_Aimj.isShowQzoneAlbum)
    {
      ...
      BaseApplicationImpl.getApplication().getRuntime().registObserver(this.jdField_a_of_type_Aima.jdField_a_of_type_Avqu);
  ...
  public boolean a(QQAlbumInfo paramQQAlbumInfo, int paramInt, Intent paramIntent)
  {
    ...
    if (paramQQAlbumInfo._id.equals("qzone_album"))
    {
      ...
      bizm.a(((bkmk)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), localbizt, (Bundle)localObject, 100016);
