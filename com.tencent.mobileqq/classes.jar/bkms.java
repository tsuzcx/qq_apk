...
class bkms
{
  ...
  private void b()
  {
    ...
    a(this.jdField_c_of_type_Int, this.h, (int)this.jdField_a_of_type_Float, bkmr.jdField_a_of_type_Int);
  ...
  private void d(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    this.jdField_c_of_type_Int = paramInt2;
    this.h = (paramInt2 - paramInt1);
    this.jdField_e_of_type_Int = bkmr.jdField_a_of_type_Int;
  }
  ...
  void b(int paramInt1, int paramInt2, int paramInt3)
  {
    if (this.i == 0) {
      if (paramInt1 == paramInt2) {
        a(paramInt2, paramInt3, this.jdField_d_of_type_Int, bkmr.jdField_a_of_type_Int);
      }
    }
    while (this.i != 4)
    {
  ...
  boolean c()
  {
    ...
    for (;;)
    {
      ...
      continue;
      d1 = bkfh.a((float)l2 / this.jdField_e_of_type_Int) * this.h;
      continue;
