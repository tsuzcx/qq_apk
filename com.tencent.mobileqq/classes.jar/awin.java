...
public class awin
  implements Handler.Callback, bamh, bfqo
{
  ...
  {
    awkj.a("NearbyIconDecoder", "notifyGetIcon", new Object[] { paramString, paramBitmap });
  ...
  {
    awkj.a("NearbyIconDecoder", "onDecodeBitmap", new Object[] { paramString1, paramString2, paramBitmap, Integer.valueOf(paramInt) });
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    awkj.a("NearbyIconDecoder", "MSG_GET_ICON_URL", new Object[] { Integer.valueOf(this.b.size()), Integer.valueOf(this.c.size()) });
