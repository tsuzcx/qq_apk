...
public class awin
  implements blop
{
  public awin(UiApiPlugin paramUiApiPlugin, JSONObject paramJSONObject, Activity paramActivity) {}
  ...
  public void a(bloo parambloo)
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_AndroidAppActivity instanceof BasePluginActivity))
      {
        ...
        ((Intent)localObject2).putExtras(parambloo);
