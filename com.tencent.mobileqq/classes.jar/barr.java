  ...
  implements DialogInterface.OnDismissListener
{
  ...
  private static barv jdField_a_of_type_Barv;
  ...
  private BusinessObserver jdField_a_of_type_MqqObserverBusinessObserver = new bart(this);
  ...
  private JSONObject a(String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        bacm.a(paramString, new File((String)localObject));
        if (paramString == null) {
          break;
        }
        ...
        callJs(str, new String[] { localJSONObject.toString() });
        paramString = localJSONObject;
      } while (this.jdField_a_of_type_Bbms == null);
      this.jdField_a_of_type_Bbms.dismiss();
  ...
  private void a(String paramString)
  {
    Object localObject1;
    Object localObject2;
    if (jdField_a_of_type_Barv == null)
    {
      localObject1 = new barv(null);
      ...
      jdField_a_of_type_Barv = (barv)localObject1;
    ...
    try
    {
      ...
      try
      {
        ...
        ((SensorManager)localObject1).registerListener(localbaru, (Sensor)localObject2, 3, 0);
        ((SensorManager)localObject1).flush(localbaru);
        localObject1 = new NewIntent(this.mRuntime.a().getApplication(), basl.class);
    ...
    do
    {
      do
      {
        ...
        if ((l1 > 0L) && (((JSONObject)localObject1).toString().getBytes().length > l1))
        {
          ...
          paramString2.put("businessRet", 0);
          paramString2.put("msg", ajjy.a(2131639659));
          super.callJs(paramString1, new String[] { paramString2.toString() });
          return;
        }
        if (this.jdField_c_of_type_JavaUtilHashMap.containsKey("yundong_report.steps"))
        {
          ...
          if ((l1 > 0L) && (System.currentTimeMillis() - l2 < l1))
          {
            ...
            paramString2.put("businessRet", 0);
            paramString2.put("msg", ajjy.a(2131639658));
            super.callJs(paramString1, new String[] { paramString2.toString() });
        ...
        localObject2 = String.valueOf(basd.a());
      ...
      ((JSONObject)localObject1).put("version", "8.2.6");
      ...
      if (TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
        this.jdField_b_of_type_JavaLangString = bcez.c();
      }
      ((JSONObject)localObject1).put("imei", String.valueOf(this.jdField_b_of_type_JavaLangString));
      ((JSONObject)localObject1).put("adcode", akfu.b());
      if (QLog.isColorLevel()) {
      ...
      localObject1 = new bars(this);
    } while (this.mRuntime == null);
    Object localObject2 = new NewIntent(this.mRuntime.a().getApplicationContext(), aquf.class);
  ...
  private JSONObject b(String paramString)
  {
    ...
    //   12: lstore_3
    //   13: aload_0
    //   14: getfield 109	barr:mRuntime	Lbbac;
    //   17: ifnull +1113 -> 1130
    //   20: aload_0
    //   21: getfield 242	barr:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   24: ifnull +1106 -> 1130
    //   27: iconst_0
    //   28: istore 5
    ...
    //   58: aload_1
    //   59: ldc_w 614
    //   62: invokevirtual 456	org/json/JSONObject:getInt	(Ljava/lang/String;)I
    //   65: istore_2
    //   66: aload_1
    //   67: ldc 201
    //   69: invokevirtual 93	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   72: astore 11
    //   74: new 616	android/graphics/BitmapFactory$Options
    //   77: dup
    //   78: invokespecial 617	android/graphics/BitmapFactory$Options:<init>	()V
    //   81: astore_1
    //   82: aload_1
    //   83: iconst_1
    //   84: putfield 620	android/graphics/BitmapFactory$Options:inJustDecodeBounds	Z
    //   87: aload 11
    //   89: aload_1
    //   90: invokestatic 626	android/graphics/BitmapFactory:decodeFile	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   93: astore 8
    //   95: aload_1
    //   96: iconst_0
    //   97: putfield 620	android/graphics/BitmapFactory$Options:inJustDecodeBounds	Z
    //   100: aload 11
    //   102: aload_1
    //   103: invokestatic 626	android/graphics/BitmapFactory:decodeFile	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   106: astore_1
    //   107: aload_1
    //   108: astore 8
    ...
    //   120: aload_1
    //   121: ifnull +126 -> 247
    //   124: new 628	java/io/FileOutputStream
    //   127: dup
    //   128: aload_1
    //   129: invokespecial 631	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   132: astore 7
    //   134: aload 7
    //   136: astore_1
    //   137: aload 8
    //   139: getstatic 637	android/graphics/Bitmap$CompressFormat:PNG	Landroid/graphics/Bitmap$CompressFormat;
    //   142: bipush 80
    //   144: aload 7
    //   146: invokevirtual 641	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   149: istore 6
    //   151: aload 7
    //   153: astore_1
    //   154: aload_0
    //   155: getfield 215	barr:jdField_a_of_type_Bbms	Lbbms;
    //   158: ifnull +975 -> 1133
    //   161: aload 7
    //   163: astore_1
    //   164: aload_0
    //   165: getfield 215	barr:jdField_a_of_type_Bbms	Lbbms;
    //   168: invokevirtual 644	bbms:isShowing	()Z
    //   171: ifeq +962 -> 1133
    //   174: aload 7
    //   176: astore_1
    //   177: aload_0
    //   178: getfield 215	barr:jdField_a_of_type_Bbms	Lbbms;
    //   181: invokevirtual 220	bbms:dismiss	()V
    //   184: goto +949 -> 1133
    //   187: aload 7
    //   189: astore_1
    ...
    //   235: ifnull +12 -> 247
    //   238: aload 7
    //   240: invokevirtual 649	java/io/FileOutputStream:close	()V
    //   243: iload 6
    //   245: istore 5
    ...
    //   270: ldc_w 332
    //   273: ldc_w 652
    //   276: invokestatic 419	ajjy:a	(I)Ljava/lang/String;
    ...
    //   331: aastore
    //   332: invokevirtual 213	barr:callJs	(Ljava/lang/String;[Ljava/lang/String;)V
    //   335: aload 9
    //   337: areturn
    //   338: astore_1
    ...
    //   361: aload_1
    //   362: invokevirtual 279	java/lang/Exception:toString	()Ljava/lang/String;
    ...
    //   400: aload_1
    //   401: invokevirtual 657	java/lang/OutOfMemoryError:toString	()Ljava/lang/String;
    ...
    //   416: aload 7
    //   418: astore_1
    //   419: new 659	android/os/Bundle
    //   422: dup
    //   423: invokespecial 660	android/os/Bundle:<init>	()V
    //   426: astore 8
    //   428: aload 7
    //   430: astore_1
    //   431: aload 8
    //   433: ldc_w 662
    //   436: iconst_1
    //   437: invokevirtual 666	android/os/Bundle:putInt	(Ljava/lang/String;I)V
    //   440: aload 7
    //   442: astore_1
    //   443: aload 8
    //   445: ldc_w 668
    //   448: aload 11
    //   450: invokevirtual 671	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   453: aload 7
    //   455: astore_1
    //   456: aload 8
    //   458: ldc_w 673
    //   461: aload 11
    //   463: invokevirtual 671	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   466: aload 7
    //   468: astore_1
    //   469: aload 8
    //   471: ldc_w 675
    //   474: aload 11
    //   476: invokevirtual 671	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   479: aload 7
    //   481: astore_1
    //   482: aload 8
    //   484: ldc_w 677
    //   487: aload 11
    //   489: invokevirtual 671	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   492: aload 7
    //   494: astore_1
    //   495: aload 8
    //   497: ldc_w 679
    //   500: iconst_1
    //   501: invokevirtual 683	android/os/Bundle:putBoolean	(Ljava/lang/String;Z)V
    //   504: aload 7
    //   506: astore_1
    //   507: new 685	android/content/Intent
    //   510: dup
    //   511: invokespecial 686	android/content/Intent:<init>	()V
    //   514: astore 12
    //   516: aload 7
    //   518: astore_1
    //   519: aload 12
    //   521: aload 8
    //   523: invokevirtual 690	android/content/Intent:putExtras	(Landroid/os/Bundle;)Landroid/content/Intent;
    //   526: pop
    //   527: aload 7
    //   529: astore_1
    //   530: aload_0
    //   531: getfield 242	barr:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   534: aload 12
    //   536: bipush 21
    //   538: invokestatic 695	aphp:a	(Landroid/app/Activity;Landroid/content/Intent;I)V
    //   541: goto -354 -> 187
    //   544: astore 8
    //   546: aload 7
    //   548: astore_1
    ...
    //   574: aload 8
    //   576: invokevirtual 696	java/io/FileNotFoundException:toString	()Ljava/lang/String;
    ...
    //   597: ifnull -350 -> 247
    //   600: aload 7
    //   602: invokevirtual 649	java/io/FileOutputStream:close	()V
    //   605: iload 6
    //   607: istore 5
    //   609: goto -362 -> 247
    //   612: astore_1
    ...
    //   620: aload 7
    //   622: astore_1
    //   623: new 659	android/os/Bundle
    //   626: dup
    //   627: invokespecial 660	android/os/Bundle:<init>	()V
    //   630: astore 8
    //   632: aload 7
    //   634: astore_1
    //   635: new 698	java/util/ArrayList
    //   638: dup
    //   639: invokespecial 699	java/util/ArrayList:<init>	()V
    //   642: astore 12
    //   644: aload 7
    //   646: astore_1
    //   647: aload 12
    //   649: aload 11
    //   651: invokestatic 704	java/net/URLDecoder:decode	(Ljava/lang/String;)Ljava/lang/String;
    //   654: invokevirtual 707	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   657: pop
    //   658: aload 7
    //   660: astore_1
    //   661: aload 8
    //   663: ldc_w 709
    //   666: aload 12
    //   668: invokevirtual 713	android/os/Bundle:putStringArrayList	(Ljava/lang/String;Ljava/util/ArrayList;)V
    //   671: aload 7
    //   673: astore_1
    //   674: aload 8
    //   676: ldc_w 715
    //   679: ldc_w 716
    //   682: invokestatic 419	ajjy:a	(I)Ljava/lang/String;
    //   685: invokevirtual 671	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   688: aload 7
    //   690: astore_1
    //   691: aload 8
    //   693: ldc_w 718
    //   696: bipush 7
    //   698: invokevirtual 666	android/os/Bundle:putInt	(Ljava/lang/String;I)V
    //   701: aload 7
    //   703: astore_1
    //   704: aload 8
    //   706: ldc_w 720
    //   709: iconst_0
    //   710: invokevirtual 683	android/os/Bundle:putBoolean	(Ljava/lang/String;Z)V
    //   713: aload 7
    //   715: astore_1
    ...
    //   741: aload 8
    //   743: invokevirtual 392	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   746: invokevirtual 149	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   749: invokestatic 312	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   752: aload 7
    //   754: astore_1
    //   755: aload_0
    //   756: getfield 109	barr:mRuntime	Lbbac;
    //   759: invokevirtual 347	bbac:a	()Lcom/tencent/common/app/AppInterface;
    //   762: aload_0
    //   763: getfield 109	barr:mRuntime	Lbbac;
    //   766: invokevirtual 177	bbac:a	()Landroid/app/Activity;
    //   769: aload 8
    //   771: aload_0
    //   772: invokestatic 727	bfqn:a	(Lcom/tencent/common/app/AppInterface;Landroid/content/Context;Landroid/os/Bundle;Landroid/content/DialogInterface$OnDismissListener;)V
    //   775: goto -588 -> 187
    //   778: astore 8
    //   780: aload_1
    //   781: astore 7
    ...
    //   788: ifnull +8 -> 796
    //   791: aload 7
    //   793: invokevirtual 649	java/io/FileOutputStream:close	()V
    //   796: aload_1
    //   797: athrow
    //   798: aload 7
    //   800: astore_1
    //   801: invokestatic 732	com/tencent/mobileqq/wxapi/WXShareHelper:a	()Lcom/tencent/mobileqq/wxapi/WXShareHelper;
    //   804: invokevirtual 734	com/tencent/mobileqq/wxapi/WXShareHelper:a	()Z
    //   807: ifeq +20 -> 827
    //   810: aload 7
    //   812: astore_1
    //   813: invokestatic 732	com/tencent/mobileqq/wxapi/WXShareHelper:a	()Lcom/tencent/mobileqq/wxapi/WXShareHelper;
    //   816: aload 11
    //   818: aload 8
    //   820: iconst_1
    //   821: invokevirtual 737	com/tencent/mobileqq/wxapi/WXShareHelper:a	(Ljava/lang/String;Landroid/graphics/Bitmap;I)V
    //   824: goto -637 -> 187
    //   827: aload 7
    //   829: astore_1
    //   830: aload_0
    //   831: getfield 109	barr:mRuntime	Lbbac;
    //   834: invokevirtual 114	bbac:a	()Lcom/tencent/biz/pubaccount/CustomWebView;
    //   837: new 739	com/tencent/mobileqq/vashealth/HealthStepCounterPlugin$4
    //   840: dup
    //   841: aload_0
    //   842: invokespecial 740	com/tencent/mobileqq/vashealth/HealthStepCounterPlugin$4:<init>	(Lbarr;)V
    //   845: invokevirtual 744	com/tencent/biz/pubaccount/CustomWebView:post	(Ljava/lang/Runnable;)Z
    //   848: pop
    //   849: goto -662 -> 187
    //   852: aload 7
    //   854: astore_1
    //   855: invokestatic 732	com/tencent/mobileqq/wxapi/WXShareHelper:a	()Lcom/tencent/mobileqq/wxapi/WXShareHelper;
    //   858: invokevirtual 734	com/tencent/mobileqq/wxapi/WXShareHelper:a	()Z
    //   861: ifeq +20 -> 881
    //   864: aload 7
    //   866: astore_1
    //   867: invokestatic 732	com/tencent/mobileqq/wxapi/WXShareHelper:a	()Lcom/tencent/mobileqq/wxapi/WXShareHelper;
    //   870: aload 11
    //   872: aload 8
    //   874: iconst_0
    //   875: invokevirtual 737	com/tencent/mobileqq/wxapi/WXShareHelper:a	(Ljava/lang/String;Landroid/graphics/Bitmap;I)V
    //   878: goto -691 -> 187
    //   881: aload 7
    //   883: astore_1
    //   884: aload_0
    //   885: getfield 109	barr:mRuntime	Lbbac;
    //   888: invokevirtual 114	bbac:a	()Lcom/tencent/biz/pubaccount/CustomWebView;
    //   891: new 746	com/tencent/mobileqq/vashealth/HealthStepCounterPlugin$5
    //   894: dup
    //   895: aload_0
    //   896: invokespecial 747	com/tencent/mobileqq/vashealth/HealthStepCounterPlugin$5:<init>	(Lbarr;)V
    //   899: invokevirtual 744	com/tencent/biz/pubaccount/CustomWebView:post	(Ljava/lang/Runnable;)Z
    //   902: pop
    //   903: goto -716 -> 187
    //   906: aload 7
    //   908: astore_1
    ...
    //   920: getstatic 752	ajed:ba	Ljava/lang/String;
    //   923: invokevirtual 131	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   926: getstatic 259	java/io/File:separator	Ljava/lang/String;
    //   929: invokevirtual 131	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   932: invokestatic 265	java/lang/System:currentTimeMillis	()J
    //   935: invokevirtual 268	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   938: ldc_w 270
    ...
    //   947: invokespecial 271	java/io/File:<init>	(Ljava/lang/String;)V
    //   950: astore 12
    //   952: aload 7
    //   954: astore_1
    //   955: aload 8
    //   957: aload 12
    //   959: invokestatic 276	bacm:a	(Landroid/graphics/Bitmap;Ljava/io/File;)V
    //   962: aload 7
    //   964: astore_1
    //   965: new 685	android/content/Intent
    //   968: dup
    //   969: ldc_w 754
    //   972: invokespecial 755	android/content/Intent:<init>	(Ljava/lang/String;)V
    //   975: astore 8
    //   977: aload 7
    //   979: astore_1
    //   980: aload 8
    //   982: aload 12
    //   984: invokestatic 761	android/net/Uri:fromFile	(Ljava/io/File;)Landroid/net/Uri;
    //   987: invokevirtual 765	android/content/Intent:setData	(Landroid/net/Uri;)Landroid/content/Intent;
    //   990: pop
    //   991: aload 7
    //   993: astore_1
    //   994: aload_0
    //   995: getfield 109	barr:mRuntime	Lbbac;
    //   998: invokevirtual 177	bbac:a	()Landroid/app/Activity;
    //   1001: invokevirtual 590	android/app/Activity:getApplicationContext	()Landroid/content/Context;
    //   1004: aload 8
    //   1006: invokevirtual 771	android/content/Context:sendBroadcast	(Landroid/content/Intent;)V
    //   1009: aload 7
    //   1011: astore_1
    ...
    //   1037: getstatic 752	ajed:ba	Ljava/lang/String;
    ...
    //   1046: invokestatic 312	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   1049: goto -862 -> 187
    //   1052: aload_1
    //   1053: ldc_w 651
    //   1056: iconst_m1
    ...
    //   1062: ldc_w 332
    //   1065: ldc_w 774
    //   1068: invokestatic 419	ajjy:a	(I)Ljava/lang/String;
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      if ((Build.VERSION.SDK_INT < 19) || (paramJsBridgeListener.getDefaultSensor(19) == null))
      {
        ...
        paramString1.put("msg", ajjy.a(2131639664));
        super.callJs(paramJsBridgeListener, new String[] { paramString1.toString() });
      }
      else
      {
        paramJsBridgeListener = new NewIntent(this.mRuntime.a().getApplication(), basl.class);
    ...
    if (paramString3.equals("healthSwitch"))
    {
      ...
      if ((!TextUtils.isEmpty(paramJsBridgeListener)) && (Integer.parseInt(paramJsBridgeListener) == 0))
      {
        ...
        paramJsBridgeListener.put("msg", ajjy.a(2131639660));
      ...
      paramString2 = new NewIntent(this.jdField_a_of_type_AndroidAppActivity, basl.class);
      ...
      paramJsBridgeListener.put("msg", ajjy.a(2131639661));
      super.callJs(paramString1, new String[] { paramJsBridgeListener.toString() });
      i = 1;
    }
    for (;;)
    {
      if (i == 0)
      {
        ...
        paramJsBridgeListener.put("msg", ajjy.a(2131639667));
        super.callJs(paramString1, new String[] { paramJsBridgeListener.toString() });
        break label1169;
        if (paramString3.equals("shareSnapshot"))
        {
          if (this.jdField_a_of_type_Bbms == null)
          {
            ...
            this.jdField_a_of_type_Bbms = paramJsBridgeListener;
          }
          if (this.jdField_a_of_type_Bbms != null)
          {
        ...
        {
          paramJsBridgeListener = new JSONObject(paramVarArgs[0]).getString("callback");
          paramString1 = new NewIntent(this.mRuntime.a().getApplication(), basl.class);
  ...
  public void onDestroy()
  {
    ...
    if (jdField_a_of_type_Barv != null)
    {
      ((SensorManager)this.jdField_a_of_type_AndroidAppActivity.getSystemService("sensor")).unregisterListener(jdField_a_of_type_Barv);
      jdField_a_of_type_Barv = null;
    }
  }
