...
public class aqwf
{
  ...
  aqwh jdField_a_of_type_Aqwh = aqwh.jdField_a_of_type_Aqwh;
  String jdField_a_of_type_JavaLangString = "";
  boolean jdField_a_of_type_Boolean = false;
  aqwh jdField_b_of_type_Aqwh = aqwh.jdField_a_of_type_Aqwh;
  String jdField_b_of_type_JavaLangString = "";
  boolean jdField_b_of_type_Boolean = false;
  aqwh jdField_c_of_type_Aqwh = aqwh.jdField_a_of_type_Aqwh;
  boolean jdField_c_of_type_Boolean = false;
  aqwh d = aqwh.jdField_a_of_type_Aqwh;
  aqwh e = aqwh.jdField_a_of_type_Aqwh;
  aqwh f = aqwh.jdField_a_of_type_Aqwh;
  aqwh g = aqwh.jdField_a_of_type_Aqwh;
  aqwh h = aqwh.jdField_a_of_type_Aqwh;
  aqwh i = aqwh.jdField_a_of_type_Aqwh;
  aqwh j = aqwh.jdField_a_of_type_Aqwh;
  ...
  private aqwh a(JSONObject paramJSONObject)
  {
    boolean bool = true;
    if (paramJSONObject == null) {
      return aqwh.jdField_a_of_type_Aqwh;
    }
    ...
    for (;;)
    {
      ...
      try
      {
        paramJSONObject = new aqwh(bool, localSimpleDateFormat.parse(str), localSimpleDateFormat.parse(paramJSONObject));
  ...
  private void b()
  {
    this.jdField_a_of_type_Aqwh = aqwh.jdField_a_of_type_Aqwh;
    this.jdField_b_of_type_Aqwh = aqwh.jdField_a_of_type_Aqwh;
    this.jdField_c_of_type_Aqwh = aqwh.jdField_a_of_type_Aqwh;
    this.d = aqwh.jdField_a_of_type_Aqwh;
    this.e = aqwh.jdField_a_of_type_Aqwh;
    this.f = aqwh.jdField_a_of_type_Aqwh;
    this.g = aqwh.jdField_a_of_type_Aqwh;
    this.h = aqwh.jdField_a_of_type_Aqwh;
    this.i = aqwh.jdField_a_of_type_Aqwh;
    this.j = aqwh.jdField_a_of_type_Aqwh;
  ...
  public void a(ConfigurationService.Config paramConfig)
  {
    ...
    if (m != k)
    {
      paramConfig = ando.b(paramConfig, m, paramConfig.type.get());
      a(paramConfig);
      b(paramConfig);
    }
  ...
  void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_Aqwh = a(paramString.optJSONObject("webview_menu"));
        this.jdField_b_of_type_Aqwh = a(paramString.optJSONObject("webview_launch_app"));
        this.jdField_c_of_type_Aqwh = a(paramString.optJSONObject("scan_qrcode"));
        ...
        if (paramString.optInt("need_report_system_share_info_new") == 1)
        {
          ...
          JefsClass.getInstance().a(this.jdField_b_of_type_Aqwh.a(), paramString);
        }
      }
