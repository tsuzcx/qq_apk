...
public class aepf
{
  ...
  private static amab jdField_a_of_type_Amab;
  ...
  {
    if (bdar.a(paramSessionInfo.jdField_a_of_type_Int)) {}
    for (int i = 5;; i = 6)
    {
      if (nav.a().a(paramSessionInfo.jdField_a_of_type_JavaLangString)) {
        i = 1;
      }
      return i;
    }
  ...
  public static int a(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo, ArrayList<String> paramArrayList, Intent paramIntent1, Intent paramIntent2)
  {
    ...
    if ((paramIntent1 == null) || (!paramIntent1.hasExtra("showFlashPic")))
    {
      ...
      paramIntent2.putExtra("showFlashPic", alnp.a(paramSessionInfo.jdField_a_of_type_Int, (HotChatManager)localObject, paramSessionInfo.b));
    }
    ...
    for (;;)
    {
      ...
      paramIntent2.putExtra("ALBUM_ID", bdar.a(paramActivity));
      paramIntent2.putExtra("ALBUM_NAME", bdar.b(paramActivity));
      ...
      paramIntent2.putExtra("is_anonymous", nav.a().a(paramSessionInfo.jdField_a_of_type_JavaLangString));
      ...
      if ((paramIntent1 != null) && (paramIntent1.getBooleanExtra("ReceiptMsgManager.EXTRA_KEY_IS_RECEIPT", false)))
      {
        ...
        paramIntent2.putExtra("PhotoConst.MAXUM_SELECTED_NUM", Math.min(axhe.b(paramQQAppInterface), j));
      }
      paramIntent2.putExtra("session_info", paramSessionInfo);
      ...
      if ((paramActivity instanceof SplashActivity))
      {
        ...
        paramIntent2 = aekt.a(paramIntent2, null);
        ...
        paramIntent2 = aekt.a(paramIntent2, null);
        paramIntent2.putExtra(bdaq.h, 80);
        ...
        localzpa = (zpa)paramQQAppInterface.a(51);
  ...
  public static void a(Intent paramIntent, SessionInfo paramSessionInfo, QQAppInterface paramQQAppInterface)
  {
    if (a(paramSessionInfo, paramQQAppInterface.a(paramSessionInfo.jdField_a_of_type_JavaLangString)))
    {
      ...
      paramIntent.putExtra("binder_presendService", new BinderWarpper(new awfr(paramSessionInfo.jdField_a_of_type_Int, paramSessionInfo.jdField_a_of_type_JavaLangString, paramSessionInfo.b, paramQQAppInterface.getAccount(), paramSessionInfo.jdField_e_of_type_Int).asBinder()));
    }
  }
  ...
  public static void a(AppInterface paramAppInterface, Activity paramActivity, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      if (!bdal.a())
      {
        QQToast.a(paramActivity, paramActivity.getResources().getString(2131719535), 0).a();
        return;
      }
      paramAppInterface = aljq.bk;
      boolean bool;
      label56:
      Object localObject;
      if (paramInt2 == 1)
      ...
      catch (Exception paramAppInterface)
      {
        for (;;)
        {
          ...
          QQToast.a(paramActivity, 2131690645, 0).a();
        }
      }
    }
  }
  ...
  {
    bixy.a(paramQQAppInterface, "tenpay.com", new aepi(paramInt1, paramSessionInfo, paramQQAppInterface, paramInt2, paramString, paramActivity));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo, aixd paramaixd, List<aixd> paramList, int paramInt)
  {
    if (paramaixd == null) {
      return;
    }
    ...
    int i = 0;
    Object localObject2 = "";
    paramList = (aipw)paramQQAppInterface.getManager(125);
    if (paramList != null) {}
    label165:
    label1704:
    label1712:
    for (String str = paramList.a();; str = null)
    {
      ...
      {
        int k;
        if (RedPacketManager.TYPEHBINFOMAP.get(Integer.valueOf(paramaixd.jdField_a_of_type_Int)) == null) {
          k = 1;
        }
        Object localObject3;
        switch (paramaixd.jdField_a_of_type_Int)
        {
        case 8: 
        case 9: 
        case 10: 
        ...
        case 7: 
          for (;;)
          {
            ...
            try
            {
              ...
              ((JSONObject)localObject3).put("bus_type", paramaixd);
              if (j > 0) {
            ...
            catch (JSONException paramaixd)
            {
              for (;;)
              {
                long l;
                paramaixd.printStackTrace();
                continue;
                if (paramInt == 1)
                {
                  agci.a(paramQQAppInterface, "0X8005FC9", paramSessionInfo.jdField_a_of_type_Int);
                  continue;
            ...
            agci.a(paramQQAppInterface, "0X8005CAF", paramSessionInfo.jdField_a_of_type_Int);
            if (jdField_a_of_type_Int != 0) {
              break label1666;
            }
            paramActivity = paramList + ".plus";
            azmj.b(paramQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", paramActivity, 0, 0, (String)localObject1, "", "", "");
            return;
            if (paramSessionInfo.jdField_a_of_type_Int == 3000)
            {
              i = 2;
              paramList = "entrance.click.group";
              j = ((almv)paramQQAppInterface.getManager(53)).a(paramSessionInfo.jdField_a_of_type_JavaLangString);
              break;
            }
            if (paramSessionInfo.jdField_a_of_type_Int == 1)
            {
              ...
              try
              {
                ...
                paramList = (alzf)paramQQAppInterface.a(20);
                if (jdField_a_of_type_Amab == null) {
                  jdField_a_of_type_Amab = new aeph(paramSessionInfo);
                }
                paramQQAppInterface.addObserver(jdField_a_of_type_Amab);
                paramList.b(l, 32, 0);
              }
              ...
              {
                azmj.b(paramQQAppInterface, "CliOper", "", "", "0X8005B9C", "0X8005B9C", 0, 0, "", "", "", "");
                j = 6;
            ...
            for (paramList = paramQQAppInterface.a().l(paramSessionInfo.jdField_a_of_type_JavaLangString);; paramList = paramQQAppInterface.a().m(paramSessionInfo.jdField_a_of_type_JavaLangString))
            {
              ...
              paramList = bdbi.encodeToString(paramList, 2);
              azmj.b(paramQQAppInterface, "CliOper", "", "", "0X8005B9D", "0X8005B9D", 0, 0, "", "", "", "");
              localObject3 = "entrance.click.c2c";
              localObject2 = paramList;
              i = 7;
              j = 1;
              paramList = (List<aixd>)localObject3;
              break;
            }
            k = ((Integer)RedPacketManager.TYPEHBINFOMAP.get(Integer.valueOf(paramaixd.jdField_a_of_type_Int))).intValue();
            break label165;
            localObject1 = "13140";
            paramaixd = String.valueOf(1);
            continue;
            localObject1 = "13141";
            paramaixd = String.valueOf(2);
            continue;
            localObject3 = "13142";
            paramaixd = (aixd)localObject1;
            localObject1 = localObject3;
        ...
        case 5: 
          ...
          azmj.b(paramQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "plus.hongbao.click", 0, 0, "", "", "", "");
          return;
        case 3: 
          if (paramaixd.jdField_a_of_type_OrgJsonJSONObject != null) {}
          for (paramaixd = paramaixd.jdField_a_of_type_OrgJsonJSONObject.optString("theme_id", "");; paramaixd = "")
          {
            localIntent.putExtra("theme_type", paramaixd);
        ...
        case 4: 
          ...
          paramList = paramaixd.jdField_a_of_type_OrgJsonJSONObject.optString("url", "");
          paramQQAppInterface = paramList;
          if (paramaixd.jdField_a_of_type_OrgJsonJSONObject.optInt("subtype", 0) == 1) {
        ...
        case 12: 
          paramaixd = paramaixd.jdField_a_of_type_OrgJsonJSONObject.optString("schema");
          if (TextUtils.isEmpty(paramaixd)) {
            break;
          }
          a(paramQQAppInterface, paramActivity, paramSessionInfo, i, j, paramaixd);
          return;
        case 13: 
          paramaixd = paramaixd.jdField_a_of_type_OrgJsonJSONObject.optString("schema", "");
          if (TextUtils.isEmpty(paramaixd)) {
          ...
          paramList.put("recv_group_type", i + "");
          paramList.put("recv_group_id", paramSessionInfo.jdField_a_of_type_JavaLangString);
          paramList.put("send_uin", paramQQAppInterface.c());
          paramQQAppInterface = bixy.a(paramaixd, paramList, true);
          if (QLog.isColorLevel()) {
            QLog.i("PlusPanelUtils", 2, "[go to miniapp] finalSchame: " + paramQQAppInterface);
          }
          ajae.a(paramActivity, paramQQAppInterface);
          return;
        }
      }
    }
  ...
  {
    azmj.b(paramQQAppInterface, "CliOper", "", paramSessionInfo.jdField_a_of_type_JavaLangString, "Music_gene", "Music_gene_AIO", 0, 0, String.valueOf(a(paramSessionInfo.jdField_a_of_type_Int)), "", "", "");
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo, ArrayList<String> paramArrayList, Intent paramIntent, HashMap<LocalMediaInfo, LocalMediaInfo> paramHashMap)
  {
    ...
    for (;;)
    {
      ...
      paramIntent.putExtra("KEY_IS_ANONYMOUS", nav.a().a(paramSessionInfo.jdField_a_of_type_JavaLangString));
      ...
      for (;;)
      {
        ...
        return;
        paramQQAppInterface = aikk.a(paramHashMap);
  ...
  {
    new aepk(paramSessionInfo, paramQQAppInterface, paramContext, bdda.b(paramContext, paramUri)).execute(new Void[0]);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, boolean paramBoolean, String paramString, BaseChatPie paramBaseChatPie)
  {
    ...
    if (((paramSessionInfo.jdField_a_of_type_Int == 1025) || (paramSessionInfo.jdField_a_of_type_Int == 0) || (paramSessionInfo.jdField_a_of_type_Int == 1000) || (paramSessionInfo.jdField_a_of_type_Int == 1004)) && (((bfua)paramQQAppInterface.getManager(165)).d(paramSessionInfo.jdField_a_of_type_JavaLangString)))
    {
      arrayOfInt[0] = 5;
      localmwz.b(2131698542);
    }
    for (int i = 1;; i = 0)
    {
      arrayOfInt[i] = 1;
      ...
      localmwz.a(new aepg(paramQQAppInterface));
      localmwz.a(new aepj(localmwz, arrayOfInt, paramSessionInfo, paramQQAppInterface, paramBaseChatPie, paramContext, paramString));
      localmwz.show();
      azmj.b(paramQQAppInterface, "CliOper", "", "", "0X8004D68", "0X8004D68", 0, 0, "", "", "", "");
      return;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, boolean paramBoolean, String paramString, Map<String, String> paramMap)
  {
    ...
    for (;;)
    {
      azmj.b(paramQQAppInterface, "CliOper", "", "", str2, str2, 0, 0, str1, "", "", "");
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, BaseActivity paramBaseActivity, SessionInfo paramSessionInfo, int paramInt1, int paramInt2)
  {
    ...
    if (AudioHelper.b(0))
    {
      bdcd.a(paramContext, 230, paramContext.getString(2131698758), paramContext.getString(2131698759), new aepl(), null).show();
      return;
    }
    if (AudioHelper.a(0))
    {
      bdcd.a(paramContext, 230, paramContext.getString(2131698758), paramContext.getString(2131698760), new aepm(), null).show();
      return;
    }
    if (paramQQAppInterface.getApp().checkPermission("android.permission.CAMERA", Process.myPid(), Process.myUid()) != 0)
    {
      bdcd.a(paramContext, 230, paramContext.getString(2131698758), alpo.a(2131708688), new aepn(), null).show();
      return;
    }
    ...
    for (int i = 1;; i = 17000)
    {
      ...
      aabm.a(paramQQAppInterface, Long.parseLong(paramSessionInfo.jdField_a_of_type_JavaLangString), "Usr_AIO_SendMsg", 2, 0, paramInt1);
      return;
    }
  }
        ...
        if (paramSessionInfo != null)
        {
          ...
          if (paramSessionInfo.length() > 0)
          {
            ...
            if (paramSessionInfo.length >= 4)
            {
              ...
              i = bdee.a(BaseApplicationImpl.getContext());
            }
          }
        }
      }
  ...
  public static void b(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo)
  {
    ...
    biqv.a(paramActivity, paramQQAppInterface.getAccount(), localIntent, -1, false);
    birh.b(paramQQAppInterface, 3, paramSessionInfo.jdField_a_of_type_Int);
  }
  ...
  {
    Object localObject = (aubm)paramQQAppInterface.getManager(11);
    String str;
    if (paramSessionInfo.jdField_a_of_type_Int == 1006) {
      str = ((aubm)localObject).a(paramSessionInfo.jdField_a_of_type_JavaLangString);
    }
    for (localObject = paramSessionInfo.jdField_a_of_type_JavaLangString; paramString == null; localObject = ((aubm)localObject).b(str))
    {
  ...
  public static void c(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo)
  {
    ...
    paramQQAppInterface.putExtra(bdaq.h, 84);
