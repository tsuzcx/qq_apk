  ...
  implements agvc
{
  ...
  public agwe(BaseChatPie paramBaseChatPie)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetListAdapter = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Aggs;
    if (this.jdField_a_of_type_AndroidWidgetListAdapter != null) {
      this.jdField_a_of_type_JavaUtilList = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Aggs.a();
    }
  }
  ...
  private void a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (i <= paramInt2)
    {
      ...
      if ((i >= 0) && (i < this.jdField_a_of_type_JavaUtilList.size()))
      {
        ...
        if (((axpf)localObject).a(localChatMessage) != paramBoolean) {
          break label69;
        }
      }
      for (;;)
      {
        ...
        break;
        label69:
        if ((axpm.c(localChatMessage)) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null))
        {
          int j = axpf.a().a();
          if ((paramBoolean) && (axpf.a().a(localChatMessage, j)))
          {
            if (axpf.a().jdField_a_of_type_Int == 7) {}
            for (localObject = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext.getString(2131697758, new Object[] { Integer.valueOf(j) });; localObject = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext.getString(2131697757, new Object[] { Integer.valueOf(j) }))
            {
          ...
          ((axpf)localObject).a(localChatMessage, paramBoolean);
          this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(localChatMessage, null, paramBoolean);
          ((aggs)this.jdField_a_of_type_AndroidWidgetListAdapter).notifyDataSetChanged();
        }
      }
    }
  ...
  private void a(View paramView)
  {
    ...
    do
    {
      do
      {
        ...
        if (axpf.a().c() == 0) {
          QQToast.a(paramView.getContext(), anzj.a(2131712645), 0).a();
        }
        j = b();
        m = c();
        k = a();
    ...
    for (;;)
    {
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(), "dc00898", "", "", "0X800A510", "0X800A510", i, j, "", "", "", "");
      return;
      if (k == 1) {
        i = 3;
      } else if (k == 3) {
  ...
  private boolean a(int paramInt)
  {
    ...
    localObject = (RelativeLayout)this.jdField_a_of_type_ComTencentMobileqqWidgetSelectTouchBarView.findViewById(2131362480);
  ...
  public void a(LinearLayout paramLinearLayout, int paramInt, RelativeLayout paramRelativeLayout)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqWidgetSelectTouchBarView == null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWidgetSelectTouchBarView.a(anzj.a(2131712644)).a(paramInt).a();
      paramRelativeLayout.addView(this.jdField_a_of_type_ComTencentMobileqqWidgetSelectTouchBarView);
      this.jdField_a_of_type_ComTencentMobileqqWidgetSelectTouchBarView.setId(2131362479);
      this.jdField_a_of_type_ComTencentMobileqqWidgetSelectTouchBarView.setOnClickListener(new agwf(this));
    }
  }
