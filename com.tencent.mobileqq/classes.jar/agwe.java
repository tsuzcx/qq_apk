  ...
  implements agvy, View.OnClickListener
{
  ...
  public agwe(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, agwa paramagwa, Context paramContext)
  {
  ...
  private void a()
  {
    ...
    if (this.jdField_a_of_type_AndroidViewView == null)
    {
      ...
      this.jdField_a_of_type_AndroidViewView.setId(2131378064);
      ...
      localObject = (ThemeImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367816);
      localObject = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378982);
      localImageView = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367815);
    ...
    for (;;)
    {
      ((TextView)localObject).setText(alpo.a(2131715389));
      return;
      label147:
      this.jdField_a_of_type_AndroidViewView.setBackgroundColor(2130839282);
      ((TextView)localObject).setTextColor(-1);
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839281));
    }
  }
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    if ((paramInt == 1000) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1))
    {
      ...
      {
        paramVarArgs = baky.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
  ...
  public void onClick(View paramView)
  {
    ...
    baky.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_AIO", "", "video_tab", "clk_whitebar", 0, 1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), "", "", "");
  }
}
