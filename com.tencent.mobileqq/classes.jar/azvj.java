...
class azvj
  extends azvc
{
  azvj(azvi paramazvi, QCircleRedPointManager.OnGetQQCircleNumRedMsgListener paramOnGetQQCircleNumRedMsgListener, int paramInt) {}
  ...
  public void a(String paramString, List<NumRedMsg.NumMsgBusi> paramList)
  {
    ...
    if ("QQCircleRedCircle".equals(paramString))
    {
      ...
      if (paramList != null)
      {
        ...
        while (paramString.hasNext())
        {
          ...
          if ((paramList != null) && (paramList.str_ext.get() != null)) {
            try
            {
              ...
              long l = azvi.a(this.jdField_a_of_type_Azvi);
              if (l > 0L) {
                try
                {
                  if (Long.parseLong(localJSONObject.optString("_red_ext_feed_time")) < azvi.a(this.jdField_a_of_type_Azvi))
                  {
                    localArrayList.add(Long.valueOf(paramList.ui64_msgid.get()));
                    azvi.a(this.jdField_a_of_type_Azvi, 140000, (int)paramList.ui64_msgid.get(), 3);
                  }
                }
        ...
        if (azvi.a(this.jdField_a_of_type_Azvi) > 0L)
        {
          azvi.a(this.jdField_a_of_type_Azvi, 0L);
          if (localArrayList.size() > 0)
          {
            paramString = this.jdField_a_of_type_Azvi.a("140000");
            azvi.a(this.jdField_a_of_type_Azvi, paramString, 9, false, null, localArrayList, "");
