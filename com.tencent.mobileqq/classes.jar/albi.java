...
public class albi
  extends Observable
{
  private static volatile albi jdField_a_of_type_Albi;
  private static albm jdField_a_of_type_Albm;
  private List<String> jdField_a_of_type_JavaUtilList = new ArrayList();
  
  public static albi a()
  {
    if (jdField_a_of_type_Albi == null) {}
    try
    {
      if (jdField_a_of_type_Albi == null) {
        jdField_a_of_type_Albi = new albi();
      }
      return jdField_a_of_type_Albi;
    }
    finally {}
  }
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        float f2 = ((FragmentActivity)localObject2).getResources().getDimension(2131299080);
        ...
        Object localObject4 = agnw.a((String)localObject3);
  ...
  {
    ArkAppNotifyCenter.setNotify(paramString, new WeakReference(new albl(this)));
  }
  ...
  public void a(List<String> paramList)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      if (jdField_a_of_type_Albm == null) {
        jdField_a_of_type_Albm = new albm(null);
      }
      ...
      BaseApplicationImpl.getApplication().getBaseContext().registerReceiver(jdField_a_of_type_Albm, paramList);
    }
  }
  ...
  public void a(String... paramVarArgs)
  {
    ...
    if (jdField_a_of_type_Albm != null)
    {
      BaseApplicationImpl.getApplication().getBaseContext().unregisterReceiver(jdField_a_of_type_Albm);
      jdField_a_of_type_Albm = null;
    }
  }
