...
public final class toz
{
  ...
  public final Bitmap a(@Nullable Bitmap paramBitmap, @NotNull Context paramContext, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (paramBitmap != null)
    {
      tpx.a(jdField_a_of_type_JavaLangString, "1:originWidth = " + paramInt1 + "  originHeight = " + paramInt2 + "  blurWidth = " + paramInt3 + "  blurHeight = " + paramInt4);
      paramBitmap = zoc.a(paramBitmap, paramInt1, paramInt2, false);
      ...
      tpx.a((String)localObject1, paramBitmap.getWidth() + "  originBPHeight = " + paramBitmap.getHeight());
      paramContext = bhmq.a(paramContext, paramBitmap, paramInt3 / paramInt1, 20.0F);
      ...
      tpx.a((String)localObject1, paramContext.getWidth() + "  blurBitmapHeight = " + paramContext.getHeight());
      paramContext = jdField_a_of_type_Toz.a(paramContext, paramInt3, paramInt4);
      localObject1 = jdField_a_of_type_JavaLangString;
      localObject2 = new StringBuilder().append("4:blurBitmapWidth = ");
      Intrinsics.checkExpressionValueIsNotNull(paramContext, "blurBitmap");
      tpx.a((String)localObject1, paramContext.getWidth() + "  blurBitmapHeight = " + paramContext.getHeight());
      localObject1 = bnqo.a(paramContext, paramBitmap, (paramInt3 - paramInt1) / 2, 0, 1);
      ...
      tpx.a((String)localObject2, ((Bitmap)localObject1).getWidth() + "  mergeBitmapHeight = " + ((Bitmap)localObject1).getHeight());
      paramBitmap.recycle();
