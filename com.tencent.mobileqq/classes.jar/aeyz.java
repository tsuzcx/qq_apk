  ...
  implements aeyt, View.OnClickListener
{
  ...
  public aeyz(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, aeyv paramaeyv, Context paramContext)
  {
  ...
  private void a()
  {
    ...
    if (this.jdField_a_of_type_AndroidViewView == null)
    {
      ...
      localObject = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378380);
    ...
    for (;;)
    {
      ((TextView)localObject).setText(ajya.a(2131715017));
      return;
      label147:
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    if ((paramInt == 1000) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1))
    {
      ...
      {
        paramVarArgs = aync.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
  ...
  public void onClick(View paramView)
  {
    ...
    aync.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_AIO", "", "video_tab", "clk_whitebar", 0, 1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), "", "", "");
  }
}
