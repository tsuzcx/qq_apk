  ...
  implements View.OnClickListener
{
  ...
  public suk(FriendProfileCardActivity paramFriendProfileCardActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      case 17: 
        for (;;)
        {
          ...
          if (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.jdField_a_of_type_ComTencentMobileqqProfileViewProfileHeaderView.b)) {
            paramView.putExtra("extra_default", 2130843050);
          }
      ...
      case 5: 
        ...
        ThreadManager.post(new sul(this), 8, null, true);
      ...
      case 7: 
        ...
        {
          if (this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.p != 1) {
            break label3619;
          }
        ...
        while (this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.jdField_a_of_type_ComTencentMobileqqProfileProfileCardInfo.jdField_b_of_type_Boolean)
        {
          ...
          break label3167;
          if (this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.p == 2) {
      ...
      case 8: 
        ...
        return;
      case 23: 
        localObject1 = paramView.findViewById(2131371308);
        localObject2 = paramView.getParent();
        paramView = (View)localObject1;
        if ((localObject2 instanceof View)) {
          paramView = ((View)localObject2).findViewById(2131371308);
        }
        i = 1;
        if (paramView != null) {
      ...
      case 16: 
        if (this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.jdField_a_of_type_ComTencentMobileqqProfileProfileCardInfo.jdField_b_of_type_Boolean)
        {
          ...
          paramView.putExtra("isMsgShielded", this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.d());
      ...
      case 84: 
        try
        {
          ...
          while (this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.jdField_a_of_type_ComTencentMobileqqProfileProfileCardInfo.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Int == 0)
          {
            ...
            paramView.putExtra(QQIndividualityUtils.jdField_i_of_type_JavaLangString, 1026);
          ...
          ((VideoActionSheet)localObject1).a(2131438365);
          ((VideoActionSheet)localObject1).b(2131433844);
          j = 0;
          paramView[0] = 1;
          i = j;
            ...
            if (this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.jdField_a_of_type_ComTencentAvAppPstnSessionInfo.c != null)
            {
              ...
              if (this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.jdField_a_of_type_ComTencentMobileqqQcallPstnManager.a() == 1)
              {
                ...
                if (this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.jdField_a_of_type_ComTencentMobileqqQcallPstnManager.a().jdField_b_of_type_Int == 1)
                {
                  ...
                  this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.l = 1;
                  ((VideoActionSheet)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.getResources().getString(2131438363), this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.getResources().getDrawable(2130840374), 0);
          ...
          for (;;)
          {
            ...
            paramView[1] = 4;
            paramView[(i + 1)] = 2;
            ((VideoActionSheet)localObject1).b(2131433841);
            ((VideoActionSheet)localObject1).c(2131433029);
            ((VideoActionSheet)localObject1).a(new sum(this));
            ((VideoActionSheet)localObject1).a(new sun(this, paramView, (VideoActionSheet)localObject1));
            ...
            {
              this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.l = 2;
              ((VideoActionSheet)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.getResources().getString(2131438363), this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.getResources().getDrawable(2130840373), 0);
            ...
            {
              this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.l = 5;
              ((VideoActionSheet)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.getResources().getString(2131438363), this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.getResources().getDrawable(2130840372), 0);
          ...
          while (this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.p == 2)
          {
            ...
            {
              this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.k = true;
              if (paramView.b(this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.jdField_a_of_type_ComTencentMobileqqProfileProfileCardInfo.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_k_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.jdField_a_of_type_ComTencentMobileqqProfileProfileCardInfo.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_JavaLangString))
              {
          ...
          if (this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.p != 3) {
            continue;
          }
          ...
          if ((((DataTag)localObject1).jdField_a_of_type_JavaLangObject instanceof String))
          {
            ...
            for (;;)
            {
              ...
              localObject2 = this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.getString(2131437510);
              localObject1 = ActionSheet.a(this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity);
              ((ActionSheet)localObject1).a(2131437509, 1);
              ((ActionSheet)localObject1).a((CharSequence)localObject2, 1);
              ((ActionSheet)localObject1).a(2131433029, 1);
              ((ActionSheet)localObject1).a(new suo(this, paramView, (ActionSheet)localObject1));
              try
              {
            ...
            for (bool = true;; bool = false)
            {
              ...
              ReportController.b(this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.app, "P_CliOper", "Grp_join", "", "person_data", "Clk", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.jdField_i_of_type_JavaLangString, "1", "", "");
              return;
            }
            ReportController.b(this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.app, "P_CliOper", "Grp_join", "", "person_data", "Clk", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.jdField_i_of_type_JavaLangString, "0", "", "");
            return;
            ...
            if (this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.jdField_i_of_type_Int == 1)
            {
              ...
              paramView.putExtra("selfSet_leftViewText", this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.getString(2131437791));
              this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.startActivity(paramView);
              return;
            }
            paramView = null;
            ...
            localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.getResources().getString(2131430002);
