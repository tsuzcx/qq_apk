...
public final class suk
{
  ...
  static
  {
    jdField_a_of_type_Sum = new sum(null);
  }
  ...
  @RequiresApi(26)
  private final void a(Activity paramActivity, View paramView, float paramFloat, sul paramsul)
  {
    ...
    try
    {
      PixelCopy.request(paramActivity, new Rect(arrayOfInt[0], arrayOfInt[1], arrayOfInt[0] + paramView.getWidth(), arrayOfInt[1] + paramView.getHeight()), localBitmap, (PixelCopy.OnPixelCopyFinishedListener)new suo(localBitmap, this, paramView, paramFloat, paramsul), this.jdField_a_of_type_AndroidOsHandler);
      return;
    }
  ...
  private final void a(Bitmap paramBitmap, sdm paramsdm)
  {
    ...
    scv localscv = new scv(paramBitmap, str);
    localscv.a((URLDrawable.DownloadListener)new sup(this, str, paramsdm, paramBitmap));
    localscv.a();
  }
  
  private final void a(Bitmap paramBitmap, sul paramsul)
  {
    int i;
    if (!paramBitmap.isRecycled())
    {
  ...
  private final void a(View paramView, boolean paramBoolean, float paramFloat, sul paramsul)
  {
    ThreadManager.getFileThreadHandler().post((Runnable)new ScreenCaptureHelper.captureViewLowApi.1(this, paramView, paramFloat, paramsul));
  }
  
  private final void a(String paramString, sdm paramsdm)
  {
    ...
    paramString = (sdn)new sdq(localContext, (QQAppInterface)localAppRuntime, paramString);
    paramString.a(paramsdm);
    paramString.a();
  }
  ...
  public final void a(@NotNull Activity paramActivity, boolean paramBoolean, float paramFloat, @Nullable sdm paramsdm)
  {
    Intrinsics.checkParameterIsNotNull(paramActivity, "activity");
    a(paramActivity, paramBoolean, paramFloat, (sul)new sun(this, paramsdm));
  }
  
  public final void a(@NotNull Activity paramActivity, boolean paramBoolean, float paramFloat, @Nullable sul paramsul)
  {
    Intrinsics.checkParameterIsNotNull(paramActivity, "activity");
    try
    {
      ...
      if (Build.VERSION.SDK_INT >= 26)
      {
        ...
        a(paramActivity, (View)localObject, paramFloat, paramsul);
        return;
      }
      Intrinsics.checkExpressionValueIsNotNull(localObject, "captureView");
      a((View)localObject, paramBoolean, paramFloat, paramsul);
      return;
    }
