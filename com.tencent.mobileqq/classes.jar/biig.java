  ...
  implements biia
{
  ...
  public biig(biib parambiib)
  {
    bihy localbihy = parambiib.a;
    if (localbihy != null) {
      localbihy.setNetTransportEventListener("sig_check", this);
    }
    this.jdField_a_of_type_Biib = parambiib;
  }
  
  public void a(biih parambiih)
  {
  ...
  public void a(Object paramObject1, Object paramObject2)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          {
            return;
          } while (this.jdField_a_of_type_Biib == null);
          paramObject1 = this.jdField_a_of_type_Biib.a;
    ...
    try
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_Biih.a(paramObject1.toString());
        return;
      }
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        ...
        l2 = l1;
        continue;
        localObject2 = this.jdField_a_of_type_Biib.a;
        if (localObject2 == null) {
          continue;
        }
        localObject1 = paramString.toByteArray();
        localObject4 = ((bihy)localObject2).getCodec("sig_check");
        paramString = (String)localObject1;
        if (localObject4 != null) {
          paramString = ((bihz)localObject4).encode(localObject1);
        }
        ((bihy)localObject2).send(paramString);
        return;
      }
      try
      {
