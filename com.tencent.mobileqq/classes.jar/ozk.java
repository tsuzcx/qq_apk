...
public class ozk
{
  ...
  {
    Long localLong = (Long)bnrf.a("sp_key_readinjoy_refresh_optimize_id", Long.valueOf(0L));
    if (localLong != null) {}
  ...
  public static void a(String paramString)
  {
    ...
    bnrf.a("sp_key_readinjoy_refresh_optimize_id", Long.valueOf(l1));
  }
  
  public static void a(qft paramqft)
  {
    if (paramqft != null)
    {
