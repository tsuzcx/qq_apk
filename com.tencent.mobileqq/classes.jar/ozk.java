...
class ozk
{
  ...
  private pan a()
  {
    ...
    if (localAppRuntime != null) {
      return ((oso)localAppRuntime.getManager(163)).a().a();
    }
    return null;
  }
    ...
    if ((localObject != null) && (((ArrayList)localObject).size() > 0))
    {
      ...
      if (i != -1)
      {
        if ((this.c.containsKey(Integer.valueOf(paramInt1))) && (i < ((ArrayList)this.c.get(Integer.valueOf(paramInt1))).size()))
        {
          ...
          if (localObject != null) {
            ((BaseArticleInfo)localObject).mRecommendSeq = ozj.a(1, paramInt2);
          }
          return localObject;
        }
  ...
  void a(int paramInt)
  {
    ...
    Object localObject3 = ((pan)localObject2).a(paramInt);
    ...
    localObject2 = ((pan)localObject2).a(paramInt);
  ...
  void c(int paramInt)
  {
    pan localpan = a();
    if (localpan != null) {
      localpan.a(paramInt, this.jdField_a_of_type_Pao);
    }
  }
