  ...
  implements uha
{
  ...
  public utx(int paramInt, String paramString)
  {
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_d_of_type_Boolean = true;
  ...
  public long a(String paramString)
  {
    try
    {
      ...
      if (arrayOfObject != null)
      {
        ...
        if (m < n)
        {
          uup localuup = (uup)arrayOfObject[m];
          if (TextUtils.equals(paramString, localuup.jdField_a_of_type_JavaLangString)) {
            return localuup.jdField_b_of_type_Long;
          }
        }
      }
    }
    catch (Exception localException)
    {
      ...
      {
        int m;
        wsv.c("Q.qqstory.msgTab.nodeList.MsgTabNodeInfo", "getRecommendIdByVid:%s", localException);
  ...
  public MsgTabNodeEntity a()
  {
    ...
    while (localIterator.hasNext()) {
      localJSONArray.put(((uup)localIterator.next()).a());
    }
    ...
    if (this.jdField_b_of_type_JavaUtilList != null)
    {
      ...
      while (localIterator.hasNext()) {
        localJSONArray.put(((vhg)localIterator.next()).a());
      }
  ...
  public void a(MsgTabNodeEntity paramMsgTabNodeEntity)
  {
    ...
    try
    {
      ...
      while (m < i1)
      {
        ...
        localObject = new uup();
        ((uup)localObject).a(localJSONObject);
        this.jdField_a_of_type_JavaUtilList.add(localObject);
        if (!((uup)localObject).jdField_a_of_type_Boolean) {
    ...
    {
      wsv.c("Q.qqstory.msgTab.nodeList.MsgTabNodeInfo", "convertFrom(entity) errors", localJSONException1);
      ...
      if ((!TextUtils.isEmpty(paramMsgTabNodeEntity.localSuccessVideoList)) && (!paramMsgTabNodeEntity.localSuccessVideoList.equals("null"))) {
        try
        {
          ...
          while (m < i1)
          {
            ...
            localObject = new vhg();
            ((vhg)localObject).a(localJSONObject);
  ...
  public void a(qqstory_service.MsgTabNodeInfo paramMsgTabNodeInfo)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      uup localuup = new uup();
      localuup.a(localMsgTabNodeVideoInfo, localArrayDeque);
    ...
    for (int m = 0;; m = 1)
    {
      ...
      if (paramMsgTabNodeInfo.redpoint.has())
      {
        ...
        wsv.a("Q.qqstory.msgTab.nodeList.MsgTabNodeInfo", "MsgTabNodeInfo convertFrom, unionId:%s, uid:%s, redPoint:%s", this.jdField_a_of_type_JavaLangString, Long.valueOf(this.jdField_b_of_type_Long), Boolean.valueOf(this.jdField_c_of_type_Boolean));
      }
  ...
  {
    this.jdField_d_of_type_Int = paramutx.jdField_d_of_type_Int;
    this.jdField_b_of_type_Boolean = paramutx.jdField_b_of_type_Boolean;
    this.h = paramutx.h;
  }
  ...
  public boolean a()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((TextUtils.isEmpty(localuup.jdField_a_of_type_JavaLangString)) || (TextUtils.isEmpty(localuup.jdField_b_of_type_JavaLangString))) {
        return false;
      }
    }
  ...
  {
    if ((paramObject instanceof utx))
    {
      paramObject = (utx)paramObject;
