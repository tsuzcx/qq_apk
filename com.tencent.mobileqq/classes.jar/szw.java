  ...
  extends LinearLayout
{
  ...
  public szw(TabLayoutCompat paramTabLayoutCompat, Context paramContext)
  {
    super(paramContext);
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      while ((i != k) || (j != m))
      {
        ...
        ((ValueAnimator)localObject).addUpdateListener(new szx(this, i, k, j, m));
        ((ValueAnimator)localObject).addListener(new szy(this, paramInt1));
