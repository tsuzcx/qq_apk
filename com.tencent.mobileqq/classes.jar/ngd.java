  ...
  extends QIPCModule
{
  ...
  private final ngf jdField_a_of_type_Ngf;
  
  public ngd(AVGameAppInterface paramAVGameAppInterface)
  {
    super("AVGameClientQIPCModule");
    this.jdField_a_of_type_ComTencentAvgameAppAVGameAppInterface = paramAVGameAppInterface;
    this.jdField_a_of_type_Ngf = new ngf(this, null);
    QIPCClientHelper.getInstance().register(this);
    QIPCClientHelper.getInstance().getClient().addListener(this.jdField_a_of_type_Ngf);
    c();
  }
  ...
  private void a(Bundle paramBundle)
  {
    ...
    mye.a().a(myc.class, i, bool, paramBundle);
  }
  ...
  private void a(Bundle paramBundle, AVGameAppInterface paramAVGameAppInterface)
  {
    ...
    do
    {
      ...
      paramAVGameAppInterface = (mxz)paramAVGameAppInterface.a(2);
  ...
  private void b(Bundle paramBundle, AVGameAppInterface paramAVGameAppInterface)
  {
    ...
    do
    {
      ...
      paramBundle = (mxz)paramAVGameAppInterface.a(2);
      if (paramBundle != null) {
  ...
  private void c()
  {
    if (this.jdField_a_of_type_Ngf.a()) {
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.i("AVGameClientQIPCModule", 2, "connect, [" + this.jdField_a_of_type_Ngf.a.get() + "]");
    }
    QIPCClientHelper.getInstance().getClient().connect(this.jdField_a_of_type_Ngf);
  }
  ...
  private void c(Bundle paramBundle, AVGameAppInterface paramAVGameAppInterface)
  {
    ...
    ((nbd)paramAVGameAppInterface.a(3)).notifyUI(11, bool, new Object[] { str, Integer.valueOf(i), paramBundle });
  }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    QIPCClientHelper.getInstance().callServer("AVGameServerIPCModule", "action_set_cur_av_game_status", localBundle, new nge(this, paramString, paramInt));
  }
