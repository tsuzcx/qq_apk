  ...
  extends alpd
{
  ...
  public ngd(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(String paramString1, long paramLong, String paramString2, nge paramnge)
  {
    this.jdField_a_of_type_Nge = null;
    this.jdField_a_of_type_Nge = paramnge;
    ...
    paramnge = new ilive_get_record_info_svr.GetRoomStateReq();
    paramnge.source.set(paramString1);
    paramnge.roomid.set((int)paramLong);
    ...
    paramString1.busi_buf.set(ByteStringMicro.copyFrom(((ilive_get_record_info_svr.GetRoomStateReq)paramnge.get()).toByteArray()));
  ...
  protected void a(boolean paramBoolean, String paramString1, String paramString2, long paramLong, String paramString3)
  {
    if (this.jdField_a_of_type_Nge != null) {
      this.jdField_a_of_type_Nge.a(paramBoolean, paramString2, paramString1, paramLong, paramString3);
    }
  }
