...
public class aqio
{
  ...
  Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new aqit(this);
  ...
  private boolean a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367517));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367521));
      continue;
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate((Context)localObject, 2131560964, null));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367517));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367518));
      continue;
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate((Context)localObject, 2131560963, null));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367517));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367518));
      continue;
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate((Context)localObject, 2131560954, null));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367517));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367522));
    }
  ...
  private void b(ArrayList<String> paramArrayList)
  {
    ...
    do
    {
      ...
      if (j > 0)
      {
        ...
        localObject = bdbk.a(localQQAppInterface, 1, (String)localObject, 4, localDrawable, localDrawable);
        ((bdbk)localObject).mutate();
        localDrawable = localImageView.getDrawable();
        if ((localDrawable != null) && (localDrawable != localObject) && ((localDrawable instanceof bdbk))) {
      ...
      for (;;)
      {
        ...
        localObject = null;
        break label225;
        localImageView.setImageDrawable(bdhj.a(true));
        localImageView.setVisibility(0);
        continue;
    ...
    if (localQQAppInterface != null)
    {
      localObject = bdhj.a(true);
      bdbk.a(localQQAppInterface, 1, paramArrayList, 4, (Drawable)localObject, (Drawable)localObject);
    }
  ...
  void b()
  {
    ...
    for (int i = aepi.a(2.0F, ((Context)localObject2).getResources());; i = aepi.a(1.0F, ((Context)localObject2).getResources()))
    {
      this.jdField_c_of_type_AndroidWidgetImageView.setPadding(i, i, i, i);
      this.jdField_c_of_type_AndroidWidgetImageView.setBackgroundResource(2130844734);
      ...
      ((RelativeLayout.LayoutParams)localObject2).addRule(7, 2131367517);
      ((RelativeLayout.LayoutParams)localObject2).addRule(6, 2131367517);
      ...
      try
      {
        ...
        ((ScaleAnimation)localObject1).setAnimationListener(new aqip(this));
  ...
  void c()
  {
    ...
    for (;;)
    {
      ...
      localObject3 = new aqir(this, (AnimatorSet)localObject1);
