...
public class kxg
{
  ...
  public static void a(VideoAppInterface paramVideoAppInterface)
  {
    ...
    {
      paramVideoAppInterface = (FilterItem)((kxf)paramVideoAppInterface.a(1)).a();
      a(paramVideoAppInterface);
      krx.c(jdField_a_of_type_JavaLangString, "DataReport onUserdFilter:" + paramVideoAppInterface + "|" + jdField_a_of_type_Boolean);
  ...
  static void a(FilterItem paramFilterItem)
  {
    ...
    krx.c(jdField_a_of_type_JavaLangString, "DataReport onUserdFilter:" + paramFilterItem + "|" + jdField_a_of_type_Long);
    if ((paramFilterItem != null) && (!paramFilterItem.isEmptyFilter()))
    {
      if (jdField_a_of_type_Long != 0L)
      {
        long l2 = l1 - jdField_a_of_type_Long;
        krx.c(jdField_a_of_type_JavaLangString, "DataReport onUserdFilter:" + l2);
        if (l2 > 5000L)
        {
      ...
      krx.c(jdField_a_of_type_JavaLangString, "DataReport onUserdFilter 33:" + jdField_a_of_type_Long);
    }
  ...
  public static void a(FilterItem paramFilterItem, long paramLong)
  {
    ...
    krx.c(jdField_a_of_type_JavaLangString, "DataReport onStateReport:" + paramFilterItem + "|" + paramLong);
    ...
    {
      krx.e(jdField_a_of_type_JavaLangString, paramFilterItem.getMessage());
    }
  }
  ...
  {
    krx.c(jdField_a_of_type_JavaLangString, "DataReport onSupport:" + paramBoolean);
    if (paramBoolean) {}
