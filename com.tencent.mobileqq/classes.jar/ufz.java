...
public class ufz
  extends Handler
{
  public ufz(TroopMemberListActivity paramTroopMemberListActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      QQToast.a(this.a, this.a.getString(2131433139), 0).b(this.a.jdField_a_of_type_AndroidViewView.getHeight());
      TroopMemberListActivity.a(this.a);
      return;
      if ((this.a.jdField_a_of_type_AndroidAppDialog != null) && (this.a.jdField_a_of_type_AndroidAppDialog.isShowing())) {
        this.a.jdField_a_of_type_AndroidAppDialog.dismiss();
      }
      QQToast.a(this.a, this.a.getString(2131433141), 0).b(this.a.jdField_a_of_type_AndroidViewView.getHeight());
      return;
