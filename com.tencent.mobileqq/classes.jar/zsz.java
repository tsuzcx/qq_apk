...
public class zsz
{
  ...
  public ArrayList<ztg> f;
  
  public zsz(JSONObject paramJSONObject, String paramString)
  {
      ...
      try
      {
        ...
        if ((localObject7 != null) && (localObject6 != null))
        {
          ...
          if (i < j)
          {
            ...
            {
              localObject8 = new zsy((JSONObject)localObject8, i);
              if (((zsy)localObject8).jdField_c_of_type_Int <= 4) {
                break label293;
              }
            }
            for (;;)
          ...
          if (i < j)
          {
            ...
            {
              localObject7 = new zsy((JSONObject)localObject7, this.jdField_a_of_type_JavaUtilArrayList.size());
              if (((zsy)localObject7).jdField_c_of_type_Int <= 4) {
                break label368;
              }
            }
            for (;;)
            {
              ...
              break;
              label368:
              if (((zsy)localObject7).jdField_b_of_type_Int != 0) {
        ...
        if (localObject5 != null)
        {
          ...
          if (i < j)
          {
            ...
            {
              localObject6 = new zsy((JSONObject)localObject6, i);
              if (((zsy)localObject6).jdField_c_of_type_Int <= 4) {
                break label554;
              }
            }
            for (;;)
            {
              ...
              break;
              label554:
              ((zsy)localObject6).jdField_b_of_type_Boolean = true;
        ...
        if (localObject4 != null)
        {
          ...
          if (i < j)
          {
            ...
            if (localObject5 != null)
            {
              localObject5 = new zsy((JSONObject)localObject5, this.jdField_d_of_type_JavaUtilArrayList.size());
              if (((zsy)localObject5).jdField_c_of_type_Int <= 2) {
                break label660;
              }
            }
            for (;;)
        ...
        if (localJSONObject1 != null) {
          this.jdField_a_of_type_Zte = new zte(localJSONObject1);
        }
        if (localJSONObject2 != null) {
          this.jdField_a_of_type_Ztc = new ztc(localJSONObject2);
        }
        ...
        if (localObject3 != null)
        {
          ...
          if (i < j)
          {
            ...
            if (localObject4 != null)
            {
              localObject4 = new zsy((JSONObject)localObject4, i);
              if (((zsy)localObject4).jdField_c_of_type_Int <= 4) {
                break label797;
              }
            }
            for (;;)
            {
              ...
              break;
              label797:
              ((zsy)localObject4).jdField_c_of_type_Int = 5;
              ((zsy)localObject4).d = true;
              this.jdField_e_of_type_JavaUtilArrayList.add(localObject4);
            }
          }
        }
        this.jdField_a_of_type_Zsn = zsm.a(paramJSONObject.optJSONObject("activityInfo"));
        localObject3 = paramJSONObject.optJSONObject("profileCard");
        if (localObject3 != null) {
          this.jdField_a_of_type_Zsp = zsm.a(((JSONObject)localObject3).optJSONObject("giftItem"));
        }
        this.jdField_a_of_type_Zso = zsm.a(paramJSONObject.optJSONObject("panelEntry"));
        ...
        if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0))
        {
          ...
          while (((Iterator)localObject3).hasNext())
          {
            ...
            if ((localObject4 instanceof zsy))
            {
              localObject4 = (zsy)localObject4;
              paramJSONObject.put(Integer.valueOf(((zsy)localObject4).jdField_a_of_type_Int), localObject4);
            }
          }
        }
        int k;
        if ((localObject2 != null) && (((JSONArray)localObject2).length() > 0))
        {
          ...
          while (i < j)
          {
            ...
            if (localObject3 != null)
            {
              localObject3 = new ztf((JSONObject)localObject3);
              this.jdField_c_of_type_JavaUtilArrayList.add(localObject3);
              localObject4 = ((ztf)localObject3).jdField_a_of_type_JavaUtilArrayList.iterator();
              while (((Iterator)localObject4).hasNext())
              {
                k = ((Integer)((Iterator)localObject4).next()).intValue();
                if (paramJSONObject.containsKey(Integer.valueOf(k))) {
                  ((ztf)localObject3).jdField_b_of_type_JavaUtilArrayList.add(paramJSONObject.get(Integer.valueOf(k)));
                }
              }
            }
            i += 1;
        ...
        if (localJSONArray2 != null)
        {
          ...
          if (j < n)
          {
            ...
            {
              localObject2 = new ztf((JSONObject)localObject2);
              if ((!TextUtils.isEmpty(((ztf)localObject2).jdField_a_of_type_JavaLangString)) && (((ztf)localObject2).jdField_a_of_type_JavaUtilArrayList != null) && (((ztf)localObject2).jdField_b_of_type_JavaUtilArrayList != null)) {
                break label1214;
              }
            }
            for (;;)
            {
              ...
              break;
              label1214:
              localObject3 = ((ztf)localObject2).jdField_a_of_type_JavaUtilArrayList.iterator();
              while (((Iterator)localObject3).hasNext())
              {
                  ...
                  for (;;)
                  {
                    ...
                    else
                    {
                      for (;;)
                      {
                        ...
                        ((ztf)localObject2).jdField_b_of_type_JavaUtilArrayList.add(paramJSONObject.get(Integer.valueOf(i1)));
                        break;
                        i += 1;
                      }
                    }
        ...
        while (i < j)
        {
          ...
          if (paramJSONObject != null)
          {
            paramJSONObject = new ztg(paramJSONObject);
  ...
  public static zsz a(Context paramContext, int paramInt)
  {
    return a(paramContext, paramInt, "");
  }
  
  public static zsz a(Context paramContext, int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramContext = a();
        paramContext = new zsz(localJSONObject, paramContext);
        if (!QLog.isColorLevel()) {
          break label157;
        }
  ...
  public void a(List<bfcs> paramList)
  {
    ...
    while (i < paramList.size())
    {
      bfcs localbfcs = (bfcs)paramList.get(i);
      this.jdField_a_of_type_AndroidUtilSparseArray.put(localbfcs.jdField_a_of_type_Int, localbfcs);
      i += 1;
    }
  }
    ...
    try
    {
      ...
      if ((paramString.length() > 0) && (paramJSONArray.length() > 0))
      {
        ...
        if (i < paramString.length())
        {
          ...
          if (i1 == 0) {
            localArrayList2.add(new zsy(localJSONObject, localArrayList2.size()));
          } else if (i1 == 1) {
            localArrayList1.add(new zsy(localJSONObject, localArrayList1.size()));
          }
        }
      }
    }
    ...
    for (;;)
    {
      try
      {
        if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (localArrayList2.size() > 0))
        {
          ...
          {
            ((zsy)this.jdField_a_of_type_JavaUtilArrayList.get(i)).g = i;
            i += 1;
            continue;
          }
        }
        ...
        ((zsy)this.jdField_d_of_type_JavaUtilArrayList.get(j)).g = j;
        j += 1;
        continue;
        if (!QLog.isColorLevel()) {
          break;
  ...
  {
    if ((this.jdField_b_of_type_JavaUtilArrayList != null) && (this.jdField_c_of_type_JavaUtilArrayList != null) && (paramInt >= 0) && (paramInt < this.jdField_b_of_type_JavaUtilArrayList.size()) && (paramInt < this.jdField_c_of_type_JavaUtilArrayList.size()) && ((this.jdField_b_of_type_JavaUtilArrayList.get(paramInt) instanceof ztf)))
    {
      ztf localztf1 = (ztf)this.jdField_b_of_type_JavaUtilArrayList.get(paramInt);
      if ((this.jdField_c_of_type_JavaUtilArrayList.get(paramInt) instanceof ztf))
      {
        ztf localztf2 = (ztf)this.jdField_c_of_type_JavaUtilArrayList.get(paramInt);
        if ((localztf2.jdField_a_of_type_JavaLangString != null) && (localztf2.jdField_a_of_type_JavaLangString.equals(localztf1.jdField_a_of_type_JavaLangString))) {
          return true;
        }
      }
    }
  ...
  public void b(List<bfct> paramList)
  {
    int j = 0;
    ...
    while (i < paramList.size())
    {
      localObject = (bfct)paramList.get(i);
      this.jdField_b_of_type_AndroidUtilSparseArray.put(((bfct)localObject).jdField_a_of_type_Int, localObject);
      i += 1;
    }
    if (this.jdField_e_of_type_JavaUtilArrayList != null)
    {
      ...
      if (this.jdField_e_of_type_JavaUtilArrayList != null)
      {
        ...
        if (this.jdField_e_of_type_JavaUtilArrayList.size() > 0)
        {
          ...
          {
            localObject = (zsy)this.jdField_e_of_type_JavaUtilArrayList.get(i);
            if (this.jdField_b_of_type_AndroidUtilSparseArray.get(((zsy)localObject).jdField_a_of_type_Int) != null)
            {
              ((zsy)localObject).g = i;
      ...
      while (i < this.jdField_e_of_type_JavaUtilArrayList.size())
      {
        ((zsy)this.jdField_e_of_type_JavaUtilArrayList.get(i)).g = i;
        i += 1;
      }
      if (this.jdField_e_of_type_JavaUtilArrayList.size() > this.jdField_e_of_type_Int) {
        ((zsy)this.jdField_e_of_type_JavaUtilArrayList.get(this.jdField_e_of_type_Int)).jdField_a_of_type_Boolean = true;
      }
    }
  }
}
