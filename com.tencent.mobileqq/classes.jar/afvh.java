...
public class afvh
  extends afvi
{
  private static final Set<WeakReference<afvh>> jdField_a_of_type_JavaUtilSet = Collections.synchronizedSet(new HashSet());
  private SessionInfo jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo;
  public WeakReference<MessageForArkApp> a;
  public boolean a;
  protected WeakReference<afvh> b = new WeakReference(this);
      ...
      do
      {
        ...
        do
        {
          do
          {
            ...
            {
              return null;
              localObject = (afvh)((WeakReference)localObject).get();
            } while (localObject == null);
            localObject = ((afvh)localObject).jdField_a_of_type_JavaLangRefWeakReference;
          } while (localObject == null);
  ...
  public static void a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      Object localObject2 = (afvh)((WeakReference)localObject2).get();
      ((afvh)localObject2).doOnEvent(paramInt);
      if (paramInt == 2) {
        b((afvh)localObject2);
      }
    }
  ...
  public static void a(afvh paramafvh)
  {
    if (paramafvh == null) {
      return;
    }
    synchronized (jdField_a_of_type_JavaUtilSet)
    {
      jdField_a_of_type_JavaUtilSet.remove(paramafvh.b);
      return;
    }
  }
  
  public static void b(afvh paramafvh)
  {
    WeakReference localWeakReference = paramafvh.jdField_a_of_type_JavaLangRefWeakReference;
    if ((localWeakReference != null) && (localWeakReference.get() != null)) {
      ((MessageForArkApp)localWeakReference.get()).arkContainer = null;
    }
    localWeakReference = paramafvh.f;
    if ((localWeakReference != null) && (localWeakReference.get() != null)) {
      ((RecommendCommonMessage)localWeakReference.get()).mOldAppInfo.mArkContainer = null;
    }
    localWeakReference = paramafvh.g;
    if ((localWeakReference != null) && (localWeakReference.get() != null)) {
      ((RecommendCommonMessage.ArkMsgAppInfo)localWeakReference.get()).mArkContainer = null;
    }
    paramafvh = paramafvh.jdField_e_of_type_JavaLangRefWeakReference;
    if ((paramafvh != null) && (paramafvh.get() != null)) {
      ((ArkBabyqCardInfo)paramafvh.get()).mArkBabyqContainer = null;
    }
  }
