...
public class yfl
  implements Runnable
{
  public yfl(TroopListAdapter2 paramTroopListAdapter2, TroopManager paramTroopManager, String paramString, TroopListAdapter2.TroopListItem paramTroopListItem, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    ThreadManager.getUIHandler().post(new yfm(this, str));
  }
}
