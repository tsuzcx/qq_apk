  ...
  extends AsyncTask<String, Void, Integer>
{
  ...
  public rtj(Context paramContext, boolean paramBoolean1, boolean paramBoolean2, rtl paramrtl)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Boolean = paramBoolean1;
    this.jdField_b_of_type_Boolean = paramBoolean2;
    this.jdField_a_of_type_Rtl = paramrtl;
  }
  ...
  private static int a(int paramInt1, int paramInt2)
  {
    ...
    {
      i = pgc.c;
      paramInt1 = bmqa.w(BaseApplicationImpl.getApplication().getRuntime());
      if (paramInt1 <= 0) {
        break label80;
      }
      i = paramInt1;
  ...
  private HashMap<String, String> a(String paramString, Context paramContext)
  {
    ...
    bcmd localbcmd = ShortVideoTrimmer.a(paramString);
    long l1;
    int i;
    if ((localbcmd != null) && (localbcmd.jdField_a_of_type_Boolean))
    {
      l1 = new File(paramString).length();
      i = a(localbcmd.jdField_a_of_type_Int, localbcmd.jdField_b_of_type_Int);
      if ((l1 <= 52428800L) && (i > 0) && (localbcmd.jdField_b_of_type_Long * 1024L / i < 1.3D))
      {
        localbcmd.jdField_a_of_type_Boolean = false;
    ...
    for (;;)
    {
      try
      {
        ...
        if (((i & 0x1) > 0) && ((i & 0x2) > 0))
        {
          ...
          localObject2 = new rtk(this, str2, (int)(localbcmd.jdField_b_of_type_Long * 1024L), (int)localbcmd.jdField_a_of_type_Long, 0L, l1);
          if ((!new bcms().a((File)localObject1, (bcmt)localObject2, true)) || (((rtk)localObject2).a != null)) {
            continue;
          }
          if (QLog.isColorLevel()) {
          ...
          {
            j = 0;
            if ((!"90".equals(localbcmd.jdField_a_of_type_JavaLangString)) && (!"270".equals(localbcmd.jdField_a_of_type_JavaLangString))) {
              break label585;
            }
            i = 1;
            if (i == 0) {
            ...
            localHashMap.put("outWidth", String.valueOf(localbcmd.d));
            localHashMap.put("outHeight", String.valueOf(localbcmd.c));
          }
          return localHashMap;
        }
      }
      ...
      if ((localbcmd != null) && (!localbcmd.jdField_a_of_type_Boolean))
      {
        ...
        label585:
        i = j;
        if ("0".equals(localbcmd.jdField_a_of_type_JavaLangString))
        {
          ...
          if (paramString != null)
          {
            ...
            if (paramString.length == 5) {
              ...
              else
              {
                ...
                continue;
                label647:
                localHashMap.put("outWidth", String.valueOf(localbcmd.c));
                localHashMap.put("outHeight", String.valueOf(localbcmd.d));
                return localHashMap;
              }
            }
          }
  ...
  private void a(int paramInt)
  {
    ...
    {
      localbctj.a(str, "actReadInJoyDeliverVideoCompressVideo", bool, this.jdField_b_of_type_Long - this.jdField_a_of_type_Long, 0L, localHashMap, "");
      return;
    }
  }
  ...
  protected Integer a(String... paramVarArgs)
  {
    ...
    this.jdField_a_of_type_Rtl.a(0.0F);
    ...
    if (localObject != null)
    {
      i = a(((bcmd)localObject).jdField_a_of_type_Int, ((bcmd)localObject).jdField_b_of_type_Int);
      this.jdField_c_of_type_JavaLangLong = Long.valueOf(((bcmd)localObject).jdField_b_of_type_Long);
      this.jdField_d_of_type_JavaLangLong = Long.valueOf(i);
      if ((i <= 0) || (((bcmd)localObject).jdField_b_of_type_Long * 1024L / i <= 1.3D)) {}
    }
    for (int i = 1;; i = 0)
    {
      if ((localFile.exists()) && (localFile.length() <= 52428800L) && (i == 0))
      {
        ...
        {
          i = j;
          if (!"90".equals(((bcmd)localObject).jdField_a_of_type_JavaLangString))
          {
            if (!"270".equals(((bcmd)localObject).jdField_a_of_type_JavaLangString)) {
              break label289;
            }
            i = j;
          }
          ...
          this.jdField_a_of_type_Int = ((bcmd)localObject).jdField_b_of_type_Int;
        }
        for (this.jdField_b_of_type_Int = ((bcmd)localObject).jdField_a_of_type_Int;; this.jdField_b_of_type_Int = ((bcmd)localObject).jdField_b_of_type_Int)
        {
          return Integer.valueOf(0);
          label289:
          if ("0".equals(((bcmd)localObject).jdField_a_of_type_JavaLangString))
          {
          ...
          break;
          label343:
          this.jdField_a_of_type_Int = ((bcmd)localObject).jdField_a_of_type_Int;
        }
      }
      localObject = new File(anhk.ba + "shortvideo");
  ...
  protected void a(Integer paramInteger)
  {
    ...
    if (paramInteger.intValue() != 0) {
      if (!this.jdField_a_of_type_Boolean)
      {
        ...
        if (this.jdField_a_of_type_Rtl != null) {
          this.jdField_a_of_type_Rtl.a(1, this.jdField_a_of_type_JavaLangLong.longValue(), this.jdField_b_of_type_JavaLangLong.longValue(), null, null, 0L);
        }
        i = 1004;
      }
    }
    for (;;)
    {
      ...
      if (!this.jdField_b_of_type_Boolean)
      {
        ...
        if (this.jdField_a_of_type_Rtl != null) {
          this.jdField_a_of_type_Rtl.a(2, this.jdField_a_of_type_JavaLangLong.longValue(), this.jdField_b_of_type_JavaLangLong.longValue(), null, null, 0L);
        }
        i = 1004;
      }
      else
      {
        ...
        if (this.jdField_a_of_type_Rtl != null) {
          this.jdField_a_of_type_Rtl.a(3, this.jdField_a_of_type_JavaLangLong.longValue(), this.jdField_b_of_type_JavaLangLong.longValue(), null, null, 0L);
        }
        i = 1004;
        continue;
        if (TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {}
        for (paramInteger = this.jdField_a_of_type_JavaLangString;; paramInteger = this.jdField_b_of_type_JavaLangString)
        {
          ...
          if (this.jdField_a_of_type_Rtl != null) {
            this.jdField_a_of_type_Rtl.a(4, this.jdField_a_of_type_JavaLangLong.longValue(), this.jdField_b_of_type_JavaLangLong.longValue(), this.jdField_c_of_type_JavaLangString, this.jdField_d_of_type_JavaLangString, this.jdField_c_of_type_JavaLangLong.longValue());
          }
          i = 1005;
          break;
        }
        label382:
        if (this.jdField_a_of_type_Rtl != null) {
          this.jdField_a_of_type_Rtl.a(0, this.jdField_a_of_type_JavaLangLong.longValue(), this.jdField_b_of_type_JavaLangLong.longValue(), this.jdField_c_of_type_JavaLangString, this.jdField_d_of_type_JavaLangString, this.jdField_d_of_type_JavaLangLong.longValue());
        }
        i = 0;
      }
    }
