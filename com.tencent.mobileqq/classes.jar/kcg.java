...
public class kcg
  implements Runnable
{
  public kcg(SysCallTransparentActivity paramSysCallTransparentActivity) {}
  
  public void run()
  {
    if (this.a.jdField_a_of_type_Int == 1) {
      DialogUtil.a(this.a, this.a.jdField_a_of_type_JavaLangString, this.a.b, 2131428675, 2131428676, new kch(this), null).show();
    }
    ...
    {
      DialogUtil.a(localSysCallTransparentActivity, 230, str2, str3, str4, str1, new kci(this, i), new kcj(this)).show();
      return;
      i = 2;
      break;
    }
