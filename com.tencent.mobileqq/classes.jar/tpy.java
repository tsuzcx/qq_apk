...
{
  public static final tpy a = new tpy();
  ...
  public final DownloadInfo a(@Nullable String paramString)
  {
    ...
    return bhyo.a().b(paramString);
  }
  
  @Nullable
  public final DownloadInfo a(@Nullable txh paramtxh)
  {
    if (paramtxh == null) {
      return null;
    }
    String str = paramtxh.c;
    paramtxh = paramtxh.d;
    return a(str);
  }
  
  public final void a(@Nullable txh paramtxh, @NotNull ValueCallback<tpz> paramValueCallback)
  {
    Intrinsics.checkParameterIsNotNull(paramValueCallback, "callback");
    ThreadManagerV2.executeOnSubThread((Runnable)new AdAppDownloadUtil.getAppDownloadState.1(paramtxh, paramValueCallback));
  }
  ...
  public final boolean a(@Nullable String paramString)
  {
    ...
    return obb.a((Context)BaseApplicationImpl.getContext(), paramString);
  }
}
