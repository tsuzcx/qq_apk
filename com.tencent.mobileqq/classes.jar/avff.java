...
public class avff
{
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new avfg(this);
  protected Handler a;
  public avfc a;
  protected QQAppInterface a;
  Runnable jdField_a_of_type_JavaLangRunnable = new QzonePhotoGuideNotifyService.1(this);
  
  public avff(QQAppInterface paramQQAppInterface, avfc paramavfc)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Avfc = paramavfc;
    if (paramQQAppInterface != null) {}
    try
    {
      paramavfc = new IntentFilter("com.qzonex.localalbum.new_photo_notification_feedback_action");
      paramQQAppInterface.getApp().registerReceiver(this.jdField_a_of_type_AndroidContentBroadcastReceiver, paramavfc);
      return;
    }
