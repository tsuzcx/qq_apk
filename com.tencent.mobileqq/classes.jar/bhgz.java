...
public class bhgz
{
  private static bhgz jdField_a_of_type_Bhgz;
  ...
  static String g = anni.a(2131698954);
  static String h = anni.a(2131698952);
  static String i = anni.a(2131698953);
  static String j = anni.a(2131698951);
  public int a;
  public long a;
  ...
  public static bhgz a()
  {
    if (jdField_a_of_type_Bhgz == null) {}
    try
    {
      if (jdField_a_of_type_Bhgz == null) {
        jdField_a_of_type_Bhgz = new bhgz();
      }
      return jdField_a_of_type_Bhgz;
    }
    finally {}
  }
  ...
  public void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    bgmg.a(paramContext.getFilesDir() + File.separator + "vipKerwordJson", paramString1);
  }
  ...
  void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    if (TextUtils.isEmpty(paramString2))
    {
      ...
      paramInt1 = bbxc.jdField_a_of_type_Int;
      bbxc.jdField_a_of_type_Int = paramInt1 + 1;
      ...
      localMessageRecord.msgUid = atvo.b();
      if (this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord == null) {
        break label249;
      }
    }
    ...
    label230:
    label249:
    for (long l1 = this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time;; l1 = bbyp.a())
    {
  ...
  public void a(AppRuntime paramAppRuntime)
  {
    ...
    if (localObject1 != null) {
      arza.a(((JSONObject)localObject1).optLong("interval", 86400L));
    }
    ...
    {
      auec.jdField_a_of_type_Boolean = bool1;
      QLog.i("AioVipKeywordHelper", 1, "lottieConfig.switch is " + bool1);
      localObject1 = paramAppRuntime.optJSONObject("ipProductGrayTips");
      if (localObject1 != null)
      {
        awmq.jdField_a_of_type_JavaLangString = ((JSONObject)localObject1).optString("leftText", awmq.jdField_a_of_type_JavaLangString);
        awmq.jdField_b_of_type_JavaLangString = ((JSONObject)localObject1).optString("linkText", awmq.jdField_b_of_type_JavaLangString);
        if (QLog.isColorLevel()) {
      ...
      if (localObject1 != null)
      {
        bgks.jdField_a_of_type_Int = ((JSONObject)localObject1).optInt("interval", 5000);
        QLog.d("AioVipKeywordHelper", 1, "getStrangerInterval is " + bgks.jdField_a_of_type_Int);
      }
      localObject1 = paramAppRuntime.optJSONObject("downloadTimeoutConfig");
      if (localObject1 != null)
      {
        arup.jdField_b_of_type_Int = ((JSONObject)localObject1).optInt("emotion", arup.jdField_b_of_type_Int);
        bool1 = bool2;
        if (((JSONObject)localObject1).optInt("emoTryReadNoLen", 0) == 1) {
          bool1 = true;
        }
        arup.jdField_b_of_type_Boolean = bool1;
      ...
      if (localObject1 != null) {
        bhap.a().a((JSONArray)localObject1);
      }
      arwc.a(paramAppRuntime.optJSONArray("h5MagicTips"));
      return;
    }
  }
  ...
  public boolean a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    do
    {
      ...
      {
        return false;
      } while ((bcnj.b()) || (this.jdField_d_of_type_Int == 0));
      l1 = 86400L;
      int i1;
      switch (paramSessionInfo.jdField_a_of_type_Int)
      {
