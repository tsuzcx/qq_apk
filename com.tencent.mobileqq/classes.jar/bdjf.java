...
public abstract class bdjf
{
  ...
  public bdjf(String paramString)
  {
    this.TAG = (paramString + "_" + AudioHelper.b());
  }
  
  public static void requestSyncTask(Resources paramResources, ArrayList<bdjf> paramArrayList, bdjg parambdjg)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localbdjf.isNeedRunTask()) {
        localArrayList.add(localbdjf);
      }
    }
    localIterator = localArrayList.iterator();
    while (localIterator.hasNext()) {
      ((bdjf)localIterator.next()).setRunning();
    }
    ThreadManager.post(new SyncLoadTask.1(localArrayList, paramResources, parambdjg, paramArrayList), 8, null, true);
  }
