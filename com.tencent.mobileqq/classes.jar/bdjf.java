  ...
  extends bdiw<Void, Void, Bitmap>
{
  ...
  public bdjf(String paramString1, String paramString2, Bundle paramBundle, String paramString3, bdjg parambdjg)
  {
    super(paramString2, paramString3);
    this.jdField_a_of_type_OrgApacheHttpImplConnTsccmThreadSafeClientConnManager = null;
    this.c = paramString1;
    this.jdField_a_of_type_Bdjg = parambdjg;
    ...
    for (;;)
    {
      ...
      return;
      paramString1.register(new Scheme("https", new ayvu(bdjf.class.getSimpleName()), 443));
    }
  }
  ...
  protected Bitmap a(Void... paramVarArgs)
  {
    ...
    //   5: dup
    //   6: aload_0
    //   7: getfield 20	bdjf:jdField_a_of_type_OrgApacheHttpImplConnTsccmThreadSafeClientConnManager	Lorg/apache/http/impl/conn/tsccm/ThreadSafeClientConnManager;
    //   10: aconst_null
    ...
    //   18: dup
    //   19: aload_0
    //   20: getfield 121	bdjf:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   23: invokespecial 122	org/apache/http/client/methods/HttpGet:<init>	(Ljava/lang/String;)V
    //   26: astore_3
    //   27: aload_0
    //   28: getfield 26	bdjf:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    //   31: ifnull +93 -> 124
    //   34: aload_0
    //   35: getfield 26	bdjf:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    ...
    //   68: astore 5
    //   70: aload_0
    //   71: getfield 26	bdjf:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    //   74: aload 5
    ...
    //   150: aload_0
    //   151: aload_1
    //   152: invokevirtual 181	bdjf:a	(Ljava/io/InputStream;)[B
    //   155: astore_3
    //   156: aload_1
    //   157: astore_2
    //   158: aload_3
  ...
  {
    if (this.jdField_a_of_type_Bdjg != null) {
      this.jdField_a_of_type_Bdjg.a(this.c, paramBitmap);
    }
  }
