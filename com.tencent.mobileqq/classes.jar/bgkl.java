...
public class bgkl
{
  ...
  private static awjk jdField_a_of_type_Awjk = new bgkm();
  ...
  private static MediaPlayer a(Context paramContext, int paramInt)
  {
    ...
    //   22: astore_2
    //   23: aload_2
    //   24: invokestatic 57	bgkl:a	(Landroid/media/MediaPlayer;)V
    //   27: aload_2
    //   28: aload_0
    ...
    for (;;)
    {
      ...
      if (paramInt1 != AppSetting.d)
      {
        ...
        if (jdField_a_of_type_AndroidMediaMediaPlayer != null)
        {
          ...
          jdField_a_of_type_AndroidMediaMediaPlayer.setOnCompletionListener(new bgkq(paramOnCompletionListener, paramHandler));
  ...
  public static void a(int paramInt, boolean paramBoolean)
  {
    for (;;)
    {
      ...
      jdField_a_of_type_AndroidMediaMediaPlayer.setOnCompletionListener(new bgko());
      jdField_a_of_type_AndroidMediaMediaPlayer.start();
  ...
  public static void a(Uri paramUri, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    //   3: ldc 2
    //   5: monitorenter
    //   6: getstatic 106	bgkl:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   9: astore_3
    //   10: aload_3
    //   11: ifnull +13 -> 24
    //   14: getstatic 106	bgkl:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   17: invokevirtual 97	android/media/MediaPlayer:release	()V
    //   20: aconst_null
    //   21: putstatic 106	bgkl:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   24: aload_0
    ...
    //   43: putstatic 106	bgkl:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   46: iload_2
    //   47: ifeq +25 -> 72
    ...
    //   66: getstatic 106	bgkl:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   69: invokestatic 57	bgkl:a	(Landroid/media/MediaPlayer;)V
    ...
    //   94: aload_0
    //   95: astore_3
    //   96: getstatic 106	bgkl:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   99: aload_0
    ...
    //   109: aload_0
    //   110: astore_3
    //   111: getstatic 106	bgkl:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   114: invokevirtual 80	android/media/MediaPlayer:prepare	()V
    //   117: aload_0
    //   118: astore 4
    //   120: aload_0
    //   121: astore_3
    //   122: getstatic 106	bgkl:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   125: new 282	bgkr
    //   128: dup
    //   129: invokespecial 283	bgkr:<init>	()V
    ...
    //   138: aload_0
    //   139: astore_3
    //   140: getstatic 106	bgkl:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   143: invokevirtual 136	android/media/MediaPlayer:start	()V
    //   146: aload_0
    //   147: astore 4
    //   149: aload_0
    //   150: astore_3
    //   151: getstatic 106	bgkl:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   154: iload_1
    ...
    //   170: astore_3
    //   171: aconst_null
    //   172: putstatic 106	bgkl:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   175: goto -151 -> 24
    //   178: astore_0
    //   179: aconst_null
    //   180: astore_3
    ...
    //   206: astore_0
    //   207: aconst_null
    //   208: putstatic 106	bgkl:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   211: aload_0
    //   212: athrow
    //   213: astore_0
    //   214: aload 4
    ...
    //   233: putstatic 106	bgkl:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   236: getstatic 106	bgkl:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   239: astore_0
    //   240: aload_0
    ...
    //   284: getstatic 106	bgkl:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   287: invokestatic 57	bgkl:a	(Landroid/media/MediaPlayer;)V
    //   290: aconst_null
    //   291: astore_0
    //   292: goto -175 -> 117
    //   295: astore_0
  ...
  public static void a(java.lang.String paramString, boolean paramBoolean)
  {
    ...
    //   9: aload 5
    //   11: astore_3
    //   12: getstatic 106	bgkl:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   15: ifnull +60 -> 75
    //   18: aload 5
    //   20: astore_3
    //   21: getstatic 106	bgkl:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    ...
    //   60: aload_0
    //   61: athrow
    //   62: getstatic 106	bgkl:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   65: invokevirtual 97	android/media/MediaPlayer:release	()V
    //   68: aload 5
    //   70: astore_3
    //   71: aconst_null
    //   72: putstatic 106	bgkl:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   75: aload 5
    //   77: astore_3
    //   78: getstatic 106	bgkl:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   81: ifnonnull +16 -> 97
    //   84: aload 5
    //   86: astore_3
    ...
    //   94: putstatic 106	bgkl:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   97: aload 5
    //   99: astore_3
    //   100: getstatic 106	bgkl:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    ...
    //   117: astore_0
    //   118: getstatic 106	bgkl:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   121: aload_0
    ...
    //   128: getstatic 106	bgkl:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   131: invokestatic 57	bgkl:a	(Landroid/media/MediaPlayer;)V
    //   134: getstatic 106	bgkl:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   137: invokevirtual 80	android/media/MediaPlayer:prepare	()V
    //   140: getstatic 106	bgkl:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   143: new 297	bgkn
    //   146: dup
    //   147: invokespecial 298	bgkn:<init>	()V
    ...
    //   153: getstatic 106	bgkl:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   156: invokevirtual 136	android/media/MediaPlayer:start	()V
    //   159: getstatic 106	bgkl:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   162: iload_1
    ...
    //   188: astore_3
    //   189: aconst_null
    //   190: putstatic 106	bgkl:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   193: goto -118 -> 75
    //   196: astore_3
    //   197: aload 4
    //   199: astore_0
    ...
    //   254: astore_3
    //   255: aconst_null
    //   256: putstatic 106	bgkl:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   259: aload 5
    //   261: astore_3
    //   262: aload_0
    //   263: athrow
  ...
  public static void b(int paramInt, boolean paramBoolean)
  {
    for (;;)
    {
      ...
      jdField_a_of_type_AndroidMediaMediaPlayer.setOnCompletionListener(new bgkp());
      jdField_a_of_type_AndroidMediaMediaPlayer.start();
      jdField_a_of_type_AndroidMediaMediaPlayer.setLooping(paramBoolean);
    }
  }
