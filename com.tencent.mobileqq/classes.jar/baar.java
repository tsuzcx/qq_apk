...
public class baar
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = baar.class.getSimpleName();
  }
  
  public baar(List<ParagraphInfo> paramList, azyv paramazyv, String paramString)
  {
    this.jdField_a_of_type_Azyv = paramazyv;
        ...
        try
        {
          ...
          if ((k >= 0) && (k < ((List)localObject).size()))
          {
            ...
            if (this.jdField_a_of_type_Azyv != null) {
              this.jdField_a_of_type_Azyv.a((WordInfo)localObject);
            }
          }
