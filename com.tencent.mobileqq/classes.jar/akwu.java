...
public class akwu
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, RecentBaseData paramRecentBaseData)
  {
    ...
    case 7230: 
      ...
      if ((paramRecentBaseData instanceof RecentItemPublicAccountChatMsgData))
      {
        ...
        if (advo.a(str2)) {
          aiku.a().a(paramQQAppInterface, 2);
        }
  ...
  public static void a(QQAppInterface paramQQAppInterface, AbsListView paramAbsListView, int paramInt)
  {
    ...
    do
    {
      ...
      } while (!(paramAbsListView.getAdapter() instanceof bfsi));
      localObject = (bfsi)paramAbsListView.getAdapter();
    } while (!(((bfsi)localObject).getWrappedAdapter() instanceof ahmv));
    b.clear();
    ahmv localahmv = (ahmv)((bfsi)localObject).getWrappedAdapter();
    ...
    if (i < k - 1)
    {
      paramAbsListView = localahmv.getItem(i);
      String str;
      if ((paramAbsListView instanceof RecentBaseData))
      {
        ...
        if (!a.containsKey(str))
        {
          ...
          aiku.a().a(paramQQAppInterface, 1);
        }
      ...
      do
      {
        for (;;)
        {
          i += 1;
          break;
          if ((!(localRecentBaseData instanceof RecentItemServiceAccountFolderData)) || (!advo.a(saz.a().a()))) {
            break label186;
          }
          aiku.a().a(paramQQAppInterface, 1);
          break label186;
