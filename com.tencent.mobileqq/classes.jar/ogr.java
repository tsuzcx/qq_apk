  ...
  extends BusinessHandler
{
  ...
  private ogt jdField_a_of_type_Ogt;
  ...
  public ogr(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {}
    while (this.jdField_a_of_type_Ogt != null) {
      return;
    }
    this.jdField_a_of_type_Ogt = new ogs(this);
    this.mApp.addObserver(this.jdField_a_of_type_Ogt);
  ...
  {
    super.onDestroy();
    this.mApp.removeObserver(this.jdField_a_of_type_Ogt);
  }
