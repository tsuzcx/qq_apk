  ...
  implements View.OnClickListener
{
  ...
  private static boolean jdField_b_of_type_Boolean = ((Boolean)bmqa.a(jdField_a_of_type_JavaLangString, Boolean.valueOf(false))).booleanValue();
  ...
  public ogr(Activity paramActivity)
  {
    super(paramActivity);
    this.jdField_a_of_type_Pmn = new ogs(this);
  }
  ...
  private void b(ListView paramListView, snh paramsnh)
  {
    TemplateBean localTemplateBean = null;
    JSONObject localJSONObject = pil.a();
    try
    {
      ...
      localObject = teh.a("default_feeds", true);
      if (localObject != null) {
        localTemplateBean = ((teh)localObject).getTemplateBean(localJSONObject);
      }
      if (localTemplateBean != null)
      {
        paramsnh = paramsnh.a();
        paramsnh = paramsnh.getViewFactory().inflate(paramsnh, localTemplateBean);
        pfr.a(paramsnh, null, localTemplateBean);
        paramsnh.setTag(localTemplateBean);
        paramListView.addFooterView(paramsnh);
        if ((paramListView instanceof ReadInJoyDailyXListView)) {
          ((ReadInJoyDailyXListView)paramListView).setPTSFooterView(paramsnh);
        }
      }
      else
      {
  ...
  private void l()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetDailyDianDianEntranceView = ((DailyDianDianEntranceView)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyBaseListViewGroup.findViewById(2131366053));
    ...
    {
      return;
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetDailyDianDianEntranceView.a(smj.a().a(a(), this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetDailyDianDianEntranceView, this));
    } while (smj.a().a() != 1);
  ...
  private void m()
  {
    ...
    View localView = LayoutInflater.from(a()).inflate(2131560135, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyDailyPullToZoomHeaderXListView, false);
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyDailyPullToZoomHeaderXListView.a(new spn());
  }
  
  private void n()
  {
    pwb localpwb = pmh.a().a();
    if ((localpwb != null) && (!jdField_b_of_type_Boolean)) {
      localpwb.a(new ogt(this, localpwb));
    }
  }
  ...
  public void a()
  {
    super.a();
    sgc.a().a(a());
    this.jdField_a_of_type_Seu = new seu(a());
    e = pil.a();
    this.jdField_b_of_type_JavaUtilMap.put(Integer.valueOf(b()), Boolean.valueOf(true));
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyBaseListViewGroup = new ReadInJoyListViewGroup(this, b(), c(), this.jdField_d_of_type_Int, null, 2131560134);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyDailyPullToZoomHeaderXListView = ((ReadInJoyDailyPullToZoomHeaderXListView)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyBaseListViewGroup.findViewById(2131378089));
    l();
    m();
    n();
    ...
    this.jdField_a_of_type_Sfq = new sfq((FrameLayout)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyBaseListViewGroup.findViewById(2131380771), this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyDailyPullToZoomHeaderXListView, this.jdField_a_of_type_AndroidAppActivity);
  ...
  public void a(ListView paramListView, snh paramsnh)
  {
    if ((paramListView != null) && (a() != 2)) {
      b(paramListView, paramsnh);
    }
  }
