  ...
  implements auch
{
  ...
  protected aubt(long paramLong, TroopFileTransferManager.Item paramItem, Bundle paramBundle, bfxx parambfxx)
  {
    super(paramLong, paramItem, paramBundle, parambfxx);
  }
  
  public static bfya a(long paramLong, TroopFileTransferManager.Item paramItem, Bundle paramBundle, bfxx parambfxx)
  {
    if (paramLong == 0L)
    {
      bfvr.a("ExcitingTransfer.TroopFileUploadWorker", bfvr.jdField_a_of_type_Int, "getWoker. troopuin=0");
      return null;
    }
    if (paramItem == null)
    {
      bfvr.a("ExcitingTransfer.TroopFileUploadWorker", bfvr.jdField_a_of_type_Int, "getWoker. item=null");
      return null;
    }
    if (paramItem.Id == null) {
      bfvr.a("ExcitingTransfer.TroopFileUploadWorker", bfvr.jdField_a_of_type_Int, "getWoker. item.id=null");
    }
    return new aubt(paramLong, paramItem, paramBundle, parambfxx);
  }
  ...
  private ExcitingTransferUploadResultRp a()
  {
    ...
    if (this.jdField_a_of_type_Bfxl != null)
    {
      ...
      if ((this.jdField_a_of_type_Bfxl instanceof auce)) {
        localObject1 = ((auce)this.jdField_a_of_type_Bfxl).a();
      }
    }
    return localObject1;
  }
  ...
  private void c(int paramInt)
  {
    ...
    aubs localaubs = new aubs(bfvp.a());
    localaubs.c(paramInt);
    int i = f();
    if (localObject != null) {
      if (((ExcitingTransferUploadResultRp)localObject).m_nResult == 0L)
      {
        localaubs.a((ExcitingTransferUploadResultRp)localObject);
        paramInt = auoo.b(((ExcitingTransferUploadResultRp)localObject).m_strServerIp);
        localaubs.c(this.jdField_a_of_type_Long);
        localObject = aunj.f(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.LocalFile);
        localaubs.a(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.troopuin, this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FileName, (String)localObject, this.jdField_c_of_type_Long);
        localaubs.c(this.jdField_a_of_type_Bfvc.jdField_a_of_type_Boolean);
        long l = System.currentTimeMillis() - this.jdField_a_of_type_Bfvc.jdField_d_of_type_Long;
        if (l <= 0L) {
          break label380;
        }
        localaubs.b(l);
        label152:
        l = this.jdField_a_of_type_Bfvc.g;
        if (l <= 0L) {
          break label389;
        }
        localaubs.a(l);
    ...
    {
      localaubs.a(i);
      localaubs.b(paramInt);
      localaubs.d(this.jdField_b_of_type_Boolean);
      localaubs.a(bool);
      return;
      bool = false;
      break;
      ...
      if (paramInt == 0)
      {
        ...
        if (this.jdField_a_of_type_Bfvc.jdField_a_of_type_Long > 0L) {
          ((ExcitingTransferUploadResultRp)localObject).m_u64StartSize = this.jdField_a_of_type_Bfvc.jdField_a_of_type_Long;
        }
        if (this.jdField_a_of_type_Bfvc.jdField_b_of_type_Long > 0L) {
          ((ExcitingTransferUploadResultRp)localObject).m_u64TransferSize = this.jdField_a_of_type_Bfvc.jdField_b_of_type_Long;
        }
  ...
  private int f()
  {
    if ((this.jdField_a_of_type_Bfxl != null) && ((this.jdField_a_of_type_Bfxl instanceof auce))) {
      return ((auce)this.jdField_a_of_type_Bfxl).g();
    }
    return 0;
  }
  ...
  private void s()
  {
    ...
    localaubs.c(33);
    localaubs.c(this.jdField_a_of_type_Long);
    Object localObject = aunj.f(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.LocalFile);
    localaubs.a(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.troopuin, this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FileName, (String)localObject, this.jdField_c_of_type_Long);
    localaubs.c(false);
    long l = System.currentTimeMillis() - this.jdField_a_of_type_Bfvc.jdField_d_of_type_Long;
    label119:
  ...
  protected bfxl a(QQAppInterface paramQQAppInterface, long paramLong, boolean paramBoolean1, boolean paramBoolean2, String paramString)
  {
    ...
    paramString = new aucg(localArrayList1, localArrayList2, paramBoolean2, paramString, null);
    paramQQAppInterface = auce.a(paramQQAppInterface, paramLong, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.troopuin, localaucf, paramString);
    if (paramQQAppInterface != null)
    {
      ((auce)paramQQAppInterface).a(this);
  ...
  public void a(int paramInt, ExcitingTransferUploaderRp paramExcitingTransferUploaderRp)
  {
    ...
    if (paramInt != 0)
    {
      this.jdField_a_of_type_Bfvc.e = 0;
      ...
      localaubu = new aubu(bfvp.a());
      localaubu.c(this.jdField_a_of_type_Long);
      String str = aunj.f(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.LocalFile);
      localaubu.c(paramInt);
      localaubu.a(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.troopuin, this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FileName, str, this.jdField_c_of_type_Long);
      localaubu.a(paramExcitingTransferUploaderRp);
      localaubu.a(f());
      localaubu.b(auoo.b(paramExcitingTransferUploaderRp.m_strServerIp));
      localaubu.c(this.jdField_b_of_type_Boolean);
      if (paramInt != 0) {
        break label206;
      }
    }
  ...
  protected void c()
  {
    ...
    for (;;)
    {
      c(j);
      return;
      j = this.jdField_a_of_type_Bfvc.jdField_d_of_type_Int;
      int i = j;
      if (j == 0) {
