  ...
  public static ArrayList<MessageRecord> a(List<MessageRecord> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if ((localMessageRecord instanceof MessageForSystemMsg))
      {
        ...
        if (((localStructMsg1 == null) || (localStructMsg1.msg_time == null) || (!localStructMsg1.msg_time.has()) || (localarbc == null) || (System.currentTimeMillis() - localStructMsg1.msg_time.get() * 1000L <= localarbc.b * 1000L)) && (localStructMsg1 != null) && (localStructMsg1.msg_seq != null) && (localStructMsg1.msg_seq.has()))
        {
          int i;
  ...
  public static void a(List<MessageRecord> paramList, int paramInt)
  {
    for (;;)
    {
      ...
      synchronized (jdField_a_of_type_JavaUtilList)
      {
        ...
        c.clear();
        d.clear();
        Object localObject = (arbc)aran.a().a(634);
        jdField_a_of_type_JavaUtilList = a(jdField_a_of_type_JavaUtilList, paramList);
        if ((localObject == null) || (!((arbc)localObject).jdField_a_of_type_Boolean))
        {
