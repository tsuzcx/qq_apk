...
public class zqi
  extends zqp
{
  private final baua jdField_a_of_type_Baua = new zqj(this, Looper.getMainLooper());
  private final ArrayList<zqk> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private Set<Long> jdField_a_of_type_JavaUtilSet = new HashSet(10);
  private ConcurrentHashMap<String, zqn> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap(20);
  zqe jdField_a_of_type_Zqe = new zqe();
  zqh jdField_a_of_type_Zqh = new zqh();
  ...
  private void a(long paramLong1, String paramString, long paramLong2, int paramInt)
  {
    ...
    {
      paramString = new zqn(this, paramString, paramLong2, paramInt, "", 0L);
  ...
  {
    zqn localzqn = (zqn)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(paramSession.uSessionID));
    if (localzqn == null) {
      return;
    }
    Object localObject1;
    ...
    {
      this.jdField_a_of_type_Zqh.a(paramSession, localzqn.jdField_a_of_type_JavaLangString, localzqn.jdField_a_of_type_Long, localzqn.jdField_a_of_type_Int, paramBoolean);
      localObject1 = BaseApplicationImpl.getApplication().getRuntime();
      if ((localObject1 instanceof QQAppInterface))
      {
        localObject1 = (QQAppInterface)localObject1;
        localObject2 = ((zpa)((QQAppInterface)localObject1).a(51)).a(Long.parseLong(localzqn.jdField_a_of_type_JavaLangString));
    ...
    for (int i = ((DeviceInfo)localObject2).productId;; i = 0)
    {
      ...
      {
        int j;
        if (paramSession.actionInfo.strServiceName.compareTo(ztk.f) == 0) {
          if (paramBoolean)
          {
            j = 0;
            aabm.a((AppRuntime)localObject1, l, "Net_SendMsg_Audio", 0, j, i);
            localObject1 = ((QQAppInterface)localObject1).getHandler(Conversation.class);
            if (localObject1 != null) {
              ((MqqHandler)localObject1).sendEmptyMessage(1009);
            }
            localObject1 = this.jdField_a_of_type_Baua.obtainMessage();
            localObject2 = new zqm(this);
            if (!paramBoolean) {
              break label364;
            }
          }
        ...
        for (i = 1003;; i = 1005)
        {
          ((zqm)localObject2).jdField_a_of_type_Int = i;
          ((zqm)localObject2).jdField_a_of_type_Long = localzqn.jdField_a_of_type_Long;
          ((Message)localObject1).obj = localObject2;
          this.jdField_a_of_type_Baua.sendMessageDelayed((Message)localObject1, 0L);
          this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(String.valueOf(paramSession.uSessionID));
          return;
          if (!paramSession.actionInfo.strServiceName.equalsIgnoreCase(ztk.f)) {
            break;
          }
          this.jdField_a_of_type_Zqe.a(paramSession, localzqn.jdField_a_of_type_JavaLangString, localzqn.jdField_a_of_type_Long, localzqn.jdField_a_of_type_Int, paramBoolean);
          break;
          j = 1;
          break label157;
          if (paramSession.actionInfo.strServiceName.compareTo(ztk.e) != 0) {
            break label170;
          }
          if (paramBoolean) {}
          for (j = 0;; j = 1)
          {
            aabm.a((AppRuntime)localObject1, l, "Net_SendMsg_Video", 0, j, i);
            break;
          }
        }
      }
  ...
  private void c(Session paramSession)
  {
    ...
    if ((localObject instanceof QQAppInterface))
    {
      ...
      MessageForDevShortVideo localMessageForDevShortVideo = (MessageForDevShortVideo)ayvw.a(-4503);
  ...
  public String a(DataPoint paramDataPoint)
  {
    for (;;)
    {
      try
      {
        ...
        long l1 = ((JSONObject)localObject1).optLong("msg_time", ayvc.a());
        ...
        if (TextUtils.isEmpty(str1))
        {
          ...
          if ((localObject2 instanceof QQAppInterface))
          {
            ...
            MessageForDevPtt localMessageForDevPtt = (MessageForDevPtt)ayvw.a(-4501);
  ...
  public void a(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      paramBundle = (zqn)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(i));
    } while (paramBundle == null);
    this.jdField_a_of_type_Zqe.a((Session)localObject, paramBundle.jdField_a_of_type_JavaLangString, paramBundle.jdField_a_of_type_Long, paramBundle.jdField_a_of_type_Int, f);
    Object localObject = this.jdField_a_of_type_Baua.obtainMessage();
    zqm localzqm = new zqm(this);
    localzqm.jdField_a_of_type_Int = 1002;
    localzqm.jdField_a_of_type_Float = f;
    localzqm.jdField_a_of_type_Long = paramBundle.jdField_a_of_type_Long;
    ((Message)localObject).obj = localzqm;
    this.jdField_a_of_type_Baua.sendMessageDelayed((Message)localObject, 0L);
  }
  
  void a(Message paramMessage)
  {
    if (QLog.isColorLevel()) {
      QLog.d("DeviceAVFileMsgObserver", 2, "handleMessage" + ((zqm)paramMessage.obj).jdField_a_of_type_Long + " status " + paramMessage.what + "retCode " + paramMessage.arg1);
    }
    int i = 0;
    if (i < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      Object localObject = (zqk)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      View localView = ((zqk)localObject).a();
      localObject = ((zqk)localObject).a();
      if ((localView != null) && (localObject != null)) {
        ((zql)localObject).a(localView, (zqm)paramMessage.obj);
      }
      for (;;)
      {
        i += 1;
  ...
  public void a(View paramView, zql paramzql)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (localIterator.hasNext())
    {
      zqk localzqk = (zqk)localIterator.next();
      if (localzqk.a() == paramView)
      {
        localzqk.b = new WeakReference(paramzql);
        return;
      }
    }
    this.jdField_a_of_type_JavaUtilArrayList.add(new zqk(this, paramView, paramzql));
  }
  ...
  public void a(MessageForDevPtt paramMessageForDevPtt)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        {
          paramMessageForDevPtt = new zqn(this, paramMessageForDevPtt.frienduin, paramMessageForDevPtt.uniseq, paramMessageForDevPtt.istroop, "", 0L);
  ...
  public void a(Session paramSession)
  {
    ...
    if ((!paramSession.bSend) && (paramSession.actionInfo.strServiceName.equalsIgnoreCase(ztk.e))) {
      c(paramSession);
    }
  }
  ...
  public void a(Session paramSession, float paramFloat)
  {
    ...
    if (localzqn != null)
    {
      ...
      this.jdField_a_of_type_Zqh.a(paramSession, localzqn.jdField_a_of_type_JavaLangString, localzqn.jdField_a_of_type_Long, localzqn.jdField_a_of_type_Int, paramFloat);
      localMessage = this.jdField_a_of_type_Baua.obtainMessage();
      localzqm = new zqm(this);
    ...
    label165:
    label205:
    for (localzqm.jdField_a_of_type_Int = 1002;; localzqm.jdField_a_of_type_Int = 2002)
    {
      localzqm.jdField_a_of_type_Float = paramFloat;
      localzqm.jdField_a_of_type_Long = localzqn.jdField_a_of_type_Long;
      localMessage.obj = localzqm;
      this.jdField_a_of_type_Baua.sendMessageDelayed(localMessage, 0L);
      return;
      if (!paramSession.actionInfo.strServiceName.equalsIgnoreCase(ztk.f)) {
        break;
      }
      this.jdField_a_of_type_Zqe.a(paramSession, localzqn.jdField_a_of_type_JavaLangString, localzqn.jdField_a_of_type_Long, localzqn.jdField_a_of_type_Int, paramFloat);
      break;
    }
  }
  ...
  public void a(Session paramSession, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      localzqn = (zqn)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(paramSession.uSessionID));
    } while (localzqn == null);
    label135:
    Object localObject1;
    Object localObject2;
    ...
    for (int i = 2003;; i = 2005)
    {
      ...
      this.jdField_a_of_type_Baua.sendMessageDelayed((Message)localObject1, 0L);
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(String.valueOf(paramSession.uSessionID));
      this.jdField_a_of_type_JavaUtilSet.remove(Long.valueOf(localzqn.jdField_a_of_type_Long));
      if (!paramBoolean) {
        break label439;
      }
      this.b.remove(Long.valueOf(localzqn.jdField_a_of_type_Long));
      return;
      if ((paramSession.actionInfo.strServiceName.equalsIgnoreCase(ztk.f)) || (!paramSession.actionInfo.strServiceName.equalsIgnoreCase(ztk.g))) {
        break label135;
      }
      localObject1 = BaseApplicationImpl.getApplication().getRuntime();
      if (!(localObject1 instanceof QQAppInterface)) {
      ...
      localObject1 = (QQAppInterface)localObject1;
      localObject2 = ((QQAppInterface)localObject1).a().a(localzqn.jdField_a_of_type_JavaLangString, localzqn.jdField_a_of_type_Int, localzqn.jdField_a_of_type_Long);
      if (localObject2 == null) {
        break;
      }
      ...
      if (paramBoolean) {}
      for (localMessageForDevPtt.fileSize = arni.a(paramSession.strFilePathSrc);; localMessageForDevPtt.fileSize = -1L)
      {
        localMessageForDevPtt.msg = localMessageForDevPtt.getSummary();
        localMessageForDevPtt.serial();
    ...
    label439:
    this.b.put(Long.valueOf(localzqn.jdField_a_of_type_Long), Long.valueOf(ayvc.a()));
  }
  
  public void a(MessageRecord paramMessageRecord, float paramFloat)
  {
    Message localMessage = this.jdField_a_of_type_Baua.obtainMessage();
    zqm localzqm = new zqm(this);
    localzqm.jdField_a_of_type_Int = 1002;
    localzqm.jdField_a_of_type_Long = paramMessageRecord.uniseq;
    localzqm.jdField_a_of_type_Float = paramFloat;
    localMessage.obj = localzqm;
    this.jdField_a_of_type_Baua.sendMessageDelayed(localMessage, 0L);
  }
  ...
  public void a(MessageRecord paramMessageRecord, Boolean paramBoolean)
  {
    ...
    {
      i = 1003;
      localzqm.jdField_a_of_type_Int = i;
      localzqm.jdField_a_of_type_Long = paramMessageRecord.uniseq;
      if (!paramBoolean.booleanValue()) {
        break label89;
      }
  ...
  public void a(String paramString1, String paramString2, long paramLong1, long paramLong2, int paramInt1, int paramInt2)
  {
    ...
    {
      localObject1 = (QQAppInterface)localObject1;
      localObject2 = (zpa)((QQAppInterface)localObject1).a(51);
      if ((!paramString1.equalsIgnoreCase(ztk.f)) || (localObject2 == null) || (!((zpa)localObject2).b(paramLong1))) {
        break label192;
      }
      localObject1 = new Session();
      ((Session)localObject1).uSessionID = ((zpa)localObject2).a(paramLong1, paramString2, paramInt2);
      ((Session)localObject1).strFilePathSrc = paramString2;
      ((Session)localObject1).uFileSizeSrc = arni.a(paramString2);
      ...
      paramString2 = new zqn(this, String.valueOf(paramLong1), paramLong2, paramInt1, paramString2, ((Session)localObject1).uFileSizeSrc);
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(localObject2, paramString2);
      label154:
      if (!bdee.d(BaseApplication.getContext()))
      {
        if (!paramString1.equalsIgnoreCase(ztk.e)) {
          break label238;
        }
        this.jdField_a_of_type_Zqh.a((Session)localObject1, String.valueOf(paramLong1), paramLong2, paramInt1, false);
      }
    }
    label192:
    label221:
    label238:
    while (!paramString1.equalsIgnoreCase(ztk.f))
    {
      return;
    ...
    this.jdField_a_of_type_Zqe.a((Session)localObject1, String.valueOf(paramLong1), paramLong2, paramInt1, false);
  }
  ...
  public boolean a(long paramLong)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (((zqn)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).jdField_a_of_type_Long == paramLong) {
        return true;
      }
    }
    return false;
  ...
  public void b(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      localzqn = (zqn)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(paramBundle.uSessionID));
    } while (localzqn == null);
    paramBundle.strFilePathSrc = localzqn.jdField_b_of_type_JavaLangString;
    paramBundle.uFileSizeSrc = localzqn.jdField_b_of_type_Long;
    Object localObject1 = this.jdField_a_of_type_Zqe;
    Object localObject2 = localzqn.jdField_a_of_type_JavaLangString;
    long l = localzqn.jdField_a_of_type_Long;
    int j = localzqn.jdField_a_of_type_Int;
    if (i == 0)
    {
      ((zqe)localObject1).a(paramBundle, (String)localObject2, l, j, bool);
      localObject1 = BaseApplicationImpl.getApplication().getRuntime();
      if ((localObject1 instanceof QQAppInterface))
      {
        localObject1 = (QQAppInterface)localObject1;
  ...
  public void b(Session paramSession)
  {
    ...
    zqm localzqm = new zqm(this);
    if (paramSession.bSend) {}
    for (localzqm.jdField_a_of_type_Int = 1001;; localzqm.jdField_a_of_type_Int = 2001)
    {
      localzqm.jdField_a_of_type_Long = localzqn.jdField_a_of_type_Long;
      localMessage.obj = localzqm;
      this.jdField_a_of_type_Baua.sendMessageDelayed(localMessage, 0L);
