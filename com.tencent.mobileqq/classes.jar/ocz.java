  ...
  extends ViewBase
{
  ...
  private oaz jdField_a_of_type_Oaz = new oaz();
  private ocx jdField_a_of_type_Ocx;
  private ocy jdField_a_of_type_Ocy;
  ...
  private ocy jdField_b_of_type_Ocy;
  private int c = -1;
  private int d;
  private int e;
  private int f;
  ...
  public ocz(VafContext paramVafContext)
  {
  ...
  private Boolean a(float paramFloat1, float paramFloat2)
  {
    ...
    boolean bool3 = true;
    boolean bool1 = true;
    float f1 = this.jdField_a_of_type_Ocy.d;
    float f2 = this.jdField_a_of_type_Ocy.c;
    float f3 = this.jdField_b_of_type_Ocy.d;
    float f4 = this.jdField_b_of_type_Ocy.c;
    if (f1 == f3)
    {
      if (paramFloat2 <= f1) {}
      for (;;)
  ...
  private ocy a(String paramString)
  {
  ...
  {
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.k = paramInt1;
  ...
  {
    this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)this.jdField_a_of_type_AndroidContentContext.getSystemService("layout_inflater")).inflate(2131559790, null);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368497));
    this.jdField_b_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368499));
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdViewReadInjoyCutImageView = ((ReadInjoyCutImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368498));
  ...
  private void a(View paramView)
  {
    ...
    if ((this.jdField_a_of_type_Pax != null) && (this.jdField_a_of_type_Pax.a() != null) && (this.jdField_a_of_type_Pax.a().a() != null))
    {
      this.jdField_b_of_type_Int = this.jdField_a_of_type_Pax.a().a().getPaddingTop();
      this.c = this.jdField_a_of_type_Pax.a().a().getTop();
      if (this.jdField_a_of_type_Int <= 0) {
        this.jdField_a_of_type_Int = this.jdField_a_of_type_Pax.a().a().getBottom();
      }
    }
    for (;;)
    {
  ...
  private void a(String paramString)
  {
    ...
    if (localObject.length == 2)
    {
      ...
      this.jdField_a_of_type_Ocy = a(paramString);
      this.jdField_b_of_type_Ocy = a((String)localObject);
    }
  }
  ...
  private void a(String paramString, Drawable paramDrawable)
  {
    ...
    do
    {
      ...
      if ((paramDrawable != null) && (paramDrawable.getStatus() == 1))
      {
        ...
        this.jdField_a_of_type_Ocx = new ocx(paramDrawable.getCurrDrawable(), this.d, this.jdField_a_of_type_Int - (this.jdField_b_of_type_Int + this.c));
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView.setImageDrawable(this.jdField_a_of_type_Ocx);
        this.jdField_a_of_type_JavaLangString = paramString;
        return;
      }
    } while (paramDrawable == null);
    paramDrawable.setURLDrawableListener(new oda(this, paramString));
  }
  
  private void a(ArrayList<String> paramArrayList)
  {
    if ((oau.l(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo)) && (paramArrayList != null) && (paramArrayList.size() > 0))
    {
  ...
  private void c()
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo != null) {
      if (!oau.i(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo))
      {
    ...
    for (Object localObject = ((URL)localObject).getFile();; localObject = null)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.g == 1009) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdImgList != null))
      {
  ...
  private void e()
  {
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo == null) || (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.c)) || (this.jdField_a_of_type_JavaUtilArrayList == null) || (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdMaterialWidth == 0) || (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdMaterialHeight == 0) || (this.jdField_a_of_type_JavaLangRunnable != null) || (this.jdField_a_of_type_Oaz.a() != null) || (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdViewReadInjoyCutImageView == null)) {
      return;
    }
    a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.c);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdViewReadInjoyCutImageView.setOnTouchListener(new odb(this));
    if ((this.jdField_a_of_type_Ocy != null) && (this.jdField_b_of_type_Ocy != null)) {
      this.jdField_a_of_type_Oaz.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdViewReadInjoyCutImageView, this.jdField_a_of_type_Ocy, this.jdField_b_of_type_Ocy, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.i, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.j, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.m);
    }
    this.jdField_a_of_type_Oaz.a(new odc(this));
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, double paramDouble)
  {
    ...
    } while (this.jdField_a_of_type_Ocx == null);
    if (this.jdField_a_of_type_Ocx.getCallback() == null) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView.setImageDrawable(this.jdField_a_of_type_Ocx);
    }
    ...
    this.jdField_a_of_type_Ocx.a(paramInt1, paramInt2);
  }
  ...
  public void a(pax parampax)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo != null) && (oau.i(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo))) {
      d();
    }
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo != null) && (oau.l(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo))) {
      a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView);
    }
  }
  ...
  public void reset()
  {
    ...
    {
      this.jdField_a_of_type_Oaz.a();
      this.jdField_a_of_type_Oaz.a(null);
      this.jdField_a_of_type_Oaz = null;
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdViewReadInjoyCutImageView.setImageSrc(null);
    }
    if (this.jdField_a_of_type_Ocx != null)
    {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView.setImageDrawable(null);
      this.jdField_a_of_type_Ocx.a();
      this.jdField_a_of_type_Ocx = null;
    }
  }
