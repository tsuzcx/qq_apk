  ...
  extends alko
{
  ...
  public void a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        ntw.b = localArrayList;
        if ((localJSONArray2 != null) && (localJSONArray2.length() > 0))
        {
          i = 0;
          if (i < localJSONArray2.length())
          {
            ntw.c.add(String.valueOf(localJSONArray2.getLong(i)));
            i += 1;
            continue;
          }
        }
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    {
      return;
      ntw localntw = (ntw)this.app.getManager(88);
      ...
      localObject = localntw.a(paramMessageRecord.senderuin);
      ...
      localntw.a((EcShopData)localObject);
  ...
  public void a(boolean paramBoolean, MessageRecord paramMessageRecord, int paramInt, String paramString)
  {
    try
    {
      ...
      if ("1".equals(paramMessageRecord.getExtInfoFromExtStr("is_AdArrive_Msg")))
      {
        paramString = new nug();
        paramString.a = 3;
        paramString = nud.a(paramString, paramMessageRecord);
        paramString.f = paramInt;
        ((nud)this.app.a(139)).a(paramString, null);
  ...
  public void b(MessageRecord paramMessageRecord)
  {
    ...
    try
    {
      ...
      QLog.i("EcshopReportHandler", 1, "doArrivalReport hasAdver: " + (String)localObject2);
      if ("1".equals(localObject2))
      {
        localObject1 = new nug();
        ((nug)localObject1).a = 1;
        localObject1 = nud.a((nug)localObject1, paramMessageRecord);
        ((nud)this.app.a(139)).a((nug)localObject1, null);
        if ((paramMessageRecord instanceof MessageForStructing))
        {
          paramMessageRecord = ((MessageForStructing)paramMessageRecord).structingMsg;
          if (!(paramMessageRecord instanceof StructMsgForGeneralShare)) {
          ...
          nur.a(paramMessageRecord.g, false);
          nur.a(this.app, "qgg.push.arrive", ((StructMsgForGeneralShare)paramMessageRecord.a).mContentTitle, NetConnInfoCenter.getServerTimeMillis() + "", "");
          return;
        }
        ...
        localObject3 = ((JSONObject)localObject2).optJSONArray("api_click_monitor_url");
        ((qq_ad_get.QQAdGetRsp.AdInfo.ReportInfo.ThirdPartyMonitorUrls)localObject1).api_click_monitor_url.set(a((JSONArray)localObject3));
    ...
    if ((paramMessageRecord instanceof MessageForArkApp))
    {
      ...
      if (localObject3 != null)
      {
        ...
        QLog.i("EcshopReportHandler", 1, "sourceAdObj: " + localObject3);
        if (("gw".equals(((JSONObject)localObject3).optString("from"))) && ("100".equals(((JSONObject)localObject3).optString("action_type"))))
        {
          nur.a(((JSONObject)localObject3).optInt("tab_id"), false);
          nur.a(this.app, "qgg.push.arrive", ((MessageForArkApp)localObject2).msg, NetConnInfoCenter.getServerTimeMillis() + "", "");
        }
      }
    ...
    do
    {
      do
      {
        do
        {
          ...
          paramToServiceMsg = (ntw)this.app.getManager(88);
