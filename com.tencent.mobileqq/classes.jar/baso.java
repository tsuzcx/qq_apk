...
public class baso
  extends baqo
{
  public baso(BaseApplicationImpl paramBaseApplicationImpl)
  {
  ...
  public File a(OutputStream paramOutputStream, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    if ((j != 0) && (bdin.g(this.a.getApplicationContext())))
    {
    ...
    for (;;)
    {
      ...
      try
      {
        new batt().a(paramOutputStream, paramDownloadParams, paramURLDrawableHandler);
        paramOutputStream.close();
        paramURLDrawableHandler = new File(str3);
        localFile = new File(str1);
        if (!paramURLDrawableHandler.renameTo(localFile))
        {
          bdhb.a(paramURLDrawableHandler, localFile);
          paramURLDrawableHandler.delete();
        }
        bivo.a(this.a.waitAppRuntime(null), false, new File(str1).length());
  ...
  public Object decodeFile(File paramFile, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    for (;;)
    {
      ...
      if (5 == arrr.a(paramFile.getName()))
      {
        localObject = arrj.a(this.a, paramFile.getPath());
        if (localObject != null)
        {
