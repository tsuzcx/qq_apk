...
public class akii
{
  ...
  public final CopyOnWriteArrayList<akij> a;
  ...
  public static akii a()
  {
    if (jdField_a_of_type_Akii == null) {}
    try
    {
      if (jdField_a_of_type_Akii == null) {
        jdField_a_of_type_Akii = new akii();
      }
      return jdField_a_of_type_Akii;
    }
    finally {}
  }
  ...
  private void c(String paramString)
  {
    ...
    if (localObject2.length == 3)
    {
      ...
      {
        localObject1 = new File(bdbg.c((String)localObject1));
        if (((File)localObject1).exists())
        {
          ...
          localObject1 = bcwc.a(((File)localObject1).getAbsolutePath());
  ...
  public Bitmap a(akif paramakif, int paramInt)
  {
    if ((paramakif == null) || (TextUtils.isEmpty(paramakif.jdField_a_of_type_JavaLangString))) {
      return null;
    }
    if (this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.containsKey(paramakif.jdField_a_of_type_JavaLangString))
    {
      Object localObject = (DiyPendantEntity)this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.get(paramakif.jdField_a_of_type_JavaLangString);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(paramakif);
      paramakif = BaseApplicationImpl.getApplication().getRuntime();
      if ((paramakif instanceof QQAppInterface)) {
        a((QQAppInterface)paramakif, 500);
      }
      return null;
      if (QLog.isColorLevel()) {
        QLog.i("DiyPendantFetcher", 2, "can not found cache in DiyPendantCache! " + paramakif.jdField_a_of_type_JavaLangString);
      }
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArraySet.add(paramakif.jdField_a_of_type_JavaLangString);
    }
  }
  
  public Bitmap a(akij paramakij, String paramString, int paramInt1, int paramInt2, float paramFloat, int paramInt3, int paramInt4, int paramInt5, Paint paramPaint)
  {
    ...
    Object localObject = bdbg.a(String.valueOf(paramInt1));
    if (!this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_isFontLoaded(paramInt1))
    {
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(paramakij);
      if (bdbg.a(String.valueOf(paramInt1)))
      {
        if (QLog.isColorLevel()) {
    ...
    paramakij = new ETFont(paramInt1, (String)localObject, paramFloat);
    paramakij.setColor(paramInt3);
    try
    {
      localObject = Bitmap.createBitmap(paramInt4, paramInt5, Bitmap.Config.ARGB_8888);
      if (!this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_isPaintableChar(paramString.charAt(0), paramakij)) {
        break label590;
      }
      for (paramInt1 = this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_spaceMeasureText(paramString, 0, paramString.length(), paramakij, paramPaint); paramInt1 > paramInt4; paramInt1 = this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_spaceMeasureText(paramString, 0, paramString.length(), paramakij, paramPaint)) {
        paramakij.mFontSize -= 1;
      }
      paramInt2 = (paramInt4 - paramInt1) / 2;
    }
    catch (OutOfMemoryError paramakij)
    {
      QLog.d("DiyPendantFetcher", 1, "fetchTextWithFont Bitmap.createBitmap OutOfMemoryError: " + paramakij.getMessage());
      return null;
    }
    paramInt1 = 0;
    paramPaint = new Paint.FontMetrics();
    if (this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_getFontMetrics(paramPaint, paramakij))
    {
      paramFloat = paramPaint.bottom;
      float f = paramPaint.top;
      paramInt1 = (int)((paramInt5 - (paramFloat - f)) / 2.0F);
    }
    if (!this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_drawText(paramString, (Bitmap)localObject, paramInt2, paramInt1, paramakij))
    {
  ...
  public Typeface a(akij paramakij, int paramInt1, int paramInt2)
  {
    if ((paramakij == null) || (paramInt1 <= 0)) {
      return null;
    }
  ...
  public DiyPendantEntity a(QQAppInterface paramQQAppInterface, String paramString, alkr paramalkr)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.containsKey(paramString))
      {
        ...
        if (paramalkr != null) {
          paramalkr.onUpdate(1, true, paramQQAppInterface);
        }
    ...
    } while (paramalkr == null);
    paramalkr.onUpdate(1, true, paramString);
    return localObject;
    if (QLog.isColorLevel()) {
    ...
    ((akik)paramQQAppInterface.a(114)).a((List)localObject, paramalkr);
    return null;
  }
  ...
  public List<DiyPendantSticker> a(akif paramakif)
  {
    if ((paramakif == null) || (TextUtils.isEmpty(paramakif.jdField_a_of_type_JavaLangString))) {
      return null;
    }
    if (this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.containsKey(paramakif.jdField_a_of_type_JavaLangString)) {
      return ((DiyPendantEntity)this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.get(paramakif.jdField_a_of_type_JavaLangString)).getStickerInfoList();
    }
    if (QLog.isColorLevel()) {
      QLog.i("DiyPendantFetcher", 2, "can not found cache in DiyPendantCache! " + paramakif.jdField_a_of_type_JavaLangString);
    }
  ...
  {
    String str = bdbg.a(String.valueOf(paramInt1));
  ...
  public void a(QQAppInterface paramQQAppInterface, boolean paramBoolean, List<DiyPendantEntity> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if (paramBoolean)
      {
        ...
        ExtensionInfo localExtensionInfo = localaloz.a(localDiyPendantEntity.uinAndDiyId.split("_")[0]);
  ...
  public void c(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      while (i < j)
      {
        DiyPendantEntity localDiyPendantEntity = (DiyPendantEntity)((awbw)localObject2).a(DiyPendantEntity.class, (String)((ArrayList)localObject1).get(i));
