  ...
  extends Dialog
{
  ...
  public bcqg(Context paramContext, Intent paramIntent)
  {
    super(paramContext, 2131755794);
    String str2 = paramIntent.getStringExtra("qzone_plugin_activity_name");
    Object localObject1 = LayoutInflater.from(paramContext).inflate(2131562087, null);
    ...
    this.a = ((TextView)((View)localObject1).findViewById(2131370458));
    ...
    for (;;)
    {
      ...
      {
        localObject3 = ((ViewStub)((View)localObject1).findViewById(2131376786)).inflate();
        localObject1 = paramIntent.getStringExtra("key_left_tab_title");
        if (!TextUtils.isEmpty((CharSequence)localObject1)) {
          break label917;
        }
        localObject1 = paramContext.getString(2131717644);
      }
      label917:
      for (;;)
      {
        ...
        for (paramContext = paramContext.getString(2131717725);; paramContext = paramIntent)
        {
          paramIntent = (ExtendButton)((View)localObject3).findViewById(2131363482);
          Object localObject4 = (ExtendButton)((View)localObject3).findViewById(2131363483);
          ...
          return;
          localObject4 = ((ViewStub)((View)localObject1).findViewById(2131364530)).inflate();
          ...
          if ("com.qzone.homepage.ui.activity.QZoneUserHomeActivity".equals(str2))
          {
            ...
            {
              localObject1 = ajyc.a(2131712200);
          ...
          for (;;)
          {
            ...
            {
              localObject1 = paramContext.getString(2131717870);
              localObject3 = paramContext.getString(2131717793);
            }
            ...
            {
              localObject1 = paramContext.getString(2131717768);
              localObject3 = localObject2;
            }
            else if ("com.qzone.detail.ui.activity.QzoneDetailActivity".equals(str2))
            {
              ...
              {
                localObject3 = paramContext.getString(2131699440);
                localObject1 = str1;
              }
            }
            else if ("com.qzone.publish.ui.activity.QZoneUploadPhotoRealActivity".equals(str2))
            {
              str1 = paramContext.getString(2131718248);
              ...
              if (!TextUtils.isEmpty(paramIntent))
              {
                ...
                for (;;)
                {
                  ...
                  case 8: 
                  case 11: 
                    localObject1 = paramContext.getString(2131718160);
                    localObject3 = localObject2;
                    break;
            ...
            {
              localObject1 = paramContext.getString(2131718187);
              localObject3 = localObject2;
            }
            else if ("com.qzone.setting.QZoneSettingManager".equals(str2))
            {
              localObject1 = paramContext.getString(2131718196);
              localObject3 = localObject2;
            }
            else if ("com.qzone.album.business.photolist.activity.QZonePersonalPhotoListActivity".equals(str2))
            {
              ...
              {
                localObject1 = paramIntent + ajyc.a(2131712199);
                localObject3 = localObject2;
              }
              else
              {
            ...
            {
              localObject1 = paramContext.getString(2131718112);
              localObject3 = localObject2;
            }
            else
            {
              ...
              {
                localObject1 = paramContext.getString(2131718001);
                localObject3 = localObject2;
              }
            }
          }
  ...
  public void setOnDismissListener(@Nullable DialogInterface.OnDismissListener paramOnDismissListener)
  {
    ...
    super.setOnDismissListener(new bcqh(paramOnDismissListener));
  }
}
