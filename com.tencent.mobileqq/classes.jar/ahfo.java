...
public class ahfo
  extends ahkz
{
  public ahfo(QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, FragmentActivity paramFragmentActivity, Context paramContext)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if ((localObject instanceof MessageForText))
        {
          paramString = "2";
          break label138;
          atyf.a("0", "1", "176", "969", "96902", "206999", paramString, "0", "20", (String)localObject);
        }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      atyf.a("0", "1", "176", "969", "96902", "206998", "", "0", "20", "0");
    }
  }
  ...
  public void onPanelIconClick(Object paramObject)
  {
    ...
    for (;;)
    {
      atyf.a("0", "1", "176", "969", "96902", paramObject, "", "0", "20", "0");
      return;
      if (i == 3) {
        paramObject = "206996";
      } else if (i == 24) {
  ...
  public void onShowFirst(int paramInt)
  {
    ...
    atyf.a("0", "1", "176", "969", "96901", "206994", "", "0", "7", "0");
  }
  ...
  public void refreshListAdapter()
  {
    ...
    if ((this.mSubTilteText != null) && (this.mContext != null))
    {
      String str = atyf.d;
      if (this.app != null) {
        str = ((atyd)this.app.getManager(358)).a();
      }
      this.mSubTilteText.setText(this.mContext.getString(2131697983) + str);
    }
  }
