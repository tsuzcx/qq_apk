...
public class pvw
{
    ...
    for (;;)
    {
      try
      {
        ...
        if (bkwm.a(paramInt))
        {
          ...
          localObject1 = (String)bkwm.a("DAILY_CHILD_FEEDS_REQUEST_CONFIG" + paramInt, "");
          ...
          if (bkwm.z()) {
            localJSONArray.put(bkwm.a());
          }
          localJSONArray.put(bkwm.b());
          return localJSONArray.toString();
        }
        Object localObject1 = ReadInJoyMMapKvStorage.getInstance().getValeForKey("KANDIAN_DAILY_SETTING_CONFIG");
        Object localObject3 = (String)bkwm.a("KANDIAN_DAILY_LCAOL_SETTING_CONFIG", "");
        if (TextUtils.isEmpty((CharSequence)localObject1)) {
          break label198;
        }
  ...
  public static pvw a(JSONObject paramJSONObject)
  {
    int j = 0;
    pvw localpvw = new pvw();
    if (paramJSONObject != null)
    {
      localpvw.jdField_a_of_type_JavaLangString = paramJSONObject.optString("key");
      localpvw.jdField_b_of_type_JavaLangString = paramJSONObject.optString("name");
      localpvw.d = paramJSONObject.optString("value");
      localpvw.c = paramJSONObject.optString("id");
      ...
      if (localObject != null)
      {
        ...
        while (i < ((JSONArray)localObject).length())
        {
          ...
          localpvw.jdField_b_of_type_JavaUtilList.add(str);
          i += 1;
        }
      }
      ...
      if (paramJSONObject != null)
      {
        ...
        while (i < paramJSONObject.length())
        {
          ...
          localpvw.jdField_a_of_type_JavaUtilList.add(localObject);
          i += 1;
        }
      }
    }
