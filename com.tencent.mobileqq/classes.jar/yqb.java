  ...
  implements View.OnTouchListener
{
  ...
  public static final int[] c = { 2130844533, 2130844536 };
  public static final int[] d = { 2131378494, 2131378495 };
  ...
  static
  {
    jdField_a_of_type_ArrayOfInt = new int[] { 2131363903, 2131363904 };
    jdField_b_of_type_ArrayOfInt = new int[] { 2130844532, 2130844535 };
  }
  
  public yqb(yqe paramyqe, View paramView, int paramInt)
  {
  ...
  public void a(CharSequence paramCharSequence)
  {
    ...
    for (CharSequence localCharSequence = this.jdField_a_of_type_AndroidWidgetTextView.getHint();; localCharSequence = paramCharSequence)
    {
      ...
      if (this.jdField_b_of_type_AndroidWidgetTextView.getVisibility() == 0)
      {
        ...
        k = UIUtils.dip2px(this.jdField_a_of_type_AndroidWidgetTextView.getContext(), 72.5F);
      ...
      for (;;)
      {
        ...
        break;
        label201:
        k = UIUtils.dip2px(this.jdField_a_of_type_AndroidWidgetTextView.getContext(), 84.0F);
      ...
      if ((n <= k) || (i == arrayOfFloat1.length - 1))
      {
        ...
        xvv.a("Q.qqstory.widget.PollWidgetUtils", "text size = %s", Float.valueOf(arrayOfFloat1[i]));
      }
      for (;;)
      {
        paramCharSequence = ypt.a(this.jdField_a_of_type_AndroidWidgetTextView, 2);
        this.jdField_a_of_type_AndroidWidgetTextView.setText(paramCharSequence);
  ...
  {
    if ((a()) || (this.jdField_a_of_type_Ypy == null) || (!this.jdField_a_of_type_Yqe.a())) {
