  ...
  implements ankr
{
  ...
  public anla(String paramString)
  {
  ...
  private void a()
  {
    ...
    try
    {
      ...
      this.jdField_c_of_type_AndroidGraphicsDrawableDrawable = localResources.getDrawable(2130846017);
      this.d = localResources.getDrawable(2130846018);
  ...
  public static void a(URLDrawable paramURLDrawable)
  {
    ...
    if (paramURLDrawable != null)
    {
      ...
      if ((localObject != null) && ((localObject instanceof GifDrawable)))
      {
        ...
        if ((localObject == null) || (!(localObject instanceof anmm))) {
          break label72;
        }
        ((anmm)localObject).b();
        ((anmm)localObject).a();
    ...
    do
    {
      ...
      {
        return;
      } while ((localObject == null) || (!(localObject instanceof anmn)));
      ((anmn)localObject).b();
      ((anmn)localObject).a();
      paramURLDrawable.invalidateSelf();
    } while (!QLog.isColorLevel());
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, Emoticon paramEmoticon, EmojiStickerManager.StickerInfo paramStickerInfo)
  {
    ...
    if (paramEmoticon.isNewSoundEmoticon()) {
      arnz.a(paramQQAppInterface, "0X800A932", paramSessionInfo.jdField_a_of_type_Int, paramEmoticon.epId);
    }
  ...
  private void a(QQAppInterface paramQQAppInterface, URL paramURL, EmoticonPackage paramEmoticonPackage, boolean paramBoolean, URLDrawable paramURLDrawable)
  {
    if (paramQQAppInterface != null)
    {
      ...
      if ((paramEmoticonPackage == null) && (!paramBoolean) && (this.jdField_a_of_type_ComTencentMobileqqDataEmoticon != null) && (!(paramURLDrawable.getCurrDrawable() instanceof ApngDrawable)))
      {
        ...
        paramQQAppInterface.a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId, new anlb(this, paramURL));
      }
    }
  }
  ...
  public static void b(URLDrawable paramURLDrawable)
  {
    if (paramURLDrawable != null)
    {
      ...
      if ((paramURLDrawable != null) && ((paramURLDrawable instanceof GifDrawable)))
      {
        ...
        if ((paramURLDrawable == null) || (!(paramURLDrawable instanceof anmm))) {
          break label61;
        }
        ((anmm)paramURLDrawable).b();
        if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      {
        return;
      } while ((paramURLDrawable == null) || (!(paramURLDrawable instanceof anmn)));
      ((anmn)paramURLDrawable).b();
    } while (!QLog.isColorLevel());
    QLog.d("PicEmoticonInfo", 2, "soundgif stopSoundDrawablePlay stop");
  }
  ...
  {
    aael.a(paramQQAppInterface, paramContext, paramSessionInfo, paramEmoticon, paramStickerInfo);
    paramSessionInfo = "";
    int m = -1;
    ...
    awqx.b(paramQQAppInterface, "CliOper", "", "", "ep_mall", "0X80057A9", 0, 0, paramEmoticon.epId, "", paramContext, paramEmoticon.eId);
  }
  ...
  private static void d(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, Emoticon paramEmoticon, EmojiStickerManager.StickerInfo paramStickerInfo)
  {
    ...
    awqx.b(paramQQAppInterface, "CliOper", "", "", "MbFasong", "MbIDDianji", 0, 0, paramEmoticon.epId, "", "", "");
    ((arnz)paramQQAppInterface.getManager(14)).a(paramEmoticon.epId, -1, new anle(paramContext, paramQQAppInterface, paramEmoticon, localanfj, paramSessionInfo, paramStickerInfo));
  }
  ...
  private static void e(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, Emoticon paramEmoticon, EmojiStickerManager.StickerInfo paramStickerInfo)
  {
    ...
    awqx.b(paramQQAppInterface, "CliOper", "", "", "ep_mall", "0X800579D", 0, 0, paramEmoticon.epId, "", "", "");
    localObject = (anfj)paramQQAppInterface.getManager(43);
    ((arnz)paramQQAppInterface.getManager(14)).a(paramEmoticon.epId, 0, new anlg(paramContext, paramQQAppInterface, paramEmoticon, (anfj)localObject, paramSessionInfo));
    c(paramQQAppInterface, paramContext, paramSessionInfo, paramEmoticon, paramStickerInfo);
  }
  ...
  public URLDrawable a()
  {
    ...
    {
      return localObject1;
      String str = anjd.q.replace("[epId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId).replace("[eId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.eId);
      localObject1 = localObject4;
      if (str == null) {
        continue;
      }
  ...
  public URLDrawable a(String paramString, boolean paramBoolean1, boolean paramBoolean2, adjt paramadjt)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqDataEmoticon == null) {}
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramadjt != null)
        {
          localObject1 = paramadjt.e.getDrawable();
          paramadjt = BaseApplicationImpl.getApplication().waitAppRuntime(null);
          if ((paramadjt instanceof QQAppInterface))
          {
            paramadjt = (QQAppInterface)paramadjt;
            ...
            if (paramadjt != null)
            {
              localObject1 = (arnz)paramadjt.getManager(14);
              if (this.jdField_a_of_type_ComTencentMobileqqDataEmoticon != null)
              {
                localObject1 = ((arnz)localObject1).b(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId, 0);
      ...
      catch (MalformedURLException paramString)
      {
        for (;;)
        {
          ...
          continue;
          a(paramadjt, paramString, (EmoticonPackage)localObject1, paramBoolean1, (URLDrawable)localObject2);
          continue;
          paramBoolean1 = false;
          continue;
  ...
  public URLDrawable a(String paramString, boolean paramBoolean1, boolean paramBoolean2, adjt paramadjt, int paramInt1, int paramInt2)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqDataEmoticon == null) {}
    for (;;)
    {
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, EditText paramEditText, SessionInfo paramSessionInfo, boolean paramBoolean, int paramInt)
  {
    ...
    do
    {
      ...
      {
        return;
        paramEditText = (anfj)paramQQAppInterface.getManager(43);
        if ((this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.jobType != 2) || (!paramBoolean) || ((!(paramContext instanceof SplashActivity)) && (!(paramContext instanceof ChatActivity))) || (!arhw.a())) {
          break label226;
        }
        if (paramEditText.a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId, Boolean.valueOf(false))) {
          break;
        }
        ChatActivityUtils.a(paramContext, 2131624423, 0);
        paramQQAppInterface = paramQQAppInterface.getHandler(ChatActivity.class);
      } while (paramQQAppInterface == null);
      paramQQAppInterface.obtainMessage(10).sendToTarget();
      paramQQAppInterface.obtainMessage(21).sendToTarget();
      return;
      paramInt = arhf.a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon, 0);
      if (QLog.isColorLevel()) {
        QLog.d("PicEmoticonInfo", 2, "forward,【maxInt:】" + paramInt);
      }
      paramInt = argh.a(paramInt);
      ((arnz)paramQQAppInterface.getManager(14)).a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId, new anlc(this, paramQQAppInterface, paramInt, paramContext, paramSessionInfo));
      return;
      ...
      for (;;)
      {
        aael.a(paramQQAppInterface, paramContext, paramSessionInfo, this.jdField_a_of_type_ComTencentMobileqqDataEmoticon, paramInt);
        return;
        if (QLog.isColorLevel()) {
  ...
  public boolean d()
  {
    ...
    Object localObject = anjd.s.replace("[epId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId).replace("[eId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.eId);
    if (localObject != null)
    {
    ...
    for (;;)
    {
      ...
      {
        localObject = anjd.o.replace("[epId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId).replace("[eId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.eId);
        if (localObject == null) {
          break label165;
        }
        localObject = new File((String)localObject);
  ...
  public boolean e()
  {
    ...
    {
      localObject = anjd.p.replace("[epId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId).replace("[eId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.eId);
      label52:
      if (localObject == null) {
        break label112;
      }
    ...
    {
      return bool;
      localObject = anjd.q.replace("[epId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId).replace("[eId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.eId);
      break label52;
      label112:
      break;
      label114:
