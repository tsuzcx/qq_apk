...
public class aquk
{
  public static List<ChatMessage> a(List<ChatMessage> paramList)
  {
    ...
    if (paramList != null)
    {
      ...
      while (paramList.hasNext())
      {
        ...
        if ((!akbm.j(localChatMessage.msgtype)) && (!acjz.a(localChatMessage))) {
  ...
  {
    arxu.a().jdField_a_of_type_Int = 7;
    ...
    do
    {
      ...
      if (paramIntent.size() > 0)
      {
        ...
        while (paramQQAppInterface.hasNext())
        {
          ...
          arxu.a().jdField_a_of_type_JavaUtilHashMap.put(localObject1, Boolean.valueOf(true));
        }
      }
