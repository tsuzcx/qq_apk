...
final class anrn
  implements bfka
{
  anrn(RockDownloaderTask paramRockDownloaderTask, boolean paramBoolean) {}
  ...
  public void onDownloadError(DownloadInfo paramDownloadInfo, int paramInt1, String paramString, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqBigbrotherRockDownloaderRockDownloaderTask.getRockDownloadListener().onDownloadFail(this.jdField_a_of_type_ComTencentMobileqqBigbrotherRockDownloaderRockDownloaderTask.getDownloadInfo(), alpo.a(2131713874), 10010);
    }
    for (;;)
    {
      this.jdField_a_of_type_ComTencentMobileqqBigbrotherRockDownloaderRockDownloaderTask.getRockDownloadListener().onDownloadFinish(this.jdField_a_of_type_ComTencentMobileqqBigbrotherRockDownloaderRockDownloaderTask.getDownloadInfo());
      paramString = (DownloadInfo)bfgi.a().a().remove(paramDownloadInfo.b);
      if (QLog.isColorLevel()) {
        QLog.d("RockDownloader", 2, new Object[] { "onDownloadError removedDownload=", paramString });
      }
      bfgg.a().a(paramDownloadInfo.b);
      anrl.a(this.jdField_a_of_type_ComTencentMobileqqBigbrotherRockDownloaderRockDownloaderTask, "0x800A1E6");
      bfgi.a().b(this);
      return;
      label200:
  ...
  public void onDownloadFinish(DownloadInfo paramDownloadInfo)
  {
    ...
    anrl.a(this.jdField_a_of_type_ComTencentMobileqqBigbrotherRockDownloaderRockDownloaderTask, paramDownloadInfo, this.jdField_a_of_type_Boolean);
    bfgi.a().b(this);
  }
