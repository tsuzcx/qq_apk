...
public class tke
{
  private static int a(List<BaseData> paramList)
  {
    ...
    while (i > 0)
    {
      ...
      if ((tjg.a(localBaseData)) && (localBaseData.r != 0))
      {
  ...
  public static void a(List<BaseData> paramList1, List<BaseData> paramList2)
  {
    ...
    if (paramList1 != null)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        if ((localBaseData.r == 9) || (localBaseData.r == 10) || (localBaseData.r == 11) || (localBaseData.r == 17)) {
    ...
    if ((paramList2 != null) && (paramList1 != null))
    {
      ...
      while (paramList2.hasNext())
      {
        ...
        if ((((BaseData)localObject1).r == 10) || (((BaseData)localObject1).r == 11) || (((BaseData)localObject1).r == 17))
        {
    ...
    if (paramList2 != null)
    {
      ...
      while (paramList2.hasNext())
      {
        ...
        if ((localObject instanceof ProteusItemData)) {
          tjm.a(paramArticleInfo, (ProteusItemData)localObject, 5, paramSparseArray);
        }
  ...
  public static void c(List<BaseData> paramList, List<CommentInfo> paramList1)
  {
    ...
    for (;;)
    {
      j += 1;
      break;
      QLog.d(tke.class.getSimpleName(), 2, "update comment data! size : " + i);
      return;
    }
  }
  ...
  private static void f(List<BaseData> paramList)
  {
    ...
    {
      localBaseData = (BaseData)localIterator.next();
      if ((localBaseData.r == 10) || (localBaseData.r == 17)) {
        localArrayList.add(localBaseData);
      }
    }
    for (;;)
