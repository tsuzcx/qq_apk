...
public class bqip
{
  public static Intent a(String paramString1, String paramString2, bqvl parambqvl, String paramString3, String paramString4)
  {
    Intent localIntent = new Intent();
    localIntent.putExtra("uin", parambqvl.jdField_a_of_type_JavaLangString);
    localIntent.putExtra("troop_uin", parambqvl.b);
    localIntent.putExtra("uintype", parambqvl.jdField_a_of_type_Int);
    localIntent.putExtra("from_uin_type", parambqvl.jdField_a_of_type_Int);
    ...
    String str = bhml.a(aunj.e(paramString1));
    if (str == null)
    {
      QLog.e("ShortVideoForwardManager", 1, "video file md5 compute fail");
      return null;
    }
    paramString3 = bhml.a(aunj.e(paramString2));
    ...
    parambqvl.g = str;
    parambqvl = new brkg();
    int i = brkf.a(paramString1, parambqvl);
    if (i != 0)
    {
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2, boolean paramBoolean, int paramInt, String paramString3)
  {
    ...
    String str2 = bhml.a(aunj.e(paramString1));
    if (str2 == null)
    {
      QLog.e("ShortVideoForwardManager", 1, "video file md5 compute fail");
      return;
    }
    String str1 = bhml.a(aunj.e(paramString2));
    if (str1 == null)
    {
      QLog.e("ShortVideoForwardManager", 1, "thumb file md5 compute fail");
      return;
    ...
    int i = brkf.a(paramString1, localbrkg);
    if (i != 0)
    {
      QLog.e("ShortVideoForwardManager", 1, new Object[] { "video file getRotationDegree fail, code:", Integer.valueOf(i) });
      return;
    ...
    if (TextUtils.isEmpty(paramString3))
    {
      ...
      {
        localIntent.putExtra("qq_camera_scheme", brdx.a(paramString1));
        localIntent.putExtra("widgetinfo", paramString1);
        paramString1 = paramActivity.getIntent().getStringExtra("key_camera_material_name");
        bpam.b("ShortVideoForwardManager", "gotoForwardShortVideoUI---activity=" + paramActivity + ", takeSameName=" + paramString1);
        if (TextUtils.isEmpty(paramString1)) {
          break label628;
        }
    ...
    if (((paramActivity instanceof PublicFragmentActivityForPeak)) || ((paramActivity instanceof QQBrowserActivity)))
    {
      ...
      for (;;)
      {
        if (paramActivity.getIntent() == null)
        {
          ...
          paramString3 = "";
          label691:
          bpam.b("ShortVideoForwardManager", "gotoForwardShortVideoUI---activity=" + paramActivity + ", takeSameName=" + paramString3);
        }
        try
        {
          if (paramString2.startsWith("http"))
          {
            ...
            localIntent.putExtra("qq_camera_scheme", brdx.a(paramString2));
            if (!TextUtils.isEmpty(paramString3))
            {
        ...
        catch (UnsupportedEncodingException paramString1)
        {
          for (;;)
          {
            ...
            continue;
            if ((!bhsr.a(paramString2)) && (!bhsr.a(paramString1)))
            {
  ...
  public static void a(Activity paramActivity, String paramString1, boolean paramBoolean1, boolean paramBoolean2, String paramString2, String paramString3)
  {
    ...
    if (!TextUtils.isEmpty(paramString2))
    {
      ...
      if ((paramActivity != null) && (paramActivity.getIntent() != null))
      {
        ...
        if (paramString2 != null)
        {
          ...
          bpam.b("ShortVideoForwardManager", "gotoForwardPicUI---activity=" + paramActivity + ", takeSameName=" + paramString2);
          if (TextUtils.isEmpty(paramString2)) {
            break label485;
          }
    ...
    for (;;)
    {
      ...
      auxu.a(paramActivity, "caller_aecamera", localIntent, 21, 100200);
      return;
      if (!paramBoolean2) {
        break;
      }
      localIntent.putExtra("forward_summary_extra", anzj.a(2131712913));
      break;
      label485:
      localIntent.putExtra("qq_camera_top_title", "魔法视频");
    }
    label500:
    auxu.a(paramActivity, localIntent, 21, 100200);
  }
}
