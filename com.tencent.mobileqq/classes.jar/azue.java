...
public abstract class azue
  implements DownloadParams.DecodeHandler
{
  public static final DownloadParams.DecodeHandler a;
  private static String a;
  public static final DownloadParams.DecodeHandler b = new azuq();
  public static final DownloadParams.DecodeHandler c = new azuv();
  public static final DownloadParams.DecodeHandler d = new azuw();
  public static final DownloadParams.DecodeHandler e = new azux();
  public static final DownloadParams.DecodeHandler f = new azuy();
  public static final DownloadParams.DecodeHandler g = new azuz();
  public static final DownloadParams.DecodeHandler h = new azva();
  public static final DownloadParams.DecodeHandler i = new azvb();
  public static final DownloadParams.DecodeHandler j = new azug();
  public static final DownloadParams.DecodeHandler k = new azuh();
  public static final DownloadParams.DecodeHandler l = new azui();
  public static final DownloadParams.DecodeHandler m = new azuj();
  public static final DownloadParams.DecodeHandler n = new azuk();
  public static final DownloadParams.DecodeHandler o = new azul();
  public static final DownloadParams.DecodeHandler p = new azum();
  public static final DownloadParams.DecodeHandler q = new azun();
  public static final DownloadParams.DecodeHandler r = new azuo();
  public static final DownloadParams.DecodeHandler s = new azvc(10);
  public static final DownloadParams.DecodeHandler t = new azvc(20);
  public static final DownloadParams.DecodeHandler u = new azup();
  public static final DownloadParams.DecodeHandler v = new azur();
  public static final DownloadParams.DecodeHandler w = new azvd();
  public static final DownloadParams.DecodeHandler x = new azus();
  public static final DownloadParams.DecodeHandler y = new azut();
  public static final DownloadParams.DecodeHandler z = new azuu();
  
  static
  {
    jdField_a_of_type_JavaLangString = "URLDrawableDecodeHandler";
    jdField_a_of_type_ComTencentImageDownloadParams$DecodeHandler = new azuf();
  }
