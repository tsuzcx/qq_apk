...
{
  public bfar(OpenAuthorityFragment paramOpenAuthorityFragment) {}
  ...
  public void onFailed(String paramString, int paramInt1, int paramInt2, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      bfja.a().a(1, "LOGIN_GETTICKT", paramString, OpenAuthorityFragment.a(this.a), null, Long.valueOf(SystemClock.elapsedRealtime()), paramInt1, 1, str);
      bfdq.a().a(paramString, "", OpenAuthorityFragment.a(this.a), "1", "1", "" + paramInt1, false);
      bfdq.a().a(paramString, "", OpenAuthorityFragment.a(this.a), "1", "6", "" + paramInt1, false);
      ...
      if ((paramInt2 == -1000) || (paramInt2 == 154))
      {
        ...
        bfhg.c("Authority_TimeCost", "<TimeStamp> login cost : " + (this.a.e - this.a.d));
  ...
  public void onGetTicketNoPasswd(String paramString, byte[] paramArrayOfByte, int paramInt, Bundle paramBundle)
  {
    ...
    if (!bool)
    {
      ...
      bfdq.a().a((Bundle)localObject, OpenAuthorityFragment.a(this.a), paramString, false);
    ...
    try
    {
      ...
      bfja.a().a(0, "LOGIN_GETTICKT", paramString, OpenAuthorityFragment.a(this.a), null, Long.valueOf(SystemClock.elapsedRealtime()), i, 1, null);
      bfdq.a().a(paramString, "", OpenAuthorityFragment.a(this.a), "1", "1", "0", false);
      this.a.i = false;
      this.a.b = 0;
      localObject = null;
      if (paramInt == 4096) {
