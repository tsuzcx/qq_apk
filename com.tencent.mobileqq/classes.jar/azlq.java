...
public class azlq
{
  ...
  public azlm a;
  private azls jdField_a_of_type_Azls;
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  public PinnedFooterExpandableListView a;
  private String jdField_a_of_type_JavaLangString = "";
  private ArrayList<auko> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private HashMap<String, Long> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private ArrayList<auko> b = new ArrayList();
  
  public azlq(QQAppInterface paramQQAppInterface, PinnedFooterExpandableListView paramPinnedFooterExpandableListView, azls paramazls)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_ComTencentWidgetPinnedFooterExpandableListView = paramPinnedFooterExpandableListView;
    this.jdField_a_of_type_Azls = paramazls;
    this.jdField_a_of_type_Azlm = new azlm(paramQQAppInterface);
  }
  ...
  private void e()
  {
    ...
    if (localazoc != null)
    {
      ArrayList localArrayList1 = this.jdField_a_of_type_Azls.a();
      if (localArrayList1 != null)
      {
        ...
        localazoc.a(localArrayList2, new azlr(this));
      }
    }
  }
  ...
  public View a(int paramInt1, int paramInt2, View paramView, ViewGroup paramViewGroup, Context paramContext, View.OnClickListener paramOnClickListener, RelationTroopEntity paramRelationTroopEntity)
  {
    if (paramView == null)
    {
      paramView = LayoutInflater.from(paramContext).inflate(2131560142, paramViewGroup, false);
      paramViewGroup = new azku();
    ...
    {
      paramContext = bayh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt1, paramRelationTroopEntity.troopInfo.troopuin, 3, bayh.a(4, 3), bayh.a(4, 3));
      ...
      return paramView;
      paramViewGroup = (azku)paramView.getTag();
  ...
  public void a()
  {
    axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_create", "", "grptab", "friendlist_exp", a(), 0, "", "", "", "");
  }
  ...
  public void a(ArrayList<Groups> paramArrayList, SparseArray<ArrayList<auko>> paramSparseArray)
  {
    if (QLog.isColorLevel()) {
    ...
    if (!this.b.isEmpty())
    {
      ...
      ((Groups)localObject2).group_name = ajya.a(2131718700);
    ...
    if (!this.jdField_a_of_type_JavaUtilArrayList.isEmpty())
    {
      ...
      ((Groups)localObject1).group_name = ajya.a(2131718699);
  ...
  public View b(int paramInt1, int paramInt2, View paramView, ViewGroup paramViewGroup, Context paramContext, View.OnClickListener paramOnClickListener, RelationTroopEntity paramRelationTroopEntity)
  {
    ...
    for (paramInt1 = 4;; paramInt1 = 113)
    {
      ...
      paramViewGroup.d.setText(paramContext);
      return paramView;
      paramViewGroup = (aiez)paramView.getTag();
      paramViewGroup.d.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
      break;
    }
  }
  ...
  public void b()
  {
    axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_create", "", "grptab", "friendlist_clk", a(), 0, "", "", "", "");
  }
  
  public void c()
  {
    axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_create", "", "grptab", "grplist_exp", a(), 0, "", "", "", "");
  }
  
  public void d()
  {
    axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_create", "", "grptab", "grplist_clk", a(), 0, "", "", "", "");
  }
}
