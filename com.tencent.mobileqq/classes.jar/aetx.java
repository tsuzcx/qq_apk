...
public class aetx
  extends akil
{
  public aetx(TroopChatPie paramTroopChatPie) {}
  ...
  protected void a(int paramInt1, int paramInt2)
  {
    if ((paramInt1 == 9) && (this.a.af)) {
      bcql.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 1, ajya.a(2131715276), 0).a();
    }
  }
  ...
  protected void a(int paramInt1, int paramInt2, String paramString)
  {
    if ((paramInt1 == 2) || (paramInt1 == 9))
    {
      if (paramInt2 == 0)
      {
        ...
        String str = ajya.a(2131715281);
        if (this.a.af) {
          str = ajya.a(2131715279);
        }
        bcql.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 2, str, 0).a();
        str = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c();
        TroopChatPie.a(this.a, paramString, str);
        ((akhp)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a().a(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      }
    }
    else {
      return;
    }
    bcql.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 1, ajya.a(2131715274), 0).a();
  }
  
  protected void a(azrw paramazrw)
  {
    if (QLog.isColorLevel()) {
      QLog.d(this.a.jdField_a_of_type_JavaLangString, 2, "onPushTroopEnterEffect: troopUin = " + paramazrw.b + ", data.id = " + paramazrw.jdField_a_of_type_Int);
    }
    ...
    paramazrw = this.a.a();
    paramazrw.a(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    paramazrw.a();
  }
  ...
  {
    if (!bbbr.a(String.valueOf(paramLong1), this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) {}
    do
    {
      return;
      if (QLog.isColorLevel())
  ...
  protected void a(boolean paramBoolean, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      localHashMap.put("netType", bbfj.a(BaseApplication.getContext()) + "");
      axrn.a(BaseApplication.getContext()).a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "multiMsgNickTimeoutR", false, 30000L, 0L, localHashMap, "");
      do
      {
        return;
        if (paramBoolean) {
        ...
        i = 1;
        break;
        if ((this.a.c != null) && (asua.a().jdField_a_of_type_Int != 2)) {
          this.a.c.dismiss();
        }
        asua.a().b.clear();
      ...
      if (asua.a().jdField_a_of_type_Int == 6)
      {
        ((adil)TroopChatPie.a(this.a).a(11)).a((Map)paramObject, asua.a().jdField_a_of_type_JavaUtilArrayList, asua.a().jdField_a_of_type_Int);
        return;
      }
      ((adio)TroopChatPie.b(this.a).a(1)).a((Map)paramObject, asua.a().jdField_a_of_type_JavaUtilArrayList, asua.a().jdField_a_of_type_Int);
      return;
      label405:
      i = 0;
    }
  ...
  protected void a(boolean paramBoolean, String paramString, int paramInt, List<String> paramList)
  {
    ...
    if ((paramBoolean) && (barb.a(paramInt)) && (paramString.equalsIgnoreCase((String)localObject)))
    {
      if ((paramInt != 2) && (paramInt != 3) && (paramInt != 1) && (paramInt != 5)) {
        break label129;
      }
      paramList = (adjl)this.a.a(28);
      if (paramList != null) {
    ...
    for (;;)
    {
      ...
      if ((paramInt == 4) && (paramList != null) && (paramList.size() > 0))
      {
        if (!this.a.am)
        {
          ...
          localObject = (adjl)this.a.a(28);
          if (localObject != null) {
            ((adjl)localObject).a(paramBoolean, paramString);
          }
        }
  ...
  protected void a(boolean paramBoolean, String paramString, long paramLong1, long paramLong2)
  {
    ...
    if (i != 0) {
      new baas(this.a.jdField_a_of_type_AndroidContentContext, "3171", "libWXVoice.so", "WXVoice").a();
    }
  ...
  protected void a(boolean paramBoolean, String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    if ((this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString.equals(paramString1)) && (this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin().equals(paramString2)) && (paramInt1 == 1) && (paramInt2 == 0))
    {
      ...
      axqy.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_AIO", "", "AIOchat", "Get_history", 0, 0, paramString1, "", "", "");
      if (QLog.isColorLevel()) {
  ...
  protected void a(boolean paramBoolean, String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, int paramInt4, String paramString3, String paramString4)
  {
    if (paramBoolean)
    {
      if (paramInt4 == 0)
      {
        myb.a().a(paramString1, paramInt2, paramInt1, paramString2, paramInt3, null, paramString4);
    ...
    this.a.a(1, this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131690054));
  }
  ...
  protected void a(boolean paramBoolean, String paramString1, String paramString2, int paramInt, String paramString3, String paramString4)
  {
    ...
    {
      if ((!bahy.a(paramInt)) && (TroopChatPie.a(this.a) != null) && ((TroopChatPie.a(this.a).a instanceof badx))) {
        ((badx)TroopChatPie.a(this.a).a).b(this.a);
      }
  ...
  protected void a(boolean paramBoolean1, String paramString, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      baiy.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      return;
    }
  }
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2, List<batf> paramList, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        localbatf = (batf)paramList.next();
        if (!TextUtils.equals(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, localbatf.jdField_a_of_type_JavaLangString)) {
          continue;
        }
        if (localbatf.jdField_a_of_type_Long == 1104445552L)
        {
          if (QLog.isColorLevel()) {
            QLog.d(this.a.jdField_a_of_type_JavaLangString, 2, new Object[] { "onUpdateTroopUnreadMsg homework. num=", Integer.valueOf(localbatf.b) });
          }
          ...
          if ((TroopChatPie.a(this.a) != null) && ((TroopChatPie.a(this.a).a instanceof badx))) {
            ((badx)TroopChatPie.a(this.a).a).a(false, this.a);
          }
        }
      }
      for (;;)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d(this.a.jdField_a_of_type_JavaLangString, 2, "receive troop album  red dot, push=" + paramBoolean2 + ", num=" + localbatf.b);
        }
        Message localMessage = TroopChatPie.c(this.a).obtainMessage(85);
        localMessage.arg1 = localbatf.b;
        localMessage.sendToTarget();
        break label72;
        break;
        label328:
        if (localbatf.jdField_a_of_type_Long == 1106611799L)
        {
          if (QLog.isColorLevel()) {
            QLog.d(this.a.jdField_a_of_type_JavaLangString, 2, "receive game feed red dot, push=" + paramBoolean2 + ", num=" + localbatf.b);
          }
  ...
  protected void c(String paramString1, String paramString2)
  {
    if (this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString.equals(paramString1))
    {
      List localList = this.a.jdField_a_of_type_Acup.a();
      ...
      paramString1 = ((bamg)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(152)).a(paramString1, paramString2);
      if (paramString1 != null)
      {
  ...
  protected void c(boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    {
      paramString2 = (batp)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(234);
  ...
  {
    if ((this.a.N) || (this.a.jdField_a_of_type_Batg == null)) {}
    boolean bool1;
    boolean bool2;
    do
    {
      ...
      bool1 = ((aruh)this.a.a(33)).c();
      bool2 = ((adji)this.a.a(43)).c();
    } while ((this.a.V) || (bool1) || (bool2));
    if (!paramBoolean)
    {
      this.a.jdField_a_of_type_Batg.a(2);
      return;
    }
    paramString2 = ((batp)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(234)).a(paramString1);
    if (!TextUtils.isEmpty(paramString2))
    {
      this.a.c(true);
      this.a.f.setText(paramString2);
    }
    if (this.a.jdField_a_of_type_Batg != null)
    {
      this.a.jdField_a_of_type_Batg.a(paramString1);
      if (this.a.jdField_a_of_type_Batg.a())
      {
        this.a.jdField_a_of_type_Batg.d();
        TroopChatPie.a(this.a, true);
        return;
      }
      this.a.jdField_a_of_type_Batg.a(0);
  ...
  protected void d(boolean paramBoolean, String paramString, List<TroopAIONotifyItem> paramList)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (this.a.jdField_a_of_type_Azno == null);
      bool1 = this.a.jdField_a_of_type_Azno.a();
      bool2 = this.a.jdField_a_of_type_Azno.d();
      int j = 0;
      int i = j;
      if (paramList != null)
      {
        ...
        if (paramList.size() > 0)
        {
          this.a.jdField_a_of_type_Azno.a(paramList);
          i = j;
          if (!bool2)
          {
            i = j;
            if (!bool1)
            {
              this.a.jdField_a_of_type_Azno.f();
              i = 1;
            }
          }
        }
