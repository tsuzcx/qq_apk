...
public class hy
  extends QIPCModule
{
  private static hy jdField_a_of_type_Hy;
  ...
  private VasQuickUpdateManager.CallBacker jdField_a_of_type_ComTencentMobileqqVasVasQuickUpdateManager$CallBacker = new hz(this);
  ...
  public static hy a()
  {
    try
    {
      if (jdField_a_of_type_Hy == null) {
        jdField_a_of_type_Hy = new hy("VasFontIPCModule");
      }
      hy localhy = jdField_a_of_type_Hy;
      return localhy;
    }
    finally {}
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    do
    {
          ...
          do
          {
            do
            {
              ...
              if (jdField_c_of_type_JavaLangString.equals(paramString))
              {
                ...
                ((ho)localQQAppInterface.getManager(42)).a(k, Integer.toString(paramInt), m);
                return null;
              }
            ...
            ((VasQuickUpdateManager)localQQAppInterface.getManager(184)).downloadItem(1004L, VasQuickUpdateManager.SCID_COLORFONT_SO, "VasFontIPCModule");
            return null;
      ...
      if (i.equals(paramString))
      {
        ...
        paramString.putInt("key_shield_font", ia.a);
