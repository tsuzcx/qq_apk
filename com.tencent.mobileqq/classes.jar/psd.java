  ...
  extends WebViewPlugin
{
  ...
  private void a(int paramInt, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      catch (JSONException localJSONException)
      {
        ...
        this.jdField_a_of_type_Aasb.a(localJSONObject, paramIntent, new psi(this, str));
      }
    }
  }
  ...
  private void a(@NotNull JSONObject paramJSONObject)
  {
    ...
    try
    {
      localObject2 = new String(bhkv.decode((String)localObject1, 0));
    ...
    try
    {
      str1 = new String(bhkv.decode((String)localObject2, 0));
      localObject2 = str1;
    }
    ...
    if (str4.isEmpty())
    {
      ...
      paramJSONObject.putExtra("comment_create_data", (Parcelable)localObject1);
      PublicTransFragmentActivity.b(this.mRuntime.a(), paramJSONObject, ReadInJoyCommentComponentFragment.class, birz.a(10, 136));
      return;
    }
  }
  ...
  private void a(JSONObject paramJSONObject, String paramString)
  {
    ...
    a(asev.a("ipc_kandian_socialfeeds_update", paramString, 0, this.jdField_a_of_type_AndroidOsBundle), false, false);
  }
  
  private boolean a(String[] paramArrayOfString)
  {
    if (this.jdField_a_of_type_Uav == null) {
      this.jdField_a_of_type_Uav = new uav(this, this.jdField_a_of_type_Aasb);
    }
    if (paramArrayOfString == null) {
      return true;
    }
    this.jdField_a_of_type_Uav.a(paramArrayOfString[0]);
    return false;
  }
  ...
  {
    String str = Aladdin.getConfig(paramJSONObject.optInt("id")).getString(paramJSONObject.optString("key", ""), "");
    try
    {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.e("ReadInJoyWebviewPlugin", 2, "Error in value:" + str);
      }
      return;
    }
    JSONObject localJSONObject = new JSONObject();
    localJSONObject.put("value", str);
    callJs(paramJSONObject, new String[] { localJSONObject.toString() });
  }
  ...
  private void c(JSONObject paramJSONObject)
  {
    ...
    catch (Exception paramJSONObject)
    {
      try
      {
        ...
        this.jdField_a_of_type_Aasb.a(str3, l1, (String)localObject, str1, l2, l3, i, new pse(this, str2));
  ...
  private void d(JSONObject paramJSONObject)
  {
    ...
    catch (JSONException paramJSONObject)
    {
      try
      {
        ...
        this.jdField_a_of_type_Aasb.a(str2, l1, str3, str4, l2, l3, new psf(this, str1));
  ...
  private void e(JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Aasb.i(new psg(this, paramJSONObject));
      return;
    }
    catch (JSONException paramJSONObject)
    {
  ...
  private void f(JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      localObject = str2;
      this.jdField_a_of_type_Aasb.e(str3, str1, new psh(this, str2));
      localObject = str2;
  ...
  public void a()
  {
    ...
    a(asev.a("ipc_kandian_socialfeeds_update", "", 0, this.jdField_a_of_type_AndroidOsBundle), false, false);
  }
  ...
  protected void a(Bundle paramBundle, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      if (paramBoolean2) {
        Toast.makeText(this.mRuntime.a().getApplicationContext(), anzj.a(2131711699), 0).show();
      }
      return;
    }
    if (paramBoolean1)
  ...
  public void onActivityResult(Intent paramIntent, byte paramByte, int paramInt)
  {
    ...
    do
    {
      ...
      } while (this.jdField_a_of_type_Uav == null);
      this.jdField_a_of_type_Uav.a(paramIntent, paramByte, paramInt);
      return;
    } while (paramByte != 10);
