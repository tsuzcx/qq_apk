...
public class agfl
{
  ...
  private agew jdField_a_of_type_Agew;
  private agex jdField_a_of_type_Agex;
  ...
  private agey[] jdField_a_of_type_ArrayOfAgey;
  private String b;
  private String c;
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    bctj.a(BaseApplication.getContext()).a(null, "pttSliceToText", true, 0L, 0L, localHashMap, "");
  }
  ...
  private void a(String paramString1, String paramString2, byte paramByte)
  {
    ...
    //   48: astore_1
    //   49: iload_3
    //   50: invokestatic 148	bgrn:a	(B)I
    //   53: istore 5
    //   55: new 150	com/tencent/mobileqq/utils/SilkCodecWrapper
    //   58: dup
    //   59: aload_0
    //   60: getfield 66	agfl:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   80: astore 10
    //   82: iload 5
    //   84: invokestatic 162	bgrn:a	(I)I
    //   87: istore 4
    //   89: aload_2
    //   90: astore 8
    //   92: aload_1
    ...
    //   191: astore 10
    //   193: aload_0
    //   194: getfield 173	agfl:jdField_a_of_type_Boolean	Z
    //   197: ifeq +91 -> 288
    //   200: aload_2
    //   201: astore 7
    //   203: aload_1
    ...
    //   342: astore 10
    //   344: aload_0
    //   345: getfield 173	agfl:jdField_a_of_type_Boolean	Z
    //   348: ifeq -60 -> 288
    //   351: aload_2
    //   352: astore 8
    //   354: aload_1
    ...
    //   359: astore 10
    //   361: aload 15
    //   363: invokestatic 188	bgrn:a	([B)I
    //   366: istore 5
    //   368: iload 5
    //   370: ifgt +133 -> 503
    //   373: aload_2
    ...
    //   521: astore 10
    //   523: aload_0
    //   524: getfield 173	agfl:jdField_a_of_type_Boolean	Z
    //   527: ifeq -239 -> 288
    //   530: aload_2
    //   531: astore 8
    //   533: aload_1
    ...
    //   700: astore 10
    //   702: aload_0
    //   703: getfield 173	agfl:jdField_a_of_type_Boolean	Z
    //   706: ifeq -418 -> 288
    //   709: aload_2
    //   710: astore 8
    //   712: aload_1
  ...
  public byte a(String paramString)
  {
    ...
    //   14: astore_1
    //   15: aload 4
    //   17: invokestatic 238	bgrn:a	(Ljava/io/InputStream;)B
    //   20: istore_2
    //   21: iload_2
    //   22: istore_3
    //   23: aload 4
  ...
  public String a(agey paramagey, int paramInt)
  {
    this.jdField_a_of_type_ArrayOfAgey[paramInt] = paramagey;
    paramagey = new StringBuffer();
    paramInt = 0;
    for (;;)
    {
      agey localagey;
      if (paramInt < this.jdField_a_of_type_ArrayOfAgey.length)
      {
        localagey = this.jdField_a_of_type_ArrayOfAgey[paramInt];
        if (localagey != null) {
          break label42;
        }
      }
      ...
      do
      {
        return paramagey.toString();
        paramagey.append(localagey.jdField_a_of_type_JavaLangString);
      } while (!localagey.jdField_a_of_type_Boolean);
      paramInt += 1;
    }
  }
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_Bdzi.d(this.c, ((Long)this.jdField_a_of_type_JavaUtilList.get(i)).longValue());
      i += 1;
    }
  ...
  public void a(agey paramagey, int paramInt)
  {
    if ((this.jdField_a_of_type_ArrayOfAgey == null) || (paramInt >= this.jdField_a_of_type_ArrayOfAgey.length) || ((this.jdField_a_of_type_ArrayOfAgey[paramInt] != null) && (this.jdField_a_of_type_ArrayOfAgey[paramInt].jdField_a_of_type_Boolean)))
    {
      if (QLog.isColorLevel()) {
    ...
    this.jdField_a_of_type_Agex.a(a(paramagey, paramInt));
  }
  
  public void a(String paramString)
  {
    bjda.a(new VoiceTextEdtiController.2(this, paramString));
  }
  
  public void a(String paramString1, QQAppInterface paramQQAppInterface, agex paramagex, int paramInt, String paramString2)
  {
    this.b = paramString1;
    this.jdField_a_of_type_Agex = paramagex;
    ...
    this.jdField_a_of_type_Bdzm = new agfm(this);
    this.jdField_a_of_type_Bdzm.addFilter(new Class[] { bdxi.class });
  }
  ...
  {
    bjda.a(new VoiceTextEdtiController.3(this, paramString));
  }
