...
public class anxz
{
  private static anxz jdField_a_of_type_Anxz = new anxz();
  ...
  private anxz()
  {
    ...
    if (!AppSetting.f().equals(localObject2))
    {
      ...
      bfyz.a((SharedPreferences.Editor)localObject2);
  ...
  public static anxz a()
  {
    return jdField_a_of_type_Anxz;
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_Boolean)
        {
          ...
          bfyz.a((SharedPreferences.Editor)localObject1);
          this.jdField_d_of_type_Int = 0;
          bool2 = bool1;
          continue;
        }
