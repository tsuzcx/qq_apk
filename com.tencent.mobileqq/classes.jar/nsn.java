...
{
  nsn(QQAppInterface paramQQAppInterface, oag paramoag, int paramInt, String paramString) {}
      ...
      try
      {
        ...
        if (paramBundle != null)
        {
          ...
          if (((mobileqq_mp.RetInfo)((mobileqq_mp.SetFunctionFlagResponse)localObject).ret_info.get()).ret_code.get() == 0)
          {
            ...
            this.jdField_a_of_type_Oag.d = this.jdField_a_of_type_Int;
            paramBundle = null;
            localObject = (aody)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(56);
            if (localObject != null) {
              paramBundle = ((aody)localObject).a(this.jdField_a_of_type_JavaLangString);
            }
            if (paramBundle != null)
            {
              if (this.jdField_a_of_type_Oag.e == 6)
              {
                ...
                localPublicAccountHandler.notifyUI(109, true, this.jdField_a_of_type_Oag);
                return;
              }
              if (this.jdField_a_of_type_Oag.e != 3) {
                continue;
              }
              paramBundle.isSyncLbs = true;
              if (this.jdField_a_of_type_Oag.d != 1) {
                break label315;
              }
              paramBoolean = true;
          ...
          {
            localPublicAccountHandler.notifyUI(109, false, this.jdField_a_of_type_Oag);
          }
        }
        else
        {
