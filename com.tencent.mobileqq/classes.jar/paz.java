...
public class paz
  extends Handler
{
  public paz(TroopMemberApiService paramTroopMemberApiService) {}
  ...
  public void handleMessage(Message paramMessage)
  {
                            ...
                            if (localObject3 != null)
                            {
                              ...
                              if (this.a.jdField_a_of_type_ComTencentMobileqqAppTroopHandler != null)
                              {
                                ...
                                if (this.a.jdField_a_of_type_ComTencentMobileqqAppTroopHandler != null)
                                {
                                  ...
                                  {
                                    this.a.jdField_a_of_type_ComTencentMobileqqAppBizTroopHandler.b((String)localObject1, bool);
                                    continue;
                                    localObject1 = ((Bundle)localObject3).getString("troopUin");
                                    bool = ((Bundle)localObject3).getBoolean("isChecked");
                                    if (this.a.jdField_a_of_type_ComTencentMobileqqAppBizTroopHandler != null)
                                                      ...
                                                      if (localObject3 != null)
                                                      {
                                                        ...
                                                        if ((!TextUtils.isEmpty((CharSequence)localObject1)) && (!TextUtils.isEmpty((CharSequence)localObject5))) {
                                                          ...
                                                          else if (((String)localObject1).equals("g_troop_reward"))
                                                          {
                                                            ...
                                                            continue;
                                                            if (!TroopMemberApiService.a((AppRuntime)localObject4, new pba(this, (Bundle)localObject3)))
                                                            {
    ...
    for (;;)
    {
        ...
        if ((((TroopAppMgr)localObject1).a(0)) && (!((TroopAppMgr)localObject1).b(0)))
        {
          ...
          if ((localObject4 != null) && (!((List)localObject4).isEmpty()))
          {
            ...
            while (((Iterator)localObject4).hasNext())
            {
              ...
              {
                QQToast.a(BaseApplication.getContext(), 2, 2131433204, 0).b(this.a.getResources().getDimensionPixelSize(2131558448));
                return;
              }
            }
          }
      ...
      for (;;)
      {
        ...
        localObject2 = (QQAppInterface)localObject4;
        QQAppInterface.b = i;
        ThreadManager.executeOnSubThread(new pbd(this, i));
        break label616;
        localObject2 = ((Bundle)localObject3).getString("troopUin");
        ...
        ((TroopPluginManager)localObject2).a("troop_manage_plugin.apk", new pbe(this, (String)localObject4, i, (String)localObject3));
        break label616;
        ...
        if (localObject3 != null)
        {
          if (j == 0)
          {
            ...
            ((TroopTopicMgr)localObject5).a((ChatMessage)localObject3, 2, new pbf(this, j, i));
            break label616;
          }
        ...
        i = ((Bundle)localObject3).getInt("seq");
        ThreadManager.post(new pbh(this, (TroopManager)((AppRuntime)localObject4).getManager(51), (String)localObject2, (String)localObject5, (Bundle)localObject3, i), 8, null, true);
        break label616;
        localObject2 = new Bundle();
        ...
        for (;;)
        {
          ((DownloaderInterface)localObject3).a(new DownloadTask("http://pub.idqqimg.com/pc/misc/nearby/nearby_heart.gif", (File)localObject4), new pbi(this, (Bundle)localObject2), new Bundle());
          break;
        ...
        HuanjiPluginProxy.a().a((String)localObject2, i, (String)localObject4, new pbj(this, (Bundle)localObject3, i));
        break label616;
        ...
        if (bool)
        {
          ...
          ShortVideoResourceManager.a((QQAppInterface)localObject4, new pbk(this, (AppRuntime)localObject4, (Bundle)localObject3));
          break label616;
        }
        ...
        localObject3 = new pbb(this, (Bundle)localObject3);
        ...
        for (localObject2 = ((FragmentActivity)localObject2).getChatFragment(); localObject2 != null; localObject2 = null)
        {
          ...
          break;
          l1 = ((Bundle)localObject3).getLong("followUin");
          i = ((Bundle)localObject3).getInt("followInfo");
          if ((i != 2) && (i != 1)) {
            break;
          }
          ...
          for (bool = true;; bool = false)
          {
            ...
            ThreadManager.post(new pbc(this, l1, i), 8, null, true);
            break;
          }
        }
        bool = false;
