...
public class pku
  extends pko<String, DynamicChannelDataModel>
{
  private pkt a;
  
  public pku(Activity paramActivity, RecyclerViewWithHeaderFooter paramRecyclerViewWithHeaderFooter, int paramInt)
  {
    super(paramActivity, paramRecyclerViewWithHeaderFooter, paramInt);
    this.jdField_a_of_type_Pkt = new pkt();
    this.jdField_a_of_type_Pkt.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, 0);
  }
  ...
  {
    if (this.jdField_a_of_type_Pkt.a(paramInt))
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        return new pkv(this, (View)localObject);
      }
  ...
  public void a(bkrv parambkrv, int paramInt)
  {
    ...
    {
      if (!this.jdField_a_of_type_Pkt.a(i)) {
        break label156;
      }
      if (i != pkl.b) {
        break label136;
    ...
    for (;;)
    {
      ...
      return;
      label136:
      this.jdField_a_of_type_Pkt.a(localProteusItemView, i, localDynamicChannelDataModel, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, paramInt);
      continue;
      label156:
  ...
  public int getItemViewType(int paramInt)
  {
    ...
    {
      paramInt = i;
      if (this.jdField_a_of_type_Pkt.a((DynamicChannelDataModel)localObject))
      {
        i = this.jdField_a_of_type_Pkt.a((DynamicChannelDataModel)localObject);
