...
public class nok
{
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (localObject != null)
    {
      localObject = ((aody)localObject).c(paramString);
      if (localObject != null) {
        break label69;
      }
      paramQQAppInterface = (anxb)paramQQAppInterface.getManager(69);
  ...
  public static Intent a(Context paramContext, Intent paramIntent, String paramString, boolean paramBoolean1, int paramInt1, boolean paramBoolean2, int paramInt2)
  {
    try
    {
      bool = ((bkgt)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(165)).c(paramString, false);
      if (bool) {
        if (paramIntent == null)
        {
  ...
  public static String a(QQAppInterface paramQQAppInterface, String paramString)
  {
    String str = "";
    if (!TextUtils.isEmpty(paramString)) {
      if (bkgt.b(paramQQAppInterface, paramString))
      {
    ...
    for (;;)
    {
      ...
      if (localObject != null)
      {
        ...
        if (paramQQAppInterface != null)
        {
          paramQQAppInterface = ((anxb)paramQQAppInterface).a(paramString);
          if (paramQQAppInterface != null) {
  ...
  private static void a(int paramInt, bjbs parambjbs)
  {
    b(paramInt, parambjbs);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo)
  {
    ...
    do
    {
      ...
      if (llk.c())
      {
        ...
        localblir.a(new non(localblir, paramQQAppInterface, paramContext, paramSessionInfo));
        localblir.show();
        return;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, String paramString)
  {
    ...
    if (bkgt.b(paramQQAppInterface, paramSessionInfo.jdField_a_of_type_JavaLangString)) {
    ...
    for (;;)
    {
      ...
      if (localObject != null)
      {
        localObject = ((aody)localObject).c(paramSessionInfo.jdField_a_of_type_JavaLangString);
        if (localObject == null)
        {
          localObject = (anxb)paramQQAppInterface.getManager(69);
          if (localObject != null)
          {
            localObject = ((anxb)localObject).a(paramSessionInfo.jdField_a_of_type_JavaLangString);
            if (localObject == null)
            {
              if (QLog.isDevelopLevel()) {
              ...
              if ((paramContext instanceof Activity)) {
                localbjbs = new bjbs(paramContext, paramContext.getResources().getDimensionPixelSize(2131299011));
              }
              if (localbjbs != null) {
              ...
              localObject = new NewIntent(paramContext.getApplicationContext(), nkl.class);
      ...
      try
      {
        ...
        ((NewIntent)localObject).setObserver(new nol(paramContext, paramQQAppInterface, localbjbs, paramSessionInfo, paramString));
        ...
        return;
        a(paramContext, 2131694659);
        bdll.b(paramQQAppInterface, "CliOper", "", "", "0X80049DF", "GetDetailFalse", 0, 0, "", "", "", "");
        return;
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, int paramInt, BusinessObserver paramBusinessObserver)
  {
    ...
    {
      paramContext = new NewIntent(paramContext.getApplicationContext(), nkl.class);
  ...
  {
    if ((paramQQAppInterface != null) && (nmd.a(paramString)) && (nmd.b(paramString)))
    {
  ...
  public static String b(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      str = bkgt.a(paramQQAppInterface, paramString);
    }
    label25:
    do
    {
  ...
  private static void b(int paramInt, bjbs parambjbs)
  {
    if (parambjbs != null)
    {
      parambjbs.c(paramInt);
      parambjbs.show();
    }
  }
  
  private static void b(bjbs parambjbs)
  {
  ...
  private static void b(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, PublicAccountInfo paramPublicAccountInfo, EqqDetail paramEqqDetail, String paramString)
  {
    ...
    for (;;)
    {
      if (bool)
      {
        ...
        if ((paramContext instanceof Activity)) {
          paramPublicAccountInfo = new bjbs(paramContext, paramContext.getResources().getDimensionPixelSize(2131299011));
        }
        if (paramPublicAccountInfo != null) {
          paramPublicAccountInfo.setCanceledOnTouchOutside(true);
        }
        NewIntent localNewIntent = new NewIntent(paramContext.getApplicationContext(), ocj.class);
        ...
        localNewIntent.setObserver(new nom(paramContext, paramQQAppInterface, paramPublicAccountInfo, paramEqqDetail, paramSessionInfo, paramString));
        paramQQAppInterface.startServlet(localNewIntent);
      }
      try
      {
        if (((paramContext instanceof Activity)) && (!((Activity)paramContext).isFinishing())) {
          a(2131694705, paramPublicAccountInfo);
        }
        label257:
        if (QLog.isColorLevel()) {
  ...
  public static void b(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2)
  {
    ...
    {
      new bjcf(paramContext).a(2131693008, paramContext.getResources().getDimensionPixelSize(2131299011), 0, 1);
      return;
    }
  ...
  public static void b(QQAppInterface paramQQAppInterface, EqqDetail paramEqqDetail)
  {
    ...
    anxb localanxb = (anxb)paramQQAppInterface.getManager(69);
    if (localanxb != null) {
      localanxb.a(paramEqqDetail);
    }
  ...
  public static boolean b(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    for (boolean bool1 = false;; bool1 = false)
    {
      ...
      if ((localObject != null) && (((anxb)localObject).a(paramString) != null))
      {
        if (QLog.isColorLevel()) {
  ...
  private static void c(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, String paramString)
  {
    ...
    {
      if (i == 0) {
        bdll.b(paramQQAppInterface, "CliOper", "", "", "0X8004628", "0X8004628", 0, 0, "", "", "", "");
      }
      if (paramSessionInfo.jdField_a_of_type_Int != 1008) {
        paramSessionInfo.jdField_a_of_type_Int = 1024;
      }
      agju.a(paramQQAppInterface, paramContext, paramSessionInfo, true, paramString, null);
      return;
    }
  }
  ...
  {
    if (!((anyw)paramQQAppInterface.getManager(51)).b(paramString2)) {}
    for (;;)
    {
      return;
      try
      {
        ...
        {
          ((bkib)paramQQAppInterface.a(85)).a(Long.valueOf(paramString1).longValue(), Long.valueOf(paramString2).longValue());
          return;
        }
      }
      catch (Exception paramQQAppInterface)
  ...
  private static boolean c(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    if (paramInt == 1024)
    {
      ...
      {
        if (((aody)localManager).c(paramString) != null) {}
        for (bool1 = true;; bool1 = true)
        {
          ...
          if (((anxb)paramQQAppInterface).a(paramString) == null) {
            break label157;
          }
        }
        label157:
