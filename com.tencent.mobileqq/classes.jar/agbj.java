  ...
  extends BaseAdapter
{
  ...
  public agbj(QQAppInterface paramQQAppInterface, Context paramContext, ChatHistoryBaseFragment paramChatHistoryBaseFragment)
  {
  ...
  private void a(agbl paramagbl, TroopLinkElement paramTroopLinkElement)
  {
    if (!TextUtils.isEmpty(paramTroopLinkElement.iconUrl))
    {
      a(agbl.a(paramagbl), paramTroopLinkElement.iconUrl);
      if (TextUtils.isEmpty(paramTroopLinkElement.title)) {
        break label245;
      }
      agbl.a(paramagbl).setText(paramTroopLinkElement.title);
    }
    for (;;)
    {
      ...
      agbl.b(paramagbl).setText((CharSequence)localObject);
      ...
      agbl.c(paramagbl).setText((CharSequence)localObject);
      agbl.a(paramagbl).setOnClickListener(new agbk(this, paramTroopLinkElement, paramagbl));
      if (!this.jdField_a_of_type_Boolean) {
        break label259;
      }
      agbl.a(paramagbl).setVisibility(0);
      boolean bool = this.b.contains(paramTroopLinkElement);
      agbl.a(paramagbl).setChecked(bool);
      paramTroopLinkElement = (LinearLayout.LayoutParams)agbl.a(paramagbl).getLayoutParams();
      paramTroopLinkElement.setMargins(paramTroopLinkElement.leftMargin, paramTroopLinkElement.topMargin, vzl.a(this.jdField_a_of_type_AndroidContentContext, 8.0F), paramTroopLinkElement.bottomMargin);
      agbl.a(paramagbl).setLayoutParams(paramTroopLinkElement);
      return;
      agbl.a(paramagbl).setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130849354));
      break;
      label245:
      agbl.a(paramagbl).setText(paramTroopLinkElement.url);
    }
    label259:
    agbl.a(paramagbl).setVisibility(8);
    paramTroopLinkElement = (LinearLayout.LayoutParams)agbl.a(paramagbl).getLayoutParams();
    paramTroopLinkElement.setMargins(paramTroopLinkElement.leftMargin, paramTroopLinkElement.topMargin, vzl.a(this.jdField_a_of_type_AndroidContentContext, 50.0F), paramTroopLinkElement.bottomMargin);
    agbl.a(paramagbl).setLayoutParams(paramTroopLinkElement);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if ((localObject2 instanceof TroopLinkElement))
    {
      ...
      if ((paramView != null) && ((paramView.getTag() instanceof agbl)))
      {
        paramViewGroup = (agbl)paramView.getTag();
    ...
    do
    {
      ...
      paramViewGroup = new agbl(paramView);
