...
public class avgf
{
  ...
  public static avfz a(Spannable paramSpannable, int paramInt)
  {
    if ((paramInt < 0) || (paramInt >= paramSpannable.length())) {
      return null;
    }
    avfz[] arrayOfavfz = (avfz[])paramSpannable.getSpans(paramInt, paramInt, avfz.class);
    int i = 0;
    while (i < arrayOfavfz.length)
    {
      int j = paramSpannable.getSpanStart(arrayOfavfz[i]);
      int k = paramSpannable.getSpanEnd(arrayOfavfz[i]);
      if ((paramInt >= j) && (paramInt < k)) {
        return arrayOfavfz[i];
      }
      i += 1;
    }
    return null;
  ...
  public static List<Pair<Integer, String>> a(Editable paramEditable)
  {
    ...
    if (i < paramEditable.length())
    {
      Object localObject2 = (avfz[])paramEditable.getSpans(i, i, avfz.class);
      ...
      localObject1 = ((avfz)localObject2).a();
  ...
  {
    boolean bool;
    if ((paramETTextView.a != null) && (paramETTextView.a.getId() != 0) && (9999 != paramETTextView.a.getId()))
    {
      bool = true;
      if (QLog.isColorLevel()) {
    ...
    for (paramETTextView = paramETTextView.getText();; paramETTextView = paramCharSequence)
    {
      ...
      paramETTextView = (avfz[])paramETTextView.getSpans(0, paramETTextView.length(), avfz.class);
      paramInt = 0;
  ...
  public static List<Pair<Integer, Integer>> b(Editable paramEditable)
  {
    ...
    if (i < paramEditable.length())
    {
      arrayOfavfz = (avfz[])paramEditable.getSpans(i, i, avfz.class);
      if ((arrayOfavfz == null) || (arrayOfavfz.length <= 0)) {
        break label184;
      }
      if (arrayOfavfz.length > 1)
      {
        int k = arrayOfavfz.length;
        j = 0;
        localObject1 = null;
        label66:
        if (j < k)
        {
          avfz localavfz = arrayOfavfz[j];
          if (localavfz == localObject2) {
            break label194;
          }
          localObject1 = localavfz;
        }
      }
    }
    label184:
    ...
    for (;;)
    {
      ...
      if (localObject1 == null) {
        localObject1 = arrayOfavfz[(arrayOfavfz.length - 1)];
      }
      for (;;)
      {
        label110:
        ...
        {
          localObject2 = ((avfz)localObject1).a();
