  ...
  extends DynamicTextItem
{
  ...
  blsj jdField_a_of_type_Blsj = null;
  ...
  public blsl(int paramInt, @NonNull List<String> paramList)
  {
    ...
    this.jdField_b_of_type_AndroidTextTextPaint.setStrokeWidth(aekt.a(3.0F, BaseApplicationImpl.getContext().getResources()));
  }
  ...
  private void a(float paramFloat1, float paramFloat2, float paramFloat3, int paramInt)
  {
    ...
    {
      this.g = paramInt;
      this.jdField_d_of_type_Int = aekt.a(paramFloat1, BaseApplicationImpl.getApplication().getResources());
      this.jdField_e_of_type_Int = aekt.a(paramFloat2, BaseApplicationImpl.getApplication().getResources());
      this.f = aekt.a(paramFloat3, BaseApplicationImpl.getApplication().getResources());
    }
  }
  ...
  private void a(boolean paramBoolean, float paramFloat, int paramInt)
  {
    ...
    {
      this.jdField_b_of_type_Int = aekt.a(paramFloat, BaseApplicationImpl.getContext().getResources());
  ...
  private boolean a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, String paramString, int paramInt5, int paramInt6, Point paramPoint)
  {
    ...
    while (j >= paramInt4)
    {
      ...
      StaticLayout localStaticLayout1 = blui.a(paramString, 0, paramString.length(), this.jdField_a_of_type_AndroidTextTextPaint, paramInt1, Layout.Alignment.ALIGN_NORMAL, 1.0F, 0.0F, false, null, 0, paramInt6);
      StaticLayout localStaticLayout2 = blui.a(paramString, 0, paramString.length(), this.jdField_b_of_type_AndroidTextTextPaint, paramInt1, Layout.Alignment.ALIGN_NORMAL, 1.0F, 0.0F, false, null, 0, paramInt6);
  ...
  public float a()
  {
    return this.jdField_a_of_type_Blsj.jdField_a_of_type_AndroidGraphicsBitmap.getWidth();
  }
  ...
  public InputFilter a()
  {
    if (this.jdField_a_of_type_AndroidTextInputFilter == null) {
      this.jdField_a_of_type_AndroidTextInputFilter = new blsm(this, 20);
    }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    while (paramInt < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      blsj localblsj = (blsj)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt);
      localObject1[paramInt] = 0;
      f1 = localblsj.jdField_c_of_type_Int;
      f2 = localblsj.jdField_d_of_type_Int;
      localObject1[paramInt] = a((int)f1, (int)f2, localblsj.h, localblsj.g, (String)localObject2, localblsj.jdField_a_of_type_Int, localblsj.i, localObject3[paramInt]);
    ...
    {
      localObject3 = (blsj)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt);
      ...
      {
        f1 = aekt.a(((blsj)localObject3).jdField_c_of_type_Int, this.jdField_a_of_type_AndroidContentResResources);
        f2 = aekt.a(((blsj)localObject3).jdField_d_of_type_Int, this.jdField_a_of_type_AndroidContentResResources);
      ...
      if (localObject2[paramInt] > localObject2[i])
      {
        ...
        for (;;)
        {
          if (j == 0)
          {
            ...
            this.jdField_a_of_type_Blsj = ((blsj)this.jdField_a_of_type_JavaUtilArrayList.get(i));
  ...
  {
    paramCanvas.save();
    paramCanvas.drawBitmap(this.jdField_a_of_type_Blsj.jdField_a_of_type_AndroidGraphicsBitmap, 0.0F, 0.0F, this.jdField_a_of_type_AndroidGraphicsPaint);
    if (this.jdField_b_of_type_AndroidTextStaticLayout != null)
    {
      ...
      this.jdField_a_of_type_Float = (this.jdField_a_of_type_Blsj.jdField_e_of_type_Int + (this.jdField_a_of_type_Blsj.jdField_c_of_type_Int - this.jdField_c_of_type_Float) / 2.0F);
      this.jdField_b_of_type_Float = (this.jdField_a_of_type_Blsj.f + (this.jdField_a_of_type_Blsj.jdField_d_of_type_Int - this.jdField_d_of_type_Float) / 2.0F);
  ...
  public float b()
  {
    return this.jdField_a_of_type_Blsj.jdField_a_of_type_AndroidGraphicsBitmap.getHeight();
  }
