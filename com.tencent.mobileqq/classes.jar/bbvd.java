  ...
  extends BaseAdapter
{
  ...
  List<bbvh<TroopInfo, Boolean>> jdField_a_of_type_JavaUtilList;
  
  public bbvd(Activity paramActivity, List<TroopInfo> paramList, TroopInfo paramTroopInfo, List<String> paramList1)
  {
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    if (paramTroopInfo != null)
    {
      this.jdField_a_of_type_JavaUtilList.add(new bbvh(paramTroopInfo, Boolean.valueOf(true)));
    ...
    if (paramList != null)
    {
      ...
      while (paramActivity.hasNext())
      {
        ...
        if (paramList != null)
        {
          ...
          {
            this.jdField_a_of_type_JavaUtilList.add(new bbvh(paramList, Boolean.valueOf(bool)));
            break;
          }
        }
      }
  ...
  {
    bbvh localbbvh = (bbvh)getItem(paramInt);
    Object localObject1;
    if (paramView != null)
    {
      localObject1 = (bbvg)paramView.getTag();
      ...
      paramView.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(((Boolean)localbbvh.b).booleanValue());
      localObject1 = paramView.jdField_a_of_type_AndroidWidgetCheckBox;
      if (((TroopInfo)localbbvh.a).troopuin.equals(this.jdField_a_of_type_JavaLangString)) {
        break label458;
      }
    }
    label458:
    for (boolean bool = true;; bool = false)
    {
      ...
      paramView.jdField_a_of_type_AndroidWidgetCheckBox.setOnCheckedChangeListener(new bbve(this, localbbvh));
      paramViewGroup.setOnClickListener(new bbvf(this, paramView.jdField_a_of_type_AndroidWidgetCheckBox));
      paramView.jdField_a_of_type_AndroidWidgetTextView.setText(((TroopInfo)localbbvh.a).troopname);
      return paramViewGroup;
      paramView = new bbvg();
      paramViewGroup = new LinearLayout(this.jdField_a_of_type_AndroidAppActivity);
      paramViewGroup.setMinimumHeight(azgq.a(48.0F));
      ...
      paramView.jdField_a_of_type_AndroidWidgetCheckBox.setButtonDrawable(2130838921);
      localObject1 = new LinearLayout.LayoutParams(-2, -2);
      ((LinearLayout.LayoutParams)localObject1).setMargins(azgq.a(12.0F), 0, 0, 0);
      ...
      ((LinearLayout.LayoutParams)localObject2).setMargins(azgq.a(12.0F), 0, azgq.a(12.0F), 0);
