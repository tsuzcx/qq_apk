...
public class bgnk
{
  ...
  public bgnk(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
  }
  
  private void a(Activity paramActivity, int paramInt, String paramString, whr paramwhr)
  {
    if (paramActivity == null) {
      return;
    }
    String str = ajya.a(2131710710);
    if (1 == paramInt) {
      paramString = str + ajya.a(2131710713) + paramString + ajya.a(2131710708);
    }
    for (;;)
    {
      bbdj.a(paramActivity, 230, paramActivity.getString(2131698386), paramString, 2131698380, 2131698380, new bgnt(this, paramwhr), null).show();
      return;
      if (2 == paramInt) {
        paramString = str + ajya.a(2131710712) + paramString + ajya.a(2131710707);
      } else {
        paramString = ajya.a(2131710709);
      }
    }
  }
  ...
  public static void a(Context paramContext, int paramInt, Bundle paramBundle)
  {
    if (paramContext == null)
    {
      ...
      Toast.makeText(BaseApplication.getContext(), ajya.a(2131710711), 0).show();
      return;
    }
    ...
    if ((paramContext instanceof xje)) {
  ...
  private void h()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 161	bgnk:jdField_a_of_type_JavaUtilTimer	Ljava/util/Timer;
    //   6: astore_1
    //   7: aload_1
    //   8: ifnull +6 -> 14
    //   11: aload_0
    ...
    //   30: putfield 161	bgnk:jdField_a_of_type_JavaUtilTimer	Ljava/util/Timer;
    //   33: aload_0
    //   34: getfield 161	bgnk:jdField_a_of_type_JavaUtilTimer	Ljava/util/Timer;
    //   37: new 170	cooperation/qlink/QQProxyForQlink$9
    //   40: dup
    //   41: aload_0
    //   42: invokespecial 172	cooperation/qlink/QQProxyForQlink$9:<init>	(Lbgnk;)V
    //   45: lconst_0
    //   46: ldc2_w 173
  ...
  private void j()
  {
    ...
    {
      this.jdField_b_of_type_AndroidContentBroadcastReceiver = new bgnl(this);
  ...
  private void l()
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 223	bgnk:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   8: ifnonnull +58 -> 66
    //   11: aload_0
    //   12: new 225	bgnm
    //   15: dup
    //   16: aload_0
    //   17: invokespecial 226	bgnm:<init>	(Lbgnk;)V
    //   20: putfield 223	bgnk:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    ...
    //   37: aload_0
    //   38: getfield 28	bgnk:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   41: ifnull +11 -> 52
    //   44: aload_0
    //   45: getfield 28	bgnk:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   56: aload_1
    //   57: aload_0
    //   58: getfield 223	bgnk:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   61: aload_2
    ...
    //   77: aload_0
    //   78: aconst_null
    //   79: putfield 223	bgnk:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   82: goto -16 -> 66
    //   85: astore_1
    //   86: aload_0
    //   87: monitorexit
  ...
  private void m()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 223	bgnk:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   6: ifnull +28 -> 34
    //   9: aload_0
    //   10: getfield 28	bgnk:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   13: ifnull +13 -> 26
    //   16: aload_0
    //   17: getfield 28	bgnk:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   44: aload_0
    //   45: getfield 223	bgnk:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    ...
    //   51: aload_0
    //   52: aconst_null
    //   53: putfield 223	bgnk:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   56: goto -22 -> 34
    //   59: astore_1
    //   60: aload_0
    //   61: monitorexit
  ...
  public void a(Activity paramActivity, DialogInterface.OnClickListener paramOnClickListener1, DialogInterface.OnClickListener paramOnClickListener2, DialogInterface.OnClickListener paramOnClickListener3, String paramString)
  {
    ...
    {
      return;
      String str2 = bbcz.j(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mPeerUin);
      String str1;
      if (str2 != null)
      {
        str1 = str2;
      ...
      {
        a("0X8004854", 1);
        paramOnClickListener3 = paramActivity.getResources().getString(2131698426) + str1 + paramActivity.getResources().getString(2131698427);
        ...
        {
          this.jdField_a_of_type_Bbgu = bbdj.a(paramActivity, 230, paramActivity.getResources().getString(2131698387), paramOnClickListener3, paramActivity.getResources().getString(2131698428), paramActivity.getResources().getString(2131698428), paramOnClickListener2, null);
          label194:
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_Bbgu.setOnDismissListener(new bgnq(this));
        return;
        label224:
        str1 = this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mPeerUin;
        break;
        this.jdField_a_of_type_Bbgu = bbdj.a(paramActivity, 230, paramActivity.getResources().getString(2131698387), paramOnClickListener3, paramActivity.getResources().getString(2131698428), paramActivity.getResources().getString(2131698429), paramOnClickListener1, paramOnClickListener2);
        break label194;
        if (this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mMode == 2)
        {
          a("0X8004856", 1);
          paramOnClickListener1 = str1 + paramActivity.getResources().getString(2131698425);
          this.jdField_a_of_type_Bbgu = bbdj.a(paramActivity, 230, paramActivity.getResources().getString(2131698387), paramOnClickListener1, paramActivity.getResources().getString(2131698424), paramActivity.getResources().getString(2131698424), paramOnClickListener3, null);
          this.jdField_a_of_type_Bbgu.show();
        }
  ...
  public void a(Activity paramActivity, ArrayList<String> paramArrayList, int paramInt1, int paramInt2, boolean paramBoolean, String paramString)
  {
    ...
    paramActivity.finish();
    return;
    a(paramActivity, new bgnn(this, paramArrayList, paramActivity, paramInt1, paramBoolean), new bgno(this), new bgnp(this), paramString);
  }
  ...
  public void a(QlAndQQInterface.InsertFMFileInfo paramInsertFMFileInfo)
  {
    ...
    String str = apug.a(paramInsertFMFileInfo.filePath);
    long l1 = apug.a(paramInsertFMFileInfo.filePath);
    long l2 = axas.a(-1000).uniseq;
    ...
    localFileManagerEntity.nFileType = apug.a(paramInsertFMFileInfo.filePath);
    ...
    if (localajxl.e(String.valueOf(localFileManagerEntity.peerUin)) != null)
    {
      localFileManagerEntity.peerType = 0;
      localFileManagerEntity.peerNick = apug.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInsertFMFileInfo.uin, null, 0);
      localFileManagerEntity.status = 1;
      if ((!localajxl.b(paramInsertFMFileInfo.uin)) && (!paramInsertFMFileInfo.bSend)) {
        break label356;
      }
      localFileManagerEntity.nOpType = 0;
      localFileManagerEntity.bSend = true;
      aywk.a(paramInsertFMFileInfo.filePath, 0L, 0, true);
    ...
    for (;;)
    {
      ...
      aywk.a(paramInsertFMFileInfo.filePath, l1, 0, false, null);
      ayph.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), str, 0, null);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(localFileManagerEntity);
    }
  }
  ...
  {
    String str = bbcz.i(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString);
    ajxl localajxl = (ajxl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", paramString, paramString, 0, paramInt, 0, "", "", "", "");
  }
  ...
  public void a(String paramString1, String paramString2, boolean paramBoolean, long paramLong1, long paramLong2, HashMap<String, String> paramHashMap)
  {
    ...
    bgoc.a(paramString1, paramString2, paramBoolean, paramLong1, paramLong2, paramHashMap);
  }
  
  public void a(AppActivity paramAppActivity, String paramString, whr paramwhr)
  {
    if ((paramAppActivity == null) || (paramString == null)) {
      return;
    }
    bgnx localbgnx = bgnw.a(paramString);
    if (localbgnx == null)
    {
      bbdj.a(paramAppActivity, 230, paramAppActivity.getString(2131698386), paramAppActivity.getString(2131698406), 2131698380, 2131698380, new bgnr(this, paramwhr), null).show();
      return;
    }
    if (this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mWorking)
    {
      a(paramAppActivity, this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mMode, this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mPeerNick, paramwhr);
      return;
    }
    ...
    paramwhr = new Bundle();
    paramwhr.putString("url", paramString);
    paramwhr.putString("key", localbgnx.a);
    paramwhr.putString("peerUin", localbgnx.b);
    paramwhr.putString("peerNick", localbgnx.c);
    paramwhr.putString("peerOS", localbgnx.d);
    paramwhr.putString("apSSID", localbgnx.e);
    paramwhr.putString("preSharedKey", localbgnx.f);
    paramwhr.putBoolean("fromqlink", bool);
    paramString = paramAppActivity.getIntent().getStringExtra("subfrom");
    if (paramString != null) {
      paramwhr.putString("subfrom", paramString);
    }
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
    a(paramAppActivity, 11, paramwhr);
    paramAppActivity.finish();
  }
  
  public void a(AppActivity paramAppActivity, whr paramwhr)
  {
    if (paramAppActivity == null) {
      return;
    }
    bbdj.a(paramAppActivity, 230, paramAppActivity.getString(2131698404), paramAppActivity.getString(2131698405), 2131698380, 2131698380, new bgns(this, paramwhr), null).show();
  }
  ...
  public boolean a(String paramString, List<String> paramList)
  {
    ...
    while (paramString.hasNext())
    {
      ...
      localSendFileInfo.sessionid = apug.a().longValue();
      localSendFileInfo.filePath = paramList;
      localSendFileInfo.fileSize = apug.a(paramList);
  ...
  {
    if (1 == paramInt) {
      apug.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext());
    }
  }
