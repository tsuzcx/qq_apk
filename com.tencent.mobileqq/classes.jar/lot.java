  ...
  extends los
{
  ...
  public void a(BufferedReader paramBufferedReader)
  {
    ...
    {
      return;
      this.jdField_a_of_type_Float = loo.a(paramBufferedReader, "highMin");
      this.jdField_b_of_type_Float = loo.a(paramBufferedReader, "highMax");
      this.c = loo.a(paramBufferedReader, "relative");
      this.jdField_b_of_type_ArrayOfFloat = new float[loo.a(paramBufferedReader, "scalingCount")];
      int i = 0;
      while (i < this.jdField_b_of_type_ArrayOfFloat.length)
      {
        this.jdField_b_of_type_ArrayOfFloat[i] = loo.a(paramBufferedReader, "scaling" + i);
        i += 1;
      }
  ...
  public float b()
  {
    return this.jdField_a_of_type_Float + (this.jdField_b_of_type_Float - this.jdField_a_of_type_Float) * loj.a();
  }
}
