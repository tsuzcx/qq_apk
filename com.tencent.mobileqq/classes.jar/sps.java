  ...
  implements View.OnClickListener
{
  ...
  public sps(spr paramspr, View paramView, BaseData paramBaseData)
  {
  ...
  {
    return LayoutInflater.from(paramContext).inflate(2131560171, (ViewGroup)this.jdField_a_of_type_AndroidViewView, false);
  }
  
  private void a(String paramString, sos paramsos, ArticleInfo paramArticleInfo)
  {
    long l1 = paramArticleInfo.mArticleID;
    long l2 = paramsos.jdField_a_of_type_Long;
    ocd.a(null, "CliOper", "", ozs.a(), paramString, paramString, 0, 0, String.valueOf(l1), String.valueOf(l2), paramArticleInfo.innerUniqueID, "", false);
  }
  ...
  public SpannableStringBuilder a(String paramString)
  {
    ...
    for (;;)
    {
      if (i < paramString.length()) {
        if (!bhsr.c(paramString.charAt(i))) {
          break label144;
        }
      }
      label144:
      for (d += 1.0D; d >= 11.0D; d += 0.5D)
      {
        ...
        if (i < paramString.length() - 1) {
          str = paramString.substring(0, i + 1) + oyu.jdField_a_of_type_JavaLangString;
        }
  ...
  public void b(BaseData paramBaseData1, BaseData paramBaseData2, boolean paramBoolean)
  {
    ...
    if (i < this.jdField_a_of_type_ComTencentWidgetHorizontalLabelLayout.getChildCount())
    {
      ...
      if (i < j)
      {
        ...
        sos localsos = (sos)paramBaseData1.jdField_a_of_type_JavaUtilList.get(i);
        localView.setTag(localsos);
        ((TextView)localView.findViewById(2131376143)).setText(a(localsos.jdField_a_of_type_JavaLangString));
        if ((!paramBoolean) && (!paramBaseData1.jdField_a_of_type_Boolean))
        {
          a("0X800919F", localsos, paramBaseData2.b);
  ...
  {
    sos localsos = (sos)paramView.getTag();
    if (localsos != null)
    {
      ozs.a(paramView.getContext(), localsos.b);
      a("0X80091A0", localsos, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataBaseData.b);
    }
