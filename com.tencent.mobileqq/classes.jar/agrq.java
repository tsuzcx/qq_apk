  ...
  extends aluu
{
  ...
  public void a(String paramString, HotChatManager.HotChatStateWrapper paramHotChatStateWrapper)
  {
    if (QLog.isColorLevel()) {
      auwz.a(this.a.jdField_a_of_type_JavaLangString, new Object[] { "onPushExitHotChat", paramString, paramHotChatStateWrapper });
    }
    if (!bdeu.a(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, paramString)) {
      return;
    }
    int i = paramHotChatStateWrapper.targetState;
    aluv.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, i);
  ...
  public void a(String paramString1, boolean paramBoolean, String paramString2)
  {
    ...
    if ((paramBoolean) && (this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString.equals(paramString1)))
    {
      ...
      aluv.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, 4);
      aluv.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  ...
  {
    if (QLog.isColorLevel()) {
      auwz.a(this.a.jdField_a_of_type_JavaLangString, new Object[] { "onQuickJoinHotChat", Boolean.valueOf(paramBoolean), paramString, paramHotChatInfo });
    }
    if (!paramBoolean) {
      if ((bdeu.a(this.a.j, paramString)) || ((this.a.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo != null) && (bdeu.a(this.a.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo.uuid, paramString))))
      {
        paramHotChatInfo = auud.a(paramInt);
        QQToast.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 1, paramHotChatInfo, 1).a();
      }
    }
    while ((!bdeu.a(this.a.j, paramString)) || (paramHotChatInfo == null) || (bdeu.a(paramHotChatInfo.troopUin, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))) {
      return;
    }
    if (QLog.isColorLevel()) {
      auwz.a(this.a.jdField_a_of_type_JavaLangString, new Object[] { "onQuickJoinHotChat_not_same_aio", String.format("uuid:%s, new:%s, old:%s", new Object[] { paramString, paramHotChatInfo.troopUin, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString }) });
    }
    ...
    for (paramInt = 2;; paramInt = 0)
    {
      ...
      paramHotChatInfo = aepi.a(paramWifiPOIInfo, new int[] { 2 });
  ...
  public void a(boolean paramBoolean, String paramString1, int paramInt, String paramString2, Long paramLong)
  {
    ...
    if (this.a.jdField_a_of_type_Aluy != null) {
      this.a.jdField_a_of_type_Aluy.b(l1);
    }
  }
  ...
  public void a(boolean paramBoolean, String paramString1, String paramString2)
  {
    if ((paramBoolean) && (paramString1 != null) && (paramString1.equals(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)))
    {
      ...
      {
        alxn.a("gift_store", "cancel_list", paramString2, paramString1, "", "");
        return;
      }
    }
    paramString2 = this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString;
  ...
  {
    auud.a(this.a.a(), this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1, paramString2);
  }
}
