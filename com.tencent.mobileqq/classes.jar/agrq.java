  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      localDeviceInfo = ((abgm)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.DEVICEPROXYMGR_HANDLER)).a(Long.parseLong(localMessageForDeviceSingleStruct.senderuin));
    ...
    for (;;)
    {
      ...
      catch (JSONException localJSONException)
      {
        ...
        continue;
        if ((i == 0) || (TextUtils.isEmpty(localMessageForDeviceSingleStruct.faceRect)) || (!agrp.a(this.a, localMessageForDeviceSingleStruct.faceRect)) || (TextUtils.isEmpty(localMessageForDeviceSingleStruct.strCoverPath))) {
          continue;
        }
        ...
        bmij.a().a((Activity)this.a.jdField_a_of_type_AndroidContentContext, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), (Intent)localObject2, "com.tencent.device.face.FaceRegisterActivity", -1, null, SmartDevicePluginProxyActivity.class);
        continue;
        str = localMessageForDeviceSingleStruct.strCoverPath;
        continue;
        agrp.a(this.a, localMessageForDeviceSingleStruct);
        continue;
        i = 3;
        continue;
      }
      ...
      agrp.a(this.a, localMessageForDeviceSingleStruct, localDeviceInfo, (String)localObject1);
      ...
      absy.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, l, "Usr_AIO_ReceiveMsg_Click", i, 0, j);
      break;
      i = 0;
      continue;
