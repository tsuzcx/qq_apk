  ...
  implements blou
{
  ...
  private bloy a(Bitmap paramBitmap, ArrayList<blov> paramArrayList)
  {
    bloy localbloy = new bloy(this);
    ...
    {
      paramBitmap = (blov)paramArrayList.get(i);
      int j = paramBitmap.jdField_b_of_type_Int;
      double d2 = paramBitmap.jdField_a_of_type_Int * j;
      double d3 = localbloy.jdField_a_of_type_Double;
      localbloy.jdField_a_of_type_Double = (d2 / d1 + d3);
      if (localbloy.jdField_a_of_type_Double > jdField_a_of_type_JavaLangDouble.doubleValue()) {
        localbloy.jdField_a_of_type_Boolean = true;
      }
      i += 1;
    }
    if ((paramArrayList.size() > 1) && (localbloy.jdField_a_of_type_Double > b.doubleValue())) {
      localbloy.b = true;
    }
    return localbloy;
  }
  
  private blpa a(String paramString)
  {
    blpa localblpa = new blpa();
    if (paramString == null) {}
    do
    {
      return null;
    ...
    while (i < localJSONArray1.length())
    {
      ...
      if (j < localJSONArray2.length())
      {
        ...
        {
          localblpa.jdField_a_of_type_Int = localJSONObject1.optInt("sceneLvOne");
          localblpa.jdField_b_of_type_Int = localJSONObject2.optInt("sceneLvTwo");
          localblpa.jdField_a_of_type_JavaLangString = localJSONObject2.optString("sceneName");
          localblpa.jdField_b_of_type_JavaLangString = localJSONObject2.optString("sceneFilterID");
          localblpa.jdField_a_of_type_Double = localJSONObject2.optDouble("sceneFilterPercent");
        }
      }
      else
      {
  ...
  private blpa a(JSONArray paramJSONArray)
  {
    double d2 = -1.0D;
    Object localObject1 = new blpa();
    ...
    if (paramJSONArray.length() > 0)
    {
      ...
      if (i < paramJSONArray.length())
      {
        ...
        blpa localblpa = a((String)localObject3);
        double d6;
        double d5;
        if (localblpa == null)
        {
        ...
        for (;;)
        {
          ...
          d5 = d2;
          d6 = d3;
          if (localblpa.jdField_b_of_type_Int != -1)
          {
            localObject3 = localObject1;
            double d1 = d2;
            if (localblpa.jdField_a_of_type_Int == 3)
            {
              localObject3 = localObject1;
              d1 = d2;
              if (d4 > c.doubleValue())
  ...
  private String a(Bitmap paramBitmap, int paramInt)
  {
    ...
    if (i > paramInt)
    {
      paramBitmap = axsb.a(paramBitmap, i / paramInt);
      localByteArrayOutputStream = new ByteArrayOutputStream();
      paramBitmap.compress(Bitmap.CompressFormat.JPEG, 100, localByteArrayOutputStream);
      return blos.a(localByteArrayOutputStream.toByteArray());
    }
  ...
  private JSONObject a(String paramString)
  {
    ...
    try
    {
      ...
      paramString = blot.a("https://tu.qq.com/cgi-bin/qq/get_face_detail.fcg", localJSONObject2.toString());
      return paramString;
    }
  ...
  private JSONObject b(String paramString)
  {
    ...
    try
    {
      ...
      localJSONObject2.put("token", b(paramString));
      paramString = blot.a("https://tu.qq.com/cgi-bin/qq/do_image_classify.fcg", localJSONObject2.toString());
      return paramString;
    }
    catch (Exception paramString)
    {
  ...
  public void a(Bitmap paramBitmap, ArrayList<blov> paramArrayList, blow paramblow)
  {
    if (paramBitmap == null)
    {
      paramblow.a("image is null");
      return;
    }
    ...
    if (paramArrayList.jdField_a_of_type_Boolean) {
      if (paramArrayList.b) {
        paramBitmap = a(amtj.a(2131714844));
      }
    }
    while (paramBitmap == null)
    {
      paramblow.a("unknown error");
      blot.a(System.currentTimeMillis() - l, 1);
      return;
      paramBitmap = a(paramBitmap);
      if ((paramBitmap == null) || (paramBitmap.isNull("retcode")))
      {
        paramblow.a("network error");
        blot.a(System.currentTimeMillis() - l, 1);
        return;
      }
      if ((paramBitmap != null) && (paramBitmap.has("retcode")) && (paramBitmap.optInt("retcode") == 0))
      {
        ...
        if (i <= 5) {
          paramBitmap = a(amtj.a(2131714847));
        } else if (j < 50) {
          paramBitmap = a(amtj.a(2131714845));
        } else {
          paramBitmap = a(amtj.a(2131714842));
        }
      }
      else
      {
        paramBitmap = a(amtj.a(2131714846));
        continue;
        ...
        if ((paramArrayList == null) || (paramArrayList.isNull("retcode")))
        {
          ...
          blot.a(l, 1);
          zxp.a("record_smart_filter", zxp.a(1L, l));
          return;
        }
        paramBitmap = localblpa;
    ...
    paramblow.a(paramBitmap);
    l = System.currentTimeMillis() - l;
    blot.a(l, 0);
    zxp.a("record_smart_filter", zxp.a(0L, l));
  }
}
