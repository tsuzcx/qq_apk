...
public class aqwe
{
  ...
  private ServerConfigObserver jdField_a_of_type_MqqObserverServerConfigObserver = new aqwf(this);
  private boolean jdField_a_of_type_Boolean = true;
  private boolean b;
  
  public aqwe(QQAppInterface paramQQAppInterface)
  {
  ...
  private Hashtable<String, ResourcePluginInfo> a()
  {
    ...
    localResourcePluginInfo.strResName = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131693032);
    ...
    localResourcePluginInfo.strResName = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131692197);
    localResourcePluginInfo.strResDesc = "";
    localResourcePluginInfo.strResURL = "";
    localResourcePluginInfo.sResSubType = 2;
    localResourcePluginInfo.cCanChangeState = 0;
  ...
  {
    aqwe localaqwe = paramQQAppInterface.getAboutConfig();
    Object localObject2 = paramResourcePluginInfo.strGotoUrl;
    Object localObject1 = "version=8.4.10.4875&appid=" + AppSetting.a() + "&QUA=" + QZoneHelper.getQUA();
    Object localObject3;
    ...
    {
      localObject3 = (String)localObject1 + "&adtag=4875";
    }
    if (paramResourcePluginInfo.strPkgName.equals("com.tencent.Feedback_5_8"))
    {
      ...
      localStringBuilder.append((String)localObject3).append("&model=").append((String)localObject2).append("&manufacture=").append((String)localObject1).append("&cpunum=").append(DeviceInfoUtil.getCpuNumber()).append("&cpurate=").append(DeviceInfoUtil.getCpuFrequency()).append("&mem=").append(DeviceInfoUtil.getSystemTotalMemory() / 1024L / 1024L).append("&amem=").append(DeviceInfoUtil.getSystemAvaialbeMemory() / 1024L / 1024L).append("&w=").append(DeviceInfoUtil.getDispalyWidth()).append("&h=").append(DeviceInfoUtil.getDispalyHeight()).append("&pss=").append(MemoryManager.getMemory(Process.myPid()) / 1024L / 1024L).append("&heapmax=").append(Runtime.getRuntime().maxMemory() / 1024L / 1024L).append("&heapsize=").append((Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / 1024L / 1024L).append("&sysver=").append(Build.VERSION.RELEASE).append("&user_tag=").append(QLog.getReportLevel(QLog.getUIN_REPORTLOG_LEVEL()));
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (paramResourcePluginInfo.isNew == 0)
          {
            ...
            ThreadManager.post(new AboutConfig.3(localaqwe, paramResourcePluginInfo), 8, null, false);
          }
          return;
  ...
  public void a(ResourcePluginInfo paramResourcePluginInfo)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 39	aqwe:jdField_a_of_type_JavaUtilHashtable	Ljava/util/Hashtable;
    //   4: ifnull +76 -> 80
    //   7: aload_1
    //   8: ifnull +72 -> 80
    //   11: aload_0
    //   12: getfield 39	aqwe:jdField_a_of_type_JavaUtilHashtable	Ljava/util/Hashtable;
    //   15: aload_1
    //   16: getfield 51	com/tencent/mobileqq/data/ResourcePluginInfo:strPkgName	Ljava/lang/String;
    //   19: invokevirtual 512	java/util/Hashtable:containsKey	(Ljava/lang/Object;)Z
    //   22: ifeq +58 -> 80
    //   25: aload_0
    //   26: getfield 39	aqwe:jdField_a_of_type_JavaUtilHashtable	Ljava/util/Hashtable;
    //   29: aload_1
    //   30: getfield 51	com/tencent/mobileqq/data/ResourcePluginInfo:strPkgName	Ljava/lang/String;
    //   33: invokevirtual 430	java/util/Hashtable:get	(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    //   56: aload_0
    //   57: getfield 29	aqwe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   60: invokevirtual 516	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lcom/tencent/mobileqq/data/QQEntityManagerFactory;
    //   63: invokevirtual 522	com/tencent/mobileqq/data/QQEntityManagerFactory:createEntityManager	()Lcom/tencent/mobileqq/persistence/EntityManager;
    //   66: astore_1
    //   67: aload_1
    //   68: aload_2
    //   69: invokestatic 526	com/tencent/mobileqq/data/ResourcePluginInfo:persistOrReplace	(Lcom/tencent/mobileqq/persistence/EntityManager;Lcom/tencent/mobileqq/data/ResourcePluginInfo;)V
    //   72: aload_1
    //   73: ifnull +7 -> 80
    //   76: aload_1
    //   77: invokevirtual 531	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   80: return
    //   81: astore_2
    //   82: aload_1
    //   83: ifnull -3 -> 80
    //   86: aload_1
    //   87: invokevirtual 531	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   90: return
    //   91: astore_2
    //   92: aload_1
    //   93: ifnull +7 -> 100
    //   96: aload_1
    //   97: invokevirtual 531	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   100: aload_2
    //   101: athrow
