  ...
  extends bqgi
{
  ...
  public bqgc(@NonNull bqgk parambqgk)
  {
    super(parambqgk);
  }
  ...
  private boolean b()
  {
    try
    {
      ...
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetStoryGuideLineView = ((StoryGuideLineView)a(2131372313));
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4)
  {
    ...
    if ((!paramBoolean3) || (paramBoolean4))
    {
      ...
      {
        localObject = this.jdField_a_of_type_Bqgk.a();
        zlk localzlk = this.jdField_a_of_type_Bqgk.a();
        if (localObject != null) {
          this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetStoryGuideLineView.setLinkerObject((bqso)localObject);
        }
        if (this.jdField_a_of_type_Boolean) {
          this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetStoryGuideLineView.setFollow();
        }
        if (localzlk != null) {
          this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetStoryGuideLineView.setStoryTag(localzlk);
        }
      }
      if ((this.jdField_a_of_type_Bqgk instanceof bqyq))
      {
        ...
        if (!((bqyq)this.jdField_a_of_type_Bqgk).r)
        {
          paramBoolean3 = true;
  ...
  protected boolean a(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        {
          return bool;
          if ((paramMessage.obj == null) || (!(paramMessage.obj instanceof bqgd))) {
            break;
          }
          bqgd localbqgd = (bqgd)paramMessage.obj;
          if (QLog.isColorLevel()) {
            QLog.d("Q.qqstory.publish.edit.StoryDoodle", 2, "showLimitView : left : " + localbqgd.d + " right : " + localbqgd.c + " top : " + localbqgd.jdField_a_of_type_Boolean + " bottom : " + localbqgd.b);
          }
          if (localbqgd.e)
          {
            a(localbqgd.d, localbqgd.c, localbqgd.jdField_a_of_type_Boolean, localbqgd.b);
            break;
          }
