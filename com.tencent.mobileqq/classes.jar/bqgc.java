  ...
  extends bokv
{
  ...
  public List<boma> a;
  private boma jdField_b_of_type_Boma;
  protected Object b;
  String d;
  String e;
  ...
  static
  {
    ...
    File localFile = new File(alkn.d);
    h = localFile.getPath();
  ...
  private ArrayList<boma> a(ArrayList<boma> paramArrayList)
  {
    ArrayList localArrayList = new ArrayList();
    paramArrayList = paramArrayList.iterator();
    while (paramArrayList.hasNext())
    {
      boma localboma = b((boma)paramArrayList.next());
      if ((localboma != null) && (localboma.jdField_a_of_type_JavaUtilList.size() > 0)) {
        localArrayList.add(localboma);
  ...
  public static List<boma> a(bqgc parambqgc, String paramString)
  {
      ...
      try
      {
        ...
        if (parambqgc != null)
        {
          if (((JSONObject)localObject).has("guide_video_url")) {
            parambqgc.d = ((JSONObject)localObject).getString("guide_video_url");
          }
          if (((JSONObject)localObject).has("guide_video_md5")) {
            parambqgc.e = ((JSONObject)localObject).getString("guide_video_md5");
          }
        }
        ...
        parambqgc = paramString.optString("bighead_model_resurl", "");
        ...
        a((List)localObject, str, parambqgc, paramString);
        return localObject;
      }
      catch (JSONException parambqgc) {}
      if (!QLog.isColorLevel()) {
        break;
      }
      parambqgc.printStackTrace();
      return null;
      label152:
      String str = "";
      paramString = "";
  ...
  static List<boma> a(JSONArray paramJSONArray)
  {
      ...
      if (j < k) {
        try
        {
          ...
          if (((JSONObject)localObject).has("content")) {
            localboma.jdField_a_of_type_JavaUtilList = PtvTemplateManager.PtvTemplateInfo.convertFrom(((JSONObject)localObject).getJSONArray("content"));
          }
          if (((JSONObject)localObject).has("categoryName")) {
            localboma.jdField_a_of_type_JavaLangString = ((JSONObject)localObject).getString("categoryName");
          }
          if ((((JSONObject)localObject).has("TipsVer")) && (((JSONObject)localObject).has("Tips")))
          {
            localboma.jdField_b_of_type_Int = ((JSONObject)localObject).getInt("TipsVer");
            localboma.jdField_b_of_type_JavaLangString = ((JSONObject)localObject).getString("Tips");
          }
          localboma.jdField_b_of_type_Boolean = "1".equals(((JSONObject)localObject).optString("random_position"));
          if (((JSONObject)localObject).has("categoryId"))
          {
            localboma.jdField_a_of_type_Int = ((JSONObject)localObject).getInt("categoryId");
            if ((localboma.jdField_a_of_type_JavaUtilList != null) && (!localboma.jdField_a_of_type_JavaUtilList.isEmpty()))
            {
              localObject = localboma.jdField_a_of_type_JavaUtilList.iterator();
              while (((Iterator)localObject).hasNext())
              {
                ((PtvTemplateManager.PtvTemplateInfo)((Iterator)localObject).next()).categoryId = localboma.jdField_a_of_type_Int;
                continue;
                return localArrayList;
              }
            }
  ...
  private static void a(List<boma> paramList, String paramString1, String paramString2, String paramString3)
  {
    ...
    {
      Object localObject = (boma)paramList.next();
      if ((((boma)localObject).jdField_a_of_type_JavaUtilList == null) || (((boma)localObject).jdField_a_of_type_JavaUtilList.size() <= 0)) {
        break;
      }
      localObject = ((boma)localObject).jdField_a_of_type_JavaUtilList.iterator();
      while (((Iterator)localObject).hasNext())
      {
        ...
        for (;;)
        {
          ...
          if (((File)localObject).exists()) {
            ...
            catch (UnsatisfiedLinkError paramString1)
            {
              try
              {
                nmk.a(new File(jdField_b_of_type_JavaIoFile, paramString1), jdField_a_of_type_JavaLangString);
                return true;
              }
  ...
  private boolean b()
  {
    return (this.jdField_a_of_type_Boma != null) && (this.jdField_a_of_type_Boma.jdField_a_of_type_JavaUtilList.size() >= 100);
  }
  ...
  public boma a(boma paramboma)
  {
    ...
    for (;;)
    {
      ...
      {
        paramboma.jdField_a_of_type_JavaUtilList.clear();
        ...
        if (paramboma.jdField_a_of_type_JavaUtilList.size() >= 100) {
          return paramboma;
        }
      }
      paramboma.jdField_a_of_type_JavaUtilList.add(localObject2);
      break label216;
      label212:
      return paramboma;
      label216:
    ...
    do
    {
      ...
      while (!((Iterator)localObject).hasNext())
      {
        do
        {
          ...
          localObject = (boma)localIterator.next();
        } while ((localObject == null) || (((boma)localObject).jdField_a_of_type_JavaUtilList == null) || (((boma)localObject).jdField_a_of_type_Int != boke.jdField_b_of_type_Int));
        localObject = ((boma)localObject).jdField_a_of_type_JavaUtilList.iterator();
      }
      localPtvTemplateInfo = (PtvTemplateManager.PtvTemplateInfo)((Iterator)localObject).next();
    } while (!localPtvTemplateInfo.id.equals(boke.jdField_b_of_type_JavaLangString));
    if (QLog.isColorLevel()) {
  ...
  public PtvTemplateManager.PtvTemplateInfo a(String paramString)
  {
    ...
    do
    {
      ...
      while (!localIterator2.hasNext())
      {
        ...
        localIterator2 = ((boma)localIterator1.next()).jdField_a_of_type_JavaUtilList.iterator();
      }
  ...
  public ArrayList<boma> a(boolean paramBoolean)
  {
    ...
    synchronized (this.jdField_b_of_type_JavaLangObject)
    {
      ...
      {
        this.jdField_a_of_type_Boma = new boma(anni.a(2131708590));
        this.jdField_a_of_type_Boma.jdField_a_of_type_JavaUtilList = new ArrayList(100);
      }
      if (paramBoolean) {
        a(this.jdField_a_of_type_Boma);
      }
      jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(true);
      this.jdField_b_of_type_Boma = b(this.jdField_a_of_type_Boma);
      localArrayList.add(0, this.jdField_b_of_type_Boma);
      if (QLog.isColorLevel()) {
  ...
  public List<boma> a()
  {
    ...
    {
      boma localboma = (boma)localIterator.next();
      if (localboma.jdField_a_of_type_Boolean) {
        localArrayList.add(localboma);
      }
    }
    return localArrayList;
  ...
  public List<boma> a(File paramFile)
  {
    if (QLog.isColorLevel()) {
    ...
    while (localIterator.hasNext())
    {
      Object localObject = (boma)localIterator.next();
      if ((((boma)localObject).jdField_a_of_type_JavaUtilList != null) && (((boma)localObject).jdField_a_of_type_JavaUtilList.size() != 0))
      {
        localObject = ((boma)localObject).jdField_a_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject).hasNext())
  ...
  public void a(AppInterface paramAppInterface, PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo, bqfz parambqfz)
  {
    ...
    b(paramAppInterface, paramPtvTemplateInfo, parambqfz);
  }
  ...
  public void a(PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo, int paramInt)
  {
    for (;;)
    {
      ...
      synchronized (this.jdField_b_of_type_JavaLangObject)
      {
        if (this.jdField_a_of_type_Boma == null)
        {
          this.jdField_a_of_type_Boma = new boma(anni.a(2131708593));
          this.jdField_a_of_type_Boma.jdField_a_of_type_JavaUtilList = new ArrayList(100);
          a(this.jdField_a_of_type_Boma);
        }
        if (this.jdField_b_of_type_Boma == null) {
          this.jdField_b_of_type_Boma = this.jdField_a_of_type_Boma.a();
        }
        j = a(this.jdField_a_of_type_Boma.jdField_a_of_type_JavaUtilList, paramPtvTemplateInfo.id);
        if (j == -1)
        {
          if (!b())
          {
            this.jdField_a_of_type_Boma.jdField_a_of_type_JavaUtilList.add(0, paramPtvTemplateInfo);
            this.jdField_b_of_type_Boma.jdField_a_of_type_JavaUtilList.add(0, paramPtvTemplateInfo);
            if (this.jdField_a_of_type_Bcgy != null) {
              this.jdField_a_of_type_Bcgy.a(paramInt, new Object[] { this.jdField_b_of_type_Boma });
            }
            if (QLog.isColorLevel()) {
          ...
          PtvTemplateManager.PtvTemplateInfo localPtvTemplateInfo = (PtvTemplateManager.PtvTemplateInfo)this.jdField_a_of_type_Boma.jdField_a_of_type_JavaUtilList.remove(99);
          this.jdField_a_of_type_Boma.jdField_a_of_type_JavaUtilList.add(0, paramPtvTemplateInfo);
          this.jdField_b_of_type_Boma.jdField_a_of_type_JavaUtilList.remove(localPtvTemplateInfo);
          this.jdField_b_of_type_Boma.jdField_a_of_type_JavaUtilList.add(0, paramPtvTemplateInfo);
          if (this.jdField_a_of_type_Bcgy == null) {
            continue;
          }
      ...
      if (j != 0)
      {
        this.jdField_a_of_type_Boma.jdField_a_of_type_JavaUtilList.remove(j);
        this.jdField_a_of_type_Boma.jdField_a_of_type_JavaUtilList.add(0, paramPtvTemplateInfo);
      }
    }
  }
  ...
  {
    boke.jdField_b_of_type_JavaLangString = paramString1;
    boke.jdField_b_of_type_Int = paramInt;
    boke.jdField_a_of_type_JavaLangString = paramString2;
  ...
  public void a(List<boma> paramList)
  {
    ...
    Object localObject = (boma)paramList.next();
    ArrayList localArrayList = new ArrayList();
    localArrayList.addAll(((boma)localObject).jdField_a_of_type_JavaUtilList);
    int j = 0;
    label63:
  ...
  protected boma b(boma paramboma)
  {
    if (paramboma == null) {
      return null;
    }
    Object localObject = (bnbo)bojv.a().c(13);
    paramboma = paramboma.a();
    if ((localObject == null) || (!((bnbo)localObject).a())) {
      return paramboma;
    }
    localObject = paramboma.jdField_a_of_type_JavaUtilList.iterator();
    while (((Iterator)localObject).hasNext())
    {
      PtvTemplateManager.PtvTemplateInfo localPtvTemplateInfo = (PtvTemplateManager.PtvTemplateInfo)((Iterator)localObject).next();
  ...
  public void b()
  {
    this.jdField_a_of_type_Boma = null;
    if (QLog.isColorLevel()) {
      QLog.d("QIMPtvTemplateManager", 2, "QIMPtvTemplateManager onDestroy");
    }
  }
  
  public void b(AppInterface paramAppInterface, PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo, bqfz parambqfz)
  {
    ...
    for (;;)
    {
      ...
      localbdvs.jdField_a_of_type_Bdvw = new bqge(this, paramPtvTemplateInfo, parambqfz);
      ...
      localbdvs.jdField_c_of_type_JavaLangString = new File(jdField_b_of_type_JavaIoFile, paramPtvTemplateInfo.name).getPath();
  ...
  public void f()
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
        } while ((this.jdField_a_of_type_Boma.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_Boma.jdField_a_of_type_JavaUtilList.isEmpty()));
        localStringBuilder = new StringBuilder();
        localObject1 = this.jdField_a_of_type_Boma.jdField_a_of_type_JavaUtilList.iterator();
