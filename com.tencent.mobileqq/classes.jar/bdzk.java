  ...
  extends abwx
{
  ...
  private Comparator jdField_a_of_type_JavaUtilComparator = new bdzl(this);
  
  public bdzk(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager, abww paramabww)
  {
  ...
  {
    if ((!paramMessageRecord.isSendFromLocal()) && ((!abwz.a(paramMessageRecord)) || (paramMessageRecord.msgtype == -4012) || (paramMessageRecord.msgtype == -4009) || (paramMessageRecord.msgtype == -5001) || (paramMessageRecord.msgtype == -5021)) && (!abwz.f(paramMessageRecord))) {}
    do
    {
      do
      {
        ...
        {
          return;
        } while ((abwz.j(paramMessageRecord.msgtype)) && (paramMessageRecord.shmsgseq > 0L));
  ...
  private List<MessageRecord> b(String paramString, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if ((localObject1 == null) || (((List)localObject1).isEmpty())) {
      if (paramBoolean1)
      {
        ...
        label428:
        new ArrayList();
        localObject2 = abwz.a(localList, false);
        ...
        if ((!abwz.a(paramString, paramInt, (List)localObject2)) && (abwz.b((List)localObject2)))
        {
          localObject1 = localObject2;
          if (!abwz.c((List)localObject2)) {}
        }
        else
        {
          ...
          localObject1 = abwz.a(localList, false, 30);
        }
        if ((abwz.a((List)localObject1)) || (localObject1 == null) || (((List)localObject1).isEmpty())) {
          break label1065;
        }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localObject2 = abwz.a(localList, true);
        break label735;
        label975:
  ...
  protected int a(String paramString, int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    aybg localaybg = a();
    String str = "( msgtype " + abwz.b() + " and isValid=1 ) and shmsgseq <= ?";
    long l = paramMessageRecord.shmsgseq;
    paramString = localaybg.query(false, paramString, new String[] { "_id" }, str, new String[] { String.valueOf(l) }, null, null, null, null);
    paramInt = i;
    if (paramString != null)
    {
  ...
  public MessageRecord a(String paramString, int paramInt, MessageRecord paramMessageRecord, List<MessageRecord> paramList)
  {
    ...
    label43:
    if (paramInt >= 0) {
      if (abwz.a((MessageRecord)paramList.get(paramInt), paramMessageRecord, true, true)) {
  ...
  public List<MessageRecord> a(String paramString, int paramInt1, long paramLong1, int paramInt2, long paramLong2, int paramInt3, int[] paramArrayOfInt)
  {
    ...
    paramString = bfwn.a(MessageRecord.getOldTableName(paramString, paramInt1), MessageRecord.getTableName(paramString, paramInt1), paramLong1, paramInt2, paramLong2, (String)localObject1, paramInt3, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getReadableDatabase());
    if (paramString == null) {
  ...
  public List<MessageRecord> a(String paramString1, int paramInt1, long paramLong, int paramInt2, String paramString2)
  {
    ...
    if (bfwn.a(MessageRecord.getTableName(paramString1, paramInt1), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getReadableDatabase()))
    {
  ...
  protected List<MessageRecord> a(String paramString, int paramInt, long paramLong1, long paramLong2)
  {
    ...
    if (localObject != null)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if ((localMessageRecord.shmsgseq == paramLong1) && ((!localMessageRecord.isSendFromLocal()) || (localMessageRecord.extraflag == 0)) && (!abwz.a(localMessageRecord))) {
  ...
  protected void a(SessionInfo paramSessionInfo, String paramString, int paramInt, Set<String> paramSet)
  {
    ...
    paramSessionInfo = ((amrb)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).a(paramString);
    paramString = paramSessionInfo.iterator();
    while (paramString.hasNext()) {
  ...
  protected void a(String paramString, int paramInt, long paramLong)
  {
    ...
    {
      a(paramString, paramInt, str2, localContentValues, String.format("isread=? and %s<=? and " + abwz.d(), new Object[] { "shmsgseq" }), new String[] { "0", str1 }, null);
      return;
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((a().a().containsKey(str)) && (paramBoolean))
        {
          ...
          abwz.a((List)localObject, paramMessageRecord, true);
          if ((paramMessageRecord.msgtype == -2006) && (ajul.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt, paramString)) && ((paramMessageRecord instanceof MessageForFoldMsg)) && (!paramMessageRecord.isSend()))
          {
            ...
            this.jdField_a_of_type_Ajul.a((List)localObject, (MessageForFoldMsg)paramMessageRecord);
          }
        }
        return;
        ...
        {
          abwz.b((List)localObject, paramMessageRecord, true);
          continue;
        }
      ...
      {
        abwz.a((List)localObject, paramMessageRecord, false);
      }
      else
      {
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.TroopMsgProxy", 2, "queryMessagesByShmsgseqFromDB, peerUin[" + aszt.e(paramString) + "] type[" + paramInt + "] shmsgseq[" + paramLong1 + "] msgUid[" + paramLong2 + "]");
    }
    ...
    paramString = localaybg.a(paramString, new String[] { String.valueOf(paramLong1) }, localQQAppInterface);
    if (paramString != null) {
      return paramString;
    }
    return new ArrayList();
