...
public class asjc
{
  ...
  static
  {
    ...
    jdField_a_of_type_JavaLangString = alpo.a(2131710667);
    b = alpo.a(2131710666);
    c = alpo.a(2131710668);
  ...
  public static StateListDrawable a(Context paramContext)
  {
    ...
    float f1 = aekt.a(4.0F, paramContext.getResources());
    float f2 = aekt.a(4.0F, paramContext.getResources());
    float f3 = aekt.a(4.0F, paramContext.getResources());
    float f4 = aekt.a(4.0F, paramContext.getResources());
    int i = 0;
    while (i < 2)
    {
      localObject2 = new RoundRectShape(new float[] { f1, f1, f2, f2, f3, f3, f4, f4 }, null, null);
      localShapeDrawable = new ShapeDrawable();
      localShapeDrawable.setPadding(aekt.a(2.0F, paramContext.getResources()), aekt.a(0.0F, paramContext.getResources()), aekt.a(2.0F, paramContext.getResources()), aekt.a(2.0F, paramContext.getResources()));
  ...
  public static StateListDrawable a(Context paramContext, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    ...
    paramFloat1 = aekt.a(paramFloat1, paramContext.getResources());
    paramFloat2 = aekt.a(paramFloat2, paramContext.getResources());
    paramFloat3 = aekt.a(paramFloat3, paramContext.getResources());
    float f = aekt.a(paramFloat4, paramContext.getResources());
    int i = 0;
    if (i < 4)
    {
      ...
      localShapeDrawable = new ShapeDrawable();
      if (paramFloat4 == 0.0F) {
        localShapeDrawable.setPadding(aekt.a(2.0F, paramContext.getResources()), aekt.a(0.0F, paramContext.getResources()), aekt.a(2.0F, paramContext.getResources()), 0);
      }
      for (;;)
      {
        localShapeDrawable.setShape((Shape)localObject2);
  ...
  {
    paramString1 = URLDrawable.getDrawable(paramString1, paramContext.getResources().getDrawable(2130849409), paramContext.getResources().getDrawable(2130849409));
  ...
  public static String a(MessageRecord paramMessageRecord, int paramInt)
  {
    ...
    //   53: astore 9
    //   55: aload_0
    //   56: invokestatic 275	asjc:a	(Lcom/tencent/mobileqq/data/MessageRecord;)Ljava/lang/String;
    //   59: astore 12
    //   61: iload_1
    //   62: ifne +563 -> 625
    ...
    //   86: astore 7
    //   88: getstatic 29	asjc:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   91: aload 7
    //   93: invokeinterface 283 2 0
    //   98: ifeq +73 -> 171
    //   101: getstatic 29	asjc:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   104: aload 7
    ...
    //   381: aload 8
    //   383: astore 7
    //   385: getstatic 29	asjc:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    ...
    //   417: aload 8
    //   419: astore 7
    //   421: getstatic 29	asjc:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    ...
    //   453: aload 8
    //   455: astore 7
    //   457: getstatic 29	asjc:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    ...
    //   489: aload 8
    //   491: astore 7
    //   493: getstatic 29	asjc:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    ...
    //   767: astore 8
    //   769: getstatic 29	asjc:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    ...
    //   1015: checkcast 385	azqk
    //   1018: checkcast 385	azqk
    //   1021: getfield 388	azqk:a	Ljava/util/ArrayList;
    //   1024: astore 8
    //   1026: iload_1
    //   1027: istore_3
    //   1028: iload_2
    ...
    //   1080: checkcast 392	azqj
    //   1083: getfield 393	azqj:b	Ljava/lang/String;
    //   1086: invokestatic 396	asjc:a	(Ljava/lang/String;)Ljava/lang/String;
    //   1089: areturn
    //   1090: iload_1
    //   1091: istore_3
    //   1092: aload 8
    ...
    //   1125: invokestatic 396	asjc:a	(Ljava/lang/String;)Ljava/lang/String;
    //   1128: astore_0
    //   1129: aload_0
    //   1130: areturn
    //   1131: astore_0
  ...
  {
    bclo.a(paramContext, TroopInfoActivity.a(paramString, 3001), 2);
  }
  ...
  public static void a(String paramString1, String paramString2, String paramString3, Context paramContext)
  {
    if (TextUtils.isEmpty(paramString3))
    {
      ...
      QQToast.a(paramContext, 1, alpo.a(2131710665), 0).b(0);
      return;
    }
    ...
    localayup.a(localAppInterface, paramContext, paramString1, paramString3, paramString2, 536870912);
    ((bdpx)localAppInterface.getBusinessHandler(71)).a(paramString1, localAppInterface.getCurrentAccountUin(), 1);
  }
