  ...
  implements Runnable
{
  ...
  public swi(FriendProfileCardActivity paramFriendProfileCardActivity)
  {
  ...
  public void run()
  {
    ...
    for (String str = localFriendProfileCardActivity.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a;; str = null)
    {
      ...
      for (;;)
      {
        Object localObject = ((ApolloManager)localFriendProfileCardActivity.app.getManager(152)).b(str);
        int i;
        if (localObject != null)
        {
          localFriendProfileCardActivity.jdField_n_of_type_Int = ((ApolloBaseInfo)localObject).apolloStatus;
        ...
        for (;;)
        {
          ...
          localFriendProfileCardActivity.jdField_n_of_type_Boolean = bool1;
          ...
          if ((i <= 0) || (arrayOfInt == null) || (arrayOfInt.length <= 0) || (localFriendProfileCardActivity.jdField_n_of_type_Int != 1) || ((i > 0) && (arrayOfInt != null) && (!ApolloActionHelper.a(str, i, arrayOfInt, localFriendProfileCardActivity.app))))
          {
            if (QLog.isColorLevel()) {
              QLog.d("FriendProfileCardActivity", 2, "roleId->" + i + " dressIds->" + arrayOfInt + " apolloStatus->" + localFriendProfileCardActivity.jdField_n_of_type_Int);
            }
