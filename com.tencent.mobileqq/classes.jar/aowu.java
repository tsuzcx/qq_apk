  ...
  extends WebViewPlugin
{
  ...
  protected void a(String paramString)
  {
    ...
    if (this.jdField_a_of_type_AndroidAppDialog == null)
    {
      ...
      localTextView4.setOnClickListener(new aowv(this));
      localTextView3.setOnClickListener(new aoww(this));
      ...
      for (;;)
      {
        ...
        for (i = j;; i = 1)
        {
          ...
          if (((String)localObject1).equals("ask"))
          {
            ...
            a(paramString.getString(2131690146));
  ...
  protected void b()
  {
    ...
    QQToast.a(localActivity, amtj.a(2131699866), 0).a();
  }
