...
public class aoyn
  extends aoxg
{
  public aoyn(QQAppInterface paramQQAppInterface, Context paramContext)
  {
  ...
  private boolean D()
  {
    ...
    if (this.jdField_a_of_type_JavaUtilHashMap.containsKey("openid")) {
      ((Bundle)localObject).putString("openid", c(bhmr.m));
    }
    ...
    bguq.a(this.jdField_a_of_type_AndroidContentContext, (Bundle)localObject, 2);
    return true;
  }
