...
public class nfs
{
  ...
  private void f()
  {
    ...
    if (!this.jdField_a_of_type_Aobt.a()) {
    ...
    synchronized (this.jdField_a_of_type_ArrayOfByte)
    {
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_Aobt.a(this.jdField_a_of_type_ArrayOfJavaNioByteBuffer[0], this.jdField_a_of_type_ArrayOfJavaNioByteBuffer[1], this.jdField_a_of_type_ArrayOfJavaNioByteBuffer[2], this.jdField_c_of_type_Int, this.jdField_d_of_type_Int);
  ...
  private void g()
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_Aobt.a(arrayOfFloat);
      return;
      label241:
      if (f1 > f2)
      {
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Aobt = null;
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_Aobt = new aobt(0);
    this.jdField_a_of_type_ArrayOfByte = new byte[1];
    this.jdField_b_of_type_ArrayOfByte = new byte[1];
    this.jdField_c_of_type_ArrayOfByte = new byte[1];
