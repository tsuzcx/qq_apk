...
public class aswv
{
  private static HashMap<String, aswv> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private final Context jdField_a_of_type_AndroidContentContext;
  private Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new asww(this);
  ...
  private aswv(Context paramContext, File paramFile, String paramString)
  {
    ...
    this.jdField_a_of_type_Boolean = aswd.a();
  ...
  public static aswv a(Context paramContext, String paramString1, String paramString2)
  {
    try
    {
      String str = paramString2 + paramString1;
      aswv localaswv = (aswv)jdField_a_of_type_JavaUtilHashMap.get(str);
      paramString1 = localaswv;
      if (localaswv == null)
      {
        paramString1 = new aswv(paramContext.getApplicationContext(), a(paramContext), paramString2);
  ...
  private InstalledPlugin a(ProgressFuture<InstalledPlugin> paramProgressFuture)
  {
    ...
    if ((!this.jdField_b_of_type_Boolean) && (aswy.jdField_a_of_type_Boolean))
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (str.equals("SOURCE_CGI"))
        {
          ...
          aswy.a("2653754");
          localObject1 = localObject2;
          a("HuayangPluginNewDownloader", alpo.a(2131706015) + localTargetDownloadInfo.url);
          localObject1 = localObject2;
      ...
      catch (VersionCheckException localVersionCheckException)
      {
        ...
        try
        {
          ...
          localObject3 = localInstalledPlugin;
          a("HuayangPluginNewDownloader", alpo.a(2131706029) + k);
          localObject3 = localInstalledPlugin;
          if (!str.equals("SOURCE_CGI")) {
            continue;
          }
  ...
  private void a(InstalledPlugin paramInstalledPlugin)
  {
    ...
    try
    {
      ...
      a("HuayangPluginNewDownloader", alpo.a(2131706011));
      str1 = str2;
      if (!this.jdField_b_of_type_Boolean)
      {
  ...
  {
    Object localObject = new StringBuilder().append(alpo.a(2131706017));
    boolean bool;
    if (paramInstalledPlugin == null)
    {
      bool = true;
  ...
  {
    Intent localIntent = new Intent(aswm.c(this.jdField_b_of_type_JavaLangString));
    int i;
    if (paramBoolean)
    {
      i = 1;
      ...
      if (!paramBoolean)
      {
        if (!aswm.a(this.jdField_b_of_type_JavaLangString)) {
          break label64;
        }
        aswy.a("2714209");
      }
    ...
    label64:
    while (!aswm.b(this.jdField_b_of_type_JavaLangString))
    {
      return;
      i = 0;
      break;
  ...
  private void b(InstalledPlugin paramInstalledPlugin)
  {
    ...
    if (this.jdField_a_of_type_Aswx != null) {
      this.jdField_a_of_type_Aswx.a(10, new Object[0]);
    }
    ...
    a("HuayangPluginNewDownloader", alpo.a(2131706031));
  }
  
  private void b(InstalledPlugin paramInstalledPlugin, boolean paramBoolean)
  {
    a("HuayangPluginNewDownloader", alpo.a(2131706019) + paramInstalledPlugin);
  ...
  private void c()
  {
    ...
    if ((localObject1 != null) && (((List)localObject1).size() > 0))
    {
      ...
      {
        a("HuayangPluginNewDownloader", alpo.a(2131706026) + (String)localObject3 + " mPluginVersion:" + this.e);
    ...
    for (;;)
    {
      try
      {
        ...
        if ((!"huiyin".equals(this.d)) || (bdee.a(this.jdField_a_of_type_AndroidContentContext)) || (!bool)) {
          break label559;
        }
        return;
      }
      ...
      if (aswz.jdField_a_of_type_JavaUtilMap.get(this.d) != null) {
        aswy.b(String.valueOf(((aswz)aswz.jdField_a_of_type_JavaUtilMap.get(this.d)).g));
      }
      localObject3 = null;
      break;
      label553:
    ...
    if (!this.jdField_b_of_type_Boolean) {
      if (localException1 == null)
      {
        ...
        a("HuayangPluginNewDownloader", alpo.a(2131706025));
  ...
  {
    this.jdField_a_of_type_Aswx = paramaswx;
  }
