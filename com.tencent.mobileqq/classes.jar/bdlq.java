...
public abstract class bdlq
  extends bdyc
  implements Handler.Callback, bdcx
{
  public static final String TAG = "AppRuntimeLoader";
  private boolean isSucceed;
  private Map<String, bdxz> mActivatedTasks;
  private final bdll mAppStateManager;
  protected Context mContext;
  private final bdlf mEventCenter;
  protected Handler mHandler;
  protected boolean mIsRunning;
  protected MiniAppInfo mMiniAppInfo;
  protected bdcw mRuntime;
  protected bdls mRuntimeLoadListener;
  protected boolean runtimeLoadCompleted;
  
  /* Error */
  public bdlq(Context paramContext)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokespecial 40	bdyc:<init>	()V
    //   4: aload_0
    //   5: new 42	bdlf
    //   8: dup
    //   9: invokespecial 43	bdlf:<init>	()V
    //   12: putfield 45	bdlq:mEventCenter	Lbdlf;
    //   15: aload_0
    //   16: new 47	bdll
    //   19: dup
    //   20: aload_0
    //   21: invokespecial 50	bdll:<init>	(Lbdlq;)V
    //   24: putfield 52	bdlq:mAppStateManager	Lbdll;
    //   27: aload_0
    //   28: aload_1
    //   29: putfield 54	bdlq:mContext	Landroid/content/Context;
    //   32: aload_0
    //   33: new 56	java/util/HashMap
    //   36: dup
    //   37: invokespecial 57	java/util/HashMap:<init>	()V
    //   40: putfield 59	bdlq:mActivatedTasks	Ljava/util/Map;
    //   43: aload_0
    //   44: getfield 45	bdlq:mEventCenter	Lbdlf;
    //   47: aload_0
    //   48: getfield 52	bdlq:mAppStateManager	Lbdll;
    //   51: invokevirtual 63	bdlf:addObserver	(Ljava/util/Observer;)V
    ...
    //   95: putfield 86	bdlq:mHandler	Landroid/os/Handler;
    //   98: aload_0
    //   99: invokespecial 89	bdlq:initTask	()V
    //   102: return
    //   103: aload_0
    ...
    //   115: putfield 86	bdlq:mHandler	Landroid/os/Handler;
    //   118: goto -20 -> 98
    //   121: astore_3
    //   122: aconst_null
    //   123: astore_2
    ...
    //   128: ldc 96
    //   130: aload_3
    //   131: invokestatic 102	bdnw:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   134: aload_2
    //   135: ifnull +29 -> 164
    //   138: aload_2
    ...
    //   158: putfield 86	bdlq:mHandler	Landroid/os/Handler;
    //   161: goto -63 -> 98
    //   164: aload_0
    ...
    //   176: putfield 86	bdlq:mHandler	Landroid/os/Handler;
    //   179: goto -81 -> 98
    //   182: astore_2
    //   183: aconst_null
    //   184: astore_1
    ...
    //   209: putfield 86	bdlq:mHandler	Landroid/os/Handler;
    //   212: aload_2
    //   213: athrow
    //   214: aload_0
    ...
    //   226: putfield 86	bdlq:mHandler	Landroid/os/Handler;
    //   229: goto -17 -> 212
    //   232: astore_2
    //   233: goto -48 -> 185
    //   236: astore_3
  ...
  public void addRuntimeStateObserver(bdlh parambdlh)
  {
    this.mEventCenter.addObserver(parambdlh);
  }
  
  public void addTask(bdxz parambdxz)
  {
    if (parambdxz == null) {
      return;
    }
    String str = parambdxz.getClass().getCanonicalName();
    if (this.mActivatedTasks.containsKey(str))
    {
      bdnw.c("AppRuntimeLoader", "Failed to add task: duplicated " + str);
      return;
    }
    this.mActivatedTasks.put(str, parambdxz);
  }
  
  public void addTasks(bdxz... paramVarArgs)
  {
  ...
  public abstract bdxz[] createTasks();
  ...
  public bdll getAppStateManager()
  {
  ...
  public bdcw getRuntime()
  {
    return this.mRuntime;
  }
  
  public bdxz getTask(Class paramClass)
  {
    return (bdxz)this.mActivatedTasks.get(paramClass.getCanonicalName());
  }
  
  public boolean handleMessage(Message paramMessage)
  {
    bdnw.a("AppRuntimeLoader", "handleMessage " + paramMessage.what);
    return false;
  }
  ...
  {
    bdlg localbdlg = bdlg.a(paramInt, this);
    if ((paramVarArgs != null) && (paramVarArgs.length > 0)) {
      localbdlg.a = paramVarArgs[0];
    }
    this.mEventCenter.a(localbdlg);
  }
  ...
  public void removeRuntimeStateObserver(bdlh parambdlh)
  {
    this.mEventCenter.deleteObserver(parambdlh);
  }
  
  public void setRuntimeLoadListener(bdls parambdls)
  {
    this.mRuntimeLoadListener = parambdls;
  }
