  ...
  implements Animation.AnimationListener
{
  ...
  protected static final int m = (int)BaseApplicationImpl.getApplication().getResources().getDimension(2131297463);
  protected float a;
  protected Handler a;
  ...
  public bfpv()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new bfpw(this);
  }
  ...
  private void a(TextView paramTextView, int paramInt)
  {
    ...
    if (paramInt == e)
    {
      paramTextView.setText(2131696932);
      paramTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130842343, 0);
