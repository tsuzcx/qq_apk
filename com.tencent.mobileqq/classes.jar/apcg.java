...
public class apcg
{
  private ArrayList<apch> a = new ArrayList();
  
  /* Error */
  public static apcg a(String paramString)
  {
    // Byte code:
    ...
    //   103: aload_2
    //   104: invokestatic 100	apcg:b	(Ljava/lang/String;)Lapcg;
    //   107: astore_2
    //   108: aload_0
    //   109: ifnull +7 -> 116
    //   112: aload_0
  ...
  public static apcg b(String paramString)
  {
    try
    {
      Object localObject = new JSONObject(paramString);
      apcg localapcg = new apcg();
      JSONArray localJSONArray = ((JSONObject)localObject).getJSONArray("360senceinfo");
      paramString = localapcg;
      if (((JSONObject)localObject).has("360senceinfo"))
      {
        ...
        if (j > 0)
        {
          ...
          for (;;)
          {
            ...
            localObject = new apch();
            if (paramString.has("text")) {
              ((apch)localObject).jdField_a_of_type_JavaLangString = paramString.optString("text");
            }
            if (paramString.has("starttime")) {
              ((apch)localObject).jdField_a_of_type_Long = paramString.optLong("starttime");
            }
            if (paramString.has("endtime")) {
              ((apch)localObject).b = paramString.optLong("endtime");
            }
            localapcg.a.add(localObject);
            if (QLog.isColorLevel()) {
              QLog.d("ARTransferDoorVideoInfo", 2, "ARTransferDoorVideoInfo parseJson index: " + i + "," + ((apch)localObject).toString());
            }
            i += 1;
          }
        }
  ...
  public apch a(long paramLong)
  {
    Iterator localIterator = this.a.iterator();
    while (localIterator.hasNext())
    {
      apch localapch = (apch)localIterator.next();
      long l = localapch.jdField_a_of_type_Long;
      if ((paramLong < localapch.b * 1000L) && (paramLong >= l * 1000L)) {
        return localapch;
      }
    }
    return null;
