  ...
  implements View.OnTouchListener
{
  ...
  private aako jdField_a_of_type_Aako;
  ...
  String a(String paramString, long paramLong, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      i = 1;
      j = azgq.b(BaseApplicationImpl.getContext());
      k = azgq.a(BaseApplicationImpl.getContext());
    ...
    for (;;)
    {
      ...
      {
        String str;
        aanp.d("GdtMotiveVideoClickCoordinateReportHelper", "getReportString error", localException);
        continue;
        paramString = "?";
        continue;
      }
      ...
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        if (!paramString.contains("&s={"))
        {
          ...
          aanp.d("GdtMotiveVideoClickCoordinateReportHelper", "getReportString click url result : " + (String)localObject);
        }
      }
      return localObject;
      i = 0;
  ...
  public void a()
  {
    this.jdField_a_of_type_Aako = null;
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Aako != null) {
        this.jdField_a_of_type_Aako.a(this.jdField_a_of_type_Long, this.jdField_b_of_type_Long, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, this.c, this.d);
      }
    }
  }
}
