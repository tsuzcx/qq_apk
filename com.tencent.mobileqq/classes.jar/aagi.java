  ...
  implements aajc, aakc
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = aagi.class.getSimpleName();
  }
  
  public aagi(Bundle paramBundle)
  {
    super(paramBundle);
  }
  ...
  private void a()
  {
    ...
    if ((getParentFragment() instanceof SubscribeBaseFragment)) {
      this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentBottomBar.setShareClickListener(new aagj(this));
    }
  ...
  private boolean a(long paramLong, CertifiedAccountMeta.StFeed paramStFeed)
  {
    ...
    } while (!aaek.a(paramStFeed.poster.attr.get()));
    return false;
  }
  ...
  public aagc a(int paramInt)
  {
    ...
    localaagc.jdField_a_of_type_JavaLangString = this.jdField_b_of_type_JavaLangString;
    localaagc.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StShare = this.jdField_b_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StShare;
    if (paramInt == 1) {}
    for (;;)
    {
      localaagc.jdField_a_of_type_Boolean = bool;
      localaagc.jdField_a_of_type_Int = paramInt;
      return localaagc;
      bool = false;
    }
  }
  ...
  public aamx a()
  {
    return this.jdField_a_of_type_Aamx;
  }
  ...
  protected void a(long paramLong, String paramString)
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizSubscribeWidgetStatusView != null)
    {
      ...
      this.jdField_a_of_type_ComTencentBizSubscribeWidgetStatusView.d(str);
    }
  ...
  public void a(CertifiedAccountMeta.StFeed paramStFeed)
  {
    ...
    setShareData("share_key_subscribe_feeds_update", new aabn(paramStFeed));
    if ((getParentFragment() instanceof SubscribeBaseFragment)) {
  ...
  public void c(CertifiedAccountMeta.StFeed paramStFeed)
  {
    ...
    if ((!aaek.a(paramStFeed.poster.attr.get())) && (getActivity() != null))
    {
      aans.a().a(getActivity(), "subscribe_freshman_interaction_guide", 5000, new aagp(this, paramStFeed));
      getActivity().runOnUiThread(new DetailBaseBlock.6(this));
      aans.a().a(getActivity(), "subscribe_freshman_share_guide", 10000, new aagq(this));
    }
  }
  ...
  protected void f()
  {
    ...
    {
      return;
      this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentBottomBar.a(getParentFragment().getActivity(), this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed, new aagk(this), this.jdField_a_of_type_ComTencentBizSubscribeBaseUIExtraTypeInfo);
  ...
  public void h()
  {
    zzc.a().a((String)aaed.b.get("follow_guide_pics"), 4000, new aagl(this), true);
  }
  
  public void i()
  {
    zzc.a().a((String)aaed.b.get("praise_guide_pics"), 4000, new aagn(this), true);
  }
  ...
  public void onInitBlock(Bundle paramBundle)
  {
    ...
    try
    {
      ...
      setShareData("share_key_subscribe_feeds_update", new aabn(this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed));
      if (!this.jdField_a_of_type_Boolean)
      {
        this.jdField_a_of_type_ComTencentBizSubscribeWidgetStatusView = getBlockContainer().a();
        paramBundle = aaek.a() + File.separator + a(getExtraTypeInfo()) + ".png";
