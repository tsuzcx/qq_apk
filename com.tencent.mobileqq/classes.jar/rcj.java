  ...
  implements View.OnClickListener
{
  ...
  static
  {
    jdField_a_of_type_Rck = new rck(null);
  }
  
  public rcj(@NotNull ViewGroup paramViewGroup, @Nullable Function1<? super Integer, Unit> paramFunction1)
  {
    this.jdField_a_of_type_AndroidViewViewGroup = paramViewGroup;
    this.jdField_a_of_type_KotlinJvmFunctionsFunction1 = paramFunction1;
    this.jdField_a_of_type_AndroidViewView = b();
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364554));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371286));
    this.b = this.jdField_a_of_type_AndroidViewView.findViewById(2131370541);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131365499));
    c();
  }
  ...
  public final void b(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      localAlphaAnimation.setDuration(250L);
      localAlphaAnimation.setFillAfter(true);
      localAlphaAnimation.setAnimationListener((Animation.AnimationListener)new rcl(this));
      View localView = this.jdField_a_of_type_AndroidViewView;
      if (localView != null) {
        localView.startAnimation((Animation)localAlphaAnimation);
      }
