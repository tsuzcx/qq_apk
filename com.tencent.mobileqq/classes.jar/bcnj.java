...
public class bcnj
{
  ...
  {
    new bhhm("QC.HomepageLogicServer.HomepageLogicObj", "QcHomePageLogic.GetConciseThemeReq", "stReq", "stRsp").a("GetConciseTheme", new GetConciseThemeReq(bhhm.a()), new GetConciseThemeRsp(), new bcnk(paramString, paramAppInterface, paramBoolean), false);
  }
      ...
      if (true == jdField_a_of_type_Boolean)
      {
        ...
        for (;;)
        {
          ...
          if ((ImmersiveUtils.isSupporImmersive() != 0) && (paramImmersiveTitleBar2 != null)) {
            paramImmersiveTitleBar2.setBackgroundColor(BaseApplicationImpl.getApplication().getResources().getColor(2131167042));
          }
        }
      }
      ...
      if (true == jdField_a_of_type_Boolean)
      {
        ...
        for (;;)
        {
          ...
          if ((ImmersiveUtils.isSupporImmersive() != 0) && (paramSystemBarCompact != null)) {
            paramSystemBarCompact.setStatusBarColor(2131167042);
          }
        }
      }
  ...
  private static final void a(String paramString)
  {
    ...
    {
      localObject = (bcnd)((QQAppInterface)localObject).a(154);
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      ((bcnd)localObject).a(bool, i);
      ((bcnd)localObject).notifyUI(4, true, new Object[] { Boolean.valueOf(bool), Integer.valueOf(i), paramString });
