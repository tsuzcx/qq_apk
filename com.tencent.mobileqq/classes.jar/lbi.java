  ...
  implements lbg
{
  ...
  public void a(String paramString, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Bimz == null) {
        this.jdField_a_of_type_Bimz = new bimz(this.mRuntime.a());
      }
      if ("checkAioShareMusic".equals(paramString))
      {
        this.jdField_a_of_type_Bimz.a(paramJSONObject);
        return;
      }
      if ("startListenAioShareMusic".equals(paramString))
      {
        this.jdField_a_of_type_Bimz.b(paramJSONObject);
        return;
      }
      if ("updateSongIdToAioShareMusic".equals(paramString)) {
        try
        {
          ...
          this.jdField_a_of_type_Bimz.a = paramString;
          if (QLog.isColorLevel())
          {
  ...
  public boolean handleEvent(String paramString, long paramLong, Map<String, Object> paramMap)
  {
    ...
    if (paramLong == 8589934594L)
    {
      if (!this.jdField_a_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_Bimz.a(this.mRuntime.a().getIntent());
        return true;
      }
    }
    else if (paramLong == 8589934622L)
    {
      ...
      if ((localObject != null) && ((localObject instanceof Intent)))
      {
        ...
        this.jdField_a_of_type_Bimz.b(paramString);
        return true;
      }
    }
  ...
  public void onDestroy()
  {
    ...
    if (this.jdField_a_of_type_Bimz != null)
    {
      this.jdField_a_of_type_Bimz.a();
      this.jdField_a_of_type_Bimz = null;
    }
    lbe.a().a();
  }
}
