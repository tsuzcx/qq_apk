...
import com.tencent.mobileqq.activity.aio.rebuild.TroopChatPie.33.1;
  ...
  extends aebj
{
  ...
  protected void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    case 1: 
    case 2: 
      paramString = this.a.b.obtainMessage(5, 1, 0, this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131624473));
    ...
    for (;;)
    {
      this.a.H();
      return;
      paramString = this.a.b.obtainMessage(5, 1, 0, this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131624467));
      this.a.b.sendMessage(paramString);
    }
  }
  ...
  protected void a(String paramString1, int paramInt1, int paramInt2, SendMessageHandler paramSendMessageHandler, long paramLong1, long paramLong2, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      ThreadManager.getUIHandler().post(new TroopChatPie.33.1(this, paramSendMessageHandler));
      break;
      bool = true;
      continue;
      paramString1 = this.a.b.obtainMessage(5, 1, 0, this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131624473));
      this.a.b.sendMessage(paramString1);
      break label388;
      paramString1 = this.a.b.obtainMessage(5, 1, 0, this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131624467));
      this.a.b.sendMessage(paramString1);
      break label388;
      paramString1 = paramString2;
      if (TextUtils.isEmpty(paramString2)) {
        paramString1 = this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131630656);
      }
      ...
      paramString1 = paramString2;
      if (TextUtils.isEmpty(paramString2)) {
        paramString1 = this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131630648);
      }
      paramString1 = this.a.b.obtainMessage(5, 1, 0, paramString1);
      this.a.b.sendMessage(paramString1);
      break label388;
  ...
  public void a(List<MessageRecord> paramList)
  {
    ...
    {
      if ((paramList != null) && (aejb.c(this.a).a() == 35)) {
        this.a.b(true, true);
      }
      return;
    }
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2, List<MessageRecord> paramList)
  {
    if (paramBoolean1)
    {
      ...
      List localList = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(ajed.N, 0);
