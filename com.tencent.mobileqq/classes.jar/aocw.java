...
public class aocw
{
  public static int a(String paramString)
  {
    try
    {
      int i = aocy.a("arfeature", "v8.0.0", aocy.b("arfeature", "v8.0.0", "arfeature"), paramString);
      return i;
    }
    finally
    {
  ...
  public static int a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        aocy.a("arfeature", "v8.0.0", "arfeature", paramString2);
        try
        {
          aocu.a(paramString1, aocy.a("arfeature", "v8.0.0", aocy.b("arfeature", "v8.0.0", "arfeature")));
          paramString2 = aocy.a("arfeature", "v8.0.0", aocy.b("arfeature", "v8.0.0", "arfeature")) + File.separator + "md5_config.xml";
        ...
        catch (IOException paramString2)
        {
          ...
          String str;
          i = -6;
          FileUtils.delete(aocy.a("arfeature", "v8.0.0", aocy.b("arfeature", "v8.0.0", "arfeature")), false);
      ...
      try
      {
        ...
        {
          paramString1 = aocy.a("arfeature", "v8.0.0", aocy.b("arfeature", "v8.0.0", "arfeature")) + File.separator + (String)((Map.Entry)localObject).getKey() + ".so";
          aocy.a("arfeature", "v8.0.0", "libARFeature", (String)((Map.Entry)localObject).getValue());
        }
  ...
  {
    return new File(aocy.a("arfeature", "v8.0.0", aocy.b("arfeature", "v8.0.0", "arfeature")) + File.separator + "libARFeature" + ".so").exists();
  }
}
