...
public class bfpx
{
  ...
  public bfpx(boolean paramBoolean1, String paramString1, String paramString2, boolean paramBoolean2, String paramString3, String paramString4)
  {
  ...
  public static bfpx a(aqxa[] paramArrayOfaqxa)
  {
    localObject2 = "";
    localObject1 = "";
    localObject3 = "";
    ...
    i = 0;
    int k = 0;
    if (n < paramArrayOfaqxa.length)
    {
      Object localObject4 = paramArrayOfaqxa[n].jdField_a_of_type_JavaLangString;
    ...
    {
      paramArrayOfaqxa = new bfpx(bool1, (String)localObject2, (String)localObject1, bool2, (String)localObject3, (String)localObject9);
      if (QLog.isColorLevel()) {
        QLog.i("PublishHwkThirdPartyEntryConfig", 2, paramArrayOfaqxa.toString());
      }
