...
public class bfpx
{
  ...
  public static void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    paramString2.putExtra("selfSet_leftViewText", anni.a(2131712256));
    if (bhog.a.containsKey("robotsummary")) {
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, int paramInt)
  {
    ...
    paramString5 = afur.a(new Intent(paramContext, SplashActivity.class), null);
    if (paramInt == 1)
    {
  ...
  public static void a(BaseActivity paramBaseActivity, String paramString)
  {
    ...
    localIntent.putExtra("selfSet_leftViewText", anni.a(2131712258));
    if (bhog.a.containsKey("robotsummary")) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    do
    {
      ...
      paramString1 = anni.a(2131712257) + paramString2;
      localObject2 = new bcvp(StructMsgForGeneralShare.class).c(14).a(anni.a(2131712260) + paramString3).a(2).a(1).a("web", paramQQAppInterface, (String)localObject2, (String)localObject1, (String)localObject1).d(paramActivity.getResources().getString(2131717275)).a();
      bczv localbczv = new bczv();
      localbczv.b(1);
      localbczv.a(anni.a(2131712259));
      bcyl localbcyl = new bcyl();
      localbcyl.b(1);
      localbcyl.a(new bcxv((String)localObject1));
      localbcyl.a(new StructMsgItemTitle(paramString3));
      localbcyl.a(new bdaq(paramString1));
      ((AbsShareMsg)localObject2).addItem(localbczv);
      ...
      aufz.a(paramActivity, (Intent)localObject2, paramInt);
    } while (!QLog.isColorLevel());
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3)
  {
    try
    {
      ...
      bcst.b(paramQQAppInterface, "dc00898", "", "", paramString1, paramString1, 0, 0, paramString2, "", paramString3, "");
      return;
    }
    catch (Exception paramString2)
    {
      bcst.b(paramQQAppInterface, "dc00898", "", "", paramString1, paramString1, 0, 0, "0", "", paramString3, "");
    }
  }
  ...
  public static void a(boolean paramBoolean, String paramString)
  {
    ...
    for (localObject = (QQAppInterface)localObject;; localObject = null)
    {
      ...
      ((bftx)localObject).a(paramBoolean, paramString);
      return;
    }
  }
  ...
  public static boolean a(String paramString1, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    ((anwd)localQQAppInterface.a(20)).a(paramString1, paramString2, paramString3, Boolean.valueOf(paramBoolean));
    return true;
  }
  ...
  public static String b(String paramString)
  {
    ...
    if ((localAppRuntime instanceof QQAppInterface)) {
      return bglf.a((QQAppInterface)localAppRuntime, paramString, false);
    }
    return null;
  }
