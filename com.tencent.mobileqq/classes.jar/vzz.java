...
public class vzz
{
  ...
  public static waa a(Object paramObject)
  {
    int k = 1;
    String str1 = "1";
    String str3 = "";
    ...
    for (int i = 2;; i = 1)
    {
      ...
      j = 1;
      if (bbjw.a(paramObject))
      {
        paramObject = "weishi://camera?logsour=3006";
        i = k;
        label105:
        localwaa = new waa();
        localwaa.jdField_a_of_type_JavaLangString = str1;
        localwaa.jdField_b_of_type_JavaLangString = str3;
        localwaa.jdField_c_of_type_JavaLangString = str2;
        localwaa.jdField_a_of_type_Int = i;
        localwaa.e = str4;
        localwaa.f = paramObject;
        localwaa.g = ((String)localObject);
        localwaa.jdField_b_of_type_Int = j;
        if (i == 2)
        {
          localwaa.jdField_d_of_type_JavaLangString = "DOV";
          return localwaa;
          str1 = "11";
          str3 = ((QIMFilterCategoryItem)localObject).jdField_b_of_type_JavaLangString;
          paramObject = ((QIMFilterCategoryItem)localObject).h;
        ...
        for (i = 2;; i = 1)
        {
          ...
          if ((paramObject instanceof QIMBeautyItem))
          {
            ...
            for (i = 2;; i = 1)
            {
              ...
              break;
              localwaa.jdField_d_of_type_JavaLangString = ajyc.a(2131716902);
              return localwaa;
              break label105;
            }
          }
  ...
  public static wcc a(Context paramContext, Object paramObject)
  {
    waa localwaa = a(paramObject);
    if (localwaa == null) {
      return null;
    }
    String str1 = localwaa.jdField_a_of_type_JavaLangString;
    String str2 = localwaa.jdField_b_of_type_JavaLangString;
    String str3 = localwaa.f;
    int j = localwaa.jdField_a_of_type_Int;
    String str4 = localwaa.e;
    int k = localwaa.jdField_b_of_type_Int;
    int i;
    int m;
    ...
    for (;;)
    {
      ...
      if (j == 2)
      {
        if (bbfd.a(paramContext, "com.tencent.qim"))
        {
          axqw.b(null, "dc00899", "grp_story", "", "app_share", "clk_entry", i, 1, str4, "dov", "", "");
          bbfd.a(paramContext, "com.tencent.qim", null);
        }
        for (;;)
        {
          return null;
          ...
          break label117;
          axqw.b(null, "dc00899", "grp_story", "", "app_share", "clk_entry", i, 0, str4, "dov", "", "");
          ttl.a(paramContext);
        }
      }
      label174:
      ...
      {
        axqw.b(null, "dc00898", "", "", "weishi_share_shoot", (String)localObject, k, 0, "", "", "", "");
        axqw.b(null, "dc00899", "grp_story", "", "weishi_share", localwaa.g, 0, 0, str1, str2, "", "");
        if (!a(paramContext)) {
          break;
        }
        axqw.b(null, "dc00899", "grp_story", "", "app_share", "clk_entry", i, 1, str4, "weishi", "", "");
        axqw.b(null, "dc00899", "grp_story", "", "weishi_share", "clk_ws", 0, 1, str1, str2, "", "");
      ...
      axqw.b(null, "dc00899", "grp_story", "", "app_share", "clk_entry", i, 0, str4, "weishi", "", "");
      localObject = localwaa.jdField_c_of_type_JavaLangString;
      axqw.b(null, "dc00899", "grp_story", "", "weishi_share", "clk_ws", 0, 2, str1, str2, "", "");
      paramContext = new wcc(paramContext, 2131755995, paramObject);
  ...
  {
    if (!vyp.b(paramContext))
    {
      bcpw.a(paramContext, ajyc.a(2131716904), 0).a();
      return;
    }
    bkyx.a().a();
    ...
    {
      veg.d("WeishiGuideUtils", "get null info");
      return;
    }
  ...
  public static void a(Object paramObject)
  {
    ...
    axqw.b(null, "dc00898", "", "", "weishi_share_shoot", "story_entry_exp", j, 0, "", "", "", "");
  }
  
  public static boolean a(Context paramContext)
  {
    return bbfd.a(paramContext, "com.tencent.weishi");
  }
}
