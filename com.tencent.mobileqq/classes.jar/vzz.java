  ...
  implements Boss, MonitorThreadPoolExecutor.ThreadPoolMonitorListener
{
  ...
  private final Executor jdField_a_of_type_JavaUtilConcurrentExecutor = new wab("StoryBoss.NetworkExecutor", 128, jdField_c_of_type_Int, null);
  private final Executor[] jdField_a_of_type_ArrayOfJavaUtilConcurrentExecutor = new Executor[3];
  private long jdField_b_of_type_Long;
  private final Executor jdField_b_of_type_JavaUtilConcurrentExecutor = new wab("StoryBoss.CpuExecutor", 16, jdField_a_of_type_Int, null);
  private final Executor jdField_c_of_type_JavaUtilConcurrentExecutor = new wab("StoryBoss.FileExecutor", 64, jdField_b_of_type_Int, null);
  
  public vzz(Context paramContext)
  {
    ...
    this.jdField_a_of_type_ComTribeAsyncAsyncLightWeightExecutor = new LightWeightExecutor(wad.a().getDefaultLooper(), 100);
    this.jdField_a_of_type_ComTribeAsyncAsyncLightWeightExecutor.setMonitorListener(this);
    this.jdField_a_of_type_AndroidOsHandler = new Handler(wad.a().getDefaultLooper());
    this.jdField_a_of_type_ComTribeAsyncAsyncJobController = new JobController(this);
    wad.a().registerSubscriber("root_group", this.jdField_a_of_type_ComTribeAsyncAsyncJobController);
  }
  ...
  private <Params, Progress, Result> Future<Result> a(Job<Params, Progress, Result> paramJob, int paramInt1, int paramInt2, @Nullable FutureListener<Progress, Result> paramFutureListener, @Nullable Params paramParams)
  {
    ...
    paramJob.addFutureListener(new waa(this, paramJob));
    if (paramInt1 == 0)
    {
      wad.a().dispatch(paramJob);
      return paramJob;
    }
    wad.a().dispatchDelayed(paramJob, paramInt1);
    return paramJob;
  }
  ...
  public <Params, Progress, Result> Future<Result> a(Job<Params, Progress, Result> paramJob, @Nullable FutureListener<Progress, Result> paramFutureListener, @Nullable Params paramParams)
  {
    ...
    if (paramJob != null) {
      ykq.b("StoryBoss", "work hash code:" + paramJob.hashCode());
    }
    return paramJob;
  }
  ...
  public <Result> void cancelJob(Future<Result> paramFuture, boolean paramBoolean)
  {
    if ((paramFuture instanceof Worker)) {
      wad.a().cancelDispatch("", (Worker)paramFuture);
    }
    wad.a().dispatch(new JobController.CancelCommand(paramFuture, paramBoolean));
  }
  ...
  {
    ykq.e("StoryBoss", paramString + " onQueueExceedLimit, size = " + paramInt);
  ...
  public void onWorkerExceedTime(String paramString, List<Runnable> paramList, int paramInt)
  {
    ...
    for (;;)
    {
      ykq.e("StoryBoss", paramString + " onWorkerExceedTime, runnable = " + paramList);
