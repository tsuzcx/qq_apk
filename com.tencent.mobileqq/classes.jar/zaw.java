  ...
  implements MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnSeekCompleteListener
{
  ...
  public void a(VsMusicItemInfo paramVsMusicItemInfo)
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewVsMusicItemInfo != null)
    {
      ...
      zaj.a("edit_smart_music_play", zaj.a((HashMap)localObject));
    }
    ...
    do
    {
      ...
      } while (this.jdField_a_of_type_Zax == null);
      this.jdField_a_of_type_Zax.a(this.jdField_a_of_type_AndroidMediaMediaPlayer, -2, -1);
      return;
    ...
    this.jdField_a_of_type_Zax.a(this.jdField_a_of_type_AndroidMediaMediaPlayer, -1, -1);
    return;
  ...
  public void a(zax paramzax)
  {
    this.jdField_a_of_type_Zax = paramzax;
  }
  ...
  {
    if ((this.jdField_a_of_type_Zax != null) && (paramInt1 != -38)) {
      this.jdField_a_of_type_Zax.a(paramMediaPlayer, paramInt1, paramInt2);
    }
    return false;
  }
  ...
  {
    if ((paramMediaPlayer != null) && (this.jdField_a_of_type_Zax != null) && (!paramMediaPlayer.isPlaying()))
    {
      this.c = (System.currentTimeMillis() - this.jdField_a_of_type_Long);
      this.jdField_b_of_type_Long = System.currentTimeMillis();
      this.jdField_a_of_type_Zax.a(paramMediaPlayer, this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewVsMusicItemInfo);
    }
  }
}
