...
public class ubv
{
  ...
  private static bjig jdField_a_of_type_Bjig = new ubw();
  private static String jdField_a_of_type_JavaLangString;
  
  public static void a()
  {
    WXShareHelper.a().a(jdField_a_of_type_Bjig);
  }
  ...
  public static void a(BaseActivity paramBaseActivity)
  {
    ...
    bmud.a(paramBaseActivity, BaseApplicationImpl.getContext(), localBundle, null, 2);
  }
  ...
  public static void b()
  {
    ...
    WXShareHelper.a().b(jdField_a_of_type_Bjig);
  }
  ...
  public static void b(Activity paramActivity)
  {
    ...
    for (;;)
    {
      if (i != -1)
      {
        QQToast.a(BaseApplicationImpl.getContext(), BaseApplicationImpl.getContext().getString(i), 0).b(BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131299011));
        return;
  ...
  {
    String str = antf.aZ + "/Tencent/QQ_Images/" + Calendar.getInstance().getTime() + ".png";
    if (bhmi.a(jdField_a_of_type_AndroidGraphicsBitmap, str))
    {
      QLog.d("ShareImageUtils", 1, "save to sdcard success");
      bhmq.a(BaseApplicationImpl.getContext(), str);
      str = BaseApplicationImpl.getContext().getString(2131694371) + " " + str;
