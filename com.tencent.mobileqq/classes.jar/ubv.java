...
{
  public ubv(TroopDisbandActivity paramTroopDisbandActivity) {}
  ...
  protected void a(int paramInt1, int paramInt2)
  {
    if (paramInt1 == 9)
    {
      ...
      if (paramInt2 == 8)
      {
        ...
        ((QQCustomDialog)localObject).setTitle(this.a.getString(2131430385));
        ((QQCustomDialog)localObject).setMessage(this.a.getString(2131430386));
        ((QQCustomDialog)localObject).setNegativeButton(this.a.getString(2131430383), new ubw(this, (QQCustomDialog)localObject));
        ((QQCustomDialog)localObject).setPositiveButton(this.a.getString(2131435285), new ubx(this, (QQCustomDialog)localObject));
  ...
  protected void a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    if (paramInt2 == 0)
    {
      ...
      paramString.putExtra("fin_tip_msg", this.a.getString(2131435302));
  ...
  protected void a(boolean paramBoolean, long paramLong1, int paramInt1, List paramList, long paramLong2, int paramInt2, String paramString)
  {
    ...
    do
    {
      ...
      paramList.putExtra("leftViewText", this.a.getString(2131434539));
      ...
      if (paramBoolean)
      {
        ...
        this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier.a(2, 2131435230, 1500);
        return;
      }
      paramList = this.a;
      paramList.jdField_b_of_type_Int &= 0xFFFFFFFD;
      ...
      this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier.a(2, 2131435233, 1500);
      return;
    } while (!paramBoolean);
    label418:
    if (paramList == null)
