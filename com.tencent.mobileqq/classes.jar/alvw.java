...
public class alvw
{
  ...
  {
    if (paramInt == 2052) {
      return alud.a(2131693837);
    }
    if (paramInt == 1033) {
      return alud.a(2131693836);
    }
    return "";
  }
  ...
  public static void a(Context paramContext)
  {
    ...
    {
      str = amrm.a(paramContext, "key_local_cache", "0");
      a("initializeAppLocale, localeIdStr:" + str);
      if (!"0".equals(str)) {
        break label182;
      }
      jdField_a_of_type_Int = 2052;
      amrm.a(paramContext, "key_local_cache", String.valueOf(jdField_a_of_type_Int));
      str = amrm.a(paramContext, "key_local_last", "0");
      if (!"0".equals(str)) {
        break label200;
      }
    ...
    {
      b = bool1;
      amrm.a(paramContext, "key_local_last", String.valueOf(jdField_a_of_type_Int));
  ...
  public static void a(Context paramContext, int paramInt)
  {
    ...
    amrm.a(paramContext, "key_local_last", String.valueOf(jdField_a_of_type_Int));
    amrm.a(paramContext, "key_local_cache", String.valueOf(paramInt));
