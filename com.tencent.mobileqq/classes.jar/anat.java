  ...
  extends QIPCModule
{
  ...
  public anat(String paramString)
  {
    super(paramString);
  }
  ...
  public static void a()
  {
    ...
    if (!a)
    {
      QIPCClientHelper.getInstance().register(localanat);
      a = true;
    }
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    try
    {
      ...
      {
        anbd.a(paramBundle.getInt("gameId"));
      }
    ...
    else if ("action_set_sso_rule".equals(paramString))
    {
      ...
      andn localandn = anbd.a();
      if (localandn != null) {
        localandn.a(paramString.gameId, paramBundle);
      }
    }
    else
    {
      ...
      if (bool)
      {
        try
        {
          ...
          if (l >= 0L)
          {
            ...
            bdmc.a(BaseApplicationImpl.getApplication()).a(null, "cmgame_ipc_start_receive", true, l, 0L, paramBundle, "", false);
          }
          anbd.a(paramString);
        }
        catch (Exception paramString)
      ...
      else if ("action_check_game_data".equals(paramString))
      {
        ...
        paramString = anbd.a(paramString.gameId);
        if (paramString != null) {
