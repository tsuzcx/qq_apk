...
public class bchy
{
  ...
  public static final String d = ajjy.a(2131651241);
  ...
  {
    bcds.c(a, "---deleteYYBApkPackage--");
    ThreadManager.getSubThreadHandler().post(new YybHandleUtil.1());
  }
  
  public static boolean a()
  {
    String str = bbtm.a().a().getFilesDir().getAbsolutePath() + File.separator + c;
    return bcev.a(bbtm.a().a(), str);
  }
}
