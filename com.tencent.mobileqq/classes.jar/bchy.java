  ...
  implements View.OnClickListener
{
  ...
  {
    Object localObject3 = paramView.findViewById(2131377871);
    ...
    for (;;)
    {
      ...
      return;
      Object localObject1 = ((View)localObject3).getTag(2131377871);
      if ((localObject1 instanceof StructMsgForImageShare))
      {
        ...
        try
        {
          ...
          {
            bcef.b((QQAppInterface)localObject1, "P_CliOper", "Pb_account_lifeservice", localStructMsgForImageShare.uin, "mp_msg_msgpic_click", "aio_morpic_click", 0, 0, "", "", Long.toString(localStructMsgForImageShare.msgId), "");
          ...
          {
            bcef.b(null, "dc00898", "", "", "0X800A428", "0X800A428", 0, 0, "", ForwardUtils.toTypeSimple(localStructMsgForImageShare.uinType), Long.toString(localStructMsgForImageShare.mSourceAppid), localStructMsgForImageShare.getTitleFromBrief());
          ...
          bcef.b(null, "CliOper", "", "", "0X800567A", "0X800567A", 0, 0, localStructMsgForImageShare.mMsgServiceID + "", "", "", "");
          ...
          if ((!bfwr.b(localStructMsgForImageShare.mIsSend)) && (((bcjc)localObject4).a != null))
          {
            localObject1 = agjt.a(localContext, ((bcjc)localObject4).a);
        ...
        catch (AccountNotMatchException localAccountNotMatchException)
        {
          ...
          else
          {
            ...
            localIntent.putExtra("image_share_by_server", ((bcjc)localObject4).a());
            localIntent.putExtra("urlAtServer", ((bcjc)localObject4).ad);
            localIntent.putExtra("KEY_FILE_ID", ((bcjc)localObject4).c);
            localIntent.putExtra("picMD5", ((bcjc)localObject4).ae);
            localIntent.putExtra("url", ((bcjc)localObject4).ac);
            ...
            localIntent.putExtra("IS_FROMOTHER_TERMINAL_KEY", bfwr.c(localStructMsgForImageShare.mIsSend));
    ...
    localIntent.putExtra("fileSize", ((bcjc)localObject4).d);
    localIntent.putExtra("KEY_TIME", ((bcjc)localObject4).e);
    ...
    localIntent.putExtra("KEY_THUMBNAL_BOUND", aagn.a((View)localObject3));
    localIntent.putExtra("title", localStructMsgForImageShare.getTitleFromBrief());
    Object localObject4 = ((bcjc)localObject4).a;
    if (localObject4 != null)
    {
    ...
    for (;;)
    {
      ...
      catch (Exception localException)
      {
        ...
        if ((!bfwr.b(((MessageForPic)localObject4).issend)) || (TextUtils.isEmpty(((MessageForPic)localObject4).path)) || (!new File(((MessageForPic)localObject4).path).exists())) {
          continue;
        }
        ...
        if ((!bfwr.b(((MessageForPic)localObject4).issend)) || (TextUtils.isEmpty(((MessageForPic)localObject4).path)) || (!TextUtils.isEmpty(((MessageForPic)localObject4).md5)) || (!new File(((MessageForPic)localObject4).path).exists())) {
          continue;
        }
        localAIOImageData.jdField_b_of_type_JavaLangString = ((MessageForPic)localObject4).path;
        localAIOImageData.jdField_b_of_type_Int = 4;
        continue;
        if (!atyv.a(localStructMsgForImageShare)) {
          continue;
        }
        localAIOImageData.jdField_b_of_type_Int = 5;
        atyv.a(localAIOImageData, localStructMsgForImageShare);
        continue;
      ...
      localAIOImageData = agzl.a((MessageForPic)localObject4);
      ...
      if ((localStructMsgForImageShare.mMsgActionData != null) && (localStructMsgForImageShare.mMsgActionData.startsWith("comic_plugin.apk")))
      {
        ...
        localAIOImageData.a = localStructMsgForImageShare.getBytes();
        localObject4 = agzi.a(localStructMsgForImageShare);
        localAIOImageData.d = agzi.a((String[])localObject4);
        if ((localObject4 != null) && (localObject4.length >= 8))
        {
          if (localObject4[7].equals("link"))
          {
            localObject3 = localObject4[4];
            bkfq.a(null, (String)localObject2, localContext, "3009", "2", "40054", localObject4[0], new String[] { localObject4[2], localObject4[4], localObject3 });
          }
        }
        else
        {
          ...
          bcef.b(null, "P_CliOper", "Pb_account_lifeservice", localStructMsgForImageShare.uin, "0X80055C7", "0X80055C7", 0, j, "" + localStructMsgForImageShare.msgId, "" + localStructMsgForImageShare.templateIDForPortal, "", localStructMsgForImageShare.mMsgUrl);
          localObject2 = new StringBuilder().append("MSGID=").append(Long.toString(localStructMsgForImageShare.msgId)).append(";TEPLATEID=").append(localStructMsgForImageShare.templateIDForPortal).append(";ARTICALID=").append("").append(";REFERRER=").append(bcgw.a(localStructMsgForImageShare.mMsgUrl));
          bcef.b(null, "P_CliOper", "Pb_account_lifeservice", localStructMsgForImageShare.uin, "0X8005D49", "0X8005D49", 0, j, ((StringBuilder)localObject2).toString(), "", "", "");
          break;
