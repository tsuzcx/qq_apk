...
{
  public aqih(DynamicAvatarRecordActivity paramDynamicAvatarRecordActivity) {}
  ...
  public boolean queueIdle()
  {
    ...
    for (;;)
    {
      ...
      if (Build.VERSION.SDK_INT < 14) {
        this.a.jdField_a_of_type_Bhpc = bhlq.a(this.a, 230).setMessage(anzj.a(2131702464)).setPositiveButton(this.a.getString(2131693485), new aqii(this));
      }
      try
      {
        this.a.jdField_a_of_type_Bhpc.setCancelable(false);
