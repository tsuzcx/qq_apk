  ...
  extends WebViewPlugin
{
  ...
  private static final String e = ajya.a(2131705712);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajya.a(2131705708);
    jdField_b_of_type_JavaLangString = ajya.a(2131705707);
    d = ajya.a(2131705713);
    jdField_c_of_type_JavaLangString = ajya.a(2131705716);
  }
  ...
  private void a()
  {
    ...
    {
      b();
      arcj.a(this.jdField_a_of_type_AndroidAppActivity, this.g, this.k, this.m, this.jdField_a_of_type_Long, new arms(this));
      return;
    }
      ...
      for (;;)
      {
        ...
        try
        {
          if (paramIntent.hasExtra("data"))
          {
            ...
            localJSONObject.put("errMsg", paramIntent.getString("errMsg", ajya.a(2131705715)));
            localJSONObject.put("idKey", paramIntent.getString("idKey"));
            localJSONObject.put("allResults", localObject1);
          }
          for (;;)
          {
            axqy.b(null, "dc00898", "", "", "0X8009862", "0X8009862", 0, 0, this.jdField_c_of_type_Int + "", "", this.jdField_b_of_type_Int + "", paramInt + "");
            if (QLog.isColorLevel()) {
            ...
            else
            {
              ...
              localJSONObject.put("errMsg", ajya.a(2131705714));
              localJSONObject.put("allResults", localObject1);
              paramInt = 299;
            }
          }
  ...
  private void a(JSONObject paramJSONObject)
  {
    ...
    if ("loginVerify".equals(this.k))
    {
      if ((paramJSONObject != null) && (paramJSONObject.has("errMsg")) && (this.jdField_a_of_type_AndroidAppActivity != null))
      {
        ...
        bcql.a(this.jdField_a_of_type_AndroidAppActivity, paramJSONObject.optString("errMsg"), 0).a();
        return;
      }
