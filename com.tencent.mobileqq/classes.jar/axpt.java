...
public class axpt
{
  ...
  public axpt(Settings paramSettings)
  {
  ...
  {
    return axpy.a(paramFloat1, this.jdField_a_of_type_Float / paramFloat2, this.b * paramFloat2);
  }
  
  public axpt a(axpv paramaxpv)
  {
    ...
    if (!axpv.a(f9, 0.0F))
    {
      ...
      label202:
      switch (axpu.a[this.jdField_a_of_type_ComTencentMobileqqOcrViewGestureSettings.a().ordinal()])
      {
      default: 
