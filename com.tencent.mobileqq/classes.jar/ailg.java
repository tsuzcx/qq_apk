  ...
  implements biug<oidb_0x8e4.RspBody>
{
  ...
  public void a(int paramInt, oidb_0x8e4.RspBody paramRspBody)
  {
    ...
    do
    {
      QQToast.a(this.a.a(), 1, anzj.a(2131703990), 1).a();
      return;
      while ((!paramRspBody.getBooleanExtra("finishAIO", false)) || (!(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity instanceof ChatActivity)))
      {
        ...
        paramRspBody.putExtra("leftViewText", this.a.a().getString(2131690384));
        axws.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "game_room_last_time", Long.valueOf(bcrg.a()));
        paramInt = agej.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, paramRspBody);
        if (paramInt != 0) {
          break;
        }
        if (QLog.isColorLevel()) {
        ...
        localObject = this.a.jdField_a_of_type_Biup.a();
        if (localObject != null) {
          ((biuo)localObject).a();
        }
