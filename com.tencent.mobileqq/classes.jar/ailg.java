...
public class ailg
  extends Handler
{
  public ailg(Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.what == 0)
    {
      ...
      try
      {
        ...
        BatteryLog.b(new Object[] { "header", localObject3, "355371", "pub", localObject1, Build.MANUFACTURER, Build.MODEL, Integer.valueOf(Build.VERSION.SDK_INT), Long.valueOf(BatteryLog.a()), "1.3" });
        return;
      }
