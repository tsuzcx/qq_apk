      ...
      if (paramVideoInfo.a.jdField_a_of_type_Int == 0)
      {
        ...
        else
        {
          ...
          if (((oidb_0x885.KdTagItem)localObject2).bytes_name.has()) {
            ((VideoInfo.KdTagItem)localObject3).jdField_a_of_type_JavaLangString = pha.a(((oidb_0x885.KdTagItem)localObject2).bytes_name);
          }
  ...
  public static void a(oidb_0x6cf.RspBody paramRspBody, Bundle paramBundle, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          oqh.a("AdVideoDataLink", "parseTagInfoResult:rspBody.msg_ad_rsp is not null");
          ...
          oqh.a("AdVideoDataLink", "parseTagInfoResult:rspBody.rpt_msg_pos_ad_info posAdInfos size >>" + ((List)localObject1).size());
      ...
      {
        oqh.a("AdVideoDataLink", "handleGetRecommendList: parse game ad info error, e= " + paramRspBody.getMessage());
      }
      label408:
    ...
    if (!paramRspBody.isEmpty())
    {
      ...
      oqh.a("AdVideoDataLink", paramBundle.toString());
      return;
    }
    oqh.a("AdVideoDataLink", "parseTagInfoResult:no softAd or gameComponent");
    return;
    label550:
    oqh.a("AdVideoDataLink", "parseTagInfoResult:rspBody.rpt_msg_pos_ad_info null ");
  }
}
