  ...
  implements sxo
{
  private boolean a(List<String> paramList)
  {
    ...
    {
      veg.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleAlbumEntraConfig type: 日迹主页影集入口配置, content: \n", paramList);
      paramList = (spq)tdc.a(30);
        ...
        catch (NumberFormatException localNumberFormatException3)
        {
          try
          {
            for (;;)
            {
              ...
              veg.e("Q.qqstory.config.QQStoryConfigServletHandler", "get enableCqMode= " + str11 + " from json error:" + localNumberFormatException1);
              continue;
              localNumberFormatException2 = localNumberFormatException2;
              veg.e("Q.qqstory.config.QQStoryConfigServletHandler", "get highBitrate= " + str11 + " from json error:" + localNumberFormatException2);
              continue;
              bool = false;
            }
            localNumberFormatException3 = localNumberFormatException3;
            veg.e("Q.qqstory.config.QQStoryConfigServletHandler", "get codecProfile= " + str11 + " from json error:" + localNumberFormatException3);
          }
          catch (NumberFormatException localNumberFormatException4)
          {
            for (;;)
            {
              veg.e("Q.qqstory.config.QQStoryConfigServletHandler", "get maxVideoSize= " + str11 + " from json error:" + localNumberFormatException4);
            }
          }
        }
      }
  ...
  private boolean a(List<String> paramList, String paramString)
  {
    ...
    {
      return false;
      veg.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleQzoneSync2QQStory config=%s", paramList);
    ...
    catch (Throwable paramString)
    {
      for (;;)
      {
        veg.e("Q.qqstory.config.QQStoryConfigServletHandler", "handleQzoneSync2QQStory  parseLong error");
      }
    }
  ...
  private boolean b(List<String> paramList)
  {
    ...
    for (paramList = "";; paramList = str)
    {
      veg.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleAlbumConfig type: 影集配置, content: \n", paramList);
      if ((!TextUtils.isEmpty(str)) && (str.trim().length() != 0)) {
        break;
      }
      localspq.f();
  ...
  private boolean b(List<String> paramList, int paramInt)
  {
    ...
    return ((tcz)tdc.a(5)).a(paramList);
  }
  ...
  private boolean c(List<String> paramList)
  {
    ...
    tgc localtgc = (tgc)QQStoryContext.a().getManager(252);
    String str = (String)paramList.get(0);
    if (str == null) {}
    for (paramList = "";; paramList = str)
    {
      veg.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleMsgTabTakeVideoNodeConfig type: 日迹拍摄配置, content: \n", paramList);
      if ((!TextUtils.isEmpty(str)) && (str.trim().length() != 0)) {
        break;
      }
      localtgc.a();
  ...
  private boolean d(List<String> paramList)
  {
    ...
    paramList = (String)paramList.get(0);
    veg.a("Q.qqstory.config.QQStoryConfigServletHandler", "handledAIOSyncToStory config=%s", paramList);
    if (TextUtils.isEmpty(paramList))
    {
      veg.d("Q.qqstory.config.QQStoryConfigServletHandler", "handledAIOSyncToStory content is null!!");
      bjrz.b();
      return true;
    }
    try
  ...
  private boolean e(List<String> paramList)
  {
    ...
    veg.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleStorySync2QzoneConfig config=%s", paramList);
    paramList = (String)paramList.get(0);
    if (TextUtils.isEmpty(paramList))
    {
      veg.d("Q.qqstory.config.QQStoryConfigServletHandler", "handleStorySync2QzoneConfig clear config");
      tcv.c(false);
      tcv.e(false);
      return true;
    }
    try
    {
      ...
      veg.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleStorySync2QzoneConfig showSyncBtn = %d,defaultStatus=%d", Integer.valueOf(i), Integer.valueOf(j));
      if (i == 1)
      {
        bool = true;
        tcv.c(bool);
    ...
    {
      vxs.a("handleStorySync2QzoneConfig:" + paramList.toString(), new Object[0]);
      paramList.printStackTrace();
    }
  }
  ...
  private boolean f(List<String> paramList)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramList = (tcx)JsonORM.a(new JSONObject(paramList), tcx.class);
        localtcv = (tcv)tdc.a(10);
        localtcv.b("boolean_enable_revert_play_mode", Boolean.valueOf(true));
        localtcv.b("boolean_enable_fast_play_mode", Boolean.valueOf(true));
        localtcv.b("boolean_enable_slow_play_mode", Boolean.valueOf(true));
        localtcv.b("boolean_enable_hw_encode_pic_to_video", Boolean.valueOf(true));
        localtcv.b("boolean_enable_flow_decode", Boolean.valueOf(true));
        localtcv.b("boolean_use_flow_decode_first", Boolean.valueOf(false));
        localtcv.b("key_story_home_preload_count", Integer.valueOf(4));
        localtcv.b("key_story_video_preload_duration", Integer.valueOf(2));
        tcy[] arrayOftcy;
        int k;
        if (paramList.f != null)
        {
          arrayOftcy = paramList.f;
          k = arrayOftcy.length;
          i = 0;
          if (i < k)
          {
            ...
            localtcv.b("boolean_use_flow_decode_first", Boolean.valueOf(true));
          }
        }
        if (paramList.jdField_a_of_type_ArrayOfTcy != null)
        {
          arrayOftcy = paramList.jdField_a_of_type_ArrayOfTcy;
          k = arrayOftcy.length;
          i = 0;
          if (i < k)
          {
            ...
            localtcv.b("boolean_enable_revert_play_mode", Boolean.valueOf(false));
          }
        }
        if (paramList.jdField_b_of_type_ArrayOfTcy != null)
        {
          arrayOftcy = paramList.jdField_b_of_type_ArrayOfTcy;
          k = arrayOftcy.length;
          i = 0;
          if (i < k)
          {
            ...
            localtcv.b("boolean_enable_fast_play_mode", Boolean.valueOf(false));
          }
        }
        if (paramList.c != null)
        {
          arrayOftcy = paramList.c;
          k = arrayOftcy.length;
          i = 0;
          if (i < k)
          {
            ...
            localtcv.b("boolean_enable_slow_play_mode", Boolean.valueOf(false));
          }
        }
        if (paramList.d != null)
        {
          arrayOftcy = paramList.d;
          k = arrayOftcy.length;
          i = 0;
          if (i < k)
          {
            ...
            localtcv.b("boolean_enable_hw_encode_pic_to_video", Boolean.valueOf(false));
          }
        }
        if (paramList.e != null)
        {
          arrayOftcy = paramList.e;
          k = arrayOftcy.length;
          i = 0;
          if (i < k)
          {
            ...
            localtcv.b("boolean_enable_flow_decode", Boolean.valueOf(false));
          }
        }
      ...
      localtcv.b("string_story_global_log_level", Integer.valueOf(i));
      localtcv.b("string_auto_play_report_control", paramList.jdField_b_of_type_JavaLangString);
      if ((paramList.jdField_a_of_type_Int > 0) && (paramList.jdField_a_of_type_Int < 20)) {
        localtcv.b("key_story_home_preload_count", Integer.valueOf(paramList.jdField_a_of_type_Int));
      }
      if ((paramList.jdField_b_of_type_Int > 0) && (paramList.jdField_b_of_type_Int < 10))
      {
        localtcv.b("key_story_video_preload_duration", Integer.valueOf(paramList.jdField_b_of_type_Int));
        break label726;
        i = j;
  ...
  private boolean g(List<String> paramList)
  {
    ...
    paramList = (String)paramList.get(0);
    if (!TextUtils.isEmpty(paramList)) {
      bbjn.i(localQQAppInterface.getApp(), localQQAppInterface.c(), paramList);
    }
    for (;;)
    {
      ((ssw)localQQAppInterface.getManager(181)).b(paramList);
      if (QLog.isColorLevel()) {
        QLog.d("Q.qqstory.config.QQStoryConfigServletHandler", 2, "handleStoryPlayerProxyConfigCmd configContent = " + paramList);
      }
      return true;
      bbjn.i(localQQAppInterface.getApp(), localQQAppInterface.c(), null);
    }
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localObject2 != null)
        {
          ...
          if ((!TextUtils.isEmpty((CharSequence)localObject1)) && (nam.a((String)localObject2)))
          {
            localtcv.b("CertificationLinkText", localObject1);
            localtcv.b("CertificationLinkUrl", localObject2);
            ...
            localtcv.b("localVideoScanInterval", String.valueOf(i));
            localObject1 = localJSONObject.optJSONObject("mainHallConfig");
            if (localObject1 == null) {
              break label554;
            }
            localtcv.b("mainHallConfig", ((JSONObject)localObject1).toString());
            localObject1 = localJSONObject.optJSONObject("troopStoryHallConfig");
            if (localObject1 == null) {
              break label567;
            }
            localtcv.b("troopStoryHallConfig", ((JSONObject)localObject1).toString());
            ...
            bool = true;
            localtcv.b("key_share_encrypt_flag", Boolean.valueOf(bool));
            ...
            bool = true;
            localtcv.b("key_show_in_friend_story_main_page", Boolean.valueOf(bool));
            ...
            localtcv.b("boolean_enable_multi_video_fragment", Boolean.valueOf(true));
            i = 0;
            if (i < j)
            {
              ...
              localtcv.b("boolean_enable_multi_video_fragment", Boolean.valueOf(false));
            }
            i = localJSONObject.optInt("qim_sync_to_qq", 0);
            QLog.d("Q.qqstory.commonConfig", 2, "qim_sync_to_qq: " + paramList);
            localtcv.b("key_qim_int_qim_sync_to_qq_default", Integer.valueOf(i));
            return true;
          }
          localtcv.b("CertificationLinkText", "");
          localtcv.b("CertificationLinkUrl", "");
          continue;
        }
        localtcv.b("CertificationLinkText", "");
      }
      ...
      continue;
      label540:
      localtcv.b("localVideoScanInterval", "1441");
      continue;
      label554:
      localtcv.b("mainHallConfig", "");
      continue;
      label567:
      localtcv.b("troopStoryHallConfig", "");
      continue;
      label580:
      localtcv.b("key_share_encrypt_flag", Boolean.valueOf(false));
      continue;
      label595:
      localtcv.b("key_show_in_friend_story_main_page", Boolean.valueOf(true));
      continue;
      label610:
      localtcv.b("boolean_enable_multi_video_fragment", Boolean.valueOf(true));
      continue;
  ...
  public boolean a(int paramInt, Intent paramIntent, ConfigurationService.Config paramConfig)
  {
    ...
    Object localObject = tcv.a(paramInt);
    int i = bbjn.a(QQStoryContext.a().getApp(), (String)localObject, str);
    int j = paramConfig.version.get();
    localObject = ando.a(paramConfig, i, paramInt);
    if (localObject == null) {
      return bool2;
    }
    switch (paramInt)
