...
{
  public yiz(TroopMemberListInnerFrame paramTroopMemberListInnerFrame)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.a.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130971586, paramViewGroup, false);
      paramView = new yja(this.a, null);
    ...
    paramViewGroup = (yja)localView.getTag();
    if (i < 0)
    {
      i = -(i + 1) - 1;
    ...
    paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(String.format(this.a.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getString(2131436015), new Object[] { paramView.toLowerCase() }));
    return localView;
  }
}
