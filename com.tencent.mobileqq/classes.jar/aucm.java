...
public class aucm
  implements apcy
{
  public aucm(JefsClass paramJefsClass, WeakReference paramWeakReference, JefsClass.CancelableRunnable paramCancelableRunnable, int paramInt, String paramString) {}
  ...
  public void a(boolean paramBoolean, int paramInt1, int paramInt2, String paramString)
  {
    ...
    if (localObject == null)
    {
      ...
      {
        bcef.b(null, "dc00898", "", "", "0X8009C5A", "0X8009C5A", 0, 0, "", "1", paramString, "");
        return;
      }
    }
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = bfur.a(paramString, 0, null, "即将离开QQ\n打开其他应用", paramString.getString(2131690620), paramString.getString(2131719641), new aucn(this), new auco(this));
      ...
      if ((paramString instanceof BasePluginActivity))
      {
        ...
        if (BaseApplicationImpl.sProcessId != 1)
        {
          if (JefsClass.a(this.jdField_a_of_type_ComTencentMobileqqHaoliyouJefsClass) == null) {
            JefsClass.a(this.jdField_a_of_type_ComTencentMobileqqHaoliyouJefsClass, new aucv(this.jdField_a_of_type_ComTencentMobileqqHaoliyouJefsClass, null));
          }
        ...
        adxr.a(paramString, PublicTransFragmentActivity.class, JumpConfirmFragment.class);
        QLog.i("TeleScreen|JefsClass", 1, "leave QQ jump other app , act == null && act.isFinishing() == true");
        return;
        apdi.a().a(this.jdField_a_of_type_Int, -2);
        return;
        label491:
        paramString = null;
      }
