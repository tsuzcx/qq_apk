...
public class adyb
  extends amab
{
  public adyb(TroopDisbandActivity paramTroopDisbandActivity) {}
  ...
  protected void a(int paramInt1, int paramInt2)
  {
    if (paramInt1 == 9)
    {
      ...
      if (paramInt2 == 8)
      {
        ...
        localObject = bdcd.a(this.a, 230);
        ((bdfq)localObject).setTitle(this.a.getString(2131696604));
        ((bdfq)localObject).setMessage(this.a.getString(2131696605));
        ((bdfq)localObject).setNegativeButton(this.a.getString(2131696636), new adyc(this, (bdfq)localObject));
        ((bdfq)localObject).setPositiveButton(this.a.getString(2131720083), new adyd(this, (bdfq)localObject));
  ...
  {
    if (!bdal.a(paramString, this.a.jdField_a_of_type_JavaLangString)) {}
    while (paramInt1 != 9) {
      return;
    }
    paramString = this.a;
    ...
    if (paramInt2 == 0)
    {
      ...
      paramString.putExtra("fin_tip_msg", this.a.getString(2131692291));
  ...
  {
    if (!bdal.a(String.valueOf(paramLong1), this.a.jdField_a_of_type_JavaLangString)) {}
    Object localObject;
    label132:
    label190:
    label320:
    ...
    do
    {
      do
      {
        ...
        case 4: 
          if (paramBoolean)
          {
            ...
            } while ((this.a.jdField_a_of_type_JavaUtilArrayList.contains(localObject)) || (localObject == null) || ("".equals(((String)localObject).trim())) || (bdal.a(this.a.d, localObject)));
          ...
          paramList = (alzf)this.a.app.a(20);
      ...
      paramList.putExtra("leftViewText", this.a.getString(2131717652));
      ...
      if (paramBoolean)
      {
        ...
        this.a.jdField_a_of_type_Beps.b(2, 2131720988, 1500);
        return;
      }
      paramList = this.a;
      paramList.jdField_b_of_type_Int &= 0xFFFFFFFD;
      ...
      this.a.jdField_a_of_type_Beps.b(2, 2131720983, 1500);
      return;
    } while (!paramBoolean);
    label418:
    if (paramList == null)
    ...
    for (paramString = null;; paramString = paramString.b(this.a.jdField_a_of_type_JavaLangString))
    {
      ...
      this.a.jdField_a_of_type_Adyf.b(paramList);
      return;
      paramInt1 = paramList.size();
      break;
    }
  ...
  protected void a(boolean paramBoolean, String paramString)
  {
    ...
    if ((paramBoolean) && (bdal.a(paramString, this.a.jdField_a_of_type_JavaLangString)))
    {
      paramString = (TroopManager)this.a.app.getManager(52);
  ...
  protected void b(boolean paramBoolean, ArrayList<TroopInfo> paramArrayList)
  {
    ...
    label56:
    while (!bdal.a(localTroopInfo.troopuin, this.a.jdField_a_of_type_JavaLangString))
    {
      i += 1;
      break label21;
      break;
