  ...
  extends apbi
{
  ...
  protected void a(int paramInt, String paramString)
  {
    ...
    apbe.b(this.jdField_a_of_type_Apbe, 10, 12);
    apbe.c(this.jdField_a_of_type_Apbe, 10, 12);
    QLog.i("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + this.jdField_a_of_type_Apbe.jdField_a_of_type_Long + "] state change :(" + this.jdField_a_of_type_Apbi.a() + "->StateExcepInvalidWhenPause)");
  ...
  protected void b()
  {
    ...
    apbe.b(this.jdField_a_of_type_Apbe, 10, 9);
    apbe.c(this.jdField_a_of_type_Apbe, 10, 9);
    QLog.i("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + this.jdField_a_of_type_Apbe.jdField_a_of_type_Long + "] state change :(" + this.jdField_a_of_type_Apbi.a() + "->StateCancelUploadWhenPause)");
