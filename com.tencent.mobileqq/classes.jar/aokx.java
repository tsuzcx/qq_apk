...
public class aokx
{
  ...
  public static FullMessageSearchResult.SearchResultItem a(QQAppInterface paramQQAppInterface, EntityManager paramEntityManager, Cursor paramCursor, String paramString1, int paramInt, String paramString2, aokv paramaokv)
  {
    ...
    do
    {
      ...
      {
        if ((paramaokv.c == 3) || (paramaokv.c == 2)) {
          return null;
        }
        paramInt = 0;
  ...
  private static String a(byte[] paramArrayOfByte)
  {
    ...
    if (paramArrayOfByte != null)
    {
      ...
      {
        AbsStructMsg localAbsStructMsg = bdof.a(paramArrayOfByte);
        localObject = str;
