  ...
  extends anud
{
  ...
  public aokx(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(int paramInt1, int paramInt2, ListenChangeVoicePanel paramListenChangeVoicePanel)
  {
    ...
    localvoiceChangeReq.str_qq_version.set("8.4.5");
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        QLog.e("VoiceChangeHandler", 1, "onReceive~ isSuccess=false ,data=" + bhvd.a((byte[])paramObject));
        bjqh.a().a("voiceChange.Auth", 100, paramFromServiceMsg.getBusinessFailCode(), this.app.getCurrentAccountUin(), 0, anzj.a(2131715622), true);
