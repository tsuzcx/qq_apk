  ...
  extends MSFServlet
{
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      notifyObserver(paramIntent, i, bool1, (Bundle)localObject1, avjj.class);
      return;
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    for (;;)
    {
      ...
      paramPacket.putSendData(bhjl.a(paramIntent.getByteArrayExtra("RequestBytes")));
      return;
      if (str.equals("QQApkSvc.check_download_apk")) {
        paramPacket.setTimeout(((aqgo)aqxe.a().a(416)).a);
      } else if (str.equals("QQApkSvc.check_jump_apk")) {
        paramPacket.setTimeout(((aqgo)aqxe.a().a(416)).b);
      }
    }
  }
}
