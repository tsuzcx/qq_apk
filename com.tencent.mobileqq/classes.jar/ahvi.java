...
{
  public ahvi(NewFlowCameraActivity paramNewFlowCameraActivity) {}
      ...
      for (;;)
      {
        ...
        if (NewFlowCameraActivity.h(this.a)) {
          if (this.a.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
          {
            ...
            if (this.a.r == 10004) {
              vel.a("plus_shoot", "clk_shoot", 0, 0, new String[] { "2", "", "", "" });
            }
          }
          else
          {
            this.a.i();
            if (this.a.r == 10002) {
              vel.a("video_shoot", "clk_shoot", 0, 0, new String[] { "2" });
            } else if (this.a.r == 10004) {
              vel.a("plus_shoot", "clk_shoot", 0, 0, new String[] { "1", "", "", "" });
            }
          }
        }
      }
