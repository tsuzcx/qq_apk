  ...
  implements View.OnClickListener
{
  ...
  public ahvi(PhotoListPanel paramPhotoListPanel) {}
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_Ahvl == null) {}
    ...
    for (;;)
    {
      ...
      Object localObject;
      long l1;
      if (this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_Ahvl.getItemCount() > 0)
      {
        localLocalMediaInfo = this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_Ahvl.a(this.jdField_a_of_type_Int);
        j = this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_Ahvl.getItemViewType(this.jdField_a_of_type_Int);
        if ((!localLocalMediaInfo.mChecked) && (bgkc.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_JavaUtilLinkedList, this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_AndroidAppActivity, PhotoListPanel.jdField_a_of_type_Int)))
        {
        ...
        else
        {
          ...
          String str;
          for (i = 0; ((Iterator)localObject).hasNext(); i = (int)(i + bgmg.a(str))) {
            str = (String)((Iterator)localObject).next();
          }
          if (i + bgmg.a(localLocalMediaInfo.path) <= 52428800L) {
            break label316;
          }
          localObject = (abqn)this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51);
          if ((localObject == null) || (!((abqn)localObject).a())) {
            break label316;
          }
          l1 = 0L;
        }
      ...
      if (!((abqn)localObject).a(l1, 1)) {
        break label316;
      }
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_AndroidAppActivity, "选择图片总大小不能超过50M", 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.getResources().getDimensionPixelSize(2131298998));
      this.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(localLocalMediaInfo.mChecked);
    }
    label316:
    boolean bool;
    if (!localLocalMediaInfo.mChecked)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_Ahvj != null) {
        this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_Ahvj.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.a());
      }
      ...
      bcst.b(null, "CliOper", "", "", "0X8005E08", "0X8005E08", 0, 0, "", "", "", "");
