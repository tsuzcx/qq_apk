...
{
  public bmyy(bmyq parambmyq) {}
  
  protected List<LocalMediaInfo> a(Object... paramVarArgs)
  {
    PhotoCommonBaseData localPhotoCommonBaseData = this.a.jdField_a_of_type_Bmzh.a;
    ...
    bhfd.a();
    paramVarArgs = this.a.jdField_a_of_type_Bmzh.a();
    ...
    for (;;)
    {
      ...
      for (int j = ((Integer)QAlbumUtil.sLastAlbumPhotoCountMap.get(localPhotoCommonBaseData.albumId)).intValue();; j = 0)
      {
        ...
        {
          break;
          this.a.jdField_a_of_type_Bmzh.a(paramVarArgs);
          ...
          if (this.a.jdField_a_of_type_Bmzh.a())
          {
  ...
  {
    this.a.jdField_a_of_type_Bmzh.a(paramList);
  }
