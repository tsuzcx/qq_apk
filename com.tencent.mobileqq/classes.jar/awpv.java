...
class awpv
  extends nme
{
  awpv(awpu paramawpu, awps paramawps) {}
    ...
    if ((paramInt == 0) && (paramArrayOfByte != null))
    {
      ...
      if (paramArrayOfByte.lists.has())
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if (!awpu.a(this.jdField_a_of_type_Awpu).contains(Long.valueOf(localComment.comment_id.get()))) {
            awpu.a(this.jdField_a_of_type_Awpu).add(Long.valueOf(localComment.comment_id.get()));
          }
      ...
      this.jdField_a_of_type_Awps.a(paramBundle);
      return;
    }
