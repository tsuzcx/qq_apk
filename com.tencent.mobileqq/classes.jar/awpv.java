...
public class awpv
  extends RecyclerView.Adapter<awpx>
  implements View.OnClickListener
{
  ...
  public awpv(PersonalityLabelGalleryActivity paramPersonalityLabelGalleryActivity, long paramLong)
  {
    this.jdField_a_of_type_Long = paramLong;
  }
  
  public awpx a(ViewGroup paramViewGroup, int paramInt)
  {
    paramViewGroup = LayoutInflater.from(paramViewGroup.getContext()).inflate(2131561142, paramViewGroup, false);
    return new awpx(this.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelPersonalityLabelGalleryActivity, paramViewGroup);
  }
  
  public void a(awpx paramawpx, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = this.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelPersonalityLabelGalleryActivity.jdField_a_of_type_Awoy.a(this.jdField_a_of_type_Long, (PersonalityLabelPhoto)localPersonalityLabelInfo.personalityLabelPhotos.get(paramInt));
        this.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelPersonalityLabelGalleryActivity.a((awoz)localObject1, (PersonalityLabelPhoto)localPersonalityLabelInfo.personalityLabelPhotos.get(paramInt), paramawpx);
        paramawpx.jdField_a_of_type_AndroidWidgetRelativeLayout.setTag(2131371856, localObject1);
        paramawpx.jdField_a_of_type_AndroidWidgetRelativeLayout.setTag(Integer.valueOf(paramInt));
        paramawpx.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this);
        return;
      }
      ...
      if ((((String)localObject2).startsWith("http")) || (((String)localObject2).startsWith("https")))
      {
        ...
        paramawpx.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject2);
      }
      else
      {
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (paramView.getId() != 2131371856);
      localObject1 = paramView.getTag();
      localObject2 = paramView.getTag(2131371856);
      if ((localObject2 != null) && ((localObject2 instanceof awoz)) && (((awoz)localObject2).b == 3))
      {
        localObject1 = (awoz)localObject2;
        if (this.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelPersonalityLabelGalleryActivity.jdField_a_of_type_Bhuf == null)
        {
          this.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelPersonalityLabelGalleryActivity.jdField_a_of_type_Bhuf = bhuf.a(paramView.getContext());
          this.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelPersonalityLabelGalleryActivity.jdField_a_of_type_Bhuf.c("重新上传");
          this.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelPersonalityLabelGalleryActivity.jdField_a_of_type_Bhuf.c("删除");
          this.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelPersonalityLabelGalleryActivity.jdField_a_of_type_Bhuf.d("取消");
        }
        this.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelPersonalityLabelGalleryActivity.jdField_a_of_type_Bhuf.a(new awpw(this, (awoz)localObject1));
        this.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelPersonalityLabelGalleryActivity.jdField_a_of_type_Bhuf.show();
        return;
      }
    ...
    if (i < ((PersonalityLabelInfo)localObject3).personalityLabelPhotos.size())
    {
      ...
      if (PersonalityLabelGalleryActivity.a(this.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelPersonalityLabelGalleryActivity))
      {
        paramView = this.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelPersonalityLabelGalleryActivity.jdField_a_of_type_Awoy.a(this.jdField_a_of_type_Long, localPersonalityLabelPhoto);
        label282:
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      azqs.b(this.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelPersonalityLabelGalleryActivity.app, "dc00898", "", "", "0X8007FD1", "0X8007FD1", 0, 0, "", "", "", "");
      return;
      bool = false;
      break;
    }
