  ...
  extends ValueAnimator
{
  ...
  private wez(View paramView, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float paramFloat5, float paramFloat6)
  {
    this.jdField_a_of_type_AndroidViewView = paramView;
    setObjectValues(new Object[] { new wfc(paramFloat1, paramFloat2, paramFloat3), new wfc(paramFloat4, paramFloat5, paramFloat6) });
    setEvaluator(new wfd(null));
    this.jdField_a_of_type_AndroidAnimationValueAnimator$AnimatorUpdateListener = new wfa(this, a(paramView));
  ...
  public static wez a(View paramView, int paramInt1, int paramInt2, float paramFloat1, float paramFloat2)
  {
    return new wez(paramView, paramInt1, paramInt2, paramFloat1, paramInt1, paramInt2, paramFloat2);
  }
