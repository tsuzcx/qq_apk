  ...
  extends ShareActionSheetBuilder
{
  ...
  public bhsg(Context paramContext)
  {
  ...
  public View a()
  {
    View localView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131562919, null);
    this.jdField_a_of_type_Bhsd.a((RelativeLayout)localView.findViewById(2131362216));
    ...
    for (int j = 0;; j = 1)
    {
      ...
      for (int k = 0;; k = 1)
      {
        ...
        if (j != 0)
        {
          this.jdField_a_of_type_AndroidWidgetGridView = ((GridView)localView.findViewById(2131367683));
        ...
        for (;;)
        {
          ...
          this.jdField_a_of_type_AndroidWidgetGridView.setAdapter(new bhsa(this.jdField_a_of_type_AndroidContentContext, (List)localObject1));
          ...
          if (k != 0)
          {
            this.jdField_b_of_type_AndroidWidgetGridView = ((GridView)localView.findViewById(2131367684));
            if (Build.VERSION.SDK_INT >= 9) {
          ...
          for (;;)
          {
            ...
            this.jdField_b_of_type_AndroidWidgetGridView.setNumColumns(i);
            this.jdField_b_of_type_AndroidWidgetGridView.setAdapter(new bhsa(this.jdField_a_of_type_AndroidContentContext, (List)localObject2));
            ...
            ((TextView)localObject1).setOnClickListener(new bhsh(this));
            if (j == 0) {
            ...
            for (;;)
            {
              ...
              localObject1 = (RelativeLayout)localView.findViewById(2131377512);
              ...
              for (;;)
              {
                localObject1 = (ImageView)localView.findViewById(2131377511);
