...
public class awgq
{
  ...
  public void a(awgr paramawgr)
  {
    this.jdField_a_of_type_Long = paramawgr.jdField_a_of_type_Long;
    this.jdField_b_of_type_Long = paramawgr.jdField_b_of_type_Long;
    this.jdField_a_of_type_Float = paramawgr.jdField_a_of_type_Float;
    this.jdField_c_of_type_Long = paramawgr.jdField_c_of_type_Long;
    this.jdField_d_of_type_Long = paramawgr.jdField_d_of_type_Long;
    this.e = paramawgr.e;
    this.f = paramawgr.f;
    this.g = paramawgr.g;
    this.h = paramawgr.h;
    this.jdField_a_of_type_Boolean = paramawgr.jdField_b_of_type_Boolean;
    this.i = paramawgr.i;
    this.jdField_c_of_type_JavaLangString = paramawgr.jdField_a_of_type_JavaLangString;
    this.jdField_b_of_type_JavaLangString = paramawgr.jdField_b_of_type_JavaLangString;
    this.jdField_d_of_type_JavaLangString = paramawgr.jdField_c_of_type_JavaLangString;
    this.jdField_d_of_type_Boolean = paramawgr.jdField_a_of_type_Boolean;
  }
  
  public boolean a()
  {
    boolean bool = true;
    if ((this.jdField_a_of_type_Long == 12L) || (this.jdField_a_of_type_Long == 1L) || (this.jdField_a_of_type_Long == 2L) || (this.jdField_a_of_type_Long == 26L) || (this.jdField_a_of_type_Long == 3L)) {
      bool = false;
    }
    do
    {
      return bool;
      if ((!awfy.c(this.jdField_a_of_type_Long)) && (this.jdField_a_of_type_Long != 7L)) {
        break;
      }
    ...
    while (!awfy.a(this.jdField_d_of_type_Long * 1000L)) {
      return false;
    }
    return true;
  }
