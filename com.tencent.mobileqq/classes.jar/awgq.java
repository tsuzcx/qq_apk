...
public class awgq
{
  private static awgh jdField_a_of_type_Awgh;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (j < k)
        {
          ...
          else if ((localRecentBaseData.a() == 6000) && (TextUtils.equals(localRecentBaseData.a(), ajsf.z)))
          {
            localArrayList.add(localRecentBaseData);
            i = j;
          }
        ...
        else
        {
          if ((localArrayList.size() == 0) || (i == -1))
          {
            ...
            paramList = ahmi.a(new RecentUser(ajsf.z, 6000), paramQQAppInterface, paramActivity);
            if (paramList != null)
            {
              paramList.mTitleName = paramActivity.getResources().getString(2131693964);
              localArrayList.add(paramList);
            }
          }
          Collections.sort(localArrayList, new ahmj(paramQQAppInterface));
  ...
  {
    awgh localawgh2 = (awgh)ampm.a().a(485);
    awgh localawgh1 = localawgh2;
    if (localawgh2 == null)
    {
      localawgh2 = new awgh();
      localawgh1 = localawgh2;
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ScreenShotHelper", 2, "ScreenShotConfigData switch isOpened = " + localawgh1);
    }
    jdField_a_of_type_Awgh = localawgh1;
  }
  ...
  public static void a(Activity paramActivity)
  {
    ...
    paramActivity = ((ViewGroup)paramActivity.getWindow().getDecorView().getRootView()).findViewById(2131375638);
  ...
  public static void a(Activity paramActivity, Handler paramHandler)
  {
    ...
    View localView = ((ViewGroup)paramActivity.getWindow().getDecorView().getRootView()).findViewById(2131375638);
    if (localView != null)
    {
  ...
  public static void a(Activity paramActivity, String paramString, Handler paramHandler)
  {
    ...
    Object localObject1 = localViewGroup.findViewById(2131375638);
    int k = bbkx.b(79.0F);
    ...
    for (;;)
    {
      ...
      {
        localObject3 = View.inflate(paramActivity, 2131562358, null);
        localImageView = (ImageView)((View)localObject3).findViewById(2131375641);
      ...
      for (;;)
      {
        try
        {
          paramActivity.getResources().getDrawable(2130840058);
          ...
          ((URLDrawable.URLDrawableOptions)localObject1).mLoadingDrawable = aywk.b();
  ...
  public static void a(Context paramContext, String paramString)
  {
    ...
    {
      localObject = ((ViewGroup)((Activity)paramContext).getWindow().getDecorView().getRootView()).findViewById(2131375638);
      if (localObject != null) {
          ...
          if (localQQAppInterface.a().a())
          {
            ...
            if (localQQAppInterface.a().a() != null)
            {
              ...
              if (localQQAppInterface.a().a().size() > 0)
              {
                ...
                abtu.a(paramString, (Intent)localObject, PublicTransFragmentActivity.class, ScreenShotFragment.class, 9011);
                i = 1;
              }
            }
          }
    ...
    if (((paramContext instanceof QQBrowserActivity)) && (a((QQBrowserActivity)paramContext)))
    {
      ...
      abtu.a((QQBrowserActivity)paramContext, (Intent)localObject, PublicTransFragmentActivity.class, ScreenShotFragment.class, 11);
    }
    while (i != 0) {
      return;
    }
    abtu.a(paramContext, (Intent)localObject, PublicTransFragmentActivity.class, ScreenShotFragment.class);
  }
  ...
  public static void a(awgh paramawgh)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ScreenShotHelper", 2, "onConfUpdate : " + paramawgh);
    }
    if (paramawgh != null) {
      jdField_a_of_type_Boolean = paramawgh.a();
    }
  }
  ...
  public static boolean a()
  {
    ...
    b = true;
    a();
    jdField_a_of_type_Boolean = jdField_a_of_type_Awgh.a();
    if (QLog.isColorLevel()) {
  ...
  private static boolean a(QQBrowserActivity paramQQBrowserActivity)
  {
    ...
    return paramQQBrowserActivity.getSupportFragmentManager().findFragmentById(2131364706) instanceof WebViewFragment;
  }
  ...
  public List<RecentBaseData> a(Activity paramActivity, QQAppInterface paramQQAppInterface)
  {
    ...
    try
    {
      ...
      ahmj localahmj = new ahmj(paramQQAppInterface);
      localahmj.a(localList);
      if (localList != null) {
        i = localList.size();
      }
      ahmi.a(localList, paramQQAppInterface, paramActivity, localArrayList, i);
      Collections.sort(localArrayList, localahmj);
    }
