  ...
  implements ajtg
{
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, int paramInt, String paramString)
  {
    ...
    label58:
    label68:
    for (String str = ajyc.a(2131710961);; str = ajyc.a(2131710959))
    {
      bdid.a().a(paramString + str + ajyc.a(2131710962));
      return;
      paramString = ajyc.a(2131710960);
      break;
    }
  }
              ...
              do
              {
                do
                {
                  ...
                  if (localObject2 != null)
                  {
                    ...
                    localObject1 = ((tdo)localObject3).b(((UserInfo)localObject2).uid);
                  ...
                  for (paramInt = i;; paramInt = 0)
                  {
                    ...
                    ((tdo)localObject3).a(paramObject);
                  ...
                  if (paramBoolean)
                  {
                    Bosses.get().postJob(new ssz(this, "QQStoryObserver", paramObject, (Boolean)localObject1, paramBoolean, paramInt));
                    return;
                  }
                  localObject1 = ((tdo)tdc.a(2)).b(paramObject);
                  if (localObject1 != null)
                  {
