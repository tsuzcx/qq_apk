...
public class ssy
{
  private static Map<String, ssz> jdField_a_of_type_JavaUtilMap = new HashMap();
    ...
    for (;;)
    {
      try
      {
        ...
        if (NetworkState.isWifiConn())
        {
          ...
          localJSONObject.put("net_type", nnr.a() + "");
  ...
  public static paa a(ArticleInfo paramArticleInfo)
  {
    ...
    localpaa.b("folder_status", ozs.d);
    localpaa.b("feeds_source", paramArticleInfo.mSubscribeID);
    localpaa.b("feeds_type", paramArticleInfo.mFeedType);
    localpaa.b("kandian_mode", ozs.e());
    localpaa.b("tab_source", ozs.d());
    localpaa.b("rowkey", paramArticleInfo.innerUniqueID);
    localpaa.a("channel_id", paramArticleInfo.mChannelID);
    return localpaa;
  }
  
  public static paa a(ArticleInfo paramArticleInfo, boolean paramBoolean, long paramLong, int paramInt)
  {
    paa localpaa = ozs.a();
    localpaa.b("algorithm_id", "" + paramArticleInfo.mAlgorithmID);
    localpaa.b("strategy_id", "" + paramArticleInfo.mStrategyId);
    if (paramBoolean) {}
    for (String str = "2";; str = "1")
    {
      localpaa.b("feeds_channel_entrance", str);
      localpaa.b("mp_article_id", "" + paramArticleInfo.mArticleID);
      localpaa.b("rowkey", paramArticleInfo.innerUniqueID);
      localpaa.b("channel_id", "" + a(paramBoolean, paramLong));
      if (paramInt != -1) {
        localpaa.b("source_extratype", paramInt);
      }
      return localpaa;
    }
  }
  
  private static ssz a(String paramString)
  {
    ssz localssz2 = (ssz)jdField_a_of_type_JavaUtilMap.get(paramString);
    ssz localssz1 = localssz2;
    if (localssz2 == null)
    {
      localssz1 = new ssz(pag.a(paramString));
      jdField_a_of_type_JavaUtilMap.put(paramString, localssz1);
    }
    return localssz1;
  }
  ...
  public static void a(Context paramContext, AppInterface paramAppInterface, ArticleInfo paramArticleInfo, int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2, JSONObject paramJSONObject)
  {
    ...
    paramContext = oxw.a(paramContext, paramAppInterface.getCurrentAccountUin(), i, paramArticleInfo.mArticleID, paramArticleInfo.innerUniqueID, paramInt1, paramInt2, paramBoolean1, null);
    if (paramBoolean2) {
      paramInt1 = 1;
    }
    try
    {
      for (;;)
      {
        ...
        oyq.a(paramContext, paramJSONObject);
        ocd.a(null, "", "0X8009544", "0X8009544", 0, 0, "", String.valueOf(paramArticleInfo.mArticleID), String.valueOf(paramArticleInfo.mAlgorithmID), paramContext.toString(), false);
        return;
        paramInt1 = 0;
      }
    }
  ...
  public static void a(Context paramContext, AppInterface paramAppInterface, ArticleInfo paramArticleInfo, int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    int i = a((int)paramArticleInfo.mChannelID, paramArticleInfo.mFeedType);
    paramContext = oxw.a(paramContext, paramAppInterface.getCurrentAccountUin(), i, paramArticleInfo.mArticleID, paramArticleInfo.innerUniqueID, paramInt1, paramInt2, paramBoolean1, Boolean.valueOf(paramBoolean2));
    if (paramBoolean3) {
      paramInt1 = 1;
    }
    try
    {
      ...
      {
        paramContext.put("is_redpack", paramInt1);
        ocd.a(null, "", "0X800979D", "0X800979D", 0, 0, "", String.valueOf(paramArticleInfo.mArticleID), String.valueOf(paramArticleInfo.mAlgorithmID), paramContext.toString(), false);
  ...
  public static void a(VideoInfo paramVideoInfo, boolean paramBoolean)
  {
    ...
    paramVideoInfo = new sbg(paramVideoInfo).i(paramVideoInfo.g).n(3);
    if (paramBoolean) {}
    for (int i = 1;; i = 2)
    {
      ocd.a(null, null, "0X800A731", "0X800A731", 0, 0, "", "", "", paramVideoInfo.o(i).a().a(), false);
      return;
    }
  }
  
  public static void a(ArticleInfo paramArticleInfo, int paramInt1, int paramInt2, paa parampaa)
  {
    int j = BaseApplicationImpl.getApplication().getResources().getDisplayMetrics().widthPixels;
    int i = Utils.px2dp(paramInt1);
    j = Utils.px2dp(j);
    parampaa.b("read_area", "" + j * i);
    parampaa.b("article_page", "" + Utils.px2dp(paramInt2));
    parampaa.b("read_page", "" + Utils.px2dp(paramInt1));
    ocd.a(null, "CliOper", "", "", "0X8009782", "0X8009782", 0, 0, "" + paramArticleInfo.mArticleID, "", "", parampaa.a(), false);
  }
  ...
  public static void a(ArticleInfo paramArticleInfo, int paramInt1, int paramInt2, boolean paramBoolean, long paramLong, int paramInt3)
  {
    ...
    paa localpaa = a(paramArticleInfo, paramBoolean, paramLong, paramInt3);
    a(paramArticleInfo, paramInt2, localpaa);
    a(paramArticleInfo, localpaa);
    a(paramArticleInfo, paramInt1, paramInt2, localpaa);
    b(paramArticleInfo, localpaa);
    c(paramArticleInfo, a(paramArticleInfo, paramBoolean, paramLong, paramInt3));
  }
  
  public static void a(ArticleInfo paramArticleInfo, int paramInt, paa parampaa)
  {
    ArrayList localArrayList = new ArrayList();
    oidb_cmd0x80a.AttributeList localAttributeList = new oidb_cmd0x80a.AttributeList();
    localAttributeList.att_id.set(1);
    localAttributeList.att_name.set("body_show_time");
    long l3 = pag.b(a(paramArticleInfo, 0));
    ...
    for (;;)
    {
      if (((oidb_cmd0x80a.AttributeList)localObject1).att_value.get() != null)
      {
        ...
        tzq.a(201, localArrayList);
      }
      try
      {
        parampaa.a("body_show_time", String.valueOf(l3));
        parampaa.a("body_height", String.valueOf(paramInt));
        parampaa.a("scroll_time", String.valueOf(l2));
        parampaa.a("scroll_list", localStringBuilder.toString());
        ocd.a(null, "", "0X800A467", "0X800A467", 0, 0, "", "", "", parampaa.a(), false);
        return;
        label666:
  ...
  public static void a(ArticleInfo paramArticleInfo, long paramLong1, long paramLong2, paa parampaa)
  {
    if (paramArticleInfo == null) {
      return;
    }
    parampaa.b("read_duration", "" + paramLong1 / 1000L);
    parampaa.b("read_begin_timestamp", "" + paramLong2 / 1000L);
    parampaa.b("read_end_timestamp", "" + NetConnInfoCenter.getServerTime());
    ocd.a(null, "CliOper", "", "" + paramArticleInfo.mSubscribeID, "0X8009781", "0X8009781", 0, 0, "" + paramArticleInfo.mArticleID, "", "", parampaa.a(), false);
  }
  ...
  {
    ocd.a(null, "CliOper", "", paramArticleInfo.mSubscribeID, paramString1, paramString1, 0, 0, paramArticleInfo.mArticleID + "", paramArticleInfo.mAlgorithmID + "", paramArticleInfo.innerUniqueID, paramString2, false);
  }
  ...
  public static void a(ArticleInfo paramArticleInfo, String paramString, JSONObject paramJSONObject)
  {
    ...
    ocd.a(null, "", paramString, paramString, 0, 0, String.valueOf(paramArticleInfo.mArticleID), String.valueOf(paramArticleInfo.mStrategyId), paramArticleInfo.innerUniqueID, paramJSONObject.toString(), false);
  }
  ...
  public static void a(ArticleInfo paramArticleInfo, List<BaseData> paramList)
  {
    ...
    paramList.put("param_uin", ozs.a());
    bdmc.a(BaseApplicationImpl.getApplication()).a(null, "actKandianFastWebItemCount", true, 0L, 0L, paramList, null);
  }
  
  public static void a(ArticleInfo paramArticleInfo, paa parampaa)
  {
    if (paramArticleInfo != null)
    {
      a(paramArticleInfo, pag.b(paramArticleInfo.innerUniqueID), pag.a(paramArticleInfo.innerUniqueID), parampaa);
      pag.a(paramArticleInfo.innerUniqueID);
    }
  }
  ...
  public static void a(BaseData paramBaseData, String paramString)
  {
    ...
    paa localpaa = new paa();
    localpaa.b("card_source", localProteusBookData.c);
    localpaa.b("topic_id", localProteusBookData.d);
    localpaa.b("source_id", localProteusBookData.e);
    ocd.a(null, "CliOper", "", "" + localFastWebArticleInfo.d, paramString, paramString, 0, 0, localFastWebArticleInfo.o + "", paramBaseData.mAlgorithmID + "", paramBaseData.innerUniqueID, localpaa.a(), false);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, AdData paramAdData)
  {
    ...
    {
      nzq.b(paramQQAppInterface, paramAdData);
  ...
  public static void a(QQAppInterface paramQQAppInterface, AdData paramAdData, float paramFloat, long paramLong)
  {
    if ((paramQQAppInterface != null) && (paramAdData != null))
    {
      ...
      tku.a(false, paramQQAppInterface.getApp().getApplicationContext(), tqb.a(paramAdData), nzq.Y, nzq.jdField_b_of_type_Int, 3);
    }
    for (;;)
    {
      ...
      return;
      label111:
      nzq.a(paramQQAppInterface, paramAdData, paramFloat, paramLong);
    }
  }
  ...
  public static void a(ColorNote paramColorNote)
  {
    ...
    if (paramColorNote.mSubType.startsWith(aqso.a))
    {
      d(paramColorNote);
      return;
    }
  ...
  public static void a(String paramString, JSONObject paramJSONObject1, JSONObject paramJSONObject2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramString = new paa(localJSONObject2);
        paramString.e();
        ocd.a(null, "", str, str, 0, 0, "", "", "", paramString.a(), false);
  ...
  public static void a(JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        Object localObject2 = new paa((JSONObject)localObject1);
        ((paa)localObject2).e();
        ocd.a(null, "", str, str, 0, 0, "", "", "", ((paa)localObject2).a(), false);
        ...
        try
        {
          ...
          else
          {
            ...
            bcjy.a(null, new ReportModelDC02528().module("all_search").action("exp_jingtan_list").obj1("2049").ver2("kandian").ver4(str).ver6(localJSONObject.getString("articleRowKey")).ver7("{\"title\":\"" + localJSONObject.getString("articleTitle") + "\"}").session_id(paramJSONObject.getString("kdschSessionId")));
            return;
          }
        }
  ...
  public static void b(ArticleInfo paramArticleInfo, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        paa localpaa = a(paramArticleInfo);
        localpaa.b("source_from", paramString2);
        if (!ozs.p()) {
          continue;
        }
        i = 1;
      ...
      ocd.a(null, paramArticleInfo.mSubscribeID, paramString1, paramString1, 0, 0, String.valueOf(paramArticleInfo.mFeedId), String.valueOf(paramArticleInfo.mArticleID), "", paramString2, false);
      return;
      i = 0;
    }
  }
  
  public static void b(ArticleInfo paramArticleInfo, paa parampaa)
  {
    ssz localssz = a(paramArticleInfo.innerUniqueID);
    if (localssz.a.isEmpty()) {
      return;
    }
    parampaa.i();
    parampaa.b("read_begin_timestamp", "" + localssz.jdField_b_of_type_Long / 1000L);
    parampaa.b("read_end_timestamp", "" + localssz.c / 1000L);
    String str1 = "";
    Iterator localIterator = localssz.a.iterator();
    long l = 0L;
    ...
    parampaa.b("read_speed_array", str1);
    parampaa.b("avg_speed", "" + l / localssz.a.size());
    ocd.a(null, "CliOper", "", "", "0X8009783", "0X8009783", 0, 0, "" + paramArticleInfo.mArticleID, "", "", parampaa.a(), false);
  ...
  public static void b(QQAppInterface paramQQAppInterface, AdData paramAdData)
  {
    ...
    for (;;)
    {
      ...
      return;
      label91:
      nzq.c(paramQQAppInterface, paramAdData);
    }
  }
  
  public static void b(ColorNote paramColorNote)
  {
    paramColorNote = tci.b(paramColorNote);
    if ((paramColorNote == null) || (paramColorNote.length() == 0)) {
      return;
    }
    ocd.a(null, null, "0X800A731", "0X800A731", 0, 0, "", "", "", new sbg(paramColorNote.toString()).a().a(), false);
  }
  ...
  public static void b(JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      paramJSONObject = new paa(localJSONObject);
      paramJSONObject.e();
      ocd.a(null, "", "0X8009A7D", "0X8009A7D", 0, 0, "", "", "", paramJSONObject.a(), false);
      return;
    }
    catch (Exception paramJSONObject) {}
  }
  ...
  private static void c(ArticleInfo paramArticleInfo, paa parampaa)
  {
    parampaa.b().e();
    ...
    while (i < j)
    {
      ...
      long l = pag.b(str);
      parampaa.a(jdField_a_of_type_ArrayOfJavaLangString[localInteger.intValue()] + "_duration_millis", l);
      pag.a(str);
      i += 1;
    }
    ocd.a(null, "CliOper", "", "" + paramArticleInfo.mSubscribeID, "0X80099D2", "0X80099D2", 0, 0, "", "" + paramArticleInfo.mArticleID, "", parampaa.a(), false);
  }
