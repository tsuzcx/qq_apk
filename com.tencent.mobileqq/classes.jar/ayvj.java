  ...
  implements ITransactionCallback
{
  ...
  public ayvj(ShortVideoUploadProcessor paramShortVideoUploadProcessor) {}
  ...
  public void onFailed(int paramInt, byte[] paramArrayOfByte, HashMap<String, String> paramHashMap)
  {
    ...
    synchronized (this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor)
    {
      ...
      paramHashMap = (aypd)this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_b_of_type_JavaUtilHashMap.get(Integer.valueOf(this.jdField_a_of_type_Int));
  ...
  public void onSuccess(byte[] paramArrayOfByte, HashMap<String, String> paramHashMap)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor)
      {
        ...
        localObject1 = (aypd)this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_b_of_type_JavaUtilHashMap.get(Integer.valueOf(this.jdField_a_of_type_Int));
      ...
      if ((ShortVideoUploadProcessor.jdField_a_of_type_Boolean) && (paramArrayOfByte != null) && (paramArrayOfByte.length > 0))
      {
        ...
        try
        {
          ...
          else
          {
            ...
            bbfb.a(String.valueOf(this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Aywc.jdField_a_of_type_Long), "svrcomp_r", "TransactionListener.onSuccess -> get MD5 from Server success!  MD5:" + HexUtil.bytes2HexStr((byte[])localObject2));
            this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Aywc.f = HexUtil.bytes2HexStr((byte[])localObject2);
            this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Aywc.f;
            if (this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_JavaUtilHashMap != null)
            {
              this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_JavaUtilHashMap.put("param_fileMD5", this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Aywc.f);
            ...
            this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Aywc.i = ShortVideoUtils.a((MessageForShortVideo)this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Aywc.jdField_a_of_type_ComTencentMobileqqDataMessageRecord, "mp4");
    ...
    Object localObject1 = this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Ayqo;
    Object localObject2 = this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Ayqo;
    ...
    ((ayqo)localObject1).jdField_a_of_type_Long = l;
  ...
  public void onUpdateProgress(int paramInt)
  {
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Ayqo.e = this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.s;
        if (this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction.cacheIp == 0) {
          break label317;
        }
