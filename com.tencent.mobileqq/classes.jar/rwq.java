...
public class rwq
{
  ...
  public static Readinjoy.ArticleSummary a(BaseVideoArticleInfo paramBaseVideoArticleInfo)
  {
    ...
    for (;;)
    {
      ...
      catch (Throwable paramBaseVideoArticleInfo)
      {
        ...
        QLog.e("VideoProtoHelper", 0, "videoArticleinfoCovert2LocalPB error:" + ozs.a(paramBaseVideoArticleInfo));
      }
  ...
  public static Readinjoy.VideoData a(qzj paramqzj)
  {
    Object localObject;
    if (paramqzj == null) {
      localObject = null;
    ...
    do
    {
      ...
      localVideoData.uint32_busi_type.set(paramqzj.jdField_a_of_type_Int);
      localVideoData.uint32_duration.set(paramqzj.jdField_b_of_type_Int);
      localVideoData.uint32_width.set(paramqzj.c);
      localVideoData.uint32_height.set(paramqzj.d);
      if (!TextUtils.isEmpty(paramqzj.jdField_a_of_type_JavaLangString)) {
        localVideoData.bytes_vid.set(ByteStringMicro.copyFromUtf8(paramqzj.jdField_a_of_type_JavaLangString));
      }
      localVideoData.uint32_file_size.set(paramqzj.e);
      localObject = localVideoData;
    } while (TextUtils.isEmpty(paramqzj.jdField_b_of_type_JavaLangString));
    localVideoData.bytes_video_url.set(ByteStringMicro.copyFromUtf8(paramqzj.jdField_b_of_type_JavaLangString));
    return localVideoData;
  }
  
  public static qzj a(Readinjoy.VideoData paramVideoData)
  {
    ...
    do
    {
      ...
      if (paramVideoData.uint32_busi_type.has()) {
        localqzj.jdField_a_of_type_Int = paramVideoData.uint32_busi_type.get();
      }
      if (paramVideoData.uint32_duration.has()) {
        localqzj.jdField_b_of_type_Int = paramVideoData.uint32_duration.get();
      }
      if (paramVideoData.uint32_width.has()) {
        localqzj.c = paramVideoData.uint32_width.get();
      }
      if (paramVideoData.uint32_height.has()) {
        localqzj.d = paramVideoData.uint32_height.get();
      }
      if (paramVideoData.bytes_vid.has()) {
        localqzj.jdField_a_of_type_JavaLangString = paramVideoData.bytes_vid.get().toStringUtf8();
      }
      if (paramVideoData.uint32_file_size.has()) {
        localqzj.e = paramVideoData.uint32_file_size.get();
      }
      localObject = localqzj;
    } while (!paramVideoData.bytes_video_url.has());
    localqzj.jdField_b_of_type_JavaLangString = paramVideoData.bytes_video_url.get().toStringUtf8();
    return localqzj;
  }
}
