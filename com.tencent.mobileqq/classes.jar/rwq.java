      ...
      for (;;)
      {
        ...
        if ("getCache".equals(paramString))
        {
          try
          {
            ...
            qkb.a().a(paramJSONObject.getString("url"), paramJSONObject.toString(), new rwr(paramOnInovkeCallback));
            return;
          }
          catch (JSONException paramString)
          {
        ...
        else if ("writeCache".equals(paramString))
        {
          try
          {
            ...
            {
              paramJSONObject.put("callid", 0);
              qkb.a().a(paramJSONObject.getString("url"), paramJSONObject.toString(), null, paramJSONObject);
              return;
            }
          }
          catch (JSONException paramString)
