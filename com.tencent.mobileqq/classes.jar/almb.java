...
final class almb
  implements bcgn
{
  almb(RockDownloaderTask paramRockDownloaderTask, boolean paramBoolean) {}
  ...
  public void onDownloadError(DownloadInfo paramDownloadInfo, int paramInt1, String paramString, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqBigbrotherRockDownloaderRockDownloaderTask.getRockDownloadListener().onDownloadFail(this.jdField_a_of_type_ComTencentMobileqqBigbrotherRockDownloaderRockDownloaderTask.getDownloadInfo(), ajjy.a(2131647703), 10010);
    }
    for (;;)
    {
      this.jdField_a_of_type_ComTencentMobileqqBigbrotherRockDownloaderRockDownloaderTask.getRockDownloadListener().onDownloadFinish(this.jdField_a_of_type_ComTencentMobileqqBigbrotherRockDownloaderRockDownloaderTask.getDownloadInfo());
      paramString = (DownloadInfo)bccu.a().a().remove(paramDownloadInfo.b);
      if (QLog.isColorLevel()) {
        QLog.d("RockDownloader", 2, new Object[] { "onDownloadError removedDownload=", paramString });
      }
      bccs.a().a(paramDownloadInfo.b);
      allz.a(this.jdField_a_of_type_ComTencentMobileqqBigbrotherRockDownloaderRockDownloaderTask, "0x800A1E6");
      bccu.a().b(this);
      return;
      label200:
  ...
  public void onDownloadFinish(DownloadInfo paramDownloadInfo)
  {
    ...
    allz.a(this.jdField_a_of_type_ComTencentMobileqqBigbrotherRockDownloaderRockDownloaderTask, paramDownloadInfo, this.jdField_a_of_type_Boolean);
    bccu.a().b(this);
  }
