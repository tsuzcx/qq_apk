...
public class aesh
{
  ...
  AdapterView.OnItemClickListener jdField_a_of_type_AndroidWidgetAdapterView$OnItemClickListener = new aesi(this);
  private bdnc jdField_a_of_type_Bdnc;
  ...
  public aesh(FragmentActivity paramFragmentActivity, QQAppInterface paramQQAppInterface, IntimateInfo paramIntimateInfo, Bitmap paramBitmap1, Bitmap paramBitmap2, Bitmap paramBitmap3)
  {
    ...
    if ((this.c == null) || (this.c.isRecycled())) {
      this.c = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130845952);
    }
    if ((this.d == null) || (this.d.isRecycled())) {
      this.d = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130845952);
    }
    jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693766) + this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693767) + this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693768);
  }
  ...
  private void a(Bitmap paramBitmap, int paramInt)
  {
    ...
    {
      this.jdField_a_of_type_Bfah = new aesj(this);
  ...
  private void b(Bitmap paramBitmap)
  {
    ...
    localbjea.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount();
    bjdt.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, localbjea, paramBitmap, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693770), "", 20001);
  }
  
  private void c()
  {
    this.jdField_a_of_type_Bdnc = new bdnc(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity);
    this.jdField_a_of_type_ArrayOfJavaUtilList = a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity);
    this.jdField_a_of_type_Bdnc.setActionSheetItems(this.jdField_a_of_type_ArrayOfJavaUtilList);
    this.jdField_a_of_type_Bdnc.setItemClickListener(this.jdField_a_of_type_AndroidWidgetAdapterView$OnItemClickListener);
  }
  ...
  private void c(Bitmap paramBitmap)
  {
    try
    {
      ...
      aryv.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, (Intent)localObject, 21);
      return;
    }
  ...
  public Bitmap a(Bitmap paramBitmap)
  {
    ...
    localCanvas.restore();
    localCanvas.drawBitmap(a(BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130840257), 194, 40), 512.0F, 1185.0F, null);
    return paramBitmap;
  }
  ...
  public Bitmap a(IntimateInfo paramIntimateInfo)
  {
    ...
    default: 
      ...
      a(localCanvas, localTextPaint, 8.0F + (f + 146.0F), 410.0F, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693705, new Object[] { "" }));
      ...
      {
        localStringBuilder.append(((Resources)localObject).getString(2131693729));
        localStringBuilder.append(this.jdField_a_of_type_ComTencentMobileqqDataIntimateInfo.commonTroopInfoList.size());
        localStringBuilder.append(((Resources)localObject).getString(2131693716));
        localStringBuilder.append("\r\n");
        label493:
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (k < j)
        {
          ...
          k += 1;
          continue;
          localObject = this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693761);
          j = Color.parseColor("#FF6FA3");
          i = Color.parseColor("#FF8AB5");
          localBitmap1 = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130840256);
          break;
          ...
          break;
          localObject = this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693760);
      ...
      localStringBuilder.append(((Resources)localObject).getString(2131693755));
      localStringBuilder.append("\r\n");
      localStringBuilder.append(((Resources)localObject).getString(2131693756));
  ...
  public String a(Bitmap paramBitmap)
  {
    ...
    //   19: aload_0
    //   20: getfield 35	aesh:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   47: dup
    //   48: getstatic 678	alof:aX	Ljava/lang/String;
    //   51: ldc_w 680
    ...
    //   60: invokestatic 690	bdzf:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   75: ifnonnull +11 -> 86
    //   78: aload_0
    //   79: getfield 33	aesh:jdField_a_of_type_AndroidSupportV4AppFragmentActivity	Landroid/support/v4/app/FragmentActivity;
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Bdnc == null) {
      c();
    }
    ...
    this.jdField_a_of_type_Bdnc.a(this.jdField_a_of_type_AndroidGraphicsBitmap);
    this.jdField_a_of_type_Bdnc.show();
  }
  ...
  public void a(int paramInt, Bitmap paramBitmap)
  {
    if ((paramInt == 3) || (paramInt == 4))
    {
      ...
      QQToast.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131693763), 0).b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getTitleBarHeight());
    }
    for (;;)
    {
      d();
      ...
      if (!WXShareHelper.a().b()) {
        QQToast.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131693771), 0).b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getTitleBarHeight());
      }
    }
  }
  ...
  public List<ShareActionSheetBuilder.ActionSheetItem>[] a(Context paramContext)
  {
    ...
    localArrayList.add(localActionSheetItem);
    localActionSheetItem = new ShareActionSheetBuilder.ActionSheetItem();
    localActionSheetItem.label = paramContext.getString(2131693773);
    localActionSheetItem.icon = 2130839745;
    localActionSheetItem.iconNeedBg = true;
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Bdnc != null) {
      this.jdField_a_of_type_Bdnc.dismiss();
    }
  }
}
