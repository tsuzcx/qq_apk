...
public class amyr
{
  ...
  public static amyr a()
  {
    if (jdField_a_of_type_Amyr == null) {}
    try
    {
      if (jdField_a_of_type_Amyr == null) {
        jdField_a_of_type_Amyr = new amyr();
      }
      return jdField_a_of_type_Amyr;
    }
    finally {}
  }
  ...
  public static void a(FragmentActivity paramFragmentActivity, Intent paramIntent)
  {
    ...
    try
    {
      ...
      if (!localApolloWebViewFragment.isAdded()) {
        paramIntent.beginTransaction().add(2131367403, localApolloWebViewFragment).commitAllowingStateLoss();
      }
      paramIntent.beginTransaction().show(localApolloWebViewFragment).setCustomAnimations(2130772048, 2130772049).commit();
  ...
  {
    // Byte code:
    //   0: getstatic 25	amyr:b	Ljava/util/Stack;
    ...
    //   11: aload_3
    //   12: ifnull +41 -> 53
    //   15: getstatic 23	amyr:jdField_a_of_type_JavaUtilStack	Ljava/util/Stack;
    //   18: aload_3
    ...
    //   35: aload_0
    //   36: invokevirtual 259	amyr:b	()V
    //   39: return
    //   40: getstatic 25	amyr:b	Ljava/util/Stack;
    ...
    //   91: aload_1
    //   92: ldc 66
    //   94: getstatic 32	amyr:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger	Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    //   109: getstatic 23	amyr:jdField_a_of_type_JavaUtilStack	Ljava/util/Stack;
    //   112: aload_2
    //   113: invokevirtual 253	java/util/Stack:push	(Ljava/lang/Object;)Ljava/lang/Object;
    //   116: pop
    //   117: aload_0
    //   118: getfield 41	amyr:jdField_a_of_type_AndroidSupportV4AppFragmentActivity	Landroid/support/v4/app/FragmentActivity;
    ...
    //   147: aload_0
    //   148: getfield 41	amyr:jdField_a_of_type_AndroidSupportV4AppFragmentActivity	Landroid/support/v4/app/FragmentActivity;
    //   151: aload_3
    ...
    try
    {
      if ((this.jdField_a_of_type_AndroidSupportV4AppFragmentManager != null) && (!jdField_a_of_type_JavaUtilStack.isEmpty()))
      {
        ...
        if (localApolloFragment != null)
        {
          ...
          this.jdField_a_of_type_AndroidSupportV4AppFragmentManager.beginTransaction().show(localApolloFragment).setCustomAnimations(2130772048, 2130772049).commit();
