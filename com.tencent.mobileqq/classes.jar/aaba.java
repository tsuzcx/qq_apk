...
public class aaba
{
  ...
  private aaau jdField_a_of_type_Aaau;
  public Activity a;
  ...
  public aaba(Activity paramActivity)
  {
    this(paramActivity, null);
  }
  
  public aaba(Activity paramActivity, aabf paramaabf)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWidgetShareShareActionSheet.setOnDismissListener(new aabb(this));
      this.jdField_a_of_type_ComTencentMobileqqWidgetShareShareActionSheet.setCancelListener(new aabc(this));
      this.jdField_a_of_type_ComTencentMobileqqWidgetShareShareActionSheet.setItemClickListenerV2(new aabg(this, paramaabf));
      if (this.jdField_a_of_type_Aaau == null) {
        this.jdField_a_of_type_Aaau = new aaau(this.jdField_a_of_type_AndroidAppActivity);
      }
      return;
    }
  }
  ...
  private Intent a()
  {
    if ((this.jdField_a_of_type_Zsf == null) || (this.jdField_a_of_type_Zsf.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed == null) || (TextUtils.isEmpty(this.jdField_a_of_type_Zsf.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed.poster.nick.get()))) {
      return null;
    }
    ...
    localIntent.putExtra("category", this.jdField_a_of_type_AndroidAppActivity.getString(2131695024));
    localIntent.putExtra("forward_type", 1001);
    localIntent.putExtra("detail_url", this.jdField_a_of_type_Zsf.b());
    localIntent.putExtra("title", this.jdField_a_of_type_Zsf.f());
    localIntent.putExtra("forward _key_nojump", true);
    localIntent.putExtra("brief_key", BaseApplicationImpl.getContext().getString(2131696132, new Object[] { this.jdField_a_of_type_Zsf.f() }));
    localIntent.putExtra("desc", a(this.jdField_a_of_type_Zsf.g()));
    localIntent.putExtra("req_type", 1);
    localIntent.putExtra("struct_share_key_content_action", "plugin");
    localIntent.putExtra("pubUin", this.jdField_a_of_type_Zsf.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed.poster.id.get());
    localIntent.putExtra("pluginName", "public_account");
    localIntent.putExtra("pubUin", this.jdField_a_of_type_Zsf.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed.poster.id.get());
    localIntent.putExtra("image_url_remote", this.jdField_a_of_type_Zsf.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed.poster.icon.get());
    localIntent.putExtra("struct_share_key_content_action_DATA", a(this.jdField_a_of_type_Zsf.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed.poster.id.get(), this.jdField_a_of_type_Zsf.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed.poster.nick.get(), this.jdField_a_of_type_Zsf.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed.poster.icon.get()));
    AbsStructMsg localAbsStructMsg = bdof.a(localIntent.getExtras());
  ...
  public static String a(zsf paramzsf)
  {
    if (paramzsf != null)
    {
      String str = paramzsf.d();
      Object localObject = str;
      if (paramzsf.jdField_a_of_type_ComTencentBizSubscribeBaseUIExtraTypeInfo != null) {
        if (paramzsf.jdField_a_of_type_ComTencentBizSubscribeBaseUIExtraTypeInfo.pageType != 7002)
        {
          localObject = str;
          if (paramzsf.jdField_a_of_type_ComTencentBizSubscribeBaseUIExtraTypeInfo.pageType != 7005) {}
        }
        else
        {
          paramzsf = paramzsf.a().poster.desc.get();
          if ((!TextUtils.isEmpty(paramzsf)) && (!paramzsf.equals(anvx.a(2131719098))))
          {
            localObject = paramzsf;
            if (!TextUtils.isEmpty(paramzsf.trim())) {}
          }
          else
          {
            localObject = anvx.a(2131719097);
          }
        }
      }
      return localObject;
  ...
  private List<Integer> a(zsf paramzsf)
  {
    ...
    int i = paramzsf.jdField_a_of_type_ComTencentBizSubscribeBaseUIExtraTypeInfo.pageType;
    if ((i == 7000) || (i == 8001)) {
  ...
  {
    if ((this.jdField_a_of_type_Zsf == null) || (this.jdField_a_of_type_AndroidAppActivity == null)) {
      return;
    }
    Object localObject = this.jdField_a_of_type_Zsf.b();
    String str1 = a(this.jdField_a_of_type_Zsf.c());
    String str2 = a(this.jdField_a_of_type_Zsf.d());
    HashMap localHashMap = new HashMap(1);
    if ((localObject == null) || (((String)localObject).isEmpty()))
    {
      QQToast.a(this.jdField_a_of_type_AndroidAppActivity, 1, anvx.a(2131714021), 0).a();
      return;
    }
    int i;
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (TextUtils.isEmpty(this.jdField_a_of_type_Zsf.e()))
        {
  ...
  private void a(CertifiedAccountMeta.StFeed paramStFeed, int paramInt, ExtraTypeInfo paramExtraTypeInfo)
  {
    if ((paramStFeed != null) && (!StringUtil.isEmpty(paramStFeed.poster.id.get())) && (!StringUtil.isEmpty(paramStFeed.id.get())) && (paramExtraTypeInfo != null)) {
      aanb.a(paramStFeed.poster.id.get(), "auth_share", "clk_" + a(paramExtraTypeInfo), paramInt, 0, new String[] { "", "", paramStFeed.id.get() });
    }
  }
  ...
  {
    if ((this.jdField_a_of_type_Zsf != null) && (this.jdField_a_of_type_Zsf.jdField_a_of_type_ComTencentBizSubscribeBaseUIExtraTypeInfo != null) && (a()) && ((this.jdField_a_of_type_Zsf.jdField_a_of_type_ComTencentBizSubscribeBaseUIExtraTypeInfo.pageType == 7000) || (this.jdField_a_of_type_Zsf.jdField_a_of_type_ComTencentBizSubscribeBaseUIExtraTypeInfo.pageType == 7001) || (this.jdField_a_of_type_Zsf.jdField_a_of_type_ComTencentBizSubscribeBaseUIExtraTypeInfo.pageType == 8001))) {
  ...
  private boolean a()
  {
    if ((this.jdField_a_of_type_Zsf == null) || (this.jdField_a_of_type_Zsf.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed == null)) {
      return false;
    }
    return zqn.a(this.jdField_a_of_type_Zsf.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed.poster.attr.get());
  }
  
  @NotNull
  private List[] a(zsf paramzsf)
  {
    List localList = a(paramzsf);
    paramzsf = b(paramzsf);
    if ((((String)VSConfigManager.getInstance().getValue("is_open_sharing", "1")).equals("1")) && (this.jdField_a_of_type_Zsf != null) && (this.jdField_a_of_type_Zsf.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed != null) && (zqn.a(this.jdField_a_of_type_Zsf.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed.status.get()))) {}
    for (int i = 1; i != 0; i = 0) {
      return new List[] { localList, paramzsf };
    }
    return new List[] { paramzsf };
  }
  ...
  private Intent b()
  {
    if ((this.jdField_a_of_type_Zsf == null) || (this.jdField_a_of_type_Zsf.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StShare == null) || (TextUtils.isEmpty(this.jdField_a_of_type_Zsf.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StShare.shareCardInfo.get()))) {
      return null;
    }
    ...
    try
    {
      JSONObject localJSONObject = new JSONObject(this.jdField_a_of_type_Zsf.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StShare.shareCardInfo.get());
  ...
  private List<Integer> b(zsf paramzsf)
  {
    ArrayList localArrayList = new ArrayList();
    int i;
    if ((paramzsf != null) && (paramzsf.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed != null) && (paramzsf.jdField_a_of_type_ComTencentBizSubscribeBaseUIExtraTypeInfo != null))
    {
      paramzsf.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed.type.get();
      i = paramzsf.jdField_a_of_type_ComTencentBizSubscribeBaseUIExtraTypeInfo.pageType;
      if ((this.jdField_a_of_type_AndroidAppActivity != null) && (this.jdField_a_of_type_Aqnr != null) && (this.jdField_a_of_type_Aqnr.a()))
      {
      ...
      if (b())
      {
        ...
        aanb.b(this.jdField_a_of_type_Zsf.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed.poster.id.get(), "auth_share", "exp_shoplist", 0, 0, new String[0]);
      }
      if (this.jdField_a_of_type_Boolean)
      {
        localArrayList.add(Integer.valueOf(157));
        if ((this.jdField_a_of_type_Zsf != null) && (this.jdField_a_of_type_Zsf.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed != null)) {
          aanb.a(this.jdField_a_of_type_Zsf.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed.poster.id.get(), "auth_share", "exp_shop", 0, 0, new String[0]);
        }
      }
    }
    for (;;)
    {
      if ((paramzsf.jdField_a_of_type_Boolean) && (!a())) {
      ...
      if ((i == 7002) && (paramzsf.b)) {
        localArrayList.add(Integer.valueOf(154));
      }
      if (this.jdField_a_of_type_Zsf.c)
      {
        i = this.jdField_a_of_type_Zsf.jdField_a_of_type_ComTencentBizSubscribeBaseUIExtraTypeInfo.pageType;
  ...
  private boolean b()
  {
    ...
    return zqn.d(this.jdField_a_of_type_Zsf.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed.poster.attr.get());
  }
  ...
  private void c()
  {
    ...
    SubscribeDeleteFeedRequest localSubscribeDeleteFeedRequest = new SubscribeDeleteFeedRequest(this.jdField_a_of_type_Zsf.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed);
    VSNetworkHelper.getInstance().sendRequest(localSubscribeDeleteFeedRequest, new aabd(this));
    try
    {
      aanb.a(this.jdField_a_of_type_Zsf.a(), "auth_share", "delete", 0, 0, new String[] { "", "", ((CertifiedAccountMeta.StUser)this.jdField_a_of_type_Zsf.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StShare.author.get()).nick.get(), this.jdField_a_of_type_Zsf.c() });
      return;
    }
  ...
  private void d()
  {
    ...
    String str4;
    String str1;
    if ((this.jdField_a_of_type_Zsf != null) && (this.jdField_a_of_type_Zsf.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed != null) && (this.jdField_a_of_type_Zsf.jdField_a_of_type_ComTencentBizSubscribeBaseUIExtraTypeInfo != null))
    {
      str2 = this.jdField_a_of_type_Zsf.c();
      this.jdField_a_of_type_Zsf.d();
      str3 = this.jdField_a_of_type_Zsf.e();
      str4 = this.jdField_a_of_type_Zsf.a();
    ...
    for (;;)
    {
      String str5 = this.jdField_a_of_type_Zsf.f();
      bmad.a(3, str2, str1, null, null, str3, null, null, false, -1L).c(str4).a("lCategory", 10L).b("sUin", str5).b("sName", str5).c(this.jdField_a_of_type_AndroidAppActivity, BaseApplicationImpl.getApplication().getRuntime().getAccount(), 2, null);
      return;
      str1 = a(this.jdField_a_of_type_Zsf.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed);
      continue;
      str1 = this.jdField_a_of_type_Zsf.b();
    }
  }
  ...
  private void e()
  {
    zqm.a(a(this.jdField_a_of_type_Zsf.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed, this.jdField_a_of_type_Zsf.jdField_a_of_type_ComTencentBizSubscribeBaseUIExtraTypeInfo));
  }
  ...
  private void f()
  {
    ...
    this.jdField_a_of_type_Biyn = new aabe(this);
  ...
  private void g()
  {
    ...
    localBundle.putString("title", this.jdField_a_of_type_Zsf.c());
    localBundle.putString("desc", a(this.jdField_a_of_type_Zsf));
    localBundle.putString("detail_url", this.jdField_a_of_type_Zsf.b() + "&source=qzone");
    Object localObject1 = new ArrayList(1);
    ((ArrayList)localObject1).add(this.jdField_a_of_type_Zsf.e());
    localBundle.putStringArrayList("image_url", (ArrayList)localObject1);
    localBundle.putLong("req_share_id", 0L);
    if (this.jdField_a_of_type_Zsf.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StShare != null)
    {
      Object localObject2 = this.jdField_a_of_type_Zsf.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StShare.shareQzoneInfo.entrys.get();
  ...
  {
    int i = 21;
    if (this.jdField_a_of_type_Zsf.jdField_a_of_type_ComTencentBizSubscribeBaseUIExtraTypeInfo != null) {}
    Intent localIntent;
    switch (this.jdField_a_of_type_Zsf.jdField_a_of_type_ComTencentBizSubscribeBaseUIExtraTypeInfo.pageType)
    {
    default: 
      ...
      if (localIntent == null) {
        if (this.jdField_a_of_type_AndroidAppActivity != null) {
          QQToast.a(this.jdField_a_of_type_AndroidAppActivity, anvx.a(2131714024), 0).a();
        }
      }
      break;
    }
  ...
  public void a(zsf paramzsf, aqnr paramaqnr)
  {
    ...
    this.jdField_a_of_type_Zsf = localzsf;
    this.jdField_a_of_type_Aqnr = paramaqnr;
    if ((this.jdField_a_of_type_Zsf.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed == null) || (TextUtils.isEmpty(this.jdField_a_of_type_Zsf.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed.poster.nick.get())))
    {
      QQToast.a(this.jdField_a_of_type_AndroidAppActivity, anvx.a(2131714035), 0).a();
      return;
    }
    paramzsf = a(localzsf);
    this.jdField_a_of_type_AndroidAppActivity.getIntent().putExtra("big_brother_source_key", "biz_src_feeds_kandian");
    this.jdField_a_of_type_ComTencentMobileqqWidgetShareShareActionSheet.setActionSheetItems(a(paramzsf));
