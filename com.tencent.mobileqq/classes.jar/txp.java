...
public class txp
{
  ...
  public txp(ViewGroup paramViewGroup)
  {
  ...
  private ImageView a()
  {
    ...
    this.jdField_a_of_type_ComTencentImageURLImageView.setBackgroundResource(2130850002);
    this.jdField_a_of_type_ComTencentImageURLImageView.setScaleType(ImageView.ScaleType.FIT_XY);
    localObject = URLDrawable.URLDrawableOptions.obtain();
    ((URLDrawable.URLDrawableOptions)localObject).mLoadingDrawable = BaseApplicationImpl.getApplication().getResources().getDrawable(2130849999);
  ...
  private void c()
  {
    ...
    a();
    d();
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setOnClickListener(new txq(this));
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setOnTouchListener(new txr(this));
  }
  ...
  public void a(RecyclerViewCompat paramRecyclerViewCompat)
  {
    if (paramRecyclerViewCompat != null)
    {
      ...
      this.jdField_a_of_type_AndroidAnimationAnimatorSet.addListener(new txs(this, paramRecyclerViewCompat));
    }
  }
