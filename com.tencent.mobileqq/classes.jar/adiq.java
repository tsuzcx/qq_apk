  ...
  implements adif
{
  ...
  private aspy a()
  {
    ...
    return ((aspx)localBaseActivity.app.getManager(325)).b(i);
  }
  ...
  private void d()
  {
    ...
    if ((localObject != null) && (((aspy)localObject).a()))
    {
      ...
      if (localObject != null) {
        ((ChatXListView)localObject).setOnLayoutListener(new adir(this));
      }
    }
  }
  ...
  private void j()
  {
    ...
    Object localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Acup;
    Object localObject2;
    if (localObject1 != null)
    {
      localObject1 = ((acup)localObject1).a();
      i = a();
      if ((localObject1 != null) && (((List)localObject1).size() == i))
      {
        localObject1 = a();
        if ((localObject1 != null) && (((aspy)localObject1).a()))
        {
          localObject2 = ((aspy)localObject1).a();
          if (localObject2 != null)
          {
            localObject2 = ((asqc)localObject2).a();
            if (localObject2 != null) {
              break label100;
            }
    ...
    this.jdField_a_of_type_AndroidOsHandler.postDelayed(new MultiWindowAIOHelper.4(this, (aspy)localObject1), 350L);
  }
  
  public void a()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Acup != null)) {
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Acup.d();
    }
