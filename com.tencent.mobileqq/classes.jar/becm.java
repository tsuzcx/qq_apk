...
public class becm
{
  ...
  private WeakReference<becn> jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(null);
  private String b;
  private String c = "android";
  private String d = "8.3.5";
  ...
  public becm(String paramString, int paramInt, becn parambecn)
  {
    this.b = paramString;
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambecn);
  }
  ...
  private bece a()
  {
    try
    {
      ...
      if (i == 200)
      {
        ...
        if (localObject != null)
        {
          ...
          if (localObject != null)
          {
            ...
            if (localObject != null) {
              return new bece((JSONObject)localObject);
            }
          }
        }
      }
      else
      {
        ...
        localObject = new bece();
        ((bece)localObject).jdField_a_of_type_Int = i;
        return localObject;
      }
    }
  ...
  private void a(bece parambece)
  {
    if ((parambece != null) && (QLog.isColorLevel())) {
      QLog.i("GetRegisterLiangHaoList", 2, "onResponse " + parambece);
    }
    ...
    if (parambece != null)
    {
      i = parambece.jdField_a_of_type_Int;
    ...
    {
      localazri.a(null, "reg_lh_get_list", bool, l1 - l2, 0L, (HashMap)localObject, "", true);
      localObject = (becn)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localObject != null) {
        break label143;
      }
      return;
    ...
    label143:
    ThreadManagerV2.getUIHandlerV2().post(new GetRegisterLiangHaoList.2(this, parambece, (becn)localObject));
  }
  ...
  private String b()
  {
    ...
    try
    {
      this.jdField_a_of_type_JavaLangString = bhsp.a("ecd027");
