  ...
  extends ajwt
{
  ...
  public ajuu(Context paramContext, bkfv parambkfv, SessionInfo paramSessionInfo, QQAppInterface paramQQAppInterface)
  {
  ...
  public ChatHistorySearchData a(SessionInfo paramSessionInfo, String paramString)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      MessageForText localMessageForText = bbzh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), localTroopLinkElement.uin, "", 0, (byte)1, (byte)0, (short)0, localTroopLinkElement.description());
      localMessageForText.msgData = bend.a(localTroopLinkElement);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      Object localObject1 = localajyc.a;
      TroopLinkElement localTroopLinkElement = new TroopLinkElement();
      try
      {
        localObject1 = bend.a(((MessageRecord)localObject1).msgData);
      ...
      catch (Exception localException)
      {
        for (;;)
        {
          Object localObject2;
          continue;
          localException.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130850448));
        }
      }
      ...
      localObject2 = localajyc.a(localTroopLinkElement.title, -11353092);
      localajwu.jdField_a_of_type_ComTencentMobileqqWidgetColorNickTextView.setText((CharSequence)localObject2);
      ...
      localObject1 = String.format(anni.a(2131704914), new Object[] { localObject2, localObject1 });
      localajwu.jdField_a_of_type_AndroidWidgetTextView.setText(localajyc.a((String)localObject1, -11353092));
      if (TextUtils.isEmpty(localTroopLinkElement.iconUrl)) {
        break;
      }
      ajun.a(localajwu.jdField_a_of_type_AndroidWidgetImageView, localTroopLinkElement.iconUrl);
