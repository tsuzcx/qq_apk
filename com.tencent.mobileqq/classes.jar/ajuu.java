...
public class ajuu
  implements bkzq
{
  public ajuu(ChatHistoryTroopMemberFragment paramChatHistoryTroopMemberFragment) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (int i = paramInt + 1;; i = paramInt)
    {
      ...
      for (;;)
      {
        if ((this.a.jdField_a_of_type_Bkzi != null) && (this.a.jdField_a_of_type_Bkzi.isShowing())) {
        ...
        if (QLog.isColorLevel())
        {
          ...
          if (this.a.jdField_d_of_type_Int == 9) {
            ...
            case 0: 
              ...
              bdla.b(this.a.getActivity().app, "P_CliOper", "Grp_pay", "", "un_pay_list", "Clk_del", 0, 0, this.a.c, this.a.o, "", "");
              break;
            }
          } else {
            switch (i)
            ...
            case 1: 
              if (!TextUtils.isEmpty(this.a.jdField_b_of_type_JavaLangString))
              {
                ...
                bdla.b(this.a.getActivity().app, "dc00899", "Grp_mber", "", "mber_list", "clk_Add", 0, 0, this.a.c, "", "", "");
              }
              break;
            case 2: 
            ...
            case 3: 
              ...
              this.a.jdField_d_of_type_AndroidWidgetTextView = ((TextView)ChatHistoryTroopMemberFragment.a(this.a, 2131369233));
              this.a.jdField_d_of_type_AndroidWidgetTextView.setVisibility(0);
              this.a.jdField_d_of_type_AndroidWidgetTextView.setText(anvx.a(2131701112));
              this.a.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(new ajuv(this));
              if (this.a.jdField_a_of_type_Ajvt != null) {
                this.a.jdField_a_of_type_Ajvt.a();
              }
              paramView = this.a.o;
