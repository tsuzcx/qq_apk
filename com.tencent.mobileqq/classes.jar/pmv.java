...
public class pmv
{
  ...
  private static volatile pmv jdField_a_of_type_Pmv;
  public static int b;
  ...
  private pmv()
  {
    this.jdField_a_of_type_Pmz = new pmz(this);
    ...
    try
    {
      String str = (String)bgmq.a(jdField_a_of_type_JavaLangString, "");
      Object localObject2;
      ...
      Object localObject1 = (String)bgmq.a(jdField_b_of_type_JavaLangString, "");
    ...
    catch (NumberFormatException localNumberFormatException)
    {
      ...
      bgmq.a(jdField_a_of_type_JavaLangString, "");
      bgmq.a(jdField_b_of_type_JavaLangString, "");
    }
  }
  ...
  public static pmv a()
  {
    if (jdField_a_of_type_Pmv == null) {}
    try
    {
      if (jdField_a_of_type_Pmv == null) {
        jdField_a_of_type_Pmv = new pmv();
      }
      return jdField_a_of_type_Pmv;
    }
    finally {}
  }
  ...
  private void a(AbsListView paramAbsListView, boolean paramBoolean)
  {
    ...
    {
      localObject1 = (pmw)this.jdField_a_of_type_JavaUtilList.get(((Integer)this.jdField_b_of_type_JavaUtilHashMap.get(str)).intValue());
      l3 = ((pmw)localObject1).jdField_b_of_type_Long;
      if (i1 <= 0) {
        break label521;
      }
    }
    ...
    {
      ((pmw)localObject1).jdField_b_of_type_Long = (l2 + l3);
      localObject2 = a(localView);
      if ((localObject2 != null) && (localObject2[1] - localObject2[0] >= localView.getHeight() * jdField_a_of_type_Double)) {
        ((pmw)localObject1).jdField_c_of_type_Long += l1;
      }
      ((pmw)localObject1).jdField_c_of_type_Boolean = this.jdField_a_of_type_JavaUtilHashMap.containsKey(str);
      if (!paramBoolean) {
        break;
      }
      ((pmw)localObject1).jdField_b_of_type_Boolean = true;
      break;
      localObject1 = new pmw(this);
      ((pmw)localObject1).jdField_a_of_type_JavaLangString = str;
      ((pmw)localObject1).jdField_a_of_type_Int = obz.a((BaseArticleInfo)localObject2);
      int m;
      label305:
      boolean bool;
      ...
      {
        m = 0;
        ((pmw)localObject1).jdField_b_of_type_Int = m;
        if (this.jdField_g_of_type_Long != -1L) {
          break label504;
        }
        bool = true;
        label326:
        ((pmw)localObject1).jdField_a_of_type_Boolean = bool;
        ((pmw)localObject1).jdField_c_of_type_Int = localView.getHeight();
        ((pmw)localObject1).jdField_b_of_type_JavaLangString = ((BaseArticleInfo)localObject2).mRecommentdReason;
        m = this.j;
        this.j = (m + 1);
        ((pmw)localObject1).jdField_d_of_type_Int = m;
        localObject2 = ocj.a().a();
      ...
      label504:
      label510:
      for (((pmw)localObject1).jdField_c_of_type_JavaLangString = (localObject2[0] + "_" + localObject2[1] + "_" + localObject2[2] + "_" + localObject2[3]);; ((pmw)localObject1).jdField_c_of_type_JavaLangString = "NULL")
      {
  ...
  private void e()
  {
    ...
    if (this.jdField_b_of_type_ArrayOfInt != null)
    {
      ...
      bgmq.a(jdField_b_of_type_JavaLangString, str);
    }
    if (this.jdField_a_of_type_JavaUtilArrayList.size() > 0)
    {
      ...
      bgmq.a(jdField_a_of_type_JavaLangString, str);
    }
  }
  
  public long a()
  {
    if (this.jdField_a_of_type_Pmz.jdField_a_of_type_Long == 0L) {
      return this.jdField_e_of_type_Long;
    }
    return this.jdField_a_of_type_Pmz.jdField_a_of_type_Long - this.jdField_a_of_type_Long;
  }
  ...
  public void a()
  {
    ...
    if ((this.jdField_d_of_type_Long != 0L) && (!TextUtils.isEmpty(this.jdField_c_of_type_JavaLangString)) && (this.jdField_b_of_type_JavaUtilHashMap.containsKey(this.jdField_c_of_type_JavaLangString)))
    {
      ...
      pmw localpmw = (pmw)this.jdField_a_of_type_JavaUtilList.get(k);
      localpmw.jdField_a_of_type_Long = (l + localpmw.jdField_a_of_type_Long);
  ...
  {
    if ((paramAbsListView == null) || (paramAbsListView == this.jdField_a_of_type_ComTencentWidgetAbsListView) || (!this.jdField_b_of_type_Boolean)) {
      return;
    }
    this.jdField_a_of_type_ComTencentWidgetAbsListView = paramAbsListView;
    this.i = awmc.a(this.jdField_a_of_type_ComTencentWidgetAbsListView.getContext());
    ((ReadInJoyXListView)this.jdField_a_of_type_ComTencentWidgetAbsListView).a(this.jdField_a_of_type_Pmz);
    this.jdField_a_of_type_ComTencentWidgetAbsListView.post(new UserActionCollector.1(this, paramInt, paramAbsListView));
  }
  ...
  public long b()
  {
    if (this.jdField_a_of_type_Pmz.jdField_b_of_type_Long == 0L) {
      return this.jdField_e_of_type_Long;
    }
    return this.jdField_c_of_type_Long - this.jdField_a_of_type_Pmz.jdField_b_of_type_Long;
  }
  ...
  public void b()
  {
    ...
    a(this.jdField_a_of_type_ComTencentWidgetAbsListView, false);
  }
  ...
  public void c()
  {
    if ((this.jdField_a_of_type_Long == 0L) || (this.jdField_a_of_type_ComTencentWidgetAbsListView == null) || (!this.jdField_b_of_type_Boolean)) {
      return;
    }
    ocj.a().b();
    ...
    a(this.jdField_a_of_type_ComTencentWidgetAbsListView, true);
    new oqv(null, null, null, pdc.a(), null).a(this, this.jdField_a_of_type_ComTencentWidgetAbsListView.getContext());
    e();
    this.jdField_a_of_type_ComTencentWidgetAbsListView = null;
    jdField_a_of_type_Pmv = null;
  }
