...
{
  private static alsa jdField_a_of_type_Alsa;
  ...
  public static alsa a()
  {
    if (jdField_a_of_type_Alsa == null) {}
    try
    {
      if (jdField_a_of_type_Alsa == null) {
        jdField_a_of_type_Alsa = new alsa();
      }
      return jdField_a_of_type_Alsa;
    }
    finally {}
  }
  ...
  {
    boolean bool = alrz.a(paramBundle.getString("extra_unikey"));
  ...
  {
    boolean bool = alrz.b(paramBundle);
    paramBundle = new Bundle();
  ...
  {
    boolean bool = alrz.b(paramBundle.getString("extra_unikey"));
    paramBundle = new Bundle();
  ...
  {
    return EIPCResult.createResult(0, alrz.a(paramBundle.getString("extra_unikey"), paramBundle.getBoolean("extra_update_colornote_state")));
  }
  
  private EIPCResult f(Bundle paramBundle)
  {
    boolean bool = alrz.a(paramBundle.getString("extra_unikey"), paramBundle.getString("extra_field_name"), paramBundle.getString("extra_field_value"));
    paramBundle = new Bundle();
  ...
  {
    boolean bool = alrz.a((ColorNote)paramBundle.getSerializable("color_note_recently_viewed_comparator"));
    paramBundle = new Bundle();
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    } while (!paramString.equalsIgnoreCase("cmd_clear_color_note"));
