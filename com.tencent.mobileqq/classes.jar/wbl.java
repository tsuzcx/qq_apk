...
public class wbl
{
  protected static vzl<String, wbm> a = new vzl(200);
  ...
  public static File a(String paramString, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    while ((zcl.a(paramString)) && (a(paramString, paramInt) != null))
    {
  ...
  {
    return vzh.h + a(paramString, false, 0L) + "/" + b(paramString, paramInt, paramBoolean1, paramBoolean2);
  }
  ...
  public static String a(String paramString, long paramLong, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (zcl.a(paramString)) {}
    for (String str = vzh.h;; str = vzh.i) {
  ...
  public static void a(StoryVideoItem paramStoryVideoItem, String paramString1, int paramInt, String paramString2)
  {
    ...
    do
    {
      do
      {
        ...
        localwjp.a(paramStoryVideoItem.mVid, paramStoryVideoItem);
        return;
  ...
  {
    wbm localwbm = new wbm();
    localwbm.a = paramString2;
    a.a(paramString1, localwbm);
  }
  ...
  {
    paramString = (wbm)a.a(paramString);
    if (paramString != null) {
