...
public final class ozx
{
  ...
  public ozx(@NotNull BaseArticleInfo paramBaseArticleInfo)
  {
  ...
  {
    if (pay.m(paramBaseArticleInfo)) {
      return 67;
    }
    if (pay.p(paramBaseArticleInfo)) {
      return 82;
    }
    if (pay.o(paramBaseArticleInfo)) {
      return 83;
    }
    return 68;
  }
  ...
  {
    if (pbh.a(paramBaseArticleInfo) == 32) {
      return 2006;
    }
    return 31;
  }
  ...
  private final int h(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    if (pay.c((ArticleInfo)paramBaseArticleInfo)) {
      return 41;
    }
    return 42;
  }
  ...
  {
    if (pay.f((ArticleInfo)paramBaseArticleInfo)) {
      return 45;
    }
    return 46;
  }
  ...
  {
    if ((paramBaseArticleInfo.mSocialFeedInfo != null) && (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfn != null) && (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfn.a)) {
      return 62;
    }
    return 61;
  }
  ...
  {
    if ((paramBaseArticleInfo.mSocialFeedInfo != null) && (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Reu != null)) {
      return paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Reu.a;
    }
    return 0;
  }
  ...
  private final int o(BaseArticleInfo paramBaseArticleInfo)
  {
    if (paramBaseArticleInfo.mProteusTemplateBean != null) {
      return qgc.a(paramBaseArticleInfo.mProteusTemplateBean);
    }
    return 0;
  }
  ...
  public final int a(@NotNull BaseArticleInfo paramBaseArticleInfo, int paramInt)
  {
    ...
    } while (!pay.i(paramBaseArticleInfo));
    return 47;
  }
