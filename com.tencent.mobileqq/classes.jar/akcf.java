  ...
  implements Manager, BusinessObserver
{
  ...
  private akcg jdField_a_of_type_Akcg;
  private SharedPreferences jdField_a_of_type_AndroidContentSharedPreferences;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private boolean jdField_a_of_type_Boolean;
  
  public akcf(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    this.jdField_a_of_type_Akcg = paramakcg;
  }
  
  public void a(AppActivity paramAppActivity)
  {
    if ((alrh.c()) && (!this.jdField_a_of_type_Boolean))
    {
      if (QLog.isColorLevel()) {
        QLog.d("weatherManager", 2, "updateWeatherInfo  from  LocaleManager.isLocaleUpdatedByUser()");
      }
      this.jdField_a_of_type_Boolean = true;
      akch.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramAppActivity);
    }
    Long localLong;
    do
    {
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Akcg.a(paramInt, paramBoolean, paramBundle);
      return;
      label421:
      if (j == 0) {
