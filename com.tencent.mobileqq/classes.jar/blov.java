  ...
  implements ugt
{
  ...
  public blov(CaptureModeController paramCaptureModeController)
  {
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Ugk.c();
  }
  
  public void b()
  {
    this.jdField_a_of_type_Bkil.I();
  }
  ...
  public void g()
  {
    ...
    if (this.jdField_b_of_type_Int == 10002)
    {
      ...
      localuef.c();
      if (localuef.a(this.jdField_a_of_type_AndroidViewView.getContext()))
      {
        ((ViewStub)this.jdField_a_of_type_AndroidViewView.findViewById(2131363937)).inflate();
        this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131363936);
        if (this.jdField_b_of_type_AndroidViewView != null)
        {
          wsv.b("SlidesMode", "init album gallery view part success");
          this.jdField_a_of_type_Ugk = new ugk(this.jdField_a_of_type_DovComQqImCaptureModeCaptureModeController.a(), this.jdField_b_of_type_AndroidViewView, this);
        }
      }
    }
    if (this.jdField_b_of_type_AndroidViewView == null)
    {
      ((ViewStub)this.jdField_a_of_type_AndroidViewView.findViewById(2131376779)).inflate();
      this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131376778);
      this.jdField_a_of_type_AndroidViewView.findViewById(2131376777).setOnClickListener(this);
      this.jdField_a_of_type_AndroidViewView.findViewById(2131363718).setOnClickListener(this);
    }
    this.jdField_b_of_type_AndroidViewView.setOnTouchListener(new blow(this));
  }
  ...
  protected void h()
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_Ugk.a(localBundle);
      return;
      try
      {
        label144:
      ...
      {
        wsv.c("SlidesMode", "format albumId error : %s", localNumberFormatException);
      }
    }
  }
  ...
  protected void i()
  {
    if (this.jdField_b_of_type_AndroidAnimationAnimator == null)
    {
      ...
      this.jdField_b_of_type_AndroidAnimationAnimator.addListener(new blox(this));
    }
