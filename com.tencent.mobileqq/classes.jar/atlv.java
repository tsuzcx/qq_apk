  ...
  extends atlw
{
  ...
  public atlv(QQAppInterface paramQQAppInterface, atln paramatln)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Atln = paramatln;
  }
  ...
  protected void a(boolean paramBoolean, Object paramObject)
  {
    ...
    localObject2 = new atlh(i, (String)localObject3);
    localObject3 = this.jdField_a_of_type_Atln.a((atlh)localObject2);
    ...
    if (localIterator.hasNext())
    {
      ...
      atlf localatlf1 = new atlf(str, new LatLng(localUserData.lat.get(), localUserData.lon.get()), localUserData.direction.get());
      if ((localatlf1.a().latitude == 0.0D) && (localatlf1.a().longitude == 0.0D))
      {
        atlf localatlf2 = ((LocationRoom)localObject3).a(str);
        if (localatlf2 != null)
        {
          localObject1 = "[filter]";
          localatlf1.a(localatlf2.a(), Double.valueOf(localatlf2.a()));
          ((List)localObject4).add(localatlf1);
          label590:
          if (!QLog.isColorLevel()) {
            break label794;
          }
    ...
    this.jdField_a_of_type_Atln.a((atlh)localObject2, paramObject, (List)localObject4);
  }
  ...
  protected void b(boolean paramBoolean, Object paramObject)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Atln.a(new atlh(localInteger.intValue(), str), (LocationRoom.Venue)localObject, paramObject.intValue(), paramBoolean, i);
      if (paramBoolean)
      {
        if (QLog.isColorLevel()) {
          QLog.d("LocationObserver", 2, new Object[] { "[venue] onVenueOpt: invoked. success ", " uin: ", str, " uinType: ", localInteger, " optType: ", paramObject });
        }
        this.jdField_a_of_type_Atln.a.a(localInteger.intValue(), str);
        return;
      }
  ...
  protected void c(boolean paramBoolean, Object paramObject)
  {
    ...
    paramObject = new atlh(paramObject.intValue(), str);
    this.jdField_a_of_type_Atln.a(paramObject, ((Integer)localObject).intValue());
  }
  ...
  protected void d(boolean paramBoolean, Object paramObject)
  {
    ...
    paramObject = new atlh(paramObject.intValue(), (String)localObject);
    this.jdField_a_of_type_Atln.b(paramObject, -1);
  }
  ...
  protected void e(boolean paramBoolean, Object paramObject)
  {
    ...
    case 2: 
    case 3: 
      atlk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramObject);
      return;
    }
    atlk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramObject, i);
  }
  ...
  protected void f(boolean paramBoolean, Object paramObject)
  {
    ...
    if (paramBoolean)
    {
      ...
      atmb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramObject);
    }
    label80:
    do
    {
      ...
      if (i == 101)
      {
        atmb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramObject, i);
        return;
      }
      if (i == 102)
      {
  ...
  protected void g(boolean paramBoolean, Object paramObject)
  {
    ...
    if (paramBoolean)
    {
      ...
      this.jdField_a_of_type_Atln.a.a(localInteger.intValue(), (String)localObject);
      this.jdField_a_of_type_Atln.a.b(localInteger.intValue(), (String)localObject);
      if (QLog.isColorLevel()) {
      ...
      {
        this.jdField_a_of_type_Atln.b(localInteger.intValue(), (String)localObject);
        azmj.b(null, "CliOper", "", "", "0X800A764", "0X800A764", 0, 0, "", "0", "0", "");
      }
      for (;;)
      {
        this.jdField_a_of_type_Atln.a(false);
        return;
        if (paramObject.intValue() == 2)
        {
          this.jdField_a_of_type_Atln.b(localInteger.intValue(), (String)localObject);
          if (this.jdField_a_of_type_Atln.a()) {
            azmj.b(null, "CliOper", "", "", "0X800A76B", "0X800A76B", atln.a(this.jdField_a_of_type_Atln.a()), 0, "", "0", "0", "");
          }
        }
      }
    }
    ...
    atlh localatlh = new atlh(localInteger.intValue(), (String)localObject);
    this.jdField_a_of_type_Atln.a(localatlh, true);
    this.jdField_a_of_type_Atln.a(localatlh, j, paramObject.intValue());
    int i = 0;
    if (j == 10101) {}
    for (i = 3;; i = 2) {
      do
      {
        this.jdField_a_of_type_Atln.a(localInteger.intValue(), (String)localObject, this.jdField_a_of_type_Atln.a(), i);
        return;
