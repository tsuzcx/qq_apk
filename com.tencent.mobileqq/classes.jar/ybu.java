  ...
  extends ybw
{
  ...
  protected String a(int paramInt1, String paramString1, String paramString2, int paramInt2)
  {
    ...
    {
      paramString1 = amtj.a(2131707299) + paramInt1 + amtj.a(2131707292) + paramInt2 + amtj.a(2131707291);
      this.t = paramString1;
      return paramString1;
    }
  ...
  public String a(String paramString)
  {
    ...
    //   3: ldc 49
    //   5: aload_0
    //   6: getfield 51	ybu:m	Ljava/lang/String;
    ...
    //   37: putfield 85	ybu:r	Ljava/lang/String;
    //   40: aload_0
    //   41: getfield 85	ybu:r	Ljava/lang/String;
    //   44: invokestatic 91	com/tencent/mobileqq/utils/FileUtils:fileExists	(Ljava/lang/String;)Z
    //   47: ifne +60 -> 107
    //   50: aload_0
    //   51: getfield 94	ybu:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   54: invokevirtual 100	android/app/Activity:getResources	()Landroid/content/res/Resources;
    //   57: ldc 101
    //   59: invokestatic 107	android/graphics/BitmapFactory:decodeResource	(Landroid/content/res/Resources;I)Landroid/graphics/Bitmap;
    //   62: astore_3
    //   63: aload_3
    //   64: ifnull +43 -> 107
    //   67: new 109	java/io/FileOutputStream
    //   70: dup
    //   71: aload_0
    //   72: getfield 85	ybu:r	Ljava/lang/String;
    //   75: invokestatic 113	com/tencent/mobileqq/utils/FileUtils:createFile	(Ljava/lang/String;)Ljava/io/File;
    //   78: invokespecial 116	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   81: astore_2
    //   82: aload_2
    //   83: astore_1
    //   84: aload_3
    //   85: getstatic 122	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   88: bipush 100
    //   90: aload_2
    //   91: invokevirtual 128	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   94: pop
    //   95: aload_3
    //   96: invokevirtual 131	android/graphics/Bitmap:recycle	()V
    //   99: aload_2
    //   100: ifnull +7 -> 107
    //   103: aload_2
    //   104: invokevirtual 134	java/io/FileOutputStream:close	()V
    //   107: aload_0
    //   108: getfield 85	ybu:r	Ljava/lang/String;
    //   111: areturn
    //   112: astore_1
    //   113: aload_1
    //   114: invokevirtual 137	java/lang/OutOfMemoryError:printStackTrace	()V
    //   117: aconst_null
    //   118: astore_3
    //   119: goto -56 -> 63
    //   122: astore_1
    //   123: aload_1
    //   124: invokevirtual 138	java/io/IOException:printStackTrace	()V
    //   127: goto -20 -> 107
    //   130: astore 4
    //   132: aconst_null
    //   133: astore_2
    ...
    //   135: astore_1
    //   136: aload 4
    //   138: invokevirtual 139	java/lang/Exception:printStackTrace	()V
    //   141: aload_3
    //   142: invokevirtual 131	android/graphics/Bitmap:recycle	()V
    //   145: aload_2
    //   146: ifnull -39 -> 107
    //   149: aload_2
    //   150: invokevirtual 134	java/io/FileOutputStream:close	()V
    //   153: goto -46 -> 107
    //   156: astore_1
    //   157: aload_1
    //   158: invokevirtual 138	java/io/IOException:printStackTrace	()V
    //   161: goto -54 -> 107
    //   164: astore_1
    //   165: aload 4
    //   167: astore_2
    //   168: aload_3
    //   169: invokevirtual 131	android/graphics/Bitmap:recycle	()V
    //   172: aload_2
    //   173: ifnull +7 -> 180
    //   176: aload_2
    //   177: invokevirtual 134	java/io/FileOutputStream:close	()V
    //   180: aload_1
    //   181: athrow
    //   182: astore_2
    //   183: aload_2
    //   184: invokevirtual 138	java/io/IOException:printStackTrace	()V
    //   187: goto -7 -> 180
    //   190: aload_0
    //   191: getfield 142	ybu:h	Ljava/lang/String;
    //   194: invokestatic 148	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   197: ifne +25 -> 222
    //   200: aload_0
    //   201: getfield 142	ybu:h	Ljava/lang/String;
    //   204: aload_0
    //   205: getfield 85	ybu:r	Ljava/lang/String;
    //   208: invokevirtual 57	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   211: ifne +11 -> 222
    //   214: aload_0
    //   215: aload_0
    //   216: getfield 142	ybu:h	Ljava/lang/String;
    //   219: invokevirtual 151	ybu:a	(Ljava/lang/String;)V
    //   222: aload_0
    //   223: aload_1
    //   224: putfield 153	ybu:s	Ljava/lang/String;
    //   227: aload_0
    //   228: getfield 153	ybu:s	Ljava/lang/String;
    //   231: areturn
    //   232: astore 4
    //   234: aload_1
    //   235: astore_2
