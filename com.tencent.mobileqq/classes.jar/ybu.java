...
public class ybu
{
  ...
  {
    return ybn.c("certified_account_download_pics");
  }
  ...
  public static String a(long paramLong)
  {
    ...
    if (((Time)localObject1).yearDay == i - 1) {
      return BaseApplicationImpl.getApplication().getString(2131721504);
    }
    return ((Time)localObject1).month + 1 + BaseApplicationImpl.getApplication().getString(2131694459) + ((Time)localObject1).monthDay + BaseApplicationImpl.getApplication().getString(2131691513);
  }
  ...
  public static String a(Bitmap paramBitmap)
  {
    ...
    //   38: iconst_2
    //   39: invokestatic 214	bdfr:encodeToString	([BI)Ljava/lang/String;
    //   42: astore_0
    //   43: aload_0
    //   44: astore_1
    //   45: aload_2
