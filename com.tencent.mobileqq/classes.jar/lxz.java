...
@TargetApi(18)
public class lxz
  implements Handler.Callback, View.OnClickListener, mcp, mcs, mcy
{
  ...
  public lxz(AVActivity paramAVActivity, RelativeLayout paramRelativeLayout1, VideoController paramVideoController, VideoAppInterface paramVideoAppInterface, RelativeLayout paramRelativeLayout2, VideoControlUI paramVideoControlUI)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentAvUiDoubleVideoCtrlUI == null)
      {
        ...
        this.jdField_a_of_type_Mcq = mcq.a();
        this.jdField_a_of_type_Long = (this.jdField_a_of_type_Mcq.h * 60 * 1000L);
      ...
      {
        if (f()) {
          this.jdField_a_of_type_Mcw = new mcw();
        }
        paramAVActivity = babp.h();
      ...
      catch (OutOfMemoryError paramAVActivity)
      {
        for (;;)
        {
          this.jdField_a_of_type_Mcw = null;
  ...
  private void a(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      if (paramLong >= 0L)
      {
        ...
        lqb.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1023, 2131630384);
        mct.a("0X8008AB0");
      }
      else if (paramLong < 0L)
      {
        a(3, true);
        lqb.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1023, 2131630359);
  ...
  public static void a(VideoController paramVideoController)
  {
    ...
    paramVideoController.a(8, "SUPPORT_TRUE");
    paramVideoController.a(8, "SUPPORT_TRUE_7.3.5#" + mcq.a().h);
    paramVideoController.a(8, "SUPPORT_TRUE_7.3.5#" + mcq.a().h);
  }
  
  private void a(VideoAppInterface paramVideoAppInterface)
  {
    LayoutInflater.from((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).inflate(2131494031, this.jdField_a_of_type_AndroidWidgetRelativeLayout);
    this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131313235));
    this.jdField_d_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131309270));
    this.jdField_e_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131309269));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131311310));
    this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131309255));
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131309252);
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131309251);
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131309250);
    ...
    this.jdField_a_of_type_Int = aciy.a(51.0F, ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
    this.jdField_b_of_type_JavaLangString = ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getString(2131630372);
    this.jdField_c_of_type_JavaLangString = ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getString(2131630368);
    this.jdField_a_of_type_ComTencentAvUiFunchatRecordQavRecordButtonView = ((QavRecordButtonView)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).findViewById(2131309242));
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).findViewById(2131309258));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).findViewById(2131309257));
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
    if (AudioHelper.a(0) == 1)
    {
  ...
  private void b(long paramLong)
  {
    ...
    this.jdField_a_of_type_ComTencentAvVideoController.a().A = false;
    lqb.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1023, 2131630360);
    this.jdField_a_of_type_ComTencentAvVideoController.F();
    n();
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
    ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(new Object[] { Integer.valueOf(163) });
  ...
  private void h(int paramInt)
  {
    ...
    do
    {
      ...
      for (paramInt = 2131630374;; paramInt = 2131630373)
      {
        bbmy.a((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 2, ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources().getString(paramInt), 0).a();
        return;
      }
    } while (((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).i);
    lqb.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1023, 2131630359);
  ...
  private void q()
  {
    ...
    aciy.a(7.5F, ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
    aciy.a(64.0F, ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
    b(2131166624);
    b(2131166621);
    b(2131166621);
    b(2131166623);
    ...
    if (this.jdField_a_of_type_AndroidAnimationValueAnimator$AnimatorUpdateListener == null) {
      this.jdField_a_of_type_AndroidAnimationValueAnimator$AnimatorUpdateListener = new lya(this);
    }
    if (this.jdField_a_of_type_AndroidAnimationAnimator$AnimatorListener == null) {
      this.jdField_a_of_type_AndroidAnimationAnimator$AnimatorListener = new lyb(this);
    }
  ...
  private void t()
  {
    if ((((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface == null) || (this.jdField_a_of_type_ComTencentAvVideoController == null)) {
      if (QLog.isColorLevel()) {
        QLog.d("QavVideoRecordUICtrl", 2, "record mActivity.get().mApp == null  || mVideoController == null");
      }
    }
    label939:
    label946:
    ...
    for (;;)
    {
      ...
      {
        ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_Lru.c(2);
      ...
      if (this.jdField_a_of_type_ComTencentAvVideoController.a().A)
      {
        ...
        awqx.b(null, "CliOper", "", "", "0X800863B", "0X800863B", 0, 0, String.valueOf(l), "", "", "");
        awrn.a(BaseApplicationImpl.getContext()).a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin(), "av_record_click_end", true, l, 0L, null, "", false);
        return;
      }
      int k = 1;
      ...
      {
        if (((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface != null) {
          lqb.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131630354);
        }
        j = 0;
        ...
        b();
        if ((j()) && (((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(3)))
        {
          localObject = (kxi)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(3);
          if (((FaceItem)((kxi)localObject).a() != null) && (((kxi)localObject).a()) && (((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface != null)) {
            lqb.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131630364);
          }
        }
        mct.a("0X800863A");
      ...
      for (;;)
      {
        ...
        if (!this.jdField_a_of_type_ComTencentAvVideoController.a().z)
        {
          ...
          for (k = 2131630362;; k = 2131630361)
          {
            if (((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface == null) {
              break label1342;
            }
            lqb.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, k);
            j = 0;
            break;
            mct.a("0X8008AB5");
          }
        ...
        {
          if (((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface != null) {
            lqb.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131630367);
          }
          j = 0;
        ...
        if ((this.jdField_a_of_type_ComTencentAvVideoController.a().B) && (this.jdField_a_of_type_ComTencentAvVideoController.a().t < 735))
        {
          ...
          lqb.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131630365);
          j = 0;
          break;
        }
        if (!e())
        {
          ...
          if (((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface != null) {
            lqb.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131630363);
          }
          j = 0;
          break;
        }
        ...
        {
          localObject = (kxi)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(3);
          FaceItem localFaceItem = (FaceItem)((kxi)localObject).a();
          if (localFaceItem != null)
          {
            boolean bool1 = ((kxi)localObject).a();
            ...
            if ((bool1) && ((bool3) || (bool4)))
            {
              ...
              localObject = ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface;
              if (!bool4) {
                break label939;
              }
            }
            for (j = 2131630386;; j = 2131630385)
            {
              lqb.a((VideoAppInterface)localObject, 1022, j);
              j = 0;
        ...
        {
          localObject = (kze)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(0);
          if (localObject != null)
          {
            ...
            if (localObject != null)
            {
              ...
              for (j = 1;; j = 0)
              {
                ...
                lqb.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131630387);
                j = 0;
        ...
        {
          if (((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface != null) {
            lqb.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131630379);
          }
          j = 0;
        ...
        if ((mez.a()) && (mez.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface).c()))
        {
        ...
        {
          localObject = (kyd)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(2);
          j = k;
          if (localObject != null)
          {
            j = k;
            if (((kyd)localObject).a() != null)
            {
  ...
  private void v()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentAvUiVideoNetStateBar.d(b() + b(2131166583));
      return;
    }
    this.jdField_a_of_type_ComTencentAvUiVideoNetStateBar.d(b(2131166583));
  }
  ...
  int a()
  {
    ...
    {
      if (bool) {
        j = bjeh.b((Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get());
      }
    }
    else {
      return j;
  ...
  public long a()
  {
    try
    {
      ...
      for (l = this.jdField_g_of_type_Long;; l = mcg.a(this.jdField_a_of_type_JavaIoFile))
      {
        if (QLog.isColorLevel()) {
  ...
  {
    if (this.jdField_a_of_type_Mcw != null) {
      this.jdField_a_of_type_Mcw.a(paramInt1, paramInt2, paramArrayOfFloat1, paramArrayOfFloat2, paramLong);
    }
    mct.b();
  }
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      mcg.a(paramString, (Context)this.jdField_a_of_type_JavaLangRefWeakReference.get());
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      catch (NumberFormatException localNumberFormatException)
      {
        ...
        j = mcu.a(paramString2, this.jdField_a_of_type_Mcq.h);
    ...
    case 1: 
      ...
      for (;;)
      {
        ...
        if (((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(2))
        {
          paramString1 = (kyd)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(2);
    ...
    case 8: 
      ...
      {
        a(4, false);
        lqb.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131630358);
      }
      for (;;)
      {
        m();
        return;
        a(9, false);
        lqb.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131630357);
      }
    case 4: 
      a(3);
      return;
  ...
  public void a(boolean paramBoolean)
  {
    ...
    Object localObject;
    int j;
    if ((this.jdField_c_of_type_AndroidWidgetRelativeLayout.getVisibility() == 0) && (!b()) && (!bjeh.b()))
    {
    ...
    for (;;)
    {
      localObject = (RedPacketGameView)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).findViewById(2131306744);
      if (localObject != null) {
  ...
  {
    if ((jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Mcw != null) && (paramInt1 == 100)) {
      this.jdField_a_of_type_Mcw.a(paramArrayOfByte, SystemClock.elapsedRealtimeNanos() / 1000L);
    }
  }
  ...
  public int[] a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      {
        j = lyg.b(paramInt1);
        this.jdField_d_of_type_JavaLangString = mcg.a();
        ...
        paramInt2 = this.jdField_a_of_type_Mcq.f;
        if (paramInt1 > paramInt2)
        {
          ...
          if (j % 2 == 1)
          {
            ...
            auzf localauzf = new auzf(this.jdField_d_of_type_JavaLangString, paramInt1, paramInt2, 5120000, 1, false, 0);
            localauzf.a(EGL14.eglGetCurrentContext());
            if (this.jdField_a_of_type_Mcw != null)
            {
              this.jdField_a_of_type_Mcw.a(localauzf, this);
              mct.a();
  ...
  public void b(int paramInt)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      mct.a(this.jdField_a_of_type_Mcq.r, this.jdField_a_of_type_Mcq.s, paramInt, b());
      return;
      if (paramInt == 2)
      {
        b(b());
  ...
  public void b(int paramInt, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout$LayoutParams.setMargins(b(2131166624), 0, 0, 0);
  ...
  public void d()
  {
    ...
    if ((this.jdField_c_of_type_Int == 90) || (this.jdField_c_of_type_Int == 270))
    {
      ...
      this.jdField_c_of_type_AndroidWidgetRelativeLayout$LayoutParams.leftMargin = aciy.a(15.0F, ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
      if (this.jdField_d_of_type_AndroidWidgetRelativeLayout != null) {
        this.jdField_d_of_type_AndroidWidgetRelativeLayout.setLayoutParams(this.jdField_c_of_type_AndroidWidgetRelativeLayout$LayoutParams);
      }
  ...
  public void f(int paramInt)
  {
    ...
    case 180: 
      ...
      localLayoutParams.setMargins(aciy.a(10.0F, ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()), 0, 0, 0);
      localLayoutParams.addRule(2, 0);
      localLayoutParams.addRule(1, 2131309242);
      localLayoutParams.addRule(6, 2131309242);
    ...
    localLayoutParams.setMargins(aciy.a(-12.5F, ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()), 0, 0, aciy.a(32.5F, ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()));
    localLayoutParams.addRule(2, 2131309242);
  ...
  public void g(int paramInt)
  {
    ...
    default: 
      return;
    case 0: 
      FaceItem localFaceItem = (FaceItem)((kxi)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(3)).a();
    ...
    for (paramInt = 1;; paramInt = 0)
    {
      ...
      for (;;)
      {
        mct.a("0X8008AC8");
        return;
        lqb.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131630370);
      }
      lqb.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131630369);
      mct.a("0X8008AC9");
      return;
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if (l > this.jdField_a_of_type_Long)
      {
        ...
        awqx.b(null, "CliOper", "", "", "0X800863C", "0X800863C", 0, 0, String.valueOf(l), "", "", "");
        awrn.a(BaseApplicationImpl.getContext()).a("", "av_record_timeout", true, l, 0L, null, "", false);
        return true;
      }
      ...
      if (!((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).i)
      {
        ...
        continue;
        if (((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface != null) {
          lqb.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131630371);
        }
      }
    }
  }
  ...
  public boolean i()
  {
    ...
    {
      if (this.jdField_a_of_type_Mcq.r <= this.jdField_a_of_type_Mcq.jdField_d_of_type_Int) {
        break label111;
      }
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_Mcq.jdField_a_of_type_Int != 1) {
      ...
      return true;
      label111:
      if ((this.jdField_a_of_type_Mcq.r == this.jdField_a_of_type_Mcq.jdField_d_of_type_Int) && (this.jdField_a_of_type_Mcq.s >= this.jdField_a_of_type_Mcq.jdField_e_of_type_Int)) {
        this.jdField_b_of_type_Int = 2;
      } else if (this.jdField_a_of_type_Mcq.r > this.jdField_a_of_type_Mcq.jdField_b_of_type_Int) {
        this.jdField_b_of_type_Int = 1;
      } else if ((this.jdField_a_of_type_Mcq.r == this.jdField_a_of_type_Mcq.jdField_b_of_type_Int) && (this.jdField_a_of_type_Mcq.s >= this.jdField_a_of_type_Mcq.jdField_c_of_type_Int)) {
        this.jdField_b_of_type_Int = 1;
      } else {
  ...
  public void l()
  {
    ...
    b(true);
    if (((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface != null) {
      lqb.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1023, 2131630389);
    }
    this.jdField_a_of_type_ComTencentAvVideoController.a().B = false;
    n();
    ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(new Object[] { Integer.valueOf(163) });
    long l = (System.currentTimeMillis() - this.jdField_c_of_type_Long) / 1000L;
    awqx.b(null, "CliOper", "", "", "0X800863E", "0X800863E", 0, 0, "", String.valueOf(l), "", "");
    awrn.a(BaseApplicationImpl.getContext()).a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin(), "av_record_cancel", true, l, 0L, null, "", false);
    c(1);
  }
