  ...
  extends avtk
{
  ...
  protected void a(int paramInt, String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (paramBoolean1 = true;; paramBoolean1 = false)
    {
      if (QLog.isColorLevel()) {
        QLog.i("LyricsController", 2, "onLyricModuleSwitchChange, newUserClosed:" + paramBoolean1 + " type:" + paramInt + " uin:" + paramString + " mFloatParams:" + this.a.jdField_a_of_type_Avut);
      }
      if ((this.a.jdField_a_of_type_Avut.a(paramInt, paramString)) && (this.a.jdField_a_of_type_Avut.jdField_b_of_type_Boolean != paramBoolean1))
      {
        this.a.jdField_a_of_type_Avut.jdField_b_of_type_Boolean = paramBoolean1;
        avuv.a(this.a);
        if ((!TextUtils.isEmpty(this.a.jdField_b_of_type_JavaLangString)) && (!paramBoolean1) && (paramBoolean2))
        {
          avuv.a(this.a, this.a.jdField_b_of_type_JavaLangString);
          if (this.a.jdField_a_of_type_JavaLangBoolean != null) {
            avuv.a(this.a, this.a.jdField_b_of_type_JavaLangString, this.a.c, this.a.jdField_a_of_type_JavaLangBoolean.booleanValue());
          }
          avuv.a(this.a, this.a.jdField_b_of_type_JavaLangString, this.a.i);
        }
      }
      if (paramBoolean2) {
  ...
  protected void a(ListenTogetherSession paramListenTogetherSession)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      this.a.jdField_a_of_type_Avut.a = ((String)localObject1);
      avuv.a(this.a);
      return;
    }
  }
  ...
  protected void a(ISong paramISong)
  {
    ...
    avuv.a(this.a, paramISong.a());
    this.a.jdField_a_of_type_Avut.a = paramISong.d();
    avuv.a(this.a);
  }
  ...
  protected void a(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      avuv.b(this.a, paramString, paramInt);
      bdpg.a().a();
      return;
      if (paramInt == 3)
      {
  ...
  {
    avuv.a(this.a, paramString, paramInt1, paramInt2);
  }
  ...
  protected void a(boolean paramBoolean, ListenTogetherSession paramListenTogetherSession)
  {
    ...
    if (paramBoolean)
    {
      ...
      this.a.jdField_a_of_type_Avut.a = paramListenTogetherSession;
      this.a.a(i, str);
      return;
    }
    this.a.b(i, str);
