  ...
  extends BaseAdapter
{
  ...
  private wzy(CountryActivity paramCountryActivity) {}
  
  private int a(wzw paramwzw)
  {
    if (paramwzw.a) {
      return 0;
    }
    ...
    String str2 = paramwzw.c;
    String str3 = paramwzw.b;
    String str1 = paramwzw.d;
    paramwzw = str1;
    if (str1 != null) {
      paramwzw = str1.toLowerCase();
    }
    str1 = ChnToSpell.a(str3, 1);
    String str4 = ChnToSpell.a(str3, 2);
    if ((str2.equals(this.jdField_a_of_type_JavaLangString)) || (str3.equals(this.jdField_a_of_type_JavaLangString)) || (str1.equals(this.jdField_a_of_type_JavaLangString)) || (str4.equals(this.jdField_a_of_type_JavaLangString)) || ((paramwzw != null) && (paramwzw.equals(this.jdField_a_of_type_JavaLangString)))) {
      return 3;
    }
    if ((str2.indexOf(this.jdField_a_of_type_JavaLangString) == 0) || (str3.indexOf(this.jdField_a_of_type_JavaLangString) == 0) || (str1.indexOf(this.jdField_a_of_type_JavaLangString) == 0) || (str4.indexOf(this.jdField_a_of_type_JavaLangString) == 0) || ((paramwzw != null) && (paramwzw.indexOf(this.jdField_a_of_type_JavaLangString) == 0))) {
      return 2;
    }
  ...
  public void a(String paramString)
  {
    ...
    if (((String)localObject).startsWith(this.jdField_a_of_type_JavaLangString))
    {
      ...
      localwzw = (wzw)paramString.next();
      k = a(localwzw);
      if (k != 3) {
        break label141;
      }
      ((ArrayList)localObject).add(j, localwzw);
      j += 1;
    }
    for (;;)
    {
      ...
      if (k == 2)
      {
        ((ArrayList)localObject).add(i + j, localwzw);
        i += 1;
      }
      else if (k == 1)
      {
        ((ArrayList)localObject).add(localwzw);
      }
    }
    label181:
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    CountryActivity.a(localView, (wzw)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt));
    return localView;
  }
}
