  ...
  extends aohg
{
  public void a()
  {
    ...
    if (i > 10)
    {
      ...
      {
        bool1 = SettingCloneUtil.readValue(BaseApplicationImpl.sApplication, null, BaseApplicationImpl.sApplication.getString(2131694432), "qqsetting_screenshot_key", false);
        boolean bool2 = bhim.a(BaseApplication.getContext());
        if ((bool1) && (bool2))
        {
    ...
    for (;;)
    {
      ...
      while (QLog.isColorLevel())
      {
        ...
        if ((!bhvl.g) && (Build.VERSION.SDK_INT < 11)) {
          bhvi.a().a(BaseActivity2.topActivity.getWindow());
        }
      }
    }
  }
