  ...
  extends rcr
{
  ...
  {
    return bhgg.a(anhk.ba + ".readInjoy/skin_res/");
  }
  ...
  public static JSONObject a()
  {
    ...
    try
    {
      jdField_a_of_type_OrgJsonJSONObject = new JSONObject(bgmg.b(new File(b() + "/colors.json")));
  ...
  public static void a()
  {
    ...
    try
    {
      String str = bgmg.b(new File(d() + "refreshConfig.json"));
      localObject = str;
  ...
  {
    return bdfc.a(new File(a(paramString)));
  }
  ...
  {
    return bhgg.a(anhk.ba + ".readInjoy/skin_guide/");
  }
  ...
  public Drawable a(String paramString)
  {
    ...
    ((URLDrawable.URLDrawableOptions)localObject1).mPlayGifImage = ayzh.a(paramString.getAbsolutePath());
