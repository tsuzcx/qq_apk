...
public class bauc
{
  ...
  private final batv jdField_a_of_type_Batv;
  private final bqen jdField_a_of_type_Bqen;
  private final String jdField_a_of_type_JavaLangString;
  private ByteBuffer jdField_a_of_type_JavaNioByteBuffer;
  private final List<baue> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  public bauc(bqen parambqen, String paramString, batv parambatv)
  {
    this.jdField_a_of_type_Bqen = parambqen;
  ...
  private void b()
  {
    ...
    baue localbaue;
    for (int i = 0; localIterator.hasNext(); i = baue.b(localbaue) + i)
    {
      localbaue = (baue)localIterator.next();
      baue.a(localbaue, localBufferInfo, i);
      this.jdField_a_of_type_AndroidMediaMediaMuxer.writeSampleData(a(baue.a(localbaue)), this.jdField_a_of_type_JavaNioByteBuffer, localBufferInfo);
    }
  ...
  public void a()
  {
    try
    {
      ...
      if (this.jdField_a_of_type_Bqen.a())
      {
  ...
  public void a(int paramInt, ByteBuffer paramByteBuffer, MediaCodec.BufferInfo paramBufferInfo)
  {
    try
    {
      ...
      this.jdField_a_of_type_JavaUtilList.add(new baue(paramInt, paramBufferInfo.size, paramBufferInfo, null));
      return;
    }
