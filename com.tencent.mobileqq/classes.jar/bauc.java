  ...
  implements batr, INetInfoHandler
{
  ...
  public bauc(AppRuntime paramAppRuntime, batq parambatq)
  {
    ...
    try
    {
      if (!this.jdField_a_of_type_JavaUtilLinkedList.isEmpty())
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          {
            if (QLog.isColorLevel()) {
              QLog.d("QueueDownloader", 2, "getTask | " + paramString + " task find =" + localbatm);
            }
            return localbatm;
          }
        }
  ...
  public void a()
  {
    for (;;)
    {
      try
      {
        synchronized (this.jdField_a_of_type_JavaUtilLinkedList)
        {
          ...
          if ((!localbatm2.a()) && (l > localbatm2.c + localbatm2.d))
          {
            ...
            QLog.d("QueueDownloader", 2, "remove task[" + localbatm2.jdField_a_of_type_JavaLangString + "], isCancal=" + localbatm2.b() + ", timeOut=" + bool);
          }
        }
        bool = false;
      }
      ...
      for (;;)
      {
        ...
        return;
        label288:
        ThreadManager.postDownLoadTask(new QueueDownloader.1(this, localbatm1), 2, null, false);
  ...
  public void a(batm parambatm)
  {
    ...
    try
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("QueueDownloader", 2, "removeTask | task=" + parambatm);
        }
        parambatm.i();
      ...
      synchronized (this.jdField_a_of_type_JavaUtilLinkedList)
      {
        ...
        if (paramBundle == null)
        {
          ...
          if (parambatm.b)
          {
            ...
            if (QLog.isColorLevel()) {
              QLog.d("QueueDownloader", 2, "startDownload | task=" + parambatm.jdField_a_of_type_JavaLangString);
            }
            a();
            return;
          }
