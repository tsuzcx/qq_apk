  ...
  implements View.OnClickListener, OnLongClickAndTouchListener, BubblePopupWindow.OnDismissListener
{
  ...
  private wlk(ChatHistoryBubbleListAdapter paramChatHistoryBubbleListAdapter) {}
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    if (((ChatItemBuilder.BaseHolder)localObject1).jdField_a_of_type_ComTencentMobileqqDataChatMessage.msgtype == -1000) {
      ((QQCustomMenu)localObject2).a(2131375639, "复制", 2130838310);
    }
    ((QQCustomMenu)localObject2).a(2131375633, this.jdField_a_of_type_ComTencentMobileqqActivityChathistoryChatHistoryBubbleListAdapter.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131433652), 2130838314);
      ...
      do
      {
        ...
        if ((localObject2 instanceof StructingMsgItemBuilder.StructingMsgViewHolder))
        {
          ...
          else
          {
            ...
            ((StructingMsgItemBuilder.StructingMsgViewHolder)localObject3).jdField_a_of_type_AndroidViewView.setBackgroundResource(2130845867);
          }
          for (;;)
          {
            ...
            break label383;
            break;
            ((StructingMsgItemBuilder.StructingMsgViewHolder)localObject3).jdField_a_of_type_AndroidViewView.setBackgroundResource(2130845703);
            continue;
