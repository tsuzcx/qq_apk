...
public class acnt
{
  public static void a(PlusPanel paramPlusPanel, acmx paramacmx)
  {
  ...
  private static void b(PlusPanel paramPlusPanel, acmx paramacmx)
  {
    if (paramacmx.a >= 0) {}
    do
    {
      ...
      do
      {
        ...
        if (paramPlusPanel.jdField_a_of_type_AndroidUtilSparseArray != null) {
          localObject = (TroopAIOAppInfo)paramPlusPanel.jdField_a_of_type_AndroidUtilSparseArray.get(paramacmx.b);
        }
      } while ((localObject == null) || (((TroopAIOAppInfo)localObject).url == null));
      paramacmx = ((TroopAIOAppInfo)localObject).url.replace("$UIN$", paramPlusPanel.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).replace("$GCODE$", paramPlusPanel.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a).replace("$APPID$", String.valueOf(paramacmx.b));
      int j = 0;
      int i = j;
      try
      {
        if (TextUtils.equals(new URI(paramacmx).getScheme(), "mqqapi"))
        {
          localObject = bade.a(paramPlusPanel.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramPlusPanel.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(), paramacmx);
          i = j;
          if (localObject != null)
          {
            ((bacn)localObject).c();
    ...
    ((Intent)localObject).putExtra("url", paramacmx);
    ((Intent)localObject).putExtra("selfSet_leftViewText", ajjy.a(2131649921));
