...
public class acnt
  extends acnp
{
  public acnt(OnlineFileSessionWorker paramOnlineFileSessionWorker)
  {
  ...
  protected void a(int paramInt)
  {
    ...
    while (paramInt != 0)
    {
      ...
      QLog.i("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreOnlineFileSessionWorker.jdField_a_of_type_Long + "] state change :(" + this.jdField_a_of_type_Acnp.a() + "->StateChangeToOffWhenPause)");
      this.jdField_a_of_type_Acnp = new acnv(this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreOnlineFileSessionWorker);
      paramInt = 0;
    }
  }
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean == true)
    {
      ...
      QLog.i("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreOnlineFileSessionWorker.jdField_a_of_type_Long + "] state change :(" + this.jdField_a_of_type_Acnp.a() + "->StateLocalFailedWhenPause)");
