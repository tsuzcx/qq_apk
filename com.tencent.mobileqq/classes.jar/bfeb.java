  ...
  implements DialogInterface.OnCancelListener, View.OnClickListener
{
  ...
  public bfeb(Context paramContext)
  {
  ...
  private void a(Context paramContext)
  {
    ...
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramContext.findViewById(2131378078));
      ...
      for (;;)
      {
        for (;;)
        {
          ...
          else
          {
            try
            {
              localField.set(localNumberPicker, new ColorDrawable(bffq.a("#3CB371")));
              i += 1;
            }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, bfed parambfed)
  {
    this.jdField_a_of_type_AndroidWidgetDatePicker.init(paramInt1, paramInt2, paramInt3, new bfec(this));
  ...
  {
    if (this.jdField_a_of_type_Bfed != null) {
      this.jdField_a_of_type_Bfed.onDateCancel();
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    {
      this.jdField_a_of_type_Bfed.onDateConfirm(String.valueOf(this.jdField_a_of_type_Int), paramView, str);
      a();
      return;
