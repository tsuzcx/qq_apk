  ...
  extends PopupWindow
{
  ...
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new bjrd(this);
  View jdField_a_of_type_AndroidViewView;
  ImageView jdField_a_of_type_AndroidWidgetImageView;
  LinearLayout jdField_a_of_type_AndroidWidgetLinearLayout;
  bjrf jdField_a_of_type_Bjrf;
  bjrg jdField_a_of_type_Bjrg = new bjre(this);
  ...
  public bjrb(@NonNull Context paramContext)
  {
    super(paramContext);
    ...
    this.jdField_b_of_type_JavaLangString = amtj.a(2131705047);
  ...
  private void a(Object paramObject, boolean paramBoolean)
  {
    ...
    odq.a(null, "", "0X8009990", "0X8009990", 0, 0, String.valueOf(this.r), "", this.jdField_c_of_type_JavaLangString, localJSONObject.toString(), false);
  }
  ...
  private void e()
  {
    ...
    {
      if (i1 <= 1) {
        ((View)this.jdField_f_of_type_JavaUtilArrayList.get(0)).setBackgroundResource(2130842966);
      }
    }
    else {
      return;
    }
    ((View)this.jdField_f_of_type_JavaUtilArrayList.get(0)).setBackgroundResource(2130842968);
    ((View)this.jdField_f_of_type_JavaUtilArrayList.get(i1 - 1)).setBackgroundResource(2130842967);
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, ArrayList<DislikeInfo> paramArrayList, String paramString)
  {
    ...
    for (paramInt1 = paramArrayList.size();; paramInt1 = 0)
    {
      ...
      paramArrayList = new DislikeInfo();
      paramArrayList.jdField_a_of_type_JavaLangString = BaseApplicationImpl.getContext().getString(2131717406);
      paramArrayList.jdField_a_of_type_Int = 8;
      paramArrayList.jdField_b_of_type_JavaLangString = "";
      this.jdField_e_of_type_JavaUtilArrayList.add(paramArrayList);
      a(this.jdField_a_of_type_JavaUtilArrayList, this.jdField_b_of_type_AndroidViewView, 2130841694, amtj.a(2131705053), true);
      a(this.jdField_b_of_type_JavaUtilArrayList, this.jdField_c_of_type_AndroidViewView, 2130841698, amtj.a(2131705063), true);
      a(this.jdField_c_of_type_JavaUtilArrayList, this.jdField_d_of_type_AndroidViewView, 2130841687, a(this.jdField_c_of_type_JavaUtilArrayList), false);
      a(this.jdField_d_of_type_JavaUtilArrayList, this.jdField_e_of_type_AndroidViewView, 2130841691, amtj.a(2131705059), false);
      a(this.jdField_e_of_type_JavaUtilArrayList, this.jdField_f_of_type_AndroidViewView, 2130841686, BaseApplicationImpl.getContext().getString(2131717406), false);
      a();
  ...
  {
    this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131371678);
    this.jdField_c_of_type_AndroidViewView = paramView.findViewById(2131371674);
    this.jdField_d_of_type_AndroidViewView = paramView.findViewById(2131371680);
    this.jdField_e_of_type_AndroidViewView = paramView.findViewById(2131371677);
    this.jdField_f_of_type_AndroidViewView = paramView.findViewById(2131371676);
    ...
    ((ImageView)paramView.findViewById(2131366716).findViewById(2131369825)).setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
    ...
    this.jdField_a_of_type_JavaUtilMap.put(Long.valueOf(1L), amtj.a(2131705060));
    this.jdField_a_of_type_JavaUtilMap.put(Long.valueOf(2L), amtj.a(2131705058));
    this.jdField_a_of_type_JavaUtilMap.put(Long.valueOf(3L), amtj.a(2131705049));
    this.jdField_a_of_type_JavaUtilMap.put(Long.valueOf(4L), amtj.a(2131705050));
    this.jdField_a_of_type_JavaUtilMap.put(Long.valueOf(5L), amtj.a(2131705055));
    this.jdField_a_of_type_JavaUtilMap.put(Long.valueOf(6L), amtj.a(2131705054));
    this.m = ((int)this.jdField_a_of_type_AndroidContentContext.getResources().getDimension(2131298754));
    this.jdField_e_of_type_AndroidViewView.findViewById(2131377134).setVisibility(4);
    setBackgroundDrawable(new ColorDrawable());
    setOnDismissListener(new bjrc(this));
    this.jdField_a_of_type_AndroidViewView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
  }
  
  public void a(View paramView, bjrf parambjrf)
  {
    if (isShowing()) {
      dismiss();
    }
    this.jdField_a_of_type_Bjrf = parambjrf;
    parambjrf = new int[2];
    try
    {
      bool = a(paramView, parambjrf);
      if (bool)
      {
        showAtLocation(paramView, 51, parambjrf[0], parambjrf[1]);
        a(0.8F);
        a(this);
      }
      return;
  ...
  protected void a(ArrayList<DislikeInfo> paramArrayList, View paramView, int paramInt, String paramString, boolean paramBoolean)
  {
    ...
    if (!paramArrayList.isEmpty())
    {
      ...
      {
        ((TextView)paramView.findViewById(2131369019)).setText(paramString);
        localTextView = (TextView)paramView.findViewById(2131369015);
        localImageView = (ImageView)paramView.findViewById(2131369003);
        ((ImageView)paramView.findViewById(2131368939)).setImageResource(paramInt);
        paramString = "";
        if (!paramBoolean) {
          break label150;
        }
  ...
  public void a(pwe parampwe, ArrayList<DislikeInfo> paramArrayList)
  {
    int i3 = 0;
    String str = null;
    if (parampwe != null) {}
    for (;;)
    {
      try
      {
        i1 = parampwe.jdField_b_of_type_Int;
        i2 = parampwe.jdField_a_of_type_Int;
        parampwe = parampwe.a();
        str = "";
        if (parampwe != null)
        {
          str = parampwe.innerUniqueID;
          i3 = pay.a(parampwe);
        }
        a(i1, i2, i3, paramArrayList, str);
        return;
      }
      catch (Exception parampwe)
      {
        QLog.e("KandianNegativeWindow", 1, "setData error! msg=" + parampwe);
        return;
      }
      int i2 = 0;
      int i1 = 0;
  ...
  protected void c(View paramView)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (this.jdField_a_of_type_Bjrf == null);
      paramView = paramView.getTag();
    } while (!(paramView instanceof DislikeInfo));
    ArrayList localArrayList = new ArrayList();
    localArrayList.add((DislikeInfo)paramView);
    this.jdField_a_of_type_Bjrf.a(null, this.o, localArrayList, null);
  }
