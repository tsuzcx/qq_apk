...
{
  private WeakReference<moa> jdField_a_of_type_JavaLangRefWeakReference;
  
  public mny(EffectFilterTextPager paramEffectFilterTextPager, moa parammoa)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parammoa);
  }
  ...
  public void onPageSelected(int paramInt)
  {
    ...
    if ((EffectFilterTextPager.a(this.jdField_a_of_type_ComTencentAvUiFunchatFilterEffectFilterTextPager) != paramInt) && (this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null))
    {
      ...
      if (localFilterItem != null) {
        ((moa)this.jdField_a_of_type_JavaLangRefWeakReference.get()).a(l, paramInt, localFilterItem.getId());
      }
