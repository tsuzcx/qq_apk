...
public class bnez
  extends bndl
  implements Handler.Callback, bnee, bner, bnew, bnex, bnfj, Manager
{
  Context jdField_a_of_type_AndroidContentContext;
  private Handler jdField_a_of_type_AndroidOsHandler;
  private bnec jdField_a_of_type_Bnec;
  private bnen jdField_a_of_type_Bnen;
  private bnet jdField_a_of_type_Bnet;
  bnfa jdField_a_of_type_Bnfa;
  private bnff jdField_a_of_type_Bnff;
  private bnfh jdField_a_of_type_Bnfh;
  Object jdField_a_of_type_JavaLangObject = new Object();
  private WeakReference<bnds> jdField_a_of_type_JavaLangRefWeakReference;
  private ConcurrentHashMap<String, PluginRecord> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
  private boolean jdField_a_of_type_Boolean;
  private ConcurrentHashMap<String, WeakReference<bndv>> jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap;
  private boolean jdField_b_of_type_Boolean;
  private boolean c;
  private boolean d;
  
  public bnez(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Bnfh = new bnfh(paramQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidOsHandler);
    this.jdField_a_of_type_Bnfh.a(this);
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
    this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
    this.jdField_a_of_type_Bnen = new bnen(this.jdField_a_of_type_AndroidContentContext);
    this.jdField_a_of_type_Bnec = new bnec(this.jdField_a_of_type_AndroidContentContext);
    this.jdField_a_of_type_Bnet = new bnet(this.jdField_a_of_type_AndroidContentContext);
    this.c = false;
    bnfm.a().a(paramQQAppInterface);
  }
  
  private void a(int paramInt, Context paramContext, bndr parambndr, bndq parambndq)
  {
    if (parambndr == null) {}
    do
    {
      do
      {
        do
        {
          do
          {
            ...
            {
              return;
              QLog.i("QZonePluginManger", 1, "doInstallAndLaunch. confirmCode, pluginId:" + paramInt + "," + parambndr.b);
            } while (c());
            if (this.jdField_b_of_type_Boolean) {
              break;
            }
          } while (parambndq == null);
          parambndq.a(false, paramContext, parambndr);
          return;
          if (paramInt != 0) {
            break;
          }
      ...
      localObject1 = this.jdField_a_of_type_Bnet.a(parambndr.b);
      if (localObject1 != null) {
        parambndr.c = ((PluginRecord)localObject1).mInstalledPath;
      }
      parambndq.a(true, paramContext, parambndr);
      return;
      if (paramInt == 1)
      {
        localObject1 = parambndr.b;
        localObject2 = this.jdField_a_of_type_Bnfh.a((String)localObject1);
        if (localObject2 == null) {}
        for (;;)
        {
          localObject2 = new bnfa();
          ((bnfa)localObject2).jdField_a_of_type_AndroidContentContext = paramContext;
          ((bnfa)localObject2).jdField_a_of_type_Bndr = parambndr;
          ((bnfa)localObject2).jdField_a_of_type_Bndq = parambndq;
          try
          {
            a((String)localObject1, new bnfb(this, (bnfa)localObject2), 0);
            return;
          }
    ...
    Object localObject1 = parambndr.b;
    Object localObject2 = new bnfa();
    ((bnfa)localObject2).jdField_a_of_type_AndroidContentContext = paramContext;
    ((bnfa)localObject2).jdField_a_of_type_Bndr = parambndr;
    ((bnfa)localObject2).jdField_a_of_type_Bndq = parambndq;
    try
  ...
  private PluginRecord b(String paramString)
  {
    ...
    {
      localPluginRecord1 = this.jdField_a_of_type_Bnet.a(paramString);
      QLog.i("QZonePluginManger", 1, "installer getInstalledPlugininfo " + localPluginRecord1 + "");
      if (localPluginRecord1 == null)
      {
        localPluginRecord1 = this.jdField_a_of_type_Bnfh.a(paramString);
    ...
    for (;;)
    {
      ...
      boolean bool = this.jdField_a_of_type_Bnfh.a(localPluginRecord1);
  ...
  private void b(Context paramContext, bndr parambndr, bndq parambndq)
  {
    if (parambndr == null) {}
    Object localObject;
    do
    {
      do
      {
        ...
        {
          return;
          QLog.i("QZonePluginManger", 1, "checkUpdate:" + parambndr.b);
        } while (c());
        if (this.jdField_b_of_type_Boolean) {
          break;
        }
      ...
      parambndq.a(false, paramContext, parambndr);
      return;
      localObject = parambndr.b;
      PluginRecord localPluginRecord = this.jdField_a_of_type_Bnfh.b((String)localObject);
      if (localPluginRecord == null)
      {
        a(0, paramContext, parambndr, parambndq);
        return;
      }
      ...
      localObject = this.jdField_a_of_type_Bnet.a((String)localObject);
      if (bool)
      {
        bool = this.jdField_a_of_type_Bnfh.a((PluginRecord)localObject);
        if (QLog.isColorLevel()) {
          QLog.d("QZonePluginManger", 2, "up to day :" + bool);
        }
        if (bool)
        {
          a(2, paramContext, parambndr, parambndq);
          return;
        }
      }
      if ((!bnfk.a(localPluginRecord, paramContext)) || (localPluginRecord == null)) {
        break;
      }
      if (QLog.isColorLevel()) {
    ...
    parambndr.c = ((PluginRecord)localObject).mInstalledPath;
    parambndq.a(true, paramContext, parambndr);
    return;
    if (QLog.isColorLevel()) {
      QLog.d("QZonePluginManger", 2, "forceUpdate, deamonInstall：" + true + ", " + true);
    }
    a(3, paramContext, parambndr, parambndq);
  }
  ...
  private void b(String paramString, int paramInt)
  {
    ...
    bdmc.a(this.jdField_a_of_type_AndroidContentContext).a(null, "actQzonePluginPatch", true, 0L, 0L, localHashMap, null);
  }
  ...
  public void a()
  {
    ...
    QQAppInterface localQQAppInterface = bnfm.a().a();
    ...
    bdek.a(localQQAppInterface, BaseApplicationImpl.getContext());
  }
  ...
  public void a(Context paramContext, bndr parambndr, bndq parambndq)
  {
    ...
    if (!this.jdField_b_of_type_Boolean)
    {
      ...
      {
        d();
        bnfa localbnfa = new bnfa();
        localbnfa.jdField_a_of_type_AndroidContentContext = paramContext;
        localbnfa.jdField_a_of_type_Bndr = parambndr;
        localbnfa.jdField_a_of_type_Bndq = parambndq;
        this.jdField_a_of_type_Bnfa = localbnfa;
        if (QLog.isColorLevel()) {
    ...
    b(paramContext, parambndr, parambndq);
  }
  ...
  public void a(bnds parambnds, int paramInt)
  {
    ...
    {
      return;
      this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambnds);
      parambnds = bmtd.b();
    } while (TextUtils.isEmpty(parambnds));
    this.jdField_a_of_type_Bnec.a(parambnds, this, paramInt);
  }
  
  public void a(bned parambned)
  {
    if (this.jdField_a_of_type_JavaLangRefWeakReference != null) {}
    try
    {
      parambned = (bnds)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (parambned != null) {
        parambned.a();
      }
      return;
    }
    catch (RemoteException parambned)
    {
      QLog.e("QZonePluginManger", 1, parambned, new Object[0]);
    }
  }
  ...
  public void a(PluginRecord paramPluginRecord)
  {
    ...
    for (;;)
    {
      ...
      if (paramPluginRecord != null)
      {
        ...
        try
        {
          localObject = (bndv)((WeakReference)localObject).get();
          if (localObject != null)
          {
            ((bndv)localObject).a(paramPluginRecord.id);
            return;
          }
        }
  ...
  public void a(PluginRecord paramPluginRecord, int paramInt)
  {
      ...
      if (paramPluginRecord != null)
      {
        ...
        try
        {
          ...
          if (localObject != null) {
            if (-9998 == paramInt)
            {
              ((bndv)localObject).a(paramPluginRecord.id, 8);
    ...
    ((bndv)localObject).a(paramPluginRecord.id, 5);
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if ((paramBoolean) && (this.jdField_a_of_type_Bnff != null)) {
      this.jdField_a_of_type_Bnff.a();
    }
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      if (this.jdField_a_of_type_Bnfa != null)
      {
        ...
        b(localbnfa.jdField_a_of_type_AndroidContentContext, localbnfa.jdField_a_of_type_Bndr, localbnfa.jdField_a_of_type_Bndq);
        this.jdField_a_of_type_Bnfa = null;
  ...
  public void a(boolean paramBoolean, PluginRecord paramPluginRecord)
  {
    ...
    try
    {
      ...
      if (paramBoolean)
      {
        if (localObject != null)
        {
          localObject = (bndv)((WeakReference)localObject).get();
          if (localObject != null) {
            ((bndv)localObject).b(paramPluginRecord.id);
          }
        }
    ...
    if (localObject != null)
    {
      localObject = (bndv)((WeakReference)localObject).get();
      if (localObject != null) {
        ((bndv)localObject).a(paramPluginRecord.id, 7);
      }
    }
  ...
  public boolean a(String paramString, bndv parambndv, int paramInt)
  {
    ...
    this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString, new WeakReference(parambndv));
    PluginRecord localPluginRecord1 = this.jdField_a_of_type_Bnfh.a(paramString);
    if (localPluginRecord1 != null)
    {
      PluginRecord localPluginRecord2 = this.jdField_a_of_type_Bnet.a(paramString);
      if ((localPluginRecord2 != null) && (localPluginRecord2.state == 4) && (this.jdField_a_of_type_Bnfh.a(localPluginRecord2)))
      {
        QLog.i("QZonePluginManger", 1, "installPlugin " + paramString + " 已安装");
        if (parambndv != null) {
          parambndv.b(paramString);
        }
      }
    }
    for (;;)
    {
      if (this.jdField_a_of_type_Bnff == null) {
        this.jdField_a_of_type_Bnff = new bnff(this, this.jdField_a_of_type_Bnfh);
      }
      return true;
  ...
  public void b(PluginRecord paramPluginRecord)
  {
    ...
    try
    {
      localObject = (bndv)((WeakReference)localObject).get();
      if (localObject != null) {
        ((bndv)localObject).a(paramPluginRecord.id, 3);
      }
    }
  ...
  public void b(PluginRecord paramPluginRecord, int paramInt)
  {
    ...
    boolean bool;
    if ((a(paramInt)) && (bnfk.a(paramPluginRecord, this.jdField_a_of_type_AndroidContentContext)))
    {
      if (!paramPluginRecord.id.equals(bnfk.a())) {
        break label248;
      }
      if (!bnkd.f(bnkd.a())) {
        break label243;
    ...
    for (;;)
    {
      ...
      try
      {
        ((bndv)localObject).a(paramPluginRecord.id, 2);
        b(paramPluginRecord.id, 2);
        this.jdField_a_of_type_Bnet.a(localPluginRecord, this);
        return;
      }
      catch (RemoteException localRemoteException)
      {
  ...
  public boolean b(String paramString)
  {
    ...
    paramString = this.jdField_a_of_type_Bnfh.a(paramString);
    this.jdField_a_of_type_Bnen.a(paramString, this);
    return false;
  }
  
  public void c(bned parambned)
  {
    if (this.jdField_a_of_type_JavaLangRefWeakReference != null) {}
    try
    {
      bnds localbnds = (bnds)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localbnds != null) {
        localbnds.a(parambned.jdField_a_of_type_Int);
      }
      return;
    }
    catch (RemoteException parambned)
    ...
    for (;;)
    {
      ...
      if (paramPluginRecord != null)
      {
        ...
        try
        {
          ...
          if (localObject != null)
          {
            ((bndv)localObject).a(paramPluginRecord.id, paramPluginRecord.progress, paramPluginRecord.size);
            return;
          }
        }
        catch (RemoteException paramPluginRecord)
  ...
  public boolean c(String paramString)
  {
    ...
    do
    {
      ...
      paramString = this.jdField_a_of_type_Bnfh.a(paramString);
      this.jdField_a_of_type_Bnet.a(paramString, null);
      this.jdField_a_of_type_Bnen.a(paramString, this);
      paramString = bmtd.b();
    } while (TextUtils.isEmpty(paramString));
    this.jdField_a_of_type_Bnec.a(paramString);
    return false;
  }
  
  public void d(bned parambned)
  {
    if (this.jdField_a_of_type_JavaLangRefWeakReference != null) {}
    try
    {
  ...
  public void e(bned parambned)
  {
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (parambned != null)) {}
    try
    {
      bnds localbnds = (bnds)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localbnds != null) {
        localbnds.a(parambned.jdField_a_of_type_Float);
      }
      return;
    }
    catch (RemoteException parambned)
  ...
  public void onDestroy()
  {
    ...
    this.jdField_a_of_type_Bnfh = null;
    this.jdField_a_of_type_Bnet = null;
    if (this.jdField_a_of_type_Bnen != null) {
      this.jdField_a_of_type_Bnen.a();
    }
    this.jdField_a_of_type_Bnec = null;
    this.jdField_a_of_type_Bnen = null;
    if (this.jdField_a_of_type_Bnff != null) {
      this.jdField_a_of_type_Bnff.b();
    }
