...
public class ayqm
{
  ...
  public ayqm()
  {
    ...
    this.jdField_a_of_type_Ayqn = new ayqn();
    this.jdField_b_of_type_Ayqn = new ayqn();
    this.jdField_c_of_type_Ayqn = new ayqn();
    this.jdField_a_of_type_Ayqo = new ayqo();
    this.jdField_b_of_type_Ayqo = new ayqo();
    this.jdField_g_of_type_Long = System.currentTimeMillis();
  }
  
  public ayqm(String paramString1, String paramString2, int paramInt)
  {
    this.jdField_a_of_type_Int = -1;
    this.jdField_b_of_type_Int = -1;
    this.jdField_d_of_type_Int = -1;
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    case 4: 
      localayqo = this.jdField_a_of_type_Ayqo;
      localayqo.e += paramInt2;
      return;
    case 3: 
      localayqo = this.jdField_a_of_type_Ayqo;
      localayqo.d += paramInt2;
      return;
    }
    this.jdField_a_of_type_Ayqo.c = true;
  }
