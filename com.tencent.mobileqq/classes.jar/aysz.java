...
public class aysz
  implements Handler.Callback, awyi
{
  private static aysz jdField_a_of_type_Aysz;
  private static Object jdField_a_of_type_JavaLangObject = new Object();
  public int a;
  private Handler jdField_a_of_type_AndroidOsHandler;
  public ConcurrentHashMap<String, awdu> a;
  ...
  {
    if (jdField_a_of_type_Aysz == null) {}
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (jdField_a_of_type_Aysz == null) {
        jdField_a_of_type_Aysz = new aysz();
      }
      return jdField_a_of_type_Aysz;
    }
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface, Friends paramFriends, TextView paramTextView)
  {
    ...
    if ((!TextUtils.isEmpty(paramFriends.songName)) && (System.currentTimeMillis() < paramFriends.songEndTime))
    {
      ...
      {
        paramQQAppInterface = String.format(paramQQAppInterface.getString(2131697643), new Object[] { paramFriends.songName, paramFriends.singerName });
        if (!(paramTextView instanceof OnlineStatusLyricView)) {
          break label152;
        }
        ((ayta)bojl.a().getBusinessHandler(174)).a(paramFriends);
        ((OnlineStatusLyricView)paramTextView).setFriendSession(paramFriends, paramQQAppInterface);
      }
      for (;;)
      {
        bcst.b(null, "dc00898", "", "", "0X800AC92", "0X800AC92", paramFriends.songSourceType, 0, "", "0", "0", "");
        return paramQQAppInterface;
        paramQQAppInterface = String.format(paramQQAppInterface.getString(2131697644), new Object[] { paramFriends.songName });
        break;
        label152:
        paramQQAppInterface = aqgv.a(paramTextView.getPaint(), paramQQAppInterface, bgtn.a(200.0F));
      }
    }
    return paramQQAppInterface.getString(2131697645);
  }
    ...
    if (paramArrayOfByte != null) {
      try
      {
        if (paramArrayOfByte.length > 0)
        {
          ...
          if (a().jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.contains(paramFriends.songId))
          {
            a(paramFriends);
  ...
  public void a(Activity paramActivity, String paramString)
  {
    ...
    bcst.b(null, "dc00898", "", "", "0X800ABB2", "0X800ABB2", 0, 0, "", "0", "0", "");
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 2: 
      ...
      {
        localayta.a((MusicInfo)localObject, j, bool, QQMusicPlayService.a());
    ...
    ayta localayta = (ayta)a().a(174);
    Object localObject = QQPlayerService.b();
    if (paramMessage.arg1 == 1) {}
    for (boolean bool = true;; bool = false)
    {
      localayta.a((SongInfo)localObject, i, bool, QQPlayerService.d());
