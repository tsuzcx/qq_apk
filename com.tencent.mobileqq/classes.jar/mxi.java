...
public abstract class mxi
{
  ...
  protected mxi(AppInterface paramAppInterface, int paramInt, long paramLong)
  {
  ...
  protected boolean a(String paramString, mxk parammxk)
  {
    ...
    mxj localmxj = new mxj(this, str, l, arrayOfByte, parammxk);
    ...
    localObject = new Transaction(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_Int, paramString, 0, (byte[])localObject, arrayOfByte, localmxj, localCommFileExtReq.toByteArray());
    int i = this.jdField_a_of_type_ComTencentCommonAppAppInterface.getHwEngine().submitTransactionTask((Transaction)localObject);
    if (i != 0) {
      parammxk.a(i, str, "", null);
    }
