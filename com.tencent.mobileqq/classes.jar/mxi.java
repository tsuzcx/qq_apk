...
public class mxi
  extends Handler
{
  public mxi(PublicAccountAdvertisementActivity paramPublicAccountAdvertisementActivity, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            ...
            default: 
              ...
              return;
            case -24: 
              this.a.b(this.a.getString(2131624080));
              return;
            }
            this.a.a(2131624084);
            return;
            this.a.b(this.a.getString(2131624082));
            return;
          } while (PublicAccountAdvertisementActivity.a(this.a) == null);
        ...
        paramMessage.add(2131313563, PublicAccountAdvertisementActivity.a(this.a));
        paramMessage.commit();
      } while (!ThemeUtil.isInNightMode(this.a.getAppRuntime()));
      paramMessage = this.a.findViewById(2131305166);
