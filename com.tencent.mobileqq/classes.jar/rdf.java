...
public class rdf
{
  ...
  private static rdf a(String paramString, int paramInt)
  {
  ...
  private static rdf a(rdf paramrdf)
  {
    SharedPreferences localSharedPreferences = bkwm.a(pay.a(), true, false);
    if ((localSharedPreferences == null) || (paramrdf == null)) {
      return paramrdf;
    }
    paramrdf.jdField_d_of_type_Long = localSharedPreferences.getLong("kandian_push_0x210_c5_msg_time", 0L);
    return paramrdf;
  }
  
  public static rdf a(byte[] paramArrayOfByte)
  {
    return a(paramArrayOfByte, 1);
  }
  
  public static rdf a(byte[] paramArrayOfByte, int paramInt)
  {
    int i1 = 0;
    rdf localrdf = new rdf();
    for (;;)
    {
      try
      {
        submsgtype0xc5.MsgBody localMsgBody = new submsgtype0xc5.MsgBody();
        localMsgBody.mergeFrom(paramArrayOfByte);
        localrdf.jdField_a_of_type_Int = paramInt;
        localrdf.jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
        localrdf.jdField_b_of_type_Int = localMsgBody.uint32_source.get();
        if (QLog.isColorLevel()) {
          QLog.d("KandianOx210MsgInfo", 2, "receive push 0xc5, bid = " + localrdf.jdField_b_of_type_Int);
        }
        localrdf.jdField_c_of_type_Int = localMsgBody.uint32_bid.get();
        if (QLog.isColorLevel()) {
          QLog.d("KandianOx210MsgInfo", 2, "receive push 0xc5, realbid = " + localrdf.jdField_c_of_type_Int);
        }
        localrdf.jdField_a_of_type_Long = localMsgBody.uint64_article_id.get();
        localrdf.jdField_b_of_type_Long = localMsgBody.uint64_seq.get();
        if (localMsgBody.bytes_diandian_cookie.has()) {
          localrdf.jdField_c_of_type_JavaLangString = localMsgBody.bytes_diandian_cookie.get().toStringUtf8();
        }
        if ((localMsgBody.msg_notify_infos.has()) && (localMsgBody.msg_notify_infos.get() != null) && (((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.has()) && (((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.get() != null))
        {
          ...
          {
            localrdf.jdField_a_of_type_JavaUtilArrayList.clear();
            ...
            if (paramInt < paramArrayOfByte.size())
            {
              ...
              localrdf.jdField_a_of_type_JavaUtilArrayList.add(localObject2);
              paramInt += 1;
              continue;
            }
          }
          ...
          if (((submsgtype0xc5.StyleSheet)localObject1).uint32_show_folder.has())
          {
            ...
            localrdf.jdField_e_of_type_Int = paramInt;
            ...
            localrdf.jdField_g_of_type_Int = paramInt;
            ...
            localrdf.jdField_a_of_type_JavaLangString = paramArrayOfByte;
            ...
            localrdf.jdField_b_of_type_JavaLangString = paramArrayOfByte;
            if (((!((submsgtype0xc5.StyleSheet)((submsgtype0xc5.StyleSheet)localObject1).get()).msg_tip_body.has()) || (((submsgtype0xc5.StyleSheet)((submsgtype0xc5.StyleSheet)localObject1).get()).msg_tip_body.get() == null)) && (localrdf.jdField_a_of_type_JavaUtilArrayList.size() == 0)) {
              return null;
            }
            if (((!((submsgtype0xc5.StyleSheet)((submsgtype0xc5.StyleSheet)localObject1).get()).msg_tip_body.has()) || (((submsgtype0xc5.StyleSheet)((submsgtype0xc5.StyleSheet)localObject1).get()).msg_tip_body.get() == null)) && (localrdf.jdField_a_of_type_JavaUtilArrayList.size() > 0)) {
              return localrdf;
            ...
            if (((submsgtype0xc5.StyleSheet)localObject1).uint32_show_lock_screen.has())
            {
              ...
              localrdf.jdField_f_of_type_Int = paramInt;
              paramInt = i1;
              ...
              localrdf.jdField_h_of_type_Int = paramInt;
              if (((submsgtype0xc5.TipsBody)localObject2).uint64_uin.has())
              {
                ...
                localrdf.jdField_e_of_type_Long = l1;
                ...
                localrdf.jdField_e_of_type_JavaLangString = paramArrayOfByte;
                ...
                localrdf.jdField_d_of_type_JavaLangString = paramArrayOfByte;
                ...
                localrdf.jdField_f_of_type_JavaLangString = paramArrayOfByte;
                ...
                localrdf.jdField_g_of_type_JavaLangString = paramArrayOfByte;
                if ((localMsgBody.msg_notify_infos.has()) && (localMsgBody.msg_notify_infos.get() != null) && (((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.has()) && (((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.get() != null) && (((submsgtype0xc5.StyleSheet)((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.get()).msg_type.has())) {
                  localrdf.i = ((submsgtype0xc5.StyleSheet)((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.get()).msg_type.get();
                }
                if ((((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_bb_info.has()) && (((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_bb_info.get() != null))
                {
                  ...
                  localrdf.jdField_c_of_type_Long = paramArrayOfByte.uint64_bb_uin.get();
                  localrdf.jdField_d_of_type_Int = paramArrayOfByte.uint32_src.get();
                }
                localrdf.jdField_h_of_type_JavaLangString = localMsgBody.str_msgid.get();
                return localrdf;
              }
            }
            else
  ...
  public static rdf b()
  {
    return a(a(bkwm.a(pay.a(), true, false).getString("kandian_push_0x210_msg_for_follow", ""), 1));
  }
  ...
  public static rdf c()
  {
    return a(a(bkwm.a(pay.a(), true, false).getString("kandian_push_0x210_msg_for_follow_show_in_folder", ""), 1));
  }
