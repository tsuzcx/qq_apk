...
public class bggq
  extends bgkn
{
  bggq(bggl parambggl, MessageForDeliverGiftTips paramMessageForDeliverGiftTips, boolean paramBoolean) {}
  ...
  public void a(int paramInt, oidb_0x962.RspBody paramRspBody)
  {
    if (paramInt == 0)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips.interactState == 2) && (paramRspBody.msg_finish_info.has()))
      {
        ...
        this.jdField_a_of_type_Bggl.jdField_a_of_type_ComTencentCommonAppAppInterface.getEntityManagerFactory().createEntityManager().update(this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips);
      }
    }
    for (;;)
    {
      this.jdField_a_of_type_Bggl.jdField_a_of_type_AndroidOsHandler.post(new AIOAnimationControlManager.2.1(this));
      return;
      List localList = (List)this.jdField_a_of_type_Bggl.c.get(this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips.frienduin);
      paramRspBody = localList;
      if (localList == null)
      {
        paramRspBody = new ArrayList();
        this.jdField_a_of_type_Bggl.c.put(this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips.frienduin, paramRspBody);
      }
      try
      {
        ...
        paramRspBody = (List)this.jdField_a_of_type_Bggl.b.get(this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips.frienduin);
      ...
      finally
      {
        try
        {
          ...
          bggl.b(this.jdField_a_of_type_Bggl);
          this.jdField_a_of_type_Bggl.notifyObservers(this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips);
          break;
        }
        finally {}
