...
public final class anga
  implements amya, amyb, amyc, TVK_SDKMgr.InstallListener
{
  ...
  private angd jdField_a_of_type_Angd;
  ...
  public anga(Activity paramActivity, amyk paramamyk)
  {
  ...
  private void j()
  {
    ...
    while ((this.jdField_b_of_type_Boolean) || (this.jdField_d_of_type_Boolean) || (this.jdField_a_of_type_Angb == null)) {
      return;
    }
    QLog.d("ScanEntryResourceDelegate", 1, "ARBaseSo res download fail");
    this.jdField_a_of_type_Angb.b();
  }
  ...
  private void k()
  {
    ...
    if (this.jdField_a_of_type_Angb != null) {
      this.jdField_a_of_type_Angb.a(k / 2);
    }
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_Angc != null) {
        this.jdField_a_of_type_Angc.a((this.jdField_c_of_type_Int + this.jdField_d_of_type_Int) / 2);
      }
      return;
  ...
  public void a(long paramLong, angb paramangb, angc paramangc)
  {
    if (paramLong == 0L) {
      return;
    }
  ...
  public void a(ARCommonConfigInfo paramARCommonConfigInfo)
  {
    ...
    try
    {
      ...
      TVK_SDKMgr.setOnLogListener(new angg());
      if (this.jdField_a_of_type_Angd != null) {
        this.jdField_a_of_type_Angd.a(paramARCommonConfigInfo);
      }
      this.i = true;
      return;
    }
  ...
  public void c(int paramInt)
  {
    ...
    try
    {
      this.jdField_a_of_type_Amyk.b(paramInt);
      return;
    }
    catch (Exception localException)
    {
  ...
  public void e()
  {
    ...
    a(this.jdField_a_of_type_Long, this.jdField_a_of_type_Angb, this.jdField_a_of_type_Angc);
  }
  ...
  public void g()
  {
    try
    {
      this.jdField_a_of_type_Boolean = this.jdField_a_of_type_Amyk.b();
      if (!this.jdField_a_of_type_Boolean)
      {
        this.jdField_b_of_type_Boolean = true;
        this.jdField_a_of_type_Amyk.c();
      }
      for (;;)
      {
  ...
  public void i()
  {
    ...
    {
      this.h = true;
      this.jdField_a_of_type_Amyk.a(1);
      this.e = amxs.a();
      if (this.e) {
        break label156;
      }
      this.g = true;
      this.jdField_a_of_type_Amyk.a(0);
  ...
  public void k_(int paramInt)
  {
    ...
    for (;;)
    {
      if ((this.e) && (this.f) && (this.jdField_a_of_type_Angc != null)) {
