  ...
  extends amnl
{
  ...
  public amdm(FriendListInnerFrame paramFriendListInnerFrame)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberFriendListInnerFrame.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562901, paramViewGroup, false);
      localamdn = new amdn(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberFriendListInnerFrame, null);
      paramView.setTag(localamdn);
      localamdn.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131376813));
      localamdn.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131379901));
      localamdn.jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)paramView.findViewById(2131364511));
      localamdn.c = ((ImageView)paramView.findViewById(2131368212));
      localamdn.b = ((TextView)paramView.findViewById(2131371647));
    }
    for (;;)
    {
      localamdn = (amdn)paramView.getTag();
      Object localObject;
      if (i < 0)
      {
        i = -(i + 1) - 1;
        ...
        {
          localamdn.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(true);
          localamdn.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
          localamdn.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
          localamdn.c.setImageBitmap(a(((Friends)localObject).uin));
          localamdn.b.setText(((Friends)localObject).getFriendNick());
          localamdn.jdField_a_of_type_JavaLangString = ((Friends)localObject).uin;
          ...
          localamdn.jdField_a_of_type_AndroidWidgetCheckBox.setEnabled(false);
          label309:
          if ((AppSetting.c) && (localamdn.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
          {
            if (!localamdn.jdField_a_of_type_AndroidWidgetCheckBox.isChecked()) {
              break label416;
            }
            paramView.setContentDescription(((Friends)localObject).getFriendNick() + anzj.a(2131703768));
          }
          label368:
      ...
      for (;;)
      {
        ...
        return paramView;
        localamdn.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(false);
        break;
        label404:
        localamdn.jdField_a_of_type_AndroidWidgetCheckBox.setEnabled(true);
        break label309;
        label416:
        paramView.setContentDescription(((Friends)localObject).getFriendNick() + anzj.a(2131703771));
        break label368;
        localamdn.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
        localamdn.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
        localObject = String.valueOf(this.jdField_a_of_type_ArrayOfJavaLangString[i]);
        localamdn.jdField_a_of_type_AndroidWidgetTextView.setText((CharSequence)localObject);
        localamdn.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(String.format(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberFriendListInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getString(2131691638), new Object[] { ((String)localObject).toLowerCase() }));
      }
    }
  }
}
