...
public final class bgae
{
  ...
  public static int a(String paramString1, String paramString2)
  {
    ...
    //   2: ldc 2
    //   4: monitorenter
    //   5: new 105	java/io/File
    //   8: dup
    //   9: new 107	java/lang/StringBuilder
    //   12: dup
    //   13: invokespecial 110	java/lang/StringBuilder:<init>	()V
    //   16: aload_0
    //   17: invokevirtual 114	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   20: getstatic 117	java/io/File:separator	Ljava/lang/String;
    ...
    //   33: invokespecial 124	java/io/File:<init>	(Ljava/lang/String;)V
    //   36: astore 4
    //   38: aload 4
    ...
    //   64: getstatic 117	java/io/File:separator	Ljava/lang/String;
    ...
    //   77: invokestatic 132	java/lang/System:load	(Ljava/lang/String;)V
    //   80: iconst_0
    //   81: istore_2
    //   82: goto -34 -> 48
    //   85: astore_0
    ...
    //   92: dup
    //   93: invokespecial 110	java/lang/StringBuilder:<init>	()V
    //   96: ldc 136
    //   98: invokevirtual 114	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   101: aload_0
    //   102: invokevirtual 139	java/lang/Throwable:getMessage	()Ljava/lang/String;
    ...
    //   111: invokestatic 144	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   114: aload 4
    //   116: invokevirtual 147	java/io/File:delete	()Z
    //   119: pop
    //   120: iconst_2
    //   121: istore_2
    //   122: goto -74 -> 48
  ...
  public static void a()
  {
    ...
    if ((BaseApplicationImpl.getApplication().getRuntime() instanceof QQAppInterface))
    {
      ...
      auen localauen = (auen)((QQAppInterface)localObject).getManager(219);
      if (localauen != null) {
        localauen.d();
      }
  ...
  public static void a(Activity paramActivity, AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2, int paramInt3, int paramInt4, Bundle paramBundle)
  {
    ...
    if (paramInt1 == 0)
    {
      ...
      {
        localObject1 = bgev.a("signatureEntrance");
        str1 = str2;
      }
    ...
    for (;;)
    {
      ...
      localObject1 = bgev.a("signatureDIYEntrance");
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (localbboi != null)
    {
      ...
      if (i != 0)
      {
        ...
        k = 1;
        if (localbboi.a("100005.100006") == -1) {
          break label278;
        }
        m = 1;
        ...
        i2 = 1;
        bool = ((gb)paramQQAppInterface.getManager(42)).a;
        if (!bool) {
          break label312;
        }
    ...
    for (;;)
    {
      ...
      {
        if (i != 0) {
          ((azvi)paramQQAppInterface.getManager(36)).b("100005");
        }
        return;
        i = 0;
        break;
    ...
    for (BubbleManager localBubbleManager = (BubbleManager)paramQQAppInterface.getManager(44);; localBubbleManager = null)
    {
      if ((paramXListView != null) && (localBubbleManager != null))
      {
        ...
        while (i >= 0)
        {
          ...
          {
            aezf localaezf = (aezf)AIOUtils.getHolder((View)localObject);
            localObject = AIOUtils.getMessage((View)localObject);
            if ((localObject != null) && (((ChatMessage)localObject).needVipBubble()) && (localaezf != null) && (localaezf.a != null) && (localaezf.a.jdField_a_of_type_Int == apfe.a.jdField_a_of_type_Int) && (localBubbleManager.a(anaj.a(((ChatMessage)localObject).vipBubbleID)))) {
              return true;
            }
            if ((localObject != null) && (((gb)paramQQAppInterface.getManager(42)).a(localaezf, (ChatMessage)localObject))) {
              return true;
            }
          }
          else if ((localObject != null) && ((AIOUtils.getHolder((View)localObject) instanceof agmy)))
          {
            return true;
          }
          i -= 1;
  ...
  public static byte[] a(byte[] paramArrayOfByte, tencent.im.msg.im_msg_body.GeneralFlags paramGeneralFlags, int paramInt)
  {
    ...
    //   4: ifnull +295 -> 299
    //   7: aload_1
    //   8: getfield 713	tencent/im/msg/im_msg_body$GeneralFlags:bytes_pb_reserve	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   11: invokevirtual 718	com/tencent/mobileqq/pb/PBBytesField:has	()Z
    //   14: ifeq +285 -> 299
    //   17: new 720	tencent/im/msg/hummer/resv/generalflags$ResvAttr
    //   20: dup
    //   21: invokespecial 721	tencent/im/msg/hummer/resv/generalflags$ResvAttr:<init>	()V
    //   24: astore 4
    //   26: aload 4
    //   28: aload_1
    //   29: getfield 713	tencent/im/msg/im_msg_body$GeneralFlags:bytes_pb_reserve	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   32: invokevirtual 725	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   35: invokevirtual 731	com/tencent/mobileqq/pb/ByteStringMicro:toByteArray	()[B
    //   38: invokevirtual 735	tencent/im/msg/hummer/resv/generalflags$ResvAttr:mergeFrom	([B)Lcom/tencent/mobileqq/pb/MessageMicro;
    //   41: pop
    //   42: aload 4
    //   44: getfield 738	tencent/im/msg/hummer/resv/generalflags$ResvAttr:bytes_oac_msg_extend	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   47: invokevirtual 718	com/tencent/mobileqq/pb/PBBytesField:has	()Z
    //   50: ifeq +244 -> 294
    //   53: new 236	org/json/JSONObject
    //   56: dup
    //   57: new 236	org/json/JSONObject
    //   60: dup
    //   61: aload 4
    //   63: getfield 738	tencent/im/msg/hummer/resv/generalflags$ResvAttr:bytes_oac_msg_extend	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   66: invokevirtual 725	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   69: invokevirtual 741	com/tencent/mobileqq/pb/ByteStringMicro:toStringUtf8	()Ljava/lang/String;
    //   72: invokespecial 245	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   75: ldc 247
    //   77: ldc 240
    //   79: invokevirtual 244	org/json/JSONObject:optString	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   82: invokespecial 245	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   85: astore_1
    //   86: aload_1
    //   87: ldc_w 743
    //   90: aload_1
    //   91: ldc 249
    //   93: aconst_null
    //   94: invokevirtual 244	org/json/JSONObject:optString	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   97: invokevirtual 244	org/json/JSONObject:optString	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   100: astore_1
    //   101: aload_1
    ...
    //   125: arraylength
    //   126: ifle +130 -> 256
    //   129: invokestatic 326	com/tencent/common/app/BaseApplicationImpl:getApplication	()Lcom/tencent/common/app/BaseApplicationImpl;
    //   132: invokevirtual 357	com/tencent/common/app/BaseApplicationImpl:getRuntime	()Lmqq/app/AppRuntime;
    //   135: astore 4
    //   137: aload 4
    //   139: instanceof 71
    //   142: ifeq +149 -> 291
    ...
    //   146: ldc_w 272
    //   149: aload 4
    //   151: checkcast 71	com/tencent/mobileqq/app/QQAppInterface
    //   154: invokestatic 270	bgae:a	(Lcom/tencent/mobileqq/app/QQAppInterface;)Ljava/lang/String;
    //   157: invokevirtual 284	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   160: astore_1
    //   161: new 274	java/lang/String
    //   164: dup
    //   165: aload_0
    //   166: iload_2
    //   167: invokestatic 748	bciq:a	([BI)[B
    //   170: ldc_w 750
    //   173: invokespecial 753	java/lang/String:<init>	([BLjava/lang/String;)V
    //   176: astore_0
    //   177: aload 5
    //   179: astore 4
    //   181: aload_0
    //   182: ldc_w 755
    //   185: invokevirtual 397	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   188: ifeq +68 -> 256
    //   191: getstatic 13	bgae:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   194: iconst_1
    //   195: new 107	java/lang/StringBuilder
    //   198: dup
    //   199: invokespecial 110	java/lang/StringBuilder:<init>	()V
    //   202: ldc_w 757
    //   205: invokevirtual 114	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   208: aload_1
    ...
    //   215: invokestatic 760	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   218: aload_0
    //   219: ldc_w 762
    //   222: new 107	java/lang/StringBuilder
    //   225: dup
    //   226: invokespecial 110	java/lang/StringBuilder:<init>	()V
    //   229: ldc_w 755
    //   232: invokevirtual 114	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   235: aload_1
    //   236: invokevirtual 114	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   239: ldc_w 764
    //   242: invokevirtual 114	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   245: invokevirtual 121	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   248: invokevirtual 767	java/lang/String:replaceFirst	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   251: invokevirtual 770	java/lang/String:getBytes	()[B
    //   254: astore 4
    //   256: aload 4
    //   258: areturn
    //   259: astore 4
    //   261: aconst_null
    //   262: astore_1
    //   263: getstatic 13	bgae:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   266: iconst_1
    //   267: aload 4
    //   269: iconst_0
    //   270: anewarray 4	java/lang/Object
    //   273: invokestatic 773	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   276: goto -164 -> 112
    //   279: astore_0
    //   280: aload_0
    //   281: invokevirtual 774	java/io/UnsupportedEncodingException:printStackTrace	()V
    //   284: aconst_null
    //   285: areturn
    //   286: astore 4
    //   288: goto -25 -> 263
