  ...
  implements ajiv
{
  ...
  public bgae(QQAppInterface paramQQAppInterface, Context paramContext, TroopChatPie paramTroopChatPie, View paramView, XListView paramXListView)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_ComTencentWidgetXListView = paramXListView;
    this.jdField_a_of_type_Bgah = new bgah(this, paramTroopChatPie);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Bgah);
    a();
  }
  ...
  public void a(String paramString, int paramInt, float paramFloat)
  {
    ...
    {
      return;
      paramInt = this.jdField_a_of_type_Bgah.a(paramString);
    } while (paramInt == -1);
