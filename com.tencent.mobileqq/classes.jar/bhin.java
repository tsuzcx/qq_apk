...
public final class bhin
{
  ...
  public static <T> void a(WebView paramWebView, bhis<T> parambhis)
  {
    ...
    if (paramWebView == null)
    {
      ...
      parambhis.a(new NullPointerException("mWebView is null"));
      return;
    }
    ...
    if (localObject1 == null)
    {
      ...
      parambhis.a(new NullPointerException("context is null"));
      return;
    }
    AtomicBoolean localAtomicBoolean = new AtomicBoolean(false);
    localObject1 = new azbu((Context)localObject1);
    ((azbu)localObject1).a(anzj.a(2131698322));
    ((azbu)localObject1).a(true);
    ((azbu)localObject1).a(new bhio(localAtomicBoolean, (azbu)localObject1));
    ((azbu)localObject1).show();
    ...
    Object localObject2 = new bhip((azbu)localObject1);
    ...
    ((azbu)localObject1).setOnDismissListener(new bhiq((AnimatorSet)localObject2));
    a(paramWebView, new bhir(localAtomicBoolean, (azbu)localObject1, parambhis, paramWebView, (AnimatorSet)localObject2));
  }
  
  public static void a(WebView paramWebView, bhit parambhit)
  {
    if ((paramWebView == null) || (parambhit == null)) {}
    int i;
    int j;
    Bitmap localBitmap;
    do
            ...
            try
            {
              ...
              try
              {
                if (jdField_a_of_type_JavaLangReflectMethod != null) {
                  jdField_a_of_type_JavaLangReflectMethod.invoke(paramWebView.getX5WebViewExtension(), new Object[] { localBitmap, Boolean.valueOf(true), Boolean.valueOf(true), Boolean.valueOf(true), Boolean.valueOf(true), Integer.valueOf(1), Integer.valueOf(1), new ScreenShotUtil.1(parambhit, localBitmap) });
                }
                i = 1;
              }
  ...
  public static <T> boolean a(WebView paramWebView, bhis<T> parambhis)
  {
    ...
    for (;;)
    {
      ...
      if ((i <= 0) || (j <= 0) || (k <= 0))
      {
        ...
        parambhis.a(new IllegalStateException("measuredWidth <= 0 || contentWidth <= 0 || contentHeight <= 0"));
        return false;
      }
      float f = i / j;
      j = (int)(k * f);
      if (j > 20000)
      {
        ...
        parambhis.a(new IllegalStateException(anzj.a(2131717711)));
        return false;
      }
      try
      {
        ...
        if (localBitmap != null)
        {
          Canvas localCanvas = new Canvas(localBitmap);
          localCanvas.scale(f, f);
          ThreadManagerV2.executeOnNetWorkThread(new ScreenShotUtil.2(paramWebView, localCanvas, parambhis, localBitmap));
          return true;
        }
      }
