  ...
  extends Animation
{
  ...
  public bhin(float paramFloat1, float paramFloat2, boolean paramBoolean, int paramInt)
  {
  ...
  public void a(bhio parambhio)
  {
    this.jdField_a_of_type_Bhio = parambhio;
  }
  ...
  protected void applyTransformation(float paramFloat, Transformation paramTransformation)
  {
    ...
    if (this.jdField_a_of_type_Bhio != null) {
      this.jdField_a_of_type_Bhio.a(paramFloat);
    }
    float f1;
    float f2;
