...
public class abgu
  implements View.OnClickListener, bjqk
{
  ...
  public abgu(AppInterface paramAppInterface, Activity paramActivity)
  {
    ...
    this.jdField_a_of_type_MqqObserverBusinessObserver = new abgx(this);
    this.jdField_a_of_type_AndroidOsHandler = new abgy(this);
    ...
    if ((paramActivity instanceof biod)) {
      this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference((biod)paramActivity);
    }
    while (this.jdField_a_of_type_JavaLangRefWeakReference == null)
    {
      QLog.e(jdField_a_of_type_JavaLangString, 2, "Error! mWebUiUtils still null! " + paramActivity.toString());
      return;
      if ((paramActivity instanceof binz))
      {
        paramAppInterface = ((binz)paramActivity).a();
    ...
    paramAppInterface = (biod)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if ((paramAppInterface != null) && ((paramAppInterface instanceof bits)))
    {
      this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView = ((bits)paramAppInterface).getWebView();
      if (QLog.isColorLevel())
      {
  ...
  public static final String a(List<abgz> paramList, int paramInt)
  {
    ...
    label270:
    label276:
    for (localObject2 = (abgz)paramList.get(i1);; localObject3 = localObject1)
    {
      try
      {
        int i3 = Integer.valueOf(((abgz)localObject2).b.get()).intValue();
        if (i3 >= paramInt)
        {
          localObject2 = ((abgz)localObject2).a.get();
          localObject1 = localObject2;
          if (!TextUtils.isEmpty((CharSequence)localObject2))
          {
            ...
            if (localObject2 == null)
            {
              ...
              localObject2 = (abgz)paramList.get(i1);
            }
          }
          i1 += 1;
        }
      ...
      catch (NumberFormatException localNumberFormatException1)
      {
        try
        {
          i2 = Integer.valueOf(((abgz)localObject2).b.get()).intValue();
          if (i2 >= paramInt) {
            break label267;
          }
          localObject2 = ((abgz)localObject2).a.get();
  ...
  public static List<abgz> a(PBRepeatMessageField<GetAppInfoProto.MsgIconsurl> paramPBRepeatMessageField)
  {
    if ((paramPBRepeatMessageField != null) && (!paramPBRepeatMessageField.isEmpty()))
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        paramPBRepeatMessageField.add(new abgz(localMsgIconsurl.url, localMsgIconsurl.size));
      }
  ...
  private void a(int paramInt, String paramString1, String paramString2, String paramString3, String paramString4, Bitmap paramBitmap)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        ((Bundle)localObject2).putString("intext_3", "" + bjqn.b(paramInt));
        ((Bundle)localObject2).putString("intext_2", "" + i2);
        ((Bundle)localObject2).putString("stringext_1", paramString3);
        bjqh.a().a((Bundle)localObject2, "", this.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount(), false);
      }
      ...
      ((Bundle)localObject1).putLong("share_begin_time", biqq.jdField_b_of_type_Long);
      if (!(this.jdField_a_of_type_AndroidAppActivity instanceof binz)) {
        break label3719;
      }
      paramString1 = ((binz)this.jdField_a_of_type_AndroidAppActivity).a();
    ...
    for (;;)
    {
      if ((paramInt != 0) || (!bmud.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_b_of_type_AndroidAppActivity, (Bundle)localObject1, null))) {
        zyx.a(1, 2131689486);
      }
      return;
      ...
      if (paramInt == 1)
      {
        ...
        if ((this.jdField_a_of_type_AndroidAppActivity instanceof binz))
        {
          paramBitmap = ((binz)this.jdField_a_of_type_AndroidAppActivity).a();
          if ((paramBitmap == null) || (paramBitmap.getComponentProvider() == null)) {
            break label3709;
          }
          localObject1 = (biqq)paramBitmap.getComponentProvider().a(4);
          if (localObject1 == null) {
            break label3709;
          }
          paramBitmap = ((biqq)localObject1).a();
          localObject1 = ((biqq)localObject1).jdField_e_of_type_JavaLangString;
        }
      }
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            ...
            catch (Exception paramBitmap)
            {
              ...
              localObject4 = ((Resources)localObject9).getString(2131695756);
              continue;
              paramBitmap = "plugin";
            ...
            if ((this.jdField_a_of_type_AndroidAppActivity instanceof PublicAccountBrowser))
            {
              ...
              if ((TextUtils.isEmpty(str2)) || (TextUtils.isEmpty((CharSequence)localObject4))) {
                if (jdField_f_of_type_Boolean)
                {
                  ...
                  if (paramInt != 0)
                  {
                    localObject4 = this.jdField_b_of_type_AndroidAppActivity.getString(2131695760);
                  ...
                  bhse.a(this.jdField_a_of_type_AndroidAppActivity, 1001, 146, "web_share", str2, paramString4, paramString1, paramString2, String.format(((Resources)localObject9).getString(2131695740), new Object[] { paramString1 }), paramString3, "web", null, null, null, paramBitmap, null, (String)localObject1, (String)localObject2, (String)localObject3, (String)localObject4, "", localIntent, -1, null, -1L);
                  i1 = 0;
                  if (TextUtils.isEmpty(paramString4)) {
                    i1 = 1;
                  }
                  ...
                  bjqh.a().a(paramString1, "", this.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount(), false);
                  return;
                  localIntent.putExtra("isWebCompShare", true);
            ...
            for (;;)
            {
              ...
              for (localObject1 = "https://qzonestyle.gtimg.cn/qzone/phone/n/QQ-Qzone-Android/logo_16.png";; localObject1 = paramBitmap)
              {
                ...
                if ((this.jdField_a_of_type_AndroidAppActivity instanceof binz))
                {
                  localObject8 = ((binz)this.jdField_a_of_type_AndroidAppActivity).a();
                  paramBitmap = (Bitmap)localObject6;
                ...
                label1942:
                if (becb.a(paramString3))
                {
                  localObject7 = "web";
                  localObject4 = anzj.a(2131712744);
                  if (TextUtils.isEmpty(arpx.a().h()))
                  {
                    localObject1 = becb.jdField_b_of_type_JavaLangString;
                    label1980:
                    localObject2 = becb.jdField_d_of_type_JavaLangString;
                    paramInt = 95;
                    l1 = becb.jdField_a_of_type_Long;
                ...
                for (;;)
                {
                  if ((bool2) || (bool1))
                  {
                    ...
                    localObject8 = this.jdField_b_of_type_AndroidAppActivity.getString(2131695740, new Object[] { paramString1 });
                  ...
                  for (i2 = -1;; i2 = 1001)
                  {
                    bhse.a((Context)localObject7, i1, paramInt, "web_share", paramBitmap, paramString4, paramString1, paramString2, (String)localObject8, paramString3, "web", null, null, null, (String)localObject1, null, (String)localObject5, (String)localObject3, (String)localObject2, (String)localObject4, "", localIntent, i2, (String)localObject6, l1);
                    break;
                    localObject2 = this.jdField_b_of_type_AndroidAppActivity.getString(2131695756);
                  ...
                  if ((paramInt == 3) || (paramInt == 4)) {
                    if (paramInt == 3)
                    {
                      ...
                      {
                        this.jdField_a_of_type_Bjig = new abgw(this, paramString3);
                        WXShareHelper.a().a(this.jdField_a_of_type_Bjig);
                      }
                      this.o = String.valueOf(System.currentTimeMillis());
                      if ((TextUtils.isEmpty(this.jdField_f_of_type_JavaLangString)) || (!becb.jdField_b_of_type_JavaUtilMap.containsKey(this.jdField_f_of_type_JavaLangString))) {
                        break label2586;
                      }
                      paramString4 = (Integer)becb.jdField_b_of_type_JavaUtilMap.get(this.jdField_f_of_type_JavaLangString);
                  ...
                  for (;;)
                  {
                    ...
                    if ((paramString3 != null) && (paramString3.contains("docs.qq.com/")))
                    {
                      if (paramInt == 3)
                      {
                        ...
                        if ((a() != null) && (a().l != null))
                        {
                          ...
                          paramString1 = becb.a(this.jdField_g_of_type_JavaLangString);
                          if ((TextUtils.isEmpty(this.jdField_g_of_type_JavaLangString)) || (!becb.d(this.jdField_g_of_type_JavaLangString))) {
                            break label2664;
                          }
                          if (paramString1 == null) {
                            break label2655;
                    ...
                    if (paramInt == 5)
                    {
                      ...
                      {
                        bdll.b(null, "CliOper", "", "", "0X8006277", "0X8006277", 0, 0, "", "", "", "");
                      ...
                      if (bnrl.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_b_of_type_AndroidAppActivity, (Bundle)localObject1, null, 0)) {
                        break;
                      }
                      zyx.a(1, 2131689486);
                      return;
                    ...
                    {
                      bkgt.a(this.jdField_a_of_type_AndroidAppActivity, paramInt, paramString1, paramString2, paramString3, paramString4, "", 0, false);
                      return;
                    }
                    if (paramInt == 8)
                    {
                      ...
                      catch (PackageManager.NameNotFoundException paramString2)
                      {
                        for (;;)
                        {
                          ...
                          {
                            Toast.makeText(BaseApplicationImpl.getContext(), anzj.a(2131712745), 1).show();
                    ...
                    if ((this.jdField_a_of_type_AndroidAppActivity instanceof FastWebActivity))
                    {
                      ...
                      pnx.a().a(this.jdField_a_of_type_AndroidAppActivity, null, 1, this.x, this.jdField_e_of_type_JavaLangString, this.h, this.i, this.w, paramString3);
                      bmky.a(paramString2, 42, 2);
                      return;
                    }
                    if ((this.jdField_a_of_type_AndroidAppActivity instanceof binz))
                    {
  ...
  {
    Bundle localBundle = bhow.a(paramString2, paramString3, "0.0.0.1", paramString4, this.jdField_a_of_type_AndroidContentContext.getResources().getDisplayMetrics().scaledDensity, null, null);
  ...
  public static final void a(AppInterface paramAppInterface, Context paramContext, String paramString1, long paramLong1, long paramLong2, BusinessObserver paramBusinessObserver, String paramString2)
  {
    ...
    localGetAppinfoRequest.qqv.set("8.4.5");
    ...
    paramContext = new NewIntent(paramContext, bjre.class);
  ...
  public static List<abgz> b(PBRepeatMessageField<appType.MsgIconsurl> paramPBRepeatMessageField)
  {
    if ((paramPBRepeatMessageField != null) && (!paramPBRepeatMessageField.isEmpty()))
    {
      Object localObject = paramPBRepeatMessageField.get();
  ...
  private void b(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    {
      if (((paramString.length() > 180) || ((!(this.jdField_a_of_type_AndroidAppActivity instanceof PublicAccountBrowser)) && (paramString.length() > 60))) && (!(this.jdField_a_of_type_AndroidAppActivity instanceof TeamWorkDocEditBrowserActivity)) && (!becb.a(paramString))) {
  ...
  public beae a()
  {
    return this.jdField_a_of_type_Beae;
  }
  ...
  public bjbs a()
  {
    ...
    if (this.jdField_a_of_type_Bjbs == null)
    {
      ...
      localbiod = (biod)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if ((localbiod == null) || (!(localbiod instanceof bitr)) || (this.jdField_a_of_type_AndroidAppActivity.isFinishing())) {
        break label134;
      }
      i1 = ((bitr)localbiod).getTitleBarHeight();
    }
    for (;;)
    {
      this.jdField_a_of_type_Bjbs = new bjbs(this.jdField_a_of_type_AndroidAppActivity, i1);
      this.jdField_a_of_type_Bjbs.c(2131689482);
      ...
      {
        i1 = this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131299011);
      }
      else
      {
  ...
  public String a()
  {
    ...
    for (;;)
    {
      if (TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
        {
          localObject = (biod)this.jdField_a_of_type_JavaLangRefWeakReference.get();
          if ((localObject != null) && ((localObject instanceof bits))) {
            localObject = ((bits)localObject).getCurrentUrl();
          }
        }
      }
      else
      {
        return noe.a((String)localObject, new String[0]);
      }
      localObject = "";
    }
  }
  ...
  void a()
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131369476));
    ...
    do
    {
      do
      {
        ...
        a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_a_of_type_AndroidAppActivity, this.n, bhki.b(this.jdField_a_of_type_Long), 0L, this.jdField_a_of_type_MqqObserverBusinessObserver);
        this.jdField_a_of_type_AndroidWidgetLinearLayout = new LinearLayout(this.jdField_a_of_type_AndroidContentContext);
        this.jdField_a_of_type_AndroidWidgetLinearLayout.setBackgroundColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131165297));
        ...
        localObject1 = new LinearLayout.LayoutParams((int)mvd.a(this.jdField_a_of_type_AndroidContentContext, 19.0F), (int)mvd.a(this.jdField_a_of_type_AndroidContentContext, 19.0F));
        this.jdField_b_of_type_AndroidWidgetLinearLayout = new LinearLayout(this.jdField_a_of_type_AndroidContentContext);
        localObject2 = new LinearLayout.LayoutParams(-2, -2);
        this.jdField_b_of_type_AndroidWidgetLinearLayout.setPadding((int)mvd.a(this.jdField_a_of_type_AndroidContentContext, 10.0F), 0, (int)mvd.a(this.jdField_a_of_type_AndroidContentContext, 10.0F), 0);
        ...
        this.jdField_c_of_type_AndroidWidgetImageView.setImageResource(2130840337);
        localObject1 = new LinearLayout.LayoutParams((int)mvd.a(this.jdField_a_of_type_AndroidContentContext, 30.0F), (int)mvd.a(this.jdField_a_of_type_AndroidContentContext, 30.0F));
        ...
        this.jdField_a_of_type_AndroidWidgetTextView.setPadding((int)mvd.a(this.jdField_a_of_type_AndroidContentContext, 8.0F), 0, (int)mvd.a(this.jdField_a_of_type_AndroidContentContext, 8.0F), 0);
        this.jdField_a_of_type_AndroidWidgetTextView.setSingleLine(true);
        this.jdField_a_of_type_AndroidWidgetTextView.setEllipsize(TextUtils.TruncateAt.END);
        localObject1 = new LinearLayout.LayoutParams(-2, -2);
        ((LinearLayout.LayoutParams)localObject1).weight = 1.0F;
        this.jdField_a_of_type_AndroidWidgetTextView.setText(2131690061);
        ...
        this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131165298));
        ...
        this.jdField_b_of_type_AndroidWidgetTextView.setBackgroundResource(2130841828);
        this.jdField_b_of_type_AndroidWidgetTextView.setGravity(17);
        this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131165298));
        localObject1 = new LinearLayout.LayoutParams((int)mvd.a(this.jdField_a_of_type_AndroidContentContext, 56.0F), (int)mvd.a(this.jdField_a_of_type_AndroidContentContext, 30.0F));
        ((LinearLayout.LayoutParams)localObject1).rightMargin = ((int)mvd.a(this.jdField_a_of_type_AndroidContentContext, 10.0F));
        ...
        localObject1 = new FrameLayout.LayoutParams(-1, (int)mvd.a(this.jdField_a_of_type_AndroidContentContext, 44.0F));
        ((FrameLayout.LayoutParams)localObject1).gravity = 80;
        ((FrameLayout.LayoutParams)localObject1).bottomMargin = ((int)mvd.a(this.jdField_a_of_type_AndroidContentContext, 50.0F));
      } while (!(this.jdField_a_of_type_AndroidAppActivity instanceof binz));
      localObject2 = ((binz)this.jdField_a_of_type_AndroidAppActivity).a();
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    try
    {
      ...
      for (;;)
      {
        if ((paramInt3 == 1) && ((paramInt2 == 0) || (paramInt2 == 1)) && (this.jdField_a_of_type_Beae != null)) {
  ...
  public void a(Context paramContext, GetAppInfoProto.GetAppinfoResponse paramGetAppinfoResponse)
  {
    ...
    try
    {
      if ((paramGetAppinfoResponse.has()) && (paramGetAppinfoResponse.ret.get() == 0))
      {
        ...
        {
          arrayOfByte = nnr.a(paramContext, paramGetAppinfoResponse, "GET", null, null);
          if (arrayOfByte == null)
          {
            if (!QLog.isColorLevel()) {
              return;
    ...
    catch (Exception paramContext)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        catch (OutOfMemoryError localOutOfMemoryError)
        {
          ...
          paramContext = nnr.a(paramContext, String.format("https://openmobile.qq.com/api/get_app_info_by_id?appid=%d", new Object[] { Long.valueOf(bhki.b(this.jdField_a_of_type_Long)) }), "GET", null, null);
        ...
        if (bhny.a(paramContext, localAndroidInfo.packName.get()))
        {
          paramContext = this.jdField_a_of_type_AndroidOsHandler.obtainMessage(1001);
          try
          {
  ...
  public void a(biod parambiod)
  {
    ...
    if (this.jdField_a_of_type_JavaLangRefWeakReference == null) {
      this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambiod);
    }
    parambiod = (biod)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if ((parambiod != null) && ((parambiod instanceof bits)))
    {
      this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView = ((bits)parambiod).getWebView();
      if (QLog.isColorLevel())
      {
        parambiod = jdField_a_of_type_JavaLangString;
        localObject = new StringBuilder().append(" Share secret webview is null?");
        if (this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView != null) {
          break label122;
        }
        bool = true;
        QLog.d(parambiod, 2, bool);
      }
    }
    label122:
    while (!QLog.isColorLevel()) {
  ...
  public boolean a()
  {
    ...
    for (Object localObject = null;; localObject = this.h)
    {
      ...
      localQZoneShareData.jdField_b_of_type_Long = biqq.jdField_b_of_type_Long;
      ...
      bmud.a(this.jdField_b_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), localQZoneShareData, null, -1);
      return true;
      this.jdField_b_of_type_AndroidAppActivity = this.jdField_a_of_type_AndroidAppActivity;
      break;
      localObject = this.jdField_e_of_type_JavaLangString;
  ...
  public boolean a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Bjqp.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_Bjqp.jdField_b_of_type_Int = bjqn.b(paramInt);
      localBundle = new Bundle();
      localBundle.putString("report_type", "102");
      localBundle.putString("act_type", "90");
      localStringBuilder = new StringBuilder().append("");
      if (this.jdField_a_of_type_Bjqp.jdField_a_of_type_Int != 0) {
        break label407;
      }
    }
    label407:
    for (int i1 = 0;; i1 = 1)
    {
      ...
      localBundle.putString("intext_3", "" + this.jdField_a_of_type_Bjqp.jdField_b_of_type_Int);
      localBundle.putString("intext_2", "" + this.jdField_a_of_type_Bjqp.jdField_a_of_type_Int);
      localBundle.putString("stringext_1", "" + paramString);
      bjqh.a().a(localBundle, "", this.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount(), false);
      this.jdField_a_of_type_Bjqp.jdField_a_of_type_Boolean = false;
      ...
      paramString.putString("intext_1", "" + bjqn.a(1));
      paramString.putString("intext_3", "1");
      paramString.putString("intext_4", "0");
      bjqh.a().a(paramString, "", this.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount(), false);
      return false;
    }
    ...
    if ((!this.jdField_a_of_type_Bjbs.isShowing()) && (bool)) {
  ...
  public boolean a(String paramString1, String paramString2, String paramString3, String paramString4, Bundle paramBundle)
  {
    ...
    //   7: aload_0
    //   8: aload_3
    //   9: invokevirtual 1728	abgu:a	(Ljava/lang/String;)Z
    //   12: ifne +5 -> 17
    //   15: iconst_0
    //   16: ireturn
    //   17: aload_0
    //   18: aload_1
    //   19: putfield 376	abgu:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   22: aload_0
    //   23: aload_2
    //   24: putfield 380	abgu:h	Ljava/lang/String;
    //   27: aload_0
    //   28: aload 4
    //   30: putfield 384	abgu:i	Ljava/lang/String;
    //   33: aload_0
    //   34: getfield 384	abgu:i	Ljava/lang/String;
    //   37: ifnull +43 -> 80
    //   40: aload_0
    //   41: getfield 384	abgu:i	Ljava/lang/String;
    //   44: ldc_w 1730
    //   47: invokevirtual 1733	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   50: ifeq +30 -> 80
    //   53: aload_0
    ...
    //   67: aload_0
    //   68: getfield 384	abgu:i	Ljava/lang/String;
    ...
    //   77: putfield 384	abgu:i	Ljava/lang/String;
    //   80: aload_0
    //   81: iconst_1
    //   82: putfield 1148	abgu:jdField_e_of_type_Boolean	Z
    //   85: aload 5
    //   87: ifnull +173 -> 260
    //   90: aload 5
    //   92: ldc_w 1737
    //   95: invokevirtual 554	android/os/Bundle:getInt	(Ljava/lang/String;)I
    //   98: iconst_1
    ...
    //   125: aload_0
    //   126: getfield 376	abgu:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   138: aload_0
    //   139: getfield 380	abgu:h	Ljava/lang/String;
    ...
    //   151: aload_0
    //   152: getfield 384	abgu:i	Ljava/lang/String;
    ...
    //   174: aload_0
    //   175: getfield 77	abgu:jdField_a_of_type_Bjqp	Lbjqp;
    //   178: iconst_1
    //   179: putfield 1679	bjqp:jdField_a_of_type_Boolean	Z
    //   182: aload_0
    //   183: getfield 77	abgu:jdField_a_of_type_Bjqp	Lbjqp;
    //   186: iconst_0
    //   187: putfield 1683	bjqp:jdField_a_of_type_Int	I
    //   190: aload 4
    //   192: invokestatic 281	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   195: ifeq +430 -> 625
    //   198: aload_0
    //   199: getfield 77	abgu:jdField_a_of_type_Bjqp	Lbjqp;
    //   202: astore 4
    //   204: aload 4
    //   206: aload 4
    //   208: getfield 1683	bjqp:jdField_a_of_type_Int	I
    //   211: iconst_1
    //   212: ior
    //   213: putfield 1683	bjqp:jdField_a_of_type_Int	I
    //   216: aload_2
    //   217: invokestatic 281	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   220: ifeq +18 -> 238
    //   223: aload_0
    //   224: getfield 77	abgu:jdField_a_of_type_Bjqp	Lbjqp;
    //   227: astore_2
    //   228: aload_2
    //   229: aload_2
    //   230: getfield 1683	bjqp:jdField_a_of_type_Int	I
    //   233: iconst_2
    //   234: ior
    //   235: putfield 1683	bjqp:jdField_a_of_type_Int	I
    //   238: aload_1
    //   239: invokestatic 281	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   242: ifeq +18 -> 260
    //   245: aload_0
    //   246: getfield 77	abgu:jdField_a_of_type_Bjqp	Lbjqp;
    //   249: astore_1
    //   250: aload_1
    //   251: aload_1
    //   252: getfield 1683	bjqp:jdField_a_of_type_Int	I
    //   255: iconst_4
    //   256: ior
    //   257: putfield 1683	bjqp:jdField_a_of_type_Int	I
    //   260: aload_0
    //   261: aconst_null
    //   262: putfield 1146	abgu:jdField_a_of_type_JavaLangRefSoftReference	Ljava/lang/ref/SoftReference;
    //   265: aload 5
    //   267: ifnull +263 -> 530
    //   270: getstatic 63	abgu:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   273: iconst_1
    //   274: ldc_w 1747
    ...
    //   281: aload 5
    //   283: ldc_w 1749
    //   286: invokevirtual 548	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   289: putfield 751	abgu:jdField_f_of_type_JavaLangString	Ljava/lang/String;
    //   292: aload_0
    //   293: aload 5
    //   295: ldc_w 1751
    //   298: invokevirtual 548	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   301: putfield 781	abgu:jdField_g_of_type_JavaLangString	Ljava/lang/String;
    //   304: aload_0
    //   305: aload 5
    //   307: ldc_w 1737
    //   310: iconst_m1
    //   311: invokevirtual 1754	android/os/Bundle:getInt	(Ljava/lang/String;I)I
    //   314: putfield 81	abgu:jdField_d_of_type_Int	I
    //   317: aload_0
    //   318: aload 5
    //   320: ldc_w 822
    //   323: invokevirtual 548	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   326: putfield 809	abgu:k	Ljava/lang/String;
    //   329: aload_0
    //   330: aload 5
    //   332: ldc_w 614
    //   335: invokevirtual 548	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   338: putfield 669	abgu:l	Ljava/lang/String;
    //   341: aload_0
    //   342: aload 5
    //   344: ldc_w 1756
    //   347: invokevirtual 548	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   350: putfield 671	abgu:m	Ljava/lang/String;
    //   353: aload_0
    //   354: aload 5
    //   356: ldc_w 824
    //   359: invokevirtual 548	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   362: invokestatic 604	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   365: putfield 79	abgu:jdField_c_of_type_Int	I
    //   368: aload_0
    //   369: aload 5
    //   371: ldc_w 1758
    //   374: invokevirtual 1761	android/os/Bundle:getBoolean	(Ljava/lang/String;)Z
    //   377: putfield 70	abgu:jdField_a_of_type_Boolean	Z
    //   380: aload_0
    //   381: aload 5
    //   383: ldc_w 1763
    //   386: invokevirtual 1761	android/os/Bundle:getBoolean	(Ljava/lang/String;)Z
    //   389: putfield 1765	abgu:jdField_b_of_type_Boolean	Z
    //   392: aload_0
    //   393: getfield 1767	abgu:jdField_d_of_type_Boolean	Z
    //   396: ifne +15 -> 411
    //   399: aload_0
    //   400: aload 5
    //   402: ldc_w 1769
    //   405: invokevirtual 1761	android/os/Bundle:getBoolean	(Ljava/lang/String;)Z
    //   408: putfield 1767	abgu:jdField_d_of_type_Boolean	Z
    //   411: aload_0
    //   412: aload 5
    //   414: ldc_w 1771
    //   417: invokevirtual 548	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   420: putfield 1773	abgu:j	Ljava/lang/String;
    //   423: aload_0
    //   424: aload 5
    //   426: ldc_w 1439
    //   429: invokevirtual 548	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   432: invokestatic 604	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   435: putfield 72	abgu:jdField_a_of_type_Int	I
    //   438: aload_0
    //   439: aload 5
    //   441: ldc_w 1775
    //   444: invokevirtual 1761	android/os/Bundle:getBoolean	(Ljava/lang/String;)Z
    //   447: putfield 1777	abgu:jdField_c_of_type_Boolean	Z
    //   450: aload_0
    //   451: getfield 128	abgu:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   454: ifnull +76 -> 530
    //   457: aload_0
    //   458: getfield 128	abgu:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   461: instanceof 1142
    //   464: ifeq +66 -> 530
    //   467: aload_0
    //   468: getfield 128	abgu:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   471: checkcast 1142	com/tencent/mobileqq/activity/TeamWorkDocEditBrowserActivity
    //   474: invokevirtual 1778	com/tencent/mobileqq/activity/TeamWorkDocEditBrowserActivity:a	()Lcom/tencent/mobileqq/webview/swift/WebViewFragment;
    //   477: checkcast 1780	com/tencent/mobileqq/activity/TeamWorkDocEditBrowserActivity$TeamWorkDocEditBrowserFragment
    //   480: astore_1
    //   481: aload_1
    //   482: ifnull +48 -> 530
    //   485: aload_1
    //   486: aload_0
    //   487: getfield 70	abgu:jdField_a_of_type_Boolean	Z
    //   490: aload_0
    //   491: getfield 72	abgu:jdField_a_of_type_Int	I
    //   494: invokevirtual 1783	com/tencent/mobileqq/activity/TeamWorkDocEditBrowserActivity$TeamWorkDocEditBrowserFragment:a	(ZI)V
    //   497: aload_1
    //   498: aload_0
    //   499: getfield 1767	abgu:jdField_d_of_type_Boolean	Z
    //   502: invokevirtual 1785	com/tencent/mobileqq/activity/TeamWorkDocEditBrowserActivity$TeamWorkDocEditBrowserFragment:a	(Z)V
    //   505: aload_1
    //   506: invokevirtual 1787	com/tencent/mobileqq/activity/TeamWorkDocEditBrowserActivity$TeamWorkDocEditBrowserFragment:h	()V
    //   509: aload_1
    //   510: iconst_1
    //   511: aload_0
    //   512: getfield 1773	abgu:j	Ljava/lang/String;
    //   515: aconst_null
    //   516: invokevirtual 1790	com/tencent/mobileqq/activity/TeamWorkDocEditBrowserActivity$TeamWorkDocEditBrowserFragment:a	(ZLjava/lang/String;Ljava/lang/String;)V
    //   519: aload_0
    //   520: getfield 1777	abgu:jdField_c_of_type_Boolean	Z
    //   523: ifeq +7 -> 530
    //   526: aload_1
    //   527: invokevirtual 1792	com/tencent/mobileqq/activity/TeamWorkDocEditBrowserActivity$TeamWorkDocEditBrowserFragment:c	()V
    //   530: ldc_w 1794
    //   533: aload_0
    //   534: getfield 376	abgu:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   537: invokestatic 1797	cooperation/qzone/LocalMultiProcConfig:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   540: ldc_w 1799
    //   543: aload_0
    //   544: getfield 380	abgu:h	Ljava/lang/String;
    //   547: invokestatic 1797	cooperation/qzone/LocalMultiProcConfig:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   550: ldc_w 1801
    //   553: aload_0
    //   554: getfield 384	abgu:i	Ljava/lang/String;
    //   557: invokestatic 1797	cooperation/qzone/LocalMultiProcConfig:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   560: ldc_w 1803
    //   563: aload_3
    //   564: invokestatic 1797	cooperation/qzone/LocalMultiProcConfig:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   567: ldc_w 1805
    //   570: aload_0
    //   571: getfield 81	abgu:jdField_d_of_type_Int	I
    //   574: invokestatic 1806	cooperation/qzone/LocalMultiProcConfig:putInt	(Ljava/lang/String;I)V
    //   577: aload_0
    //   578: getfield 223	abgu:jdField_a_of_type_ComTencentBizPubaccountCustomWebView	Lcom/tencent/biz/pubaccount/CustomWebView;
    //   581: ifnull +16 -> 597
    //   584: ldc_w 1808
    //   587: aload_0
    //   588: getfield 223	abgu:jdField_a_of_type_ComTencentBizPubaccountCustomWebView	Lcom/tencent/biz/pubaccount/CustomWebView;
    //   591: invokevirtual 1652	com/tencent/biz/pubaccount/CustomWebView:getUrl	()Ljava/lang/String;
    //   594: invokestatic 1797	cooperation/qzone/LocalMultiProcConfig:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   597: new 513	android/content/Intent
    //   600: dup
    //   601: ldc_w 1810
    //   604: invokespecial 1811	android/content/Intent:<init>	(Ljava/lang/String;)V
    //   607: astore_1
    //   608: aload_0
    //   609: getfield 128	abgu:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   612: ifnull +11 -> 623
    //   615: aload_0
    //   616: getfield 128	abgu:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   619: aload_1
    //   620: invokevirtual 1814	android/app/Activity:sendBroadcast	(Landroid/content/Intent;)V
    //   623: iconst_1
    //   624: ireturn
    //   625: aload_0
    //   626: iconst_2
    //   627: putfield 1815	abgu:jdField_b_of_type_Int	I
    //   630: goto -414 -> 216
    //   633: astore_1
    //   634: getstatic 63	abgu:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   637: iconst_1
    //   638: ldc_w 1817
    //   641: invokestatic 180	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   644: aload_0
    //   645: iconst_m1
    //   646: putfield 79	abgu:jdField_c_of_type_Int	I
    //   649: goto -281 -> 368
    //   652: astore_1
    //   653: getstatic 63	abgu:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   656: iconst_1
    //   657: ldc_w 1819
    ...
    //   667: aload_0
    //   668: aconst_null
    //   669: putfield 1773	abgu:j	Ljava/lang/String;
    //   672: getstatic 63	abgu:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   675: iconst_1
    //   676: ldc_w 1821
    ...
    //   686: aload_0
    //   687: iconst_m1
    //   688: putfield 72	abgu:jdField_a_of_type_Int	I
    //   691: goto -253 -> 438
  ...
  public boolean a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8)
  {
    ...
    if (this.jdField_a_of_type_Bjbs == null)
    {
      paramString7 = (biod)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if ((paramString7 == null) || (!(paramString7 instanceof bitr))) {
        break label456;
      }
    }
    label139:
    ...
    label192:
    label456:
    for (int i1 = ((bitr)paramString7).getTitleBarHeight();; i1 = 0)
    {
      this.jdField_a_of_type_Bjbs = new bjbs(this.jdField_a_of_type_AndroidAppActivity, i1);
      this.jdField_a_of_type_Bjbs.c(2131689482);
      boolean bool;
      ...
      for (;;)
      {
        ...
        String str = String.format(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131695740), new Object[] { paramString2 });
        bhse.a(this.jdField_a_of_type_AndroidAppActivity, 1001, 146, "struct_msg_from_h5", paramString1, paramString5, paramString2, paramString3, str, paramString4, "web", null, null, null, "plugin", null, paramString7, paramString8, "https://url.cn/JS8oE7", paramString6, null);
        int i2 = 0;
  ...
  public void b()
  {
    ...
    this.m = null;
    this.p = null;
    this.jdField_a_of_type_Admy = null;
    this.q = null;
    this.r = null;
    this.s = null;
    this.t = null;
  ...
  public void onClick(View paramView)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentProtofileGetappinfoGetAppInfoProto$GetAppinfoResponse != null) && (this.jdField_a_of_type_ComTencentProtofileGetappinfoGetAppInfoProto$GetAppinfoResponse.androidInfo != null))
    {
      ...
      if (!bhny.a(this.jdField_a_of_type_AndroidAppActivity, ((GetAppInfoProto.AndroidInfo)localObject).packName.get())) {
        break label104;
      }
      bhny.a(this.jdField_a_of_type_AndroidAppActivity, ((GetAppInfoProto.AndroidInfo)localObject).packName.get(), null);
      localObject = "run";
      noe.a(null, "", "webviewsourceclick", bhki.b(this.jdField_a_of_type_Long), 0L, (String)localObject);
    }
    label414:
    for (;;)
    {
      ...
      bjqz.a(this.jdField_a_of_type_AndroidAppActivity, String.valueOf(bhki.b(this.jdField_a_of_type_Long)), 2470, localBundle);
      localObject = "setup";
      break;
      label203:
      if (paramView == this.jdField_b_of_type_AndroidWidgetTextView)
      {
        ...
        {
          bhny.a(this.jdField_a_of_type_AndroidAppActivity, ((GetAppInfoProto.AndroidInfo)localObject).packName.get(), null);
          bjvq.a().a(this.n, String.valueOf(bhki.b(this.jdField_a_of_type_Long)), "ANDROIDQQ.SHAREBAR", "203", false);
        }
        for (;;)
        {
          ...
          localBundle.putBoolean("autoDownload", true);
          localBundle.putString("packageName", ((GetAppInfoProto.AndroidInfo)localObject).packName.get());
          localBundle.putString("appId", String.valueOf(bhki.b(this.jdField_a_of_type_Long)));
          bjqz.b(this.jdField_a_of_type_AndroidAppActivity, localBundle);
          bjvq.a().a(this.n, String.valueOf(bhki.b(this.jdField_a_of_type_Long)), "ANDROIDQQ.SHAREBAR", "202", false);
        }
      }
