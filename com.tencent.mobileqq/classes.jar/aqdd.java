  ...
  implements DialogInterface.OnDismissListener, View.OnClickListener
{
  ...
  bbkh jdField_a_of_type_Bbkh = new aqde(this);
  ...
  public aqdd(@NonNull Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidViewWindowManager$LayoutParams = new WindowManager.LayoutParams(-1, bbkf.a(0), 2, 32, -1);
  ...
  {
    Object localObject = new aqdk(this);
    ...
    if ((paramContext instanceof QQAppInterface))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonMainPanel.setCallBack((anyg)localObject);
  ...
  public aqdd a(String paramString, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.lBtn.setOnClickListener(new aqdl(this, paramOnClickListener));
    return this;
  }
  ...
  public void a(int paramInt)
  {
    if (this.jdField_a_of_type_AndroidWidgetEditText != null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new aqdj(this, paramInt));
    }
  }
  ...
  public aqdd b(String paramString, DialogInterface.OnClickListener paramOnClickListener)
  {
    if (paramOnClickListener == null)
    {
    ...
    this.rBtn.setOnClickListener(new aqdf(this, paramOnClickListener));
    return this;
  }
  
  public void b(int paramInt)
  {
    this.jdField_a_of_type_ComTencentWidgetMaxHeightRelativelayout.setMaxHeight(actj.a(paramInt, getContext().getResources()));
  }
  ...
  public void onClick(View paramView)
  {
    if (paramView.getId() == 2131365560)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonMainPanel.setMinimumHeight(bbkf.a(0));
  ...
  public void setContentView(int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetMaxHeightRelativelayout = ((MaxHeightRelativelayout)findViewById(2131375364));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131378544));
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131368198));
    this.jdField_a_of_type_AndroidViewView = findViewById(2131365142);
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.setOnTouchListener(new aqdg(this));
    ...
    this.jdField_b_of_type_Int = this.jdField_a_of_type_Bbkf.a();
    this.jdField_b_of_type_Int = bbkf.a(this.jdField_b_of_type_Int);
    setOnDismissListener(this);
    a((Context)localObject);
    this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonMainPanel.setDispatchKeyEventListener(new aqdh(this));
    localObject = this.jdField_a_of_type_AndroidViewView.findViewById(2131375652);
    if ((localObject instanceof ScrollView)) {
      this.jdField_a_of_type_AndroidWidgetScrollView = ((ScrollView)localObject);
    }
    this.jdField_a_of_type_AndroidViewView.getViewTreeObserver().addOnGlobalLayoutListener(new aqdi(this));
  }
}
