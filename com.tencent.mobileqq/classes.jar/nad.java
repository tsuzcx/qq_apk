...
public class nad
  extends mxl
{
  public nad(AppInterface paramAppInterface)
  {
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
      ...
      if (bool1)
      {
        ...
        if (i == 0)
        {
          ...
          if (((AvGameRoomManager.CmdRoomInfoRsp)localObject).room_info.has())
          {
            ...
            {
              localRoomInfo = myn.a((AvGameCommon.RoomInfo)((AvGameRoomManager.CmdRoomInfoRsp)localObject).room_info.get());
              localmyo = null;
              localList = null;
              localArrayList = null;
              j = 0;
              ...
              if (bool4)
              {
                localmyo = myn.a((AvGameCommon.GameStatusInfo)((AvGameRoomManager.CmdRoomInfoRsp)localObject).game_status_info.get());
                if ((localmyo == null) || (!localmyo.a())) {
                  break label644;
                }
                bool2 = true;
                localList = myn.a(((AvGameRoomManager.CmdRoomInfoRsp)localObject).game_ranking_info);
                ...
                QLog.d("avgame_logic.GameRoomHandler", 1, String.format("onGetGameRoomInfo game valid=%b game=%s", new Object[] { Boolean.valueOf(bool2), localmyo }));
                bool2 = bool1 & bool2;
              }
              bool3 = bool2;
              if (bool2) {
                mxt.a().b(nam.class, 1, true, new Object[] { Boolean.valueOf(bool4), Long.valueOf(l), str, localRoomInfo, localmyo, localList, localArrayList, Integer.valueOf(j), paramObject, paramFromServiceMsg, Integer.valueOf(k) });
              }
            }
          }
        }
    ...
    for (boolean bool3 = bool2;; bool3 = bool1)
    {
      if (!bool3)
      {
        ...
        mxt.a().b(nam.class, 1, false, new Object[] { Boolean.valueOf(bool4), Long.valueOf(l), str, paramFromServiceMsg, Integer.valueOf(i), Integer.valueOf(k) });
      }
      mys.a(bool3, k);
      return;
      bool1 = false;
  ...
  private void a(List<AvGameList.GameListItemInfo> paramList, List<mzj> paramList1)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      while (paramList.hasNext())
      {
        ...
        if (localGameListItemInfo != null)
        {
          ...
          localmzj.a(localGameListItemInfo);
          paramList1.add(localmzj);
        }
      }
    }
  }
  ...
  private void a(AvGameNotify.NotifyMsg paramNotifyMsg, long paramLong1, long paramLong2)
  {
    ...
    {
      myn.a("avgame_logic.GameRoomHandler", "handlerChangeGamePush()", new String[] { "AvGameNotify.RoomOwnerChangeGameS2CReq" }, new MessageMicro[] { paramNotifyMsg });
      mxt.a().b(nam.class, 24, true, new Object[] { Long.valueOf(paramLong1), Long.valueOf(paramLong2), Integer.valueOf(i) });
      return;
    }
  }
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      if (i != 0)
      {
        ...
        try
        {
          ...
          myn.a("avgame_logic.GameRoomHandler", "onGetGameRoomList()", null, new MessageMicro[] { localCmdGameListRsp });
          if (localCmdGameListRsp.game_list.has())
          {
            ...
            mxt.a().b(nam.class, 2, true, new Object[] { paramObject, Integer.valueOf(i), paramToServiceMsg, paramFromServiceMsg, Long.valueOf(l) });
            if (QLog.isColorLevel()) {
    ...
    mxt.a().b(nam.class, 2, false, new Object[] { Long.valueOf(l) });
  }
  ...
  private void b(AvGameNotify.NotifyMsg paramNotifyMsg, long paramLong1, long paramLong2)
  {
    ...
    {
      RoomInfo localRoomInfo = myn.a((AvGameCommon.RoomInfo)localRoomUserChangeStatusS2CReq.room_info.get());
      myn.a("avgame_logic.GameRoomHandler", "handlerChangeUserStatusPush()", new String[] { "AvGameNotify.RoomUserChangeStatusS2CReq" }, new MessageMicro[] { localRoomUserChangeStatusS2CReq });
      mxt.a().b(nam.class, 23, true, new Object[] { Long.valueOf(paramLong1), Long.valueOf(paramLong2), paramNotifyMsg, Integer.valueOf(i), localRoomInfo });
      return;
      paramNotifyMsg = "";
      break;
    }
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        myn.a("avgame_logic.GameRoomHandler", "onGetQuestionClass()", null, new MessageMicro[] { paramToServiceMsg });
        ...
        if ((i != 0) && (paramObject.res.errcode.get() == 0)) {
          if (paramObject.question_class_title_url.has())
          {
            ...
            localmzk.a(localQuestionClassInfo);
            localArrayList.add(localmzk);
            i += 1;
            continue;
            i = 0;
          }
      ...
      catch (InvalidProtocolBufferMicroException paramFromServiceMsg)
      {
        ...
        paramObject = null;
        continue;
        mxt.a().b(nam.class, 9, true, new Object[] { Long.valueOf(l), null, localArrayList, paramToServiceMsg, paramFromServiceMsg });
        if (QLog.isColorLevel()) {
      ...
      for (paramToServiceMsg = paramObject.res.errmsg.get().toStringUtf8();; paramToServiceMsg = "拉取题库类型失败")
      {
        ...
        mxt.a().b(nam.class, 9, false, new Object[] { Long.valueOf(l), paramToServiceMsg, null, null, null });
        return;
      }
      label514:
      paramObject = null;
  ...
  private void c(AvGameNotify.NotifyMsg paramNotifyMsg, long paramLong1, long paramLong2)
  {
    ...
    myn.a("avgame_logic.GameRoomHandler", "handlerDestroyRoomPush()", new String[] { "AvGameNotify.RoomDestoryS2CReq" }, new MessageMicro[] { paramNotifyMsg });
    mxt.a().b(nam.class, 22, true, new Object[] { Long.valueOf(paramLong1), Long.valueOf(paramLong2) });
  }
      ...
      if (i != 0)
      {
        ...
        try
        {
          ...
          if (i != 0) {
            if (paramFromServiceMsg.res.has())
            {
              ...
              mxt.a().b(nam.class, 6, true, new Object[] { Long.valueOf(l1), Long.valueOf(l2) });
              myn.a("avgame_logic.GameRoomHandler", "onSelectGame()", new String[] { "AvGameCommon.Result -> seq = " + l1 }, new MessageMicro[] { paramToServiceMsg });
              return;
              i = 0;
            }
          }
        ...
        catch (InvalidProtocolBufferMicroException paramToServiceMsg)
        {
          for (;;)
          {
            ...
            continue;
            label239:
            mxt.a().b(nam.class, 6, false, new Object[] { Long.valueOf(l1), Long.valueOf(l2) });
          }
        }
      }
    }
    QLog.e("avgame_logic.GameRoomHandler", 1, "onSelectGame()  failed ");
    mxt.a().b(nam.class, 6, false, new Object[] { Long.valueOf(0L), Long.valueOf(l2) });
  }
  ...
  private void d(AvGameNotify.NotifyMsg paramNotifyMsg, long paramLong1, long paramLong2)
  {
    ...
    {
      RoomInfo localRoomInfo = myn.a((AvGameCommon.RoomInfo)localRoomUserExitS2CReq.room_info.get());
      myn.a("avgame_logic.GameRoomHandler", "handlerExitRoomPush()", new String[] { "AvGameNotify.RoomUserExitS2CReq" }, new MessageMicro[] { localRoomUserExitS2CReq });
      mxt.a().b(nam.class, 21, true, new Object[] { Long.valueOf(paramLong1), Long.valueOf(paramLong2), Integer.valueOf(i), paramNotifyMsg, str1, localRoomInfo, Integer.valueOf(j), Integer.valueOf(k), str2, str3 });
      return;
      i = 0;
      break;
      paramNotifyMsg = "";
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      mxt.a().a(nam.class, 8, false, new Object[] { "", Long.valueOf(l) });
    ...
    mxt.a().a(nam.class, 8, true, new Object[] { paramToServiceMsg, Long.valueOf(l) });
  ...
  private void e(AvGameNotify.NotifyMsg paramNotifyMsg, long paramLong1, long paramLong2)
  {
    ...
    {
      RoomInfo localRoomInfo = myn.a((AvGameCommon.RoomInfo)localRoomUserEnterS2CReq.room_info.get());
      myn.a("avgame_logic.GameRoomHandler", "handlerEnterRoomPush()", new String[] { "AvGameNotify.RoomUserEnterS2CReq" }, new MessageMicro[] { localRoomUserEnterS2CReq });
      mxt.a().b(nam.class, 20, true, new Object[] { Long.valueOf(paramLong1), Long.valueOf(paramLong2), Integer.valueOf(i), paramNotifyMsg, str, localRoomInfo });
      return;
      i = 0;
      break;
      paramNotifyMsg = "";
  ...
  private void f(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((paramToServiceMsg != null) && (paramToServiceMsg.errcode.get() == 0))
        {
          paramToServiceMsg = myn.a((AvGameCommon.RoomInfo)localCmdRoomLeaveRsp.room_info.get());
          mxt.a().a(nam.class, 3, true, new Object[] { Long.valueOf(l), Integer.valueOf(j), paramFromServiceMsg, paramToServiceMsg });
          myn.a("avgame_logic.GameRoomHandler", "onLeaveGameRoom()", null, new MessageMicro[] { localCmdRoomLeaveRsp });
          return;
          i = 0;
        }
      }
    ...
    {
      mxt.a().a(nam.class, 3, false, new Object[] { Long.valueOf(l), Integer.valueOf(j), paramFromServiceMsg, paramToServiceMsg });
      break;
    }
    label292:
    if (QLog.isColorLevel()) {
    ...
    mxt.a().a(nam.class, 3, false, new Object[] { Long.valueOf(l), Integer.valueOf(j), paramFromServiceMsg, "" });
  }
  ...
  private void g(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localCmdRoomChangeUserStatusRsp.res.has())
        {
          ...
          paramToServiceMsg = myn.a((AvGameCommon.RoomInfo)localCmdRoomChangeUserStatusRsp.room_info.get());
          mxt.a().b(nam.class, 4, true, new Object[] { paramToServiceMsg, Integer.valueOf(j) });
          myn.a("avgame_logic.GameRoomHandler", "onChangeUserStatus()", null, new MessageMicro[] { localCmdRoomChangeUserStatusRsp });
          return;
          i = 0;
        }
      }
    ...
    {
      mxt.a().b(nam.class, 4, false, new Object[] { Long.valueOf(l), paramFromServiceMsg, Integer.valueOf(i), Integer.valueOf(j) });
      break;
      paramFromServiceMsg = "";
      break label250;
    }
    ...
    mxt.a().b(nam.class, 4, false, new Object[] { Long.valueOf(l), "", Integer.valueOf(109), Integer.valueOf(j) });
  }
      ...
      try
      {
        ...
        if (bool) {
          if (localGetActivitysRsp.res.has())
          {
            ...
            mxt.a().a(nam.class, 10, bool, new Object[] { Integer.valueOf(i), paramToServiceMsg, paramFromServiceMsg });
            if (QLog.isColorLevel()) {
      ...
      try
      {
        ...
        if (bool) {
          if (localSyncShareGameRsp.res.has())
          {
            ...
            mxt.a().a(nam.class, 11, bool, new Object[] { Integer.valueOf(i), paramToServiceMsg, str, paramFromServiceMsg });
            if (QLog.isColorLevel()) {
  ...
  private void j(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
        ...
        try
        {
          ...
          if (i != 0) {
            if (localCmdUserHeartBeatRsp.res.has())
            {
              ...
              mxt.a().a(nam.class, 5, true, new Object[] { Long.valueOf(l1), Integer.valueOf(i), Long.valueOf(l2), paramFromServiceMsg, Integer.valueOf(j) });
    ...
    mxt.a().a(nam.class, 5, false, new Object[] { "", Long.valueOf(l2), paramFromServiceMsg });
  }
  ...
  public void a(AvGameNotify.NotifyMsg paramNotifyMsg)
  {
    ...
    try
    {
      ...
      QLog.d("avgame_logic.GameRoomHandler", 1, String.format("handleOnlinePush type=%d [%s] seq=%d roomId=%d gameId=%s", new Object[] { Integer.valueOf(i), myn.a(i), Long.valueOf(l1), Long.valueOf(l2), str }));
      switch (i)
      {
      case 1: 
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    } while (!"qqvgame.ActivityCenter-SyncShareGame".equals(str));
