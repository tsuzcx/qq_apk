  ...
  implements Manager
{
  ...
  private aewr jdField_a_of_type_Aewr;
  private aewy jdField_a_of_type_Aewy;
  ...
  private List<aewg> jdField_a_of_type_JavaUtilList;
  private MqqHandler jdField_a_of_type_MqqOsMqqHandler = ThreadManager.getFileThreadHandler();
  private volatile boolean jdField_a_of_type_Boolean;
  private final aexe jdField_b_of_type_Aexe = new aexc(this);
  private File jdField_b_of_type_JavaIoFile;
  private List<aewf> jdField_b_of_type_JavaUtilList = new CopyOnWriteArrayList();
  private boolean jdField_b_of_type_Boolean = true;
  private File c;
  private File d;
  
  public aexb(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Aukp = paramQQAppInterface.getEntityManagerFactory().createEntityManager();
    this.jdField_b_of_type_Boolean = bbkb.D(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin());
    this.jdField_a_of_type_Askf = ((askf)paramQQAppInterface.getManager(14));
    d();
    if (this.jdField_a_of_type_JavaUtilList != null) {
      this.jdField_a_of_type_JavaUtilList.clear();
    }
    a(new aexa(paramQQAppInterface));
    this.jdField_a_of_type_Aewr = new aewr(paramQQAppInterface);
    a(this.jdField_a_of_type_Aewr);
    this.jdField_a_of_type_Aewy = new aewy(paramQQAppInterface);
    a(this.jdField_a_of_type_Aewy);
  }
  ...
  public static aexb a(QQAppInterface paramQQAppInterface)
  {
    return (aexb)paramQQAppInterface.getManager(314);
  }
  ...
  public static File a(String paramString)
  {
    try
    {
      ...
      paramString = new File(aewu.jdField_a_of_type_JavaLangString + paramString);
      return paramString;
    }
  ...
  private List<aewf> a(List<aewf> paramList, StickerRecommendSortEntity paramStickerRecommendSortEntity)
  {
    int i2 = 0;
    int j;
    int m;
    ...
    if (paramStickerRecommendSortEntity != null)
    {
      try
      {
        ...
        arrayOfaewf[i] = ((aewf)paramList.get(i1));
        i += 1;
      }
      ...
      if (n < m)
      {
        ...
        arrayOfaewf[i] = ((aewf)paramList.get(j));
        i += 1;
        break label461;
      }
    }
    for (;;)
    {
      if (i1 < k)
      {
        ...
        if ((i < i3) && (j < i3))
        {
          arrayOfaewf[j] = ((aewf)paramList.get(i));
          i = j + 1;
          break label470;
        }
      }
      ...
      {
        paramList = Arrays.asList(arrayOfaewf);
        return paramList;
        return null;
      }
      i = j;
  ...
  private void a(String paramString1, String paramString2, int paramInt, String paramString3)
  {
    ...
    for (boolean bool = true;; bool = false) {
      for (;;)
      {
        ...
        ((ayrx)localObject).jdField_a_of_type_Aysc = new aexd(this, paramString2, bool, paramString3);
        ((ayrx)localObject).jdField_a_of_type_JavaLangString = paramString1;
        ((ayrx)localObject).jdField_a_of_type_Int = 0;
        ((ayrx)localObject).jdField_c_of_type_JavaLangString = this.d.getAbsolutePath();
        ...
        try
        {
          ...
          ((QQAppInterface)paramString2).getNetEngine(0).a((aysy)localObject);
          if (!QLog.isColorLevel()) {
            break;
          }
  ...
  private void a(boolean paramBoolean, long paramLong)
  {
    ...
    for (String str = "1";; str = "0")
    {
      ...
      axrn.a(BaseApplication.getContext()).a(null, "StickerRecInitCost", paramBoolean, 0L, 0L, localHashMap, "");
      return;
    }
  }
  ...
  private void a(boolean paramBoolean, String paramString)
  {
    ...
    if ((paramBoolean) && (this.jdField_a_of_type_JavaUtilList != null))
    {
      ...
      {
        Object localObject = (aewg)localIterator.next();
        if (((aewg)localObject).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString))
        {
          localObject = ((aewg)localObject).a(paramString);
          if ((localObject != null) && (!((List)localObject).isEmpty())) {
            localArrayList.addAll((Collection)localObject);
          }
        }
      }
      paramString = aewh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localArrayList);
      ...
      while (paramString.hasNext()) {
        ((aewf)paramString.next()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      if (QLog.isColorLevel()) {
  ...
  private void a(byte[] paramArrayOfByte)
  {
    try
    {
      ...
      else
      {
        ...
        localObject = bbkb.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "words_version_key805_gray_one", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
    ...
    catch (Exception paramArrayOfByte)
    {
      ...
      if (QLog.isColorLevel())
      {
        QLog.d("StickerRecManager", 2, bfnu.a(paramArrayOfByte));
        return;
        if (QLog.isColorLevel()) {
  ...
  private void a(byte[] paramArrayOfByte, String paramString1, String paramString2, boolean paramBoolean, StickerRecommendSortEntity paramStickerRecommendSortEntity)
  {
    ...
    while (i < localList.size())
    {
      ...
      aewv localaewv = new aewv();
      localaewv.e(i);
      localaewv.a(localImgInfo.uint64_img_size.get());
      localaewv.a(localImgInfo.uint32_img_width.get());
      localaewv.b(localImgInfo.uint32_img_height.get());
      localaewv.d(localImgInfo.bytes_img_md5.get().toStringUtf8());
      localaewv.b(localImgInfo.bytes_img_down_url.get().toStringUtf8());
      localaewv.b(localImgInfo.uint64_thumb_size.get());
      localaewv.d(localImgInfo.uint32_thumb_img_height.get());
      localaewv.c(localImgInfo.uint32_thumb_img_width.get());
      localaewv.c(localImgInfo.bytes_thumb_down_url.get().toStringUtf8());
      localaewv.e(localImgInfo.bytes_thumb_img_md5.get().toStringUtf8());
      localaewv.f(localImgInfo.uint32_src_type.get());
      localaewv.f(localImgInfo.bytes_src_desc.get().toStringUtf8());
      localaewv.g(localImgInfo.bytes_web_url.get().toStringUtf8());
      localaewv.h("");
      localaewv.i(localImgInfo.bytes_pack_name.get().toStringUtf8());
      localaewv.g(localImgInfo.uint32_pack_id.get());
      paramArrayOfByte.add(localaewv);
      i += 1;
    }
    ...
    for (paramArrayOfByte = localRspBody.bytes_rsp_other.get().toStringUtf8();; paramArrayOfByte = "999")
    {
      if (paramBoolean)
      {
        this.jdField_b_of_type_Aexe.a(paramStickerRecommendSortEntity, paramString1, paramArrayOfByte);
        return;
      }
      if (this.jdField_a_of_type_Aexe != null)
      {
        this.jdField_a_of_type_Aexe.a(paramStickerRecommendSortEntity, paramString1, paramArrayOfByte);
        return;
        break;
      }
      return;
  ...
  public static boolean a(aewf paramaewf)
  {
    return paramaewf.a();
  }
  ...
  private boolean a(File paramFile1, File paramFile2)
  {
    ...
    try
    {
      ...
      nav.a(paramFile1, localFile.getAbsolutePath() + File.separator);
  ...
  private boolean a(File paramFile, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        paramFile = bbdx.c(paramFile.getPath());
  ...
  public static boolean b(aewf paramaewf)
  {
    return !a(paramaewf);
  }
  ...
  public static String d(String paramString)
  {
    ...
    {
      paramString = Utils.Crc64String(paramString);
      paramString = aewu.jdField_a_of_type_JavaLangString + paramString;
      return paramString;
    }
    catch (Exception paramString)
    {
  ...
  {
    Object localObject = new File(aewu.jdField_a_of_type_JavaLangString);
  ...
  private void i()
  {
    axrn.a(BaseApplication.getContext()).a(null, "StickerRecEmptyImg", false, 0L, 0L, null, "");
  }
  ...
  {
    return aylc.a(aylc.i(bbkk.c(paramString).toLowerCase()));
  }
  ...
  public void a()
  {
    ...
    try
    {
      ...
      try
      {
        if (bbdx.a(this.c.getAbsolutePath())) {
          break label116;
        }
    ...
    if (QLog.isColorLevel())
    {
      QLog.d("StickerRecManager", 2, bfnu.a(localException1));
    ...
    l2 = bbkb.o(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
    if ((!bbdx.a(this.jdField_b_of_type_JavaIoFile.getAbsolutePath())) || ((l2 != 0L) && (System.currentTimeMillis() - l2 >= 86400000L)))
    {
      bbkb.m(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), 0L);
      localObject1 = new HashSet();
      localObject2 = this.jdField_a_of_type_Askf.b();
      localList = this.jdField_a_of_type_Askf.jdField_a_of_type_JavaUtilList;
      ...
      {
        apvd.c(this.jdField_b_of_type_JavaIoFile.getAbsolutePath());
    ...
    for (;;)
    {
      ...
      if (localObject1 != null) {
        this.jdField_a_of_type_ComTencentMobileqqDataCard = ((ajxl)localObject1).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      }
  ...
  public void a(aewg paramaewg)
  {
    ...
    } while (this.jdField_a_of_type_JavaUtilList.contains(paramaewg));
    this.jdField_a_of_type_JavaUtilList.add(paramaewg);
  }
  
  public void a(aexe paramaexe)
  {
    this.jdField_a_of_type_Aexe = paramaexe;
  }
  ...
  public void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        bbmx.a((byte[])localObject, 0, paramFromServiceMsg.getWupBuffer(), 4, i);
        ...
        QLog.d("StickerRecManager", 2, bfnu.a(paramIntent));
        continue;
      }
      finally {}
      label122:
      ...
      {
        ((aknu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(285)).a(paramFromServiceMsg);
        continue;
  ...
  public void a(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 65	aexb:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   6: astore 5
    //   8: aload 5
    //   10: ifnonnull +6 -> 16
    //   13: aload_0
    ...
    //   59: astore 7
    //   61: aload_0
    //   62: getfield 65	aexb:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   65: invokevirtual 83	com/tencent/mobileqq/app/QQAppInterface:getApp	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   68: invokestatic 1132	aney:a	(Landroid/content/Context;)Ljava/lang/String;
    //   71: astore 8
    ...
    //   275: dup
    //   276: aload_0
    //   277: getfield 65	aexb:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   312: pop
    //   313: aload_0
    //   314: getfield 65	aexb:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   317: aload 5
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqDataCard != null)
        {
          ...
          localObject2 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), aexg.class);
  ...
  public void a(List<aexh> paramList, boolean paramBoolean, int paramInt, String paramString)
  {
    ...
    while (localIterator.hasNext())
    {
      localObject2 = (aexh)localIterator.next();
      if (localObject2 != null)
      {
        str1 = ((aexh)localObject2).jdField_a_of_type_JavaLangString;
        localObject1 = ((aexh)localObject2).jdField_a_of_type_JavaUtilList;
        ...
        {
          localObject1 = (aewf)((Iterator)localObject5).next();
          if (((aewf)localObject1).b() != null)
          {
            String str2 = ((aewf)localObject1).c();
            if (!TextUtils.isEmpty(str2)) {
              ((StringBuilder)localObject4).append(str2);
            }
            ((StringBuilder)localObject4).append(((aewf)localObject1).b());
            ((StringBuilder)localObject4).append(";");
            if (((aewf)localObject1).a() != null)
            {
              ((StringBuilder)localObject3).append(((aewf)localObject1).a());
              ((StringBuilder)localObject3).append(";");
            }
            if (!((aewf)localObject1).b()) {
              break label599;
            }
            paramList = (List<aexh>)localObject1;
          }
        }
      }
    }
    ...
    for (;;)
    {
      ...
      localObject3 = new aexf();
      ((aexf)localObject3).l = "dc04577";
      ((aexf)localObject3).jdField_b_of_type_JavaLangString = str1;
      ((aexf)localObject3).k = ((aexh)localObject2).jdField_b_of_type_JavaLangString;
      ((aexf)localObject3).jdField_c_of_type_JavaLangString = String.valueOf(AppSetting.a());
      ((aexf)localObject3).jdField_a_of_type_JavaLangString = String.valueOf(Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).longValue());
      if (paramList != null)
      {
        ...
        ((aexf)localObject3).f = ((String)localObject1);
        ((aexf)localObject3).g = paramList.a();
      }
      ((aexf)localObject3).d = ((String)localObject4);
      ((aexf)localObject3).e = ((String)localObject5);
      if (paramBoolean)
      {
        if (paramInt != 0) {
          break label536;
        }
        ((aexf)localObject3).h = "c2c";
      }
      for (;;)
      {
        ((aexf)localObject3).j = paramString;
        ((aexf)localObject3).i = "android";
        paramList = ((aexf)localObject3).a();
        localObject1 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), aexg.class);
        ((NewIntent)localObject1).putExtra("key_cmd", "MQInference.CommonReport");
        ((NewIntent)localObject1).putExtra("key_body", bbma.a(paramList.toString().getBytes()));
        if (QLog.isColorLevel())
        {
          ((aexf)localObject3).jdField_b_of_type_JavaLangString = c(((aexf)localObject3).jdField_b_of_type_JavaLangString);
          QLog.d("StickerRecManager", 2, "report content:" + ((aexf)localObject3).a().toString());
        }
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.startServlet((NewIntent)localObject1);
        break label22;
        break;
        if (paramInt == 1) {
          ((aexf)localObject3).h = "group";
        } else if (paramInt == 3000) {
          ((aexf)localObject3).h = "discuss";
        } else if (paramInt == 11000) {
          ((aexf)localObject3).h = "qzone";
        } else {
          ((aexf)localObject3).h = "other";
        }
      }
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    bbkb.u(BaseApplication.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), paramBoolean);
  }
  ...
  public boolean a(String paramString1, int paramInt, String paramString2, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    try
    {
      ...
      if (!bool)
      {
        ...
        if ((!paramBoolean2) || (this.jdField_a_of_type_Aexe == null)) {
          break label251;
        }
    ...
    catch (Exception paramString1)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("StickerRecManager", 2, bfnu.a(paramString1));
        }
      }
    }
    return true;
  ...
  {
    return aylc.a(aylc.i(bbkk.c(paramString)));
  }
  ...
  public Collection<String> b()
  {
    ...
    Object localObject1 = ((answ)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(149)).a();
    if (localObject1 != null)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if (("isUpdate".equals(((CustomEmotionData)localObject2).RomaingType)) || ("needDownload".equals(((CustomEmotionData)localObject2).RomaingType)) || ("overflow".equals(((CustomEmotionData)localObject2).RomaingType)) || ("overflow_downloaded".equals(((CustomEmotionData)localObject2).RomaingType))) {
          ...
          {
            localObject2 = localaskf.a(((CustomEmotionData)localObject2).emoPath, ((CustomEmotionData)localObject2).eId);
  ...
  public void b(List<aexh> paramList)
  {
    paramList = new ArrayList(paramList).iterator();
    while (paramList.hasNext())
    {
      Object localObject1 = (aexh)paramList.next();
      if (localObject1 != null)
      {
        Object localObject2 = ((aexh)localObject1).jdField_a_of_type_JavaLangString;
        StickerRecommendSortEntity localStickerRecommendSortEntity = (StickerRecommendSortEntity)this.jdField_a_of_type_Aukp.a(StickerRecommendSortEntity.class, "usrMessage=?", new String[] { localObject2 });
        Object localObject3;
        if (localStickerRecommendSortEntity != null)
        {
          localStickerRecommendSortEntity.convertToList();
          localObject1 = ((aexh)localObject1).jdField_a_of_type_JavaUtilList.iterator();
          while (((Iterator)localObject1).hasNext())
          {
            localObject2 = (aewf)((Iterator)localObject1).next();
            if (!((aewf)localObject2).a())
            {
              localObject2 = (aewv)localObject2;
              localObject3 = Integer.valueOf(((aewv)localObject2).d());
              if (((aewv)localObject2).b())
              {
          ...
          this.jdField_a_of_type_Aukp.a(localStickerRecommendSortEntity);
        }
        else
        {
          localStickerRecommendSortEntity = new StickerRecommendSortEntity((String)localObject2);
          localObject2 = ((aexh)localObject1).jdField_a_of_type_JavaUtilList.iterator();
          while (((Iterator)localObject2).hasNext())
          {
            localObject3 = (aewf)((Iterator)localObject2).next();
            if (!((aewf)localObject3).a())
            {
              localObject3 = (aewv)localObject3;
              if (((aewv)localObject3).b()) {
                localStickerRecommendSortEntity.addClicked(Integer.valueOf(((aewv)localObject3).d()));
              } else {
                localStickerRecommendSortEntity.addExposed(Integer.valueOf(((aewv)localObject3).d()));
              }
            }
          }
          localObject1 = ((aexh)localObject1).jdField_b_of_type_JavaUtilList.iterator();
          while (((Iterator)localObject1).hasNext())
          {
            localObject2 = (aewf)((Iterator)localObject1).next();
            if (!((aewf)localObject2).a()) {
              localStickerRecommendSortEntity.addNoExpose(Integer.valueOf(((aewv)localObject2).d()));
            }
          }
          if ((localStickerRecommendSortEntity.noExposeList != null) && (localStickerRecommendSortEntity.noExposeList.size() == 0))
          {
          ...
          this.jdField_a_of_type_Aukp.b(localStickerRecommendSortEntity);
        }
      }
    }
  }
  ...
  public void g()
  {
    if (this.jdField_a_of_type_Aewr == null) {
      return;
    }
    this.jdField_a_of_type_Aewr.a();
  }
  
  public void h()
  {
    if (this.jdField_a_of_type_Aewy == null) {
      return;
    }
    this.jdField_a_of_type_Aewy.a();
  }
