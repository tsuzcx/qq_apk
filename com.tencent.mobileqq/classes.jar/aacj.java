  ...
  extends aabm
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = "DoraemonOpenAPI." + aacj.class.getSimpleName();
  }
  ...
  private void a(JSONObject paramJSONObject, aabi paramaabi)
  {
    ...
    if (i <= 0)
    {
      aaep.a(paramaabi, -100, "rankingID must be bigger than 0");
      return;
    }
    Object localObject = (aacs)this.jdField_a_of_type_Aabl.a(aacs.class, false);
    if (localObject == null)
    {
      aaep.a(paramaabi, -10, "internal error, try again.");
      return;
    }
    Oidb_0xb85.ReqBody localReqBody = new Oidb_0xb85.ReqBody();
    localObject = ((aacs)localObject).a();
    localReqBody.appid.set(Integer.valueOf(this.jdField_a_of_type_Aabl.jdField_a_of_type_JavaLangString).intValue());
    localReqBody.service_id.set(this.jdField_a_of_type_Aabl.jdField_a_of_type_Int);
    localReqBody.openid.set(((aacv)localObject).jdField_a_of_type_JavaLangString);
    localReqBody.openkey.set(((aacv)localObject).b);
    ...
    mxf.a(BaseApplicationImpl.getApplication().getRuntime(), new aack(this, (aacv)localObject, paramJSONObject, paramaabi), localReqBody.toByteArray(), "OidbSvc.0xb85", 2949, 2, null, 0L);
  }
  ...
  private void b(JSONObject paramJSONObject, aabi paramaabi)
  {
    ...
    if (i <= 0)
    {
      aaep.a(paramaabi, -100, "rankingID 没有传或者值小于等于0");
      return;
    }
    Object localObject1 = (aacs)this.jdField_a_of_type_Aabl.a(aacs.class, false);
    Oidb_0xb85.ReqBody localReqBody = new Oidb_0xb85.ReqBody();
    localObject1 = ((aacs)localObject1).a();
    localReqBody.appid.set(Integer.valueOf(this.jdField_a_of_type_Aabl.jdField_a_of_type_JavaLangString).intValue());
    localReqBody.service_id.set(this.jdField_a_of_type_Aabl.jdField_a_of_type_Int);
    localReqBody.openid.set(((aacv)localObject1).jdField_a_of_type_JavaLangString);
    localReqBody.openkey.set(((aacv)localObject1).b);
    ...
    {
      aaep.a(paramaabi, -101, "参数处理错误, 是否是类型不对? 查看一下文档吧. \nerrorMsg: " + paramJSONObject.getMessage());
      return;
    }
    mxf.a(BaseApplicationImpl.getApplication().getRuntime(), new aacl(this, (aacv)localObject1, paramJSONObject, paramaabi), localReqBody.toByteArray(), "OidbSvc.0xb85", 2949, 1, null, 0L);
  }
