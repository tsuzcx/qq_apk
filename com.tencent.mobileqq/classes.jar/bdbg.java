...
public final class bdbg
{
  ...
  static
  {
    ...
    jdField_b_of_type_JavaLangString = aljq.aX + "avatarPendantIcons";
  ...
  public static String a(File paramFile)
  {
    ...
    try
    {
      paramFile = new String(bdcs.a(paramFile));
  ...
  {
    return aljq.bQ + "font_info/" + paramString + File.separator + paramString + ".ttf";
  }
  
  public static void a()
  {
    File localFile = new File(aljq.aX + "avatarPendantDefaultHead");
    if (!localFile.exists()) {
      localFile.mkdir();
    }
    localFile = new File(aljq.bQ);
    if (!localFile.exists()) {
      localFile.mkdir();
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, asot paramasot)
  {
    if ((paramContext == null) || (TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2))) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      paramQQAppInterface.a(-1, new bdbh(paramasot));
      return;
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, boolean paramBoolean, ProfileActivity.AllInOne paramAllInOne)
  {
    ...
    if (paramAllInOne != null)
    {
      ...
      aywz localaywz = (aywz)paramQQAppInterface.getManager(12);
      i = localaywz.a("100005.100006");
      if ((i == 1) || (i == 0))
      {
        if (QLog.isColorLevel()) {
        ...
        localaxho = (axho)paramQQAppInterface.getManager(36);
        localaxho.b("100005.100006");
        if (localaywz.a("100005.100003") == -1) {
          break label445;
        }
        j = 1;
        if (localaywz.a("100005.100002") == -1) {
          break label451;
        }
        k = 1;
        if (localaywz.a("100005.100001") == -1) {
          break label457;
        }
        m = 1;
        if (localaywz.a("100005.100018") == -1) {
          break label463;
        }
        n = 1;
        if (localaywz.a("100005.100020") == -1) {
          break label469;
        }
        i1 = 1;
        if (localaywz.a("100005.100021") == -1) {
          break label475;
        }
        i2 = 1;
        label202:
        if (!((fx)paramQQAppInterface.getManager(42)).jdField_a_of_type_Boolean) {
          break label495;
        }
        if (localaywz.a("100005.100011") == -1) {
          break label481;
        }
        i = 1;
      }
    ...
    for (;;)
    {
      ...
      if (paramAllInOne == null)
      {
        ...
        localIntent.putExtra("url", bdox.a(paramContext, "pendant", ""));
      ...
      for (i = 40202;; i = 40201)
      {
        ...
        azmj.b(paramQQAppInterface, "CliOper", "", "", "PendantMarket", "OtherEntrance", 0, 0, "", "", "", "");
        return;
  ...
  {
    ((bdpx)paramQQAppInterface.a(71)).a(new String[] { paramString }, new int[] { 27235 });
  }
  ...
  public static String b(long paramLong, int paramInt)
  {
    ...
    localStringBuilder.append(aljq.bQ).append(paramLong).append(File.separator);
    switch (paramInt)
    {
    }
    for (;;)
  ...
  {
    return aljq.bQ + "font_info/" + paramString + "/";
  }
  ...
  public static boolean b(String paramString)
  {
    ...
    return new File(aljq.bQ + "sticker_info", paramString).exists();
  }
  ...
  public static String c(long paramLong, int paramInt)
  {
    ...
    for (;;)
    {
      return apih.a("VIP_avatar", localStringBuilder.toString());
      localStringBuilder.append("aio_50.png");
      continue;
      localStringBuilder.append("aio_file.zip");
      continue;
  ...
  {
    return aljq.bQ + "sticker_info/" + paramString + ".png";
  }
}
