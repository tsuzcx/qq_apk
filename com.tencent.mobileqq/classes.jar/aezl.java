...
public class aezl
  extends beej
  implements beha, beht, belp, belt
{
  private aezi a;
  protected zfy a;
  
  public aezl(Context paramContext, Activity paramActivity, AppInterface paramAppInterface)
  {
    super(paramContext, paramActivity, paramAppInterface);
    super.preInitPluginEngine();
    this.mWebview = new TouchWebView(paramContext);
    buildBaseWebView(this.mInterface);
    this.jdField_a_of_type_Aezi = new aezi(paramActivity, this.mWebview);
  }
  ...
  protected zfy b()
  {
    ...
    {
      this.jdField_a_of_type_Zfy = new zfy(this.mInterface, this.mInActivity);
      this.jdField_a_of_type_Zfy.a(this);
    }
  ...
  public void c()
  {
    this.jdField_a_of_type_Aezi.a(b());
  }
