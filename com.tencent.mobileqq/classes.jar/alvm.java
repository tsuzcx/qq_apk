...
public class alvm
  ...
  implements alvl
{
  private static volatile alvm a;
  ...
  {
    QLog.d("DanmuDataIPCServer", 1, "notifyDanmuSendResult, isBarrageMsg:");
    ...
    for (;;)
    {
      paramSpannableString = (QQAppInterface)bhfc.a();
      paramString1 = new DanmuItemBean(Long.parseLong(paramSpannableString.c()), 0L, paramLong1, paramLong2, paramString1, paramSpannableString.getCurrentNickname());
      paramString1.jdField_a_of_type_Boolean = mnf.a().a(paramString2);
      if (paramString1.jdField_a_of_type_Boolean)
      {
        if (QLog.isColorLevel()) {
          QLog.d("DanmuDataIPCServer", 2, "notifyDanmuSendResult, anonymousFlag true");
        }
        paramSpannableString = mnf.a().a(paramString2);
  ...
  public void a(alvf paramalvf, boolean paramBoolean1, boolean paramBoolean2, int paramInt, ArrayList<DanmuItemBean> paramArrayList, List<Long> paramList)
  {
    ...
    localBundle.putLong("key_barrage_msg_seq", paramalvf.jdField_a_of_type_Long);
    localBundle.putLong("key_barrage_grp_uin", paramalvf.b);
    localBundle.putInt("key_barrage_topic_type", paramalvf.jdField_a_of_type_Int);
    localBundle.putInt("key_barrage_interval_time", paramInt);
    localBundle.putBoolean("key_barrage_is_success", paramBoolean1);
    if (paramalvf.c > 0L)
    {
      localBundle.putLong("key_barrage_req_time", paramalvf.c);
      localBundle.putLong("key_barrage_net_req_time", paramalvf.d);
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if ("qipc_action_get_barrage".equals(paramString))
    {
      ...
      localObject = alvg.a().a(alvg.a().a(l2, l1));
      if ((localObject != null) && (!((alvh)localObject).jdField_a_of_type_Boolean))
      {
    ...
    label261:
    for (Object localObject = new alvf(l2, l1, i, bool);; localObject = ((alvh)localObject).jdField_a_of_type_Alvf)
    {
      ((alvf)localObject).c = paramBundle.getLong("key_barrage_req_time");
      ((alvf)localObject).d = System.currentTimeMillis();
      ((alvf)localObject).jdField_a_of_type_Boolean = bool;
      alvg.a().a((alvf)localObject, this);
