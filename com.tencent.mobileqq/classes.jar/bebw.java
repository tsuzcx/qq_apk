...
public class bebw
{
  ...
  public bebw(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    a();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Bebi);
  }
  
  private AbsStructMsg a(Context paramContext, String paramString)
  {
    String str3 = aunj.a(paramString);
    String str1 = auog.a(paramString);
    if (becb.jdField_a_of_type_JavaLangString.indexOf(str1) < 0)
    {
      QLog.e("TeamWorkSender", 1, paramString + " is not docs support file");
      return null;
    }
    if (".doc|.docx".contains(str1)) {
      paramString = anzj.a(2131713595);
    }
    for (str1 = "https://pub.idqqimg.com/pc/misc/files/20180403/29c998e16c094b10a96b3e0d1589c2f6.png";; str1 = "https://pub.idqqimg.com/pc/misc/files/20180403/da40f07bd79e4796b712b44023911be0.png")
    {
      ...
      localIntent.putExtra("app_name", anzj.a(2131713614));
      localIntent.putExtra("brief_key", paramContext.getString(2131695740, new Object[] { str2 }));
      return bdow.a(localIntent.getExtras());
      paramString = anzj.a(2131713591);
    }
  }
  ...
  private TeamWorkFileImportInfo a(String paramString)
  {
    ...
    localTeamWorkFileImportInfo.jdField_b_of_type_JavaLangString = aunj.a(paramString);
    localTeamWorkFileImportInfo.jdField_e_of_type_Int = aunj.a(paramString);
    localTeamWorkFileImportInfo.jdField_b_of_type_Boolean = false;
    localTeamWorkFileImportInfo.jdField_d_of_type_Int = 4;
    localTeamWorkFileImportInfo.jdField_d_of_type_Long = aunj.a(paramString);
  ...
  private String a(int paramInt)
  {
    ...
    case -104: 
    default: 
      return anzj.a(2131713569);
    case -102: 
    case -101: 
    case -100: 
      return anzj.a(2131713559);
    case -103: 
      return anzj.a(2131713589);
    case -116: 
    case -106: 
      return anzj.a(2131713587);
    case -107: 
      return anzj.a(2131713551);
    case -108: 
      return anzj.a(2131713603);
    case -110: 
      return anzj.a(2131713590);
    case -111: 
      return anzj.a(2131713572);
    case -115: 
    case -113: 
    case -112: 
      return anzj.a(2131713556);
    }
    return anzj.a(2131713612);
  }
  
  private void a()
  {
    this.jdField_a_of_type_Bebi = new bebx(this);
  }
  ...
  private void a(AbsStructMsg paramAbsStructMsg, TeamWorkFileImportInfo paramTeamWorkFileImportInfo, String paramString, int paramInt)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqDataMessageForStructing = bcry.a(localQQAppInterface, str2, paramString, str1, paramInt, l, paramAbsStructMsg);
      ...
      paramAbsStructMsg = (beav)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(120);
  ...
  {
    paramString2 = aunj.a(paramString1);
  ...
  public boolean a(MessageForStructing paramMessageForStructing, SessionInfo paramSessionInfo)
  {
    ...
    beav localbeav = (beav)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(120);
    if (!TextUtils.isEmpty(localbeav.a(paramSessionInfo))) {
      localbeav.a(paramSessionInfo);
    }
    if (!localbeav.a(paramSessionInfo)) {
      localbeav.a(paramSessionInfo);
    }
