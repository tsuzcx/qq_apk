...
public abstract class appz
{
  int jdField_a_of_type_Int;
  appw jdField_a_of_type_Appw;
  appy jdField_a_of_type_Appy;
  public String a;
  List<appw> jdField_a_of_type_JavaUtilList;
  boolean jdField_a_of_type_Boolean;
  int jdField_b_of_type_Int;
  appw jdField_b_of_type_Appw;
  boolean jdField_b_of_type_Boolean;
  int jdField_c_of_type_Int;
  appw jdField_c_of_type_Appw;
  boolean jdField_c_of_type_Boolean;
  int jdField_d_of_type_Int;
  appw jdField_d_of_type_Appw;
  boolean jdField_d_of_type_Boolean;
  appw jdField_e_of_type_Appw;
  boolean jdField_e_of_type_Boolean;
  appw jdField_f_of_type_Appw;
  ...
  public appw a(int paramInt)
  {
    paramInt = a(paramInt);
    if (paramInt == -1) {
      return this.jdField_a_of_type_Appw;
    }
    if (paramInt == -2) {
      return this.jdField_c_of_type_Appw;
    }
    if (paramInt == -3) {
      return this.jdField_b_of_type_Appw;
    }
    if (paramInt == -4) {
      return this.jdField_d_of_type_Appw;
    }
    if (paramInt == -5) {
      return this.jdField_e_of_type_Appw;
    }
    if (paramInt == -6) {
      return this.jdField_f_of_type_Appw;
    }
    if ((this.jdField_a_of_type_JavaUtilList != null) && (paramInt < this.jdField_a_of_type_JavaUtilList.size())) {
      return (appw)this.jdField_a_of_type_JavaUtilList.get(paramInt);
    }
    return null;
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_Appy.a(paramInt1, paramInt2);
  }
