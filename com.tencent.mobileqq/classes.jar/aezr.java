  ...
  extends aezn
{
  ...
  private aezu jdField_a_of_type_Aezu = new aezu(this, null);
  public Calendar a;
  Context b;
  public Calendar b;
  
  public aezr(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner, BaseChatPie paramBaseChatPie, aezt paramaezt)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    View localView = ((aezx)localObject).a(paramInt, this.jdField_a_of_type_JavaUtilList.size(), localChatMessage, paramView, paramViewGroup, this.jdField_a_of_type_Aezu);
    if (localView != null) {
    ...
    for (;;)
    {
      ...
      else if (localChatMessage.msgtype == -2039)
      {
        ...
        else if ((localObject instanceof afuq))
        {
          ((afuq)localObject).a(false);
        }
      }
