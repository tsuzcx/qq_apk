...
public class svv
{
  ...
  public static int a(String paramString, Map<Long, rcz> paramMap)
  {
    if ((paramMap != null) && (!TextUtils.isEmpty(paramString)) && (TextUtils.isDigitsOnly(paramString)))
    {
      paramString = (rcz)paramMap.get(Long.valueOf(paramString));
      if (paramString != null)
      {
        if (paramString.a()) {
          return 1;
  ...
  {
    return String.valueOf(((Float)bkwm.a("readinjoy_font_size_ratio_sp", Float.valueOf(1.0F))).floatValue());
  }
  ...
  public static void a(Context paramContext, ArticleInfo paramArticleInfo, String paramString, FastWebArticleInfo paramFastWebArticleInfo, boolean paramBoolean)
  {
    ...
    String str = uhv.a(paramArticleInfo, paa.k + bfuc.encodeToString(String.valueOf(paramString).getBytes(), 2), uhv.d);
    ...
    {
      pay.a(paramContext, localReadInJoyUserInfo.getLiveUrl());
      ozw.a(paramString, "live_circle_from_page", Integer.valueOf(1));
      paramContext = "0X800B17E";
      swy.a(paramArticleInfo, "", paramString.toString());
      swy.a(paramArticleInfo, paramContext, paramString.toString());
      return;
    }
    ...
    for (;;)
    {
      ozw.a(paramString, "is_intensify", Integer.valueOf(i));
  ...
  public static void a(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, long paramLong, String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        uhv.a(paramArticleInfo, uhv.d, paramBoolean);
        Object localObject = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
        pwu localpwu = pkm.a().a();
        localObject = ((QQAppInterface)localObject).getAccount();
        paramFastWebArticleInfo = new svw(paramArticleInfo, paramFastWebArticleInfo, paramBoolean);
        if (pgb.g(paramArticleInfo))
        {
          i = 2;
          localpwu.a((String)localObject, paramLong, true, paramString, paramFastWebArticleInfo, i);
          return;
        }
      }
  ...
  private static JSONObject b(Context paramContext, ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, long paramLong)
  {
    ...
    for (paramFastWebArticleInfo = "2";; paramFastWebArticleInfo = "1") {
      return pay.a(paramContext, paramArticleInfo, i, paramFastWebArticleInfo);
    }
  }
}
