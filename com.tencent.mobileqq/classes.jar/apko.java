...
public class apko
{
  private Handler jdField_a_of_type_AndroidOsHandler = new apkp(this);
  private apkq jdField_a_of_type_Apkq;
  private apkr jdField_a_of_type_Apkr = new apkr();
  ...
  public apko()
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Apkr.a((aplh)localObject);
      return;
  ...
  public boolean a()
  {
    if (BaseApplicationImpl.sProcessId == 1) {
      return this.jdField_a_of_type_Apkr.c();
    }
    return aplo.a().c();
  }
  ...
  {
    return aplo.a().a(paramInt, paramString);
  }
  
  public void b(int paramInt1, String paramString, int paramInt2)
  {
    boolean bool = apkr.b(paramInt1, paramString, paramInt2);
  ...
  {
    Bundle localBundle = apkr.a(paramInt, paramString, paramBoolean);
    if (localBundle == null) {
      return;
    }
  ...
  public void b(ColorNote paramColorNote)
  {
    ...
    for (boolean bool2 = apkr.a((String)localObject, "mMainTitle", paramColorNote.mMainTitle);; bool2 = true)
    {
      boolean bool1 = bool2;
      if (paramColorNote.mSubTitle != null) {
        bool1 = bool2 & apkr.a((String)localObject, "mSubTitle", paramColorNote.mSubTitle);
      }
      bool2 = bool1;
      if (paramColorNote.mPicUrl != null) {
        bool2 = bool1 & apkr.a((String)localObject, "mPicUrl", paramColorNote.mPicUrl);
      }
      bool1 = bool2;
      if (paramColorNote.mReserve != null) {
        bool1 = bool2 & apkr.a((String)localObject, "mReserve", paramColorNote.mReserve, 1);
      }
