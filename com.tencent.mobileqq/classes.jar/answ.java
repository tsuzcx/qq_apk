...
public class answ
  extends anqr<CustomEmotionData>
{
  private boolean a;
  
  public answ(QQAppInterface paramQQAppInterface)
  {
  ...
  private CustomEmotionData a(String paramString1, String paramString2, String paramString3, int paramInt, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          localante = new ante(paramString1);
          localObject = localCustomEmotionData;
        } while (TextUtils.isEmpty(localante.jdField_a_of_type_JavaLangString));
        str2 = localante.jdField_c_of_type_JavaLangString;
        localObject = localCustomEmotionData;
      } while (str2 == null);
      localObject = localCustomEmotionData;
    } while ("".equals(str2));
    ...
    if (str2.equals("1"))
    {
      ...
      localCustomEmotionData.emoPath = localante.e;
      localCustomEmotionData.eId = localante.f;
      localCustomEmotionData.resid = paramString1;
      localCustomEmotionData.RomaingType = paramString3;
      localCustomEmotionData.url = ansu.a(paramString1, paramString2, str1);
    ...
    for (;;)
    {
      ...
      localCustomEmotionData.uin = str1;
      localCustomEmotionData.emoPath = ansu.a(paramString1);
      localCustomEmotionData.resid = paramString1;
      localCustomEmotionData.md5 = localante.jdField_d_of_type_JavaLangString;
      localCustomEmotionData.url = ansu.a(paramString1, paramString2, str1);
      localCustomEmotionData.RomaingType = paramString3;
      localCustomEmotionData.emoId = paramInt;
      break;
      ...
      {
        localCustomEmotionData.eId = localante.e;
        if (QLog.isColorLevel()) {
  ...
  public anqt<CustomEmotionData> a()
  {
    return (ansx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(103);
  }
  
  public anyh a(CustomEmotionData paramCustomEmotionData)
  {
    if (paramCustomEmotionData.isMarkFace)
    {
      ...
      ((aobp)localObject1).jdField_c_of_type_Boolean = paramCustomEmotionData.isAPNG;
      ((aobp)localObject1).jdField_a_of_type_ComTencentMobileqqDataEmoticon = ((askf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(14)).a(str, (String)localObject2);
      ((aobp)localObject1).jdField_d_of_type_Int = 2;
      ((aobp)localObject1).jdField_a_of_type_JavaLangString = paramCustomEmotionData.RomaingType;
      ((aobp)localObject1).jdField_g_of_type_Int = paramCustomEmotionData.emoId;
      return localObject1;
    }
    Object localObject1 = ((anua)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(141)).a();
    Object localObject2 = new aoaz();
    ((aoaz)localObject2).jdField_c_of_type_Int = 4;
    ((aoaz)localObject2).jdField_d_of_type_JavaLangString = a(paramCustomEmotionData);
    ((aoaz)localObject2).jdField_d_of_type_Int = 2;
    ((aoaz)localObject2).jdField_c_of_type_JavaLangString = paramCustomEmotionData.eId;
    ((aoaz)localObject2).e = paramCustomEmotionData.url;
    if (localObject1 != null) {
      ((aoaz)localObject2).jdField_a_of_type_JavaLangString = aoaz.a((Map)localObject1, paramCustomEmotionData.md5);
    }
    ((aoaz)localObject2).jdField_g_of_type_JavaLangString = paramCustomEmotionData.RomaingType;
    ((aoaz)localObject2).jdField_g_of_type_Int = paramCustomEmotionData.emoId;
    ((aoaz)localObject2).f = paramCustomEmotionData.resid;
    return localObject2;
  }
  ...
  public CustomEmotionData a(List<CustomEmotionData> paramList, String paramString)
  {
    ...
    for (;;)
    {
      label131:
      return paramList;
      Object localObject = new ante(paramString);
      if (!((ante)localObject).a())
      {
        if (!QLog.isColorLevel()) {
          break;
        }
      ...
      {
        str = ((ante)localObject).e;
        localObject = ((ante)localObject).f;
      ...
      localObject = ((ante)localObject).jdField_d_of_type_JavaLangString;
      if (TextUtils.isEmpty((CharSequence)localObject)) {
        break label98;
      }
  ...
  public String a(CustomEmotionData paramCustomEmotionData)
  {
    ...
    do
    {
      ...
      localObject1 = ajsd.bh;
      localObject2 = (anua)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(141);
      if ((localObject2 != null) && (((anua)localObject2).a(paramCustomEmotionData)))
      {
        if ((!TextUtils.isEmpty(paramCustomEmotionData.emoPath)) && (paramCustomEmotionData.emoPath.startsWith(ajsd.bh))) {
          return paramCustomEmotionData.emoPath;
        }
        if (!TextUtils.isEmpty(paramCustomEmotionData.md5)) {
          return ((anua)localObject2).a(paramCustomEmotionData.md5);
        }
        if (!TextUtils.isEmpty(paramCustomEmotionData.resid)) {
          return (String)localObject1 + akvt.a(paramCustomEmotionData.resid);
        }
      ...
      if ((paramCustomEmotionData.url != null) && (paramCustomEmotionData.url.contains("qto_"))) {
        return (String)localObject1 + ajxo.a(paramCustomEmotionData.url);
      }
      if (TextUtils.isEmpty(ajxo.a(paramCustomEmotionData.eId))) {
        break;
      }
  ...
  public List<CustomEmotionData> a()
  {
    ...
    //   15: astore 8
    //   17: aload_0
    //   18: getfield 301	answ:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   21: invokeinterface 237 1 0
    //   26: ifle +104 -> 130
    //   29: aload_0
    //   30: getfield 301	answ:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   129: areturn
    //   130: aload_0
    //   131: getfield 22	answ:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   134: ifnonnull +6 -> 140
    //   137: goto -12 -> 125
    //   140: aload_0
    //   141: getfield 22	answ:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   144: invokevirtual 326	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Laukq;
    //   147: invokevirtual 332	aukq:createEntityManager	()Laukp;
    //   150: astore 11
    //   152: aload 11
    //   154: ifnull +379 -> 533
    //   157: aload 11
    //   159: aload_0
    //   160: invokevirtual 334	answ:a	()Ljava/lang/Class;
    //   163: iconst_0
    //   164: aconst_null
    //   165: aconst_null
    //   166: aconst_null
    ...
    //   168: aconst_null
    //   169: aconst_null
    //   170: invokevirtual 339	aukp:a	(Ljava/lang/Class;ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    //   173: astore 9
    //   175: ldc_w 341
    //   178: aload_0
    //   179: getfield 22	answ:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   182: invokevirtual 343	com/tencent/mobileqq/app/QQAppInterface:c	()Ljava/lang/String;
    //   185: invokestatic 346	akvt:a	(Ljava/lang/String;Ljava/lang/String;)I
    //   188: iconst_1
    //   189: if_icmpge +335 -> 524
    //   192: aload 11
    //   194: invokevirtual 349	aukp:a	()Laukr;
    //   197: astore 10
    //   199: aload 9
    ...
    //   255: getstatic 268	ajsd:bh	Ljava/lang/String;
    ...
    //   292: getstatic 268	ajsd:bh	Ljava/lang/String;
    ...
    //   303: invokestatic 278	akvt:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   324: istore 4
    //   326: aload 10
    //   328: invokevirtual 353	aukr:a	()V
    //   331: iconst_1
    //   332: istore_3
    //   333: iload_3
    //   334: istore_2
    ...
    //   338: aload 11
    //   340: aload 8
    //   342: invokevirtual 356	aukp:a	(Lauko;)Z
    //   345: pop
    //   346: iload_3
    //   347: istore_1
    //   348: iload 5
    ...
    //   385: getstatic 268	ajsd:bh	Ljava/lang/String;
    ...
    //   438: aload 12
    //   440: aload 12
    //   442: invokestatic 278	akvt:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   460: istore 4
    //   462: aload 10
    //   464: invokevirtual 353	aukr:a	()V
    //   467: iconst_1
    //   468: istore_3
    //   469: iload_3
    //   470: istore_2
    ...
    //   474: aload 11
    //   476: aload 8
    //   478: invokevirtual 356	aukp:a	(Lauko;)Z
    //   481: pop
    //   482: iload_3
    //   483: istore_1
    //   484: goto -136 -> 348
    ...
    //   494: istore 4
    //   496: aload 10
    //   498: invokevirtual 363	aukr:c	()V
    //   501: iload_1
    //   502: ifeq +8 -> 510
    //   505: aload 10
    //   507: invokevirtual 365	aukr:b	()V
    //   510: ldc_w 341
    //   513: aload_0
    //   514: getfield 22	answ:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   517: invokevirtual 343	com/tencent/mobileqq/app/QQAppInterface:c	()Ljava/lang/String;
    //   520: iconst_1
    //   521: invokestatic 368	akvt:a	(Ljava/lang/String;Ljava/lang/String;I)V
    //   524: aload 11
    //   526: invokevirtual 369	aukp:a	()V
    //   529: aload 9
    //   531: astore 8
    //   533: iload 7
    //   535: istore_2
    ...
    //   631: aload 11
    //   633: iconst_1
    //   634: invokevirtual 374	answ:b	(Lcom/tencent/mobileqq/data/CustomEmotionBase;I)V
    //   637: goto -62 -> 575
    //   640: astore 8
    //   642: iconst_0
    //   643: istore 4
    ...
    //   655: ifeq -145 -> 510
    //   658: aload 10
    //   660: invokevirtual 365	aukr:b	()V
    //   663: goto -153 -> 510
    //   666: iload_2
    //   667: ifeq +8 -> 675
    //   670: aload 10
    //   672: invokevirtual 365	aukr:b	()V
    //   675: aload 8
    //   677: athrow
    //   678: aload 11
    ...
    //   707: pop
    //   708: aload_0
    //   709: invokevirtual 378	answ:b	()V
    //   712: iconst_1
    //   713: istore_1
    //   714: goto -84 -> 630
    //   717: aload_0
    //   718: invokevirtual 379	answ:a	()V
    //   721: iload_2
    //   722: ifeq +10 -> 732
    //   725: aload_0
    //   726: aload 8
    //   728: iconst_2
    //   729: invokevirtual 382	answ:a	(Ljava/util/List;I)V
    //   732: aload 8
  ...
  public List<CustomEmotionData> a(List<String> paramList1, List<String> paramList2, String paramString, List<Integer> paramList)
  {
    ...
    for (;;)
    {
          ...
          for (;;)
          {
            ...
            if (localList != null)
            {
              ...
              if ((TextUtils.isEmpty(paramList1.url)) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null))
              {
                ...
                paramList1.url = ansu.a(str, paramString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
              }
      ...
      if (((List)localObject1).size() > ansu.b) {}
      for (paramList1 = ((List)localObject1).subList(0, ansu.b);; paramList1 = (List<String>)localObject1)
      {
        i = 0;
        ...
        paramList2 = (ajvy)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(72);
  ...
  public boolean a(CustomEmotionData paramCustomEmotionData, int paramInt)
  {
    ...
    for (Object localObject = "isUpdate";; localObject = "overflow_downloaded")
    {
      ...
      localObject = (ansx)a();
      if (localObject != null) {
        ((ansx)localObject).d(paramCustomEmotionData);
      }
      return true;
    }
  }
  ...
  public List<anyh> b()
  {
    bbkj.a("AIO_EmoticonPanel_Refresh", null);
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
        ...
        if (i >= 0)
        {
          ...
          else
          {
            ...
            if ((localObject2 instanceof aobp))
            {
              ...
              if (((aobp)localObject2).jdField_a_of_type_ComTencentMobileqqDataEmoticon != null) {
      ...
      catch (OutOfMemoryError localOutOfMemoryError)
      {
        ...
        bbkj.a(null, "AIO_EmoticonPanel_Refresh");
      }
      if (QLog.isColorLevel()) {
      ...
      break label322;
      if ((localObject2 instanceof aoaz))
      {
        localObject1 = (aoaz)localObject2;
        if ((TextUtils.isEmpty(((aoaz)localObject1).jdField_d_of_type_JavaLangString)) && (TextUtils.isEmpty(((aoaz)localObject1).e))) {
          QLog.e("FavroamingDBManager", 1, "path and url is null! " + ((aoaz)localObject1).toString());
        } else {
  ...
  protected List<anyh> c()
  {
    Map localMap = ((anua)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(141)).a();
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i >= 0)
        {
          ...
          {
            localObject = new aobp(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
            ((aobp)localObject).jdField_c_of_type_Int = 6;
            String str1 = localCustomEmotionData.eId;
            String str2 = localCustomEmotionData.emoPath;
            ((aobp)localObject).jdField_c_of_type_Boolean = localCustomEmotionData.isAPNG;
            ((aobp)localObject).jdField_a_of_type_ComTencentMobileqqDataEmoticon = ((askf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(14)).a(str2, str1);
            ((aobp)localObject).jdField_d_of_type_Int = 2;
            if (((aobp)localObject).jdField_a_of_type_ComTencentMobileqqDataEmoticon != null) {
      ...
      break label471;
      Object localObject = new aoaz();
      ((aoaz)localObject).jdField_c_of_type_Int = 4;
      ((aoaz)localObject).jdField_d_of_type_JavaLangString = a(localCustomEmotionData);
      ((aoaz)localObject).jdField_d_of_type_Int = 2;
      ((aoaz)localObject).jdField_c_of_type_JavaLangString = localCustomEmotionData.eId;
      ((aoaz)localObject).e = localCustomEmotionData.url;
      ((aoaz)localObject).jdField_a_of_type_JavaLangString = aoaz.a(localOutOfMemoryError, localCustomEmotionData.md5);
      ((aoaz)localObject).jdField_g_of_type_JavaLangString = localCustomEmotionData.RomaingType;
      ((aoaz)localObject).jdField_g_of_type_Int = localCustomEmotionData.emoId;
      ((aoaz)localObject).f = localCustomEmotionData.resid;
      if ((TextUtils.isEmpty(((aoaz)localObject).jdField_d_of_type_JavaLangString)) && (TextUtils.isEmpty(((aoaz)localObject).e))) {
        QLog.e("FavroamingDBManager", 1, "path and url is null! " + ((aoaz)localObject).toString());
      } else {
        localArrayList.add(localObject);
      }
      label471:
