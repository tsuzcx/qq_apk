...
public class amfa
  extends alpd
{
  private ArrayList<amfb> a = new ArrayList();
  
  public amfa(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    if (paramamfb == null) {}
    while (this.a.contains(paramamfb)) {
      return;
    }
    this.a.add(paramamfb);
  }
  ...
  public void b(amfb paramamfb)
  {
    if ((paramamfb != null) && (this.a.contains(paramamfb))) {
      this.a.remove(paramamfb);
    }
  }
