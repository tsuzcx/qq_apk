  ...
  extends afxd
{
  ...
  public ImageView a;
  private bdzc jdField_a_of_type_Bdzc = new afwt(this);
  ...
  public afws(Activity paramActivity)
  {
    super(paramActivity);
  ...
  public void a()
  {
    ...
    bdla.b(null, "dc00898", "", "", "0X8007777", "0X8007777", 0, 0, "", "", "", "");
  }
  ...
  public void a(afxj paramafxj)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.jdField_a_of_type_AndroidGraphicsBitmap = bheg.a(str + this.jdField_a_of_type_JavaLangString, localOptions);
        this.jdField_b_of_type_AndroidGraphicsBitmap = bheg.a(str + this.jdField_b_of_type_JavaLangString, localOptions);
        this.jdField_c_of_type_AndroidGraphicsBitmap = bheg.a(str + this.jdField_c_of_type_JavaLangString, localOptions);
        this.jdField_d_of_type_AndroidGraphicsBitmap = bheg.a(str + this.jdField_d_of_type_JavaLangString, localOptions);
        this.jdField_e_of_type_AndroidGraphicsBitmap = bheg.a(str + this.jdField_e_of_type_JavaLangString, localOptions);
        this.jdField_f_of_type_AndroidGraphicsBitmap = bheg.a(str + this.jdField_f_of_type_JavaLangString, localOptions);
        this.jdField_g_of_type_AndroidGraphicsBitmap = bheg.a(str + this.jdField_g_of_type_JavaLangString, localOptions);
        this.jdField_h_of_type_AndroidGraphicsBitmap = bheg.a(str + this.jdField_h_of_type_JavaLangString, localOptions);
        this.jdField_i_of_type_AndroidGraphicsBitmap = bheg.a(str + this.jdField_i_of_type_JavaLangString, localOptions);
        this.jdField_j_of_type_AndroidGraphicsBitmap = bheg.a(str + this.jdField_j_of_type_JavaLangString, localOptions);
        this.jdField_k_of_type_AndroidGraphicsBitmap = bheg.a(str + this.jdField_k_of_type_JavaLangString, localOptions);
        this.jdField_l_of_type_AndroidGraphicsBitmap = bheg.a(str + this.jdField_l_of_type_JavaLangString, localOptions);
        if ((this.jdField_a_of_type_AndroidGraphicsBitmap != null) && (this.jdField_b_of_type_AndroidGraphicsBitmap != null) && (this.jdField_d_of_type_AndroidGraphicsBitmap != null) && (this.jdField_i_of_type_AndroidGraphicsBitmap != null) && (this.jdField_j_of_type_AndroidGraphicsBitmap != null) && (this.jdField_k_of_type_AndroidGraphicsBitmap != null))
        {
          ...
          super.a(paramafxj);
          paramafxj.a(this.jdField_a_of_type_Boolean);
          return;
        }
        if (!QLog.isColorLevel()) {
          continue;
