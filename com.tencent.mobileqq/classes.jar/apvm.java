  ...
  implements AdapterView.OnItemClickListener
{
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    bdnm.a(null, "AIO_EmoticonPanel_TabClick");
    ...
    label228:
    Object localObject1;
    if ((paramAdapterView.size() > EmoticonPanelController.d) && (((apwv)paramAdapterView.get(EmoticonPanelController.d)).jdField_a_of_type_Int == 8))
    {
      bool = true;
      EmoticonPanelController.jdField_a_of_type_Boolean = bool;
      paramAdapterView = (apwv)paramAdapterView.get(paramInt);
      if (paramAdapterView.jdField_a_of_type_Int != 8) {
        break label421;
      }
      localObject2 = alud.a(2131704471);
      paramAdapterView = (ImageView)paramView.findViewById(2131375572);
      bool = false;
      if (paramAdapterView != null)
      {
    ...
    for (;;)
    {
      if (!TextUtils.isEmpty(paramAdapterView)) {
        azqs.b(localQQAppInterface, "CliOper", "", "", "ep_mall", paramAdapterView, 0, 0, paramView, "", (String)localObject1, "");
      }
      ...
      bdnm.a("AIO_EmoticonPanel_TabClick", null);
      this.a.a.i = true;
      ...
      if (paramAdapterView.jdField_a_of_type_Int == 9)
      {
        ...
        localObject2 = alud.a(2131704460);
        localObject1 = "";
        paramView = "";
      }
      else if (paramAdapterView.jdField_a_of_type_Int == 4)
      {
        localObject2 = alud.a(2131704433);
        azqs.b(localQQAppInterface, "dc00898", "", "", "0x800a56e", "0x800a56e", 0, 0, "", "", "", "");
        ((apvd)this.a.a.a(2)).k();
        localObject1 = "";
        paramView = "";
      ...
      else
      {
        ...
        localObject2 = alud.a(2131704480);
        localObject1 = "";
        paramView = "";
      }
    }
    ...
    if (paramAdapterView.jdField_a_of_type_Int == 6)
    {
      ...
      if (((EmoticonPackage)localObject2).status == 2)
      {
        ...
        localObject4 = alud.a(2131704440) + ((EmoticonPackage)localObject2).name + alud.a(2131704457);
        if (((EmoticonPackage)localObject2).status == 2) {
          break label846;
        }
        localObject4 = (String)localObject4 + alud.a(2131704483);
    ...
    for (;;)
    {
      ...
      {
        localObject2 = alud.a(2131704481);
        paramAdapterView = (ImageView)paramView.findViewById(2131375572);
        if (paramAdapterView != null)
        {
          paramAdapterView.setVisibility(8);
        ...
        azqs.b(localQQAppInterface, "dc00898", "", "", "0X800A36D", "0X800A36D", 0, 0, "", "", "", "");
        localObject1 = "";
        paramView = "";
        paramAdapterView = "";
        break;
