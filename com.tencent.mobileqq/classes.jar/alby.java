...
public class alby
{
  public static int a(String paramString)
  {
    try
    {
      int i = alca.a("arfeature", "v8.0.0", alca.b("arfeature", "v8.0.0", "arfeature"), paramString);
      return i;
    }
    finally
    {
  ...
  public static int a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        alca.a("arfeature", "v8.0.0", "arfeature", paramString2);
        try
        {
          albw.a(paramString1, alca.a("arfeature", "v8.0.0", alca.b("arfeature", "v8.0.0", "arfeature")));
          paramString2 = alca.a("arfeature", "v8.0.0", alca.b("arfeature", "v8.0.0", "arfeature")) + File.separator + "md5_config.xml";
        ...
        catch (IOException paramString2)
        {
          ...
          String str;
          i = -6;
          bbdj.a(alca.a("arfeature", "v8.0.0", alca.b("arfeature", "v8.0.0", "arfeature")), false);
      ...
      try
      {
        ...
        {
          paramString1 = alca.a("arfeature", "v8.0.0", alca.b("arfeature", "v8.0.0", "arfeature")) + File.separator + (String)((Map.Entry)localObject).getKey() + ".so";
          alca.a("arfeature", "v8.0.0", "libARFeature", (String)((Map.Entry)localObject).getValue());
        }
  ...
  {
    return new File(alca.a("arfeature", "v8.0.0", alca.b("arfeature", "v8.0.0", "arfeature")) + File.separator + "libARFeature" + ".so").exists();
  }
}
