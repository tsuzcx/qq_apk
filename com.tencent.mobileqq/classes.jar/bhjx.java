...
{
  bhjx(int paramInt, bhjz parambhjz, VideoView paramVideoView, boolean paramBoolean) {}
  ...
  public boolean onError(MediaPlayer paramMediaPlayer, int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Bhjz != null) {
      this.jdField_a_of_type_Bhjz.a(paramInt1, paramInt2, this.jdField_a_of_type_Int);
    }
    paramMediaPlayer = bhjt.a(null, this.jdField_a_of_type_Int, 7, null);
    ...
    do
    {
      for (;;)
      {
        ...
        {
          paramMediaPlayer = bggl.a(paramMediaPlayer);
