...
public class och
  extends SimpleJob
{
  public och(MemoriesVideoListSegment paramMemoriesVideoListSegment, String paramString1, int paramInt, View paramView, String paramString2) {}
  ...
  protected Object a(@NonNull JobContext paramJobContext, Void... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      ThreadManager.getUIHandler().post(new oci(this, paramVarArgs, i, paramJobContext, bool, (QQUserUIItem)localObject));
      return null;
      bool = false;
    }
  }
