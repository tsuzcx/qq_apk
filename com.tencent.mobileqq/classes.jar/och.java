  ...
  implements sai, sak
{
  ...
  public int a(BaseData paramBaseData)
  {
    ...
    if ((paramBaseData instanceof ProteusBannerTriplePicItemData)) {
      i = odv.a((ProteusBannerTriplePicItemData)paramBaseData);
    }
    return i;
  }
  ...
  public sah a(Context paramContext, BaseData paramBaseData, ViewGroup paramViewGroup)
  {
    ...
    return new oci(this, paramViewGroup, localProteusItemData);
  }
  ...
  {
    return (paramBaseData != null) && (paramBaseData.s == 24);
  }
