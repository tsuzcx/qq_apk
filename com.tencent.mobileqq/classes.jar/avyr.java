  ...
  implements PluginManagerUpdater
{
  ...
  public avyr(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    this.e = paramString3;
    ...
    this.jdField_a_of_type_Avyq = new avyq(paramContext, paramString1, paramString3);
  ...
  public File a()
  {
    ...
    awbo localawbo = new awbo();
    localawbo.a(BaseApplicationImpl.getContext());
    localawbo.a(this.jdField_a_of_type_JavaLangString, new avyt(this, localFile, arrayOfException, l, localCountDownLatch));
    localawbo.b(awbq.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaIoFile.getAbsolutePath()));
  ...
  public Future<File> update()
  {
    ...
    this.jdField_a_of_type_JavaUtilConcurrentFuture = aoik.a(192).submit(new avys(this));
    return this.jdField_a_of_type_JavaUtilConcurrentFuture;
  }
