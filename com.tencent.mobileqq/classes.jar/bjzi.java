  ...
  implements bdhu, bdkt
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new bjzj(this);
  private bdks jdField_a_of_type_Bdks;
  private bjzk jdField_a_of_type_Bjzk;
  ...
  public bjzi(Context paramContext, bjzk parambjzk)
  {
    this.jdField_a_of_type_Int = 360000;
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramContext);
    this.jdField_a_of_type_Bjzk = parambjzk;
  }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    for (int i = 0;; i = 1)
    {
      this.jdField_a_of_type_Bdks = new bdks(paramString, localHandler, i);
      this.jdField_a_of_type_Bdks.a(BaseApplication.getContext());
  ...
  {
    a();
    if (this.jdField_a_of_type_Bjzk == null) {
      return;
    }
    if (this.jdField_b_of_type_Int > 0)
    {
      this.jdField_a_of_type_Bjzk.b(this.jdField_b_of_type_Int, paramString);
      this.jdField_b_of_type_Int = 0;
      return;
    }
    this.jdField_a_of_type_Bjzk.a(3, this.e);
  }
  ...
  {
    awtg.b(paramString);
    this.jdField_a_of_type_Bjzk.a(paramString, paramDouble);
  }
  
  public void a(String paramString1, QQRecorder.RecorderParam paramRecorderParam, String paramString2)
  {
    awtg.a(paramString1);
    this.jdField_a_of_type_Bjzk.c();
  }
  ...
  public void b(String paramString)
  {
    ...
    if ((this.jdField_a_of_type_Bjzk != null) && (!TextUtils.isEmpty(str1)))
    {
      this.jdField_a_of_type_Bjzk.a(1, paramString);
      d(str1);
      return;
    }
    ...
    for (;;)
    {
      if (i != 0)
      {
        if (new StatFs(Environment.getExternalStorageDirectory().getAbsolutePath()).getAvailableBlocks() > 1)
        {
          ...
          paramString = banc.a(paramString, null, 2, null);
        ...
        QQToast.a(BaseApplication.getContext(), 2131719540, 0).a();
        return;
      }
    }
    QQToast.a(BaseApplication.getContext(), 2131694851, 0).a();
  }
}
