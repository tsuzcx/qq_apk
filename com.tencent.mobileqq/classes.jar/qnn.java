  ...
  extends pwd
{
  ...
  static
  {
    jdField_a_of_type_Qno = new qno(null);
  }
  
  public qnn(@Nullable AppInterface paramAppInterface, @Nullable EntityManager paramEntityManager, @Nullable ExecutorService paramExecutorService, @Nullable qli paramqli, @Nullable Handler paramHandler)
  {
  ...
  private final void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int k = qlk.a(paramFromServiceMsg, paramObject, (MessageMicro)localRspBody);
    int i;
  ...
  public final void a(@NotNull PTSComposer paramPTSComposer, int paramInt, @NotNull String paramString1, @NotNull String paramString2)
  {
    ...
    localObject = qlk.a("OidbSvc.0xebf", 3775, 0, ((oidb_cmd0xebf.ReqBody)localObject).toByteArray());
