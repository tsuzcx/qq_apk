...
public class aoik
{
  private aodp jdField_a_of_type_Aodp = new aoil(this);
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private LinkedHashMap<Long, aopj> jdField_a_of_type_JavaUtilLinkedHashMap = new LinkedHashMap();
  ...
  public int a(long paramLong1, String paramString, int paramInt, long paramLong2)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 26	aoik:jdField_a_of_type_JavaUtilLinkedHashMap	Ljava/util/LinkedHashMap;
    //   6: lload 5
    ...
    //   37: ireturn
    //   38: aload_0
    //   39: getfield 28	aoik:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   42: invokevirtual 60	com/tencent/mobileqq/app/QQAppInterface:a	()Laoig;
    //   45: lload_1
    //   46: aload_3
    //   47: iload 4
    //   49: lload 5
    //   51: invokevirtual 65	aoig:a	(JLjava/lang/String;IJ)Lcom/tencent/mobileqq/filemanager/data/FileManagerEntity;
    //   54: astore_3
    //   55: aload_3
    //   56: ifnonnull +9 -> 65
    //   59: iconst_m1
    ...
    //   62: goto -29 -> 33
    //   65: aload_0
    //   66: getfield 26	aoik:jdField_a_of_type_JavaUtilLinkedHashMap	Ljava/util/LinkedHashMap;
    //   69: aload_3
  ...
  public long a(String paramString, long paramLong1, long paramLong2, int paramInt)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 28	aoik:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   6: invokevirtual 60	com/tencent/mobileqq/app/QQAppInterface:a	()Laoig;
    //   9: lload 4
    //   11: aload_1
    //   12: iload 6
    //   14: invokevirtual 79	aoig:a	(JLjava/lang/String;I)Lcom/tencent/mobileqq/filemanager/data/FileManagerEntity;
    //   17: astore 7
    //   19: aload 7
    //   21: ifnull +45 -> 66
    //   24: aload_0
    //   25: getfield 26	aoik:jdField_a_of_type_JavaUtilLinkedHashMap	Ljava/util/LinkedHashMap;
    //   28: aload 7
    ...
    //   65: lreturn
    //   66: aload_0
    //   67: getfield 28	aoik:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   70: invokevirtual 60	com/tencent/mobileqq/app/QQAppInterface:a	()Laoig;
    //   73: aload_1
    //   74: lload_2
    //   75: lload 4
    //   77: iload 6
    //   79: invokevirtual 84	aoig:a	(Ljava/lang/String;JJI)J
    //   82: lstore_2
    //   83: goto -21 -> 62
    //   86: astore_1
    //   87: aload_0
  ...
  public FileManagerEntity a(String paramString)
  {
    ...
    //   20: areturn
    //   21: aload_0
    //   22: getfield 26	aoik:jdField_a_of_type_JavaUtilLinkedHashMap	Ljava/util/LinkedHashMap;
    ...
    //   52: astore 4
    //   54: aload_0
    //   55: getfield 26	aoik:jdField_a_of_type_JavaUtilLinkedHashMap	Ljava/util/LinkedHashMap;
    //   58: aload 4
    //   60: invokevirtual 51	java/util/LinkedHashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   63: checkcast 53	aopj
    //   66: astore 4
    //   68: aload_1
    //   69: aload 4
      ...
      try
      {
        ...
        if ((!TextUtils.isEmpty(paramString1)) && (!TextUtils.isEmpty(paramString2)))
        {
          ...
          if (localIterator.hasNext())
          {
            ...
            localObject = (aopj)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(localObject);
            FileManagerEntity localFileManagerEntity = ((aopj)localObject).a();
            if ((paramString1.equalsIgnoreCase((String)localFileManagerEntity.mContext)) && (paramString2.equals(localFileManagerEntity.zipInnerPath))) {
              paramString1 = ((aopj)localObject).a();
            }
          }
          else
          {
  ...
  public void a()
  {
    ...
    try
    {
      i = besv.a(BaseApplication.getContext());
      if (i == 1) {
        break label596;
      }
      if (i != 2) {
    ...
    while (localIterator.hasNext())
    {
      ...
      localaopj = (aopj)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(localLong);
      if (localaopj == null)
      {
      ...
      else
      {
        ...
        for (;;)
        {
          ...
          break;
          if ((localaopj.a() == 1) || (localaopj.a() == 8) || (localaopj.a() == 5) || (localaopj.a() == 50)) {
            break label614;
          }
          if (localaopj.a() != 41) {
            break label376;
        ...
        label376:
        str2 = str2 + "type[" + localaopj.a() + "] is not processed, maxtype is " + 8 + "\n";
        continue;
        label426:
  ...
  public void a(long paramLong)
  {
    try
    {
      aopj localaopj = (aopj)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(Long.valueOf(paramLong));
      if (localaopj != null) {
        localaopj.b();
      }
      if (QLog.isColorLevel()) {
  ...
  public void a(long paramLong1, long paramLong2, String paramString, int paramInt1, int paramInt2)
  {
    ...
    {
      if (apdh.b(localFileManagerEntity1.getFilePath()))
      {
      ...
      {
        apck.a(BaseApplicationImpl.getContext().getString(2131627218));
    ...
    if ((localFileManagerEntity1.nFileType == 2) && (!localFileManagerEntity1.isZipInnerFile) && (localFileManagerEntity1.cloudType != 2) && ((localFileManagerEntity1.peerType == 3000) || (localFileManagerEntity1.peerType == 0)))
    {
      ...
      aojd.a(BaseActivity.sTopActivity, new aoin(this, localFileManagerEntity1));
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(true, 3, null);
      return;
    }
  ...
  public void a(long paramLong, aopj paramaopj)
  {
    try
    {
      this.jdField_a_of_type_JavaUtilLinkedHashMap.put(Long.valueOf(paramLong), paramaopj);
  ...
  public void a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    if (!bace.b(paramFileManagerEntity.getFilePath()))
    {
      ...
      for (;;)
      {
        ...
        return;
        if (!apck.b(paramFileManagerEntity.getFilePath()))
        {
          i = 9042;
        ...
        localObject = str;
        if (apck.a(paramFileManagerEntity.getFilePath()) != 0L) {
          break;
        }
        i = 9071;
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(paramFileManagerEntity);
        apck.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFileManagerEntity.nSessionId, "actFileUp", 0L, "", paramFileManagerEntity.peerUin, paramFileManagerEntity.Uuid, paramFileManagerEntity.strFileMd5, i, "", 0L, 0L, paramFileManagerEntity.fileSize, "", "", 0, (String)localObject, null);
        apck.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFileManagerEntity.nSessionId, "actFileUpDetail", 0L, "", paramFileManagerEntity.peerUin, paramFileManagerEntity.Uuid, paramFileManagerEntity.strFileMd5, i, "", 0L, 0L, paramFileManagerEntity.fileSize, "", "", 0, (String)localObject, null);
        continue;
        paramFileManagerEntity.status = 0;
        ...
        apck.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFileManagerEntity.nSessionId, "actFileWyUp", 0L, "", paramFileManagerEntity.peerUin, paramFileManagerEntity.Uuid, paramFileManagerEntity.strFileMd5, i, "", 0L, 0L, paramFileManagerEntity.fileSize, "", "", 0, (String)localObject, null);
      }
    }
    if (paramFileManagerEntity.peerType == 3000) {
      localObject = new aopd(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFileManagerEntity);
    }
    for (;;)
    {
      try
      ...
      localObject = (arip)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(16);
      if ((localObject != null) && (((arip)localObject).a(paramFileManagerEntity.peerUin)))
      {
        ...
        for (i = 0;; i = 16)
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(paramFileManagerEntity.uniseq, paramFileManagerEntity.nSessionId, paramFileManagerEntity.peerUin, paramFileManagerEntity.peerType, 15, null, -1, ajjy.a(2131638745));
          return;
        }
      }
      if (paramFileManagerEntity.nOpType == 0)
      {
        if ((aopn.a().a()) && (paramFileManagerEntity.fileSize > aopn.a().a())) {
          localObject = new aoqe(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFileManagerEntity);
        } else {
          localObject = new aojz(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFileManagerEntity);
        }
      }
      else {
        localObject = new aoio(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFileManagerEntity);
      }
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    try
    {
      ...
      while (((Iterator)localObject2).hasNext()) {
        localArrayList.add(0, (aopj)((Iterator)localObject2).next());
      }
    ...
    for (;;)
    {
      if (localIterator.hasNext())
      {
        localObject2 = (aopj)localIterator.next();
        ((aopj)localObject2).c();
        if (!paramBoolean)
        {
          ((aopj)localObject2).e();
      ...
      {
        if ((paramBoolean) && (i == 0)) {
          apck.a(BaseApplicationImpl.getContext().getString(2131627246));
        }
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(true, 3, null);
        break;
      }
  ...
  public boolean a(long paramLong)
  {
    ...
    //   30: aload_0
    //   31: getfield 26	aoik:jdField_a_of_type_JavaUtilLinkedHashMap	Ljava/util/LinkedHashMap;
    //   34: lload_1
    ...
    //   41: pop
    //   42: aload_0
    //   43: invokevirtual 239	aoik:a	()V
    //   46: aload_0
    //   47: getfield 28	aoik:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   50: invokevirtual 60	com/tencent/mobileqq/app/QQAppInterface:a	()Laoig;
    //   53: lload_1
    //   54: invokevirtual 243	aoig:a	(J)Lcom/tencent/mobileqq/filemanager/data/FileManagerEntity;
    //   57: astore 4
    //   59: aload 4
    //   61: ifnull +87 -> 148
    //   64: aload 4
    ...
    //   96: invokestatic 462	aojd:a	(Ljava/lang/String;)V
    //   99: aload 4
    ...
    //   123: aload_0
    //   124: getfield 28	aoik:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   127: invokevirtual 60	com/tencent/mobileqq/app/QQAppInterface:a	()Laoig;
    //   130: aload 4
    //   132: invokevirtual 258	aoig:c	(Lcom/tencent/mobileqq/filemanager/data/FileManagerEntity;)V
    //   135: aload_0
    //   136: getfield 28	aoik:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   139: invokevirtual 33	com/tencent/mobileqq/app/QQAppInterface:a	()Laoii;
    //   142: iconst_1
    //   143: iconst_0
    //   144: aconst_null
    //   145: invokevirtual 261	aoii:a	(ZILjava/lang/Object;)V
    //   148: aload 4
    //   150: ifnull +36 -> 186
    //   153: aload 4
    ...
    //   168: aload_0
    //   169: getfield 28	aoik:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   172: invokevirtual 60	com/tencent/mobileqq/app/QQAppInterface:a	()Laoig;
    //   175: aload 4
    //   177: invokevirtual 258	aoig:c	(Lcom/tencent/mobileqq/filemanager/data/FileManagerEntity;)V
    //   180: iconst_1
    //   181: istore_3
    //   182: aload_0
    //   183: monitorexit
  ...
  public boolean a(String paramString)
  {
    ...
    //   55: astore 5
    //   57: aload_0
    //   58: getfield 26	aoik:jdField_a_of_type_JavaUtilLinkedHashMap	Ljava/util/LinkedHashMap;
    //   61: aload 5
    //   63: invokevirtual 51	java/util/LinkedHashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   66: checkcast 53	aopj
  ...
  public boolean a(String paramString, long paramLong, int paramInt)
  {
    ...
    //   11: iload 4
    //   13: ldc2_w 467
    //   16: invokevirtual 65	aoig:a	(JLjava/lang/String;IJ)Lcom/tencent/mobileqq/filemanager/data/FileManagerEntity;
    //   19: astore_1
    //   20: aload_1
    //   21: ifnonnull +11 -> 32
    //   24: iconst_0
    ...
    //   37: invokevirtual 470	aoik:a	(J)Z
    //   40: istore 5
    //   42: goto -15 -> 27
    //   45: astore_1
    //   46: aload_0
  ...
  public void b(FileManagerEntity paramFileManagerEntity)
  {
    ...
    {
      aojd.a(BaseActivity.sTopActivity, new aoim(this, paramFileManagerEntity));
      return;
    }
    if ((paramFileManagerEntity.peerType == 0) && (paramFileManagerEntity.nOpType != 5) && (paramFileManagerEntity.nOpType != 50) && (aopn.a().b()) && (paramFileManagerEntity.fileSize > aopn.a().b()) && (!TextUtils.isEmpty(paramFileManagerEntity.Uuid))) {}
    for (Object localObject = new aopy(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFileManagerEntity);; localObject = new aoio(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFileManagerEntity)) {
      try
      {
        this.jdField_a_of_type_JavaUtilLinkedHashMap.put(Long.valueOf(paramFileManagerEntity.nSessionId), localObject);
  ...
  public void c(FileManagerEntity paramFileManagerEntity)
  {
    ...
    for (;;)
    {
      ...
      aopj localaopj = (aopj)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(Long.valueOf(paramFileManagerEntity.nSessionId));
      if ((localaopj == null) || (localaopj.a())) {
        break;
      }
