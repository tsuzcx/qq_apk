...
public class agvs
  implements Runnable
{
  public agvs(ProfileHeaderView paramProfileHeaderView, int paramInt, ProfileActivity.AllInOne paramAllInOne, String paramString) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      if (localObject1 != null) {
        this.jdField_a_of_type_ComTencentMobileqqProfileViewProfileHeaderView.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.runOnUiThread(new agvt(this, (Bitmap)localObject1));
      }
      return;
      label245:
      localObject1 = localObject2;
        ...
        else
        {
          if (3 == this.jdField_a_of_type_Int)
          {
            ...
            for (;;)
            {
              ...
              try
              {
                localObject2 = BitmapFactory.decodeResource(this.jdField_a_of_type_ComTencentMobileqqProfileViewProfileHeaderView.getContext().getResources(), 2130840204);
                localObject1 = localObject2;
              }
