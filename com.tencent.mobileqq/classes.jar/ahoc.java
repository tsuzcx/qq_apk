  ...
  implements Runnable
{
  ...
  public ahoc(@NonNull String paramString, Surface paramSurface, HWDecodeListener paramHWDecodeListener)
  {
  ...
  public void run()
  {
    ...
    //   3: lstore_3
    //   4: aload_0
    //   5: getfield 102	ahoc:jdField_b_of_type_ComTencentMobileqqRichmediaMediacodecDecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/decoder/DecodeConfig;
    //   8: aload_0
    //   9: getfield 100	ahoc:jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/decoder/DecodeConfig;
    ...
    //   15: pop
    //   16: aload_0
    //   17: invokespecial 442	ahoc:a	()Z
    //   20: ifne +4 -> 24
    //   23: return
    //   24: aload_0
    //   25: invokespecial 444	ahoc:b	()Z
    //   28: ifeq -5 -> 23
    //   31: invokestatic 151	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   34: ifeq +35 -> 69
    //   37: aload_0
    //   38: getfield 32	ahoc:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   41: iconst_2
    ...
    //   72: ifne +415 -> 487
    //   75: aload_0
    //   76: getfield 34	ahoc:jdField_a_of_type_Boolean	Z
    //   79: ifne +408 -> 487
    //   82: aload_0
    //   83: getfield 100	ahoc:jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/decoder/DecodeConfig;
    //   86: getfield 169	com/tencent/mobileqq/richmedia/mediacodec/decoder/DecodeConfig:jdField_a_of_type_Int	I
    //   89: aload_0
    //   90: getfield 102	ahoc:jdField_b_of_type_ComTencentMobileqqRichmediaMediacodecDecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/decoder/DecodeConfig;
    //   93: getfield 169	com/tencent/mobileqq/richmedia/mediacodec/decoder/DecodeConfig:jdField_a_of_type_Int	I
    //   96: if_icmpeq +29 -> 125
    //   99: aload_0
    //   100: getfield 100	ahoc:jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/decoder/DecodeConfig;
    ...
    //   110: aload_0
    //   111: aload_0
    //   112: getfield 102	ahoc:jdField_b_of_type_ComTencentMobileqqRichmediaMediacodecDecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/decoder/DecodeConfig;
    //   115: getfield 170	com/tencent/mobileqq/richmedia/mediacodec/decoder/DecodeConfig:jdField_b_of_type_Long	J
    //   118: ldc2_w 130
    //   121: lmul
    //   122: putfield 143	ahoc:jdField_c_of_type_Long	J
    //   125: aload_0
    //   126: getfield 102	ahoc:jdField_b_of_type_ComTencentMobileqqRichmediaMediacodecDecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/decoder/DecodeConfig;
    //   129: aload_0
    //   130: getfield 100	ahoc:jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/decoder/DecodeConfig;
    ...
    //   136: pop
    //   137: aload_0
    //   138: getfield 102	ahoc:jdField_b_of_type_ComTencentMobileqqRichmediaMediacodecDecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/decoder/DecodeConfig;
    ...
    //   149: ldc2_w 130
    //   152: aload_0
    //   153: getfield 102	ahoc:jdField_b_of_type_ComTencentMobileqqRichmediaMediacodecDecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/decoder/DecodeConfig;
    ...
    //   163: istore_2
    //   164: aload_0
    //   165: getfield 51	ahoc:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicLong	Ljava/util/concurrent/atomic/AtomicLong;
    ...
    //   201: aload_0
    //   202: lload 7
    //   204: invokespecial 451	ahoc:a	(J)J
    //   207: pop2
    //   208: iconst_1
    //   209: istore_1
    //   210: aload_0
    //   211: getfield 51	ahoc:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicLong	Ljava/util/concurrent/atomic/AtomicLong;
    //   214: lload 7
    //   216: ldc2_w 45
    ...
    //   228: aload_0
    //   229: iconst_1
    //   230: invokespecial 457	ahoc:c	(Z)V
    //   233: iload_1
    //   234: ifeq +42 -> 276
    //   237: invokestatic 151	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   240: ifeq +36 -> 276
    //   243: aload_0
    //   244: getfield 32	ahoc:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   247: iconst_2
    ...
    //   276: aload_0
    //   277: getfield 139	ahoc:jdField_c_of_type_Boolean	Z
    //   280: ifeq +59 -> 339
    //   283: invokestatic 151	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   286: ifeq +14 -> 300
    //   289: aload_0
    //   290: getfield 32	ahoc:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   293: iconst_2
    //   294: ldc_w 459
    //   297: invokestatic 165	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   300: aload_0
    //   301: getfield 102	ahoc:jdField_b_of_type_ComTencentMobileqqRichmediaMediacodecDecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/decoder/DecodeConfig;
    //   304: getfield 432	com/tencent/mobileqq/richmedia/mediacodec/decoder/DecodeConfig:jdField_b_of_type_Boolean	Z
    //   307: ifeq +180 -> 487
    //   310: aload_0
    //   311: getfield 102	ahoc:jdField_b_of_type_ComTencentMobileqqRichmediaMediacodecDecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/decoder/DecodeConfig;
    ...
    //   324: aload_0
    //   325: lload_3
    //   326: invokespecial 451	ahoc:a	(J)J
    //   329: pop2
    //   330: aload_0
    //   331: getfield 84	ahoc:jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderHWDecodeListener	Lcom/tencent/mobileqq/richmedia/mediacodec/decoder/HWDecodeListener;
    //   334: invokeinterface 462 1 0
    //   339: aload_0
    //   340: getfield 259	ahoc:jdField_d_of_type_Boolean	Z
    //   343: ifeq -274 -> 69
    //   346: aload_0
    //   347: getfield 53	ahoc:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   350: astore 9
    //   352: aload 9
    //   354: monitorenter
    //   355: aload_0
    //   356: getfield 34	ahoc:jdField_a_of_type_Boolean	Z
    //   359: ifne +10 -> 369
    //   362: aload_0
    //   363: getfield 53	ahoc:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    ...
    //   376: aload_0
    //   377: getfield 264	ahoc:jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo	Landroid/media/MediaCodec$BufferInfo;
    //   380: getfield 281	android/media/MediaCodec$BufferInfo:presentationTimeUs	J
    //   383: ldc2_w 130
    //   386: ldiv
    //   387: lsub
    //   388: putfield 42	ahoc:jdField_a_of_type_Long	J
    //   391: goto -322 -> 69
    //   394: astore 9
    //   396: aload 9
    ...
    //   401: aload_0
    //   402: iconst_1
    //   403: putfield 34	ahoc:jdField_a_of_type_Boolean	Z
    //   406: goto -337 -> 69
    //   409: astore 9
    //   411: invokestatic 235	java/lang/Thread:interrupted	()Z
    //   414: ifeq +18 -> 432
    //   417: aload_0
    //   418: getfield 32	ahoc:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   421: iconst_2
    //   422: ldc 237
    //   424: aload 9
    ...
    //   441: astore 10
    //   443: aload_0
    //   444: getfield 34	ahoc:jdField_a_of_type_Boolean	Z
    //   447: ifne +15 -> 462
    //   450: aload_0
    //   451: getfield 84	ahoc:jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderHWDecodeListener	Lcom/tencent/mobileqq/richmedia/mediacodec/decoder/HWDecodeListener;
    //   454: iconst_3
    //   455: aload 10
    //   457: invokeinterface 254 3 0
    //   462: aload_0
    //   463: getfield 32	ahoc:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   466: iconst_2
    //   467: ldc_w 256
    //   470: aload 9
    ...
    //   486: athrow
    //   487: aload_0
    //   488: getfield 113	ahoc:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   491: invokevirtual 468	android/media/MediaCodec:stop	()V
    //   494: aload_0
    //   495: getfield 113	ahoc:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   498: invokevirtual 471	android/media/MediaCodec:release	()V
    //   501: aload_0
    //   502: getfield 120	ahoc:jdField_a_of_type_AndroidMediaMediaExtractor	Landroid/media/MediaExtractor;
    //   505: invokevirtual 472	android/media/MediaExtractor:release	()V
    //   508: aload_0
    //   509: getfield 139	ahoc:jdField_c_of_type_Boolean	Z
    //   512: ifeq +48 -> 560
    //   515: aload_0
    //   516: getfield 84	ahoc:jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderHWDecodeListener	Lcom/tencent/mobileqq/richmedia/mediacodec/decoder/HWDecodeListener;
    ...
    //   557: goto -49 -> 508
    //   560: aload_0
    //   561: getfield 84	ahoc:jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderHWDecodeListener	Lcom/tencent/mobileqq/richmedia/mediacodec/decoder/HWDecodeListener;
