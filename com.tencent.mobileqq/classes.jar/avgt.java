...
public class avgt
  implements behi
{
  public avgt(ScreenShotFragment paramScreenShotFragment) {}
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    default: 
      if ((ScreenShotFragment.a(this.a)) && (paramAdapterView != null)) {
        avgx.a("0X800A9A9", paramAdapterView, "1");
      }
      if ((i != 9) && (i != 10)) {
        break label300;
      }
    ...
    for (;;)
    {
      ...
      bbmy.a(this.a.getActivity(), this.a.getActivity().getString(paramInt), 0).b(this.a.getActivity().getResources().getDimensionPixelSize(2131167766));
      return;
      avgx.a("0X8009FF0", 0);
      paramAdapterView = "1";
      break;
    ...
    case 9: 
      if ((PicShareToWX.a().a()) && (PicShareToWX.a().a(ScreenShotFragment.a(this.a))))
      {
        ...
        awqx.b(null, "dc00898", "", "", "0X800A505", "0X800A505", 0, 0, "", "", "", "");
        return;
      }
