...
public class bfta
{
  ...
  private static Handler jdField_a_of_type_AndroidOsHandler = new bftb(ThreadManager.getSubThreadLooper());
  private static bjmo<Integer> jdField_a_of_type_Bjmo = new bjmo(40);
  ...
  private static void c()
  {
    ...
    for (;;)
    {
      ...
      while (i < j)
      {
        ...
        {
          jdField_a_of_type_Bjmo.a(localThread3.getId(), Integer.valueOf(localThread3.getPriority()));
  ...
  private static void d()
  {
    ...
    while (i < j)
    {
      ...
      {
        int k = ((Integer)jdField_a_of_type_Bjmo.a(localThread.getId(), Integer.valueOf(0))).intValue();
        if (k != 0) {
