...
{
  private static final String jdField_a_of_type_JavaLangString = bkjn.class.getSimpleName();
  ...
  private bkjp jdField_a_of_type_Bkjp;
  ...
  public bkjn(int paramInt1, int paramInt2)
  {
  ...
  private void d()
  {
    this.jdField_a_of_type_Bkjp = new bkjp();
    this.jdField_a_of_type_Bkjp.a();
    if (this.jdField_b_of_type_Boolean) {
      Log.d(jdField_a_of_type_JavaLangString, "textureID=" + this.jdField_a_of_type_Bkjp.a());
    }
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture = new SurfaceTexture(this.jdField_a_of_type_Bkjp.a());
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Bkjp = null;
  ...
  {
    this.jdField_a_of_type_Bkjp.a(this.jdField_a_of_type_AndroidGraphicsSurfaceTexture, paramBoolean);
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Bkjp.a("before updateTexImage");
