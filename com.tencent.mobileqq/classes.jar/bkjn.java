  ...
  extends QIMEffectCameraCaptureUnit
{
  ...
  public bkjn(bmcv parambmcv, bmcu parambmcu)
  {
    super(parambmcv, parambmcu);
    this.jdField_a_of_type_Bmcn = new bmcn(10004, 8, 2);
  ...
  private void a(Activity paramActivity)
  {
    ...
    bizm.c(paramActivity, localAppRuntime.getAccount(), localIntent, -1);
  }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (!(localObject1 instanceof ajlk)) {
          break label564;
        }
        localObject1 = (ajlk)localObject1;
        ((ajlk)localObject1).d_((String)localObject2);
        ...
        bkkb.a(this.jdField_a_of_type_Bmcv.a(), paramIntent, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView$VideoCaptureResult, this.jdField_a_of_type_Bmcu, null, (ajlk)localObject1, (String)localObject2, 1, null, bool, null, false);
      ...
      {
        bkkb.a(this.jdField_a_of_type_Bmcv.a(), paramIntent, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView$VideoCaptureResult, this.jdField_a_of_type_Bmcu, new bkjo(this, localActivity, paramIntent));
        continue;
        if ((paramInt2 == -1) && (paramIntent != null))
        {
          localObject1 = this.jdField_a_of_type_Bmcv.a();
          paramInt1 = paramIntent.getIntExtra("forward_to_someplace_from_shoot_quick", 0);
          if (paramInt1 == 1002)
          {
        ...
        if ((bool) || (paramIntent != null) || (!(this.jdField_a_of_type_Bmcv.a() instanceof SplashActivity))) {
          break;
        }
        if (this.jdField_a_of_type_Blly != null)
        {
  ...
  {
    super.a(paramaxmn);
    bmco localbmco = new bmcq(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView.a()).a(2).b(101).a();
  ...
  public void a(CameraCaptureView.VideoCaptureResult paramVideoCaptureResult, LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    bmcr localbmcr = new bmct().a(101).b(2).a();
