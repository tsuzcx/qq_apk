  ...
  implements Runnable
{
  ...
  public ajuf(TroopMoreDetailView paramTroopMoreDetailView)
  {
  ...
  public void run()
  {
    ...
    ((LinearLayout)((View)localObject3).findViewById(2131371581)).setVisibility(0);
    Object localObject2 = (TextView)((View)localObject3).findViewById(2131371582);
    ((TextView)localObject2).setText("共" + k + "人");
    Object localObject3 = (TextView)((View)localObject3).findViewById(2131365882);
    ...
    for (;;)
    {
      ...
      if (j < i - 1)
      {
        ...
        ((ImageView)localObject1).setOnClickListener(new ajug(this, localTroopMoreDetailView));
        if (AppSetting.b)
        {
