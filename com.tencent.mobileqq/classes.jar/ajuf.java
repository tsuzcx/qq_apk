  ...
  implements akvc
{
  ...
  public ajuf(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_Ajug = new ajug(this);
  }
  ...
  public static akvf a(UpgradeInfo paramUpgradeInfo)
  {
  ...
  private void a(aukn paramaukn, GetResourceRespInfo paramGetResourceRespInfo)
  {
    if (QLog.isColorLevel()) {
    ...
    {
      return;
      localAppShareID = bbbo.a(paramGetResourceRespInfo);
    } while (localAppShareID == null);
    if (QLog.isColorLevel()) {
      QLog.d("share_appid", 2, "parser share appid from resp info, result:  " + localAppShareID);
    }
    paramGetResourceRespInfo = (AppShareID)paramaukn.a(AppShareID.class, "strPkgName=?", new String[] { paramGetResourceRespInfo.strPkgName });
    if (paramGetResourceRespInfo == null)
    {
      paramaukn.a(localAppShareID);
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      {
        paramaukn.b(paramGetResourceRespInfo);
        paramaukn.a(localAppShareID);
        if (QLog.isColorLevel()) {
  ...
  private boolean a(String paramString, long paramLong)
  {
    ...
    do
    {
      ...
      if ("eggs_android_CI_4.7.1".equals(paramString))
      {
        ...
        {
          bbdj.d(new File(this.app.getApplication().getFilesDir(), "eggs_config.zip").getAbsolutePath());
          bbdj.d(acys.b);
          bool1 = false;
          acys.a().a(this.app.getApplication());
  ...
  private void b(UpgradeDetailWrapper paramUpgradeDetailWrapper)
  {
    ...
    do
    {
        ...
        for (;;)
        {
          ...
          if (localUpgradeInfo != null)
          {
            ...
            if ((localUpgradeInfo.iUpgradeType > 0) && (localUpgradeInfo.bNewSwitch == 1))
            {
              ...
              localObject = "1";
              axqw.b(localQQAppInterface, "CliOper", "", "", "0X8004DA5", "0X8004DA5", 0, 0, (String)localObject, "", akva.a(), "");
            ...
            for (;;)
            {
              ...
              ((Intent)localObject).putExtra("StrTitle", ajyc.a(2131702415));
              ((Intent)localObject).putExtra("StrUpgradeDesc", ajyc.a(2131702418));
      ...
      if (paramUpgradeDetailWrapper.jdField_a_of_type_ComTencentMobileqqAppNewUpgradeConfig.dialog.jdField_a_of_type_Boolean)
      {
        ...
        bdlc.a().a(BaseActivity.sTopActivity, "biz_src_yyb");
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   183: aload_0
    //   184: aload 12
    //   186: invokespecial 731	ajuf:a	(Landroid/content/Intent;)V
    //   189: aload_0
    //   190: bipush 11
    //   192: iload 8
    //   194: iload 6
    //   196: invokestatic 382	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   199: invokevirtual 273	ajuf:notifyUI	(IZLjava/lang/Object;)V
    //   202: return
    //   203: iconst_0
    //   204: istore 8
    //   206: goto -180 -> 26
    ...
    //   433: invokestatic 901	bfkq:a	(Landroid/content/Context;Ljava/lang/String;ILjava/lang/String;)Z
    //   436: istore 6
    ...
    //   721: invokestatic 942	bfkq:a	(Landroid/content/Context;)Z
    //   724: pop
    //   725: iload 5
    //   727: istore 6
    //   729: goto -684 -> 45
  ...
  private void b(GetResourceRespInfo paramGetResourceRespInfo)
  {
    ...
    do
    {
      ...
      {
        return;
        localaikx = (aikx)this.app.getManager(114);
    ...
    this.app.a(new ConfigHandler.3(this, paramGetResourceRespInfo, localaikx, l1));
  }
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        akva.a().a(bool1, str2, paramToServiceMsg);
        return;
        i = 0;
        break;
  ...
  {
    apef.jdField_a_of_type_Boolean = true;
  ...
  private void e(GetResourceRespInfo paramGetResourceRespInfo)
  {
    ...
    do
    {
      ...
      localaweo = (aweo)this.app.getManager(15);
    } while (localaweo == null);
    if (!localaweo.a(paramGetResourceRespInfo.uiNewVer))
    {
      notifyUI(7, true, Integer.valueOf(100));
      return;
    }
    ...
    this.app.a(new ConfigHandler.6(this, str, localaweo, paramGetResourceRespInfo));
  }
  ...
  public void a(int paramInt, UpgradeDetailWrapper paramUpgradeDetailWrapper, akva paramakva)
  {
    paramakva = paramUpgradeDetailWrapper.jdField_a_of_type_ProtocolKQQConfigUpgradeInfo;
    if ((paramInt == 0) && (paramakva != null))
    {
      BaseApplicationImpl.sApplication.getPackageName();
      a(paramakva);
      a(this.app, paramakva.strNewTipsDescURL, paramakva.iTipsWaitDay);
      b(this.app, paramakva.strBannerPicUrl, paramakva.iDisplayDay);
  ...
  public void a(String paramString, int paramInt, ArrayList<QQOperationViopTipTask> paramArrayList)
  {
    ...
    Object localObject2 = andi.a(this.app);
    paramArrayList = paramArrayList.iterator();
    while (paramArrayList.hasNext())
    {
      QQOperationViopTipTask localQQOperationViopTipTask = ((andi)localObject2).a(((QQOperationViopTipTask)paramArrayList.next()).taskid);
      ...
      ((andi)localObject2).a(this.app, localQQOperationVoipTipsTaskExcuteRecord);
    }
    notifyUI(8, true, localObject1);
  }
  
  public void a(String paramString, int paramInt, ArrayList<andl> paramArrayList, boolean paramBoolean)
  {
    if (TextUtils.isEmpty(paramString)) {
      return;
    }
      ...
      try
      {
        ...
        if (paramInt == 3000)
        {
          ...
          if (paramArrayList != null)
          {
            ...
            if (paramArrayList.hasNext())
            {
              andl localandl = (andl)paramArrayList.next();
              MobileTips.TaskInfo localTaskInfo = new MobileTips.TaskInfo();
              localTaskInfo.task_id.set(localandl.jdField_a_of_type_Int);
              localTaskInfo.msgcnt.set(localandl.b);
              localTaskInfo.keywords.set(localandl.jdField_a_of_type_JavaUtilArrayList);
  ...
  public boolean a()
  {
    boolean bool = bfkq.b(BaseApplicationImpl.sApplication);
    if (QLog.isDevelopLevel()) {
    ...
    try
    {
      localObject2 = bfkl.a(new File(BaseApplicationImpl.sApplication.getPackageResourcePath()));
    ...
    ((ToServiceMsg)localObject2).extraData.putInt("mv", anet.a(this.app.getApp()));
    ((ToServiceMsg)localObject2).extraData.putInt("sv", bbct.a());
  ...
  public boolean a(String paramString1, int paramInt, String paramString2)
  {
    ...
    localToServiceMsg.extraData.putInt("mv", anet.a(this.app.getApp()));
    localToServiceMsg.extraData.putInt("sv", bbct.a());
  ...
  {
    Object localObject = (aweo)this.app.getManager(15);
    if (localObject == null) {
      return null;
    }
    long l = ((aweo)localObject).a();
  ...
  public void d()
  {
    ...
    try
    {
      ...
      ((ByteBuffer)localObject).putInt(bbbd.a(Long.parseLong(this.app.getAccount()))).putShort((short)16);
  ...
  {
    ajty localajty = (ajty)this.app.getManager(59);
    if (localajty == null) {
      return null;
    }
    GetResourceReqInfo localGetResourceReqInfo = new GetResourceReqInfo();
    ...
    localGetResourceReqInfo.uiCurVer = localajty.a(true);
    localGetResourceReqInfo.sResType = 2;
    localGetResourceReqInfo.sLanType = 0;
    localGetResourceReqInfo.sReqType = 1;
    return localGetResourceReqInfo;
  ...
  public void e()
  {
    ...
    do
    {
      ...
      {
        return;
        if (aoen.a().a(this.app, BaseApplicationImpl.getApplication()) != 0) {
          break;
        }
      } while (!QLog.isColorLevel());
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    else
    {
      ...
      if (paramToServiceMsg.extraData.getBoolean("reqRegionConfig")) {
        ((ajty)this.app.getManager(59)).a(null);
      }
    }
    label119:
    do
    ...
    for (;;)
    {
      ...
      else if (paramFromServiceMsg.sResType == 2)
      {
        ...
        {
          paramObject = (ajty)this.app.getManager(59);
          if (paramObject != null) {
      ...
      {
        paramObject = (anox)this.app.getManager(77);
        if (paramObject != null) {
          paramObject.a(paramFromServiceMsg);
        }
      }
