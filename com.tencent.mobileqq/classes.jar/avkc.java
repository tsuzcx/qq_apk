...
public class avkc
  extends altm
{
  public avkc(NearbyPeopleProfileActivity paramNearbyPeopleProfileActivity) {}
  
  public void a()
  {
    boolean bool = this.a.g;
    alto localalto = (alto)this.a.app.getManager(51);
    if (localalto != null) {
      bool = localalto.b(NearbyPeopleProfileActivity.a(this.a).uin);
    }
    for (;;)
    {
      if (bool != this.a.g)
