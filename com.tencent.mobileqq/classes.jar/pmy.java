...
public class pmy
  implements Handler.Callback, bdlx, Manager
{
  ...
  public pmy(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    if (bhhr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()))
    {
