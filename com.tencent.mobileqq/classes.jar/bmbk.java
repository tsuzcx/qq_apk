  ...
  implements SensorEventListener
{
  ...
  private bmbl jdField_a_of_type_Bmbl;
  private float[] jdField_a_of_type_ArrayOfFloat = new float[3];
  private float[] b = new float[3];
  
  public bmbk(Context paramContext, bmbl parambmbl)
  {
    ...
    this.jdField_a_of_type_Bmbl = parambmbl;
  }
  ...
  public void onSensorChanged(SensorEvent paramSensorEvent)
  {
    if (paramSensorEvent.sensor.getType() == 4)
    {
      if (this.jdField_a_of_type_Long != 0L)
      {
        ...
        if (this.jdField_a_of_type_Bmbl != null) {
          this.jdField_a_of_type_Bmbl.a(f1 * 1.0F, f2 * 1.0F, f3 * 1.0F);
        }
