  ...
  implements asrm
{
  ...
  public asrq(QQAppInterface paramQQAppInterface, FileManagerEntity paramFileManagerEntity)
  {
  ...
  private String a(String paramString, int paramInt, List<String> paramList, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((paramBoolean) && (paramList != null) && (paramList.size() > 0))
      {
        ...
        paramString = asgv.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1, paramList);
      ...
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        while (paramInt < i)
        {
          paramList = (asgx)paramString.a.get(paramInt);
  ...
  public void a(ashw paramashw)
  {
    ...
    {
      a(true);
      paramashw.a(-6101, BaseApplication.getContext().getResources().getString(2131692553));
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileTransferHandler().a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileIdCrc, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.bSend, false, new asrr(this, paramashw));
  }
  ...
  public String b()
  {
    return asyy.a().c() + bjkz.a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid);
  }
