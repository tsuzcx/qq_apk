  ...
  extends apgu
{
  ...
  public apgz(QQAppInterface paramQQAppInterface)
  {
  ...
  public void c()
  {
    boolean bool = arof.a(new File(anah.a()));
    if (QLog.isColorLevel()) {
  ...
  {
    int i = 0;
    long l1 = anak.a("report_tag_so_cover", 0L);
    ...
    for (;;)
    {
      anak.a(paramBoolean, i, str);
      anak.a("report_tag_so_cover", l2);
      return;
      label102:
      paramBoolean = false;
      continue;
