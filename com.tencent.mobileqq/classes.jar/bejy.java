  ...
  extends beqt
{
  ...
  public bejy(String paramString, MiniAppBaseInfo paramMiniAppBaseInfo)
  {
  ...
  public static bejy a(String paramString1, String paramString2, MiniAppBaseInfo paramMiniAppBaseInfo)
  {
    if ((TextUtils.isEmpty(paramString1)) || (!new File(paramString1).exists())) {
      return null;
    }
    paramString1 = new bejy(paramString1, paramMiniAppBaseInfo);
  ...
  public bejz a()
  {
    ...
    bejz localbejz = new bejz();
    if (!((File)localObject).exists())
    {
      localbejz.jdField_a_of_type_JavaLangString = b();
      return localbejz;
    }
    try
    {
      localObject = bekq.a((File)localObject);
      ...
      localbejz.jdField_a_of_type_JavaLangString = ((String)localObject);
      localbejz.jdField_b_of_type_JavaLangString = str;
      return localbejz;
    }
  ...
  public bequ a()
  {
    return this.jdField_a_of_type_Bequ;
  }
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        this.jdField_b_of_type_JavaLangString = bekq.b(new File(e() + "/" + paramString, "app-config.json"));
        ...
        this.jdField_a_of_type_Bequ = bequ.a(this.jdField_b_of_type_JavaLangString);
        return;
      }
      ...
      this.jdField_b_of_type_JavaLangString = bekq.b(new File(e(), "app-config.json"));
    }
  }
  ...
  public boolean a(String paramString)
  {
    ...
    Object localObject = this.jdField_a_of_type_Bequ.jdField_a_of_type_Berw;
    if (localObject != null)
    {
      localObject = ((berw)localObject).a.iterator();
      while (((Iterator)localObject).hasNext()) {
        if (((berx)((Iterator)localObject).next()).jdField_a_of_type_JavaLangString.equals(paramString)) {
          return true;
        }
      }
    }
  ...
  public boolean a(String paramString, MiniAppBaseInfo paramMiniAppBaseInfo)
  {
    ...
    {
      return true;
      paramString = new File(beip.a(paramMiniAppBaseInfo, false), paramString).getAbsolutePath();
      bool = new File(paramString).exists();
      besl.a("ApkgInfo", "isUrlResReady | subFolderPath :" + paramString + "isExist:" + bool);
    } while (bool);
    return false;
  }
  ...
  public String b(String paramString)
  {
    ...
    try
    {
      String str3 = bekq.b(new File(e(), str2));
      paramString = str1;
  ...
  public boolean b(String paramString)
  {
    ...
    do
    {
      return false;
      paramString = bekj.a(paramString);
    } while ((!a(paramString)) && (!paramString.equals(this.jdField_a_of_type_Bequ.jdField_a_of_type_JavaLangString)));
    return true;
  }
  
  public String c(String paramString)
  {
    return this.jdField_a_of_type_Bequ.a(paramString);
  }
  
  public boolean c(String paramString)
  {
    if (TextUtils.isEmpty(paramString)) {}
    while (!new File(g(bekj.a(paramString))).exists()) {
      return false;
    }
    return true;
  }
  ...
  {
    return bekq.a(new File(d(paramString)));
  }
  
  public String f(String paramString)
  {
    paramString = this.jdField_a_of_type_Bequ.a(paramString);
    if (TextUtils.isEmpty(paramString)) {
      return "";
    }
    paramString = new File(new File(e(), paramString), "page-frame.js");
    if (paramString.exists()) {
      return bekq.a(paramString);
    }
    return "";
  }
}
