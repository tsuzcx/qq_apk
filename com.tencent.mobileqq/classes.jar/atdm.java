...
public class atdm
{
  private static atdm jdField_a_of_type_Atdm;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver;
  public QQAppInterface a;
  private List<atdt> jdField_a_of_type_JavaUtilList = new ArrayList();
  private Map<String, atdr> jdField_a_of_type_JavaUtilMap = new HashMap();
  private boolean jdField_a_of_type_Boolean = false;
  private Map<String, atgv> jdField_b_of_type_JavaUtilMap = new HashMap();
  ...
  private int a(String paramString)
  {
    ...
    {
      atdr localatdr = (atdr)this.jdField_a_of_type_JavaUtilMap.remove(paramString);
      if (localatdr != null)
      {
        atgv localatgv = a(paramString);
        if ((localatdr.jdField_a_of_type_Atgs != null) && (localatgv != null)) {
          localatdr.jdField_a_of_type_Atgs.a(localatgv);
        }
      }
  ...
  private int a(String paramString, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      catch (UnsupportedEncodingException localUnsupportedEncodingException)
      {
        ...
        int k = localUnsupportedEncodingException.jdField_a_of_type_Atgs.f();
      ...
      if ((localObject2 == null) && (paramBundle.containsKey("big_brother_source_key")))
      {
        ...
        if ((localObject2 != null) && ((localObject2 == null) || (((atdr)localObject2).jdField_a_of_type_Atgs != null))) {
          break label201;
        }
    ...
    localUnsupportedEncodingException.jdField_a_of_type_Atgs.a(paramString);
    localUnsupportedEncodingException.jdField_a_of_type_Atgs.a(paramString, false);
    return 0;
    d(paramString);
    return 0;
    a(paramString);
  ...
  private int a(String paramString1, String paramString2, long paramLong, String paramString3, Bundle paramBundle, int paramInt, boolean paramBoolean)
  {
    ...
    long l = a();
    atgs localatgs = new atgs(l, paramString1, paramBundle);
    ...
    if (1 == localatgs.g())
    {
      ...
      paramInt = atdu.a().a(localatgs, (Bundle)localObject, l, paramInt);
      a(paramString1, new atdr(this, null, localatgs.g(), localatgs, l, paramInt));
      if (!paramBoolean) {
        break label435;
      }
    ...
    for (;;)
    {
      ...
      {
        localatgs.a(true);
        atdu.a().b(paramInt, (Bundle)localObject);
      }
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
        if (1 == localatgs.g()) {
          bcev.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "Start_download_2-0_3-0");
        } else if (2 == localatgs.g()) {
          bcev.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "Start_download_2-0_3-1");
        }
      }
    }
  }
  ...
  public static atdm a()
  {
    try
    {
      if (jdField_a_of_type_Atdm == null)
      {
        QLog.i("UniformDownloadMgr<FileAssistant>", 1, "[UniformDL] UniformDownloadMgr.getInstance.create");
        jdField_a_of_type_Atdm = new atdm();
      }
      atdm localatdm = jdField_a_of_type_Atdm;
      return localatdm;
    }
    finally {}
  }
  
  private atdr a(String paramString)
  {
    synchronized (this.jdField_a_of_type_JavaUtilMap)
    {
      paramString = (atdr)this.jdField_a_of_type_JavaUtilMap.get(paramString);
      return paramString;
    }
  }
  
  private atds a(String paramString)
  {
    if (paramString == null)
    {
  ...
  private atdt a(String paramString)
  {
    if (paramString == null)
    {
    ...
    return new atdt(arrayOfString[0], Integer.parseInt(arrayOfString[1]));
  }
  
  private atgv a(String paramString)
  {
    if (paramString == null) {
      paramString = null;
    }
    for (;;)
    {
      ...
      try
      {
        paramString = (atgv)this.jdField_b_of_type_JavaUtilMap.get(paramString);
      }
      finally {}
    }
  }
  
  private String a(atds paramatds)
  {
    if (paramatds == null)
    {
    ...
    return String.valueOf(paramatds.jdField_a_of_type_Int) + "^" + paramatds.jdField_a_of_type_JavaLangString + "^" + String.valueOf(paramatds.jdField_a_of_type_Long) + "^" + String.valueOf(paramatds.jdField_a_of_type_Boolean) + "^" + paramatds.b;
  }
  
  private String a(atdt paramatdt)
  {
    if (paramatdt == null)
    {
    ...
    return String.valueOf(paramatdt.jdField_a_of_type_JavaLangString) + "^" + String.valueOf(paramatdt.jdField_a_of_type_Int);
  }
  
  private void a(String paramString, atgv paramatgv)
  {
    if ((paramString != null) && (paramatgv != null)) {}
    try
    {
      this.jdField_b_of_type_JavaUtilMap.put(paramString, paramatgv);
      return;
    }
    finally
    {
  ...
  private boolean a(String paramString, atdr paramatdr)
  {
    if ((paramString == null) || (paramatdr == null))
    {
    ...
    this.jdField_a_of_type_JavaUtilMap.put(paramString, paramatdr);
  ...
  {
    int i = 0;
    if ((NetworkUtil.isNetSupport(BaseApplication.getContext())) && (!aszt.a())) {}
    for (int m = 2;; m = 1)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaUtilMap)
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          int n = j;
          k = i;
          if (localatdr.jdField_a_of_type_Atgs != null)
          {
            n = j;
            k = i;
            if (localatdr.jdField_a_of_type_Atgs.b())
            {
              i += 1;
              n = j;
              k = i;
              if (paramString != null)
              {
                n = j;
                k = i;
                if (paramString.equalsIgnoreCase(localatdr.jdField_a_of_type_JavaLangString))
                {
          ...
          ((List)localObject2).add(localatdr);
          j = n;
          i = k;
        }
      }
      ...
      for (;;)
      {
        if (j < m)
        {
          ...
          if (((Iterator)???).hasNext())
          {
            localObject2 = (atdr)((Iterator)???).next();
            k = j;
            if (((atdr)localObject2).jdField_a_of_type_Atgs == null) {
              break label526;
            }
            k = j;
            if (!((atdr)localObject2).jdField_a_of_type_Atgs.a()) {
              break label526;
            }
            if (j < m)
            {
              QLog.i("UniformDownloadMgr<FileAssistant>", 1, "[UniformDL] >>> Happy. start a download task, url:[" + ((atdr)localObject2).jdField_a_of_type_JavaLangString + "]");
              j += 1;
              ((atdr)localObject2).jdField_a_of_type_Atgs.a();
              k = j;
              if (paramString == null) {
                break label526;
              }
              k = j;
              if (!paramString.equalsIgnoreCase(((atdr)localObject2).jdField_a_of_type_JavaLangString)) {
                break label526;
              }
  ...
  private int b(String paramString, Bundle paramBundle)
  {
    ...
    if (-1 == c(paramString))
    {
      atgn.a(paramString, new atdq(this));
      atdu.a().a(i, (Bundle)paramBundle.clone());
      b(null);
    }
    return 0;
  }
  
  private atgv b(String paramString)
  {
    try
    {
      paramString = (atgv)this.jdField_b_of_type_JavaUtilMap.remove(paramString);
      return paramString;
    }
    finally
    {
  ...
  {
    atdr localatdr = a(paramString);
    if (localatdr != null)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
      {
        if (localatdr.jdField_a_of_type_Int != 1) {
          break label71;
        }
        bcev.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "Stop_download_2-2_3-0");
      }
      for (;;)
      {
        if (localatdr.jdField_a_of_type_Atgs != null) {
          localatdr.jdField_a_of_type_Atgs.b();
        }
        b(null);
        return 0;
        label71:
        bcev.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "Stop_download_2-2_3-1");
      }
    }
  ...
  private int d(String paramString)
  {
    ...
    if (localatdr != null)
    {
      if (localatdr.jdField_a_of_type_Atgs != null)
      {
        paramString = a(paramString);
        if (paramString != null) {
          localatdr.jdField_a_of_type_Atgs.a(paramString, false);
        }
        localatdr.jdField_a_of_type_Atgs.c();
      }
      b(null);
      return 0;
    }
  ...
  private int e(String paramString)
  {
    ...
    {
      if (localatdr.jdField_a_of_type_Atgs != null) {
        localatdr.jdField_a_of_type_Atgs.d();
      }
      return 0;
    }
  ...
  private void g(String paramString, Bundle paramBundle)
  {
    ...
    bcfv.a().addDownloadURL(paramString);
    ...
    if (bhyn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) {}
    Object localObject2;
    ...
    for (;;)
    {
      try
      {
        ...
        bcef.b(null, "dc00898", "", "", "0X800A003", "0X800A003", 0, 0, paramBundle, (String)localObject1, (String)localObject2, paramString);
      }
      ...
      paramString = (String)localHashMap.get("Stack1");
      bcef.b(null, "dc00898", "", "", "0X800A002", "0X800A002", 0, 0, paramBundle, (String)localObject1, (String)localObject2, paramString);
    }
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if ((??? != null) && (((Map)???).size() > 0))
        {
          ...
          if (localIterator.hasNext())
          {
            atdt localatdt = a((String)((Map.Entry)localIterator.next()).getKey());
            if (localatdt == null) {
              break label207;
            }
            QLog.i("UniformDownloadMgr<FileAssistant>", 1, "[UniformDL] initSucDownloadInfo, pkgName:[" + localatdt.jdField_a_of_type_JavaLangString + "]] nId:[" + localatdt.jdField_a_of_type_Int + "] ");
            synchronized (this.jdField_a_of_type_JavaUtilList)
            {
              this.jdField_a_of_type_JavaUtilList.add(localatdt);
            }
          }
        }
        return;
  ...
  public long a(String paramString, int paramInt)
  {
    ...
    //   106: iconst_1
    //   107: isub
    //   108: invokevirtual 764	atdm:a	(Ljava/lang/String;I)J
    //   111: lreturn
    //   112: iload 5
    //   114: istore_3
    //   115: aload 11
  ...
  public List<atdt> a(String paramString, boolean paramBoolean)
  {
    if (paramString == null) {
      return null;
    }
    ...
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      ...
      {
        localatdt = (atdt)localIterator.next();
        if ((localatdt != null) && (paramString.equalsIgnoreCase("package:" + localatdt.jdField_a_of_type_JavaLangString))) {
          localArrayList.add(localatdt);
        }
      }
    }
    if ((localArrayList.size() > 0) && (paramBoolean))
    {
      ...
      try
      {
        ...
        {
          localatdt = (atdt)localIterator.next();
          this.jdField_a_of_type_JavaUtilList.remove(localatdt);
          paramString.remove(a(localatdt));
          continue;
      ...
      try
      {
        ...
        if ((localObject1 != null) && (((Map)localObject1).size() > 0))
        {
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            QLog.i("UniformDownloadMgr<FileAssistant>", 1, "[UniformDL] getDownloadingRbResmeInfo, url:[" + str + "]] nId:[" + ((atds)localObject2).jdField_a_of_type_Int + "] w:[" + ((atds)localObject2).jdField_a_of_type_Boolean + "]");
  ...
  public void a(atdt paramatdt)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      this.jdField_a_of_type_JavaUtilList.add(paramatdt);
      QLog.i("UniformDownloadMgr<FileAssistant>", 1, "[UniformDL] saveSucDownloadInfo. pkgName:" + paramatdt.jdField_a_of_type_JavaLangString + " notificationId:" + paramatdt.jdField_a_of_type_Int + " size:" + this.jdField_a_of_type_JavaUtilList.size());
      try
      {
        ??? = BaseApplication.getContext().getSharedPreferences("download_suc_info", 0).edit();
        ((SharedPreferences.Editor)???).putString(a(paramatdt), "-");
        ((SharedPreferences.Editor)???).commit();
        return;
      }
      catch (Exception paramatdt)
      {
        paramatdt.printStackTrace();
        return;
      }
    }
  }
  ...
  {
    atgv localatgv = b(paramString);
    if (!TextUtils.isEmpty(paramString))
    {
      paramString = a(paramString);
      if ((paramString != null) && (paramString.jdField_a_of_type_Atgs != null) && (localatgv != null)) {
        paramString.jdField_a_of_type_Atgs.a(localatgv);
      }
    }
  }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaUtilList)
      {
        ...
        if (localIterator.hasNext())
        {
          localObject = (atdt)localIterator.next();
          if ((localObject == null) || (!paramString.equalsIgnoreCase(((atdt)localObject).jdField_a_of_type_JavaLangString)) || (paramInt != ((atdt)localObject).jdField_a_of_type_Int)) {
            continue;
          }
          if (localObject != null)
          {
          ...
          try
          {
            ...
            ((SharedPreferences.Editor)localObject).remove(a(new atdt(paramString, paramInt)));
  ...
  public void a(String paramString, Bundle paramBundle, atgv paramatgv)
  {
    atgv localatgv = a(paramString);
    a(paramString, paramatgv);
    ThreadManager.getSubThreadHandler().post(new UniformDownloadMgr.9(this, paramBundle, paramString, localatgv));
  }
  
  public void a(String paramString1, String paramString2)
  {
    atgn.a(paramString1, new atdo(this, paramString1, paramString2));
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3, long paramLong, Bundle paramBundle, int paramInt, boolean paramBoolean)
  {
    try
    {
      ...
      atds localatds = new atds(this);
      localatds.jdField_a_of_type_Int = paramInt;
      localatds.jdField_a_of_type_JavaLangString = paramString2;
      if (!TextUtils.isEmpty(paramString3)) {}
      for (localatds.b = paramString3;; localatds.b = paramString2)
      {
        localatds.jdField_a_of_type_Long = paramLong;
        localatds.jdField_a_of_type_Boolean = paramBoolean;
        localatds.jdField_a_of_type_AndroidOsBundle = paramBundle;
        localEditor.putString(paramString1, a(localatds));
        localEditor.commit();
        return;
      }
      return;
  ...
  public void c()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilMap)
    {
      if (this.jdField_a_of_type_JavaUtilMap.size() > 0)
      {
        ...
        {
          atdr localatdr = (atdr)((Map.Entry)localIterator.next()).getValue();
          if ((localatdr.jdField_a_of_type_Atgs != null) && (localatdr.jdField_a_of_type_Atgs.b())) {
            QLog.i("UniformDownloadMgr<FileAssistant>", 1, "[UniformDL] >>>onQQProcessExit. stop download:url:" + localatdr.jdField_a_of_type_JavaLangString);
          }
          Bundle localBundle = new Bundle();
          localBundle.putString("_notify_param_Url", localatdr.jdField_a_of_type_JavaLangString);
          atdu.a().c(localatdr.b, localBundle);
          QLog.i("UniformDownloadMgr<FileAssistant>", 1, "[UniformDL] >>>onQQProcessExit. cancel notification:" + localatdr.b);
        }
      }
    }
    e();
