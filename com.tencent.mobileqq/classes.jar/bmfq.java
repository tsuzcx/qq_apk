...
public class bmfq
{
  ...
  public static bmfl a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      return bmfl.a((String)localObject);
  ...
  public static void a(int paramInt, QqLiveMsg paramQqLiveMsg)
  {
    ...
    if ((paramQqLiveMsg != null) || ((paramQqLiveMsg != null) && (!TextUtils.isEmpty(paramQqLiveMsg.anchorUrl)) && (!TextUtils.isEmpty(paramQqLiveMsg.viewerUrl))))
    {
      ...
      a(paramQqLiveMsg);
      bmfr.a().a(paramQqLiveMsg.isPreload);
    }
  ...
  private static void a(QqLiveMsg paramQqLiveMsg)
  {
    ...
    localbmfl.jdField_a_of_type_Boolean = bmfx.c();
    localbmfl.c = paramQqLiveMsg.anchorUrl;
    localbmfl.d = paramQqLiveMsg.anchorUrlMd5;
    localbmfl.jdField_a_of_type_JavaLangString = paramQqLiveMsg.viewerUrl;
    localbmfl.b = paramQqLiveMsg.viewerUrlMd5;
    QLog.e("IliveFileDbManager", 1, "saveIlivePluginConfig anchorMd5 = " + localbmfl.d + " mWatchPluginMd5 = " + localbmfl.b);
    a(1, localbmfl);
  }
  ...
  public static boolean a(int paramInt, bmfl parambmfl)
  {
    if (parambmfl == null) {
      return false;
    }
    ...
    for (;;)
    {
      parambmfl = bmfl.a(parambmfl);
      boolean bool = localSharedPreferences.edit().putString(str, parambmfl).commit();
      if (QLog.isColorLevel()) {
        QLog.d("IliveFileDbManager", 1, "saveIliveConfigBean set sp key:" + str + " json value = " + parambmfl);
      }
      return bool;
      str = "ilive_plugin_new_data";
      continue;
