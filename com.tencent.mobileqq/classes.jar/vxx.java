...
public abstract class vxx
  extends wbp<CertifiedAccountMeta.StFeed>
  implements wcl, wgr
{
  ...
  private void a(SubscribeFeedsEvent paramSubscribeFeedsEvent)
  {
        ...
        do
        {
          do
          {
            ...
            if (this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StUser == null) {
              this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StUser = ((CertifiedAccountMeta.StUser)a("share_key_subscribe_user").a);
            }
            ...
            case 1: 
              if (this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StUser != null)
              {
                paramSubscribeFeedsEvent.mSingleFakeFeed.poster.icon.set(this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StUser.icon.get());
                paramSubscribeFeedsEvent.mSingleFakeFeed.poster.nick.set(this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StUser.nick.get());
              }
    ...
    if (this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StUser != null)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        {
          localStFeed.poster.icon.set(this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StUser.icon.get());
          localStFeed.poster.nick.set(this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StUser.nick.get());
        }
      }
    }
  ...
  public void a(String paramString, wbv paramwbv)
  {
    ...
    if ((paramString.equals("share_key_subscribe_user")) && (paramwbv.a != null)) {
      this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StUser = ((CertifiedAccountMeta.StUser)paramwbv.a);
    }
  }
