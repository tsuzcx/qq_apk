  ...
  implements rwn
{
  ...
  public rwj(Activity paramActivity)
  {
  ...
  private static void b(boolean paramBoolean, int paramInt, KandianMsgBoxRedPntInfo paramKandianMsgBoxRedPntInfo)
  {
    ...
    for (;;)
    {
      try
      {
        localorz.k(1037);
        localorz.a(0);
        localorz.a("message_type", String.valueOf(paramKandianMsgBoxRedPntInfo.messageType));
        localorz.a("feedsid", String.valueOf(paramKandianMsgBoxRedPntInfo.feedsID));
        localorz.a("feedstype", String.valueOf(paramKandianMsgBoxRedPntInfo.feedsType));
        if (paramKandianMsgBoxRedPntInfo.mMsgType == 2)
        {
          localorz.a("sys_msg_id", String.valueOf(paramKandianMsgBoxRedPntInfo.sysMsgID));
          localorz.a("sys_msg_from", String.valueOf(paramKandianMsgBoxRedPntInfo.sysMsgFrom));
        }
        localorz.a("reddot_num", String.valueOf(paramKandianMsgBoxRedPntInfo.mMsgCnt));
        localorz.b("msgbox1000000000");
        if (paramBoolean) {
          break label220;
        }
        localorz.a("behavior_type", String.valueOf(paramInt));
      }
      ...
      nrt.a(null, "CliOper", "", String.valueOf(paramKandianMsgBoxRedPntInfo.mUin), str, str, 0, 0, String.valueOf(paramKandianMsgBoxRedPntInfo.mUin), "", "", localorz.a(), false);
      return;
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setOnClickListener(new rwk(this));
  }
  ...
  public void a(KandianMsgBoxRedPntInfo paramKandianMsgBoxRedPntInfo)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          localTemplateBean = ProteusParser.getTemplateBean(sfq.a("default_feeds", true), localJSONObject);
        }
