...
class bgsz
  extends nkp
{
  bgsz(bgsu parambgsu, bgst parambgst, String paramString1, String paramString2) {}
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    if ((paramInt != 0) || (paramArrayOfByte == null) || (this.jdField_a_of_type_Bgst == null))
    {
      if (QLog.isColorLevel()) {
        QLog.i(".troop.send_gift", 2, "send_oidb_0x6c2. onResult error=" + paramInt + " data=" + paramArrayOfByte + " callback=" + this.jdField_a_of_type_Bgst);
      }
    ...
    try
    {
      ...
      if ((paramInt == 0) && (localRspBody.msg_gift_bag_info.has()))
      {
        ...
        if (paramArrayOfByte != null)
        {
          ...
          this.jdField_a_of_type_Bgsu.a.put(paramArrayOfByte, paramBundle);
    ...
    if ((paramInt == 1) && (localRspBody.int32_player.has()))
    {
      ...
      this.jdField_a_of_type_Bgst.c(paramInt);
      return;
    }
