...
public class wmq
{
  private static final String jdField_a_of_type_JavaLangString = wmq.class.getSimpleName();
  private Handler jdField_a_of_type_AndroidOsHandler;
  private Map<String, ArrayList<CertifiedAccountMeta.StComment>> jdField_a_of_type_JavaUtilMap = new HashMap();
  private Map<String, Integer> b = new HashMap();
  private Map<String, wna> c = new HashMap();
  ...
  private void a(String paramString, COMM.StCommonExt paramStCommonExt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      wna localwna = new wna();
      localwna.jdField_a_of_type_NS_COMMCOMM$StCommonExt = paramStCommonExt;
      localwna.jdField_a_of_type_Boolean = paramBoolean1;
      localwna.b = paramBoolean2;
      this.c.put(paramString, localwna);
      QLog.d(jdField_a_of_type_JavaLangString, 1, "getDetailCommentSize: attachInfo:" + paramStCommonExt.attachInfo.get());
      return;
    }
    ((wna)this.c.get(paramString)).jdField_a_of_type_Boolean = paramBoolean1;
    ((wna)this.c.get(paramString)).jdField_a_of_type_NS_COMMCOMM$StCommonExt = paramStCommonExt;
  }
  
  private void a(String paramString, boolean paramBoolean)
  {
    if ((this.c != null) && (this.c.get(paramString) != null)) {
      ((wna)this.c.get(paramString)).b = paramBoolean;
    }
  }
  ...
  private void a(boolean paramBoolean, long paramLong, String paramString, CertifiedAccountRead.StGetFeedDetailRsp paramStGetFeedDetailRsp, COMM.StCommonExt paramStCommonExt)
  {
    if (paramStGetFeedDetailRsp != null)
    {
      ...
      ste.a().dispatch(new wnd(5, new Object[] { str, Integer.valueOf(a(str)) }));
    }
    ste.a().dispatch(a(new Object[] { Integer.valueOf(2), Long.valueOf(paramLong), paramString, paramStGetFeedDetailRsp, Integer.valueOf(hashCode()), paramStCommonExt }));
  }
  ...
  public long a(CertifiedAccountMeta.StFeed paramStFeed, CertifiedAccountMeta.StComment paramStComment)
  {
    ...
    VSNetworkHelper.a().a(paramStFeed, new wmx(this));
  ...
  public long a(CertifiedAccountMeta.StFeed paramStFeed, CertifiedAccountMeta.StComment paramStComment, CertifiedAccountMeta.StReply paramStReply)
  {
    ...
    VSNetworkHelper.a().a(paramStFeed, new wmv(this, paramStComment, paramStReply));
    return 0L;
  }
  ...
  public COMM.StCommonExt a(String paramString)
  {
    ...
    paramString = (wna)this.c.get(paramString);
    if (paramString != null)
    {
  ...
  public String a(CertifiedAccountMeta.StFeed paramStFeed, CertifiedAccountMeta.StComment paramStComment)
  {
    ...
    {
      ste.a().dispatch(a(new Object[] { Integer.valueOf(5), Integer.valueOf(-1), ajyc.a(2131702164), null }));
      return "";
    }
    paramStFeed = new DoCommentRequest(paramStFeed, paramStComment, 0);
    VSNetworkHelper.a().a(paramStFeed, new wmu(this, paramStComment));
  ...
  public String a(CertifiedAccountMeta.StFeed paramStFeed, CertifiedAccountMeta.StComment paramStComment, CertifiedAccountMeta.StReply paramStReply)
  {
    ...
    {
      ste.a().dispatch(a(new Object[] { Integer.valueOf(5), Integer.valueOf(-1), ajyc.a(2131702162), null }));
      return "";
    }
    paramStFeed = new DoReplyReq(paramStFeed, paramStComment, paramStReply, 0);
    VSNetworkHelper.a().a(paramStFeed, new wmw(this, paramStReply, paramStComment));
  ...
  public wnd a(Object... paramVarArgs)
  {
    return new wnd(6, paramVarArgs);
  }
  ...
  public void a(CertifiedAccountMeta.StFeed paramStFeed, CertifiedAccountMeta.StComment paramStComment)
  {
    ...
    VSNetworkHelper.a().a(paramStFeed, new wmt(this, paramStComment));
  }
  ...
  {
    paramStFeed = new DoLikeRequest(paramStFeed);
    VSNetworkHelper.a().a(paramStFeed, new wmy(this));
  }
  
  public void a(CertifiedAccountMeta.StFeed paramStFeed, COMM.StCommonExt paramStCommonExt)
  {
    wmr localwmr = new wmr(this, paramStCommonExt);
    if (paramStCommonExt == null)
    {
      String str = paramStFeed.id.get();
      if (wrb.a("1002" + str))
      {
        wrb.a("1002" + str, new wms(this, localwmr));
        wrb.a("1002" + str);
        return;
      }
    }
    ...
    VSNetworkHelper.a().a(paramStFeed, localwmr);
  }
  ...
  public void a(CertifiedAccountMeta.StFeed paramStFeed, COMM.StCommonExt paramStCommonExt, String paramString)
  {
    ...
    VSNetworkHelper.a().a(paramStCommonExt, new wmz(this, paramStFeed, paramString));
  }
