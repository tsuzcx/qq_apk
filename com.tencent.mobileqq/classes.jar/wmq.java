...
public class wmq
{
  ...
  public static wmq a(List<wmq> paramList, long paramLong)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if (paramLong == localwmq.jdField_a_of_type_Long) {
        return localwmq;
      }
    }
    return null;
  ...
  public void a(@NonNull JSONObject paramJSONObject)
  {
    try
    {
      ...
      if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
        this.jdField_a_of_type_ComTencentBizQqstoryModelItemStoryVideoItem = ((wjp)wjs.a(5)).a(this.jdField_a_of_type_JavaLangString);
      }
      return;
    }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    {
      return true;
      if (!(paramObject instanceof wmq)) {
        return false;
      }
      paramObject = (wmq)paramObject;
