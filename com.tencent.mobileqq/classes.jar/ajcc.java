...
import com.tencent.mobileqq.activity.home.Conversation.36.1;
import com.tencent.mobileqq.activity.home.Conversation.36.2;
...
{
  public ajcc(Conversation paramConversation) {}
  ...
  public void onCardDownload(boolean paramBoolean, Object paramObject)
  {
    ...
    for (paramObject = (Card)paramObject;; paramObject = null)
    {
      ...
      {
        if (!bftf.a(paramObject.uin, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())) {
      ...
      Conversation.b(this.a, "onCardDownload");
      return;
    }
  }
  ...
  public void onSetNotDisturb(boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      if (!paramBoolean)
      {
        ThreadManagerV2.getUIHandlerV2().post(new Conversation.36.1(this));
        return;
      }
      Conversation.a(this.a.jdField_a_of_type_MqqOsMqqHandler, this.a.a());
    } while (FriendsStatusUtil.a(this.a.a()));
    ThreadManagerV2.getUIHandlerV2().post(new Conversation.36.2(this));
  }
  ...
  public void onUpdateAvatar(boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    if ((paramBoolean) && (this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (bftf.a(paramString, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))) {
