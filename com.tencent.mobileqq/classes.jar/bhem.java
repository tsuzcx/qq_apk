...
public class bhem
{
  private final bhes a = new bhes(null);
  
  public static bhem a()
  {
    return bhet.a();
  }
  ...
  public static String a(@Nullable BusinessInfoCheckUpdate.AppInfo paramAppInfo)
  {
    ...
    {
      paramAppInfo = bher.a(paramAppInfo);
  ...
  public static String a(String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      paramString1 = "&trace_detail=base64-" + aswz.a(localJSONObject.toString());
      return paramString1;
    }
  ...
  {
    if (paramAppInfo != null) {
      return String.format("&trace_detail=base64-%s", new Object[] { aswz.a(bheq.a(paramAppInfo).a()) });
    }
    return null;
  }
  ...
  public void a(@Nullable BusinessInfoCheckUpdate.AppInfo paramAppInfo, int paramInt)
  {
    ...
    bher localbher = bher.a(paramAppInfo);
    ItemInfo localItemInfo = new bhep(null).a(localbher.b).b(paramAppInfo.buffer.get()).a(new bheo(System.currentTimeMillis(), paramInt).a()).a();
    ...
    for (;;)
    {
      QLog.d("MobileReport.Manager", 2, "report " + localbher.toString() + " actionId = " + paramAppInfo);
      bhes.a(this.a, localbher, localItemInfo);
      return;
      label120:
      if (101 == paramInt) {
  ...
  public void a(String paramString1, int paramInt1, long paramLong, String paramString2, int paramInt2, String paramString3)
  {
    ...
    {
      localbher = new bher("", 0, "", 0, "H5CostReport", paramString1, null);
    ...
    try
    {
      ...
      paramString3 = new bhep(null).a("").b(localJSONObject.toString()).a(new bheo(System.currentTimeMillis(), paramInt1, paramLong).a()).a();
      if (QLog.isColorLevel()) {
        QLog.d("MobileReport.Manager", 2, "report " + localbher.toString() + " opType = " + paramInt1 + " url = " + paramString1 + " timecost " + paramLong + " errorcode " + paramString2);
      }
      bhes.a(this.a, localbher, paramString3);
      return;
    }
