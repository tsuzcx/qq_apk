...
public class bhem
  extends BaseAdapter
{
  public bhem(GridListView paramGridListView) {}
  ...
  private LinearLayout a(ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup.setTag(new bhek(null));
  ...
  public int getItemViewType(int paramInt)
  {
    ...
    if (this.a.jdField_a_of_type_Int == 0) {
      return this.a.jdField_a_of_type_Bhel.getItemViewType(paramInt) + 2;
    }
    return 1;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      bhek localbhek = (bhek)((LinearLayout)localObject1).getTag();
      ...
      if (j < i)
      {
        paramView = localbhek.a[j];
        m = this.a.jdField_a_of_type_Bhel.b(k + j);
      ...
      for (;;)
      {
        View localView = this.a.jdField_a_of_type_Bhel.getView(k + j, paramView, (ViewGroup)localObject1);
        localView.setTag(2131361856, Integer.valueOf(m));
        localbhek.a[j] = localView;
        ...
        if ((this.a.jdField_a_of_type_ComTencentWidgetAdapterView$OnItemClickListener != null) && (this.a.jdField_a_of_type_Bhel.isEnabled(k + j)))
        {
        ...
        i = this.a.jdField_a_of_type_Bhel.a(paramInt) + 2;
        localObject1 = paramView;
        if (paramView != null)
        {
          localObject1 = paramView;
        ...
        paramView = this.a.jdField_a_of_type_Bhel.getView(paramInt, (View)localObject1, paramViewGroup);
        paramView.setTag(2131361856, Integer.valueOf(i));
        if ((this.a.jdField_a_of_type_ComTencentWidgetAdapterView$OnItemClickListener != null) && (this.a.jdField_a_of_type_Bhel.isEnabled(paramInt)))
        {
