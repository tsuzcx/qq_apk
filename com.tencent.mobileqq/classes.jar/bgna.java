...
public class bgna
{
  ...
  private aksh jdField_a_of_type_Aksh = new bgnd(this);
  private Handler jdField_a_of_type_AndroidOsHandler;
  private aoip jdField_a_of_type_Aoip;
  private aojs jdField_a_of_type_Aojs = new bgnf(this);
  private aoof jdField_a_of_type_Aoof;
  private aoog jdField_a_of_type_Aoog = new bgnc(this);
  private bgmi jdField_a_of_type_Bgmi;
  public bgpp a;
  ...
  private Observer jdField_a_of_type_JavaUtilObserver = new bgne(this);
  protected noa a;
  ...
  public bgna()
  {
    this.jdField_a_of_type_Noa = new bgnb(this);
    this.jdField_a_of_type_Bgpp = new bgng(this);
  }
  
  private FragmentActivity a()
  {
    if (this.jdField_a_of_type_Bgmi != null) {
      return ((VisitorTroopCardFragment)this.jdField_a_of_type_Bgmi).getActivity();
    }
    return null;
  }
  ...
  {
    if (this.jdField_a_of_type_Bgmi != null) {
      return (VisitorTroopCardFragment)this.jdField_a_of_type_Bgmi;
    }
    return null;
  }
  ...
  private void a(KQQ.BatchResponse paramBatchResponse)
  {
    ...
    //   169: ifne +31 -> 200
    //   172: aload_0
    //   173: invokespecial 84	bgna:a	()Landroid/support/v4/app/FragmentActivity;
    //   176: ifnull +696 -> 872
    //   179: aload_0
    //   180: getfield 76	bgna:jdField_a_of_type_Bgmi	Lbgmi;
    //   183: aload_0
    //   184: invokespecial 84	bgna:a	()Landroid/support/v4/app/FragmentActivity;
    //   187: ldc 182
    ...
    //   235: ifnull -108 -> 127
    //   238: aload_0
    //   239: getfield 76	bgna:jdField_a_of_type_Bgmi	Lbgmi;
    //   242: aload 8
    ...
    //   332: ifeq +65 -> 397
    //   335: aload_0
    //   336: getfield 98	bgna:jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData	Lcom/tencent/mobileqq/troopinfo/TroopInfoData;
    //   339: getfield 234	com/tencent/mobileqq/troopinfo/TroopInfoData:isMember	Z
    //   342: ifeq +20 -> 362
    //   345: aload_0
    //   346: invokespecial 95	bgna:a	()Lcom/tencent/mobileqq/troop/troopCard/VisitorTroopCardFragment;
    //   349: ifnull +526 -> 875
    //   352: aload_0
    //   353: invokespecial 95	bgna:a	()Lcom/tencent/mobileqq/troop/troopCard/VisitorTroopCardFragment;
    //   356: getfield 237	com/tencent/mobileqq/troop/troopCard/VisitorTroopCardFragment:c	Z
    //   359: ifeq +516 -> 875
    //   362: aload_0
    //   363: invokespecial 95	bgna:a	()Lcom/tencent/mobileqq/troop/troopCard/VisitorTroopCardFragment;
    //   366: ifnull +31 -> 397
    //   369: aload_0
    //   370: invokespecial 95	bgna:a	()Lcom/tencent/mobileqq/troop/troopCard/VisitorTroopCardFragment;
    ...
    //   376: ifnull +21 -> 397
    //   379: aload_0
    //   380: invokespecial 95	bgna:a	()Lcom/tencent/mobileqq/troop/troopCard/VisitorTroopCardFragment;
    ...
    //   508: astore 7
    //   510: aload_0
    //   511: getfield 91	bgna:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   514: bipush 52
    ...
    //   541: invokevirtual 292	com/tencent/mobileqq/app/TroopManager:b	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/TroopInfo;
    //   544: astore 10
    //   546: aload 10
    //   548: ifnull -537 -> 11
    //   551: aload_1
    ...
    //   557: aload_1
    //   558: aload 7
    //   560: invokevirtual 298	com/tencent/mobileqq/data/TroopInfo:setTroopLevelMap787	(Ljava/util/List;Ljava/util/List;)V
    //   563: aload 8
    ...
    //   585: iload_2
    //   586: i2l
    //   587: putfield 306	com/tencent/mobileqq/data/TroopInfo:dwGroupLevelSeq	J
    ...
    //   635: putfield 328	com/tencent/mobileqq/data/TroopInfo:ownerNameShow	Ljava/lang/String;
    //   638: aload 10
    //   640: aload 8
    ...
    //   651: putfield 334	com/tencent/mobileqq/data/TroopInfo:adminNameShow	Ljava/lang/String;
    //   654: aload 8
    ...
    //   675: i2b
    //   676: putfield 341	com/tencent/mobileqq/data/TroopInfo:cGroupRankSysFlag	B
    //   679: aload 10
    //   681: getfield 341	com/tencent/mobileqq/data/TroopInfo:cGroupRankSysFlag	B
    //   684: istore_2
    //   685: aload 8
    ...
    //   706: i2b
    //   707: putfield 347	com/tencent/mobileqq/data/TroopInfo:cGroupRankUserFlag	B
    //   710: aload 10
    //   712: getfield 347	com/tencent/mobileqq/data/TroopInfo:cGroupRankUserFlag	B
    //   715: istore_3
    //   716: aload 8
    ...
    //   737: i2b
    //   738: putfield 353	com/tencent/mobileqq/data/TroopInfo:cNewGroupRankUserFlag	B
    //   741: aload 10
    //   743: getfield 353	com/tencent/mobileqq/data/TroopInfo:cNewGroupRankUserFlag	B
    //   746: istore 4
    ...
    //   811: aload 9
    //   813: aload 10
    //   815: invokespecial 367	com/tencent/mobileqq/troop/troopCard/VisitorTroopCardPresenter$7:<init>	(Lbgna;Lcom/tencent/mobileqq/app/TroopManager;Lcom/tencent/mobileqq/data/TroopInfo;)V
    //   818: bipush 8
    //   820: aconst_null
    //   821: iconst_0
    ...
    //   884: invokespecial 381	bgna:a	(Ljava/util/List;)V
    //   887: goto -490 -> 397
    //   890: astore 7
  ...
  private void a(List<oidb_0x899.memberlist> paramList)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      } else if (((bgty)localObject2).b(str)) {
        localArrayList1.add(localObject1);
      } else if (bguq.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, str)) {
    ...
    catch (NumberFormatException paramList)
    {
      ...
      localObject1 = bguq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.isMember, a().jdField_a_of_type_ComTencentMobileqqDataTroopInfo, paramList);
  ...
  private void e()
  {
    this.jdField_a_of_type_Aksb.a(this.jdField_a_of_type_Aksh);
  ...
  private void f()
  {
    ...
    if (this.jdField_a_of_type_Aksb != null) {
      this.jdField_a_of_type_Aksb.a(null);
    }
    this.jdField_a_of_type_Aksh = null;
    this.jdField_a_of_type_Bgpp = null;
  }
  ...
  public Drawable a(String paramString)
  {
    ...
    if (this.jdField_a_of_type_Aoof != null)
    {
      ...
      if (localBitmap == null)
      {
        ...
        {
          this.jdField_a_of_type_Aoof.a(paramString, 4, true);
          localObject = localBitmap;
        }
      }
    }
  ...
  public void a(Bundle paramBundle, boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Aksh != null)
    {
      ...
      this.jdField_a_of_type_Aksh.a(paramBundle);
    }
  }
  
  public void a(bgmi parambgmi)
  {
    this.jdField_a_of_type_Bgmi = parambgmi;
    if (a() == null) {
      return;
    }
    ...
    this.jdField_a_of_type_Aksb = new akry(a(), a(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin);
    e();
    g();
  }
  ...
  {
    if (this.jdField_a_of_type_Bgqu != null) {
      this.jdField_a_of_type_Bgqu.a(paramString);
    }
  }
  
  public void a(String paramString, int paramInt)
  {
    if ((this.jdField_a_of_type_Bgmi == null) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)) {}
    do
    {
      aoip localaoip;
      do
      ...
      try
      {
        ...
        this.jdField_a_of_type_Bgmi.c();
        localaoip.a(l, paramInt);
        return;
      }
  ...
  {
    if (this.jdField_a_of_type_Aksb != null) {
      this.jdField_a_of_type_Aksb.a(paramString1, paramString2);
    }
  }
  ...
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null) || (this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData == null) || (this.jdField_a_of_type_Bgmi == null)) {
      return;
    }
    ...
    else
    {
      ...
      if (localTroopInfo != null)
      {
        ...
        if (paramList == null)
        {
          ...
          aksj.b((List)localObject, localTroopInfo);
        }
      }
      if (localObject == null) {
        break label314;
    ...
    for (;;)
    {
      ...
      localArrayList.add(akps.a((TroopClipPic)localObject, null));
    ...
    if (this.b.size() == 0)
    {
      ...
      paramList.id = akps.jdField_a_of_type_JavaLangString;
      paramList.type = 1;
      this.b.add(paramList);
    }
    label314:
    this.jdField_a_of_type_Bgmi.a(false, localArrayList);
  }
  ...
  public void b()
  {
    ...
    while (this.jdField_a_of_type_Aoip == null) {
      return;
    }
    aoip localaoip = this.jdField_a_of_type_Aoip;
    long l = antz.a(this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin);
    if ((this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.isMember) && (!a().c)) {}
    for (boolean bool = true;; bool = false)
    {
      localaoip.a(l, bool, 0);
      return;
    }
  }
  ...
  public void b(String paramString1, String paramString2)
  {
    ...
    ((aoip)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, "", this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.getStatOption(), paramString1, paramString2, null, null);
  }
