  ...
  extends xom
{
  ...
  public axbq(QQAppInterface paramQQAppInterface)
  {
  ...
  private CSGet3rdCloudCheck a(Context paramContext, ToServiceMsg paramToServiceMsg)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramContext = bcws.a(((DhcpInfo)localObject2).dns1);
      ...
      catch (Exception localException1)
      {
        try
        {
          localObject2 = bcws.a(((DhcpInfo)localObject2).dns2);
          ...
          paramContext = bfnn.a("f5cc92");
          if (!TextUtils.isEmpty(paramContext)) {
            localCSGet3rdCloudCheck.imei = paramContext;
          }
          localCSGet3rdCloudCheck.mac = bcws.a();
          localCSGet3rdCloudCheck.vid = bcws.b();
      ...
      if (QLog.isColorLevel())
      {
        ...
        localCSGet3rdCloudCheck.operType = bcws.a(paramContext);
        continue;
        label493:
        paramContext = null;
      }
  ...
  private SCGet3rdCloudCheck a(ToServiceMsg paramToServiceMsg, SCGet3rdCloudCheck paramSCGet3rdCloudCheck)
  {
    ...
    do
    {
      ...
      if (((Integer)paramToServiceMsg.getAttribute("network_type", Integer.valueOf(-1))).intValue() == 1)
      {
        ...
        if (bcws.b((Context)localObject1) != 1)
        {
          if (QLog.isColorLevel()) {
  ...
  public CSGUIDRegist a(Context paramContext)
  {
    ...
    localCSGUIDRegist.imei = bfnn.a("f5cc92");
    localCSGUIDRegist.imsi = bfnn.b("f5cc92");
    localCSGUIDRegist.mac = bcws.a();
  ...
  public Object a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    localObject2 = new bcwt();
    ((bcwt)localObject2).jdField_a_of_type_MConchSCPullConchs = ((SCPullConchs)((UniPacket)localObject1).get("SCPullConchs", null));
    ((bcwt)localObject2).jdField_a_of_type_MWIFISCGet3rdCloudCheck = a(paramToServiceMsg, paramFromServiceMsg);
    return localObject2;
    label463:
    label492:
    return null;
  ...
  public boolean a(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    for (;;)
    {
      ...
      paramToServiceMsg = bcwr.a(this.a.getApp(), this.a.getCurrentAccountUin());
      if (QLog.isColorLevel()) {
