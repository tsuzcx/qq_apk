  ...
  extends lql
{
  ...
  public lqd(int paramInt1, int paramInt2)
  {
    super(2);
  ...
  @NotNull
  protected Frame a(List<lqp> paramList, long paramLong)
  {
    ...
    Frame localFrame = ((lqp)paramList.get(0)).a;
    a(this.jdField_a_of_type_ArrayOfFloat, localFrame.width, localFrame.height);
    this.jdField_a_of_type_Lqe.addParam(new UniformParam.Float4fParam("offset", this.jdField_a_of_type_ArrayOfFloat[0], this.jdField_a_of_type_ArrayOfFloat[1], this.jdField_a_of_type_ArrayOfFloat[2], this.jdField_a_of_type_ArrayOfFloat[3]));
    if (paramList.size() > 1)
    {
      paramList = ((lqp)paramList.get(1)).a;
      a(this.jdField_b_of_type_ArrayOfFloat, paramList.width, paramList.height);
      this.jdField_a_of_type_Lqe.addParam(new UniformParam.TextureParam("inputImageTexture1", paramList.getTextureId(), 33985));
      this.jdField_a_of_type_Lqe.addParam(new UniformParam.Float4fParam("offset1", this.jdField_b_of_type_ArrayOfFloat[0], this.jdField_b_of_type_ArrayOfFloat[1], this.jdField_b_of_type_ArrayOfFloat[2], this.jdField_b_of_type_ArrayOfFloat[3]));
    }
    for (;;)
    {
      return this.jdField_a_of_type_Lqe.RenderProcess(localFrame.getTextureId(), this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      this.jdField_a_of_type_Lqe.addParam(new UniformParam.TextureParam("inputImageTexture1", -1, 33985));
    }
  }
  
  protected void a()
  {
    this.jdField_a_of_type_Lqe = new lqe(this);
    QLog.d(this.jdField_a_of_type_JavaLangString, 1, "onInit: create filter#" + Integer.toHexString(this.jdField_a_of_type_Lqe.hashCode()));
    this.jdField_a_of_type_Lqe.setPositions(AEOpenRenderConfig.ORIGIN_POSITION_COORDS, true);
    this.jdField_a_of_type_Lqe.setTexCords(AEOpenRenderConfig.ORIGIN_TEX_COORDS, true);
    this.jdField_a_of_type_Lqe.ApplyGLSLFilter();
  }
  ...
  protected void b()
  {
    ...
    {
      this.jdField_a_of_type_Lqe.clearGLSLSelf();
      QLog.d(this.jdField_a_of_type_JavaLangString, 1, "onDestroy: filter#" + Integer.toHexString(this.jdField_a_of_type_Lqe.hashCode()));
