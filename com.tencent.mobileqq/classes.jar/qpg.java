...
class qpg
  extends ajxj
{
  qpg(qpd paramqpd, QQAppInterface paramQQAppInterface) {}
  ...
  protected void onUpdateFriendInfo(String paramString, boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      localBundle.putString("VALUE_USER_NICK_NAME", bbcz.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, true));
