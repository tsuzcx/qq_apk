  ...
  implements Manager
{
  ...
  static
  {
    ...
    jdField_a_of_type_JavaLangString = alpo.a(2131702592);
    jdField_b_of_type_JavaLangString = alpo.a(2131702591);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageForMarketFace paramMessageForMarketFace)
  {
    ...
    {
      i = ((aubd)paramQQAppInterface.getManager(200)).a(paramMessageForMarketFace.time, String.valueOf(localMarkFaceMessage.dwTabID), localMarkFaceMessage.copywritingContent, localMarkFaceMessage.copywritingType);
      if (i != 0) {
        break label70;
      }
    ...
    for (;;)
    {
      try
      {
        paramMessageForMarketFace.msgData = ammq.a(localMarkFaceMessage);
        return;
      }
