  ...
  extends View
{
  ...
  Drawable jdField_a_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130840901);
  boolean jdField_a_of_type_Boolean = false;
  int jdField_b_of_type_Int = 0;
  Drawable jdField_b_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130840918);
  protected int c;
  protected int d = this.jdField_b_of_type_AndroidGraphicsDrawableDrawable.getIntrinsicHeight();
  
  public pct(Context paramContext)
  {
    super(paramContext);
  ...
  public void postInvalidateDelayed(long paramLong, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    postDelayed(new pcu(this, paramInt1, paramInt2, paramInt3, paramInt4), paramLong);
  }
}
