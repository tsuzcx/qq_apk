  ...
  extends bmrm
{
  ...
  private bmvo jdField_a_of_type_Bmvo = new bmvi(this);
  ...
  public bmvh(@NonNull String paramString, @NonNull List<String> paramList, float paramFloat1, float paramFloat2, float paramFloat3)
  {
    super(null);
  ...
  public int a()
  {
    ...
    {
      this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextConfigManager.a();
  ...
  public int a(Activity paramActivity, int paramInt)
  {
    ...
    do
    {
      do
      {
        ...
        localDoodleLayout = bmxk.a().a(paramInt);
      } while ((localDoodleLayout == null) || (localDoodleLayout.a() == null));
      localDoodleLayout.a().a(4);
      localDynamicTextItem = new bmvk().a(Integer.valueOf(this.jdField_a_of_type_JavaLangString).intValue(), this.jdField_a_of_type_JavaUtilList);
    } while (localDynamicTextItem == null);
    float f = bodx.a * this.c / localDynamicTextItem.a();
    bngp localbngp = new bngp(this.jdField_a_of_type_Float * bodx.a, this.b * bodx.a, f, 0.0F, 0.0F, 0.0F, localDynamicTextItem.a(), localDynamicTextItem.b());
    if (localDoodleLayout.a().a(localbngp, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper, localDoodleLayout.d()) != null)
    {
    ...
    QQToast.a(paramActivity, paramActivity.getString(2131697743), 0).a();
  ...
  public int b()
  {
    ...
    this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextConfigManager.a(this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextConfigManager$DynamicTextConfigBean, this.jdField_a_of_type_Bmvo);
