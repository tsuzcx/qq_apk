...
public class vil
{
  ...
  public vil(long paramLong, String paramString1, String paramString2, int paramInt)
  {
  ...
  public vil(TagEntry paramTagEntry)
  {
  ...
  public vil(qqstory_struct.TagInfoBase paramTagInfoBase)
  {
  ...
  public static boolean a(vil paramvil)
  {
    return (paramvil != null) && (Math.abs(System.currentTimeMillis() - paramvil.jdField_b_of_type_Long) < 60000L);
  }
