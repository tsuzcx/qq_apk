  ...
  implements Handler.Callback
{
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      while (((bemt)localObject).jdField_b_of_type_Boolean)
      {
        paramQQAppInterface = ((axlx)paramQQAppInterface.getManager(36)).a().iterator();
        do
        {
          bool1 = bool2;
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Bhtd.hasMessages(0)) {
      this.jdField_a_of_type_Bhtd.removeMessages(0);
    }
    this.jdField_b_of_type_Int += 1;
    this.jdField_a_of_type_Bhtd.sendEmptyMessageDelayed(0, 2000L);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (this.jdField_b_of_type_Boolean != paramBoolean)
    {
      ...
      ambm.a((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime());
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8008824", "0X8008824", 0, this.jdField_b_of_type_Int, 0, "", "", "", "");
    this.jdField_b_of_type_Int = 0;
    return false;
  }
}
