  ...
  extends BaseAdapter
{
  ...
  public bemt(List<ParagraphInfo> paramList, Set<Integer> paramSet)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      localView = LayoutInflater.from(paramViewGroup.getContext()).inflate(2131560656, paramViewGroup, false);
    }
    Object localObject1 = (CheckBox)localView.findViewById(2131364526);
    paramView = (TextView)localView.findViewById(2131379544);
    ...
    ((SpannableString)localObject2).setSpan(new bfew(paramViewGroup.getContext(), paramViewGroup.getContext().getResources().getColor(2131167091), 17, 4, 3, 12, Color.parseColor("#777777"), (String)localObject1), 0, ((String)localObject1).length(), 33);
