...
public class bemt
  ...
  implements bemn
{
  public bemt(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(oidb_cmd0xe89.ReqBody paramReqBody, bent parambent, String paramString)
  {
    try
    {
    ...
    catch (Exception localException)
    {
      ...
      localAtext.bytes_text.set(ByteStringMicro.copyFrom(parambent.d.getBytes()));
      localAtext.bytes_attribs.set(ByteStringMicro.copyFrom(parambent.e.getBytes()));
      localAtext.bytes_apool.set(ByteStringMicro.copyFrom(parambent.c.getBytes()));
  ...
  public void a(bent parambent, String paramString)
  {
    if (QLog.isColorLevel()) {
    ...
    a(localReqBody, parambent, paramString);
    parambent = a(localReqBody, 0, "OidbSvcTcp.0xe89_0");
    parambent.extraData.putString("write_together_group_code", paramString);
    sendPbReq(parambent);
  }
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    {
      notifyUI(2, true, bemv.a((oidb_cmd0xe89.RspGetDocContent)localRspBody.get_pad_content_rsp_info.get()));
      return;
    }
