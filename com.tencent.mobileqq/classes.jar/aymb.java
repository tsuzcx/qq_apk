...
public class aymb
{
  ...
  private static void a(aylv paramaylv)
  {
    boolean bool = a(paramaylv.jdField_a_of_type_JavaLangCharSequence);
    if (((paramaylv.jdField_b_of_type_Boolean) && (paramaylv.jdField_a_of_type_JavaLangCharSequence.length() <= 5)) || (!bool))
    {
      paramaylv.jdField_c_of_type_Int = 0;
      return;
    }
    paramaylv.jdField_c_of_type_Int = 4;
  }
  
  public static void a(List<aylv> paramList, PersonalityLabel paramPersonalityLabel, float paramFloat)
  {
    ...
    Collections.sort(localArrayList, new aymc());
    ...
    localaylv.jdField_a_of_type_JavaLangCharSequence = str;
    boolean bool = a(str);
    label398:
    int i4;
    label420:
    ...
    {
      localaylv.jdField_b_of_type_Int = ((PersonalityLabelInfo)localObject2).bgColor;
      localaylv.jdField_e_of_type_Int = 2;
      localaylv.jdField_a_of_type_Int = ((PersonalityLabelInfo)localObject2).fgColor;
      if (localaylv.jdField_e_of_type_Int != 2) {
        break label886;
      }
      i4 = 1;
      ...
      {
        localaylv.jdField_b_of_type_Boolean = true;
        localaylv.jdField_e_of_type_Boolean = true;
        i2 = n + 1;
      }
      i1 = i2;
      n = i;
      if (!localaylv.jdField_e_of_type_Boolean)
      {
        if ((i5 > 1) && (i < 2) && (i != i5 - 1) && (str.length() <= 6)) {
          break label892;
        }
        localaylv.jdField_b_of_type_Boolean = true;
        if (localaylv.jdField_b_of_type_Boolean) {
          break label905;
        }
        n = i + 1;
        i1 = i2;
    ...
    for (;;)
    {
      ...
      for (j = m + 1;; j = m)
      {
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            localaylv.jdField_a_of_type_Float = (m * paramFloat);
            localaylv.jdField_a_of_type_AndroidTextTextPaint.setTextSize(localaylv.jdField_a_of_type_Float);
            if (QLog.isColorLevel()) {
              QLog.i("TagUtil", 2, "getTags " + localaylv.jdField_a_of_type_JavaLangCharSequence + " sizeLevel:" + i + " size:" + localaylv.jdField_a_of_type_Float / paramFloat);
            }
            paramList.add(localaylv);
            m = j;
            j = i2;
            i = n;
            break label265;
            ...
            localaylv.d = true;
            localaylv.jdField_a_of_type_AndroidTextTextPaint.setFakeBoldText(true);
            break label398;
            label886:
            i4 = 0;
            break label420;
            label892:
            localaylv.jdField_b_of_type_Boolean = ((Random)localObject1).nextBoolean();
            break label544;
            label905:
            i1 = i2 + 1;
            n = i;
            ...
            if (n == 0)
            {
              paramPersonalityLabel = (aylv)paramList.get(0);
            ...
            if ((i == 0) && (i5 > 1))
            {
              ...
              if (j < paramList.size())
              {
                paramPersonalityLabel = (aylv)paramList.get(j);
            ...
            for (;;)
            {
              ...
              for (;;)
              {
                ...
                j += 1;
                break label1033;
                localObject2 = new aylv();
                ((aylv)localObject2).jdField_a_of_type_JavaLangCharSequence = ((CharSequence)localObject1);
                ((aylv)localObject2).jdField_c_of_type_Boolean = true;
                ((aylv)localObject2).jdField_b_of_type_Boolean = false;
                ((aylv)localObject2).jdField_a_of_type_Float = paramPersonalityLabel.jdField_a_of_type_Float;
                ((aylv)localObject2).jdField_a_of_type_AndroidTextTextPaint.setTextSize(paramPersonalityLabel.jdField_a_of_type_Float);
