...
public class aymb
{
  ...
  {
    byte[] arrayOfByte = bace.a(BaseApplication.getContext().getFileStreamPath("0x496_aio_keyword"));
  ...
  public static List<aymc> a(oidb_0x496.AioKeyword paramAioKeyword)
  {
    ...
    while (paramAioKeyword.hasNext())
    {
      ...
      aymc localaymc = new aymc();
      localaymc.jdField_a_of_type_JavaLangString = localAioKeywordInfo.word.get();
      localaymc.jdField_a_of_type_JavaUtilList = localAioKeywordInfo.rule_id.get();
      localArrayList.add(localaymc);
    }
    return localArrayList;
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, oidb_0x496.AioKeyword paramAioKeyword)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = localFileOutputStream;
        localObject2 = localFileOutputStream;
        baig.O(BaseApplicationImpl.getApplication(), paramQQAppInterface.getCurrentAccountUin(), paramAioKeyword.version.get());
      }
  ...
  public static List<aymd> b(oidb_0x496.AioKeyword paramAioKeyword)
  {
    ...
    while (paramAioKeyword.hasNext())
    {
      ...
      localaymd.jdField_a_of_type_Int = localAioKeywordRuleInfo.rule_id.get();
      localaymd.b = localAioKeywordRuleInfo.start_time.get();
      localaymd.c = localAioKeywordRuleInfo.end_time.get();
      localaymd.d = localAioKeywordRuleInfo.postion_flag.get();
      localaymd.jdField_a_of_type_JavaUtilList = localAioKeywordRuleInfo.match_group_class.get();
      localaymd.e = localAioKeywordRuleInfo.version.get();
      localArrayList.add(localaymd);
    }
    return localArrayList;
  }
}
