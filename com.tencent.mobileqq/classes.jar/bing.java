...
public final class bing
  extends bimg
  implements Handler.Callback, bimx, bind, binp
{
  ...
  private binl jdField_a_of_type_Binl;
  private binn jdField_a_of_type_Binn;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private PluginUpdater jdField_a_of_type_CooperationPluginPluginUpdater;
  private Object jdField_a_of_type_JavaLangObject = new Object();
  private ArrayList<bink> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public bing(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Binn = new binn(this.jdField_a_of_type_AndroidAppApplication, this, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_a_of_type_CooperationPluginPluginUpdater.a(this);
    this.jdField_a_of_type_Bimu = new bimu(this.jdField_a_of_type_AndroidAppApplication, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    try
    {
      this.jdField_a_of_type_Bina = new bina(this.jdField_a_of_type_AndroidAppApplication, bimu.a(this.jdField_a_of_type_AndroidAppApplication).getCanonicalPath());
      label160:
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
      this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
      this.jdField_a_of_type_Bima = bima.a(this.jdField_a_of_type_AndroidAppApplication);
      this.jdField_a_of_type_Binl = new binl(this);
      this.jdField_a_of_type_Binl.a();
      PluginCommunicationHandler localPluginCommunicationHandler = PluginCommunicationHandler.getInstance();
      localPluginCommunicationHandler.setCommunicationChannel(new binq());
      localPluginCommunicationHandler.register(new binr(paramQQAppInterface));
  ...
  {
    if (paramBoolean) {}
    for (paramString = alpo.a(2131708667) + paramString + "（" + bimb.a(paramLong) + alpo.a(2131708664);; paramString = paramString + "（" + bimb.a(paramLong) + alpo.a(2131708666)) {
      return new AlertDialog.Builder(paramContext).setMessage(paramString).setNegativeButton(alpo.a(2131708665), paramOnClickListener2).setPositiveButton(alpo.a(2131708669), paramOnClickListener1).create();
    }
  }
  ...
  private static ProgressDialog a(Context paramContext, String paramString, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    paramContext.setMessage(alpo.a(2131708668));
    paramContext.setCancelable(false);
    paramContext.setButton(-2, alpo.a(2131708670), new binh(paramOnClickListener));
    return paramContext;
  }
  
  private void a(int paramInt, Context paramContext, bimp parambimp, bimn parambimn)
  {
    a(paramInt, false, paramContext, parambimp, parambimn);
  }
  
  private void a(int paramInt, boolean paramBoolean, Context paramContext, bimp parambimp, bimn parambimn)
  {
    QLog.d("plugin_tag", 1, "doInstallAndLaunch. confirmCode, pluginId:" + paramInt + "," + parambimp.b + ", " + this.c);
    if ((!this.c) && (!bima.b(parambimp.b))) {
      if (parambimn != null) {
    ...
    do
    {
      ...
      localObject1 = this.jdField_a_of_type_Bina.a(parambimp.b);
      if ((localObject1 != null) && (((PluginInfo)localObject1).mInstalledPath != null))
      {
        parambimp.c = ((PluginInfo)localObject1).mInstalledPath;
        parambimp.a((PluginBaseInfo)localObject1);
      }
      parambimn.a(true, paramContext, parambimp);
      return;
      if (paramInt == 4)
      {
        localObject1 = parambimp.b;
        localObject2 = new bink();
        ((bink)localObject2).jdField_a_of_type_AndroidContentContext = paramContext;
        ((bink)localObject2).jdField_a_of_type_Bimp = parambimp;
        ((bink)localObject2).jdField_a_of_type_Bimn = parambimn;
        ((bink)localObject2).jdField_a_of_type_Boolean = true;
        a((String)localObject1, new binm(this, (bink)localObject2));
        return;
      }
      if (paramInt == 1)
      {
        localObject2 = parambimp.b;
        ...
        {
          bink localbink = new bink();
          localbink.jdField_a_of_type_AndroidContentContext = paramContext;
          localbink.jdField_a_of_type_Bimp = parambimp;
          localbink.jdField_a_of_type_Bimn = parambimn;
          localbink.jdField_a_of_type_Boolean = false;
          localbink.jdField_a_of_type_AndroidAppProgressDialog = a(paramContext, (String)localObject1, new bini(this, parambimp.b, null));
          a((String)localObject2, paramBoolean, new binm(this, localbink));
          return;
        }
      }
    } while (paramInt != 3);
    Object localObject1 = parambimp.b;
    Object localObject2 = new bink();
    ((bink)localObject2).jdField_a_of_type_AndroidContentContext = paramContext;
    ((bink)localObject2).jdField_a_of_type_Bimp = parambimp;
    ((bink)localObject2).jdField_a_of_type_Bimn = parambimn;
    ((bink)localObject2).jdField_a_of_type_Boolean = true;
    a((String)localObject1, paramBoolean, new binm(this, (bink)localObject2));
  }
  
  private void a(String paramString, bimo parambimo)
  {
    if (QLog.isColorLevel()) {
      QLog.d("plugin_tag", 2, "doQueryPlugin: " + paramString + ", " + parambimo);
    }
    ...
    b();
    parambimo.a(paramString, localPluginInfo1, this);
  }
  ...
  {
    paramString = this.jdField_a_of_type_Bima.a(paramString);
    if (paramString == null) {
      return false;
    }
  ...
  private PluginInfo b(String paramString)
  {
    ...
    {
      PluginInfo localPluginInfo = this.jdField_a_of_type_Bina.a(paramString);
      if (QLog.isColorLevel()) {
  ...
  private void b()
  {
    ...
    try
    {
      bdcs.a(localFile1.getCanonicalPath());
      bdcs.a(localFile2.getCanonicalPath());
      return;
    }
    catch (IOException localIOException) {}
  }
  ...
  private void c(Context paramContext, bimp parambimp, bimn parambimn)
  {
    int j = 2;
    boolean bool2 = false;
    boolean bool3 = true;
    ...
    do
    {
      ...
      {
        return;
        QLog.d("plugin_tag", 1, "checkUpdate:" + parambimp.b + ", " + parambimp.e);
        if ((this.c) || (bima.b(parambimp.b))) {
          break;
        }
      } while (parambimn == null);
      parambimn.a(false, paramContext, parambimp);
      return;
      String str = parambimp.b;
      localPluginInfo2 = this.jdField_a_of_type_CooperationPluginPluginUpdater.a(str);
      if (localPluginInfo2 == null)
      {
        a(0, paramContext, parambimp, parambimn);
        return;
      }
      bool4 = this.jdField_a_of_type_Bina.a(str);
      if (QLog.isColorLevel()) {
        QLog.d("plugin_tag", 2, "installed :" + bool4);
      }
      if (bool4)
      {
        PluginInfo localPluginInfo1 = this.jdField_a_of_type_Bina.a(str);
        ...
        if (bool1)
        {
          ...
          if (a())
          {
            ...
            {
              if (!bimy.a(localPluginInfo2, this.jdField_a_of_type_AndroidAppApplication)) {
                break label309;
              }
          ...
          for (;;)
          {
            a(i, paramContext, parambimp, parambimn);
            return;
            i = 4;
      ...
      if ((!bimy.a(localPluginInfo2, this.jdField_a_of_type_AndroidAppApplication)) || (localObject == null)) {
        break;
      }
      if (QLog.isColorLevel()) {
    ...
    parambimp.c = ((PluginInfo)localObject).mInstalledPath;
    parambimp.a((PluginBaseInfo)localObject);
    parambimn.a(true, paramContext, parambimp);
    return;
    ...
    for (;;)
    {
      ...
      a(3, paramContext, parambimp, parambimn);
      return;
      bool1 = bool3;
    ...
    {
      parambimp = new binj(this, parambimn, bool1, paramContext, parambimp, bool4, (String)localObject, null);
      a(paramContext, localPluginInfo2.mName, localPluginInfo2.mLength, parambimp, parambimp, bool1).show();
      return;
    }
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if (!this.jdField_a_of_type_Boolean)
        {
          ...
          if (!bdee.g(this.jdField_a_of_type_AndroidAppApplication)) {
            a(false);
          } else {
  ...
  public void a(Context paramContext, bimp parambimp, bimn parambimn)
  {
    if ((!this.c) && (!bima.b(parambimp.b)))
    {
      if (QLog.isColorLevel()) {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        if (!this.jdField_a_of_type_JavaUtilArrayList.isEmpty())
        {
          ...
          localbink.jdField_a_of_type_Bimp = parambimp;
          localbink.jdField_a_of_type_Bimn = parambimn;
          this.jdField_a_of_type_JavaUtilArrayList.add(localbink);
          return;
        }
        synchronized (this.jdField_a_of_type_JavaLangObject)
        {
    ...
    c(paramContext, parambimp, parambimn);
  }
  ...
  public void a(String paramString, OnPluginInstallListener paramOnPluginInstallListener)
  {
    ...
    if (bimy.a(localPluginInfo, this.jdField_a_of_type_AndroidAppApplication))
    {
    ...
    this.jdField_a_of_type_Bina.b(localPluginInfo, this);
  }
  ...
  public void a(String paramString1, String paramString2, long paramLong)
  {
    ...
    paramString1 = this.jdField_a_of_type_Bina.a(paramString1);
  ...
  public void a(String paramString, boolean paramBoolean1, boolean paramBoolean2, OnPluginInstallListener paramOnPluginInstallListener)
  {
    ...
    if (paramBoolean1)
    {
      localPluginInfo1 = this.jdField_a_of_type_Bima.a(paramString);
    ...
    for (;;)
    {
      ...
      localPluginInfo1 = localPluginInfo2.a();
      break;
      if (bimy.a(localPluginInfo1, this.jdField_a_of_type_AndroidAppApplication))
      {
      ...
      {
        this.jdField_a_of_type_Bina.a(localPluginInfo1, this);
        return;
      }
      this.jdField_a_of_type_Bimu.a(localPluginInfo1, this, paramBoolean2);
      return;
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        bink localbink = (bink)localIterator.next();
        c(localbink.jdField_a_of_type_AndroidContentContext, localbink.jdField_a_of_type_Bimp, localbink.jdField_a_of_type_Bimn);
      }
      this.jdField_a_of_type_Binn.a();
    }
  ...
  public void a(boolean paramBoolean, String paramString)
  {
    ...
    if (localObject != null)
    {
      ...
      this.jdField_a_of_type_Bina.a((PluginInfo)localObject, this);
    }
    label72:
    do
    {
  ...
  {
    this.jdField_a_of_type_Bimu.a(paramPluginInfo.mID);
    return this.jdField_a_of_type_Bina.b(paramPluginInfo.mID);
  }
  ...
  public void c(String paramString)
  {
    ...
    if (localObject != null)
    {
      ...
      ((PluginInfo)localObject).a = bdee.b(this.jdField_a_of_type_AndroidAppApplication);
    }
    localObject = (OnPluginInstallListener)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
    if (localObject != null) {}
    try
  ...
  {
    this.jdField_a_of_type_Bimu.a(paramString);
    this.jdField_a_of_type_Bina.b(paramString);
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    default: 
      return true;
    case 65536: 
      a(paramMessage.getData().getString("index_for_id"), (bimo)paramMessage.obj);
      return true;
    case 66049: 
      e();
      return true;
