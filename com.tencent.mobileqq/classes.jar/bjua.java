...
public class bjua
{
  ...
  private bjub jdField_a_of_type_Bjub;
  ...
  private String jdField_b_of_type_JavaLangString = alof.aW + "/tencent/Qzone/AntishakeGif/";
  ...
  static
  {
    ...
    jdField_a_of_type_JavaUtilConcurrentThreadPoolExecutor = new ThreadPoolExecutor(bdgk.b(), bdgk.b() + 5, 200L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue());
    a();
  }
  ...
  public static bjua a()
  {
    try
    {
      if (jdField_a_of_type_Bjua == null) {
        jdField_a_of_type_Bjua = new bjua();
      }
      bjua localbjua = jdField_a_of_type_Bjua;
      return localbjua;
    }
    finally {}
  }
  ...
  private String a()
  {
    ...
    if (!this.jdField_b_of_type_Boolean)
    {
      ...
      localFile = new File(bdzf.a(this.jdField_b_of_type_JavaLangString));
      if (!localFile.exists()) {
        localFile.mkdirs();
      }
      localFile = new File(bdzf.a(this.jdField_b_of_type_JavaLangString + this.jdField_c_of_type_JavaLangString));
      if (localFile.exists()) {}
    }
    try
    {
  ...
  private void a(int paramInt)
  {
    if (this.jdField_a_of_type_Bjub != null) {
      this.jdField_a_of_type_Bjub.a(paramInt);
    }
  }
  ...
  public void a(bjub parambjub)
  {
    this.jdField_a_of_type_Bjub = parambjub;
  }
  ...
  public boolean a(ArrayList<String> paramArrayList)
  {
    ...
    String str = alof.aW + "/tencent/Qzone/AlbumAutoVConvGif/";
  ...
  public boolean a(ArrayList<String> paramArrayList, LruCache<Integer, BitmapDrawable> paramLruCache)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("QzoneVision", 2, "DeviceInfoUtil.getMemoryClass() = " + bdgk.f() / 1048576L + "M, DeviceInfoUtil.getSystemAvaialbeMemory() = " + bdgk.e() / 1048576L + "M");
    }
