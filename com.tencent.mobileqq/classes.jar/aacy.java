...
class aacy
  extends mxm
{
  aacy(aacw paramaacw, aabm paramaabm) {}
  
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    if (QLog.isColorLevel()) {
      QLog.i(aacw.jdField_a_of_type_JavaLangString, 2, "onResult appid=" + aacw.a(this.jdField_a_of_type_Aacw).jdField_a_of_type_JavaLangString + ", openid=" + this.jdField_a_of_type_Aacw.jdField_a_of_type_Aacz.jdField_a_of_type_JavaLangString + ", openkey=" + this.jdField_a_of_type_Aacw.jdField_a_of_type_Aacz.b + ", code=" + paramInt);
    }
    if ((paramInt != 0) || (paramArrayOfByte == null))
    {
      aaet.a(this.jdField_a_of_type_Aabm, paramInt, "getappfriends result error, try again");
      return;
    }
    ...
    catch (InvalidProtocolBufferMicroException paramBundle)
    {
      ...
      catch (JSONException paramArrayOfByte)
      {
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.e(aacw.jdField_a_of_type_JavaLangString, 2, paramArrayOfByte.getMessage(), paramArrayOfByte);
          }
        }
      }
