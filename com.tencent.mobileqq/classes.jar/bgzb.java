...
public class bgzb
{
  ...
  public bgzb(int paramInt, String paramString1, String paramString2, Object paramObject, Bundle paramBundle)
  {
  ...
  {
    if ((paramObject instanceof bgzb))
    {
      paramObject = (bgzb)paramObject;
      if ((paramObject.jdField_a_of_type_Int == this.jdField_a_of_type_Int) && (bhbx.a(this.jdField_a_of_type_JavaLangString, paramObject.jdField_a_of_type_JavaLangString)) && ((3 != this.jdField_a_of_type_Int) || ((bhbx.a(this.b, paramObject.b)) && (bhbx.a(this.jdField_a_of_type_JavaLangObject, paramObject.jdField_a_of_type_JavaLangObject)) && (bhbx.a(this.jdField_a_of_type_AndroidOsBundle, paramObject.jdField_a_of_type_AndroidOsBundle))))) {
        return true;
      }
    }
    return false;
