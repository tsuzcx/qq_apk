  ...
  extends apsl
{
  ...
  apua(ark.Application paramApplication, long paramLong)
  {
    super(paramApplication, paramLong);
    QLog.i("ArkApp.downloadyyb.module", 1, "init");
    bjjq.a();
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
    this.jdField_a_of_type_ComTencentOpenDownloadnewDownloadListener = new apuc(this);
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramInt < i)
        {
          ...
          localObject1 = bjjq.a().b(((DownloadInfo)localObject1).jdField_d_of_type_JavaLangString);
      ...
      if (localArrayList.size() > 0)
      {
        ...
        while (paramInt < localArrayList.size())
        {
          ...
          boolean bool = bhfn.a(paramJSONArray, ((DownloadInfo)localObject2).jdField_e_of_type_JavaLangString);
  ...
  private void a(DownloadInfo paramDownloadInfo, int paramInt)
  {
    ...
    if (QLog.isColorLevel())
    {
      ...
      bjjq.a().b(paramDownloadInfo);
      return;
      bjjq.a().a(paramDownloadInfo.jdField_d_of_type_JavaLangString);
      return;
      bjjq.a().a(paramDownloadInfo.jdField_d_of_type_JavaLangString, true);
      return;
      ...
      bjlu.a("305", paramDownloadInfo.jdField_h_of_type_JavaLangString, paramDownloadInfo.jdField_c_of_type_JavaLangString, paramDownloadInfo.o);
  ...
  private void a(DownloadInfo paramDownloadInfo, boolean paramBoolean, int paramInt)
  {
    ...
    boolean bool1 = bjkj.d(localBaseActivity);
    boolean bool2 = bjkj.c(localBaseActivity);
    int i = j;
    if (paramDownloadInfo != null) {
  ...
  private void a(String paramString, ark.VariantWrapper paramVariantWrapper)
  {
    ...
    //   37: ldc_w 282
    //   40: aload 19
    //   42: getstatic 287	bjmy:J	Ljava/lang/String;
    //   45: invokevirtual 72	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   48: invokestatic 237	bjlu:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   73: aload 19
    //   75: invokevirtual 290	org/json/JSONObject:toString	()Ljava/lang/String;
    ...
    //   87: aload 19
    //   89: getstatic 293	bjmy:j	Ljava/lang/String;
    //   92: invokevirtual 72	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   95: astore 22
    //   97: aload 22
    //   99: invokestatic 299	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   102: ifeq +19 -> 121
    //   105: ldc 16
    //   107: iconst_1
    //   108: ldc_w 301
    ...
    //   178: istore 4
    //   180: aload 19
    //   182: getstatic 287	bjmy:J	Ljava/lang/String;
    //   185: invokevirtual 72	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   188: astore 20
    //   190: aload 19
    //   192: getstatic 326	bjmy:y	Ljava/lang/String;
    //   195: iconst_1
    //   196: invokevirtual 329	org/json/JSONObject:optBoolean	(Ljava/lang/String;Z)Z
    //   199: istore 6
    //   201: aload 19
    //   203: ldc_w 331
    //   206: iconst_0
    //   207: invokevirtual 329	org/json/JSONObject:optBoolean	(Ljava/lang/String;Z)Z
    //   210: istore 7
    //   212: aload 19
    //   214: ldc_w 333
    //   217: invokevirtual 87	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   220: invokestatic 335	apua:a	(I)Z
    //   223: istore 9
    //   225: aload 19
    //   227: getstatic 338	bjmy:x	Ljava/lang/String;
    //   230: invokevirtual 341	org/json/JSONObject:optBoolean	(Ljava/lang/String;)Z
    //   233: istore 10
    //   235: aload 19
    //   237: getstatic 344	bjmy:D	Ljava/lang/String;
    //   240: iconst_0
    //   241: invokevirtual 347	org/json/JSONObject:optInt	(Ljava/lang/String;I)I
    //   244: istore 5
    //   246: aload 19
    //   248: getstatic 350	bjmy:K	Ljava/lang/String;
    //   251: invokevirtual 87	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   254: invokestatic 335	apua:a	(I)Z
    //   257: istore 11
    //   259: aload 19
    //   261: ldc 93
    ...
    //   270: ldc_w 352
    //   273: ldc_w 354
    //   276: invokevirtual 357	org/json/JSONObject:optString	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   279: astore 17
    //   281: aload 19
    //   283: getstatic 360	bjmy:L	Ljava/lang/String;
    //   286: ldc_w 354
    //   289: invokevirtual 357	org/json/JSONObject:optString	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   292: astore 18
    //   294: getstatic 177	com/tencent/mobileqq/app/BaseActivity:sTopActivity	Lcom/tencent/mobileqq/app/BaseActivity;
    //   297: invokestatic 364	com/tencent/open/appcommon/js/DownloadInterface:parseCurrentPageId	(Landroid/app/Activity;)Ljava/lang/String;
    //   300: ifnonnull +569 -> 869
    //   303: ldc_w 354
    //   306: astore 12
    //   308: aload 19
    //   310: getstatic 367	bjmy:r	Ljava/lang/String;
    //   313: invokevirtual 87	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   316: invokestatic 335	apua:a	(I)Z
    //   319: istore 8
    //   321: aload 19
    //   323: ldc_w 369
    ...
    //   445: astore 29
    //   447: aload_0
    //   448: getfield 379	apua:jdField_a_of_type_Bjil	Lbjil;
    ...
    //   461: aload 24
    //   463: iload_3
    //   464: invokespecial 384	bjil:<init>	(Ljava/lang/String;Ljava/lang/String;I)V
    //   467: putfield 379	apua:jdField_a_of_type_Bjil	Lbjil;
    //   470: invokestatic 29	bjjq:a	()Lbjjq;
    //   473: aload 22
    //   475: invokevirtual 133	bjjq:b	(Ljava/lang/String;)Lcom/tencent/open/downloadnew/DownloadInfo;
    //   478: astore 13
    //   480: aload 13
    //   482: astore_1
    //   483: aload 13
    ...
    //   571: aload_1
    //   572: aload 19
    //   574: getstatic 409	bjmy:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   583: aload_1
    //   584: aload 19
    //   586: getstatic 412	bjmy:H	Ljava/lang/String;
    ...
    //   658: istore 7
    //   660: sipush 380
    //   663: invokestatic 447	aqyt:b	(I)Laqyn;
    //   666: invokevirtual 452	aqyn:a	()Laqys;
    //   669: astore 12
    //   671: iload 7
    //   673: istore 6
    //   675: aload 12
    ...
    //   682: istore 6
    //   684: aload 12
    //   686: invokevirtual 457	aqys:a	()Laqzm;
    //   689: ifnull +44 -> 733
    //   692: aload 12
    //   694: invokevirtual 457	aqys:a	()Laqzm;
    //   697: astore 12
    //   699: iload 7
    //   701: istore 6
    //   703: aload 12
    //   705: getfield 461	aqzm:c	Ljava/util/ArrayList;
    //   708: ifnull +25 -> 733
    //   711: iload 7
    //   713: istore 6
    //   715: aload 12
    //   717: getfield 461	aqzm:c	Ljava/util/ArrayList;
    //   720: aload_0
    //   721: getfield 148	apua:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   748: iconst_1
    //   749: aload_0
    //   750: getfield 148	apua:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   753: aastore
    //   754: dup
    //   755: iconst_2
    //   756: ldc_w 470
    ...
    //   808: iload 6
    //   810: ifeq +120 -> 930
    //   813: invokestatic 490	aqav:a	()Laqav;
    //   816: aload_0
    //   817: getfield 148	apua:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   820: aload 16
    //   822: aload 14
    //   824: aload 15
    //   826: new 492	apud
    ...
    //   836: iload 8
    //   838: iload_3
    //   839: invokespecial 495	apud:<init>	(Lapua;Ljava/lang/String;Ljava/lang/String;Lcom/tencent/open/downloadnew/DownloadInfo;ZI)V
    //   842: invokevirtual 498	aqav:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;)V
    //   845: aload_2
    //   846: iconst_1
    //   847: invokevirtual 307	com/tencent/ark/ark$VariantWrapper:SetInt	(I)Z
    //   850: pop
    //   851: return
    //   852: astore_1
    //   853: ldc 16
    ...
    //   862: aload_2
    //   863: iconst_m1
    //   864: invokevirtual 307	com/tencent/ark/ark$VariantWrapper:SetInt	(I)Z
    //   867: pop
    //   868: return
    //   869: getstatic 177	com/tencent/mobileqq/app/BaseActivity:sTopActivity	Lcom/tencent/mobileqq/app/BaseActivity;
    //   872: invokestatic 364	com/tencent/open/appcommon/js/DownloadInterface:parseCurrentPageId	(Landroid/app/Activity;)Ljava/lang/String;
    //   875: astore 12
    //   877: goto -569 -> 308
    //   880: aload_0
    //   881: getfield 379	apua:jdField_a_of_type_Bjil	Lbjil;
    //   884: aload 16
    //   886: aload 24
    //   888: iload_3
    //   889: invokevirtual 501	bjil:a	(Ljava/lang/String;Ljava/lang/String;I)Z
    //   892: ifeq -422 -> 470
    //   895: ldc 16
    //   897: iconst_1
    //   898: ldc_w 503
    ...
    //   904: aload_2
    //   905: bipush 253
    //   907: invokevirtual 307	com/tencent/ark/ark$VariantWrapper:SetInt	(I)Z
    //   910: pop
    //   911: return
    //   912: aload_1
    //   913: iconst_0
    ...
    //   932: iload 8
    //   934: iload_3
    //   935: invokespecial 198	apua:a	(Lcom/tencent/open/downloadnew/DownloadInfo;ZI)V
    //   938: goto -93 -> 845
    //   941: astore 13
    //   943: goto -348 -> 595
  ...
  public void Destruct()
  {
    ...
    this.jdField_a_of_type_Apug = null;
  ...
  {
    if (!apqx.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.YYB_DOWNLOAD"))
    {
    ...
    if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 1))
    {
      ...
      this.jdField_a_of_type_Apug = new apub(this);
