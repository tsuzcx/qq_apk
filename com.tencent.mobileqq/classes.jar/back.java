...
public class back
{
  ...
  public back(int paramInt1, int paramInt2, Map<Integer, String> paramMap)
  {
  ...
  {
    boolean bool = false;
    if ((paramObject instanceof back)) {
      bool = bhjx.a(((back)paramObject).jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString);
    }
    return bool;
  }
}
