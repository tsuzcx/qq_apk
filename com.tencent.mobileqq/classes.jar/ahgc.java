...
{
  public ahgc(EditLocalVideoActivity paramEditLocalVideoActivity) {}
  ...
  public void onPrepared(MediaPlayer paramMediaPlayer)
  {
    ...
    if (!EditLocalVideoActivity.a(this.a).a())
    {
      ...
      if ((bgfb.a(EditLocalVideoActivity.b(this.a)) / EditLocalVideoActivity.a(this.a).getDuration() * 15000L > this.a.a(EditLocalVideoActivity.a())) && (QLog.isColorLevel())) {
      ...
      if ((i <= 0) || (j <= 0)) {
        Toast.makeText(this.a.getApplicationContext(), ajjy.a(2131637853), 1).show();
      }
    }
    else
    {
