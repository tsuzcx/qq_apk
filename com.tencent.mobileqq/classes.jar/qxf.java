...
public class qxf
{
  ...
  public static void a(Context paramContext, pvc parampvc, ViewGroup.LayoutParams paramLayoutParams)
  {
    a(paramContext, parampvc, paramLayoutParams, null);
  }
  
  public static void a(Context paramContext, pvc parampvc, ViewGroup.LayoutParams paramLayoutParams, View paramView)
  {
    ...
    paramLayoutParams.height = paramContext.getResources().getDimensionPixelSize(2131298732);
    int i = parampvc.a();
    int j = parampvc.b();
  ...
  public static void a(pvc parampvc, RingAvatarView paramRingAvatarView, ImageView paramImageView)
  {
    if ((paramRingAvatarView == null) || (paramImageView == null) || (parampvc == null)) {}
    do
    {
      return;
      parampvc = parampvc.a();
  ...
  public static void a(rfj paramrfj, ReadInJoyYAFolderTextView paramReadInJoyYAFolderTextView, qtr paramqtr, SpannableStringBuilder paramSpannableStringBuilder)
  {
    ...
    if (pay.a(paramrfj))
    {
      List localList = paramrfj.jdField_a_of_type_Rep.a;
      ...
      {
        paramrfj = paramSpannableStringBuilder.substring(1);
        localStringBuilder.append(paramrfj);
        ...
        paramrfj = ContactUtils.getBuddyName((QQAppInterface)pay.a(), String.valueOf(l), true);
        paramSpannableStringBuilder = "@" + paramrfj;
        paramrfj = paramSpannableStringBuilder;
      ...
      {
        localStringBuilder.append(paramrfj).append(paramSpannableStringBuilder);
        paramSpannableStringBuilder = new qvr();
        paramSpannableStringBuilder.jdField_a_of_type_Int = j;
        paramSpannableStringBuilder.b = (paramrfj.length() + j);
      ...
      label329:
      paramrfj = new SpannableStringBuilder(new QQText(localStringBuilder, 7, 16));
      paramSpannableStringBuilder = ((List)localObject).iterator();
      while (paramSpannableStringBuilder.hasNext())
      {
        localObject = (qvr)paramSpannableStringBuilder.next();
        paramrfj.setSpan(new qtt(((qvr)localObject).jdField_a_of_type_Long, -3355444, paramqtr), ((qvr)localObject).jdField_a_of_type_Int, ((qvr)localObject).b, 17);
      }
      localSpannableStringBuilder.append(paramrfj);
    }
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(paramrfj.jdField_a_of_type_JavaLangString)) {
        try
        {
          localSpannableStringBuilder.append(new QQText(bblk.b(paramrfj.jdField_a_of_type_JavaLangString), 7, 16));
        }
        catch (Exception paramrfj)
        {
          QLog.d("UtilsForComponent", 1, "parse bytes_comments failed ", paramrfj);
        }
      }
    }
  }
  ...
  {
    return (pgb.b(paramArticleInfo) == 23) || (pgb.c(paramArticleInfo) == 56);
  }
