...
public class bewr
  extends Observable
  implements beww, INetInfoHandler
{
  private static bewr jdField_a_of_type_Bewr;
  private LinkedList<UUID> jdField_a_of_type_JavaUtilLinkedList = new LinkedList();
  private Map<UUID, bewu> jdField_a_of_type_JavaUtilMap = new HashMap();
  public boolean a;
  private LinkedList<bewu> b = new LinkedList();
  
  public static bewr a()
  {
    try
    {
      if (jdField_a_of_type_Bewr == null) {
        jdField_a_of_type_Bewr = new bewr();
      }
      bewr localbewr = jdField_a_of_type_Bewr;
      return localbewr;
    }
    finally {}
  }
  ...
  private void a(long paramLong, TroopFileTransferManager.Item paramItem, Bundle paramBundle, boolean paramBoolean, int paramInt, group_file_common.FileInfo paramFileInfo)
  {
    ...
    paramFileInfo = bevv.a();
    if ((paramFileInfo != null) && (atvo.a(paramItem.FileName) == 2) && (atwt.a(paramFileInfo)))
    {
      atdq.a(new atnq(paramFileInfo, paramItem.getInfo(paramLong))).a();
      return;
    }
    bevn.a(new TroopFileDownloadMgr.5(this, paramLong, paramItem, paramBundle), false);
  }
  ...
  private boolean a(long paramLong, TroopFileTransferManager.Item paramItem, group_file_common.FileInfo paramFileInfo)
  {
    ...
    String str1 = atjh.a(paramItem.Md5);
    paramItem.Sha = paramFileInfo.bytes_sha.get().toByteArray();
    String str2 = atjh.a(paramItem.Sha);
    paramItem.Sha3 = atjh.a(paramFileInfo.bytes_sha3.get().toByteArray());
    ...
    while (paramFileInfo.hasNext())
    {
      ...
      if (((localFileManagerEntity.strFileMd5 != null) && (localFileManagerEntity.strFileMd5.equals(str1))) || ((localFileManagerEntity.strFileMd5 != null) && (localFileManagerEntity.strFileMd5.equals(str1))) || ((localFileManagerEntity.str10Md5 != null) && (localFileManagerEntity.str10Md5.equals(str1))) || ((localFileManagerEntity.strFileSha3 != null) && (localFileManagerEntity.strFileSha3.equals(paramItem.Sha3))) || ((localFileManagerEntity.strFileSHA != null) && (localFileManagerEntity.strFileSHA.equals(str2))) || ((localFileManagerEntity.strTroopFileSha1 != null) && (localFileManagerEntity.strTroopFileSha1.equals(str2))))
      {
        ...
        else
        {
          ...
          if ((!bgmg.b(paramItem.middleThumbnailFile)) && (bgmg.b(localFileManagerEntity.strMiddleThumPath))) {
            paramItem.middleThumbnailFile = localFileManagerEntity.strMiddleThumPath;
          }
          if ((!bgmg.b(paramItem.largeThumbnailFile)) && (bgmg.b(localFileManagerEntity.strLargeThumPath))) {
            paramItem.largeThumbnailFile = localFileManagerEntity.strLargeThumPath;
          }
          bevg.a(paramLong, paramItem, 11);
          a(paramItem.getInfo(paramLong), str1, str2, paramItem.Sha3);
          if (5 == atvo.a(paramItem.FileName)) {
  ...
  private int b(UUID paramUUID, Bundle paramBundle)
  {
    ...
    {
      bewu localbewu = (bewu)paramBundle.next();
      if (paramUUID.equals(localbewu.a()))
      {
        localbewu.a(0);
        paramBundle.remove();
      }
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      if (!bool1)
      {
        paramBundle = (bewu)this.jdField_a_of_type_JavaUtilMap.remove(paramUUID);
        if (paramBundle == null) {
          break label154;
        }
        paramBundle.a(0);
      ...
      for (;;)
      {
        ...
        if (bool2) {
          bevx.c("TroopFileDownloadMgr", bevx.a, "[" + paramUUID.toString() + "] stopDownload." + a());
        }
        c();
        return 0;
      }
  ...
  private int c(long paramLong, TroopFileTransferManager.Item paramItem, Bundle paramBundle)
  {
    if (a(paramItem.Id))
    {
      bevx.c("TroopFileDownloadMgr", bevx.a, "[" + paramItem.Id.toString() + "] startDownload worker exsited. ");
      return -4;
    }
    if ((paramItem.ProgressTotal > 0L) && (atjl.a().d()) && (paramItem.ProgressTotal > atjl.a().d())) {}
    for (paramBundle = atjn.a(paramLong, paramItem, paramBundle, this); paramBundle == null; paramBundle = bewu.b(paramLong, paramItem, paramBundle, this)) {
      return -3;
    }
    ...
    paramBundle.e();
    bevx.c("TroopFileDownloadMgr", bevx.a, "[" + paramItem.Id.toString() + "] startDownload filePath. " + paramItem.FilePath + a());
    c();
    return 0;
  }
  ...
  private void c()
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localObject = (bewu)this.jdField_a_of_type_JavaUtilMap.remove(localObject);
        if (localObject != null)
        {
          this.b.add(localObject);
          if (((bewu)localObject).a()) {
            break;
          }
  ...
  private int d(long paramLong, TroopFileTransferManager.Item paramItem, Bundle paramBundle)
  {
    if (a(paramItem.Id))
    {
      bevx.c("TroopFileDownloadMgr", bevx.a, "[" + paramItem.Id.toString() + "] startDownloadZipInnerFile worker exsited. ");
      return -4;
    }
    paramBundle = bexa.a(paramLong, paramItem, paramBundle, this);
    if (paramBundle == null) {
      return -3;
    }
    this.jdField_a_of_type_JavaUtilMap.put(paramItem.Id, paramBundle);
    this.jdField_a_of_type_JavaUtilLinkedList.add(paramItem.Id);
    paramBundle.e();
    bevx.c("TroopFileDownloadMgr", bevx.a, "[" + paramItem.Id.toString() + "] startDownloadZipInnerFile filePath. " + paramItem.FilePath + a());
    c();
    return 0;
  }
  ...
  public int a(long paramLong, TroopFileTransferManager.Item paramItem)
  {
    ...
    paramItem = bewy.a(paramLong, paramItem);
    if (paramItem == null) {
      return -3;
    }
    if (!paramItem.a()) {
  ...
  public int a(long paramLong, TroopFileTransferManager.Item paramItem, Bundle paramBundle)
  {
    if ((paramLong == 0L) || (paramItem == null))
    {
      bevx.a("TroopFileDownloadMgr", bevx.a, "startDownload key param invaild.");
      return -1;
    }
    if (paramItem.Id == null)
    {
      bevx.a("TroopFileDownloadMgr", bevx.a, "startDownload item.id null.");
      return -2;
    }
  ...
  public int a(UUID paramUUID, Bundle paramBundle)
  {
    if (paramUUID == null)
    {
      bevx.a("TroopFileDownloadMgr", bevx.a, "stopUpload item.id null.");
      return -2;
    }
    bevn.a(new TroopFileDownloadMgr.7(this, paramUUID, paramBundle), false);
    return 0;
  }
  
  public void a()
  {
    bevx.c("TroopFileDownloadMgr", bevx.a, "init");
    ThreadManager.getSubThreadHandler().post(new TroopFileDownloadMgr.1(this));
  }
  
  protected void a(int paramInt)
  {
    bevx.b("TroopFileDownloadMgr", bevx.a, "failAll. reason:" + paramInt);
    bevn.a(new TroopFileDownloadMgr.9(this, paramInt), false);
  }
  ...
  public void a(int paramInt, Set<Long> paramSet)
  {
    ...
    {
      localbewu = (bewu)localIterator.next();
      localbewu.a(paramInt);
      if (paramSet != null) {
        paramSet.add(Long.valueOf(localbewu.a()));
      }
    }
    this.b.clear();
    ...
    bevx.c("TroopFileDownloadMgr", bevx.a, "stopAllInter");
  }
  ...
  protected void a(long paramLong, TroopFileTransferManager.Item paramItem, Bundle paramBundle)
  {
    ...
    {
      aaqt.a(localQQAppInterface, paramLong, paramItem.BusId, paramItem.FilePath, new bews(this, paramLong, paramItem, paramBundle));
      return;
    }
  ...
  protected final void a(bety parambety, String paramString1, String paramString2, String paramString3)
  {
    ...
    if (localQQAppInterface == null)
    {
      bevx.a("TroopFileDownloadMgr", bevx.a, "[" + parambety.b + "] addFMEntity fail app=null ");
      return;
    }
    FileManagerEntity localFileManagerEntity = atvo.a(parambety);
    localFileManagerEntity.isReaded = true;
    localFileManagerEntity.peerUin = String.valueOf(parambety.b);
    ...
    localFileManagerEntity.TroopUin = parambety.b;
    ...
    try
    {
      localFileManagerEntity.localModifyTime = new VFSFile(parambety.a).lastModified();
      label265:
  ...
  public void a(UUID paramUUID, boolean paramBoolean, int paramInt, bewu parambewu)
  {
    bevn.a(new TroopFileDownloadMgr.8(this, paramUUID, paramBoolean, paramInt, parambewu), false);
  }
  ...
  protected boolean a(UUID paramUUID)
  {
    Iterator localIterator = this.b.iterator();
    while (localIterator.hasNext()) {
      if (paramUUID.equals(((bewu)localIterator.next()).a())) {
        return true;
      }
    }
  ...
  public int b(long paramLong, TroopFileTransferManager.Item paramItem, Bundle paramBundle)
  {
    if ((paramLong == 0L) || (paramItem == null))
    {
      bevx.a("TroopFileDownloadMgr", bevx.a, "startDownloadZipInnerFile key param invaild.");
      return -1;
    }
    if (paramItem.Id == null)
    {
      bevx.a("TroopFileDownloadMgr", bevx.a, "startDownloadZipInnerFile item.id null.");
      return -2;
    }
    bevn.a(new TroopFileDownloadMgr.6(this, paramLong, paramItem, paramBundle), false);
    return 0;
  }
  
  public void b()
  {
    bevx.c("TroopFileDownloadMgr", bevx.a, "release");
    ...
    bevn.a(new TroopFileDownloadMgr.3(this), true);
  }
  
  public void b(UUID paramUUID, boolean paramBoolean, int paramInt, bewu parambewu)
  {
    this.b.remove(parambewu);
    bevx.c("TroopFileDownloadMgr", bevx.a, "[" + paramUUID.toString() + "] onWorkDoneInter. bSuc:" + paramBoolean + " errCode:" + paramInt + a());
    c();
  }
  
  public void onNetMobile2None()
  {
    bevx.c("TroopFileDownloadMgr", bevx.a, "onNetMobile2None");
    a(3);
  }
  
  public void onNetMobile2Wifi(String paramString)
  {
    bevx.c("TroopFileDownloadMgr", bevx.a, "onNetMobile2Wifi");
  }
  
  public void onNetNone2Mobile(String paramString)
  {
    bevx.c("TroopFileDownloadMgr", bevx.a, "onNetNone2Mobile");
    bevn.a(new TroopFileDownloadMgr.10(this), false);
  }
  
  public void onNetNone2Wifi(String paramString)
  {
    bevx.c("TroopFileDownloadMgr", bevx.a, "onNetNone2Wifi");
  }
  
  public void onNetWifi2Mobile(String paramString)
  {
    bevn.a(new TroopFileDownloadMgr.11(this), false);
  }
  
  public void onNetWifi2None()
  {
    bevx.c("TroopFileDownloadMgr", bevx.a, "onNetWifi2None");
    a(3);
  }
}
