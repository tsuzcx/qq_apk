...
{
  static String jdField_a_of_type_JavaLangString = bhhr.f(BaseApplication.getContext());
  ...
  private void g()
  {
    ...
    {
      localMessageForShortVideo = this.jdField_a_of_type_Aklw.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo;
      i2 = this.jdField_a_of_type_Aklw.jdField_a_of_type_Int;
    }
    for (;;)
    {
      ...
      for (int i1 = 0;; i1 = (int)(100L * this.jdField_a_of_type_Long / this.jdField_b_of_type_Long))
      {
        ...
        String str = ShortVideoUtils.findVideoPathIfExists(localMessageForShortVideo);
        if ((this.t == 2003) && (!StringUtil.isEmpty(str))) {
          localMessageForShortVideo.lastModified = new File(str).lastModified();
        }
        if (this.jdField_a_of_type_Ahtp == null) {
          break;
        }
        this.jdField_a_of_type_Ahtp.a(localMessageForShortVideo);
        return;
      }
      i2 = -1;
    ...
    for (;;)
    {
      try
      {
        ...
        else
        {
          ...
          {
            if (this.jdField_a_of_type_Aklw != null) {
              this.jdField_a_of_type_Aklw.jdField_a_of_type_Boolean = false;
            }
  ...
  public View a(Context paramContext, Handler paramHandler, aklw paramaklw, ahtp paramahtp)
  {
    ...
    this.jdField_a_of_type_Long = paramaklw.jdField_d_of_type_Long;
  ...
  public void a(String paramString, long paramLong)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOutputMute(this.jdField_a_of_type_Aklw.jdField_e_of_type_Boolean);
  ...
  public void f()
  {
    if ((!this.jdField_f_of_type_Boolean) || (this.jdField_a_of_type_Aklw == null) || (this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer == null)) {}
    Object localObject;
    do
    {
      return;
      localObject = this.jdField_a_of_type_Aklw.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo;
    ...
    for (boolean bool = false;; bool = true)
    {
      ...
      str1 = null;
      if (!StringUtil.isEmpty(this.jdField_g_of_type_JavaLangString)) {
        str1 = InnerDns.getHostFromUrl(this.jdField_g_of_type_JavaLangString);
      }
      i3 = i2;
      if (this.jdField_a_of_type_Aklw.jdField_a_of_type_ArrayOfJavaLangString == null) {
        break label1349;
      }
      i3 = i2;
      if (this.jdField_a_of_type_Aklw.jdField_a_of_type_ArrayOfJavaLangString.length <= 0) {
        break label1349;
      }
      i1 = 0;
      for (;;)
      {
        i3 = i2;
        if (i1 >= this.jdField_a_of_type_Aklw.jdField_a_of_type_ArrayOfJavaLangString.length) {
          break;
        }
        String str2 = InnerDns.getHostFromUrl(this.jdField_a_of_type_Aklw.jdField_a_of_type_ArrayOfJavaLangString[i1]);
    ...
    localHashMap.put("HttpDomain", this.jdField_a_of_type_Aklw.jdField_b_of_type_JavaLangString);
    localStringBuffer1.append(" HttpDomain" + this.jdField_a_of_type_Aklw.jdField_b_of_type_JavaLangString);
    ...
    ShortVideoUtils.getFromUinForForward((MessageForShortVideo)localObject);
    localHashMap.put("FromUin", String.valueOf(ShortVideoUtils.getFromUinForForward((MessageForShortVideo)localObject)));
  ...
  public void onSurfaceCreated(SurfaceHolder paramSurfaceHolder)
  {
    ...
    if (this.jdField_a_of_type_Aklw != null)
    {
      ...
      if (this.jdField_a_of_type_Aklw.jdField_a_of_type_JavaLangString != null) {
        a(this.jdField_a_of_type_Aklw.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Aklw.jdField_e_of_type_Long);
      }
    }
    label63:
    while (this.jdField_a_of_type_Aklw.jdField_b_of_type_Boolean) {
      return;
    }
    ...
    label149:
    for (String str = "";; str = this.jdField_a_of_type_Aklw.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo.md5)
    {
      a(this.jdField_a_of_type_Aklw.a(), paramSurfaceHolder, this.jdField_a_of_type_Aklw.jdField_a_of_type_ArrayOfJavaLangString, this.jdField_a_of_type_Aklw.jdField_e_of_type_Long, str, this.jdField_b_of_type_AndroidContentContext);
      return;
      paramSurfaceHolder = String.valueOf(this.jdField_a_of_type_Aklw.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo.videoFileTime);
      break;
    }
  }
