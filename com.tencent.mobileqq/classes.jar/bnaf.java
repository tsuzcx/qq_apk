...
public class bnaf
{
  ...
  private static bnae a(Cursor paramCursor)
  {
    bnae localbnae = new bnae();
    localbnae.jdField_a_of_type_Long = paramCursor.getLong(0);
    localbnae.jdField_a_of_type_JavaLangString = paramCursor.getString(1);
    localbnae.jdField_b_of_type_JavaLangString = paramCursor.getString(2);
    localbnae.jdField_c_of_type_JavaLangString = paramCursor.getString(3);
    localbnae.jdField_d_of_type_JavaLangString = paramCursor.getString(4);
    localbnae.jdField_e_of_type_JavaLangString = paramCursor.getString(5);
    localbnae.jdField_b_of_type_Long = paramCursor.getLong(6);
    localbnae.f = paramCursor.getString(7);
    localbnae.jdField_c_of_type_Long = paramCursor.getLong(8);
    localbnae.g = paramCursor.getString(9);
    localbnae.jdField_a_of_type_Int = paramCursor.getInt(10);
    localbnae.jdField_b_of_type_Int = paramCursor.getInt(11);
    localbnae.h = paramCursor.getString(12);
    localbnae.jdField_d_of_type_Long = paramCursor.getLong(13);
    localbnae.jdField_e_of_type_Long = paramCursor.getLong(14);
    localbnae.i = paramCursor.getString(15);
    localbnae.j = paramCursor.getString(16);
    localbnae.k = paramCursor.getString(17);
    localbnae.l = paramCursor.getString(18);
    return localbnae;
  }
  
  /* Error */
  public static java.util.ArrayList<bnae> a(String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_1
    ...
    //   53: aload_3
    //   54: ldc 36
    //   56: getstatic 145	bnag:a	[Ljava/lang/String;
    //   59: aload 4
    ...
    //   93: aload_2
    //   94: aload_0
    //   95: invokestatic 161	bnaf:a	(Landroid/database/Cursor;)Lbnae;
