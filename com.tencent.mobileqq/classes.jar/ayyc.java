...
{
  public ayyc(ReciteFragment paramReciteFragment, QQAppInterface paramQQAppInterface) {}
  ...
  public void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      str1 = this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkReciteUiReciteFragment.jdField_a_of_type_Azac.f;
      str2 = this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkReciteUiReciteFragment.jdField_a_of_type_Azac.f;
    ...
    {
      azzx.a(localQQAppInterface, str1, "Grp_recite", "Out_Recite_Clk", 0, 0, new String[] { str2, "", paramDialogInterface, "" });
      return;
    }
  }
}
