...
public class ayyc
{
  static final String jdField_a_of_type_JavaLangString = apcx.jdField_a_of_type_JavaLangString + "_Res";
  long jdField_a_of_type_Long = 0L;
  private apcn jdField_a_of_type_Apcn;
  private apcw jdField_a_of_type_Apcw;
  private ayyh jdField_a_of_type_Ayyh;
  private bczz jdField_a_of_type_Bczz;
  ...
  public ayyc(ScanTorchActivity paramScanTorchActivity)
  {
    this.jdField_a_of_type_ComTencentMobileqqOlympicActivityScanTorchActivity = paramScanTorchActivity;
  }
  
  private void a(AppInterface paramAppInterface, apcn paramapcn)
  {
    if ((paramapcn != null) && ((!paramapcn.jdField_a_of_type_Boolean) || (paramapcn.a() != null)))
    {
      this.jdField_a_of_type_Apcn = paramapcn;
      d(paramAppInterface);
      apcx.a(paramAppInterface).a(paramAppInterface, paramapcn.jdField_a_of_type_JavaLangString);
      a(paramAppInterface, this.jdField_a_of_type_Ayyh.d());
      return;
    }
  ...
  private void a(String paramString, AppInterface paramAppInterface)
  {
    ...
    do
    {
      ...
      bool2 = this.jdField_a_of_type_Ayyh.c();
      if (this.jdField_a_of_type_ArrayOfInt[0] == 100) {
        bool1 = true;
      }
    ...
    this.jdField_a_of_type_Ayyh.a(paramAppInterface);
  }
  ...
  private void a(String paramString, AppInterface paramAppInterface, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Ayyh.a(paramAppInterface, false);
    return;
    a("checkAllRes", true);
    if (a())
    {
    ...
    if (!this.jdField_a_of_type_Ayyh.b())
    {
    ...
    a();
    this.jdField_a_of_type_Ayyh.a(paramAppInterface, true);
  }
  ...
  private void a(String paramString, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Ayyh.a("PromotionRes_" + paramString, 0);
  }
  ...
  public apcn a()
  {
    return this.jdField_a_of_type_Apcn;
  }
  ...
  void a()
  {
    ...
    {
      return;
      localButton = (Button)this.jdField_a_of_type_ComTencentMobileqqOlympicActivityScanTorchActivity.findViewById(2131365432);
      localButton.setVisibility(0);
    } while (localButton.getTag() != null);
    localButton.setTag(new Object());
    localButton.setOnClickListener(new ayyg(this));
  }
  
  public void a(ayyh paramayyh)
  {
    this.jdField_a_of_type_Ayyh = paramayyh;
  }
  ...
  {
    if (this.jdField_a_of_type_Ayyh.d())
    {
    ...
    apcx.a(paramAppInterface).a(paramAppInterface, new ayyd(this, paramString, paramAppInterface));
  }
  ...
  public boolean a(AppInterface paramAppInterface)
  {
    ...
    localObject1 = ((apcn)localObject1).a();
    ...
    {
      localObject2 = (apco)((Map.Entry)((Iterator)localObject1).next()).getValue();
      if (apcu.a(paramAppInterface.getCurrentAccountUin(), (apco)localObject2)) {
  ...
  public void b(AppInterface paramAppInterface)
  {
    ...
    {
      apcx.a(paramAppInterface).b(this.jdField_a_of_type_Apcw);
      this.jdField_a_of_type_Apcw = null;
    }
    if (this.jdField_a_of_type_Bczz != null) {
      bczy.a().a(false, this.jdField_a_of_type_Bczz);
    }
    this.jdField_a_of_type_Apcn = null;
  }
  ...
  public void c(AppInterface paramAppInterface)
  {
    ...
    QLog.w(jdField_a_of_type_JavaLangString, 1, "reTry, promotionItem[" + localapcn + "], isDownloading[" + bool2 + "], isDownloadError[" + bool1 + "], needShowDownloadProgress[" + this.jdField_a_of_type_Boolean + "], TotalProgress[" + a() + "]");
    this.jdField_a_of_type_Boolean = true;
    if (localapcn == null) {}
    while (bool2) {
      return;
    }
    apcx.a(paramAppInterface).a(paramAppInterface, localapcn.jdField_a_of_type_JavaLangString);
    a(paramAppInterface, this.jdField_a_of_type_Ayyh.d());
  }
  ...
  void d(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_Bczz = new ayye(this, paramAppInterface);
    bczy.a().a(true, this.jdField_a_of_type_Bczz);
    this.jdField_a_of_type_Apcw = new ayyf(this, paramAppInterface);
    apcx.a(paramAppInterface).a(this.jdField_a_of_type_Apcw);
  }
