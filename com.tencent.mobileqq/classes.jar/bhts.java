  ...
  extends WebViewPlugin
{
  ...
  private void a(String... paramVarArgs)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        {
          if ((localActivity != null) && ((localActivity instanceof bhtt)) && (((bhtt)localActivity).a())) {
            return;
          }
          ...
          if ((localActivity == null) || ((!(localActivity instanceof bhtt)) && (!(localActivity instanceof BasePluginActivity)))) {
            break label330;
          }
  ...
  private void c(String... paramVarArgs)
  {
    try
    {
      ...
      paramVarArgs.putExtra("key_left_tab_title", this.mRuntime.a().getString(2131717655));
      paramVarArgs.putExtra("key_right_tab_title", this.mRuntime.a().getString(2131717736));
