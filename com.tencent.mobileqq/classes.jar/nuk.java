  ...
  extends BaseAdapter
{
  ...
  {
    return (oag)this.a.jdField_a_of_type_JavaUtilArrayList.get(paramInt);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    int i = agej.a(200.0F, (Resources)localObject1);
    int j = agej.a(140.0F, (Resources)localObject1);
    int k = agej.a(12.0F, (Resources)localObject1);
    Object localObject2;
    if (paramView == null)
    {
      paramView = new num(this);
    ...
    for (;;)
    {
      ...
      paramView.jdField_a_of_type_ComTencentImageURLImageView.setBackgroundDrawable(URLDrawable.getDrawable(((oag)localObject2).e, null, null, true));
      paramView.jdField_a_of_type_AndroidWidgetTextView.setText(((oag)localObject2).a);
      EventCollector.getInstance().onListGetView(paramInt, (View)localObject1, paramViewGroup, getItemId(paramInt));
      return localObject1;
      localObject2 = (num)paramView.getTag();
