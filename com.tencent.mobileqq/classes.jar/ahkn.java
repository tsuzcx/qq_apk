...
public class ahkn
  implements Runnable
{
  public ahkn(RedTouchWebviewHandler paramRedTouchWebviewHandler, String paramString, long paramLong) {}
  ...
  public void run()
  {
    ...
    localObject5 = localObject1;
    localObject7 = localObject3;
    localObject4 = RedTouchWebviewHandler.access$200(this.jdField_a_of_type_ComTencentMobileqqRedtouchRedTouchWebviewHandler, (List)localObject4);
    ...
    try
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqRedtouchRedTouchWebviewHandler.mRuntime == null) || (this.jdField_a_of_type_ComTencentMobileqqRedtouchRedTouchWebviewHandler.mRuntime.a() == null) || (localObject1 == null) || (((List)localObject1).isEmpty())) {
        break label1337;
      }
      localObject5 = new RedTouchManager(this.jdField_a_of_type_ComTencentMobileqqRedtouchRedTouchWebviewHandler.mRuntime.a());
      if (localObject5 == null) {
        break label1337;
      }
      localObject5 = ((RedTouchManager)localObject5).a();
    ...
    for (localObject1 = ((BusinessInfoCheckUpdate.AppInfo)((List)localObject1).get(0)).path.get();; localObject1 = "")
    {
      for (;;)
      {
        for (;;)
        {
          if (this.jdField_a_of_type_ComTencentMobileqqRedtouchRedTouchWebviewHandler.mRuntime != null)
          {
            localObject8 = this.jdField_a_of_type_ComTencentMobileqqRedtouchRedTouchWebviewHandler.mRuntime.a();
            if (localObject8 != null) {
              ((Activity)localObject8).runOnUiThread(new ahko(this, (String)localObject4, localJSONObject, (BusinessInfoCheckUpdate.AppInfo)localObject5, j, i, (ArrayList)localObject7, (String)localObject1, (String)localObject3));
            }
          }
          return;
          j = n;
