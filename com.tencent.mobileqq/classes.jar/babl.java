  ...
  extends babq
{
  ...
  public String a;
  public URL a;
  public ConcurrentHashMap<String, bhxj> a;
  public int b;
  protected String b;
  public String c;
  public int d;
  ...
  public babl(String paramString)
  {
    b(paramString);
    a();
  ...
  public babl(JSONObject paramJSONObject)
  {
    a(paramJSONObject);
    this.jdField_d_of_type_JavaLangString = String.valueOf(hashCode());
  }
  ...
  public static String b()
  {
    ...
    {
      localVFSFile.mkdirs();
      bbdx.c(TroopHWJsPlugin.jdField_a_of_type_JavaLangString + ".nomedia");
    }
  ...
  public bhxj a(String paramString1, String paramString2)
  {
    ...
    {
      paramString2 = new bhxj(tsr.a(), paramString1, paramString2);
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString1, paramString2);
      return paramString2;
    }
    return (bhxj)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString1);
  }
  ...
  public Stream<babl> a(XMediaEditor paramXMediaEditor)
  {
    ...
    if (!apvd.b(this.jdField_c_of_type_JavaLangString)) {
      localObject1 = ((Stream)localObject2).map(new babm(this.jdField_d_of_type_Int));
    }
    if (TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
      localObject1 = ((Stream)localObject1).map(new babn(0, paramXMediaEditor, paramXMediaEditor.a("troopuin")));
    }
    for (;;)
    {
      localObject2 = paramXMediaEditor.findViewHolderForLayoutPosition(this.jdField_c_of_type_Int);
      if ((localObject2 instanceof bacm))
      {
        localObject2 = (bacm)localObject2;
        if (this.jdField_d_of_type_JavaLangString.equals(((bacm)localObject2).a.getTag())) {
          ((baci)((babc)paramXMediaEditor.getAdapter()).a.a(1)).a((bacm)localObject2, this, 0);
        }
      }
