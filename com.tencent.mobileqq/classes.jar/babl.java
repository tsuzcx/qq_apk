...
public class babl
{
  private static babl jdField_a_of_type_Babl;
  private String jdField_a_of_type_JavaLangString;
  private Map<Integer, akur> jdField_a_of_type_JavaUtilMap = new HashMap();
  ...
  private Map<Integer, akur> e = new HashMap();
  private Map<Integer, Integer> f = new HashMap();
  
  private babl()
  {
    this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(1), new akur(960, 720));
    this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(2), new akur(960, 720));
  ...
  {
    if (jdField_a_of_type_Babl == null) {}
    try
    {
      if (jdField_a_of_type_Babl == null) {
        jdField_a_of_type_Babl = new babl();
      }
      return jdField_a_of_type_Babl;
    }
    finally {}
  }
  ...
  private void a()
  {
    ...
    for (;;)
    {
      ...
      for (j = arrayOfString2.length - 1;; j = 0)
      {
        ...
        {
          this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(2), new akur(arrayOfInt3[i], arrayOfInt2[i]));
          this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(1), new akur(arrayOfInt3[i], arrayOfInt2[i]));
          this.e.put(Integer.valueOf(2), new akur(arrayOfInt3[j], arrayOfInt2[j]));
          this.e.put(Integer.valueOf(1), new akur(arrayOfInt3[j], arrayOfInt2[j]));
        }
        if (localObject != null)
        {
  ...
  public akur a(int paramInt)
  {
    if (this.jdField_a_of_type_JavaUtilMap.containsKey(Integer.valueOf(paramInt))) {
      return (akur)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
    }
    return new akur(960, 720);
  }
}
