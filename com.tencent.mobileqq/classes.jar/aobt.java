...
public class aobt
{
  private static aobt jdField_a_of_type_Aobt;
  public int a;
  public Paint a;
  private LruCache<String, aobu> jdField_a_of_type_AndroidUtilLruCache;
  private aoca jdField_a_of_type_Aoca;
  
  private aobt()
  {
    this.jdField_a_of_type_Int = bdkf.a(150.0F);
    ...
    if (BaseApplicationImpl.sProcessId == 1)
    {
      if (this.jdField_a_of_type_Aoca == null) {
        this.jdField_a_of_type_Aoca = new aoca();
      }
      b();
    }
  }
  ...
  {
    if (jdField_a_of_type_Aobt == null) {
      jdField_a_of_type_Aobt = new aobt();
    }
    return jdField_a_of_type_Aobt;
  }
  
  public aobu a(String paramString)
  {
    return (aobu)this.jdField_a_of_type_AndroidUtilLruCache.get(paramString);
  }
  ...
  public List<DanmuItemBean> a(List<oidb_0xdea.Comment> paramList, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        Object localObject3 = localayvr.a((List)localObject2, new StringBuilder(), l2, paramList);
        if (TextUtils.isEmpty(((ayvs)localObject3).jdField_a_of_type_JavaLangString)) {
          break;
        }
        if ((TextUtils.isEmpty(((ayvs)localObject3).jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText$SourceMsgInfo.mAnonymousNickName)) && (((ayvs)localObject3).jdField_a_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo != null) && (!TextUtils.isEmpty(((ayvs)localObject3).jdField_a_of_type_JavaLangString)) && (((ayvs)localObject3).jdField_a_of_type_JavaLangString.length() > ((ayvs)localObject3).jdField_a_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo.textLen + 1) && (((ayvs)localObject3).jdField_a_of_type_JavaLangString.startsWith(((ayvs)localObject3).b)))
        {
          paramList = ((ayvs)localObject3).jdField_a_of_type_JavaLangString.substring(((ayvs)localObject3).jdField_a_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo.textLen + 1);
          if (!TextUtils.isEmpty(paramList)) {
            ((ayvs)localObject3).jdField_a_of_type_JavaLangString = paramList;
          }
        }
        ...
        if (TextUtils.isEmpty(paramList))
        {
          localObject1 = bdbt.h(localQQAppInterface, String.valueOf(paramLong), String.valueOf(l1));
          ...
          paramList = aocc.a(this.jdField_a_of_type_AndroidGraphicsPaint, paramList, this.jdField_a_of_type_Int);
          localObject1 = new DanmuItemBean(l1, l2, l3, l4, ((ayvs)localObject3).jdField_a_of_type_JavaLangString, paramList);
      ...
      if (i == 4)
      {
        localObject1 = ((aloz)localQQAppInterface.getManager(51)).b(String.valueOf(l1));
  ...
  public void a(aobs paramaobs, aoby paramaoby)
  {
    if ((paramaobs.a == 0L) || (paramaobs.b == 0L))
    {
      if (QLog.isColorLevel()) {
        QLog.d("DanmuDataHolder", 2, String.format("request, bad parameter, topicUin:%s, groupUin:%s", new Object[] { Long.valueOf(paramaobs.a), Long.valueOf(paramaobs.b) }));
      }
      return;
    }
    Object localObject = a().a(paramaobs.b, paramaobs.a);
    aobu localaobu = a().a((String)localObject);
    localObject = localaobu;
    if (localaobu == null)
    {
      localObject = new aobu(this).a(paramaobs).d(0).e(0).a(paramaoby).a();
      QLog.d("DanmuDataHolder", 2, "request start, reqHolder is null, create it");
    }
    this.jdField_a_of_type_Aoca.a((aobu)localObject);
  }
  
  public void a(String paramString, aobu paramaobu)
  {
    this.jdField_a_of_type_AndroidUtilLruCache.put(paramString, paramaobu);
  }
  
  public aobu b(String paramString)
  {
    aobu localaobu = new aobu(this);
    a(paramString, localaobu);
    return localaobu;
  }
  ...
  public void b()
  {
    ...
    if ((this.jdField_a_of_type_AndroidGraphicsPaint == null) && (localQQAppInterface != null)) {
      this.jdField_a_of_type_AndroidGraphicsPaint = ((TextView)LayoutInflater.from(localQQAppInterface.getApp()).inflate(2131558853, null).findViewById(2131364509)).getPaint();
    }
  }
}
