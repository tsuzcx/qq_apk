  ...
  extends alko
{
  ...
  public alxw(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_JavaLangString = paramQQAppInterface.getApplication().getString(2131720072);
    this.jdField_b_of_type_JavaLangString = paramQQAppInterface.getApplication().getString(2131720073);
    this.c = paramQQAppInterface.getApplication().getString(2131720070);
    this.d = paramQQAppInterface.getApplication().getString(2131720074);
    this.f = paramQQAppInterface.getApplication().getString(2131720068);
    this.g = paramQQAppInterface.getApplication().getString(2131720066);
    this.h = paramQQAppInterface.getApplication().getString(2131720069);
    this.e = paramQQAppInterface.getApplication().getString(2131720071);
    this.i = paramQQAppInterface.getApplication().getString(2131720067);
  }
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, sso2sns_0x3_blocklist.RspBody paramRspBody)
  {
    ...
    ((atvt)this.app.getManager(16)).a(paramFromServiceMsg);
  ...
  private void a(boolean paramBoolean, int paramInt, long[] paramArrayOfLong)
  {
    ...
    if (j < m)
    {
      ...
      if (k != 1006) {
        if (paramBoolean)
        {
          ...
          if (k == 1024)
          {
            localbfua = (bfua)this.app.getManager(165);
            if (localbfua != null)
            {
              localObject1 = localObject2;
              if (!localbfua.a((String)localObject3))
              {
                localObject1 = localObject2;
                if (localbfua.f((String)localObject3)) {}
              }
            }
            else
            {
          ...
          if ((localObject1 == null) || (((List)localObject1).size() <= 0) || (!abot.a((MessageRecord)((List)localObject1).get(((List)localObject1).size() - 1), (MessageRecord)localObject3, false))) {
            break label610;
          }
          if (QLog.isColorLevel()) {
    ...
    for (int k = 1;; k = 0)
    {
      ...
      do
      {
        ...
        localObject2 = bdbt.f(this.app, String.valueOf(l1));
  ...
  private boolean a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    long l1 = bdlr.a(arrayOfByte1, 0);
    long l2 = bdlr.a(arrayOfByte1, 4);
  ...
  private boolean a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, sso2sns_0x3_blocklist.RspBody paramRspBody)
  {
    ...
    paramToServiceMsg = (atvt)this.app.getManager(16);
    int j = 0;
  ...
  private byte[] a(sso2sns_comm_info.Sso2SnsCommInfo paramSso2SnsCommInfo, sso2sns_0x3_blocklist.ReqBody paramReqBody)
  {
    ...
    bdlr.a(arrayOfByte1, 0, l1);
    bdlr.a(arrayOfByte2, 0, l2);
  ...
  private void d()
  {
    ...
    ((atvt)this.app.getManager(16)).a(localArrayList);
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    if (paramInt == 1006)
    {
      paramString = bdbt.e(this.app, paramString);
