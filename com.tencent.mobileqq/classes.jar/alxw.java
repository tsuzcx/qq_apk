  ...
  extends ahbj
{
  ...
  public View a(int paramInt, Object paramObject, ahbe paramahbe, View paramView, ViewGroup paramViewGroup, Context paramContext, View.OnClickListener paramOnClickListener, View.OnLongClickListener paramOnLongClickListener, ahdb paramahdb)
  {
    ...
    {
      paramahbe = null;
      if ((paramView == null) || (!(paramView.getTag() instanceof alxx))) {
        break label179;
      }
      paramahbe = (alxx)paramahbe;
      label35:
    ...
    for (;;)
    {
      if ((paramView.getLayoutParams() instanceof AbsListView.LayoutParams))
      {
        ...
        if ((paramObject instanceof Integer))
        {
          ...
          paramahbe.jdField_a_of_type_AndroidWidgetTextView.setText(2131632959);
        }
      }
      while (paramInt != 17)
      {
        ...
        break;
        paramView = LayoutInflater.from(paramContext).inflate(2131495124, null);
        paramahbe = new alxx();
        ...
        this.a = (paramOnClickListener.getDimensionPixelSize(2131166868) + paramOnClickListener.getDimensionPixelSize(2131166870) + paramOnClickListener.getDimensionPixelSize(2131166869) * 2);
        break label35;
      ...
      paramahbe.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(null);
      paramahbe.jdField_a_of_type_AndroidWidgetTextView.setText(2131632958);
      return paramView;
    }
  }
}
