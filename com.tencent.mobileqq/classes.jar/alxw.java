...
public class alxw
  extends amgf
{
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new alxx(this);
  ...
  public alxw(PhoneContactTabView paramPhoneContactTabView, Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, boolean paramBoolean)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    int i = Arrays.binarySearch(this.jdField_a_of_type_ArrayOfInt, paramInt);
    if (paramView == null) {
      paramView = alyb.a(paramViewGroup, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberPhoneContactTabView.jdField_a_of_type_AndroidViewLayoutInflater, 2131558995);
    }
    for (;;)
    {
      ...
      if (i < 0)
      {
        ...
        alyb.a(this, localalyb, (PhoneContact)localObject);
        localalyb.jdField_b_of_type_AndroidWidgetTextView.setText(((PhoneContact)localObject).name);
        localalyb.d.setText(((PhoneContact)localObject).mobileNo);
        localalyb.d.setVisibility(0);
        if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberPhoneContactTabView.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.isResultListContainFriend(localalyb.jdField_a_of_type_JavaLangString))
        {
          ...
          if ((AppSetting.c) && (localalyb.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
          {
            ...
            paramView.setContentDescription(((PhoneContact)localObject).name + anvx.a(2131707451));
          }
          label226:
          localalyb.jdField_a_of_type_ComTencentMobileqqDataPhoneContact = ((PhoneContact)localObject);
          localalyb.jdField_b_of_type_AndroidViewView.setVisibility(8);
          localalyb.jdField_b_of_type_AndroidViewView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
      ...
      for (;;)
      {
        ...
        break;
        label291:
        paramView.setContentDescription(((PhoneContact)localObject).name + anvx.a(2131707449));
        break label226;
