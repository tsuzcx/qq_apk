...
public class bblf
{
  public static final Comparator<? super abyg> a = new bblg();
  
  public static int a(int paramInt, QQAppInterface paramQQAppInterface)
  {
    return ((abyl)paramQQAppInterface.getMessageFacade().getRegistry().a().a(Integer.valueOf(paramInt))).a();
  }
  ...
  public static int a(im_msg_body.RichText paramRichText, String paramString, ArrayList<MessageForText.AtTroopMemberInfo> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      {
        bblh localbblh = new bblh(paramRichText, paramString, paramArrayList, i, j, localStringBuilder, k).a();
        i = localbblh.a();
        j = localbblh.b();
        k = localbblh.c() + 1;
      }
  ...
  public static MessageRecord a(List<MessageRecord> paramList, byte[] paramArrayOfByte, bdyi parambdyi)
  {
    ...
    paramList = (MessageForMixedMsg)bbli.a(-1035);
    paramList.msgtype = -1035;
    paramList.msgData = localMsg.toByteArray();
    if ((parambdyi != null) && (parambdyi.jdField_a_of_type_Int == 3000)) {
      paramList.frienduin = parambdyi.jdField_a_of_type_JavaLangString;
    }
    if (i != 0) {
      bevq.a(parambdyi.jdField_a_of_type_Int, localJSONObject.toString(), paramList);
    }
  ...
  public static String a(String paramString)
  {
    ...
    if (i < paramString.length())
    {
      if ((paramString.charAt(i) == '\024') && (i + 1 < paramString.length()))
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "localeCode value:" + k + ",max len:" + bblk.a.length);
        }
        j = i;
  ...
  private static List<abyg> a(List<im_msg_body.Elem> paramList, QQMessageFacade paramQQMessageFacade)
  {
  ...
  public static msg_svc.PbSendMsgReq a(QQAppInterface paramQQAppInterface, int paramInt1, String paramString, bbln parambbln, long paramLong, int paramInt2)
  {
    if (parambbln == null) {
    ...
    do
    {
      ...
      {
        l = 0x0 | parambbln.jdField_a_of_type_ArrayOfByte.length << 16 | 0xA6;
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "<PbSendMsg><S>--->createPbSendMsgReq: routingType:" + paramInt1 + ",toUin:" + paramString + ",msgUid:" + l + ",msgSeq:" + paramLong + ",uint32Seq:" + k + ",shortSeq:" + j + ",randomNum:" + paramInt2 + ",msgContext:" + parambbln);
        }
      ...
      for (;;)
      {
        ...
        ((msg_svc.TransMsg)localObject).c2c_cmd.set(parambbln.jdField_a_of_type_Int);
        ...
        ((msg_svc.Trans0x211)localObject).cc_cmd.set(parambbln.jdField_a_of_type_Int);
        paramString = paramString.replace("+", "");
        ((msg_svc.Trans0x211)localObject).to_uin.set(mrb.a(paramString));
      ...
      localMsgBody.msg_content.set(ByteStringMicro.copyFrom(parambbln.jdField_a_of_type_ArrayOfByte));
      ...
      parambbln = paramQQAppInterface.a();
      paramQQAppInterface = paramString;
    } while (parambbln == null);
    paramString.sync_cookie.set(ByteStringMicro.copyFrom(parambbln));
    return paramString;
  }
  ...
  public static msg_svc.PbSendMsgReq a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, im_msg_body.RichText paramRichText, int paramInt)
  {
    ...
    do
    {
      ...
      k = bblk.a(l);
      localbbko = paramQQAppInterface.getMsgCache();
      localRoutingHead = new msg_svc.RoutingHead();
    ...
    if ((i != 2) && (i != 4) && (i != 21))
    {
      paramMessageRecord = localbbko.a();
  ...
  public static im_msg_body.RichText a(ChatMessage paramChatMessage, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      byte[] arrayOfByte = bciq.b((byte[])localObject3);
      localObject1 = localObject2;
      if (arrayOfByte == null) {
        continue;
      }
      ...
      try
      {
        ...
        for (;;)
        {
          ...
          if ((paramChatMessage == null) || (paramChatMessage.length() == 0)) {
            localObject1 = BaseApplication.getContext().getString(2131693341);
          } else {
            localObject1 = String.format(BaseApplication.getContext().getString(2131693342), new Object[] { paramChatMessage });
          }
        }
        return null;
      }
  ...
  public static im_msg_body.RichText a(MessageForMarketFace paramMessageForMarketFace)
  {
    ...
    for (String str = amtj.a(2131705771);; str = "[" + paramMessageForMarketFace.mMarkFaceMessage.faceName + "]")
    {
      boolean bool = true;
  ...
  public static im_msg_body.RichText a(MessageForReplyText paramMessageForReplyText)
  {
    ...
    try
    {
      String str = HexUtil.bytes2HexStr(anwz.a(paramMessageForReplyText.mSourceMsgInfo));
      localObject1 = str;
      localObject2 = str;
      ...
      if ((paramMessageForStructing.structingMsg instanceof AbsShareMsg))
      {
        ...
        if (localObject1 != null)
        {
          ...
          for (;;)
          {
            ...
            {
              localObject2 = ((bcgx)localObject2).a;
              if (localObject2 != null)
              {
  ...
  public static im_msg_body.RichText a(MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      if (!TextUtils.isEmpty((CharSequence)localObject4))
      {
        try
        {
          localSourceMsgInfo = (MessageForReplyText.SourceMsgInfo)anwz.a(HexUtil.hexStr2Bytes((String)localObject4));
  ...
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg, boolean paramBoolean1, boolean paramBoolean2, bdyi parambdyi)
  {
    a(paramMessageHandler, paramList, paramMsg, paramBoolean1, paramBoolean2, parambdyi, null, null);
  }
  
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg, boolean paramBoolean1, boolean paramBoolean2, bdyi parambdyi, bblm parambblm, bbkm parambbkm)
  {
    ...
    do
    {
      ...
      a(localList, paramMsg, paramList, (StringBuilder)localObject1, paramMessageHandler.app.getMessageFacade(), paramBoolean2, paramBoolean1, parambdyi, (List)localObject2, parambblm, parambbkm);
    } while (!QLog.isColorLevel());
  ...
  private static void a(List<abyg> paramList1, List<abyg> paramList2)
  {
    paramList2 = paramList2.iterator();
    while (paramList2.hasNext())
    {
      abyg localabyg = (abyg)paramList2.next();
      if (localabyg != null) {
        localabyg.a(paramList1);
      }
    }
  }
  
  private static void a(List<im_msg_body.Elem> paramList, List<abyg> paramList1, List<abyg> paramList2)
  {
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      ...
      while (localIterator.hasNext())
      {
        abyg localabyg = (abyg)localIterator.next();
        if ((localabyg != null) && (localabyg.a(localElem))) {
          paramList1.add(localabyg);
        }
      }
    }
  }
  
  private static void a(List<im_msg_body.Elem> paramList, msg_comm.Msg paramMsg, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, bdyi parambdyi)
  {
    bblb localbblb = new bblb();
    if (paramList1.isEmpty()) {
      localbblb.f(paramList, paramList1, paramStringBuilder, paramMsg, parambdyi);
    }
    if (paramList1.isEmpty()) {
      localbblb.i(paramList, paramList1, paramStringBuilder, paramMsg, parambdyi);
    }
  }
  
  private static void a(List<im_msg_body.Elem> paramList, msg_comm.Msg paramMsg, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, QQMessageFacade paramQQMessageFacade, boolean paramBoolean1, boolean paramBoolean2, bdyi parambdyi, List<abyg> paramList2, bblm parambblm, bbkm parambbkm)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        localabyg = (abyg)paramQQMessageFacade.next();
      } while (localabyg == null);
      bool = localabyg.a(paramList, paramMsg, paramList1, paramStringBuilder, paramBoolean1, paramBoolean2, parambdyi, parambblm, parambbkm);
      if (QLog.isColorLevel()) {
        QLog.d("Q.msg.MessageHandler", 2, "dispatchDecodePBMsgElements() decoder = [" + localabyg + "], handled = [" + bool + "]");
      }
    } while (!bool);
    a(paramList, paramMsg, paramList1, paramStringBuilder, parambdyi);
    b(paramList2);
    paramQQMessageFacade = paramList2.iterator();
    while (paramQQMessageFacade.hasNext())
    {
      paramList2 = (abyg)paramQQMessageFacade.next();
      if (paramList2 != null)
      {
        bool = paramList2.a(paramList, paramMsg, paramList1, paramStringBuilder, paramBoolean1, paramBoolean2, parambdyi, parambblm, parambbkm);
        if (QLog.isColorLevel()) {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, msg_svc.RoutingHead paramRoutingHead)
  {
    ...
    int i = b(paramMessageRecord.istroop, paramQQAppInterface);
    return ((abyl)paramQQAppInterface.getMessageFacade().getRegistry().a().a(Integer.valueOf(i))).a(paramRoutingHead, paramMessageRecord, paramQQAppInterface);
  }
  ...
  public static im_msg_body.RichText b(ChatMessage paramChatMessage)
  {
    if ((paramChatMessage != null) && ((paramChatMessage instanceof MessageForLimitChatConfirm)))
    {
      ...
      for (int i = 1;; i = 2)
      {
        ...
        ((im_msg_body.Text)localObject2).str.set(ByteStringMicro.copyFromUtf8(amtj.a(2131705774)));
  ...
  public static im_msg_body.RichText b(ChatMessage paramChatMessage, boolean paramBoolean)
  {
    ...
    localObject2 = bciq.b((byte[])localObject2);
    if ((localObject2 == null) || (localObject2.length == 0)) {
      return null;
    }
    ...
    if (((MessageForArkApp)localObject1).ark_app_message.containStructMsg != null)
    {
      ...
      if (!"1".equals(paramChatMessage.getExtInfoFromExtStr(bbkv.e))) {
        break label466;
      }
    }
    label466:
    for (int i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        ...
        if ((localObject1 == null) || (((String)localObject1).length() == 0)) {
          ...
          localObject1 = String.format(BaseApplication.getContext().getString(2131693342), new Object[] { localObject1 });
        }
      }
    }
  }
  ...
  public static im_msg_body.RichText b(MessageForApollo paramMessageForApollo)
  {
    ...
    localApolloActMsg.uint32_peer_uin.set(bftf.a(localApolloMessage.peer_uin));
    localApolloActMsg.uint32_sender_ts.set(bftf.a(localApolloMessage.sender_ts));
    localApolloActMsg.uint32_peer_ts.set(bftf.a(localApolloMessage.peer_ts));
    ...
    localObject1 = amtj.a(2131705775);
  ...
  private static void b(List<abyg> paramList)
  {
    int i = paramList.size() - 1;
    while (i >= 0)
    {
      if (((abyg)paramList.get(i)).a() > -1000) {
        paramList.remove(i);
      }
      i -= 1;
    }
  ...
  private static void b(List<abyg> paramList1, List<abyg> paramList2)
  {
  ...
  public static im_msg_body.RichText c(ChatMessage paramChatMessage)
  {
    ...
    do
    {
      ...
      localObject2 = bciq.b((byte[])localObject1);
    ...
    try
    {
      ...
      paramChatMessage = a(bblk.a(paramChatMessage.getSummery(), true, null), null);
      paramChatMessage.elems.add((MessageMicro)localObject2);
      return paramChatMessage;
    }
    catch (Exception paramChatMessage) {}
  ...
  public static im_msg_body.RichText c(ChatMessage paramChatMessage, boolean paramBoolean)
  {
    ...
    paramChatMessage = bciq.b(paramChatMessage);
    if ((paramChatMessage == null) || (paramChatMessage.length == 0)) {
      return null;
    }
  ...
  public static im_msg_body.RichText e(ChatMessage paramChatMessage)
  {
    ...
    paramChatMessage = new im_msg_body.Elem();
    paramChatMessage.common_elem.set((MessageMicro)localObject1);
    Object localObject2 = amtj.a(2131705773);
    localObject1 = new im_msg_body.Text();
    ((im_msg_body.Text)localObject1).str.set(ByteStringMicro.copyFromUtf8((String)localObject2));
    localObject2 = new im_msg_body.Elem();
    ((im_msg_body.Elem)localObject2).text.set((MessageMicro)localObject1);
  ...
  public static im_msg_body.RichText f(ChatMessage paramChatMessage)
  {
    ...
    Object localObject2 = amtj.a(2131705778);
    Object localObject1 = "";
  ...
  public static im_msg_body.RichText g(ChatMessage paramChatMessage)
  {
    if ((paramChatMessage != null) && ((paramChatMessage instanceof MessageForScribble)))
    {
      ...
      localObject1 = new im_msg_body.Elem();
      localObject2 = new im_msg_body.Text();
      ((im_msg_body.Text)localObject2).str.set(ByteStringMicro.copyFromUtf8(amtj.a(2131705770)));
      ((im_msg_body.Elem)localObject1).text.set((MessageMicro)localObject2);
      ((im_msg_body.Elem)localObject1).text.setHasFlag(true);
      localObject2 = new im_msg_body.RichText();
      ((im_msg_body.RichText)localObject2).elems.add((MessageMicro)localObject1);
