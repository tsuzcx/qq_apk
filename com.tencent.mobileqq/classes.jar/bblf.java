...
{
  private alsi jdField_a_of_type_Alsi = new bblg(this);
  private bblm jdField_a_of_type_Bblm;
  private bblx jdField_a_of_type_Bblx;
  ...
  private void a(MessageRecord paramMessageRecord, TroopAioKeywordTipInfo paramTroopAioKeywordTipInfo)
  {
    ...
    this.jdField_d_of_type_Int = this.jdField_a_of_type_Aelz.a(paramMessageRecord.uniseq);
    if (this.jdField_a_of_type_Bblm == null)
    {
      this.jdField_a_of_type_Bblm = new bblm(this);
      this.jdField_a_of_type_Bblm.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560398, null));
      this.jdField_a_of_type_Bblm.jdField_a_of_type_AndroidViewViewGroup.setOnClickListener(this);
      this.jdField_a_of_type_Bblm.jdField_a_of_type_ComTencentWidgetURLThemeImageView = ((URLThemeImageView)this.jdField_a_of_type_Bblm.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378258));
      this.jdField_a_of_type_Bblm.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_Bblm.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378261));
      this.jdField_a_of_type_Bblm.b = ((TextView)this.jdField_a_of_type_Bblm.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378260));
      this.jdField_a_of_type_Bblm.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_Bblm.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378257));
      this.jdField_a_of_type_Bblm.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130850007);
    }
    this.jdField_a_of_type_Bblm.jdField_a_of_type_AndroidViewViewGroup.setBackgroundResource(2130843445);
    for (;;)
    {
      try
      {
        ...
        this.jdField_a_of_type_Bblm.jdField_a_of_type_ComTencentWidgetURLThemeImageView.setImageDrawable((Drawable)localObject1);
        if (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipInfo.title))
        {
          this.jdField_a_of_type_Bblm.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
          if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipInfo.summary)) {
            break label688;
          }
          this.jdField_a_of_type_Bblm.b.setVisibility(8);
          if (this.jdField_a_of_type_AndroidWidgetRelativeLayout.indexOfChild(this.jdField_a_of_type_Bblm.jdField_a_of_type_AndroidViewViewGroup) < 0)
          {
            localObject1 = new RelativeLayout.LayoutParams(-2, -2);
            ((RelativeLayout.LayoutParams)localObject1).topMargin = bcwh.a(this.jdField_a_of_type_AndroidContentContext, 18.0F);
            ((RelativeLayout.LayoutParams)localObject1).addRule(11);
            this.jdField_a_of_type_AndroidWidgetRelativeLayout.addView(this.jdField_a_of_type_Bblm.jdField_a_of_type_AndroidViewViewGroup, (ViewGroup.LayoutParams)localObject1);
          }
          localObject1 = (RelativeLayout.LayoutParams)this.jdField_a_of_type_Bblm.jdField_a_of_type_AndroidViewViewGroup.getLayoutParams();
          int i = bblr.a(this.jdField_a_of_type_AndroidWidgetRelativeLayout, new int[] { 2131378420, 2131373393, 2131373478, 2131373473 });
          if (i > 0) {
            ((RelativeLayout.LayoutParams)localObject1).addRule(3, i);
          }
          this.jdField_a_of_type_Bblm.jdField_a_of_type_AndroidViewViewGroup.setVisibility(0);
          localObject1 = new TranslateAnimation(2, 1.0F, 2, 0.0F, 2, 0.0F, 2, 0.0F);
          ((Animation)localObject1).setDuration(500L);
          this.jdField_b_of_type_Boolean = true;
          ((Animation)localObject1).setAnimationListener(new bblh(this));
          if (this.jdField_a_of_type_Bblm.jdField_a_of_type_AndroidViewViewGroup.getAnimation() == null) {
            this.jdField_a_of_type_Bblm.jdField_a_of_type_AndroidViewViewGroup.startAnimation((Animation)localObject1);
          }
          localObject2 = new azmo(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_AIO").c("notice_center_new");
          if (!paramMessageRecord.isSend()) {
            break label719;
          }
          localObject1 = "exp_keyword_input";
          ((azmo)localObject2).d((String)localObject1).a(new String[] { paramMessageRecord.frienduin, String.valueOf(paramTroopAioKeywordTipInfo.ruleId), paramMessageRecord.getExtInfoFromExtStr("key_aio_keyword") }).a();
          return;
        }
      }
      ...
      this.jdField_a_of_type_Bblm.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
      this.jdField_a_of_type_Bblm.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipInfo.title);
      continue;
      label688:
      this.jdField_a_of_type_Bblm.b.setVisibility(0);
      this.jdField_a_of_type_Bblm.b.setText(this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipInfo.summary);
      continue;
      label719:
  ...
  private boolean a(MessageRecord paramMessageRecord)
  {
    ...
    return a(this.jdField_a_of_type_Aelz.b(paramMessageRecord.uniseq));
  }
  
  private void b(boolean paramBoolean)
  {
    if ((!this.jdField_a_of_type_Boolean) || (this.jdField_a_of_type_Bblm == null) || (!this.jdField_b_of_type_Boolean) || (this.jdField_a_of_type_AndroidWidgetRelativeLayout.indexOfChild(this.jdField_a_of_type_Bblm.jdField_a_of_type_AndroidViewViewGroup) < 0)) {}
    ...
    do
    {
      ...
      localTranslateAnimation.setAnimationListener(new bbli(this, paramBoolean));
    } while (this.jdField_a_of_type_Bblm.jdField_a_of_type_AndroidViewViewGroup.getAnimation() != null);
    this.jdField_a_of_type_Bblm.jdField_a_of_type_AndroidViewViewGroup.startAnimation(localTranslateAnimation);
  }
  ...
  private boolean b()
  {
    ...
    do
    {
      ...
      return false;
      if ((this.jdField_a_of_type_Bblx == null) || (!this.jdField_a_of_type_Bblx.g())) {
        break label129;
      }
    } while (!QLog.isColorLevel());
  ...
  {
    if (this.jdField_a_of_type_Bblm != null) {
      return this.jdField_a_of_type_Bblm.jdField_a_of_type_AndroidViewViewGroup;
    }
    return null;
  }
  ...
  protected void d()
  {
    ...
    if ((this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) && (this.jdField_a_of_type_Bblm != null) && (this.jdField_a_of_type_AndroidWidgetRelativeLayout.indexOfChild(this.jdField_a_of_type_Bblm.jdField_a_of_type_AndroidViewViewGroup) >= 0))
    {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.removeView(this.jdField_a_of_type_Bblm.jdField_a_of_type_AndroidViewViewGroup);
      this.jdField_a_of_type_Bblm = null;
    }
  ...
  public void e()
  {
    ...
    {
      return;
      i = this.jdField_a_of_type_Aelz.a().size();
      if (i != this.e) {
        break;
      }
    } while (!QLog.isColorLevel());
  ...
  public void f()
  {
    ...
    this.jdField_d_of_type_Int = this.jdField_a_of_type_Aelz.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.uniseq);
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramView = paramView.replace("$TEXT$", bdbi.encodeToString(((MessageForText)this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord).sb.toString().getBytes(), 0));
        localObject = paramView;
        if (this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipInfo.url.contains("$KEYWORD$")) {
          localObject = paramView.replace("$KEYWORD$", bdbi.encodeToString(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.getExtInfoFromExtStr("key_aio_keyword").getBytes(), 0));
        }
      ...
      localObject = new azmo(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_AIO").c("notice_center_new");
      if (this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.isSend())
      {
        paramView = "clk_keyword_input";
        ((azmo)localObject).d(paramView).a(new String[] { this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.frienduin, String.valueOf(this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipInfo.ruleId), this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.getExtInfoFromExtStr("key_aio_keyword") }).a();
        b(true);
        return;
        if ((this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord instanceof MessageForStructing))
        {
          ...
          {
            paramView = paramView.replace("$TEXT$", bdbi.encodeToString(((AbsShareMsg)((MessageForStructing)localObject).structingMsg).mContentTitle.getBytes(), 0));
            continue;
            if (((String)localObject).startsWith("mqqapi"))
            {
              paramView = bdds.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, (String)localObject);
              if (paramView != null)
              {
                paramView.c();
                continue;
