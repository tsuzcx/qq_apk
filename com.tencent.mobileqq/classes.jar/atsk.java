  ...
  implements Handler.Callback
{
  ...
  public atsk(Conversation paramConversation, ViewGroup paramViewGroup)
  {
    ...
    this.jdField_a_of_type_Bejz = new atsn(this);
    this.jdField_c_of_type_Boolean = true;
    this.jdField_f_of_type_Int = -1;
    this.jdField_e_of_type_Boolean = true;
    this.jdField_f_of_type_Boolean = befo.e();
  ...
  private void a(View paramView1, View paramView2, View paramView3)
  {
    ...
    if (this.jdField_a_of_type_ComNineoldandroidsAnimationValueAnimator == null)
    {
      ...
      this.jdField_a_of_type_ComNineoldandroidsAnimationValueAnimator.addUpdateListener(new atss(this, paramView2, paramView1, paramView3));
      this.jdField_a_of_type_ComNineoldandroidsAnimationAnimator$AnimatorListener = new atst(this, paramView3);
    }
  ...
  private void b(View paramView1, View paramView2, View paramView3)
  {
    ...
    if (this.jdField_b_of_type_ComNineoldandroidsAnimationValueAnimator == null)
    {
      ...
      this.jdField_b_of_type_ComNineoldandroidsAnimationValueAnimator.addUpdateListener(new atsl(this, paramView2, paramView1, paramView3));
      this.jdField_b_of_type_ComNineoldandroidsAnimationAnimator$AnimatorListener = new atsm(this, paramView3, paramView1);
    }
  ...
  private void o()
  {
    ...
    do
    {
      ...
      if (this.jdField_d_of_type_Int == 3)
      {
        int j = aciy.a(100.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
  ...
  public void b(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidOsCountDownTimer = new atso(this, arrayOfLong[1], 40L, arrayOfLong);
  ...
  public boolean c()
  {
    ...
    localAlphaAnimation.setAnimationListener(new atsp(this));
    ...
    localTranslateAnimation.setAnimationListener(new atsq(this));
    localAnimationSet.addAnimation(localTranslateAnimation);
    localAnimationSet.addAnimation(localAlphaAnimation);
    localAlphaAnimation = new AlphaAnimation(1.0F, 0.0F);
    localAlphaAnimation.setDuration(500L);
    localAlphaAnimation.setStartOffset(1000L);
    localAlphaAnimation.setAnimationListener(new atsr(this));
    localAnimationSet.addAnimation(localAlphaAnimation);
