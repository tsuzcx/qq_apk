  ...
  implements akqw
{
  ...
  private List<augl> jdField_a_of_type_JavaUtilList;
  private Drawable b;
  
  public auej(Context paramContext)
  {
    ...
    this.b = paramContext.getResources().getDrawable(2130839414);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560934, null);
      paramView = new auel(this, null);
      paramView.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localView.findViewById(2131368320));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131378898));
      paramView.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)localView.findViewById(2131373048));
      localView.setTag(paramView);
    }
    Object localObject1;
    for (;;)
    {
      localObject1 = (augl)getItem(paramInt);
      ...
      return localView;
      localObject1 = (auel)paramView.getTag();
      localView = paramView;
      paramView = (View)localObject1;
    }
    URL localURL = ((augl)localObject1).a();
    int i = ((augl)localObject1).a();
    if (localURL != null)
    {
      ...
      if (((augl)localObject1).a())
      {
        paramView.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
        label246:
        a(localView, (URLDrawable)localObject2, ((augl)localObject1).b());
        if ((i != 1) || (!AsyncImageView.a(localURL)) || (!auog.a(((augl)localObject1).b()))) {
          break label321;
        }
