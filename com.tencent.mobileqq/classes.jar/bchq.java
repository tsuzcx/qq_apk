  ...
  implements bchm<bcfq>
{
  ...
  public List<bcfq> a(Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (m < i2)
        {
          ...
          for (;;)
          {
            ...
            localObject4 = str6;
            continue;
            paramVarArgs = new bcfy(str2, l3, localArrayList2, localResultItem, j);
            continue;
            paramVarArgs = new bcgu(str2, l3, localArrayList2, localResultItem, j);
            continue;
            paramVarArgs = new bcfz(str2, l3, localArrayList2, localResultItem, j);
            continue;
            paramVarArgs = new bcgh(str2, l3, localArrayList2, localResultItem, j);
            continue;
            paramVarArgs = new bcgq(str2, l3, localArrayList2, localResultItem, j);
            continue;
            paramVarArgs = new bcgn(str2, l3, localArrayList2, localResultItem, j);
            continue;
            paramVarArgs = new bcgo(str2, l3, localArrayList2, localResultItem, j);
            continue;
            paramVarArgs = new bcge(str2, l3, localArrayList2, localResultItem, j);
            continue;
            paramVarArgs = new bcgc(str2, l3, localArrayList2, localResultItem, j);
            continue;
            paramVarArgs = new bcgf(str2, l3, localArrayList2, localResultItem, j);
            continue;
            paramVarArgs = new bcgp(str2, l3, localArrayList2, localResultItem, j);
            continue;
            paramVarArgs = new bcgm(str2, l3, localArrayList2, localResultItem, j);
            continue;
            paramVarArgs = new bcgk(str2, l3, localArrayList2, localResultItem, j);
            continue;
            l2 = l1 - 1L;
            continue;
            if (!bcni.b(l2))
            ...
            {
              paramVarArgs = new bcha(str2, str14, -4, str12);
              paramVarArgs.u = localResultItem.seporator_type.get();
              localArrayList3.add(paramVarArgs);
              l2 = l1;
            }
            ...
            {
              paramVarArgs = new bcep(str2, str10, str11, str12, str13, str14, l2, localArrayList2, j, str1, (String)localObject1, n, (String)localObject2, paramVarArgs, (String)localObject4);
              l2 = l1;
      ...
      {
        localArrayList1.add(new bceo(str2, l3, str7, localArrayList3, l1, paramVarArgs, (String)localObject1, localArrayList2, bool1, bool2, bool3, str8, str9));
        break;
        bool2 = false;
        break label1589;
      }
