  ...
  implements Manager
{
  ...
  public aeky(QQAppInterface paramQQAppInterface)
  {
  ...
  private void b(MessageRecord paramMessageRecord, AppGuideTipsConfig paramAppGuideTipsConfig)
  {
    ...
    paramMessageRecord = new aslp(str, (String)localObject, paramAppGuideTipsConfig.tipsMsg, paramMessageRecord.istroop, -5022, 2621441, l);
  ...
  public void a(BaseChatPie paramBaseChatPie, MessageRecord paramMessageRecord)
  {
    ...
    label22:
    while (aoep.a(paramMessageRecord)) {
      return;
    }
    ...
    for (;;)
    {
      ...
      azmj.b(null, "dc00898", "", "", "0X8008947", "0X8008947", 0, 0, "", "", "", "");
      return;
      localAppGuideTipsConfig.allow = false;
      break label92;
      label277:
  ...
  public void a(java.util.List<AppGuideTipsConfig> paramList)
  {
    ...
    //   15: astore_3
    //   16: aload_0
    //   17: getfield 50	aeky:jdField_a_of_type_Awbw	Lawbw;
    //   20: invokevirtual 402	awbw:a	()Lawby;
    //   23: astore 4
    //   25: aload 4
    //   27: astore_3
    //   28: aload_3
    //   29: invokevirtual 406	awby:a	()V
    //   32: aload_0
    //   33: getfield 32	aeky:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   36: invokeinterface 409 1 0
    //   41: aload_0
    //   42: iconst_0
    //   43: putfield 93	aeky:jdField_a_of_type_Boolean	Z
    //   46: iconst_0
    //   47: istore_2
    //   48: iload_2
    //   49: aload_1
    ...
    //   72: ifnull +234 -> 306
    //   75: aload_0
    //   76: getfield 50	aeky:jdField_a_of_type_Awbw	Lawbw;
    //   79: ldc 95
    //   81: aload 4
    //   83: getfield 387	com/tencent/mobileqq/data/AppGuideTipsConfig:tipsType	Ljava/lang/String;
    //   86: invokevirtual 415	awbw:a	(Ljava/lang/Class;Ljava/lang/String;)Lawbv;
    ...
    //   139: aload_0
    //   140: getfield 50	aeky:jdField_a_of_type_Awbw	Lawbw;
    //   143: aload 4
    //   145: ldc_w 421
    //   148: iconst_1
    ...
    //   154: ldc 238
    //   156: aastore
    //   157: invokevirtual 424	awbw:a	(Lawbv;Ljava/lang/String;[Ljava/lang/String;)Z
    //   160: pop
    //   161: iconst_0
    //   162: istore_2
    //   163: iload_2
    ...
    //   190: aload_0
    //   191: aload 4
    //   193: invokevirtual 382	aeky:a	(Lawbv;)Z
    //   196: pop
    //   197: goto +116 -> 313
    //   200: aload_3
    //   201: invokevirtual 425	awby:c	()V
    //   204: aload_3
    //   205: ifnull -192 -> 13
    //   208: aload_3
    //   209: invokevirtual 427	awby:b	()V
    //   212: return
    //   213: astore 4
    //   215: aload_3
    //   216: astore_1
    ...
    //   227: ifeq +33 -> 260
    //   230: getstatic 22	aeky:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   233: iconst_2
    ...
    //   261: ifnull -248 -> 13
    //   264: aload_1
    //   265: invokevirtual 427	awby:b	()V
    //   268: return
    //   269: astore_1
    //   270: aconst_null
    //   271: astore_3
    ...
    //   273: ifnull +7 -> 280
    //   276: aload_3
    //   277: invokevirtual 427	awby:b	()V
    //   280: aload_1
    //   281: athrow
    //   282: astore_1
    //   283: goto -11 -> 272
