...
public class aeky
  extends andd
{
  public aeky(TroopDisbandActivity paramTroopDisbandActivity) {}
  ...
  protected void onGetMutilTroopInfoResult(boolean paramBoolean, ArrayList<TroopInfo> paramArrayList)
  {
    ...
    label56:
    while (!bftf.a(localTroopInfo.troopuin, this.a.jdField_a_of_type_JavaLangString))
    {
      i += 1;
      break label21;
      break;
  ...
  protected void onGetTroopInfoResult(boolean paramBoolean, String paramString)
  {
    ...
    if ((paramBoolean) && (bftf.a(paramString, this.a.jdField_a_of_type_JavaLangString)))
    {
  ...
  {
    if (!bftf.a(String.valueOf(paramLong1), this.a.jdField_a_of_type_JavaLangString)) {}
    Object localObject;
    label132:
    label190:
    label320:
    ...
    do
    {
      do
      {
        ...
        case 4: 
          if (paramBoolean)
          {
            ...
            } while ((this.a.jdField_a_of_type_JavaUtilArrayList.contains(localObject)) || (localObject == null) || ("".equals(((String)localObject).trim())) || (bftf.a(this.a.d, localObject)));
          ...
          paramList = (anca)this.a.app.getBusinessHandler(20);
      ...
      paramList.putExtra("leftViewText", this.a.getString(2131716232));
      ...
      if (paramBoolean)
      {
        ...
        this.a.jdField_a_of_type_Bhhw.b(2, 2131719124, 1500);
        return;
      }
      paramList = this.a;
      paramList.jdField_b_of_type_Int &= 0xFFFFFFFD;
      ...
      this.a.jdField_a_of_type_Bhhw.b(2, 2131719119, 1500);
      return;
    } while (!paramBoolean);
    label418:
    if (paramList == null)
    ...
    for (paramString = null;; paramString = paramString.b(this.a.jdField_a_of_type_JavaLangString))
    {
      ...
      this.a.a(this.a.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo, false);
      this.a.jdField_a_of_type_Aelc.b(paramList);
      return;
      paramInt1 = paramList.size();
      break;
    }
  ...
  protected void onTroopManagerFailed(int paramInt1, int paramInt2)
  {
    if (paramInt1 == 9)
    {
      ...
      if (paramInt2 == 8)
      {
        ...
        localObject = bfur.a(this.a, 230);
        ((QQCustomDialog)localObject).setTitle(this.a.getString(2131695613));
        ((QQCustomDialog)localObject).setMessage(this.a.getString(2131695614));
        ((QQCustomDialog)localObject).setNegativeButton(this.a.getString(2131695645), new aekz(this, (QQCustomDialog)localObject));
        ((QQCustomDialog)localObject).setPositiveButton(this.a.getString(2131718436), new aela(this, (QQCustomDialog)localObject));
  ...
  {
    if (!bftf.a(paramString, this.a.jdField_a_of_type_JavaLangString)) {}
    while (paramInt1 != 9) {
      return;
    }
    paramString = this.a;
    ...
    if (paramInt2 == 0)
    {
      ...
      paramString.putExtra("fin_tip_msg", this.a.getString(2131691948));
