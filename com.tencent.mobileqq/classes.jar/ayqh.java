...
class ayqh
{
  ...
  {
    if (!ayqf.a(this.jdField_a_of_type_Ayqf).a()) {}
    for (int i = 2;; i = 5)
    {
      if (paramArrayOfInt != null)
      {
  ...
  FileStorageServerListInfo a()
  {
    ...
    ArrayList localArrayList = ayqf.c(this.jdField_a_of_type_Ayqf, 16);
    ...
    if (localArrayList != null)
    {
      ...
      if (localArrayList.size() > 0)
      {
        int i = b(ayqf.a(this.jdField_a_of_type_Ayqf).a(ayqf.a(this.jdField_a_of_type_Ayqf).b()));
        localObject1 = localObject2;
        if (i > -1)
        {
          localObject1 = localObject2;
  ...
  {
    Object localObject2 = null;
    ArrayList localArrayList = ayqf.c(this.jdField_a_of_type_Ayqf, paramInt);
    Object localObject1 = localObject2;
    if (localArrayList != null)
    {
      localObject1 = localObject2;
  ...
  void a(FileStoragePushFSSvcList paramFileStoragePushFSSvcList)
  {
    ...
    if (paramFileStoragePushFSSvcList != null)
    {
      ...
      if (i <= 10)
      {
        paramFileStoragePushFSSvcList = ayqf.a(this.jdField_a_of_type_Ayqf, ayqf.a(this.jdField_a_of_type_Ayqf, i));
        if (paramFileStoragePushFSSvcList != null) {}
      ...
      if (i <= 15)
      {
        paramFileStoragePushFSSvcList = ayqf.b(this.jdField_a_of_type_Ayqf, ayqf.b(this.jdField_a_of_type_Ayqf, i));
        if (paramFileStoragePushFSSvcList != null) {}
        for (j = paramFileStoragePushFSSvcList.size();; j = 0)
        {
          this.jdField_a_of_type_Array2dOfInt[i] = new int[j];
      ...
      paramFileStoragePushFSSvcList = ayqf.b(this.jdField_a_of_type_Ayqf, ayqf.b(this.jdField_a_of_type_Ayqf, 17));
      i = k;
      if (paramFileStoragePushFSSvcList != null) {
    ...
    ayqf.a(this.jdField_a_of_type_Ayqf).a();
  }
