  ...
  implements alia
{
  ...
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)alib.a(this.a).get();
    ...
    synchronized (alib.a(this.a))
    {
      if ((Bundle)alib.a(this.a).get(Long.valueOf(l)) != null)
      {
        alib.a(this.a).remove(Long.valueOf(l));
        alib.a(this.a).removeMessages(1, localObject1);
    ...
    for (??? = "1";; ??? = "2")
    {
      ...
      awrn.a(BaseApplicationImpl.getApplication()).a(null, "actAsyncShareCallback", true, 0L, 0L, (HashMap)localObject2, null);
      if (!paramBoolean) {
        break;
      }
    ...
    alib.a(this.a, localQQAppInterface, (MessageForArkApp)localObject1);
  }
}
