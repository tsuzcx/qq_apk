...
public class bahq
{
  ...
  public static ArrayList<bahr> a(long paramLong, DataInputStream paramDataInputStream, int paramInt1, int paramInt2)
  {
                ...
                if (!TextUtils.isEmpty(localObject4))
                {
                  ...
                  if (l != -1L)
                  {
                    ...
                    if (localObject1 == null) {
                      localObject3 = new bahr();
                    }
                    ((bahr)localObject3).jdField_a_of_type_Long = paramLong;
                    ((bahr)localObject3).jdField_a_of_type_Int = paramInt2;
                    ((bahr)localObject3).b = l;
                    ((bahr)localObject3).jdField_a_of_type_JavaLangString = localObject4;
  ...
  public static ArrayList<bahr> a(long paramLong, byte[] paramArrayOfByte, int paramInt)
  {
    ...
    while (i < paramInt)
    {
      ...
      while (j < k)
      {
        bahr localbahr = (bahr)localArrayList2.get(j);
        if (!localHashMap.containsKey(Long.valueOf(localbahr.b)))
        {
          localArrayList1.add(localbahr);
          localHashMap.put(Long.valueOf(localbahr.b), Boolean.valueOf(true));
        }
        j += 1;
      }
      i += 1;
