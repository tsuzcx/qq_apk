  ...
  implements Handler.Callback
{
  ...
  private static final int[] jdField_b_of_type_ArrayOfInt = { 1, 8, 14 };
  public static int c;
  ...
  static
  {
    jdField_c_of_type_ArrayOfInt = new int[] { 5, 6 };
    jdField_d_of_type_ArrayOfInt = new int[] { 10, 11, 16, 17 };
    jdField_e_of_type_ArrayOfInt = new int[] { 12, 10, 11, 16 };
    jdField_f_of_type_ArrayOfInt = new int[] { 6, 18 };
    jdField_g_of_type_ArrayOfInt = new int[] { 12, 10, 16 };
    jdField_h_of_type_ArrayOfInt = jdField_f_of_type_ArrayOfInt;
    jdField_i_of_type_ArrayOfInt = new int[] { 31, 5, 9 };
    jdField_j_of_type_ArrayOfInt = new int[] { 13, 5, 10, 9 };
    jdField_a_of_type_ArrayOfInt = new int[] { 13, 5, 10, 9 };
    jdField_k_of_type_ArrayOfInt = new int[] { 13 };
    l = new int[] { 5, 9, 7, 19 };
    m = new int[] { 12, 5 };
    n = new int[] { 12, 5, 13, 11, 9 };
    o = new int[] { 12, 5, 13, 11, 20 };
    p = new int[] { 12, 5, 13, 11 };
    q = new int[] { 29, 32 };
    r = new int[] { 5, 13, 7, 11, 9 };
  ...
  private final int a(android.content.Context paramContext)
  {
    ...
    //   12: iconst_0
    //   13: istore_2
    //   14: new 98	java/io/File
    //   17: dup
    //   18: aload_1
    //   19: invokevirtual 104	android/content/Context:getFilesDir	()Ljava/io/File;
    //   22: ldc 106
    ...
    //   31: istore_3
    //   32: aload 9
    //   34: invokevirtual 113	java/io/File:exists	()Z
    //   37: ifeq +49 -> 86
    //   40: new 115	java/io/BufferedInputStream
    //   43: dup
    //   44: new 117	java/io/FileInputStream
    //   47: dup
    //   48: aload 9
    //   50: invokespecial 120	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   53: invokespecial 123	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   56: astore 5
    //   58: aload 5
    //   60: astore_1
    //   61: aload 5
    //   63: invokevirtual 127	java/io/BufferedInputStream:read	()I
    //   66: istore_3
    //   67: iload_3
    //   68: iconst_m1
    ...
    //   76: ifnull +10 -> 86
    //   79: aload 5
    //   81: invokevirtual 130	java/io/BufferedInputStream:close	()V
    //   84: iload_2
    //   85: istore_3
    //   86: iload_3
    //   87: iconst_1
    ...
    //   90: aload 8
    //   92: astore_1
    //   93: new 132	java/io/FileOutputStream
    //   96: dup
    //   97: aload 9
    //   99: invokespecial 133	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   102: astore 5
    //   104: aload 5
    //   106: iload_2
    //   107: invokevirtual 137	java/io/FileOutputStream:write	(I)V
    //   110: aload 5
    //   112: ifnull +8 -> 120
    //   115: aload 5
    //   117: invokevirtual 138	java/io/FileOutputStream:close	()V
    //   120: iload_2
    //   121: ireturn
    //   122: astore_1
    //   123: aload_1
    ...
    //   139: astore_1
    //   140: aload 6
    //   142: invokevirtual 142	java/lang/Exception:printStackTrace	()V
    //   145: iload 4
    //   147: istore_3
    //   148: aload 5
    //   150: ifnull -64 -> 86
    //   153: aload 5
    //   155: invokevirtual 130	java/io/BufferedInputStream:close	()V
    //   158: iload 4
    //   160: istore_3
    //   161: goto -75 -> 86
    //   164: astore_1
    //   165: aload_1
    //   166: invokevirtual 141	java/io/IOException:printStackTrace	()V
    //   169: iload 4
    //   171: istore_3
    //   172: goto -86 -> 86
    //   175: astore_1
    ...
    //   182: ifnull +8 -> 190
    //   185: aload 5
    //   187: invokevirtual 130	java/io/BufferedInputStream:close	()V
    //   190: aload_1
    //   191: athrow
    //   192: astore 5
    //   194: aload 5
    //   196: invokevirtual 141	java/io/IOException:printStackTrace	()V
    //   199: goto -9 -> 190
    //   202: astore_1
    //   203: aload_1
    //   204: invokevirtual 141	java/io/IOException:printStackTrace	()V
    //   207: iload_2
    //   208: ireturn
    //   209: astore 6
    //   211: aload 7
    ...
    //   217: astore_1
    //   218: aload 6
    //   220: invokevirtual 141	java/io/IOException:printStackTrace	()V
    //   223: aload 5
    //   225: ifnull -105 -> 120
    //   228: aload 5
    //   230: invokevirtual 138	java/io/FileOutputStream:close	()V
    //   233: iload_2
    //   234: ireturn
    //   235: astore_1
    //   236: aload_1
    //   237: invokevirtual 141	java/io/IOException:printStackTrace	()V
    //   240: iload_2
    //   241: ireturn
    //   242: astore 6
    //   244: aload_1
    ...
    //   252: ifnull +8 -> 260
    //   255: aload 5
    //   257: invokevirtual 138	java/io/FileOutputStream:close	()V
    //   260: aload_1
    //   261: athrow
    //   262: astore 5
    //   264: aload 5
    //   266: invokevirtual 141	java/io/IOException:printStackTrace	()V
    //   269: goto -9 -> 260
    //   272: astore_1
    //   273: goto -23 -> 250
    //   276: astore 6
  ...
  public static axnv a()
  {
    if (QLog.isColorLevel()) {
      QLog.i("AutoMonitor", 2, "onApplicationCreate ");
    }
    axnv localaxnv = new axnv();
    localaxnv.a(0);
    axpj.b(0, localaxnv, jdField_b_of_type_ArrayOfInt).step();
    ...
    jdField_a_of_type_Boolean = false;
    axpj.b(12, localaxnv, null).step();
    if (BaseApplicationImpl.sProcessId == 2)
    {
      axpj.b(10, localaxnv, null).step();
      axpj.b(39, localaxnv, null).step();
      ThreadManager.post(axpj.b(0, localaxnv, l), 10, null, false);
      axpj.b(0, localaxnv, jdField_k_of_type_ArrayOfInt).step();
    }
    label384:
    for (;;)
    {
      ...
      {
        axpj.b(0, localaxnv, r).step();
      }
      else if ((BaseApplicationImpl.sProcessId == 5) || (BaseApplicationImpl.sProcessId == 7))
      {
        axpj.b(10, localaxnv, null).step();
        axpj.b(7, localaxnv, null).step();
        axpj.b(0, localaxnv, jdField_i_of_type_ArrayOfInt).step();
        axpj.b(11, localaxnv, null).step();
        axpj.b(46, localaxnv, null).step();
      }
      ...
      else if (!BaseApplicationImpl.processName.endsWith(":qqfav"))
      {
        ...
        {
          ThreadManager.excute(axpj.b(0, localaxnv, jdField_a_of_type_ArrayOfInt), 16, null, false);
        }
        else
        {
          ...
          for (;;)
          {
            ...
            axpj.b(37, localaxnv, null).step();
            break;
            axpj.b(0, localaxnv, jdField_j_of_type_ArrayOfInt).step();
          }
        }
      }
    }
  ...
  {
    int i2 = 0;
    if ((!jdField_i_of_type_Boolean) && (BaseApplicationImpl.sProcessId == 1)) {}
    for (;;)
    {
      try
      {
        ...
        if ((jdField_d_of_type_Boolean) || (jdField_c_of_type_Boolean) || (jdField_e_of_type_Boolean) || (jdField_f_of_type_Boolean)) {
          break label536;
        }
      ...
      if ((i1 != 0) && (bool))
      {
        ...
        if (!str1.isEmpty())
        {
          ...
          if (arrayOfString.length > 0)
          {
            ...
            if (i1 < i3)
            {
              ...
              aklc.jdField_a_of_type_JavaUtilSet.add(Integer.valueOf(Integer.parseInt(str2)));
              i1 += 1;
              continue;
            }
          }
        ...
        if (jdField_h_of_type_Boolean) {
          jdField_c_of_type_Int |= 0x10;
        }
        jdField_i_of_type_Boolean = true;
        QLog.d("Perf", 1, "sDisablePreloadProcess:" + jdField_d_of_type_Boolean + ",sDisableGetTroopList:" + jdField_c_of_type_Boolean + ",sDisablePreDownload:" + jdField_e_of_type_Boolean + ",sEnableAutoMatorPerf:" + jdField_f_of_type_Boolean + ",sEnableCpuTimePrint:" + jdField_g_of_type_Boolean + ",extra_imp_steps:" + str1 + ",sPerfConfigReportValue:" + jdField_c_of_type_Int + ",predownload_white_list:" + (String)localObject + ",sEnableThreadSuspend:" + jdField_h_of_type_Boolean);
        return;
      }
      return;
      label536:
  ...
  private void a(int paramInt)
  {
    ...
    if (jdField_a_of_type_Boolean)
    {
      ...
      Log.i("AutoMonitor", "STATE_" + this.jdField_e_of_type_Int + ", cost=" + (l1 - jdField_j_of_type_Long) + " then " + paramInt);
    }
    for (;;)
    {
      if (paramInt != 1000)
  ...
  private void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ThreadManager.getSubThreadHandler().postAtFrontOfQueue(axpj.b(9, this, null));
      if (jdField_a_of_type_Int == 1) {
        ThreadManager.getSubThreadHandler().post(axpj.b(21, this, null));
      }
    }
    ...
    if (paramBoolean)
    {
      ...
      if ((BaseApplicationImpl.sShowTime <= 0L) || (!bbev.g(BaseApplicationImpl.sApplication))) {
        break label314;
      }
    }
    label314:
  ...
  private void a(int[] paramArrayOfInt1, int[] paramArrayOfInt2, int paramInt)
  {
    ...
    paramArrayOfInt1 = axpj.b(0, this, paramArrayOfInt1);
    if (paramArrayOfInt2 != null)
    {
      this.jdField_f_of_type_Int = 2;
      this.jdField_g_of_type_Int = paramInt;
      paramArrayOfInt1.setResultListener(this.jdField_b_of_type_AndroidOsHandler, 10);
      paramArrayOfInt2 = axpj.b(0, this, paramArrayOfInt2);
  ...
  private void b(AppActivity paramAppActivity, boolean paramBoolean)
  {
    ...
    if (!paramBoolean) {
      localTextView.setText(2131693581);
    }
    for (;;)
    {
      ...
      return;
      localTextView.setText(ajyc.a(2131714347));
    }
  }
  ...
  public void a(AppActivity paramAppActivity, boolean paramBoolean)
  {
    ...
    if (Build.VERSION.SDK_INT >= 23)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqStartupStepCheckPermission == null) {
        this.jdField_a_of_type_ComTencentMobileqqStartupStepCheckPermission = ((CheckPermission)axpj.b(3, this, null));
      }
    ...
    if (this.jdField_e_of_type_Int == 2)
    {
      if (1 == BaseApplicationImpl.sProcessId) {
        ThreadManager.getFileThreadHandler().postDelayed(axpj.b(13, this, null), 1000L);
      }
      a(11, 1, 5L);
      a(3);
    }
    ...
    for (paramObject = (AppActivity)paramObject;; paramObject = null)
    {
      ...
      if (paramObject == null)
      {
        ...
        if (this.jdField_e_of_type_Int == 1)
        {
          ...
          {
            paramObject = o;
            axpj.b(0, this, paramObject).step();
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          paramIntent = (SetSplash)axpj.b(2, this, null);
          paramIntent.step();
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      for (;;)
      {
        return true;
        a(4, 0, 300L);
        bool1 = axpj.b(12, this, null).step();
        ...
        if (this.jdField_a_of_type_MqqAppAppActivity != null)
        {
          ...
          if (this.jdField_a_of_type_MqqAppAppActivity != null)
          {
            bbjp.a(this.jdField_a_of_type_MqqAppAppActivity, "com.tencent.mobileqq.activity.MainActivity");
            bbjp.a(this.jdField_a_of_type_MqqAppAppActivity, SplashActivity.class.getName());
            return true;
            ...
            if (paramMessage.arg1 == 0)
            {
              if (this.jdField_a_of_type_Long > 0L) {
                this.jdField_h_of_type_Long = (this.jdField_i_of_type_Long + this.jdField_a_of_type_Long - SystemClock.uptimeMillis());
              }
              if (BaseApplicationImpl.isCurrentVersionFirstLaunch)
              {
                System.gc();
                this.jdField_h_of_type_Long = 2000L;
              }
              if ((this.jdField_h_of_type_Long > 0L) && (this.jdField_h_of_type_Long < 6000L))
              {
                if (this.jdField_a_of_type_Axnw != null)
                {
                  a(6, 2, this.jdField_h_of_type_Long);
                  return true;
                }
                a(6, 1, this.jdField_h_of_type_Long);
                return true;
              }
              c();
              return true;
            ...
            this.jdField_a_of_type_Axnw.a(this);
            if (this.jdField_a_of_type_Long > 0L) {
              this.jdField_h_of_type_Long = this.jdField_a_of_type_Long;
            }
            QLog.i("SplashAD", 1, "mDelay" + this.jdField_h_of_type_Long);
            if ((this.jdField_h_of_type_Long > 0L) && (this.jdField_h_of_type_Long < 11000L))
            {
              a(15, 1, this.jdField_h_of_type_Long);
              return true;
            }
            c();
            return true;
            axpj.b(13, this, null).step();
      ...
      axpj.b(28, this, null).step();
      return true;
    } while (this.jdField_a_of_type_Axnw.jdField_a_of_type_Boolean);
    this.jdField_a_of_type_Axnw.a();
