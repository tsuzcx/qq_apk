...
public class bhai
{
  ...
  public static SpannableString a(Resources paramResources, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (!bhru.a(((AppInterface)localObject).getApp(), paramInt1)) {
      bhru.a((QQAppInterface)localObject, paramInt1, null, false);
    }
    boolean bool = ThemeUtil.isNowThemeIsNight(null, false, null);
    if (paramInt2 == 0)
    {
      localObject = new SpannableString("*");
      paramInt2 = (int)paramResources.getDimension(2131298435);
      paramResources = paramResources.getDrawable(2130845841);
      paramResources = VasApngUtil.getOptimizedApngDrawable(bhaa.a(paramInt1, bhaa.a), paramResources, VasApngUtil.VIP_APNG_TAGS, "halfStar");
    ...
    for (;;)
    {
      ...
      paramInt3 = (int)paramResources.getDimension(2131298435);
      paramInt2 = 0;
      if (paramInt2 < str1.length())
      {
        ...
        if ("!".equalsIgnoreCase(str2))
        {
          ...
          localObject = VasApngUtil.getOptimizedApngDrawable(bhaa.a(paramInt1, bhaa.e), (Drawable)localObject, VasApngUtil.VIP_APNG_TAGS, "crown");
          label452:
          if (localObject != null)
          {
            if (!"&".equalsIgnoreCase(str2)) {
        ...
        for (;;)
        {
          ...
          if ("@".equalsIgnoreCase(str2))
          {
            localObject = paramResources.getDrawable(2130845843);
            localObject = VasApngUtil.getOptimizedApngDrawable(bhaa.a(paramInt1, bhaa.d), (Drawable)localObject, VasApngUtil.VIP_APNG_TAGS, "sun");
            break label452;
          }
          if ("#".equalsIgnoreCase(str2))
          {
            localObject = paramResources.getDrawable(2130845840);
            localObject = VasApngUtil.getOptimizedApngDrawable(bhaa.a(paramInt1, bhaa.c), (Drawable)localObject, VasApngUtil.VIP_APNG_TAGS, "moon");
            break label452;
          }
          if ("%".equalsIgnoreCase(str2))
          {
            localObject = paramResources.getDrawable(2130845842);
            localObject = VasApngUtil.getOptimizedApngDrawable(bhaa.a(paramInt1, bhaa.b), (Drawable)localObject, VasApngUtil.VIP_APNG_TAGS, "star");
            break label452;
          }
          if ("$".equalsIgnoreCase(str2))
          {
            localObject = paramResources.getDrawable(2130850827);
            break label452;
          }
          localObject = null;
          break label452;
  ...
  public static SpannableString a(View paramView, Resources paramResources, long paramLong, int paramInt, boolean paramBoolean)
  {
    ...
    for (localObject = bhpw.a().a(((QQAppInterface)localObject).getCurrentUin(), paramLong, paramInt, paramBoolean);; localObject = "")
    {
      ...
      for (;;)
      {
        if (localObject != null)
        {
          ((URLDrawable)localObject).setURLDrawableListener(new bhaj(paramView));
          localSpannableString.setSpan(new ImageSpan((Drawable)localObject), 0, 1, 33);
          paramView = paramResources.getDrawable(2130845864);
          paramView.setBounds(0, 0, (int)paramResources.getDimension(2131297225), UIUtils.dip2px(BaseApplicationImpl.getContext(), 5.0F));
  ...
  public static SpannableString a(View paramView, Resources paramResources, boolean paramBoolean1, boolean paramBoolean2, int paramInt)
  {
    ...
    paramView = null;
    int i = (int)paramResources.getDimension(2131297254);
    ...
    if ((paramBoolean1) && (paramInt > 0))
    {
      ...
      localDrawable = paramResources.getDrawable(2130847074);
    ...
    for (;;)
    {
      ...
      {
        paramView.mutate();
        ((URLDrawable)paramView).setURLDrawableListener(new bhak(localWeakReference));
        localSpannableString.setSpan(new ImageSpan(paramView), 0, 1, 33);
        paramView = paramResources.getDrawable(2130845864);
        paramView.setBounds(0, 0, (int)paramResources.getDimension(2131297225), i);
        localSpannableString.setSpan(new ImageSpan(paramView), 1, 2, 33);
      }
      if (QLog.isDevelopLevel()) {
      ...
      if ((paramBoolean2) && (paramInt > 0))
      {
        ...
        localDrawable = paramResources.getDrawable(2130847075);
        paramView = URLDrawable.getDrawable(paramView, localDrawable, localDrawable);
  ...
  public static void b(QQAppInterface paramQQAppInterface)
  {
    ...
    boolean bool = SettingCloneUtil.readValue((Context)localObject2, null, ((Context)localObject2).getString(2131694758), "qqsetting_auto_receive_pic_key", true);
    int i;
    Object localObject3;
    if (bool)
    {
      ...
      localObject3 = (bbvn)paramQQAppInterface.getManager(QQManagerFactory.STATUS_MANAGER);
      if (localObject3 != null)
      {
        bool = ((bbvn)localObject3).b();
        if (!bool) {
          break label1201;
        }
        i = 1;
        ...
        if (!ansg.a(paramQQAppInterface, false)) {
          break label1206;
        }
        i = 1;
        label109:
        ((Map)localObject1).put("Download_new", Integer.valueOf(i));
        if (!SettingCloneUtil.readValue((Context)localObject2, null, ((Context)localObject2).getString(2131718598), "qqsetting_notify_icon_key", false)) {
          break label1211;
        }
        i = 1;
        label147:
        ((Map)localObject1).put("System_icon", Integer.valueOf(i));
        if (!SettingCloneUtil.readValue((Context)localObject2, null, paramQQAppInterface.getApp().getString(2131694743), "qqsetting_enter_sendmsg_key", false)) {
          break label1216;
        }
        i = 1;
        label187:
        ...
        if (!axqc.b(paramQQAppInterface.getAccount())) {
          break label1241;
        }
        i = 1;
        label323:
    ...
    for (;;)
    {
      try
      {
        ...
        if (((Iterator)localObject2).hasNext())
        {
          ...
          bdla.b(paramQQAppInterface, "CliStatus", "", "", "Setting_tab", (String)localObject3, 0, 0, String.valueOf(((Map)localObject1).get(localObject3)), "", "", "");
          continue;
        }
        if (!SettingCloneUtil.readValue(paramQQAppInterface.getApp(), null, paramQQAppInterface.getApp().getString(2131694747), "qqsetting_screenshot_key", false)) {
          break label1296;
        }
        i = 1;
        bdla.b(paramQQAppInterface, "CliStatus", "", "", "Setting_tab", "Shake_screenshot_switch", 0, 0, String.valueOf(i), "", "", "");
        if (!paramQQAppInterface.getVisibilityForNetWorkStatus(false)) {
          break label1301;
        }
        i = 1;
        bdla.b(paramQQAppInterface, "CliStatus", "", "", "0X80044D1", "0X80044D1", 0, 0, String.valueOf(i), "", "", "");
        localObject1 = ((anvk)paramQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER)).b(paramQQAppInterface.getCurrentAccountUin());
        if (localObject1 != null)
        {
          ...
          i = 1;
          bdla.b(paramQQAppInterface, "CliStatus", "", "", "0X8004884", "0X8004884", 0, 0, String.valueOf(i), "", "", "");
        }
        if (!HotChatManager.b(paramQQAppInterface)) {
          break label1311;
        }
        i = 1;
        bdla.b(paramQQAppInterface, "CliStatus", "", "", "0X8004B1E", "0X8004B1E", 0, 0, String.valueOf(i), "", "", "");
        if (!paramQQAppInterface.getNotAllowedSeeMyDongtai(false)) {
          break label1316;
        }
        i = 1;
        bdla.b(paramQQAppInterface, "CliStatus", "", "", "0X8004C5C", "0X8004C5C", 0, 0, String.valueOf(i), "", "", "");
        if (!paramQQAppInterface.getShieldHisDongtai(false)) {
          break label1321;
        }
        i = 1;
        bdla.b(paramQQAppInterface, "CliStatus", "", "", "0X8004C5D", "0X8004C5D", 0, 0, String.valueOf(i), "", "", "");
        localObject3 = (anvk)paramQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER);
        i = ((anvk)localObject3).c();
        if (i <= 0) {
          break label1326;
        }
        localObject1 = "1";
        if (i > 0)
        {
          ...
          bdla.b(paramQQAppInterface, "CliStatus", "", "", "0X8004C69", "0X8004C69", 0, 0, (String)localObject1, (String)localObject2, String.valueOf(((anvk)localObject3).b()), "");
          if (((aohe)paramQQAppInterface.getManager(QQManagerFactory.MGR_ACTVATE_FRIENDS)).a(false))
          {
            i = 1;
            bdla.b(paramQQAppInterface, "CliStatus", "", "", "0X8004E0C", "0X8004E0C", 0, i, String.valueOf(i), "", "", "");
            if (!paramQQAppInterface.isCallTabShow) {
              continue;
            }
            i = 1;
            bdla.b(paramQQAppInterface, "CliStatus", "", "", "0X8004EDE", "0X8004EDE", 0, 0, String.valueOf(i), "", "", "");
            localObject1 = ((ajmy)paramQQAppInterface.getManager(QQManagerFactory.CTENTRY_MNG)).a();
            ...
            localObject2 = (ajmt)((Iterator)localObject1).next();
            int j = ((ajmt)localObject2).a;
            if (!((ajmt)localObject2).e) {
              continue;
            }
            i = 2;
            bdla.b(paramQQAppInterface, "CliStatus", "", "", "0X80097A1", "0X80097A1", j, 0, String.valueOf(i), "", "", "");
            continue;
          }
        }
        else
