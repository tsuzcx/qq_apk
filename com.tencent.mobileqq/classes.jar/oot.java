  ...
  implements AladdinConfigHandler
{
  ...
  static
  {
    if (((Integer)bhvh.a("readinjoy_channel_mode", Integer.valueOf(-1))).intValue() == 2) {}
  ...
  public boolean onReceiveConfig(int paramInt1, int paramInt2, String paramString)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (TextUtils.equals(str1, "channel_mode")) {
        bhvh.a("readinjoy_channel_mode", Integer.valueOf(Integer.valueOf(str2).intValue()));
      }
    }
    return true;
  }
  ...
  public void onWipeConfig(int paramInt)
  {
    ...
    bhvh.a("readinjoy_channel_mode", Integer.valueOf(-1));
  }
}
