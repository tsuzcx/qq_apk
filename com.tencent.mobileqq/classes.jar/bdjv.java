...
public class bdjv
{
  ...
  {
    bdii.c("AppUpdate", "httpRequest >>> " + paramString1.toString());
    try
    {
    ...
    catch (JSONException paramContext)
    {
      ...
      for (;;)
      {
        bdii.c("AppUpdate", "httpRequest JSONException", paramContext);
        return;
        i = 0;
        continue;
        paramString1 = "0";
      ...
      bdii.c("AppUpdate", "use supportEtag");
      if (paramBoolean) {
        break label548;
      }
      ...
      bdii.c("AppUpdate", "execute asyncTask url >>> " + str2 + " methodName " + str3);
      a(new bdjd(str2, str3, new bdjw(paramContext, paramWebView, str1, str4, str5, paramBoolean)), localBundle);
      return;
    }
    catch (Exception paramContext)
    {
      bdii.c("AppUpdate", "httpRequest Exception", paramContext);
    }
    localBundle = new Bundle();
    localBundle.putString("platform", bcyb.a().g());
    localBundle.putString("keystr", bcyb.a().a());
    localBundle.putString("uin", paramString2);
    localBundle.putString("resolution", bdjp.e());
    localBundle.putString("keytype", "256");
    if (bdjl.a(paramContext))
    {
      paramString1 = "1";
      ...
      while (paramString2.hasNext())
      {
        ...
        bdii.c("AppUpdate", "key = " + (String)localObject1 + " value = " + localObject2.toString());
  ...
  @TargetApi(11)
  protected static void a(bdjd parambdjd, Bundle paramBundle)
  {
