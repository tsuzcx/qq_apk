  ...
  extends WebViewClient
{
  ...
  public void onDetectedBlankScreen(String paramString, int paramInt)
  {
    ...
    if (this.b.jdField_a_of_type_Bhnj != null) {
      this.b.jdField_a_of_type_Bhnj.onDetectedBlankScreen(paramString, paramInt);
    }
  }
  ...
  public void onPageFinished(WebView paramWebView, String paramString)
  {
    ...
    if (this.b.jdField_a_of_type_Bhnj != null) {
      this.b.jdField_a_of_type_Bhnj.onPageFinished(paramWebView, paramString);
    }
    paramWebView = ((CustomWebView)paramWebView).getPluginEngine();
    if (paramWebView != null) {
      paramWebView.a(paramString, 8589934594L, null);
    }
    afuh.b(this.b.jdField_a_of_type_AndroidContentIntent);
  }
  ...
  public void onPageStarted(WebView paramWebView, String paramString, Bitmap paramBitmap)
  {
    ...
    do
    {
      ...
      if (this.b.jdField_a_of_type_Bhnj != null)
      {
        this.b.jdField_a_of_type_Bhnj.onPageStarted(paramWebView, paramString, paramBitmap);
        this.b.jdField_a_of_type_Bhnj.onWebViewClientImplPageStarted(paramWebView, paramString, paramBitmap);
      }
      paramWebView = ((CustomWebView)paramWebView).getPluginEngine();
  ...
  public void onReceivedError(WebView paramWebView, int paramInt, String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      if (this.b.jdField_a_of_type_Bhnj != null) {
        this.b.jdField_a_of_type_Bhnj.onReceivedError(paramWebView, paramInt, paramString1, paramString2);
      }
      paramWebView = ((CustomWebView)paramWebView).getPluginEngine();
    } while (paramWebView == null);
  ...
  public void onReceivedSslError(WebView paramWebView, SslErrorHandler paramSslErrorHandler, SslError paramSslError)
  {
    ...
    {
      QLog.e("WebLog_WebViewWrapper", 1, (String)localObject + ", pageUrl=" + nmj.b(str, new String[0]));
      if (this.b.jdField_a_of_type_Bhnj != null) {
        this.b.jdField_a_of_type_Bhnj.onReceivedSslError(paramWebView, paramSslError);
      }
  ...
  public boolean shouldOverrideUrlLoading(WebView paramWebView, String paramString)
  {
    ...
    if ((paramString.startsWith("mqqapi:")) && (paramString.contains("getTcntDocData")) && (((arbg)localObject).a()))
    {
      paramWebView = Uri.parse(paramString).getQueryParameter("id");
      bdjn.a(paramWebView, this.b.jdField_a_of_type_ComTencentBizUiTouchWebView);
      if ((this.b.jdField_a_of_type_Bhnj instanceof TeamWorkDocEditBrowserActivity.TeamWorkDocEditBrowserFragment)) {
        bdjn.a(paramWebView, this.b.jdField_a_of_type_ComTencentBizUiTouchWebView);
      }
      for (;;)
      {
    ...
    for (;;)
    {
      afuh.b(this.b.jdField_a_of_type_AndroidContentIntent, (String)localObject);
      paramString = bhre.b((String)localObject);
      if ((this.b.jdField_a_of_type_Bhnj == null) || (!this.b.jdField_a_of_type_Bhnj.beforeWebViewEngineHandleOverrideUrl(this.b.jdField_a_of_type_ComTencentBizUiTouchWebView, (String)localObject))) {
        break label398;
      }
      ...
      break;
      label361:
      QLog.d("WebLog_WebViewWrapper", 2, "shouldOverrideUrlLoading:" + nmj.b((String)localObject, new String[0]));
    }
    label398:
    if ((("http".equals(paramString)) || ("data".equals(paramString))) && (!((String)localObject).contains("/cgi-bin/httpconn?htcmd=0x6ff0080"))) {
      CustomWebView.addContextLog(nmj.b((String)localObject, new String[0]));
    }
    try
    {
      ...
      if ((this.b.jdField_a_of_type_Bhnj != null) && (this.b.jdField_a_of_type_Bhnj.shouldOverrideUrlLoading(paramWebView, (String)localObject))) {
        return true;
      }
      ...
      else if (this.b.jdField_a_of_type_Bhnj != null)
      {
        boolean bool = this.b.jdField_a_of_type_Bhnj.afterWebViewEngineHandleOverrideUrl(this.b.jdField_a_of_type_ComTencentBizUiTouchWebView, (String)localObject);
        if (bool) {
          return true;
        }
      }
