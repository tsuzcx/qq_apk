  ...
  implements View.OnClickListener
{
  ...
  {
    oay localoay = (oay)paramView.getTag();
    Object localObject = (anrs)this.a.a.a.getManager(56);
    if ((localObject != null) && (((anrs)localObject).c(localoay.jdField_a_of_type_JavaLangString) != null)) {}
    for (boolean bool = true;; bool = false)
    {
      if (bool)
      {
        localObject = new Intent(this.a.a.a(), ChatActivity.class);
        if (localoay.jdField_a_of_type_Boolean)
        {
          ((Intent)localObject).putExtra("uintype", 1008);
          ((Intent)localObject).putExtra("uin", localoay.jdField_a_of_type_JavaLangString);
          ((Intent)localObject).putExtra("uinname", localoay.b);
      ...
      {
        oat.a(this.a.a.a, localoay.jdField_a_of_type_JavaLangString, "0X8007404", "0X8007404", 0, 0, "", "", (String)localObject, "");
        if (QLog.isColorLevel())
        {
          ...
          localStringBuilder.append(", puin:").append(localoay.jdField_a_of_type_JavaLangString);
        ...
        for (;;)
        {
          ...
          this.a.a.a().startActivity((Intent)localObject);
          break;
          localObject = nmp.a(this.a.a.a(), null, "", false, -1, false, -1);
        }
      }
    }
  }
