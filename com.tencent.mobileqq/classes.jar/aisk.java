  ...
  implements aisi
{
  ...
  private aisk(airx paramairx)
  {
    b();
    SharedPreferences localSharedPreferences = paramairx.a.getApp().getSharedPreferences("apollo_sp" + paramairx.a.c(), 0);
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.content = ajya.a(2131700465);
    this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.show_counts = 1;
    this.jdField_a_of_type_Airx.c(this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem);
    a(true);
  }
  ...
  private void a(JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        if (!aisj.jdField_a_of_type_Boolean)
        {
          QLog.d("ApolloManager", 1, new Object[] { "parseGuide3DBubble", " mIs3dAvailable:", Boolean.valueOf(this.b), " mApolloStatus: " + this.jdField_a_of_type_Int + ", show: " + aisj.jdField_a_of_type_Boolean });
          return;
        }
        try
        {
          i = (int)(paramJSONObject.optLong("startTime") / 1000L);
          localSharedPreferences = this.jdField_a_of_type_Airx.a.getApp().getSharedPreferences("apollo_sp" + this.jdField_a_of_type_Airx.a.c(), 0);
      ...
      this.jdField_a_of_type_Airx.c(localDrawerPushItem);
      localSharedPreferences.edit().putInt("key_panel_bubble_guide3d_start_time", i).commit();
      b(true);
      if (this.e) {
        ((airt)this.jdField_a_of_type_Airx.a.getManager(211)).a.a(this.jdField_a_of_type_Airx.a);
      }
  ...
  private void b()
  {
    this.b = airx.a(this.jdField_a_of_type_Airx.a);
    this.jdField_a_of_type_Int = airx.a(this.jdField_a_of_type_Airx.a);
  }
  ...
  private void c(boolean paramBoolean)
  {
    ...
    //   2: aload_0
    //   3: iload_1
    //   4: putfield 241	aisk:e	Z
    //   7: iload_1
    //   8: ifeq +10 -> 18
    //   11: aload_0
    //   12: invokespecial 24	aisk:b	()V
    //   15: aload_0
    //   16: monitorexit
    //   17: return
    //   18: aload_0
    //   19: getfield 91	aisk:jdField_a_of_type_ComTencentMobileqqDrawerPushItem	Lcom/tencent/mobileqq/DrawerPushItem;
    //   22: ifnull -7 -> 15
    //   25: aload_0
    //   26: getfield 19	aisk:jdField_a_of_type_Airx	Lairx;
    //   29: aload_0
    //   30: getfield 91	aisk:jdField_a_of_type_ComTencentMobileqqDrawerPushItem	Lcom/tencent/mobileqq/DrawerPushItem;
    //   33: invokevirtual 271	airx:a	(Lcom/tencent/mobileqq/DrawerPushItem;)V
    //   36: aload_0
    //   37: aconst_null
    //   38: putfield 91	aisk:jdField_a_of_type_ComTencentMobileqqDrawerPushItem	Lcom/tencent/mobileqq/DrawerPushItem;
    //   41: goto -26 -> 15
    //   44: astore_2
    //   45: aload_0
    //   46: monitorexit
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      this.c = paramBoolean;
      SharedPreferences.Editor localEditor = this.jdField_a_of_type_Airx.a.getApp().getSharedPreferences("apollo_sp" + this.jdField_a_of_type_Airx.a.c(), 0).edit();
      if (paramBoolean) {
        i = 1;
      }
      ...
      if (aisj.jdField_a_of_type_Boolean)
      {
        ...
        if (!this.jdField_a_of_type_Boolean)
        {
          ...
          if (this.b)
          {
            ...
            {
              bool1 = bool2;
              if (!ajkm.jdField_a_of_type_Boolean)
              {
                bool1 = bool2;
                if (!paramMessageForApollo.isSend())
                {
                  ...
                  if (paramMessageForApollo.is3dAction())
                  {
                    ...
                    this.jdField_a_of_type_Airx.a.getApp().getSharedPreferences("apollo_sp" + this.jdField_a_of_type_Airx.a.c(), 0).edit().putInt("key_panel_meet_3d_action", 1).commit();
                    a();
                    ((airt)this.jdField_a_of_type_Airx.a.getManager(211)).a.a(this.jdField_a_of_type_Airx.a);
  ...
  public boolean b()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 74	aisk:d	Z
    //   6: ifeq +17 -> 23
    //   9: getstatic 274	ajkm:jdField_a_of_type_Boolean	Z
    //   12: istore_1
    //   13: iload_1
    //   14: ifne +9 -> 23
    //   17: iconst_1
