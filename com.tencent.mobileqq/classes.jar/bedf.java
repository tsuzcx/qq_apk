  ...
  implements BluetoothProfile.ServiceListener
{
  ...
  public bedf(TraeAudioManager paramTraeAudioManager)
  {
  ...
  void a(Context paramContext, Intent paramIntent)
  {
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            ...
            do
            {
              ...
              case 0: 
                ...
                this.jdField_a_of_type_Bedj.a("DEVICE_BLUETOOTHHEADSET", false);
              }
            ...
            this.jdField_a_of_type_Bedj.a("DEVICE_BLUETOOTHHEADSET", true);
          } while (!QLog.isColorLevel());
          ...
          else
          {
            ...
            this.jdField_a_of_type_Bedj.a("DEVICE_BLUETOOTHHEADSET", true);
            localObject = this.jdField_a_of_type_Bedj;
            if (paramIntent == null) {
              break label525;
            }
          }
          ...
          {
            ((bedj)localObject).a(paramContext);
            return;
            paramContext = " ";
            break;
            paramContext = "null";
      ...
      if (QLog.isColorLevel()) {
        QLog.w("BluetoohHeadsetCheck", 2, "   EXTRA_SCO_AUDIO_STATE " + b(i) + "  Bluetooth visible:" + this.jdField_a_of_type_Bedj.b("DEVICE_BLUETOOTHHEADSET"));
      }
    } while (!QLog.isColorLevel());
    label519:
    label525:
  ...
  public boolean a(Context paramContext, bedj parambedj)
  {
    AudioDeviceInterface.LogTraceEntry("");
    if ((paramContext == null) || (parambedj == null)) {
      if (QLog.isColorLevel()) {
