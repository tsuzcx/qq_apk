...
public class bbnz
{
  ...
  public bbnz(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    bcyt localbcyt = new bcyt(this.a, this.a.getApplication(), paramMessageForShortVideo, null);
    bcys.a().a(paramMessageForShortVideo.uniseq, localbcyt);
  }
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      ...
      while (QLog.isColorLevel())
      {
        ...
        return;
        ((aocy)this.a.getBusinessHandler(BusinessHandlerFactory.SVIP_HANDLER)).a(paramMessageRecord);
  ...
  public void a(MessageRecord paramMessageRecord, anyz paramanyz, bbod parambbod)
  {
    ...
    if (parambbod != null) {
      parambbod.onSendBegin(paramMessageRecord);
    }
    this.a.getMessageFacade().sendMessage(paramMessageRecord, paramanyz);
  }
