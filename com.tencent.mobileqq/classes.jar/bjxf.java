  ...
  extends bjxl
{
  ...
  public bjxf(@NonNull bjxn parambjxn)
  {
    super(parambjxn);
  }
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4)
  {
    ...
    if ((!paramBoolean3) || (paramBoolean4))
    {
      ...
      {
        localObject = this.jdField_a_of_type_Bjxn.a();
        vvd localvvd = this.jdField_a_of_type_Bjxn.a();
        if (localObject != null) {
          this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetStoryGuideLineView.setLinkerObject((bkjr)localObject);
        }
        if (this.jdField_a_of_type_Boolean) {
          this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetStoryGuideLineView.setFollow();
        }
        if (localvvd != null) {
          this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetStoryGuideLineView.setStoryTag(localvvd);
        }
      }
      if ((this.jdField_a_of_type_Bjxn instanceof bkpw))
      {
        ...
        if (!((bkpw)this.jdField_a_of_type_Bjxn).r)
        {
          paramBoolean3 = true;
  ...
  protected boolean a(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        {
          return bool;
          if ((paramMessage.obj == null) || (!(paramMessage.obj instanceof bjxg))) {
            break;
          }
          bjxg localbjxg = (bjxg)paramMessage.obj;
          if (QLog.isColorLevel()) {
            QLog.d("Q.qqstory.publish.edit.StoryDoodle", 2, "showLimitView : left : " + localbjxg.d + " right : " + localbjxg.c + " top : " + localbjxg.jdField_a_of_type_Boolean + " bottom : " + localbjxg.b);
          }
          if (localbjxg.e)
          {
            a(localbjxg.d, localbjxg.c, localbjxg.jdField_a_of_type_Boolean, localbjxg.b);
            break;
          }
