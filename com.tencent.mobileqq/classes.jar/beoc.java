...
{
  public beoc(MiniAppVideoPlayer paramMiniAppVideoPlayer) {}
  ...
  public void onVideoPrepared(VideoPlayerProxy paramVideoPlayerProxy)
  {
    ...
    for (;;)
    {
      ...
      beiw.c().post(new MiniAppVideoPlayer.7.1(this));
      ...
      try
      {
        ...
        this.a.jdField_a_of_type_Begy.a("onVideoWaiting", paramVideoPlayerProxy.toString(), this.a.jdField_a_of_type_Int);
      }
    ...
    if (!this.a.jdField_a_of_type_Begy.getClass().getName().equals("com.tencent.qqmini.sdk.runtime.core.service.AppBrandService"))
    {
      ...
      beiw.c().post(new MiniAppVideoPlayer.7.3(this));
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          paramVideoPlayerProxy.put("videoId", this.a.jdField_a_of_type_Long);
          paramVideoPlayerProxy.put("data", this.a.jdField_a_of_type_JavaLangString);
          this.a.jdField_a_of_type_Begy.a("onVideoPlay", paramVideoPlayerProxy.toString(), this.a.jdField_a_of_type_Int);
          besl.a("MiniAppVideoPlayer", "OnVideoPreparedListener - onVideoPrepared evaluateSubcribeJS onVideoPlay = " + paramVideoPlayerProxy.toString());
        }
        catch (JSONException paramVideoPlayerProxy)
        {
          paramVideoPlayerProxy.printStackTrace();
