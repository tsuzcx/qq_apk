...
public class bjnn
{
  ...
  protected bjnn()
  {
    this.jdField_a_of_type_ComTencentTmassistantsdkITMAssistantCallBackListener = new bjnz(this);
    ...
    catch (Throwable localThrowable)
    {
      for (;;)
      {
        bjko.c("MyAppApi", "MyAppApi init>>>", localThrowable);
      }
    }
  }
  ...
  {
    return Uri.parse("tmast://sdk_wake?jump_code=" + bjlt.a(bizw.a().a(), null).a("Common_jump_code") + "&outerCallTime=" + paramOuterCallReportModel.mOuterCallTime + "&outerCallType=" + paramOuterCallReportModel.mOuterCallType + "&outerCallMode=" + paramOuterCallReportModel.mOuterCallMode + "&hostpname=com.tencent.mobileqq&hostversion=" + GlobalUtil.getAppVersionCode(bizw.a().a()));
  }
  
  public static bjnn a()
  {
    try
    {
      if (jdField_a_of_type_Bjnn == null) {
        jdField_a_of_type_Bjnn = new bjnn();
      }
      c();
      bjnn localbjnn = jdField_a_of_type_Bjnn;
      return localbjnn;
    }
    finally {}
  }
  ...
  private static void c(OuterCallReportModel paramOuterCallReportModel)
  {
    ...
    if (!(bizw.a().a() instanceof Activity)) {
    ...
    {
      bjko.e("TAMST_WAKE", "activity not found error:" + paramOuterCallReportModel.getMessage());
    }
  }
  
  private static void d(OuterCallReportModel paramOuterCallReportModel)
  {
    GlobalUtil.getInstance().setContext(bizw.a().a());
  ...
  public static boolean d()
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 142	bjnn:jdField_a_of_type_Bjnn	Lbjnn;
    //   6: astore_1
    //   7: aload_1
    //   8: ifnull +10 -> 18
    //   11: iconst_1
  ...
  private void i()
  {
    ...
    bizw.a().a().registerReceiver(new AppReportReceiver(), localIntentFilter);
  }
  
  private static boolean i()
  {
    return (bjmt.i()) && (TMAssistantCallYYB_V1.getQQDownloadApiLevel(bizw.a().a()) >= 7);
  }
  
  public int a()
  {
    int i = TMAssistantCallYYB_V1.getQQDownloadApiLevel(bizw.a().a());
    if (!arqj.a("com.tencent.android.qqdownloader", BaseActivity.sTopActivity)) {
      i = 3;
    }
    return i;
  }
  ...
  public int a(Bundle paramBundle)
  {
    ...
    {
      i = j;
      if (paramBundle.getInt(bjmy.k) == 3) {
        i = 2;
      }
    }
    return i;
  ...
  public long a(Bundle paramBundle)
  {
    try
    {
      bjko.c("MyAppApi", "--addDownloadTaskFromTmast--params = " + paramBundle);
      if (paramBundle == null) {
        return -1L;
      }
  ...
  {
    bjko.c("MyAppApi", "--addDownloadTaskFromTaskList--params = " + paramBundle + "autoDownload = " + paramBoolean1);
    if (paramBundle == null) {
      return -1L;
    }
  ...
  public DownloadInfo a(TMAssistantCallYYBParamStruct paramTMAssistantCallYYBParamStruct, Bundle paramBundle)
  {
    ...
    if (paramBundle != null)
    {
      localDownloadInfo.jdField_h_of_type_JavaLangString = paramBundle.getString(bjmy.i);
      localDownloadInfo.f = paramBundle.getString(bjmy.l);
      localDownloadInfo.jdField_d_of_type_JavaLangString = paramBundle.getString(bjmy.j);
      localDownloadInfo.jdField_d_of_type_Int = paramBundle.getInt(bjmy.F);
    }
  ...
  protected TMAssistantCallYYBParamStruct a(Bundle paramBundle)
  {
    ...
    String str4 = paramBundle.getString(bjmy.jdField_c_of_type_JavaLangString);
    String str5 = paramBundle.getString(bjmy.jdField_d_of_type_JavaLangString);
    String str6 = paramBundle.getString(bjmy.f);
    Object localObject = paramBundle.getString(bjmy.i);
    int j = paramBundle.getInt(bjmy.e);
    int i = j;
    if (j == 0) {}
    try
    {
      i = Integer.valueOf(paramBundle.getString(bjmy.e)).intValue();
      String str2;
      String str1;
      if (this.jdField_a_of_type_Boolean)
      {
        str2 = bjlu.a((String)localObject, "NEWYYB");
        paramBundle.getString(bjmy.A);
        localObject = paramBundle.getString(bjmy.C);
        j = paramBundle.getInt(bjmy.B);
        if (j != 1) {
          break label418;
        }
      ...
      for (;;)
      {
        bjko.b("State_Log", " channelId:" + (String)localObject);
        ...
        bjko.b("MyAppApi", "recommendId:" + ((TMAssistantCallYYBParamStruct)localObject).recommendId);
        return localObject;
        str2 = bjlu.a((String)localObject, "YYB");
        break;
        label418:
  ...
  public String a()
  {
    if ((this.jdField_a_of_type_Bjny != null) && (this.jdField_a_of_type_Bjny.jdField_a_of_type_AndroidOsBundle != null)) {
      return this.jdField_a_of_type_Bjny.jdField_a_of_type_AndroidOsBundle.getString(bjmy.b);
    }
    return "";
  }
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentTmassistantsdkInternalOpenSDKTMAssistantBaseCallYYB.initTMAssistantCallYYBApi(bizw.a().a());
      g();
      return;
    }
  }
  ...
  {
    String str = paramBundle.getString(bjmy.p);
    int i = paramBundle.getInt("dialogType");
    int j = paramBundle.getInt("auto_start_yyb_download");
    bjko.c("TIME-STATISTIC", "MyAppApi--showTipDialog");
    bjko.c("MyAppApi", "-showTipDialog-");
    ...
    if (paramInt2 == 1) {
      if (paramInt1 == 2)
      {
        ...
        localObject = bjmt.a(paramInt1, paramString2);
        label86:
        ...
        {
        default: 
          paramString2 = localResources.getString(2131691576);
          label138:
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = localResources.getString(2131691596);
        if ((paramInt2 == 1) && (i == 1))
        {
          paramString1 = localResources.getString(2131691597);
          paramString2 = localResources.getString(2131691580);
          localObject = new bjob(paramActivity);
          ((bjob)localObject).b(2131691591, paramOnClickListener2, true);
          if (!paramBoolean)
          {
            bool = true;
            ((bjob)localObject).a(2131691594, paramOnClickListener1, bool);
            ((bjob)localObject).a(paramString1);
            ((bjob)localObject).b(paramString2);
            if (i == 1)
            {
              ((bjob)localObject).b(2131691591, Color.parseColor("#D2D1D1"), paramOnClickListener2, true);
              paramInt1 = Color.parseColor("#3AC8FF");
              if (paramBoolean) {
                continue;
              }
              paramBoolean = true;
              ((bjob)localObject).a(2131691594, paramInt1, paramOnClickListener1, paramBoolean);
              ((bjob)localObject).a(paramActivity.getResources().getDrawable(2130841896));
              ((bjob)localObject).a(Color.parseColor("#848484"));
            }
            ((bjob)localObject).setCancelable(true);
            ((bjob)localObject).setOnCancelListener(paramOnCancelListener);
            ((bjob)localObject).setOnDismissListener(new bjnq(this));
            if ((!(paramActivity instanceof AppActivity)) || (((AppActivity)paramActivity).isResume())) {
              continue;
            }
            bjko.c("TIME-STATISTIC", "MyAppApi--showTipDialog---cancel !isResume");
            return;
            ...
            paramString2 = localResources.getString(2131691576);
            break label138;
            paramString2 = localResources.getString(2131691577, new Object[] { paramString1 });
            break label138;
            paramString2 = localResources.getString(2131691578);
            break label138;
            paramString2 = localResources.getString(2131691579, new Object[] { paramString1 });
          }
        }
      }
      catch (Exception paramString2)
      {
        if (paramInt1 == 2)
        {
          paramString1 = localResources.getString(2131691576);
          bjko.c("MyAppApi", " errorMsg = " + paramString2.getMessage());
          continue;
        }
        paramString1 = localResources.getString(2131691578);
        continue;
        boolean bool = false;
        continue;
        paramBoolean = false;
        ...
        try
        {
          ...
          {
            ((bjob)localObject).show();
            bdla.b(null, "dc00898", "", "", "0X8008F7A", "0X8008F7A", 0, 0, "", "", "", "");
            if (i == 1)
            {
              bjkf.a("6006", "0", "0", paramBundle.getString(bjmy.i), paramBundle.getString("pageId") + "_" + paramBundle.getString("moduleId") + "_" + paramBundle.getString(bjmy.f) + "_" + paramBundle.getString(bjmy.jdField_c_of_type_JavaLangString) + "_" + paramBundle.getString(bjmy.jdField_d_of_type_JavaLangString));
              if (j == 1) {
                ThreadManager.getUIHandler().post(new MyAppApi.13(this, paramOnClickListener1, (bjob)localObject));
              }
            }
          }
        }
        ...
        bjko.c("TIME-STATISTIC", "MyAppApi--showTipDialog---complete");
        this.jdField_a_of_type_Bjob = ((bjob)localObject);
        return;
  ...
  protected void a(Activity paramActivity, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    do
    {
      ...
      break label74;
      bjko.e("MyAppApi", "startToAuthorizedDirect mLastAuthorizeParam = null, needCarryQQIdentity = false");
      return;
      localbjks = new bjks();
      localbjks.a(new bjnr(this, localbjks, l, paramActivity, paramOnClickListener));
    } while (!(paramActivity instanceof BaseActivity));
    localbjks.a(((BaseActivity)paramActivity).getAppRuntime(), 710020706L, "com.tencent.android.qqdownloader");
  }
  
  public void a(Activity paramActivity, Bundle paramBundle, DialogInterface.OnClickListener paramOnClickListener)
  {
    bjko.c("TIME-STATISTIC", "MyAppApi--handleDownloadAction");
    ...
    boolean bool2 = paramBundle.getBoolean(bjmy.g, false);
    boolean bool3 = paramBundle.getBoolean(bjmy.jdField_h_of_type_JavaLangString, true);
    int k = paramBundle.getInt(bjmy.n);
    int j = paramBundle.getInt(bjmy.k);
    String str3 = paramBundle.getString(bjmy.i);
    String str2 = paramBundle.getString(bjmy.b);
    int m = paramBundle.getInt("dialogType");
    int n = paramBundle.getInt(bjmy.t, 0);
    int i1 = paramBundle.getInt(bjmy.u, 0);
    boolean bool4 = bjmt.e();
    bool5 = bjmt.g();
    bjko.c("OpenConfig-MyAppApi", " useMyAppFlag = " + bool4);
    localDownloadInfo = bjna.a().a(str2);
    boolean bool1;
    if ((localDownloadInfo != null) && (localDownloadInfo.jdField_c_of_type_Int == 1))
    {
      ...
      {
        bjko.a("MyAppApi", "allowMyApp=" + bool4 + " allowMyAppDownload=" + bool5 + " taskExist=" + bool1);
        paramOnClickListener.onClick(null, 0);
      }
      bjlu.a("200", str3, str2);
    }
    for (;;)
    {
      return;
      ...
      if (i == 1) {
        label307:
        if ((this.jdField_a_of_type_Bjob != null) && (this.jdField_a_of_type_Bjob.isShowing())) {
          if (this.jdField_a_of_type_Bjob.a() == paramActivity)
          {
            bjko.a("MyAppApi", "mTipDialog is showing return");
            return;
          }
        }
      }
      try
      {
        ...
        label351:
        for (this.jdField_a_of_type_Bjob = null; (!bjmt.f()) || ((j != 2) && (j != 12)); this.jdField_a_of_type_Bjob = null)
        {
          bjko.a("MyAppApi", "not allowShowDialog return actionCode = " + j);
          if (paramOnClickListener != null) {
            paramOnClickListener.onClick(null, 0);
          }
          bjlu.a("200", str3, str2);
        ...
        bool4 = bjmt.a();
        bjnu localbjnu = new bjnu(this, bool2, paramOnClickListener, paramBundle, k, bool4, paramActivity, str3, bool1, bool3, str2, m);
        bjnw localbjnw = new bjnw(this, paramOnClickListener, str3, str2);
        bjnv localbjnv = new bjnv(this, str3, str2);
        String str1 = null;
        ...
        if (i1 > 0)
        {
          ...
          if (n > 0)
          {
            ...
            localObject = str1;
            if (k > 0) {
              localObject = bjok.a(k);
            }
          }
        }
        str1 = paramBundle.getString("source");
        ThreadManager.getUIHandler().post(new MyAppApi.7(this, paramActivity, j, i, (String)localObject, localbjnu, localbjnw, localbjnv, str1, bool4, paramBundle));
        ...
        if ((bjmt.h()) || (bool1))
        {
          paramOnClickListener = bjlu.a(str3, "YYB");
          if (k == 0) {
            a(paramActivity, paramBundle, bool2, bool3);
          }
          while ((localObject == null) && ((j == 2) || (j == 12)))
          {
            bjlu.a("202", paramOnClickListener, str2);
            return;
            a(paramActivity, paramBundle, bool2, bool3);
          }
          bjlu.a("200", paramOnClickListener, str2);
          return;
        }
        if (paramOnClickListener != null) {
          paramOnClickListener.onClick(null, 0);
  ...
  {
    bjko.c("NewUpgradeDialog", "preDownload called,get updateDetail info");
  ...
  {
    bjko.c("MyAppApi", "downloadYyb");
    if (paramInt == 1) {
      bjmu.a("_1101070898");
    }
    if (this.jdField_a_of_type_Bjoa == null)
    {
      this.jdField_a_of_type_Bjoa = new bjoa(this);
      bjna.a().a(this.jdField_a_of_type_Bjoa);
    }
    Object localObject = bjna.a().a("1101070898");
    ...
    if (localObject != null)
    {
      ...
      for (((DownloadInfo)localObject).jdField_h_of_type_Int = 1;; ((DownloadInfo)localObject).jdField_h_of_type_Int = 0)
      {
        ...
        bjna.a().a((DownloadInfo)localObject);
        return;
  ...
  public void a(Activity paramActivity, String paramString1, String paramString2, int paramInt, boolean paramBoolean)
  {
    ...
    localBundle.putString(bjmy.b, "1101070898");
    localBundle.putString(bjmy.j, str);
    localBundle.putString(bjmy.f, "com.tencent.android.qqdownloader");
    localBundle.putInt(bjmy.k, 2);
    localBundle.putString(bjmy.i, paramString2);
    localBundle.putString(bjmy.l, bjok.jdField_d_of_type_JavaLangString);
    if (paramInt == 1) {
      localBundle.putBoolean(bjmy.x, true);
    }
    for (;;)
    {
      localBundle.putInt(bjmy.D, paramInt);
      localBundle.putString(bjmy.m, "yyb");
      localBundle.putString(bjmy.jdField_c_of_type_JavaLangString, "5848");
      localBundle.putBoolean(bjmy.g, true);
      localBundle.putBoolean(bjmy.jdField_h_of_type_JavaLangString, paramBoolean);
  ...
  {
    bjko.c("TIME-STATISTIC", "MyAppApi--startToDownloadTaskList");
    ...
    while ((i == 0) || (paramContext == null) || (!(paramContext instanceof BaseActivity)))
    {
      ...
      {
        bjko.e("MyAppApi", "--startToDownloadTaskList--Exception = " + paramContext);
        return;
      }
      i = 0;
      continue;
      i = paramBundle.getInt(bjmy.k);
      j = a(paramBundle);
      if (i != 3) {
        break label400;
      }
    ...
    for (;;)
    {
      ...
      return;
      localObject = new bjks();
      ((bjks)localObject).a(new bjnp(this, (bjks)localObject, localTMAssistantCallYYBParamStruct, paramBundle, l, paramContext, paramBoolean1, paramBoolean2));
      if (!(paramContext instanceof BaseActivity)) {
        break;
      }
      ((bjks)localObject).a(((BaseActivity)paramContext).getAppRuntime(), 710020706L, "com.tencent.android.qqdownloader");
      return;
    }
  }
  ...
  public void a(Context paramContext, JSONArray paramJSONArray, int paramInt, String paramString1, String paramString2)
  {
    ...
    if (i < k)
    {
      ...
      for (;;)
      {
        ...
        localTMAssistantCallYYBParamStruct.channelId = localJSONObject.optString(bjmy.L);
        localTMAssistantCallYYBParamStruct.taskPackageName = localJSONObject.optString(bjmy.f);
        localTMAssistantCallYYBParamStruct.taskVersion = localJSONObject.optInt(bjmy.e);
        localTMAssistantCallYYBParamStruct.via = localJSONObject.optString(bjmy.i);
        localTMAssistantCallYYBParamStruct.taskApkId = localJSONObject.optString(bjmy.jdField_d_of_type_JavaLangString);
        localTMAssistantCallYYBParamStruct.taskAppId = localJSONObject.optString(bjmy.jdField_c_of_type_JavaLangString);
        localTMAssistantCallYYBParamStruct.SNGAppId = localJSONObject.optString(bjmy.jdField_c_of_type_JavaLangString);
        if (TextUtils.isEmpty(localTMAssistantCallYYBParamStruct.SNGAppId)) {
          localTMAssistantCallYYBParamStruct.SNGAppId = localJSONObject.optString(bjmy.b);
        }
  ...
  protected void a(String paramString)
  {
    ...
    if (localDownloadInfo != null) {
      localbjna.a(10, localDownloadInfo);
    }
  }
  ...
  public void a(boolean paramBoolean, String paramString)
  {
    ...
    SharedPreferences.Editor localEditor = bizw.a().a().getSharedPreferences("showTost_pf", 0).edit();
  ...
  {
    bjko.c("TIME-STATISTIC", "MyAppApi--startToWebView");
    if (paramBundle == null) {
      return false;
    }
  ...
  {
    bjko.c("TIME-STATISTIC", "MyAppApi--startToAppDetail ");
    if (paramBundle == null) {
      return false;
    }
    if (TMAssistantCallYYB_V1.getQQDownloadApiLevel(paramContext) >= 6) {
    ...
    TMAssistantCallYYBParamStruct localTMAssistantCallYYBParamStruct = a(paramBundle);
    if (!bjmu.b(localTMAssistantCallYYBParamStruct.SNGAppId)) {
      return false;
    }
    boolean bool = bjmt.d();
    long l = bizw.a().a();
    ...
    for (int i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        ...
        {
          bjko.b("MyAppApi", "startToAppDetail err", paramContext);
          return false;
        }
        localObject = new bjks();
        ((bjks)localObject).a(new bjno(this, (bjks)localObject, localTMAssistantCallYYBParamStruct, paramBundle, l, paramContext, paramBoolean1, paramBoolean2));
        if ((paramContext instanceof BaseActivity)) {
          ((bjks)localObject).a(((BaseActivity)paramContext).getAppRuntime(), 710020706L, "com.tencent.android.qqdownloader");
        }
        return true;
  ...
  public long b(Bundle paramBundle)
  {
    try
    {
      bjko.c("MyAppApi", "--addDownloadTaskFromAppDetail--params = " + paramBundle);
      if (paramBundle == null) {
        return -1L;
      }
  ...
  {
    bjko.c("MyAppApi", "--addDownloadTaskFromAppDetail--params = " + paramBundle + "autoDownload = " + paramBoolean1);
    if (paramBundle == null) {
      return -1L;
    }
    paramBundle = a(paramBundle);
  ...
  public void b(Activity paramActivity)
  {
    ...
    bjko.c("MyAppApi", "judgeInstallFlag -- mInstalledFlag = " + this.jdField_a_of_type_Boolean + "mInstallTime = " + this.jdField_b_of_type_Long + " countTime =" + l);
    int i;
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if ((!this.jdField_b_of_type_Boolean) && (i == 0))
      {
        ...
        if (this.jdField_a_of_type_Bjny != null)
        {
          if (this.jdField_a_of_type_Bjny.jdField_a_of_type_Int != 0) {
            break label350;
          }
          a(paramActivity, this.jdField_a_of_type_Bjny.jdField_a_of_type_AndroidOsBundle, this.jdField_a_of_type_Bjny.jdField_a_of_type_Boolean, this.jdField_a_of_type_Bjny.jdField_b_of_type_Boolean);
        }
      }
    }
    for (;;)
    {
      ...
      {
        paramActivity = bizw.a().a().getSharedPreferences("showTost_pf", 0);
      ...
      if (this.jdField_d_of_type_Boolean)
      {
        ...
        this.jdField_d_of_type_Boolean = false;
        paramActivity = bizw.a().a().getSharedPreferences("showTost_pf", 0).edit();
      ...
      {
        label404:
        if (new File(bizw.a().a().getFilesDir() + File.separator + "yyb_via_info.txt").exists()) {
          bizw.a().a().deleteFile("yyb_via_info.txt");
        }
        label464:
        if ((this.jdField_b_of_type_Boolean) || (i != 0)) {
          continue;
  ...
  public void b(Activity paramActivity, Bundle paramBundle, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    catch (Exception localException)
    {
      ...
      paramOnClickListener.onClick(null, 0);
      bjlu.a("202", str2, localException);
      return;
      if ((!bjmt.h()) && (j == 0)) {
        break label331;
      }
      ...
      for (;;)
      {
        paramActivity = bjlu.a(str2, "YYB");
        if ((localDownloadInfo != null) || ((m != 2) && (m != 12))) {
          break;
        }
        bjlu.a("202", paramActivity, localException);
        return;
        a(paramActivity, paramBundle, bool1, bool2);
      }
      bjlu.a("200", paramActivity, localException);
      return;
      if (paramOnClickListener == null) {
        break label343;
      }
      paramOnClickListener.onClick(null, 0);
      bjlu.a("200", str2, localException);
    }
    bool1 = paramBundle.getBoolean(bjmy.g, false);
    bool2 = paramBundle.getBoolean(bjmy.jdField_h_of_type_JavaLangString, true);
    k = paramBundle.getInt(bjmy.n);
    m = paramBundle.getInt(bjmy.k);
    bool3 = bjmt.e();
    bool4 = bjmt.g();
    str1 = paramBundle.getString(bjmy.b);
    str2 = paramBundle.getString(bjmy.i);
    localDownloadInfo = bjna.a().a(str1);
    if ((localDownloadInfo != null) && (localDownloadInfo.jdField_c_of_type_Int == 1))
    {
      j = 1;
      bjko.c("OpenConfig-MyAppApi", " useMyAppFlag = " + bool3);
      if (((bool3) && (bool4)) || (j != 0)) {
        break label209;
      }
      if (paramOnClickListener != null) {
  ...
  public void b(String paramString, DialogInterface.OnClickListener paramOnClickListener, Activity paramActivity)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        str3 = localJSONObject.optString("appName", anvx.a(2131706521));
        ...
        localBundle.putString(bjmy.jdField_c_of_type_JavaLangString, localJSONObject.optString("myAppid", ""));
        localBundle.putString(bjmy.jdField_d_of_type_JavaLangString, localJSONObject.optString("apkId"));
        localBundle.putInt(bjmy.e, i);
        localBundle.putString(bjmy.f, localJSONObject.optString("appPackageName"));
        localBundle.putString(bjmy.i, localJSONObject.optString("via"));
        localBundle.putString(bjmy.l, localJSONObject.optString("appName"));
        localBundle.putString(bjmy.A, localJSONObject.optString("channelId"));
        localBundle.putString(bjmy.C, localJSONObject.optString("channel"));
        localBundle.putString(bjmy.v, localJSONObject.optString("uin"));
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject1))
        {
          ...
          boolean bool = bjmt.a();
          localObject1 = new bjns(this, localBundle, bool, paramActivity, str2, paramOnClickListener, str1);
          paramOnClickListener = new bjnw(this, paramOnClickListener, str2, str1);
          localObject2 = new bjnv(this, str2, str1);
          localBundle.putString(bjmy.p, paramString);
      ...
      paramString = str3 + anvx.a(2131706518);
    }
  }
  ...
  public boolean b()
  {
    ...
    {
      bjko.c("MyAppApi", "hasValidQQDownloader>>>", localException);
    }
    return false;
  }
  ...
  public boolean b(Context paramContext, Bundle paramBundle)
  {
    ...
    bjko.c("TIME-STATISTIC", "mDownloadSdk.startToDownloadListWithParams");
  ...
  {
    new bjol(paramActivity, null).execute(new Void[0]);
  }
  
  public boolean c()
  {
    return (b()) && (bjmt.e()) && (bjmt.h());
  }
  ...
  protected void d()
  {
    ...
    bjnt localbjnt = new bjnt(this);
    bizw.a().a().registerReceiver(localbjnt, localIntentFilter);
  }
  ...
  public void h()
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        try
        {
          jdField_a_of_type_Bjnn = null;
          return;
        }
        finally {}
        localException = localException;
        bjko.a("MyAppApi", "onDestroy>>>", localException);
      }
    }
  }
}
