  ...
  extends ImageBase
{
  ...
  public pmd(VafContext paramVafContext)
  {
  ...
  public void loadImage(String paramString)
  {
    if ((!TextUtils.isEmpty(paramString)) && (paramString.startsWith("http")))
    {
      ...
      if (DateUtils.isToday(bbjn.b("search_word_prefix_ug_weishi_opt_day_show_time"))) {
        break label163;
      }
      Log.d("DEBUG_LOADIMG", "loadimg not in a day");
      bbjn.a("search_word_prefix_ug_weishi_opt_day_show_time", System.currentTimeMillis());
      if (a(new Date(System.currentTimeMillis()), new Date(bbjn.b("search_word_prefix_ug_weishi_opt_week_first_show_time"))) > 7L)
      {
        Log.d("DEBUG_LOADIMG", "loadimg after 7 days");
        bbjn.a("search_word_prefix_ug_weishi_opt_week_first_show_time", System.currentTimeMillis());
        bbjn.a("search_word_prefix_ug_weishi_opt_week_first_show_count", 1);
        a(paramString);
      }
    }
    else
    ...
    if (bbjn.a("search_word_prefix_ug_weishi_opt_week_first_show_count") < 3)
    {
      Log.d("DEBUG_LOADIMG", "loadimg in 7 days, less than 3");
      bbjn.a("search_word_prefix_ug_weishi_opt_week_first_show_count", bbjn.a("search_word_prefix_ug_weishi_opt_week_first_show_count") + 1);
      a(paramString);
      return;
    }
