...
public final class slv
{
  ...
  public final int a(@Nullable ArticleInfo paramArticleInfo, int paramInt)
  {
    ...
    do
    {
      return paramInt;
      qny localqny = qny.a();
      Intrinsics.checkExpressionValueIsNotNull(localqny, "PTSLiteSwitchManager.getInstance()");
      if ((localqny.a()) && (qmh.a((BaseArticleInfo)paramArticleInfo))) {
        return qmh.a(paramArticleInfo);
      }
      if (qgc.a(paramArticleInfo)) {
        return slt.a.a(paramArticleInfo);
      }
    ...
    {
      paramInt = pbh.a((BaseArticleInfo)paramArticleInfo);
      if ((paramInt == 21) || (paramInt == 22)) {
        return pay.a(paramArticleInfo, true);
      }
      if (paramInt == 11) {
        return 33;
      }
      if (pay.h(paramArticleInfo))
      {
      ...
      if (pay.e(paramArticleInfo)) {
        if ((paramArticleInfo.mSocialFeedInfo == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfe == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfe.jdField_a_of_type_JavaUtilArrayList == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfe.jdField_a_of_type_JavaUtilArrayList.size() <= 0)) {
          break label2443;
        }
      }
    }
    label2440:
    label2443:
    for (paramInt = ComponentContentGridImage.a(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfe.jdField_a_of_type_JavaUtilArrayList.size(), paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Int);; paramInt = 0)
    {
      if (paramInt != 0)
      {
        switch (paramInt)
      ...
      if ((paramInt == 27) && (paramArticleInfo.mSocialFeedInfo != null) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfi != null))
      {
        if (!TextUtils.isEmpty((CharSequence)paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfi.c)) {
          return 94;
        }
        return 95;
      }
      if ((paramInt == 32) && (paramArticleInfo.mSocialFeedInfo != null) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Ret != null)) {
        return 26;
      }
      ...
      if (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfj.jdField_a_of_type_Int == 1)
      {
        if (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfj.c.size() > 0) {
          return 108;
        }
        return 24;
      }
      if ((paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfj.jdField_a_of_type_Int == 3) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfj.jdField_a_of_type_Int == 2))
      {
      ...
      if ((pgb.g((BaseArticleInfo)paramArticleInfo)) && (paramArticleInfo.mSocialFeedInfo != null)) {
        return pgb.b(paramArticleInfo);
      }
      ...
      if ((pay.f(paramArticleInfo)) || (pay.g(paramArticleInfo))) {
        return pgb.c(paramArticleInfo);
      }
      ...
      {
        if ((paramArticleInfo.mChannelID == 0L) && (paramArticleInfo.mSimpleVideoColumnInfo != null) && (pay.a((BaseArticleInfo)paramArticleInfo))) {
          return 128;
        }
        if ((paramArticleInfo.mChannelID == 0L) && (paramArticleInfo.mVideoColumnInfo != null) && (pay.a((BaseArticleInfo)paramArticleInfo))) {
          return 118;
        }
        ...
        if ((pay.a((BaseArticleInfo)paramArticleInfo)) && (paramArticleInfo.mPictures != null) && (paramArticleInfo.mPictures.length >= 3) && (paramArticleInfo.mChannelID == 0L)) {
          return 14;
        }
        if (pay.a((BaseArticleInfo)paramArticleInfo))
        {
        ...
        if (pay.b((BaseArticleInfo)paramArticleInfo))
        {
        ...
        if (paramArticleInfo.mShowBigPicture)
        {
          if (paramArticleInfo.mIsGallery == 0)
          {
            ...
            if (AdvertisementInfo.isAdvertisementInfo((BaseArticleInfo)paramArticleInfo)) {
              return twr.b((AdvertisementInfo)paramArticleInfo);
            }
            return 2;
          }
        ...
        if ((AdvertisementInfo.isAdvertisementInfo((BaseArticleInfo)paramArticleInfo)) && (twr.g((AdvertisementInfo)paramArticleInfo))) {
          return 116;
        }
        if ((AdvertisementInfo.isAdvertisementInfo((BaseArticleInfo)paramArticleInfo)) && (twr.h((AdvertisementInfo)paramArticleInfo))) {
          return 39;
        }
        if ((AdvertisementInfo.isAdvertisementInfo((BaseArticleInfo)paramArticleInfo)) && (twr.i((AdvertisementInfo)paramArticleInfo))) {
          return 117;
        }
        if (pay.j(paramArticleInfo))
        {
          if (pay.k(paramArticleInfo)) {
            return 91;
          }
          return 90;
        }
        if ((AdvertisementInfo.isAdvertisementInfo((BaseArticleInfo)paramArticleInfo)) && (twr.j((AdvertisementInfo)paramArticleInfo))) {
          return 127;
        }
        if (twr.a((BaseArticleInfo)paramArticleInfo)) {
          return 140;
        }
        if (twr.c((BaseArticleInfo)paramArticleInfo)) {
          return 144;
        }
        if (twr.e((BaseArticleInfo)paramArticleInfo)) {
          return 145;
        }
        if (twr.b((BaseArticleInfo)paramArticleInfo)) {
          return 146;
        }
        if (twr.f((BaseArticleInfo)paramArticleInfo)) {
          return 143;
        }
        if (twr.d((BaseArticleInfo)paramArticleInfo)) {
          return 141;
        }
        ...
        if ((AdvertisementInfo.isAdvertisementInfo((BaseArticleInfo)paramArticleInfo)) && (twr.k((AdvertisementInfo)paramArticleInfo))) {
          return 122;
        }
        ...
        if (paramArticleInfo.mIsGallery == 0)
        {
          if (AdvertisementInfo.isAdvertisementInfo((BaseArticleInfo)paramArticleInfo))
          {
            if (obb.a((BaseArticleInfo)paramArticleInfo)) {
              return 106;
            }
            return 104;
          }
