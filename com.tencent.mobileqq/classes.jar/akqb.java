...
public class akqb
{
  ...
  public String b()
  {
    if (8 == this.jdField_a_of_type_Int) {
      return aliu.h + this.jdField_b_of_type_Int + File.separator + this.jdField_a_of_type_JavaLangString;
    }
    return aliu.jdField_a_of_type_JavaLangString + this.jdField_b_of_type_Int + File.separator + this.jdField_a_of_type_JavaLangString;
  }
  
  public boolean b()
  {
    if ((ApolloUtil.c(b())) && (this.jdField_a_of_type_Int == 8)) {
      return ApolloUtil.c(aliu.h + this.jdField_b_of_type_Int + File.separator + "room.bin");
    }
    return false;
  }
  ...
  public String c()
  {
    ...
    if (this.jdField_a_of_type_Int == 6)
    {
      ...
      localObject1 = new File(aliu.j + (String)localObject1 + File.separator + "face.json");
    ...
    {
      return "";
      Object localObject2 = new File(aliu.f + this.jdField_b_of_type_Int + File.separator + "blendshape.json");
      if (((File)localObject2).exists())
      {
        try
        {
          localObject2 = bdhb.b((File)localObject2);
          return localObject2;
        }
        ...
        continue;
        Object localObject3 = new File(aliu.f + this.jdField_b_of_type_Int + File.separator + "face.json");
        if (((File)localObject3).exists())
        {
          try
          {
            localObject3 = bdhb.b((File)localObject3);
            return localObject3;
          }
        ...
        {
          Object localObject4 = new File(aliu.f + this.jdField_b_of_type_Int + File.separator + "blendshape.json");
          if (((File)localObject4).exists()) {
            try
            {
              localObject4 = bdhb.b((File)localObject4);
              return localObject4;
            }
