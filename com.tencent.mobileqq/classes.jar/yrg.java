  ...
  implements View.OnClickListener
{
  ...
  public yrg(@NonNull yty paramyty)
  {
    super(paramyty);
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetSeekBar.setOnSeekBarChangeListener(new yrh(this));
  }
  ...
  public void a(int paramInt, Object paramObject)
  {
    ...
    if (this.e == -1)
    {
      if (!this.jdField_a_of_type_Yty.a.jdField_a_of_type_Boolean) {
        break label193;
      }
      paramInt = (int)this.jdField_a_of_type_Yty.a.jdField_a_of_type_CooperationQzoneWidgetFastAnimationDrawable.a();
      this.e = paramInt;
      this.c = paramInt;
    }
  ...
  public void a(@NonNull zem paramzem)
  {
    if (this.e == -1) {
      if (this.jdField_a_of_type_Yty.a.jdField_a_of_type_Boolean)
      {
        paramzem.a.jdField_b_of_type_Int = ((int)this.jdField_a_of_type_Yty.a.jdField_a_of_type_CooperationQzoneWidgetFastAnimationDrawable.a());
        paramzem.a.c = this.jdField_a_of_type_Boolean;
        if (QLog.isColorLevel()) {
  ...
  public boolean a()
  {
    ...
    if (this.jdField_a_of_type_Yty.jdField_b_of_type_Int == 21)
    {
      ...
      if (this.jdField_a_of_type_Yty.a.jdField_a_of_type_CooperationQzoneWidgetFastAnimationDrawable != null) {
        this.jdField_a_of_type_Yty.a.jdField_a_of_type_CooperationQzoneWidgetFastAnimationDrawable.a(NativeGifImage.QZONE_DELAY);
      }
      this.e = this.c;
