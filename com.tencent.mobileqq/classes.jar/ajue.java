  ...
  extends ajfb
{
  ...
  private ServiceConnection jdField_a_of_type_AndroidContentServiceConnection = new ajug(this);
  public Handler a;
  private HandlerThread jdField_a_of_type_AndroidOsHandlerThread;
  public Messenger a;
  SparseArray<ajuj> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
  private final ArrayList<ajui> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public ajue(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_AndroidOsMessenger = null;
    this.jdField_b_of_type_AndroidOsMessenger = null;
    this.jdField_a_of_type_AndroidOsHandler = new ajuf(this, Looper.getMainLooper(), paramQQAppInterface);
  }
  ...
  private void a(int paramInt1, ajuj paramajuj, int paramInt2, int paramInt3)
  {
    Message localMessage = this.jdField_a_of_type_AndroidOsHandler.obtainMessage();
    localMessage.what = 1;
    localMessage.obj = new Object[] { Integer.valueOf(paramInt1), paramajuj, Integer.valueOf(paramInt2), Integer.valueOf(paramInt3) };
  ...
  private void b()
  {
    ...
    bfpr.a(this.app, this.jdField_a_of_type_AndroidContentServiceConnection);
  }
  ...
  {
    ajuj localajuj = (ajuj)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt2, null);
    if (localajuj == null) {
      return;
    }
    a(paramInt2, localajuj, paramInt1, paramInt3);
  }
  
  public void a(int paramInt, String paramString, long paramLong)
  {
    if (this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt) == null) {
      this.jdField_a_of_type_AndroidUtilSparseArray.append(paramInt, new ajuj(this, paramString, paramLong));
    }
    a(paramInt);
  }
  ...
  void a(long paramLong, int paramInt1, int paramInt2)
  {
    ...
    {
      Object localObject = (ajui)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      View localView = ((ajui)localObject).a();
      localObject = ((ajui)localObject).a();
      if ((localView != null) && (localObject != null)) {
        ((ajuh)localObject).a(localView, paramLong, paramInt1, paramInt2);
      }
      for (;;)
      {
        i += 1;
  ...
  public void a(View paramView, ajuh paramajuh)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (localIterator.hasNext())
    {
      ajui localajui = (ajui)localIterator.next();
      if (localajui.a() == paramView)
      {
        localajui.b = new WeakReference(paramajuh);
        return;
      }
    }
    this.jdField_a_of_type_JavaUtilArrayList.add(new ajui(this, paramView, paramajuh));
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, int paramInt1, String paramString, long paramLong, int paramInt2, int paramInt3)
  {
    ...
    for (Object localObject2 = (StructMsgForGeneralShare)localObject2;; localObject2 = null)
    {
      ...
      {
        ((StructMsgForGeneralShare)localObject2).setSummary(BaseApplication.getContext().getResources().getString(2131625213));
        ((StructMsgForGeneralShare)localObject2).setProgress(paramInt3);
        return;
      }
      paramInt1 = 32772;
      localObject1 = BaseApplication.getContext().getResources().getString(2131625214);
      ...
      for (;;)
      {
        ...
        ((StructMsgForGeneralShare)localObject2).mMsgBrief = (ajjy.a(2131649927) + (String)localObject1);
        ...
        if (paramInt2 == 1003)
        {
          localObject1 = BaseApplication.getContext().getResources().getString(2131625212);
          paramInt1 = 32768;
        }
        else if (paramInt2 == 1005)
        {
          localObject1 = BaseApplication.getContext().getResources().getString(2131625211);
          paramInt1 = 32770;
