  ...
  implements agvc, View.OnClickListener
{
  ...
  public agvi(BaseChatPie paramBaseChatPie)
  {
  ...
  public static FileManagerEntity a(bftf parambftf)
  {
    ...
    if (auog.a(parambftf.jdField_b_of_type_JavaLangString))
    {
      ...
      localFileManagerEntity.nFileType = aunj.a(parambftf.g);
    ...
    for (;;)
    {
      ...
      localFileManagerEntity.strTroopFilePath = parambftf.e;
      ...
      QLog.i("MultiFavoriteHelper", 1, "=_= create new Entity[" + localFileManagerEntity.nSessionId + "] fileName[" + parambftf.g + "] by troop size(" + localFileManagerEntity.imgHeight + ":" + localFileManagerEntity.imgWidth + ")");
  ...
  public static FileManagerEntity a(QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage)
  {
    ...
    for (;;)
    {
      ...
      for (int i = Integer.parseInt((String)localObject); (i == 1) || (i == 2) || (i == 3); i = -1)
      {
        ...
        ((FileManagerEntity)localObject).nSessionId = aunj.a().longValue();
        ...
        for (;;)
        {
          ...
          if (i == 1)
          {
            ...
            label147:
            ((FileManagerEntity)localObject).peerNick = aunj.a(paramQQAppInterface, ((FileManagerEntity)localObject).peerUin, null, ((FileManagerEntity)localObject).peerType);
  ...
  public static String a(QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage)
  {
    ...
    do
    {
      ...
      if (paramChatMessage.isMultiMsg)
      {
        ...
        if (!nlj.a(paramChatMessage))
        {
          ...
          if (TextUtils.isEmpty(str2)) {
            str1 = axpf.a().a(paramChatMessage.senderuin, paramChatMessage.msgseq, paramQQAppInterface);
          }
        }
      }
      if (str1 != null)
      ...
      {
        paramQQAppInterface = axpm.a(paramChatMessage.senderuin);
      }
  ...
  private ArrayList<ChatMessage> a(MessageForStructing paramMessageForStructing, ArrayList<ChatMessage> paramArrayList)
  {
    ...
    //   100: aload_0
    //   101: aload 7
    //   103: invokespecial 464	agvi:a	(Lcom/tencent/mobileqq/persistence/Entity;)Lcom/tencent/mobileqq/persistence/Entity;
  ...
  private void a(aggs paramaggs, ChatMessage paramChatMessage)
  {
    if ((paramChatMessage == null) || (paramaggs == null)) {}
    for (;;)
    {
      return;
      ...
      bmkz.a().a = false;
      paramaggs.a.a(paramChatMessage, paramaggs).a(2131366320, this.jdField_a_of_type_AndroidContentContext, paramChatMessage);
      if (bmkz.a().a) {
        bmkz.a().a = false;
      }
      while (ambu.a().c())
  ...
  private void a(List<ChatMessage> paramList)
  {
    ...
    {
      return;
      agsd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramList, 4);
      axpf.a().b(paramList);
      if (QLog.isColorLevel()) {
    ...
    axpf.a().jdField_a_of_type_Int = 6;
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aimn)) {
      this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo = axpf.a().a();
    }
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1) {
      ((aoip)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, localArrayList, false, null);
    }
    for (;;)
    {
  ...
  private void a(List<ChatMessage> paramList, List<String> paramList1)
  {
    ...
    for (;;)
    {
      ...
      while (paramList.hasNext())
      {
        String str = adak.c((ChatMessage)paramList.next());
  ...
  private boolean a(ChatMessage paramChatMessage)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return false;
        } while (!axpm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage));
        if (!(paramChatMessage instanceof MessageForStructing)) {
          break;
        }
      } while (((MessageForStructing)paramChatMessage).structingMsg.mMsgServiceID != 35);
      return true;
    } while (((paramChatMessage instanceof MessageForArkApp)) || (((paramChatMessage instanceof MessageForPic)) && (aiyz.a((MessageForPic)paramChatMessage))));
    return true;
  }
  ...
  public void a(BaseChatPie paramBaseChatPie, aggs paramaggs, MessageForStructing paramMessageForStructing)
  {
    if (QLog.isColorLevel()) {
      QLog.d("MultiFavoriteHelper", 2, "onClickMultiFavoriteBtn");
    }
    int i = axpf.a().c();
    bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009C5B", "0X8009C5B", 0, i, "", "", "", "");
    if (paramMessageForStructing == null)
    {
      paramMessageForStructing = axpf.a().a();
      if (paramMessageForStructing.size() == 1)
      {
        localArrayList = axpm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ArrayList)paramMessageForStructing);
        if ((localArrayList != null) && (localArrayList.size() > 0))
        {
          paramMessageForStructing = (ChatMessage)localArrayList.get(0);
          a(paramaggs, paramMessageForStructing);
          paramBaseChatPie.a(false, null, false);
        }
      }
    }
    while (!bmlc.a(paramMessageForStructing))
    {
      for (;;)
      {
      ...
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131697752, 0).b(paramBaseChatPie.a());
      return;
    }
    paramaggs = new ArrayList();
    paramaggs.add(paramMessageForStructing);
    for (;;)
    {
      bmkz.a().a = true;
      if (!a(paramaggs, axpf.a().a()))
      {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131693479, 0).b(paramBaseChatPie.a());
        return;
      }
      i = a(paramaggs);
      paramMessageForStructing = paramaggs;
      if (i > 0)
      {
        if (paramaggs.size() == i)
        {
          QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131693873, 0).b(paramBaseChatPie.a());
          paramBaseChatPie.a(false, null, false);
          return;
        }
        ...
        {
          bmlc.b(paramMessageForStructing);
          a(this.jdField_a_of_type_AndroidContentContext.getString(2131692975), this.jdField_a_of_type_AndroidContentContext.getString(2131693874), new agvj(this, paramaggs, paramBaseChatPie));
          return;
        }
      ...
      return;
      label423:
      paramaggs = paramMessageForStructing;
    }
  }
  ...
  public void a(BaseChatPie paramBaseChatPie, LinearLayout paramLinearLayout, boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_AndroidWidgetImageView == null)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetImageView.setId(2131364471);
        if (AppSetting.c) {
          this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(anzj.a(2131705888));
        }
      }
      ...
      Drawable localDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839367);
      paramBaseChatPie.addState(new int[] { 16842919 }, localDrawable);
      localDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839366);
  ...
  public void a(String paramString1, String paramString2, DialogInterface.OnClickListener paramOnClickListener)
  {
    try
    {
      bhlq.a(this.jdField_a_of_type_AndroidAppActivity, 230, null, paramString1, "", paramString2, new agvk(this, paramOnClickListener), null).show();
      return;
    }
  ...
  public void a(Map<String, String> paramMap, ArrayList<ChatMessage> paramArrayList, int paramInt)
  {
    ...
    for (;;)
    {
      if ((paramArrayList != null) && (paramArrayList.size() == 1) && (bmlc.a((ChatMessage)paramArrayList.get(0))))
      {
        localObject1 = (MessageForStructing)paramArrayList.get(0);
        localObject2 = null;
        label87:
        paramArrayList = bmko.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForStructing)localObject1, (List)localObject2, paramMap);
        ...
        paramArrayList = this.jdField_a_of_type_AndroidContentContext.getString(paramArrayList.getIntExtra("nReasonInt", 2131691992));
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        MessageForStructing localMessageForStructing = axpf.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_b_of_type_JavaLangString, (AbsStructMsg)localObject1);
      ...
      label399:
      bmkq.a(this.jdField_a_of_type_AndroidContentContext, paramMap, bool, null, false);
      return;
      label412:
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      ((agvi)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(11)).a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Aggs, null);
    }
  }
}
