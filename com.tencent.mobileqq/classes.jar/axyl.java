  ...
  extends axuo
{
  public View a(Context paramContext, View paramView, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (paramView != null)
    {
      ...
      if ((paramView instanceof RelativeLayout))
      {
        ...
        if (paramView.getChildCount() == j)
        {
          ...
          localObject1 = (axun)this.jdField_a_of_type_JavaUtilArrayList.get(i);
          ...
          {
            localObject1 = (axzh)localObject1;
            if (paramBoolean)
            {
              ((axzh)localObject1).b("black");
              label122:
              localObject2 = ((axzh)localObject1).f();
              if ((localObject2 == null) || (!((String)localObject2).equals("1"))) {
                break label189;
              }
              ((axzh)localObject1).c("22");
              ((axzh)localObject1).a(true);
              ((axzh)localObject1).a(paramContext, paramView.findViewById(2), paramBundle);
            }
          }
          for (;;)
          {
            i += 1;
            break;
            ((axzh)localObject1).b(null);
            break label122;
            label189:
            if ((localObject2 != null) && (((String)localObject2).equals("2")))
            {
              ((axzh)localObject1).c("44");
              ((axzh)localObject1).a(true);
              ((axzh)localObject1).a(paramContext, paramView.findViewById(3), paramBundle);
            }
            else
            {
              ((axzh)localObject1).c("30");
              ((axzh)localObject1).b(20);
              ((axzh)localObject1).a(paramContext, paramView.findViewById(4), paramBundle);
              continue;
              if ("picture".equals(localObject2))
              {
                localObject1 = (axwq)localObject1;
                if ((((axwq)localObject1).c != null) && (!((axwq)localObject1).c.equals("")))
                {
                  localObject2 = ((axwq)localObject1).a(paramContext, paramView.findViewById(6), true, paramBundle);
                  ((View)localObject2).setClickable(true);
                  ((View)localObject2).setOnClickListener((View.OnClickListener)localObject1);
                }
                else
                {
                  ((axwq)localObject1).a(paramContext, paramView.findViewById(5), true, paramBundle);
                }
              }
            }
          }
    ...
    for (;;)
    {
      ...
      paramView.rightMargin = actn.a(20.0F, localResources);
      ...
      if (i < j)
      {
        localObject2 = (axun)this.jdField_a_of_type_JavaUtilArrayList.get(i);
        ((axun)localObject2).jdField_a_of_type_JavaLangRefWeakReference = this.jdField_a_of_type_JavaLangRefWeakReference;
        localObject3 = ((axun)localObject2).jdField_a_of_type_JavaLangString;
        if ("summary".equals(localObject3))
        {
          localObject2 = (axzh)localObject2;
          if (paramBoolean)
          {
            ((axzh)localObject2).b("black");
            label527:
            localObject3 = ((axzh)localObject2).f();
            if ((localObject3 == null) || (!((String)localObject3).equals("1"))) {
              break label621;
            }
            ((axzh)localObject2).c("22");
            ((axzh)localObject2).a(true);
            localObject2 = ((axzh)localObject2).a(paramContext, null, paramBundle);
      ...
      for (;;)
      {
        i += 1;
        break;
        ((axzh)localObject2).b(null);
        break label527;
        label621:
        if ((localObject3 != null) && (((String)localObject3).equals("2")))
        {
          ((axzh)localObject2).c("44");
          ((axzh)localObject2).a(true);
          localObject2 = ((axzh)localObject2).a(paramContext, null, paramBundle);
          ((View)localObject2).setId(3);
          localObject3 = new LinearLayout.LayoutParams(-2, -2);
          ((LinearLayout.LayoutParams)localObject3).topMargin = actn.a(-3.5F, localResources);
          localLinearLayout.addView((View)localObject2, (ViewGroup.LayoutParams)localObject3);
        }
        else
        {
          ((axzh)localObject2).c("30");
          ((axzh)localObject2).b(20);
          localObject2 = ((axzh)localObject2).a(paramContext, null, paramBundle);
          ...
          {
            localObject3 = (axwq)localObject2;
            localObject2 = ((axwq)localObject3).a(paramContext, null, true, paramBundle);
            RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(actn.a(40.0F, localResources), actn.a(40.0F, localResources));
            if ((((axwq)localObject3).c != null) && (!((axwq)localObject3).c.equals("")))
            {
            ...
            else
            {
              ...
              if (paramView != null)
              {
                paramContext = new RelativeLayout.LayoutParams(actn.a(40.0F, localResources), actn.a(40.0F, localResources));
                if (((RelativeLayout)localObject1).findViewById(6) != null)
                {
                  paramContext.addRule(0, 6);
                  paramContext.rightMargin = actn.a(7.5F, localResources);
              ...
              for (;;)
              {
                ...
                a((View)localObject1);
                i = actn.a(22.5F, localResources);
                j = actn.a(22.5F, localResources);
                ((RelativeLayout)localObject1).setPadding(i, actn.a(10.75F, localResources), j, actn.a(11.75F, localResources));
                return localObject1;
