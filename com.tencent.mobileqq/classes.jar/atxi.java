...
public class atxi
{
  public static View a(Context paramContext, int paramInt, ViewGroup paramViewGroup)
  {
    ...
    case 5: 
    case 7: 
      return LayoutInflater.from(paramContext).inflate(2131559200, paramViewGroup, false);
    }
  ...
  public static View a(Context paramContext, ViewGroup paramViewGroup)
  {
    ...
    localImageView.setId(2131363316);
    localImageView.setScaleType(ImageView.ScaleType.FIT_XY);
    return localImageView;
  }
  
  public static atxd a(Context paramContext, int paramInt, ViewGroup paramViewGroup)
  {
    ...
    default: 
      return null;
    case 5: 
      return new atxk(paramContext, localView, paramViewGroup);
    case 7: 
      return new atxj(paramContext, localView, paramViewGroup);
    }
    return new atxe(paramContext, localView, paramViewGroup);
  }
}
