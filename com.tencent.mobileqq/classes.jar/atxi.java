  ...
  extends atwq
{
  ...
  private anyz jdField_a_of_type_Anyz = new atxn(this);
  bhgj jdField_a_of_type_Bhgj;
  ...
  public atxi(QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity, List<atuz> paramList, int paramInt)
  {
  ...
  private void a(long paramLong)
  {
    ...
    paramLong = localansr.a().a(localFileManagerEntity.uniseq, localFileManagerEntity.peerDin, localFileManagerEntity.strDataLineMPFileID, localFileManagerEntity.fileName, localFileManagerEntity.fileSize, paramLong, this.jdField_c_of_type_Int);
    if (paramLong == -1L)
    {
      if (QLog.isColorLevel()) {
  ...
  private void g(int paramInt)
  {
    ...
    p();
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityMPFileFailedView = new MPFileFailedView(this.jdField_a_of_type_Atuw.getActivity(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityMPFileFailedView.b();
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityMPFileFailedView.a(this.jdField_a_of_type_Atuw.a(), new atxk(this), paramInt, this.jdField_c_of_type_Int);
    this.jdField_a_of_type_Atuw.a().setVisibility(0);
    this.jdField_a_of_type_Atuw.a().removeAllViews();
    this.jdField_a_of_type_Atuw.a().addView(this.jdField_a_of_type_AndroidViewView);
  ...
  public atvp a()
  {
    if (this.jdField_a_of_type_Atvp == null) {
      this.jdField_a_of_type_Atvp = new atxo(this);
    }
  ...
  protected void a()
  {
    ...
    {
      this.jdField_a_of_type_AndroidContentBroadcastReceiver = new atxq(this);
      ...
      localIntentFilter.addAction(blzp.d);
      localIntentFilter.addAction(blzp.g);
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqMsfSdkHandlerINetEventHandler = new atxj(this);
  ...
  public void a(byte[] paramArrayOfByte, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      if (this.d >= 3)
      {
        this.jdField_a_of_type_Bhgj = new bhgj(this.jdField_a_of_type_AndroidAppActivity, 2131755829);
        this.jdField_a_of_type_Bhgj.setContentView(2131559045);
        this.jdField_a_of_type_Bhgj.setTitle(2131694075);
        this.jdField_a_of_type_Bhgj.a(2131694074);
        this.jdField_a_of_type_Bhgj.a(0, 0, null);
        this.jdField_a_of_type_Bhgj.a(2131693635, new atxm(this));
      ...
      if (this.jdField_a_of_type_Atuw != null) {
        this.jdField_a_of_type_Atuw.a(false);
      }
      if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityMPFileVerifyPwdView == null) {
        o();
      }
  ...
  {
    q();
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityMPFileVerifyPwdView = new MPFileVerifyPwdView(this.jdField_a_of_type_Atuw.getActivity(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityMPFileVerifyPwdView.a(this.jdField_a_of_type_Atuw.a(), new atxl(this));
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityMPFileVerifyPwdView.b();
    this.jdField_a_of_type_Atuw.a().setVisibility(0);
    this.jdField_a_of_type_Atuw.a().removeAllViews();
    this.jdField_a_of_type_Atuw.a().addView(this.jdField_b_of_type_AndroidViewView);
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, -1);
  ...
  public void p()
  {
    if (this.jdField_b_of_type_AndroidViewView != null)
    {
      ...
      this.jdField_a_of_type_Atuw.a().removeView(this.jdField_b_of_type_AndroidViewView);
    }
    if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityMPFileVerifyPwdView != null)
    {
  ...
  protected void q()
  {
    if (this.jdField_a_of_type_AndroidViewView != null)
    {
      ...
      this.jdField_a_of_type_Atuw.a().removeView(this.jdField_a_of_type_AndroidViewView);
    }
  ...
  public void r()
  {
    ...
    Object localObject = (InputMethodManager)this.jdField_a_of_type_Atuw.a().getContext().getSystemService("input_method");
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityMPFileVerifyPwdView != null) && (bool))
    {
      ...
      ((InputMethodManager)localObject).hideSoftInputFromWindow(this.jdField_a_of_type_Atuw.a().getWindowToken(), 0);
    }
    if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityMPFileVerifyPwdView != null) {
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityMPFileVerifyPwdView.c();
    }
  ...
  protected void u()
  {
    ...
    if (!this.jdField_a_of_type_Boolean) {
      if (localansr.a().a())
      {
        this.jdField_c_of_type_Long = localansr.a().a(1);
    ...
    do
    {
      ...
      {
        return;
        this.jdField_c_of_type_Long = localansr.a().a(2);
        break;
        QLog.d("MPcFileModel<FileAssistant>", 2, "CLOUD_TYPE_DATALINEMPFILE doDownload,mEntity.uniseq:" + localFileManagerEntity.uniseq + ",mEntity.peerDin:" + localFileManagerEntity.peerDin + ",mEntity.strDataLineMPFileID:" + localFileManagerEntity.strDataLineMPFileID + " ,mEntity.fileName:" + localFileManagerEntity.fileName + ",mEntity.fileSize:" + localFileManagerEntity.fileSize);
        this.jdField_a_of_type_Long = NetConnInfoCenter.getServerTimeMillis();
        this.jdField_b_of_type_Boolean = true;
        l = localansr.a().a(localFileManagerEntity.uniseq, localFileManagerEntity.peerDin, localFileManagerEntity.strDataLineMPFileID, localFileManagerEntity.fileName, localFileManagerEntity.fileSize);
        if (l != -1L) {
          break label299;
        }
        if (QLog.isColorLevel()) {
        ...
        audr.a(2131693648);
      } while (this.jdField_a_of_type_Atxg == null);
  ...
  protected void v()
  {
    ...
    ansr localansr = (ansr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.DATALINE_HANDLER);
    FileManagerEntity localFileManagerEntity = this.jdField_a_of_type_Atuz.a();
    localansr.a().a(localFileManagerEntity.strDataLineMPFileID);
