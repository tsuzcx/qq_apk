...
public class mtg
{
  private static BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new mth();
  static String jdField_a_of_type_JavaLangString = "actAVGSensorCaseReport";
  int jdField_a_of_type_Int = 0;
  private long jdField_a_of_type_Long;
  ArrayList<mti> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  mti jdField_a_of_type_Mti = null;
  ...
  private void a(int paramInt, ArrayList<mti> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          mti localmti = (mti)paramArrayList.next();
          JSONObject localJSONObject = new JSONObject();
          localJSONObject.put("i", localmti.jdField_a_of_type_Int);
          localJSONObject.put("off", localmti.jdField_a_of_type_Long);
          localJSONObject.put("on", localmti.jdField_b_of_type_Long);
          localJSONObject.put("why", localmti.jdField_c_of_type_Long);
      ...
      catch (JSONException paramArrayList)
      {
        ...
        for (localObject1 = "JSONException. ";; localObject1 = ((JSONObject)localObject1).toString())
        {
          ...
          this.jdField_a_of_type_Mti = null;
          if (paramInt == 1) {
            break;
          }
  ...
  void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, int paramInt, boolean paramBoolean4, VideoController paramVideoController)
  {
    ...
    long l = System.currentTimeMillis();
    paramVideoController = this.jdField_a_of_type_Mti;
    this.jdField_a_of_type_Mti = null;
    if (paramVideoController != null)
    {
  ...
  void c()
  {
    this.jdField_a_of_type_Mti = new mti(this);
    this.jdField_a_of_type_Mti.jdField_a_of_type_Int = this.h;
    this.h += 1;
    this.jdField_a_of_type_Mti.jdField_a_of_type_Long = System.currentTimeMillis();
    this.jdField_a_of_type_JavaUtilArrayList.add(this.jdField_a_of_type_Mti);
  }
