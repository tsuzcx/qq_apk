  ...
  extends alsi
{
  ...
  private void c(int paramInt)
  {
    ...
    QQToast.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131719294), 0).b(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getTitleBarHeight());
  }
  ...
  protected void a(boolean paramBoolean, String paramString, long paramLong)
  {
    ...
    if (this.a.U)
    {
      ...
      agoj.a(this.a).removeMessages(39);
      agoj.b(this.a).sendMessage(paramString);
    }
    ThreadManagerV2.excute(new NearbyChatPie.11.1(this, paramBoolean, this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getIntent().getStringExtra("NEARBY_MSG_REPORT_SOURCE"), (auqc)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(106)), 16, null, false);
  }
