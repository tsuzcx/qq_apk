  ...
  implements View.OnClickListener
{
  ...
  public agol(PersonalityLabelGalleryActivity paramPersonalityLabelGalleryActivity, long paramLong)
  {
    this.jdField_a_of_type_Long = paramLong;
  }
  
  public agon a(ViewGroup paramViewGroup, int paramInt)
  {
    paramViewGroup = LayoutInflater.from(paramViewGroup.getContext()).inflate(2130970513, paramViewGroup, false);
    return new agon(this.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelPersonalityLabelGalleryActivity, paramViewGroup);
  }
  
  public void a(agon paramagon, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelPersonalityLabelGalleryActivity.a((agni)localObject1, (PersonalityLabelPhoto)localPersonalityLabelInfo.personalityLabelPhotos.get(paramInt), paramagon);
        paramagon.jdField_a_of_type_AndroidWidgetRelativeLayout.setTag(2131370959, localObject1);
        paramagon.jdField_a_of_type_AndroidWidgetRelativeLayout.setTag(Integer.valueOf(paramInt));
        paramagon.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this);
        return;
      }
      ...
      if ((((String)localObject2).startsWith("http")) || (((String)localObject2).startsWith("https")))
      {
        ...
        paramagon.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject2);
      }
      else
      {
        ...
        try
        {
          ...
          paramagon.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(URLDrawable.getDrawable((URL)localObject2, this.jdField_a_of_type_Int, this.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelPersonalityLabelGalleryActivity.jdField_a_of_type_AndroidGraphicsDrawableDrawable, this.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelPersonalityLabelGalleryActivity.jdField_a_of_type_AndroidGraphicsDrawableDrawable));
        }
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (paramView.getId() != 2131370959);
      localObject1 = paramView.getTag();
      localObject2 = paramView.getTag(2131370959);
      if ((localObject2 != null) && ((localObject2 instanceof agni)) && (((agni)localObject2).b == 3))
      {
        localObject1 = (agni)localObject2;
        ...
        this.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelPersonalityLabelGalleryActivity.jdField_a_of_type_ComTencentWidgetActionSheet.a(new agom(this, (agni)localObject1));
