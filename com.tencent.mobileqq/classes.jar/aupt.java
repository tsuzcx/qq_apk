...
public abstract class aupt
  implements DialogInterface.OnDismissListener, aupo, aupp, auqk
{
  ...
  antq jdField_a_of_type_Antq = new auqb(this);
  protected bisl a;
  ...
  private bisl jdField_c_of_type_Bisl;
  ...
  public aupt(Intent paramIntent)
  {
  ...
  private void I()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = bhdj.a(this.jdField_a_of_type_AndroidAppActivity, c(), this.jdField_a_of_type_AndroidOsBundle, this.jdField_a_of_type_AndroidAppActivity.getResources().getInteger(2131427338));
      this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setMessage("");
      this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setNegativeButton(2131690697, b());
      this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setPositiveButton(2131690786, a());
      this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.show();
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = bhdj.a(this.jdField_a_of_type_AndroidAppActivity, c(), a(), null, a(), b());
  }
  ...
  private void J()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = bhdj.a(this.jdField_a_of_type_AndroidAppActivity, c(), a(), d(), a(), b(), a(), b());
  }
  ...
  private void L()
  {
    ...
    if (this.jdField_a_of_type_Aatx == null) {
      this.jdField_a_of_type_Aatx = new aatx(this.jdField_a_of_type_AndroidAppActivity);
    }
    Object localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131718624);
    String str = this.jdField_a_of_type_AndroidOsBundle.getString("app_name");
    Object localObject1 = localObject2;
    if (str != null) {
      localObject1 = (String)localObject2 + str;
    }
    localObject2 = new aupu(this);
    this.jdField_a_of_type_Aatx.a((String)localObject1, (DialogInterface.OnClickListener)localObject2);
    this.jdField_a_of_type_Aatx.a((DialogInterface.OnClickListener)localObject2);
  ...
  private void N()
  {
    ...
    if (bool)
    {
      ...
      olh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", (String)localObject1, "0X8005A2C", "0X8005A2C", 0, 0, "", "", "", "", false);
    }
    int i;
    ...
    for (;;)
    {
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", (String)localObject1, (String)localObject1, 0, 0, "", "", "", "");
      if ((this.jdField_a_of_type_AndroidOsBundle != null) && (this.jdField_a_of_type_AndroidOsBundle.getBoolean("forward_report_confirm")))
      {
        ...
        bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", (String)localObject1, (String)localObject1, 0, 0, (String)localObject2, "", "", "");
      }
      if (this.jdField_c_of_type_Boolean) {
        bjgx.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "", String.valueOf(this.jdField_a_of_type_Long), "1000", "50", "0", false, this.jdField_c_of_type_Boolean);
      }
      ...
      if ((this.jdField_a_of_type_AndroidOsBundle != null) && (this.jdField_a_of_type_AndroidOsBundle.getBoolean("KEY_FROM_OCR", false))) {
        bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009C8E", "0X8009C8E", 0, 0, "", "", "", "");
      }
      if ((this.jdField_a_of_type_AndroidOsBundle != null) && (this.jdField_a_of_type_AndroidOsBundle.getBoolean("KEY_FROM_TRANSLATE", false))) {
        bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009C85", "0X8009C85", 0, 0, "", "", "", "");
      }
      return;
      label421:
      if (i == 1) {
  ...
  private void Q()
  {
    if (this.jdField_c_of_type_Bisl == null)
    {
      this.jdField_c_of_type_Bisl = new bisl(this.jdField_a_of_type_AndroidAppActivity, 0, 2131561307, 17);
      this.jdField_c_of_type_Bisl.setContentView(2131562799);
      this.jdField_c_of_type_Bisl.a("正在发送");
      this.jdField_c_of_type_Bisl.setCancelable(true);
    }
    if (this.jdField_c_of_type_Bisl.isShowing()) {
      this.jdField_c_of_type_Bisl.dismiss();
    }
    this.jdField_c_of_type_Bisl.show();
  }
  
  private void R()
  {
    if ((this.jdField_c_of_type_Bisl != null) && (this.jdField_c_of_type_Bisl.isShowing())) {
      this.jdField_c_of_type_Bisl.dismiss();
    }
  }
  ...
  private void a(Bundle paramBundle, int paramInt, String paramString)
  {
    ...
    {
      bdla.b(null, "dc00899", str, "", "video_tab", "videoark_share", 0, 0, paramString, paramBundle, "", "");
      return;
      paramBundle = l + "";
      break;
      bool = false;
  ...
  private void a(MessageForPic paramMessageForPic, String paramString)
  {
    ...
    for (Object localObject = Long.valueOf(paramMessageForPic.uniseq);; localObject = "")
    {
      ...
      if (paramMessageForPic != null)
      {
        ...
        localObject = new Bundle();
        ((Bundle)localObject).putBoolean("extra.EXTRA_NOT_CLEAR_TOP", true);
        a((Bundle)localObject, paramString, ahsl.a(paramMessageForPic));
        F();
      }
      return;
    }
  ...
  private void a(MessageForPic paramMessageForPic, String paramString, auqh paramauqh)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ForwardOption.ForwardBaseOption", 2, "getImageEditListener from MessageForPic");
    }
    paramauqh = new File(paramMessageForPic.path);
    if ((paramauqh != null) && (paramauqh.exists()) && (paramauqh.length() == paramMessageForPic.size)) {}
  ...
  private void a(String paramString, int paramInt)
  {
    if ((this.jdField_a_of_type_AndroidContentIntent != null) && (("ChatActivity".equals(this.jdField_a_of_type_AndroidContentIntent.getStringExtra("caller_name"))) || ("SplashActivity".equals(this.jdField_a_of_type_AndroidContentIntent.getStringExtra("caller_name"))))) {
      ahcj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt, this.jdField_a_of_type_AndroidContentIntent.getStringExtra("forward_photo_sender_uin"), this.jdField_a_of_type_AndroidContentIntent.getStringExtra("forward_photo_md5"), "0X8009F55", paramString);
    }
    ...
    ahcj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt, this.jdField_a_of_type_AndroidContentIntent.getStringExtra("forward_photo_sender_uin"), this.jdField_a_of_type_AndroidContentIntent.getStringExtra("forward_photo_md5"), "0X8009F56", paramString);
  }
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2, int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      bdla.b(null, "dc00899", str, "", "music_tab", "musicark_share", 0, 0, paramString, "", "", "");
      return;
      bool = false;
      break;
      str = "Grp_AIO";
  ...
  private void a(int[] paramArrayOfInt, String paramString, String[] paramArrayOfString1, String[] paramArrayOfString2, boolean[] paramArrayOfBoolean)
  {
    ...
    while (i < paramArrayOfBoolean.length)
    {
      if (paramArrayOfBoolean[i] != 0) {
        localbeno.b(paramArrayOfString1[i], paramArrayOfString2[i], paramArrayOfInt[i], paramString);
      }
      i += 1;
    }
    Q();
    paramArrayOfInt = new auqd(this, paramArrayOfBoolean, paramArrayOfString1, paramArrayOfString2, paramArrayOfInt, this.jdField_a_of_type_AndroidOsBundle.getInt("forward_write_together_number"));
  ...
  {
    return (paramRecentUser != null) && (!bhbx.a(paramRecentUser.uin)) && ((paramRecentUser.getType() != 1006) || (a(aupp.jdField_h_of_type_JavaLangInteger))) && (b(paramRecentUser)) && ((paramRecentUser.getType() != 1) || (!a(paramRecentUser.uin))) && ((paramRecentUser.getType() != 0) || (!nwu.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramRecentUser.uin, paramRecentUser.getType()))) && (((paramRecentUser.getType() != 1004) && (paramRecentUser.getType() != 1000)) || (this.jdField_b_of_type_Boolean));
  }
  ...
  private boolean b(String paramString)
  {
    ...
    if (((bgkf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.TROOP_GAG_MANAGER)).a(str, true).jdField_a_of_type_Boolean)
    {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131697134, 0).b(this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131299080));
      return false;
    }
  ...
  private void e()
  {
    ...
    try
    {
      ...
      if ((!TextUtils.isEmpty((CharSequence)localObject1)) && (!TextUtils.isEmpty(str)) && (!TextUtils.isEmpty((CharSequence)localObject2))) {
        apyp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject1, "AIOArkSdkSelectSend", 1, 0, 0L, 0L, 0L, str, "");
      }
      label160:
      this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setMessage("");
      this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setNegativeButton(2131690697, b());
      ...
      {
        return;
        this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = bhdj.a(this.jdField_a_of_type_AndroidAppActivity, c(), a(), null, a(), b(), this.jdField_a_of_type_AndroidAppActivity.getResources().getInteger(2131427338));
      ...
      ((QQCustomDialogWtihEmoticonInput)localObject1).getEditText().setHint(anvx.a(2131704208));
      return;
    }
    ...
    if (this.jdField_a_of_type_AndroidOsBundle != null)
    {
      ...
      if (bool)
      {
        ...
        if (paramInt == jdField_e_of_type_JavaLangInteger.intValue())
        {
          ...
          olh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", str1, "0X8005B07", "0X8005B07", paramInt, 0, str2, (String)localObject2, (String)localObject1, (String)localObject3, false);
        }
      }
    }
    for (;;)
    {
      if ((this.jdField_a_of_type_AndroidOsBundle != null) && (!bool))
      {
        ...
        if (localObject2 != null)
        {
          ...
          {
            localObject3 = bdof.a((byte[])localObject1);
            if (localObject3 != null)
            {
              str1 = this.jdField_a_of_type_AndroidOsBundle.getString("uin");
              localObject1 = str1;
              ...
              olh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", (String)localObject1, "0X8005B06", "0X8005B06", 0, 0, (String)localObject2, "" + ((AbsStructMsg)localObject3).msgId, "", "", false);
              olh.a("0X8005B06", (String)localObject1, (String)localObject2, "" + ((AbsStructMsg)localObject3).msgId, "", "");
            }
          }
        }
      }
      ...
      break label112;
      label371:
      olh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "", "0X80059DC", "0X80059DC", paramInt, 0, str1, (String)localObject2, (String)localObject1, (String)localObject3, false);
      continue;
      label405:
      break;
      bool = false;
  ...
  public void C()
  {
    ...
    bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A7EB", "0X800A7EB", i, 0, "", "", String.valueOf(j), str);
  }
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          m = a(str3, k);
          bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", str3, "0X800A7EC", "0X800A7EC", i, 0, str2, String.valueOf(m), String.valueOf(j), str1);
          if (QLog.isColorLevel()) {
      ...
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", (String)localObject, "0X800A7EC", "0X800A7EC", i, 0, str2, String.valueOf(m), String.valueOf(j), str1);
    } while (!QLog.isColorLevel());
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((this.jdField_b_of_type_JavaUtilArrayList != null) && (this.jdField_b_of_type_JavaUtilArrayList.size() > 0))
      {
        ...
        if (((Iterator)localObject2).hasNext())
        {
          ...
          {
            bdla.b(localQQAppInterface, "dc00898", "", str1, "0X800A7ED", "0X800A7ED", j, 0, (String)localObject1, String.valueOf(i), String.valueOf(k), str2);
            if (QLog.isColorLevel()) {
            ...
            localObject1 = str1;
            break label229;
            if (!(this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog instanceof aurs)) {
              break;
            }
            localObject1 = ((aurs)this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog).getInputValue();
            break;
          }
        }
      }
      else
      {
        ...
        localObject1 = "1";
        bdla.b((QQAppInterface)localObject2, "dc00898", "", str1, "0X800A7ED", "0X800A7ED", j, 0, (String)localObject1, String.valueOf(i), String.valueOf(k), str2);
        if (QLog.isColorLevel()) {
  ...
  public void F()
  {
    bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009BE9", "0X8009BE9", this.jdField_b_of_type_Int, 0, "", "", "", "");
  }
  
  public void G()
  {
    bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009BEA", "0X8009BEA", this.jdField_b_of_type_Int, 0, "", "", "", "");
    E();
  }
  ...
  public void H()
  {
    ...
    do
    {
      ...
      bdla.b(null, "dc00898", "", "", "0X800A427", "0X800A427", 0, 0, "", ForwardUtils.toTypeSimple(i), str1, str2);
    } while (!QLog.isColorLevel());
  ...
  public float a(float paramFloat)
  {
    ...
    int i = this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131296897);
    float f1 = paramFloat;
    if (i > f2 * paramFloat)
    {
  ...
  protected final DialogInterface.OnClickListener a()
  {
    if (this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener == null) {
      this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener = new auqc(this);
    }
  ...
  protected View.OnClickListener a(auqh paramauqh)
  {
    String str = this.jdField_a_of_type_AndroidOsBundle.getString("uin");
    if (this.jdField_a_of_type_AndroidViewView$OnClickListener == null) {
      this.jdField_a_of_type_AndroidViewView$OnClickListener = new auqg(this, str, paramauqh);
    }
  ...
  public List<RecentUser> a(List<RecentUser> paramList)
  {
    ...
    if ((bool) && (this.jdField_c_of_type_Int == 2))
    {
      ...
      localRecentUser.displayName = anvx.a(2131694211);
  ...
  public void a(int paramInt)
  {
    if (this.jdField_b_of_type_Bisl == null) {
      this.jdField_b_of_type_Bisl = new bisl(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131299080));
    }
  ...
  public void a(Drawable paramDrawable, boolean paramBoolean)
  {
    ...
    paramDrawable.setBounds(bheg.a(paramDrawable, 36, 100, this.jdField_a_of_type_Float));
  }
  ...
  {
    blvp.a(this.jdField_a_of_type_AndroidAppActivity, paramBundle, paramAIOImageProviderService, paramAIORichMediaData, 19001, 4);
  }
  ...
  protected void a(Bundle paramBundle, String paramString, df paramdf)
  {
    ...
    for (;;)
    {
      if (!TextUtils.isEmpty(paramBundle))
      {
        ...
        int i = localansr.a().b(paramString, localBundle, paramdf);
        if (QLog.isColorLevel()) {
      ...
      return;
      if ((this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog instanceof aurs)) {
        paramBundle = ((aurs)this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog).getInputValue();
      }
    }
  }
  ...
  public void a(String paramString1, String paramString2, Bundle paramBundle)
  {
    ...
    localBundle.putString("uinname", anvx.a(2131704213) + paramString2);
    a(aupp.jdField_d_of_type_JavaLangInteger.intValue(), localBundle);
  }
  ...
  public boolean a(int paramInt1, String paramString, int paramInt2)
  {
    ...
    if (paramInt1 == 1) {
      if (((bgkf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.TROOP_GAG_MANAGER)).a(paramString, true).jdField_a_of_type_Boolean)
      {
        bool1 = false;
        bool2 = bool1;
        if (bool1)
  ...
  protected boolean a(Intent paramIntent)
  {
    ...
    if (!bool2)
    {
      ...
      {
        bool1 = bool2;
        if (str.equals(this.jdField_a_of_type_AndroidAppActivity.getString(2131692148))) {
          bool1 = true;
        }
      }
    }
    if (bool1)
    {
      ...
      this.jdField_a_of_type_AndroidOsBundle.putString("leftBackText", this.jdField_a_of_type_AndroidAppActivity.getString(2131719161));
  ...
  protected final DialogInterface.OnClickListener b()
  {
    if (this.jdField_b_of_type_AndroidContentDialogInterface$OnClickListener == null) {
      this.jdField_b_of_type_AndroidContentDialogInterface$OnClickListener = new auqe(this);
    }
  ...
  public void b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("sendMultiple", false))
      {
        ...
        paramInt = localansr.a().a(str, localBundle, localaupy);
      ...
      for (;;)
      {
        ...
        b(localIntent);
        localBundle.putAll(localIntent.getExtras());
        paramInt = localansr.a().b(str, localBundle, localaupy);
        a(localBundle, str, null);
        break label258;
        label360:
        break;
  ...
  public void b(Bundle paramBundle)
  {
    ...
    if (paramBundle != null) {
      a(paramBundle.getInt("key_forward_ability_type", aupp.a.intValue()), paramBundle);
    }
  }
  ...
  protected boolean b(String paramString1, String paramString2, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (!(this instanceof ForwardShareCardOption)) {
        agfe.a().a((SessionInfo)localObject, str, i);
      }
      return true;
      if (!(this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog instanceof aurs)) {
        break;
      }
      str = ((aurs)this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog).getInputValue();
      break;
      label241:
  ...
  protected final DialogInterface.OnClickListener c()
  {
    if (this.jdField_c_of_type_AndroidContentDialogInterface$OnClickListener == null) {
      this.jdField_c_of_type_AndroidContentDialogInterface$OnClickListener = new auqf(this);
    }
  ...
  public void c()
  {
    bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005A0F", "0X8005A0F", 0, 0, "0", "", "", "");
  }
  ...
  protected void c(int paramInt)
  {
    ...
    if (paramInt == k.intValue())
    {
      ...
      {
        this.jdField_a_of_type_AndroidOsBundle.putString("leftBackText", anvx.a(2131704206));
  ...
  protected void c(String paramString)
  {
    ...
    Object localObject2 = ((abgm)localObject1).a(Long.parseLong(paramString));
    ((abgm)localObject1).a(this.jdField_a_of_type_AndroidAppActivity, (DeviceInfo)localObject2, false);
  ...
  protected String d()
  {
    ...
    if (a(i)) {
      return anvx.a(2131704210);
    }
    if ((j == jdField_f_of_type_JavaLangInteger.intValue()) || (j == k.intValue())) {
      return anvx.a(2131704215);
    }
    return "";
  }
  ...
  protected void d(int paramInt)
  {
    ...
    z();
    auqa localauqa = new auqa(this);
    if (this.jdField_a_of_type_Aaua == null) {
      this.jdField_a_of_type_Aaua = new aaua(this.jdField_a_of_type_AndroidAppActivity);
    }
    for (;;)
    {
      String str = this.jdField_a_of_type_AndroidAppActivity.getString(2131690676);
      ...
      this.jdField_a_of_type_Aaua.a((String)localObject, localauqa);
      this.jdField_a_of_type_Aaua.a(2131692052);
      localObject = this.jdField_a_of_type_Aaua;
      boolean bool;
      if (paramInt == 0)
      {
        bool = true;
        ((aaua)localObject).a(bool);
        this.jdField_a_of_type_Aaua.a(2131718787);
        this.jdField_a_of_type_Aaua.b(0);
        this.jdField_a_of_type_Aaua.c(2131718788);
        this.jdField_a_of_type_Aaua.b(this.jdField_a_of_type_AndroidAppActivity.getString(2131694451), localauqa);
      }
      try
      {
        this.jdField_a_of_type_Aaua.show();
        return;
  ...
  public void d(String paramString)
  {
    ...
    do
    {
      ...
      bdla.b(null, "dc00898", "", "", "0X800A631", "0X800A631", 0, 0, paramString, ForwardUtils.toTypeSimple(i), str, String.valueOf(this.jdField_a_of_type_Long));
    } while (!QLog.isColorLevel());
  ...
  public void f()
  {
    if ((this.jdField_a_of_type_AndroidOsBundle != null) && (this.jdField_a_of_type_AndroidOsBundle.getBoolean("k_forward_show_direct_share_tips", false))) {
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A220", "0X800A220", 0, 0, "0", "", "", "");
    }
    D();
  }
  ...
  void h()
  {
    if (jdField_a_of_type_Int <= 0)
    {
      ...
      int i = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131297430);
      int j = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131297432);
  ...
  public final void m()
  {
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = bhdj.a(this.jdField_a_of_type_AndroidAppActivity, c(), a(), null, a(), b(), this.jdField_a_of_type_AndroidAppActivity.getResources().getInteger(2131427338), false);
      }
      else
      {
        Object localObject2;
        if (i == 4)
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = bhdj.a(this.jdField_a_of_type_AndroidAppActivity, c(), (String)localObject1, (String)localObject2, localArrayList, null, a(), b(), this.jdField_a_of_type_AndroidAppActivity.getResources().getInteger(2131427338), false);
        }
        else if (i == 5)
        {
          i = this.jdField_a_of_type_AndroidOsBundle.getInt("key_hiboom_id");
          this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = bhdj.a(this.jdField_a_of_type_AndroidAppActivity, c(), "", null, a(), b(), this.jdField_a_of_type_AndroidAppActivity.getResources().getInteger(2131427338), false);
          localObject1 = new HiBoomTextView(this.jdField_a_of_type_AndroidAppActivity);
          ((HiBoomTextView)localObject1).setHiBoom(i, 0, avkh.jdField_a_of_type_Avka);
          ((HiBoomTextView)localObject1).setText(this.jdField_a_of_type_JavaLangString);
          ((HiBoomTextView)localObject1).setMaxSize(avkh.jdField_a_of_type_Int);
  ...
  protected boolean o()
  {
    ...
    if (localObject != null)
    {
      localObject = ((antp)localObject).a();
  ...
  protected boolean q()
  {
    ...
    if (localObject != null)
    {
      localObject = ((anvk)localObject).e();
      if (localObject != null)
      {
  ...
  protected void r()
  {
    ...
    for (;;)
    {
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8009AAE", "0X8009AAE", i, 0, "", "", "", "");
      return;
      label82:
      if (j == 1) {
        i = 2;
  ...
  protected boolean r()
  {
    ...
    do
    {
      ...
      {
        bool1 = bool2;
        if (((abgm)localObject).a())
        {
          localObject = ((abgm)localObject).a();
          bool1 = bool2;
          if (localObject != null)
          {
            bool1 = bool2;
  ...
  protected void s()
  {
    ...
    if (this.jdField_a_of_type_AndroidOsBundle.getBoolean("avgame_share_callback_key", false)) {
      aojq.a().a(this.jdField_a_of_type_AndroidAppActivity, false);
    }
    if (QLog.isColorLevel()) {
  ...
  protected void u()
  {
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setImageOnClickListener(a(new aupw(this)));
  }
  
  protected void v()
  {
    aurs localaurs = new aurs(this.jdField_a_of_type_AndroidAppActivity);
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = localaurs;
    if (!h()) {}
    for (boolean bool = true;; bool = false)
    {
      localaurs.a(bool);
      localaurs.c(210);
      localaurs.a(a());
      localaurs.setCanceledOnTouchOutside(false);
      localaurs.a(c(), d(), this.jdField_a_of_type_AndroidAppActivity.getResources().getString(a()), this.jdField_a_of_type_AndroidAppActivity.getResources().getString(b()), a(), b());
      localaurs.a(new aupx(this));
      a(localaurs);
      if (!this.jdField_a_of_type_AndroidAppActivity.isFinishing()) {
        localaurs.show();
      }
  ...
  protected void x()
  {
    ...
    bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004047", "0X8004047", 0, 0, "", "", "", "");
  }
