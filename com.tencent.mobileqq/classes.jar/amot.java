  ...
  extends BaseAdapter
{
  ...
  public amot(Context paramContext, JSONArray paramJSONArray, abdn paramabdn)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Abdn = paramabdn;
  ...
  public void c()
  {
    if (this.jdField_a_of_type_Boolean)
    {
      if (this.jdField_a_of_type_Abdn != null)
      {
        this.jdField_a_of_type_Abdn.a("com.tencent.biz.hotchatpostlist.widget.HotChatPostItemView");
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if ((paramView == null) && (this.jdField_a_of_type_Boolean)) {
      paramView = this.jdField_a_of_type_Abdn.a("com.tencent.biz.hotchatpostlist.widget.HotChatPostItemView");
    }
    Object localObject;
    for (;;)
    {
      ...
      if (paramView != null) {
        ((View)localObject).setOnClickListener(new amov(this, paramView.optString("bid"), paramView.optString("pid")));
      }
      try
      {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        abdn.a((View)localObject, paramView.toString());
  ...
  {
    Collections.sort(this.jdField_a_of_type_JavaUtilArrayList, new amou(this));
