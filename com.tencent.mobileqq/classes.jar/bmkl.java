  ...
  implements bmkk
{
  ...
  public static bmkk a(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("cooperation.qqdataline.ipc.IDatalineService");
    if ((localIInterface != null) && ((localIInterface instanceof bmkk))) {
      return (bmkk)localIInterface;
    }
    return new bmkm(paramIBinder);
  }
