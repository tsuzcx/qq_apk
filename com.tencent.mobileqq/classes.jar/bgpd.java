...
public class bgpd
{
  ...
  public bgpd(int paramInt)
  {
    this.a = new Intent();
    this.a.putExtra("nType", paramInt);
  }
  
  public bgpd(Intent paramIntent)
  {
    this.a = paramIntent;
  }
  
  public static bgpd a(float paramFloat1, float paramFloat2, String paramString1, String paramString2, String paramString3)
  {
    return new bgpd(7).b("sLocation", paramString2).b("sBrief", paramString3).b("sPublisher", paramString1).a("fLatitude", paramFloat1).a("fLongitude", paramFloat2);
  }
  
  public static bgpd a(int paramInt, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, byte[] paramArrayOfByte, boolean paramBoolean, long paramLong)
  {
    ...
    {
      paramArrayOfByte = bgpv.a(paramArrayOfByte);
      str6 = bgpv.a(paramArrayOfByte[0], paramString1);
      str5 = bgpv.a(paramArrayOfByte[1], paramString2);
      str4 = bgpv.a(paramArrayOfByte[2], paramString3);
      str3 = bgpv.a(paramArrayOfByte[3], paramString4);
      str2 = bgpv.a(paramArrayOfByte[4], paramString5);
      str1 = bgpv.a(paramArrayOfByte[5], paramString6);
    }
    paramString1 = new bgpd(6).a("nLinkType", paramInt).b("sTitle", str6).b("sUrl", str5).a("bAppShare", paramBoolean).a("lAppId", paramLong).b("sPublisher", str4).b("sBrief", str3).b("sPath", str2).b("sResUrl", str1);
    if (paramBoolean) {}
  ...
  public static bgpd a(Intent paramIntent)
  {
    int i = 1;
    if (paramIntent == null) {
      return null;
    ...
    for (i = (int)new File((String)localObject).length();; i = paramIntent.getIntExtra("file_thumb_Size", 0))
    {
      ...
      localObject = new bgpd(5);
      ((bgpd)localObject).a.putExtra("shortVideoContents", localContentValues);
      return ((bgpd)localObject).c(paramIntent.getStringExtra("from_uin"));
      i = j;
      break;
      l = 0L;
      break label132;
  ...
  public static bgpd a(aukm paramaukm)
  {
    return new bgpd(2).c(paramaukm);
  }
  
  public static bgpd a(QQAppInterface paramQQAppInterface, MessageForStructing paramMessageForStructing, List<ChatMessage> paramList, Map<String, String> paramMap)
  {
    if ((paramMessageForStructing == null) || (paramMessageForStructing.structingMsg == null)) {
      return null;
    }
    bgpd localbgpd = new bgpd(8).c(paramMessageForStructing);
    if (!bgpv.a(paramMessageForStructing))
    {
      localbgpd.c(paramMessageForStructing);
      return localbgpd;
    }
    ArrayList localArrayList = new ArrayList();
    byte[] arrayOfByte = bgpv.a(paramMessageForStructing.uniseq, paramMessageForStructing.structingMsg);
    if (arrayOfByte != null) {
    ...
    {
      arrayOfByte = bgpv.a(paramMessageForStructing.uniseq, l);
      if (arrayOfByte != null) {
        localArrayList.add(arrayOfByte);
      }
      arrayOfByte = bgpv.a(-1L, paramMap);
      if (arrayOfByte != null) {
        localArrayList.add(arrayOfByte);
      }
      bgpv.a(paramQQAppInterface, paramMessageForStructing, paramList, paramMap, localArrayList);
      if (localArrayList != null) {
        localbgpd.b("sBizDataList", localArrayList);
      }
      return localbgpd;
    }
  }
  
  public static bgpd a(MessageForShortVideo paramMessageForShortVideo)
  {
    ContentValues localContentValues = new ContentValues();
    ...
    for (long l1 = new File(str).length();; l1 = paramMessageForShortVideo.thumbFileSize)
    {
      ...
      paramMessageForShortVideo = new bgpd(5);
  ...
  public static bgpd a(String paramString)
  {
    return new bgpd(6).b("sUrl", paramString);
  }
  
  public static bgpd a(String paramString1, int paramInt, String paramString2)
  {
    return new bgpd(4).b("sPath", paramString1).a("nDuration", paramInt).b("sBrief", paramString2);
  }
  
  public static bgpd a(String paramString1, int paramInt, String paramString2, long paramLong1, String paramString3, long paramLong2)
  {
    paramInt = bgpv.b(paramInt);
    ...
    for (;;)
    {
      ...
      return new bgpd(2).b("sMD5", paramString1).b("sPath", paramString3).a("nPicType", paramInt).b("sPicId", paramString2).a("lSize", paramLong2);
    }
  }
  
  public static bgpd a(String paramString1, String paramString2)
  {
    return new bgpd(1).b("sText", paramString2).b("sTitle", paramString1);
  }
  
  public static bgpd a(ArrayList<String> paramArrayList, boolean paramBoolean1, String paramString1, String paramString2, boolean paramBoolean2, long paramLong, String paramString3)
  {
    paramArrayList = new bgpd(8).a("sPathList", paramArrayList).b("sTitle", paramString1).a("bOnlyPic", paramBoolean1).b("sText", paramString2).a("bAppShare", paramBoolean2).a("lAppId", paramLong).b("sAppName", paramString3);
    if (paramBoolean2) {}
    for (paramLong = 4L;; paramLong = 1L) {
  ...
  public static void a(Activity paramActivity, Intent paramIntent)
  {
    ...
    {
      bgpf.a(paramActivity, str, bool, null, false);
      return;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, ChatMessage paramChatMessage)
  {
    ...
    {
      return;
      localObject2 = (MessageForArkApp)alsx.a(1, ((MessageForArkApp)localObject1).ark_app_message.appName, localObject1, localObject1);
      ...
      try
      {
        ...
        if (ampv.c.equals(((MessageForArkApp)localObject1).ark_app_message.appName))
        {
          ...
          bgpr.a(paramQQAppInterface, 11, 0, paramChatMessage.istroop);
          return;
        }
      }
    ...
    {
      localObject3 = paramContext.getString(2131719068);
    ...
    for (i = 4;; i = 5)
    {
      ...
      bgpr.a(paramQQAppInterface, 9, 0, paramChatMessage.istroop);
      return;
      bgpr.a(paramQQAppInterface, 8, 0, paramChatMessage.istroop);
      return;
      break label50;
      break;
      i = 1;
  ...
  public static bgpd b(aukm paramaukm)
  {
    return new bgpd(8).c(paramaukm);
  }
  
  public static bgpd b(String paramString)
  {
    return new bgpd(2).b("sPath", paramString);
  }
  ...
  public bgpd a(int paramInt, long paramLong1, String paramString1, long paramLong2, String paramString2)
  {
  ...
  public bgpd a(long paramLong)
  {
    return a("requestId", paramLong);
  }
  
  public bgpd a(long paramLong, String paramString)
  {
    this.a.putExtra("nAuthorType", 1).putExtra("lUin", paramLong).putExtra("sName", paramString);
    return this;
  }
  
  public bgpd a(QQAppInterface paramQQAppInterface)
  {
  ...
  public bgpd a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
  ...
  public bgpd a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    if (paramQQAppInterface == null) {
      return this;
    }
    int i = bgpv.a(paramInt2);
    String str2 = "";
    long l6 = 0L;
    Object localObject4 = "";
    long l5 = 0L;
    ...
    if (TextUtils.isEmpty(paramString1))
    {
      ...
      for (;;)
      {
        try
        {
          ...
          if (paramMessageRecord != null)
          {
            ...
            if (mye.a(paramMessageRecord))
            {
              ...
              else
              {
                ...
                paramString1 = (String)localObject1;
                l3 = l1;
                localObject4 = BaseApplicationImpl.getContext().getString(2131690052);
              }
            }
          }
          l4 = l2;
          ...
          l3 = l1;
          localObject1 = bajb.a(paramMessageRecord);
          ...
          paramString1 = (String)localObject4;
          l3 = l1;
          paramMessageRecord = ((bajc)localObject1).c;
        }
        ...
        paramString1 = paramMessageRecord;
        l3 = l1;
        localObject3 = bbcl.a(paramQQAppInterface, (String)localObject1, true);
        l4 = l2;
        localObject2 = localObject3;
        paramString1 = paramMessageRecord;
        l3 = l1;
        ...
        try
        {
          localObject1 = bbcl.c(paramQQAppInterface, paramString2);
          paramString1 = (String)localObject1;
        ...
        if (str1 != null)
        {
          ...
          paramString1 = str2;
          l3 = l6;
          localObject1 = bbcl.b(paramQQAppInterface, str1, paramInt2);
          l1 = 0L;
          l2 = l5;
          localObject3 = localObject4;
          continue;
          ...
          paramString1 = str2;
          l3 = l6;
          localObject1 = bbcl.b(paramQQAppInterface, paramString2, paramInt2);
          l4 = l5;
          localObject2 = localObject4;
          paramString1 = (String)localObject1;
          l3 = l6;
    ...
    for (;;)
    {
      ...
      paramString1 = str2;
      l3 = l6;
      localObject3 = bbcl.b(paramQQAppInterface, str1, 0);
      ...
      if (((String)localObject3).equals(str1))
      {
        ...
        if (paramInt2 == 3000)
        {
          ...
          paramString1 = (String)localObject3;
          l3 = l6;
          localObject1 = bbcl.a(paramQQAppInterface, paramString2, str1);
        }
      }
      l4 = l5;
      localObject2 = localObject4;
      ...
      for (localObject3 = bbcl.a(paramQQAppInterface, paramString2, true);; localObject3 = bbcl.c(paramQQAppInterface, paramString2))
      {
        l4 = l5;
        localObject2 = localObject3;
        paramString1 = (String)localObject1;
  ...
  public bgpd a(String paramString, float paramFloat)
  {
    this.a.putExtra(paramString, paramFloat);
    return this;
  }
  
  public bgpd a(String paramString, int paramInt)
  {
    this.a.putExtra(paramString, paramInt);
    return this;
  }
  
  public bgpd a(String paramString, long paramLong)
  {
    this.a.putExtra(paramString, paramLong);
    return this;
  }
  
  public bgpd a(String paramString, ArrayList<String> paramArrayList)
  {
    this.a.putStringArrayListExtra(paramString, paramArrayList);
    return this;
  }
  
  public bgpd a(String paramString, boolean paramBoolean)
  {
  ...
  {
    return a(paramActivity, paramString, 2131692325, null);
  }
  ...
  public boolean a(Activity paramActivity, String paramString, int paramInt, bgpe parambgpe)
  {
    ...
    if (!bool)
    {
      ...
      if (this.a != null) {
        localObject1 = paramActivity.getString(this.a.getIntExtra("nReasonInt", 2131692326));
      }
    }
    bgpf.a(paramActivity, paramString, bool, (String)localObject1, false, paramInt);
    if (parambgpe != null) {
      parambgpe.b(bool);
    }
    return bool;
  ...
  {
    bgps.a().a = true;
    String str = apvb.a(paramFileManagerEntity.fileName);
    int m = 6;
    ...
    {
      if (!paramBoolean) {
        bgpv.a(paramActivity, 2131692328, 1);
      }
      bgpr.a(paramQQAppInterface, "User_AddFav", 6, -80010, m, i, str, null);
      paramQQAppInterface = new ContentValues();
      paramQQAppInterface.put("errorMsg", BaseApplicationImpl.getContext().getResources().getString(2131692342));
    ...
    int i1 = apue.a(paramFileManagerEntity);
    switch (i1)
    {
    case 3: 
    default: 
      if (!paramBoolean) {
        bgpv.a(paramActivity, 2131692329, 0);
      }
      bgpr.a(paramQQAppInterface, "User_AddFav", 6, -80003, m, i, str, null);
      paramQQAppInterface = new ContentValues();
      paramQQAppInterface.put("errorMsg", BaseApplicationImpl.getContext().getResources().getString(2131692344));
      this.a.putExtra("fileContents", paramQQAppInterface);
      return false;
    case 1: 
      ...
      {
        if (!paramBoolean) {
          bgpv.a(paramActivity, 2131692327, 1);
        }
        bgpr.a(paramQQAppInterface, "User_AddFav", 6, -80011, m, i, str, null);
        paramQQAppInterface = new ContentValues();
        paramQQAppInterface.put("errorMsg", BaseApplicationImpl.getContext().getResources().getString(2131692341));
        this.a.putExtra("fileContents", paramQQAppInterface);
        return false;
      }
      break;
    ...
    case 3: 
      ...
      ((ContentValues)localObject2).put("fileCloudType", Integer.valueOf(i1));
      ...
      if (!paramBoolean)
      {
        ...
        paramQQAppInterface.runOnUiThread(new QfavBuilder.1(this, paramActivity, paramQQAppInterface, paramBoolean, (String)localObject1));
        label792:
        if (paramChatMessage != null) {
          bgpr.a(paramQQAppInterface, 5, paramFileManagerEntity.nFileType, paramChatMessage.istroop);
        }
        bgpr.a(paramQQAppInterface, "User_AddFav", 6, 0, m, i, str, null);
        return paramBoolean;
        localObject1 = paramFileManagerEntity.selfUin;
        localObject2 = paramFileManagerEntity.peerUin;
  ...
  public bgpd b(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
  ...
  public bgpd b(String paramString1, String paramString2)
  {
    this.a.putExtra(paramString1, paramString2);
    return this;
  }
  
  public bgpd b(String paramString, ArrayList<byte[]> paramArrayList)
  {
  ...
  public boolean b(Activity paramActivity, String paramString, int paramInt, Intent paramIntent)
  {
    ...
    } while ((paramIntent.getIntExtra("nPicType", 1) != 1) || (!bgpv.a(str, paramIntent.getLongExtra("lSize", -1L))));
    paramIntent.putExtra("nReasonInt", 2131695191);
    if (QLog.isColorLevel()) {
      QLog.i("qqfav", 1, "QfavBuilder.add: picture too big [" + str + "]");
    }
    bgpr.a(null, "Net_AddFav", 3, 3, -3);
    return false;
  }
  
  public bgpd c(aukm paramaukm)
  {
    this.a.putExtra("cvEntityContents", bgpv.a(paramaukm, ""));
    this.a.putExtra("sEntityClassName", paramaukm.getClass().getName());
    return this;
  }
  
  public bgpd c(String paramString)
  {
    try
    {
  ...
  public boolean c(Activity paramActivity, String paramString, int paramInt, Intent paramIntent)
  {
    ...
    bgpf.a(paramActivity, paramString, bool, "", false, 2131692325);
    return bool;
  }
}
