  ...
  extends blas
{
  ...
  public bgpd(String paramString1, View paramView, String paramString2)
  {
  ...
  protected ViewGroup.LayoutParams a(ViewGroup.LayoutParams paramLayoutParams, JSONObject paramJSONObject)
  {
    ...
    int i = UIUtils.dip2px(this.jdField_a_of_type_AndroidViewView.getContext(), paramJSONObject.optInt("lpd", 2) / 2);
    int j = UIUtils.dip2px(this.jdField_a_of_type_AndroidViewView.getContext(), paramJSONObject.optInt("rpd", 2) / 2);
