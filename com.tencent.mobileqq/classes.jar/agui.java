  ...
  extends agsj
{
  ...
  private agui(NewPhotoListActivity paramNewPhotoListActivity)
  {
  ...
  public static agsc b(NewPhotoListActivity paramNewPhotoListActivity)
  {
    ...
    {
      if ((jdField_a_of_type_Agsc == null) || (jdField_a_of_type_Agsc.jdField_a_of_type_MqqUtilWeakReference.get() != paramNewPhotoListActivity)) {
        jdField_a_of_type_Agsc = new agui(paramNewPhotoListActivity);
      }
  ...
  public void b(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    if ((paramView.fileSize > this.jdField_a_of_type_Agrz.jdField_b_of_type_Long) && (!this.jdField_a_of_type_Boolean))
    {
    ...
    if (!this.jdField_a_of_type_Agsb.m)
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        agmg.a(BaseApplicationImpl.getContext()).a(new aguj(this, paramAdapterView, (ArrayList)localObject1), paramView);
        return;
      }
