...
class bjbs
  implements abla
{
  bjbs(bjbr parambjbr, Activity paramActivity) {}
  ...
  public void onAdClicked(GdtAd paramGdtAd)
  {
    ...
    if ((paramGdtAd != null) && (paramGdtAd.getAd() != null) && (AdUtils.isHitReport50ViewAndOneSecond(paramGdtAd.getAd()))) {
      AdExposureChecker.onClick(this.jdField_a_of_type_AndroidAppActivity, paramGdtAd.getAd(), new WeakReference(this.jdField_a_of_type_Bjbr.jdField_a_of_type_ComTencentAdTangramUtilAdExposureChecker$ExposureCallback));
    }
    for (;;)
    {
      if (this.jdField_a_of_type_Bjbr.jdField_a_of_type_ComTencentQqminiSdkLauncherCoreProxyAdProxy$IBannerAdListener != null) {
        this.jdField_a_of_type_Bjbr.jdField_a_of_type_ComTencentQqminiSdkLauncherCoreProxyAdProxy$IBannerAdListener.onADClicked();
      }
      return;
  ...
  public void onAdClosed(GdtAd paramGdtAd)
  {
    ...
    if (this.jdField_a_of_type_Bjbr.jdField_a_of_type_ComTencentQqminiSdkLauncherCoreProxyAdProxy$IBannerAdListener != null) {
      this.jdField_a_of_type_Bjbr.jdField_a_of_type_ComTencentQqminiSdkLauncherCoreProxyAdProxy$IBannerAdListener.onADClosed();
    }
  }
