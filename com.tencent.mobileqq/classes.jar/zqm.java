...
public class zqm
{
  ...
  {
    zpr.a("1001" + paramString);
    zpr.a("1001" + paramString, new zxy(paramString));
  ...
  private static boolean a(Context paramContext, CertifiedAccountMeta.StFeed paramStFeed, ExtraTypeInfo paramExtraTypeInfo, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      if (i != 0)
      {
        zpr.a("1002" + paramStFeed.id.get());
        zpr.a("1002" + paramStFeed.id.get(), new zxw(paramStFeed));
      }
      if (bool2)
      {
        ...
        paramContext.startActivity(paramIntent, zyh.a());
