...
public class adbv
  implements adid, ark.RuntimeClassCallbackWrapper
{
  ...
  public adbv(QQAppInterface paramQQAppInterface, String paramString)
  {
  ...
  private boolean a(ark.VariantWrapper[] paramArrayOfVariantWrapper, ark.VariantWrapper paramVariantWrapper)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Addc = new adnx(localQQAppInterface, this.jdField_a_of_type_JavaLangString);
    } while (!this.jdField_a_of_type_Addc.a(paramArrayOfVariantWrapper));
  ...
  private void b()
  {
    if (this.jdField_a_of_type_Addc != null)
    {
      this.jdField_a_of_type_Addc.a(null);
      this.jdField_a_of_type_Addc.a();
      this.jdField_a_of_type_Addc = null;
    }
  }
  ...
  {
    if ((this.jdField_a_of_type_Addc == null) || (paramArrayOfVariantWrapper == null) || (paramArrayOfVariantWrapper.length < 2)) {}
    do
    {
      paramVariantWrapper.SetBool(false);
      return true;
    ...
    for (;;)
    {
      this.jdField_a_of_type_Addc.a(this);
      if (!this.jdField_a_of_type_Addc.b(paramArrayOfVariantWrapper)) {
        break;
      }
      paramVariantWrapper.SetBool(true);
      return true;
  ...
  private boolean f(ark.VariantWrapper[] paramArrayOfVariantWrapper, ark.VariantWrapper paramVariantWrapper)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        this.jdField_a_of_type_Addc.a(i);
        paramVariantWrapper.SetBool(true);
        return true;
  ...
  {
    boolean bool = false;
    if ((this.jdField_a_of_type_Addc == null) || (paramArrayOfVariantWrapper == null) || (paramArrayOfVariantWrapper.length < 1))
    {
      paramVariantWrapper.SetBool(false);
      return true;
    }
    if (this.jdField_a_of_type_Addc.a() == 0) {
      bool = true;
    }
        ...
        do
        {
          do
          {
            do
            {
              ...
              return true;
            } while (this.jdField_a_of_type_Addc.a() != 0);
            str = this.jdField_a_of_type_Addc.a();
          } while (str == null);
          paramArrayOfVariantWrapper = paramArrayOfVariantWrapper[1].GetString();
        } while (TextUtils.isEmpty(paramArrayOfVariantWrapper));
