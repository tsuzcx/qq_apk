...
public class aevk
{
  ...
  public static int a(@NonNull String paramString)
  {
    try
    {
      ...
      {
        jdField_a_of_type_Int = bbkb.b(paramString);
  ...
  @Nullable
  public static aevm a(String paramString)
  {
    return (aevm)bbcw.a("StickerBubbleGifCache_" + paramString);
  }
  
  public static aevp a(int paramInt1, String paramString, int paramInt2, int[] paramArrayOfInt)
  {
    ...
    {
      return new aevp(paramArrayOfInt, paramString, bool, new aevg(d1, d2), new aevf(0.0D, 200.0D), 49);
      d1 = -jdField_a_of_type_JavaUtilRandom.nextInt(8000) + 4000;
      break;
    }
  }
  
  public static aevp a(@NonNull Point paramPoint, @NonNull String paramString, int paramInt)
  {
    ...
    {
      return new aevp(paramPoint, paramString, bool, new aevg(d1, d2), new aevf(0.0D, 200.0D), 85);
  ...
  public static Drawable a(@NonNull String paramString)
  {
    try
    {
      if (((!paramString.equals(jdField_a_of_type_JavaLangString)) || (jdField_a_of_type_AndroidGraphicsDrawableDrawable == null)) && (a(paramString) > 0)) {
        jdField_a_of_type_AndroidGraphicsDrawableDrawable = aevj.a(a(paramString));
      }
  ...
  {
    int i = actj.a(8.0F, paramContext.getResources());
  ...
  public static void a(@NonNull aevi paramaevi, @NonNull String paramString)
  {
    try
    {
      jdField_a_of_type_Int = paramaevi.jdField_a_of_type_Int;
      jdField_a_of_type_AndroidGraphicsDrawableDrawable = aevj.a(jdField_a_of_type_Int);
      bbkb.b(paramaevi.jdField_a_of_type_Int, paramString);
      jdField_a_of_type_JavaLangString = paramString;
      return;
    }
    finally
  ...
  public static void a(String paramString, BitmapDrawable[] paramArrayOfBitmapDrawable, int paramInt)
  {
    if (a())
    {
      ...
      if (bbcw.a(str) == null) {
        bbcw.a(str, new aevm(paramString, paramArrayOfBitmapDrawable, paramInt));
      }
    }
  }
  ...
  public static int[] a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      paramQQAppInterface = adwj.a(paramQQAppInterface, 7);
  ...
  public static aevp b(@NonNull Point paramPoint, @NonNull String paramString, int paramInt)
  {
    boolean bool = a(paramInt);
    double d1;
    if (bool)
    ...
    for (double d2 = -1000 - jdField_a_of_type_JavaUtilRandom.nextInt(500);; d2 = -2000 - jdField_a_of_type_JavaUtilRandom.nextInt(1000))
    {
      return new aevp(paramPoint, paramString, bool, new aevg(d1, d2), new aevf(0.0D, 200.0D), 81);
      d1 = -jdField_a_of_type_JavaUtilRandom.nextInt(6000) + 3000;
      break;
    }
  }
  ...
  public static void b(Object paramObject, View paramView)
  {
    ...
    if (jdField_a_of_type_AndroidViewAnimationAnimation == null)
    {
      ...
      jdField_a_of_type_AndroidViewAnimationAnimation.setAnimationListener(new aevl());
    }
    if (QLog.isColorLevel()) {
