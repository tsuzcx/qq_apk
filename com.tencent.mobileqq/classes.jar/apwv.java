  ...
  extends alko
{
  ...
  public apwv(QQAppInterface paramQQAppInterface)
  {
  ...
  private Card a(String paramString1, String paramString2, String paramString3, int paramInt1, long paramLong, int paramInt2)
  {
    ...
    Card localCard = localaloz.c(paramString1);
  ...
  private void a(List<Long> paramList1, int paramInt1, int paramInt2, List<Long> paramList2)
  {
    ...
    for (;;)
    {
      ...
      if (localIterator.hasNext())
      {
        ...
        localObject3 = localayvc.c(String.valueOf(localLong), (String)localObject1);
        localObject2 = localObject3;
        if (localObject3 == null) {
          localObject2 = localayvc.a(String.valueOf(localLong), (String)localObject1, false);
        }
  ...
  private void a(oidb_0xe03.MatchUinData paramMatchUinData, apxk paramapxk)
  {
    int j = 0;
    if ((paramMatchUinData == null) || (paramapxk == null))
    {
    ...
    if (paramMatchUinData.uint32_age.has())
    {
      ...
      if (localObject1 != null) {
        paramapxk.i = RichStatus.parseStatus((byte[])localObject1).getPlainText();
      }
      if (!paramMatchUinData.uint32_sex.has()) {
        break label566;
      }
      paramapxk.jdField_a_of_type_Int = paramMatchUinData.uint32_sex.get();
      label316:
    ...
    {
      paramapxk.jdField_a_of_type_Long = l;
      ...
      while (i < paramMatchUinData.rpt_school_info.size())
      {
        ...
        {
          localObject2 = new apyn(((oidb_0xe03.schoolInfo)paramMatchUinData.rpt_school_info.get(i)).str_school_id.get(), ((oidb_0xe03.schoolInfo)paramMatchUinData.rpt_school_info.get(i)).str_school_name.get(), ((oidb_0xe03.schoolInfo)paramMatchUinData.rpt_school_info.get(i)).uint64_state.get());
          ((ArrayList)localObject1).add(localObject2);
          if (QLog.isColorLevel()) {
            QLog.d("ExtendFriendHandlerExtendFriendLimitChat", 2, "schoolInfo. " + ((apyn)localObject2).toString());
          }
        }
        i += 1;
      }
      ...
      localObject1 = null;
      break label278;
      paramapxk.jdField_a_of_type_Int = 0;
      QLog.e("ExtendFriendHandlerExtendFriendLimitChat", 2, "mGender  is null. set 0  ");
      break label316;
    }
    label590:
    paramapxk.jdField_b_of_type_JavaUtilArrayList = ((ArrayList)localObject1);
    ...
    if (paramMatchUinData.rpt_tag.has())
    {
      ...
      while (i < paramMatchUinData.rpt_tag.size())
      {
        if (((oidb_0xe03.ProfileTagInfo)paramMatchUinData.rpt_tag.get(i)).bytes_tag.has())
        {
          ...
          localapym.jdField_a_of_type_Int = j;
          localapym.jdField_a_of_type_JavaLangString = ((String)localObject2);
          ((ArrayList)localObject1).add(localapym);
        }
        i += 1;
      }
    }
    if (QLog.isColorLevel()) {
      QLog.d("ExtendFriendHandlerExtendFriendLimitChat", 2, "ChatFriendInfo. " + paramapxk.toString());
    }
    paramapxk.jdField_a_of_type_JavaUtilArrayList = ((ArrayList)localObject1);
  }
  ...
  private void h(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      paramFromServiceMsg = (apwx)this.mApp.getManager(264);
  ...
  private void j(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      paramObject = (apwx)this.mApp.getManager(264);
      if (paramObject != null) {
  ...
  public void a()
  {
    ...
    if (!atwl.a(this.app, "matchchat_redpoint_show")) {
      atwl.a(this.app, "matchchat_redpoint_show", true);
    }
    b();
  }
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    if ((paramMessageRecord != null) && ((paramMessageRecord instanceof MessageForLimitChatConfirm)))
    {
      ...
      {
        localObject1 = new apyd();
        ((apyd)localObject1).jdField_a_of_type_Boolean = paramMessageRecord.bEnterMsg;
        ((apyd)localObject1).jdField_a_of_type_Int = paramMessageRecord.leaveChatType;
        ((apyd)localObject1).jdField_a_of_type_Long = paramMessageRecord.timeStamp;
        ((apyd)localObject1).jdField_a_of_type_JavaLangString = paramMessageRecord.frienduin;
        ((apyd)localObject1).jdField_b_of_type_JavaLangString = paramMessageRecord.SenderNickName;
        ((apyd)localObject1).d = paramMessageRecord.c2cExpiredTime;
        ((apyd)localObject1).jdField_b_of_type_Int = paramMessageRecord.leftChatTime;
        ((apyd)localObject1).jdField_c_of_type_JavaLangString = paramMessageRecord.tipsWording;
        ((apyd)localObject1).jdField_c_of_type_Int = paramMessageRecord.matchExpiredTime;
        ((apyd)localObject1).jdField_b_of_type_Long = paramMessageRecord.readyTs;
        QLog.i("ExtendFriendHandlerExtendFriendLimitChat", 2, "HandleC2CConfirmOrCancelMsg  info：" + ((apyd)localObject1).toString());
        i = 1;
        j = i;
        if (!bdec.b(paramMessageRecord.issend)) {
  ...
  public void a(String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    {
      QQToast.a(this.app.getApp(), 1, 2131694764, 0).a();
    ...
    new bdwc("QC.UniBusinessLogicServer.UniBusinessLogicObj", "QCUniBusinessLogic.UniSetExtFriend").a("UniSetExtFriend", new UniSetExtFriendReq(bdwc.a(), new UniBusinessItem(304, paramInt4), new ExtendFriend(paramInt2)), new UniSetExtFriendRsp(), new apww(this, paramString1, paramInt4, paramInt2), true);
    try
    {
  ...
  public void a(String paramString1, byte[] paramArrayOfByte, int paramInt, String paramString2, long paramLong, String paramString3, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      localReqBody.bytes_req_buff.set(ByteStringMicro.copyFrom(bkbp.a().a()));
      ...
      if ((!TextUtils.isEmpty(paramString3)) && (paramString3.equals(paramString1)))
      {
        ...
        {
          paramInt = 1;
          azmj.b(paramString1, "dc00898", "", "", "0X8009423", "0X8009423", paramInt, 0, "", "", paramString2, "");
          return;
  ...
  public void a(submsgtype0x128.MsgBody paramMsgBody)
  {
    if (paramMsgBody != null)
    {
      ...
      localapyc.jdField_a_of_type_JavaLangString = this.app.c();
      localapyc.jdField_a_of_type_ArrayOfByte = paramMsgBody.bytes_sig.get().toByteArray();
      String str;
      label91:
      long l;
      label116:
      ...
      if (paramMsgBody.uint64_match_uin.has())
      {
        ...
        localapyc.jdField_b_of_type_Int = paramMsgBody.msg_tag.uint32_tag_id.get();
        ...
        localapyc.jdField_a_of_type_Apxk = new apxk();
        localapyc.jdField_a_of_type_Apxk.jdField_a_of_type_JavaLangString = localapyc.jdField_b_of_type_JavaLangString;
        a(paramMsgBody.msg_match_uin_data, localapyc.jdField_a_of_type_Apxk);
      }
      for (;;)
      {
        str = "";
        ...
        localapyc.e = paramMsgBody;
        if (QLog.isColorLevel()) {
          QLog.d("ExtendFriendHandlerExtendFriendLimitChat", 2, new Object[] { "handleGetUnlimitMatchOfflinePush push matchInfo = ", localapyc });
        }
        paramMsgBody = (aqbb)this.app.getManager(292);
        if (paramMsgBody != null) {
          paramMsgBody.a();
        }
        notifyUI(16, true, new Object[] { localapyc });
        return;
        str = "0";
        break;
        label426:
        ...
        break label241;
        label457:
        localapyc.jdField_b_of_type_Int = 1;
  ...
  public void b()
  {
    notifyUI(17, true, Integer.valueOf(atwl.a(this.app)));
  }
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          localapyo = new apyo();
          localapyo.mUin = String.valueOf(localStrangerInfo.uint64_uin.get());
          localapyo.mNickName = localStrangerInfo.bytes_nick.get().toStringUtf8();
          localapyo.mGender = localStrangerInfo.uint32_gender.get();
          if (localStrangerInfo.uint32_is_my_like.get() != 1) {
            break label1748;
          }
          bool4 = true;
          localapyo.mLiked = bool4;
          localapyo.mAvailLikeCount = localStrangerInfo.uint32_my_left_like_count.get();
          if (localStrangerInfo.uint32_addfri_status.get() != 1) {
            break label1754;
          }
          bool4 = true;
          localapyo.mAddFriendVerified = bool4;
          localapyo.mPopularity = localStrangerInfo.uint32_popularity.get();
          localapyo.mDeclaration = localStrangerInfo.bytes_declaration.get().toStringUtf8();
          localapyo.mVoiceUrl = localStrangerInfo.bytes_voice_url.get().toStringUtf8();
          localapyo.mVoiceDuration = localStrangerInfo.uint32_voice_duration.get();
          if (localStrangerInfo.uint32_vote_switch.get() != 0) {
            break label1760;
          }
          bool4 = true;
          localapyo.mbAllowStrangerVote = bool4;
          localapyo.mStrRecomTrace = localStrangerInfo.str_recom_trace.get();
          localapyo.voiceCode = localStrangerInfo.bytes_voice_code.get().toByteArray();
          ...
          localapyo.fontId = paramToServiceMsg.fontid.get();
          localapyo.fontType = paramToServiceMsg.fonttype.get();
          localapyo.clothesId = paramToServiceMsg.itemid.get();
          if (!TextUtils.isEmpty(localapyo.mDeclaration))
          {
            localapyo.mDeclaration = localapyo.mDeclaration.replace('\n', ' ');
            localapyo.mDeclaration = localapyo.mDeclaration.trim();
          }
          if (localStrangerInfo.uint32_show_vip_info_flag.get() != 0) {
            break label1766;
          }
          bool4 = true;
          localapyo.mVipHide = bool4;
        ...
        localapyo.mBigVipHide = bool4;
        localapyo.mBigVipLevel = localStrangerInfo.uint32_bigvip_level.get();
        localapyo.mVipType = localStrangerInfo.uint32_vip_flag.get();
        localapyo.mVipLevel = localStrangerInfo.uint32_svip_level.get();
        localapyo.mTemplateId = localStrangerInfo.uint32_vipicon_id.get();
        ...
        label670:
        localapyo.mAlumbasicdata = paramToServiceMsg;
        localapyo.mAge = localStrangerInfo.uint32_age.get();
        localapyo.mLabelInfos = new ArrayList();
        if (localStrangerInfo.rpt_label_info.has())
        {
          i = 0;
          if (i < localStrangerInfo.rpt_label_info.get().size())
          {
            localObject3 = new apyp();
            ((apyp)localObject3).jdField_a_of_type_Long = ((ExtendFriendSquareInfo.labelInfo)localStrangerInfo.rpt_label_info.get().get(i)).uint64_label_id.get();
            ...
            ((apyp)localObject3).jdField_a_of_type_JavaLangString = paramToServiceMsg;
            localapyo.mLabelInfos.add(localObject3);
            i += 1;
            continue;
          }
        }
        localapyo.mSchoolInfos = new ArrayList();
        if (localStrangerInfo.rpt_school_info.has())
        {
          i = 0;
          if (i < localStrangerInfo.rpt_school_info.get().size())
          {
            localObject3 = new apyq();
            ((apyq)localObject3).jdField_a_of_type_JavaLangString = ((ExtendFriendSquareInfo.schoolInfo)localStrangerInfo.rpt_school_info.get().get(i)).str_school_id.get();
            ((apyq)localObject3).jdField_a_of_type_Long = ((ExtendFriendSquareInfo.schoolInfo)localStrangerInfo.rpt_school_info.get().get(i)).uint64_state.get();
            ...
            ((apyq)localObject3).jdField_b_of_type_JavaLangString = paramToServiceMsg;
            if (QLog.isColorLevel()) {
              QLog.d("ExtendFriendHandler", 2, "handleGetSquareStrangerList: schoolId " + ((apyq)localObject3).jdField_a_of_type_JavaLangString + " schoolName " + ((apyq)localObject3).jdField_b_of_type_JavaLangString + " authState " + ((apyq)localObject3).jdField_a_of_type_Long);
            }
            localapyo.mSchoolInfos.add(localObject3);
            i += 1;
            continue;
          }
        }
        if (QLog.isColorLevel()) {
          QLog.d("ExtendFriendHandler", 2, "handleGetSquareStrangerList: " + localapyo.mUin + " " + localStrangerInfo.uint32_vip_flag.get() + " " + localStrangerInfo.uint32_svip_level.get());
        }
        if ((!TextUtils.isEmpty(localapyo.mNickName)) || (localapyo.mAlumbasicdata != null))
        {
          localArrayList.add(localapyo);
          continue;
          aqcx.a().c(paramFromServiceMsg.isSuccess(), paramFromServiceMsg.getResultCode());
        }
        else if (QLog.isColorLevel())
        {
          QLog.w("ExtendFriendHandler", 2, String.format("handleGetSquareStrangerList nick name is empty, uin=%s", new Object[] { localapyo.mUin }));
        }
      }
      paramToServiceMsg = new apyb();
      ...
      if (n <= 12)
      {
        ...
        {
          paramToServiceMsg.jdField_a_of_type_JavaUtilList.add(((apyo)((List)localObject1).get(i)).mUin);
          i += 1;
        }
      }
    ...
    for (;;)
    {
      ...
      if (i < n)
      {
        ...
        break label1799;
        if (this.app != null) {
          ((aqbb)this.app.getManager(292)).a(true, paramToServiceMsg);
        }
        if (QLog.isColorLevel()) {
  ...
  public void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    else
    {
      ...
      if (localRspBody.rpt_label_info.has())
      {
        ...
        {
          localObject1 = new apyp();
          ((apyp)localObject1).jdField_a_of_type_Long = ((GetExtendFriendInfo.labelInfo)localRspBody.rpt_label_info.get().get(i)).uint64_label_id.get();
    ...
    {
      ((apyp)localObject1).jdField_a_of_type_JavaLangString = paramFromServiceMsg;
    ...
    do
    {
      ...
      if (j == 0)
      {
        ...
        for (int k = paramToServiceMsg.uint32_match_count.get();; k = -1)
        {
          ...
          if ((aqbb)this.app.getManager(292) != null) {}
      ...
      if (i == 0) {
        if (localRspBody.uint64_allow_kuolie.has())
        {
          ...
          if (this.app != null)
          {
            ...
            aqbv.a(this.app, bool2, j, i, paramToServiceMsg, l2);
            if (bool2) {
          ...
          bool3 = true;
          label257:
          aqbb.b(this.app, Boolean.valueOf(bool3));
          if (QLog.isColorLevel()) {
  ...
  public void g(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (((oidb_0xe03.RspBody)localObject1).enum_matchopcode.has())
    {
      ...
      localObject2 = new apyc();
      ((apyc)localObject2).jdField_a_of_type_JavaLangString = String.valueOf(((oidb_0xe03.RspBody)localObject1).uint64_uin.get());
      ((apyc)localObject2).jdField_a_of_type_ArrayOfByte = paramObject.bytes_sig.get().toByteArray();
      if (!paramObject.uint64_match_uin.has()) {
        break label818;
      }
      paramToServiceMsg = String.valueOf(paramObject.uint64_match_uin.get());
      ((apyc)localObject2).jdField_b_of_type_JavaLangString = paramToServiceMsg;
      if (!paramObject.bytes_tips_wording.has()) {
        break label825;
      }
      paramToServiceMsg = paramObject.bytes_tips_wording.get().toStringUtf8();
      ((apyc)localObject2).jdField_c_of_type_JavaLangString = paramToServiceMsg;
      if (!paramObject.uint64_time_stamp.has()) {
        break label831;
      }
      l = paramObject.uint64_time_stamp.get();
      ((apyc)localObject2).jdField_a_of_type_Long = l;
      if (!paramObject.uint32_match_expired_time.has()) {
        break label839;
      }
      k = paramObject.uint32_match_expired_time.get();
      label422:
      ((apyc)localObject2).jdField_a_of_type_Int = k;
      if (!paramObject.bytes_nick.has()) {
        break label846;
      }
      paramToServiceMsg = paramObject.bytes_nick.get().toStringUtf8();
      label450:
      ((apyc)localObject2).d = paramToServiceMsg;
    ...
    for (paramToServiceMsg = paramObject.string_report_id.get();; paramToServiceMsg = "")
    {
      ...
      ((apyc)localObject2).e = paramObject;
      if (((oidb_0xe03.RspBody)localObject1).msg_match_info.msg_tag.has()) {
        ...
        {
          ((apyc)localObject2).jdField_b_of_type_Int = ((oidb_0xe03.RspBody)localObject1).msg_match_info.msg_tag.uint32_tag_id.get();
          label553:
          if (((oidb_0xe03.RspBody)localObject1).msg_match_info.msg_tag.bytes_tag.has()) {
            ((apyc)localObject2).f = ((oidb_0xe03.RspBody)localObject1).msg_match_info.msg_tag.bytes_tag.get().toStringUtf8();
          }
          label592:
          if (!((oidb_0xe03.RspBody)localObject1).msg_match_info.msg_match_uin_data.has()) {
            break label876;
          }
          if (((apyc)localObject2).jdField_a_of_type_Apxk == null)
          {
            ((apyc)localObject2).jdField_a_of_type_Apxk = new apxk();
            ((apyc)localObject2).jdField_a_of_type_Apxk.jdField_a_of_type_JavaLangString = ((apyc)localObject2).jdField_b_of_type_JavaLangString;
          }
          a(((oidb_0xe03.RspBody)localObject1).msg_match_info.msg_match_uin_data, ((apyc)localObject2).jdField_a_of_type_Apxk);
        }
      }
      for (;;)
      {
        if (QLog.isColorLevel()) {
          QLog.d("ExtendFriendHandlerExtendFriendLimitChat", 2, new Object[] { "handleMatchResponse type =" + m, " uin = ", str, ", match_op = ", Integer.valueOf(i), " retCode = ", Integer.valueOf(j), " matchInfo = ", ((apyc)localObject2).toString(), " errMsg = ", paramFromServiceMsg });
        }
      ...
      if (m == 13)
      {
        ...
        for (boolean bool2 = true;; bool2 = false)
        {
          ...
          aqbb.a(this.app, Boolean.valueOf(bool1));
          aqbb.b(this.app, Boolean.valueOf(bool2));
          aqbb.a(this.app, paramFromServiceMsg);
          if (!QLog.isColorLevel()) {
            break;
          }
