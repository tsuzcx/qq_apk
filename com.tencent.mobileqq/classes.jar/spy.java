  ...
  implements spj
{
  public static String a(String paramString, ImageData paramImageData)
  {
    ...
    while (!((Boolean)bnrf.a("sp_native_web_sharpp_pic_switch", Boolean.valueOf(false))).booleanValue()) {
      return paramString;
    }
    ...
    paramImageData = blhn.a(paramString);
    ...
    for (;;)
    {
      QLog.d(ppe.a, 2, "sharpSupport, url : " + paramString);
      return paramString;
  ...
  {
    return new spz(LayoutInflater.from(paramContext).inflate(2131560177, null), paramBaseData);
  }
