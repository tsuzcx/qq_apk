...
public class spy
{
  ...
  public static Readinjoy.ArticleSummary a(BaseVideoArticleInfo paramBaseVideoArticleInfo)
  {
    ...
    for (;;)
    {
      ...
      catch (Throwable paramBaseVideoArticleInfo)
      {
        ...
        QLog.e("VideoProtoHelper", 0, "videoArticleinfoCovert2LocalPB error:" + pqu.a(paramBaseVideoArticleInfo));
      }
  ...
  public static Readinjoy.VideoData a(rsp paramrsp)
  {
    Object localObject;
    if (paramrsp == null) {
      localObject = null;
    ...
    do
    {
      ...
      localVideoData.uint32_busi_type.set(paramrsp.jdField_a_of_type_Int);
      localVideoData.uint32_duration.set(paramrsp.jdField_b_of_type_Int);
      localVideoData.uint32_width.set(paramrsp.c);
      localVideoData.uint32_height.set(paramrsp.d);
      if (!TextUtils.isEmpty(paramrsp.jdField_a_of_type_JavaLangString)) {
        localVideoData.bytes_vid.set(ByteStringMicro.copyFromUtf8(paramrsp.jdField_a_of_type_JavaLangString));
      }
      localVideoData.uint32_file_size.set(paramrsp.e);
      localObject = localVideoData;
    } while (TextUtils.isEmpty(paramrsp.jdField_b_of_type_JavaLangString));
    localVideoData.bytes_video_url.set(ByteStringMicro.copyFromUtf8(paramrsp.jdField_b_of_type_JavaLangString));
    return localVideoData;
  }
  
  public static rsp a(Readinjoy.VideoData paramVideoData)
  {
    ...
    do
    {
      ...
      if (paramVideoData.uint32_busi_type.has()) {
        localrsp.jdField_a_of_type_Int = paramVideoData.uint32_busi_type.get();
      }
      if (paramVideoData.uint32_duration.has()) {
        localrsp.jdField_b_of_type_Int = paramVideoData.uint32_duration.get();
      }
      if (paramVideoData.uint32_width.has()) {
        localrsp.c = paramVideoData.uint32_width.get();
      }
      if (paramVideoData.uint32_height.has()) {
        localrsp.d = paramVideoData.uint32_height.get();
      }
      if (paramVideoData.bytes_vid.has()) {
        localrsp.jdField_a_of_type_JavaLangString = paramVideoData.bytes_vid.get().toStringUtf8();
      }
      if (paramVideoData.uint32_file_size.has()) {
        localrsp.e = paramVideoData.uint32_file_size.get();
      }
      localObject = localrsp;
    } while (!paramVideoData.bytes_video_url.has());
    localrsp.jdField_b_of_type_JavaLangString = paramVideoData.bytes_video_url.get().toStringUtf8();
    return localrsp;
  }
}
