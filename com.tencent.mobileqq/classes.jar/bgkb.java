...
import cooperation.qzone.webviewplugin.QzoneVideoTabJsPlugin.1;
  ...
  implements bgcc
{
  ...
  public bgkb()
  {
    this.jdField_a_of_type_JavaLangString = bgkb.class.getSimpleName();
  }
  ...
  private void a(String paramString)
  {
    try
    {
      ...
      if (((ArrayList)localObject).size() > 0) {
        this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getHandler(bgkb.class).post(new QzoneVideoTabJsPlugin.1(this, (ArrayList)localObject, localArrayList));
      }
      return;
    }
  ...
  private void b()
  {
    this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getHandler(bgkb.class).post(new QzoneVideoTabJsPlugin.3(this));
  }
  ...
  private void b(String paramString)
  {
    try
    {
      ...
      if (localArrayList1.size() > 0) {
        this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getHandler(bgkb.class).post(new QzoneVideoTabJsPlugin.2(this, localArrayList1, localArrayList2));
      }
      return;
    }
    catch (JSONException paramString)
  ...
  private void c(String paramString)
  {
    try
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getHandler(bgkb.class).post(new QzoneVideoTabJsPlugin.4(this, paramString));
      return;
    }
    catch (JSONException paramString)
    {
