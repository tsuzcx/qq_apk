  ...
  extends asti
{
  ...
  private LinearLayout a(ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup.setTag(new astq(null));
  ...
  private View b(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    astq localastq = (astq)paramView.getTag();
    int i = 0;
    for (;;)
    {
      View localView;
      if (i < 4)
      {
        localView = a(paramInt1, paramInt2 * 4 + i, paramBoolean, localastq.a[i], paramViewGroup);
        if (localView != null) {}
      }
      else
      {
  ...
  protected View a(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (Object localObject = (FileInfo)paramViewGroup;; localObject = null)
    {
      ...
      for (;;)
      {
        try
        {
          paramViewGroup = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131560858, null);
          paramView = paramViewGroup;
          try
          {
            localasth = new asth();
            paramView = paramViewGroup;
            localasth.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView = ((AsyncImageView)paramViewGroup.findViewById(2131368246));
            paramView = paramViewGroup;
            localasth.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131368263));
            paramView = paramViewGroup;
            localasth.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131368260));
            paramView = paramViewGroup;
            ...
            paramView = paramViewGroup;
            paramViewGroup.setTag(localasth);
            paramView = paramViewGroup;
            ((FileInfo)localObject).a((String)getGroup(paramInt1));
            paramView = paramViewGroup;
            localasth.jdField_a_of_type_JavaLangObject = localObject;
            paramView = paramViewGroup;
            ...
            if (((FileInfo)localObject).c() != null)
            {
              ...
              {
                paramView = paramViewGroup;
                if (atwl.b(((FileInfo)localObject).c()))
                {
                  paramView = paramViewGroup;
                  localasth.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setAsyncImage(((FileInfo)localObject).c());
                }
              }
            }
            paramView = paramViewGroup;
            ...
            if (athc.a((FileInfo)localObject))
            {
              ...
              paramView = paramViewGroup;
              localasth.jdField_a_of_type_AndroidWidgetImageView.setContentDescription((CharSequence)localObject);
              paramView = paramViewGroup;
              localasth.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setContentDescription((CharSequence)localObject);
              return paramViewGroup;
            ...
            paramView = paramViewGroup;
            localObject = str + anni.a(2131708449);
            paramView = paramViewGroup;
            localasth.jdField_b_of_type_AndroidWidgetImageView.setVisibility(4);
            paramView = paramViewGroup;
            localasth.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130845690);
            continue;
        ...
        return paramView;
        paramView = paramViewGroup;
        localasth.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
        paramView = paramViewGroup;
        localasth.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
        localObject = str;
      }
    }
  }
