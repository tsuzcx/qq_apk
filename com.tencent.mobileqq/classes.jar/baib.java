...
public class baib
  extends bdiw<HashMap<String, Object>, Void, JSONObject>
{
  protected int a;
  protected Bundle a;
  protected baic a;
  ...
  public baib(String paramString1, String paramString2, baic parambaic, int paramInt, Bundle paramBundle)
  {
    super(paramString1, paramString2);
    this.jdField_a_of_type_Baic = parambaic;
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_AndroidOsBundle = paramBundle;
  }
  
  public baib(String paramString1, String paramString2, baic parambaic, int paramInt, Bundle paramBundle, boolean paramBoolean)
  {
    super(paramString1, paramString2);
    this.jdField_a_of_type_Baic = parambaic;
    this.jdField_a_of_type_Int = paramInt;
  ...
  protected JSONObject a(HashMap<String, Object>... paramVarArgs)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = new JSONObject(naj.a(paramVarArgs, this.jdField_a_of_type_JavaLangString, this.b, (Bundle)localObject, localBundle));
  ...
  {
    if (isCancelled()) {}
    while (this.jdField_a_of_type_Baic == null) {
      return;
    }
    this.jdField_a_of_type_Baic.a(paramJSONObject, this.jdField_a_of_type_Int, this.jdField_a_of_type_AndroidOsBundle);
  }
}
