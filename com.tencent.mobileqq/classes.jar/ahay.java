...
public class ahay
{
  private static ahay jdField_a_of_type_Ahay;
  ...
  public static ahay a()
  {
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (jdField_a_of_type_Ahay == null) {
        jdField_a_of_type_Ahay = new ahay();
      }
      return jdField_a_of_type_Ahay;
    }
  }
  ...
  private void a(QQAppInterface paramQQAppInterface, List<RecentUser> paramList)
  {
    ...
    if (localArrayList1.size() > 2) {
      ((ajjj)paramQQAppInterface.getManager(51)).a(localArrayList1);
    }
    if (localArrayList3.size() > 2) {
      ((ajhh)paramQQAppInterface.getManager(53)).a(localArrayList3);
    }
  ...
  public boolean a(QQAppInterface paramQQAppInterface, Context paramContext, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    label561:
    label567:
    for (Object localObject1 = ((akeu)localObject1).a(true);; localObject1 = null)
    {
      label107:
      int k;
      int j;
      ...
      if (localObject1 == null)
      {
        ...
        RecentBaseData localRecentBaseData = ahca.a(paramQQAppInterface, paramContext, (RecentUser)localObject2);
      ...
      for (;;)
      {
        ...
        break label107;
        localObject2 = agzt.a((RecentUser)localObject2, paramQQAppInterface, paramContext, true);
        this.jdField_b_of_type_JavaUtilList.add(localObject2);
      }
      ahca.a(((List)localObject1).size(), ((List)localObject1).size() - j);
      ...
      for (;;)
      {
        paramContext = new ahbe(paramQQAppInterface);
        ...
        agzt.a((List)localObject1, paramQQAppInterface, paramContext, this.jdField_b_of_type_JavaUtilList, k);
