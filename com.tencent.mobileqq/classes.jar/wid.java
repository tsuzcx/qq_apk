...
{
  wid(why paramwhy, String paramString1, String paramString2, StoryVideoItem paramStoryVideoItem)
  {
    super(paramString1);
  }
  ...
  {
    paramJobContext = new wor(new ErrorMessage(), this.jdField_a_of_type_JavaLangString, true);
