  ...
  implements apxm
{
  ...
  public apxv(String paramString)
  {
  ...
  private void a()
  {
    ...
    try
    {
      ...
      this.jdField_c_of_type_AndroidGraphicsDrawableDrawable = localResources.getDrawable(2130846656);
      this.d = localResources.getDrawable(2130846657);
  ...
  public static void a(URLDrawable paramURLDrawable)
  {
    ...
    if (paramURLDrawable != null)
    {
      ...
      if ((localObject != null) && ((localObject instanceof GifDrawable)))
      {
        ...
        if ((localObject == null) || (!(localObject instanceof apzk))) {
          break label72;
        }
        ((apzk)localObject).b();
        ((apzk)localObject).a();
    ...
    do
    {
      ...
      {
        return;
      } while ((localObject == null) || (!(localObject instanceof apzl)));
      ((apzl)localObject).b();
      ((apzl)localObject).a();
      paramURLDrawable.invalidateSelf();
    } while (!QLog.isColorLevel());
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, Emoticon paramEmoticon, EmojiStickerManager.StickerInfo paramStickerInfo)
  {
    ...
    if (paramEmoticon.isNewSoundEmoticon()) {
      aufn.a(paramQQAppInterface, "0X800A932", paramSessionInfo.jdField_a_of_type_Int, paramEmoticon.epId);
    }
  ...
  private void a(QQAppInterface paramQQAppInterface, URL paramURL, EmoticonPackage paramEmoticonPackage, boolean paramBoolean, URLDrawable paramURLDrawable)
  {
    if (paramQQAppInterface != null)
    {
      ...
      if ((paramEmoticonPackage == null) && (!paramBoolean) && (this.jdField_a_of_type_ComTencentMobileqqDataEmoticon != null) && (!(paramURLDrawable.getCurrDrawable() instanceof ApngDrawable)))
      {
        ...
        paramQQAppInterface.a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId, new apxw(this, paramURL));
      }
    }
  }
  ...
  public static void b(URLDrawable paramURLDrawable)
  {
    if (paramURLDrawable != null)
    {
      ...
      if ((paramURLDrawable != null) && ((paramURLDrawable instanceof GifDrawable)))
      {
        ...
        if ((paramURLDrawable == null) || (!(paramURLDrawable instanceof apzk))) {
          break label61;
        }
        ((apzk)paramURLDrawable).b();
        if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      {
        return;
      } while ((paramURLDrawable == null) || (!(paramURLDrawable instanceof apzl)));
      ((apzl)paramURLDrawable).b();
    } while (!QLog.isColorLevel());
    QLog.d("PicEmoticonInfo", 2, "soundgif stopSoundDrawablePlay stop");
  }
  ...
  {
    acjm.a(paramQQAppInterface, paramContext, paramSessionInfo, paramEmoticon, paramStickerInfo);
    paramSessionInfo = "";
    int m = -1;
    ...
    azqs.b(paramQQAppInterface, "CliOper", "", "", "ep_mall", "0X80057A9", 0, 0, paramEmoticon.epId, "", paramContext, paramEmoticon.eId);
  }
  ...
  private static void d(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, Emoticon paramEmoticon, EmojiStickerManager.StickerInfo paramStickerInfo)
  {
    ...
    azqs.b(paramQQAppInterface, "CliOper", "", "", "MbFasong", "MbIDDianji", 0, 0, paramEmoticon.epId, "", "", "");
    ((aufn)paramQQAppInterface.getManager(14)).a(paramEmoticon.epId, -1, new apxz(paramContext, paramQQAppInterface, paramEmoticon, localapro, paramSessionInfo, paramStickerInfo));
  }
  ...
  private static void e(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, Emoticon paramEmoticon, EmojiStickerManager.StickerInfo paramStickerInfo)
  {
    ...
    azqs.b(paramQQAppInterface, "CliOper", "", "", "ep_mall", "0X800579D", 0, 0, paramEmoticon.epId, "", "", "");
    localObject = (apro)paramQQAppInterface.getManager(43);
    ((aufn)paramQQAppInterface.getManager(14)).a(paramEmoticon.epId, 0, new apyb(paramContext, paramQQAppInterface, paramEmoticon, (apro)localObject, paramSessionInfo));
    c(paramQQAppInterface, paramContext, paramSessionInfo, paramEmoticon, paramStickerInfo);
  }
  ...
  public URLDrawable a()
  {
    ...
    {
      return localObject1;
      String str = apvx.q.replace("[epId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId).replace("[eId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.eId);
      localObject1 = localObject4;
      if (str == null) {
        continue;
      }
  ...
  public URLDrawable a(String paramString, boolean paramBoolean1, boolean paramBoolean2, afvu paramafvu)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqDataEmoticon == null) {}
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramafvu != null)
        {
          localObject1 = paramafvu.e.getDrawable();
          paramafvu = BaseApplicationImpl.getApplication().waitAppRuntime(null);
          if ((paramafvu instanceof QQAppInterface))
          {
            paramafvu = (QQAppInterface)paramafvu;
            ...
            if (paramafvu != null)
            {
              localObject1 = (aufn)paramafvu.getManager(14);
              if (this.jdField_a_of_type_ComTencentMobileqqDataEmoticon != null)
              {
                localObject1 = ((aufn)localObject1).b(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId, 0);
      ...
      catch (MalformedURLException paramString)
      {
        for (;;)
        {
          ...
          continue;
          a(paramafvu, paramString, (EmoticonPackage)localObject1, paramBoolean1, (URLDrawable)localObject2);
          continue;
          paramBoolean1 = false;
          continue;
  ...
  public URLDrawable a(String paramString, boolean paramBoolean1, boolean paramBoolean2, afvu paramafvu, int paramInt1, int paramInt2)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqDataEmoticon == null) {}
    for (;;)
    {
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, EditText paramEditText, SessionInfo paramSessionInfo, boolean paramBoolean, int paramInt)
  {
    ...
    do
    {
      ...
      {
        return;
        paramEditText = (apro)paramQQAppInterface.getManager(43);
        if ((this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.jobType != 2) || (!paramBoolean) || ((!(paramContext instanceof SplashActivity)) && (!(paramContext instanceof ChatActivity))) || (!atzj.a())) {
          break label226;
        }
      ...
      return;
      paramInt = atys.a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon, 0);
      if (QLog.isColorLevel()) {
        QLog.d("PicEmoticonInfo", 2, "forward,【maxInt:】" + paramInt);
      }
      paramInt = atxu.a(paramInt);
      ((aufn)paramQQAppInterface.getManager(14)).a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId, new apxx(this, paramQQAppInterface, paramInt, paramContext, paramSessionInfo));
      return;
      ...
      for (;;)
      {
        acjm.a(paramQQAppInterface, paramContext, paramSessionInfo, this.jdField_a_of_type_ComTencentMobileqqDataEmoticon, paramInt);
        return;
        if (QLog.isColorLevel()) {
  ...
  public boolean d()
  {
    ...
    Object localObject = apvx.s.replace("[epId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId).replace("[eId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.eId);
    if (localObject != null)
    {
    ...
    for (;;)
    {
      ...
      {
        localObject = apvx.o.replace("[epId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId).replace("[eId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.eId);
        if (localObject == null) {
          break label165;
        }
        localObject = new File((String)localObject);
  ...
  public boolean e()
  {
    ...
    {
      localObject = apvx.p.replace("[epId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId).replace("[eId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.eId);
      label52:
      if (localObject == null) {
        break label112;
      }
    ...
    {
      return bool;
      localObject = apvx.q.replace("[epId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId).replace("[eId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.eId);
      break label52;
      label112:
      break;
      label114:
