  ...
  extends LinearLayout
{
  ...
  public bnmh(Context paramContext, int paramInt1, int paramInt2, float paramFloat, View.OnClickListener paramOnClickListener, bnlr parambnlr)
  {
    super(paramContext);
  ...
  private void a()
  {
    ...
    while (i < this.b)
    {
      ...
      if (i == 0) {
        localLayoutParams.leftMargin = bnnl.b(getContext(), 7.0F);
      }
      if (i == this.b - 1) {
        localLayoutParams.rightMargin = bnnl.b(getContext(), 7.0F);
      }
  ...
  public void a(bnln parambnln, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (paramInt1 == paramInt2 - 1)
    {
      ...
      localObject = parambnln.a(paramInt2);
      localImageView.setTag(2131378207, localObject);
      localImageView.setTag(2131378194, Integer.valueOf(paramInt2));
      if (parambnln.a(paramInt2) != 1) {
        break label252;
      }
      if (!(getContext() instanceof EditPicActivity)) {
        break label158;
      }
      localObject = parambnln.b(paramInt2);
      localImageView.setTag(2131378207, localObject);
      bnhg.a().a(localImageView, (String)localObject, this.d, this.d, paramBoolean);
    }
    for (;;)
    {
      paramInt2 += 1;
