...
public class blco
  implements blds
{
  public blco(AETemplateInfoFragment paramAETemplateInfoFragment, String paramString, Bitmap paramBitmap, long paramLong) {}
  
  public void a(List<bldt> paramList)
  {
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      ...
      {
        bldt localbldt = (bldt)paramList.next();
        if (localbldt.jdField_a_of_type_Boolean)
        {
          String str = AETemplateInfoFragment.jdField_a_of_type_JavaLangString + System.currentTimeMillis();
          BitmapUtils.saveBitmap(localbldt.jdField_a_of_type_AndroidGraphicsBitmap, str);
          AETemplateInfoFragment.a(this.jdField_a_of_type_DovComQqImAePlayAETemplateInfoFragment).add(str);
          BitmapUtils.recycle(localbldt.jdField_a_of_type_AndroidGraphicsBitmap);
        }
        else
        {
