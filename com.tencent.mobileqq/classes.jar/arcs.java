...
{
  arcs(arcq paramarcq, File paramFile, EIPCResult paramEIPCResult, QQAppInterface paramQQAppInterface, int paramInt1, int paramInt2, int paramInt3) {}
  
  public void onFailed(int paramInt, byte[] paramArrayOfByte, HashMap<String, String> paramHashMap)
  {
    QLog.i("qqidentification_server", 1, "BDH.Upload fail  : result:" + paramInt);
    arcq.a(this.jdField_a_of_type_Arcq);
    axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80097EC", "0X80097EC", 0, 0, "", "", this.c + "", "");
    ...
    paramArrayOfByte.putString("errMsg", ajya.a(2131705709));
    this.jdField_a_of_type_EipcEIPCResult.data = paramArrayOfByte;
    this.jdField_a_of_type_Arcq.callbackResult(arcq.a(this.jdField_a_of_type_Arcq), this.jdField_a_of_type_EipcEIPCResult);
  }
  ...
  public void onSuccess(byte[] paramArrayOfByte, HashMap<String, String> paramHashMap)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80097ED", "0X80097ED", 0, 0, this.jdField_a_of_type_Int + "", "" + this.b, this.c + "", "");
      }
      catch (InvalidProtocolBufferMicroException paramArrayOfByte)
      {
        ...
        paramArrayOfByte.putString("errMsg", ajya.a(2131705711));
        this.jdField_a_of_type_EipcEIPCResult.data = paramArrayOfByte;
        axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80097EC", "0X80097EC", 0, 0, this.jdField_a_of_type_Int + "", "" + this.b, this.c + "", "");
        continue;
      }
      this.jdField_a_of_type_Arcq.callbackResult(arcq.a(this.jdField_a_of_type_Arcq), this.jdField_a_of_type_EipcEIPCResult);
      return;
      QLog.e("qqidentification_server", 1, "request err: " + i + ", " + str);
      axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80097EE", "0X80097EE", 0, 0, this.jdField_a_of_type_Int + "", "" + this.b, this.c + "", i + "");
    }
  }
