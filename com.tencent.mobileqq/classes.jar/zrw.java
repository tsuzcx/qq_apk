...
public class zrw
{
  public static int a(QQAppInterface paramQQAppInterface, Activity paramActivity, zrs paramzrs, String paramString, Bundle paramBundle)
  {
    if ((paramzrs == null) || (paramzrs.a() == 0))
    {
    ...
    for (;;)
    {
      ...
      a(paramQQAppInterface, paramActivity, paramzrs.a().a() + "", paramBundle.getBoolean("issupportwpa", false));
      return 1;
      str3 = "";
      str4 = "";
      ...
      a(paramQQAppInterface, paramActivity, paramzrs.a().a() + "", str2, str1, paramBundle.getString("authKey"), str5);
      return 2;
      a(paramQQAppInterface, paramActivity, paramzrs.a().a() + "", paramBundle);
      return 3;
      a(paramActivity, paramzrs);
      return paramzrs.c;
      a(paramQQAppInterface, paramActivity, twf.a(paramzrs.a().a()), paramBundle);
      return 10;
    }
  }
  ...
  private static void a(Context paramContext, zrs paramzrs)
  {
    nmp.a(paramContext, null, String.valueOf(paramzrs.a().a()), false, 1, true, -1);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString)
  {
    ...
    paramString = 1024 + "https://qm.qq.com/cgi-bin/result" + "?p=a&v=" + bgln.c() + "&r=" + URLEncoder.encode(paramString).replaceAll("\\+", "%20") + "&_wv=1027";
    paramQQAppInterface.putExtra("title", paramActivity.getString(2131717451));
  ...
  private static final void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString, Bundle paramBundle)
  {
    ...
    tzo.a(localIntent, paramQQAppInterface, paramActivity, paramString, -1);
  ...
  private static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    if (!TextUtils.isEmpty(bgmp.l)) {
      localBundle.putString("appid", bgmp.l);
    }
    if (!TextUtils.isEmpty(bgmp.m)) {
      localBundle.putString("openid", a(bgmp.m));
    }
    bgmp.l = null;
    bgmp.m = null;
    ...
    for (;;)
    {
      if (!bgsp.a(paramString3)) {
        localBundle.putString("source_id", paramString3);
      }
      localBundle.putString("jump_from", paramString1);
      paramQQAppInterface = bgng.a(paramQQAppInterface, paramActivity, Uri.parse("mqqapi://card/show_pslcard?" + nlw.a(localBundle)).toString());
