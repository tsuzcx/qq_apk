...
import com.tencent.qqmini.sdk.runtime.core.service.AppBrandService.2;
...
public class bdwg
  extends bdwf
{
  private bdwq jdField_a_of_type_Bdwq;
  private WebView jdField_a_of_type_ComTencentSmttSdkWebView;
  
  public bdwg(bdcz parambdcz, bdwq parambdwq)
  {
    super(parambdcz);
    a(parambdwq);
    this.jdField_a_of_type_ComTencentSmttSdkWebView = new WebView(parambdcz.a());
    this.jdField_a_of_type_ComTencentSmttSdkWebView.addJavascriptInterface(this, "WeixinJSCore");
    parambdcz = this.jdField_a_of_type_ComTencentSmttSdkWebView.getSettings();
    parambdcz.setSupportZoom(false);
    parambdcz.setJavaScriptEnabled(true);
    parambdcz.setCacheMode(2);
    this.jdField_a_of_type_ComTencentSmttSdkWebView.setWebChromeClient(new bdwh(this));
    a(Integer.valueOf(3));
  }
  ...
  public String a(boolean paramBoolean)
  {
    ...
    {
      bdnw.d("AppBrandService", "getJsDefaultConfig failed: ", localException);
    }
    return "";
  }
  ...
  {
    this.jdField_a_of_type_Bdwq = parambdwq;
  }
  ...
  public void a(String paramString1, ValueCallback paramValueCallback, String paramString2)
  {
    if (Thread.currentThread() == Looper.getMainLooper().getThread())
    {
      if (this.jdField_a_of_type_ComTencentSmttSdkWebView != null) {
        this.jdField_a_of_type_ComTencentSmttSdkWebView.evaluateJavascript(paramString1, bdxf.a(paramValueCallback));
      }
      return;
    }
    this.jdField_a_of_type_AndroidOsHandler.post(new AppBrandService.2(this, paramString1, paramValueCallback));
  }
  
  public void a(String paramString1, String paramString2, int paramInt)
  {
    bdnw.a("AppBrandService", "evaluateSubscribeJS  eventName=" + paramString1);
  ...
  {
    a(a(true));
    MiniAppEnv.g().getBaselibLoader().loadBaselib(MiniAppEnv.g().getContext(), new bdwi(this));
  }
}
