  ...
  implements IRequestCallback
{
  ...
  public void onResponse(HwResponse paramHwResponse)
  {
    ...
    if (paramHwResponse.retCode == 0)
    {
      if (paramHwResponse.segmentResp.uint32_cache_addr.has())
      {
        ...
        if (i != 0)
        {
          ...
          if ((bdwd.a(this.a) != 0) && (bdwd.a(this.a) != i)) {
      ...
      if ((localObject1 != null) && (localObject1.length > 0)) {
        try
        {
          ...
          {
            if ((bdwd.jdField_a_of_type_Boolean) || (!QLog.isColorLevel())) {
              return;
            }
    ...
    else
    {
      ...
      bgnl.a(String.valueOf(this.a.jdField_a_of_type_Bdzn.a), "svrcomp_r", "sendAckToBDHServer success!  MD5:" + HexUtil.bytes2HexStr((byte[])localObject3));
      this.a.jdField_a_of_type_Bdzn.f = HexUtil.bytes2HexStr((byte[])localObject3);
      this.a.jdField_a_of_type_Bdzn.i = ShortVideoUtils.a(bdwd.a(this.a), "mp4");
      this.a.c = this.a.jdField_a_of_type_Bdzn.f;
      ...
      localObject2 = this.a.jdField_a_of_type_Bduk;
      localObject3 = this.a;
      long l = this.a.q;
      ((bdwd)localObject3).s = l;
      ((bduk)localObject2).e = l;
      localbduk.a = l;
      this.a.d(1007);
      this.a.b(false);
    }
