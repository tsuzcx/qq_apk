...
{
  public bgop(MiniAppVideoPlayer paramMiniAppVideoPlayer) {}
  ...
  public void onSeekComplete(VideoPlayerProxy paramVideoPlayerProxy)
  {
    ...
    try
    {
      ...
      this.a.jdField_a_of_type_Bghn.a("onVideoSeeked", paramVideoPlayerProxy.toString(), this.a.jdField_a_of_type_Int);
