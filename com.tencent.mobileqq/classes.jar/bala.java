  ...
  implements AdapterView.OnItemClickListener
{
  ...
  private bale jdField_a_of_type_Bale;
  ...
  public bala(Activity paramActivity, QQAppInterface paramQQAppInterface)
  {
  ...
  protected View a()
  {
    View localView = this.jdField_a_of_type_AndroidAppActivity.getLayoutInflater().inflate(2131559084, null);
    localView.setBackgroundResource(2130838592);
    ...
    if (a())
    {
      ...
      localGridView2 = (GridView)localView.findViewById(2131367308);
      localGridView1 = (GridView)localView.findViewById(2131367309);
      localObject1 = (TextView)localView.findViewById(2131361928);
      ((TextView)localObject1).setTextColor(-16777216);
      ((TextView)localObject1).setText(2131690648);
      ((TextView)localObject1).setOnClickListener(new balb(this));
  ...
  public void a()
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Bhuf == null)
      {
        ...
        View localView = a();
        this.jdField_a_of_type_Bhuf.setOnDismissListener(new balc(this));
        this.jdField_a_of_type_Bhuf.setOnKeyListener(new bald(this));
  ...
  protected List<nqh>[] a()
  {
    ...
    ((nqh)localObject).jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidAppActivity.getString(2131696873);
    ...
    localObject = new nqh();
    ((nqh)localObject).jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidAppActivity.getString(2131696893);
    ((nqh)localObject).jdField_a_of_type_Int = 2130838921;
    ((nqh)localObject).jdField_b_of_type_Int = 9;
    ((nqh)localObject).jdField_b_of_type_JavaLangString = "";
    localArrayList.add(localObject);
    localObject = new nqh();
    ((nqh)localObject).jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidAppActivity.getString(2131696876);
    ((nqh)localObject).jdField_a_of_type_Int = 2130838915;
    ((nqh)localObject).jdField_b_of_type_Int = 10;
    ((nqh)localObject).jdField_b_of_type_JavaLangString = "";
    localArrayList.add(localObject);
    localObject = new nqh();
    ((nqh)localObject).jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidAppActivity.getString(2131696890);
    ...
    localnqh.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidAppActivity.getString(2131696881);
    ...
    localnqh = new nqh();
    localnqh.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidAppActivity.getString(2131696865);
    ...
    ((ArrayList)localObject).add(localnqh);
    localnqh = new nqh();
    localnqh.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidAppActivity.getString(2131696871);
  ...
  public void c()
  {
    ...
    {
      this.jdField_a_of_type_Bale = null;
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    } while (this.jdField_a_of_type_Bale == null);
    this.jdField_a_of_type_Bale.a(paramAdapterView.jdField_b_of_type_Int);
  }
}
