...
public class bpde
{
  ...
  public static bovz a(boww paramboww, float paramFloat1, float paramFloat2, float paramFloat3)
  {
    return new bovz(paramFloat1, paramFloat2, paramFloat3, 0.0F, 0.0F, 0.0F, paramboww.jdField_a_of_type_AndroidGraphicsDrawableDrawable.getIntrinsicWidth(), paramboww.jdField_a_of_type_AndroidGraphicsDrawableDrawable.getIntrinsicHeight());
  }
  
  public static bovz a(bpbd parambpbd, int paramInt1, int paramInt2, float paramFloat1, float paramFloat2)
  {
    if (!a(parambpbd)) {
      return null;
    }
    ykq.b("DoodleUtil", "item:" + parambpbd.toString());
    int i = 0;
    paramInt2 = 0;
    if (parambpbd.jdField_a_of_type_AndroidGraphicsDrawableDrawable != null)
    {
      i = parambpbd.jdField_a_of_type_AndroidGraphicsDrawableDrawable.getBounds().width();
      paramInt2 = parambpbd.jdField_a_of_type_AndroidGraphicsDrawableDrawable.getBounds().height();
    }
    float f2 = parambpbd.jdField_a_of_type_Bpbe.c;
    float f1 = parambpbd.jdField_a_of_type_Bpbe.d;
    float f3 = parambpbd.jdField_a_of_type_Bpbe.e;
    f2 = f2 * (paramInt1 / f3) / i;
    paramInt1 = (int)(parambpbd.jdField_a_of_type_Bpbe.b / f1 * paramInt2);
    parambpbd = new bovz(paramFloat1, paramFloat2, f2, 0.0F, 0.0F, 0.0F, i, paramInt2 + a(parambpbd.b, paramInt1, i) * 2 + 32, parambpbd.b, Color.parseColor(parambpbd.jdField_a_of_type_Bpbe.a), paramInt1);
    ykq.b("DoodleUtil", "LayerParams:" + parambpbd.toString());
    return parambpbd;
  }
  
  public static bovz a(bpbd parambpbd, int paramInt1, int paramInt2, float paramFloat1, float paramFloat2, float paramFloat3)
  {
    if (!a(parambpbd)) {
      return null;
    }
    ...
    float f = parambpbd.jdField_a_of_type_Bpbe.c;
    f = parambpbd.jdField_a_of_type_Bpbe.d;
    paramFloat3 = paramInt1 * paramFloat3 / i;
    paramInt1 = (int)(parambpbd.jdField_a_of_type_Bpbe.b / f * paramInt2);
    parambpbd = new bovz(paramFloat1, paramFloat2, paramFloat3, 0.0F, 0.0F, 0.0F, i, paramInt2 + a(parambpbd.b, paramInt1, i) * 2 + 32, parambpbd.b, Color.parseColor(parambpbd.jdField_a_of_type_Bpbe.a), paramInt1);
    ykq.b("DoodleUtil", "LayerParams:" + parambpbd.toString());
    return parambpbd;
  }
  ...
  public static ArrayList<DynamicStickerData> a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          localDynamicStickerData.mGifDecoder = new bojh(localDynamicStickerData.path);
        ...
        localDynamicStickerData.mGifDecoder = new bojg(localDynamicStickerData.type, localDynamicStickerData.data);
        continue;
        if (!QLog.isColorLevel()) {
          break;
        }
  ...
  public static boolean a(bpbd parambpbd)
  {
    if (parambpbd == null)
    {
      ykq.e("DoodleUtil", "item is null.");
      return false;
    }
    if (TextUtils.isEmpty(parambpbd.e))
    {
      ykq.e("DoodleUtil", "item layoutJson is empty,can't parse.");
      return false;
    }
    if (!parambpbd.a())
    {
      ykq.e("DoodleUtil", "parseJson error:" + parambpbd.e);
      return false;
    }
    if (parambpbd.jdField_a_of_type_Bpbe.b < 0)
    {
      ykq.e("DoodleUtil", "item textSize < 0. textSize:" + parambpbd.jdField_a_of_type_Bpbe.b);
      return false;
    }
    if ((parambpbd.jdField_a_of_type_Bpbe.c <= 0) || (parambpbd.jdField_a_of_type_Bpbe.d <= 0))
    {
      ykq.e("DoodleUtil", "item pictureWidth <= 0 or item pictureHeight <= 0. pictureWidth:" + parambpbd.jdField_a_of_type_Bpbe.c + ",pictureHeight:" + parambpbd.jdField_a_of_type_Bpbe.d);
      return false;
    }
    if ((parambpbd.jdField_a_of_type_Bpbe.e <= 0) || (parambpbd.jdField_a_of_type_Bpbe.f <= 0))
    {
      ykq.e("DoodleUtil", "item standardWidth <= 0 or item standardHeight <= 0. standardWidth:" + parambpbd.jdField_a_of_type_Bpbe.e + ",standardHeight:" + parambpbd.jdField_a_of_type_Bpbe.f);
      return false;
    }
    try
    {
      Color.parseColor(parambpbd.jdField_a_of_type_Bpbe.a);
      return true;
    }
    catch (Exception localException)
    {
      ykq.e("DoodleUtil", "item color is illegal:" + parambpbd.jdField_a_of_type_Bpbe.a);
