...
public class ukp
  extends ukv<HotRecommendFeedItem>
{
  public ukp(@NonNull HotRecommendFeedItem paramHotRecommendFeedItem)
  {
    ...
    if (!this.c.isEmpty())
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (!TextUtils.isEmpty(localStoryVideoItem.mOwnerUid)) {
          localsqs.b(localStoryVideoItem.mOwnerUid);
        }
      }
    }
  }
