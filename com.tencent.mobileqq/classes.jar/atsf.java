  ...
  extends atrt
{
  ...
  public atsf(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_Atru = new atru();
  }
  ...
  private boolean b()
  {
    ...
    for (long l = SystemUtil.getSDCardAvailableSize() * 1024L; this.jdField_a_of_type_Atru.d > l; l = SystemUtil.getSystemAvailableSize() * 1024L) {
      return true;
    }
    return false;
  }
  ...
  protected HashMap<String, String> a()
  {
    ...
    if (this.jdField_a_of_type_Atru != null) {
      localHashMap.putAll(this.jdField_a_of_type_Atru.a());
    }
  ...
  public void a()
  {
    this.jdField_a_of_type_Atru.jdField_a_of_type_Long = 5L;
    this.jdField_a_of_type_Long = 3L;
    this.jdField_a_of_type_Atru.jdField_b_of_type_Long = 9004L;
    a(false);
  }
  ...
  {
    atru localatru = new atru();
    localatru.jdField_b_of_type_Int = this.jdField_a_of_type_Atru.jdField_b_of_type_Int;
    localatru.jdField_a_of_type_Int = this.jdField_a_of_type_Atru.jdField_a_of_type_Int;
    localatru.c = this.jdField_a_of_type_Atru.c;
    localatru.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_Atru.jdField_a_of_type_JavaLangString;
    localatru.d = this.jdField_a_of_type_Atru.d;
    localatru.jdField_a_of_type_Long = paramInt1;
    localatru.jdField_b_of_type_Long = paramInt2;
    HashMap localHashMap = new HashMap();
    localHashMap.put("param_V6SelectType", String.valueOf(this.jdField_a_of_type_Int));
    if (paramExcitingTransferOneSlotComplete != null) {
      localHashMap.put("param_ipAddrType", String.valueOf(aufd.b(paramExcitingTransferOneSlotComplete.m_strIp)));
    }
    for (;;)
    {
      localHashMap.put("param_stackType", String.valueOf(aufd.b()));
      localHashMap.put("param_loginType", String.valueOf(aufd.c()));
      localHashMap.put("param_ishttps", String.valueOf(this.c));
      super.a(localatru, paramExcitingTransferOneSlotComplete, localHashMap);
      return;
  ...
  protected HashMap<String, String> b()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo != null)
    {
      ...
      localHashMap.put("param_FailCode", String.valueOf(a(this.jdField_a_of_type_Atru.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo.m_nSrvReturnCode)));
      ...
      localHashMap.put("param_ipStackType", String.valueOf(aufd.a()));
    ...
    for (;;)
    {
      ...
      localHashMap.put("param_fsizeo", String.valueOf(this.jdField_a_of_type_Atru.d));
      localHashMap.put("param_PeerUin", String.valueOf(this.jdField_a_of_type_Atru.c));
      ...
      continue;
      localHashMap.put("param_FailCode", String.valueOf(this.jdField_a_of_type_Atru.jdField_b_of_type_Long));
    }
  }
  
  public void b()
  {
    this.jdField_a_of_type_Atru.jdField_a_of_type_Long = 1L;
    if (this.jdField_a_of_type_Boolean) {}
    for (this.jdField_a_of_type_Long = 3L;; this.jdField_a_of_type_Long = 2L)
    {
      this.jdField_a_of_type_Atru.jdField_b_of_type_Long = 9037L;
      a(false);
      return;
    }
  }
  ...
  {
    this.jdField_a_of_type_Atru.jdField_a_of_type_Long = 2L;
    this.jdField_a_of_type_Long = 2L;
    this.jdField_a_of_type_Atru.jdField_b_of_type_Long = paramLong;
    a(false);
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloaderFirstPkgRp.mCSStartTime = bcrg.a();
  }
  ...
  public void d()
  {
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloaderFirstPkgRp.mCSEndTime = bcrg.a();
  }
