...
class aief
  extends apas
{
  aief(aido paramaido, String paramString) {}
  ...
  public void a(Object paramObject)
  {
    if ((paramObject instanceof oidb_cmd0xc96.RspBody))
    {
      ...
      if ((this.jdField_a_of_type_Aido.sessionInfo != null) && (this.jdField_a_of_type_Aido.sessionInfo.curFriendUin.equals(paramObject.appid.get() + ""))) {
        this.jdField_a_of_type_Aido.finish(1);
      }
    }
    else
    {
