...
public class tgb
  extends BaseAdapter
  implements DownloadListener, tgw, tgx
{
  private float jdField_a_of_type_Float;
  private int jdField_a_of_type_Int;
  private Context jdField_a_of_type_AndroidContentContext;
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new tgc(this);
  private FaceDecoder jdField_a_of_type_ComTencentMobileqqAppFaceFaceDecoder;
  private List<BaseData> jdField_a_of_type_JavaUtilList;
  private tgs[] jdField_a_of_type_ArrayOfTgs;
  private float jdField_b_of_type_Float = 14.0F;
  private int jdField_b_of_type_Int = 16;
  private int c = 18;
  private int d = -1;
  
  public tgb(Context paramContext, List<BaseData> paramList, FaceDecoder paramFaceDecoder)
  {
  ...
  private void f()
  {
    thz localthz = new thz();
    tis localtis = new tis(this.jdField_a_of_type_AndroidContentContext);
    tgt localtgt = new tgt();
    this.jdField_a_of_type_ArrayOfTgs = new tgs[] { localtis, new tha(), new thf(), new thr(), new uhk(), new thn(), new uho(), new uhs(), localthz, localtgt };
    localthz.a(this);
    localthz.a(this.jdField_a_of_type_AndroidContentContext);
    localtis.f();
    localtgt.a();
    bjjq.a().a(this);
  }
  ...
  private void g()
  {
    for (;;)
    {
      try
      {
        localJSONObject = new JSONObject(String.valueOf(bmhv.a("local_kd_native_main_text_style")));
      ...
      do
      {
        do
        {
          ...
          try
          {
            ...
            tgs localtgs = a(localBaseData);
            if (localtgs == null) {
              break;
            }
            paramViewGroup = localtgs.a(this.jdField_a_of_type_AndroidContentContext, localBaseData, paramViewGroup);
          ...
          catch (Exception paramView)
          {
            for (;;)
            {
              ...
              continue;
              paramViewGroup = (tgr)paramView.getTag();
            }
          }
          if (paramViewGroup != null)
          {
          ...
          {
            uvs.a(localBaseData.b, uvs.d, false);
            paramViewGroup = paramView;
          }
  ...
  public tgs a(BaseData paramBaseData)
  {
    int i = 0;
    while (i < this.jdField_a_of_type_ArrayOfTgs.length)
    {
      if (this.jdField_a_of_type_ArrayOfTgs[i].a(paramBaseData)) {
        return this.jdField_a_of_type_ArrayOfTgs[i];
      }
      i += 1;
    }
  ...
  public void a()
  {
    ...
    while (i < this.jdField_a_of_type_ArrayOfTgs.length)
    {
      if ((this.jdField_a_of_type_ArrayOfTgs[i] instanceof tgx)) {
        ((tgx)this.jdField_a_of_type_ArrayOfTgs[i]).a();
      }
      i += 1;
    }
  }
  ...
  public void a(AbsListView paramAbsListView, int paramInt)
  {
    ...
    {
      if ((this.jdField_a_of_type_ArrayOfTgs[i] instanceof tgx)) {
        ((tgx)this.jdField_a_of_type_ArrayOfTgs[i]).a(paramAbsListView, paramInt);
      }
      i += 1;
    }
  }
  ...
  public void b()
  {
    ...
    {
      if ((this.jdField_a_of_type_ArrayOfTgs[i] instanceof tgx)) {
        ((tgx)this.jdField_a_of_type_ArrayOfTgs[i]).b();
      }
      i += 1;
    }
  }
  ...
  public void c()
  {
    ...
    {
      if ((this.jdField_a_of_type_ArrayOfTgs[i] instanceof tgx)) {
        ((tgx)this.jdField_a_of_type_ArrayOfTgs[i]).c();
      }
      i += 1;
    }
  }
  ...
  public void d()
  {
    ...
    {
      if ((this.jdField_a_of_type_ArrayOfTgs[i] instanceof tgx)) {
        ((tgx)this.jdField_a_of_type_ArrayOfTgs[i]).d();
      }
      i += 1;
    }
    bjjq.a().b(this);
  ...
  public void e()
  {
    ...
    {
      if ((this.jdField_a_of_type_ArrayOfTgs[i] instanceof tgx)) {
        ((tgx)this.jdField_a_of_type_ArrayOfTgs[i]).e();
      }
      i += 1;
    }
    bjjq.a().b(this);
  ...
  {
    return tgr.jdField_a_of_type_Int;
  }
