...
public final class bgev
{
  ...
  public static bgez a;
  private static final String jdField_a_of_type_JavaLangString;
  public static HashMap<String, bgey> a;
  private static List<SoftReference<bgex>> jdField_a_of_type_JavaUtilList;
  ...
  static
  {
    ...
    ((StringBuilder)localObject).append("uin=[uin]").append("&client=androidQQ").append("&version=").append("8.4.8.4810").append("&platformId=2").append("&device=").append(Build.DEVICE).append("&system=").append(Build.VERSION.RELEASE).append("&density=[density]");
    ...
    ((StringBuilder)localObject).append("?uin=[uin]").append("&client=androidQQ").append("&version=").append("8.4.8.4810").append("&platformId=2").append("&device=").append(Build.DEVICE).append("&system=").append(Build.VERSION.RELEASE).append("&density=[density]").append("&_bid=182").append("&_wv=3");
    ...
    ((StringBuilder)localObject).append("?uin=[uin]").append("&client=androidQQ").append("&version=").append("8.4.8.4810").append("&platformId=2").append("&device=").append(Build.DEVICE).append("&system=").append(Build.VERSION.RELEASE).append("&density=[density]").append("&adtag=mvip.gxh.android.search").append("&_bid=2229").append("&_wv=1027");
  ...
  public static String a(String paramString, ImageView paramImageView)
  {
    ...
    {
      jdField_a_of_type_JavaUtilList.add(new SoftReference(new bgex(paramString, paramImageView)));
      paramImageView = localObject;
      if (!jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) {
        paramImageView = a(paramString, jdField_a_of_type_Bgez);
      }
  ...
  public static String a(String paramString, bgez parambgez)
  {
    ...
    for (Object localObject2 = localObject1;; localObject2 = null)
    {
      ...
      if (TextUtils.isEmpty(localObject2)) {
        if (!jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
        {
          ...
          ThreadManager.post(new IndividuationUrlHelper.2(parambgez), 5, null, true);
        }
      }
      for (;;)
      {
        parambgez = (String)jdField_b_of_type_JavaUtilMap.get(paramString);
        localObject1 = parambgez;
        if (QLog.isColorLevel())
        {
          QLog.d("IndividuationUrlHelper", 2, "getUrl, from default, id=" + paramString + ", url=" + parambgez);
          localObject1 = parambgez;
        }
        parambgez = (bgez)localObject1;
