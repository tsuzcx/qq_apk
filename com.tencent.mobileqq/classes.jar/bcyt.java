  ...
  extends AsyncTask<Void, Void, Integer>
{
  ...
  private bcyw jdField_a_of_type_Bcyw;
  ...
  public bcyt(QQAppInterface paramQQAppInterface, Context paramContext, MessageForShortVideo paramMessageForShortVideo, bcyw parambcyw)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramQQAppInterface);
    this.jdField_b_of_type_JavaLangRefWeakReference = new WeakReference(paramContext);
    this.jdField_a_of_type_Bcyw = parambcyw;
  ...
  private int a(String paramString1, String paramString2)
  {
    ...
    Object localObject1 = bcyo.a((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get());
    bcyr localbcyr = bcyo.a(paramString1);
    bcys.a(localbcyr);
    boolean bool = bcyo.a(localbcyr, (bcyq)localObject1);
    this.jdField_b_of_type_Boolean = bool;
    if (QLog.isColorLevel()) {
      QLog.d("VideoCompressProcessor", 1, "CompressTask, isNeedCompress = " + bool);
    }
    if (this.jdField_a_of_type_Bcyw != null) {
      bkyq.a(new VideoCompressProcessor.CompressTask.1(this, bool));
    }
    if (!bool) {
      return -1;
    }
    localObject1 = bcyo.a(localbcyr, (bcyq)localObject1, this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo.sendRawVideo);
    ...
    if ((Build.VERSION.SDK_INT >= 18) && ((i & 0x1) > 0) && ((i & 0x2) > 0))
    {
      ...
      localObject2 = new bcyx(this.jdField_a_of_type_JavaLangRefWeakReference, paramString1, paramString2, (bcyp)localObject1, new bcyu(this));
      this.jdField_a_of_type_ComTencentMobileqqShortvideoUtilVideoconverterVideoConverter = new VideoConverter();
      if ((!this.jdField_a_of_type_ComTencentMobileqqShortvideoUtilVideoconverterVideoConverter.start(new File(paramString1), (VideoConverter.Processor)localObject2, true)) || (((bcyx)localObject2).a != null)) {
        break label567;
      }
      if (QLog.isColorLevel()) {
      ...
      localObject2 = new bcyv(this);
      i = ShortVideoTrimmer.compressVideoNew((Context)this.jdField_b_of_type_JavaLangRefWeakReference.get(), paramString1, paramString2, (QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), (ShortVideoTrimmer.ProcessCallBack)localObject2, (bcyp)localObject1, localbcyr);
      if (i != 0) {
        break label627;
      }
    ...
    {
      bcys.a(bool, l3, localbcyr, (bcyp)localObject1, l2);
      if (QLog.isColorLevel()) {
      ...
      label586:
      if (this.jdField_a_of_type_Bcyw != null) {
        this.jdField_a_of_type_Bcyw.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, 1.0F);
      }
      if (QLog.isColorLevel()) {
  ...
  public void a(bcyw parambcyw)
  {
    ...
    do
    {
      do
      {
        ...
        } while (this.jdField_a_of_type_Bcyw == null);
        this.jdField_a_of_type_Bcyw.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, 1);
        return;
        if (!isCancelled()) {
          break;
        }
      } while (this.jdField_a_of_type_Bcyw == null);
      this.jdField_a_of_type_Bcyw.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, 3);
      return;
    } while (this.jdField_a_of_type_Bcyw == null);
    this.jdField_a_of_type_Bcyw.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, this.jdField_b_of_type_Boolean);
  }
  ...
  protected void a(Integer paramInteger)
  {
    ...
    if (this.jdField_a_of_type_Bcyw != null)
    {
      bcyw localbcyw = this.jdField_a_of_type_Bcyw;
      MessageForShortVideo localMessageForShortVideo = this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo;
      if (paramInteger.intValue() == 1) {
        i = 1;
      }
      localbcyw.a(localMessageForShortVideo, i);
    }
    while (paramInteger.intValue() == 1)
    {
      ahfz.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, (QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), (Context)this.jdField_b_of_type_JavaLangRefWeakReference.get());
      return;
      if (QLog.isColorLevel()) {
        QLog.d("VideoCompressProcessor", 2, "onPostExecute, mListener is null ," + b());
      }
    }
    ahfz.b(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, (QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), (Context)this.jdField_b_of_type_JavaLangRefWeakReference.get());
  }
  ...
  protected void onCancelled()
  {
    ...
    if (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)
    {
      ...
      bbob.a((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), localMessageForShortVideo.frienduin, localMessageForShortVideo.uniseq);
    ...
    for (Object localObject = ShortVideoUtils.getShortVideoRawCompressPath(this.jdField_a_of_type_JavaLangString, "mp4");; localObject = ShortVideoUtils.getShortVideoCompressPath(this.jdField_a_of_type_JavaLangString, "mp4"))
    {
      ...
      bcys.a().a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo.uniseq);
      if (QLog.isColorLevel()) {
