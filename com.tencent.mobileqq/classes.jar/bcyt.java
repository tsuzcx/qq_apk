...
{
  public bcyt(AuthorityActivity paramAuthorityActivity) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("AuthorityActivity", 2, "-->doAuthorize-onReceive, ssoAccount: " + str + " | uin: " + this.a.jdField_a_of_type_Bdnp.jdField_a_of_type_JavaLangString);
    }
    ...
    for (str = "s_a_a_emp";; str = "s_a_a")
    {
      ...
      for (;;)
      {
        try
        {
          ...
          localObject = bdoo.b((byte[])localObject, this.a.jdField_a_of_type_Bdnp);
          if (localObject != null)
          {
            ...
            if (localAuthorizeResponse != null)
            {
              ...
              if (localAuthorizeResponse.ret.get() == 0) {
                bdoo.a(AuthorityActivity.e, this.a.jdField_a_of_type_Bdnp.jdField_a_of_type_JavaLangString, localAuthorizeResponse.expires_in.get(), (byte[])localObject);
              }
        ...
        try
        {
          ...
          bdkd.a().a(0, "LOGIN_AUTH", this.a.jdField_a_of_type_Bdnp.jdField_a_of_type_JavaLangString, AuthorityActivity.e, null, Long.valueOf(SystemClock.elapsedRealtime()), i, 1, null);
          AuthorityActivity.a(this.a, "KEY_AUTHORIZE_REQUEST", this.a.d, true);
        }
        catch (Exception paramBundle)
        {
          bdii.c("AuthorityActivity", "-->success report exception cmd: agent_authority", paramBundle);
          continue;
        }
        ...
        bdii.c("Authority_TimeCost", "<TimeStamp> authority cost : " + (this.a.jdField_i_of_type_Long - this.a.h));
        return;
        paramBundle = "1";
        continue;
        ...
        try
        {
          ...
          bdkd.a().a(1, "LOGIN_AUTH", this.a.jdField_a_of_type_Bdnp.jdField_a_of_type_JavaLangString, AuthorityActivity.e, null, Long.valueOf(SystemClock.elapsedRealtime()), 3002, 1, paramBundle);
          bdes.a().a(this.a.jdField_a_of_type_Bdnp.jdField_a_of_type_JavaLangString, "", AuthorityActivity.e, "1", "6", "" + 3002, false);
        }
        catch (Exception paramBundle)
        {
          bdii.c("AuthorityActivity", "-->failed report exception cmd: agent_authority", paramBundle);
        }
      }
    }
  }
