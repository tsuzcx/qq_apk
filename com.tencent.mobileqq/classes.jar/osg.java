...
public class osg
{
  ...
  private static String a(String paramString1, String paramString2)
  {
    ...
    paramString1 = rbg.a().a(paramString2);
    return paramString1;
  }
  ...
  public static void a(@NonNull Activity paramActivity, @NonNull Intent paramIntent)
  {
    ...
    six.a(paramActivity, localBundle, paramIntent.getStringExtra("pushRowKey"), 27);
  ...
  public static void a(@NonNull Activity paramActivity, @NonNull Intent paramIntent, int paramInt)
  {
    ...
    localBundle.putInt("RETURN_SCENE", paramIntent.getIntExtra("return_scene", 0));
    localBundle.putInt("REPORT_VIDEO_FEEDS_CHANNEL_ID", a(paramIntent));
    if ((paramInt != 1) || (bmic.a(localBundle))) {
      pin.a(32);
    }
    bmic.a(paramActivity, 3, paramInt, localBundle, a(paramIntent));
  ...
  private static void a(Activity paramActivity, HashMap<String, String> paramHashMap)
  {
    ...
    for (;;)
    {
      ...
      six.a(paramActivity, null, true, i);
      return;
  ...
  public static void a(Context paramContext, ArticleInfo paramArticleInfo1, ArticleInfo paramArticleInfo2, boolean paramBoolean)
  {
    ...
    localIntent.putExtra("channel_name", anvx.a(2131712476));
  ...
  public static void a(Context paramContext, String paramString, int paramInt)
  {
    ...
    //   132: ldc_w 581
    //   135: iload_2
    //   136: invokestatic 585	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   139: ldc_w 581
    //   142: invokestatic 589	com/tencent/biz/pubaccount/readinjoy/activity/ReadInJoyBaseDeliverActivity:a	()Ljava/lang/String;
    //   145: iconst_0
    //   146: invokestatic 594	olh:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)V
    //   149: aload_0
    //   150: ldc_w 595
    //   153: getstatic 599	pjj:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   156: iconst_0
    //   157: iload_2
    //   158: aload_1
    //   159: invokestatic 439	osg:a	(Landroid/content/Context;ILjava/lang/String;IILjava/util/Map;)V
    //   162: return
    //   163: astore 5
    //   165: aconst_null
    //   166: astore_1
    //   167: aload 5
    //   169: invokevirtual 600	org/json/JSONException:printStackTrace	()V
    //   172: goto -58 -> 114
    //   175: astore 6
    //   177: aload 5
    //   179: astore_1
  ...
  public static void a(Context paramContext, String paramString1, int paramInt, String paramString2, boolean paramBoolean)
  {
    ...
    localIntent.putExtra("big_brother_source_key", pqx.a(paramInt));
    localIntent.putExtra("launch_app_time", System.currentTimeMillis());
    paramString1 = new osh(new WeakReference(paramContext), paramBoolean, paramString2, paramString1);
    jdField_a_of_type_Int = aqgm.a().a(paramString1);
  ...
  public static void a(Context paramContext, HashMap<String, String> paramHashMap)
  {
    ...
    {
      boolean bool2 = bhfn.a(paramContext, str1);
  ...
  public static void a(Context paramContext, List<Long> paramList, long paramLong, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      paramContext.startActivity(localIntent);
      ((KandianMergeManager)BaseApplicationImpl.getApplication().getRuntime().getManager(QQManagerFactory.KANDIAN_MERGE_MANAGER)).h();
      return;
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt1, int paramInt2, Bundle paramBundle)
  {
    ...
    for (localIntent = new Intent(paramContext, ReadInJoySettingActivity.class);; localIntent = a(paramContext, paramInt1))
    {
      ...
      paramContext.startActivity(localIntent);
      if ((paramInt2 == 0) && (!bmhv.n())) {
        ((KandianMergeManager)paramQQAppInterface.getManager(QQManagerFactory.KANDIAN_MERGE_MANAGER)).h();
      }
      return;
      if (!bmhv.n()) {
        break;
    ...
    for (;;)
    {
      ...
      if (paramInt1 == 9)
      {
        ...
        pkj.a(localIntent);
        QLog.d(osg.class.getSimpleName(), 2, "start kandian activity, launch from lock screen");
      }
      else
      {
        localIntent.putExtra("from_search", false);
  ...
  public static Intent b(Context paramContext, HashMap<String, String> paramHashMap)
  {
    ...
    try
    {
      ...
      if (TextUtils.isEmpty(paramContext))
      {
        ...
        if (str2 != null) {
          localArticleInfo.mArticleContentUrl = new String(bhcu.decode(str2, 0));
        }
        if (localObject != null) {
  ...
  public static void b(Context paramContext, HashMap<String, String> paramHashMap)
  {
    ...
    String str28 = (String)paramHashMap.get("commentId");
    String str29 = (String)paramHashMap.get("subCommentId");
    String str30 = (String)paramHashMap.get("isAwesome");
    String str31 = (String)paramHashMap.get("jumpCommentType");
    ...
    String str17 = (String)paramHashMap.get("percentage");
    ...
    String str1 = (String)paramHashMap.get("backColor");
    String str25 = (String)paramHashMap.get("forceNative");
    if (!TextUtils.isEmpty(str1)) {}
    for (str1 = "#" + str1;; str1 = null)
    {
      ...
      if (!TextUtils.isEmpty(str28))
      {
        ...
        paramHashMap.jdField_a_of_type_JavaLangString = str28;
        paramHashMap.jdField_b_of_type_JavaLangString = str29;
        paramHashMap.jdField_a_of_type_Boolean = "1".equals(str30);
        paramHashMap.jdField_b_of_type_Boolean = "0".equals(str31);
        localBundle.putBoolean("VIDEO_SHOW_COMMENT", true);
        localBundle.putParcelable("VIDEO_COMMENT_ANCHOR", paramHashMap);
      }
      if (str3 != null) {}
      for (;;)
      {
        try
        {
          ...
          {
            i = 10;
            pjd.b(localBundle, "VIDEO_STRATEGY_ID", str14);
            pjd.a(localBundle, "VIDEO_ALGORITHM_ID", str15);
            pjd.b(localBundle, "REPORT_VIDEO_FEEDS_CHANNEL_ID", str16);
            pjd.a(localBundle, "VIDEO_PLAY_POSITION", str17);
            if (!TextUtils.isEmpty(str18)) {
              localBundle.putString("video_player_session_id", str18);
            }
            if (!TextUtils.isEmpty(str19)) {
              localBundle.putString("session_id", str19);
            }
            pjd.b(localBundle, "VIDEO_COLUMN_ID", str20);
            if (i == 31) {
              localBundle.putInt("REPORT_VIDEO_FEEDS_JUMP_FROM", 7);
            }
            if (!TextUtils.isEmpty(str22)) {
              localBundle.putString("video_column_topic_id", str22);
            }
            if (!TextUtils.isEmpty(str23)) {
              localBundle.putString("video_column_topic_cookie", str23);
            }
            if (!TextUtils.isEmpty(str24)) {
              localBundle.putString("enable_video_feeds_default_anim", str24);
            }
            if (!TextUtils.isEmpty(str25)) {
              localBundle.putString("video_feeds_force_native", str25);
            }
            if (bmhv.g(i)) {
              localBundle.putInt("video_feeds_req_sub_source", 7);
            }
            if (!TextUtils.isEmpty(str1)) {
              localBundle.putString("video_feeds_back_color", str1);
            }
            if (!TextUtils.isEmpty(str27)) {
              localBundle.putString("VIDEO_THIRD_ICON", str27);
            }
            if (!TextUtils.isEmpty(str26)) {
              localBundle.putString("VIDEO_THIRD_NAME", str26);
            }
            localBundle.putString("FIRST_VIDEO_TOKEN", str21);
            six.a((Activity)paramContext, localBundle, i, str4, j, str6, k, m, n, str10, str2, paramHashMap, str12, str11, 0L, false, 0L, 0, null, null, null, null, null);
            return;
          }
        }
        catch (Exception paramContext)
  ...
  public static void c(Context paramContext, HashMap<String, String> paramHashMap)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (!TextUtils.isEmpty(paramContext)) {
          bmhv.a("DAILY_CHILD_FEEDS_REQUEST_CONFIG" + str1, paramContext);
        }
