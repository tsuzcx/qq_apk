  ...
  extends bbab
{
  ...
  public baxq(String paramString1, long paramLong1, String paramString2, List<bayt> paramList, long paramLong2, String paramString3, String paramString4, List<String> paramList1, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, String paramString5, String paramString6)
  {
    this.f = paramString1;
  ...
  public void a(View paramView)
  {
    ...
    if (this.jdField_a_of_type_Long == 1002L) {
      bbgf.a(this.jdField_a_of_type_JavaUtilList, this.f);
    }
    ...
    do
    {
      ...
      localObject = bfwg.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramView.getContext(), this.jdField_b_of_type_JavaLangString);
      if (localObject != null)
      {
        ((bfvp)localObject).a();
        return;
    ...
    try
    {
      QLog.d("Q.uniteSearch.GroupBaseNetSearchModel", 2, "onMoreAction,moreUrl = " + this.jdField_b_of_type_JavaLangString + ",dstUrl = " + audi.a((String)localObject));
