...
public abstract class bhez
  implements DownloadParams.DecodeHandler
{
  public static final DownloadParams.DecodeHandler A = new bhfq();
  ...
  static
  {
    ...
    jdField_a_of_type_ComTencentImageDownloadParams$DecodeHandler = new bhfa();
    b = new bhfl();
    c = new bhfr();
    d = new bhfs();
    e = new bhft();
