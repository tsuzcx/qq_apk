...
public class ubt
{
  ...
  private static bihh jdField_a_of_type_Bihh = new ubu();
  private static String jdField_a_of_type_JavaLangString;
  
  public static void a()
  {
    WXShareHelper.a().a(jdField_a_of_type_Bihh);
  }
  ...
  public static void a(BaseActivity paramBaseActivity)
  {
    ...
    bltb.a(paramBaseActivity, BaseApplicationImpl.getContext(), localBundle, null, 2);
  }
  ...
  public static void b()
  {
    ...
    WXShareHelper.a().b(jdField_a_of_type_Bihh);
  }
  ...
  public static void b(Activity paramActivity)
  {
    ...
    for (;;)
    {
      if (i != -1)
      {
        QQToast.a(BaseApplicationImpl.getContext(), BaseApplicationImpl.getContext().getString(i), 0).b(BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131298998));
        return;
  ...
  {
    String str = anhk.aZ + "/Tencent/QQ_Images/" + Calendar.getInstance().getTime() + ".png";
    if (bgmg.a(jdField_a_of_type_AndroidGraphicsBitmap, str))
    {
      QLog.d("ShareImageUtils", 1, "save to sdcard success");
      bgmo.a(BaseApplicationImpl.getContext(), str);
      str = BaseApplicationImpl.getContext().getString(2131694329) + " " + str;
