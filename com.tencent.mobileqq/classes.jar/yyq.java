...
public class yyq
{
  ...
  public static String a(int paramInt)
  {
    ...
    if (paramInt == 1)
    {
      FileUtils.createFileIfNotExits(vzh.e + ".nomedia");
      str = vzh.e + b(paramInt) + "/";
    }
    for (;;)
    {
      a(str);
  ...
  private static void a(String paramString)
  {
    ...
    if (paramString.isFile())
    {
      ...
      ykq.d("Q.qqstory.publish.edit.PublishFileManager", "delete file : " + bool);
    }
    if (!paramString.exists())
    {
      bool = paramString.mkdirs();
      ykq.d("Q.qqstory.publish.edit.PublishFileManager", "create folder : " + bool);
    }
  }
