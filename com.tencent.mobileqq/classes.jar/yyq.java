...
public class yyq
{
  public static int a(Context paramContext, GdtAppBtnData paramGdtAppBtnData)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        return -1;
        localDownloadInfo = bdgv.a().b(paramGdtAppBtnData);
  ...
  {
    akgs.a("scheme", paramString1, paramString2, "4", "gdtAppAd", paramContext.getClass().getName());
  }
  ...
  public static void a(Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        Object localObject5 = bdey.a(str);
        localObject4 = (String)((HashMap)localObject5).get("appid");
        localObject1 = localObject4;
        localObject3 = str;
        if (TextUtils.isEmpty((CharSequence)localObject4))
        {
          localObject1 = (String)((HashMap)localObject5).get(bdkm.b);
          localObject3 = str;
        }
        str = bdey.g() + File.separator + "qapp_center_detail.htm";
        ...
        if ("1".equals((String)bdey.a(paramBundle.getString("schemaUrl")).get("auto_download")))
        {
          localObject3 = localObject1;
  ...
  public static void a(GdtBaseAdItem paramGdtBaseAdItem)
  {
    ...
    {
      ((yxt)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(110)).a(BaseApplicationImpl.getContext(), paramGdtBaseAdItem);
  ...
  {
    return bbev.h(BaseApplicationImpl.getContext());
  }
  ...
  public static boolean a(Context paramContext, String paramString)
  {
    ...
    do
    {
      ...
      localDownloadInfo = bdgv.a().c(paramString);
      if (localDownloadInfo == null)
      {
  ...
  public static boolean b(Context paramContext, GdtBaseAdItem paramGdtBaseAdItem)
  {
    ...
    try
    {
      ...
      bool2 = true;
      bool1 = bool3;
      yyh.a(138, paramGdtBaseAdItem.d, paramGdtBaseAdItem.e);
      bool1 = bool3;
      a(paramContext, paramGdtBaseAdItem.b, paramGdtBaseAdItem.jdField_a_of_type_JavaLangString);
      bool1 = bool3;
      yxs.a("GdtAppOpenUtil", "launchAPPMain report " + paramGdtBaseAdItem.toString());
      bool1 = bool2;
      return bool1;
    }
    catch (Exception paramContext)
    {
      yxs.d("GdtAppOpenUtil", "launchApp failed", paramContext);
    }
    return bool1;
  }
  ...
  public static boolean b(Context paramContext, String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        localDownloadInfo = bdgv.a().b(paramString);
        bool2 = bool1;
  ...
  public static int c(Context paramContext, GdtAppBtnData paramGdtAppBtnData)
  {
    ...
    do
    {
      ...
      paramContext = bdgv.a().b(paramGdtAppBtnData);
  ...
  private static boolean c(Context paramContext, GdtBaseAdItem paramGdtBaseAdItem)
  {
    ...
    if (a(paramContext, paramGdtBaseAdItem.jdField_a_of_type_JavaLangString, paramGdtBaseAdItem.c))
    {
      ...
      try
      {
        ...
        bool2 = true;
        bool1 = bool3;
        yyh.a(137, paramGdtBaseAdItem.d, paramGdtBaseAdItem.e);
        bool1 = bool3;
        a(paramContext, paramGdtBaseAdItem.b, paramGdtBaseAdItem.jdField_a_of_type_JavaLangString);
        bool1 = bool3;
        yxs.a("GdtAppOpenUtil", "launchAPPDeepLink report " + paramGdtBaseAdItem.toString());
        bool1 = bool2;
        return bool1;
      }
      catch (Exception paramContext)
      {
        yxs.d("GdtAppOpenUtil", "launchAPPDeepLink failed", paramContext);
        return bool1;
      }
    }
    yxs.a("GdtAppOpenUtil", "launchAPPDeepLink isDLURISupported false");
    return false;
  }
}
