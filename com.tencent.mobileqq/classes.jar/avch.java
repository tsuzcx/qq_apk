...
{
  private final avci jdField_a_of_type_Avci = new avci();
  private avcj jdField_a_of_type_Avcj;
  private final bfnk jdField_a_of_type_Bfnk;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private boolean jdField_a_of_type_Boolean;
  private final avci jdField_b_of_type_Avci = new avci();
  private boolean jdField_b_of_type_Boolean;
  private final avci c = new avci();
  
  public avch(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Bfnk = new bfnk(ThreadManager.getSubThreadLooper(), this);
    a(new PTTPreDownloadStrategy(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Bfnk));
  }
  ...
  public static int a(QQAppInterface paramQQAppInterface, MessageForPtt paramMessageForPtt)
  {
    ...
    {
      return 2005;
      if ((paramMessageForPtt.url.startsWith(ajsf.aV)) && (bbdj.a(paramMessageForPtt.getLocalFilePath()))) {
        return 2003;
      }
  ...
  public static avch a(QQAppInterface paramQQAppInterface)
  {
    return (avch)paramQQAppInterface.getManager(127);
  }
  
  private avci a(MessageForPtt paramMessageForPtt)
  {
    avci localavci = null;
    ...
    do
    {
      ...
      if (paramMessageForPtt.istroop == 1) {
        return this.jdField_b_of_type_Avci;
      }
  ...
  private void a(avci paramavci)
  {
    ...
    int i = 0;
    if (i < paramavci.jdField_a_of_type_JavaUtilArrayList.size())
    {
      MessageForPtt localMessageForPtt = (MessageForPtt)paramavci.jdField_a_of_type_JavaUtilArrayList.get(i);
      if (this.jdField_a_of_type_Avcj.b(localMessageForPtt)) {
  ...
  private void a(boolean paramBoolean, int paramInt, MessageForPtt paramMessageForPtt)
  {
    ...
    if ((paramMessageForPtt.extFlag > 0L) && ((paramMessageForPtt.extFlag & 1L) > 0L))
    {
      ...
      this.jdField_a_of_type_Avcj.b(paramMessageForPtt);
    }
    label129:
    while (((paramMessageForPtt.extFlag & 0x2) != 0L) || (!this.jdField_a_of_type_Avcj.a(paramMessageForPtt, 3)))
    {
  ...
  private boolean a(avci paramavci)
  {
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      if ((paramavci.jdField_a_of_type_Int < 3) && (paramavci.jdField_a_of_type_JavaUtilArrayList.size() > 0))
      {
        MessageForPtt localMessageForPtt = (MessageForPtt)paramavci.jdField_a_of_type_JavaUtilArrayList.get(0);
        if (this.jdField_a_of_type_Avcj.a(localMessageForPtt))
        {
          long l;
          ...
          try
          {
            ...
            label113:
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(localMessageForPtt.frienduin, localMessageForPtt.istroop, localMessageForPtt.uniseq, localMessageForPtt.msgData);
            paramavci.jdField_a_of_type_JavaUtilArrayList.remove(0);
            for (bool = false;; bool = true)
            {
              ...
              break label102;
              paramavci.jdField_a_of_type_Int += 1;
              paramavci.jdField_a_of_type_JavaUtilArrayList.remove(0);
            }
          }
    ...
    do
    {
      for (;;)
      {
        ...
        if (!((HotChatManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(60)).b(paramMessageForPtt.frienduin))
        {
          ...
          if ((i == 0) || (i == -1))
          {
            localavci = a(paramMessageForPtt);
            if (localavci != null)
            {
              if (!this.jdField_b_of_type_Boolean) {
                break;
              ...
              long l;
              if ((localavci.jdField_a_of_type_Int < 3) && (this.jdField_a_of_type_Avcj.a(paramMessageForPtt))) {
                if (!g(paramMessageForPtt)) {
                  if (this.jdField_a_of_type_Avcj.b(paramMessageForPtt))
                  {
                    if (paramMessageForPtt.extFlag != -1L) {
                      break label290;
                    }
              ...
              for (;;)
              {
                ...
                axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "changevoice", "0X8006F7D", 0, 0, "" + paramMessageForPtt.istroop, "", "", "");
                return true;
                l = (0x3 ^ 0xFFFFFFFF) & paramMessageForPtt.extFlag;
                break;
                localavci.jdField_a_of_type_Int += 1;
                continue;
                i = localavci.jdField_a_of_type_JavaUtilArrayList.size();
                localavci.getClass();
                if (i + 1 < 99) {
                  localavci.jdField_a_of_type_JavaUtilArrayList.add(paramMessageForPtt);
                }
              }
            }
          }
  ...
  private boolean f(MessageForPtt paramMessageForPtt)
  {
    ...
    if (this.jdField_a_of_type_Avcj.a(paramMessageForPtt, 1)) {
      if (paramMessageForPtt.extFlag != -1L) {
        break label113;
      }
    }
  ...
  private boolean g(MessageForPtt paramMessageForPtt)
  {
    ...
    else
    {
      ...
      localaywa.jdField_c_of_type_JavaLangString = paramMessageForPtt.frienduin;
      localaywa.jdField_a_of_type_Int = paramMessageForPtt.istroop;
      localaywa.jdField_b_of_type_Int = 2;
      localaywa.jdField_a_of_type_Long = paramMessageForPtt.uniseq;
      localaywa.jdField_a_of_type_Boolean = false;
      localaywa.e = paramMessageForPtt.urlAtServer;
      localaywa.h = paramMessageForPtt.getLocalFilePath();
    ...
    for (;;)
    {
      localaywa.jdField_b_of_type_Boolean = bool1;
      localaywa.f = paramMessageForPtt.md5;
      localaywa.jdField_c_of_type_Long = paramMessageForPtt.groupFileID;
      localaywa.jdField_g_of_type_JavaLangString = paramMessageForPtt.groupFileKeyStr;
      localaywa.d = paramMessageForPtt.subVersion;
      localaywa.jdField_a_of_type_ComTencentMobileqqDataMessageRecord = paramMessageForPtt;
      localaywa.jdField_g_of_type_Int = 1;
      localaywa.jdField_a_of_type_JavaLangObject = new aywf(6, 0);
      try
      {
        bool1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(localaywa);
        if (QLog.isDevelopLevel()) {
  ...
  public void a(avcj paramavcj)
  {
    this.jdField_a_of_type_Avcj = paramavcj;
  }
  
  public void a(boolean paramBoolean, int paramInt, aywf paramaywf, MessageForPtt paramMessageForPtt)
  {
    paramaywf = this.jdField_a_of_type_Bfnk;
    if (paramBoolean) {}
    for (int i = 1;; i = 0)
    {
      paramaywf.obtainMessage(2, i, paramInt, paramMessageForPtt).sendToTarget();
      return;
    }
  }
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean2)
    {
      localObject = this.jdField_a_of_type_Bfnk;
      if (paramBoolean1) {}
      for (;;)
      {
        localObject = ((bfnk)localObject).obtainMessage(3, i, 0);
        this.jdField_a_of_type_Bfnk.sendMessageDelayed((Message)localObject, 30000L);
        return;
        i = 0;
      }
    }
    this.jdField_a_of_type_Bfnk.removeMessages(3);
    Object localObject = this.jdField_a_of_type_Bfnk;
    if (paramBoolean1) {}
    for (i = j;; i = 0)
    {
      ((bfnk)localObject).obtainMessage(3, i, 0).sendToTarget();
      return;
    }
  }
  ...
  {
    this.jdField_a_of_type_Bfnk.obtainMessage(0, paramMessageForPtt).sendToTarget();
    return true;
  }
  ...
  public boolean b(MessageForPtt paramMessageForPtt)
  {
    ...
    {
      paramMessageForPtt.extFlag = l;
      this.jdField_a_of_type_Bfnk.obtainMessage(4, paramMessageForPtt).sendToTarget();
      return true;
      l = 0x2 | paramMessageForPtt.extFlag;
    }
  }
