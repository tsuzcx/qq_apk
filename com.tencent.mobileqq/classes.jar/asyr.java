...
public class asyr
{
  ...
  private static asys a()
  {
    Object localObject1 = BaseApplication.getContext();
    asys localasys = new asys();
    try
    {
      String str1;
      String str2;
      ...
      try
      {
        ...
        if ((str3 != null) && (str3.startsWith("ctwap"))) {
          ...
          {
            localasys.jdField_a_of_type_JavaLangString = str1;
            localasys.jdField_a_of_type_Int = Integer.valueOf(str2).intValue();
          }
          else
          {
            localasys.jdField_a_of_type_JavaLangString = "10.0.0.200";
            localasys.jdField_a_of_type_Int = 80;
          }
        }
      }
      ...
      if ((str3 != null) && (str3.startsWith("cmwap")))
      {
        ...
        {
          localasys.jdField_a_of_type_JavaLangString = "10.0.0.172";
          localasys.jdField_a_of_type_Int = 80;
        }
      }
  ...
  public static InetSocketAddress a()
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          localObject1 = a();
          str = ((asys)localObject1).jdField_a_of_type_JavaLangString;
          i = ((asys)localObject1).jdField_a_of_type_Int;
        }
      }
    }
  }
