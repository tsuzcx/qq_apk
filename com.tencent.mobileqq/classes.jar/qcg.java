  ...
  implements Cloneable
{
  ...
  public SpannableStringBuilder a(ArticleInfo paramArticleInfo, String paramString, pbg parampbg)
  {
    return SocializeFeedsInfo.a(paramArticleInfo, paramString, parampbg, this.jdField_a_of_type_JavaUtilList);
  }
  ...
  public qcg a()
  {
    try
    {
      qcg localqcg = (qcg)super.clone();
      try
      {
        localqcg.jdField_a_of_type_JavaUtilList = new ArrayList();
        ...
        while (localIterator.hasNext())
        {
          ...
          localqcg.jdField_a_of_type_JavaUtilList.add(localBiuCommentInfo.a());
        }
        return localqcg;
      }
