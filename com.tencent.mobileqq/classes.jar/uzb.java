...
{
  public uzb(PAMultiItemBuilder paramPAMultiItemBuilder) {}
  
  public void onClick(View paramView)
  {
    uzc localuzc = (uzc)paramView.getTag();
    ...
    if ((localuzc == null) || (!(localChatMessage instanceof MessageForPubAccount))) {
      if (QLog.isColorLevel()) {
        QLog.d("ChatItemBuilder", 2, "PAMultiItemBuilder onClickListener holder = " + localuzc + ", msg = " + localChatMessage);
      }
    }
    Object localObject1;
    do
    ...
    return;
    Object localObject2 = (PAMessage.Item)((MessageForPubAccount)localObject1).mPAMessage.items.get(localuzc.d);
    ...
    if ((this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface instanceof QQAppInterface)) {
      ReportController.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, "mp_msg_msgpic_click", "aio_morpic_click", localuzc.d + 1, 0, "", "", Long.toString(((MessageForPubAccount)localObject1).mPAMessage.mMsgId), "");
    }
    ...
    if (TextUtils.isEmpty(((PAMessage.Item)localObject2).a_actionData))
    {
      ...
      PASingleItemBuilder.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_AndroidContentContext, localuzc.a, localuzc.b, localuzc.c, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.d, l1);
      label569:
    ...
    for (;;)
    {
      ...
      ((EcshopReportHandler)localObject2).a(false, localChatMessage, localuzc.d + 1, paramView);
      return;
