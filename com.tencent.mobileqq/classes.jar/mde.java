...
public class mde
{
  ...
  {
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131378788) != null)
    {
    ...
    int k = arrayOfInt2[1];
    float f2 = actn.a(0, this.jdField_a_of_type_AndroidViewView.getResources()) + (k - j);
  ...
  private boolean a(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if (paramBoolean)
      {
        ...
        if (!muf.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface)) {
          return false;
        }
      }
  ...
  private void b(TextView paramTextView)
  {
    ...
    int m = actn.a(0, this.jdField_a_of_type_AndroidViewView.getResources());
  ...
  private void d()
  {
    ...
    {
      TextView localTextView = (TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131378788);
  ...
  private void e()
  {
    ...
    do
    {
      ...
      localTextView = null;
      if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) {
        localTextView = (TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131378788);
      }
    ...
    float f1 = i - m - this.jdField_a_of_type_AndroidViewView.getWidth() / 2 - k / 2 - i1 + actn.a(0.0F, this.jdField_a_of_type_AndroidViewView.getResources());
    float f2 = j - n - i2 - actn.a(11.0F, this.jdField_a_of_type_AndroidViewView.getResources());
    ...
    localTextView.getViewTreeObserver().addOnPreDrawListener(new mdf(this, localTextView));
    d();
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout == null) {
      b(localTextView);
    }
    for (;;)
    {
      localTextView.setOnClickListener(new mdg(this));
      return;
      a(localTextView);
    }
  }
  ...
  public void a()
  {
    ...
    muf.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
    d();
  }
