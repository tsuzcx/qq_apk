  ...
  implements View.OnTouchListener
{
  ...
  public static final int[] c = { 2130844599, 2130844602 };
  public static final int[] d = { 2131378785, 2131378786 };
  ...
  static
  {
    jdField_a_of_type_ArrayOfInt = new int[] { 2131363976, 2131363977 };
    jdField_b_of_type_ArrayOfInt = new int[] { 2130844598, 2130844601 };
  }
  
  public zeu(zex paramzex, View paramView, int paramInt)
  {
  ...
  public void a(CharSequence paramCharSequence)
  {
    ...
    for (CharSequence localCharSequence = this.jdField_a_of_type_AndroidWidgetTextView.getHint();; localCharSequence = paramCharSequence)
    {
      ...
      if ((n <= k) || (i == arrayOfFloat1.length - 1))
      {
        ...
        ykq.a("Q.qqstory.widget.PollWidgetUtils", "text size = %s", Float.valueOf(arrayOfFloat1[i]));
      }
      for (;;)
      {
        paramCharSequence = zem.a(this.jdField_a_of_type_AndroidWidgetTextView, 2);
        this.jdField_a_of_type_AndroidWidgetTextView.setText(paramCharSequence);
  ...
  {
    if ((a()) || (this.jdField_a_of_type_Zer == null) || (!this.jdField_a_of_type_Zex.a())) {
