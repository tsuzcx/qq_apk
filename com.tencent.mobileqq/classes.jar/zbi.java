...
public class zbi
{
  ...
  {
    return zbb.c("certified_account_download_pics");
  }
  ...
  public static String a(long paramLong)
  {
    ...
    if (((Time)localObject1).yearDay == i - 1) {
      return BaseApplicationImpl.getApplication().getString(2131719735);
    }
    return ((Time)localObject1).month + 1 + BaseApplicationImpl.getApplication().getString(2131693843) + ((Time)localObject1).monthDay + BaseApplicationImpl.getApplication().getString(2131691333);
  }
  ...
  public static String a(Bitmap paramBitmap)
  {
    ...
    //   38: iconst_2
    //   39: invokestatic 226	bfuc:encodeToString	([BI)Ljava/lang/String;
    //   42: astore_0
    //   43: aload_0
    //   44: astore_1
    //   45: aload_2
