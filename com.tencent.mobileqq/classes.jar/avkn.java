  ...
  extends aodb
{
  ...
  public avkn(Context paramContext)
  {
  ...
  public void b(boolean paramBoolean, Object paramObject)
  {
    ...
    Object localObject = avkh.a(localContext);
    if ((localObject != null) && (((bisl)localObject).isShowing())) {
      ((bisl)localObject).dismiss();
    }
    label124:
    int j;
    if ((paramBoolean) && ((paramObject instanceof Object[])))
    {
      ...
      if (arrayOfObject.length >= 5)
      {
        ...
        for (paramObject = (String)arrayOfObject[3];; paramObject = null)
        {
          ...
          avkh.a(localContext, (byte[])localObject, j);
          avkh.b.set(false);
          return;
          i = -1;
          break;
    ...
    {
    default: 
      QQToast.a(localContext, 1, anvx.a(2131704954), 0).a();
      avkh.b.set(false);
      return;
    case 1: 
      label234:
      ...
      ((Bundle)localObject).putInt("key_hiboom_type", avkh.a(j));
      paramObject = new Intent();
      paramObject.putExtras((Bundle)localObject);
      aupt.a((Activity)localContext, paramObject, 21);
      return;
    }
    if ((localContext instanceof FragmentActivity))
    {
      ...
      if ((((FragmentActivity)localObject).getChatFragment() != null) && (((FragmentActivity)localObject).getChatFragment().a() != null))
      {
        ...
        ((avkh)((BaseChatPie)localObject).app.getManager(QQManagerFactory.HIBOOM_MANAGER)).a((BaseChatPie)localObject, paramObject, j, avkh.a(j));
  ...
  public void c(boolean paramBoolean, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean)
      {
        ...
        if (localObject.length >= 5)
        {
          ...
          for (localObject = (String)localObject[4];; localObject = null)
          {
            ...
            avkh.a(localContext, paramObject, j);
            avkh.b.set(false);
            return;
            i = -1;
            break label102;
          ...
          if (paramBoolean)
          {
            if ((localContext instanceof FragmentActivity))
            {
              ...
              if ((paramObject.getChatFragment() != null) && (paramObject.getChatFragment().a() != null))
              {
                ...
                ((avkh)paramObject.app.getManager(QQManagerFactory.HIBOOM_MANAGER)).a(paramObject, (String)localObject, j, avkh.a(j));
          ...
          ((aocy)((QQAppInterface)paramObject).getBusinessHandler(BusinessHandlerFactory.SVIP_HANDLER)).b();
          return;
        }
        paramBoolean = false;
      }
      while (paramBoolean)
      {
        QQToast.a(localContext, 1, anvx.a(2131704951), 0).a();
        avkh.b.set(false);
        return;
