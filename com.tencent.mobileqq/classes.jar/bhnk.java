...
public class bhnk
{
  ...
  bhmr jdField_a_of_type_Bhmr = null;
  ...
  public void a(Intent paramIntent)
  {
    ...
    do
    {
      ...
      bdmc.a(BaseApplicationImpl.getApplication()).a(null, "jump_act_system_report", true, 0L, 0L, paramIntent, null);
    ...
    return;
    String str;
    if (this.jdField_a_of_type_Bhmr != null)
    {
      str = this.jdField_a_of_type_Bhmr.jdField_b_of_type_JavaLangString;
      paramIntent = this.jdField_a_of_type_Bhmr.jdField_c_of_type_JavaLangString;
    }
    for (;;)
    {
      ...
      bdmc.a(BaseApplicationImpl.getApplication()).a(null, "jump_act_business_report", true, 0L, 0L, (HashMap)localObject, null);
  ...
  public void a(QQAppInterface paramQQAppInterface, Activity paramActivity, Intent paramIntent)
  {
        ...
        do
        {
          do
          {
            do
            {
              ...
              Object localObject = bhnh.a(paramActivity);
    ...
    this.jdField_a_of_type_Bhmr = bhni.a(paramQQAppInterface, paramActivity, this.g);
  }
