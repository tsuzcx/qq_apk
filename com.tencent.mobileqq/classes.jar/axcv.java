...
public class axcv
{
  ...
  {
    axct.a();
    axct.a.jdField_a_of_type_Long = d;
    axct.a.p = g;
    String str1;
    String str2;
    if (axcm.a().e() == 2)
    {
      axct.a.q = e;
      if (d > 0L) {
        axct.a.jdField_a_of_type_Double = (jdField_c_of_type_Long * 1000.0D / d);
      }
      if (jdField_a_of_type_Boolean)
      {
        str1 = axcw.a(jdField_b_of_type_Long);
        str2 = axcw.a(jdField_a_of_type_Long);
        if (d != 0L) {
          break label120;
        }
        axcw.b(jdField_a_of_type_JavaLangString, "transport speed error", new Object[0]);
      }
    }
    label120:
    do
    {
      ...
      axct.a.q = f;
      break;
      axcw.b(jdField_a_of_type_JavaLangString, "transport speed sSizeCache.size = %d, sLogs.size = %d", new Object[] { Integer.valueOf(jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.size()), Integer.valueOf(jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size()) });
      long l1 = jdField_c_of_type_Long * 1000L / d;
      axcw.b(jdField_a_of_type_JavaLangString, "transport speed totalLength = %d B, totalElipse = %d ms", new Object[] { Long.valueOf(jdField_c_of_type_Long), Long.valueOf(d) });
      String str3 = axcw.a(l1);
      axcw.b(jdField_a_of_type_JavaLangString, "transport speed max = %s, min = %s, average = %s", new Object[] { str1, str2, str3 });
    } while (axcm.a().e() != 2);
    axcw.b(jdField_a_of_type_JavaLangString, anvx.a(2131706390), new Object[] { Long.valueOf(e) });
  }
  ...
  public static void a(long paramLong)
  {
    if (jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(Long.valueOf(paramLong)))
    {
      ...
      if (localLong != null)
      {
        axcw.b(jdField_a_of_type_JavaLangString, "transport complete complete = %d", new Object[] { localLong });
  ...
  {
    axcw.b(jdField_a_of_type_JavaLangString, "transport reset", new Object[0]);
  ...
  public static void b(long paramLong1, long paramLong2)
  {
    ...
    axcw.b(jdField_a_of_type_JavaLangString, "transport increment = %d sMaxSpeed = %d, sMinSpeed = %d", new Object[] { Long.valueOf(paramLong2), Long.valueOf(jdField_b_of_type_Long), Long.valueOf(jdField_a_of_type_Long) });
    axcw.b(jdField_a_of_type_JavaLangString, "transport storeSpeed increment = %s", new Object[] { axcw.a(paramLong2) });
  ...
  public static void d()
  {
    if ((jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey("statis_qianchums_start")) && (jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey("statis_qianchums_end")))
    {
      ...
      axcw.b(jdField_a_of_type_JavaLangString, "pure qianchu time cost = %d,pb_pack cost time = %d ", new Object[] { Long.valueOf(h), Long.valueOf(i) });
    }
  }
  ...
  public static void f()
  {
    if ((jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey("statis_qianchums_start")) && (jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey("statis_qianchums_end")))
    {
      ...
      axcw.b(jdField_a_of_type_JavaLangString, "pure qianru time cost = %d ", new Object[] { Long.valueOf(l) });
      axcw.b(jdField_a_of_type_JavaLangString, "pure daoru time cost = %d,pb_unpack cost time = %d ", new Object[] { Long.valueOf(j), Long.valueOf(k) });
    }
  }
}
