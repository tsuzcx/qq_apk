...
{
  public axcv(NearbyProfileFragment paramNearbyProfileFragment, String paramString, int paramInt) {}
  ...
  public void onClick(View paramView)
  {
    ...
    bcek localbcek = new bcek(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyProfileFragment.a.app).a("dc00899").b("grp_lbs").c("face_score_vip").d("expert_click");
    ...
    {
      localbcek.a(new String[] { "", str1, str2, localObject }).a();
