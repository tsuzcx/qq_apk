  ...
  extends bcjp
{
  ...
  public bcle()
  {
    this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new bclf(this);
  }
  ...
  public static String a(AbsShareMsg paramAbsShareMsg, String paramString)
  {
    ...
    } while ((!(localObject1 instanceof bcgx)) || (((bcgx)localObject1).a == null) || (((bcgx)localObject1).a.isEmpty()));
    Object localObject1 = ((bcgx)localObject1).a.iterator();
    label191:
    if (((Iterator)localObject1).hasNext())
    {
      localObject2 = (bcgw)((Iterator)localObject1).next();
      if ((paramString.equals("cover")) && ((localObject2 instanceof bciz)))
      {
    ...
    for (;;)
    {
      if (!TextUtils.isEmpty(paramAbsShareMsg))
      {
        ...
        if ((!paramString.equals("summary")) || (!(localObject2 instanceof bclv))) {
          break label301;
        }
        paramAbsShareMsg = StructMsgForGeneralShare.getSummary((bcgw)localObject2);
        break label231;
        label295:
        break label191;
      }
  ...
  void a()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg != null) && (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.message != null))
    {
      ...
      {
        localObject = (AbsShareMsg)bchh.a(((MessageRecord)localObject).msgData);
  ...
  {
    Object localObject = new bclh(this);
    Resources localResources = paramContext.getResources();
    View localView;
    int i;
    label122:
    int j;
    if ((paramView != null) && ((paramView instanceof RelativeLayout)) && (paramView.findViewById(2131364022) != null) && ((paramView.getTag() instanceof bclh)))
    {
      localObject = (bclh)paramView.getTag();
      localView = paramView;
      paramView = (View)localObject;
      a();
      boolean bool = paramBundle.getBoolean("isSend", true);
      paramBundle = (BubbleViewLayout)localView.findViewById(2131364022);
      i = 19;
      ...
      paramView.jdField_a_of_type_AndroidWidgetTextView.setPadding(AIOUtils.dp2px(9.0F, localResources), 0, AIOUtils.dp2px(i, localResources), 0);
      paramView.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setPadding(AIOUtils.dp2px(9.0F, localResources), AIOUtils.dp2px(3.0F, localResources), AIOUtils.dp2px(i, localResources), 0);
      ...
      paramBundle.setMargins(AIOUtils.dp2px(18.0F, localResources), 0, 0, 0);
      paramView.jdField_a_of_type_AndroidWidgetLinearLayout.setPadding(AIOUtils.dp2px(19.5F, localResources), 0, AIOUtils.dp2px(10.0F, localResources), 0);
      label332:
      paramBundle = localResources.getDrawable(2130850385);
    ...
    for (;;)
    {
      ...
      paramContext = new bclg(this, paramContext, new String(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.mMsgActionData), this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.mMsgUrl);
      ...
      return localView;
      localView = LayoutInflater.from(paramContext).inflate(2131559634, null);
      ((bclh)localObject).jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localView.findViewById(2131365187));
      ((bclh)localObject).jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131378707));
      ((bclh)localObject).jdField_a_of_type_ComTencentWidgetSingleLineTextView = ((SingleLineTextView)localView.findViewById(2131378011));
      ((bclh)localObject).jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localView.findViewById(2131364022));
      ((bclh)localObject).jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localView.findViewById(2131362322));
      ((bclh)localObject).jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)localView.findViewById(2131364834));
      ((bclh)localObject).jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131362321));
      ((bclh)localObject).c = ((RelativeLayout)localView.findViewById(2131364070));
      ((bclh)localObject).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131364063));
      ...
      break label332;
      paramView.jdField_a_of_type_AndroidWidgetTextView.setPadding(AIOUtils.dp2px(i, localResources), 0, AIOUtils.dp2px(9.0F, localResources), 0);
      paramView.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setPadding(AIOUtils.dp2px(i, localResources), AIOUtils.dp2px(3.0F, localResources), AIOUtils.dp2px(9.0F, localResources), 0);
      paramBundle = (ViewGroup.MarginLayoutParams)paramView.jdField_a_of_type_AndroidWidgetRelativeLayout.getLayoutParams();
      if (j != 0)
      {
        ...
        paramBundle.setMargins(0, 0, AIOUtils.dp2px(18.0F, localResources), 0);
        paramView.jdField_a_of_type_AndroidWidgetLinearLayout.setPadding(AIOUtils.dp2px(10.0F, localResources), 0, AIOUtils.dp2px(19.5F, localResources), 0);
        break label332;
      }
      paramBundle.setMargins(0, 0, 0, 0);
      break label332;
