...
public class afni
  extends BaseAdapter
{
  private afni(RDBaseListLayout paramRDBaseListLayout) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localObject1 = ((afnj)localObject1).a;
        break;
        this.a.a(paramInt, localObject2, localObject1);
        localObject2 = ((afnk)localObject1).a();
        if (localObject2 != null) {
          ((View)localObject2).setTag(new afnj(this.a, paramInt, localObject1));
        }
