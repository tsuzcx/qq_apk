...
public class afad
  extends ascz
{
  public afad(TeamWorkDocEditBrowserActivity.TeamWorkDocEditBrowserFragment paramTeamWorkDocEditBrowserFragment) {}
  ...
  public void onResponse(Bundle paramBundle)
  {
    ...
    if ((!TextUtils.isEmpty(str)) && (TeamWorkDocEditBrowserActivity.TeamWorkDocEditBrowserFragment.a(this.a) != null) && (TeamWorkDocEditBrowserActivity.TeamWorkDocEditBrowserFragment.a(this.a).a()))
    {
      ...
      if (this.a.getIntent().getStringExtra("tdsourcetag") != null)
      {
        ...
        str = becr.b(str, (String)localObject);
        ...
        for (;;)
        {
          beeg.a("WebLog_WebViewFragment", "get_url_time", String.valueOf(l) + " - url:" + str);
          return;
    ...
    if ((Math.abs(i) == 115) && (!TextUtils.isEmpty((CharSequence)localObject)))
    {
      ...
      for (;;)
      {
        beeg.a("WebLog_WebViewFragment", "get_url_time", String.valueOf(l) + " - redirectUrl:" + (String)localObject);
        return;
        becr.a(paramBundle, "0X8009ED6");
    ...
    if (TeamWorkDocEditBrowserActivity.TeamWorkDocEditBrowserFragment.a(this.a, null)) {
      beeg.a(null, "0X800A755");
    }
    beeg.a("WebLog_WebViewFragment", "get_url_time", "retCode = " + i + " errorStr = " + str);
  }
}
