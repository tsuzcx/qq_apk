...
public class lui
  implements alxr, Handler.Callback, Manager
{
  public alxo a;
  ...
  public lui(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaLangObject = new Object();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper(), this);
    this.jdField_a_of_type_Alxo = ((alxo)paramQQAppInterface.getManager(191));
    this.jdField_a_of_type_Alxo.a(this);
  }
  ...
  public void a(AVRedPacketConfig paramAVRedPacketConfig, boolean paramBoolean)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      lwf locallwf = this.jdField_a_of_type_Lwf;
      if (locallwf != null) {}
      try
      {
        this.jdField_a_of_type_Lwf.a(true, paramAVRedPacketConfig);
  ...
  public void a(lwf paramlwf)
  {
    ...
    ((ayxs)localObject).a(this.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.resURL);
    ((ayxs)localObject).a(this.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.musicResUrl);
    localObject = a();
    if (localObject != null)
    {
      ((MqqHandler)localObject).post(new AVRedPacketConfigManager.1(this, paramlwf));
      return;
    }
  ...
  public void b(lwf paramlwf)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      this.jdField_a_of_type_Lwf = paramlwf;
      if (!this.jdField_a_of_type_Boolean)
      {
        paramlwf = this.jdField_a_of_type_Lwf;
        if (paramlwf == null) {}
      }
      try
      {
        this.jdField_a_of_type_Lwf.a(true, this.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig);
        return;
      }
      catch (RemoteException paramlwf)
      {
        for (;;)
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.d("AVRedPacketConfigManger", 2, "getAVRedPacketConfig,error    ", paramlwf);
          }
        }
      }
    }
  ...
  {
    this.jdField_a_of_type_Alxo.b(this);
    a("onDestroy");
  }
}
