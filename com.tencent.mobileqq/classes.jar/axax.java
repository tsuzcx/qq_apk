  ...
  implements axaw
{
  ...
  public axax(QQAppInterface paramQQAppInterface)
  {
  ...
  public ReqItem a(int paramInt)
  {
    ...
    {
      xop localxop = this.app.a.a(this.jdField_a_of_type_ComTencentQphoneBaseRemoteToServiceMsg.getServiceCmd());
      ...
      if (localxop != null)
      {
        ...
        localObject1 = localObject2;
        if (localxop.a(this.jdField_a_of_type_ComTencentQphoneBaseRemoteToServiceMsg, localUniPacket))
        {
