  ...
  extends QIMEffectCameraCaptureUnit
{
  ...
  public bncq(boyn paramboyn, boym paramboym)
  {
    super(paramboyn, paramboym);
    this.jdField_a_of_type_Boyf = new boyf(10012, 105, 11);
  ...
  public void I()
  {
    ...
    localIntent.putExtras(this.jdField_a_of_type_Boyn.a().getIntent().getExtras());
    localIntent.putExtra("qq_sub_business_id", this.jdField_a_of_type_Boyf.c);
    localIntent.putExtra("entrance_type", this.jdField_a_of_type_Boyf.jdField_b_of_type_Int);
    ...
    localIntent.putExtra("ALBUM_NAME", bgkb.RECENT_ALBUM_NAME);
    ...
    localActivity.overridePendingTransition(2130772302, 2130771990);
  }
  ...
  public View a()
  {
    ...
    Object localObject1 = befl.a(this.jdField_a_of_type_Boyn.a().getIntent().getExtras());
    ...
    localObject1 = this.jdField_a_of_type_Boyn.a().getIntent().getExtras();
    try
    {
      ...
      this.jdField_a_of_type_Boyn.a().getIntent().putExtras((Bundle)localObject1);
    }
  ...
  protected baou a()
  {
    ...
    if (bcjb.r > 2000000)
    {
      localbaou.j(2000000);
      bcjb.r = 2000000;
      yqp.b("QIMTribeEffectsCameraCaptureUnit", "maxrate:" + bcjb.r);
    }
    localbaou.b(false);
    return localbaou;
  }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    {
      return;
      if (paramInt1 != bedu.jdField_a_of_type_Int) {
        break label87;
      }
      if (paramInt2 != -1) {
        break;
    ...
    if ((paramInt1 == 10012) && (paramInt2 == -1))
    {
      ...
      localActivity.startActivityForResult(localIntent, bedu.jdField_a_of_type_Int);
      return;
    }
    yqp.d("QIMTribeEffectsCameraCaptureUnit", "onActivityResult, requestCode=%d, resultCode=%d, data=%s", new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), paramIntent });
  }
  ...
  public void a(CameraCaptureView.VideoCaptureResult paramVideoCaptureResult, LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    if (this.jdField_a_of_type_Boyf.jdField_b_of_type_Int != 102)
    {
      ...
      bool2 = true;
      localObject = new boyl().a(false).e(bool1).f(bool2).g(true).h(this.h).a();
      localBundle = this.jdField_a_of_type_Boyn.a().getIntent().getExtras();
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      a(this.jdField_a_of_type_Boyn.a());
    }
  }
  
  protected void w()
  {
    ThreadManager.post(new QIMTribeEffectsCameraCaptureUnit.1(this, this.jdField_a_of_type_Boyn.a()), 5, null, true);
  }
}
