  ...
  implements Manager
{
  ...
  public azko(QQAppInterface paramQQAppInterface)
  {
  ...
  private MessageForTroopReward a(String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3, int paramInt3)
  {
    ...
    localMessageForTroopReward.msgUid = awbk.a(paramInt1);
    localMessageForTroopReward.msg = bado.a(null);
    ...
    localMessageForTroopReward.time = awao.a();
