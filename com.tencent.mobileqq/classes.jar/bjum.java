  ...
  implements Handler.Callback, View.OnClickListener
{
    ...
    if (tcs.f())
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        if (tcs.h())
        {
          ...
          tcs.d();
          vei.a("video_edit", "exp_qztip", 0, 0, new String[0]);
        }
      }
    }
    for (;;)
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryViewPressDarkImageButton = ((PressDarkImageButton)a(2131376774));
  ...
  public void a(int paramInt, @NonNull bkld parambkld)
  {
    ...
    ved.d("Q.qqstory.publish.edit.EditSyncQzonePart", "story_sync_qzone : %s", new Object[] { Boolean.valueOf(bool) });
    parambkld.a.putExtra("story_sync_qzone", Boolean.valueOf(bool));
  }
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131376774: 
      if (this.jdField_a_of_type_Bjxn.a() != null) {
        this.jdField_a_of_type_Bjxn.a().a.add(Integer.valueOf(11));
      }
      bjkv.a(paramView, 200L, new bjun(this));
      if (this.jdField_a_of_type_Boolean) {}
      for (paramView = "1";; paramView = "2")
      {
        vei.a("video_edit", "clk_qzone", 0, 0, new String[] { paramView });
        this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
        this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
        this.jdField_a_of_type_AndroidOsHandler.removeMessages(0);
        return;
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
    this.jdField_a_of_type_AndroidOsHandler.removeMessages(0);
    vei.a("video_edit", "clk_qztip", 0, 0, new String[0]);
  }
}
