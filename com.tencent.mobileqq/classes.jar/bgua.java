  ...
  implements azts
{
  ...
  private aztr jdField_a_of_type_Aztr;
  private Runnable jdField_a_of_type_JavaLangRunnable = new VoicePlayer.1(this);
  private String jdField_a_of_type_JavaLangString;
  private ArrayList<bgub> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private boolean jdField_a_of_type_Boolean;
  private int jdField_b_of_type_Int;
  private boolean jdField_b_of_type_Boolean;
  
  public bgua(Context paramContext, int paramInt)
  {
    this.jdField_a_of_type_Aztr = new AmrPlayer(paramContext, paramInt);
    this.jdField_a_of_type_Int = 1;
    this.jdField_b_of_type_Int = 1;
  }
  
  public bgua(String paramString, Handler paramHandler)
  {
    this(paramString, paramHandler, 0);
  }
  
  public bgua(String paramString, Handler paramHandler, int paramInt)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_AndroidOsHandler = paramHandler;
    if (paramInt == 0) {
      this.jdField_a_of_type_Aztr = new AmrPlayer();
    }
    for (this.jdField_b_of_type_Int = 2;; this.jdField_b_of_type_Int = 3)
    {
      this.jdField_a_of_type_Int = 1;
      return;
      this.jdField_a_of_type_Aztr = new SilkPlayer();
    }
  }
    ...
    for (this.jdField_a_of_type_Int = 8;; this.jdField_a_of_type_Int = 4)
    {
      if (this.jdField_a_of_type_Aztr != null)
      {
        ...
        if (this.jdField_a_of_type_Int == 4) {
          i = this.jdField_a_of_type_Aztr.b();
        }
      ...
      while (localIterator.hasNext()) {
        ((bgub)localIterator.next()).a(this.jdField_a_of_type_Int, this.jdField_a_of_type_JavaLangString, i);
      }
    }
  }
  ...
  {
    if (a()) {
      ((SilkPlayer)this.jdField_a_of_type_Aztr).a(paramaztq);
    }
  }
  ...
  public void a(bgub parambgub)
  {
    if (!this.jdField_a_of_type_JavaUtilArrayList.contains(parambgub)) {
      this.jdField_a_of_type_JavaUtilArrayList.add(parambgub);
    }
  }
  
  public boolean a()
  {
    return (this.jdField_a_of_type_Aztr != null) && ((this.jdField_a_of_type_Aztr instanceof SilkPlayer));
  }
  ...
  public void b()
  {
    if (this.jdField_a_of_type_Int == 1)
    {
      try
      {
        ...
        {
          this.jdField_a_of_type_Aztr.a(this.jdField_a_of_type_JavaLangString);
          this.jdField_a_of_type_Aztr.g();
        }
        this.jdField_a_of_type_Aztr.a(this);
        this.jdField_a_of_type_Aztr.a();
      }
  ...
  {
    this.jdField_a_of_type_Aztr.b(paramInt);
  }
  ...
  public void c()
  {
    ...
    {
      this.jdField_a_of_type_Int = 2;
      ((AmrPlayer)this.jdField_a_of_type_Aztr).b();
      if (this.jdField_b_of_type_Boolean) {
        bgkl.a(this.jdField_a_of_type_AndroidContentContext, true);
      }
      QLog.d("Q.profilecard.VoicePlayer", 2, "continue to play... for test time=" + System.currentTimeMillis());
  ...
  public void d()
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Aztr.f();
      Iterator localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
      while (localIterator.hasNext()) {
        ((bgub)localIterator.next()).b(this.jdField_a_of_type_JavaLangString, c(), b());
      }
    }
  }
