...
{
  private static bgub jdField_a_of_type_Bgub;
  ...
  {
    jdField_a_of_type_Bgub = parambgub;
  }
  ...
  public Bundle invoke(Bundle paramBundle, RemoteCommand.OnInvokeFinishLinstener paramOnInvokeFinishLinstener)
  {
    ...
    if (i != jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get())
    {
      ...
      if (jdField_a_of_type_Bgub != null) {
        jdField_a_of_type_Bgub.a(jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get());
      }
    }
