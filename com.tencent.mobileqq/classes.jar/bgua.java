  ...
  implements biyn
{
  ...
  protected bguh a;
  protected bisl a;
  bjyh jdField_a_of_type_Bjyh = new bgue(this);
  protected bkzi a;
  protected bkzw a;
  ...
  public bgua(BaseActivity paramBaseActivity, TroopInfoData paramTroopInfoData)
  {
    this(paramBaseActivity, paramTroopInfoData, null);
  }
  
  public bgua(BaseActivity paramBaseActivity, TroopInfoData paramTroopInfoData, bguh parambguh)
  {
    this.jdField_a_of_type_Int = -1;
    this.jdField_b_of_type_Int = -1;
    this.jdField_a_of_type_Aofu = new bgud(this);
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity = paramBaseActivity;
    this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData = paramTroopInfoData;
    if (this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.addObserver(this.jdField_a_of_type_Bjyh);
  ...
  public static Bitmap a(String paramString, Resources paramResources, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    catch (OutOfMemoryError paramString)
    {
      ...
      if (paramBoolean)
      {
        ...
        paramResources = bgyo.a(paramResources, 2130839719);
  ...
  public static String a(String paramString, Context paramContext)
  {
    ...
    if (TextUtils.isEmpty(paramString)) {
      str = paramContext.getString(2131718799);
    }
    return str;
  }
  ...
  public static void a(Activity paramActivity, Bundle paramBundle, int paramInt)
  {
    try
    {
      localAbsShareMsg = new bdnr(StructMsgForGeneralShare.class).c(132).a(paramBundle.getString("summary")).e(paramBundle.getString("targetUrl")).a(1105290942L).a();
      ...
      for (localAbsShareMsg.mSourceName = "NOW";; localAbsShareMsg.mSourceName = "")
      {
        ...
        ((bdnv)localObject).a(paramBundle.getString("imageUrl"), paramBundle.getString("title"), str);
        localAbsShareMsg.addItem((bdnu)localObject);
        ...
        aupt.a(paramActivity, paramBundle, paramInt);
        return;
  ...
  public static void a(Activity paramActivity, MessageForQQStory paramMessageForQQStory, int paramInt)
  {
    try
    {
      AbsShareMsg localAbsShareMsg = new bdnr(StructMsgForGeneralShare.class).c(80).a(paramMessageForQQStory.brief).e("").a();
      ...
      try
      {
        ...
        aupt.a(paramActivity, (Intent)localObject, paramInt);
        if (QLog.isColorLevel())
        {
  ...
  public static List<ShareActionSheetBuilder.ActionSheetItem>[] a(Context paramContext, boolean paramBoolean)
  {
    ...
    ((ShareActionSheetBuilder.ActionSheetItem)localObject).label = paramContext.getString(2131696130);
    ...
    ((ShareActionSheetBuilder.ActionSheetItem)localObject).label = paramContext.getString(2131696143);
    ...
    localArrayList.add(localObject);
    localObject = new ShareActionSheetBuilder.ActionSheetItem();
    ((ShareActionSheetBuilder.ActionSheetItem)localObject).label = paramContext.getString(2131696133);
    ...
    localActionSheetItem.label = paramContext.getString(2131696122);
    ...
    if (paramBoolean)
    {
      ...
      localActionSheetItem.label = paramContext.getString(2131716510);
      localActionSheetItem.icon = 2130842503;
      localActionSheetItem.iconNeedBg = true;
  ...
  public static void b(Activity paramActivity, Bundle paramBundle, int paramInt)
  {
    try
    {
      Object localObject = new bdnr(StructMsgForGeneralShare.class);
      if ("action_mqq".equals(paramBundle.getString("jump_action")))
      {
        localObject = ((bdnr)localObject).c(129).a(paramBundle.getString("summary")).a(1104763709L).a();
      ...
      for (;;)
      {
        ...
        String str = paramBundle.getString("summary");
        localbdnv.a(paramBundle.getString("imageUrl"), paramBundle.getString("title"), str);
        ...
        aupt.a(paramActivity, paramBundle, 21, -1);
        return;
        localObject = ((bdnr)localObject).c(129).a(paramBundle.getString("summary")).e(paramBundle.getString("targetUrl")).a(1104763709L).a();
        ((AbsShareMsg)localObject).mMsgBrief = paramBundle.getString("summary");
        ((AbsShareMsg)localObject).mContentSummary = paramBundle.getString("summary");
        ((AbsShareMsg)localObject).mContentTitle = paramBundle.getString("title");
        ((AbsShareMsg)localObject).mSourceAction = "";
  ...
  private void h()
  {
    ...
    do
    {
      ...
      {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 0, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131719621), 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
        return;
      }
      ...
      {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 0, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131697502), 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
        return;
      }
      localObject = "";
      if (this.jdField_b_of_type_Int == 1)
      ...
      for (;;)
      {
        ...
        bdla.b(localQQAppInterface, "CliOper", "", "", "Grp", (String)localObject, 0, 0, str, "", "", "");
        ...
        if (this.jdField_a_of_type_Bguh != null) {
          this.jdField_a_of_type_Bguh.onShareResp(this.jdField_a_of_type_Int, false);
        }
        this.jdField_a_of_type_Int = -1;
        this.jdField_b_of_type_Int = -1;
    ...
    {
      ((bjyi)localQQAppInterface.getBusinessHandler(BusinessHandlerFactory.QIDIAN_HANDLER)).b(this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopowneruin);
      return;
    }
    Object localObject = (aoep)localQQAppInterface.getBusinessHandler(BusinessHandlerFactory.TROOP_HANDLER);
    ...
    default: 
      return;
    case 0: 
      this.jdField_c_of_type_JavaLangString = bghb.a("", this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, 0);
      l();
      return;
    case 3: 
      i();
  ...
  private void i()
  {
    ...
    for (;;)
    {
      ...
      if (TextUtils.isEmpty((CharSequence)localObject3)) {
        localObject1 = anvx.a(2131715151) + ContactUtils.getTroopMemberNameWithoutRemark(localQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopowneruin);
      }
  ...
  private void j()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopName == null)
    {
      ...
      str1 = anvx.a(2131715147) + ContactUtils.getTroopMemberNameWithoutRemark(localQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopowneruin);
    }
    label338:
    for (;;)
    {
  ...
  private void k()
  {
    ...
    if (bool)
    {
      ...
      localObject1 = String.format(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131718794), new Object[] { localObject2 }) + "(" + this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin + ")" + a();
      ...
      ((Bundle)localObject3).putString("desc", anvx.a(2131715150) + ContactUtils.getTroopMemberNameWithoutRemark(localQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopowneruin));
    }
    for (;;)
    {
      ...
      this.jdField_b_of_type_Int = -1;
      return;
      localObject1 = bghb.a("", this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, 0) + "100";
      break;
      label540:
  ...
  private void l()
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("TroopShareUtility", 2, "shareToMobileQQ isNewTroop = " + bool + ",mNewTroopHeadUrl = " + this.d);
      }
      if ((!bool) || (this.d != null)) {
        break;
      }
    ...
    for (localObject3 = (String)localObject1 + "(" + ((TroopInfo)localObject3).wMemberNum + ")";; localObject3 = localObject1)
    {
      ...
      AbsShareMsg localAbsShareMsg = new bdnr(StructMsgForGeneralShare.class).c(15).a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131717991) + (String)localObject3).a("web", a(), (String)localObject1, (String)localObject1, (String)localObject1).a();
      ...
      for (;;)
      {
        ...
        localbdry.b(1);
        localbdry.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131695920));
        bdnv localbdnv = bdoe.a(2);
        String str = this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.mRichFingerMemo;
        if (TextUtils.isEmpty(str))
        {
          localObject2 = anvx.a(2131715149) + ContactUtils.getTroopMemberNameWithoutRemark(localQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopowneruin);
          label484:
          localbdnv.a((String)localObject1, (String)localObject3, (String)localObject2, 1);
          localAbsShareMsg.addItem(localbdry);
        ...
        for (int i = 21;; i = 3)
        {
          aupt.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, (Intent)localObject2, i);
          if ((this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity instanceof TroopCreateLogicActivity)) {
  ...
  private void m()
  {
    ...
    str1 = String.format(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131693404), new Object[] { str1, a() });
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 2, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131691268), 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
      if (this.jdField_a_of_type_Bguh != null) {
        this.jdField_a_of_type_Bguh.onShareResp(this.jdField_a_of_type_Int, true);
      }
      this.jdField_a_of_type_Int = -1;
      this.jdField_b_of_type_Int = -1;
      return;
  ...
  public void a()
  {
    try
    {
      if ((this.jdField_a_of_type_Bisl == null) && (this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity != null))
      {
  ...
  public void a(bgui parambgui)
  {
    ThreadManager.post(new TroopShareUtility.10(this, parambgui), 8, null, false);
  }
  ...
  public void a(TroopInfoData paramTroopInfoData)
  {
    ...
    bdla.b((QQAppInterface)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getAppRuntime(), "CliOper", "", "", "Grp", "Clk_share_grplink", 0, 0, "", "", "", "");
    this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData = paramTroopInfoData;
    d();
  }
  ...
  protected void b(boolean paramBoolean)
  {
    ...
    default: 
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        str1 = "0";
        localbdlf = new bdlf(null).a("P_CliOper").b("Grp_set").c("Grp_data").d((String)localObject);
    ...
    {
      localbdlf.a(new String[] { str2, localObject, str1 }).a();
      return;
  ...
  protected void d()
  {
    ...
    for (int i = 5;; i = 4)
    {
      ...
      while (j <= i)
      {
        ((List)localObject).add(bkzw.a(j));
        j += 1;
      }
    }
    if ((this.jdField_a_of_type_Bkzw == null) && (this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity != null)) {
      this.jdField_a_of_type_Bkzw = new bkzw(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity);
    }
    if (this.jdField_a_of_type_Bkzw != null) {
      this.jdField_a_of_type_Bkzw.a((List)localObject);
    }
    if (this.jdField_a_of_type_Bkzi == null)
    {
      localObject = new bgub(this);
      if (this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder == null)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder.setOnDismissListener(new bguc(this));
  ...
  public void e()
  {
    this.jdField_a_of_type_Bguh = null;
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.removeObserver(this.jdField_a_of_type_Bjyh);
  ...
  public void f()
  {
    ...
    localIntent.putExtra("title", anvx.a(2131715146));
    int i;
  ...
  public void onWXShareResp(BaseResp paramBaseResp)
  {
    ...
    if (this.jdField_a_of_type_Bguh != null)
    {
      bguh localbguh = this.jdField_a_of_type_Bguh;
      int i = this.jdField_a_of_type_Int;
      if (paramBaseResp.errCode == 0)
      {
        bool = true;
        localbguh.onShareResp(i, bool);
      }
    }
    else
    {
      ...
      case -1: 
      default: 
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 1, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131718766), 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
      }
    }
    for (;;)
    {
      ...
      bool = false;
      break;
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 2, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131718784), 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
    }
  }
}
