...
public class afzf
{
  private static afzf jdField_a_of_type_Afzf;
  private static afzg jdField_a_of_type_Afzg;
  ...
  beyf jdField_a_of_type_Beyf;
  private final Object jdField_a_of_type_JavaLangObject = new Object();
  private boolean jdField_a_of_type_Boolean;
  
  private afzf(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext.getApplicationContext();
    a(paramContext);
  }
  
  public static afzf a(Context paramContext)
  {
    if (jdField_a_of_type_Afzf != null) {
      return jdField_a_of_type_Afzf;
    }
    try
    {
      if (jdField_a_of_type_Afzf == null)
      {
        jdField_a_of_type_Afzf = new afzf(paramContext);
        if (Build.BRAND.equals("Sony")) {
          jdField_a_of_type_Afzf.jdField_a_of_type_Boolean = true;
        }
      }
      paramContext = jdField_a_of_type_Afzf;
      return paramContext;
    }
    finally {}
  }
  ...
  private void a(Context paramContext)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 65	afzf:jdField_a_of_type_Beyf	Lbeyf;
    //   6: astore_1
    //   7: aload_1
    //   8: ifnull +6 -> 14
    //   11: aload_0
    ...
    //   21: getstatic 73	ajed:aY	Ljava/lang/String;
    ...
    //   52: getstatic 73	ajed:aY	Ljava/lang/String;
    ...
    //   93: iconst_0
    //   94: iconst_1
    //   95: invokespecial 103	beyf:<init>	(Ljava/lang/String;IIZI)V
    //   98: putfield 65	afzf:jdField_a_of_type_Beyf	Lbeyf;
    //   101: goto -90 -> 11
    //   104: astore_1
    //   105: ldc 105
    //   107: iconst_2
  ...
  private boolean a(byte[] paramArrayOfByte, long paramLong, BytesBufferPool.BytesBuffer paramBytesBuffer)
  {
    ...
    do
    {
      ...
      {
        return false;
        if (this.jdField_a_of_type_Beyf != null) {
          break;
        }
        a(this.jdField_a_of_type_AndroidContentContext);
      } while (this.jdField_a_of_type_Beyf == null);
      try
      {
        localbeyg = new beyg();
        localbeyg.jdField_a_of_type_Long = paramLong;
        localbeyg.jdField_a_of_type_ArrayOfByte = paramBytesBuffer.data;
        synchronized (this.jdField_a_of_type_JavaLangObject)
        {
          if (!this.jdField_a_of_type_Beyf.a(localbeyg)) {
            return false;
          }
        }
      }
    ...
    } while (!a(paramArrayOfByte, localbeyg.jdField_a_of_type_ArrayOfByte));
    paramBytesBuffer.data = localbeyg.jdField_a_of_type_ArrayOfByte;
    paramBytesBuffer.offset = paramArrayOfByte.length;
    paramBytesBuffer.length = (localbeyg.jdField_a_of_type_Int - paramBytesBuffer.offset);
    return true;
  }
  ...
  public Bitmap a(URL paramURL, axwp paramaxwp)
  {
    return a(paramURL, paramaxwp, null);
  }
  
  public Bitmap a(URL paramURL, axwp paramaxwp, DownloadParams paramDownloadParams)
  {
    Object localObject1;
    ...
    for (??? = "" + ((File)localObject1).length();; ??? = "")
    {
      ...
      try
      {
        ...
        {
          paramaxwp = paramaxwp.a(paramURL);
          if (paramaxwp == null) {
            break label713;
          }
          paramDownloadParams = a(paramaxwp, 70);
          ...
          synchronized (this.jdField_a_of_type_JavaLangObject)
          {
            try
            {
              this.jdField_a_of_type_Beyf.a(l2, localByteBuffer.array());
              if ((QLog.isColorLevel()) && (paramURL.getProtocol().equals("albumthumb"))) {
                QLog.d("AlbumThumbManager", 2, "getThumb bitmap from cache,url:" + paramURL + " cost:" + (SystemClock.uptimeMillis() - l1) + " sizeDisk:" + paramDownloadParams.length + " sizeMemory:" + paramaxwp.getByteCount());
              }
              return paramaxwp;
            }
      ...
      catch (OutOfMemoryError paramaxwp)
      {
        QLog.e("AlbumThumbManager", 2, "decode thumb", paramaxwp);
        if ((QLog.isColorLevel()) && (paramURL.getProtocol().equals("albumthumb"))) {
          QLog.d("AlbumThumbManager", 2, "getThumb bitmap OutOfMemoryError,url:" + paramURL + " cost:" + (SystemClock.uptimeMillis() - l1));
        }
        return null;
        paramaxwp = new BitmapFactory.Options();
        paramaxwp.inPreferredConfig = Bitmap.Config.RGB_565;
        if (paramDownloadParams == null) {}
        for (paramaxwp.inSampleSize = 1;; paramaxwp.inSampleSize = URLState.calculateInSampleSize(paramaxwp, paramDownloadParams.reqWidth, paramDownloadParams.reqHeight))
        {
          paramaxwp = SafeBitmapFactory.decodeByteArray(((BytesBufferPool.BytesBuffer)localObject1).data, ((BytesBufferPool.BytesBuffer)localObject1).offset, ((BytesBufferPool.BytesBuffer)localObject1).length, paramaxwp);
          if ((QLog.isColorLevel()) && (paramURL.getProtocol().equals("albumthumb"))) {
            QLog.d("AlbumThumbManager", 2, "getThumb bitmap from decode,url:" + paramURL + " cost:" + (SystemClock.uptimeMillis() - l1) + " sizeDisk:" + ((BytesBufferPool.BytesBuffer)localObject1).length + " sizeMemory:" + paramaxwp.getByteCount());
          }
          return paramaxwp;
          paramaxwp.inJustDecodeBounds = true;
          SafeBitmapFactory.decodeByteArray(((BytesBufferPool.BytesBuffer)localObject1).data, ((BytesBufferPool.BytesBuffer)localObject1).offset, ((BytesBufferPool.BytesBuffer)localObject1).length, paramaxwp);
          paramaxwp.inJustDecodeBounds = false;
        }
      }
      catch (Throwable paramaxwp)
      {
        for (;;)
        {
          QLog.e("AlbumThumbManager", 2, "decode thumb", paramaxwp);
