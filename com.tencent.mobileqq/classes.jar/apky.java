  ...
  extends apld
{
  ...
  public void a(String paramString)
  {
    ...
    if (BaseApplicationImpl.sProcessId == 1)
    {
      ...
      if (new File(paramString).exists())
      {
        ...
        if (localObject != null)
        {
          ...
          apkr.a((XmlData)localObject, new String[] { "loadState", "Version" });
        }
        QLog.e("ApolloSoLoader_libHandler", 1, "[doOnDownloadSuccess],unzip apollo lib failed!");
        if (i != 0)
        {
          alhp.a(10, 200, 1001, new Object[] { "unzip sava lib failed" });
          alko.a = true;
        }
      }
    }
    for (;;)
    {
      ...
      if (i != 0) {
        alhp.a(10, 200, 0, new Object[] { "libsava so download success" });
      }
      alko.a("after_ApolloSo_downloaded");
    }
  }
