  ...
  implements View.OnClickListener, SeekBar.OnSeekBarChangeListener
{
  ...
  public bayd(Activity paramActivity, baxa parambaxa)
  {
    super(paramActivity, parambaxa);
    this.jdField_b_of_type_JavaLangString = "";
    this.jdField_b_of_type_JavaUtilArrayList = new ArrayList();
    this.jdField_c_of_type_JavaUtilArrayList = new ArrayList();
    this.jdField_a_of_type_Baxa = parambaxa;
  }
  ...
  private VideoPlayParam a(akhh paramakhh)
  {
    ...
    if (!paramakhh.jdField_a_of_type_Boolean)
    {
      ...
      localVideoPlayParam.mSavePath = paramakhh.jdField_a_of_type_AndroidOsBundle.getString("savepath");
      localVideoPlayParam.mFileID = paramakhh.jdField_a_of_type_AndroidOsBundle.getString("fileid");
      localVideoPlayParam.mUrls = paramakhh.jdField_a_of_type_ArrayOfJavaLangString;
      localVideoPlayParam.mCookies = paramakhh.jdField_a_of_type_JavaUtilArrayList;
      localVideoPlayParam.mVideoFormat = 104;
      b(1);
    }
    for (;;)
    {
      localVideoPlayParam.mIsMute = paramakhh.jdField_e_of_type_Boolean;
  ...
  private void a(int paramInt1, int paramInt2, VideoPlayParam paramVideoPlayParam)
  {
    ...
    if (paramInt1 == 2)
    {
      akhh localakhh = new bawr().a(localAIOFileVideoData, localAIOFileVideoData.i);
      if ((localakhh != null) && (localakhh.jdField_a_of_type_ArrayOfJavaLangString != null) && (!bgsp.a(localakhh.jdField_b_of_type_JavaLangString)))
      {
        String[] arrayOfString = localakhh.jdField_a_of_type_ArrayOfJavaLangString;
        ...
        while (i < j)
        {
          ...
          if (!bgsp.a(str2)) {
            InnerDns.getInstance().reportBadIp(localakhh.jdField_b_of_type_JavaLangString, InnerDns.getHostFromUrl(str2), 1005);
          }
          i += 1;
        }
        baxq.a().a();
    ...
    for (;;)
    {
      ...
      if ((!azwt.a(paramInt2, paramVideoPlayParam)) || (this.jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView == null) || (localAIOFileVideoData == null) || (localAIOFileVideoData.jdField_g_of_type_Int >= 2)) {
        break;
      }
  ...
  private void a(int paramInt, boolean paramBoolean)
  {
    ...
    Object localObject = this.jdField_a_of_type_Baxa.getItem(paramInt);
    bawr localbawr;
    if ((localObject != null) && (((RichMediaBrowserInfo)localObject).baseData != null) && (((RichMediaBrowserInfo)localObject).baseData.getType() == 103))
    {
      ...
      localbawr = new bawr();
      if ((!localbawr.a((AIOFileVideoData)localObject)) && (!((AIOFileVideoData)localObject).jdField_d_of_type_Boolean))
      {
        localbawr.a((AIOFileVideoData)localObject, (bawh)RichMediaBrowserManager.getInstance().getProvider());
        this.jdField_a_of_type_Baxa.a((AIOFileVideoData)localObject);
        this.jdField_a_of_type_Baxa.a(((AIOFileVideoData)localObject).jdField_a_of_type_Long, ((AIOFileVideoData)localObject).jdField_a_of_type_Int, 4);
        updateUI();
      }
    }
    else
    ...
    a(localbawr.a((AIOFileVideoData)localObject, ((AIOFileVideoData)localObject).i));
  ...
  private void a(Bitmap paramBitmap)
  {
    ...
    //   25: return
    //   26: invokestatic 447	com/tencent/common/app/BaseApplicationImpl:getApplication	()Lcom/tencent/common/app/BaseApplicationImpl;
    //   29: invokevirtual 451	com/tencent/common/app/BaseApplicationImpl:getFilesDir	()Ljava/io/File;
    //   32: invokevirtual 456	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   35: astore_3
    //   36: new 453	java/io/File
    //   39: dup
    //   40: new 287	java/lang/StringBuilder
    //   43: dup
    //   44: invokespecial 288	java/lang/StringBuilder:<init>	()V
    //   47: aload_3
    //   48: invokevirtual 294	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   51: getstatic 459	java/io/File:separator	Ljava/lang/String;
    //   54: invokevirtual 294	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   57: ldc_w 461
    //   60: invokevirtual 294	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   63: invokevirtual 301	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   66: invokespecial 464	java/io/File:<init>	(Ljava/lang/String;)V
    //   69: astore_3
    //   70: aload_3
    //   71: invokevirtual 467	java/io/File:exists	()Z
    //   74: ifne +8 -> 82
    //   77: aload_3
    //   78: invokevirtual 470	java/io/File:createNewFile	()Z
    //   81: pop
    //   82: aload_0
    //   83: aload_3
    //   84: invokevirtual 456	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   87: putfield 42	bayd:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   90: invokestatic 66	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   93: ifeq +32 -> 125
    //   96: ldc 68
    //   98: iconst_2
    //   99: new 287	java/lang/StringBuilder
    //   102: dup
    //   103: invokespecial 288	java/lang/StringBuilder:<init>	()V
    //   106: ldc_w 472
    //   109: invokevirtual 294	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   112: aload_0
    //   113: getfield 42	bayd:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   116: invokevirtual 294	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   119: invokevirtual 301	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   122: invokestatic 74	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   125: aload_1
    //   126: aload_0
    //   127: getfield 42	bayd:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   130: invokestatic 477	atwl:a	(Landroid/graphics/Bitmap;Ljava/lang/String;)Z
    //   133: pop
    //   134: new 44	java/util/ArrayList
    //   137: dup
    //   138: invokespecial 47	java/util/ArrayList:<init>	()V
    //   141: astore 6
    //   143: new 479	android/util/SparseArray
    //   146: dup
    //   147: iconst_2
    //   148: invokespecial 481	android/util/SparseArray:<init>	(I)V
    //   151: astore 7
    //   153: aload_1
    //   154: iconst_1
    //   155: iconst_3
    //   156: aload 7
    //   158: invokestatic 486	zuc:a	(Landroid/graphics/Bitmap;ZILandroid/util/SparseArray;)I
    //   161: istore_2
    //   162: iload_2
    //   163: invokestatic 489	zuc:a	(I)Z
    //   166: ifeq +98 -> 264
    ...
    //   184: aload 7
    //   186: iconst_1
    //   187: invokevirtual 495	android/util/SparseArray:get	(I)Ljava/lang/Object;
    //   190: astore_1
    //   191: aload_1
    //   192: instanceof 497
    //   195: ifeq +242 -> 437
    //   198: aload_1
    //   199: checkcast 497	android/util/Pair
    //   202: astore_3
    //   203: new 499	org/json/JSONObject
    //   206: dup
    //   207: invokespecial 500	org/json/JSONObject:<init>	()V
    //   210: astore_1
    //   211: aload_1
    //   212: ldc_w 502
    //   215: aload_3
    //   216: getfield 506	android/util/Pair:second	Ljava/lang/Object;
    //   219: invokestatic 509	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   222: invokevirtual 512	java/lang/String:trim	()Ljava/lang/String;
    //   225: invokevirtual 516	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   228: pop
    //   229: aload_1
    //   230: ldc_w 518
    //   233: aload_3
    //   234: getfield 521	android/util/Pair:first	Ljava/lang/Object;
    //   237: invokestatic 509	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   240: invokevirtual 512	java/lang/String:trim	()Ljava/lang/String;
    //   243: invokevirtual 516	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   246: pop
    //   247: aload_1
    ...
    //   258: aload_1
    //   259: iconst_0
    //   260: invokestatic 526	bgrr:a	(ILjava/util/ArrayList;Ljava/lang/String;I)Lcom/tencent/mobileqq/utils/ShareActionSheetBuilder$ActionSheetItem;
    //   263: pop
    //   264: iload_2
    //   265: invokestatic 528	zuc:b	(I)Z
    //   268: ifeq +74 -> 342
    ...
    //   286: aload 7
    //   288: iconst_2
    //   289: invokevirtual 495	android/util/SparseArray:get	(I)Ljava/lang/Object;
    //   292: astore_3
    //   293: aload 5
    //   295: astore_1
    //   296: aload_3
    ...
    //   300: ifeq +25 -> 325
    //   303: aload_3
    //   304: checkcast 383	java/lang/String
    //   307: astore_3
    //   308: new 499	org/json/JSONObject
    //   311: dup
    //   312: invokespecial 500	org/json/JSONObject:<init>	()V
    //   315: astore_1
    //   316: aload_1
    //   317: ldc_w 532
    //   320: aload_3
    //   321: invokevirtual 516	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   324: pop
    //   325: aload_1
    ...
    //   336: aload_1
    //   337: iconst_0
    //   338: invokestatic 526	bgrr:a	(ILjava/util/ArrayList;Ljava/lang/String;I)Lcom/tencent/mobileqq/utils/ShareActionSheetBuilder$ActionSheetItem;
    //   341: pop
    //   342: aload 6
    //   344: invokevirtual 535	java/util/ArrayList:isEmpty	()Z
    //   347: ifeq +64 -> 411
    ...
    //   366: astore_3
    //   367: aload_3
    //   368: invokevirtual 540	java/io/IOException:printStackTrace	()V
    //   371: goto -237 -> 134
    //   374: astore_3
    //   375: aconst_null
    //   376: astore_1
    //   377: aload_3
    //   378: invokevirtual 541	org/json/JSONException:printStackTrace	()V
    //   381: goto -134 -> 247
    //   384: aload_1
    //   385: invokevirtual 542	org/json/JSONObject:toString	()Ljava/lang/String;
    //   388: astore_1
    //   389: goto -135 -> 254
    //   392: astore_3
    //   393: aload 4
    //   395: astore_1
    //   396: aload_3
    //   397: invokevirtual 541	org/json/JSONException:printStackTrace	()V
    //   400: goto -75 -> 325
    //   403: aload_1
    //   404: invokevirtual 542	org/json/JSONObject:toString	()Ljava/lang/String;
    //   407: astore_1
    //   408: goto -76 -> 332
    //   411: invokestatic 320	com/tencent/mobileqq/app/ThreadManager:getUIHandler	()Lmqq/os/MqqHandler;
    //   414: new 544	com/tencent/mobileqq/richmediabrowser/view/AIOFileVideoView$6
    //   417: dup
    //   418: aload_0
    //   419: aload 6
    //   421: invokespecial 547	com/tencent/mobileqq/richmediabrowser/view/AIOFileVideoView$6:<init>	(Lbayd;Ljava/util/ArrayList;)V
    //   424: invokevirtual 331	mqq/os/MqqHandler:post	(Ljava/lang/Runnable;)Z
    //   427: pop
    //   428: return
    //   429: astore_3
    //   430: goto -34 -> 396
  ...
  {
    paramVideoPlayParam.mCallback = new bayf(this, paramVideoPlayParam);
  }
  ...
  private boolean a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      RichMediaBrowserInfo localRichMediaBrowserInfo = this.jdField_a_of_type_Baxa.getSelectedItem();
      if ((localRichMediaBrowserInfo == null) || (!(localRichMediaBrowserInfo.baseData instanceof AIOFileVideoData))) {
        break label74;
      }
      if (!bgmg.b(((AIOFileVideoData)localRichMediaBrowserInfo.baseData).jdField_c_of_type_JavaLangString)) {
        return false;
      }
  ...
  private void b(int paramInt)
  {
    AIOFileVideoData localAIOFileVideoData = a();
    if (localAIOFileVideoData != null) {
      this.jdField_a_of_type_Baxa.a(localAIOFileVideoData.jdField_a_of_type_Long, localAIOFileVideoData.jdField_a_of_type_Int, paramInt);
    }
  }
  ...
  private void b(AIOFileVideoData paramAIOFileVideoData)
  {
    ...
    if (new bawr().a(paramAIOFileVideoData))
    {
      atvo.a(this.mContext, paramAIOFileVideoData.jdField_c_of_type_JavaLangString);
      return;
    }
  ...
  private void k()
  {
    ...
    j();
    if (this.jdField_a_of_type_Baxa.a(this.jdField_a_of_type_Baxa.getCurrentPosition())) {
      this.jdField_a_of_type_Baxa.a(true);
    }
  }
  
  private void l()
  {
    AIOFileVideoData localAIOFileVideoData = this.jdField_a_of_type_Baxa.a();
    if ((localAIOFileVideoData == null) || (!bgmg.b(localAIOFileVideoData.jdField_c_of_type_JavaLangString))) {}
    for (;;)
    {
      return;
      ...
      this.jdField_a_of_type_Bifg.a(localAIOFileVideoData.jdField_c_of_type_JavaLangString, localAIOFileVideoData.jdField_a_of_type_Long, l);
      if (bgmg.b(localAIOFileVideoData.jdField_b_of_type_JavaLangString)) {
        this.jdField_a_of_type_Bifg.a(localAIOFileVideoData.jdField_b_of_type_JavaLangString, localAIOFileVideoData.jdField_c_of_type_Int, localAIOFileVideoData.jdField_d_of_type_Int);
      }
      if (localAIOFileVideoData.jdField_c_of_type_Int > localAIOFileVideoData.jdField_d_of_type_Int) {}
      for (boolean bool = true; this.jdField_a_of_type_Bifg.a(bool, localAIOFileVideoData.jdField_b_of_type_Int); bool = false)
      {
        this.jdField_a_of_type_Baxa.back();
        return;
      }
    }
  }
  ...
  public void a()
  {
    if (this.mBrowserItemView != null)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)((RelativeLayout)localObject).findViewById(2131371784));
      this.jdField_a_of_type_AndroidWidgetSeekBar = ((SeekBar)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131377106));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131372032));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131372933));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131379074));
      ...
      this.e = ((ImageButton)this.mBrowserItemView.findViewById(2131374214));
      this.e.setContentDescription(anni.a(2131698840));
      this.e.setOnClickListener(this);
      this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)((RelativeLayout)localObject).findViewById(2131380281));
      this.jdField_b_of_type_AndroidWidgetSeekBar = ((SeekBar)this.jdField_c_of_type_AndroidWidgetRelativeLayout.findViewById(2131380283));
      this.jdField_b_of_type_AndroidWidgetSeekBar.setMax(10000);
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_c_of_type_AndroidWidgetRelativeLayout.findViewById(2131380282));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_c_of_type_AndroidWidgetRelativeLayout.findViewById(2131364540));
      this.jdField_c_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
      this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this);
      this.jdField_d_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.mBrowserItemView.findViewById(2131363985));
      ...
      this.jdField_d_of_type_AndroidWidgetImageButton = ((ImageButton)this.mBrowserItemView.findViewById(2131374221));
      this.jdField_d_of_type_AndroidWidgetImageButton.setOnClickListener(this);
      this.jdField_a_of_type_AndroidViewView = this.mBrowserItemView.findViewById(2131380806);
      this.mBrowserItemView.findViewById(2131372847).setOnClickListener(this);
      ...
      this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.mBrowserItemView.findViewById(2131372849));
      if (bqcd.b())
      {
  ...
  public void a(int paramInt1, String paramString1, String[] paramArrayOfString, String paramString2, MessageForShortVideo paramMessageForShortVideo, int paramInt2, Bundle paramBundle)
  {
    ...
    RichMediaBrowserInfo localRichMediaBrowserInfo = this.jdField_a_of_type_Baxa.getItem(paramInt1);
    ...
    for (;;)
    {
      ...
      if (localRichMediaBrowserInfo.baseData.getType() == 103)
      {
        ...
        paramMessageForShortVideo = new bawr();
        ...
        if ("I:E".equals(paramString1)) {
          try
          {
            ...
            this.jdField_a_of_type_Baxa.a(paramString2.jdField_a_of_type_Long, paramString2.jdField_a_of_type_Int, 8);
            if (paramString2.jdField_f_of_type_Long == -134L)
            {
              paramString1 = this.mContext.getString(2131718100);
              bool = true;
              if (bool)
              {
                paramString1 = bglp.a(this.mContext, 230, "", paramString1, null, anni.a(2131698877), new baye(this), null);
    ...
    for (;;)
    {
      this.jdField_a_of_type_Baxa.a(paramString2.jdField_a_of_type_Long, paramString2.jdField_a_of_type_Int, 0);
      ...
      this.jdField_a_of_type_Baxa.a(paramString2.jdField_a_of_type_Long, paramString2.jdField_a_of_type_Int, 5);
      a(paramString1);
      return;
  ...
  {
    this.jdField_a_of_type_Baxa.a(paramLong, paramInt, 2);
  }
  ...
  {
    this.jdField_a_of_type_Baxa.a(paramLong, paramInt1, paramInt2, paramString1);
    a(this.jdField_a_of_type_Baxa.getSelectedIndex(), paramString1, paramArrayOfString, paramString2, paramMessageForShortVideo, paramInt3, paramBundle);
  }
  
  public void a(AIOFileVideoData paramAIOFileVideoData)
  {
    this.jdField_a_of_type_ComTencentMobileqqWidgetShareShareActionSheet.setItemClickListenerV2(new bayg(this, paramAIOFileVideoData));
  }
  ...
  public void a(AIOFileVideoData paramAIOFileVideoData, int paramInt)
  {
    ...
    bgrr.a(2, this.jdField_b_of_type_JavaUtilArrayList);
    bgrr.a(27, this.jdField_b_of_type_JavaUtilArrayList);
    bgrr.a(39, this.jdField_c_of_type_JavaUtilArrayList);
    bgrr.a(6, this.jdField_c_of_type_JavaUtilArrayList);
    if ((bawe.a().g()) && (!TextUtils.isEmpty(bawe.a().c()))) {
      bgrr.a(54, this.jdField_c_of_type_JavaUtilArrayList);
    }
    ...
    for (;;)
    {
      ...
      paramAIOFileVideoData = this.jdField_a_of_type_Baxa.a(paramAIOFileVideoData, this.mContext);
  ...
  public boolean b()
  {
    ...
    {
      AIOFileVideoData localAIOFileVideoData = this.jdField_a_of_type_Baxa.a();
      if ((localAIOFileVideoData != null) && (!bawe.a().c()) && (atwl.b(localAIOFileVideoData.jdField_c_of_type_JavaLangString))) {
        return true;
      }
    }
    return false;
  ...
  public void bindView(int paramInt)
  {
    ...
    RichMediaBrowserInfo localRichMediaBrowserInfo = this.jdField_a_of_type_Baxa.getItem(paramInt);
    if ((localRichMediaBrowserInfo == null) || (localRichMediaBrowserInfo.baseData == null)) {
      return;
    }
    Object localObject;
    ...
    if (localRichMediaBrowserInfo.baseData.getType() == 103)
    {
      localObject = this.jdField_a_of_type_Baxa.a();
      ...
      localbawr = new bawr();
      localObject = (Drawable)this.jdField_a_of_type_Baxa.mActiveDrawable.get(Integer.valueOf(paramInt));
      if (!localbawr.b(localAIOFileVideoData)) {
        break label346;
      }
    }
    for (;;)
    {
      ...
      this.mBrowserItemView.setId(2131374182);
      ...
      this.jdField_a_of_type_ComTencentRichmediabrowserViewGalleryUrlImageView.setContentDescription(this.mContext.getString(2131691433));
      if (localbawr.b(localAIOFileVideoData)) {
      ...
      localObject = new bayh(this);
      ((bayh)localObject).jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView = this.jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView;
      ...
      this.jdField_a_of_type_Baxa.onLoadFinish(paramInt, true);
    }
    label373:
    if (!TextUtils.isEmpty(localAIOFileVideoData.jdField_b_of_type_JavaLangString))
    {
      ...
      this.jdField_a_of_type_Baxa.mActiveDrawable.put(Integer.valueOf(paramInt), (URLDrawable)localObject);
    }
    label499:
    for (;;)
    {
      break;
      localObject = BaseApplicationImpl.getApplication().getResources().getDrawable(2130838062);
      break;
    }
  }
  ...
  public void buildParams(Intent paramIntent)
  {
    ...
    this.jdField_a_of_type_Int = (bcor.a(this.mContext) / 2);
  }
  ...
  public void e(boolean paramBoolean)
  {
    ...
    if (QLog.isColorLevel())
    {
      ...
      if (this.jdField_a_of_type_Baxa.a() == null) {
        break label93;
      }
    }
    label93:
    for (boolean bool = this.jdField_a_of_type_Baxa.a().b();; bool = false)
    {
      ...
      b(false);
      this.jdField_a_of_type_Baxa.b(false);
      return;
    }
    if ((this.jdField_a_of_type_Baxa.a() != null) && (this.jdField_a_of_type_Baxa.a().b()))
    {
      this.jdField_a_of_type_Baxa.a().jdField_a_of_type_Boolean = false;
      this.jdField_a_of_type_Baxa.d();
      this.jdField_a_of_type_Baxa.e();
      i(false);
      return;
    }
    showContentView(false);
  ...
  {
    if (((paramView instanceof RelativeLayout)) && ((paramView.getTag() instanceof bayh)))
    {
      this.mBrowserItemView = ((RelativeLayout)paramView);
      this.jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView = ((bayh)paramView.getTag()).jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView;
    }
    for (;;)
    {
  ...
  public void i()
  {
    a(this.jdField_a_of_type_Baxa.getCurrentPosition(), true);
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        this.jdField_a_of_type_Baxa.i();
        g();
        break;
        QLog.i("AIOFileVideoView<FileAssistant>XOXO", 1, "video pause, try PLAY!");
        new bawr().a(localAIOFileVideoData, this.mContext, this);
      }
      if (this.jdField_a_of_type_Baxa.b())
      {
        if (this.jdField_a_of_type_Baxa.a().jdField_a_of_type_Boolean)
        {
          this.jdField_a_of_type_Baxa.a().f();
          this.jdField_a_of_type_Baxa.a().jdField_a_of_type_Boolean = false;
          e();
          this.jdField_a_of_type_Baxa.a().a();
        }
        else
        {
          this.jdField_a_of_type_Baxa.a().f();
          this.jdField_a_of_type_Baxa.a().b();
          this.jdField_a_of_type_Baxa.a().jdField_a_of_type_Boolean = true;
          e(true);
        }
      }
      else
      {
        this.jdField_a_of_type_Baxa.back();
        continue;
        localAIOFileVideoData = this.jdField_a_of_type_Baxa.a();
        ...
        if (localbawr.a(localAIOFileVideoData)) {
          this.jdField_a_of_type_Baxa.a(localAIOFileVideoData.jdField_a_of_type_Long, localAIOFileVideoData.jdField_a_of_type_Int, 5);
        }
        for (;;)
        {
          a(this.jdField_a_of_type_Baxa.getCurrentPosition(), false);
          h();
          updateUI();
          break;
          this.jdField_a_of_type_Baxa.a(localAIOFileVideoData.jdField_a_of_type_Long, localAIOFileVideoData.jdField_a_of_type_Int, 1);
        }
        localAIOFileVideoData = this.jdField_a_of_type_Baxa.a();
        if (localAIOFileVideoData != null)
        {
          localAIOFileVideoData.jdField_e_of_type_Boolean = true;
          this.jdField_a_of_type_Baxa.a(localAIOFileVideoData.jdField_a_of_type_Long, localAIOFileVideoData.jdField_a_of_type_Int, 0);
          this.jdField_a_of_type_Baxa.b(localAIOFileVideoData);
          this.jdField_a_of_type_Baxa.back();
          continue;
          l();
          this.jdField_a_of_type_Baxa.k();
          continue;
          d();
          continue;
          c();
          ...
          {
            long l = this.jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView.getCurPlayingPos();
            MiniChatActivity.a(this.mContext, bawe.a().a(), bawe.a().a(), false, 26, localAIOFileVideoData.jdField_d_of_type_Long, l);
          }
          this.jdField_a_of_type_Baxa.l();
          continue;
  ...
  public void onDestroy()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView != null)
    {
      ...
      this.jdField_a_of_type_Baxa.c(a());
    }
    this.jdField_a_of_type_Baxa.getSelectedItem();
  }
  
  public void onDestroyView(int paramInt, View paramView)
  {
    if (this.jdField_a_of_type_Baxa.mActiveDrawable != null) {
      this.jdField_a_of_type_Baxa.mActiveDrawable.remove(Integer.valueOf(paramInt));
    }
  }
  ...
  public void onItemSelected(int paramInt)
  {
    ...
    bawr localbawr = new bawr();
    if ((localAIOFileVideoData.h) && (localbawr.a(localAIOFileVideoData)))
    {
      a(paramInt, true);
      return;
    }
    ...
    if (RichMediaBrowserManager.getInstance().getProvider() != null)
    {
      ...
      {
        this.jdField_a_of_type_Baxa.a(localAIOFileVideoData.jdField_a_of_type_Long, localAIOFileVideoData.jdField_a_of_type_Int, 1);
        localbawr.a(localAIOFileVideoData, (bawh)RichMediaBrowserManager.getInstance().getProvider());
      }
      if ((!bgmg.b(localAIOFileVideoData.jdField_c_of_type_JavaLangString)) && (this.jdField_a_of_type_Baxa.a(this.jdField_a_of_type_Baxa.getCurrentPosition()))) {
        this.jdField_a_of_type_Baxa.a(false);
      }
      updateUI();
    ...
    if ((this.jdField_a_of_type_Baxa.b(paramInt)) && (localRichMediaBrowserInfo.isEnterImage)) {
      a(localbawr.a(localAIOFileVideoData, localAIOFileVideoData.i));
    }
    if ((!bgmg.b(localAIOFileVideoData.jdField_c_of_type_JavaLangString)) && (this.jdField_a_of_type_Baxa.a(this.jdField_a_of_type_Baxa.getCurrentPosition()))) {
      this.jdField_a_of_type_Baxa.a(false);
    }
  ...
  public void onResume()
  {
    ...
    if ((this.jdField_a_of_type_Baxa.b(this.jdField_a_of_type_Baxa.getCurrentPosition())) && (this.jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView != null))
    {
      AIOFileVideoData localAIOFileVideoData = this.jdField_a_of_type_Baxa.a();
  ...
  public void onScrollEnd()
  {
    ...
    label79:
    for (boolean bool = bgmg.b(localAIOFileVideoData.jdField_c_of_type_JavaLangString);; bool = false)
    {
  ...
  public void onStopTrackingTouch(SeekBar paramSeekBar)
  {
    ...
    if ((this.jdField_a_of_type_Baxa.a() != null) && (this.jdField_a_of_type_Baxa.a(this.jdField_a_of_type_Baxa.getCurrentPosition())) && (paramSeekBar != null))
    {
      BrowserLogHelper.getInstance().getGalleryLog().d("AIOFileVideoView<FileAssistant>XOXO", 4, "seek danmaku");
      this.jdField_a_of_type_Baxa.a().a(paramSeekBar.getProgress());
      AIOFileVideoData localAIOFileVideoData = this.jdField_a_of_type_Baxa.a();
      if (localAIOFileVideoData != null) {
        this.jdField_a_of_type_Baxa.a().a(bawc.a(localAIOFileVideoData.jdField_d_of_type_Long, paramSeekBar.getProgress(), this.jdField_a_of_type_Baxa.a(), this.jdField_a_of_type_Baxa.a));
      }
    }
  ...
  public void updateUI()
  {
    int i = 8;
    super.updateUI();
    Object localObject1 = this.jdField_a_of_type_Baxa.a();
    if (localObject1 != null)
    {
      c(b());
      d(a(this.jdField_a_of_type_Baxa.getSelectedItem()));
    ...
    case 5: 
      ...
      {
        return;
        this.jdField_a_of_type_Baxa.onLoadFinish(this.jdField_a_of_type_Baxa.getSelectedIndex(), true);
        g(false);
        localObject2 = this.mContext.getString(2131692456) + "(" + atwl.a(((AIOFileVideoData)localObject1).jdField_g_of_type_Long) + "/" + atwl.a(((AIOFileVideoData)localObject1).jdField_c_of_type_Long) + ")";
        ...
        this.jdField_d_of_type_AndroidWidgetTextView.setText(anni.a(2131698846) + (String)localObject1 + "%");
        ...
        a(false);
        return;
        localObject1 = this.mContext.getString(2131692456) + "(0/" + atwl.a(((AIOFileVideoData)localObject1).jdField_c_of_type_Long) + ")";
  ...
  {
    Object localObject1 = this.jdField_a_of_type_Baxa.getItem(paramInt);
    if ((localObject1 == null) || (((RichMediaBrowserInfo)localObject1).baseData == null) || (paramView == null)) {
      return;
    }
    BaseVideoView localBaseVideoView;
    if ((paramView.getTag() instanceof bayh))
    {
      localBaseVideoView = ((bayh)paramView.getTag()).jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView;
      if (((RichMediaBrowserInfo)localObject1).baseData.getType() == 103)
      {
        ...
        localObject2 = localbawr.a((AIOFileVideoData)localObject2);
        ...
        this.jdField_a_of_type_Baxa.onLoadFinish(paramInt, true);
        this.jdField_a_of_type_Baxa.a().c();
      }
    }
    for (;;)
    {
      ...
      break;
      label196:
      localBaseVideoView.setCoverDrawable(BaseApplicationImpl.getApplication().getResources().getDrawable(2130838062));
      this.jdField_a_of_type_Baxa.onLoadFinish(paramInt, true);
    }
  }
}
