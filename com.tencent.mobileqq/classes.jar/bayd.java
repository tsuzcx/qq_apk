...
class bayd
  extends mmn
{
  bayd(baxz parambaxz, bayf parambayf, int paramInt) {}
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          paramBundle = paramArrayOfByte;
          localObject = new baye(null);
          paramBundle = paramArrayOfByte;
          ((baye)localObject).jdField_a_of_type_Long = (l2 * 1000L + l1);
          paramBundle = paramArrayOfByte;
          ((baye)localObject).jdField_a_of_type_Int = localUrlCheckResult.result.get();
          paramBundle = paramArrayOfByte;
          ((baye)localObject).jdField_b_of_type_Int = localUrlCheckResult.jump_result.get();
          paramBundle = paramArrayOfByte;
          ((baye)localObject).jdField_a_of_type_JavaLangString = localUrlCheckResult.jump_url.get();
          paramBundle = paramArrayOfByte;
          ((baye)localObject).c = localUrlCheckResult.uint32_level.get();
          paramBundle = paramArrayOfByte;
          ((baye)localObject).d = localUrlCheckResult.uint32_sub_level.get();
          paramBundle = paramArrayOfByte;
          ((baye)localObject).e = localUrlCheckResult.uint32_umrtype.get();
          paramBundle = paramArrayOfByte;
          ((baye)localObject).f = localUrlCheckResult.ret_from.get();
          paramBundle = paramArrayOfByte;
          ((baye)localObject).jdField_b_of_type_Long = localUrlCheckResult.operation_bit.get();
          if (paramInt == 0) {
            paramArrayOfByte = (byte[])localObject;
          }
          paramBundle = paramArrayOfByte;
          this.jdField_a_of_type_Baxz.a.put(str, localObject);
          paramInt += 1;
        }
