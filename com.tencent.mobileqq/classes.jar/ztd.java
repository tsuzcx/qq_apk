...
{
  private ztd(QRDisplayActivity paramQRDisplayActivity) {}
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    {
      return false;
      if ((2131374659 == paramView.getId()) && (this.a.jdField_b_of_type_AndroidWidgetImageView != null) && (this.a.a != null))
      {
        this.a.jdField_b_of_type_AndroidWidgetImageView.setAlpha(0.5F);
        this.a.a.setAlpha(0.5F);
      }
      else if ((2131374674 == paramView.getId()) && (this.a.jdField_c_of_type_AndroidWidgetImageView != null) && (this.a.jdField_b_of_type_AndroidWidgetTextView != null))
      {
        ...
        else if ((2131374674 == paramView.getId()) && (this.a.jdField_c_of_type_AndroidWidgetImageView != null) && (this.a.jdField_b_of_type_AndroidWidgetTextView != null))
        {
          ...
          if (this.a.jdField_c_of_type_Int == 2) {
            ...
            default: 
              break;
            case 0: 
              if ((2131374682 == paramView.getId()) && (this.a.d != null) && (this.a.jdField_c_of_type_AndroidWidgetTextView != null))
              {
                this.a.d.setAlpha(0.5F);
                this.a.jdField_c_of_type_AndroidWidgetTextView.setAlpha(0.5F);
              }
              else if ((2131374662 == paramView.getId()) && (this.a.jdField_b_of_type_AndroidWidgetImageView != null) && (this.a.a != null))
              {
                this.a.jdField_b_of_type_AndroidWidgetImageView.setAlpha(0.5F);
                this.a.a.setAlpha(0.5F);
              }
