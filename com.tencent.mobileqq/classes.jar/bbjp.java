...
public class bbjp
{
  private long jdField_a_of_type_Long = (int)ayxe.a();
  ...
  public bbjp a(long paramLong)
  {
    this.jdField_a_of_type_Long = paramLong;
    return this;
  }
  
  public bbjp a(boolean paramBoolean)
  {
  ...
  public Pair<ArrayList<String>, ArrayList<String>> a(List<String> paramList, boolean paramBoolean, Map<String, LocalMediaInfo> paramMap1, Map<String, LocalMediaInfo> paramMap2)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      else
      {
        ...
        {
          int i = bbbx.a((LocalMediaInfo)localObject);
  ...
  public boolean a(Context paramContext, String paramString, boolean paramBoolean1, Map<String, LocalMediaInfo> paramMap1, Map<String, LocalMediaInfo> paramMap2, boolean paramBoolean2)
  {
    ...
    if (i == 1)
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        if (l1 > this.b)
        {
          ...
          label234:
          paramString = String.format(paramContext.getResources().getString(2131690015), new Object[] { "" + paramMap1.format(d1), paramString });
        }
      }
    }
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        label560:
        for (paramMap1 = paramContext.getResources().getString(2131689881);; paramMap1 = paramContext.getResources().getString(2131689882))
        {
          paramBoolean2 = paramBoolean1;
          if (!paramBoolean1) {
            break;
          }
          bfny.a(new SendByFile.1(this, paramContext, paramMap1));
          ...
          paramString = String.format(paramContext.getResources().getString(2131690016), new Object[] { "" + (this.c / 1024L / 1024L + 1L) });
          break label283;
          ...
          if (this.jdField_a_of_type_Boolean) {
            if (paramBoolean2) {
              paramString = String.format(paramContext.getResources().getString(2131689974), new Object[] { "" + this.jdField_a_of_type_Long / 1024L / 1024L });
            }
          }
          for (;;)
          {
            ...
            break;
            if (paramBoolean2) {
              paramString = String.format(paramContext.getResources().getString(2131689975), new Object[] { "" + this.jdField_a_of_type_Long / 1024L / 1024L });
            }
          }
        }
        label574:
