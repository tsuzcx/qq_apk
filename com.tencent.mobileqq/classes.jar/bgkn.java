...
{
  public int a;
  BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new bgkq(this);
  public String a;
  ...
  private int a(int paramInt)
  {
    ...
    if ((localbazo instanceof bbad)) {
      i = ((bbad)localbazo).switchRequestCode(this, (byte)paramInt);
    }
    return i;
  }
  ...
  private void a(int paramInt)
  {
    ...
    int j = this.mRuntime.a().getResources().getDimensionPixelSize(2131167766);
    if (!bfpr.d()) {}
    for (int i = 1; i != 0; i = 0)
    {
      bbmy.a(this.mRuntime.a(), 2131652433, 0).b(j);
      return;
    }
    a();
    switch (paramInt)
    ...
    case 1: 
      ...
      localbfpy.jdField_a_of_type_JavaLangString = this.mRuntime.a().getCurrentAccountUin();
      BaseBusinessAlbumInfo localBaseBusinessAlbumInfo = new BaseBusinessAlbumInfo();
      localBaseBusinessAlbumInfo.jdField_a_of_type_JavaLangString = localbfpy.jdField_a_of_type_JavaLangString;
      ...
      localBaseBusinessAlbumInfo.jdField_b_of_type_JavaLangString = this.mRuntime.a().getString(2131651952);
      bfpr.b(this.mRuntime.a(), localbfpy, localBaseBusinessAlbumInfo, -1, "cover_mall_record_video");
      return;
    }
    QLog.i("CoverStore", 1, "VIDEO_COVER click select record video.");
    bfqv.a(this.mRuntime.a().getLongAccountUin(), this.mRuntime.a(), "cover_mall_record_video", new bgkp(this, j));
  }
      ...
      do
      {
        do
        {
          ...
          for (;;)
          {
            ...
            Object localObject = bgis.a(str);
            if (localObject == null) {
              break;
            }
            double d1 = bgis.a((bgiv)localObject);
            if (d1 > 0.0D)
            {
              ((bgiv)localObject).jdField_a_of_type_Int = ((int)(((bgiv)localObject).jdField_a_of_type_Int / d1));
              ((bgiv)localObject).jdField_b_of_type_Int = ((int)(((bgiv)localObject).jdField_b_of_type_Int / d1));
            }
            localObject = bgis.a(str, ((bgiv)localObject).jdField_a_of_type_Int, ((bgiv)localObject).jdField_b_of_type_Int);
  ...
  private void a(String paramString)
  {
    ...
    ((bfpy)localObject).jdField_a_of_type_JavaLangString = this.mRuntime.a().getAccount();
    paramString.putString("keyAction", "actionSelectPicture");
    paramString.putBoolean("key_need_change_to_jpg", false);
    bfpr.a(this.mRuntime.a(), (bfpy)localObject, paramString, a(3));
  }
    ...
    for (;;)
    {
      ...
      try
      {
        if (i < paramArrayList.size())
        {
          ...
          Object localObject2 = bgis.a((String)localObject1);
          if (localObject2 == null) {
            break label335;
          }
          double d1 = bgis.a((bgiv)localObject2);
          if (d1 > 0.0D)
          {
            ((bgiv)localObject2).jdField_a_of_type_Int = ((int)(((bgiv)localObject2).jdField_a_of_type_Int / d1));
            ((bgiv)localObject2).jdField_b_of_type_Int = ((int)(((bgiv)localObject2).jdField_b_of_type_Int / d1));
          }
          localObject2 = bgis.a((String)localObject1, ((bgiv)localObject2).jdField_a_of_type_Int, ((bgiv)localObject2).jdField_b_of_type_Int);
          ...
          awqm.a(BaseApplication.getContext()).reportTimeKVEvent("Qzone.EventTransformPhotoBase64", (Properties)localObject1, (int)(l2 - l1));
        }
      }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if (paramString3.equals("showStoreButton"))
    {
      ...
      paramJsBridgeListener = (TextView)this.mRuntime.a().findViewById(2131302832);
      if (paramJsBridgeListener != null)
      {
        paramJsBridgeListener.setVisibility(0);
        paramJsBridgeListener.setTextColor(-1);
        paramJsBridgeListener.setText(ajjy.a(2131645841));
        paramJsBridgeListener.setOnClickListener(new bgko(this));
      }
    }
    do
    {
      for (;;)
      {
        ...
        else
        {
          ...
          paramString2 = ajjy.a(2131645839);
      ...
      if (paramString3.equals("leftButtonClick"))
      {
        ...
        ((TextView)this.mRuntime.a().findViewById(2131302804)).performClick();
        return true;
      }
