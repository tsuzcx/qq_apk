...
public class bgkn
{
  ...
  private static void a(String paramString)
  {
    ...
    //   27: iload_1
    //   28: invokevirtual 50	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   31: ldc 162
    ...
    //   43: invokespecial 164	java/io/FileReader:<init>	(Ljava/lang/String;)V
    //   46: astore 6
    //   48: new 166	java/io/BufferedReader
    //   51: dup
    //   52: aload 6
    //   54: sipush 1024
    //   57: invokespecial 169	java/io/BufferedReader:<init>	(Ljava/io/Reader;I)V
    //   60: astore 5
    //   62: aload 5
    //   64: astore 7
    //   66: aload 6
    //   68: astore 9
    //   70: aload 5
    //   72: invokevirtual 172	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   75: astore 8
    //   77: aload 8
    //   79: ifnull +111 -> 190
    //   82: aload 5
    ...
    //   88: astore 9
    //   90: aload 8
    //   92: invokestatic 178	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   95: lstore_3
    //   96: aload 5
    //   98: astore 7
    //   100: aload 6
    //   102: astore 9
    //   104: getstatic 74	bgkn:jdField_a_of_type_Long	J
    //   107: lload_3
    //   108: lcmp
    //   109: ifge +15 -> 124
    //   112: aload 5
    ...
    //   118: astore 9
    //   120: lload_3
    //   121: putstatic 74	bgkn:jdField_a_of_type_Long	J
    //   124: aload 5
    //   126: astore 7
    //   128: aload 6
    //   130: astore 9
    //   132: ldc 36
    //   134: invokestatic 184	java/util/Locale:getDefault	()Ljava/util/Locale;
    //   137: ldc 186
    //   139: iconst_2
    ...
    //   144: iconst_0
    //   145: iload_1
    //   146: invokestatic 192	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   149: aastore
    //   150: dup
    //   151: iconst_1
    //   152: lload_3
    //   153: invokestatic 195	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   156: aastore
    //   157: invokestatic 201	java/lang/String:format	(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   160: invokestatic 66	com/tencent/qqmini/sdk/log/QMLog:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   163: aload 5
    //   165: ifnull +8 -> 173
    //   168: aload 5
    //   170: invokevirtual 204	java/io/BufferedReader:close	()V
    //   173: aload 6
    //   175: ifnull +8 -> 183
    //   178: aload 6
    //   180: invokevirtual 205	java/io/FileReader:close	()V
    //   183: iload_1
    //   184: iconst_1
    //   185: iadd
    //   186: istore_1
    ...
    //   195: astore 5
    //   197: aload 5
    //   199: invokevirtual 208	java/lang/Exception:printStackTrace	()V
    //   202: goto -29 -> 173
    //   205: astore 5
    //   207: aload 5
    //   209: invokevirtual 208	java/lang/Exception:printStackTrace	()V
    //   212: goto -29 -> 183
    //   215: astore 8
    //   217: aload 5
    //   219: astore 7
    ...
    //   223: astore 9
    //   225: aload 8
    //   227: invokevirtual 208	java/lang/Exception:printStackTrace	()V
    //   230: aload 5
    //   232: ifnull +8 -> 240
    //   235: aload 5
    //   237: invokevirtual 204	java/io/BufferedReader:close	()V
    //   240: aload 6
    //   242: ifnull -59 -> 183
    //   245: aload 6
    //   247: invokevirtual 205	java/io/FileReader:close	()V
    //   250: goto -67 -> 183
    //   253: astore 5
    //   255: aload 5
    //   257: invokevirtual 208	java/lang/Exception:printStackTrace	()V
    //   260: goto -77 -> 183
    //   263: astore 5
    //   265: aload 5
    //   267: invokevirtual 208	java/lang/Exception:printStackTrace	()V
    //   270: goto -30 -> 240
    //   273: astore_0
    //   274: aload 9
    //   276: astore 6
    ...
    //   280: ifnull +8 -> 288
    //   283: aload 7
    //   285: invokevirtual 204	java/io/BufferedReader:close	()V
    //   288: aload 6
    //   290: ifnull +8 -> 298
    //   293: aload 6
    //   295: invokevirtual 205	java/io/FileReader:close	()V
    //   298: aload_0
    //   299: athrow
    //   300: astore 5
    //   302: aload 5
    //   304: invokevirtual 208	java/lang/Exception:printStackTrace	()V
    //   307: goto -19 -> 288
    //   310: astore 5
    //   312: aload 5
    //   314: invokevirtual 208	java/lang/Exception:printStackTrace	()V
    //   317: goto -19 -> 298
    //   320: return
    //   321: astore_0
    //   322: aconst_null
  ...
  public static long b()
  {
    ...
    //   2: aconst_null
    //   3: astore_0
    //   4: getstatic 212	bgkn:b	J
    //   7: lconst_0
    //   8: lcmp
    //   9: ifne +138 -> 147
    //   12: new 158	java/io/FileReader
    //   15: dup
    //   16: ldc 214
    ...
    //   26: aload_1
    //   27: sipush 1024
    //   30: invokespecial 169	java/io/BufferedReader:<init>	(Ljava/io/Reader;I)V
    //   33: astore_0
    //   34: aload_0
    //   35: invokevirtual 172	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   38: astore_2
    //   39: aload_2
    //   40: ifnull +24 -> 64
    //   43: aload_2
    //   44: ldc 216
    //   46: invokevirtual 220	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   49: iconst_1
    //   50: aaload
    //   51: invokestatic 223	java/lang/Long:valueOf	(Ljava/lang/String;)Ljava/lang/Long;
    //   54: invokevirtual 226	java/lang/Long:longValue	()J
    //   57: ldc2_w 227
    //   60: lmul
    //   61: putstatic 212	bgkn:b	J
    //   64: aload_0
    //   65: ifnull +7 -> 72
    //   68: aload_0
    //   69: invokevirtual 204	java/io/BufferedReader:close	()V
    //   72: aload_1
    //   73: ifnull +7 -> 80
    //   76: aload_1
    //   77: invokevirtual 205	java/io/FileReader:close	()V
    //   80: getstatic 212	bgkn:b	J
    //   83: lconst_0
    //   84: lcmp
    //   85: ifne +62 -> 147
    //   88: ldc2_w 229
    ...
    //   98: astore_0
    //   99: lconst_0
    //   100: putstatic 212	bgkn:b	J
    //   103: aload_0
    //   104: ifnull +7 -> 111
    //   107: aload_0
    //   108: invokevirtual 204	java/io/BufferedReader:close	()V
    //   111: aload_1
    //   112: ifnull -32 -> 80
    //   115: aload_1
    //   116: invokevirtual 205	java/io/FileReader:close	()V
    //   119: goto -39 -> 80
    //   122: astore_0
    //   123: goto -43 -> 80
    //   126: astore_0
    ...
    //   138: ifnull +7 -> 145
    //   141: aload_1
    //   142: invokevirtual 205	java/io/FileReader:close	()V
    //   145: aload_0
    //   146: athrow
    //   147: getstatic 212	bgkn:b	J
    //   150: lreturn
    //   151: astore_1
    //   152: goto -7 -> 145
    //   155: astore_0
  ...
  {
    // Byte code:
    //   0: getstatic 249	bgkn:c	J
    //   3: lconst_0
    //   4: lcmp
    //   5: ifle +7 -> 12
    //   8: getstatic 249	bgkn:c	J
    //   11: lreturn
    //   12: iconst_0
    //   13: istore_0
    //   14: invokestatic 25	bgkn:b	()I
    //   17: istore_1
    //   18: getstatic 249	bgkn:c	J
    //   21: lconst_0
    //   22: lcmp
    //   23: ifgt +126 -> 149
    //   26: iload_0
    ...
    //   31: aconst_null
    //   32: astore_3
    //   33: new 166	java/io/BufferedReader
    //   36: dup
    //   37: new 158	java/io/FileReader
    //   40: dup
    ...
    //   53: iload_0
    //   54: invokevirtual 50	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   57: ldc 251
    ...
    //   65: invokespecial 164	java/io/FileReader:<init>	(Ljava/lang/String;)V
    //   68: sipush 1024
    //   71: invokespecial 169	java/io/BufferedReader:<init>	(Ljava/io/Reader;I)V
    //   74: astore_2
    //   75: aload_2
    //   76: invokevirtual 172	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   79: astore_3
    //   80: aload_3
    //   81: ifnull +20 -> 101
    //   84: aload_3
    //   85: invokestatic 178	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   88: putstatic 249	bgkn:c	J
    //   91: getstatic 249	bgkn:c	J
    //   94: ldc2_w 227
    //   97: ldiv
    //   98: putstatic 249	bgkn:c	J
    //   101: aload_2
    //   102: ifnull +7 -> 109
    //   105: aload_2
    //   106: invokevirtual 204	java/io/BufferedReader:close	()V
    //   109: iload_0
    //   110: iconst_1
    //   111: iadd
    //   112: istore_0
    ...
    //   118: ifnull -9 -> 109
    //   121: aload_2
    //   122: invokevirtual 204	java/io/BufferedReader:close	()V
    //   125: goto -16 -> 109
    //   128: astore_2
    //   129: goto -20 -> 109
    //   132: astore 4
    ...
    //   140: ifnull +7 -> 147
    //   143: aload_3
    //   144: invokevirtual 204	java/io/BufferedReader:close	()V
    //   147: aload_2
    //   148: athrow
    //   149: ldc 253
    ...
    //   163: getstatic 249	bgkn:c	J
    //   166: invokevirtual 258	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   169: ldc_w 260
    //   172: invokevirtual 47	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   175: iload_0
    //   176: iconst_1
    //   177: isub
    //   178: invokevirtual 50	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   181: invokevirtual 60	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   184: invokestatic 66	com/tencent/qqmini/sdk/log/QMLog:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   187: getstatic 249	bgkn:c	J
    //   190: lreturn
    //   191: astore_2
    //   192: goto -83 -> 109
    //   195: astore_3
    ...
    //   195	1	3	localIOException3	java.io.IOException
    ...
    //   75	80	132	finally
    //   84	101	132	finally
    //   105	109	191	java/io/IOException
    //   143	147	195	java/io/IOException
    //   33	75	199	finally
    //   33	75	203	java/lang/Exception
  }
  ...
  private static final int d()
  {
    try
    {
      int i = new File("/sys/devices/system/cpu/").listFiles(new bgko()).length;
      return i;
    }
    catch (Exception localException) {}
    return 1;
