  ...
  extends bawf
{
  ...
  private static ConcurrentHashMap<String, SoftReference<ArrayList<bawi>>> c = new ConcurrentHashMap();
  private amtf jdField_a_of_type_Amtf = new bawq(this);
  private anuz jdField_a_of_type_Anuz;
  private Object jdField_a_of_type_JavaLangObject = new Object();
  private String jdField_a_of_type_JavaLangString;
  private Comparator<FTSEntity> jdField_a_of_type_JavaUtilComparator = new bawo(this);
  ...
  public bawm(QQAppInterface paramQQAppInterface)
  {
  ...
  private int a(String paramString, int paramInt)
  {
    if (this.jdField_a_of_type_Anuz == null) {
      this.jdField_a_of_type_Anuz = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProxyManager().a();
    }
    int i = 0;
    if (!this.jdField_a_of_type_Anuz.isRecentUserInCache(paramString, paramInt)) {
      i = 10;
    }
    if (paramInt == 3000) {
      return i + 2;
  ...
  private ArrayList<bawr> a(ArrayList<FTSEntity> paramArrayList)
  {
    ...
    while (paramArrayList.hasNext())
    {
      ...
      if ((localFTSMessage != null) && (localFTSMessage.msgExts != null))
      {
        ...
        String str = abwz.a((String)localObject2, i);
        if (!((HashMap)localObject1).containsKey(str))
        {
          bawr localbawr = new bawr();
          localbawr.jdField_a_of_type_JavaUtilList = new ArrayList();
          localbawr.jdField_a_of_type_JavaUtilList.add(localFTSMessage);
          localbawr.jdField_a_of_type_Int = localFTSMessage.mSearchScene;
          localbawr.b = localFTSMessage.mProximity;
          localbawr.c = a((String)localObject2, i);
          localbawr.jdField_a_of_type_Long = ((FTSMessageCodec.TextMsgExts)localFTSMessage.msgExts).time;
          localbawr.jdField_a_of_type_JavaUtilHashSet = new HashSet();
          localbawr.jdField_a_of_type_JavaUtilHashSet.add(Long.valueOf(localFTSMessage.mOId));
          localbawr.d = localFTSMessage.searchStrategy;
          localbawr.e = localFTSMessage.senderNum;
          localbawr.f = localFTSMessage.friendNum;
          localbawr.g = localFTSMessage.friendIndex;
          ((HashMap)localObject1).put(str, localbawr);
        }
        else
        {
          localObject2 = (bawr)((HashMap)localObject1).get(str);
          if (((bawr)localObject2).jdField_a_of_type_JavaUtilHashSet.add(Long.valueOf(localFTSMessage.mOId)))
          {
            if (localFTSMessage.mSearchScene == ((bawr)localObject2).jdField_a_of_type_Int)
            {
              if (localFTSMessage.mProximity < ((bawr)localObject2).b) {
                ((bawr)localObject2).b = localFTSMessage.mProximity;
              }
              if (((FTSMessageCodec.TextMsgExts)localFTSMessage.msgExts).time > ((bawr)localObject2).jdField_a_of_type_Long) {
                ((bawr)localObject2).jdField_a_of_type_Long = ((FTSMessageCodec.TextMsgExts)localFTSMessage.msgExts).time;
              }
              if (localFTSMessage.senderNum > ((bawr)localObject2).e) {
                ((bawr)localObject2).e = localFTSMessage.senderNum;
              }
              if (localFTSMessage.friendNum > ((bawr)localObject2).f) {
                ((bawr)localObject2).f = localFTSMessage.friendNum;
              }
              if (localFTSMessage.friendIndex > ((bawr)localObject2).g) {
                ((bawr)localObject2).g = localFTSMessage.friendIndex;
              }
            }
            for (;;)
            {
              if (localFTSMessage.mSearchScene < ((bawr)localObject2).jdField_a_of_type_Int) {
                ((bawr)localObject2).jdField_a_of_type_Int = localFTSMessage.mSearchScene;
              }
              if (localFTSMessage.searchStrategy < ((bawr)localObject2).d) {
                ((bawr)localObject2).d = localFTSMessage.searchStrategy;
              }
              ((bawr)localObject2).jdField_a_of_type_JavaUtilList.add(localFTSMessage);
              break;
              if (localFTSMessage.mSearchScene < ((bawr)localObject2).jdField_a_of_type_Int)
              {
                ((bawr)localObject2).b = localFTSMessage.mProximity;
    ...
    Collections.sort(paramArrayList, new bawp(this));
    return paramArrayList;
  }
  
  private List<bawi> a(String paramString1, String paramString2, String paramString3, boolean paramBoolean1, ArrayList<FTSEntity> paramArrayList, boolean paramBoolean2)
  {
    Object localObject1 = new HashMap();
    paramArrayList = paramArrayList.iterator();
    int i = 0;
    ...
    while (paramArrayList.hasNext())
    {
      ...
      if ((localObject2 != null) && (((FTSMessage)localObject2).msgExts != null))
      {
        ...
        localObject4 = abwz.a((String)localObject3, j);
        if (!((HashMap)localObject1).containsKey(localObject4))
        {
          localObject5 = new bawr();
          ((bawr)localObject5).jdField_a_of_type_JavaUtilList = new ArrayList();
          ((bawr)localObject5).jdField_a_of_type_JavaUtilList.add(localObject2);
          ((bawr)localObject5).b = ((FTSMessage)localObject2).mProximity;
          ((bawr)localObject5).c = a((String)localObject3, j);
          ((bawr)localObject5).jdField_a_of_type_Long = ((FTSMessageCodec.TextMsgExts)((FTSMessage)localObject2).msgExts).time;
          ((bawr)localObject5).jdField_a_of_type_JavaUtilHashSet = new HashSet();
          ((bawr)localObject5).jdField_a_of_type_JavaUtilHashSet.add(Long.valueOf(((FTSMessage)localObject2).mOId));
          ((bawr)localObject5).d = ((FTSMessage)localObject2).searchStrategy;
          ((HashMap)localObject1).put(localObject4, localObject5);
        }
        else
        {
          localObject3 = (bawr)((HashMap)localObject1).get(localObject4);
          if (!((bawr)localObject3).jdField_a_of_type_JavaUtilHashSet.add(Long.valueOf(((FTSMessage)localObject2).mOId)))
          {
            i = 1;
          }
          else
          {
            if (((FTSMessage)localObject2).mProximity < ((bawr)localObject3).b) {
              ((bawr)localObject3).b = ((FTSMessage)localObject2).mProximity;
            }
            if (((FTSMessageCodec.TextMsgExts)((FTSMessage)localObject2).msgExts).time > ((bawr)localObject3).jdField_a_of_type_Long) {
              ((bawr)localObject3).jdField_a_of_type_Long = ((FTSMessageCodec.TextMsgExts)((FTSMessage)localObject2).msgExts).time;
            }
            if (((FTSMessage)localObject2).searchStrategy < ((bawr)localObject3).d) {
              ((bawr)localObject3).d = ((FTSMessage)localObject2).searchStrategy;
            }
            ((bawr)localObject3).jdField_a_of_type_JavaUtilList.add(localObject2);
          }
        }
      }
    }
    ...
    Collections.sort(paramArrayList, new bawn(this));
    localObject1 = bgbo.a(paramString2);
    ...
    if (paramArrayList != null)
    {
      ...
      {
        localObject4 = (bawr)((Iterator)localObject3).next();
        if (a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(((FTSMessage)((bawr)localObject4).jdField_a_of_type_JavaUtilList.get(0)).uin), ((FTSMessage)((bawr)localObject4).jdField_a_of_type_JavaUtilList.get(0)).istroop))
        {
          ...
          {
            paramArrayList = new bawt((QQAppInterface)localObject5, paramArrayList, paramString2, (ArrayList)localObject1, ((bawr)localObject4).jdField_a_of_type_JavaUtilList, paramString3, null);
            paramArrayList.jdField_a_of_type_Int = ((bawr)localObject4).d;
            paramArrayList.b = ((bawr)localObject4).e;
            paramArrayList.c = ((bawr)localObject4).f;
            paramArrayList.d = ((bawr)localObject4).g;
            ((List)localObject2).add(paramArrayList);
            i = bass.a("fts_native_chathistory_maxnum", 3);
  ...
  private List<bawh> a(String paramString, ArrayList<FTSEntity> paramArrayList)
  {
    ArrayList localArrayList = bgbo.a(paramString);
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      paramArrayList.add(new baws(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, localArrayList, (FTSEntity)localObject2));
    }
    return paramArrayList;
  }
  ...
  public List<bawi> a(bbfs parambbfs)
  {
    if (parambbfs == null) {
      return null;
    }
    ...
    for (boolean bool = parambbfs.jdField_a_of_type_AndroidOsBundle.getBoolean("fts_search_is_limited", true);; bool = true)
    {
      if (bgbo.g(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) == 1) {
        return b(parambbfs, bool);
      }
      return a(parambbfs, bool);
    }
  }
  
  public List<bawi> a(bbfs arg1, boolean paramBoolean)
  {
  ...
  public List<bawi> a(String paramString, boolean paramBoolean)
  {
    if (!NetworkUtil.isNetSupport(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) {
      return null;
    }
    ??? = (amte)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(81);
    Object localObject2 = new ArrayList();
    ((ArrayList)localObject2).add(paramString);
    ((amte)???).a((ArrayList)localObject2);
  ...
  public void a(bbfs parambbfs, bbff<bawi> parambbff)
  {
    bgbp.e = System.nanoTime();
    bgbp.f = 0L;
    ThreadManager.post(new FTSMessageSearchEngine.1(this, parambbfs, parambbff), 8, null, true);
  }
  ...
  public List<bawh> b(bbfs parambbfs)
  {
    if (QLog.isColorLevel()) {
      QLog.d("FTSMessageSearchEngine", 2, "========== search message use FTSMessageSearchEngine");
    }
    ...
    Object localObject = parambbfs.jdField_a_of_type_JavaLangString;
    if (parambbfs.jdField_a_of_type_AndroidOsBundle == null) {
      return new ArrayList();
    }
    long l3 = parambbfs.jdField_a_of_type_AndroidOsBundle.getLong("uin");
    int i = parambbfs.jdField_a_of_type_AndroidOsBundle.getInt("uinType");
    parambbfs = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFTSDBManager().a().a((String)localObject, FTSMessage.class, false, false, l3, i);
    l3 = System.nanoTime();
    localObject = a((String)localObject, parambbfs);
    long l4 = System.nanoTime();
    if (parambbfs != null) {}
    for (i = parambbfs.size();; i = 0)
    {
  ...
  public List<bawi> b(bbfs arg1, boolean paramBoolean)
  {
    if (QLog.isColorLevel()) {
      QLog.d("FTSMessageSearchEngine", 2, "========== search message use FTSMessageSearchEngine");
    }
    ...
    Object localObject4 = bgbo.a(str);
    ...
    long l1 = System.nanoTime();
    localObject4 = bgbo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject4);
    ...
    if ((localObject4 != null) && (!((ArrayList)localObject4).isEmpty()))
    {
      ...
      while (((Iterator)localObject5).hasNext())
      {
        localObject6 = (bgbq)((Iterator)localObject5).next();
        if ((((bgbq)localObject6).jdField_a_of_type_Int != 0) && (((bgbq)localObject6).jdField_a_of_type_Int != 1004)) {
          break label2300;
        }
        j += 1;
      }
    ...
    for (;;)
    {
      ...
      if ((localObject4 != null) && (!((ArrayList)localObject4).isEmpty()))
      {
        ...
        {
          localObject5 = ((bgbq)((ArrayList)localObject4).get(i5)).jdField_a_of_type_JavaLangString;
          int i9 = ((bgbq)((ArrayList)localObject4).get(i5)).jdField_a_of_type_Int;
          localObject6 = ((bgbq)((ArrayList)localObject4).get(i5)).jdField_a_of_type_AndroidUtilPair;
          int i6 = m;
          ...
          {
            i = k;
            if (bgbo.h(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) == 1)
            {
      ...
      for (m = i;; m = i)
      {
        ...
        for (;;)
        {
          ...
          l3 += l4;
          localObject3 = bgbo.a(localHashMap);
          localObject5 = ((ArrayList)localObject5).iterator();
          while (((Iterator)localObject5).hasNext())
          {
            localObject6 = (bawr)((Iterator)localObject5).next();
            localObject7 = (FTSMessage)((bawr)localObject6).jdField_a_of_type_JavaUtilList.get(0);
            ...
            {
              localObject7 = new bawt(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localHashMap, localHashMap, (ArrayList)localObject3, ((bawr)localObject6).jdField_a_of_type_JavaUtilList, null, null);
              ((bawt)localObject7).jdField_a_of_type_Int = ((bawr)localObject6).d;
              ((bawt)localObject7).b = ((bawr)localObject6).e;
              ((bawt)localObject7).c = ((bawr)localObject6).f;
              ((bawt)localObject7).d = ((bawr)localObject6).g;
  ...
  public void b(bbfs parambbfs, bbff<bawh> parambbff)
  {
    ThreadManager.post(new FTSMessageSearchEngine.2(this, parambbfs, parambbff), 8, null, true);
  }
  
  public void f()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Amtf);
  }
  
  public void g()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Amtf);
  }
}
