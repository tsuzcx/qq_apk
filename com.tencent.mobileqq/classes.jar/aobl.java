  ...
  implements Manager
{
  ...
  anyu jdField_a_of_type_Anyu = new aobo(this);
  private axfs jdField_a_of_type_Axfs = new aobp(this);
  private bduz jdField_a_of_type_Bduz = new aobq(this);
  ...
  private ArrayList<ajiq> jdField_c_of_type_JavaUtilArrayList;
  ...
  public aobl(QQAppInterface paramQQAppInterface)
  {
    ...
    if (this.jdField_a_of_type_Axfs != null)
    {
      ...
      if (paramQQAppInterface != null) {
        paramQQAppInterface.a(this.jdField_a_of_type_Axfs);
      }
    }
  ...
  private int a(List<RecentBaseData> paramList, int paramInt1, int paramInt2)
  {
    if (paramInt1 < 3)
    {
      ...
      if (alms.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentBaseData)) {
        break label78;
      }
      paramInt1 += 1;
      label58:
  ...
  private ajiq a(oidb_0xc26.TabInfo paramTabInfo)
  {
    ajiq localajiq = new ajiq();
    localajiq.jdField_a_of_type_Int = paramTabInfo.uint32_tab_id.get();
    localajiq.jdField_b_of_type_Int = paramTabInfo.uint32_recommend_count.get();
    String str;
    if (paramTabInfo.bytes_table_name.has())
    {
      str = paramTabInfo.bytes_table_name.get().toStringUtf8();
      localajiq.jdField_a_of_type_JavaLangString = str;
      if (!paramTabInfo.bytes_icon_url_select.has()) {
        break label116;
      }
      str = paramTabInfo.bytes_icon_url_select.get().toStringUtf8();
      label77:
      localajiq.jdField_b_of_type_JavaLangString = str;
  ...
  private RecentRecommendTroopItem a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      paramString = (RecentUser)localapaw.findRecentUser(paramString, 8113);
      if (paramString != null)
      {
  ...
  private <T extends MayKnowRecommend> ArrayList<T> b(@NonNull ArrayList<T> paramArrayList)
  {
    ...
    while (paramArrayList.hasNext())
    {
      ...
      if (!localanyw.b(localMayKnowRecommend.uin))
      {
        boolean bool = localanyw.a(localMayKnowRecommend.uin, false, true);
        if (bool) {}
        for (int k = 1;; k = 0)
        {
  ...
  private void c(List<oidb_0xc26.TabInfo> paramList)
  {
    ...
    for (??? = "null";; ??? = Integer.valueOf(paramList.size()))
    {
      ...
      synchronized (this.jdField_d_of_type_JavaLangObject)
      {
        ...
        if (((ajiq)localObject2).jdField_a_of_type_Int == 23) {
          ((ajiq)localObject2).jdField_b_of_type_Int += c().size();
        }
  ...
  private void d(List<ajiq> paramList)
  {
    for (;;)
    {
      SharedPreferences localSharedPreferences;
      ...
      synchronized (this.jdField_e_of_type_JavaLangObject)
      {
        ...
        paramList = paramList.iterator();
        if (paramList.hasNext()) {
          localJSONArray.put(ajiq.a((ajiq)paramList.next()));
        }
      }
  ...
  private boolean f()
  {
    return !((ajwm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(295)).c();
  }
  ...
  private void l()
  {
    ...
    arbb localarbb = arba.a();
    StringBuilder localStringBuilder;
    if (localarbb != null)
    {
      this.jdField_g_of_type_Int = localarbb.jdField_a_of_type_Int;
      this.jdField_a_of_type_JavaLangString = localarbb.jdField_a_of_type_JavaLangString;
      if (localarbb.jdField_b_of_type_Int == 1)
      {
        bool1 = true;
    ...
    synchronized (this.jdField_d_of_type_JavaLangObject)
    {
      ...
      synchronized (this.jdField_e_of_type_JavaLangObject)
      {
        ...
        try
        {
          ...
          {
            localArrayList.add(ajiq.a(((JSONArray)localObject4).getJSONObject(k)));
            k += 1;
          }
  ...
  public int a()
  {
    ...
    int k = 0;
    p();
    if (!((ajwm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(295)).c()) {}
    for (int m = 1;; m = 0) {
      label149:
      for (;;)
      {
        synchronized (this.jdField_d_of_type_JavaLangObject)
        {
          if (this.jdField_c_of_type_JavaUtilArrayList != null)
          {
            ...
            {
              ajiq localajiq = (ajiq)localIterator.next();
              if ((localajiq.jdField_a_of_type_Int != 23) && (m == 0)) {
                break label149;
              }
              k = localajiq.jdField_b_of_type_Int + k;
              break label149;
            }
          }
          if (QLog.isColorLevel()) {
  ...
  public ArrayList<ajiq> a()
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_d_of_type_JavaLangObject)
      {
        ...
        localajiq = ajiq.a((ajiq)localIterator.next());
        if (localajiq.jdField_a_of_type_Int == 23)
        {
          localajiq.jdField_a_of_type_Boolean = true;
          localArrayList.add(localajiq);
        }
      }
      localajiq.jdField_a_of_type_Boolean = bool;
    }
    if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        ...
        synchronized (this.jdField_d_of_type_JavaLangObject)
        {
          if (this.jdField_c_of_type_JavaUtilArrayList != null)
          {
            ...
            {
              ajiq localajiq = (ajiq)((Iterator)localObject3).next();
              if ((localajiq.equals(paramList)) && ((localajiq.jdField_b_of_type_Int != paramList.jdField_b_of_type_Int) || (!localajiq.jdField_a_of_type_JavaLangString.equals(paramList.jdField_a_of_type_JavaLangString)) || (!localajiq.jdField_b_of_type_JavaLangString.equals(paramList.jdField_b_of_type_JavaLangString)) || (!localajiq.c.equals(paramList.c))))
              {
                localajiq.jdField_b_of_type_Int = paramList.jdField_b_of_type_Int;
                localajiq.jdField_a_of_type_JavaLangString = paramList.jdField_a_of_type_JavaLangString;
                localajiq.jdField_b_of_type_JavaLangString = paramList.jdField_b_of_type_JavaLangString;
                localajiq.c = paramList.c;
                d(this.jdField_c_of_type_JavaUtilArrayList);
              }
            }
          }
  ...
  public void a(View paramView, Context paramContext, String paramString)
  {
    ...
    if ((paramString.equals("sp_uin_for_title")) && (k == 2131376341))
    {
      paramView = blir.a(paramContext);
      paramView.b(2131691104);
      paramView.c(2131690580);
      paramView.a(new aobn(this, paramView));
      paramView.show();
      bdll.b(null, "dc00899", "Grp_recom", "", "msg_tab", "clk_ellipsis", 0, 0, "", "", "", "");
    }
    for (;;)
    {
      return;
      if ((paramView.getTag() != null) && ((paramView.getTag() instanceof alox)))
      {
        paramView = (alox)paramView.getTag();
        if (paramView.a == null) {
          break;
        }
        ...
        for (paramView = (RecentRecommendTroopItem)paramView.a.mUser.extraInfo; paramView != null; paramView = null)
        {
          ...
          if (k == 2131363840)
          {
            ...
            bdll.b(null, "dc00899", "Grp_recom", "", "msg_tab", "clk_add", 0, 0, paramView.uin, paramView.recomAlgol, "", "");
            return;
          }
          ...
          for (;;)
          {
            try
            {
              ...
              if (TextUtils.isEmpty(paramView.recommendReason))
              {
                ...
                localObject = nli.a(paramView);
                if (localObject != null) {
                  paramString.labels = ((ArrayList)localObject);
                }
                paramString.strJoinSig = paramView.authSig;
                bguq.a(paramContext, bguq.a(107, paramString, 10018, false), 2);
                bdll.b(null, "dc00899", "Grp_recom", "", "msg_tab", "clk_grp", 0, 0, paramView.uin, paramView.recomAlgol, "", "");
                return;
              }
            }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        synchronized (jdField_a_of_type_JavaLangObject)
        {
          ...
          synchronized (this.jdField_c_of_type_JavaUtilArrayList)
          {
            ...
            for (;;)
            {
              ...
              localajiq = (ajiq)localIterator.next();
              label218:
              label223:
              synchronized (this.jdField_f_of_type_JavaLangObject)
              {
                ...
                {
                  if (localajiq.jdField_b_of_type_Int <= 0) {
                    break;
                  }
                  k = localajiq.jdField_b_of_type_Int - 1;
                  localajiq.jdField_b_of_type_Int = k;
                }
              }
            }
          }
        ...
        break label218;
        label253:
        Object localObject3 = (ArrayList)this.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(localajiq.jdField_a_of_type_Int));
        if (localObject3 != null)
        {
          ...
          if (((Iterator)localObject3).hasNext())
          {
            ...
            localajiq.jdField_b_of_type_Int -= 1;
          }
        }
      }
      label337:
  ...
  public void a(@NonNull ArrayList<MayKnowRecommend> paramArrayList)
  {
    ...
    //   38: aload_0
    //   39: aload_1
    //   40: invokespecial 351	aobl:b	(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    //   43: astore 4
    //   45: aload 4
    //   47: astore_3
    //   48: aload 4
    ...
    //   72: astore_3
    //   73: getstatic 47	aobl:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   76: astore 4
    //   78: aload 4
    //   80: monitorenter
    //   81: aload_0
    //   82: getfield 140	aobl:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   85: invokevirtual 1266	java/util/ArrayList:clear	()V
    //   88: aload_0
    //   89: getfield 140	aobl:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   92: aload_3
    ...
    //   99: monitorexit
    //   100: aload_0
    //   101: getfield 129	aobl:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    ...
    //   114: aload_0
    //   115: getfield 129	aobl:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   118: ldc_w 707
    ...
    //   160: invokevirtual 1325	aobl:a	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   163: pop
    //   164: goto -23 -> 141
    //   167: astore_3
    ...
    //   191: istore_2
    //   192: aload_0
    //   193: getfield 97	aobl:jdField_f_of_type_JavaLangObject	Ljava/lang/Object;
    //   196: astore_3
    //   197: aload_3
    //   198: monitorenter
    //   199: aload_0
    //   200: getfield 84	aobl:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   203: ifnull +10 -> 213
    //   206: aload_0
    //   207: getfield 84	aobl:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    ...
    //   246: iconst_1
    //   247: aload_0
    //   248: getfield 140	aobl:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
  ...
  public void a(List<String> paramList, long paramLong1, long paramLong2, boolean paramBoolean)
  {
    ...
    //   21: astore 7
    //   23: getstatic 47	aobl:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   26: astore 8
    //   28: aload 8
    //   30: monitorenter
    //   31: aload_0
    //   32: getfield 140	aobl:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   147: ifne -134 -> 13
    //   150: aload_0
    //   151: getfield 129	aobl:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    ...
    //   196: aload_0
    //   197: aload 8
    //   199: invokevirtual 1325	aobl:a	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   202: pop
    //   203: goto -34 -> 169
    //   206: astore 7
    //   208: ldc_w 265
      ...
      if ((??? != null) && (!???.isEmpty()))
      {
        ...
        while (localIterator2.hasNext())
        {
          ...
          if (localRgroupInfo.uint64_group_code.has())
          {
            ...
            localRecentRecommendTroopItem.labelList = aoga.b(localRgroupInfo.rpt_group_label.get());
  ...
  public boolean a(String paramString)
  {
    ...
    {
      apaw localapaw = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a();
      paramString = (RecentUser)localapaw.findRecentUser(paramString, 8112);
      if (paramString != null)
      {
        localapaw.delRecentUser(paramString);
        return true;
    ...
    try
    {
      if (this.jdField_c_of_type_JavaUtilArrayList != null)
      {
        ...
        if (!this.jdField_c_of_type_JavaUtilArrayList.isEmpty()) {
          localObject1 = (ajiq)this.jdField_c_of_type_JavaUtilArrayList.get(0);
        }
      }
      if (localObject1 != null)
      {
        localObject1 = a(((ajiq)localObject1).jdField_a_of_type_Int);
        if (localObject1 != null) {
  ...
  public void b()
  {
    ...
    if (this.jdField_c_of_type_JavaUtilArrayList != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (localajiq.jdField_a_of_type_Int != 23)
        {
          a(localajiq.jdField_a_of_type_Int, new ArrayList(0), true);
          a(localajiq.jdField_a_of_type_Int, null);
        }
      }
    }
  }
  ...
  public void b(int paramInt)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_d_of_type_JavaLangObject)
      {
        ...
        if (localIterator.hasNext())
        {
          if (((ajiq)localIterator.next()).jdField_a_of_type_Int != paramInt) {
            continue;
          }
          localIterator.remove();
          k = 1;
  ...
  public void c()
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaUtilList)
      {
        ...
        {
          apaw localapaw = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a();
          localapaw.deleteRecentUserByType(8112);
          ??? = (RecentUser)localapaw.findRecentUser(antf.ag, 8111);
          if (??? != null) {
            localapaw.delRecentUser((BaseRecentUser)???);
          }
          localapaw.deleteRecentUserByType(8113);
          Object localObject2 = (RecentUser)localapaw.findRecentUser("sp_uin_for_title", 8113);
          ??? = localObject2;
          if (localObject2 == null) {
          ...
          ??? = (RecentUser)localapaw.findRecentUser(localRecentRecommendTroopItem.uin, 8113);
          if (??? != null) {
            break label414;
          }
  ...
  public void c(String paramString)
  {
    ...
    a(paramString);
    ((aoga)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(22)).a(paramString, new aobr(this, paramString));
    ...
    if (this.jdField_e_of_type_Int == 0)
    {
      ...
      bdll.b(null, "dc00899", "Grp_recom", "", "link_top", "clk_hide", 0, 0, "", "", "", "");
    }
  ...
  public void d()
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      localObject1 = (RecentUser)localapaw.findRecentUser(antf.ag, 8111);
      if (localObject1 != null) {
        localapaw.delRecentUser((BaseRecentUser)localObject1);
      }
      g(8112);
      localRecentUser = (RecentUser)localapaw.findRecentUser("sp_uin_for_title", 8112);
      ...
      localapaw.saveRecentUser((BaseRecentUser)localObject1);
      Iterator localIterator = ((ArrayList)localObject2).iterator();
      if (!localIterator.hasNext()) {
        break label474;
      }
      localMayKnowRecommend = (MayKnowRecommend)localIterator.next();
      localRecentUser = (RecentUser)localapaw.findRecentUser(localMayKnowRecommend.uin, 8112);
      if (localRecentUser != null) {
        break label491;
      }
    ...
    for (;;)
    {
      ...
      break;
      g(8112);
      localRecentUser = (RecentUser)localapaw.findRecentUser(antf.ag, 8111);
      if (QLog.isColorLevel()) {
      ...
      localObject1 = localRecentUser;
      if (localRecentUser == null) {
        localObject1 = new RecentUser(antf.ag, 8111);
      }
      localapaw.saveRecentUser((BaseRecentUser)localObject1);
  ...
  public void d(String paramString)
  {
    ...
    ((aoga)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(22)).a(paramString, new aobm(this, paramString));
    ...
    {
      bdll.b(null, "dc00899", "Grp_recom", "", "msg_tab", "slide_delete", 0, 0, paramString, (String)localObject, "", "");
      return;
  ...
  public void e()
  {
    ...
    apaw localapaw = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a();
    g(8112);
    RecentUser localRecentUser = (RecentUser)localapaw.findRecentUser(antf.ag, 8111);
    if (QLog.isColorLevel()) {
