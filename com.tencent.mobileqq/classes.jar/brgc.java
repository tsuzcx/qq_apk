  ...
  implements GLSurfaceView.Renderer
{
  ...
  private brio jdField_a_of_type_Brio;
  ...
  private int b;
  private int c = boec.jdField_a_of_type_Int;
  private int d;
  private int e;
  ...
  public Bitmap a(Bitmap paramBitmap, long paramLong)
  {
    ...
    if (localQQFilterRenderManager != null)
    {
      ...
      this.jdField_a_of_type_Brio = new brio(localQQFilterRenderManager.getBusinessOperation().getCurrentAVFilterIdList(), localMusicItemInfo, this.d, this.e, null);
      this.jdField_a_of_type_Brio.a(true);
      if ((this.jdField_a_of_type_Brio == null) || (localObject == null)) {
        break label210;
      }
    }
    for (;;)
    {
      try
      {
        paramBitmap = zps.a(paramBitmap, 1.0F, -1.0F);
        ((GPUBaseFilter)localObject).init();
        this.jdField_a_of_type_Brio.a(this.d, this.e);
      ...
      try
      {
        ...
        localObject = zps.a(paramBitmap, 1.0F, -1.0F);
        this.jdField_a_of_type_Brio = null;
        return localObject;
      }
  ...
  public Bitmap a(Bitmap paramBitmap, GPUBaseFilter paramGPUBaseFilter)
  {
    ...
    if ((this.jdField_a_of_type_Brio != null) && (this.jdField_a_of_type_Brio.jdField_a_of_type_Boolean)) {}
    for (int i = 30;; i = 2)
    {
      int j = 0;
      while (j < i)
  ...
  public Bitmap a(Bitmap paramBitmap, List<FilterDesc> paramList, brgc parambrgc)
  {
    this.jdField_a_of_type_ComTencentTtpicOpenapiFilterGPUBaseFilter = parambrgc.jdField_a_of_type_ComTencentTtpicOpenapiFilterGPUBaseFilter;
    this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager = parambrgc.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager;
    if ((this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager != null) && (this.jdField_a_of_type_ComTencentTtpicOpenapiFilterGPUBaseFilter != null) && (paramList != null))
    {
      ...
      this.jdField_a_of_type_AndroidGraphicsBitmap = paramBitmap;
      int i = 5;
      if (parambrgc.jdField_a_of_type_Boolean)
      {
        parambrgc.jdField_a_of_type_Boolean = false;
        i = 20;
      }
      int j = 0;
      while (j < i)
      ...
      return zps.a(paramBitmap, 1.0F, -1.0F);
    }
    return null;
  }
  ...
  {
    GPUBaseFilter localGPUBaseFilter = brgb.a(0);
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager != null) && (localGPUBaseFilter != null) && (paramList != null))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager.getBusinessOperation().setFilterEffectList(paramList);
      return zps.a(a(paramBitmap, localGPUBaseFilter), 1.0F, -1.0F);
    }
    return null;
  }
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager != null)
    {
      ...
      this.c = boec.jdField_a_of_type_Int;
    }
  }
  ...
  {
    if (Build.VERSION.SDK_INT >= 17) {
      this.jdField_a_of_type_Bbma = new bbma(EGL14.EGL_NO_CONTEXT, 1);
    }
    d(paramInt1, paramInt2);
  }
  ...
  public void c(int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_ComTencentTtpicOpenapiFilterGPUBaseFilter = brgb.a(0);
    this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager = boec.b();
  ...
  public void onDrawFrame(GL10 paramGL10)
  {
    ...
    for (Object localObject = this.jdField_a_of_type_AndroidGraphicsBitmap;; localObject = paramGL10)
    {
      ...
      if (this.jdField_a_of_type_Brio != null) {
        this.b = this.jdField_a_of_type_Brio.a(this.d, this.e, this.b, this.jdField_a_of_type_Long);
      }
      if (this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager != null)
      {
