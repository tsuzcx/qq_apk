...
{
  public static int a;
  private static awkk jdField_a_of_type_Awkk;
  ...
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new awkl(this);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajed.aU + "VideoRedbagRes" + File.separator;
  ...
  public awkk(AppInterface paramAppInterface)
  {
  ...
  private RelativeLayout.LayoutParams a(CustomFrameAnimationDrawable paramCustomFrameAnimationDrawable)
  {
    if ((paramCustomFrameAnimationDrawable != null) && (this.jdField_a_of_type_AndroidAppActivity != null))
    {
      ...
      paramCustomFrameAnimationDrawable = new RelativeLayout.LayoutParams(aciy.a(j / 2, this.jdField_a_of_type_AndroidAppActivity.getResources()), aciy.a(k / 2, this.jdField_a_of_type_AndroidAppActivity.getResources()));
  ...
  public static awkk a(AppInterface paramAppInterface)
  {
    if (jdField_a_of_type_Awkk == null) {}
    try
    {
      if (jdField_a_of_type_Awkk == null) {
        jdField_a_of_type_Awkk = new awkk(paramAppInterface);
      }
      return jdField_a_of_type_Awkk;
    }
    finally {}
  }
  ...
  private CustomFrameAnimationDrawable a(String paramString)
  {
    ...
    //   11: getstatic 57	awkk:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   154: aload_1
    //   155: invokestatic 229	bacm:a	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   158: astore_1
    ...
    //   169: aload_1
    //   170: aload_0
    //   171: getfield 235	awkk:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
  ...
  public static void a(Intent paramIntent, Activity paramActivity)
  {
    ...
    ahcq.a(paramActivity, paramIntent);
  }
  
  public static void a(View paramView, adpi paramadpi, ChatMessage paramChatMessage, Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (j != 0)
        {
          if (paramView.findViewById(2131307264) != null)
          {
            paramView.findViewById(2131307263).setVisibility(0);
            paramadpi = (ImageView)paramView.findViewById(2131307264);
            if (j == 1) {
              paramadpi.setImageResource(2130848438);
            }
            for (;;)
            {
              paramadpi.setVisibility(0);
              paramView = (RelativeLayout.LayoutParams)((ImageView)paramView.findViewById(2131307263)).getLayoutParams();
              if (!paramChatMessage.isSend()) {
                break label213;
              }
              paramView.rightMargin = aciy.a(6.0F, paramContext.getResources());
              ...
              break;
              if (j == 2) {
                paramadpi.setImageResource(2130848439);
              } else if (j == 3) {
                paramadpi.setImageResource(2130848437);
              }
            }
            paramView.rightMargin = 0;
            paramView.leftMargin = aciy.a(6.0F, paramContext.getResources());
            return;
          }
          paramadpi = new ImageView(paramContext);
          paramadpi.setBackgroundDrawable(paramContext.getResources().getDrawable(2130848436));
          paramadpi.setId(2131307263);
          paramadpi.setVisibility(0);
          RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, aciy.a(70.0F, paramContext.getResources()));
          localLayoutParams.addRule(7, 2131305912);
          localLayoutParams.addRule(8, 2131305912);
          if (paramChatMessage.isSend())
          {
            localLayoutParams.rightMargin = aciy.a(6.0F, paramContext.getResources());
            localLayoutParams.leftMargin = 0;
            ((RelativeLayout)paramView).addView(paramadpi, localLayoutParams);
            paramadpi = new ImageView(paramContext);
            if (j != 1) {
              break label441;
            }
          ...
          for (;;)
          {
            paramadpi.setId(2131307264);
            paramadpi.setVisibility(0);
            paramChatMessage = new RelativeLayout.LayoutParams(-2, -2);
            paramChatMessage.addRule(8, 2131305912);
            paramChatMessage.addRule(14);
            ((RelativeLayout)paramView).addView(paramadpi, paramChatMessage);
            return;
            localLayoutParams.rightMargin = 0;
            localLayoutParams.leftMargin = aciy.a(6.0F, paramContext.getResources());
            break;
            if (j == 2) {
              paramadpi.setImageResource(2130848439);
            } else if (j == 3) {
        ...
        paramView.findViewById(2131307264).setVisibility(4);
        paramView.findViewById(2131307263).setVisibility(4);
        return;
        j = 0;
      }
    }
  ...
  {
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApp(), awku.class);
  ...
  private static String b(String paramString)
  {
    ...
    catch (UnsatisfiedLinkError localUnsatisfiedLinkError)
    {
      ...
      for (;;)
      {
        try
        {
          paramString = bech.a(paramString);
          if (paramString == null) {
            continue;
          }
        }
  ...
  private void b(AIOShortVideoData paramAIOShortVideoData)
  {
    ...
    if (paramAIOShortVideoData.h == 0)
    {
      ...
      new awks(this).execute(new String[] { paramAIOShortVideoData.jdField_c_of_type_JavaLangString });
    }
    for (;;)
    {
  ...
  private static boolean b(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    if (baig.c(paramQQAppInterface.getApp()))
    {
      if (QLog.isColorLevel()) {
    ...
    if ((paramQQAppInterface.exists()) && (!paramQQAppInterface.isDirectory()))
    {
      try
      {
        paramQQAppInterface = bace.b(paramQQAppInterface);
  ...
  public static void c()
  {
    try
    {
      if (!jdField_a_of_type_Boolean) {
        baig.e(BaseApplication.getContext(), true);
      }
      return;
    }
    finally {}
  ...
  private void c(AIOShortVideoData paramAIOShortVideoData)
  {
    ...
    {
      this.jdField_c_of_type_AndroidWidgetImageView.setBackgroundResource(2130848440);
    ...
    if (paramAIOShortVideoData.h == 0)
    {
      ...
      {
        this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130848449);
        this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      }
    ...
    for (;;)
    {
      ...
      break;
      label207:
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130848450);
      c();
    }
  }
  ...
  private void d()
  {
    ...
    do
    {
      for (;;)
      {
        ...
        if (!ajjy.a(2131647498).trim().equals(localObject)) {
          break;
        }
    ...
    } while (!ajjy.a(2131647496).trim().equals(localObject));
    ahhk.b("", "0X80088E6");
    j();
    a();
  }
  ...
  private void g()
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(ajjy.a(2131647495));
      this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(0);
      this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColorStateList(2131101222));
      this.jdField_a_of_type_AndroidWidgetTextView.setTextSize(14.0F);
      this.jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130848441, 0);
  ...
  private void h()
  {
    if ((this.jdField_a_of_type_AndroidWidgetTextView != null) && (this.jdField_a_of_type_AndroidAppActivity != null))
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(ajjy.a(2131647499));
      this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(0);
  ...
  private void i()
  {
    ...
    if (localCustomFrameAnimationDrawable != null)
    {
      ...
      localCustomFrameAnimationDrawable.c();
      localCustomFrameAnimationDrawable.a(new awkr(this));
      if (this.jdField_a_of_type_AndroidOsHandler == null) {
        this.jdField_a_of_type_AndroidOsHandler = new Handler();
      }
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      return;
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130848444);
      k();
      c();
    }
  }
  ...
  private void k()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(ajjy.a(2131647497));
    this.jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
    this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColorStateList(2131101223));
    this.jdField_a_of_type_AndroidWidgetTextView.setTextSize(16.0F);
    this.jdField_a_of_type_AndroidWidgetTextView.setPadding(aciy.a(12.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), aciy.a(5.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), aciy.a(12.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), aciy.a(5.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()));
    this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130848445);
    this.jdField_a_of_type_AndroidWidgetTextView.bringToFront();
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    ObjectAnimator.ofFloat(this.jdField_a_of_type_AndroidWidgetTextView, "alpha", new float[] { 0.0F, 1.0F }).setDuration(180L).start();
  }
  ...
  private void l()
  {
    ...
    if (localCustomFrameAnimationDrawable != null)
    {
      ...
      localCustomFrameAnimationDrawable.a(new awkm(this, localCustomFrameAnimationDrawable));
      return;
    }
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130848444);
    c();
  ...
  private void n()
  {
    ...
    for (;;)
    {
      ...
      h();
      return;
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130848448);
      c();
    }
  }
  ...
  public ImageView a(Activity paramActivity, ViewGroup paramViewGroup, String paramString)
  {
    ...
    paramString.setId(2131307317);
    Object localObject = new RelativeLayout.LayoutParams(-1, aciy.a(180.0F, paramActivity.getResources()));
    ...
    ((TextView)localObject).setId(2131307318);
    localLayoutParams = new RelativeLayout.LayoutParams(-2, -2);
    localLayoutParams.addRule(12);
    localLayoutParams.addRule(14);
    localLayoutParams.bottomMargin = aciy.a(10.0F, paramActivity.getResources());
    paramViewGroup.addView((View)localObject, localLayoutParams);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localObject);
    ((TextView)localObject).bringToFront();
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new awkq(this));
    e();
    return paramString;
  }
  ...
  public void a(int paramInt)
  {
    if (paramInt == -1)
    {
      ...
      localCustomFrameAnimationDrawable.c();
      localCustomFrameAnimationDrawable.a(new awkn(this));
    }
    for (;;)
    {
  ...
  public void a(Activity paramActivity)
  {
    if (a())
    {
      ...
      Bundle localBundle = bhdh.a(null, paramActivity.getClass().getName(), 10004, 8);
      vjq.a().a(paramActivity, localBundle, 9010);
    }
  }
