  ...
  extends VasWebviewJsPlugin
{
    ...
    try
    {
      ...
      if (this.mRuntime.a() != null)
      {
        ...
        if (localObject1 != null)
        {
          ...
          if ((paramString instanceof becr)) {
            i = ((becr)paramString).switchRequestCode(this, (byte)100);
          }
          for (;;)
          {
  ...
  public void onDestroy()
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      super.sendRemoteReq(apic.a("ipc_cmd_historyhead_refresh_numflag", "", 0, localBundle), false, true);
    }
    super.onDestroy();
  }
}
