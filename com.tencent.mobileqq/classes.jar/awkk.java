...
public class awkk
  extends akiz
{
  public awkk(ActiveEntitySearchFragment paramActiveEntitySearchFragment) {}
  ...
  public void a(String paramString1, boolean paramBoolean, String paramString2, int paramInt, String paramString3, long[] paramArrayOfLong)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.a.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131699764));
        this.a.g.setOnClickListener(new awkm(this));
      ...
      this.a.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(new awkn(this));
    }
  }
  ...
  public void a(String paramString1, boolean paramBoolean1, String paramString2, byte[] paramArrayOfByte, boolean paramBoolean2, List<awof> paramList, long[] paramArrayOfLong, String paramString3, List<DynamicTabSearch.SubHotWord> paramList1, boolean paramBoolean3, String paramString4)
  {
    ...
    {
      localObject2 = (awof)((Iterator)localObject1).next();
      if (((awof)localObject2).a() == null) {
        break label3403;
      }
      if (!(localObject2 instanceof awnd)) {
        break label3400;
      }
      localObject3 = (awnd)localObject2;
      localObject4 = ((awnd)localObject3).a();
      Iterator localIterator = ((List)localObject4).iterator();
      while (localIterator.hasNext())
      {
        Object localObject5 = (awog)localIterator.next();
        if ((localObject5 instanceof awne))
        {
          localObject5 = (awne)localObject5;
          if (ActiveEntitySearchActivity.b) {
            ((awne)localObject5).l = 1;
          }
          paramString2.add(Long.valueOf(((awne)localObject5).d()));
        }
      }
      if (l1 != -1L) {
        break label3397;
      }
      l1 = ((awnd)localObject3).a;
      l2 = ((awnd)localObject3).a;
      if ((((List)localObject4).size() > 0) && (((awnd)localObject3).a == 1001L))
      {
        axqw.b(null, "dc00898", "", "", "0X800A339", "0X800A339", 1, 0, "", "", "", "");
        i = j + ((awof)localObject2).a().size();
        l3 = l1;
        l1 = l2;
        l2 = l3;
      }
    ...
    for (;;)
    {
      ...
      j = i;
      break label363;
      if ((((List)localObject4).size() > 0) && (((awnd)localObject3).a == 1002L)) {
        axqw.b(null, "dc00898", "", "", "0X800A339", "0X800A339", 2, 0, "", "", "", "");
      }
      break label572;
      ...
      if (!paramBoolean1)
      {
        ...
        awvy.a("sub_result", "load_result", new String[] { this.a.jdField_b_of_type_JavaLangString, awvy.a(paramString3), "", awvy.a("dynamic_tab_search.1", this.a.jdField_a_of_type_ArrayOfLong) });
      }
      ...
      {
        bool1 = true;
        awvt.a(paramString2, paramList, bool1, this.a.jdField_a_of_type_ArrayOfLong, this.a.jdField_e_of_type_JavaLangString, this.a.jdField_b_of_type_JavaLangString);
        if (j != 0) {
          break label1347;
        }
        if ((this.a.getActivity() instanceof awin)) {}
        switch (((awin)this.a.getActivity()).a())
        {
        case 2: 
        default: 
          if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        ...
        bool1 = false;
        break;
        awvy.a("sub_result", "no_result", new String[] { this.a.jdField_b_of_type_JavaLangString, awvy.a(this.a.jdField_a_of_type_ArrayOfLong), "", awvy.a("dynamic_tab_search.1", paramArrayOfLong) });
        break label892;
        awvy.a("all_result", "exp_tab_empty", new String[] { this.a.jdField_b_of_type_JavaLangString, awvy.a(this.a.jdField_a_of_type_ArrayOfLong), "", awvy.a("dynamic_tab_search.1", paramArrayOfLong) });
        break label892;
        if ((this.a.jdField_a_of_type_ArrayOfByte != null) || (!(this.a.getActivity() instanceof awin))) {
          break label892;
        }
        paramString2 = (awin)this.a.getActivity();
        ...
        default: 
          break;
        case 1: 
          awvy.a("all_result", "exp_tab_page", new String[] { this.a.jdField_b_of_type_JavaLangString, awvy.a(this.a.jdField_b_of_type_JavaUtilList), "", awvy.a("UnifySearch.Unite", paramString2.a()) });
          break;
        case 3: 
          awvy.a("sub_result", "exp_result", new String[] { paramString2.a(), awvy.a(this.a.jdField_b_of_type_JavaUtilList), "", awvy.a("dynamic_tab_search.1", paramString2.a()) });
          break;
          if (QLog.isColorLevel()) {
      ...
      if ((!TextUtils.isEmpty(ActiveEntitySearchFragment.a(this.a))) && (ActiveEntitySearchFragment.a(this.a).size() > 0))
      {
        ...
        k = bawz.a(paramString3, 8.0F);
        m = bawz.a(paramString3, 10.0F);
        int n = bawz.a(paramString3, 2.0F);
        paramList1 = new GradientDrawable();
        paramList1.setCornerRadius(bawz.a(this.a.getActivity(), 15.0F));
        ...
        if (this.a.jdField_a_of_type_AndroidWidgetLinearLayout.getChildCount() == 0)
        {
          ...
          paramString2 = awiu.a(paramList, paramBoolean1, this.a.jdField_f_of_type_Boolean);
          if ((paramBoolean1) || (l1 != ActiveEntitySearchFragment.a(this.a)) || (paramBoolean3) || (paramString2 == null) || (paramString2.size() <= 0)) {
            break label2428;
          }
          paramArrayOfByte = (awoe)this.a.jdField_a_of_type_JavaUtilList.get(this.a.jdField_a_of_type_JavaUtilList.size() - 1);
          ...
          if (!((awoe)paramString2.get(i) instanceof awnn)) {
            break label2415;
          }
        }
      }
      for (;;)
      {
        if ((paramArrayOfByte instanceof awog))
        {
          paramArrayOfByte = (awog)paramArrayOfByte;
          k = paramArrayOfByte.a();
          awwb.a(paramArrayOfByte, k + i, k - 1);
        }
        for (;;)
        {
          m = 0;
          for (;;)
          {
            if (m < i)
            {
              paramArrayOfByte = (awoe)paramString2.get(m);
              if ((paramArrayOfByte instanceof awog)) {
                awwb.a((awog)paramArrayOfByte, k + i, k + m);
              }
              m += 1;
              continue;
          ...
          this.a.jdField_a_of_type_Awkj.a(this.a.jdField_a_of_type_JavaUtilList);
          ...
          for (;;)
          {
            ...
            {
              this.a.g.setVisibility(0);
              paramString3 = (akac)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159);
              if ((!bool1) && (paramString3.jdField_d_of_type_Boolean)) {
                if (this.a.jdField_a_of_type_Afdf == null)
                {
                  this.a.jdField_a_of_type_Afdf = new afdj(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.getActivity(), this.a.jdField_b_of_type_ComTencentWidgetXListView, null);
                  paramString2 = this.a.jdField_a_of_type_Afdf.a();
                  paramArrayOfByte = new TextView(this.a.getActivity());
                  paramArrayOfByte.setGravity(17);
                  paramArrayOfByte.setLayoutParams(new AbsListView.LayoutParams(-1, actn.a(105.0F, this.a.getResources())));
                  paramArrayOfByte.setTextColor(this.a.getResources().getColor(2131166931));
                  paramArrayOfByte.setTextSize(1, 17.0F);
                  paramArrayOfByte.setText(ajyc.a(2131699766));
                  ...
                  paramArrayOfByte.setPadding(actn.a(15.0F, this.a.getResources()), 0, 0, 0);
                  paramArrayOfByte.setLayoutParams(new AbsListView.LayoutParams(-1, actn.a(40.0F, this.a.getResources())));
                  paramArrayOfByte.setText(ajyc.a(2131699772));
                  paramArrayOfByte.setBackgroundResource(2130838515);
                  paramString2.addHeaderView(paramArrayOfByte);
            ...
            for (;;)
            {
              for (;;)
              {
                ...
                this.a.jdField_a_of_type_Awkj.a(this.a.jdField_a_of_type_JavaUtilList);
                break;
                this.a.jdField_a_of_type_Afdf.b();
                break label2965;
                ...
                try
                {
                  ...
                  this.a.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131699761));
                  if (bool1)
                  {
                    this.a.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
                    this.a.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new awkl(this, paramString2));
                    if (TextUtils.isEmpty(paramArrayOfByte)) {
                      break label2976;
                    }
                    this.a.jdField_a_of_type_AndroidWidgetButton.setText(paramArrayOfByte);
                    this.a.jdField_b_of_type_AndroidWidgetTextView.setPadding(0, bawz.a(this.a.jdField_b_of_type_AndroidWidgetTextView.getContext(), 15.0F), 0, 0);
                  }
                }
