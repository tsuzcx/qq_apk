  ...
  extends ajfb
{
  ...
  public ajve(QQAppInterface paramQQAppInterface)
  {
  ...
  private static PayRuleCfg a(String arg0, String paramString2)
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      ...
      if (paramString2 != null) {
        return (PayRuleCfg)bgfh.a(PayRuleCfg.class, paramString2);
      }
    }
    return null;
  }
  ...
  public static String a(PayRuleCfg paramPayRuleCfg)
  {
    ...
    return Base64.encodeToString(bgfh.a(paramPayRuleCfg), 2) + "\n" + paramPayRuleCfg;
  }
  ...
  public static void a(int paramInt, String paramString)
  {
    ...
    localbgqx.b = (str + "_" + l1);
    localbgqx.jdField_a_of_type_Int = 1;
    localbgqx.jdField_e_of_type_JavaLangString = "tianshu.47";
    localbgqx.jdField_f_of_type_JavaLangString = "tianshu.47";
    localbgqx.g = paramString;
    localbgqx.h = "";
    localbgqx.jdField_a_of_type_Long = l1;
  ...
  private void a(@NonNull PrivExtV2Rsp paramPrivExtV2Rsp, String paramString)
  {
    ...
    Friends localFriends = localajjj.d(paramString);
    ...
    {
      paramString = (ajkz)this.app.getManager(131);
    ...
    for (;;)
    {
      batf.a().a(this.app, paramPrivExtV2Rsp);
      return;
      label508:
      paramString.apply();
    }
  ...
  private void a(VipMedalList paramVipMedalList, String paramString)
  {
    ...
    ajjj localajjj = (ajjj)this.app.getManager(51);
    paramString = localajjj.d(paramString);
  ...
  private static boolean a(PayRuleCfg paramPayRuleCfg1, PayRuleCfg paramPayRuleCfg2)
  {
    ...
    return Arrays.equals(bgfh.a(paramPayRuleCfg1), bgfh.a(paramPayRuleCfg2));
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, PayRuleCfg paramPayRuleCfg, boolean paramBoolean)
  {
    ...
    for (paramQQAppInterface = Boolean.valueOf(false);; paramQQAppInterface = Integer.valueOf(paramPayRuleCfg.enable))
    {
      ...
      return false;
      long l1 = baub.a(paramQQAppInterface, "last_pull_pay_rule", 0L);
  ...
  public static int b(PayRuleCfg paramPayRuleCfg)
  {
    ...
    while (paramPayRuleCfg.userType == 3) {
      return i1;
    }
    if (paramPayRuleCfg.clubType == 2) {
      return 4;
    }
    if (paramPayRuleCfg.clubType == 3) {
      return 3;
    }
    return 1;
  }
  ...
  private static void b(String paramString1, String arg1, PayRuleCfg paramPayRuleCfg)
  {
    ...
    paramPayRuleCfg = bgfh.a(paramPayRuleCfg);
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      bace.a(paramPayRuleCfg, paramString1.getAbsolutePath());
      return;
    }
  }
  ...
  public void a(UniGetReq paramUniGetReq, ajfe paramajfe, boolean paramBoolean)
  {
    paramajfe = createToServiceMsg("QCUniBusinessLogic.uniGet", paramajfe, paramBoolean);
    paramUniGetReq.stLogin = a();
    paramajfe.extraData.putSerializable("req", paramUniGetReq);
    send(paramajfe);
  }
  
  public void a(UniSetReq paramUniSetReq, ajfe paramajfe, boolean paramBoolean)
  {
    paramajfe = createToServiceMsg("QCUniBusinessLogic.uniSet", paramajfe, paramBoolean);
    paramUniSetReq.stLogin = a();
    paramajfe.extraData.putSerializable("req", paramUniSetReq);
    send(paramajfe);
  }
          ...
          do
          {
            ...
            if ("ClubInfoSvc.queryPrivExt".equals(localObject1))
            {
              ...
              if (i1 == 1)
              {
                ...
                bati.a(((PrivExtV2Rsp)localObject1).trafficResult, paramToServiceMsg.extraData);
                if ((localObject2 != null) && (((VipUserInfo)localObject2).bUpdate == 1) && (((PrivExtV2Rsp)localObject1).trafficResult != null) && (((PrivExtV2Rsp)localObject1).trafficResult.bUpdate == 1) && (((PrivExtV2Rsp)localObject1).medalInfoList != null) && (((PrivExtV2Rsp)localObject1).medalInfoList.bUpdate == 1)) {
                  baub.a(this.app, "setting_me_get_vip_info_sequence", NetConnInfoCenter.getServerTime());
                }
                baub.a(this.app, "setting_me_last_request_success_time", NetConnInfoCenter.getServerTime());
                baub.a(this.app, "setting_me_vip_sync_freq", ((PrivExtV2Rsp)localObject1).iSyncFreq);
                if ((((PrivExtV2Rsp)localObject1).medalInfoList != null) && (((PrivExtV2Rsp)localObject1).medalInfoList.bUpdate == 1))
                {
                  ...
                  l1 = 1L;
                  baub.a(this.app, "key_long_setting_me_vip_medal_list_record", l1);
                }
                paramToServiceMsg = ((PrivExtV2Rsp)localObject1).itemCfgList;
                if (paramToServiceMsg != null)
                {
                  l1 = baub.a(this.app, "name_plate_config_version", 0L);
                  ...
                  {
                    baub.a(this.app, "name_plate_config_version", paramToServiceMsg.iItemCfgVer);
                ...
                {
                  baub.a(this.app, "last_pull_pay_rule", NetConnInfoCenter.getServerTime());
              ...
              for (bool2 = bool1;; bool2 = bool1)
              {
                ...
                bcad.a().a("ClubInfoSvc.queryPrivExt", 100, paramFromServiceMsg.getBusinessFailCode(), this.app.getCurrentAccountUin(), 1000277, "[CMD:ClubInfoSvc.queryPrivExtfailed]", true);
              }
            }
