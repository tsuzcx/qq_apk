...
public class bkpg
{
  ...
  public void a(Canvas paramCanvas, bkph parambkph)
  {
    if ((paramCanvas == null) || (parambkph == null)) {
      return;
    }
    if ((this.jdField_a_of_type_Boolean) && (a()))
    {
      this.jdField_a_of_type_AndroidGraphicsRectF.set(0.0F, 0.0F, parambkph.getWidth(), parambkph.getHeight());
      int i = this.e;
      if (b()) {
        i = c;
      }
