...
public class aqvs
{
  ...
  public WeakReference<aqwn> a;
  public HashSet<String> a;
  
  public aqvs(BaseActivity paramBaseActivity, aqwn paramaqwn)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity = paramBaseActivity;
    this.jdField_a_of_type_JavaUtilHashSet = bbew.a(paramBaseActivity);
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramaqwn);
  }
  ...
  public ArrayList<String> a(Bundle paramBundle)
  {
    ...
    if ((paramBundle != null) && ((paramBundle instanceof ArrayList)))
    {
      ...
      aqvv localaqvv = new aqvv(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, false, null);
      int i = 0;
      while (i < paramBundle.size())
      {
        String str = localaqvv.a((Uri)paramBundle.get(i), false);
  ...
  public void a(String paramString)
  {
    ...
    aqwk localaqwk = (aqwk)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.getManager(311);
    ...
    paramString = (aqwn)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if (paramString != null) {
      localaqwk.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, localCheckShareExtensionReq, "android.intent.action.SEND", paramString);
    }
  }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      localaqwk = (aqwk)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.getManager(311);
      ...
      if ((!TextUtils.isEmpty(paramString1)) && (new File(paramString1).exists()))
      {
        ...
        localVideoInfo.sha1.set(aqvu.a(paramString1));
        localVideoInfo.play_duration.set((int)l);
        localCheckShareExtensionReq.videos.add(localVideoInfo);
      }
      paramString1 = (aqwn)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (paramString1 == null);
    localaqwk.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, localCheckShareExtensionReq, paramString2, paramString1);
  }
  ...
  public void a(ArrayList<String> paramArrayList, String paramString)
  {
    ...
    do
    {
      ...
      while (paramArrayList.hasNext())
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject2))
        {
          ...
          if (((File)localObject1).exists())
          {
            ...
            String str = bbea.a(apug.d((String)localObject2));
            if (QLog.isColorLevel()) {
              QLog.d("CheckForward.Security", 2, "sendCheckImgShareReq md5= " + str);
            }
            localImgInfo.md5.set(str);
            localImgInfo.sha1.set(aqvu.a((String)localObject2));
            localObject2 = aqvu.a((String)localObject2);
            ...
            localObject1 = aqvu.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, (File)localObject1);
      ...
      paramArrayList = (aqwn)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (paramArrayList == null);
    localaqwk.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, localCheckShareExtensionReq, paramString, paramArrayList);
  }
  ...
  public boolean a(Uri paramUri, int paramInt, String paramString)
  {
    if (this.jdField_a_of_type_Aqvv == null) {
      this.jdField_a_of_type_Aqvv = new aqvv(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, false, new aqvt(this, paramInt, paramString));
    }
    String str = this.jdField_a_of_type_Aqvv.a(paramUri);
    ...
    {
      return false;
      if ((this.jdField_a_of_type_Aqvv.b) || (this.jdField_a_of_type_Aqvv.a)) {
        return true;
      }
      paramUri = new File(str);
      l = paramUri.length();
    } while ((!this.jdField_a_of_type_Aqvv.b) && (!this.jdField_a_of_type_Aqvv.a) && (l == 0L));
    if ((aqcc.b(str)) || (!paramUri.canRead()))
    {
