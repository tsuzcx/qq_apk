...
public class pye
  implements oxp
{
  public pye(ComponentPGCShortContentBig paramComponentPGCShortContentBig, qda paramqda) {}
  ...
  public void a(String[] paramArrayOfString1, String[] paramArrayOfString2)
  {
    if ((ComponentPGCShortContentBig.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentPGCShortContentBig) != null) && ((ComponentPGCShortContentBig.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentPGCShortContentBig) instanceof VideoView)))
    {
      if ((paramArrayOfString2 != null) && (paramArrayOfString2.length > 0))
      {
        ...
        if ((!TextUtils.isEmpty(this.jdField_a_of_type_Qda.e)) && (this.jdField_a_of_type_Qda.e.equals(paramArrayOfString1[0])) && (this.jdField_a_of_type_Qda.e.equals(((MediaVideoView)ComponentPGCShortContentBig.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentPGCShortContentBig)).a())))
        {
