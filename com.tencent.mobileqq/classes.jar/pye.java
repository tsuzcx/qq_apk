...
public class pye
{
  ...
  public pye(ExecutorService paramExecutorService, ReadInJoyUserInfoModule paramReadInJoyUserInfoModule, EntityManager paramEntityManager)
  {
  ...
  private void a(ReadInJoyUserInfo paramReadInJoyUserInfo)
  {
    ...
    if (paramReadInJoyUserInfo != null) {
      pha.a("saveReadInJoyUserInfoToDB", new ReadInJoyUserInfoRepository.1(this, paramReadInJoyUserInfo), this.jdField_a_of_type_JavaUtilConcurrentExecutorService);
    }
  }
  ...
  public void a(int paramInt)
  {
    try
    {
      pha.a("loadReadInJoyUserInfoFromDB", new ReadInJoyUserInfoRepository.2(this, paramInt), this.jdField_a_of_type_JavaUtilConcurrentExecutorService);
      return;
    }
  ...
  public void a(String paramString, ReadInJoyUserInfo paramReadInJoyUserInfo)
  {
    ...
    if ((localObject != null) && (((ConcurrentHashMap)localObject).get(paramString) != null))
    {
      ...
      while (localIterator.hasNext())
      {
        pyb localpyb = (pyb)localIterator.next();
        if (localpyb != null)
        {
          localpyb.onLoadUserInfoSucceed(paramString, paramReadInJoyUserInfo);
          localArrayList.add(localpyb);
        }
      }
