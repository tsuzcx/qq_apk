...
public final class bgtw
{
    ...
    if (!jdField_a_of_type_Boolean) {
      try
      {
        if (!jdField_a_of_type_Boolean)
        {
          ...
          bgti.a(localBaseApplicationImpl, false);
          bguo.a(localBaseApplicationImpl);
  ...
  private static void a(Application paramApplication)
  {
    ...
    for (paramApplication = new File(ajed.aU);; paramApplication = paramApplication.getCacheDir())
    {
  ...
  public static void b()
  {
    if (jdField_a_of_type_Boolean) {
      try
      {
        if (jdField_a_of_type_Boolean)
        {
          bgti.a(false, BaseApplicationImpl.getApplication().getRuntime().getLongAccountUin());
