  ...
  extends adoc
{
  ...
  adyu(QQAppInterface paramQQAppInterface, String paramString)
  {
  ...
  public void a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    do
    {
      ...
      this.jdField_c_of_type_Int = 0;
      paramString = this.jdField_a_of_type_Adtd;
  ...
  public boolean b(String paramString)
  {
    ...
    WeakReference localWeakReference = new WeakReference(this);
    if (!((altm)localObject).a(str, paramString, this.jdField_a_of_type_Int, i, new adyv(this, localWeakReference)))
    {
