  ...
  implements phs
{
  ...
  public JSONObject a(int paramInt, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    for (;;)
    {
      try
      {
        localpdp.a(str1).c(paramBaseArticleInfo, str2).j(paramBaseArticleInfo).r(paramBaseArticleInfo);
        return localpdp.a();
      }
      ...
      try
      {
        localpdp.a("ReadInjoy_QA_NoImage_cell");
      }
      catch (JSONException paramBaseArticleInfo)
      {
        paramBaseArticleInfo.printStackTrace();
  ...
  public void a(int paramInt1, Container paramContainer, pax parampax, int paramInt2)
  {
    ...
    if ((localObject == null) || (parampax == null) || (parampax.a() == null)) {}
    ...
    boolean bool = osj.a().a(parampax.a().mArticleID);
