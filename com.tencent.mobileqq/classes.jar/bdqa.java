  ...
  extends bdnu
{
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    for (paramBundle = ahcj.a(paramContext, this.jdField_a_of_type_ComTencentMobileqqDataMessageForPic);; paramBundle = null)
    {
      ...
      for (paramBundle = this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForImageShare.currentAccountUin;; paramBundle = this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForImageShare.uin)
      {
        ...
        if (a())
        {
          ...
          avek.a(this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForImageShare, (MessageForPic)localObject, this);
        }
        paramBundle = AbsDownloader.getFile(URLDrawableHelper.getURL((azkl)localObject, 1, null).toString());
        ...
        localObject = ahcj.a(paramContext, this.jdField_a_of_type_ComTencentMobileqqDataMessageForPic);
        ...
        avek.a(this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForImageShare, paramContext, this);
        return paramContext;
      }
      paramView = new BubbleImageView(paramContext);
      paramView.setId(2131368706);
  ...
  public boolean a(bdpl parambdpl)
  {
    ...
    {
      return true;
      String str4 = parambdpl.a("uuid");
      String str3 = parambdpl.a("md5");
      String str6 = parambdpl.a("md5");
      String str5 = parambdpl.a("filesize");
      String str2 = parambdpl.a("local_path");
      String str1 = str4;
      if (str4 == null) {
        str1 = "";
      }
      ...
      if (str3 == null)
      {
        ...
        str1 = "";
        this.ac = str1;
        this.o = AIOUtils.parseInt(parambdpl, "minWidth");
        this.p = AIOUtils.parseInt(parambdpl, "minHeight");
        this.q = AIOUtils.parseInt(parambdpl, "maxWidth");
        this.r = AIOUtils.parseInt(parambdpl, "maxHeight");
        if (str6 == null) {}
      }
      try
      {
