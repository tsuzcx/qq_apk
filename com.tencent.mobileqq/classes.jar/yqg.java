...
public class yqg
{
  public static int a(int paramInt)
  {
    ...
    if (localObject == null)
    {
      xvv.c("Q.qqstory.tag.RedPointUtils", "getStoryRedPointByAppId() error, app is null", new Throwable());
      return 0;
    }
    localObject = ((nmq)((QQAppInterface)localObject).getManager(70)).a(paramInt);
    if (localObject == null)
    {
      xvv.a("Q.qqstory.tag.RedPointUtils", "getStoryRedPointByAppId(%d) info is null", Integer.valueOf(paramInt));
      return 0;
    }
    xvv.a("Q.qqstory.tag.RedPointUtils", "getStoryRedPointByAppId(%d) info is %s", Integer.valueOf(paramInt), yps.a((MessageMicro)localObject));
  ...
  {
    return ((vxx)paramQQAppInterface.getManager(252)).a;
  }
