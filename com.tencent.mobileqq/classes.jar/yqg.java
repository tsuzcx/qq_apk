  ...
  extends QIPCModule
{
  ...
  public static String a()
  {
    ...
    if (localObject2 != null)
    {
      ...
      {
        JSONObject localJSONObject = ((yqb)((Iterator)localObject2).next()).a();
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if ("action_img_preupload".equals(paramString))
    {
      ...
      a();
      this.jdField_a_of_type_Yqi = yqi.a(paramString, l1);
      if (QLog.isColorLevel()) {
        QLog.d("ArtFilterModule", 2, "ACTION_IMG_PREUPLOAD:  currentFilterImgPath:" + this.b + " currentFilterUploadProcessors:" + this.jdField_a_of_type_AndroidUtilSparseArray + "\n currentFilterUploadInfo:" + this.jdField_a_of_type_Yqi);
      }
      a().begin(paramInt, -1, "", 0, this.jdField_a_of_type_Yqi, true);
    }
    for (;;)
    {
      return null;
      if ("action_get_art_filter_path".equals(paramString))
      {
        ...
        if ((this.b != null) && (this.b.equals(str)))
        {
          if (this.jdField_a_of_type_AndroidUtilSparseArray.get(i) == null)
          {
            ...
            {
              if (this.jdField_a_of_type_Yqi == null) {
                this.jdField_a_of_type_Yqi = yqi.a(str, l1);
              }
              paramBundle = a();
              paramBundle.reportKey("current_TaskCount", String.valueOf(this.jdField_a_of_type_AndroidUtilSparseArray.size()));
              paramBundle.begin(paramInt, i, paramString, j, this.jdField_a_of_type_Yqi, bool1);
        ...
        else
        {
          ...
          paramBundle = a();
          this.jdField_a_of_type_AndroidUtilSparseArray.put(i, paramBundle);
          paramBundle.begin(paramInt, i, paramString, j, this.jdField_a_of_type_Yqi, true);
        }
      }
      ...
      else if ("action_exit_art_filter".equals(paramString))
      {
        a(true);
        a();
        this.jdField_a_of_type_Yqi = null;
      }
    }
  }
}
