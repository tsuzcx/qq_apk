...
public class asnw
  extends asls
  implements View.OnClickListener, asgj, blih
{
  ...
  public asnw(EmoticonPanelController paramEmoticonPanelController)
  {
  ...
  public void A()
  {
    if ((this.jdField_a_of_type_Aslt != null) && (this.jdField_a_of_type_ComTencentWidgetListView != null) && ((this.jdField_a_of_type_Aslt instanceof aspa)))
    {
      ...
      ((aspa)this.jdField_a_of_type_Aslt).a(i, j);
    }
  }
  ...
  public View a()
  {
    ...
    Object localObject = ardt.a();
    if (localObject != null)
    {
      localObject = ((ardu)localObject).jdField_a_of_type_JavaUtilList;
      this.jdField_a_of_type_JavaUtilList = ((List)localObject);
      if ((localObject != null) && (!this.jdField_a_of_type_JavaUtilList.isEmpty()))
      {
        this.jdField_a_of_type_ComTencentMobileqqExtendfriendWigetExtendFriendLabelFlowLayout.setAdapter(new asny(this, a(), this.jdField_a_of_type_JavaUtilList));
  ...
  public void a()
  {
    ...
    ((asnp)this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonPanelController.a(1)).m();
  }
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqExtendfriendWigetExtendFriendLabelFlowLayout = ((ExtendFriendLabelFlowLayout)paramView.findViewById(2131366907));
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)paramView.findViewById(2131370285));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131380065));
    ImageView localImageView = (ImageView)paramView.findViewById(2131369364);
    Button localButton = (Button)paramView.findViewById(2131363744);
    this.jdField_b_of_type_AndroidViewViewGroup = ((ViewGroup)paramView.findViewById(2131366737));
    this.jdField_d_of_type_AndroidViewView = paramView.findViewById(2131376903);
  ...
  public void a(asgh paramasgh)
  {
    ...
    if ((this.jdField_a_of_type_Aslt == null) || (this.jdField_a_of_type_ComTencentWidgetListView == null))
    {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("EmoticonPanelHotPicSearchHelper", 2, "onSearchCallBack result： " + paramasgh.a());
    }
    if ((paramasgh.a() == -101) || (paramasgh.a() == -103))
    {
      this.jdField_c_of_type_Boolean = false;
      return;
    }
    ThreadManager.getUIHandler().post(new EmoticonPanelHotPicSearchHelper.1(this, paramasgh));
  }
  
  protected void a(QQAppInterface paramQQAppInterface, asgi paramasgi, asgj paramasgj)
  {
    if (QLog.isColorLevel()) {
      QLog.d("EmoticonPanelHotPicSearchHelper", 2, "pushEmotionSearchTask ");
    }
    paramQQAppInterface = (asgg)paramQQAppInterface.getManager(367);
    paramQQAppInterface.b();
    paramQQAppInterface.a(paramasgj);
    paramQQAppInterface.a(paramasgi);
  }
  ...
  public void a(EmotionPanelListView paramEmotionPanelListView, aslt paramaslt, int paramInt)
  {
    if ((paramEmotionPanelListView != null) && (paramInt == 14))
    {
      b(paramEmotionPanelListView, paramaslt);
      paramaslt = a();
      if ((paramaslt.getParent() == null) && (paramEmotionPanelListView.findHeaderViewPosition(paramaslt) == -1)) {
        paramEmotionPanelListView.addHeaderView(paramaslt);
      }
      paramaslt = b();
      if (paramaslt.getParent() == null) {
        paramEmotionPanelListView.addFooterView(paramaslt);
      }
    }
  }
  ...
  protected View b()
  {
    if (this.jdField_b_of_type_AndroidViewView == null)
    {
      this.jdField_b_of_type_AndroidViewView = View.inflate(a(), 2131558613, null);
      this.jdField_b_of_type_AndroidViewView.setBackgroundColor(0);
      this.jdField_b_of_type_AndroidViewView.setLayoutParams(new AbsListView.LayoutParams(-1, bhtq.a(74.0F)));
    }
    p();
  ...
  public void b()
  {
    ...
    ((asnp)this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonPanelController.a(1)).n();
  }
  ...
  public void b(asgh paramasgh)
  {
    if ((this.jdField_a_of_type_Aslt == null) || (paramasgh == null)) {
      return;
    }
    int i;
    if (paramasgh.a() == 0)
    {
      if (QLog.isColorLevel()) {
        QLog.d("EmoticonPanelHotPicSearchHelper", 2, "onSearchCallBack success isHasMore: " + paramasgh.a());
      }
      Object localObject = paramasgh.a();
      if ((localObject == null) || (((List)localObject).isEmpty()))
      {
        ...
        b(8);
        this.jdField_a_of_type_Aslt.a(new ArrayList());
        m();
        o();
        p();
        return;
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        localArrayList.add(new asqu(a(), localArrayList.size() + 1, b(), localEmotionSearchItem));
      }
      ...
      if (paramasgh.a())
      {
        ...
        o();
        p();
        this.jdField_a_of_type_Aslt.a(localArrayList);
        m();
      }
    }
    for (;;)
  ...
  protected void b(ListView paramListView, aslt paramaslt)
  {
  ...
  {
    bdll.b(a(), "dc00898", "", "", paramString, paramString, 0, 0, "2", "", "", "");
  }
  ...
  protected boolean b()
  {
    int i = bhsi.aK(a(), a().getCurrentAccountUin());
    return (a() == 2) && (i == 5);
  }
  ...
  protected void c(asgh paramasgh)
  {
    if ((this.jdField_a_of_type_Int == 0) || (this.jdField_a_of_type_Int == 5)) {
      b(4);
    }
    for (;;)
    {
      ...
      p();
      return;
      if ((paramasgh.a() == -102) || (paramasgh.a() == -100)) {
        b(7);
      } else if (paramasgh.a() == -104) {
        b(3);
      } else {
        b(2);
      }
  ...
  {
    bdll.b(a(), "dc00898", "", "", paramString, paramString, 0, 0, "", "", "", "");
  }
  ...
  protected boolean c()
  {
    ...
    label106:
    for (localLayoutParams.topMargin = (bhtq.a(60.0F) + this.jdField_a_of_type_ComTencentMobileqqExtendfriendWigetExtendFriendLabelFlowLayout.getHeight());; localLayoutParams.topMargin = bhtq.a(60.0F))
    {
  ...
  public void d(String paramString)
  {
    ...
    if ((TextUtils.isEmpty(paramString)) || (this.jdField_a_of_type_Aslt == null)) {
      return;
    }
    if (QLog.isColorLevel()) {
  ...
  public void f()
  {
    ...
    if ((jdField_c_of_type_Int != a()) || (a() == 2))
    {
      ...
      if ((i != 0) && (this.jdField_a_of_type_ComTencentWidgetListView != null) && (this.jdField_a_of_type_Aslt != null))
      {
        if (!TextUtils.isEmpty(b())) {
          break label102;
        }
  ...
  public void i()
  {
    ...
    jdField_b_of_type_Boolean = false;
    this.jdField_c_of_type_Boolean = false;
    this.jdField_a_of_type_Aslt = null;
  ...
  protected void m()
  {
    ...
    TextView localTextView = (TextView)this.jdField_c_of_type_AndroidViewView.findViewById(2131365944);
    View localView = this.jdField_c_of_type_AndroidViewView.findViewById(2131365955);
    this.jdField_c_of_type_AndroidViewView.setVisibility(0);
    if ((this.jdField_a_of_type_Int == 4) && ((bhtq.a(XPanelContainer.b()) < XPanelContainer.jdField_a_of_type_Int) || ("RichTextPanelEmoticonSearchLayoutHelper".equals(a()))))
    {
      localView.setVisibility(8);
      localTextView.setText(2131689862);
    ...
    {
      localView.setVisibility(8);
      localTextView.setText(2131689860);
      return;
    }
  ...
  protected void p()
  {
    ...
    TextView localTextView1 = (TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131368172);
    localTextView1.setTextSize(12.0F);
    View localView = this.jdField_b_of_type_AndroidViewView.findViewById(2131368171);
    TextView localTextView2 = (TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131370327);
    ...
    if (this.jdField_a_of_type_Int == 7)
    {
      ...
      localTextView1.setText(2131689861);
  ...
  protected void u()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonPanelController.jdField_a_of_type_Asok.b(EmoticonPanelController.jdField_b_of_type_Int);
  }
  
  protected void v()
  {
    if ((this.jdField_a_of_type_Aslt instanceof aspa)) {
      ((aspa)this.jdField_a_of_type_Aslt).d();
    }
  }
  ...
  protected void y()
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetListView.setOnScrollListener(new asnx(this));
  }
  ...
  public void z()
  {
    ...
    b(5);
    if (this.jdField_a_of_type_Aslt != null)
    {
      this.jdField_a_of_type_AndroidViewViewGroup.setVisibility(8);
      this.jdField_b_of_type_AndroidViewViewGroup.setVisibility(8);
      this.jdField_a_of_type_ComTencentMobileqqExtendfriendWigetExtendFriendLabelFlowLayout.setVisibility(8);
