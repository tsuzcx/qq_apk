...
{
  public aegv(LikeRankingListActivity paramLikeRankingListActivity) {}
  ...
  public void onCardDownload(boolean paramBoolean, Object paramObject)
  {
    ...
    if ((paramBoolean) && ((paramObject instanceof Card)))
    {
      ...
      if (paramObject.uin.equals(this.a.b)) {
        this.a.app.execute(new LikeRankingListActivity.2.1(this, paramObject));
      }
    }
  }
  ...
  public void onReqLikeRankingListResult(boolean paramBoolean1, String paramString, List<LikeRankingInfo> paramList, int paramInt, boolean paramBoolean2)
  {
    ...
    else
    {
      ...
      this.a.jdField_a_of_type_Anxs.a(paramList, paramInt, paramBoolean2);
      if ((!paramBoolean2) || (paramList.size() != 0)) {
        break label258;
      }
      this.a.e.setVisibility(0);
      label165:
      this.a.jdField_a_of_type_Aegw.a(paramList, true);
    ...
    for (;;)
    {
      ...
      label284:
      this.a.a(null);
      this.a.jdField_a_of_type_Aegw.a = false;
      this.a.jdField_a_of_type_Aegw.notifyDataSetChanged();
      if (this.a.jdField_a_of_type_Aegw.getCount() <= 1) {
        this.a.e.setVisibility(0);
      }
    }
    label341:
    this.a.jdField_a_of_type_Aegw.a = false;
    this.a.jdField_a_of_type_Aegw.notifyDataSetChanged();
    QQToast.a(BaseApplication.getContext(), 1, anvx.a(2131705593), 0).a();
  }
}
