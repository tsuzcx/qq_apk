...
public class vpu
  extends vpw
{
  public vpu(PhotoListPanel.SwipeUpAndDragListener paramSwipeUpAndDragListener, Context paramContext, ViewGroup paramViewGroup)
  {
  ...
  private boolean a(int paramInt)
  {
    ...
    ((AnimationSet)localObject1).setAnimationListener(new vpv(this));
    return true;
  }
