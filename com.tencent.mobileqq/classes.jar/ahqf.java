...
public class ahqf
  implements Runnable
{
  public ahqf(ScribbleResMgr paramScribbleResMgr, ScribbleResMgr.ResInfo paramResInfo) {}
  
  public void run()
  {
    Object localObject1 = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
    Object localObject2 = ScribbleResMgr.a((QQAppInterface)localObject1).b(this.jdField_a_of_type_ComTencentMobileqqScribbleScribbleResMgr$ResInfo.resType, this.jdField_a_of_type_ComTencentMobileqqScribbleScribbleResMgr$ResInfo.sourceId);
    ...
    do
    {
      ...
      ((HttpNetReq)localObject2).jdField_a_of_type_ComTencentMobileqqTransfileINetEngine$INetEngineListener = new ahqg(this);
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqScribbleScribbleResMgr$ResInfo.resType == 1) {
        ((HttpNetReq)localObject2).jdField_c_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqScribbleScribbleResMgr.b(this.jdField_a_of_type_ComTencentMobileqqScribbleScribbleResMgr$ResInfo.resType, this.jdField_a_of_type_ComTencentMobileqqScribbleScribbleResMgr$ResInfo.sourceId);
      }
      if (this.jdField_a_of_type_ComTencentMobileqqScribbleScribbleResMgr$ResInfo.resType == 2) {
        ((HttpNetReq)localObject2).jdField_c_of_type_JavaLangString = ScribbleResMgr.a(this.jdField_a_of_type_ComTencentMobileqqScribbleScribbleResMgr, this.jdField_a_of_type_ComTencentMobileqqScribbleScribbleResMgr$ResInfo.sourceId);
      }
