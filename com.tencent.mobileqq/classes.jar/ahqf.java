...
public class ahqf
  extends ajmw
{
  public ahqf(CreateFaceToFaceDiscussionActivity paramCreateFaceToFaceDiscussionActivity) {}
  ...
  protected void a(boolean paramBoolean, Object paramObject)
  {
    ...
    if (this.a.jdField_a_of_type_Bbms != null)
    {
      ...
      this.a.jdField_a_of_type_Bbms = null;
    }
    ...
    if (paramBoolean)
    {
      ...
      if (j == this.a.jdField_a_of_type_Int)
      {
        ...
        this.a.finish();
        localObject = babh.a(this.a.app, this.a.getActivity().getApplicationContext(), paramObject);
        localIntent = aciy.a(new Intent(this.a.getActivity(), SplashActivity.class), null);
    ...
    while (j != this.a.jdField_a_of_type_Int)
    {
      ...
      {
        this.a.finish();
        localObject = aciy.a(new Intent(this.a.getActivity(), SplashActivity.class), null);
        ((Intent)localObject).putExtra("uin", paramObject);
        ((Intent)localObject).putExtra("uintype", 1);
        ((Intent)localObject).putExtra("uinname", babh.h(this.a.app, this.a.app.getCurrentAccountUin()) + ajjy.a(2131636829));
        ((Intent)localObject).putExtra("isBack2Root", true);
        this.a.startActivity((Intent)localObject);
        awqx.b(this.a.app, "dc00899", "Grp_create", "", "f2f", "cre_suc", 0, 0, paramObject, "", "", "");
        return;
      }
      CreateFaceToFaceDiscussionActivity.a(this.a, 1, this.a.getString(2131626716));
      return;
    }
    CreateFaceToFaceDiscussionActivity.b(this.a, 1, this.a.getString(2131626716));
  }
    ...
    if (paramBoolean)
    {
      ...
      if ((paramBusiRespHead != null) && (paramBusiRespHead.int32_reply_code.get() != 0))
      {
        if (!this.a.jdField_c_of_type_Boolean)
        {
          ...
          bbmy.a(this.a.jdField_a_of_type_AndroidContentContext, paramList, 0).a();
    ...
    for (;;)
    {
      ...
      default: 
        if (this.a.jdField_a_of_type_JavaUtilList == null)
        {
          ...
          if (this.a.jdField_a_of_type_Ahqi != null)
          {
            this.a.jdField_a_of_type_Ahqi.notifyDataSetChanged();
      ...
      for (;;)
      {
        ...
        return;
        CreateFaceToFaceDiscussionActivity.a(this.a).setText(this.a.getString(2131624197));
        CreateFaceToFaceDiscussionActivity.a(this.a).setContentDescription(this.a.getString(2131624197));
        this.a.jdField_a_of_type_AndroidWidgetTextView.setText(this.a.getString(2131653363));
        this.a.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(this.a.getString(2131653363));
        this.a.jdField_b_of_type_AndroidWidgetTextView.setText(this.a.getString(2131653364));
        this.a.jdField_b_of_type_AndroidWidgetTextView.setContentDescription(this.a.getString(2131653364));
        this.a.jdField_a_of_type_AndroidWidgetButton.setTextColor(this.a.getResources().getColor(2131101290));
        this.a.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130838998);
        this.a.jdField_a_of_type_AndroidWidgetButton.setText(ajjy.a(2131636828));
        this.a.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
        this.a.jdField_c_of_type_AndroidWidgetTextView.setText(this.a.getString(2131653368));
        break;
        this.a.jdField_b_of_type_Boolean = false;
        this.a.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
        this.a.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
        this.a.jdField_c_of_type_AndroidWidgetTextView.setText(this.a.getString(2131653370, new Object[] { localObject }));
        this.a.jdField_a_of_type_AndroidWidgetButton.setText(this.a.getString(2131653366));
        this.a.jdField_a_of_type_AndroidWidgetButton.setTextColor(-1);
        this.a.jdField_a_of_type_AndroidWidgetButton.setContentDescription(this.a.getString(2131653366));
        this.a.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130838998);
        break;
        this.a.jdField_b_of_type_Boolean = true;
        this.a.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
        this.a.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
        this.a.jdField_c_of_type_AndroidWidgetTextView.setText(this.a.getString(2131653369, new Object[] { localObject }));
        this.a.jdField_a_of_type_AndroidWidgetButton.setText(this.a.getString(2131653367));
        this.a.jdField_a_of_type_AndroidWidgetButton.setTextColor(-1);
        this.a.jdField_a_of_type_AndroidWidgetButton.setContentDescription(this.a.getString(2131653367));
        this.a.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130838998);
        break;
        ...
        if (!this.a.jdField_c_of_type_Boolean)
        {
          bbmy.a(this.a.jdField_a_of_type_AndroidContentContext, ajjy.a(2131636826), 1).a();
          if (this.a.jdField_a_of_type_AndroidOsHandler.hasMessages(1)) {
            this.a.jdField_a_of_type_AndroidOsHandler.removeMessages(1);
          }
          this.a.jdField_a_of_type_AndroidOsHandler.sendEmptyMessageDelayed(1, 600L);
