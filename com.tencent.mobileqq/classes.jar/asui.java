...
public class asui
{
  ...
  public asui(String paramString, int paramInt)
  {
  ...
  public static Drawable a(Context paramContext, asuo paramasuo)
  {
    Object localObject = paramasuo.a;
    ...
    for (paramContext = paramContext.a("fromAIO", true);; paramContext = null)
    {
      ...
      do
      {
        ...
        localURL = beyq.a((MessageForPic)localObject, 1);
        ...
        localURL = ahng.a((MessageForPic)localObject);
      ...
      QLog.d("EmotionDataManager", 2, new Object[] { "init view,big pic not exist:", beqz.a(localURL.toString()) });
      return localObject;
      return null;
    }
  }
  
  public static asre a(MessageForMarketFace paramMessageForMarketFace)
  {
    return ((axfj)((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime()).getManager(14)).a(paramMessageForMarketFace.mMarkFaceMessage);
  }
  ...
  private static URLDrawable.URLDrawableOptions a(Context paramContext, int paramInt1, int paramInt2)
  {
    ...
    localURLDrawableOptions.mLoadingDrawable = new ascz(paramInt1, paramInt2);
    return localURLDrawableOptions;
  }
  
  public static EmoticonPackage a(String paramString)
  {
    return ((axfj)((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime()).getManager(14)).a(paramString);
  }
  ...
  private List<MessageRecord> a(List<MessageRecord> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if ((localObject1 instanceof MessageForPic))
      {
        ...
        if ((!a((MessageForPic)localObject2)) && (ahng.a((MessageForPic)localObject2))) {
        ...
        if (((MessageForMixedMsg)localObject1).msgElemList != null)
        {
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            if ((localObject2 instanceof MessageForPic))
            {
              ...
              ((MessageForPic)localObject2).parse();
              if (ahng.a((MessageForPic)localObject2)) {
  ...
  {
    return aiyz.a(paramMessageForPic);
  }
}
