...
public class bcfe
{
  ...
  public bcfe(float paramFloat1, int paramInt1, int paramInt2, float paramFloat2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, boolean paramBoolean)
  {
    this.jdField_a_of_type_Int = 100;
    this.jdField_b_of_type_Int = 10;
    this.jdField_a_of_type_Float = 0.001F;
