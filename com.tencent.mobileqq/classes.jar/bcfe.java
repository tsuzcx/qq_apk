  ...
  implements Handler.Callback
{
  ...
  public bcfe(Activity paramActivity)
  {
  ...
  private static Pair<Integer, Integer> a(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      if (paramString.isHierarchical())
      {
        ...
        if ((!TextUtils.isEmpty(paramString)) && (mvv.a().l(paramString)))
        {
          ...
          if (!paramString.contains("cmshow")) {
            i = m - (int)muf.a(BaseApplicationImpl.getApplication(), 54.0F);
          }
        }
      }
    }
  ...
  private String a()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.a != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.a.size() > 1))
    {
      ...
      {
        localObject = (bgin)((AppInterface)MobileQQ.sMobileQQ.waitAppRuntime(null).getAppRuntime("modular_web")).getManager(213);
        ArrayList localArrayList = new ArrayList();
        localArrayList.add("1113.100803");
        this.jdField_a_of_type_JavaUtilMap = ((bgin)localObject).a(localArrayList);
      }
      if (this.jdField_a_of_type_JavaUtilMap == null) {
        break label244;
      }
  ...
  public static void a(WebView paramWebView, String paramString1, String paramString2)
  {
    ...
    for (localObject = "";; localObject = bcgp.a(paramString2))
    {
  ...
  private void c()
  {
    ...
    {
      String str = a();
      if ((!TextUtils.isEmpty(str)) && (bcgc.a(str)) && (!str.contains("asyncMode=3")) && (!str.contains("sonic=1"))) {
  ...
  public Object a(String paramString, Bundle paramBundle)
  {
    ...
    paramString = bdkp.a().a(paramBundle);
    if (paramString != null)
    {
      paramString = paramString.d;
      Bundle localBundle = new Bundle();
      localBundle.putString(bdkm.b, paramBundle);
      localBundle.putString(bdkm.j, paramString);
      localBundle.putInt(bdkm.k, 2);
      localBundle.putString(bdkm.l, str);
      localBundle.putBoolean(bdkm.r, false);
      localBundle.putBoolean(bdkm.x, false);
      localBundle.putString(bdkm.m, "_" + paramBundle);
      bdki.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity, localBundle, "biz_src_yyb", null, 0);
      return paramBundle;
    }
    ...
    if ("cancelDownloadTask".equals(paramString))
    {
      ...
      if (!bdki.a(paramString)) {
        return Boolean.valueOf(false);
      }
      bdki.a(paramString, "_" + paramString, true);
    ...
    {
      paramString = paramBundle.getString("download_id");
      paramBundle = bdkp.a().a(paramString);
      if ((paramBundle == null) || (paramBundle.a() != 4)) {
        return Boolean.valueOf(false);
      }
      paramBundle = new Bundle();
      paramBundle.putString(bdkm.b, paramString);
      paramBundle.putInt(bdkm.k, 5);
      paramBundle.putBoolean(bdkm.r, false);
      paramBundle.putBoolean(bdkm.x, false);
      bdki.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity, paramBundle, "biz_src_yyb", null, 0);
      return Boolean.valueOf(true);
    }
    if ("notifyQBiconShine".equals(paramString))
    {
      paramString = (bcfj)this.jdField_a_of_type_Bcdt.a().a(2);
      if (paramString != null)
      {
        paramString.jdField_a_of_type_Bcfm.x = true;
    ...
    for (;;)
    {
      if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_ComTencentMobileqqAppBrowserAppInterface != null) && (i != 0)) {
        if ("CN".equals(Locale.getDefault().getCountry())) {
          if (TbsDownloader.needDownload(BaseApplication.getContext(), false, false, new bcff(this)))
          {
            if (QLog.isColorLevel()) {
      ...
      label438:
      label445:
      for (localObject1 = (bcfa)this.jdField_a_of_type_Bcdt.a().a(-2);; localObject1 = null)
      {
        if (((localObject1 == null) || (!((bcfa)localObject1).i)) && (!QLog.isColorLevel())) {
          break label448;
        }
        ...
        {
          if ((localObject1 == null) || (!((bcfa)localObject1).i)) {
            break;
          }
        ...
        for (;;)
        {
          axqw.b(null, "P_CliOper", "BizTechReport", "", "web", (String)localObject1, 0, 1, j, "", "", "", "");
          return;
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      paramBundle = (arpd)paramBundle.getPluginEngine().a("x5");
    } while (paramBundle == null);
    paramBundle.a();
  }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    for (Object localObject = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getWebView();; localObject = null)
    {
      if (localObject != null)
      {
        localObject = (arpd)((CustomWebView)localObject).getPluginEngine().a("x5");
        if (localObject != null) {
          ((arpd)localObject).a(paramInt, paramString);
        }
      }
      return;
    }
      ...
      for (;;)
      {
        ...
        catch (Throwable paramBundle)
        {
          try
          {
            ...
            QLog.d("SwiftBrowserTBSHandler", 1, "handle stgw time, requestTime: " + localObject4 + "s, responseTime: " + (String)localObject3 + "s, url: " + nax.b(localObject5, new String[0]));
            return;
          }
          catch (Throwable paramBundle)
          {
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = bdkp.a().a("801097412");
        if ((localObject == null) || (!bbev.h(BaseApplicationImpl.getApplication()))) {
          break;
        }
        ...
        if (paramBoolean)
        {
          ...
          bcpw.a(BaseApplicationImpl.getApplication(), 2, paramString, 0).b(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.b());
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_Bcfj.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
      ThreadManager.post(new SwiftBrowserTBSHandler.6(this), 8, null, true);
      paramString = new bcfg(this);
      localObject = new bcfh(this);
      if (!bbev.h(BaseApplicationImpl.getApplication())) {
        break label351;
      }
      this.jdField_a_of_type_MqqOsMqqHandler.sendMessage(this.jdField_a_of_type_MqqOsMqqHandler.obtainMessage(102));
      if (!paramBoolean) {
    ...
    for (paramString = BaseApplicationImpl.getApplication().getResources().getString(2131689504);; paramString = BaseApplicationImpl.getApplication().getResources().getString(2131689510))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_Bcfj.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
      return;
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_Bcfj.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
      break;
    }
    label351:
    if (paramBoolean)
    {
      Drawable localDrawable = BaseApplicationImpl.getApplication().getResources().getDrawable(2130843546);
      this.jdField_a_of_type_AndroidAppDialog = bbcv.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity, localDrawable, BaseApplicationImpl.getApplication().getResources().getString(2131689503), " ", BaseApplicationImpl.getApplication().getResources().getString(2131690573), BaseApplicationImpl.getApplication().getResources().getString(2131689502), paramString, (View.OnClickListener)localObject);
    ...
    for (paramString = paramString.getString("icon_url", null);; paramString = null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_Bcfj.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
      return;
      this.jdField_a_of_type_AndroidAppDialog = bbcv.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity, BaseApplicationImpl.getApplication().getResources().getString(2131689509), 2131690573, 2131689502, paramString, (View.OnClickListener)localObject);
      this.jdField_a_of_type_AndroidAppDialog.show();
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_Bcfj.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
      return;
    }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        if (paramMessage != null)
        {
          ...
          if ((localObject1 != null) && (((String)localObject1).length() != 0))
          {
            ...
            aoxz.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity, (String)localObject1, paramMessage);
          }
        }
        this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_Bcfj.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
        return true;
      ...
      Object localObject1 = (ImageView)this.jdField_a_of_type_AndroidAppDialog.findViewById(2131378616);
      ((ImageView)localObject1).setImageDrawable(null);
      ((ImageView)localObject1).setImageDrawable(paramMessage);
      return true;
      paramMessage = (String)paramMessage.obj;
    } while ((this.jdField_a_of_type_AndroidAppDialog == null) || (!this.jdField_a_of_type_AndroidAppDialog.isShowing()) || (paramMessage == null));
    ((TextView)this.jdField_a_of_type_AndroidAppDialog.findViewById(2131378618)).setText(paramMessage);
    return true;
  }
}
