...
public class wak
  implements Runnable
{
  public wak(HotChatPie paramHotChatPie, int paramInt1, int paramInt2) {}
  ...
  public void run()
  {
    ...
    if (!NetworkUtil.g(this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildHotChatPie.jdField_a_of_type_AndroidContentContext)) {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildHotChatPie.jdField_a_of_type_AndroidContentContext, 1, this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildHotChatPie.jdField_a_of_type_AndroidContentContext.getString(2131434859), 0).a();
    }
