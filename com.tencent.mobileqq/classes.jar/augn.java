...
public class augn
  implements augj
{
  private arpe jdField_a_of_type_Arpe;
  ...
  private arpd a(int paramInt)
  {
    QLog.i("MsgBackupFileProcessor<QFile>", 1, "getMsgBackupHandler: chatTYpe[" + paramInt + "]");
    Object localObject1 = null;
    if (paramInt == 1)
    {
      if (this.jdField_a_of_type_Arpe == null) {
        this.jdField_a_of_type_Arpe = new arpe(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      localObject1 = this.jdField_a_of_type_Arpe;
    }
    for (;;)
    {
      ...
      if (localObject1 == null)
      {
        ...
        localObject2 = this.jdField_a_of_type_Arpe;
      }
      return localObject2;
      if (paramInt == 2)
      {
      ...
      {
        if (this.jdField_a_of_type_Arpf == null) {
          this.jdField_a_of_type_Arpf = new arpf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        }
        localObject1 = this.jdField_a_of_type_Arpf;
      }
    }
  }
  
  private arpd a(MessageRecord paramMessageRecord)
  {
    ...
    if (paramMessageRecord.isMultiMsg)
    {
      ...
      if (!TextUtils.isEmpty(paramMessageRecord))
      {
        ...
        localObject = this.jdField_a_of_type_Arpf;
      }
    }
    for (;;)
    {
      ...
      localObject = this.jdField_a_of_type_Arpe;
      continue;
  ...
  public augw a(MessageRecord paramMessageRecord, MsgBackupResEntity paramMsgBackupResEntity)
  {
    ...
    localaugw.a = a(Integer.parseInt(str)).a(paramMessageRecord, paramMsgBackupResEntity);
    return localaugw;
  }
  
  public String a(MessageRecord paramMessageRecord, MsgBackupResEntity paramMsgBackupResEntity)
  {
    paramMessageRecord = new File(arpd.b);
    if (!paramMessageRecord.exists()) {
      paramMessageRecord.mkdirs();
    }
    paramMessageRecord = new File(arpd.a);
    if (!paramMessageRecord.exists()) {
      paramMessageRecord.mkdirs();
    }
  ...
  {
    arpd localarpd = a(paramMessageRecord);
    if (localarpd != null) {
      localarpd.a(paramMessageRecord, paramList);
    }
  }
  ...
  public void b(MessageRecord paramMessageRecord, List<MsgBackupResEntity> paramList)
  {
    arpd localarpd = a(paramMessageRecord);
    if (localarpd != null) {
      localarpd.b(paramMessageRecord, paramList);
    }
  }
}
