...
public class bpkz
{
  ...
  static double a(int paramInt)
  {
    ...
    {
      bpam.a("AEEditorMusicWaveRandomGenerator", "obtainRandomValue() mRandoms == null.");
      d = a();
    }
    for (;;)
    {
      ...
      {
        bpam.a("AEEditorMusicWaveRandomGenerator", "obtainRandomValue() index == mRandoms.size().");
        d = a();
      ...
      if (paramInt < 0)
      {
        bpam.a("AEEditorMusicWaveRandomGenerator", "obtainRandomValue() index < 0.");
        return a();
      }
      if (paramInt <= jdField_a_of_type_JavaUtilArrayList.size()) {
        break;
