  ...
  implements View.OnClickListener
{
  ...
  private yky jdField_a_of_type_Yky;
  ...
  public ylk(Activity paramActivity, ylm paramylm)
  {
  ...
  private void a(View paramView)
  {
    ...
    localObjectAnimator1.setInterpolator(new ykp(0.33F, 0.0F, 0.67F, 1.0F));
    ...
    localObjectAnimator2.setInterpolator(new ykp(0.33F, 0.0F, 0.67F, 1.0F));
    ...
    localObjectAnimator3.setInterpolator(new ykp(0.33F, 0.0F, 0.67F, 1.0F));
    ...
    paramView.setInterpolator(new ykp(0.33F, 0.0F, 0.67F, 1.0F));
  ...
  private void f()
  {
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidAppActivity.findViewById(2131374466);
    this.jdField_a_of_type_AndroidViewView.setVisibility(0);
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidAppActivity.findViewById(2131374462);
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView = ((RecyclerView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374468));
      ...
      this.jdField_a_of_type_Yky = new yky(this.jdField_a_of_type_AndroidViewView.getContext(), this, this.jdField_a_of_type_Ylm);
      this.jdField_a_of_type_Yky.a(ylg.a().a());
      this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.setAdapter(this.jdField_a_of_type_Yky);
      this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.getRecycledViewPool().setMaxRecycledViews(this.jdField_a_of_type_Yky.getItemViewType(0), 10);
      this.jdField_a_of_type_Yky.a(new yll(this));
      new bjwf(new ylf(this.jdField_a_of_type_Yky)).attachToRecyclerView(this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView);
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374469));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374470));
      this.c = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374461));
      this.c.setOnClickListener(this);
      this.d = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374460));
      this.d.setOnClickListener(this);
      this.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideProgressNotifier = new SlideProgressNotifier(this.jdField_a_of_type_AndroidAppActivity, 2131561385);
      if (a())
      {
        this.jdField_a_of_type_Int = 60000;
        ylg.a().a(this.jdField_a_of_type_Int);
      }
      return;
      i = 0;
      break;
  ...
  public String a()
  {
    if (this.jdField_a_of_type_Yky != null) {
      return this.jdField_a_of_type_Yky.a();
    }
    return "";
  }
  ...
  public void a()
  {
    ...
    for (int i1 = localList.size();; i1 = 0)
    {
      ...
      if (i1 > 0)
      {
        ...
        {
          this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131167188));
          this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131167188));
          if (this.d.getVisibility() != 0)
          {
            localObject = ylg.a().a().iterator();
            i = 0;
            j = 0;
            i2 = 0;
            if (((Iterator)localObject).hasNext())
      ...
      for (;;)
      {
        ...
        if (localSlideItemInfo.jdField_b_of_type_Int == 0)
        {
          ...
          if (m != 0)
          {
            ...
            localObject = "0";
            xwa.a("pic_choose", "exp_autoCut", i3, 0, new String[] { localObject, i2 + "", j + "", i + "" });
            this.d.setVisibility(0);
            if (k == 0) {
              this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidAppActivity.getString(2131698629, new Object[] { Integer.valueOf(this.jdField_a_of_type_Int / 1000) }));
            }
            this.jdField_a_of_type_AndroidWidgetTextView.setText(ylj.a(l));
          ...
          {
            if (this.jdField_a_of_type_Yky != null) {
              this.jdField_a_of_type_Yky.a(localList);
            }
            return;
            i3 = 1;
            break;
            ...
            if (n != 0)
            {
              this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131166917));
              this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131167189));
            }
            for (;;)
            {
              this.d.setVisibility(8);
              break;
              this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131167337));
            ...
            if (n != 0)
            {
              ...
              this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidAppActivity.getString(2131698631));
            }
            for (;;)
            {
              ...
              break label674;
              label753:
              this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidAppActivity.getString(2131698630));
            }
            bool = false;
            break label511;
            if (m == 0)
  ...
  {
    if (this.jdField_a_of_type_Yky != null) {
      this.jdField_a_of_type_Yky.a(paramInt);
    }
  }
  
  public void b()
  {
    List localList = ylg.a().a();
    if ((this.jdField_a_of_type_AndroidSupportV7WidgetLinearLayoutManager != null) && (this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView != null))
    {
      ...
      while (i <= j)
      {
        ...
        if (localObject != null)
        {
          ...
          if ((localObject instanceof ylb))
          {
            SlideItemInfo localSlideItemInfo1 = (SlideItemInfo)((ylb)localObject).a.getTag();
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131377564: 
      for (;;)
      {
        ...
        i = ylg.a().a().indexOf(localObject1);
        if ((this.jdField_a_of_type_Ylm != null) && (localObject1 != null)) {
          this.jdField_a_of_type_Ylm.a(((SlideItemInfo)localObject1).jdField_b_of_type_JavaLangString);
        }
        a(i);
      }
    case 2131374461: 
      ...
      for (;;)
      {
        try
        {
          ...
          if (this.jdField_a_of_type_AndroidAppActivity != null) {
            xwa.a("pic_fictitious", "clk_next", this.jdField_a_of_type_AndroidAppActivity.getIntent(), new String[0]);
          }
          if ((!ylg.a().a()) || (this.jdField_a_of_type_AndroidAppActivity == null)) {
            break;
          }
          xwa.a("video_edit_new", "change_pic", this.jdField_a_of_type_AndroidAppActivity.getIntent(), new String[0]);
        }
        catch (Exception localException) {}
        if (!QLog.isColorLevel()) {
          break;
        }
        QLog.d(this.jdField_a_of_type_JavaLangString, 2, bjna.a(localException));
        break;
        i = 1;
        break label117;
        label342:
    ...
    Object localObject2 = ylg.a().a().iterator();
    int k = 0;
    int j = 0;
    int i = 0;
    label462:
    ...
    for (;;)
    {
      ...
      if (localSlideItemInfo.jdField_b_of_type_Int == 0)
      {
        ...
        {
          xwa.a("pic_choose", "clk_autoCut", m, 0, new String[] { localObject2, k + "", j + "", i + "" });
          ylg.a().i();
          break;
          m = 0;
          break label568;
