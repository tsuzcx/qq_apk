...
public abstract class aklt
  implements akkr, Handler.Callback, TextWatcher, View.OnClickListener, blig, blih, blnt, Observer
{
  static int e;
  float jdField_a_of_type_Float;
  int jdField_a_of_type_Int;
  protected long a;
  aday jdField_a_of_type_Aday;
  ...
  private anyu jdField_a_of_type_Anyu = new aklv(this);
  private bhsm jdField_a_of_type_Bhsm;
  bhso jdField_a_of_type_Bhso = new aklw(this);
  ...
  public aklt(Context paramContext, SessionInfo paramSessionInfo, QQAppInterface paramQQAppInterface)
  {
  ...
  private void A()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130849835);
  ...
  private void B()
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130844853);
      localImageView = (ImageView)this.jdField_d_of_type_AndroidWidgetRelativeLayout.findViewById(2131369056);
      localImageView.setBackgroundResource(0);
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130850139));
      localImageView = (ImageView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131368451);
      Object localObject = localImageView.getLayoutParams();
      if ((localObject instanceof RelativeLayout.LayoutParams))
      {
        localObject = (RelativeLayout.LayoutParams)localObject;
        ((RelativeLayout.LayoutParams)localObject).width = agej.a(35.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
        ((RelativeLayout.LayoutParams)localObject).height = agej.a(35.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
        localImageView.setLayoutParams((ViewGroup.LayoutParams)localObject);
      }
      localImageView.setBackgroundResource(0);
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130850668));
      this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166987));
      this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166987));
    ...
    this.jdField_b_of_type_AndroidWidgetTextView.setAlpha(0.8F);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130844852);
    ImageView localImageView = (ImageView)this.jdField_d_of_type_AndroidWidgetRelativeLayout.findViewById(2131369056);
    localImageView.setBackgroundResource(0);
    if (bdgb.b()) {
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130844790));
    }
    for (;;)
    {
      localImageView = (ImageView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131368451);
      localImageView.setBackgroundResource(0);
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130850669));
      return;
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130850140));
    }
  }
  ...
  private void C()
  {
    ...
    mrh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, 3);
  }
  ...
  private void F()
  {
    ...
    List localList1 = this.jdField_a_of_type_Akks.a();
  ...
  private void b(int paramInt)
  {
    ...
    if (this.jdField_c_of_type_AndroidWidgetTextView == null)
    {
      ...
      ((TextView)localObject1).setId(2131371498);
      ((TextView)localObject1).setBackgroundResource(2130838376);
  ...
  {
    return this.jdField_a_of_type_Akkv.a(paramInt);
  }
  ...
  public SpannableString a(boolean paramBoolean)
  {
    ...
    {
      bool1 = true;
      str1 = bhlg.a(localQQAppInterface, ((SessionInfo)localObject).jdField_a_of_type_Int, ((SessionInfo)localObject).jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText$SourceMsgInfo.mSourceMsgSenderUin + "");
    ...
    {
      localObject = bgme.a(localQQAppInterface, localContext, str2, str3, str1, bool1, localXEditTextEx, bool2, true);
  ...
  {
    if (paramView == null) {
      paramLayoutInflater = paramLayoutInflater.inflate(2131558865, paramViewGroup, false);
    }
    for (;;)
    {
      this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)paramLayoutInflater.findViewById(2131362291));
      this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131364389));
  ...
  protected void a(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Bhsm = new bhsm(((ViewGroup)((Activity)this.jdField_a_of_type_AndroidContentContext).getWindow().getDecorView().findViewById(16908290)).getChildAt(0), this.jdField_a_of_type_AndroidViewWindowManager.getDefaultDisplay().getHeight(), this.jdField_a_of_type_Bhso);
    this.jdField_j_of_type_Int = this.jdField_a_of_type_Bhsm.a();
    this.jdField_j_of_type_Int = bhsm.a(this.jdField_j_of_type_Int);
    paramContext = new aklx(this);
    AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    if ((localAppRuntime instanceof QQAppInterface))
    {
      int k = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131299011);
      ...
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonMainPanel.setDispatchKeyEventListener(new akly(this));
      return;
    }
  ...
  public void a(ChatMessage paramChatMessage, int paramInt, long paramLong, String paramString)
  {
    ...
    do
    {
      return;
      if (paramLong == 0L) {
        ahpx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, Long.parseLong(paramChatMessage.senderuin));
      }
      paramString = airf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage, paramInt, paramLong, paramString);
    ...
    paramString = bgmh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText$SourceMsgInfo, paramInt - k, this.jdField_a_of_type_ComTencentWidgetXEditTextEx.getPaint(), null);
    if (paramString != null)
    {
      ...
      this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setTag(2131373866, paramString);
      ...
      this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setMovementMethod(bgmg.a());
  ...
  protected void a(List<ChatMessage> paramList1, List<ChatMessage> paramList2)
  {
    ...
    this.jdField_a_of_type_Akks.a(paramList2, null, 0);
    ...
    if (paramBoolean)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getOverScrollHeaderView() == null)
      {
        if (this.jdField_a_of_type_AndroidViewView == null) {
          this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558931, null);
        }
  ...
  public boolean a()
  {
    ...
    this.jdField_a_of_type_Akkv.a(3);
    b();
    e();
    g();
    d();
    ...
    x();
    a();
    this.jdField_a_of_type_Aday = new aday();
    this.jdField_a_of_type_Aday.a = new aggv(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    this.jdField_a_of_type_Aday.jdField_h_of_type_Boolean = true;
    return true;
  }
  ...
  protected void b(List<ChatMessage> paramList1, List<ChatMessage> paramList2)
  {
    ...
    default: 
      if (localakmh != null) {
        this.jdField_g_of_type_Int = localakmh.a(paramList1, paramList2, this.jdField_g_of_type_Int);
      }
      break;
    }
    for (;;)
    {
      ...
      return;
      k = akmh.b(this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView, this.jdField_g_of_type_Int, paramList1, paramList2);
      if (k != 0)
      {
      ...
      if (localakmh != null)
      {
        ...
        if (localakmh != null)
        {
          this.jdField_g_of_type_Int = localakmh.a(this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView, this.jdField_g_of_type_Int, paramList1, paramList2);
          continue;
          if (localakmh != null)
          {
            localakmh.a(this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView, 0, paramList1, paramList2);
            k = paramList1.size();
  ...
  public void beforeTextChanged(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3)
  {
    if (paramInt3 == 0)
    {
      paramCharSequence = (bgme[])this.jdField_a_of_type_ComTencentWidgetXEditTextEx.getEditableText().getSpans(paramInt1, paramInt1 + paramInt2, bgme.class);
  ...
  protected void d()
  {
    ...
    {
      if (("1103".equals(ThemeUtil.curThemeId)) || ("2920".equals(ThemeUtil.curThemeId))) {
        this.jdField_a_of_type_AndroidViewViewGroup.setBackgroundResource(2130850036);
      }
    }
    else {
      return;
    }
    this.jdField_a_of_type_AndroidViewViewGroup.setBackgroundResource(2130850257);
  }
  ...
  protected void e()
  {
    this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView = ((ChatXListView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131370020));
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getHeaderViewsCount() == 0)
    {
      ...
      ((View)localObject).setId(2131362426);
    ...
    this.jdField_a_of_type_Akks.a(this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView);
    Object localObject = this.jdField_a_of_type_Akks;
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_f_of_type_Int == 3) {}
    for (boolean bool = true;; bool = false)
    {
      ((akks)localObject).a(bool);
  ...
  protected void g()
  {
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131376731));
    ...
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131369042));
    this.jdField_b_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this);
    this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
    this.jdField_d_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131376744));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131379026));
    this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
    ImageView localImageView1 = (ImageView)this.jdField_d_of_type_AndroidWidgetRelativeLayout.findViewById(2131369056);
    localImageView1.setOnClickListener(this);
    if ((this.jdField_e_of_type_Boolean) && (!this.jdField_d_of_type_Boolean))
    {
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_d_of_type_AndroidWidgetRelativeLayout.findViewById(2131369051));
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_f_of_type_Int == 2) || (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_f_of_type_Int == 5))
    {
      ImageView localImageView2 = (ImageView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131368451);
      Object localObject = localImageView2.getLayoutParams();
      if ((localObject instanceof RelativeLayout.LayoutParams))
      {
        localObject = (RelativeLayout.LayoutParams)localObject;
        ((RelativeLayout.LayoutParams)localObject).width = agej.a(13.5F, this.jdField_a_of_type_AndroidContentContext.getResources());
        ((RelativeLayout.LayoutParams)localObject).height = agej.a(13.5F, this.jdField_a_of_type_AndroidContentContext.getResources());
        localImageView2.setLayoutParams((ViewGroup.LayoutParams)localObject);
      }
      localImageView2.setImageResource(2130850104);
      this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
      localImageView1.setImageResource(2130850252);
      if (Build.VERSION.SDK_INT >= 16) {
  ...
  protected void h()
  {
    this.jdField_b_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131368726));
    ...
    i();
    this.jdField_a_of_type_ComTencentWidgetXEditTextEx = ((XEditTextEx)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131368725));
    ...
    try
    {
      ...
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131367328));
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
      Object localObject = (PanelIconLinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131372262);
      ((PanelIconLinearLayout)localObject).setPanelIconListener(new aklu(this));
      if (this.jdField_d_of_type_Boolean)
      {
        ((PanelIconLinearLayout)localObject).setCustomHeight(agej.a(50.0F, ((PanelIconLinearLayout)localObject).getContext().getResources()));
        ...
        {
          localObject = this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131368734);
          if (localObject != null) {
            ((View)localObject).setBackgroundResource(2130849842);
          }
          this.jdField_b_of_type_AndroidViewViewGroup.setBackgroundResource(2130849842);
          this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setBackgroundResource(2130849843);
          this.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130838267);
          this.jdField_a_of_type_AndroidWidgetButton.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166976));
        }
        localObject = new aklz(this, null);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      b(paramMessage.arg1);
      continue;
      ahtp.a(paramMessage, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView);
      continue;
      boolean bool = bhto.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView);
      if (QLog.isColorLevel()) {
        QLog.d(this.jdField_a_of_type_JavaLangString, 2, "MSG_EFRESH_FONT_BUBBLE, needRefresh=" + bool);
      }
      if (bool) {
        this.jdField_a_of_type_Akks.notifyDataSetChanged();
      }
    }
  }
  ...
  public void k()
  {
    ...
    this.jdField_a_of_type_Akkv.a(5);
  ...
  public void l()
  {
    if (this.jdField_d_of_type_Boolean)
    {
      ...
      if ((localadab != null) && (localadab.a(this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Int) > 0))
      {
        if (QLog.isColorLevel()) {
  ...
  public void m()
  {
    ...
    this.jdField_a_of_type_Akkv.a(9);
  ...
  public void n()
  {
    this.jdField_a_of_type_Akkv.a(4);
  }
  ...
  public void o()
  {
    ...
    this.jdField_a_of_type_Akkv.a(10);
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_f_of_type_Int == 2) || (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_f_of_type_Int == 5))
      {
        Object localObject = agej.a(new Intent(paramView.getContext(), SplashActivity.class), new int[] { 0, 2 });
        ...
        bdll.b(null, "dc00898", "", "", "0X800A194", "0X800A194", k, 1, "", "", "", "");
        try
        {
          int m = anxm.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int);
          if ((k != 28) || (m <= 0)) {
            continue;
          }
          bdll.b(null, "dc00898", "", "", "0X800AFD0", "0X800AFD0", m, 0, "", "", "", "");
        }
        ...
        if (this.jdField_i_of_type_Int == 0)
        {
          ...
          localImageButton.setImageResource(2130840133);
          this.jdField_a_of_type_ComTencentWidgetXPanelContainer.a();
          t();
        }
        else
        {
          ...
          localImageButton.setImageResource(2130840132);
          s();
          continue;
          this.jdField_g_of_type_Int = this.jdField_a_of_type_Akks.getCount();
  ...
  public void p()
  {
    ...
    this.jdField_a_of_type_Akkv.a(13);
  ...
  {
    this.jdField_a_of_type_ComTencentWidgetXPanelContainer.a();
    this.jdField_a_of_type_Akkv.a(12);
  ...
  protected void u()
  {
    ...
    if ((localList != null) && (localList.size() > 0))
    {
      ...
      this.jdField_a_of_type_Akks.a(localList, null, 0);
    }
  }
  ...
  protected void v()
  {
    if ((this.jdField_a_of_type_Akks != null) && (this.jdField_a_of_type_Akks.getCount() > 0))
    {
      this.jdField_a_of_type_Long = SystemClock.uptimeMillis();
      ((aggv)this.jdField_a_of_type_Aday.a).a(this.jdField_a_of_type_Long);
      this.jdField_a_of_type_Aday.jdField_e_of_type_Boolean = false;
  ...
  protected void w()
  {
    this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131362374));
    this.jdField_a_of_type_AndroidWidgetImageButton.setVisibility(0);
    this.jdField_a_of_type_AndroidWidgetImageButton.setOnClickListener(this);
    agej.a(this.jdField_a_of_type_AndroidWidgetImageButton, (int)(this.jdField_a_of_type_Float * 5.0F + 0.5F), (int)(this.jdField_a_of_type_Float * 5.0F + 0.5F), 0, 0);
    if (this.jdField_d_of_type_Boolean) {
  ...
  public void x()
  {
    ...
    if ((k != 1033) && (k != 1034))
    {
      ...
      bdks.a(1, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, k);
    }
  ...
  public void z()
  {
    ...
    if (localChatMessage != null) {
      a(localChatMessage, 0, ahpx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, Long.parseLong(localChatMessage.senderuin)), null);
    }
  }
}
