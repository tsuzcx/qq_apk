...
public class aklt
{
  private static volatile aklt jdField_a_of_type_Aklt;
  private List<aklu> jdField_a_of_type_JavaUtilList;
  ...
  {
    if (jdField_a_of_type_Aklt == null) {}
    try
    {
      if (jdField_a_of_type_Aklt == null) {
        jdField_a_of_type_Aklt = new aklt();
      }
      return jdField_a_of_type_Aklt;
    }
    finally {}
  }
  ...
  public void a(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString)) {
      this.jdField_a_of_type_JavaUtilList = aklu.a(paramString);
    }
  ...
  public boolean a(String paramString, WebViewFragment paramWebViewFragment)
  {
    ...
    do
    {
      do
      {
        ...
        localaklu = (aklu)((Iterator)localObject1).next();
      } while (TextUtils.isEmpty(localaklu.jdField_b_of_type_JavaLangString));
      if (localaklu.jdField_a_of_type_JavaUtilRegexPattern == null) {
        localaklu.jdField_a_of_type_JavaUtilRegexPattern = Pattern.compile(localaklu.jdField_b_of_type_JavaLangString);
      }
    } while (!localaklu.jdField_a_of_type_JavaUtilRegexPattern.matcher(paramString).matches());
    Object localObject1 = "";
    Object localObject2 = paramWebViewFragment.mStatistics;
    paramWebViewFragment = (WebViewFragment)localObject1;
    if (localObject2 != null)
    {
      localObject2 = ((bhqc)localObject2).jdField_a_of_type_JavaUtilList;
      paramWebViewFragment = (WebViewFragment)localObject1;
      if (localObject2 != null)
      {
        paramWebViewFragment = (WebViewFragment)localObject1;
    ...
    boolean bool;
    if (TextUtils.isEmpty(localaklu.jdField_a_of_type_JavaLangString)) {
      bool = true;
    }
    while (bool)
    {
      if (localaklu.jdField_a_of_type_Boolean) {
        VACDReportUtil.a("originURL=" + paramWebViewFragment + "|interceptURL=" + paramString, "qqwallet", "InterceptOpenOtherApp", null, null, 0, null);
      }
      if (!localaklu.jdField_b_of_type_Boolean) {
        break;
      }
      if (!TextUtils.isEmpty(localaklu.c))
      {
        if (TextUtils.isEmpty(localaklu.d)) {
          localaklu.d = a(localaklu.c, "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDsE3WI7sDFUi6QWV/oK8qozDvS\nTlxmu1a3NSFxeOrjlVEVtOx8yIMVFYIixq/Fv1XgUlyvL7bGJbaLLKaqlYruGd2z\nNbaIz90Zm4H0pMFHx4vCYhsRP1HXbVMo2ZDiHEDbnSm/99uzFPPiXqLi8jE9t4if\n0GuYdSZfe5o+SIKT5QIDAQAB");
        }
        paramWebViewFragment = localaklu.d;
        if (QLog.isColorLevel()) {
      ...
      try
      {
        for (;;)
        {
          ...
          return true;
          if (localaklu.jdField_b_of_type_JavaUtilRegexPattern == null) {
            localaklu.jdField_b_of_type_JavaUtilRegexPattern = Pattern.compile(localaklu.jdField_a_of_type_JavaLangString);
          }
          bool = localaklu.jdField_b_of_type_JavaUtilRegexPattern.matcher(paramWebViewFragment).matches();
          break;
          label515:
          paramWebViewFragment = paramWebViewFragment + "?j=";
        }
