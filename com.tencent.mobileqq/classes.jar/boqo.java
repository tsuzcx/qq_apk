...
{
  private static boqo jdField_a_of_type_Boqo = new boqo();
  private static final String jdField_a_of_type_JavaLangString = boqo.class.getSimpleName();
  ...
  public static boqo a()
  {
    return jdField_a_of_type_Boqo;
  }
  
  public void a(ViewModel paramViewModel)
  {
    if ((paramViewModel instanceof boqn))
    {
  ...
  {
    if (boqn.class.isAssignableFrom(paramClass))
    {
