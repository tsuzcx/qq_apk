...
public class bhuh
{
  private static volatile bhuh jdField_a_of_type_Bhuh;
  public static boolean a;
  private long jdField_a_of_type_Long;
  private String jdField_a_of_type_JavaLangString;
  private WeakReference<View> jdField_a_of_type_JavaLangRefWeakReference;
  private WtloginObserver jdField_a_of_type_MqqObserverWtloginObserver = new bhuj(this);
  ...
  public static bhuh a()
  {
    if (jdField_a_of_type_Bhuh == null) {}
    try
    {
      if (jdField_a_of_type_Bhuh == null) {
        jdField_a_of_type_Bhuh = new bhuh();
      }
      return jdField_a_of_type_Bhuh;
    }
    finally {}
  }
  ...
  private void a()
  {
    ...
    {
      if (i != 0) {
        QIPCServerHelper.getInstance().register(new bhui(this, "QR_LOGIN_QIPC_MODULE_NAME"));
      }
      return;
      i = 0;
    }
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    for (paramArrayOfByte = new String(paramArrayOfByte);; paramArrayOfByte = amtj.a(2131710300))
    {
