  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          localObject = new NewIntent(BaseApplicationImpl.getApplication(), basl.class);
          ...
          ((NewIntent)localObject).putExtra("has_report_yes", new Boolean(basd.jdField_a_of_type_Boolean));
          BaseApplicationImpl.getApplication().getRuntime().startServlet((NewIntent)localObject);
          basd.jdField_a_of_type_Float = basd.jdField_a_of_type_Int - basd.b + basd.c;
          localObject = BaseApplicationImpl.getApplication().getRuntime().getAccount();
          if (!TextUtils.isEmpty((CharSequence)localObject)) {
            basd.jdField_a_of_type_JavaLangString = (String)localObject;
          }
          basd.jdField_a_of_type_Long = NetConnInfoCenter.getServerTimeMillis();
          QLog.i("SSOHttpUtils", 1, "SSOHttpUtils do report success steps:" + basd.jdField_a_of_type_Float);
        }
        ...
        if (((JSONObject)localObject).has("svr_steps"))
        {
          ...
          paramBundle = new NewIntent(BaseApplicationImpl.getApplication(), basl.class);
