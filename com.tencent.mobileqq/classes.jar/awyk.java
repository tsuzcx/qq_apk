  ...
  implements azla
{
  ...
  public awyk(MessageForMixedMsg paramMessageForMixedMsg, Map<String, List<Integer>> paramMap, String paramString, ArrayList<MessageForText.AtTroopMemberInfo> paramArrayList)
  {
  ...
  private void a(MessageForMixedMsg paramMessageForMixedMsg)
  {
    ...
    if (paramMessageForMixedMsg.istroop == 1)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        nty.a().a(localMessageRecord);
      }
    }
    awyg.a(this.jdField_a_of_type_Awyg, this.jdField_a_of_type_Awyg.a, paramMessageForMixedMsg.frienduin, paramMessageForMixedMsg.istroop, paramMessageForMixedMsg, true);
  }
  ...
  public void onSend(azlb paramazlb)
  {
    ...
    {
      localObject1 = new ErrorMessage(paramazlb.jdField_b_of_type_Int, paramazlb.jdField_a_of_type_JavaLangString);
      QLog.d("MixedMsgManager", 2, "reqUploadMultiPics UiCallBack success result = " + paramazlb + ", error = " + localObject1);
    }
    if (paramazlb.jdField_b_of_type_Int != 0) {
      awyg.a(this.jdField_a_of_type_Awyg, this.jdField_a_of_type_ComTencentMobileqqDataMessageForMixedMsg, false, "send Msg fail: " + paramazlb);
    }
    do
    {
      do
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if ((localObject2 instanceof MessageForPic))
        {
          ...
          ((MessageForPic)localObject2).md5 = paramazlb.d;
          ((MessageForPic)localObject2).uuid = paramazlb.c;
          ((MessageForPic)localObject2).size = paramazlb.jdField_a_of_type_Long;
          ((MessageForPic)localObject2).groupFileID = paramazlb.jdField_b_of_type_Long;
          if (QLog.isColorLevel()) {
