  ...
  implements DialogInterface.OnCancelListener, View.OnClickListener
{
  ...
  public bhfo(@NonNull Context paramContext)
  {
  ...
  {
    paramContext = LayoutInflater.from(paramContext).inflate(2131559356, null);
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramContext.findViewById(2131370903));
    this.b = ((TextView)paramContext.findViewById(2131370904));
    this.b.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramContext.findViewById(2131370905));
  ...
  public void a(bhfq parambhfq)
  {
    this.jdField_a_of_type_Bhfq = parambhfq;
  }
    ...
    if (paramArrayOfString != null)
    {
      ...
      if (i < paramArrayOfString.length)
      {
        ...
        for (Object localObject = new MiniNumberPicker(getContext());; localObject = new NumberPicker(getContext()))
        {
          ...
          ((NumberPicker)localObject).setOnValueChangedListener(new bhfp(this, i));
  ...
  public void onCancel(DialogInterface paramDialogInterface)
  {
    if (this.jdField_a_of_type_Bhfq != null) {
      this.jdField_a_of_type_Bhfq.onValCancel();
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    if (this.jdField_a_of_type_Bhfq != null) {
      this.jdField_a_of_type_Bhfq.onValConfirm(this.jdField_a_of_type_ArrayOfInt);
    }
    a();
  }
}
