...
public class anmw
{
  ...
  public static ayki a(appoint_define.RichText paramRichText)
  {
    return a(paramRichText, 16);
  }
  
  public static ayki a(appoint_define.RichText paramRichText, int paramInt)
  {
    return a(aqjz.a(paramRichText), paramInt);
  }
  
  public static ayki a(String paramString, int paramInt)
  {
    return new ayki(paramString, 5, paramInt);
  }
  ...
  public static String a(String paramString)
  {
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          if (((JSONObject)localObject5).has("audio_list"))
          {
            ...
            {
              localObject4 = localObject3;
              localObject1 = (String)localObject3 + ajyc.a(2131706938);
            }
          ...
          if (((JSONObject)localObject5).has("video_list"))
          {
            ...
            {
              localObject4 = localObject3;
              localObject1 = (String)localObject3 + ajyc.a(2131706939);
            }
          }
          else
          {
            ...
            if (((JSONObject)localObject5).has("pic_list"))
            {
              ...
              {
                localObject4 = localObject3;
                localObject1 = (String)localObject3 + ajyc.a(2131706937);
              }
            }
            else
            {
      ...
      if (i < ((JSONArray)localObject5).length())
      {
        ...
        {
          localObject4 = localObject3;
          localObject1 = (String)localObject3 + ajyc.a(2131706935);
          break label450;
        }
        localObject4 = localObject3;
        localObject1 = localObject3;
        ...
        localObject4 = localObject3;
        localObject1 = (String)localObject3 + ajyc.a(2131706936);
        break label450;
  ...
  {
    return (paramInt == -2053) && (!paramString.equals(String.valueOf(1822701914L + ajsf.l))) && (!paramString.equals("1822701914"));
  }
  ...
  public static boolean a(QQMessageFacade.Message paramMessage, QQAppInterface paramQQAppInterface)
  {
    ...
    if (paramMessage.msgtype == -2011) {
      localMessageRecord = paramQQAppInterface.a(1001).a(ajsf.I, 1001, paramMessage.uniseq);
    }
  ...
  public static String b(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        str1 = paramString;
        str2 = paramString;
        if (paramString.indexOf('\024' + ayjw.a[i]) == -1) {
          break label268;
        }
        str1 = paramString;
        str2 = paramString.replace('\024' + ayjw.a[i], "\024" + (char)i);
      }
      ...
      if (i < ayjw.a.length)
      {
        ...
        {
          str1 = paramString;
          str2 = paramString.replace(ayjw.a[i], "\024" + (char)i);
        }
        i += 1;
        paramString = str2;
      }
