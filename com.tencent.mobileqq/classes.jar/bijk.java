  ...
  extends WtloginObserver
{
  ...
  final bijl jdField_a_of_type_Bijl;
  final String jdField_a_of_type_JavaLangString;
  
  bijk(Intent paramIntent, String paramString, bijl parambijl)
  {
    this.jdField_a_of_type_AndroidContentIntent = paramIntent;
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_Bijl = parambijl;
  }
  ...
  public void onRegGetSMSVerifyLoginAccountWithLhSig(int paramInt, long paramLong, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, byte[] paramArrayOfByte4)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramArrayOfByte1 = BaseApplicationImpl.getContext().getString(2131715879);
        ...
        if (QLog.isDevelopLevel()) {
          bijm.a("LHLoginMng -- OnRegGetSMSVerifyLoginAccountWithLhSig", localIntent);
        }
        if (this.jdField_a_of_type_Bijl != null) {
          this.jdField_a_of_type_Bijl.a(localIntent, bool, this.jdField_a_of_type_JavaLangString, paramArrayOfByte4, paramArrayOfByte1);
        }
