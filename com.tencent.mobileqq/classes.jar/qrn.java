...
public class qrn
{
  ...
  private static volatile qrn jdField_a_of_type_Qrn;
  public static int b;
  ...
  private qrn()
  {
    ...
    try
    {
      String str = (String)bnrf.a(jdField_a_of_type_JavaLangString, "");
      Object localObject2;
      ...
      Object localObject1 = (String)bnrf.a(jdField_b_of_type_JavaLangString, "");
    ...
    catch (NumberFormatException localNumberFormatException)
    {
      ...
      bnrf.a(jdField_a_of_type_JavaLangString, "");
      bnrf.a(jdField_b_of_type_JavaLangString, "");
    }
  }
  ...
  public static qrn a()
  {
    if (jdField_a_of_type_Qrn == null) {}
    try
    {
      if (jdField_a_of_type_Qrn == null) {
        jdField_a_of_type_Qrn = new qrn();
      }
      return jdField_a_of_type_Qrn;
    }
    finally {}
  }
  ...
  private void a(AbsListView paramAbsListView, boolean paramBoolean)
  {
    ...
    {
      localObject1 = (qro)this.jdField_a_of_type_JavaUtilList.get(((Integer)this.jdField_b_of_type_JavaUtilHashMap.get(str)).intValue());
      l3 = ((qro)localObject1).jdField_b_of_type_Long;
      if (i1 <= 0) {
        break label521;
      }
    }
    ...
    {
      ((qro)localObject1).jdField_b_of_type_Long = (l2 + l3);
      localObject2 = a(localView);
      if ((localObject2 != null) && (localObject2[1] - localObject2[0] >= localView.getHeight() * jdField_a_of_type_Double)) {
        ((qro)localObject1).jdField_c_of_type_Long += l1;
      }
      ((qro)localObject1).jdField_c_of_type_Boolean = this.jdField_a_of_type_JavaUtilHashMap.containsKey(str);
      if (!paramBoolean) {
        break;
      }
      ((qro)localObject1).jdField_b_of_type_Boolean = true;
      break;
      localObject1 = new qro(this);
      ((qro)localObject1).jdField_a_of_type_JavaLangString = str;
      ((qro)localObject1).jdField_a_of_type_Int = ozs.a((BaseArticleInfo)localObject2);
      int m;
      label305:
      boolean bool;
      ...
      {
        m = 0;
        ((qro)localObject1).jdField_b_of_type_Int = m;
        if (this.jdField_g_of_type_Long != -1L) {
          break label504;
        }
        bool = true;
        label326:
        ((qro)localObject1).jdField_a_of_type_Boolean = bool;
        ((qro)localObject1).jdField_c_of_type_Int = localView.getHeight();
        ((qro)localObject1).jdField_b_of_type_JavaLangString = ((BaseArticleInfo)localObject2).mRecommentdReason;
        m = this.j;
        this.j = (m + 1);
        ((qro)localObject1).jdField_d_of_type_Int = m;
        localObject2 = pad.a().a();
      ...
      label504:
      label510:
      for (((qro)localObject1).jdField_c_of_type_JavaLangString = (localObject2[0] + "_" + localObject2[1] + "_" + localObject2[2] + "_" + localObject2[3]);; ((qro)localObject1).jdField_c_of_type_JavaLangString = "NULL")
      {
  ...
  private void e()
  {
    ...
    if (this.jdField_b_of_type_ArrayOfInt != null)
    {
      ...
      bnrf.a(jdField_b_of_type_JavaLangString, str);
    }
    if (this.jdField_a_of_type_JavaUtilArrayList.size() > 0)
    {
      ...
      bnrf.a(jdField_a_of_type_JavaLangString, str);
    }
  }
  
  public long a()
  {
    if (this.jdField_a_of_type_Qrr.jdField_a_of_type_Long == 0L) {
      return this.jdField_e_of_type_Long;
    }
    return this.jdField_a_of_type_Qrr.jdField_a_of_type_Long - this.jdField_a_of_type_Long;
  }
  ...
  public void a()
  {
    ...
    if ((this.jdField_d_of_type_Long != 0L) && (!TextUtils.isEmpty(this.jdField_c_of_type_JavaLangString)) && (this.jdField_b_of_type_JavaUtilHashMap.containsKey(this.jdField_c_of_type_JavaLangString)))
    {
      ...
      qro localqro = (qro)this.jdField_a_of_type_JavaUtilList.get(k);
      localqro.jdField_a_of_type_Long = (l + localqro.jdField_a_of_type_Long);
  ...
  public void a(AbsListView paramAbsListView, int paramInt)
  {
    ...
    this.i = bdep.a(paramAbsListView.getContext());
    ((ReadInJoyXListView)paramAbsListView).a(this.jdField_a_of_type_Qrr);
  ...
  public long b()
  {
    if (this.jdField_a_of_type_Qrr.jdField_b_of_type_Long == 0L) {
      return this.jdField_e_of_type_Long;
    }
    return this.jdField_c_of_type_Long - this.jdField_a_of_type_Qrr.jdField_b_of_type_Long;
  }
  ...
  public void c()
  {
    ...
    new pra(null, null, null, qfo.a(), null).a(this, BaseApplication.getContext());
    e();
    this.jdField_a_of_type_MqqUtilWeakReference = null;
    jdField_a_of_type_Qrn = null;
  }
