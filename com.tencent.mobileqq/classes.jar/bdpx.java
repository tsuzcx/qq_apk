  ...
  extends alko
{
  ...
  public Bundle a;
  public awok a;
  private WeakReference<bdpy> jdField_a_of_type_JavaLangRefWeakReference;
  private List<bdpz> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  public bdpx(QQAppInterface paramQQAppInterface)
  {
  ...
  private void B(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramIntent = (akji)this.app.getManager(153);
  ...
  private void C(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramIntent)
      {
        ...
        localBundle.putString("msg", alpo.a(2131716424));
        if (!QLog.isColorLevel()) {
          continue;
        }
      ...
      localBundle.putString("msg", alpo.a(2131716425));
      if (QLog.isColorLevel()) {
  ...
  private void E(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    if (paramFromServiceMsg != null)
    {
      ...
      paramArrayOfByte = new bbps();
      paramArrayOfByte.a(paramFromServiceMsg);
      paramIntent.a(paramArrayOfByte);
      paramIntent.a(paramFromServiceMsg);
      bdiv.f(this.app.getApplication(), this.app.getCurrentAccountUin(), System.currentTimeMillis());
    ...
    if ((paramIntent != null) && (paramArrayOfByte != null) && (paramFromServiceMsg != null) && (paramFromServiceMsg.isSuccess()))
    {
      try
      {
        ...
        if (paramIntent.ret.get() == 0L)
        {
          if (this.app != null)
          {
            ((akje)this.app.getManager(211)).a(paramIntent.ret.get(), paramIntent.pbRsqData.get().toByteArray());
            return;
          }
    ...
    if ((paramIntent != null) && (paramArrayOfByte != null) && (paramFromServiceMsg != null) && (paramFromServiceMsg.isSuccess()))
    {
      try
      {
        ...
        if (paramFromServiceMsg.ret.get() == 0L)
        {
          if (this.app != null)
          {
            ((akje)this.app.getManager(211)).a(paramFromServiceMsg.ret.get(), paramFromServiceMsg.pbRsqData.get().toByteArray(), paramIntent.getBundleExtra("extras"));
            return;
          }
      ...
      try
      {
        ...
        if (paramIntent.ret.get() == 0L)
        {
          ...
          if (paramFromServiceMsg.getResultCode() == 1002)
          {
            ...
            azmz.a(BaseApplication.getContext()).a(BaseApplicationImpl.getApplication().getRuntime().getAccount(), "RichTextIllegalWordTime", bool1, l, 0L, null, "");
            if (QLog.isColorLevel()) {
              QLog.d(jdField_a_of_type_JavaLangString, 2, "costTime:" + l + " isTimeOut:" + bool2 + " legalSuccess:" + bool1);
            }
            ((asnx)this.app.getManager(219)).b(bool1);
          }
        }
        else
        {
  ...
  private void J(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramIntent = new akqi(paramFromServiceMsg.ip_list.get(), i, paramFromServiceMsg.aes_key.get(), paramFromServiceMsg.distribute_ts.get(), paramFromServiceMsg.sign.get());
      }
      catch (Exception paramIntent)
      {
      ...
      paramFromServiceMsg = ((akji)this.mApp.getManager(153)).a();
      if (paramIntent != null)
      {
    ...
    while (!QLog.isColorLevel()) {
      for (;;)
      {
        try
        {
          ...
          if (paramFromServiceMsg.ret.get() == 0L)
          {
            ...
            if (paramIntent != null)
            {
              ...
              if (paramArrayOfByte.cmshow3dFlag != j)
              {
                ...
                paramArrayOfByte = akwt.a(this.app);
                if (paramArrayOfByte != null) {
          ...
          {
            paramIntent = (bdpy)this.jdField_a_of_type_JavaLangRefWeakReference.get();
            if (paramFromServiceMsg.ret.get() == 0L)
            {
              bool = true;
              paramIntent.a(bool);
    ...
    try
    {
      ...
      if (paramIntent.ret.get() == 0L)
      {
        ...
        if (paramIntent != null)
        {
          ...
          {
            paramIntent = (aywz)this.app.getManager(12);
  ...
  private void a(Long[] paramArrayOfLong, String paramString)
  {
    try
    {
      ...
      localJSONObject.put("cpuCount", bdcb.b());
      localJSONObject.put("cpuFrequency", bdcb.a());
      localJSONObject.put("systemTotalMemory", bdcb.d());
      ...
      paramString = new NewIntent(this.app.getApp(), bdqd.class);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i == 0)
        {
          ...
          if ((this.jdField_a_of_type_AndroidOsBundle == null) || (this.jdField_a_of_type_Awok == null)) {
            break;
          }
          this.jdField_a_of_type_Awok.a(i, j, paramIntent, this.jdField_a_of_type_AndroidOsBundle);
          this.jdField_a_of_type_AndroidOsBundle = null;
          this.jdField_a_of_type_Awok = null;
          return;
        }
      }
      catch (Exception paramIntent)
      ...
      try
      {
        ...
        for (;;)
        {
          ...
          while (((Iterator)localObject).hasNext())
          {
            ...
            if (akji.a(this.app, this.app.c()) == 2) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (0L == paramFromServiceMsg.ret.get())
        {
          ...
          localakji = (akji)this.app.getManager(153);
          ...
          if (localJSONArray != null)
          {
            ...
            if (i < localJSONArray.length())
            {
              ...
              ApolloBaseInfo localApolloBaseInfo = localakji.b(l1 + "");
          ...
          if (paramArrayOfByte != null)
          {
            ...
            if (i < paramArrayOfByte.length())
            {
              ...
              paramFromServiceMsg = localakji.b(l1 + "");
              j = 1;
              ...
              akzg.a(this.app, paramFromServiceMsg.jdField_a_of_type_JavaLangString, null);
              break label1111;
            }
          }
      ...
      for (;;)
      {
        ...
        break;
        label839:
        localakji.b(localArrayList);
        ((akji)this.app.getManager(153)).a(localArrayList);
        continue;
        label867:
  ...
  private void z(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    for (int i = paramArrayOfByte.length;; i = -1)
    {
      ...
      if ((paramArrayOfByte != null) && (paramFromServiceMsg.isSuccess())) {
        try
        {
          ...
          if ((paramFromServiceMsg.uint32_result.has()) && (paramFromServiceMsg.uint32_result.get() == 0))
          {
            ...
            localObject1 = (akji)this.app.getManager(153);
            i = 0;
          }
          for (;;)
          {
            if (i < paramIntent.rpt_msg_uin_data.size())
            {
              ...
              ApolloBaseInfo localApolloBaseInfo = ((akji)localObject1).b((String)localObject2);
              ...
              else
              {
                synchronized (this.jdField_a_of_type_JavaUtilList)
                {
                  ...
                  do
                  {
                    ...
                    localbdpz = (bdpz)localIterator.next();
                  } while (!localbdpz.a((String)localObject2, localApolloBaseInfo));
                  localArrayList.add(localbdpz);
                }
                return;
              }
            }
      ...
      do
      {
        ...
        break;
        ((akji)localObject1).b(paramArrayOfByte);
      ...
      while (i < j)
      {
        ...
        localObject1 = ((akji)this.app.getManager(153)).b(paramArrayOfByte);
  ...
  public void a()
  {
    for (;;)
    {
      try
      {
        ...
        boolean bool = ((akji)this.app.getManager(153)).c(this.app.c());
        if (bool)
        {
          ...
          NewIntent localNewIntent = new NewIntent(this.app.getApp(), bdqd.class);
  ...
  public void a(int paramInt)
  {
    ...
    ((IndividPub.Platform_Comm_Req)localObject).mqqver.set("8.3.3.4515");
    ...
    localObject = new NewIntent(this.app.getApp(), bdqd.class);
  ...
  public void a(int paramInt1, int paramInt2, long paramLong)
  {
    ...
    try
    {
      ...
      localJSONObject2.put("qq_version", "8.3.3.4515");
  ...
  public void a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    ((qqshop_act.SQQSHPUsrInfo)localObject).carriertype.set(ntw.b());
    ((qqshop_act.SQQSHPUsrInfo)localObject).net_type.set(i);
    ((qqshop_act.SQQSHPUsrInfo)localObject).src.set(ntw.a(paramInt2));
  ...
  public void a(int paramInt, Bundle paramBundle, awok paramawok)
  {
    if (QLog.isColorLevel()) {
    ...
    localTPraiseSsoReq.str_qq_ver.set("8.3.3.4515");
    ...
    this.jdField_a_of_type_Awok = paramawok;
    this.app.startServlet((NewIntent)localObject);
  }
  ...
  public void a(int paramInt, String paramString1, String paramString2)
  {
    ...
    for (paramString1 = Long.valueOf(0L);; paramString1 = Long.valueOf(Long.parseLong(paramString1)))
    {
      ...
      paramString1 = new NewIntent(this.app.getApp(), bdqd.class);
  ...
  public void a(int paramInt, List<MessageRecord> paramList)
  {
    ...
    for (;;)
    {
      ...
      break;
      localUniSsoServerReq.pbReqData.set(ByteStringMicro.copyFrom(((MonitReport.MonitReportReq)localObject).toByteArray()));
      paramList = new NewIntent(this.app.getApp(), bdqd.class);
  ...
  public void a(long paramLong, int paramInt1, int paramInt2)
  {
    ...
    localSetAddonReq.str_qq_version.set("8.3.3");
    if (paramInt2 != -1) {
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    localReqBody.str_version.set(bdcb.c());
    Object localObject;
    if (paramLong1 == 8192L)
    {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      localObject = new NewIntent(this.mApp.getApp(), bdqd.class);
  ...
  public void a(Intent paramIntent, byte[] paramArrayOfByte)
  {
    ...
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      ...
      localObject1 = ((aloz)localObject2).a((String)localObject3);
      paramArrayOfByte = (byte[])localObject1;
      ...
      ((aloz)localObject2).a(paramArrayOfByte);
      label679:
  ...
  public void a(bdpy parambdpy)
  {
    ...
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambdpy);
  }
  
  public void a(bdpz parambdpz)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      this.jdField_a_of_type_JavaUtilList.add(parambdpz);
      return;
    }
  }
  ...
  public void a(ReportInfoManager.ReportChannlInfo paramReportChannlInfo)
  {
    ...
    try
    {
      ...
      localUniSsoServerReq.reqdata.set(((JSONObject)localObject).toString());
      paramReportChannlInfo = new NewIntent(this.app.getApp(), bdqd.class);
  ...
  public void a(QQAppInterface paramQQAppInterface, int[] paramArrayOfInt)
  {
    ...
    try
    {
      ...
      paramArrayOfInt = new NewIntent(paramQQAppInterface.getApp(), bdqd.class);
  ...
  public void a(String paramString1, int paramInt, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localUniSsoServerReq.reqdata.set(localJSONObject.toString());
        paramString2 = new NewIntent(this.app.getApp(), bdqd.class);
  ...
  public void a(String paramString, long paramLong1, long paramLong2, int paramInt1, int paramInt2)
  {
    ...
    Card localCard = ((aloz)localObject).b(paramString);
  ...
  public void a(String paramString1, long paramLong1, long paramLong2, List<String> paramList, boolean paramBoolean, String paramString2, String paramString3)
  {
    ...
    for (int i = 0;; i = 1)
    {
      ...
      localJSONObject2.put("qq_version", "8.3.3");
      localJSONObject2.put("skey", ((TicketManager)this.app.getManager(2)).getSkey(this.app.getCurrentAccountUin()));
      localJSONObject1.put("req", localJSONObject2);
  ...
  public void a(String paramString, ApolloBaseInfo paramApolloBaseInfo)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      ...
      {
        bdpz localbdpz = (bdpz)localIterator.next();
        if (localbdpz.b(paramString, paramApolloBaseInfo)) {
          localArrayList.add(localbdpz);
        }
      }
    }
  ...
  public void a(String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    try
    {
      ...
      localObject2 = new NewIntent(this.app.getApp(), bdqd.class);
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    try
    {
      ...
      localUniSsoServerReqComm.mqqver.set("8.3.3.4515");
      WebSSOAgent.UniSsoServerReq localUniSsoServerReq = new WebSSOAgent.UniSsoServerReq();
  ...
  public void a(String paramString, ArrayList<bejq> paramArrayList)
  {
    ...
    if (localIterator.hasNext())
    {
      bejq localbejq = (bejq)localIterator.next();
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("ColorNick", 2, "modifyTroopMemberCardInfoWithColorNick type = " + localbejq.c + " text = " + localbejq.jdField_a_of_type_JavaLangString);
        }
        localArrayList2.add(localRichCardNameElem);
        break;
        localRichCardNameElem.bytes_text.set(ByteStringMicro.copyFrom(localbejq.jdField_a_of_type_JavaLangString.getBytes()));
        localStringBuilder.append(localbejq.jdField_a_of_type_JavaLangString);
        continue;
        paramArrayList = localbejq.jdField_a_of_type_JavaLangString;
    ...
    paramString.string_clientver.set(bdcb.c());
    ...
    paramArrayList = new NewIntent(this.app.getApp(), bdqd.class);
  ...
  public void a(long... paramVarArgs)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localUniSsoServerReq.reqdata.set(((JSONObject)localObject).toString());
        paramVarArgs = new NewIntent(this.app.getApp(), bdqd.class);
  ...
  public void a(String[] paramArrayOfString, int[] paramArrayOfInt)
  {
    ...
    localObject1 = new NewIntent(this.app.getApp(), bdqd.class);
  ...
  public boolean a(String paramString1, String paramString2)
  {
    try
    {
      ...
      localSCUpdateReq.comm.qver.set(ByteStringMicro.copyFrom("8.3.3.4515".getBytes()));
      localSCUpdateReq.comm.osrelease.set(ByteStringMicro.copyFrom(String.valueOf(Build.VERSION.SDK_INT).getBytes()));
      localSCUpdateReq.comm.network.set(bdee.b(this.app.getApplication()));
  ...
  public void b(int paramInt)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (akji.a(this.app, this.app.c()) != 2);
  ...
  public void d(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    if ((paramArrayOfByte != null) && (paramFromServiceMsg.isSuccess()))
    {
      try
      {
        ...
        if (i != 0)
        {
          paramFromServiceMsg = (akji)this.app.getManager(153);
  ...
  public void d(String paramString)
  {
    ...
    default: 
      ...
      return;
    case 1: 
      localObject1 = this.app.getApp().getString(2131693288);
    }
    for (;;)
    {
      paramString = new aslp(paramString, paramString, (String)localObject1, 0, -5020, 2097156, ayvc.a());
      localObject2 = new Bundle();
      String str = alpo.a(2131716426);
      if (!TextUtils.isEmpty(str))
      {
      ...
      return;
      localObject1 = this.app.getApp().getString(2131693291);
      continue;
      localObject1 = this.app.getApp().getString(2131693290);
      continue;
      localObject1 = this.app.getApp().getString(2131693287);
      continue;
      localObject1 = this.app.getApp().getString(2131693289);
      continue;
      localObject1 = this.app.getApp().getString(2131693286);
    }
  }
  ...
  public void e()
  {
    ...
    try
    {
      ...
      localAddrDistribueReq.net_type.set(akro.d());
      WebSSOAgent.UniSsoServerReq localUniSsoServerReq = new WebSSOAgent.UniSsoServerReq();
      localUniSsoServerReq.comm.set((MessageMicro)localObject);
  ...
  public void e(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    if ((paramArrayOfByte != null) && (paramFromServiceMsg.isSuccess()) && (!TextUtils.isEmpty((CharSequence)localObject1)))
    {
      try
      {
        ...
        localObject3 = (akji)this.mApp.getManager(153);
        if (localObject3 != null) {
          ((akji)localObject3).a = ((HashMap)localObject1);
        }
        localObject2 = (aleh)this.mApp.getManager(155);
        if (localObject2 == null) {
          break label1385;
        }
        ((aleh)localObject2).a((JSONArray)localObject4);
        Object localObject5 = ((aleh)localObject2).a(1);
        localObject4 = ((aleh)localObject2).b();
        k = 0;
        i = 0;
        if (localObject5 == null) {
          break label1395;
        ...
        if (k < ((List)localObject5).size())
        {
          ...
          if (localObject3 != null) {
            ((akji)localObject3).a(localApolloActionData, localBundle);
          }
          m = 1;
          i = m;
          if (!QLog.isColorLevel()) {
        ...
        ((aleh)localObject2).b((List)localObject5);
        k = i;
      }
      catch (Exception paramIntent)
      {
      ...
      ((aleh)localObject2).b((List)localObject4);
      m = i;
      break label1418;
    }
    label1102:
    ...
    for (;;)
    {
      ...
      while (((Iterator)localObject1).hasNext()) {
        if (((aleh)localObject2).a(((Integer)((Iterator)localObject1).next()).intValue()) == null)
        {
      ...
      do
      {
        ...
        if (paramIntent.has("CurrencyInfo"))
        {
          ...
          if (localObject1 != null)
          {
            ((akkb)localObject1).jdField_a_of_type_Int = i;
            if (((akkb)localObject1).jdField_a_of_type_Boolean) {
              ((akkb)localObject1).b();
            }
          }
          if (QLog.isColorLevel()) {
  ...
  public void e(String paramString)
  {
    ...
    for (Object localObject1 = str1.replace("gray_small_ship", " ");; localObject1 = str1)
    {
      ...
      for (;;)
      {
        ...
        if (!TextUtils.isEmpty(str1))
        {
          str1 = auny.a(this.app, 12L, 1L);
          str2 = auny.a(this.app, 12L, 2L);
  ...
  public void f(String paramString)
  {
    ...
    localFilter_Req_Comm.mqqver.set("8.3.3");
    ...
    if ((paramArrayOfByte != null) && (paramFromServiceMsg.isSuccess())) {
      try
      {
        ...
        if (0L == paramIntent.ret.get())
        {
          ...
          paramArrayOfByte = (akji)this.app.getManager(153);
          if (paramArrayOfByte != null)
          {
  ...
  public void l(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      if (paramFromServiceMsg.isSuccess())
      {
        ...
        ((akje)this.app.getManager(211)).a((int)paramFromServiceMsg.ret.get(), paramArrayOfByte.rpt_msg_list.get(), paramIntent);
        return;
      }
    ...
    if ((paramArrayOfByte != null) && (paramFromServiceMsg != null)) {
      for (;;)
      {
        ...
        try
        {
          ...
          localObject = (akje)this.app.getManager(211);
          ...
          {
            ((akje)localObject).a(localUniSsoServerRsp.ret.get(), paramArrayOfByte, paramFromServiceMsg, paramIntent.getStringExtra("reqData"));
            if (!QLog.isColorLevel()) {
              return;
            }
        ...
        {
          localObject = ((akji)this.app.getManager(153)).a();
          if (localObject != null) {
            ((akkb)localObject).a(localUniSsoServerRsp.ret.get(), paramFromServiceMsg, paramIntent.getStringExtra("reqData"));
          }
        }
      }
    }
      ...
      try
      {
        ...
        if ((paramFromServiceMsg.uint32_result.has()) && (paramFromServiceMsg.uint32_result.get() == 0))
        {
          ...
          if (i1 < i2)
          {
            ...
            paramFromServiceMsg = localaloz.a(str);
            if (paramFromServiceMsg != null) {
              break label2102;
            }
            ...
            if (QLog.isColorLevel())
            {
              QLog.d("VasShieldFont", 2, "handleGetStrangerVasInfo: " + gj.c);
              i = k;
            }
            if ((fx.a(l) == paramFromServiceMsg.uVipFont) && (fx.b(l) == paramFromServiceMsg.vipFontType)) {
              break label2093;
            }
            paramFromServiceMsg.uVipFont = fx.a(l);
            paramFromServiceMsg.vipFontType = fx.b(l);
            ...
            if (localUdcUinData.uint32_rsp_qq_level_icon_type.has())
            {
              ...
              localObject3 = (aloz)this.app.getManager(51);
              Card localCard = ((aloz)localObject3).b(str + "");
              if ((localCard != null) && (localCard.mQQLevelType != j))
              {
                localCard.mQQLevelType = j;
                ((aloz)localObject3).a(localCard);
                this.app.a(2).notifyUI(1, true, localCard);
              }
            }
            if (localUdcUinData.uint32_rsp_theme_font_id.has()) {
              bdrp.b(localUdcUinData.uint32_rsp_theme_font_id.get());
            }
          ...
          paramIntent = localaloz.a(this.app.getCurrentAccountUin());
          fx.a(this.app, this.app.getCurrentAccountUin(), paramIntent, i, j);
          localaloz.b((List)localObject2);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i != 0)
        {
          ...
          akzg.a(this.app, (String)localObject4, str);
        }
      ...
      Object localObject1 = localakji.b((String)localObject1);
      if (localObject1 != null)
      {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          paramIntent = (aleh)this.app.getManager(155);
  ...
  public void s(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramIntent = ((akji)this.app.getManager(153)).a();
        if (paramIntent != null) {
        ...
        paramIntent.put("tips", this.app.getApp().getString(2131690118));
      ...
      if (i == 0) {
        ApolloItemBuilder.a(alpo.a(2131716427), 1, BaseApplicationImpl.getContext());
      }
      return;
      label397:
      i = 0;
