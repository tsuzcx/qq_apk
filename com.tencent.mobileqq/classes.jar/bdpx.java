  ...
  extends bdnu
{
  ...
  public bdpx()
  {
    this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new bdpy(this);
    this.jdField_a_of_type_JavaLangString = "picture";
    this.jdField_a_of_type_Int = 19;
  }
  
  public bdpx(String paramString)
  {
    this();
    this.ac = paramString;
  }
  
  public bdpx(String paramString1, String paramString2)
  {
    this();
  ...
  public static Bitmap a(Drawable paramDrawable)
  {
    try
    {
      ...
      for (Object localObject = Bitmap.Config.ARGB_8888;; localObject = Bitmap.Config.RGB_565)
      {
        ...
        paramDrawable = bheg.a((Bitmap)localObject, i, i, i);
  ...
  public View a(Context paramContext, View paramView, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        Drawable localDrawable1 = onb.a().a((Resources)localObject3, 2130850491);
      ...
      catch (OutOfMemoryError localOutOfMemoryError)
      {
        for (;;)
        {
          ...
          ((PAHighLightImageView)localObject2).setId(2131368676);
          ((PAHighLightImageView)localObject2).setContentDescription(((Resources)localObject3).getString(2131691219));
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          ((PAHighLightImageView)localObject1).setImageDrawable(bheg.a());
          return localObject2;
        }
        ...
        paramContext.setTag(bgxc.b(j, j, j));
      ...
      if ("StructMsgItemCover createView ,exception  = " + paramContext != null)
      {
          ...
          if ((localObject3 instanceof BaseActivity))
          {
            ...
            if (paramView.indexOf("internal_phone") > -1)
            {
              ...
              else
              {
                ...
                if (!ContactUtils.isContainChinese(paramContext)) {
                  break label997;
                }
                i = ((Context)localObject3).getResources().getDimensionPixelSize(2131299023);
                ((PAHighLightImageView)localObject1).setTextSize(i);
                ((PAHighLightImageView)localObject1).e = paramContext;
                paramContext = ((Context)localObject3).getResources().getDrawable(2130842118);
              }
            }
            for (;;)
            {
              ...
              break;
              i = ((Context)localObject3).getResources().getDimensionPixelSize(2131299025);
              break label944;
              if (ContactUtils.isContainChinese(paramContext))
              {
                i = ((Context)localObject3).getResources().getDimensionPixelSize(2131299019);
                break label944;
              }
              i = ((Context)localObject3).getResources().getDimensionPixelSize(2131299021);
              break label944;
        ...
        {
          ((PAHighLightImageView)localObject1).setImageResource(2130843935);
          return localObject2;
        }
        if (QLog.isColorLevel()) {
        ...
        for (;;)
        {
          for (;;)
          {
            try
            {
              if (this.t == q)
              {
                j = AIOUtils.dp2px(70.0F, (Resources)localObject3);
                i = j;
              }
            }
            catch (MalformedURLException paramContext) {}
          ...
          j = AIOUtils.dp2px(140.0F, (Resources)localObject3);
          i = j;
          continue;
          paramBundle = null;
      ...
      for (;;)
      {
        ...
        {
          ((PAHighLightImageView)localObject1).setScaleType(ImageView.ScaleType.CENTER_CROP);
          i = AIOUtils.dp2px(70.0F, (Resources)localObject3);
          if (!bool1) {
            break label1943;
          }
          ((PAHighLightImageView)localObject1).setBackgroundColor(Color.parseColor("#dddfe2"));
        ...
        for (;;)
        {
          ...
          paramContext.restartDownload();
          break label2045;
          if ((paramView.startsWith(aahr.b)) || (paramView.startsWith(aahr.c)) || (paramView.startsWith(aahr.d)))
          {
            ((PAHighLightImageView)localObject1).setBackgroundDrawable(null);
            i = paramView.lastIndexOf("&uin=");
            paramContext = paramView.substring("&uin=".length() + i);
          ...
          if ((paramView.startsWith("http://imgplat.store.qq.com/bqq_qfpic/520520")) || (paramView.contains(aaba.jdField_a_of_type_JavaLangString)))
          {
            paramBoolean = true;
          ...
          if (this.t == r)
          {
            ...
            i = AIOUtils.dp2px(140.0F, (Resources)localObject3);
            break label1367;
          }
          ((PAHighLightImageView)localObject1).setScaleType(ImageView.ScaleType.CENTER);
          break label1367;
  ...
  StructMsgForGeneralShare a(View paramView)
  {
    for (paramView = paramView.getParent(); paramView != null; paramView = paramView.getParent())
    {
      ...
      if (paramView.getId() == 2131378157) {
        return (StructMsgForGeneralShare)paramView.getTag(2131378157);
      }
    }
    return null;
  }
  ...
  public void a(View paramView, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      localObject2 = AIOUtils.getMessage(paramView);
      localObject1 = localObject2;
    }
    ...
    for (localObject2 = null;; localObject2 = ((ChatFragment)localObject2).a())
    {
      ...
      catch (Exception localException)
      {
        ...
        bdla.b((QQAppInterface)localObject2, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D93", "0X8005D93", paramInt2, 1, paramInt1, str, String.valueOf(paramView.msgId), "1", "");
        return;
      }
  ...
  public boolean a(bdpl parambdpl)
  {
    ...
    do
    {
      ...
      {
        return true;
        str = parambdpl.a("cover");
        if (str == null) {
          break;
        }
        this.ac = str;
      } while (this.jdField_a_of_type_Int <= 3);
      this.c = parambdpl.a("action");
      this.b = parambdpl.a("url");
    } while (this.jdField_a_of_type_Int <= 5);
    this.j = parambdpl.a("index");
    this.k = parambdpl.a("index_name");
    this.l = parambdpl.a("index_type");
    for (;;)
    {
      try
      {
      ...
      this.ad = parambdpl.a("needRoundView");
      return true;
      str = "";
      break label18;
