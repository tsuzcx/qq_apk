...
{
  public int a;
  private agem jdField_a_of_type_Agem;
  private ages jdField_a_of_type_Ages = new azfc(this);
  private ajtg jdField_a_of_type_Ajtg;
  private ajuc jdField_a_of_type_Ajuc = new azfe(this);
  private Handler jdField_a_of_type_AndroidOsHandler;
  private azej jdField_a_of_type_Azej;
  public azgl a;
  private azhn jdField_a_of_type_Azhn;
  private azwg jdField_a_of_type_Azwg;
  private azwh jdField_a_of_type_Azwh = new azfb(this);
  ...
  private Observer jdField_a_of_type_JavaUtilObserver = new azfd(this);
  protected mps a;
  ...
  public azez()
  {
    this.jdField_a_of_type_Mps = new azfa(this);
    this.jdField_a_of_type_Azgl = new azff(this);
  }
  
  private FragmentActivity a()
  {
    if (this.jdField_a_of_type_Azej != null) {
      return ((VisitorTroopCardFragment)this.jdField_a_of_type_Azej).getActivity();
    }
    return null;
  }
  ...
  {
    if (this.jdField_a_of_type_Azej != null) {
      return (VisitorTroopCardFragment)this.jdField_a_of_type_Azej;
    }
    return null;
  }
  ...
  private void a(KQQ.BatchResponse paramBatchResponse)
  {
    ...
    //   169: ifne +31 -> 200
    //   172: aload_0
    //   173: invokespecial 84	azez:a	()Landroid/support/v4/app/FragmentActivity;
    //   176: ifnull +630 -> 806
    //   179: aload_0
    //   180: getfield 76	azez:jdField_a_of_type_Azej	Lazej;
    //   183: aload_0
    //   184: invokespecial 84	azez:a	()Landroid/support/v4/app/FragmentActivity;
    //   187: ldc 182
    ...
    //   235: ifnull -108 -> 127
    //   238: aload_0
    //   239: getfield 76	azez:jdField_a_of_type_Azej	Lazej;
    //   242: aload 8
    ...
    //   332: ifeq +65 -> 397
    //   335: aload_0
    //   336: getfield 98	azez:jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData	Lcom/tencent/mobileqq/troopinfo/TroopInfoData;
    //   339: getfield 234	com/tencent/mobileqq/troopinfo/TroopInfoData:isMember	Z
    //   342: ifeq +20 -> 362
    //   345: aload_0
    //   346: invokespecial 95	azez:a	()Lcom/tencent/mobileqq/troop/troopCard/VisitorTroopCardFragment;
    //   349: ifnull +460 -> 809
    //   352: aload_0
    //   353: invokespecial 95	azez:a	()Lcom/tencent/mobileqq/troop/troopCard/VisitorTroopCardFragment;
    //   356: getfield 237	com/tencent/mobileqq/troop/troopCard/VisitorTroopCardFragment:c	Z
    //   359: ifeq +450 -> 809
    //   362: aload_0
    //   363: invokespecial 95	azez:a	()Lcom/tencent/mobileqq/troop/troopCard/VisitorTroopCardFragment;
    //   366: ifnull +31 -> 397
    //   369: aload_0
    //   370: invokespecial 95	azez:a	()Lcom/tencent/mobileqq/troop/troopCard/VisitorTroopCardFragment;
    ...
    //   376: ifnull +21 -> 397
    //   379: aload_0
    //   380: invokespecial 95	azez:a	()Lcom/tencent/mobileqq/troop/troopCard/VisitorTroopCardFragment;
    ...
    //   488: astore_1
    //   489: aload_0
    //   490: getfield 91	azez:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   493: bipush 52
    ...
    //   745: aload 8
    //   747: aload 9
    //   749: invokespecial 355	com/tencent/mobileqq/troop/troopCard/VisitorTroopCardPresenter$7:<init>	(Lazez;Lcom/tencent/mobileqq/app/TroopManager;Lcom/tencent/mobileqq/data/TroopInfo;)V
    //   752: bipush 8
    //   754: aconst_null
    //   755: iconst_0
    ...
    //   818: invokespecial 369	azez:a	(Ljava/util/List;)V
    //   821: goto -424 -> 397
    //   824: astore 7
  ...
  private void a(List<oidb_0x899.memberlist> paramList)
  {
    ...
    Object localObject2 = (azks)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(203);
    ...
    while (localIterator.hasNext())
    {
      ...
      } else if (((azks)localObject2).b(str)) {
        localArrayList1.add(localObject1);
      } else if (azlj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, str)) {
    ...
    catch (NumberFormatException paramList)
    {
      ...
      localObject1 = azlj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.isMember, a().jdField_a_of_type_ComTencentMobileqqDataTroopInfo, paramList);
  ...
  private void e()
  {
    this.jdField_a_of_type_Agem.a(this.jdField_a_of_type_Ages);
  ...
  private void f()
  {
    ...
    if (this.jdField_a_of_type_Agem != null) {
      this.jdField_a_of_type_Agem.a(null);
    }
    this.jdField_a_of_type_Ages = null;
    this.jdField_a_of_type_Azgl = null;
  }
  ...
  public Drawable a(String paramString)
  {
    ...
    if (this.jdField_a_of_type_Azwg != null)
    {
      Bitmap localBitmap = this.jdField_a_of_type_Azwg.a(4, paramString);
      ...
      if (localBitmap == null)
      {
        ...
        {
          this.jdField_a_of_type_Azwg.a(paramString, 4, true);
          localObject = localBitmap;
        }
      }
    }
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_Azhn.b(this.jdField_a_of_type_JavaUtilObserver);
      this.jdField_a_of_type_Azhn.a();
    }
  ...
  public void a(Bundle paramBundle, boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Ages != null)
    {
      ...
      this.jdField_a_of_type_Ages.a(paramBundle);
    }
  }
  
  public void a(azej paramazej)
  {
    this.jdField_a_of_type_Azej = paramazej;
    if (a() == null) {
      return;
    }
    ...
    this.jdField_a_of_type_Azhn = new azhn(this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, azlh.class, this.jdField_a_of_type_Ajtg);
    this.jdField_a_of_type_Azhn.a(this.jdField_a_of_type_JavaUtilObserver);
    this.jdField_a_of_type_Azwg = new azwg(a(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_a_of_type_Agem = new agej(a(), a(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin);
    e();
    g();
  }
  ...
  {
    if (this.jdField_a_of_type_Azhn != null) {
      this.jdField_a_of_type_Azhn.a(paramString);
    }
  }
  
  public void a(String paramString, int paramInt)
  {
    if ((this.jdField_a_of_type_Azej == null) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)) {}
    do
    {
      ajtg localajtg;
      do
      ...
      try
      {
        ...
        this.jdField_a_of_type_Azej.c();
        localajtg.a(l, paramInt);
        return;
      }
  ...
  {
    if (this.jdField_a_of_type_Agem != null) {
      this.jdField_a_of_type_Agem.a(paramString1, paramString2);
    }
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    do
    {
      ...
      if (paramString2 == null)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Mps);
  ...
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null) || (this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData == null) || (this.jdField_a_of_type_Azej == null)) {
      return;
    }
    ...
    else
    {
      ...
      if (localTroopInfo != null)
      {
        ...
        if (paramList == null)
        {
          ...
          ageu.b((List)localObject, localTroopInfo);
        }
      }
      if (localObject == null) {
        break label314;
    ...
    for (;;)
    {
      ...
      localArrayList.add(afzi.a((TroopClipPic)localObject, null));
    ...
    if (this.b.size() == 0)
    {
      ...
      paramList.id = afzi.jdField_a_of_type_JavaLangString;
      paramList.type = 1;
      this.b.add(paramList);
    }
    label314:
    this.jdField_a_of_type_Azej.a(false, localArrayList);
  }
  ...
  public void b()
  {
    ...
    while (this.jdField_a_of_type_Ajtg == null) {
      return;
    }
    ajtg localajtg = this.jdField_a_of_type_Ajtg;
    long l = ajex.a(this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin);
  ...
  public void b(String paramString1, String paramString2)
  {
    ...
    ((ajtg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, "", this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.getStatOption(), paramString1, paramString2, null, null);
  }
