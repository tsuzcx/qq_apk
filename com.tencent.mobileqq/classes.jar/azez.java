...
public class azez
{
  ...
  private static void a(azet paramazet)
  {
    boolean bool = a(paramazet.jdField_a_of_type_JavaLangCharSequence);
    if (((paramazet.jdField_b_of_type_Boolean) && (paramazet.jdField_a_of_type_JavaLangCharSequence.length() <= 5)) || (!bool))
    {
      paramazet.jdField_c_of_type_Int = 0;
      return;
    }
    paramazet.jdField_c_of_type_Int = 4;
  }
  
  public static void a(List<azet> paramList, PersonalityLabel paramPersonalityLabel, float paramFloat)
  {
    ...
    Collections.sort(localArrayList, new azfa());
    ...
    azet localazet = new azet();
    localazet.jdField_a_of_type_JavaLangCharSequence = str;
    boolean bool = a(str);
    label398:
    int i4;
    label420:
    ...
    {
      localazet.jdField_b_of_type_Int = ((PersonalityLabelInfo)localObject2).bgColor;
      localazet.jdField_e_of_type_Int = 2;
      localazet.jdField_a_of_type_Int = ((PersonalityLabelInfo)localObject2).fgColor;
      if (localazet.jdField_e_of_type_Int != 2) {
        break label886;
      }
      i4 = 1;
      ...
      {
        localazet.jdField_b_of_type_Boolean = true;
        localazet.jdField_e_of_type_Boolean = true;
        i2 = n + 1;
      }
      i1 = i2;
      n = i;
      if (!localazet.jdField_e_of_type_Boolean)
      {
        if ((i5 > 1) && (i < 2) && (i != i5 - 1) && (str.length() <= 6)) {
          break label892;
        }
        localazet.jdField_b_of_type_Boolean = true;
        if (localazet.jdField_b_of_type_Boolean) {
          break label905;
        }
        n = i + 1;
        i1 = i2;
    ...
    for (;;)
    {
      ...
      for (j = m + 1;; j = m)
      {
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            localazet.jdField_a_of_type_Float = (m * paramFloat);
            localazet.jdField_a_of_type_AndroidTextTextPaint.setTextSize(localazet.jdField_a_of_type_Float);
            if (QLog.isColorLevel()) {
              QLog.i("TagUtil", 2, "getTags " + localazet.jdField_a_of_type_JavaLangCharSequence + " sizeLevel:" + i + " size:" + localazet.jdField_a_of_type_Float / paramFloat);
            }
            paramList.add(localazet);
            m = j;
            j = i2;
            i = n;
            break label265;
            ...
            localazet.d = true;
            localazet.jdField_a_of_type_AndroidTextTextPaint.setFakeBoldText(true);
            break label398;
            label886:
            i4 = 0;
            break label420;
            label892:
            localazet.jdField_b_of_type_Boolean = ((Random)localObject1).nextBoolean();
            break label544;
            label905:
            i1 = i2 + 1;
            n = i;
            ...
            if (n == 0)
            {
              paramPersonalityLabel = (azet)paramList.get(0);
            ...
            if ((i == 0) && (i5 > 1))
            {
              ...
              if (j < paramList.size())
              {
                paramPersonalityLabel = (azet)paramList.get(j);
            ...
            for (;;)
            {
              ...
              for (;;)
              {
                ...
                j += 1;
                break label1033;
                localObject2 = new azet();
                ((azet)localObject2).jdField_a_of_type_JavaLangCharSequence = ((CharSequence)localObject1);
                ((azet)localObject2).jdField_c_of_type_Boolean = true;
                ((azet)localObject2).jdField_b_of_type_Boolean = false;
                ((azet)localObject2).jdField_a_of_type_Float = paramPersonalityLabel.jdField_a_of_type_Float;
                ((azet)localObject2).jdField_a_of_type_AndroidTextTextPaint.setTextSize(paramPersonalityLabel.jdField_a_of_type_Float);
