  ...
  implements TencentLocationListener
{
  ...
  azez(azey paramazey, Runnable paramRunnable, MqqHandler paramMqqHandler) {}
  ...
  public void onLocationChanged(TencentLocation paramTencentLocation, int paramInt, String paramString)
  {
    ...
    {
      return;
      azey.a(this.jdField_a_of_type_Azey, paramTencentLocation);
      if (this.b != null)
      {
        if (QLog.isColorLevel()) {
      ...
      if (paramInt == 0) {
        azey.a(this.jdField_a_of_type_Azey, true);
      }
