  ...
  implements Runnable
{
  ...
  public ahat(String paramString, Surface paramSurface, HWDecodeListener paramHWDecodeListener)
  {
  ...
  public void run()
  {
    ...
    //   3: lstore_3
    //   4: aload_0
    //   5: getfield 133	ahat:jdField_b_of_type_ComTencentMobileqqRichmediaMediacodecVideodecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;
    //   8: aload_0
    //   9: getfield 131	ahat:jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecVideodecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;
    ...
    //   15: aload_0
    //   16: invokespecial 467	ahat:a	()Z
    //   19: ifne +4 -> 23
    //   22: return
    //   23: aload_0
    //   24: invokespecial 469	ahat:b	()Z
    //   27: ifeq -5 -> 22
    ...
    //   50: aload_0
    //   51: getfield 34	ahat:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   86: ifne +515 -> 601
    //   89: aload_0
    //   90: getfield 40	ahat:jdField_a_of_type_Boolean	Z
    //   93: ifne +508 -> 601
    //   96: aload_0
    //   97: getfield 131	ahat:jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecVideodecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;
    //   100: getfield 269	com/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig:jdField_a_of_type_Int	I
    //   103: aload_0
    //   104: getfield 133	ahat:jdField_b_of_type_ComTencentMobileqqRichmediaMediacodecVideodecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;
    ...
    //   113: aload_0
    //   114: getfield 131	ahat:jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecVideodecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;
    ...
    //   124: aload_0
    //   125: aload_0
    //   126: getfield 133	ahat:jdField_b_of_type_ComTencentMobileqqRichmediaMediacodecVideodecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;
    //   129: getfield 374	com/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig:jdField_b_of_type_Long	J
    //   132: ldc2_w 163
    //   135: lmul
    //   136: putfield 50	ahat:jdField_c_of_type_Long	J
    //   139: aload_0
    //   140: getfield 133	ahat:jdField_b_of_type_ComTencentMobileqqRichmediaMediacodecVideodecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;
    //   143: aload_0
    //   144: getfield 131	ahat:jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecVideodecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;
    ...
    //   150: aload_0
    //   151: getfield 133	ahat:jdField_b_of_type_ComTencentMobileqqRichmediaMediacodecVideodecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;
    ...
    //   162: ldc2_w 163
    //   165: aload_0
    //   166: getfield 133	ahat:jdField_b_of_type_ComTencentMobileqqRichmediaMediacodecVideodecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;
    ...
    //   176: istore_2
    //   177: aload_0
    //   178: getfield 61	ahat:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicLong	Ljava/util/concurrent/atomic/AtomicLong;
    ...
    //   214: aload_0
    //   215: lload 7
    //   217: invokespecial 475	ahat:a	(J)J
    //   220: pop2
    //   221: iconst_1
    //   222: istore_1
    //   223: aload_0
    //   224: lload 7
    //   226: putfield 76	ahat:e	J
    //   229: aload_0
    //   230: getfield 61	ahat:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicLong	Ljava/util/concurrent/atomic/AtomicLong;
    //   233: lload 7
    //   235: ldc2_w 55
    //   238: invokevirtual 478	java/util/concurrent/atomic/AtomicLong:compareAndSet	(JJ)Z
    //   241: pop
    //   242: aload_0
    //   243: getfield 63	ahat:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicLong	Ljava/util/concurrent/atomic/AtomicLong;
    ...
    //   258: aload_0
    //   259: lload 7
    //   261: putfield 76	ahat:e	J
    //   264: aload_0
    //   265: getfield 63	ahat:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicLong	Ljava/util/concurrent/atomic/AtomicLong;
    //   268: lload 7
    //   270: ldc2_w 55
    ...
    //   282: aload_0
    //   283: iconst_1
    //   284: invokespecial 480	ahat:c	(Z)V
    //   287: iload_1
    //   288: ifeq +57 -> 345
    ...
    //   311: aload_0
    //   312: getfield 34	ahat:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   345: aload_0
    //   346: getfield 38	ahat:jdField_c_of_type_Boolean	Z
    //   349: ifeq +88 -> 437
    //   352: aload_0
    //   353: getfield 68	ahat:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   356: ifnull +10 -> 366
    //   359: aload_0
    //   360: getfield 68	ahat:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   386: aload_0
    //   387: getfield 34	ahat:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   390: ldc_w 482
    //   393: invokeinterface 184 3 0
    //   398: aload_0
    //   399: getfield 133	ahat:jdField_b_of_type_ComTencentMobileqqRichmediaMediacodecVideodecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;
    //   402: getfield 457	com/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig:jdField_b_of_type_Boolean	Z
    //   405: ifeq +196 -> 601
    //   408: aload_0
    //   409: getfield 133	ahat:jdField_b_of_type_ComTencentMobileqqRichmediaMediacodecVideodecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;
    ...
    //   422: aload_0
    //   423: lload_3
    //   424: invokespecial 475	ahat:a	(J)J
    //   427: pop2
    //   428: aload_0
    //   429: getfield 115	ahat:jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecVideodecoderHWDecodeListener	Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/HWDecodeListener;
    //   432: invokeinterface 485 1 0
    //   437: aload_0
    //   438: getfield 72	ahat:jdField_d_of_type_Boolean	Z
    //   441: ifeq -358 -> 83
    //   444: aload_0
    //   445: getfield 76	ahat:e	J
    //   448: lconst_0
    //   449: lcmp
    //   450: ifge -367 -> 83
    //   453: aload_0
    //   454: getfield 74	ahat:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   457: astore 9
    //   459: aload 9
    //   461: monitorenter
    //   462: aload_0
    //   463: getfield 40	ahat:jdField_a_of_type_Boolean	Z
    //   466: ifne +10 -> 476
    //   469: aload_0
    //   470: getfield 74	ahat:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    ...
    //   483: aload_0
    //   484: getfield 280	ahat:jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo	Landroid/media/MediaCodec$BufferInfo;
    //   487: getfield 297	android/media/MediaCodec$BufferInfo:presentationTimeUs	J
    //   490: ldc2_w 163
    //   493: ldiv
    //   494: lsub
    //   495: putfield 48	ahat:jdField_a_of_type_Long	J
    //   498: goto -415 -> 83
    //   501: astore 9
    //   503: aload 9
    ...
    //   508: aload_0
    //   509: iconst_1
    //   510: putfield 40	ahat:jdField_a_of_type_Boolean	Z
    //   513: goto -430 -> 83
    //   516: astore 9
    ...
    //   530: aload_0
    //   531: getfield 34	ahat:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   534: ldc 249
    //   536: aload 9
    ...
    //   555: astore 10
    //   557: aload_0
    //   558: getfield 115	ahat:jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecVideodecoderHWDecodeListener	Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/HWDecodeListener;
    //   561: iconst_3
    //   562: aload 10
    ...
    //   575: aload_0
    //   576: getfield 34	ahat:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   579: ldc_w 267
    //   582: aload 9
    ...
    //   600: athrow
    //   601: aload_0
    //   602: getfield 146	ahat:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   605: invokevirtual 491	android/media/MediaCodec:stop	()V
    //   608: aload_0
    //   609: getfield 146	ahat:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   612: invokevirtual 494	android/media/MediaCodec:release	()V
    //   615: aload_0
    //   616: getfield 153	ahat:jdField_a_of_type_AndroidMediaMediaExtractor	Landroid/media/MediaExtractor;
    //   619: invokevirtual 495	android/media/MediaExtractor:release	()V
    //   622: aload_0
    //   623: getfield 38	ahat:jdField_c_of_type_Boolean	Z
    //   626: ifeq +55 -> 681
    //   629: aload_0
    //   630: getfield 115	ahat:jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecVideodecoderHWDecodeListener	Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/HWDecodeListener;
    ...
    //   678: goto -56 -> 622
    //   681: aload_0
    //   682: getfield 115	ahat:jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecVideodecoderHWDecodeListener	Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/HWDecodeListener;
