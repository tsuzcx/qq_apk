...
{
  public aken(ChatHistoryTroopMemberFragment paramChatHistoryTroopMemberFragment) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (j == 2131365350)
        {
          localObject2 = paramView.findViewById(2131365351);
          bool1 = bool2;
          ...
          if (this.a.jdField_d_of_type_Int == 20)
          {
            ...
            localObject1 = ((akfj)localObject2).a.getTag();
            ...
            localObject1 = (akfc)this.a.jdField_a_of_type_Akfe.getItem(i);
            this.a.a((akfc)localObject1);
            break;
            i = 0;
            break label100;
            label314:
          ...
          {
            if (this.a.jdField_a_of_type_Akfe.jdField_b_of_type_JavaUtilList.contains(localObject1)) {
              this.a.jdField_a_of_type_Akfe.jdField_b_of_type_JavaUtilList.remove(localObject1);
            }
            for (;;)
            {
              ChatHistoryTroopMemberFragment.a(this.a);
              this.a.jdField_a_of_type_Akfe.notifyDataSetChanged();
              break;
              if (i != 0) {
                this.a.jdField_a_of_type_Akfe.jdField_b_of_type_JavaUtilList.add(localObject1);
              }
            }
          }
          if (bool1)
          {
            ...
            if (localObject2 != null) {
              ((akfj)localObject2).a.a(true);
            }
            if (!TextUtils.isEmpty(this.a.v))
            {
              localObject2 = this.a.a(this.a.v, bool1);
              if (localObject2 != null) {
                ((akfj)localObject2).a.b(true);
              }
            }
      ...
      if (j == 2131377787)
      {
        localObject2 = paramView.findViewById(2131379943);
        bool1 = bool3;
        if (((View)localObject2).getTag() != null)
        {
          bool1 = bool3;
      ...
      else if ((j == 2131363842) && (this.a.jdField_f_of_type_Boolean))
      {
        if (QLog.isColorLevel()) {
        ...
        if (!bhnv.d(BaseApplication.getContext()))
        {
          if (this.a.getActivity().isResume()) {
            QQToast.a(this.a.getActivity(), this.a.getString(2131693965), 0).b(this.a.getActivity().getTitleBarHeight());
          }
        }
