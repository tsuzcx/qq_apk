  ...
  extends akej
{
  ...
  public aken(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager)
  {
  ...
  public static boolean a(ProxyManager paramProxyManager, String paramString)
  {
    ...
    {
      aker localaker = (aker)paramProxyManager.next();
      if ((String.valueOf(0).equals(localaker.jdField_a_of_type_JavaLangString)) && (localaker.jdField_a_of_type_Int == 0) && (localaker.jdField_b_of_type_JavaLangString.equals(paramString)) && ((localaker.jdField_b_of_type_Int == 1) || (localaker.jdField_b_of_type_Int == 2) || (localaker.jdField_b_of_type_Int == 0))) {
        return true;
      }
    }
    return false;
  ...
  private long c(DataLineMsgRecord paramDataLineMsgRecord)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: invokevirtual 142	aken:a	()V
    //   6: aload_1
    //   7: aload_0
    //   8: getfield 144	aken:jdField_a_of_type_ComTencentMobileqqDataDataLineMsgSetList	Lcom/tencent/mobileqq/data/DataLineMsgSetList;
    ...
    //   19: aload_0
    //   20: getfield 144	aken:jdField_a_of_type_ComTencentMobileqqDataDataLineMsgSetList	Lcom/tencent/mobileqq/data/DataLineMsgSetList;
    //   23: aload_1
    ...
    //   27: astore 4
    //   29: aload_0
    //   30: invokespecial 175	aken:f	()V
    //   33: aload_0
    //   34: getfield 29	aken:b	Lcom/tencent/mobileqq/data/DataLineMsgSetList;
    //   37: ifnull +17 -> 54
    //   40: aload 4
    //   42: ifnonnull +21 -> 63
    //   45: aload_0
    //   46: getfield 29	aken:b	Lcom/tencent/mobileqq/data/DataLineMsgSetList;
    //   49: aload_1
    ...
    //   62: lreturn
    //   63: aload_0
    //   64: getfield 29	aken:b	Lcom/tencent/mobileqq/data/DataLineMsgSetList;
    //   67: aload 4
  ...
  private void e(long paramLong)
  {
    ...
    for (;;)
    {
      localObject = apck.a(localDataLineMsgRecord);
      ...
      if (!localDataLineMsgRecord.isSend()) {
        ((FileManagerEntity)localObject).srvTime = (awao.a() * 1000L);
      }
  ...
  public long a(DataLineMsgRecord paramDataLineMsgRecord)
  {
    ...
    new Handler(localLooper).post(new DataLineMsgProxy.5(this, paramDataLineMsgRecord, localeu));
    localeu.a(-1L);
    return 0L;
  }
  ...
  public DataLineMsgRecord a()
  {
    ...
    //   3: invokevirtual 142	aken:a	()V
    //   6: aload_0
    //   7: getfield 144	aken:jdField_a_of_type_ComTencentMobileqqDataDataLineMsgSetList	Lcom/tencent/mobileqq/data/DataLineMsgSetList;
    //   10: astore_1
    //   11: aload_1
    //   12: ifnonnull +9 -> 21
    //   15: aconst_null
    ...
    //   20: areturn
    //   21: aload_0
    //   22: getfield 144	aken:jdField_a_of_type_ComTencentMobileqqDataDataLineMsgSetList	Lcom/tencent/mobileqq/data/DataLineMsgSetList;
    //   25: aload_0
    //   26: getfield 144	aken:jdField_a_of_type_ComTencentMobileqqDataDataLineMsgSetList	Lcom/tencent/mobileqq/data/DataLineMsgSetList;
    //   29: invokevirtual 153	com/tencent/mobileqq/data/DataLineMsgSetList:size	()I
    //   32: iconst_1
    //   33: isub
    //   34: invokevirtual 312	com/tencent/mobileqq/data/DataLineMsgSetList:get	(I)Lcom/tencent/mobileqq/data/DataLineMsgSet;
    //   37: invokevirtual 380	com/tencent/mobileqq/data/DataLineMsgSet:getLastItem	()Lcom/tencent/mobileqq/data/DataLineMsgRecord;
    //   40: astore_1
    //   41: goto -24 -> 17
    //   44: astore_1
    //   45: aload_0
    ...
    for (;;)
    {
      try
      {
        ...
        if (a(this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager, this.jdField_a_of_type_JavaLangString)) {
          this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.a(localatmp);
        }
        ThreadManager.post(new DataLineMsgProxy.1(this, localatmp, (String)localObject1), 5, null, true);
        Object localObject3 = localatmp.a(DataLineMsgRecord.class, a(-1L, 15), null);
        localObject1 = localObject3;
  ...
  public void a(int paramInt, akeo paramakeo)
  {
    long l2 = 0L;
    long l1 = l2;
    if (this.b != null)
    ...
    ThreadManager.post(new DataLineMsgProxy.13(this, l1, paramInt, paramakeo), 8, null, true);
  }
  ...
  public void a(atmo paramatmo, akes paramakes)
  {
    ...
    if (Thread.currentThread() == localLooper.getThread())
    {
      paramatmo = ((DataLineMsgRecord)paramatmo).clone();
      this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.a(String.valueOf(0), 0, this.jdField_a_of_type_JavaLangString, paramatmo, 0, paramakes);
      return;
    }
    new Handler(localLooper).post(new DataLineMsgProxy.2(this, paramatmo, paramakes, localeu));
    localeu.a(-1L);
  }
  ...
  public void a(String paramString1, ContentValues paramContentValues, String paramString2, String[] paramArrayOfString, akes paramakes)
  {
    ...
    new Handler(localLooper).post(new DataLineMsgProxy.3(this, paramString1, paramContentValues, paramString2, paramArrayOfString, paramakes));
  }
  ...
  public void a(String paramString1, String paramString2, String[] paramArrayOfString, akes paramakes)
  {
    ...
    new Handler(localLooper).post(new DataLineMsgProxy.4(this, paramString1, paramString2, paramArrayOfString, paramakes));
  }
  ...
  public long b(DataLineMsgRecord paramDataLineMsgRecord)
  {
    ...
    new Handler(localLooper).post(new DataLineMsgProxy.6(this, paramDataLineMsgRecord, localeu));
    localeu.a(-1L);
    return 0L;
  }
