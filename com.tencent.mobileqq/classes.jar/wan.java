  ...
  extends wio
{
  ...
  private LruCache<String, wav> c = new LruCache(200);
  ...
  private DownloadingUrlEntry a(String paramString, int paramInt)
  {
    ...
    localObject = wjp.a(QQStoryContext.a().a().createEntityManager(), DownloadingUrlEntry.class, DownloadingUrlEntry.class.getSimpleName(), "key=?", new String[] { DownloadingUrlEntry.makeKey(paramString, paramInt) });
  ...
  public static String a(String paramString)
  {
    ...
    {
      ykq.d("Q.qqstory.DownloadUrlManager", "getIpOfDomain url: %s", new Object[] { paramString });
    }
    return null;
  }
  
  private void a(@NonNull String paramString, @NonNull waw paramwaw)
  {
    ykq.b("Q.qqstory.DownloadUrlManager", "pullNewVideoInfoIfNecessary , vid = %s", paramString);
    Bosses.get().postJob(new was(this, "Q.qqstory.DownloadUrlManager", paramString, paramwaw));
  }
  ...
  private boolean a(String paramString)
  {
    // Byte code:
    //   0: iconst_5
    //   1: invokestatic 164	wjs:a	(I)Lwja;
    //   4: checkcast 71	wjp
    //   7: aload_1
    //   8: invokevirtual 167	wjp:a	(Ljava/lang/String;)Lcom/tencent/biz/qqstory/model/item/StoryVideoItem;
    //   11: astore_3
    //   12: aload_3
    //   13: ifnonnull +11 -> 24
    //   16: ldc 169
    //   18: aload_1
    //   19: invokestatic 173	ykq:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   22: iconst_0
    //   23: ireturn
    //   24: aload_3
    ...
    //   83: invokestatic 208	ykq:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   86: new 210	wtz
    //   89: dup
    //   90: invokespecial 211	wtz:<init>	()V
    //   93: astore 4
    //   95: aload 4
    ...
    //   105: putfield 217	wtz:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   108: aload 4
    //   110: getfield 217	wtz:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   113: aload_1
    //   114: invokeinterface 221 2 0
    //   119: pop
    //   120: aload 4
    //   122: ldc2_w 222
    //   125: putfield 225	wtz:jdField_a_of_type_Long	J
    ...
    //   163: aload 5
    //   165: aload 6
    //   167: invokespecial 236	wau:<init>	(Lwan;Ljava/lang/String;Ljava/lang/Object;Ljava/util/concurrent/atomic/AtomicBoolean;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    //   170: astore_1
    //   171: invokestatic 241	wfi:a	()Lwfi;
    //   174: aload 4
    //   176: aload_1
    //   177: invokevirtual 244	wfi:a	(Lwfm;Lwfk;)V
    //   180: aload_3
    ...
    //   191: ldc 118
    //   193: ldc 246
    //   195: invokestatic 208	ykq:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   198: iconst_0
    //   199: ireturn
    //   200: aload_2
    //   201: monitorenter
    //   202: ldc 118
    //   204: ldc 248
    //   206: invokestatic 208	ykq:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   209: aload 5
  ...
  private wav b(String paramString, int paramInt)
  {
    paramString = DownloadingUrlEntry.makeKey(paramString, paramInt);
    paramString = (wav)this.c.get(paramString);
  ...
  @Deprecated
  private void b(@NonNull String paramString, @NonNull waw paramwaw)
  {
    ykq.b("Q.qqstory.DownloadUrlManager", "pullNewVideoInfoIfNecessaryInner , vid = %s", paramString);
    Object localObject = ((wjp)wjs.a(5)).a(paramString);
    if (localObject == null)
    {
      ykq.e("Q.qqstory.DownloadUrlManager", "DownloadUrlQueryResult:: error video is null");
      paramwaw.a(false);
      return;
    }
    ...
    ykq.d("Q.qqstory.DownloadUrlManager", ((StoryVideoItem)localObject).mVid + " request video url is expire :" + ((StoryVideoItem)localObject).videoUrlExpireTime);
    localObject = new wtz();
    ((wtz)localObject).jdField_a_of_type_JavaUtilList = new ArrayList(1);
    ((wtz)localObject).jdField_a_of_type_JavaUtilList.add(paramString);
    ((wtz)localObject).jdField_a_of_type_Long = 10000L;
    paramString = new wat(this, paramwaw, paramString);
    wfi.a().a((wfm)localObject, paramString);
  }
  ...
  public List<VideoUrlEntry> a(String paramString)
  {
    ...
    List localList = wjp.a(QQStoryContext.a().a().createEntityManager(), VideoUrlEntry.class, VideoUrlEntry.class.getSimpleName(), "vid=?", new String[] { paramString });
  ...
  public wav a(String paramString, int paramInt)
  {
    zdl.b();
    wav localwav = new wav();
    localwav.jdField_a_of_type_JavaLangString = paramString;
    localwav.jdField_a_of_type_Int = paramInt;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          i = 1;
          localwav.jdField_a_of_type_Boolean = true;
          localObject2 = null;
            ...
            if (a())
            {
              ...
              if (localList != null)
              {
                ...
                if (localList.size() > 0)
                {
                  ...
                  localwav.jdField_b_of_type_Int = 2;
                  localwav.jdField_b_of_type_JavaLangString = ((DownloadingUrlEntry)localObject1).url;
                  localwav.c = ((VideoUrlEntry)localObject2).videoUrlLevel;
                }
              }
            }
          }
          if (localwav.jdField_b_of_type_Int != -1) {
            break label644;
          }
          localObject2 = localwjp.a(paramString);
          ...
          if (paramInt == 0)
          {
            ...
            ((DownloadingUrlEntry)localObject1).key = DownloadingUrlEntry.makeKey(((DownloadingUrlEntry)localObject1).vid, ((DownloadingUrlEntry)localObject1).fileType);
            localwav.jdField_b_of_type_Int = 3;
            localwav.jdField_b_of_type_JavaLangString = ((DownloadingUrlEntry)localObject1).url;
            if ((localObject1 != null) && (!TextUtils.isEmpty(((DownloadingUrlEntry)localObject1).url)))
            {
              localObject2 = wbl.a(paramString, paramInt, false, false);
            ...
            if (i != 0)
            {
              ykq.d("Q.qqstory.DownloadUrlManager", "pullNewVideoInfoIfNecessary: video url have expire,so we need to handle the temOrphan~~");
              paramString = a(paramString, paramInt);
              if ((paramString == null) || (!TextUtils.equals(paramString.url, localwav.jdField_b_of_type_JavaLangString))) {
                break label598;
              }
              ykq.d("Q.qqstory.DownloadUrlManager", "pullNewVideoInfoIfNecessary: set isTmpOrphan false,cache entry url=" + paramString.url + " result url=" + localwav.jdField_b_of_type_JavaLangString);
              localwav.jdField_a_of_type_Boolean = false;
            }
            return localwav;
          }
        }
        else
        {
          ...
          localwav.jdField_b_of_type_Int = 0;
          localwav.jdField_b_of_type_JavaLangString = ((DownloadingUrlEntry)localObject1).url;
          localwav.c = ((DownloadingUrlEntry)localObject1).compressLevel;
          return localwav;
        }
        if (paramInt == 1)
        {
      ...
      if (paramString == null)
      {
        ykq.d("Q.qqstory.DownloadUrlManager", "pullNewVideoInfoIfNecessary: set isTmpOrphan true,cache entry url");
      }
      else
      {
        ykq.d("Q.qqstory.DownloadUrlManager", "pullNewVideoInfoIfNecessary: set isTmpOrphan true,cache entry url :" + paramString.url);
        continue;
        continue;
        i = 0;
      }
  ...
  public wav a(String paramString, int paramInt, boolean paramBoolean)
  {
    zdl.b();
    ...
    for (;;)
    {
      ...
      {
        localwav.a();
        localwav.jdField_a_of_type_Long = System.currentTimeMillis();
        this.c.put(str, localwav);
        this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.unlock();
      }
      ((DownloadingUrlEntry)localObject1).url = ((StoryVideoItem)localObject2).getThumbUrl();
      continue;
  ...
  {
    if ((paramInt != 0) || (zcl.a(paramString))) {
      return;
    }
    Bosses.get().postJob(new waq(this, "Q.qqstory.DownloadUrlManager", paramString, paramInt));
  }
  
  public void a(String paramString, int paramInt, wax paramwax)
  {
    wav localwav = b(paramString, paramInt);
    if (localwav != null)
    {
      paramwax.a(localwav);
      return;
    ...
    if (paramInt == 0)
    {
      a(paramString, new wao(this, paramString, paramInt, paramwax));
      return;
    }
    Bosses.get().postJob(new wap(this, "Q.qqstory.DownloadUrlManager", paramString, paramInt, paramwax));
  }
  ...
  public void a(List<List<VideoUrlEntry>> paramList)
  {
    ...
    ykq.a("Q.qqstory.DownloadUrlManager", "update video url:%s", paramList);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (TextUtils.isEmpty(localVideoUrlEntry2.videoUrl))
        {
          ...
          ykq.d("Q.qqstory.DownloadUrlManager", "%s url error!", new Object[] { localVideoUrlEntry2.vid });
          continue;
        }
  ...
  {
    ykq.a("Q.qqstory.DownloadUrlManager", "replaceDomain2Ip domain - url: %s", paramString);
    ...
    for (;;)
    {
          ...
          if ((localObject != null) && (((List)localObject).size() > 0))
          {
            ...
            if (i < ((List)localObject).size())
            {
              ...
              else
              {
                ...
                ykq.a("Q.qqstory.DownloadUrlManager", "replaceDomain2Ip ip - url: %s", str1);
                i += 1;
                continue;
              }
              str1 = str2 + "&txhost=" + str3;
      ...
      {
        ykq.b("Q.qqstory.DownloadUrlManager", "replaceDomain2Ip MalformedURLException: %s", localMalformedURLException);
      }
  ...
  {
    Bosses.get().postJob(new war(this, "Q.qqstory.DownloadUrlManager", paramString, paramInt));
  }
  ...
  public void c(String paramString, int paramInt)
  {
    try
    {
      ...
      paramString = wjp.a((EntityManager)localObject, DownloadingUrlEntry.class, DownloadingUrlEntry.class.getSimpleName(), "key=?", new String[] { DownloadingUrlEntry.makeKey(paramString, paramInt) });
