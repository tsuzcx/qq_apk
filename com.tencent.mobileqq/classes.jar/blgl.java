...
{
  private final blgm jdField_a_of_type_Blgm;
  private final ReleaseLooperHandler jdField_a_of_type_ComTencentWeiyunTransmissionUtilsHandlerReleaseLooperHandler;
  
  public blgl(blgm paramblgm, ReleaseLooperHandler paramReleaseLooperHandler)
  {
  ...
  private void b(blfr paramblfr)
  {
    ...
    do
    {
        ...
        do
        {
          do
          {
            ...
            do
            {
              ...
              {
                this.jdField_a_of_type_Blgm.a(paramblfr.a(), true, false, false, str2);
                return;
              }
            } while (paramblfr.d());
            if (!IOUtils.ensureStorageSpace(str4, l1 - l2))
            {
              this.jdField_a_of_type_Blgm.a(paramblfr.a(), false, false, true, "");
              return;
            }
          } while (paramblfr.d());
          if (!IOUtils.ensureWritable(str4))
          {
            this.jdField_a_of_type_Blgm.a(paramblfr.a(), false, true, false, "");
            return;
          }
        } while (paramblfr.d());
        localObject = IOUtils.ensureFilePath(str4, paramblfr.a().b);
      } while (paramblfr.d());
      String str1 = a(str3);
      if ((!TextUtils.isEmpty(str1)) && (!TextUtils.equals(str2, str1)) && (TextUtils.equals(str3, IOUtils.getFileSha1(str1))))
      {
        ...
        for (;;)
        {
          this.jdField_a_of_type_Blgm.a(paramblfr.a(), bool, false, false, (String)localObject);
          return;
          bool = IOUtils.copyFileAndNotifyOS(WeiyunTransmissionGlobal.getInstance().getContext(), str1, (String)localObject);
        }
      }
    } while (paramblfr.d());
    this.jdField_a_of_type_Blgm.a(paramblfr.a(), false, false, false, (String)localObject);
  }
  ...
  public void a(blfr paramblfr)
  {
    ...
    this.jdField_a_of_type_ComTencentWeiyunTransmissionUtilsHandlerReleaseLooperHandler.sendMessage(Message.obtain(null, 11, paramblfr));
  }
