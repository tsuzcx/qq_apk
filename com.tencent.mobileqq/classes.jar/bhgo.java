...
{
  public bhgo(MiniAppLivePusher paramMiniAppLivePusher, String paramString1, String paramString2, bgkd parambgkd, String paramString3, JSONObject paramJSONObject, String paramString4, DownloaderProxy paramDownloaderProxy) {}
  ...
  public void onDownloadFailed(int paramInt, String paramString)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Bgkd.a.a("onLivePusherError", localJSONObject.toString(), this.jdField_a_of_type_ComTencentQqminiSdkRuntimeWidgetMediaMiniAppLivePusher.jdField_a_of_type_Int);
      return;
    }
  ...
  public void onDownloadSucceed(int paramInt, String paramString, Map<String, List<String>> paramMap)
  {
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          if ((!bgkv.b(localFile, paramMap)) || (!paramMap.exists()) || (paramMap.length() != localFile.length())) {
            continue;
          }
