...
public class bhgo
{
  ...
  public static void a(bhgd parambhgd, String paramString, long paramLong)
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("module_id", parambhgd.a);
    localHashMap.put("module_url", parambhgd.d);
    localHashMap.put("module_version", parambhgd.b);
    localHashMap.put("resolveClassState", paramString);
    localHashMap.put("param_FailCode", "v" + parambhgd.b + "_" + paramString);
    boolean bool = "1".equalsIgnoreCase(paramString);
    a(BaseApplicationImpl.getApplication().getRuntime().getAccount(), parambhgd.a + "_resolveClassRes", bool, paramLong, 0L, localHashMap, "");
  }
  
  public static void a(bhgd parambhgd, boolean paramBoolean, long paramLong)
  {
    if (paramBoolean) {}
    for (String str = "1";; str = "0")
    {
      ...
      localHashMap.put("module_id", parambhgd.a);
      localHashMap.put("module_url", parambhgd.d);
      localHashMap.put("module_version", String.valueOf(parambhgd.b));
      localHashMap.put("downloadState", str);
      localHashMap.put("param_FailCode", "v" + parambhgd.b + "_" + str);
      a(BaseApplicationImpl.getApplication().getRuntime().getAccount(), parambhgd.a + "_downloadRes", paramBoolean, paramLong, 0L, localHashMap, "");
      return;
    }
  }
  ...
  public static void b(bhgd parambhgd, boolean paramBoolean, long paramLong)
  {
    if (paramBoolean) {}
    for (String str = "1";; str = "0")
    {
      ...
      localHashMap.put("param_FailCode", "v" + parambhgd.b + "_" + str);
      a(BaseApplicationImpl.getApplication().getRuntime().getAccount(), parambhgd.a + "_loadRes", paramBoolean, paramLong, 0L, localHashMap, "");
      return;
    }
  }
}
