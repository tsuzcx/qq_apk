  ...
  extends aqli
{
  ...
  public aqlj(Reader paramReader, int paramInt)
  {
  ...
  public final aqlg a()
  {
    ...
    for (;;)
    {
      ...
      return new aqlg(new String(this.jdField_a_of_type_ArrayOfChar, 0, k), n, k + n, this.jdField_a_of_type_JavaLangString);
      label700:
      m = i1;
    }
  }
