...
public class apph
{
  public static int a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    {
      paramMessageRecord = agmk.a(paramQQAppInterface, paramMessageRecord);
      int i;
      if ((paramMessageRecord instanceof MessageForFile))
      {
        ...
        {
          i = aszt.a(paramQQAppInterface.fileName);
          if (i == 0) {
            return 3;
          }
          if (i == 2) {
      ...
      else if ((paramMessageRecord instanceof MessageForTroopFile))
      {
        ...
        if (paramQQAppInterface != null)
        {
          i = aszt.a(paramQQAppInterface.g);
          if (i == 0) {
            return 3;
          }
          if (i == 2) {
  ...
  public static final String a(Context paramContext, int paramInt)
  {
    ...
    if (i < 60) {
      return paramContext.getString(2131698484, new Object[] { Integer.valueOf(i) });
    }
    if (i < 3600) {
      return paramContext.getString(2131698485, new Object[] { Integer.valueOf(i / 60), Integer.valueOf(i % 60) });
    }
    paramInt = i / 60;
    return paramContext.getString(2131698486, new Object[] { Integer.valueOf(paramInt / 60), Integer.valueOf(paramInt % 60) });
  }
