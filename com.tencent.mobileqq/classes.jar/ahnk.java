  ...
  implements View.OnClickListener
{
  ...
  private List<akhx> jdField_a_of_type_JavaUtilList;
  private boolean jdField_a_of_type_Boolean;
  
  public ahnk(Context paramContext, QQAppInterface paramQQAppInterface, ListView paramListView, int paramInt, boolean paramBoolean, PhoneContactFragment paramPhoneContactFragment)
  {
    ...
    do
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        if (!localPhoneContact.isHiden) {
          ((List)localObject1).add(akhs.a(1, localPhoneContact, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext));
        }
      }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (a())
    {
      ...
      {
        this.jdField_a_of_type_AndroidViewView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131558879, null);
        this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130839216);
        this.jdField_a_of_type_AndroidViewView.findViewById(2131368762).setVisibility(8);
        this.jdField_a_of_type_AndroidViewView.findViewById(2131368853).setVisibility(8);
        paramView = (SingleLineTextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367341);
        paramView.setText(alpo.a(2131708376));
        paramViewGroup = (ViewGroup.MarginLayoutParams)paramView.getLayoutParams();
        paramViewGroup.leftMargin /= 2;
        paramView.setLayoutParams(paramViewGroup);
        ((SimpleTextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364709)).setText("0");
      }
      return this.jdField_a_of_type_AndroidViewView;
    }
    paramView = ((akhx)this.jdField_a_of_type_JavaUtilList.get(paramInt)).a(0, paramInt, paramView, paramViewGroup, this);
    if (paramView != null)
    {
      paramViewGroup = (akia)paramView.getTag();
      ...
      if ((paramViewGroup instanceof akic)) {
        ((akic)paramViewGroup).a.setOnClickListener(this);
      }
    }
    return paramView;
  }
  ...
  {
    int i = 17;
    if ((paramView != null) && (paramView.getId() == 2131375665) && ((paramView.getTag() instanceof PhoneContact)))
    {
    ...
    for (;;)
    {
      ...
      paramView = AddFriendLogicActivity.a(this.jdField_a_of_type_AndroidContentContext, 2, paramView.unifiedCode, null, 3006, i, paramView.name, null, null, alpo.a(2131708371), null);
      this.jdField_a_of_type_AndroidContentContext.startActivity(paramView);
      azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "contact", "", "addbook", "add_friend", 0, 0, "", "", "", "");
      do
      {
        do
        {
          return;
        } while ((paramView == null) || (!(paramView.getTag() instanceof akia)));
      ...
      for (;;)
      {
        ...
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80053DF", "0X80053DF", 0, 0, "1", "", "", "");
        return;
