  ...
  public void a(boolean paramBoolean, String paramString1, String paramString2, long paramLong, String paramString3, String paramString4, String paramString5, String paramString6, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      if (this.a.jdField_a_of_type_Apep != null) {
        this.a.jdField_a_of_type_Apep.jdField_f_of_type_Long = System.currentTimeMillis();
      }
      this.a.c = true;
      if (!paramBoolean)
      {
        ...
        for (;;)
        {
          ...
          if (this.a.jdField_a_of_type_Apep != null)
          {
            this.a.jdField_a_of_type_Apep.jdField_a_of_type_Boolean = false;
            this.a.jdField_a_of_type_Apep.jdField_c_of_type_Long = (this.a.jdField_a_of_type_Apep.jdField_f_of_type_Long - this.a.jdField_a_of_type_Apep.jdField_e_of_type_Long);
            this.a.jdField_a_of_type_Apep.jdField_e_of_type_JavaLangString = String.valueOf(paramLong);
            this.a.jdField_a_of_type_Apep.i = paramString3;
            this.a.jdField_a_of_type_Apep.jdField_d_of_type_JavaLangString = paramString6;
            this.a.jdField_a_of_type_Apep.jdField_d_of_type_Long = (System.currentTimeMillis() - this.a.jdField_a_of_type_Apep.jdField_a_of_type_Long);
            this.a.jdField_a_of_type_Apep.a();
          }
          ...
          return;
          this.a.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131704564));
        }
      }
      ...
      if (this.a.jdField_a_of_type_Apep != null)
      {
        this.a.jdField_a_of_type_Apep.jdField_a_of_type_Boolean = true;
        this.a.jdField_a_of_type_Apep.g = paramString4;
        this.a.jdField_a_of_type_Apep.i = "";
        this.a.jdField_a_of_type_Apep.jdField_f_of_type_Long = System.currentTimeMillis();
        this.a.jdField_a_of_type_Apep.jdField_c_of_type_Long = (this.a.jdField_a_of_type_Apep.jdField_f_of_type_Long - this.a.jdField_a_of_type_Apep.jdField_e_of_type_Long);
        this.a.jdField_a_of_type_Apep.jdField_c_of_type_JavaLangString = paramString1;
        this.a.jdField_a_of_type_Apep.jdField_f_of_type_JavaLangString = this.a.jdField_b_of_type_JavaLangString;
        this.a.jdField_a_of_type_Apep.jdField_d_of_type_JavaLangString = paramString6;
        this.a.jdField_a_of_type_Apep.jdField_d_of_type_Long = (System.currentTimeMillis() - this.a.jdField_a_of_type_Apep.jdField_a_of_type_Long);
        this.a.jdField_a_of_type_Apep.a();
      }
    ...
    } while (this.a.jdField_a_of_type_Apep == null);
    this.a.jdField_a_of_type_Apep.jdField_e_of_type_Long = System.currentTimeMillis();
    this.a.jdField_a_of_type_Apep.l = "2";
  }
}
