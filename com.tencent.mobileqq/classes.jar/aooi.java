  ...
  implements aonz
{
  ...
  public boolean a(String paramString, ark.VariantWrapper[] paramArrayOfVariantWrapper, ark.VariantWrapper paramVariantWrapper)
  {
    ...
    for (;;)
    {
      ...
      paramString.putExtra("from", aonx.class.getName());
      paramString.putExtra("finishAfterSucc", true);
      if (aonx.a(this.a) != null) {}
      try
      {
        BaseApplicationImpl.getApplication().unregisterReceiver(aonx.a(this.a));
        label105:
        aonx.a(this.a, null);
        aonx.a(this.a, new aooj(this, l));
        paramArrayOfVariantWrapper = new IntentFilter("com.tencent.mobileqq.ark.API.scanResultAction");
        BaseApplicationImpl.getApplication().registerReceiver(aonx.a(this.a), paramArrayOfVariantWrapper, "com.tencent.msg.permission.pushnotify", null);
