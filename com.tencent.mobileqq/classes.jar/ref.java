  ...
  implements View.OnClickListener
{
  ...
  private void a(View paramView, int paramInt)
  {
    ...
    localGradientDrawable1.setCornerRadius(bbkx.a(17.0F));
    ...
    localGradientDrawable2.setCornerRadius(bbkx.a(17.0F));
  ...
  public void a(reh paramreh)
  {
    this.jdField_a_of_type_Reh = paramreh;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localObject = new rei(this, null);
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559976, paramViewGroup, false);
      ((rei)localObject).jdField_a_of_type_AndroidViewView = paramView.findViewById(2131364657);
      ((rei)localObject).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131376833));
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (!((ChannelCoverInfo)localObject).isReport)
        {
          ...
          oes.a("0X8007F01", (ChannelCoverInfo)localObject, oes.b);
        }
        ...
        return paramView;
        paramViewGroup = (rei)paramView.getTag();
        break;
        paramViewGroup.jdField_a_of_type_AndroidViewView.setPadding(bbkx.a(8.0F), 0, bbkx.a(8.0F), 0);
  ...
  public void onClick(View paramView)
  {
    ...
    if (localChannelCoverInfo != null)
    {
      ...
      nut.a(this.jdField_a_of_type_AndroidContentContext, localChannelCoverInfo.mChannelCoverId, localChannelCoverInfo.mChannelCoverName, localChannelCoverInfo.mChannelType, 4, (Map)localObject);
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      oes.a("0X8007F02", localChannelCoverInfo, oes.b);
      if ((this.jdField_a_of_type_Reh == null) || (!(paramView.getTag() instanceof ChannelCoverInfo))) {
        break;
      }
      this.jdField_a_of_type_Reh.a((ChannelCoverInfo)paramView.getTag());
      return;
      label252:
      if (rwa.b(localChannelCoverInfo.mChannelJumpUrl)) {
        rwa.a(this.jdField_a_of_type_AndroidContentContext, "", localChannelCoverInfo.mChannelJumpUrl, null);
      }
      for (;;)
      {
        if (!QLog.isColorLevel()) {
