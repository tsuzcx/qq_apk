...
public class wjj
  extends axvs
{
  public wjj(TroopMemberApiService paramTroopMemberApiService) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 1003: 
      do
      {
        ...
        {
          return;
          if (localaxqf.jdField_b_of_type_Int != 64) {
            break;
          }
          this.a.jdField_a_of_type_Int = axsm.jdField_a_of_type_Int;
        ...
        paramMessage = (asft)((QQAppInterface)TroopMemberApiService.k(this.a)).a(60);
        ...
        return;
        if (localaxqf.jdField_b_of_type_Int == 39)
        {
          this.a.jdField_b_of_type_JavaLangString = ((axsm)localaxqf.a).jdField_b_of_type_JavaLangString;
          if (QLog.isColorLevel()) {
          ...
          asfn.a((QQAppInterface)TroopMemberApiService.l(this.a), this.a.jdField_a_of_type_JavaLangString);
          return;
        }
