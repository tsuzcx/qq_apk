...
public class wjj
{
  ...
  public wjj(qqstory_710_message.StoryMessage paramStoryMessage)
  {
    ...
    for (;;)
    {
      if (paramStoryMessage.video_info.has())
      {
        ...
        if (!TextUtils.isEmpty(this.jdField_g_of_type_JavaLangString)) {
          this.jdField_a_of_type_Utb = utb.a(this.jdField_g_of_type_JavaLangString);
        }
        if (!TextUtils.isEmpty(this.jdField_h_of_type_JavaLangString)) {
          this.jdField_a_of_type_Uta = uta.a(this.jdField_h_of_type_JavaLangString);
        }
      }
      ...
      if (paramStoryMessage.share_info.has())
      {
        ...
        for (bool1 = bool9;; bool1 = false)
        {
          ...
          this.jdField_e_of_type_JavaLangString = ume.a(2131700073, new Object[] { this.k });
          break label1020;
          this.jdField_a_of_type_Int = 7;
          this.l = ((qqstory_710_message.ShareGroupInfo)localObject).share_new_name.get().toStringUtf8();
          this.jdField_e_of_type_JavaLangString = ume.a(2131700074, new Object[] { this.l });
          break label1020;
          this.jdField_a_of_type_Int = 8;
          break label1020;
          this.jdField_a_of_type_Int = 9;
          this.jdField_e_of_type_JavaLangString = ume.a(2131700079, new Object[] { this.k });
          break label1020;
          this.jdField_a_of_type_Int = 11;
          this.jdField_e_of_type_JavaLangString = alpo.a(2131706943);
          break label1020;
        }
      }
  ...
  {
    if (this.t == null) {
      this.t = wnc.a(this.jdField_a_of_type_Long);
    }
    return this.t;
  }
