...
public class bmul
{
  ...
  public static void a(long paramLong, Activity paramActivity, String paramString, bmun parambmun)
  {
    ...
    bmum localbmum2 = b();
    if (QLog.isColorLevel()) {
      QLog.d("QZoneVideoCommonUtils", 2, "support record=" + localbmum1.a() + ", support trim=" + localbmum2.a());
    }
    if ((!localbmum1.a()) && (!localbmum2.a()))
    {
      if (localbmum1.b()) {}
      for (paramString = localbmum1.a();; paramString = null)
      {
        String str;
        if (paramString != null)
        {
        ...
        {
          str = paramActivity.getString(2131716919);
        }
        if (parambmun != null) {
          parambmun.onFail(paramActivity, str);
        }
        if (!QLog.isColorLevel()) {
          break;
        }
        QLog.w("QZoneVideoCommonUtils", 2, "qzone video is not supported, recordSupport tips=" + localbmum1.a() + ",trimSupport tips=" + localbmum2.a() + ",show tips=" + str);
        return;
      }
    }
    a(paramLong, paramActivity, localbmum1.a(), localbmum2.a(), paramString);
    PerfTracer.traceEnd("Video_component_pre_launch");
  }
  
  public static void a(long paramLong, Activity paramActivity, String paramString, bmun parambmun, Bundle paramBundle)
  {
    PerfTracer.traceStart("Video_component_pre_launch");
    if (paramActivity == null)
    {
    ...
    if ((!localbmum1.a()) && (!localbmum2.a()))
    {
      ...
      for (paramString = localbmum1.a();; paramString = null)
      {
        ...
        {
          paramBundle = paramActivity.getString(2131716919);
        }
        if (parambmun != null) {
          parambmun.onFail(paramActivity, paramBundle);
        }
        if (!QLog.isColorLevel()) {
          break;
        }
        QLog.w("QZoneVideoCommonUtils", 2, "qzone video is not supported, recordSupport tips=" + localbmum1.a() + ",trimSupport tips=" + localbmum2.a() + ",show tips=" + paramBundle);
        return;
      }
    }
