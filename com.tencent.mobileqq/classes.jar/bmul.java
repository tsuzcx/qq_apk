...
public class bmul
  extends bmut
  implements View.OnClickListener, View.OnTouchListener, bbhp, bbig, bbih, bori, bpog, MediaScanner.OnMediaInfoScannerListener
{
  protected int a;
  protected long a;
  ...
  public bmul(borh paramborh, borg paramborg)
  {
    ...
    this.jdField_a_of_type_JavaLangString = anvx.a(2131709224);
  ...
  {
    bpii.a("onCreateView");
    Object localObject = new RelativeLayout(this.jdField_a_of_type_Borh.a());
    ((RelativeLayout)localObject).setLayoutParams(new ViewGroup.LayoutParams(-1, -1));
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_Borh.a().getLayoutInflater().inflate(a(), (ViewGroup)localObject, false).findViewById(2131367063);
    bpii.a("onCreateView1");
    this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView = ((CameraCaptureView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364231));
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131367064));
      ...
      this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131363643));
      this.jdField_c_of_type_Boolean = LiuHaiUtils.a(this.jdField_a_of_type_AndroidWidgetLinearLayout, this.jdField_b_of_type_AndroidWidgetRelativeLayout, ViewUtils.dip2px(1.0F));
      if (QLog.isColorLevel()) {
        QLog.i("QIMCameraCaptureUnit", 1, "initLiuHaiScreenUI_Common mEnableLHLayout:" + this.jdField_c_of_type_Boolean);
      }
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131364441));
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
      this.jdField_a_of_type_AndroidWidgetButton.setContentDescription(this.jdField_a_of_type_AndroidWidgetButton.getResources().getString(2131718071));
      if (!aqmy.d())
      {
        this.jdField_a_of_type_AndroidWidgetButton.setVisibility(4);
        this.jdField_a_of_type_AndroidWidgetButton.setEnabled(false);
      }
      this.jdField_b_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131366929));
      this.jdField_b_of_type_AndroidWidgetButton.setOnClickListener(this);
      this.jdField_b_of_type_AndroidWidgetButton.setSelected(false);
      this.jdField_c_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131365386));
      this.jdField_c_of_type_AndroidWidgetButton.setOnClickListener(this);
      this.jdField_c_of_type_AndroidWidgetButton.setSelected(false);
      this.jdField_c_of_type_AndroidWidgetButton.setVisibility(8);
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364250));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364255));
      l();
      this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131374150);
      this.jdField_a_of_type_ComTencentBizQqstoryTakevideoCameraFocusView = ((CameraFocusView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364241));
      this.jdField_a_of_type_Boolean = this.jdField_a_of_type_Borh.a().getIntent().getBooleanExtra("enable_local_video", false);
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370490));
      this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this);
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      localObject = this.jdField_a_of_type_AndroidViewView.getResources().getDrawable(2130849211);
      ...
      this.jdField_a_of_type_Bbhh = new bbhh(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView);
      this.jdField_a_of_type_Bbgz = a();
      this.jdField_a_of_type_Bbhd = new bbhd(this.jdField_a_of_type_Borh.a(), new bmum(this));
      this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131367033);
      this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131364289));
  ...
  protected bbgz a()
  {
    return new bbgz(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoCameraFocusView);
  }
  
  protected bbii a()
  {
    if (bddt.l()) {
      return bpnj.a().a(this.jdField_a_of_type_Borh.a());
    }
    return bpnj.a().b(this.jdField_a_of_type_Borh.a());
  }
  ...
  public void a(int paramInt, boil paramboil) {}
  ...
  {
    super.a(paramBundle);
    this.jdField_a_of_type_Long = this.jdField_a_of_type_Borh.a().getIntent().getLongExtra("ACTIVITY_START_TIME", -1L);
    if (paramBundle != null) {
    ...
    this.jdField_a_of_type_Borh.a().registerReceiver(this.jdField_a_of_type_AndroidContentBroadcastReceiver, a());
    bbht.a();
  }
  
  public void a(bbil parambbil) {}
  ...
  public void a(CameraCaptureView.VideoCaptureResult paramVideoCaptureResult)
  {
    ...
    int i1;
    if ((this.g) && (bbht.jdField_a_of_type_Long < 500L))
    {
      i1 = 1;
    ...
    for (;;)
    {
      ykv.a("clk_shoot", ykv.b(bbhl.jdField_a_of_type_Int), 2, new String[0]);
      return;
      i1 = 0;
      break;
      label168:
  ...
  protected void a(List<CameraCaptureView.VideoCaptureResult> paramList, List<LocalMediaInfo> paramList1)
  {
    ...
    if ((!this.o) || (paramList.size() == 1))
    {
      ...
      MediaScanner.getInstance(BaseApplicationImpl.getContext()).queryMediaInfoAsync(new bmun(this), this.jdField_b_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo);
      return;
    }
  ...
  public void a(boolean paramBoolean, String paramString)
  {
    ...
    bbht.jdField_b_of_type_Int = this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView.a();
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Bmuv = ((bmuv)bogd.a().c(13));
      this.jdField_a_of_type_Bmuv.a(paramBoolean);
      AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
      if ((localAppRuntime instanceof AppInterface)) {
        localAppRuntime.notifyObservers(boiu.class, 7, false, null);
      }
  ...
  public void c(boolean paramBoolean)
  {
    ...
    label41:
    t();
    float f1 = UIUtils.dip2px(this.jdField_a_of_type_Borh.a(), 90.0F);
    ArrayList localArrayList = new ArrayList();
    if (this.jdField_a_of_type_AndroidWidgetFrameLayout != null)
    {
      localArrayList.add(new bonm(this.jdField_a_of_type_AndroidWidgetFrameLayout, "translationY", 0.0F, f1, 450L, 0L));
      localArrayList.add(new bonm(this.jdField_a_of_type_AndroidWidgetFrameLayout, "alpha", 1.0F, 0.0F, 450L, 0L));
    }
    if (this.jdField_a_of_type_AndroidViewViewGroup != null)
    {
      localArrayList.add(new bonm(this.jdField_a_of_type_AndroidViewViewGroup, "translationY", f1, 0.0F, 450L, 0L));
      localArrayList.add(new bonm(this.jdField_a_of_type_AndroidViewViewGroup, "alpha", 0.0F, 1.0F, 450L, 0L));
    ...
    if ((localObject != null) && (((List)localObject).size() > 0))
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        localArrayList.add(new bonm(localView, "translationY", f1, 0.0F, 450L, 0L));
        localArrayList.add(new bonm(localView, "alpha", 0.0F, 1.0F, 450L, 0L));
        localView.setAlpha(0.0F);
      }
    }
    bonj.a(localArrayList, new bmup(this));
  }
  ...
  public void denied()
  {
    ...
    if (((Activity)localObject).checkSelfPermission("android.permission.CAMERA") != 0)
    {
      ...
      localObject = bhdj.a(new String[] { "android.permission.CAMERA", "android.permission.RECORD_AUDIO" });
    }
    for (;;)
    {
      ...
      label98:
      if (i1 != 0) {
        localObject = bhdj.a(new String[] { "android.permission.CAMERA" });
      } else {
        localObject = bhdj.a(new String[] { "android.permission.RECORD_AUDIO" });
      }
    }
  }
  ...
  public void h()
  {
    this.jdField_a_of_type_Borg.a(2);
  }
  ...
  protected void l()
  {
    this.jdField_b_of_type_DovComTencentMobileqqRichmediaCaptureViewQIMCameraCaptureButtonLayoutNew = ((QIMCameraCaptureButtonLayoutNew)this.jdField_a_of_type_AndroidViewView.findViewById(2131364282));
    this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewQIMCameraSegmentCaptureButtonLayoutNew = ((QIMCameraSegmentCaptureButtonLayoutNew)this.jdField_a_of_type_AndroidViewView.findViewById(2131377282));
    this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewQIMCameraCaptureButtonLayoutNew = this.jdField_b_of_type_DovComTencentMobileqqRichmediaCaptureViewQIMCameraCaptureButtonLayoutNew;
  }
  ...
  public void n()
  {
    book.a(this.jdField_a_of_type_AndroidWidgetButton, 200L, null);
    ...
    if (this.jdField_a_of_type_AndroidWidgetButton != null)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView.a() == 1) {
        this.jdField_a_of_type_AndroidWidgetButton.setContentDescription(this.jdField_a_of_type_AndroidWidgetButton.getResources().getString(2131718070));
      }
    }
    else {
      return;
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      n();
      bbht.f();
      ykv.a("clk_switch", this.jdField_a_of_type_Boqz.a(), 0, new String[0]);
      continue;
      book.a(this.jdField_b_of_type_AndroidWidgetButton, 200L, null);
      boolean bool;
      ...
      {
        bbhl.b(i1);
        ykv.a("clk_flash", this.jdField_a_of_type_Boqz.a(), 0, new String[0]);
        bnqm.a().I();
        break;
        bool = false;
        break label120;
      ...
      book.a(this.jdField_c_of_type_AndroidWidgetButton, 200L, null);
  ...
  public void p()
  {
    ...
    for (;;)
    {
      ykv.a("clk_cancel", ykv.b(this.jdField_a_of_type_Boqz.a()), 0, new String[0]);
      return;
  ...
  public void q()
  {
    ...
    String str = localActivity.getString(2131698784);
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = bhdj.a(localActivity, 230).setMessage(str).setPositiveButton(localActivity.getString(2131693764), new bmus(this));
  }
