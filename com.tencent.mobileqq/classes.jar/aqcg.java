  ...
  implements Manager
{
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, alls paramalls)
  {
    QLog.i("TeleScreen|CheckForwardManager", 1, "dl src: " + paramString1 + ", refId: " + paramString4);
    BaseApplicationImpl localBaseApplicationImpl = BaseApplicationImpl.getApplication();
    NewIntent localNewIntent = new NewIntent(localBaseApplicationImpl.getApplicationContext(), aqci.class);
    ...
    if (paramalls != null)
    {
      int i = paramString1.a(paramContext, paramalls);
      localNewIntent.putExtra("req_id", i);
      if (QLog.isColorLevel()) {
        QLog.d("TeleScreen|CheckForwardManager", 2, "add req with id: " + i);
      }
    }
    localNewIntent.setObserver(alml.a());
    localBaseApplicationImpl.getRuntime().startServlet(localNewIntent);
  }
  
  public static void a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, List<ResolveInfo> paramList, String paramString6, allx paramallx)
  {
    ...
    for (;;)
    {
      ...
      int i = alml.a().a(paramContext, paramallx);
      localNewIntent.putExtra("req_id", i);
      if (QLog.isColorLevel()) {
        QLog.d("TeleScreen|CheckForwardManager", 2, "add req with id: " + i);
      }
  ...
  public void a(QQAppInterface paramQQAppInterface, oidb_cmd0xc78.CheckShareExtensionReq paramCheckShareExtensionReq, String paramString, aqcj paramaqcj)
  {
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApp(), aqci.class);
