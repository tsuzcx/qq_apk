  ...
  extends aqcc
{
  ...
  public aqcg(Intent paramIntent)
  {
    super(paramIntent);
  ...
  private void G()
  {
    ...
    for (;;)
    {
      ...
      if ((m == 10000) || (m == 10001) || (m == 10002) || (m == 10004) || (m == 10003))
      {
        ...
        if (localObject1 != null) {
          aptd.a((FileManagerEntity)localObject1).a(this.jdField_a_of_type_AndroidAppActivity, m, 12);
        }
      }
      else if (m == 10006)
      {
        ...
        {
          localObject2 = bakx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (FileManagerEntity)localObject2);
          ...
          apvm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, null, null, l1, (azqv)localObject2, (String)localObject1, l2, -1, 12, null, false, false);
          return;
          if (bbdx.b(this.jdField_i_of_type_JavaLangString)) {
            try
            {
              localObject1 = apug.a(new FileInfo(this.jdField_i_of_type_JavaLangString));
              if (localObject1 != null)
              {
                aptd.a((FileManagerEntity)localObject1).a(this.jdField_a_of_type_AndroidAppActivity, 12);
                return;
              }
            }
  ...
  public static int a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    case 7: 
      ...
      {
        return 10000;
      } while (apvd.b(paramFileManagerEntity.getFilePath()));
      return 10009;
    case 1: 
      return 10002;
    case 2: 
  ...
  private Drawable a()
  {
    ...
    if (bbdx.b(str))
    {
      ...
      localURLDrawableOptions.mLoadingDrawable = aywm.b();
  ...
  private String a(String paramString)
  {
    ...
    try
    {
      bbef.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), paramString, str, 600, 800);
      return str;
    }
  ...
  protected View a()
  {
    ...
    int m = actj.a(8.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
    int n = actj.a(12.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
    int i1 = actj.a(15.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
    int i2 = actj.a(16.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
    int i3 = actj.a(20.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
    int i4 = actj.a(32.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
    int i5 = actj.a(40.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
    RelativeLayout localRelativeLayout = new RelativeLayout(this.jdField_a_of_type_AndroidAppActivity);
    Object localObject1 = new RelativeLayout.LayoutParams(-2, -2);
    localRelativeLayout.setOnClickListener(new aqci(this));
    localRelativeLayout.setOnTouchListener(new aqcj(this));
    ...
    if (i6 == 2)
    {
      ...
      ((URLImageView)localObject1).setMaxHeight(bbll.a(140.0F));
    ...
    if (i6 == 1)
    {
      ...
      {
        apug.a((AsyncImageView)localObject3, (String)localObject1);
        ((TextView)localObject4).setText((CharSequence)localObject1);
        localTextView.setText(apvd.a(l1, this.jdField_a_of_type_AndroidAppActivity.getResources().getDisplayMetrics().densityDpi));
        return localRelativeLayout;
    ...
    ((RelativeLayout.LayoutParams)localObject2).bottomMargin = axlk.a(10.0F);
    localRelativeLayout.addView((View)localObject1, (ViewGroup.LayoutParams)localObject2);
  ...
  public List<RecentUser> a(List<RecentUser> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if ((localRecentUser != null) && (localRecentUser.getType() != 9501) && ((localRecentUser.getType() != 1006) || (a(aqau.h))) && (localRecentUser.getType() != 6004) && (localRecentUser.getType() != 7000)) {
        if (this.jdField_j_of_type_Boolean)
        {
          if (((localRecentUser.getType() == 1) && (!a(localRecentUser.uin))) || ((localRecentUser.getType() == 0) && (!naz.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentUser.uin, localRecentUser.getType()))) || (localRecentUser.getType() == 3000) || (-1L != apug.a(localRecentUser.getType()))) {
            localArrayList.add(localRecentUser);
          }
        }
        else if (this.l)
        {
          if (((localRecentUser.getType() == 0) && (!naz.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentUser.uin, localRecentUser.getType()))) || (localRecentUser.getType() == 1) || (localRecentUser.getType() == 3000) || (localRecentUser.getType() == 1006) || (localRecentUser.getType() == 1004) || (localRecentUser.getType() == 1000)) {
            localArrayList.add(localRecentUser);
          }
        }
        ...
        else if ((localRecentUser != null) && (!bbbr.a(localRecentUser.uin)) && (((localRecentUser.getType() == 0) && (!naz.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentUser.uin, localRecentUser.getType()))) || (localRecentUser.getType() == 3000) || ((localRecentUser.getType() == 1) && (a(c)) && (!a(localRecentUser.uin))) || (-1L != apug.a(localRecentUser.getType())))) {
          localArrayList.add(localRecentUser);
        }
      }
    }
  ...
  protected void a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataForwardFileInfo != null) {
      if (ajum.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataForwardFileInfo.b())))
      {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_JavaUtilArrayList != null)
      {
        ...
        if ((localForwardFileInfo == null) || (!ajum.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(localForwardFileInfo.b())))) {
          break;
        }
        this.jdField_a_of_type_JavaUtilSet.add(jdField_f_of_type_JavaLangInteger);
        this.jdField_a_of_type_JavaUtilSet.add(jdField_k_of_type_JavaLangInteger);
  ...
  {
    if ((this.jdField_j_of_type_Boolean) && (!this.jdField_i_of_type_Boolean) && (-1L != apug.a(paramBundle.getInt("uintype"))))
    {
      bbdj.a(this.jdField_a_of_type_AndroidAppActivity, 230, this.jdField_a_of_type_AndroidAppActivity.getString(2131697916), this.jdField_a_of_type_AndroidAppActivity.getString(2131697870), null, this.jdField_a_of_type_AndroidAppActivity.getString(2131720422), new aqch(this), null).show();
      return;
    }
  ...
  public DeviceInfo[] a(DeviceInfo[] paramArrayOfDeviceInfo)
  {
    ...
    if (m < n)
    {
      ...
      {
        int i1 = apug.a(f());
        localProductInfo = localyah.a(localDeviceInfo.productId);
        if ((i1 != 2) || (!localyah.c(localDeviceInfo.din)) || (!localyah.a(localDeviceInfo.din, 17))) {
          break label105;
        }
      }
      for (;;)
  ...
  protected boolean c()
  {
    ...
    if (f())
    {
      ...
      if (bool)
      {
        this.jdField_a_of_type_AndroidOsBundle.putString("leftBackText", ajya.a(2131704760));
        ...
        if (this.jdField_f_of_type_Boolean)
        {
          ...
          if ((QSecFramework.a().a(1003).booleanValue()) && (this.jdField_i_of_type_Boolean))
          {
            ...
            while (((Iterator)localObject).hasNext())
            {
              ...
              bcxk.a().a(4, f(), localResultRecord.a(), localResultRecord.a);
              bcxk.a().a();
            }
          }
        }
    ...
    if (m == 1008)
    {
      ...
      this.jdField_a_of_type_AndroidOsBundle.putString("leftBackText", ajya.a(2131704759));
      localIntent.addFlags(268435456);
      localIntent.addFlags(67108864);
      localIntent.putExtras(this.jdField_a_of_type_AndroidOsBundle);
      bool = a(localIntent);
      ...
      if ((QSecFramework.a().a(1003).booleanValue()) && (this.jdField_i_of_type_Boolean))
      {
        bcxk.a().a(4, f(), m, (String)localObject);
        bcxk.a().a();
      }
    }
    for (;;)
  ...
  protected int d()
  {
    ...
    {
      if (!new bgpu(3).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity, jdField_a_of_type_ComTencentMobileqqDataChatMessage, true)) {
        break label131;
      }
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataForwardFileInfo != null)
      {
        ...
        if ((localFileManagerEntity != null) && (new bgpu(3).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, localFileManagerEntity, null, true)))
        {
          jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity = null;
          m = 0;
          continue;
  ...
  protected void y()
  {
    ...
    for (;;)
    {
      ...
      localyer.a().a((String)localObject, str2, localArrayList, null);
      this.jdField_a_of_type_AndroidAppActivity.finish();
      return;
      label92:
      localObject = (yah)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51);
      if ((localObject != null) && (((yah)localObject).a(Long.parseLong(this.jdField_a_of_type_AndroidOsBundle.getString("uin")), 17)))
      {
        ((yah)localObject).a(Long.parseLong(str2), "", "", "", 0, null);
        if (m == 0)
        {
