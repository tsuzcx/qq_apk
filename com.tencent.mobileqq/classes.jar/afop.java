...
public class afop
  extends akav
{
  public afop(TroopSuspiciousFragment paramTroopSuspiciousFragment) {}
  ...
  protected void a(String paramString)
  {
    if ((TroopSuspiciousFragment.a(this.a) != null) && (TroopSuspiciousFragment.a(this.a).isShowing()))
    {
      ...
      paramString = this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getString(2131719993);
      bcpw.a(this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 1, paramString, 0).b(this.a.a());
    }
  }
  ...
  protected void a(boolean paramBoolean, String paramString1, int paramInt1, String paramString2, int paramInt2, int paramInt3, String paramString3, String paramString4, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramString1 = this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getString(2131719251);
        if (TextUtils.isEmpty(paramString3)) {
          break label590;
        }
        bcpw.a(this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 1, paramString3, 0).b(this.a.a());
      ...
      paramString3 = this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getString(2131692793);
      if (paramInt1 == 1)
      {
        paramString1 = aydb.a().a(Long.valueOf(l1));
      ...
      for (;;)
      {
        bcpw.a(this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 2, paramString1, 0).b(this.a.a());
        l2 = aydb.a().a();
        ...
        try
        {
          if ((TroopSuspiciousFragment.a(this.a) != null) && (paramString1 != null)) {
            TroopSuspiciousFragment.a(this.a).a().a(ajsf.O, 0, l2, paramString1.toByteArray());
          }
        }
        catch (Exception paramString1)
        {
        ...
        TroopSuspiciousFragment.e(this.a);
        return;
        paramString1 = this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getString(2131692781);
        continue;
        if (paramInt1 == 2)
        {
          paramString1 = this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getString(2131692791);
        }
        else
        {
  ...
  protected void b(boolean paramBoolean1, boolean paramBoolean2, List<MessageRecord> paramList)
  {
    ...
    for (;;)
    {
      ...
      {
        String str = this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getString(2131719988);
        bcpw.a(this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 1, str, 0).b(this.a.a());
      }
      if (QLog.isColorLevel()) {
      ...
      try
      {
        ...
        aydb.a().b(TroopSuspiciousFragment.a(this.a), 0);
        if (TroopSuspiciousFragment.a(this.a) != null)
        {
