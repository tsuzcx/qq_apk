...
public class lef
{
  ...
  void a(int paramInt, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      bctj.a(BaseApplicationImpl.getApplication()).a(null, "av_qua_low_memory", true, 0L, 0L, (HashMap)localObject1, "", true);
      ...
      {
        String str3 = ((ley)localObject2).d;
        localObject2 = ((ley)localObject2).c;
      ...
      bcrt.a(null, "dc02660", (String)localObject1);
      return;
    }
  ...
  public void b()
  {
    ...
    try
    {
      if (this.jdField_a_of_type_AndroidContentComponentCallbacks == null)
      {
        this.jdField_a_of_type_AndroidContentComponentCallbacks = new leg(this);
