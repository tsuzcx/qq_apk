  ...
  implements agpc
{
  ...
  public aoav(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130846926);
    this.jdField_a_of_type_Int = actj.a(207.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if ((paramView == null) || (TextUtils.isEmpty(paramView.a)))
    {
      ...
      localURLImageView.setImageDrawable(aywm.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
    ...
    for (;;)
    {
      ...
      if (((File)localObject).exists())
      {
        ...
        paramViewGroup.mLoadingDrawable = aywm.jdField_a_of_type_AndroidGraphicsDrawableDrawable;
