...
public class aoav
  implements Handler.Callback, aoah, aoar
{
  ...
  private aoau jdField_a_of_type_Aoau;
  private aoaw jdField_a_of_type_Aoaw;
  ...
  public aoav(Context paramContext)
  {
  ...
  private File a()
  {
    try
    {
      File localFile = new File(aoat.b());
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_b_of_type_Int == -1) {
      this.jdField_b_of_type_Int = 2130838677;
    }
    try
    {
      ...
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        if (this.jdField_a_of_type_Boolean)
        {
          ...
          if (this.jdField_a_of_type_Aoaq != null)
          {
            ...
            this.jdField_a_of_type_Aoaq = null;
  ...
  public void a(int paramInt1, int paramInt2, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, long paramLong)
  {
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      ...
      if ((this.jdField_c_of_type_Boolean) && (this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Aoaq != null) && (!this.j))
      {
      ...
      try
      {
        this.jdField_a_of_type_Aoau.b();
        GLES20.glViewport(0, 0, this.jdField_a_of_type_Bafx.jdField_a_of_type_Int, this.jdField_a_of_type_Bafx.jdField_b_of_type_Int);
        ...
        if (this.i)
        {
          ...
          this.jdField_a_of_type_Aoax.a(3553, this.jdField_a_of_type_Int, this.jdField_a_of_type_ArrayOfFloat, this.jdField_b_of_type_ArrayOfFloat);
          GLES20.glDisable(3042);
        }
        this.jdField_a_of_type_Aoau.a(paramLong);
        this.jdField_a_of_type_Aoau.c();
        this.jdField_a_of_type_Aoau.a();
        this.jdField_a_of_type_Aoaq.a(paramLong);
      }
  ...
  public void a(aoaw paramaoaw)
  {
    QLog.d("VideoRecordController", 2, String.format("setVideoRecordListener listener=%s", new Object[] { paramaoaw }));
    this.jdField_a_of_type_Aoaw = paramaoaw;
  }
  
  public void a(bafv parambafv, int paramInt1, int paramInt2)
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          paramInt1 = 1024000;
          this.jdField_a_of_type_Bafx = new bafx(str, 540, paramInt2 * 16, paramInt1, 1, false, 0);
          this.jdField_a_of_type_Bafx.a(EGL14.eglGetCurrentContext());
          this.jdField_a_of_type_Aoaq = new aoaq();
          this.jdField_a_of_type_Aoaq.a(this.jdField_a_of_type_Bafx, this);
          this.jdField_a_of_type_AndroidViewSurface = this.jdField_a_of_type_Aoaq.a();
          this.jdField_a_of_type_Aoau = new aoau(parambafv, this.jdField_a_of_type_AndroidViewSurface);
          this.jdField_a_of_type_ComTencentTtpicOpenapiFilterTextureRender = new TextureRender();
          this.jdField_a_of_type_Aoax = new aoax();
          a(this.jdField_a_of_type_Bafx.jdField_a_of_type_Int, this.jdField_a_of_type_Bafx.jdField_b_of_type_Int);
        ...
        catch (Exception parambafv)
        {
          QLog.e("VideoRecordController", 1, "doStartRecord fail.", parambafv);
          b(1);
          continue;
        }
        return;
  ...
  public void a(byte[] paramArrayOfByte, long paramLong)
  {
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      ...
      if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Aoaq != null) && (!this.j))
      {
        this.jdField_a_of_type_Aoaq.a(paramArrayOfByte, paramLong - l);
  ...
  public void d()
  {
    ...
    if (this.jdField_a_of_type_Aoau != null)
    {
      this.jdField_a_of_type_Aoau.d();
      this.jdField_a_of_type_Aoau = null;
    }
    ...
    {
      this.jdField_a_of_type_Aoax.a();
      this.jdField_a_of_type_Aoax = null;
    }
      ...
      do
      {
        do
        {
          do
          {
            ...
            g();
            return true;
          } while ((this.jdField_a_of_type_Aoaw == null) || (this.jdField_b_of_type_Boolean));
          this.jdField_a_of_type_Aoaw.h();
          return true;
        } while ((this.jdField_a_of_type_Aoaw == null) || (this.jdField_b_of_type_Boolean));
        this.jdField_a_of_type_Aoaw.a(paramMessage.arg1, paramMessage.arg2);
        return true;
      } while ((this.jdField_a_of_type_Aoaw == null) || (this.jdField_b_of_type_Boolean));
      this.jdField_a_of_type_Aoaw.a(paramMessage.arg1, (String)paramMessage.obj);
      return true;
    } while ((this.jdField_a_of_type_Aoaw == null) || (this.jdField_b_of_type_Boolean));
    this.jdField_a_of_type_Aoaw.c(paramMessage.arg1);
    return true;
  }
}
