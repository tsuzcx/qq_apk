...
public class uwe
{
  ...
  public static String a(AbsStructMsg paramAbsStructMsg)
  {
    ...
    if (ahsj.b(paramAbsStructMsg.mMsgActionData))
    {
      paramAbsStructMsg = ahsj.b(paramAbsStructMsg.mMsgActionData);
  ...
  public static uwe a()
  {
    if (jdField_a_of_type_Uwe == null) {
      jdField_a_of_type_Uwe = new uwe();
    }
    return jdField_a_of_type_Uwe;
  }
  ...
  public static boolean a(AbsStructMsg paramAbsStructMsg)
  {
    ...
    try
    {
      bool = usu.b(new URL(paramAbsStructMsg.mMsgUrl).getHost());
      if (!bool) {
        break label407;
      }
      return true;
  ...
  public void a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, anyz paramanyz, boolean paramBoolean)
  {
    if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      if (arrayOfByte == null)
      {
        ...
        paramMessageRecord.extraflag = 32768;
        paramQQAppInterface.getMsgCache().a(paramMessageRecord.frienduin, paramMessageRecord.istroop, paramMessageRecord.uniseq);
        paramanyz = paramMessageRecord.frienduin;
        int i = paramMessageRecord.istroop;
        long l = paramMessageRecord.uniseq;
        ((MessageHandler)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.MESSAGE_HANDLER)).notifyUI(MessageHandler.a(paramMessageRecord.istroop), false, new Object[] { paramanyz, Integer.valueOf(i), Integer.valueOf(-1), null, Long.valueOf(0L), Long.valueOf(l) });
        return;
      }
      paramBoolean = a(paramQQAppInterface, arrayOfByte, paramQQAppInterface.getCurrentAccountUin(), paramMessageRecord.frienduin, paramMessageRecord.selfuin, paramMessageRecord.istroop, paramMessageRecord.uniseq + 1L, 1035, new uwf(this, paramMessageRecord, paramQQAppInterface, paramanyz, paramBoolean));
      if (!paramBoolean) {
        break;
      }
    } while (!QLog.isColorLevel());
