...
public class aiwz
  extends aivl
  implements aios, View.OnClickListener
{
  int jdField_a_of_type_Int;
  aixt jdField_a_of_type_Aixt;
  ...
  public aiwz(FragmentActivity paramFragmentActivity)
  {
  ...
  public int a()
  {
    return this.jdField_a_of_type_Aixt.jdField_a_of_type_ArrayOfInt[this.jdField_a_of_type_Int];
  }
  ...
  {
    super.a();
    a(2131369068).setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)a(2131369099));
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
    this.jdField_a_of_type_ComTencentWidgetFadeIconImageView = ((FadeIconImageView)a(2131369067));
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsSimpleSlidingIndicator = ((SimpleSlidingIndicator)a(2131377570));
    this.jdField_a_of_type_ComTencentMobileqqWidgetQQViewPager = ((QQViewPager)a(2131364398));
    this.jdField_a_of_type_Aixt = new aixt();
    int[] arrayOfInt1 = a();
    int[] arrayOfInt2 = b();
    if ((arrayOfInt1 != null) && (arrayOfInt2 != null))
    {
      this.jdField_a_of_type_Aixt.a(a(), arrayOfInt1, arrayOfInt2);
      this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsSimpleSlidingIndicator.setTabData(this.jdField_a_of_type_Aixt.jdField_a_of_type_ArrayOfJavaLangString, arrayOfInt1);
    }
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsSimpleSlidingIndicator.setOnTabListener(this);
    this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryViewPagerAdapter = new ChatHistoryViewPagerAdapter(a(), a(), this, this.jdField_a_of_type_Aixt, this.jdField_a_of_type_JavaLangString);
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetQQViewPager.setOnPageChangeListener(new aixa(this));
    c(0);
  }
  ...
  public void a(int paramInt)
  {
    ...
    case 1602: 
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setText(2131689951);
      this.jdField_a_of_type_ComTencentWidgetFadeIconImageView.setVisibility(8);
      this.c = 1;
      return;
    }
