...
public class acif
  extends akim
{
  public acif(TroopInviteStatusFragment paramTroopInviteStatusFragment) {}
    ...
    for (;;)
    {
      synchronized (this.a)
      {
        ...
        if (paramInt1 != 6) {
          ...
          {
            paramArrayList = "1";
            bbbb.a("Grp_AIO", "invite", "in_exp", 0, 0, new String[] { paramArrayList, String.valueOf(paramInt1) });
      ...
      {
      default: 
        bcpw.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 1, ajyc.a(2131715469), 0).b(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getTitleBarHeight()).show();
        paramInt1 = paramInt4;
        break;
      case 1282: 
      case 1283: 
      ...
      case 1285: 
        ...
        paramArrayList = "2";
        continue;
        bbbb.a("Grp_AIO", "invite", "in_past", 0, 0, new String[0]);
      }
    }
  }
}
