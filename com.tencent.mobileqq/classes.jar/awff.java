  ...
  implements beki
{
  ...
  public awff(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt1, String paramString, int paramInt2, long paramLong2, long paramLong3, int paramInt3)
  {
    ...
    do
    {
      ...
      paramString = new avpd((String)localObject, (String)localObject, paramString, paramInt1, i, paramInt3, bcrg.a());
      ...
      bool = avpe.a(paramQQAppInterface, (MessageForUniteGrayTip)localObject);
  ...
  {
    bekj localbekj = ((bejx)this.a.getManager(339)).a(2, 1, paramString);
    if ((localbekj instanceof WatchTogetherSession))
    {
      localbekj.g = 3;
      localbekj.jdField_h_of_type_Int = 3;
      bekk.a(this.a, paramString, false);
      a(true, (WatchTogetherSession)localbekj, 1007, "");
    }
  }
    ...
    do
    {
      ...
      do
      {
        ...
        for (paramObject = localVideoChangePushInfo.bytes_gray_tips.get().toStringUtf8();; paramObject = null)
        {
          ...
          long l4 = ((bejx)paramQQAppInterface.getManager(339)).a(2, 1, l2);
          if (l1 >= l4) {
            break label348;
          }
          if (!QLog.isColorLevel()) {
        ...
        WatchTogetherSession localWatchTogetherSession = (WatchTogetherSession)bekk.a(2, 1, String.valueOf(l2));
        if (i == 1)
        {
          if (l3 != -1L) {
            break;
  ...
  public void a(QQAppInterface paramQQAppInterface, WatchTogetherSession paramWatchTogetherSession, int paramInt, long paramLong1, String paramString, long paramLong2, long paramLong3, TroopTips0x857.VideoChangePushInfo paramVideoChangePushInfo)
  {
    ...
    localbejx.a(2, 1, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, paramLong2);
    WatchTogetherSession localWatchTogetherSession2 = (WatchTogetherSession)localbejx.a(paramWatchTogetherSession.jdField_d_of_type_Int, paramWatchTogetherSession.jdField_e_of_type_Int, paramWatchTogetherSession.jdField_e_of_type_JavaLangString);
    ...
    if (localWatchTogetherSession2 != null)
    {
      ...
      if (paramQQAppInterface.getCurrentAccountUin().equals(String.valueOf(paramLong1)))
      {
        ...
        bekk.a(paramQQAppInterface, localWatchTogetherSession1.jdField_e_of_type_JavaLangString, true);
      }
    }
    for (;;)
    {
      ...
      {
        paramQQAppInterface = localbejx.a(2, 1, localWatchTogetherSession1.jdField_e_of_type_JavaLangString, 1003);
        ...
        localbejx.a(2, 1, localWatchTogetherSession1.jdField_e_of_type_JavaLangString, 1003);
      }
      return;
      localbejx.a(paramWatchTogetherSession.jdField_d_of_type_Int, paramWatchTogetherSession.jdField_e_of_type_Int, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, paramWatchTogetherSession);
      localWatchTogetherSession1 = paramWatchTogetherSession;
      break;
      label277:
      if (paramInt == 2) {
        bekk.a(paramQQAppInterface, localWatchTogetherSession1.jdField_e_of_type_JavaLangString, false);
      }
    }
  }
  ...
  public void a(ToServiceMsg paramToServiceMsg, aio_media.RspLatestPlayingState paramRspLatestPlayingState)
  {
    ...
    paramToServiceMsg = (WatchTogetherSession)localbejx.a(2, 1, str);
    Object localObject = paramToServiceMsg;
    if (paramToServiceMsg == null)
    {
      localObject = (WatchTogetherSession)bekk.a(2, 1, str);
      localbejx.a(2, 1, str, (bekj)localObject);
    }
    boolean bool1;
    label470:
    boolean bool2;
    if (((WatchTogetherSession)localObject).a())
    {
      ...
      {
        bhlg.h(this.a, ((WatchTogetherSession)localObject).jdField_e_of_type_JavaLangString, ((WatchTogetherSession)localObject).jdField_f_of_type_JavaLangString);
        bool2 = bool1;
        paramRspLatestPlayingState = paramToServiceMsg;
      }
    }
  ...
  {
    bejx localbejx = (bejx)this.a.getManager(339);
    Object localObject = localbejx.a(2, 1, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, paramInt);
    if ((paramBoolean) && (paramInt == 1003) && ((((bekd)localObject).jdField_a_of_type_JavaLangObject instanceof TroopTips0x857.VideoChangePushInfo)))
    {
      int i = ((bekd)localObject).jdField_a_of_type_AndroidOsBundle.getInt("action_type");
      String str = ((bekd)localObject).jdField_a_of_type_AndroidOsBundle.getString("tips");
      long l1 = ((bekd)localObject).jdField_a_of_type_AndroidOsBundle.getLong("seq");
      long l2 = ((bekd)localObject).jdField_a_of_type_AndroidOsBundle.getLong("msgSeq");
      localbejx.a(paramWatchTogetherSession, i, str, l1, l2, (TroopTips0x857.VideoChangePushInfo)((bekd)localObject).jdField_a_of_type_JavaLangObject);
      localbejx.b(paramWatchTogetherSession, i, str, l1, l2, (TroopTips0x857.VideoChangePushInfo)((bekd)localObject).jdField_a_of_type_JavaLangObject);
    }
    boolean bool1;
    label201:
    boolean bool2;
    ...
    {
      bekk.a(this.a, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, false);
      if ((paramWatchTogetherSession.g == 1) && (paramWatchTogetherSession.jdField_h_of_type_Int == 2))
      {
        ...
        bool2 = true;
        label224:
        if ((!bool1) || (!bool2) || (!awen.b(paramWatchTogetherSession.jdField_d_of_type_Int, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, paramWatchTogetherSession.jdField_e_of_type_Int))) {
          break label561;
        }
        if (QLog.isColorLevel()) {
        ...
        label360:
        awen.a(BaseApplicationImpl.context, (WatchTogetherFloatingData)localObject);
      }
    }
    for (;;)
    {
      ...
      localbejx.a(paramBoolean, paramWatchTogetherSession, paramInt, paramString);
      localbejx.b(2, 1, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, paramInt);
      return;
      bekk.a(this.a, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, true);
      break;
      label540:
      bool1 = false;
      break label201;
      ...
      break label360;
      label561:
      if (awen.b(paramWatchTogetherSession.jdField_d_of_type_Int, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, paramWatchTogetherSession.jdField_e_of_type_Int))
      {
        if (QLog.isColorLevel()) {
          QLog.d("WatchTogetherParser", 1, "isSameFloatingInfo but param error isSupportRoomType=" + bool1 + " isUrlValid=" + bool2);
        }
        awen.a(false, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, paramWatchTogetherSession.jdField_e_of_type_Int, false);
      }
    }
  }
}
