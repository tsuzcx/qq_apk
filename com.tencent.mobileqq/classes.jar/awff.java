  ...
  extends Handler
{
  ...
  public awff(MusicPlayerActivity paramMusicPlayerActivity)
  {
  ...
  private void a(int[] paramArrayOfInt, boolean paramBoolean)
  {
    ...
    if ((paramArrayOfInt != null) && (paramArrayOfInt.length >= 2) && (localMusicPlayerActivity != null))
    {
      ...
      ((ImageView)localMusicPlayerActivity.findViewById(2131371536)).setImageDrawable(localGradientDrawable);
      localMusicPlayerActivity.findViewById(2131371539).setBackgroundColor(i);
      i = paramArrayOfInt[1];
      ...
      MusicPlayerActivity.a(localMusicPlayerActivity, 2130841814, i);
      MusicPlayerActivity.a(localMusicPlayerActivity, 2130841815, i);
      MusicPlayerActivity.a(localMusicPlayerActivity, 2130840119, i);
      if (paramBoolean)
      {
        MusicPlayerActivity.a(localMusicPlayerActivity, 2130841342, i);
        MusicPlayerActivity.a(localMusicPlayerActivity, 2130841344, i);
        MusicPlayerActivity.a(localMusicPlayerActivity, 2130841343, i);
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
          ...
          do
          {
            do
            {
              do
              {
                do
                {
                  ...
                  if ((paramMessage instanceof Integer))
                  {
                    ...
                    MusicPlayerActivity.a((MusicPlayerActivity)localObject1, 2130841814, j);
                    MusicPlayerActivity.a((MusicPlayerActivity)localObject1, 2130841815, j);
                  }
                  if ((i == 3) || (i == 4)) {
                    MusicPlayerActivity.b((MusicPlayerActivity)localObject1).setImageResource(2130841815);
                  }
                  for (;;)
                  {
                    MusicPlayerActivity.a((MusicPlayerActivity)localObject1);
                    return;
                    MusicPlayerActivity.b((MusicPlayerActivity)localObject1).setImageResource(2130841814);
                  }
                } while (!(paramMessage.obj instanceof awfh));
                localObject2 = (awfh)paramMessage.obj;
                ...
                if (MusicPlayerActivity.a((MusicPlayerActivity)localObject1).isSelected()) {
                  MusicPlayerActivity.a((MusicPlayerActivity)localObject1).setImageResource(2130841343);
                }
                for (;;)
                {
                  MusicPlayerActivity.c((MusicPlayerActivity)localObject1).setVisibility(i);
                  MusicPlayerActivity.c((MusicPlayerActivity)localObject1).setImageResource(2130841342);
                  ...
                  return;
                  MusicPlayerActivity.a((MusicPlayerActivity)localObject1).setImageResource(2130841344);
                }
              ...
              for (;;)
              {
                ...
                paramMessage = (URLImageView)((MusicPlayerActivity)localObject1).findViewById(2131371545);
                localURLDrawable = URLDrawable.getDrawable((String)localObject3, URLDrawable.URLDrawableOptions.obtain());
                localObject4 = awen.a((String)localObject3);
              ...
              for (;;)
              {
                ...
                MusicPlayerActivity.b((MusicPlayerActivity)localObject1).setText(2131694010);
                return;
                localObject3 = new awen((String)localObject3, MusicPlayerActivity.a((MusicPlayerActivity)localObject1), Boolean.valueOf(bool1));
                if (localURLDrawable.getStatus() == 1)
                {
                  localObject4 = localURLDrawable.getCurrDrawable();
                  if ((localObject4 instanceof RegionDrawable)) {
                    ((awen)localObject3).run(null, ((RegionDrawable)localObject4).getBitmap());
                  }
                }
                else
                {
              ...
              MusicPlayerActivity.b((MusicPlayerActivity)localObject1).setText(((MusicPlayerActivity)localObject1).getString(2131694008, new Object[] { paramMessage }));
              return;
              MusicPlayerActivity.a((MusicPlayerActivity)localObject1);
              return;
            } while (!(paramMessage.obj instanceof View));
            localObject2 = (View)paramMessage.obj;
            paramMessage = bjvq.a((Context)localObject1).b(3).a(((MusicPlayerActivity)localObject1).getString(paramMessage.arg1)).a(paramMessage.arg2);
            paramMessage.c(49);
            paramMessage = new bjvs(paramMessage).b(Color.argb(13, 255, 255, 255)).a(5).a();
      ...
      } while (!(localObject1 instanceof awfh));
      localObject1 = (awfh)localObject1;
    ...
    WXShareHelper.getInstance().shareMusic(String.valueOf(l), ((awfh)localObject1).a, (Bitmap)localObject2, ((awfh)localObject1).b, ((awfh)localObject1).d, i, ((awfh)localObject1).e);
  }
}
