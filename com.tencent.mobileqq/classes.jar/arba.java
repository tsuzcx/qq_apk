...
public class arba
  extends aqyq<CustomEmotionData>
{
  private boolean a;
  
  public arba(QQAppInterface paramQQAppInterface)
  {
  ...
  private CustomEmotionData a(String paramString1, String paramString2, String paramString3, int paramInt, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          localarbi = new arbi(paramString1);
          localObject = localCustomEmotionData;
        } while (TextUtils.isEmpty(localarbi.a));
        str2 = localarbi.c;
        localObject = localCustomEmotionData;
      } while (str2 == null);
      localObject = localCustomEmotionData;
    ...
    if (str2.equals("1"))
    {
      ...
      localCustomEmotionData.emoPath = localarbi.e;
      localCustomEmotionData.eId = localarbi.f;
      localCustomEmotionData.resid = paramString1;
      localCustomEmotionData.RomaingType = paramString3;
      localCustomEmotionData.url = aray.a(paramString1, paramString2, str1);
    ...
    for (;;)
    {
      ...
      localCustomEmotionData.uin = str1;
      localCustomEmotionData.emoPath = aray.a(paramString1);
      localCustomEmotionData.resid = paramString1;
      localCustomEmotionData.md5 = localarbi.d;
      localCustomEmotionData.url = aray.a(paramString1, paramString2, str1);
      localCustomEmotionData.RomaingType = paramString3;
      localCustomEmotionData.emoId = paramInt;
      break;
      ...
      {
        localCustomEmotionData.eId = localarbi.e;
        if (QLog.isColorLevel()) {
  ...
  private List<CustomEmotionData> a(List<CustomEmotionData> paramList)
  {
    ...
    if (paramList.size() > aray.b) {
      localObject = paramList.subList(0, aray.b);
    }
    int i = 0;
        ...
        for (;;)
        {
          ...
          if (paramList2 != null)
          {
            ...
            if ((TextUtils.isEmpty(localCustomEmotionData2.url)) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null))
            {
              ...
              localCustomEmotionData2.url = aray.a(str, paramString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
            }
  ...
  {
    return (arbb)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(103);
  }
  ...
  public CustomEmotionData a(List<CustomEmotionData> paramList, String paramString)
  {
    ...
    for (;;)
    {
      label131:
      return paramList;
      Object localObject = new arbi(paramString);
      if (!((arbi)localObject).a())
      {
        if (!QLog.isColorLevel()) {
          break;
        }
      ...
      {
        str = ((arbi)localObject).e;
        localObject = ((arbi)localObject).f;
      ...
      localObject = ((arbi)localObject).d;
      if (TextUtils.isEmpty((CharSequence)localObject)) {
        break label98;
      }
  ...
  public EmoticonInfo a(CustomEmotionData paramCustomEmotionData)
  {
    if (paramCustomEmotionData.isMarkFace)
    {
      ...
      ((PicEmoticonInfo)localObject1).emoticon = ((avsq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(14)).a(str, (String)localObject2);
    ...
    Object localObject1 = ((arce)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(141)).a();
  ...
  public String a(CustomEmotionData paramCustomEmotionData)
  {
    ...
    do
    {
      ...
      localObject2 = (arce)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(141);
      if ((localObject2 != null) && (((arce)localObject2).a(paramCustomEmotionData)))
      {
        ...
        if (!TextUtils.isEmpty(paramCustomEmotionData.md5)) {
          return ((arce)localObject2).a(paramCustomEmotionData.md5);
        }
        if (!TextUtils.isEmpty(paramCustomEmotionData.resid)) {
          return (String)localObject1 + anws.a(paramCustomEmotionData.resid);
        }
      ...
      if ((paramCustomEmotionData.url != null) && (paramCustomEmotionData.url.contains("qto_"))) {
        return (String)localObject1 + amsz.a(paramCustomEmotionData.url);
      }
      if (TextUtils.isEmpty(amsz.a(paramCustomEmotionData.eId))) {
        break;
      }
  ...
  public List<CustomEmotionData> a(List<String> paramList1, List<String> paramList2, String paramString, List<Integer> paramList)
  {
    ...
    paramString = (amrm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(72);
  ...
  public boolean a(CustomEmotionData paramCustomEmotionData, int paramInt)
  {
    ...
    for (Object localObject = "isUpdate";; localObject = "overflow_downloaded")
    {
      ...
      localObject = (arbb)a();
      if (localObject != null) {
        ((arbb)localObject).d(paramCustomEmotionData);
      }
      return true;
    }
  }
  ...
  {
    bfzg.a("AIO_EmoticonPanel_Refresh", null);
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      catch (OutOfMemoryError localOutOfMemoryError)
      {
        ...
        bfzg.a(null, "AIO_EmoticonPanel_Refresh");
      }
      if (QLog.isColorLevel()) {
  ...
  {
    Map localMap = ((arce)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(141)).a();
    if (QLog.isColorLevel()) {
      ...
      try
      {
        ...
        if (i >= 0)
        {
          ...
          else if (localCustomEmotionData.isMarkFace)
          {
            ...
            ((PicEmoticonInfo)localObject).emoticon = ((avsq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(14)).a(str2, str1);
  ...
  public List<CustomEmotionData> d()
  {
    ...
    //   13: astore 8
    //   15: aload_0
    //   16: getfield 64	arba:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   19: ifnonnull +10 -> 29
    //   22: aload 8
    //   24: astore 9
    //   26: aload 9
    //   28: areturn
    //   29: aload_0
    //   30: getfield 64	arba:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   33: invokevirtual 502	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lcom/tencent/mobileqq/data/QQEntityManagerFactory;
    //   36: invokevirtual 508	com/tencent/mobileqq/data/QQEntityManagerFactory:createEntityManager	()Lcom/tencent/mobileqq/persistence/EntityManager;
    //   39: astore 11
    //   41: aload 11
    //   43: ifnull +379 -> 422
    //   46: aload 11
    //   48: aload_0
    //   49: invokevirtual 510	arba:a	()Ljava/lang/Class;
    //   52: iconst_0
    //   53: aconst_null
    //   54: aconst_null
    //   55: aconst_null
    ...
    //   57: aconst_null
    //   58: aconst_null
    //   59: invokevirtual 516	com/tencent/mobileqq/persistence/EntityManager:query	(Ljava/lang/Class;ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    //   62: astore 9
    //   64: ldc_w 518
    //   67: aload_0
    //   68: getfield 64	arba:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   71: invokevirtual 521	com/tencent/mobileqq/app/QQAppInterface:getCurrentUin	()Ljava/lang/String;
    //   74: invokestatic 524	anws:a	(Ljava/lang/String;Ljava/lang/String;)I
    //   77: iconst_1
    //   78: if_icmpge +335 -> 413
    //   81: aload 11
    //   83: invokevirtual 528	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   86: astore 10
    //   88: aload 9
    ...
    //   144: getstatic 361	com/tencent/mobileqq/app/AppConstants:SDCARD_IMG_FAVORITE	Ljava/lang/String;
    ...
    //   181: getstatic 361	com/tencent/mobileqq/app/AppConstants:SDCARD_IMG_FAVORITE	Ljava/lang/String;
    ...
    //   192: invokestatic 368	anws:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   213: istore 4
    //   215: aload 10
    //   217: invokevirtual 533	com/tencent/mobileqq/persistence/EntityTransaction:begin	()V
    //   220: iconst_1
    //   221: istore_3
    //   222: iload_3
    //   223: istore_2
    ...
    //   227: aload 11
    //   229: aload 8
    //   231: invokevirtual 537	com/tencent/mobileqq/persistence/EntityManager:update	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   234: pop
    //   235: iload_3
    //   236: istore_1
    //   237: iload 5
    ...
    //   274: getstatic 361	com/tencent/mobileqq/app/AppConstants:SDCARD_IMG_FAVORITE	Ljava/lang/String;
    ...
    //   297: invokevirtual 542	java/lang/String:matches	(Ljava/lang/String;)Z
    //   300: ifeq +399 -> 699
    //   303: iload_1
    //   304: istore_2
    //   305: iload_1
    ...
    //   327: aload 12
    //   329: aload 12
    //   331: invokestatic 368	anws:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   349: istore 4
    //   351: aload 10
    //   353: invokevirtual 533	com/tencent/mobileqq/persistence/EntityTransaction:begin	()V
    //   356: iconst_1
    //   357: istore_3
    //   358: iload_3
    //   359: istore_2
    ...
    //   363: aload 11
    //   365: aload 8
    //   367: invokevirtual 537	com/tencent/mobileqq/persistence/EntityManager:update	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   370: pop
    //   371: iload_3
    //   372: istore_1
    //   373: goto -136 -> 237
    ...
    //   383: istore 4
    //   385: aload 10
    //   387: invokevirtual 545	com/tencent/mobileqq/persistence/EntityTransaction:commit	()V
    //   390: iload_1
    //   391: ifeq +8 -> 399
    //   394: aload 10
    //   396: invokevirtual 548	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   399: ldc_w 518
    //   402: aload_0
    //   403: getfield 64	arba:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   406: invokevirtual 521	com/tencent/mobileqq/app/QQAppInterface:getCurrentUin	()Ljava/lang/String;
    //   409: iconst_1
    //   410: invokestatic 551	anws:a	(Ljava/lang/String;Ljava/lang/String;I)V
    //   413: aload 11
    //   415: invokevirtual 554	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   418: aload 9
    //   420: astore 8
    //   422: iload 7
    //   424: istore_2
    ...
    //   519: aload 11
    //   521: iconst_1
    //   522: invokevirtual 496	arba:b	(Lcom/tencent/mobileqq/data/CustomEmotionBase;I)V
    //   525: goto -61 -> 464
    //   528: astore 8
    //   530: iconst_0
    //   531: istore 4
    ...
    //   535: istore_2
    //   536: aload 8
    //   538: invokevirtual 557	java/lang/Exception:printStackTrace	()V
    //   541: iload 4
    //   543: ifeq -144 -> 399
    //   546: aload 10
    //   548: invokevirtual 548	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   551: goto -152 -> 399
    //   554: astore 8
    //   556: iconst_0
    //   557: istore_2
    ...
    //   559: ifeq +8 -> 567
    //   562: aload 10
    //   564: invokevirtual 548	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   567: aload 8
    //   569: athrow
    //   570: aload 11
    ...
    //   599: pop
    //   600: aload_0
    //   601: invokevirtual 559	arba:b	()V
    //   604: iconst_1
    //   605: istore_1
    //   606: goto -88 -> 518
    //   609: aload_0
    //   610: invokevirtual 561	arba:a	()V
    //   613: iload_2
    //   614: ifeq +10 -> 624
    //   617: aload_0
    //   618: aload 8
    //   620: iconst_2
    //   621: invokevirtual 425	arba:a	(Ljava/util/List;I)V
    //   624: aload 8
