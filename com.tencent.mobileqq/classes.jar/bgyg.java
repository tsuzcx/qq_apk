...
public final class bgyg
{
  ...
  public static bgyk a;
  private static final String jdField_a_of_type_JavaLangString;
  public static HashMap<String, bgyj> a;
  private static List<SoftReference<bgyi>> jdField_a_of_type_JavaUtilList;
  ...
  static
  {
    ...
    ((StringBuilder)localObject).append("uin=[uin]").append("&client=androidQQ").append("&version=").append("8.4.1.4680").append("&platformId=2").append("&device=").append(Build.DEVICE).append("&system=").append(Build.VERSION.RELEASE).append("&density=[density]");
    ...
    ((StringBuilder)localObject).append("?uin=[uin]").append("&client=androidQQ").append("&version=").append("8.4.1.4680").append("&platformId=2").append("&device=").append(Build.DEVICE).append("&system=").append(Build.VERSION.RELEASE).append("&density=[density]").append("&_bid=182").append("&_wv=3");
    ...
    ((StringBuilder)localObject).append("?uin=[uin]").append("&client=androidQQ").append("&version=").append("8.4.1.4680").append("&platformId=2").append("&device=").append(Build.DEVICE).append("&system=").append(Build.VERSION.RELEASE).append("&density=[density]").append("&adtag=mvip.gxh.android.search").append("&_bid=2229").append("&_wv=1027");
  ...
  public static String a(String paramString, ImageView paramImageView)
  {
    ...
    {
      jdField_a_of_type_JavaUtilList.add(new SoftReference(new bgyi(paramString, paramImageView)));
      paramImageView = localObject;
      if (!jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) {
        paramImageView = a(paramString, jdField_a_of_type_Bgyk);
      }
  ...
  public static String a(String paramString, bgyk parambgyk)
  {
    ...
    for (Object localObject2 = localObject1;; localObject2 = null)
    {
      ...
      if (TextUtils.isEmpty(localObject2)) {
        if (!jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
        {
          ...
          ThreadManager.post(new IndividuationUrlHelper.2(parambgyk), 5, null, true);
        }
      }
      for (;;)
      {
        parambgyk = (String)jdField_b_of_type_JavaUtilMap.get(paramString);
        localObject1 = parambgyk;
        if (QLog.isColorLevel())
        {
          QLog.d("IndividuationUrlHelper", 2, "getUrl, from default, id=" + paramString + ", url=" + parambgyk);
          localObject1 = parambgyk;
        }
        parambgyk = (bgyk)localObject1;
