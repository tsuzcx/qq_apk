...
public class anyv
  extends QIPCModule
{
  private static volatile anyv a;
  
  public anyv(String paramString)
  {
    super(paramString);
  }
  ...
  private void a(QQAppInterface paramQQAppInterface, Bundle paramBundle)
  {
    ...
    paramBundle = (anyw)paramQQAppInterface.getManager(51);
    if (j == 1) {
      if (bool)
      {
        paramBundle.e(str);
        ...
        amjp.a(str, "1", paramQQAppInterface);
      }
    }
    do
    {
  ...
  private EIPCResult c(QQAppInterface paramQQAppInterface, Bundle paramBundle)
  {
    ...
    paramBundle = ((anyw)paramQQAppInterface.getManager(51)).a(str1);
    Bundle localBundle = new Bundle();
    ...
    paramBundle = bhsj.a(localSharedPreferences, str2, null);
    ...
    if (paramQQAppInterface.add(str1))
    {
      ...
      bhsj.a(paramBundle, str2, paramQQAppInterface.toArray());
      paramBundle.commit();
    }
    for (;;)
    {
  ...
  {
    paramBundle = paramBundle.getString("KEY_UIN");
    ExtensionInfo localExtensionInfo = ((anyw)paramQQAppInterface.getManager(51)).a(paramBundle, false);
    if (localExtensionInfo != null) {}
    for (int i = localExtensionInfo.friendRingId;; i = 0)
    {
      paramQQAppInterface = aqqr.a(paramQQAppInterface).a(i, paramBundle, 0);
  ...
  private EIPCResult e(QQAppInterface paramQQAppInterface, Bundle paramBundle)
  {
    ...
    if ((paramBundle != null) && (!paramBundle.isEmpty())) {
      ((aohx)paramQQAppInterface.a(26)).notifyUI(5, true, paramBundle);
    }
