...
{
  private static ajjg jdField_a_of_type_Ajjg;
  private long jdField_a_of_type_Long;
  private ajji jdField_a_of_type_Ajji;
  ...
  {
    if (jdField_a_of_type_Ajjg == null) {}
    try
    {
      if (jdField_a_of_type_Ajjg == null) {
        jdField_a_of_type_Ajjg = new ajjg();
      }
      return jdField_a_of_type_Ajjg;
    }
    finally {}
  }
  ...
  public static void a(int paramInt)
  {
    if ((BaseApplicationImpl.getApplication().getRuntime() instanceof QQAppInterface)) {
      ((ajje)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getBusinessHandler(147)).a(Integer.valueOf(paramInt));
    }
  }
  
  private void a(int paramInt, Bundle paramBundle)
  {
    MiniArkShareAsyncManager.performUploadArkShareImage(paramBundle.getString("preview"), new ajjh(this, paramBundle, paramInt));
  }
  
  private void a(Bundle paramBundle)
  {
    if (this.c != null) {
      QIPCServerHelper.getInstance().callClient(ajji.a(this.c), ajji.b(this.c), "actionMiniCreateUpdatableMsgCallback", paramBundle, null);
    }
  }
  ...
  private void b(int paramInt, Bundle paramBundle)
  {
    ...
    {
      ajji localajji = this.jdField_a_of_type_Ajji;
      if ((localObject == null) || (localajji == null)) {
        break;
      }
      if (paramBundle == null) {
      ...
      for (;;)
      {
        ...
        for (int i = ((QQMessageFacade)localObject).getMiniUnreadMsgsNum();; i = 0)
        {
          ...
          paramBundle.putInt("param_proc_badge_count", i);
          QIPCServerHelper.getInstance().callClient(ajji.a(localajji), ajji.b(localajji), "action_sync_unreadcount", paramBundle, null);
          if (this.c != null) {
            QIPCServerHelper.getInstance().callClient(ajji.a(this.c), ajji.b(this.c), "action_sync_unreadcount", paramBundle, null);
          }
  ...
  {
    if (this.c != null) {
      QIPCServerHelper.getInstance().callClient(ajji.a(this.c), ajji.b(this.c), "actionMiniReportEvent", paramBundle, null);
    }
  }
  
  private void c(Bundle paramBundle)
  {
    if (this.jdField_a_of_type_Ajji != null)
    {
      ...
      if ((str1 != null) && (str1.equals(this.jdField_a_of_type_Ajji.a())) && (str2 != null) && (str2.equals(this.jdField_a_of_type_Ajji.b()))) {
  ...
  private void d(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_Ajji = new ajji(str1, str2);
    this.b = new ajji(str1, "aio_client_module");
    if (("mini_app_client_module".equals(str2) | "mini_sdk_client_module".equals(str2))) {
      this.c = new ajji(str1, str2);
    }
    this.jdField_a_of_type_Ajji.a = i;
  ...
  {
    if (this.c != null) {
      QIPCServerHelper.getInstance().callClient(ajji.a(this.c), ajji.b(this.c), "actionMiniDirectShareFailCallback", null, null);
    }
  }
  ...
  private void e(Bundle paramBundle)
  {
    ...
    {
      ajji localajji = this.b;
      if ((paramBundle == null) || (localajji == null)) {
        break;
      }
      ...
      for (int i = paramBundle.getSingleConUnreadCount(j, str);; i = 0)
      {
        ...
        QIPCServerHelper.getInstance().callClient(ajji.a(localajji), ajji.b(localajji), "action_sync_single_con_unread_count", paramBundle, null);
        if (this.c == null) {
          break;
        }
        QIPCServerHelper.getInstance().callClient(ajji.a(this.c), ajji.b(this.c), "action_sync_single_con_unread_count", paramBundle, null);
        return;
      }
    }
  }
  ...
  {
    if (this.c != null) {
      QIPCServerHelper.getInstance().callClient(ajji.a(this.c), ajji.b(this.c), "actionMiniDirectShareSucCallback", null, null);
    }
  }
  ...
  {
    if (this.c != null) {
      QIPCServerHelper.getInstance().callClient(ajji.a(this.c), ajji.b(this.c), "actionMiniShareSucCallback", null, null);
    }
  }
  ...
  {
    if (this.c != null) {
      QIPCServerHelper.getInstance().callClient(ajji.a(this.c), ajji.b(this.c), "actionMiniShareFailCallback", null, null);
    }
  }
  ...
  private void i()
  {
    ...
    for (Object localObject = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();; localObject = null)
    {
      ...
      for (int i = ((QQMessageFacade)localObject).getMiniUnreadMsgsNum();; i = 0)
      {
        ...
        QIPCServerHelper.getInstance().callClient(ajji.a(localajji), ajji.b(localajji), "action_sync_unreadcount", (Bundle)localObject, null);
        if (this.c == null) {
          break;
        }
        QIPCServerHelper.getInstance().callClient(ajji.a(this.c), ajji.b(this.c), "action_sync_unreadcount", (Bundle)localObject, null);
        return;
      }
    }
  }
  ...
  private void j()
  {
    ...
    for (Object localObject = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();; localObject = null)
    {
      ...
      if ((localObject != null) && (localajji != null))
      {
        ...
        QIPCServerHelper.getInstance().callClient(ajji.a(localajji), ajji.b(localajji), "action_mini_msgtab_notify_to_conversation", (Bundle)localObject, null);
      }
      return;
    }
  }
    ...
    for (Object localObject = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();; localObject = null)
    {
      ...
      for (int i = localQQMessageFacade.getMiniUnreadMsgsNum();; i = 0)
      {
        if ((localObject != null) && (localajji != null))
        {
          ...
          QIPCServerHelper.getInstance().callClient(ajji.a(localajji), ajji.b(localajji), "action_msg_tab_back_refresh", (Bundle)localObject, null);
        }
        return;
      }
    }
    ...
    for (Object localObject = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();; localObject = null)
    {
      ...
      for (int i = localQQMessageFacade.getMiniUnreadMsgsNum();; i = 0)
      {
        if ((localObject != null) && (localajji != null))
        {
          ...
          QIPCServerHelper.getInstance().callClient(ajji.a(localajji), ajji.b(localajji), "action_get_unread", (Bundle)localObject, null);
        }
        return;
      }
    }
  ...
  public ajji a()
  {
    return this.jdField_a_of_type_Ajji;
  }
  ...
  public void d()
  {
    ...
    for (Object localObject = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();; localObject = null)
    {
      ...
      if ((localObject != null) && (localajji != null))
      {
        ...
        QIPCServerHelper.getInstance().callClient(ajji.a(localajji), ajji.b(localajji), "action_mini_aio_to_aio", (Bundle)localObject, null);
      }
      return;
    }
  }
