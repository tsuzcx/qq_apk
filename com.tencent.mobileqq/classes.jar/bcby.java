  ...
  implements bcbx
{
  ...
  public static bcby a()
  {
    if (jdField_a_of_type_Bcby == null) {
      jdField_a_of_type_Bcby = new bcby();
    }
    return jdField_a_of_type_Bcby;
  }
  ...
  protected String a(int paramInt)
  {
    ...
    catch (JSONException localJSONException)
    {
      for (;;)
      {
        bcds.c("DownloadCallbackWebImpl", "getCallBackJsonObject >>> ", localJSONException);
      }
    }
  }
  ...
  protected String a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, String paramString3, int paramInt4, int paramInt5)
  {
    ...
    catch (JSONException paramString1)
    {
      for (;;)
      {
        bcds.c("DownloadCallbackWebImpl", "getCallBackJsonObject >>> ", paramString1);
      }
    }
  }
  ...
  public JSONObject a(DownloadInfo paramDownloadInfo, int paramInt)
  {
    ...
    {
      bcds.c("DownloadCallbackWebImpl", "onNetworkConnect " + paramDownloadInfo.getMessage(), paramDownloadInfo);
    }
    return localJSONObject;
  }
  ...
  {
    bccc localbccc = bccc.a();
    for (;;)
    {
      int i;
      try
      {
        int j = localbccc.a().size();
        i = 0;
        if (i < j)
        {
          Object localObject = (bcex)localbccc.a().get(i);
          WebView localWebView = ((bcex)localObject).getWebview();
          if (localWebView != null) {
            if (TextUtils.isEmpty(((bcex)localObject).getJsCallbackMethod()))
            {
              ...
              bcds.a("DownloadCallbackWebImpl", " commonJsCallBack >>> " + (String)localObject);
              this.jdField_a_of_type_AndroidOsHandler.post(new DownloadCallbackWebImpl.1(this, localWebView, (String)localObject));
            }
            else
            {
              localObject = "javascript:" + ((bcex)localObject).getJsCallbackMethod() + "(" + paramString + ")";
              continue;
            }
          }
        }
      ...
      {
        bcds.c("DownloadCallbackWebImpl", "doJsCallback >>> ", paramString);
      }
      i += 1;
    }
  }
