  ...
  implements bcbx
{
  ...
  public bcby(Context paramContext, Activity paramActivity, Intent paramIntent, AppInterface paramAppInterface)
  {
  ...
  protected void adjustLayout(boolean paramBoolean, bcca parambcca)
  {
    if (QLog.isColorLevel()) {
    ...
    if (paramBoolean)
    {
      localLayoutParams = (RelativeLayout.LayoutParams)parambcca.b.getLayoutParams();
      localLayoutParams.topMargin = i;
      parambcca.b.setLayoutParams(localLayoutParams);
      localLayoutParams = (RelativeLayout.LayoutParams)parambcca.a.getLayoutParams();
      localLayoutParams.topMargin = 0;
      localLayoutParams.addRule(3, 0);
      parambcca.a.setLayoutParams(localLayoutParams);
      return;
    }
    RelativeLayout.LayoutParams localLayoutParams = (RelativeLayout.LayoutParams)parambcca.b.getLayoutParams();
    localLayoutParams.topMargin = i;
    parambcca.b.setLayoutParams(localLayoutParams);
    localLayoutParams = (RelativeLayout.LayoutParams)parambcca.a.getLayoutParams();
    localLayoutParams.topMargin = (i + baxn.a(this.mContext, 50.0F));
    parambcca.a.setLayoutParams(localLayoutParams);
  }
  ...
  public void buildTitleBar()
  {
    ...
    this.mTitleBar = new bcgu(this.mInActivity, this.mWebview, this.titleContainer);
    this.titleContainer.setBackgroundResource(2130849032);
    ...
    this.mTitleBar.a(new bcbz(this));
  }
  ...
  protected void onImmersive(boolean paramBoolean, bcca parambcca)
  {
    if (QLog.isColorLevel()) {
  ...
  protected final void setTittlebarImmersive(boolean paramBoolean, bcca parambcca)
  {
    if (QLog.isColorLevel()) {
      QLog.d("WebViewBaseBuilder", 2, "setTittlebarImmersive");
    }
    adjustLayout(paramBoolean, parambcca);
    onImmersive(paramBoolean, parambcca);
  }
}
