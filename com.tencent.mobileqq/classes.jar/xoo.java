...
public class xoo
{
  ...
  public static xop a(Object paramObject)
  {
    int k = 1;
    String str1 = "1";
    String str3 = "";
    ...
    for (int i = 2;; i = 1)
    {
      ...
      j = 1;
      if (bdje.a(paramObject))
      {
        paramObject = "weishi://camera?logsour=3006";
        i = k;
        label105:
        localxop = new xop();
        localxop.jdField_a_of_type_JavaLangString = str1;
        localxop.jdField_b_of_type_JavaLangString = str3;
        localxop.jdField_c_of_type_JavaLangString = str2;
        localxop.jdField_a_of_type_Int = i;
        localxop.e = str4;
        localxop.f = paramObject;
        localxop.g = ((String)localObject);
        localxop.jdField_b_of_type_Int = j;
        if (i == 2)
        {
          localxop.jdField_d_of_type_JavaLangString = "DOV";
          return localxop;
          str1 = "11";
          str3 = ((QIMFilterCategoryItem)localObject).jdField_b_of_type_JavaLangString;
          paramObject = ((QIMFilterCategoryItem)localObject).h;
        ...
        for (i = 2;; i = 1)
        {
          ...
          if ((paramObject instanceof QIMBeautyItem))
          {
            ...
            for (i = 2;; i = 1)
            {
              ...
              break;
              localxop.jdField_d_of_type_JavaLangString = alpo.a(2131717285);
              return localxop;
              break label105;
            }
          }
  ...
  public static xqr a(Context paramContext, Object paramObject)
  {
    xop localxop = a(paramObject);
    if (localxop == null) {
      return null;
    }
    String str1 = localxop.jdField_a_of_type_JavaLangString;
    String str2 = localxop.jdField_b_of_type_JavaLangString;
    String str3 = localxop.f;
    int j = localxop.jdField_a_of_type_Int;
    String str4 = localxop.e;
    int k = localxop.jdField_b_of_type_Int;
    int i;
    int m;
    ...
    for (;;)
    {
      ...
      if (j == 2)
      {
        if (bdem.a(paramContext, "com.tencent.qim"))
        {
          azmj.b(null, "dc00899", "grp_story", "", "app_share", "clk_entry", i, 1, str4, "dov", "", "");
          bdem.a(paramContext, "com.tencent.qim", null);
        }
        for (;;)
        {
          return null;
          ...
          break label117;
          azmj.b(null, "dc00899", "grp_story", "", "app_share", "clk_entry", i, 0, str4, "dov", "", "");
          via.a(paramContext);
        }
      }
      label174:
      ...
      {
        azmj.b(null, "dc00898", "", "", "weishi_share_shoot", (String)localObject, k, 0, "", "", "", "");
        azmj.b(null, "dc00899", "grp_story", "", "weishi_share", localxop.g, 0, 0, str1, str2, "", "");
        if (!a(paramContext)) {
          break;
        }
        azmj.b(null, "dc00899", "grp_story", "", "app_share", "clk_entry", i, 1, str4, "weishi", "", "");
        azmj.b(null, "dc00899", "grp_story", "", "weishi_share", "clk_ws", 0, 1, str1, str2, "", "");
      ...
      azmj.b(null, "dc00899", "grp_story", "", "app_share", "clk_entry", i, 0, str4, "weishi", "", "");
      localObject = localxop.jdField_c_of_type_JavaLangString;
      azmj.b(null, "dc00899", "grp_story", "", "weishi_share", "clk_ws", 0, 2, str1, str2, "", "");
      paramContext = new xqr(paramContext, 2131756014, paramObject);
  ...
  {
    if (!xne.b(paramContext))
    {
      QQToast.a(paramContext, alpo.a(2131717287), 0).a();
      return;
    }
    bnky.a().a();
    ...
    {
      wsv.d("WeishiGuideUtils", "get null info");
      return;
    }
  ...
  public static void a(Object paramObject)
  {
    ...
    azmj.b(null, "dc00898", "", "", "weishi_share_shoot", "story_entry_exp", j, 0, "", "", "", "");
  }
  ...
  public static boolean a(Context paramContext)
  {
    ...
    return bhpe.a(paramContext, "com.tencent.weishi");
  }
}
