...
public class zuw
{
  public static void a(Activity paramActivity)
  {
    ...
    Object localObject = alof.aX + "shortvideo/" + System.currentTimeMillis() + ".mp4";
      ...
      do
      {
        ...
        if ((localMessageRecord instanceof MessageForDevShortVideo))
        {
          ...
          if (!paramSession.bSend) {
            ...
            {
              Object localObject3 = new zuv();
              ((zuv)localObject3).a = paramSession.strFilePathSrc;
              ((zuv)localObject3).a();
              ((MessageForDevShortVideo)localObject2).md5 = ((zuv)localObject3).jdField_c_of_type_JavaLangString;
              ((MessageForDevShortVideo)localObject2).videoFileTime = ((int)(((zuv)localObject3).jdField_b_of_type_Long / 1000L));
              ((MessageForDevShortVideo)localObject2).thumbWidth = ((zuv)localObject3).jdField_b_of_type_Int;
              ((MessageForDevShortVideo)localObject2).thumbHeight = ((zuv)localObject3).jdField_c_of_type_Int;
              ((MessageForDevShortVideo)localObject2).thumbMD5 = ((zuv)localObject3).e;
              if (!paramBoolean) {
                break label282;
              }
              ...
              bdhb.b(paramSession.strFilePathSrc, (String)localObject3);
            }
          }
          for (;;)
          {
