...
public class zgp
{
  ...
  public zgp(zgm paramzgm, CustomWebView paramCustomWebView)
  {
  ...
  {
    paramString = belc.g(paramString);
    belc.a("catchHtml");
    WebSoService.WebSoState.WebSo3 localWebSo3 = zgm.a(this.jdField_a_of_type_Zgm).a();
    if (localWebSo3 != null)
    {
      WebSoService.a(paramString, localWebSo3.jdField_a_of_type_JavaLangString, localWebSo3.b, Uri.parse(localWebSo3.d));
      return;
    }
    belc.a("return webSo3 == null");
  }
