  ...
  implements View.OnClickListener
{
  ...
  private zgd jdField_a_of_type_Zgd;
  ...
  public zgp(Activity paramActivity, zgr paramzgr)
  {
  ...
  private void a(View paramView)
  {
    ...
    localObjectAnimator1.setInterpolator(new zfu(0.33F, 0.0F, 0.67F, 1.0F));
    ...
    localObjectAnimator2.setInterpolator(new zfu(0.33F, 0.0F, 0.67F, 1.0F));
    ...
    localObjectAnimator3.setInterpolator(new zfu(0.33F, 0.0F, 0.67F, 1.0F));
    ...
    paramView.setInterpolator(new zfu(0.33F, 0.0F, 0.67F, 1.0F));
  ...
  private void f()
  {
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidAppActivity.findViewById(2131374561);
    this.jdField_a_of_type_AndroidViewView.setVisibility(0);
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidAppActivity.findViewById(2131374557);
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView = ((RecyclerView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374563));
      ...
      this.jdField_a_of_type_Zgd = new zgd(this.jdField_a_of_type_AndroidViewView.getContext(), this, this.jdField_a_of_type_Zgr);
      this.jdField_a_of_type_Zgd.a(zgl.a().a());
      this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.setAdapter(this.jdField_a_of_type_Zgd);
      this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.getRecycledViewPool().setMaxRecycledViews(this.jdField_a_of_type_Zgd.getItemViewType(0), 10);
      this.jdField_a_of_type_Zgd.a(new zgq(this));
      new bkrd(new zgk(this.jdField_a_of_type_Zgd)).attachToRecyclerView(this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView);
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374564));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374565));
      this.c = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374556));
      this.c.setOnClickListener(this);
      this.d = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374555));
      this.d.setOnClickListener(this);
      this.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideProgressNotifier = new SlideProgressNotifier(this.jdField_a_of_type_AndroidAppActivity, 2131561460);
      if (a())
      {
        this.jdField_a_of_type_Int = 60000;
        zgl.a().a(this.jdField_a_of_type_Int);
      }
      return;
      i = 0;
      break;
  ...
  public String a()
  {
    if (this.jdField_a_of_type_Zgd != null) {
      return this.jdField_a_of_type_Zgd.a();
    }
    return "";
  }
  ...
  public void a()
  {
    ...
    for (int i1 = localList.size();; i1 = 0)
    {
      ...
      if (i1 > 0)
      {
        ...
        {
          this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131167147));
          this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131167147));
          if (this.d.getVisibility() != 0)
          {
            localObject = zgl.a().a().iterator();
            i = 0;
            j = 0;
            i2 = 0;
            if (((Iterator)localObject).hasNext())
      ...
      for (;;)
      {
        ...
        if (localSlideItemInfo.jdField_b_of_type_Int == 0)
        {
          ...
          if (m != 0)
          {
            ...
            localObject = "0";
            yqu.a("pic_choose", "exp_autoCut", i3, 0, new String[] { localObject, i2 + "", j + "", i + "" });
            this.d.setVisibility(0);
            if (k == 0) {
              this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidAppActivity.getString(2131698358, new Object[] { Integer.valueOf(this.jdField_a_of_type_Int / 1000) }));
            }
            this.jdField_a_of_type_AndroidWidgetTextView.setText(zgo.a(l));
          ...
          {
            if (this.jdField_a_of_type_Zgd != null) {
              this.jdField_a_of_type_Zgd.a(localList);
            }
            return;
            i3 = 1;
            break;
            ...
            if (n != 0)
            {
              this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131166894));
              this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131167148));
            }
            for (;;)
            {
              this.d.setVisibility(8);
              break;
              this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131167279));
            ...
            if (n != 0)
            {
              ...
              this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidAppActivity.getString(2131698360));
            }
            for (;;)
            {
              ...
              break label674;
              label753:
              this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidAppActivity.getString(2131698359));
            }
            bool = false;
            break label511;
            if (m == 0)
  ...
  {
    if (this.jdField_a_of_type_Zgd != null) {
      this.jdField_a_of_type_Zgd.a(paramInt);
    }
  }
  
  public void b()
  {
    List localList = zgl.a().a();
    if ((this.jdField_a_of_type_AndroidSupportV7WidgetLinearLayoutManager != null) && (this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView != null))
    {
      ...
      while (i <= j)
      {
        ...
        if (localObject != null)
        {
          ...
          if ((localObject instanceof zgg))
          {
            SlideItemInfo localSlideItemInfo1 = (SlideItemInfo)((zgg)localObject).a.getTag();
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131377647: 
      for (;;)
      {
        ...
        i = zgl.a().a().indexOf(localObject1);
        if ((this.jdField_a_of_type_Zgr != null) && (localObject1 != null)) {
          this.jdField_a_of_type_Zgr.a(((SlideItemInfo)localObject1).jdField_b_of_type_JavaLangString);
        }
        a(i);
      }
    case 2131374556: 
      ...
      for (;;)
      {
        try
        {
          ...
          yqu.a("pic_fictitious", "clk_next", this.jdField_a_of_type_AndroidAppActivity.getIntent(), new String[0]);
          if ((!zgl.a().a()) || (this.jdField_a_of_type_AndroidAppActivity == null)) {
            break;
          }
          yqu.a("video_edit_new", "change_pic", this.jdField_a_of_type_AndroidAppActivity.getIntent(), new String[0]);
        }
        catch (Exception localException) {}
        if (!QLog.isColorLevel()) {
          break;
        }
        QLog.d(this.jdField_a_of_type_JavaLangString, 2, bkgg.a(localException));
        break;
        i = 1;
        break label117;
        label335:
    ...
    Object localObject2 = zgl.a().a().iterator();
    int k = 0;
    int j = 0;
    int i = 0;
    label455:
    ...
    for (;;)
    {
      ...
      if (localSlideItemInfo.jdField_b_of_type_Int == 0)
      {
        ...
        {
          yqu.a("pic_choose", "clk_autoCut", n, 0, new String[] { localObject2, k + "", j + "", i + "" });
          zgl.a().i();
          break;
          m = 0;
          break label551;
