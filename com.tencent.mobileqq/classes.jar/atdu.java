  ...
  implements ated, bguz
{
  ...
  private atdu(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt1, int paramInt2, String paramString1, String paramString2, long paramLong2, boolean paramBoolean, String paramString3)
  {
  ...
  public static atdu a(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt1, int paramInt2, String paramString1, String paramString2, long paramLong2, boolean paramBoolean, String paramString3)
  {
    ...
    return new atdu(paramQQAppInterface, paramLong1, paramInt1, paramInt2, paramString1, paramString2, paramLong2, paramBoolean, paramString3);
  }
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      if (localDataInputStream.readInt() != 0) {
        this.jdField_a_of_type_Atec.a(9001, "httpServer retCode!=0");
      }
    }
    catch (IOException localIOException)
    {
      for (;;)
      {
        ...
        this.jdField_a_of_type_Atec.a(9001, "httpServer flag!=0 flag!=1");
        try
        {
    ...
    if (i == 0)
    {
      ...
      l2 = i;
      this.jdField_a_of_type_Atec.a(l1 << 32 | l2, null);
    }
    for (;;)
    {
      try
  ...
  public void a()
  {
    ...
    {
      a().b(this.jdField_a_of_type_Bgux);
  ...
  public boolean a(String paramString, long paramLong, byte[] paramArrayOfByte)
  {
    ...
    this.jdField_a_of_type_Bgux = new bgux(paramString, paramArrayOfByte, this);
    ...
    this.jdField_a_of_type_Bgux.a("Net-type", paramArrayOfByte);
    this.jdField_a_of_type_Bgux.b("POST");
    this.jdField_a_of_type_Bgux.b(1);
    if (this.jdField_a_of_type_Atec != null) {
      this.jdField_a_of_type_Atec.a(this.jdField_a_of_type_Bgux);
    }
    this.jdField_a_of_type_Bgux.jdField_b_of_type_Int = this.jdField_b_of_type_Int;
    this.jdField_a_of_type_Bgux.c = this.jdField_a_of_type_Int;
    this.jdField_a_of_type_Bgux.jdField_a_of_type_JavaLangString = String.valueOf(this.jdField_a_of_type_Long);
    paramArrayOfByte = "";
    if (paramString != null) {
    ...
    {
      this.jdField_a_of_type_Bgux.i = true;
      this.jdField_a_of_type_Bgux.j = atdx.a(paramString);
      this.jdField_a_of_type_Bgux.e = this.jdField_a_of_type_JavaLangString;
    }
    this.jdField_a_of_type_Bgux.jdField_a_of_type_Bdxx = atvo.a();
    a().a(this.jdField_a_of_type_Bgux);
    return true;
  }
  ...
  public void b(bgux parambgux1, bgux parambgux2)
  {
    ...
    this.jdField_a_of_type_Atec.a(0, "null", "null");
  }
}
