...
public class atdu
{
  private static atdu jdField_a_of_type_Atdu;
  ...
  private atdu()
  {
    try
    {
      ...
      this.jdField_a_of_type_Atdw = new atdw(this, BaseApplicationImpl.getContext());
  ...
  public static atdu a()
  {
    if (jdField_a_of_type_Atdu == null) {
      jdField_a_of_type_Atdu = new atdu();
    }
    return jdField_a_of_type_Atdu;
  }
  ...
  public int a(atgs paramatgs, Bundle paramBundle, long paramLong, int paramInt)
  {
    if (-1 == paramInt)
    {
      paramInt = a();
    ...
    while (paramatgs != null)
    {
      paramatgs.a(new atdv(this, ThreadManager.getSubThreadHandler().getLooper(), paramInt, paramBundle, paramLong), false);
      return paramInt;
  ...
  public Notification a(Bundle paramBundle)
  {
    ...
    if (paramBundle != null)
    {
      ...
      ((Notification)localObject1).icon = 2130844273;
      paramBundle = new RemoteViews(BaseApplication.getContext().getPackageName(), 2131560806);
      paramBundle.setImageViewResource(2131371917, 2130844269);
      paramBundle.setTextViewText(2131371928, (CharSequence)localObject2);
      paramBundle.setProgressBar(2131371910, 100, 0, false);
      paramBundle.setViewVisibility(2131371916, 8);
      paramBundle.setViewVisibility(2131371911, 8);
      paramBundle.setTextColor(2131371928, -7829368);
      paramBundle.setTextColor(2131371916, -7829368);
      paramBundle.setTextColor(2131371912, -7829368);
      float f1 = this.jdField_a_of_type_Atdw.a();
      if (this.jdField_a_of_type_Atdw.a() <= 0.0F)
      {
        QLog.w(jdField_a_of_type_JavaLangString, 1, "[UniformDL]. initNotification param error. getTextSize failed. set defualt value:14");
        f1 = 14.0F;
      }
      paramBundle.setFloat(2131371916, "setTextSize", f1);
      paramBundle.setFloat(2131371912, "setTextSize", f1);
      float f2 = this.jdField_a_of_type_Atdw.b();
      f1 = f2;
      if (f2 <= 0.0F)
      {
      ...
      paramBundle.setFloat(2131371928, "setTextSize", f1);
      ...
      try
      {
        int i = this.jdField_a_of_type_Atdw.a().intValue();
        paramBundle.setInt(2131371918, "setBackgroundColor", (i & 0xFF000000) + (-1 - i));
  ...
  protected void a(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    {
      return;
      paramNotification.tickerText = (BaseApplication.getContext().getString(2131719352) + " " + paramBundle1.getString("_notify_param_Filename"));
      paramNotification.contentView.setImageViewResource(2131371917, 2130844269);
      int i = paramBundle2.getInt("_START_WAITING_");
      if (1 == i)
      {
        paramNotification.contentView.setTextViewText(2131371912, BaseApplication.getContext().getString(2131719353));
        paramNotification.contentView.setViewVisibility(2131371911, 0);
        paramNotification.contentView.setViewVisibility(2131371916, 8);
        paramNotification.contentView.setProgressBar(2131371910, 100, 0, false);
      ...
      for (;;)
      {
        ...
        paramNotification.contentView.setTextViewText(2131371912, "0%");
        break;
        paramNotification.when = a(3);
        break label243;
        paramNotification.contentView.setOnClickPendingIntent(2131371918, paramBundle1);
      }
    }
  }
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    ...
    if (localNotification != null)
    {
      ...
      atdm.a().b(paramBundle.getString("_notify_param_Url"));
      return;
    }
  ...
  protected void a(int paramInt, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    localNotification.tickerText = (BaseApplication.getContext().getString(2131719346) + " " + paramBundle1.getString("_notify_param_Filename"));
    ...
    localObject = BaseApplication.getContext().getString(2131719348);
    if (atgn.a(str1) != null)
    {
      localBitmap = atgn.a(str1);
      localObject = BaseApplication.getContext().getString(2131719347);
    }
    if (localBitmap == null)
    {
      int j = aszt.b(str1);
      if (j != 0)
      {
        localNotification.contentView.setImageViewResource(2131371917, j);
        label236:
        localNotification.contentView.setImageViewResource(2131371917, 2130844271);
      }
    }
    for (;;)
    {
      localNotification.contentView.setViewVisibility(2131371916, 0);
      localNotification.contentView.setViewVisibility(2131371911, 8);
      localNotification.contentView.setTextViewText(2131371916, (CharSequence)localObject);
      ...
      localNotification.contentView.setImageViewResource(2131371917, 2130844271);
      break label236;
      localNotification.contentView.setImageViewBitmap(2131371917, localBitmap);
    }
  }
  ...
  protected void b(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    for (;;)
    {
      ...
      paramNotification.contentView.setProgressBar(2131371910, 100, i, false);
      paramNotification.contentView.setTextViewText(2131371912, "" + i + "%");
      paramNotification.flags = 34;
      paramBundle2 = new Intent("com.tencent.mobileqq.UniformDownloadNfn.PAUSE");
      paramBundle2.setPackage(MobileQQ.getContext().getPackageName());
      paramBundle2.putExtra("_PARAM_EXTRA", paramBundle1);
  ...
  public void b(int paramInt, Bundle paramBundle)
  {
    ...
    if (localNotification != null)
    {
      ...
      atdm.a().a(paramBundle.getString("_notify_param_Url"), paramBundle.getString("_notify_param_Filename"), paramBundle.getString("_notify_param_ContentTitle", ""), paramBundle.getLong("_notify_param_Filesize"), paramBundle.getBundle("_notify_param_userdata"), paramInt, true);
      return;
    }
  ...
  protected void c(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    paramNotification.tickerText = null;
    int i = paramBundle2.getInt("_FILE_PROGRESS_");
    paramNotification.contentView.setImageViewResource(2131371917, 2130844272);
    paramNotification.contentView.setViewVisibility(2131371916, 0);
    paramNotification.contentView.setViewVisibility(2131371911, 8);
    paramNotification.contentView.setTextViewText(2131371916, BaseApplication.getContext().getString(2131719351));
    paramNotification.contentView.setProgressBar(2131371910, 100, i, false);
    paramNotification.contentView.setTextViewText(2131371912, "" + i + "%");
    ...
    for (;;)
    {
      ...
      paramNotification.contentView.setOnClickPendingIntent(2131371918, paramBundle2);
    }
  }
  ...
  protected void d(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    if (2 == i)
    {
      paramNotification.tickerText = BaseApplication.getContext().getString(2131719350);
      paramNotification.contentView.setTextViewText(2131371916, BaseApplication.getContext().getString(2131719350));
      label115:
      paramNotification.contentView.setImageViewResource(2131371917, 2130844270);
      paramNotification.contentView.setViewVisibility(2131371916, 0);
      paramNotification.contentView.setTextViewText(2131371912, " ");
      paramNotification.flags = 16;
    ...
    for (;;)
    {
      ...
      paramNotification.tickerText = (BaseApplication.getContext().getString(2131719349) + " " + paramBundle1.getString("_notify_param_Filename"));
      paramNotification.contentView.setTextViewText(2131371916, atgs.a(i) + amtj.a(2131714895));
      break label115;
      label397:
      paramNotification.contentView.setOnClickPendingIntent(2131371918, paramBundle2);
    }
