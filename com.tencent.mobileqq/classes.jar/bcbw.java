...
public class bcbw
{
  ...
  public static bcbw a()
  {
    if (jdField_a_of_type_Bcbw == null) {}
    try
    {
      if (jdField_a_of_type_Bcbw == null) {
        jdField_a_of_type_Bcbw = new bcbw();
      }
      return jdField_a_of_type_Bcbw;
    }
    finally {}
  }
  ...
  public boolean a(AppRuntime paramAppRuntime, JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      if ((TextUtils.isEmpty(str)) || (bbqa.a(str, "8.3.0.4480"))) {
        break label416;
      }
      i = 0;
    }
