...
public class bcbw
  extends aoki
{
  public bcbw(ActiveEntitySearchFragment paramActiveEntitySearchFragment) {}
  ...
  public void handleTabSearchError(String paramString1, boolean paramBoolean, String paramString2, int paramInt, String paramString3, long[] paramArrayOfLong)
  {
    ...
    for (;;)
    {
      try
      {
        this.a.jdField_a_of_type_AndroidGraphicsBitmap = BitmapFactory.decodeResource(this.a.getResources(), 2130842306);
        this.a.jdField_a_of_type_AndroidWidgetImageView.setImageBitmap(this.a.jdField_a_of_type_AndroidGraphicsBitmap);
        this.a.jdField_b_of_type_AndroidWidgetTextView.setText(anzj.a(2131698692));
        this.a.g.setOnClickListener(new bcby(this));
      ...
      this.a.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(new bcbz(this));
    }
  }
  ...
  public void handleTabSearchResult(String paramString1, boolean paramBoolean1, String paramString2, byte[] paramArrayOfByte, boolean paramBoolean2, List<bcfq> paramList, long[] paramArrayOfLong, String paramString3, List<DynamicTabSearch.SubHotWord> paramList1, boolean paramBoolean3, String paramString4, int paramInt)
  {
    ...
    {
      localObject2 = (bcfq)((Iterator)localObject1).next();
      if (((bcfq)localObject2).a() == null) {
        break label3419;
      }
      if (!(localObject2 instanceof bceo)) {
        break label3416;
      }
      localObject3 = (bceo)localObject2;
      localObject4 = ((bceo)localObject3).a();
      Iterator localIterator = ((List)localObject4).iterator();
      while (localIterator.hasNext())
      {
        Object localObject5 = (bcfr)localIterator.next();
        if ((localObject5 instanceof bcep))
        {
          localObject5 = (bcep)localObject5;
          if (ActiveEntitySearchActivity.b) {
            ((bcep)localObject5).o = 1;
          }
          paramString2.add(Long.valueOf(((bcep)localObject5).d()));
        }
      }
      if (l1 != -1L) {
        break label3413;
      }
      l1 = ((bceo)localObject3).a;
      l2 = ((bceo)localObject3).a;
      if ((((List)localObject4).size() > 0) && (((bceo)localObject3).a == 1001L))
      {
        bdll.b(null, "dc00898", "", "", "0X800A339", "0X800A339", 1, 0, "", "", "", "");
        label572:
        paramInt = i + ((bcfq)localObject2).a().size();
        l3 = l1;
        l1 = l2;
        l2 = l3;
      }
    ...
    for (;;)
    {
      ...
      i = paramInt;
      break label363;
      if ((((List)localObject4).size() > 0) && (((bceo)localObject3).a == 1002L)) {
        bdll.b(null, "dc00898", "", "", "0X800A339", "0X800A339", 2, 0, "", "", "", "");
      }
      break label572;
      ...
      if (!paramBoolean1)
      {
        ...
        bcni.a("sub_result", "load_result", new String[] { this.a.jdField_b_of_type_JavaLangString, bcni.a(paramString3), "", bcni.a("dynamic_tab_search.1", this.a.jdField_a_of_type_ArrayOfLong) });
      }
      ...
      {
        bool1 = true;
        bcnd.a(paramString2, paramList, bool1, this.a.jdField_a_of_type_ArrayOfLong, this.a.jdField_e_of_type_JavaLangString, this.a.jdField_b_of_type_JavaLangString);
        if (i != 0) {
          break label1347;
        }
        if ((this.a.getActivity() instanceof bbzq)) {}
        switch (((bbzq)this.a.getActivity()).a())
        {
        case 2: 
        default: 
          if (QLog.isColorLevel()) {
            QLog.i(ActiveEntitySearchFragment.jdField_a_of_type_JavaLangString, 2, "handleTabSearchResult isFirstReq==" + paramBoolean1 + " newSearchDataCount:" + this.a.jdField_b_of_type_Int + "   newSearchIndex:" + this.a.jdField_a_of_type_Int + " result.size():" + i);
          }
          this.a.jdField_e_of_type_AndroidViewView.setVisibility(8);
      ...
      for (;;)
      {
        ...
        bool1 = false;
        break;
        bcni.a("sub_result", "no_result", new String[] { this.a.jdField_b_of_type_JavaLangString, bcni.a(this.a.jdField_a_of_type_ArrayOfLong), "", bcni.a("dynamic_tab_search.1", paramArrayOfLong) });
        break label892;
        bcni.a("all_result", "exp_tab_empty", new String[] { this.a.jdField_b_of_type_JavaLangString, bcni.a(this.a.jdField_a_of_type_ArrayOfLong), "", bcni.a("dynamic_tab_search.1", paramArrayOfLong) });
        break label892;
        if ((this.a.jdField_a_of_type_ArrayOfByte != null) || (!(this.a.getActivity() instanceof bbzq))) {
          break label892;
        }
        paramString2 = (bbzq)this.a.getActivity();
        ...
        default: 
          break;
        case 1: 
          bcni.a("all_result", "exp_tab_page", new String[] { this.a.jdField_b_of_type_JavaLangString, bcni.a(this.a.jdField_b_of_type_JavaUtilList), "", bcni.a("UnifySearch.Unite", paramString2.a()) });
          break;
        case 3: 
          bcni.a("sub_result", "exp_result", new String[] { paramString2.a(), bcni.a(this.a.jdField_b_of_type_JavaUtilList), "", bcni.a("dynamic_tab_search.1", paramString2.a()) });
          break;
          if (QLog.isColorLevel()) {
      ...
      if ((!TextUtils.isEmpty(ActiveEntitySearchFragment.a(this.a))) && (ActiveEntitySearchFragment.a(this.a).size() > 0))
      {
        ...
        j = bhgr.a(paramString3, 8.0F);
        k = bhgr.a(paramString3, 10.0F);
        int m = bhgr.a(paramString3, 2.0F);
        paramList1 = new GradientDrawable();
        paramList1.setCornerRadius(bhgr.a(this.a.getActivity(), 15.0F));
        ...
        while (paramString4.hasNext())
        {
          ...
          if (!TextUtils.isEmpty((CharSequence)localObject2))
          {
            ...
            for (;;)
            {
              ...
              ((TextView)localObject3).setTag(2131368158, localObject1);
        ...
        if (this.a.jdField_a_of_type_AndroidWidgetLinearLayout.getChildCount() == 0)
        {
          ...
          paramString2 = bbzx.a(paramList, paramBoolean1, this.a.jdField_f_of_type_Boolean);
          if ((paramBoolean1) || (l1 != ActiveEntitySearchFragment.a(this.a)) || (paramBoolean3) || (paramString2 == null) || (paramString2.size() <= 0)) {
            break label2428;
          }
          paramArrayOfByte = (bcfp)this.a.jdField_a_of_type_JavaUtilList.get(this.a.jdField_a_of_type_JavaUtilList.size() - 1);
          ...
          if (!((bcfp)paramString2.get(paramInt) instanceof bcey)) {
            break label2415;
          }
        }
      }
      for (;;)
      {
        if ((paramArrayOfByte instanceof bcfr))
        {
          paramArrayOfByte = (bcfr)paramArrayOfByte;
          j = paramArrayOfByte.a();
          bcnl.a(paramArrayOfByte, j + paramInt, j - 1);
        }
        for (;;)
        {
          k = 0;
          for (;;)
          {
            if (k < paramInt)
            {
              paramArrayOfByte = (bcfp)paramString2.get(k);
              if ((paramArrayOfByte instanceof bcfr)) {
                bcnl.a((bcfr)paramArrayOfByte, j + paramInt, j + k);
              }
              k += 1;
              continue;
          ...
          this.a.jdField_a_of_type_Bcbr.a(this.a.jdField_a_of_type_JavaUtilList);
          ...
          for (;;)
          {
            ...
            {
              this.a.g.setVisibility(0);
              paramString3 = (aobl)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159);
              if ((!bool1) && (paramString3.jdField_d_of_type_Boolean)) {
                if (this.a.jdField_a_of_type_Ajnu == null)
                {
                  this.a.jdField_a_of_type_Ajnu = new ajny(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.getActivity(), this.a.jdField_b_of_type_ComTencentWidgetXListView, null);
                  paramString2 = this.a.jdField_a_of_type_Ajnu.a();
                  paramArrayOfByte = new TextView(this.a.getActivity());
                  paramArrayOfByte.setGravity(17);
                  paramArrayOfByte.setLayoutParams(new AbsListView.LayoutParams(-1, agej.a(105.0F, this.a.getResources())));
                  paramArrayOfByte.setTextColor(this.a.getResources().getColor(2131167074));
                  paramArrayOfByte.setTextSize(1, 17.0F);
                  paramArrayOfByte.setText(anzj.a(2131698696));
                  paramArrayOfByte.setBackgroundResource(2130838779);
                  paramString2.addHeaderView(paramArrayOfByte);
                  paramArrayOfByte = new TextView(this.a.getActivity());
                  paramArrayOfByte.setTextColor(this.a.getResources().getColor(2131167074));
                  paramArrayOfByte.setTextSize(1, 14.0F);
                  paramArrayOfByte.setGravity(16);
                  paramArrayOfByte.setPadding(agej.a(15.0F, this.a.getResources()), 0, 0, 0);
                  paramArrayOfByte.setLayoutParams(new AbsListView.LayoutParams(-1, agej.a(40.0F, this.a.getResources())));
                  paramArrayOfByte.setText(anzj.a(2131698694));
                  paramArrayOfByte.setBackgroundResource(2130838779);
                  paramString2.addHeaderView(paramArrayOfByte);
            ...
            for (;;)
            {
              for (;;)
              {
                ...
                this.a.jdField_a_of_type_Bcbr.a(this.a.jdField_a_of_type_JavaUtilList);
                break;
                this.a.jdField_a_of_type_Ajnu.e();
                break label2973;
                ...
                try
                {
                  ...
                  this.a.jdField_b_of_type_AndroidWidgetTextView.setText(anzj.a(2131698687));
                  if (bool1)
                  {
                    this.a.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
                    this.a.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new bcbx(this, paramString2));
                    if (TextUtils.isEmpty(paramArrayOfByte)) {
                      break label2984;
                    }
                    this.a.jdField_a_of_type_AndroidWidgetButton.setText(paramArrayOfByte);
                    this.a.jdField_b_of_type_AndroidWidgetTextView.setPadding(0, bhgr.a(this.a.jdField_b_of_type_AndroidWidgetTextView.getContext(), 15.0F), 0, 0);
                  }
                }
