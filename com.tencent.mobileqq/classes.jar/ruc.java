...
public class ruc
{
  ...
  private static ruc jdField_a_of_type_Ruc;
  ...
  private WeakReference<ruf> jdField_a_of_type_JavaLangRefWeakReference;
  private boolean jdField_a_of_type_Boolean;
  
  static
  {
    jdField_a_of_type_JavaLangString = ruc.class.getSimpleName();
  }
  
  public static ruc a()
  {
    if (jdField_a_of_type_Ruc == null) {}
    try
    {
      if (jdField_a_of_type_Ruc == null) {
        jdField_a_of_type_Ruc = new ruc();
      }
      return jdField_a_of_type_Ruc;
    }
    finally {}
  }
  ...
  public void a()
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$UGCVoiceInfo != null)
      {
        ...
        {
          ruf localruf = (ruf)this.jdField_a_of_type_JavaLangRefWeakReference.get();
          if (localruf != null)
          {
            localruf.b(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$UGCVoiceInfo);
  ...
  public void a(ruf paramruf, SocializeFeedsInfo.UGCVoiceInfo paramUGCVoiceInfo)
  {
    if (this.jdField_a_of_type_AndroidMediaMediaPlayer == null) {
    ...
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramruf);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$UGCVoiceInfo = paramUGCVoiceInfo;
    this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnPreparedListener(new rud(this));
    this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnCompletionListener(new rue(this));
    try
    {
    ...
    catch (IOException paramruf)
    {
      paramruf.printStackTrace();
    }
  }
  ...
  public void a(boolean paramBoolean, String paramString)
  {
    ...
    //   2: aload_0
    //   3: iload_1
    //   4: putfield 85	ruc:jdField_a_of_type_Boolean	Z
    //   7: aload_0
    //   8: getfield 42	ruc:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   11: ifnull +81 -> 92
    //   14: aload_0
    //   15: getfield 49	ruc:jdField_a_of_type_JavaLangRunnable	Ljava/lang/Runnable;
    //   18: ifnull +74 -> 92
    //   21: invokestatic 158	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   24: ifeq +38 -> 62
    //   27: getstatic 25	ruc:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   30: iconst_2
    ...
    //   62: aload_0
    //   63: getfield 42	ruc:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   66: aload_0
    //   67: getfield 49	ruc:jdField_a_of_type_JavaLangRunnable	Ljava/lang/Runnable;
    //   70: invokevirtual 183	android/os/Handler:removeCallbacks	(Ljava/lang/Runnable;)V
    //   73: aload_0
    //   74: getfield 85	ruc:jdField_a_of_type_Boolean	Z
    //   77: ifeq +18 -> 95
    //   80: aload_0
    //   81: getfield 42	ruc:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   84: aload_0
    //   85: getfield 49	ruc:jdField_a_of_type_JavaLangRunnable	Ljava/lang/Runnable;
    ...
    //   94: return
    //   95: aload_0
    //   96: getfield 42	ruc:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   99: aload_0
    //   100: getfield 49	ruc:jdField_a_of_type_JavaLangRunnable	Ljava/lang/Runnable;
    //   103: ldc2_w 188
