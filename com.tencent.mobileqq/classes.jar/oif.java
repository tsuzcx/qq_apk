...
public class oif
{
  ...
  private final View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new oig(this);
  ...
  private final LbsManagerService.OnLocationChangeListener jdField_a_of_type_ComTencentMobileqqAppSosoLbsManagerService$OnLocationChangeListener = new oim(this, "readinjoy_weather");
  private final pkt jdField_a_of_type_Pkt = new oin(this);
  private int jdField_b_of_type_Int = -1;
  private final View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new oii(this);
  private final View.OnClickListener c = new oij(this);
  private final View.OnClickListener d = new oik(this);
  private View.OnClickListener e;
  
  public oif(@NonNull VafContext paramVafContext)
  {
  ...
  private static Container a(VafContext paramVafContext, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = syz.a("daily_dynamic_header", true);
        if (localObject != null)
        {
          paramJSONObject = ((syz)localObject).getTemplateBean(paramJSONObject);
          if (paramJSONObject != null)
          {
            paramVafContext = paramVafContext.getViewFactory().inflate(paramVafContext, paramJSONObject);
            ozp.a(paramVafContext, null, paramJSONObject);
  ...
  private Container a(JSONObject paramJSONObject, View.OnClickListener paramOnClickListener)
  {
    if ((this.jdField_b_of_type_Int == -1) || (this.jdField_b_of_type_Int == 0))
    {
      ...
      {
        Drawable localDrawable = this.jdField_a_of_type_AndroidViewView.getContext().getResources().getDrawable(2130843217);
    ...
    for (;;)
    {
      ...
      if (paramJSONObject != null)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130843217);
  ...
  private static URLDrawable.URLDrawableOptions a(Context paramContext)
  {
    ...
    paramContext = paramContext.getResources().getDrawable(2130843217);
  ...
  private void a(int paramInt)
  {
    ...
    bkwm.a("sp_key_daily_dynamic_header_state", Integer.valueOf(this.jdField_a_of_type_Int));
  ...
  private void a(@NonNull View paramView, @NonNull Container paramContainer, @NonNull Drawable paramDrawable, JSONObject paramJSONObject)
  {
    ...
    ((DailyTitleBar)paramView.findViewById(2131371875)).setVisibility(8);
    DailyTitleBarSwitcher localDailyTitleBarSwitcher = (DailyTitleBarSwitcher)paramView.findViewById(2131365282);
    ...
    ReadInJoyDailyPullToZoomHeaderXListView localReadInJoyDailyPullToZoomHeaderXListView = (ReadInJoyDailyPullToZoomHeaderXListView)paramView.findViewById(2131378014);
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)LayoutInflater.from(paramView.getContext()).inflate(2131560156, localReadInJoyDailyPullToZoomHeaderXListView, false));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131363278));
    oid.a(paramDrawable);
    oid.a(this.jdField_a_of_type_AndroidWidgetImageView);
  ...
  private static void a(Container paramContainer, String paramString, JSONObject paramJSONObject)
  {
    ...
    ViewFactory.findClickableViewListener(paramContainer.getVirtualView(), new oip(paramString, paramJSONObject));
  }
  ...
  private void a(@NonNull BaseActivity paramBaseActivity, @NonNull Runnable paramRunnable)
  {
    if (Build.VERSION.SDK_INT >= 23)
    {
      ...
      {
        paramBaseActivity.requestPermissions(new oio(this, paramRunnable), 1, new String[] { "android.permission.ACCESS_FINE_LOCATION" });
        return;
      }
      paramRunnable.run();
      return;
  ...
  private void a(String paramString)
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2131166882);
  ...
  private void a(JSONObject paramJSONObject)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewDailyTitleBarSwitcher == null) {
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewDailyTitleBarSwitcher = ((DailyTitleBarSwitcher)this.jdField_a_of_type_AndroidViewView.findViewById(2131365282));
      }
    ...
    if (!TextUtils.isEmpty(str))
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewDailyTitleBarSwitcher.setOnTitleClickWeatherListener(new oih(this, paramJSONObject));
      return;
    }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    long l1 = ((Long)bkwm.a("sp_key_daily_dynamic_header_last_refresh_time", Long.valueOf(0L))).longValue();
  ...
  private static boolean a(Container paramContainer, JSONObject paramJSONObject)
  {
    ...
    if ((localObject instanceof TemplateBean))
    {
      ...
      try
      {
        syz localsyz = syz.a("daily_dynamic_header", true);
        if (localsyz != null) {}
        for (paramJSONObject = localsyz.getTemplateBean(paramJSONObject); (paramJSONObject != null) && (TextUtils.equals(paramJSONObject.getStyleName(), ((TemplateBean)localObject).getStyleName())) && (((TemplateBean)localObject).getId() == paramJSONObject.getId()); paramJSONObject = null)
        {
          QLog.i("DailyHeaderViewController", 1, "[bindDataForProteusHeader] template match, bind data");
          ozp.a(paramContainer, (TemplateBean)localObject, paramJSONObject);
          return true;
        }
        return false;
      }
  ...
  private void b()
  {
    ...
    DailyTitleBar localDailyTitleBar = (DailyTitleBar)this.jdField_a_of_type_AndroidViewView.findViewById(2131371875);
    ...
    this.jdField_a_of_type_AndroidViewView.findViewById(2131365282).setVisibility(8);
    if (this.jdField_a_of_type_AndroidViewViewGroup != null)
    {
      ((ReadInJoyDailyPullToZoomHeaderXListView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378014)).removeHeaderView(this.jdField_a_of_type_AndroidViewViewGroup);
  ...
  private void b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      localJSONObject.putOpt("error_reason", amtj.a(2131701844)).putOpt("operation_text", amtj.a(2131701849));
      View.OnClickListener localOnClickListener = this.c;
      for (;;)
      {
        a(localJSONObject, localOnClickListener);
        return;
        localJSONObject.putOpt("error_reason", amtj.a(2131701850)).putOpt("operation_text", amtj.a(2131701847));
        localOnClickListener = this.d;
        continue;
        localJSONObject.putOpt("error_reason", amtj.a(2131701851)).putOpt("operation_text", amtj.a(2131701848));
  ...
  private void b(View paramView)
  {
    ...
    a(((Integer)bkwm.a("sp_key_daily_dynamic_header_state", Integer.valueOf(0))).intValue());
  }
  ...
  private static void b(String paramString, JSONObject paramJSONObject)
  {
    ...
    localpbg.b("model_type", a(paramString));
    localpbg.b("topic_id", paramJSONObject.optString("topic_id", ""));
    odq.a(null, "CliOper", "", "", "0X8009D12", "0X8009D12", 0, 0, "", "", "", localpbg.a(), false);
  }
  ...
  private void c()
  {
    JSONObject localJSONObject = pkm.a().a();
    Object localObject;
    ...
    if (localContainer != null)
    {
      ...
      catch (Exception localException)
      {
        for (;;)
        {
          Drawable localDrawable = this.jdField_a_of_type_AndroidViewView.getContext().getResources().getDrawable(2131166882);
        }
      }
    }
    a(0);
  ...
  private static void c(String paramString, JSONObject paramJSONObject)
  {
    ...
    localpbg.b("model_type", a(paramString));
    localpbg.b("topic_id", paramJSONObject.optString("topic_id", ""));
    odq.a(null, "CliOper", "", "", "0X8009D13", "0X8009D13", 0, 0, "", "", "", localpbg.a(), false);
  }
    ...
    for (;;)
    {
      ...
      catch (Exception localException)
      {
        ...
        if (localObject != null)
        {
          ...
          Animation localAnimation = AnimationUtils.loadAnimation(((View)localObject).getContext(), 2130772196);
      ...
      ((JSONObject)localObject).putOpt("error_reason", amtj.a(2131701842));
      for (;;)
      {
        ((JSONObject)localObject).putOpt("operation_text", amtj.a(2131701843));
        break;
        ((JSONObject)localObject).putOpt("error_reason", amtj.a(2131701846));
        continue;
        ((JSONObject)localObject).putOpt("error_reason", amtj.a(2131701845));
      }
    }
  }
