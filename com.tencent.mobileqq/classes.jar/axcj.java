...
public class axcj
  ...
  implements bhko
{
  private static akuj jdField_a_of_type_Akuj;
  private static akup jdField_a_of_type_Akup;
  ...
  {
    SosoInterface.SosoLbsInfo localSosoLbsInfo = akug.a(paramString);
    if (localSosoLbsInfo != null) {}
    for (boolean bool = true;; bool = false)
    {
      bhkp.a(bool, paramString);
  ...
  public static void a(String paramString)
  {
    ...
    do
    {
      return;
      e = l;
    } while (jdField_a_of_type_Akuj == null);
  ...
  {
    if ((jdField_a_of_type_Boolean) && (jdField_a_of_type_Akuj == null))
    {
      jdField_a_of_type_Akuj = new axck(paramString, false);
      try
      {
  ...
  {
    super.onDestroy();
    if (jdField_a_of_type_Akup != null) {
      SosoInterface.b(jdField_a_of_type_Akup);
    }
    jdField_a_of_type_Akup = null;
    if (jdField_a_of_type_Akuj != null) {
      akug.b(jdField_a_of_type_Akuj);
    }
    jdField_a_of_type_Akuj = null;
    bhkl.a().b(this);
    if (this.jdField_a_of_type_MqqOsMqqHandler != null)
    {
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    {
      axbh.a(paramIntent, paramFromServiceMsg, (QQAppInterface)localObject, this);
      return;
    }
    axbh.a((QQAppInterface)localObject, paramIntent, paramFromServiceMsg, this);
  }
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        Object localObject2 = (axch)((QQAppInterface)localObject1).getManager(10);
        Object localObject3;
        if (localObject2 != null)
        {
          paramIntent = ((axch)localObject2).a;
          if (paramIntent != null)
          {
            localObject3 = axbh.a(paramIntent);
            ...
            if (j < i1)
            {
              ...
              localObject4 = (bhav)((axch)localObject2).a.get(Integer.valueOf(i2));
              ArrayList localArrayList;
              if (localObject4 != null)
              {
                localObject5 = new single_count(((bhav)localObject4).jdField_a_of_type_Long, (byte)((bhav)localObject4).jdField_a_of_type_Int);
                localArrayList = new ArrayList();
                if ((((bhav)localObject4).jdField_a_of_type_JavaUtilArrayList == null) || (((bhav)localObject4).jdField_a_of_type_JavaUtilArrayList.size() <= 0)) {
                  break label765;
                }
              }
              label765:
              for (paramIntent = new feed_host_info(((QZoneCountUserInfo)((bhav)localObject4).jdField_a_of_type_JavaUtilArrayList.get(0)).jdField_a_of_type_Long, "", ((bhav)localObject4).jdField_a_of_type_JavaLangString, null, null, null);; paramIntent = new feed_host_info(0L, "", ((bhav)localObject4).jdField_a_of_type_JavaLangString, null, null, null))
              {
                localArrayList.add(paramIntent);
                localConcurrentHashMap1.put(Integer.valueOf(i2), new count_info((single_count)localObject5, localArrayList, ((bhav)localObject4).jdField_b_of_type_JavaLangString, ((bhav)localObject4).c, ((bhav)localObject4).e, ((bhav)localObject4).f, ((bhav)localObject4).g, ((bhav)localObject4).jdField_b_of_type_Long, ((bhav)localObject4).d));
                j += 1;
                break;
              }
            }
            paramIntent = (bhav)((axch)localObject2).a.get(Integer.valueOf(56));
            if (paramIntent != null)
            {
        ...
        for (;;)
        {
          ...
          paramIntent = axbh.a(Long.valueOf(((QQAppInterface)localObject1).getCurrentAccountUin()).longValue(), null, m, n, i, k, localConcurrentHashMap1, paramIntent, localConcurrentHashMap2);
          if (paramIntent == null)
          {
            paramIntent = new byte[4];
            notifyObserver(null, 1000, false, new Bundle(), atzo.class);
          }
          for (;;)
          {
            a();
  ...
  public void onWebEvent(String paramString, Bundle paramBundle)
  {
    ...
    axbh.a((QQAppInterface)paramString, i, paramBundle);
  }
  ...
  public void service(Intent paramIntent)
  {
    if (paramIntent.getAction().equals("Qzone_Refresh_UI"))
    {
      ...
      notifyObserver(null, 1000, true, paramIntent, atzo.class);
      if (QLog.isColorLevel()) {
