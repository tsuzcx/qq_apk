...
public class afir
  extends nit
{
  public afir(TroopAssistantActivity paramTroopAssistantActivity) {}
      ...
      try
      {
        ...
        if (localRspGetGroupDynamicEntrancePicture.cover_url.has())
        {
          ...
          else
          {
            ...
            zlx.a(this.a.jdField_a_of_type_AndroidWidgetImageView, paramArrayOfByte, 68, 68, 4, zlx.b, "TroopStorySnap");
            return paramBundle;
          }
        }
      }
