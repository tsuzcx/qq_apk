  ...
  implements Animation.AnimationListener
{
  ...
  public void onAnimationEnd(Animation paramAnimation)
  {
    ...
    if (this.a.jdField_b_of_type_AndroidViewAnimationTranslateAnimation == paramAnimation)
    {
      ...
      if (this.a.jdField_a_of_type_Aymw != null) {
        this.a.jdField_a_of_type_Aymw.d = false;
      }
      ...
      if (this.a.e)
      {
        ...
        bbmy.a((Context)this.a.jdField_a_of_type_JavaLangRefWeakReference.get(), 1, ((FragmentActivity)this.a.jdField_a_of_type_JavaLangRefWeakReference.get()).getString(2131632129), 1).b(((FragmentActivity)this.a.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources().getDimensionPixelSize(2131167766) - (int)bacc.a((Context)this.a.jdField_a_of_type_JavaLangRefWeakReference.get(), 5.0F));
      }
    }
    for (;;)
    {
      return;
      label247:
      azhg localazhg = (azhg)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(133);
      String str = this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a;
      if (!TextUtils.isEmpty(str))
      {
        TroopAioTopADInfo localTroopAioTopADInfo = localazhg.a(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a);
        Object localObject;
        if (localTroopAioTopADInfo != null)
        {
          ...
          localObject = bade.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (Context)this.a.jdField_a_of_type_JavaLangRefWeakReference.get(), paramAnimation);
          if (localObject == null) {
            break label439;
          }
          ((bacn)localObject).c();
        ...
        for (;;)
        {
          awqx.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_AIO", "", "notice_center", "Clk_Promote", 0, 0, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, localTroopAioTopADInfo.adId + "", "", "");
          localazhg.a(str);
          this.a.d = false;
          return;
          label430:
        ...
        {
          if ((this.a.jdField_a_of_type_AndroidViewView != null) && (this.a.jdField_a_of_type_Aymw != null))
          {
            ...
            if ((this.a.c) && (this.a.jdField_a_of_type_AndroidViewView != null) && ((this.a.jdField_a_of_type_AndroidViewView instanceof TroopAioFeedsCenterView)))
            {
              ...
              this.a.jdField_a_of_type_Ayok.b();
            }
          }
