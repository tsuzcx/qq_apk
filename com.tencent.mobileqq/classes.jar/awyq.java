  ...
  implements Manager
{
  ...
  static
  {
    ...
    jdField_a_of_type_JavaLangString = anvx.a(2131701717);
    jdField_b_of_type_JavaLangString = anvx.a(2131701716);
  }
  
  public awyq(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageForMarketFace paramMessageForMarketFace)
  {
    ...
    {
      i = ((awyq)paramQQAppInterface.getManager(QQManagerFactory.COMMERCIAL_DRAINAGE_MANAGER)).a(paramMessageForMarketFace.time, String.valueOf(localMarkFaceMessage.dwTabID), localMarkFaceMessage.copywritingContent, localMarkFaceMessage.copywritingType);
      if (i != 0) {
        break label70;
      }
    ...
    for (;;)
    {
      try
      {
        paramMessageForMarketFace.msgData = apab.a(localMarkFaceMessage);
        return;
      }
