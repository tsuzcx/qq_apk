...
public class abvg
{
  ...
  private static int a(abvq paramabvq)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 30	abvq:b	()Ljava/lang/String;
    ...
    //   557: aload 8
    //   559: invokestatic 134	abvg:a	(Ljava/io/InputStream;Ljava/io/File;)V
    //   562: aload 6
    //   564: astore 4
    //   566: aload 8
  ...
  private static void a(abvq paramabvq)
  {
    long l = System.currentTimeMillis();
    try
    {
      paramabvq = paramabvq.b();
      String str = PatchCommonUtil.getPatchPath(paramabvq);
      if ("Success".equals(anbr.a(BaseApplicationImpl.sApplication, str, null, false)))
      {
        jdField_a_of_type_Int = 500;
        jdField_a_of_type_JavaLangString = paramabvq;
      }
      for (;;)
      {
    ...
    catch (Throwable paramabvq)
    {
      for (;;)
      {
        jdField_a_of_type_Int = 502;
        QLog.d("PatchLogTag", 1, "DexPatchInstaller injectDexPatch throwable=" + paramabvq);
      }
    }
  }
  ...
  {
    long l = System.currentTimeMillis();
    abvq localabvq = abvr.a(paramContext, "dex");
    if ((jdField_a_of_type_Int == 0) && (a(paramContext, localabvq)))
    {
      String str = a();
      ...
      if (jdField_a_of_type_Int == 500) {
        if ((localabvq.b()) && (PatchCommonUtil.isArtGeN()) && (!SoLoadUtil.a()))
        {
          j = a(localabvq);
          i = j;
          if (j != 800)
          {
            str = anbr.a(BaseApplicationImpl.sApplication, 0);
      ...
      for (int i = j;; i = 0)
      {
        a(paramContext, localabvq);
        PatchReporter.reportPatchEvent(paramContext, "", "actPatchInstall", jdField_a_of_type_Int, localabvq.b(), i);
        ...
        if (PatchCommonUtil.isDalvik()) {
          PatchResolveForDalvik.a(paramContext, localabvq);
        }
      }
    }
  ...
  private static void a(Context paramContext, abvq paramabvq)
  {
    paramContext = new DexPatchInstaller.1(paramabvq, paramContext);
  ...
  private static boolean a(Context paramContext, abvq paramabvq)
  {
    if (paramabvq == null) {
      QLog.d("PatchLogTag", 1, "DexPatchInstaller checkDexPatchConfigAndStatus patch config is null");
    }
    while (!paramabvq.a(paramContext, BaseApplicationImpl.processName)) {
      return false;
    }
    String str = paramabvq.b();
    ...
    if (localFile.length() != paramabvq.b())
    {
