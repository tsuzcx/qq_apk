...
public class bkmn
{
  protected static ConcurrentHashMap<String, bkmn> a;
  protected volatile long a;
  protected ServiceConnection a;
  private bkmg jdField_a_of_type_Bkmg;
  public volatile bkmj a;
  protected Object a;
  ...
  public bkmn(String paramString1, String paramString2)
  {
    this.jdField_a_of_type_JavaLangObject = new Object();
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue = new ConcurrentLinkedQueue();
    this.jdField_a_of_type_Long = -1L;
    this.jdField_a_of_type_AndroidContentServiceConnection = new bkmo(this);
    this.jdField_a_of_type_JavaLangString = paramString1;
    this.b = paramString2;
  }
  
  public static bkmn a(String paramString)
  {
    try
    {
      if (jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString) == null) {
        jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString, new bkmn(null, paramString));
      }
      paramString = (bkmn)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
      return paramString;
    }
    finally {}
  }
  ...
  public void a(SendMsg paramSendMsg)
  {
    ...
    this.jdField_a_of_type_Bkmj.a(paramSendMsg);
  }
  ...
  public void a(SendMsg paramSendMsg, RecvMsg paramRecvMsg)
  {
    try
    {
      ...
      {
        this.jdField_a_of_type_Bkmg.a(paramRecvMsg);
        return;
      }
    }
  ...
  protected boolean a()
  {
    return this.jdField_a_of_type_Bkmj != null;
  }
  ...
  public void b(SendMsg paramSendMsg)
  {
    ...
    {
      if (this.jdField_a_of_type_Bkmj == null)
      {
        c(paramSendMsg);
        return;
      }
  ...
  void c()
  {
    try
    {
      ...
      localbkkz.d = amtj.a(2131712505);
      localbkkz.jdField_a_of_type_JavaLangString = this.b;
      if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {}
      for (localbkkz.e = "com.tencent.plugin.qappcenter.remote.RemoteService";; localbkkz.e = this.jdField_a_of_type_JavaLangString)
      {
        localbkkz.jdField_a_of_type_AndroidContentIntent = localIntent;
        localbkkz.jdField_a_of_type_AndroidContentServiceConnection = this.jdField_a_of_type_AndroidContentServiceConnection;
