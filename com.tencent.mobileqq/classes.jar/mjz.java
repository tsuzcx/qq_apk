...
public class mjz
  extends lfe
{
  public mjz(VideoInviteActivity paramVideoInviteActivity) {}
  ...
  protected void a()
  {
    ...
    if (this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null)
    {
      ...
      this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.c(this.a.jdField_a_of_type_Ley.A, this.a.jdField_a_of_type_Ley.p);
    }
  }
  ...
  protected void a(String paramString, boolean paramBoolean)
  {
    if ((this.a.c != null) && (this.a.c.equals(paramString)))
    {
      ...
      if (paramBoolean)
      {
        ...
        this.a.jdField_a_of_type_Mhe.a(new mkb(this));
      }
    }
    return;
    label187:
  ...
  protected void c(int paramInt)
  {
    ...
    do
    {
      return;
      int i = bhjt.a();
      String str = bhjt.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, paramInt, i, null);
      File localFile = new File(str);
      int j = this.a.jdField_a_of_type_Ley.d;
      if ((localFile != null) && (localFile.exists()) && (this.a.jdField_a_of_type_Ley.g != 4) && ((j == 1) || (j == 0)) && (this.a.jdField_a_of_type_AndroidWidgetRelativeLayout != null))
      {
        if (this.a.jdField_a_of_type_ComTencentMobileqqVipavVipFullScreenVideoView == null) {
          this.a.jdField_a_of_type_ComTencentMobileqqVipavVipFullScreenVideoView = bhjt.a((Activity)this.a.jdField_a_of_type_JavaLangRefWeakReference.get(), this.a.jdField_a_of_type_AndroidWidgetRelativeLayout, false);
        }
        if (bhjt.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getApplicationContext(), this.a.jdField_a_of_type_ComTencentMobileqqVipavVipFullScreenVideoView, str, i, null, paramInt, false))
        {
          this.a.a(true);
