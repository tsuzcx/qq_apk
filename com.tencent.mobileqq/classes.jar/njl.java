...
public class njl
{
  ...
  public static nis a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    if ((paramMessageRecord instanceof MessageForStructing))
    {
      ...
      if ((localMessageForStructing.structingMsg != null) && ((localMessageForStructing.structingMsg instanceof AbsShareMsg)))
      {
              ...
              if (((axuq)localObject3).a.size() > 0)
              {
                ...
                for (;;)
                {
                  ...
                  if ((localObject4 instanceof axzs))
                  {
                    ...
                    if ((!TextUtils.isEmpty(((axzs)localObject4).S)) && (!TextUtils.isEmpty(((axzs)localObject4).T)))
                    {
                      localObject4 = new nit(i, ((axzs)localObject4).S, ((axzs)localObject4).T);
                      i += 1;
                      ((ArrayList)localObject1).add(localObject4);
                      localArrayList2.add(((nit)localObject4).b);
                      localArrayList1.add(((nit)localObject4).a);
                    }
                  }
                }
              }
        ...
        {
          localObject1 = new nis(paramMessageRecord.senderuin, localMessageForStructing.structingMsg.mMsgUrl, (ArrayList)localObject1, localMessageForStructing.structingMsg.mCommonData);
          if (((nis)localObject1).b())
          {
            ((nis)localObject1).c = String.valueOf(localMessageForStructing.structingMsg.msgId);
            if (!paramBoolean)
            {
              ((nis)localObject1).a = NetConnInfoCenter.getServerTimeMillis();
              paramMessageRecord.saveExtInfoToExtStr("recent_list_advertisement_message_push_time", String.valueOf(((nis)localObject1).a));
            }
            for (;;)
            {
              if (QLog.isColorLevel()) {
                QLog.d("AD_Util", 2, "start preload msgid:" + ((nis)localObject1).c);
              }
              ThreadManager.executeOnSubThread(new PublicAccountAdUtil.1(localArrayList1));
              if (paramQQAppInterface == null) {
                break;
              }
              paramQQAppInterface = (njf)paramQQAppInterface.getManager(238);
              if (paramQQAppInterface != null) {
                paramQQAppInterface.a((nis)localObject1);
              }
              return localObject1;
              paramMessageRecord = paramMessageRecord.getExtInfoFromExtStr("recent_list_advertisement_message_push_time");
              try
              {
                ((nis)localObject1).a = Long.parseLong(paramMessageRecord);
              }
              catch (Exception paramMessageRecord)
              {
                ((nis)localObject1).a = 0L;
              }
            }
          }
          return null;
  ...
  public static oidb_cmd0x886.PhoneInfo a()
  {
    ...
    Object localObject = oaf.a();
    String str = oaf.c();
    if (!TextUtils.isEmpty((CharSequence)localObject))
    {
      localObject = bdik.d(((String)localObject).toLowerCase()).toLowerCase();
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(str))
      {
        ...
        str = bdik.d((String)localObject).toLowerCase();
