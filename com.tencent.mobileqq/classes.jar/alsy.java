  ...
  implements Manager
{
  public static int b;
  public static int c;
  public static final String e = alpo.a(2131707526);
  public static final String f = alpo.a(2131707534);
  public static final String g = alpo.a(2131707529);
  public int a;
  public Handler a;
  ...
  public alsy(QQAppInterface paramQQAppInterface)
  {
  ...
  public static final alsy a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface == null) {
      return null;
    }
    return (alsy)paramQQAppInterface.getManager(124);
  }
  ...
  private GrayTipsInfo a(String paramString1, String paramString2, AbsStructMsg paramAbsStructMsg)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      long l = ayvc.a();
      if (!bool) {
        if (((Boolean)aush.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "sp_file_nearby_flower_tip", 0, "nearby_flower_tip_first_flag", Boolean.valueOf(true))).booleanValue())
        {
          if (QLog.isColorLevel()) {
          ...
          if (Friends.isValidUin(paramString1)) {
            localObject3 = String.format("https://imgcache.qq.com/club/client/flower/release/html/gift_mall.html?ADTAG=%s&_bid=2050&sourceType=%d&_handle=1&_wv=2147347&platId=1&qqVersion=%s", new Object[] { "aio.m.xiaohuitiao", Integer.valueOf(1), "8.3.3" });
          }
          aush.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "sp_file_nearby_flower_tip", 0, "nearby_flower_tip_first_flag", Boolean.valueOf(false));
          azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80060B6", "0X80060B6", 0, 0, "", "", "", "");
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80060B8", "0X80060B8", 0, 0, "", "", "", "");
          localObject2 = null;
          i = 1;
          break;
          ...
          azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80060B5", "0X80060B5", 0, 0, "", "", "", "");
          i = 1;
          localObject3 = localObject5;
          localObject2 = localObject4;
          break;
  ...
  private String a(AbsStructMsg paramAbsStructMsg)
  {
    ...
    if ((paramAbsStructMsg instanceof StructMsgForGeneralShare))
    {
      ...
      if (paramAbsStructMsg.getItemCount() > 0)
      {
        ...
        if (!(paramAbsStructMsg instanceof azsv)) {
          break label147;
        }
        paramAbsStructMsg = ((azsv)paramAbsStructMsg).a.getString("cMean");
      }
    }
    for (;;)
    {
      ...
      {
        return localObject;
        if (!(paramAbsStructMsg instanceof azue)) {
          break label248;
        }
        paramAbsStructMsg = ((azue)paramAbsStructMsg).a.iterator();
        do
        {
          if (!paramAbsStructMsg.hasNext()) {
            break;
          }
          localObject = (azqj)paramAbsStructMsg.next();
  ...
  private String a(boolean paramBoolean, String paramString, AbsStructMsg paramAbsStructMsg)
  {
    ...
    if (paramString.contains("Ta"))
    {
      ...
      if ((paramAbsStructMsg instanceof StructMsgForGeneralShare))
      {
        ...
        if (paramAbsStructMsg.getItemCount() > 0)
        {
          azqj localazqj = paramAbsStructMsg.getItemByIndex(0);
          str = paramString;
          if ((localazqj instanceof azsv))
          {
            ...
            paramAbsStructMsg = ((azsv)localazqj).a.getString(paramAbsStructMsg);
            str = paramString;
    ...
    label118:
    label125:
    for (paramAbsStructMsg = alpo.a(2131707525);; paramAbsStructMsg = alpo.a(2131707535))
    {
  ...
  private void a()
  {
    this.jdField_a_of_type_JavaLangString = ((String)aush.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "sp_file_nearby_flower_tip", 0, "senderGrayTip", e));
    this.jdField_b_of_type_JavaLangString = ((String)aush.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "sp_file_nearby_flower_tip", 0, "receiverGrayTip", "Ta送了你XX朵YY，快和Ta说声谢谢吧。"));
    this.jdField_c_of_type_JavaLangString = ((String)aush.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "sp_file_nearby_flower_tip", 0, "exchangeGrayTip", f));
    this.d = ((String)aush.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "sp_file_nearby_flower_tip", 0, "exchangeHighLight", g));
    jdField_b_of_type_Int = ((Integer)aush.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "sp_file_nearby_flower_tip", 0, "openFlag", Integer.valueOf(jdField_b_of_type_Int))).intValue();
    this.jdField_a_of_type_Int = ((Integer)aush.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "sp_file_nearby_flower_tip", 0, "scoreThreshold", Integer.valueOf(0))).intValue();
  }
  ...
  {
    azmj.b(null, "dc00899", "grp_lbs", "", paramString1, paramString2, 0, 0, paramString3, paramString4, paramString5, paramString6);
  }
  ...
  public MessageRecord a(String paramString1, String paramString2, int paramInt, AbsStructMsg paramAbsStructMsg)
  {
    ...
    if (paramString2 != null)
    {
      ...
      long l = ayvc.a();
      MessageForNewGrayTips localMessageForNewGrayTips = (MessageForNewGrayTips)ayvw.a(-2037);
    ...
    for (;;)
    {
      try
      {
        ...
        if ((!TextUtils.isEmpty(paramString2)) && (!paramString2.equals(this.jdField_a_of_type_JavaLangString)))
        {
          ...
          aush.a(paramString1, "sp_file_nearby_flower_tip", 0, "senderGrayTip", this.jdField_a_of_type_JavaLangString);
        }
        if ((!TextUtils.isEmpty(str1)) && (!paramString2.equals(this.jdField_b_of_type_JavaLangString)))
        {
          ...
          aush.a(paramString1, "sp_file_nearby_flower_tip", 0, "receiverGrayTip", this.jdField_b_of_type_JavaLangString);
        }
        if ((!TextUtils.isEmpty(str2)) && (!paramString2.equals(this.jdField_c_of_type_JavaLangString)))
        {
          ...
          aush.a(paramString1, "sp_file_nearby_flower_tip", 0, "exchangeGrayTip", this.jdField_c_of_type_JavaLangString);
        }
        if ((!TextUtils.isEmpty(str3)) && (!paramString2.equals(this.d)))
        {
          this.d = str3;
          aush.a(paramString1, "sp_file_nearby_flower_tip", 0, "exchangeHighLight", this.d);
        }
        if (i != jdField_b_of_type_Int)
        {
          jdField_b_of_type_Int = i;
          aush.a(paramString1, "sp_file_nearby_flower_tip", 0, "openFlag", Integer.valueOf(jdField_b_of_type_Int));
        }
        if (j != this.jdField_a_of_type_Int)
        {
          this.jdField_a_of_type_Int = j;
          aush.a(paramString1, "sp_file_nearby_flower_tip", 0, "scoreThreshold", Integer.valueOf(this.jdField_a_of_type_Int));
        }
        if (!QLog.isColorLevel()) {
          break;
        }
