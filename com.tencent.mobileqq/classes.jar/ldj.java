...
public class ldj
{
  ...
  public ldj(Context paramContext, int paramInt, long paramLong)
  {
  ...
  private File a(Context paramContext)
  {
    ...
    Object localObject = ldo.a(paramContext);
    if ((("mounted".equals(Environment.getExternalStorageState())) || (!ldo.a())) && (localObject != null)) {
  ...
  private String b(String paramString)
  {
    ...
    //   1: astore 4
    //   3: aload_1
    //   4: invokestatic 115	ldo:a	(Ljava/lang/String;)Ljava/lang/String;
    //   7: astore_1
    //   8: aload_0
    //   9: getfield 32	ldj:a	Lcom/jakewharton/disklrucache/DiskLruCache;
    //   12: aload_1
  ...
  public ldm a(String paramString1, long paramLong, String paramString2)
  {
    String str = a(ldo.a(paramString2, paramString1));
    if (str == null) {
      return null;
    }
    paramString2 = a(ldo.a(paramString2, paramString1, paramLong));
    paramString1 = Boolean.valueOf(false);
    if (paramString2 != null) {
      paramString1 = Boolean.valueOf(paramString2);
    }
    return new ldm(str, paramString1.booleanValue());
  }
  ...
  {
    a(ldo.a(paramString1, paramString2, paramLong), paramBoolean.toString());
  }
  
  public void a(String paramString1, String paramString2, long paramLong, Boolean paramBoolean, String paramString3)
  {
    a(ldo.a(paramString3, paramString1, paramLong), paramBoolean.toString());
    a(ldo.a(paramString3, paramString1), paramString2);
  }
}
