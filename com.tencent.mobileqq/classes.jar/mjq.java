...
public class mjq
{
  ...
  {
    if ((!paramBoolean) && (this.jdField_a_of_type_Mjr != null)) {
      this.jdField_a_of_type_Mjr.b(1);
    }
  }
  
  private void d()
  {
    this.jdField_a_of_type_AndroidHardwareDisplayVirtualDisplay = this.jdField_a_of_type_AndroidMediaProjectionMediaProjection.createVirtualDisplay("ScreenRecordHelper", this.jdField_b_of_type_Int, this.c, this.jdField_a_of_type_Int, 16, this.jdField_a_of_type_Lpd.a(), null, null);
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        {
          if (QLog.isDevelopLevel()) {
            QLog.i("ScreenRecordHelper", 4, "updateRecordParam, pre[" + this.jdField_a_of_type_Lwf + "], display[" + this.jdField_b_of_type_Int + "," + this.c + "], limit[" + i + "," + j + "], come[" + paramInt1 + "," + paramInt2 + "," + paramInt3 + "], record[" + m + "," + k + "]");
          }
          this.jdField_a_of_type_Lwf.jdField_a_of_type_Int = m;
          this.jdField_a_of_type_Lwf.jdField_b_of_type_Int = k;
          if (paramInt3 > 0) {
            this.jdField_a_of_type_Lwf.c = paramInt3;
          }
          if (this.jdField_a_of_type_Lpd != null) {
            this.jdField_a_of_type_Lpd.a(this.jdField_a_of_type_Lwf);
          }
          return;
          k = 0;
          break;
  ...
  public void a(Context paramContext)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Lpd.a(this.jdField_b_of_type_Int, this.c);
      this.jdField_a_of_type_Lpd.a(this.jdField_a_of_type_Lwf);
      this.jdField_a_of_type_Lpd.a();
  ...
  {
    if (this.jdField_a_of_type_Lpd != null) {
      this.jdField_a_of_type_Lpd.a(paramlpf);
    }
  }
  
  public void a(mjr parammjr)
  {
    this.jdField_a_of_type_Mjr = parammjr;
  }
  ...
  public boolean a(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Mjr != null) {
      this.jdField_a_of_type_Mjr.a(paramInt);
    }
    a(null);
    a(null);
    this.jdField_b_of_type_Boolean = false;
    mbb.a(VideoController.a().a, true);
    if (this.jdField_a_of_type_JavaLangRefWeakReference == null) {
  ...
  public boolean a(Intent paramIntent)
  {
    ...
    d();
    if (this.jdField_a_of_type_Mjr != null) {
      this.jdField_a_of_type_Mjr.a(this.jdField_a_of_type_Lwf, this.jdField_b_of_type_Int, this.c);
    }
    paramIntent = VideoController.a().a;
    if (Build.VERSION.SDK_INT >= 21) {
      lzq.a(l, 3, localContext, true, paramIntent.getCurrentAccountUin(), true);
    }
    mbb.a(paramIntent, 8, 0L, true);
  ...
  public void c()
  {
    ...
    if (this.jdField_a_of_type_Lpd != null)
    {
      this.jdField_a_of_type_Lpd.a(true);
      this.jdField_a_of_type_Lpd = null;
    }
