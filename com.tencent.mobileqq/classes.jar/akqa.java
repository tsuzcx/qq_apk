  ...
  extends aksu
{
  ...
  aukx jdField_a_of_type_Aukx = null;
  private Object jdField_a_of_type_JavaLangObject = new Object();
  
  public akqa(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager)
  {
      ...
      else
      {
        ...
        for (Object localObject = localArrayList;; localObject = null)
        {
          ...
          while (paramMessageForStructing.hasNext())
          {
            ...
            if (asuh.a((ChatMessage)localObject))
            {
              if (QLog.isColorLevel()) {
  ...
  private void a(MessageForStructing paramMessageForStructing, HashMap<String, ArrayList<MessageRecord>> paramHashMap1, HashMap<String, ArrayList<MessageRecord>> paramHashMap2, int paramInt, aktd paramaktd, boolean paramBoolean1, boolean paramBoolean2, ArrayList<MessageRecord> paramArrayList)
  {
    if (paramInt > 3) {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        for (;;)
        {
          ...
          paramMessageForStructing = a(paramMessageForStructing, (ArrayList)localObject, paramaktd, paramBoolean1, paramBoolean2, paramArrayList);
          ...
          while (paramMessageForStructing.hasNext())
          {
            localObject = (MessageRecord)paramMessageForStructing.next();
            if (asuh.a((ChatMessage)localObject)) {
              a((MessageForStructing)localObject, paramHashMap1, paramHashMap2, paramInt + 1, paramaktd, paramBoolean1, paramBoolean2, paramArrayList);
            }
          }
          break;
        }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage)
  {
    ...
    } while (!apug.a(paramQQAppInterface, (MessageForFile)paramChatMessage).sendCloudUnsuccessful());
    return false;
    return false;
  }
  ...
  private void b(MessageForStructing paramMessageForStructing, HashMap<String, ArrayList<MessageRecord>> paramHashMap, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (paramMessageForStructing.hasNext())
      {
        ...
        if (!asuh.a((ChatMessage)localMessageRecord1)) {
          continue;
        }
        if (paramInt != 2) {
          break label214;
        }
        MessageRecord localMessageRecord2 = a(localMessageRecord1, asty.jdField_a_of_type_JavaLangString, false);
  ...
  public ArrayList<MessageRecord> a(MessageRecord paramMessageRecord, ArrayList<? extends MessageRecord> paramArrayList, aktd paramaktd, boolean paramBoolean1, boolean paramBoolean2)
  {
    paramMessageRecord = a(paramMessageRecord, paramArrayList, paramaktd, paramBoolean1, paramBoolean2, new ArrayList(0));
    if (paramBoolean1) {
  ...
  public ArrayList<MessageRecord> a(MessageRecord paramMessageRecord, ArrayList<? extends MessageRecord> paramArrayList, aktd paramaktd, boolean paramBoolean1, boolean paramBoolean2, ArrayList<MessageRecord> paramArrayList1)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (paramBoolean2)
      {
          ...
          else if (localMessageRecord.msgtype == -1035)
          {
            ...
            if (((MessageForMixedMsg)localObject1).getReplyMessage(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) != null)
            {
              ...
              if ((localObject1 != null) && (localObject2 != null)) {
                apvm.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((MessageForReplyText)localObject1).getSourceMessage(), ((MessageForReplyText)localObject2).getSourceMessage());
              }
            }
          }
        ...
        if ((myb.a(paramArrayList)) && (myb.b(paramArrayList))) {
      ...
      apvm.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord, paramArrayList);
      ...
      if (paramBoolean1) {
        if (paramArrayList.getStatus() == 1000) {
          this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.c(paramArrayList.frienduin, paramArrayList.istroop, paramArrayList.getTableName(), paramArrayList, 0, paramaktd);
        } else {
  ...
  public ArrayList<MessageRecord> a(msg_comm.Msg paramMsg, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, azml paramazml)
  {
    ...
    Object localObject2 = axaq.a((MessageHandler)localObject3, paramMsg, String.valueOf(l3), String.valueOf(l3));
    long l1;
    ...
    for (long l2 = 0L;; l2 = l1)
    {
      ...
      int i;
      if (((axau.c(j)) || (j == 208) || (j == 529)) && (localMsgHead.c2c_cmd.has()))
      {
        ...
        if ((j == 529) && (i == 4))
        {
          ...
          paramazml = localMsgHead.from_nick.get();
          paramHashMap.put(String.valueOf(l3), localMsgHead.from_nick.get());
        }
      }
      for (paramHashMap = paramazml;; paramHashMap = (HashMap<String, String>)localObject1)
      {
        if (((paramMessageRecord instanceof MessageForStructing)) && (((MessageForStructing)paramMessageRecord).structingMsg != null) && (((MessageForStructing)paramMessageRecord).structingMsg.mMsgServiceID == 107)) {
          axaq.a((MessageHandler)localObject3, (List)localObject2, paramMsg);
        }
        l1 = l3;
        int k = axaq.a(paramMsg);
        localObject1 = ((ArrayList)localObject2).iterator();
        i = 0;
        if (((Iterator)localObject1).hasNext())
        {
          paramazml = (MessageRecord)((Iterator)localObject1).next();
          paramMsg = paramazml;
          if (!avpj.a(paramMessageRecord))
          {
            paramMsg = paramazml;
            if (!asuh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)paramazml))
            {
              paramMsg = paramazml;
              if (!(paramazml instanceof MessageForArkApp))
              {
                if (QLog.isColorLevel()) {
                  QLog.d("MultiMsg_TAG", 2, "not support multi forward msg! " + paramazml.toString());
                }
                paramMsg = axas.a(-1000);
          ...
          paramMsg.vipBubbleID = akfv.a((int)l2, k);
          asuh.a(paramMsg, paramHashMap, paramMessageRecord);
          if ((j == 82) || (j == 43)) {
            paramMsg.istroop = 1;
          }
          for (;;)
          {
            ...
            axaq.a((MessageHandler)localObject3, (List)localObject2, paramMsg, true, false, paramazml);
            break label328;
            if (((j == 82) || (j == 43)) && (localMsgHead.group_info.has()))
            {
              ...
              if (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a((ArrayList)localObject2, paramMsg)) {
                axaq.a((MessageHandler)localObject3, (List)localObject2, paramMsg, false, false, paramazml);
              }
              paramazml = (azml)localObject1;
              ...
              if (((paramMessageRecord instanceof MessageForStructing)) && (((MessageForStructing)paramMessageRecord).structingMsg != null) && (((MessageForStructing)paramMessageRecord).structingMsg.mMsgServiceID == 107)) {
                axaq.a((MessageHandler)localObject3, paramMsg, (List)localObject2);
              }
                      ...
                      if (((im_msg_body.Elem)localObject1).anon_group_msg.has())
                      {
                        ...
                        for (;;)
                        {
                          try
                          {
                            ...
                            localObject1 = "";
                            localMessageRecord.saveExtInfoToExtStr("anonymous", myb.a(i, paramHashMap, (String)localObject1, k, m, str));
  ...
  public ArrayList<MessageRecord> a(byte[] paramArrayOfByte, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, azml paramazml)
  {
    ...
    localObject2 = axaq.a(localMessageHandler, (msg_comm.Msg)localObject3, String.valueOf(l3), String.valueOf(l3));
    long l1;
    if (((Long)((Pair)localObject2).first).longValue() != 4294967295L)
    {
      l1 = ((Long)((Pair)localObject2).first).longValue();
    ...
    for (long l2 = 0L;; l2 = l1)
    {
      localObject2 = new ArrayList();
      int k;
      if (((axau.c(j)) || (j == 208)) && (((msg_comm.MsgHead)localObject4).c2c_cmd.has()))
      {
        ...
        else
        {
          ...
          if (((paramMessageRecord instanceof MessageForStructing)) && (((MessageForStructing)paramMessageRecord).structingMsg != null) && (((MessageForStructing)paramMessageRecord).structingMsg.mMsgServiceID == 107)) {
            axaq.a(localMessageHandler, (List)localObject2, (msg_comm.Msg)localObject3);
          }
          l1 = l3;
          k = axaq.a((msg_comm.Msg)localObject3);
      ...
      for (;;)
      {
        ...
        ((MessageRecord)localObject4).vipBubbleID = akfv.a((int)l2, k);
        if ((j == 82) || (j == 43))
        {
          ...
          l1 = ((Long)((Pair)localObject2).second).longValue();
          break;
          axaq.a(localMessageHandler, (List)localObject2, (msg_comm.Msg)localObject3, true, false, paramazml);
          break label497;
          if (((j == 82) || (j == 43)) && (((msg_comm.MsgHead)localObject4).group_info.has()))
          {
            ...
            if (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a((ArrayList)localObject2, (msg_comm.Msg)localObject3)) {
              axaq.a(localMessageHandler, (List)localObject2, (msg_comm.Msg)localObject3, false, false, paramazml);
            }
            ...
            if (((paramMessageRecord instanceof MessageForStructing)) && (((MessageForStructing)paramMessageRecord).structingMsg != null) && (((MessageForStructing)paramMessageRecord).structingMsg.mMsgServiceID == 107)) {
              axaq.a(localMessageHandler, (msg_comm.Msg)localObject3, (List)localObject2);
            }
            break label575;
          }
  ...
  public HashMap<String, ArrayList<MessageRecord>> a(MessageRecord paramMessageRecord, HashMap<String, ArrayList<MessageRecord>> paramHashMap, aktd paramaktd, boolean paramBoolean1, boolean paramBoolean2)
  {
    HashMap localHashMap = new HashMap();
    ArrayList localArrayList = new ArrayList();
    ...
    do
    {
      ...
      {
        return localHashMap;
        if (asuh.a((ChatMessage)paramMessageRecord)) {
          break;
        }
      } while (!QLog.isColorLevel());
      QLog.d("MultiMsg_TAG", 2, "preAddMultiMsgWithNest error before of not structMsg");
      return localHashMap;
      a((MessageForStructing)paramMessageRecord, paramHashMap, localHashMap, 0, paramaktd, paramBoolean1, paramBoolean2, localArrayList);
  ...
  public HashMap<String, ArrayList<MessageRecord>> a(byte[] paramArrayOfByte, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, azml paramazml)
  {
    ...
    try
    {
      ...
      if (paramArrayOfByte.msg.has())
      {
        ...
        {
          localObject3 = a((msg_comm.Msg)paramArrayOfByte.msg.get(i), paramHashMap, paramMessageRecord, paramazml);
    ...
    if (!a(paramMessageRecord, (HashMap)localObject1, null))
    {
      ...
      if (i < paramArrayOfByte.pbItemList.size())
      {
        ...
        try
        {
          ...
          {
            ArrayList localArrayList = a((msg_comm.Msg)((msg_transmit.PbMultiMsgNew)localObject3).msg.get(j), paramHashMap, paramMessageRecord, paramazml);
  ...
  public msg_comm.MsgHead a(MessageRecord paramMessageRecord, HashMap<String, String> paramHashMap, boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
    ...
    localMsgHead.from_uin.set(Long.valueOf(akpx.c(paramMessageRecord)).longValue());
    ...
    if (paramBoolean1)
    {
      ...
      String str = akpx.c(paramMessageRecord);
      ...
      asuh.a("step:packPb.getMsgHead.nickName = %s", new Object[] { localObject1 });
  ...
  public im_msg_body.MsgBody a(MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    if ((paramMessageRecord.msgtype == -1000) || (paramMessageRecord.msgtype == -10000)) {
      if (!TextUtils.isEmpty(paramMessageRecord.getExtInfoFromExtStr("sens_msg_source_msg_info"))) {
        localObject1 = axaq.a(paramMessageRecord);
      }
    }
    for (;;)
    {
      if ((localObject1 != null) && (!((im_msg_body.RichText)localObject1).elems.isEmpty()))
      {
        ...
        if (myb.a(paramMessageRecord))
        {
          ...
          myc localmyc = myb.a(paramMessageRecord);
          ((im_msg_body.AnonymousGroupMsg)localObject4).uint32_flags.set(localmyc.jdField_a_of_type_Int);
          if (!TextUtils.isEmpty(localmyc.jdField_a_of_type_JavaLangString)) {
            ((im_msg_body.AnonymousGroupMsg)localObject4).str_anon_id.set(ByteStringMicro.copyFrom(localmyc.jdField_a_of_type_JavaLangString.getBytes()));
          }
          if (!TextUtils.isEmpty(localmyc.jdField_b_of_type_JavaLangString)) {
            ((im_msg_body.AnonymousGroupMsg)localObject4).str_anon_nick.set(ByteStringMicro.copyFrom(localmyc.jdField_b_of_type_JavaLangString.getBytes()));
          }
          ((im_msg_body.AnonymousGroupMsg)localObject4).uint32_head_portrait.set(localmyc.jdField_b_of_type_Int);
          ((im_msg_body.AnonymousGroupMsg)localObject4).uint32_expire_time.set(localmyc.jdField_c_of_type_Int);
          if (!TextUtils.isEmpty(localmyc.jdField_c_of_type_JavaLangString)) {
            ((im_msg_body.AnonymousGroupMsg)localObject4).str_rank_color.set(ByteStringMicro.copyFrom(localmyc.jdField_c_of_type_JavaLangString.getBytes()));
          }
        ...
        return paramMessageRecord;
        localObject1 = axaq.a((MessageForText)paramMessageRecord);
        continue;
        if (paramMessageRecord.msgtype == -1049)
        {
          localObject1 = axaq.a((MessageForReplyText)paramMessageRecord);
          continue;
        }
        if (paramMessageRecord.msgtype == -2005)
        {
          if (paramBoolean)
          {
            localObject1 = ajya.a(2131707022);
            if ((paramMessageRecord instanceof MessageForFile)) {
              localObject1 = ((MessageForFile)paramMessageRecord).getSummaryMsg();
            }
            localObject1 = axaq.a((MessageForText)a(paramMessageRecord, (String)localObject1, false));
            continue;
          }
        ...
        if (paramMessageRecord.msgtype == -2017)
        {
          if (paramBoolean)
          {
            localObject1 = ajya.a(2131707020);
        ...
        {
          localObject1 = axaq.a((MessageForQQStoryComment)paramMessageRecord);
          continue;
        }
        if (paramMessageRecord.msgtype == -2000)
        {
          localObject1 = axaq.a((MessageForPic)paramMessageRecord);
          continue;
        }
        if (paramMessageRecord.msgtype == -5008)
        {
          localObject1 = axaq.a((MessageForArkApp)paramMessageRecord, true);
          continue;
        }
        if (paramMessageRecord.msgtype == -5016)
        {
          localObject1 = axaq.c((MessageForArkBabyqReply)paramMessageRecord, true);
          continue;
        }
        if (paramMessageRecord.msgtype == -5017)
        {
          localObject1 = axaq.b((MessageForArkApp)paramMessageRecord, true);
          continue;
        }
        if (paramMessageRecord.msgtype == -5013)
        {
          localObject1 = axaq.c((MessageForArkFlashChat)paramMessageRecord);
          continue;
        }
        if (paramMessageRecord.msgtype == -5014)
        {
          localObject1 = axaq.d((MessageForHiBoom)paramMessageRecord);
          continue;
        }
        if (paramMessageRecord.msgtype == -2011)
        {
          localObject3 = axaq.a((MessageForStructing)paramMessageRecord);
          if (localObject3 == null) {
            return null;
          }
          ...
          try
          {
            ...
            localObject1 = ((axwv)localObject4).a.richText;
            if (localObject1 == null) {
              return null;
            }
        ...
        if (paramMessageRecord.msgtype == -1035)
        {
          ...
          if (i < k)
          {
            ...
            {
              localObject3 = axaq.a((MessageForText)localObject3);
              if (localObject3 == null) {
                return null;
              }
              j = 0;
            ...
            for (;;)
            {
              ...
              {
                localObject3 = axaq.a((MessageForReplyText)localObject3);
                if (localObject3 != null)
                {
                  j = 0;
                  while (j < ((im_msg_body.RichText)localObject3).elems.size())
        ...
        {
          localObject2 = axaq.a((MessageForLongTextMsg)paramMessageRecord, false);
          continue;
        }
  ...
  protected void a(MessageRecord paramMessageRecord, List<MessageRecord> paramList, aktd paramaktd)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.c(localMessageRecord1.frienduin, localMessageRecord1.istroop, localMessageRecord1.getTableName(), localMessageRecord1, 0, paramaktd);
    }
  }
  ...
  public boolean a(MessageRecord paramMessageRecord, aktd paramaktd)
  {
  ...
  public boolean a(MessageRecord paramMessageRecord, HashMap<String, ArrayList<MessageRecord>> paramHashMap, aktd paramaktd)
  {
    if ((paramMessageRecord == null) || (paramHashMap == null)) {
      if (QLog.isColorLevel()) {
  ...
  protected boolean a(MessageRecord paramMessageRecord, List<MessageRecord> paramList, aktd paramaktd)
  {
    a(paramMessageRecord, paramList, paramaktd);
    this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.d();
    return true;
  }
  ...
  public boolean a(List<MessageRecord> paramList, aktd paramaktd)
  {
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      paramaktd = (MessageRecord)paramList.next();
      if (paramaktd.getStatus() == 1000) {
        this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.c(paramaktd.frienduin, paramaktd.istroop, paramaktd.getTableName(), paramaktd, 3, null);
      } else {
        this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.c(paramaktd.frienduin, paramaktd.istroop, paramaktd.getTableName(), paramaktd, 4, null);
      }
    }
    this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.d();
    return true;
    ...
    for (;;)
    {
      ...
      if ((paramHashMap != null) && (paramHashMap.size() > 0))
      {
        ...
        if (((Iterator)localObject1).hasNext())
        {
          ...
          if (!asuh.a((ChatMessage)paramHashMap)) {
            break label610;
          }
          paramHashMap = a(paramHashMap, asty.jdField_b_of_type_JavaLangString, false);
        }
      }
      for (;;)
      {
