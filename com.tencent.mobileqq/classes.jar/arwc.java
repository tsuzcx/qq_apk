  ...
  implements Manager
{
  ...
  private apqs jdField_a_of_type_Apqs;
  private arwg jdField_a_of_type_Arwg;
  private arwh jdField_a_of_type_Arwh;
  private arwi jdField_a_of_type_Arwi;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private HashMap<Long, WeakReference<arwf>> jdField_a_of_type_JavaUtilHashMap = new HashMap(5);
  private boolean jdField_a_of_type_Boolean = true;
  private HashMap<Long, WeakReference<arwd>> b = new HashMap(20);
  private HashMap<Long, Boolean> c = new HashMap(200);
  private HashMap<Long, WeakReference<arwe>> d = new HashMap(5);
  private HashMap<Long, ArrayList<Long>> e = new HashMap(5);
  private HashMap<Long, ArrayList<Long>> f = new HashMap(5);
  
  public arwc(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Apqs = ((apqs)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(323));
  }
  ...
  private ArrayList<Long> a(long paramLong)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 58	arwc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   20: aload_0
    //   21: getfield 58	arwc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
  ...
  private void a(long paramLong, arwf paramarwf)
  {
    ThreadManager.getSubThreadHandler().post(new MultiCardManager.3(this, paramLong, paramarwf));
  }
  
  private void a(long paramLong, ArrayList<Long> paramArrayList, arwd paramarwd)
  {
    ThreadManager.getSubThreadHandler().post(new MultiCardManager.2(this, paramLong, paramArrayList, paramarwd));
  }
  
  private void a(long paramLong, ArrayList<Long> paramArrayList, arwe paramarwe)
  {
    ThreadManager.getSubThreadHandler().post(new MultiCardManager.1(this, paramArrayList, paramLong, paramarwe));
  }
  ...
  public IntimateInfo a(long paramLong1, long paramLong2)
  {
    ...
    if (localIntimateInfo2 == null)
    {
      ...
      localIntimateInfo2 = this.jdField_a_of_type_Apqs.a(str);
  ...
  public void a(long paramLong)
  {
    ...
    if (this.jdField_a_of_type_Arwg == null) {
      this.jdField_a_of_type_Arwg = new arwg(this, null);
    }
    if (this.jdField_a_of_type_Arwh == null) {
      this.jdField_a_of_type_Arwh = new arwh(this, null);
    }
    if (this.jdField_a_of_type_Arwi == null) {
      this.jdField_a_of_type_Arwi = new arwi(this, null);
    }
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Arwg);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Arwh);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Arwi);
  }
  ...
  public void a(Context arg1, long paramLong, arwf paramarwf)
  {
    if (QLog.isColorLevel()) {
      QLog.d("MultiCardManager", 2, String.format("getGroupRecommendUinLists, uin: %d", new Object[] { Long.valueOf(paramLong) }));
    }
    if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (paramarwf != null))
    {
      if (!badq.d(???)) {
        a(paramLong, paramarwf);
      }
    }
    else {
      return;
    ...
    synchronized (this.f)
    {
      ...
      if (localArrayList != null)
      {
        ...
        paramarwf.a(paramLong, localArrayList);
        return;
      }
    }
    paramarwf = new WeakReference(paramarwf);
    synchronized (this.jdField_a_of_type_JavaUtilHashMap)
    {
      this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(paramLong), paramarwf);
      ((apqq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(153)).a(paramLong, 10000L);
      return;
    }
  }
  
  public void a(Context paramContext, long paramLong, ArrayList<Long> arg4, arwd paramarwd)
  {
    if (QLog.isColorLevel())
    {
    ...
    for (Object localObject1 = ???.toString();; localObject1 = "null")
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (paramarwd != null) && (??? != null))
      {
        if (badq.d(paramContext)) {
          break;
        }
        a(paramLong, ???, paramarwd);
      }
      return;
    }
    ...
    {
      paramarwd.a(a(paramLong, (ArrayList)localObject1));
      return;
    }
    a(paramLong, ???, paramarwd);
    paramarwd = new WeakReference(paramarwd);
    synchronized (this.b)
    {
      this.b.put(Long.valueOf(paramLong), paramarwd);
      ??? = new HashMap(5);
      ???.put("alreadyRequest", localObject1);
      ???.put("notRequest", paramContext);
      paramarwd = new ArrayList(1);
      paramarwd.add(Long.valueOf(paramLong));
      ???.put("groupUin", paramarwd);
      ((apqq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(153)).a(paramLong, paramContext, ???);
      return;
    }
  }
  
  public void a(Context arg1, long paramLong, ArrayList<Long> paramArrayList, arwe paramarwe)
  {
    Object localObject2;
    if (QLog.isColorLevel())
    {
    ...
    {
      QLog.d("MultiCardManager", 2, (String)localObject1);
      if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (paramarwe != null) && (paramArrayList != null))
      {
        if (badq.d(???)) {
          break;
        }
        a(paramLong, paramArrayList, paramarwe);
      }
      return;
    }
    synchronized (this.e)
    ...
    for (;;)
    {
      ...
      paramArrayList = new WeakReference(paramarwe);
      synchronized (this.d)
      {
        this.d.put(Long.valueOf(paramLong), paramArrayList);
        ((ajtg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(false, paramLong + "", "0", 9);
        return;
        label317:
  ...
  public void a(String paramString, IntimateInfo paramIntimateInfo)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Apqs.a(paramString, paramIntimateInfo);
  ...
  public void b(long paramLong)
  {
    ...
    if (this.jdField_a_of_type_Arwg != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Arwg);
      this.jdField_a_of_type_Arwg = null;
    }
    if (this.jdField_a_of_type_Arwh != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Arwh);
      this.jdField_a_of_type_Arwh = null;
    }
    if (this.jdField_a_of_type_Arwi != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Arwi);
      this.jdField_a_of_type_Arwi = null;
    }
