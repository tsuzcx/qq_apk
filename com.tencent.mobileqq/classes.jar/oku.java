...
public class oku
  implements scz
{
  public oku(ReadInJoyNewFeedsActivity paramReadInJoyNewFeedsActivity) {}
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if ((paramInt1 == paramInt2) && (paramInt2 == 0) && ((this.a.a() instanceof ReadInJoySubChannelFragment)))
    {
      ...
      localView = this.a.b.findViewById(2131378964);
      if (localView.getVisibility() == 0)
      {
        if (paramInt1 != 0) {
          break label167;
        }
        ((TextView)localView.findViewById(2131369088)).setText(anzj.a(2131693174));
        label107:
        localView.clearAnimation();
        localAlphaAnimation = new AlphaAnimation(1.0F, 0.0F);
        localAlphaAnimation.setDuration(250L);
        localAlphaAnimation.setAnimationListener(new okv(this, localView));
    ...
    do
    {
      ...
      if (paramInt1 == 1)
      {
        ((TextView)localView.findViewById(2131369088)).setText(anzj.a(2131711768));
        break label107;
      }
      if (paramInt1 != 2) {
        break label107;
      }
      ((TextView)localView.findViewById(2131369088)).setText(anzj.a(2131711925));
      break label107;
      localView = this.a.b.findViewById(2131378964);
    ...
    localAlphaAnimation.setAnimationListener(new okw(this, localView));
    localView.startAnimation(localAlphaAnimation);
  }
}
