  ...
  extends bbqu
{
  ...
  {
    if ((!paramBoolean) || (paramObject == null) || (ajhm.a(this.a) == null)) {
      return;
    }
    if (QLog.isColorLevel()) {
    ...
    int i = ((SharedPreferences)localObject).getInt("apollo_zan_count" + ajhm.a(this.a), 0);
    ((SharedPreferences)localObject).edit().putInt("apollo_zan_count" + ajhm.a(this.a), ((Integer)paramObject).intValue()).commit();
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ajhm.a(this.a).a((String)localObject, i, ((Integer)paramObject).intValue());
        return;
      }
    }
  }
  ...
  {
    if ((paramObject == null) || (ajhm.a(this.a) == null) || (ajhm.a(this.a) == null)) {
      return;
    }
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      try
      {
        ...
        ((SharedPreferences)localObject).edit().putBoolean(ajhm.a(this.a).getCurrentAccountUin() + "apollo_today_has_vote" + ajhm.a(this.a) + localCalendar.get(1) + localCalendar.get(2) + localCalendar.get(5), true).commit();
        if (((Integer)paramObject).intValue() <= 99999) {
          break label378;
        }
        paramObject = Integer.valueOf(99999);
        ajhm.a(this.a).b(((Integer)paramObject).intValue());
        return;
      }
      ...
      if (QLog.isColorLevel()) {
        QLog.d("ApolloGuestsPresenter", 2, "today has vote to " + ajhm.a(this.a));
      }
      paramObject = BaseApplicationImpl.getApplication().getSharedPreferences("cmshow_zan", 0);
      Object localObject = Calendar.getInstance();
      paramObject.edit().putBoolean(ajhm.a(this.a).getCurrentAccountUin() + "apollo_today_has_vote" + ajhm.a(this.a) + ((Calendar)localObject).get(1) + ((Calendar)localObject).get(2) + ((Calendar)localObject).get(5), true).commit();
      return;
    }
  }
}
