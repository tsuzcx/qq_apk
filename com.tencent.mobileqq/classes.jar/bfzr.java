  ...
  extends bfzk
{
  ...
  public bfzr(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(long paramLong1, PubAccountNavigationMenu paramPubAccountNavigationMenu, long paramLong2)
  {
    ...
    try
    {
      ...
      for (int i = 0;; i = paramPubAccountNavigationMenu.version)
      {
        ...
        ((subcmd0x519.CRMMsgHead)localObject1).uint32_ver_no.set(bgab.a("8.3.5"));
  ...
  private void a(awgf paramawgf)
  {
    if (paramawgf != null)
    {
      paramawgf = paramawgf.a(PubAccountNavigationMenu.class);
      if (paramawgf != null)
      {
        paramawgf = paramawgf.iterator();
        while (paramawgf.hasNext())
        {
          PubAccountNavigationMenu localPubAccountNavigationMenu = (PubAccountNavigationMenu)paramawgf.next();
          if (QLog.isColorLevel()) {
  ...
  public void a(long paramLong)
  {
    if (!jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
    {
      ...
      if (localObject != null)
      {
        localObject = (PubAccountNavigationMenu)((awgf)localObject).a(PubAccountNavigationMenu.class, new String[] { String.valueOf(paramLong) });
        if (localObject != null) {
