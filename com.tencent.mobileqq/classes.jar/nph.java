...
public class nph
{
  ...
  public static void a(ProteusInnerData paramProteusInnerData, int paramInt)
  {
    ...
    nbe.a(new nmv().a(localQQAppInterface).a(BaseApplication.getContext()).a(nbe.a).b(nbe.W).a(npk.a(paramProteusInnerData)).d(paramInt).d(nbe.a(paramProteusInnerData)).a());
  }
}
