...
public class atbt
{
  ...
  private static String a(android.graphics.Bitmap paramBitmap)
  {
    ...
    //   6: dup
    //   7: getstatic 30	ajsd:cf	Ljava/lang/String;
    //   10: invokestatic 35	bbvj:a	(Ljava/lang/String;)Ljava/lang/String;
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, aywb paramaywb)
  {
    paramaywb.addFilter(new Class[] { aysv.class });
    paramQQAppInterface.a().a(paramaywb);
  ...
  {
    new axrc(null).a("dc00899").b("grp_lbs").c(paramString1).d(paramString2).a(paramInt1).b(paramInt2).a(paramVarArgs).a();
  }
  ...
  public static boolean a(Activity paramActivity, QQAppInterface paramQQAppInterface)
  {
    ...
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, actj.a(150.0F, paramActivity.getResources()));
    new atye(paramActivity).a(localImageView, localLayoutParams).b(ajya.a(2131707402)).a(new atxy(ajya.a(2131707404), new atbu(paramActivity, paramQQAppInterface))).show();
