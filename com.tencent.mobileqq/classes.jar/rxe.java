...
public class rxe
{
  ...
  private rxg jdField_a_of_type_Rxg;
  ...
  public rxe(Fragment paramFragment)
  {
  ...
  public rxe(ViolaFragment paramViolaFragment)
  {
    this.jdField_d_of_type_Boolean = true;
    this.jdField_e_of_type_Boolean = true;
  ...
  private static HashMap<String, Object> a(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      if (paramString.contains("hideNav=1"))
      {
        ...
        if (!TextUtils.isEmpty(rwa.a(paramString, "v_nav_bgclr"))) {
          localHashMap.put(jdField_c_of_type_JavaLangString, rwa.a(paramString, "v_nav_bgclr"));
        }
        if (!TextUtils.isEmpty(rwa.a(paramString, "v_nav_txtclr"))) {
          localHashMap.put(jdField_d_of_type_JavaLangString, rwa.a(paramString, "v_nav_txtclr"));
        }
        if (!TextUtils.isEmpty(rwa.a(paramString, "v_nav_titleclr"))) {
          localHashMap.put(jdField_e_of_type_JavaLangString, rwa.a(paramString, "v_nav_titleclr"));
        }
        if (!TextUtils.isEmpty(rwa.a(paramString, "v_nav_alpha"))) {
          localHashMap.put(jdField_f_of_type_JavaLangString, rwa.a(paramString, "v_nav_alpha"));
        }
        str = i;
        ...
        if (!TextUtils.isEmpty(rwa.a(paramString, "statusBarColor"))) {
          localHashMap.put(jdField_g_of_type_JavaLangString, rwa.a(paramString, "statusBarColor"));
        }
        str = j;
        ...
        label336:
        localHashMap.put(str, Boolean.valueOf(bool1));
        if (!TextUtils.isEmpty(rwa.a(paramString, "v_present_radius"))) {
          localHashMap.put(n, rwa.a(paramString, "v_present_radius"));
        }
        if (!TextUtils.isEmpty(rwa.a(paramString, "v_present_top"))) {
          localHashMap.put(o, rwa.a(paramString, "v_present_top"));
        }
        if (!TextUtils.isEmpty(rwa.a(paramString, "v_present_titleHeight"))) {
          localHashMap.put(u, rwa.a(paramString, "v_present_titleHeight"));
        }
        str = v;
      ...
      for (boolean bool1 = bool2;; bool1 = false)
      {
        ...
        if (paramString.contains("v_bg_color")) {
          localHashMap.put(y, "#" + rwa.a(paramString, "v_bg_color"));
        }
        return localHashMap;
        i1 = 0;
        break;
  ...
  {
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramViewGroup.findViewById(2131372592));
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(0);
  }
  
  private void e()
  {
    if (this.jdField_a_of_type_Rxg == null) {
      this.jdField_a_of_type_Rxg = new rxf(this);
    }
  }
  ...
  public rxg a()
  {
    return this.jdField_a_of_type_Rxg;
  }
  ...
  public void a()
  {
    ...
    while ((this.jdField_a_of_type_Bcsc == null) || (this.jdField_a_of_type_Bcsc.b() == 0)) {
      return;
    }
  ...
  public void a(ViewGroup paramViewGroup, View.OnClickListener paramOnClickListener)
  {
    if (!b())
    {
      this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)paramViewGroup.findViewById(2131379243));
    ...
    {
      this.jdField_a_of_type_AndroidViewView = ((ViewStub)paramViewGroup.findViewById(2131379244)).inflate();
      if (this.jdField_b_of_type_Int != -1) {
        this.jdField_a_of_type_AndroidViewView.setBackgroundColor(this.jdField_b_of_type_Int);
      }
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374766));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374765));
    }
    this.jdField_a_of_type_AndroidWidgetTextView.setText(paramViewGroup.getResources().getString(2131718536));
    ...
    for (;;)
    {
      ...
      ((LinearLayout.LayoutParams)this.jdField_a_of_type_AndroidWidgetTextView.getLayoutParams()).topMargin = actn.a(10.0F, paramViewGroup.getResources());
      return;
  ...
  public void a(HashMap<String, Object> paramHashMap, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      if ((paramHashMap.containsKey(o)) && (paramViewGroup != null))
      {
        ...
        this.jdField_a_of_type_Int = actn.a(i1, paramViewGroup.getResources());
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaViolaFragment.a(ajyc.a(2131716467), null);
  ...
  public void b()
  {
    ...
    while ((this.jdField_a_of_type_Bcsc == null) || (this.jdField_a_of_type_Bcsc.b() == 2)) {
      return;
    }
  ...
  public void b(ViewGroup paramViewGroup)
  {
    ...
    do
    {
      ...
      RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, actn.a(3.0F, paramViewGroup.getContext().getResources()));
    ...
    } while ((rys.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaViolaFragment.a())) && (anqa.i()) && (anqb.i()));
    a();
  }
