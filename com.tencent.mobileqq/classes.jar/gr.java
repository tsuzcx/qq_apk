public final class gr
{
  ...
  {
    int j = paramgr.jdField_a_of_type_Int;
  ...
  {
    if (this.jdField_a_of_type_ArrayOfInt.length != paramgr.jdField_a_of_type_ArrayOfInt.length) {
    ...
    {
      int[] arrayOfInt = this.jdField_a_of_type_ArrayOfInt;
      arrayOfInt[i] ^= paramgr.jdField_a_of_type_ArrayOfInt[i];
      i += 1;
    }
  }
