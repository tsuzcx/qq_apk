...
public class autx
{
  ...
  private static auty a()
  {
    Object localObject1 = BaseApplication.getContext();
    auty localauty = new auty();
    try
    {
      String str1;
      String str2;
      ...
      try
      {
        ...
        if ((str3 != null) && (str3.startsWith("ctwap"))) {
          ...
          {
            localauty.jdField_a_of_type_JavaLangString = str1;
            localauty.jdField_a_of_type_Int = Integer.valueOf(str2).intValue();
          }
          else
          {
            localauty.jdField_a_of_type_JavaLangString = "10.0.0.200";
            localauty.jdField_a_of_type_Int = 80;
          }
        }
      }
      ...
      if ((str3 != null) && (str3.startsWith("cmwap")))
      {
        ...
        {
          localauty.jdField_a_of_type_JavaLangString = "10.0.0.172";
          localauty.jdField_a_of_type_Int = 80;
        }
      }
  ...
  public static InetSocketAddress a()
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          localObject1 = a();
          str = ((auty)localObject1).jdField_a_of_type_JavaLangString;
          i = ((auty)localObject1).jdField_a_of_type_Int;
        }
      }
    }
  }
