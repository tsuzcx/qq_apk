  ...
  implements GetChars, Spannable, CharSequence, Cloneable
{
  ...
  private ArrayList<bczt> jdField_b_of_type_JavaUtilArrayList = new ArrayList();
  
  public bczs(CharSequence paramCharSequence, int paramInt)
  {
      ...
      if ((paramStringBuilder.charAt(paramInt1) == '<') && (paramInt1 < k - 2))
      {
        ...
        else
        {
          ...
          if (((i2 == 37) || (i2 == 38)) && (paramInt1 < k - 6))
          {
            ...
            a(new bged(i, (i1 & 0xFF) + ((j << 24) + 0 + (m << 16 & 0xFF0000) + (n << 8 & 0xFF00))), paramInt1, paramInt1 + 7, 33);
            paramInt1 += 7;
            continue;
          }
        }
  ...
  private void a(Object paramObject, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    paramObject = new bczt(paramInt1, paramInt2, paramInt3);
  ...
  public int getSpanEnd(Object paramObject)
  {
    ...
    return ((bczt)this.jdField_b_of_type_JavaUtilArrayList.get(i)).b;
  }
  ...
  public int getSpanFlags(Object paramObject)
  {
    ...
    return ((bczt)this.jdField_b_of_type_JavaUtilArrayList.get(i)).c;
  }
  ...
  public int getSpanStart(Object paramObject)
  {
    ...
    return ((bczt)this.jdField_b_of_type_JavaUtilArrayList.get(i)).jdField_a_of_type_Int;
  }
  ...
  public <T> T[] getSpans(int paramInt1, int paramInt2, Class<T> paramClass)
  {
    ...
    while (i < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      {
        bczt localbczt = (bczt)this.jdField_b_of_type_JavaUtilArrayList.get(i);
        if ((localbczt.jdField_a_of_type_Int >= paramInt1) && (localbczt.b <= paramInt2)) {
  ...
  public int nextSpanTransition(int paramInt1, int paramInt2, Class paramClass)
  {
    ...
    while (k < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      bczt localbczt = (bczt)this.jdField_b_of_type_JavaUtilArrayList.get(k);
      int i = paramInt2;
      if (((Class)localObject).isInstance(paramClass))
      {
        int j = paramInt2;
        if (localbczt.jdField_a_of_type_Int > paramInt1)
        {
          j = paramInt2;
          if (localbczt.jdField_a_of_type_Int < paramInt2) {
            j = localbczt.jdField_a_of_type_Int;
          }
        }
        i = j;
        if (localbczt.b > paramInt1)
        {
          i = j;
          if (localbczt.b < j) {
            i = localbczt.b;
  ...
  public void removeSpan(Object paramObject)
  {
    ...
    if (i >= 0)
    {
      ...
      bczt localbczt = (bczt)this.jdField_b_of_type_JavaUtilArrayList.remove(i);
      b(paramObject, localbczt.jdField_a_of_type_Int, localbczt.b);
    }
  }
  ...
  public void setSpan(Object paramObject, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      localbczt = (bczt)this.jdField_b_of_type_JavaUtilArrayList.get(i);
      int j = localbczt.jdField_a_of_type_Int;
      int k = localbczt.b;
      localbczt.jdField_a_of_type_Int = paramInt1;
      localbczt.b = paramInt2;
      localbczt.c = paramInt3;
      a(paramObject, j, k, paramInt1, paramInt2);
    }
    if (i < 0)
    {
      this.jdField_a_of_type_JavaUtilArrayList.add(paramObject);
      localbczt = new bczt(paramInt1, paramInt2, paramInt3);
      this.jdField_b_of_type_JavaUtilArrayList.add(localbczt);
