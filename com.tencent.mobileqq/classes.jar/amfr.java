  ...
  extends MqqHandler
{
  ...
  public amfr(Looper paramLooper, VideoBroadcastReceiver paramVideoBroadcastReceiver)
  {
    super(paramLooper);
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        do
        {
          ...
          case 0: 
            ...
            if (i == 1006)
            {
              ...
              localObject1 = ((aufv)localQQAppInterface.getManager(11)).a();
            ...
            for (;;)
            {
              acjm.b(localQQAppInterface, paramMessage, (SessionInfo)localObject3, (String)localObject2);
              return;
              if (i == 1000)
              {
          ...
          case 1: 
            ...
            localObject1 = (bdjz)paramMessage[0];
        ...
        } while (!((bdjz)localObject1).isShowing());
        ((bdjz)localObject1).dismiss();
        if (!bool2) {}
        ...
        paramMessage = (bdjz)localObject4[0];
      ...
      return;
      paramMessage = (bdjz)((Object[])(Object[])paramMessage.obj)[0];
    } while (!paramMessage.isShowing());
    paramMessage.dismiss();
    return;
