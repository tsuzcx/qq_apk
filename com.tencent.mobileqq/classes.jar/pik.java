...
public class pik
{
  ...
  private static pil jdField_a_of_type_Pil = new pil(null);
  private static pim jdField_a_of_type_Pim = new pim(null);
    ...
    for (;;)
    {
      try
      {
        ...
        else
        {
          ...
          localObject2 = bjop.a().a("com.tencent.reading");
          boolean bool;
  ...
  {
    String str = b(pkh.a(), "sp_key_local_apk_path");
  ...
  private static void b(Context paramContext, String paramString)
  {
    ...
    {
      a(pkh.a(), "sp_key_current_app_version_name", paramContext.versionName);
    ...
    {
      a(pkh.a(), "sp_key_local_apk_path", paramString);
      a(pkh.a(), "sp_key_current_app_md5", paramContext);
  ...
  private static void b(boolean paramBoolean, long paramLong, int paramInt)
  {
    ...
    StatisticCollector.getInstance(pkh.a().getApplication()).collectPerformance(str, "actKBPreDownload", paramBoolean, paramLong, 0L, localHashMap, null, false);
  }
  
  private static boolean b(Context paramContext)
  {
    boolean bool2 = false;
    paramContext = b(pkh.a(), "sp_key_current_app_version_name");
    String str1 = b(pkh.a(), "sp_key_latest_app_version_name");
    String str2 = b(pkh.a(), "sp_key_current_app_md5");
    String str3 = b(pkh.a(), "sp_key_latest_app_md5");
