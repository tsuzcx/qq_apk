  ...
  implements ansd
{
  ...
  WeakReference<bejq> jdField_a_of_type_MqqUtilWeakReference = new WeakReference(this);
  volatile boolean jdField_a_of_type_Boolean;
  
  public bejq(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_Anrz = ((anrz)paramQQAppInterface.getManager(QQManagerFactory.CONDITION_SEARCH_MANAGER));
    this.jdField_a_of_type_Anrz.a(this.jdField_a_of_type_MqqUtilWeakReference);
    this.jdField_a_of_type_Anrz.c(this);
  }
  ...
  private boolean a(JSONObject paramJSONObject, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    arrayOfString[0] = anrz.a(paramInt1);
    arrayOfString[1] = anrz.a(paramInt2);
    arrayOfString[2] = anrz.a(paramInt3);
    arrayOfString[3] = anrz.a(paramInt4);
    ...
    try
    {
      ...
      String str = this.jdField_a_of_type_Anrz.a(arrayOfString);
      ??? = str;
      if (str.equals("不限")) {
        ??? = "";
      }
  ...
  public void a()
  {
    this.jdField_a_of_type_Anrz.d(this);
    this.jdField_a_of_type_Anrz.b(this.jdField_a_of_type_MqqUtilWeakReference);
  }
