...
public class nix
{
  ...
  public static nix a(String paramString1, String paramString2, String paramString3)
  {
    boolean bool = true;
    nix localnix = new nix();
    localnix.jdField_a_of_type_JavaLangString = paramString2;
    localnix.jdField_b_of_type_JavaLangString = paramString3;
    for (;;)
    {
      try
      {
        paramString1 = new JSONObject(paramString1);
        localnix.jdField_c_of_type_JavaLangString = paramString1.optString("str_adId", "");
        localnix.jdField_d_of_type_JavaLangString = paramString1.optString("str_adPosId", "");
        localnix.jdField_b_of_type_Boolean = paramString1.optBoolean("bool_bannerShow", false);
        localnix.jdField_c_of_type_Int = paramString1.optInt("uint32_bannertype", 0);
        localnix.jdField_d_of_type_Int = paramString1.optInt("uint32_jumpType", 0);
        localnix.n = paramString1.optString("str_jumpUrl", "");
        localnix.jdField_k_of_type_JavaLangString = paramString1.optString("str_appId", "");
        localnix.jdField_l_of_type_JavaLangString = paramString1.optString("str_packagename", "");
        localnix.jdField_i_of_type_JavaLangString = paramString1.optString("str_androidDownloadUrl", "");
        localnix.jdField_f_of_type_JavaLangString = paramString1.optString("str_bannerImgUrl", "");
        localnix.jdField_g_of_type_JavaLangString = paramString1.optString("str_bannerText", "");
        localnix.jdField_h_of_type_JavaLangString = paramString1.optString("str_bannerButtonText", "");
        localnix.jdField_c_of_type_Boolean = paramString1.optBoolean("bool_silentDownload", false);
        localnix.m = paramString1.optString("str_appName", "");
        localnix.jdField_e_of_type_JavaLangString = paramString1.optString("str_reportLink", "");
        if ((!TextUtils.isEmpty(localnix.jdField_e_of_type_JavaLangString)) && (!localnix.jdField_e_of_type_JavaLangString.contains("https"))) {
          localnix.jdField_e_of_type_JavaLangString = localnix.jdField_e_of_type_JavaLangString.replace("http", "https");
        }
        localnix.jdField_a_of_type_Boolean = paramString1.optBoolean("bool_horizontalVideo", false);
        localnix.jdField_a_of_type_Int = paramString1.optInt("uint32_audioFadeinDuration", 5);
        localnix.jdField_b_of_type_Int = paramString1.optInt("uint32_audioSwitchType", 0);
        localnix.jdField_e_of_type_Int = paramString1.optInt("uint32_preDownloadType", 0);
        localnix.jdField_e_of_type_Int = PAAdPreloadTask.checkNetworkType(localnix.jdField_e_of_type_Int);
        localnix.o = paramString1.optString("str_openJumpUrlGuide", "");
        localnix.jdField_j_of_type_JavaLangString = paramString1.optString("str_myappDownloadUrl", "");
        localnix.p = paramString1.optString("str_jumpTypeParams", "");
        localnix.jdField_h_of_type_Int = paramString1.optInt("uint32_scrollUpToJump", 0);
        if (localnix.jdField_h_of_type_Int == 1)
        {
          localnix.jdField_d_of_type_Boolean = bool;
          localnix.jdField_i_of_type_Int = paramString1.optInt("uint32_controlVariable", 0);
          localnix.jdField_j_of_type_Int = paramString1.optInt("uint32_control_plugin_time", 0);
          localnix.jdField_k_of_type_Int = paramString1.optInt("uint32_autoJump", 0);
          if (localnix.jdField_d_of_type_Int >= 3)
          {
            bool = TextUtils.isEmpty(localnix.p);
            if (bool) {}
          }
          try
          {
            paramString2 = new JSONObject(localnix.p);
            localnix.jdField_g_of_type_Int = paramString2.optInt("class_id", -1);
            localnix.q = paramString2.optString("class_name", "");
            localnix.jdField_f_of_type_Int = paramString2.optInt("pendant_id", -1);
            localnix.r = paramString1.optString("str_clickLink", "");
            localnix.jdField_l_of_type_Int = paramString1.optInt("uint32_monitorType", 0);
            localnix.s = paramString1.optString("str_share_nick", "");
            localnix.t = paramString1.optString("str_share_ad_head_url", "");
            localnix.u = paramString1.optString("str_share_ad_brief", "");
            localnix.v = paramString1.optString("str_share_ad_txt", "");
            localnix.w = paramString1.optString("str_share_ad_icon_url", "");
            localnix.x = paramString1.optString("str_share_jump_url", "");
            return localnix;
          }
  ...
  public static nix a(submsgtype0xf9.MsgCommonData paramMsgCommonData, String paramString1, String paramString2)
  {
    boolean bool = true;
    nix localnix = new nix();
    localnix.jdField_a_of_type_JavaLangString = paramString1;
    localnix.jdField_b_of_type_JavaLangString = paramString2;
    if (paramMsgCommonData.str_adId.has()) {
      localnix.jdField_c_of_type_JavaLangString = paramMsgCommonData.str_adId.get();
    }
    if (paramMsgCommonData.str_adPosId.has()) {
      localnix.jdField_d_of_type_JavaLangString = paramMsgCommonData.str_adPosId.get();
    }
    if (paramMsgCommonData.bool_bannerShow.has()) {
      localnix.jdField_b_of_type_Boolean = paramMsgCommonData.bool_bannerShow.get();
    }
    if (paramMsgCommonData.uint32_bannertype.has()) {
      localnix.jdField_c_of_type_Int = paramMsgCommonData.uint32_bannertype.get();
    }
    if (paramMsgCommonData.uint32_jumpType.has()) {
      localnix.jdField_d_of_type_Int = paramMsgCommonData.uint32_jumpType.get();
    }
    if (paramMsgCommonData.str_jumpUrl.has()) {
      localnix.n = paramMsgCommonData.str_jumpUrl.get();
    }
    if (paramMsgCommonData.str_appId.has()) {
      localnix.jdField_k_of_type_JavaLangString = paramMsgCommonData.str_appId.get();
    }
    if (paramMsgCommonData.str_packagename.has()) {
      localnix.jdField_l_of_type_JavaLangString = paramMsgCommonData.str_packagename.get();
    }
    if (paramMsgCommonData.str_androidDownloadUrl.has()) {
      localnix.jdField_i_of_type_JavaLangString = paramMsgCommonData.str_androidDownloadUrl.get();
    }
    if (paramMsgCommonData.str_bannerImgUrl.has()) {
      localnix.jdField_f_of_type_JavaLangString = paramMsgCommonData.str_bannerImgUrl.get();
    }
    if (paramMsgCommonData.str_bannerText.has()) {
      localnix.jdField_g_of_type_JavaLangString = paramMsgCommonData.str_bannerText.get();
    }
    if (paramMsgCommonData.str_bannerButtonText.has()) {
      localnix.jdField_h_of_type_JavaLangString = paramMsgCommonData.str_bannerButtonText.get();
    }
    if (paramMsgCommonData.bool_silentDownload.has()) {
      localnix.jdField_c_of_type_Boolean = paramMsgCommonData.bool_silentDownload.get();
    }
    if (paramMsgCommonData.str_appName.has()) {
      localnix.m = paramMsgCommonData.str_appName.get();
    }
    if (paramMsgCommonData.str_reportLink.has())
    {
      localnix.jdField_e_of_type_JavaLangString = paramMsgCommonData.str_reportLink.get();
      if ((!TextUtils.isEmpty(localnix.jdField_e_of_type_JavaLangString)) && (!localnix.jdField_e_of_type_JavaLangString.contains("https"))) {
        localnix.jdField_e_of_type_JavaLangString = localnix.jdField_e_of_type_JavaLangString.replace("http", "https");
      }
    }
    if (paramMsgCommonData.bool_horizontalVideo.has()) {
      localnix.jdField_a_of_type_Boolean = paramMsgCommonData.bool_horizontalVideo.get();
    }
    if (paramMsgCommonData.uint32_audioFadeinDuration.has()) {
      localnix.jdField_a_of_type_Int = paramMsgCommonData.uint32_audioFadeinDuration.get();
    }
    if (paramMsgCommonData.uint32_audioSwitchType.has()) {
      localnix.jdField_b_of_type_Int = paramMsgCommonData.uint32_audioSwitchType.get();
    }
    if (paramMsgCommonData.uint32_preDownloadType.has())
    {
      localnix.jdField_e_of_type_Int = paramMsgCommonData.uint32_preDownloadType.get();
      localnix.jdField_e_of_type_Int = PAAdPreloadTask.checkNetworkType(localnix.jdField_e_of_type_Int);
    }
    if (paramMsgCommonData.str_openJumpUrlGuide.has()) {
      localnix.o = paramMsgCommonData.str_openJumpUrlGuide.get();
    }
    if (paramMsgCommonData.str_myappDownloadUrl.has()) {
      localnix.jdField_j_of_type_JavaLangString = paramMsgCommonData.str_myappDownloadUrl.get();
    }
    if (paramMsgCommonData.str_jumpTypeParams.has()) {
      localnix.p = paramMsgCommonData.str_jumpTypeParams.get();
    }
    if (paramMsgCommonData.uint32_scrollUpToJump.has())
    {
      ...
      localnix.jdField_h_of_type_Int = paramMsgCommonData.uint32_scrollUpToJump.get();
      if (localnix.jdField_h_of_type_Int != 1) {
        break label1112;
      }
    }
    for (;;)
    {
      ...
      if (paramMsgCommonData.uint32_controlVariable.has())
      {
        ...
        localnix.jdField_i_of_type_Int = paramMsgCommonData.uint32_controlVariable.get();
      }
      if (paramMsgCommonData.uint32_control_plugin_time.has())
      {
        ...
        localnix.jdField_j_of_type_Int = paramMsgCommonData.uint32_control_plugin_time.get();
      }
      if (paramMsgCommonData.uint32_autoJump.has())
      {
        ...
        localnix.jdField_k_of_type_Int = paramMsgCommonData.uint32_autoJump.get();
      }
      if ((localnix.jdField_d_of_type_Int >= 3) && (!TextUtils.isEmpty(localnix.p))) {}
      try
      {
        paramString1 = new JSONObject(localnix.p);
        localnix.jdField_g_of_type_Int = paramString1.optInt("class_id", -1);
        localnix.q = paramString1.optString("class_name", "");
        localnix.jdField_f_of_type_Int = paramString1.optInt("pendant_id", -1);
        if (paramMsgCommonData.str_clickLink.has())
        {
          localnix.r = paramMsgCommonData.str_clickLink.get();
          if ((!TextUtils.isEmpty(localnix.r)) && (!localnix.r.startsWith("https://"))) {
            localnix.r = localnix.r.replace("http://", "https://");
          }
        }
        if (paramMsgCommonData.uint32_monitorType.has()) {
          localnix.jdField_l_of_type_Int = paramMsgCommonData.uint32_monitorType.get();
        }
        if (paramMsgCommonData.str_share_nick.has()) {
          localnix.s = paramMsgCommonData.str_share_nick.get();
        }
        if (paramMsgCommonData.str_share_ad_head_url.has()) {
          localnix.t = paramMsgCommonData.str_share_ad_head_url.get();
        }
        if (paramMsgCommonData.str_share_ad_brief.has()) {
          localnix.u = paramMsgCommonData.str_share_ad_brief.get();
        }
        if (paramMsgCommonData.str_share_ad_txt.has()) {
          localnix.v = paramMsgCommonData.str_share_ad_txt.get();
        }
        if (paramMsgCommonData.str_share_ad_icon_url.has()) {
          localnix.w = paramMsgCommonData.str_share_ad_icon_url.get();
        }
        if (paramMsgCommonData.str_share_jump_url.has()) {
          localnix.x = paramMsgCommonData.str_share_jump_url.get();
        }
        return localnix;
        label1112:
        bool = false;
