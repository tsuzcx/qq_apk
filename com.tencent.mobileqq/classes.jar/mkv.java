...
public class mkv
  implements bkzs
{
  public mkv(VideoInviteActivity paramVideoInviteActivity, boolean paramBoolean) {}
  ...
  public void onDismiss()
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      {
        bdla.b(null, "CliOper", "", "", str, str, 0, 0, Integer.toString(this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.d), Integer.toString(this.jdField_a_of_type_ComTencentAvUiVideoInviteActivity.h), "", "");
