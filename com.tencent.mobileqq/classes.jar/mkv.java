...
{
  public mkv(VideoLayerUI paramVideoLayerUI) {}
  
  public boolean onDoubleTap(MotionEvent arg1)
  {
    int i;
    int j;
    if ((this.a.q == 0) && ((this.a.o == 0) || (this.a.n == 0)) && (2 == this.a.jdField_a_of_type_ArrayOfMdt[0].h()) && (!VideoLayerUIBase.b(this.a.jdField_a_of_type_ComTencentAvVideoController.a())))
    {
      i = (int)???.getX();
      j = (int)???.getY();
      float f = this.a.jdField_a_of_type_ArrayOfMdt[0].c();
      ??? = this.a;
      ???.p += 1;
      if (this.a.p % 2 == 1)
      {
        f = this.a.jdField_a_of_type_ArrayOfMdt[0].b() / f;
        this.a.jdField_a_of_type_ArrayOfMdt[0].a(f, i, j);
      }
      for (;;)
      {
        return true;
        f = this.a.jdField_a_of_type_ArrayOfMdt[0].a() / f;
        i = this.a.jdField_a_of_type_ArrayOfMdt[0].b() / 2;
        j = this.a.jdField_a_of_type_ArrayOfMdt[0].c() / 2;
        this.a.jdField_a_of_type_ArrayOfMdt[0].a(f, i, j);
        this.a.jdField_a_of_type_ArrayOfMdt[0].a(i, j, true);
      }
    }
    if ((this.a.jdField_a_of_type_Min != null) && (this.a.jdField_a_of_type_Min.a() == 3))
    {
      Object localObject1;
      Object localObject3;
      if (QLog.isColorLevel())
      {
        ...
        localObject3 = this.a.jdField_a_of_type_ArrayOfMdt;
        if (this.a.q >= 0) {
          break label420;
        }
      }
      ...
      for (i = 0;; i = this.a.q)
      {
        ...
        if ((VideoLayerUI.c(this.a)) && (this.a.q != -1) && (this.a.q < this.a.jdField_a_of_type_ArrayOfMdt.length) && (this.a.jdField_a_of_type_ArrayOfMdt[this.a.q].a() != 1) && (this.a.jdField_a_of_type_ComTencentAvVideoController.a().c.size() > 0)) {
          break;
        }
        return true;
      }
      if (this.a.q != 0)
      {
        long l = Long.parseLong(this.a.jdField_a_of_type_ArrayOfMdt[this.a.q].b());
        j = this.a.jdField_a_of_type_ArrayOfMdt[this.a.q].h();
        localObject1 = (lnn)this.a.jdField_a_of_type_ComTencentAvVideoController.a().c.get(0);
        i = 0;
        if (i < this.a.jdField_a_of_type_ComTencentAvVideoController.a().c.size())
        {
          localObject3 = (lnn)this.a.jdField_a_of_type_ComTencentAvVideoController.a().c.get(i);
          if ((l != ((lnn)localObject3).jdField_a_of_type_Long) || (j != ((lnn)localObject3).jdField_a_of_type_Int)) {
            break label759;
          }
          ((lnn)localObject1).jdField_a_of_type_Boolean = false;
          ((lnn)localObject3).jdField_a_of_type_Boolean = true;
      ...
      for (;;)
      {
        synchronized (this.a.jdField_a_of_type_ComTencentAvVideoController.a().jdField_d_of_type_JavaUtilArrayList)
        {
          ...
          bcst.b(null, "CliOper", "", "", "0X8009F61", "0X8009F61", 0, 0, "", "", "", "");
        ...
        i += 1;
        break;
        if ((this.a.jdField_a_of_type_ComTencentAvVideoController.a().c.size() > 0) && (!((lnn)this.a.jdField_a_of_type_ComTencentAvVideoController.a().c.get(0)).jdField_a_of_type_Boolean))
        {
          ((lnn)this.a.jdField_a_of_type_ComTencentAvVideoController.a().c.get(0)).jdField_a_of_type_Boolean = true;
          if (QLog.isColorLevel()) {
    ...
    if ((this.a.jdField_a_of_type_Min != null) && (this.a.jdField_a_of_type_Min.a() == 4))
    {
      if (!VideoLayerUI.c(this.a)) {
        return true;
      }
      bcst.b(null, "CliOper", "", "", "0X8009F60", "0X8009F60", 0, 0, "", "", "", "");
  ...
  public boolean onFling(MotionEvent paramMotionEvent1, MotionEvent paramMotionEvent2, float paramFloat1, float paramFloat2)
  {
    ...
    if ((localAVActivity == null) || (localAVActivity.jdField_a_of_type_ComTencentAvUiVideoControlUI == null) || (localAVActivity.jdField_a_of_type_ComTencentAvUiVideoControlUI.a() == null) || (localAVActivity.jdField_a_of_type_Mmj == null)) {
      return false;
    }
    ...
    float f1;
    float f2;
    if (!localAVActivity.jdField_a_of_type_Mmj.a())
    {
      i = 1;
      ley localley = localAVActivity.jdField_a_of_type_ComTencentAvVideoController.a();
      ...
      if ((!this.a.jdField_a_of_type_ArrayOfMdt[0].b) && (!this.a.jdField_a_of_type_ArrayOfMdt[1].b)) {
        break label619;
      }
      k = 1;
      if ((j == 0) || (!bool1) || (k == 0)) {
    ...
    else
    {
      ...
      localAVActivity.jdField_a_of_type_Mmj.c(1);
      ljs.a("0X800A8D2");
    }
    for (;;)
    {
      ...
      if ((bool1) && (j != 0))
      {
        ...
        localAVActivity.jdField_a_of_type_Mmj.a(2);
        if (!bool8) {
  ...
  public boolean onSingleTapConfirmed(MotionEvent paramMotionEvent)
  {
    ...
    do
    {
            ...
            do
            {
              do
              {
                ...
                do
                {
                  ...
                  bool1 = bool2;
                } while (!this.a.jdField_a_of_type_Min.a());
                this.a.a(0, this.a.q);
                return true;
                if (!bool3) {
                  break;
                ...
                bool1 = bool2;
              } while (this.a.jdField_a_of_type_ArrayOfMdt == null);
              bool1 = bool2;
            } while (this.a.q <= 0);
            bool1 = bool2;
          } while (this.a.q >= this.a.jdField_a_of_type_ArrayOfMdt.length);
          if (!this.a.jdField_a_of_type_Min.a()) {
            break;
          }
          localObject = this.a.jdField_a_of_type_ArrayOfMdt[0];
          paramMotionEvent = this.a.jdField_a_of_type_ArrayOfMdt[this.a.q];
          bool1 = bool2;
        } while (localObject == null);
        bool1 = bool2;
      } while (paramMotionEvent == null);
      String str = ((mdt)localObject).b();
      int i = Integer.valueOf(((mdt)localObject).h()).intValue();
      ...
      return true;
      bool1 = bool2;
    } while (this.a.jdField_a_of_type_Min.a() != 3);
    this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(new Object[] { Integer.valueOf(110), Long.valueOf(l) });
    return true;
    this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(new Object[] { Integer.valueOf(110), Long.valueOf(l) });
    return true;
