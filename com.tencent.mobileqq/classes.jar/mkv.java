...
public class mkv
  extends lfl
{
  public mkv(VideoInviteActivity paramVideoInviteActivity) {}
  ...
  protected void a()
  {
    ...
    if (this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null)
    {
      ...
      this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.c(this.a.jdField_a_of_type_Lff.A, this.a.jdField_a_of_type_Lff.p);
    }
  }
  ...
  protected void a(long paramLong, int paramInt, String paramString)
  {
    ...
    while (this.a.jdField_a_of_type_Lff.j()) {
      return;
    }
    mur.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
    if ((this.a.l) && (this.a.jdField_a_of_type_Mia != null) && (!this.a.f()))
    {
      this.a.jdField_a_of_type_Mia.a(new mkw(this, paramInt));
      return;
    }
  ...
  protected void a(String paramString, boolean paramBoolean)
  {
    if ((this.a.c != null) && (this.a.c.equals(paramString)))
    {
      ...
      if (paramBoolean)
      {
        ...
        this.a.jdField_a_of_type_Mia.a(new mkx(this));
      }
    }
    return;
    label187:
  ...
  protected void c(int paramInt)
  {
    ...
    do
    {
      return;
      int i = biki.a();
      String str = biki.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, paramInt, i, null);
      File localFile = new File(str);
      int j = this.a.jdField_a_of_type_Lff.d;
      if ((localFile != null) && (localFile.exists()) && (this.a.jdField_a_of_type_Lff.g != 4) && ((j == 1) || (j == 0)) && (this.a.jdField_a_of_type_AndroidWidgetRelativeLayout != null))
      {
        if (this.a.jdField_a_of_type_ComTencentMobileqqVipavVipFullScreenVideoView == null) {
          this.a.jdField_a_of_type_ComTencentMobileqqVipavVipFullScreenVideoView = biki.a((Activity)this.a.jdField_a_of_type_JavaLangRefWeakReference.get(), this.a.jdField_a_of_type_AndroidWidgetRelativeLayout, false);
        }
        if (biki.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getApplicationContext(), this.a.jdField_a_of_type_ComTencentMobileqqVipavVipFullScreenVideoView, str, i, null, paramInt, false))
        {
          this.a.a(true);
