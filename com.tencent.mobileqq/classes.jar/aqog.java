...
public final class aqog
  extends Animation
{
  static final WeakHashMap<View, aqog> jdField_a_of_type_JavaUtilWeakHashMap;
  ...
  public static aqog a(View paramView)
  {
    aqog localaqog2 = (aqog)jdField_a_of_type_JavaUtilWeakHashMap.get(paramView);
    aqog localaqog1;
    if (localaqog2 != null)
    {
      localaqog1 = localaqog2;
      if (localaqog2 == paramView.getAnimation()) {}
    }
    else
    {
      localaqog1 = new aqog(paramView);
      jdField_a_of_type_JavaUtilWeakHashMap.put(paramView, localaqog1);
    }
    return localaqog1;
  }
