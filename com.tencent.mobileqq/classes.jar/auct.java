  ...
  implements INetEngine.INetEngineListener
{
  ...
  public void a(long paramLong)
  {
    ...
    try
    {
      ...
      if (arrayOfByte == null)
      {
        this.jdField_a_of_type_Aucs.b();
        return;
      }
      arrayOfByte = this.jdField_a_of_type_Aucs.a(arrayOfByte, paramLong);
      if (arrayOfByte == null)
      {
        this.jdField_a_of_type_Aucs.b();
        return;
    ...
    localException.mTimeoutParam = auea.a();
  ...
  byte[] a(long paramLong)
  {
    ...
    //   6: aload_0
    //   7: lconst_0
    //   8: putfield 143	auct:jdField_b_of_type_Long	J
    //   11: aload_0
    //   12: getfield 145	auct:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   15: ifnonnull +23 -> 38
    //   18: aload_0
    //   19: new 147	java/io/FileInputStream
    //   22: dup
    //   23: aload_0
    //   24: getfield 149	auct:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   27: invokespecial 152	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   30: putfield 145	auct:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   33: aload_0
    //   34: lconst_0
    //   35: putfield 154	auct:jdField_c_of_type_Long	J
    //   38: lload_1
    //   39: lconst_0
    //   40: lcmp
    //   41: ifne +113 -> 154
    //   44: aload_0
    //   45: getfield 154	auct:jdField_c_of_type_Long	J
    //   48: lconst_0
    //   49: lcmp
    //   50: ifeq +23 -> 73
    //   53: aload_0
    ...
    //   57: dup
    //   58: aload_0
    //   59: getfield 149	auct:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   62: invokespecial 152	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   65: putfield 145	auct:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   68: aload_0
    //   69: lconst_0
    //   70: putfield 154	auct:jdField_c_of_type_Long	J
    //   73: aload_0
    //   74: lload_1
    //   75: putfield 154	auct:jdField_c_of_type_Long	J
    //   78: aload_0
    //   79: getfield 156	auct:jdField_a_of_type_Blkh	Lblkh;
    //   82: aload_0
    //   83: getfield 158	auct:jdField_a_of_type_Long	J
    //   86: aload_0
    //   87: getfield 143	auct:jdField_b_of_type_Long	J
    //   90: lload_1
    //   91: invokestatic 163	aucu:a	(Lblkh;JJJ)I
    //   94: istore_3
    //   95: iload_3
    //   96: newarray byte
    //   98: astore 4
    //   100: aload_0
    //   101: getfield 145	auct:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   104: aload 4
    //   106: iconst_0
    //   107: iload_3
    ...
    //   112: aload_0
    //   113: aload_0
    //   114: getfield 154	auct:jdField_c_of_type_Long	J
    //   117: iload_3
    //   118: i2l
    //   119: ladd
    //   120: putfield 154	auct:jdField_c_of_type_Long	J
    //   123: aload 4
    //   125: areturn
    //   126: astore 4
    //   128: aload_0
    //   129: aconst_null
    //   130: putfield 145	auct:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   133: aload 4
    ...
    //   142: aload_0
    //   143: aconst_null
    //   144: putfield 145	auct:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   147: aload 4
    ...
    //   154: lload_1
    //   155: aload_0
    //   156: getfield 154	auct:jdField_c_of_type_Long	J
    //   159: lcmp
    //   160: ifle +29 -> 189
    //   163: aload_0
    //   164: getfield 145	auct:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   167: lload_1
    //   168: aload_0
    //   169: getfield 154	auct:jdField_c_of_type_Long	J
    //   172: lsub
    ...
    //   189: lload_1
    //   190: aload_0
    //   191: getfield 154	auct:jdField_c_of_type_Long	J
    //   194: lcmp
    //   195: ifge -122 -> 73
    //   198: aload_0
    ...
    //   202: dup
    //   203: aload_0
    //   204: getfield 149	auct:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   207: invokespecial 152	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   210: putfield 145	auct:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   213: aload_0
    //   214: lconst_0
    //   215: putfield 154	auct:jdField_c_of_type_Long	J
    //   218: aload_0
    //   219: getfield 145	auct:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   222: lload_1
    ...
    //   232: aload_0
    //   233: aconst_null
    //   234: putfield 145	auct:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   237: aload 4
  ...
  public void onResp(NetResp paramNetResp)
  {
    ...
    do
    {
      ...
      if ((paramNetResp.mErrCode == 9364) && (this.jdField_a_of_type_Int < 3))
      {
        ...
        if (this.jdField_a_of_type_Aucs != null) {
          this.jdField_a_of_type_Aucs.a(true);
        }
    ...
    for (long l = Long.parseLong(str);; l = 0L)
    {
      ...
      l = this.jdField_a_of_type_Aucs.a(paramNetResp);
      if (l == -1L)
      {
      ...
      this.jdField_a_of_type_Aucs.a(this.jdField_b_of_type_Long, this.jdField_a_of_type_Long);
      a(l);
      return;
    }
  }
