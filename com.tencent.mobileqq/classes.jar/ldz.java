  ...
  extends MSFServlet
{
  ...
  private void a(MultiVideoMsg paramMultiVideoMsg)
  {
    ...
    NewIntent localNewIntent = new NewIntent(this.a.getApplication(), ldz.class);
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    paramArrayOfByte = ldu.a(paramArrayOfByte);
    ...
    liu.a(34);
    mst.a("VideoServlet", lcx.a(3, String.valueOf(paramArrayOfByte.c), new int[0]), this.a, paramArrayOfByte);
  }
  ...
  void a(int paramInt, Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    Object localObject = locallko;
    if (paramFromServiceMsg.isSuccess())
    {
      localObject = locallko;
      if (i > 0)
      {
    ...
    locallko = this.a.a();
    if (locallko != null) {
      locallko.a(paramInt, paramFromServiceMsg.isSuccess(), paramFromServiceMsg.getResultCode(), paramIntent, (byte[])localObject);
    }
  }
  ...
  void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    //   30: iconst_4
    //   31: iload_3
    //   32: invokestatic 420	bbmx:a	([BI[BII)V
    ...
    //   63: astore_2
    //   64: aload_2
    //   65: invokestatic 532	lgy:a	(Lcom/tencent/av/common$ErrorInfo;)I
    //   68: istore 4
    //   70: aload_2
    ...
    //   187: i2l
    //   188: invokespecial 577	loh:<init>	(JJ)V
    ...
    //   210: istore 9
    //   212: aload_0
    //   213: getfield 99	ldz:a	Lcom/tencent/av/app/VideoAppInterface;
    //   216: instanceof 101
    //   219: ifeq +170 -> 389
    //   222: aload_0
    //   223: getfield 99	ldz:a	Lcom/tencent/av/app/VideoAppInterface;
    //   226: astore_1
    //   227: iload 9
    //   229: ifne +104 -> 333
    //   232: aload_1
    ...
    //   332: return
    //   333: aload_0
    //   334: getfield 99	ldz:a	Lcom/tencent/av/app/VideoAppInterface;
    //   337: iconst_4
    ...
    //   388: return
    //   389: aload_0
    //   390: getfield 99	ldz:a	Lcom/tencent/av/app/VideoAppInterface;
    //   393: iconst_4
  ...
  void a(String paramString, Packet paramPacket, Bundle paramBundle)
  {
    ...
    if (paramString != null) {
      paramPacket.putSendData(bbma.a(paramString));
    }
  }
  ...
  void b(Packet paramPacket, Bundle paramBundle)
  {
    ...
    paramPacket.putSendData(bbma.a(paramBundle.toByteArray()));
  }
  ...
  public void onCreate()
  {
    ...
    lvz.a().jdField_a_of_type_Boolean = true;
    lvz.a().jdField_b_of_type_Long = System.currentTimeMillis();
  }
          ...
          for (;;)
          {
            ...
            for (boolean bool = true;; bool = false)
            {
              ...
              if ("SharpSvr.c2s".equalsIgnoreCase(str)) {
                axqy.b(null, "CliOper", "", "", "0X80088B1", "0X80088B1", 0, 0, "", "", "", "");
              }
              if (paramIntent == null) {
                break;
              }
            ...
            if ("SharpSvr.s2c".equalsIgnoreCase(str))
            {
              ...
              if (i != 1013)
              {
                ...
                for (;;)
                {
                  if (!lvz.a().jdField_b_of_type_Boolean) {
                    lvz.a().a(paramIntent.msg_seq);
                  }
                  lvz.a().a("eVideoRecvInviteMsg", 3L, paramIntent.msg_seq, ((Long)paramIntent.to_uin.get(0)).longValue(), paramIntent.from_uin, 0);
                  localObject = paramIntent.msg_seq + "-" + paramIntent.msg_uid;
                  this.a.a(paramIntent.from_uin, (String)localObject, awzy.a());
                  if (this.a.c)
                  {
                    this.a.c = false;
                    this.a.d = true;
                  ...
                  try
                  {
                    localObject = ldu.a(paramIntent.video_buff);
                    QLog.w("tagSharpSvr", 1, "<-- onReceive() cmd = " + str + " , msg_type = " + paramIntent.msg_type + ", bodyType = " + ((ldv)localObject).a);
                    c(paramIntent);
            ...
            else
            {
              if ("SharpSvr.c2sack".equalsIgnoreCase(localException))
              {
                ...
                for (;;)
                {
                  ...
                  try
                  {
                    paramFromServiceMsg = ldu.a(paramIntent.video_buff);
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          {
            return;
            long l2 = mtj.a(paramIntent);
            long l1 = l2;
            if (l2 == 0L)
            {
              l1 = AudioHelper.b();
              mtj.a(paramIntent, l1);
            }
        ...
        return;
        axqy.b(null, "CliOper", "", "", "0X80088B0", "0X80088B0", 0, 0, "", "", "", "");
        if (QLog.isColorLevel()) {
        ...
        try
        {
          paramPacket = ldu.a(paramIntent.video_buff);
        ...
        {
          lvz.a().a("eVideoSendACK", ((SharpVideoMsg)localObject3).msg_type, ((SharpVideoMsg)localObject3).msg_seq, ((Long)((SharpVideoMsg)localObject3).to_uin.get(0)).longValue(), ((SharpVideoMsg)localObject3).from_uin, 0);
          lvz.a().b();
        }
        if (QLog.isColorLevel()) {
        ...
        try
        {
          localObject1 = ldu.a(((SharpVideoMsg)localObject3).video_buff);
          QLog.w("tagSharpSvr", 1, "--> onSend() cmd = SharpSvr.s2cack , msg_type = " + ((SharpVideoMsg)localObject3).msg_type + ", bodyType = " + ((ldv)localObject1).a);
        ...
        bbmx.a((byte[])localObject2, 0, paramIntent.length + 4);
        bbmx.a((byte[])localObject2, 4, paramIntent, paramIntent.length);
    ...
    paramPacket.putSendData(bbma.a(((Bundle)localObject2).getByteArray("vMsg")));
    return;
