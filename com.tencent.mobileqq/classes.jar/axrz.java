  ...
  extends axox
{
  ...
  ajmm jdField_a_of_type_Ajmm = new axsa(this);
  private Handler jdField_a_of_type_AndroidOsHandler;
  avbl jdField_a_of_type_Avbl;
  private avbm jdField_a_of_type_Avbm;
  ...
  public axrz(axos paramaxos, axvt paramaxvt)
  {
    super(paramaxos, paramaxvt);
    this.jdField_b_of_type_JavaUtilArrayList = new ArrayList();
    this.jdField_b_of_type_JavaUtilMap = new HashMap();
    paramaxos = paramaxvt.jdField_b_of_type_JavaLangObject;
    if ((paramaxos != null) && ((paramaxos instanceof avbm))) {
      this.jdField_a_of_type_Avbm = ((avbm)paramaxvt.jdField_b_of_type_JavaLangObject);
    }
    if ((this.jdField_a_of_type_Axos != null) && (this.jdField_a_of_type_Axos.a != null)) {
      this.jdField_a_of_type_AndroidOsHandler = this.jdField_a_of_type_Axos.a;
    }
    this.jdField_a_of_type_ComTencentMobileqqDataMessageForLightVideo = ((MessageForLightVideo)paramaxvt.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
  ...
  private axyu a()
  {
    ...
    for (;;)
    {
      ...
      localaxyu.jdField_a_of_type_JavaLangString = ((File)localObject).getName();
      ...
      localaxyu.jdField_b_of_type_ArrayOfByte = this.d;
      localaxyu.e = this.jdField_c_of_type_Int;
      localaxyu.jdField_d_of_type_Int = this.jdField_b_of_type_Int;
      localaxyu.h = this.x;
      localaxyu.jdField_b_of_type_Long = this.jdField_b_of_type_Long;
      localObject = this.jdField_a_of_type_Axqf;
      long l = localaxyu.jdField_a_of_type_Long + this.jdField_b_of_type_Long;
      this.q = l;
      ((axqf)localObject).jdField_a_of_type_Long = l;
      localaxyu.g = 3;
      localaxyu.k = 3;
      localaxyu.j = this.jdField_a_of_type_ComTencentMobileqqDataMessageForLightVideo.busiType;
      return localaxyu;
  ...
  private im_msg_body.RichText a()
  {
    for (;;)
    {
      try
      {
        ...
        Object localObject1 = (MessageForLightVideo)this.jdField_a_of_type_Axvt.jdField_a_of_type_ComTencentMobileqqDataMessageRecord;
        Object localObject3;
        if (localObject1 != null)
        {
          ...
          localVideoFile.bytes_file_md5.set(ByteStringMicro.copyFrom(HexUtil.hexStr2Bytes(this.jdField_a_of_type_Axvt.f)));
        ...
        if (this.x == 0)
        {
          if ((this.jdField_a_of_type_Avbm != null) && (this.jdField_a_of_type_Avbm.jdField_b_of_type_Int != 0))
          {
            localVideoFile.uint32_file_time.set(this.jdField_a_of_type_Avbm.jdField_b_of_type_Int / 1000);
            ...
            localObject1 = ajjy.a(2131640254);
            ((im_msg_body.Text)localObject3).str.set(ByteStringMicro.copyFromUtf8(BaseApplication.getContext().getString(2131625718)));
  ...
  private void t()
  {
    ...
    //   21: lstore_2
    //   22: aload_0
    //   23: getfield 175	axrz:d	[B
    //   26: arraylength
    //   27: aload_0
    //   28: getfield 172	axrz:jdField_a_of_type_ArrayOfByte	[B
    //   31: arraylength
    //   32: iadd
    //   33: newarray byte
    //   35: astore 5
    //   37: aload_0
    //   38: getfield 175	axrz:d	[B
    //   41: iconst_0
    //   42: aload 5
    //   44: iconst_0
    //   45: aload_0
    //   46: getfield 175	axrz:d	[B
    //   49: arraylength
    //   50: invokestatic 497	java/lang/System:arraycopy	(Ljava/lang/Object;ILjava/lang/Object;II)V
    //   53: aload_0
    //   54: getfield 172	axrz:jdField_a_of_type_ArrayOfByte	[B
    //   57: iconst_0
    //   58: aload 5
    //   60: aload_0
    //   61: getfield 175	axrz:d	[B
    //   64: arraylength
    //   65: aload_0
    //   66: getfield 172	axrz:jdField_a_of_type_ArrayOfByte	[B
    //   69: arraylength
    ...
    //   176: astore 6
    //   178: aload_0
    //   179: invokespecial 529	axrz:a	()Z
    //   182: ifne +642 -> 824
    //   185: aload 5
    //   187: astore 8
    //   189: aload 7
    ...
    //   194: sipush 9303
    //   197: ldc_w 531
    //   200: invokevirtual 534	axrz:b	(ILjava/lang/String;)V
    //   203: aload 5
    //   205: astore 8
    //   207: aload 7
    //   209: astore 6
    //   211: aload_0
    //   212: invokevirtual 536	axrz:d	()V
    //   215: aload 7
    //   217: ifnull +8 -> 225
    //   220: aload 7
    ...
    //   284: aload_0
    //   285: invokespecial 543	axrz:a	()Laxyu;
    //   288: astore 5
    ...
    //   310: aload 5
    //   312: getfield 139	axyu:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   326: aload 5
    //   328: getfield 142	axyu:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   342: aload 5
    //   344: getfield 151	axyu:jdField_a_of_type_Int	I
    ...
    //   355: aload 5
    //   357: getfield 153	axyu:jdField_b_of_type_Int	I
    //   360: invokevirtual 282	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   363: aload 5
    //   365: getfield 150	axyu:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   368: ifnull +821 -> 1189
    //   371: aload 6
    ...
    //   376: aload 5
    //   378: getfield 150	axyu:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   445: aload 5
    //   447: getfield 165	axyu:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   458: aload 5
    //   460: getfield 173	axyu:jdField_a_of_type_ArrayOfByte	[B
    ...
    //   474: aload 5
    //   476: getfield 177	axyu:jdField_b_of_type_ArrayOfByte	[B
    ...
    //   490: aload 5
    //   492: getfield 170	axyu:jdField_a_of_type_Long	J
    ...
    //   503: aload 5
    //   505: getfield 184	axyu:jdField_d_of_type_Int	I
    ...
    //   555: aload 5
    //   557: getfield 192	axyu:jdField_b_of_type_Long	J
    ...
    //   587: aload 5
    //   589: aload_0
    //   590: getfield 621	axrz:jdField_b_of_type_ArrayOfByte	[B
    ...
    //   603: aload 10
    //   605: lload_2
    //   606: invokespecial 630	axsb:<init>	(Laxrz;Ljava/lang/String;J)V
    //   609: astore 6
    //   611: aload_0
    //   612: new 632	com/tencent/mobileqq/highway/transaction/Transaction
    //   615: dup
    //   616: aload_0
    //   617: getfield 69	axrz:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   620: invokevirtual 635	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   623: bipush 12
    //   625: aload 10
    //   627: aload_0
    //   628: getfield 637	axrz:r	J
    //   631: l2i
    //   632: aload_0
    //   633: getfield 639	axrz:jdField_c_of_type_ArrayOfByte	[B
    //   636: aload_0
    //   637: getfield 172	axrz:jdField_a_of_type_ArrayOfByte	[B
    //   640: aload 6
    //   642: aload 5
    ...
    //   647: putfield 645	axrz:jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction	Lcom/tencent/mobileqq/highway/transaction/Transaction;
    //   650: aload_0
    //   651: getfield 69	axrz:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   654: invokevirtual 649	com/tencent/mobileqq/app/QQAppInterface:getHwEngine	()Lcom/tencent/mobileqq/highway/HwEngine;
    //   657: aload_0
    //   658: getfield 645	axrz:jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction	Lcom/tencent/mobileqq/highway/transaction/Transaction;
    ...
    //   697: aload_0
    //   698: getfield 645	axrz:jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction	Lcom/tencent/mobileqq/highway/transaction/Transaction;
    ...
    //   713: aload_0
    //   714: getfield 131	axrz:jdField_a_of_type_Axvt	Laxvt;
    //   717: getfield 133	axvt:jdField_a_of_type_Long	J
    ...
    //   729: aload_0
    //   730: getfield 668	axrz:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   742: aload_0
    //   743: getfield 672	axrz:k	Ljava/lang/String;
    ...
    //   755: aload_0
    //   756: getfield 645	axrz:jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction	Lcom/tencent/mobileqq/highway/transaction/Transaction;
    //   759: getfield 677	com/tencent/mobileqq/highway/transaction/Transaction:filePath	Ljava/lang/String;
    ...
    //   791: ldc_w 683
    //   794: aload_0
    //   795: getfield 686	axrz:jdField_b_of_type_Axow	Laxow;
    //   798: invokevirtual 689	axrz:a	(ILjava/lang/String;Ljava/lang/String;Laxow;)V
    //   801: aload_0
    //   802: invokevirtual 536	axrz:d	()V
    //   805: return
    //   806: astore 6
    //   808: aload 6
    ...
    //   830: astore 6
    //   832: aload_0
    //   833: getfield 468	axrz:jdField_b_of_type_JavaIoRandomAccessFile	Ljava/io/RandomAccessFile;
    //   836: invokevirtual 690	java/io/RandomAccessFile:length	()J
    //   839: l2i
    //   840: newarray byte
    //   842: astore 9
    //   844: aload 5
    ...
    //   850: astore 6
    //   852: aload_0
    //   853: getfield 468	axrz:jdField_b_of_type_JavaIoRandomAccessFile	Ljava/io/RandomAccessFile;
    //   856: aload 9
    //   858: invokevirtual 694	java/io/RandomAccessFile:read	([B)I
    //   861: pop
    //   862: aload 5
    //   864: astore 8
    //   866: aload 7
    ...
    //   870: aload 7
    //   872: aload 9
    //   874: invokevirtual 698	java/io/BufferedOutputStream:write	([B)V
    //   877: aload 5
    //   879: astore 8
    //   881: aload 7
    //   883: astore 6
    ...
    //   898: astore 6
    //   900: aload_0
    //   901: getfield 470	axrz:jdField_a_of_type_JavaIoRandomAccessFile	Ljava/io/RandomAccessFile;
    //   904: aload 9
    //   906: invokevirtual 694	java/io/RandomAccessFile:read	([B)I
    //   909: istore_1
    //   910: iload_1
    //   911: iconst_m1
    ...
    //   927: iconst_0
    //   928: iload_1
    //   929: invokevirtual 702	java/io/BufferedOutputStream:write	([BII)V
    //   932: goto -40 -> 892
    //   935: aload 5
    //   937: astore 8
    //   939: aload 7
    ...
    //   1088: astore 6
    //   1090: aload 9
    //   1092: invokevirtual 703	java/lang/OutOfMemoryError:printStackTrace	()V
    //   1095: aload 7
    //   1097: ifnull +8 -> 1105
    //   1100: aload 7
  ...
  public int a()
  {
    ...
    this.jdField_a_of_type_Avbm = null;
    return super.a();
  }
  ...
  /* Error */
  void a(axsd paramaxsd)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_1
    //   3: getfield 747	axsd:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   6: astore 5
    //   8: aload_1
    //   9: getfield 748	axsd:jdField_a_of_type_ArrayOfByte	[B
    //   12: astore 6
    //   14: aload_1
    //   15: getfield 749	axsd:jdField_b_of_type_ArrayOfByte	[B
    //   18: astore 7
    //   20: aload_1
    //   21: getfield 750	axsd:jdField_c_of_type_ArrayOfByte	[B
    //   24: astore 8
    //   26: aload_1
    //   27: getfield 751	axsd:jdField_a_of_type_Int	I
    //   30: istore_2
    //   31: aload_1
    //   32: getfield 752	axsd:d	[B
    //   35: astore 9
    //   37: aload_1
    //   38: getfield 754	axsd:jdField_a_of_type_Avbl	Lavbl;
    //   41: astore 9
    //   43: aload_1
    //   44: getfield 755	axsd:jdField_a_of_type_Long	J
    //   47: lstore_3
    //   48: new 757	axse
    //   51: dup
    //   52: aload_0
    //   53: invokespecial 758	axse:<init>	(Laxrz;)V
    //   56: astore_1
    //   57: new 632	com/tencent/mobileqq/highway/transaction/Transaction
    //   60: dup
    //   61: aload_0
    //   62: getfield 69	axrz:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   83: astore 5
    //   85: aload_0
    //   86: getfield 106	axrz:y	I
    //   89: ifeq +12 -> 101
    //   92: aload 5
    //   94: aload_0
    //   95: getfield 106	axrz:y	I
    //   98: putfield 761	com/tencent/mobileqq/highway/transaction/Transaction:cacheIp	I
    //   101: aload_1
    //   102: aload 5
    //   104: putfield 763	axse:jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction	Lcom/tencent/mobileqq/highway/transaction/Transaction;
    //   107: aload_1
    //   108: iload_2
    //   109: putfield 764	axse:jdField_a_of_type_Int	I
    //   112: aload_1
    //   113: aload 9
    //   115: putfield 765	axse:jdField_a_of_type_Avbl	Lavbl;
    //   118: aload_0
    //   119: getfield 69	axrz:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   135: aload_0
    //   136: iload_2
    //   137: invokevirtual 767	axrz:f	(I)V
    //   140: aload_0
    //   141: monitorexit
    //   142: return
    //   143: aload_0
    //   144: getfield 44	axrz:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   147: aload 5
    //   149: invokeinterface 770 2 0
    //   154: pop
    //   155: goto -15 -> 140
    //   158: astore_1
    //   159: aload_0
  ...
  public void a(axyg paramaxyg, axyv paramaxyv)
  {
    ...
    if (paramaxyv != null)
    {
      ...
      if (i < paramaxyv.jdField_a_of_type_JavaUtilList.size())
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("LightVideoUploadProcessor", 2, "onBusiProtoResp()------response.result = " + paramaxyg.jdField_c_of_type_Int);
        }
        this.f = paramaxyg.jdField_a_of_type_JavaLangString;
        if (paramaxyg.jdField_c_of_type_Int == 0)
        {
          if (QLog.isColorLevel()) {
            QLog.d("LightVideoUploadProcessor", 2, "onBusiProtoResp()------response.isExist = " + paramaxyg.jdField_a_of_type_Boolean);
          }
        ...
        for (;;)
        {
          ...
          else
          {
            d();
            continue;
            b(paramaxyg.jdField_c_of_type_Int, "onBusiProtoResp error");
            d();
          }
        }
      }
  ...
  {
    long l;
    if ((this.jdField_a_of_type_Avbm != null) && (this.jdField_a_of_type_Avbm.jdField_b_of_type_Long != 0L))
    {
      l = System.currentTimeMillis() - this.jdField_a_of_type_Avbm.jdField_b_of_type_Long;
      if (QLog.isColorLevel()) {
        QLog.d("LightVideoUploadProcessor", 2, "doReport, timeCost:" + l + " mFileSize:" + this.q + " mUploadType:" + this.jdField_a_of_type_Int + " errorCode:" + this.j);
      }
    ...
    while ((this.jdField_a_of_type_Int == 0) || (this.jdField_a_of_type_Int == 1))
    {
      ...
      awrn.a(BaseApplication.getContext()).a(null, "LightVideoSend", paramBoolean, l, this.q, this.jdField_a_of_type_JavaUtilHashMap, null);
      return;
      label197:
    ...
    awrn.a(BaseApplication.getContext()).a(null, "LightVideoSendComplete", paramBoolean, l, this.q, this.jdField_a_of_type_JavaUtilHashMap, null);
  }
  
  public void aU_()
  {
    super.aU_();
    this.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_Axvt.j;
    this.jdField_a_of_type_Long = this.jdField_a_of_type_Axvt.jdField_a_of_type_Long;
    if (this.jdField_a_of_type_Axvt.k == null) {
      this.d = HexUtil.hexStr2Bytes(avhm.a(this.jdField_b_of_type_JavaLangString));
    }
    this.d = HexUtil.hexStr2Bytes(this.jdField_a_of_type_Axvt.k);
    Object localObject;
    ...
    if (i()) {
      if (this.jdField_a_of_type_Avbm != null) {
        if (this.jdField_a_of_type_Axvt.jdField_i_of_type_Boolean)
        {
          ...
          this.jdField_a_of_type_Avbm.a(this);
          label234:
          d(1001);
        }
      }
    ...
    for (;;)
    {
      ...
      break;
      this.jdField_a_of_type_Int = 2;
      this.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_Axvt.jdField_i_of_type_JavaLangString;
      if (this.jdField_a_of_type_Axvt.f == null) {
        this.jdField_a_of_type_Axvt.f = avhm.a(this.jdField_a_of_type_JavaLangString);
      }
      localObject = this.jdField_a_of_type_Axqf;
      String str = this.jdField_a_of_type_Axvt.f;
      ((axqf)localObject).f = str;
      this.jdField_c_of_type_JavaLangString = str;
      this.jdField_a_of_type_ArrayOfByte = HexUtil.hexStr2Bytes(this.jdField_a_of_type_Axvt.f);
      if ((this.jdField_a_of_type_ComTencentMobileqqDataMessageForLightVideo.videoFileSize == 0) || (this.jdField_a_of_type_ComTencentMobileqqDataMessageForLightVideo.videoFileTime == 0))
      {
        ...
        awln.a(this.jdField_a_of_type_JavaLangString, (awlo)localObject);
      ...
      f();
      break label234;
      HwServlet.getConfig(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Axvt.jdField_b_of_type_JavaLangString);
      this.jdField_a_of_type_Int = 2;
      this.jdField_a_of_type_Avbm.a(this);
    }
  }
  
  void b(avbl paramavbl)
  {
    String str = paramavbl.jdField_a_of_type_JavaLangString;
    ...
    if (QLog.isColorLevel()) {
      QLog.d("LightVideoUploadProcessor", 2, "<BDH_LOG>sendVideoThumbByBDH  filePath:" + str + " index :" + paramavbl.jdField_d_of_type_Int + " md5:" + HexUtil.bytes2HexStr(arrayOfByte2) + " fileSize:" + i);
    }
    ...
    for (;;)
    {
      ...
      localObject = new axsd(this);
      ((axsd)localObject).jdField_a_of_type_JavaLangString = str;
      ((axsd)localObject).jdField_a_of_type_ArrayOfByte = arrayOfByte1;
      ((axsd)localObject).jdField_b_of_type_ArrayOfByte = arrayOfByte2;
      ((axsd)localObject).jdField_c_of_type_ArrayOfByte = arrayOfByte3;
      ((axsd)localObject).jdField_a_of_type_Int = 0;
      ((axsd)localObject).d = arrayOfByte2;
      ((axsd)localObject).jdField_a_of_type_Avbl = paramavbl;
      ((axsd)localObject).jdField_a_of_type_Long = i;
      a((axsd)localObject);
      return;
  ...
  public void b(boolean paramBoolean)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("LightVideoUploadProcessor", 2, "confirm send:" + this.jdField_a_of_type_Avbm.b());
      }
      if (!this.jdField_a_of_type_Avbm.b()) {
        return;
      }
    }
    if (QLog.isColorLevel()) {
    ...
    ((avau)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(326)).a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForLightVideo, this.jdField_a_of_type_Ajmm);
  }
  
  void c(avbl paramavbl)
  {
    String str = paramavbl.jdField_a_of_type_JavaLangString;
    int i = (int)new File(str).length();
    byte[] arrayOfByte1 = this.d;
    byte[] arrayOfByte2 = HexUtil.hexStr2Bytes(paramavbl.jdField_b_of_type_JavaLangString);
    int j = paramavbl.jdField_d_of_type_Int;
    int k = paramavbl.jdField_b_of_type_Int;
    int m = paramavbl.jdField_a_of_type_Int;
    int n = paramavbl.e;
    long l = paramavbl.jdField_b_of_type_Long;
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      localObject2 = new axsd(this);
      ((axsd)localObject2).jdField_a_of_type_JavaLangString = str;
      ((axsd)localObject2).jdField_a_of_type_ArrayOfByte = this.jdField_c_of_type_ArrayOfByte;
      ((axsd)localObject2).jdField_b_of_type_ArrayOfByte = arrayOfByte1;
      ((axsd)localObject2).jdField_c_of_type_ArrayOfByte = ((byte[])localObject1);
      ((axsd)localObject2).jdField_a_of_type_Int = j;
      ((axsd)localObject2).d = arrayOfByte2;
      ((axsd)localObject2).jdField_a_of_type_Avbl = paramavbl;
      ((axsd)localObject2).jdField_a_of_type_Long = i;
      a((axsd)localObject2);
      return;
  ...
  void e()
  {
    ...
    localatqr.jdField_a_of_type_Long = (this.q - this.jdField_b_of_type_Long);
    localatqr.jdField_d_of_type_JavaLangString = this.jdField_c_of_type_JavaLangString;
    if (this.f == null) {}
    for (String str = this.k;; str = this.f)
    {
      localatqr.jdField_c_of_type_JavaLangString = str;
      localatqr.jdField_c_of_type_Long = this.jdField_b_of_type_Long;
      if (QLog.isColorLevel()) {
        QLog.d("LightVideoUploadProcessor", 2, "onSuccess uuid = " + localatqr.jdField_c_of_type_JavaLangString);
      }
      if (this.jdField_a_of_type_Axvt.jdField_a_of_type_Atqq == null) {
        break;
      }
    ...
    this.jdField_a_of_type_ComTencentMobileqqDataMessageForLightVideo.uuid = localatqr.jdField_c_of_type_JavaLangString;
    this.jdField_a_of_type_ComTencentMobileqqDataMessageForLightVideo.md5 = localatqr.jdField_d_of_type_JavaLangString;
    d(1003);
  }
  
  public void e(avbl paramavbl)
  {
    if (QLog.isColorLevel()) {
      QLog.d("VideoSend", 2, "addToSendQuene, info:" + paramavbl + " mSendingInfos:" + this.jdField_b_of_type_JavaUtilMap.size() + " mReadyToSendInfos:" + this.jdField_b_of_type_JavaUtilArrayList.size() + " mUploadType" + this.jdField_a_of_type_Int);
    }
    if (paramavbl.c())
    {
    ...
    localaxqf.jdField_a_of_type_Long += paramavbl.jdField_a_of_type_Long;
    this.q += paramavbl.jdField_a_of_type_Long;
    this.jdField_b_of_type_JavaUtilArrayList.add(paramavbl);
    s();
  }
  ...
  public void f(avbl paramavbl)
  {
    this.jdField_a_of_type_AndroidOsHandler.post(new LightVideoUploadProcessor.5(this, paramavbl));
  }
  ...
  public void h()
  {
    int j = 1;
    if (QLog.isColorLevel()) {
      QLog.d("VideoSend", 2, "checkNeedSendCompleteFile check, mUploadType:" + this.jdField_a_of_type_Int + " mSendFileSliceFailed:" + this.jdField_b_of_type_Boolean + " mCombineInfo:" + this.jdField_a_of_type_Avbl);
    }
    int i;
    if (this.jdField_a_of_type_Int == 0) {
    ...
    for (;;)
    {
      if ((i != 0) && (this.jdField_a_of_type_Avbl != null))
      {
        this.jdField_a_of_type_Axvt.jdField_i_of_type_JavaLangString = this.jdField_a_of_type_Avbl.jdField_a_of_type_JavaLangString;
        this.jdField_a_of_type_Axvt.f = this.jdField_a_of_type_Avbl.jdField_b_of_type_JavaLangString;
        this.jdField_a_of_type_Axvt.jdField_i_of_type_Boolean = false;
        this.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_Avbl.jdField_a_of_type_JavaLangString;
        this.jdField_a_of_type_ArrayOfByte = HexUtil.hexStr2Bytes(this.jdField_a_of_type_Avbl.jdField_b_of_type_JavaLangString);
        axqf localaxqf = this.jdField_a_of_type_Axqf;
        String str = this.jdField_a_of_type_Avbl.jdField_b_of_type_JavaLangString;
        localaxqf.f = str;
        this.jdField_c_of_type_JavaLangString = str;
        this.q = this.jdField_a_of_type_Avbl.jdField_a_of_type_Long;
        this.x = (this.jdField_a_of_type_Avbl.e / 1000);
        g();
      }
      return;
      if ((this.jdField_a_of_type_Avbl != null) && (!this.jdField_a_of_type_Avbl.jdField_a_of_type_Boolean))
      {
  ...
  protected void i()
  {
    super.i();
    if (QLog.isColorLevel()) {
      QLog.d("LightVideoUploadProcessor", 2, "sendProgressMessage,progress;" + this.n + " transferedSize:" + this.jdField_a_of_type_Axqf.e + " fileSize:" + this.jdField_a_of_type_Axqf.jdField_a_of_type_Long);
    }
  }
  ...
  public void r()
  {
    ...
    if (jdField_a_of_type_Boolean)
    {
      ...
      l1 = Long.parseLong(this.jdField_a_of_type_Axvt.jdField_b_of_type_JavaLangString);
      l2 = Long.parseLong(this.jdField_a_of_type_Axvt.jdField_c_of_type_JavaLangString);
    ...
    for (;;)
    {
      j = ((MessageForLightVideo)this.jdField_a_of_type_Axvt.jdField_a_of_type_ComTencentMobileqqDataMessageRecord).busiType;
      ...
      if (1 == this.jdField_a_of_type_Axvt.jdField_a_of_type_Int) {
        i = 1;
      } else if (3000 == this.jdField_a_of_type_Axvt.jdField_a_of_type_Int) {
        i = 2;
      } else {
        i = 3;
      }
  ...
  public void s()
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        avbl localavbl = (avbl)this.jdField_b_of_type_JavaUtilArrayList.remove(0);
        if (localavbl == null) {
          break;
        }
        if (QLog.isColorLevel()) {
          QLog.d("VideoSend", 2, "sendSlice, info:" + localavbl + " mSendingInfos:" + this.jdField_b_of_type_JavaUtilMap.size() + " mReadyToSendInfos:" + this.jdField_b_of_type_JavaUtilArrayList.size());
        }
        this.jdField_b_of_type_JavaUtilMap.put(Integer.valueOf(localavbl.jdField_d_of_type_Int), localavbl);
        a(localavbl);
      }
    }
  }
