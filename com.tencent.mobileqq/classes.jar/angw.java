  ...
  extends BaseAdapter
{
  ...
  public angw(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewLayoutInflater = ((LayoutInflater)paramContext.getSystemService("layout_inflater"));
    this.jdField_a_of_type_Int = paramContext.getResources().getColor(2131165621);
  }
  ...
  public Drawable a(ApolloActionPackage paramApolloActionPackage)
  {
    ...
    {
      localURLDrawable2 = amwz.a("" + paramApolloActionPackage.mIconSelectedUrl.hashCode(), null, paramApolloActionPackage.mIconSelectedUrl, true);
    ...
    for (URLDrawable localURLDrawable1 = localURLDrawable2;; localURLDrawable1 = null)
    {
      ...
      {
        paramApolloActionPackage = amwz.a("" + paramApolloActionPackage.mIconUnselectedUrl.hashCode(), null, paramApolloActionPackage.mIconUnselectedUrl, true);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131558685, paramViewGroup, false);
      paramView = new angx(this);
      paramView.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localView.findViewById(2131378182));
      ...
      paramView.jdField_a_of_type_AndroidViewView = localView.findViewById(2131378179);
      paramView.jdField_a_of_type_AndroidViewView.setBackgroundColor(this.jdField_a_of_type_Int);
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131378180));
      paramView.b = localView.findViewById(2131380881);
    ...
    for (;;)
    {
      ...
      return localView;
      localObject = (angx)paramView.getTag();
      localView = paramView;
