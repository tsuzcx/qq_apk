...
public class aqhc
  extends akwr
{
  public aqhc(AppletsSettingFragment paramAppletsSettingFragment) {}
  ...
  protected void onGetAppletsSettingSwitch(boolean paramBoolean, List<akxa> paramList)
  {
    ...
    if (paramBoolean)
    {
      ...
      if ((paramList != null) && (paramBoolean) && (paramList.size() > 0))
      {
        ...
        {
          Object localObject1 = (akxa)paramList.next();
          Object localObject2;
          if ((((akxa)localObject1).jdField_a_of_type_JavaUtilList != null) && (((akxa)localObject1).jdField_a_of_type_JavaUtilList.size() > 0) && (((akxa)localObject1).jdField_a_of_type_JavaUtilList.get(0) != null) && (((AppletItem)((akxa)localObject1).jdField_a_of_type_JavaUtilList.get(0)).a() == 1L))
          {
            AppletsSettingFragment.a(this.a, (AppletItem)((akxa)localObject1).jdField_a_of_type_JavaUtilList.get(0));
            ...
            {
              ((ahjz)localObject2).a(paramBoolean);
              if (TextUtils.isEmpty(((akxa)localObject1).jdField_a_of_type_JavaLangString)) {
                break;
              }
              AppletsSettingFragment.b(this.a).setText(((akxa)localObject1).jdField_a_of_type_JavaLangString);
              this.a.a.a(((akxa)localObject1).jdField_a_of_type_JavaLangString);
              break;
              paramBoolean = false;
              break label247;
            }
          ...
          if (!TextUtils.isEmpty(((akxa)localObject1).jdField_a_of_type_JavaLangString))
          {
            AppletsSettingFragment.c(this.a).setText(((akxa)localObject1).jdField_a_of_type_JavaLangString);
            this.a.a.b(((akxa)localObject1).jdField_a_of_type_JavaLangString);
          }
          if ((((akxa)localObject1).jdField_a_of_type_JavaUtilList != null) && (((akxa)localObject1).jdField_a_of_type_JavaUtilList.size() > 0))
          {
            AppletsSettingFragment.a(this.a).clear();
            localObject1 = ((akxa)localObject1).jdField_a_of_type_JavaUtilList.iterator();
