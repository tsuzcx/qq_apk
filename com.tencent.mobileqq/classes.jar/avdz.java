...
public class avdz
  implements bhks
{
  private static volatile avdz a;
  ...
  private void a(MobileQbossAdvRsp paramMobileQbossAdvRsp, QQAppInterface paramQQAppInterface)
  {
    ...
    try
    {
      ...
      if (localObject != null)
      {
        ...
        if (localObject != null) {
          ahmr.a().a(((Long)localObject).longValue(), 2783);
        }
      }
      ...
      if ((paramMobileQbossAdvRsp != null) && (paramQQAppInterface != null))
      {
        ...
        avdn.a().a(paramMobileQbossAdvRsp, paramQQAppInterface);
      }
      return;
    }
  ...
  private void a(MobileQbossAdvRsp paramMobileQbossAdvRsp, String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    if (paramMobileQbossAdvRsp != null)
    {
      ...
      if (paramString != null)
      {
        ...
        if (paramString != null) {
          ahmr.a().a(paramString.longValue(), 2741);
        }
      }
      paramMobileQbossAdvRsp = paramMobileQbossAdvRsp.mapAdv;
      if (paramMobileQbossAdvRsp != null)
  ...
  private void a(ahmp paramahmp)
  {
    ...
    do
    {
      ...
      {
        return;
        localahmp = ahmr.a().a(localQQAppInterface.getAccount());
      } while ((paramahmp == null) || (paramahmp.a == null) || (localahmp == null) || (localahmp.a == null) || (paramahmp.a.pattern_id == localahmp.a.pattern_id));
      paramahmp = localQQAppInterface.getHandler(Conversation.class);
    } while (paramahmp == null);
    QLog.e("QzoneQbossHelper", 1, "checkIfNeedRemoveBanner remove");
    paramahmp.sendEmptyMessage(1063);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong)
  {
    ...
    try
    {
      Object localObject1 = avdu.a(BaseApplicationImpl.getContext(), paramLong);
      localArrayList = new ArrayList();
      if ((localObject1 != null) && (((List)localObject1).size() > 0))
      {
        if ((avdu.a == null) || (avdu.a.size() == 0))
        {
          localHashMap = avdu.a(BaseApplicationImpl.getApplication(), paramLong + "");
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          {
            localObject2 = (avdv)localHashMap.get(localObject2);
            if (((avdv)localObject2).b())
            {
              localArrayList.add(localObject2);
              QLog.i("QSplash@QbossSplashNetService", 1, "checkNeedDowloadAndDowload aid =" + ((avdv)localObject2).jdField_b_of_type_JavaLangString + "UIN" + paramLong % 10000L);
            }
  ...
  private void a(ArrayList<tAdvDesc> paramArrayList)
  {
    if ((paramArrayList != null) && (paramArrayList.size() > 0))
    {
      ...
      if (paramArrayList != null)
      {
        ...
        paramArrayList = ahmp.a(paramArrayList);
        a(paramArrayList);
        ahmr.a().a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramArrayList);
      }
    }
    else
    {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localObject != null)
        {
          ...
          if (localObject != null) {
            ahmr.a().a(((Long)localObject).longValue(), 2742);
          }
        }
        paramMobileQbossAdvRsp = paramMobileQbossAdvRsp.mapAdv;
        if ((paramMobileQbossAdvRsp != null) && (paramQQAppInterface != null))
        {
          ...
          if ((paramMobileQbossAdvRsp != null) && (paramMobileQbossAdvRsp.size() > 0))
          {
            ...
            avdq.a(paramMobileQbossAdvRsp, paramQQAppInterface, (String)localObject);
            i = 1;
            if ((i == 0) && (paramQQAppInterface != null))
            {
              ...
              avdu.a(BaseApplicationImpl.getContext(), avdu.a(paramMobileQbossAdvRsp), false);
              avdu.b(BaseApplicationImpl.getContext(), avdu.a(paramMobileQbossAdvRsp));
            }
            return;
          }
        }
  ...
  public void a(String paramString, ArrayList<Integer> paramArrayList)
  {
    ...
    bhkw.a().a(paramArrayList, this, paramString);
  }
        ...
        if ("qboss_banner_login".equals(paramString))
        {
          ...
          if (localObject != null)
          {
            if (!bool1)
            {
              ...
              a((QQAppInterface)localObject, avdu.a(((QQAppInterface)localObject).getAccount()));
            }
            if (!bool3)
            {
              QLog.i("QSplash@QbossSplashNetService", 1, "sendQbossRequest QbossPreDownloadManager.checkPreDownloadResStatus ");
              avdn.a().a((QQAppInterface)localObject);
            }
          }
        }
