...
public class bjgl
{
  public void a(boolean paramBoolean, String paramString1, String paramString2, List<bjcg> paramList, long paramLong, bjgg parambjgg, String paramString3, Activity paramActivity, bjpl parambjpl, Bundle paramBundle)
  {
    ...
    if ((localAppRuntime == null) || (paramBundle == null) || (parambjpl == null))
    {
      QLog.e("SDK_LOGIN.ProxyAuthManager", 1, "doAuthorize return for param is null.");
      parambjgg.a(false, -1, null);
      return;
    }
    ...
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      {
        paramList = (bjcg)paramString1.next();
    ...
    if (Build.VERSION.RELEASE == null)
    {
      ...
      paramBundle.qqv.set(bizw.a().d());
      paramBundle.app_type.set(1);
      paramBundle.pf.set(bjhh.a((Bundle)localObject, "pf", "openmobile_android"));
      paramBundle.sdkp.set(bjhh.a((Bundle)localObject, "sdkp", "android"));
      paramBundle.sdkv.set(bjhh.a((Bundle)localObject, "sdkv", "1.5.9"));
    ...
    for (paramString1 = paramString1.toString();; paramString1 = "")
    {
      ...
      break;
      paramList = bjqk.a(paramActivity, paramString3);
    ...
    paramBundle.skey.set(parambjpl.b);
    if (paramBoolean) {
    ...
    for (;;)
    {
      ...
      paramActivity = new NewIntent(BaseApplicationImpl.getApplication(), bjhv.class);
      paramActivity.setWithouLogin(true);
      paramActivity.putExtra("uin", parambjpl.a);
      localObject = bjhh.a(localAppRuntime, parambjpl, paramBundle.login_sig, "QQConnectLogin.auth", "QQConnectLogin.auth_emp");
      paramBoolean = "QQConnectLogin.auth_emp".equals(localObject);
      paramList = paramBundle.toByteArray();
      paramString1 = paramList;
      if (paramBoolean) {
        paramString1 = bjqk.a(paramList, parambjpl);
      }
      paramActivity.putExtra("data", paramString1);
      paramActivity.putExtra("cmd", (String)localObject);
      paramLong = System.currentTimeMillis();
      QLog.d("SDK_LOGIN.ProxyAuthManager", 1, new Object[] { "cmd=" + (String)localObject, ", uin=*" + bjhh.a(parambjpl.a), ", reqState=", paramString3 });
      paramActivity.setObserver(new bjgm(this, paramLong, parambjpl, (String)localObject, parambjgg, paramBoolean, paramString3, paramString2));
