  ...
  extends VideoJsProxy
{
  ...
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new bjgp(this);
  ...
  private void a(File paramFile, boolean paramBoolean)
  {
    ...
    //   5: if_icmpge +4 -> 9
    //   8: return
    //   9: new 489	java/io/FileInputStream
    //   12: dup
    //   13: aload_1
    //   14: invokespecial 492	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   17: astore 6
    //   19: new 121	android/media/MediaExtractor
    //   22: dup
    //   23: invokespecial 493	android/media/MediaExtractor:<init>	()V
    //   26: astore 5
    //   28: aload 6
    //   30: astore 8
    //   32: aload 5
    ...
    //   36: aload 5
    //   38: aload 6
    //   40: invokevirtual 497	java/io/FileInputStream:getFD	()Ljava/io/FileDescriptor;
    //   43: invokevirtual 501	android/media/MediaExtractor:setDataSource	(Ljava/io/FileDescriptor;)V
    //   46: aload 6
    //   48: astore 8
    //   50: aload 5
    //   52: astore 7
    //   54: aload 5
    //   56: invokestatic 503	bjgl:a	(Landroid/media/MediaExtractor;)I
    //   59: istore_3
    //   60: iload_3
    //   61: iconst_m1
    ...
    //   85: aload 5
    //   87: astore 7
    //   89: new 422	com/tencent/mobileqq/activity/photo/LocalMediaInfo
    //   92: dup
    //   93: invokespecial 504	com/tencent/mobileqq/activity/photo/LocalMediaInfo:<init>	()V
    //   96: astore 4
    //   98: iconst_0
    //   99: istore_3
    //   100: aload 6
    ...
    //   108: aload 9
    //   110: ldc_w 506
    //   113: invokevirtual 509	android/media/MediaFormat:containsKey	(Ljava/lang/String;)Z
    //   116: ifeq +422 -> 538
    //   119: aload 6
    //   121: astore 8
    //   123: aload 5
    ...
    //   127: aload 9
    //   129: ldc_w 506
    //   132: invokevirtual 512	android/media/MediaFormat:getInteger	(Ljava/lang/String;)I
    //   135: istore_3
    //   136: goto +402 -> 538
    //   139: aload 6
    //   141: astore 8
    ...
    //   149: aload 9
    //   151: ldc_w 514
    //   154: invokevirtual 512	android/media/MediaFormat:getInteger	(Ljava/lang/String;)I
    //   157: putfield 466	com/tencent/mobileqq/activity/photo/LocalMediaInfo:mediaWidth	I
    //   160: aload 6
    //   162: astore 8
    //   164: aload 5
    //   166: astore 7
    ...
    //   170: aload 9
    //   172: ldc_w 516
    //   175: invokevirtual 512	android/media/MediaFormat:getInteger	(Ljava/lang/String;)I
    //   178: putfield 469	com/tencent/mobileqq/activity/photo/LocalMediaInfo:mediaHeight	I
    //   181: aload 6
    //   183: astore 8
    //   185: aload 5
    //   187: astore 7
    ...
    //   191: aload 9
    //   193: ldc_w 518
    //   196: invokevirtual 522	android/media/MediaFormat:getLong	(Ljava/lang/String;)J
    //   199: l2d
    //   200: ldc2_w 523
    //   203: ddiv
    //   204: invokestatic 530	java/lang/Math:round	(D)J
    //   207: putfield 533	com/tencent/mobileqq/activity/photo/LocalMediaInfo:mDuration	J
    //   210: aload 6
    //   212: astore 8
    //   214: aload 5
    //   216: astore 7
    //   218: aload 4
    //   220: aload_1
    //   221: invokevirtual 535	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   224: putfield 425	com/tencent/mobileqq/activity/photo/LocalMediaInfo:path	Ljava/lang/String;
    //   227: aload 6
    //   229: astore 8
    //   231: aload 5
    //   233: astore 7
    //   235: aload 4
    //   237: aload_1
    //   238: invokevirtual 538	java/io/File:length	()J
    //   241: putfield 541	com/tencent/mobileqq/activity/photo/LocalMediaInfo:fileSize	J
    //   244: aload 4
    //   246: astore_1
    //   247: aload 6
    //   249: ifnull +8 -> 257
    //   252: aload 6
    //   254: invokevirtual 544	java/io/FileInputStream:close	()V
    //   257: aload_1
    //   258: astore 4
    //   260: aload 5
    //   262: ifnull +11 -> 273
    //   265: aload 5
    //   267: invokevirtual 547	android/media/MediaExtractor:release	()V
    //   270: aload_1
    //   271: astore 4
    //   273: aload 4
    ...
    //   278: aload_0
    //   279: aload_0
    //   280: getfield 61	bjgl:jdField_a_of_type_Int	I
    //   283: ldc_w 549
    //   286: aconst_null
    //   287: ldc_w 433
    //   290: invokespecial 551	bjgl:a	(ILjava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;)V
    //   293: return
    //   294: aload 6
    //   296: astore 8
    //   298: aload 5
    ...
    //   304: aload 9
    //   306: ldc_w 516
    //   309: invokevirtual 512	android/media/MediaFormat:getInteger	(Ljava/lang/String;)I
    //   312: putfield 466	com/tencent/mobileqq/activity/photo/LocalMediaInfo:mediaWidth	I
    //   315: aload 6
    //   317: astore 8
    //   319: aload 5
    //   321: astore 7
    ...
    //   325: aload 9
    //   327: ldc_w 514
    //   330: invokevirtual 512	android/media/MediaFormat:getInteger	(Ljava/lang/String;)I
    //   333: putfield 469	com/tencent/mobileqq/activity/photo/LocalMediaInfo:mediaHeight	I
    //   336: goto -155 -> 181
    //   339: astore 7
    //   341: aload 4
    //   343: astore_1
    ...
    //   359: ldc_w 553
    //   362: aload 4
    //   364: invokestatic 556	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   367: aload 6
    //   369: ifnull +8 -> 377
    //   372: aload 6
    //   374: invokevirtual 544	java/io/FileInputStream:close	()V
    //   377: aload_1
    //   378: astore 4
    //   380: aload 5
    //   382: ifnull -109 -> 273
    //   385: aload 5
    //   387: invokevirtual 547	android/media/MediaExtractor:release	()V
    //   390: aload_1
    //   391: astore 4
    //   393: goto -120 -> 273
    //   396: astore_1
    ...
    //   405: ifnull +8 -> 413
    //   408: aload 6
    //   410: invokevirtual 544	java/io/FileInputStream:close	()V
    //   413: aload 7
    //   415: ifnull +8 -> 423
    //   418: aload 7
    //   420: invokevirtual 547	android/media/MediaExtractor:release	()V
    //   423: aload_1
    //   424: athrow
    //   425: iload_2
    //   426: ifeq +11 -> 437
    ...
    //   430: aload 4
    //   432: iconst_1
    //   433: invokespecial 404	bjgl:a	(Lcom/tencent/mobileqq/activity/photo/LocalMediaInfo;Z)V
    //   436: return
    //   437: aload_0
    //   438: aload_0
    //   439: getfield 192	bjgl:jdField_a_of_type_ComTencentQqminiSdkLauncherCoreIMiniAppContext	Lcom/tencent/qqmini/sdk/launcher/core/IMiniAppContext;
    //   442: ldc 194
    //   444: invokeinterface 200 2 0
    //   449: checkcast 194	com/tencent/qqmini/sdk/launcher/shell/IMiniAppFileManager
    //   452: aload 4
    //   454: getfield 425	com/tencent/mobileqq/activity/photo/LocalMediaInfo:path	Ljava/lang/String;
    //   457: invokeinterface 559 2 0
    //   462: aload 4
    //   464: getfield 541	com/tencent/mobileqq/activity/photo/LocalMediaInfo:fileSize	J
    //   467: aload 4
    //   469: invokespecial 416	bjgl:a	(Ljava/lang/String;JLcom/tencent/mobileqq/activity/photo/LocalMediaInfo;)V
    //   472: return
    //   473: astore 4
    //   475: goto -218 -> 257
    //   478: astore 4
  ...
  private void a(String paramString1, String paramString2, LocalMediaInfo paramLocalMediaInfo, int paramInt)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentBizQqstoryUtilsFfmpegFFmpeg.execute(arrayOfString, new bjgq(this, l1, paramString1, paramLocalMediaInfo, paramInt, paramString2, l2));
      return;
    }
  ...
  private boolean a(Bitmap paramBitmap, LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    //   11: iconst_2
    //   12: ldc_w 668
    //   15: invokestatic 670	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   18: iload_3
    //   19: istore 4
    //   21: iload 4
    //   23: ireturn
    ...
    //   30: iconst_2
    //   31: ldc_w 672
    //   34: invokestatic 670	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   37: iconst_0
    //   38: ireturn
    //   39: aload_0
    //   40: getfield 192	bjgl:jdField_a_of_type_ComTencentQqminiSdkLauncherCoreIMiniAppContext	Lcom/tencent/qqmini/sdk/launcher/core/IMiniAppContext;
    //   43: ldc 194
    //   45: invokeinterface 200 2 0
    //   50: checkcast 194	com/tencent/qqmini/sdk/launcher/shell/IMiniAppFileManager
    //   53: ldc_w 674
    //   56: invokeinterface 450 2 0
    //   61: astore 5
    //   63: new 241	java/io/File
    //   66: dup
    //   67: aload 5
    //   69: invokespecial 452	java/io/File:<init>	(Ljava/lang/String;)V
    //   72: astore 10
    //   74: aload 10
    //   76: invokevirtual 455	java/io/File:exists	()Z
    //   79: ifeq +9 -> 88
    //   82: aload 10
    //   84: invokevirtual 458	java/io/File:delete	()Z
    //   87: pop
    //   88: new 676	java/io/FileOutputStream
    //   91: dup
    //   92: aload 10
    //   94: invokespecial 677	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   97: astore 6
    //   99: new 679	java/io/BufferedOutputStream
    //   102: dup
    //   103: aload 6
    //   105: sipush 4096
    //   108: invokespecial 682	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;I)V
    //   111: astore 9
    //   113: aload 9
    //   115: astore 8
    //   117: aload 6
    //   119: astore 7
    //   121: aload_1
    //   122: getstatic 688	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   125: bipush 100
    //   127: aload 9
    //   129: invokevirtual 693	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   132: istore_3
    //   133: aload 9
    //   135: astore 8
    //   137: aload 6
    //   139: astore 7
    //   141: aload 9
    //   143: invokevirtual 696	java/io/BufferedOutputStream:flush	()V
    //   146: aload 9
    //   148: astore 8
    //   150: aload 6
    //   152: astore 7
    //   154: aload 10
    //   156: invokevirtual 535	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   159: astore_1
    //   160: aload 9
    //   162: astore 8
    //   164: aload 6
    ...
    //   168: aload_2
    //   169: aload_0
    //   170: getfield 192	bjgl:jdField_a_of_type_ComTencentQqminiSdkLauncherCoreIMiniAppContext	Lcom/tencent/qqmini/sdk/launcher/core/IMiniAppContext;
    //   173: ldc 194
    //   175: invokeinterface 200 2 0
    //   180: checkcast 194	com/tencent/qqmini/sdk/launcher/shell/IMiniAppFileManager
    //   183: aload_1
    //   184: invokeinterface 559 2 0
    //   189: putfield 567	com/tencent/mobileqq/activity/photo/LocalMediaInfo:thumbnailPath	Ljava/lang/String;
    //   192: aload 6
    //   194: ifnull +8 -> 202
    //   197: aload 6
    //   199: invokevirtual 697	java/io/FileOutputStream:close	()V
    //   202: aload 9
    //   204: ifnull +275 -> 479
    //   207: aload 9
    //   209: invokevirtual 698	java/io/BufferedOutputStream:close	()V
    //   212: aload_1
    //   213: astore_2
    //   214: iload_3
    //   215: istore 4
    ...
    //   246: invokestatic 285	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   249: iload_3
    //   250: ireturn
    //   251: astore_2
    //   252: aload_2
    //   253: invokevirtual 701	java/io/IOException:printStackTrace	()V
    //   256: goto -54 -> 202
    //   259: astore_2
    //   260: aload_2
    //   261: invokevirtual 701	java/io/IOException:printStackTrace	()V
    //   264: aload_1
    //   265: astore_2
    //   266: goto -52 -> 214
    //   269: astore_2
    ...
    //   308: ldc_w 703
    //   311: aload_2
    //   312: invokestatic 556	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   315: aload 6
    //   317: ifnull +8 -> 325
    //   320: aload 6
    //   322: invokevirtual 697	java/io/FileOutputStream:close	()V
    //   325: aload_1
    //   326: astore_2
    //   327: iload 4
    //   329: istore_3
    ...
    //   332: ifnull -118 -> 214
    //   335: aload 5
    //   337: invokevirtual 698	java/io/BufferedOutputStream:close	()V
    //   340: aload_1
    //   341: astore_2
    //   342: iload 4
    //   344: istore_3
    ...
    //   348: astore_2
    //   349: aload_2
    //   350: invokevirtual 701	java/io/IOException:printStackTrace	()V
    //   353: aload_1
    //   354: astore_2
    //   355: iload 4
    //   357: istore_3
    ...
    //   361: astore_2
    //   362: aload_2
    //   363: invokevirtual 701	java/io/IOException:printStackTrace	()V
    //   366: goto -41 -> 325
    //   369: astore_1
    //   370: aconst_null
    //   371: astore 8
    ...
    //   378: ifnull +8 -> 386
    //   381: aload 6
    //   383: invokevirtual 697	java/io/FileOutputStream:close	()V
    //   386: aload 8
    //   388: ifnull +8 -> 396
    //   391: aload 8
    //   393: invokevirtual 698	java/io/BufferedOutputStream:close	()V
    //   396: aload_1
    //   397: athrow
    //   398: astore_2
    //   399: aload_2
    //   400: invokevirtual 701	java/io/IOException:printStackTrace	()V
    //   403: goto -17 -> 386
    //   406: astore_2
    //   407: aload_2
    //   408: invokevirtual 701	java/io/IOException:printStackTrace	()V
    //   411: goto -15 -> 396
    //   414: astore_1
    //   415: aconst_null
    //   416: astore 8
  ...
  private void b(Activity paramActivity, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    localIActivityResultManager.addActivityResultListener(new bjgr(this, localFile, localIActivityResultManager, paramBoolean1));
    ...
    catch (JSONException paramActivity)
    {
      for (;;)
      {
        ...
        if ("saveVideoToPhotosAlbum".equals(paramString1))
        {
          ...
          else if (ypi.a(paramActivity, ((IMiniAppFileManager)this.jdField_a_of_type_ComTencentQqminiSdkLauncherCoreIMiniAppContext.getManager(IMiniAppFileManager.class)).getAbsolutePath(paramString2), a()))
          {
            a(paramInt, paramString1, null);
          }
          else
