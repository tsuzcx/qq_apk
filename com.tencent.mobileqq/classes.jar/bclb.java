  ...
  extends bcgx
{
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    int i = AIOUtils.dp2px(10.0F, localResources);
    if (paramView == null)
    {
      paramBundle = new LinearLayout(paramContext);
      paramBundle.setOrientation(1);
      bcld localbcld = new bcld(null);
      paramBundle.setTag(2131374716, localbcld);
      ...
      if (paramView == null)
      {
        ...
        paramContext.setCompoundDrawablePadding(AIOUtils.dp2px(5.0F, localResources));
        localObject = localResources.getDrawable(2130847245);
        ((Drawable)localObject).setBounds(0, 0, AIOUtils.dp2px(18.0F, localResources), AIOUtils.dp2px(10.0F, localResources));
        ...
        localbcld.jdField_a_of_type_AndroidWidgetTextView = paramView;
        localbcld.b = localTextView;
        localbcld.jdField_a_of_type_AndroidWidgetImageView = localImageView;
        localbcld.c = paramContext;
        localbcld.jdField_a_of_type_AndroidWidgetLinearLayout = paramBundle;
        paramView = localbcld;
    ...
    for (;;)
    {
      ...
      paramView = (bcld)paramContext.getTag(2131374716);
      break label443;
      label517:
      paramContext.setPadding(0, 0, 0, 0);
      break label462;
      label528:
      i = AIOUtils.dp2px(24.0F, localResources);
      try
      {
        ...
        paramBundle.setDecodeHandler(bfol.a);
        ...
        paramView.c.setText(amtj.a(2131713647));
