...
{
  public arux(Bundle paramBundle, MessengerService paramMessengerService, URLDrawable paramURLDrawable, QQAppInterface paramQQAppInterface, PicMessageExtraData paramPicMessageExtraData) {}
  ...
  protected Integer a(Void... paramVarArgs)
  {
    ...
    {
      ahth.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, null, paramVarArgs);
      return Integer.valueOf(2);
    }
    paramVarArgs = this.jdField_a_of_type_ComTencentImageURLDrawable.getURL().toString();
    if (!bdsh.b(paramVarArgs)) {
      return Integer.valueOf(1);
    }
    paramVarArgs = bdsh.a(paramVarArgs);
    if (paramVarArgs != null) {}
    label296:
    label307:
    for (paramVarArgs = SecUtil.getFileMd5(paramVarArgs.getAbsolutePath());; paramVarArgs = null)
    {
      ...
      {
        paramVarArgs = anhk.bl + aopp.a(str2) + paramVarArgs + str1 + ".jpg";
        try
        {
