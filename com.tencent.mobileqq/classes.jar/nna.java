  ...
  extends ajtd
{
  ...
  nnb jdField_a_of_type_Nnb;
  
  public nna(AppInterface paramAppInterface)
  {
    super(paramAppInterface);
    this.jdField_a_of_type_JavaLangString = "image_collection_article_id";
  }
  
  public nna(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if ((!localGetArticleLikeCountRespond.ret.ret_code.has()) || (localGetArticleLikeCountRespond.ret.ret_code.get() != 0))
        {
          ...
          this.jdField_a_of_type_Nnb.a(bool, paramToServiceMsg, i);
          return;
        }
      }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((!paramFromServiceMsg.ret.ret_code.has()) || (paramFromServiceMsg.ret.ret_code.get() != 0))
        {
          ...
          this.jdField_a_of_type_Nnb.a(bool2, paramToServiceMsg, bool1);
          return;
        }
      }
      catch (Exception paramToServiceMsg)
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.jdField_a_of_type_Nnb.a(bool1, paramToServiceMsg);
        return;
      }
      catch (Exception paramToServiceMsg)
      {
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Nnb != null) {
        this.jdField_a_of_type_Nnb.a(bool1);
      }
      return;
    }
    catch (Exception paramToServiceMsg)
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Nnb != null) {
        this.jdField_a_of_type_Nnb.a(bool1, i);
      }
      return;
    }
    catch (Exception paramToServiceMsg)
    ...
    for (;;)
    {
      try
      {
        ...
        if ((!paramToServiceMsg.ret.ret_code.has()) || (paramToServiceMsg.ret.ret_code.get() == 0))
        {
          ...
          if (this.jdField_a_of_type_Nnb != null) {
            this.jdField_a_of_type_Nnb.b(bool2, i);
          }
          return;
        }
      }
  ...
  private void g(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      {
        paramFromServiceMsg.mergeFrom((byte[])paramObject);
        localsoz.jdField_a_of_type_JavaLangString = ((String)paramToServiceMsg.extraData.get(this.jdField_a_of_type_JavaLangString));
        paramToServiceMsg = localsoz.jdField_a_of_type_JavaLangString;
        if (paramFromServiceMsg.ret.has()) {
          if ((!paramFromServiceMsg.ret.ret_code.has()) || (paramFromServiceMsg.ret.ret_code.get() == 0))
          {
            bool = true;
            if (paramFromServiceMsg.article_share_url.has()) {
              localsoz.jdField_b_of_type_JavaLangString = paramFromServiceMsg.article_share_url.get().toStringUtf8();
            }
            if (paramFromServiceMsg.puin.has()) {
              localsoz.c = (paramFromServiceMsg.puin.get() + "");
            }
            if (paramFromServiceMsg.article_img_url.has()) {
              localsoz.d = paramFromServiceMsg.article_img_url.get().toStringUtf8();
            }
            if (paramFromServiceMsg.article_title.has()) {
              localsoz.e = paramFromServiceMsg.article_title.get().toStringUtf8();
            }
            if (paramFromServiceMsg.enable_comment.has()) {
              localsoz.jdField_a_of_type_Int = paramFromServiceMsg.enable_comment.get();
            }
            if (paramFromServiceMsg.comment_url.has()) {
              localsoz.f = paramFromServiceMsg.comment_url.get().toStringUtf8();
            }
            if (paramFromServiceMsg.firstItem.has())
            {
              localsoz.jdField_a_of_type_Spa = new spa();
              localsoz.jdField_a_of_type_Spa.jdField_a_of_type_JavaLangString = paramFromServiceMsg.firstItem.url.get().toStringUtf8();
              localsoz.jdField_a_of_type_Spa.d = paramFromServiceMsg.firstItem.photo_author_name.get().toStringUtf8();
              localsoz.jdField_a_of_type_Spa.c = paramFromServiceMsg.firstItem.photo_time.get().toStringUtf8();
              localsoz.jdField_a_of_type_Spa.jdField_b_of_type_JavaLangString = paramFromServiceMsg.firstItem.publicaccount_name.get().toStringUtf8();
            }
            ...
            {
              localspb = new spb();
              localspb.jdField_a_of_type_JavaLangString = ((ArticleComment.PhotoItemInfo)paramFromServiceMsg.item.get(i)).url.get().toStringUtf8();
              localspb.jdField_b_of_type_JavaLangString = ((ArticleComment.PhotoItemInfo)paramFromServiceMsg.item.get(i)).content.get().toStringUtf8();
              localspb.c = ((ArticleComment.PhotoItemInfo)paramFromServiceMsg.item.get(i)).static_url.get().toStringUtf8();
              localspb.jdField_a_of_type_Int = ((ArticleComment.PhotoItemInfo)paramFromServiceMsg.item.get(i)).width.get();
              localspb.jdField_b_of_type_Int = ((ArticleComment.PhotoItemInfo)paramFromServiceMsg.item.get(i)).height.get();
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_Nnb.a(bool, localsoz, (byte[])paramObject, paramToServiceMsg);
        return;
        bool = false;
        continue;
        bool = false;
        paramToServiceMsg = localspb;
      }
    }
  }
  ...
  private void h(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    this.jdField_a_of_type_Nnb.a(bool, paramToServiceMsg);
  }
      ...
      try
      {
        ...
        if ((paramFromServiceMsg.uint32_ret_code.has()) && (paramFromServiceMsg.uint32_ret_code.get() == 0))
        {
          if (paramFromServiceMsg.uint32_read_count.has())
          {
            ...
            if (this.jdField_a_of_type_Nnb != null) {
              this.jdField_a_of_type_Nnb.c(bool, i);
            }
            return;
            bool = false;
            break;
  ...
  public void a()
  {
    this.jdField_a_of_type_Nnb = null;
  }
  ...
  public void a(String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    localGetPhotoCollectionInfoRequest.versionInfo.set("8.2.8,3,4440");
  ...
  public void a(String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, String paramString4, int paramInt3, ArrayList<spc> paramArrayList)
  {
    if (QLog.isColorLevel()) {
    ...
    paramString2 = ByteStringMicro.copyFromUtf8("8.2.8");
    localReportGalleryInfoRequest.mv.set(paramString2);
    paramString2 = ByteStringMicro.copyFromUtf8("4440");
    localReportGalleryInfoRequest.subv.set(paramString2);
    paramString2 = ByteStringMicro.copyFromUtf8(ajsf.c[bbev.a(this.mApp.getApp().getBaseContext())]);
    ...
    if ((paramArrayList != null) && (paramArrayList.size() > 0) && (paramInt1 == 2))
    {
      ...
      {
        paramString3 = (spc)paramString2.next();
  ...
  public void b(String paramString)
  {
    ...
    localGetRecommendInfoRequest.versionInfo.set("8.2.8,3,4440");
