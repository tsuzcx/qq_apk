...
public class nna
  implements nmx
{
  private static HashMap<String, nmv> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private ITMAssistantDownloadClientListener jdField_a_of_type_ComTencentTmdownloaderITMAssistantDownloadClientListener = new nnb(this);
  ...
  public void a(Context paramContext, String paramString1, String paramString2, String paramString3, nmg paramnmg, Map<String, String> paramMap)
  {
    if (paramnmg == null) {
      return;
    }
    if (paramContext == null)
    {
      paramnmg.loaded(paramString1, 11);
      return;
    }
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString3)))
    {
      paramnmg.loaded(paramString1, 12);
      return;
    }
    if (AppNetConnInfo.getRecentNetworkInfo() == null)
    {
      paramnmg.loaded(paramString1, 10);
      return;
    }
    Object localObject = new File(paramString3.substring(0, paramString3.lastIndexOf("/")));
    if ((!((File)localObject).exists()) && (!((File)localObject).mkdirs()))
    {
      paramnmg.loaded(paramString1, 13);
      return;
    }
    localObject = Md5Utils.getMD5(paramString1);
    paramString2 = new nmv((String)localObject, paramString3, paramString2, paramnmg);
      ...
      try
      {
        ...
        if (i == 0)
        {
          ...
          try
          {
            ...
            bjsy.a(paramContext, paramString3);
            return;
          }
  ...
  public void a(Context paramContext, String paramString1, String paramString2, nmg paramnmg)
  {
    a(paramContext, paramString1, "0", paramString2, paramnmg, null);
  }
  
  public void a(TMAssistantDownloadClient paramTMAssistantDownloadClient, nmv paramnmv, String paramString)
  {
    ...
    try
    {
      ...
      for (paramTMAssistantDownloadClient = localObject;; paramTMAssistantDownloadClient = paramTMAssistantDownloadClient.mSavePath)
      {
        ...
        a(paramnmv.jdField_a_of_type_Nmg, paramString, paramnmv.c, 14, "get current download path fail after download");
        return;
      }
    ...
    {
      a(paramnmv.jdField_a_of_type_Nmg, paramString, paramnmv.c, 15, "cannot get current file after download");
      return;
    }
    if (!bhmi.d(localTMAssistantDownloadClient, paramnmv.b))
    {
      a(paramnmv.jdField_a_of_type_Nmg, paramString, paramnmv.c, 16, "rename file fail after download");
      paramTMAssistantDownloadClient.delete();
      return;
    }
    a(paramnmv.jdField_a_of_type_Nmg, paramString, paramnmv.c, 0, "offline zip download success");
  }
  ...
  public void a(nmg paramnmg, String paramString1, String paramString2, int paramInt, String paramString3)
  {
    if (QLog.isColorLevel()) {
      QLog.d("OfflineDownload", 2, paramString3 + ", bid: " + paramString2 + ", errCode: " + paramInt);
    }
    if ((paramnmg != null) && (paramInt >= 0)) {
      paramnmg.loaded(paramString1, paramInt);
    }
