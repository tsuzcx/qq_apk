  ...
  implements View.OnClickListener
{
  ...
  public okt(ohs paramohs, Activity paramActivity)
  {
    super(paramActivity);
  ...
  private void a(IBinder paramIBinder)
  {
    ...
    this.jdField_b_of_type_AndroidViewView.setOnKeyListener(new okv(this));
  ...
  public View a(LayoutInflater paramLayoutInflater)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramLayoutInflater.findViewById(2131364204));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramLayoutInflater.findViewById(2131364206));
  ...
  protected void a()
  {
    ...
    localLayoutParams.width = bbll.a(21.0F);
    localLayoutParams.height = bbll.a(10.5F);
  ...
  protected final void a(View paramView, int paramInt)
  {
    ...
    if (paramInt == 3)
    {
      ...
      bbll.a(21.0F);
      n = bbll.a(21.0F);
      i = this.e - bbll.a(12.0F) - this.c;
      if (this.f - (localObject[1] + n) <= this.d) {
        break label277;
      }
      RelativeLayout.LayoutParams localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_a_of_type_AndroidWidgetImageView.getLayoutParams();
      localLayoutParams.setMargins(0, 0, bbll.a(10.5F), 0);
      this.jdField_a_of_type_AndroidWidgetImageView.setLayoutParams(localLayoutParams);
      this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(4);
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      paramInt = localObject[1] + n + bbll.a(4.0F);
    ...
    for (;;)
    {
      ...
      ((RelativeLayout.LayoutParams)localObject).setMargins(0, 0, bbll.a(10.5F), 0);
  ...
  public void b()
  {
    ...
    setOnDismissListener(new oku(this));
  }
  ...
  public final void b(View paramView, int paramInt)
  {
    ...
    {
      a(actj.a(125.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), actj.a(88.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()));
      a();
      this.jdField_a_of_type_Boolean = true;
    }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_Okw != null) {
        this.jdField_a_of_type_Okw.a(i);
      }
      if (this.jdField_a_of_type_Ohs != null)
      {
        this.jdField_a_of_type_Ohs.c();
        if ((i == 3) && ((this.jdField_a_of_type_Ohs instanceof ogn))) {
          ((ogn)this.jdField_a_of_type_Ohs).g();
        }
      }
      return;
      i = 3;
