...
public class avsr
{
  ...
  public avsr(HeartLayout paramHeartLayout)
  {
    this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger = new AtomicInteger(0);
    this.jdField_a_of_type_Avst = new avst(paramHeartLayout);
  ...
  public Path a(int paramInt1, int paramInt2, AtomicInteger paramAtomicInteger, View paramView)
  {
    ...
    if (!this.jdField_a_of_type_Avst.jdField_a_of_type_Boolean) {
      ...
      {
        this.jdField_a_of_type_Avst.jdField_a_of_type_Int = ((paramView.getWidth() - this.jdField_a_of_type_Avst.h) / 2);
        if ((paramInt2 >= 0) && (paramInt2 <= paramView.getHeight())) {
          break label402;
        }
        this.jdField_a_of_type_Avst.b = this.jdField_a_of_type_Avst.i;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        return localPath;
        this.jdField_a_of_type_Avst.jdField_a_of_type_Int = (paramInt1 - this.jdField_a_of_type_Avst.h / 2);
        break;
        label402:
        this.jdField_a_of_type_Avst.b = (paramView.getHeight() - paramInt2 + this.jdField_a_of_type_Avst.h / 2);
        break label87;
        label429:
        paramInt1 = -1;
        break label99;
  ...
  public avst a()
  {
    return this.jdField_a_of_type_Avst;
  }
  ...
  {
    paramView.setTag(2131374348, Boolean.valueOf(true));
    paramViewGroup.addView(paramView, new ViewGroup.LayoutParams(paramInt1, paramInt2));
    avsu localavsu = new avsu(a((int)paramFloat1, (int)paramFloat2, this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger, paramViewGroup), a(), paramViewGroup, paramView, this.jdField_a_of_type_Avst);
    if (paramLong > 0L) {}
    for (;;)
    {
      localavsu.setDuration(paramLong);
      localavsu.setInterpolator(this.b);
      localavsu.jdField_a_of_type_Int = paramInt3;
      localavsu.jdField_a_of_type_Avsv = this.jdField_a_of_type_Avsv;
      localavsu.jdField_a_of_type_AndroidViewAnimationInterpolator = this.jdField_a_of_type_AndroidViewAnimationInterpolator;
      localavsu.setAnimationListener(new avss(this, paramViewGroup, paramView));
      paramView.startAnimation(localavsu);
      return;
      paramLong = this.jdField_a_of_type_Avst.j;
    }
  }
  ...
  {
    a(paramView, paramFloat1, paramFloat2, this.jdField_a_of_type_Avst.h, this.jdField_a_of_type_Avst.i, paramViewGroup, paramLong, paramInt);
  }
  
  public void a(avsv paramavsv)
  {
    this.jdField_a_of_type_Avsv = paramavsv;
  }
}
