...
public class nmc
{
  ...
  public static double a(BaseArticleInfo paramBaseArticleInfo, Context paramContext, String paramString1, String paramString2)
  {
    ...
    SosoInterface.SosoLbsInfo localSosoLbsInfo = akuf.a("readinjoy_feed_ad_distance");
  ...
  public static int a(Context paramContext, nla paramnla)
  {
    if ((paramContext == null) || (paramnla == null)) {}
    do
    {
      ...
      do
      {
        ...
        {
          return -1;
          paramContext = paramnla.jdField_f_of_type_JavaLangString;
          paramnla = paramnla.jdField_d_of_type_JavaLangString;
          if ((!TextUtils.isEmpty(paramContext)) && (!TextUtils.isEmpty(paramnla))) {
            break;
          }
        } while (!QLog.isColorLevel());
        QLog.d("NativeAdUtils", 2, "isPkgDownloading pkg:" + paramContext + ", appid:" + paramnla + " false");
        return -1;
        localDownloadInfo = bdle.a().a(paramnla);
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("NativeAdUtils", 2, "isPkgDownloading pkg:" + paramContext + ", appid:" + paramnla + " true");
        }
  ...
  public static String a()
  {
    for (;;)
    {
      try
      {
        ...
        Object localObject1 = bhvy.a((AppRuntime)localObject1, true, false);
        if (localObject1 != null) {
  ...
  public static JSONObject a(Context paramContext)
  {
    ...
    //   7: astore 6
    //   9: invokestatic 844	oaf:a	()Ljava/lang/String;
    //   12: astore 5
    //   14: invokestatic 846	oaf:c	()Ljava/lang/String;
    //   17: astore 4
    //   19: aload 5
    ...
    //   35: ldc_w 853
    //   38: aload_3
    //   39: invokestatic 857	bdik:d	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   69: new 864	yyq
    //   72: dup
    //   73: invokespecial 865	yyq:<init>	()V
    //   76: astore 5
    //   78: aload 5
    //   80: ldc_w 867
    //   83: putfield 868	yyq:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   89: aload 5
    //   91: invokestatic 879	yyp:a	(Landroid/content/Context;Lyyq;)Lyyr;
    //   94: astore 5
    //   96: aload 5
    //   98: ifnull +51 -> 149
    //   101: aload 5
    //   103: getfield 884	yyr:a	Ltencent/gdt/qq_ad_get$QQAdGet$DeviceInfo;
    //   106: ifnull +43 -> 149
    //   109: aload 6
    //   111: ldc_w 853
    //   114: aload 5
    //   116: getfield 884	yyr:a	Ltencent/gdt/qq_ad_get$QQAdGet$DeviceInfo;
    ...
    //   131: ldc_w 862
    //   134: aload 5
    //   136: getfield 884	yyr:a	Ltencent/gdt/qq_ad_get$QQAdGet$DeviceInfo;
    ...
    //   248: ldc_w 946
    //   251: aload_0
    //   252: invokestatic 949	onh:c	(Landroid/content/Context;)Ljava/lang/String;
    ...
    //   380: ldc_w 853
    //   383: aload_3
    //   384: invokestatic 857	bdik:d	(Ljava/lang/String;)Ljava/lang/String;
  ...
  public static JSONObject a(AdData paramAdData, HashMap<String, Object> paramHashMap)
  {
    try
    {
      ...
      if (paramAdData != null)
      {
        ...
        if (oai.a(paramAdData))
        {
          localJSONObject.put("game_component_type", paramAdData.jdField_a_of_type_Nxw.x);
          localJSONObject.put("game_pkg", paramAdData.jdField_a_of_type_Nxw.jdField_b_of_type_JavaLangString);
        }
  ...
  public static void a(Activity paramActivity, nla paramnla, bdld parambdld)
  {
    if ((paramActivity == null) || (paramnla == null)) {}
    String str1;
    String str2;
    String str3;
    do
    {
      return;
      str1 = paramnla.jdField_f_of_type_JavaLangString;
      str2 = paramnla.jdField_d_of_type_JavaLangString;
      str3 = paramnla.jdField_j_of_type_JavaLangString;
      paramnla = paramnla.i;
    } while ((TextUtils.isEmpty(str1)) || (TextUtils.isEmpty(str2)) || (TextUtils.isEmpty(str3)) || (TextUtils.isEmpty(paramnla)));
    Bundle localBundle = new Bundle();
    localBundle.putString(bdlb.jdField_f_of_type_JavaLangString, str1);
    localBundle.putString(bdlb.jdField_b_of_type_JavaLangString, str2);
    localBundle.putString(bdlb.jdField_j_of_type_JavaLangString, str3);
    localBundle.putString(bdlb.jdField_l_of_type_JavaLangString, paramnla);
    localBundle.putInt(bdlb.k, 2);
    localBundle.putInt(bdlb.E, 0);
    localBundle.putBoolean(bdlb.x, false);
    localBundle.putInt(bdlb.H, 0);
    localBundle.putBoolean(bdlb.y, true);
    if (QLog.isColorLevel()) {
      QLog.d("NativeAdUtils", 2, "downloadApk pkg:" + str1 + ", appid:" + str2 + ", name:" + paramnla + ", url:" + str3);
    }
    if (parambdld != null) {
      bdle.a().a(parambdld);
    }
  ...
  private static void a(Context paramContext)
  {
    ...
    while ((paramContext == null) || (!bbfj.g(paramContext))) {
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.d("NativeAdUtils", 2, "getADPosition doStartADLocation network is Available...");
    }
    akuf.a(new nmg("readinjoy_feed_ad_distance"));
    aO += 1;
  }
  ...
  {
    if (oaq.a(paramAdData))
    {
      a(new nyd().a(paramQQAppInterface).a(BaseApplication.getContext()).a(jdField_b_of_type_Int).b(a(paramAdData)).a(oas.a(paramAdData)).d(a(paramAdData)).a());
      return;
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, AdData paramAdData, float paramFloat, long paramLong)
  {
    ...
    try
    {
      ...
      if (oaq.a(paramAdData))
      {
        a(new nyd().a(paramQQAppInterface).a(BaseApplication.getContext()).a(jdField_b_of_type_Int).b(a(paramAdData)).a(oas.a(paramAdData)).c(localJSONObject).d(a(paramAdData)).a());
        return;
      }
    }
    catch (JSONException localJSONException)
  ...
  {
    if (oaq.a(paramAdData, false))
    {
      a(new nyd().a(paramQQAppInterface).a(BaseApplication.getContext()).a(jdField_a_of_type_Int).b(K).a(oas.a(paramAdData)).d(a(paramAdData)).d(paramInt).a());
      return;
    }
  ...
  {
    axqy.b(paramQQAppInterface, "dc04719", "ad", "0", paramString1.toUpperCase(), paramString2.toUpperCase(), paramInt1, paramInt2, paramString3, paramString4, paramString5, paramString6);
  }
  ...
  public static void a(nyb paramnyb)
  {
    if (paramnyb == null) {}
    ...
    {
      return;
      AppInterface localAppInterface = paramnyb.a();
      localContext = paramnyb.a();
      i1 = paramnyb.a();
      i2 = paramnyb.b();
      localAdvertisementInfo = paramnyb.a();
      localVideoAdInfo = paramnyb.a();
      l1 = paramnyb.a();
      str = paramnyb.a();
      localJSONObject1 = paramnyb.a();
      i3 = paramnyb.d();
      localJSONObject2 = paramnyb.b();
      localBundle = paramnyb.a();
      localJSONObject3 = paramnyb.c();
      localJSONObject4 = paramnyb.d();
      localJSONObject5 = paramnyb.f();
      localJSONObject6 = paramnyb.e();
      i4 = paramnyb.c();
      bool = paramnyb.a();
      paramnyb = localAppInterface;
        ...
        if (BaseApplicationImpl.sProcessId == 1)
        {
          ...
          if (localAppRuntime != null)
          {
            ...
            if ((localAppRuntime instanceof QQAppInterface)) {
              paramnyb = (QQAppInterface)localAppRuntime;
            }
          }
        }
      }
    } while (paramnyb == null);
    ThreadManager.post(new NativeAdUtils.3(localJSONObject3, paramnyb.getAccount(), i1, i2, i4, localContext, localAdvertisementInfo, localVideoAdInfo, i3, localJSONObject1, localJSONObject2, localBundle, str, l1, localJSONObject4, localJSONObject6, localJSONObject5, paramnyb, bool), 5, null, true);
  }
  ...
  public static boolean a(Context paramContext, String paramString)
  {
    ...
    {
      return bool1;
      bool2 = bbfr.a(paramContext, paramString);
      bool1 = bool2;
    } while (!QLog.isColorLevel());
  ...
  public static boolean a(Context paramContext, nla paramnla)
  {
    ...
    do
    {
      ...
      paramnla = localDownloadInfo.jdField_l_of_type_JavaLangString;
      bool1 = bool3;
      if (!TextUtils.isEmpty(paramnla))
      {
        bool1 = bool3;
        if (new File(paramnla).exists()) {
          bool1 = true;
        }
      }
      bool2 = bool1;
    } while (!QLog.isColorLevel());
    QLog.d("NativeAdUtils", 2, "isPkgExist(" + bool1 + ") pkg:" + str1 + ", appid:" + str2 + ", path:" + paramnla);
    return bool1;
  ...
  public static boolean a(nla paramnla)
  {
    String str1 = paramnla.jdField_f_of_type_JavaLangString;
    String str2 = paramnla.jdField_d_of_type_JavaLangString;
    String str3 = paramnla.jdField_j_of_type_JavaLangString;
    paramnla = paramnla.i;
    Bundle localBundle = new Bundle();
    ...
    localBundle.putString(bdlb.jdField_l_of_type_JavaLangString, paramnla);
    if (QLog.isColorLevel()) {
      QLog.d("NativeAdUtils", 2, "installApk pkg:" + str1 + ", appid:" + str2 + ", name:" + paramnla + ", url:" + str3);
    }
    return bdkx.a(localBundle);
  }
    ...
    for (;;)
    {
      ...
      if (paramBaseArticleInfo.mLocalInfo != null) {
        try
        {
          ...
          double d1 = nmh.a(paramBaseArticleInfo.mLocalInfo.jdField_e_of_type_JavaLangString, 0.0D);
          double d2 = nmh.a(str, 0.0D);
          if ((d2 != 0.0D) || (d1 != 0.0D)) {
  ...
  private static JSONObject b(Context paramContext)
  {
    ...
    for (;;)
    {
      try
      {
        localJSONObject.put("dma", oaf.c());
        localJSONObject.put("hwm", bbdh.i());
        localJSONObject.put("hwma", bbdh.h());
        localJSONObject.put("osver", bbdh.e());
        localJSONObject.put("imei", oaf.a());
        localJSONObject.put("brd", bbdh.k());
        localJSONObject.put("ns", naj.a());
        ...
        localJSONObject.put("wn", vym.c(paramContext));
        str = "";
        switch (ajnc.b())
        {
        case 1: 
          localJSONObject.put("mnc", str);
          localJSONObject.put("rma", onh.c(paramContext));
          return localJSONObject;
        }
      }
      ...
      str = ajya.a(2131707077);
      continue;
      str = ajya.a(2131707075);
      continue;
      str = ajya.a(2131707073);
    }
  }
  ...
  private static void b(int paramInt, AdvertisementInfo paramAdvertisementInfo, VideoAdInfo paramVideoAdInfo)
  {
    if (paramInt == jdField_b_of_type_Int)
    {
      ...
      yxv.a(0, 1, shq.a(paramAdvertisementInfo));
    }
    label270:
    label271:
    label379:
    do
    {
      do
      {
        ...
        if (paramInt == jdField_a_of_type_Int)
        {
          ...
          yxv.a(1, 1, shq.a(paramAdvertisementInfo));
        }
        for (;;)
        {
          if (paramInt == E)
          {
            ...
            yxv.a(2, 1, shq.a(paramAdvertisementInfo));
          }
          return;
          ...
          yxv.a(0, 1, shq.a(localAdvertisementInfo));
          break;
          if ((paramVideoAdInfo != null) && (paramVideoAdInfo.jdField_o_of_type_Int == 1))
          {
            ...
            if ((localAdvertisementInfo != null) && (localAdvertisementInfo.mC2SSwitch == 1))
            {
              ...
              yxv.a(1, 1, shq.a(localAdvertisementInfo));
            }
          }
        }
  ...
  public static void b(QQAppInterface paramQQAppInterface, AdData paramAdData)
  {
    if (oaq.a(paramAdData))
    {
      a(new nyd().a(paramQQAppInterface).a(BaseApplication.getContext()).a(jdField_l_of_type_Int).b(a(paramAdData)).a(oas.a(paramAdData)).d(a(paramAdData)).a());
      return;
    }
