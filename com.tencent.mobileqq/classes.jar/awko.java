...
public class awko
  extends akjc
{
  public awko(ActiveEntitySearchFragment paramActiveEntitySearchFragment) {}
  ...
  public void a(String paramString1, boolean paramBoolean, String paramString2, int paramInt, String paramString3, long[] paramArrayOfLong)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.a.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131699767));
        this.a.g.setOnClickListener(new awkq(this));
      ...
      this.a.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(new awkr(this));
    }
  }
            ...
            if ((paramList == null) || (paramList.isEmpty()))
            {
              ...
              if ((!bool1) && (paramString3.jdField_d_of_type_Boolean)) {
                if (this.a.jdField_a_of_type_Afdf == null)
                {
                  ...
                  paramArrayOfByte.setText(ajyc.a(2131699771));
                  ...
                  paramArrayOfByte.setText(ajyc.a(2131699769));
                  paramArrayOfByte.setBackgroundResource(2130838515);
                  paramString2.addHeaderView(paramArrayOfByte);
            ...
            for (;;)
            {
              for (;;)
              {
                ...
                try
                {
                  ...
                  this.a.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131699762));
                  if (bool1)
                  {
                    this.a.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
                    this.a.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new awkp(this, paramString2));
