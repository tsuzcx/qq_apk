...
public class zzy
{
  ...
  public zzy(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3)
  {
    this.b = paramString1;
  ...
  public View a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      catch (ClassNotFoundException localClassNotFoundException)
      {
        ...
        try
        {
          paramString = (View)localObject.getConstructor(new Class[] { Context.class }).newInstance(new Object[] { this.jdField_a_of_type_Zzt });
          return paramString;
        }
  ...
  public void a(nnw paramnnw, boolean paramBoolean)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((!nny.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getApplicationContext(), str, new zzz(this, l, localContext, paramBoolean, paramnnw))) && (QLog.isColorLevel())) {
