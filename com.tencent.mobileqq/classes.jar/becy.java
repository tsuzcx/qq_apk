...
public class becy
  extends abwa
{
  public Comparator b = new becz(this);
  
  public becy(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
  ...
  private long a(ArrayList<msg_comm.Msg> paramArrayList, ArrayList<MessageRecord> paramArrayList1, ArrayList<MessageRecord> paramArrayList2, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      if (localIterator.hasNext())
      {
        ...
        try
        {
          paramArrayList = a(paramArrayList, (ArrayList)localObject, localbbll, true, localbdyi);
          if (paramArrayList != null) {
  ...
  private void a(long paramLong1, long paramLong2, String paramString, MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      if ((i != 2) || (paramMessageRecord == null)) {
        ((anca)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(20)).c(Long.parseLong(paramString));
      }
      return;
      label145:
      ...
      for (int j = 1;; j = 0)
      {
        ...
        if (((ArrayList)localObject2).size() > 0)
        {
          ...
          if (i >= 0)
          {
            ...
            if (((((MessageRecord)localObject3).senderuin != null) && (((MessageRecord)localObject3).senderuin.equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))) || ((nmy.a((MessageRecord)localObject3)) && (nmy.b((MessageRecord)localObject3))))
            {
              if (nmy.a((MessageRecord)localObject3))
              {
                ((MessageRecord)localObject3).senderuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
                localObject4 = nmy.a((MessageRecord)localObject3);
                nmy.a().a(((MessageRecord)localObject3).frienduin, ((MessageRecord)localObject3).vipBubbleID, ((nmz)localObject4).jdField_b_of_type_Int, ((nmz)localObject4).jdField_b_of_type_JavaLangString, ((nmz)localObject4).jdField_c_of_type_Int, ((nmz)localObject4).a, ((nmz)localObject4).jdField_c_of_type_JavaLangString);
              }
          ...
          if ((!TextUtils.isEmpty((CharSequence)localObject1)) && (paramPbGetGroupMsgResp != null) && (paramPbGetGroupMsgResp.size() > 0))
          {
            ...
            {
              this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache();
              bbko.a.a = new ConcurrentHashMap();
            }
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache();
            bbko.a.a.put(localObject1, paramPbGetGroupMsgResp);
          }
          if (paramToServiceMsg.size() > 0)
          {
            ...
            paramArrayList = (abvw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getBaseMessageManager(1);
            ...
            while (i < k)
            {
              ...
              if ((paramPbGetGroupMsgResp instanceof MessageForMarketFace)) {
                avsp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForMarketFace)paramPbGetGroupMsgResp);
              }
        ...
        for (;;)
        {
          if ((j != 0) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().a((String)localObject1) == 1))
          {
            ...
            if (paramArrayList != null)
            {
              ...
              ((abvw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getBaseMessageManager(1)).b((String)localObject1, 1, l2);
            }
          }
          if (l1 >= 0L)
          {
          ...
          bool2 = amwh.b(paramToServiceMsg);
          ...
          if (paramToServiceMsg.size() > 0) {
            anll.a((MessageRecord)paramToServiceMsg.get(0), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          }
          return;
          bool1 = false;
          break;
  ...
  private void a(ToServiceMsg paramToServiceMsg, msg_svc.PbGetGroupMsgResp paramPbGetGroupMsgResp, ArrayList<msg_comm.Msg> paramArrayList, String paramString)
  {
    ...
    if (paramArrayList != null)
    {
      ...
      for (;;)
      {
        if (localIterator.hasNext())
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.d("Q.msg.TroopMessageProcessor", 2, "<---refreshTroopHead_PB : fromUin:" + l4 + ",toUin:" + l3 + ",msgTime:" + l5 + ",msgSeq:" + l1 + ",msgUid:" + l2 + ",userActive:" + i + ",fromInstid:" + j + ",groupCode:" + l6 + ",groupType:" + k + ",groupSeq:" + l7 + ",Hascard:" + ((msg_comm.GroupInfo)localObject2).group_card.has() + ",cardName:" + bftf.a((String)localObject3) + ",hasAppShare:" + paramArrayList.appshare_info.has() + ",hasMsgBody:" + paramArrayList.msg_body.has());
          }
          localObject2 = new ArrayList();
          localObject3 = new bbll();
          ((bbll)localObject3).jdField_e_of_type_Long = paramPbGetGroupMsgResp.group_code.get();
          ((bbll)localObject3).jdField_e_of_type_Int = 1;
          ((bbll)localObject3).f = k;
          if (paramArrayList.content_head.has())
          {
            msg_comm.ContentHead localContentHead = (msg_comm.ContentHead)paramArrayList.content_head.get();
            i = localContentHead.div_seq.get();
          ...
          try
          {
            paramArrayList = a(paramArrayList, (ArrayList)localObject2, (bbll)localObject3, true, localbdyi);
            if (paramArrayList != null)
            {
    ...
    ((avtd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(37)).a(paramArrayList, localbdyi);
    ...
    ((bgga)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(235)).a.a(paramString);
  }
  ...
  private void a(String paramString, MessageRecord paramMessageRecord1, MessageRecord paramMessageRecord2)
  {
    ...
    if (paramMessageRecord1.msgtype == -2011)
    {
      ...
      if ((localObject1 != null) && ((localObject1 instanceof MessageForUniteGrayTip)) && (((MessageForUniteGrayTip)localObject1).tipParam != null) && (((MessageForUniteGrayTip)localObject1).tipParam.jdField_b_of_type_Int == 3276802))
      {
        ...
        QLog.i("Q.msg.TroopMessageProcessor" + bctz.i, 1, "updateGroupMsgSeqAndTime. docs gray msg. shmsgseq = " + paramMessageRecord1.shmsgseq + ", grayMsgType = " + -5020 + ", grayUniSeq = " + ((MessageRecord)localObject1).uniseq);
      }
    }
    label356:
    label375:
    while (paramMessageRecord1.msgtype != -2000)
    {
      ...
      localObject1 = abwz.a(paramMessageRecord2, paramMessageRecord1);
      ...
      afoa.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord2.uniseq);
      if (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().b(paramMessageRecord2)) {
        break label915;
      }
      a(paramMessageRecord2);
      blbw.a().a(paramMessageRecord2.getExtInfoFromExtStr("report_key_bytes_oac_msg_extend"));
    ...
    for (;;)
    {
      ...
      break;
      break;
      if ((bcie.a(paramMessageRecord2)) || (paramMessageRecord2.msgtype == -2048))
      {
  ...
  private void a(msg_comm.Msg paramMsg, FromServiceMsg paramFromServiceMsg, msg_onlinepush.PbPushMsg paramPbPushMsg, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localObject2 = new ArrayList();
        bbll localbbll = new bbll();
        localbbll.jdField_e_of_type_Long = l8;
        localbbll.jdField_e_of_type_Int = 1;
        localbbll.f = n;
        Object localObject4;
        if (QLog.isColorLevel())
        ...
        label473:
        paramPbPushMsg = (avtd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(37);
        if (!MessageHandler.b)
        {
          if (paramBoolean) {
            break label608;
        ...
        paramFromServiceMsg = new bdyi();
        try
        {
          a(paramMsg, (ArrayList)localObject1, localbbll, true, paramFromServiceMsg);
          ...
          if ((localObject2 != null) && (((ArrayList)localObject2).size() > 0))
          {
            ...
            if (i < j)
            {
              ...
              if ((localObject3 instanceof MessageForMarketFace)) {
                avsp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForMarketFace)localObject3);
              }
              if (QLog.isColorLevel())
              {
              ...
              if (((((MessageRecord)localObject3).senderuin != null) && (((MessageRecord)localObject3).senderuin.equalsIgnoreCase(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))) || ((nmy.a((MessageRecord)localObject3)) && (nmy.b((MessageRecord)localObject3))))
              {
                if (nmy.a((MessageRecord)localObject3))
                {
                  ((MessageRecord)localObject3).senderuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
                  localObject4 = nmy.a((MessageRecord)localObject3);
                  nmy.a().a(String.valueOf(localbbll.jdField_e_of_type_Long), ((MessageRecord)localObject3).vipBubbleID, ((nmz)localObject4).jdField_b_of_type_Int, ((nmz)localObject4).jdField_b_of_type_JavaLangString, ((nmz)localObject4).jdField_c_of_type_Int, ((nmz)localObject4).a, ((nmz)localObject4).jdField_c_of_type_JavaLangString);
                }
              ...
              for (;;)
              {
                ...
                if ((localObject3 instanceof MessageForTroopFile)) {
                  ((bcws)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(272)).a((ChatMessage)localObject3);
                }
              }
            }
          }
          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().b(paramMsg);
          bool1 = amwh.a(paramMsg);
          bool2 = amwh.b(paramMsg);
          i = abwz.a(paramMsg, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      ...
      for (paramBoolean = true;; paramBoolean = false)
      {
        ...
        if ((localObject1 != null) && (((ArrayList)localObject1).size() > 0))
        {
          ...
          ((bfdm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(203)).c(paramFromServiceMsg);
        }
        if (n == 127) {
          break;
        }
        ...
        ((bgga)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(235)).a.a((List)localObject2);
        l1 = System.currentTimeMillis() - l1;
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.TroopMessageProcessor", 2, "decodecMsg costTime = [" + l1 + "]");
        }
        anll.a("actGroupDecodeCost", l1);
        if (((ArrayList)localObject2).size() <= 0) {
          break;
        }
        anll.a((MessageRecord)((ArrayList)localObject2).get(0), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        return;
      }
      label1700:
      i = 0;
  ...
  public void a(GroupMsgReadedNotify paramGroupMsgReadedNotify)
  {
    ...
    paramGroupMsgReadedNotify = (bfas)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(132);
