...
public class bgda
{
  ...
  public bgda(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_MqqObserverBusinessObserver = new bgdb(this);
  ...
  public void a(long paramLong, int paramInt, JSONObject paramJSONObject)
  {
    ...
    NewIntent localNewIntent = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), bgcz.class);
