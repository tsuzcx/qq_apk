...
public class oev
{
  ...
  public boolean a(Context paramContext, MessageRecord paramMessageRecord, TextView paramTextView, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        boolean bool = bhsr.a(paramString);
        if (bool) {
          return false;
        }
        try
        {
          ...
          {
            paramTextView.setBackgroundResource(2130847107);
            paramTextView.setVisibility(0);
            paramTextView.setText(anzj.a(2131702510));
            localObject1 = paramContext.getResources().getDrawable(2130847110);
            ((Drawable)localObject1).setBounds(0, 0, 24, 16);
            paramTextView.setCompoundDrawables(null, null, (Drawable)localObject1, null);
            i = zps.a(paramContext, 6.0F);
            paramTextView.setPadding(i, 0, i, 0);
            paramTextView.setCompoundDrawablePadding(zps.a(paramContext, 2.0F));
            ...
            localObject1 = LayoutInflater.from(paramContext).inflate(2131559582, null);
            LinearLayout localLinearLayout = (LinearLayout)((View)localObject1).findViewById(2131370152);
            ...
            if (i < paramString.length())
            {
              ...
              ((LinearLayout)localObject3).setOnClickListener(new oew(this, j, (JSONObject)localObject2, paramContext, paramMessageRecord));
              ...
              ((LinearLayout.LayoutParams)localObject4).height = zps.a(paramContext, 50.0F);
              ...
              ((LinearLayout.LayoutParams)localObject5).width = zps.a(paramContext, 20.0F);
              ((LinearLayout.LayoutParams)localObject5).height = zps.a(paramContext, 18.0F);
              ((LinearLayout.LayoutParams)localObject5).leftMargin = zps.a(paramContext, 15.0F);
              localObject5 = ((JSONObject)localObject2).optString("icon_url", "");
              if (!bhsr.a((String)localObject5))
              {
                URLDrawable.URLDrawableOptions localURLDrawableOptions = URLDrawable.URLDrawableOptions.obtain();
                localURLDrawableOptions.mRequestHeight = zps.a(paramContext, 20.0F);
                localURLDrawableOptions.mRequestWidth = zps.a(paramContext, 18.0F);
              ...
              ((LinearLayout.LayoutParams)localObject3).leftMargin = zps.a(paramContext, 10.0F);
              ...
              ((LinearLayout.LayoutParams)localObject3).height = zps.a(paramContext, 1.0F);
        ...
        catch (JSONException paramString)
        {
          ...
          paramTextView.setOnClickListener(new oex(this, paramContext, paramTextView, paramMessageRecord));
          return true;
        }
        return false;
      }
