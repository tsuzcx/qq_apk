  ...
  extends bflp
{
  ...
  public bflo(TraeAudioManager paramTraeAudioManager)
  {
  ...
  public boolean a(Context paramContext, bflq parambflq)
  {
    ...
    if ((this.jdField_a_of_type_AndroidContentContext == null) || (this.jdField_a_of_type_Bflq == null)) {}
    for (;;)
    {
      return false;
      try
      ...
      catch (Exception parambflq)
      {
        ...
        catch (Exception parambflq)
        {
          ...
          catch (NoSuchMethodException parambflq)
          {
            try
            {
              do
              {
                for (;;)
                {
                  ...
                  this.jdField_a_of_type_Bflq.a("DEVICE_BLUETOOTHHEADSET", a());
                  if (!a()) {
                    break label337;
                  }
                  this.jdField_a_of_type_Bflq.a("DEVICE_BLUETOOTHHEADSET", true);
                  ...
                  if (QLog.isColorLevel())
                  {
                    ...
                    parambflq = parambflq;
                    if (QLog.isColorLevel()) {
                      QLog.e("TraeAudioManager", 2, "BTLooperThread BluetoothHeadset.ServiceListener class not found:" + parambflq);
                    }
                  }
                }
                parambflq = parambflq;
