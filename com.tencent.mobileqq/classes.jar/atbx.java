...
public class atbx
  extends aqyj
{
  public atbx(HeartLayout paramHeartLayout)
  {
  ...
  public Path a(int paramInt1, int paramInt2, AtomicInteger paramAtomicInteger, View paramView)
  {
    ...
    if (!this.jdField_a_of_type_Aqyl.jdField_a_of_type_Boolean) {
      ...
      {
        this.jdField_a_of_type_Aqyl.jdField_a_of_type_Int = ((paramView.getWidth() - (int)(20.0F * this.jdField_a_of_type_Aqyl.jdField_a_of_type_Float)) / 2);
        if ((paramInt2 >= 0) && (paramInt2 <= paramView.getHeight())) {
          break label415;
        }
        this.jdField_a_of_type_Aqyl.b = ((int)(20.0F * this.jdField_a_of_type_Aqyl.jdField_a_of_type_Float));
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        return localPath;
        this.jdField_a_of_type_Aqyl.jdField_a_of_type_Int = (paramInt1 - (int)(20.0F * this.jdField_a_of_type_Aqyl.jdField_a_of_type_Float / 3.0F));
        break;
        label415:
        this.jdField_a_of_type_Aqyl.b = (paramView.getHeight() - paramInt2 + (int)(20.0F * this.jdField_a_of_type_Aqyl.jdField_a_of_type_Float / 3.0F));
        break label95;
        label447:
        paramInt1 = -1;
        break label107;
