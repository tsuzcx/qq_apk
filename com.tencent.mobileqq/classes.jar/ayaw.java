...
public class ayaw
{
  ...
  public ayaw(int paramInt)
  {
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList(2);
    this.jdField_a_of_type_Int = paramInt;
  }
  
  public static ayaw a(appoint_define.InterestTag paramInterestTag)
  {
    ayaw localayaw = null;
    if (paramInterestTag != null)
    {
      localayaw = new ayaw(paramInterestTag.uint32_tag_type.get());
  ...
  public static ayaw a(JSONObject paramJSONObject)
  {
    int j = 0;
    ...
    for (;;)
    {
      ...
      if (i < paramJSONObject.length())
      {
        ...
        if (localObject != null)
        {
          ...
          if (localObject != null)
          {
            localayaw.jdField_a_of_type_JavaUtilArrayList.add(localObject);
            break label140;
            label114:
            localObject = null;
          }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (!bhjx.a(this.jdField_a_of_type_JavaUtilArrayList.get(i), paramObject.jdField_a_of_type_JavaUtilArrayList.get(i))) {
        break;
      }
      i += 1;
    }
