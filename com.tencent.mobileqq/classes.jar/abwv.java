...
public class abwv
{
  ...
  {
    paramInt2 = abwz.a(paramInt2, paramInt3);
    paramQQAppInterface.getMessageProxy(paramInt1).a(paramString1, paramInt1, paramString2, paramString3, paramInt2);
    paramString3 = paramQQMessageFacade.getLastMessage(paramString1, paramInt1);
    ...
    do
    {
      ...
      paramQQAppInterface = (RecentUser)paramQQAppInterface.getProxyManager().a().findRecentUserByUin(paramString1, paramInt1);
    } while (paramQQAppInterface == null);
    paramQQMessageFacade.removeRecentUser(paramQQAppInterface);
  }
    ...
    do
    {
      do
      {
        ...
        for (;;)
        {
          ...
          break label34;
          QQMessageFacade.Message localMessage = paramQQMessageFacade.getLastMessage(paramString1, paramInt);
          ...
          if ((paramString2 != null) && (!paramString2.isEmpty()))
          {
            ...
            paramString3 = bbli.a(paramString2.msgtype);
            ...
            if (!abwz.h(paramString2.msgtype)) {
          ...
          try
          {
            ...
            paramString2 = paramQQMessageFacade.getLastMessage(str, paramInt);
      ...
      paramQQAppInterface = (RecentUser)paramQQAppInterface.getProxyManager().a().findRecentUserByUin(str, paramInt);
    } while (paramQQAppInterface == null);
    paramQQMessageFacade.removeRecentUser(paramQQAppInterface);
  }
}
