...
public class ahni
  extends alwx
{
  public ahni(SystemMsgListView paramSystemMsgListView) {}
  
  protected void a(String paramString)
  {
    if (this.a.jdField_a_of_type_Ahlc.a())
    {
      paramString = SystemMsgListView.a(this.a).getResources().getString(2131720551);
    ...
    for (;;)
    {
      ...
      if (!paramBoolean)
      {
        ...
        for (;;)
        {
          ...
          return;
          paramString3 = SystemMsgListView.a(this.a).getResources().getString(2131719755);
        }
      }
      paramString1 = SystemMsgListView.a(this.a).getResources().getString(2131692866);
      ...
      try
      {
        this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(alof.M, 0, l2, localStructMsg.toByteArray());
        ...
        if (avui.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(localStructMsg.req_uin.get()), localStructMsg, false))
        {
        ...
        AutoRemarkActivity.a(this.a.jdField_a_of_type_Ahlc.getActivity(), 0, String.valueOf(localStructMsg.req_uin.get()), l1, paramString3);
        return;
      }
      catch (Exception paramString1)
      {
