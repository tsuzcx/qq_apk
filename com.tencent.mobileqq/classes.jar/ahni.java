  ...
  implements ahng
{
  ...
  private ahnl jdField_a_of_type_Ahnl;
  private ahnm jdField_a_of_type_Ahnm;
  private Bitmap jdField_a_of_type_AndroidGraphicsBitmap;
  private Canvas jdField_a_of_type_AndroidGraphicsCanvas;
  private Paint jdField_a_of_type_AndroidGraphicsPaint = new Paint();
  private Rect jdField_a_of_type_AndroidGraphicsRect;
  private GestureDetector.OnGestureListener jdField_a_of_type_AndroidViewGestureDetector$OnGestureListener = new ahnj(this);
  ...
  public ahni(ahnh paramahnh, String paramString, int paramInt1, int paramInt2, float paramFloat1, float paramFloat2, int paramInt3, float paramFloat3, int paramInt4)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetScroller = new Scroller(this.jdField_a_of_type_Ahnh.getContext());
    this.jdField_a_of_type_AndroidViewGestureDetector = new GestureDetector(this.jdField_a_of_type_Ahnh.getContext(), this.jdField_a_of_type_AndroidViewGestureDetector$OnGestureListener);
    this.jdField_a_of_type_Ahnf = new ahnf(this);
    ...
    for (this.jdField_a_of_type_Ahnm = new VideoFramesRetriever(paramString, paramFloat1);; this.jdField_a_of_type_Ahnm = new VideoFramesFetcher())
    {
      this.jdField_a_of_type_Ahnm.a(paramInt4, paramInt1, this.jdField_a_of_type_Ahnf);
      this.jdField_a_of_type_Ahnm.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      return;
    }
  }
  ...
  private void c()
  {
    if ((this.jdField_a_of_type_Ahnf == null) || (this.jdField_a_of_type_Ahnf.a())) {}
    int j;
    do
    {
      return;
  ...
  private void d()
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetScroller.computeScrollOffset())
    {
      ...
      c();
      if (this.jdField_a_of_type_Ahnh != null) {
    ...
    label157:
    while (this.jdField_a_of_type_Ahnl == null)
    {
      return;
      this.jdField_a_of_type_Ahnm.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      break;
    }
    this.jdField_a_of_type_Ahnl.a(this.jdField_d_of_type_Float, -this.jdField_d_of_type_Float, this.f - this.jdField_d_of_type_Float);
  }
  
  public void a()
  {
    this.jdField_a_of_type_Ahnh.postInvalidate();
  }
  ...
  public void a(ahnl paramahnl)
  {
    this.jdField_a_of_type_Ahnl = paramahnl;
  ...
  {
    if (this.jdField_a_of_type_Ahnf == null) {
      return;
    }
    d();
    ...
    while (j < m)
    {
      ahnk localahnk = this.jdField_a_of_type_Ahnf.a(j);
      if (localahnk != null)
      {
        ...
        this.jdField_a_of_type_AndroidGraphicsCanvas.drawBitmap(localahnk.jdField_a_of_type_AndroidGraphicsBitmap, this.jdField_c_of_type_AndroidGraphicsRect, this.jdField_c_of_type_AndroidGraphicsRect, this.jdField_a_of_type_AndroidGraphicsPaint);
      }
  ...
  public void b()
  {
    this.jdField_a_of_type_Ahnl = null;
    if (this.jdField_a_of_type_Ahnm != null) {
      this.jdField_a_of_type_Ahnm.a();
    }
    if (this.jdField_a_of_type_Ahnf != null) {
      this.jdField_a_of_type_Ahnf.a();
    }
    this.jdField_a_of_type_Ahnf = null;
  }
