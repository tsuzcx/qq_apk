...
public class mpx
{
  ...
  public static void a(VideoAppInterface paramVideoAppInterface, BaseToolbar paramBaseToolbar)
  {
    ...
    for (int j = paramBaseToolbar.jdField_a_of_type_Int;; j = -1)
    {
      ...
      for (;;)
      {
        ...
        axqw.b(null, "dc00898", "", "", "0X8008977", "0X8008977", n, 0, String.valueOf(i), String.valueOf(j), jdField_a_of_type_JavaLangString, "");
        return;
        label243:
        i = 0;
      }
  ...
  public static void a(String paramString1, String paramString2)
  {
    ...
    axqw.b(null, "dc00898", "", "", paramString1, paramString1, jdField_a_of_type_Int, 0, "", "", jdField_a_of_type_JavaLangString, paramString2);
  }
  
  public static void a(mpz parammpz)
  {
    if (QLog.isDevelopLevel()) {
      QLog.w("RedBagReport", 1, "reportClickEvent, key[" + "0X800897F" + "], fromType[" + jdField_a_of_type_Int + "], mSucAboutGame[" + parammpz.jdField_a_of_type_Boolean + "], mExceptionType[" + parammpz.jdField_f_of_type_Int + "], mRoomId[" + jdField_a_of_type_JavaLangString + "]");
    }
    int i = jdField_a_of_type_Int;
    int j = parammpz.jdField_f_of_type_Int;
    if (parammpz.jdField_a_of_type_Boolean) {}
    for (parammpz = "1";; parammpz = "0")
    {
      axqw.b(null, "dc00898", "", "", "0X800897F", "0X800897F", i, 0, String.valueOf(j), parammpz, jdField_a_of_type_JavaLangString, "");
      return;
    }
  }
  ...
  public static void a(boolean paramBoolean, int paramInt)
  {
    ...
    for (;;)
    {
      axqw.b(null, "dc00898", "", "", "0X8008978", "0X8008978", j, i, String.valueOf(paramInt), "", jdField_a_of_type_JavaLangString, String.valueOf(j));
      return;
      i = 0;
    }
  }
  ...
  public static void b(mpz parammpz)
  {
    ...
    {
      if (QLog.isDevelopLevel()) {
        QLog.w("RedBagReport", 1, "reportClickEvent, key[" + str1 + "], fromType[" + jdField_a_of_type_Int + "], getRedbag_ResultCode[" + parammpz.jdField_e_of_type_JavaLangString + "], getRedbag_ResultState[" + parammpz.jdField_f_of_type_JavaLangString + "], mRoomId[" + jdField_a_of_type_JavaLangString + "], hitScore[" + parammpz.jdField_a_of_type_Int + "]");
      }
      axqw.b(null, "dc00898", "", "", str1, str1, jdField_a_of_type_Int, parammpz.jdField_a_of_type_Int, String.valueOf(parammpz.jdField_f_of_type_Int), parammpz.jdField_e_of_type_JavaLangString, jdField_a_of_type_JavaLangString, parammpz.jdField_f_of_type_JavaLangString);
      return;
      str1 = "0X800897E";
      continue;
      str1 = "0X8008983";
  ...
  public static void b(boolean paramBoolean, int paramInt)
  {
    ...
    axqw.b(null, "dc00898", "", "", str, str, jdField_a_of_type_Int, 0, String.valueOf(paramInt), "", jdField_a_of_type_JavaLangString, null);
  }
