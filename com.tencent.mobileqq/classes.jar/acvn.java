  ...
  extends acve
{
  ...
  {
    MessageForShortVideo localMessageForShortVideo = (MessageForShortVideo)bcsa.a(-2022);
    ...
    for (localMessageForShortVideo.msg = ShortVideoConstants.MESSAGE_FOR_SHORT_VIDEO_PTV;; localMessageForShortVideo.msg = ShortVideoConstants.MESSAGEFORSHORTVIDEO_MSG)
    {
      ...
      try
      {
        ...
        ((anqn)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getBusinessHandler(BusinessHandlerFactory.BABY_Q_HANDLER)).a(arrayOfByte);
      }
      ...
      if (localMessageForShortVideo.redBagType == LocalMediaInfo.REDBAG_TYPE_GET)
      {
        ...
        bdcw.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), false);
