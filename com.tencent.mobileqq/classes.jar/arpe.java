...
public abstract class arpe<T extends CustomEmotionBase>
  implements Manager
{
  ...
  public abstract arxg a(T paramT);
  ...
  public void a(arpf paramarpf)
  {
    ...
    ThreadManager.post(new CustomEmotionRoamingDBManagerBase.3(this, paramarpf), 5, null, true);
  }
