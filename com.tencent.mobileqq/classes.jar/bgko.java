  ...
  implements Manager
{
  ...
  public bgko(AppInterface paramAppInterface)
  {
  ...
  private void a(String paramString1, int paramInt1, int paramInt2, int paramInt3, String paramString2, int paramInt4, int paramInt5, oidb_0x6b6.SendFlowerReq paramSendFlowerReq, oidb_0x6b6.ThrowFlowerReq paramThrowFlowerReq, long paramLong, bgkn parambgkn)
  {
    if (parambgkn == null)
    {
      if (QLog.isColorLevel()) {
        QLog.e(".troop.send_gift", 2, "send_oidb_0x6b6. callback=" + parambgkn);
      }
      label37:
      return;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        default: 
          ...
          if (nty.a().a(paramString2))
          {
            paramThrowFlowerReq = new oidb_0x6b6.AnonymousGroupMsg();
            paramString2 = nty.a().a(paramString2);
          ...
          if ((paramInt3 >= 4) && (System.currentTimeMillis() - axti.jdField_a_of_type_Long < 600000L))
          {
            paramString2 = new oidb_0x6b6.GPSInfo();
            paramString2.int32_gps_type.set(1, true);
            paramString2.int64_longitude.set(axti.jdField_a_of_type_ArrayOfLong[0], true);
            paramString2.int64_latitude.set(axti.jdField_a_of_type_ArrayOfLong[1], true);
          ...
          ntb.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bgkp(this, parambgkn), localReqBody.toByteArray(), paramString1 + "_" + paramInt2, paramInt1, paramInt2, paramString2, paramLong);
          return;
          if (paramInt2 != 11) {
            continue;
          }
  ...
  private void a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, int paramInt4, oidb_0x6c3.GetStockReq paramGetStockReq, oidb_0x6c3.GetExtraDataReq paramGetExtraDataReq, long paramLong, bgkn parambgkn)
  {
    if (parambgkn == null)
    {
      if (QLog.isColorLevel()) {
        QLog.e(".troop.send_gift", 2, "send_oidb_0x6c3. troopUin is null. callback=" + parambgkn);
      }
      return;
    }
    ...
    for (paramGetStockReq = paramGetStockReq.getSkey(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin());; paramGetStockReq = "")
    {
      ...
      ntb.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bgkr(this, parambgkn), localReqBody.toByteArray(), paramString1 + "_" + paramInt4, paramInt1, paramInt4, paramGetStockReq, paramLong);
      return;
    }
  }
  
  private void a(String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, long paramLong, bgkn parambgkn)
  {
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)) || (parambgkn == null))
    {
      if (QLog.isColorLevel()) {
        QLog.e(".troop.send_gift", 2, "send_oidb_0x6c2. troopUin=" + paramString1 + " giftBagID=" + paramString2 + " callback=" + parambgkn);
      }
      return;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        default: 
          ...
          ntb.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bgkt(this, parambgkn, paramString1, paramString2), localReqBody.toByteArray(), "OidbSvc.0x6c2_" + paramInt3, 1730, paramInt3, (Bundle)localObject, paramLong);
          return;
        }
      }
  ...
  private void a(String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, bgkn parambgkn)
  {
    if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      ntb.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bgku(this, parambgkn), paramString1.toByteArray(), "OidbSvc.0x962_" + paramInt3, 2402, 1, paramString2, 500L);
      return;
    }
  ...
  private void b(bgkn parambgkn)
  {
    ...
    ntb.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bgkq(this, parambgkn), localReqBody.toByteArray(), "OidbSvc.0xcd1_0", 3281, 0, null, 0L);
  }
  
  private void b(String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3, long paramLong, bgkn parambgkn)
  {
    if ((TextUtils.isEmpty(paramString2)) || (TextUtils.isEmpty(paramString3)) || (parambgkn == null))
    {
      if (QLog.isColorLevel()) {
        QLog.e(".troop.send_gift", 2, "send_oidb_0x6b5. troopUin=" + paramString2 + " giftBagID=" + paramString3 + " callback=" + parambgkn);
      }
      return;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        paramInt2 = 1;
        ntb.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bgks(this, parambgkn, paramString2, paramString3), localReqBody.toByteArray(), paramString1 + "_" + paramInt2, paramInt1, paramInt2, (Bundle)localObject, paramLong);
        return;
      }
      catch (NumberFormatException paramString1) {}
      if (!QLog.isColorLevel()) {
  ...
  public TroopGiftBagInfo a(String paramString1, String paramString2, bgkn parambgkn)
  {
    ...
    a(paramString1, paramString2, 0, 0, 1000L, parambgkn);
    return null;
  }
  ...
  public void a(int paramInt, bgkn parambgkn)
  {
    if (!(this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof QQAppInterface)) {
      return;
    }
    ...
    ntb.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bgkw(this, parambgkn), localReqBody.toByteArray(), "OidbSvc.0x9e9_0", 2537, 0);
  }
  
  public void a(aaik paramaaik, int paramInt, String paramString, long paramLong, bgkn parambgkn)
  {
    if ((paramaaik == null) || (parambgkn == null)) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      localReqBody.product_id.set(paramaaik.jdField_a_of_type_Int, true);
      localReqBody.amount.set(paramaaik.f, true);
      ...
      try
      {
        ...
        ntb.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bgkv(this, parambgkn, paramaaik), localReqBody.toByteArray(), "OidbSvc.0xdad_" + paramInt, 3501, paramInt, paramString, 0L);
        return;
      }
      catch (NumberFormatException paramaaik) {}
    } while (!QLog.isColorLevel());
    QLog.e(".troop.send_gift", 2, "send_oidb_0x6b6. NumberFormatException troopUin=" + paramString);
  }
  
  public void a(bgkn parambgkn)
  {
    if (QLog.isColorLevel()) {
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, int paramInt3, String paramString2, int paramInt4, int paramInt5, int paramInt6, int paramInt7, bgkn parambgkn)
  {
    if (QLog.isColorLevel()) {
    ...
    a(paramString1, paramInt1, paramInt2, paramInt3, paramString2, paramInt4, 0, null, localThrowFlowerReq, 0L, parambgkn);
  }
  
  public void a(String paramString1, int paramInt1, int paramInt2, int paramInt3, String paramString2, int paramInt4, int paramInt5, long paramLong, int paramInt6, int paramInt7, int paramInt8, int paramInt9, bgkn parambgkn, int paramInt10)
  {
    if (QLog.isColorLevel()) {
    ...
    a(paramString1, paramInt1, paramInt2, paramInt3, paramString2, paramInt4, paramInt9, localSendFlowerReq, null, 0L, parambgkn);
  }
  
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, int paramInt4, int paramInt5, bgkn parambgkn)
  {
    if (QLog.isColorLevel()) {
    ...
    a(paramString1, paramInt1, paramInt2, paramString2, paramInt3, paramInt4, null, localGetExtraDataReq, 0L, parambgkn);
  }
  
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, int paramInt4, bgkn parambgkn)
  {
    a(paramString1, paramInt1, paramInt2, paramString2, paramInt3, paramInt4, false, false, parambgkn);
  }
  
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, int paramInt4, boolean paramBoolean1, boolean paramBoolean2, bgkn parambgkn)
  {
    if (QLog.isColorLevel()) {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      a(paramString1, paramInt1, paramInt2, paramString2, paramInt3, paramInt4, localGetStockReq, null, 0L, parambgkn);
      return;
    }
  }
  
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3, long paramLong, bgkn parambgkn)
  {
    if (QLog.isColorLevel()) {
      QLog.e(".troop.send_gift .troop.send_gift", 2, "grabGift. troopUin:" + paramString2 + " bagID:" + paramString3);
    }
    b(paramString1, paramInt1, paramInt2, paramString2, paramString3, paramLong, parambgkn);
  }
  
  public void a(String paramString, bgkn parambgkn)
  {
    try
    {
      ...
      ntb.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bgkx(this, parambgkn), paramString.toByteArray(), "OidbSvc.0xa48_1", 2632, 1, new Bundle(), 6000L);
      return;
    }
    catch (Exception paramString)
    {
      parambgkn.a(-1, "troop uin error");
    }
  }
  
  public void a(String paramString1, String paramString2, int paramInt1, int paramInt2, long paramLong, bgkn parambgkn)
  {
    if (QLog.isColorLevel()) {
    ...
    a(paramString1, paramString2, paramInt1, paramInt2, 0, paramLong, parambgkn);
  }
  
  public void a(String paramString1, String paramString2, int paramInt1, int paramInt2, bgkn parambgkn)
  {
    if (QLog.isColorLevel()) {
      QLog.d(".troop.send_gift .troop.send_gift", 2, "reportInteract. troopUin:" + paramString1 + " giftID:" + paramString2);
    }
    a(paramString1, paramString2, paramInt2, paramInt1, 3, parambgkn);
  }
  
  public void a(String paramString1, String paramString2, int paramInt, bgkn parambgkn)
  {
    if (QLog.isColorLevel()) {
      QLog.d(".troop.send_gift .troop.send_gift", 2, "chechInteract. troopUin:" + paramString1 + " giftID:" + paramString2);
    }
    a(paramString1, paramString2, 0, paramInt, 1, parambgkn);
  }
  ...
  public void b(String paramString1, String paramString2, int paramInt, bgkn parambgkn)
  {
    if (QLog.isColorLevel()) {
      QLog.d(".troop.send_gift .troop.send_gift", 2, "startInteract. troopUin:" + paramString1 + " giftID:" + paramString2);
    }
    a(paramString1, paramString2, 0, paramInt, 2, parambgkn);
  }
