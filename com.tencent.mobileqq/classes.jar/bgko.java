...
public class bgko
{
  ...
  public static bgko a(araj[] paramArrayOfaraj)
  {
    boolean bool2 = true;
    ...
    int i1 = 0;
    int n = 0;
    if (i4 < paramArrayOfaraj.length)
    {
      Object localObject = paramArrayOfaraj[i4].a;
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      paramArrayOfaraj.jdField_a_of_type_JavaUtilArrayList = localArrayList1;
      paramArrayOfaraj.jdField_a_of_type_Int = i3;
      paramArrayOfaraj.jdField_b_of_type_Int = i2;
      paramArrayOfaraj.jdField_b_of_type_JavaUtilArrayList = localArrayList2;
      if (QLog.isColorLevel()) {
        QLog.d("TroopShortcutBarConfig", 2, "parse:" + paramArrayOfaraj.toString());
      }
