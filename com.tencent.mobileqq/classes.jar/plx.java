  ...
  extends pwd
{
  ...
  static
  {
    jdField_a_of_type_Ply = new ply(null);
  }
  
  public plx(@Nullable AppInterface paramAppInterface, @Nullable EntityManager paramEntityManager, @Nullable ExecutorService paramExecutorService, @Nullable qli paramqli, @Nullable Handler paramHandler)
  {
  ...
  private final void a(BaseArticleInfo paramBaseArticleInfo, ArrayList<BaseArticleInfo> paramArrayList)
  {
    ...
    while (localIterator.hasNext())
    {
      if (TextUtils.equals((CharSequence)((BaseArticleInfo)localIterator.next()).innerUniqueID, (CharSequence)paramBaseArticleInfo.innerUniqueID))
      {
        ...
        QLog.i("RIJFeedsInsertModule", 1, "[addOrReplaceArticleInfoInList] replace old articleInfo, articleInfo = " + pma.a.a(paramBaseArticleInfo) + ", index = " + i);
        return;
      }
      i += 1;
    }
    paramArrayList.add(0, paramBaseArticleInfo);
    QLog.i("RIJFeedsInsertModule", 1, "[addOrReplaceArticleInfoInList] add new articleInfo, articleInfo = " + pma.a.a(paramBaseArticleInfo));
  }
  
  private final void a(ToServiceMsg paramToServiceMsg, plz paramplz)
  {
    ...
    ((Map)localObject).put("key_channel_id", Long.valueOf(paramplz.a()));
    localObject = paramToServiceMsg.getAttributes();
    Intrinsics.checkExpressionValueIsNotNull(localObject, "request.attributes");
    Map localMap = (Map)localObject;
    localObject = paramplz.a();
    if (localObject != null)
    {
    ...
    for (;;)
    {
      ...
      ((Map)paramToServiceMsg).put("key_subscribe_id", paramplz.a());
      return;
      localObject = "";
    }
  }
  ...
  private final void a(ArrayList<BaseArticleInfo> paramArrayList)
  {
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      QLog.i("RIJFeedsInsertModule", 1, localpma.a((BaseArticleInfo)localObject2));
    }
  }
      ...
      for (paramObject = localObject;; paramObject = localObject)
      {
        ...
        if (paramFromServiceMsg != null)
        {
          ...
          for (;;)
          {
            ...
            {
              localObject = qlh.a((articlesummary.ArticleSummary)paramFromServiceMsg.next(), (int)l, 0, null);
  ...
  public final void a(long paramLong, @NotNull BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    if (localObject != null)
    {
      ...
      QLog.i("RIJFeedsInsertModule", 1, "[deleteFeedsInsertInfo] articleInfo = " + pma.a.a(paramBaseArticleInfo));
    }
  }
  ...
  public final void a(@NotNull plz paramplz)
  {
    Intrinsics.checkParameterIsNotNull(paramplz, "reqParams");
    if (!pma.a.a((int)paramplz.a())) {
      QLog.i("RIJFeedsInsertModule", 1, "[requestFeedsInsertInfo] do not request, channelId = " + paramplz.a());
    }
    while (!pma.a.a()) {
      return;
    }
    ...
    localReqRecommendPara.uint64_channel_id.set(paramplz.a());
    PBBytesField localPBBytesField = localReqRecommendPara.bytes_req_rowkey;
    Object localObject = paramplz.a();
    if (localObject != null)
    {
      localObject = ((BaseArticleInfo)localObject).innerUniqueID;
      if (localObject == null) {}
    ...
    for (;;)
    {
      ...
      localReqRecommendPara.bytes_subscribe_id.set(ByteStringMicro.copyFromUtf8(paramplz.a()));
      localReqRecommendPara.uint32_update_times.set(paramplz.a());
      localReqRecommendPara.uint32_req_recommend_flag.set(paramplz.b());
      localObject = new oidb_cmd0xebb.ReqBody();
      ((oidb_cmd0xebb.ReqBody)localObject).uint32_network_type.set(ptv.b());
      ...
      localObject = qlk.a("OidbSvc.0xebb", 3771, 0, ((oidb_cmd0xebb.ReqBody)localObject).toByteArray());
      Intrinsics.checkExpressionValueIsNotNull(localObject, "ReadInJoyOidbHelper.make…T, reqBody.toByteArray())");
      a((ToServiceMsg)localObject, paramplz);
      a((ToServiceMsg)localObject);
      long l = System.currentTimeMillis();
      ((Map)this.b).put(paramplz.a(), Long.valueOf(l));
      QLog.i("RIJFeedsInsertModule", 1, "[requestFeedsInsertInfo], reqParams = " + paramplz + ", timeStamp = " + l);
      return;
      localObject = "";
    }
  }
