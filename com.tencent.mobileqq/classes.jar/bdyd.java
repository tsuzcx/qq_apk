public abstract class bdyd
{
  ...
  public bdyd(int paramInt1, int paramInt2, int paramInt3)
  {
  ...
  {
    if ((paramInt >= this.jdField_c_of_type_Int) && (this.jdField_a_of_type_Bdye != null)) {
      this.jdField_a_of_type_Bdye.a();
    }
  }
