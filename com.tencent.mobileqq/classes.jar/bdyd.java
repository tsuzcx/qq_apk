  ...
  implements DialogInterface.OnDismissListener
{
  ...
  private static bdyh jdField_a_of_type_Bdyh;
  ...
  private BusinessObserver jdField_a_of_type_MqqObserverBusinessObserver = new bdyf(this);
  ...
  private void a(String paramString)
  {
    Object localObject1;
    Object localObject2;
    if (jdField_a_of_type_Bdyh == null)
    {
      localObject1 = new bdyh(null);
      ...
      jdField_a_of_type_Bdyh = (bdyh)localObject1;
    ...
    try
    {
      ...
      try
      {
        ...
        return;
        label180:
        bdyg localbdyg = new bdyg(this);
        ((SensorManager)localObject1).registerListener(localbdyg, (Sensor)localObject2, 3, 0);
        ((SensorManager)localObject1).flush(localbdyg);
        localObject1 = new NewIntent(this.mRuntime.a().getApplication(), bdyx.class);
    ...
    do
    {
      do
      {
        ...
        if ((l1 > 0L) && (((JSONObject)localObject1).toString().getBytes().length > l1))
        {
          ...
          paramString2.put("businessRet", 0);
          paramString2.put("msg", alud.a(2131705839));
          super.callJs(paramString1, new String[] { paramString2.toString() });
          return;
        }
        if (this.jdField_c_of_type_JavaUtilHashMap.containsKey("yundong_report.steps"))
        {
          ...
          if ((l1 > 0L) && (System.currentTimeMillis() - l2 < l1))
          {
            ...
            paramString2.put("businessRet", 0);
            paramString2.put("msg", alud.a(2131705838));
            super.callJs(paramString1, new String[] { paramString2.toString() });
        ...
        localObject2 = String.valueOf(bdyp.a());
      ...
      ((JSONObject)localObject1).put("version", "8.3.5");
      ...
      if (TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
        this.jdField_b_of_type_JavaLangString = bfmw.c();
      }
      ((JSONObject)localObject1).put("imei", String.valueOf(this.jdField_b_of_type_JavaLangString));
      ((JSONObject)localObject1).put("adcode", ampk.b());
      if (QLog.isColorLevel()) {
      ...
      localObject1 = new bdye(this);
    } while (this.mRuntime == null);
    Object localObject2 = new NewIntent(this.mRuntime.a().getApplicationContext(), atkg.class);
  ...
  private JSONObject b(String paramString)
  {
    ...
    //   12: lstore_3
    //   13: aload_0
    //   14: getfield 109	bdyd:mRuntime	Lbegz;
    //   17: ifnull +1113 -> 1130
    //   20: aload_0
    //   21: getfield 282	bdyd:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   24: ifnull +1106 -> 1130
    //   27: iconst_0
    //   28: istore 5
    ...
    //   153: astore_1
    //   154: aload_0
    //   155: getfield 215	bdyd:jdField_a_of_type_Bety	Lbety;
    //   158: ifnull +975 -> 1133
    //   161: aload 7
    //   163: astore_1
    //   164: aload_0
    //   165: getfield 215	bdyd:jdField_a_of_type_Bety	Lbety;
    //   168: invokevirtual 634	bety:isShowing	()Z
    //   171: ifeq +962 -> 1133
    //   174: aload 7
    //   176: astore_1
    //   177: aload_0
    //   178: getfield 215	bdyd:jdField_a_of_type_Bety	Lbety;
    //   181: invokevirtual 220	bety:dismiss	()V
    //   184: goto +949 -> 1133
    //   187: aload 7
    //   189: astore_1
    ...
    //   270: ldc_w 322
    //   273: ldc_w 642
    //   276: invokestatic 409	alud:a	(I)Ljava/lang/String;
    ...
    //   331: aastore
    //   332: invokevirtual 213	bdyd:callJs	(Ljava/lang/String;[Ljava/lang/String;)V
    //   335: aload 9
    //   337: areturn
    //   338: astore_1
    ...
    //   529: astore_1
    //   530: aload_0
    //   531: getfield 282	bdyd:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   534: aload 12
    //   536: bipush 21
    //   538: invokestatic 685	aryv:a	(Landroid/app/Activity;Landroid/content/Intent;I)V
    //   541: goto -354 -> 187
    //   544: astore 8
    //   546: aload 7
    //   548: astore_1
    ...
    //   676: ldc_w 705
    //   679: ldc_w 706
    //   682: invokestatic 409	alud:a	(I)Ljava/lang/String;
    ...
    //   754: astore_1
    //   755: aload_0
    //   756: getfield 109	bdyd:mRuntime	Lbegz;
    //   759: invokevirtual 337	begz:a	()Lcom/tencent/common/app/AppInterface;
    //   762: aload_0
    //   763: getfield 109	bdyd:mRuntime	Lbegz;
    //   766: invokevirtual 177	begz:a	()Landroid/app/Activity;
    //   769: aload 8
    //   771: aload_0
    //   772: invokestatic 717	bjev:a	(Lcom/tencent/common/app/AppInterface;Landroid/content/Context;Landroid/os/Bundle;Landroid/content/DialogInterface$OnDismissListener;)V
    //   775: goto -588 -> 187
    //   778: astore 8
    //   780: aload_1
    //   781: astore 7
    ...
    //   829: astore_1
    //   830: aload_0
    //   831: getfield 109	bdyd:mRuntime	Lbegz;
    //   834: invokevirtual 114	begz:a	()Lcom/tencent/biz/pubaccount/CustomWebView;
    //   837: new 729	com/tencent/mobileqq/vashealth/HealthStepCounterPlugin$4
    //   840: dup
    //   841: aload_0
    //   842: invokespecial 730	com/tencent/mobileqq/vashealth/HealthStepCounterPlugin$4:<init>	(Lbdyd;)V
    ...
    //   883: astore_1
    //   884: aload_0
    //   885: getfield 109	bdyd:mRuntime	Lbegz;
    //   888: invokevirtual 114	begz:a	()Lcom/tencent/biz/pubaccount/CustomWebView;
    //   891: new 736	com/tencent/mobileqq/vashealth/HealthStepCounterPlugin$5
    //   894: dup
    //   895: aload_0
    //   896: invokespecial 737	com/tencent/mobileqq/vashealth/HealthStepCounterPlugin$5:<init>	(Lbdyd;)V
    ...
    //   920: getstatic 742	alof:bd	Ljava/lang/String;
    ...
    //   955: aload 8
    //   957: aload 12
    //   959: invokestatic 264	bdhj:a	(Landroid/graphics/Bitmap;Ljava/io/File;)V
    //   962: aload 7
    //   964: astore_1
    ...
    //   993: astore_1
    //   994: aload_0
    //   995: getfield 109	bdyd:mRuntime	Lbegz;
    //   998: invokevirtual 177	begz:a	()Landroid/app/Activity;
    ...
    //   1037: getstatic 742	alof:bd	Ljava/lang/String;
    ...
    //   1062: ldc_w 322
    //   1065: ldc_w 764
    //   1068: invokestatic 409	alud:a	(I)Ljava/lang/String;
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      if ((Build.VERSION.SDK_INT < 19) || (paramJsBridgeListener.getDefaultSensor(19) == null))
      {
        ...
        paramString1.put("msg", alud.a(2131705844));
        super.callJs(paramJsBridgeListener, new String[] { paramString1.toString() });
      }
      else
      {
        paramJsBridgeListener = new NewIntent(this.mRuntime.a().getApplication(), bdyx.class);
    ...
    if (paramString3.equals("healthSwitch"))
    {
      ...
      if ((!TextUtils.isEmpty(paramJsBridgeListener)) && (Integer.parseInt(paramJsBridgeListener) == 0))
      {
        ...
        paramJsBridgeListener.put("msg", alud.a(2131705840));
      ...
      paramString2 = new NewIntent(this.jdField_a_of_type_AndroidAppActivity, bdyx.class);
      ...
      paramJsBridgeListener.put("msg", alud.a(2131705841));
      super.callJs(paramString1, new String[] { paramJsBridgeListener.toString() });
      i = 1;
    }
    for (;;)
    {
      if (i == 0)
      {
        ...
        paramJsBridgeListener.put("msg", alud.a(2131705847));
        super.callJs(paramString1, new String[] { paramJsBridgeListener.toString() });
        break label1169;
        if (paramString3.equals("shareSnapshot"))
        {
          if (this.jdField_a_of_type_Bety == null)
          {
            ...
            this.jdField_a_of_type_Bety = paramJsBridgeListener;
          }
          if (this.jdField_a_of_type_Bety != null)
          {
        ...
        {
          paramJsBridgeListener = new JSONObject(paramVarArgs[0]).getString("callback");
          paramString1 = new NewIntent(this.mRuntime.a().getApplication(), bdyx.class);
  ...
  public void onDestroy()
  {
    ...
    if (jdField_a_of_type_Bdyh != null)
    {
      ((SensorManager)this.jdField_a_of_type_AndroidAppActivity.getSystemService("sensor")).unregisterListener(jdField_a_of_type_Bdyh);
      jdField_a_of_type_Bdyh = null;
    }
  }
