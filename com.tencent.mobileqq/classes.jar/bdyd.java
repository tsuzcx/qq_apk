...
public class bdyd
{
  ...
  private WeakReference<bdye> jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(null);
  private String b;
  private String c = "android";
  private String d = "8.3.3";
  ...
  public bdyd(String paramString, int paramInt, bdye parambdye)
  {
    this.b = paramString;
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambdye);
  }
  ...
  private bdxv a()
  {
    try
    {
      ...
      if (i == 200)
      {
        ...
        if (localObject != null)
        {
          ...
          if (localObject != null)
          {
            ...
            if (localObject != null) {
              return new bdxv((JSONObject)localObject);
            }
          }
        }
      }
      else
      {
        ...
        localObject = new bdxv();
        ((bdxv)localObject).jdField_a_of_type_Int = i;
        return localObject;
      }
    }
  ...
  private void a(bdxv parambdxv)
  {
    if ((parambdxv != null) && (QLog.isColorLevel())) {
      QLog.i("GetRegisterLiangHaoList", 2, "onResponse " + parambdxv);
    }
    ...
    if (parambdxv != null)
    {
      i = parambdxv.jdField_a_of_type_Int;
    ...
    {
      localazmz.a(null, "reg_lh_get_list", bool, l1 - l2, 0L, (HashMap)localObject, "", true);
      localObject = (bdye)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localObject != null) {
        break label143;
      }
      return;
    ...
    label143:
    ThreadManagerV2.getUIHandlerV2().post(new GetRegisterLiangHaoList.2(this, parambdxv, (bdye)localObject));
  }
  ...
  private String b()
  {
    ...
    try
    {
      this.jdField_a_of_type_JavaLangString = bhoi.a("ecd027");
