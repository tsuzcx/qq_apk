...
public class ahte
{
  ...
  private final actw jdField_a_of_type_Actw = new ahtf(this);
  private final ahxl jdField_a_of_type_Ahxl = new ahtg(this);
  ...
  private ahte(Activity paramActivity, FixedSizeVideoView paramFixedSizeVideoView, ImageButton paramImageButton, QzoneVerticalVideoTopicInfo paramQzoneVerticalVideoTopicInfo)
  {
  ...
  public static ahte a(Activity paramActivity, FixedSizeVideoView paramFixedSizeVideoView, QzoneVerticalVideoTopicInfo paramQzoneVerticalVideoTopicInfo, ImageButton paramImageButton)
  {
    return new ahte(paramActivity, paramFixedSizeVideoView, paramImageButton, paramQzoneVerticalVideoTopicInfo);
  }
  ...
  private vrn a()
  {
    ...
    {
      vrn localvrn = new vrn();
      localvrn.jdField_d_of_type_JavaLangString = this.jdField_a_of_type_CooperationQzoneVideoQzoneVerticalVideoTopicInfo.c();
      localvrn.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_CooperationQzoneVideoQzoneVerticalVideoTopicInfo.d();
      localvrn.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_CooperationQzoneVideoQzoneVerticalVideoTopicInfo.b();
      localvrn.jdField_b_of_type_Int = 3;
      return localvrn;
    }
    return null;
  }
  ...
  private boolean c()
  {
    return (this.jdField_a_of_type_Vrn != null) && (a() - this.jdField_a_of_type_Vrn.f > 0L);
  }
  ...
  private void f()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioAudioPlayer == null)
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityAioAudioPlayer = new AudioPlayer(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Actw);
    ...
    if (this.jdField_a_of_type_Vrn != null)
    {
      ...
      str = this.jdField_a_of_type_Vrn.g;
      if (this.jdField_a_of_type_Int == 0) {
        break label108;
      }
    }
    label108:
    for (int i = this.jdField_a_of_type_Int;; i = this.jdField_a_of_type_Vrn.jdField_d_of_type_Int)
    {
    ...
    label119:
    QZLog.e("EditLocalVideoMusicMixe", 2, new Object[] { "startAudioPlayback: music not downloaded " + this.jdField_a_of_type_Vrn.jdField_d_of_type_JavaLangString });
  }
  
  public void a()
  {
    P2VEditMusicDialog localP2VEditMusicDialog = new P2VEditMusicDialog(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Ahxl, (int)a(), true);
  ...
  {
    if (this.jdField_a_of_type_Vrn != null) {
      new P2VEditMusicDialog(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Ahxl, (int)paramLong, true);
    }
  }
  ...
  public void a(ahti paramahti)
  {
    QzoneHandlerThreadFactory.getHandlerThread("Normal_HandlerThread").post(new EditLocalVideoMusicMixRunnable(this.jdField_a_of_type_Long, this.b, this.c, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Vrn, new ahth(this, paramahti)));
  }
  ...
  public boolean b()
  {
    return (this.jdField_a_of_type_Vrn != null) && ((this.jdField_a_of_type_Vrn.jdField_b_of_type_Int == 0) || (this.jdField_a_of_type_Vrn.jdField_b_of_type_Int == 3) || (this.jdField_a_of_type_Vrn.jdField_b_of_type_Int == 2)) && (!this.jdField_a_of_type_Boolean);
  }
