...
public class atym
{
  ...
  public static ArrayList<atyk> a()
  {
    int i = 0;
    ArrayList localArrayList = new ArrayList();
    Object localObject1 = BaseApplicationImpl.getApplication().getRuntime();
    Object localObject2 = (String)atbi.a(((AppRuntime)localObject1).getAccount(), "key_nearby_publish_menu", "");
    if (!TextUtils.isEmpty((String)atbi.a(((AppRuntime)localObject1).getAccount(), "cike_guide_content", ""))) {}
      ...
      for (;;)
      {
        try
        {
          ...
          if (i < ((JSONArray)localObject1).length())
          {
            ...
            atyk localatyk2 = new atyk();
            localatyk2.jdField_a_of_type_Int = ((JSONObject)localObject2).optInt("id");
            if ((!bool) && (localatyk2.jdField_a_of_type_Int != 1) && (localatyk2.jdField_a_of_type_Int != 2)) {
              break label337;
            }
            localatyk2.jdField_a_of_type_JavaLangString = ((JSONObject)localObject2).optString("icon");
            localatyk2.jdField_b_of_type_JavaLangString = ((JSONObject)localObject2).optString("title");
            localatyk2.c = ((JSONObject)localObject2).optString("subTitle");
            localatyk2.d = ((JSONObject)localObject2).optString("jumpUrl");
            localArrayList.add(localatyk2);
          }
        }
        catch (Exception localException)
        {
          ...
          {
            atyk localatyk1 = new atyk();
            localatyk1.jdField_a_of_type_Int = 1;
            localatyk1.jdField_b_of_type_Int = 2130840959;
            localatyk1.jdField_b_of_type_JavaLangString = ajya.a(2131707384);
            localArrayList.add(localatyk1);
            localatyk1 = new atyk();
            localatyk1.jdField_a_of_type_Int = 2;
            localatyk1.jdField_b_of_type_Int = 2130840958;
            localatyk1.jdField_b_of_type_JavaLangString = ajya.a(2131707385);
            localArrayList.add(localatyk1);
          }
  ...
  public static void a(Context paramContext, atyk paramatyk, String paramString)
  {
    if (QLog.isColorLevel()) {
      QLog.d("NearbyPublishMenuHelper", 2, "handleMenuItemClick：id=" + paramatyk.jdField_a_of_type_Int);
    }
    switch (paramatyk.jdField_a_of_type_Int)
    {
    default: 
      a(paramContext, paramatyk.d);
      return;
    case 1: 
      a(paramContext);
      return;
  ...
  {
    asyt localasyt = asyt.a(paramContext, BaseApplicationImpl.getApplication().getRuntime().getAccount(), 0);
    if (localasyt != null)
    {
      if (asyt.a(paramContext))
      {
        a(paramContext, localasyt.d);
        return;
      }
      localasyt.f = a(paramString1, paramString2);
      paramContext = new atyd(paramContext);
      paramContext.a(localasyt);
      paramContext.show();
      return;
    }
  ...
  {
    new axrc(null).a("dc00899").b("grp_lbs").c(paramString1).d(paramString2).a();
  }
  ...
  protected static void b(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      {
        bcql.a(paramContext, 2131719055, 0).a();
        if (QLog.isColorLevel()) {
      ...
      {
        String str = bbvj.a(ajsd.aW + "photo/" + System.currentTimeMillis() + ".jpg");
        ...
        for (localObject1 = (AppActivity)paramContext;; localObject2 = null)
        {
          ...
          if ((Build.VERSION.SDK_INT >= 23) && (((AppActivity)localObject1).checkSelfPermission("android.permission.CAMERA") != 0))
          {
            ...
            ((AppActivity)localObject1).requestPermissions(new atyn(paramContext, str, (AppActivity)localObject1, localIntent), 1, new String[] { "android.permission.CAMERA" });
          }
          for (int i = 1;; i = 0) {
            for (;;)
            {
              ...
              catch (Exception localException)
              {
                ...
                bcql.a(paramContext, 2131690593, 0).a();
                return;
              }
            }
          }
  ...
  {
    bcqf localbcqf = new bcqf(paramContext, paramContext.getResources().getDimensionPixelSize(2131298865));
    localbcqf.c(2131694100);
    ThreadManager.post(new NearbyPublishMenuHelper.2(localbcqf, paramString2, paramContext, paramString1), 5, null, true);
  }
