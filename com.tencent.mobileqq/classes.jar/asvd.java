...
final class asvd
{
  public static final asut a(String paramString, Object paramObject)
  {
    return a(paramString, new Object[] { paramObject });
  }
  
  public static final asut a(String paramString, Object paramObject1, Object paramObject2)
  {
    return a(paramString, new Object[] { paramObject1, paramObject2 });
  }
  
  public static final asut a(String paramString, Object[] paramArrayOfObject)
  {
  ...
  public static final asut a(String paramString, Object[] paramArrayOfObject, Throwable paramThrowable)
  {
    int j = 0;
    if (paramString == null) {
      return new asut(null, paramArrayOfObject, paramThrowable);
    }
    if (paramArrayOfObject == null) {
      return new asut(paramString);
    }
    ...
    if (j < paramArrayOfObject.length)
    {
      ...
      {
        if (i == 0) {
          return new asut(paramString, paramArrayOfObject, paramThrowable);
        }
        localStringBuilder.append(paramString, i, paramString.length());
        return new asut(localStringBuilder.toString(), paramArrayOfObject, paramThrowable);
      }
      if (a(paramString, k)) {
        if (!b(paramString, k))
        {
