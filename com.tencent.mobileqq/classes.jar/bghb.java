  ...
  implements bggv
{
  ...
  private static ConcurrentHashMap<String, bghb> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  private Handler jdField_a_of_type_AndroidOsHandler;
  private String jdField_a_of_type_JavaLangString;
  
  private bghb(String paramString)
  {
  ...
  {
    Object localObject1 = (bghb)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
    if (localObject1 == null) {
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        bghb localbghb = (bghb)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
        localObject1 = localbghb;
        if (localbghb == null)
        {
          localObject1 = new bghb(paramString);
  ...
  public void onLocationFinish(int paramInt, SosoInterface.SosoLbsInfo paramSosoLbsInfo)
  {
    ...
    bgcd.a(paramInt, this.jdField_a_of_type_JavaLangString, l1 - l2);
