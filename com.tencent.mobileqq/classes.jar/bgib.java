  ...
  implements Manager
{
  ...
  public void a(Bundle paramBundle, RemoteCommand.OnInvokeFinishLinstener paramOnInvokeFinishLinstener)
  {
    ...
    for (;;)
    {
      ...
      paramOnInvokeFinishLinstener = new aywc();
      ...
      paramOnInvokeFinishLinstener.jdField_a_of_type_Auoq = this.jdField_a_of_type_Auoq;
      ...
      try
      {
        ...
        this.jdField_a_of_type_Ayvx.a(paramOnInvokeFinishLinstener);
        return;
      }
