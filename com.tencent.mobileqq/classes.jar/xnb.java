  ...
  extends WebViewPlugin
{
  ...
  private void b()
  {
    if (this.jdField_a_of_type_Mxk == null) {
      this.jdField_a_of_type_Mxk = new mxk(this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView, new xnc(this));
    }
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_AndroidWidgetImageView != null) {
          this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new xnd(this));
        }
    ...
    do
    {
      do
      {
        ...
        if (this.jdField_a_of_type_Mxk != null)
        {
          ...
          this.jdField_a_of_type_Mxk = null;
        }
