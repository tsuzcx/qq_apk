...
{
  public xnb(Context paramContext)
  {
  ...
  public void a(java.util.List paramList)
  {
    ...
    //   26: astore 5
    //   28: aload_0
    //   29: invokevirtual 369	xnb:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   32: astore 7
    //   34: aload 7
    //   36: astore 5
    //   38: aload 7
    //   40: astore 6
    //   42: aload 7
    //   44: invokevirtual 372	android/database/sqlite/SQLiteDatabase:beginTransaction	()V
    //   47: aload 7
    //   49: astore 5
    //   51: aload 7
    //   53: astore 6
    //   55: aload_1
    //   56: invokeinterface 373 1 0
    //   61: istore_3
    //   62: aload 7
    //   64: astore 5
    //   66: aload 7
    ...
    //   75: bipush 14
    //   77: imul
    //   78: invokespecial 374	java/lang/StringBuilder:<init>	(I)V
    //   81: astore 8
    //   83: iconst_0
    //   84: istore_2
    //   85: iload_2
    ...
    //   100: aload_1
    //   101: iload_2
    //   102: invokeinterface 377 2 0
    //   107: checkcast 273	java/lang/Long
    //   110: invokevirtual 380	java/lang/Long:longValue	()J
    ...
    //   242: astore 6
    //   244: aload 7
    //   246: invokevirtual 391	android/database/sqlite/SQLiteDatabase:setTransactionSuccessful	()V
    //   249: aload 7
    //   251: ifnull -232 -> 19
    //   254: aload 7
    //   256: invokevirtual 394	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   259: aload 7
    ...
    //   357: ifnull -338 -> 19
    //   360: aload 5
    //   362: invokevirtual 394	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   365: aload 5
    ...
    //   415: ifnull +13 -> 428
    //   418: aload 6
    //   420: invokevirtual 394	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   423: aload 6
    ...
    //   0	478	0	this	xnb
    //   0	478	1	paramList	java.util.List
    //   84	391	2	i	int
    //   61	60	3	j	int
    //   12	3	4	bool	boolean
  ...
  /* Error */
  public void b(java.util.List paramList)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 4
    ...
    //   24: return
    //   25: aload_0
    //   26: invokevirtual 369	xnb:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   29: astore 5
    //   31: aload 5
    //   33: astore_3
    //   34: aload 5
    //   36: astore 4
    //   38: aload 5
    //   40: invokevirtual 372	android/database/sqlite/SQLiteDatabase:beginTransaction	()V
    //   43: aload 5
    //   45: astore_3
    //   46: aload 5
    //   48: astore 4
    //   50: new 400	android/content/ContentValues
    //   53: dup
    //   54: invokespecial 401	android/content/ContentValues:<init>	()V
    //   57: astore 6
    //   59: aload 5
    //   61: astore_3
    //   62: aload 5
    ...
    //   117: astore 4
    //   119: aload 6
    //   121: invokevirtual 417	android/content/ContentValues:clear	()V
    //   124: aload 5
    //   126: astore_3
    //   127: aload 5
    //   129: astore 4
    ...
    //   143: invokevirtual 420	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Long;)V
    //   146: aload 5
    //   148: astore_3
    //   149: aload 5
    //   151: astore 4
    ...
    //   157: aload_0
    //   158: aload 7
    //   160: invokespecial 422	xnb:a	(LVACDReport/ReportItem;)Ljava/lang/String;
    //   163: invokevirtual 425	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   166: aload 5
    //   168: astore_3
    //   169: aload 5
    //   171: astore 4
    ...
    //   185: invokevirtual 420	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Long;)V
    //   188: aload 5
    //   190: astore_3
    //   191: aload 5
    //   193: astore 4
    ...
    //   197: ldc 201
    //   199: iconst_0
    //   200: invokestatic 430	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   203: invokevirtual 433	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Integer;)V
    //   206: aload 5
    //   208: astore_3
    //   209: aload 5
    //   211: astore 4
    ...
    //   217: aconst_null
    //   218: aload 6
    //   220: invokevirtual 437	android/database/sqlite/SQLiteDatabase:insertOrThrow	(Ljava/lang/String;Ljava/lang/String;Landroid/content/ContentValues;)J
    //   223: pop2
    //   224: goto -151 -> 73
    //   227: astore_1
    //   228: aload_3
    ...
    //   270: ifnull -248 -> 22
    //   273: aload_3
    //   274: invokevirtual 394	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   277: aload_3
    ...
    //   333: astore 4
    //   335: aload 5
    //   337: invokevirtual 391	android/database/sqlite/SQLiteDatabase:setTransactionSuccessful	()V
    //   340: aload 5
    //   342: ifnull -320 -> 22
    //   345: aload 5
    //   347: invokevirtual 394	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   350: aload 5
    ...
    //   400: ifnull +13 -> 413
    //   403: aload 4
    //   405: invokevirtual 394	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   408: aload 4
    ...
    //   start	length	slot	name	signature
    //   0	454	0	this	xnb
    //   0	454	1	paramList	java.util.List
    //   17	2	2	bool	boolean
  ...
  /* Error */
  public void c(java.util.List paramList)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 4
    ...
    //   112: astore 4
    //   114: aload 6
    //   116: invokevirtual 417	android/content/ContentValues:clear	()V
    //   119: aload 5
    //   121: astore_3
    //   122: aload 5
    //   124: astore 4
    ...
    //   138: invokevirtual 420	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Long;)V
    //   141: aload 5
    //   143: astore_3
    //   144: aload 5
    //   146: astore 4
    ...
    //   152: aload_0
    //   153: aload 7
    //   155: invokespecial 444	xnb:a	(LVACDReport/ReportHeader;)Ljava/lang/String;
    //   158: invokevirtual 425	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   161: aload 5
    //   163: astore_3
    //   164: aload 5
    //   166: astore 4
    ...
    //   170: ldc 201
    //   172: iconst_1
    //   173: invokestatic 430	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   176: invokevirtual 433	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Integer;)V
    //   179: aload 5
    //   181: astore_3
    //   182: aload 5
    //   184: astore 4
    ...
    //   188: ldc 96
    //   190: iconst_0
    //   191: invokestatic 430	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   194: invokevirtual 433	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Integer;)V
    //   197: aload 5
    //   199: astore_3
    //   200: aload 5
    //   202: astore 4
    ...
    //   208: aconst_null
    //   209: aload 6
    //   211: invokevirtual 437	android/database/sqlite/SQLiteDatabase:insertOrThrow	(Ljava/lang/String;Ljava/lang/String;Landroid/content/ContentValues;)J
    //   214: pop2
    //   215: goto -142 -> 73
    //   218: astore_1
    //   219: aload_3
    ...
    //   261: ifnull -239 -> 22
    //   264: aload_3
    //   265: invokevirtual 394	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   268: aload_3
    ...
    //   324: astore 4
    //   326: aload 5
    //   328: invokevirtual 391	android/database/sqlite/SQLiteDatabase:setTransactionSuccessful	()V
    //   331: aload 5
    //   333: ifnull -311 -> 22
    //   336: aload 5
    //   338: invokevirtual 394	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   341: aload 5
    ...
    //   391: ifnull +13 -> 404
    //   394: aload 4
    //   396: invokevirtual 394	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   399: aload 4
    ...
    //   start	length	slot	name	signature
    //   0	445	0	this	xnb
    //   0	445	1	paramList	java.util.List
    //   17	2	2	bool	boolean
