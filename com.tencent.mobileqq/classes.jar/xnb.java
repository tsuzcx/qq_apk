...
public class xnb
  extends Handler
{
  public xnb(EditLocalVideoActivity paramEditLocalVideoActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 1100: 
      do
      {
        ...
        new AlertDialog.Builder(this.a).setMessage("初始化裁剪组件失败").setNegativeButton(2131428346, new xnc(this)).setCancelable(false).create().show();
        return;
    ...
    case 9999: 
      ...
      try
      {
        new AlertDialog.Builder(this.a).setMessage("加载视频超时").setNegativeButton(2131428346, new xnd(this)).setCancelable(false).create().show();
        return;
      }
