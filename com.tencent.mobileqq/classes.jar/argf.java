...
public class argf
{
  private static HashMap<String, argf> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private final Context jdField_a_of_type_AndroidContentContext;
  private Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new argg(this);
  ...
  private argf(Context paramContext, File paramFile, String paramString)
  {
    ...
    this.jdField_a_of_type_Boolean = arfn.a();
  ...
  public static argf a(Context paramContext, String paramString1, String paramString2)
  {
    try
    {
      String str = paramString2 + paramString1;
      argf localargf = (argf)jdField_a_of_type_JavaUtilHashMap.get(str);
      paramString1 = localargf;
      if (localargf == null)
      {
        paramString1 = new argf(paramContext.getApplicationContext(), a(paramContext), paramString2);
  ...
  private InstalledPlugin a(ProgressFuture<InstalledPlugin> paramProgressFuture)
  {
    ...
    if ((!this.jdField_b_of_type_Boolean) && (argi.jdField_a_of_type_Boolean))
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (str.equals("SOURCE_CGI"))
        {
          ...
          argi.a("2653754");
          localObject1 = localObject2;
          a("HuayangPluginNewDownloader", ajyc.a(2131705632) + localTargetDownloadInfo.url);
          localObject1 = localObject2;
      ...
      catch (VersionCheckException localVersionCheckException)
      {
        ...
        try
        {
          ...
          localObject3 = localInstalledPlugin;
          a("updatePlugin", localInstalledPlugin.pluginFileType, k, "", "");
          localObject3 = localInstalledPlugin;
          a("HuayangPluginNewDownloader", ajyc.a(2131705646) + k);
          localObject3 = localInstalledPlugin;
          if (!str.equals("SOURCE_CGI")) {
            continue;
          }
  ...
  private void a(InstalledPlugin paramInstalledPlugin)
  {
    ...
    try
    {
      ...
      a("HuayangPluginNewDownloader", ajyc.a(2131705628));
      str1 = str2;
      if (!this.jdField_b_of_type_Boolean)
      {
  ...
  {
    Object localObject = new StringBuilder().append(ajyc.a(2131705634));
    boolean bool;
    if (paramInstalledPlugin == null)
    {
      bool = true;
  ...
  {
    Intent localIntent = new Intent(arfw.c(this.jdField_b_of_type_JavaLangString));
    int i;
    if (paramBoolean)
    {
      i = 1;
      ...
      if (!paramBoolean)
      {
        if (!arfw.a(this.jdField_b_of_type_JavaLangString)) {
          break label64;
        }
        argi.a("2714209");
      }
    ...
    label64:
    while (!arfw.b(this.jdField_b_of_type_JavaLangString))
    {
      return;
      i = 0;
      break;
  ...
  private void b(InstalledPlugin paramInstalledPlugin)
  {
    ...
    if (this.jdField_a_of_type_Argh != null) {
      this.jdField_a_of_type_Argh.a(10, new Object[0]);
    }
    ...
    a("HuayangPluginNewDownloader", ajyc.a(2131705648));
  }
  
  private void b(InstalledPlugin paramInstalledPlugin, boolean paramBoolean)
  {
    a("HuayangPluginNewDownloader", ajyc.a(2131705636) + paramInstalledPlugin);
  ...
  private void c()
  {
    ...
    if ((localObject1 != null) && (((List)localObject1).size() > 0))
    {
      ...
      {
        a("HuayangPluginNewDownloader", ajyc.a(2131705643) + (String)localObject3 + " mPluginVersion:" + this.e);
    ...
    for (;;)
    {
      try
      {
        ...
        if ((!"huiyin".equals(this.d)) || (bbev.a(this.jdField_a_of_type_AndroidContentContext)) || (!bool)) {
          break label559;
        }
        return;
      }
      ...
      if (argj.jdField_a_of_type_JavaUtilMap.get(this.d) != null) {
        argi.b(String.valueOf(((argj)argj.jdField_a_of_type_JavaUtilMap.get(this.d)).g));
      }
      localObject3 = null;
      break;
      label553:
    ...
    if (!this.jdField_b_of_type_Boolean) {
      if (localException1 == null)
      {
        ...
        a("HuayangPluginNewDownloader", ajyc.a(2131705642));
  ...
  {
    this.jdField_a_of_type_Argh = paramargh;
  }
