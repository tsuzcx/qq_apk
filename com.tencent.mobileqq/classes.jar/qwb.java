...
{
  private static final String jdField_c_of_type_JavaLangString = ajya.a(2131716930);
  private WeishiRedDotInfo jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructWeishiRedDotInfo;
  private otm jdField_a_of_type_Otm = (otm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(274);
  private boolean jdField_c_of_type_Boolean;
  private boolean d;
  
  public qwb(qjq paramqjq, Bundle paramBundle, QQAppInterface paramQQAppInterface, FragmentActivity paramFragmentActivity, String paramString1, String paramString2, boolean paramBoolean, int paramInt)
  {
  ...
  private void a(WeishiRedDotInfo paramWeishiRedDotInfo)
  {
    ...
    this.jdField_a_of_type_Nps.a(this.jdField_a_of_type_Npt, l1, a(), i, null, str1, l3, true, 0, str2, str3, paramWeishiRedDotInfo, 0, null, null, 0, null);
  }
  ...
  public void a(int paramInt)
  {
    if (paramInt == 0)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130842597);
      return;
    }
    super.a(paramInt);
  }
  ...
  public boolean a(Bundle paramBundle)
  {
    if (this.jdField_c_of_type_Boolean)
    {
      ...
      if (this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo != null)
      {
        ...
        this.jdField_a_of_type_Otm.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity);
        return true;
      }
    }
  ...
  public void b()
  {
    ...
    ((URLDrawable.URLDrawableOptions)localObject).mRequestHeight = ((int)bbdh.l());
  ...
  {
    if ((paramVideoInfo != null) && (this.jdField_a_of_type_Otm != null))
    {
      if (paramVideoInfo.a == null) {
        qoi.a(paramVideoInfo);
      }
      long l = NetConnInfoCenter.getServerTime();
      this.jdField_a_of_type_Otm.a(sgg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramVideoInfo.a), l);
    }
  }
