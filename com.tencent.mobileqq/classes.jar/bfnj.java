...
public final class bfnj
{
  ...
  public static String a(String paramString, boolean paramBoolean)
  {
    ...
    for (paramString = "&";; paramString = "?")
    {
      ...
      bfne.d("ReaderUrlHelper", "getUrlWithBid = " + (String)localObject);
      return localObject;
  ...
  private static String d(String paramString)
  {
    String str2 = null;
    String str1;
    if ((bfly.a != null) && (bfly.a.size() > 0)) {
      str1 = (String)bfly.a.get(paramString);
    }
    for (;;)
    {
      bfne.c("ReaderUrlHelper", "getUrl = " + str1);
      return str1;
      if (bfly.a != null) {
        str2 = (String)bfly.a.get(paramString);
      }
      str1 = str2;
      if (str2 == null) {
