...
public class awfo
{
  ...
  private static final String c = anvx.a(2131693532);
  private static final String d = anvx.a(2131693536);
  
  private static void a(int paramInt1, String paramString1, int paramInt2, String paramString2, avhz paramavhz)
  {
    Object localObject;
    if (paramInt2 == 31)
    {
      ...
      paramString2 = beki.a(16, awfq.a((QQAppInterface)localObject, paramString1, paramInt1, paramString2));
    ...
    {
      paramString1 = ((Resources)localObject).getString(2131693557, new Object[] { paramString2, paramString1 });
      paramavhz.c = paramString1;
      paramInt1 = paramString1.indexOf(d);
      if (paramInt1 != -1)
      {
        paramString1 = new Bundle();
        paramString1.putInt("key_action", 59);
        paramavhz.a(paramInt1, d.length() + paramInt1, paramString1);
      }
      return;
      paramInt1 = 2;
      break;
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, TroopTips0x857.MediaChangePushInfo paramMediaChangePushInfo)
  {
    if (paramMediaChangePushInfo != null)
    {
      ...
      label403:
      if ((i == 31) || (i == 32)) {
        localListenTogetherManager.a(1, str1, paramLong1, l1, awfq.a(1, j, 0));
      }
  ...
  private static void a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt1, String paramString2, int paramInt2, String paramString3, long paramLong1, long paramLong2, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      paramBundle = new avhz(paramString1, paramString1, paramString2, paramInt1, i, 131083, bcrg.a());
      ...
      bool = avia.a(paramQQAppInterface, paramString2);
  ...
  private static void a(String paramString, int paramInt, avhz paramavhz)
  {
    if ((paramInt == 1) || (paramInt == 3))
    {
      ...
      if (paramInt != -1)
      {
        ...
        paramavhz.a(paramInt, paramInt + 4, paramString);
      }
    }
    else
    {
