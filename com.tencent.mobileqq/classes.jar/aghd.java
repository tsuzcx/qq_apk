...
public class aghd
{
  ...
  public aghd(aggy paramaggy, Context paramContext, ViewGroup paramViewGroup)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnTouchListener(new aghe(this, paramaggy));
    this.jdField_c_of_type_AndroidWidgetRelativeLayout$LayoutParams = new RelativeLayout.LayoutParams(-1, -1);
    this.jdField_c_of_type_AndroidWidgetRelativeLayout$LayoutParams.topMargin = paramaggy.a;
    ...
    this.jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener = new aghf(this, paramaggy);
    this.jdField_a_of_type_JavaLangRunnable = new PhotoListPanel.SwipeUpAndDragListener.GestureHandler.3(this, paramaggy);
    this.jdField_b_of_type_JavaLangRunnable = new PhotoListPanel.SwipeUpAndDragListener.GestureHandler.4(this, paramaggy);
  }
  ...
  public boolean a(aggv paramaggv, int paramInt)
  {
    this.jdField_a_of_type_Aggv = paramaggv;
    this.jdField_b_of_type_Int = paramInt;
    paramaggv.itemView.getLocationInWindow(this.jdField_c_of_type_ArrayOfInt);
    paramaggv = this.jdField_a_of_type_Aggv.a.getDrawable();
    this.jdField_a_of_type_ComTencentWidgetRoundRectImageView.setImageDrawable(paramaggv);
  ...
  void b()
  {
    ...
    try
    {
      this.jdField_a_of_type_Aggv.itemView.clearAnimation();
