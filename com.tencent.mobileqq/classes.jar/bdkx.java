...
public class bdkx
{
  ...
  private static bdkz jdField_a_of_type_Bdkz = new bdkz();
  ...
  public static int a()
  {
    ...
    if (!((aoan)((AppRuntime)localObject).getManager(QQManagerFactory.PUBLICACCOUNTDATA_MANAGER)).a(Long.valueOf(Long.parseLong("2290230341"))))
    {
      if (QLog.isColorLevel()) {
  ...
  {
    RemoteHandleManager.getInstance().addWebEventListener(new bdky(paramQQAppInterface));
  ...
  public static void a(QQAppInterface paramQQAppInterface, ConfigurationService.Config paramConfig, int paramInt, String paramString)
  {
    ...
    int j = bhhr.a(paramQQAppInterface.getApp(), "qzone_xp_config_version", paramString);
    if (QLog.isColorLevel()) {
    ...
    while (!QLog.isColorLevel())
    {
      do
      {
        try
        {
          ...
          bhhr.a(paramQQAppInterface.getApp(), "qzone_xp_config_version", paramString, i);
          return;
        }
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    NewIntent localNewIntent = new NewIntent(BaseApplicationImpl.getApplication(), bcwa.class);
    ...
    for (String str = "1";; str = "0")
    {
      ...
      BaseApplicationImpl.getApplication().getRuntime().registObserver(jdField_a_of_type_Bdkz);
      BaseApplicationImpl.getApplication().getRuntime().startServlet(localNewIntent);
      bdla.b(paramQQAppInterface, "CliOper", "", "", "0X800915C", "0X800915C", 0, 0, "", "", "", "");
      return;
    }
  }
}
