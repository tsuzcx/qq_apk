...
public class bdkx
{
  ...
  {
    return bdky.a(ampn.a, paramString, "config_qq.android.ar_");
  }
  
  public static SharedPreferences a(String paramString1, String paramString2)
  {
    return bdky.a(ampn.a, paramString1, "res_qq.android.ar_" + paramString2);
  }
      ...
      try
      {
        if (TextUtils.isEmpty(paramString2))
        {
          ...
          if (localObject != null)
          {
            ...
            QLog.w(ampn.a, 1, "ConfigInfo.get, step[" + i + "], configText[" + paramString2 + "]");
            localObject = new PromotionConfigInfo();
            ((PromotionConfigInfo)localObject).setUin(paramString1);
            if (!TextUtils.isEmpty(paramString2)) {
              ((PromotionConfigInfo)localObject).tryParse(ampn.a, paramString2);
            }
            return localObject;
          }
          i = 2;
  ...
  {
    BusinessCommonConfig.saveMd5(ampn.a, a(paramString1, paramString2), "md5_" + paramInt, paramString3);
  }
  
  public static boolean a(String paramString1, String paramString2, int paramInt, String paramString3, String paramString4)
  {
    return BusinessCommonConfig.isResReady(ampn.a + "_" + paramString2, a(paramString1, paramString2), "md5_" + paramInt, paramString3, paramString4);
  }
  ...
  {
    return bdky.a(ampn.a, paramString, "res_qq.android.ar_");
  }
}
