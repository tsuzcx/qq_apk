...
public class nqy
{
  ...
  public boolean a(Context paramContext, MessageRecord paramMessageRecord, TextView paramTextView, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        boolean bool = bbkk.a(paramString);
        if (bool) {
          return false;
        }
        try
        {
          ...
          {
            paramTextView.setBackgroundResource(2130846196);
            paramTextView.setVisibility(0);
            paramTextView.setText(ajya.a(2131703622));
            localObject1 = paramContext.getResources().getDrawable(2130846199);
            ((Drawable)localObject1).setBounds(0, 0, 24, 16);
            paramTextView.setCompoundDrawables(null, null, (Drawable)localObject1, null);
            i = vzl.a(paramContext, 6.0F);
            paramTextView.setPadding(i, 0, i, 0);
            paramTextView.setCompoundDrawablePadding(vzl.a(paramContext, 2.0F));
            ...
            localObject1 = LayoutInflater.from(paramContext).inflate(2131559395, null);
            LinearLayout localLinearLayout = (LinearLayout)((View)localObject1).findViewById(2131369371);
            ...
            if (i < paramString.length())
            {
              ...
              ((LinearLayout)localObject3).setOnClickListener(new nqz(this, j, (JSONObject)localObject2, paramContext, paramMessageRecord));
              ...
              ((LinearLayout.LayoutParams)localObject4).height = vzl.a(paramContext, 50.0F);
              ...
              ((LinearLayout.LayoutParams)localObject5).width = vzl.a(paramContext, 20.0F);
              ((LinearLayout.LayoutParams)localObject5).height = vzl.a(paramContext, 18.0F);
              ((LinearLayout.LayoutParams)localObject5).leftMargin = vzl.a(paramContext, 15.0F);
              localObject5 = ((JSONObject)localObject2).optString("icon_url", "");
              if (!bbkk.a((String)localObject5))
              {
                URLDrawable.URLDrawableOptions localURLDrawableOptions = URLDrawable.URLDrawableOptions.obtain();
                localURLDrawableOptions.mRequestHeight = vzl.a(paramContext, 20.0F);
                localURLDrawableOptions.mRequestWidth = vzl.a(paramContext, 18.0F);
              ...
              ((LinearLayout.LayoutParams)localObject3).leftMargin = vzl.a(paramContext, 10.0F);
              ...
              ((LinearLayout.LayoutParams)localObject3).height = vzl.a(paramContext, 1.0F);
        ...
        catch (JSONException paramString)
        {
          ...
          paramTextView.setOnClickListener(new nra(this, paramContext, paramTextView, paramMessageRecord));
          return true;
        }
        return false;
      }
