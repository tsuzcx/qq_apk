  ...
  implements DialogInterface.OnCancelListener
{
  ...
  private void a()
  {
    ...
    if (k < m)
    {
      ...
      for (;;)
      {
        ...
        Object localObject3 = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130840975);
    ...
    {
      localObject1 = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131559335, null);
      ...
      ((Button)localObject2).setText(2131694326);
  ...
  public TextView a(String paramString)
  {
    try
    {
      ...
      localButton.setBackgroundResource(2130840821);
