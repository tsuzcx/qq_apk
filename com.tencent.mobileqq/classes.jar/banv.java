...
public class banv
{
  public static banw a;
  public static final String a;
  public static HashMap<String, banw> a;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = antf.ba + "qbosssplahAD/";
    b = antf.ba + "qbdownres";
  ...
  public static HashMap<String, banw> a(String paramString, SharedPreferences paramSharedPreferences, Set<String> paramSet)
  {
    ...
    try
    {
      ...
      while (paramSet.hasNext())
      {
        ...
        localbanx.h(paramString).b(str1).c(str2).d(str3).c(i).e(str4).e(k).g(str6).f(str5).d(j).b(bool1).a(bool2).b(m).i(str7).j(str8).a(n).a(str9);
        QLog.i("QSplash@QbossSplashUtil", 1, "buildADEntryFromSP  adid =" + str1);
        jdField_a_of_type_JavaUtilHashMap.put(str1, localbanx.a());
      }
      return jdField_a_of_type_JavaUtilHashMap;
    }
    catch (Exception paramString)
  ...
  public static boolean a(long paramLong)
  {
    ...
    //   9: lload_0
    //   10: invokestatic 480	banv:a	(Landroid/content/Context;J)Ljava/util/List;
    //   13: astore 7
    //   15: iload 4
    //   17: istore_3
    //   18: aload 7
    ...
    //   90: invokestatic 176	banv:a	(Landroid/content/Context;Ljava/lang/String;)Landroid/content/SharedPreferences;
    //   93: astore 9
    ...
    //   117: invokestatic 488	bnua:a	(Landroid/content/Context;Ljava/lang/String;)Landroid/content/SharedPreferences;
    //   120: astore 6
    ...
    //   144: invokestatic 490	banv:a	(Landroid/content/Context;Ljava/lang/String;)Ljava/util/Set;
    //   147: astore 10
    ...
    //   171: invokestatic 491	bnua:a	(Landroid/content/Context;Ljava/lang/String;)Ljava/util/Set;
    //   174: astore 8
    ...
    //   195: aload 9
    //   197: aload 10
    //   199: invokestatic 493	banv:a	(Ljava/lang/String;Landroid/content/SharedPreferences;Ljava/util/Set;)Ljava/util/HashMap;
    //   202: astore 9
    //   204: aload 9
    ...
    //   225: aload 6
    //   227: aload 8
    //   229: invokestatic 493	banv:a	(Ljava/lang/String;Landroid/content/SharedPreferences;Ljava/util/Set;)Ljava/util/HashMap;
    //   232: invokevirtual 497	java/util/HashMap:putAll	(Ljava/util/Map;)V
    //   235: aconst_null
    //   236: astore 6
    //   238: aload 7
    //   240: invokeinterface 498 1 0
    //   245: astore 10
    //   247: aload 10
    ...
    //   269: aload 9
    //   271: aload 7
    //   273: invokevirtual 501	java/util/HashMap:containsKey	(Ljava/lang/Object;)Z
    //   276: ifeq +145 -> 421
    //   279: aload 9
    //   281: aload 7
    //   283: invokevirtual 504	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   286: checkcast 506	banw
    //   289: astore 8
    //   291: ldc 61
    //   293: iconst_1
    ...
    //   307: aload 8
    //   309: invokevirtual 509	banw:toString	()Ljava/lang/String;
    ...
    //   321: aload 8
    //   323: invokevirtual 511	banw:a	()Z
    //   326: ifeq +95 -> 421
    //   329: aload 6
    ...
    //   343: astore 7
    //   345: aload 8
    //   347: getfield 514	banw:d	I
    //   350: aload 6
    //   352: getfield 514	banw:d	I
    //   355: if_icmpgt +59 -> 414
    //   358: goto +63 -> 421
    //   361: aload 6
    //   363: putstatic 516	banv:jdField_a_of_type_Banw	Lbanw;
    //   366: iconst_1
    //   367: istore_3
    //   368: iload_3
    //   369: ireturn
