...
public class abjb
  extends ajyr
{
  public abjb(HotChatAnnounceActivity paramHotChatAnnounceActivity) {}
  ...
  public void a(boolean paramBoolean, String paramString1, int paramInt, String paramString2)
  {
    ...
    if ((paramBoolean) && (paramInt == 0))
    {
      ...
      bcql.a(this.a, 2, ajya.a(2131705536), 0).b(this.a.getTitleBarHeight());
      this.a.setResult(-1);
      this.a.finish();
      return;
    }
    paramString1 = ajya.a(2131705539);
    if (paramInt == 1282) {
      paramString1 = ajya.a(2131705544);
    }
    bcql.a(this.a, 1, paramString1, 0).b(this.a.getTitleBarHeight());
  }
  ...
  public void a(boolean paramBoolean, byte[] paramArrayOfByte, int paramInt, String paramString)
  {
    ...
    if ((paramBoolean) && (paramInt == 0))
    {
      ...
      bcql.a(this.a, 2, ajya.a(2131705543), 0).b(this.a.getTitleBarHeight());
      this.a.setResult(-1);
      this.a.finish();
      return;
    }
    paramArrayOfByte = ajya.a(2131705537);
    if (paramInt == 1288) {
      paramArrayOfByte = ajya.a(2131705541);
    }
    bcql.a(this.a, 1, paramArrayOfByte, 0).b(this.a.getTitleBarHeight());
  }
}
