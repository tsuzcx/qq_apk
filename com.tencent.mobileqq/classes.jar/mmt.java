...
public final class mmt
  implements Runnable
{
  public mmt(String paramString1, String paramString2, String paramString3, FastWebRequestUtil.ResponseCallback paramResponseCallback) {}
  ...
  public void run()
  {
    ...
    try
    {
      ...
      if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
      {
        ...
        ((Map)localObject3).put("mqv", "7.6.0");
        ...
        ((JSONObject)localObject1).put("c_version", "7.6.0".replace(".", ""));
