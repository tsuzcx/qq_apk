  ...
  implements DialogInterface.OnCancelListener, View.OnClickListener
{
  ...
  public bfes(Context paramContext)
  {
      ...
      for (;;)
      {
        for (;;)
        {
          ...
          else
          {
            try
            {
              localField.set(localNumberPicker, new ColorDrawable(bfgh.a("#3CB371")));
              i += 1;
            }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, bfeu parambfeu)
  {
    this.jdField_a_of_type_AndroidWidgetDatePicker.init(paramInt1, paramInt2, paramInt3, new bfet(this));
    this.jdField_a_of_type_Bfeu = parambfeu;
  }
  ...
  public void onCancel(DialogInterface paramDialogInterface)
  {
    if (this.jdField_a_of_type_Bfeu != null) {
      this.jdField_a_of_type_Bfeu.onDateCancel();
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    {
      this.jdField_a_of_type_Bfeu.onDateConfirm(String.valueOf(this.jdField_a_of_type_Int), paramView, str);
      a();
      return;
