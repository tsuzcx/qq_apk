  ...
  implements bfer
{
  ...
  public static bfer a(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("cooperation.qappcenter.remote.IServiceHandler");
    if ((localIInterface != null) && ((localIInterface instanceof bfer))) {
      return (bfer)localIInterface;
    }
    return new bfet(paramIBinder);
  }
