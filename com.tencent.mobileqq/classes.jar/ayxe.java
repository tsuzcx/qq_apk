  ...
  extends MSFServlet
{
  ...
  public static void a(int paramInt, String paramString1, String paramString2, String paramString3, BusinessObserver paramBusinessObserver)
  {
    try
    {
      ...
      a("https://graph.qq.com/face/if_proxy", "application/json", localJSONObject.toString(), new ayxf(paramBusinessObserver));
      return;
    }
  ...
  private static void a(QQAppInterface paramQQAppInterface, int paramInt1, String paramString, int paramInt2, byte[] paramArrayOfByte, BusinessObserver paramBusinessObserver)
  {
    ...
    paramArrayOfByte = new NewIntent(paramQQAppInterface.getApp(), ayxe.class);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, avqt paramavqt)
  {
    ...
    for (;;)
    {
      ...
      localObject = new NewIntent(paramQQAppInterface.getApp(), ayxe.class);
      ((NewIntent)localObject).setObserver(paramavqt);
  ...
  public static void a(String paramString1, long paramLong, String paramString2, BusinessObserver paramBusinessObserver)
  {
    try
    {
      ...
      a("https://graph.qq.com/face/appconf", "application/json", localJSONObject.toString(), new ayxg(paramBusinessObserver));
      return;
    }
    catch (JSONException paramString1)
    {
  ...
  private static void a(String paramString1, String paramString2, String paramString3, ayxi paramayxi)
  {
    ThreadManager.getNetExcutor().execute(new LoginVerifyServlet.3(paramString1, paramString2, paramString3, paramayxi));
  }
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (localObject2 = bdku.b(paramFromServiceMsg.getWupBuffer());; localObject2 = null)
    {
