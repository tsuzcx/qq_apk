...
import java.util.HashMap<Ljava.lang.String;Layxd;>;
...
public class ayxe
  extends QIPCModule
{
  public static volatile ayxe a;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new ayxh(this);
  private String jdField_a_of_type_JavaLangString;
  private HashMap<String, HashMap<String, ayxd>> jdField_a_of_type_JavaUtilHashMap;
  ...
  private ayxe()
  {
    ...
    return;
    label105:
    QIPCClientHelper.getInstance().getClient().connect(new ayxf(this));
    QIPCClientHelper.getInstance().getClient().addListener(new ayxg(this));
  ...
  public static ayxe a()
  {
    if (jdField_a_of_type_Ayxe == null) {}
    try
    {
      if (jdField_a_of_type_Ayxe == null) {
        jdField_a_of_type_Ayxe = new ayxe();
      }
      return jdField_a_of_type_Ayxe;
    }
    finally {}
  }
  ...
  private String a()
  {
    ...
    String str2 = String.valueOf(bbev.a(localContext));
    String str1 = str2;
    if (!bbjw.a(str2))
    {
      str1 = str2;
      if (str2.equals(String.valueOf(1))) {
        str1 = avbu.a(localContext);
      }
    }
    return str1;
  }
  ...
  public static String a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      localObject1 = ayui.a(paramString1, (String)localObject1);
      return localObject1;
      label68:
  ...
  public static String a(HashMap<String, HashMap<String, ayxd>> paramHashMap)
  {
    ...
    try
    {
      ...
      while (paramHashMap.hasNext())
      {
        ...
        localJSONObject.put("domain_map", ayxd.a((HashMap)localObject));
  ...
  private ArrayList<ayxi> a(ArrayList<ayxi> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          if (((ayxi)((Iterator)localObject).next()).b <= 0) {
            continue;
          }
  ...
  public static HashMap<String, HashMap<String, ayxd>> a(String paramString)
  {
    if (paramString == null) {}
    do
    {
      ...
      try
      {
        ...
        while (i < paramString.length())
        {
          ...
          localObject = ayxd.a(((JSONObject)localObject).getString("domain_map"));
          if (localObject != null) {
  ...
  private static HashMap<String, ayxd> a(List<DomainIp.iplistInfo> paramList, HashMap<String, ayxd> paramHashMap)
  {
    if (paramList == null) {}
    Object localObject1;
    String str;
    ...
    do
    {
      ...
      for (;;)
      {
        paramHashMap = (HashMap<String, ayxd>)localObject1;
    ...
    {
      paramList = (ayxd)((HashMap)localObject1).get(str);
      if (paramList.a != null) {
        break label392;
      }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (paramHashMap.hasNext())
        {
          ...
          ayxi localayxi = new ayxi();
          localayxi.jdField_a_of_type_JavaLangString = ((DomainIp.ServerList)localObject2).string_IP.get();
          localayxi.jdField_a_of_type_Int = ((DomainIp.ServerList)localObject2).uint32_Port.get();
          localayxi.c = i;
          paramList.a.add(localayxi);
          if (QLog.isColorLevel())
          {
            QLog.d("InnerDns", 2, "onDomainServerListUpdate type=" + i + " d:" + str + " " + localayxi.jdField_a_of_type_JavaLangString + " " + localayxi.jdField_a_of_type_Int);
            continue;
            paramList = new ayxd(str, new ArrayList());
            break;
          }
        }
      }
  ...
  public ArrayList<String> a(String paramString, int paramInt1, boolean paramBoolean, int paramInt2)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localObject = a(((ayxd)((HashMap)localObject).get(paramString)).a);
        if ((localObject != null) && (((ArrayList)localObject).size() > 0))
        {
          if (((ayxi)((ArrayList)localObject).get(0)).b <= 0) {
            break label716;
          }
          i = 1;
          continue;
          ...
          axrl.a(BaseApplication.getContext()).a(null, "actDnsReq", paramBoolean, BaseApplicationImpl.sProcessId, 0L, (HashMap)localObject, "");
      ...
      do
      {
        ...
        localayxi = (ayxi)localIterator.next();
      } while (localayxi.c != paramInt2);
      String str = localayxi.jdField_a_of_type_JavaLangString;
      if ((localayxi.c == 1) && (localayxi.jdField_a_of_type_Int != 80)) {
        localObject = str + ":" + localayxi.jdField_a_of_type_Int;
      }
      for (;;)
      {
  ...
  public void a()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 44	ayxe:jdField_a_of_type_Boolean	Z
    //   4: ifeq +43 -> 47
    //   7: ldc 2
    //   9: monitorenter
    ...
    //   24: ldc 56
    //   26: aload_0
    //   27: getfield 72	ayxe:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   30: invokestatic 418	ayxe:a	(Ljava/util/HashMap;)Ljava/lang/String;
    ...
    //   50: aload_0
    //   51: getfield 36	ayxe:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
  ...
  public void a(String paramString1, String paramString2, int paramInt)
  {
    ...
    int i;
    boolean bool1;
    if ((bbjw.a(paramString1)) || (bbjw.a(paramString2)) || (paramString1.equals(paramString2)))
    {
      i = 40;
      bool1 = false;
    }
    ...
    for (;;)
    {
      ...
      ((HashMap)localObject).put("param_FailCode", String.valueOf(i));
      axrl.a(BaseApplication.getContext()).a(null, "actDnsBadIp", bool1, BaseApplicationImpl.sProcessId, 0L, (HashMap)localObject, "");
      return;
      localObject = a();
      if ((this.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_JavaUtilHashMap.containsKey(localObject)))
      {
        try
        {
          ...
          {
            localObject = (ayxd)((HashMap)localObject).get(paramString1);
            if (((ayxd)localObject).a != null)
            {
              localObject = ((ayxd)localObject).a.iterator();
              while (((Iterator)localObject).hasNext())
              {
                ayxi localayxi = (ayxi)((Iterator)localObject).next();
                if (paramString2.equals(localayxi.jdField_a_of_type_JavaLangString)) {
                  localayxi.b += 1;
                }
              }
            }
  ...
  public void b()
  {
    if ((BaseApplicationImpl.sProcessId == 1) && (!this.c))
    {
      ...
      localQQAppInterface.startServlet(new NewIntent(localQQAppInterface.getApp(), axbx.class));
      this.c = true;
    }
  }
