  ...
  implements View.OnClickListener
{
  ...
  public void a(int paramInt1, int paramInt2)
  {
    if (Build.VERSION.SDK_INT >= 21)
    {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer.setOutlineProvider(new bcsy(paramInt2));
      ...
      {
        this.jdField_a_of_type_AndroidWidgetFrameLayout.setOutlineProvider(new bcsy(paramInt1));
  ...
  public void a(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setId(2131373163);
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setBackgroundColor(paramContext.getResources().getColor(2131167087));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate(paramContext, 2131561189, null));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373150));
    this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(ajyc.a(2131704624));
  ...
  {
    if ((paramInt != 1) || (this.jdField_a_of_type_Bctp == null) || (!this.jdField_a_of_type_Bctp.a()))
    {
  ...
  public void onClick(View paramView)
  {
    ...
    while ((i != 2131373156) || (this.jdField_a_of_type_Bctp == null)) {
      return;
    }
    this.jdField_a_of_type_Bctp.a(this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer.a(), this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer.b());
  }
}
