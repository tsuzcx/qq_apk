  ...
  implements bizn
{
  ...
  public acxn(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          localObject2 = acxm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationInfo().sourceDir);
    ...
    for (int i = 0;; i = 1)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          localObject1 = new bizh(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext(), (bize)localObject1);
          if (localObject1 == null) {
            break;
          }
          localObject1 = (bizm)((bizh)localObject1).a("sig_check");
          if (localObject1 == null) {
            break;
          }
          ((bizm)localObject1).a(this);
          ((bizm)localObject1).a(((JSONObject)localObject4).toString());
          return;
        }
