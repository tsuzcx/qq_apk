...
public class arif
{
  ...
  public static arif a(JSONObject paramJSONObject)
  {
    if (paramJSONObject != null) {
      for (;;)
      {
        try
        {
          localObject = new arif();
          try
          {
            if (paramJSONObject.has("tip"))
            {
              ((arif)localObject).a = paramJSONObject.getString("tip");
              if (!paramJSONObject.has("key_word")) {
                continue;
              }
              ((arif)localObject).b = paramJSONObject.getString("key_word");
              if (!paramJSONObject.has("jump_url")) {
                continue;
              }
              ((arif)localObject).c = paramJSONObject.getString("jump_url");
              return localObject;
            }
            ((arif)localObject).a = "";
            continue;
