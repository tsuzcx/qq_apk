...
public class uqe
  implements View.OnClickListener, uql, uqs
{
  ...
  private uor jdField_a_of_type_Uor;
  private uqi jdField_a_of_type_Uqi;
  private uqj jdField_a_of_type_Uqj;
  ...
  public uqe(Context paramContext, View paramView, upp paramupp, boolean paramBoolean, int paramInt, uqi paramuqi)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem = paramupp.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem;
    this.jdField_b_of_type_Int = paramInt;
    this.jdField_a_of_type_Uqi = paramuqi;
  ...
  public static CommentEntry a(int paramInt)
  {
    ...
    localCommentEntry.content = (ajya.a(2131703142) + vzl.a(paramInt) + ajya.a(2131703141));
  ...
  private CommentEntry a(String paramString)
  {
    ...
    localCommentEntry.authorUin = tsr.a().c();
    ...
    if (this.jdField_a_of_type_Uqj.jdField_a_of_type_ComTencentBizQqstoryDatabaseCommentEntry != null)
    {
      localCommentEntry.replierUnionId = this.jdField_a_of_type_Uqj.jdField_a_of_type_ComTencentBizQqstoryDatabaseCommentEntry.authorUnionId;
      localCommentEntry.replierName = this.jdField_a_of_type_Uqj.jdField_a_of_type_ComTencentBizQqstoryDatabaseCommentEntry.authorName;
      localCommentEntry.replierRole = this.jdField_a_of_type_Uqj.jdField_a_of_type_ComTencentBizQqstoryDatabaseCommentEntry.authorRole;
    }
    if (((Integer)((tcs)tcz.a(10)).b("qqstory_i_am_vip", Integer.valueOf(-1))).intValue() == 1) {
      localCommentEntry.authorRole = 2;
    }
    ved.a("Q.qqstory.detail.DetailCommentHelper", "create comment entry: %s.", localCommentEntry.toString());
    return localCommentEntry;
  }
  ...
  public static CommentEntry a(String paramString1, int paramInt1, long paramLong, int paramInt2, String paramString2)
  {
    ...
    ved.a("Q.qqstory.detail.DetailCommentHelper", "create fake vote comment entry: %s.", localCommentEntry.toString());
    return localCommentEntry;
  }
  ...
  public static CommentEntry a(String paramString1, int paramInt, long paramLong, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    {
      ved.e("Q.qqstory.detail.DetailCommentHelper", "createGamePKCommentEntry styles error. styles=%s", new Object[] { paramString6 });
    }
    return paramString1;
  }
  ...
  {
    boolean bool = true;
    this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setOnEditorActionListener(new uqf(this));
    if (this.jdField_a_of_type_Boolean) {
      if ((this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem.feedId)))
      {
        ...
        this.jdField_a_of_type_Uor = new uor(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem.feedId, "2_", 10000, bool);
        this.jdField_a_of_type_ComTencentWidgetXEditTextEx.addTextChangedListener(this.jdField_a_of_type_Uor);
      }
    }
    for (;;)
    {
      this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setOnTouchListener(new uqg(this));
      this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setOnFocusChangeListener(new uqh(this));
      return;
      label136:
      bool = false;
      break;
      ...
      this.jdField_a_of_type_Uor.jdField_a_of_type_Boolean = bool;
    }
  }
  
  private void b(CommentEntry paramCommentEntry, int paramInt)
  {
    if (this.jdField_a_of_type_Uqj.a(paramCommentEntry))
    {
      this.jdField_a_of_type_Uqj.a(paramCommentEntry, paramInt);
      d(false);
    }
    a(2, new String[] { paramCommentEntry.authorName, paramCommentEntry.authorUnionId, String.valueOf(paramCommentEntry.authorUin) });
    this.jdField_a_of_type_Uqp.a(true);
    tau.a().a = "4";
  }
  ...
  private void f()
  {
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131364656);
    ...
    this.jdField_a_of_type_Uqp = new uqp(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidViewView, this);
    ...
    for (this.jdField_a_of_type_Uqo = new uqn(this.jdField_a_of_type_AndroidContentContext, this.jdField_b_of_type_Int, this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem, this);; this.jdField_a_of_type_Uqo = new uqk(this.jdField_a_of_type_AndroidContentContext, this.jdField_b_of_type_Int, this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem, this))
    {
      this.jdField_a_of_type_Uqj = new uqj(this);
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Uqo.a())
    {
      tau.a().a = "1";
      a(true);
    }
    int i = vei.b(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem);
    ...
    {
      vei.a("home_page", "clk_reply", vei.a(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem), 0, new String[] { String.valueOf(i), vei.a(this.jdField_b_of_type_Int), this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem.feedId, str });
      return;
    }
  }
  ...
  {
    this.jdField_a_of_type_Uqi.b(paramInt);
    paramInt = vei.a(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem);
    if (this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem.getOwner().isMe()) {}
    for (String str = "1";; str = "2")
    {
      vei.a("play_video", "del_reply", paramInt, 0, new String[] { str, vei.a(this.jdField_b_of_type_Int), "", this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem.feedId });
      return;
    }
  }
  ...
  public void a(int paramInt, String... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      return;
      this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setHint(ajya.a(2131703139));
      ...
      continue;
      this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setHint(ajya.a(2131703143));
      this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setEnabled(true);
      ...
      if ((paramVarArgs != null) && (paramVarArgs.length >= 3))
      {
        ...
        if (TextUtils.isEmpty(str2))
        {
          ...
          str1 = upw.a(paramVarArgs[1], paramVarArgs[2], bool1, str1);
        }
        this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setHint(ajya.a(2131703140) + str1 + "：");
        this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setEnabled(true);
        this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setFocusable(true);
        this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setFocusableInTouchMode(true);
      }
  ...
  {
    tsr.a(this.jdField_a_of_type_AndroidContentContext, paramCommentEntry);
    vei.a("play_video", "report_reply", vei.a(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem), 0, new String[] { "", vei.a(this.jdField_b_of_type_Int), "", this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem.feedId });
  }
  ...
  {
    if (this.jdField_a_of_type_Uqo.a(paramCommentEntry, paramInt1, paramInt2)) {
  ...
  {
    this.jdField_a_of_type_Uqp.a(paramBoolean);
  }
  ...
  public void b(CommentEntry paramCommentEntry)
  {
    ...
    this.jdField_a_of_type_Uqi.b(paramCommentEntry);
    paramCommentEntry = "";
    ...
    int i = vei.a(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem);
    if (this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem.getOwner().isMe()) {}
    for (String str = "1";; str = "2")
    {
      vei.a("play_video", "retry_reply", i, 0, new String[] { str, vei.a(this.jdField_b_of_type_Int), paramCommentEntry, this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem.feedId });
      return;
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Uqo.b(paramCommentEntry, paramInt1, paramInt2)) {
      b(paramCommentEntry, paramInt1);
    }
  }
  ...
  {
    this.jdField_a_of_type_Uqi.c();
    if (!paramBoolean)
    {
      tau.a().a = "2";
      this.jdField_a_of_type_Uqi.N_();
      return;
    }
    if (this.jdField_a_of_type_Uqj.jdField_a_of_type_Int != -1)
    {
      this.jdField_a_of_type_Uqi.f_(this.jdField_a_of_type_Uqj.jdField_a_of_type_Int);
      return;
    }
    this.jdField_a_of_type_Uqi.N_();
  }
  ...
  public boolean b()
  {
    ved.c("Q.qqstory.detail.DetailCommentHelper", "on emoji button click.");
    tau.a().a = "2";
    int i = vei.a(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem);
    if (this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem.getOwner().isMe()) {}
    for (String str = "1";; str = "2")
    {
      vei.a("home_page", "switch_face", i, 0, new String[] { str, vei.a(this.jdField_b_of_type_Int), "", this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem.feedId });
  ...
  public void c(CommentEntry paramCommentEntry)
  {
    try
    {
      ...
      if (aylc.a(paramCommentEntry))
      {
        paramCommentEntry = axau.b(paramCommentEntry);
        ...
        {
          vei.a("home_page", "copy_reply", i, 0, new String[] { paramCommentEntry, vei.a(this.jdField_b_of_type_Int), "", this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem.feedId });
          return;
        }
      }
    }
  ...
  public void c(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      this.jdField_a_of_type_Uqi.d();
      uqj.a(this.jdField_a_of_type_Uqj);
      a(1, new String[0]);
    }
  }
  ...
  public void d()
  {
    if (!bbfj.d(this.jdField_a_of_type_AndroidContentContext)) {
      bcql.a(BaseApplication.getContext(), 1, ajya.a(2131703144), 0).a();
    }
    String str;
    do
    {
    ...
    ved.a("Q.qqstory.detail.DetailCommentHelper", "comment content is %s when click send button.", str);
    Object localObject = str;
    if (aylc.a(str)) {
      localObject = axau.a(str);
    }
    localObject = a((String)localObject);
    this.jdField_a_of_type_Uqi.a((CommentEntry)localObject);
    d(true);
    c();
    uqj.a(this.jdField_a_of_type_Uqj);
    a(1, new String[0]);
