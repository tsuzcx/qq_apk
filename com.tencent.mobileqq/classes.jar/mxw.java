...
public class mxw
{
  ...
  public mxw(QQAppInterface paramQQAppInterface)
  {
  ...
  private userinfo.UserInfo a(SosoInterface.SosoLbsInfo paramSosoLbsInfo)
  {
    ...
    try
    {
      ...
      paramSosoLbsInfo.str_app_version.set(bbdh.c());
      localUserInfo.app_info.set(paramSosoLbsInfo);
      localUserInfo.bytes_client_version.set(ByteStringMicro.copyFromUtf8("8.3.0"));
  ...
  private void a(String paramString, byte[] paramArrayOfByte, BusinessObserver paramBusinessObserver)
  {
    ...
    NewIntent localNewIntent = new NewIntent(this.a.getApplication(), mxe.class);
  ...
  private void a(userinfo.UserInfo paramUserInfo, mxx parammxx)
  {
    ...
    a("SearchAsmTab.GetPopClassific", localReqBody.toByteArray(), new mxy(parammxx, this.a, 1));
  }
  
  public void a(mxx parammxx)
  {
    try
    {
      a(a(null), parammxx);
