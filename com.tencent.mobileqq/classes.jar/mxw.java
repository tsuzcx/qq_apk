...
public class mxw
{
  ...
  public static mxw a(String paramString1, String paramString2, String paramString3)
  {
    boolean bool = true;
    mxw localmxw = new mxw();
    localmxw.jdField_a_of_type_JavaLangString = paramString2;
    localmxw.jdField_b_of_type_JavaLangString = paramString3;
    for (;;)
    {
      try
      {
        paramString1 = new JSONObject(paramString1);
        localmxw.jdField_c_of_type_JavaLangString = paramString1.optString("str_adId", "");
        localmxw.jdField_d_of_type_JavaLangString = paramString1.optString("str_adPosId", "");
        localmxw.jdField_b_of_type_Boolean = paramString1.optBoolean("bool_bannerShow", false);
        localmxw.jdField_c_of_type_Int = paramString1.optInt("uint32_bannertype", 0);
        localmxw.jdField_d_of_type_Int = paramString1.optInt("uint32_jumpType", 0);
        localmxw.n = paramString1.optString("str_jumpUrl", "");
        localmxw.jdField_k_of_type_JavaLangString = paramString1.optString("str_appId", "");
        localmxw.jdField_l_of_type_JavaLangString = paramString1.optString("str_packagename", "");
        localmxw.jdField_i_of_type_JavaLangString = paramString1.optString("str_androidDownloadUrl", "");
        localmxw.jdField_f_of_type_JavaLangString = paramString1.optString("str_bannerImgUrl", "");
        localmxw.jdField_g_of_type_JavaLangString = paramString1.optString("str_bannerText", "");
        localmxw.jdField_h_of_type_JavaLangString = paramString1.optString("str_bannerButtonText", "");
        localmxw.jdField_c_of_type_Boolean = paramString1.optBoolean("bool_silentDownload", false);
        localmxw.m = paramString1.optString("str_appName", "");
        localmxw.jdField_e_of_type_JavaLangString = paramString1.optString("str_reportLink", "");
        if ((!TextUtils.isEmpty(localmxw.jdField_e_of_type_JavaLangString)) && (!localmxw.jdField_e_of_type_JavaLangString.contains("https"))) {
          localmxw.jdField_e_of_type_JavaLangString = localmxw.jdField_e_of_type_JavaLangString.replace("http", "https");
        }
        localmxw.jdField_a_of_type_Boolean = paramString1.optBoolean("bool_horizontalVideo", false);
        localmxw.jdField_a_of_type_Int = paramString1.optInt("uint32_audioFadeinDuration", 5);
        localmxw.jdField_b_of_type_Int = paramString1.optInt("uint32_audioSwitchType", 0);
        localmxw.jdField_e_of_type_Int = paramString1.optInt("uint32_preDownloadType", 0);
        localmxw.jdField_e_of_type_Int = PAAdPreloadTask.checkNetworkType(localmxw.jdField_e_of_type_Int);
        localmxw.o = paramString1.optString("str_openJumpUrlGuide", "");
        localmxw.jdField_j_of_type_JavaLangString = paramString1.optString("str_myappDownloadUrl", "");
        localmxw.p = paramString1.optString("str_jumpTypeParams", "");
        localmxw.jdField_h_of_type_Int = paramString1.optInt("uint32_scrollUpToJump", 0);
        if (localmxw.jdField_h_of_type_Int == 1)
        {
          localmxw.jdField_d_of_type_Boolean = bool;
          localmxw.jdField_i_of_type_Int = paramString1.optInt("uint32_controlVariable", 0);
          localmxw.jdField_j_of_type_Int = paramString1.optInt("uint32_control_plugin_time", 0);
          localmxw.jdField_k_of_type_Int = paramString1.optInt("uint32_autoJump", 0);
          if (localmxw.jdField_d_of_type_Int >= 3)
          {
            bool = TextUtils.isEmpty(localmxw.p);
            if (bool) {}
          }
          try
          {
            paramString2 = new JSONObject(localmxw.p);
            localmxw.jdField_g_of_type_Int = paramString2.optInt("class_id", -1);
            localmxw.q = paramString2.optString("class_name", "");
            localmxw.jdField_f_of_type_Int = paramString2.optInt("pendant_id", -1);
            localmxw.r = paramString1.optString("str_clickLink", "");
            localmxw.jdField_l_of_type_Int = paramString1.optInt("uint32_monitorType", 0);
            localmxw.s = paramString1.optString("str_share_nick", "");
            localmxw.t = paramString1.optString("str_share_ad_head_url", "");
            localmxw.u = paramString1.optString("str_share_ad_brief", "");
            localmxw.v = paramString1.optString("str_share_ad_txt", "");
            localmxw.w = paramString1.optString("str_share_ad_icon_url", "");
            localmxw.x = paramString1.optString("str_share_jump_url", "");
            return localmxw;
          }
  ...
  public static mxw a(submsgtype0xf9.MsgCommonData paramMsgCommonData, String paramString1, String paramString2)
  {
    boolean bool = true;
    mxw localmxw = new mxw();
    localmxw.jdField_a_of_type_JavaLangString = paramString1;
    localmxw.jdField_b_of_type_JavaLangString = paramString2;
    if (paramMsgCommonData.str_adId.has()) {
      localmxw.jdField_c_of_type_JavaLangString = paramMsgCommonData.str_adId.get();
    }
    if (paramMsgCommonData.str_adPosId.has()) {
      localmxw.jdField_d_of_type_JavaLangString = paramMsgCommonData.str_adPosId.get();
    }
    if (paramMsgCommonData.bool_bannerShow.has()) {
      localmxw.jdField_b_of_type_Boolean = paramMsgCommonData.bool_bannerShow.get();
    }
    if (paramMsgCommonData.uint32_bannertype.has()) {
      localmxw.jdField_c_of_type_Int = paramMsgCommonData.uint32_bannertype.get();
    }
    if (paramMsgCommonData.uint32_jumpType.has()) {
      localmxw.jdField_d_of_type_Int = paramMsgCommonData.uint32_jumpType.get();
    }
    if (paramMsgCommonData.str_jumpUrl.has()) {
      localmxw.n = paramMsgCommonData.str_jumpUrl.get();
    }
    if (paramMsgCommonData.str_appId.has()) {
      localmxw.jdField_k_of_type_JavaLangString = paramMsgCommonData.str_appId.get();
    }
    if (paramMsgCommonData.str_packagename.has()) {
      localmxw.jdField_l_of_type_JavaLangString = paramMsgCommonData.str_packagename.get();
    }
    if (paramMsgCommonData.str_androidDownloadUrl.has()) {
      localmxw.jdField_i_of_type_JavaLangString = paramMsgCommonData.str_androidDownloadUrl.get();
    }
    if (paramMsgCommonData.str_bannerImgUrl.has()) {
      localmxw.jdField_f_of_type_JavaLangString = paramMsgCommonData.str_bannerImgUrl.get();
    }
    if (paramMsgCommonData.str_bannerText.has()) {
      localmxw.jdField_g_of_type_JavaLangString = paramMsgCommonData.str_bannerText.get();
    }
    if (paramMsgCommonData.str_bannerButtonText.has()) {
      localmxw.jdField_h_of_type_JavaLangString = paramMsgCommonData.str_bannerButtonText.get();
    }
    if (paramMsgCommonData.bool_silentDownload.has()) {
      localmxw.jdField_c_of_type_Boolean = paramMsgCommonData.bool_silentDownload.get();
    }
    if (paramMsgCommonData.str_appName.has()) {
      localmxw.m = paramMsgCommonData.str_appName.get();
    }
    if (paramMsgCommonData.str_reportLink.has())
    {
      localmxw.jdField_e_of_type_JavaLangString = paramMsgCommonData.str_reportLink.get();
      if ((!TextUtils.isEmpty(localmxw.jdField_e_of_type_JavaLangString)) && (!localmxw.jdField_e_of_type_JavaLangString.contains("https"))) {
        localmxw.jdField_e_of_type_JavaLangString = localmxw.jdField_e_of_type_JavaLangString.replace("http", "https");
      }
    }
    if (paramMsgCommonData.bool_horizontalVideo.has()) {
      localmxw.jdField_a_of_type_Boolean = paramMsgCommonData.bool_horizontalVideo.get();
    }
    if (paramMsgCommonData.uint32_audioFadeinDuration.has()) {
      localmxw.jdField_a_of_type_Int = paramMsgCommonData.uint32_audioFadeinDuration.get();
    }
    if (paramMsgCommonData.uint32_audioSwitchType.has()) {
      localmxw.jdField_b_of_type_Int = paramMsgCommonData.uint32_audioSwitchType.get();
    }
    if (paramMsgCommonData.uint32_preDownloadType.has())
    {
      localmxw.jdField_e_of_type_Int = paramMsgCommonData.uint32_preDownloadType.get();
      localmxw.jdField_e_of_type_Int = PAAdPreloadTask.checkNetworkType(localmxw.jdField_e_of_type_Int);
    }
    if (paramMsgCommonData.str_openJumpUrlGuide.has()) {
      localmxw.o = paramMsgCommonData.str_openJumpUrlGuide.get();
    }
    if (paramMsgCommonData.str_myappDownloadUrl.has()) {
      localmxw.jdField_j_of_type_JavaLangString = paramMsgCommonData.str_myappDownloadUrl.get();
    }
    if (paramMsgCommonData.str_jumpTypeParams.has()) {
      localmxw.p = paramMsgCommonData.str_jumpTypeParams.get();
    }
    if (paramMsgCommonData.uint32_scrollUpToJump.has())
    {
      ...
      localmxw.jdField_h_of_type_Int = paramMsgCommonData.uint32_scrollUpToJump.get();
      if (localmxw.jdField_h_of_type_Int != 1) {
        break label1112;
      }
    }
    for (;;)
    {
      ...
      if (paramMsgCommonData.uint32_controlVariable.has())
      {
        ...
        localmxw.jdField_i_of_type_Int = paramMsgCommonData.uint32_controlVariable.get();
      }
      if (paramMsgCommonData.uint32_control_plugin_time.has())
      {
        ...
        localmxw.jdField_j_of_type_Int = paramMsgCommonData.uint32_control_plugin_time.get();
      }
      if (paramMsgCommonData.uint32_autoJump.has())
      {
        ...
        localmxw.jdField_k_of_type_Int = paramMsgCommonData.uint32_autoJump.get();
      }
      if ((localmxw.jdField_d_of_type_Int >= 3) && (!TextUtils.isEmpty(localmxw.p))) {}
      try
      {
        paramString1 = new JSONObject(localmxw.p);
        localmxw.jdField_g_of_type_Int = paramString1.optInt("class_id", -1);
        localmxw.q = paramString1.optString("class_name", "");
        localmxw.jdField_f_of_type_Int = paramString1.optInt("pendant_id", -1);
        if (paramMsgCommonData.str_clickLink.has())
        {
          localmxw.r = paramMsgCommonData.str_clickLink.get();
          if ((!TextUtils.isEmpty(localmxw.r)) && (!localmxw.r.startsWith("https://"))) {
            localmxw.r = localmxw.r.replace("http://", "https://");
          }
        }
        if (paramMsgCommonData.uint32_monitorType.has()) {
          localmxw.jdField_l_of_type_Int = paramMsgCommonData.uint32_monitorType.get();
        }
        if (paramMsgCommonData.str_share_nick.has()) {
          localmxw.s = paramMsgCommonData.str_share_nick.get();
        }
        if (paramMsgCommonData.str_share_ad_head_url.has()) {
          localmxw.t = paramMsgCommonData.str_share_ad_head_url.get();
        }
        if (paramMsgCommonData.str_share_ad_brief.has()) {
          localmxw.u = paramMsgCommonData.str_share_ad_brief.get();
        }
        if (paramMsgCommonData.str_share_ad_txt.has()) {
          localmxw.v = paramMsgCommonData.str_share_ad_txt.get();
        }
        if (paramMsgCommonData.str_share_ad_icon_url.has()) {
          localmxw.w = paramMsgCommonData.str_share_ad_icon_url.get();
        }
        if (paramMsgCommonData.str_share_jump_url.has()) {
          localmxw.x = paramMsgCommonData.str_share_jump_url.get();
        }
        return localmxw;
        label1112:
        bool = false;
