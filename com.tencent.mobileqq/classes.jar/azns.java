...
{
  private azns(PortalManager paramPortalManager) {}
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    case 1011: 
      ...
      localObject = aznv.b(paramIntent);
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(paramContext))
      {
        paramIntent = aznv.b(paramContext);
        localObject = PortalManager.a(this.a).getFaceBitmap(paramIntent, false);
        if (localObject != null)
        {
          paramIntent = aznv.a((Bitmap)localObject);
        ...
        localObject = new aznr();
        ((aznr)localObject).jdField_a_of_type_JavaLangString = paramContext;
        ((aznr)localObject).b = k;
        ((aznr)localObject).jdField_a_of_type_Int = m;
