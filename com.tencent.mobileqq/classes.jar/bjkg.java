...
{
  public bjkg(AuthorityActivity paramAuthorityActivity, boolean paramBoolean) {}
  
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    QLog.i("AuthorityActivity", 1, "getAppInfo observer onReceive isSuccess = " + paramBoolean);
    avcw.a("KEY_GET_APP_INFO_REQUEST", this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.jdField_a_of_type_Bjzb, paramBoolean);
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Boolean) {
          localObject = bjzy.b(arrayOfByte, this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.jdField_a_of_type_Bjzb);
        }
        if (localObject == null) {
          break;
        }
