...
{
  private static final String jdField_a_of_type_JavaLangString = bpeb.class.getSimpleName();
  ...
  private bped jdField_a_of_type_Bped;
  ...
  public bpeb(int paramInt1, int paramInt2)
  {
  ...
  private void d()
  {
    this.jdField_a_of_type_Bped = new bped();
    this.jdField_a_of_type_Bped.a();
    if (this.jdField_b_of_type_Boolean) {
      Log.d(jdField_a_of_type_JavaLangString, "textureID=" + this.jdField_a_of_type_Bped.a());
    }
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture = new SurfaceTexture(this.jdField_a_of_type_Bped.a());
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Bped = null;
  ...
  {
    this.jdField_a_of_type_Bped.a(this.jdField_a_of_type_AndroidGraphicsSurfaceTexture, paramBoolean);
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Bped.a("before updateTexImage");
