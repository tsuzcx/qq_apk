...
public class aisa
{
  ...
  protected static alwk a;
  public static Handler a;
  public static String a;
  public static WeakReference<aisg> a;
  public static int b;
  ...
  static
  {
    ...
    jdField_a_of_type_AndroidOsHandler = new aisb(Looper.myLooper());
    jdField_a_of_type_Alwk = new alwk(jdField_a_of_type_AndroidOsHandler);
  }
  ...
  public static ArrayList<PfaFriend> a()
  {
    ...
    do
    {
      ...
      localObject2 = ((amjk)localObject1).a(true);
  ...
  public static HashMap<String, Object> a(aisg paramaisg, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramaisg);
    ...
    paramaisg = new HashMap();
    if (jdField_a_of_type_WalletPfaFriendRsp == null)
    {
      paramaisg.put(jdField_a_of_type_JavaLangString, a());
    ...
    for (;;)
    {
      paramaisg.put(jdField_b_of_type_JavaLangString, jdField_a_of_type_WalletPfaFriendRsp.vecPfaMsg);
      if (!paramBoolean) {
        break;
      }
      ...
      return paramaisg;
      label142:
      paramaisg.put(jdField_a_of_type_JavaLangString, jdField_a_of_type_WalletPfaFriendRsp.vecRec);
    }
  }
  ...
  public static void a(int paramInt1, int paramInt2)
  {
    ...
    localQQAppInterface.addObserver(jdField_a_of_type_Alwk);
    PfaFriendRqt localPfaFriendRqt = new PfaFriendRqt();
    localPfaFriendRqt.mqq_version = bdcb.a(BaseApplicationImpl.getContext());
    if (jdField_a_of_type_WalletPfaFriendRsp != null)
    {
    ...
    for (;;)
    {
      ((alwj)localQQAppInterface.a(42)).a(localPfaFriendRqt);
      return;
  ...
  public static void a(SelectMemberActivity paramSelectMemberActivity, ArrayList<ResultRecord> paramArrayList)
  {
    ...
    Object localObject2 = alpo.a(2131715405);
    ...
    for (localObject2 = (String)localObject1 + "、";; localObject2 = localObject1)
    {
      ...
      {
        QQToast.a(paramSelectMemberActivity, paramSelectMemberActivity.getString(2131720888), 0).a();
        return;
      }
      paramArrayList = new aisc(new WeakReference(paramSelectMemberActivity), localArrayList);
      localObject2 = paramSelectMemberActivity.getIntent().getExtras();
      paramSelectMemberActivity = bdcd.a(paramSelectMemberActivity, (String)localObject1, ((Bundle)localObject2).getString("choose_friend_content"), ((Bundle)localObject2).getString("choose_friend_subcontent"), paramSelectMemberActivity.f, null, paramArrayList, paramArrayList, 36, false);
      azmj.b(ajaf.a(), "P_CliOper", "Vip_pay_mywallet", "", "wallet", "friendpay.selectpage.windowshow", 0, 0, "", "", "", "");
  ...
  public static void a(SelectMemberActivity paramSelectMemberActivity, ArrayList<ResultRecord> paramArrayList, bdhc parambdhc)
  {
    if ((paramSelectMemberActivity == null) || (paramSelectMemberActivity.isFinishing()) || (paramSelectMemberActivity.getIntent() == null) || (paramSelectMemberActivity.getIntent().getExtras() == null)) {}
    ...
    if (parambdhc != null) {
      paramArrayList.putString("choose_friend_feedback", parambdhc.getInputValue());
    }
    parambdhc = new TopayManager.5(null, new WeakReference(paramSelectMemberActivity), localResultReceiver, localArrayList1, localArrayList3);
    b(paramSelectMemberActivity, true);
    paramSelectMemberActivity = Parcel.obtain();
    parambdhc.writeToParcel(paramSelectMemberActivity, 0);
    paramSelectMemberActivity.setDataPosition(0);
    parambdhc = (ResultReceiver)ResultReceiver.CREATOR.createFromParcel(paramSelectMemberActivity);
    paramSelectMemberActivity.recycle();
    paramArrayList.putParcelable("callback", parambdhc);
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (paramQQAppInterface != null) {
      paramQQAppInterface.removeObserver(jdField_a_of_type_Alwk);
    }
  }
  ...
  protected static void a(boolean paramBoolean)
  {
    if (jdField_a_of_type_JavaLangRefWeakReference != null)
    {
      aisg localaisg = (aisg)jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localaisg != null) {
        localaisg.b(paramBoolean);
      }
    }
  }
  ...
  {
    aise localaise = new aise(paramActivity);
    paramList1 = new aisf(paramActivity, paramList1, paramList2);
    paramActivity = bdcd.a(paramActivity, 230, null, alpo.a(2131715406), alpo.a(2131715404), "留在QQ", paramList1, localaise);
