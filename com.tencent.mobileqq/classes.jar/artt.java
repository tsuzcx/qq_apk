...
public class artt
{
  ...
  void a(int paramInt, boolean paramBoolean)
  {
    ...
    if ((!paramBoolean) && (this.jdField_d_of_type_Boolean)) {
      arty.a(this.jdField_a_of_type_Int, this.h, this.e, this.f, this.g, this.jdField_a_of_type_Boolean, this.jdField_b_of_type_Boolean, this.jdField_c_of_type_Boolean);
    }
