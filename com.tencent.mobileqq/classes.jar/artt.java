  ...
  extends andd
{
  ...
  public artt(FMActivity paramFMActivity) {}
  ...
  protected void onOIDB0X899_0_Ret(boolean paramBoolean, long paramLong1, int paramInt1, List<oidb_0x899.memberlist> paramList, long paramLong2, int paramInt2, String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        paramString = ((TroopManager)localObject1).c(this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityFMActivity.g);
      } while ((paramString == null) || (StringUtil.isEmpty(paramString.troopowneruin)));
    ...
    {
      bcef.b(paramString, "P_CliOper", "Grp_files", "", "power", "nopower_upload", 0, 0, (String)localObject1, paramList, "", "");
      FMActivity.f(this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityFMActivity);
      return;
      paramInt1 = 0;
      break;
    }
