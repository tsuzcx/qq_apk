...
public class bmva
{
  ...
  public int a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      StaticLayout localStaticLayout = bmwz.a(localStringBuilder, 0, localStringBuilder.length(), localTextPaint, this.c, Layout.Alignment.ALIGN_NORMAL, 1.0F, 0.0F, false, null, 0, 1);
