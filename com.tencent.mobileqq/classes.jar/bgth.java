  ...
  implements Manager
{
  ...
  {
    paramString = (bgtf)this.jdField_a_of_type_JavaUtilMap.get(paramString);
  ...
  public List<bgtg> a(String paramString)
  {
    paramString = (bgtf)this.jdField_a_of_type_JavaUtilMap.get(paramString);
    if (paramString == null) {
      return null;
  ...
  public void a(String paramString1, int paramInt1, String paramString2, int paramInt2, int paramInt3)
  {
    ...
    bgtf localbgtf2 = (bgtf)this.jdField_a_of_type_JavaUtilMap.get(paramString1);
    bgtf localbgtf1 = localbgtf2;
    if (localbgtf2 == null)
    {
      localbgtf1 = new bgtf();
      this.jdField_a_of_type_JavaUtilMap.put(paramString1, localbgtf1);
    }
    if ((i != 4) || (!TextUtils.isEmpty(paramString2)))
    {
      localbgtf1.jdField_a_of_type_JavaLangString = paramString2;
      localbgtf1.jdField_b_of_type_Int = paramInt3;
    }
    localbgtf1.jdField_a_of_type_Long = (NetConnInfoCenter.getServerTime() + i);
    if (paramInt2 != -1) {
      localbgtf1.jdField_a_of_type_Int = paramInt2;
    }
  }
  ...
  public void a(String paramString1, List<bgtg> paramList, int paramInt1, String paramString2, int paramInt2)
  {
    int i = paramInt1;
    if (paramInt1 <= 0) {
      i = 10;
    ...
    {
      localbgtf1.jdField_a_of_type_JavaLangString = paramString2;
      localbgtf1.jdField_b_of_type_Int = paramInt2;
    }
    if ((paramList != null) && (paramList.size() > 0)) {
      localbgtf1.jdField_a_of_type_JavaUtilList = paramList;
    }
    localbgtf1.jdField_b_of_type_Long = (NetConnInfoCenter.getServerTime() + i);
  }
