  ...
  implements View.OnClickListener
{
  ...
  public awun(String paramString1, String paramString2)
  {
    this.jdField_a_of_type_Int = i;
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      paramView.setLineSpacing(aciy.a(d() * 1.0F / 2.0F, paramView.getResources()), 1.0F);
  ...
  /* Error */
  public awuo a(android.content.res.Resources paramResources)
  {
    // Byte code:
    //   0: new 85	awuo
    //   3: dup
    //   4: invokespecial 209	awuo:<init>	()V
    //   7: astore_1
    //   8: aload_0
    //   9: getfield 211	awun:T	Ljava/lang/String;
    //   12: invokestatic 153	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   15: ifne +151 -> 166
    //   18: aload_1
    //   19: aload_0
    //   20: getfield 211	awun:T	Ljava/lang/String;
    //   23: invokestatic 217	android/graphics/Color:parseColor	(Ljava/lang/String;)I
    //   26: putfield 86	awuo:jdField_a_of_type_Int	I
    //   29: aload_0
    //   30: getfield 219	awun:U	Ljava/lang/String;
    //   33: invokestatic 153	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   36: ifeq +176 -> 212
    //   39: aload_0
    //   40: invokevirtual 222	awun:g	()I
    //   43: istore_2
    //   44: aload_1
    //   45: iload_2
    //   46: putfield 101	awuo:jdField_b_of_type_Int	I
    //   49: aload_0
    //   50: getfield 224	awun:Z	Ljava/lang/String;
    ...
    //   61: aload_1
    //   62: iload_2
    //   63: putfield 226	awuo:d	I
    //   66: aload_1
    //   67: iconst_0
    //   68: putfield 127	awuo:jdField_a_of_type_Boolean	Z
    //   71: aload_1
    //   72: getfield 101	awuo:jdField_b_of_type_Int	I
    //   75: iflt +11 -> 86
    //   78: aload_1
    //   79: getfield 101	awuo:jdField_b_of_type_Int	I
    //   82: iconst_4
    //   83: if_icmplt +24 -> 107
    //   86: aload_1
    //   87: getfield 101	awuo:jdField_b_of_type_Int	I
    //   90: iconst_4
    //   91: if_icmpne +152 -> 243
    //   94: aload_1
    //   95: iconst_1
    //   96: putfield 127	awuo:jdField_a_of_type_Boolean	Z
    //   99: aload_1
    //   100: aload_0
    //   101: invokevirtual 222	awun:g	()I
    //   104: putfield 101	awuo:jdField_b_of_type_Int	I
    //   107: aload_0
    //   108: getfield 228	awun:W	Ljava/lang/String;
    //   111: invokestatic 153	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   114: ifne +145 -> 259
    //   117: aload_1
    //   118: aload_0
    //   119: getfield 228	awun:W	Ljava/lang/String;
    //   122: invokestatic 233	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   125: putfield 108	awuo:c	I
    //   128: aload_1
    //   129: getfield 108	awuo:c	I
    //   132: iconst_1
    //   133: if_icmpge +11 -> 144
    //   136: aload_1
    //   137: aload_0
    //   138: invokevirtual 236	awun:f	()I
    //   141: putfield 108	awuo:c	I
    //   144: aload_1
    //   145: aload_1
    //   146: getfield 108	awuo:c	I
    //   149: iconst_2
    //   150: idiv
    //   151: putfield 108	awuo:c	I
    //   154: aload_0
    //   155: invokevirtual 238	awun:b	()Ljava/lang/String;
    //   158: invokestatic 153	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   161: ifeq +132 -> 293
    //   164: aconst_null
    //   165: areturn
    //   166: aload_0
    //   167: getfield 240	awun:S	Ljava/lang/String;
    //   170: invokestatic 153	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   173: ifeq +28 -> 201
    //   176: aload_0
    //   177: invokevirtual 243	awun:e	()I
    //   180: istore_2
    //   181: aload_1
    //   182: iload_2
    //   183: putfield 86	awuo:jdField_a_of_type_Int	I
    //   186: goto -157 -> 29
    //   189: astore_3
    //   190: aload_1
    //   191: aload_0
    //   192: invokevirtual 243	awun:e	()I
    //   195: putfield 86	awuo:jdField_a_of_type_Int	I
    //   198: goto -169 -> 29
    //   201: aload_0
    //   202: getfield 240	awun:S	Ljava/lang/String;
    //   205: invokestatic 217	android/graphics/Color:parseColor	(Ljava/lang/String;)I
    //   208: istore_2
    //   209: goto -28 -> 181
    //   212: aload_0
    //   213: getfield 219	awun:U	Ljava/lang/String;
    //   216: invokestatic 233	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   219: istore_2
    //   220: goto -176 -> 44
    //   223: aload_0
    //   224: getfield 224	awun:Z	Ljava/lang/String;
    ...
    //   235: aload_1
    //   236: iconst_0
    //   237: putfield 226	awuo:d	I
    //   240: goto -174 -> 66
    //   243: aload_1
    //   244: getfield 101	awuo:jdField_b_of_type_Int	I
    //   247: iconst_5
    //   248: if_icmpne -149 -> 99
    //   251: aload_1
    //   252: iconst_1
    //   253: putfield 137	awuo:jdField_b_of_type_Boolean	Z
    //   256: goto -157 -> 99
    //   259: aload_0
    //   260: getfield 245	awun:V	Ljava/lang/String;
    //   263: invokestatic 153	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   266: ifeq +16 -> 282
    //   269: aload_0
    //   270: invokevirtual 236	awun:f	()I
    //   273: istore_2
    //   274: aload_1
    //   275: iload_2
    //   276: putfield 108	awuo:c	I
    //   279: goto -151 -> 128
    //   282: aload_0
    //   283: getfield 245	awun:V	Ljava/lang/String;
    //   286: invokestatic 233	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   289: istore_2
    //   290: goto -16 -> 274
    //   293: aload_1
    //   294: aload_0
    //   295: invokevirtual 238	awun:b	()Ljava/lang/String;
    //   298: putfield 154	awuo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   301: aload_1
    //   302: aload_0
    //   303: getfield 247	awun:X	Ljava/lang/String;
    //   306: putfield 156	awuo:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   309: aload_1
    //   310: areturn
    //   311: astore_3
    //   312: goto -263 -> 49
  ...
  public void a(ObjectInput paramObjectInput)
  {
    ...
    if (this.jdField_a_of_type_Int == 1) {
      this.Y = awbk.a(paramObjectInput.readUTF(), false);
    }
    do
    {
      do
      {
        ...
        if (this.jdField_a_of_type_Int == 2)
        {
          ...
          this.V = awbk.a(paramObjectInput.readUTF(), false);
          this.Y = awbk.a(paramObjectInput.readUTF(), false);
          return;
        }
      ...
      this.Y = awbk.a(paramObjectInput.readUTF(), false);
      this.X = awbk.a(paramObjectInput.readUTF(), false);
      this.Z = awbk.a(paramObjectInput.readUTF(), false);
    } while (this.jdField_a_of_type_Int < 11);
    this.aa = awbk.a(paramObjectInput.readUTF(), false);
    this.ab = awbk.a(paramObjectInput.readUTF(), false);
  }
    ...
    do
    {
      do
      {
        ...
        if (this.jdField_a_of_type_Int == 2)
        {
          ...
          for (str = "";; str = awbk.a(this.Y, false))
          {
            paramObjectOutput.writeUTF(str);
            return;
            str = this.S;
  ...
  public boolean a(awwc paramawwc)
  {
    ...
    this.S = paramawwc.a("color");
    this.U = paramawwc.a("style");
    this.V = paramawwc.a("size");
    this.Y = awbk.a(awuw.a(paramawwc), false);
    this.X = paramawwc.a("html");
    this.Z = paramawwc.a("type");
    this.aa = paramawwc.a("maxLines");
    this.ab = paramawwc.a("lineSpace");
    return true;
  }
  ...
  public int b()
  {
    if (!TextUtils.isEmpty(this.aa)) {
      try
      {
        int j = Integer.parseInt(this.aa);
        return j;
      }
  ...
  protected int d()
  {
    if (!TextUtils.isEmpty(this.ab)) {
      try
      {
        int j = Integer.parseInt(this.ab);
        return j;
      }
      catch (Exception localException) {}
    }
