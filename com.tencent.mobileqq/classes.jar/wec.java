...
public class wec
{
  ...
  private static void b(String paramString, Bitmap paramBitmap, ImageView paramImageView)
  {
    ...
    if (paramBitmap != null)
    {
      localBitmap = bacm.a(paramImageView.getContext(), paramBitmap, 0.25F, 20.0F);
      if (localBitmap != null)
      {
    ...
    for (Object localObject = localBitmap;; localObject = localBitmap.copy(localBitmap.getConfig(), true))
    {
      ...
      localObject = vnb.a(paramBitmap.getWidth(), paramBitmap.getHeight(), paramImageView.getWidth(), paramImageView.getHeight());
      paramBitmap = vlc.a(vlc.a(localBitmap, ((Integer)((Pair)localObject).first).intValue(), ((Integer)((Pair)localObject).second).intValue(), true), paramBitmap);
      b(paramBitmap, paramImageView);
      babe.a(paramString, paramBitmap);
      return;
    }
  }
}
