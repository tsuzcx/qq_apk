...
public class wec
  implements Runnable
{
  public wec(AddContactsView paramAddContactsView, StringBuilder paramStringBuilder) {}
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        try
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactAddContactsView.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.runOnUiThread(new wed(this));
          return;
