        ...
        if ((paramObject != null) && (localObject1 != null))
        {
          ...
          try
          {
            ...
            if (paramInt <= k)
            {
              ...
              m = oar.a((AdvertisementInfo)localObject3);
              String str = oar.b((AdvertisementInfo)localObject3);
              ...
              if ((localObject2 == null) || (!(localObject2 instanceof ocb))) {
                break label717;
              }
              ((ocb)localObject2).a(true, (AdvertisementInfo)localObject3, paramVarArgs);
            }
          }
