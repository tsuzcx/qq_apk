  ...
  implements Manager
{
  ...
  private String jdField_b_of_type_JavaLangString = ajjy.a(2131647658);
  private boolean jdField_b_of_type_Boolean;
  private String jdField_c_of_type_JavaLangString = ajjy.a(2131647659);
  private boolean jdField_c_of_type_Boolean;
  
  public apha(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaUtilArrayList.clear();
    this.jdField_b_of_type_Boolean = baig.A(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin());
  }
  
  public static apha a(QQAppInterface paramQQAppInterface)
  {
    return (apha)paramQQAppInterface.getManager(286);
  }
  ...
  private void a(QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface = (aqdf)paramQQAppInterface.getManager(219);
  ...
  {
    int j = baig.aJ(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin());
    if (QLog.isColorLevel()) {
      QLog.d("RichTextChatManager", 2, "last Memoried Tab:" + j);
    }
    int i;
    if (j == -1) {
      if (!baig.z(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin()))
      {
        i = paramArrayList.indexOf(Integer.valueOf(a(paramQQAppInterface)));
        baig.q(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin(), true);
        if (QLog.isColorLevel()) {
  ...
  public void a(QQAppInterface paramQQAppInterface, Integer paramInteger, ConfigurationService.Config paramConfig)
  {
    ...
    int j = baig.aH(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount());
    int m = baig.aI(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount());
    int n = AppSetting.a();
    if (QLog.isColorLevel()) {
    ...
    if (m != n) {
      baig.Y(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), n);
    }
    for (;;)
    {
      if (k != i)
      {
        paramInteger = amnh.b(paramConfig, i, paramInteger.intValue());
        if (QLog.isColorLevel()) {
        ...
        baig.f(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), k, paramInteger);
  ...
  public void a(boolean paramBoolean, QQAppInterface paramQQAppInterface)
  {
    ...
    baig.r(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin(), paramBoolean);
  }
