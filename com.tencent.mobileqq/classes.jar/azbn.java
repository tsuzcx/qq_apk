  ...
  extends CameraCaptureSession.CaptureCallback
{
  ...
  public azbn(Camera2Control paramCamera2Control)
  {
      ...
      do
      {
        ...
        do
        {
          do
          {
            ...
            azbl.a(1, "[Camera2]process afState:" + localInteger);
        ...
        azbl.a(1, "[Camera2]process aeState:" + paramCaptureResult);
      } while (this.jdField_a_of_type_ComTencentMobileqqShortvideoCamera2Camera2Control == null);
      this.jdField_a_of_type_ComTencentMobileqqShortvideoCamera2Camera2Control.d();
      return;
      azbl.a(1, "[Camera2]process preCapture aeState:" + paramCaptureResult);
    } while (this.jdField_a_of_type_ComTencentMobileqqShortvideoCamera2Camera2Control == null);
    this.jdField_a_of_type_ComTencentMobileqqShortvideoCamera2Camera2Control.d();
  }
