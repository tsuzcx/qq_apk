...
public class aqnc
{
  ...
  public static String a(Bitmap paramBitmap, String paramString, int[] paramArrayOfInt)
  {
    ...
    paramBitmap = aubp.a(new File(paramString).getName(), false);
    try
    {
  ...
  private static boolean a(Bitmap paramBitmap, ByteArrayOutputStream paramByteArrayOutputStream, int paramInt)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.e(aqnc.class.getName(), 2, "doCompress Exception:", paramBitmap);
      }
      paramByteArrayOutputStream.reset();
      return false;
    }
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.e(aqnc.class.getName(), 2, "doCompress OutOfMemoryError:", paramBitmap);
      }
      paramByteArrayOutputStream.reset();
    }
    return false;
