...
public class vyx
{
  ...
  public vyx(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(Context paramContext, int paramInt1, String paramString1, String paramString2, long paramLong, int paramInt2, int paramInt3)
  {
    ...
    localbhpy.a(alpo.a(2131700253), 5);
    localbhpy.a(alpo.a(2131700251) + ugx.a + alpo.a(2131700252), 5);
    localbhpy.c(2131690648);
    localbhpy.a(new vyy(this, localbhpy, paramContext, paramInt1, paramString1, paramString2, paramLong, paramInt2, paramInt3));
  ...
  {
    wsv.d("AddVideoController", "addVideoByRecord %s %s %s", new Object[] { paramString1, paramString2, Boolean.valueOf(paramBoolean) });
    if (paramContext == null) {
      throw new NullPointerException("context is null");
    }
    if (TextUtils.isEmpty(paramString1)) {
    ...
    if ((paramContext instanceof Activity))
    {
      ...
      localxlb.a(paramContext, localBundle, paramInt2);
      paramContext.overridePendingTransition(2130772232, 2130772038);
      return;
    }
  ...
  {
    wsv.d("AddVideoController", "addVideoByExist %s %s", new Object[] { paramString1, paramString2 });
    Bundle localBundle = new Bundle();
    localBundle.putString("shareGroupId", paramString1);
    localBundle.putString("shareGroupName", paramString2);
    localBundle.putInt("add_video_source", paramInt3);
    StoryTransitionActivity.a(paramContext, vyz.class.getName(), localBundle, paramInt2);
  }
}
