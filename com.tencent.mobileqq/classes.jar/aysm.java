  ...
  implements TencentLocationListener
{
  ...
  aysm(aysl paramaysl, Runnable paramRunnable, MqqHandler paramMqqHandler) {}
  ...
  public void onLocationChanged(TencentLocation paramTencentLocation, int paramInt, String paramString)
  {
    ...
    {
      return;
      aysl.a(this.jdField_a_of_type_Aysl, paramTencentLocation);
      if (this.b != null)
      {
        if (QLog.isColorLevel()) {
      ...
      if (paramInt == 0) {
        aysl.a(this.jdField_a_of_type_Aysl, true);
      }
