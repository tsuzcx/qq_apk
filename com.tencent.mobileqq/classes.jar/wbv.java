...
public class wbv
  extends Handler
{
  public wbv(PublicAccountChatPie paramPublicAccountChatPie) {}
    ...
    case 7: 
      do
      {
        do
        {
          ...
          PublicAccountChatPie.a(this.a, DialogUtil.a(this.a.jdField_a_of_type_AndroidContentContext, 230, null, String.format("定位到你当前所在城市在%s，是否切换？", new Object[] { (String)paramMessage.obj }), "否", "是", new wbw(this, i), new wbx(this, localSharedPreferences)));
