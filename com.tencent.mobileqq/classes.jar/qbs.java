...
public class qbs
  implements qdy
{
  private void a(Context paramContext, BaseArticleInfo paramBaseArticleInfo, slt paramslt)
  {
    if ((paramBaseArticleInfo != null) && (paramBaseArticleInfo.mVideoDownloadBarInfo != null) && (paramBaseArticleInfo.mVideoDownloadBarInfo.get() != null)) {
      rwv.a(paramContext, UrlJumpInfo.a(paramBaseArticleInfo.mVideoDownloadBarInfo.msg_url_jump_info));
    }
    while ((paramslt == null) || (paramBaseArticleInfo == null)) {
      return;
    }
    paramslt.a(slt.a(paramBaseArticleInfo), paramBaseArticleInfo, false, false);
  }
  ...
  private void a(BaseArticleInfo paramBaseArticleInfo, boolean paramBoolean, JSONObject paramJSONObject)
  {
    ...
    for (int i = paramBaseArticleInfo.mVideoColumnInfo.a;; i = -1)
    {
      ...
      for (int j = 0;; j = 1)
      {
        paramJSONObject = new sie(null, null, null, null).V(Integer.valueOf("1031").intValue()).i(paramBaseArticleInfo.getInnerUniqueID()).Y(j).q(paramJSONObject.optString("double_videocard_jump_page")).r(paramJSONObject.optString("double_videocard_jump_src")).s(paramBaseArticleInfo.mSubscribeName).a((int)paramBaseArticleInfo.mChannelID);
        j = k;
        if (uhv.b() > 0) {
          j = 0;
        }
        paramBaseArticleInfo = paramJSONObject.ae(j).f(paramBaseArticleInfo);
        if (i != -1) {
          paramBaseArticleInfo.X(i);
        }
        paramBaseArticleInfo = paramBaseArticleInfo.a().a();
        odq.a(null, null, "0X8007625", "0X8007625", 0, 0, "", "", "", paramBaseArticleInfo, false);
        odq.a(null, null, "0X800A5A9", "0X800A5A9", 0, 0, "", "", "", paramBaseArticleInfo, false);
        return;
      }
    }
  }
    ...
    catch (Exception localException1)
    {
      for (;;)
      {
        try
        {
          ...
          localObject1 = new JSONObject();
          ((JSONObject)localObject1).put("cover_image_url_1", pay.a(paramBaseArticleInfo.mFirstPagePicUrl, ViewUtils.dpToPx(180.5F), ViewUtils.dpToPx(102.0F)));
          localJSONObject2.put("cover_image_1", localObject1);
          localJSONObject2.put("id_paly_wrapper_1", new JSONObject());
          localObject1 = new JSONObject();
          localObject2 = rwv.a(paramBaseArticleInfo.mVideoDuration * 1000);
          ...
          ((JSONObject)localObject2).put("article_title_1_textsize", pcn.a());
          ...
          localObject1 = new JSONObject();
          localObject2 = rwv.d(paramBaseArticleInfo.mVideoCommentCount);
          if (!TextUtils.isEmpty((CharSequence)localObject2))
          {
            ((JSONObject)localObject1).put("comment_num_1", (String)localObject2 + amtj.a(2131702566));
          ...
          localJSONObject2.put("id_container_1", localObject1);
          localObject1 = new JSONObject();
          ((JSONObject)localObject1).put("cover_image_url_2", pay.a(localBaseArticleInfo.mFirstPagePicUrl, ViewUtils.dpToPx(180.5F), ViewUtils.dpToPx(102.0F)));
          localJSONObject2.put("cover_image_2", localObject1);
          localJSONObject2.put("id_play_wrapper_2", new JSONObject());
          localObject1 = new JSONObject();
          localObject2 = rwv.a(localBaseArticleInfo.mVideoDuration * 1000);
          if (localObject2 != null)
          {
            localObject2 = ((StringBuilder)localObject2).toString();
            if (!TextUtils.isEmpty((CharSequence)localObject2))
          ...
          if (!pkm.a().a(localBaseArticleInfo.mArticleID)) {
            continue;
          }
          localObject1 = "#999999";
          ((JSONObject)localObject2).put("article_title_2_color", localObject1);
          ((JSONObject)localObject2).put("article_title_2_textsize", pcn.a());
          ...
          localObject1 = new JSONObject();
          localObject2 = rwv.d(localBaseArticleInfo.mVideoCommentCount);
          if (!TextUtils.isEmpty((CharSequence)localObject2))
          {
            ((JSONObject)localObject1).put("comment_num_2", (String)localObject2 + amtj.a(2131702567));
  ...
  public void a(int paramInt1, Container paramContainer, pvc parampvc, int paramInt2)
  {
    ...
    {
      return;
      a(paramContainer.findViewBaseByName("id_artilce_title_1"), parampvc.a());
    } while ((parampvc.a() == null) || (parampvc.a().mSubArtilceList == null) || (parampvc.a().mSubArtilceList.size() <= 0) || (parampvc.a().mSubArtilceList.get(0) == null));
    a(paramContainer.findViewBaseByName("id_artilce_title_2"), (BaseArticleInfo)parampvc.a().mSubArtilceList.get(0));
  }
  ...
  public boolean a(int paramInt, Container paramContainer, pvc parampvc, ViewBase paramViewBase)
  {
    ...
    paramViewBase.setOnClickListener(new qbt(this, parampvc, paramInt, paramContainer));
    return true;
  }
}
