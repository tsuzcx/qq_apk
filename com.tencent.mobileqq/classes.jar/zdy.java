...
public abstract class zdy
  extends zeu
  implements bhqp, bhqq, bhqr, bhsz, bhta, zel
{
  ...
  public zdy(Activity paramActivity, zec paramzec)
  {
    this.jdField_a_of_type_Zel = new zdz(this);
  ...
  protected RelativeLayout a()
  {
    return (RelativeLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2131561140, null);
  }
  ...
  protected zdx a(Context paramContext)
  {
    return new zeq();
  }
  ...
  {
    if ((this.jdField_a_of_type_Zek != null) && (this.jdField_a_of_type_Zek.a())) {
      this.jdField_a_of_type_Zek.b();
    }
    if ((this.jdField_a_of_type_Zek != null) && (this.jdField_a_of_type_Zek.b())) {
      this.jdField_a_of_type_Zek.c();
    }
  ...
  public void a(ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      b((ViewGroup)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131375981));
      this.jdField_a_of_type_ComTencentWidgetGallery = ((Gallery)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131367010));
      this.d = this.jdField_a_of_type_AndroidAppActivity.findViewById(2131363034);
      this.jdField_a_of_type_Zdx = a(this.jdField_a_of_type_AndroidAppActivity);
      if (this.jdField_a_of_type_Zdx != null) {
        this.jdField_a_of_type_Zdx.a(this.jdField_a_of_type_AndroidAppActivity, this, this.b);
      }
      this.jdField_a_of_type_Zek = a();
      if (this.jdField_a_of_type_Zek != null) {
        this.jdField_a_of_type_Zek.a(this.jdField_a_of_type_AndroidAppActivity, this);
      }
      this.jdField_a_of_type_ComTencentCommonGalleryactivityAbstractImageAdapter = a(this.jdField_a_of_type_AndroidAppActivity);
      this.jdField_a_of_type_ComTencentCommonGalleryactivityAbstractImageAdapter.a(this.jdField_a_of_type_Zec);
      if (this.jdField_a_of_type_Zek != null)
      {
        this.jdField_a_of_type_ComTencentCommonGalleryactivityAbstractImageAdapter.a(this.jdField_a_of_type_Zek);
        this.jdField_a_of_type_Zek.a();
      }
      ...
      this.jdField_a_of_type_ComTencentWidgetGallery.setSelection(this.jdField_a_of_type_Zec.b());
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    localAlphaAnimation.setDuration(this.jdField_a_of_type_Zep.a().a());
    ...
    localAlphaAnimation.setAnimationListener(new zea(this));
  ...
  public void b(boolean paramBoolean)
  {
    if (b())
    {
      a(paramBoolean, this.jdField_a_of_type_Zep.a().b());
      return;
    }
  ...
  public void b(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    localAlphaAnimation.setInterpolator(new bhov());
    localAlphaAnimation.setDuration(this.jdField_a_of_type_Zep.a().a());
    ...
    localScaleAnimation.setDuration(this.jdField_a_of_type_Zep.a().a());
    AnimationSet localAnimationSet = new AnimationSet(true);
    localAnimationSet.setFillAfter(true);
    localAnimationSet.addAnimation(localAlphaAnimation);
    localAnimationSet.addAnimation(localScaleAnimation);
    localAnimationSet.setAnimationListener(new zeb(this));
    this.d.startAnimation(localAlphaAnimation);
  ...
  public boolean d()
  {
    return this.jdField_a_of_type_Zep.a().a();
  }
  ...
  public boolean e()
  {
    ...
    if (c()) {
      b(false, this.jdField_a_of_type_Zep.a().c());
    }
    for (;;)
    {
  ...
  public void o()
  {
    if (this.jdField_a_of_type_Zep.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_Zep.jdField_a_of_type_Boolean = false;
      return;
    }
    b(true, this.jdField_a_of_type_Zep.jdField_a_of_type_Zdw.c());
  }
  ...
  public void onItemSelected(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    {
      return;
      if ((this.jdField_a_of_type_Zdx != null) && (a())) {
        this.jdField_a_of_type_Zdx.a(paramAdapterView, paramInt);
      }
      this.jdField_a_of_type_Zec.a(paramInt);
      if ((!d()) && (this.jdField_a_of_type_Zek != null) && (!this.jdField_a_of_type_Zek.a())) {
        this.jdField_a_of_type_Zek.a();
      }
