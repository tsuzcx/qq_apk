...
public class zdy
{
  ...
  private void b(String paramString, SlideItemInfo paramSlideItemInfo)
  {
    ...
    this.jdField_a_of_type_Int = zdm.a(paramString);
  ...
  private boolean b(LocalMediaInfo paramLocalMediaInfo, int paramInt1, int paramInt2, String paramString, SlideItemInfo paramSlideItemInfo)
  {
    ...
    //   180: goto -136 -> 44
    //   183: aload 19
    //   185: invokestatic 193	zdy:a	(Landroid/media/MediaFormat;)V
    //   188: iload_2
    //   189: ifle +15 -> 204
    //   192: aload 20
    //   194: iload_2
    ...
    //   266: invokestatic 212	zdm:a	(Landroid/media/MediaFormat;Ljava/lang/String;)I
    //   269: istore 11
    //   271: aload_0
    //   272: aload 19
    //   274: invokestatic 173	zdm:a	(Landroid/media/MediaFormat;)I
    //   277: putfield 175	zdy:jdField_a_of_type_Int	I
    //   280: aload 5
    //   282: aload_0
    //   283: getfield 175	zdy:jdField_a_of_type_Int	I
    ...
    //   349: aload_0
    //   350: getfield 22	zdy:jdField_a_of_type_JavaNioByteOrder	Ljava/nio/ByteOrder;
    ...
    //   549: aload_1
    //   550: aload_0
    //   551: getfield 22	zdy:jdField_a_of_type_JavaNioByteOrder	Ljava/nio/ByteOrder;
