...
public class ret
{
  ...
  static
  {
    jdField_c_of_type_Int = ((Integer)bmqa.a(h, Integer.valueOf(0))).intValue();
  }
  ...
  {
    jdField_c_of_type_Int = ((Integer)bmqa.a(h, Integer.valueOf(0))).intValue();
    NativeAwesomeCommentView.jdField_a_of_type_Int = ((Integer)bmqa.a(i, Integer.valueOf(1))).intValue();
  }
  ...
  public static void a(BaseArticleInfo paramBaseArticleInfo, String paramString)
  {
    ...
    try
    {
      if ((paramBaseArticleInfo.mResolvedFeedType == 0) && ((paramBaseArticleInfo instanceof ArticleInfo))) {
        paramBaseArticleInfo.mResolvedFeedType = snh.a((ArticleInfo)paramBaseArticleInfo, 0);
      }
    ...
    if (paramBaseArticleInfo != null) {
      oat.a(null, "", paramString, paramString, 0, 0, paramBaseArticleInfo.mArticleID + "", paramBaseArticleInfo.mStrategyId + "", paramBaseArticleInfo.rawkey, localJSONObject.toString(), false);
    }
  }
