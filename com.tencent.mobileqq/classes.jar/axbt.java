...
{
  public static int a;
  public static volatile HashMap<Integer, axcy> a;
  public static volatile List<bhkq> a;
  ...
  public static int b;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new axbu(this);
  private Runnable jdField_a_of_type_JavaLangRunnable = new CliNotifyPush.1(this);
  private volatile ArrayList<axcy> jdField_a_of_type_JavaUtilArrayList;
  private volatile ArrayList<axcy> b;
  private int c;
  ...
  private String a(ArrayList<axcy> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      {
        localaxcy = (axcy)paramArrayList.next();
        if ((localaxcy != null) && (localaxcy.jdField_a_of_type_JavaUtilMap != null)) {
      ...
      else
      {
        try
        {
          localJSONObject.put("addTime", localaxcy.jdField_a_of_type_Long);
          localJSONObject.put("opUin", localaxcy.jdField_b_of_type_Long);
          Iterator localIterator = localaxcy.jdField_a_of_type_JavaUtilMap.keySet().iterator();
          while (localIterator.hasNext())
          {
            String str = (String)localIterator.next();
            localJSONObject.put(str, localaxcy.jdField_a_of_type_JavaUtilMap.get(str));
          }
      ...
      for (;;)
      {
        ...
        if ((this.c == 0) || (this.c == 10000))
        {
          ...
          if (this.jdField_a_of_type_JavaUtilArrayList != null)
          {
            ...
            while (localIterator.hasNext())
            {
              axcy localaxcy = (axcy)localIterator.next();
              a(localaxcy, (QQAppInterface)getAppRuntime(), 2L);
              a(localaxcy, true);
              a(localaxcy);
            }
          }
  ...
  private void a(int paramInt)
  {
    ...
    b(paramInt);
    bgyp.a((QQAppInterface)getAppRuntime(), "qzonenewservice.callqzonev2", paramInt, "CliNotifyPush", 1, System.currentTimeMillis());
  }
  
  private void a(axcy paramaxcy)
  {
    QLog.e("CliNotifyPush", 1, "dispathQzonePushMsg()");
    QQAppInterface localQQAppInterface = (QQAppInterface)getAppRuntime();
    if (localQQAppInterface == null) {}
    while ((paramaxcy == null) || (paramaxcy.jdField_a_of_type_JavaUtilMap == null)) {
      return;
    }
    Object localObject;
    if ((paramaxcy.jdField_a_of_type_JavaUtilMap != null) && (paramaxcy.jdField_a_of_type_JavaUtilMap.get("utime") != null) && (LocalMultiProcConfig.getInt4Uin("qzone_preget_passive_open", 0, localQQAppInterface.getLongAccountUin()) == 1))
    {
      localObject = (String)paramaxcy.jdField_a_of_type_JavaUtilMap.get("utime");
      if (!LocalMultiProcConfig.getString4Uin("qzone_passive_undealtime", "", localQQAppInterface.getLongAccountUin()).equals(localObject))
      {
        paramaxcy.jdField_a_of_type_Boolean = true;
        int i = bhlc.a().a().a(localQQAppInterface.getLongAccountUin());
        jdField_a_of_type_JavaUtilHashMap.put(Integer.valueOf(i), paramaxcy);
      }
    }
    if (a(localQQAppInterface, paramaxcy))
    {
      if (jdField_a_of_type_Boolean)
      {
        ...
        this.jdField_b_of_type_JavaUtilArrayList.add(paramaxcy);
        return;
      }
      localObject = new ArrayList();
      ((ArrayList)localObject).add(paramaxcy);
  ...
  public static void a(axcy paramaxcy, QQAppInterface paramQQAppInterface, long paramLong)
  {
    if (paramaxcy == null) {
      return;
    }
    ...
    for (long l1 = Long.parseLong(paramQQAppInterface.getAccount());; l1 = 0L)
    {
      ...
      if (paramaxcy.jdField_a_of_type_Long != 0L)
      {
        l2 = paramLong;
        if (l1 != 0L)
        {
          localNewIntent = new NewIntent(paramQQAppInterface.getApplication(), axco.class);
          localNewIntent.putExtra("timestamp", paramaxcy.jdField_a_of_type_Long);
          localNewIntent.putExtra("hostuin", l1);
          if (!paramaxcy.jdField_b_of_type_Boolean) {
            break label230;
          }
        }
      }
      ...
      {
        String str2 = paramaxcy.jdField_a_of_type_JavaLangString;
        String str1;
        ...
        {
          str1 = str2;
          if (paramaxcy.jdField_a_of_type_JavaUtilMap != null) {
            str1 = (String)paramaxcy.jdField_a_of_type_JavaUtilMap.get("pushstatkey");
          }
        }
        ...
        l2 = paramLong;
        QLog.e("CliNotifyPush", 1, "sentQzoneMsfPushAck: localTimeStamp=" + paramaxcy.jdField_a_of_type_Long + " uin=" + l1 + " flag=" + l2);
        return;
      }
    }
  }
  
  private void a(axcy paramaxcy, boolean paramBoolean)
  {
    if ((paramaxcy == null) || (paramaxcy.jdField_a_of_type_JavaUtilMap == null)) {
    ...
    do
    {
      ...
      localaxcj = (axcj)((QQAppInterface)localObject1).getManager(10);
    } while (localaxcj == null);
    for (;;)
    {
      int m;
      try
      {
        int k = Integer.parseInt((String)paramaxcy.jdField_a_of_type_JavaUtilMap.get("pushtype"));
        QLog.i("CliNotifyPush", 1, "showRedTouch type:" + k + ",uin:" + paramaxcy.jdField_b_of_type_Long + ",isBackground_Pause:" + ((QQAppInterface)localObject1).isBackground_Pause);
        if ((k != 1) && (k != 300) && (k != 302)) {
          break;
        }
        localObject1 = (String)paramaxcy.jdField_a_of_type_JavaUtilMap.get("conent");
        m = Integer.parseInt((String)paramaxcy.jdField_a_of_type_JavaUtilMap.get("count"));
        l = paramaxcy.jdField_b_of_type_Long;
        int i = 0;
        try
        {
          boolean bool = paramaxcy.jdField_a_of_type_JavaUtilMap.containsKey("opuin_qzoneVipLevel");
          if (!bool) {
            break label673;
          }
          i = 1;
        ...
        catch (Exception localException1)
        {
          try
          {
            j = Integer.parseInt((String)paramaxcy.jdField_a_of_type_JavaUtilMap.get("opuin_qzoneVipLevel"));
            i = 1;
            ...
            paramaxcy.jdField_a_of_type_ArrayOfByte = bhon.a(paramaxcy.jdField_a_of_type_ArrayOfByte);
            if (paramaxcy.jdField_a_of_type_ArrayOfByte != null)
            {
              localObject3 = (PassiveFeedsPush)bhon.a(PassiveFeedsPush.class, paramaxcy.jdField_a_of_type_ArrayOfByte);
            ...
            localObject2 = (String)paramaxcy.jdField_a_of_type_JavaUtilMap.get("shcemaUrlAnd");
          }
          ...
          try
          {
            paramaxcy = (String)paramaxcy.jdField_a_of_type_JavaUtilMap.get("psv_tab_textlist");
            if (!TextUtils.isEmpty(paramaxcy))
            {
              paramaxcy = new JSONObject(paramaxcy);
              paramaxcy.getJSONObject("psv_tab_list");
              paramaxcy = paramaxcy.getJSONObject("psv_tab_list").getJSONArray("text_data");
              i = 0;
              if (i < paramaxcy.length())
              {
                localObject4 = (JSONObject)paramaxcy.get(i);
          ...
          catch (Exception paramaxcy)
          {
            QLog.e("CliNotifyPush", 1, "psv_tab_textlist failed" + paramaxcy);
            if (k != 302) {
              break label644;
            }
          }
        }
        localaxcj.a(1, m, localException1, (String)localObject1, paramBoolean, true, (String)localObject2);
        return;
      }
      catch (Exception paramaxcy)
      {
      ...
      label644:
      long l = m;
      localaxcj.a(1, l, localException1, (String)localObject1, paramBoolean, true, "");
      return;
      label673:
      int j = 0;
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((!TextUtils.isEmpty(str)) && (i > 0))
        {
          ...
          paramQQAppInterface = (akwp)paramQQAppInterface.a(148);
          if (paramQQAppInterface != null)
          {
  ...
  private void a(ArrayList<axcy> paramArrayList, QQAppInterface paramQQAppInterface)
  {
    ...
    try
    {
      ...
      while (localIterator.hasNext()) {
        ((axcy)localIterator.next()).a(true);
      }
      return;
    }
    catch (Exception localException)
    {
      jdField_a_of_type_Boolean = false;
      paramQQAppInterface.getHandler(axbt.class).removeCallbacks(this.jdField_a_of_type_JavaLangRunnable);
      ...
      paramQQAppInterface.getHandler(axbt.class).postDelayed(this.jdField_a_of_type_JavaLangRunnable, QzoneConfig.getInstance().getConfig("QZoneSetting", "CallQZoneWNSFromPushTimeout", 20000));
  ...
  private void a(Map<String, String> paramMap, String paramString)
  {
    ...
    try
    {
      bhpg localbhpg = new bhpg();
      localbhpg.jdField_a_of_type_Int = Integer.parseInt((String)paramMap.get("key_ctrl_cmd"));
      localbhpg.jdField_a_of_type_JavaUtilMap.putAll(paramMap);
      bhpf.a(paramString).a(localbhpg);
      return;
    }
  ...
  private boolean a(axcy paramaxcy)
  {
    boolean bool = false;
    int i = Integer.parseInt((String)paramaxcy.jdField_a_of_type_JavaUtilMap.get("pushtype"));
    QQAppInterface localQQAppInterface = (QQAppInterface)getAppRuntime();
    Object localObject;
    bhkq localbhkq2;
    if (i == 301) {
      ...
      {
        localObject = (String)paramaxcy.jdField_a_of_type_JavaUtilMap.get("live_roomid");
        if (localObject != null)
        {
          localbhkq2 = (bhkq)jdField_a_of_type_JavaUtilList.get(jdField_a_of_type_JavaUtilList.size() - 1);
          if ((localbhkq2 == null) || (!((String)localObject).equals(localbhkq2.jdField_a_of_type_JavaLangString))) {
            break label257;
          }
          jdField_a_of_type_JavaUtilList.remove(localbhkq2);
    ...
    for (;;)
    {
      ...
      a(paramaxcy, localQQAppInterface, 16L);
      bool = true;
      return bool;
      label187:
      bhkq localbhkq1 = (bhkq)jdField_a_of_type_JavaUtilList.get(jdField_a_of_type_JavaUtilList.size() - 1);
      if (localbhkq1 != null)
      {
        bhko.a().a(localQQAppInterface, 0, null, localbhkq1.b, null, null, localbhkq1.jdField_a_of_type_Boolean, localbhkq1.jdField_a_of_type_Int, localbhkq1.c, localbhkq1.d, false, false);
        continue;
        label257:
        if (jdField_a_of_type_JavaUtilList.size() > 1)
        {
          ...
          {
            localbhkq2 = (bhkq)jdField_a_of_type_JavaUtilList.get(i);
            if ((localbhkq2 != null) && (localbhkq1.equals(localbhkq2.jdField_a_of_type_JavaLangString))) {
              jdField_a_of_type_JavaUtilList.remove(localbhkq2);
            }
            i += 1;
          }
  ...
  private boolean a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    return LocalMultiProcConfig.getBool(paramQQAppInterface.getApp().getApplicationContext().getString(2131718858) + paramQQAppInterface.getAccount(), true);
  }
  ...
  private void b(int paramInt)
  {
    ...
    axrn.a(BaseApplication.getContext()).a(localQQAppInterface.getAccount(), "callqzonefrompushv2", true, 0L, 0L, localHashMap, null, true);
  }
  
  private void b(axcy paramaxcy)
  {
    QLog.e("CliNotifyPush", 1, "showPush()");
    if ((paramaxcy.jdField_a_of_type_Boolean) && (paramaxcy.jdField_a_of_type_Int == 0)) {
      paramaxcy.jdField_a_of_type_Int += 1;
    }
    ...
    do
    {
      ...
      m = Integer.parseInt((String)paramaxcy.jdField_a_of_type_JavaUtilMap.get("pushtype"));
      QLog.e("CliNotifyPush", 1, "pushType:" + m);
      if (m == 10000)
      {
        a(paramaxcy.jdField_a_of_type_JavaUtilMap, localQQAppInterface.getAccount());
        a(paramaxcy, localQQAppInterface, 16L);
        return;
      }
      if (m == 350)
    ...
    String str1 = (String)paramaxcy.jdField_a_of_type_JavaUtilMap.get("conent");
    String str2 = (String)paramaxcy.jdField_a_of_type_JavaUtilMap.get("pushstatkey");
    String str3 = (String)paramaxcy.jdField_a_of_type_JavaUtilMap.get("shcemaUrlAnd");
    String str4 = (String)paramaxcy.jdField_a_of_type_JavaUtilMap.get("title");
    String str5 = (String)paramaxcy.jdField_a_of_type_JavaUtilMap.get("fake_push");
    String str6 = (String)paramaxcy.jdField_a_of_type_JavaUtilMap.get("icon_type");
    String str7 = (String)paramaxcy.jdField_a_of_type_JavaUtilMap.get("icon_url");
    if (QLog.isColorLevel()) {
      QLog.d("CliNotifyPush", 2, new Object[] { "showPush: invoked. ", " iconType: ", str6, " title: ", str4, " message: ", str1 });
    }
    long l = paramaxcy.jdField_b_of_type_Long;
    if (paramaxcy.jdField_a_of_type_JavaUtilMap.get("count") != null) {
      QLog.i("CliNotifyPush", 1, "showPush receive push time:" + paramaxcy.jdField_a_of_type_Long + ",unreadCount=" + 1 + ",uin=" + l + ",type=" + m);
    }
    for (;;)
    {
      int j;
      ...
      try
      {
        j = Integer.parseInt((String)paramaxcy.jdField_a_of_type_JavaUtilMap.get("count"));
        i = j;
        if (j < 1) {
          i = 1;
        }
      ...
      catch (Exception localException2)
      {
        try
        {
          j = Integer.parseInt((String)paramaxcy.jdField_a_of_type_JavaUtilMap.get("CtrlFlag"));
          if (QLog.isColorLevel())
          {
            QLog.i("CliNotifyPush", 2, "qzone redtypeinfo:receive push time:" + paramaxcy.jdField_a_of_type_Long + "=unreadCount=" + i + "=uin=" + l + "=type=" + m + "=CtrlFlag=" + j + "=message=" + str1);
            if (j != 1) {
              continue;
            }
            bool1 = true;
        ...
        catch (Exception localException2)
        {
          try
          {
            k = Integer.parseInt((String)paramaxcy.jdField_a_of_type_JavaUtilMap.get("show_level"));
            ...
            if (!a(localQQAppInterface, m))
            {
              ...
              j = 0;
              continue;
              QLog.i("CliNotifyPush", 1, "qzone redtypeinfo:receive push time:" + paramaxcy.jdField_a_of_type_Long + "=unreadCount=" + i + "=uin=" + l + "=type=" + m + "=CtrlFlag=" + j);
              continue;
              bool1 = false;
            }
          }
          catch (Exception localException3)
          {
            ...
            if (j == 1)
            {
              ...
              a(paramaxcy, localQQAppInterface, 128L);
              return;
            }
      ...
      for (;;)
      {
        if ((j != 0) && (!a(k, 0)))
        {
          a(paramaxcy, localQQAppInterface, 64L);
          return;
          j = 0;
        }
        else
        {
          ...
          {
            a(paramaxcy, localQQAppInterface, 512L);
            return;
          }
          boolean bool3;
          if (str1 != null)
          {
            ...
            str1 = localQQAppInterface.getApp().getApplicationContext().getString(2131718136) + i + localQQAppInterface.getApp().getApplicationContext().getString(2131718137);
          }
          label1112:
          label1122:
          for (;;)
          {
            ...
            {
              bool1 = bool2;
              if (paramaxcy.jdField_a_of_type_JavaUtilMap.get("daemonShow") != null) {
                bool1 = "1".equals(paramaxcy.jdField_a_of_type_JavaUtilMap.get("daemonShow"));
              }
            }
            if (bool1)
            {
              bhko.a().a(localQQAppInterface, 1, str4, str1, str6, str7, bool3, m, str3, str2, true, "1".equals(str5));
              a(paramaxcy, localQQAppInterface, 4L);
            }
            QLog.e("CliNotifyPush", 1, "show push: XXX");
            return;
            a(paramaxcy, localQQAppInterface, 256L);
            return;
            a(paramaxcy, localQQAppInterface, 32L);
            return;
          }
          label1125:
          j = 0;
  ...
  private void c(axcy paramaxcy)
  {
    ...
    if ((paramaxcy.jdField_a_of_type_ArrayOfByte != null) && (paramaxcy.jdField_a_of_type_ArrayOfByte.length > 0)) {
      localIntent.putExtra("update_feeds_buffer", paramaxcy.jdField_a_of_type_ArrayOfByte);
    }
    for (;;)
    {
      BaseApplication.getContext().sendBroadcast(localIntent, "com.tencent.msg.permission.pushnotify");
      return;
      if ((paramaxcy.jdField_a_of_type_JavaUtilMap != null) && ((paramaxcy.jdField_a_of_type_JavaUtilMap instanceof HashMap))) {
        localIntent.putExtra("update_feeds", (HashMap)paramaxcy.jdField_a_of_type_JavaUtilMap);
      }
    }
  }
  
  /* Error */
  private void d(axcy paramaxcy)
  {
    // Byte code:
    //   0: iconst_m1
    //   1: istore_3
    ...
    //   3: ifnull +10 -> 13
    //   6: aload_1
    //   7: getfield 159	axcy:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   10: ifnonnull +4 -> 14
    //   13: return
    //   14: aload_1
    //   15: getfield 159	axcy:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   18: ldc_w 880
    //   21: invokeinterface 188 2 0
    //   26: checkcast 24	java/lang/String
    //   29: astore 6
    //   31: aload_1
    //   32: getfield 159	axcy:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   35: ldc_w 882
    ...
    //   64: ldc 199
    //   66: ldc_w 884
    //   69: invokestatic 889	cooperation/qzone/util/QZLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   72: iconst_1
    //   73: istore_2
    //   74: aload_0
    //   75: invokevirtual 233	axbt:getAppRuntime	()Lmqq/app/AppRuntime;
    ...
    //   97: aload 7
    //   99: aload_1
    //   100: getfield 159	axcy:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   103: invokevirtual 890	java/util/HashMap:putAll	(Ljava/util/Map;)V
    //   106: aload 7
    //   108: ldc_w 892
    //   111: iload_2
    //   112: invokestatic 729	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   115: invokevirtual 321	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   118: pop
    //   119: invokestatic 634	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   122: invokestatic 739	axrn:a	(Landroid/content/Context;)Laxrn;
    //   125: aload 6
    ...
    //   138: aconst_null
    //   139: iconst_1
    //   140: invokevirtual 744	axrn:a	(Ljava/lang/String;Ljava/lang/String;ZJJLjava/util/HashMap;Ljava/lang/String;Z)V
    //   143: return
    //   144: invokestatic 634	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   147: aload 6
    //   149: invokestatic 896	axbt:a	(Landroid/content/Context;Ljava/lang/String;)Z
    //   152: istore 5
    //   154: iload 5
    //   156: ifeq +212 -> 368
    //   159: aload_1
    //   160: getfield 159	axcy:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   163: ldc_w 898
    ...
    //   191: istore_3
    //   192: aload_1
    //   193: getfield 159	axcy:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   196: ldc_w 900
    ...
    //   222: istore_2
    //   223: invokestatic 634	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   226: aload 6
    //   228: invokestatic 902	axbt:a	(Landroid/content/Context;Ljava/lang/String;)I
    //   231: istore 4
    //   233: iload 4
    //   235: iload_3
    ...
    //   245: aload_0
    //   246: aload_1
    //   247: getfield 159	axcy:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   250: aload 6
    //   252: aload 7
    //   254: invokevirtual 905	axbt:a	(Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;)V
    //   257: iconst_0
    //   258: istore_2
    //   259: goto +133 -> 392
    //   262: astore 8
    ...
    //   266: ldc_w 907
    //   269: aload 8
    //   271: invokestatic 910	cooperation/qzone/util/QZLog:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   274: goto -82 -> 192
    //   277: astore 6
    //   279: invokestatic 911	cooperation/qzone/util/QZLog:isColorLevel	()Z
    //   282: ifeq +24 -> 306
    //   285: ldc 199
    //   287: iconst_2
    //   288: iconst_2
    //   289: anewarray 587	java/lang/Object
    //   292: dup
    //   293: iconst_0
    //   294: ldc_w 913
    //   297: aastore
    ...
    //   300: aload 6
    //   302: aastore
    //   303: invokestatic 915	cooperation/qzone/util/QZLog:e	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   306: iconst_4
    //   307: istore_2
    //   308: goto -234 -> 74
    //   311: ldc_w 916
    ...
    //   322: ldc_w 918
    //   325: aload 8
    //   327: invokestatic 910	cooperation/qzone/util/QZLog:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   330: ldc_w 916
    //   333: istore_2
    //   334: goto -111 -> 223
    //   337: iconst_3
    ...
    //   339: iload_3
    //   340: istore_2
    //   341: invokestatic 911	cooperation/qzone/util/QZLog:isColorLevel	()Z
    //   344: ifeq +48 -> 392
    //   347: ldc 199
    //   349: iconst_2
    //   350: iconst_1
    //   351: anewarray 587	java/lang/Object
    //   354: dup
    //   355: iconst_0
    //   356: ldc_w 920
    //   359: aastore
    //   360: invokestatic 915	cooperation/qzone/util/QZLog:e	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   363: iload_3
    //   364: istore_2
    //   365: goto +27 -> 392
    //   368: invokestatic 911	cooperation/qzone/util/QZLog:isColorLevel	()Z
    //   371: ifeq +19 -> 390
    //   374: ldc 199
    //   376: iconst_2
    //   377: iconst_1
    //   378: anewarray 587	java/lang/Object
    //   381: dup
    //   382: iconst_0
    //   383: ldc_w 922
    //   386: aastore
    //   387: invokestatic 915	cooperation/qzone/util/QZLog:e	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   390: iconst_2
    //   391: istore_2
    //   392: goto -318 -> 74
    //   395: iconst_m1
  ...
  public Map<Integer, axcy> a(FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      if ((i == 1) || (i == 2) || (i == 4) || (i == 301) || (i == 8) || (i == 300) || (i == 10000) || (i == 302) || (i == 350) || (i == 100))
      {
        ...
        if (QzoneConfig.getInstance().getConfig("QZoneSetting", "PushDeduplication", 1) == 1)
        {
          ...
          a(new axcy(localSingleMsg.addTime, localSingleMsg.data, localSingleMsg.opUin, paramFromServiceMsg.Mark), localQQAppInterface, 8L);
          a(2014);
          break;
        ...
        {
          axcy localaxcy = (axcy)((Map)localObject1).get(Integer.valueOf(i));
          if ((localaxcy != null) && (localaxcy.jdField_a_of_type_Long < localSingleMsg.addTime))
          {
            ((Map)localObject1).put(Integer.valueOf(i), new axcy(localSingleMsg.addTime, localSingleMsg.data, localSingleMsg.opUin, paramFromServiceMsg.Mark, localSingleMsg.extBuffer));
            QLog.e("CliNotifyPush", 1, "PushDeduplication: msg localTimeStap:" + localSingleMsg.addTime + " sm newTimeStap:" + localaxcy.jdField_a_of_type_Long + " msg:" + (String)localaxcy.jdField_a_of_type_JavaUtilMap.get("conent"));
            a(localaxcy, localQQAppInterface, 8L);
            label713:
      ...
      for (;;)
      {
        ...
        if (i == 7066) {
          ...
          a(new axcy(localSingleMsg.addTime, localSingleMsg.data, localSingleMsg.opUin, paramFromServiceMsg.Mark), localQQAppInterface, 256L);
        }
      }
      if (l3 < l1) {
  ...
  public boolean a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      if (QZLog.isColorLevel()) {
        QZLog.i("CliNotifyPush", 2, "checkShowEnabled showLevel: " + paramInt1 + ",result: " + bool);
      }
      return bool;
      bool = false;
    }
  ...
  public boolean a(QQAppInterface paramQQAppInterface, axcy paramaxcy)
  {
    ...
    try
    {
      if ((paramaxcy.jdField_a_of_type_JavaUtilMap.containsKey("CtrlFlag")) && (Integer.parseInt((String)paramaxcy.jdField_a_of_type_JavaUtilMap.get("CtrlFlag")) == 1))
      {
    ...
    catch (Exception localException)
    {
      ...
      int j = Integer.parseInt((String)paramaxcy.jdField_a_of_type_JavaUtilMap.get("pushtype"));
  ...
  public void onWebEvent(String paramString, Bundle paramBundle)
  {
    ...
    paramBundle = (axcy)jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(i));
    ...
    b((axcy)jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(i)));
  }
}
