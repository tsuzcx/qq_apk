  ...
  extends ControlUIObserver
{
  ...
  public jqo(AVActivity paramAVActivity) {}
    ...
    if (this.jdField_a_of_type_ComTencentAvUiAVActivity.d == 9500) {
      if ((paramObject instanceof VcControllerImpl.DeviceCMDTLV))
      {
        ...
        if ((this.jdField_a_of_type_ComTencentAvUiAVActivity.jdField_a_of_type_ComTencentAvUiVideoControlUI instanceof DoubleVideoCtrlUI))
        {
          ...
          ((DoubleVideoCtrlUI)this.jdField_a_of_type_ComTencentAvUiAVActivity.jdField_a_of_type_ComTencentAvUiVideoControlUI).a(2131365371, true, 2130840137);
        }
      }
    }
    label299:
      ...
      do
      {
        do
        {
          do
          {
              ...
              do
              {
                ...
                for (;;)
                {
                  ...
                  if (((paramObject.jdField_b_of_type_Int & 0x8) == 8) && ((this.jdField_a_of_type_ComTencentAvUiAVActivity.jdField_a_of_type_ComTencentAvUiVideoControlUI instanceof DoubleVideoCtrlUI)))
                  {
                    ...
                    this.jdField_a_of_type_ComTencentAvUiAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().postDelayed(new jqr(this, localDoubleVideoCtrlUI), 500L);
                  }
                  if (((paramObject.jdField_b_of_type_Int & 0x2) == 2) && ((this.jdField_a_of_type_ComTencentAvUiAVActivity.jdField_a_of_type_ComTencentAvUiVideoControlUI instanceof DoubleVideoCtrlUI)))
                  {
                    ...
                    this.jdField_a_of_type_ComTencentAvUiAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().postDelayed(new jqs(this, paramObject), 500L);
                  }
                  return;
                  if (((paramObject.jdField_b_of_type_Int & 0x1) == 0) && ((this.jdField_a_of_type_ComTencentAvUiAVActivity.jdField_a_of_type_ComTencentAvUiVideoControlUI instanceof DoubleVideoCtrlUI)))
                  {
                    ...
                    ((DoubleVideoCtrlUI)this.jdField_a_of_type_ComTencentAvUiAVActivity.jdField_a_of_type_ComTencentAvUiVideoControlUI).a(2131365371, false, 2130840137);
                  }
                }
            ...
            paramObject = (DoubleVideoCtrlUI)this.jdField_a_of_type_ComTencentAvUiAVActivity.jdField_a_of_type_ComTencentAvUiVideoControlUI;
            paramObject.a(2131429236, 2, 0, paramObject.a.getDimensionPixelSize(2131558448));
            return;
          ...
          paramObject = (DoubleVideoCtrlUI)this.jdField_a_of_type_ComTencentAvUiAVActivity.jdField_a_of_type_ComTencentAvUiVideoControlUI;
          paramObject.a(2131429237, 1, 0, paramObject.a.getDimensionPixelSize(2131558448));
          return;
  ...
  protected void a(ArrayList paramArrayList)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentAvUiAVActivity.jdField_a_of_type_ComTencentAvUiVideoLayerUI != null) && (paramArrayList != null))
    {
      ...
      Collections.sort(paramArrayList, new jqp(this));
      j = 0;
      if (j < paramArrayList.size())
      {
        ...
        if (this.jdField_a_of_type_ComTencentAvUiAVActivity.d == 3000)
        {
          ...
          localObject = String.format(this.jdField_a_of_type_ComTencentAvUiAVActivity.getString(2131428970), new Object[] { localObject });
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        break label304;
        label658:
        localObject = String.format(this.jdField_a_of_type_ComTencentAvUiAVActivity.getString(2131428969), new Object[] { localObject });
  ...
  protected void b()
  {
    ...
    for (;;)
    {
      ...
      localObject1 = String.format(this.jdField_a_of_type_ComTencentAvUiAVActivity.getString(2131429127), new Object[] { localObject2 });
      if (this.jdField_a_of_type_ComTencentAvUiAVActivity.jdField_a_of_type_ComTencentAvUiVideoControlUI != null) {
  ...
  protected void b(ArrayList paramArrayList)
  {
    if ((this.jdField_a_of_type_ComTencentAvUiAVActivity.jdField_a_of_type_ComTencentAvUiVideoLayerUI != null) && (paramArrayList != null))
    {
      ...
      Collections.sort(paramArrayList, new jqq(this));
      int i = 0;
  ...
  protected void g()
  {
    ViewGroup localViewGroup = (ViewGroup)this.jdField_a_of_type_ComTencentAvUiAVActivity.findViewById(2131365798);
  ...
  protected void r()
  {
    CharSequence localCharSequence = this.jdField_a_of_type_ComTencentAvUiAVActivity.getResources().getText(2131429585);
