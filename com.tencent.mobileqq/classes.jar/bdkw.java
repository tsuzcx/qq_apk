...
public class bdkw
{
  ...
  {
    return bdjq.a(bcyb.a().a(), null).a("Common_tips_dialog_interval");
  }
  
  public static String a()
  {
    return bdjq.a(bcyb.a().a(), null).b("Common_myapp_download_url");
  }
  ...
  public static String a(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      return bdjq.a(bcyb.a().a(), null).b(paramString);
      paramString = "Common_GC_InstallYYB_Install_Words";
      continue;
  ...
  {
    int i = 1;
    if (!bdjq.a(bcyb.a().a(), null).b("Common_Show_Dialog_Flag")) {}
    SharedPreferences.Editor localEditor;
    do
    {
      return;
      localObject = bcyb.a().a().getSharedPreferences("share_myAppApi", 0);
      localEditor = ((SharedPreferences)localObject).edit();
      if (bdjq.a(bcyb.a().a(), null).a("Common_Dialog_Only_Once_Flag"))
      {
        localEditor.putBoolean("SP_Has_shown_Dialog", true);
        localEditor.commit();
        return;
      }
      j = bdjq.a(bcyb.a().a(), null).a("Common_Max_Count");
    } while ((j == -1) || (j == 0));
  ...
  {
    SharedPreferences.Editor localEditor = bcyb.a().a().getSharedPreferences("share_myAppApi", 0).edit();
  ...
  {
    SharedPreferences localSharedPreferences = bcyb.a().a().getSharedPreferences("share_myAppApi", 0);
  ...
  {
    return bdjq.a(bcyb.a().a(), null).a("Common_require_root_interval");
  }
  ...
  {
    return bdjq.a(bcyb.a().a(), null).a("Common_root_autoinstall_flag") <= 0;
  }
  ...
  public static boolean d()
  {
    boolean bool2 = false;
    boolean bool1 = bool2;
    if (bdjl.a("com.tencent.android.qqdownloader") > 4001126)
    {
      bool1 = bool2;
      if (bdjq.a(bcyb.a().a(), null).b("Common_QQ_CARRY_IDENTITY")) {
        bool1 = true;
      }
    }
    return bool1;
  ...
  {
    Object localObject = bdjq.a(bcyb.a().a(), null).b("Common_Release_Control").trim();
    if (TextUtils.isEmpty((CharSequence)localObject)) {}
    do
    {
      do
    ...
    String str1 = String.valueOf(bcyb.a().a());
    if (str1 == null) {
      return false;
    }
  ...
  public static boolean f()
  {
    ...
    do
    {
      ...
      return true;
      i = bdjq.a(bcyb.a().a(), null).a("Common_Max_Count");
      bdii.c("OpenConfig-MyAppApi", " maxCount = " + i);
      if ((i == -1) || (i == 0)) {
        return true;
      }
  ...
  {
    return bdjq.a(bcyb.a().a(), null).b("Common_MyAppDownload_Flag");
  }
  
  public static boolean h()
  {
    return bdjq.a(bcyb.a().a(), null).b("Common_Detail_Page");
  }
  
  public static boolean i()
  {
    boolean bool2 = false;
    boolean bool3 = bdjq.a(bcyb.a().a(), null).c("Common_tmast_wake");
    long l1 = bdjq.a(bcyb.a().a(), null).a("Common_wake_limite");
    long l2 = bdjq.a(bcyb.a().a(), null).a("Common_wake_interval") * 1000L;
    SharedPreferences localSharedPreferences = bcyb.a().a().getSharedPreferences("share_myAppApi", 0);
    ...
    bdii.c("TAMST_WAKE", ">>allowTmastWake allowWake = " + bool3 + " wakeLimit = " + l1 + " wakeInterval = " + l2 + " wakeTimes = " + i + " isToday = " + bool4);
    boolean bool1 = bool2;
    if (bool3)
    {
      bool1 = bool2;
  ...
  {
    return bdjq.a(bcyb.a().a(), null).b("Common_yyb_wifi_download_Switch");
  }
}
