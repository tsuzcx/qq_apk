...
public class biqi
  implements Observer
{
  private ServiceConnection jdField_a_of_type_AndroidContentServiceConnection = new biqo(this);
  ...
  public biqi(QQAppInterface paramQQAppInterface)
  {
  ...
  private Bundle a(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        paramBundle = this.jdField_a_of_type_Biqp.a("com.qqdataline.action.notify", paramBundle);
        if (paramBundle != null) {
          paramBundle.setClassLoader(getClass().getClassLoader());
        }
        return paramBundle;
  ...
  private void a(Bundle paramBundle, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_Biqp.a("com.qqdataline.action.notify", paramBundle);
        return;
      }
      catch (Exception paramBundle)
      {
  ...
  private Bundle b(Bundle paramBundle)
  {
    ...
    if (((String)localObject2).equals("DatalineHandler_sendC2CMessage_ToService"))
    {
      ...
      paramBundle.putParcelable("ToServiceMsg", ((allz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(8)).a(l1, (String)localObject1, i, j, k, (byte[])localObject2, l2));
    }
    do
    {
      do
      {
        do
        {
          do
          {
            ...
            {
              ((allz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(8)).sendPbReq((ToServiceMsg)paramBundle.getParcelable("ToServiceMsg"));
              return null;
            }
          ...
          localObject2 = ((amjg)localObject2).a();
          paramBundle = (Bundle)localObject1;
      ...
      if (((String)localObject2).equals("DatalineHandler_saveFileManagerEntity"))
      {
        ...
        paramBundle = arni.a((String)localObject1);
        ...
        localFileManagerEntity.fileSize = arni.a((String)localObject1);
        localFileManagerEntity.isReaded = true;
        localFileManagerEntity.peerUin = ((String)localObject2);
        if (l1 == 0L) {}
        for (localFileManagerEntity.peerNick = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131694652);; localFileManagerEntity.peerNick = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131694664))
        {
  ...
  private void b()
  {
    if ((this.jdField_a_of_type_Biqp == null) && (!this.jdField_a_of_type_Boolean))
    {
  ...
  private void d()
  {
    ...
    {
      CheckPermission.requestSDCardPermission(BaseActivity.sTopActivity, new biqk(this));
      return;
    }
    f();
  }
  ...
  private void f()
  {
    a(0);
    this.b = false;
    this.jdField_a_of_type_Bdfq = bdcd.a(BaseActivity.sTopActivity, 230, alpo.a(2131703139), alpo.a(2131703143), 2131694804, 2131721490, new biql(this), new biqm(this));
    this.jdField_a_of_type_Bdfq.setOnDismissListener(new biqn(this));
    TextView localTextView = (TextView)this.jdField_a_of_type_Bdfq.findViewById(2131365231);
    LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(-2, -2);
    localLayoutParams.gravity = 17;
    localTextView.setLayoutParams(localLayoutParams);
    localTextView.setMinHeight(bcwh.a(BaseActivity.sTopActivity, 35.0F));
    ...
    for (;;)
    {
      ...
      while (!this.jdField_a_of_type_JavaUtilArrayList.isEmpty())
      {
        ...
        try
        {
          ...
          localObject1 = localObject2;
          this.jdField_a_of_type_Biqp.a("com.qqdataline.action.notify", localBundle);
          localObject1 = localObject2;
          if (!QLog.isColorLevel()) {
            continue;
          }
  ...
  private void i()
  {
    ...
    localPluginCommunicationHandler.register(new biqj(this, "dataline.remotecall"));
  }
  ...
  private void k()
  {
    ...
    biqg.a(BaseActivity.sTopActivity, (Bundle)localObject, "com.qqdataline.activity.LiteWifiphotoActivity");
  ...
  public biqh a()
  {
    ...
    biqh localbiqh = new biqh();
    localbiqh.jdField_a_of_type_JavaLangString = localBundle.getString("ServerInfo.serverIp");
    localbiqh.jdField_a_of_type_Int = localBundle.getInt("ServerInfo.serverPort");
    return localbiqh;
  }
  ...
  {
    if ((paramawbv instanceof DataLineMsgRecord)) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(0).a(paramawbv, paramamji);
    }
    while (!(paramawbv instanceof MpfileTaskRecord)) {
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a((MpfileTaskRecord)paramawbv);
  }
  
  public void a(MpfileTaskInfo paramMpfileTaskInfo, long paramLong)
  {
    FileManagerEntity localFileManagerEntity = arni.a(paramMpfileTaskInfo, paramLong);
  ...
  public void a(String paramString1, ContentValues paramContentValues, String paramString2, String[] paramArrayOfString, amji paramamji)
  {
    if (paramString1.equals(DataLineMsgRecord.tableName())) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(0).a(paramString1, paramContentValues, paramString2, paramArrayOfString, paramamji);
    }
    while (!paramString1.equals(MpfileTaskRecord.tableName())) {
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a(paramString1, paramContentValues, paramString2, paramArrayOfString, paramamji);
  }
  
  public void a(String paramString1, String paramString2, String[] paramArrayOfString, amji paramamji)
  {
    if (paramString1.equals(DataLineMsgRecord.tableName())) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(0).a(paramString1, paramString2, paramArrayOfString, paramamji);
    }
    while (!paramString1.equals(MpfileTaskRecord.tableName())) {
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a(paramString1, paramString2, paramArrayOfString, paramamji);
  }
