...
public class bfgt
{
  public static axap a(bfgy parambfgy)
  {
    if (parambfgy != null)
    {
      axap localaxap = new axap();
      localaxap.jdField_c_of_type_JavaLangString = parambfgy.b;
      String str = parambfgy.jdField_a_of_type_JavaLangString;
      localaxap.jdField_a_of_type_JavaLangString = str;
      localaxap.d = str;
      localaxap.jdField_a_of_type_Long = parambfgy.jdField_a_of_type_Int;
      localaxap.jdField_c_of_type_Boolean = true;
      return localaxap;
    }
    return null;
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    return c(((bfgp)paramQQAppInterface.getManager(346)).a(paramString1, paramString2));
  }
  ...
  public static ArrayList<bkok> a(QQAppInterface paramQQAppInterface, String paramString)
  {
    if (TextUtils.isEmpty(paramString)) {
      return null;
    }
    paramString = ((bfgp)paramQQAppInterface.getManager(346)).a(paramString);
    ...
    {
      bfgy localbfgy = (bfgy)paramString.next();
      bkok localbkok = new bkok();
      localbkok.jdField_a_of_type_JavaLangString = localbfgy.b;
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString, NavBarAIO paramNavBarAIO, ImageView paramImageView1, ImageView paramImageView2, boolean paramBoolean)
  {
    ...
    bfgp localbfgp = (bfgp)paramQQAppInterface.getManager(346);
    if (!localbfgp.b(paramString))
    {
    ...
    localbfgp.b(paramString, paramQQAppInterface.getCurrentAccountUin(), new bfgu(paramNavBarAIO, paramImageView1, paramImageView2, paramBoolean, paramQQAppInterface, paramString, paramActivity));
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    return !((bftx)paramQQAppInterface.getManager(203)).b(paramMessageRecord.senderuin);
  }
  ...
  public static String b(List<bfgy> paramList)
  {
    if ((paramList == null) || (paramList.size() == 0)) {
      return "";
    }
    ...
    while (i < paramList.size())
    {
      localStringBuilder.append(((bfgy)paramList.get(i)).jdField_a_of_type_Int);
      if (i != paramList.size() - 1) {
        localStringBuilder.append("|");
      }
      i += 1;
  ...
  public static String c(List<bfgy> paramList)
  {
    StringBuilder localStringBuilder = new StringBuilder();
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      while (paramList.hasNext()) {
        localStringBuilder.append(((bfgy)paramList.next()).jdField_a_of_type_JavaLangString);
      }
    }
    return localStringBuilder.toString();
  }
