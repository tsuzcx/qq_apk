...
public class bfgt
{
  ...
  static
  {
    jdField_a_of_type_JavaUtilComparator = new bfgv();
    jdField_b_of_type_JavaUtilComparator = new bfgu();
  ...
  public static String b(String paramString)
  {
    try
    {
      paramString = bfgo.a(a(paramString.getBytes("UTF-8")));
      return paramString;
    }
  ...
  public static String c(String paramString)
  {
    ...
    paramString = new bfgt().b(paramString);
