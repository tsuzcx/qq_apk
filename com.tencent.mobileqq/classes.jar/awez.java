...
public class awez
{
  ...
  public static final String[] b = { "XG预下载配额余量", "XG当前消耗流量", "XG流量总消耗", "XG预下载总数", "XG预下载命中数", "XG预下载未命中数", "XG手动看图数", "XG消耗量余量", "WIFI预下载总数", "WIFI预下载命中数", "WIFI预下载未命中数", "WIFI手动看图数", "XG是否超过上限", alpo.a(2131708537) };
  ...
  public static int a(QQAppInterface paramQQAppInterface, int paramInt, String paramString)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        try
        {
          bool = atwd.a().a(paramQQAppInterface, paramString);
          if (paramInt != 3000) {
            break label69;
          }
          j = 1;
  ...
  public static long a(QQAppInterface paramQQAppInterface, String paramString, long paramLong)
  {
    ...
    //   35: invokestatic 204	awez:a	(Ljava/lang/String;J)V
    //   38: ldc 206
    //   40: ldc 208
    ...
    //   80: invokestatic 235	awen:a	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   83: lload 4
    //   85: lreturn
    //   86: aload_1
    //   87: lload_2
    //   88: invokestatic 204	awez:a	(Ljava/lang/String;J)V
    //   91: lload_2
    //   92: lstore 4
    //   94: goto -56 -> 38
    //   97: astore_0
  ...
  public static void a(QQAppInterface paramQQAppInterface, baub parambaub)
  {
    if (parambaub == null) {}
    while ((!(parambaub.a instanceof MessageForPic)) || (parambaub.b == 65537)) {
      return;
    }
    MessageForPic localMessageForPic = (MessageForPic)parambaub.a;
    awen.a("PIC_TAG_PRELOAD", "updateDownState", "Before update, networkType:" + localMessageForPic.preDownNetworkType + ",state:" + localMessageForPic.preDownState + ",uniseq:" + localMessageForPic.uniseq);
    if (parambaub.g == 1) {
      localMessageForPic.preDownState = 1;
    }
    for (;;)
    {
      awen.a("PIC_TAG_PRELOAD", "updateDownState", "After update, networkType:" + localMessageForPic.preDownNetworkType + ",state:" + localMessageForPic.preDownState + ",uniseq:" + localMessageForPic.uniseq);
    ...
    do
    {
      do
      {
        ...
        do
        {
          ...
          {
            return;
            awen.a("PIC_TAG_PRELOAD", "updateMsg", "uniseq:" + paramMessageForPic.uniseq + ",network:" + paramMessageForPic.preDownNetworkType + "state:" + paramMessageForPic.preDownState);
        ...
        localazsp.a = paramMessageForPic;
  ...
  public static void b(QQAppInterface paramQQAppInterface, MessageForPic paramMessageForPic)
  {
    ...
    awen.a("PIC_TAG_PRELOAD", "updateDownState4SD", "networkType:" + paramMessageForPic.preDownNetworkType + ",state:" + paramMessageForPic.preDownState + ",uniseq:" + paramMessageForPic.uniseq);
