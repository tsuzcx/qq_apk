...
public class ahxq
  implements Runnable
{
  public ahxq(VideoSprite paramVideoSprite, String paramString, int paramInt) {}
  ...
  public void run()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqSurfaceviewactionGlVideoSprite.jdField_a_of_type_AndroidMediaMediaPlayer.setOnSeekCompleteListener(new ahxr(this));
