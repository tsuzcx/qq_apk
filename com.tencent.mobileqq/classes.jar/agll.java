  ...
  extends agkr
{
  ...
  public agll(int paramInt, AIOAnimationConatiner paramAIOAnimationConatiner, ListView paramListView)
  {
  ...
  private BaseChatItemLayout a(long paramLong)
  {
    ...
    if (paramLong == 0L)
    {
      ...
      while (k < this.jdField_a_of_type_ComTencentWidgetListView.getChildCount())
      {
        ...
        {
          localObject2 = (aggl)agej.a((View)localObject1);
          if ((((aggl)localObject2).jdField_a_of_type_Int != 0) && (((aggl)localObject2).jdField_a_of_type_AndroidViewView.getTop() + ((View)localObject1).getTop() + BaseChatItemLayout.h > 0)) {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          if (((localObject2 instanceof BaseChatItemLayout)) && (((aggl)agej.a((View)localObject2)).jdField_a_of_type_Int != 0)) {
  ...
  private void a(agky paramagky, ChatMessage paramChatMessage)
  {
    aglk.a(null, "0X800B072", paramChatMessage.frienduin, paramagky);
  }
  
  private void a(Object[] paramArrayOfObject)
  {
    if ((paramArrayOfObject.length < 5) || (!(paramArrayOfObject[3] instanceof agky)) || (!(paramArrayOfObject[4] instanceof ChatMessage))) {}
    agky localagky;
    do
    {
      return;
      localagky = (agky)paramArrayOfObject[3];
    } while (!a(localagky.a));
    paramArrayOfObject = (ChatMessage)paramArrayOfObject[4];
    if (QLog.isColorLevel()) {
      QLog.d("FloorJumper", 2, "set jump url, url = " + localagky.a);
    }
    this.jdField_a_of_type_AndroidViewView.setOnClickListener(new aglm(this, localagky, paramArrayOfObject));
  }
  ...
  int a(int paramInt, aggl paramaggl)
  {
    int k;
    int m;
    int n;
    if (paramaggl.jdField_a_of_type_ComTencentMobileqqDataChatMessage.isSend())
    {
      k = paramaggl.jdField_a_of_type_AndroidViewView.getLeft() + BaseChatItemLayout.k + BaseChatItemLayout.p;
      m = paramaggl.jdField_a_of_type_AndroidViewView.getRight() - BaseChatItemLayout.j - BaseChatItemLayout.o;
      if (paramInt > k) {
        break label135;
      }
    ...
    {
      return n;
      k = paramaggl.jdField_a_of_type_AndroidViewView.getLeft() + BaseChatItemLayout.j + BaseChatItemLayout.o;
      m = paramaggl.jdField_a_of_type_AndroidViewView.getRight() - BaseChatItemLayout.k - BaseChatItemLayout.k;
      break;
      d1 = Math.random();
  ...
  public long a()
  {
    ...
    case 3: 
      ...
      if (this.jdField_b_of_type_Int == 1)
      {
        ...
        {
          localaggl = (aggl)agej.a(localBaseChatItemLayout);
          if (localaggl != null)
          {
            this.jdField_b_of_type_Int = 2;
            this.jdField_a_of_type_Long = 0L;
            this.jdField_b_of_type_Long = localaggl.jdField_a_of_type_ComTencentMobileqqDataChatMessage.uniseq;
            this.jdField_d_of_type_Long = 0L;
            this.jdField_e_of_type_Int = 0;
            k = localaggl.jdField_a_of_type_AndroidViewView.getTop();
            ...
            this.jdField_g_of_type_Int = a((localaggl.jdField_a_of_type_AndroidViewView.getLeft() + localaggl.jdField_a_of_type_AndroidViewView.getRight()) / 2, localaggl);
            this.h = 0;
      ...
      if (localBaseChatItemLayout != null)
      {
        ...
        if (localaggl != null)
        {
          ...
          this.jdField_e_of_type_Int = (a(this.i, localaggl) - this.i);
  ...
  public boolean a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      while ((this.jdField_a_of_type_ComTencentMobileqqActivityAioAnimAIOAnimationConatiner == null) || (this.jdField_a_of_type_AndroidViewView == null))
      {
        ...
        return false;
        k = agej.a(this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentWidgetListView.getAdapter());
        ...
        {
          aggl localaggl = (aggl)agej.a(agej.a(this.jdField_a_of_type_ComTencentWidgetListView, k));
          if (localaggl != null)
          {
            k = localaggl.jdField_a_of_type_AndroidViewView.getTop();
            k = localaggl.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() + k + BaseChatItemLayout.h - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - (this.h + this.jdField_f_of_type_Int);
            if (k != 0)
            {
              this.h += k;
              this.j += k;
          ...
          else
          {
            ...
            return false;
            k = agej.a(this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentWidgetListView.getAdapter());
            int m = agej.a(this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentWidgetListView.getAdapter());
            ...
            {
              localaggl = (aggl)agej.a(agej.a(this.jdField_a_of_type_ComTencentWidgetListView, k));
              if (localaggl != null)
              {
                k = localaggl.jdField_a_of_type_AndroidViewView.getTop();
                k = localaggl.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() + k + BaseChatItemLayout.h - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - (this.h + this.jdField_f_of_type_Int);
            ...
            {
              localaggl = (aggl)agej.a(agej.a(this.jdField_a_of_type_ComTencentWidgetListView, m));
              if (localaggl != null)
              {
                k = localaggl.jdField_a_of_type_AndroidViewView.getTop();
                k = localaggl.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() + k + BaseChatItemLayout.h - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - (this.h + this.jdField_f_of_type_Int);
