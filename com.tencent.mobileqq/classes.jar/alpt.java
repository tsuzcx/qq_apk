  ...
  extends alpc
{
  ...
  public static final ArrayList<WeakReference<alpt>> a;
  private static String e = "";
  protected SongInfo a;
  private WeakReference<alpt> jdField_a_of_type_JavaLangRefWeakReference;
  protected long c = 0L;
  protected String d;
  ...
  public alpt(ark.Application paramApplication, long paramLong)
  {
    super(paramApplication, paramLong);
    jdField_a_of_type_Alpu = new alpu(this.jdField_a_of_type_JavaLangString);
  ...
  {
    QQPlayerService.c(jdField_a_of_type_Alpu);
  ...
  public boolean Invoke(String paramString, ark.VariantWrapper[] paramArrayOfVariantWrapper, ark.VariantWrapper paramVariantWrapper)
  {
    ...
    if (paramString.equals("SetCallback"))
    {
      ...
      QQPlayerService.b(jdField_a_of_type_Alpu);
      QQPlayerService.a(null);
      return true;
    }
