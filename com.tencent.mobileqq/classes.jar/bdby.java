  ...
  implements Manager
{
  ...
  private final bcni jdField_a_of_type_Bcni;
  private bgpa jdField_a_of_type_Bgpa;
  private final QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private final String jdField_a_of_type_JavaLangString;
  private final List<bdbz> jdField_a_of_type_JavaUtilList;
  ...
  public bdby(@NotNull QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Bcni = ((bcni)new bdce(this));
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver((anil)this.jdField_a_of_type_Bcni);
  }
  ...
  private final void a(int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      if (((bcnd)localObject).a(bool1, paramInt1, paramBoolean, bool2)) {
        break label165;
      }
      if (QLog.isColorLevel()) {
        QLog.d(this.jdField_a_of_type_JavaLangString, 2, "doChangeMode switching");
      }
      QQToast.a((Context)BaseApplication.getContext(), 0, 2131717855, 0).a();
      localObject = ((Iterable)this.jdField_a_of_type_JavaUtilList).iterator();
      while (((Iterator)localObject).hasNext()) {
        ((bdbz)((Iterator)localObject).next()).d(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      }
      bool1 = false;
      break;
      label159:
    ...
    localObject = ((Iterable)this.jdField_a_of_type_JavaUtilList).iterator();
    while (((Iterator)localObject).hasNext()) {
      ((bdbz)((Iterator)localObject).next()).b(paramInt2, paramInt3);
    }
  }
  ...
  private final void a(boolean paramBoolean, String paramString)
  {
    ...
    while (localIterator.hasNext()) {
      ((bdbz)localIterator.next()).a(paramBoolean, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, paramString);
    }
    if ((paramBoolean) && ((this.jdField_a_of_type_Int == 2) || (this.jdField_b_of_type_Int == 2))) {
      bgsg.a((Context)BaseApplicationImpl.context, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), true, "study_mode_has_change", Boolean.valueOf(true));
    }
  }
  ...
  private final void b()
  {
    ...
    for (int i = 1;; i = 2)
    {
      ...
      bgsg.a((Context)BaseApplicationImpl.context, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), true, "study_mode_last_report_time", localSimpleDateFormat.format(new Date()));
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800AD6C", "0X800AD6C", 0, i, "", "", "", "");
      return;
    }
  }
  ...
  {
    Object localObject1 = (String)bgsg.b((Context)BaseApplicationImpl.context, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "study_mode_last_report_time", "");
  ...
  private final void d(boolean paramBoolean)
  {
    ...
    for (String str = BaseApplicationImpl.getContext().getString(2131693719, new Object[] { str });; str = BaseApplicationImpl.getContext().getString(2131693721, new Object[] { str }))
    {
  ...
  private final void e(boolean paramBoolean)
  {
    if (!paramBoolean)
    {
      String str = BaseApplicationImpl.getContext().getString(2131693720);
  ...
  @NotNull
  public final bdcb a(@NotNull Activity paramActivity, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if ((!this.jdField_a_of_type_Boolean) && ((i != paramInt1) || (paramInt2 != this.c)))
    {
      ...
      {
        QQToast.a((Context)BaseApplication.getContext(), 1, 2131693991, 0).a();
        paramActivity = ((Iterable)this.jdField_a_of_type_JavaUtilList).iterator();
        while (paramActivity.hasNext()) {
          ((bdbz)paramActivity.next()).c(paramInt1, i);
        }
        return new bdcb(false, paramInt1, i);
      }
      if (paramInt1 == 1)
      {
        ...
        if (((SharedPreferences)localObject).getBoolean("key_simple_should_show_switch_dialog", true))
        {
          ...
          localObject = (DialogInterface.OnClickListener)new bdcd(this, paramInt2, paramInt1, i, paramBoolean);
          bgpa localbgpa = this.jdField_a_of_type_Bgpa;
          if (localbgpa != null) {
            localbgpa.dismiss();
          }
          this.jdField_a_of_type_Bgpa = bglp.a(paramActivity, BaseApplicationImpl.getContext().getString(2131717850), 0, 2131717848, (DialogInterface.OnClickListener)localObject, null);
          paramActivity = this.jdField_a_of_type_Bgpa;
          if (paramActivity == null) {
            Intrinsics.throwNpe();
          }
          paramActivity.setOnDismissListener((DialogInterface.OnDismissListener)new bdcc(this, paramInt1, i));
          paramActivity = this.jdField_a_of_type_Bgpa;
          if (paramActivity == null) {
            Intrinsics.throwNpe();
          }
      ...
      for (;;)
      {
        return new bdcb(true, paramInt1, i);
        a(paramInt2, paramInt1, i, paramBoolean);
        continue;
        a(paramInt2, paramInt1, i, paramBoolean);
      }
    }
    return new bdcb(this.jdField_a_of_type_Boolean, paramInt1, i);
  }
  ...
  public final void a(@Nullable bdbz parambdbz)
  {
    if (parambdbz != null) {
      this.jdField_a_of_type_JavaUtilList.add(parambdbz);
    }
  }
  ...
  public final void a(@NotNull BaseActivity paramBaseActivity)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((this.d == 2) && (this.e == 1) && (bdch.c()) && (!((Boolean)bgsg.b((Context)paramBaseActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "study_mode_has_change", Boolean.valueOf(false))).booleanValue()) && (!((Boolean)bgsg.b((Context)paramBaseActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "study_mode_change_dialog_has_show", Boolean.valueOf(false))).booleanValue()))
      {
        new bdcl(paramBaseActivity).show();
        bgsg.a((Context)BaseApplicationImpl.context, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), true, "study_mode_change_dialog_has_show", Boolean.valueOf(true));
      }
      return;
    }
  }
  ...
  public final void b(@Nullable bdbz parambdbz)
  {
    if ((parambdbz != null) && (this.jdField_a_of_type_JavaUtilList.contains(parambdbz))) {
      this.jdField_a_of_type_JavaUtilList.remove(parambdbz);
    }
  }
  ...
  public void onDestroy()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver((anil)this.jdField_a_of_type_Bcni);
    a();
