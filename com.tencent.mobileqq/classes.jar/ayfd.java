...
public class ayfd
  extends atwf
{
  public ayfd(TroopAvatarWallPreviewActivity paramTroopAvatarWallPreviewActivity) {}
  ...
  public void a(boolean paramBoolean, String paramString, long paramLong1, long paramLong2)
  {
    ...
    do
    {
      ...
      {
        return;
      } while ((this.a.jdField_a_of_type_Int < 0) || (this.a.jdField_a_of_type_Int > this.a.jdField_a_of_type_Aznl.getCount() - 1) || (this.a.jdField_b_of_type_JavaUtilArrayList == null) || (this.a.jdField_a_of_type_Int > this.a.jdField_b_of_type_JavaUtilArrayList.size() - 1));
    ...
    if (paramBoolean) {}
    for (paramString = this.a.getResources().getString(2131627148);; paramString = this.a.getResources().getString(2131625936))
    {
      ...
      if (this.a.jdField_a_of_type_Int >= this.a.jdField_a_of_type_Aznl.getCount())
      {
        paramString = this.a;
      ...
      this.a.jdField_a_of_type_Aznl.notifyDataSetChanged();
      return;
    }
  }
}
