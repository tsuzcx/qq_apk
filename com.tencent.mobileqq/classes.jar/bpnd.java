...
public class bpnd
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = alrs.jdField_d_of_type_JavaLangString + "pddata/prd/dov_capture_qsvf" + File.separator;
    jdField_b_of_type_JavaLangString = jdField_a_of_type_JavaLangString + "capture_res" + File.separator;
    e = alrs.jdField_d_of_type_JavaLangString + "qav" + File.separator + "beauty" + File.separator;
