  ...
  implements View.OnClickListener
{
  ...
  public arqf(Context paramContext)
  {
  ...
  private void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3)
  {
    ...
    try
    {
      ...
      paramQQAppInterface = bbej.a(paramQQAppInterface, this.jdField_a_of_type_AndroidContentContext, paramString1);
  ...
  private void a(String paramString1, String paramString2, String paramString3, List<String> paramList, int paramInt)
  {
    ...
    for (paramList = (String)paramList.get(0);; paramList = null)
    {
      if ("url".equals(paramString2))
      {
        ...
        paramString2 = arqe.a("banner_exp");
      ...
      paramString2 = arqe.a("banner_clk");
      paramString2.jdField_b_of_type_Int = i;
      paramString2.a = paramString3;
      paramString2.jdField_b_of_type_JavaLangString = paramList;
      paramString2.e = paramString1;
  ...
  {
    ((LebaRoundLayout)paramView.findViewById(2131363712)).a = bbkx.a(16.0F);
    Object localObject = (LinearLayout)paramView.findViewById(2131369436);
    if (ThemeUtil.isNowThemeIsNight(paramAppRuntime, false, null))
    {
      ((LinearLayout)localObject).setBackgroundResource(2130840183);
    ...
    for (;;)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if ((localRedTypeInfo.red_type.get() == 5) || (localRedTypeInfo.red_type.get() == 4)) {
          try
          {
            ...
            localJSONObject.put("cr", String.format("#%06X", new Object[] { Integer.valueOf(0xFFFFFF & this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166861)) }));
      ...
      ((LinearLayout)localObject).setBackgroundResource(2130839132);
      break;
      label240:
      paramView = paramView.findViewById(2131369359);
      paramView = new RedTouch(this.jdField_a_of_type_AndroidContentContext, paramView).c(bbkx.b(5.0F)).b(bbkx.b(1.0F)).a(3).a();
    ...
    if ((!this.jdField_a_of_type_JavaUtilHashSet.contains(Integer.valueOf(paramAppInfo.uiAppId.get()))) && (paramAppInfo.iNewFlag.get() != 0))
    {
      ...
      ((avpq)paramAppRuntime.getManager(36)).a(paramAppInfo.uiAppId.get(), 30);
    ...
    try
    {
      ...
      if (AppSetting.d) {
        bawi.a(paramView, paramView.a(), Button.class.getName());
      }
      return;
    }
  ...
  public void onClick(View paramView)
  {
    ...
    paramView = (avpq)localAppRuntime.getManager(36);
    if (paramView != null)
    {
