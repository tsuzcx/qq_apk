...
public class alxc
  extends BaseAdapter
{
  alxd jdField_a_of_type_Alxd;
  LayoutInflater jdField_a_of_type_AndroidViewLayoutInflater;
  
  public alxc(CreateFaceToFaceDiscussionActivity paramCreateFaceToFaceDiscussionActivity)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561163, null);
      this.jdField_a_of_type_Alxd = new alxd(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberCreateFaceToFaceDiscussionActivity);
      this.jdField_a_of_type_Alxd.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368381));
      this.jdField_a_of_type_Alxd.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131371803));
      paramView.setTag(this.jdField_a_of_type_Alxd);
    }
    label238:
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        return paramView;
        this.jdField_a_of_type_Alxd = ((alxd)paramView.getTag());
        if (!this.jdField_a_of_type_Alxd.jdField_a_of_type_Boolean) {
          break label238;
        }
        paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561163, null);
        this.jdField_a_of_type_Alxd = new alxd(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberCreateFaceToFaceDiscussionActivity);
        ...
        this.jdField_a_of_type_Alxd.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131371803));
        paramView.setTag(this.jdField_a_of_type_Alxd);
        this.jdField_a_of_type_Alxd.jdField_a_of_type_Boolean = false;
        break;
