...
public class vxg
  extends vxk
{
  public vxg(TroopStoryMemoriesListAdapter paramTroopStoryMemoriesListAdapter, View paramView)
  {
  ...
  public void a(TroopStoryItemInfo paramTroopStoryItemInfo, int paramInt)
  {
    ...
    try
    {
      ...
      localDrawable = this.jdField_a_of_type_ComTencentBizQqstoryTroopMemoriesTroopStoryMemoriesListAdapter.a.getResources().getDrawable(2130845986);
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131715788));
      this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-65536);
      this.jdField_a_of_type_AndroidViewView.setOnClickListener(new vxh(this, paramTroopStoryItemInfo));
      return;
    }
