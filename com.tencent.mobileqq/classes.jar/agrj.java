  ...
  implements View.OnClickListener
{
  ...
  public agrj(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo)
  {
  ...
  private View a(View paramView, agrk paramagrk)
  {
    View localView = paramView;
    if (paramView == null)
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558870, null);
      paramagrk.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131365073);
      paramagrk.jdField_c_of_type_AndroidViewView = paramView.findViewById(2131370601);
      paramagrk.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131363452));
      paramagrk.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131369862));
      paramagrk.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131376460));
      paramagrk.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131369941));
      paramagrk.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131369942));
      paramagrk.d = ((TextView)paramView.findViewById(2131378669));
      paramagrk.jdField_b_of_type_AndroidViewView.setOnTouchListener(mum.a);
      localView = paramView;
      if (e)
      {
        paramagrk.jdField_b_of_type_JavaLangStringBuilder = new StringBuilder();
        localView = paramView;
      }
    }
    if (e)
    {
      ...
      paramagrk.jdField_b_of_type_JavaLangStringBuilder.replace(0, paramagrk.jdField_b_of_type_JavaLangStringBuilder.length(), "");
    }
    return localView;
  }
  ...
  protected View a(MessageRecord paramMessageRecord, aexg paramaexg, View paramView, LinearLayout paramLinearLayout, afce paramafce)
  {
    ...
    paramMessageRecord = (agrk)paramaexg;
    ...
    if ((!TextUtils.isEmpty(paramLinearLayout.url1)) && (!TextUtils.isEmpty(paramLinearLayout.url2)))
    {
      ...
      paramafce = a(false, paramLinearLayout.url2);
      a(paramMessageRecord.jdField_b_of_type_AndroidWidgetImageView, paramView);
      a(paramMessageRecord.jdField_c_of_type_AndroidWidgetImageView, paramafce);
      a(paramMessageRecord.jdField_a_of_type_AndroidWidgetImageView, null);
      paramView = agjq.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendNick, 6);
      paramView = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131689970, new Object[] { paramView, Integer.valueOf(paramLinearLayout.countInc) });
    ...
    for (;;)
    {
      paramView = bfzl.a(this.jdField_a_of_type_AndroidContentContext, 7, paramLinearLayout.upTime * 1000L);
      ...
      if (e)
      {
        ...
        paramaexg.setContentDescription(paramMessageRecord.jdField_b_of_type_JavaLangStringBuilder.toString());
      }
      paramMessageRecord.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
      bdcf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "0X800AE5F", 0);
      return paramaexg;
  ...
  {
    agrk localagrk = (agrk)paramView.getTag();
    if (localagrk == null) {}
    for (;;)
    {
      EventCollector.getInstance().onViewClicked(paramView);
      return;
      PhotoWallView.a((Activity)paramView.getContext(), localagrk.jdField_a_of_type_JavaLangString, false);
      if (QLog.isColorLevel()) {
        QLog.d("TofuNicePicsItemBuilder", 2, "jump photowall:" + localagrk.jdField_a_of_type_JavaLangString);
      }
      bdcf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "0X800AE60", 0);
    }
  }
}
