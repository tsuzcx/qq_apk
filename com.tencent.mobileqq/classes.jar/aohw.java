  ...
  implements aomd
{
  ...
  protected LinkedHashMap<Long, aohx> a;
  ...
  protected final aohx a(long paramLong)
  {
    ...
    aohx localaohx = (aohx)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(Long.valueOf(paramLong));
    return localaohx;
  }
  ...
  protected final void a(aohx paramaohx)
  {
    if (paramaohx == null)
    {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilLinkedHashMap)
    {
      QLog.i("BaseThumbDownloader<FileAssistant>", 2, "[downloadThumb]  ID[" + paramaohx.jdField_a_of_type_Long + "] addSession");
      this.jdField_a_of_type_JavaUtilLinkedHashMap.put(Long.valueOf(paramaohx.jdField_a_of_type_Long), paramaohx);
      if (QLog.isDevelopLevel())
      {
        paramaohx = this.jdField_a_of_type_JavaUtilLinkedHashMap.keySet().iterator();
        if (paramaohx.hasNext())
        {
          long l = ((Long)paramaohx.next()).longValue();
  ...
  protected void a(aohx paramaohx, String paramString)
  {
    if ((paramaohx.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.mContext != null) && ((paramaohx.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.mContext instanceof String)) && ("igonFlow".equalsIgnoreCase((String)paramaohx.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.mContext))) {
      paramaohx.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.mContext = null;
    }
    for (int i = 1;; i = 0)
    {
      if ((i == 0) && (!aonj.a()) && (apck.a()))
      {
        QLog.i("BaseThumbDownloader<FileAssistant>", 1, "[downloadThumb] Id[" + paramaohx.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId + "] size(wh)[" + paramaohx.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.imgWidth + ":" + paramaohx.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.imgHeight + "]autoDownload Thumb switch is off!");
        return;
      }
      long l = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a(paramString, this);
      if (l == -1L)
      {
        QLog.w("BaseThumbDownloader<FileAssistant>", 1, "[downloadThumb] Id[" + paramaohx.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId + "] size(wh)[" + paramaohx.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.imgWidth + ":" + paramaohx.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.imgHeight + "] thumb is Downloading,waiting please!");
        return;
      }
      paramString = paramaohx.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity;
      ...
      paramaohx.jdField_a_of_type_Long = l;
      a(paramaohx);
