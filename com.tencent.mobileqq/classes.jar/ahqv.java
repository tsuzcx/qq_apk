  ...
  implements ahqq
{
  ...
  public ahqv(BaseChatPie paramBaseChatPie, View.OnClickListener paramOnClickListener)
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie = paramBaseChatPie;
    this.jdField_a_of_type_AndroidViewView$OnClickListener = paramOnClickListener;
  }
  
  private void b(bddf parambddf, QQAppInterface paramQQAppInterface)
  {
    parambddf = parambddf.b(paramQQAppInterface);
    this.jdField_a_of_type_ComTencentMobileqqTogetherUiWatchPanelView.a(0, parambddf);
  }
  ...
  public View a(Object... paramVarArgs)
  {
    ...
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.getActivity()).inflate(2131560938, null));
    a();
  ...
  protected void a()
  {
    ...
    View localView = this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131372135);
  ...
  public void a(bddf parambddf, QQAppInterface paramQQAppInterface)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqTogetherUiWatchPanelView != null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqTogetherUiWatchPanelView.b(this.jdField_a_of_type_ComTencentMobileqqTogetherUiWatchPanelView.getResources().getString(parambddf.d()));
      this.jdField_a_of_type_ComTencentMobileqqTogetherUiWatchPanelView.a(parambddf.a(paramQQAppInterface), 2131166992);
      b(parambddf, paramQQAppInterface);
      this.jdField_a_of_type_ComTencentMobileqqTogetherUiWatchPanelView.a(parambddf.a());
      this.jdField_a_of_type_ComTencentMobileqqTogetherUiWatchPanelView.b(parambddf.b());
      this.jdField_a_of_type_ComTencentMobileqqTogetherUiWatchPanelView.a(parambddf.a());
      this.jdField_a_of_type_ComTencentMobileqqTogetherUiWatchPanelView.a(parambddf.f, paramQQAppInterface);
    }
  }
