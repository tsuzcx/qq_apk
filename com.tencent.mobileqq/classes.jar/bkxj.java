...
public class bkxj
{
  ...
  public bkxj(Context paramContext)
  {
    ...
    this.e = paramContext.getDimensionPixelSize(2131296669);
    this.f = this.e;
    this.g = paramContext.getDimensionPixelOffset(2131296671);
    this.h = paramContext.getDimensionPixelOffset(2131296672);
    this.jdField_a_of_type_Bkxo = new bkxo();
    int i = (paramContext.getDisplayMetrics().widthPixels - (int)(a() * 5.2F)) / (((int)5.2F + 1) * 2);
    b(i);
    a((int)(i * 6 / 5.5F));
  }
  
  private String a(List<bbjs> paramList)
  {
    Object localObject = "";
    int i = 0;
    if (i < paramList.size())
  ...
  protected View a()
  {
    ...
    this.jdField_a_of_type_Bkxo.a((RelativeLayout)localView.findViewById(2131362136));
    ...
    for (int j = 0;; j = 1)
    {
      ...
      for (int k = 0;; k = 1)
      {
        ...
        if (j != 0)
        {
          localObject4 = (GridView)localView.findViewById(2131367168);
          ...
          {
            if (((bbjs)((Iterator)localObject5).next()).d != 0) {
              break label885;
            }
            i += 1;
          }
        ...
        for (;;)
        {
          ...
          ((GridView)localObject4).setAdapter(new bkxl(this.jdField_a_of_type_AndroidContentContext, (List)localObject1));
          ...
          if (k != 0)
          {
            localObject1 = (GridView)localView.findViewById(2131367169);
            if (Build.VERSION.SDK_INT >= 9) {
          ...
          for (;;)
          {
            ...
            ((GridView)localObject1).setNumColumns(i);
            ((GridView)localObject1).setAdapter(new bkxl(this.jdField_a_of_type_AndroidContentContext, (List)localObject2));
            ...
            ((TextView)localObject1).setOnClickListener(new bkxk(this));
            if (j == 0) {
