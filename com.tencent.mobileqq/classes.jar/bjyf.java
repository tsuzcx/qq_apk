  ...
  implements INetEngine.INetEngineListener
{
  ...
  private WeakReference<bjyd> jdField_a_of_type_JavaLangRefWeakReference;
  private byte[] jdField_a_of_type_ArrayOfByte;
  private int b = -1;
  
  public bjyf(int paramInt1, bjyd parambjyd, byte[] paramArrayOfByte, int paramInt2, Object paramObject)
  {
    this.jdField_a_of_type_Int = paramInt1;
    this.b = paramInt2;
    this.jdField_a_of_type_JavaLangObject = paramObject;
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambjyd);
  ...
  public void onResp(NetResp paramNetResp)
  {
    ...
    bjyd localbjyd = (bjyd)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if (localbjyd == null)
    {
      if (QLog.isColorLevel()) {
    ...
    if ((paramNetResp == null) || (paramNetResp.mResult != 0))
    {
      ...
      for (i = paramNetResp.mResult;; i = 0)
      {
        ...
        localbjyd.a(this.jdField_a_of_type_Int, false, null, this.b, this.jdField_a_of_type_JavaLangObject);
        return;
      }
    }
    Object localObject2;
    ...
    for (int i = ((im_msg_head.HttpConnHead)((im_msg_head.Head)localObject2).msg_httpconn_head.get()).uint32_error_code.get();; i = 0)
    {
      if ((j > 0) && (i == 0))
      {
        ...
        localbjyd.a(this.jdField_a_of_type_Int, true, paramNetResp, this.b, this.jdField_a_of_type_JavaLangObject);
        return;
      }
      if (QLog.isColorLevel()) {
