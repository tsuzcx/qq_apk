...
public class aicy
  extends BaseAdapter
{
  aicz jdField_a_of_type_Aicz;
  LayoutInflater jdField_a_of_type_AndroidViewLayoutInflater;
  
  public aicy(CreateFaceToFaceDiscussionActivity paramCreateFaceToFaceDiscussionActivity)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131560780, null);
      this.jdField_a_of_type_Aicz = new aicz(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberCreateFaceToFaceDiscussionActivity);
      this.jdField_a_of_type_Aicz.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131367679));
      this.jdField_a_of_type_Aicz.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370647));
      paramView.setTag(this.jdField_a_of_type_Aicz);
    }
    while ((paramInt == getCount() - 1) && (getCount() < 50))
    {
      ...
      return paramView;
      this.jdField_a_of_type_Aicz = ((aicz)paramView.getTag());
      if (this.jdField_a_of_type_Aicz.jdField_a_of_type_Boolean)
      {
        paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131560780, null);
        this.jdField_a_of_type_Aicz = new aicz(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberCreateFaceToFaceDiscussionActivity);
        this.jdField_a_of_type_Aicz.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131367679));
        this.jdField_a_of_type_Aicz.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370647));
        paramView.setTag(this.jdField_a_of_type_Aicz);
        this.jdField_a_of_type_Aicz.jdField_a_of_type_Boolean = false;
      }
    }
