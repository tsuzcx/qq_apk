  ...
  implements Runnable
{
  ...
  public aicy(BaseShortVideoOprerator paramBaseShortVideoOprerator, ArrayList paramArrayList)
  {
  ...
  public void a()
  {
    ...
    for (;;)
    {
      ...
      localTransferRequest.jdField_a_of_type_ComTencentMobileqqPicUpCallBack = new aicz(this, j);
