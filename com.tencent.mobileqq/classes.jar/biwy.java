...
public class biwy
  extends biwr
  implements awoh, biwf, IVideoOuterStatusListener
{
  private IVideoInnerStatusListener a;
  private ImageView b;
  
  biwy(Context paramContext)
  {
    super(paramContext);
  ...
  public void a(Context paramContext)
  {
    ...
    this.b = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131374501));
    this.b.setContentDescription(anvx.a(2131704111));
    a(new View[] { this.b });
  ...
  public void d()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenStatusReceiver == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenStatusReceiver.a(2, new biwz(this));
    }
  }
