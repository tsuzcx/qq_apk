...
public class bmpq
  implements bmoh
{
  private bmpq(DoodleLayout paramDoodleLayout) {}
  ...
  public void a(DynamicTextItem paramDynamicTextItem, boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      this.a.f();
      if (QLog.isColorLevel()) {
        QLog.d("DoodleLayout", 2, "raymondguo count " + localbmmk.b() + ", items:" + localbmmk.jdField_a_of_type_JavaUtilArrayList.size());
      }
      return;
      localbmmk.b(paramDynamicTextItem);
      paramInt = 1;
      continue;
      if (paramInt == 0)
      {
  ...
  public void a(boolean paramBoolean)
  {
    ...
    this.a.jdField_a_of_type_Bmpp.q();
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      this.a.setTrackerState(this.a.a().jdField_a_of_type_Bmmn, 0);
      return;
      DoodleLayout.a(this.a, new bmpr(this, paramBoolean));
    }
  }
}
