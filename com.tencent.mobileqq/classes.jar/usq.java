  ...
  extends HttpDownloader
{
  ...
  public usq(BaseApplicationImpl paramBaseApplicationImpl)
  {
    this.a = paramBaseApplicationImpl;
    this.mSupportInnerIp = qdk.a.h();
  }
  ...
  public static URL a(String paramString, int paramInt, Object paramObject, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramObject = bkyp.a(paramString);
      ...
      return paramString;
      paramString = bkyp.a(paramString, "busiType", paramInt + "");
      continue;
  ...
  {
    return axxs.a(paramInputStream, (int)paramLong);
  }
  
  public void copyRespInfo(NetResp paramNetResp, URLDrawableHandler paramURLDrawableHandler)
  {
    if ((paramURLDrawableHandler instanceof ust))
    {
      uss localuss = ((ust)paramURLDrawableHandler).a();
      if (localuss != null)
      {
        localuss.a(paramNetResp, paramNetResp.mErrDesc);
        ((ust)paramURLDrawableHandler).a("image/" + uss.a(localuss));
      }
    }
  }
  ...
  public File downloadImage(OutputStream paramOutputStream, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    for (;;)
    {
      Object localObject1 = bkyp.a(str);
      ...
      for (;;)
      {
        try
        {
          ...
          localuss = new uss(this, this.a, i);
          localuss.a(paramDownloadParams, (Map)localObject1);
          localObject1 = null;
      ...
      {
        usr localusr = new usr(this, paramOutputStream);
        ...
        for (;;)
        {
          try
          {
            ...
            localObject1 = localObject3;
            localObject4 = localObject3;
            localObject3 = super.downloadImage(localusr, paramDownloadParams, localuss.a(paramURLDrawableHandler));
            ...
            localuss.a(j, paramDownloadParams);
            localObject1 = localObject3;
          }
          ...
          finally
          {
            ...
            continue;
            localObject4 = localObject2;
            localuss.a(-1, localIOException.getMessage());
            continue;
            localObject4 = localObject2;
            try
            {
            ...
            catch (Exception localException)
            {
              ...
              if ((i == -1) || (i == 0))
              {
                if ((uss.a(localuss) != 0) && (paramDownloadParams.retryCount != tlw.g)) {
                  break label799;
                }
                localuss.a(j, paramDownloadParams);
                continue;
