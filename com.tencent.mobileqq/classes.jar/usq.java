  ...
  extends uut
{
  ...
  private void b(int paramInt)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("EditPicActivity.EditPicPartManager", 2, "reset2Camera begin " + this.jdField_a_of_type_Uwe.getActivity() + " new path " + str);
    }
    PreferenceManager.getDefaultSharedPreferences(this.jdField_a_of_type_Uwe.a()).edit().putString("edit_pic_new_path", str).commit();
    Intent localIntent;
    if (paramInt == 101)
    {
    ...
    try
    {
      bbmy.a(localActivity, ajjy.a(2131637895), 0).a();
  ...
  private void w()
  {
    ...
    localvfh.b = vfx.a(2);
    localvfh.jdField_a_of_type_Vfl = new vfl(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams$EditSource.a());
    localvfh.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064 = new LpReportInfo_pf00064();
    localvfh.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.actionType = 615;
    localvfh.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.subactionType = 8;
    ...
    if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int == 3)
    {
      ...
      int i = 0;
      while (i < localvfh.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.size())
      {
        ((StringBuilder)localObject).append((String)localvfh.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.get(i) + ",");
        i += 1;
      }
      if (((StringBuilder)localObject).length() > 0) {
        ((StringBuilder)localObject).deleteCharAt(((StringBuilder)localObject).length() - 1);
      }
      localvfh.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reserves5 = ((StringBuilder)localObject).toString();
      LpReportManager.getInstance().reportToPF00064(localvfh.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064, true, false);
    }
    urq.b("0X80076EA");
    urk.d("EditPicActivity.EditPicPartManager", "PUBLISH start ...");
    this.jdField_a_of_type_Uwe.a(ajjy.a(2131637894), false, 500L);
    Stream.of(localvfh).map(new vfj((ury)a(ury.class), null)).map(new ThreadOffFunction("EditPicActivity.EditPicPartManager", 2)).map(new vfv(uso.jdField_a_of_type_JavaLangString + "qq_pic_merged_" + System.currentTimeMillis() + ".jpg")).map(new UIThreadOffFunction(this)).subscribe(new usr(this, localvfh));
  }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if ((paramInt1 == 1000) && (paramInt2 != -1) && (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)))
    {
      ...
      vlm.b(BaseApplication.getContext(), new File(this.jdField_a_of_type_JavaLangString));
  ...
  void a(Activity paramActivity, int paramInt, Intent paramIntent)
  {
    ...
    default: 
      ...
      this.jdField_a_of_type_Uwe.a(-1, null, 2130772028, 0);
    case 101: 
    case 104: 
      do
      {
    ...
    case 5: 
      ...
      paramIntent.putExtra("param_title", paramActivity.getString(2131624953));
      paramIntent.putExtra("param_done_button_wording", paramActivity.getString(2131625463));
  ...
  protected void a(@NonNull EditVideoParams paramEditVideoParams)
  {
    ...
    Object localObject = new utf(this, paramEditVideoParams.b);
    this.jdField_a_of_type_Utf = ((utf)localObject);
    localArrayList.add(localObject);
    localObject = new uth(this, paramEditVideoParams.b);
    ...
    {
      localObject = new usd(this);
      this.jdField_a_of_type_Usd = ((usd)localObject);
      localArrayList.add(localObject);
    }
    a(localArrayList);
  ...
  public void b()
  {
    Object localObject = this.jdField_a_of_type_Uwe.getActivity().getIntent();
    ...
    if ((i == 103) && (i == 103))
    {
      ...
      awqx.b(null, "dc00898", "", "", "0X80072C5", "0X80072C5", 0, 0, (String)localObject, "" + j, "", "");
      if (bool) {
        awqx.b(null, "dc00898", "", "", "0X80083B2", "0X80083B2", 0, 0, (String)localObject, "" + j, "", "");
      }
      urq.b("0X80075E8");
    }
    for (;;)
    {
      ...
      break;
      label379:
      awqx.b(null, "dc00898", "", "", "0X80072C4", "0X80072C4", 0, 0, (String)localObject, "" + j, "", "");
    }
  }
  ...
  protected void c()
  {
    ...
    if (i != -1)
    {
      ...
      bacm.a(this.jdField_a_of_type_Uwe.a(), this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams$EditSource.a());
      ...
      if (i == 103)
      {
        ...
        for (;;)
        {
          this.jdField_a_of_type_Uwe.a(0, localIntent, 2130772028, 0);
          return;
          localObject = "1";
          break;
          label264:
