  ...
  implements Manager
{
  ...
  public wfe(QQAppInterface paramQQAppInterface)
  {
  ...
  @NonNull
  public static wfe a(QQAppInterface paramQQAppInterface)
  {
    return (wfe)paramQQAppInterface.getManager(253);
  }
  ...
  public void a(ConfigurationService.Config paramConfig)
  {
    ...
    int j = bgsg.aD(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    String str;
    if (i != j)
    {
      str = arcj.b(paramConfig, j, paramConfig.type.get());
      if (QLog.isColorLevel()) {
    ...
    {
      return;
      bgsg.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramConfig.version.get(), str);
      try
      {
        b(str);
        return;
  ...
  public void a(@NonNull MessageForQQStoryFeed paramMessageForQQStoryFeed)
  {
    ...
    yqu.a("aio_msg", "aio_push", 0, 0, new String[] { paramMessageForQQStoryFeed.frienduin });
    afwx localafwx = (afwx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(282);
    Object localObject = localafwx.a(paramMessageForQQStoryFeed.frienduin, 0, 5);
    int i;
    if (localObject != null)
    {
    ...
    for (;;)
    {
      ...
      bgsg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), paramMessageForQQStoryFeed.frienduin, i);
      return;
