  ...
  implements asjg
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new asgy(this);
  private ashu jdField_a_of_type_Ashu;
  private int b;
  private int c;
  private int d;
  
  public asgx(Context paramContext, FullPopData paramFullPopData, String paramString1, String paramString2, boolean paramBoolean)
  {
  ...
  {
    paramFullPopData = asiy.a(paramFullPopData.resPath, "video.mp4");
  ...
  private void e()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqGamecenterDataFullPopData != null)
    {
      ...
      int i = azgq.e(this.jdField_a_of_type_AndroidContentContext);
      Object localObject1 = asiy.a(this.jdField_a_of_type_ComTencentMobileqqGamecenterDataFullPopData.resPath, "line.png", i, 0);
      Object localObject2 = QWalletPicHelper.getDrawableForWallet(asiy.a(this.jdField_a_of_type_ComTencentMobileqqGamecenterDataFullPopData.resPath, "box.png").getPath(), null);
      ...
      ((ObjectAnimator)localObject2).addListener(new asgz(this));
  ...
  private void f()
  {
    int i = this.jdField_a_of_type_AndroidWidgetRelativeLayout.getTop() + aekt.a(4.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    int j = this.jdField_a_of_type_AndroidWidgetRelativeLayout.getBottom() - aekt.a(4.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.jdField_a_of_type_Ashu = new ashu(i, j, this.jdField_a_of_type_AndroidWidgetRelativeLayout.getLeft(), this.jdField_a_of_type_AndroidWidgetRelativeLayout.getRight());
    this.jdField_a_of_type_ComTencentMobileqqGamecenterViewFullPopVideoView.setOutlineProvider(this.jdField_a_of_type_Ashu);
    ...
    asjd.a(System.currentTimeMillis());
  ...
  private void g()
  {
    ...
    {
      ashu localashu = this.jdField_a_of_type_Ashu;
      localashu.jdField_a_of_type_Int -= this.jdField_a_of_type_Int;
      localashu = this.jdField_a_of_type_Ashu;
      localashu.jdField_b_of_type_Int += this.jdField_b_of_type_Int;
      if (Build.VERSION.SDK_INT >= 21)
      {
        this.jdField_a_of_type_ComTencentMobileqqGamecenterViewFullPopVideoView.setOutlineProvider(this.jdField_a_of_type_Ashu);
        this.jdField_a_of_type_ComTencentMobileqqGamecenterViewFullPopVideoView.setClipToOutline(true);
      }
      if (this.jdField_a_of_type_Ashu.jdField_a_of_type_Int <= 0) {
  ...
  private void h()
  {
    ...
    this.jdField_d_of_type_AndroidWidgetImageView.setOnClickListener(new asha(this));
  }
  ...
  private void i()
  {
    if (this.jdField_a_of_type_Ashu != null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqGamecenterViewFullPopVideoView.setOutlineProvider(this.jdField_a_of_type_Ashu);
      this.jdField_a_of_type_ComTencentMobileqqGamecenterViewFullPopVideoView.setClipToOutline(true);
      if (this.jdField_a_of_type_Ashu.jdField_a_of_type_Int > this.jdField_a_of_type_Ashu.jdField_b_of_type_Int)
      {
  ...
  private void j()
  {
    ...
    localObjectAnimator.addListener(new ashb(this));
  }
