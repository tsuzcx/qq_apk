...
public class ansd
{
  ...
  public static ansd a;
  public static boolean a;
  public final int a;
  public final Handler a;
  public final Runnable a;
  public final Map<String, String> a;
  public final ConcurrentHashMap<Integer, HashMap<String, antk>> a;
  public final CopyOnWriteArrayList<anty> a;
  ...
  public static ansd a()
  {
    if (jdField_a_of_type_Ansd == null) {}
    try
    {
      if (jdField_a_of_type_Ansd == null) {
        jdField_a_of_type_Ansd = new ansd();
      }
      return jdField_a_of_type_Ansd;
    }
    finally {}
  }
  
  public Bitmap a(anty paramanty, antl paramantl)
  {
    if ((paramanty == null) || (paramantl == null)) {
      return null;
    }
    paramanty = "BubbleDiyFetcher_" + paramantl.jdField_a_of_type_Int + "_" + paramantl.jdField_a_of_type_JavaLangString.toUpperCase() + "_" + "chartlet";
    paramantl = (Bitmap)BaseApplicationImpl.sImageCache.get(paramanty);
    if (paramantl != null)
    {
      this.c.remove(paramanty);
      return paramantl;
    }
    this.c.add(paramanty);
    paramanty = BaseApplicationImpl.getApplication().getRuntime();
    if ((paramanty instanceof QQAppInterface)) {
      a((QQAppInterface)paramanty, 500);
    }
    return null;
  }
  
  public String a(anty paramanty, String paramString)
  {
    Object localObject;
    if ((paramanty == null) || (TextUtils.isEmpty(paramString))) {
      localObject = "";
    }
    String str;
    do
    ...
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(paramanty);
    paramanty = BaseApplicationImpl.getApplication().getRuntime();
    if ((paramanty instanceof QQAppInterface)) {
      a((QQAppInterface)paramanty, 500);
    }
  ...
  public void a()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((localanty != null) && (localanty.getCallback() != null) && (a(localanty.jdField_a_of_type_JavaLangString))) {
        localHashSet.add(localanty.jdField_a_of_type_JavaLangString);
      }
    }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString, alkr paramalkr)
  {
    ...
    ((anse)paramQQAppInterface.a(70)).a((List)localObject, paramalkr);
  }
  ...
  public Bitmap b(anty paramanty, antl paramantl)
  {
    if ((paramanty == null) || (paramantl == null) || (TextUtils.isEmpty(paramanty.jdField_a_of_type_JavaLangString))) {
      return null;
    }
    if (this.jdField_b_of_type_JavaUtilMap.containsKey(paramanty.jdField_a_of_type_JavaLangString))
    {
      Object localObject = (HashMap)this.jdField_b_of_type_JavaUtilMap.get(paramanty.jdField_a_of_type_JavaLangString);
      if ((localObject != null) && (((HashMap)localObject).containsKey(paramantl.jdField_a_of_type_JavaLangString.toUpperCase())))
      {
        localObject = (String)((HashMap)localObject).get(paramantl.jdField_a_of_type_JavaLangString.toUpperCase());
        if (TextUtils.isEmpty((CharSequence)localObject))
        {
          if (QLog.isColorLevel()) {
            QLog.i("BubbleDiyFetcher", 2, "diy id " + paramanty.jdField_a_of_type_JavaLangString + " has no pasterId for align: " + paramantl.jdField_a_of_type_JavaLangString.toUpperCase());
          }
          return null;
        }
      }
      ...
      paramantl = "BubbleDiyFetcher_" + paramantl.jdField_a_of_type_Int + "_" + paramantl.jdField_a_of_type_JavaLangString.toUpperCase() + "_" + (String)localObject;
      localObject = (Bitmap)BaseApplicationImpl.sImageCache.get(paramantl);
      if (localObject != null)
      {
        this.jdField_b_of_type_JavaUtilConcurrentCopyOnWriteArraySet.remove(paramantl);
        return localObject;
      }
      if (QLog.isColorLevel()) {
        QLog.i("BubbleDiyFetcher", 2, "can not found bitmap cache in BaseApplicationImpl.sImageCache! " + paramantl);
      }
      this.jdField_b_of_type_JavaUtilConcurrentCopyOnWriteArraySet.add(paramantl);
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
      ...
      return null;
      if (QLog.isColorLevel()) {
        QLog.i("BubbleDiyFetcher", 2, "can not found cache in diyPasterCache! " + paramanty.jdField_a_of_type_JavaLangString);
      }
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArraySet.add(paramanty.jdField_a_of_type_JavaLangString);
    }
  }
  ...
  public void c(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      while (i < j)
      {
        BubbleDiyEntity localBubbleDiyEntity = (BubbleDiyEntity)((awbw)localObject2).a(BubbleDiyEntity.class, (String)((ArrayList)localObject1).get(i));
  ...
  public void c(String paramString)
  {
      ...
      if (BaseApplicationImpl.sImageCache.get(paramString) == null)
      {
        ...
        if (localObject2 == null)
        {
          ...
          if (((File)localObject6).exists())
          {
            ...
            localObject2 = bcwc.a(((File)localObject6).getAbsolutePath());
            localObject1 = localObject2;
            if (localObject2 != null)
            {
    ...
    try
    {
      ...
      {
        localObject2 = (antk)((HashMap)localObject2).get(localObject4);
      ...
      if (BaseApplicationImpl.sImageCache.get(paramString) == null)
      {
        ...
        if (localObject2 == null)
        {
          ...
          if (localFile.exists())
          {
            ...
            localObject2 = bcwc.a(localFile.getAbsolutePath());
            localObject1 = localObject2;
            if (localObject2 != null)
            {
