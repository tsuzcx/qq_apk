  ...
  implements apqs, RecogCallback
{
  ...
  public apqt(Handler paramHandler, Context paramContext)
  {
  ...
  private boolean b(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      paramArrayOfByte = this.jdField_a_of_type_Apqo.a(paramArrayOfByte, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, 0);
      bool2 = apqo.a(paramArrayOfByte);
      ...
      bool1 = bool2;
    } while (this.jdField_a_of_type_Apqu == null);
    this.jdField_a_of_type_Apqu.a(bool2, paramArrayOfByte, paramBoolean);
    return bool2;
  }
  ...
  public int a()
  {
    ...
    this.jdField_a_of_type_Apqo.a(this);
    this.jdField_a_of_type_Apqo.a(this);
    this.jdField_a_of_type_Apqo.a(this.jdField_a_of_type_AndroidContentContext, hashCode(), "MiniRecog");
  ...
  {
    boolean bool1 = this.jdField_a_of_type_Apqo.c();
    ...
    catch (Throwable paramArrayOfByte)
    {
      ...
      try
      {
        ...
        bool1 = bool2;
        bool2 = this.jdField_a_of_type_Apqo.a(paramRect, this.jdField_a_of_type_Long);
        bool3 = bool2;
        if (!bool2)
        {
          bool1 = bool2;
  ...
  public Bitmap a(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    while (apqo.a(this.jdField_a_of_type_ArrayOfInt, paramArrayOfByte, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int) != 0) {
      try
      {
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_Apqo.c(this);
      this.jdField_a_of_type_Apqo.b(this);
      this.jdField_a_of_type_Apqo.a(hashCode(), "MiniRecog");
    }
  }
  ...
  {
    this.jdField_a_of_type_Apqu = ((apqu)paramapqn);
  }
  
  public boolean a()
  {
    return (this.jdField_a_of_type_Apqo.c()) && (this.jdField_c_of_type_Boolean) && (!this.jdField_b_of_type_Boolean);
  }
  ...
  public void onDetectReady(int paramInt)
  {
    ...
    apra.d(this.jdField_c_of_type_Int, (int)l);
  }
  ...
  public void onDetectResult(List<apqk> paramList, long paramLong)
  {
    ...
    {
      if ((((apqk)paramList.get(i)).jdField_a_of_type_AndroidGraphicsRect.width() > 0) && (((apqk)paramList.get(i)).jdField_a_of_type_AndroidGraphicsRect.height() > 0))
      {
        Rect localRect = new Rect(((apqk)paramList.get(i)).jdField_a_of_type_AndroidGraphicsRect);
        ...
        localapqk.jdField_a_of_type_Int = ((apqk)paramList.get(i)).jdField_a_of_type_Int;
        localapqk.jdField_a_of_type_Float = ((apqk)paramList.get(i)).jdField_a_of_type_Float;
