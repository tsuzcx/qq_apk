...
public class bbbu
{
  ...
  public static bbbv a(byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localbbbv.jdField_a_of_type_Int = paramArrayOfByte.get();
        ...
        if (paramArrayOfByte.hasRemaining())
        {
          ...
          localbbbv.c = i;
          localbbbv.jdField_a_of_type_JavaLangString = new String(arrayOfByte);
          if (QLog.isColorLevel()) {
            QLog.d("ActionMsgUtil", 2, "decodeAppShareCookie succes appShareCookie.buissnessType =" + localbbbv.jdField_a_of_type_Int + "appShareCookie.action" + localbbbv.b + "appShareCookie.actionType" + localbbbv.c + "appShareCookie.actionValue" + localbbbv.jdField_a_of_type_JavaLangString);
          }
        }
      }
