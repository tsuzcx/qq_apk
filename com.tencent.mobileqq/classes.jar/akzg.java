...
public final class akzg
{
  ...
  {
    vyf.a(BaseApplicationImpl.getContext(), paramFile);
  }
  ...
  {
    bbkb.a(BaseApplicationImpl.getApplication().getSharedPreferences("ARRecordUtils_AR", 4).edit().putBoolean("ARVideoRecordPressKey12", paramBoolean));
  }
