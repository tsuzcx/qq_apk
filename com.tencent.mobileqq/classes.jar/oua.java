...
public class oua
  extends rrx<TabChannelCoverInfo>
  implements View.OnClickListener, bfpt, bfpu, rsd, rse
{
  public int a;
  private int[] a;
  private int c = -1;
  ...
  public oua(ReadInJoyChannelPanelFragment paramReadInJoyChannelPanelFragment, Context paramContext, int paramInt1, int paramInt2)
  {
  ...
  private void a(int paramInt, TabChannelCoverInfo paramTabChannelCoverInfo)
  {
    ...
    do
    {
      ...
      try
      {
        ReadInJoyChannelPanelFragment.a("0X800949C", new ono().b().a(paramTabChannelCoverInfo.mChannelCoverId).m(ReadInJoyChannelPanelFragment.a(paramTabChannelCoverInfo)).a());
    ...
    for (paramTabChannelCoverInfo.channelConfigType = ((qaq)ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment).get(1)).a;; paramTabChannelCoverInfo.channelConfigType = paramTabChannelCoverInfo.sectionId)
    {
      localReadInJoyStaticGridView.a(localReadInJoyStaticGridView.a().getCount() - 1, 0, paramTabChannelCoverInfo);
      paramTabChannelCoverInfo = new oub(this, localReadInJoyStaticGridView);
      localReadInJoyStaticGridView.setTag(2131374762, paramTabChannelCoverInfo);
  ...
  private void d()
  {
    ...
    for (;;)
    {
      ...
      {
        localObject = new qby();
        ((qao)localObject).a = ((TabChannelCoverInfo)localList.get(i));
        ((qao)localObject).l = i;
        ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment, (qao)localObject, this.d);
        i += 1;
      }
    }
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      ReadInJoyChannelPanelFragment.a("0X800949B", new ono().b().a(localTabChannelCoverInfo.mChannelCoverId).m(ReadInJoyChannelPanelFragment.a(localTabChannelCoverInfo)).a());
      this.c = -1;
      return;
    }
    catch (JSONException localJSONException)
  ...
  public boolean a(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    try
    {
      ReadInJoyChannelPanelFragment.a("0X800949A", new ono().b().a(paramAdapterView.mChannelCoverId).m(ReadInJoyChannelPanelFragment.a(paramAdapterView)).a());
      return true;
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment, 2131559969), null);
      paramViewGroup = new ouc(this);
      paramViewGroup.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131369239));
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetAutoFitTextView = ((AutoFitTextView)paramView.findViewById(2131364052));
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131375030));
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131375035));
      paramViewGroup.b = ((ImageView)paramView.findViewById(2131365002));
      ...
      paramViewGroup.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKanDianUrlRoundCornerImageView = ((KanDianUrlRoundCornerImageView)paramView.findViewById(2131368595));
      ...
      paramViewGroup.b.setTag(2131374817, Integer.valueOf(paramInt));
    ...
    for (;;)
    {
      if ((paramViewGroup.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKanDianUrlRoundCornerImageView != null) && (ooq.a())) {}
      try
      {
        localObject = new URL(((TabChannelCoverInfo)localObject).mChannelCoverIcon);
        omr.a(paramViewGroup.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKanDianUrlRoundCornerImageView, (URL)localObject, paramView.getContext());
        return paramView;
      }
      ...
      paramViewGroup = (ouc)paramView.getTag();
      break;
      label368:
      i = 8;
      break label223;
  ...
  public void onClick(View paramView)
  {
    ...
    int i = ((Integer)paramView.getTag(2131374817)).intValue();
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    if (!ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment)) {
      try
      {
        ReadInJoyChannelPanelFragment.a("0X8009499", new ono().b().a(paramAdapterView.mChannelCoverId).m(ReadInJoyChannelPanelFragment.a(paramAdapterView)).n(ReadInJoyChannelPanelFragment.a(paramAdapterView)).c((int)paramAdapterView.sectionId).b("style", 1).a());
        ...
        if (bhvy.z())
        {
          osg.a().a(paramAdapterView.mChannelCoverId, 3, false, true);
          onh.b().post(new ReadInJoyChannelPanelFragment.DynamicGridViewAdapter.1(this, paramAdapterView));
          return;
        }
      }
      catch (JSONException paramView)
      {
        for (;;)
        {
          ...
          continue;
          osg.a().b(paramAdapterView.mChannelCoverId, 3);
        }
      }
    }
