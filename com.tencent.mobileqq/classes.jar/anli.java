  ...
  extends InputStream
{
  ...
  private final WeakReference<anlj> jdField_a_of_type_JavaLangRefWeakReference;
  private boolean jdField_a_of_type_Boolean = true;
  private BufferedInputStream jdField_b_of_type_JavaIoBufferedInputStream;
  private boolean jdField_b_of_type_Boolean = true;
  
  public anli(anlj paramanlj, ByteArrayOutputStream paramByteArrayOutputStream, BufferedInputStream paramBufferedInputStream)
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramanlj);
      return;
  ...
  public void close()
  {
    ...
    //   21: aload_0
    //   22: getfield 18	anli:jdField_a_of_type_Boolean	Z
    ...
    //   33: aload_0
    //   34: getfield 20	anli:jdField_b_of_type_Boolean	Z
    ...
    //   46: aload_0
    //   47: getfield 42	anli:jdField_b_of_type_JavaIoBufferedInputStream	Ljava/io/BufferedInputStream;
    //   50: ifnull +15 -> 65
    //   53: aload_0
    //   54: getfield 42	anli:jdField_b_of_type_JavaIoBufferedInputStream	Ljava/io/BufferedInputStream;
    //   57: invokevirtual 89	java/io/BufferedInputStream:close	()V
    //   60: aload_0
    //   61: aconst_null
    //   62: putfield 42	anli:jdField_b_of_type_JavaIoBufferedInputStream	Ljava/io/BufferedInputStream;
    //   65: aload_0
    //   66: getfield 22	anli:jdField_a_of_type_JavaIoBufferedInputStream	Ljava/io/BufferedInputStream;
    //   69: ifnull +15 -> 84
    //   72: aload_0
    //   73: getfield 22	anli:jdField_a_of_type_JavaIoBufferedInputStream	Ljava/io/BufferedInputStream;
    //   76: invokevirtual 89	java/io/BufferedInputStream:close	()V
    //   79: aload_0
    //   80: aconst_null
    //   81: putfield 22	anli:jdField_a_of_type_JavaIoBufferedInputStream	Ljava/io/BufferedInputStream;
    //   84: aload_0
    //   85: getfield 49	anli:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    //   88: invokevirtual 93	java/lang/ref/WeakReference:get	()Ljava/lang/Object;
    //   91: checkcast 95	anlj
    //   94: astore_2
    //   95: aload_2
    //   96: ifnull +30 -> 126
    //   99: aload_0
    //   100: getfield 18	anli:jdField_a_of_type_Boolean	Z
    //   103: ifeq +29 -> 132
    //   106: aload_0
    //   107: getfield 20	anli:jdField_b_of_type_Boolean	Z
    //   110: ifeq +22 -> 132
    //   113: iconst_1
    //   114: istore_1
    //   115: aload_2
    //   116: iload_1
    //   117: aload_0
    //   118: getfield 24	anli:jdField_a_of_type_JavaIoByteArrayOutputStream	Ljava/io/ByteArrayOutputStream;
    //   121: invokeinterface 98 3 0
    //   126: aload_0
    //   127: aconst_null
    //   128: putfield 24	anli:jdField_a_of_type_JavaIoByteArrayOutputStream	Ljava/io/ByteArrayOutputStream;
    //   131: return
    //   132: iconst_0
    //   133: istore_1
    //   134: goto -19 -> 115
