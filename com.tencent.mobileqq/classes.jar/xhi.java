...
public class xhi
{
  ...
  public xhi(long paramLong1, long paramLong2)
  {
  ...
  private boolean a()
  {
    try
    {
      ...
      this.jdField_a_of_type_Xhn = new xhn(null, "MediaCodecGLFrameFetcher");
    }
    ...
    this.jdField_a_of_type_Xhn.b(new MediaCodecGLFrameFetcher.2(this));
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_Xhm = new xhm();
    this.jdField_a_of_type_Xhm.a(true);
    this.jdField_a_of_type_Xhm.a();
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture = new SurfaceTexture(this.jdField_a_of_type_Xhm.a());
    this.f = xhh.a(this.c, this.d);
  }
  
  private void d()
  {
    f();
    this.jdField_a_of_type_Xhn.b(new MediaCodecGLFrameFetcher.3(this));
  }
  ...
  private void g()
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture.setOnFrameAvailableListener(new xhj(this));
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_Xhn.b(new MediaCodecGLFrameFetcher.1(this));
      this.jdField_a_of_type_Xhn.a();
      this.jdField_a_of_type_Xhn = null;
    }
    h();
