  ...
  implements Manager
{
  ...
  protected ArrayList<bbwt> a;
  protected HashMap<String, String> a;
  protected ConcurrentHashMap<String, String> a;
  
  public pyw(AppInterface paramAppInterface)
  {
  ...
  {
    String str2 = bbvj.a(ajsd.aW + ".readInjoy/resource/");
    String str1 = str2;
  ...
  {
    this.jdField_a_of_type_JavaUtilArrayList.add(parambbwt);
  }
  
  public void a(String paramString, bbwu parambbwu) {}
  ...
  public boolean a(String paramString, BaseResData paramBaseResData, int paramInt)
  {
    ...
    do
    {
      ...
      localObject = new bbwu(paramBaseResData.url, localFile);
      ((bbwu)localObject).b = paramInt;
      ((bbwu)localObject).d = 60L;
      this.jdField_a_of_type_Bbwz.a((bbwu)localObject, new pyx(this, str, paramBaseResData, paramString), localBundle);
    } while (!QLog.isColorLevel());
  ...
  public void b(bbwt parambbwt)
  {
    this.jdField_a_of_type_JavaUtilArrayList.remove(parambbwt);
  }
