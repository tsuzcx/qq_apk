  ...
  extends sdu<sec>
{
  ...
  protected List<sdf> a(List<sdg> paramList)
  {
    ...
    {
      localObject2 = (sdg)paramList.next();
      Object localObject3 = ((sdg)localObject2).jdField_a_of_type_ComTencentBizQqstoryModelItemAddressItem;
      ...
      {
        urk.a("Q.qqstory.recommendAlbum.logic.AbstractSplitStrategy", "handleSplit pic poi is null picPath=%s", ((sdg)localObject2).jdField_a_of_type_JavaLangString);
      }
    }
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      {
        localObject2 = new sdf(a().a, (List)localObject2);
        ((sdf)localObject2).a(this.a);
