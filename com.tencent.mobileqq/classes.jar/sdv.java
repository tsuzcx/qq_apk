...
public class sdv
{
  ...
  private ozi jdField_a_of_type_Ozi = new sdy(this);
  ...
  public sdv(Activity paramActivity, boolean paramBoolean)
  {
    this(paramActivity);
    if (paramBoolean)
    {
  ...
  {
    Object localObject = olg.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_Int, this.jdField_a_of_type_Long, this.i, paramInt1, paramInt2, paramBoolean);
    try
    {
      localObject = new JSONObject((String)localObject);
      ((JSONObject)localObject).put("pattern", this.jdField_e_of_type_Int);
      noo.a(null, "", "0X8009545", "0X8009545", 0, 0, "", String.valueOf(this.jdField_a_of_type_Long), String.valueOf(this.jdField_b_of_type_Long), ((JSONObject)localObject).toString(), false);
      return;
    }
  ...
  {
    paramBoolean1 = olg.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_Int, this.jdField_a_of_type_Long, this.i, paramInt1, paramInt2, paramBoolean, paramBoolean1);
    noo.a(null, "", "0X800979D", "0X800979D", 0, 0, "", String.valueOf(this.jdField_a_of_type_Long), String.valueOf(this.jdField_b_of_type_Long), paramBoolean1, false);
  }
  ...
  private void a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    {
      bcpw.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidAppActivity.getString(2131719476), 0).a();
    ...
    } while (bgyu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, localBundle, null));
    wim.a(1, 2131689512);
  }
  ...
  private void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8)
  {
    ...
    if (onk.a(paramString5)) {
      paramString4 = onk.a(paramString5, 260, 520, 1);
    }
    ...
    paramString5.putExtra("brief_key", BaseApplicationImpl.getContext().getString(2131696697, new Object[] { paramString1 }));
    ...
    for (paramString1 = "";; paramString1 = paramString7.trim())
    {
      ...
      paramString5.putExtra("stuctmsg_bytes", axuy.a(paramString5.getExtras()).getBytes());
  ...
  {
    str3 = olg.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_Int, this.jdField_a_of_type_Long, this.i, paramInt1, paramInt2, paramBoolean);
    try
    {
      ...
      {
        paramInt1 = olg.a(onk.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo));
    ...
    noo.a(null, "", "0X8009A79", "0X8009A79", 0, 0, "", String.valueOf(this.jdField_a_of_type_Long), String.valueOf(this.jdField_b_of_type_Long), str1, false);
  }
  ...
  private void b(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    if (this.jdField_a_of_type_Bcpq == null) {
      this.jdField_a_of_type_Bcpq = new bcpq(this.jdField_a_of_type_AndroidAppActivity, localActivity.getResources().getDimensionPixelSize(2131298865));
    }
  ...
  public bbjc a(ArticleInfo paramArticleInfo)
  {
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo = paramArticleInfo;
    this.i = paramArticleInfo.innerUniqueID;
    this.jdField_a_of_type_JavaLangString = onk.e(this.i);
    ...
    this.jdField_b_of_type_JavaLangString = ajyc.a(2131704995);
    ...
    if ((paramArticleInfo.mGalleryFeedsInfo != null) && (paramArticleInfo.mGalleryFeedsInfo.uint32_is_account_derelict.get() == 1))
    {
      ...
      this.g = (omm.k + Base64.encodeToString(this.k.getBytes(), 0));
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_Sgy == null) {
        this.jdField_a_of_type_Sgy = new sgy(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, null, new sdz(this));
      }
      this.jdField_a_of_type_Sgy.a.a("biu出去让更多好友看到");
      this.jdField_a_of_type_Sgy.a.a(new sdw(this));
      return this.jdField_a_of_type_Sgy.a(a());
      this.f = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131699347);
  ...
  public qaw a(ArrayList<DislikeInfo> paramArrayList)
  {
    qaw localqaw = new qaw();
    if (!TextUtils.isEmpty(this.i)) {
      localqaw.jdField_a_of_type_JavaLangString = this.i;
    }
    localqaw.jdField_a_of_type_Long = this.jdField_a_of_type_Long;
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Raa != null) {
      this.jdField_a_of_type_Raa = null;
    }
  ...
  public void a(String paramString1, String paramString2, String paramString3, Bitmap paramBitmap, boolean paramBoolean, shf paramshf)
  {
    int i1 = 0;
    int n = 0;
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            ...
            paramshf = new sdx(this, str, paramshf);
          ...
          if (bhvh.t(onk.a()) == 1)
          {
            paramshf = WXShareHelper.a();
            if (paramBoolean) {}
            for (m = n;; m = 1)
            {
              paramshf.b(str, paramString1, paramBitmap, paramString2, paramString3, m);
              break;
            }
          }
          paramshf = WxShareHelperFromReadInjoy.a();
          if (paramBoolean) {}
          for (m = i1;; m = 1)
          {
            paramshf.a(str, paramString1, paramBitmap, paramString2, paramString3, m);
            break;
          }
          label266:
          m = -1;
  ...
  public void a(String paramString, boolean paramBoolean, shf paramshf)
  {
    if (TextUtils.isEmpty(paramString)) {
      return;
    }
    ThreadManager.post(new GalleryShareHelper.3(this, paramString, paramBoolean, new HashMap(1), paramshf), 8, null, false);
  }
