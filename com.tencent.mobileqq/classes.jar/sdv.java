...
{
  public sdv(Conversation paramConversation) {}
  ...
  protected void onGetGenralSettings(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    this.a.a(9, AppConstants.aC, 5001);
  ...
  protected void onUpdateCustomHead(boolean paramBoolean, String paramString)
  {
    ...
    {
      this.a.a(new sdx(this, paramString));
      return;
    }
  ...
  protected void onUpdateHotFriendLevel(boolean paramBoolean, ArrayList paramArrayList)
  {
    ...
    if (paramBoolean) {
      this.a.a(new sdz(this, paramArrayList));
    }
  }
  ...
  {
    if (paramBoolean) {
      this.a.a(new sdy(this, paramString));
    }
  }
}
