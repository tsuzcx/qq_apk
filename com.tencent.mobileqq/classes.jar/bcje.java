...
public class bcje
  extends bcgx
{
  private void a(Context paramContext, View paramView, bcjf parambcjf, Bundle paramBundle)
  {
    if ((paramView != null) && ((paramView instanceof RelativeLayout)))
    {
      ...
      if (parambcjf.a != null)
      {
        ...
        parambcjf.a.setId(2131363033);
        paramBundle.addRule(9, -1);
        ((RelativeLayout)paramView).addView(parambcjf.a);
      }
      if (parambcjf.b != null)
      {
    ...
    for (int i = AIOUtils.dp2px(5.0F, paramContext);; i = AIOUtils.dp2px(10.0F, paramContext))
    {
      ...
      ((RelativeLayout)paramView).addView(parambcjf.b, paramBundle);
      return;
    }
  }
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    bcjf localbcjf;
    Object localObject1;
    if ((paramView != null) && ((paramView instanceof RelativeLayout)) && ((paramView.getTag() instanceof bcjf)))
    {
      localbcjf = (bcjf)paramView.getTag();
    ...
    for (;;)
    {
      ...
      if (((Iterator)localObject1).hasNext())
      {
        ...
        localObject2 = localbcgw.jdField_a_of_type_JavaLangString;
        if ("title".equals(localObject2))
        {
          localObject2 = (StructMsgItemTitle)localbcgw;
      ...
      try
      {
        ...
        for (;;)
        {
          localbcjf.b = localbcgw.a(paramContext, localbcjf.b, paramBundle);
          break;
        ...
        localbcjf.a = localbcgw.a(paramContext, localbcjf.a, paramBundle);
        continue;
        paramContext = localbcjf;
        ...
        try
        {
          for (;;)
          {
            ...
            if ("paaudio".equals(localObject2))
            {
              localbcjf.a = localbcgw.a(paramContext, localbcjf.a, paramBundle);
              continue;
              a(paramContext, paramView, localbcjf, paramBundle);
              paramContext = localbcjf;
            }
          }
