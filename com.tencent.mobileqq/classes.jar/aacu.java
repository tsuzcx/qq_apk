  ...
  extends WebViewPlugin
{
  ...
  private static long a(bgve parambgve)
  {
    if (parambgve == null) {
      return 0L;
    }
    try
    {
      long l = parambgve.a().getIntent().getLongExtra("preAct_time", 0L);
      return l;
    }
    catch (Exception parambgve)
    {
      QLog.w("QzoneWebViewOfflinePlugin", 2, "can not get click time", parambgve);
    }
    return 0L;
  }
  ...
  private void a(bgyr parambgyr, String paramString)
  {
    if (TextUtils.isEmpty(paramString)) {}
    while (parambgyr == null) {
      return;
    }
    QLog.i("QzoneWebViewOfflinePlugin", 1, "state is " + parambgyr);
    for (;;)
    {
      ...
      try
      {
        ...
        switch (parambgyr.jdField_a_of_type_Int)
        {
        case 1: 
          if (!TextUtils.isEmpty(parambgyr.jdField_b_of_type_JavaLangString)) {
            localJSONObject.put("url", parambgyr.jdField_b_of_type_JavaLangString);
          }
          localJSONObject.put("code", parambgyr.jdField_c_of_type_Int);
          if (!TextUtils.isEmpty(parambgyr.f)) {
            localJSONObject.put("msg", parambgyr.f);
          }
          localJSONObject.put("dataIsBase64", parambgyr.jdField_a_of_type_Boolean);
          if (TextUtils.isEmpty(parambgyr.d)) {
            break label396;
          }
          if (!parambgyr.jdField_a_of_type_Boolean) {
            break label387;
          }
          str = bfuc.encodeToString(parambgyr.d.getBytes(), 0);
          localJSONObject.put("data", str);
          if (parambgyr.jdField_b_of_type_Int > 0) {
            localJSONObject.put("httpStatusCode", parambgyr.jdField_b_of_type_Int);
          }
          if (!TextUtils.isEmpty(parambgyr.jdField_c_of_type_JavaLangString)) {
            localJSONObject.put("header", new JSONObject(parambgyr.jdField_c_of_type_JavaLangString));
          }
          if (parambgyr.jdField_a_of_type_JavaLangObject != null) {
            localJSONObject.put("userinfo", parambgyr.jdField_a_of_type_JavaLangObject);
          }
          callJs(paramString, new String[] { localJSONObject.toString() });
          long l1 = System.currentTimeMillis();
          long l2 = parambgyr.jdField_a_of_type_Long;
          QLog.i("QzoneWebViewOfflinePlugin", 1, "wnscgi@ status=" + parambgyr.jdField_a_of_type_Int + ",total cost " + (l1 - l2) + " ms");
          return;
        }
      }
      catch (Exception parambgyr)
      {
        parambgyr.printStackTrace();
        return;
      }
  ...
  private void a(String... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.mRuntime != null) {}
        for (paramVarArgs = this.mRuntime.a(); QzoneZipCacheHelper.checkAndDownLoadFileIfNeeded(paramVarArgs, str1, str2, str3, i, new aacw(this, str2, str3, str4)); paramVarArgs = null)
        {
  ...
  private static void b(String paramString, long paramLong, bgve parambgve)
  {
    int i;
    long l;
    try
    ...
    label205:
    String str1;
    if ((!TextUtils.isEmpty(paramString)) && (parambgve != null) && ((8589934594L == paramLong) || (8589934593L == paramLong)) && (paramString.equals(QzoneConfig.getInstance().getConfig("H5Url", "GameBar", "https://h5.qzone.qq.com/h5plus/homeV2/index/alpha?_proxy=1&_wv=3&via=qqnavigation.2017"))))
    {
      l = a(parambgve);
      if (l <= 0L)
      {
      ...
      if (QzoneOfflineCacheHelper.getSmallGameLastCacheTime(parambgve.a().getLongAccountUin()) <= 0L) {
        break label367;
      }
      i = 1;
    ...
    for (;;)
    {
      ...
      bcdu.a(localBaseApplication).reportTimeKVEvent(str1, localProperties, (int)l);
      if (8589934594L == paramLong) {}
      for (paramString = amtj.a(2131711734);; paramString = amtj.a(2131711735))
      {
        QLog.i("QzoneWebViewOfflinePlugin", 2, paramString + l + "ms,mta key=" + str1);
        if (8589934594L != paramLong) {
          break;
        }
        QzoneOfflineCacheHelper.updataSmallGameLastCacheFinishTime(parambgve.a().getLongAccountUin(), System.currentTimeMillis());
        return;
      }
      while (i == 0)
      {
  ...
  private void c(String... paramVarArgs)
  {
    ...
    try
    {
      ...
      localbgyq.f = ((JSONObject)localObject2).optString("callback");
      localbgyq.jdField_a_of_type_JavaLangString = ((JSONObject)localObject2).optString("url");
    ...
    catch (Exception localException)
    {
      ...
      paramVarArgs = new bgyr();
      paramVarArgs.jdField_b_of_type_JavaLangString = localbgyq.jdField_a_of_type_JavaLangString;
      paramVarArgs.jdField_a_of_type_Int = 3;
      paramVarArgs.jdField_c_of_type_Int = 101;
      paramVarArgs.f = localException.getMessage();
      paramVarArgs.e = localbgyq.f;
      a(paramVarArgs, localbgyq.f);
      return;
    }
    if (!a(a(), localbgyq.jdField_a_of_type_JavaLangString))
    {
      localObject1 = a(a());
      localObject2 = a(localbgyq.jdField_a_of_type_JavaLangString);
      throw new Exception("not support for cross-domain request!!! current host=" + (String)localObject1 + ",req host=" + (String)localObject2);
    }
    localbgyq.jdField_b_of_type_JavaLangString = ((JSONObject)localObject2).optString("method");
    if ((!"GET".equalsIgnoreCase(localbgyq.jdField_b_of_type_JavaLangString)) && (!"POST".equalsIgnoreCase(localbgyq.jdField_b_of_type_JavaLangString))) {
      throw new Exception("no such method support!!!");
    }
    Object localObject1 = ((JSONObject)localObject2).opt("body");
    if ((localObject1 instanceof JSONObject)) {
      localbgyq.e = "application/x-www-form-urlencoded";
    }
    for (localbgyq.d = a((JSONObject)localObject1);; localbgyq.d = localObject1.toString())
    {
    ...
    {
      localbgyq.jdField_c_of_type_JavaLangString = ((String)localObject1);
      localbgyq.jdField_a_of_type_Boolean = ((JSONObject)localObject2).optBoolean("dataNeedBase64", false);
      localbgyq.jdField_a_of_type_Int = ((int)(((JSONObject)localObject2).optDouble("timeout", 0.0D) * 1000.0D));
      localbgyq.jdField_a_of_type_JavaLangObject = ((JSONObject)localObject2).opt("userinfo");
      if (this.jdField_b_of_type_AndroidOsHandler == null) {
        this.jdField_b_of_type_AndroidOsHandler = new aacx(this, Looper.getMainLooper());
      }
      if (bgyp.a().a(localbgyq, this.jdField_b_of_type_AndroidOsHandler)) {
        break;
      }
      paramVarArgs = new bgyr();
      paramVarArgs.jdField_b_of_type_JavaLangString = localbgyq.jdField_a_of_type_JavaLangString;
  ...
  protected void a(bgyr parambgyr)
  {
    a(parambgyr, parambgyr.e);
  }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      if ((paramJsBridgeListener.has("proxyUrl")) && (paramJsBridgeListener.has("isCheckCache")))
      {
        ...
        if ((bool) && (!TextUtils.isEmpty(bgzd.d(this.jdField_a_of_type_JavaLangString))))
        {
        ...
        if (this.jdField_a_of_type_AndroidOsHandler == null) {
          this.jdField_a_of_type_AndroidOsHandler = new aacv(this, Looper.getMainLooper());
        }
