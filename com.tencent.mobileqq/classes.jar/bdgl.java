...
public class bdgl
  ...
  implements bdgf
{
  public bdgl(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(oidb_cmd0xe89.ReqBody paramReqBody, bdhl parambdhl, String paramString)
  {
    try
    {
    ...
    catch (Exception localException)
    {
      ...
      localAtext.bytes_text.set(ByteStringMicro.copyFrom(parambdhl.d.getBytes()));
      localAtext.bytes_attribs.set(ByteStringMicro.copyFrom(parambdhl.e.getBytes()));
      localAtext.bytes_apool.set(ByteStringMicro.copyFrom(parambdhl.c.getBytes()));
  ...
  public void a(bdhl parambdhl, String paramString)
  {
    if (QLog.isColorLevel()) {
    ...
    a(localReqBody, parambdhl, paramString);
    parambdhl = a(localReqBody, 0, "OidbSvcTcp.0xe89_0");
    parambdhl.extraData.putString("write_together_group_code", paramString);
    sendPbReq(parambdhl);
  }
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    {
      notifyUI(2, true, bdgn.a((oidb_cmd0xe89.RspGetDocContent)localRspBody.get_pad_content_rsp_info.get()));
      return;
    }
