  ...
  extends ajtb
{
  ...
  public mug(QQAppInterface paramQQAppInterface)
  {
  ...
  public ToServiceMsg a(long paramLong1, String paramString, int paramInt1, int paramInt2, int paramInt3, byte[] paramArrayOfByte, long paramLong2)
  {
    ...
    paramLong1 = apug.b();
    long l = apug.a();
    Object localObject = new axax();
    ((axax)localObject).jdField_a_of_type_Int = paramInt2;
    ((axax)localObject).jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
    paramString = a(13, paramString, (axax)localObject, l, axau.b(paramLong1), paramLong2);
