...
public class bamd
  extends banq
{
  public bamd(BaseApplicationImpl paramBaseApplicationImpl)
  {
  ...
  public Object decodeFile(File paramFile, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    try
    {
      ...
      paramDownloadParams.inPreferredConfig = baul.a;
      ...
      if (bool) {
        try
        {
          ...
          if (paramDownloadParams != null) {
            return new bauz(paramFile.getAbsolutePath()).a(paramDownloadParams);
          }
          paramFile.delete();
