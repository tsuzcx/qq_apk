...
public class bgcn
{
  public static int a(EditText paramEditText, ArrayList<ResultRecord> paramArrayList, List<bgcm> paramList, int paramInt)
  {
    int i;
    ...
    for (;;)
    {
      ...
      bgcm localbgcm = new bgcm();
      if (!TextUtils.isEmpty(((ResultRecord)localObject).b)) {}
      for (localbgcm.jdField_a_of_type_JavaLangString = ((ResultRecord)localObject).b;; localbgcm.jdField_a_of_type_JavaLangString = ((ResultRecord)localObject).jdField_a_of_type_JavaLangString) {
        try
        {
          long l = Long.valueOf(((ResultRecord)localObject).jdField_a_of_type_JavaLangString).longValue();
          localbgcm.jdField_a_of_type_Long = l;
          if ((localbgcm.jdField_a_of_type_JavaLangString == null) || (localbgcm.jdField_a_of_type_Long == 0L)) {
            break label15;
          }
          i = paramInt;
          if (paramList == null) {
          ...
          paramList.add(localbgcm);
          localObject = "@" + localbgcm.jdField_a_of_type_JavaLangString + " ";
          i = paramInt;
  ...
  public static int a(CharSequence paramCharSequence, int paramInt1, int paramInt2, List<bgcm> paramList, int paramInt3, int paramInt4, String paramString)
  {
  ...
  public static SystemEmoticonPanel a(Context paramContext, EditText paramEditText)
  {
    try
    {
      paramContext = new SystemEmoticonPanel(paramContext, new bgco(paramEditText));
      return paramContext;
    }
  ...
  public static String a(EditText paramEditText)
  {
    ...
    {
      if ((paramEditText.getText() instanceof axkn))
      {
        axkn localaxkn = (axkn)paramEditText.getText();
        if (localaxkn != null) {
          return localaxkn.a();
        }
      }
  ...
  public static String a(EditText paramEditText, List<bgcm> paramList)
  {
    if (paramEditText != null)
    {
      paramEditText = a(paramEditText);
      if (!TextUtils.isEmpty(paramEditText)) {
        return a(paramEditText, paramList).replaceAll(ajjy.a(2131640003), ajjy.a(2131640007)).replaceAll(ajjy.a(2131640004), "/MM");
      }
    }
    return "";
  }
  ...
  public static String a(String paramString, List<bgcm> paramList)
  {
  ...
  public static void a(String paramString, int paramInt, EditText paramEditText)
  {
    ...
    Editable localEditable = axkr.c.newEditable(paramEditText.getText());
  ...
  public static boolean a(String paramString1, boolean paramBoolean, List<bgcm> paramList, int paramInt1, int paramInt2, String paramString2)
  {
    if (((a(paramInt1, paramInt2, paramString2)) || (!paramBoolean)) && (paramList != null))
    {
      ...
      {
        paramString2 = (bgcm)paramList.get(paramInt1);
  ...
  public static String b(String paramString, List<bgcm> paramList)
  {
    String str;
    if (paramString == null) {
      str = null;
    ...
    for (;;)
    {
      ...
      bgcm localbgcm = (bgcm)localIterator.next();
      str = localbgcm.jdField_a_of_type_JavaLangString;
      paramList = str;
      if (str == null) {
        paramList = localbgcm.jdField_a_of_type_Long + "";
      }
      paramList = paramList.replace("%", "%25").replace(",", "%2C").replace("}", "%7D");
      paramList = "@{uin:" + localbgcm.jdField_a_of_type_Long + ",nick:" + paramList + "}";
      str = "@" + localbgcm.jdField_a_of_type_JavaLangString;
      if ((!TextUtils.isEmpty(localbgcm.jdField_a_of_type_JavaLangString)) && (paramString.contains(str))) {
