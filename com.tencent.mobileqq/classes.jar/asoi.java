...
public class asoi
{
  ...
  aslv jdField_a_of_type_Aslv;
  asnb jdField_a_of_type_Asnb;
  public asor a;
  protected asot a;
  ...
  public asoi(Context paramContext, QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Aslv = new aslv(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
  ...
  {
    TVK_SDKMgr.setOnLogListener(new asoq(null));
  ...
  public static void a(String paramString)
  {
    ...
    Object localObject = ajed.aU + ".now_video/" + "vid_" + a(paramString) + ".mp4";
    ...
    localObject = asoz.a(shp.a("vid_" + a(paramString), 0), (String)localObject + ".tmp", 0L);
    ((TVK_PlayerVideoInfo)localObject).setConfigMap("cache_duration", "5");
    paramString = axwx.b(paramString.replace("https://", "http://"), 1012);
    localTVK_ICacheMgr.setPreloadCallback(new asoj());
    localTVK_ICacheMgr.preLoadVideoByUrl(BaseApplicationImpl.getContext(), paramString, null, (TVK_PlayerVideoInfo)localObject);
  }
  
  public long a()
  {
    return this.jdField_a_of_type_Asot.a();
  }
  ...
  public asot a()
  {
    ...
    if (TVK_SDKMgr.isInstalled(this.jdField_a_of_type_AndroidContentContext)) {
      return new asoz(this.jdField_a_of_type_AndroidContentContext);
    }
    QLog.w("VideoPlayerView", 1, "use VideoViewTextureImpl!");
    return new aspg(this.jdField_a_of_type_AndroidContentContext);
  }
  ...
  public void a(RelativeLayout paramRelativeLayout)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131302919));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131299747));
    ...
    this.jdField_a_of_type_AndroidOsHandler = new asok(this, this.jdField_a_of_type_AndroidContentContext.getMainLooper());
  }
  ...
  public void a(asor paramasor)
  {
    this.jdField_a_of_type_Asor = paramasor;
  }
  ...
  public void a(VideoData paramVideoData)
  {
    ...
    if ((this.jdField_a_of_type_Asot != null) && (this.jdField_a_of_type_Asot.a() != null) && (this.jdField_a_of_type_Asot.a().getParent() != null)) {
      ((ViewGroup)this.jdField_a_of_type_Asot.a().getParent()).removeView(this.jdField_a_of_type_Asot.a());
    }
    this.jdField_a_of_type_Asot = a();
    Object localObject;
    if ((this.jdField_a_of_type_Asot instanceof asoz))
    {
      localObject = (asoz)this.jdField_a_of_type_Asot;
    ...
    if (this.jdField_a_of_type_Asot != null) {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.addView(this.jdField_a_of_type_Asot.a(), 0, new RelativeLayout.LayoutParams(-1, -1));
    }
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.requestLayout();
    this.jdField_a_of_type_Int = 1;
    asmr.jdField_a_of_type_Int = 0;
    asmr.jdField_a_of_type_Long = System.currentTimeMillis();
    ...
    for (;;)
    {
      try
      {
        ...
        this.jdField_a_of_type_Asot.a(new asol(this));
        this.jdField_a_of_type_Asot.a(new asom(this));
        this.jdField_a_of_type_Asot.a(new ason(this));
        this.jdField_a_of_type_Asot.a(new asoo(this, paramVideoData));
        localObject = ajed.aU + ".now_video/" + "vid_" + a(str) + ".mp4";
        ...
        if (localFile.exists())
        {
          ...
          this.jdField_a_of_type_Asot.a("vid_" + a(str), (String)localObject, str, paramVideoData.f);
          this.jdField_a_of_type_Asot.a(new asop(this, paramVideoData, bool2));
          if (QLog.isColorLevel()) {
      ...
      this.jdField_a_of_type_Asot.a("vid_" + a(str), (String)localObject + ".tmp", str, paramVideoData.f);
    }
  }
  ...
  public void b()
  {
    if (this.jdField_c_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_Asot.a(this.jdField_c_of_type_Long);
    }
  ...
  public long c()
  {
    ...
    {
      return 0L;
      localObject = ajed.aU + ".now_video/" + "vid_" + a(this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelVideoData.jdField_b_of_type_JavaLangString) + ".mp4";
      if (new File((String)localObject).exists()) {
        return ((String)localObject).length();
      }
      localObject = new File(ajed.aU + ".now_video/" + "vid_" + a(this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelVideoData.jdField_b_of_type_JavaLangString) + ".mp4.tmp");
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Asot.a();
    this.jdField_a_of_type_Asnb = null;
  }
  ...
  public boolean c()
  {
    ...
    {
      return false;
      if (new File(ajed.aU + ".now_video/" + "vid_" + a(this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelVideoData.jdField_b_of_type_JavaLangString) + ".mp4").exists()) {
        return true;
      }
