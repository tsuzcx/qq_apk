...
public class asoi
{
  ...
  public static String a(asln paramasln)
  {
    String str = String.format("%s_%d", new Object[] { paramasln.jdField_a_of_type_JavaLangString, Integer.valueOf(b(paramasln.jdField_a_of_type_Int)) });
    if (!TextUtils.isEmpty(paramasln.b)) {
      str = String.format("%s_%d_%s", new Object[] { paramasln.jdField_a_of_type_JavaLangString, Integer.valueOf(b(paramasln.jdField_a_of_type_Int)), paramasln.b });
    }
    return asoc.c + str + ".db";
  }
  ...
  {
    apvd.c(asoc.jdField_a_of_type_JavaLangString);
  }
  ...
  public static void a(MessageRecord paramMessageRecord, MsgBackupResEntity paramMsgBackupResEntity)
  {
    ...
    int i = axau.b(paramMessageRecord.msgUid);
  ...
  public static void a(MsgBackupMsgEntity paramMsgBackupMsgEntity)
  {
    if ((b) && (paramMsgBackupMsgEntity != null))
    {
      if (!TextUtils.isEmpty(paramMsgBackupMsgEntity.chatUin)) {
        paramMsgBackupMsgEntity.chatUin = MsgBackupJniProxy.decryptFromString(paramMsgBackupMsgEntity.chatUin, aslg.c);
      }
      if (paramMsgBackupMsgEntity.extraData != null) {
        paramMsgBackupMsgEntity.extraData = MsgBackupJniProxy.decryptFromByteArray(paramMsgBackupMsgEntity.extraData, aslg.c);
      }
      if (paramMsgBackupMsgEntity.extensionData != null) {
        paramMsgBackupMsgEntity.extensionData = MsgBackupJniProxy.decryptFromByteArray(paramMsgBackupMsgEntity.extensionData, aslg.c);
      }
    }
  }
  ...
  {
    if ((b) && (paramMsgBackupResEntity != null) && (paramMsgBackupResEntity.extraData != null) && (aslg.b != null)) {
      paramMsgBackupResEntity.extraData = MsgBackupJniProxy.encryptFromByteArray(paramMsgBackupResEntity.extraData, aslg.b);
    }
  }
  
  public static void a(String paramString, asln paramasln)
  {
    paramString = paramString.substring(0, paramString.indexOf(".")).split("_");
    paramasln.jdField_a_of_type_JavaLangString = paramString[0];
    paramasln.jdField_a_of_type_Int = c(Integer.parseInt(paramString[1]));
    if (paramString.length > 2) {
      paramasln.b = paramString[2];
    }
  }
  ...
  public static boolean a()
  {
    ...
    for (;;)
    {
      ...
      if (bool2)
      {
        File localFile = new File(asoc.b);
  ...
  public static long b(MessageRecord paramMessageRecord)
  {
    ...
    return axau.b(paramMessageRecord.msgUid);
  }
  ...
  {
    if ((b) && (paramMsgBackupMsgEntity != null) && (aslg.b != null))
    {
      if (!TextUtils.isEmpty(paramMsgBackupMsgEntity.chatUin)) {
        paramMsgBackupMsgEntity.chatUin = MsgBackupJniProxy.encryptFromString(paramMsgBackupMsgEntity.chatUin, aslg.b);
      }
      if (paramMsgBackupMsgEntity.extraData != null) {
        paramMsgBackupMsgEntity.extraData = MsgBackupJniProxy.encryptFromByteArray(paramMsgBackupMsgEntity.extraData, aslg.b);
      }
      if (paramMsgBackupMsgEntity.extensionData != null) {
        paramMsgBackupMsgEntity.extensionData = MsgBackupJniProxy.encryptFromByteArray(paramMsgBackupMsgEntity.extensionData, aslg.b);
      }
    }
  }
  ...
  {
    if ((b) && (paramMsgBackupResEntity != null) && (paramMsgBackupResEntity.extraData != null) && (aslg.c != null)) {
      paramMsgBackupResEntity.extraData = MsgBackupJniProxy.decryptFromByteArray(paramMsgBackupResEntity.extraData, aslg.c);
    }
  }
