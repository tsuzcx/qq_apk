  ...
  extends Drawable
{
  ...
  public bpcq(Context paramContext, String paramString)
  {
    this.jdField_a_of_type_Bpcg = new bpcg();
  ...
  public Bitmap a()
  {
    return a(this.jdField_a_of_type_Bpcg.a());
  }
  ...
  protected void c()
  {
    this.jdField_a_of_type_AndroidAnimationValueAnimator = ValueAnimator.ofObject(this.jdField_a_of_type_Bpcg, new Object[] { this.jdField_a_of_type_Bpcg.b(), this.jdField_a_of_type_Bpcg.a() });
    this.jdField_a_of_type_AndroidAnimationValueAnimator.setInterpolator(new DecelerateInterpolator());
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new bpcr(this));
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new bpcs(this));
    this.jdField_a_of_type_AndroidAnimationValueAnimator.setDuration(this.jdField_a_of_type_Bpcg.a());
