  ...
  implements Manager
{
  ...
  public aufu(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a()
  {
    ...
    NewIntent localNewIntent = new NewIntent(this.a.getApplication(), aufw.class);
  ...
  public boolean b()
  {
    ...
    Object localObject = (auqh)this.a.getManager(36);
    if (localObject == null) {
      return false;
    }
    localObject = ((auqh)localObject).a(String.valueOf(100180));
    return (localObject != null) && (((BusinessInfoCheckUpdate.AppInfo)localObject).iNewFlag.get() == 1);
  }
  
  public void c()
  {
    if ((!bgfo.d()) && (bgfo.c()) && (bgfo.e()))
    {
  ...
  public void d()
  {
    ...
    while ((i == 1) && (this.a != null) && (this.a.getApp() != null) && (aufx.a(this.a.getApp(), 84)))
    {
      if (QLog.isColorLevel()) {
        QLog.d("QzoneAlbumRedTouchManager", 2, "GetQZonePhotoGuideCheck supportJumpToQzone");
      }
      new aufx(this.a, this).a();
      return;
      localEditor.apply();
    }
    a();
