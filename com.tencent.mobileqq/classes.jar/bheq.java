...
{
  bheq(bheh parambheh, bisl parambisl, String paramString1, String paramString2, String paramString3) {}
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (paramInt != 0)
        {
          ...
          if (this.jdField_a_of_type_Bheh.a != null) {
            ArkFullScreenAppActivity.a(this.jdField_a_of_type_Bheh.a, this.c, paramAppPathInfo, "0.0.0.1", paramObject, ArkAppCenterUtil.getDensity(), null, 1);
          }
        }
        do
        {
          ...
          } while (this.jdField_a_of_type_Bheh.a == null);
          this.jdField_a_of_type_Bheh.a.startActivity(paramObject);
          return;
          QQToast.a(this.jdField_a_of_type_Bheh.a, 2131690151, 0).a();
