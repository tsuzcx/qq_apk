...
public class awhh
{
  ...
  private static awhi a()
  {
    Object localObject1 = BaseApplication.getContext();
    awhi localawhi = new awhi();
    try
    {
      String str1;
      String str2;
      ...
      try
      {
        ...
        if ((str3 != null) && (str3.startsWith("ctwap"))) {
          ...
          {
            localawhi.jdField_a_of_type_JavaLangString = str1;
            localawhi.jdField_a_of_type_Int = Integer.valueOf(str2).intValue();
          }
          else
          {
            localawhi.jdField_a_of_type_JavaLangString = "10.0.0.200";
            localawhi.jdField_a_of_type_Int = 80;
          }
        }
      }
      ...
      if ((str3 != null) && (str3.startsWith("cmwap")))
      {
        ...
        {
          localawhi.jdField_a_of_type_JavaLangString = "10.0.0.172";
          localawhi.jdField_a_of_type_Int = 80;
        }
      }
  ...
  public static InetSocketAddress a()
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          localObject1 = a();
          str = ((awhi)localObject1).jdField_a_of_type_JavaLangString;
          i = ((awhi)localObject1).jdField_a_of_type_Int;
        }
      }
    }
  }
