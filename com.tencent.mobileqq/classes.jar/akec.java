  ...
  implements INetInfoHandler
{
  ...
  public void onNetMobile2None()
  {
    ...
    arzy.a("Network", "onNetMobile2None()");
    if ((a == null) || (a.get() == null)) {}
    do
    {
      return;
      MqqHandler localMqqHandler = ((QQAppInterface)a.get()).getHandler(aozg.class);
  ...
  public void onNetMobile2Wifi(String paramString)
  {
    ...
    arzy.a("Network", "onNetMobile2Wifi()");
    if ((a == null) || (a.get() == null)) {}
    do
    {
      return;
      QQAppInterface localQQAppInterface = (QQAppInterface)a.get();
      MqqHandler localMqqHandler = localQQAppInterface.getHandler(aozg.class);
      if (localMqqHandler != null) {
        localMqqHandler.obtainMessage(10001, null).sendToTarget();
      }
      ...
      paramString = (anpc)localQQAppInterface.getManager(77);
      if (paramString != null) {
        paramString.a();
      }
      onh.a(localQQAppInterface);
  ...
  public void onNetNone2Mobile(String paramString)
  {
    ...
    arzy.a("Network", "onNetNone2Mobile()");
    if ((a == null) || (a.get() == null)) {
      return;
    }
    QQAppInterface localQQAppInterface = (QQAppInterface)a.get();
  ...
  public void onNetWifi2Mobile(String paramString)
  {
    ...
    Object localObject = auoj.a();
    if (localObject != null) {
      ((auoj)localObject).b();
    }
    arzy.a("Network", "onNetWifi2Mobile()");
    if ((a == null) || (a.get() == null)) {
      return;
    }
    localObject = (QQAppInterface)a.get();
    MqqHandler localMqqHandler = ((QQAppInterface)localObject).getHandler(aozg.class);
    if (localMqqHandler != null) {
      localMqqHandler.obtainMessage(10001, null).sendToTarget();
    }
    ...
    paramString = (anpc)((QQAppInterface)localObject).getManager(77);
    if (paramString != null) {
      paramString.a();
    }
