  ...
  public void a(String paramString, long paramLong, bguu parambguu, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        {
          if (parambguu.jdField_b_of_type_Int == 1810002)
          {
            if (QLog.isColorLevel()) {
          ...
          for (;;)
          {
            ...
            this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.a.jdField_b_of_type_Long, this.a.c, this.a.e, this.a.jdField_a_of_type_Int, 36, null, parambguu.jdField_b_of_type_Int, parambguu.jdField_a_of_type_JavaLangString);
            return;
            paramString = new String[3];
            paramString[0] = "param_XGFileFlow";
            paramString[1] = "param_XGFlow";
      ...
      this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.setFilePath(parambguu.jdField_b_of_type_JavaLangString);
      ...
      this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileName = apck.a(this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.getFilePath());
      ...
      this.a.jdField_a_of_type_Long = parambguu.jdField_b_of_type_Long;
