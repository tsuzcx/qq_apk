...
public class unb
{
  private static unb jdField_a_of_type_Unb;
  ...
  public static unb a()
  {
    try
    {
      if (jdField_a_of_type_Unb == null) {
        jdField_a_of_type_Unb = new unb();
      }
      unb localunb = jdField_a_of_type_Unb;
      return localunb;
    }
    finally {}
  }
  ...
  private void b(boolean paramBoolean, long paramLong, String paramString1, String paramString2)
  {
    ...
    if ("fullscreen_videoplay".equals(paramString1))
    {
      ...
      upe.c("WsBeaconReportPresenter", "只在播放页上报actWsPageFrom");
    }
    localHashMap.put("type", "4");
    bctj.a(BaseApplication.getContext()).a(null, "actWsGzhPerformance", paramBoolean, 0L, 0L, localHashMap, "");
    upe.d("WsBeaconReportPresenter", "event report: actWsGzhPerformance, position: " + (String)localHashMap.get("position") + ",params:" + localHashMap.toString());
  }
  ...
  public void a(long paramLong1, long paramLong2, int paramInt1, boolean paramBoolean1, boolean paramBoolean2, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      bctj.a(BaseApplication.getContext()).a(null, "actWsGzhFeedUserConsumption", true, 0L, 0L, localHashMap, "");
      upe.c("WsBeaconReportPresenter", "reportFallListExit{ stayTime:" + paramLong1 + ",loadTime:" + paramLong2 + ",exposeCount:" + paramInt1 + ",hasClickFuceng:" + paramBoolean1 + ",hasClickWeishi:" + paramBoolean2);
      upg.jdField_a_of_type_Boolean = false;
      return;
  ...
  public void a(HashMap<String, String> paramHashMap)
  {
    ...
    bctj.a(BaseApplication.getContext()).a(null, "actWsGzhFeedPerformance", true, 0L, 0L, (HashMap)localObject, "", true);
    localObject = new StringBuilder().append("reportRecommendReportFail：");
    if (paramHashMap != null) {}
    for (paramHashMap = paramHashMap.toString();; paramHashMap = "")
    {
      upe.a("WsBeaconReportPresenter", paramHashMap);
      return;
    }
  }
  ...
  public void a(boolean paramBoolean, long paramLong)
  {
    ...
    bctj.a(BaseApplication.getContext()).a(null, "actWsGzhFeedPerformance", paramBoolean, 0L, 0L, localHashMap, "");
  ...
  public void a(boolean paramBoolean, long paramLong1, long paramLong2, String paramString1, String paramString2)
  {
    ...
    bctj.a(BaseApplication.getContext()).a(null, "actWsGzhPerformance", paramBoolean, 0L, 0L, localHashMap, "");
    upe.c("WsBeaconReportPresenter", "event report: actWsGzhPerformance, position: " + (String)localHashMap.get("position") + ",params:" + localHashMap.toString());
  }
  ...
  public void a(boolean paramBoolean1, long paramLong, String paramString1, int paramInt, String paramString2, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      bctj.a(BaseApplication.getContext()).a(null, "actWsGzhPerformance", paramBoolean1, 0L, 0L, localHashMap, "");
      upe.c("WsBeaconReportPresenter", "event report: actWsGzhPerformance, position: " + (String)localHashMap.get("position") + ",params:" + localHashMap.toString());
      return;
      label175:
