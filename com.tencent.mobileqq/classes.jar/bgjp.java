  ...
  implements bgcc
{
  ...
  private String a(String paramString)
  {
    if (!TextUtils.isEmpty(paramString)) {
      return bgis.a(paramString, 200, 200, true);
    }
    return "";
  }
  ...
  private void a(String paramString, Bundle paramBundle, bgjt parambgjt)
  {
    Bundle localBundle;
    if ((paramBundle != null) && (parambgjt != null))
    {
    ...
    try
    {
      parambgjt.a(paramBundle, localBundle);
      if (paramString != null) {
        this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.callJs(paramString, new String[] { paramBundle.toString() });
      }
      return;
    }
    catch (Throwable parambgjt)
    {
      for (;;)
      {
        QLog.e("QzoneRecommedPhotoJsPlugin", 1, "onCallJsBridge.setData error", parambgjt);
      }
    }
  }
  ...
  private void a(String paramString1, String paramString2, Runnable paramRunnable, boolean paramBoolean)
  {
    try
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getHandler(bgkb.class).post(paramRunnable);
      return;
    }
  ...
  private void b(String paramString)
  {
    try
    {
      ...
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getHandler(bgkb.class).post(new QzoneRecommedPhotoJsPlugin.2(this));
      }
      return;
    }
  ...
  private void c(String paramString)
  {
    try
    {
      ...
      bfpr.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), bfpy.a(), localIntent, 0);
      return;
    }
    catch (Exception paramString)
    {
