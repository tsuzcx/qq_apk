...
public class acic
{
  private static final String jdField_a_of_type_JavaLangString = acic.class.getSimpleName();
  private static final byte[] jdField_a_of_type_ArrayOfByte = new byte[0];
  private achz jdField_a_of_type_Achz;
  private SharedPreferences jdField_a_of_type_AndroidContentSharedPreferences;
  private AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface;
  
  public acic(AppInterface paramAppInterface)
  {
    this.jdField_a_of_type_ComTencentCommonAppAppInterface = paramAppInterface;
    if (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null) {
      this.jdField_a_of_type_Achz = ((achz)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(321));
    }
  ...
  private void a(File paramFile)
  {
    ...
    if (paramFile.length > 0)
    {
      ...
      if ((localObject != null) && (((File)localObject).isFile()) && (((File)localObject).exists()))
      {
        ...
        if (bace.d(paramFile[0].getAbsolutePath())) {
  ...
  private File[] a(File paramFile)
  {
    ...
    Arrays.sort(paramFile, new acid(this));
    return paramFile;
  }
  ...
  private void b(AcsMsg paramAcsMsg)
  {
    ...
    {
      if (this.jdField_a_of_type_Achz == null) {
        this.jdField_a_of_type_Achz = ((achz)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(321));
      }
      if (this.jdField_a_of_type_Achz == null) {
        break label143;
      ...
      this.jdField_a_of_type_Achz.a(paramAcsMsg.hashCode());
    }
    while ((this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof QQAppInterface))
    {
      ...
      localQQAppInterface.a().b(ajed.ac, 9002, paramAcsMsg.msg_id.hashCode());
  ...
  {
    paramFile = paramFile.listFiles(new acie(this));
  ...
  public List<AcsMsg> a()
  {
    ...
    if (arrayOfFile.length > 0)
    {
      ...
      while (i < j)
      {
        ...
        if ((localObject != null) && (((File)localObject).isFile()) && (((File)localObject).exists()) && (ache.a(a((File)localObject))))
        {
          localObject = a((File)localObject);
  ...
  public void a(AcsMsg paramAcsMsg)
  {
    ...
    //   8: return
    //   9: aload_0
    //   10: getfield 39	acic:jdField_a_of_type_Achz	Lachz;
    //   13: ifnonnull +20 -> 33
    //   16: aload_0
    //   17: aload_0
    //   18: getfield 29	acic:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    //   21: sipush 321
    //   24: invokevirtual 35	com/tencent/common/app/AppInterface:getManager	(I)Lmqq/manager/Manager;
    //   27: checkcast 37	achz
    //   30: putfield 39	acic:jdField_a_of_type_Achz	Lachz;
    //   33: aload_0
    //   34: getfield 39	acic:jdField_a_of_type_Achz	Lachz;
    //   37: ifnull +35 -> 72
    //   40: aload_0
    //   41: getfield 39	acic:jdField_a_of_type_Achz	Lachz;
    //   44: aload_1
    //   45: invokevirtual 314	achz:a	(LWallet/AcsMsg;)V
    //   48: new 316	com/tencent/mobileqq/activity/activateFriend/biz/ReminderDataManager$1
    //   51: dup
    //   52: aload_0
    //   53: aload_1
    //   54: invokespecial 318	com/tencent/mobileqq/activity/activateFriend/biz/ReminderDataManager$1:<init>	(Lacic;LWallet/AcsMsg;)V
    //   57: bipush 64
    //   59: aconst_null
    //   60: iconst_1
    ...
    //   71: athrow
    //   72: aload_1
    //   73: invokestatic 319	agwb:a	(LWallet/AcsMsg;)V
    //   76: goto -28 -> 48
    //   79: astore_2
    //   80: aload_2
  ...
  public void a(String paramString, acig paramacig)
  {
    try
    {
      ThreadManagerV2.excute(new ReminderDataManager.5(this, paramString, paramacig), 64, null, true);
      return;
    }
    finally
    {
  ...
  public void a(String paramString, acih paramacih)
  {
    try
    {
      acib.b(paramString, new acif(this, paramacih));
      return;
    }
