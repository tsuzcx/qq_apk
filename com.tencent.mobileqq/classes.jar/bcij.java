  ...
  extends bcgw
{
  ...
  public bcij(String paramString)
  {
    this(paramString, "tag");
  }
  
  public bcij(String paramString1, String paramString2)
  {
    this.a = paramString2;
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if ((paramView != null) && ((paramView instanceof LinearLayout)))
    {
      ...
      paramBundle = (URLImageView)paramView.findViewById(2131368548);
      paramContext = (TextView)paramView.findViewById(2131379863);
    }
    for (;;)
    {
      ...
      try
      {
        ...
        {
          localObject = new ColorDrawable(2131167276);
  ...
  public void a(ObjectInput paramObjectInput)
  {
    ...
    this.ag = bblk.a(paramObjectInput.readUTF(), false);
  ...
  public boolean a(bcin parambcin)
  {
    ...
    {
      return true;
      this.ae = parambcin.a("color");
      this.af = parambcin.a("style");
      this.ag = parambcin.a("size");
      this.ah = bblk.a(bchh.a(parambcin), false);
      this.ac = parambcin.a("bgColor");
      this.ad = parambcin.a("icon");
      parambcin = parambcin.a("radius");
      try
      {
        this.p = Integer.valueOf(parambcin).intValue();
        return true;
      }
      catch (NumberFormatException parambcin) {}
    } while (!QLog.isColorLevel());
    QLog.e("Q..troop.faceScore.StructMsgItemTag", 2, "StructMsgItemTag fromXml radius is not a integer value.", parambcin);
    return true;
  }
