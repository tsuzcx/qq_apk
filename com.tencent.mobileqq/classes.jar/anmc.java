...
public class anmc
{
  private static anmc jdField_a_of_type_Anmc;
  private static String b = "LimixiuAVManager";
  private Context jdField_a_of_type_AndroidContentContext;
  anme jdField_a_of_type_Anme = null;
  anmf jdField_a_of_type_Anmf = null;
  anmg jdField_a_of_type_Anmg = null;
  AVContext jdField_a_of_type_ComTencentTMGSdkAVContext = null;
  private AVRoomMulti.EventListener jdField_a_of_type_ComTencentTMGSdkAVRoomMulti$EventListener = new anmd(this);
  String jdField_a_of_type_JavaLangString = null;
  
  private anmc(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_JavaLangString = "user";
  }
  
  public static anmc a(Context paramContext)
  {
    if (jdField_a_of_type_Anmc == null) {}
    try
    {
      if (jdField_a_of_type_Anmc == null) {
        jdField_a_of_type_Anmc = new anmc(paramContext);
      }
      return jdField_a_of_type_Anmc;
    }
    finally {}
  }
  ...
  {
    anlt localanlt = new anlt();
    localanlt.sdkAppId = Integer.parseInt(this.jdField_a_of_type_Anme.jdField_a_of_type_JavaLangString);
    localanlt.accountType = this.jdField_a_of_type_Anme.b;
    localanlt.appIdAt3rd = this.jdField_a_of_type_Anme.jdField_a_of_type_JavaLangString;
    localanlt.identifier = this.jdField_a_of_type_Anme.c;
    localanlt.engineCtrlType = 2;
    localanlt.jdField_a_of_type_Int = Integer.valueOf(this.jdField_a_of_type_Anme.f).intValue();
    localanlt.jdField_a_of_type_Long = Long.valueOf(this.jdField_a_of_type_Anme.g).longValue();
    QLog.i("AVManager", 1, "getStartParams|param.sdkAppId=" + localanlt.sdkAppId + ", param.accountType=" + localanlt.accountType + ", param.appIdAt3rd=" + localanlt.appIdAt3rd + ", param.identifier=" + localanlt.identifier + ", param.engineCtrlType=" + localanlt.engineCtrlType + ", param.nGameID=" + localanlt.jdField_a_of_type_Int + ", param.lGameRoomID=" + localanlt.jdField_a_of_type_Long);
    return localanlt;
  }
  ...
  public void a(long paramLong)
  {
    ...
    this.jdField_a_of_type_Anme.g = String.valueOf(paramLong);
  }
  ...
  public void a(anme paramanme)
  {
    this.jdField_a_of_type_Anme = paramanme;
  }
  
  public void a(anmg paramanmg)
  {
    this.jdField_a_of_type_Anmg = paramanmg;
  }
  ...
  public void a(AVCallback paramAVCallback)
  {
    ...
    com.tencent.TMG.utils.SoUtil.customLibPath = anml.a();
    ...
    for (;;)
    {
      ...
      i = 1101;
      continue;
      this.jdField_a_of_type_ComTencentTMGSdkAVContext.setAppVersion(this.jdField_a_of_type_Anme.e);
      AVChannelManager.setAppChannel(new anmh());
  ...
  public void a(String paramString, boolean paramBoolean1, boolean paramBoolean2, int paramInt, anmf paramanmf)
  {
    QLog.i("AVManager", 1, "enterRoom.");
    this.jdField_a_of_type_Anmf = paramanmf;
    if (this.jdField_a_of_type_ComTencentTMGSdkAVContext == null)
    {
      Log.e("AVManager", "enterRoom| enter room faild, because of context not started.");
      if (this.jdField_a_of_type_Anmf != null) {
        this.jdField_a_of_type_Anmf.a(1101, "context not started.");
      }
      return;
    }
    AVChannelManager.getAppChannel().loginWithParam(a());
  ...
  public void b(long paramLong)
  {
    ...
    this.jdField_a_of_type_Anme.f = String.valueOf(paramLong);
  }
