...
public class bnsa
{
  ...
  private bnsd jdField_a_of_type_Bnsd = new bnsd(null);
  private String jdField_a_of_type_JavaLangString;
  private int jdField_b_of_type_Int;
  private MediaExtractor jdField_b_of_type_AndroidMediaMediaExtractor;
  private String jdField_b_of_type_JavaLangString;
  
  public bnsa(String paramString1, String paramString2)
  {
  ...
  {
    int i = 0;
    this.jdField_a_of_type_Bnsd.jdField_a_of_type_JavaNioByteBuffer.position(0);
    if (this.jdField_a_of_type_AndroidMediaMediaExtractor.readSampleData(this.jdField_a_of_type_Bnsd.jdField_a_of_type_JavaNioByteBuffer, 0) <= 0)
    {
      a();
      i = -5;
    }
    do
    {
      return i;
      this.jdField_a_of_type_Bnsd.jdField_a_of_type_JavaNioByteBuffer.position(0);
    } while (this.jdField_b_of_type_AndroidMediaMediaExtractor.readSampleData(this.jdField_a_of_type_Bnsd.jdField_a_of_type_JavaNioByteBuffer, 0) > 0);
    a();
    return -6;
  }
  ...
  public static int a(String paramString1, String paramString2)
  {
    ...
    //   3: invokestatic 70	bnrz:a	(Landroid/content/Context;)Ljava/lang/String;
    //   6: astore 4
    ...
    //   54: aconst_null
    //   55: invokestatic 102	bnsa:b	(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    //   254: invokestatic 152	bnrz:b	(Landroid/content/Context;)Ljava/lang/String;
    ...
    //   449: aconst_null
    //   450: invokestatic 102	bnsa:b	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   453: aload_0
    //   454: ifnull +7 -> 461
    //   457: aload_0
    ...
    //   467: ldc 226
    //   469: aload_0
    //   470: invokestatic 102	bnsa:b	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   473: bipush 245
    //   475: ireturn
    //   476: astore 4
    //   478: ldc 226
    //   480: aload 4
    //   482: invokestatic 102	bnsa:b	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   485: goto -85 -> 400
  ...
  private static int a(List<String> paramList)
  {
    ...
    //   21: invokestatic 70	bnrz:a	(Landroid/content/Context;)Ljava/lang/String;
    //   24: astore 4
    ...
    //   72: aconst_null
    //   73: invokestatic 102	bnsa:b	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   76: aload_0
    //   77: iconst_0
    //   78: aload 4
    ...
    //   125: invokestatic 152	bnrz:b	(Landroid/content/Context;)Ljava/lang/String;
    //   128: invokeinterface 111 2 0
    //   133: pop
    //   134: new 242	bnsc
    //   137: dup
    //   138: aconst_null
    //   139: invokespecial 243	bnsc:<init>	(Lbnsb;)V
    //   142: astore 4
    ...
    //   177: aload 4
    //   179: aload_0
    //   180: putfield 246	bnsc:a	Ljava/lang/Process;
    //   183: aload 4
    //   185: invokevirtual 247	bnsc:a	()V
    //   188: aload_0
    ...
    //   221: aconst_null
    //   222: invokestatic 102	bnsa:b	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   225: aload 4
    //   227: invokevirtual 249	bnsc:b	()V
    //   230: iload_2
    //   231: istore_1
    //   232: aload_0
    //   233: ifnull -217 -> 16
    ...
    //   246: ldc 226
    //   248: aload_0
    //   249: invokestatic 102	bnsa:b	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   252: bipush 245
    //   254: ireturn
    //   255: astore 5
    //   257: ldc 226
    //   259: aload 5
    //   261: invokestatic 102	bnsa:b	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   264: goto -71 -> 193
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  {
    int j = new bnsa(paramString1, paramString2).a(null, paramInt);
    int i;
    if ((j == -2) || (j == -4) || (j == -6)) {
  ...
  private static int c(String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    //   56: aconst_null
    //   57: invokestatic 102	bnsa:b	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   60: aload_0
    //   61: iload_3
    //   62: invokestatic 381	bnsa:b	(Ljava/lang/String;I)I
    //   65: pop
    ...
    //   221: invokestatic 152	bnrz:b	(Landroid/content/Context;)Ljava/lang/String;
    //   224: invokeinterface 111 2 0
    //   229: pop
    //   230: new 242	bnsc
    //   233: dup
    //   234: aconst_null
    //   235: invokespecial 243	bnsc:<init>	(Lbnsb;)V
    //   238: astore_0
    ...
    //   269: aload_0
    //   270: aload_1
    //   271: putfield 246	bnsc:a	Ljava/lang/Process;
    //   274: aload_0
    //   275: invokevirtual 247	bnsc:a	()V
    //   278: aload_1
    ...
    //   332: aconst_null
    //   333: invokestatic 102	bnsa:b	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   336: aload_0
    //   337: invokevirtual 249	bnsc:b	()V
    //   340: aload_1
    //   341: ifnull +7 -> 348
    //   344: aload_1
    ...
    //   354: ldc 226
    //   356: aload_0
    //   357: invokestatic 102	bnsa:b	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   360: bipush 245
    //   362: ireturn
    //   363: astore 5
    //   365: ldc 226
    //   367: aload 5
    //   369: invokestatic 102	bnsa:b	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   372: goto -89 -> 283
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  public int a(String paramString, int paramInt)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Bnsd.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      j = a();
      i = j;
    } while (j != 0);
    if (!a(paramString))
    ...
    try
    {
      ...
      this.jdField_a_of_type_Bnsd.jdField_a_of_type_Int = this.jdField_a_of_type_AndroidMediaMediaMuxer.addTrack(localMediaFormat);
      this.jdField_a_of_type_Bnsd.jdField_b_of_type_Int = this.jdField_a_of_type_AndroidMediaMediaMuxer.addTrack((MediaFormat)localObject);
      return j;
    }
