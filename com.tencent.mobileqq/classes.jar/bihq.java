...
public class bihq
{
  ...
  public static bihr a(String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    bihr localbihr = new bihr();
    localbihr.jdField_a_of_type_JavaLangString = a(paramString);
    String str;
    if (!localSharedPreferences.getBoolean("guideEnable", false))
    {
      ...
      localbihr.jdField_a_of_type_Int = 4;
      switch (localbihr.jdField_a_of_type_Int)
      {
      case 3: 
      default: 
        str = "P3";
    ...
    for (;;)
    {
      ...
      if (localSharedPreferences.getInt("guideToastOpen", 0) == 1)
      {
        ...
        for (;;)
        {
          ...
          localbihr.jdField_a_of_type_Int = 1;
          break;
          label258:
      ...
      if (localSharedPreferences.getInt("guidePopupOpen", 0) == 1)
      {
        ...
        if ((i == 0) || (i == 1))
        {
          ...
          {
            localbihr.jdField_a_of_type_Int = 3;
          ...
          for (str = "lastTipTime_";; str = "lastDialogTime_")
          {
            ...
            if (localbihr.jdField_a_of_type_Int == 4) {
              break;
            }
            localSharedPreferences.edit().putLong(str, l).commit();
            break;
            localbihr.jdField_a_of_type_Int = 2;
            break label365;
          }
        }
        localbihr.jdField_a_of_type_Int = 4;
  ...
  public static void a(TrafficResultInfo paramTrafficResultInfo, Bundle paramBundle)
  {
    ...
    boolean bool1 = paramBundle.getBoolean(aokv.i);
    boolean bool3 = paramBundle.getBoolean(aokv.j);
    String str2 = paramBundle.getString(aokv.k);
    String str1 = paramBundle.getString(aokv.l);
  ...
  public static boolean a(Activity paramActivity, int paramInt, bihs parambihs, String paramString)
  {
    boolean bool = true;
    ...
    {
      return bool;
      localbihr = a(paramString, false, true);
      if (QLog.isColorLevel()) {
        QLog.i("CUKingCardHelper", 2, "shouldOverrideDialog, popUpType: " + localbihr.jdField_a_of_type_Int);
      }
    } while (localbihr.jdField_a_of_type_Int == 4);
    if (localbihr.jdField_a_of_type_Int == 1)
    {
      if (parambihs != null) {
        parambihs.callback(2);
      }
      return false;
    }
    new bihp(paramActivity, parambihs, paramInt, paramString, localbihr.jdField_a_of_type_Int).show();
    return false;
  }
