  ...
  implements bggz
{
  ...
  public alaw(MessageForQQWalletMsg paramMessageForQQWalletMsg)
  {
  ...
  public static void a(MessageRecord paramMessageRecord, QQAppInterface paramQQAppInterface)
  {
    if (paramMessageRecord != null)
    {
      ...
      albw.a(paramQQAppInterface, paramMessageRecord);
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageForQQWalletMsg paramMessageForQQWalletMsg)
  {
    ...
    if (bool)
    {
      ((bggl)paramQQAppInterface.getManager(QQManagerFactory.AIO_ANIMATION_MANAGER)).a(new alaw(paramMessageForQQWalletMsg), false);
      return true;
    }
    return false;
  }
  ...
  public static boolean a(Object paramObject, QQAppInterface paramQQAppInterface)
  {
    ...
    if ((i == 7) || (i == 8) || (i == 11) || (i == 12))
    {
      ...
      if ((!akyo.a().a()) && (!paramQQAppInterface.getCurrentUin().equals(paramObject.senderuin)))
      {
  ...
  public void a(BaseChatPie paramBaseChatPie, bdyy parambdyy)
  {
    albw.a(albw.a(), "212", "only.animation.show");
    String str = alau.a() + this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg.mQQWalletRedPacketMsg.body.feedId + ".zip";
    ...
    parambdyy = new alax(this, parambdyy);
    this.jdField_a_of_type_JavaLangRunnable = new SpecifyRedPacketAnimMsg.2(this, parambdyy);
    ThreadManager.getUIHandler().postDelayed(this.jdField_a_of_type_JavaLangRunnable, 10000L);
    PreloadManager.a().c(str, new alay(this, localWeakReference, parambdyy, paramBaseChatPie));
  }
