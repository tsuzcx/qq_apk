  ...
  implements wou
{
  ...
  public whg()
  {
    ...
    this.jdField_a_of_type_Whh = new whi(this);
    Object localObject1 = new whj();
    ((whj)localObject1).a(0);
    localObject1 = ((whj)localObject1).a();
    Object localObject2 = new whj();
    ((whj)localObject2).a(1);
    localObject2 = ((whj)localObject2).a();
    Object localObject3 = new whj();
    ((whj)localObject3).a(2);
    localObject3 = ((whj)localObject3).a();
  ...
  public void a()
  {
    this.jdField_a_of_type_ComTencentBizQqstoryBasePreloadPreloadDownloader.a(this.jdField_a_of_type_Whh);
  ...
  public void a(int paramInt)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 24	whg:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   6: iload_1
    ...
    //   41: invokestatic 89	yqp:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   44: aload_0
    //   45: monitorexit
    //   46: return
    //   47: aload_0
    //   48: getfield 29	whg:jdField_a_of_type_ComTencentBizQqstoryBasePreloadPreloadDownloader	Lcom/tencent/biz/qqstory/base/preload/PreloadDownloader;
    //   51: invokevirtual 92	com/tencent/biz/qqstory/base/preload/PreloadDownloader:a	()I
    //   54: istore_2
    //   55: aload_0
    //   56: getfield 29	whg:jdField_a_of_type_ComTencentBizQqstoryBasePreloadPreloadDownloader	Lcom/tencent/biz/qqstory/base/preload/PreloadDownloader;
    //   59: invokevirtual 95	com/tencent/biz/qqstory/base/preload/PreloadDownloader:a	()Lwgv;
    //   62: astore 4
    //   64: aload_3
    ...
    //   98: invokestatic 105	yqp:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   101: iload_2
    //   102: iload_1
    //   103: if_icmpne -59 -> 44
    //   106: aload_0
    //   107: getfield 29	whg:jdField_a_of_type_ComTencentBizQqstoryBasePreloadPreloadDownloader	Lcom/tencent/biz/qqstory/base/preload/PreloadDownloader;
    //   110: aload 4
    //   112: invokevirtual 108	com/tencent/biz/qqstory/base/preload/PreloadDownloader:a	(Lwgv;)V
    //   115: goto -71 -> 44
    //   118: astore_3
    //   119: aload_0
    //   120: monitorexit
  ...
  public void a(List<wgv> paramList, int paramInt, boolean paramBoolean)
  {
    if (paramList == null) {}
    ...
    for (;;)
    {
      ...
      try
      {
        yqp.d("Q.qqstory.download.preload.PreloadDownloaderManager", "setPreloadTaskList , id = %d , size = %d", new Object[] { Integer.valueOf(paramInt), Integer.valueOf(paramList.size()) });
        localPreloadQueue = (PreloadQueue)this.jdField_a_of_type_JavaUtilList.get(paramInt);
        if (localPreloadQueue == null) {
          yqp.d("Q.qqstory.download.preload.PreloadDownloaderManager", "cannot find queue , id = " + paramInt);
        }
      }
      finally {}
    }
    wgv localwgv2 = this.jdField_a_of_type_ComTencentBizQqstoryBasePreloadPreloadDownloader.a();
    if (paramList.size() == 0) {}
    for (wgv localwgv1 = null;; localwgv1 = (wgv)paramList.get(0))
    {
      localPreloadQueue.clearAllTask();
      paramList = paramList.iterator();
      while (paramList.hasNext()) {
        localPreloadQueue.addTask((wgv)paramList.next(), false);
      }
    }
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentBizQqstoryBasePreloadPreloadDownloader.a(localwgv2);
      break;
    }
  }
  ...
  {
    this.jdField_a_of_type_ComTencentBizQqstoryBasePreloadPreloadDownloader.a(paramwgz);
  }
