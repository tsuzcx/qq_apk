...
{
  public bcyf(AuthorityActivity paramAuthorityActivity) {}
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 0: 
      ...
      if (i != 0) {
        QLog.d("AuthorityActivity", 1, "rec | cmd: G_A_L_D | uin : *" + bdem.a(this.a.jdField_a_of_type_Bdna.jdField_a_of_type_JavaLangString) + " | ret : success | code : " + i);
      }
      break;
    }
    label3592:
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          bded.a().a(this.a.jdField_a_of_type_Bdna.jdField_a_of_type_JavaLangString, "", AuthorityActivity.jdField_e_of_type_JavaLangString, "1", "6", "" + i, false);
          if (TextUtils.isEmpty(localGetAuthApiListResponse.msg.get()))
          {
            ...
            if (i == 110405)
            {
              this.a.a(paramMessage, new bcyg(this));
          ...
          {
            paramMessage = String.format(this.a.getResources().getString(2131696781), new Object[] { localGetAuthApiListResponse.msg.get(), Integer.valueOf(i) });
            continue;
          }
          ...
          if (i == 100044)
          {
            ...
            bded.a().a((Bundle)localObject3, AuthorityActivity.jdField_e_of_type_JavaLangString, this.a.jdField_a_of_type_Bdna.jdField_a_of_type_JavaLangString, false);
          }
          ...
          this.a.a(paramMessage, new bcyh(this, localGetAuthApiListResponse, (JSONObject)localObject1));
          continue;
        ...
        if (this.a.jdField_a_of_type_ComTencentOpenAgentCardContainer.a(localGetAuthApiListResponse))
        {
          ...
          this.a.jdField_a_of_type_AndroidWidgetButton.setText(2131694900);
          ...
          axrl.a(this.a).a(this.a.jdField_a_of_type_JavaLangString, "connect_sso_pageview", false, System.currentTimeMillis() - this.a.jdField_a_of_type_Long, 0L, paramMessage, "");
        ...
        if (i != 0)
        {
          QLog.d("AuthorityActivity", 1, "rec | cmd: A_D | uin : *" + bdem.a(this.a.jdField_a_of_type_Bdna.jdField_a_of_type_JavaLangString) + " | ret : success | code : " + i);
          try
          {
            ...
            if (TextUtils.isEmpty((CharSequence)localObject2))
            {
              ...
              this.a.a(paramMessage, new bcyi(this));
            }
            for (;;)
            {
              this.a.b(i, paramMessage);
              ...
              if (i == 1105030)
              {
                ...
                paramMessage = bdnz.a(AuthorityActivity.jdField_e_of_type_JavaLangString, this.a.jdField_a_of_type_Bdna.jdField_a_of_type_JavaLangString);
              ...
              if (i == 100044)
              {
                ...
                this.a.a(paramMessage, new bcyj(this, (SdkAuthorize.AuthorizeResponse)localObject1, (JSONObject)localObject2));
              }
            }
        ...
        catch (JSONException paramMessage)
        {
          ...
          for (paramMessage = "1";; paramMessage = "0")
          {
            ...
            axrl.a(this.a).a(this.a.jdField_a_of_type_JavaLangString, "connect_sso_lognback", true, System.currentTimeMillis() - this.a.jdField_b_of_type_Long, 0L, (HashMap)localObject1, "");
