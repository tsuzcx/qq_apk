...
public class axku
{
  ...
  static
  {
    jdField_a_of_type_Int = axjs.jdField_b_of_type_ArrayOfJavaLangString.length;
  }
  ...
  public static int a(String paramString, int paramInt)
  {
    ...
    if (n < i3)
    {
      ...
      if (((paramInt & 0x6) > 0) && (i4 == 20) && (n < i3 - 1))
      {
        ...
        if (i < axjs.jdField_a_of_type_Int)
        {
          j = 1;
          i = k + 1;
          m = 2;
  ...
  public static final Drawable a(int paramInt)
  {
    ...
    {
      i = j;
      if (paramInt < axjs.jdField_b_of_type_Int) {
  ...
  public static final Drawable a(int paramInt, axkv paramaxkv)
  {
    if (paramInt < 0) {
      throw new IllegalArgumentException("invaid emoji index: " + paramInt);
    }
    ...
    if (paramInt >= 1000)
    {
      ...
      ThreadManager.executeOnFileThread(new TextUtils.1(paramInt, paramaxkv));
      return null;
    }
    ...
    for (paramInt = 2130839808 + paramInt;; paramInt = 2130839942)
    {
      if (BaseApplicationImpl.sImageCache != null)
      {
        ...
        ThreadManager.executeOnFileThread(new TextUtils.2(paramInt, paramaxkv));
        return null;
      }
  ...
  public static final Drawable a(int paramInt, boolean paramBoolean)
  {
    ...
    if (!paramBoolean)
    {
      paramInt = axjs.jdField_b_of_type_ArrayOfInt[paramInt];
      if (BaseApplicationImpl.sImageCache != null) {
    ...
    do
    {
      ...
      int i = axjs.jdField_a_of_type_ArrayOfInt[paramInt];
      j = axjs.jdField_b_of_type_ArrayOfInt[paramInt];
      try
      {
  ...
  public static Drawable a(Resources paramResources, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramInt = azzg.a((Drawable)localObject);
  ...
  {
    if ((paramInt < 0) || (paramInt >= axjs.d.length)) {
      throw new IllegalArgumentException("invaid sys emotcation index: " + paramInt);
    }
    return String.valueOf(Character.toChars(axjs.d[paramInt]));
  }
        ...
        if (paramString != null)
        {
          for (;;)
          {
            ...
            catch (Throwable paramString)
            {
              ...
              paramString[j] = 13;
              continue;
              paramString = anam.a(paramString);
              if (paramString == null) {
                break label428;
              }
            }
            ...
            if (localStringBuilder.codePointAt(i) == 20)
            {
              ...
              if (i < localStringBuilder.length() - 1)
              {
                ...
                if (k >= axjs.jdField_a_of_type_Int) {
                  continue;
                }
                paramString = axjs.jdField_a_of_type_ArrayOfJavaLangString[k];
  ...
  public static String a(String paramString, Paint paramPaint, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    if ((k < i3) && (paramInt2 < paramInt3))
    {
      ...
      if (((paramInt1 & 0x6) > 0) && (i5 == 20) && (k < i3 - 1))
      {
        ...
        if (paramInt2 < axjs.jdField_a_of_type_Int)
        {
          paramInt2 = 2;
          i += 1;
          j = 1;
  ...
  {
    QQSysAndEmojiBaseInfo localQQSysAndEmojiBaseInfo = angd.a().a(1);
    boolean bool = false;
  ...
  public static final Drawable b(Resources paramResources, int paramInt)
  {
    ...
    //   63: getstatic 440	axjp:b	Ljava/lang/String;
    ...
    //   114: astore_0
    //   115: aload 6
    //   117: invokestatic 466	axjp:a	([B)I
    //   120: istore_2
    //   121: aload 5
    //   123: astore_0
    ...
    //   212: getstatic 440	axjp:b	Ljava/lang/String;
    ...
    //   256: astore_0
    //   257: aload 6
    //   259: invokestatic 489	azzz:a	(Landroid/graphics/Bitmap;)I
    //   262: istore_2
    //   263: aload 5
    //   265: astore_0
    ...
    //   408: ldc_w 472
    //   411: iconst_2
    //   412: invokestatic 503	aciy:a	()Ljava/lang/StringBuilder;
    //   415: ldc_w 505
    ...
    //   448: getstatic 440	axjp:b	Ljava/lang/String;
    ...
    //   465: getstatic 440	axjp:b	Ljava/lang/String;
    ...
    //   521: getstatic 440	axjp:b	Ljava/lang/String;
    ...
    //   533: ldc_w 472
    //   536: iconst_2
    //   537: invokestatic 503	aciy:a	()Ljava/lang/StringBuilder;
    //   540: ldc_w 505
    ...
    //   575: getstatic 440	axjp:b	Ljava/lang/String;
  ...
  {
    if ((paramInt < 0) || (paramInt >= bglr.e.length)) {
      throw new IllegalArgumentException("invaid emotcation index: " + paramInt);
    }
    return String.valueOf(Character.toChars(bglr.e[paramInt]));
  }
  ...
  public static String b(String paramString)
  {
    ...
    do
    {
      return str1;
      i = 0;
      while (i < axjs.d.length)
      {
        j = paramString.indexOf(axjs.d[i], 0);
        str1 = paramString;
        if (j != -1)
        {
          str1 = paramString;
      ...
      catch (AccountNotMatchException localAccountNotMatchException)
      {
        for (;;)
        {
          try
          {
            ...
            localObject1 = (arnz)((AppInterface)localObject1).getManager(14);
            ...
            if (localStringBuilder.codePointAt(i) == 20)
            {
              ...
              {
                k = localStringBuilder.charAt(i + 1);
                if ((k >= axjs.jdField_a_of_type_Int) && (250 != k)) {
                  break label244;
                }
                j = k;
                if (250 == k) {
                ...
                paramString = axjs.jdField_a_of_type_ArrayOfJavaLangString[j];
                localStringBuilder.replace(i, i + 2, paramString);
                j = i + (paramString.length() - 1);
              }
            }
  ...
  public static final String e(int paramInt)
  {
    ...
    return axjs.jdField_a_of_type_ArrayOfJavaLangString[paramInt];
  }
  ...
  public static String e(String paramString)
  {
    ...
    {
      k = paramString.indexOf(axjs.d[i], 0);
      localObject = paramString;
      if (k != -1)
      {
        ...
        catch (AccountNotMatchException paramString)
        {
          for (;;)
          {
            try
            {
              ...
              localObject = axjs.jdField_a_of_type_ArrayOfJavaLangString[m];
              if (k != 0) {
                break label650;
              }
              localObject = ajjy.a(2131649094) + (String)localObject;
