...
public class aiwa
{
  public static aiwa a()
  {
    return aiwd.a();
  }
  
  private ArrayList<aiwc> b(String paramString)
  {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      paramString.add(new aiwc(this, (String)localEntry.getKey(), (Long)localEntry.getValue()));
    }
  ...
  ArrayList<String> a(String paramString)
  {
    ...
    while (paramString.hasNext()) {
      localArrayList.add(((aiwc)paramString.next()).a());
    }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    if (localSharedPreferences.getLong(paramString2, -1L) == -1L)
    {
      ...
      if ((paramString1 != null) && (paramString1.size() >= 3))
      {
        ...
        {
          localEditor.remove(((aiwc)paramString1.get(i)).a());
          i += 1;
        }
      }
    }
