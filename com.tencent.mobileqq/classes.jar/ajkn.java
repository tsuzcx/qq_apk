...
public class ajkn
{
  ...
  public static ajkn a()
  {
    try
    {
      if (jdField_a_of_type_Ajkn == null) {
        jdField_a_of_type_Ajkn = new ajkn();
      }
      ajkn localajkn = jdField_a_of_type_Ajkn;
      return localajkn;
    }
    finally {}
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    {
      return;
      localajmu = (ajmu)paramQQAppInterface.getManager(155);
      localObject1 = localajmu.a(paramSessionInfo);
    ...
    if (i >= 0)
    {
      ...
      ApolloGameData localApolloGameData = localajmu.a(((MessageForApollo)localObject1).gameId);
      if ((localApolloGameData == null) || (!ajmr.a("8.3.0", localApolloGameData.minVer, localApolloGameData.maxVer))) {
        break label262;
      }
    }
    label262:
        ...
        do
        {
          do
          {
            do
            {
              ...
              localObject1 = localajmu.a(((MessageForApollo)localObject1).gameId);
            } while ((localObject1 != null) && (ajmr.a("8.3.0", ((ApolloGameData)localObject1).minVer, ((ApolloGameData)localObject1).maxVer)));
            paramQQAppInterface = ((ajfe)paramQQAppInterface.getManager(249)).a();
