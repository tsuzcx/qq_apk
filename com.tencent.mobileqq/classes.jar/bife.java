...
{
  bife(biey parambiey, OpenSDKAppInterface paramOpenSDKAppInterface, bifg parambifg) {}
  ...
  public void onFailed(String paramString, int paramInt1, int paramInt2, Bundle paramBundle)
  {
    ...
    for (Object localObject = "null";; localObject = Integer.valueOf(paramBundle.getInt("code")))
    {
      ...
      this.jdField_a_of_type_Bifg.a(paramString, paramBundle);
      return;
    }
  }
  ...
  public void onGetTicketNoPasswd(String paramString, byte[] paramArrayOfByte, int paramInt, Bundle paramBundle)
  {
    ...
    localbiej.jdField_b_of_type_JavaLangString = new String(paramArrayOfByte);
    localbiej.jdField_a_of_type_JavaLangString = Long.toString(this.jdField_a_of_type_ComTencentQqconnectWtloginOpenSDKAppInterface.a(localWtloginManager, paramString));
    ...
    this.jdField_a_of_type_Bifg.a(localbiej);
  }
}
