  ...
  implements Handler.Callback
{
  ...
  private final biff jdField_a_of_type_Biff;
  private final ReleaseLooperHandler jdField_a_of_type_ComTencentWeiyunTransmissionUtilsHandlerReleaseLooperHandler;
  
  public bife(biff parambiff, ReleaseLooperHandler paramReleaseLooperHandler)
  {
  ...
  private biem a(Cursor paramCursor)
  {
    Object localObject = biei.a(paramCursor.getInt(2), paramCursor.getString(6), paramCursor.getString(3), paramCursor.getString(7), paramCursor.getLong(8), paramCursor.getInt(9), paramCursor.getString(4), paramCursor.getString(5), null);
    ((biei)localObject).f = paramCursor.getString(11);
    bien localbien = new bien();
    localbien.jdField_a_of_type_Int = paramCursor.getInt(12);
    localbien.jdField_b_of_type_Int = paramCursor.getInt(13);
    localbien.jdField_a_of_type_JavaLangString = paramCursor.getString(14);
    localbien.jdField_a_of_type_Long = paramCursor.getLong(15);
    localbien.jdField_b_of_type_Long = paramCursor.getLong(16);
    localbien.jdField_b_of_type_JavaLangString = paramCursor.getString(17);
    localbien.c = ((biei)localObject).jdField_a_of_type_JavaLangString;
    localbien.d = paramCursor.getString(10);
    localObject = biem.a(paramCursor.getString(1), (biei)localObject, paramCursor.getString(18), localbien);
    ((biem)localObject).a(paramCursor.getLong(0));
    return localObject;
  }
  
  private void a(ContentValues paramContentValues, bien parambien, boolean paramBoolean)
  {
    boolean bool = false;
    ...
    {
      i = 0;
      paramContentValues = this.jdField_a_of_type_Biff;
      if (i > 0) {
        bool = true;
      }
      paramContentValues.a(l, bool, parambien, paramBoolean);
      return;
    }
    if (l >= 0L) {}
  ...
  /* Error */
  private void b(int paramInt, biem parambiem)
  {
    // Byte code:
    //   0: aload_2
    //   1: ifnonnull +4 -> 5
    //   4: return
    //   5: aload_2
    //   6: invokevirtual 184	biem:a	()Lbiei;
    //   9: astore 12
    //   11: aload_2
    //   12: invokevirtual 187	biem:a	()Lbien;
    //   15: astore 13
    ...
    //   28: ifnull -24 -> 4
    //   31: aload_2
    //   32: invokevirtual 190	biem:a	()Ljava/lang/String;
    //   35: astore 8
    //   37: aload 12
    //   39: getfield 114	biei:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   42: astore 10
    //   44: aload_2
    //   45: invokevirtual 192	biem:b	()Ljava/lang/String;
    //   48: astore 14
    ...
    //   92: aload 11
    //   94: ldc 162
    //   96: getstatic 23	bife:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   99: aload 15
    ...
    //   187: astore 8
    //   189: aload 12
    //   191: getfield 222	biei:c	Ljava/lang/String;
    //   194: astore 10
    ...
    //   290: ldc 37
    //   292: aload 12
    //   294: getfield 243	biei:jdField_a_of_type_Long	J
    ...
    //   305: ldc 39
    //   307: aload 12
    //   309: getfield 250	biei:jdField_b_of_type_Int	I
    ...
    //   320: ldc 55
    //   322: aload_2
    //   323: invokevirtual 192	biem:b	()Ljava/lang/String;
    ...
    //   379: aload 13
    //   381: getfield 113	bien:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   384: invokestatic 270	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   387: ifne +15 -> 402
    //   390: aload 14
    //   392: ldc 21
    //   394: aload 13
    //   396: getfield 113	bien:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   482: aload_2
    //   483: lload 6
    //   485: invokevirtual 128	biem:a	(J)V
    //   488: aload_0
    //   489: getfield 64	bife:jdField_a_of_type_Biff	Lbiff;
    //   492: iload_1
    //   493: aload_2
    //   494: aload 8
    ...
    //   548: ldc 45
    //   550: aload 13
    //   552: getfield 102	bien:jdField_a_of_type_Int	I
    ...
    //   563: ldc 47
    //   565: aload 13
    //   567: getfield 104	bien:jdField_b_of_type_Int	I
    ...
    //   578: ldc 49
    //   580: aload 13
    //   582: getfield 106	bien:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   585: invokevirtual 227	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   588: aload 14
    //   590: ldc 51
    //   592: aload 13
    //   594: getfield 109	bien:jdField_a_of_type_Long	J
    ...
    //   605: ldc 53
    //   607: aload 13
    //   609: getfield 111	bien:jdField_b_of_type_Long	J
    ...
    //   9	351	12	localbiei	biei
    //   15	593	13	localbien	bien
  ...
  private void b(long paramLong, boolean paramBoolean)
  {
    ...
    //   34: astore 6
    //   36: aload_0
    //   37: getfield 64	bife:jdField_a_of_type_Biff	Lbiff;
    //   40: astore 7
    //   42: iload 5
    //   44: istore_3
    //   45: iload 4
    ...
    //   70: aload 10
    //   72: ldc 162
    //   74: getstatic 57	bife:b	[Ljava/lang/String;
    //   77: ldc 164
    //   79: iconst_1
    ...
    //   113: aload_0
    //   114: aload 7
    //   116: invokespecial 296	bife:a	(Landroid/database/Cursor;)Lbiem;
    //   119: astore 6
    //   121: aload 7
  ...
  private void b(String paramString)
  {
    ...
    //   15: ifnonnull +15 -> 30
    //   18: aload_0
    //   19: getfield 64	bife:jdField_a_of_type_Biff	Lbiff;
    //   22: aload_1
    //   23: aload_2
    ...
    //   77: aload 5
    //   79: ldc 162
    //   81: getstatic 57	bife:b	[Ljava/lang/String;
    //   84: aload 4
    ...
    //   143: aload_0
    //   144: aload_2
    //   145: invokespecial 296	bife:a	(Landroid/database/Cursor;)Lbiem;
  ...
  public void a(int paramInt, biem parambiem)
  {
    if (parambiem == null) {
      return;
    }
    this.jdField_a_of_type_ComTencentWeiyunTransmissionUtilsHandlerReleaseLooperHandler.sendMessage(Message.obtain(null, 1, paramInt, 0, parambiem));
  }
  ...
  public void a(biem parambiem, boolean paramBoolean)
  {
    if (parambiem == null) {
      return;
    }
    bien localbien = parambiem.b();
    ContentValues localContentValues = new ContentValues();
    localContentValues.put("_id", Long.valueOf(parambiem.a()));
    localContentValues.put("state", Integer.valueOf(localbien.jdField_a_of_type_Int));
    localContentValues.put("error_code", Integer.valueOf(localbien.jdField_b_of_type_Int));
    localContentValues.put("error_msg", localbien.jdField_a_of_type_JavaLangString);
    localContentValues.put("total_size", Long.valueOf(localbien.jdField_a_of_type_Long));
    localContentValues.put("cur_size", Long.valueOf(localbien.jdField_b_of_type_Long));
    if (!TextUtils.isEmpty(localbien.jdField_b_of_type_JavaLangString)) {
      localContentValues.put("local_path", localbien.jdField_b_of_type_JavaLangString);
    }
    if (!TextUtils.isEmpty(parambiem.c())) {
      localContentValues.put("file_version", parambiem.c());
    }
    parambiem = this.jdField_a_of_type_ComTencentWeiyunTransmissionUtilsHandlerReleaseLooperHandler;
    if (paramBoolean) {}
    for (int i = 1;; i = 0)
    {
      parambiem.sendMessage(Message.obtain(null, 2, i, 0, new Object[] { localContentValues, localbien }));
      return;
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    default: 
      return false;
    case 1: 
      b(paramMessage.arg1, (biem)paramMessage.obj);
      return true;
    case 2: 
      ContentValues localContentValues = (ContentValues)((Object[])(Object[])paramMessage.obj)[0];
      bien localbien = (bien)((Object[])(Object[])paramMessage.obj)[1];
      if (paramMessage.arg1 == 1) {
        bool1 = true;
      }
      a(localContentValues, localbien, bool1);
      return true;
    case 3: 
