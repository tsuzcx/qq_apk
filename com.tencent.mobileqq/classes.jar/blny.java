...
{
  blny(blnx paramblnx, Context paramContext) {}
  
  public void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    this.jdField_a_of_type_Blnx.b(this.jdField_a_of_type_Blnx.a.a);
    this.jdField_a_of_type_Blnx.a = null;
    if (paramInt == 1)
    {
      this.jdField_a_of_type_Blnx.c = true;
