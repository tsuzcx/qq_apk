  ...
  extends ViewBase
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new tzq(this, Looper.getMainLooper());
  ...
  public tzp(VafContext paramVafContext)
  {
  ...
  {
    this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)paramContext.getSystemService("layout_inflater")).inflate(2131560046, null);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369174));
  }
  ...
  private void b()
  {
    ...
    {
      return;
      localBitmap = bfuj.a(String.valueOf(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdAid));
  ...
  public void a(NativeReadInjoyImageView paramNativeReadInjoyImageView, String paramString, Drawable paramDrawable)
  {
    ...
    if (bfuj.a(paramNativeReadInjoyImageView) == null)
    {
