...
public class bllw<K extends bllc>
  extends bllu<K>
  implements bllv
{
  protected blky a;
  
  protected bllw(K paramK)
  {
    super(paramK);
    this.jdField_a_of_type_Bllv = this;
  }
  
  public View a(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    Resources localResources = ((bllc)this.jdField_a_of_type_MqqUtilWeakReference.get()).getResources();
    blky localblky = b();
    View localView;
    ...
    if (paramView == null)
    {
      localView = ((bllc)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getLayoutInflater().inflate(2131560947, null);
      localTextView = (TextView)localView;
      localQQAlbumInfo = localblky.a(paramInt);
      ...
      if (localblky.getItemViewType(paramInt) != 1) {
        break label398;
      }
    ...
    for (;;)
    {
      ...
      {
        localObject = URLDrawableHelper.getDrawable(paramView, blky.jdField_a_of_type_AndroidGraphicsDrawableColorDrawable, blky.jdField_a_of_type_AndroidGraphicsDrawableColorDrawable);
        ((URLDrawable)localObject).setTag(localQQAlbumInfo.mCoverInfo);
        ((URLDrawable)localObject).setBounds(0, 0, localblky.jdField_a_of_type_Int, localblky.b);
      }
      ...
      {
        paramView = localblky.jdField_a_of_type_AndroidGraphicsDrawableDrawable$ConstantState.newDrawable(localResources);
  ...
  protected blky a()
  {
    return new blky((bllc)this.jdField_a_of_type_MqqUtilWeakReference.get());
  }
  ...
  {
    if ((this.jdField_a_of_type_MqqUtilWeakReference.get() == null) || (((bllc)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity() == null)) {
      return null;
    }
    Object localObject;
        ...
        for (i = j;; i = 0)
        {
          ...
          if (paramInt == -1)
          {
            ...
            if ((this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.filter != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.filter.showVideo()))
            {
              ...
              paramList1 = ((bllc)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getContentResolver().query(paramList1, new String[] { "_id" }, "_size>0 ", null, null);
              i = 0;
              if (paramList1 != null)
              {
              ...
              if (bool)
              {
                ...
                paramList1 = b().a(((bllc)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity());
              }
            }
          }
          for (;;)
          {
            ...
            label559:
            bfwl.a("PEAK", "compact.queryRecentBucket");
            return localObject;
  ...
  public void a(int paramInt)
  {
    ...
    {
      bfwl.a();
      localList1 = localblky.a(((bllc)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), paramInt);
    ...
    for (;;)
    {
      ...
      {
        bfwl.a();
        localList2 = localblky.a(((bllc)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), paramInt, localMediaFileFilter);
      ...
      {
        bfwl.a();
        localList1 = this.jdField_a_of_type_Bllv.a(localList1, localList2, paramInt);
        if (localList1 != null) {
        ...
        {
          return;
          bfwl.a("PEAK", "compact(" + (localList1.size() - 1) + "," + k + ")");
          localblky.b(localList1);
        } while (paramInt == -1);
        if (i != 0)
        {
          ThreadManager.getFileThreadHandler().post(new AEAlbumListLogicBase.2(this, localblky));
          return;
        }
        ThreadManager.getFileThreadHandler().post(new AEAlbumListLogicBase.3(this, localblky, localMediaFileFilter));
        return;
        break;
        localList2 = null;
      }
  ...
  public void a(Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Blky = a();
      ((bllc)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Blky = this.jdField_a_of_type_Blky;
      ...
      break;
      label260:
      bmbx.b("AEAlbumListLogicBase", "passed in albumId=" + this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.albumId + ", albumName=" + this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.albumName);
    }
  }
  ...
  public boolean a(QQAlbumInfo paramQQAlbumInfo, int paramInt, Intent paramIntent)
  {
    ...
    XListView localXListView = ((bllc)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_ComTencentWidgetXListView;
  ...
  protected blky b()
  {
    return this.jdField_a_of_type_Blky;
  }
