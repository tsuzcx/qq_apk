  ...
  extends aiir
{
  ...
  public aijl(QQAppInterface paramQQAppInterface, CustomEmotionData paramCustomEmotionData)
  {
    ...
    if (localarro != null) {
      this.jdField_a_of_type_JavaLangString = localarro.a(paramCustomEmotionData);
    }
    if (paramCustomEmotionData.isMarkFace) {
      this.jdField_a_of_type_ComTencentMobileqqDataEmoticon = ((awmr)paramQQAppInterface.getManager(14)).a(paramCustomEmotionData.emoPath, paramCustomEmotionData.eId);
    }
  }
  ...
  private void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, String paramString)
  {
    ...
    StructMsgForImageShare.sendAndUploadImageShare(paramQQAppInterface, (StructMsgForImageShare)bcwd.a(localBundle), paramSessionInfo.jdField_a_of_type_JavaLangString, paramSessionInfo.jdField_a_of_type_Int, paramSessionInfo.b, 0);
    paramSessionInfo = ahte.a(paramString);
    if ((paramSessionInfo != null) && (paramSessionInfo.length >= 8)) {
      blaq.a(paramQQAppInterface, "100007", "2", "40051", paramSessionInfo[0], new String[] { paramSessionInfo[2], paramSessionInfo[4], ahte.a(paramString) });
    }
  }
  ...
  {
    ((arrp)paramQQAppInterface.getManager(103)).b(this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData.isMarkFace) && (this.jdField_a_of_type_ComTencentMobileqqDataEmoticon != null))
    {
      adrm.a(paramQQAppInterface, paramContext, paramSessionInfo, this.jdField_a_of_type_ComTencentMobileqqDataEmoticon);
      if (this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.isNewSoundEmoticon()) {
        awmr.a(paramQQAppInterface, "0X800A932", paramSessionInfo.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId);
      }
      ((arrp)paramQQAppInterface.getManager(103)).a(this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData);
      return;
    }
    ...
    if (!this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData.isMarkFace) {}
    for (String str = asaz.a(((arss)paramQQAppInterface.getManager(141)).a(), this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData.md5);; str = null)
    {
      if (ahte.a(str))
      {
      ...
      adrm.a(paramQQAppInterface, paramContext, paramSessionInfo, str, true, bool, this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData.eId, null);
      break;
    }
  }
