...
public class amdz
  extends amnl
{
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new amea(this);
  ...
  public amdz(PhoneContactTabView paramPhoneContactTabView, Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, boolean paramBoolean)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    int i = Arrays.binarySearch(this.jdField_a_of_type_ArrayOfInt, paramInt);
    if (paramView == null) {
      paramView = ameg.a(paramViewGroup, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberPhoneContactTabView.jdField_a_of_type_AndroidViewLayoutInflater, 2131558960);
    }
    for (;;)
    {
      ...
      if (i < 0)
      {
        ...
        ameg.a(this, localameg, (PhoneContact)localObject);
        localameg.jdField_b_of_type_AndroidWidgetTextView.setText(((PhoneContact)localObject).name);
        localameg.d.setText(((PhoneContact)localObject).mobileNo);
        localameg.d.setVisibility(0);
        if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberPhoneContactTabView.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.b(localameg.jdField_a_of_type_JavaLangString))
        {
          ...
          if ((AppSetting.c) && (localameg.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
          {
            ...
            paramView.setContentDescription(((PhoneContact)localObject).name + anzj.a(2131706872));
          }
          label226:
          localameg.jdField_a_of_type_ComTencentMobileqqDataPhoneContact = ((PhoneContact)localObject);
          localameg.jdField_b_of_type_AndroidViewView.setVisibility(8);
          localameg.jdField_b_of_type_AndroidViewView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
      ...
      for (;;)
      {
        ...
        break;
        label291:
        paramView.setContentDescription(((PhoneContact)localObject).name + anzj.a(2131706870));
        break label226;
