...
public class amdz
  extends alsi
{
  private amdz(RegisterProxy paramRegisterProxy) {}
  ...
  private void h()
  {
    ...
    if ((RegisterProxy.a(this.a) == 2) && (RegisterProxy.c(this.a) == 2))
    {
      ...
      if ((BaseApplicationImpl.sLaunchTime < 0L) && (BaseApplicationImpl.sShowTime < 0L))
      {
        ...
        azmz.a(this.a.jdField_a_of_type_ComTencentMobileqqAppAutomatorAutomator.app.getApp()).a(null, "prxyRegisterB", true, l2, 0L, null, null);
      }
    ...
    for (;;)
    {
      ...
      azmz.a(this.a.jdField_a_of_type_ComTencentMobileqqAppAutomatorAutomator.app.getApp()).a(null, "prxyRegisterT", true, l1 - l2, 0L, (HashMap)localObject2, null);
      if (this.a.jdField_a_of_type_ComTencentMobileqqAppAutomatorAutomator.jdField_a_of_type_Long > 0L)
      {
        ...
        if (bdee.g(this.a.jdField_a_of_type_ComTencentMobileqqAppAutomatorAutomator.app.getApp()))
        {
          ...
          azmz.a(this.a.jdField_a_of_type_ComTencentMobileqqAppAutomatorAutomator.app.getApp()).a(null, "prxyRegisterM", RegisterProxy.a(this.a), l1, 0L, (HashMap)localObject1, null);
          if (QLog.isColorLevel()) {
