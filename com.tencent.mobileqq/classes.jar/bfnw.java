...
public class bfnw
  implements bked, bket
{
  public static String a;
  protected final int a;
  protected long a;
  private Handler jdField_a_of_type_AndroidOsHandler;
  private bfil jdField_a_of_type_Bfil;
  ...
  public bfnw(boolean paramBoolean, bfil parambfil)
  {
    this.jdField_a_of_type_Int = 1000;
    this.jdField_a_of_type_Boolean = paramBoolean;
    this.jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
    this.jdField_a_of_type_Bfil = parambfil;
  }
  
  private void a()
  {
    if (this.jdField_a_of_type_Bfil == null) {}
    ...
    while (((Iterator)localObject2).hasNext()) {
      ((JSONArray)localObject1).put(bfob.a((WadlResult)((Iterator)localObject2).next()));
    }
    localObject1 = ((JSONArray)localObject1).toString();
    localObject2 = this.jdField_a_of_type_Bfil.getJsCallbackMethod();
  ...
  private void a(int paramInt, WadlParams paramWadlParams)
  {
    ...
    while (i != 0)
    {
      a(bfob.a(paramInt));
      return;
      bkel.a().c(0, paramWadlParams.jdField_a_of_type_JavaLangString);
      i = j;
      continue;
      bkel.a().a(0, paramWadlParams.jdField_a_of_type_JavaLangString);
  ...
  private void b(String paramString)
  {
    ...
    {
      return;
      bfnq.c(jdField_a_of_type_JavaLangString, "doJsCallBack loadJs=" + paramString);
      try
      {
        WebView localWebView = this.jdField_a_of_type_Bfil.getWebview();
      ...
      {
        bfnq.a(jdField_a_of_type_JavaLangString, "doJsCallback exception", paramString);
      }
    }
  }
  ...
  public void a(WadlResult paramWadlResult)
  {
    ...
    {
      paramWadlResult = bfob.a(paramWadlResult).toString();
      str = this.jdField_a_of_type_Bfil.getJsCallbackMethod();
  ...
  public void a(String paramString)
  {
    ...
    {
      bfnq.a(jdField_a_of_type_JavaLangString, "showToast>>>", paramString);
    }
  }
  ...
  {
    bfnq.c(jdField_a_of_type_JavaLangString, "onCmdRsp cmd=" + paramString + ",isSucc");
  ...
  {
    bfnq.c(jdField_a_of_type_JavaLangString, "onQueryCallback params:" + paramArrayList);
    ...
    if (paramArrayList != null) {
      try
      {
        ...
        {
          localJSONArray.put(bfob.a((WadlResult)paramArrayList.next()));
          continue;
          return;
        }
      }
      ...
      {
        bfnq.a(jdField_a_of_type_JavaLangString, "onQueryCallback exception:" + paramArrayList.getMessage());
      }
    }
  ...
  {
    bfnq.c(jdField_a_of_type_JavaLangString, "onQueryCallbackVia params:" + paramArrayList);
    JSONArray localJSONArray;
    if (paramArrayList != null) {
      try
      {
      ...
      {
        bfnq.a(jdField_a_of_type_JavaLangString, "onQueryCallbackVia exception:" + paramArrayList.getMessage());
      }
    }
  ...
  public void onWadlTaskStatusChanged(WadlResult paramWadlResult)
  {
    ...
    {
      bfnq.a(jdField_a_of_type_JavaLangString, "onWadlTaskStatusChanged error wadlResult is null");
      return;
    }
    WadlParams localWadlParams = paramWadlResult.a;
    String str = localWadlParams.jdField_a_of_type_JavaLangString;
    int i = bfob.a(paramWadlResult.b);
    bfnv.b(localWadlParams.jdField_a_of_type_JavaLangString);
    bfnq.c(jdField_a_of_type_JavaLangString, "onWadlTaskStatusChanged:" + paramWadlResult + ",localStatus:" + i);
    switch (i)
    {
    default: 
      bfnq.a(jdField_a_of_type_JavaLangString, "download status not response!");
      return;
    case 3: 
    case 4: 
    case 6: 
    ...
    case -2: 
      ...
      bfnq.a(jdField_a_of_type_JavaLangString, "onWadlTaskStatusChanged  error,wadlErrCode=" + i);
      c(str);
      a(i, localWadlParams);
      a(paramWadlResult);
      return;
