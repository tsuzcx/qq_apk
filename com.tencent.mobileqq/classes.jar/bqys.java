...
class bqys
{
  ...
  private final Class<? extends bqgi> jdField_a_of_type_JavaLangClass;
  private Set<Integer> jdField_a_of_type_JavaUtilSet = new HashSet();
  private final int b;
  private final int c;
  
  private bqys(int paramInt1, int paramInt2, int paramInt3, Class<? extends bqgi> paramClass)
  {
  ...
  static bqys a(int paramInt1, int paramInt2, int paramInt3, Class<? extends bqgi> paramClass)
  {
    return new bqys(paramInt1, paramInt2, paramInt3, paramClass);
  }
  
  Class<? extends bqgi> a()
  {
