...
public class bczo
{
  ...
  public bczo(bcvt parambcvt, Context paramContext, int paramInt)
  {
  ...
  private TextView a(String paramString, View paramView, boolean paramBoolean)
  {
    ...
    if (paramView == null)
    {
      ...
      int i = afur.a(12.5F, localResources);
  ...
  public static boolean a(bcvt parambcvt, int paramInt)
  {
    ...
    label14:
    String str;
    if (parambcvt.hasNext())
    {
      str = ((bcvs)parambcvt.next()).a;
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      localObject1 = (FrameLayout)localLinearLayout.findViewById(2131378035);
      if (localObject1 == null) {
        break label381;
      }
      localObject2 = this.jdField_a_of_type_Bcvt.a.iterator();
      paramView = null;
      if (((Iterator)localObject2).hasNext())
      {
        bcvs localbcvs = (bcvs)((Iterator)localObject2).next();
        String str = localbcvs.a;
        if ("title".equals(str)) {
          paramView = ((StructMsgItemTitle)localbcvs).b();
        }
        for (;;)
        {
          break;
          if ("picture".equals(str)) {
            this.jdField_a_of_type_AndroidViewView = a(localbcvs, (View)localObject1, paramBundle);
          }
        }
      }
      ...
      paramBundle = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378048);
    ...
    for (;;)
    {
      if (localLinearLayout == null)
      {
        ...
        localLinearLayout.setId(2131378049);
      }
      for (;;)
      {
        localObject1 = this.jdField_a_of_type_Bcvt.a.iterator();
        label331:
        if (((Iterator)localObject1).hasNext())
        {
          paramContext = (bcvs)((Iterator)localObject1).next();
        ...
        for (;;)
        {
          ...
          if ((!TextUtils.isEmpty(paramView)) && (paramView.trim().length() > 0))
          {
            ...
            this.jdField_a_of_type_AndroidWidgetTextView.setId(2131378051);
  ...
  public View a(bcvs parambcvs, View paramView, Bundle paramBundle)
  {
    ...
    {
      PAImageView localPAImageView = (PAImageView)parambcvs;
      localPAImageView.setUseRadiusRound(true, localResources.getDimensionPixelSize(2131296391));
      localPAImageView.setTag(2131373036, Integer.valueOf(1));
    }
