  ...
  extends CameraCaptureSession.CaptureCallback
{
  ...
  public bczo(Camera2Control paramCamera2Control)
  {
      ...
      do
      {
        ...
        do
        {
          do
          {
            ...
            bczm.a(1, "[Camera2]process afState:" + localInteger);
        ...
        bczm.a(1, "[Camera2]process aeState:" + paramCaptureResult);
      } while (this.jdField_a_of_type_ComTencentMobileqqShortvideoCamera2Camera2Control == null);
      this.jdField_a_of_type_ComTencentMobileqqShortvideoCamera2Camera2Control.d();
      return;
      bczm.a(1, "[Camera2]process preCapture aeState:" + paramCaptureResult);
    } while (this.jdField_a_of_type_ComTencentMobileqqShortvideoCamera2Camera2Control == null);
    this.jdField_a_of_type_ComTencentMobileqqShortvideoCamera2Camera2Control.d();
  }
