...
{
  public ttl(TroopAssistantActivity paramTroopAssistantActivity, int paramInt, String paramString, ActionSheet paramActionSheet) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    if (!NetworkUtil.d(BaseApplication.getContext()))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityTroopAssistantActivity.a.a(2, 2131434794, 1500);
    }
    try
    {
