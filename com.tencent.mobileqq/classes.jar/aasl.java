...
public class aasl
  extends aata
  implements aime, Handler.Callback
{
  ...
  private void a(LinkedHashMap<String, List<Object>> paramLinkedHashMap)
  {
    ...
    while (paramLinkedHashMap.hasNext()) {
      Collections.sort((List)paramLinkedHashMap.next(), new aasm(this));
    }
  }
    ...
    if (paramJSONObject != null)
    {
      ...
      if (ayfv.a(paramJSONObject))
      {
        ...
        while (paramJSONObject.hasNext())
        {
          ...
          String str = apvu.a(localTencentDocData.aioTime);
  ...
  private void i()
  {
    ...
    this.jdField_b_of_type_AndroidViewView$OnClickListener = new aasn(this);
  }
  ...
  private void j()
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new aaso(this);
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Aouj = new aasr(this);
  ...
  public void a(Intent paramIntent, QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    this.jdField_a_of_type_Aimc = new aimc(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaUtilList, this.jdField_b_of_type_AndroidViewView$OnClickListener, this.jdField_a_of_type_AndroidViewView$OnClickListener, this);
    ...
    paramQQAppInterface = paramIntent.findViewById(2131372796);
  ...
  public void a(TencentDocData paramTencentDocData)
  {
    ...
    for (;;)
    {
      ...
      continue;
      ayfv.a(paramTencentDocData.docUrl, this.jdField_a_of_type_AndroidContentContext);
      apuc.a("0X8009A9F");
    }
  }
  ...
  public void a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    if (a()) {
      if (this.jdField_a_of_type_ComTencentMobileqqActivityChatHistoryFileActivity.a(paramFileManagerEntity))
      {
        ...
        {
          aptv.a(apue.d(paramFileManagerEntity.fileName) + ajyc.a(2131701590));
          this.jdField_a_of_type_ComTencentMobileqqActivityChatHistoryFileActivity.b(paramFileManagerEntity);
        }
        this.jdField_a_of_type_Aimc.notifyDataSetChanged();
      }
    ...
    apuc.a("0X8004AE4");
    localObject = new apoe(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, paramFileManagerEntity, 10001);
  ...
  public void d()
  {
    ...
    this.jdField_a_of_type_Aimc.a(true);
    this.jdField_a_of_type_Aimc.notifyDataSetChanged();
  }
  ...
  public void e()
  {
    ...
    this.jdField_a_of_type_Aimc.a(false);
    this.jdField_a_of_type_Aimc.notifyDataSetChanged();
  }
