...
{
  public static final String a = aasl.class.getSimpleName();
  private static final String b = aasl.class.getName();
  ...
  public boolean handleEvent(String paramString, long paramLong, Map<String, Object> paramMap)
  {
    if ((paramLong == 32L) && (a()))
    {
      ...
      if ((paramString != null) && ((paramString instanceof bikm))) {
        ((bikm)paramString).hideQQBrowserButton();
      }
