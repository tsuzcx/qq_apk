  ...
  public TofuItem a(@NotNull TofuItem paramTofuItem, long paramLong, int paramInt)
  {
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      if (QLog.isColorLevel()) {
        QLog.i("Tofu_TofuDataBaseHandler", 2, String.format("makeReqItemIfPull [%s] [canPull,tsCheck]=[%b,%b] [curTs,lastTs,interval]=[%d,%d,%d]", new Object[] { bejj.a(paramTofuItem.busId), Boolean.valueOf(bool2), Boolean.valueOf(bool1), Long.valueOf(paramLong), Long.valueOf(paramTofuItem.lastPullTsLocal), Long.valueOf(paramTofuItem.pullInterval) }));
      }
      if ((!bool2) || (!bool1)) {
        break;
      }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (!TextUtils.isEmpty(paramBeancurdCubeInfoResult))
        {
          ...
          bejn.a(this.a, localBeancurdMsg, a(), b());
        }
        QLog.d("Tofu_TofuDataBaseHandler", 1, String.format("onGetRsp [%s] bNew=%b ts=%d item=%s", new Object[] { bejj.a(paramTofuItem.busId), Boolean.valueOf(bool), Long.valueOf(paramLong), paramTofuItem }));
        return;
        bool = false;
        continue;
