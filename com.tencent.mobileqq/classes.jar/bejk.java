  ...
  implements Handler.Callback, Manager
{
  ...
  awqn<bejh, QQAppInterface> jdField_a_of_type_Awqn;
  bejn jdField_a_of_type_Bejn = new bejl(this);
  ...
  public bejk(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper(), this);
    this.jdField_a_of_type_Awqn = new bejm(this);
    this.jdField_a_of_type_JavaUtilSet = Collections.synchronizedSet(new HashSet());
    this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager = paramQQAppInterface.getEntityManagerFactory().createEntityManager();
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Bejn, true);
  }
  ...
  private void a(boolean paramBoolean, String paramString, List<oidb_0xe61.BeancurdCubeInfoResult> paramList)
  {
    ...
    try
    {
      ...
      a(paramList, new bejd(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localafqy, this.jdField_a_of_type_Awqn));
  ...
  protected List<TofuItem> a(String paramString, int paramInt)
  {
    ...
    ArrayList localArrayList = new ArrayList(bejf.a.length);
    long l = System.currentTimeMillis() / 1000L;
    int i = 0;
    while (i < bejf.a.length)
    {
      beje localbeje = ((bejh)this.jdField_a_of_type_Awqn.get(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)).a(i);
      ...
      localTofuItem1 = localbeje.a(localTofuItem1, l, paramInt);
  ...
  protected void a(String paramString, List<TofuItem> paramList, boolean paramBoolean)
  {
    ...
    //   3: lstore 4
    //   5: aload_0
    //   6: getfield 83	bejk:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    ...
    //   49: aload_0
    //   50: aload_0
    //   51: getfield 83	bejk:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   54: aload 8
    //   56: invokespecial 351	bejk:a	(Lcom/tencent/mobileqq/persistence/EntityManager;Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   59: pop
    //   60: goto -33 -> 27
    //   63: astore 7
    //   65: ldc 138
    ...
    //   75: ldc_w 353
    //   78: invokevirtual 236	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   81: aload 7
    //   83: invokevirtual 289	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   86: invokevirtual 236	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   89: invokevirtual 243	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   92: aload 7
    //   94: invokestatic 292	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   97: aload 6
    //   99: invokevirtual 356	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   102: iload_3
    //   103: ifeq +25 -> 128
    //   106: aload_0
    //   107: getfield 31	bejk:jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache	Lcom/tencent/commonsdk/cache/QQLruCache;
    //   110: astore 6
    //   112: aload 6
    //   114: monitorenter
    //   115: aload_0
    //   116: getfield 31	bejk:jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache	Lcom/tencent/commonsdk/cache/QQLruCache;
    //   119: aload_1
    //   120: aload_2
    //   121: invokevirtual 277	com/tencent/commonsdk/cache/QQLruCache:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   124: pop
    //   125: aload 6
    //   127: monitorexit
    ...
    //   160: dup
    //   161: iconst_2
    //   162: invokestatic 257	java/lang/System:currentTimeMillis	()J
    //   165: lload 4
    //   167: lsub
    //   168: invokestatic 284	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   171: aastore
    //   172: dup
    //   173: iconst_3
    //   174: iload_3
    ...
    //   185: return
    //   186: aload 6
    //   188: invokevirtual 361	com/tencent/mobileqq/persistence/EntityTransaction:commit	()V
    //   191: aload 6
    //   193: invokevirtual 356	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   196: goto -94 -> 102
    //   199: astore_1
    //   200: aload 6
    //   202: invokevirtual 356	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   205: aload_1
    //   206: athrow
    //   207: astore_1
    //   208: aload 6
  ...
  protected boolean a(String paramString, List<TofuItem> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      localObject = ((bejh)this.jdField_a_of_type_Awqn.get(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)).a(((TofuItem)localObject).busId).a((TofuItem)localObject);
      if (localObject != null) {
        localArrayList.add(localObject);
      }
    }
    ((beji)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.TOFUMSG_HANDLER)).a(paramString, localArrayList);
    return true;
  }
  ...
  protected boolean a(String paramString, List<oidb_0xe61.BeancurdCubeInfoResult> paramList, List<TofuItem> paramList1)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      int i = bejf.b((int)((oidb_0xe61.BeancurdCubeInfo)localBeancurdCubeInfoResult.beancurdCubeInfo.get()).uint64_busi_id.get());
      if (i != -1)
      {
        ...
        bool = true;
        label145:
        ((bejh)this.jdField_a_of_type_Awqn.get(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)).a(i).a(paramList, localBeancurdCubeInfoResult, l);
      }
    }
    label180:
    label183:
  ...
  public void onDestroy()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Bejn);
    this.jdField_a_of_type_AndroidOsHandler.removeCallbacksAndMessages(null);
    ((bejh)this.jdField_a_of_type_Awqn.get(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)).a();
  }
}
