...
{
  public ujh(VideoActionSheet paramVideoActionSheet, int[] paramArrayOfInt, int paramInt, QQAppInterface paramQQAppInterface, Context paramContext, PstnSessionInfo paramPstnSessionInfo, SessionInfo paramSessionInfo, BaseChatPie paramBaseChatPie, String paramString) {}
      ...
      do
      {
        do
        {
          ...
          if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1001) || (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 10002))
          {
            ...
            {
              this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.d(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a().getString(2131437393));
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1001) || (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 10002))
        {
          ...
          if (!LBSHandler.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))
          {
            this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.d(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a().getString(2131437394));
