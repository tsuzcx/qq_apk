...
public class muc
{
  ...
  {
    int i = actj.a(paramFloat, paramContext.getResources());
      ...
      do
      {
        ...
        do
        {
          do
          {
            ...
            {
              return localObject2;
              Object localObject3 = ((ajxl)paramQQAppInterface.getManager(51)).b(paramString);
  ...
  public static String a(String paramString)
  {
    ...
    for (;;)
    {
      if ((k > 0) || (j > 0) || (i > 0))
      {
        paramString = str;
        if (k > 0) {
          paramString = str + k + ajya.a(2131715874);
        }
        str = paramString;
        if (j > 0) {
          str = paramString + j + ajya.a(2131715873);
        }
        paramString = str;
        if (i > 0) {
          paramString = str + i + ajya.a(2131715872);
        }
        return paramString;
        if (arrayOfString.length == 2)
        {
  ...
  public static void a()
  {
    ...
    bbkb.a(BaseApplicationImpl.getApplication().getSharedPreferences("UITools", 4).edit().putBoolean("has_show_svip_dialog", false));
  }
  ...
  public static void a(int paramInt)
  {
    ...
    for (;;)
    {
      bbkb.a(BaseApplicationImpl.getApplication().getSharedPreferences("UITools", 4).edit().putInt(str, 0));
      return;
  ...
  public static void a(Activity paramActivity)
  {
    ...
    Intent localIntent;
    if (lze.a(paramActivity, "miui.intent.action.APP_PERM_EDITOR"))
    {
    ...
    for (;;)
    {
      ...
      if (!bool1)
      {
        i = j;
        bool2 = bool1;
        if (lze.a(paramActivity, "com.meizu.safe.security.SHOW_APPSEC"))
        {
      ...
      if (!bool2)
      {
        j = i;
        bool1 = bool2;
        if (lze.a(paramActivity, "huawei.intent.action.NOTIFICATIONMANAGER"))
        {
          i = 3;
      ...
      if ((!bool2) && (lze.a(paramActivity, "android.settings.action.MANAGE_OVERLAY_PERMISSION")))
      {
        i = 5;
  ...
  public static void a(Context paramContext)
  {
    ...
    {
      paramContext = bbkb.a(paramContext);
  ...
  public static void a(View paramView, String paramString, int paramInt)
  {
    if (jdField_a_of_type_Boolean)
    {
      ...
      if (paramInt == 2) {
        str = paramString.replace(paramView.getResources().getString(2131695680), ajya.a(2131715875));
      }
      if (QLog.isColorLevel()) {
  ...
  {
    return (lze.a(paramActivity, "miui.intent.action.APP_PERM_EDITOR")) || (lze.a(paramActivity, "com.meizu.safe.security.SHOW_APPSEC")) || (lze.a(paramActivity, "huawei.intent.action.NOTIFICATIONMANAGER")) || (lze.a(paramActivity, "android.settings.action.MANAGE_OVERLAY_PERMISSION"));
  }
