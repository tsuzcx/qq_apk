...
public class bczx
  implements bdip
{
  public bczx(ChallengeBragBase paramChallengeBragBase) {}
  ...
  protected void a(Intent paramIntent)
  {
    ...
    if (i != 0)
    {
      ...
      bdht.e("qqBaseActivity", "onGetNickNameError{KEY_ERROR_CODE:" + i + "; KEY_ERROR_MSG:" + paramIntent.getStringExtra("key_error_msg") + "}");
    }
  ...
  {
    this.a.d();
    bdht.c("qqBaseActivity", "GetNickNameCallback exception." + paramException.getMessage(), paramException);
  ...
  public void a(JSONObject paramJSONObject)
  {
    try
    {
      ...
      if (paramJSONObject.length() == 0)
      {
        ...
        paramJSONObject.putExtra("key_error_msg", bdix.c);
        paramJSONObject.putExtra("key_error_detail", ajyc.a(2131701499));
        a(paramJSONObject);
        return;
      }
    }
    ...
    {
      bdht.c("qqBaseActivity", "GetNickNameCallback exception." + paramJSONObject.getMessage(), paramJSONObject);
      paramJSONObject = new Intent();
      paramJSONObject.putExtra("key_error_code", -4);
      paramJSONObject.putExtra("key_error_msg", bdix.b);
      a(paramJSONObject);
      return;
      paramJSONObject = bdhz.a(bdhz.a(paramJSONObject.getJSONObject(0).getString("nick")), 12, true, true);
