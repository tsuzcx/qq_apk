...
public class ayjm
{
  ...
  public void a()
  {
    ...
    bjlo.a(localActivity, "com.guagua.qiqi", bcqt.a("pt=$PT$&at=$AT$&openid=$OPID$&pf=$PF$"), 335544320);
  }
  ...
  public void a(int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidOsAsyncTask = new ayjn(this);
    this.jdField_a_of_type_AndroidOsAsyncTask.execute(new Integer[] { Integer.valueOf(paramInt) });
    return;
    Bundle localBundle = new Bundle();
    localBundle.putString(bjmy.b, this.c);
    localBundle.putString(bjmy.j, this.d);
    localBundle.putString(bjmy.f, this.b);
    localBundle.putInt(bjmy.k, paramInt);
    localBundle.putString(bjmy.i, "ANDROIDQQ.MSG.QIQI");
    localBundle.putString(bjmy.l, "");
    localBundle.putBoolean(bjmy.x, false);
    localBundle.putBoolean(bjmy.g, true);
    localBundle.putBoolean(bjmy.h, false);
    bjmu.a(localNearbyPeopleProfileActivity, localBundle, "biz_src_yyb", null, 0);
  }
  ...
  public void a(com.tencent.common.app.AppInterface paramAppInterface, android.content.Context paramContext, String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    //   10: aload_2
    //   11: iload 6
    //   13: invokespecial 219	ayjo:<init>	(Layjm;Ljava/lang/String;Landroid/content/Context;I)V
    //   16: astore 14
    //   18: aload_0
    //   19: getfield 28	ayjm:jdField_a_of_type_MqqAppNewIntent	Lmqq/app/NewIntent;
    //   22: ifnonnull +17 -> 39
    //   25: aload_0
    ...
    //   36: putfield 28	ayjm:jdField_a_of_type_MqqAppNewIntent	Lmqq/app/NewIntent;
    ...
    //   93: aload_2
    //   94: invokestatic 262	bjlo:a	(Landroid/content/Context;)Ljava/lang/String;
    //   97: astore_3
    //   98: aload 15
    ...
    //   155: invokevirtual 283	com/tencent/mobileqq/app/QQAppInterface:getvKeyStr	()Ljava/lang/String;
    //   158: astore_3
    //   159: aload 15
    //   161: getfield 286	com/tencent/qconn/protofile/fastauthorize/FastAuthorize$AuthorizeRequest:vkey	Lcom/tencent/mobileqq/pb/PBStringField;
    //   164: aload_3
    //   165: invokevirtual 259	com/tencent/mobileqq/pb/PBStringField:set	(Ljava/lang/String;)V
    //   168: aload_0
    //   169: getfield 205	ayjm:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   172: invokestatic 289	bcqt:a	(Ljava/lang/String;)I
    //   175: istore 7
    //   177: iload 7
    //   179: ifne +28 -> 207
    //   182: aload_2
    //   183: aload 4
    //   185: aload_0
    //   186: getfield 205	ayjm:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   189: invokestatic 64	bcqt:a	(Ljava/lang/String;)Landroid/os/Bundle;
    //   192: iload 6
    //   194: invokestatic 70	bjlo:a	(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;I)Z
    //   197: pop
    //   198: return
    //   199: astore 12
    //   201: lconst_0
    ...
    //   204: goto -147 -> 57
    //   207: aload 15
    //   209: getfield 293	com/tencent/qconn/protofile/fastauthorize/FastAuthorize$AuthorizeRequest:flags	Lcom/tencent/mobileqq/pb/PBInt32Field;
    //   212: iload 7
    //   214: invokevirtual 297	com/tencent/mobileqq/pb/PBInt32Field:set	(I)V
    //   217: ldc 148
    //   219: astore 5
    //   221: aload 5
    //   223: astore_3
    //   224: aload_2
    //   225: invokevirtual 303	android/content/Context:getPackageManager	()Landroid/content/pm/PackageManager;
    //   228: aload 4
    //   230: bipush 64
    //   232: invokevirtual 309	android/content/pm/PackageManager:getPackageInfo	(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    //   235: getfield 315	android/content/pm/PackageInfo:signatures	[Landroid/content/pm/Signature;
    //   238: astore 16
    //   240: aload 5
    //   242: astore_3
    //   243: aload 16
    ...
    //   254: astore_3
    //   255: ldc_w 317
    //   258: invokestatic 323	java/security/MessageDigest:getInstance	(Ljava/lang/String;)Ljava/security/MessageDigest;
    //   261: astore 13
    //   263: aload 5
    //   265: astore 12
    //   267: aload 5
    ...
    //   274: iconst_0
    //   275: aaload
    //   276: invokevirtual 329	android/content/pm/Signature:toByteArray	()[B
    //   279: invokevirtual 333	java/security/MessageDigest:update	([B)V
    //   282: aload 5
    //   284: astore 12
    //   286: aload 5
    //   288: astore_3
    //   289: aload 13
    //   291: invokevirtual 336	java/security/MessageDigest:digest	()[B
    //   294: invokestatic 342	com/tencent/mobileqq/utils/HexUtil:bytes2HexStr	([B)Ljava/lang/String;
    //   297: astore 5
    //   299: aload 5
    //   301: invokevirtual 347	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   304: astore_3
    //   305: aload_3
    //   306: astore 5
    //   308: aload 5
    ...
    //   314: astore_3
    //   315: aload 13
    //   317: invokevirtual 350	java/security/MessageDigest:reset	()V
    //   320: aload 5
    //   322: astore_3
    //   323: aload_3
    ...
    //   351: aload 4
    //   353: aload_0
    //   354: getfield 205	ayjm:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   357: invokestatic 64	bcqt:a	(Ljava/lang/String;)Landroid/os/Bundle;
    //   360: iload 6
    //   362: invokestatic 70	bjlo:a	(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;I)Z
    //   365: pop
    //   366: return
    //   367: astore 13
    //   369: aload 12
    ...
    //   375: astore_3
    //   376: aload 13
    //   378: invokevirtual 355	java/security/NoSuchAlgorithmException:printStackTrace	()V
    //   381: aload 5
    //   383: astore_3
    //   384: goto -61 -> 323
    //   387: astore 5
    //   389: goto -66 -> 323
    //   392: aload 15
    //   394: getfield 358	com/tencent/qconn/protofile/fastauthorize/FastAuthorize$AuthorizeRequest:apk_sign	Lcom/tencent/mobileqq/pb/PBStringField;
    //   397: aload_3
    //   398: invokevirtual 259	com/tencent/mobileqq/pb/PBStringField:set	(Ljava/lang/String;)V
    //   401: aload_0
    //   402: getfield 28	ayjm:jdField_a_of_type_MqqAppNewIntent	Lmqq/app/NewIntent;
    //   405: ldc_w 360
    //   408: ldc_w 362
    //   411: invokevirtual 366	mqq/app/NewIntent:putExtra	(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    //   414: pop
    //   415: aload_0
    //   416: getfield 28	ayjm:jdField_a_of_type_MqqAppNewIntent	Lmqq/app/NewIntent;
    //   419: ldc_w 368
    //   422: aload 15
    //   424: invokevirtual 369	com/tencent/qconn/protofile/fastauthorize/FastAuthorize$AuthorizeRequest:toByteArray	()[B
    //   427: invokevirtual 372	mqq/app/NewIntent:putExtra	(Ljava/lang/String;[B)Landroid/content/Intent;
    //   430: pop
    //   431: aload_0
    //   432: getfield 28	ayjm:jdField_a_of_type_MqqAppNewIntent	Lmqq/app/NewIntent;
    //   435: aload 14
    //   437: invokevirtual 34	mqq/app/NewIntent:setObserver	(Lmqq/observer/BusinessObserver;)V
    //   440: aload_1
    //   441: aload_0
    //   442: getfield 28	ayjm:jdField_a_of_type_MqqAppNewIntent	Lmqq/app/NewIntent;
    //   445: invokevirtual 376	com/tencent/common/app/AppInterface:startServlet	(Lmqq/app/NewIntent;)V
    //   448: aload_0
    //   449: getfield 76	ayjm:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   452: bipush 6
    //   454: ldc2_w 377
    //   457: invokevirtual 382	android/os/Handler:sendEmptyMessageDelayed	(IJ)Z
    //   460: pop
    //   461: return
    //   462: astore_1
    ...
    //   476: iconst_2
    //   477: aload_1
    //   478: invokevirtual 385	java/lang/Exception:getMessage	()Ljava/lang/String;
