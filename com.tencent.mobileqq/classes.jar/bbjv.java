...
public class bbjv
{
  ...
  public bbjv(QQAppInterface paramQQAppInterface)
  {
  ...
  public ArrayList<awbv> a(String paramString)
  {
    ...
    Object localObject2 = (amjr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(2);
    Object localObject1 = ((amjr)localObject2).a(paramString);
    ...
    if (j < ((List)localObject1).size())
    {
      ...
      {
        localObject6 = ((amjk)localObject4).a(((TroopIndex)localObject5).mTroopUin, 1);
    ...
    for (float f2 = f1;; f2 = 0.0F)
    {
      ...
      localObject7 = ((amjr)localObject2).b((String)localObject7);
      ...
      if ((((aloz)localObject1).b(((TroopIndex)localObject8).mMemberUin)) && (!((String)localObject6).equals(((TroopIndex)localObject8).mMemberUin)) && (!paramString.equals(((TroopIndex)localObject8).mMemberUin)))
      {
        if (((HashMap)localObject5).containsKey(((TroopIndex)localObject8).mMemberUin)) {
          break label668;
        }
        bbjy localbbjy = new bbjy(this, f3);
        localbbjy.b = f2;
        localbbjy.jdField_a_of_type_Int = 1;
        RecentUser localRecentUser = ((amjk)localObject4).a(((TroopIndex)localObject8).mMemberUin, 0);
        if (localRecentUser != null) {
          localbbjy.jdField_a_of_type_Long = localRecentUser.lastmsgtime;
        }
        ((HashMap)localObject5).put(((TroopIndex)localObject8).mMemberUin, localbbjy);
      }
      for (;;)
      {
        j += 1;
        break;
        localObject8 = (bbjy)((HashMap)localObject5).get(((TroopIndex)localObject8).mMemberUin);
        ((bbjy)localObject8).jdField_a_of_type_Int += 1;
        ((bbjy)localObject8).b += f2;
      }
      if (QLog.isColorLevel()) {
      ...
      Collections.sort(paramString, new bbjw(this));
      i = paramString.size();
      if ((i > 1) && (((bbjy)((Map.Entry)paramString.get(i - 1)).getValue()).a() == ((bbjy)((Map.Entry)paramString.get(0)).getValue()).a())) {}
      for (i = 1;; i = 0)
      {
        if (i != 0)
        {
          ...
          Collections.sort(paramString, new bbjx(this));
        }
        localObject2 = new ArrayList();
        i = 0;
        if (i < paramString.size())
        {
          localObject3 = (bbjy)((Map.Entry)paramString.get(i)).getValue();
          localObject4 = ((aloz)localObject1).b((String)((Map.Entry)paramString.get(i)).getKey());
          if (localObject4 != null)
          {
            ((ArrayList)localObject2).add(localObject4);
            if ((i < 20) && (QLog.isColorLevel())) {
              QLog.i("RelationFriendsSearchHelper", 2, "top20:uin" + bdje.e(((Friends)localObject4).uin) + ",scores:" + ((bbjy)localObject3).a() + ",frequency:" + ((bbjy)localObject3).jdField_a_of_type_Int + ",activefactor:" + ((bbjy)localObject3).b + ",c2clastmsgtime:" + ((bbjy)localObject3).jdField_a_of_type_Long);
            }
          }
          for (;;)
          {
