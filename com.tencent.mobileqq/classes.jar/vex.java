  ...
  implements Comparable<vex>
{
  ...
  public vex(vel paramvel, vey paramvey, vfa paramvfa)
  {
    ...
    this.jdField_a_of_type_Vey = paramvey;
    this.jdField_a_of_type_Vfa = paramvfa;
    this.r = 10000;
    this.o = this.jdField_a_of_type_Vel.jdField_k_of_type_Int;
    this.p = this.jdField_a_of_type_Vel.l;
    a();
  }
  ...
  public int a(vex paramvex)
  {
    return vhg.a(this, paramvex);
  }
  
  public long a()
  {
    return this.jdField_a_of_type_Vey.a();
  }
  ...
  public vel a()
  {
    return this.jdField_a_of_type_Vel;
  }
  
  public vfa a()
  {
    return this.jdField_a_of_type_Vfa;
  }
  
  protected void a()
  {
    f(this.jdField_a_of_type_Vel.jdField_h_of_type_Int);
    e(this.jdField_a_of_type_Vel.jdField_g_of_type_Int);
    e(this.jdField_a_of_type_Vel.jdField_b_of_type_Float);
    f(this.jdField_a_of_type_Vel.jdField_c_of_type_Float);
    k(this.jdField_a_of_type_Vel.jdField_d_of_type_Float);
    c(this.jdField_a_of_type_Vel.jdField_i_of_type_Int);
    a(this.jdField_a_of_type_Vel.jdField_a_of_type_Float);
    a(this.jdField_a_of_type_Vel.jdField_j_of_type_Int);
    d(this.jdField_a_of_type_Vel.jdField_a_of_type_Boolean);
    e(this.jdField_a_of_type_Vel.jdField_c_of_type_Boolean);
    d(this.jdField_a_of_type_Vel.jdField_e_of_type_Float);
    c(this.jdField_a_of_type_Vel.jdField_b_of_type_Boolean);
  }
  ...
  {
    return paramLong - this.jdField_c_of_type_Long >= this.jdField_a_of_type_Vey.a();
  }
  ...
  public final void c()
  {
    long l1 = this.jdField_a_of_type_Vfa.b();
  ...
  public boolean c()
  {
    if (this.jdField_a_of_type_Vfa != null) {
      return a(this.jdField_a_of_type_Vfa.a());
    }
    return true;
  }
