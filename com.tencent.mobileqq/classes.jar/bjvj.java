...
{
  public int a;
  BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new bjvn(this);
  public String a;
  ...
  private int a(int paramInt)
  {
    ...
    if ((localbebx instanceof becr)) {
      i = ((becr)localbebx).switchRequestCode(this, (byte)paramInt);
    }
    return i;
  }
  ...
  private void a(int paramInt)
  {
    ...
    do
    {
      ...
      for (int i = 1; i != 0; i = 0)
      {
        QQToast.a(this.mRuntime.a(), 2131718638, 0).b(j);
        return;
      }
      a();
      switch (paramInt)
      ...
      case 1: 
        ...
        localbizt.jdField_a_of_type_JavaLangString = this.mRuntime.a().getCurrentAccountUin();
        BaseBusinessAlbumInfo localBaseBusinessAlbumInfo = new BaseBusinessAlbumInfo();
        localBaseBusinessAlbumInfo.jdField_a_of_type_JavaLangString = localbizt.jdField_a_of_type_JavaLangString;
        ...
        localBaseBusinessAlbumInfo.jdField_b_of_type_JavaLangString = this.mRuntime.a().getString(2131718126);
        bizm.b(this.mRuntime.a(), localbizt, localBaseBusinessAlbumInfo, -1, "cover_mall_record_video");
        return;
      }
      QLog.i("CoverStore", 1, "VIDEO_COVER click select record video.");
    } while (!bjqu.a(this.mRuntime.a(), new bjvl(this, j), 1));
    b(j);
  }
      ...
      do
      {
        do
        {
          ...
          for (;;)
          {
            ...
            Object localObject = bjtn.a(str);
            if (localObject == null) {
              break;
            }
            double d1 = bjtn.a((bjtq)localObject);
            if (d1 > 0.0D)
            {
            ...
            localObject = bjtn.a(str, ((bjtq)localObject).jdField_a_of_type_Int, ((bjtq)localObject).jdField_b_of_type_Int);
  ...
  private void a(String paramString)
  {
    ...
    Object localObject = bizt.a();
    ((bizt)localObject).jdField_a_of_type_JavaLangString = this.mRuntime.a().getAccount();
    paramString.putString("keyAction", "actionSelectPicture");
    paramString.putBoolean("key_need_change_to_jpg", false);
    bizm.a(this.mRuntime.a(), (bizt)localObject, paramString, a(3));
  }
    ...
    for (;;)
    {
      ...
      try
      {
        if (i < paramArrayList.size())
        {
          ...
          Object localObject2 = bjtn.a((String)localObject1);
          if (localObject2 == null) {
            break label335;
          }
          double d1 = bjtn.a((bjtq)localObject2);
          if (d1 > 0.0D)
          {
            ((bjtq)localObject2).jdField_a_of_type_Int = ((int)(((bjtq)localObject2).jdField_a_of_type_Int / d1));
            ((bjtq)localObject2).jdField_b_of_type_Int = ((int)(((bjtq)localObject2).jdField_b_of_type_Int / d1));
          }
          localObject2 = bjtn.a((String)localObject1, ((bjtq)localObject2).jdField_a_of_type_Int, ((bjtq)localObject2).jdField_b_of_type_Int);
          ...
          azly.a(BaseApplication.getContext()).reportTimeKVEvent("Qzone.EventTransformPhotoBase64", (Properties)localObject1, (int)(l2 - l1));
        }
      }
  ...
  {
    bjaw.a(this.mRuntime.a().getLongAccountUin(), this.mRuntime.a(), "cover_mall_record_video", new bjvm(this, paramInt));
  }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if (paramString3.equals("showStoreButton"))
    {
      ...
      paramJsBridgeListener = (TextView)this.mRuntime.a().findViewById(2131368644);
      if (paramJsBridgeListener != null)
      {
        paramJsBridgeListener.setVisibility(0);
        paramJsBridgeListener.setTextColor(-1);
        paramJsBridgeListener.setText(alpo.a(2131712012));
        paramJsBridgeListener.setOnClickListener(new bjvk(this));
      }
    }
    label810:
    do
    {
      for (;;)
      {
        ...
        else if (paramString3.equals("openYellowDiamond"))
        {
          ...
          paramString2 = alpo.a(2131712010);
      ...
      if (paramString3.equals("leftButtonClick"))
      {
        ...
        ((TextView)this.mRuntime.a().findViewById(2131368613)).performClick();
        return true;
      }
