  ...
  extends BroadcastReceiver
{
  ...
  {
    paramContext = this.a.jdField_a_of_type_Apkt.a();
    if (paramIntent == null) {}
    Object localObject;
    label420:
    label452:
    ...
    do
    {
      do
      {
        ...
        do
        {
          ...
          do
          {
              ...
              for (;;)
              {
                ...
                if (localObject != null)
                {
                  ...
                  if (paramIntent.getLongExtra("token_task_id", 0L) == paramContext.uniseq)
                  {
                    ...
                    if (l2 != 0L) {}
                    for (paramContext.fProgress = ((float)l1 / (float)l2); this.a.jdField_a_of_type_Apnf != null; paramContext.fProgress = 1.0F)
                    {
                      this.a.jdField_a_of_type_Apnf.a(paramContext.fProgress);
                      return;
                    }
                  }
                }
            ...
            apnh.a(this.a, NetConnInfoCenter.getServerTimeMillis());
            ...
            paramIntent.uNotifyTime = apnh.a(this.a);
            paramIntent.uFileSize = l2;
            paramIntent.bFileExist = false;
            paramIntent.uStartPos = 0L;
            paramIntent.uTaskStart = apnh.a(this.a);
            paramIntent.uTaskEnd = apnh.b(this.a);
            paramIntent.uDuration = (apnh.b(this.a) - apnh.a(this.a));
            ...
            if (bool)
            {
              ...
              localObject = ((ajum)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(8)).a().a();
              if (localObject == null) {
                break label631;
              }
              paramIntent.dwServerIP = fb.a(((bgpi)localObject).jdField_a_of_type_JavaLangString);
              paramIntent.wServerPort = ((short)((bgpi)localObject).jdField_a_of_type_Int);
            ...
            for (;;)
            {
              ((ajum)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(8)).a().a(paramContext.strDataLineMPFileID);
              if (apnh.b(this.a)) {
                break label841;
              }
              paramContext.mContext = "needMPFileC2C";
              QLog.d("MPcFileModel<FileAssistant>", 2, "mConnPCSuc:" + apnh.b(this.a) + ",create mEntity.mContext");
              return;
              if (apnh.a(this.a))
              {
                i = 32;
              ...
              apnh.a(this.a, j + 2100);
              break label505;
              paramContext.status = 1;
              paramIntent = ((ajum)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(8)).a().b();
              if (paramIntent == null) {
            ...
            QLog.d("MPcFileModel<FileAssistant>", 2, "mConnPCSuc:" + apnh.b(this.a) + "mEntity.mContext = null");
            paramContext.mContext = null;
            return;
            if (!bgpg.d.equalsIgnoreCase((String)localObject)) {
              break;
            }
            paramContext = paramIntent.getExtras();
            l1 = paramIntent.getLongExtra(bgpg.f, 0L);
            i = paramContext.getInt(bgpg.e);
            j = paramContext.getInt("result");
            if ((i == 0) && (j == 0)) {
              apnh.a(this.a, true);
            }
            QLog.d("MPcFileModel<FileAssistant>[MPFile]", 1, "mainReceiver MPFILE_ACTION_HOST_INFO_UPDATE,ret:" + i);
          } while (apnh.c(this.a) != l1);
          if (i != 0) {
            break;
          }
          ...
          case 3: 
          case 4: 
            apnh.a(this.a, i + 2000);
          }
        } while (this.a.jdField_a_of_type_Apkq == null);
        this.a.jdField_a_of_type_Apkq.a(false);
        return;
      ...
      this.a.jdField_a_of_type_Apkq.a(false);
      return;
    } while (!bgpg.g.equalsIgnoreCase((String)localObject));
    label631:
    apnh.a(this.a, false);
    label644:
    label651:
