...
public class upp
{
  ...
  private List<vve> f = new ArrayList();
  ...
  public void a(List<CommentEntry> paramList, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean1)
      {
        ...
        ved.a("Q.qqstory.detail.DetailFeedItem", "comment list's size is %d after clear.", Integer.valueOf(localList.size()));
      }
      ...
      Collections.sort(localList, new upq(this));
      ved.a("Q.qqstory.detail.DetailFeedItem", "comment list's size is %d after add %d comments.", Integer.valueOf(localList.size()), Integer.valueOf(paramList.size()));
      return;
    }
  }
  ...
  public void b(List<vve> paramList, boolean paramBoolean)
  {
    if (paramBoolean) {
      this.f.clear();
    }
