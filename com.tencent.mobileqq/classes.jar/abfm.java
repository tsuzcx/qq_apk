  ...
  implements abfy
{
  ...
  public void f()
  {
    ...
    this.a.f();
    if ((this.a.jdField_a_of_type_Abfx != null) && (!this.a.jdField_a_of_type_Abfx.a())) {
      this.a.jdField_a_of_type_Abfx.a();
    }
  }
  
  public void g()
  {
    if (this.a.jdField_a_of_type_Abgc.a().b) {
      this.a.jdField_a_of_type_ComTencentWidgetGallery.setVisibility(4);
    }
    this.a.g();
    if ((this.a.jdField_a_of_type_Abfx != null) && (this.a.jdField_a_of_type_Abfx.a())) {
      this.a.jdField_a_of_type_Abfx.b();
    }
  }
  ...
  public void h()
  {
    ...
    if (this.a.jdField_a_of_type_Abfk != null) {
      this.a.jdField_a_of_type_Abfk.a(4);
    }
    if ((this.a.jdField_a_of_type_Abfx != null) && (this.a.jdField_a_of_type_Abfx.a())) {
      this.a.jdField_a_of_type_Abfx.b();
    }
  ...
  public void i()
  {
    ...
    if (QLog.isColorLevel())
    {
      ...
      if (this.a.jdField_a_of_type_Abgc.a() != this.a) {
        break label87;
      }
    }
    label87:
