  ...
  implements View.OnTouchListener
{
  ...
  protected bfol a;
  private bfqd jdField_a_of_type_Bfqd = new aprd(this);
  ...
  public apqx(Activity paramActivity)
  {
    super(paramActivity);
  }
  ...
  private String a(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Bfol != null) {
      str = this.jdField_a_of_type_Bfol.a(paramInt);
    }
    return str;
  }
  ...
  private void a(List<bbje> paramList, int paramInt, View paramView)
  {
    ...
    do
    {
      ...
      localbbje = (bbje)paramList.next();
    } while (!str.equalsIgnoreCase(localbbje.jdField_a_of_type_JavaLangString));
    localbbje.jdField_a_of_type_AndroidViewView$OnClickListener.onClick(paramView);
  }
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_AndroidViewView == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131378892));
      ...
      this.h = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131375203));
      this.h.setText(ajyc.a(2131716259));
      ...
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369905));
      ...
      this.g = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362986));
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    {
      Rect localRect = apvk.a(this.jdField_a_of_type_AndroidAppActivity, a(), paramInt1, paramInt2);
      if (localRect != null) {
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    localTextView.setCompoundDrawablesWithIntrinsicBounds(0, 2130843493, 0, 0);
    ...
    if (apvb.b(paramString1))
    {
      ...
      paramString2.setOnClickListener(new apqz(this, paramString1));
    ...
    this.jdField_a_of_type_AndroidViewView.setOnClickListener(new apra(this));
  }
  
  public void a(List<bbje> paramList)
  {
    if (this.jdField_a_of_type_Bfol == null)
    {
    ...
    while (localIterator.hasNext())
    {
      ...
      this.jdField_a_of_type_Bfol.a(localbbje.jdField_a_of_type_JavaLangString, 0);
    }
    this.jdField_a_of_type_Bfol.d(ajyc.a(2131716258));
    this.jdField_a_of_type_Bfol.a(new aprb(this, paramList));
  }
  ...
  public void b(String paramString, View.OnClickListener paramOnClickListener)
  {
    ...
    {
      this.jdField_c_of_type_AndroidViewView = aozx.a(paramString).a(this.jdField_a_of_type_AndroidAppActivity);
      this.jdField_c_of_type_AndroidViewView.setId(2131379139);
      ...
      if (paramString != null) {
        paramString.addOnLayoutChangeListener(new apqy(this));
      }
  ...
  public void d()
  {
    if (Build.VERSION.SDK_INT >= 11)
    {
      ...
      this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new aprc(this));
    }
  }
  ...
  public void d(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      this.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130844888);
    ...
    this.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130844886);
