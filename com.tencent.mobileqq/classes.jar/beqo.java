  ...
  implements Animation.AnimationListener
{
  ...
  protected static final int m = (int)BaseApplicationImpl.getApplication().getResources().getDimension(2131297451);
  protected float a;
  protected Handler a;
  ...
  public beqo()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new beqp(this);
  }
  ...
  private void a(TextView paramTextView, int paramInt)
  {
    ...
    if (paramInt == e)
    {
      paramTextView.setText(2131696883);
      paramTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130842331, 0);
