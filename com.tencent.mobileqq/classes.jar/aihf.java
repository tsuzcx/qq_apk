  ...
  implements View.OnClickListener
{
  ...
  public aihf(AbsShareMsg paramAbsShareMsg) {}
  ...
  public void onClick(View paramView)
  {
    ...
    Object localObject3 = new aihh(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg, localQQAppInterface, paramView);
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgServiceID == 114) {
        ThreadManager.post(new aihg(this, localQQAppInterface), 0, null, false);
      }
      label791:
      label926:
        ...
        while (((Iterator)localObject3).hasNext())
        {
          ...
          if ((paramView instanceof StructMsgItemLayout5))
          {
            ...
            for (paramView = paramView.B;; paramView = "0")
            {
              ...
              break;
              if (((aihh)localObject3).a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceUrl, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceActionData, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSource_A_ActionData))
              {
                paramView = "run";
                break label413;
              }
              if (((aihh)localObject3).a(((FragmentActivity)localContext).getActivity(), this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceAppid, localAbsShareMsg.mSourceName, localAbsShareMsg.mSourceActionData, localAbsShareMsg.mSource_A_ActionData))
              {
                paramView = "setup";
                break label413;
              }
              ((aihh)localObject3).a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceUrl);
              paramView = "setup";
              break label413;
              if ("web".equals(paramView))
              {
                ...
                ((aihh)localObject3).a(paramView);
                paramView = "setup";
                break label443;
              }
              if ("plugin".equals(paramView))
              {
                ((aihh)localObject3).c(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceActionData, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSource_A_ActionData);
              ...
              ((aihh)localObject3).a(paramView, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceUrl, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceActionData, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSource_A_ActionData);
              break label443;
            }
          }
        }
