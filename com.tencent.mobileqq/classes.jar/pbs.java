  ...
  implements behi
{
  ...
  public pbs(Context paramContext, List<bahx> paramList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (this.jdField_a_of_type_Pbt == null) {
      this.jdField_a_of_type_Pbt = new pbt(paramViewGroup.getContext());
    }
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131494207, paramViewGroup, false);
    ...
    if (paramViewGroup.jdField_a_of_type_Bahx.e > 0)
    {
      ...
      localObject1 = this.jdField_a_of_type_Pbt.a((Drawable)localObject1, paramInt, i);
      if (!paramViewGroup.jdField_a_of_type_Bahx.c) {
        break label486;
      }
      localObject2 = pbt.a(this.jdField_a_of_type_Pbt, (Drawable)localObject1);
      localObject1 = this.jdField_a_of_type_Pbt.a((Drawable)localObject1, (Drawable)localObject2);
    ...
    for (paramViewGroup = paramViewGroup.jdField_a_of_type_Bahx.jdField_a_of_type_JavaLangString;; paramViewGroup = "")
    {
      ...
      break label324;
      label486:
      localObject1 = pbt.b(this.jdField_a_of_type_Pbt, (Drawable)localObject1);
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject1);
      break label403;
      label509:
