...
public class ual
{
  ...
  public ual(ViewGroup paramViewGroup, JSONObject paramJSONObject)
  {
    ...
    this.jdField_a_of_type_Uah = new uah(paramJSONObject.getJSONObject("video_info"));
