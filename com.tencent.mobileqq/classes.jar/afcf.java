...
public class afcf
  extends anuw
{
  public afcf(PermisionPrivacyActivity paramPermisionPrivacyActivity) {}
  ...
  protected void onGetAllowStrangerInviteToGroupSwitch(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    if (!paramBoolean1)
    {
      ...
      Card localCard = ((anyw)this.a.app.getManager(51)).c(this.a.app.getCurrentAccountUin());
  ...
  protected void onGetCalReactiveDays(boolean paramBoolean1, boolean paramBoolean2)
  {
    if ((paramBoolean1) && (!this.a.isFinishing()))
    {
      ...
      this.a.jdField_a_of_type_ComTencentMobileqqWidgetFormSimpleItem.setRightText(anzj.a(2131698371));
    }
    for (;;)
    {
      ...
      return;
      label106:
      this.a.jdField_a_of_type_ComTencentMobileqqWidgetFormSimpleItem.setRightText(anzj.a(2131698372));
    }
  }
  ...
  protected void onGetTroopHonorSwitch(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      if (paramBoolean2) {
        this.a.b.setRightText(anzj.a(2131698371));
      }
    }
    else {
      return;
    }
    this.a.b.setRightText(anzj.a(2131698372));
  }
  ...
  protected void onSetMedal(boolean paramBoolean)
  {
    ...
    if (!paramBoolean)
    {
      QQToast.a(this.a.app.getApp(), 1, this.a.getString(2131717966), 3000).b(this.a.getTitleBarHeight());
      localObject1 = this.a;
    ...
    Object localObject1 = ((anyw)this.a.app.getManager(51)).c(this.a.app.getCurrentAccountUin());
    ...
    for (;;)
    {
      bdll.b((QQAppInterface)localObject2, "dc00898", "", "", "0X80073A0", "0X80073A0", i, 0, "", "", "", "");
      return;
      label260:
      paramBoolean = false;
      break;
