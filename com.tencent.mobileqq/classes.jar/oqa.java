...
public class oqa
{
    ...
    for (;;)
    {
      try
      {
        ...
        if (bgmq.a(paramInt))
        {
          ...
          localObject1 = (String)bgmq.a("DAILY_CHILD_FEEDS_REQUEST_CONFIG" + paramInt, "");
  ...
  public static oqa a(JSONObject paramJSONObject)
  {
    int j = 0;
    oqa localoqa = new oqa();
    if (paramJSONObject != null)
    {
      localoqa.jdField_a_of_type_JavaLangString = paramJSONObject.optString("key");
      localoqa.jdField_b_of_type_JavaLangString = paramJSONObject.optString("name");
      localoqa.d = paramJSONObject.optString("value");
      localoqa.c = paramJSONObject.optString("id");
      ...
      if (localObject != null)
      {
        ...
        while (i < ((JSONArray)localObject).length())
        {
          ...
          localoqa.jdField_b_of_type_JavaUtilList.add(str);
          i += 1;
        }
      }
      ...
      if (paramJSONObject != null)
      {
        ...
        while (i < paramJSONObject.length())
        {
          ...
          localoqa.jdField_a_of_type_JavaUtilList.add(localObject);
          i += 1;
        }
      }
    }
