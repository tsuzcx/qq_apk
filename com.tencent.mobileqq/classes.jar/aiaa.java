  ...
  implements ahzy
{
  ...
  private GestureDetector.OnGestureListener jdField_a_of_type_AndroidViewGestureDetector$OnGestureListener = new aiab(this);
  ...
  public aiaa(ahzz paramahzz, String paramString, int paramInt1, int paramInt2, float paramFloat1, float paramFloat2, int paramInt3, float paramFloat3, int paramInt4)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetScroller = new Scroller(this.jdField_a_of_type_Ahzz.getContext());
    this.jdField_a_of_type_AndroidViewGestureDetector = new GestureDetector(this.jdField_a_of_type_Ahzz.getContext(), this.jdField_a_of_type_AndroidViewGestureDetector$OnGestureListener);
    this.jdField_a_of_type_Ahzx = new ahzx(this);
    ...
    for (this.jdField_a_of_type_Aiae = new VideoFramesRetriever(paramString, paramFloat1);; this.jdField_a_of_type_Aiae = new VideoFramesFetcher())
    {
      this.jdField_a_of_type_Aiae.a(paramInt4, paramInt1, this.jdField_a_of_type_Ahzx);
      this.jdField_a_of_type_Aiae.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      return;
    }
  }
  ...
  private void c()
  {
    if ((this.jdField_a_of_type_Ahzx == null) || (this.jdField_a_of_type_Ahzx.a())) {}
    int j;
    do
    {
      return;
  ...
  private void d()
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetScroller.computeScrollOffset())
    {
      ...
      c();
      if (this.jdField_a_of_type_Ahzz != null) {
    ...
    label157:
    while (this.jdField_a_of_type_Aiad == null)
    {
      return;
      this.jdField_a_of_type_Aiae.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      break;
    }
    this.jdField_a_of_type_Aiad.a(this.jdField_d_of_type_Float, -this.jdField_d_of_type_Float, this.f - this.jdField_d_of_type_Float);
  }
  
  public void a()
  {
    this.jdField_a_of_type_Ahzz.postInvalidate();
  }
  ...
  public void a(aiad paramaiad)
  {
    this.jdField_a_of_type_Aiad = paramaiad;
  ...
  public void a(Canvas paramCanvas)
  {
    ...
    while (j < m)
    {
      aiac localaiac = this.jdField_a_of_type_Ahzx.a(j);
      if (localaiac != null)
      {
        ...
        this.jdField_a_of_type_AndroidGraphicsCanvas.drawBitmap(localaiac.jdField_a_of_type_AndroidGraphicsBitmap, this.jdField_c_of_type_AndroidGraphicsRect, this.jdField_c_of_type_AndroidGraphicsRect, this.jdField_a_of_type_AndroidGraphicsPaint);
      }
  ...
  public void b()
  {
    this.jdField_a_of_type_Aiad = null;
    if (this.jdField_a_of_type_Aiae != null) {
      this.jdField_a_of_type_Aiae.a();
    }
    if (this.jdField_a_of_type_Ahzx != null) {
