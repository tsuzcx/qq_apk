...
{
  bgza(bgyx parambgyx, String paramString, int paramInt)
  {
  ...
  public void onEvent(int paramInt, String paramString)
  {
    ...
    case 256: 
      ...
      bgyx.a(this.a).sendEmptyMessageDelayed(1, paramInt);
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.d("QZoneStartupMonitor", 2, "启动成功，清理超时，并校验odex和上报");
    }
    bgyx.a(this.a).removeMessages(1);
    paramString = bgyx.a(BaseApplicationImpl.getApplication(), "qzone_plugin.apk");
    if (paramString != null) {}
    for (paramInt = ((Integer)paramString.first).intValue();; paramInt = 0)
    {
      bgyx.a(this.a, true);
      bgyx.a(this.a, paramInt, bgyx.a(this.a), LocalMultiProcConfig.getInt("key_recovery_count", 0));
