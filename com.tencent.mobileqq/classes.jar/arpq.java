  ...
  extends akej
{
  ...
  public arpq(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager)
  {
  ...
  public static MessageRecord a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte)
  {
    ...
    if (((Long)((Pair)localObject2).first).longValue() != 4294967295L)
    {
      ...
      if (((!awbk.c(k)) && (k != 208) && (k != 529)) || (!paramArrayOfByte.c2c_cmd.has())) {
        break label554;
      }
    ...
    for (;;)
    {
      ...
      {
        awbg.a(localMessageHandler, localArrayList, localMsg);
        break label1259;
        int m = awbg.a(localMsg);
        ...
        if (paramArrayOfByte.hasNext())
        {
          ...
          Object localObject1;
          ((MessageRecord)localObject2).vipBubbleID = ajrm.a((int)localObject1, m);
          ...
          awbg.a(localMessageHandler, localArrayList, localMsg, true, false, null);
          continue;
          label554:
          ...
          if (!paramQQAppInterface.a().a().a(localArrayList, localMsg)) {
            awbg.a(localMessageHandler, localArrayList, localMsg, false, false, null);
          }
                ...
                if (((im_msg_body.Elem)localObject2).anon_group_msg.has())
                {
                  ...
                  for (;;)
                  {
                    try
                    {
                      ...
                      {
                        localObject2 = "";
                        localMessageRecord.saveExtInfoToExtStr("anonymous", mnf.a(i, paramArrayOfByte, (String)localObject2, j, m, str));
          ...
          awbg.a(localMessageHandler, localMsg, localArrayList);
          break label1296;
          label972:
    ...
    for (;;)
    {
      ...
      do
      {
        if (ajed.z.equals(Long.valueOf(l3)))
        {
          ((MessageRecord)localObject2).istroop = 6000;
          break label452;
        }
        if (ajed.A.equals(Long.valueOf(l3)))
        {
        ...
        break label452;
        ajml.a(localArrayList);
        if (localArrayList.size() > 0) {
          return (MessageRecord)localArrayList.get(0);
        }
        arsc.a("MsgBackup_msgproxy", "transToMessageRecord failed.........", new Object[0]);
        return null;
        break label303;
        break label303;
        do
  ...
  public static msg_comm.MsgHead a(MessageRecord paramMessageRecord, long paramLong)
  {
    ...
    Object localObject = akbm.c(paramMessageRecord);
    for (;;)
    {
      try
      {
  ...
  public static im_msg_body.MsgBody a(MessageRecord paramMessageRecord, QQAppInterface paramQQAppInterface)
  {
    if ((paramMessageRecord.msgtype == -1000) || (paramMessageRecord.msgtype == -10000)) {
      if (!TextUtils.isEmpty(paramMessageRecord.getExtInfoFromExtStr("sens_msg_source_msg_info"))) {
        paramQQAppInterface = awbg.a(paramMessageRecord);
      }
    }
    label965:
    for (;;)
    {
      if ((paramQQAppInterface != null) && (!paramQQAppInterface.elems.isEmpty()))
      {
        ...
        if (mnf.a(paramMessageRecord))
        {
          ...
          ((im_msg_body.AnonymousGroupMsg)localObject2).uint32_flags.set(localmng.jdField_a_of_type_Int);
          if (!TextUtils.isEmpty(localmng.jdField_a_of_type_JavaLangString)) {
            ((im_msg_body.AnonymousGroupMsg)localObject2).str_anon_id.set(ByteStringMicro.copyFrom(localmng.jdField_a_of_type_JavaLangString.getBytes()));
          }
          if (!TextUtils.isEmpty(localmng.jdField_b_of_type_JavaLangString)) {
            ((im_msg_body.AnonymousGroupMsg)localObject2).str_anon_nick.set(ByteStringMicro.copyFrom(localmng.jdField_b_of_type_JavaLangString.getBytes()));
          }
          ((im_msg_body.AnonymousGroupMsg)localObject2).uint32_head_portrait.set(localmng.jdField_b_of_type_Int);
          ((im_msg_body.AnonymousGroupMsg)localObject2).uint32_expire_time.set(localmng.jdField_c_of_type_Int);
          if (!TextUtils.isEmpty(localmng.jdField_c_of_type_JavaLangString)) {
            ((im_msg_body.AnonymousGroupMsg)localObject2).str_rank_color.set(ByteStringMicro.copyFrom(localmng.jdField_c_of_type_JavaLangString.getBytes()));
          }
        ...
        paramQQAppInterface = awbg.a((MessageForText)paramMessageRecord);
        continue;
        if (paramMessageRecord.msgtype == -1049)
        {
          paramQQAppInterface = awbg.a((MessageForReplyText)paramMessageRecord);
          continue;
        }
        ...
        {
          paramQQAppInterface = awbg.a((MessageForQQStoryComment)paramMessageRecord);
          continue;
        }
        if (paramMessageRecord.msgtype == -2000)
        {
          paramQQAppInterface = awbg.a((MessageForPic)paramMessageRecord);
          continue;
        }
        if (paramMessageRecord.msgtype == -5008)
        {
          paramQQAppInterface = awbg.a((MessageForArkApp)paramMessageRecord, true);
          continue;
        }
        if (paramMessageRecord.msgtype == -5016)
        {
          paramQQAppInterface = awbg.c((MessageForArkBabyqReply)paramMessageRecord, true);
          continue;
        }
        if (paramMessageRecord.msgtype == -5017)
        {
          paramQQAppInterface = awbg.b((MessageForArkApp)paramMessageRecord, true);
          continue;
        }
        if (paramMessageRecord.msgtype == -5013)
        {
          paramQQAppInterface = awbg.c((MessageForArkFlashChat)paramMessageRecord);
          continue;
        }
        if (paramMessageRecord.msgtype == -5014)
        {
          paramQQAppInterface = awbg.d((MessageForHiBoom)paramMessageRecord);
          continue;
        }
        if (paramMessageRecord.msgtype == -2011)
        {
          paramQQAppInterface = awbg.a((MessageForStructing)paramMessageRecord);
        ...
        if (paramMessageRecord.msgtype == -1035)
        {
          ...
          while (i < k)
          {
            ...
            {
              localObject1 = awbg.a((MessageForText)localObject1);
        ...
        {
          paramQQAppInterface = awbg.a((MessageForLongTextMsg)paramMessageRecord, false);
          continue;
        }
        ...
        else
        {
          ...
          {
            paramQQAppInterface = awbg.a((MessageForMarketFace)paramMessageRecord);
            continue;
          }
  ...
  public static byte[] a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    catch (Throwable paramQQAppInterface)
    {
      for (;;)
      {
        ...
        awpu.a(paramQQAppInterface, "MsgBackup_msgproxy,mr = " + paramMessageRecord.getClass().getSimpleName());
        paramQQAppInterface = null;
      }
  ...
  {
    QLog.d("MsgBackup_msgproxy", 1, "jasshen添加log");
    QLog.d("MsgBackup_msgproxy", 1, "jasshen添加log_11.19");
    msg_comm.Msg localMsg = new msg_comm.Msg();
    long l5;
    int i1;
    Object localObject4;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject4 = new aylt();
        ((aylt)localObject4).jdField_a_of_type_Int = arsc.c(paramMsgBackupMsgEntity.chatType);
        localMessageHandler = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
        localObject5 = awbg.a(localMessageHandler, localMsg, String.valueOf(l5), String.valueOf(l4));
        if (((Long)((Pair)localObject5).first).longValue() != 4294967295L)
        {
          l1 = ((Long)((Pair)localObject5).first).longValue();
          break label1564;
          localObject5 = new ArrayList();
          if (((!awbk.c(i1)) && (i1 != 208) && (i1 != 529)) || (!((msg_comm.MsgHead)localObject2).c2c_cmd.has())) {
            break label827;
          }
          ...
          if (i1 == 208)
          {
            awbg.a(localMessageHandler, (List)localObject5, localMsg);
            l1 = l3;
          }
          int m = 0;
          int i2 = awbg.a(localMsg);
          ...
          Object localObject1;
          ((MessageRecord)localObject4).vipBubbleID = ajrm.a((int)localObject1, i2);
      ...
      awbg.a(localMessageHandler, (List)localObject5, localMsg, true, false, (aylt)localObject4);
      continue;
      label827:
      ...
      if (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a((ArrayList)localObject5, localMsg)) {
        awbg.a(localMessageHandler, (List)localObject5, localMsg, false, false, (aylt)localObject4);
      }
            ...
            if (((im_msg_body.Elem)localObject4).anon_group_msg.has())
            {
              ...
              for (;;)
              {
                try
                {
                  ...
                  {
                    localObject4 = "";
                    localMessageRecord.saveExtInfoToExtStr("anonymous", mnf.a(i, (String)localObject2, (String)localObject4, j, k, str));
                    localMessageRecord.extLong |= 0x3;
                  }
                  else
                  {
      ...
      awbg.a(localMessageHandler, localMsg, (List)localObject5);
      break label1603;
    ...
    for (;;)
    {
      ...
      do
      {
        if (ajed.z.equals(Long.valueOf(l5))) {
  ...
  public MsgBackupMsgEntity a(@NonNull MessageRecord paramMessageRecord)
  {
    ...
    try
    {
      ...
      {
        arsc.a("transBackupEntity error,mr = %s ", paramMessageRecord.toString(), new Object[0]);
        return null;
      }
    }
    catch (Throwable localThrowable)
    {
      ...
      {
        QLog.e("MsgBackup_msgproxy", 1, "transToBackupEntity,getMsgBody error mr = " + paramMessageRecord.getClass().getSimpleName());
        awpu.a(localThrowable, "MsgBackup_msgproxy,mr = " + paramMessageRecord.getClass().getSimpleName());
        localObject2 = null;
      }
      localMsg.msg_head.set(localMsgHead);
      ...
      ((MsgBackupMsgEntity)localObject2).chatType = arsc.b(paramMessageRecord.istroop);
      ((MsgBackupMsgEntity)localObject2).msgType = arsc.a(paramMessageRecord.msgtype);
    ...
    if (paramMessageRecord.istroop == 3000)
    {
      ...
      paramMessageRecord = arpf.a(i);
      if (paramMessageRecord != null) {
        break label402;
      }
      paramMessageRecord = localMsg.toByteArray();
      arpf.a(paramMessageRecord);
    }
    label363:
    ...
    {
      return localObject2;
      i = awbk.b(paramMessageRecord.msgUid);
