...
public class boyk
{
  ...
  private boxm jdField_a_of_type_Boxm = new boxm();
  ...
  private void e(float paramFloat1, float paramFloat2)
  {
    ...
    this.jdField_a_of_type_Boxm.a(paramFloat1, paramFloat2);
  ...
  private void f()
  {
    ...
    this.jdField_a_of_type_Boxm.a(this.jdField_b_of_type_AndroidGraphicsRectF, a());
  }
  ...
  public boyh a(float paramFloat1, float paramFloat2)
  {
    RectF localRectF = this.jdField_a_of_type_Boxm.a(paramFloat1, paramFloat2);
    ...
    return new boyh(this.jdField_b_of_type_AndroidGraphicsRectF.centerX() - localRectF.centerX() + paramFloat1, this.jdField_b_of_type_AndroidGraphicsRectF.centerY() - localRectF.centerY() + paramFloat2, c(), b());
  }
  
  public boyh a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    this.jdField_a_of_type_Boxm.d(false);
    if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipConstant$Anchor != null)
    {
      this.jdField_a_of_type_Boxm.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipConstant$Anchor, paramFloat3, paramFloat4);
      ...
      RectF localRectF2 = this.jdField_a_of_type_Boxm.a(paramFloat1, paramFloat2);
      boyh localboyh = new boyh(paramFloat1, paramFloat2, c(), a());
      localboyh.a(boxl.b(localRectF2, localRectF1, this.jdField_b_of_type_AndroidGraphicsRectF.centerX(), this.jdField_b_of_type_AndroidGraphicsRectF.centerY()));
      return localboyh;
    }
    return null;
  }
  ...
  {
    if (this.jdField_a_of_type_Boxm.c()) {}
  ...
  {
    this.jdField_a_of_type_Boxm.a(paramCanvas);
  }
  ...
  public boolean a()
  {
    return this.jdField_a_of_type_Boxm.a();
  }
  ...
  public boolean a(float paramFloat1, float paramFloat2, boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Boxm.a(false);
      this.jdField_a_of_type_Boxm.b(true);
      this.jdField_a_of_type_Boxm.c(false);
      return paramBoolean;
    }
  }
  ...
  public boyh b(float paramFloat1, float paramFloat2)
  {
    return new boyh(paramFloat1, paramFloat2, c(), b());
  }
  ...
  public void b(float paramFloat1, float paramFloat2)
  {
    ...
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipConstant$Anchor = this.jdField_a_of_type_Boxm.a(paramFloat1, paramFloat2);
  }
  ...
  {
    this.jdField_a_of_type_Boxm.c(paramBoolean);
  }
  ...
  public boyh c(float paramFloat1, float paramFloat2)
  {
    boyh localboyh = new boyh(paramFloat1, paramFloat2, c(), a());
    RectF localRectF1 = new RectF(this.jdField_a_of_type_Boxm.a());
    localRectF1.offset(paramFloat1, paramFloat2);
    if (this.jdField_a_of_type_Boxm.d())
    {
      ...
      localboyh.a(boxl.a(localRectF1, localRectF2));
      return localboyh;
    }
    RectF localRectF2 = new RectF();
    if (this.jdField_a_of_type_Boxm.b())
    {
      ...
      this.jdField_a_of_type_AndroidGraphicsMatrix.mapRect(localRectF2, this.jdField_a_of_type_Boxm.a(paramFloat1, paramFloat2));
      localboyh.a(boxl.a(localRectF1, localRectF2, this.jdField_b_of_type_AndroidGraphicsRectF.centerX(), this.jdField_b_of_type_AndroidGraphicsRectF.centerY()));
      return localboyh;
    }
    this.jdField_a_of_type_AndroidGraphicsMatrix.setRotate(a(), this.jdField_b_of_type_AndroidGraphicsRectF.centerX(), this.jdField_b_of_type_AndroidGraphicsRectF.centerY());
    this.jdField_a_of_type_AndroidGraphicsMatrix.mapRect(localRectF2, this.jdField_a_of_type_AndroidGraphicsRectF);
    localboyh.a(boxl.b(localRectF1, localRectF2, this.jdField_b_of_type_AndroidGraphicsRectF.centerX(), this.jdField_b_of_type_AndroidGraphicsRectF.centerY()));
    return localboyh;
  }
  ...
  {
    this.jdField_a_of_type_Boxm.a(paramFloat);
  }
  ...
  public void d(float paramFloat1, float paramFloat2)
  {
    ...
    a();
    this.jdField_a_of_type_Boxm.d(true);
  }
