...
public class amyg
  implements bbnm
{
  public amyg(PublicAccountHandler paramPublicAccountHandler) {}
  ...
  public ReqItem a(int paramInt)
  {
    ...
    if (bool)
    {
      ...
      ((CertifiedAccountRead.StGetFollowListReq)localObject1).seq.set(bftf.a(l1));
      ((CertifiedAccountRead.StGetFollowListReq)localObject1).count.set(bftf.a(1L));
      ...
      localReqItem.vecParam = bgau.a((byte[])localObject1);
      return localReqItem;
    }
    ...
    localReqItem.vecParam = bgau.a(((mobileqq_mp.GetUserFollowListRequest)localObject1).toByteArray());
    return localReqItem;
  }
