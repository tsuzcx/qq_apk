  ...
  extends DynamicTextItem
{
  ...
  public bhmv(int paramInt, @NonNull List<String> paramList, Typeface paramTypeface1, Typeface paramTypeface2, Bitmap paramBitmap)
  {
  ...
  private void a(Typeface paramTypeface1, Typeface paramTypeface2)
  {
    ...
    this.jdField_c_of_type_Int = ((int)this.jdField_a_of_type_AndroidTextTextPaint.measureText(ajjy.a(2131640197)));
  ...
  public InputFilter a()
  {
    if (this.jdField_a_of_type_AndroidTextInputFilter == null) {
      this.jdField_a_of_type_AndroidTextInputFilter = new bhmx(this, 20);
    }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    paramString = super.a(paramInt, new bhmw(this)).split("\n");
  ...
  public void a(Canvas paramCanvas)
  {
    ...
    while (j < i1)
    {
      ...
      if (m < str.length())
      {
        ...
        int i3;
        int i2;
        if (bhnn.a(((String)localObject2).charAt(0)) == 3)
        {
