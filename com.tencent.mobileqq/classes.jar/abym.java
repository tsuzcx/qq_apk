...
{
  public abym(DeviceMsgSettingActivity paramDeviceMsgSettingActivity) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (!paramBoolean)
    {
      ...
      bjuh.a().a(this.a.getString(2131717937));
      return;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = (abyn)paramBundle.next();
        if (((abyn)localObject).a == j) {
          if (this.a.jdField_a_of_type_AndroidWidgetCompoundButton.isChecked())
          {
            paramInt = 1;
            ((abyn)localObject).b = paramInt;
          }
          else
          {
            paramInt = 0;
    ...
    achd.a(paramBundle, l, "Usr_MsgMgr_Setting", paramInt, 0, Integer.parseInt(this.a.b));
    return;
    label280:
    ...
    for (paramBoolean = bool2;; paramBoolean = false)
    {
      ...
      bjtx.a("DeviceMsgSettingActivity", "msg:" + paramBundle.optString("msg"));
      bjuh.a().a(this.a.getString(2131717937));
      return;
    }
  }
