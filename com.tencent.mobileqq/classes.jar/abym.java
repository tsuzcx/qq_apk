...
public class abym
  implements Runnable
{
  public abym(EmotionKeywordAdapter paramEmotionKeywordAdapter, EmoticonResp paramEmoticonResp, String paramString) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      ThreadManager.getUIHandler().post(new abyn(this, localArrayList));
      return;
    }
  }
}
