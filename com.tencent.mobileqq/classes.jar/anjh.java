...
{
  public anjh(MessageForQQWalletTips paramMessageForQQWalletTips, SoftReference paramSoftReference1, SoftReference paramSoftReference2, QQAppInterface paramQQAppInterface, Context paramContext, adiy paramadiy, agvz paramagvz, int paramInt) {}
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletTips.bytes_jumpurl))
      {
        ...
        paramView = bgwk.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletTips.bytes_jumpurl, MessageForQQWalletTips.access$100(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletTips, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), true);
        ahix.a(this.jdField_a_of_type_AndroidContentContext, paramView);
        return;
      }
      if ((MessageForQQWalletTips.access$200(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletTips) != 524288) || (this.jdField_a_of_type_Adiy == null) || (this.jdField_a_of_type_Agvz == null)) {
        break;
      }
      localObject2 = this.jdField_a_of_type_Agvz.a(MessageForQQWalletTips.access$300(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletTips));
      if ((localObject2 == null) || (((agvy)localObject2).a) || (((agvy)localObject2).b) || (((agvy)localObject2).a())) {
        break;
      }
      paramView = this.jdField_a_of_type_Agvz.a(((agvy)localObject2).e);
    } while (bbjw.a(paramView));
    this.jdField_a_of_type_Adiy.b(MessageForQQWalletTips.access$300(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletTips), paramView, ajyc.a(2131706588));
    return;
