  ...
  implements Manager
{
  ...
  private anmu jdField_a_of_type_Anmu = new anjj(this);
  ...
  static
  {
    ...
    jdField_a_of_type_ArrayOfInt = new int[] { 2130845882, 2130844919, 2130844919, 2130844919, 2130845640, 2130845640, 2130845900, 2130845900, 2130845424, 2130845424, 2130845424, 2130845882, 2130845882, 2130845701, 2130845882 };
  ...
  public anjh(QQAppInterface paramQQAppInterface)
  {
  ...
  public int a(int paramInt, boolean paramBoolean)
  {
    ...
    if (paramInt == 1)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        {
          bool = true;
          QLog.d("ConditionSearch.Manager", 2, bool + " | isNetAvaiable = " + bgnt.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()));
        }
      }
      else
      {
        ...
        localObject = ((beaw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(193)).a(this.jdField_a_of_type_JavaLangString);
        if (QLog.isColorLevel()) {
          QLog.d("ConditionSearch.Manager", 2, "update, find task=" + localObject);
        }
        if ((localObject != null) && ((localObject instanceof anjk))) {
          ((anjk)localObject).realStart();
        }
      }
    }
    label246:
    while (paramInt != 2)
    {
      ...
      if (!bgnt.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) {
        return 2;
      }
      ...
      for (paramBoolean = true;; paramBoolean = false)
      {
        ...
        localObject = (anjo)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(4);
        ((anjo)localObject).a(null, new GetResourceReqInfo[] { ((anjo)localObject).e() });
        return 0;
      }
    }
    label264:
  ...
  public List<BaseAddress> a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqConditionsearchDataAddressData != null)
    {
      ...
      Collections.sort(localArrayList, new anji(this));
    }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Anjm != null) {
      this.jdField_a_of_type_Anjm.a();
    }
  }
  ...
  public void a(anjm paramanjm)
  {
    this.jdField_a_of_type_Anjm = paramanjm;
  }
  ...
  public void a(GetResourceRespInfo paramGetResourceRespInfo)
  {
    ...
    do
    {
      ...
      paramGetResourceRespInfo = new anjk(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject, paramGetResourceRespInfo, localFile);
      ...
      bool = ((beaw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(193)).a(10023, "prd", (String)localObject, 0, (String)localObject, localFile.getAbsolutePath(), 2, 0, false, paramGetResourceRespInfo);
      if (QLog.isColorLevel()) {
  ...
  void a(boolean paramBoolean1, List<CondFitUser> paramList, boolean paramBoolean2, int paramInt)
  {
    ...
    if (this.jdField_b_of_type_JavaUtilLinkedList != null)
    {
      ...
      while (((Iterator)localObject).hasNext()) {
        ((anjn)((Iterator)localObject).next()).a(paramBoolean1, paramList, paramBoolean2, paramInt);
      }
    }
  }
  ...
  public String c(String paramString)
  {
    ...
    {
      String[] arrayOfString = bgsp.a(paramString, '-');
      str = paramString;
      if (arrayOfString.length >= 2)
      {
  ...
  {
    if ((paramObject instanceof anjl))
    {
    ...
    do
    {
      this.jdField_a_of_type_JavaUtilLinkedList.add((anjl)paramObject);
      do
      {
        return;
      } while (!(paramObject instanceof anjn));
      if (this.jdField_b_of_type_JavaUtilLinkedList == null) {
    ...
    this.jdField_b_of_type_JavaUtilLinkedList.add((anjn)paramObject);
  }
  ...
  public int d()
  {
    if (this.jdField_g_of_type_Boolean)
    {
      Card localCard = ((anmw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      if (localCard == null) {
        break label134;
      }
      if (localCard.shGender != 0) {
  ...
  public void d(Object paramObject)
  {
    ...
    while ((!(paramObject instanceof anjn)) || (this.jdField_b_of_type_JavaUtilLinkedList == null)) {
      return;
    }
