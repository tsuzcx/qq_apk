  ...
  implements BaseLayer.OnLayerTouchListener
{
  ...
  private anjh(DoodleLayout paramDoodleLayout) {}
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    ((AlphaAnimation)localObject).setAnimationListener(new anji(this));
    ...
    localAlphaAnimation.setAnimationListener(new anjj(this));
    if (paramBoolean2) {
