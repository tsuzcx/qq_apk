...
public class alrg
{
  ...
  public static int a(alqk paramalqk, int paramInt1, int paramInt2)
  {
    int i = paramInt2;
    if (paramInt2 == -1) {
      i = 0;
    }
    Camera.CameraInfo localCameraInfo = paramalqk.a()[paramInt1];
    if (localCameraInfo.facing == 1) {
      return (paramalqk.a().a(paramInt1, localCameraInfo.orientation) - i + 360) % 360;
    }
    return (paramalqk.a().a(paramInt1, localCameraInfo.orientation) + i) % 360;
  }
  ...
  public static Bitmap a(Bitmap paramBitmap)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.i("Q.camera.CameraUtils", 4, "clipBitmapToScreenRatio bmpWidth=" + j + " bmpHeight=" + i + " screenWidth=" + awmc.a + " screenHeight=" + awmc.b);
    }
    if (i < j) {
      return paramBitmap;
    }
    double d = awmc.b * 1.0D / awmc.a;
    if (d > i * 1.0D / j)
    {
      k = (int)(i / d);
      if (QLog.isColorLevel()) {
  ...
  public static boolean a()
  {
    ...
    for (;;)
    {
      ...
      awrn.a(BaseApplication.getContext()).a(null, "qcamera_choice_type", false, 0L, 0L, (HashMap)localObject, "");
  ...
  private static boolean a(SharedPreferences paramSharedPreferences, String paramString, int paramInt)
  {
    ...
    //   115: aload 6
    //   117: astore 5
    //   119: invokestatic 282	alrf:a	()Lalrf;
    //   122: invokevirtual 284	alrf:a	()Ljava/lang/String;
    //   125: astore 9
    //   127: aload 6
    //   129: astore 5
  ...
  {
    return Build.VERSION.SDK_INT >= alre.a().a();
  }
