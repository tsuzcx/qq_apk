...
public class mgc
  extends lef
{
  public mgc(MultiVideoCtrlLayerUI4NewGroupChat paramMultiVideoCtrlLayerUI4NewGroupChat) {}
  ...
  protected void a(long paramLong1, long paramLong2)
  {
    ...
    QLog.w(this.a.jdField_d_of_type_JavaLangString, 1, "onCreateRoomSuc, GroupID[" + paramLong2 + "], seq[" + paramLong1 + "], sessionId[" + ((lff)localObject).c + "]");
    if (this.a.jdField_e_of_type_Boolean) {}
    for (int i = 4;; i = 3)
    {
      mmi.a(i, this.a.jdField_a_of_type_ComTencentAvVideoController.d() + "");
      i = j;
      if (this.a.jdField_e_of_type_Boolean) {
        i = 4;
      }
      bdld.a(i, this.a.jdField_a_of_type_ComTencentAvVideoController.d() + "");
      this.a.x();
      this.a.q(paramLong1);
      this.a.jdField_a_of_type_Mud.c(true);
      this.a.jdField_a_of_type_Mud.b(true);
      this.a.jdField_a_of_type_Mud.a();
      ((lff)localObject).al = true;
      this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(this.a.b);
      if (((lff)localObject).ad != 4) {
        break;
      }
