...
public class amqr
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString, List<cmd0x777.AddFrdInfo> paramList)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (k > 0)
        {
          QQToast.a(BaseApplication.getContext(), 0, alud.a(2131701447), 0).a();
        ...
        for (;;)
        {
          ...
          QQToast.a(BaseApplication.getContext(), 0, alud.a(2131701450), 0).a();
          break label353;
          label465:
          break;
          label467:
        ...
        for (;;)
        {
          paramList = bdgm.a(paramActivity, String.format(Locale.getDefault(), alud.a(2131701454), new Object[] { paramList }), 0, 0, null, null);
          paramList.setPositiveButton(2131694953, new amqs());
          if ((paramActivity != null) && (!paramActivity.isFinishing())) {
            paramList.show();
          }
          azqs.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "frd_select", "notAdd_exp", 0, 0, paramString, String.valueOf(j), "", "");
          return;
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3)
  {
    ...
    bctz.a(paramQQAppInterface, true, localTroopInfo);
    ...
    if ((localObject1 != null) && (!((List)localObject1).isEmpty()))
    {
      ...
      i = 1;
      localObject1 = String.format(Locale.getDefault(), alud.a(2131701448), new Object[] { paramString3, Integer.valueOf(paramInt2) });
      if (paramInt2 != 1) {
        break label745;
      }
      paramString3 = String.format(Locale.getDefault(), alud.a(2131701451), new Object[] { paramString3 });
      paramInt2 = 1;
    }
    for (;;)
    {
      ...
      if (paramInt1 == 0)
      {
        paramString3 = paramString3 + alud.a(2131701455);
        localObject1 = alud.a(2131701452);
        i = paramString3.indexOf((String)localObject1);
        j = ((String)localObject1).length();
        localObject1 = new aspy(paramString1, paramString1, paramString3, 1, -5020, 135178, l2);
        ((aspy)localObject1).jdField_c_of_type_JavaLangString = paramString3;
        ...
        ((aspy)localObject1).a(i, i + j, paramString3);
        ...
        label348:
        ((aspy)localObject1).d = paramString3;
      ...
      {
        azqs.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "Grp_AIO", (String)localObject2, 0, 0, paramString1, (String)localObject1, "", paramString3);
        if (!QLog.isDevelopLevel()) {
          break;
        }
        ...
        break label108;
        label618:
        paramString3 = String.format(Locale.getDefault(), alud.a(2131701453), new Object[] { Integer.valueOf(paramInt2) });
        i = j;
        ...
        paramString3 = String.format(Locale.getDefault(), alud.a(2131701449), new Object[] { paramString2 });
        paramInt2 = 0;
        break label187;
        paramString3 = paramString3 + alud.a(2131701446);
        break label217;
        paramString3 = "";
        break label348;
      }
  ...
  private void b(FriendListHandler paramFriendListHandler)
  {
    ...
    alto localalto = (alto)paramFriendListHandler.app.getManager(51);
    ...
    for (boolean bool2 = true;; bool2 = bool1)
    {
      if (localAddFrdInfo.uint32_send_req_flag.get() == 1)
      {
        ...
        localalto.a(Long.toString(localAddFrdInfo.uint64_uin.get()), false);
        bool1 = bool2;
        break label90;
  ...
  public void a(FriendListHandler paramFriendListHandler)
  {
    ...
    for (;;)
    {
      ...
      Object localObject = (alto)paramFriendListHandler.app.getManager(51);
      ...
      if (i > 0)
      {
        ...
        if (i >= 0)
        {
          ...
          ((alto)localObject).a(Long.toString(l1), true);
          i -= 1;
        }
        else
        {
