  ...
  extends bfvb
{
  ...
  public String a;
  public URL a;
  public ConcurrentHashMap<String, bmjg> a;
  public int b;
  protected String b;
  public String c;
  public int d;
  ...
  public bfuw(String paramString)
  {
    b(paramString);
    a();
  ...
  public bfuw(JSONObject paramJSONObject)
  {
    a(paramJSONObject);
    this.jdField_d_of_type_JavaLangString = String.valueOf(hashCode());
  }
  ...
  public static String b()
  {
    ...
    {
      localVFSFile.mkdirs();
      FileUtils.createFileIfNotExits(TroopHWJsPlugin.jdField_a_of_type_JavaLangString + ".nomedia");
    }
  ...
  public bmjg a(String paramString1, String paramString2)
  {
    ...
    {
      paramString2 = new bmjg(wzk.a(), paramString1, paramString2);
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString1, paramString2);
      return paramString2;
    }
    return (bmjg)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString1);
  }
  
  public Stream<bfuw> a(XMediaEditor paramXMediaEditor)
  {
    this.g = 1;
    Object localObject2 = Stream.of(this).map(new ThreadOffFunction("ImageInfo", 2));
    Object localObject1 = localObject2;
    if (!FileUtil.fileExistsAndNotEmpty(this.jdField_c_of_type_JavaLangString)) {
      localObject1 = ((Stream)localObject2).map(new bfux(this.jdField_d_of_type_Int));
    }
    if (TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
      localObject1 = ((Stream)localObject1).map(new bfuy(0, paramXMediaEditor, paramXMediaEditor.a("troopuin")));
    }
    for (;;)
    {
      localObject2 = paramXMediaEditor.findViewHolderForLayoutPosition(this.jdField_c_of_type_Int);
      if ((localObject2 instanceof bfvx))
      {
        localObject2 = (bfvx)localObject2;
        if (this.jdField_d_of_type_JavaLangString.equals(((bfvx)localObject2).a.getTag())) {
          ((bfvt)((bfun)paramXMediaEditor.getAdapter()).a.a(1)).a((bfvx)localObject2, this, 0);
        }
      }
