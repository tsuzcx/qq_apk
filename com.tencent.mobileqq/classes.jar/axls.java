  ...
  implements Manager
{
  ...
  public ConcurrentHashMap<Integer, axlr> a;
  
  public axls(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Alxz = ((alxz)paramQQAppInterface.a(56));
  }
  ...
  private void a(long[] paramArrayOfLong, axlr paramaxlr, String paramString, boolean paramBoolean)
  {
    ThreadManager.post(new NumRedMsgManager.2(this, paramArrayOfLong, paramaxlr, paramBoolean, paramString), 5, null, false);
  }
  ...
  {
    boolean bool = bdhb.a(new File(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getFilesDir(), "NumRedMsgFileName_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).getAbsolutePath(), paramNumMsgRspBody.toByteArray(), false);
    if (bool) {
  ...
  public void a(NumRedMsg.NumMsgRspBody paramNumMsgRspBody, ToServiceMsg paramToServiceMsg, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      paramNumMsgRspBody = (axlr)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(i));
      if (paramNumMsgRspBody == null) {
        break;
      }
  ...
  public void a(List<Submsgtype0x89.NumRedBusiInfo> paramList, String paramString, axlr paramaxlr)
  {
    ThreadManager.post(new NumRedMsgManager.1(this, paramList, paramaxlr, paramString), 5, null, false);
  }
  
  public void a(long[] paramArrayOfLong, String paramString, axlr paramaxlr)
  {
    a(paramArrayOfLong, paramaxlr, paramString, false);
  }
