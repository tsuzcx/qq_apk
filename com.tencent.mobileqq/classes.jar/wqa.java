...
{
  public wqa(NotificationView paramNotificationView) {}
  ...
  protected void a(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    while (this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog == null) {
      ...
      catch (InvalidProtocolBufferMicroException paramBundle)
      {
        ...
        QQToast.a(this.a.jdField_a_of_type_AndroidContentContext, this.a.jdField_a_of_type_AndroidContentContext.getString(2131430306), 0).b(this.a.a());
        return;
      }
    }
    this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.dismiss();
