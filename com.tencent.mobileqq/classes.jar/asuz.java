...
public class asuz
{
  ...
  Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new asve(this);
  ...
  private boolean a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate((Context)localObject, 2131561126, null));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131368064));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131368068));
      continue;
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate((Context)localObject, 2131561148, null));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131368064));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131368065));
      continue;
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate((Context)localObject, 2131561147, null));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131368064));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131368065));
      continue;
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate((Context)localObject, 2131561135, null));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131368064));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131368069));
    }
  ...
  private void b(ArrayList<String> paramArrayList)
  {
    ...
    do
    {
      ...
      if (j > 0)
      {
        ...
        localObject = asmj.a(localQQAppInterface, (String)localObject);
      ...
      for (;;)
      {
        ...
        localObject = null;
        break label225;
        localImageView.setImageDrawable(bheg.a(true));
        localImageView.setVisibility(0);
        continue;
    ...
    if (localQQAppInterface != null) {
      asmj.a(localQQAppInterface, paramArrayList);
    }
  ...
  void b()
  {
    ...
    for (int i = AIOUtils.dp2px(2.0F, ((Context)localObject2).getResources());; i = AIOUtils.dp2px(1.0F, ((Context)localObject2).getResources()))
    {
      ...
      this.jdField_c_of_type_AndroidWidgetImageView.setBackgroundResource(2130845103);
      ...
      ((RelativeLayout.LayoutParams)localObject2).addRule(7, 2131368064);
      ((RelativeLayout.LayoutParams)localObject2).addRule(6, 2131368064);
      ...
      try
      {
        ...
        localObject1 = asmj.a((AppInterface)localObject1, (String)localObject2);
        ...
        ((ScaleAnimation)localObject1).setAnimationListener(new asva(this));
  ...
  void c()
  {
    ...
    int j = i - ((Context)localObject1).getResources().getDimensionPixelSize(2131298180);
    ...
    for (;;)
    {
      ...
      localObject3 = new asvc(this, (AnimatorSet)localObject1);
      ...
      if (this.jdField_a_of_type_JavaUtilList.size() > 1)
      {
        ...
        for (;;)
        {
          if (j < this.jdField_a_of_type_JavaUtilList.size() - 1)
          {
            ...
            j = ((Context)localObject1).getResources().getDimensionPixelSize(2131298191);
            i -= ((Context)localObject1).getResources().getDimensionPixelSize(2131298189);
            break;
          }
        }
