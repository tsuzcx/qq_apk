    ...
    for (;;)
    {
      try
      {
        ...
        if ("share".equals(paramJsBridgeListener.optString("type")))
        {
          ...
          bipi.a().a(paramJsBridgeListener, "", this.mRuntime.a().getAccount(), false);
        }
        paramJsBridgeListener = this.mRuntime.a(this.mRuntime.a());
        if ((paramJsBridgeListener == null) || (!(paramJsBridgeListener instanceof bhso))) {
          break label747;
        }
        paramString1 = (bhso)paramJsBridgeListener;
        if (QLog.isColorLevel()) {
          QLog.d("ShareApiPlugin", 2, "Share JS deal cost=" + (System.currentTimeMillis() - paramString1.getLoadShareJsTime()));
        }
        if (!(paramJsBridgeListener instanceof bhst)) {
          break label747;
        }
        paramJsBridgeListener = (bhst)paramJsBridgeListener;
        ...
        else if ((TextUtils.isEmpty(this.c)) || (TextUtils.isEmpty(this.b)) || (TextUtils.isEmpty(this.d)) || (TextUtils.isEmpty(this.a)) || (this.c.startsWith("http://")) || (this.c.startsWith("https://")))
        {
          ...
          paramString1 = new NewIntent(this.mRuntime.a().getApplication(), avqy.class);
          ...
          paramString1.setObserver(new abcy(this, paramJsBridgeListener));
