...
public class zze
  extends ajfo
{
  public zze(AssistantSettingActivity paramAssistantSettingActivity) {}
  ...
  {
    if ((paramBoolean) && (AssistantSettingActivity.a(this.a) != null) && (this.a.jdField_a_of_type_Aaaf != null) && (this.a.jdField_a_of_type_Aaaf.a(paramArrayOfShort)))
    {
  ...
  protected void onGetConnectionsSwitch(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    if (paramBoolean)
    {
      ...
      if (this.a.jdField_a_of_type_Afgd.c()) {
        break label81;
      }
    }
    label81:
  ...
  {
    boolean bool2 = true;
    if (this.a.jdField_a_of_type_Aaaf == null) {}
    for (affz localaffz = null; localaffz == null; localaffz = this.a.jdField_a_of_type_Aaaf.a(paramShort1)) {
      return;
    }
    if (com.tencent.TMG.utils.QLog.isColorLevel()) {
    ...
    if (paramShort2 == 1)
    {
      bool1 = true;
      label91:
      if ((paramBoolean) || (bool1 != localaffz.e)) {
        break label148;
      }
      if (localaffz.e) {
        break label150;
  ...
  protected void onSetConnectionsSwitch(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    if (!paramBoolean)
    {
      AssistantSettingActivity.a(this.a, 2131653546, 1);
      localAssistantSettingActivity = this.a;
      if (this.a.jdField_a_of_type_Afgd.c()) {
        break label95;
      }
  ...
  protected void onSetEmotionRecSwitch(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      AssistantSettingActivity.a(this.a, 2131653546, 1);
      AssistantSettingActivity.a(this.a, aemi.a(this.a.app).b(), AssistantSettingActivity.a(this.a));
      return;
    }
    ...
    {
      awqx.b(localQQAppInterface, "dc00898", "", "", "0X800A223", "0X800A223", 0, 0, str, "", "", "");
      return;
    }
  }
  ...
  protected void onSetPttAutoToTxtSwitch(boolean paramBoolean, Object paramObject)
  {
    if (!paramBoolean)
    {
      bbmy.a(BaseApplication.getContext(), 1, ajjy.a(2131634986), 0).b(this.a.getTitleBarHeight());
