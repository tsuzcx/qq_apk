...
{
  apio(FileManagerEntity paramFileManagerEntity, Activity paramActivity, boolean paramBoolean) {}
  ...
  public void onClick(View paramView)
  {
    ...
    {
      if ((bool1) && (!bbdj.b(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.getFilePath())))
      {
        bcpw.a(BaseApplicationImpl.getApplication(), 1, BaseApplicationImpl.getApplication().getString(2131720123), 0).b(BaseApplicationImpl.getApplication().getResources().getDimensionPixelSize(2131298865));
        return;
        axqw.b(paramView, "dc00898", "", "", "0X8009063", "0X8009063", 0, 0, "", "", "", "");
        break;
        label232:
      ...
      ayec.a(localTeamWorkFileImportInfo, this.jdField_a_of_type_AndroidAppActivity, paramView, localTeamWorkFileImportInfo.jdField_d_of_type_Int);
      return;
