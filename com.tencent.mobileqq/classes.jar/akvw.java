    ...
    if ((paramFile.exists()) && (paramFile.isDirectory()))
    {
      ...
      if (i < j)
      {
        ...
        for (;;)
        {
          ...
          {
            localObject2 = paramFile.getAbsolutePath() + "/" + akvt.a((String)localObject2);
            bbdx.c((String)localObject2 + "/.moveflag");
            akvt.a(((File)localObject1).getAbsolutePath(), (String)localObject2);
          }
        }
      }
    }
    paramFile = new File(ajsd.aW);
    if ((paramFile.exists()) && (paramFile.isDirectory()))
    {
      paramFile = akvt.a(paramFile);
      ...
      while (k < n)
      {
        ...
        if (arrayOfFile.isDirectory())
        {
          ...
          if (((String)localObject1).length() > 4)
          {
            ...
            {
              if (akvt.a(arrayOfFile).length > 0)
              {
                localObject2 = akvt.a(arrayOfFile);
                ...
                for (;;)
                {
                  ...
                  if (((File)localObject3).isDirectory())
                  {
                    ...
                    {
                      localObject3 = akvt.a((File)localObject3);
                      ...
                      while (i < j)
                      {
                        ...
                        {
                          bbdx.c(ThemeDiyStyleLogic.getSdcardDIYDir() + akvt.a((String)localObject1) + "/.moveflag");
                          bbdx.a(localObject4.getAbsolutePath(), ThemeDiyStyleLogic.getSdcardDIYDir() + akvt.a((String)localObject1) + "/" + localObject4.getName());
                        }
                        i += 1;
                      }
                      j = 1;
        ...
        if (j != 0) {
          bbdx.a(arrayOfFile.getAbsolutePath());
        }
        k += 1;
      }
    }
