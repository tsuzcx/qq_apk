  ...
  implements lze
{
  ...
  public String a;
  public Timer a;
  ljd jdField_a_of_type_Ljd = new lyz(this);
  lzb jdField_a_of_type_Lzb = new lzb(this);
  public lzd a;
  ...
  public lyy(SmallScreenService paramSmallScreenService)
  {
    ...
    this.jdField_a_of_type_Mbx = new lza(this);
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          break;
          localley = paramVideoController.a();
          i = localley.jdField_d_of_type_Int;
          if (QLog.isColorLevel()) {
        ...
        } while ((localley.jdField_j_of_type_Int == 1011) || (paramVideoController.f));
        ...
        if (localley.J)
        {
          ...
          localIntent.putExtra("sessionType", localley.jdField_d_of_type_Int);
          localIntent.putExtra("GroupId", localley.jdField_d_of_type_JavaLangString);
          localIntent.putExtra("uin", localley.jdField_d_of_type_JavaLangString);
        ...
        l = localley.jdField_g_of_type_Long;
        j = localley.F;
        if ((l == 0L) && (localley.a.jdField_b_of_type_Int <= 0)) {
          break label692;
        }
        if (localley.a.jdField_b_of_type_Int <= 0) {
          break label545;
        }
      } while ((localley.jdField_d_of_type_Int == 1) || (localley.a.jdField_a_of_type_Int == 1) || (localley.jdField_d_of_type_Int == 3) || (localley.a.jdField_a_of_type_Int == 3) || (!QLog.isColorLevel()));
      ...
      paramVideoController.putExtra("uinType", mue.c(j));
      paramVideoController.putExtra("isDoubleVideoMeeting", localley.J);
      paramVideoController.putExtra("MultiAVType", localley.D);
      ...
      if (QLog.isColorLevel())
      {
        ...
        continue;
        label692:
        if ((paramVideoController.d()) && (localley.i()))
        {
          paramVideoController = new Intent(paramContext, VideoInviteActivity.class);
          paramVideoController.addFlags(268435456);
          paramVideoController.putExtra("uinType", localley.jdField_j_of_type_Int);
          paramVideoController.putExtra("peerUin", localley.jdField_d_of_type_JavaLangString);
          paramVideoController.putExtra("extraUin", localley.jdField_f_of_type_JavaLangString);
          if (localley.jdField_f_of_type_Int == 1) {}
          for (;;)
          {
  ...
  {
    RedPacketGameSmallScreenView localRedPacketGameSmallScreenView = (RedPacketGameSmallScreenView)paramViewGroup.findViewById(2131373454);
  ...
  private void b(int paramInt)
  {
    ...
    if (AudioHelper.f())
    {
      ...
      if (this.jdField_a_of_type_Lzd == null) {
        break label96;
      }
    }
    label96:
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((this.jdField_a_of_type_Lzd != null) && (paramInt != this.jdField_a_of_type_Lzd.f())) {
        break;
      }
      return;
    }
    ...
    this.jdField_a_of_type_Lzd.g(paramInt);
  ...
  public void a(long paramLong)
  {
    ...
    for (Object localObject = null;; localObject = this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService.a(1))
    {
      if (localObject != null)
      {
        View localView = ((SmallScreenRelativeLayout)localObject).findViewById(2131376234);
        if (localView != null) {
          localView.findViewById(2131376238).clearAnimation();
        }
      }
      if (this.jdField_a_of_type_JavaUtilTimer != null)
      {
  ...
  {
    lbc.c("SmallScreenVideoController", "notifyEvent :" + paramInteger + "|" + paramObject1 + "|" + paramObject2);
  ...
  void a(boolean paramBoolean)
  {
    ...
    if ((localObject != null) && (QLog.isColorLevel())) {
      QLog.d("SmallScreenVideoController", 2, "onCreateUI SessionType = " + ((ley)localObject).jdField_d_of_type_Int);
    }
    this.jdField_a_of_type_AndroidGraphicsBitmap = mue.a(this.jdField_a_of_type_AndroidContentContext, 2130841915);
    if (this.jdField_a_of_type_ComTencentAvCameraCameraUtils == null)
    {
    ...
    View localView = this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService.a(1).findViewById(2131363079);
    if (this.jdField_a_of_type_Lzd == null)
    {
      this.jdField_a_of_type_Lzd = new lzd(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService, localView, this);
    ...
    for (;;)
    {
      if ((this.jdField_a_of_type_ComTencentAvVideoController.f) && (this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI == null)) {
        this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI = new lym(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService, this.jdField_a_of_type_Mbx);
      }
      if (this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI != null) {
        this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI.a(paramBoolean);
      }
      if ((localObject != null) && (((ley)localObject).jdField_g_of_type_Int != 4) && (this.jdField_c_of_type_Int == 1) && (!this.jdField_a_of_type_Boolean))
      {
        int i = bhjt.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getAccount(), 6, true, null);
        if (i > 0)
        {
          int j = bhjt.a();
          localObject = bhjt.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, i, j, null);
          if (localObject != null)
          {
            localObject = new File((String)localObject);
            if ((localObject != null) && (((File)localObject).exists()) && (this.jdField_a_of_type_Lzd != null)) {
              this.jdField_a_of_type_Lzd.w();
            }
          }
        }
      }
      return;
      this.jdField_a_of_type_Lzd.c();
      break;
      if (this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI == null) {
        if (this.jdField_d_of_type_Boolean)
        {
          this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI = new SmallScreenMultiVideoControlUI(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService, this.jdField_a_of_type_Mbx);
          if (localObject != null)
          {
            this.jdField_c_of_type_Int = ((ley)localObject).jdField_d_of_type_Int;
            this.jdField_d_of_type_Int = ((ley)localObject).jdField_f_of_type_Int;
          }
        }
        else
        {
          ...
          else
          {
            ...
            if (this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI == null) {
              ...
              else
              {
                this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI = new SmallScreenMultiVideoControlUI(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService, this.jdField_a_of_type_Mbx);
                continue;
                if ((localObject != null) && (((ley)localObject).a.jdField_b_of_type_Int > 0))
                {
                  if (((ley)localObject).a.jdField_a_of_type_Int == 3) {
                    this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI = new SmallScreenMultiVideoControlUI(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService, this.jdField_a_of_type_Mbx);
                  } else {
                    this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI = new lym(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService, this.jdField_a_of_type_Mbx);
                  }
                }
                else if ((localObject != null) && (((ley)localObject).jdField_e_of_type_Boolean) && ((((ley)localObject).jdField_g_of_type_Int == 1) || (((ley)localObject).jdField_g_of_type_Int == 2))) {
                  this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI = new lym(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService, this.jdField_a_of_type_Mbx);
                }
              }
            }
  ...
  public boolean a(int paramInt)
  {
    ...
    while ((this.jdField_a_of_type_Int == paramInt) || (this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI == null) || (!(this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI instanceof lym))) {
      return false;
    }
    if (!this.jdField_a_of_type_ComTencentAvVideoController.a().k)
    {
      lbc.e("SmallScreenVideoController", "Remote not has video, nOff=" + paramInt);
      return false;
    }
    ...
    {
      return true;
      this.jdField_a_of_type_Lzd.n();
      this.jdField_a_of_type_ComTencentAvVideoController.a(0);
      continue;
      this.jdField_a_of_type_Lzd.m();
      this.jdField_a_of_type_ComTencentAvVideoController.a(0);
      continue;
      this.jdField_a_of_type_Lzd.n();
  ...
  public void d()
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService == null)
    {
      ...
      label18:
      if ((!this.jdField_b_of_type_Boolean) || (locallyt == null) || (!locallyt.b()) || (localSmallScreenRelativeLayout == null) || (localSmallScreenRelativeLayout.getVisibility() == 8)) {
        break label78;
      }
    ...
    {
      return;
      locallyt = this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService.a(1);
      break;
  ...
  public void f()
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvVideoController.a().jdField_d_of_type_Int == 2) {
      if (this.jdField_a_of_type_ComTencentAvVideoController.a().l())
      {
        ...
        this.jdField_a_of_type_Lzd.a((String)localObject, 1, bool1, false, this.jdField_a_of_type_ComTencentAvVideoController.b(this.jdField_a_of_type_JavaLangString));
        if ((this.jdField_a_of_type_ComTencentAvVideoController.a().jdField_j_of_type_Boolean) && (!this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.c()))
        {
          ...
          this.jdField_a_of_type_Lzd.a(true, false);
          this.jdField_a_of_type_Lzd.c(l2, this.jdField_a_of_type_ComTencentAvCameraCameraUtils.a());
        }
      }
    }
    ...
    {
      lnn locallnn = (lnn)((ArrayList)localObject).get(i);
      str = String.valueOf(locallnn.jdField_a_of_type_Long);
      j = locallnn.jdField_a_of_type_Int;
      bool2 = locallnn.jdField_a_of_type_Boolean;
      bool3 = locallnn.jdField_b_of_type_Boolean;
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      if ((!str.equals(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin())) && (bool3)) {
        this.jdField_a_of_type_Lzd.a(str, j, bool3, bool2, bool1);
      }
      i += 1;
      break label422;
      break;
  ...
  void j()
  {
    if (this.jdField_a_of_type_Mbh == null) {
      this.jdField_a_of_type_Mbh = new lzc(this, this.jdField_a_of_type_AndroidContentContext, 2);
    }
  }
