  ...
  extends azjg
{
  ...
  private long a(long paramLong)
  {
    ...
    if (paramLong == 0L)
    {
      ...
      {
        azjq.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "calcFlowConsume", "picSize==0,fix by pisSizeAvg");
        l1 = paramLong;
      }
    }
    return l1;
  ...
  private void a(int paramInt, long paramLong1, long paramLong2, boolean paramBoolean)
  {
    if (paramInt == 1)
    {
      ...
      for (paramLong1 = 0L;; paramLong1 = this.A)
      {
        ...
        paramLong2 = this.z;
        paramLong1 = this.A;
        azkc.a("4gFlowPre", this.z, false);
        azkc.a("4gFlowWaste", this.A, paramBoolean);
        if (QLog.isColorLevel()) {
          azjq.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "updateFlow", "networkType=" + paramInt + ", preFlowPre=" + l2 + " preFlowWaste=" + l1 + "flowPre=" + paramLong2 + ", flowWaste:" + paramLong1);
        }
        return;
        paramLong1 = this.z;
        break;
    ...
    for (paramLong1 = 0L;; paramLong1 = this.C)
    {
      ...
      paramLong2 = this.B;
      paramLong1 = this.C;
      azkc.a("xgFlowPre", this.B, false);
      azkc.a("xgFlowWaste", this.C, paramBoolean);
      break;
      paramLong1 = this.B;
      break label270;
      paramLong1 = this.B;
  ...
  {
    this.jdField_a_of_type_Azkk.a(paramInt1, paramInt2, paramMessageForPic.mNotPredownloadReason);
    paramMessageForPic.preDownState = 2;
    a(paramMessageForPic);
    if (paramInt1 == 0)
    {
      this.K += 1L;
      azkc.a("wifiHitCount", this.K, true);
      if (QLog.isColorLevel()) {
        azjq.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payHit", "networkType:" + paramInt1 + ",wifiHitCount:" + this.K + ",uniseq:" + paramMessageForPic.uniseq);
      }
    }
    do
    {
      ...
      this.G += 1L;
      this.E -= paramLong;
      azkc.a("accFlowWasteTotal", this.E, false);
      azkc.a("xgHitCount", this.G, true);
    } while (!QLog.isColorLevel());
    azjq.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payHit", "networkType:" + paramInt1 + ",xgHitCount:" + this.G + ",uniseq:" + paramMessageForPic.uniseq);
    azjq.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payHit", "accFlowPreTotal:" + this.D + ",accFlowWasteTotal:" + this.E);
  }
  ...
  private void b(MessageForPic paramMessageForPic, long paramLong, int paramInt1, int paramInt2)
  {
    if (this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      if (localPicPreDownloader != null)
      {
        ...
        this.jdField_a_of_type_Azkk.e(paramInt1, i1);
        this.jdField_a_of_type_Azkk.a(paramInt1, i1);
        this.jdField_a_of_type_Azkk.c(paramInt1, paramInt2);
      }
    }
    ...
    {
      this.L += 1L;
      azkc.a("wifiMissCount", this.L, true);
      azjq.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payMiss", "networkType:" + paramInt1 + ",wifiMissCount:" + this.L + ",uniseq:" + paramMessageForPic.uniseq);
    }
    label164:
    do
    {
      return;
      this.jdField_a_of_type_Azkk.a(paramMessageForPic.preDownNetworkType, paramMessageForPic.mNotPredownloadReason);
      ...
      this.H += 1L;
      azkc.a("xgMissCount", this.H, true);
    } while (!QLog.isColorLevel());
    azjq.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payMiss", "networkType:" + paramInt1 + ", xgMissCount:" + this.H + ", uniseq:" + paramMessageForPic.uniseq);
  }
  ...
  private void c(MessageForPic paramMessageForPic, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 == 0) {
      if (QLog.isColorLevel()) {
        azjq.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payLeftRight", "networkType:" + paramInt1 + ",wifiHitCount:" + this.K + ",uniseq:" + paramMessageForPic.uniseq);
      }
    }
    do
    {
    ...
    azjq.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payLeftRight", "networkType:" + paramInt1 + ",xgHitCount:" + this.G + ",uniseq:" + paramMessageForPic.uniseq);
  }
  
  private void d(MessageForPic paramMessageForPic, long paramLong, int paramInt1, int paramInt2)
  {
    this.jdField_a_of_type_Azkk.d(paramInt1, paramInt2);
    paramMessageForPic.preDownState = 6;
    a(paramMessageForPic);
    if (paramInt1 == 0) {
      if (QLog.isColorLevel()) {
        azjq.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payNotSupport", "networkType:" + paramInt1 + ",wifiHitCount:" + this.K + ",uniseq:" + paramMessageForPic.uniseq);
      }
    }
    do
    {
    ...
    azjq.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payNotSupport", "networkType:" + paramInt1 + ",xgHitCount:" + this.G + ", uniseq:" + paramMessageForPic.uniseq);
  }
  ...
  private void f()
  {
    try
    {
      if (this.jdField_a_of_type_Azjl == null) {
  ...
  private void g()
  {
    this.z = azkc.a("4gFlowPre", this.r);
    this.A = azkc.a("4gFlowWaste", 0L);
    this.B = azkc.a("xgFlowPre", this.x);
    this.C = azkc.a("xgFlowWaste", 0L);
    this.K = azkc.a("wifiHitCount", this.K);
    this.L = azkc.a("wifiMissCount", this.L);
    this.M = azkc.a("wifiManualClickCount", this.M);
    this.J = azkc.a("wifiPreDownCount", this.J);
    this.G = azkc.a("xgHitCount", this.G);
    this.H = azkc.a("xgMissCount", this.H);
    this.I = azkc.a("xgManualClickCount", this.I);
    this.F = azkc.a("xgPreDownCount", this.F);
    this.D = azkc.a("accFlowPreTotal", this.D);
    this.E = azkc.a("accFlowWasteTotal", this.E);
    this.N = azkc.a("requestListOverLimitCount", this.N);
    if (QLog.isColorLevel()) {
  ...
  private void h()
  {
    Object localObject1 = azkc.a("flowCombination", "12000|600|20000|400|6000|300|20000|200");
    if (QLog.isColorLevel()) {
    ...
    else
    {
      ...
      this.t = azkc.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "AMaxPDFlow3G", 614400L);
      this.u = azkc.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "AMaxWFlow3G", 716800L);
      this.v = 0L;
      this.w = 0L;
      this.n = this.t;
      this.p = 0L;
      ...
      localObject1 = azkc.a("troopCombination", "20|10|50|10");
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_JavaLangLong = Long.valueOf(azkc.a("maxRequest", 100L));
      this.h = azkc.a("xGPreDownPolicy", 1374942199L);
      this.i = azkc.a("AFBFlowHitXG", 150L);
      this.j = azkc.a("AFBFlowMissXG", 40960L);
      this.k = this.j;
      this.l = azkc.a("APicAvgSize", 71680L);
      this.m = azkc.a("APicMaxSize", 204800L);
      this.jdField_b_of_type_Boolean = azkc.a("enablePeakFlow", Boolean.valueOf(false)).booleanValue();
      this.jdField_a_of_type_ArrayOfLong = azkc.a();
      this.S = azkc.a("PeakFlowMaxPicSize", 921600L);
      if (QLog.isColorLevel())
      {
  ...
  public int a(long paramLong, int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3)
  {
    ...
    if (azjl.a(null, paramBoolean, paramInt3))
    {
      if (this.jdField_a_of_type_Azjl == null) {
        f();
      }
      if (paramInt2 == 0) {}
      for (paramBoolean = true; this.jdField_a_of_type_Azjl.a(paramBoolean, paramLong); paramBoolean = false) {
        return -11;
      }
      return 2;
    }
    ...
    boolean bool = a();
    if (QLog.isColorLevel()) {
      azjq.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "isOverLimit()", "NetworkType:" + paramInt2 + " isInDPCWhiteList:" + bool);
    }
    if (paramInt2 == 0)
    {
      paramInt1 = paramInt3;
      if (QLog.isColorLevel())
      {
        azjq.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "isOverLimit()", "Wifi, result=" + 0);
        paramInt1 = paramInt3;
      }
    }
    for (;;)
    {
      ...
      if (QLog.isColorLevel())
      {
        azjq.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "isOverLimit()", "InDPCWhiteList, result=" + 0);
        paramInt1 = paramInt3;
      }
    }
    long l3 = a(paramLong);
    ...
    {
      if (QLog.isColorLevel()) {
        azjq.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "isOverLimit", "result:" + paramInt3 + ",FlowWaste +picSize=" + (l2 + l3) + ",FlowWasteLimit：" + paramLong + ",FlowPre:" + l1 + ",picSize:" + l3 + ",FlowWaste:" + l2 + ",uinType:" + paramInt1 + ",networkType:" + paramInt2 + ",isDynamic:" + paramBoolean);
      }
      paramInt1 = paramInt3;
      break;
      paramLong = this.u;
  ...
  public HashMap<String, String> a()
  {
    ...
    long l1 = azkc.a("4gFlowPre", this.z);
    long l2 = azkc.a("4gFlowWaste", this.A);
    long l3 = azkc.a("xgFlowPre", this.B);
    long l4 = azkc.a("xgFlowWaste", this.C);
    long l5 = azkc.a("accFlowPreTotal", this.D);
    long l6 = azkc.a("xgPreDownCount", this.F);
    long l7 = azkc.a("xgHitCount", this.G);
    long l8 = azkc.a("xgMissCount", this.H);
    long l9 = azkc.a("wifiPreDownCount", this.J);
    long l10 = azkc.a("wifiHitCount", this.K);
    long l11 = azkc.a("wifiMissCount", this.L);
    long l12 = azkc.a("xgManualClickCount", this.I);
    long l13 = azkc.a("wifiManualClickCount", this.M);
    long l14 = azkc.a("requestListOverLimitCount", this.N);
    if (QLog.isColorLevel()) {
      azjq.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "getReportInfo", "\n|- sp4gFlowPre:" + l1 + "\n|- sp4gFlowWaste:" + l2 + "\n|- spXgFlowPre:" + l3 + "\n|-  spXgFlowWaste：" + l4 + "\n|-  spFlowPreTotal:" + l5 + "\n|-  spXgPreDownCount：" + l6 + "\n|-  spXgHitCount:" + l7 + "\n|-  spXgMissCount：" + l8 + "\n|-  spWifiPreDownCount:" + l9 + "\n|-  spWifiHitCount：" + l10 + "\n|-  spWifiMissCount:" + l11 + "\n|-  spXgManulClickCount：" + l12 + "\n|-  spWifiManulClickCount:" + l13 + "\n|-  spRequestOverLimitCount:" + l14);
    }
  ...
  public void a(long paramLong, int paramInt)
  {
    ...
    {
      this.J += 1L;
      azkc.a("wifiPreDownCount", this.J, true);
    }
    do
    {
      return;
      ...
      this.E += paramLong;
      this.F += 1L;
      azkc.a("accFlowPreTotal", this.D, false);
      azkc.a("accFlowWasteTotal", this.E, false);
      azkc.a("xgPreDownCount", this.F, true);
    } while (!QLog.isColorLevel());
    azjq.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "calcFlowConsume", "networkType:" + paramInt + ",wifiPreDownCount:" + this.J + ",xgPreDownCount:" + this.F);
    azjq.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "calcFlowConsume", "accFlowPreTotal:" + this.D + ",accFlowWasteTotal:" + this.E);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Azkk = ((azkk)this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.PICTURE_STATISTICS_MANAGER));
    this.jdField_a_of_type_Aohl = ((aohl)this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getCacheManager().getCache(3));
    f();
    h();
    g();
    long l1 = System.currentTimeMillis();
    if (l1 - azkc.a("lastDayTime", 0L) > 86400000L)
    {
      String str = paramQQAppInterface.getCurrentAccountUin();
      azkc.a("lastDayTime", l1, true);
      azkd.a(str, a());
      e();
      ((azkk)paramQQAppInterface.getManager(QQManagerFactory.PICTURE_STATISTICS_MANAGER)).a();
    }
    if (QLog.isColorLevel()) {
      azjq.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "init", "");
    }
  }
  
  public void a(MessageForPic paramMessageForPic)
  {
    azkc.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageForPic);
  }
  ...
  public void a(MessageForPic paramMessageForPic, long paramLong)
  {
    ...
    do
    {
      ...
      this.E -= paramLong;
      azkc.a("accFlowPreTotal", this.D, false);
      azkc.a("accFlowWasteTotal", this.E, true);
    } while (!QLog.isColorLevel());
    azjq.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "fixPicSizeAfter", "accFlowPreTotal:" + this.D + ",accFlowWasteTotal:" + this.E);
  }
  ...
  public void a(String paramString)
  {
    ...
    do
    {
      ...
      return;
      localTroopStatisticsInfo = this.jdField_a_of_type_Aohl.a(paramString);
    ...
    {
      this.jdField_a_of_type_Aohl.addCache(paramString);
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  {
    if (azkc.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageForPic.istroop, paramMessageForPic.frienduin) != 0) {}
    label346:
    for (;;)
    {
      return true;
  ...
  public boolean a(String paramString)
  {
    ...
    do
    {
      ...
      QLog.d("PIC_TAG_PRELOAD_TROOP", 2, "DPC has not been initialized");
      return true;
      paramString = this.jdField_a_of_type_Aohl.a(paramString);
  ...
  public boolean[] a(int paramInt1, int paramInt2)
  {
    ...
    if ((a()) && (paramInt2 != 3))
    {
      i2 = azkc.a(0, paramInt1, 0);
      i1 = azkc.a(0, paramInt1, 1);
      if ((this.h >> i2 & 1L) != 1L) {
        break label172;
      }
      bool1 = true;
    ...
    {
      if (QLog.isColorLevel()) {
        azjq.a("PIC_TAG_PRELOAD", "isPreDownload", "netWorkType:" + paramInt2 + ",uinType:" + paramInt1 + ",preDownThumb:" + bool1 + ",preDownBig:" + bool2 + ",xGPreDownPolicy:" + this.h);
      }
      return new boolean[] { bool1, bool2 };
      i2 = azkc.a(paramInt2, paramInt1, 0);
      i1 = azkc.a(paramInt2, paramInt1, 1);
      break;
      bool1 = false;
      break label44;
    }
  ...
  public void b(MessageForPic paramMessageForPic, long paramLong)
  {
    ...
    do
    {
      ...
      {
        return;
      } while ((paramMessageForPic.isSendFromLocal()) || (paramMessageForPic.subVersion < 5) || (azjl.a(paramMessageForPic)));
      i1 = azkc.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageForPic.istroop, paramMessageForPic.frienduin);
  ...
  public void b(String paramString)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (this.jdField_a_of_type_Aohl == null);
      if (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) {
        break;
      }
    } while (!QLog.isColorLevel());
    QLog.d("PIC_TAG_PRELOAD_TROOP", 2, "DPC has not been initialized");
    return;
    TroopStatisticsInfo localTroopStatisticsInfo = this.jdField_a_of_type_Aohl.a(paramString);
    long l1;
    if (localTroopStatisticsInfo != null)
    {
    ...
    for (paramString = localTroopStatisticsInfo;; paramString = localTroopStatisticsInfo)
    {
      this.jdField_a_of_type_Aohl.updateCache(paramString);
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  public void e()
  {
    ...
    this.I = 0L;
    this.F = 0L;
    azkc.a("requestListOverLimitCount", this.N, false);
    azkc.a("wifiHitCount", this.K, false);
    azkc.a("wifiMissCount", this.L, false);
    azkc.a("wifiManualClickCount", this.M, false);
    azkc.a("wifiPreDownCount", this.J, false);
    azkc.a("4gFlowWaste", this.A, false);
    azkc.a("xgFlowWaste", this.C, false);
    azkc.a("xgHitCount", this.G, false);
    azkc.a("xgMissCount", this.H, false);
    azkc.a("xgManualClickCount", this.I, false);
    azkc.a("xgPreDownCount", this.F, true);
  }
}
