  ...
  implements Handler.Callback
{
  ...
  Comparator<lkv> jdField_a_of_type_JavaUtilComparator = new lku(this);
  private final ConcurrentHashMap<ChatRoomInfo, ConcurrentLinkedQueue<lkv>> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  private final ConcurrentLinkedQueue<lkw> b = new ConcurrentLinkedQueue();
  ...
  {
    Object localObject1 = ldc.a().a();
    int i = ((lgf)localObject1).d();
    long l5 = ((lgf)localObject1).a();
    long l3 = ((lgf)localObject1).b();
    long l4 = ((lgf)localObject1).e();
    long l2 = l4;
    long l1 = l3;
    Object localObject2;
    if (i == paramRoomKey.type.get())
    {
      ...
      if (l5 == paramRoomKey.id.get())
      {
        ...
        if (localObject2 != null) {
          ((VideoController)localObject2).a("pushMsg", (lgf)localObject1);
        }
        l1 = ((lgf)localObject1).b();
        l2 = ((lgf)localObject1).e();
      }
    }
    if ((i == paramRoomKey.type.get()) && (l5 == paramRoomKey.id.get()) && (l1 == paramRoomKey.room_id.get()) && (l2 == paramRoomKey.create_ts.get())) {}
    for (localObject1 = a((lgf)localObject1);; localObject1 = null)
    {
  ...
  private ConcurrentLinkedQueue<lkv> a(ChatRoomInfo paramChatRoomInfo)
  {
  ...
  private void a(lkv paramlkv)
  {
    if ((paramlkv == null) || (paramlkv.jdField_a_of_type_ComTencentAvChatroomChatRoomInfo == null)) {}
    ChatRoomInfo localChatRoomInfo;
    do
    {
      return;
      localChatRoomInfo = paramlkv.jdField_a_of_type_ComTencentAvChatroomChatRoomInfo;
      long l1 = 0L;
      try
      {
      ...
      l2 = AudioHelper.b();
      if (QLog.isColorLevel()) {
        QLog.i("ChatRoomMng", 2, "sendMsg, seq[" + l2 + "], room[" + localChatRoomInfo + "], msg[" + paramlkv + "]");
      }
      paramlkv.a();
      ...
      localMsg.msg.set(paramlkv.jdField_a_of_type_JavaLangString);
      localMsg.uin.set(l1);
      ...
      localObject = new NewIntent(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApplication(), lee.class);
      ...
      ((NewIntent)localObject).putExtra("localSeq", paramlkv.jdField_b_of_type_Long);
      mtm.a((Intent)localObject, l2);
      this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.startServlet((NewIntent)localObject);
    } while (paramlkv.e != lkv.jdField_a_of_type_Int);
    a(1, localChatRoomInfo);
  }
  
  private void b(lkv paramlkv)
  {
    if (!this.jdField_a_of_type_AndroidOsHandler.hasMessages(2, paramlkv))
    {
      Message localMessage = Message.obtain();
      localMessage.what = 2;
      localMessage.obj = paramlkv;
      this.jdField_a_of_type_AndroidOsHandler.sendMessage(localMessage);
    }
  }
  ...
  public ChatRoomInfo a(lgf paramlgf)
  {
    ChatRoomInfo localChatRoomInfo = a(paramlgf, true);
    Object localObject;
    ...
    for (;;)
    {
      ...
      if ((QLog.isDevelopLevel()) && (paramlgf != null)) {
        QLog.i("ChatRoomMng", 4, "enterChatRoom, SessionType[" + paramlgf.jdField_d_of_type_Int + "], relationType[" + paramlgf.E + "], relationId[" + paramlgf.g + "], peerUin[" + paramlgf.jdField_d_of_type_JavaLangString + "], extraUin[" + paramlgf.f + "], isDoubleVideoMeeting[" + paramlgf.I + "], room[" + localChatRoomInfo + "]");
      }
      return localChatRoomInfo;
      label189:
  ...
  public ChatRoomInfo a(lgf paramlgf, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (localChatRoomInfo2 == null)
      {
        ...
        if (paramBoolean)
        {
          ...
          {
            QLog.i("ChatRoomMng", 4, "getRoomInfo, SessionType[" + paramlgf.jdField_d_of_type_Int + "], relationType[" + paramlgf.E + "], relationId[" + paramlgf.g + "], peerUin[" + paramlgf.jdField_d_of_type_JavaLangString + "], extraUin[" + paramlgf.f + "], isDoubleVideoMeeting[" + paramlgf.I + "], type[" + i + "], roomID[" + l2 + "], id[" + l5 + "], createTime[" + l1 + "], room[" + localChatRoomInfo1 + "]");
            localObject = localChatRoomInfo1;
          }
        }
      }
  ...
  public lkv a(ChatRoomInfo paramChatRoomInfo, long paramLong)
  {
    if (paramChatRoomInfo == null) {
      return null;
    }
    ...
    if ((paramChatRoomInfo != null) && (paramChatRoomInfo.size() > 0))
    {
      ...
      do
      {
        ...
        paramChatRoomInfo = (lkv)localIterator.next();
          ...
          do
          {
            do
            {
              do
              {
                ...
                for (;;)
                {
                  ...
                  catch (InvalidProtocolBufferMicroException paramArrayOfByte)
                  {
                    try
                    {
                      ...
                      ((lkv)localObject2).a(lkv.jdField_b_of_type_Int);
                      b((lkv)localObject2);
                      if (!((lkv)localObject2).b()) {
                        break;
                      }
                ...
                ((lkv)localObject2).jdField_d_of_type_Long = l1;
                ((lkv)localObject2).a(lkv.jdField_c_of_type_Int);
                b((lkv)localObject2);
              ...
              } while ((((ChatRoomInfo)localObject1).jdField_b_of_type_Boolean) || (TextUtils.isEmpty(((lkv)localObject2).jdField_a_of_type_JavaLangString)) || (((lkv)localObject2).jdField_a_of_type_JavaLangString.indexOf('\024') < 0));
              lkx.a("0X800A8D5");
  ...
  public void a(VideoController paramVideoController, lgf paramlgf)
  {
    ChatRoomInfo localChatRoomInfo2 = a(paramlgf, false);
    boolean bool = paramVideoController.a("onSwitchTerminalSuccess", paramlgf);
    ChatRoomInfo localChatRoomInfo1 = a(paramlgf, false);
    paramVideoController = localChatRoomInfo1;
    if (localChatRoomInfo1 == null) {
      paramVideoController = a(paramlgf);
    }
    if (paramVideoController != null)
    {
      ...
      paramlgf = Message.obtain();
      paramlgf.obj = paramVideoController;
      paramlgf.what = 3;
      this.jdField_a_of_type_AndroidOsHandler.sendMessage(paramlgf);
    }
    if (QLog.isColorLevel()) {
  ...
  public void a(ChatRoomInfo paramChatRoomInfo, String paramString, long paramLong)
  {
    ...
    paramString = new lkv(paramChatRoomInfo, l1, paramString, paramLong, -9223372036854775808L, lkv.jdField_a_of_type_Int);
    a(paramChatRoomInfo).add(paramString);
    a(paramString);
  }
  
  public void a(ChatRoomInfo paramChatRoomInfo, List<lkv> paramList)
  {
  ...
  public void a(ChatRoomInfo paramChatRoomInfo, chatroom_sso.Msg paramMsg, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      if (localIterator.hasNext())
      {
        locallkv = (lkv)localIterator.next();
        if (locallkv != null) {
          if (locallkv.a(paramMsg))
          {
            bool = true;
            locallkv.jdField_c_of_type_Long = paramMsg.msg_time.get();
            locallkv.a(lkv.jdField_d_of_type_Int);
          }
        }
      }
    }
    for (;;)
    {
      ...
      {
        bool = true;
        ((lkv)localObject).jdField_d_of_type_Long = paramMsg.msg_id.get();
        ((lkv)localObject).jdField_c_of_type_Long = paramMsg.msg_time.get();
        ((lkv)localObject).a(lkv.jdField_d_of_type_Int);
        label140:
        if (!bool)
        {
          localObject = new lkv(paramChatRoomInfo, paramMsg.uin.get(), paramMsg.msg.get(), paramMsg.msg_time.get(), paramMsg.msg_id.get(), lkv.jdField_d_of_type_Int);
        ...
        else
        {
          ...
          return;
          if ((locallkv.jdField_d_of_type_Long != -9223372036854775808L) || (locallkv.jdField_a_of_type_Long != l) || (!TextUtils.equals(locallkv.jdField_a_of_type_JavaLangString, paramMsg.msg.get()))) {
            break label329;
          }
          localObject = locallkv;
        }
      }
      label320:
      label329:
  ...
  {
    ChatRoomInfo localChatRoomInfo = a(paramlgf, false);
    a(localChatRoomInfo);
    if ((QLog.isDevelopLevel()) && (paramlgf != null)) {
      QLog.i("ChatRoomMng", 4, "quitChatRoom, SessionType[" + paramlgf.jdField_d_of_type_Int + "], relationType[" + paramlgf.E + "], relationId[" + paramlgf.g + "], peerUin[" + paramlgf.jdField_d_of_type_JavaLangString + "], extraUin[" + paramlgf.f + "], isDoubleVideoMeeting[" + paramlgf.I + "], room[" + localChatRoomInfo + "]");
    }
  }
  
  public void a(lkw paramlkw)
  {
    if (QLog.isColorLevel()) {
      QLog.i("ChatRoomMng", 2, "addObserver, observer[" + paramlkw + "]");
    }
    if ((paramlkw != null) && (!this.b.contains(paramlkw))) {
      this.b.add(paramlkw);
    }
  }
  ...
  public void b(ChatRoomInfo paramChatRoomInfo)
  {
    ...
    mtm.a((Intent)localObject, l);
    this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.startServlet((NewIntent)localObject);
  }
  
  public void b(lkw paramlkw)
  {
    if (QLog.isColorLevel()) {
      QLog.i("ChatRoomMng", 2, "removeObserver, observer[" + paramlkw + "]");
    }
    if (paramlkw != null) {
      this.b.remove(paramlkw);
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.what == 1)
    {
      ...
      while (localIterator.hasNext())
      {
        locallkw = (lkw)localIterator.next();
        if (locallkw != null) {
          locallkw.a(i, paramMessage);
        }
      }
    }
    if (paramMessage.what == 2)
    {
      paramMessage = (lkv)paramMessage.obj;
      localIterator = this.b.iterator();
      while (localIterator.hasNext())
      {
        locallkw = (lkw)localIterator.next();
        if (locallkw != null) {
          locallkw.a(paramMessage);
        }
      }
    }
