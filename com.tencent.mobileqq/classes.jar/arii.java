...
{
  public static int a;
  static amah jdField_a_of_type_Amah = new arip();
  private final long jdField_a_of_type_Long = 1800000L;
  private aabp jdField_a_of_type_Aabp;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new ariu(this);
  public arjc a;
  arjf jdField_a_of_type_Arjf;
  arkg jdField_a_of_type_Arkg = new ariq(this);
  ...
  public arii(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentIntervideoNowproxyCustomized_interfaceCustomizedLog = new ariv(this);
    this.jdField_a_of_type_ComTencentIntervideoNowproxyCustomized_interfaceCustomizedChannel = new ariw(this);
    this.jdField_a_of_type_ComTencentIntervideoNowproxyCustomized_interfaceCustomizedLoading = new arix(this);
    this.jdField_a_of_type_ComTencentIntervideoNowproxyCustomized_interfaceCustomizedReport = new ariy(this);
    this.jdField_a_of_type_ComTencentIntervideoNowproxyCustomized_interfaceCustomizedDownloader = new ariz(this);
    this.jdField_a_of_type_ComTencentIntervideoNowproxyCustomized_interfaceCustomizedRecord = new arik(this);
    this.jdField_a_of_type_ComTencentIntervideoNowproxyQqshareCustomizedShareForQQ = new aril(this);
    this.jdField_a_of_type_ComTencentIntervideoNowproxyQQKandianInterface = new arim(this);
    this.jdField_a_of_type_ComTencentIntervideoNowproxyCustomized_interfaceCustomizedWebView = new arin(this);
    this.jdField_a_of_type_ComTencentIntervideoNowproxyCustomized_interfaceCustomizedDns = new ario(this);
    try
    {
      ...
      e();
      f();
      this.jdField_a_of_type_Arjc = new arjc(paramQQAppInterface);
  ...
  private static void a(long paramLong, String paramString1, String paramString2)
  {
    ...
    for (str = "https://now.qq.com/qq/play.html?_bid=2374&_wv=16778245&from=50320";; str = "https://now.qq.com/h5/index.html?_bid=2336&_wv=16778245&from=50320&roomid=" + paramLong)
    {
      ...
      arjh.a().a().a("", String.valueOf(paramLong), paramString2, paramString1);
      ...
      acqz.a(BaseApplicationImpl.getContext(), paramString2, paramString1);
      return;
    }
  }
  ...
  {
    return bbfd.a(BaseApplicationImpl.getContext(), "com.tencent.now");
  }
  ...
  {
    jdField_a_of_type_Int = amav.a().a(jdField_a_of_type_Amah);
  }
  
  private void e()
  {
    this.jdField_a_of_type_Arjf = new arjf();
    InitData localInitData = new InitData();
    localInitData.mAppID = "2";
    localInitData.mSourceVersion = String.valueOf(anet.a(BaseApplicationImpl.getContext()));
    localInitData.mSourceUid = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
    NowLive.setShadowImp(this.jdField_a_of_type_Arjf);
  ...
  public void a(Activity paramActivity, Bundle paramBundle)
  {
    ...
    long l2 = ((Long)atbg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "key_nearby_now_qq_connect_auth_time", Long.valueOf(0L))).longValue();
    QLog.d("XProxy|NowProxy", 1, "now qq connect auth time diff = " + (l1 - l2) / 1000L);
    if ((this.jdField_a_of_type_Aabp == null) || (l1 - l2 > 1728000000L))
    {
      atbg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "key_nearby_now_qq_connect_auth_time", Long.valueOf(l1));
      aabu.a();
      this.jdField_a_of_type_Aabp = aabu.a(paramActivity, 6, "101490787");
    }
    paramActivity = new WeakReference(paramActivity);
    this.jdField_a_of_type_Aabp.a("loginSilent", null, new arit(this, paramActivity, paramBundle));
  }
  ...
  public void a(Bundle paramBundle, arja paramarja)
  {
    if (AppSetting.b)
    {
      paramarja = ajyc.a(2131689492);
      bcpw.a(BaseApplicationImpl.getContext(), 1, paramarja, 0).a();
      paramBundle = aric.b(paramBundle);
      arjh.a().a().a(paramBundle);
      return;
    }
    paramBundle.putInt("jumpCallbackId", jdField_a_of_type_Int);
    paramarja = new Intent();
    paramarja.putExtras(paramBundle);
    abtu.a(paramarja, PublicTransFragmentActivity.class, NowQQConnectFragment.class);
  }
  ...
  public void a(NewTogetherRoomMessageData paramNewTogetherRoomMessageData, Bundle paramBundle, arkf paramarkf)
  {
    ...
    localBundle.putString("group_name", bbcl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramNewTogetherRoomMessageData.jdField_a_of_type_JavaLangString, false));
    ...
    a(localBundle, new arij(this, paramarkf));
  }
  ...
  public void b(Bundle paramBundle, arja paramarja)
  {
    paramBundle.putInt("ctrl_cmd", 1);
    NowLive.closeRoom(paramBundle, new arir(this, paramarja));
  }
  
  public void b(NewTogetherRoomMessageData paramNewTogetherRoomMessageData, Bundle paramBundle, arkf paramarkf)
  {
    b(a(paramBundle, paramNewTogetherRoomMessageData), new aris(this, paramarkf));
  }
  
  public void c()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
      arhy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
    }
  }
  ...
  public void onDestroy()
  {
    ...
    arjh.a();
    ((arla)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(338)).a(1);
    this.jdField_a_of_type_Arjc.b();
