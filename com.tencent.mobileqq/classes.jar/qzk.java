...
public class qzk
{
  ...
  private String a()
  {
    return Aladdin.getConfig(238).getString("black_wording", BaseApplicationImpl.getContext().getString(2131652523));
  }
  ...
  {
    PreferenceManager.getDefaultSharedPreferences(BaseApplicationImpl.getContext()).edit().putInt("fusion_biu_guide_has_shown_times_" + obz.a(), paramInt).apply();
  }
  
  private void a(long paramLong)
  {
    PreferenceManager.getDefaultSharedPreferences(BaseApplicationImpl.getContext()).edit().putLong("fusion_biu_guide_last_show_time_stamp_" + obz.a(), paramLong).apply();
  }
  ...
  private void a(boolean paramBoolean, long paramLong, String paramString)
  {
    ...
    if (paramBoolean) {
      bbmy.a(BaseApplicationImpl.getContext(), 2, BaseApplicationImpl.getContext().getString(2131652577), 0).a();
    }
    for (;;)
    {
      ohb.a().a(paramBoolean, paramLong, this.jdField_a_of_type_Int, paramString);
      this.jdField_a_of_type_Boolean = false;
      this.jdField_a_of_type_Int = 0;
      this.jdField_a_of_type_JavaLangString = "";
      this.jdField_a_of_type_AndroidOsHandler.removeCallbacksAndMessages(null);
      return;
      bbmy.a(BaseApplicationImpl.getContext(), 1, BaseApplicationImpl.getContext().getString(2131652575), 0).a();
    }
  }
  ...
  private void a(boolean paramBoolean, String paramString)
  {
    ...
    if (paramBoolean) {
      bbmy.a(BaseApplicationImpl.getContext(), 2, BaseApplicationImpl.getContext().getString(2131652568), 0).a();
    }
    for (;;)
    {
      ohb.a().a(paramBoolean, this.jdField_a_of_type_Int, paramString);
      ogy.a().b(true);
      this.jdField_a_of_type_Boolean = false;
      this.jdField_a_of_type_Int = 0;
      this.jdField_a_of_type_JavaLangString = "";
      this.jdField_a_of_type_AndroidOsHandler.removeCallbacksAndMessages(null);
      return;
      bbmy.a(BaseApplicationImpl.getContext(), 1, BaseApplicationImpl.getContext().getString(2131652567), 0).a();
    }
  }
  
  private int b()
  {
    return PreferenceManager.getDefaultSharedPreferences(BaseApplicationImpl.getContext()).getInt("fusion_biu_guide_has_shown_times_" + obz.a(), 0);
  }
  
  private long b()
  {
    return PreferenceManager.getDefaultSharedPreferences(BaseApplicationImpl.getContext()).getLong("fusion_biu_guide_last_show_time_stamp_" + obz.a(), 0L);
  }
  
  private String b()
  {
    return Aladdin.getConfig(238).getString("blue_wording", BaseApplicationImpl.getContext().getString(2131652524));
  }
  
  private String c()
  {
    return Aladdin.getConfig(238).getString("guide_wording", BaseApplicationImpl.getContext().getString(2131652520));
  }
  ...
  public SpannableString a(Context paramContext)
  {
    ...
    Drawable localDrawable = paramContext.getResources().getDrawable(2130841174);
    localDrawable.setBounds(0, 0, vct.a(paramContext, 20.0F), vct.a(paramContext, 20.0F));
    localSpannableString.setSpan(new vrc(localDrawable), 0, 1, 17);
    ...
    localDrawable = paramContext.getResources().getDrawable(2130841168);
    localDrawable.setBounds(0, 0, vct.a(paramContext, 6.0F), vct.a(paramContext, 10.0F));
    localSpannableString.setSpan(new vrc(localDrawable), str1.length() + 2 + 1 + str2.length() + 1, str1.length() + 2 + 1 + str2.length() + 2, 17);
  ...
  public void a(Context paramContext, long paramLong, int paramInt1, int paramInt2, ArticleInfo paramArticleInfo, int paramInt3, String paramString)
  {
    ...
    ogy.a().a(paramLong, paramInt1, paramInt2, paramArticleInfo);
  }
  ...
  public void a(Context paramContext, long paramLong1, long paramLong2, int paramInt1, int paramInt2, String paramString)
  {
    ...
    rac.a(paramContext, new qzm(this, paramString));
  }
  ...
  public void a(ImageView paramImageView, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_AndroidViewAnimationScaleAnimation.setAnimationListener(new qzn(this));
  ...
  public void a(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    try
    {
      ...
      ndn.a(null, null, "0X800A91C", "0X800A91C", 0, 0, "", "", "", localJSONObject.toString(), false);
      return;
    }
  ...
  public SpannableString b(Context paramContext)
  {
    ...
    Drawable localDrawable = paramContext.getResources().getDrawable(2130841173);
    localDrawable.setBounds(0, 0, vct.a(paramContext, 24.0F), vct.a(paramContext, 24.0F));
    localSpannableString.setSpan(new vrc(localDrawable), 0, 1, 17);
  ...
  public void b(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    try
    {
      ...
      localJSONObject.put("like_biu_content_type", paramInt2);
      localJSONObject.put("like_biu_page", paramInt3);
      ndn.a(null, null, "0X800A91D", "0X800A91D", 0, 0, "", "", "", localJSONObject.toString(), false);
      return;
    }
    catch (JSONException paramString)
    {
  ...
  public SpannableString d(Context paramContext)
  {
    ...
    localDrawable = paramContext.getResources().getDrawable(2130841169);
    localDrawable.setBounds(0, 0, vct.a(paramContext, 6.0F), vct.a(paramContext, 10.0F));
    localSpannableString.setSpan(new vrc(localDrawable), str1.length() + 2 + 1 + str2.length() + 1, str1.length() + 2 + 1 + str2.length() + 2, 17);
    return localSpannableString;
  }
