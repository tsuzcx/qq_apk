  ...
  implements XmlSerializer
{
  ...
  public bcgv(AbsStructMsg paramAbsStructMsg, XmlSerializer paramXmlSerializer)
  {
  ...
  public XmlSerializer text(@NonNull String paramString)
  {
    try
    {
      paramString = this.jdField_a_of_type_OrgXmlpullV1XmlSerializer.text(bblk.a(paramString, false));
      return paramString;
    }
