  ...
  implements bhpo
{
  ...
  protected Bitmap a(Bitmap paramBitmap)
  {
    ...
    j = (int)(j * f1);
    i = (int)(f1 * i);
    return bdda.a(paramBitmap, j, j, i);
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Int == 0)
        {
          ...
          this.jdField_a_of_type_Bcgw.sendMessage((Message)localObject);
          if (QLog.isColorLevel()) {
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    if (i < j)
    {
      ...
      if (!(localObject instanceof akee)) {
        break label131;
      }
      localObject = (akee)localObject;
      if ((localObject != null) && (((akee)localObject).a != null) && (((akee)localObject).a.length() > 0)) {
        ((akee)localObject).c.setImageBitmap(a(((akee)localObject).a, paramBoolean));
      }
    }
    for (;;)
    {
  ...
  public void onScrollStateChanged(AbsListView paramAbsListView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      while (this.jdField_a_of_type_Bhpo != null)
      {
