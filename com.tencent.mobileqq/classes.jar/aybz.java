  ...
  implements Manager
{
  ...
  public aybz(QQAppInterface paramQQAppInterface)
  {
  ...
  public int a(String paramString)
  {
    ...
    while (!bfwn.a(paramString, localSQLiteDatabase)) {
      return 0;
    }
  ...
  public long a(String paramString)
  {
    ...
    do
    {
      return l3;
      l2 = l1;
      if (bfwn.a(paramString, localSQLiteDatabase)) {
        l3 = l1;
      }
      try
      {
  ...
  public Cursor a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      paramString2 = bfwn.b(null, paramString1, localSQLiteDatabase, (String)localObject1);
    ...
    for (;;)
    {
      ...
      if (paramString1.indexOf("mr_discusssion_") != -1)
      {
        ...
        paramString2 = bfwn.b(null, paramString1, localSQLiteDatabase, (String)localObject2);
      ...
      Object localObject2 = bfwn.a(null, paramString1, localSQLiteDatabase, paramString2, null);
  ...
  public aybg a()
  {
    ...
    {
      if ((this.jdField_a_of_type_Aybg == null) || (!this.jdField_a_of_type_Aybg.isOpen())) {
        this.jdField_a_of_type_Aybg = ((aybg)a().createMessageRecordEntityManager());
      }
  ...
  public ayby a()
  {
    ...
    try
    {
      if (this.jdField_a_of_type_Ayby == null)
      {
        this.jdField_a_of_type_Ayby = new ayby(str);
  ...
  public List<MessageRecord> a(String paramString1, String paramString2)
  {
    ...
    {
      return null;
      paramString1 = bfwn.a(null, paramString1, localSQLiteDatabase, paramString2, null);
  ...
  public void onDestroy()
  {
    ...
    if (this.jdField_a_of_type_Ayby != null) {
      this.jdField_a_of_type_Ayby.close();
    }
  }
}
