...
public class zyo
  implements begw
{
  public zyo(AddRequestActivity paramAddRequestActivity, begr parambegr) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    {
      long l1 = axcy.a().b();
      this.jdField_a_of_type_ComTencentMobileqqActivityAddRequestActivity.a = axcy.a().a(Long.valueOf(l1));
      if (this.jdField_a_of_type_ComTencentMobileqqActivityAddRequestActivity.a != null)
      {
        ...
        if ((paramView != null) && (1 < paramView.size()))
        {
          ...
          AddRequestActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityAddRequestActivity, 2131653452, 1000L, false);
        }
      }
    }
    for (;;)
    {
      awqx.b(this.jdField_a_of_type_ComTencentMobileqqActivityAddRequestActivity.app, "CliOper", "", "", "Verification_msg", "Vfc_shield_clk", 0, 0, "", "", "", "");
      break;
      ...
      continue;
      bbmy.a(this.jdField_a_of_type_ComTencentMobileqqActivityAddRequestActivity, 2131628948, 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityAddRequestActivity.getTitleBarHeight());
    }
  }
}
