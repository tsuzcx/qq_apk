...
public class bjma
{
  private static volatile bjma jdField_a_of_type_Bjma;
  private String jdField_a_of_type_JavaLangString = "CHANNEL_ID_SHOW_BADGE";
  
  public static bjma a()
  {
    if (jdField_a_of_type_Bjma == null) {}
    try
    {
      if (jdField_a_of_type_Bjma == null) {
        jdField_a_of_type_Bjma = new bjma();
      }
      return jdField_a_of_type_Bjma;
    }
    finally {}
  }
  ...
  public Notification b(PendingIntent paramPendingIntent, Context paramContext, Bitmap paramBitmap, String paramString1, String paramString2, int paramInt)
  {
    ...
    //   78: aload_3
    //   79: aload_0
    //   80: getfield 15	bjma:jdField_a_of_type_JavaLangString	Ljava/lang/String;
