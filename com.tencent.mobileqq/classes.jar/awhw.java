  ...
  implements Handler.Callback
{
  ...
  public awhw(Conversation paramConversation, ViewGroup paramViewGroup)
  {
    ...
    this.jdField_a_of_type_Bhth = new awhz(this);
    this.jdField_c_of_type_Boolean = true;
    this.jdField_f_of_type_Int = -1;
    this.jdField_e_of_type_Boolean = true;
    this.jdField_f_of_type_Boolean = bhou.e();
  ...
  private void a(View paramView1, View paramView2, View paramView3)
  {
    ...
    if (this.jdField_a_of_type_ComNineoldandroidsAnimationValueAnimator == null)
    {
      ...
      this.jdField_a_of_type_ComNineoldandroidsAnimationValueAnimator.addUpdateListener(new awie(this, paramView2, paramView1, paramView3));
      this.jdField_a_of_type_ComNineoldandroidsAnimationAnimator$AnimatorListener = new awif(this, paramView3);
    }
  ...
  private void b(View paramView1, View paramView2, View paramView3)
  {
    ...
    if (this.jdField_b_of_type_ComNineoldandroidsAnimationValueAnimator == null)
    {
      ...
      this.jdField_b_of_type_ComNineoldandroidsAnimationValueAnimator.addUpdateListener(new awhx(this, paramView2, paramView1, paramView3));
      this.jdField_b_of_type_ComNineoldandroidsAnimationAnimator$AnimatorListener = new awhy(this, paramView3, paramView1);
    }
  ...
  private void o()
  {
    ...
    do
    {
      ...
      if (this.jdField_d_of_type_Int == 3)
      {
        int j = aekt.a(100.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
  ...
  public void b(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidOsCountDownTimer = new awia(this, arrayOfLong[1], 40L, arrayOfLong);
  ...
  public boolean c()
  {
    ...
    localAlphaAnimation.setAnimationListener(new awib(this));
    ...
    localTranslateAnimation.setAnimationListener(new awic(this));
    localAnimationSet.addAnimation(localTranslateAnimation);
    localAnimationSet.addAnimation(localAlphaAnimation);
    localAlphaAnimation = new AlphaAnimation(1.0F, 0.0F);
    localAlphaAnimation.setDuration(500L);
    localAlphaAnimation.setStartOffset(1000L);
    localAlphaAnimation.setAnimationListener(new awid(this));
    localAnimationSet.addAnimation(localAlphaAnimation);
