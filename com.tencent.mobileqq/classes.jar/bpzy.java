...
public class bpzy
{
  ...
  private static int a(int paramInt1, int paramInt2)
  {
    ...
    if (i == 0)
    {
      bpzw.a("glCreateProgram:program == 0");
      return 0;
    }
    ...
    if (a[0] == 0)
    {
      ...
      bpzw.a("linkProgram:GL_COMPILE_STATUS errorinfo =" + str);
      return 0;
    }
    return i;
  }
  ...
  private static int a(int paramInt, String paramString)
  {
    ...
    if (i == 0)
    {
      bpzw.a("glCreateShader:shader==0 type=" + a(paramInt));
      return 0;
    }
    ...
    if (a[0] == 0)
    {
      ...
      bpzw.a("glGetShaderiv:GL_COMPILE_STATUS error  loginfo=" + paramString);
      return 0;
    }
    return i;
  }
  ...
  public static int a(String paramString1, String paramString2)
  {
    ...
    if ((i == 0) || (j == 0))
    {
      bpzw.a("compileShader:vertext or fragment == 0");
      return 0;
    }
    int k = a(i, j);
    if (k == 0)
