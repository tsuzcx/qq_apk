...
import com.tencent.mobileqq.forward.ForwardSdkBaseOption.2;
import com.tencent.mobileqq.forward.ForwardSdkBaseOption.3;
  ...
  implements bcag
{
  ...
  private Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new aple(this);
  protected Handler a;
  public aphd a;
  aplk jdField_a_of_type_Aplk = new aplk(this);
  protected apll a;
  ...
  public apld(Intent paramIntent)
  {
    super(paramIntent);
    this.jdField_a_of_type_MqqObserverBusinessObserver = new aplg(this);
    this.jdField_b_of_type_AndroidOsHandler = new aplj(this);
  }
  ...
  private void L()
  {
    ...
    localBundle.putString("intext_2", "" + this.d);
    bcad.a().a(localBundle, "", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false);
    if (QLog.isColorLevel()) {
      QLog.d("ForwardOption.ForwardSdkBaseOption", 2, new Object[] { "checkAndRich|lack=", Integer.valueOf(this.d) });
    }
    if (this.d <= 0)
    {
      M();
    ...
    ThreadManager.post(new ForwardSdkBaseOption.2(this, str1, str2, str3, str5, str4), 5, null, false);
  }
  
  private void M()
  {
    String str = this.jdField_a_of_type_AndroidOsBundle.getString("image_url_remote");
    QLog.d("ForwardOption.ForwardSdkBaseOption", 1, new Object[] { "changeRemoteUrl|url=", str });
    if (TextUtils.isEmpty(str)) {
      return;
    }
    ThreadManager.excute(new ForwardSdkBaseOption.3(this, str), 128, null, true);
  }
  ...
  private void N()
  {
    try
    {
      bcfn.a().a(0, "SHARE_TO_QQ", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), String.valueOf(this.jdField_b_of_type_Long), "4", Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, null);
      return;
    }
  ...
  private void b(String paramString, boolean paramBoolean)
  {
    if (this.jdField_c_of_type_Boolean) {
      apmt.a(paramString, paramBoolean);
    }
  }
  ...
  private boolean p()
  {
    if ((!this.jdField_c_of_type_Boolean) || (!this.n) || (this.jdField_a_of_type_Aphd == null)) {
      return false;
    }
    ...
    {
      str = this.jdField_a_of_type_Aphd.e();
      ...
      for (str = "1";; str = "0")
      {
        ...
        bcad.a().a((Bundle)localObject, "" + this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), false);
        return true;
      }
    }
    return false;
  ...
  protected void G()
  {
    ...
    if (mpv.a((String)localObject1, "UTF-8") > 80) {
      localObject3 = mpv.a((String)localObject1, 80, "UTF-8", null);
    }
    localObject1 = localObject2;
    if (mpv.a((String)localObject2, "UTF-8") > 130) {
      localObject1 = mpv.a((String)localObject2, 130, "UTF-8", null);
    }
  ...
  public final void H()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.ssoGetTicketNoPasswd(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 4096, this.jdField_a_of_type_Aplk);
  }
  ...
  void I()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ForwardOption.ForwardSdkBaseOption", 2, new Object[] { "asyncUploadImageAndSendToBuddy mForwardSubType=", Integer.valueOf(this.jdField_c_of_type_Int) });
    }
    if (this.j != null) {
  ...
  public void K()
  {
    ...
    {
      return;
      QLog.d("ForwardOption.ForwardSdkBaseOption", 1, new Object[] { "realSendStructMsg, mForwardSubType = ", Integer.valueOf(this.jdField_c_of_type_Int) });
      x();
      ...
      awrn.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "sha_share2qq", 1, "", "", String.valueOf(this.jdField_b_of_type_Long));
      if (this.jdField_c_of_type_Int != 5) {
        break label636;
      }
      localObject1 = "connect_sharepic";
      mpw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject2, (String)localObject1, "send", this.jdField_b_of_type_Long, f(), String.valueOf(i1));
      a(0, "", "");
      ...
      ((Bundle)localObject1).putString("intext_2", "" + bcaj.a(i1, (String)localObject2));
    ...
    for (int i1 = 0;; i1 = this.jdField_a_of_type_Aphd.a())
    {
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Xfc == null)
    {
      ...
      this.jdField_a_of_type_Xfc.a(new aplf(this));
    }
    for (;;)
    {
      ...
      this.jdField_a_of_type_Xfc.a((String)localObject, c());
      ...
      if (paramInt1 == 0)
      {
        ...
        N();
        this.jdField_a_of_type_Xfc.b(null, null);
      }
      try
      {
        ...
        for (;;)
        {
          this.jdField_a_of_type_Xfc.b(this.jdField_a_of_type_AndroidAppActivity.getString(2131652922), c());
          break;
          if (paramInt1 == 1003) {
            this.jdField_a_of_type_Xfc.a(2131626647);
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      if (paramInt == g.intValue()) {
        this.jdField_a_of_type_Bafb.setEditLint("");
      }
  ...
  protected void a(String paramString, boolean paramBoolean)
  {
    ...
    localbafb.setTitle(this.jdField_a_of_type_AndroidAppActivity.getString(2131653601));
    Object localObject;
    if (paramBoolean)
    {
      localObject = paramString;
      if (TextUtils.isEmpty(paramString)) {
        localObject = this.jdField_a_of_type_AndroidAppActivity.getString(2131653602);
      }
      localbafb.setMessageWithUrl((String)localObject);
    }
    for (;;)
    {
      localObject = localbafb.setPositiveButton(2131653580, new apli(this));
      StringBuilder localStringBuilder = new StringBuilder().append(this.jdField_a_of_type_AndroidAppActivity.getString(2131625011));
      paramString = str;
      if (TextUtils.isEmpty(str)) {
        paramString = "";
      }
      ((bafb)localObject).setNegativeButton(paramString, new aplh(this));
      localbafb.setCancelable(false);
      localbafb.show();
      return;
      localbafb.setMessage(2131653602);
    }
  }
  ...
  public boolean a()
  {
    ...
    QLog.d("ForwardOption.ForwardSdkBaseOption", 1, new Object[] { "preloadData|subType=", Integer.valueOf(this.jdField_c_of_type_Int), ",targetUrl=", str2, ",remoteImg=", localObject2, ",localImg=", str1 });
    Object localObject1 = localObject2;
    if (!TextUtils.isEmpty(str2))
    {
      localObject1 = localObject2;
    ...
    for (;;)
    {
      ...
      ((Bundle)localObject2).putString("intext_1", "" + bcaj.a(this.jdField_c_of_type_Int));
      ((Bundle)localObject2).putString("intext_3", "0");
      bcad.a().a((Bundle)localObject2, "", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false);
      if ((this.jdField_c_of_type_Boolean) && (this.jdField_a_of_type_Aphd == null)) {
        L();
      }
      if ((this.jdField_c_of_type_Int == 5) && (TextUtils.isEmpty(str1)) && (TextUtils.isEmpty((CharSequence)localObject1)))
      {
        if (QLog.isColorLevel()) {
        ...
        a(-1, ajjy.a(2131639013), ajjy.a(2131639025));
      }
      try
      {
        bcfn.a().a(1, "SHARE_CHECK_AGENT", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), String.valueOf(this.jdField_b_of_type_Long), null, Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "分享的图片不存在");
        return false;
        localObject1 = null;
        continue;
        if (this.jdField_a_of_type_Aphd != null)
        ...
        if ((l1 > 0L) && (!"101735437".equals(String.valueOf(l1))))
        {
          ...
          if (TextUtils.isEmpty((CharSequence)localObject2))
          {
            ...
            a(2131653054);
            this.jdField_b_of_type_Bbms.setCancelable(false);
            long l4 = apmf.a();
            e("KEY_GET_APP_INFO");
            xdt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), l1, (String)localObject1, l2, l3, this.jdField_a_of_type_MqqObserverBusinessObserver, (String)localObject2, l4, true);
            return true;
          }
          localObject1 = AgentActivity.a(this.jdField_a_of_type_AndroidContentContext, (String)localObject2, l3 + "");
          continue;
        }
        if (!(this instanceof apln)) {
          continue;
        }
        a("", false);
      }
  ...
  protected void e()
  {
    if (this.jdField_a_of_type_Aphd.a())
    {
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Aphd.a())) {
        this.jdField_a_of_type_AndroidOsBundle.putString("struct_share_key_source_icon", this.jdField_a_of_type_Aphd.a());
      }
      String str = this.jdField_a_of_type_Aphd.e();
      if (!TextUtils.isEmpty(str)) {
        this.jdField_a_of_type_AndroidOsBundle.putString("struct_share_key_source_icon_big", str);
      }
      if ((!TextUtils.isEmpty(this.jdField_a_of_type_Aphd.b())) && (this.jdField_b_of_type_Long != Long.parseLong("1103584836"))) {
        this.jdField_a_of_type_AndroidOsBundle.putString("struct_share_key_source_url", this.jdField_a_of_type_Aphd.b());
      }
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Aphd.c())) {
        this.jdField_a_of_type_AndroidOsBundle.putString("struct_share_key_source_name", this.jdField_a_of_type_Aphd.c());
      }
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Aphd.d())) {
        this.jdField_a_of_type_AndroidOsBundle.putString("struct_share_key_source_a_action_data", this.jdField_a_of_type_Aphd.d());
      }
      if (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg != null)
      {
  ...
  protected void o()
  {
    ...
    localBundle.putString("intext_1", "" + bcaj.a(this.jdField_c_of_type_Int));
    localBundle.putString("intext_2", "" + bcaj.a(this.jdField_a_of_type_AndroidOsBundle.getInt("uintype"), this.jdField_a_of_type_AndroidOsBundle.getString("uin")));
    localBundle.putString("intext_3", "0");
    bcad.a().a(localBundle, "", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false);
  }
