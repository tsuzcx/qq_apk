...
public class akxc
{
  private static akxc jdField_a_of_type_Akxc = new akxc();
  ...
  private akxc()
  {
    ...
    if (!AppSetting.f().equals(localObject2))
    {
      ...
      bbjn.a((SharedPreferences.Editor)localObject2);
  ...
  public static akxc a()
  {
    return jdField_a_of_type_Akxc;
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_Boolean)
        {
          ...
          bbjn.a((SharedPreferences.Editor)localObject1);
          this.jdField_d_of_type_Int = 0;
          bool2 = bool1;
          continue;
        }
