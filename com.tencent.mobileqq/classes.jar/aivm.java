...
public class aivm
  extends anxg
{
  public aivm(TroopView paramTroopView) {}
  ...
  protected void d(boolean paramBoolean, ArrayList<aius> paramArrayList)
  {
    ...
    if ((TroopView.a(this.a) != null) && (TroopView.a(this.a).b()))
    {
      ...
      {
        i = 1;
        localObject = ((aivv)localObject).obtainMessage(14, 0, i);
    ...
    for (;;)
    {
      ...
      if ((paramArrayList != null) && (paramArrayList.size() > 0))
      {
        ...
        for (;;)
        {
          ...
          {
            aius localaius = (aius)paramArrayList.get(i);
            localaius.c = (i + 100);
            ((ArrayList)localObject).add(localaius);
            i += 1;
            continue;
            i = 0;
            break;
