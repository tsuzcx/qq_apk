  ...
  implements wou
{
  ...
  public List<PromoteTaskEntry> a(String paramString, int paramInt)
  {
    ...
    {
      yqp.a("StoryPromoteTaskManager", "findPromoteTaskListByFeedIdInner(%s, %d) return null", paramString, Integer.valueOf(paramInt));
  ...
  {
    yqp.a("StoryPromoteTaskManager", "findPromoteTaskListByFeedIds(%s, %d)", paramList, Integer.valueOf(paramInt));
    a();
  ...
  public void a()
  {
    ...
    this.jdField_b_of_type_JavaLangString = ((String)((wpf)wpm.a(10)).b("key_story_player_promote_url", this.jdField_b_of_type_JavaLangString));
    yqp.a("StoryPromoteTaskManager", "onInit() mUrl = %s", this.jdField_b_of_type_JavaLangString);
    ...
    for (;;)
    {
      ...
      if ((a()) && (localObject1 != null))
      {
        ...
        yqp.a("StoryPromoteTaskManager", "onInit() update memory count from DB; %s", this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap);
      }
      return;
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      yqp.a("StoryPromoteTaskManager", "refreshPromoteTask, time not expire now: %s(%d), expire: %s(%d), won't request!", zkk.a(l), Long.valueOf(l), zkk.a(this.jdField_a_of_type_Long), Long.valueOf(this.jdField_a_of_type_Long));
      return;
    }
    yqp.a("StoryPromoteTaskManager", "refreshPromoteTask(clear=%b), time expire, will request new list, now: %d, expire: %d", Boolean.valueOf(paramBoolean), Long.valueOf(l), Long.valueOf(this.jdField_a_of_type_Long));
    if (paramBoolean) {
      this.jdField_a_of_type_JavaLangString = "";
    }
    xaf localxaf = new xaf(this.jdField_a_of_type_JavaLangString);
    wlb.a().a(localxaf, new wpl(this));
  }
  ...
  public boolean a()
  {
    ...
    String str = zkk.a();
    if (TextUtils.equals((String)((wpf)localObject).b("key_story_promote_task_date", ""), str))
    {
      yqp.a("StoryPromoteTaskManager", "ensureCountValidate() date is %s, keep last promoteCount", str);
      return true;
    }
    yqp.a("StoryPromoteTaskManager", "ensureCountValidate() date is %s new date, so mTaskIdCounts should be empty, taskIdCounts=%s", str, this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap);
    ((wpf)localObject).b("key_story_promote_task_date", str);
    ...
    yqp.a("StoryPromoteTaskManager", "ensureCountValidate() exec sql: taskEntry updated sql=%s", localObject);
  ...
  {
    yqp.a("StoryPromoteTaskManager", "markTaskIdPromoted(%s)", Long.valueOf(paramLong));
  ...
  public boolean a(PromoteTaskEntry paramPromoteTaskEntry)
  {
    ...
    for (;;)
    {
      ...
      yqp.a("StoryPromoteTaskManager", "updateEntry %s, return %b", paramPromoteTaskEntry, Boolean.valueOf(bool));
      return bool;
      bool = false;
      continue;
      ...
      {
        yqp.e("StoryPromoteTaskManager", "updateEntry error: entry status unknown: %d", new Object[] { Integer.valueOf(paramPromoteTaskEntry.getStatus()) });
        bool = false;
      }
    }
  }
  ...
  public boolean a(qqstory_service.RspGetPromoteTaskList paramRspGetPromoteTaskList)
  {
    ...
    {
      Object localObject = wqs.a((qqstory_service.PromoteTask)paramRspGetPromoteTaskList.get(i));
      Long localLong = (Long)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(((wqs)localObject).jdField_a_of_type_Long));
      if (localLong != null) {}
      for (((wqs)localObject).e = localLong.longValue();; ((wqs)localObject).e = 0L)
      {
        localArrayList.remove(Long.valueOf(((wqs)localObject).jdField_a_of_type_Long));
        localObject = ((wqs)localObject).a();
        a((PromoteTaskEntry)localObject);
        yqp.a("StoryPromoteTaskManager", "overwriteEntries() [%d] taskEntry updated %s", Integer.valueOf(i), localObject);
        i += 1;
        break;
      }
    }
    ...
    {
      yqp.b("StoryPromoteTaskManager", "overwriteEntries() taskIds not empty, will delete it");
      a(localArrayList);
    }
    return true;
  }
  ...
  {
    yqp.a("StoryPromoteTaskManager", "deleteListOfTasks(%s)", paramList);
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      ...
      yqp.a("StoryPromoteTaskManager", "deleteListOfTasks() exec sql: taskEntry updated %s", paramList);
  ...
  {
    yqp.a("StoryPromoteTaskManager", "findPromoteTaskByUnionId(%s, %d)", paramString, Integer.valueOf(paramInt));
    a();
    ...
    yqp.a("StoryPromoteTaskManager", "findPromoteTaskListByUnionId(%s, %d) return null", paramString, Integer.valueOf(paramInt));
    return Collections.emptyList();
  }
  ...
  {
    yqp.a("StoryPromoteTaskManager", "markEntryPromoted(%s)", paramPromoteTaskEntry);
    if (paramPromoteTaskEntry == null)
    {
      yqp.b("StoryPromoteTaskManager", "markEntryPromoted entry is null!");
      return false;
    }
    if (paramPromoteTaskEntry.promoteCount >= paramPromoteTaskEntry.limitPromoteCount)
    {
      yqp.e("StoryPromoteTaskManager", "Error: entry.promoteCount >= entry.limitPromoteCount");
      return false;
    }
  ...
  public void c()
  {
    ((wpf)wpm.a(10)).b("key_story_promote_task_date", "");
  }
}
