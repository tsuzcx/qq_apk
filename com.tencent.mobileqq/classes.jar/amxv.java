...
{
  public static int a;
  private SparseArray<amxw> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
  public WeakReference<amyo> a;
  ...
  public amxv(amyo paramamyo)
  {
    a(new amxi());
    if (paramamyo != null)
    {
      this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramamyo);
      this.b = paramamyo.a();
    }
  }
  ...
  private void a(long paramLong, String paramString1, String paramString2)
  {
    if ((TextUtils.isEmpty(paramString1)) && (paramString2 != null)) {
      amwn.a().callbackFromRequest(paramLong, 0, paramString1, paramString2);
    }
  }
  ...
  public amqr a(long paramLong, String paramString1, String paramString2)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        Object localObject = (amyo)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        if (localObject != null)
        {
          ...
          if ((localObject != null) && (((ApolloSurfaceView)localObject).getLuaState() == paramLong))
          {
            ...
            {
              localObject = (amxw)this.jdField_a_of_type_AndroidUtilSparseArray.get(i);
              paramString2.put("N_R_CMD", paramString1);
              paramString2.put("N_R_STATE", paramLong);
              if (localObject != null)
              {
                paramString1 = ((amxw)localObject).a(this, paramString2);
                if (paramString2.optBoolean("N_R_SYNC"))
                {
                  if (paramString1 != null) {
                    paramString1.put("code", 0);
                  }
                  localObject = new amqr();
                  ((amqr)localObject).b = true;
                  if (paramString1 == null)
                  {
                    paramString1 = paramString2.toString();
                    ((amqr)localObject).a = paramString1;
                    return localObject;
                  }
              ...
              else
              {
                ...
                if (i < j)
                {
                  ...
                  paramString1 = (amxw)this.jdField_a_of_type_AndroidUtilSparseArray.get(k);
                  if (paramString1 == null) {
                    break label327;
                  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_AndroidUtilSparseArray != null)
    {
      ...
      {
        int k = this.jdField_a_of_type_AndroidUtilSparseArray.keyAt(i);
        amxw localamxw = (amxw)this.jdField_a_of_type_AndroidUtilSparseArray.get(k);
        if (localamxw != null) {
          localamxw.a();
        }
        i += 1;
  ...
  public void a(amxw paramamxw)
  {
    if (paramamxw != null)
    {
      ...
      if (this.jdField_a_of_type_AndroidUtilSparseArray.get(i) == null) {
        this.jdField_a_of_type_AndroidUtilSparseArray.put(i, paramamxw);
      }
    }
  }
  ...
  public void a(JSONObject paramJSONObject)
  {
    if (paramJSONObject != null) {
      try
      {
        ...
        {
          amwn.a().callbackFromRequest(l, 0, str, paramJSONObject.toString());
          return;
        }
