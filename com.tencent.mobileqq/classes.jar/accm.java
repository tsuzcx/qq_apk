...
{
  public accm(FilePreviewActivity paramFilePreviewActivity) {}
  ...
  public void loadFinish(int paramInt1, boolean paramBoolean, int paramInt2, String paramString)
  {
    ...
    {
      bool1 = true;
      this.a.runOnUiThread(new acco(this, paramInt1, bool1, paramInt2, paramString));
      paramString = this.a;
      if (paramBoolean) {
        break label67;
      }
  ...
  public void openFile(String paramString1, String paramString2, long paramLong, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        DialogUtil.a(this.a, 233, this.a.getString(2131434129), "是否下载文件:\n" + paramString1 + "(" + FileUtil.a(paramLong) + ")", new accp(this, paramString2, (UniformDownloadMgr)localObject2, (Bundle)localObject3), new accq(this)).show();
        return;
  ...
  {
    this.a.runOnUiThread(new accn(this, paramInt1, paramInt2));
  }
