...
public class accm
{
  ...
  awdn jdField_a_of_type_Awdn = new acco(this);
  ...
  public String a;
  private AccountObserver jdField_a_of_type_MqqObserverAccountObserver = new accp(this);
  WtloginObserver jdField_a_of_type_MqqObserverWtloginObserver = new accn(this);
  public boolean a;
  ...
  public accm(QQAppInterface paramQQAppInterface, RegisterNewBaseActivity paramRegisterNewBaseActivity, Intent paramIntent)
  {
  ...
  {
    awdr.a().a(true);
    awdr.a().b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_MqqObserverWtloginObserver);
  }
  ...
  public void a()
  {
    if (QLog.isDevelopLevel()) {
      bdxm.a(getClass().getSimpleName(), a());
    }
    ...
    if ((this.h) && (this.i))
    {
      this.k = false;
      this.l = true;
      this.jdField_a_of_type_Bdxq = new bdxq(this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity, null);
      this.jdField_a_of_type_Bdxq.a(this.jdField_d_of_type_JavaLangString, new accq(this));
    }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    {
      k();
      this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.a(2131717503, 0);
    }
    for (;;)
    {
      this.k = false;
      ...
      if ((this.j) && (this.k)) {
        if (this.f) {
          ...
          awdp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ArrayOfByte, this.jdField_d_of_type_JavaLangString);
        }
      }
    }
  }
  ...
  public void c()
  {
    ...
    if (this.jdField_e_of_type_Boolean)
    {
      ...
      QQToast.a(BaseApplicationImpl.sApplication, alpo.a(2131701208), 0).a();
    }
    j();
    LoginActivity.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount());
    h();
  ...
  public void e()
  {
    ...
    do
    {
      return;
      if (this.g) {
        azmj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80072FC", "0X80072FC", 0, 0, "", "", "", "");
      }
