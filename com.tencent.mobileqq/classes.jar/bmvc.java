  ...
  extends DynamicTextItem
{
  ...
  bmva jdField_a_of_type_Bmva = null;
  ...
  public bmvc(int paramInt, @NonNull List<String> paramList)
  {
  ...
  private boolean a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, String paramString, int paramInt5, int paramInt6, Point paramPoint)
  {
    ...
    while (j >= paramInt4)
    {
      ...
      StaticLayout localStaticLayout1 = bmwz.a(paramString, 0, paramString.length(), this.jdField_a_of_type_AndroidTextTextPaint, paramInt1, Layout.Alignment.ALIGN_NORMAL, 1.0F, 0.0F, false, null, 0, paramInt6);
      StaticLayout localStaticLayout2 = bmwz.a(paramString, 0, paramString.length(), this.jdField_b_of_type_AndroidTextTextPaint, paramInt1, Layout.Alignment.ALIGN_NORMAL, 1.0F, 0.0F, false, null, 0, paramInt6);
  ...
  public float a()
  {
    return this.jdField_a_of_type_Bmva.jdField_a_of_type_AndroidGraphicsBitmap.getWidth();
  }
  ...
  public InputFilter a()
  {
    if (this.jdField_a_of_type_AndroidTextInputFilter == null) {
      this.jdField_a_of_type_AndroidTextInputFilter = new bmvd(this, 20);
    }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    while (paramInt < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      bmva localbmva = (bmva)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt);
      localObject1[paramInt] = 0;
      f1 = localbmva.jdField_c_of_type_Int;
      f2 = localbmva.jdField_d_of_type_Int;
      localObject1[paramInt] = a((int)f1, (int)f2, localbmva.h, localbmva.g, (String)localObject2, localbmva.jdField_a_of_type_Int, localbmva.i, localObject3[paramInt]);
    ...
    {
      localObject3 = (bmva)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt);
      ...
      {
        f1 = AIOUtils.dp2px(((bmva)localObject3).jdField_c_of_type_Int, this.jdField_a_of_type_AndroidContentResResources);
        f2 = AIOUtils.dp2px(((bmva)localObject3).jdField_d_of_type_Int, this.jdField_a_of_type_AndroidContentResResources);
      ...
      if (localObject2[paramInt] > localObject2[i])
      {
        ...
        for (;;)
        {
          if (j == 0)
          {
            ...
            this.jdField_a_of_type_Bmva = ((bmva)this.jdField_a_of_type_JavaUtilArrayList.get(i));
  ...
  {
    paramCanvas.save();
    paramCanvas.drawBitmap(this.jdField_a_of_type_Bmva.jdField_a_of_type_AndroidGraphicsBitmap, 0.0F, 0.0F, this.jdField_a_of_type_AndroidGraphicsPaint);
    if (this.jdField_b_of_type_AndroidTextStaticLayout != null)
    {
      ...
      this.jdField_a_of_type_Float = (this.jdField_a_of_type_Bmva.jdField_e_of_type_Int + (this.jdField_a_of_type_Bmva.jdField_c_of_type_Int - this.jdField_c_of_type_Float) / 2.0F);
      this.jdField_b_of_type_Float = (this.jdField_a_of_type_Bmva.f + (this.jdField_a_of_type_Bmva.jdField_d_of_type_Int - this.jdField_d_of_type_Float) / 2.0F);
  ...
  public float b()
  {
    return this.jdField_a_of_type_Bmva.jdField_a_of_type_AndroidGraphicsBitmap.getHeight();
  }
