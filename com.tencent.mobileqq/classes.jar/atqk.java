...
public class atqk
{
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, long paramLong, TroopTips0x857.NotifyMsgBody paramNotifyMsgBody)
  {
    ...
    if (i == 4)
    {
      atud.b(paramQQAppInterface, String.valueOf(l));
      localatpw.notifyUI(5, true, new Object[] { Integer.valueOf(1), String.valueOf(l) });
      atue.a(paramQQAppInterface);
    }
    for (;;)
    {
      localatpw.notifyUI(3, true, new Object[] { paramNotifyMsgBody });
      return;
      if ((i == 1) || (i == 2))
      {
        atue.a(paramQQAppInterface, 1, String.valueOf(l), true);
      }
      else
      {
        if (i == 5)
        {
          ...
          atud.b(paramQQAppInterface, String.valueOf(l));
          localatpw.notifyUI(6, true, new Object[] { Integer.valueOf(1), String.valueOf(l), Integer.valueOf(paramInt) });
          atue.a(paramQQAppInterface);
          continue;
        }
        if (i == 3) {
  ...
  private static void a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2)
  {
    ...
    if (paramLong1 == paramQQAppInterface.getLongAccountUin()) {
      atpw.a(paramQQAppInterface).a(new atpq(1, String.valueOf(paramLong2)), false);
    }
  }
  
  static void a(QQAppInterface paramQQAppInterface, TroopTips0x857.LbsShareChangePushInfo paramLbsShareChangePushInfo)
  {
    paramQQAppInterface = atpw.a(paramQQAppInterface);
  ...
  static void a(QQAppInterface paramQQAppInterface, TroopTips0x857.LbsShareChangePushInfo paramLbsShareChangePushInfo, int paramInt)
  {
    ...
    paramLbsShareChangePushInfo = new atpq(1, String.valueOf(l1));
