...
public class blfr
{
  private static final String jdField_a_of_type_JavaLangString = blfr.class.getSimpleName();
  private FragmentManager jdField_a_of_type_AndroidSupportV4AppFragmentManager;
  private HashMap<Class<? extends AEEditorBaseFragment>, AEEditorBaseFragment> jdField_a_of_type_JavaUtilHashMap;
  
  public blfr(FragmentManager paramFragmentManager)
  {
  ...
  private void a(AEEditorBaseFragment paramAEEditorBaseFragment, Class<? extends AEEditorBaseFragment> paramClass, String paramString, Bundle paramBundle, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        blfg.d(jdField_a_of_type_JavaLangString, "replaceFragment: " + Log.getStackTraceString(paramAEEditorBaseFragment));
        return;
      }
  ...
  public void a(Activity paramActivity, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      {
        blfg.d(jdField_a_of_type_JavaLangString, Log.getStackTraceString(paramActivity));
        return;
      }
    ...
    blfg.b(jdField_a_of_type_JavaLangString, "goBack finish activity");
    b(paramActivity);
  ...
  {
    blfg.b(jdField_a_of_type_JavaLangString, "enter");
    if (blfq.a(paramBundle))
    {
      a(null, paramBundle);
      return;
    }
    if (blfq.b(paramBundle))
    {
      b(null, paramBundle);
      return;
    }
  ...
  {
    blfg.b(jdField_a_of_type_JavaLangString, "gotoImageClipModule from " + paramString);
    a(paramAEEditorBaseFragment, AEEditorImageClipFragment.class, paramString, paramBundle, paramBoolean);
  }
  
  public void a(String paramString, Bundle paramBundle)
  {
    blfg.b(jdField_a_of_type_JavaLangString, "gotoImageEditModule from " + paramString);
  ...
  {
    blfg.b(jdField_a_of_type_JavaLangString, "gotoVideoClipModule from " + paramString);
  ...
  {
    blfg.b(jdField_a_of_type_JavaLangString, "gotoVideoEditModule from " + paramString);
