...
public class ahvv
{
  ...
  public ahvv(ahvq paramahvq, Context paramContext, ViewGroup paramViewGroup)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnTouchListener(new ahvw(this, paramahvq));
    this.jdField_c_of_type_AndroidWidgetRelativeLayout$LayoutParams = new RelativeLayout.LayoutParams(-1, -1);
    this.jdField_c_of_type_AndroidWidgetRelativeLayout$LayoutParams.topMargin = paramahvq.a;
    ...
    this.jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener = new ahvx(this, paramahvq);
    this.jdField_a_of_type_JavaLangRunnable = new PhotoListPanel.SwipeUpAndDragListener.GestureHandler.3(this, paramahvq);
    this.jdField_b_of_type_JavaLangRunnable = new PhotoListPanel.SwipeUpAndDragListener.GestureHandler.4(this, paramahvq);
  }
  ...
  public boolean a(ahvn paramahvn, int paramInt)
  {
    this.jdField_a_of_type_Ahvn = paramahvn;
    this.jdField_b_of_type_Int = paramInt;
    paramahvn.itemView.getLocationInWindow(this.jdField_c_of_type_ArrayOfInt);
    paramahvn = this.jdField_a_of_type_Ahvn.a.getDrawable();
    this.jdField_a_of_type_ComTencentWidgetRoundRectImageView.setImageDrawable(paramahvn);
  ...
  void b()
  {
    ...
    try
    {
      this.jdField_a_of_type_Ahvn.itemView.clearAnimation();
