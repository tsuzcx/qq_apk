...
public class aihk
{
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      paramActivity = bcwd.a(paramActivity);
    } while (paramActivity == null);
    bgsc.a(paramQQAppInterface, paramSessionInfo.jdField_a_of_type_JavaLangString, paramSessionInfo.jdField_a_of_type_Int, paramActivity, null);
    bcst.b(paramQQAppInterface, "CliOper", "", paramSessionInfo.jdField_a_of_type_JavaLangString, "0X8004B51", "0X8004B51", 0, 0, "", "", "", "");
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, FragmentActivity paramFragmentActivity, SessionInfo paramSessionInfo, AbsShareMsg paramAbsShareMsg, String paramString)
  {
    ...
    abdx localabdx = new abdx(paramFragmentActivity);
    String str = paramFragmentActivity.getString(2131717865);
    if (paramString != null) {}
    for (paramString = str + paramString;; paramString = str)
    {
      paramAbsShareMsg = new aihl(paramAbsShareMsg, paramFragmentActivity, paramFragmentActivity, paramQQAppInterface, paramSessionInfo);
      localabdx.a(paramString, paramAbsShareMsg);
      localabdx.a(paramFragmentActivity.getResources().getString(2131717872));
      localabdx.a(paramAbsShareMsg);
      localabdx.a(false);
      localabdx.show();
      bcst.b(paramQQAppInterface, "CliOper", "", paramSessionInfo.jdField_a_of_type_JavaLangString, "0X8004B54", "0X8004B54", 0, 0, "", "", "", "");
      return;
    }
  }
  ...
  {
    boolean bool = false;
    bcst.b(paramQQAppInterface, "CliOper", "", paramSessionInfo.jdField_a_of_type_JavaLangString, "0X8004B53", "0X8004B53", 0, 0, "", "", "", "");
    ...
    if (paramIntent.getBooleanExtra("from3rdApp", false))
    {
      ...
      if (paramIntent.getBooleanExtra("showFirstStructMsg", false))
      {
        ...
        if (paramIntent != null)
        {
          ...
          long l = bbxc.jdField_a_of_type_Int;
          paramSessionInfo = bbzh.a(paramQQAppInterface, paramSessionInfo.jdField_a_of_type_JavaLangString, paramSessionInfo.jdField_a_of_type_JavaLangString, paramSessionInfo.jdField_a_of_type_JavaLangString, paramSessionInfo.jdField_a_of_type_Int, l, paramIntent);
