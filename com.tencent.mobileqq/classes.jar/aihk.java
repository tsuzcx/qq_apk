  ...
  extends AsyncTask<RespondQueryQQBindingStat, Void, List<PhoneContact>>
{
  ...
  private aihk(PhoneContactManagerImp paramPhoneContactManagerImp) {}
  ...
  protected List<PhoneContact> a(RespondQueryQQBindingStat... paramVarArgs)
  {
    ...
    Collections.sort(paramVarArgs, new aihl(this));
    ArrayList localArrayList = new ArrayList();
    amsw localamsw = (amsw)PhoneContactManagerImp.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactPhonecontactPhoneContactManagerImp).getManager(51);
    ...
    do
    {
      do
      {
        ...
        {
          Collections.sort(localArrayList, new aihm(this));
    ...
    for (;;)
    {
      ...
      break;
      paramVarArgs = localamsw.e(localPhoneContact.uin);
      break label201;
      label260:
      localPhoneContact.uin = "0";
      if (localamsw.d(localPhoneContact.nationCode + localPhoneContact.mobileCode))
      {
