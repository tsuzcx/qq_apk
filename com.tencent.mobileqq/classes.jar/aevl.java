...
public class aevl
{
  ...
  public static ArrayList<aevk> a;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bbuv.a(ajsf.bC) + File.separator;
  ...
  public static aevk a(int paramInt)
  {
    if (jdField_a_of_type_JavaUtilArrayList.size() > paramInt) {
      return (aevk)jdField_a_of_type_JavaUtilArrayList.get(paramInt);
    }
    return null;
  }
  ...
  public static Drawable a(int paramInt)
  {
    ...
    ((URLDrawable.URLDrawableOptions)localObject).mLoadingDrawable = BaseApplicationImpl.getContext().getResources().getDrawable(2130841045);
    ((URLDrawable.URLDrawableOptions)localObject).mFailedDrawable = BaseApplicationImpl.getContext().getResources().getDrawable(2130841045);
  ...
  public static String a(int paramInt)
  {
    ...
    if (TextUtils.isEmpty(str2)) {
      str1 = ajyc.a(2131707909);
    }
    return str1;
  }
  
  public static List<aevk> a(String paramString)
  {
        ...
        for (;;)
        {
          if (i < j) {
            try
            {
              ...
              aevk localaevk = new aevk();
              localaevk.jdField_a_of_type_Int = k;
              localaevk.jdField_a_of_type_JavaLangString = b(k);
              jdField_a_of_type_JavaUtilArrayList.add(localaevk);
              i += 1;
            }
  ...
  public static aevk b(int paramInt)
  {
    Object localObject;
    aevk localaevk;
    if (jdField_a_of_type_JavaUtilArrayList.size() != 0)
    {
      ...
      do
      {
        ...
        localaevk = (aevk)((Iterator)localObject).next();
      } while (localaevk.jdField_a_of_type_Int != paramInt);
    }
    for (;;)
    {
      localObject = localaevk;
      if (localaevk == null)
      {
        localObject = new aevk();
        ((aevk)localObject).jdField_a_of_type_Int = paramInt;
        ((aevk)localObject).jdField_a_of_type_JavaLangString = b(paramInt);
      }
      return localObject;
      localaevk = null;
    }
