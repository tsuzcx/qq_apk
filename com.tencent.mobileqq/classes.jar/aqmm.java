...
public class aqmm
  extends aycd
{
  public aqmm(ContactSyncManager paramContactSyncManager) {}
  
  protected void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    avsy localavsy = (avsy)this.a.a.getManager(11);
    int i = localavsy.d();
    ...
    do
    {
      do
      {
        ...
        ContactSyncManager.a(this.a).sendEmptyMessage(1);
        return;
      } while ((i != 5) && (i != 1) && ((i != 6) || (localavsy.a() == null) || (localavsy.a().lastUsedFlag != 3L)) && ((i != 7) || (localavsy.a() == null) || (!localavsy.a().isStopFindMatch)));
      if ((i == 5) || (i == 1)) {
