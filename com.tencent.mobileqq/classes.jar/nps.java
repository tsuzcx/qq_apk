  ...
  extends ajtb
{
  ...
  public nps(AppInterface paramAppInterface)
  {
    super(paramAppInterface);
  }
  
  public nps(QQAppInterface paramQQAppInterface)
  {
  ...
  private int a()
  {
    switch (bbfj.a(BaseApplicationImpl.getApplication().getApplicationContext()))
    {
    case 2: 
    default: 
      return 2;
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (!bool3)
      {
        ...
        nmi.a(localBundle, paramFromServiceMsg);
        ...
        continue;
        localObject1 = localVideoInfo;
        nmi.a(localRspBody, localBundle, this.jdField_a_of_type_Long);
  ...
  private void a(Object paramObject, long paramLong1, VideoInfo paramVideoInfo, int paramInt1, ArrayList<VideoInfo> paramArrayList1, String paramString1, long paramLong2, boolean paramBoolean, int paramInt2, String paramString2, String paramString3, WeishiRedDotInfo paramWeishiRedDotInfo, int paramInt3, String paramString4, byte[] paramArrayOfByte, ArrayList<oidb_0x885.AdTagInfo> paramArrayList, int paramInt4, int paramInt5, int paramInt6, int paramInt7, ArrayList<VideoInfo> paramArrayList2)
  {
    ...
    paramString2.msg_phone_info.set(oaf.a());
  ...
  private void a(oidb_0x6cf.ReqBody paramReqBody)
  {
    ...
    if (i < k)
    {
      ...
      str = bbfr.a(BaseApplicationImpl.getContext(), str);
  ...
  private VideoInfo b(oidb_0x6cf.ArticleSummary paramArticleSummary, oidb_0x6cf.RspBody paramRspBody)
  {
      ...
      catch (JSONException localJSONException1)
      {
        ...
        catch (NumberFormatException localNumberFormatException)
        {
          ...
          if ((paramArticleSummary.msg_feeds_info.has()) && (((oidb_0x6cf.FeedsInfo)paramArticleSummary.msg_feeds_info.get()).feeds_type.get() == 1))
          {
            ...
            localObject2 = nmc.a(localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo);
            if (oaq.a(null, localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo)) {
          ...
          try
          {
            ...
            nmc.a(new nyd().a(BaseApplication.getContext()).a(nmc.jdField_k_of_type_Int).b(nmc.T).a((AdvertisementInfo)localObject2).a(localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo).b((JSONObject)localObject4).a());
            oar.a(localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo);
    ...
    else
    {
      ...
      nmi.a(paramArticleSummary, localVideoInfo);
  ...
  public void a(npt paramnpt, int paramInt1, VideoInfo paramVideoInfo, String paramString, int paramInt2)
  {
    if (paramVideoInfo == null) {
      return;
    }
    ThreadManagerV2.executeOnSubThread(new VideoPlayRecommendHandler.6(this, paramInt2, paramInt1, paramVideoInfo, paramString, paramnpt));
  }
  
  public void a(npt paramnpt, long paramLong1, VideoInfo paramVideoInfo, int paramInt1, ArrayList<VideoInfo> paramArrayList1, String paramString1, long paramLong2, boolean paramBoolean, int paramInt2, String paramString2, String paramString3, WeishiRedDotInfo paramWeishiRedDotInfo, int paramInt3, String paramString4, byte[] paramArrayOfByte, int paramInt4, int paramInt5, ArrayList<VideoInfo> paramArrayList2)
  {
    if (paramVideoInfo == null)
    {
      if (QLog.isDevelopLevel()) {
    ...
    ThreadManager.post(new VideoPlayRecommendHandler.3(this, paramnpt, paramLong1, paramVideoInfo, paramInt1, paramArrayList1, paramString1, paramLong2, paramBoolean, paramInt2, paramString2, paramString3, paramWeishiRedDotInfo, paramInt3, paramString4, paramArrayOfByte, paramInt4, paramInt5, paramArrayList2), 5, null, true);
  }
  ...
  public void a(npt paramnpt, long paramLong1, VideoInfo paramVideoInfo, int paramInt1, ArrayList<VideoInfo> paramArrayList1, String paramString1, long paramLong2, boolean paramBoolean, int paramInt2, String paramString2, String paramString3, WeishiRedDotInfo paramWeishiRedDotInfo, int paramInt3, String paramString4, byte[] paramArrayOfByte, int paramInt4, ArrayList<VideoInfo> paramArrayList2)
  {
    ...
    ThreadManager.post(new VideoPlayRecommendHandler.1(this, paramnpt, paramLong1, paramVideoInfo, paramInt1, paramArrayList1, paramString1, paramLong2, paramBoolean, paramInt2, paramString2, paramString3, paramWeishiRedDotInfo, paramInt3, paramString4, paramArrayOfByte, paramInt4, paramArrayList2), 5, null, true);
  }
  ...
  public void a(npt paramnpt, long paramLong1, VideoInfo paramVideoInfo, int paramInt1, ArrayList<VideoInfo> paramArrayList1, String paramString1, long paramLong2, boolean paramBoolean, int paramInt2, String paramString2, String paramString3, WeishiRedDotInfo paramWeishiRedDotInfo, int paramInt3, String paramString4, byte[] paramArrayOfByte, ArrayList<VideoInfo.AdTagInfo> paramArrayList, int paramInt4, int paramInt5, int paramInt6, ArrayList<VideoInfo> paramArrayList2)
  {
    ...
    ThreadManager.post(new VideoPlayRecommendHandler.2(this, paramArrayList, paramnpt, paramLong1, paramVideoInfo, paramInt1, paramArrayList1, paramString1, paramLong2, paramBoolean, paramInt2, paramString2, paramString3, paramWeishiRedDotInfo, paramInt3, paramString4, paramArrayOfByte, paramInt4, paramInt5, paramInt6, paramArrayList2), 5, null, true);
  }
  
  public void a(npt paramnpt, long paramLong, String paramString, int paramInt, VideoInfo paramVideoInfo)
  {
    ThreadManager.post(new VideoPlayRecommendHandler.4(this, paramLong, paramInt, paramString, paramnpt, paramVideoInfo), 5, null, true);
  }
  
  public void a(npt paramnpt, String paramString, int paramInt, boolean paramBoolean)
  {
    oidb_0x6cf.ReqBody localReqBody = new oidb_0x6cf.ReqBody();
    ...
    for (paramInt = 1;; paramInt = 0)
    {
      ...
      paramString = pot.a("OidbSvc.0x6cf", 1743, 1, localReqBody.toByteArray());
      paramString.addAttribute("is_from_first_recommend_video", Boolean.valueOf(true));
      paramString.addAttribute("VALUE_OBSERVER_TAG", Integer.valueOf(paramnpt.hashCode()));
