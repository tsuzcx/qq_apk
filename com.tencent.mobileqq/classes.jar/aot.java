...
{
  public aot(LbsStrangerPoiDialog paramLbsStrangerPoiDialog) {}
  ...
  public void onGetSenderNick(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    label218:
    label224:
    for (paramBundle = "等" + this.a.d + "人发" + this.a.getContext().getString(2131438758);; paramBundle = this.a.getContext().getString(2131438758))
    {
