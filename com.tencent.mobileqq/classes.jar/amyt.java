...
public class amyt
{
  ...
  public amyt(String paramString1, boolean paramBoolean, String paramString2, String[] paramArrayOfString1, String[] paramArrayOfString2)
  {
  ...
  public SpannableString a(Context paramContext, CharSequence paramCharSequence)
  {
    ...
    if (i < this.jdField_a_of_type_ArrayOfJavaLangString.length)
    {
      ...
      for (;;)
      {
        ...
        localSpannableString.setSpan(new amyu(this, str2, paramContext), j, str1.length() + j, 33);
      }
    }
    axqy.b(null, "dc00898", "", "", this.c, this.c, 2, 0, "", "", "", "");
