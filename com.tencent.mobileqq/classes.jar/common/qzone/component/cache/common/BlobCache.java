  ...
  implements Closeable
{
  ...
  private boolean a(RandomAccessFile paramRandomAccessFile, int paramInt, BlobCache.LookupRequest paramLookupRequest)
  {
    ...
    try
    {
      ...
      if ((paramLookupRequest.jdField_a_of_type_ArrayOfByte == null) || (paramLookupRequest.jdField_a_of_type_ArrayOfByte.length < m)) {
        paramLookupRequest.jdField_a_of_type_ArrayOfByte = new byte[m];
      }
      arrayOfByte = paramLookupRequest.jdField_a_of_type_ArrayOfByte;
      paramLookupRequest.jdField_a_of_type_Int = m;
  ...
  public boolean a(BlobCache.LookupRequest paramLookupRequest)
  {
    ...
    } while ((this.jdField_e_of_type_Int + 20 + paramLookupRequest.jdField_a_of_type_Int > this.jdField_b_of_type_Int) || (this.jdField_d_of_type_Int * 2 >= this.jdField_a_of_type_Int));
    this.i = k;
    try
    {
