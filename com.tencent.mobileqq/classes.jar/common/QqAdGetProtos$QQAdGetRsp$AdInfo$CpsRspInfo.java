...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 32, 42, 50, 58, 66, 74, 80, 88, 98, 106, 112, 122, 8018 }, new String[] { "product_id", "img_list", "product_name", "product_price", "sales_tips", "h5_page", "deep_link", "apurl", "rl", "catelog_id", "source", "wechat_app_info", "qq_app_info", "product_original_price", "chantag", "product_id_str" }, new Object[] { Long.valueOf(0L), "", "", Integer.valueOf(0), "", "", "", "", "", Long.valueOf(0L), Integer.valueOf(0), null, null, Integer.valueOf(0), "", "" }, CpsRspInfo.class);
