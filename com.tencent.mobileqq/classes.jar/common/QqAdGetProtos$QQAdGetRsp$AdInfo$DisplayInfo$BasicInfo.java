  ...
  extends MessageMicro<BasicInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 34, 40, 48 }, new String[] { "img", "img_s", "txt", "desc", "pic_width", "pic_height" }, new Object[] { "", "", "", "", localInteger, localInteger }, BasicInfo.class);
  }
}
