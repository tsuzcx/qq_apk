  ...
  extends MessageMicro<AdvertiserInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 32, 40, 48 }, new String[] { "corporation_name", "corporate_image_name", "corporate_logo", "advertiser_id", "ad_first_category", "ad_second_category" }, new Object[] { "", "", "", localLong, localLong, localLong }, AdvertiserInfo.class);
  }
}
