  ...
  extends MessageMicro<Ext>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 40, 50 }, new String[] { "mini_program_preload", "no_clkcgi_jump", "landing_page_style", "market_deep_link", "disable_auto_download", "market_package_name" }, new Object[] { localInteger, localBoolean, localInteger, "", localBoolean, "" }, Ext.class);
  }
}
