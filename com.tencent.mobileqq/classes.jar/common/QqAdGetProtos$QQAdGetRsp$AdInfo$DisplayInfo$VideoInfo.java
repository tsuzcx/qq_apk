  ...
  extends MessageMicro<VideoInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 26, 32, 40 }, new String[] { "video_url", "media_duration", "tencent_video_id", "video_file_size", "no_auto_play" }, new Object[] { "", localInteger, "", localInteger, Boolean.valueOf(false) }, VideoInfo.class);
  }
}
