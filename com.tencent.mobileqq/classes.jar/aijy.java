  ...
  implements ailp, View.OnClickListener
{
  ...
  public aijy(QQAppInterface paramQQAppInterface, Context paramContext, ailr paramailr)
  {
  ...
  public View a(Object... paramVarArgs)
  {
    ...
    ImageView localImageView1 = (ImageView)paramVarArgs.findViewById(2131362536);
    ImageView localImageView2 = (ImageView)paramVarArgs.findViewById(2131362546);
    ((TextView)paramVarArgs.findViewById(2131362547)).setText(this.jdField_a_of_type_AndroidTextSpannableString);
    if (this.jdField_a_of_type_Int == 0)
    {
      localImageView1.setImageResource(2130839534);
      paramVarArgs.setBackgroundResource(2130839531);
      localImageView2.setImageResource(2130850159);
    }
    for (;;)
    {
      paramVarArgs.setOnClickListener(this);
      return paramVarArgs;
      localImageView1.setImageResource(2130844191);
      paramVarArgs.setBackgroundResource(2130847161);
      localImageView2.setImageResource(2130844347);
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "qq_vip", "0X8009E34", this.jdField_b_of_type_Int, 0, "", "", "", "");
        this.jdField_a_of_type_Ailr.a();
      }
      aofp.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_b_of_type_JavaLangString, "group_aio_tip");
      localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
      if (this.jdField_b_of_type_Int == 3) {}
      for (localObject = "0X800A57A";; localObject = "0X800A57C")
      {
        bdla.b(localQQAppInterface, "dc00898", "", "", "qq_vip", (String)localObject, 1, 0, "", "", "", "");
        break;
      }
    ...
    {
      bdla.b(localQQAppInterface, "dc00898", "", "", "qq_vip", (String)localObject, 2, 0, "", "", "", "");
      break;
    }
  }
}
