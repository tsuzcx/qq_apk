...
public class aijy
{
  public static volatile aijx a;
  
  /* Error */
  public static aijx a(android.content.Context paramContext, String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 4
    ...
    //   87: astore_0
    //   88: aload_0
    //   89: invokestatic 55	aijy:a	(Lorg/json/JSONObject;)Laijx;
    //   92: putstatic 11	aijy:a	Laijx;
    //   95: getstatic 11	aijy:a	Laijx;
    //   98: astore_3
    //   99: goto -76 -> 23
    //   102: astore_0
    //   103: ldc 57
  ...
  /* Error */
  public static aijx a(JSONObject paramJSONObject)
  {
    // Byte code:
    //   0: iconst_1
    //   1: istore_3
    ...
    //   85: invokestatic 102	aijy:a	(Lorg/json/JSONObject;)Laikd;
    //   88: astore 7
    //   90: aload 7
    //   92: ifnull +13 -> 105
    //   95: aload 6
    ...
    //   122: iload_1
    //   123: aload 6
    //   125: invokespecial 113	aijx:<init>	(ZILjava/util/List;)V
    //   128: areturn
    //   129: astore 5
    //   131: iconst_0
    //   132: istore_1
  ...
  public static aikd a(JSONObject paramJSONObject)
  {
    int j = 0;
    ...
    try
    {
      ...
      if (paramJSONObject.has("emos"))
      {
        ...
        while (i < localJSONArray.length())
        {
          ...
          aikb localaikb = new aikb();
          localaikb.jdField_a_of_type_JavaLangString = str1;
          localaikb.jdField_b_of_type_JavaLangString = str2;
          localaikb.jdField_a_of_type_Long = Long.valueOf(l).longValue();
          localaikb.jdField_a_of_type_Int = j;
          localaikb.jdField_b_of_type_Int = k;
          localaikb.c = str3;
          localaikb.d = ((String)localObject);
          localArrayList2.add(localaikb);
          i += 1;
        }
      }
      return new aikd(localArrayList1, localArrayList2);
    }
  ...
  public static void a(android.content.Context paramContext, String paramString, JSONObject paramJSONObject)
  {
    ...
    //   45: aload_2
    //   46: invokestatic 55	aijy:a	(Lorg/json/JSONObject;)Laijx;
    //   49: putstatic 11	aijy:a	Laijx;
    //   52: aload_0
    //   53: ifnull +48 -> 101
    //   56: aload_0
    //   57: ldc 13
