...
{
  public nmq(VideoPlayModeBase paramVideoPlayModeBase, int paramInt, String paramString1, String paramString2, StoryVideoItem paramStoryVideoItem) {}
  ...
  public void a(boolean paramBoolean1, QQUserUIItem paramQQUserUIItem, boolean paramBoolean2)
  {
    ...
    for (String str = paramQQUserUIItem.toString();; str = "null")
    {
      ...
      if (Looper.getMainLooper() != Looper.myLooper()) {
        this.jdField_a_of_type_ComTencentBizQqstoryPlaymodeVideoPlayModeBase.a.post(new nmr(this));
      }
      return;
    }
  }
