  ...
  extends slz
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = skt.a("StorySvc.feed_like_list_batch_715");
  }
  
  public sza(List<String> paramList, boolean paramBoolean)
  {
  ...
  public slu a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return new szb(localRspBatchFeedLike);
    }
