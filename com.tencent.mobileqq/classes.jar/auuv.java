...
public class auuv
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = Environment.getExternalStorageDirectory().getAbsolutePath() + "/Android/data/com.tencent.mobileqq/qq/video/LightVideo/";
  ...
  public auuv()
  {
    ...
    this.jdField_b_of_type_JavaLangString = (Environment.getExternalStorageDirectory().getAbsolutePath() + "/Android/data/com.tencent.mobileqq/qq/video/Source/" + this.jdField_a_of_type_Long);
