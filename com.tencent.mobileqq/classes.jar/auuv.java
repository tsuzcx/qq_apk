...
public class auuv
{
  ...
  public static String a(MessageForStructing paramMessageForStructing)
  {
    ...
    if (paramMessageForStructing.getItemCount() > 0)
    {
      ...
      if ((paramMessageForStructing instanceof azxe))
      {
        Object localObject = (azxe)paramMessageForStructing;
        if (((azxe)localObject).a.size() > 0)
        {
          paramMessageForStructing = ((azxe)localObject).a.getString("sNick");
          String str = ((azxe)localObject).a.getString("rNick");
          localObject = ((azxe)localObject).a.getString("cMean");
  ...
  public static boolean a(MessageRecord paramMessageRecord)
  {
    ...
    if ((paramMessageRecord instanceof MessageForStructing))
    {
      ...
      if ((paramMessageRecord.structingMsg != null) && ((paramMessageRecord.structingMsg instanceof AbsShareMsg)) && (paramMessageRecord.structingMsg.mMsgServiceID == 52))
      {
        ...
        if ((paramMessageRecord.getItemCount() <= 0) || (!(paramMessageRecord.getItemByIndex(0) instanceof azxe))) {}
      }
    }
  ...
  public static int[] a(Context paramContext)
  {
    ...
    paramContext = bdne.k(paramContext);
  ...
  public static void b(String paramString)
  {
    ...
    //   22: newarray int
    //   24: putstatic 105	auuv:jdField_a_of_type_ArrayOfInt	[I
    //   27: iconst_0
    //   28: istore_1
    //   29: iload_1
    //   30: aload_0
    ...
    //   47: istore_2
    //   48: getstatic 105	auuv:jdField_a_of_type_ArrayOfInt	[I
    //   51: iload_1
    //   52: iload_2
    //   53: iastore
    //   54: iload_1
