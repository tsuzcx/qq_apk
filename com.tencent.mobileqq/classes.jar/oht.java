...
public class oht
  implements Manager, tlu
{
  private int jdField_a_of_type_Int;
  private final Object jdField_a_of_type_JavaLangObject = new Object();
  private ArrayList<String> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private tlw jdField_a_of_type_Tlw;
  private int b;
  
  public oht(QQAppInterface paramQQAppInterface)
  {
  ...
  private void b()
  {
    for (;;)
    {
      ...
      {
        String str1;
        if ((this.jdField_a_of_type_Tlw == null) && (this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0)) {
          str1 = (String)this.jdField_a_of_type_JavaUtilArrayList.remove(0);
        }
        try
        {
          Object localObject2 = new URL(str1);
          if (tlv.a().a((URL)localObject2))
          {
            b();
            if (QLog.isColorLevel()) {
          ...
          this.jdField_a_of_type_Tlw = new tlw();
          this.jdField_a_of_type_Tlw.jdField_a_of_type_JavaNetURL = ((URL)localObject2);
          this.jdField_a_of_type_Tlw.jdField_a_of_type_Int = this.jdField_a_of_type_Int;
          this.jdField_a_of_type_Tlw.b = this.b;
          localObject2 = tlv.a().a(this.jdField_a_of_type_Tlw);
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("NativeAdPreloadManager", 2, "onFail url:" + paramtlw.jdField_a_of_type_JavaNetURL.toString());
    }
    if (paramtlw.equals(this.jdField_a_of_type_Tlw))
    {
      this.jdField_a_of_type_Tlw = null;
      b();
    }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("NativeAdPreloadManager", 2, "onSuccess url:" + paramtlw.jdField_a_of_type_JavaNetURL.toString());
    }
    if (paramtlw.equals(this.jdField_a_of_type_Tlw))
    {
      this.jdField_a_of_type_Tlw = null;
