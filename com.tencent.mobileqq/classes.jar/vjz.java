...
public class vjz
{
  ...
  {
    return new WSStatisticsReporter.Builder().setSceneFrom("QQ_official_account").setSopName(paramString).setTestId(vnd.a(10003)).setPushId(vmm.a().a()).setFlush(true).setImmediatelyUpload(vnd.c());
  }
