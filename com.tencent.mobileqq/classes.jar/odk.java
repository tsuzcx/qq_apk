  ...
  implements AladdinConfigHandler
{
  ...
  public static int a()
  {
    String[] arrayOfString = ((String)bgmq.a("readinjoy_comment_guide_show_num_one_day", "0_0")).split("_");
  ...
  public static TemplateBean a(VafContext paramVafContext)
  {
    ...
    {
      rdg localrdg = rdg.a("comment_feeds", true);
      paramVafContext = localrdg;
      if (localrdg == null) {
        return null;
      }
    }
    ...
    {
      paramVafContext = (rdg)paramVafContext.getTemplateFactory();
    }
    if (paramVafContext != null) {}
    for (;;)
    {
  ...
  {
    String str = (String)bgmq.a("readinjoy_comment_guide_wording", ajjy.a(2131636387));
  ...
  {
    String str2 = (String)bgmq.a("readinjoy_comment_guide_base_jump_url", "");
    ...
    do
    {
      ...
      str3 = (String)befm.a(str2).get("appSchema");
      str1 = str2;
    ...
    try
    {
      ...
      paramString = befm.a(befm.a(str2, "appSchema"), "appSchema", paramString);
  ...
  public static JSONObject a()
  {
    ...
    try
    {
      ...
      localJSONObject.put("guide_image", bgmq.a("readinjoy_comment_guide_image_url", "readinjoy_comment_guide_big_bg"));
      localJSONObject.put("guide_wording", a());
      localJSONObject.put("jump_button_text", ajjy.a(2131636386));
  ...
  public static void a(int paramInt)
  {
    ...
    bgmq.a("readinjoy_comment_guide_show_num_one_day", str + "_" + paramInt);
  }
  
  public static boolean a()
  {
    if (((Integer)bgmq.a("readinjoy_comment_guide_pic_button_should_show", Integer.valueOf(-1))).intValue() == 1) {}
  ...
  {
    boolean bool1;
    if (((Integer)bgmq.a("readinjoy_comment_guide_should_show", Integer.valueOf(-1))).intValue() == 1)
    {
      bool1 = true;
      bool2 = bool1;
      if (bool1)
      {
        int i = ((Integer)bgmq.a("readinjoy_comment_guide_max_show_count", Integer.valueOf(3))).intValue();
        int j = a();
  ...
  public boolean onReceiveConfig(int paramInt1, int paramInt2, String paramString)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (TextUtils.equals(str1, "should_show")) {
        bgmq.a("readinjoy_comment_guide_should_show", Integer.valueOf(Integer.valueOf(str2).intValue()));
      } else if (TextUtils.equals(str1, "wording")) {
        bgmq.a("readinjoy_comment_guide_wording", str2);
      } else if (TextUtils.equals(str1, "image_url")) {
        bgmq.a("readinjoy_comment_guide_image_url", str2);
      } else if (TextUtils.equals(str1, "base_jump_url")) {
        bgmq.a("readinjoy_comment_guide_base_jump_url", str2);
      } else if (TextUtils.equals(str1, "max_show_count")) {
        bgmq.a("readinjoy_comment_guide_max_show_count", Integer.valueOf(Integer.valueOf(str2).intValue()));
      } else if (TextUtils.equals(str1, "pic_button_should_show")) {
        bgmq.a("readinjoy_comment_guide_pic_button_should_show", Integer.valueOf(Integer.valueOf(str2).intValue()));
      }
    }
    return true;
  }
  ...
  public void onWipeConfig(int paramInt)
  {
    ...
    bgmq.a("readinjoy_comment_guide_should_show", Integer.valueOf(0));
  }
}
