...
public class befm
{
  private static final LRULinkedHashMap<String, befn> jdField_a_of_type_ComTencentUtilLRULinkedHashMap = new LRULinkedHashMap(4);
  private static WeakReference<zab> jdField_a_of_type_MqqUtilWeakReference;
  
  public static befn a(String paramString)
  {
    if (AppSetting.f) {
      return null;
    }
    ...
    for (paramString = null;; paramString = (befn)jdField_a_of_type_ComTencentUtilLRULinkedHashMap.get(paramString))
    {
      String str;
      if (paramString != null)
      {
  ...
  public static boolean a(String paramString)
  {
    ...
    //   9: ireturn
    //   10: aload_0
    //   11: invokestatic 55	befm:a	(Ljava/lang/String;)Lbefn;
    //   14: ifnull +19 -> 33
    ...
    //   299: lstore 8
    //   301: getstatic 158	befm:jdField_a_of_type_MqqUtilWeakReference	Lmqq/util/WeakReference;
    //   304: ifnull +12 -> 316
    //   307: getstatic 158	befm:jdField_a_of_type_MqqUtilWeakReference	Lmqq/util/WeakReference;
    ...
    //   358: invokespecial 190	zab:<init>	(Lcom/tencent/common/app/AppInterface;)V
    //   361: astore 12
    //   363: new 160	mqq/util/WeakReference
    //   366: dup
    //   367: aload 12
    //   369: invokespecial 193	mqq/util/WeakReference:<init>	(Ljava/lang/Object;)V
    //   372: putstatic 158	befm:jdField_a_of_type_MqqUtilWeakReference	Lmqq/util/WeakReference;
    //   375: goto +558 -> 933
    //   378: aload 12
    //   380: instanceof 185
    //   383: ifeq +509 -> 892
    ...
    //   395: invokespecial 190	zab:<init>	(Lcom/tencent/common/app/AppInterface;)V
    //   398: astore 12
    //   400: goto -37 -> 363
    //   403: getstatic 158	befm:jdField_a_of_type_MqqUtilWeakReference	Lmqq/util/WeakReference;
    //   406: invokevirtual 163	mqq/util/WeakReference:get	()Ljava/lang/Object;
    //   409: checkcast 187	zab
    //   412: astore 12
    //   414: goto +519 -> 933
    //   417: aload 12
    //   419: aload 13
    //   421: invokevirtual 196	zab:a	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/OfflineWebRes;
    //   424: astore 12
    ...
    //   654: aload 14
    //   656: astore 13
    //   658: getstatic 19	befm:jdField_a_of_type_ComTencentUtilLRULinkedHashMap	Lcom/tencent/util/LRULinkedHashMap;
    //   661: aload 15
    //   663: new 41	befn
    //   666: dup
    //   667: aload 12
    //   669: aload 16
    //   671: ldc_w 256
    //   674: invokespecial 262	befn:<init>	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
