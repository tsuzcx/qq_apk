...
public class aegp
{
  private static aegp jdField_a_of_type_Aegp;
  private final ArrayList<aegr> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  
  public static aegp a()
  {
    if (jdField_a_of_type_Aegp == null) {}
    try
    {
      if (jdField_a_of_type_Aegp == null) {
        jdField_a_of_type_Aegp = new aegp();
      }
      return jdField_a_of_type_Aegp;
    }
    finally {}
  }
  ...
  public static void a(Activity paramActivity)
  {
    ...
    try
    {
      bbgu localbbgu = bbdj.a(paramActivity, 230).setMessage(ajya.a(2131700047)).setPositiveButton(paramActivity.getString(2131694088), new aegq(paramActivity));
      if ((localbbgu != null) && (!paramActivity.isFinishing())) {
        localbbgu.show();
      }
      return;
    }
  ...
  public static void a(Activity paramActivity, RelativeLayout paramRelativeLayout)
  {
    if ((paramActivity != null) && (paramRelativeLayout != null))
    {
      ...
      a(paramActivity);
      axqy.b(null, "dc00898", "", "", "0X8009EB8", "0X8009EB8", 0, 0, "", "", "", "");
    }
  }
  ...
  public static void a(MessageRecord paramMessageRecord)
  {
    if (((paramMessageRecord instanceof MessageForPic)) || ((paramMessageRecord instanceof MessageForShortVideo)) || ((paramMessageRecord instanceof MessageForMarketFace)) || ((paramMessageRecord instanceof MessageForFile)) || ((paramMessageRecord instanceof MessageForTroopFile)) || ((paramMessageRecord instanceof MessageForMixedMsg)) || ((paramMessageRecord instanceof MessageForStructing)))
    {
      ...
      if (localObject2 != null) {
        synchronized (((aegp)localObject2).jdField_a_of_type_JavaUtilArrayList)
        {
          localObject2 = ((aegp)localObject2).jdField_a_of_type_JavaUtilArrayList.iterator();
          if (((Iterator)localObject2).hasNext()) {
            ((aegr)((Iterator)localObject2).next()).a(paramMessageRecord.uniseq);
          }
        }
      }
      ??? = RichmediaService.a();
  ...
  public void a(aegr paramaegr)
  {
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      if (!this.jdField_a_of_type_JavaUtilArrayList.contains(paramaegr)) {
        this.jdField_a_of_type_JavaUtilArrayList.add(paramaegr);
      }
      return;
    }
  }
  ...
  public void a(Bundle arg1)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      ...
      if (((Iterator)localObject1).hasNext()) {
        ((aegr)((Iterator)localObject1).next()).a(l);
      }
    }
  }
  
  public void b(aegr paramaegr)
  {
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      this.jdField_a_of_type_JavaUtilArrayList.remove(paramaegr);
      return;
    }
  }
}
