...
public class anui
  extends anrh
{
  public anui(QQAppInterface paramQQAppInterface, Context paramContext)
  {
  ...
  private void d()
  {
    ...
    if ((localObject1 != null) && (((ChatFragment)localObject1).a() != null))
    {
      ...
      if ((localObject1 != null) && ((localObject1 instanceof TroopChatPie)))
      {
        ...
        Object localObject2 = (afsw)((TroopChatPie)localObject1).getHelper(43);
        if (localObject2 != null) {
          ((afsw)localObject2).b(2);
        }
        ...
        bddt.a("click#aio_graybar", (HashMap)localObject2);
      }
    }
  }
