...
public class aujs
{
  ...
  HashMap<bcvs, View> jdField_a_of_type_JavaUtilHashMap = new HashMap(1);
  
  public aujs(ForwardSdkBaseOption paramForwardSdkBaseOption, Context paramContext)
  {
  ...
  public View a()
  {
    ...
    ((FrameLayout)localObject1).addView((View)localObject2, new FrameLayout.LayoutParams(-1, bgtn.a(33.0F), 16));
    ((View)localObject2).setOnClickListener(new aujt(this));
    ((View)localObject2).setContentDescription(anni.a(2131703615));
    localObject2 = new FrameLayout.LayoutParams(-1, -2, 16);
    ((FrameLayout.LayoutParams)localObject2).rightMargin = bgtn.a(16.0F);
    ...
    ((FrameLayout)localObject1).addView((View)localObject2, new FrameLayout.LayoutParams(bgtn.a(8.0F), bgtn.a(14.0F), 21));
    return localObject1;
  }
  ...
  void a()
  {
    ...
    for (;;)
    {
      ...
      if (localIterator.hasNext())
      {
        ...
        View localView1 = (View)this.jdField_a_of_type_JavaUtilHashMap.get(localbcvs);
        View localView2 = localbcvs.a(this.jdField_a_of_type_AndroidContentContext, localView1, (Bundle)localObject1);
        if ((localView2 != null) && ((localbcvs instanceof bcyl)))
        {
          TextView localTextView = (TextView)localView2.findViewById(2131379957);
        ...
        this.jdField_a_of_type_JavaUtilHashMap.put(localbcvs, localView2);
