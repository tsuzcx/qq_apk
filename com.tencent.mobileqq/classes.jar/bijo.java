  ...
  extends bika
{
  ...
  bhlz jdField_a_of_type_Bhlz = new bhlz();
  public bijp a;
  public bijr a;
  public bira a;
  public ArrayList<bijr> a;
  private Paint jdField_b_of_type_AndroidGraphicsPaint;
  bijr jdField_b_of_type_Bijr;
  public int g;
  public int h;
  public int i;
  public int j = c;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bijo.class.getSimpleName();
    jdField_b_of_type_Int = biyb.a[1];
    c = Color.parseColor("#80000000");
    e = 270;
    f = 5;
  }
  
  public bijo(DoodleView paramDoodleView)
  {
  ...
  /* Error */
  private String a(String paramString, bijr parambijr)
  {
    // Byte code:
    //   0: aload_1
    ...
    //   14: areturn
    //   15: aload_0
    //   16: invokevirtual 111	bijo:c	()I
    //   19: aload_0
    //   20: invokevirtual 113	bijo:d	()I
    ...
    //   50: aload 6
    //   52: aload_0
    //   53: getfield 132	bijo:jdField_a_of_type_Bira	Lbira;
    //   56: aload_2
    //   57: invokevirtual 137	bira:a	(Lbirb;)Landroid/graphics/Matrix;
    //   60: invokevirtual 141	android/graphics/Canvas:concat	(Landroid/graphics/Matrix;)V
    //   63: aload 4
    //   65: astore 5
    //   67: aload_2
    //   68: getfield 146	bijr:jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem	Ldov/com/qq/im/capture/text/DynamicTextItem;
    //   71: aload 6
    ...
    //   80: aload_1
    //   81: ldc 153
    //   83: invokestatic 156	bijo:a	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   86: astore_1
    //   87: aload 4
    //   89: astore 5
    //   91: aload_0
    ...
    //   97: bipush 100
    //   99: aload_1
    //   100: invokevirtual 165	bijo:a	(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap$CompressFormat;ILjava/lang/String;)Z
    //   103: istore_3
    //   104: aload 4
    //   106: astore 5
    //   108: getstatic 42	bijo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   154: invokestatic 193	urk:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   157: iload_3
    //   158: ifne +23 -> 181
    //   161: aload 4
    //   163: ifnull +16 -> 179
    ...
    //   211: aload 4
    //   213: astore 5
    //   215: getstatic 42	bijo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   218: ldc 202
    //   220: aload_2
    //   221: invokestatic 205	urk:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   224: aload_1
    //   225: astore_2
    //   226: aload 4
    //   228: ifnull -215 -> 13
  ...
  private void a(bijr parambijr)
  {
    boolean bool1 = this.jdField_a_of_type_Bira.a(parambijr, StoryGuideLineView.jdField_a_of_type_Int, true);
    boolean bool2 = this.jdField_a_of_type_Bira.a(parambijr, StoryGuideLineView.jdField_b_of_type_Int, false);
    boolean bool3 = this.jdField_a_of_type_Bira.b(parambijr, StoryGuideLineView.d, false);
    if (this.jdField_a_of_type_Bijp != null) {
      this.jdField_a_of_type_Bijp.a(bool1, bool2, false, bool3, parambijr.l);
    }
    if (parambijr != null)
    {
      if (parambijr.k) {
        this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.a(parambijr.l, parambijr.r, parambijr.s, parambijr.t, parambijr.jdField_b_of_type_AndroidGraphicsPointF, parambijr.m, 2);
      }
    }
    else {
      return;
    }
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.a(parambijr.l, parambijr.r, parambijr.s, parambijr.t, parambijr.jdField_b_of_type_AndroidGraphicsPointF, parambijr.m, 1);
  }
  ...
  private boolean e()
  {
    ...
    urk.b(jdField_a_of_type_JavaLangString, "isRubbish:" + bool + " brand:" + str);
    return bool;
  }
  
  private void o()
  {
    this.k = aciy.a(50.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.i = biqy.a(this.jdField_a_of_type_AndroidContentContext);
    this.h = 1;
    this.g = 1;
  ...
  public Bundle a()
  {
    ...
    {
      localArrayList.add(new TextParcelData((bijr)this.jdField_a_of_type_JavaUtilArrayList.get(i1)));
      i1 += 1;
    }
  ...
  public bijr a()
  {
    ...
    {
      this.jdField_a_of_type_JavaUtilArrayList.remove(this.jdField_a_of_type_Bijr);
      return this.jdField_a_of_type_Bijr;
    }
    return null;
  }
  ...
  public DynamicTextItem a()
  {
    if (this.jdField_a_of_type_Bijr != null) {
      return this.jdField_a_of_type_Bijr.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem;
    }
    return null;
  }
  ...
  public DynamicTextItem a(bijq parambijq, SegmentKeeper paramSegmentKeeper, int paramInt)
  {
    ...
    label87:
    for (parambijq = new bijr(this, parambijq);; parambijq = new bijr(this))
    {
      parambijq.jdField_a_of_type_Int = paramInt;
      parambijq.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper = new SegmentKeeper(paramSegmentKeeper);
      if (parambijq.jdField_a_of_type_Int == 0) {
        SegmentKeeper.adjustTime(-1L * System.currentTimeMillis());
      }
      this.jdField_a_of_type_JavaUtilArrayList.add(parambijq);
      localDynamicTextItem = parambijq.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem;
      this.jdField_a_of_type_Bijr = parambijq;
  ...
  public ArrayList<TrackerStickerParam> a(String paramString)
  {
    ...
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0))
    {
      ...
      {
        bijr localbijr = (bijr)localIterator.next();
        if ((localbijr.c()) || (localbijr.d()))
        {
          Object localObject = a(paramString, localbijr);
          localObject = new TrackerStickerParam(c() / 2, d() / 2, 1.0F, 0.0F, 0.0F, 0.0F, c(), d(), c(), d(), (String)localObject, localbijr.jdField_a_of_type_JavaUtilMap);
          ((TrackerStickerParam)localObject).setSegmentList(localbijr.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper.getSegmentList());
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Bijr = null;
  ...
  public void a(int paramInt)
  {
    ...
    {
      bijr localbijr = (bijr)localIterator.next();
      if (localbijr.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper != null) {
        localbijr.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper.setMode(paramInt);
      }
    }
  }
  ...
  protected void a(Canvas paramCanvas)
  {
    ...
    if (this.g == 6)
    {
      if (this.jdField_b_of_type_Bijr != null) {
        this.jdField_b_of_type_Bijr.a(paramCanvas);
      }
      localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
      while (localIterator.hasNext())
      {
        localbijr = (bijr)localIterator.next();
        if ((this.jdField_b_of_type_Bijr != null) && (localbijr.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem != this.jdField_b_of_type_Bijr.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem)) {
          localbijr.a(paramCanvas);
        }
      }
    }
    ...
    while (localIterator.hasNext())
    {
      ((bijr)localIterator.next()).a(paramCanvas);
      continue;
      if (this.g == 5)
      {
        localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
        ...
        {
          localbijr = (bijr)localIterator.next();
          if (localbijr.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem != this.jdField_a_of_type_Bijr.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem) {
            localbijr.a(paramCanvas);
          }
        }
      }
  ...
  public void a(Canvas paramCanvas, float paramFloat, boolean paramBoolean)
  {
    ...
    {
      bijr localbijr = (bijr)localIterator.next();
      if (((!localbijr.c()) && (!localbijr.d())) || (paramBoolean)) {
        localbijr.a(paramCanvas);
      }
    }
    paramCanvas.restore();
  ...
  public void a(bijp parambijp)
  {
    this.jdField_a_of_type_Bijp = parambijp;
  }
  ...
  public void a(DynamicTextItem paramDynamicTextItem)
  {
    ...
    if ((paramDynamicTextItem != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0))
    {
      ...
      {
        bijr localbijr = (bijr)localIterator.next();
        if (!paramDynamicTextItem.equals(localbijr.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem)) {
          break label72;
        }
        localObject = localbijr;
      }
    }
    label72:
    for (;;)
  ...
  public void a(ArrayList<TextParcelData> paramArrayList, boolean paramBoolean)
  {
    if ((paramArrayList != null) && (!paramArrayList.isEmpty()))
    {
      ...
      do
      {
        ...
        bijr localbijr = ((TextParcelData)paramArrayList.next()).a(this);
        if (!paramBoolean)
        {
          localbijr.c(true);
          localbijr.jdField_a_of_type_Int = 1;
        }
        this.jdField_a_of_type_JavaUtilArrayList.add(localbijr);
  ...
  {
    urk.b(jdField_a_of_type_JavaLangString, "setKeyboardState:" + paramBoolean);
    if (paramBoolean) {}
    for (;;)
    {
      super.k();
  ...
  public boolean a(long paramLong)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (localIterator.hasNext()) {
      if (((bijr)localIterator.next()).jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper.isSegmentChanged(paramLong)) {
        return false;
      }
    }
    return true;
  ...
  public boolean a(android.graphics.Bitmap paramBitmap, android.graphics.Bitmap.CompressFormat paramCompressFormat, int paramInt, String paramString)
  {
    ...
    //   0: iconst_0
    //   1: istore 5
    //   3: getstatic 42	bijo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   27: invokestatic 193	urk:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   30: aload_1
    //   31: ifnonnull +15 -> 46
    //   34: getstatic 42	bijo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   37: ldc_w 584
    //   40: invokestatic 193	urk:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   43: iload 5
    //   45: ireturn
    //   46: aconst_null
    //   47: astore 8
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      bool = true;
      return bool;
      this.jdField_a_of_type_Bira.a(this.jdField_a_of_type_Bijr);
      j();
      this.jdField_a_of_type_Bijr.b();
      this.l = i1;
      break;
      this.jdField_a_of_type_Bijr.c();
      break;
      if (this.g == 3) {
        this.jdField_a_of_type_Bijr.c();
      }
  ...
  public boolean a(JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      while (((Iterator)localObject).hasNext()) {
        localJSONArray.put(new TextParcelData((bijr)((Iterator)localObject).next()).a());
      }
  ...
  {
    urk.b(jdField_a_of_type_JavaLangString, "setMode:" + paramInt + ",preMode:" + this.h);
    this.h = this.g;
    this.g = paramInt;
    if (paramInt == 4) {
      n();
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    {
      urk.e(jdField_a_of_type_JavaLangString, "setTextOffset x:" + paramInt1 + "y=" + paramInt2);
      return;
    }
    urk.b(jdField_a_of_type_JavaLangString, "setTextTop:" + paramInt1 + "y=" + paramInt2);
    this.n = paramInt1;
    this.o = paramInt2;
  }
  ...
  public void b(DynamicTextItem paramDynamicTextItem)
  {
    if (this.jdField_a_of_type_Bijr != null)
    {
      this.jdField_a_of_type_Bijr.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem = paramDynamicTextItem;
      this.jdField_a_of_type_Bijr.u = paramDynamicTextItem.a();
      this.jdField_a_of_type_Bijr.v = paramDynamicTextItem.b();
    }
    if (this.jdField_b_of_type_Bijr != null)
    {
      this.jdField_b_of_type_Bijr.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem = paramDynamicTextItem;
      if (this.jdField_a_of_type_Bijr != null)
      {
        this.jdField_b_of_type_Bijr.q = this.jdField_a_of_type_Bijr.q;
        this.jdField_b_of_type_Bijr.jdField_b_of_type_Float = this.jdField_a_of_type_Bijr.q;
      }
    }
  }
  ...
  public boolean b(MotionEvent paramMotionEvent)
  {
    if (b())
    {
      ...
      if (i1 >= 0)
      {
        paramMotionEvent = (bijr)this.jdField_a_of_type_JavaUtilArrayList.get(i1);
        ...
        while (!this.jdField_a_of_type_Bira.a(paramMotionEvent, f1, f2, false))
        {
          i1 -= 1;
          break;
        }
        this.jdField_a_of_type_Bijr = paramMotionEvent;
      }
    }
    for (boolean bool = true;; bool = false)
    {
      ...
      {
        this.jdField_a_of_type_JavaUtilArrayList.remove(this.jdField_a_of_type_Bijr);
        this.jdField_a_of_type_JavaUtilArrayList.add(this.jdField_a_of_type_Bijr);
      }
      return bool;
    }
  }
  ...
  public void c()
  {
    if ((this.jdField_a_of_type_Bijp != null) && (this.jdField_a_of_type_Bijr != null))
    {
      if (this.jdField_a_of_type_Bijp.a(this.jdField_a_of_type_Bijr)) {
        this.jdField_a_of_type_JavaUtilArrayList.remove(this.jdField_a_of_type_Bijr);
      }
    }
    else {
    ...
    this.jdField_a_of_type_Bijp.a(this.jdField_a_of_type_Bijr.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem);
  }
  ...
  public void c(int paramInt)
  {
    if (paramInt < 0)
    {
      urk.e(jdField_a_of_type_JavaLangString, "setTextTop:" + paramInt);
      return;
    }
    urk.b(jdField_a_of_type_JavaLangString, "setTextTop:" + paramInt);
    this.m = paramInt;
  }
  ...
  public void d()
  {
    if (!a())
    {
      ...
      if (this.jdField_a_of_type_Bijr != null)
      {
        this.jdField_b_of_type_Bijr = new bijr(this, this.jdField_a_of_type_Bijr);
        this.jdField_b_of_type_Bijr.a();
        bijr.a(this.jdField_b_of_type_Bijr);
      }
    }
    while (this.jdField_a_of_type_Bijp == null) {
      return;
    }
    this.jdField_a_of_type_Bijp.a(1.0F);
  }
  ...
  public void f()
  {
    ...
    if (this.jdField_a_of_type_JavaUtilArrayList.size() > 0)
    {
      ...
      {
        bijr localbijr = (bijr)((Iterator)localObject2).next();
        if ((localbijr.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem != null) && (localbijr.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.e())) {
          ((List)localObject1).add(localbijr);
        }
      }
    }
    ...
    {
      localObject2 = (bijr)((Iterator)localObject1).next();
      this.jdField_a_of_type_JavaUtilArrayList.remove(localObject2);
    }
    if ((this.jdField_a_of_type_Bijr != null) && (this.jdField_a_of_type_Bijr.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem != null) && (this.jdField_a_of_type_Bijr.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.e())) {
      this.jdField_a_of_type_Bijr = null;
    }
  }
  ...
  public void g()
  {
    ...
    {
      b(6);
      bijr.b(this.jdField_b_of_type_Bijr);
    }
  }
  ...
  public void h()
  {
    if (this.jdField_a_of_type_Bijr != null)
    {
      this.jdField_a_of_type_JavaUtilArrayList.remove(this.jdField_a_of_type_Bijr);
      this.jdField_a_of_type_Bijr.c();
      urk.b(jdField_a_of_type_JavaLangString, "delete " + this.jdField_a_of_type_Bijr);
      this.jdField_a_of_type_Bijr = null;
    }
    if (this.jdField_a_of_type_JavaUtilArrayList.size() == 0)
    {
  ...
  public void i()
  {
    if ((this.jdField_a_of_type_Bijr != null) && (this.jdField_a_of_type_Bijr.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem != null)) {
      this.jdField_a_of_type_Bijr.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.a(-1, false);
    }
    if (this.jdField_a_of_type_JavaUtilArrayList != null)
    {
      ...
      {
        bijr localbijr = (bijr)localIterator.next();
        if (localbijr.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem != null) {
          localbijr.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.a(-1, false);
        }
      }
    }
    k();
  ...
  public void j()
  {
    if ((this.jdField_a_of_type_Bijr != null) && (!this.jdField_a_of_type_Bijr.a())) {
      this.jdField_a_of_type_Bijr.d();
    }
  }
}
