  ...
  extends acve
{
  ...
  public void a(im_msg_body.Elem paramElem, List<MessageRecord> paramList, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bcse parambcse)
  {
    ...
    if (localObject2 != null)
    {
      ...
      if (i == 1)
      {
        ...
        {
          paramStringBuilder = (bjxa)((MessageHandler)localObject1).app.getManager(QQManagerFactory.QIDIAN_MANAGER);
          if (!paramStringBuilder.a.containsKey(paramElem)) {
            paramStringBuilder.a(new BmqqAccountType(paramElem, 1));
          }
        }
        if ((parambcse != null) && (parambcse.a == 1024)) {
          parambcse.a = 1025;
        }
      }
    ...
    while (!QLog.isColorLevel()) {
      try
      {
        ...
        if ((i == 8) && (paramElem.qidian_group_msg.has()))
        {
          ...
          bcrx.a((MessageHandler)localObject1, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
          if (j != 0)
          {
            paramStringBuilder = (bjyi)localQQAppInterface.getBusinessHandler(BusinessHandlerFactory.QIDIAN_HANDLER);
        ...
        if ((i == 11) && (paramElem.msg_gray_msg.has()))
        {
          ...
          bjyv.a(localQQAppInterface, String.valueOf(l1), paramStringBuilder, 1024, ((StringBuilder)localObject1).toString());
        }
        if (paramElem.str_check_id.has()) {
          bjyv.a(localQQAppInterface, paramList, paramMsg, parambcse, paramElem);
        }
        if ((parambcse != null) && (parambcse.a == 1024) && (paramElem.str_ext_nick_name.has()))
        {
  ...
  public boolean a(List<im_msg_body.Elem> paramList, msg_comm.Msg paramMsg, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, boolean paramBoolean1, boolean paramBoolean2, bffl parambffl, bcse parambcse, bcre parambcre)
  {
    ...
    {
      parambffl = (im_msg_body.Elem)paramList.next();
      if (a(parambffl)) {
        a(parambffl, paramList1, paramStringBuilder, paramMsg, parambcse);
      }
    }
    return false;
  }
