  ...
  extends azkz
{
  ...
  axix(axiw paramaxiw, ArrayList paramArrayList, HashMap paramHashMap, MessageRecord paramMessageRecord, axif paramaxif, axiu paramaxiu) {}
  
  private int a(MessageForPic paramMessageForPic, azkf paramazkf)
  {
    ...
    for (;;)
    {
      ...
      paramMessageForPic.md5 = FileUtils.calcMd5(axio.a);
      ...
      for (;;)
      {
        if (i != 0)
        {
          ...
          if (paramazkf.jdField_a_of_type_Int == 0)
          {
            ...
            if (QLog.isColorLevel()) {
              QLog.e("PicMultiMsgProcessor", 2, "WTF, picResult.mExtraObj is " + paramazkf.jdField_a_of_type_JavaLangObject.getClass().getSimpleName());
            }
            i = 0;
            continue;
          }
      ...
      label591:
      for (int j = paramazkf.jdField_a_of_type_Azkb.jdField_a_of_type_Int;; j = -1)
      {
        i = j;
        if (!QLog.isColorLevel()) {
          break;
  ...
  private boolean a(ArrayList<azkf> paramArrayList)
  {
    ...
    if (n < this.b.size())
    {
      ...
      {
        i = k;
        if (((azkf)paramArrayList.get(j)).b) {
          i = 1;
        }
      }
      if (((localObject1 instanceof MessageForPic)) || (((localObject1 instanceof MessageForReplyText)) && (((MessageForReplyText)localObject1).getSourceMessage() != null) && ((((MessageForReplyText)localObject1).getSourceMessage() instanceof MessageForPic))))
      {
        ...
        if ((localObject1 instanceof MessageForReplyText))
        {
          ...
          m = a((MessageForPic)localObject1, (azkf)paramArrayList.get(j));
          k = i;
          bool2 = bool1;
          if (m != 0)
          {
            b(m);
            if (!this.jdField_a_of_type_Axiw.a(m)) {
              break label288;
            }
            bool2 = true;
            k = i;
        ...
        for (;;)
        {
          ...
          break label152;
          localObject2 = this.jdField_a_of_type_Axiw.a.getMultiMessageProxy().a((MessageRecord)localObject1, axiw.a(), false);
          ...
          bool2 = this.jdField_a_of_type_Axiw.a.getMultiMessageProxy().a(this.jdField_a_of_type_JavaUtilHashMap, (MessageRecord)localObject2);
          if (QLog.isColorLevel()) {
      ...
      if (((localObject1 instanceof MessageForMixedMsg)) || (((localObject1 instanceof MessageForReplyText)) && (((MessageForReplyText)localObject1).getSourceMessage() != null) && ((((MessageForReplyText)localObject1).getSourceMessage() instanceof MessageForMixedMsg)))) {
        if ((localObject1 instanceof MessageForReplyText))
        {
          ...
          m = a((MessageForPic)localObject2, (azkf)paramArrayList.get(j));
          k = i;
          bool2 = bool1;
          if (m != 0)
          {
    ...
    for (;;)
    {
      ...
      break label483;
      label724:
      localObject2 = this.jdField_a_of_type_Axiw.a.getMultiMessageProxy().a((MessageRecord)localObject2, anvx.a(2131707611), false);
      ...
      for (;;)
      {
        ...
        if (((Iterator)localObject1).hasNext())
        {
          ...
          i1 = a((MessageForPic)localObject3, (azkf)paramArrayList.get(j));
          k = i;
          bool2 = bool1;
          if (i1 != 0)
          {
            b(i1);
            if (this.jdField_a_of_type_Axiw.a(i1))
            {
              bool2 = true;
              k = i;
            }
        ...
        for (;;)
        {
          ...
          break label905;
          localObject3 = this.jdField_a_of_type_Axiw.a.getMultiMessageProxy().a((MessageRecord)localObject3, anvx.a(2131707612), false);
          ...
          if (((localObject1 instanceof MessageForStructing)) || (((localObject1 instanceof MessageForReplyText)) && (((MessageForReplyText)localObject1).getSourceMessage() != null) && ((((MessageForReplyText)localObject1).getSourceMessage() instanceof MessageForMixedMsg))))
          {
            ...
            for (;;)
            {
              if ((localObject2 != null) && ((localObject2 instanceof StructMsgForImageShare)))
              {
                ...
                if ((localObject2 != null) && (((bdqa)localObject2).a != null))
                {
                  localObject2 = ((bdqa)localObject2).a;
                  if (QLog.isColorLevel()) {
                    QLog.d("PicMultiMsgProcessor", 2, "updateMessageForPic for MessageForPic, MsgIndex[" + n + "], resultIndex[" + j + "]");
                  }
                  ...
                  k = a((MessageForPic)localObject2, (azkf)paramArrayList.get(j));
                  bool2 = bool1;
                  if (k != 0)
                  {
                    b(k);
                    bool2 = bool1;
                    if (this.jdField_a_of_type_Axiw.a(k)) {
                      bool2 = true;
                    }
                  }
                  k = j + 1;
                  ...
                  if (k != 0)
                  {
                    if (this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.isReMultiMsg) {
                      bdla.b(this.jdField_a_of_type_Axiw.a, "CliOper", "", "", "0X800662B", "0X800662B", 0, 1, 0, "", "", "", "");
                    }
                    if (QLog.isColorLevel()) {
                      QLog.e("PicMultiMsgProcessor", 2, "requestUploadPics isPicMsgModify");
                    }
                    this.jdField_a_of_type_Axiw.a.getProxyManager().a().a(this.b, null);
                  }
                  if (this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.isReMultiMsg) {
                    bdla.b(this.jdField_a_of_type_Axiw.a, "CliOper", "", "", "0X800662A", "0X800662A", 0, 1, 0, "", "", "", "");
                  }
                  return bool1;
                }
              }
  ...
  public void a(int paramInt, ArrayList<azkf> paramArrayList)
  {
    if ((paramInt == 0) && (paramArrayList != null) && (paramArrayList.size() > 0))
    {
      ...
      for (bool1 = true;; bool1 = false)
      {
        ...
        this.jdField_a_of_type_Axif.a(1, 1, this.jdField_a_of_type_Axiu);
        return;
    ...
    label317:
    this.jdField_a_of_type_Axif.a(0, 1, this.jdField_a_of_type_Axiu);
  }
}
