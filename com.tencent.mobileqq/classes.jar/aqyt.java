...
public class aqyt
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = anzj.a(2131701316);
  }
  ...
  public static im_msg_body.Elem a(MessageRecord paramMessageRecord)
  {
    ...
    do
    {
      ...
      localC2CConfessContext.uint64_confessor_uin.set(Long.parseLong(((aqyq)localObject2).jdField_c_of_type_JavaLangString));
      localC2CConfessContext.uint64_confess_to_uin.set(Long.parseLong(((aqyq)localObject2).jdField_b_of_type_JavaLangString));
      localC2CConfessContext.uint64_send_uin.set(Long.parseLong(paramMessageRecord.senderuin));
      localC2CConfessContext.bytes_confess.set(ByteStringMicro.copyFromUtf8(((aqyq)localObject2).jdField_d_of_type_JavaLangString));
      localC2CConfessContext.bytes_confessor_nick.set(ByteStringMicro.copyFromUtf8(((aqyq)localObject2).jdField_e_of_type_JavaLangString));
      localC2CConfessContext.uint64_confess_time.set(((aqyq)localObject2).jdField_a_of_type_Long);
      localC2CConfessContext.uint32_bg_type.set(((aqyq)localObject2).jdField_b_of_type_Int);
      localC2CConfessContext.uint32_topic_id.set(((aqyq)localObject2).jdField_a_of_type_Int);
      localC2CConfessContext.uint32_confessor_sex.set(((aqyq)localObject2).jdField_c_of_type_Int);
      localC2CConfessContext.uint32_confess_num.set(((aqyq)localObject2).jdField_d_of_type_Int);
      localC2CConfessContext.uint32_biz_type.set(((aqyq)localObject2).f);
      localC2CConfessContext.uint32_confess_to_sex.set(((aqyq)localObject2).jdField_e_of_type_Int);
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if ((paramQQAppInterface != null) && (aqyl.a(paramQQAppInterface, "redpoint_leba_show"))) {
      aqyl.a(paramQQAppInterface, "redpoint_leba_show", 0L);
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt1, String paramString1, int paramInt2, String paramString2)
  {
    ...
    paramQQAppInterface = (aqyp)paramQQAppInterface.getManager(269);
    ...
    {
      paramString1 = String.format("&topicId=%d&fromEncodeUin=%s&fromGender=%d&toUin=%s", new Object[] { Integer.valueOf(paramInt1), axwz.a(paramString1), Integer.valueOf(paramInt2), axwz.a(paramString2) });
  ...
  public static void a(QQAppInterface paramQQAppInterface, RecentItemConfessMsg paramRecentItemConfessMsg, boolean paramBoolean)
  {
    ...
    {
      return;
      if ((paramRecentItemConfessMsg.mType == 1032) && (TextUtils.equals(paramRecentItemConfessMsg.mUin, antf.aN))) {
      ...
      while (QLog.isDevelopLevel())
      {
        ...
        return;
        int i = paramQQAppInterface.a().a(paramRecentItemConfessMsg.getRecentUserUin(), paramRecentItemConfessMsg.getRecentUserType(), paramRecentItemConfessMsg.mConfessInfo.topicId);
        if (paramBoolean) {
          paramQQAppInterface.a().a(antf.aM, 1032, paramRecentItemConfessMsg.getRecentUserUin(), paramQQAppInterface.getCurrentAccountUin(), paramRecentItemConfessMsg.mType, paramRecentItemConfessMsg.mConfessInfo.topicId);
        }
        if (i > 0) {
          paramQQAppInterface.a().a(paramRecentItemConfessMsg.getRecentUserUin(), paramRecentItemConfessMsg.getRecentUserType(), paramRecentItemConfessMsg.mConfessInfo.topicId, true, false);
        }
      }
    }
  }
  ...
  {
    if ((paramInt2 <= 0) || (adak.a(paramInt1) != 1032)) {
      if (QLog.isColorLevel()) {
    ...
    {
      return;
      localConfessInfo = ((aqyp)paramQQAppInterface.getManager(269)).a().a(paramString, paramInt1, paramInt2);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2, ConfessInfo paramConfessInfo)
  {
    ...
    Object localObject1 = ((aqyp)paramQQAppInterface.getManager(269)).b();
    int i;
    long l;
    if (localObject1 == null)
    {
      i = 24;
      Object localObject2 = String.format(aqyl.jdField_d_of_type_JavaLangString, new Object[] { Integer.valueOf(i) });
      localObject1 = anzj.a(2131701314);
      i = ((String)localObject2).indexOf((String)localObject1);
      int j = ((String)localObject1).length();
      localObject1 = new avpd(paramString, paramString, (String)localObject2, paramInt1, -5020, 655369, bcrg.a());
      ((avpd)localObject1).jdField_c_of_type_JavaLangString = ((String)localObject2);
      localObject2 = new Bundle();
      ((Bundle)localObject2).putInt("key_action", 31);
      ((avpd)localObject1).a(i, j + i, (Bundle)localObject2);
      ...
      paramString.initGrayTipMsg(paramQQAppInterface, (avpd)localObject1);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    avpd localavpd = new avpd(paramString1, paramString1, paramString2, paramInt1, -5040, 655377, bcrg.a());
    localavpd.jdField_c_of_type_JavaLangString = paramString2;
    String str = anzj.a(2131701311);
    int i = paramString2.indexOf(str);
    int j = str.length();
    paramString2 = new Bundle();
    paramString2.putInt("key_action", 34);
    localavpd.a(i, j + i, paramString2);
    ...
    if ((paramString1 != null) && (!paramString1.isEmpty()))
    {
      ...
      paramString1.initGrayTipMsg(paramQQAppInterface, localavpd);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt1, int paramInt2, ConfessInfo paramConfessInfo)
  {
    if (QLog.isColorLevel())
    {
      localObject = bhjx.a(paramString2);
      if (paramConfessInfo != null) {
        break label75;
      }
    }
    ...
    Object localObject = new avpd(paramString1, paramString1, paramString2, paramInt1, -5020, 655376, bcrg.a());
    ((avpd)localObject).jdField_c_of_type_JavaLangString = paramString2;
    paramString1 = paramQQAppInterface.a().a(paramString1, paramInt1);
    long l;
    if ((paramString1 != null) && (!paramString1.isEmpty()))
    {
      l = ((ChatMessage)paramString1.get(paramString1.size() - 1)).shmsgseq;
      paramString1 = new MessageForUniteGrayTip();
      paramString1.initGrayTipMsg(paramQQAppInterface, (avpd)localObject);
      paramString1.isread = true;
      paramString1.shmsgseq = l;
      paramString1.mNeedTimeStamp = true;
      paramString1.updateUniteGrayTipMsgData(paramQQAppInterface);
  ...
  public static void a(QQAppInterface paramQQAppInterface, List<MessageRecord> paramList)
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      if ((localMessageRecord.isSend()) || (adak.a(localMessageRecord.istroop) != 1032) || (!a(localMessageRecord))) {
        break label429;
      }
      ...
      if (((MessageRecord)((List)localObject2).get(j)).getConfessTopicId() == localMessageRecord.getConfessTopicId())
      {
        ...
        if (i == 0)
        {
          ...
          {
            localObject2 = bcry.a(paramQQAppInterface, paramQQAppInterface.c(), localMessageRecord.senderuin, null, localMessageRecord.istroop, (byte)0, (byte)0, (short)0, (String)localObject1);
  ...
  {
    aqyl.a(paramQQAppInterface, "redpoint_box_show", 0L);
    aqyl.a(paramQQAppInterface, "redpoint_clear_time", bcrg.a());
  }
  ...
  {
    if ((paramMessageRecord != null) && (paramMessageRecord.istroop == 1032) && (antf.aM.equals(paramMessageRecord.frienduin)))
    {
      if (QLog.isColorLevel()) {
  ...
  public static void a(msg_comm.Msg paramMsg, im_msg_body.Elem paramElem, List<MessageRecord> paramList, QQAppInterface paramQQAppInterface)
  {
      ...
      do
      {
        do
        {
          ...
          for (;;)
          {
            ...
            paramList = (aqyp)paramQQAppInterface.getManager(269);
            if (paramList.a(paramElem, (String)localObject3, str1, i) != 1) {
              break;
            }
            localObject1 = new aqyq();
            ((aqyq)localObject1).jdField_a_of_type_Int = i;
            ((aqyq)localObject1).jdField_b_of_type_Int = ((hummer_commelem.MsgElemInfo_servtype21.C2CConfessContext)localObject2).uint32_bg_type.get();
            ((aqyq)localObject1).jdField_b_of_type_JavaLangString = ((String)localObject3);
            ((aqyq)localObject1).jdField_c_of_type_JavaLangString = str1;
            ((aqyq)localObject1).jdField_d_of_type_JavaLangString = ((hummer_commelem.MsgElemInfo_servtype21.C2CConfessContext)localObject2).bytes_confess.get().toStringUtf8();
            ((aqyq)localObject1).jdField_e_of_type_JavaLangString = ((hummer_commelem.MsgElemInfo_servtype21.C2CConfessContext)localObject2).bytes_confessor_nick.get().toStringUtf8();
            ((aqyq)localObject1).jdField_a_of_type_JavaLangString = paramQQAppInterface.getCurrentNickname();
            ...
            ((aqyq)localObject1).jdField_c_of_type_Int = i;
            ...
            ((aqyq)localObject1).jdField_a_of_type_Long = l1;
            ...
            ((aqyq)localObject1).jdField_d_of_type_Int = i;
            ...
            ((aqyq)localObject1).jdField_e_of_type_Int = i;
            l1 = ((msg_comm.MsgHead)paramMsg.msg_head.get()).msg_time.get() - 1L;
            l2 = ((msg_comm.MsgHead)paramMsg.msg_head.get()).msg_seq.get() - 1L;
            paramList.a(paramElem, (aqyq)localObject1, l1, l2);
            if (!QLog.isColorLevel()) {
              break;
            }
            l3 = bcrg.a();
            QLog.i("ConfessMsgUtil", 2, "decodeConfessMsgElem strConfessorDesc:" + ((aqyq)localObject1).jdField_d_of_type_JavaLangString + " msgTime:" + l1 + " msgSeq:" + l2 + " nowTime" + l3);
            return;
    ...
    Object localObject1 = (aqyp)paramQQAppInterface.getManager(269);
    int k = ((aqyp)localObject1).a(paramElem, paramList, str1, str2, j);
    if ((i == 0) && (k == 1))
    {
      localObject2 = new aqyr();
      ((aqyr)localObject2).jdField_a_of_type_JavaLangString = paramElem;
      ((aqyr)localObject2).jdField_a_of_type_Int = j;
      ((aqyr)localObject2).jdField_b_of_type_Int = (j % 4);
      ((aqyr)localObject2).jdField_d_of_type_JavaLangString = paramList;
      ((aqyr)localObject2).jdField_e_of_type_JavaLangString = str2;
      ...
      label1784:
      ((aqyr)localObject2).jdField_c_of_type_Int = i;
      ...
      if (TextUtils.isEmpty(paramList)) {
        if (((aqyr)localObject2).jdField_c_of_type_Int == 1)
        {
          paramList = anzj.a(2131701312);
          label1837:
          ((aqyr)localObject2).g = paramList;
          label1843:
          ...
          label1866:
          ((aqyr)localObject2).jdField_c_of_type_JavaLangString = paramList;
          ...
          label1893:
          ((aqyr)localObject2).jdField_a_of_type_Long = l1;
    ...
    {
      ((aqyr)localObject2).jdField_d_of_type_Int = i;
      ((aqyr)localObject2).jdField_b_of_type_JavaLangString = str1;
      ...
      if ((l4 < l1 - 5L) && (l1 >= 0L))
      {
        ...
        ThreadManager.getSubThreadHandler().postDelayed(new ConfessMsgUtil.1((aqyp)localObject1, paramElem, (aqyr)localObject2, l3, l4), 250L);
        return;
        paramList = anzj.a(2131701315);
        break label1837;
        ((aqyr)localObject2).g = paramList;
        break label1843;
      }
      ((aqyp)localObject1).a(paramElem, (aqyr)localObject2, l3, l3, l4);
      if (!QLog.isColorLevel()) {
        break;
      }
      l1 = bcrg.a();
      QLog.i("ConfessMsgUtil", 2, "decodeConfessMsgElem 2 strConfessorDesc:" + ((aqyr)localObject2).f + " msgTime:" + l3 + " msgSeq:" + l4 + " nowTime" + l1);
      return;
      if ((!paramMsg.msg_head.has()) || (!((msg_comm.MsgHead)paramMsg.msg_head.get()).msg_seq.has())) {
        break;
      }
      ((aqyp)localObject1).a(paramElem, paramList, str1, str2, j, ((msg_comm.MsgHead)paramMsg.msg_head.get()).msg_seq.get());
      return;
      i = 0;
      paramElem = "";
      break label1558;
  ...
  {
    if ((adak.a(paramInt1) == 1032) || (adak.a(paramInt3) == 1032)) {}
  ...
  public static im_msg_body.Elem b(MessageRecord paramMessageRecord)
  {
    ...
    do
    {
      ...
      localGroupConfessContext.uint64_confessor_uin.set(Long.parseLong(((aqyr)localObject2).jdField_e_of_type_JavaLangString));
      localGroupConfessContext.uint64_confess_to_uin.set(Long.parseLong(((aqyr)localObject2).jdField_d_of_type_JavaLangString));
      localGroupConfessContext.uint64_send_uin.set(Long.parseLong(paramMessageRecord.senderuin));
      localGroupConfessContext.bytes_topic.set(ByteStringMicro.copyFromUtf8(((aqyr)localObject2).f));
      localGroupConfessContext.bytes_confess_to_nick.set(ByteStringMicro.copyFromUtf8(((aqyr)localObject2).jdField_c_of_type_JavaLangString));
      localGroupConfessContext.uint64_confess_time.set(((aqyr)localObject2).jdField_a_of_type_Long);
      localGroupConfessContext.uint32_topic_id.set(((aqyr)localObject2).jdField_a_of_type_Int);
      localGroupConfessContext.uint32_confessor_sex.set(((aqyr)localObject2).jdField_c_of_type_Int);
      localGroupConfessContext.uint32_confess_to_nick_type.set(((aqyr)localObject2).jdField_d_of_type_Int);
      localGroupConfessContext.bytes_confessor_nick.set(ByteStringMicro.copyFromUtf8(((aqyr)localObject2).g));
  ...
  public static void b(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, String paramString)
  {
    ...
    do
    {
      ...
      aqyr localaqyr = paramQQAppInterface.a();
      if (localaqyr != null)
      {
        paramMessageRecord.saveExtInfoToExtStr("ext_key_group_chat_confess_info", localaqyr.a());
        paramQQAppInterface.a(paramString, localaqyr.jdField_d_of_type_JavaLangString, localaqyr.jdField_b_of_type_JavaLangString, localaqyr.jdField_e_of_type_JavaLangString, localaqyr.jdField_a_of_type_Int);
      }
    } while (!QLog.isColorLevel());
  ...
  public static void b(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    {
      return;
      localObject = (aysq)paramQQAppInterface.getManager(160);
      RedTouchItem localRedTouchItem = ((aysq)localObject).a(10018);
      if ((paramBoolean) && (localRedTouchItem != null)) {
        localRedTouchItem.extMsgs = null;
      }
      ((aysq)localObject).a(10018);
      localObject = ((aqyp)paramQQAppInterface.getManager(269)).a();
      if ((localObject != null) && (((aqzb)localObject).jdField_a_of_type_Int > 0)) {
        break;
      }
    } while (!QLog.isDevelopLevel());
    ...
    boolean bool2;
    if (localObject != null) {
      if (((aqzb)localObject).jdField_a_of_type_Int != 0)
      {
        bool1 = true;
        ((aqzb)localObject).jdField_a_of_type_Int = 0;
        bool2 = bool1;
        if (paramBoolean)
        {
          bool2 = bool1 | ((aqzb)localObject).a();
          ((aqzb)localObject).jdField_a_of_type_JavaLangString = "";
          ((aqzb)localObject).jdField_c_of_type_JavaLangString = "";
          ((aqzb)localObject).jdField_b_of_type_JavaLangString = "";
          ((aqzb)localObject).jdField_b_of_type_Int = 0;
        }
        ThreadManager.post(new ConfessMsgUtil.2((aqzb)localObject), 8, null, false);
      }
    }
    for (;;)
    {
      if (bool2) {
        ((aqym)paramQQAppInterface.a(125)).a((aqzb)localObject);
      }
