  ...
  implements ayeo
{
  ...
  public awcq(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, String paramString, int paramInt)
  {
  ...
  public void onSend(ayep paramayep)
  {
    if (paramayep.jdField_a_of_type_Int == 0)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("MultiMsg_TAG", 2, "send real struct msg done, cost : " + (System.currentTimeMillis() - awcm.b()));
      }
      return;
    }
    if (QLog.isColorLevel()) {
