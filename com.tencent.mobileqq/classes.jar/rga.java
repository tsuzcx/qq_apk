  ...
  implements tbx
{
  ...
  public rga(ArticleInfo paramArticleInfo, int paramInt, Context paramContext, Resources paramResources, rfw paramrfw)
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo != null)
    {
      ...
      if (this.jdField_a_of_type_Rfw != null)
      {
        ...
        if (this.jdField_a_of_type_Rfw.a != null) {
          i = this.jdField_a_of_type_Rfw.a.e();
        }
      }
      pqb.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo, i);
      return;
    }
