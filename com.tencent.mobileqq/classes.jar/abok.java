...
public class abok
  implements Runnable
{
  public abok(ARMapPOIStarDialog paramARMapPOIStarDialog) {}
  ...
  public void run()
  {
    ...
    QQToast.a(this.a.jdField_a_of_type_AndroidContentContext, 2131438795, 1).b(this.a.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131558448));
  }
}
