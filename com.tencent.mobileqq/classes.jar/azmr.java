...
public class azmr
{
  ...
  {
    byte[] arrayOfByte = bbdj.a(BaseApplication.getContext().getFileStreamPath("0x496_aio_keyword"));
  ...
  public static List<azms> a(oidb_0x496.AioKeyword paramAioKeyword)
  {
    ...
    while (paramAioKeyword.hasNext())
    {
      ...
      localazms.jdField_a_of_type_JavaLangString = localAioKeywordInfo.word.get();
      localazms.jdField_a_of_type_JavaUtilList = localAioKeywordInfo.rule_id.get();
      localArrayList.add(localazms);
    }
    return localArrayList;
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, oidb_0x496.AioKeyword paramAioKeyword)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = localFileOutputStream;
        localObject2 = localFileOutputStream;
        bbjn.O(BaseApplicationImpl.getApplication(), paramQQAppInterface.getCurrentAccountUin(), paramAioKeyword.version.get());
      }
  ...
  public static List<azmt> b(oidb_0x496.AioKeyword paramAioKeyword)
  {
    ...
    while (paramAioKeyword.hasNext())
    {
      ...
      azmt localazmt = new azmt();
      localazmt.jdField_a_of_type_Int = localAioKeywordRuleInfo.rule_id.get();
      localazmt.b = localAioKeywordRuleInfo.start_time.get();
      localazmt.c = localAioKeywordRuleInfo.end_time.get();
      localazmt.d = localAioKeywordRuleInfo.postion_flag.get();
      localazmt.jdField_a_of_type_JavaUtilList = localAioKeywordRuleInfo.match_group_class.get();
      localazmt.e = localAioKeywordRuleInfo.version.get();
      localArrayList.add(localazmt);
    }
    return localArrayList;
  }
}
