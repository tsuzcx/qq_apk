...
{
  private static bbqj jdField_a_of_type_Bbqj;
  ...
  private bbqj(String paramString)
  {
    super(paramString);
  }
  
  public static bbqj a()
  {
    try
    {
      if (jdField_a_of_type_Bbqj == null) {
        jdField_a_of_type_Bbqj = new bbqj("VasApngIPCModule");
      }
      bbqj localbbqj = jdField_a_of_type_Bbqj;
      return localbbqj;
    }
    finally {}
  }
  ...
  public void a(int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (bbkv.a(str2, str1, "libAPNG_release_813.so"))
      {
  ...
  public void a(URLDrawableHandler paramURLDrawableHandler, boolean paramBoolean)
  {
    ...
    QIPCClientHelper.getInstance().callServer("VasApngIPCModule", jdField_a_of_type_JavaLangString, null, new bbqk(this, paramURLDrawableHandler));
  }
        ...
        if (!TextUtils.isEmpty(str))
        {
          ...
          if (new File(str).exists())
          {
            ...
            catch (Throwable localThrowable)
            {
              ...
              axqw.b(null, "CliOper", "", "", "Font_Mall", "0X80073FE", 0, 0, "101", "", "", "");
              break label206;
            }
          }
