  ...
  extends alpd
{
  ...
  public bema(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_AndroidSupportV4UtilLruCache = new LruCache(100);
    this.jdField_a_of_type_Bemi = new bemi();
    this.jdField_a_of_type_Bemq = null;
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new bemg(this);
  ...
  public bemq a(String paramString)
  {
    if (this.jdField_a_of_type_Bemq == null) {
      this.jdField_a_of_type_Bemq = new bemq(paramString);
    }
    if (!TextUtils.isEmpty(paramString)) {
      this.jdField_a_of_type_Bemq.jdField_a_of_type_JavaLangString = paramString;
    }
    return this.jdField_a_of_type_Bemq;
  }
  
  protected nac a(bemh<oidb_0x8e4.RspBody> parambemh)
  {
    return new beme(this, parambemh);
  }
  ...
  public void a(int paramInt1, int paramInt2, bemh<oidb_0x8e4.RspBody> parambemh)
  {
    ...
    mzy.a(this.app, a(parambemh), localReqBody.toByteArray(), "OidbSvc.0x8e4_1", 2276, 1, new Bundle(), 5000L);
  }
  ...
  public void a(TextView paramTextView, String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      if (((alto)localObject).b(paramString1))
      {
        paramString1 = bdgc.j(this.app, paramString1);
        try
        {
      ...
      localObject = ((alto)localObject).a(paramString1);
  ...
  public void a(bemh<oidb_0x8e4.RspBody> parambemh)
  {
    if (QLog.isColorLevel()) {
      QLog.e("WerewolvesHandler", 2, "reqInviteId");
    }
    oidb_0x8e4.ReqBody localReqBody = new oidb_0x8e4.ReqBody();
    mzy.a(this.app, a(parambemh), localReqBody.toByteArray(), "OidbSvc.0x8e4_6", 2276, 6, new Bundle(), 5000L);
  }
  ...
  public void a(HotChatInfo paramHotChatInfo, int paramInt1, int paramInt2, bemh<oidb_0x8e4.RspBody> parambemh)
  {
    if (QLog.isColorLevel()) {
      QLog.e("WerewolvesHandler", 2, "exitRoom");
    }
    oidb_0x8ed.ReqBody localReqBody = new oidb_0x8ed.ReqBody();
    bemc localbemc = new bemc(this, parambemh);
    try
    {
      long l = Long.parseLong(paramHotChatInfo.troopUin);
      localReqBody.uint64_room_id.set(l, true);
      localReqBody.rpt_uint64_uins.add(Long.valueOf(this.app.getLongAccountUin()));
      mzy.a(this.app, b(new bemd(this, localbemc, paramHotChatInfo, l, paramInt2, paramInt1, parambemh)), localReqBody.toByteArray(), "OidbSvc.0x8ed_2", 2285, 2, new Bundle(), 5000L);
      return;
    }
    catch (Exception paramHotChatInfo)
    {
  ...
  public void a(HotChatInfo paramHotChatInfo, bemh<oidb_0x8ed.RspBody> parambemh)
  {
    if (QLog.isColorLevel()) {
      QLog.e("WerewolvesHandler", 2, "exitRoom");
    }
    ...
    try
    {
      ...
      localReqBody.uint64_room_id.set(l, true);
      localReqBody.rpt_uint64_uins.add(Long.valueOf(this.app.getLongAccountUin()));
      mzy.a(this.app, b(new bemb(this, parambemh, paramHotChatInfo)), localReqBody.toByteArray(), "OidbSvc.0x8ed_2", 2285, 2, new Bundle(), 5000L);
      auxp.a().a(l);
      auwq.a(this.app.getCurrentAccountUin(), "game_room_last_time", Long.valueOf(ayzl.a()));
      try
      {
  ...
  public void a(String paramString, long paramLong, bemh<oidb_0x8e4.RspBody> parambemh)
  {
    if (QLog.isColorLevel()) {
    ...
    mzy.a(this.app, a(parambemh), localReqBody.toByteArray(), "OidbSvc.0x8e4_5", 2276, 5, new Bundle(), 5000L);
  }
  
  public void a(String paramString, bemh<oidb_0x8e4.RspBody> parambemh)
  {
    oidb_0x8e4.ReqBody localReqBody = new oidb_0x8e4.ReqBody();
    localReqBody.string_invite_id.set(ByteStringMicro.copyFromUtf8(paramString), true);
    mzy.a(this.app, a(parambemh), localReqBody.toByteArray(), "OidbSvc.0x8e4_3", 2276, 3, new Bundle(), 5000L);
  }
  
  public void a(String paramString, boolean paramBoolean, bemh<oidb_0x8e4.RspBody> parambemh)
  {
    if (TextUtils.isEmpty(paramString))
    {
    ...
    for (int i = 1;; i = 2)
    {
      ...
      mzy.a(this.app, a(parambemh), localReqBody.toByteArray(), "OidbSvc.0x8e4_2", 2276, 2, new Bundle(), 5000L);
      return;
    }
  }
  ...
  public void a(TroopTips0x857.WereWolfPush paramWereWolfPush, byte[] paramArrayOfByte)
  {
    ...
    for (paramWereWolfPush = "";; paramWereWolfPush = str1.substring(0, 1) + "***" + str1.substring(str1.length() - 1) + "|msg len:" + str1.length())
    {
      ...
      this.jdField_a_of_type_Bemq.a("WereWolfPush", paramArrayOfByte);
      return;
    }
  }
  ...
  protected nac b(bemh<oidb_0x8ed.RspBody> parambemh)
  {
    return new bemf(this, parambemh);
  }
  
  public void b(int paramInt1, int paramInt2, bemh<oidb_0x8e4.RspBody> parambemh)
  {
    if (QLog.isColorLevel()) {
    ...
    localReqBody.uint32_zone_id.set(paramInt2);
    mzy.a(this.app, a(parambemh), localReqBody.toByteArray(), "OidbSvc.0x8e4_4", 2276, 4, new Bundle(), 5000L);
  }
  
  public void b(String paramString, bemh<oidb_0x8e4.RspBody> parambemh)
  {
    if (QLog.isColorLevel()) {
  ...
  public void b(String paramString, boolean paramBoolean, bemh<oidb_0x8e4.RspBody> parambemh)
  {
    oidb_0x8e4.ReqBody localReqBody = new oidb_0x8e4.ReqBody();
    ...
    {
      paramString.set(i);
      mzy.a(this.app, a(parambemh), localReqBody.toByteArray(), "OidbSvc.0x8e4_7", 2276, 7, new Bundle(), 5000L);
      return;
    }
  }
  ...
  public void onDestroy()
  {
    ...
    this.jdField_a_of_type_Bemi.removeCallbacksAndMessages(null);
    super.onDestroy();
  }
    ...
    if ("ProfileService.GetSimpleInfo".equals(localObject))
    {
      ...
      if (paramFromServiceMsg.isSuccess())
      {
        ...
        if ((localObject != null) && (paramToServiceMsg != null) && (((ArrayList)localObject).size() > 0) && (paramToServiceMsg.size() > 0))
        {
          ...
          this.jdField_a_of_type_Bemi.sendMessage(paramFromServiceMsg);
        }
      }
    }
  }
