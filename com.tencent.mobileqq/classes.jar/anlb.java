  ...
  extends anii
{
  ...
  private CopyOnWriteArrayList<aruw> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  ...
  public anlb(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(int paramInt, EmosmPb.RspBody paramRspBody)
  {
    ...
    if (paramRspBody.msg_subcmd0x19_rsp.has())
    {
      ...
      localawmr = (awmr)this.app.getManager(14);
      localEmoticonPackage = localawmr.a(String.valueOf(i), paramInt);
      if (localEmoticonPackage != null)
      {
        ...
        if (TextUtils.isEmpty(str)) {
          paramRspBody = anni.a(2131702875);
        }
  ...
  private void a(int paramInt, EmosmPb.RspBody paramRspBody, awmr paramawmr)
  {
    ...
    if (bool1)
    {
      ...
      paramawmr.a(paramRspBody, paramInt);
    }
    if (QLog.isColorLevel()) {
  ...
  private void a(EmosmPb.RspBody paramRspBody)
  {
    ...
    if ((paramRspBody != null) && (paramRspBody.size() > 1))
    {
      ...
      ((arwz)this.app.getManager(172)).a(paramRspBody);
      return;
    }
  ...
  {
    awmr localawmr = (awmr)this.app.getManager(14);
    if (paramInt1 == 2)
    {
      if (paramBoolean)
      {
        ThreadManagerV2.excute(new EmoticonHandler.1(this, localawmr, paramEmoticonResp, paramInt2), 32, null, true);
        return;
      }
    ...
    if (paramInt1 == 3)
    {
      ...
      while (paramFromServiceMsg.hasNext()) {
        ((aruw)paramFromServiceMsg.next()).a(paramBoolean, paramInt1, paramEmoticonResp);
      }
    }
    notifyUI(paramInt1, paramBoolean, paramEmoticonResp);
  }
  
  private void a(ToServiceMsg paramToServiceMsg, int paramInt, EmoticonResp paramEmoticonResp, awmr paramawmr)
  {
    ...
    for (;;)
    {
      ...
      while (paramToServiceMsg.hasNext())
      {
        ...
        paramawmr.g(paramEmoticonResp, paramInt);
        paramEmoticonResp = paramawmr.a(paramEmoticonResp, paramInt);
        aruo.a().b(paramEmoticonResp);
      }
    }
  }
    ...
    for (;;)
    {
      ...
      catch (Exception paramArrayOfByte)
      {
        ...
        case 1: 
          ...
          ((awmr)localObject).g(paramToServiceMsg, j);
          paramToServiceMsg = ((awmr)localObject).a(paramToServiceMsg, j);
          aruo.a().b(paramToServiceMsg);
          break;
        case 17: 
          a(paramToServiceMsg, j, localEmoticonResp, (awmr)localObject);
          break;
        case 2: 
      ...
      if (paramToServiceMsg.extraData.getBoolean("EmosmSubCmdFllow"))
      {
        ...
        a(j, paramArrayOfByte, (awmr)localObject);
        continue;
        a(paramArrayOfByte);
        continue;
        k = paramToServiceMsg.extraData.getInt("tabId");
        paramToServiceMsg = new arza();
    ...
    for (;;)
    {
      try
      {
        ...
        case 1: 
          ...
          if (this.app != null)
          {
            localObject3 = (awmr)this.app.getManager(14);
            if (localObject3 != null)
            {
              localObject1 = ((awmr)localObject3).a((String)localObject1);
              ((EmoticonPackage)localObject1).ipSiteInfo = ((VipIPSiteInfo)localObject2);
              ((EmoticonPackage)localObject1).ipSiteInfoBytes = ((awmr)localObject3).a((VipIPSiteInfo)localObject2);
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    localReqBody.str_app_version.set("8.4.1");
  ...
  public void a(int paramInt, ArrayList<Emoticon> paramArrayList, String paramString)
  {
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      try
      {
        localObject3 = ByteStringMicro.copyFrom(arze.a(((Emoticon)localObject3).eId));
  ...
  {
    if (paramaruw != null) {
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.addIfAbsent(paramaruw);
    }
  }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    paramString.str_app_version.set("8.4.1");
  ...
  public void a(String paramString, List<String> paramList1, List<String> paramList2)
  {
    ...
    paramList2.str_app_version.set("8.4.1");
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    localModuleReq.mqqver.set("8.4.1");
  ...
  public void a(List<String> paramList, boolean paramBoolean, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramList)
      {
        ...
        paramList.str_app_version.set("8.4.1");
  ...
  public void b()
  {
    ...
    localReqBody.str_app_version.set("8.4.1");
    Object localObject1 = ((arwz)this.app.getManager(172)).c();
  ...
  {
    if (paramaruw != null) {
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.remove(paramaruw);
    }
  }
    ...
    if (localObject1 != null)
    {
      ...
      if ((localJSONArray != null) && (localJSONArray.length() > 0))
      {
        ...
        if (i < localJSONArray.length())
        {
          ...
          localObject1 = "";
          if (k == 3) {
            localObject1 = arze.k.replace("[epId]", String.valueOf(j)).replace("[mod]", String.valueOf(j % 10));
          }
          for (;;)
          {
            String str2 = bgyg.a(BaseApplicationImpl.context, "emojiDetail", String.valueOf(j), "") + "&sceneType=1";
            ...
            break;
            if (k == 6) {
              localObject1 = arze.l.replace("[epId]", String.valueOf(j));
            }
          }
        }
        ...
        localObject2 = (awmr)this.app.getManager(14);
        if (localObject2 != null) {
          ((awmr)localObject2).a((EmosmPb.SubCmd0x5RspBQRecommend)localObject1, 1);
        }
      }
    }
  }
