...
public class anlb
{
  ...
  private anlb(Activity paramActivity, ArkAppView paramArkAppView)
  {
    ...
    if (this.jdField_a_of_type_AndroidViewView != null) {
      this.jdField_a_of_type_AndroidViewView.getViewTreeObserver().addOnGlobalLayoutListener(new anlc(this));
    }
  ...
  {
    new anlb(paramActivity, paramArkAppView);
  }
}
