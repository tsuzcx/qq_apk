  ...
  extends BaseAdapter
{
  ...
  public ahzj(Context paramContext, List<Object> paramList, View.OnClickListener paramOnClickListener1, View.OnClickListener paramOnClickListener2, aaji paramaaji)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          localObject1 = paramView;
          if ((paramView.getTag() instanceof ahzk))
          {
            localObject1 = paramView;
            paramViewGroup = (ahzk)paramView.getTag();
            localObject1 = paramView;
            apck.a(paramViewGroup.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView, localFileManagerEntity);
            localObject1 = paramView;
            ...
            localObject1 = paramView;
            apck.a(paramViewGroup.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView, localFileManagerEntity.getFilePath(), localFileManagerEntity.nFileType);
            localObject1 = paramView;
        ...
        case 17: 
          ...
          localObject1 = paramView;
          if (this.jdField_a_of_type_Ahzl == null) {
            break label1239;
          }
          localObject1 = paramView;
          bool = this.jdField_a_of_type_Ahzl.a(localFileManagerEntity);
          localObject1 = paramView;
          paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(bool);
          localObject1 = paramView;
          apck.a(paramViewGroup.b, localFileManagerEntity);
          return paramView;
          localObject1 = paramView;
          localObject2 = new ahzk(this);
          localObject1 = paramView;
          paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131494879, paramViewGroup, false);
          localObject1 = paramView;
          ((ahzk)localObject2).jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131309122));
          localObject1 = paramView;
          ((ahzk)localObject2).jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
          localObject1 = paramView;
          ((ahzk)localObject2).jdField_a_of_type_AndroidWidgetRelativeLayout.setTag(localObject2);
          localObject1 = paramView;
          ((ahzk)localObject2).jdField_a_of_type_ComTencentMobileqqWidgetCircleFileStateView = ((CircleFileStateView)paramView.findViewById(2131296354));
          localObject1 = paramView;
          ((ahzk)localObject2).jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)paramView.findViewById(2131300623));
          localObject1 = paramView;
          ((ahzk)localObject2).jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView = ((AsyncImageView)paramView.findViewById(2131300609));
          localObject1 = paramView;
          ((ahzk)localObject2).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131300621));
          localObject1 = paramView;
          ((ahzk)localObject2).jdField_a_of_type_AndroidWidgetTextView.setMaxLines(2);
          localObject1 = paramView;
          ((ahzk)localObject2).b = ((TextView)paramView.findViewById(2131300607));
          localObject1 = paramView;
          ((ahzk)localObject2).jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setAsyncClipSize(aciy.a(70.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aciy.a(70.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
          localObject1 = paramView;
      ...
      {
        localObject1 = paramView;
        paramViewGroup.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setDefaultImage(2130843395);
        localObject1 = paramView;
      ...
      {
        localObject1 = paramView;
        apck.a(paramViewGroup.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView, localFileManagerEntity.fileName, localFileManagerEntity.nFileType);
        continue;
        label732:
        localObject1 = paramView;
        apck.a(paramViewGroup.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView, localFileManagerEntity);
        ...
        continue;
        localObject1 = paramView;
        bool = apdh.a(localFileManagerEntity.getFilePath());
        localObject1 = paramView;
        ...
        for (;;)
        {
          ...
          paramViewGroup = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131494902, null);
