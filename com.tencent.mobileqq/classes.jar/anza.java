...
public class anza
  implements askq<Integer>
{
  public anza(EmoticonMainPanel paramEmoticonMainPanel, long paramLong) {}
  ...
  public void a(Integer paramInteger)
  {
    ...
    if (paramInteger.size() > EmoticonMainPanel.jdField_e_of_type_Int) {
      if (((aoap)paramInteger.get(EmoticonMainPanel.jdField_e_of_type_Int)).a != 8) {
