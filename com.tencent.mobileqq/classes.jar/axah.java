...
public class axah
  extends altm
{
  public axah(QCallDetailActivity paramQCallDetailActivity) {}
  ...
  protected void onUpdateCustomHead(boolean paramBoolean, String paramString)
  {
    ...
    Object localObject;
    if ((paramBoolean) && (QCallDetailActivity.a(this.a) == 3000) && (!bdeu.a(paramString, this.a.app.getCurrentAccountUin())))
    {
      localObject = (alrk)this.a.app.getManager(53);
      if (localObject != null) {
        break label109;
      }
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      {
        return;
        if (((alrk)localObject).a(QCallDetailActivity.a(this.a)) != null) {
          break;
        }
      ...
      localObject = ((alrk)localObject).a(QCallDetailActivity.a(this.a));
  ...
  protected void onUpdateFriendInfo(String paramString, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      {
        return;
        localDiscussionInfo = ((alrk)localObject).a(QCallDetailActivity.a(this.a));
