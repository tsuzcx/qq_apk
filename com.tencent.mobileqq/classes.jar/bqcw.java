...
{
  public bqcw(EditProviderPart.2 param2) {}
  
  @TargetApi(16)
  public void onGlobalLayout()
  {
    if ((this.a.this$0.jdField_a_of_type_Bqhs == null) || (bqcu.a(this.a.this$0) == null))
    {
    ...
    Object localObject = bqcu.a(this.a.this$0).getViewTreeObserver();
    if (((ViewTreeObserver)localObject).isAlive()) {
      ((ViewTreeObserver)localObject).removeOnGlobalLayoutListener(this);
    }
    localObject = this.a.this$0.jdField_a_of_type_Bqgk.a();
    if (localObject != null)
    {
      int i = ((View)localObject).getLeft();
      int j = ((View)localObject).getWidth() / 2;
      int k = bqcu.a(this.a.this$0).getWidth() / 2;
      bqcu.a(this.a.this$0).setX(j + i - k);
    }
    localObject = (GridView)this.a.this$0.a(2131379271);
    ...
    bpmh localbpmh = new bpmh(this.a.this$0.a(), this.a.this$0.b());
    localbpmh.a = true;
    localbpmh.a(this.a.a);
    ((GridView)localObject).setAdapter(localbpmh);
    ((GridView)localObject).setOnItemClickListener(new bqcx(this, localbpmh));
  }
}
