...
public class pqh
{
  ...
  private void a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    try
    {
      ...
      {
        paramBaseArticleInfo = bfnx.a(paramBaseArticleInfo);
        ...
        {
          paramBaseArticleInfo = (String)bfnx.a(Uri.decode(str)).get("rowkey");
  ...
  private void c()
  {
    ...
    for (;;)
    {
      ...
      this.d = bbfr.a(BaseApplicationImpl.getApplication(), "com.tencent.reading");
      c = false;
      return;
      bool = false;
    }
  ...
  public String a(String paramString)
  {
    ...
    {
      return paramString;
      str = (String)bfnx.a(paramString).get("rowkey");
  ...
  public void a(int paramInt, List<Long> paramList)
  {
    ...
    b(osg.a().a(Integer.valueOf(paramInt), paramList));
  }
