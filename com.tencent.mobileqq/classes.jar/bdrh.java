...
public class bdrh
{
  ...
  public static bdrl[] a;
  public static bdrl b;
  public static bdrl c;
  public static bdrl d;
  public static bdrl e;
  public static bdrl f;
  public static bdrl g;
  public static bdrl h;
  public static bdrl i;
  
  static
  {
    jdField_a_of_type_Bdrl = new bdrl("recommendEmotion.json", "https://i.gtimg.cn/qqshow/admindata/comdata/vipData_emoji_aioPanal/", "https://i.gtimg.cn/qqshow/admindata/comdata/vipData_emoji_aioPanal/xydata.json", "recommendEmotionVersion", "vipData_emoji_aio_recommend.json");
    b = new bdrl("IndividuationUrls.json", "", "https://i.gtimg.cn/qqshow/admindata/comdata/vipData_individuation_url/android.json", "individuationUrlJsonNewVersion", "vipData_individuation_url_json");
    c = new bdrl("Individuation.json", "https://i.gtimg.cn/qqshow/admindata/comdata/vipData_individuation/", "https://i.gtimg.cn/qqshow/admindata/comdata/vipData_individuation/xydata.json", "IndividuationVersion", "individ_json");
    d = new bdrl("EmoticonWording.json", "", "https://i.gtimg.cn/club/item/parcel/client_wording.json", "EmoticonWordingVersion", "wording_json");
    e = new bdrl("WebviewCrashReport.json", "", "https://i.gtimg.cn/qqshow/admindata/comdata/vip_crash_report/WebviewCrashReport.json", "WebviewCrashJSONVersion", "WebviewCrashReport.json");
    f = new bdrl("Qutu_xydata.json", "", "https://i.gtimg.cn/qqshow/admindata/comdata/vipQutu_release_zip/xydata.json", "QutuXYDataJsonVersion", "xydata.json");
    g = new bdrl("iRedPacket_v2.json", "https://i.gtimg.cn/qqshow/admindata/comdata/vipRedPacketDataV2/", "https://i.gtimg.cn/qqshow/admindata/comdata/vipRedPacketDataV2/xydata.mobile.v1.json", "vipRedPacketData_json_v2", "vipRedPacketData_json_v2");
    h = new bdrl("UrlIntercept.json", "https://i.gtimg.cn/qqshow/admindata/comdata/vipData_url_to_api", "https://i.gtimg.cn/qqshow/admindata/comdata/vipData_url_to_api/android.json", "UrlIntercept_json", "UrlIntercept_json");
    i = new bdrl("font_info.json", "https://i.gtimg.cn/qqshow/admindata/comdata/vipList_font_data", "https://i.gtimg.cn/qqshow/admindata/comdata/vipList_font_data/version.json", "FontInfoList_json", "FontInfoList_json");
    jdField_a_of_type_ArrayOfBdrl = new bdrl[] { jdField_a_of_type_Bdrl, c, d };
    jdField_a_of_type_JavaLangString = "https://i.gtimg.cn/xydata";
    jdField_a_of_type_JavaUtilHashMap = new HashMap();
    jdField_a_of_type_Bead = new bdri();
  }
  ...
  public static JSONObject a(QQAppInterface paramQQAppInterface, bdrl parambdrl, boolean paramBoolean)
  {
    Object localObject = paramQQAppInterface.getApplication().getApplicationContext();
    String str = parambdrl.jdField_a_of_type_JavaLangString;
    localObject = new File(((Context)localObject).getFilesDir(), str);
    if (((File)localObject).exists()) {
      try
      {
        paramQQAppInterface = bdhb.a((File)localObject, -1);
    ...
    for (;;)
    {
      ...
      if (paramBoolean) {
        a(paramQQAppInterface, parambdrl);
      }
    }
  }
  ...
  public static void a(AppInterface paramAppInterface, bdrl parambdrl, String paramString, File paramFile, Bundle paramBundle)
  {
    if (paramFile == null) {}
    String str1;
    do
    {
      return;
      str1 = paramString;
    } while ((paramString == null) && (parambdrl == null));
    label427:
    label435:
    label441:
    label444:
    for (;;)
    {
      try
      {
        for (;;)
        {
          ...
          parambdrl = parambdrl.jdField_a_of_type_JavaLangString;
          ...
          String str3 = parambdrl + "_" + j;
          if (QLog.isColorLevel()) {
            QLog.d("ClubContentJsonTask", 2, "club_downloadFile,method:" + paramString + ",key:" + parambdrl + ", server version:" + j + ",ifromet:" + str2);
          }
          ...
          paramFile = new beae(str1, paramFile);
          paramFile.n = true;
          paramFile.jdField_a_of_type_JavaLangString = parambdrl;
          ((beag)paramAppInterface.getManager(47)).a(1).a(paramFile, jdField_a_of_type_Bead, paramBundle);
          if (QLog.isColorLevel()) {
          ...
          try
          {
            ...
            paramString.put("param_key", parambdrl);
            paramString.put("param_ifromet", str2);
            azri.a(paramAppInterface.getApplication().getApplicationContext()).a(paramAppInterface.getAccount(), "VipClubContentJsonTaskLoad", true, 1L, 0L, paramString, "", false);
          }
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    int j = 0;
    while (j < jdField_a_of_type_ArrayOfBdrl.length)
    {
      a(paramQQAppInterface, jdField_a_of_type_ArrayOfBdrl[j]);
      j += 1;
    }
  }
  
  public static void a(QQAppInterface paramQQAppInterface, bdrl parambdrl)
  {
    int j = 10;
    int k = 0;
    if ((paramQQAppInterface == null) || (parambdrl == null)) {}
    do
    {
      return;
      File localFile = new File(paramQQAppInterface.getApplication().getApplicationContext().getFilesDir(), parambdrl.jdField_a_of_type_JavaLangString);
      if (!localFile.exists())
      {
        if (QLog.isColorLevel()) {
          QLog.d("ClubContentJsonTask", 2, "downloadIfNotExist, not exist: " + parambdrl.jdField_a_of_type_JavaLangString);
        }
        for (;;)
        {
          try
          ...
          ((Bundle)localObject).putString("version_key", parambdrl.d);
          ((Bundle)localObject).putString("method", "downloadIfNotExist");
          ((Bundle)localObject).putString("ifromet", "null1");
          a(paramQQAppInterface, parambdrl, apmq.a("VIP_emosm", parambdrl.b), localFile, (Bundle)localObject);
          return;
  ...
  public static void a(QQAppInterface paramQQAppInterface, bdrl parambdrl, int paramInt, boolean paramBoolean)
  {
    File localFile = new File(paramQQAppInterface.getApplication().getApplicationContext().getFilesDir(), parambdrl.jdField_a_of_type_JavaLangString);
    Bundle localBundle = new Bundle();
    localBundle.putInt("version", paramInt);
    localBundle.putString("version_key", parambdrl.d);
    localBundle.putString("method", "updateJson");
    localBundle.putString("ifromet", String.valueOf(paramBoolean));
    a(paramQQAppInterface, parambdrl, null, localFile, localBundle);
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface)
  {
    ...
    //   13: ifnonnull +4 -> 17
    //   16: return
    //   17: getstatic 465	fx:jdField_c_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   20: iconst_0
    //   21: invokevirtual 471	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   24: new 473	bdrj
    //   27: dup
    //   28: invokespecial 474	bdrj:<init>	()V
    //   31: putstatic 476	bdrh:jdField_a_of_type_Bdrj	Lbdrj;
    //   34: aload 6
    //   36: ldc_w 478
    ...
    //   55: invokestatic 491	bdvj:a	(Lmqq/app/AppRuntime;Ljava/lang/String;Ljava/lang/String;)Z
    //   58: pop
    //   59: aload 6
    //   61: ldc_w 493
    ...
    //   178: astore 5
    //   180: getstatic 476	bdrh:jdField_a_of_type_Bdrj	Lbdrj;
    //   183: aload 4
    //   185: putfield 516	bdrj:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   188: getstatic 476	bdrh:jdField_a_of_type_Bdrj	Lbdrj;
    //   191: aload 5
    //   193: putfield 517	bdrj:b	Ljava/lang/String;
    ...
    //   278: istore_3
    //   279: iload_3
    //   280: putstatic 533	fx:jdField_e_of_type_Boolean	Z
    //   283: getstatic 533	fx:jdField_e_of_type_Boolean	Z
    //   286: ifeq +488 -> 774
    //   289: aload 4
    //   291: ldc_w 535
    ...
    //   412: getstatic 537	fx:jdField_f_of_type_Boolean	Z
    ...
    //   436: getstatic 550	fx:jdField_b_of_type_Float	F
    ...
    //   448: getstatic 554	fx:jdField_c_of_type_Float	F
    ...
    //   472: getstatic 562	fx:jdField_e_of_type_Float	F
    ...
    //   484: getstatic 566	fx:jdField_f_of_type_Float	F
    ...
    //   496: getstatic 571	fx:jdField_b_of_type_Int	I
    ...
    //   508: getstatic 465	fx:jdField_c_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   511: iconst_1
    //   512: invokevirtual 471	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   515: getstatic 595	agda:a	Lcom/tencent/util/LRULinkedHashMap;
    //   518: astore 4
    //   520: aload 4
    //   522: monitorenter
    //   523: getstatic 595	agda:a	Lcom/tencent/util/LRULinkedHashMap;
    //   526: invokevirtual 600	com/tencent/util/LRULinkedHashMap:clear	()V
    //   529: aload 4
    //   531: monitorexit
    //   532: aload_0
    //   533: invokestatic 605	bdom:a	(Lcom/tencent/common/app/AppInterface;)V
    //   536: aload 6
    //   538: ldc_w 607
    ...
    //   625: putstatic 627	assg:jdField_a_of_type_Int	I
    //   628: aload 6
    //   630: ldc_w 629
    ...
    //   664: iconst_1
    //   665: iadd
    //   666: putstatic 641	ge:jdField_a_of_type_Int	I
    //   669: getstatic 644	ge:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger	Ljava/util/concurrent/atomic/AtomicInteger;
    //   672: aload_0
    //   673: ldc_w 646
    ...
    //   682: getstatic 653	ge:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   685: astore 4
    //   687: aload_0
    //   688: ldc_w 655
    ...
    //   715: aload_0
    //   716: ifnull -700 -> 16
    //   719: getstatic 660	bdrv:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   722: astore 4
    //   724: aload_0
    //   725: ldc_w 531
