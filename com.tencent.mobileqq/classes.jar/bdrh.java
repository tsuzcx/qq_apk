  ...
  extends bdnv
{
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    {
      if (!((bdnu)((Iterator)localObject1).next() instanceof bdpr)) {
        break label944;
      }
      i += 1;
    }
    ...
    for (;;)
    {
      ...
      if ((paramView != null) && ((paramView instanceof LinearLayout)))
      {
        ...
        paramView = (bdnu)this.jdField_a_of_type_JavaUtilArrayList.get(j);
      ...
      for (;;)
      {
        ...
        if ("button".equals(localObject2))
        {
          ...
          if (i == 0)
          {
            ...
            if (m < n)
            {
              localObject2 = (bdnu)this.jdField_a_of_type_JavaUtilArrayList.get(m);
              ((bdnu)localObject2).jdField_a_of_type_JavaLangRefWeakReference = this.jdField_a_of_type_JavaLangRefWeakReference;
              str = ((bdnu)localObject2).jdField_a_of_type_JavaLangString;
            ...
            ((bdnu)localObject2).jdField_a_of_type_JavaLangRefWeakReference = this.jdField_a_of_type_JavaLangRefWeakReference;
            localObject2 = ((bdnu)localObject2).a(paramContext, null, paramBundle);
            j = 0;
            if (m == 0)
            {
              j = 2131378132;
            ...
            for (;;)
            {
              ...
              if ("button".equals(str))
              {
                ...
                j = AIOUtils.dp2px(10.0F, localResources);
                ...
                if (k < n)
                {
                  ...
                  {
                    m = AIOUtils.dp2px(45.0F, localResources);
                ...
                for (;;)
                {
                  ...
                  return paramView;
                  j = AIOUtils.dp2px(5.0F, localResources);
                  break;
                  label888:
                  k = AIOUtils.dp2px(5.0F, localResources);
                  m = i;
                  n = j;
                  j = k;
                  k = n;
