...
public class apkb
{
  ...
  public void a()
  {
    this.jdField_a_of_type_JavaLangString = (apfw.a() + "ar_cloud_img/");
  ...
  public void a(byte[] paramArrayOfByte, int paramInt1, int paramInt2, ARRecognition paramARRecognition, apkc paramapkc)
  {
    if (QLog.isColorLevel()) {
      QLog.d("AREngine_ARCloudPretreatmentManagert", 2, "[ScanStarFace]pretreatFaceRecogInfo,  FaceScanModelsLoader.hasFaceModelInit =  " + apgo.b);
    }
    if (apgo.c)
    {
    ...
    apke localapke = new apke();
    localapke.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    ...
    if (apky.a != null)
    {
      if (apky.a.hasMessages(4))
      {
        if (QLog.isColorLevel()) {
          QLog.d("AREngine_ARCloudPretreatmentManagert", 2, "[DEBUG_SCAN_yt_face] pretreatFaceRecogInfo, remove pending task");
        }
        apky.a.removeMessages(4);
      }
      paramArrayOfByte = Message.obtain(apky.a, new ARCloudPretreatmentManager.1(this, paramARRecognition, localFaceCluster, paramArrayOfByte, paramInt1, paramInt2));
      paramArrayOfByte.what = 4;
      if (apky.a != null) {
        apky.a.sendMessage(paramArrayOfByte);
      }
    }
    for (;;)
    {
      ...
      {
        localapke.jdField_a_of_type_ArrayOfComTencentYTFaceModelFaceStatus = paramARRecognition;
        bdla.b(null, "dc00898", "", "", "0X800834C", "0X800834C", 0, 0, "", "", "", "");
      }
      paramapkc.a(localapke);
      return;
      if (QLog.isColorLevel()) {
  ...
  public void a(byte[] paramArrayOfByte, ARRecognition paramARRecognition, apkc paramapkc)
  {
    paramArrayOfByte = new apko();
    paramArrayOfByte.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    paramapkc.a(paramArrayOfByte);
  }
  
  public void a(byte[] paramArrayOfByte, ArrayList<ARRecognition> paramArrayList, apkc paramapkc, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (paramArrayOfByte.hasNext())
    {
      ...
      if (l3 == 1L) {
        a(this.jdField_a_of_type_ArrayOfByte, paramArrayList, paramapkc);
      }
      for (;;)
      {
        break;
        if (l3 == 2L)
        {
          b(this.jdField_a_of_type_ArrayOfByte, paramArrayList, paramapkc);
        }
        else if (l3 == 4L)
        {
          l1 = System.currentTimeMillis();
          a(this.jdField_a_of_type_ArrayOfByte, j, i, paramArrayList, paramapkc);
          l1 = System.currentTimeMillis() - l1;
        }
        else if (l3 == 64L)
        {
          d(this.jdField_a_of_type_ArrayOfByte, paramArrayList, paramapkc);
        }
        else if (l3 == 128L)
        {
          c(this.jdField_a_of_type_ArrayOfByte, paramArrayList, paramapkc);
        }
        else if (l3 == 2048L)
        {
          e(this.jdField_a_of_type_ArrayOfByte, paramArrayList, paramapkc);
        }
      }
    }
    paramArrayList = new YuvImage(this.jdField_a_of_type_ArrayOfByte, paramInt3, j, i, null);
    paramArrayOfByte = a();
    paramArrayOfByte = new apkd(this.jdField_a_of_type_JavaLangString, paramArrayOfByte, this.jdField_a_of_type_ArrayOfByte);
    ...
    apkv localapkv = apkv.a();
    localapkv.c = l1;
    localapkv.b = l2;
    l1 = paramArrayOfByte.jdField_a_of_type_ArrayOfByte.length / 8192;
    paramapkc.a(jdField_a_of_type_Int, paramArrayList, l1);
  }
  ...
  public void b(byte[] paramArrayOfByte, ARRecognition paramARRecognition, apkc paramapkc)
  {
    paramArrayOfByte = new apkf();
    paramArrayOfByte.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    paramapkc.a(paramArrayOfByte);
  }
  
  public void c(byte[] paramArrayOfByte, ARRecognition paramARRecognition, apkc paramapkc)
  {
    paramArrayOfByte = new apkf();
    paramArrayOfByte.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    paramapkc.b(paramArrayOfByte);
  }
  
  public void d(byte[] paramArrayOfByte, ARRecognition paramARRecognition, apkc paramapkc)
  {
    paramArrayOfByte = new apkg();
    paramArrayOfByte.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    paramapkc.a(paramArrayOfByte);
  }
  
  public void e(byte[] paramArrayOfByte, ARRecognition paramARRecognition, apkc paramapkc)
  {
    paramArrayOfByte = new apkh();
    paramArrayOfByte.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    paramapkc.a(paramArrayOfByte);
  }
}
