...
public class ashb
{
  ...
  public static void a(List<String> paramList)
  {
    ...
    Object localObject1 = (QQAppInterface)bplg.a();
    ashc localashc = (ashc)((QQAppInterface)localObject1).getManager(149);
    anxd localanxd = (anxd)((QQAppInterface)localObject1).a(72);
    ...
    for (;;)
    {
      ...
      if (!a(localCustomEmotionData1.emoOriginalPath))
      {
        ...
        localashc.c(localCustomEmotionData1);
        k += 1;
        localanxd.notifyUI(2, true, null);
        a(false, 1, 0);
        break;
      }
      ...
      localObject2 = antf.bl + apdf.a(str1) + str3 + (String)localObject2;
      boolean bool = bhmi.d((String)localObject1, (String)localObject2);
      if (QLog.isColorLevel()) {
      ...
      if (((Iterator)localObject1).hasNext())
      {
        ...
        {
          localashc.a(localCustomEmotionData2, localList.indexOf(localCustomEmotionData2));
          i = 1;
        }
      }
      for (;;)
      {
        ...
        {
          localashc.a(localCustomEmotionData2);
        }
        else
        {
          m = 1;
  ...
  public static void a(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    if (paramBoolean)
    {
      ...
      bdmc.a(BaseApplication.getContext()).a(null, "FavEmoUploadLocal", false, 0L, 0L, localHashMap, null);
      if (!paramBoolean) {
        break label91;
      }
    }
  ...
  public static boolean a(String paramString)
  {
    try
    {
      ardy localardy = (ardy)aran.a().a(561);
      if (new File(paramString).length() >= localardy.a) {
        return false;
      }
      if (!azru.a(paramString))
      {
        ...
        if (localOptions.outWidth < localardy.b)
        {
