  ...
  implements aiiy
{
  ...
  public airv(int paramInt, aisd paramaisd)
  {
    this.jdField_a_of_type_Int = paramInt;
    this.b = ("cmshow_script_" + paramInt + ".js");
    this.jdField_a_of_type_Aisd = paramaisd;
    if ((paramaisd != null) && (paramaisd.a() != null)) {
      this.jdField_a_of_type_Aisi = ((aisi)paramaisd.a().getManager(249));
    }
  ...
  {
    String str = aiwi.b(paramString, paramQQAppInterface);
    ...
    aise.a(paramQQAppInterface, str, new airy(this, paramBoolean, paramQQAppInterface, paramString, paramInt1, paramArrayOfInt, paramInt2));
  }
  ...
  public aiii a()
  {
    ...
    return this.jdField_a_of_type_Aisd.a();
  }
  ...
  public String a()
  {
    ...
    localStringBuilder.append(aiys.av).append(this.b);
  ...
  {
    if ((TextUtils.isEmpty(paramString)) || (this.jdField_a_of_type_Aisd == null)) {
    ...
    {
      return;
      localaiii = this.jdField_a_of_type_Aisd.a();
    } while (localaiii == null);
    localaiii.runRenderTask(new SpriteAioScript.1(this, paramString, localaiii, paramInt, paramBoolean));
  }
    ...
    do
    {
      do
      {
        do
        {
          ...
          localObject = aiwi.a(paramString, a(), false);
        } while ((localObject == null) || (localObject.length != 2));
        i = ((Integer)localObject[0]).intValue();
        localObject = (int[])localObject[1];
      } while ((localObject == null) || (localObject.length == 0));
      if (2 != ((aifg)localQQAppInterface.getManager(153)).b(paramString)) {
        break;
      }
    } while (!paramBoolean);
    a(localQQAppInterface, paramString, i, (int[])localObject, 0);
    return;
    aise.a(localQQAppInterface, paramString, i, (int[])localObject, new airw(this, paramBoolean));
  }
  ...
  public void a(boolean paramBoolean, QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int[] paramArrayOfInt, int paramInt2)
  {
    ...
    Object localObject = aiwi.a(paramString, i, a(), false);
    i = ((Integer)localObject[0]).intValue();
    ...
    aise.b(paramQQAppInterface, paramString, i, (int[])localObject, new airx(this, paramBoolean, paramInt1, paramArrayOfInt));
  }
  ...
  {
    boolean bool = true;
    if (!new ajav(paramString + ".sig", paramString).a(1))
    {
  ...
  public boolean b()
  {
    try
    {
      if ((this.jdField_a_of_type_Int == 0) && (!TextUtils.isEmpty(aifg.e)))
      {
        this.jdField_a_of_type_JavaLangString = aifg.e;
      ...
      if (!localFile.exists())
      {
        ...
        if (TextUtils.isEmpty(aiys.au)) {
          aixo.a(this.jdField_a_of_type_Aisd.a(), 300, 202, new Object[] { "Fail to read script file:", str });
        } else {
          aixo.a(this.jdField_a_of_type_Aisd.a(), 300, 200, new Object[] { "Fail to read script file:", str });
        }
      }
    }
    catch (OutOfMemoryError localOutOfMemoryError)
    {
      ...
      aixo.a(this.jdField_a_of_type_Aisd.a(), 300, 150, new Object[] { "loadScript:", localOutOfMemoryError });
      return false;
      if (!a(localOutOfMemoryError))
      {
        aixo.a(this.jdField_a_of_type_Aisd.a(), 300, 201, new Object[] { "Fail to verify script file:", localOutOfMemoryError });
        return false;
      }
      this.jdField_a_of_type_JavaLangString = bace.b(localFile);
    ...
    catch (Throwable localThrowable)
    {
      ...
      aixo.a(this.jdField_a_of_type_Aisd.a(), 300, 30, new Object[] { "loadScript:", localThrowable });
      return false;
    }
    return false;
  }
  ...
  {
    if (TextUtils.isEmpty(aiys.au)) {}
    while (new File(aiys.av + "cm3d.js").exists()) {
      return true;
    }
    return false;
  }
  ...
  public void g()
  {
    ...
    this.jdField_a_of_type_Aism = null;
