...
{
  public int a;
  private axrn jdField_a_of_type_Axrn = new axrn(this, null);
  ...
  public int a(String arg1, String paramString2)
  {
    ...
    {
      localaxro = new axro();
      localaxro.jdField_a_of_type_Axrt = this.jdField_a_of_type_Axrn;
      localaxro.jdField_a_of_type_JavaLangString = ???;
      localaxro.jdField_a_of_type_Int = 0;
      localaxro.c = paramString2;
      localaxro.e = String.valueOf(System.currentTimeMillis());
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        awrn.a(BaseApplication.getContext()).a(null, "HttpInterfaceForTVKImp", true, 0L, 0L, ???, "");
        return this.b;
        ((QQAppInterface)???).getNetEngine(0).a(localaxro);
      }
      label289:
