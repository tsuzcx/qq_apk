  ...
  extends BaseBubbleBuilder
{
  ...
  public ahxf(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo, paramAIOAnimationConatiner);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new ahxg(this);
    this.b = paramContext;
  ...
  private RelativeLayout a(Context paramContext)
  {
    ...
    localQQWalletTransferBubbleView.setId(2131381166);
    ...
    ((ImageView)localObject1).setId(2131381162);
    localQQWalletTransferBubbleView.addView((View)localObject1);
    localObject1 = new LinearLayout(paramContext);
    localObject2 = new RelativeLayout.LayoutParams(-2, -2);
    ((RelativeLayout.LayoutParams)localObject2).addRule(0, 2131381162);
    ...
    ((TextView)localObject2).setId(2131381165);
    ...
    ((TextView)localObject2).setId(2131381164);
    ((LinearLayout)localObject1).addView((View)localObject2);
    localQQWalletTransferBubbleView.addView((View)localObject1);
    ...
    ((RelativeLayout.LayoutParams)localObject1).addRule(3, 2131381166);
    localQQWalletTransferBubbleView.setLayoutParams((ViewGroup.LayoutParams)localObject1);
    localQQWalletTransferBubbleView.setBackgroundResource(2130847249);
    localQQWalletTransferBubbleView.setId(2131381161);
  ...
  {
    boolean bool2 = true;
    paramView = (ahxh)paramaggl;
    if (paramView.a == null) {
      paramView.a = a(this.b);
    }
    if ((paramChatMessage instanceof MessageForVIPDonate)) {}
    for (paramaggl = (MessageForVIPDonate)paramChatMessage;; paramaggl = null)
    {
      if (paramaggl == null)
      {
      ...
      paramaggl.parse();
      paramaggl = paramaggl.donateMsg;
      if (paramaggl == null)
      {
        QLog.e("VIPDonateMsgItemBuilder", 1, "donateMsg empty");
        return null;
      }
      paramBaseChatItemLayout = (TextView)paramView.a.findViewById(2131381165);
      paramBaseChatItemLayout.setText(paramaggl.title);
      paramBaseChatItemLayout.setTextColor(-1);
      paramBaseChatItemLayout = (TextView)paramView.a.findViewById(2131381164);
      paramBaseChatItemLayout.setText(paramaggl.subTitle);
      paramBaseChatItemLayout.setTextColor(-1);
      ((TextView)paramView.a.findViewById(2131381163)).setText(paramaggl.footer);
      ((ImageView)paramView.a.findViewById(2131381162)).setImageResource(2130850807);
      paramBaseChatItemLayout = (QQWalletTransferBubbleView)paramView.a.findViewById(2131381161);
      QQWalletTransferBubbleView localQQWalletTransferBubbleView = (QQWalletTransferBubbleView)paramView.a.findViewById(2131381166);
      int m = Color.rgb(255, 170, 57);
      if (!paramChatMessage.isSend())
      {
        bool1 = true;
        localQQWalletTransferBubbleView.setBubbleBackground(2130847248, m, bool1);
      ...
      {
        paramBaseChatItemLayout.setBubbleBackground(2130847249, m, bool1);
        if (jdField_e_of_type_Boolean) {
          paramView.a.setContentDescription(paramaggl.subTitle + paramaggl.title);
        }
        paramView.a.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
        paramView.a.setOnLongClickListener(paramagjk);
        paramView.a.setOnTouchListener(paramagjk);
        return paramView.a;
        bool1 = false;
        break;
      }
  ...
  public void a(int paramInt, Context paramContext, ChatMessage paramChatMessage)
  {
    ...
    default: 
      ...
      return;
    case 2131365352: 
      aean.b(this.b, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage);
      return;
    }
  ...
  public bhum[] a(View paramView)
  {
    ...
    aean.a(localbhuk, this.b, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a);
