  ...
  extends PagerAdapter
{
  ...
  public ahxf(VideoFilterViewPager paramVideoFilterViewPager) {}
  ...
  public Object instantiateItem(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    for (localObject1 = (View)((Queue)localObject1).poll();; localObject1 = null)
    {
      ...
      if (localObject1 == null) {
        localObject2 = ((LayoutInflater)this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaVideoFilterViewPager.getContext().getSystemService("layout_inflater")).inflate(2131560777, null);
      }
