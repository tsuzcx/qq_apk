...
public class ajjy
{
  ...
  public ajjy(String paramString1, boolean paramBoolean, ajju paramajju, String paramString2)
  {
  ...
  private BufferedInputStream a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 35	ajjy:jdField_a_of_type_JavaIoBufferedInputStream	Ljava/io/BufferedInputStream;
    //   6: ifnonnull +54 -> 60
    //   9: aload_0
    //   10: getfield 37	ajjy:jdField_a_of_type_JavaNetHttpURLConnection	Ljava/net/HttpURLConnection;
    //   13: astore_1
    //   14: aload_1
    //   15: ifnull +45 -> 60
    //   18: aload_0
    //   19: getfield 37	ajjy:jdField_a_of_type_JavaNetHttpURLConnection	Ljava/net/HttpURLConnection;
    //   22: invokevirtual 43	java/net/HttpURLConnection:getInputStream	()Ljava/io/InputStream;
    //   25: astore_1
    //   26: ldc 45
    //   28: aload_0
    //   29: getfield 37	ajjy:jdField_a_of_type_JavaNetHttpURLConnection	Ljava/net/HttpURLConnection;
    ...
    //   57: putfield 35	ajjy:jdField_a_of_type_JavaIoBufferedInputStream	Ljava/io/BufferedInputStream;
    //   60: aload_0
    //   61: getfield 35	ajjy:jdField_a_of_type_JavaIoBufferedInputStream	Ljava/io/BufferedInputStream;
    //   64: astore_1
    //   65: aload_0
    //   66: monitorexit
    //   67: aload_1
    ...
    //   78: putfield 35	ajjy:jdField_a_of_type_JavaIoBufferedInputStream	Ljava/io/BufferedInputStream;
    //   81: goto -21 -> 60
    //   84: astore_1
    //   85: ldc 65
    //   87: iconst_2
  ...
  int a()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          str1 = ajjc.c(this.jdField_a_of_type_JavaLangString);
        ...
        if ((this.jdField_a_of_type_Ajju == null) || (!this.jdField_a_of_type_Ajju.a()) || (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))) {
          break label888;
        }
        this.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_Ajju.jdField_a_of_type_JavaLangString;
        str2 = this.jdField_a_of_type_Ajju.a(true);
        if (QLog.isColorLevel()) {
          QLog.d("apollo_client_ApolloUrlConnection", 2, "getUrlConnection mCgiConfig.parameterStr:" + str2);
        }
        if ((TextUtils.isEmpty(str2)) || (!"get".equals(this.jdField_a_of_type_Ajju.jdField_b_of_type_JavaLangString.toLowerCase()))) {
          break label881;
        }
      ...
      catch (IOException localIOException)
      {
        ...
        if (!"get".equals(this.jdField_a_of_type_Ajju.jdField_b_of_type_JavaLangString.toLowerCase())) {
          continue;
        }
        ...
        break label894;
        if (!"post".equals(this.jdField_a_of_type_Ajju.jdField_b_of_type_JavaLangString.toLowerCase())) {
          break label876;
        }
      ...
      localObject3 = bcgq.a(bcgq.c("httpAsync 1.0"), "", false);
      ...
      {
        localObject3 = this.jdField_a_of_type_Ajju.jdField_a_of_type_JavaUtilHashMap.keySet().iterator();
        if (((Iterator)localObject3).hasNext())
        {
          str2 = (String)((Iterator)localObject3).next();
          this.jdField_a_of_type_JavaNetHttpURLConnection.setRequestProperty(str2, (String)this.jdField_a_of_type_Ajju.jdField_a_of_type_JavaUtilHashMap.get(str2));
          continue;
        }
      }
      label876:
  ...
  ajjz a(AtomicBoolean paramAtomicBoolean, ByteArrayOutputStream paramByteArrayOutputStream)
  {
    boolean bool = false;
    for (;;)
    {
