  ...
  extends BaseBubbleBuilder
{
  ...
  private URLDrawable a(FileManagerEntity paramFileManagerEntity, MessageForFile paramMessageForFile, Context paramContext, URL paramURL, adpp paramadpp)
  {
    ...
    int k = this.c;
    int m = this.d;
    paramMessageForFile = apuw.a(paramFileManagerEntity.imgWidth, paramFileManagerEntity.imgHeight, paramFileManagerEntity.strMiddleThumPath);
    int j = k;
    int i = m;
    ...
    paramadpp.e = j;
    paramadpp.jdField_f_of_type_Int = i;
    if (paramURL != null)
    {
      ...
      {
        paramContext = aywk.a(paramURL, 0, 0, null, null, true, 0.0F);
        paramadpp.jdField_a_of_type_Boolean = true;
        return paramContext;
      }
    }
    ...
    {
      paramMessageForFile = ((SkinnableBitmapDrawable)aywk.b()).getBitmap();
      label277:
      paramContext = URLDrawable.URLDrawableOptions.obtain();
      paramContext.mRequestWidth = j;
      paramContext.mRequestHeight = i;
      paramContext.mLoadingDrawable = aywk.b();
      paramContext.mFailedDrawable = aywk.a();
      paramContext.mGifRoundCorner = 12.0F;
      if (paramMessageForFile != null) {
        paramContext.mLoadingDrawable = new anos(this.jdField_a_of_type_AndroidContentContext.getResources(), paramMessageForFile, j, i, -921103);
      }
      if (paramURL == null) {
        break label414;
      }
    ...
    for (;;)
    {
      ...
      apue.e(paramFileManagerEntity);
      return paramMessageForFile;
      if (!(aywk.b() instanceof BitmapDrawable)) {
        break label277;
      }
      paramMessageForFile = ((BitmapDrawable)aywk.b()).getBitmap();
      break label277;
      label414:
      ...
      for (;;)
      {
        paramMessageForFile = AsyncImageView.a(ajsf.aV, j, i, null, false, false, true);
        if (paramMessageForFile != null) {
          break;
        }
        return null;
      ...
      paramMessageForFile.setProgressDrawable(new bcnz(aywk.a(), 0, false));
      if (apuw.a(paramFileManagerEntity)) {
        paramMessageForFile.setAutoDownload(true);
      } else {
  ...
  private void a(adpp paramadpp)
  {
    ...
    for (;;)
    {
      ...
      ((TextView)localObject).setText(2131693372);
      ...
      localObject = new RelativeLayout.LayoutParams(paramadpp.e, paramadpp.jdField_f_of_type_Int);
      ((RelativeLayout)paramadpp.jdField_a_of_type_AndroidViewView).addView(localFrameLayout, (ViewGroup.LayoutParams)localObject);
      paramadpp.jdField_a_of_type_AndroidWidgetFrameLayout = localFrameLayout;
      return;
      localFrameLayout.setBackgroundDrawable((Drawable)localObject);
    }
  }
  
  private void a(adpp paramadpp, FileManagerEntity paramFileManagerEntity)
  {
    int j = 1;
    ...
    default: 
      ...
      label65:
      if (j != 0) {
        if (paramadpp.jdField_a_of_type_ComTencentMobileqqCustomviewsPicProgressView == null)
        {
          ...
          ((RelativeLayout)paramadpp.jdField_a_of_type_AndroidViewView).addView(paramFileManagerEntity, localLayoutParams);
          paramFileManagerEntity.setProgress(0);
          paramadpp.jdField_a_of_type_ComTencentMobileqqCustomviewsPicProgressView = paramFileManagerEntity;
          paramadpp.jdField_a_of_type_ComTencentMobileqqCustomviewsPicProgressView.setProgressKey(paramadpp.jdField_a_of_type_ComTencentMobileqqDataChatMessage.frienduin + paramadpp.jdField_a_of_type_ComTencentMobileqqDataChatMessage.uniseq);
          label233:
          paramadpp.jdField_a_of_type_ComTencentMobileqqCustomviewsPicProgressView.setVisibility(0);
        }
      }
      break;
    }
    for (;;)
    {
      if ((i != 0) && (paramadpp.jdField_a_of_type_ComTencentMobileqqCustomviewsPicProgressView != null))
      {
        if (paramadpp.jdField_a_of_type_ComTencentMobileqqCustomviewsPicProgressView.a(paramadpp.jdField_a_of_type_ComTencentMobileqqDataChatMessage.frienduin + paramadpp.jdField_a_of_type_ComTencentMobileqqDataChatMessage.uniseq)) {
          break label447;
        }
        ((RelativeLayout)paramadpp.jdField_a_of_type_AndroidViewView).removeView(paramadpp.jdField_a_of_type_ComTencentMobileqqCustomviewsPicProgressView);
        paramadpp.jdField_a_of_type_ComTencentMobileqqCustomviewsPicProgressView = null;
      }
      return;
      i = 0;
      j = 0;
      ...
      j = 0;
      break label65;
      paramadpp.jdField_a_of_type_ComTencentMobileqqCustomviewsPicProgressView.setProgress((int)(paramFileManagerEntity.fProgress * 100.0F));
      break label233;
      if (paramadpp.jdField_a_of_type_ComTencentMobileqqCustomviewsPicProgressView != null) {
        if (!paramadpp.jdField_a_of_type_ComTencentMobileqqCustomviewsPicProgressView.a(paramadpp.jdField_a_of_type_ComTencentMobileqqDataChatMessage.frienduin + paramadpp.jdField_a_of_type_ComTencentMobileqqDataChatMessage.uniseq))
        {
        ...
        {
          paramadpp.jdField_a_of_type_ComTencentMobileqqCustomviewsPicProgressView.setProgress(100);
        }
      }
    }
    label447:
  ...
  public static void a(Context paramContext, Rect paramRect, ChatMessage paramChatMessage, SessionInfo paramSessionInfo, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, com.tencent.mobileqq.data.MessageForReplyText paramMessageForReplyText)
  {
    ...
    //   121: aload 10
    //   123: getstatic 474	bgkh:b	Ljava/lang/String;
    //   126: iload 6
    ...
    //   286: iconst_1
    //   287: invokestatic 541	atzt:a	(Ljava/lang/String;I)Z
    //   290: istore 4
    //   292: aload 10
    //   294: ldc_w 543
    //   297: iload 4
    ...
    //   316: invokestatic 546	atzt:a	(Ljava/lang/String;)Ljava/lang/String;
    //   319: astore 7
    //   321: aload 7
    ...
    //   418: aload_2
    //   419: aload 7
    //   421: invokestatic 579	aehy:a	(Lcom/tencent/mobileqq/data/ChatMessage;Lcom/tencent/mobileqq/app/QQAppInterface;)Lcom/tencent/mobileqq/activity/aio/photo/AIORichMediaData;
    //   424: iconst_m1
    //   425: iload 8
    //   427: invokestatic 582	bgkh:a	(Landroid/content/Context;Landroid/os/Bundle;Laejd;Lcom/tencent/mobileqq/activity/aio/photo/AIORichMediaData;II)V
    ...
    //   563: aload_2
    //   564: aload 7
    //   566: invokestatic 579	aehy:a	(Lcom/tencent/mobileqq/data/ChatMessage;Lcom/tencent/mobileqq/app/QQAppInterface;)Lcom/tencent/mobileqq/activity/aio/photo/AIORichMediaData;
    //   569: iconst_m1
    //   570: aload_3
    //   571: getfield 596	com/tencent/mobileqq/activity/aio/SessionInfo:c	I
    //   574: invokestatic 582	bgkh:a	(Landroid/content/Context;Landroid/os/Bundle;Laejd;Lcom/tencent/mobileqq/activity/aio/photo/AIORichMediaData;II)V
    //   577: goto -147 -> 430
    //   580: astore_0
    //   581: aload_0
  ...
  private void a(String paramString1, String paramString2, adpp paramadpp)
  {
    if (paramadpp.jdField_a_of_type_AndroidWidgetRelativeLayout != null)
    {
      paramadpp.jdField_a_of_type_AndroidWidgetRelativeLayout.removeAllViews();
      ((RelativeLayout)paramadpp.jdField_a_of_type_AndroidViewView).removeView(paramadpp.jdField_a_of_type_AndroidWidgetRelativeLayout);
    }
    RelativeLayout localRelativeLayout = new RelativeLayout(this.jdField_a_of_type_AndroidContentContext);
    localRelativeLayout.setId(2131366235);
    localRelativeLayout.setBackgroundResource(2130838791);
    paramadpp.jdField_a_of_type_AndroidWidgetRelativeLayout = localRelativeLayout;
    ...
    ((RelativeLayout)paramadpp.jdField_a_of_type_AndroidViewView).addView(localRelativeLayout, (ViewGroup.LayoutParams)localObject1);
    ...
    int i = apvk.a(paramadpp.e, paramadpp.jdField_f_of_type_Int);
    ...
    if (i == 1)
    {
      ...
      paramString1 = apvk.a(this.jdField_a_of_type_AndroidContentContext, i, paramadpp.e, (TextView)localObject2, (TextView)localObject1, paramString1, paramString2);
      switch (i)
      {
      }
    }
  ...
  private boolean a(adpp paramadpp, FileManagerEntity paramFileManagerEntity)
  {
    boolean bool = false;
    int i;
    if ((paramadpp.jdField_a_of_type_Boolean) && ((paramFileManagerEntity.status == -1) || (paramFileManagerEntity.status == 1) || (paramFileManagerEntity.status == 0) || (paramFileManagerEntity.status == 3) || (paramFileManagerEntity.status == 13)))
    {
      i = 1;
  ...
  public acum a(View paramView)
  {
    if ((paramView != null) && (paramView.getParent() != null))
    {
      ...
      if ((paramView != null) && (adpp.class.isInstance(paramView))) {
        return ((adpp)paramView).jdField_a_of_type_ComTencentMobileqqWidgetBubbleImageView;
      }
    }
    return null;
  }
  ...
  public View a(ChatMessage paramChatMessage, acun paramacun, View paramView, BaseChatItemLayout paramBaseChatItemLayout, acxn paramacxn)
  {
    ...
    if (adpp.class.isInstance(paramacun))
    {
      paramacun = (adpp)paramacun;
      ...
      super.a(paramChatMessage, paramacxn);
      paramacun.jdField_a_of_type_ComTencentMobileqqWidgetBubbleImageView = paramView;
    }
    label352:
    for (;;)
    {
      paramView = paramacun.jdField_a_of_type_ComTencentMobileqqWidgetBubbleImageView;
      ...
      paramacun.jdField_a_of_type_AndroidViewView = paramChatMessage;
      a(paramBaseChatItemLayout, localMessageForFile, paramacun, paramView, false);
      return paramChatMessage;
      paramView = new adpp(this);
  ...
  public bblr a(bblr parambblr, ChatMessage paramChatMessage, acve paramacve)
  {
    ...
    for (;;)
    {
      ...
      if ((paramacve.status == 1) || (paramacve.status == -1) || ((paramacve.status == 3) && (paramacve.nOpType == 1))) {
  ...
  public String a(ChatMessage paramChatMessage)
  {
    if (bbet.a(paramChatMessage.issend)) {
      return ajyc.a(2131704560);
    }
    return ajyc.a(2131704559);
  }
  ...
  public void a(int paramInt, Context paramContext, ChatMessage paramChatMessage)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          if (bcvm.a((Activity)paramContext, 5, new adpl(this, localMessageForFile, paramContext))) {
            aptr.a(paramContext, 2131692672, 2131692675, new adpm(this, localMessageForFile, paramContext));
          }
        }
        else
        {
          apue.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForFile, paramContext);
          continue;
          if (localFileManagerEntity.status == 16)
          {
            aptv.a(2131692856);
          ...
          else
          {
            ...
            paramChatMessage.putExtra("forward_text", ajyc.a(2131704562) + apue.d(localFileManagerEntity.fileName) + ajyc.a(2131704561) + apvb.a(localFileManagerEntity.fileSize) + "。");
            ...
            else
            {
              ...
              else
              {
                ...
                apsz.a(localFileManagerEntity).a(false, paramContext, new adpn(this, localFileManagerEntity));
                ...
                else
                {
                  ...
                  apsz.a(localFileManagerEntity).a(bool, paramContext, new adpo(this, localFileManagerEntity));
                  this.jdField_a_of_type_AndroidWidgetBaseAdapter.notifyDataSetChanged();
                  continue;
                  this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(localFileManagerEntity.nSessionId);
                  b();
  ...
  {
    super.a(paramView);
    adpp localadpp = (adpp)actn.a(paramView);
    MessageForFile localMessageForFile = a(paramView);
    BaseChatItemLayout localBaseChatItemLayout = localadpp.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout;
    paramView = apue.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForFile);
    ...
    for (paramView = this.jdField_a_of_type_AndroidContentContext.getString(2131692445); localMessageForFile.isSendFromLocal(); paramView = this.jdField_a_of_type_AndroidContentContext.getString(2131692443))
    {
      ...
      localbfol.a(new adpj(this, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(localMessageForFile.uniseq, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, -1L), localMessageForFile, localbfol, localBaseChatItemLayout, localadpp));
      localbfol.show();
      return;
    ...
    paramView.a(new adpk(this, localMessageForFile, paramView, localBaseChatItemLayout, localadpp));
    paramView.show();
  }
  
  public void a(BaseChatItemLayout paramBaseChatItemLayout, MessageForFile paramMessageForFile, adpp paramadpp, FileManagerEntity paramFileManagerEntity, boolean paramBoolean)
  {
    if (paramFileManagerEntity == null) {
      return;
    }
    ...
    apue.c(paramFileManagerEntity);
    apue.b(paramFileManagerEntity);
    ...
    paramMessageForFile.fileSizeString = apvb.a(paramFileManagerEntity.fileSize);
    if (paramadpp.jdField_a_of_type_AndroidWidgetFrameLayout != null)
    {
      paramadpp.jdField_a_of_type_AndroidWidgetFrameLayout.removeAllViews();
      ((RelativeLayout)paramadpp.jdField_a_of_type_AndroidViewView).removeView(paramadpp.jdField_a_of_type_AndroidWidgetFrameLayout);
    }
    if ((paramFileManagerEntity.status == 16) && (!apue.e(paramFileManagerEntity)))
    {
      paramMessageForFile = apuw.a(paramFileManagerEntity);
      if ((paramMessageForFile.jdField_a_of_type_Int > 0) && (paramMessageForFile.jdField_b_of_type_Int > 0))
      {
        paramadpp.e = paramMessageForFile.jdField_a_of_type_Int;
        paramadpp.jdField_f_of_type_Int = paramMessageForFile.jdField_b_of_type_Int;
        paramadpp.jdField_a_of_type_ComTencentMobileqqWidgetBubbleImageView.setImageDrawable(null);
        paramadpp.jdField_a_of_type_ComTencentImageURLDrawable = null;
        a(paramadpp);
        if (!a(paramadpp, paramFileManagerEntity)) {
          break label457;
        }
        a(paramFileManagerEntity.fileName, bbdj.a(paramFileManagerEntity.fileSize), paramadpp);
      }
    }
    for (;;)
    {
      paramBaseChatItemLayout.setFailedIconVisable(b(paramFileManagerEntity), this);
      a(paramadpp, paramFileManagerEntity);
      return;
      paramadpp.e = this.c;
      paramadpp.jdField_f_of_type_Int = this.d;
      break;
      localObject = paramFileManagerEntity.strLargeThumPath;
      if ((paramMessageForFile.isMultiMsg) && (TextUtils.isEmpty((CharSequence)localObject)) && (!TextUtils.isEmpty(apue.a(paramMessageForFile)))) {}
      URL localURL;
      for (localObject = apue.a(paramMessageForFile);; localURL = apuw.b(paramFileManagerEntity)) {
        try
        {
          localObject = AsyncImageView.a((String)localObject, -1, -1, new File((String)localObject), false, false, true);
          if ((paramadpp.jdField_a_of_type_ComTencentImageURLDrawable != null) && (paramadpp.jdField_a_of_type_ComTencentImageURLDrawable.getURL().equals(localObject))) {
            break;
          }
          paramMessageForFile = a(paramFileManagerEntity, paramMessageForFile, this.jdField_a_of_type_AndroidContentContext, (URL)localObject, paramadpp);
          paramadpp.jdField_a_of_type_ComTencentMobileqqWidgetBubbleImageView.setImageDrawable(paramMessageForFile);
          paramadpp.jdField_a_of_type_ComTencentImageURLDrawable = paramMessageForFile;
        }
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      do
      {
        ...
        if (!adpp.class.isInstance(localObject))
        {
          QLog.w("FilePicItemBuilder<FileAssistant>", 1, "holder tag class[" + localObject.getClass().getName() + "] is not Holder");
          return;
        }
        localObject = (adpp)localObject;
        paramView = a(paramView);
      } while ((paramView.isMultiMsg) && (!apue.a(paramView, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext)));
      localFileManagerEntity = apue.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramView);
    } while ((localFileManagerEntity.status == 16) && (!apue.e(localFileManagerEntity)));
    Object localObject = xpx.a(((adpp)localObject).jdField_a_of_type_ComTencentMobileqqWidgetBubbleImageView);
