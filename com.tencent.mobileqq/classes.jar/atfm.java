...
public class atfm
{
  ...
  public atfm(int paramInt)
  {
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList(2);
    this.jdField_a_of_type_Int = paramInt;
  }
  
  public static atfm a(appoint_define.InterestTag paramInterestTag)
  {
    atfm localatfm = null;
    if (paramInterestTag != null)
    {
      localatfm = new atfm(paramInterestTag.uint32_tag_type.get());
      ...
      if ((paramInterestTag != null) && (paramInterestTag.size() > 0))
      {
        ...
        while (paramInterestTag.hasNext())
        {
          ...
          if (localInterestTagInfo != null) {
            localatfm.jdField_a_of_type_JavaUtilArrayList.add(localInterestTagInfo);
          }
        }
      }
    }
  ...
  public static atfm a(JSONObject paramJSONObject)
  {
    int j = 0;
    ...
    for (;;)
    {
      ...
      if (i < paramJSONObject.length())
      {
        ...
        if (localObject != null)
        {
          ...
          if (localObject != null)
          {
            localatfm.jdField_a_of_type_JavaUtilArrayList.add(localObject);
            break label140;
            label114:
            localObject = null;
          }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (!bbbr.a(this.jdField_a_of_type_JavaUtilArrayList.get(i), paramObject.jdField_a_of_type_JavaUtilArrayList.get(i))) {
        break;
      }
      i += 1;
    }
