...
public abstract class mci
{
  ...
  public lfe a;
  lni jdField_a_of_type_Lni = new mcj(this);
  public mlh a;
  ...
  public void a(String paramString)
  {
    ...
    if (this.jdField_a_of_type_Mlh != null) {}
    for (TextView localTextView = this.jdField_a_of_type_Mlh.a();; localTextView = null)
    {
      ...
      if (this.jdField_a_of_type_ComTencentAvGaudioBaseGaInvite$GetGaFaceRunnable == null) {
        this.jdField_a_of_type_ComTencentAvGaudioBaseGaInvite$GetGaFaceRunnable = new BaseGaInvite.GetGaFaceRunnable(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_b_of_type_Int, this.jdField_c_of_type_Int, this.jdField_a_of_type_Long, this.jdField_b_of_type_Long, this.jdField_a_of_type_Lni);
      }
  ...
  void a(boolean paramBoolean)
  {
    if (QLog.isColorLevel()) {
      QLog.w(this.jdField_a_of_type_JavaLangString, 1, "refreshUI, isMultiCall[" + mrr.b(this.jdField_b_of_type_Int) + "], multiIncomingCall[" + paramBoolean + "], mUinType[" + this.jdField_b_of_type_Int + "], mIsAudioMode[" + this.jdField_a_of_type_Boolean + "]");
    }
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_Mlh == null)
      {
        this.jdField_a_of_type_Mlh = new mlh(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getApplicationContext());
        this.jdField_a_of_type_Mlh.a(this.jdField_a_of_type_AndroidGraphicsBitmap, this.jdField_b_of_type_JavaLangString);
        localObject = new Date();
        localObject = new SimpleDateFormat("HH:mm").format((Date)localObject);
        this.jdField_a_of_type_Mlh.b((String)localObject);
        this.jdField_a_of_type_Mlh.a(this.jdField_a_of_type_Boolean, mrr.b(this.jdField_b_of_type_Int), paramBoolean);
        if (mrr.b(this.jdField_b_of_type_Int)) {
      ...
      if (this.jdField_a_of_type_Lfe != null)
      {
        ...
        if (this.jdField_a_of_type_Lfe.A == 1)
        {
          ...
          if (this.jdField_b_of_type_Int == 9500)
          {
            ...
            {
              localObject = this.jdField_a_of_type_Lfe.p;
              i = 0;
            }
          }
        }
      ...
      {
        if (this.jdField_a_of_type_Lfe != null) {
          this.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_Lfe.a();
        }
        if (QLog.isColorLevel()) {
