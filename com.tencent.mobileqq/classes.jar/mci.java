...
{
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new mcj(this);
  private Context jdField_a_of_type_AndroidContentContext;
  private boolean jdField_a_of_type_Boolean;
  private long[] jdField_a_of_type_ArrayOfLong;
  private boolean b;
  
  public mci(Context paramContext)
  {
  ...
  private void a(View paramView)
  {
    ...
    ((Activity)localObject).findViewById(2131372231).setVisibility(0);
    paramView = (TextView)((Activity)localObject).findViewById(2131372233);
    localObject = (TextView)((Activity)localObject).findViewById(2131372232);
    ...
    String str1 = llq.a(this.jdField_a_of_type_AndroidContentContext);
    str2 = str2 + "\n----------\n";
    str1 = str2 + a(str1);
  ...
  {
    Object localObject = (Activity)this.jdField_a_of_type_AndroidContentContext;
    View localView = ((Activity)localObject).findViewById(2131372230);
    if (localView != null)
    {
      localView.setOnClickListener(this);
      localView.setVisibility(0);
    }
    localView = ((Activity)localObject).findViewById(2131372232);
    if (localView != null) {
      localView.setOnClickListener(this);
    }
    localObject = ((Activity)localObject).findViewById(2131372231);
    if (localObject != null) {
  ...
  public void onClick(View paramView)
  {
    ...
    ((Activity)this.jdField_a_of_type_AndroidContentContext).findViewById(2131372231).setVisibility(8);
  }
}
