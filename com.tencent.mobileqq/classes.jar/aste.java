...
public class aste
  extends QIPCModule
{
  private static volatile aste jdField_a_of_type_Aste;
  ...
  private aste(String paramString)
  {
    super(paramString);
  }
  ...
  {
    if (jdField_a_of_type_Aste == null) {}
    try
    {
      if (jdField_a_of_type_Aste == null) {
        jdField_a_of_type_Aste = new aste("IdentificationIpcServer_Model");
      }
      return jdField_a_of_type_Aste;
    }
    finally {}
  }
  ...
  {
    return new astg(this, paramFile, paramEIPCResult, paramQQAppInterface, paramInt2, paramInt3, paramInt1);
  }
  ...
  private void a(Bundle paramBundle)
  {
    ...
    azmj.b((QQAppInterface)localObject2, "dc00898", "", "", "0X80097EB", "0X80097EB", 0, 0, i + "", "" + k, j + "", "");
  ...
  private void a(Bundle paramBundle, int paramInt)
  {
    ...
    atdc.a(paramBundle, str3, str4, i, AppSetting.a(), str2, str1, l, new astf(this, localFaceDetectForThirdPartyManager, paramInt, paramBundle));
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    bdcs.b(paramString3);
    paramString2 = new asth(this, paramString3, paramString2, paramString1, paramInt);
    if (this.jdField_a_of_type_Baqy == null)
    {
      paramQQAppInterface = new HttpCommunicator(paramQQAppInterface, 4);
      paramQQAppInterface.a();
      this.jdField_a_of_type_Baqy = new baqy(paramQQAppInterface, false);
    }
    paramQQAppInterface = new baps();
    paramQQAppInterface.jdField_a_of_type_Bapx = paramString2;
    ...
    this.jdField_a_of_type_Baqy.a(paramQQAppInterface);
  }
      ...
      if (((List)localObject2).size() > 0)
      {
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          if (((ShortVideoResourceManager.SVConfigItem)localObject1).name.startsWith("new_qq_android_native_short_new_other_"))
          {
            ...
            QLog.d("qqidentification_server", 1, new Object[] { "no res,start download, localpath is", localObject2, " version is : ", Integer.valueOf(i), " app so bits is : ", Integer.valueOf(astc.b()) });
