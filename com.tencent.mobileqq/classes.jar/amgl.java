  ...
  implements View.OnClickListener
{
  ...
  public amgl(Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, List<PhoneContact> paramList)
  {
    ...
    this.jdField_a_of_type_Int = paramContext.getResources().getDimensionPixelOffset(2131298144);
    this.jdField_b_of_type_Int = paramContext.getResources().getDimensionPixelOffset(2131298145);
    a(paramList);
  }
  
  public static amgo a(List<PhoneContact> paramList, ArrayList<PhoneContact> paramArrayList, boolean paramBoolean)
  {
    ...
    localamgo.jdField_a_of_type_JavaUtilList = ((List)localObject);
    label52:
    label53:
    ...
    {
      if (localamgo.jdField_a_of_type_JavaUtilLinkedHashMap.get(paramArrayList) == null) {
        localamgo.jdField_a_of_type_JavaUtilLinkedHashMap.put(paramArrayList, new ArrayList());
      }
      ((List)localamgo.jdField_a_of_type_JavaUtilLinkedHashMap.get(paramArrayList)).add(localPhoneContact);
      ...
      if (localamgo.jdField_a_of_type_JavaUtilLinkedHashMap.get("★") == null) {
        localamgo.jdField_a_of_type_JavaUtilLinkedHashMap.put("★", new ArrayList());
      }
      ((List)localamgo.jdField_a_of_type_JavaUtilLinkedHashMap.get("★")).add(localPhoneContact);
      break label53;
      paramList = null;
      break;
    ...
    if (paramList != null)
    {
      localamgo.jdField_b_of_type_JavaUtilList = paramList;
      if (!paramBoolean)
      {
        if (localamgo.jdField_a_of_type_JavaUtilLinkedHashMap.get("★") == null) {
          localamgo.jdField_a_of_type_JavaUtilLinkedHashMap.put("★", new ArrayList());
        }
        ((List)localamgo.jdField_a_of_type_JavaUtilLinkedHashMap.get("★")).addAll(paramList);
      }
    }
    paramArrayList = localamgo.jdField_a_of_type_JavaUtilLinkedHashMap;
    localamgo.jdField_a_of_type_JavaUtilLinkedHashMap = new LinkedHashMap();
    for (char c1 = 'A'; c1 <= 'Z'; c1 = (char)(c1 + '\001')) {
      if (paramArrayList.get(String.valueOf(c1)) != null) {
        localamgo.jdField_a_of_type_JavaUtilLinkedHashMap.put(String.valueOf(c1), paramArrayList.get(String.valueOf(c1)));
      }
    }
    if (paramArrayList.get("#") != null) {
      localamgo.jdField_a_of_type_JavaUtilLinkedHashMap.put("#", paramArrayList.get("#"));
    }
    if ((paramList != null) && ((((List)localObject).size() > 10) || (!paramBoolean)) && (paramArrayList.get("★") != null)) {
      localamgo.jdField_a_of_type_JavaUtilLinkedHashMap.put("★", paramList);
    }
    paramArrayList.clear();
    localamgo.jdField_a_of_type_ArrayOfInt = new int[localamgo.jdField_a_of_type_JavaUtilLinkedHashMap.keySet().size()];
    localamgo.jdField_a_of_type_ArrayOfJavaLangString = new String[localamgo.jdField_a_of_type_ArrayOfInt.length];
    paramList = new ArrayList(localamgo.jdField_a_of_type_JavaUtilLinkedHashMap.keySet());
    Collections.sort(paramList, new amgm());
    paramArrayList = paramList.iterator();
    if (localamgo.jdField_a_of_type_ArrayOfInt.length == 0) {
      return localamgo;
    }
    localamgo.jdField_a_of_type_ArrayOfInt[0] = 0;
    int i = 1;
    while (i < localamgo.jdField_a_of_type_ArrayOfInt.length)
    {
      localObject = localamgo.jdField_a_of_type_ArrayOfInt;
      int j = localObject[i];
      int k = localamgo.jdField_a_of_type_ArrayOfInt[(i - 1)];
      localObject[i] = (((List)localamgo.jdField_a_of_type_JavaUtilLinkedHashMap.get(paramArrayList.next())).size() + k + 1 + j);
      i += 1;
    }
    ...
    {
      localamgo.jdField_a_of_type_ArrayOfJavaLangString[i] = ((String)paramList.next());
      i += 1;
    }
    return localamgo;
  }
  ...
  {
    this.jdField_b_of_type_JavaUtilList = paramamgo.jdField_a_of_type_JavaUtilList;
    this.jdField_a_of_type_ArrayOfInt = paramamgo.jdField_a_of_type_ArrayOfInt;
    this.jdField_a_of_type_JavaUtilLinkedHashMap = paramamgo.jdField_a_of_type_JavaUtilLinkedHashMap;
    this.jdField_a_of_type_ArrayOfJavaLangString = paramamgo.jdField_a_of_type_ArrayOfJavaLangString;
    this.c = paramamgo.jdField_b_of_type_JavaUtilList;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localObject2 = new amgn();
      Object localObject3 = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131561075, null);
      ((amgn)localObject2).jdField_a_of_type_AndroidWidgetTextView = ((TextView)((View)localObject3).findViewById(2131371981));
      ((amgn)localObject2).jdField_c_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject3).findViewById(2131361796));
      ((amgn)localObject2).b = ((TextView)((View)localObject3).findViewById(2131376609));
      ((amgn)localObject2).jdField_c_of_type_AndroidWidgetTextView = ((TextView)((View)localObject3).findViewById(2131377905));
      ((amgn)localObject2).jdField_a_of_type_AndroidWidgetButton = ((Button)((View)localObject3).findViewById(2131376596));
      ((amgn)localObject2).d = ((TextView)((View)localObject3).findViewById(2131376606));
      ((amgn)localObject2).jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)((View)localObject3).findViewById(2131364608));
      ((amgn)localObject2).e = ((TextView)((View)localObject3).findViewById(2131379987));
      ((amgn)localObject2).jdField_a_of_type_AndroidViewView = ((View)localObject3).findViewById(2131374342);
      ((View)localObject3).setBackgroundDrawable(null);
      ((View)localObject3).setTag(localObject2);
      paramView = (View)localObject2;
      localObject1 = localObject3;
      if ((((amgn)localObject2).jdField_c_of_type_AndroidWidgetImageView instanceof ThemeImageView))
      {
        ((ThemeImageView)((amgn)localObject2).jdField_c_of_type_AndroidWidgetImageView).setSupportMaskView(false);
        localObject1 = localObject3;
        paramView = (View)localObject2;
      }
      ...
      ((View)localObject1).findViewById(2131376602).setPadding(0, 0, this.jdField_a_of_type_Int, 0);
      label265:
      if (i >= 0) {
        break label1072;
      }
      ...
      aiyz.a((View)localObject1, true);
      aiyz.b(paramView.jdField_a_of_type_AndroidViewView, true);
      label372:
      ...
      if (AppSetting.c)
      {
        bgyd.a(paramView.jdField_a_of_type_AndroidWidgetTextView, false);
      ...
      Object localObject4 = String.format(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131691066), new Object[] { Integer.valueOf(((PhoneContact)localObject2).samFriend) });
      ...
      paramView.d.setText(anvx.a(2131701957));
      ...
      if (AppSetting.c) {
        paramView.d.setContentDescription(anvx.a(2131701952));
      }
      label643:
    ...
    for (;;)
    {
      ...
      return localObject1;
      localObject2 = (amgn)paramView.getTag();
      localObject1 = paramView;
      paramView = (View)localObject2;
      break;
      label779:
      ((View)localObject1).findViewById(2131376602).setPadding(0, 0, this.jdField_b_of_type_Int, 0);
      break label265;
      label800:
      aiyz.a((View)localObject1, false);
      aiyz.b(paramView.jdField_a_of_type_AndroidViewView, false);
      break label372;
      label817:
      ...
      break label538;
      label841:
      if (this.jdField_a_of_type_Anvk.a(((PhoneContact)localObject2).unifiedCode, true))
      {
        paramView.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
        paramView.d.setVisibility(0);
        paramView.d.setText(anvx.a(2131701955));
        if (this.jdField_a_of_type_Boolean)
        {
          paramView.jdField_a_of_type_AndroidViewView.setEnabled(false);
          paramView.jdField_a_of_type_AndroidWidgetCheckBox.setEnabled(false);
        ...
        paramView.d.setContentDescription(anvx.a(2131701961));
        break label643;
      }
      if (this.jdField_a_of_type_Boolean)
      {
      ...
      for (;;)
      {
        ...
        paramView.jdField_a_of_type_AndroidWidgetButton.setText(anvx.a(2131689550));
        ...
        if (AppSetting.c) {
          paramView.jdField_a_of_type_AndroidWidgetButton.setContentDescription(anvx.a(2131689550));
        }
      }
      label1065:
      i = 8;
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      case 2131374342: 
        ...
        localObject1 = (amgn)localObject1;
        boolean bool2 = a(((amgn)localObject1).jdField_a_of_type_ComTencentMobileqqDataPhoneContact);
        localObject2 = ((amgn)localObject1).jdField_a_of_type_ComTencentMobileqqDataPhoneContact;
        if (bool2) {
          break label733;
        }
        bool1 = true;
        ...
        {
          localObject2 = this.jdField_a_of_type_Amgp;
          localObject1 = ((amgn)localObject1).jdField_a_of_type_ComTencentMobileqqDataPhoneContact;
          if (bool2) {
            break label739;
          }
          bool1 = true;
          label147:
          ((amgp)localObject2).a((PhoneContact)localObject1, bool1);
        }
        break;
      }
    }
    ...
    for (int i = 3084;; i = 3006)
    {
      ...
      if (!((awyz)localObject1).i()) {
        if (this.c.contains(localObject2))
        {
          bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80077CD", "0X80077CD", 1, 0, "", "", "", "");
      ...
      for (localObject1 = "#";; localObject1 = String.valueOf(((PhoneContact)localObject2).pinyinFirst.charAt(0)).toUpperCase())
      {
        ...
        localObject1 = AddFriendLogicActivity.a(this.jdField_a_of_type_AndroidContentContext, 2, ((PhoneContact)localObject2).unifiedCode, null, i, j, ((PhoneContact)localObject2).name, null, null, anvx.a(2131701958), null);
        this.jdField_a_of_type_AndroidContentContext.startActivity((Intent)localObject1);
        bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006A75", "0X8006A75", 0, 0, "", "", "", "");
        notifyDataSetChanged();
        break;
        bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80077CD", "0X80077CD", 2, 0, "", "", "", "");
        break label269;
        if (this.c.isEmpty())
        {
          bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80077D0", "0X80077D0", 0, 0, "", "", "", "");
          break label312;
        }
        if (this.c.contains(localObject2)) {
          bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80077D3", "0X80077D3", 1, 0, "", "", "", "");
        }
        for (;;)
        {
          bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80077D3", "0X80077D3", 0, 0, "", "", "", "");
          break;
          bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80077D3", "0X80077D3", 2, 0, "", "", "", "");
        }
      }
      label733:
      bool1 = false;
      ...
      break label147;
      label745:
      this.jdField_a_of_type_ComTencentMobileqqDataPhoneContact = ((amgn)localObject1).jdField_a_of_type_ComTencentMobileqqDataPhoneContact;
