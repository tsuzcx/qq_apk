...
public class amgl
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new amgm(this, Looper.getMainLooper());
  ...
  public boolean a()
  {
    ...
    try
    {
      SAXParserFactory.newInstance().newSAXParser().parse(new InputSource(new InputStreamReader(new FileInputStream((File)localObject), "UTF-8")), localamgp);
      this.jdField_a_of_type_Int = localamgp.a();
      this.jdField_a_of_type_JavaUtilArrayList = localamgp.a();
      return true;
    }
