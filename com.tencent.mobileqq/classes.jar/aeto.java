...
public class aeto
  extends Handler
{
  public aeto(PressToChangeVoicePanel paramPressToChangeVoicePanel, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    else
    {
      ...
      awud.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a, (QQRecorder.RecorderParam)localObject1);
      Object localObject2 = (ListenChangeVoicePanel)this.a.f.findViewById(2131369545);
      ...
      if ((this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof agot)) {
      ...
      paramMessage = (ViewGroup)((ListenChangeVoicePanel)localObject2).findViewById(2131364105);
      if (bhou.e())
      {
        ...
        localAnimatorSet.addListener(new aetp(this, paramMessage));
