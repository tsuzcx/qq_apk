...
public class bcrs
{
  ...
  private boolean d(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    //   34: invokespecial 302	bcrs:a	(Ljava/lang/String;)J
  ...
  private boolean i(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    for (;;)
    {
      ...
      for (int i = 1;; i = 2)
      {
        ...
        return true;
        localObject2 = bcsa.a((String)localObject2);
        break;
      }
    }
  }
  ...
  private boolean l(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    awuz.a("Video", "Send video message :selfUin = " + localSvcRequestSendVideoMsg.lUin + " toUin = " + localSvcRequestSendVideoMsg.lPeerUin + " buffer[2] = " + paramToServiceMsg);
    return true;
  }
  ...
  private boolean m(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    case 1: 
      for (;;)
      {
        ...
        if (paramToServiceMsg != null)
        {
          ...
          bhvd.a(localReqOffFilePack.vBody, 2, (short)0);
          bhvd.a(localReqOffFilePack.vBody, 4, (short)0);
          bhvd.a(localReqOffFilePack.vBody, 6, (short)1);
          bhvd.a(localReqOffFilePack.vBody, 8, (short)j);
          bhvd.a(localReqOffFilePack.vBody, 10, paramToServiceMsg, j);
          continue;
          localReqOffFilePack.vBody = new byte[13];
          localReqOffFilePack.vBody[0] = 6;
          bhvd.a(localReqOffFilePack.vBody, 1, l);
          bhvd.a(localReqOffFilePack.vBody, 5, 0L);
          bhvd.a(localReqOffFilePack.vBody, 9, 0L);
        }
      }
    case 2: 
    ...
    for (k = 8 + j;; k = 8)
    {
      ...
      bhvd.a(localReqOffFilePack.vBody, 2, l);
      bhvd.a(localReqOffFilePack.vBody, 6, (short)j);
      bhvd.a(localReqOffFilePack.vBody, 8, paramToServiceMsg, j);
      break;
  ...
  private boolean r(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    paramToServiceMsg.iMsgId = bdoc.b(str);
    paramToServiceMsg.type = 1;
    paramToServiceMsg.iSendTime = 0;
    paramToServiceMsg.shPackNum = bdoc.b(str);
    paramToServiceMsg.shFlowLayer = bdoc.a(str);
    ...
    ((StreamData)localObject1).vData = bdoc.a(str, localShort.shortValue());
    boolean bool = bdoc.b(str);
    if (bool)
    {
      paramToServiceMsg.shPackNum = 0;
  ...
  private boolean s(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    paramToServiceMsg.iMsgId = bdoc.b(str1);
    paramToServiceMsg.type = 1;
    paramToServiceMsg.iSendTime = 0;
    paramToServiceMsg.shPackNum = 0;
    paramToServiceMsg.shFlowLayer = bdoc.a(str1);
    if (QLog.isColorLevel()) {
  ...
  public byte[] a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, byte[] paramArrayOfByte4, long paramLong)
  {
    ...
    if (paramArrayOfByte1 == null)
    {
      ...
      arrayOfByte[0] = 1;
      bhvd.a(arrayOfByte, 1, 0L);
      if (paramArrayOfByte1 == null) {
        break label388;
      }
      bhvd.a(arrayOfByte, 5, (short)paramArrayOfByte1.length);
      bhvd.a(arrayOfByte, 7, paramArrayOfByte1, paramArrayOfByte1.length);
      i = paramArrayOfByte1.length + 7;
      label112:
      if (paramArrayOfByte1 == null) {
        break label402;
      }
      bhvd.a(arrayOfByte, i, (short)paramArrayOfByte1.length);
      i += 2;
      bhvd.a(arrayOfByte, i, paramArrayOfByte1, paramArrayOfByte1.length);
      i += paramArrayOfByte1.length;
      label149:
      bhvd.a(arrayOfByte, i, (short)0);
      i += 2;
      bhvd.a(arrayOfByte, i, paramLong);
      i += 4;
      if (paramArrayOfByte3 == null) {
        break label419;
      }
      bhvd.a(arrayOfByte, i, (short)paramArrayOfByte3.length);
      i += 2;
      bhvd.a(arrayOfByte, i, paramArrayOfByte3, paramArrayOfByte3.length);
      ...
      i += 1;
      bhvd.a(arrayOfByte, i, paramArrayOfByte4, paramArrayOfByte4.length);
    ...
    for (;;)
    {
      ...
      bhvd.a(arrayOfByte, i, (short)paramArrayOfByte2.length);
      i += 2;
      bhvd.a(arrayOfByte, i, paramArrayOfByte2, paramArrayOfByte2.length);
