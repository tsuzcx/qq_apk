  ...
  extends DynamicTextItem
{
  ...
  private static final String jdField_a_of_type_JavaLangString = bjhg.class.getSimpleName();
  ...
  public bjhg(int paramInt, List<String> paramList, Typeface paramTypeface, Bitmap paramBitmap1, Bitmap paramBitmap2)
  {
    ...
    QLog.i(bkaj.jdField_a_of_type_JavaLangString, 1, "setLetterSpacing" + bool);
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    paramInt = (int)this.jdField_a_of_type_AndroidTextTextPaint.measureText(ajyc.a(2131704946));
