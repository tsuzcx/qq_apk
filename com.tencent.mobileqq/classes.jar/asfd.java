  ...
  extends ases
{
  ...
  public asfd(MessageRecord paramMessageRecord)
  {
  ...
  public int a(List<ases> paramList)
  {
    ...
    {
      ases localases = (ases)localIterator.next();
      if ((localases instanceof asfd))
      {
        MessageRecord localMessageRecord = ((asfd)localases).jdField_a_of_type_ComTencentMobileqqDataMessageRecord;
        if (localMessageRecord.uniseq == this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.uniseq) {
          if (((localMessageRecord instanceof MessageForPic)) && ((this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord instanceof MessageForPic)) && (((MessageForPic)localMessageRecord).md5 != null))
          {
            if (((MessageForPic)localMessageRecord).md5.equals(((MessageForPic)this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord).md5)) {
              return paramList.indexOf(localases);
            }
          }
          else {
            return paramList.indexOf(localases);
  ...
  {
    asfa localasfa = new asfa(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
    paramContext = aseu.a(paramContext, localasfa);
    this.jdField_a_of_type_Boolean = localasfa.c;
    return paramContext;
  }
  ...
  public arxg a()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord instanceof MessageForMarketFace)) {
      return aseu.a((MessageForMarketFace)this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
    }
    return null;
  }
  ...
  public boolean a(ases paramases)
  {
    ...
    if ((paramases instanceof asfd))
    {
      ...
      if (paramases != null)
      {
        ...
        {
          bool1 = bool2;
          if (paramases.shmsgseq == this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.shmsgseq)
          {
            bool1 = bool2;
            if (paramases.msgUid == this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.msgUid) {
              bool1 = true;
            }
          }
        }
  ...
  public ases b(Bundle paramBundle)
  {
    if (paramBundle.containsKey("cur_msg_uniseq"))
    {
      ...
      if ((paramBundle instanceof QQAppInterface)) {
        return new asfd(((QQAppInterface)paramBundle).a().b(str, i, l));
      }
    }
    return null;
  }
