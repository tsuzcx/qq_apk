  ...
  extends BaseUpdateBusiness
{
  ...
  private void a(@NonNull UpdateListenerParams paramUpdateListenerParams)
  {
    ...
    do
    {
      ...
      paramUpdateListenerParams = bhry.a(l);
  ...
  public void deleteFile(@NonNull BusinessUpdateParams paramBusinessUpdateParams, BusinessItemInfo paramBusinessItemInfo)
  {
    ...
    paramBusinessItemInfo = bhry.a(l);
    QQAppInterface localQQAppInterface = a();
    if (localQQAppInterface == null) {
  ...
  {
    Object localObject = bhry.a(paramLong);
    if (localObject == null) {
      return null;
    }
    QQAppInterface localQQAppInterface = a();
    ...
    localBusinessItemInfo.mIsCanUpdate = ((bhoc)localObject).canUpdate(localQQAppInterface, paramLong, paramString, "");
    if (QLog.isColorLevel()) {
    ...
    localObject = ((bhoc)localObject).getItemInfo(localQQAppInterface, paramLong, paramString);
    if (localObject != null)
    {
  ...
  public void onProgress(@NonNull UpdateListenerParams paramUpdateListenerParams)
  {
    ...
    do
    {
      ...
      paramUpdateListenerParams = bhry.a(l1);
    } while (paramUpdateListenerParams == null);
    QQAppInterface localQQAppInterface = a();
    if (localQQAppInterface == null) {
