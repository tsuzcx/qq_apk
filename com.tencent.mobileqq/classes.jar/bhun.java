...
{
  bhun(bhum parambhum, String paramString) {}
  ...
  public void onDownloadCanceled(String paramString)
  {
    ...
    try
    {
      ...
      bhum.a(this.jdField_a_of_type_Bhum).callJs(this.jdField_a_of_type_JavaLangString, new String[] { localJSONObject.toString() });
      return;
    }
  ...
  public void onDownloadFailed(String paramString, DownloadResult paramDownloadResult)
  {
    ...
    for (;;)
    {
      ...
      bhum.b(this.jdField_a_of_type_Bhum).callJs(this.jdField_a_of_type_JavaLangString, new String[] { paramString.toString() });
      return;
      paramString.put("code", -1);
    }
  }
  ...
  public void onDownloadSucceed(String paramString, DownloadResult paramDownloadResult)
  {
    ...
    try
    {
      ...
      bhum.c(this.jdField_a_of_type_Bhum).callJs(this.jdField_a_of_type_JavaLangString, new String[] { paramString.toString() });
      return;
    }
    catch (Exception paramString)
    {
