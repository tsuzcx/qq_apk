...
{
  public bkza(ARMapHongBaoListView paramARMapHongBaoListView) {}
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 1: 
      ...
      if ((bool1) && (bool2))
      {
        this.a.jdField_a_of_type_Aqcq.a(-this.a.d);
      ...
      {
        float f = j * 1.0F / 6.0F;
        if (this.a.jdField_a_of_type_Aqco != null) {
          this.a.jdField_a_of_type_Aqco.a((int)(f * this.a.d), j * 300L);
        }
        k = j - 1;
        i = k;
        if (k > 0)
    ...
    for (int i = k;; i = j)
    {
      ...
      this.a.jdField_a_of_type_Aqcq.a(-i);
      if (this.a.jdField_a_of_type_Aqco != null) {
        this.a.jdField_a_of_type_Aqco.a(this.a.d / 3, 300L);
      }
