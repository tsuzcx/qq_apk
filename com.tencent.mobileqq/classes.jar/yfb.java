  ...
  extends CharDividedFacePreloadBaseAdapter
{
  ...
  public yfb(DiscussionMemberListInnerFrame paramDiscussionMemberListInnerFrame)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberDiscussionMemberListInnerFrame.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130971586, paramViewGroup, false);
      paramView = new yfc(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberDiscussionMemberListInnerFrame, null);
      ...
      paramView.jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)localView.findViewById(2131363964));
      paramView.c = ((ImageView)localView.findViewById(2131362724));
      paramView.b = ((TextView)localView.findViewById(2131362759));
    }
    paramView = (yfc)localView.getTag();
    if (i < 0)
    {
      i = -(i + 1) - 1;
