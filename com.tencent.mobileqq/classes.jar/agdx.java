...
public final class agdx
{
  public static void a(Activity paramActivity)
  {
    ...
    {
      localObject = new xez(paramActivity);
      ((TextView)((xez)localObject).findViewById(2131311544)).setText(ajjy.a(2131647807));
      QQAppInterface localQQAppInterface = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
      str2 = localQQAppInterface.getApplication().getString(2131653579) + str2;
      paramActivity = new aged(paramActivity, str1, str3, localQQAppInterface);
      ((xez)localObject).a(str2, paramActivity);
      ((xez)localObject).a(paramActivity);
      ((xez)localObject).setCancelable(false);
      ((xez)localObject).show();
      return;
    }
  ...
  public static void a(Activity paramActivity, String paramString)
  {
    ...
    String str3 = localQQAppInterface.getApplication().getString(2131653579) + (String)localObject1;
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = bach.a(((MessageDigest)localObject2).digest());
      }
      ...
      awqx.b(localQQAppInterface, "dc00898", "", "", "0X8009DFB", "0X8009DFB", 0, 0, str2, "1", "", "");
      try
      {
        paramString = babr.a(paramActivity, 230);
        paramString.setMessage(ajjy.a(2131647806));
        paramString.setNegativeButton(2131625035, new agdy(paramActivity));
    ...
    zsb.a(paramActivity, 1, str2, (Bundle)localObject2).a("sdk_dynamic_avatar_edit", null, new agdz(localQQAppInterface, str2, paramActivity, str3, str5, paramString, localIntent));
  }
  ...
  private static void b(Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    try
    {
      xez localxez = new xez(paramActivity);
      ((TextView)localxez.findViewById(2131311544)).setText(paramString1);
      paramString1 = localxez.findViewById(2131299574);
      View localView = localxez.findViewById(2131297971);
      paramString1.setVisibility(8);
      localView.setVisibility(8);
      localxez.findViewById(2131311545).setVisibility(8);
      localxez.a(paramString2, new ageb(paramActivity, paramString3, paramString4));
      localxez.setCancelable(false);
      localxez.show();
      return;
    }
    catch (Exception paramActivity)
  ...
  private static void c(Activity paramActivity)
  {
    ...
    try
    {
      ...
      ((bafb)localObject).setMessage(ajjy.a(2131647808));
      ((bafb)localObject).setTitle(2131626648);
      paramActivity = new agec(paramActivity, str1, str2);
      ((bafb)localObject).setNegativeButton(2131625035, paramActivity);
      ((bafb)localObject).setPositiveButton(2131653589, paramActivity);
