...
{
  public aeow(GameRoomTransActivity paramGameRoomTransActivity, String paramString, int paramInt) {}
        ...
        for (;;)
        {
          ...
          else
          {
            ...
            else if (paramInt == 1009)
            {
              ...
              this.jdField_a_of_type_ComTencentMobileqqNearbyGameroomGameRoomTransActivity.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setPositiveButton("查看我的游戏", new aeox(this, paramRspBody));
              this.jdField_a_of_type_ComTencentMobileqqNearbyGameroomGameRoomTransActivity.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setNegativeButton(2131432414, new aeoy(this));
