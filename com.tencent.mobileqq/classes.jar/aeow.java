  ...
  extends RelativeLayout
{
  ...
  public aeow(PanelAdapter paramPanelAdapter, Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
    this.jdField_a_of_type_AndroidViewLayoutInflater = LayoutInflater.from(paramContext);
    int k = paramPanelAdapter.a();
    int m = paramPanelAdapter.b();
    int i = aekt.a(15.0F, getContext().getResources());
    ...
    while (i < m)
    {
      ...
      localLayoutParams.leftMargin = aekt.a(20.0F, getContext().getResources());
      localLayoutParams.rightMargin = aekt.a(20.0F, getContext().getResources());
      ...
      while (j < k)
      {
        ...
        localObject = new aeox();
        ((aeox)localObject).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131367934));
        ((aeox)localObject).jdField_a_of_type_ComTencentMobileqqRedtouchRedTouch = new RedTouch(paramContext, ((aeox)localObject).jdField_a_of_type_AndroidWidgetImageView).a(8388661).a();
        ((aeox)localObject).b = ((ImageView)localView.findViewById(2131366463));
        ((aeox)localObject).jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131377567));
  ...
  public void a()
  {
    ...
    while (i < getChildCount())
    {
      ...
      if (localObject != null)
      {
        localObject = (aeox)((View)localObject).getTag();
        if ((localObject != null) && (((aeox)localObject).jdField_a_of_type_AndroidWidgetImageView != null)) {
          ((aeox)localObject).jdField_a_of_type_AndroidWidgetImageView.setBackgroundDrawable(null);
        }
      }
      i += 1;
    }
  ...
  protected void a(Context paramContext)
  {
    ...
    {
      int i = aekt.a(18.0F, getContext().getResources());
      int j = aekt.a(18.0F, getContext().getResources());
