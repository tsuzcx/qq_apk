...
public class bmhg
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, bmhi parambmhi)
  {
    paramQQAppInterface = a(paramQQAppInterface, paramString, new bmhh(parambmhi, paramString));
    if (!StringUtil.isEmpty(paramQQAppInterface))
    {
      if (parambmhi != null)
      {
        ...
        parambmhi.a(0, new String[] { paramQQAppInterface });
      }
      return;
    }
