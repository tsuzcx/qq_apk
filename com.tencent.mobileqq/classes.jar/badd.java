...
public class badd
{
  private static badd jdField_a_of_type_Badd;
  ...
  public static badd a()
  {
    if (jdField_a_of_type_Badd == null) {}
    try
    {
      if (jdField_a_of_type_Badd == null) {
        jdField_a_of_type_Badd = new badd();
      }
      return jdField_a_of_type_Badd;
    }
    finally {}
  }
  ...
  private static String a()
  {
    ...
    try
    {
      localObject = aqca.b((String)localObject);
      return localObject;
    }
    ...
    for (;;)
    {
      ...
      try
      {
        if (a().a())
        {
          ...
          {
            if (paramBoolean) {
              bbmy.a(paramActivity, 1, str, 1000).b(paramActivity.getResources().getDimensionPixelSize(2131167766));
            }
