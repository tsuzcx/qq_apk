  ...
  extends alko
{
  ...
  public badd(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_Boolean = bdiv.b(paramQQAppInterface.getApp(), paramQQAppInterface.c(), "tencent_docs_config_enable_assistant", false);
    this.jdField_b_of_type_Boolean = bdiv.b(paramQQAppInterface.getApp(), paramQQAppInterface.c(), "tencent_docs_config_preload_tool_process", false);
  }
  ...
  public static int a(String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      paramString1 = badg.b(localJSONObject, paramString2, "https://docs.qq.com/form/collect/recordcnt", "docs.qq.com");
      i = j;
  ...
  {
    return new File(a(), bfhi.b(paramString));
  }
  ...
  private String a(ReSendCmd paramReSendCmd)
  {
    ...
    {
      paramReSendCmd = localTicketManager.GetSkey(this.mApp.getCurrentAccountUin(), 16L, new badf(this, localTicketManager, paramReSendCmd));
  ...
  private String a(ReSendCmd paramReSendCmd, boolean paramBoolean)
  {
    ...
    if (localObject != null)
    {
      ...
      bade localbade = new bade(this, (TicketManager)localObject, paramReSendCmd);
      localObject = ((TicketManager)localObject).GetPskey(str, 16L, new String[] { "docs.qq.com" }, localbade);
  ...
  public static String a(String paramString, babw parambabw)
  {
    int j = 1;
    localObject2 = null;
    try
    {
      i = parambabw.jdField_a_of_type_Int;
      if (i != 0) {
        break label461;
      }
      i = 1;
    }
    catch (JSONException parambabw)
    {
      for (;;)
      {
        int i;
        ...
        if (QLog.isColorLevel()) {
          QLog.e("TeamWorkHandler", 2, parambabw, new Object[0]);
        }
        continue;
        paramString = null;
      }
    ...
    localJSONObject.put("url", URLEncoder.encode(parambabw.e));
    if (parambabw.j != null) {
      localJSONObject.put("title", URLEncoder.encode(parambabw.j));
    }
    ...
    if (parambabw.k == null)
    {
      ...
      localObject1 = new StringBuilder("https://docs.qq.com/cgi-bin/online_docs/wxqrcode").append('?').append("domainId=").append(parambabw.i).append("&padId=").append(parambabw.h).append("&dataType=");
      if (parambabw.jdField_b_of_type_Int != 3) {
        break label390;
      }
    }
    for (;;)
    {
      localObject1 = badg.a(paramString, j + "&page=" + "pages/shareFriend/shareFriend" + "&ac=" + "share" + "&t=" + "0" + "&policy=" + String.valueOf(i) + "&right_flag=" + "1" + "&param=" + localJSONObject.toString() + "&type=" + "1", "docs.qq.com");
      if (localObject1 == null) {
        break label456;
      }
      parambabw = new JSONObject((String)localObject1);
      paramString = parambabw;
      for (;;)
      {
        try
        {
          if (parambabw.optInt("retcode", -1) != 0)
          {
            parambabw.put("retcode", -1);
            paramString = parambabw;
            if (QLog.isColorLevel())
            {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("TeamWorkHandler", 2, parambabw.toString());
      }
      return (String)parambabw.opt("key");
      localObject1 = parambabw.k;
      break;
      j = 0;
    }
  }
    ...
    if (paramString1 != null)
    {
      ...
      if (localObject.length == 2)
      {
        ...
        try
        {
          ...
          paramString1 = badg.a(localStringBuilder2.toString(), paramString2, "https://docs.qq.com/cgi-bin/online_docs/doc_delete", "docs.qq.com", localStringBuilder1.toString(), (Map)localObject, false);
          return paramString1;
        }
  ...
  public static JSONObject a(String paramString1, int paramInt, String paramString2)
  {
    ...
    //   33: ldc 69
    //   35: invokestatic 311	badg:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   38: astore 4
    //   40: aload 4
    //   42: ifnull +155 -> 197
  ...
  public static JSONObject a(String paramString1, String paramString2)
  {
    ...
    //   23: ldc 69
    //   25: invokestatic 311	badg:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   28: astore_3
    //   29: aload_3
    //   30: ifnull +150 -> 180
  ...
  public static JSONObject a(String paramString1, String paramString2, int paramInt, String paramString3, String paramString4, String paramString5)
  {
    ...
    //   75: ldc 69
    //   77: invokestatic 311	badg:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   80: astore_3
    //   81: aload_3
    //   82: ifnull +187 -> 269
  ...
  public static JSONObject a(JSONObject paramJSONObject, String paramString)
  {
    try
    {
      String str = badg.b(paramJSONObject, paramString, "https://docs.qq.com/cgi-go/imp/import_form_cache", "docs.qq.com");
      if (str != null)
      {
  ...
  public static JSONObject a(JSONObject paramJSONObject, String paramString1, String paramString2)
  {
    try
    {
      paramString2 = badg.a(paramJSONObject, paramString1, "https://docs.qq.com/cgi-go/imp/import_form_file", paramString2);
  ...
  {
    paramString1 = badg.b("doc_url=" + URLEncoder.encode(paramString3), paramString1, "https://docs.qq.com/cgi-bin/online_docs/doc_content", "docs.qq.com");
    if (!TextUtils.isEmpty(paramString1)) {
      bdcs.a(a(), bfhi.b(paramString2), paramString1);
    }
  }
  ...
  public static boolean a(String paramString, babw parambabw)
  {
    Object localObject = UUID.randomUUID().toString().replaceAll("-", "");
    parambabw = new StringBuilder("https://docs.qq.com/cgi-bin/api/wechatshare/shareTips").append('?').append("domainId=").append(parambabw.i).append("&padId=").append(parambabw.h).append("&xsrf=").append((String)localObject);
    localObject = new StringBuilder().append("TOK=").append((String)localObject);
    try
    {
      paramString = badg.a(paramString, parambabw.toString(), "docs.qq.com", ((StringBuilder)localObject).toString());
      if (paramString != null)
      {
  ...
  public static boolean a(String paramString1, String paramString2, String paramString3, boolean paramBoolean1, boolean paramBoolean2, int paramInt, List<String> paramList1, List<String> paramList2, List<String> paramList3)
  {
    ...
    for (paramInt = 1;; paramInt = 0)
    {
      ...
      paramString1 = badg.a(paramString1, paramString2.toString(), "docs.qq.com", paramString3.toString());
      if (paramString1 == null) {
        break;
      }
  ...
  public static JSONObject b(JSONObject paramJSONObject, String paramString)
  {
    try
    {
      String str = badg.b(paramJSONObject, paramString, "https://docs.qq.com/cgi-go/imp/import_form_url", "docs.qq.com");
      if (str != null)
      {
        paramJSONObject = new JSONObject(str);
        paramString = paramJSONObject;
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    try
    {
      ...
      if (j == 0)
      {
        ...
        QLog.i("TeamWorkHandler" + baca.i, 2, " handleGetUserAuthDocsGrayTips  | policy=" + k + " privilege =" + m + " memberNum = " + n + " remainTime = " + i1 + " setTime= " + i);
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          QLog.i("TeamWorkHandler" + baca.i, 2, " handleGetUserAuthDocsGrayTips ,result: " + j);
          return;
          bool = false;
          paramToServiceMsg = this.app.getApp().getString(2131720687);
          continue;
          bool = false;
    ...
    {
      QLog.e("TeamWorkHandler" + baca.i, 1, " handleGetUserAuthDocsGrayTips exception = " + paramToServiceMsg.toString());
      return;
    }
    label425:
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i == 0)
        {
          ...
          {
            azmj.b(null, "CliOper", "", "", "0X8009550", "0X8009550", 0, 0, "", "", "", "");
            break label309;
            notifyUI(9, bool, new Object[] { localDocsGrayTipsInfo, paramToServiceMsg, Long.valueOf(l) });
            if (!QLog.isColorLevel()) {
              break;
            }
            QLog.i("TeamWorkHandler" + baca.i, 2, " handleSetUserAuthDocsGrayTips ,result: " + i);
          }
          else if ("2".equals(localDocsGrayTipsInfo.d))
          {
            azmj.b(null, "CliOper", "", "", "0X8009552", "0X8009552", 0, 0, "", "", "", "");
          }
        }
      }
      catch (Exception paramToServiceMsg)
      {
        QLog.e("TeamWorkHandler" + baca.i, 1, " handleSetUserAuthDocsGrayTips  exception = " + paramToServiceMsg.toString());
        return;
      }
      boolean bool = false;
      paramToServiceMsg = localDocsGrayTipsInfo.k;
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    try
    {
      ...
      if (k == 0)
      {
        ...
        QLog.i("TeamWorkHandler" + baca.i, 1, " handleGetGroupAuthDocsGrayTips  | policy = " + i + " userInfoList.size() = " + paramFromServiceMsg.size() + " totalMembers = " + n + " privilegeMembers = " + i1 + " privilege = " + i2 + " memberNum = " + i3 + " remainTime = " + m + " setTime = " + j + " docsGrayTipsInfo.policy = " + localDocsGrayTipsInfo.m + " docsGrayTipsInfo.privilege = " + localDocsGrayTipsInfo.n);
      ...
      for (;;)
      {
        QLog.i("TeamWorkHandler" + baca.i, 1, " handleGetGroupAuthDocsGrayTips. result = " + k + ", isSuccess = " + bool);
        if (bool) {
          break;
        }
    ...
    {
      QLog.e("TeamWorkHandler" + baca.i, 1, " handleGetGroupAuthDocsGrayTips exception = " + paramToServiceMsg.toString());
    }
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i == 0)
        {
          ...
          if ("1".equals(localDocsGrayTipsInfo.d))
          {
            azmj.b(null, "CliOper", "", "", "0X8009550", "0X8009550", 1, 0, "", "", "", "");
            break label303;
            QLog.i("TeamWorkHandler" + baca.i, 1, " handleSetGroupAuthDocsGrayTips. result = " + i);
            notifyUI(11, bool, new Object[] { localDocsGrayTipsInfo, paramToServiceMsg, Long.valueOf(l) });
          }
          else if ("2".equals(localDocsGrayTipsInfo.d))
          {
            azmj.b(null, "CliOper", "", "", "0X8009552", "0X8009552", 1, 0, "", "", "", "");
          }
        }
      }
      catch (Exception paramToServiceMsg)
      {
        QLog.e("TeamWorkHandler" + baca.i, 1, " handleSetGroupAuthDocsGrayTips  exception = " + paramToServiceMsg.toString());
        return;
      }
      boolean bool = false;
      paramToServiceMsg = localDocsGrayTipsInfo.k;
  ...
  public String a(String paramString1, String paramString2, String paramString3)
  {
    try
    {
      ...
      paramString1 = badg.a(paramString1, this.app.getCurrentAccountUin(), "https://docs.qq.com/cgi-bin/online_docs/tool_decryptuin", "docs.qq.com", paramString2, null, false);
      if (TextUtils.isEmpty(paramString1)) {
        return null;
      }
      paramString1 = new JSONObject(paramString1);
  ...
  public JSONObject a()
  {
    ...
    //   1: astore_1
    //   2: aload_0
    //   3: getfield 191	badd:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   6: invokevirtual 192	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   9: ldc_w 865
    //   12: ldc 69
    //   14: invokestatic 311	badg:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   17: astore_3
    //   18: aload_3
    //   19: ifnull +148 -> 167
  ...
  public JSONObject a(String paramString)
  {
    ...
    //   95: astore_1
    //   96: aload_0
    //   97: getfield 191	badd:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   113: invokestatic 500	badg:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   116: astore 4
    //   118: aload 4
  ...
  public JSONObject a(JSONObject paramJSONObject)
  {
    ...
    //   84: aload_1
    //   85: aload_0
    //   86: getfield 191	badd:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   103: invokestatic 883	badg:a	(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   106: astore 4
    //   108: aload 4
    //   110: ifnull +143 -> 253
  ...
  public void a(DocsGrayTipsInfo paramDocsGrayTipsInfo, int paramInt, long paramLong)
  {
    ...
    try
    {
      if (!bdee.d(BaseApplicationImpl.getContext()))
      {
        ...
        for (paramDocsGrayTipsInfo = this.app.getApp().getString(2131694766);; paramDocsGrayTipsInfo = paramDocsGrayTipsInfo.l)
        {
  ...
  public void a(DocsGrayTipsInfo paramDocsGrayTipsInfo, long paramLong)
  {
    try
    {
      ...
      QLog.i("TeamWorkHandler" + baca.i, 2, "get user auth | uin = " + paramDocsGrayTipsInfo.jdField_a_of_type_JavaLangString + " docUrl = " + paramDocsGrayTipsInfo.jdField_b_of_type_JavaLangString);
      return;
    }
    catch (Exception paramDocsGrayTipsInfo)
    {
      QLog.e("TeamWorkHandler" + baca.i, 1, "get user auth exception = " + paramDocsGrayTipsInfo.toString());
    }
  }
  ...
  public void b(DocsGrayTipsInfo paramDocsGrayTipsInfo, int paramInt, long paramLong)
  {
    ...
    try
    {
      ...
      ((ToServiceMsg)localObject1).addAttribute("seq", Long.valueOf(paramLong));
      sendPbReq((ToServiceMsg)localObject1);
      QLog.i("TeamWorkHandler" + baca.i, 1, "set group auth | uin = " + paramDocsGrayTipsInfo.jdField_a_of_type_JavaLangString + " docUrl = " + paramDocsGrayTipsInfo.jdField_b_of_type_JavaLangString + " setploicy = " + paramDocsGrayTipsInfo.h + " setonly= " + paramDocsGrayTipsInfo.i + " setprivilege=" + paramDocsGrayTipsInfo.g + " bNeedtime = " + paramDocsGrayTipsInfo.r + " settime=" + paramInt);
      return;
    }
    catch (Exception paramDocsGrayTipsInfo)
    {
      QLog.e("TeamWorkHandler" + baca.i, 1, "set group auth exception = " + paramDocsGrayTipsInfo.toString());
    }
  }
  ...
  public void b(DocsGrayTipsInfo paramDocsGrayTipsInfo, long paramLong)
  {
    try
    {
      ...
      ((ToServiceMsg)localObject).addAttribute("seq", Long.valueOf(paramLong));
      sendPbReq((ToServiceMsg)localObject);
      QLog.i("TeamWorkHandler" + baca.i, 1, "get group auth | uin = " + paramDocsGrayTipsInfo.jdField_a_of_type_JavaLangString + " docUrl = " + paramDocsGrayTipsInfo.jdField_b_of_type_JavaLangString + ", msgSeq = " + paramLong);
      return;
    }
    catch (Exception paramDocsGrayTipsInfo)
    {
      QLog.e("TeamWorkHandler" + baca.i, 1, "get group auth exception = " + paramDocsGrayTipsInfo.toString());
    }
  }
