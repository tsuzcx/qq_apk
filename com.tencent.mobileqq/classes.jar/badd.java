  ...
  implements Manager
{
  ...
  public badd(QQAppInterface paramQQAppInterface)
  {
    ...
    List localList = this.jdField_a_of_type_Awgf.a(SubAccountInfo.class);
    Object localObject;
  ...
  private void c()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        ArrayList localArrayList = (ArrayList)this.jdField_a_of_type_Awgf.a(SubAccountMessage.class, SubAccountMessage.class.getSimpleName(), false, "subUin=?", new String[] { str }, null, null, "time desc", null);
            ...
            if ((paramString1.equals(localSubAccountMessage.subUin)) && (paramString2.equals(localSubAccountMessage.senderuin)))
            {
              ...
              if (localIterator.hasNext())
              {
                ...
                if (localSubAccountMessage != null) {
                  this.jdField_a_of_type_Awgf.b(localSubAccountMessage);
                }
                if (QLog.isColorLevel()) {
  ...
  SubAccountMessage a(String paramString)
  {
    ...
    localSubAccountMessage.sendername = alud.a(2131720450);
  ...
  public List<SubAccountMessage> a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        if ((this.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramString)))
        {
          ...
          if (localIterator.hasNext())
          {
            ...
            if (alof.aD.equals(((SubAccountMessage)localObject2).senderuin))
            {
              localObject1 = localObject2;
              break label304;
            }
      ...
      for (localObject1 = null;; localObject1 = "containsKey=" + this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramString))
      {
        ...
        label239:
        if ((localaors == null) || (localaors.jdField_a_of_type_Boolean) || (!this.jdField_a_of_type_Boolean)) {
          break;
        }
        localArrayList.add(0, a(paramString));
        break;
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Awgf.a(SubAccountMessage.class.getSimpleName());
  }
  
  public void a(bade parambade)
  {
    Object localObject2;
    if (QLog.isColorLevel())
    {
    ...
    {
      if ((parambade != null) && (parambade.jdField_b_of_type_JavaLangString != null) && (parambade.c())) {
        break label183;
      }
      if (QLog.isColorLevel())
      {
    ...
    label143:
    for (parambade = "data == null";; parambade = "data.mMainAccount=" + parambade.jdField_b_of_type_JavaLangString + " data.mSubUin=" + parambade.jdField_c_of_type_JavaLangString)
    {
      QLog.d("SUB_ACCOUNT", 2, parambade);
      return;
      localObject1 = "data.mMainAccount=" + parambade.jdField_b_of_type_JavaLangString + " data.mSubUin=" + parambade.jdField_c_of_type_JavaLangString;
      break;
    }
    label183:
    ArrayList localArrayList2 = parambade.a();
    Object localObject1 = parambade.c();
    ArrayList localArrayList3 = parambade.b();
    if (QLog.isColorLevel())
    {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          if ((!parambade.jdField_b_of_type_JavaLangString.equals(((SubAccountInfo)localObject1).trunkuin)) || (!str.equals(((SubAccountInfo)localObject1).subuin))) {
            continue;
          }
          ...
          ((SubAccountInfo)localObject2).trunkuin = parambade.jdField_b_of_type_JavaLangString;
          ((SubAccountInfo)localObject2).serverErrorType = parambade.jdField_b_of_type_Int;
          ((SubAccountInfo)localObject2).serverErrorMsg = parambade.jdField_a_of_type_JavaLangString;
      ...
      {
        parambade = localArrayList3.iterator();
        while (parambade.hasNext()) {
          a((String)parambade.next());
        }
      }
      label575:
      this.jdField_a_of_type_JavaUtilConcurrentLocksLock.unlock();
      ...
      parambade = localArrayList1.iterator();
      while (parambade.hasNext()) {
        a((SubAccountInfo)parambade.next());
      }
      break;
      label629:
      localObject1 = null;
          ...
          if (paramString2 != null)
          {
            ...
            if (bool)
            {
              ...
              if (localSubAccountMessage.istroop == 1)
              {
                ...
                bacu.a(paramQQAppInterface, paramString1, 6);
                paramQQAppInterface.a().d(paramString1, 7000, -i);
                paramQQAppInterface.a().a(new String[] { alof.x, paramString1 });
                paramQQAppInterface.D();
                paramString2 = new bade();
        ...
        if (localObject != null)
        {
          ...
          if (i4 != 0)
          {
            ...
            if ((((SubAccountMessage)localObject).mEmoRecentMsg == null) && (((SubAccountMessage)localObject).msg != null)) {
              ((SubAccountMessage)localObject).mEmoRecentMsg = new bamp(((SubAccountMessage)localObject).msg, 3, 16);
            }
      ...
      try
      {
        if (this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramSubAccountMessage.subUin))
        {
          ...
          if (((Iterator)localObject).hasNext())
          {
            ...
            if ((alof.aD.equals(paramSubAccountMessage.senderuin)) && (paramSubAccountMessage.time > localSubAccountMessage.time))
            {
              bool = true;
              continue;
            }
            if ((!alof.aD.equals(paramSubAccountMessage.senderuin)) || (paramSubAccountMessage.unreadNum != 0)) {
              continue;
            }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          if ((alof.aD.equals(paramSubAccountMessage.senderuin)) && (paramSubAccountMessage.time == 0L) && (paramSubAccountMessage.unreadNum == 0))
          {
        ...
        if (!alof.aD.equals(paramSubAccountMessage.senderuin)) {
          continue;
        }
      }
      finally
  ...
  public void b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      boolean bool = this.jdField_a_of_type_Awgf.a((String)localObject1, (ContentValues)localObject2, "subUin=?", new String[] { paramString });
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  public void c(String paramString)
  {
    ...
    while (paramString.hasNext())
    {
      ...
      {
        localbacz = bacu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localSubAccountInfo.subuin);
        ...
        if ((localbacz.jdField_a_of_type_Boolean) || (j == localbacz.jdField_a_of_type_Int)) {
          break label429;
        }
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().d(localSubAccountInfo.subuin, 7000, localbacz.jdField_a_of_type_Int - j);
      }
    }
    label338:
    abta localabta;
    ...
    for (;;)
    {
      if (QLog.isColorLevel())
      {
        QLog.d("SUB_ACCOUNT", 2, "updateAnotherSubAccountUnreadMsg" + " info.subuin=" + localSubAccountInfo.subuin + " anotherC2cUnread=" + j + " anotherTroopUnread=" + k + " item.showRedDot=" + localbacz.jdField_a_of_type_Boolean + " item.unReadCount=" + localbacz.jdField_a_of_type_Int);
        break label198;
        break;
        if ((localbacz.jdField_a_of_type_Boolean) && (localbacz.jdField_a_of_type_Int != k))
        {
          ...
          if (localObject2 != null)
          {
            ...
            if ((localObject2 != null) && (((ArrayList)localObject2).size() != 0))
            {
              ...
              if (((Iterator)localObject2).hasNext())
              {
                ...
                localSubAccountMessage.mTimeString = bdns.a(localSubAccountMessage.time * 1000L, true, paramString);
                if (i == 0) {
                  break label332;
                }
                i = 0;
  ...
  public void h(String paramString)
  {
    ...
    boolean bool = this.jdField_a_of_type_Awgf.a(str, localContentValues, null, null);
    if (QLog.isColorLevel()) {
