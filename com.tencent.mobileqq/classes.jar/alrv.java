...
public class alrv
  extends MqqHandler
{
  public alrv(FaceDownloader paramFaceDownloader, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    if (i < this.a.b.size())
    {
      paramMessage = (alry)this.a.b.get(i);
      if (paramMessage != null) {
        break label56;
      }
    }
    for (;;)
    {
      ...
      if ((paramMessage != null) && (paramMessage.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo != null) && (paramMessage.jdField_a_of_type_AndroidGraphicsBitmap != null) && (this.a.a.size() > 0))
      {
        ...
        {
          ((alrw)this.a.a.get(j)).a(true, paramMessage.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo, paramMessage.jdField_a_of_type_AndroidGraphicsBitmap);
          j += 1;
        }
      }
      this.a.b.remove(i);
