public final class gp
{
  ...
  {
    int j = paramgp.jdField_a_of_type_Int;
  ...
  {
    if (this.jdField_a_of_type_ArrayOfInt.length != paramgp.jdField_a_of_type_ArrayOfInt.length) {
    ...
    {
      int[] arrayOfInt = this.jdField_a_of_type_ArrayOfInt;
      arrayOfInt[i] ^= paramgp.jdField_a_of_type_ArrayOfInt[i];
      i += 1;
    }
  }
