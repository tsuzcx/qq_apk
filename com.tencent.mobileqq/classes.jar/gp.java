...
public class gp
{
  ...
  private static WifiConfiguration a(gr paramgr)
  {
    ...
    localWifiConfiguration.SSID = a(paramgr.b(), new int[0]);
    localWifiConfiguration.hiddenSSID = paramgr.a();
  ...
  private static boolean a(WifiManager paramWifiManager, gr paramgr)
  {
    WifiConfiguration localWifiConfiguration = a(paramgr);
    localWifiConfiguration.wepKeys[0] = a(paramgr.d(), new int[] { 10, 26, 58 });
  ...
  private static boolean b(WifiManager paramWifiManager, gr paramgr)
  {
    WifiConfiguration localWifiConfiguration = a(paramgr);
    localWifiConfiguration.preSharedKey = a(paramgr.d(), new int[] { 64 });
  ...
  private static boolean c(WifiManager paramWifiManager, gr paramgr)
  {
    paramgr = a(paramgr);
    paramgr.allowedKeyManagement.set(0);
    return a(paramWifiManager, paramgr);
  }
  ...
  public boolean a(gr paramgr)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        i += 1;
        continue;
        String str = paramgr.c();
        if ((TextUtils.isEmpty(str)) || (str.equals("nopass"))) {
          return c(this.jdField_a_of_type_AndroidNetWifiWifiManager, paramgr);
        }
        if (TextUtils.isEmpty(paramgr.d())) {
          break label84;
        }
        if ("WEP".equals(str)) {
          return a(this.jdField_a_of_type_AndroidNetWifiWifiManager, paramgr);
        }
        if (!"WPA".equals(str)) {
          break label84;
        }
        return b(this.jdField_a_of_type_AndroidNetWifiWifiManager, paramgr);
      }
