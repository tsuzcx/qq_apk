...
public abstract class aifb
  implements aiea, Handler.Callback, TextWatcher, View.OnClickListener, bhpn, bhpo, bhuy, Observer
{
  static int e;
  float jdField_a_of_type_Float;
  int jdField_a_of_type_Int;
  protected long a;
  abpd jdField_a_of_type_Abpd;
  aieb jdField_a_of_type_Aieb;
  aiee jdField_a_of_type_Aiee;
  private alox jdField_a_of_type_Alox = new aifg(this);
  public Context a;
  ...
  bdjb jdField_a_of_type_Bdjb = new aifd(this);
  ...
  public aifb(Context paramContext, SessionInfo paramSessionInfo, QQAppInterface paramQQAppInterface)
  {
  ...
  private void A()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130849200);
  ...
  private void B()
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130844373);
      localImageView = (ImageView)this.jdField_d_of_type_AndroidWidgetRelativeLayout.findViewById(2131368627);
      localImageView.setBackgroundResource(0);
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130849503));
      localImageView = (ImageView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131368042);
      Object localObject = localImageView.getLayoutParams();
      if ((localObject instanceof RelativeLayout.LayoutParams))
      {
        localObject = (RelativeLayout.LayoutParams)localObject;
        ((RelativeLayout.LayoutParams)localObject).width = aekt.a(35.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
        ((RelativeLayout.LayoutParams)localObject).height = aekt.a(35.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
        localImageView.setLayoutParams((ViewGroup.LayoutParams)localObject);
      }
      localImageView.setBackgroundResource(0);
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130849987));
      this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166898));
      this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166898));
    ...
    this.jdField_b_of_type_AndroidWidgetTextView.setAlpha(0.8F);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130844372);
    ImageView localImageView = (ImageView)this.jdField_d_of_type_AndroidWidgetRelativeLayout.findViewById(2131368627);
    localImageView.setBackgroundResource(0);
    if (azib.b()) {
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130844310));
    }
    for (;;)
    {
      localImageView = (ImageView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131368042);
      localImageView.setBackgroundResource(0);
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130849988));
      return;
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130849504));
    }
  }
  ...
  private void F()
  {
    ...
    List localList1 = this.jdField_a_of_type_Aieb.a();
  ...
  private void a(int paramInt)
  {
    ...
    if (this.jdField_c_of_type_AndroidWidgetTextView == null)
    {
      ...
      ((TextView)localObject1).setId(2131370810);
      ((TextView)localObject1).setBackgroundResource(2130838255);
  ...
  {
    return this.jdField_a_of_type_Aiee.a(paramInt);
  }
  ...
  public SpannableString a(boolean paramBoolean)
  {
    ...
    {
      bool1 = true;
      str1 = bdbt.a(localQQAppInterface, ((SessionInfo)localObject).jdField_a_of_type_Int, ((SessionInfo)localObject).jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText$SourceMsgInfo.mSourceMsgSenderUin + "");
    ...
    {
      localObject = bceh.a(localQQAppInterface, localContext, str2, str3, str1, bool1, localXEditTextEx, bool2, true);
  ...
  {
    if (paramView == null) {
      paramLayoutInflater = paramLayoutInflater.inflate(2131558795, paramViewGroup, false);
    }
    for (;;)
    {
      this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)paramLayoutInflater.findViewById(2131362208));
      this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131364137));
  ...
  protected void a(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Bdiz = new bdiz(((ViewGroup)((Activity)this.jdField_a_of_type_AndroidContentContext).getWindow().getDecorView().findViewById(16908290)).getChildAt(0), this.jdField_a_of_type_AndroidViewWindowManager.getDefaultDisplay().getHeight(), this.jdField_a_of_type_Bdjb);
    this.jdField_j_of_type_Int = this.jdField_a_of_type_Bdiz.a();
    this.jdField_j_of_type_Int = bdiz.a(this.jdField_j_of_type_Int);
    paramContext = new aife(this);
    ...
    if ((localAppRuntime instanceof QQAppInterface))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonMainPanel.setDispatchKeyEventListener(new aiff(this));
      return;
    }
  ...
  public void a(ChatMessage paramChatMessage, int paramInt, long paramLong, String paramString)
  {
    ...
    do
    {
      return;
      if (paramLong == 0L) {
        afus.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, Long.parseLong(paramChatMessage.senderuin));
      }
      paramString = agsd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage, paramInt, paramLong, paramString);
    ...
    paramString = bcek.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText$SourceMsgInfo, paramInt - k, this.jdField_a_of_type_ComTencentWidgetXEditTextEx.getPaint(), null);
    if (paramString != null)
    {
      ...
      this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setTag(2131373095, paramString);
      ...
      this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setMovementMethod(bcej.a());
  ...
  protected void a(List<ChatMessage> paramList1, List<ChatMessage> paramList2)
  {
    ...
    this.jdField_a_of_type_Aieb.a(paramList2, null, 0);
    ...
    if (paramBoolean)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getOverScrollHeaderView() == null)
      {
        if (this.jdField_a_of_type_AndroidViewView == null) {
          this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558861, null);
        }
  ...
  public boolean a()
  {
    ...
    this.jdField_a_of_type_Aiee = new aiee(this);
    this.jdField_a_of_type_Aiee.a(2);
    b();
    e();
    g();
    d();
    ...
    x();
    a();
    this.jdField_a_of_type_Abpd = new abpd();
    this.jdField_a_of_type_Abpd.a = new aemc(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    this.jdField_a_of_type_Abpd.jdField_h_of_type_Boolean = true;
    return true;
  }
  ...
  protected void b(List<ChatMessage> paramList1, List<ChatMessage> paramList2)
  {
    ...
    default: 
      if (localaifp != null) {
        this.jdField_g_of_type_Int = localaifp.a(paramList1, paramList2, this.jdField_g_of_type_Int);
      }
      break;
    }
    for (;;)
    {
      ...
      return;
      k = aifp.b(this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView, this.jdField_g_of_type_Int, paramList1, paramList2);
      if (k != 0)
      {
      ...
      if (localaifp != null)
      {
        ...
        if (localaifp != null)
        {
          this.jdField_g_of_type_Int = localaifp.a(this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView, this.jdField_g_of_type_Int, paramList1, paramList2);
          continue;
          if (localaifp != null)
          {
            localaifp.a(this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView, 0, paramList1, paramList2);
            k = paramList1.size();
  ...
  public void beforeTextChanged(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3)
  {
    if (paramInt3 == 0)
    {
      paramCharSequence = (bceh[])this.jdField_a_of_type_ComTencentWidgetXEditTextEx.getEditableText().getSpans(paramInt1, paramInt1 + paramInt2, bceh.class);
  ...
  protected void d()
  {
    ...
    {
      if (("1103".equals(ThemeUtil.curThemeId)) || ("2920".equals(ThemeUtil.curThemeId))) {
        this.jdField_a_of_type_AndroidViewViewGroup.setBackgroundResource(2130849400);
      }
    }
    else {
      return;
    }
    this.jdField_a_of_type_AndroidViewViewGroup.setBackgroundResource(2130849596);
  }
  ...
  protected void e()
  {
    this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView = ((ChatXListView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131369509));
    ...
    this.jdField_a_of_type_Aieb.a(this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView);
    Object localObject = this.jdField_a_of_type_Aieb;
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_f_of_type_Int == 3) {}
    for (boolean bool = true;; bool = false)
    {
      ((aieb)localObject).a(bool);
  ...
  protected void g()
  {
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131375812));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131377884));
    this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_c_of_type_JavaLangString);
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131368613));
    this.jdField_b_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this);
    this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
    this.jdField_d_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131375822));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131377968));
    this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
    ImageView localImageView1 = (ImageView)this.jdField_d_of_type_AndroidWidgetRelativeLayout.findViewById(2131368627);
    localImageView1.setOnClickListener(this);
    if ((this.jdField_e_of_type_Boolean) && (!this.jdField_d_of_type_Boolean))
    {
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_d_of_type_AndroidWidgetRelativeLayout.findViewById(2131368622));
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_f_of_type_Int == 2) || (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_f_of_type_Int == 5))
    {
      ImageView localImageView2 = (ImageView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131368042);
      Object localObject = localImageView2.getLayoutParams();
      if ((localObject instanceof RelativeLayout.LayoutParams))
      {
        localObject = (RelativeLayout.LayoutParams)localObject;
        ((RelativeLayout.LayoutParams)localObject).width = aekt.a(13.5F, this.jdField_a_of_type_AndroidContentContext.getResources());
        ((RelativeLayout.LayoutParams)localObject).height = aekt.a(13.5F, this.jdField_a_of_type_AndroidContentContext.getResources());
        localImageView2.setLayoutParams((ViewGroup.LayoutParams)localObject);
      }
      localImageView2.setImageResource(2130849468);
      this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
      localImageView1.setImageResource(2130849591);
      if (Build.VERSION.SDK_INT >= 16) {
  ...
  protected void h()
  {
    this.jdField_b_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131368333));
    ...
    i();
    this.jdField_a_of_type_ComTencentWidgetXEditTextEx = ((XEditTextEx)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131368332));
    ...
    try
    {
      ...
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131366996));
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
      Object localObject = (PanelIconLinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131371555);
      ((PanelIconLinearLayout)localObject).setPanelIconListener(new aifc(this));
      if (this.jdField_d_of_type_Boolean)
      {
        ((PanelIconLinearLayout)localObject).setCustomHeight(aekt.a(50.0F, ((PanelIconLinearLayout)localObject).getContext().getResources()));
        ...
        {
          localObject = this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131368341);
          if (localObject != null) {
            ((View)localObject).setBackgroundResource(2130849207);
          }
          this.jdField_b_of_type_AndroidViewViewGroup.setBackgroundResource(2130849207);
          this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setBackgroundResource(2130849208);
          this.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130838154);
          this.jdField_a_of_type_AndroidWidgetButton.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166887));
        }
        localObject = new aifh(this, null);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      a(paramMessage.arg1);
      continue;
      afyl.a(paramMessage, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView);
      continue;
      boolean bool = bdkd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView);
      if (QLog.isColorLevel()) {
        QLog.d(this.jdField_a_of_type_JavaLangString, 2, "MSG_EFRESH_FONT_BUBBLE, needRefresh=" + bool);
      }
      if (bool) {
        this.jdField_a_of_type_Aieb.notifyDataSetChanged();
      }
    }
  }
  ...
  public void k()
  {
    ...
    this.jdField_a_of_type_Aiee.a(4);
  ...
  public void l()
  {
    if (this.jdField_d_of_type_Boolean)
    {
      ...
      if ((localabol != null) && (localabol.a(this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Int) > 0))
      {
        if (QLog.isColorLevel()) {
  ...
  public void m()
  {
    ...
    this.jdField_a_of_type_Aiee.a(8);
  ...
  public void n()
  {
    this.jdField_a_of_type_Aiee.a(3);
  }
  ...
  public void o()
  {
    ...
    this.jdField_a_of_type_Aiee.a(9);
  }
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131368627: 
      ...
      Intent localIntent = aekt.a(new Intent(paramView.getContext(), SplashActivity.class), new int[] { 0, 2 });
      ...
      if ((BaseApplicationImpl.getApplication().getRuntime() instanceof QQAppInterface)) {
        ((aieo)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(147)).a();
      }
      aieq.a().d();
    ...
    case 2131366996: 
      ...
      azmj.b(null, "dc00898", "", "", "0X800A194", "0X800A194", k, 1, "", "", "", "");
      return;
    case 2131368332: 
      if (QLog.isColorLevel()) {
    ...
    case 2131362283: 
      ...
      paramView.setImageResource(2130839716);
      s();
      return;
    case 2131370810: 
      this.jdField_g_of_type_Int = this.jdField_a_of_type_Aieb.getCount();
  ...
  {
    paramAbsListView = (aifp)a(1);
    if (paramAbsListView != null) {
      paramAbsListView.a(paramInt1, paramInt2, paramInt3);
    }
    this.jdField_a_of_type_Aiee.a(17);
  }
  ...
  public void p()
  {
    ...
    this.jdField_a_of_type_Aiee.a(11);
  ...
  {
    this.jdField_a_of_type_ComTencentWidgetXPanelContainer.a();
    this.jdField_a_of_type_Aiee.a(10);
  ...
  protected void u()
  {
    ...
    if ((localList != null) && (localList.size() > 0))
    {
      ...
      this.jdField_a_of_type_Aieb.a(localList, null, 0);
    }
  }
    ...
    do
    {
      do
      {
        do
        {
          ...
          return;
          if (!(paramObject instanceof abpd)) {
            break;
          }
          paramObservable = (abpd)paramObject;
          paramObject = (aemc)paramObservable.a;
  ...
  protected void v()
  {
    if ((this.jdField_a_of_type_Aieb != null) && (this.jdField_a_of_type_Aieb.getCount() > 0))
    {
      this.jdField_a_of_type_Long = SystemClock.uptimeMillis();
      ((aemc)this.jdField_a_of_type_Abpd.a).a(this.jdField_a_of_type_Long);
      this.jdField_a_of_type_Abpd.jdField_e_of_type_Boolean = false;
  ...
  protected void w()
  {
    ...
    aekt.a(this.jdField_a_of_type_AndroidWidgetImageButton, (int)(this.jdField_a_of_type_Float * 5.0F + 0.5F), (int)(this.jdField_a_of_type_Float * 5.0F + 0.5F), 0, 0);
    if (this.jdField_d_of_type_Boolean) {
  ...
  public void x()
  {
    ...
    if ((k != 1033) && (k != 1034))
    {
      ...
      azlq.a(1, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, k);
    }
  ...
  public void z()
  {
    ...
    if (localChatMessage != null) {
      a(localChatMessage, 0, afus.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, Long.parseLong(localChatMessage.senderuin)), null);
    }
  }
}
