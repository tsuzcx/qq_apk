...
public class aley
{
  private static aley jdField_a_of_type_Aley;
  private static aley jdField_b_of_type_Aley;
  ...
  public static aley a(int paramInt)
  {
    if (paramInt == 0)
    {
      if (jdField_a_of_type_Aley == null) {
        jdField_a_of_type_Aley = new aley(0);
      }
      return jdField_a_of_type_Aley;
    }
    if (jdField_b_of_type_Aley == null) {
      jdField_b_of_type_Aley = new aley(1);
    }
    return jdField_b_of_type_Aley;
  }
