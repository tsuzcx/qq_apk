...
public class andq
{
  public static SSLContext a()
  {
    ...
    catch (Throwable localThrowable1)
    {
      try
      {
        localSSLContext.init(null, new TrustManager[] { new andt() }, null);
  ...
  /* Error */
  public static void a(String paramString1, String paramString2, String paramString3, String paramString4, String[] paramArrayOfString, andn paramandn)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 12
    ...
    //   37: instanceof 78
    //   40: ifeq +29 -> 69
    //   43: invokestatic 80	andq:a	()Ljavax/net/ssl/SSLContext;
    //   46: astore 12
    //   48: aload 12
    //   50: ifnull +19 -> 69
    //   53: aload 12
    ...
    //   168: iconst_m1
    //   169: aconst_null
    //   170: invokevirtual 114	andn:a	(I[B)V
    //   173: aload_3
    //   174: ifnull +7 -> 181
    //   177: aload_3
    ...
    //   302: invokevirtual 114	andn:a	(I[B)V
    //   305: aload_0
    //   306: ifnull +7 -> 313
    //   309: aload_0
  ...
  /* Error */
  public static void a(String paramString1, String paramString2, byte[] paramArrayOfByte, String[] paramArrayOfString, andn paramandn)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 11
    ...
    //   36: instanceof 78
    //   39: ifeq +24 -> 63
    //   42: invokestatic 80	andq:a	()Ljavax/net/ssl/SSLContext;
    //   45: astore_0
    //   46: aload_0
    //   47: ifnull +16 -> 63
    //   50: aload_0
    ...
    //   136: iconst_m1
    //   137: aconst_null
    //   138: invokevirtual 114	andn:a	(I[B)V
    //   141: aload_3
    //   142: ifnull +7 -> 149
    //   145: aload_3
    ...
    //   267: invokevirtual 114	andn:a	(I[B)V
    //   270: aload_1
    //   271: ifnull +7 -> 278
    //   274: aload_1
  ...
  /* Error */
  public static void a(String paramString1, String paramString2, String[] paramArrayOfString, andn paramandn)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 7
    ...
    //   28: instanceof 78
    //   31: ifeq +29 -> 60
    //   34: invokestatic 80	andq:a	()Ljavax/net/ssl/SSLContext;
    //   37: astore 6
    //   39: aload 6
    //   41: ifnull +19 -> 60
    //   44: aload 6
    ...
    //   137: iconst_m1
    //   138: aconst_null
    //   139: invokevirtual 114	andn:a	(I[B)V
    //   142: aload_2
    //   143: ifnull +7 -> 150
    //   146: aload_2
    ...
    //   255: invokevirtual 114	andn:a	(I[B)V
    //   258: aload_0
    //   259: ifnull +7 -> 266
    //   262: aload_0
  ...
  public static void a(@NonNull String paramString1, @NonNull String paramString2, @Nullable String[] paramArrayOfString, @Nullable byte[] paramArrayOfByte, @NonNull andp paramandp, @Nullable ando paramando1, @Nullable ando paramando2)
  {
    if (paramandp == null) {
      return;
    }
    ...
    for (paramString2 = paramString1.substring(i + "http://stubcmshow.qq.com/cm3d/".length());; paramString2 = paramString1)
    {
      ...
      paramString1 = ancb.g + j + File.separator + paramString1;
      ...
      if (paramString2.exists())
      {
        ...
        if (a(paramString1))
        {
          ...
          paramandp.a(0, paramArrayOfString, paramString1);
          if (QLog.isColorLevel()) {
        ...
        while (QLog.isColorLevel())
        {
          ...
          return;
          paramandp.a(0, paramArrayOfString, ApolloRender.readStream(new FileInputStream(paramString2)));
        }
        break;
      }
      QLog.d("ApolloHttpUtil", 1, "fakeResource3DUrlRequest start download id:" + j);
      amxb.b(ampj.a(), null, new andr(paramString1, paramArrayOfString, paramandp), j, null, -1, -1, false);
      return;
      label474:
      if (paramString2.startsWith("Dress:"))
      {
        ...
        paramString1 = ancb.f + j + File.separator + paramString1;
        paramString2 = new File(paramString1);
        if (paramString2.exists())
        {
          if (QLog.isColorLevel()) {
          ...
          paramArrayOfString = b(paramArrayOfString);
          if (a(paramString1)) {
            paramandp.a(0, paramArrayOfString, b(paramString2, paramArrayOfString));
          }
          while (QLog.isColorLevel())
          {
            QLog.d("ApolloHttpUtil", 2, new Object[] { "fakeResource3DUrlRequest retHeader:", paramArrayOfString });
        ...
        QLog.d("ApolloHttpUtil", 1, "fakeResource3DUrlRequest start download id:" + j);
        amxb.b(ampj.a(), null, new ands(paramString1, paramArrayOfString, paramandp, j), -1, new int[] { j }, -1, -1, true);
        return;
      }
      if (!paramString2.startsWith("def/role/0/3D/")) {
        break;
      }
      paramString1 = ancb.c + File.separator + paramString2;
      paramString2 = new File(paramString1);
      if (paramString2.exists())
      {
        if (QLog.isColorLevel()) {
  ...
  /* Error */
  public static void a(String paramString, String[] paramArrayOfString, andn paramandn)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 7
    ...
    //   51: instanceof 78
    //   54: ifeq +38 -> 92
    //   57: invokestatic 80	andq:a	()Ljavax/net/ssl/SSLContext;
    //   60: astore 5
    //   62: aload 5
    //   64: ifnull +71 -> 135
    //   67: aload 5
    ...
    //   165: iconst_m1
    //   166: aconst_null
    //   167: invokevirtual 114	andn:a	(I[B)V
    //   170: aload_1
    //   171: ifnull +7 -> 178
    //   174: aload_1
    ...
    //   383: invokevirtual 114	andn:a	(I[B)V
    //   386: aload_0
    //   387: ifnull +7 -> 394
    //   390: aload_0
  ...
  private static byte[] a(@NonNull HttpURLConnection paramHttpURLConnection, @Nullable ando paramando)
  {
    localObject3 = null;
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          {
            localObject2 = paramHttpURLConnection;
            paramando.a(((ByteArrayOutputStream)localObject3).size(), i);
          }
        }
        try
        {
          ...
          localObject2 = paramHttpURLConnection;
          paramando = ((ByteArrayOutputStream)localObject3).toByteArray();
          localObject2 = paramando;
          paramando = (ando)localObject2;
          if (paramHttpURLConnection == null) {
            continue;
          }
          try
        ...
        catch (IOException paramando)
        {
          for (;;)
          {
            paramando.printStackTrace();
          }
        }
      }
    }
  ...
  /* Error */
  public static void b(@NonNull String paramString1, @NonNull String paramString2, @Nullable String[] paramArrayOfString, @Nullable byte[] paramArrayOfByte, @NonNull andp paramandp, @Nullable ando paramando1, @Nullable ando paramando2)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 11
    ...
    //   80: aload 14
    //   82: astore 11
    //   84: invokestatic 80	andq:a	()Ljavax/net/ssl/SSLContext;
    //   87: astore 15
    //   89: aload 15
    //   91: ifnull +160 -> 251
    //   94: aload 13
    ...
    //   772: aload_0
    //   773: aload 6
    //   775: invokestatic 469	andq:a	(Ljava/net/HttpURLConnection;Lando;)[B
    //   778: astore_2
    //   779: aload 17
    //   781: ldc_w 471
    ...
    //   0	1017	4	paramandp	andp
    //   0	1017	5	paramando1	ando
    //   0	1017	6	paramando2	ando
    //   219	778	7	i	int
    //   19	927	8	j	int
    //   588	51	9	k	int
    //   559	73	10	m	int
