...
public class pvp
  extends ahyw
  implements View.OnClickListener, View.OnLongClickListener, aroi, pvb<ObservableArrayList<ResultRecord>>
{
  private static final pvv jdField_a_of_type_Pvv = new pvv(null);
  private final int jdField_a_of_type_Int;
  protected final Context a;
  private final SparseArray<List<atmo>> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
  ...
  private final View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new pvq(this);
  private ExpandableListView jdField_b_of_type_ComTencentWidgetExpandableListView;
  private final boolean jdField_b_of_type_Boolean;
  private final View.OnClickListener c = new pvs(this);
  
  public pvp(Context paramContext, QQAppInterface paramQQAppInterface, ExpandableListView paramExpandableListView, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Int = ((int)bacc.a(this.jdField_a_of_type_AndroidContentContext, 12.0F));
    this.jdField_b_of_type_Int = ((int)bacc.a(this.jdField_a_of_type_AndroidContentContext, 9.0F));
  ...
  private void a(List<pvt> paramList)
  {
    try
    {
      Collections.sort(paramList, jdField_a_of_type_Pvv);
      return;
    }
  ...
  private View c(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      if (PublicAccountInfo.isLooker(localPublicAccountInfo))
      {
        ...
        return paramView;
        paramViewGroup = (pvw)paramView.getTag();
        paramViewGroup.d.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
      }
      else
      {
      ...
      if (localObject3 != null)
      {
        ...
        while (((Iterator)localObject3).hasNext())
        {
          ...
          if (localObject4 != null) {
            try
            {
              if ((((RecentUser)localObject4).getType() == 0) && (Long.parseLong(((RecentUser)localObject4).uin) >= 10000L) && (!((RecentUser)localObject4).uin.equals(localObject2)) && (!azzz.b(((RecentUser)localObject4).uin)))
              {
    ...
    for (;;)
    {
      ...
      if (((Iterator)localObject3).hasNext())
      {
        ...
        for (localObject2 = new ArrayList();; localObject2 = new ArrayList((Collection)localObject2))
        {
          ...
          while (((Iterator)localObject5).hasNext()) {
            ((ArrayList)localObject4).add(new pvt((Friends)((Iterator)localObject5).next(), -1));
          }
        ...
        while (((Iterator)localObject4).hasNext()) {
          ((List)localObject2).add(((pvt)((Iterator)localObject4).next()).a);
        }
      ...
      for (;;)
      {
        ...
        while (i < ((List)localObject2).size())
        {
          ...
          if ((!((Friends)localObject5).uin.equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())) && (!azzz.b(((Friends)localObject5).uin)) && (!bcpn.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((Friends)localObject5).uin))) {
  ...
  protected View a(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      if ((AppSetting.c) && (paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
      {
        ...
        paramView.setContentDescription((String)localObject + ajjy.a(2131647938));
      }
      return paramView;
      paramViewGroup = (pvx)paramView.getTag();
      paramViewGroup.d.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
    ...
    label355:
    paramView.setContentDescription((String)localObject + ajjy.a(2131647943));
    return paramView;
  }
  ...
  {
    pvu localpvu = (pvu)paramView.getTag();
    if (localpvu == null)
    {
      localpvu = new pvu();
      paramView.findViewById(2131302936).setVisibility(0);
      localpvu.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131301599));
      paramView.setTag(localpvu);
    }
    for (;;)
    {
      Groups localGroups = (Groups)getGroup(paramInt);
      localpvu.jdField_a_of_type_AndroidWidgetTextView.setText(localGroups.group_name);
  ...
  public View getGroupView(int paramInt, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView != null)
    {
      localObject = (pvu)paramView.getTag();
      ...
      if (AppSetting.c)
      {
        ...
        paramViewGroup.setContentDescription(((Groups)localObject).group_name + ajjy.a(2131647970));
      }
    }
    for (;;)
    {
      ...
      break;
      label153:
      paramViewGroup.setContentDescription(((Groups)localObject).group_name + ajjy.a(2131647932));
    }
  }
  ...
  {
    paramView = (pvu)paramView.getTag();
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    baay.a(paramView, localbakh, this.c, new pvr(this));
    return true;
  }
