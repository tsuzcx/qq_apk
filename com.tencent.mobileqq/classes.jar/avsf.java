  ...
  implements Manager
{
  ...
  public avsf(QQAppInterface paramQQAppInterface)
  {
  ...
  private MessageForMixedMsg a(List<MessageRecord> paramList, ArrayList<MessageForText.AtTroopMemberInfo> paramArrayList, MessageForReplyText.SourceMsgInfo paramSourceMsgInfo, int paramInt, boolean paramBoolean)
  {
    ...
    MessageForMixedMsg localMessageForMixedMsg = (MessageForMixedMsg)bbli.a(-1035);
    ...
    if (localMessageForMixedMsg.istroop == 1) {
      nmy.a().b(localMessageForMixedMsg);
    }
    ...
    bevq.a(paramInt, paramSourceMsgInfo.toString(), localMessageForMixedMsg);
  ...
  public static MessageForPic a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    {
      paramString2 = bbli.a(paramQQAppInterface, paramString3, paramString2, paramInt);
      ...
      if (ayfc.a(paramString1))
      {
        paramString1 = new PicMessageExtraData();
        paramString1.textSummary = paramQQAppInterface.getApp().getString(2131691165);
  ...
  private void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, MessageForMixedMsg paramMessageForMixedMsg, boolean paramBoolean)
  {
    ...
    if (j < m)
    {
      ...
      {
        localObject = bblf.a((MessageForText)localObject);
        if (localObject != null) {}
      }
    }
    for (;;)
    {
      ...
      {
        localObject = bblf.a((MessageForReplyText)localObject);
        if (localObject != null)
        {
          k = 0;
          while (k < ((im_msg_body.RichText)localObject).elems.size())
  ...
  private void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, ArrayList<aydn> paramArrayList, MessageForMixedMsg paramMessageForMixedMsg)
  {
    ayds localayds = aydj.a(8, 7);
    localayds.a(paramArrayList);
    localayds.a(new avsg(this, paramMessageForMixedMsg, paramQQAppInterface, paramString, paramInt));
  ...
  private void a(MessageForMixedMsg paramMessageForMixedMsg, ArrayList<MessageForText.AtTroopMemberInfo> paramArrayList, String paramString, Map<String, Boolean> paramMap)
  {
    ...
    ((bahm)localObject).a(paramString, paramMessageForMixedMsg.uniseq);
    ((bahm)localObject).a(paramMessageForMixedMsg, null);
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((paramString instanceof MessageForPic))
      {
        ...
        if (FileUtil.isFileExists(localMessageForPic.path))
        {
          ...
          if (localObject == null)
          {
            localHashMap.put(localMessageForPic, new avsj(this, paramMessageForMixedMsg, localMap, localMessageForPic.path, paramArrayList));
    ...
    if (paramMessageForMixedMsg.hasNext())
    {
      ...
      paramString = (avsj)paramArrayList.getValue();
      if (paramMap == null) {
        break label346;
      }
  ...
  private void a(MessageForMixedMsg paramMessageForMixedMsg, boolean paramBoolean, String paramString)
  {
    ...
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(Long.valueOf(paramMessageForMixedMsg.mForwardFromUniSeq));
    bahm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageForMixedMsg.frienduin, paramMessageForMixedMsg.uniseq);
  ...
  public void a(SessionInfo paramSessionInfo, long paramLong, int paramInt)
  {
    ...
    if (localObject != null) {
      if (((ChatMessage)localObject).msgtype == -1036)
      {
        ...
        azyi.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForMixedMsg)localObject, paramSessionInfo, paramInt);
      }
    }
    ...
    do
    {
      ...
      do
      {
        ...
        if ((TextUtils.isEmpty(paramMixedMsgInfo.b())) && (localObject1 != null) && (((List)localObject1).size() == 1))
        {
          ...
          agwt.a(paramQQAppInterface, paramBaseChatPie, paramBaseChatPie.mInputBar, paramBaseChatPie.panelicons, false, null).a(paramBaseChatPie, (List)localObject1, false);
          return;
        }
        int i;
        ...
        if (localObject1 == null)
        {
          ...
          if (paramArrayList != null)
          {
            ...
            {
              localObject2 = (bfdm)paramQQAppInterface.getManager(203);
              ...
              } while (!((bfdm)localObject2).a(((MessageForText.AtTroopMemberInfo)((Iterator)localObject3).next()).uin));
              bool1 = true;
            }
          }
          ...
          if ((localObject3 instanceof MixedMsgInfo.TextMsgNode))
          {
            ...
            if (!TextUtils.isEmpty((CharSequence)localObject4))
            {
              ...
              localObject5 = bbli.a(paramQQAppInterface, (String)localObject1, m, localSourceMsgInfo, (String)localObject4);
        ...
        for (;;)
        {
          ...
          break;
          localObject5 = bbli.a(paramQQAppInterface, paramQQAppInterface.getCurrentAccountUin(), (String)localObject1, (String)localObject1, m, (byte)1, (byte)0, (short)0, (String)localObject4);
  ...
  protected void a(QQAppInterface paramQQAppInterface, MessageForPic paramMessageForPic, boolean paramBoolean, ayeo paramayeo)
  {
    TransferRequest localTransferRequest = new TransferRequest();
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt, ArrayList<String> paramArrayList, boolean paramBoolean, String paramString2, ArrayList<MessageForText.AtTroopMemberInfo> paramArrayList1, MessageForReplyText.SourceMsgInfo paramSourceMsgInfo)
  {
    ...
    {
      paramString2 = bbli.a(paramQQAppInterface, paramString1, paramInt, paramSourceMsgInfo, paramString2);
      ...
      while (paramArrayList.hasNext())
      {
        ...
        if (FileUtil.isFileExists(paramString2))
        {
          ...
          if (paramString2 != null)
          {
            ...
            paramString2 = bbli.a(paramQQAppInterface, paramQQAppInterface.getCurrentAccountUin(), paramString1, paramString1, paramInt, (byte)1, (byte)0, (short)0, paramString2);
            paramString2.atInfoList = paramArrayList1;
            if ((paramString2.atInfoList == null) || (paramString2.atInfoList.isEmpty())) {
              break label411;
            }
            bfdm localbfdm = (bfdm)paramQQAppInterface.getManager(203);
  ...
  public void a(String paramString, int paramInt, MessageForMixedMsg paramMessageForMixedMsg, QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        paramString = new avsh(this, paramQQAppInterface, paramMessageForMixedMsg, paramString, paramInt);
        paramBoolean = a(paramQQAppInterface, arrayOfByte, paramQQAppInterface.getCurrentAccountUin(), paramMessageForMixedMsg.frienduin, paramMessageForMixedMsg.frienduin, paramMessageForMixedMsg.istroop, paramMessageForMixedMsg.uniseq, 1035, new avsi(this, paramQQAppInterface, paramMessageForMixedMsg, paramString));
        if (!paramBoolean) {
          break;
        }
      } while (!QLog.isColorLevel());
