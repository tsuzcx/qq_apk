...
public class avsf
{
  ...
  private avsh jdField_a_of_type_Avsh;
  private avsl jdField_a_of_type_Avsl;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ahvy.jdField_a_of_type_JavaLangString + "/capture_qsvf" + File.separator;
    jdField_b_of_type_JavaLangString = jdField_a_of_type_JavaLangString + "capture_res" + File.separator;
    f = ahvy.jdField_a_of_type_JavaLangString + "/qav" + File.separator + "beauty" + File.separator;
  ...
  public static int a(Context paramContext)
  {
    ...
    if ((j > 0) && (!new File(jdField_a_of_type_JavaLangString + "filter_config.xml").exists())) {
      lcg.c("CaptureVideoFilterManager", "getQQShortVideoFilterConfigVersion config file don't exist!");
    }
    for (;;)
    {
      lcg.c("CaptureVideoFilterManager", "getQQShortVideoFilterConfigVersion:" + i);
      return i;
      i = j;
    }
  }
  ...
  private static avsm a(String paramString)
  {
    if (TextUtils.isEmpty(paramString))
    {
      lcg.c("CaptureVideoFilterManager", "parseConfig|content is empty.");
      return null;
    }
    for (;;)
    {
      ...
      try
      {
        ...
        localavsm = new avsm(i, str1, str2);
        try
        {
          lcg.c("CaptureVideoFilterManager", "parseConfig:" + i + "|" + str1 + "|" + str2);
          return localavsm;
        }
      ...
      try
      {
        ...
        lcg.c("CaptureVideoFilterManager", "parseConfig failed. info = " + localJSONObject);
        return localavsm;
      }
      catch (JSONException localJSONException2)
      {
        localJSONException2.printStackTrace();
        lcg.c("CaptureVideoFilterManager", "parseConfig|parse failed.context = " + paramString);
        return localavsm;
      }
    }
  }
  ...
  public static void a(Context paramContext)
  {
    try
    {
      ...
      if ((paramContext != null) && (!TextUtils.isEmpty(paramContext.jdField_a_of_type_JavaLangString)))
      {
        ...
        lcg.c("CaptureVideoFilterManager", "preDownloadResource :" + ((File)localObject).exists());
        if (!((File)localObject).exists())
        {
          localObject = new ayrx();
          ((ayrx)localObject).jdField_a_of_type_Aysc = new avsj();
          ((ayrx)localObject).jdField_a_of_type_JavaLangString = paramContext.jdField_a_of_type_JavaLangString;
          ((ayrx)localObject).jdField_a_of_type_Int = 0;
          ((ayrx)localObject).jdField_c_of_type_JavaLangString = (f + "skin_color.zip");
          ((ayrx)localObject).a(paramContext);
          lch.a().a((aysy)localObject);
        }
      }
      return;
    }
  ...
  static void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      if ((paramString2 != null) && (!paramString2.equals("")))
      {
        ...
        lcg.c("CaptureVideoFilterManager", "compareContent newList.size=0");
        bbdx.a(jdField_b_of_type_JavaLangString);
      }
      for (;;)
      {
        long l2 = System.currentTimeMillis();
        lcg.c("CaptureVideoFilterManager", "compareContent :" + (l2 - l1));
        return;
        ...
        if (paramString1 != null)
        {
          ...
          while (paramString1.hasNext())
          {
            ...
            while (localIterator.hasNext())
            {
              ...
              {
                lcg.c("CaptureVideoFilterManager", "compareContent res:" + localFilterDesc.name + "|" + localFilterDesc.resMD5 + "|" + paramString2.resMD5);
                if ((localFilterDesc.resMD5 != null) && (!localFilterDesc.resMD5.equals(paramString2.resMD5))) {
                  bbdx.a(paramString2.getResFold(jdField_b_of_type_JavaLangString));
                }
                lcg.c("CaptureVideoFilterManager", "compareContent iconMD5:" + localFilterDesc.name + "|" + localFilterDesc.iconMD5 + "|" + paramString2.iconMD5);
                if ((localFilterDesc.iconMD5 != null) && (!localFilterDesc.iconMD5.equals(paramString2.iconMD5))) {
                  bbdx.d(paramString2.getIconFile(jdField_b_of_type_JavaLangString));
                }
              }
            }
          }
  ...
  public static boolean a(int paramInt1, long paramLong1, long paramLong2, int paramInt2)
  {
    ...
    if (i < paramInt2)
    {
      lcg.c("CaptureVideoFilterManager", "isSupportOfDevice error OSversion: " + i);
      return false;
    }
    paramInt2 = llw.e();
    if (paramInt2 < paramInt1)
    {
      lcg.c("CaptureVideoFilterManager", "isSupportOfDevice error cpucount: " + paramInt2);
      return false;
    }
    long l = llw.c();
    if (l < paramLong1)
    {
      lcg.c("CaptureVideoFilterManager", "isSupportOfDevice error cpuFrequency: " + l);
      return false;
    }
    paramLong1 = bbdh.d();
    if (paramLong1 < paramLong2)
    {
      lcg.c("CaptureVideoFilterManager", "isSupportOfDevice error memory: " + paramLong1);
      return false;
    }
    return true;
  }
  ...
  public static String b(Context paramContext)
  {
    try
    {
      ...
      lcg.c("CaptureVideoFilterManager", "getVideoEffectBeautyConfig:" + f + "beauty_config.json" + "|" + localFile.exists());
      if (localFile.exists()) {
        return bbdx.b(localFile);
      }
      b(paramContext, 0);
  ...
  {
    lcg.c("CaptureVideoFilterManager", "setVideoEffectBeautyConfigVersion:" + paramInt);
  ...
  private static boolean b(Context paramContext)
  {
    ...
    lcg.c("CaptureVideoFilterManager", "getIsFirstLauncher:" + i);
    if (i == 0) {
      bool = true;
    }
    return bool;
  ...
  private boolean b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Avsh != null) {
        this.jdField_a_of_type_Avsh.a();
      }
      return true;
      label335:
      i += 1;
  ...
  public void a()
  {
    this.jdField_a_of_type_Avsh = null;
  }
  ...
  public void a(Context paramContext, String paramString, int paramInt)
  {
    if (paramString == null)
    {
      lcg.c("CaptureVideoFilterManager", "updateQQShortVideoFilterConfig error ");
      return;
    }
    ...
    bbdx.a(jdField_a_of_type_JavaLangString, "filter_config.xml", paramString);
    a(paramContext, paramInt);
    c();
    a(paramString);
    lcg.c("CaptureVideoFilterManager", "updateQQShortVideoFilterConfig sendBroadcast");
    paramContext.sendBroadcast(new Intent("action_brocassreceiver_for_filter"));
  }
  
  public void a(avsh paramavsh)
  {
    this.jdField_a_of_type_Avsh = paramavsh;
  }
  
  public void a(avsl paramavsl)
  {
    ...
    {
      return;
      this.jdField_a_of_type_Avsl = paramavsl;
      ...
      paramavsl = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
      while (paramavsl.hasNext())
      {
        Object localObject1 = (FilterCategory)paramavsl.next();
              ...
              if (localFilterDesc.predownload == 1)
              {
                ...
                if (!TextUtils.isEmpty(localFilterDesc.iconurl))
                {
                  ...
                  if (!((File)localObject3).exists())
                  {
                    ...
                    ((ayrx)localObject3).jdField_a_of_type_Aysc = new avsk(this);
                ...
                if ((!TextUtils.isEmpty(localFilterDesc.resurl)) && (!TextUtils.isEmpty((CharSequence)localObject2)))
                {
                  ...
                  if (!((File)localObject3).exists())
                  {
                    ...
                    ((ayrx)localObject2).jdField_a_of_type_Aysc = new avsi(this);
    ...
    } while ((this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 0) || (this.jdField_a_of_type_Avsl == null));
    this.jdField_a_of_type_Avsl.a(false);
  }
  ...
  public void b(Context paramContext)
  {
    if (new File(f + "beauty_config.json").exists())
    {
      ...
      {
        lcg.c("CaptureVideoFilterManager", "!JasonFile.exists()");
        a(paramContext);
      }
      return;
    }
    lcg.c("CaptureVideoFilterManager", "BEAUTY_CONFIG  is not exsit");
  }
