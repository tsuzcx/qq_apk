...
public class artr
  implements artq
{
  static ayrz jdField_a_of_type_Ayrz = new artu();
  private static File jdField_a_of_type_JavaIoFile;
  private static Comparator<File> jdField_a_of_type_JavaUtilComparator = new arts();
  private ayry jdField_a_of_type_Ayry;
  private aysa jdField_a_of_type_Aysa = new artt(this);
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private ConcurrentHashMap<String, List<artv>> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
  private ConcurrentHashMap<String, ayrv> b;
  ...
  public static String a(String paramString)
  {
    ...
    {
      jdField_a_of_type_JavaIoFile = new File(arqp.jdField_a_of_type_JavaLangString);
    ...
    return new File(arqp.jdField_a_of_type_JavaLangString, bdhv.d(paramString)).getAbsolutePath();
  }
  ...
  private void a(MusicInfo paramMusicInfo)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        i = arqq.a().jdField_a_of_type_Int;
        if (i <= 0)
        {
          ...
          if (paramMusicInfo.b.size() > 0)
          {
            ...
            while (((Iterator)localObject2).hasNext())
            {
              ...
              if (!TextUtils.isEmpty(str)) {
                ((List)localObject1).add(new artv(paramMusicInfo.jdField_a_of_type_JavaLangString, str));
              }
            }
          }
        }
    ...
    for (;;)
    {
      ...
      {
        localObject2 = (artv)localIterator.next();
        if (((artv)localObject2).jdField_a_of_type_Int == 1)
        {
          bool = true;
          break label583;
        }
      ...
      for (;;)
      {
        ...
        break;
        if ((((artv)localObject2).jdField_a_of_type_Int == 0) && (localObject1 == null))
        {
          localObject1 = localObject2;
          break label595;
        }
        do
        {
          ...
          ((ayrv)localObject2).jdField_a_of_type_Aysa = this.jdField_a_of_type_Aysa;
          ((ayrv)localObject2).jdField_a_of_type_JavaLangString = ((artv)localObject1).b;
          ((ayrv)localObject2).jdField_a_of_type_Int = 0;
          ((ayrv)localObject2).c = ((artv)localObject1).d;
          ((ayrv)localObject2).e = 1;
          ((ayrv)localObject2).a(new Object[] { paramMusicInfo, localObject1 });
          ((ayrv)localObject2).jdField_a_of_type_Ayrz = jdField_a_of_type_Ayrz;
          this.jdField_a_of_type_Ayry.a((aysw)localObject2);
          ((artv)localObject1).jdField_a_of_type_Int = 1;
          break;
          break label595;
          bool = false;
          localObject1 = localObject2;
  ...
  {
    int i = bcxh.a(BaseApplicationImpl.getContext());
    boolean bool;
    if (paramInt == 0) {
      bool = true;
    }
  ...
  public static void b()
  {
    ...
    Object localObject1 = new File(arqp.jdField_a_of_type_JavaLangString);
  ...
  private boolean b(int paramInt)
  {
    ...
    File localFile1 = new File(arqp.jdField_a_of_type_JavaLangString);
    Object localObject;
    int i;
  ...
  private void c()
  {
    try
    {
      ...
      {
        Object localObject2 = (aysw)((Map.Entry)localIterator.next()).getValue();
        this.jdField_a_of_type_Ayry.b((aysw)localObject2);
        if ((localObject2 instanceof ayrv))
        {
          localObject2 = (ayrv)localObject2;
          if (QLog.isColorLevel()) {
            QLog.d("ListenTogether.downloader", 2, String.format("cancelAllRequests, cancel req url: %s", new Object[] { ((ayrv)localObject2).jdField_a_of_type_JavaLangString }));
          }
        }
      }
      if (!QLog.isColorLevel()) {
  ...
  public void a(String paramString)
  {
    ...
    //   20: return
    //   21: aload_0
    //   22: getfield 59	artr:b	Ljava/util/concurrent/ConcurrentHashMap;
    //   25: aload_1
    //   26: invokevirtual 357	java/util/concurrent/ConcurrentHashMap:remove	(Ljava/lang/Object;)Ljava/lang/Object;
    //   29: checkcast 344	aysw
    //   32: astore_2
    //   33: aload_2
    //   34: ifnull +13 -> 47
    //   37: aload_0
    //   38: getfield 52	artr:jdField_a_of_type_Ayry	Layry;
    //   41: aload_2
    //   42: invokeinterface 346 2 0
    //   47: aload_0
    //   48: getfield 57	artr:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   51: aload_1
