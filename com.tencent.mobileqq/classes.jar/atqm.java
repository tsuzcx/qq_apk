...
{
  public atqm(ListView paramListView, FaceDecoder paramFaceDecoder, List<bcfj> paramList, String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    {
      paramListView = (atqj)paramString.get(0);
  ...
  {
    return new atqo(FileSearchFragment.a(this.a));
  }
