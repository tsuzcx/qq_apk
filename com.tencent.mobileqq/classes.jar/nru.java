  ...
  extends ViewBase
{
  ...
  public nru(VafContext paramVafContext)
  {
  ...
  {
    this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)this.jdField_a_of_type_AndroidContentContext.getSystemService("layout_inflater")).inflate(2131494227, null);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131302986));
    this.jdField_b_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131303045));
    this.jdField_c_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131302991));
  }
  ...
  private void a(View paramView)
  {
    ...
    if ((localObject1 != null) && (((Activity)localObject1).getWindow() != null))
    {
      ...
      this.d = aciy.a(40.0F, ((Activity)localObject1).getResources());
    }
    if ((this.jdField_a_of_type_Opw != null) && (this.jdField_a_of_type_Opw.a() != null) && (this.jdField_a_of_type_Opw.a().a() != null))
    {
      ...
      this.jdField_c_of_type_Int = this.jdField_a_of_type_Opw.a().a().getTop();
