  ...
  implements Manager
{
  ...
  public String a;
  HashMap<String, nrw> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  public nru(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Bezd = new nrv(this);
  ...
  public nrw a(String paramString, long paramLong)
  {
    nrw localnrw2 = (nrw)this.jdField_a_of_type_JavaUtilHashMap.get(paramString + paramLong);
    nrw localnrw1 = localnrw2;
    if (localnrw2 == null)
    {
      localnrw1 = new nrw(this);
      localnrw1.jdField_a_of_type_JavaLangString = paramString;
      localnrw1.jdField_a_of_type_Long = paramLong;
      this.jdField_a_of_type_JavaUtilHashMap.put(localnrw1.a(), localnrw1);
    }
    return localnrw1;
  }
  ...
  public void a(String paramString1, String paramString2, long paramLong)
  {
    ...
    new bezc("https://now.qq.com/cgi-bin/now/web/room/get_live_room_url", "GET", this.jdField_a_of_type_Bezd, 1001, localBundle, true).execute(new HashMap[] { paramString2 });
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3, long paramLong, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication();
    paramString2.put("CONTEXT", MobileQQ.getContext());
    new bezc("https://now.qq.com/cgi-bin/now/web/room/check_live_stat", "GET", this.jdField_a_of_type_Bezd, 1003, localBundle, true).execute(new HashMap[] { paramString2 });
  }
  ...
  public boolean b()
  {
    ...
    Iterator localIterator = ((azvi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36)).a().iterator();
