  ...
  extends FrameLayout
{
  ...
  public xif(TroopUnAccalimedRedPacketList paramTroopUnAccalimedRedPacketList, @NonNull Context paramContext, QQWalletTroopHbItem paramQQWalletTroopHbItem)
  {
    super(paramContext);
    ...
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setBackgroundResource(2130844309);
  ...
  public void a(RedPackGrapInfo paramRedPackGrapInfo)
  {
    ...
    {
      localObject = FaceDrawable.a(TroopUnAccalimedRedPacketList.a(this.jdField_a_of_type_ComTencentMobileqqActivityQwalletTroopUnAccalimedRedPacketList), String.valueOf(paramRedPackGrapInfo.lUin), (byte)3);
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioItemQQWalletTroopHbItem != null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityAioItemQQWalletTroopHbItem.a((FrameLayout)localObject, paramRedPackGrapInfo, new xig(this));
    }
    label120:
