  ...
  implements View.OnClickListener
{
  ...
  public qyd(View paramView, BaseData paramBaseData)
  {
  ...
  private static int a(Context paramContext, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    return aciy.a(paramInt1, paramContext.getResources());
  }
  
  private void a(URLDrawable paramURLDrawable)
  {
    int i = aciy.a(this.d, this.jdField_a_of_type_AndroidViewView.getContext().getResources());
    int j = aciy.a(this.c, this.jdField_a_of_type_AndroidViewView.getContext().getResources());
    ...
    paramURLDrawable = new LinearLayout.LayoutParams(a(this.jdField_a_of_type_AndroidViewView.getContext()) - i - i, aciy.a(190.0F, this.jdField_a_of_type_AndroidViewView.getContext().getResources()));
    paramURLDrawable.leftMargin = i;
    paramURLDrawable.rightMargin = i;
    paramURLDrawable.topMargin = j;
    paramURLDrawable.bottomMargin = j;
  ...
  public void a(BaseData paramBaseData1, BaseData paramBaseData2, boolean paramBoolean)
  {
    ...
    int j = aciy.a(this.d, this.jdField_a_of_type_AndroidViewView.getContext().getResources());
    int k = aciy.a(this.c, this.jdField_a_of_type_AndroidViewView.getContext().getResources());
    ...
    for (;;)
    {
      ...
      paramBaseData1.mUseSharpPImage = becs.a(this.jdField_a_of_type_AndroidViewView.getContext());
      paramBaseData1.mMemoryCacheKeySuffix = "fast_web";
      paramBaseData1 = URLDrawable.getDrawable(rsl.a(qyc.a(paramBaseData2.jdField_a_of_type_JavaLangString, paramBaseData2), 4), paramBaseData1);
      if (i != 0) {
        a(paramBaseData1);
      }
      ...
      this.jdField_a_of_type_ComTencentImageURLImageView.setURLDrawableDownListener(new qye(this));
      return;
  ...
  {
    this.jdField_a_of_type_Qxt.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataBaseData);
    ...
    for (paramView = "2";; paramView = "1")
    {
      ...
      raz.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataBaseData.b, "0X8008996", paramView.toString());
      return;
    }
  }
}
