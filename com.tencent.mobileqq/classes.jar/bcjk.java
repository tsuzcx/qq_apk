...
public class bcjk
{
  ...
  public static int a(QQAppInterface paramQQAppInterface, Context paramContext, long paramLong)
  {
    ...
    if (i == 0) {
      bcig.a(paramQQAppInterface, paramLong, 106);
    }
    return i;
  }
  ...
  {
    MessageRecord localMessageRecord = ayvw.a(-2017);
    aeyf.a().a(localMessageRecord.uniseq, paramLong3, paramInt5);
    ...
    localMessageRecord.msgUid = ayvy.a(paramInt1);
    localMessageRecord.msg = bdec.a(null);
  ...
  public static Bitmap a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      Object localObject = bdda.a(paramString, i);
      try
      {
        paramString = bdda.a(paramString, (BitmapFactory.Options)localObject);
        if (paramString == null)
        {
          localObject = null;
          return localObject;
  ...
  public static bbpe a(QQAppInterface paramQQAppInterface, long paramLong1, String paramString1, String paramString2, String paramString3, long paramLong2, int paramInt)
  {
    ...
    paramQQAppInterface = new bbpe(paramString1);
  ...
  public static bbpe a(QQAppInterface paramQQAppInterface, MessageForTroopFile paramMessageForTroopFile)
  {
    Object localObject = null;
    ...
    paramQQAppInterface = new bbpe((bbpe)localObject);
    if (TextUtils.isEmpty(paramQQAppInterface.g)) {
  ...
  public static bbpe a(QQAppInterface paramQQAppInterface, FileManagerEntity paramFileManagerEntity)
  {
  ...
  public static TroopFileData a(obj_msg.ObjMsg paramObjMsg)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localTroopFileData.dspFileName = arni.a(localTroopFileData.dspFileName);
  ...
  public static void a(Context paramContext, QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage)
  {
    ...
    aroo.a(paramQQAppInterface, paramContext, Long.parseLong(paramChatMessage.frienduin), paramChatMessage.uuid, paramChatMessage.url, paramChatMessage.fileName, paramChatMessage.fileSize, paramChatMessage.bisID);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, List<bbnr> paramList)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        bbnr localbbnr = (bbnr)localIterator.next();
        localObject1 = (List)((Map)localObject2).get(Long.valueOf(paramLong));
        paramList = (List<bbnr>)localObject1;
        if (localObject1 == null)
        {
          paramList = new ArrayList();
          ((Map)localObject2).put(Long.valueOf(paramLong), paramList);
        }
        localObject1 = aroo.a(paramQQAppInterface, paramLong, localbbnr);
        if ((localObject1 == null) || (((bbpe)localObject1).e == null)) {
          break;
        }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, boolean paramBoolean, long paramLong1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt1, long paramLong2, long paramLong3, String paramString6, String paramString7, int paramInt2)
  {
    ...
    if (l1 < 1L)
    {
      ...
      l2 = 0L;
      i = ndd.a();
      if ((i >= aljq.c.length) || (i < 0)) {
        break label503;
      }
    }
    label482:
    label503:
    for (String str = aljq.c[i];; str = "NONE")
    {
      ...
      for (i = 0;; i = 1)
      {
        azmj.b(paramQQAppInterface, "P_CliOper", "BizTechReport", "", "troop_troopfile", paramString1, 0, i, paramString3, paramString4, paramLong1 + "KB/s", localHashMap.toString());
        if (QLog.isColorLevel()) {
  ...
  public static boolean a(String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    //   4: iload_2
    //   5: iload_3
    //   6: invokestatic 921	bcjk:a	(Ljava/lang/String;II)Landroid/graphics/Bitmap;
    //   9: astore 6
    //   11: aload 6
    //   13: ifnonnull +10 -> 23
    //   16: iload 5
