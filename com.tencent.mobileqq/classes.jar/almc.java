  ...
  implements Manager
{
  ...
  public almc(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a()
  {
    ...
    Object localObject2 = bahj.a(this.a.getApp());
    ...
    localObject2 = allz.a().a(RockDownloadInfo.class);
    if (localObject2 != null)
    {
      localObject2 = ((List)localObject2).iterator();
      while (((Iterator)localObject2).hasNext())
      {
        ...
        {
          localObject4 = new File(((RockDownloadInfo)localObject3).localPath);
          if (((File)localObject4).exists()) {
            ((File)localObject4).delete();
          }
          allz.a().b((atmo)localObject3);
    ...
    if (((File)localObject1).exists())
    {
      ...
      if ((localObject1 != null) && (localObject1.length > 0))
      {
        ...
        while (i < j)
        {
          ...
          if (((File)localObject2).lastModified() + 604800000L < l)
          {
            if (QLog.isColorLevel()) {
              QLog.d("RockDownloaderManager", 2, new Object[] { "remove file", ((File)localObject2).getAbsolutePath() });
            }
