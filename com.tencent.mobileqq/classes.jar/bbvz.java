...
public class bbvz
{
  private ameq jdField_a_of_type_Ameq = new bbwa(this);
  public Context a;
  public Handler a;
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  public String a;
  
  public bbvz(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, Handler paramHandler)
  {
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      ((amdu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(true, this.jdField_a_of_type_JavaLangString, str, 5);
      if (l1 == 0L)
      {
