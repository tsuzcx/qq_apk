  ...
  implements Manager
{
  ...
  public bfua(AppInterface paramAppInterface)
  {
  ...
  {
    String str = bdbt.m(paramQQAppInterface, paramString);
    if ((TextUtils.isEmpty(str)) || (str.equals(paramString)))
    {
      paramQQAppInterface = ((bfua)paramQQAppInterface.getManager(165)).a(String.valueOf(paramString));
  ...
  {
    paramawbw = paramawbw.a(QidianExternalInfo.class);
    if (paramawbw != null)
    {
      paramawbw = paramawbw.iterator();
      while (paramawbw.hasNext())
      {
        QidianExternalInfo localQidianExternalInfo = (QidianExternalInfo)paramawbw.next();
        if (QLog.isColorLevel()) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, String paramString)
  {
    for (;;)
    {
      try
      {
        ...
        bfua localbfua = (bfua)paramQQAppInterface.getManager(165);
        ...
        if (bool1)
        {
          ...
          localbfua.a(localBmqqAccountType);
          if (!bool1) {
            continue;
          }
          QidianExternalInfo localQidianExternalInfo = localbfua.a(paramString);
          paramString = localbfua.a(paramString);
          if ((localQidianExternalInfo != null) && (paramString != null)) {
            continue;
          }
          if (bhot.a()) {
            ThreadManager.post(new QidianManager.10(localbfua, paramQQAppInterface, localBmqqAccountType), 5, null, true);
          }
        }
        else
        {
        ...
        localbfua.b(paramQQAppInterface.getApp().getBaseContext(), localBmqqAccountType);
        return;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    try
    {
      ...
      ((bfua)paramQQAppInterface.getManager(165)).h.put(paramString1, paramString2);
      return;
    }
    catch (Exception paramQQAppInterface) {}
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Friends[] paramArrayOfFriends)
  {
    ...
    {
      localbfua = (bfua)paramQQAppInterface.getManager(165);
      if (bhot.a()) {
        ThreadManager.postImmediately(new QidianManager.9(localbfua, paramQQAppInterface, paramArrayOfFriends), null, false);
      }
    }
    else
    {
    ...
    localbfua.b(paramQQAppInterface, paramArrayOfFriends);
  }
  ...
  private void a(String paramString1, int paramInt1, int paramInt2, String paramString2)
  {
    if ((!TextUtils.isEmpty(paramString1)) && (paramString1.contains("isNeedReply=")) && (paramString1.contains("QidianKfUin=")))
    {
      ...
      if (bool2)
      {
        ...
        SosoInterface.a(new bfub(this, 1, true, true, 0L, true, false, "QidianManager", paramString1, paramInt1, str3, paramInt2, str2, str1, paramString2));
      }
    }
    label364:
    while (!QLog.isColorLevel())
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    return ((((bfua)paramQQAppInterface.getManager(165)).a(paramMessageRecord.frienduin)) || (paramMessageRecord.istroop == 1024)) && (!TextUtils.isEmpty(paramMessageRecord.getExtInfoFromExtStr("is_eman_sc_message")));
  }
  
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString)
  {
    return ((bfua)paramQQAppInterface.getManager(165)).e(paramString);
  }
  
  private boolean a(String paramString, int paramInt)
  {
    Object localObject = (aloz)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(51);
    if (localObject != null)
    {
      localObject = ((aloz)localObject).b(paramString);
  ...
  {
    paramawbw = paramawbw.a(QidianInternalInfo.class);
    if (paramawbw != null)
    {
      paramawbw = paramawbw.iterator();
      while (paramawbw.hasNext())
      {
        QidianInternalInfo localQidianInternalInfo = (QidianInternalInfo)paramawbw.next();
        if (QLog.isColorLevel()) {
  ...
  private void b(QQAppInterface paramQQAppInterface, Friends[] paramArrayOfFriends)
  {
    ...
    //   45: return
    //   46: iload 5
    //   48: invokestatic 371	bfua:b	(I)Z
    //   51: istore 6
    //   53: iload 5
    //   55: invokestatic 373	bfua:a	(I)Z
    //   58: istore 7
    //   60: iload 5
    //   62: invokestatic 375	bfua:c	(I)Z
    //   65: istore 8
    //   67: iload 6
    //   69: ifne +60 -> 129
    //   72: iload 7
    ...
    //   155: aload_0
    //   156: aload 10
    //   158: invokevirtual 592	bfua:a	(Ljava/lang/String;)I
    //   161: aload 9
    //   163: invokevirtual 596	com/tencent/qidian/data/BmqqAccountType:getAccountType	()I
    //   166: if_icmpeq +119 -> 285
    //   169: aload_0
    //   170: getfield 50	bfua:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   173: aload 10
    //   175: aload 9
    ...
    //   194: aload_0
    //   195: aload 10
    //   197: invokevirtual 126	bfua:a	(Ljava/lang/String;)Lcom/tencent/qidian/data/QidianExternalInfo;
    //   200: astore 11
    //   202: aload_0
    //   203: aload 10
    //   205: invokevirtual 394	bfua:a	(Ljava/lang/String;)Lcom/tencent/qidian/data/QidianProfileUiInfo;
    //   208: astore 10
    //   210: aload 11
    //   212: ifnull +8 -> 220
    //   215: aload 10
    ...
    //   228: aload 9
    //   230: invokevirtual 415	bfua:b	(Landroid/content/Context;Lcom/tencent/qidian/data/BmqqAccountType;)Z
    //   233: pop
    //   234: goto +51 -> 285
    //   237: astore_1
    //   238: aload_1
  ...
  private void b(BmqqUserSimpleInfo paramBmqqUserSimpleInfo)
  {
    ...
    while (!QLog.isColorLevel()) {
      for (;;)
      {
        try
        {
          localawbw.b(paramBmqqUserSimpleInfo);
          if (QLog.isColorLevel()) {
  ...
  private void b(QidianExternalInfo paramQidianExternalInfo, QidianInternalInfo paramQidianInternalInfo, QidianCorpInfo paramQidianCorpInfo, QidianProfileUiInfo paramQidianProfileUiInfo)
  {
    ...
    while (!QLog.isColorLevel())
    {
      try
      {
        localawbw.b(paramQidianExternalInfo);
        if (paramQidianInternalInfo == null) {
          break label124;
        }
        localawbw.b(paramQidianInternalInfo);
      }
      ...
      {
        localawbw.b(paramQidianCorpInfo);
        if (paramQidianProfileUiInfo == null) {
          break label168;
        }
        localawbw.b(paramQidianProfileUiInfo);
      }
      for (;;)
      {
        if (QLog.isColorLevel()) {
  ...
  {
    return ((bfua)paramQQAppInterface.getManager(165)).f(paramString);
  }
  ...
  private void c(awbw paramawbw)
  {
    paramawbw = paramawbw.a(BmqqUserSimpleInfo.class);
    if (paramawbw != null)
    {
      paramawbw = paramawbw.iterator();
      while (paramawbw.hasNext())
      {
        BmqqUserSimpleInfo localBmqqUserSimpleInfo = (BmqqUserSimpleInfo)paramawbw.next();
        if (QLog.isColorLevel()) {
  ...
  private void d(awbw paramawbw)
  {
    paramawbw = paramawbw.a(QidianCorpInfo.class);
    if (paramawbw != null)
    {
      paramawbw = paramawbw.iterator();
      while (paramawbw.hasNext())
      {
        QidianCorpInfo localQidianCorpInfo = (QidianCorpInfo)paramawbw.next();
        if (QLog.isColorLevel()) {
  ...
  private void e(awbw paramawbw)
  {
    paramawbw = paramawbw.a(QidianProfileUiInfo.class);
    if (paramawbw != null)
    {
      paramawbw = paramawbw.iterator();
      while (paramawbw.hasNext())
      {
        QidianProfileUiInfo localQidianProfileUiInfo = (QidianProfileUiInfo)paramawbw.next();
        if (QLog.isColorLevel()) {
  ...
  private void f(awbw paramawbw)
  {
    paramawbw = paramawbw.a(QidianPAForWpa.class);
    if (paramawbw != null)
    {
      paramawbw = paramawbw.iterator();
      while (paramawbw.hasNext())
      {
        QidianPAForWpa localQidianPAForWpa = (QidianPAForWpa)paramawbw.next();
  ...
  public String a(Context paramContext, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString)) {
      return String.format(paramContext.getString(2131698878), new Object[] { paramString });
    }
    return paramContext.getString(2131698877);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        localObject2 = azqu.a(paramString.getBytes(), 0);
    ...
    paramString = (MessageForStructing)ayvw.a(-2011);
    ...
    for (;;)
    {
      ...
      if (alsh.a(paramQQAppInterface, paramString, false)) {
        break;
      }
  ...
  {
    ((bfvi)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(85)).a(paramString1, paramInt1, paramBoolean, 0.0D, 0.0D, paramString2, paramInt2, paramString3, paramString4, paramString5);
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ((bfvi)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(85)).a(paramString1, paramString2, paramString3);
      return;
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    if ((!nbp.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) || (nbp.a(null, paramString))) {
      ((alkv)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(2)).a(paramString, paramBoolean);
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    while (localIterator.hasNext()) {
      ((bfuc)localIterator.next()).a(paramBoolean);
    }
  }
      ...
      try
      {
        ...
        if (nbp.a(paramContext))
        {
          ...
          default: 
            return false;
          case 1: 
            ((bfvi)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(85)).b(l);
            return true;
          }
          ((bfvi)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(85)).d(l);
          return true;
        }
      }
  ...
  {
    ((alkv)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(2)).f(paramString);
  }
      ...
      try
      {
        ...
        if (nbp.a(paramContext))
        {
          ...
          case 2: 
            ...
            return true;
          case 1: 
            ((bfvi)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(85)).a(l);
            return true;
          }
          ((bfvi)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(85)).c(l);
          return true;
        }
      }
      catch (Exception paramContext) {}
