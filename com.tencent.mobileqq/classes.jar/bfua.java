...
public class bfua
{
  ...
  private void a(int paramInt)
  {
    ...
    this.jdField_a_of_type_Int = actj.a(1.0F, ((Context)localObject).getResources());
    if (this.h == 0)
    {
      f1 = 3.0F;
      this.jdField_b_of_type_Int = actj.a(f1, ((Context)localObject).getResources());
      f1 = f3;
      if (this.h == 0) {
        f1 = 3.0F;
      }
      this.c = actj.a(f1, ((Context)localObject).getResources());
      f1 = f2;
      if (this.h == 0) {
        f1 = 2.0F;
      }
      paramInt = actj.a(f1, ((Context)localObject).getResources());
      if (this.h != 0) {
        break label352;
      }
    }
    ...
    {
      int i1 = actj.a(f1, ((Context)localObject).getResources());
      this.e = i1;
      this.d = i1;
