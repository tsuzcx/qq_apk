  ...
  extends GPUBaseFilter
{
  ...
  private bppv jdField_a_of_type_Bppv;
  ...
  public boolean a()
  {
    return (this.jdField_a_of_type_Bppv != null) || (this.b != null);
  }
  
  public void destroy()
  {
    if (this.jdField_a_of_type_Bppv != null) {
      this.jdField_a_of_type_Bppv.destroy();
    }
    if (this.b != null) {
      this.b.destroy();
    }
  ...
  public void drawTexture(int paramInt, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2)
  {
    if (!a())
    {
      ykq.e("Q.qqstory.publish.edit GpuImagePartsFilterGroup", "must set filters before draw texture");
      return;
    }
    if (this.jdField_a_of_type_Bppv != null) {
      this.jdField_a_of_type_Bppv.drawTexture(paramInt, paramArrayOfFloat1, paramArrayOfFloat2);
    }
  ...
  public void init()
  {
    if ((this.jdField_a_of_type_Bppv != null) && (!this.jdField_a_of_type_Bppv.isInitialized())) {
      this.jdField_a_of_type_Bppv.init();
    }
  ...
  {
    if (this.jdField_a_of_type_Bppv != null) {
      this.jdField_a_of_type_Bppv.onOutputSizeChanged(paramInt1, paramInt2);
    }
    if (this.b != null) {
