...
public class aneh
{
  ...
  WeakReference<anei> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  public static void a(Activity paramActivity, QQAppInterface paramQQAppInterface, Runnable paramRunnable1, Runnable paramRunnable2)
  {
    ...
    do
    {
      do
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.i("BindMsgConstant", 2, String.format("checkReadContactPermission [%s, %s]", new Object[] { Boolean.valueOf(bool), Boolean.valueOf(bfnz.l()) }));
        }
        if (!bool) {
          break;
        }
      ...
      if (bfnz.l())
      {
        ...
        localanej.jdField_a_of_type_JavaLangRunnable = paramRunnable1;
        localanej.jdField_b_of_type_JavaLangRunnable = paramRunnable2;
        localanej.jdField_a_of_type_Int = 1;
        paramQQAppInterface.a().a(paramActivity, localanej, null, new String[] { "android.permission.READ_CONTACTS", "android.permission.WRITE_CONTACTS", "android.permission.GET_ACCOUNTS" });
        return;
      }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Anej.jdField_b_of_type_Int = a();
      QLog.d("contact.PermissionChecker", 1, "onPermissionResult = " + this.jdField_a_of_type_Anej.jdField_b_of_type_Int);
      ...
      localanei.a(paramBoolean, this.jdField_a_of_type_Anej);
    }
    for (;;)
    {
      this.jdField_a_of_type_Anej = null;
      return;
      label78:
      localanei = (anei)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      break;
      label92:
      this.jdField_a_of_type_Anej.a(paramBoolean);
    }
  }
  ...
  public void a(Activity paramActivity, anej paramanej, anei paramanei, String... paramVarArgs)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramActivity = paramanej;
        if (paramanej == null) {
          paramActivity = new anej();
        }
        paramanej = new StringBuilder(512);
        ...
        if (i < j)
        {
          ...
          paramanej.append(str).append(",");
          i += 1;
        }
        else
        {
          paramActivity.jdField_a_of_type_JavaUtilList = localArrayList;
          this.jdField_a_of_type_Anej = paramActivity;
          this.jdField_a_of_type_JavaLangRefWeakReference = null;
          if (paramanei != null) {
            this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramanei);
          }
          QLog.d("contact.PermissionChecker", 1, "requestPermissions = " + paramanej.toString());
