  ...
  implements lqo
{
  ...
  public bfrd(Context paramContext, long paramLong, bfqy parambfqy)
  {
  ...
  private void a()
  {
    bfrg.c("MultiOperatorBase", "initGAudioCtrl");
    try
    {
      if (this.jdField_a_of_type_ComTencentAvGaudioQQGAudioCtrl == null)
      {
        ...
        if (this.jdField_a_of_type_ComTencentAvGaudioQQGAudioCtrl != null)
        {
          ...
          this.jdField_a_of_type_ComTencentAvGaudioQQGAudioCtrl.init(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Long, 1, "8.3.3");
          ClientLogReport.instance().init(this.jdField_a_of_type_AndroidContentContext, AppSetting.a());
          GAClientLogReport.instance();
          return;
        }
        bfrg.a("MultiOperatorBase", "initGAudioCtrl create instance fail.");
        return;
      }
    }
    catch (Exception localException)
    {
      bfrg.a("MultiOperatorBase", "initGAudioCtrl  fail.", localException);
  ...
  private boolean a()
  {
    bfrg.c("MultiOperatorBase", "loadLibrary");
    try
    {
    ...
    {
      bfrg.a("MultiOperatorBase", "loadLibrary fail.", localThrowable);
    }
    return false;
  }
  ...
  private void b()
  {
    bfrg.c("MultiOperatorBase", "unInitGAudioCtrl");
    try
    {
      if (this.jdField_a_of_type_ComTencentAvGaudioQQGAudioCtrl != null)
      {
    ...
    {
      bfrg.a("MultiOperatorBase", "unInitGAudioCtrl  fail.", localException);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Bfqy != null) {
      this.jdField_a_of_type_Bfqy.a(paramLong1, paramLong2, paramArrayOfByte);
    }
  }
