...
public class anhd
  extends anhe
{
  public anhd(int paramInt, anhg paramanhg, anhc paramanhc)
  {
    super(paramInt, paramanhg, paramanhc);
  }
  
  public anhd(int paramInt, String paramString, anhg paramanhg, anhc paramanhc)
  {
    super(paramInt, paramString, paramanhg, paramanhc);
  }
  ...
  private amww b()
  {
    ...
    try
    {
      ...
      {
        localJSONObject.put("is3DBetaTester", angi.a(localQQAppInterface));
  ...
  private amww d(String paramString)
  {
    try
    {
      QLog.d("CmShow_SpriteActionScript", 1, new Object[] { "handleJsError mSpriteFrom:", Integer.valueOf(this.jdField_a_of_type_Anhg.e) });
      paramString = new JSONObject(paramString).optString("data");
      anmq.a(angi.b(this.jdField_a_of_type_Anhg.e), 1000, 50, new Object[] { paramString });
      return null;
    }
    catch (Exception paramString)
    {
  ...
  private amww f(String paramString)
  {
    try
    {
      ...
      if ((i == angi.b(1)) || (i == angi.b(2))) {
        anmq.a(i, null, new int[] { anmp.a(i, false, this.jdField_a_of_type_Anhg.jdField_b_of_type_Int, -1, true) });
      }
      anmq.b(i);
      if ((i == angi.b(1)) || (i == angi.b(2)))
      {
        anmq.a(angi.b(this.jdField_a_of_type_Anhg.e), false);
        return null;
      }
    }
    catch (Throwable paramString)
  ...
  private amww j(String paramString)
  {
    try
    {
      if (this.jdField_a_of_type_Anhg.e != 0) {
        return null;
      }
  ...
  private amww m(String paramString)
  {
    try
    {
      ...
      paramString = this.jdField_a_of_type_Anhc;
      if (paramString != null) {
        return null;
      }
    }
    ...
    for (;;)
    {
      try
      {
        ...
        if ("pet".equals(paramString.getString("config_name")))
        {
          ...
          if (localObject != null)
          {
            localObject = (amsx)((QQAppInterface)localObject).getManager(153);
            if (((amsx)localObject).j == null) {
              break label124;
            }
            paramString = new JSONArray(((amsx)localObject).j);
  ...
  private amww p(String paramString)
  {
    ...
    paramString = this.jdField_a_of_type_Anhg.a();
    if (paramString != null)
    {
      paramString.a();
      return null;
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          localObject = angi.a(ApolloUtil.a());
          if (localObject != null)
          {
  ...
  private amww q(String paramString)
  {
    ...
    try
    {
      ...
      if ((this.jdField_a_of_type_Anhg == null) || (this.jdField_a_of_type_Anhg.a() == null))
      {
      ...
      if (this.jdField_a_of_type_Anhg.a().a() == null)
      {
    ...
    ApolloUtil.a(this.jdField_a_of_type_Anhg.a().a(), (String)localObject);
    return null;
    label122:
    ...
    if (i > 0)
    {
      ApolloGameUtil.a(this.jdField_a_of_type_Anhg.a(), i, 333002, "message", 1);
      return null;
    }
  ...
  public amww a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localamww.jdField_b_of_type_Boolean = true;
        JSONObject localJSONObject = new JSONObject();
        if ((1 == localQQAppInterface.c()) && (((this.jdField_a_of_type_Anhg.jdField_a_of_type_Int != 1) && (this.jdField_a_of_type_Anhg.jdField_a_of_type_Int != 3000)) || (((1 == localQQAppInterface.a()) || (this.jdField_a_of_type_Anhg.jdField_a_of_type_Int == 0) || (this.jdField_a_of_type_Anhg.jdField_a_of_type_Int == -2)) && (!localQQAppInterface.q()) && (!localQQAppInterface.r()) && (localQQAppInterface.s()) && (!MediaPlayerManager.a(localQQAppInterface).a()) && ((localQQAppInterface.a() == null) || (!localQQAppInterface.a().k())) && (!localQQAppInterface.d()))))
        {
  ...
  {
    amwa localamwa = a();
    if ((localamwa == null) || (localamwa.getLuaState() != paramLong)) {}
    do
    {
      do
      {
      ...
      if ("cs.script_update_boundinglist.local".equals(paramString1)) {
        return a(paramString2, localamwa.getRenderImpl().a());
      }
  ...
  public amww a(String paramString)
  {
    ...
    try
    {
      ...
      anhm localanhm = this.jdField_a_of_type_Anhc.a();
      if (localanhm != null)
      {
        int i = 0;
        if (i < localJSONArray1.length())
        {
          ...
          if (j == 1) {
            localJSONObject2.put("petPath", localanhm.a(new JSONArray(paramString.optString("actionList"))));
          }
          for (;;)
          {
            ...
            i += 1;
            break;
            localObject = localanhm.a((String)localObject);
  ...
  public void a(int paramInt)
  {
    try
    {
      ...
      ApolloUtil.a().callbackFromRequest(this.jdField_a_of_type_Anhg.a().getLuaState(), 0, "sc.script_notify_user_operation.local", localJSONObject.toString());
      return;
    }
    catch (Throwable localThrowable)
    {
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, String paramString, int paramInt5)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (!this.jdField_a_of_type_Anhg.jdField_b_of_type_Boolean) {
          break label890;
        }
        ...
        if (localObject != null)
        {
          ...
          localJSONObject.put("freeMemory", ((anpw)localObject).d);
          localJSONObject.put("totalMemory", ((anpw)localObject).jdField_c_of_type_Long);
          localJSONObject.put("maxMemory", ((anpw)localObject).jdField_b_of_type_Long);
        }
        localJSONObject.put("aioType", ApolloGameUtil.a(ApolloUtil.a(), paramInt4, this.jdField_a_of_type_Anhg.jdField_a_of_type_JavaLangString));
        ...
        localJSONObject.put("uin", this.jdField_a_of_type_Anhg.jdField_b_of_type_JavaLangString);
        ...
        {
          paramString.put(anlk.a(1, Integer.valueOf(localObject[paramInt2]).intValue()));
          paramInt2 += 1;
          continue;
        }
        ...
        localJSONObject.put("traceFeatureId", this.jdField_a_of_type_Anhg.a());
  ...
  public void a(int paramInt, String paramString1, String paramString2)
  {
    try
    {
      ...
      {
        ApolloCmdChannel.getChannel(paramString1).callbackFromRequest(this.jdField_a_of_type_Anhg.a().getLuaState(), 0, "sc.script_on_sprite_single_clicked.local", localJSONObject.toString());
        return;
      }
      paramString1 = ApolloUtil.a();
      if (paramString1 != null)
      {
        ApolloCmdChannel.getChannelFromOtherProcess(paramString1).callbackFromRequest(this.jdField_a_of_type_Anhg.a().getLuaState(), 0, "sc.script_on_sprite_single_clicked.local", localJSONObject.toString());
        return;
      }
    }
  ...
  {
    if ((this.jdField_a_of_type_Anhg != null) && (this.jdField_a_of_type_Anhg.a() != null)) {
      a(this.jdField_a_of_type_Anhg.a().getWidth(), this.jdField_a_of_type_Anhg.a().getInitHeight(), this.jdField_a_of_type_Anhg.a().getHeight(), this.jdField_a_of_type_Anhg.jdField_a_of_type_Int, this.jdField_a_of_type_Anhg.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Anhg.e);
    }
  }
  ...
  public amww c(String paramString)
  {
    try
    {
      int i = this.jdField_a_of_type_Anhg.e;
      if (i != 0) {}
      return null;
    }
    catch (Throwable paramString)
