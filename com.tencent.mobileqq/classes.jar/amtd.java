...
public class amtd
  implements SurfaceTexture.OnFrameAvailableListener, angj, TVK_IMediaPlayer.OnCompletionListener, TVK_IMediaPlayer.OnDownloadCallbackListener, TVK_IMediaPlayer.OnErrorListener, TVK_IMediaPlayer.OnSeekCompleteListener, TVK_IMediaPlayer.OnVideoPreparedListener
{
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private amte jdField_a_of_type_Amte;
  private amvz jdField_a_of_type_Amvz = new amvz(0);
  ...
  public amtd(amte paramamte, int paramInt)
  {
    this.jdField_a_of_type_Amte = paramamte;
  ...
  private void d()
  {
    ...
    if ((localTVK_IProxyFactory != null) && (this.jdField_a_of_type_AndroidGraphicsSurfaceTexture == null))
    {
      ...
      if (this.jdField_a_of_type_Angi != null) {
        this.jdField_a_of_type_Angi.a(null);
      }
      if (this.jdField_a_of_type_Angi == null) {
      ...
      {
        this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer = localTVK_IProxyFactory.createMediaPlayer(BaseApplicationImpl.getContext(), this.jdField_a_of_type_Angi);
  ...
  public void a(String paramString, long paramLong, boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
    ...
    label197:
    localTVK_PlayerVideoInfo.setConfigMap("file_dir", angh.a(paramString));
    if (this.jdField_b_of_type_Boolean) {}
    for (localObject = "true";; localObject = "false")
    {
      ...
      localTVK_PlayerVideoInfo.setVid(bflr.d(paramString));
  ...
  public void a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, int paramInt1, int paramInt2, int paramInt3, int paramInt4, float paramFloat, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Amte != null) {
      this.jdField_a_of_type_Amte.a(paramArrayOfByte1);
    }
  }
  ...
  public void c()
  {
    ...
    {
      this.f = true;
      this.jdField_a_of_type_Amte = null;
      if (this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer != null)
      {
  ...
  public void onCompletion(TVK_IMediaPlayer paramTVK_IMediaPlayer)
  {
    ...
    if (this.jdField_a_of_type_Amte != null) {
      this.jdField_a_of_type_Amte.a(paramTVK_IMediaPlayer);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Amte != null) {
      this.jdField_a_of_type_Amte.a(this.jdField_a_of_type_JavaLangRunnable);
    }
  }
