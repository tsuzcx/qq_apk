...
public class bclu
  extends BaseAdapter
{
  public bclu(DraggableGridView paramDraggableGridView) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (getItemViewType(paramInt) == DraggableGridView.a())
    {
      if (paramView == null)
      {
        paramViewGroup = (MeasureGridView)LayoutInflater.from(this.a.getContext()).inflate(2131560301, paramViewGroup, false);
        paramViewGroup.setClickable(false);
        paramViewGroup.setNumColumns(DraggableGridView.a(this.a));
        paramViewGroup.setAdapter(new bclv(this.a, paramInt / 2));
      ...
      for (;;)
      {
        ...
        ((bclv)paramViewGroup.getAdapter()).a(paramInt / 2);
      }
    }
    if (paramView == null) {
