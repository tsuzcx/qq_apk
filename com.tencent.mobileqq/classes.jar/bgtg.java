...
public class bgtg
{
  ...
  private static bgth jdField_a_of_type_Bgth = new bgth(Looper.getMainLooper());
  ...
  public static String a(android.content.Context paramContext)
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 39	bgtg:jdField_b_of_type_Int	I
    //   6: sipush 1127
    //   9: if_icmpne +15 -> 24
    //   12: aload_0
    //   13: ldc 40
    ...
    //   22: aload_0
    //   23: areturn
    //   24: getstatic 39	bgtg:jdField_b_of_type_Int	I
    //   27: sipush 22000
    //   30: if_icmpne +13 -> 43
    //   33: aload_0
    //   34: ldc 40
    ...
    //   39: astore_0
    //   40: goto -21 -> 19
    //   43: getstatic 39	bgtg:jdField_b_of_type_Int	I
    //   46: sipush 1053
    //   49: if_icmpeq +12 -> 61
    //   52: getstatic 39	bgtg:jdField_b_of_type_Int	I
    //   55: sipush -20001
    //   58: if_icmpne +13 -> 71
    //   61: aload_0
    //   62: ldc 47
    ...
    //   67: astore_0
    //   68: goto -49 -> 19
    //   71: getstatic 39	bgtg:jdField_b_of_type_Int	I
    //   74: sipush 22081
    //   77: if_icmpne +13 -> 90
    //   80: aload_0
    //   81: ldc 48
    ...
    //   86: astore_0
    //   87: goto -68 -> 19
    //   90: getstatic 39	bgtg:jdField_b_of_type_Int	I
    //   93: sipush 22121
    //   96: if_icmpne +13 -> 109
    //   99: aload_0
    //   100: ldc 49
  ...
  public static void a()
  {
    try
    {
      ...
      jdField_a_of_type_Bgth.removeMessages(0);
      jdField_a_of_type_Bgth.sendEmptyMessageDelayed(0, 60000L);
      return;
    }
    finally
    {
  ...
  static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3)
  {
    ...
    if (!TextUtils.isEmpty(paramString3))
    {
      ...
      str2 = paramQQAppInterface.getApp().getString(2131628064);
      str1 = bgtw.b(paramQQAppInterface.getCurrentAccountUin(), "mvip.n.a.zcwy_xht");
    ...
    do
    {
      ...
      if (paramInt2 == 1053)
      {
        str2 = paramQQAppInterface.getApp().getString(2131628067);
        str1 = bgtw.a(paramQQAppInterface.getCurrentAccountUin(), "qq_aio_capacity_open_vip");
        break;
      }
      if (paramInt2 == 22081)
      {
        str2 = paramQQAppInterface.getApp().getString(2131628066);
        str1 = bgtw.a(paramQQAppInterface.getCurrentAccountUin(), "qq_aio_capacity_open_vip");
        break;
      }
      if (paramInt2 != 22121) {
      ...
      str2 = paramQQAppInterface.getApp().getString(2131628065);
      str1 = bgtw.c();
      break;
  ...
  public static boolean a()
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 33	bgtg:jdField_a_of_type_Int	I
    //   6: istore_0
    //   7: iload_0
    //   8: ifne +10 -> 18
    //   11: iconst_1
  ...
  {
    Message localMessage = jdField_a_of_type_Bgth.obtainMessage();
    localMessage.what = 1;
    localMessage.obj = paramQQAppInterface;
    jdField_a_of_type_Bgth.sendMessageDelayed(localMessage, 1000L);
  }
