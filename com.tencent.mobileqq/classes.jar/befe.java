...
public class befe
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, amnq paramamnq, int paramInt1, int paramInt2)
  {
    try
    {
      if (paramamnq.a.strPkgName.equals("com.android.ReadInJoy")) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, MainFragment paramMainFragment, ajii paramajii, int paramInt)
  {
    try
    {
      if ((((paramajii instanceof ReadinjoyTabFrame)) || (paramInt == MainFragment.h)) && ((ReadinjoyTabFrame)paramMainFragment.a(ReadinjoyTabFrame.class) != null) && (paramInt == MainFragment.h) && (paramMainFragment.getActivity().getIntent().getIntExtra("launch_from", 5) == 6)) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    try
    {
      if ((paramMessageRecord.istroop == 7220) || ((paramMessageRecord.istroop == 1008) && (ajed.ay.equals(paramMessageRecord.frienduin)))) {
    ...
    if (paramRecentUser != null) {
      try
      {
        ...
        while (paramRecentUser.getType() == 7220)
        {
          ...
          return;
          label145:
          if (ajed.aQ.equals(paramRecentBaseData.a())) {
  ...
  {
    awqx.b(paramQQAppInterface, "dc00898", "", "", paramString1, paramString1, 0, 0, paramString2, paramString3, paramString4, paramString5);
  }
}
