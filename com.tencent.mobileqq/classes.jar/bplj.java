  ...
  implements bpvt, bqnc
{
  ...
  private bprd jdField_a_of_type_Bprd = new bplp(this);
  private bpre jdField_a_of_type_Bpre;
  private bprh jdField_a_of_type_Bprh = new bplo(this);
  bqah jdField_a_of_type_Bqah;
  private bqgw jdField_a_of_type_Bqgw = new bpln(this);
  ...
  public bplj(AppInterface paramAppInterface, View paramView, bqah parambqah)
  {
    this.jdField_a_of_type_Bpnc = new bplm(this);
    if (paramView == null) {
      throw new IllegalStateException("rootView is null");
    }
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_Bqah = parambqah;
    this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewEffectsCameraCaptureView = ((EffectsCameraCaptureView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364134));
    this.jdField_a_of_type_DovComQqImCaptureViewQIMProviderContainerView = ((QIMProviderContainerView)this.jdField_a_of_type_AndroidViewView.findViewById(2131373091));
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidViewView.findViewById(2131367136));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131364194));
    ...
    this.jdField_b_of_type_DovComTencentMobileqqRichmediaCaptureViewQIMCameraCaptureButtonLayout = ((QIMCameraCaptureButtonLayout)paramView.findViewById(2131364184));
    this.jdField_c_of_type_DovComTencentMobileqqRichmediaCaptureViewQIMCameraCaptureButtonLayout = ((QIMCameraCaptureButtonLayout)paramView.findViewById(2131377259));
  ...
  public void a()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout == null)
      {
        ...
        this.jdField_a_of_type_AndroidViewViewStub = ((ViewStub)this.jdField_a_of_type_AndroidViewView.findViewById(2131365677));
        this.jdField_a_of_type_AndroidViewViewStub.inflate();
        this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout = ((DoodleLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131364186));
        ...
        bpue.a().a(0, this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout);
      ...
      {
        l1 = System.currentTimeMillis();
        this.jdField_b_of_type_AndroidViewViewStub = ((ViewStub)this.jdField_a_of_type_AndroidViewView.findViewById(2131374154));
        ...
        this.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer = ((ProviderViewEditContainer)this.jdField_a_of_type_AndroidViewView.findViewById(2131373093));
        ...
        ((DoodleEditView)localObject).setDoodleEditViewListener(new bplk(this));
        this.jdField_a_of_type_AndroidViewView.findViewById(2131365851).setOnTouchListener(new bpll(this));
        l2 = System.currentTimeMillis();
        if (QLog.isColorLevel()) {
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    {
      QQToast.a(this.jdField_a_of_type_AndroidViewView.getContext(), anzj.a(2131708652), 0).a();
  ...
  public void a(int paramInt, QIMFilterCategoryItem paramQIMFilterCategoryItem)
  {
    ...
    if (paramInt != -1)
    {
      localObject = (VideoFilterViewPager)this.jdField_a_of_type_AndroidViewView.findViewById(2131366846);
      if (localObject != null) {
    ...
    if (paramQIMFilterCategoryItem != null)
    {
      ...
      while (paramQIMFilterCategoryItem.hasNext())
      {
        ...
        if (EffectsCameraCaptureView.a(bqzz.a().a((String)localObject))) {
  ...
  public void a(int paramInt, Object paramObject)
  {
    ...
    if (paramInt == 104)
    {
      paramObject = (QIMMusicConfigManager)bplq.a(2);
  ...
  public void a(PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo, String paramString)
  {
    ...
    else
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewEffectsCameraCaptureView != null) {
        if ((bdcy.a(brhn.a)) && (paramPtvTemplateInfo != null))
        {
  ...
  public boolean a()
  {
    if (this.jdField_a_of_type_Bpre.a())
    {
      this.jdField_a_of_type_Bpre.d();
      return true;
    }
    if (this.jdField_a_of_type_Bpqz.b())
    {
      this.jdField_a_of_type_Bpqz.e();
      return true;
    }
    return false;
  }
  ...
  public void b(String paramString)
  {
    ...
    if (this.jdField_a_of_type_AndroidViewView != null) {
      this.jdField_a_of_type_Bpre.a().a(true, (Activity)this.jdField_a_of_type_AndroidViewView.getContext());
    }
  ...
  {
    bqzz.a().a(0);
    ((bpmw)bplq.a(5)).a[0].a((Activity)this.jdField_a_of_type_AndroidViewView.getContext());
  }
  ...
  public void n()
  {
    ...
    bqzz.a().a(0);
    VideoFilterViewPager localVideoFilterViewPager = (VideoFilterViewPager)this.jdField_a_of_type_AndroidViewView.findViewById(2131366846);
  ...
  public void u()
  {
    ...
    MusicProviderView localMusicProviderView = (MusicProviderView)this.jdField_a_of_type_DovComQqImCaptureViewQIMProviderContainerView.a(MusicProviderView.class);
    DoodleLayout localDoodleLayout = bpue.a().a(0);
  ...
  public void x()
  {
    ...
    this.jdField_a_of_type_DovComQqImCaptureViewQIMProviderContainerView.b(this.jdField_c_of_type_Int, bplz.jdField_b_of_type_Int, bplz.jdField_b_of_type_JavaLangString);
