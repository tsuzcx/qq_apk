...
public class axlm
{
  ...
  static
  {
    jdField_a_of_type_ArrayOfInt = new int[] { 101, 2130845444 };
    jdField_b_of_type_ArrayOfInt = new int[] { 102, 2130845447 };
    jdField_c_of_type_ArrayOfInt = new int[] { 103, 2130845443 };
    jdField_d_of_type_ArrayOfInt = new int[] { 104, 2130845450 };
  }
  
  public axlm(int paramInt)
  {
