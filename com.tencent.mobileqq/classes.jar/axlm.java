...
public class axlm
  extends axlt
{
  private static axlm jdField_a_of_type_Axlm;
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private baof jdField_a_of_type_Baof = new axlo(this);
  ...
  private boolean d;
  private boolean e = aqvv.a((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime(), "is_first_show_atmosphere", true, false);
  private boolean f;
  
  public static axlm a()
  {
    if (jdField_a_of_type_Axlm == null) {}
    try
    {
      if (jdField_a_of_type_Axlm == null) {
        jdField_a_of_type_Axlm = new axlm();
      }
      return jdField_a_of_type_Axlm;
    }
    finally {}
  }
  ...
  private void a(View paramView, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        b(paramView, 2131309578, 2130848801);
        b(paramView, 2131303102, 2130848815, 2130848819);
        b(paramView, 2131302804, 2130848815, 2130848819);
        Object localObject1;
        Object localObject2;
        if (this.jdField_a_of_type_Int == 1)
        {
          a(paramView, 2131302811, 2130848534, 2130848535);
          a(paramView, 2131302816, 2130848837, 2130848831);
          if (!c()) {
            break label499;
          }
          a(paramView, 2131307203, 2130848637, 2130848638);
          a(paramView, 2131307193, 2130848594, 2130848595);
          a(paramView, 2131307206, 2130848643, 2130848644);
          a(paramView, 2131307185, 2130848575, 2130848576);
          a(paramView, 2131307175, 2130848565, 2130848566);
          a(paramView, 2131307198, 2130848614, 2130848615);
          a(paramView, 2131307182, 2130837961, 2130837962);
          a(paramView, 2131307186, 2130837989, 2130837991);
          a(paramView, 2131307196, 2130838002, 2130838003);
          a(paramView, 2131307169, 2130848545, 2130848546);
          localObject1 = paramView.findViewById(2131302566);
          if (localObject1 != null) {
            a((View)localObject1, a(((View)localObject1).getContext(), 2130848528));
          }
          localObject2 = (TextView)paramView.findViewById(2131301272);
          if ((localObject2 != null) && (!awnu.b()))
          {
            ...
            a(paramView, 2131301272, 2130848693, 2130848694, 2130848690);
            ((TextView)localObject2).setPadding(j, i, k, m);
          }
          localObject2 = paramView.findViewById(2131302567);
          if (localObject1 != null) {
            a((View)localObject2, a(((View)localObject1).getContext(), 2130848527));
          }
          b(paramView, 2131305547, 2130848577);
          a(paramView, 2131302566, 2131101352);
          a(paramView, 2131311534, 2131101257);
          a(paramView, 2131302839, 2131101257);
          localObject2 = paramView.findViewById(2131297761);
          ...
          localObject2 = paramView.findViewById(2131312968);
          View localView = paramView.findViewById(2131302567);
        ...
        for (int i = 8;; i = 0)
        {
          ...
          localObject1 = b(((View)localObject1).getContext(), 2130848738);
          paramView = paramView.findViewById(2131296648);
          if (paramView == null) {
            break;
          }
          paramView.setBackgroundDrawable((Drawable)localObject1);
          return;
          a(paramView, 2131302811, 2130848518, 2130848521);
          break label60;
  ...
  private static boolean b(int paramInt)
  {
    ...
    baqt localbaqt = baqt.a;
    localObject = localbaqt.getDir((Context)localObject, localbaqt.getScid(paramInt));
  ...
  public void a(int paramInt)
  {
    ...
    ImageView localImageView = (ImageView)this.jdField_a_of_type_ComTencentMobileqqActivityChatFragment.jdField_a_of_type_ComTencentMobileqqActivityFlingTopGestureLayout.findViewById(2131304924);
    ...
    for (int i = 1;; i = 0)
    {
      ...
      balm localbalm2 = (balm)localImageView.getTag();
      localbalm1 = localbalm2;
      if (localbalm2 == null)
      {
        localbalm1 = new balm(localImageView);
        localImageView.setTag(localbalm1);
      }
      switch (paramInt)
      {
      default: 
    ...
    if (i != 0) {
      localbalm1.a(a("play.png"), 1);
    }
    localbalm1.a(a("playing.png"), 0);
    return;
    if (i != 0) {
      localbalm1.a(a("pause.png"), 1);
    }
    localbalm1.a(a("pausing.png"), 0);
  }
  ...
  public void a(Context paramContext)
  {
    ...
    {
      this.e = false;
      localView = this.jdField_a_of_type_ComTencentMobileqqActivityChatFragment.jdField_a_of_type_ComTencentMobileqqActivityFlingTopGestureLayout.findViewById(2131304903);
      if (localView != null) {}
    }
    else
    {
    ...
    localTextView.setText(paramContext.getResources().getString(2131628190));
    this.jdField_a_of_type_ComTencentWidgetBubblePopupWindow.a(2131690201);
    ...
    this.jdField_a_of_type_ComTencentWidgetBubblePopupWindow.a().setOnClickListener(new axln(this));
    aqvv.a((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime(), "is_first_show_atmosphere", false, false);
    awqx.b(null, "dc00898", "", "", "qq_vip", "0X800A5B9", 1, 0, "", "", "", "");
  }
  ...
  public void a(Context paramContext, View paramView)
  {
    ...
    b(paramContext, 2131303646, 2130848954, 2130848955);
    a(paramContext, 2131307780, 2130843913, 2130843914);
    a(paramContext, 2131304903, 2130843907, 2130843908);
    a(paramContext, 2131304922, 2131101244);
    a(paramContext, 2131304925, 2131101242);
    a(paramContext, 2131304921, 2131101244);
    paramView = (CircleProgress)paramContext.findViewById(2131304919);
    if (paramView != null)
    {
      ColorStateList localColorStateList = a(paramContext.getContext(), 2131101243);
      paramView.setBgAndProgressColor(100, a(paramContext.getContext(), 2131101245).getDefaultColor(), 100, localColorStateList.getDefaultColor());
    }
  ...
  public void a(ChatFragment paramChatFragment, String paramString, int paramInt)
  {
    ...
    if ((paramInt == 1) && (this.jdField_a_of_type_ComTencentMobileqqActivityChatFragment != null) && ((this.jdField_a_of_type_ComTencentMobileqqActivityChatFragment.a() instanceof aebg)) && (((aebg)this.jdField_a_of_type_ComTencentMobileqqActivityChatFragment.a()).F())) {
      return;
    }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    if (paramInt == 1)
    {
      ...
      if ((paramString.jdField_b_of_type_Int != this.jdField_c_of_type_Int) || (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)))
      {
        ...
        awqx.b(null, "dc00898", "", "", "qq_vip", "0X800A5BB", 1, 0, "", "", "", "");
      }
      a();
      label154:
      if (paramString != null) {
    ...
    {
      awqx.b(null, "dc00898", "", "", "qq_vip", "0X800A5BE", paramInt, 0, "", "", "", "");
      if (QLog.isColorLevel()) {
      ...
      if ((paramString != null) && (paramString.jdField_b_of_type_Int == 0)) {
        awqx.b(null, "dc00898", "", "", "qq_vip", "0X800A5BB", 2, 0, "", "", "", "");
      }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    if (!paramBoolean) {
      awqx.b(null, "dc00898", "", "", "qq_vip", "0X800A5BC", 0, 0, "", "", "", "");
    }
    a();
  }
  ...
  public boolean a(ChatFragment paramChatFragment, int paramInt)
  {
    ...
    if ((paramInt == 1) && ((paramChatFragment.a() instanceof aebg)))
    {
      if ((((aebg)paramChatFragment.a()).F()) || (awnu.b())) {}
  ...
  public void b(Context paramContext)
  {
    ...
    this.f = true;
    paramContext = a(paramContext, 2131101315);
  ...
  public void c()
  {
    ...
    awqx.b(null, "dc00898", "", "", "qq_vip", "0X800A5BF", 0, 0, String.valueOf((System.currentTimeMillis() - this.jdField_a_of_type_Long) / 1000L), "", "", "");
  }
}
