...
public class agdt
{
  private static agdt jdField_a_of_type_Agdt;
  ...
  private Map<Integer, agdu> jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  private int a(int paramInt, boolean paramBoolean)
  {
    ...
    agdu localagdu = (agdu)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
    if (localagdu != null)
    {
      Object localObject = localagdu.jdField_a_of_type_JavaLangRefWeakReference;
      if (localObject != null)
      {
        ...
        if (localObject != null)
        {
          ...
          {
            if ((!((DoodleMsgLayout)localObject).b()) && (this.jdField_a_of_type_Long != localagdu.jdField_b_of_type_Long) && (((DoodleMsgLayout)localObject).a()))
            {
              if (paramBoolean)
              {
                a((DoodleMsgLayout)localObject, false);
                if (localagdu.jdField_b_of_type_Long == this.jdField_c_of_type_Long) {
            ...
            if (QLog.isColorLevel()) {
              QLog.d(jdField_a_of_type_JavaLangString, 2, "checkPlayable: can not play:" + localagdu.jdField_a_of_type_Long + "uniID:" + localagdu.jdField_b_of_type_Long + " mPlayedID:" + this.jdField_a_of_type_Long);
            }
          ...
          if (QLog.isColorLevel()) {
            QLog.d(jdField_a_of_type_JavaLangString, 2, "checkPlayable: invisible MsgID:" + localagdu.jdField_a_of_type_Long + "uniID:" + localagdu.jdField_b_of_type_Long);
          }
        }
      }
    }
  ...
  public static agdt a()
  {
    try
    {
      if (jdField_a_of_type_Agdt == null) {
        jdField_a_of_type_Agdt = new agdt();
      }
      return jdField_a_of_type_Agdt;
    }
    finally {}
  }
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      {
        agdu localagdu = (agdu)((Map.Entry)localIterator.next()).getValue();
        if ((localagdu == null) || (localagdu.jdField_a_of_type_Int < paramInt1) || (localagdu.jdField_a_of_type_Int > paramInt2)) {
  ...
  private void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        Object localObject = (agdu)localIterator.next();
        if ((localObject != null) && (((agdu)localObject).jdField_a_of_type_Int >= this.d) && (((agdu)localObject).jdField_a_of_type_Int <= this.e))
        {
          localObject = ((agdu)localObject).jdField_a_of_type_JavaLangRefWeakReference;
          if (localObject != null)
          {
            localObject = (DoodleMsgLayout)((WeakReference)localObject).get();
            if (localObject != null) {
  ...
  private void a(boolean paramBoolean, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      ...
      do
      {
        do
        {
          ...
          agdu localagdu = (agdu)((Iterator)localObject).next();
          if (localagdu.jdField_b_of_type_Long != this.jdField_c_of_type_Long) {
            break;
          }
          localObject = localagdu.jdField_a_of_type_JavaLangRefWeakReference;
    ...
    for (;;)
    {
      ...
      break;
      label135:
      localObject = (agdu)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(i));
      if ((localObject != null) && ((((agdu)localObject).jdField_a_of_type_Long > this.jdField_b_of_type_Long) || (((agdu)localObject).jdField_b_of_type_Long == this.jdField_c_of_type_Long)))
      {
        localObject = ((agdu)localObject).jdField_a_of_type_JavaLangRefWeakReference;
        if (localObject != null)
        {
  ...
  public static void b()
  {
    try
    {
      if (jdField_a_of_type_Agdt != null)
      {
        jdField_a_of_type_Agdt.a();
        jdField_a_of_type_Agdt = null;
      }
      return;
    }
    finally {}
  ...
  public void a(long paramLong1, long paramLong2, int paramInt, DoodleMsgLayout paramDoodleMsgLayout)
  {
    ...
    this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(paramInt), new agdu(this, paramLong1, paramLong2, paramInt, paramDoodleMsgLayout));
    boolean bool;
    if (this.jdField_a_of_type_Int != 0)
    {
      bool = true;
  ...
  public void a(DoodleMsgLayout paramDoodleMsgLayout, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        {
          agdu localagdu = (agdu)((Iterator)localObject).next();
          if ((localagdu.jdField_a_of_type_JavaLangRefWeakReference != null) && (localagdu.jdField_a_of_type_JavaLangRefWeakReference.get() == paramDoodleMsgLayout))
          {
            this.jdField_a_of_type_Long = localagdu.jdField_b_of_type_Long;
            if (QLog.isColorLevel()) {
