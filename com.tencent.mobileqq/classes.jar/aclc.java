...
public class aclc
  extends Handler
{
  public aclc(ChatSettingForTroop paramChatSettingForTroop) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      if (!TextUtils.isEmpty(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopColorNick))
      {
        ...
        localObject1 = new bahs(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopColorNick, 16).a();
        paramMessage.setRightText((CharSequence)localObject1);
        bdnm.a(this.a.app, paramMessage.a(), (Spannable)localObject1);
        return;
      }
      paramMessage.setRightText(this.a.getString(2131698004));
      bdnm.a(this.a.app, paramMessage.a(), new SpannableString(""));
      return;
    ...
    if (this.a.jdField_c_of_type_AndroidWidgetTextView != null) {
      this.a.jdField_c_of_type_AndroidWidgetTextView.setText(alpo.a(2131702127) + this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.wMemberNum + alpo.a(2131702133));
    }
    this.a.b(true);
    this.a.e();
    this.a.a(this.a.e);
    ...
    for (;;)
    {
      ...
      if ((localObject2 != null) && (((List)localObject2).size() > 0))
      {
        ...
        for (;;)
        {
          if (((Iterator)localObject2).hasNext())
          {
            ...
            continue;
            if ((this.a.jdField_a_of_type_Bcru == null) || (TextUtils.isEmpty(this.a.jdField_a_of_type_Bcru.a))) {
              break label1404;
            }
            if (alpo.a(2131702120).equals(this.a.jdField_a_of_type_Bcru.a))
            {
              i = 0;
              break;
            }
            paramMessage = this.a.jdField_a_of_type_Bcru.a;
            i = 1;
            break;
          }
        }
      ...
      {
        localObject2 = (FormSimpleItem)localView2.findViewById(2131368579);
        localSwitch = ((FormSwitchItem)localView1).a();
        localObject3 = (TextView)localView2.findViewById(2131368300);
        ((TextView)localObject3).setBackgroundResource(2130839255);
        localObject1 = "";
        paramMessage = "";
        Boolean localBoolean = (Boolean)this.a.jdField_a_of_type_Bdih.c.get(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin);
        ...
        localView1.setBackgroundResource(2130839260);
      ...
      for (;;)
      {
        ((FormSimpleItem)localObject2).setRightText(new baig((CharSequence)localObject1, 3));
        ((TextView)localObject3).setText(paramMessage);
        ((TextView)localObject3).setTextColor(this.a.getResources().getColor(2131166975));
        atwd.a().c(this.a.app, this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin);
        return;
        label1045:
        localView1.setBackgroundResource(2130839263);
        localView1.getBackground().setAlpha(255);
        if (!localSwitch.isChecked())
        {
          localSwitch.setTag(Boolean.TRUE);
        ...
        default: 
          ...
          break;
        case 2: 
          localObject1 = this.a.getString(2131698077);
          paramMessage = this.a.getString(2131698079);
          break;
        case 3: 
          localObject1 = this.a.getString(2131693308);
          paramMessage = this.a.getString(2131698075);
          break;
        case 4: 
          localObject1 = this.a.getString(2131698081);
          paramMessage = this.a.getString(2131698083);
          break;
          label1204:
          localView2.setVisibility(0);
          localView1.setBackgroundResource(2130839263);
      ...
      {
        localObject1 = (TextView)paramMessage.findViewById(2131377884);
        ...
        paramMessage = (ProgressBar)paramMessage.findViewById(2131372271);
        if (paramMessage != null) {
      ...
      if (i == 0) {}
      for (paramMessage = null;; paramMessage = this.a.getResources().getDrawable(2130849728))
      {
