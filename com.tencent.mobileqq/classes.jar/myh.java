  ...
  implements Manager
{
  ...
  private myk jdField_a_of_type_Myk;
  ...
  public myh(QQAppInterface paramQQAppInterface)
  {
  ...
  private ngr a()
  {
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
      return (ngr)((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getManager(237);
    }
    return null;
  }
  ...
  private void b()
  {
    ...
    if (localTVK_IProxyFactory != null)
    {
      ...
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_ICacheMgr.setPreloadCallback(new myl(this, null));
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_ICacheMgr.setOnPreLoadCompleteCallback(new mym(this, null));
    }
    this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_UserInfo = new TVK_UserInfo(b(), "");
    this.jdField_a_of_type_Myk = new myk(this, this);
    AppNetConnInfo.registerConnectionChangeReceiver(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Myk);
  ...
  public void a(mxu parammxu)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        c("handlePreloadTaskFromMessage msgid:" + parammxu.c + ", vid:" + localmxv.b);
        if (!TextUtils.isEmpty(localmxv.b))
        {
          ...
          localPAAdPreloadTask.mMsgId = parammxu.c;
          ...
          if (parammxu.jdField_a_of_type_Long > 0L)
          {
            ...
            c("handlePreloadTaskFromMessage msgid:" + parammxu.c + ", vid:" + localmxv.b + ", add to queue");
          }
        }
        else
        {
      ...
      continue;
      label309:
      c("handlePreloadTaskFromMessage msgid:" + parammxu.c + ", vid:" + localmxv.b + ", exist in queue, ignore");
    }
  }
  ...
  public void a(mxu parammxu, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        if ((parammxu.jdField_a_of_type_Mxw == null) || (parammxu.jdField_a_of_type_JavaUtilArrayList == null) || (parammxu.jdField_a_of_type_JavaUtilArrayList.size() <= paramInt))
        {
          c("handlePreloadTaskFromPlay invalid item");
          return;
        }
        str = ((mxv)parammxu.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).b;
        c("handlePreloadTaskFromPlay msgid:" + parammxu.c + ", index:" + paramInt + ", vid:" + str);
        if (!TextUtils.isEmpty(str))
        {
          PAAdPreloadTask localPAAdPreloadTask = new PAAdPreloadTask();
          localPAAdPreloadTask.mUserUin = b();
          ...
          if (parammxu.jdField_a_of_type_Long > 0L)
          {
            ...
            localPAAdPreloadTask.mExpireTime = (localPAAdPreloadTask.mReceiveTime + jdField_a_of_type_JavaLangLong.longValue());
            localPAAdPreloadTask.mPreloadState = 1;
            localPAAdPreloadTask.mNetworkType = parammxu.jdField_a_of_type_Mxw.e;
            this.c.add(localPAAdPreloadTask);
            ThreadManager.executeOnNetWorkThread(new AdvertisementVideoPreloadManager.9(this));
            c("handlePreloadTaskFromPlay msgid:" + parammxu.c + ", index:" + paramInt + ", vid:" + str + ", add to queue");
          }
        }
        else
        {
      ...
      continue;
      label317:
      c("handlePreloadTaskFromPlay msgid:" + parammxu.c + ", index:" + paramInt + ", vid:" + str + ", exist in queue, ignore");
    }
  }
  ...
  public void onDestroy()
  {
    ...
    if (this.jdField_a_of_type_Myk != null)
    {
      this.jdField_a_of_type_Myk.a();
      AppNetConnInfo.unregisterNetInfoHandler(this.jdField_a_of_type_Myk);
