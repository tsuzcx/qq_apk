  ...
  implements Manager
{
  ...
  public bfnr(QQAppInterface paramQQAppInterface)
  {
  ...
  private ayju a(String paramString)
  {
    paramString = new ayju(paramString, 16);
  ...
  public static bfnr a()
  {
    return a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime());
  }
  
  public static bfnr a(QQAppInterface paramQQAppInterface)
  {
    return (bfnr)paramQQAppInterface.getManager(313);
  }
  ...
  public String a(String paramString, QQMessageFacade.Message paramMessage)
  {
    ...
    if (aijb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + paramMessage.frienduin)) {
      str = ajyc.a(2131707636) + paramString;
    }
    return str;
  }
  ...
  public void a(QQMessageFacade.Message paramMessage, Intent paramIntent, SpannableStringBuilder paramSpannableStringBuilder)
  {
    if ((a(paramMessage.frienduin, paramMessage.senderuin)) && (paramMessage.istroop == 1))
    {
      ...
      paramSpannableStringBuilder.append(new ayju("[" + paramIntent + "]", 16));
      paramSpannableStringBuilder.append(a(ajyc.a(2131707635)));
      paramSpannableStringBuilder.append(new ayju(paramMessage.nickName, 16));
    }
  }
  
  public void a(QQMessageFacade.Message paramMessage, SpannableStringBuilder paramSpannableStringBuilder)
  {
    if ((aijb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + paramMessage.senderuin)) && (paramMessage.istroop == 0)) {
      paramSpannableStringBuilder.append(a(ajyc.a(2131707637)));
    }
  }
  ...
  public String b(String paramString, QQMessageFacade.Message paramMessage)
  {
    ...
    if ((bool) || ((localObject != null) && (((Boolean)localObject).booleanValue())))
    {
      ...
      localObject = ajyc.a(2131707638) + paramString;
    }
    do
    {
      do
    ...
    return localResources.getString(2131699600) + paramString;
  }
  
  public void b()
  {
    ((ajtk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(2)).j();
  }
  ...
  {
    return aijb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + paramMessage.senderuin);
  }
