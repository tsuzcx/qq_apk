...
public class yas
{
  ...
  public yas(@NonNull Activity paramActivity, @NonNull RMVideoStateMgr paramRMVideoStateMgr, @NonNull Intent paramIntent)
  {
    ...
    this.jdField_a_of_type_Boolean = paramIntent.getBooleanExtra("extra_now_tab", wjz.a(2131099651).booleanValue());
    ...
    if ((paramIntent.getIntExtra("edit_video_type", 0) == 10002) && (this.jdField_a_of_type_Long > 0L)) {
      yqu.b("take_video", "video_startup", 0, 0, new String[] { "", String.valueOf(SystemClock.uptimeMillis() - this.jdField_a_of_type_Long), String.valueOf(this.jdField_b_of_type_Int) });
    }
    yqp.a("QQStoryTakeVideoHelper", "default label:%s", this.jdField_a_of_type_JavaLangString);
  }
  ...
  private void a(PublishParam paramPublishParam, String paramString, int paramInt)
  {
    ...
    if (!this.jdField_b_of_type_Boolean)
    {
      ...
      if (wka.a())
      {
        StoryTransitionActivity.a(this.jdField_a_of_type_AndroidAppActivity, yab.class.getName(), null);
  ...
  private boolean a()
  {
    ...
    {
      yqp.e("QQStoryTakeVideoHelper", "check manifest's existance error. directory is null.");
      return false;
    }
    return bgmg.a(this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_JavaLangString + File.separator + "manifest.ini");
  }
  
  public String a()
  {
    return (String)((wpf)wpm.a(10)).b("StorySvc.get_photography_guide.word", anni.a(2131709822));
  }
  
  public String a(String paramString)
  {
    Object localObject = (wpf)wpm.a(10);
    int i = ((Integer)((wpf)localObject).b("StoryVideoWidth", Integer.valueOf(-1))).intValue();
    int j = ((Integer)((wpf)localObject).b("StoryVideoHeight", Integer.valueOf(-1))).intValue();
    int k = ((Integer)((wpf)localObject).b("StoryVideoMaxrate", Integer.valueOf(-1))).intValue();
    int m = ((Integer)((wpf)localObject).b("StoryVideoMinrate", Integer.valueOf(-1))).intValue();
    String str = (String)((wpf)localObject).b("StoryVideoKey", "960*720#600#1000;640*480#450#750");
    yqp.b("QQStoryTakeVideoHelper", "setupStoryVideoConfig : key = " + str + " width = " + i + " height = " + j + " maxrate = " + k + " minrate = " + m);
    if ((i == -1) && (j == -1) && (k == -1) && (m == -1) && ((str == null) || (str.isEmpty()) || (str.equals("-1")))) {
      yqp.b("QQStoryTakeVideoHelper", "setupStoryVideoConfig : no configs");
    }
    label390:
    ...
    yqp.d("QQStoryTakeVideoHelper", "setupStoryVideoConfig(): newConfig = " + paramString);
    return paramString;
  }
  
  public void a()
  {
    ylb.a(new yav(this, (wpf)wpm.a(10)));
  }
  
  public void a(Intent paramIntent, @NonNull ImageView paramImageView)
  {
    yqp.b("QQStoryTakeVideoHelper", "preview confirm");
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        yqp.b("QQStoryTakeVideoHelper", "preview confirm takephoto ");
      ...
      if (!a())
      {
        yqp.d("QQStoryTakeVideoHelper", "manifest file doesn't exist. generate again before publishing.");
        a(new yat(this, localPublishParam, str, i));
        return;
      }
      yqp.c("QQStoryTakeVideoHelper", "manifest file already exists. start publishing.");
      a(localPublishParam, str, i);
      return;
    }
  ...
  public void a(yaw paramyaw)
  {
    this.jdField_a_of_type_Int = 1;
    Stream.of(this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaStateRMVideoStateMgr).map(new ThreadOffFunction("QQStoryTakeVideoHelper", 2)).map(new zev()).subscribe(new yau(this, paramyaw));
  }
