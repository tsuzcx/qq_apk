  ...
  implements View.OnClickListener, SeekBar.OnSeekBarChangeListener
{
  ...
  public axwf(Activity paramActivity, axup paramaxup)
  {
    super(paramActivity, paramaxup);
    this.jdField_a_of_type_Axup = paramaxup;
  }
  ...
  private View a(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup = this.jdField_a_of_type_Axup.getItem(paramInt);
    ...
    if ((paramViewGroup != null) && (paramViewGroup.baseData != null) && (paramViewGroup.baseData.getType() == 101))
    {
      ...
      if ((!(paramView instanceof RelativeLayout)) || (!(paramView.getTag() instanceof axwo))) {
        break label380;
      }
      this.galleryView = ((RelativeLayout)paramView);
      this.jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView = ((axwo)paramView.getTag()).jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView;
      paramView = null;
      this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.galleryView.findViewById(2131372237));
      this.jdField_c_of_type_AndroidWidgetImageView.bringToFront();
      this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.galleryView.findViewById(2131372239));
      paramViewGroup = new axuf();
      this.galleryView.setTag(2131296400, Boolean.valueOf(true));
      this.galleryView.setTag(2131296433, Boolean.valueOf(true));
      Object localObject = (URLDrawable)this.jdField_a_of_type_Axup.b.get(Integer.valueOf(paramInt));
      ...
      this.galleryView.setContentDescription(this.mContext.getString(2131691691));
      localObject = this.jdField_a_of_type_Axup.a();
      ...
      azmj.b(null, "dc00898", "", "", paramViewGroup, paramViewGroup, 1, 0, "", "", "", "");
      ((RichMediaBrowserInfo)localObject).isReport = true;
    }
    for (;;)
    {
      paramViewGroup = new axwo(this);
      ...
      paramView = (BaseVideoView)awwq.a(this.mContext, localAIOVideoData.jdField_a_of_type_Long, null, paramView);
      ...
      this.jdField_a_of_type_Axup.a(localAIOVideoData.jdField_a_of_type_JavaLangString, localAIOVideoData.jdField_e_of_type_Int, localAIOVideoData.jdField_f_of_type_Int, paramView.getCoverImage(), paramInt);
      break label221;
      label521:
      azmj.b(null, "dc00898", "", "", paramViewGroup, paramViewGroup, 2, 0, "", "", "", "");
    }
  }
  ...
  private void a(int paramInt)
  {
    ...
    a(true);
    Object localObject = this.jdField_a_of_type_Axup.getItem(paramInt);
    ailz localailz;
    if ((localObject != null) && (((RichMediaBrowserInfo)localObject).baseData != null) && (((RichMediaBrowserInfo)localObject).baseData.getType() == 101))
    {
      ...
      this.jdField_a_of_type_Axup.a(((AIOVideoData)localObject).jdField_a_of_type_Long);
      if (QLog.isColorLevel()) {
      ...
      localailz = this.jdField_a_of_type_Axup.a((AIOVideoData)localObject);
      if (localailz != null) {
        break label264;
      }
      this.jdField_a_of_type_Axup.b((AIOVideoData)localObject);
      this.jdField_a_of_type_Axup.a(((AIOVideoData)localObject).jdField_a_of_type_Long, ((AIOVideoData)localObject).jdField_a_of_type_Int, 4);
    ...
    for (;;)
    {
      ...
      label264:
      a(localailz);
      this.jdField_a_of_type_Axup.a(((AIOVideoData)localObject).jdField_a_of_type_Long, ((AIOVideoData)localObject).jdField_a_of_type_Int, 5);
    }
  }
  
  private void a(ailz paramailz)
  {
    if (paramailz == null) {
      return;
    }
    BrowserLogHelper.getInstance().getGalleryLog().d("AIOVideoView", 4, "realPlayVideo id = " + paramailz.jdField_a_of_type_Long);
    this.jdField_a_of_type_Axup.a(paramailz.jdField_a_of_type_Long, paramailz.jdField_b_of_type_Int, 5);
    this.jdField_a_of_type_Axup.a(0L, 0L, axtu.a().c());
    VideoPlayParam localVideoPlayParam = new VideoPlayParam();
    localVideoPlayParam.mSceneId = 101;
    localVideoPlayParam.mSceneName = (awwr.a(101) + "_FulScr");
    if (this.jdField_a_of_type_Axup != null) {
      localVideoPlayParam.mIsMute = this.jdField_a_of_type_Axup.a(paramailz.jdField_a_of_type_Long);
    }
    if (!localVideoPlayParam.mIsMute) {
      j();
    }
    if (paramailz.jdField_a_of_type_Boolean)
    {
      localVideoPlayParam.mUrls = paramailz.jdField_a_of_type_ArrayOfJavaLangString;
      localVideoPlayParam.mSavePath = paramailz.jdField_a_of_type_JavaLangString;
      label178:
      if (paramailz.jdField_a_of_type_Boolean) {
        break label384;
      }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (paramailz.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo != null)
      {
        long l = paramailz.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo.videoFileTime * 1000;
      ...
      paramailz = paramailz.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo;
      if (paramailz != null)
      {
        localVideoPlayParam.mFileID = (paramailz.md5 + paramailz.uniseq);
        localVideoPlayParam.mFileSize = paramailz.videoFileSize;
      }
      localVideoPlayParam.mCallback = new axwg(this);
      if (this.jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView == null) {
        break;
      }
      ...
      return;
      localVideoPlayParam.mVideoPath = paramailz.jdField_a_of_type_JavaLangString;
      break label178;
    }
  }
  ...
  private void a(Bitmap paramBitmap)
  {
    ...
    //   87: putfield 46	axwf:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   112: aload_0
    //   113: getfield 46	axwf:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   125: aload_1
    //   126: aload_0
    //   127: getfield 46	axwf:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   130: invokestatic 557	arof:a	(Landroid/graphics/Bitmap;Ljava/lang/String;)Z
    //   133: pop
    ...
    //   155: iconst_3
    //   156: aload 7
    //   158: invokestatic 566	xwb:a	(Landroid/graphics/Bitmap;ZILandroid/util/SparseArray;)I
    //   161: istore_2
    //   162: iload_2
    //   163: invokestatic 569	xwb:a	(I)Z
    //   166: ifeq +98 -> 264
    ...
    //   258: aload_1
    //   259: iconst_0
    //   260: invokestatic 607	bdig:a	(ILjava/util/ArrayList;Ljava/lang/String;I)Lcom/tencent/mobileqq/utils/ShareActionSheetBuilder$ActionSheetItem;
    //   263: pop
    //   264: iload_2
    //   265: invokestatic 609	xwb:b	(I)Z
    //   268: ifeq +74 -> 342
    ...
    //   336: aload_1
    //   337: iconst_0
    //   338: invokestatic 607	bdig:a	(ILjava/util/ArrayList;Ljava/lang/String;I)Lcom/tencent/mobileqq/utils/ShareActionSheetBuilder$ActionSheetItem;
    //   341: pop
    //   342: aload 6
    ...
    //   418: aload_0
    //   419: aload 6
    //   421: invokespecial 634	com/tencent/mobileqq/richmediabrowser/view/AIOVideoView$10:<init>	(Laxwf;Ljava/util/ArrayList;)V
  ...
  {
    Object localObject1 = new axuf().a(paramAIOVideoData, 1);
    Object localObject2 = this.jdField_a_of_type_Axup.getSelectedItem();
    ...
    {
      if (j != 0) {
        bdig.a(2, this.jdField_a_of_type_JavaUtilArrayList);
      }
      if ((bhou.d()) && ((paramAIOVideoData.jdField_d_of_type_Int != 1) || (i == 0))) {
        bdig.a(39, this.jdField_b_of_type_JavaUtilArrayList);
      }
      if (i == 0)
      {
        bdig.a(6, this.jdField_b_of_type_JavaUtilArrayList);
        bdig.a(3, this.jdField_a_of_type_JavaUtilArrayList);
        bdig.a(27, this.jdField_a_of_type_JavaUtilArrayList);
      }
      if ((axtu.a().g()) && (!TextUtils.isEmpty(axtu.a().c())) && (axtu.a().a() != -1)) {
        bdig.a(54, this.jdField_b_of_type_JavaUtilArrayList);
      }
      if (i == 0) {
        bdig.a(64, this.jdField_b_of_type_JavaUtilArrayList);
      }
      ...
      {
        paramAIOVideoData = RichMediaBrowserManager.getInstance().getProvider().getForwardData(paramAIOVideoData.jdField_a_of_type_Long, paramAIOVideoData.jdField_a_of_type_Int, axtu.a().a());
        if (paramAIOVideoData != null)
        {
          paramAIOVideoData.putExtra("NeedReportForwardShortVideo", true);
          if (this.jdField_a_of_type_Axup.getSelectedItem() != null)
          {
            localObject1 = this.jdField_a_of_type_Axup.getSelectedItem().baseData;
  ...
  private void a(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      azmj.b(null, "dc00898", "", "", paramString, paramString, paramInt, 0, "", "0", "0", "");
      return;
      if (paramInt == 1) {
        paramInt = 2;
  ...
  private boolean a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      RichMediaBrowserInfo localRichMediaBrowserInfo = this.jdField_a_of_type_Axup.getSelectedItem();
      if ((localRichMediaBrowserInfo != null) && ((localRichMediaBrowserInfo.baseData instanceof AIOVideoData)) && (this.jdField_a_of_type_Axup.a((AIOVideoData)localRichMediaBrowserInfo.baseData) != null))
      {
  ...
  private void b(int paramInt)
  {
    ...
    if (localAIOVideoData != null) {
      this.jdField_a_of_type_Axup.a(localAIOVideoData.jdField_a_of_type_Long, localAIOVideoData.jdField_a_of_type_Int, paramInt);
    }
  }
  ...
  private void i()
  {
    ...
    k();
    b(6);
    this.jdField_a_of_type_Axup.onLoadFinish(this.jdField_a_of_type_Axup.getSelectedIndex(), true);
    f(true);
    e(false);
    ...
    a(true);
    if (this.jdField_a_of_type_Axup.a(this.jdField_a_of_type_Axup.getCurrentPosition())) {
      this.jdField_a_of_type_Axup.a(true);
    }
  }
  
  private void j()
  {
    if ((bhou.b()) && (this.mContext != null))
    {
  ...
  private void l()
  {
    ...
    {
      bngr.a(this.mContext, localAIOVideoData.jdField_f_of_type_JavaLangString);
      azmj.b(null, "dc00898", "", "", "0X800A91F", "0X800A91F", 2, 0, "", "", localAIOVideoData.jdField_f_of_type_JavaLangString, "");
    }
  }
  ...
  private void m()
  {
    ...
    if (localAIOVideoData != null)
    {
      ...
      ailz localailz = this.jdField_a_of_type_Axup.a(localAIOVideoData);
      if (localailz == null) {
        break label157;
      }
      this.jdField_a_of_type_Betz.a(localailz, localAIOVideoData.jdField_e_of_type_Long, l);
      this.jdField_a_of_type_Betz.a(localAIOVideoData.jdField_a_of_type_JavaLangString, localAIOVideoData.jdField_e_of_type_Int, localAIOVideoData.jdField_f_of_type_Int);
    ...
    for (boolean bool = true;; bool = false)
    {
      if (this.jdField_a_of_type_Betz.a(bool, localAIOVideoData.jdField_b_of_type_Int)) {
        this.jdField_a_of_type_Axup.back();
      }
      return;
      l = 0L;
      break;
  ...
  public void a()
  {
    if (this.contentView == null)
    {
      ...
      this.jdField_a_of_type_AndroidViewView = ((RelativeLayout)localObject).findViewById(2131371201);
      this.jdField_a_of_type_AndroidWidgetSeekBar = ((SeekBar)this.jdField_a_of_type_AndroidViewView.findViewById(2131376271));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371442));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131372319));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378166));
      ...
      this.jdField_d_of_type_AndroidWidgetImageButton = ((ImageButton)this.contentView.findViewById(2131373457));
      this.jdField_d_of_type_AndroidWidgetImageButton.setContentDescription(alpo.a(2131700417));
      this.jdField_d_of_type_AndroidWidgetImageButton.setOnClickListener(this);
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)((RelativeLayout)localObject).findViewById(2131379297));
      this.jdField_b_of_type_AndroidWidgetSeekBar = ((SeekBar)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131379299));
      this.jdField_b_of_type_AndroidWidgetSeekBar.setMax(10000);
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131379298));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131364326));
      this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this);
      this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.contentView.findViewById(2131363777));
      ...
      this.jdField_e_of_type_AndroidWidgetImageButton = ((ImageButton)this.contentView.findViewById(2131373464));
      this.jdField_e_of_type_AndroidWidgetImageButton.setOnClickListener(this);
      this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.contentView.findViewById(2131363903));
      this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)this.contentView.findViewById(2131363904));
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setOnClickListener(this);
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
      this.jdField_b_of_type_AndroidViewView = this.contentView.findViewById(2131379791);
  ...
  {
    a(bdcd.a(this.mContext, 230, this.mContext.getString(2131719312), this.mContext.getString(2131719311), new axwm(this, paramInt, paramObject), new axwn(this)));
  }
  ...
  public void a(long paramLong, int paramInt1, int paramInt2, String paramString1, String[] paramArrayOfString, String paramString2, MessageForShortVideo paramMessageForShortVideo, int paramInt3)
  {
    ...
    this.jdField_a_of_type_Axup.a(paramLong, paramInt1, paramInt2, paramString1);
    AIOVideoData localAIOVideoData = a();
    if (localAIOVideoData == null) {
      return;
    }
    axuz.a().a(localAIOVideoData.jdField_a_of_type_Long, paramArrayOfString, System.currentTimeMillis(), paramMessageForShortVideo, paramInt3, paramString2);
    paramString2 = new ailz();
    ...
    for (paramString2.jdField_d_of_type_Long = paramString1.length();; paramString2.jdField_d_of_type_Long = 0L)
    {
      ...
      if (new axuf().a(localAIOVideoData, 0) != null) {
        break;
      }
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqWidgetShareShareActionSheet.setItemClickListenerV2(new axwi(this, paramAIOVideoData, paramFile, paramInt, paramRichMediaBrowserInfo));
    this.jdField_a_of_type_ComTencentMobileqqWidgetShareShareActionSheet.setCancelListener(new axwj(this));
  }
  ...
  {
    this.jdField_a_of_type_Axup.b.clear();
  }
  
  public void d(boolean paramBoolean)
  {
    BrowserLogHelper.getInstance().getGalleryLog().d("AIOVideoView", 2, "doEnterImmersion, isClick:" + paramBoolean + ", hasDanmaku:" + this.jdField_a_of_type_Axup.c());
    super.d(paramBoolean);
    if (paramBoolean)
    {
      showContentView(false);
      this.jdField_a_of_type_Axup.b(false);
      return;
    }
    if (this.jdField_a_of_type_Axup.c())
    {
      this.jdField_a_of_type_Axup.a().jdField_a_of_type_Boolean = false;
      this.jdField_a_of_type_Axup.d();
      h(false);
      return;
    }
    showContentView(false);
    this.jdField_a_of_type_Axup.a().e();
  }
  ...
  public void g(boolean paramBoolean)
  {
    ...
    {
      Object localObject = this.jdField_a_of_type_Axup.getSelectedItem();
      int i = j;
      if (paramBoolean)
      {
        i = j;
                ...
                if (axld.a())
                {
                  ...
                  if (ShortVideoUtils.g())
                  {
                    ...
                    if (!TextUtils.isEmpty(localAIOVideoData.jdField_f_of_type_JavaLangString))
                    {
                      ...
                      localObject = this.mContext.getString(2131692981);
                      ...
                      {
                        azmj.b(null, "dc00898", "", "", "0X800A91E", "0X800A91E", 2, 0, "", "", localAIOVideoData.jdField_f_of_type_JavaLangString, "");
  ...
  public void h()
  {
    ...
    {
      Object localObject = this.mContext.getString(2131720109);
      localObject = bdcd.a(this.mContext, 230, null, (String)localObject, 2131694804, 2131721490, new axwk(this), new axwl(this));
      this.jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView.pause();
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131373464: 
      ...
      do
      {
        do
        {
          ...
          for (;;)
          {
            this.jdField_a_of_type_Axup.g();
            this.jdField_a_of_type_Axup.a().b();
            this.jdField_a_of_type_Axup.a().jdField_a_of_type_Boolean = false;
            this.jdField_a_of_type_Axup.a().a();
            return;
            a(this.jdField_a_of_type_Axup.getCurrentPosition());
          }
          paramView = this.jdField_a_of_type_Axup.getSelectedItem();
        ...
        this.jdField_a_of_type_Axup.a(paramView.jdField_a_of_type_Long, paramView.jdField_a_of_type_Int, 0);
        updateUI();
        return;
        m();
        this.jdField_a_of_type_Axup.i();
        return;
        d();
        return;
        c();
        ...
        paramView = this.jdField_a_of_type_Axup.a();
        if (paramView != null) {
          if (this.jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView == null) {
            break label328;
          }
    ...
    if ((this.mContext instanceof AIOGalleryActivity))
    {
      ...
      {
        if (!ammv.a(this.mContext))
        {
          paramView.requestPermissions(new axwh(this), 3, new String[] { "android.permission.READ_EXTERNAL_STORAGE", "android.permission.WRITE_EXTERNAL_STORAGE" });
          return;
        }
        l();
        return;
  ...
  public View onCreateView(int paramInt, RichMediaBrowserInfo paramRichMediaBrowserInfo)
  {
    ...
    if ((paramRichMediaBrowserInfo != null) && (paramRichMediaBrowserInfo.baseData != null) && (paramRichMediaBrowserInfo.baseData.getType() == 101))
    {
      ...
      paramRichMediaBrowserInfo = new axuf().a((AIOVideoData)localObject, 0);
      ...
      this.jdField_a_of_type_Axup.b.put(Integer.valueOf(paramInt), paramRichMediaBrowserInfo);
  ...
  {
    this.jdField_a_of_type_Axup.b.remove(Integer.valueOf(paramInt));
  }
  ...
  {
    paramAdapterView = this.jdField_a_of_type_Axup.getItem(paramInt);
    ...
    do
    {
      ...
      if (!a(((DragGallery)this.jdField_a_of_type_Axup.getGallery()).getSingleTapConfirmedEvent())) {
        break;
      }
    ...
    if (this.jdField_a_of_type_Axup.b())
    {
      if (this.jdField_a_of_type_Axup.a().jdField_a_of_type_Boolean)
      {
        this.jdField_a_of_type_Axup.a().jdField_a_of_type_Boolean = false;
        this.jdField_a_of_type_Axup.a().a();
        e();
      ...
      for (;;)
      {
        this.jdField_a_of_type_Axup.a().f();
        return;
        this.jdField_a_of_type_Axup.a().b();
        this.jdField_a_of_type_Axup.a().jdField_a_of_type_Boolean = true;
        d(true);
      }
    }
    this.jdField_a_of_type_Axup.back();
  ...
  public void onItemSelected(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    if ((this.jdField_a_of_type_Axup != null) && (this.jdField_a_of_type_Axup.b(paramInt))) {
      a(paramInt);
    }
    for (;;)
    {
  ...
  {
    if ((paramInt == this.jdField_a_of_type_Axup.getCurrentPosition()) && (this.jdField_a_of_type_Axup.a(paramInt)))
    {
    ...
    this.jdField_a_of_type_Axup.a(false);
  }
  ...
  public void onStopTrackingTouch(SeekBar paramSeekBar)
  {
    ...
    if ((this.jdField_a_of_type_Axup.a() != null) && (this.jdField_a_of_type_Axup.a(this.jdField_a_of_type_Axup.getCurrentPosition())) && (paramSeekBar != null))
    {
      BrowserLogHelper.getInstance().getGalleryLog().d("AIOVideoView", 4, "seek danmaku");
      this.jdField_a_of_type_Axup.a().a(paramSeekBar.getProgress());
      AIOVideoData localAIOVideoData = this.jdField_a_of_type_Axup.a();
      if (localAIOVideoData != null) {
        this.jdField_a_of_type_Axup.a().a(axts.a(localAIOVideoData.jdField_d_of_type_Long, paramSeekBar.getProgress(), this.jdField_a_of_type_Axup.a(), this.jdField_a_of_type_Axup.a));
      }
    }
  }
  ...
  {
    if ((paramView != null) && ((paramView.getTag() instanceof axwo)))
    {
      paramView = ((axwo)paramView.getTag()).jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView;
      paramRichMediaBrowserInfo = (URLDrawable)this.jdField_a_of_type_Axup.mActiveDrawable.get(Integer.valueOf(paramInt));
      if (paramRichMediaBrowserInfo != null)
      {
    ...
    paramView.setCoverDrawable(baul.a);
  ...
  public void updateUI()
  {
    ...
    AIOVideoData localAIOVideoData = a();
    b(b());
    c(a(this.jdField_a_of_type_Axup.getSelectedItem()));
    g(true);
    ...
    case 2: 
      this.jdField_a_of_type_Axup.onLoadFinish(this.jdField_a_of_type_Axup.getSelectedIndex(), true);
      this.jdField_d_of_type_AndroidWidgetTextView.setText(alpo.a(2131700444) + localAIOVideoData.progress + "%");
      ...
      return;
    case 4: 
      this.jdField_a_of_type_Axup.onLoadStart(this.jdField_a_of_type_Axup.getSelectedIndex(), localAIOVideoData.progress);
      e(false);
      this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
      f(false);
      this.jdField_b_of_type_AndroidWidgetLinearLayout.setVisibility(8);
  ...
  {
    Object localObject2 = this.jdField_a_of_type_Axup.getItem(paramInt);
    if ((localObject2 == null) || (((RichMediaBrowserInfo)localObject2).baseData == null) || (paramView == null)) {
      return;
    }
    if ((paramView.getTag() instanceof axwo))
    {
      Object localObject1 = ((axwo)paramView.getTag()).jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView;
      if (((RichMediaBrowserInfo)localObject2).baseData.getType() == 101)
      {
        ...
        this.jdField_a_of_type_Axup.a(((AIOVideoData)localObject2).jdField_a_of_type_JavaLangString, ((AIOVideoData)localObject2).jdField_e_of_type_Int, ((AIOVideoData)localObject2).jdField_f_of_type_Int, ((BaseVideoView)localObject1).getCoverImage(), paramInt);
        if (this.jdField_a_of_type_Boolean)
        {
          localObject1 = this.jdField_a_of_type_Axup.a((AIOVideoData)localObject2);
