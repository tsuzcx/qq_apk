  ...
  protected void j(boolean paramBoolean, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        atrj.a(this.a, false, localArrayList);
        return;
      ...
      catch (Exception paramObject)
      {
        ...
        if ((!TextUtils.isEmpty((CharSequence)localObject)) && (!((String)localObject).equals(atrj.a(this.a))))
        {
          QLog.i("TroopFileSearchEngine<QFile>", 1, "keyword is update, current result is old");
          return;
        }
        atrj.b(this.a, paramObject.bytes_sync_cookie.get().toStringUtf8());
        localObject = this.a;
      ...
      paramBoolean = true;
      atrj.b((atrj)localObject, paramBoolean);
      if (QLog.isDevelopLevel())
      {
        localObject = new StringBuilder();
        ((StringBuilder)localObject).append("onRspTroopFileSearch cookie = " + atrj.b(this.a));
        ((StringBuilder)localObject).append(", isEnd = " + atrj.c(this.a));
    ...
    for (;;)
    {
      ...
      {
        localObject = new bfmo(atrj.a(this.a), (cmd0x383.ApplyFileSearchRspBody.Item)paramObject.get(i));
        bgjh localbgjh;
        bfif localbfif;
        if (((bfmo)localObject).jdField_a_of_type_Bfif != null)
        {
          localbgjh = bgjh.a(atrj.a(this.a), ((bfmo)localObject).jdField_a_of_type_Long);
          localbfif = localbgjh.a(((bfmo)localObject).jdField_a_of_type_Bfif.b);
          if (localbfif == null) {
            break label717;
          }
        }
        label717:
        for (((bfmo)localObject).jdField_a_of_type_Bfif.a = localbfif.a;; ((bfmo)localObject).jdField_a_of_type_Bfif.a = UUID.randomUUID())
        {
          localbgjh.a(((bfmo)localObject).jdField_a_of_type_Bfif.b, ((bfmo)localObject).jdField_a_of_type_Bfif);
          if (QLog.isColorLevel()) {
            QLog.d("TroopFileSearchEngine<QFile>", 4, "fileList[" + i + "]: " + ((bfmo)localObject).toString());
          }
      ...
      atrj.a(this.a, true, localArrayList);
      return;
      paramBoolean = false;
      break;
      label747:
