  ...
  extends zqp
{
  ...
  private ArrayList<zqq> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private ConcurrentHashMap<Long, zqr> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap(20);
  private ConcurrentHashMap<Long, Long> b = new ConcurrentHashMap(10);
  
  public ztj(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
  }
  
  private long a(MessageForDeviceFile paramMessageForDeviceFile, View paramView, apae paramapae)
  {
    long l1;
    ...
    {
      zqq localzqq = (zqq)localIterator.next();
      if (localzqq.a() == paramView) {
        localzqq.b = new WeakReference(paramapae);
      }
    }
    for (int i = 1;; i = 0)
    {
      if (i == 0) {
        this.jdField_a_of_type_JavaUtilArrayList.add(new zqq(this, paramView, paramapae));
      }
  ...
  private MessageRecord a(long paramLong1, long paramLong2, JSONObject paramJSONObject)
  {
    ...
    MessageForDevPtt localMessageForDevPtt = (MessageForDevPtt)ayvw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, Long.toString(paramLong2), null, 9501);
    ...
    localMessageForDevPtt.time = ayvc.a();
    localMessageForDevPtt.msg = (bdbt.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForDevPtt.senderuin, true) + ": " + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691351));
  ...
  private void a(long paramLong1, String paramString, int paramInt, long paramLong2)
  {
    ...
    {
      paramString = new zqr(this, paramString, paramInt, paramLong2);
  ...
  private MessageRecord b(long paramLong1, long paramLong2, JSONObject paramJSONObject)
  {
    ...
    MessageForDeviceFile localMessageForDeviceFile = (MessageForDeviceFile)ayvw.a(-4500);
    localMessageForDeviceFile.strServiceName = ztk.d;
    ...
    localMessageForDeviceFile.time = ayvc.a();
    localMessageForDeviceFile.msg = (bdbt.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForDeviceFile.senderuin, true) + ": " + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691650));
  ...
  private void b(MessageRecord paramMessageRecord)
  {
    ...
    {
      Object localObject = (zqq)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      View localView = ((zqq)localObject).a();
      localObject = ((zqq)localObject).a();
      if ((localView != null) && (localObject != null))
      {
        j = i;
        if ((paramMessageRecord instanceof MessageForDeviceFile)) {
          ((apae)localObject).a(localView, (MessageForDeviceFile)paramMessageRecord);
        }
      }
      for (int j = i;; j = i - 1)
      {
  ...
  public long a(MessageRecord paramMessageRecord, View paramView, apae paramapae)
  {
    if ((paramMessageRecord instanceof MessageForDeviceFile)) {
      return a((MessageForDeviceFile)paramMessageRecord, paramView, paramapae);
    }
    return 0L;
  }
  ...
  {
    Object localObject1 = (zqr)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong));
    ...
    do
    {
      ...
      localObject2 = ((QQAppInterface)localObject2).a().a(((zqr)localObject1).jdField_a_of_type_JavaLangString, ((zqr)localObject1).jdField_a_of_type_Int, ((zqr)localObject1).jdField_a_of_type_Long);
  ...
  public void a(Session paramSession, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        this.b.put(Long.valueOf(localMessageRecord.uniseq), Long.valueOf(ayvc.a()));
      }
    } while (!QLog.isColorLevel());
