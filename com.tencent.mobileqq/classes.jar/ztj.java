...
public class ztj
  extends zou<SubscribeDraftBean>
  implements SimpleEventReceiver
{
  ...
  public void c()
  {
    if ((a() != null) && (a() != null) && (((PublicFragmentActivity)a()).app != null))
    {
      ...
      if (zzf.a().a(this.jdField_b_of_type_JavaLangString)) {
        zzf.a().a(this.jdField_b_of_type_JavaLangString, new ztk(this));
      }
    }
    else
    {
  ...
  {
    if ((paramViewHolder instanceof ztl)) {
      ((ztl)paramViewHolder).a((SubscribeDraftBean)a().get(paramInt));
    }
  ...
  {
    return new ztl(this, new SubScribeDraftItemView(paramViewGroup.getContext(), this));
  }
