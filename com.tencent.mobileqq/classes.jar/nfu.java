...
public class nfu
  implements Runnable
{
  public nfu(ReportEvilToXinanHandler paramReportEvilToXinanHandler, boolean paramBoolean, String paramString1, String paramString2, String paramString3, String paramString4) {}
  ...
  public void run()
  {
    ...
    for (String str1 = "1";; str1 = "0")
    {
      ...
      String str3 = this.b;
      str4 = MD5Utils.d("android" + "_" + "7.6.3" + "_" + "1111" + "_" + str4);
      ...
      ((Bundle)localObject1).putString("version", "7.6.3");
