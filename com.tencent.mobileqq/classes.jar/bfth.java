...
public class bfth
{
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, List<String> paramList, long paramLong)
  {
    ...
    return;
    Object localObject = anni.a(2131718788);
    String str2 = anni.a(2131718786);
    String str1 = anni.a(2131718787);
    str2 = (String)localObject + " " + str2 + " " + str1;
    paramString1 = new auxc(paramString1, paramString2, str2, 1, -5040, 131086, System.currentTimeMillis() / 1000L);
    ...
    i = BaseApplicationImpl.getApplication().getResources().getColor(2131167252);
