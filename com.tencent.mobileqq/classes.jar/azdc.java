  ...
  extends Handler
{
  ...
  public void handleMessage(Message paramMessage)
  {
      ...
      do
      {
        do
        {
          do
          {
            do
            {
              do
              {
                do
                {
                  ...
                  bcpw.a(this.a, "最多只能选择9张图片", 0).b(this.a.getTitleBarHeight());
                  return;
                  this.a.c(false);
            ...
            {
              this.a.requestPermissions(new azdd(this), 1, new String[] { "android.permission.RECORD_AUDIO" });
              return;
            }
            ...
            if (this.a.q != null)
            {
              ...
              bair.a(this.a.o, this.a.p, "Clk_record", this.a.q, this.a.jdField_b_of_type_JavaLangString, "", "");
            }
            abtu.a(this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, paramMessage, PublicTransFragmentActivity.class, AudioRecordFragment.class, 1003);
            return;
          } while (!this.a.a(4));
          return;
          ...
          this.a.jdField_a_of_type_AndroidWidgetImageButton.setImageResource(2130842975);
          this.a.jdField_a_of_type_AndroidWidgetImageButton.setContentDescription(this.a.getString(2131696542));
          this.a.jdField_a_of_type_AndroidViewViewGroup.setVisibility(8);
          bfmr.b(this.a.jdField_b_of_type_ComTencentMobileqqTribeViewTEditText);
    ...
    {
      this.a.jdField_a_of_type_Azga.a(this.a.jdField_a_of_type_JavaUtilArrayList);
      paramMessage = this.a.jdField_a_of_type_Azga;
      if (this.a.jdField_a_of_type_JavaUtilArrayList.size() < 9) {
        bool = true;
      }
    ...
    this.a.jdField_a_of_type_Azga.a(false, true);
    this.a.jdField_a_of_type_ComTencentMobileqqTroopDataAudioInfo = null;
    this.a.a(0);
