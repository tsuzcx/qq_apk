  ...
  implements Manager
{
  ...
  private altm jdField_a_of_type_Altm = new atew(this);
  private atex jdField_a_of_type_Atex = new atev(this);
  ...
  public ateu(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_JavaUtilHashMap = new HashMap();
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.registObserver(this.jdField_a_of_type_Atex);
  ...
  private OpenIdItem a(OpenIdItem paramOpenIdItem, boolean paramBoolean)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 46	ateu:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   144: areturn
    //   145: aload_0
    //   146: getfield 46	ateu:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   149: aload_1
    ...
    for (;;)
    {
      try
      {
        ...
        if (localObject1 != null)
        {
          ...
          atey.a(paramLong1, paramLong2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          continue;
        }
        String str = "";
      }
  ...
  public void a(long paramLong1, long paramLong2, String paramString)
  {
    ...
    //   52: aload_0
    //   53: getfield 41	ateu:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   56: lload_1
    ...
    //   84: astore 6
    //   86: aload_0
    //   87: getfield 41	ateu:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   90: lload_1
    ...
    //   99: pop
    //   100: aload_0
    //   101: getfield 36	ateu:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   104: invokevirtual 197	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lawgg;
    //   107: invokevirtual 203	awgg:createEntityManager	()Lawgf;
    //   110: astore 7
    //   112: aload 6
    //   114: lload_3
    ...
    //   153: aload 6
    //   155: iconst_1
    //   156: invokespecial 64	ateu:a	(Lcom/tencent/mobileqq/intervideo/singtogether/OpenIdItem;Z)Lcom/tencent/mobileqq/intervideo/singtogether/OpenIdItem;
    //   159: astore 5
    //   161: aload 5
    ...
    //   172: aload 7
    //   174: aload 5
    //   176: invokevirtual 213	awgf:a	(Lawge;)V
    //   179: aload 7
    //   181: invokevirtual 215	awgf:a	()V
    //   184: aload_0
    //   185: monitorexit
    //   186: return
    //   187: aload 7
    //   189: aload 5
    //   191: invokevirtual 218	awgf:a	(Lawge;)Z
    //   194: pop
    //   195: goto -16 -> 179
    //   198: astore 5
    //   200: aload_0
  ...
  public boolean a(long paramLong1, long paramLong2)
  {
    ...
    //   4: monitorenter
    //   5: aload_0
    //   6: getfield 41	ateu:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   9: lload_1
    ...
    //   50: istore 5
    //   52: aload_0
    //   53: getfield 46	ateu:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   166: aload_0
    //   167: getfield 46	ateu:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   170: aload 7
    //   172: invokeinterface 224 2 0
    //   177: pop
    //   178: aload_0
    //   179: getfield 36	ateu:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   182: invokevirtual 197	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lawgg;
    //   185: invokevirtual 203	awgg:createEntityManager	()Lawgf;
    //   188: astore 8
    //   190: aload 8
    //   192: aload 7
    //   194: invokevirtual 226	awgf:b	(Lawge;)Z
    //   197: pop
    //   198: aload 8
    //   200: invokevirtual 215	awgf:a	()V
    //   203: aload_0
    //   204: monitorexit
    //   205: iload 5
    //   207: ireturn
  ...
  public void onDestroy()
  {
    try
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.unRegistObserver(this.jdField_a_of_type_Atex);
