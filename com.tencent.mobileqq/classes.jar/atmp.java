...
public class atmp
{
  ...
  private atmr jdField_a_of_type_Atmr;
  ...
  atmp(ajrl paramajrl, String paramString)
  {
  ...
  /* Error */
  private List<? extends atmo> a(Class<? extends atmo> paramClass, String paramString1, boolean paramBoolean, String paramString2, String[] paramArrayOfString, String paramString3, String paramString4, String paramString5, String paramString6, atmz paramatmz, int paramInt)
  {
    // Byte code:
    //   0: aload_0
    //   1: iload_3
    ...
    //   12: aload 8
    //   14: aload 9
    //   16: invokevirtual 55	atmp:a	(ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   19: astore 5
    //   21: aload 5
    //   23: ifnull +122 -> 145
    //   26: new 57	atmi
    //   29: dup
    //   30: aload 5
    //   32: invokespecial 60	atmi:<init>	(Landroid/database/Cursor;)V
    //   35: astore 4
    //   37: aload 4
    //   39: astore 5
    //   41: aload_0
    ...
    //   44: aload 4
    //   46: aload 10
    //   48: invokevirtual 63	atmp:a	(Ljava/lang/Class;Ljava/lang/String;Landroid/database/Cursor;Latmz;)Ljava/util/List;
    //   51: astore_1
    //   52: aload 4
    //   54: ifnull +10 -> 64
    //   57: aload 4
    ...
    //   0	154	0	this	atmp
    //   0	154	1	paramClass	Class<? extends atmo>
  ...
  private boolean a(String paramString, atmo paramatmo, boolean paramBoolean)
  {
    ...
    for (boolean bool2 = ((Boolean)jdField_a_of_type_JavaUtilMap.get(str)).booleanValue();; bool2 = false)
    {
      ...
      {
        return bool1;
        bool2 = this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a(atnp.a(paramatmo));
        paramatmo = atnp.b(paramatmo);
        if (paramatmo != null) {
          this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a(paramatmo);
        }
  ...
  {
    return this.jdField_a_of_type_Ajrl.a().a(paramString1, paramString2, paramArrayOfString);
  }
  
  protected ContentValues a(atmo paramatmo)
  {
    List localList = atnp.a(paramatmo.getClassForTable());
    ...
    if (i < j)
    {
      ...
      localObject = ((Field)localObject).get(paramatmo);
  ...
  public Cursor a(boolean paramBoolean, String paramString1, String[] paramArrayOfString1, String paramString2, String[] paramArrayOfString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    try
    {
      if (d(paramString1))
      {
        paramString1 = this.jdField_a_of_type_Ajrl.b().a(paramString1, paramArrayOfString1, paramString2, paramArrayOfString2, paramString5, paramString6);
        return paramString1;
      }
    }
  ...
  public atmo a(Class<? extends atmo> paramClass, long paramLong)
  {
    try
    {
      paramClass = a(paramClass, atnp.a(paramClass), false, "_id=?", new String[] { String.valueOf(paramLong) }, null, null, null, null, null, 3);
      if (paramClass != null) {
        return (atmo)paramClass.get(0);
      }
    }
  ...
  public atmo a(Class<? extends atmo> paramClass, Cursor paramCursor)
  {
    try
    {
      paramClass = a(paramClass, atnp.a(paramClass), paramCursor);
      return paramClass;
    }
  ...
  public atmo a(Class<? extends atmo> paramClass, String paramString)
  {
    Object localObject = atnp.a(paramClass);
    int j = ((List)localObject).size();
    int i = 0;
    while (i < j)
    {
      Field localField = (Field)((List)localObject).get(i);
      if (localField.isAnnotationPresent(atoc.class))
      {
        localObject = localField.getName();
        localObject = (String)localObject + "=?";
        try
        {
          paramClass = a(paramClass, atnp.a(paramClass), false, (String)localObject, new String[] { paramString }, null, null, null, null, null, 3);
  ...
  public atmo a(Class<? extends atmo> paramClass, String paramString, Cursor paramCursor)
  {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (localatmo != null)
          {
            ...
            if (atmo.class.isAssignableFrom(localClass))
            {
              localObject = a(localClass, paramCursor);
              ((atmo)localObject)._status = 1002;
              localField.set(localatmo, localObject);
            }
            localObject = localField.getName();
        ...
        else
        {
          ...
          if (localClass == Double.TYPE)
          {
            ...
            if (paramatmz != null)
            {
              paramatmz.a(new NoColumnError((String)localObject, localClass));
              break label568;
              if ((l != -1L) && (paramString != null)) {}
              for (localatmo._status = 1001;; localatmo._status = 1002)
              {
                localatmo.postRead();
                return localatmo;
              }
  ...
  public atmo a(Class<? extends atmo> paramClass, String paramString, String[] paramArrayOfString)
  {
  ...
  public atmo a(Class<? extends atmo> paramClass, String... paramVarArgs)
  {
    ...
    try
    {
      paramClass = a(paramClass, atnp.a(paramClass), false, localStringBuffer.toString(), paramVarArgs, null, null, null, null, null, 3);
      if (paramClass != null) {
        return (atmo)paramClass.get(0);
      }
    }
  ...
  public atmr a()
  {
    if (this.jdField_a_of_type_Atmr == null) {
      this.jdField_a_of_type_Atmr = new atmr(this.jdField_a_of_type_Ajrl);
    }
    return this.jdField_a_of_type_Atmr;
  }
  
  public List<? extends atmo> a(Class<? extends atmo> paramClass)
  {
    try
    {
      paramClass = a(paramClass, atnp.a(paramClass), false, null, null, null, null, null, null, null, 2);
      return paramClass;
    }
    catch (InstantiationException paramClass)
    {
  ...
  public List<? extends atmo> a(Class<? extends atmo> paramClass, String paramString, Cursor paramCursor)
  {
    return a(paramClass, paramString, paramCursor, null);
  }
  
  public List<? extends atmo> a(Class<? extends atmo> paramClass, String paramString, Cursor paramCursor, atmz paramatmz)
  {
    localObject4 = null;
  ...
  /* Error */
  public List<? extends atmo> a(Class<? extends atmo> paramClass, String paramString1, String paramString2, String paramString3, String[] paramArrayOfString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 6
    ...
    //   4: astore 7
    //   6: aload_0
    //   7: getfield 33	atmp:jdField_a_of_type_Ajrl	Lajrl;
    //   10: invokevirtual 235	ajrl:b	()Lcom/tencent/mobileqq/app/SQLiteDatabase;
    //   13: aload_2
    //   14: aload_3
    //   15: aload 4
    //   17: aload 5
    ...
    //   34: aconst_null
    //   35: aload_2
    //   36: invokevirtual 473	atmp:a	(Ljava/lang/Class;Ljava/lang/String;Landroid/database/Cursor;)Ljava/util/List;
    //   39: astore_1
    //   40: aload_1
    //   41: astore_3
    //   42: aload_3
    ...
    //   start	length	slot	name	signature
    //   0	119	0	this	atmp
    //   0	119	1	paramClass	Class<? extends atmo>
  ...
  public List<? extends atmo> a(Class<? extends atmo> paramClass, String paramString1, boolean paramBoolean, String paramString2, String[] paramArrayOfString, String paramString3, String paramString4, String paramString5, String paramString6)
  {
  ...
  public List<? extends atmo> a(Class<? extends atmo> paramClass, String paramString1, boolean paramBoolean, String paramString2, String[] paramArrayOfString, String paramString3, String paramString4, String paramString5, String paramString6, atmz paramatmz)
  {
    return a(paramClass, paramString1, paramBoolean, paramString2, paramArrayOfString, paramString3, paramString4, paramString5, paramString6, paramatmz, 1);
  }
  
  /* Error */
  public List<? extends atmo> a(Class<? extends atmo> paramClass, String paramString, String[] paramArrayOfString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 4
    ...
    //   30: aconst_null
    //   31: aload_2
    //   32: invokevirtual 473	atmp:a	(Ljava/lang/Class;Ljava/lang/String;Landroid/database/Cursor;)Ljava/util/List;
    //   35: astore_1
    //   36: aload_1
    //   37: astore_3
    //   38: aload_3
    ...
    //   start	length	slot	name	signature
    //   0	157	0	this	atmp
    //   0	157	1	paramClass	Class<? extends atmo>
  ...
  public List<? extends atmo> a(Class<? extends atmo> paramClass, boolean paramBoolean, String paramString1, String[] paramArrayOfString, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    try
    {
      paramString1 = a(paramClass, atnp.a(paramClass), paramBoolean, paramString1, paramArrayOfString, paramString2, paramString3, paramString4, paramString5);
      return paramString1;
    }
    catch (Exception paramString1)
    {
  ...
  public void a(atmo paramatmo)
  {
    ...
    catch (Throwable paramatmo)
    {
      while (!QLog.isColorLevel()) {}
      QLog.e("EntityManager", 2, "persist error", paramatmo);
    }
  }
  ...
  protected void a(atmo paramatmo, boolean paramBoolean)
  {
    ...
    String str;
    if (paramatmo._status == 1000)
    {
      str = paramatmo.getTableName();
      a(str, paramatmo, false);
      paramatmo.prewrite();
    }
    for (;;)
    {
      try
      {
        localContentValues = a(paramatmo);
        if (!paramBoolean) {
          continue;
        }
  ...
  public boolean a(atmo paramatmo)
  {
    ...
    try
    {
      if ((paramatmo._status == 1001) || (paramatmo._status == 1002))
      {
        ContentValues localContentValues = a(paramatmo);
        int i = this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a(paramatmo.getTableName(), localContentValues, "_id=?", new String[] { String.valueOf(paramatmo._id) });
        return i > 0;
      }
    }
    catch (Exception localException)
  ...
  public boolean a(atmo paramatmo, String paramString, String[] paramArrayOfString)
  {
    boolean bool1 = false;
    boolean bool2 = false;
    if (this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase == null) {
    ...
    paramatmo.prewrite();
    if (paramatmo._status == 1001)
    {
      bool1 = bool2;
      if (this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a(paramatmo.getTableName(), paramString, paramArrayOfString) > 0) {
        bool1 = true;
      }
      paramatmo._status = 1003;
    }
    paramatmo.postwrite();
    return bool1;
  }
  
  public boolean a(Class<? extends atmo> paramClass)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase == null) {
      this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase = this.jdField_a_of_type_Ajrl.a();
    }
  ...
  public void b(atmo paramatmo)
  {
    ...
    {
      while (!QLog.isColorLevel()) {}
      QLog.e("EntityManager", 2, "persistOrReplace error", paramatmo);
    }
  }
  ...
  public boolean b(atmo paramatmo)
  {
    ...
    paramatmo.prewrite();
    if (paramatmo._status == 1001) {
      if (this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a(paramatmo.getTableName(), "_id=?", new String[] { String.valueOf(paramatmo._id) }) > 0) {
        paramatmo._status = 1003;
      }
    }
    for (;;)
  ...
  public boolean b(String paramString)
  {
    try
    {
      this.jdField_a_of_type_Ajrl.b().a(paramString);
      return true;
    }
    catch (Exception paramString)
    {
  ...
  public boolean d(String paramString)
  {
    ...
    do
    {
      ...
      localSQLiteDatabase = this.jdField_a_of_type_Ajrl.b();
