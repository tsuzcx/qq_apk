  ...
  implements lwx
{
  ...
  public static lwx a(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("com.tencent.av.service.IQQServiceCallback");
    if ((localIInterface != null) && ((localIInterface instanceof lwx))) {
      return (lwx)localIInterface;
    }
    return new lwz(paramIBinder);
  }
