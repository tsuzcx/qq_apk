  ...
  implements ual
{
  ...
  private bhod jdField_a_of_type_Bhod;
  ...
  private List<twm> jdField_b_of_type_JavaUtilList;
  private String c;
  
  public uat(pzs parampzs, aanz paramaanz)
  {
    this.jdField_a_of_type_Pzs = parampzs;
    this.jdField_a_of_type_Bhod = parampzs.mRuntime;
    this.jdField_a_of_type_Aanz = paramaanz;
    this.jdField_a_of_type_AndroidAppActivity = a();
    this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView = this.jdField_a_of_type_Bhod.a();
    parampzs = this.jdField_a_of_type_Bhod.a(this.jdField_a_of_type_Bhod.a());
    if ((parampzs != null) && ((parampzs instanceof bhsx))) {
      this.jdField_a_of_type_Bhsx = ((bhsx)parampzs);
    }
    parampzs = this.jdField_a_of_type_Bhod.a(this.jdField_a_of_type_Bhod.a());
    if ((parampzs != null) && ((parampzs instanceof bhsl))) {
      this.jdField_a_of_type_Bhsl = ((bhsl)parampzs);
    }
  }
  ...
  private List<Integer>[] a()
  {
    ...
    while (((Iterator)localObject).hasNext()) {
      localArrayList1.add(Integer.valueOf(((twm)((Iterator)localObject).next()).a));
    }
    ArrayList localArrayList2 = new ArrayList();
    localObject = this.jdField_b_of_type_JavaUtilList.iterator();
    while (((Iterator)localObject).hasNext()) {
      localArrayList2.add(Integer.valueOf(((twm)((Iterator)localObject).next()).a));
    }
    ...
    for (;;)
    {
      ...
      label152:
      localObject = this.jdField_a_of_type_Uba.c;
      break;
      label163:
  ...
  private void b()
  {
    ...
    if (this.jdField_a_of_type_Long != -1L) {
      this.jdField_b_of_type_JavaUtilList.add(2, new twm("fav_move_group", 39, false));
    }
  }
  ...
  private void e()
  {
    String str1 = this.jdField_a_of_type_Uba.a;
    String str2 = this.jdField_a_of_type_Uba.jdField_b_of_type_JavaLangString;
    String str3 = this.jdField_a_of_type_Uba.d;
    String str4 = this.jdField_a_of_type_Bhod.a().uin;
    String str5 = this.jdField_a_of_type_Uba.f;
    bljl.a(0, str1, this.jdField_a_of_type_Uba.c, str5, str2, str3, null, null, false, -1L).a("lCategory", 8L).c(str4).a(this.jdField_a_of_type_Bhod.a(), str4);
  }
  
  private void f()
  {
    Object localObject1 = Pattern.compile("(http|https)://.*.mp.qq.com.*").matcher(this.jdField_a_of_type_Uba.c);
    int i = 0;
    ...
    try
    {
      localObject1 = URLEncoder.encode(this.jdField_a_of_type_Uba.c, "UTF-8");
      str2 = this.jdField_a_of_type_Bhod.a().uin;
      if (i != 0)
      {
        String str3 = String.valueOf(NetConnInfoCenter.getServerTime());
        String str1 = bita.b((String)localObject1 + 200 + str3 + "jubao@article@123");
        localObject3 = str1;
        if (str1 != null)
        {
          localObject3 = str1;
        ...
        str1 = this.jdField_a_of_type_Bhod.a().publicUin;
  ...
  Activity a()
  {
    for (Activity localActivity = this.jdField_a_of_type_Bhod.a(); (localActivity != null) && ((localActivity instanceof BasePluginActivity)); localActivity = ((BasePluginActivity)localActivity).getOutActivity()) {}
  ...
  {
    this.jdField_a_of_type_Bhod.a().getSettings().setTextZoom(bhpv.a[paramInt]);
    this.jdField_a_of_type_Aanz.a(paramInt);
  }
  ...
  public void a(String paramString)
  {
    if (this.jdField_a_of_type_Uai == null) {
      this.jdField_a_of_type_Uai = new uai(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Bhod.a(), new uay(this));
    }
    this.jdField_a_of_type_Uai.a().setActionSheetTitle("biu出去让更多好友看到");
    this.jdField_a_of_type_Uai.a().setCancelListener(new uau(this));
    for (;;)
    {
      try
      {
        ...
        {
          this.jdField_a_of_type_JavaUtilList = uai.b();
          if (localJSONArray2 == null)
          {
            this.jdField_b_of_type_JavaUtilList = uai.c();
            b();
            this.jdField_a_of_type_Uba = new uba(null);
            this.jdField_a_of_type_Uba.c = paramString.optString("share_url");
            this.jdField_a_of_type_Uba.jdField_b_of_type_JavaLangString = paramString.optString("desc");
            this.jdField_a_of_type_Uba.a = paramString.optString("title");
            this.jdField_a_of_type_Uba.d = paramString.optString("image_url");
            this.jdField_a_of_type_Uba.e = paramString.optString("puin");
            this.jdField_a_of_type_Uba.f = paramString.optString("nick_name");
            if (TextUtils.isEmpty(this.jdField_a_of_type_Uba.f)) {
              this.jdField_a_of_type_Uba.f = paramString.optString("sourceName");
            }
            this.jdField_b_of_type_JavaLangString = paramString.optString("callback");
            int i = paramString.optInt("report_from");
            this.jdField_a_of_type_Uai.a(a(), i);
          }
        }
        else
        {
          this.jdField_a_of_type_JavaUtilList = uai.a(localJSONArray1, null);
          continue;
        }
        this.jdField_b_of_type_JavaUtilList = uai.a(localJSONArray2, null);
      }
      catch (JSONException paramString)
      {
        paramString.printStackTrace();
  ...
  void a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    catch (Exception paramString2)
    {
      do
      {
        paramString2 = this.jdField_a_of_type_Bhod.a();
  ...
  void a(JSONObject paramJSONObject, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    paramString1.putLong("share_begin_time", bhpv.jdField_b_of_type_Long);
    if (this.jdField_a_of_type_Bhsx != null)
    {
      paramString1.putString("struct_url", this.jdField_a_of_type_Bhsx.getCurrentUrl());
      paramString1.putBoolean("from_web", true);
    }
    if (this.jdField_a_of_type_Bhsl != null) {
      i = this.jdField_a_of_type_Bhsl.switchRequestCode(this.jdField_a_of_type_Pzs, (byte)2, true);
    }
    bltb.a(this.jdField_a_of_type_Bhod.a(), this.jdField_a_of_type_AndroidAppActivity, paramString1, null, i);
  }
  ...
  public void a(JSONObject paramJSONObject, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      localIntent.putExtra("brief_key", BaseApplicationImpl.getContext().getString(2131695697, new Object[] { paramString5 }));
      ...
      if (paramJSONObject.has("serviceID"))
      {
        ...
        if ((paramInt == 116) || (paramInt == 123)) {
          localIntent.putExtra("compatible_text", aqjq.a);
        }
      }
      ...
      paramJSONObject = this.jdField_a_of_type_Bhod.a();
      if (paramJSONObject != null)
      {
        c();
        localIntent.putExtra("struct_share_key_source_name", Long.toString(l));
        abcr.a(paramJSONObject, this.jdField_a_of_type_AndroidAppActivity, paramJSONObject.getAccount(), l, 3000L, new uav(this, localIntent));
      }
      return;
    ...
    for (;;)
    {
      ...
      {
        paramString2 = this.jdField_a_of_type_Bhod.a().getEntityManagerFactory(this.jdField_a_of_type_Bhod.a().getAccount()).createEntityManager();
      ...
      for (paramString2 = paramString5.name;; paramString2 = null)
      {
        ...
        for (;;)
        {
          if (paramString2.equalsIgnoreCase(this.jdField_a_of_type_AndroidAppActivity.getString(2131698461)))
          {
            boolean bool = paramString2.equalsIgnoreCase(this.jdField_a_of_type_AndroidAppActivity.getString(2131698461));
            if (bool)
            {
          ...
          for (;;)
          {
            ...
            this.jdField_a_of_type_Pzs.startActivityForResult(localIntent, (byte)1);
            return;
            if (paramJSONObject.has("sourceName")) {
            ...
            {
              localIntent.putExtra("app_name", this.jdField_a_of_type_AndroidAppActivity.getString(2131695713));
            }
          }
          paramString2 = paramString3;
        }
