...
public class aieo
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new aiep(this, Looper.getMainLooper());
  ...
  public boolean a()
  {
    ...
    aies localaies = new aies();
    try
    {
      SAXParserFactory.newInstance().newSAXParser().parse(new InputSource(new InputStreamReader(new FileInputStream((File)localObject), "UTF-8")), localaies);
      this.jdField_a_of_type_Int = localaies.a();
      this.jdField_a_of_type_JavaUtilArrayList = localaies.a();
      return true;
    }
