  ...
  extends alko
{
  ...
  Comparator<RecentBaseData> jdField_a_of_type_JavaUtilComparator = new aiep(this);
  ...
  public aieo(QQAppInterface paramQQAppInterface)
  {
  ...
  private List<RecentBaseData> a(List<RecentUser> paramList, List<RecentBaseData> paramList1)
  {
    ...
    if (paramList == null)
    {
      ...
      Object localObject3 = ajeu.a(localRecentUser.uin, localRecentUser.getType());
      localObject2 = ajeu.a().a((String)localObject3);
      localObject1 = localObject2;
      if (localObject2 == null)
      {
        localObject1 = ajdp.a(localRecentUser, this.app, BaseApplicationImpl.getContext());
        if (localObject1 != null) {
          ajeu.a().a((RecentBaseData)localObject1, (String)localObject3);
        }
      }
      if (localObject1 != null)
      {
        ...
        localObject3 = ((behr)this.app.a(107)).a("");
        if ((!((HotChatInfo)localObject2).isGameRoom) && (!((HotChatInfo)localObject2).troopUin.equals(((beih)localObject3).a))) {
          break label241;
        }
      }
    }
  ...
  private void a(List<RecentUser> paramList)
  {
    ...
    for (Object localObject2 = this.app.a(true);; localObject2 = localObject1)
    {
      ...
      {
        localObject2 = ((almv)this.app.getManager(53)).a(str);
  ...
  public void a(String paramString, int paramInt1, int paramInt2)
  {
    if (((paramInt1 == 1) || (paramInt1 == 0) || (paramInt1 == 3000)) && (!a(paramInt2)))
    {
      ...
      if (!TextUtils.isEmpty(paramString)) {
        aieq.a().a(paramString, paramInt1);
      }
    }
  }
