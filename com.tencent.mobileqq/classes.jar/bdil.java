  ...
  public void a(boolean paramBoolean, int paramInt, oidb_0x6d6.DownloadFileRspBody paramDownloadFileRspBody, Bundle paramBundle)
  {
    ...
    if (paramBoolean) {
      if (paramDownloadFileRspBody != null)
      {
        ...
        Object localObject = bgmj.a(paramDownloadFileRspBody.bytes_cookie_val.get().toByteArray());
        paramBundle = (Bundle)localObject;
        if (localObject != null) {
          paramBundle = ((String)localObject).toLowerCase();
        }
        localObject = paramDownloadFileRspBody.str_download_ip.get();
        String str = bgmj.a(paramDownloadFileRspBody.bytes_download_url.get().toByteArray());
        ...
        paramDownloadFileRspBody.append((String)localObject).append("/ftn_handler/").append(str).append("/?fname=").append(bgmj.b(this.a.jdField_a_of_type_ComTencentMobileqqTeamworkTeamWorkFileImportInfo.jdField_d_of_type_JavaLangString));
        try
        {
    ...
    if (((i != 0) || (paramInt != 0)) && (bdho.a(localJSONObject)) && (bdik.a(this.a, localJSONObject)))
    {
      this.a.jdField_a_of_type_Bdia.a(localJSONObject, this.a.jdField_a_of_type_ComTencentMobileqqTeamworkTeamWorkFileImportInfo, this.a.hashCode());
      return;
      for (;;)
      {
        paramInt = 0;
