  ...
  extends BaseAdapter
{
  ...
  public asyj(Context paramContext, Drawable paramDrawable, int paramInt1, int paramInt2, int paramInt3)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_JavaUtilList = new ArrayList(2);
    this.jdField_a_of_type_Int = paramInt1;
    this.b = paramInt2;
    int i = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131167565);
    this.d = paramInt1;
    this.c = (i + paramInt2);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (i == 0)
    {
      ...
      if (paramView == null)
      {
        paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131495325, null);
        localasyk = new asyk();
        localasyk.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)paramViewGroup.findViewById(2131302286));
        localasyk.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131311534));
        paramViewGroup.setTag(localasyk);
      ...
      for (;;)
      {
        ...
        if (localInterestTagInfo != null)
        {
          ...
          if (localasyk != null)
          {
            ...
            localasyk.jdField_a_of_type_ComTencentImageURLImageView.setImageResource(2130840912);
            if ((localInterestTagInfo.tagType == 10) || (localInterestTagInfo.tagType == 11) || (localInterestTagInfo.tagType == 9)) {
              localasyk.jdField_a_of_type_ComTencentImageURLImageView.setImageResource(2130840913);
            }
            localasyk.jdField_a_of_type_AndroidWidgetTextView.setText(localInterestTagInfo.tagName);
            localObject = paramViewGroup;
          }
        }
        label203:
        return localObject;
        localasyk = (asyk)paramView.getTag();
    ...
    for (;;)
    {
      try
      {
        ...
        paramView = URLDrawable.getDrawable(axsk.a(paramView), (URLDrawable.URLDrawableOptions)localObject);
      }
      catch (Exception localException1)
      {
        for (;;)
        {
          try
          {
            if (this.e == 7)
            {
              paramView.setTag(azue.b(this.jdField_a_of_type_Int, this.b, (int)(10.0F * this.jdField_a_of_type_Float)));
              paramView.setDecodeHandler(azue.c);
            }
            paramView.setDownloadListener(new ascs(this.jdField_a_of_type_AndroidContentContext, "actInterestTagPicDownload"));
          }
          ...
          try
          {
            ...
            localURLImageView = localasyk.jdField_a_of_type_ComTencentImageURLImageView;
