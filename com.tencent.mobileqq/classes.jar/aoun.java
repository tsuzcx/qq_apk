  ...
  private void a(Object paramObject)
  {
    ...
    case 3: 
      for (;;)
      {
        ...
        QLog.i("FMObserver<FileAssistant>", 1, "OnFileCome uniseq[" + String.valueOf(l1) + "],nSessionId[" + String.valueOf(l2) + "], strUin[" + apug.e((String)localObject1) + "], peerType[" + String.valueOf(i) + "]");
        ...
        localObject1 = (String)paramObject[3];
        i = ((Integer)paramObject[4]).intValue();
        QLog.i("FMObserver<FileAssistant>", 1, "OnFileTransferStart uniseq[" + String.valueOf(l1) + "],nSessionId[" + String.valueOf(l2) + "], strUin[" + apug.e((String)localObject1) + "], peerType[" + String.valueOf(i) + "]");
        ...
        {
          paramObject = (Object[])paramObject[2];
          localObject1 = new apez();
          ((apez)localObject1).jdField_a_of_type_JavaLangString = ((String)paramObject[0]);
          ((apez)localObject1).jdField_a_of_type_Int = ((Integer)paramObject[1]).intValue();
          ((apez)localObject1).jdField_b_of_type_JavaLangString = ((String)paramObject[2]);
          ((apez)localObject1).jdField_a_of_type_JavaLangObject = paramObject[3];
          QLog.i("FMObserver<FileAssistant>", 1, "OnThumbDownLoadSuccess,fileId[" + ((apez)localObject1).jdField_a_of_type_JavaLangString + "],filePath[" + ((apez)localObject1).jdField_b_of_type_JavaLangString + "]");
          if ((((apez)localObject1).jdField_a_of_type_JavaLangObject != null) && (((apez)localObject1).jdField_b_of_type_JavaLangString != null) && (((apez)localObject1).jdField_b_of_type_JavaLangString.length() > 0))
          {
            if (!(((apez)localObject1).jdField_a_of_type_JavaLangObject instanceof WeiYunFileInfo)) {
              break label3135;
            }
            ((WeiYunFileInfo)((apez)localObject1).jdField_a_of_type_JavaLangObject).h = ((apez)localObject1).jdField_b_of_type_JavaLangString;
          }
          for (;;)
          {
            a((apez)localObject1);
            return;
            if ((((apez)localObject1).jdField_a_of_type_JavaLangObject instanceof OfflineFileInfo)) {
              ((OfflineFileInfo)((apez)localObject1).jdField_a_of_type_JavaLangObject).c = ((apez)localObject1).jdField_b_of_type_JavaLangString;
            } else if ((((apez)localObject1).jdField_a_of_type_JavaLangObject instanceof FileManagerEntity)) {
              ((FileManagerEntity)((apez)localObject1).jdField_a_of_type_JavaLangObject).strThumbPath = ((apez)localObject1).jdField_b_of_type_JavaLangString;
            }
          }
        }
        localObject1 = (Object[])paramObject[2];
        localObject2 = (String)localObject1[0];
        paramObject = new apez();
    ...
    for (i = ((Integer)localObject1[1]).intValue();; i = 0)
    {
      ...
      {
        localObject1 = new apez();
        ((apez)localObject1).jdField_a_of_type_JavaLangObject = paramObject;
        ((apez)localObject1).jdField_a_of_type_JavaLangString = paramObject.Uuid;
        ((apez)localObject1).jdField_b_of_type_Int = i;
        if (i == 7) {
          ((apez)localObject1).jdField_b_of_type_JavaLangString = paramObject.strLargeThumPath;
        }
        for (;;)
        {
          ((apez)localObject1).jdField_a_of_type_Long = paramObject.nSessionId;
          a((apez)localObject1);
          return;
          if (i == 5) {
            ((apez)localObject1).jdField_b_of_type_JavaLangString = paramObject.strMiddleThumPath;
          } else {
            ((apez)localObject1).jdField_b_of_type_JavaLangString = paramObject.strThumbPath;
          }
        }
      }
      localObject1 = new apez();
      ((apez)localObject1).jdField_a_of_type_JavaLangObject = paramObject;
      ((apez)localObject1).jdField_a_of_type_JavaLangString = paramObject.Uuid;
      ((apez)localObject1).jdField_b_of_type_JavaLangString = null;
      ((apez)localObject1).jdField_b_of_type_Int = i;
      ((apez)localObject1).jdField_a_of_type_Long = paramObject.nSessionId;
      a((apez)localObject1);
      return;
