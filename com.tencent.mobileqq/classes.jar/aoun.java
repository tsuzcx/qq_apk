...
public class aoun
  extends aouc
{
  public aoun(QQAppInterface paramQQAppInterface, Context paramContext)
  {
  ...
  private boolean C()
  {
    ...
    ArkAppMgr.getInstance().getAppPathByName(str1, str3, "0.0.0.1", "", new aouo(this, localbisl, str3, str2, str1));
    return true;
  }
