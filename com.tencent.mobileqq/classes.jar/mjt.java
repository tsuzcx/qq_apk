...
public class mjt
  extends mjo
{
  protected mjt(Context paramContext, VideoAppInterface paramVideoAppInterface)
  {
  ...
  {
    int i = paramInt >> 1;
    int j = mjp.b(paramInt);
    parammeu1.a(0, 0, 0, 0);
    parammeu1.b(i, 0, paramInt, j);
  ...
  public void a(meu[] paramArrayOfmeu, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, boolean paramBoolean)
  {
    ...
    {
      bool = true;
      lbd.f("ScreenLayoutSmallUIDouble", "layoutCommon: " + paramBoolean + "|" + bool);
      if (!bool) {
        break label112;
      }
      if (paramBoolean) {
