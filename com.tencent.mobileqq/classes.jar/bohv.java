  ...
  implements IEventReceiver
{
  ...
  bohy jdField_a_of_type_Bohy;
  bpju jdField_a_of_type_Bpju;
  AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface = bofz.a();
  CardObserver jdField_a_of_type_ComTencentMobileqqAppCardObserver = new bohx(this);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = alrs.jdField_a_of_type_JavaLangString + "/tencent/qim/share/";
  }
  ...
  private void c()
  {
    if (this.jdField_a_of_type_Bohy == null)
    {
      this.jdField_a_of_type_Bohy = new bohy(this);
      if (QLog.isColorLevel()) {
        QLog.i("ComboLockManager", 2, "registerStoryReceiver");
      }
      wad.a().registerSubscriber(this.jdField_a_of_type_Bohy);
    }
  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Bohy != null)
    {
      ...
      wad.a().unRegisterSubscriber(this.jdField_a_of_type_Bohy);
      this.jdField_a_of_type_Bohy = null;
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Bpju == parambpju) {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_JavaUtilHashMap = parambpju.jdField_a_of_type_JavaUtilHashMap;
      this.jdField_a_of_type_Bpju = parambpju;
      parambpju = this.jdField_a_of_type_JavaUtilHashMap.keySet().iterator();
      while (parambpju.hasNext())
      {
        Object localObject = (String)parambpju.next();
  ...
  public boolean a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      else if (localLockedCategory.jdField_a_of_type_Int == 1)
      {
        ...
        {
          localLockedCategory.jdField_a_of_type_Boolean = bhhr.x(BaseApplicationImpl.getApplication(), paramString);
  ...
  public void b()
  {
    ...
    wad.a().unRegisterSubscriber(this.jdField_a_of_type_Bohy);
    Object localObject = (anri)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(BusinessHandlerFactory.CARD_HANLDER);
    ...
    if (this.jdField_a_of_type_DovComQqImCaptureDataLockedCategory != null)
    {
      ...
      bohw localbohw = new bohw(this, (Context)localObject);
      ThreadManager.getUIHandler().postDelayed(new ComboLockManager.2(this, (Context)localObject, localbohw), 1000L);
    }
  }
  
  public void b(String paramString)
  {
    Object localObject1 = this.jdField_a_of_type_Bpju.a(this.jdField_a_of_type_Int).a;
