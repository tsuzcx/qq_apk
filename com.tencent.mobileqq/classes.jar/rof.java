  ...
  extends BaseAdapter
{
  ...
  public rof(List<DiandianTopConfig> paramList, int paramInt)
  {
  ...
  public android.view.View getView(int paramInt, android.view.View paramView, android.view.ViewGroup paramViewGroup)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 21	rof:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   4: iload_1
    ...
    //   22: dup
    //   23: aconst_null
    //   24: invokespecial 62	roi:<init>	(Lrnw;)V
    //   27: astore_2
    //   28: aload_3
    ...
    //   54: putfield 91	roi:jdField_a_of_type_ComTencentImageURLImageView	Lcom/tencent/image/URLImageView;
    //   57: aload_2
    //   58: aload 4
    //   60: ldc 92
    //   62: invokevirtual 86	android/view/View:findViewById	(I)Landroid/view/View;
    //   65: checkcast 94	android/widget/TextView
    //   68: putfield 97	roi:jdField_a_of_type_AndroidWidgetTextView	Landroid/widget/TextView;
    //   71: aload_2
    //   72: aload 4
    //   74: ldc 98
    //   76: invokevirtual 86	android/view/View:findViewById	(I)Landroid/view/View;
    //   79: checkcast 94	android/widget/TextView
    //   82: putfield 101	roi:b	Landroid/widget/TextView;
    //   85: aload_2
    //   86: aload 4
    //   88: ldc 102
    //   90: invokevirtual 86	android/view/View:findViewById	(I)Landroid/view/View;
    //   93: checkcast 94	android/widget/TextView
    //   96: putfield 105	roi:c	Landroid/widget/TextView;
    //   99: aload_2
    //   100: new 107	roh
    //   103: dup
    //   104: aload_0
    //   105: getfield 13	rof:jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewHeadersReadInJoyDiandianHeaderController	Lcom/tencent/biz/pubaccount/readinjoy/view/headers/ReadInJoyDiandianHeaderController;
    //   108: aconst_null
    //   109: invokespecial 110	roh:<init>	(Lcom/tencent/biz/pubaccount/readinjoy/view/headers/ReadInJoyDiandianHeaderController;Lrnw;)V
    //   112: putfield 113	roi:jdField_a_of_type_Roh	Lroh;
    //   115: aload 4
    //   117: aload_2
    //   118: invokevirtual 117	android/view/View:setTag	(Ljava/lang/Object;)V
    //   121: aload 4
    //   123: aload_2
    //   124: getfield 113	roi:jdField_a_of_type_Roh	Lroh;
    ...
    //   134: astore_2
    //   135: aload_3
    //   136: getfield 113	roi:jdField_a_of_type_Roh	Lroh;
    //   139: aload_0
    //   140: getfield 23	rof:jdField_a_of_type_Int	I
    //   143: iconst_2
    //   144: imul
    //   145: iload_1
    //   146: iadd
    //   147: putfield 122	roh:jdField_a_of_type_Int	I
    ...
    //   155: aload 4
    //   157: aload_0
    //   158: getfield 13	rof:jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewHeadersReadInJoyDiandianHeaderController	Lcom/tencent/biz/pubaccount/readinjoy/view/headers/ReadInJoyDiandianHeaderController;
    ...
    //   167: aload 4
    //   169: aload_0
    //   170: getfield 13	rof:jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewHeadersReadInJoyDiandianHeaderController	Lcom/tencent/biz/pubaccount/readinjoy/view/headers/ReadInJoyDiandianHeaderController;
    ...
    //   203: ldc 156
    //   205: invokestatic 161	baxn:a	(Landroid/content/Context;F)I
    //   208: aload_2
    //   209: invokevirtual 155	android/view/View:getContext	()Landroid/content/Context;
    //   212: ldc 156
    //   214: invokestatic 161	baxn:a	(Landroid/content/Context;F)I
    //   217: invokestatic 166	bavw:a	(II)[I
    //   220: invokevirtual 167	com/tencent/image/URLDrawable:setTag	(Ljava/lang/Object;)V
    //   223: aload_3
    //   224: getfield 91	roi:jdField_a_of_type_ComTencentImageURLImageView	Lcom/tencent/image/URLImageView;
    //   227: aload 4
    ...
    //   263: aload_3
    //   264: getfield 97	roi:jdField_a_of_type_AndroidWidgetTextView	Landroid/widget/TextView;
    //   267: iconst_0
    //   268: invokevirtual 184	android/widget/TextView:setVisibility	(I)V
    //   271: aload_3
    //   272: getfield 101	roi:b	Landroid/widget/TextView;
    //   275: aload 5
    ...
    //   291: ifne +212 -> 503
    //   294: aload_3
    //   295: getfield 105	roi:c	Landroid/widget/TextView;
    //   298: aload 5
    ...
    //   309: aload_3
    //   310: getfield 105	roi:c	Landroid/widget/TextView;
    //   313: aload 5
    ...
    //   321: aload_0
    //   322: getfield 13	rof:jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewHeadersReadInJoyDiandianHeaderController	Lcom/tencent/biz/pubaccount/readinjoy/view/headers/ReadInJoyDiandianHeaderController;
    ...
    //   365: aload_0
    //   366: getfield 13	rof:jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewHeadersReadInJoyDiandianHeaderController	Lcom/tencent/biz/pubaccount/readinjoy/view/headers/ReadInJoyDiandianHeaderController;
    ...
    //   396: iconst_0
    //   397: invokestatic 256	nol:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)V
    //   400: aload_0
    //   401: getfield 13	rof:jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewHeadersReadInJoyDiandianHeaderController	Lcom/tencent/biz/pubaccount/readinjoy/view/headers/ReadInJoyDiandianHeaderController;
    //   404: iconst_1
    ...
    //   415: checkcast 59	roi
    //   418: astore_3
    //   419: goto -284 -> 135
    //   422: aload_3
    //   423: getfield 97	roi:jdField_a_of_type_AndroidWidgetTextView	Landroid/widget/TextView;
    //   426: bipush 8
    ...
    //   487: aload_3
    //   488: getfield 105	roi:c	Landroid/widget/TextView;
    //   491: ldc_w 282
    ...
    //   500: goto -191 -> 309
    //   503: aload_3
    //   504: getfield 105	roi:c	Landroid/widget/TextView;
    //   507: ldc_w 282
