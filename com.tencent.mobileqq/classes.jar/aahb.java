  ...
  extends ntf
{
  ...
  protected abstract void a(boolean paramBoolean, int paramInt, bfif parambfif);
  ...
  protected void b(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      {
        a(true, 0, new bfif((group_file_common.FolderInfo)paramArrayOfByte.folder_info.get()));
        return;
      }
    }
