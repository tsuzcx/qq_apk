...
public class bcha
  implements Manager
{
  private bcgv jdField_a_of_type_Bcgv = new bcgv("Cahce_");
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  
  public bcha(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
  }
  
  public ArrayList<bcgy> a(String paramString)
  {
    if (this.jdField_a_of_type_Bcgv != null)
    {
      paramString = this.jdField_a_of_type_Bcgv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString);
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Bcgv != null)
    {
      this.jdField_a_of_type_Bcgv.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  ...
  {
    b();
    this.jdField_a_of_type_Bcgv = null;
