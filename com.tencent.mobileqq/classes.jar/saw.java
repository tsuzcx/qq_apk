...
public final class saw
{
  ...
  static
  {
    jdField_a_of_type_Say = new say(null);
  }
  ...
  @RequiresApi(26)
  private final void a(Activity paramActivity, View paramView, float paramFloat, sax paramsax)
  {
    ...
    try
    {
      PixelCopy.request(paramActivity, new Rect(arrayOfInt[0], arrayOfInt[1], arrayOfInt[0] + paramView.getWidth(), arrayOfInt[1] + paramView.getHeight()), localBitmap, (PixelCopy.OnPixelCopyFinishedListener)new sba(localBitmap, this, paramView, paramFloat, paramsax), this.jdField_a_of_type_AndroidOsHandler);
      return;
    }
  ...
  private final void a(Bitmap paramBitmap, rjx paramrjx)
  {
    String str = beyq.a.toString() + File.separator + beqz.c(new StringBuilder().append("screen_capture").append(System.currentTimeMillis()).toString());
    rjg localrjg = new rjg(paramBitmap, str);
    localrjg.a((URLDrawable.DownloadListener)new sbb(this, str, paramrjx, paramBitmap));
    localrjg.a();
  }
  
  private final void a(Bitmap paramBitmap, sax paramsax)
  {
    int i;
    if (!paramBitmap.isRecycled())
    {
  ...
  private final void a(View paramView, boolean paramBoolean, float paramFloat, sax paramsax)
  {
    ThreadManager.getFileThreadHandler().post((Runnable)new ScreenCaptureHelper.captureViewLowApi.1(this, paramView, paramFloat, paramsax));
  }
  
  private final void a(String paramString, rjx paramrjx)
  {
    ...
    paramString = (rjy)new rkb(localContext, (QQAppInterface)localAppRuntime, paramString);
    paramString.a(paramrjx);
    paramString.a();
  }
  ...
  private final boolean b(TextureView paramTextureView)
  {
    ...
    tmp9_5;
    paramTextureView.getLocationOnScreen(arrayOfInt);
    if ((arrayOfInt[0] < 0) || (arrayOfInt[0] > zft.a((Context)BaseApplicationImpl.getContext()))) {
      return false;
    }
    return (arrayOfInt[1] >= 0) && (arrayOfInt[1] <= zft.b((Context)BaseApplicationImpl.getContext()));
  }
  
  public final void a(@NotNull Activity paramActivity, boolean paramBoolean, float paramFloat, @Nullable rjx paramrjx)
  {
    Intrinsics.checkParameterIsNotNull(paramActivity, "activity");
    a(paramActivity, paramBoolean, paramFloat, (sax)new saz(this, paramrjx));
  }
  
  public final void a(@NotNull Activity paramActivity, boolean paramBoolean, float paramFloat, @Nullable sax paramsax)
  {
    Intrinsics.checkParameterIsNotNull(paramActivity, "activity");
    try
    {
      ...
      if (Build.VERSION.SDK_INT >= 26)
      {
        ...
        a(paramActivity, (View)localObject, paramFloat, paramsax);
        return;
      }
      Intrinsics.checkExpressionValueIsNotNull(localObject, "captureView");
      a((View)localObject, paramBoolean, paramFloat, paramsax);
      return;
    }
