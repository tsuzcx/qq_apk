...
public final class blnh
{
  private static Intent a(Activity paramActivity, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      default: 
        ...
        if (paramIntent.getBooleanExtra("is_from_qreader_shortcut", false)) {
          ...
          {
            blpu.e("QRJumpAction", localNumberFormatException.toString());
          }
        } else {
          i = -1;
        }
    ...
    paramActivity.putExtras(paramIntent);
    return paramActivity;
    paramIntent.putExtra("url", blpw.b(a(paramIntent.getStringExtra("url"))));
    paramIntent.putExtra("item_type", 2);
    paramActivity = new Intent(paramActivity, ReaderContentPageActivity.class);
  ...
  public static Intent a(Activity paramActivity, Intent paramIntent, String paramString)
  {
    ...
    {
      blpu.e("QRJumpAction", "jumpAction args error");
      return new Intent();
    }
  ...
  public static void a(Context paramContext, Intent paramIntent, String paramString, blfn paramblfn)
  {
    if ((paramContext == null) || (paramIntent == null) || (TextUtils.isEmpty(paramString)))
    {
      blpu.a("QRJumpAction", "jumpToPlugin args error");
      return;
    }
    String str = BaseApplicationImpl.getApplication().getRuntime().getAccount();
    blfq localblfq = new blfq(1);
    localblfq.b = "qqreaderplugin.apk";
    localblfq.d = anni.a(2131709970);
    localblfq.jdField_a_of_type_JavaLangString = str;
    localblfq.e = paramString;
    localblfq.jdField_a_of_type_JavaLangClass = QRPluginProxyActivity.a(paramString);
    paramIntent.putExtra("userQqResources", 2);
    localblfq.jdField_a_of_type_AndroidContentIntent = paramIntent;
    paramIntent = bkzp.a(1);
    if (paramIntent != null)
    {
      paramIntent.a();
      localblfq.jdField_a_of_type_Avaj = paramIntent.jdField_a_of_type_Avaj;
    }
    try
    {
      blfh.a(paramContext, localblfq, paramblfn);
      return;
    }
    catch (Exception paramContext)
    {
      blpu.a("QRJumpAction", "[jumpToPlugin] error!", paramContext);
    }
  }
}
