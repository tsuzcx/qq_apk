...
public class ajbw
{
  ...
  public static int a(long paramLong, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    int i = -1;
    ajch localajch = ajae.b(paramLong);
    if (localajch != null) {
      i = localajch.a();
    }
  ...
  private static boolean a(long paramLong, String paramString1, String paramString2, boolean paramBoolean, int paramInt)
  {
    if (paramString1.equals("cs.check_pubAccount_state.local")) {
      a(paramString1, paramString2, paramBoolean, new ajbx(paramLong), paramInt);
    }
    label199:
    do
    {
      ...
      do
      {
        do
        {
          ...
          {
            a(paramString1, paramString2, paramBoolean, new ajby(paramLong), paramInt);
            return false;
          }
          if (!paramString1.equals("cs.get_dress_path.local")) {
            break label199;
          }
          localObject2 = new ajbz(paramLong, paramString1);
          try
          {
            ajch localajch = ajae.b(paramLong);
            str = paramString2;
            if (localajch != null)
            {
              ...
              {
                localJSONObject.put("gameId", localajch.a());
        ...
        Object localObject1 = new ajca(paramLong);
  ...
  public static boolean a(long paramLong, boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localajcv != null)
        {
          paramBoolean = localajcv.a(paramLong, paramBoolean, paramString1, paramString2);
          return paramBoolean;
        }
      }
