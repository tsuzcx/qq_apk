...
import com.tencent.mobileqq.activity.home.Conversation.30.1;
import com.tencent.mobileqq.activity.home.Conversation.30.2;
import com.tencent.mobileqq.activity.home.Conversation.30.3;
import com.tencent.mobileqq.activity.home.Conversation.30.4;
import com.tencent.mobileqq.activity.home.Conversation.30.5;
...
public class ajbw
  extends amsu
{
  public ajbw(Conversation paramConversation) {}
  ...
  protected void onCancelMayKnowRecommend(boolean paramBoolean, String paramString)
  {
    ...
    if (paramBoolean)
    {
      amvo localamvo = (amvo)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159);
      ArrayList localArrayList = localamvo.c();
      if (localamvo.a(paramString)) {
  ...
  protected void onGetGenralSettings(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      localObject1 = null;
      avnu.a().i(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (localObject1 != null) {
        break label176;
      }
    }
    for (;;)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        {
          if (localObject1 != null) {
            ((anuz)localObject1).delRecentUser(localRecentUser);
          }
          akms.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentUser.uin, 1);
  ...
  {
    if ((paramBoolean) && (bftf.a(paramString, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()))) {
  ...
  protected void onGetStoreFace(boolean paramBoolean, HashSet<String> paramHashSet)
  {
    ...
    this.a.b(new Conversation.30.3(this, paramHashSet));
  }
  ...
  protected void onHideConversationMayKnowRecommend(boolean paramBoolean, Object paramObject)
  {
    ...
    if (paramBoolean)
    {
      paramObject = (amvo)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159);
      paramObject.e();
      this.a.jdField_a_of_type_MqqOsMqqHandler.sendEmptyMessage(1009);
    ...
    QQToast.a(BaseApplication.getContext(), amtj.a(2131701735), 0).a();
    paramBoolean = ((amvo)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159)).b("sp_mayknow_ml_s_a_vl");
    paramObject = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    if (paramBoolean) {}
    for (;;)
    {
  ...
  protected void onMayknowStateChanged(boolean paramBoolean)
  {
    ...
    if ((paramBoolean) && (((amvo)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159)).b("sp_mayknow_ml_s_a_vl")))
    {
      this.a.jdField_a_of_type_MqqOsMqqHandler.sendEmptyMessage(1009);
      this.a.jdField_a_of_type_MqqOsMqqHandler.removeCallbacks(this.a.jdField_a_of_type_JavaLangRunnable);
      this.a.jdField_a_of_type_MqqOsMqqHandler.postDelayed(this.a.jdField_a_of_type_JavaLangRunnable, 1600L);
  ...
  protected void onSetGenralSettingsTroopFilter(boolean paramBoolean, Map<String, Integer> paramMap)
  {
    ...
    if (localObject == null)
    {
      ...
      avnu.a().a(str, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    }
    for (;;)
    {
      ...
      try
      {
        RecentUser localRecentUser = (RecentUser)((anuz)localObject).findRecentUser(str, 1);
      ...
      break;
      label318:
      avnu.a().c(str, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    }
    label336:
    this.a.a(9, AppConstants.TROOP_ASSISTANT_UIN, 5000);
    this.a.a(9, AppConstants.HOTCHAT_CENTER_UIN, 5001);
  ...
  protected void onUpdateCustomHead(boolean paramBoolean, String paramString)
  {
    ...
    if (!bftf.a(paramString, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))
    {
  ...
  protected void onUpdateFriendInfo(String paramString, boolean paramBoolean)
  {
    ...
    if (!bftf.a(paramString, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()))
    {
      this.a.a(0L);
      return;
    }
    Conversation.b(this.a, "onUpdateFriendInfo");
  }
  ...
  protected void onUpdateFriendList(boolean paramBoolean1, boolean paramBoolean2)
  {
    if ((paramBoolean1) && (paramBoolean2))
    {
      ...
      this.a.a(0L);
      this.a.b(new Conversation.30.1(this));
      Conversation.b(this.a, "onUpdateFriendList");
    }
  }
  ...
  protected void onUpdateHotFriendLevel(boolean paramBoolean, ArrayList<String> paramArrayList)
  {
    ...
    if (paramBoolean) {
      this.a.b(new Conversation.30.5(this, paramArrayList));
    }
  }
  ...
  {
    if (paramBoolean) {
      this.a.b(new Conversation.30.4(this, paramString));
    }
  }
}
