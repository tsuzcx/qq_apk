...
public class zcl
{
  public static MessageRecord a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    {
      zcj localzcj = (zcj)paramQQAppInterface.getManager(QQManagerFactory.TROOP_STORY_MANAGER);
      String str = a(paramString);
      paramString = localzcj.a(paramString);
      if (paramString != null) {
        return paramQQAppInterface.getMessageFacade().queryMsgItemByShmsgseq4Troop(str, 1, paramString.longValue());
      }
    }
    return null;
  }
  ...
  {
    return (vzv.i()) && (paramInt == 1) && ((paramMessageRecord instanceof MessageForShortVideo)) && (((MessageForShortVideo)paramMessageRecord).busiType == 1);
  }
