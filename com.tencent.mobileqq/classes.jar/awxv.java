...
public class awxv
{
  ...
  private awxy a(String paramString1, String paramString2)
  {
    int j = 0;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramString1.has("num")) {
          localawxy.jdField_a_of_type_Int = paramString1.getInt("num");
        }
        if (paramString1.has("process_frame"))
        {
          ...
          if (((JSONObject)localObject).has("repeat")) {
            localawxy.jdField_b_of_type_Int = ((JSONObject)localObject).getInt("repeat");
          }
          if (((JSONObject)localObject).has("frame_delay")) {
            localawxy.c = ((JSONObject)localObject).getInt("frame_delay");
          }
          localObject = ((JSONObject)localObject).getJSONArray("seq_array");
          if ((localObject != null) && (((JSONArray)localObject).length() > 0))
          {
            localawxy.jdField_a_of_type_ArrayOfJavaLangString = new String[((JSONArray)localObject).length()];
            i = 0;
            while (i < ((JSONArray)localObject).length())
            {
              localawxy.jdField_a_of_type_ArrayOfJavaLangString[i] = (asos.z.replace("[epId]", paramString2) + ((JSONArray)localObject).getString(i));
              i += 1;
            }
          }
        }
        Object localObject = paramString1.getJSONArray("result_frame");
        paramString1 = localawxy;
        if (localObject == null) {
          continue;
        }
        paramString1 = localawxy;
        ...
        localawxy.jdField_b_of_type_ArrayOfJavaLangString = new String[((JSONArray)localObject).length()];
        int i = j;
        for (;;)
        {
          paramString1 = localawxy;
          ...
          localawxy.jdField_b_of_type_ArrayOfJavaLangString[i] = (asos.z.replace("[epId]", paramString2) + ((JSONArray)localObject).getString(i));
          i += 1;
        }
        return localawxy;
      }
  ...
  private String a(String paramString)
  {
    ...
    localStringBuffer.append(asos.z.replace("[epId]", paramString));
