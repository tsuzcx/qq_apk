...
public class axfm
{
  private axey jdField_a_of_type_Axey;
  ...
  public axfm(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    a();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Axey);
  }
  
  private AbsStructMsg a(Context paramContext, String paramString)
  {
    String str3 = apck.a(paramString);
    String str1 = apdh.a(paramString);
    if (axfs.jdField_a_of_type_JavaLangString.indexOf(str1) < 0)
    {
      QLog.e("TeamWorkSender", 1, paramString + " is not docs support file");
      return null;
    }
    if (".doc|.docx".contains(str1)) {
      paramString = ajjy.a(2131649002);
    }
    for (str1 = "https://pub.idqqimg.com/pc/misc/files/20180403/29c998e16c094b10a96b3e0d1589c2f6.png";; str1 = "https://pub.idqqimg.com/pc/misc/files/20180403/da40f07bd79e4796b712b44023911be0.png")
    {
      ...
      localIntent.putExtra("app_name", ajjy.a(2131649021));
      localIntent.putExtra("brief_key", paramContext.getString(2131630985, new Object[] { str2 }));
      return awuw.a(localIntent.getExtras());
      paramString = ajjy.a(2131648998);
    }
  }
  ...
  private TeamWorkFileImportInfo a(String paramString)
  {
    ...
    localTeamWorkFileImportInfo.jdField_b_of_type_JavaLangString = apck.a(paramString);
    localTeamWorkFileImportInfo.jdField_e_of_type_Int = apck.a(paramString);
    localTeamWorkFileImportInfo.jdField_b_of_type_Boolean = false;
    localTeamWorkFileImportInfo.jdField_d_of_type_Int = 4;
    localTeamWorkFileImportInfo.jdField_d_of_type_Long = apck.a(paramString);
  ...
  private String a(int paramInt)
  {
    ...
    case -104: 
    default: 
      return ajjy.a(2131648976);
    case -102: 
    case -101: 
    case -100: 
      return ajjy.a(2131648966);
    case -103: 
      return ajjy.a(2131648996);
    case -116: 
    case -106: 
      return ajjy.a(2131648994);
    case -107: 
      return ajjy.a(2131648958);
    case -108: 
      return ajjy.a(2131649010);
    case -110: 
      return ajjy.a(2131648997);
    case -111: 
      return ajjy.a(2131648979);
    case -115: 
    case -113: 
    case -112: 
      return ajjy.a(2131648963);
    }
    return ajjy.a(2131649019);
  }
  
  private void a()
  {
    this.jdField_a_of_type_Axey = new axfn(this);
  }
  ...
  private void a(AbsStructMsg paramAbsStructMsg, TeamWorkFileImportInfo paramTeamWorkFileImportInfo, String paramString, int paramInt)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqDataMessageForStructing = awbi.a(localQQAppInterface, str2, paramString, str1, paramInt, l, paramAbsStructMsg);
      ...
      paramAbsStructMsg = (axem)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(120);
  ...
  {
    paramString2 = apck.a(paramString1);
  ...
  public boolean a(MessageForStructing paramMessageForStructing, SessionInfo paramSessionInfo)
  {
    ...
    axem localaxem = (axem)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(120);
    if (!TextUtils.isEmpty(localaxem.a(paramSessionInfo))) {
      localaxem.a(paramSessionInfo);
    }
    if (!localaxem.a(paramSessionInfo)) {
      localaxem.a(paramSessionInfo);
    }
