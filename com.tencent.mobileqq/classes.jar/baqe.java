...
{
  private static baqe jdField_a_of_type_Baqe;
  baqc jdField_a_of_type_Baqc;
  boolean jdField_a_of_type_Boolean;
  
  public static MovementMethod a()
  {
    if (jdField_a_of_type_Baqe == null) {
      jdField_a_of_type_Baqe = new baqe();
    }
    return jdField_a_of_type_Baqe;
  }
  ...
  public boolean onTouchEvent(TextView paramTextView, Spannable paramSpannable, MotionEvent paramMotionEvent)
  {
    ...
    if ((i == 1) || (i == 0) || (i == 3))
    {
      ...
      localObject = (baqc[])paramSpannable.getSpans(j, j, baqc.class);
      ...
      if (localObject.length != 0)
      {
        ...
        if (i == 1)
        {
          ...
          {
            this.jdField_a_of_type_Baqc.a(paramTextView, false);
        ...
        for (;;)
        {
          ...
          if (i == 0)
          {
            ...
            this.jdField_a_of_type_Baqc = paramSpannable;
          }
          else if ((i == 3) && (this.jdField_a_of_type_Baqc != null))
          {
            this.jdField_a_of_type_Baqc.a(paramTextView, false);
            this.jdField_a_of_type_Baqc = null;
          }
