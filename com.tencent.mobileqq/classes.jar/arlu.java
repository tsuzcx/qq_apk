...
public class arlu
{
  HashMap<String, arlw> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  mvv jdField_a_of_type_Mvv;
  
  public void a(arlw paramarlw, String paramString)
  {
    this.jdField_a_of_type_JavaUtilHashMap.put(paramString, paramarlw);
  }
  ...
  public void a(String paramString1, String paramString2, List<String> paramList, arlv paramarlv)
  {
    ...
    paramString1 = (arlw)this.jdField_a_of_type_JavaUtilHashMap.get(paramString1);
    if (paramString1 != null) {
      paramString1.call(paramString2, paramList, paramarlv);
    }
    while (paramarlv == null) {
      return;
    }
    paramarlv.a();
  }
  ...
  public boolean a(WebView paramWebView, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString = new arlv(paramWebView, l, paramString);
        paramWebView = paramWebView.getUrl();
        if (this.jdField_a_of_type_Mvv == null) {
          this.jdField_a_of_type_Mvv = mvv.a();
        }
        if (this.jdField_a_of_type_Mvv.a(paramWebView, str1 + "." + str2))
        {
      ...
      QLog.e("JsBridge", 1, "JS API no auth url = " + nax.b(paramWebView, new String[0]) + " objectName = " + str1 + " methodName = " + str2);
      paramString.b();
    }
  }
}
