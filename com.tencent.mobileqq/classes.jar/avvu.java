...
public class avvu
{
  ...
  ActionCallback jdField_a_of_type_ComTencentIntervideoNowproxyCustomized_interfaceActionCallback = new avvw(this);
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  
  public avvu(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Avuo = avvz.a().a();
  ...
  private void d(Bundle paramBundle)
  {
    ...
    {
      localObject2 = AbsDownloader.getFile(str2);
      localObject1 = localObject2;
      if (localObject2 == null) {
        localObject1 = AbsDownloader.getFile(str2 + "?busiType=3");
      }
      localObject2 = str1;
    ...
    paramBundle.putString("hostVersion", String.valueOf(arqj.a(BaseApplicationImpl.getContext())));
  ...
  public void a(Bundle paramBundle, avvs paramavvs)
  {
    ...
    paramavvs = paramBundle.getString("mqqUrl", "");
    long l = System.currentTimeMillis();
    if ((l - this.jdField_a_of_type_Long < 1000L) && (!avur.c(paramBundle).equals("1")))
    {
      QLog.i("DynamicNow | NowEntry", 1, "开始处理mqq　scheme,time = " + System.currentTimeMillis() + " 点太快了");
      QQToast.a(BaseApplicationImpl.getContext(), anvx.a(2131707119), 0).a();
      return;
    }
    this.jdField_a_of_type_Long = l;
    QLog.i("DynamicNow | NowEntry", 1, "开始进入now结合版,time = " + System.currentTimeMillis() + " mqqScheme = " + paramavvs);
  ...
  {
    Object localObject1 = avur.a(paramBundle);
    Object localObject2 = avur.b(paramBundle);
    long l = avur.a(paramBundle);
    this.jdField_a_of_type_Avuo.a(false, (String)localObject2, String.valueOf(l), (String)localObject1, false, false, true);
    ...
    ((URLDrawable)localObject1).setURLDrawableListener(new avvv(this, l, (AtomicBoolean)localObject2, paramBundle));
