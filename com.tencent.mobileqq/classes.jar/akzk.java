...
public class akzk
  implements akzo, akzx, Handler.Callback
{
  ...
  private volatile akzj jdField_a_of_type_Akzj;
  private volatile akzn jdField_a_of_type_Akzn;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajya.a(2131700768);
    jdField_b_of_type_JavaLangString = ajya.a(2131700769);
    jdField_c_of_type_JavaLangString = ajya.a(2131700764);
    jdField_d_of_type_JavaLangString = ajya.a(2131700765);
    jdField_e_of_type_JavaLangString = ajya.a(2131700767);
    jdField_f_of_type_JavaLangString = ajya.a(2131700771);
    jdField_g_of_type_JavaLangString = ajya.a(2131700766);
    jdField_h_of_type_JavaLangString = ajya.a(2131700770);
  }
  ...
  private boolean c()
  {
    return (a()) && (this.jdField_a_of_type_Akzj.a());
  }
  ...
  private void d(int paramInt)
  {
    ...
    if (c())
    {
      ...
      {
        this.jdField_a_of_type_Akzn.a(0);
        this.jdField_a_of_type_Akzn.b();
      }
      if ((paramInt == 2) || (paramInt == 4) || (paramInt == 6) || (paramInt == 1) || (paramInt == 3))
      {
        this.jdField_a_of_type_Akzj.a(false, true);
        this.m = paramInt;
    ...
    {
      return;
      this.jdField_a_of_type_Akzj.a(false, false);
      if (!QLog.isColorLevel()) {
        break;
      }
      ...
      if (this.jdField_a_of_type_Akzj != null) {
        this.jdField_a_of_type_Akzj.a(false, false);
      }
  ...
  private void e(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if (!this.jdField_c_of_type_Boolean) {
        if (paramInt == 11) {
          akzg.a(jdField_a_of_type_JavaLangString, false);
        }
      }
      for (;;)
      {
  ...
  private void j()
  {
    ...
    {
      return;
      if ((this.jdField_a_of_type_Akzj != null) && (this.jdField_a_of_type_Akzj.a())) {
        this.jdField_a_of_type_Akzj.a(false, true);
      }
  ...
  private void l()
  {
    ...
    for (;;)
    {
      ...
      return;
      if ((this.m == -1) && (this.jdField_a_of_type_Akzj != null)) {
        this.jdField_a_of_type_Akzj.a(false, false);
      }
    }
  }
  ...
  private void n()
  {
    ...
    if ((this.jdField_a_of_type_Akzj == null) || (this.jdField_a_of_type_Akzn == null)) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      do
      {
        ...
        {
          return;
          if (this.jdField_a_of_type_Akzn.a() != 0) {
            break label145;
          }
          if (!akzg.a(104857600L))
          {
            akzg.a(jdField_c_of_type_JavaLangString, jdField_d_of_type_JavaLangString);
            return;
          }
          if (this.jdField_a_of_type_Akzj.a(true, null)) {
            break;
          }
          akzg.a(jdField_a_of_type_JavaLangString, false);
        } while (!QLog.isColorLevel());
        ...
        return;
        a("0X8008A54");
        this.jdField_a_of_type_Akzn.a(1);
      } while (!QLog.isColorLevel());
      QLog.i("ARVideoRecordUIControllerImpl", 2, "startVideoRecord end");
      return;
      if (c())
      {
        this.jdField_a_of_type_Akzj.a(true, true);
        this.m = 7;
        this.jdField_d_of_type_Boolean = true;
        a("0X8008A55");
        if (QLog.isColorLevel()) {
  ...
  public void a(Object paramObject)
  {
    ...
    {
      return;
      if ((paramObject instanceof akzn))
      {
        this.jdField_a_of_type_Akzn = ((akzn)paramObject);
        this.jdField_a_of_type_Akzn.a(this);
        return;
      }
    } while (!(paramObject instanceof akzj));
    this.jdField_a_of_type_Akzj = ((akzj)paramObject);
    this.jdField_a_of_type_Akzj.a(this);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      return;
      this.jdField_a_of_type_Akzn = null;
      this.jdField_a_of_type_Akzj = null;
  ...
  public boolean a()
  {
    return (this.jdField_a_of_type_Akzj != null) && (this.jdField_a_of_type_Akzj.b());
  }
  ...
  public boolean b()
  {
    return (this.jdField_a_of_type_Akzj != null) && (this.jdField_a_of_type_Akzj.b()) && (!this.jdField_a_of_type_Akzj.a());
  }
  ...
  public void d()
  {
    ...
    if ((!this.jdField_e_of_type_Boolean) || (!this.jdField_f_of_type_Boolean)) {}
    while (this.jdField_a_of_type_Akzj == null) {
      return;
    }
    this.jdField_a_of_type_Akzj.a(System.currentTimeMillis());
  }
    ...
    for (int n = ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).checkSelfPermission("android.permission.RECORD_AUDIO");; n = 0)
    {
      ...
      for (int i1 = ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).checkSelfPermission("android.permission.WRITE_EXTERNAL_STORAGE");; i1 = 0)
      {
        ...
        for (int i2 = ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).checkSelfPermission("android.permission.READ_EXTERNAL_STORAGE");; i2 = 0)
        {
          ...
          ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).requestPermissions(new akzl(this), 1, new String[] { "android.permission.RECORD_AUDIO", "android.permission.READ_EXTERNAL_STORAGE", "android.permission.WRITE_EXTERNAL_STORAGE" });
          return true;
          ...
          this.jdField_a_of_type_Akzj.a(false, null);
          return true;
          if (this.jdField_a_of_type_Akzj == null) {
            break;
          }
