...
public class aeqt
  implements Runnable
{
  public aeqt(EmoticonManager paramEmoticonManager, int paramInt) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqModelEmoticonManager.jdField_a_of_type_AndroidOsHandler.post(new aequ(this, (EmosmPb.SubCmd0x5RspBQRecommend)localObject));
        return;
      }
