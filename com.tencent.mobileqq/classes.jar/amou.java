...
import com.tencent.mobileqq.apollo.CmShowLauncher.1;
...
public class amou
{
  public static void a(Activity paramActivity)
  {
    ...
    boolean bool = bnqu.a().a("sp_key_cmshow_first_guide_has_shown_" + BaseApplicationImpl.getApplication().getRuntime().getAccount(), false, 4);
  ...
  public static void a(Context paramContext, String paramString, Intent paramIntent)
  {
    ...
    float f1 = 2.0F;
    if (f2 != 0.0F) {
      f1 = DeviceInfoUtil.getDesity() / f2;
    }
    f2 = f1;
    if (f1 == 0.0F) {
      f2 = DeviceInfoUtil.getDesity();
    }
    ...
    for (;;)
    {
      ...
      if (str.indexOf("&_wwv") < 0) {
        localStringBuilder.append("&_wwv=").append(8712L);
      }
