  ...
  extends PublicBaseFragment
{
  ...
  public static void a(Activity paramActivity, JSONObject paramJSONObject, Class<? extends abqf> paramClass)
  {
    if ((paramActivity == null) || (paramJSONObject == null))
    {
      abrl.b("GdtBaseBannerFragment", "start error");
      return;
    }
    abrl.b("GdtBaseBannerFragment", "start");
    ...
    adxr.a(paramActivity, paramJSONObject, PublicFragmentActivityForTool.class, paramClass);
  }
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramBundle = (qq_ad_get.QQAdGet)qq_ad_get.QQAdGet.class.cast(abrk.a(new qq_ad_get.QQAdGet(), paramBundle));
      ...
      catch (JSONException paramLayoutInflater)
      {
        for (;;)
        {
          abrl.d("GdtBaseBannerFragment", "createParams error", paramLayoutInflater);
        }
      }
      paramLayoutInflater = new Button(getActivity());
      paramLayoutInflater.setText("load");
      paramLayoutInflater.setOnClickListener(new abqg(this));
      paramViewGroup = new Button(getActivity());
      paramViewGroup.setText("show");
      paramViewGroup.setOnClickListener(new abqh(this));
