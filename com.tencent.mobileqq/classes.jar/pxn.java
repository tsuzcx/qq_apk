...
public class pxn
{
  ...
  public pxn(pwb parampwb)
  {
    this.jdField_a_of_type_Pwb = parampwb;
  }
  ...
  public static List<BaseArticleInfo> a(List<BaseArticleInfo> paramList)
  {
    ...
    if (i < j)
    {
      ...
      if (!pha.h(localBaseArticleInfo1)) {
      ...
      for (;;)
      {
        ...
        while ((i + 1 < j) && (pha.a(localBaseArticleInfo1, (BaseArticleInfo)paramList.get(i + 1))))
        {
        ...
        if ((pha.l(localBaseArticleInfo1)) && (localArticleInfo.mGroupSubArticleList.size() >= 1))
        {
          localArrayList.add(localArticleInfo);
          if (QLog.isColorLevel()) {
            QLog.d("PolymericSmallVideo_" + pxn.class.getSimpleName(), 2, localStringBuilder.toString());
          }
        }
    ...
    if ((localArrayList.size() > 1) && (pha.j((BaseArticleInfo)localArrayList.get(localArrayList.size() - 1)))) {
  ...
  static void a(BaseArticleInfo paramBaseArticleInfo)
  {
    if ((paramBaseArticleInfo.mNewPolymericInfo != null) && (paramBaseArticleInfo.mNewPolymericInfo.jdField_a_of_type_JavaUtilList != null) && (paramBaseArticleInfo.mNewPolymericInfo.jdField_a_of_type_JavaUtilList.size() > 0))
    {
      ...
      try
      {
        ...
        {
          localrfw = (rfw)((Iterator)localObject).next();
          ...
          localArticleInfo.mAlgorithmID = localrfw.b;
          localArticleInfo.innerUniqueID = localrfw.g;
          localArticleInfo.mArticleContentUrl = localrfw.jdField_d_of_type_JavaLangString;
          localArticleInfo.mSubscribeID = localrfw.e;
          if (localrfw.jdField_c_of_type_Int == 1)
          {
            bool = true;
            localArticleInfo.mIsPolymericGallery = bool;
            localArticleInfo.mGalleryPicNumber = localrfw.jdField_d_of_type_Int;
            localArticleInfo.mSinglePicture = pha.a(localrfw.jdField_c_of_type_JavaLangString);
            if (localrfw.jdField_a_of_type_Rfz != null)
            {
              localArticleInfo.mVideoCoverUrl = pha.a(localrfw.jdField_c_of_type_JavaLangString);
              localArticleInfo.mVideoVid = localrfw.jdField_a_of_type_Rfz.a;
            }
            localArticleInfo.mNewPolymericInfo = new rfv();
      ...
      catch (Exception localException1)
      {
        try
        {
          for (;;)
          {
            ...
            localArticleInfo.mNewPolymericInfo.jdField_a_of_type_JavaUtilList.add((rfw)localrfw.clone());
            if (snh.g(paramBaseArticleInfo))
            {
              localrfw.jdField_a_of_type_Boolean = true;
  ...
  public void a(Integer paramInteger, List<Long> paramList)
  {
    ...
    for (;;)
    {
      if (i < k)
      {
        localObject1 = this.jdField_a_of_type_Pwb.a(paramInteger, (Long)paramList.get(i));
  ...
  public void a(Integer paramInteger, List<ArticleInfo> paramList, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (!paramBoolean)
      {
        ...
        paramInteger = this.jdField_a_of_type_Pwb.a(paramInteger.intValue(), 10, localArticleInfo1.mRecommendSeq, true).iterator();
        while (paramInteger.hasNext())
        {
