  ...
  implements Runnable
{
  ...
  public anfu(TroopHWJsPlugin paramTroopHWJsPlugin, HashMap paramHashMap)
  {
  ...
  public void run()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject2))
      {
        ...
        anfw localanfw = new anfw(this.jdField_a_of_type_CooperationTroop_homeworkJspTroopHWJsPlugin.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_CooperationTroop_homeworkJspTroopHWJsPlugin.e, this.jdField_a_of_type_CooperationTroop_homeworkJspTroopHWJsPlugin.d);
        TroopHWJsPlugin.UploadMediaEntry localUploadMediaEntry = this.jdField_a_of_type_CooperationTroop_homeworkJspTroopHWJsPlugin.a(this.jdField_a_of_type_CooperationTroop_homeworkJspTroopHWJsPlugin, i, localException, null, localanfw, 1);
