  ...
  extends agsr
{
  ...
  private int c;
  protected String c;
  private final String jdField_d_of_type_JavaLangString = "ArkApp.SSODataRequest";
  
  ahhb(QQAppInterface paramQQAppInterface, String paramString)
  {
  ...
  private void b(int paramInt)
  {
    ...
    ArkAppCenter.a().post(this.jdField_c_of_type_JavaLangString, new SSODataRequest.2(this, localWeakReference, paramInt));
  }
  ...
  public void a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    do
    {
      ...
      this.jdField_c_of_type_Int = 0;
      paramString = this.jdField_a_of_type_Agww;
      this.jdField_a_of_type_Agww = null;
  ...
  protected boolean a(String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    WeakReference localWeakReference = new WeakReference(this);
    return ((apou)localObject).a(paramString1, paramString2, this.jdField_a_of_type_Int, paramInt2, new ahhc(this, localWeakReference));
  }
