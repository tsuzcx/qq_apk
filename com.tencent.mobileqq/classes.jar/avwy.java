  ...
  implements TencentLocationListener
{
  ...
  avwy(avwv paramavwv, boolean paramBoolean, Runnable paramRunnable, MqqHandler paramMqqHandler, LocationRoom paramLocationRoom)
  {
  ...
  public void onLocationChanged(TencentLocation paramTencentLocation, int paramInt, String paramString)
  {
    if (paramInt == 0)
    {
      ...
      avwv.a(this.jdField_a_of_type_Avwv, paramTencentLocation);
    }
    ...
    if (paramInt != 0)
    {
      ...
      avzs.a(this.jdField_a_of_type_Avwv.app, paramTencentLocation.a(), paramTencentLocation.a(), 1);
    }
    for (;;)
    {
      ...
      {
        this.c = false;
        this.jdField_a_of_type_Avwv.a(avwv.a(this.jdField_a_of_type_Avwv).a(), avwv.a(this.jdField_a_of_type_Avwv).a());
      }
      avwv.a(this.jdField_a_of_type_Avwv, true);
    }
  }
