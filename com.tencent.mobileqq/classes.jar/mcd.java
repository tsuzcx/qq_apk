...
public class mcd
{
  ...
  {
    bdla.b(null, "dc00898", "", "", "0X8006F88", "0X8006F88", 0, 0, "", "", "", "");
  }
  ...
  static void a(int paramInt1, int paramInt2, long paramLong, String paramString, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject)) {
        bdla.b(null, "dc00898", "", "", (String)localObject, (String)localObject, paramInt2, 0, str2, "", str3, paramString);
      }
      if (!TextUtils.isEmpty(str1)) {
        bdla.b(null, "dc00898", "", "", str1, str1, paramInt2, 0, str2, "", str3, paramString);
      }
      return;
      str1 = "0X8007F37";
      localObject = str1;
  ...
  public static void a(int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      if (!TextUtils.isEmpty(str)) {
        bdla.b(null, "dc00898", "", "", str, str, 0, 0, "", "", String.valueOf(paramLong), "");
      }
      return;
      str = "0X8007F2B";
      continue;
  ...
  static void a(long paramLong, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      return;
      if (!((lls)localObject).a()) {
        localObject = "0X80077C0";
      } else if (!((lls)localObject).b) {
  ...
  public static void a(String paramString, boolean paramBoolean, long paramLong)
  {
    ...
    for (int i = 1;; i = -1)
    {
      bdla.b(null, "dc00898", "", "", paramString, paramString, 0, i, "", "", String.valueOf(paramLong), "");
      return;
    }
  }
  ...
  static void b()
  {
    bdla.b(null, "dc00898", "", "", "0X8006F8F", "0X8006F8F", 0, 0, "", "", "", "");
  }
