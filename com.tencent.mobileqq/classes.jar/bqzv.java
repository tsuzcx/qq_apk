...
public class bqzv
  implements beur
{
  private static bqzv jdField_a_of_type_Bqzv;
  public bqzx a;
  private HashMap<String, bqzw> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private Lock jdField_a_of_type_JavaUtilConcurrentLocksLock = new ReentrantLock();
  
  public bqzv()
  {
    this.jdField_a_of_type_Bqzx = new bqzx(this);
  }
  
  public static bqzv a()
  {
    if (jdField_a_of_type_Bqzv == null) {
      jdField_a_of_type_Bqzv = new bqzv();
    }
    return jdField_a_of_type_Bqzv;
  }
  ...
  private void a(FilterDesc paramFilterDesc, long paramLong, int paramInt)
  {
    ...
    try
    {
      Object localObject2 = ((bpmw)bplq.a(5)).a;
      Object localObject1 = new ArrayList();
      if (localObject2 != null) {
        localObject1 = ((braa)localObject2).a(0).c;
      }
      ...
      abbe.a("record_filter_download", abbe.a(paramInt, System.currentTimeMillis() - l, paramFilterDesc.resurl, paramLong, paramFilterDesc.name));
  ...
  private void a(FilterDesc paramFilterDesc, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        bqzw localbqzw = (bqzw)this.jdField_a_of_type_JavaUtilHashMap.get(paramFilterDesc.name);
        if ((localbqzw != null) && (localbqzw.jdField_a_of_type_JavaUtilArrayList != null))
        {
          i = 0;
          if (i < localbqzw.jdField_a_of_type_JavaUtilArrayList.size())
          {
            bqzy localbqzy = (bqzy)((WeakReference)localbqzw.jdField_a_of_type_JavaUtilArrayList.get(i)).get();
            if (localbqzy != null) {
              localArrayList.add(localbqzy);
            }
          }
          else
          {
            localbqzw.jdField_a_of_type_JavaUtilArrayList.clear();
        ...
        else
        {
          ...
          if ((localArrayList != null) && (localArrayList.size() > 0))
          {
            ...
            {
              paramFilterDesc = (bqzy)localArrayList.get(i);
              if (paramFilterDesc != null) {
  ...
  {
    String str = paramFilterDesc.getResFold(brdl.b);
    bqzz.a();
  ...
  /* Error */
  private boolean a(FilterDesc paramFilterDesc, bqzy parambqzy)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 26	bqzv:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   4: invokeinterface 174 1 0
    //   9: aload_0
    //   10: getfield 21	bqzv:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   13: aload_1
    ...
    //   33: dup
    //   34: aload_0
    //   35: invokespecial 254	bqzw:<init>	(Lbqzv;)V
    //   38: astore 4
    //   40: aload 4
    //   42: aload_1
    //   43: putfield 257	bqzw:jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc	Lcom/tencent/mobileqq/richmedia/capture/data/FilterDesc;
    //   46: aload 4
    //   48: getfield 181	bqzw:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   62: pop
    //   63: aload_0
    //   64: getfield 21	bqzv:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   67: aload_1
    ...
    //   78: istore_3
    //   79: aload_0
    //   80: getfield 26	bqzv:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   83: invokeinterface 206 1 0
    //   88: iload_3
    //   89: ireturn
    //   90: aload 4
    //   92: getfield 181	bqzw:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   112: astore_1
    //   113: aload_0
    //   114: getfield 26	bqzv:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    ...
    //   0	124	2	parambqzy	bqzy
    //   78	31	3	bool	boolean
    //   23	68	4	localbqzw	bqzw
    // Exception table:
    //   from	to	target	type
    //   9	25	112	finally
    //   30	77	112	finally
  ...
  public void a(FilterDesc paramFilterDesc, bqzy parambqzy)
  {
    if (!a(paramFilterDesc, parambqzy)) {
      a(paramFilterDesc);
    }
  }
  ...
  {
    parambevm = (FilterDesc)parambevm.a.a();
    if (parambevm != null) {
      QLog.e("VideoFilterListDownloader", 2, "MyListDownloaderListener onFailed file: " + parambevm.resurl);
    }
  }
}
