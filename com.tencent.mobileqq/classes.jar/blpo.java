...
{
  private int jdField_a_of_type_Int = bkka.jdField_a_of_type_Int;
  private blph jdField_a_of_type_Blph;
  private blpi jdField_a_of_type_Blpi;
  private bnnb jdField_a_of_type_Bnnb = new bnnb();
  private MusicItemInfo jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo;
  private HashMap<Integer, blpi> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private List<blpj> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  private ConcurrentHashMap<String, bdvv> jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  /* Error */
  private blpi a(MusicItemInfo paramMusicItemInfo)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   9: if_icmpne +62 -> 71
    //   12: aload_0
    //   13: getfield 44	blpo:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   16: iconst_1
    ...
    //   33: new 73	blpi
    //   36: dup
    //   37: invokespecial 74	blpi:<init>	()V
    //   40: astore_2
    //   41: aload_2
    //   42: aload_0
    //   43: getfield 49	blpo:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   46: invokevirtual 77	blpi:a	(Ljava/util/List;)V
    //   49: aload_0
    //   50: getfield 44	blpo:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   53: iconst_1
    ...
    //   62: aload_2
    //   63: aload_1
    //   64: invokevirtual 84	blpi:a	(Lcom/tencent/mobileqq/richmedia/capture/data/MusicItemInfo;)V
    //   67: aload_0
    //   68: monitorexit
    //   69: aload_2
    //   70: areturn
    ...
    //   76: if_icmpne -9 -> 67
    //   79: aload_0
    //   80: getfield 44	blpo:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   83: iconst_2
    ...
    //   108: aload_2
    //   109: aload_0
    //   110: getfield 49	blpo:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   113: invokevirtual 77	blpi:a	(Ljava/util/List;)V
    //   116: aload_0
    //   117: getfield 44	blpo:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   120: iconst_2
    ...
    //   129: aload_2
    //   130: aload_1
    //   131: invokevirtual 84	blpi:a	(Lcom/tencent/mobileqq/richmedia/capture/data/MusicItemInfo;)V
    //   134: goto -67 -> 67
    //   137: astore_1
    //   138: aload_0
    //   139: monitorexit
  ...
  {
    if ((this.jdField_a_of_type_Blph != null) && (!this.jdField_a_of_type_Boolean) && ((this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo == null) || (this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.isMute() != paramMusicItemInfo.isMute()))) {
      this.jdField_a_of_type_Blph.a(paramMusicItemInfo.isMute());
    }
  }
  ...
  public int a()
  {
    int i = -1;
    if (a()) {
      i = this.jdField_a_of_type_Blpi.a();
    }
    return i;
  }
  ...
  public void a(int paramInt)
  {
    if (this.jdField_a_of_type_Blph != null) {
      this.jdField_a_of_type_Blph.a(true);
    }
    a(-1, -1, paramInt);
  }
  ...
  {
    if (this.jdField_a_of_type_Blpi != null) {
      this.jdField_a_of_type_Blpi.a(paramLong);
    }
  }
  
  public void a(blph paramblph)
  {
    this.jdField_a_of_type_Blph = paramblph;
    if ((!this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo != null) && (this.jdField_a_of_type_Blph != null)) {
      this.jdField_a_of_type_Blph.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.isMute());
    }
  }
  
  public void a(blpj paramblpj)
  {
    if ((paramblpj == null) || (this.jdField_a_of_type_JavaUtilList == null)) {
    ...
    {
      return;
      if (!this.jdField_a_of_type_JavaUtilList.contains(paramblpj)) {
        break;
      }
    } while (!QLog.isColorLevel());
    QLog.d("QimMusicPlayer", 2, "addMusicPlayerSceneListener mListeners has listener");
    return;
    this.jdField_a_of_type_JavaUtilList.add(paramblpj);
  }
  ...
  public void a(MusicItemInfo paramMusicItemInfo)
  {
    ...
    {
      localObject = (bdvv)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramMusicItemInfo.getLocalPath());
      if (localObject != null) {
        QQMusicDownloader.a((bdvv)localObject);
      }
    }
  ...
  public boolean a()
  {
    return (this.jdField_a_of_type_Blpi != null) && (this.jdField_a_of_type_Blpi.a());
  }
  
  public boolean a(int paramInt1, int paramInt2, int paramInt3)
  {
    MusicItemInfo localMusicItemInfo = ((QIMMusicConfigManager)blmf.a(2)).a(paramInt1, paramInt2);
  ...
  public boolean a(MusicItemInfo paramMusicItemInfo)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      ...
      while (localIterator.hasNext()) {
        ((blpj)localIterator.next()).a(paramMusicItemInfo);
      }
    }
    e();
    ...
    this.jdField_a_of_type_Blpi = a(paramMusicItemInfo);
    return true;
  }
  ...
  public boolean a(MusicItemInfo paramMusicItemInfo, blpg paramblpg)
  {
    String str;
    ...
    if (!this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(str))
    {
      ...
      paramblpg = new blpn(this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap, this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap, paramblpg);
      bdvv localbdvv = QQMusicDownloader.a(paramMusicItemInfo.mUrl, str, paramblpg);
      if (localbdvv != null)
      {
        this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.put(str, localbdvv);
        QQMusicDownloader.a(localbdvv, paramblpg);
  ...
  public boolean a(MusicItemInfo paramMusicItemInfo, boolean paramBoolean, int paramInt)
  {
    ...
    if (!b(paramMusicItemInfo)) {}
    while ((azbu.a().b()) || (c(paramMusicItemInfo))) {
      return false;
    }
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_Blph = null;
    ...
    while (localIterator.hasNext()) {
      ((blpi)localIterator.next()).f();
    }
    this.jdField_a_of_type_JavaUtilHashMap.clear();
    this.jdField_a_of_type_JavaUtilHashMap = null;
    this.jdField_a_of_type_Bnnb.a();
    this.jdField_a_of_type_Bnnb = null;
  }
  ...
  public void b(int paramInt)
  {
    ...
    while (this.jdField_a_of_type_Blpi == null) {
      return;
    }
    this.jdField_a_of_type_Blpi.c();
  }
  
  public void b(blpj paramblpj)
  {
    if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.contains(paramblpj))) {
      this.jdField_a_of_type_JavaUtilList.remove(paramblpj);
    }
  }
  ...
  public void c()
  {
    if (this.jdField_a_of_type_Blpi != null)
    {
      if ((this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo != null) && (this.jdField_a_of_type_JavaUtilList != null))
      {
        Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
        while (localIterator.hasNext()) {
          ((blpj)localIterator.next()).a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo);
        }
      }
      this.jdField_a_of_type_Blpi.b();
      f();
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Blpi != null) {
      this.jdField_a_of_type_Blpi.jdField_a_of_type_Int = paramInt;
    }
  }
  ...
  public boolean c()
  {
    ...
    int i = j;
    if (j == bkka.jdField_a_of_type_Int) {
      i = bkka.a();
    }
    QQFilterRenderManager localQQFilterRenderManager = bkka.a(i);
  ...
  public void f()
  {
    ...
    do
    {
      do
      {
        ...
        localQQFilterRenderManager = bkka.a(i);
        if ((localMusicItemInfo.needPlay()) && (c()))
        {
          if (a()) {}
          for (i = a() - localMusicItemInfo.musicStart;; i = 0)
          {
            this.jdField_a_of_type_Bnnb.a(localMusicItemInfo, i);
            if (localQQFilterRenderManager == null) {
              break;
            }
  ...
  public float getCurrentMusicGain()
  {
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          if ((this.jdField_a_of_type_Bnnb != null) && (localMusicItemInfo.needPlay()) && (a()))
          {
            float f = this.jdField_a_of_type_Bnnb.a(a() - localMusicItemInfo.musicStart);
            return f;
          }
        }
