  ...
  implements Closeable
{
  ...
  public blpo(String paramString, int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3)
  {
  ...
  private boolean a(RandomAccessFile paramRandomAccessFile, int paramInt, blpp paramblpp)
  {
    ...
    try
    {
      ...
      l2 = a(arrayOfByte, 0);
      long l3 = paramblpp.jdField_a_of_type_Long;
      if (l2 != l3) {
        return false;
      }
      k = a(arrayOfByte, 8);
      ...
      if ((paramblpp.jdField_a_of_type_ArrayOfByte == null) || (paramblpp.jdField_a_of_type_ArrayOfByte.length < m)) {
        paramblpp.jdField_a_of_type_ArrayOfByte = new byte[m];
      }
      arrayOfByte = paramblpp.jdField_a_of_type_ArrayOfByte;
      paramblpp.jdField_a_of_type_Int = m;
    ...
    catch (Throwable paramblpp)
    {
      QLog.e("BlobCache", 2, "getBlob failed.", paramblpp);
      return false;
    }
    finally
    {
  ...
  public boolean a(blpp paramblpp)
  {
    if ((a(paramblpp.jdField_a_of_type_Long, this.g)) && (a(this.jdField_d_of_type_JavaIoRandomAccessFile, this.j, paramblpp))) {}
    int k;
    do
    {
      return true;
      k = this.i;
      if ((!a(paramblpp.jdField_a_of_type_Long, this.h)) || (!a(this.jdField_e_of_type_JavaIoRandomAccessFile, this.j, paramblpp))) {
        break;
      }
    } while ((this.jdField_e_of_type_Int + 20 + paramblpp.jdField_a_of_type_Int > this.jdField_b_of_type_Int) || (this.jdField_d_of_type_Int * 2 >= this.jdField_a_of_type_Int));
    this.i = k;
    try
    {
      b(paramblpp.jdField_a_of_type_Long, paramblpp.jdField_a_of_type_ArrayOfByte, paramblpp.jdField_a_of_type_Int);
      this.jdField_d_of_type_Int += 1;
      a(this.jdField_a_of_type_ArrayOfByte, 16, this.jdField_d_of_type_Int);
      f();
      return true;
