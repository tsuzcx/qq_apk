  ...
  implements Manager
{
  ...
  private bpth jdField_a_of_type_Bpth;
  public volatile String a;
  private HashMap<String, String> jdField_a_of_type_JavaUtilHashMap;
  private List<RecentUser> jdField_a_of_type_JavaUtilList = new ArrayList();
  private CopyOnWriteArrayList<bptq> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  ...
  private String a(RecentUser paramRecentUser)
  {
    ...
    for (;;)
    {
      ...
      continue;
      str1 = this.jdField_a_of_type_Aohm.a(paramRecentUser.uin);
      continue;
      bovt.a(paramRecentUser.troopUin, paramRecentUser.uin);
      continue;
      str1 = this.jdField_a_of_type_Aohm.a(paramRecentUser.troopUin, paramRecentUser.uin);
    }
  }
  ...
  private void a(bptq parambptq, int paramInt1, int paramInt2)
  {
    int i = parambptq.jdField_b_of_type_Int;
    if (i == 1) {
      if ((paramInt1 == 1003) || (paramInt1 == 1007))
      {
        parambptq.jdField_b_of_type_Int = 3;
        parambptq.jdField_c_of_type_Int = 100;
      }
    }
    while ((i != 0) || ((paramInt1 != 1003) && (paramInt1 != 1007)))
    {
      ...
      {
        parambptq.jdField_b_of_type_Int = 2;
        return;
      }
      parambptq.jdField_c_of_type_Int = paramInt2;
      return;
    }
    parambptq.jdField_b_of_type_Int = 3;
    parambptq.jdField_c_of_type_Int = 100;
  ...
  private void b()
  {
    ...
    if (this.jdField_a_of_type_Bpth != null) {
      this.jdField_a_of_type_Bpth.c();
    }
    j();
    d();
    ...
    {
      while (this.jdField_a_of_type_Bpth == null) {}
      if (QLog.isColorLevel()) {
  ...
  private void e()
  {
    a(this.jdField_a_of_type_Aohm.a(RecentUser.class, "select * from recent order by lastmsgtime desc", null));
    f();
  ...
  private void f()
  {
    if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.size() > 0))
    {
      ...
      {
        Collections.sort((List)localObject2, new bptj());
      ...
      {
        Collections.sort((List)localObject1, new bptj());
  ...
  private void h()
  {
    if ((this.jdField_b_of_type_Boolean) && (this.jdField_c_of_type_Boolean))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        localbptq = new bptq();
        localbptq.jdField_a_of_type_JavaLangString = localRecentUser.uin;
        localbptq.jdField_b_of_type_JavaLangString = localRecentUser.troopUin;
        if (localRecentUser.getType() == 1000)
        {
          localbptq.jdField_c_of_type_JavaLangString = localRecentUser.displayName;
        ...
        for (;;)
        {
          ...
          {
            localPair = bovt.a(localRecentUser.uin);
            if (localPair != null)
            {
              if (((Boolean)localPair.first).booleanValue())
              {
                ...
                break;
                localbptq.jdField_c_of_type_JavaLangString = a(localRecentUser);
                continue;
              }
              localbptq.jdField_c_of_type_Boolean = ((Boolean)localPair.second).booleanValue();
            }
          }
        }
        localbptq.jdField_a_of_type_Int = localRecentUser.getType();
        if ((localRecentUser.getType() == 0) && (!TextUtils.isEmpty(localbptq.jdField_a_of_type_JavaLangString)) && ((TextUtils.isEmpty(localbptq.jdField_c_of_type_JavaLangString)) || (localbptq.jdField_a_of_type_JavaLangString.equals(localbptq.jdField_c_of_type_JavaLangString)))) {
          localbptq.jdField_c_of_type_JavaLangString = bovt.a(localbptq.jdField_a_of_type_JavaLangString);
        }
        this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(localbptq);
      }
  ...
  public void a(bpth parambpth)
  {
    this.jdField_a_of_type_Bpth = parambpth;
  }
  ...
  public void a(String paramString, int paramInt1, int paramInt2, int paramInt3, long paramLong)
  {
    ...
    {
      return;
      if ((this.jdField_a_of_type_Bpth != null) && (this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList != null) && (this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() > 0))
      {
        int j = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size();
        int i = 0;
        while (i < j)
        {
          bptq localbptq = (bptq)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i);
          if ((!TextUtils.isEmpty(localbptq.jdField_a_of_type_JavaLangString)) && (localbptq.jdField_a_of_type_JavaLangString.equals(paramString)) && (localbptq.jdField_a_of_type_Int == paramInt1) && (localbptq.jdField_b_of_type_Boolean))
          {
            a(localbptq, paramInt2, paramInt3);
            if (localbptq.jdField_a_of_type_Long <= 0L) {
              localbptq.jdField_a_of_type_Long = paramLong;
            }
            if (QLog.isColorLevel()) {
              QLog.i("SendPanelManager", 2, "updateOperateStatus operateStatus = " + localbptq.jdField_b_of_type_Int + " ,progress = " + localbptq.jdField_c_of_type_Int + " ,position = " + i + ", uinseq:" + localbptq.jdField_a_of_type_Long);
            }
            this.jdField_a_of_type_AndroidOsHandler.post(new SendPanelManager.6(this, i, localbptq));
            return;
          }
          i += 1;
        }
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList != null) && (this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() > 0))
      {
        ...
        while (paramString1.hasNext()) {
          ((bptq)paramString1.next()).g = paramString2;
        }
      }
    }
  }
  ...
  public void a(String paramString1, int paramInt, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList != null)
    {
      ...
      if (this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() > 0)
      {
        ...
        if (j < m)
        {
          localObject2 = (bptq)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(j);
          ((bptq)localObject2).e = paramString2;
          ((bptq)localObject2).f = paramString3;
          ((bptq)localObject2).jdField_a_of_type_Boolean = paramBoolean;
          if ((TextUtils.isEmpty(((bptq)localObject2).jdField_a_of_type_JavaLangString)) || (!((bptq)localObject2).jdField_a_of_type_JavaLangString.equals(paramString1)) || (paramInt != ((bptq)localObject2).jdField_a_of_type_Int)) {
            break label389;
          }
    ...
    for (;;)
    {
      ...
      {
        ((bptq)localObject2).jdField_b_of_type_Int = 1;
        if (this.jdField_a_of_type_Bpth != null) {
          this.jdField_a_of_type_AndroidOsHandler.post(new SendPanelManager.7(this, k, (bptq)localObject2));
        }
        if (paramBoolean) {
          bovt.a(((bptq)localObject2).e, paramString3, (bptq)localObject2, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString);
        }
        for (;;)
        {
          ((bptq)localObject2).jdField_b_of_type_Boolean = true;
          banm.a((bptq)localObject2);
          bnyh.a().a(((bptq)localObject2).g, ((bptq)localObject2).jdField_a_of_type_Int);
          bnzb.b("SendPanelManager", "【updateFilePath】messageType:" + ((bptq)localObject2).jdField_a_of_type_Int);
          a(paramString1, paramInt, ((bptq)localObject2).g);
          return;
          bovt.a(paramString2, (bptq)localObject2, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString);
        }
      }
      if (!QLog.isColorLevel()) {
        break;
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        {
          bptq localbptq = (bptq)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i);
          if ((!TextUtils.isEmpty(localbptq.jdField_a_of_type_JavaLangString)) && (localbptq.jdField_a_of_type_JavaLangString.equals(paramString1)) && (localbptq.jdField_a_of_type_Int == 1000))
          {
            localbptq.jdField_c_of_type_JavaLangString = paramString2;
            if (QLog.isColorLevel()) {
              QLog.e("SendPanelManager", 2, "updateTroopMemberName");
            }
            this.jdField_a_of_type_AndroidOsHandler.post(new SendPanelManager.5(this, i, localbptq));
            return;
          }
          i += 1;
        }
  ...
  public void onDestroy()
  {
    ...
    if (this.jdField_a_of_type_Bpth != null)
    {
      this.jdField_a_of_type_Bpth.d();
      this.jdField_a_of_type_Bpth = null;
    }
  }
}
