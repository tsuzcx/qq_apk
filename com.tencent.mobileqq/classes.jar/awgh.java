...
public class awgh
{
  ...
  private final ambz jdField_a_of_type_Ambz;
  ...
  public void a()
  {
    ...
    azru.b(localThread.getId(), localThread.getName());
    ...
    for (;;)
    {
      azru.a(localThread.getId());
      azru.a(localThread.getId(), localThread.getName());
      return;
  ...
  public void b()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 54	awgh:jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase	Lcom/tencent/mobileqq/app/SQLiteDatabase;
    //   4: invokevirtual 79	com/tencent/mobileqq/app/SQLiteDatabase:d	()V
    //   7: aload_0
    //   8: aconst_null
    //   9: putfield 54	awgh:jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase	Lcom/tencent/mobileqq/app/SQLiteDatabase;
    //   12: getstatic 17	awgh:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    ...
    //   24: ldc2_w 83
    //   27: aconst_null
    //   28: invokestatic 72	azru:a	(JLjava/lang/String;)V
    //   31: getstatic 17	awgh:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   34: invokeinterface 87 1 0
    //   39: return
    //   40: astore_1
    //   41: getstatic 17	awgh:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    ...
    //   53: ldc2_w 83
    //   56: aconst_null
    //   57: invokestatic 72	azru:a	(JLjava/lang/String;)V
    //   60: getstatic 17	awgh:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   63: invokeinterface 87 1 0
    //   68: return
    //   69: astore_1
    //   70: getstatic 17	awgh:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    ...
    //   82: ldc2_w 83
    //   85: aconst_null
    //   86: invokestatic 72	azru:a	(JLjava/lang/String;)V
    //   89: getstatic 17	awgh:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
