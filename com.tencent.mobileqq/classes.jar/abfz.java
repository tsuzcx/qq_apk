  ...
  extends BroadcastReceiver
{
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if ("com.tencent.device.ble.ACTION_GATT_CONNECTED".equals(paramContext)) {
      absy.a().a(null, "Net_Bind_BLE_Connect", 0);
    }
    do
    {
      do
          ...
          do
          {
            do
            {
              ...
              if (paramContext != null)
              {
                ...
                abfw.b(this.a).remove(paramContext);
                if (this.a.jdField_a_of_type_Abmk == paramContext) {
                  this.a.jdField_a_of_type_Abmk = null;
                }
                abfw.a(this.a).remove(paramContext);
                abfw.a(this.a, i);
