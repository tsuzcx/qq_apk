...
public class aiay
{
  ...
  private void a()
  {
    ...
    {
      this.jdField_a_of_type_Aurb.a.put("percent1", Integer.valueOf(GLES20.glGetUniformLocation(this.jdField_a_of_type_Int, "percent1")));
      this.jdField_a_of_type_Aurb.a.put("percent2", Integer.valueOf(GLES20.glGetUniformLocation(this.jdField_a_of_type_Int, "percent2")));
      this.jdField_a_of_type_Aurb.a.put("percent3", Integer.valueOf(GLES20.glGetUniformLocation(this.jdField_a_of_type_Int, "percent3")));
      this.jdField_a_of_type_Aurb.a.put("percent4", Integer.valueOf(GLES20.glGetUniformLocation(this.jdField_a_of_type_Int, "percent4")));
      this.jdField_a_of_type_Aurb.a.put("percent5", Integer.valueOf(GLES20.glGetUniformLocation(this.jdField_a_of_type_Int, "percent5")));
      this.jdField_a_of_type_Aurb.a.put("percent6", Integer.valueOf(GLES20.glGetUniformLocation(this.jdField_a_of_type_Int, "percent6")));
      this.jdField_a_of_type_Aurb.a.put("percent7", Integer.valueOf(GLES20.glGetUniformLocation(this.jdField_a_of_type_Int, "percent7")));
      this.jdField_a_of_type_Aurb.a.put("quality", Integer.valueOf(GLES20.glGetUniformLocation(this.jdField_a_of_type_Int, "quality")));
      this.jdField_a_of_type_Aurb.a.put("add_red", Integer.valueOf(GLES20.glGetUniformLocation(this.jdField_a_of_type_Int, "add_red")));
      this.jdField_a_of_type_Aurb.a.put("red_m", Integer.valueOf(GLES20.glGetUniformLocation(this.jdField_a_of_type_Int, "red_m")));
      this.jdField_a_of_type_Aurb.a.put("green_m", Integer.valueOf(GLES20.glGetUniformLocation(this.jdField_a_of_type_Int, "green_m")));
      this.jdField_a_of_type_Aurb.a.put("blue_m", Integer.valueOf(GLES20.glGetUniformLocation(this.jdField_a_of_type_Int, "blue_m")));
      this.jdField_a_of_type_Aurb.a.put("inputImageTexture2", Integer.valueOf(GLES20.glGetUniformLocation(this.jdField_a_of_type_Int, "inputImageTexture2")));
      localObject1 = null;
    }
    try
    {
      localObject2 = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidContentContext.getResources(), 2130844433);
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if ((this.jdField_a_of_type_JavaNioByteBuffer == null) || (this.jdField_a_of_type_JavaNioByteBuffer.capacity() < i)) {
      this.jdField_a_of_type_JavaNioByteBuffer = aiaz.a(0, i);
    }
    i = 0 + i;
    ...
    if ((this.jdField_b_of_type_JavaNioByteBuffer == null) || (this.jdField_b_of_type_JavaNioByteBuffer.capacity() < paramInt1)) {
      this.jdField_b_of_type_JavaNioByteBuffer = aiaz.a(i, paramInt1);
    }
    if ((this.jdField_c_of_type_JavaNioByteBuffer == null) || (this.jdField_c_of_type_JavaNioByteBuffer.capacity() < paramInt1)) {
      this.jdField_c_of_type_JavaNioByteBuffer = aiaz.a(i + paramInt1, paramInt1);
    }
  }
  ...
  public boolean a(boolean paramBoolean, int paramInt1, int paramInt2, ByteBuffer paramByteBuffer1, ByteBuffer paramByteBuffer2, ByteBuffer paramByteBuffer3)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_Aurb.a(aurb.jdField_c_of_type_Int);
