...
public class aosc
{
  private ArrayList<aosd> a = new ArrayList();
  
  /* Error */
  public static aosc a(String paramString)
  {
    // Byte code:
    ...
    //   103: aload_2
    //   104: invokestatic 100	aosc:b	(Ljava/lang/String;)Laosc;
    //   107: astore_2
    //   108: aload_0
    //   109: ifnull +7 -> 116
    //   112: aload_0
  ...
  public static aosc b(String paramString)
  {
    try
    {
      ...
      if (((JSONObject)localObject).has("360senceinfo"))
      {
        ...
        if (j > 0)
        {
          ...
          for (;;)
          {
            ...
            localObject = new aosd();
            if (paramString.has("text")) {
              ((aosd)localObject).jdField_a_of_type_JavaLangString = paramString.optString("text");
            }
            if (paramString.has("starttime")) {
              ((aosd)localObject).jdField_a_of_type_Long = paramString.optLong("starttime");
            }
            if (paramString.has("endtime")) {
              ((aosd)localObject).b = paramString.optLong("endtime");
            }
            localaosc.a.add(localObject);
            if (QLog.isColorLevel()) {
              QLog.d("ARTransferDoorVideoInfo", 2, "ARTransferDoorVideoInfo parseJson index: " + i + "," + ((aosd)localObject).toString());
            }
            i += 1;
          }
        }
  ...
  public aosd a(long paramLong)
  {
    Iterator localIterator = this.a.iterator();
    while (localIterator.hasNext())
    {
      aosd localaosd = (aosd)localIterator.next();
      long l = localaosd.jdField_a_of_type_Long;
      if ((paramLong < localaosd.b * 1000L) && (paramLong >= l * 1000L)) {
        return localaosd;
      }
    }
    return null;
