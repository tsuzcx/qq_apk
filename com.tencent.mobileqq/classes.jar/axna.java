...
public class axna
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, agab paramagab)
  {
    ThreadManager.post(new OldMutualMarkLogicHelper.1(paramQQAppInterface, paramSessionInfo, paramagab), 5, null, false);
  }
  ...
  private static void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, MessageForUniteGrayTip paramMessageForUniteGrayTip, MqqHandler paramMqqHandler, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    ...
    {
      paramSessionInfo = afuu.a();
      paramMessageForUniteGrayTip = new axlx(BaseApplicationImpl.getContext(), paramMessageForUniteGrayTip.caidanAnimUrl);
  ...
  public static void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, MessageForUniteGrayTip paramMessageForUniteGrayTip, MqqHandler paramMqqHandler, AIOAnimationConatiner paramAIOAnimationConatiner, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      paramMqqHandler = afuu.a();
      if (paramInt == 3) {
        paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850216);
      }
      while (paramMessageForUniteGrayTip != null)
      {
        ...
        if (paramInt == 26)
        {
          paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850217);
        }
        else if (paramInt == 27)
        {
          paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850218);
        }
        else if (paramInt == 4)
        {
        ...
        {
          paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850220);
        }
        else if (paramInt == 2)
        {
        ...
        {
          paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850219);
        }
        else if (paramInt == 30)
        {
          paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850221);
        }
        else if (paramInt == 31)
        {
          paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850222);
        }
        else if (paramInt == 7)
        {
          paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850214);
        }
        else if (paramInt == 8)
        {
          paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850215);
        }
        else
        {
          ...
          if (paramInt != 11) {
            ...
            {
              paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850188);
            }
            else if (paramInt == 20)
            {
              paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850189);
            }
            else if (paramInt == 21)
            {
              paramMessageForUniteGrayTip = BaseApplicationImpl.getContext().getResources().getDrawable(2130850190);
            }
            else if (paramInt == 22)
            {
            ...
            else
            {
              ...
              if (axma.a(paramInt))
              {
                ...
                {
                  paramInt = axlp.a(paramQQAppInterface, paramSessionInfo.curFriendUin, String.valueOf(paramInt));
                  paramMessageForUniteGrayTip = localObject;
                  if (paramInt != 0) {
  ...
  private static void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, List<ChatMessage> paramList, agab paramagab)
  {
    if ((aoze.a().a()) && (a(paramQQAppInterface, paramSessionInfo, paramList)))
    {
      paramagab.e = true;
      aoze.a().a();
      if (QLog.isColorLevel()) {
  ...
  public static void b(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, agab paramagab)
  {
    if (paramagab.e) {}
    for (;;)
    {
      return;
      if (((anvk)paramQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER)).a(paramSessionInfo.curFriendUin, false) != null)
      {
        axms localaxms = axlr.a(paramQQAppInterface, paramSessionInfo.curFriendUin, 7L, false);
        if ((localaxms != null) && (localaxms.b > 0L) && (localaxms.a())) {}
        for (int i = 1; i != 0; i = 0)
        {
          a(paramQQAppInterface, paramSessionInfo, paramQQAppInterface.getMessageFacade().getAIOList(paramSessionInfo.curFriendUin, paramSessionInfo.curType), paramagab);
          return;
        }
      }
    }
