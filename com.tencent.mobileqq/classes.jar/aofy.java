...
public class aofy
{
  ...
  public aofy(QQAppInterface paramQQAppInterface, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  {
    return (1008 == paramMessage.istroop) && (paramMessage.senderuin != null) && (twk.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessage.senderuin, paramMessage.istroop));
  }
  
  private boolean m(QQMessageFacade.Message paramMessage)
  {
    return adak.c(paramMessage.senderuin);
  }
  ...
  {
    return (awlm.b(paramMessage)) && (awlm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessage));
  }
  ...
  {
    if ((1008 == paramMessage.istroop) && ((antf.az.equals(paramMessage.frienduin)) || (antf.ay.equals(paramMessage.frienduin)))) {
      if (QLog.isColorLevel()) {
    ...
    {
      return true;
      if ((7220 != paramMessage.istroop) || (!antf.aA.equals(paramMessage.frienduin)) || (ozs.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessage))) {
        break;
      }
  ...
  {
    anxm localanxm = anxm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    boolean bool2 = ((KeyguardManager)BaseApplicationImpl.context.getSystemService("keyguard")).inKeyguardRestrictedInputMode();
    boolean bool3 = ayus.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    if ((bool3) || (bool2)) {}
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      if (localanxm != null)
      {
        ...
        if (g(paramMessage))
        {
          ...
          if (!bool1)
          {
            paramIntent = bhlg.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessage.frienduin, paramMessage.istroop);
            localIntent = localanxm.b(paramMessage.istroop, paramMessage.frienduin, paramIntent, 28);
            azir.a("0X800AFCD", localanxm.a(paramMessage.istroop));
          }
        }
      }
      if (QLog.isColorLevel()) {
        QLog.d("ReceivedMsgNotificationHelper", 2, new Object[] { "getMiniAioIntentIfNeed: invoked. ", " appBackgroundOrLocked: ", Boolean.valueOf(bool1), " isScreenLocked: ", Boolean.valueOf(bool2), " app.isBackgroundStop: ", Boolean.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackgroundStop), " isAppBackground: ", Boolean.valueOf(bool3), " foregroundNotifyManager: ", localanxm });
      }
      return localIntent;
    }
  }
  ...
  boolean a(boolean paramBoolean, QQMessageFacade.Message paramMessage)
  {
    ...
    {
      int i = ((aljo)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(315)).a(paramMessage);
      if (QLog.isColorLevel()) {
  ...
  {
    if ((FriendsStatusUtil.a(paramMessage.frienduin, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) || (aguy.a(paramMessage.frienduin, paramMessage.istroop, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))) {}
    do
    {
      return true;
  ...
  public boolean c(QQMessageFacade.Message paramMessage)
  {
    if (paramMessage.istroop == 9002) {
      ...
      {
        aold localaold = (aold)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(85);
        if (!localaold.a(paramMessage.msgData)) {
          return true;
        }
        if (localaold.b(paramMessage.msgData)) {
    ...
    for (;;)
    {
      ...
      paramMessage.counter += this.jdField_a_of_type_Int;
      continue;
      if ((paramMessage.istroop == 7220) || (antf.aR.equals(paramMessage.frienduin))) {
        paramMessage.counter = 1;
      } else if ((antf.M.equals(paramMessage.frienduin)) || (antf.ax.equals(paramMessage.frienduin))) {
        paramMessage.counter = this.jdField_a_of_type_Int;
      } else {
        paramMessage.counter += this.jdField_a_of_type_Int;
      }
  ...
  {
    anxm localanxm = anxm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    return (localanxm != null) && (localanxm.a(paramMessage));
  }
  ...
  public boolean i(QQMessageFacade.Message paramMessage)
  {
    ...
    {
      bool1 = bool2;
      if (localanxm.a(paramMessage.istroop))
      {
        bool1 = bool2;
        if (localanxm.a(paramMessage.frienduin))
        {
          bool1 = bool2;
          if (!localanxm.a())
          {
