  ...
  public static AppRuntime a(BaseApplicationImpl paramBaseApplicationImpl, String paramString)
  {
    if ((paramBaseApplicationImpl == null) || (paramString == null))
    {
      if (QLog.isColorLevel()) {
        QLog.d(bfkr.a, 2, "createQQPimRuntime() application == null || processName == null");
      }
      return null;
    }
    try
    ...
    catch (ClassNotFoundException localClassNotFoundException)
    {
      for (;;)
      {
        try
        {
          ...
          QLog.d(bfkr.a, 2, "createQQPimRuntime() cls == null");
        }
        ...
        do
        {
          return null;
          if (QLog.isColorLevel()) {
            QLog.d(bfkr.a, 2, "createQQPimRuntime() 1 ");
          }
        ...
        if (QLog.isColorLevel()) {
          QLog.d(bfkr.a, 2, "createQQPimRuntime() succ");
        }
