  ...
  implements DownloadGlobalListener
{
  ...
  public static void a(Context paramContext, DownloadTaskInfo paramDownloadTaskInfo)
  {
    ...
    {
      return;
      aztk.a().addDownloadURL(paramDownloadTaskInfo.url);
      if (!a(paramDownloadTaskInfo.url))
      {
        HashMap localHashMap = new HashMap();
        localHashMap.put("url", paramDownloadTaskInfo.url);
        localHashMap.put("NetworkType", bdin.b(paramContext) + "");
        ...
        if (paramDownloadTaskInfo.stackInfo.length() < 950)
        {
          ...
          azri.a(paramContext).a(null, "UniformDownloadEvent_NO_SOURCE", true, 0L, 0L, localHashMap, "");
        }
        for (;;)
        {
          if (!QLog.isColorLevel()) {
          ...
          azri.a(paramContext).a(null, "UniformDownloadEvent", true, 0L, 0L, localHashMap, "");
        }
      }
    }
