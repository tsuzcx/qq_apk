...
public class bfkz
{
  ...
  HashMap<String, bfla> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  public bfkz(TraeAudioManager paramTraeAudioManager) {}
  ...
  {
    this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.lock();
    paramString = (bfla)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    if (paramString != null) {}
  ...
  public String a(int paramInt)
  {
    ...
    for (localObject = (bfla)localEntry.getValue();; localObject = null)
    {
      if (localObject != null) {}
      for (localObject = ((bfla)localObject).a();; localObject = "DEVICE_NONE")
      {
        this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.unlock();
        return localObject;
        i += 1;
  ...
  public String a(String paramString)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      bfla localbfla = (bfla)((Map.Entry)localObject2).getValue();
      if ((localbfla != null) && (localbfla.a()) && (!localbfla.a().equals(paramString)))
      {
        if (localObject1 == null) {
          localObject2 = localbfla;
        }
        for (;;)
        {
  ...
  boolean a(String paramString, int paramInt)
  {
    ...
    bfla localbfla = new bfla(this);
    if (localbfla.a(paramString, paramInt)) {
    ...
    {
      return false;
      this.jdField_a_of_type_JavaUtilHashMap.put(paramString, localbfla);
  ...
  {
    this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.lock();
    Object localObject = (bfla)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    if ((localObject != null) && (((bfla)localObject).a() != paramBoolean))
    {
      ((bfla)localObject).a(paramBoolean);
      ((bfla)localObject).b(paramBoolean);
      this.jdField_a_of_type_Boolean = true;
      if (QLog.isColorLevel())
      {
  ...
  public String b()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      ((Map.Entry)localObject2).getValue();
      bfla localbfla = (bfla)((Map.Entry)localObject2).getValue();
      if ((localbfla != null) && (localbfla.a()) && (localbfla.b()))
      {
        if (localObject1 == null) {
          localObject2 = localbfla;
        }
  ...
  ArrayList<String> b()
  {
    ...
    while (localIterator.hasNext())
    {
      bfla localbfla = (bfla)((Map.Entry)localIterator.next()).getValue();
      if ((localbfla != null) && (localbfla.a()) && (localbfla.b())) {
        localArrayList.add(localbfla.a());
      }
    }
    return localArrayList;
  }
  ...
  {
    this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.lock();
    Object localObject = (bfla)this.jdField_a_of_type_JavaUtilHashMap.get(this.c);
    if ((localObject != null) && (((bfla)localObject).a())) {}
  ...
  {
    this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.lock();
    bfla localbfla = (bfla)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    if ((localbfla != null) && (localbfla.a())) {
      this.c = paramString;
    }
  ...
  String f()
  {
    bfla localbfla = (bfla)this.jdField_a_of_type_JavaUtilHashMap.get(this.b);
    if ((localbfla != null) && (localbfla.a())) {
      return this.b;
    }
    return "DEVICE_NONE";
  ...
  String g()
  {
    bfla localbfla = (bfla)this.jdField_a_of_type_JavaUtilHashMap.get(this.jdField_a_of_type_JavaLangString);
    if ((localbfla != null) && (localbfla.a())) {
