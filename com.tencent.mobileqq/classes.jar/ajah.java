...
public class ajah
{
  ...
  private HashMap<Integer, ajaj> jdField_a_of_type_JavaUtilHashMap;
  
  public ajah(int paramInt)
  {
  ...
  private int a()
  {
    for (;;)
    {
      try
      {
        ...
        if ((localObject == null) || (((ajch)localObject).a() == null)) {
          break label105;
        }
        i = ((ajch)localObject).a().getMeasuredHeight();
        if (i == 0)
        {
          localObject = a();
          if (localObject != null)
  ...
  private void a(long paramLong, int paramInt1, int paramInt2, int paramInt3)
  {
    try
    {
      ...
      ajae.a().callbackFromRequest(paramLong, paramInt2, "sc.game_ad_banner_load.local", localJSONObject.toString());
      return;
    }
    catch (Throwable localThrowable)
    {
