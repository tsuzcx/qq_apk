  ...
  implements bbmi
{
  ...
  private apal jdField_a_of_type_Apal;
  ...
  public apak(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a()
  {
    ...
    try
    {
      ...
      bbmg localbbmg = new bbmg(this.jdField_a_of_type_JavaLangString, null, this, true);
      String str = "gprs";
      ...
      QLog.d("ZipThumbDownloader", 1, "[downloadThumb]  ID[" + this.jdField_a_of_type_Long + "] start runDownload... , url[" + this.jdField_a_of_type_JavaLangString + "] data RANGE[" + String.valueOf("bytes=0-") + "], peerType[" + String.valueOf(localbbmg.jdField_c_of_type_Int) + "]");
      localbbmg.a("Accept-Encoding", "identity");
      if (!TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
        localbbmg.a("Cookie", this.jdField_b_of_type_JavaLangString);
      }
    ...
    catch (FileNotFoundException localFileNotFoundException)
    {
      ...
      {
        a(true);
      } while (this.jdField_a_of_type_Apal == null);
      this.jdField_a_of_type_Apal.a(this.jdField_a_of_type_JavaLangString, false, -2, null, this.jdField_a_of_type_Long);
    }
  }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        if (paramBoolean) {
          apvb.c(this.jdField_d_of_type_JavaLangString);
        }
        return;
  ...
  public void a(long paramLong, String paramString1, String paramString2, apal paramapal)
  {
    this.jdField_a_of_type_Long = paramLong;
    this.jdField_a_of_type_JavaLangString = paramString2;
    this.jdField_c_of_type_JavaLangString = paramString1;
    this.jdField_d_of_type_JavaLangString = (paramString1 + ".tmp");
    this.jdField_a_of_type_Apal = paramapal;
  ...
  public void a(bbmg parambbmg1, bbmg parambbmg2)
  {
    ...
    long l1 = -1L;
    if (parambbmg2 != null) {
      l1 = Long.parseLong(parambbmg2.jdField_a_of_type_JavaLangString);
    }
    ...
    do
    {
      do
      {
        ...
        this.jdField_a_of_type_Apal.a(this.jdField_a_of_type_JavaLangString, false, -7, null, this.jdField_a_of_type_Long);
        return;
      } while ((parambbmg2.c() != 206) && (parambbmg2.c() != 200));
      if (this.jdField_a_of_type_JavaIoFileOutputStream != null) {
        break;
      }
      a(true);
    } while (this.jdField_a_of_type_Apal == null);
    this.jdField_a_of_type_Apal.a(this.jdField_a_of_type_JavaLangString, false, -8, null, this.jdField_a_of_type_Long);
    return;
    for (;;)
    {
      try
      {
        this.jdField_a_of_type_JavaIoFileOutputStream.write(parambbmg2.a());
      ...
      catch (Exception parambbmg1)
      {
        try
        {
          ...
          a(false);
          if (bbdj.b(new File(this.jdField_d_of_type_JavaLangString), new File(this.jdField_c_of_type_JavaLangString))) {
            break label615;
          }
          i = -9;
          QLog.e("ZipThumbDownloader", 1, "decode : [downloadThumb] = " + this.jdField_a_of_type_Long + " renameFile failed");
          if (this.jdField_a_of_type_Apal == null) {
            break;
          }
          this.jdField_a_of_type_Apal.a(this.jdField_a_of_type_JavaLangString, bool, i, this.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_Long);
          return;
        }
      ...
      this.jdField_a_of_type_Apal.a(this.jdField_a_of_type_JavaLangString, i);
      return;
      label615:
      i = 0;
      bool = true;
  ...
  public void b(bbmg parambbmg1, bbmg parambbmg2)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Apal.a(this.jdField_a_of_type_JavaLangString, false, -1, null, this.jdField_a_of_type_Long);
      return;
    ...
    this.jdField_a_of_type_Apal.a(this.jdField_a_of_type_JavaLangString, false, -3, null, this.jdField_a_of_type_Long);
    return;
    if (parambbmg1 == null)
    {
      i = -6;
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Apal.a(this.jdField_a_of_type_JavaLangString, false, i, null, this.jdField_a_of_type_Long);
      return;
      if (!parambbmg2.d())
      {
        i = -4;
      ...
      else
      {
        if (this.jdField_b_of_type_Int < 3)
        {
          ...
          for (this.jdField_d_of_type_Int += 1;; this.jdField_d_of_type_Int = 0)
          {
            a(true);
            if (this.jdField_a_of_type_Apal != null) {
              this.jdField_a_of_type_Apal.a(this.jdField_a_of_type_JavaLangString);
            }
