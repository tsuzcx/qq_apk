...
public class vta
{
  ...
  public void a()
  {
    ...
    if (localMessenger != null) {
      for (;;)
      {
        ...
        try
        {
          vsx.b("RMWServiceProxy", "client.flush : " + vsy.a(localMessage));
          localMessenger.send(localMessage);
        }
        catch (RemoteException localRemoteException)
        {
          vsx.a("RMWServiceProxy", "sendMessageToService error", new Object[] { localRemoteException });
        }
      }
    }
    vsx.b("RMWServiceProxy", "can not flushMessageQueue, service state invalid : " + a(this.jdField_a_of_type_Int));
  }
  ...
  protected void a(ComponentName paramComponentName)
  {
    ...
    vsx.b("RMWServiceProxy", "onServiceDisconnected " + a(this.jdField_a_of_type_Int));
    this.jdField_a_of_type_Vte.notifyObservers(new vtd(this.jdField_a_of_type_Int));
    if (this.jdField_a_of_type_Vtc != null)
    {
      this.jdField_a_of_type_Vtc.a();
      this.jdField_a_of_type_Vtc = null;
    }
  }
  ...
  protected void a(ComponentName paramComponentName, IBinder paramIBinder)
  {
    try
    {
      paramIBinder.linkToDeath(new vtb(this, paramComponentName), 0);
      this.jdField_a_of_type_AndroidOsMessenger = new Messenger(paramIBinder);
      this.jdField_a_of_type_Int = 2;
      vsx.b("RMWServiceProxy", "onServiceConnected " + a(this.jdField_a_of_type_Int));
      a();
      this.jdField_a_of_type_Vte.notifyObservers(new vtd(this.jdField_a_of_type_Int));
      return;
    }
    ...
    {
      vsx.c("RMWServiceProxy", "linkToDeath failed : " + paramComponentName);
  ...
  {
    vsx.a("RMWServiceProxy", "setup, current state = " + a(this.jdField_a_of_type_Int) + ", force = " + paramBoolean);
    b();
    if (this.jdField_a_of_type_AndroidContentContext == null)
    {
      vsx.c("RMWServiceProxy", "setup but without context, give up");
      return;
    }
    ...
    if (this.jdField_b_of_type_Int > 0)
    {
      ...
      vsx.c("RMWServiceProxy", "setup again because of remote died, retry count left = " + this.jdField_b_of_type_Int);
      this.jdField_a_of_type_Int = 1;
      vsx.a("RMWServiceProxy", "connecting ... " + a(this.jdField_a_of_type_Int));
      if (this.jdField_a_of_type_Vtc == null) {
        this.jdField_a_of_type_Vtc = new vtc(this);
      }
      Intent localIntent = new Intent(this.jdField_a_of_type_AndroidContentContext, RMWService.class);
      this.jdField_a_of_type_AndroidContentContext.bindService(localIntent, this.jdField_a_of_type_Vtc, 1);
      return;
    }
    vsx.c("RMWServiceProxy", "give up setup again");
  }
}
