...
public class aqgs
  ...
  implements aqgr
{
  private static volatile aqgs a;
  ...
  public void a(long paramLong1, long paramLong2, String paramString1, String paramString2, long paramLong3, SpannableString paramSpannableString)
  {
    ...
    for (;;)
    {
      paramSpannableString = (QQAppInterface)bojl.a();
      str = bglf.h(paramSpannableString, String.valueOf(paramString2), paramSpannableString.getAccount());
      paramString1 = new DanmuItemBean(Long.parseLong(paramSpannableString.c()), 0L, paramLong1, paramLong2, paramString1, str);
      paramString1.jdField_a_of_type_Boolean = njo.a().a(paramString2);
      if (paramString1.jdField_a_of_type_Boolean)
      {
        if (QLog.isColorLevel()) {
          QLog.d("DanmuDataIPCServer", 2, "notifyDanmuSendResult, anonymousFlag true");
        }
        paramSpannableString = njo.a().a(paramString2);
  ...
  public void a(aqgl paramaqgl, boolean paramBoolean1, boolean paramBoolean2, int paramInt, ArrayList<DanmuItemBean> paramArrayList, List<Long> paramList)
  {
    ...
    localBundle.putLong("key_barrage_msg_seq", paramaqgl.jdField_a_of_type_Long);
    localBundle.putLong("key_barrage_grp_uin", paramaqgl.b);
    localBundle.putInt("key_barrage_topic_type", paramaqgl.jdField_a_of_type_Int);
    localBundle.putInt("key_barrage_interval_time", paramInt);
    localBundle.putBoolean("key_barrage_is_success", paramBoolean1);
    if (paramaqgl.c > 0L)
    {
      localBundle.putLong("key_barrage_req_time", paramaqgl.c);
      localBundle.putLong("key_barrage_net_req_time", paramaqgl.d);
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if ("qipc_action_get_barrage".equals(paramString))
    {
      ...
      localObject = aqgm.a().a(aqgm.a().a(l2, l1));
      if ((localObject != null) && (!((aqgn)localObject).jdField_a_of_type_Boolean))
      {
    ...
    label262:
    for (Object localObject = new aqgl(l2, l1, i, bool);; localObject = ((aqgn)localObject).jdField_a_of_type_Aqgl)
    {
      ((aqgl)localObject).c = paramBundle.getLong("key_barrage_req_time");
      ((aqgl)localObject).d = System.currentTimeMillis();
      ((aqgl)localObject).jdField_a_of_type_Boolean = bool;
      aqgm.a().a((aqgl)localObject, this);
