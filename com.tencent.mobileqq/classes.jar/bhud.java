...
public class bhud
{
  ...
  public static void a(bcdp parambcdp, String... paramVarArgs)
  {
    ...
    if ((parambcdp.a() == null) || (parambcdp.a() == null)) {
      return;
    }
    LocalMultiProcConfig.putInt4Uin("key_personalize_prefix_19", 0, Long.valueOf(parambcdp.a().getCurrentAccountUin()).longValue());
  ...
  public static void b(bcdp parambcdp, String... paramVarArgs)
  {
    ...
    if ((!TextUtils.isEmpty(localObject2)) && (parambcdp.a() != null))
    {
  ...
  public static void c(bcdp parambcdp, String... paramVarArgs)
  {
    if (QLog.isColorLevel()) {
    ...
    if (parambcdp != null) {
      parambcdp.callJs("window.QzAvatarDressJSInterface.onReceive({type:\"idlist\",data:\"" + paramVarArgs + "\"});");
    }
  }
}
