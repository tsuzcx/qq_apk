  ...
  extends bcqa
{
  ...
  public bcqc(bcpx parambcpx, int paramInt)
  {
    super(parambcpx, paramInt);
    this.jdField_b_of_type_ComTencentMobileqqHighwayApiITransactionCallback = new bcqd(this);
  }
  
  public void a()
  {
    String str1 = this.jdField_a_of_type_Bcpx.jdField_b_of_type_JavaLangString;
    String str2 = this.jdField_a_of_type_Bcpx.jdField_a_of_type_JavaLangString;
  ...
  protected boolean b(String paramString)
  {
    ...
    do
    {
      ...
      localPttShortVideoFileInfo.uint32_file_time.set((int)this.jdField_a_of_type_Bcpx.jdField_a_of_type_Long);
