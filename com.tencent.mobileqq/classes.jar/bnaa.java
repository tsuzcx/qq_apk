...
{
  private static final String jdField_a_of_type_JavaLangString = bnaa.class.getSimpleName();
  ...
  public bnaa(int paramInt1, int paramInt2)
  {
  ...
  private void d()
  {
    this.jdField_a_of_type_Bnac = new bnac();
    this.jdField_a_of_type_Bnac.a();
    if (this.jdField_b_of_type_Boolean) {
      Log.d(jdField_a_of_type_JavaLangString, "textureID=" + this.jdField_a_of_type_Bnac.a());
    }
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture = new SurfaceTexture(this.jdField_a_of_type_Bnac.a());
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Bnac = null;
  ...
  {
    this.jdField_a_of_type_Bnac.a(this.jdField_a_of_type_AndroidGraphicsSurfaceTexture, paramBoolean);
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Bnac.a("before updateTexImage");
