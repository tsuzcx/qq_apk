  ...
  implements zlz
{
  ...
  public zlx(AppInterface paramAppInterface, boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  public void a(@NonNull ArrayList<zma> paramArrayList, @NonNull Context paramContext)
  {
    ...
    if (this.jdField_a_of_type_Boolean) {
      paramArrayList.add(new zma(paramContext.getResources().getDrawable(2130846791), 1, 0));
    }
      ...
      if (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null)
      {
        ...
        if (bool)
        {
          ...
          if ((localObject4 != null) && (!((ArrayList)localObject4).isEmpty()))
          {
            ...
            do
            {
              localObject4 = localzma1;
              localObject5 = localObject2;
              localObject6 = localObject3;
              localObject7 = localzma2;
            ...
            {
              localObject4 = new zma(paramContext.getResources().getDrawable(2130845071), 2, i);
    ...
    for (;;)
    {
      ...
      {
        localzma1 = new zma(paramContext.getResources().getDrawable(2130845072), 2, i);
      ...
      {
        localObject4 = new zma(paramContext.getResources().getDrawable(2130845073), 2, i);
        localObject3 = localObject1;
        localObject1 = localObject2;
      ...
      {
        localObject4 = new zma(paramContext.getResources().getDrawable(2130845070), 2, i);
        localObject1 = localObject2;
        localObject2 = localObject3;
        localObject3 = localObject4;
      }
      ...
      {
        localzma2 = new zma(paramContext.getResources().getDrawable(2130845069), 2, i);
        localObject4 = localObject1;
        localObject1 = localObject2;
        localObject2 = localObject3;
        localObject3 = localObject4;
        ...
        paramArrayList.add(new zma(paramContext.getResources().getDrawable(2130846783), 0, -1));
        int k = 0;
