...
public class born
{
  ...
  public static born a()
  {
    if (jdField_a_of_type_Born == null) {}
    try
    {
      if (jdField_a_of_type_Born == null) {
        jdField_a_of_type_Born = new born();
      }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    if (str != null)
    {
      ...
      {
        if (!bork.a(new File(paramString2), new File(str))) {
          break label135;
        }
    ...
    if (bork.a(paramString2, (byte[])localObject, arrayOfByte, arrayOfByte.length, 0.0D))
    {
      if (!QLog.isColorLevel()) {
        break label185;
      }
