  ...
  implements Manager
{
  ...
  private ArrayList<bgpa> jdField_a_of_type_JavaUtilArrayList;
  ...
  private ArrayList<bdec> jdField_c_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public bddy(QQAppInterface paramQQAppInterface)
  {
  ...
  public static int a(QQAppInterface paramQQAppInterface)
  {
    ...
    bddy localbddy = (bddy)paramQQAppInterface.getManager(62);
    if (localbddy != null) {}
    for (int i = localbddy.a(paramQQAppInterface.c() + "_all_third_last_msg_time");; i = 0)
    {
      if (QLog.isColorLevel()) {
  ...
  public static int a(QQAppInterface paramQQAppInterface, acvy paramacvy)
  {
    int i;
    if ((paramQQAppInterface == null) || (!paramQQAppInterface.isRunning()) || (paramacvy == null))
    {
      i = 0;
      return i;
    }
    ...
    if (localbdeh != null)
    {
      Iterator localIterator = localbdeh.b().iterator();
      i = 0;
      j = i;
      ...
      if ((localObject == null) || (TextUtils.isEmpty(((SubAccountInfo)localObject).subuin)) || (localbdeh.a(((SubAccountInfo)localObject).subuin) != 1)) {
        break label238;
      }
    }
    label179:
    label191:
    label238:
    for (int j = paramacvy.a(((SubAccountInfo)localObject).subuin, 7000);; j = 0)
    {
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    do
    {
      ...
      j = localbddy.a(paramQQAppInterface.c() + "_" + paramString + "_msgNum");
      i = j;
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    paramQQAppInterface = (bddy)paramQQAppInterface.getManager(62);
  ...
  private int a(String paramString)
  {
    ...
    try
    {
      ...
      if (localObject != null)
      {
        i = ((Integer)((bdec)localObject).jdField_a_of_type_JavaLangObject).intValue();
        return i;
      }
      ...
      if (localObject != null)
      {
        ...
        if (this.jdField_c_of_type_JavaUtilArrayList != null) {
          this.jdField_c_of_type_JavaUtilArrayList.add(new bdec(paramString, Integer.valueOf(i)));
        }
        return i;
      }
      return 0;
  ...
  private bdec a(String paramString)
  {
    if (this.jdField_c_of_type_JavaUtilArrayList != null) {
      try
      {
        ...
        while (i < j)
        {
          ...
          for (bdec localbdec = (bdec)this.jdField_c_of_type_JavaUtilArrayList.get(i); localbdec != null; localbdec = null)
          {
            boolean bool = TextUtils.equals(localbdec.jdField_a_of_type_JavaLangString, paramString);
            if (!bool) {
              break;
            }
            return localbdec;
  ...
  public static bded a(QQAppInterface paramQQAppInterface, String paramString)
  {
    bded localbded = new bded();
    ...
    if (i > 0)
    {
      localbded.jdField_a_of_type_Int = i;
      return localbded;
    }
    ...
    {
      localbded.jdField_a_of_type_Int = i;
      localbded.jdField_a_of_type_Boolean = true;
    }
    return localbded;
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt, String paramString2)
  {
    ...
    for (;;)
    {
      paramQQAppInterface = bglf.b(paramQQAppInterface, paramString2, true);
      ...
      return paramString1;
      paramString1 = localBaseApplication.getString(2131689582);
      continue;
      paramString1 = localBaseApplication.getString(2131689497);
      continue;
      paramString1 = localBaseApplication.getString(2131689496);
      continue;
      paramString1 = localBaseApplication.getString(2131717293);
      continue;
      paramString1 = localBaseApplication.getString(2131689619);
    }
  ...
  private String a(String paramString)
  {
    ...
    try
    {
      ...
      if (localObject != null)
      {
        paramString = (String)((bdec)localObject).jdField_a_of_type_JavaLangObject;
        return paramString;
      }
      localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getSharedPreferences("qq_subaccount_associated_cache", 0);
      if (localObject != null)
      {
        ...
        if (this.jdField_c_of_type_JavaUtilArrayList != null) {
          this.jdField_c_of_type_JavaUtilArrayList.add(new bdec(paramString, localObject));
        }
        return localObject;
      }
      return "";
  ...
  public static ArrayList<String> a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (localbddy != null)
    {
      ...
      localbddy.jdField_b_of_type_JavaUtilConcurrentLocksLock.lock();
    }
    for (;;)
    {
      try
      {
        bdec localbdec = localbddy.a(paramString);
        if (localbdec != null)
        {
          localArrayList.addAll((ArrayList)localbdec.jdField_a_of_type_JavaLangObject);
          localbddy.jdField_b_of_type_JavaUtilConcurrentLocksLock.unlock();
          if (QLog.isColorLevel()) {
        ...
        {
          localbddy.jdField_c_of_type_JavaUtilArrayList.add(new bdec(paramString, localArrayList));
          continue;
        }
        i += 1;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject2 = (bdeh)paramQQAppInterface.getManager(61);
      } while (localObject2 == null);
      long l1 = bglj.a().a(paramQQAppInterface.getApp());
      long l2 = ardl.a(paramQQAppInterface.getApp());
      if (QLog.isColorLevel()) {
      ...
      if (l1 < l2)
      {
        if (l1 == 0L)
        {
          ...
          bool = bglj.a().a(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount());
          localObject1 = ((bdeh)localObject2).a("sub.uin.default");
          if ((localObject1 != null) && (((SubAccountInfo)localObject1).subuin != null))
          {
            ((bdeh)localObject2).h(((SubAccountInfo)localObject1).subuin);
            i = ((bdeh)localObject2).c(((SubAccountInfo)localObject1).subuin) - paramQQAppInterface.a().a(((SubAccountInfo)localObject1).subuin, 7000);
            if (i != 0)
            {
              paramQQAppInterface.a().d(((SubAccountInfo)localObject1).subuin, 7000, i);
              paramQQAppInterface.a().a(new String[] { anhk.x, ((SubAccountInfo)localObject1).subuin });
            }
            if (bool)
            {
              if (QLog.isColorLevel()) {
          ...
          bglj.a().a(paramQQAppInterface.getApp());
        }
      }
      else
      {
        if (!bglj.a().b(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount()))
        {
          if (QLog.isColorLevel()) {
            QLog.d("SUB_ACCOUNT", 2, "initAllData() showedBefore:false, isFirstTime to user SubAccount.");
          }
          bglj.a().a(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), true);
          a(paramQQAppInterface, 7);
        }
        localObject1 = paramQQAppInterface.a().a();
        localObject3 = (RecentUser)((aong)localObject1).findRecentUser(anhk.x, 7000);
        if (((bdeh)localObject2).a() <= 0) {
          break label791;
        }
        if (QLog.isColorLevel()) {
          QLog.d("SUB_ACCOUNT", 2, "initAllData() getBindedNumber > 0, go to initAllData");
        }
        localObject4 = ((bdeh)localObject2).b();
      ...
      for (;;)
      {
        ...
        if ((localObject3 != null) && (l1 == 0L))
        {
          ...
          if (localObject2 != null) {
            j = ((bdeh)localObject2).c(localSubAccountInfo.subuin);
          }
          int n = j - m;
          if (QLog.isColorLevel()) {
          ...
          if (n != 0)
          {
            ...
            paramQQAppInterface.a().a(new String[] { anhk.x, localSubAccountInfo.subuin });
          }
        }
        bool = false;
        ...
        if (bool) {
          paramQQAppInterface.getSubAccountKey(paramQQAppInterface.getAccount(), localSubAccountInfo.subuin, new bddz(paramQQAppInterface));
        }
      }
      if (QLog.isColorLevel()) {
        QLog.d("SUB_ACCOUNT", 2, "initAllData() delete subaccount recentuser, add default subaccount box");
      }
      Object localObject2 = ((bdeh)localObject2).b();
      int j = ((ArrayList)localObject2).size();
      int i = 0;
      if (i < j)
      {
        localObject3 = (SubAccountInfo)((ArrayList)localObject2).get(i);
        if ((localObject3 == null) || (anhk.x.equals(((SubAccountInfo)localObject3).subuin))) {}
        for (;;)
        {
          i += 1;
          break;
          localObject3 = (RecentUser)((aong)localObject1).findRecentUser(((SubAccountInfo)localObject3).subuin, 7000);
          if (localObject3 != null) {
            ((aong)localObject1).delRecentUser((BaseRecentUser)localObject3);
          }
        }
      }
      localObject2 = (RecentUser)((aong)localObject1).findRecentUser(anhk.x, 7000);
      ...
      {
        a(paramQQAppInterface, (aong)localObject1, anhk.x, 7);
  ...
  public static void a(QQAppInterface paramQQAppInterface, byte paramByte, ArrayList<String> paramArrayList)
  {
    ...
    for (paramArrayList = (String)localIterator.next();; paramArrayList = null)
    {
      try
      {
        ...
        Object localObject2 = (bdeh)paramQQAppInterface.getManager(61);
        if (localObject2 == null) {
          continue;
        }
        paramArrayList = ((bdeh)localObject2).a(paramArrayList);
        if (paramArrayList == null)
        {
      ...
      catch (Exception localException)
      {
        for (;;)
        {
          ...
          long l1 = 0L;
          continue;
          paramArrayList = bgmj.a(paramArrayList);
          continue;
          label377:
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    if (localObject != null)
    {
      ...
      for (;;)
      {
        ...
        if ((localRecentUser != null) && (localRecentUser.getType() == 7000) && (!anhk.x.equals(localRecentUser.uin)))
        {
          if (QLog.isColorLevel()) {
    ...
    a(paramQQAppInterface, localaong, anhk.x, i);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, RecentItemSubAccount paramRecentItemSubAccount, MsgSummary paramMsgSummary)
  {
    ...
    {
      return;
      localbdeh = (bdeh)paramQQAppInterface.getManager(61);
      if (localbdeh != null) {
        break;
      }
    } while (!QLog.isColorLevel());
    ...
    return;
    ArrayList localArrayList = localbdeh.b();
    Object localObject1 = new ArrayList();
    ...
    {
      paramMsgSummary.strContent = paramContext.getString(2131718294);
      if (QLog.isColorLevel()) {
    ...
    int k = a(paramQQAppInterface, localacvy);
    int m = b(paramQQAppInterface, localacvy);
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((localSubAccountInfo == null) || (TextUtils.isEmpty(localSubAccountInfo.subuin)) || (localbdeh.a(localSubAccountInfo.subuin) != 1)) {
          continue;
        }
        localObject8 = localbdeh.a(localSubAccountInfo.subuin);
        ...
        if (localObject8 != null)
        {
          ...
          if (((List)localObject8).size() > 0)
          {
            ...
            localObject6 = null;
            if (!anhk.aD.equals(((SubAccountMessage)localObject7).senderuin)) {
              break label1381;
            }
        ...
        if (((bded)localObject1).jdField_a_of_type_Boolean)
        {
          i = ((bded)localObject1).jdField_a_of_type_Int + i;
          break label1362;
        }
        j = ((bded)localObject1).jdField_a_of_type_Int + j;
        break label1362;
        if ((localObject1 != null) && (localObject3 != null))
        {
          paramMsgSummary.strContent = paramContext.getString(2131718256);
          ...
          localObject4 = (aqtu)aqlk.a().a(607);
          if ((j <= 0) && ((j != 0) || (i != 0))) {
            continue;
          }
          ...
          if (((((SubAccountMessage)localObject3).mEmoRecentMsg == null) || (((SubAccountMessage)localObject3).mEmoRecentMsg.length() == 0)) && (((SubAccountMessage)localObject3).msg != null)) {
            ((SubAccountMessage)localObject3).mEmoRecentMsg = new bdnt(((SubAccountMessage)localObject3).msg, 3, 16);
          }
          ...
          paramRecentItemSubAccount.mMsgExtroInfo = ("[" + paramContext.getString(2131716033) + "]");
      ...
      catch (Throwable localThrowable)
      {
        ...
        if ((k > 0) && (localacvy != null))
        {
          ...
          if (((Iterator)localObject2).hasNext())
          {
            ...
            i = localacvy.a(((SubAccountInfo)localObject3).subuin, 7000);
            if (i > 0)
            {
            ...
            paramMsgSummary.strContent = ((CharSequence)localObject6);
            continue;
            if ((i <= 0) || (localObject4 == null) || (((aqtu)localObject4).jdField_a_of_type_Boolean)) {
              break;
            }
  ...
  private static void a(QQAppInterface paramQQAppInterface, aong paramaong, String paramString, int paramInt)
  {
    int i = 1;
    if (QLog.isColorLevel()) {
    ...
    if ((paramString == null) || (paramString.length() == 0) || (paramInt == 0)) {
      if (QLog.isColorLevel())
      {
        paramaong = new StringBuilder().append("updateRecentUser() return,");
        if (paramString != null) {
          break label103;
        }
    ...
    do
    {
      ...
      {
        localRecentUser = (RecentUser)paramaong.findRecentUser(paramString, 7000);
        if (localRecentUser != null) {
          paramaong.delRecentUser(localRecentUser);
        }
      }
      localRecentUser = (RecentUser)paramaong.findRecentUser(anhk.x, 7000);
      if (localRecentUser != null) {
        break label661;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity)
  {
    ...
    localObject1 = paramBaseActivity.getString(2131718298);
    Object localObject2 = paramBaseActivity.getString(2131718274, new Object[] { Integer.valueOf(2) });
    localObject1 = bglp.a(paramBaseActivity, 230).setTitle((String)localObject1).setMessage((CharSequence)localObject2);
    ((bgpa)localObject1).setOwnerActivity(paramBaseActivity);
    ((bgpa)localObject1).setPositiveButton(paramBaseActivity.getString(2131718286), new bdeb(paramQQAppInterface, paramBaseActivity));
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    {
      paramString = (bdeh)paramQQAppInterface.getManager(61);
      if (paramString == null) {
        break label183;
      }
    }
      ...
      if (paramString != null)
      {
        ...
        while (paramString.hasNext())
        {
          ...
          if (!"sub.uin.all".equals(localObject))
          {
            ...
            if (paramQQAppInterface != null)
            {
              localObject = (bdeh)paramQQAppInterface.getManager(61);
              if (localObject != null)
              {
                ((bdeh)localObject).a(paramString);
                ((bdeh)localObject).d(paramString);
                if (bglf.c(paramQQAppInterface, paramString, false) != null) {
                  break;
                }
              }
            }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    if ((!anhk.x.equals(paramString)) && ((paramString == null) || (paramString.length() < 5))) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      return;
      aong localaong = paramQQAppInterface.a().a();
      if (((RecentUser)localaong.findRecentUser(anhk.x, 7000) != null) && (QLog.isColorLevel())) {
        QLog.d("SUB_ACCOUNT", 2, "bindRecentItem() bind, delete defaultRU");
      }
      a(paramQQAppInterface, localaong, paramString, paramInt);
    } while (!QLog.isColorLevel());
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, ArrayList<String> paramArrayList, int paramInt1, int paramInt2)
  {
    ...
    {
      return;
      localbddy = (bddy)paramQQAppInterface.getManager(62);
    } while (localbddy == null);
    ...
    for (;;)
    {
      try
      {
        paramString2 = localbddy.a(paramString1);
        ...
        if (paramString2 != null) {
          ...
          localbddy.jdField_c_of_type_JavaUtilArrayList.add(new bdec(paramString1, localArrayList));
        }
      }
      finally
      {
    ...
    localbddy.a(paramString1 + "_sysTime", Integer.valueOf(paramInt1));
    localbddy.jdField_b_of_type_Long = paramInt2;
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    do
    {
      do
      {
        ...
        paramString1 = (bddy)paramQQAppInterface.getManager(62);
      } while (paramString1 == null);
      paramQQAppInterface = paramQQAppInterface.c() + "_" + paramString2;
      paramString2 = bgva.a(paramArrayOfByte);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    if (anhk.x.equals(paramString)) {
      if (paramBoolean) {
        a(paramQQAppInterface, paramQQAppInterface.a().a(), anhk.x, 7);
      }
    }
    for (;;)
    {
      ...
      paramQQAppInterface.sendEmptyMessage(1009);
      return;
      ((bdeh)paramQQAppInterface.getManager(61)).a(paramString, paramBoolean);
      aong localaong = paramQQAppInterface.a().a();
      if (paramBoolean) {
        a(paramQQAppInterface, localaong, paramString, 4);
      } else {
        a(paramQQAppInterface, localaong, paramString, 5);
      }
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, ArrayList<String> paramArrayList, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (((RecentUser)((aong)localObject).findRecentUser(anhk.x, 7000) != null) && (QLog.isColorLevel())) {
        QLog.d("SUB_ACCOUNT", 2, "bindRecentItem() bind, delete defaultRU");
      }
      ...
      while (paramArrayList.hasNext())
      {
        ...
        a(paramQQAppInterface, (aong)localObject, str, paramInt);
        if (QLog.isColorLevel()) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    localbddy.a(paramQQAppInterface.c() + "_display_third_qq_checked", String.valueOf(paramBoolean));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean, String paramString)
  {
    ...
    for (;;)
    {
      ...
      if ((localbdeh != null) && (paramQQAppInterface != null))
      {
        Iterator localIterator = localbdeh.a().iterator();
        while (localIterator.hasNext())
        {
          String str = (String)localIterator.next();
          if (!TextUtils.isEmpty(str))
          {
            int i = localbdeh.c(str);
            localbdeh.b(str);
            if ((paramBoolean) || (i > 0))
            {
              if (QLog.isColorLevel()) {
              ...
              aofz localaofz = paramQQAppInterface.a();
              if (localaofz != null) {
                localaofz.a(str, paramString);
              }
            }
          }
        }
    ...
    do
    {
      ...
      do
      {
        ...
        do
        {
          ...
          localbdeh = (bdeh)paramQQAppInterface.getManager(61);
          paramQQAppInterface = (MessageHandler)paramQQAppInterface.a(0);
        } while ((localbdeh == null) || (paramQQAppInterface == null));
        i = localbdeh.c(paramString2);
        localbdeh.b(paramString2);
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    bddy localbddy = (bddy)paramQQAppInterface.getManager(62);
    if (localbddy != null) {
      return localbddy.a(paramQQAppInterface.c() + "_all_third_last_msg_time", Integer.valueOf(paramInt));
    }
    return false;
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, SimpleAccount paramSimpleAccount)
  {
    ...
    paramSimpleAccount = localbddy.a(paramQQAppInterface + "_last_cookie");
    if (!TextUtils.isEmpty(paramSimpleAccount)) {
      localbddy.a(paramQQAppInterface + "_cookie", paramSimpleAccount);
    }
    localbddy.a(paramQQAppInterface + "_msgNum", Integer.valueOf(0));
    localbddy.a(paramQQAppInterface + "_msgFlag", Integer.valueOf(0));
    localbddy.a(paramQQAppInterface + "_redBagTime", Integer.valueOf(0));
    if (QLog.isColorLevel()) {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (paramQQAppInterface != null)
    {
      ...
      localObject = ((bdeh)localObject).a();
      label45:
      paramQQAppInterface = (bddy)paramQQAppInterface.getManager(62);
      bool1 = bool2;
      if (paramQQAppInterface != null) {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    label381:
    for (Object localObject = ((bdeh)localObject).a(paramString);; localObject = null)
    {
      bdee localbdee = (bdee)paramQQAppInterface.getManager(28);
      if (localbdee != null)
      {
        paramBoolean = localbdee.a();
        if (!paramBoolean)
        {
          localObject = new bdei();
          ((bdei)localObject).jdField_a_of_type_JavaLangString = "";
          ((bdei)localObject).b = paramQQAppInterface.getAccount();
          ((bdei)localObject).c = paramString;
          ((bdei)localObject).jdField_a_of_type_Int = 1009;
      ...
      if ((paramString == null) || (paramString.length() == 0) || (localObject == null) || (((String)localObject).length() == 0) || (((String)localObject).trim().equals("")))
      {
        ...
        ((bdei)localObject).b = paramQQAppInterface.getAccount();
        ((bdei)localObject).c = paramString;
        ((bdei)localObject).jdField_a_of_type_Int = 1010;
        paramQQAppInterface.a().notifyUI(8003, false, localObject);
        return false;
      }
      if (QLog.isColorLevel()) {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    if (localbddy != null)
    {
      if (!localbddy.jdField_b_of_type_Boolean) {
        return false;
      }
      if (BaseActivity.mAppForground)
      {
        bool = localbddy.d(paramQQAppInterface, paramBoolean);
        paramBoolean = bool;
        if (bool) {
          localbddy.b(paramQQAppInterface);
        }
      }
      for (paramBoolean = bool;; paramBoolean = bool)
      {
        if ((!paramBoolean) && (localbddy.jdField_c_of_type_JavaLangRunnable != null)) {
          ThreadManager.getSubThreadHandler().removeCallbacks(localbddy.jdField_c_of_type_JavaLangRunnable);
        }
        return paramBoolean;
        localbddy.jdField_a_of_type_Boolean = true;
      }
    }
    return false;
  }
  ...
  private boolean a(String paramString, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localObject == null)
        {
          this.jdField_c_of_type_JavaUtilArrayList.add(new bdec(paramString, paramObject));
          bool1 = true;
          this.jdField_b_of_type_JavaUtilConcurrentLocksLock.unlock();
          bool2 = bool1;
          if (!bool1) {
        ...
        if (((paramObject instanceof Integer)) && ((((bdec)localObject).jdField_a_of_type_JavaLangObject instanceof Integer)))
        {
          if ((Integer)((bdec)localObject).jdField_a_of_type_JavaLangObject == (Integer)paramObject) {
            break label346;
          }
          bool2 = true;
          bool1 = bool2;
          ...
          ((bdec)localObject).jdField_a_of_type_JavaLangObject = paramObject;
          bool1 = bool2;
          continue;
        }
      ...
      if ((((bdec)localObject).jdField_a_of_type_JavaLangObject instanceof String))
      {
        bool1 = TextUtils.equals((String)((bdec)localObject).jdField_a_of_type_JavaLangObject, (String)paramObject);
        if (!bool1)
        {
          bool2 = true;
          continue;
  ...
  public static byte[] a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (localbddy != null)
    {
      paramQQAppInterface = localbddy.a(paramQQAppInterface.c() + "_" + paramString + "_cookie");
      if (!TextUtils.isEmpty(paramQQAppInterface)) {
        return bgva.a(paramQQAppInterface);
      }
    }
    return null;
  }
  
  public static int b(QQAppInterface paramQQAppInterface, acvy paramacvy)
  {
    int i;
    if ((paramQQAppInterface == null) || (!paramQQAppInterface.isRunning()) || (paramacvy == null))
    {
    ...
    label192:
    label240:
    for (int j = paramacvy.b(((SubAccountInfo)localObject).subuin, 7000);; j = 0)
    {
      StringBuilder localStringBuilder;
      if (QLog.isColorLevel())
      {
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    do
    {
      ...
      paramString = (bddy)paramQQAppInterface.getManager(62);
  ...
  public static void b(QQAppInterface paramQQAppInterface, boolean paramBoolean, String paramString)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject1 = (bddy)paramQQAppInterface.getManager(62);
        if (localObject1 == null) {
          break label110;
        }
        l1 = System.currentTimeMillis();
        l2 = (l1 - ((bddy)localObject1).jdField_c_of_type_Long) / 1000L;
        if (l2 >= ((bddy)localObject1).jdField_b_of_type_Long) {
          break;
        }
      } while (!QLog.isColorLevel());
      QLog.d("SUB_ACCOUNT", 2, "getSubAccountSpecialCareListFromService skip adviseGap=" + ((bddy)localObject1).jdField_b_of_type_Long + "  realGap=" + l2);
      return;
      ((bddy)localObject1).jdField_c_of_type_Long = l1;
      localObject1 = (bdeh)paramQQAppInterface.getManager(61);
    } while (localObject1 == null);
    Object localObject2 = new ArrayList();
    if (paramBoolean) {
      ((List)localObject2).addAll(((bdeh)localObject1).b());
    }
    for (;;)
    {
      ...
      break;
      ((List)localObject2).add(((bdeh)localObject1).a(paramString));
    }
  }
  ...
  public static void c(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      return;
      Object localObject1 = (bdeh)paramQQAppInterface.getManager(61);
      if (localObject1 != null)
      {
        Object localObject2 = new ArrayList();
        ((List)localObject2).addAll(((bdeh)localObject1).b());
  ...
  public static void c(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        paramString = (RecentUser)localaong.findRecentUser(paramString, 7000);
        if (paramString != null)
        {
      ...
      } while (((bdeh)paramQQAppInterface.getManager(61)).a() != 0);
      a(paramQQAppInterface, localaong, anhk.x, 7);
    } while (!QLog.isColorLevel());
  ...
  public static boolean c(QQAppInterface paramQQAppInterface)
  {
    ...
    Object localObject1 = (bdeh)paramQQAppInterface.getManager(61);
    bddy localbddy = (bddy)paramQQAppInterface.getManager(62);
    if ((localObject1 == null) || (localbddy == null)) {
      return false;
    }
    localObject1 = ((bdeh)localObject1).a();
    Object localObject2 = new ArrayList();
    Object localObject3 = paramQQAppInterface.getApplication().getAllAccounts();
    if ((localObject3 != null) && (((List)localObject3).size() > 0)) {
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      if ((localObject3 != null) && (!TextUtils.isEmpty(((SimpleAccount)localObject3).getUin())) && (!((SimpleAccount)localObject3).getUin().equals(paramQQAppInterface)) && (!((List)localObject1).contains(((SimpleAccount)localObject3).getUin())))
      {
        ...
        String str = localbddy.a((String)localObject3 + "_last_cookie");
        if (!TextUtils.isEmpty(str)) {
          localbddy.a((String)localObject3 + "_cookie", str);
        }
        localbddy.a((String)localObject3 + "_msgNum", Integer.valueOf(0));
        localbddy.a((String)localObject3 + "_msgFlag", Integer.valueOf(0));
        localbddy.a((String)localObject3 + "_redBagTime", Integer.valueOf(0));
      }
    }
    if (QLog.isColorLevel()) {
      QLog.d("SUB_ACCOUNT", 2, "cleanAllThirdQQUnreadMsgNum()");
  ...
  public static boolean d(QQAppInterface paramQQAppInterface)
  {
    ...
    bddy localbddy = (bddy)paramQQAppInterface.getManager(62);
    return (localbddy == null) || (!TextUtils.equals(localbddy.a(paramQQAppInterface.c() + "_display_third_qq_checked"), String.valueOf(false)));
  }
  ...
  private boolean d(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    Object localObject3 = (bdeh)paramQQAppInterface.getManager(61);
  ...
  public ArrayList<Pair<String, Integer>> a(String paramString)
  {
    ...
    //   45: areturn
    //   46: aload_0
    //   47: getfield 43	bddy:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   50: invokeinterface 264 1 0
    //   55: aload_0
    //   56: getfield 1069	bddy:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   59: ifnull +29 -> 88
    //   62: ldc_w 954
    //   65: aload_1
    ...
    //   72: aload_3
    //   73: aload_0
    //   74: getfield 1069	bddy:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   77: invokevirtual 463	java/util/ArrayList:addAll	(Ljava/util/Collection;)Z
    //   80: pop
    //   81: aload_0
    //   82: getfield 1069	bddy:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   85: invokevirtual 79	java/util/ArrayList:clear	()V
    //   88: aload_0
    //   89: getfield 43	bddy:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   92: invokeinterface 279 1 0
    //   97: aload_3
    //   98: areturn
    //   99: aload_0
    //   100: getfield 1069	bddy:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   110: iflt -22 -> 88
    //   113: aload_0
    //   114: getfield 1069	bddy:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   117: iload_2
    ...
    //   144: pop
    //   145: aload_0
    //   146: getfield 1069	bddy:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   149: iload_2
    ...
    //   161: astore_1
    //   162: aload_0
    //   163: getfield 43	bddy:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
  ...
  public void a(SubAccountBaseActivity paramSubAccountBaseActivity)
  {
    ...
    while (i >= 0)
    {
      localObject = (bgpa)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      if ((localObject == null) || (((bgpa)localObject).getOwnerActivity() != paramSubAccountBaseActivity) || (((bgpa)localObject).isShowing())) {}
      try
      {
  ...
  public void a(QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity, Pair<String, Integer> paramPair, android.content.DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    //   222: istore 6
    //   224: aload_0
    //   225: getfield 43	bddy:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   228: invokeinterface 264 1 0
    //   233: aload_0
    //   234: getfield 1236	bddy:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   237: ifnull +141 -> 378
    //   240: aload_0
    //   241: getfield 1236	bddy:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   253: iflt +125 -> 378
    //   256: aload_0
    //   257: getfield 1236	bddy:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   260: iload 5
    //   262: invokevirtual 304	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   265: checkcast 921	bgpa
    //   268: astore 10
    //   270: aload 10
    //   272: ifnull +298 -> 570
    //   275: aload 10
    //   277: invokevirtual 1262	bgpa:getTag	()Ljava/lang/Object;
    //   280: instanceof 346
    //   283: ifeq +287 -> 570
    //   286: aload 10
    //   288: invokevirtual 1262	bgpa:getTag	()Ljava/lang/Object;
    ...
    //   306: ifeq +264 -> 570
    //   309: aload 10
    //   311: invokevirtual 1243	bgpa:isShowing	()Z
    //   314: istore 7
    //   316: iload 7
    //   318: ifeq +8 -> 326
    //   321: aload 10
    //   323: invokevirtual 1246	bgpa:dismiss	()V
    //   326: aload_0
    //   327: getfield 1236	bddy:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   330: iload 5
    ...
    //   388: aload 8
    //   390: iconst_0
    //   391: invokestatic 964	bglf:c	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Z)Ljava/lang/String;
    //   394: astore 9
    //   396: aload 9
    //   398: ifnull +181 -> 579
    //   401: aload 9
    ...
    //   436: aload_2
    //   437: sipush 230
    //   440: invokestatic 919	bglp:a	(Landroid/content/Context;I)Lbgpa;
    //   443: aload 10
    //   445: invokevirtual 925	bgpa:setTitle	(Ljava/lang/String;)Lbgpa;
    //   448: aload_1
    //   449: invokevirtual 929	bgpa:setMessage	(Ljava/lang/CharSequence;)Lbgpa;
    //   452: astore_1
    //   453: aload_1
    //   454: aload_3
    //   455: invokevirtual 1268	bgpa:setTag	(Ljava/lang/Object;)V
    //   458: aload_1
    //   459: aload_2
    //   460: invokevirtual 933	bgpa:setOwnerActivity	(Landroid/app/Activity;)V
    //   463: aload_1
    //   464: aload_2
    //   465: ldc_w 934
    //   468: invokevirtual 910	com/tencent/mobileqq/app/BaseActivity:getString	(I)Ljava/lang/String;
    //   471: aload 4
    //   473: invokevirtual 942	bgpa:setPositiveButton	(Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;)Lbgpa;
    //   476: pop
    //   477: aload_1
    //   478: new 1270	bdea
    //   481: dup
    ...
    //   483: aload 8
    //   485: iload 6
    //   487: invokespecial 1273	bdea:<init>	(Lbddy;Ljava/lang/String;I)V
    //   490: invokevirtual 1277	bgpa:setOnCancelListener	(Landroid/content/DialogInterface$OnCancelListener;)V
    //   493: aload_1
    //   494: invokevirtual 949	bgpa:show	()V
    //   497: aload_0
    //   498: getfield 1236	bddy:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   501: ifnonnull +14 -> 515
    //   504: aload_0
    //   505: new 57	java/util/ArrayList
    //   508: dup
    //   509: invokespecial 58	java/util/ArrayList:<init>	()V
    //   512: putfield 1236	bddy:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   515: aload_0
    //   516: getfield 1236	bddy:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   519: aload_1
    //   520: invokevirtual 297	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   523: pop
    //   524: aload_0
    //   525: getfield 43	bddy:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    ...
    //   553: astore_1
    //   554: aload_0
    //   555: getfield 43	bddy:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
  ...
  public void a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    //   54: return
    //   55: aload_0
    //   56: getfield 43	bddy:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   59: invokeinterface 264 1 0
    //   64: aload_0
    //   65: getfield 1236	bddy:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   68: ifnull +253 -> 321
    //   71: aload_0
    //   72: getfield 1236	bddy:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   84: iflt +237 -> 321
    //   87: aload_0
    //   88: getfield 1236	bddy:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   91: iload 5
    //   93: invokevirtual 304	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   96: checkcast 921	bgpa
    //   99: astore 7
    //   101: aload 7
    //   103: ifnull +162 -> 265
    //   106: aload 7
    //   108: invokevirtual 1262	bgpa:getTag	()Ljava/lang/Object;
    //   111: astore 8
    //   113: aload 8
    //   115: ifnull +193 -> 308
    //   118: aload 8
    ...
    //   169: ifeq +173 -> 342
    //   172: aload 7
    //   174: invokevirtual 1243	bgpa:isShowing	()Z
    //   177: istore 6
    //   179: iload 6
    //   181: ifeq +8 -> 189
    //   184: aload 7
    //   186: invokevirtual 1246	bgpa:dismiss	()V
    //   189: aload_0
    //   190: getfield 1236	bddy:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   193: iload 5
    ...
    //   262: goto +80 -> 342
    //   265: aload_0
    //   266: getfield 1236	bddy:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   269: iload 5
    ...
    //   278: astore_1
    //   279: aload_0
    //   280: getfield 43	bddy:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    ...
    //   305: goto -138 -> 167
    //   308: aload_0
    //   309: getfield 1236	bddy:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   312: iload 5
    //   314: invokevirtual 1076	java/util/ArrayList:remove	(I)Ljava/lang/Object;
    //   317: pop
    //   318: goto +24 -> 342
    //   321: aload_0
    //   322: getfield 43	bddy:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
  ...
  public void onDestroy()
  {
    ...
    try
    {
      if (this.jdField_a_of_type_JavaUtilArrayList != null)
      {
        ...
        while (localIterator.hasNext())
        {
          bgpa localbgpa = (bgpa)localIterator.next();
          try
          {
            if (localbgpa.isShowing()) {
              localbgpa.dismiss();
            }
          }
          catch (Exception localException) {}
