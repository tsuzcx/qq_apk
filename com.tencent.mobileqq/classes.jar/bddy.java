...
{
  private static boolean jdField_a_of_type_Boolean = bdaw.c(bdaw.z);
  private int jdField_a_of_type_Int;
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
  private HandlerThread jdField_a_of_type_AndroidOsHandlerThread;
  public bddz a;
  private bdea jdField_a_of_type_Bdea = new bdea(null);
  bded jdField_a_of_type_Bded;
  ...
  public bddy()
  {
    this.jdField_a_of_type_Bddz = new bddz();
    f();
  ...
  private bden a()
  {
    bden localbden = this.jdField_a_of_type_Bddz.a.b();
    if (localbden != null) {
      return localbden;
    }
    localbden = this.jdField_a_of_type_Bddz.a.a();
    if (localbden != null)
    {
      this.jdField_a_of_type_Bded.a(localbden.jdField_a_of_type_Int, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      return localbden;
    }
    return null;
  }
  ...
  {
    this.jdField_a_of_type_Bdea.jdField_a_of_type_Int = paramAVIOStruct.pFrameIndex;
    paramAVIOStruct.pFrameIndex = 0;
    this.jdField_a_of_type_Bdea.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Bdea.jdField_b_of_type_Int = 0;
    alvd.a("handleMessage:writeVideoFrame[false]  mThumbPicControl.mSendThumbOKIndex=" + this.jdField_a_of_type_Bdea.jdField_a_of_type_Int);
  }
  ...
  private boolean a()
  {
    boolean bool2 = true;
    bool1 = false;
    synchronized (bddz.a(this.jdField_a_of_type_Bddz))
    {
      Object localObject2 = bddz.a(this.jdField_a_of_type_Bddz);
  ...
  private void h()
  {
    if (this.jdField_a_of_type_Bded != null) {
      this.jdField_a_of_type_Bded.c();
    }
    this.jdField_a_of_type_Bded = null;
    c();
  ...
  public void a(int paramInt1, int paramInt2, alte paramalte)
  {
    ...
    this.jdField_e_of_type_Int = bdax.a().b();
  ...
  public void a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqShortvideoUtilOffScreenInputSurface != null)
    {
      if (paramBoolean)
      {
        this.jdField_a_of_type_Bded = new bded();
        this.jdField_a_of_type_Bded.a(false, false);
        d();
      }
      bdct.b();
      return;
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.what == -16716524)
    {
      ...
      a(paramMessage.arg1, paramMessage.arg2, (alte)paramMessage.obj);
      this.h = true;
      if (this.i) {
        a(a());
      }
    ...
    do
    {
      do
      {
        ...
        f();
        this.jdField_a_of_type_Bddz.a();
        this.jdField_a_of_type_Bddz.a = null;
        this.jdField_a_of_type_Bdea.jdField_b_of_type_Int = 0;
        this.jdField_a_of_type_Bdea.jdField_a_of_type_Boolean = false;
        this.jdField_a_of_type_Bdea.jdField_a_of_type_Int = -1;
        h();
      } while (!QLog.isColorLevel());
    ...
    if (j != 0)
    {
      alvd.a("handleMessage:[RenderModeCheck-Recorder][May Lost Frame] mode=" + j);
      return true;
    }
    if (this.jdField_a_of_type_Bded != null) {
      bdct.a(PtvFilterUtils.a() / 1000L);
    }
    boolean bool1;
    if (paramMessage.obj != null)
    {
      ...
      for (;;)
      {
        ...
        alvd.a("handleMessage:[copyDataToByteBuffer] steptime=" + l1 + " us");
        bdct.d(l1);
        ...
        if (this.jdField_a_of_type_Bddz.a != null) {
          break;
        }
        alvd.a("handleMessage:[RenderModeCheck-Recorder][May Lost Frame] mode=" + j);
        return true;
        if (paramMessage.arg1 == 1) {
          localObject = ((bdbu)paramMessage.obj).jdField_a_of_type_ArrayOfByte;
        }
      }
      ...
      if (localbden != null)
      {
        this.jdField_a_of_type_Bded.a(localbden.jdField_a_of_type_Int);
        alvd.a("handleMessage:[CAMERA_OPENGL_RANDER_DATA] bindTextureId=" + localbden.jdField_a_of_type_Int);
        alvd.a("handleMessage:[CAMERA_OPENGL_RANDER_DATA] Begin drawFrame mWidth=" + this.jdField_a_of_type_Int + " mHeight=" + this.jdField_b_of_type_Int);
        e();
        alvd.a("handleMessage:[CAMERA_OPENGL_RANDER_DATA] End drawFrame");
        if (!jdField_a_of_type_Boolean) {}
        AVIOStruct localAVIOStruct;
        for (bool1 = true;; bool1 = false)
        {
          PtvFilterUtils.a(bool1);
          alvd.a("handleMessage:[CAMERA_OPENGL_RANDER_DATA] glSyncCommand OK: sNeedSyncUseFlush=" + jdField_a_of_type_Boolean);
          if (paramMessage.arg1 != 1) {
            break label1126;
          }
          localAVIOStruct = ((bdbu)paramMessage.obj).jdField_a_of_type_ComTencentMaxvideoCommonAVIOStruct;
        ...
        {
          this.jdField_a_of_type_Bdea.jdField_a_of_type_Boolean = true;
          localObject = localAVIOStruct;
        }
        label713:
        ...
        bool1 = true;
        label739:
        localbden.a(j, localObject, bool1);
        localbden.e();
        bool1 = this.jdField_a_of_type_Bddz.a.a();
        alvd.a("handleMessage:writeVideoFrame  mNewSession=" + this.jdField_a_of_type_Bdea.jdField_a_of_type_Boolean + "  Make data ready: frameIndex= " + ((AVIOStruct)localObject).pFrameIndex + "  hasRenaderFrame=" + bool1);
        if (!bool1)
        {
          if (this.jdField_a_of_type_Bdea.jdField_a_of_type_Boolean) {
            a((AVIOStruct)localObject);
          }
          localbden.a();
        }
        alvd.a("handleMessage:writeVideoFrame frameBufferTime=" + l2 + "  sNeedSyncUseFlush=" + jdField_a_of_type_Boolean);
      }
      l1 = (PtvFilterUtils.a() - l1) / 1000L;
      bdct.c(l1);
    ...
    for (;;)
    {
      ...
      break label739;
      label1143:
      alvd.a("handleMessage:byteBufferProcessFrame  framebuffer=null");
    }
  }
}
