...
{
  private static final OutputStream jdField_a_of_type_JavaIoOutputStream = new bdea();
  ...
  private final LinkedHashMap<String, bded> jdField_a_of_type_JavaUtilLinkedHashMap = new LinkedHashMap(0, 0.75F, true);
  private final Callable<Void> jdField_a_of_type_JavaUtilConcurrentCallable = new bddz(this);
  ...
  private bddy(File paramFile, int paramInt1, int paramInt2, long paramLong)
  {
  ...
  public static bddy a(File paramFile, int paramInt1, int paramInt2, long paramLong)
  {
    if (paramLong <= 0L) {
    ...
    for (;;)
    {
      localObject = new bddy(paramFile, paramInt1, paramInt2, paramLong);
      if (!((bddy)localObject).jdField_b_of_type_JavaIoFile.exists()) {
        break label174;
      }
      try
      {
    ...
    label174:
    paramFile.mkdirs();
    paramFile = new bddy(paramFile, paramInt1, paramInt2, paramLong);
    paramFile.e();
    return paramFile;
  }
  
  private bdeb a(String paramString, long paramLong)
  {
    for (;;)
    {
      bdeb localbdeb;
      try
      {
        f();
        b(paramString);
        bded localbded = (bded)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(paramString);
        if (paramLong != -1L) {
          if (localbded != null)
          {
            long l = bded.a(localbded);
            if (l == paramLong) {}
          }
          else
          {
        ...
        if (localbded == null)
        {
          localbded = new bded(this, paramString, null);
          this.jdField_a_of_type_JavaUtilLinkedHashMap.put(paramString, localbded);
          localbdeb = new bdeb(this, localbded, null);
          bded.a(localbded, localbdeb);
          this.jdField_a_of_type_JavaIoWriter.write("DIRTY " + paramString + '\n');
          this.jdField_a_of_type_JavaIoWriter.flush();
          paramString = localbdeb;
          continue;
        }
        localbdeb = bded.a(localbded);
      }
      finally {}
      if (localbdeb != null) {
        paramString = null;
  ...
  private void a(bdeb parambdeb, boolean paramBoolean)
  {
    int k = 0;
    bded localbded;
    try
    {
      localbded = bdeb.a(parambdeb);
      if (bded.a(localbded) != parambdeb) {
    ...
    if (paramBoolean)
    {
      ...
      if (!bded.a(localbded))
      {
        ...
        for (;;)
        {
          ...
          if (bdeb.a(parambdeb)[i] == 0)
          {
            parambdeb.b();
            throw new IllegalStateException("Newly created entry didn't create value for index " + i);
          }
          if (!localbded.b(i).exists())
          {
            parambdeb.b();
            return;
          }
    ...
    for (;;)
    {
      ...
      {
        parambdeb = localbded.b(j);
        if (paramBoolean)
        {
          if (parambdeb.exists())
          {
            File localFile = localbded.a(j);
            parambdeb.renameTo(localFile);
            l1 = bded.a(localbded)[j];
            long l2 = localFile.length();
            bded.a(localbded)[j] = l2;
      ...
      else
      {
        ...
        bded.a(localbded, null);
        if ((bded.a(localbded) | paramBoolean))
        {
          bded.a(localbded, true);
          this.jdField_a_of_type_JavaIoWriter.write("CLEAN " + bded.a(localbded) + localbded.a() + '\n');
          if (paramBoolean)
          {
        ...
        for (;;)
        {
          ...
          break;
          this.jdField_a_of_type_JavaUtilLinkedHashMap.remove(bded.a(localbded));
          this.jdField_a_of_type_JavaIoWriter.write("REMOVE " + bded.a(localbded) + '\n');
        }
      }
      j += 1;
    }
  ...
  private void a(String paramString)
  {
    ...
    for (;;)
    {
      bded localbded2 = (bded)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(str);
      bded localbded1 = localbded2;
      if (localbded2 == null)
      {
        localbded1 = new bded(this, str, null);
        this.jdField_a_of_type_JavaUtilLinkedHashMap.put(str, localbded1);
      }
      if ((k != -1) && (i == "CLEAN".length()) && (paramString.startsWith("CLEAN")))
      {
        paramString = paramString.substring(k + 1).split(" ");
        bded.a(localbded1, true);
        bded.a(localbded1, null);
        bded.a(localbded1, paramString);
        return;
      }
      if ((k == -1) && (i == "DIRTY".length()) && (paramString.startsWith("DIRTY")))
      {
        bded.a(localbded1, new bdeb(this, localbded1, null));
        return;
      }
  ...
  {
    return bdef.a(new InputStreamReader(paramInputStream, bdef.b));
  }
  ...
  private void c()
  {
    ...
    //   7: dup
    //   8: aload_0
    //   9: getfield 89	bddy:jdField_b_of_type_JavaIoFile	Ljava/io/File;
    //   12: invokespecial 382	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   15: getstatic 384	bdef:a	Ljava/nio/charset/Charset;
    //   18: invokespecial 385	bdej:<init>	(Ljava/io/InputStream;Ljava/nio/charset/Charset;)V
    //   21: astore_2
    //   22: aload_2
    //   23: invokevirtual 386	bdej:a	()Ljava/lang/String;
    //   26: astore_3
    //   27: aload_2
    //   28: invokevirtual 386	bdej:a	()Ljava/lang/String;
    //   31: astore 4
    //   33: aload_2
    //   34: invokevirtual 386	bdej:a	()Ljava/lang/String;
    //   37: astore 5
    //   39: aload_2
    //   40: invokevirtual 386	bdej:a	()Ljava/lang/String;
    //   43: astore 6
    //   45: aload_2
    //   46: invokevirtual 386	bdej:a	()Ljava/lang/String;
    //   49: astore 7
    //   51: ldc_w 388
    //   54: aload_3
    ...
    //   69: ifeq +44 -> 113
    //   72: aload_0
    //   73: getfield 80	bddy:jdField_a_of_type_Int	I
    ...
    //   84: ifeq +29 -> 113
    //   87: aload_0
    //   88: getfield 99	bddy:jdField_b_of_type_Int	I
    ...
    //   180: astore_3
    //   181: aload_2
    //   182: invokestatic 409	bdef:a	(Ljava/io/Closeable;)V
    //   185: aload_3
    //   186: athrow
    //   187: iconst_0
    //   188: istore_1
    //   189: aload_0
    //   190: aload_2
    //   191: invokevirtual 386	bdej:a	()Ljava/lang/String;
    //   194: invokespecial 411	bddy:a	(Ljava/lang/String;)V
    //   197: iload_1
    //   198: iconst_1
    //   199: iadd
    //   200: istore_1
    ...
    //   206: iload_1
    //   207: aload_0
    //   208: getfield 51	bddy:jdField_a_of_type_JavaUtilLinkedHashMap	Ljava/util/LinkedHashMap;
    //   211: invokevirtual 374	java/util/LinkedHashMap:size	()I
    //   214: isub
    //   215: putfield 105	bddy:jdField_c_of_type_Int	I
    //   218: aload_2
    //   219: invokevirtual 413	bdej:a	()Z
    //   222: ifeq +12 -> 234
    //   225: aload_0
    //   226: invokespecial 175	bddy:e	()V
    //   229: aload_2
    //   230: invokestatic 409	bdef:a	(Ljava/io/Closeable;)V
    //   233: return
    //   234: aload_0
    ...
    //   246: dup
    //   247: aload_0
    //   248: getfield 89	bddy:jdField_b_of_type_JavaIoFile	Ljava/io/File;
    //   251: iconst_1
    //   252: invokespecial 422	java/io/FileOutputStream:<init>	(Ljava/io/File;Z)V
    //   255: getstatic 384	bdef:a	Ljava/nio/charset/Charset;
    ...
    //   264: putfield 209	bddy:jdField_a_of_type_JavaIoWriter	Ljava/io/Writer;
    //   267: goto -38 -> 229
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	270	0	this	bddy
    //   188	27	1	i	int
    //   21	209	2	localbdej	bdej
  ...
  private void d()
  {
    ...
    {
      bded localbded = (bded)localIterator.next();
      int i;
      if (bded.a(localbded) == null)
      {
        i = 0;
        while (i < this.jdField_b_of_type_Int)
        {
          this.jdField_b_of_type_Long += bded.a(localbded)[i];
          i += 1;
        }
      }
      else
  ...
  private void e()
  {
    for (;;)
    {
      try
      {
        ...
        BufferedWriter localBufferedWriter = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(this.jdField_c_of_type_JavaIoFile), bdef.a));
        bded localbded;
        try
        {
          ...
          localbded = (bded)localIterator.next();
          if (bded.a(localbded) != null)
          {
            localBufferedWriter.write("DIRTY " + bded.a(localbded) + '\n');
            continue;
        ...
        localObject1.write("CLEAN " + bded.a(localbded) + localbded.a() + '\n');
      }
      finally {}
    }
    localObject1.close();
    ...
    this.d.delete();
    this.jdField_a_of_type_JavaIoWriter = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(this.jdField_b_of_type_JavaIoFile, true), bdef.a));
  }
  ...
  public bdeb a(String paramString)
  {
    return a(paramString, -1L);
  }
  
  /* Error */
  public bdee a(String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 4
    ...
    //   4: monitorenter
    //   5: aload_0
    //   6: invokespecial 179	bddy:f	()V
    //   9: aload_0
    //   10: aload_1
    //   11: invokespecial 181	bddy:b	(Ljava/lang/String;)V
    //   14: aload_0
    //   15: getfield 51	bddy:jdField_a_of_type_JavaUtilLinkedHashMap	Ljava/util/LinkedHashMap;
    //   18: aload_1
    //   19: invokevirtual 185	java/util/LinkedHashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   22: checkcast 187	bded
    //   25: astore 6
    //   27: aload 6
    //   29: ifnonnull +10 -> 39
    //   32: aload 4
    ...
    //   41: astore_3
    //   42: aload 6
    //   44: invokestatic 247	bded:a	(Lbded;)Z
    //   47: ifeq -12 -> 35
    //   50: aload_0
    //   51: getfield 99	bddy:jdField_b_of_type_Int	I
    ...
    //   61: iload_2
    //   62: aload_0
    //   63: getfield 99	bddy:jdField_b_of_type_Int	I
    //   66: if_icmpge +65 -> 131
    //   69: aload 5
    //   71: iload_2
    ...
    //   76: aload 6
    //   78: iload_2
    //   79: invokevirtual 262	bded:a	(I)Ljava/io/File;
    ...
    //   99: iload_2
    //   100: aload_0
    //   101: getfield 99	bddy:jdField_b_of_type_Int	I
    //   104: if_icmpge -69 -> 35
    //   107: aload 4
    //   109: astore_3
    //   110: aload 5
    ...
    //   119: iload_2
    //   120: aaload
    //   121: invokestatic 409	bdef:a	(Ljava/io/Closeable;)V
    //   124: iload_2
    //   125: iconst_1
    //   126: iadd
    //   127: istore_2
    ...
    //   131: aload_0
    //   132: aload_0
    //   133: getfield 105	bddy:jdField_c_of_type_Int	I
    //   136: iconst_1
    //   137: iadd
    //   138: putfield 105	bddy:jdField_c_of_type_Int	I
    //   141: aload_0
    //   142: getfield 209	bddy:jdField_a_of_type_JavaIoWriter	Ljava/io/Writer;
    ...
    //   173: pop
    //   174: aload_0
    //   175: invokespecial 295	bddy:b	()Z
    //   178: ifeq +15 -> 193
    //   181: aload_0
    //   182: getfield 69	bddy:jdField_a_of_type_JavaUtilConcurrentThreadPoolExecutor	Ljava/util/concurrent/ThreadPoolExecutor;
    //   185: aload_0
    //   186: getfield 76	bddy:jdField_a_of_type_JavaUtilConcurrentCallable	Ljava/util/concurrent/Callable;
    ...
    //   198: aload_1
    //   199: aload 6
    //   201: invokestatic 192	bded:a	(Lbded;)J
    //   204: aload 5
    //   206: aload 6
    //   208: invokestatic 269	bded:a	(Lbded;)[J
    //   211: aconst_null
    //   212: invokespecial 491	bdee:<init>	(Lbddy;Ljava/lang/String;J[Ljava/io/InputStream;[JLbddz;)V
    //   215: astore_3
    //   216: goto -181 -> 35
    //   219: astore_1
    //   220: aload_0
  ...
  public boolean a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 209	bddy:jdField_a_of_type_JavaIoWriter	Ljava/io/Writer;
    //   6: astore_2
    //   7: aload_2
    //   8: ifnonnull +9 -> 17
    //   11: iconst_1
    ...
    for (;;)
    {
      try
      {
        ...
        else
        {
          ...
          return bool;
          this.jdField_b_of_type_Long -= bded.a(localbded)[i];
          bded.a(localbded)[i] = 0L;
          i += 1;
        }
        if (i < this.jdField_b_of_type_Int)
        {
          localObject = localbded.a(i);
  ...
  {
    close();
    bdef.a(this.jdField_a_of_type_JavaIoFile);
  }
  ...
  public void close()
  {
    for (;;)
    {
      try
      {
        ...
        {
          bded localbded = (bded)((Iterator)localObject1).next();
          if (bded.a(localbded) == null) {
            continue;
          }
          bded.a(localbded).b();
