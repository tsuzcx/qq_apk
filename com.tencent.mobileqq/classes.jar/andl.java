...
public class andl
  implements anek
{
  andm jdField_a_of_type_Andm = new andm(this);
  ...
  public andl(Activity paramActivity, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    this.jdField_a_of_type_Ansi = new ansi();
    this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam = paramStartCheckParam;
    paramActivity = new anev(paramActivity, paramStartCheckParam);
    paramActivity.a(this);
    this.jdField_a_of_type_Anev = paramActivity;
    this.jdField_a_of_type_Blhq = new blhq(Looper.getMainLooper(), this.jdField_a_of_type_Anev);
  ...
  public static andl a(String paramString)
  {
    Object localObject;
    ...
    do
    {
      return localObject;
      localandl = a();
      if ((localandl == null) || (localandl.jdField_a_of_type_JavaUtilSet == null)) {
        break;
      }
      localObject = localandl;
    } while (localandl.jdField_a_of_type_JavaUtilSet.contains(paramString));
    return null;
  }
  ...
  private BaseChatPie a()
  {
    ...
    if (localObject != null)
    {
      localObject = (amsx)((AppInterface)localObject).getManager(153);
      if (localObject != null)
      {
  ...
  public static void a(String paramString)
  {
    andl localandl = a();
    if ((localandl != null) && (localandl.jdField_a_of_type_JavaUtilSet != null)) {
      localandl.jdField_a_of_type_JavaUtilSet.add(paramString);
    }
    if (QLog.isColorLevel()) {
      QLog.d("cmgame_process.CmGameMainManager", 2, "onShare2Aio currentApolloGame:" + localandl + ",aioUin:" + paramString);
    }
  }
  ...
  {
    andl localandl = a();
    if ((localandl != null) && (localandl.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null)) {
      VipUtils.a(null, "cmshow", "Apollo", "clk_game_banner", 3, 0, new String[] { localandl.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId + "" });
    }
  }
  ...
  public void a(Activity paramActivity)
  {
    if (this.jdField_a_of_type_Anev != null) {
      this.jdField_a_of_type_Anev.a(paramActivity);
    }
  }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (((aody)localAppInterface.getManager(56)).a(Long.valueOf(Long.parseLong((String)localObject))))
        {
          i = 1;
  ...
  public boolean a()
  {
    ...
    {
      this.jdField_a_of_type_Blhq.sendEmptyMessage(18);
      return true;
    }
    return false;
  }
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_Blhq.obtainMessage(21).sendToTarget();
  }
  ...
  public void b(String paramString)
  {
    ...
    label794:
    label803:
    for (paramString = bhlg.e(localQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.sessionUin, (String)localObject3);; paramString = null)
    {
      if (TextUtils.isEmpty(paramString))
      {
        localObject1 = ((anyw)localQQAppInterface.getManager(51)).b((String)localObject3);
      ...
      for (localObject1 = ((Friends)localObject1).getFriendNick();; localObject1 = paramString)
      {
        ...
        if (TextUtils.isEmpty((CharSequence)localObject1)) {
          paramString = bhlg.c(localQQAppInterface, (String)localObject3, true);
        }
        if (QLog.isColorLevel()) {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject1))
        {
          paramString = this.jdField_a_of_type_Blhq.obtainMessage(26);
        ...
        this.jdField_a_of_type_Ansi.jdField_a_of_type_Int = i;
        this.jdField_a_of_type_Ansi.jdField_a_of_type_Long = l;
        this.jdField_a_of_type_Ansi.jdField_c_of_type_Int = j;
        localObject2 = (annx)localQQAppInterface.getManager(155);
        localObject1 = ((annx)localObject2).a(i);
        paramString = anzj.a(2131701018);
        if ((localObject1 != null) && (!TextUtils.isEmpty(((ApolloGameData)localObject1).name)))
        {
          localObject2 = ((annx)localObject2).a(((ApolloGameData)localObject1).actionId);
        ...
        for (;;)
        {
          ...
          this.jdField_a_of_type_Ansi.jdField_b_of_type_JavaLangString = ((ApolloGameData)localObject1).name;
          for (;;)
          {
            this.jdField_a_of_type_Ansi.jdField_a_of_type_JavaLangString = paramString;
            this.jdField_a_of_type_Ansi.jdField_b_of_type_Int = i;
            ...
            return;
            this.jdField_a_of_type_Ansi.jdField_b_of_type_JavaLangString = anzj.a(2131701019);
            i = 0;
          }
          this.jdField_a_of_type_Ansi.jdField_c_of_type_JavaLangString = ((JSONObject)localObject1).toString();
          return;
        }
      }
    }
    ...
    do
    {
      do
      {
        ...
        try
        {
          ...
          paramString = ((annx)((QQAppInterface)localObject1).getManager(155)).a(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
        ...
        this.jdField_a_of_type_Andm.jdField_a_of_type_Int = paramString.gameId;
        this.jdField_a_of_type_Andm.jdField_b_of_type_Int = paramInt;
        ((WtloginManager)localObject1).getOpenKeyWithoutPasswd((String)localObject2, 16L, paramString.appId, this.jdField_a_of_type_Andm);
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Blhq.obtainMessage(22).sendToTarget();
  }
  ...
  public void e(String paramString)
  {
    ...
    Message localMessage = this.jdField_a_of_type_Blhq.obtainMessage(28);
  ...
  public void f(String paramString)
  {
    ...
    Message localMessage = this.jdField_a_of_type_Blhq.obtainMessage(23);
    localMessage.obj = paramString;
    localMessage.sendToTarget();
  }
  ...
  public void g(String paramString)
  {
    ...
    this.jdField_a_of_type_Blhq.removeMessages(19);
    this.jdField_a_of_type_Blhq.removeMessages(20);
    Message localMessage = this.jdField_a_of_type_Blhq.obtainMessage(19);
    localMessage.obj = paramString;
    localMessage.sendToTarget();
    b(paramString);
  }
  ...
  {
    if (this.jdField_a_of_type_Anev != null) {
      this.jdField_a_of_type_Anev.b();
    }
  }
  
  public void h(String paramString)
  {
    this.jdField_a_of_type_Anev.a(true);
    c(paramString);
  ...
  public void i(String paramString)
  {
    ...
    Message localMessage = this.jdField_a_of_type_Blhq.obtainMessage(17);
    localMessage.obj = paramString;
    localMessage.sendToTarget();
  }
