  ...
  implements Manager
{
  ...
  public ankc(QQAppInterface paramQQAppInterface)
  {
  ...
  private void c(ApolloActionData paramApolloActionData)
  {
    ...
    {
      return;
      if ((TextUtils.isEmpty(paramApolloActionData.minVer)) || (TextUtils.isEmpty(paramApolloActionData.maxVer)) || (anjy.a(AppSetting.f(), paramApolloActionData.minVer, paramApolloActionData.maxVer)))
      {
  ...
  private void k(List<ApolloObtainedActionData> paramList)
  {
    ...
    //   10: ifeq +10 -> 20
    //   13: aload_0
    //   14: getfield 124	ankc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   17: ifnonnull +4 -> 21
    //   20: return
    //   21: aload_0
    //   22: getfield 124	ankc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   97: aload_3
    //   98: aload 6
    //   100: invokevirtual 352	ankc:a	(Lcom/tencent/mobileqq/persistence/EntityManager;Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   103: pop
    ...
    //   181: aload_0
    //   182: getfield 83	ankc:h	Ljava/util/List;
    //   185: ifnull +32 -> 217
    //   188: aload_0
    //   189: getfield 83	ankc:h	Ljava/util/List;
    //   192: astore_2
    //   193: aload_2
    //   194: monitorenter
    //   195: aload_0
    //   196: getfield 83	ankc:h	Ljava/util/List;
    //   199: invokeinterface 373 1 0
    //   204: aload_0
    //   205: getfield 83	ankc:h	Ljava/util/List;
    //   208: aload_1
    ...
    //   216: monitorexit
    //   217: aload_0
    //   218: getfield 87	ankc:jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   221: ifnull +10 -> 231
    //   224: aload_0
    //   225: getfield 87	ankc:jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   228: invokevirtual 377	java/util/concurrent/ConcurrentHashMap:clear	()V
    //   231: aload_0
    //   232: getfield 85	ankc:jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   235: ifnull -215 -> 20
    //   238: aload_0
    //   239: getfield 85	ankc:jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
  ...
  public Pair<List<ApolloFavActionData>, List<ApolloActionData>> a()
  {
    ...
    List localList = d();
    Collections.sort(localList, new ankd(this));
    ...
    for (;;)
    {
      ...
      if (i1 == 0)
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (this.jdField_b_of_type_Boolean))
        {
          ...
          ((amme)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.APOLLO_MANAGER)).a(false, "getFavPanelActionPairInfo action not exit", 1);
        }
      }
  ...
  public void a(BaseChatPie paramBaseChatPie, List<ApolloActionData> paramList)
  {
    ...
    Object localObject = (amme)paramBaseChatPie.getApp().getManager(QQManagerFactory.APOLLO_MANAGER);
    boolean bool = ((amme)localObject).a(paramBaseChatPie.getApp().getCurrentAccountUin());
    int i2 = ((amme)localObject).a(paramBaseChatPie.getApp().getCurrentAccountUin());
    ...
    Collections.sort(paramBaseChatPie, new anke(this));
    Collections.sort(localArrayList1, new ankf(this));
    Collections.sort((List)localObject, new ankg(this));
    Collections.sort(localArrayList2, new ankh(this));
    Collections.sort(localArrayList3, new anki(this));
    paramList.clear();
  ...
  public void a(ArrayList<ApolloGameRoamData> paramArrayList)
  {
    ...
    //   1: ifnull +17 -> 18
    //   4: aload_1
    //   5: invokevirtual 791	java/util/ArrayList:size	()I
    //   8: ifeq +10 -> 18
    //   11: aload_0
    //   12: getfield 124	ankc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   15: ifnonnull +4 -> 19
    //   18: return
    //   19: aload_0
    //   20: getfield 74	ankc:jdField_f_of_type_JavaUtilList	Ljava/util/List;
    //   23: ifnull +130 -> 153
    //   26: aload_0
    //   27: getfield 74	ankc:jdField_f_of_type_JavaUtilList	Ljava/util/List;
    //   30: astore_2
    //   31: aload_2
    //   32: monitorenter
    //   33: aload_1
    //   34: invokevirtual 552	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   37: astore_3
    //   38: aload_3
    ...
    //   53: checkcast 764	com/tencent/mobileqq/data/ApolloGameRoamData
    //   56: astore 4
    //   58: aload_0
    //   59: getfield 74	ankc:jdField_f_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   86: checkcast 764	com/tencent/mobileqq/data/ApolloGameRoamData
    //   89: astore 6
    //   91: aload 4
    //   93: ifnull -24 -> 69
    //   96: aload 6
    //   98: ifnull -29 -> 69
    //   101: aload 6
    //   103: getfield 765	com/tencent/mobileqq/data/ApolloGameRoamData:gameId	I
    //   106: aload 4
    //   108: getfield 765	com/tencent/mobileqq/data/ApolloGameRoamData:gameId	I
    //   111: if_icmpne -42 -> 69
    //   114: aload_0
    //   115: getfield 74	ankc:jdField_f_of_type_JavaUtilList	Ljava/util/List;
    //   118: aload 6
    //   120: invokeinterface 675 2 0
    //   125: pop
    //   126: aload 6
    //   128: getfield 794	com/tencent/mobileqq/data/ApolloGameRoamData:tagUrl	Ljava/lang/String;
    //   131: invokestatic 204	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   134: ifeq -96 -> 38
    //   137: aload_0
    //   138: aload 6
    //   140: invokevirtual 796	ankc:a	(Lcom/tencent/mobileqq/data/ApolloGameRoamData;)V
    //   143: goto -105 -> 38
    //   146: astore_1
    //   147: aload_2
    //   148: monitorexit
    ...
    //   152: monitorexit
    //   153: aload_0
    //   154: getfield 124	ankc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   177: aload_1
    //   178: invokevirtual 552	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   181: astore_1
    //   182: aload_1
    ...
    //   197: checkcast 764	com/tencent/mobileqq/data/ApolloGameRoamData
    //   200: astore 4
    //   202: aload 4
    //   204: ifnull -22 -> 182
    //   207: aload_3
    ...
    //   221: aload 4
    //   223: getfield 765	com/tencent/mobileqq/data/ApolloGameRoamData:gameId	I
    ...
    //   232: invokevirtual 681	com/tencent/mobileqq/persistence/EntityManager:execSQL	(Ljava/lang/String;)Z
    //   235: pop
    //   236: goto -54 -> 182
    //   239: astore_1
    //   240: aload_1
    //   241: invokevirtual 684	java/lang/Exception:printStackTrace	()V
    //   244: aload_2
  ...
  public void a(List<AioPushData> paramList, int paramInt)
  {
    ...
    //   28: astore 5
    //   30: aload_0
    //   31: getfield 89	ankc:m	Ljava/util/List;
    //   34: ifnull +277 -> 311
    //   37: aload_0
    //   38: getfield 89	ankc:m	Ljava/util/List;
    //   41: astore 6
    //   43: aload 6
    //   45: monitorenter
    //   46: aload_1
    //   47: invokestatic 807	java/util/Collections:sort	(Ljava/util/List;)V
    ...
    //   121: ifne -54 -> 67
    //   124: aload_0
    //   125: getfield 89	ankc:m	Ljava/util/List;
    //   128: aload 8
    ...
    //   139: iflt +67 -> 206
    //   142: aload_0
    //   143: getfield 89	ankc:m	Ljava/util/List;
    //   146: iload 4
    ...
    //   229: aload 8
    //   231: invokevirtual 818	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    ...
    //   245: aload_0
    //   246: getfield 124	ankc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   249: getstatic 821	com/tencent/mobileqq/app/QQManagerFactory:HOTCHAT_CENTER_MANAGER	I
    //   252: invokevirtual 509	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   255: checkcast 823	anwa
    //   258: astore 9
    //   260: aload 9
    //   262: ifnull +33 -> 295
    //   265: aload 9
    ...
    //   272: aload 8
    //   274: getfield 826	com/tencent/mobileqq/data/AioPushData:wording	Ljava/lang/String;
    //   277: invokevirtual 829	anwa:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   280: aload_0
    //   281: getfield 89	ankc:m	Ljava/util/List;
    //   284: aload 8
    ...
    //   310: monitorexit
    //   311: aload_0
    //   312: getfield 124	ankc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   387: invokevirtual 352	ankc:a	(Lcom/tencent/mobileqq/persistence/EntityManager;Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   390: pop
    //   391: goto -25 -> 366
    //   394: astore_1
    //   395: ldc_w 305
    ...
    //   412: aload_1
    //   413: invokevirtual 642	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   430: aload_0
    //   431: invokespecial 835	ankc:g	()V
    //   434: return
    //   435: aload 6
  ...
  public void a(Map<String, ApolloPreDownloadData> paramMap, boolean paramBoolean)
  {
    ...
    //   1: ifeq +10 -> 11
    //   4: aload_0
    //   5: getfield 101	ankc:jdField_e_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   8: invokevirtual 377	java/util/concurrent/ConcurrentHashMap:clear	()V
    //   11: aload_0
    //   12: getfield 101	ankc:jdField_e_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   15: aload_1
    //   16: invokevirtual 843	java/util/concurrent/ConcurrentHashMap:putAll	(Ljava/util/Map;)V
    //   19: aload_0
    //   20: getfield 124	ankc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   50: aload 4
    //   52: ldc_w 845
    //   55: invokevirtual 681	com/tencent/mobileqq/persistence/EntityManager:execSQL	(Ljava/lang/String;)Z
    //   58: pop
    //   59: aload_1
    //   60: invokeinterface 851 1 0
    //   65: invokeinterface 854 1 0
    //   70: astore_1
    //   71: aload_1
    ...
    //   88: checkcast 591	com/tencent/mobileqq/apollo/data/ApolloPreDownloadData
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (anjy.c != null)
    {
      localApolloActionPackage.mIconUnselectedUrl = anjy.c.optString("apImg");
      localApolloActionPackage.mIconSelectedUrl = anjy.c.optString("apcImg");
      b(2);
      ArrayList localArrayList = new ArrayList();
  ...
  public void b(int paramInt)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 124	ankc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   4: ifnonnull +4 -> 8
    //   7: return
    //   8: aload_0
    //   9: getfield 66	ankc:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   12: ifnull +125 -> 137
    //   15: aload_0
    //   16: getfield 66	ankc:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   19: astore 7
    //   21: aload 7
    //   23: monitorenter
    //   24: iconst_1
    ...
    //   29: aload_0
    //   30: getfield 66	ankc:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   74: if_icmpne -34 -> 40
    //   77: aload 6
    //   79: invokevirtual 1042	com/tencent/mobileqq/data/ApolloActionPackage:getCopy	()Lcom/tencent/mobileqq/data/ApolloActionPackage;
    //   82: astore 6
    //   84: aload 6
    //   86: astore 5
    ...
    //   106: astore 5
    //   108: aload_0
    //   109: getfield 66	ankc:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   112: invokeinterface 373 1 0
    //   117: aload 5
    //   119: ifnull +15 -> 134
    //   122: aload_0
    //   123: getfield 66	ankc:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   126: aload 5
    ...
    //   136: monitorexit
    //   137: aload_0
    //   138: getfield 124	ankc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   171: aload 6
    //   173: ldc_w 1046
    //   176: invokevirtual 681	com/tencent/mobileqq/persistence/EntityManager:execSQL	(Ljava/lang/String;)Z
    //   179: pop
    //   180: aload 5
    ...
    //   197: istore_2
    //   198: aload_0
    //   199: getfield 66	ankc:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   298: ifle -164 -> 134
    //   301: aload_0
    //   302: getfield 66	ankc:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   305: iload 4
    ...
    //   323: aload_0
    //   324: getfield 66	ankc:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   327: iload 4
    ...
    //   351: aload 6
    //   353: ldc_w 1050
    //   356: invokevirtual 681	com/tencent/mobileqq/persistence/EntityManager:execSQL	(Ljava/lang/String;)Z
    //   359: pop
    //   360: goto -180 -> 180
    //   363: astore 6
    //   365: aload 6
    //   367: invokevirtual 684	java/lang/Exception:printStackTrace	()V
    //   370: aload 5
  ...
  public void b(EntityManager paramEntityManager, List<ApolloGameRankData> paramList)
  {
    ...
    //   14: ifle +121 -> 135
    //   17: aload_0
    //   18: getfield 97	ankc:k	Ljava/util/List;
    //   21: ifnull +114 -> 135
    //   24: aload_0
    //   25: getfield 97	ankc:k	Ljava/util/List;
    //   28: astore_3
    //   29: aload_3
    //   30: monitorenter
    //   31: aload_0
    //   32: getfield 97	ankc:k	Ljava/util/List;
    //   35: aload_2
    //   36: invokeinterface 288 2 0
    //   41: pop
    //   42: aload_0
    //   43: getfield 97	ankc:k	Ljava/util/List;
    //   46: aload_2
    ...
    //   77: checkcast 554	com/tencent/mobileqq/data/ApolloGameRankData
    //   80: astore_3
    //   81: aload_1
    //   82: aload_3
    //   83: invokevirtual 786	com/tencent/mobileqq/persistence/EntityManager:persistOrReplace	(Lcom/tencent/mobileqq/persistence/Entity;)V
    ...
    //   128: ldc_w 1066
    //   131: aastore
    //   132: invokestatic 1069	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   135: return
    //   136: astore_1
    //   137: aload_3
    //   138: monitorexit
  ...
  public void b(ArrayList<ApolloGameRoamData> paramArrayList)
  {
    ...
    //   17: ifnull +10 -> 27
    //   20: aload_1
    //   21: invokevirtual 791	java/util/ArrayList:size	()I
    //   24: ifne +14 -> 38
    //   27: ldc_w 305
    //   30: iconst_1
    //   31: ldc_w 1074
    //   34: invokestatic 1077	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   37: return
    //   38: ldc_w 305
    //   41: iconst_1
    ...
    //   55: aload_1
    //   56: invokevirtual 791	java/util/ArrayList:size	()I
    ...
    //   65: invokestatic 616	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   68: aload_0
    //   69: getfield 74	ankc:jdField_f_of_type_JavaUtilList	Ljava/util/List;
    //   72: ifnull +29 -> 101
    //   75: aload_0
    //   76: getfield 74	ankc:jdField_f_of_type_JavaUtilList	Ljava/util/List;
    //   79: astore_2
    //   80: aload_2
    //   81: monitorenter
    //   82: aload_0
    //   83: getfield 74	ankc:jdField_f_of_type_JavaUtilList	Ljava/util/List;
    //   86: iconst_0
    //   87: aload_1
    //   88: invokeinterface 840 3 0
    //   93: pop
    //   94: aload_0
    //   95: aload_1
    //   96: invokevirtual 982	ankc:h	(Ljava/util/List;)V
    //   99: aload_2
    //   100: monitorexit
    //   101: aload_0
    //   102: getfield 124	ankc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   105: ifnull -68 -> 37
    //   108: aload_0
    //   109: getfield 124	ankc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   142: astore 4
    //   144: aload_1
    //   145: invokevirtual 552	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   148: astore_1
    //   149: aload_1
    ...
    //   164: checkcast 764	com/tencent/mobileqq/data/ApolloGameRoamData
    //   167: astore 5
    //   169: aload_0
    //   170: aload_3
    //   171: aload 5
    //   173: invokevirtual 352	ankc:a	(Lcom/tencent/mobileqq/persistence/EntityManager;Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   176: pop
    ...
    //   191: aload 5
    //   193: getfield 765	com/tencent/mobileqq/data/ApolloGameRoamData:gameId	I
    ...
    //   214: ldc_w 1083
    //   217: aload_1
    //   218: invokestatic 803	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   221: aload_2
  ...
  public void c(EntityManager paramEntityManager, List<ApolloGameRankData> paramList)
  {
    ...
    //   66: checkcast 554	com/tencent/mobileqq/data/ApolloGameRankData
    //   69: astore_3
    //   70: aload_1
    //   71: aload_3
    ...
    //   118: ldc_w 1119
    //   121: aastore
    //   122: invokestatic 1069	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   125: return
    //   126: astore_1
    //   127: aload_3
    //   128: monitorexit
      ...
      if (localObject5 != null)
      {
        ...
        if ((this.jdField_c_of_type_JavaUtilList != null) && (this.jdField_c_of_type_JavaUtilList.size() > 0))
        {
          ...
          if (i1 == 0)
          {
            ...
            {
              this.jdField_b_of_type_Boolean = false;
              ((amme)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.APOLLO_MANAGER)).a(false, "getActionByPackageId action not exit", 1);
            }
          }
          label453:
  ...
  public void d(List<ApolloActionPackageData> paramList)
  {
    ...
    //   13: return
    //   14: aload_0
    //   15: getfield 68	ankc:jdField_c_of_type_JavaUtilList	Ljava/util/List;
    //   18: ifnull +23 -> 41
    //   21: aload_0
    //   22: getfield 68	ankc:jdField_c_of_type_JavaUtilList	Ljava/util/List;
    //   25: astore_2
    //   26: aload_2
    //   27: monitorenter
    //   28: aload_0
    //   29: getfield 68	ankc:jdField_c_of_type_JavaUtilList	Ljava/util/List;
    //   32: aload_1
    ...
    //   40: monitorexit
    //   41: aload_0
    //   42: getfield 124	ankc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   45: ifnull -32 -> 13
    //   48: aload_0
    //   49: getfield 124	ankc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   112: aload_3
    //   113: aload 5
    //   115: invokevirtual 352	ankc:a	(Lcom/tencent/mobileqq/persistence/EntityManager;Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   118: pop
    ...
    //   197: ldc_w 801
    //   200: aload_1
    //   201: invokestatic 803	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   204: aload_2
  ...
  public void f(List<ApolloFavActionData> paramList)
  {
    ...
    //   7: return
    //   8: aload_0
    //   9: getfield 70	ankc:jdField_d_of_type_JavaUtilList	Ljava/util/List;
    //   12: ifnull +90 -> 102
    //   15: aload_0
    //   16: getfield 70	ankc:jdField_d_of_type_JavaUtilList	Ljava/util/List;
    //   19: astore 5
    //   21: aload 5
    //   23: monitorenter
    //   24: iconst_0
    ...
    //   33: if_icmpge +66 -> 99
    //   36: aload_0
    //   37: getfield 70	ankc:jdField_d_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   49: iflt +163 -> 212
    //   52: aload_0
    //   53: getfield 70	ankc:jdField_d_of_type_JavaUtilList	Ljava/util/List;
    //   56: iload_3
    ...
    //   82: ifne +123 -> 205
    //   85: aload_0
    //   86: getfield 70	ankc:jdField_d_of_type_JavaUtilList	Ljava/util/List;
    //   89: iload_3
    ...
    //   101: monitorexit
    //   102: aload_0
    //   103: getfield 124	ankc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   106: ifnull -99 -> 7
    //   109: aload_0
    //   110: getfield 124	ankc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   155: checkcast 942	com/tencent/mobileqq/persistence/Entity
    ...
    //   186: astore_1
    //   187: aload_1
    //   188: invokevirtual 684	java/lang/Exception:printStackTrace	()V
    //   191: aload 5
  ...
  public void g(List<ApolloRecommendAction> paramList)
  {
    ...
    //   10: aload_0
    //   11: getfield 124	ankc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   14: ifnull +16 -> 30
    //   17: aload_1
    //   18: ifnull +12 -> 30
    //   21: aload_1
    ...
    //   30: return
    //   31: aload_0
    //   32: getfield 105	ankc:l	Ljava/util/List;
    //   35: astore_2
    //   36: aload_2
    //   37: monitorenter
    //   38: aload_0
    //   39: getfield 105	ankc:l	Ljava/util/List;
    //   42: invokeinterface 373 1 0
    //   47: aload_0
    //   48: getfield 105	ankc:l	Ljava/util/List;
    //   51: aload_1
    ...
    //   59: monitorexit
    //   60: aload_0
    //   61: getfield 124	ankc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   108: checkcast 1001	com/tencent/mobileqq/data/ApolloRecommendAction
    //   111: invokevirtual 352	ankc:a	(Lcom/tencent/mobileqq/persistence/EntityManager;Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   114: pop
    //   115: goto -24 -> 91
    //   118: astore_1
    //   119: ldc_w 305
  ...
  public void i(List<ApolloKapuEntranceTips> paramList)
  {
    ...
    //   18: aload_0
    //   19: getfield 124	ankc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   22: astore_3
    //   23: aload_3
    //   24: ifnonnull +6 -> 30
    //   27: aload_0
    ...
    //   29: return
    //   30: aload_0
    //   31: getfield 124	ankc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   55: aload 4
    //   57: ldc_w 477
    //   60: invokevirtual 534	com/tencent/mobileqq/persistence/EntityManager:query	(Ljava/lang/Class;)Ljava/util/List;
    //   63: astore 5
    //   65: aload 5
    //   67: ifnull +52 -> 119
    //   70: aload 5
    ...
    //   225: astore 8
    //   227: aload 6
    //   229: getfield 774	com/tencent/mobileqq/data/ApolloKapuEntranceTips:adId	I
    //   232: aload 8
    //   234: getfield 774	com/tencent/mobileqq/data/ApolloKapuEntranceTips:adId	I
    ...
    //   386: aload 4
    //   388: aload 6
    //   390: invokevirtual 786	com/tencent/mobileqq/persistence/EntityManager:persistOrReplace	(Lcom/tencent/mobileqq/persistence/Entity;)V
    //   393: aload_3
    //   394: aload 6
    ...
    //   453: ifeq -23 -> 430
    //   456: aload_3
    //   457: getfield 771	com/tencent/mobileqq/data/ApolloKapuEntranceTips:isInstall	Z
    //   460: ifeq +53 -> 513
    //   463: aload_0
    //   464: getfield 107	ankc:n	Ljava/util/List;
    //   467: astore 4
    //   469: aload 4
    //   471: monitorenter
    //   472: aload_0
    //   473: getfield 107	ankc:n	Ljava/util/List;
    //   476: aload_3
    ...
    //   512: athrow
    //   513: aload_0
    //   514: getfield 109	ankc:o	Ljava/util/List;
    //   517: astore 4
    //   519: aload 4
    //   521: monitorenter
    //   522: aload_0
    //   523: getfield 109	ankc:o	Ljava/util/List;
    //   526: aload_3
    ...
    //   548: dup
    //   549: aload_0
    //   550: invokespecial 1218	ankj:<init>	(Lankc;)V
    //   553: astore_1
    //   554: aload_0
    //   555: getfield 107	ankc:n	Ljava/util/List;
    //   558: aload_1
    //   559: invokestatic 492	java/util/Collections:sort	(Ljava/util/List;Ljava/util/Comparator;)V
    //   562: aload_0
    //   563: getfield 109	ankc:o	Ljava/util/List;
    //   566: aload_1
  ...
  public List<ApolloGameData> j()
  {
    ...
    if (((Iterator)localObject).hasNext())
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localApolloGameData != null) && (localApolloGameRoamData != null) && (localApolloGameData.gameId == localApolloGameRoamData.gameId) && (localApolloGameData.isShow != 0) && (localApolloGameData.gameId != 1) && (localApolloGameData.gameId != 2) && (!localApolloGameData.isGameApp) && (anjy.a("8.4.10", localApolloGameData.minVer, localApolloGameData.maxVer)))
        {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (i1 != 0) && (!this.jdField_c_of_type_Boolean))
      {
        ...
        ((amma)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.APOLLO_GAME_MANAGER)).e();
