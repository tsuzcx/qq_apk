...
{
  private static final String jdField_a_of_type_JavaLangString = aoky.class.getSimpleName();
  ...
  public aoky(int paramInt1, int paramInt2)
  {
  ...
  private void d()
  {
    this.jdField_a_of_type_Aolc = new aolc();
    this.jdField_a_of_type_Aolc.a();
    if (this.jdField_b_of_type_Boolean) {
      Log.d(jdField_a_of_type_JavaLangString, "textureID=" + this.jdField_a_of_type_Aolc.a());
    }
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture = new SurfaceTexture(this.jdField_a_of_type_Aolc.a());
  ...
  {
    this.jdField_a_of_type_Aolc.a(this.jdField_a_of_type_AndroidGraphicsSurfaceTexture, paramBoolean);
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Aolc.a("before updateTexImage");
