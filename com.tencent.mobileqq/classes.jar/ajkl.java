  ...
  implements View.OnClickListener
{
  ...
  public boolean a;
  protected ArrayList<ajiy> b;
  protected boolean b;
  private boolean c;
  private boolean d;
  
  public ajkl(Context paramContext, QQAppInterface paramQQAppInterface, ListView paramListView, int paramInt, boolean paramBoolean)
  {
  ...
  private void a(View paramView)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if (bmij.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
        break label134;
      }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (bool)
        {
          absy.a(null, "Usr_NewDevice_Click", i, 0, 0);
      ...
      catch (Exception localException2)
      {
        for (;;)
        {
          try
          {
            ...
            bmij.a().a((Activity)this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), localIntent2, str1, 0, null, SmartDevicePluginProxyActivity.class);
            absy.a(null, "Usr_NewDevice_Click", i, 0, 0);
          }
  ...
  private void a(View paramView, Friends paramFriends)
  {
    ...
    paramFriends = localabgm.a(paramFriends.signature, paramFriends.iTermType);
    localabgm.a((Activity)this.jdField_a_of_type_AndroidContentContext, paramFriends, false);
    ...
    if (paramFriends != null)
    {
      ...
      i = 1;
      absy.a(null, l, "Usr_LiteApp_Open", i, 0, paramFriends.productId);
      l = paramFriends.din;
    ...
    for (int i = 1;; i = 2)
    {
      absy.a(null, l, "Usr_LiteApp_Open_Online", i, 0, paramFriends.productId);
      return;
      i = 2;
      break;
    }
  ...
  {
    aocn localaocn = (aocn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.REGPRXYSVCPACK_HANDLER);
    int i;
  ...
  private void f()
  {
    ...
    localFriends.remark = anvx.a(2131694211);
    localFriends.name = anvx.a(2131694211);
    if (a(AppConstants.DATALINE_PC_UIN))
    {
      i = 10;
      localFriends.status = ((byte)i);
      localFriends.groupid = 1001;
      localArrayList.add(ajix.a(5, localFriends, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext));
      ...
      if ((a(AppConstants.DATALINE_IPAD_UIN)) || (this.c))
      {
        ...
        localFriends.remark = this.jdField_a_of_type_AndroidContentContext.getString(2131693668);
        localFriends.name = this.jdField_a_of_type_AndroidContentContext.getString(2131693668);
        ...
        if (!this.d)
        {
          bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005D18", "0X8005D18", 0, 0, "", "", "", "");
          this.d = true;
      ...
      if (((aoab)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.PRINTER_STATUS_HANDLER)).a())
      {
        localFriends = new Friends();
        localFriends.uin = AppConstants.DATALINE_PRINTER_UIN;
        localFriends.remark = this.jdField_a_of_type_AndroidContentContext.getString(2131691340);
        localFriends.name = this.jdField_a_of_type_AndroidContentContext.getString(2131691340);
        if (!a(AppConstants.DATALINE_IPAD_UIN)) {
          break label529;
        }
      }
    ...
    for (int i = 10;; i = 0)
    {
      ...
      if (this.jdField_b_of_type_Boolean)
      {
        ...
        localFriends.remark = this.jdField_a_of_type_AndroidContentContext.getString(2131691338);
        localFriends.name = this.jdField_a_of_type_AndroidContentContext.getString(2131691338);
  ...
  public int a()
  {
    ...
    while (i < getCount())
    {
      ...
      if ((localObject1 != null) && ((localObject1 instanceof ajkj)))
      {
        localObject1 = (Friends)((ajkj)localObject1).a;
        Object localObject2 = (abgm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.DEVICEPROXYMGR_HANDLER);
        if (localObject2 != null)
        {
          localObject2 = ((abgm)localObject2).b();
  ...
  public void a(boolean paramBoolean, String paramString)
  {
    ...
    {
      Friends localFriends = (Friends)((ajiy)((Iterator)localObject).next()).a;
  ...
  public void b()
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localFriends.remark = absz.a(localDeviceInfo);
        ...
        localArrayList1.add(ajix.a(5, localFriends, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext));
        this.jdField_a_of_type_Int += 1;
        break;
        i = 0;
        break label171;
        ...
        {
          localObject = localabgm.a(localDeviceInfo.productId);
      ...
      label480:
      localArrayList2.add(ajix.a(5, localFriends, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext));
      break;
  ...
  public void d()
  {
    ...
    if (i < localArrayList.size()) {
      if (!((Friends)((ajiy)localArrayList.get(i)).a).uin.equals(AppConstants.DATALINE_PRINTER_UIN)) {}
    }
    for (;;)
    {
      if (((aoab)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.PRINTER_STATUS_HANDLER)).a()) {
  ...
  public void e()
  {
    ...
    for (;;)
    {
      ...
      int i = 0;
      if (i < localArrayList.size()) {
        if (!((Friends)((ajiy)localArrayList.get(i)).a).uin.equals(AppConstants.DATALINE_IPAD_UIN)) {}
      }
      for (;;)
      {
        if (i != -1) {
        ...
        for (i = 1;; i = 0)
        {
          ...
          ((aocn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.REGPRXYSVCPACK_HANDLER)).d(1);
          return;
          i += 1;
          break;
          i = 0;
  ...
  public Object getItem(int paramInt)
  {
    ...
    return (ajiy)this.jdField_b_of_type_JavaUtilArrayList.get(paramInt);
  }
  ...
  {
    View localView = ((ajiy)this.jdField_b_of_type_JavaUtilArrayList.get(paramInt)).a(0, paramInt, paramView, paramViewGroup, null);
    if (localView != null)
    {
      a((ajjb)localView.getTag(), null);
  ...
  public void onClick(View paramView)
  {
    ...
    if (localajjb != null)
    {
      ...
      if ((localajjb.a instanceof Friends)) {
        localObject = (Friends)localajjb.a;
      }
    }
    if (localObject == null) {}
    for (;;)
    {
      ...
      try
      {
        ((bbbq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.MGR_RED_TOUCH)).b("100701.100702");
        label119:
        if ((this.jdField_a_of_type_AndroidContentContext instanceof BaseActivity))
        {
          ...
          localBaseActivity.requestPermissions(new ajkm(this, paramView, localBaseActivity), 3, new String[] { "android.permission.READ_EXTERNAL_STORAGE", "android.permission.WRITE_EXTERNAL_STORAGE" });
        }
        for (;;)
        {
          ...
          bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800603C", "0X800603C", 0, 0, "", "", "", "");
          break;
          label263:
          a(paramView);
          continue;
        ...
        if (AppConstants.DATALINE_IPAD_UIN.equals(((Friends)localObject).uin))
        {
          ...
          this.jdField_a_of_type_AndroidContentContext.startActivity((Intent)localObject);
          bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006041", "0X8006041", 0, 0, "", "", "", "");
          continue;
        }
        ...
        if ((this.jdField_a_of_type_AndroidContentContext instanceof BaseActivity))
        {
          ...
          if (!PermissionUtils.isStorePermissionEnable(localBaseActivity))
          {
            localBaseActivity.requestPermissions(new ajkn(this, paramView, (Friends)localObject, localBaseActivity), 3, new String[] { "android.permission.READ_EXTERNAL_STORAGE", "android.permission.WRITE_EXTERNAL_STORAGE" });
            continue;
          }
