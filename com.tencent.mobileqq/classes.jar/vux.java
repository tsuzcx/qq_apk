  ...
  extends vut
{
  ...
  private void a(DecodeConfig paramDecodeConfig, avyy paramavyy, int paramInt)
  {
    if (paramInt != 0)
    {
      paramavyy.h = paramInt;
      paramavyy.g = 0;
    }
    paramInt = Math.min(paramavyy.jdField_a_of_type_Int, paramavyy.b);
    int i = Math.max(paramavyy.jdField_a_of_type_Int, paramavyy.b);
    paramavyy.jdField_a_of_type_Int = paramInt;
    paramavyy.b = i;
    paramDecodeConfig.width = paramavyy.jdField_a_of_type_Int;
    paramDecodeConfig.height = paramavyy.b;
  }
  
  private boolean a(vuq paramvuq)
  {
    if (paramvuq.jdField_b_of_type_Boolean) {}
    while (!paramvuq.c) {
      return false;
    }
    return true;
  ...
  public void a(vuq paramvuq)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("VideoToVideo", 2, "[runLocalVideo2Video]run begin, taskid:" + paramvuq.jdField_b_of_type_Long + " run:" + paramvuq.d);
    }
    if (a(paramvuq))
    {
      vel.a("actVideo2VideoResult", new String[] { "9" });
      a(9, paramvuq.jdField_a_of_type_JavaLangString, null, null, paramvuq.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramvuq);
      return;
    }
    ...
    localObject1 = null;
    Object localObject2 = new File(paramvuq.jdField_a_of_type_JavaLangString);
    ...
    if (vyi.e((String)localObject1))
    {
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "before,getPCMFromFile[Have audio File]:  " + paramvuq.jdField_b_of_type_Long + " audioPath: " + (String)localObject1 + " audioFileSize=" + apvb.a((String)localObject1));
      }
      localObject2 = new vyf();
      l1 = System.currentTimeMillis();
      ((vyf)localObject2).a(paramvuq.jdField_a_of_type_JavaLangString, paramvuq.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo);
      l2 = System.currentTimeMillis();
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "run,getMetaDataFromFile:  " + paramvuq.jdField_b_of_type_Long + " cost=" + (l2 - l1) + " ms audioTrack: " + paramvuq.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Boolean + " mSampleRate: " + paramvuq.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_c_of_type_Int);
      }
    }
    for (;;)
    {
      ...
      localLocalMediaInfo.path = paramvuq.jdField_a_of_type_JavaLangString;
      localLocalMediaInfo.mDuration = paramvuq.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Long;
      l1 = System.currentTimeMillis();
      bool = ((vyf)localObject2).a(localLocalMediaInfo, 0, (int)paramvuq.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Long, (String)localObject1, paramvuq.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo);
      l2 = System.currentTimeMillis();
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "run,getPCMFromFile:  " + paramvuq.jdField_b_of_type_Long + " cost=" + (l2 - l1) + " ms audioTrack: " + paramvuq.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Boolean);
      }
      if (paramvuq.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Boolean)
      {
        if ((!bool) || (!vyi.e((String)localObject1)))
        {
          if (QLog.isColorLevel()) {
            QLog.d("VideoToVideo", 2, "run,getPCMFromFile: failed " + paramvuq.jdField_b_of_type_Long + " path=" + (String)localObject1 + " success=" + bool);
          }
          vyi.g((String)localObject1);
          vel.a("actVideo2VideoResult", new String[] { "8" });
          a(8, paramvuq.jdField_a_of_type_JavaLangString, null, null, paramvuq.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramvuq);
        }
      }
      else
      {
        vyi.g((String)localObject1);
        vyf.a((String)localObject1, (int)paramvuq.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Long);
        if (!vyi.e((String)localObject1))
        {
          if (QLog.isColorLevel()) {
            QLog.d("VideoToVideo", 2, "run[video convert],createSilentPCMFile: failed " + paramvuq.jdField_b_of_type_Long + " path=" + (String)localObject1);
          }
          vel.a("actVideo2VideoResult", new String[] { "8" });
          a(8, paramvuq.jdField_a_of_type_JavaLangString, null, null, paramvuq.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramvuq);
          return;
      ...
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "After,getPCMFromFile: hasAudioTrack= " + paramvuq.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Boolean + " path=" + (String)localObject1 + " success=" + bool + " audioFileSize=" + apvb.a((String)localObject1));
      }
    }
    paramvuq.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
    if (a(paramvuq))
    {
      vel.a("actVideo2VideoResult", new String[] { "9" });
      a(9, paramvuq.jdField_a_of_type_JavaLangString, null, null, paramvuq.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramvuq);
    ...
    boolean bool = a(paramvuq.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramvuq);
    ...
    vel.a("actVideo2VideoTime", new String[] { l3 - l4 + "" });
    if ((bool) && (apvb.a(this.jdField_a_of_type_JavaLangString)))
    {
      l3 = apvb.a(this.jdField_a_of_type_JavaLangString);
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "runLocalVideo2Video, file exist, size:" + l3 + " file:" + this.jdField_a_of_type_JavaLangString);
      }
      this.jdField_a_of_type_Int = 0;
      vel.a("actVideo2VideoResult", new String[] { "0" });
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "runLocalVideo2Video, taskid:" + paramvuq.jdField_b_of_type_Long + " run:" + paramvuq.d + " cost:" + (l2 - l1) + " ms successVideo:" + bool);
      }
      if (!paramvuq.d) {
        break;
      }
      a(this.jdField_a_of_type_Int, paramvuq.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString, null, paramvuq.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramvuq);
      return;
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "runLocalVideo2Video, [failed]file not exist:" + paramvuq.jdField_b_of_type_Long + " file:" + this.jdField_a_of_type_JavaLangString);
      }
      this.jdField_a_of_type_Int = 7;
      vel.a("actVideo2VideoResult", new String[] { "7" });
      vyi.g(this.jdField_a_of_type_JavaLangString);
    }
  }
  
  /* Error */
  public boolean a(SlideItemInfo arg1, vuq paramvuq)
  {
    // Byte code:
    //   0: aload_1
    //   1: ifnull +10 -> 11
    ...
    //   33: new 291	bkxg
    //   36: dup
    //   37: invokespecial 292	bkxg:<init>	()V
    //   40: putfield 294	vux:jdField_a_of_type_Bkxg	Lbkxg;
    ...
    //   165: invokevirtual 325	vux:a	(Lcom/tencent/mobileqq/activity/photo/LocalMediaInfo;)I
    //   168: istore 5
    //   170: new 22	avyy
    //   173: dup
    //   174: aload 13
    ...
    //   194: invokespecial 333	avyy:<init>	(Ljava/lang/String;IIIIZI)V
    //   197: astore 14
    //   199: aload 14
    //   201: sipush 720
    //   204: putfield 31	avyy:jdField_a_of_type_Int	I
    //   207: aload 14
    //   209: sipush 1280
    //   212: putfield 34	avyy:b	I
    //   215: aload_1
    ...
    //   292: sipush 720
    //   295: sipush 1280
    //   298: invokestatic 339	vzx:a	(IIII)Z
    //   301: ifeq +9 -> 310
    //   304: aload 14
    //   306: iconst_1
    //   307: putfield 340	avyy:c	Z
    ...
    //   340: aload 14
    //   342: iload 5
    //   344: invokespecial 345	vux:a	(Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;Lavyy;I)V
    //   347: aload 15
    //   349: iconst_1
    ...
    //   372: invokevirtual 64	vux:a	(Lcom/tencent/mobileqq/activity/photo/LocalMediaInfo;)Z
    ...
    //   488: aload_0
    //   489: getfield 294	vux:jdField_a_of_type_Bkxg	Lbkxg;
    //   492: aload 15
    //   494: aload 14
    //   496: new 370	vuy
    //   499: dup
    //   500: aload_0
    //   501: aload_2
    //   502: invokespecial 373	vuy:<init>	(Lvux;Lvuq;)V
    //   505: aconst_null
    //   506: invokevirtual 376	bkxg:a	(Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;Lavyy;Lavzk;Lbkxh;)V
    //   509: aload_0
    //   510: getfield 17	vux:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   513: astore_1
    //   514: aload_1
    //   515: monitorenter
    ...
    //   538: aload_2
    //   539: getfield 57	vuq:jdField_b_of_type_Boolean	Z
    ...
    //   564: aload_2
    //   565: getfield 383	vuq:jdField_a_of_type_Boolean	Z
    ...
    //   577: aload_2
    //   578: getfield 57	vuq:jdField_b_of_type_Boolean	Z
    //   581: ifne +84 -> 665
    //   584: aload_2
    //   585: getfield 60	vuq:c	Z
    //   588: ifne +77 -> 665
    //   591: aload_2
    //   592: getfield 383	vuq:jdField_a_of_type_Boolean	Z
    //   595: istore 6
    //   597: iload 6
    //   599: ifne +66 -> 665
    //   602: aload_0
    //   603: getfield 17	vux:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    ...
    //   667: aload_0
    //   668: aload_2
    //   669: invokespecial 391	vux:a	(Lvuq;)Z
    //   672: istore 7
    //   674: iload 7
    //   676: istore 6
  ...
  public void b(vuq paramvuq)
  {
    ...
    {
      paramvuq.jdField_b_of_type_Boolean = true;
