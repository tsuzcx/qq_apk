  ...
  implements sla
{
  ...
  protected oze a;
  private pfh jdField_a_of_type_Pfh = new ohy(this, null);
  public pir a;
  ...
  public ohx(int paramInt1, int paramInt2, Activity paramActivity, pia parampia)
  {
    super(paramActivity);
    this.jdField_c_of_type_Int = 1;
    this.jdField_d_of_type_Int = paramInt2;
    this.jdField_b_of_type_Int = paramInt1;
    this.jdField_a_of_type_Pir = ((pir)parampia);
    this.jdField_a_of_type_Oze = new oze();
    this.jdField_a_of_type_Oze.jdField_a_of_type_Long = bnrf.a(paramInt1, (QQAppInterface)ozs.a());
  }
  ...
  private void a(List<BaseArticleInfo> paramList, int paramInt)
  {
    ...
    localArrayList.addAll(this.jdField_a_of_type_Pir.a());
    paramList = poc.a().a(this.jdField_b_of_type_Int, paramList, localArrayList, paramInt);
    this.jdField_a_of_type_Pir.a(paramList);
    this.jdField_a_of_type_Pir.a();
  }
  ...
  private void a(boolean paramBoolean1, int paramInt1, boolean paramBoolean2, int paramInt2)
  {
    ...
    long l = a();
    ArticleInfo localArticleInfo = (ArticleInfo)this.jdField_a_of_type_Pir.a(0);
    ...
    this.jdField_a_of_type_Pir.a(paramBoolean1);
    localArrayList = new ArrayList();
    pfa.a().a(this.jdField_b_of_type_Int, (List)localObject, i, true, false, this.jdField_c_of_type_Int, null, -1L, null, a(), 0L, 0L, null, paramInt1, false, null, 0, localArrayList);
    this.jdField_c_of_type_Int += 1;
    if ((a() instanceof ReadInJoyNewFeedsActivity)) {
      a(-2);
    }
    ubg.a(paramInt1, this.jdField_b_of_type_Int, a(), paramBoolean2, paramInt2);
  }
  ...
  private boolean a(boolean paramBoolean)
  {
    ...
    boolean bool2 = this.jdField_a_of_type_Pir.a();
    boolean bool3 = ohp.a(this.jdField_b_of_type_Int);
    Object localObject = (KandianMergeManager)((BaseActivity)a()).app.getManager(162);
    boolean bool1;
    if (System.currentTimeMillis() - this.jdField_a_of_type_Oze.d > 300000L)
    {
      bool1 = true;
      boolean bool4 = c();
      ...
      bool1 = ohp.c(this.jdField_b_of_type_Int);
    ...
    for (;;)
    {
      ...
      if (this.jdField_b_of_type_Int != 70)
      {
        ...
        if (this.jdField_b_of_type_Int != 56)
        {
          ...
          {
            bool1 = paramBoolean;
            if (!pbd.c(this.jdField_b_of_type_Int)) {
              bool1 = true;
            }
          }
        }
    ...
    label377:
    localObject = this.jdField_a_of_type_Oze;
    if (this.jdField_a_of_type_Oze.jdField_a_of_type_Long == 0L) {}
    for (;;)
    {
      ((oze)localObject).jdField_a_of_type_Long = l;
      if (this.jdField_b_of_type_Int == 0) {}
      return false;
      l = this.jdField_a_of_type_Oze.jdField_a_of_type_Long;
    }
  }
  ...
  {
    this.jdField_a_of_type_Pir.a();
    this.jdField_a_of_type_Pir.a(paramBaseArticleInfo, paramInt);
    QQToast.a(this.jdField_a_of_type_AndroidAppActivity, -1, this.jdField_a_of_type_AndroidAppActivity.getString(2131698587), 0).b(((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).getTitleBarHeight());
    if (poc.a(paramBaseArticleInfo.mRecommendSeq)) {
      poc.a().a(this.jdField_b_of_type_Int, paramBaseArticleInfo.mRecommendSeq);
    }
    do
    {
      do
      {
        ...
        localDislikeInfo.jdField_a_of_type_JavaLangString = anzj.a(2131711598);
        localDislikeInfo.jdField_a_of_type_Int = 9;
        localDislikeInfo.b = "";
        ArrayList localArrayList = new ArrayList();
        localArrayList.add(localDislikeInfo);
        pfa.a().a(Long.valueOf(str).longValue(), ((ArticleInfo)paramBaseArticleInfo).makeDislikeParam(localArrayList));
        pfa.a().a(this.jdField_b_of_type_Int, paramBaseArticleInfo);
      } while (paramInt != 0);
      paramBaseArticleInfo = (KandianMergeManager)((QQAppInterface)ozs.a()).getManager(162);
    } while (this.jdField_a_of_type_Pir.a().size() > 0);
  ...
  public void a(ReadInjoyXRecyclerView paramReadInjoyXRecyclerView, int paramInt)
  {
    ...
    for (;;)
    {
      pfa.a().a(this.jdField_b_of_type_Int, a(), paramInt, 0, i);
  ...
  public void a(ReadInjoyXRecyclerView paramReadInjoyXRecyclerView, boolean paramBoolean)
  {
    ...
    if ((!ozs.a()) || (d()) || (paramBoolean))
    {
      ...
      pfd.a().a(2, null);
      ReadinjoyTabFrame localReadinjoyTabFrame = ozs.a(a());
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    ...
    {
      return;
      this.jdField_a_of_type_Pir.c();
    } while (!paramBoolean);
    this.jdField_a_of_type_Pir.b();
  }
  ...
  public void b()
  {
    ...
    super.b();
    if (this.jdField_a_of_type_Pir != null) {
      this.jdField_a_of_type_Pir.a(a(Integer.valueOf(this.jdField_b_of_type_Int)), b(Integer.valueOf(this.jdField_b_of_type_Int)));
    }
    this.jdField_a_of_type_Oze.b = System.currentTimeMillis();
  ...
  public void c()
  {
    ...
    do
    {
      ...
      super.c();
    } while (this.jdField_a_of_type_Pir == null);
    this.jdField_a_of_type_Pir.a(b(Integer.valueOf(this.jdField_b_of_type_Int)), a(Integer.valueOf(this.jdField_b_of_type_Int)));
  }
  ...
  public void i()
  {
    this.jdField_a_of_type_JavaUtilArrayList = ((ArrayList)pfa.a().a(this.jdField_b_of_type_Int));
    if ((this.jdField_a_of_type_JavaUtilArrayList == null) || (this.jdField_a_of_type_JavaUtilArrayList.size() == 0)) {
      pfa.a().c(this.jdField_b_of_type_Int);
    }
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0)) {
      this.jdField_a_of_type_Pir.c(this.jdField_a_of_type_JavaUtilArrayList);
    }
    pfa.a().a(this.jdField_b_of_type_Int);
  }
  ...
  public void k()
  {
    if (this.jdField_a_of_type_Pir != null)
    {
      ...
      Map localMap2 = ubg.a(this.jdField_b_of_type_Int);
      ThreadManager.executeOnSubThread(new ReadInJoyChannelWaterFallViewController.1(this, localMap1, a(Integer.valueOf(this.jdField_b_of_type_Int)), localMap2, ozs.e(this.jdField_b_of_type_Int)));
