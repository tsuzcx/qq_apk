  ...
  implements bfpc
{
  ...
  private baxk jdField_a_of_type_Baxk = new baxk(this.jdField_a_of_type_AndroidContentContext, ajae.a());
  private bbqu jdField_a_of_type_Bbqu = new aqtd(this);
  private String jdField_a_of_type_JavaLangString;
  private List<FeedsItemData.FriendInfo> jdField_a_of_type_JavaUtilList;
  
  protected aqtc(Context paramContext)
  {
    super(paramContext);
    this.jdField_a_of_type_AndroidContentContext = paramContext;
  }
  
  public aqtc(Context paramContext, String paramString, int paramInt)
  {
    this(paramContext);
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_JavaLangString = paramString;
    f();
    ajae.a().addObserver(this.jdField_a_of_type_Bbqu);
    ((bbqp)ajae.a().getBusinessHandler(71)).a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int);
  }
  ...
  private String a(long paramLong)
  {
    ...
    if (paramLong < 60L) {
      return paramLong / 60L + ajyc.a(2131710286);
    }
    if ((paramLong >= 60L) && (paramLong < 3600L)) {
      return paramLong / 60L + ajyc.a(2131710289);
    }
    if ((paramLong >= 3600L) && (paramLong < paramLong / 86400L)) {
      return paramLong / 3600L + ajyc.a(2131710287);
    }
    int i = (int)(paramLong / 86400L);
    if (i >= 30) {
      return i / 30 + ajyc.a(2131710292);
    }
    if (i >= 7) {
      return i / 7 + ajyc.a(2131710290);
    }
    return i + ajyc.a(2131710291);
  }
  
  private void f()
  {
    LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(-1, actn.a(500.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
    ...
    Object localObject1 = new RelativeLayout.LayoutParams(-1, (int)(bbct.k() / 750L * 36L));
    ...
    ((TextView)localObject2).setText(ajyc.a(2131710288));
    Object localObject3 = new RelativeLayout.LayoutParams(-2, -2);
    ((RelativeLayout.LayoutParams)localObject3).addRule(9);
    ((RelativeLayout.LayoutParams)localObject3).setMargins(actn.a(20.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actn.a(16.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0, 0);
    ...
    this.jdField_a_of_type_Aqte = new aqte(this, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaUtilList);
    ((ListView)localObject3).setAdapter(this.jdField_a_of_type_Aqte);
    ...
    ((ListView)localObject3).setSelector(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130849549));
  ...
  {
    super.dismiss();
    ajae.a().removeObserver(this.jdField_a_of_type_Bbqu);
  }
  
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    paramAdapterView = (ajxn)ajae.a().getManager(51);
