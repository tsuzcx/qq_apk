...
public class bkfi
{
  ...
  public bkfi a()
  {
    bkfi localbkfi = new bkfi();
    localbkfi.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.putAll(this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap);
    return localbkfi;
  }
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    bkfe.d = a("land_page", paramJSONObject.optString("land_page_id", bkfe.d));
    bkfe.b = a("obj_ownerid", paramJSONObject.optString("obj_ownerid", bkfe.b));
    bkfe.g = a("algo_id", paramJSONObject.optString("algo_id", "0"));
  }
  ...
  public void b(JSONObject paramJSONObject)
  {
    ...
    bkfe.a = a("mod", paramJSONObject.optString("mod_18", bkfe.a));
    bkfe.e = a("obj_pos", paramJSONObject.optString("obj_pos_14", bkfe.e));
    bkfe.f = a("detailpage_from", paramJSONObject.optString("detailpage_from_45", bkfe.f));
  }
