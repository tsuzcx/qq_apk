...
public class bfxr
{
  private static volatile bfxr jdField_a_of_type_Bfxr;
  private Map<String, bfxs> jdField_a_of_type_JavaUtilMap = a(LocalMultiProcConfig.getString("Qz_setting", "NetworkedModuleConfig_cur", ""));
  private Map<String, bfxs> b = new ConcurrentHashMap();
  
  public static bfxr a()
  {
    if (jdField_a_of_type_Bfxr == null) {}
    try
    {
      if (jdField_a_of_type_Bfxr == null) {
        jdField_a_of_type_Bfxr = new bfxr();
      }
      return jdField_a_of_type_Bfxr;
    }
    finally {}
  }
  
  private bfxs a(UPDATE_INFO paramUPDATE_INFO)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject1 = new bfxt();
        ((bfxt)localObject1).a(str3).b(str5).c(str6).d((String)localObject3).e(str4).f(paramUPDATE_INFO).g((String)localObject4).a(i).a(0L);
        return ((bfxt)localObject1).a();
      }
  ...
  static String a(Map<String, bfxs> paramMap)
  {
    if ((paramMap != null) && (paramMap.size() > 0))
    {
      ...
      for (;;)
      {
        if (localIterator.hasNext())
        {
          ...
          localObject = (bfxs)paramMap.get(localObject);
          try
          {
            localJSONObject2.put("module_id", ((bfxs)localObject).jdField_a_of_type_JavaLangString);
            localJSONObject2.put("module_md5", ((bfxs)localObject).e);
            localJSONObject2.put("module_url", ((bfxs)localObject).d);
            localJSONObject2.put("module_version", ((bfxs)localObject).b);
            localJSONObject2.put("module_main_version", ((bfxs)localObject).c);
            localJSONObject2.put("module_key_class_name", ((bfxs)localObject).f);
            localJSONObject2.put("module_class_ids", ((bfxs)localObject).h);
            localJSONObject2.put("module_class_ids_count", ((bfxs)localObject).jdField_a_of_type_Int);
            localJSONObject2.put("module_file_length", ((bfxs)localObject).jdField_a_of_type_Long);
  ...
  static Map<String, bfxs> a(String paramString)
  {
      ...
      try
      {
        ...
        if (paramString != null)
        {
          ...
          while (i < j)
          {
            ...
            {
              localObject2 = new bfxt();
              ((bfxt)localObject2).a((String)localObject1).b(str3).c(str4).d(str2).e(str1).f(str5).g(str6).a(k).a(l);
              localObject1 = ((bfxt)localObject2).a();
              localConcurrentHashMap.put(((bfxs)localObject1).jdField_a_of_type_JavaLangString, localObject1);
            }
            i += 1;
          }
        }
  ...
  public bfxs a(String paramString)
  {
    boolean bool = true;
    label386:
    for (;;)
    {
      try
      {
        bfxs localbfxs1 = (bfxs)this.jdField_a_of_type_JavaUtilMap.get(paramString);
        bfxs localbfxs2 = (bfxs)this.b.get(paramString);
        Object localObject = localbfxs2;
        if (localbfxs2 == null)
        {
          localbfxs2 = QzoneModuleRecordFactory.getInstance().createRecord(paramString);
          ...
          localObject = localbfxs2;
          if (localbfxs2 != null)
          {
            this.b.put(paramString, localbfxs2);
            localObject = localbfxs2;
          }
        }
        if (localbfxs1 != null)
        {
          localbfxs1.jdField_a_of_type_Bfxs = ((bfxs)localObject);
          paramString = localbfxs1;
          localObject = paramString;
          if (paramString != null)
          {
            if ((paramString.jdField_a_of_type_Bfxs != null) && (!TextUtils.isEmpty(paramString.jdField_a_of_type_Bfxs.g)) && (!bfpk.a().equalsIgnoreCase(paramString.jdField_a_of_type_Bfxs.g)))
            {
              QLog.i("QzoneModuleConfigManager", 1, "mNewVersion.mQua=" + paramString.jdField_a_of_type_Bfxs.g + " is not equal QUA=" + bfpk.a());
              paramString.jdField_a_of_type_Bfxs = null;
            }
            localObject = paramString;
            if (!TextUtils.isEmpty(paramString.g))
            {
              localObject = paramString;
              if (!bfpk.a().equalsIgnoreCase(paramString.g))
              {
                QLog.i("QzoneModuleConfigManager", 1, "curRecord.mQua=" + paramString.g + " is not equal QUA=" + bfpk.a());
                if ((paramString.jdField_a_of_type_Bfxs == null) || (!paramString.e.equalsIgnoreCase(paramString.jdField_a_of_type_Bfxs.e))) {
                  continue;
                }
                localObject = paramString.jdField_a_of_type_Bfxs;
                a((bfxs)localObject);
        ...
        else
        {
          ...
          ((bfxs)localObject).jdField_a_of_type_Bfxs = ((bfxs)localObject);
          if (!TextUtils.equals(((bfxs)localObject).e, ((bfxs)localObject).e)) {
            break label386;
          }
          ((bfxs)localObject).jdField_a_of_type_Long = ((bfxs)localObject).jdField_a_of_type_Long;
          break label386;
        }
        localObject = paramString.jdField_a_of_type_Bfxs;
        continue;
  ...
  public ArrayList<UPDATE_INFO> a()
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      bfxs localbfxs = (bfxs)this.jdField_a_of_type_JavaUtilMap.get(str);
      if (localbfxs != null) {}
      for (localUPDATE_INFO.ver = localbfxs.b;; localUPDATE_INFO.ver = "0")
      {
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramSQ_CLIENT_UPDATE_RSP.hasNext())
        {
          ...
          if (localObject != null) {
            this.b.put(((bfxs)localObject).jdField_a_of_type_JavaLangString, localObject);
          }
          if (localUPDATE_INFO.actype == 4)
          {
            QLog.w("QzoneModuleConfigManager", 1, "clear module config:" + localUPDATE_INFO.id);
            localObject = (bfxs)this.jdField_a_of_type_JavaUtilMap.get(localUPDATE_INFO.id);
            if (localObject == null) {
              break label508;
            }
            localObject = new File(QzoneModuleConst.getModuleSavePath(BaseApplicationImpl.getApplication(), (bfxs)localObject));
          ...
          bfxs localbfxs = (bfxs)this.jdField_a_of_type_JavaUtilMap.get(localUPDATE_INFO.id);
          if (localbfxs == null) {
            continue;
          }
          this.jdField_a_of_type_JavaUtilMap.remove(localUPDATE_INFO.id);
          if (!localbfxs.e.equalsIgnoreCase(localUPDATE_INFO.md5))
          {
            localObject = new File(QzoneModuleConst.getModuleSavePath(BaseApplicationImpl.getApplication(), localbfxs));
            if (((File)localObject).exists()) {
              ((File)localObject).delete();
            }
  ...
  public void a(bfxs parambfxs)
  {
    if (parambfxs != null) {}
    try
    {
      this.b.remove(parambfxs.jdField_a_of_type_JavaLangString);
      Object localObject = (bfxs)this.jdField_a_of_type_JavaUtilMap.get(parambfxs.jdField_a_of_type_JavaLangString);
      if ((localObject != null) && (!((bfxs)localObject).e.equalsIgnoreCase(parambfxs.e)))
      {
        localObject = new File(QzoneModuleConst.getModuleSavePath(BaseApplicationImpl.getApplication(), (bfxs)localObject));
        if (((File)localObject).exists()) {
          ((File)localObject).delete();
      ...
      localObject = new File(QzoneModuleConst.getModuleSavePath(BaseApplicationImpl.getApplication(), parambfxs));
      if (((File)localObject).exists()) {
        parambfxs.jdField_a_of_type_Long = ((File)localObject).length();
      }
      this.jdField_a_of_type_JavaUtilMap.put(parambfxs.jdField_a_of_type_JavaLangString, parambfxs);
      LocalMultiProcConfig.putString("Qz_setting", "NetworkedModuleConfig_cur", a(this.jdField_a_of_type_JavaUtilMap));
      QzoneModuleConst.clearLastCrashCount(parambfxs.jdField_a_of_type_JavaLangString);
      return;
    }
    finally {}
  }
  
  public void b(bfxs parambfxs)
  {
    try
    {
      this.b.put(parambfxs.jdField_a_of_type_JavaLangString, parambfxs);
      return;
    }
    finally
    {
