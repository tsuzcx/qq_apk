...
{
  private static final String jdField_a_of_type_JavaLangString = anly.class.getSimpleName();
  ...
  private anmc jdField_a_of_type_Anmc;
  ...
  public anly(int paramInt1, int paramInt2)
  {
  ...
  private void d()
  {
    this.jdField_a_of_type_Anmc = new anmc();
    this.jdField_a_of_type_Anmc.a();
    if (this.jdField_b_of_type_Boolean) {
      Log.d(jdField_a_of_type_JavaLangString, "textureID=" + this.jdField_a_of_type_Anmc.a());
    }
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture = new SurfaceTexture(this.jdField_a_of_type_Anmc.a());
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Anmc = null;
  ...
  {
    this.jdField_a_of_type_Anmc.a(this.jdField_a_of_type_AndroidGraphicsSurfaceTexture, paramBoolean);
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Anmc.a("before updateTexImage");
