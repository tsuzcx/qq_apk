  ...
  extends GestureDetector
{
  ...
  Animator.AnimatorListener jdField_a_of_type_AndroidAnimationAnimator$AnimatorListener = new anlz(this);
  Context jdField_a_of_type_AndroidContentContext;
  Rect jdField_a_of_type_AndroidGraphicsRect;
  View jdField_a_of_type_AndroidViewView;
  ImageView jdField_a_of_type_AndroidWidgetImageView;
  anmc jdField_a_of_type_Anmc = new anmc(this, null);
  ...
  public anly(Context paramContext, GestureDetector.SimpleOnGestureListener paramSimpleOnGestureListener, BaseChatPie paramBaseChatPie)
  {
    ...
    else
    {
      ...
      this.jdField_j_of_type_Int = paramContext.getResources().getDimensionPixelOffset(2131167766);
    ...
    for (int i1 = 0;; i1 = ImmersiveUtils.getStatusBarHeight(this.jdField_a_of_type_AndroidContentContext))
    {
      ...
      if (!(paramBaseChatPie instanceof aede)) {
        break;
      }
  ...
  private String a(anlr paramanlr)
  {
    if (paramanlr.jdField_a_of_type_ComTencentMobileqqDataEmoticon == null)
    {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null) {
      try
      {
        int i1 = Integer.parseInt(paramanlr.jdField_a_of_type_ComTencentMobileqqDataEmoticon.eId);
        int i2 = Integer.parseInt(paramanlr.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId);
        paramanlr = anam.a(i2, i1);
        EmoticonPackage localEmoticonPackage = ((arnz)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(14)).a(String.valueOf(i2));
        char[] arrayOfChar = new char[5];
        arrayOfChar[0] = '\024';
        arrayOfChar[1] = paramanlr[3];
        arrayOfChar[2] = paramanlr[2];
        arrayOfChar[3] = paramanlr[1];
        arrayOfChar[4] = paramanlr[0];
        if ((localEmoticonPackage != null) && (localEmoticonPackage.isAPNG == 2)) {
          arrayOfChar[1] = 'ǿ';
        }
        paramanlr = new StringBuilder(String.valueOf(arrayOfChar));
        EmojiStickerManager.a(paramanlr);
        return paramanlr.toString();
      }
  ...
  private void e()
  {
    ...
    babr.a(this.jdField_a_of_type_AndroidContentContext, 230).setTitle(ajjy.a(2131648596)).setMessage(ajjy.a(2131648589)).setPositiveButton(ajjy.a(2131648595), new anmb(this)).setNegativeButton("取消", new anma(this)).show();
    int i1;
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null)
    {
  ...
  void a(float paramFloat1, float paramFloat2)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerFrameLayout != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView != null))
    {
      ...
      localViewPropertyAnimator.setListener(this.jdField_a_of_type_Anmc);
  ...
  void a(View paramView, boolean paramBoolean)
  {
    ...
    if (paramView != null)
    {
      localalmt = (almt)paramView.getTag(2131298155);
      localObject = (ChatMessage)paramView.getTag(2131298595);
      bool = false;
      if (localObject != null) {
      ...
      if (localalmt != null)
      {
        ...
        ((alok)localObject).b(paramBoolean);
      }
    }
    label77:
    ...
    {
      if (bool) {}
      for (i1 = 2130848702;; i1 = 2130848509)
      {
        ...
        localalmt.a(paramView, (Drawable)localObject);
        return;
      }
    }
    if (bool) {}
    for (int i1 = 2130848703;; i1 = 2130848510)
    {
      localObject = ((Resources)localObject).getDrawable(i1);
      break label112;
      break;
  ...
  void a(String paramString)
  {
    ...
    bbmy.a(this.jdField_a_of_type_AndroidContentContext, paramString, 0).b(this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131167766));
  }
  ...
  boolean a()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityFlingTopGestureLayout != null)
    {
      ...
      while (i1 >= 0)
      {
        ...
        if (((View)localObject).getId() == 2131307178)
        {
          ...
          double d1;
          if (((localObject instanceof anla)) || ((localObject instanceof Emoticon)) || ((localObject instanceof ankl)))
          {
            this.s = 1;
          ...
          {
            return true;
            if ((!(localObject instanceof anmf)) && (!(localObject instanceof anlr))) {
              break;
            }
            this.s = 0;
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null)
    {
      ...
      {
        localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityFlingTopGestureLayout.findViewById(2131307213);
    ...
    {
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityFlingTopGestureLayout.findViewById(2131307212);
      if (localObject1 != null) {
        return ((View)localObject1).onTouchEvent(paramMotionEvent);
      }
    }
    ...
    {
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityFlingTopGestureLayout.findViewById(2131307215);
      if (localObject1 != null) {
        return ((View)localObject1).onTouchEvent(paramMotionEvent);
      }
    }
          ...
          for (;;)
          {
            ...
            if ((localObject1 instanceof BaseChatItemLayout))
            {
              ...
              if (i1 >= 0)
              {
                ...
                if ((localObject3 != null) && (((View)localObject3).getId() == 2131298552))
                {
            ...
            for (;;)
            {
              ...
              if ((this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerFrameLayout.getTag(2131307214) instanceof Integer)) {
                i1 = ((Integer)this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerFrameLayout.getTag(2131307214)).intValue();
              }
              ...
              {
                localObject1 = (anmf)localObject1;
                if (((anmf)localObject1).jdField_a_of_type_Int == 1)
                {
                  this.t = 2;
                  break label1902;
                }
                if (((anmf)localObject1).jdField_a_of_type_Int != 2) {
                  break label1902;
                }
                this.t = 3;
                break label1902;
              }
              if ((localObject1 instanceof anlr))
              {
                this.t = 4;
                break label1902;
              }
              if (!(localObject1 instanceof ankl)) {
                break label1902;
              }
              this.t = 5;
              break label1902;
            ...
            if (b(this.jdField_c_of_type_Float, this.jdField_d_of_type_Float, paramMotionEvent))
            {
              ...
              if (this.jdField_a_of_type_ComTencentMobileqqActivityFlingTopGestureLayout != null)
              {
                ...
                if ((i1 == EmoticonPanelLinearLayout.jdField_d_of_type_Int) && (!bajr.b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)))
                {
                  e();
                  return true;
                }
            ...
            for (;;)
            {
              ...
              for (;;)
              {
                ...
                Object localObject4;
                ankl localankl;
                if ((paramMotionEvent instanceof anla))
                {
                  localObject1 = (anla)paramMotionEvent;
                  localObject2 = null;
                  localObject4 = null;
                  localObject3 = null;
                  localankl = null;
                ...
                for (;;)
                {
                  label2921:
                  View localView;
                  if ((!EmojiStickerManager.f) && (bace.a() > 1.048576E+008F))
                  {
                    i1 = 1;
                    paramMotionEvent = null;
                    if ((localObject1 == null) || (((anla)localObject1).jdField_a_of_type_ComTencentMobileqqDataEmoticon == null)) {
                      break label3566;
                    }
                    if (i1 == 0) {
                      break label3549;
                    }
                    paramMotionEvent = ((anla)localObject1).a("fromAIO", true, false, null, (int)(this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerFrameLayout.getWidth() * this.jdField_b_of_type_Double), (int)(this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerFrameLayout.getHeight() * this.jdField_b_of_type_Double));
                    ...
                    if ((localView == null) || (localView.getId() != 2131298552)) {
                      break label7828;
                    }
                    ...
                    localObject6 = (ChatMessage)localView.getTag(2131298595);
                  ...
                  for (;;)
                  {
                    ...
                    if (i2 != 0)
                    {
                      ...
                      if ((paramMotionEvent instanceof anmf))
                      {
                        localObject4 = (anmf)paramMotionEvent;
                        localObject2 = null;
                        localObject3 = null;
                        localankl = null;
                        localObject1 = null;
                      ...
                      if ((paramMotionEvent instanceof anlr))
                      {
                        localObject2 = (anlr)paramMotionEvent;
                        localObject4 = null;
                        localObject3 = null;
                        localankl = null;
                        localObject1 = null;
                      ...
                      if (!(paramMotionEvent instanceof ankl)) {
                        break label8000;
                      }
                      localankl = (ankl)paramMotionEvent;
                      localObject2 = null;
                      localObject4 = null;
                      localObject3 = null;
                      localObject1 = null;
                      ...
                      break label2921;
                      label3549:
                      paramMotionEvent = ((anla)localObject1).a(this.jdField_a_of_type_AndroidContentContext, this.jdField_g_of_type_Float);
                      break label2981;
                      label3566:
                      if (localObject4 != null)
                      {
                        paramMotionEvent = ((anmf)localObject4).b(this.jdField_a_of_type_AndroidContentContext, this.jdField_g_of_type_Float);
                        break label2981;
                      }
                      ...
                      if (localObject2 != null)
                      {
                        paramMotionEvent = ((anlr)localObject2).b(this.jdField_a_of_type_AndroidContentContext, this.jdField_g_of_type_Float);
                        break label2981;
                      }
                      if (localankl == null) {
                        break label2981;
                      }
                      paramMotionEvent = localankl.b(this.jdField_a_of_type_AndroidContentContext, this.jdField_g_of_type_Float, 0, 0);
                      break label2981;
                    ...
                    for (;;)
                    {
                      if ((localObject6 != null) && (((ChatMessage)localObject6).extraflag != 32772) && (((ChatMessage)localObject6).extraflag != 32768) && (bool3) && (bool4) && (((ChatMessage)localObject6).msgtype != -2009) && (((ChatMessage)localObject6).msgtype != -2016) && (!(localObject6 instanceof MessageForLongMsg)) && (!(localObject6 instanceof MessageForLongTextMsg)) && (bool2) && (i5 != 0) && (i4 == 0) && (i3 == 0) && (i1 == 0))
                      {
                        ...
                        if ((localObject1 != null) && (((anla)localObject1).jdField_a_of_type_ComTencentMobileqqDataEmoticon != null))
                        {
                          localObject5 = ((anla)localObject1).jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId;
                          if (f2 - i16 + this.r <= i8) {
                            break label4786;
                          }
                        ...
                        for (;;)
                        {
                          ...
                          if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null) && (localObject5 != null))
                          {
                            ...
                            if (bool1)
                            {
                              ...
                              if (localObject1 != null)
                              {
                                ((anla)localObject1).jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerInfo = ((EmojiStickerManager.StickerInfo)localObject6);
                                ((ChatMessage)localObject5).stickerHidden = false;
                                this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a((anht)localObject1);
                              }
                              do
                              {
                                for (;;)
                                {
                                  ...
                                  if (localObject3 != null)
                                  {
                                    aael.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, (Emoticon)localObject3, (EmojiStickerManager.StickerInfo)localObject6);
                                  }
                                  else
                                  {
                                    if (localObject4 != null)
                                    {
                                      if (((anmf)localObject4).jdField_a_of_type_Int == 1) {}
                                      for (paramMotionEvent = axku.c(((anmf)localObject4).jdField_b_of_type_Int);; paramMotionEvent = axku.a(((anmf)localObject4).jdField_b_of_type_Int))
                                      {
                                    ...
                                    paramMotionEvent = a((anlr)localObject2);
                                    this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(paramMotionEvent, (EmojiStickerManager.StickerInfo)localObject6);
                                  }
                                }
                              } while (localankl == null);
                              ...
                              localObject5 = localankl.d;
                              if (!TextUtils.isEmpty(localankl.c)) {}
                              for (bool1 = true;; bool1 = false)
                              {
                                aael.a(paramMotionEvent, (Context)localObject2, (SessionInfo)localObject4, (String)localObject5, true, bool1, localankl.c, (EmojiStickerManager.StickerInfo)localObject6);
                                break;
                              }
                              label6137:
                              ...
                              a(String.format(ajjy.a(2131648598), new Object[] { Integer.valueOf(EmojiStickerManager.jdField_e_of_type_Int) }));
                                ...
                                if (i1 == 2)
                                {
                                  ...
                                  if ((localObject1 instanceof FragmentActivity))
                                  {
                                    ...
                                    if (((FragmentActivity)localObject1).getChatFragment() != null)
                                    {
                                      ...
                                      if ((((localObject1 instanceof aebg)) || ((localObject1 instanceof aedo)) || ((localObject1 instanceof aede))) && (EmojiStickerManager.a().jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() > 0))
                                      {
