  ...
  implements bnir
{
  ...
  public bkjt(bmcv parambmcv, bmcu parambmcu)
  {
  ...
  private void b(Intent paramIntent)
  {
    ...
    if (!TextUtils.isEmpty(paramIntent))
    {
      ...
      localArrayList.add("*");
      atda.a(paramIntent, null, localArrayList, null);
    }
    localActivity.finish();
  }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if (paramIntent != null)
    {
      ...
      this.jdField_a_of_type_Bmcv.a().setResult(paramInt2, paramIntent);
    }
  ...
  public void a(int paramInt, blon paramblon)
  {
    ...
    int i = paramblon.a();
    paramblon = wta.b(h());
    jdField_a_of_type_JavaUtilHashSet.add(Integer.valueOf(paramblon));
    if ((i == 2) || (i == 4) || (i == 5))
    {
    ...
    for (paramInt = (int)(jdField_a_of_type_Long - this.jdField_b_of_type_Long);; paramInt = 0)
    {
      ...
      wta.a("time_waitshoot", 10002, paramInt, new String[] { "", paramblon, "", "" });
      return;
    }
  }
  ...
  {
    int i = this.jdField_a_of_type_Bmcv.a().getIntent().getIntExtra("entrance_type", 1);
    this.jdField_a_of_type_Bmcn = new bmcn(10002, i, 1);
    super.a(paramBundle);
    if (i == 104) {
      wta.a("video_shoot_fromweb", "exp_cam", 0, 0, new String[0]);
    }
    if (i == 18) {
      wta.a("video_shoot_new", "shoot_exp", 1, 0, new String[] { "", "", "", "18" });
    }
    jdField_a_of_type_Long = -1L;
    y = false;
    jdField_a_of_type_JavaUtilHashSet = new HashSet();
    l = String.valueOf(i);
    z = false;
    long l1 = this.jdField_a_of_type_Bmcv.a().getIntent().getLongExtra("TIMESTAMP_START_ACTIVITY", 0L);
    if (l1 != 0L)
    {
  ...
  public void a(axmn paramaxmn)
  {
    ...
    if (this.jdField_a_of_type_Bmcn.jdField_b_of_type_Int != 102)
    {
      ...
      bool4 = true;
      label56:
      Object localObject = new bmcq(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView.a()).b(bool1).c(bool2).d(true).a(bool4).e(bool3).c(h()).a(11).a();
      ...
      bngr.a(this.jdField_a_of_type_Bmcv.a(), paramaxmn, this.jdField_a_of_type_Bmcn, this.jdField_a_of_type_AndroidOsBundle, this.jdField_a_of_type_Int, (Bundle)localObject);
      if (!y)
      {
        y = true;
        wta.a("clk_mode", 10002, 0, new String[] { ShortVideoUtils.a(jdField_a_of_type_JavaUtilHashSet), "0", "", "" });
      }
      if (!z)
      {
        z = true;
    ...
    {
      wta.a("time_shoot", 10002, i, new String[] { wta.b(h()), "0", "", "" });
      return;
      bool1 = false;
      break;
      bool2 = false;
  ...
  public void a(CameraCaptureView.VideoCaptureResult paramVideoCaptureResult, LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    if (this.jdField_a_of_type_Bmcn.jdField_b_of_type_Int != 102)
    {
      ...
      if ((this.jdField_a_of_type_Bmcn.b() == 108) || (!this.h)) {
        break label432;
      }
      bool4 = true;
      label110:
      Bundle localBundle = this.jdField_a_of_type_Bmcv.a().getIntent().getExtras();
      Object localObject = new bmct().a(false).e(bool1).f(bool2).g(true).h(bool4).i(bool3).c(h()).j(true);
      this.jdField_a_of_type_Bmcn.a(((bmct)localObject).a());
      if (!this.h) {
        break label438;
      }
      i = 2;
    ...
    for (int i = (int)(System.currentTimeMillis() - jdField_a_of_type_Long);; i = 0)
    {
      wta.a("time_shoot", 10002, i, new String[] { wta.b(h()), String.valueOf(paramLocalMediaInfo.mDuration), "", "" });
      return;
      bool1 = false;
      break;
      bool2 = false;
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (!paramBoolean1)
    {
      ...
      localObject = this.jdField_a_of_type_Blly;
      if (paramBoolean1) {
        break label206;
      }
      paramBoolean2 = true;
      label30:
      ((blly)localObject).g(paramBoolean2);
      if (!paramBoolean1) {
        break label211;
      }
      ...
      if ((this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) && (this.e != null))
      {
        ...
        ((RelativeLayout.LayoutParams)localObject).addRule(2, 2131366807);
        i = xod.a(this.jdField_a_of_type_Bmcv.a(), 88.0F);
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.removeView(this.e);
    localObject = new RelativeLayout.LayoutParams(-1, -1);
    ((RelativeLayout.LayoutParams)localObject).addRule(2, 2131372365);
    int i = xod.a(this.jdField_a_of_type_Bmcv.a(), 88.0F);
    this.e.setTranslationY(i);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.addView(this.e, (ViewGroup.LayoutParams)localObject);
  ...
  public boolean a()
  {
    ...
    {
      wta.a("time_waitshoot", 10002, i, new String[] { "", "1", "", "" });
      if ((!y) && (bool))
      {
        y = true;
        wta.a("clk_mode", 10002, 0, new String[] { ShortVideoUtils.a(jdField_a_of_type_JavaUtilHashSet), "1", "", "" });
      }
      return bool;
    }
  }
  ...
  public void ac()
  {
    ...
    if (!this.jdField_b_of_type_JavaUtilHashSet.contains(Integer.valueOf(this.jdField_b_of_type_Int)))
    {
      ...
      wta.a("start_shoot", 10002, 0, new String[] { wta.b(h()), "0", "", l });
    }
  }
  ...
  void ad()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 159	bkjt:jdField_a_of_type_DovComQqImCaptureModeCaptureModeController	Ldov/com/qq/im/capture/mode/CaptureModeController;
    //   4: invokevirtual 353	dov/com/qq/im/capture/mode/CaptureModeController:a	()Lbmdi;
    //   7: invokevirtual 731	bmdi:b	()Ljava/lang/String;
    //   10: astore_3
    //   11: aload_3
    //   12: ifnull +231 -> 243
    ...
    //   87: aload 4
    //   89: ldc_w 765
    //   92: invokestatic 769	alpo:a	(I)Ljava/lang/String;
    ...
    //   162: aload_0
    //   163: getfield 550	bkjt:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    //   166: ldc_w 806
    ...
    //   210: ldc_w 830
    //   213: aload_0
    //   214: getfield 324	bkjt:jdField_b_of_type_Int	I
    ...
    //   232: aload_0
    //   233: getfield 550	bkjt:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    //   236: ldc_w 806
    //   239: aload_3
  ...
  {
    int i = 0;
    int k = this.jdField_a_of_type_Bmcv.a().getIntent().getExtras().getInt("capture_intent_mode", 0);
    int j = blop.a(k);
  ...
  public void d(int paramInt)
  {
    ...
    case 2: 
      ...
      return;
    case 3: 
      this.jdField_a_of_type_DovComQqImCaptureViewStoryImageToastView.a(alpo.a(2131710223)).a(2130844176).a(false);
      return;
    case 4: 
      this.jdField_a_of_type_DovComQqImCaptureViewStoryImageToastView.a(alpo.a(2131710230)).a(2130844175).a(false);
      return;
    case 5: 
      this.jdField_a_of_type_DovComQqImCaptureViewStoryImageToastView.b();
      return;
  ...
  public void i()
  {
    ...
    if ((this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewQIMCameraStoryCaptureButtonLayout.b()) || (this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewQIMCameraStoryCaptureButtonLayout.c())) {
      wta.a("clk_shoot", wta.b(axlc.jdField_a_of_type_Int), 1, new String[0]);
    }
    for (;;)
    {
      ThreadManager.getUIHandler().post(new QIMStoryEffectCameraCaptureUnit.1(this));
      return;
      wta.a("clk_shoot", wta.b(axlc.jdField_a_of_type_Int), 3, new String[0]);
    }
  }
  ...
  public void i(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
      if ((this.jdField_a_of_type_Blly != null) && (this.jdField_a_of_type_DovComQqImCaptureModeCaptureModeController.jdField_a_of_type_Boolean)) {
        this.jdField_a_of_type_Blly.n();
      }
      if (this.e != null) {
  ...
  public void j()
  {
    ...
    for (int i = (int)(System.currentTimeMillis() - this.jdField_b_of_type_Long);; i = 0)
    {
      wta.a("time_waitshoot", 10002, i, new String[] { "", "0", "", "" });
      if (!this.jdField_b_of_type_JavaUtilHashSet.contains(Integer.valueOf(this.jdField_b_of_type_Int)))
      {
        this.jdField_b_of_type_JavaUtilHashSet.add(Integer.valueOf(this.jdField_b_of_type_Int));
        wta.a("start_shoot", 10002, 0, new String[] { wta.b(h()), "0", "", l });
  ...
  protected void u()
  {
    this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewQIMCameraStoryCaptureButtonLayout = ((QIMCameraStoryCaptureButtonLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131363938));
    ...
    ((ViewStub)this.jdField_a_of_type_AndroidViewView.findViewById(2131373257)).inflate();
    this.jdField_a_of_type_DovComQqImCaptureViewStoryImageToastView = ((StoryImageToastView)this.jdField_a_of_type_AndroidViewView.findViewById(2131373256));
    this.jdField_a_of_type_DovComQqImCaptureViewStoryTextToastView = ((StoryTextToastView)this.jdField_a_of_type_AndroidViewView.findViewById(2131373247));
  }
}
