...
public class mjw
{
  ...
  public mjw(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_ComTencentAvVideoEffectCoreQqavimageQQAVImageFilter = new mjy();
  ...
  mjx a(QQAVImageFilter paramQQAVImageFilter, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if (paramQQAVImageFilter != null)
    {
      ...
      return new mjx(this, paramInt3, paramInt4);
    }
    return new mjx(this, paramInt1, paramInt2);
  }
