...
public class mjw
{
  ...
  private mjx jdField_a_of_type_Mjx;
  ...
  {
    if ((!paramBoolean) && (this.jdField_a_of_type_Mjx != null)) {
      this.jdField_a_of_type_Mjx.b(1);
    }
  }
  
  private void d()
  {
    this.jdField_a_of_type_AndroidHardwareDisplayVirtualDisplay = this.jdField_a_of_type_AndroidMediaProjectionMediaProjection.createVirtualDisplay("ScreenRecordHelper", this.jdField_b_of_type_Int, this.c, this.jdField_a_of_type_Int, 16, this.jdField_a_of_type_Loy.a(), null, null);
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        {
          if (QLog.isDevelopLevel()) {
            QLog.i("ScreenRecordHelper", 4, "updateRecordParam, pre[" + this.jdField_a_of_type_Nbs + "], display[" + this.jdField_b_of_type_Int + "," + this.c + "], limit[" + i + "," + j + "], come[" + paramInt1 + "," + paramInt2 + "," + paramInt3 + "], record[" + m + "," + k + "]");
          }
          this.jdField_a_of_type_Nbs.jdField_a_of_type_Int = m;
          this.jdField_a_of_type_Nbs.jdField_b_of_type_Int = k;
          if (paramInt3 > 0) {
            this.jdField_a_of_type_Nbs.c = paramInt3;
          }
          if (this.jdField_a_of_type_Loy != null) {
            this.jdField_a_of_type_Loy.a(this.jdField_a_of_type_Nbs);
          }
          return;
          k = 0;
          break;
  ...
  public void a(Context paramContext)
  {
    ...
    do
    {
      ...
      a(0, 0, 15);
      this.jdField_a_of_type_Loy = new loy();
      this.jdField_a_of_type_Loy.a(this.jdField_b_of_type_Int, this.c);
      this.jdField_a_of_type_Loy.a(this.jdField_a_of_type_Nbs);
  ...
  {
    if (this.jdField_a_of_type_Loy != null) {
      this.jdField_a_of_type_Loy.a(paramlpa);
    }
  }
  
  public void a(mjx parammjx)
  {
    this.jdField_a_of_type_Mjx = parammjx;
  }
  ...
  public boolean a(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Mjx != null) {
      this.jdField_a_of_type_Mjx.a(paramInt);
    }
    a(null);
    a(null);
    this.jdField_b_of_type_Boolean = false;
    mbf.a(VideoController.a().a, true);
    if (this.jdField_a_of_type_JavaLangRefWeakReference == null) {
  ...
  public boolean a(Intent paramIntent)
  {
    ...
    d();
    if (this.jdField_a_of_type_Mjx != null) {
      this.jdField_a_of_type_Mjx.a(this.jdField_a_of_type_Nbs, this.jdField_b_of_type_Int, this.c);
    }
    paramIntent = VideoController.a().a;
    if (Build.VERSION.SDK_INT >= 21) {
      lzr.a(l, 3, localContext, true, paramIntent.getCurrentAccountUin(), true);
    }
    this.jdField_a_of_type_JavaUtilTimer = new Timer();
    this.jdField_a_of_type_Long = 0L;
    this.jdField_a_of_type_JavaUtilTimer.scheduleAtFixedRate(new ScreenRecordHelper.1(this), 0L, 1000L);
    this.jdField_b_of_type_Boolean = true;
    lwf.jdField_a_of_type_Boolean = false;
    return true;
  }
  ...
  public void c()
  {
    ...
    if (this.jdField_a_of_type_Loy != null)
    {
      this.jdField_a_of_type_Loy.a(true);
      this.jdField_a_of_type_Loy = null;
    }
