...
public class aviq
{
  ...
  public WeakReference<avjl> a;
  public HashSet<String> a;
  
  public aviq(BaseActivity paramBaseActivity, avjl paramavjl)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity = paramBaseActivity;
    this.jdField_a_of_type_JavaUtilHashSet = bhex.a(paramBaseActivity);
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramavjl);
  }
  ...
  public ArrayList<String> a(Bundle paramBundle)
  {
    ...
    if ((paramBundle != null) && ((paramBundle instanceof ArrayList)))
    {
      ...
      avit localavit = new avit(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, false, null);
      int i = 0;
      while (i < paramBundle.size())
      {
        String str = localavit.a((Uri)paramBundle.get(i), false);
  ...
  public void a(String paramString)
  {
    ...
    avji localavji = (avji)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.getManager(QQManagerFactory.CHECK_FORWARD_MANAGER);
    ...
    paramString = (avjl)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if (paramString != null) {
      localavji.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, localCheckShareExtensionReq, "android.intent.action.SEND", paramString);
    }
  }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      localavji = (avji)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.getManager(QQManagerFactory.CHECK_FORWARD_MANAGER);
      ...
      if ((!TextUtils.isEmpty(paramString1)) && (new File(paramString1).exists()))
      {
        ...
        String str = HexUtil.bytes2HexStr(auea.e(paramString1));
        ...
        localVideoInfo.sha1.set(avis.a(paramString1));
        localVideoInfo.play_duration.set((int)l);
        localCheckShareExtensionReq.videos.add(localVideoInfo);
      }
      paramString1 = (avjl)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (paramString1 == null);
    localavji.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, localCheckShareExtensionReq, paramString2, paramString1);
  }
  ...
  public void a(ArrayList<String> paramArrayList, String paramString)
  {
    ...
    do
    {
      ...
      while (paramArrayList.hasNext())
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject2))
        {
          ...
          if (((File)localObject1).exists())
          {
            ...
            String str = HexUtil.bytes2HexStr(auea.e((String)localObject2));
            if (QLog.isColorLevel()) {
              QLog.d("CheckForward.Security", 2, "sendCheckImgShareReq md5= " + str);
            }
            localImgInfo.md5.set(str);
            localImgInfo.sha1.set(avis.a((String)localObject2));
            localObject2 = avis.a((String)localObject2);
            ...
            localObject1 = avis.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, (File)localObject1);
      ...
      paramArrayList = (avjl)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (paramArrayList == null);
    localavji.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, localCheckShareExtensionReq, paramString, paramArrayList);
  }
  ...
  public boolean a(Uri paramUri, int paramInt, String paramString)
  {
    if (this.jdField_a_of_type_Avit == null) {
      this.jdField_a_of_type_Avit = new avit(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, false, new avir(this, paramInt, paramString));
    }
    String str = this.jdField_a_of_type_Avit.a(paramUri);
    ...
    {
      return false;
      if ((this.jdField_a_of_type_Avit.b) || (this.jdField_a_of_type_Avit.a)) {
        return true;
      }
      paramUri = new File(str);
      l = paramUri.length();
    } while ((!this.jdField_a_of_type_Avit.b) && (!this.jdField_a_of_type_Avit.a) && (l == 0L));
