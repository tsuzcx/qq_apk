...
public class bfss
{
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        if (((File)localObject1).exists()) {
          try
          {
            localObject1 = new JSONObject(bace.a((File)localObject1)).getJSONArray("so_lib");
            i = 0;
            bool2 = bool1;
  ...
  public void a()
  {
    for (;;)
    {
      ...
      jdField_a_of_type_Boolean = false;
      a(false);
      bfxs localbfxs = bfxr.a().a("upload.so");
      ...
      try
      {
        ...
        b(localbfxs.a.d);
        QzoneModuleManager.getInstance().downloadModule("upload.so", new bfst(this));
      }
  ...
  public boolean a(String paramString)
  {
    ...
    //   2: aload_0
    //   3: monitorenter
    //   4: invokestatic 324	beya:a	()Lbeya;
    //   7: ldc_w 326
    //   10: ldc_w 328
    //   13: iconst_0
    //   14: invokevirtual 331	beya:a	(Ljava/lang/String;Ljava/lang/String;I)I
    //   17: istore_2
    //   18: ldc 60
    //   20: iconst_1
    ...
    //   44: getstatic 146	bfss:jdField_a_of_type_Boolean	Z
    ...
    //   58: if_icmpeq +7 -> 65
    //   61: iconst_0
    //   62: putstatic 146	bfss:jdField_a_of_type_Boolean	Z
    //   65: aload_0
    //   66: invokespecial 255	bfss:a	()Z
    //   69: istore 4
    //   71: ldc 60
    //   73: iconst_1
    ...
    //   100: ifne +7 -> 107
    //   103: iconst_0
    //   104: putstatic 146	bfss:jdField_a_of_type_Boolean	Z
    //   107: getstatic 146	bfss:jdField_a_of_type_Boolean	Z
    //   110: ifeq +149 -> 259
    ...
    //   124: getstatic 29	bfss:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    ...
    //   243: iconst_0
    //   244: putstatic 146	bfss:jdField_a_of_type_Boolean	Z
    //   247: aload_0
    //   248: iconst_0
    //   249: invokespecial 91	bfss:a	(Z)V
    //   252: getstatic 29	bfss:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   255: invokevirtual 299	java/io/File:delete	()Z
    //   258: pop
    //   259: getstatic 146	bfss:jdField_a_of_type_Boolean	Z
    //   262: istore_3
    //   263: goto -54 -> 209
    //   266: iconst_0
    //   267: putstatic 146	bfss:jdField_a_of_type_Boolean	Z
    //   270: ldc 60
    //   272: iconst_1
    ...
    //   296: aload_0
    //   297: iconst_0
    //   298: invokespecial 91	bfss:a	(Z)V
    //   301: getstatic 29	bfss:jdField_a_of_type_JavaIoFile	Ljava/io/File;
