  ...
  extends MSFServlet
{
  ...
  protected byte[] a(FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramFromServiceMsg != null)
    {
      ...
      if (paramFromServiceMsg.isSuccess()) {
        localObject1 = bhjl.b(paramFromServiceMsg.getWupBuffer());
      }
    }
    return localObject1;
  }
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    //   3: ifeq +13 -> 16
    //   6: aload_0
    //   7: getfield 14	apat:a	Ljava/lang/String;
    //   10: iconst_2
    //   11: ldc 44
    ...
    //   24: aload_0
    //   25: aload_2
    //   26: invokevirtual 58	apat:a	(Lcom/tencent/qphone/base/remote/FromServiceMsg;)[B
    //   29: astore 5
    ...
    //   150: ifeq +34 -> 184
    //   153: aload_0
    //   154: getfield 14	apat:a	Ljava/lang/String;
    //   157: iconst_2
    ...
    //   228: aload 6
    //   230: aload 5
    //   232: invokespecial 156	com/tencent/mobileqq/applets/NewPublicAccountServlet$1:<init>	(Lapat;Lapar;[B)V
    ...
    //   241: ifeq +13 -> 254
    //   244: aload_0
    //   245: getfield 14	apat:a	Ljava/lang/String;
    //   248: iconst_2
    //   249: ldc 164
    ...
    //   255: astore_2
    //   256: aload_0
    //   257: getfield 14	apat:a	Ljava/lang/String;
    //   260: iconst_4
    //   261: aload_2
    ...
    //   276: ifeq -38 -> 238
    //   279: aload_0
    //   280: getfield 14	apat:a	Ljava/lang/String;
    //   283: iconst_2
    //   284: iconst_2
    ...
    //   306: astore_2
    //   307: aload_0
    //   308: getfield 14	apat:a	Ljava/lang/String;
    //   311: iconst_4
    //   312: aload_2
    ...
    //   326: ifeq +13 -> 339
    //   329: aload_0
    //   330: getfield 14	apat:a	Ljava/lang/String;
    //   333: iconst_2
    //   334: ldc 182
    ...
    //   347: aload_0
    //   348: aload 6
    //   350: invokespecial 187	com/tencent/mobileqq/applets/NewPublicAccountServlet$2:<init>	(Lapat;Lapar;)V
    ...
    //   362: ifeq +33 -> 395
    //   365: aload_0
    //   366: getfield 14	apat:a	Ljava/lang/String;
    //   369: iconst_2
    ...
    //   403: aload_0
    //   404: aload 6
    //   406: invokespecial 192	com/tencent/mobileqq/applets/NewPublicAccountServlet$3:<init>	(Lapat;Lapar;)V
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    while (!QLog.isColorLevel()) {
      try
      {
        ...
        localObject2 = (apar)paramIntent.a();
        ((apar)localObject2).a((QQAppInterface)localObject1);
        ((QQAppInterface)localObject1).addObserver((BusinessObserver)localObject2);
        apaw.a((QQAppInterface)localObject1, paramIntent.getBooleanExtra("BUNDLE_PUBLIC_ACCOUNT_IS_FOLLOW", false), paramIntent.getStringExtra("BUNDLE_PUBLIC_ACCOUNT_UIN"), paramIntent.getIntExtra("BUNDLE_PUBLIC_ACCOUNT_SOURCE", 0));
      ...
      catch (ClassCastException localClassCastException)
      {
        ...
        paramPacket.putSendData(bhjl.a(paramIntent));
      }
    }
