...
public class apdk
  implements Handler.Callback, apdo, apdy
{
  ...
  private volatile apdj jdField_a_of_type_Apdj;
  private volatile apdn jdField_a_of_type_Apdn;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = anvx.a(2131700267);
    jdField_b_of_type_JavaLangString = anvx.a(2131700268);
    jdField_c_of_type_JavaLangString = anvx.a(2131700263);
    jdField_d_of_type_JavaLangString = anvx.a(2131700264);
    jdField_e_of_type_JavaLangString = anvx.a(2131700266);
    jdField_f_of_type_JavaLangString = anvx.a(2131700270);
    jdField_g_of_type_JavaLangString = anvx.a(2131700265);
    jdField_h_of_type_JavaLangString = anvx.a(2131700269);
  }
  ...
  private boolean c()
  {
    return (a()) && (this.jdField_a_of_type_Apdj.a());
  }
  ...
  private void d(int paramInt)
  {
    ...
    if (c())
    {
      ...
      {
        this.jdField_a_of_type_Apdn.a(0);
        this.jdField_a_of_type_Apdn.b();
      }
      if ((paramInt == 2) || (paramInt == 4) || (paramInt == 6) || (paramInt == 1) || (paramInt == 3))
      {
        this.jdField_a_of_type_Apdj.a(false, true);
        this.m = paramInt;
    ...
    {
      return;
      this.jdField_a_of_type_Apdj.a(false, false);
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  private void e(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if (!this.jdField_c_of_type_Boolean) {
        if (paramInt == 11) {
          apdg.a(jdField_a_of_type_JavaLangString, false);
        }
      }
      for (;;)
      {
  ...
  private void j()
  {
    ...
    {
      return;
      if ((this.jdField_a_of_type_Apdj != null) && (this.jdField_a_of_type_Apdj.a())) {
        this.jdField_a_of_type_Apdj.a(false, true);
      }
    } while (this.jdField_a_of_type_Apdn == null);
    this.jdField_a_of_type_Apdn.b();
  }
  ...
  private void l()
  {
    ...
    for (;;)
    {
      ...
      return;
      if ((this.m == -1) && (this.jdField_a_of_type_Apdj != null)) {
        this.jdField_a_of_type_Apdj.a(false, false);
      }
    }
  }
  ...
  private void n()
  {
    ...
    if ((this.jdField_a_of_type_Apdj == null) || (this.jdField_a_of_type_Apdn == null)) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      do
      {
        ...
        {
          return;
          if (this.jdField_a_of_type_Apdn.a() != 0) {
            break label145;
          }
          if (!apdg.a(104857600L))
          {
            apdg.a(jdField_c_of_type_JavaLangString, jdField_d_of_type_JavaLangString);
            return;
          }
          if (this.jdField_a_of_type_Apdj.a(true, null)) {
            break;
          }
          apdg.a(jdField_a_of_type_JavaLangString, false);
        } while (!QLog.isColorLevel());
        ...
        return;
        a("0X8008A54");
        this.jdField_a_of_type_Apdn.a(1);
      } while (!QLog.isColorLevel());
      QLog.i("ARVideoRecordUIControllerImpl", 2, "startVideoRecord end");
      return;
      if (c())
      {
        this.jdField_a_of_type_Apdj.a(true, true);
        this.m = 7;
        this.jdField_d_of_type_Boolean = true;
        a("0X8008A55");
        if (QLog.isColorLevel()) {
  ...
  public void a(Object paramObject)
  {
    ...
    {
      return;
      if ((paramObject instanceof apdn))
      {
        this.jdField_a_of_type_Apdn = ((apdn)paramObject);
        this.jdField_a_of_type_Apdn.a(this);
        return;
      }
    } while (!(paramObject instanceof apdj));
    this.jdField_a_of_type_Apdj = ((apdj)paramObject);
    this.jdField_a_of_type_Apdj.a(this);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      return;
      this.jdField_a_of_type_Apdn = null;
      this.jdField_a_of_type_Apdj = null;
  ...
  public boolean a()
  {
    return (this.jdField_a_of_type_Apdj != null) && (this.jdField_a_of_type_Apdj.b());
  }
  ...
  public boolean b()
  {
    return (this.jdField_a_of_type_Apdj != null) && (this.jdField_a_of_type_Apdj.b()) && (!this.jdField_a_of_type_Apdj.a());
  }
  ...
  public void d()
  {
    ...
    this.jdField_a_of_type_Apdj.a(System.currentTimeMillis());
  }
    ...
    for (int n = ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).checkSelfPermission("android.permission.RECORD_AUDIO");; n = 0)
    {
      ...
      for (int i1 = ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).checkSelfPermission("android.permission.WRITE_EXTERNAL_STORAGE");; i1 = 0)
      {
        ...
        for (int i2 = ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).checkSelfPermission("android.permission.READ_EXTERNAL_STORAGE");; i2 = 0)
        {
          ...
          ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).requestPermissions(new apdl(this), 1, new String[] { "android.permission.RECORD_AUDIO", "android.permission.READ_EXTERNAL_STORAGE", "android.permission.WRITE_EXTERNAL_STORAGE" });
          return true;
          ...
          this.jdField_a_of_type_Apdj.a(false, null);
          return true;
          if (this.jdField_a_of_type_Apdj == null) {
            break;
          }
