...
public class apdk
{
  private static apdk jdField_a_of_type_Apdk;
  ...
  private apdk()
  {
    try
    {
      ...
      this.jdField_a_of_type_Apdm = new apdm(this, BaseApplicationImpl.getContext());
  ...
  {
    if (jdField_a_of_type_Apdk == null) {
      jdField_a_of_type_Apdk = new apdk();
    }
    return jdField_a_of_type_Apdk;
  }
  ...
  public int a(apwj paramapwj, Bundle paramBundle, long paramLong, int paramInt)
  {
    if (-1 == paramInt)
    {
      paramInt = a();
    ...
    while (paramapwj != null)
    {
      paramapwj.a(new apdl(this, ThreadManager.getSubThreadHandler().getLooper(), paramInt, paramBundle, paramLong), false);
      return paramInt;
  ...
  public Notification a(Bundle paramBundle)
  {
    ...
    if (paramBundle != null)
    {
      ...
      ((Notification)localObject1).icon = 2130843549;
      paramBundle = new RemoteViews(BaseApplication.getContext().getPackageName(), 2131560496);
      paramBundle.setImageViewResource(2131370949, 2130843545);
      paramBundle.setTextViewText(2131370958, (CharSequence)localObject2);
      paramBundle.setProgressBar(2131370943, 100, 0, false);
      paramBundle.setViewVisibility(2131370948, 8);
      paramBundle.setViewVisibility(2131370944, 8);
      paramBundle.setTextColor(2131370958, -7829368);
      paramBundle.setTextColor(2131370948, -7829368);
      paramBundle.setTextColor(2131370945, -7829368);
      float f1 = this.jdField_a_of_type_Apdm.a();
      if (this.jdField_a_of_type_Apdm.a() <= 0.0F)
      {
        QLog.w(jdField_a_of_type_JavaLangString, 1, "[UniformDL]. initNotification param error. getTextSize failed. set defualt value:14");
        f1 = 14.0F;
      }
      paramBundle.setFloat(2131370948, "setTextSize", f1);
      paramBundle.setFloat(2131370945, "setTextSize", f1);
      float f2 = this.jdField_a_of_type_Apdm.b();
      f1 = f2;
      if (f2 <= 0.0F)
      {
      ...
      paramBundle.setFloat(2131370958, "setTextSize", f1);
      ...
      try
      {
        int i = this.jdField_a_of_type_Apdm.a().intValue();
        paramBundle.setInt(2131370950, "setBackgroundColor", (i & 0xFF000000) + (-1 - i));
  ...
  protected void a(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    {
      return;
      paramNotification.tickerText = (BaseApplication.getContext().getString(2131720629) + " " + paramBundle1.getString("_notify_param_Filename"));
      paramNotification.contentView.setImageViewResource(2131370949, 2130843545);
      int i = paramBundle2.getInt("_START_WAITING_");
      if (1 == i)
      {
        paramNotification.contentView.setTextViewText(2131370945, BaseApplication.getContext().getString(2131720630));
        paramNotification.contentView.setViewVisibility(2131370944, 0);
        paramNotification.contentView.setViewVisibility(2131370948, 8);
        paramNotification.contentView.setProgressBar(2131370943, 100, 0, false);
      ...
      for (;;)
      {
        ...
        paramNotification.contentView.setTextViewText(2131370945, "0%");
        break;
        paramNotification.when = a(3);
        break label243;
        paramNotification.contentView.setOnClickPendingIntent(2131370950, paramBundle1);
      }
    }
  }
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    ...
    if (localNotification != null)
    {
      ...
      apdc.a().b(paramBundle.getString("_notify_param_Url"));
      return;
    }
  ...
  protected void a(int paramInt, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    localNotification.tickerText = (BaseApplication.getContext().getString(2131720623) + " " + paramBundle1.getString("_notify_param_Filename"));
    ...
    localObject = BaseApplication.getContext().getString(2131720625);
    if (apwe.a(str1) != null)
    {
      localBitmap = apwe.a(str1);
      localObject = BaseApplication.getContext().getString(2131720624);
    }
    if (localBitmap == null)
    {
      int j = apug.b(str1);
      if (j != 0)
      {
        localNotification.contentView.setImageViewResource(2131370949, j);
        label236:
        localNotification.contentView.setImageViewResource(2131370949, 2130843547);
      }
    }
    for (;;)
    {
      localNotification.contentView.setViewVisibility(2131370948, 0);
      localNotification.contentView.setViewVisibility(2131370944, 8);
      localNotification.contentView.setTextViewText(2131370948, (CharSequence)localObject);
      ...
      localNotification.contentView.setImageViewResource(2131370949, 2130843547);
      break label236;
      localNotification.contentView.setImageViewBitmap(2131370949, localBitmap);
    }
  }
  ...
  protected void b(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    for (;;)
    {
      ...
      paramNotification.contentView.setProgressBar(2131370943, 100, i, false);
      paramNotification.contentView.setTextViewText(2131370945, "" + i + "%");
      paramNotification.flags = 34;
      paramBundle2 = new Intent("com.tencent.mobileqq.UniformDownloadNfn.PAUSE");
      paramBundle2.setPackage(MobileQQ.getContext().getPackageName());
      paramBundle2.putExtra("_PARAM_EXTRA", paramBundle1);
  ...
  public void b(int paramInt, Bundle paramBundle)
  {
    ...
    if (localNotification != null)
    {
      ...
      apdc.a().a(paramBundle.getString("_notify_param_Url"), paramBundle.getString("_notify_param_Filename"), paramBundle.getString("_notify_param_ContentTitle", ""), paramBundle.getLong("_notify_param_Filesize"), paramBundle.getBundle("_notify_param_userdata"), paramInt, true);
      return;
    }
  ...
  protected void c(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    paramNotification.tickerText = null;
    int i = paramBundle2.getInt("_FILE_PROGRESS_");
    paramNotification.contentView.setImageViewResource(2131370949, 2130843548);
    paramNotification.contentView.setViewVisibility(2131370948, 0);
    paramNotification.contentView.setViewVisibility(2131370944, 8);
    paramNotification.contentView.setTextViewText(2131370948, BaseApplication.getContext().getString(2131720628));
    paramNotification.contentView.setProgressBar(2131370943, 100, i, false);
    paramNotification.contentView.setTextViewText(2131370945, "" + i + "%");
    ...
    for (;;)
    {
      ...
      paramNotification.contentView.setOnClickPendingIntent(2131370950, paramBundle2);
    }
  }
  ...
  protected void d(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    if (2 == i)
    {
      paramNotification.tickerText = BaseApplication.getContext().getString(2131720627);
      paramNotification.contentView.setTextViewText(2131370948, BaseApplication.getContext().getString(2131720627));
      label115:
      paramNotification.contentView.setImageViewResource(2131370949, 2130843546);
      paramNotification.contentView.setViewVisibility(2131370948, 0);
      paramNotification.contentView.setTextViewText(2131370945, " ");
      paramNotification.flags = 16;
    ...
    for (;;)
    {
      ...
      paramNotification.tickerText = (BaseApplication.getContext().getString(2131720626) + " " + paramBundle1.getString("_notify_param_Filename"));
      paramNotification.contentView.setTextViewText(2131370948, apwj.a(i) + ajya.a(2131715893));
      break label115;
      label397:
      paramNotification.contentView.setOnClickPendingIntent(2131370950, paramBundle2);
    }
