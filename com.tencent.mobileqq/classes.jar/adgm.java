...
public class adgm
  implements adig, bfwq
{
  private Activity jdField_a_of_type_AndroidAppActivity;
  private bady jdField_a_of_type_Bady;
  private TroopChatPie jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie;
  
  public adgm(TroopChatPie paramTroopChatPie)
  {
  ...
  private boolean a(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if ((paramInt3 == 1) && ((paramCharSequence.charAt(paramInt1) == 65312) || (paramCharSequence.charAt(paramInt1) == '@')))
    {
      ...
      if ((bool1) || (bool2))
      {
        ...
        if (this.jdField_a_of_type_Bady == null)
        {
          if (this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie.a().findViewById(2131362229) == null)
          {
            paramCharSequence = new View(this.jdField_a_of_type_AndroidAppActivity);
            paramCharSequence.setId(2131362229);
            localObject = new RelativeLayout.LayoutParams(-1, -2);
            ((RelativeLayout.LayoutParams)localObject).addRule(12);
            ((RelativeLayout.LayoutParams)localObject).addRule(6, 2131368187);
            ((RelativeLayout)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131364076)).addView(paramCharSequence, 3, (ViewGroup.LayoutParams)localObject);
          }
          this.jdField_a_of_type_Bady = new bady(this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie);
      ...
      j = baee.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx);
      paramInt3 = baee.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx);
      if (i - 1 < 0) {
        break label596;
      }
    }
    ...
    for (paramCharSequence = this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx.getText().toString().substring(i - 1, i);; paramCharSequence = null)
    {
      if ((paramInt3 >= 0) && (paramInt3 == i))
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("AIOAtHelper", 2, "selectIndex =" + i + " isFirstAddAt=" + bool1 + " isFirstBackAt=" + bool2 + " max=" + paramInt1 + " lastSpanAt=" + j + " mAtPanel=" + this.jdField_a_of_type_Bady);
        }
        if ((j >= paramInt1) || (paramInt1 < 0) || (this.jdField_a_of_type_Bady == null)) {
          break label569;
        }
        ...
        bool1 = baee.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx, this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        localObject = this.jdField_a_of_type_AndroidAppActivity.findViewById(2131362229);
        this.jdField_a_of_type_Bady.a((View)localObject, paramCharSequence, bool1);
      }
      for (;;)
      {
        return false;
        ...
        paramInt3 = 0;
        break label378;
        if ((this.jdField_a_of_type_Bady != null) && (paramInt3 == 0) && (paramInt2 == 0)) {
          this.jdField_a_of_type_Bady.a();
        }
      }
    }
  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Bady != null)
    {
      View localView = this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie.a().findViewById(2131362229);
      if (localView != null) {
        this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie.a().removeView(localView);
      }
      this.jdField_a_of_type_Bady.b();
      ...
      this.jdField_a_of_type_Bady = null;
    }
  }
  ...
  public void a(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if ((this.jdField_a_of_type_Bady != null) && (this.jdField_a_of_type_Bady.b())) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      do
      {
        ...
        paramCharSequence = baee.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx);
        paramInt2 = baee.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx);
    ...
    } while (this.jdField_a_of_type_Bady == null);
    this.jdField_a_of_type_Bady.a(paramCharSequence.a());
  }
  
  public boolean a()
  {
    return (this.jdField_a_of_type_Bady != null) && (this.jdField_a_of_type_Bady.a());
  }
  
  public boolean a(KeyEvent paramKeyEvent)
  {
    return (paramKeyEvent.getKeyCode() == 4) && (this.jdField_a_of_type_Bady != null) && (this.jdField_a_of_type_Bady.a());
  }
