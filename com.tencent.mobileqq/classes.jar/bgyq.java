...
public class bgyq
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = anzj.a(2131712405);
    jdField_b_of_type_JavaLangString = anzj.a(2131712409);
  }
  
  public bgyq(QQAppInterface paramQQAppInterface, String paramString, int paramInt, bgyr parambgyr, List<String> paramList)
  {
  ...
  public static List<TroopMemberInfo> a(QQAppInterface paramQQAppInterface, String paramString, List<String> paramList, boolean paramBoolean)
  {
    ...
    //   509: invokevirtual 267	anyw:b	(Ljava/lang/String;)Z
    ...
    //   537: invokevirtual 267	anyw:b	(Ljava/lang/String;)Z
    //   540: ifne +85 -> 625
    //   543: aload_1
    //   544: astore_2
    //   545: iload 4
    ...
    //   557: invokestatic 274	bhjx:d	(Ljava/lang/String;)Z
    //   560: ifeq +65 -> 625
    //   563: aload_1
    //   564: astore_2
    //   565: iload 4
    ...
    //   600: invokestatic 283	bgpy:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;)Z
    //   603: ifne +22 -> 625
    //   606: aload_1
    //   607: astore_2
    //   608: iload 4
  ...
  public static void a(QQAppInterface paramQQAppInterface, TroopInfo paramTroopInfo, bgyq parambgyq)
  {
    Object localObject = a(paramQQAppInterface, parambgyq.jdField_c_of_type_JavaLangString);
    if (localObject == null) {}
    int j;
    int k;
    do
    {
      ...
      bbbv localbbbv = ((TroopManager)paramQQAppInterface.getManager(52)).a();
      int n = (int)(localbbbv.jdField_a_of_type_Float * i);
      k = (int)(localbbbv.jdField_b_of_type_Float * i);
      if ((m >= n) && (j >= k) && (j > 0)) {}
      for (boolean bool = true;; bool = false)
      {
        QLog.d("troopBatchAddFrd.Scene", 1, String.format("doInsertGrayTip_V1 check nComFrdCnt_limit_nNonFrdCnt_limit_check=%d_%d_%d_%d_%b_%s", new Object[] { Integer.valueOf(m), Integer.valueOf(n), Integer.valueOf(j), Integer.valueOf(k), Boolean.valueOf(bool), parambgyq.jdField_c_of_type_JavaLangString }));
        if (!bool) {
          break;
        }
        bbbt.a(paramQQAppInterface, parambgyq.jdField_c_of_type_JavaLangString, m, j, paramTroopInfo, (String)localObject);
        return;
      }
      if ((m < n) && (i != 0))
      {
        ...
        bdll.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "nonGreyTip", "commonFrd", 0, 0, parambgyq.jdField_c_of_type_JavaLangString, "", paramTroopInfo.substring(0, m - 1), "");
      }
    } while ((j >= k) || (i == 0));
    paramTroopInfo = String.format(Locale.getDefault(), "%.2f", new Object[] { Float.valueOf(j / i) });
    int i = paramTroopInfo.length();
    bdll.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "nonGreyTip", "nonFrd", 0, 0, parambgyq.jdField_c_of_type_JavaLangString, "", paramTroopInfo.substring(0, i - 1), "");
  }
  ...
  public static Object[] a(com.tencent.common.app.AppInterface paramAppInterface, String paramString)
  {
    ...
    //   316: invokestatic 274	bhjx:d	(Ljava/lang/String;)Z
    //   319: ifeq +70 -> 389
    //   322: iload_3
    //   323: istore 7
    //   325: iload 5
    ...
    //   334: invokestatic 483	bhjx:c	(Ljava/lang/String;)Z
    //   337: ifne +52 -> 389
    //   340: iload_3
    //   341: istore 7
    //   343: iload 5
    ...
    //   379: invokevirtual 484	bgty:b	(Ljava/lang/String;)Z
    //   382: istore 11
    //   384: iload 11
    //   386: ifeq +266 -> 652
    //   389: aload_1
    ...
    //   666: invokevirtual 267	anyw:b	(Ljava/lang/String;)Z
    //   669: ifeq +26 -> 695
    //   672: aload_1
    //   673: astore 13
    //   675: aload_0
  ...
  public static void b(QQAppInterface paramQQAppInterface, TroopInfo paramTroopInfo, bgyq parambgyq)
  {
    int j = parambgyq.jdField_e_of_type_Int;
    int i = parambgyq.jdField_d_of_type_Int;
    Object localObject1 = parambgyq.jdField_e_of_type_JavaLangString;
    ...
    QLog.i("troopBatchAddFrd.Scene", 1, String.format("doInsertGrayTip_V2 troopUin_type_nonFrdCnt_cmnFrdCnt=%s_%d_%d_%d", new Object[] { paramTroopInfo.troopuin, Integer.valueOf(parambgyq.jdField_a_of_type_Int), Integer.valueOf(j), Integer.valueOf(i) }));
    ...
    label594:
    label617:
    for (localObject1 = (String)localObject1 + anzj.a(2131712406);; localObject1 = (String)localObject1 + anzj.a(2131712408))
    {
      localObject2 = anzj.a(2131712407);
      j = ((String)localObject1).indexOf((String)localObject2);
      int k = ((String)localObject2).length();
      localObject2 = new avpd(paramTroopInfo.troopuin, paramTroopInfo.troopuin, (String)localObject1, 1, -5020, 135178, l2);
      ((avpd)localObject2).jdField_c_of_type_JavaLangString = ((String)localObject1);
      ...
      ((avpd)localObject2).a(j, j + k, (Bundle)localObject1);
      ((avpd)localObject2).jdField_d_of_type_JavaLangString = (a(parambgyq.jdField_a_of_type_Int) + "-" + parambgyq.jdField_d_of_type_JavaLangString);
      ...
      localObject1 = ((aoip)paramQQAppInterface.a(20)).a();
      ((TroopBatchAddFriendMgr)localObject1).b(parambgyq.jdField_d_of_type_JavaLangString, parambgyq.jdField_c_of_type_JavaLangString);
      if (parambgyq.jdField_a_of_type_Int == 4) {
        ((TroopBatchAddFriendMgr)localObject1).b(parambgyq.jdField_c_of_type_JavaLangString);
      }
      localObject1 = "1";
      if (i > 0) {
        localObject1 = "0";
      }
      bguq.c(paramQQAppInterface, paramTroopInfo.troopuin, l2);
      bdll.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "Grp_AIO", a(true, parambgyq.jdField_a_of_type_Int), 0, 0, paramTroopInfo.troopuin, Integer.toString(parambgyq.f), Integer.toString(paramTroopInfo.wMemberNum), (String)localObject1);
      return;
  ...
  private boolean b()
  {
    ...
    int n = (int)(((bbbv)localObject).jdField_a_of_type_Float * i);
    int k = (int)(((bbbv)localObject).jdField_b_of_type_Float * i);
    if ((m >= n) && (j >= k) && (j > 0)) {}
    for (boolean bool = true;; bool = false)
    {
      if (QLog.isColorLevel()) {
    ...
    if ((m < n) && (i != 0))
    {
      ...
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_addFrd", "", "nonGreyTip", "commonFrd", 0, 0, this.jdField_c_of_type_JavaLangString, "", ((String)localObject).substring(0, m - 1), "");
    }
    if ((j < k) && (i != 0))
    {
      localObject = String.format(Locale.getDefault(), "%.2f", new Object[] { Float.valueOf(j / i) });
      i = ((String)localObject).length();
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_addFrd", "", "nonGreyTip", "nonFrd", 0, 0, this.jdField_c_of_type_JavaLangString, "", ((String)localObject).substring(0, i - 1), "");
    }
    return false;
  }
  ...
  public static boolean b(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    bbbv localbbbv = ((TroopManager)localObject).a();
    if (localbbbv.jdField_a_of_type_Int != 1) {
      return false;
    }
    ...
    if (!localbbbv.a((TroopInfo)localObject, bbbv.jdField_a_of_type_ArrayOfLong)) {
      return false;
    }
    if (((TroopInfo)localObject).dwCmdUinJoinTime < localbbbv.jdField_a_of_type_Long)
    {
    ...
    long l1 = localbbbv.jdField_c_of_type_Int * 86400;
    long l2 = NetConnInfoCenter.getServerTime();
    long l3 = l2 - ((TroopInfo)localObject).dwCmdUinJoinTime;
    if ((l3 > l1) || (l3 < 0L))
    {
      bdll.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "nonGreyTip", "joinDate", 0, 0, paramString, "", String.valueOf(l3 / 86400L), "");
      return false;
    }
    if (((TroopInfo)localObject).wMemberNum > localbbbv.jdField_b_of_type_Int)
    {
      bdll.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "nonGreyTip", "mberNum", 0, 0, paramString, "", String.valueOf(((TroopInfo)localObject).wMemberNum), "");
      return false;
    }
    if (((TroopInfo)localObject).wClickBAFTipCount != 0) {
      return false;
    }
    if (((TroopInfo)localObject).wInsertBAFTipCount >= localbbbv.jdField_d_of_type_Int) {
      return false;
    }
    ...
    return bbbt.a(((TroopInfo)localObject).dwLastInsertBAFTipTime, l2);
  }
  ...
  public static boolean c(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    TroopBatchAddFriendMgr localTroopBatchAddFriendMgr = ((aoip)paramQQAppInterface.a(20)).a();
    ...
    if (!((bbbv)localObject).a(localTroopInfo, ((bbbv)localObject).jdField_b_of_type_ArrayOfLong))
    {
    ...
    if (localTroopInfo.wMemberNum > ((bbbv)localObject).s)
    {
      bdll.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "nonGreyTip", "mberNum", 0, 0, localTroopInfo.troopuin, Integer.toString(a(paramInt)), Integer.toString(localTroopInfo.wMemberNum), "");
      localStringBuilder.append(" ").append("err:").append("member count").append(localTroopInfo.wMemberNum).append(">").append(((bbbv)localObject).s);
      if (QLog.isColorLevel()) {
        QLog.i("troopBatchAddFrd.Scene", 2, localStringBuilder.toString());
      }
      return false;
    ...
    {
      bdll.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "nonGreyTip", "grpNum", 0, 0, localTroopInfo.troopuin, Integer.toString(a(paramInt)), Integer.toString(localTroopInfo.wMemberNum), "");
  ...
  public int a()
  {
    ...
    if (i == 0)
    {
      ...
      ((aoip)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(localTroopInfo.troopuin, localTroopInfo.troopcode, this.jdField_a_of_type_Long, this.jdField_a_of_type_Int);
      return 0;
    }
    if (i != 1)
    {
  ...
  List<TroopMemberInfo> a()
  {
    ...
    int k = ((bbbv)localObject2).a(this.jdField_a_of_type_Int);
    int j;
    int i;
    ...
    for (;;)
    {
      ...
      if (i < k)
      {
        ...
        {
          bdll.b((QQAppInterface)localObject2, "dc00899", "Grp_addFrd", "", "nonGreyTip", "actvie-res", 0, 0, (String)localObject3, str, Integer.toString(i), "");
          return null;
        }
        ...
        for (;;)
        {
          ...
          {
            bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_addFrd", "", "nonGreyTip", "discus-res", 0, 0, this.jdField_c_of_type_JavaLangString, Integer.toString(i), Integer.toString(((List)localObject2).size()), "");
            return localObject1;
            localObject1 = new ArrayList();
            ...
            if (((List)localObject1).size() == 0)
            {
              ...
              {
                bdll.b((QQAppInterface)localObject3, "dc00899", "Grp_addFrd", "", "nonGreyTip", "new_res", 0, 0, str, Integer.toString(i), "", "");
                return localObject1;
              }
              localObject1 = new ArrayList();
              localObject2 = a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_JavaUtilList, false);
              ...
              if (((List)localObject1).size() == 0)
              {
                ...
                for (i = 0;; i = ((TroopMemberInfo)((List)localObject2).get(0)).commonFrdCnt)
                {
                  bdll.b((QQAppInterface)localObject3, "dc00899", "Grp_addFrd", "", "nonGreyTip", "@_res", 0, 0, str, Integer.toString(i), "", "");
                  return localObject1;
                }
              }
              return localObject1;
  ...
  public void a(String paramString)
  {
    ...
    if (this.jdField_a_of_type_Bgyr != null) {
      this.jdField_a_of_type_Bgyr.b(this);
    }
  }
  ...
  void a(List<TroopMemberInfo> paramList)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      {
        bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_addFrd", "", "nonGreyTip", "UinNum_total", 0, 0, this.jdField_c_of_type_JavaLangString, Integer.toString(a(this.jdField_a_of_type_Int)), Integer.toString(i), "");
        return;
      }
    }
  }
  ...
  public int b()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      switch (((aoip)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a().a(this.jdField_c_of_type_JavaLangString, l, this.jdField_a_of_type_Int))
      {
      default: 
        i = -1;
      case 1: 
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Bgyr != null) {
      this.jdField_a_of_type_Bgyr.a(this);
    }
  }
  ...
  public int c()
  {
    ...
    String str;
    int k;
    if ((l == 0L) || (System.currentTimeMillis() - l > ((bbbv)localObject).t * 60 * 60 * 1000))
    {
      bool = true;
      ...
      {
        localObject = ((aoip)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a();
        str = this.jdField_c_of_type_JavaLangString;
  ...
  public int d()
  {
    ...
    String str;
    int k;
    if ((l == 0L) || (System.currentTimeMillis() - l > ((bbbv)localObject).u * 60 * 60 * 1000))
    {
      bool = true;
  ...
  public int f()
  {
    ...
    if (localList.size() > 0)
    {
      ...
      i = localList.size() - i;
      if (i < localList.size()) {
        if (!nlj.a((MessageRecord)localList.get(i))) {}
      }
    }
    for (boolean bool = true;; bool = false)
    {
