...
public class bdlt
{
  ...
  {
    bdlu localbdlu = new bdlu();
    localbdlu.jdField_c_of_type_JavaLangString = paramString1;
    localbdlu.jdField_d_of_type_JavaLangString = paramString2;
    localbdlu.jdField_e_of_type_JavaLangString = paramString3;
    localbdlu.f = paramString4;
    localbdlu.jdField_c_of_type_Long = paramInt1;
    localbdlu.jdField_d_of_type_Long = paramInt2;
    localbdlu.jdField_e_of_type_Long = paramInt3;
    localbdlu.g = paramString5;
    localbdlu.h = paramString6;
    localbdlu.i = paramString7;
    localbdlu.j = paramString8;
    paramString1 = localbdlu.a();
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, int paramInt3, String paramString4, String paramString5, String paramString6, String paramString7)
  {
    ...
    bdla.b(localQQAppInterface, "dc05263", a(localQQAppInterface.getCurrentAccountUin(), paramString1, paramString2, paramString3, paramInt1, paramInt2, paramInt3, paramString4, paramString5, paramString6, paramString7), paramInt2);
  }
