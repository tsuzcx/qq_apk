  ...
  implements BusinessObserver
{
  ...
  private algg jdField_a_of_type_Algg;
  private final String jdField_a_of_type_JavaLangString;
  private final List<alge> jdField_a_of_type_JavaUtilList;
  private JSONObject jdField_a_of_type_OrgJsonJSONObject;
  private boolean jdField_a_of_type_Boolean;
  private final String jdField_b_of_type_JavaLangString;
  private boolean jdField_b_of_type_Boolean;
  
  public algf(algg paramalgg, String paramString1, String paramString2)
  {
    this.jdField_a_of_type_JavaLangString = paramString2;
    this.jdField_b_of_type_JavaLangString = paramString1;
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_a_of_type_Algg = paramalgg;
  }
  ...
  public JSONObject a(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (i == 1001)
    {
      ...
      localJSONObject.put("businessRet", 0);
      localJSONObject.put("msg", alud.a(2131700968));
    }
    for (;;)
    {
      localJSONObject.put("ssoRet", 202);
      localJSONObject.put("businessRet", 0);
      localJSONObject.put("msg", alud.a(2131700965));
      label473:
      do
      {
        localJSONObject.put("ssoRet", 255);
        localJSONObject.put("businessRet", 0);
        localJSONObject.put("msg", alud.a(2131700969));
  ...
  public void a()
  {
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      while (localIterator.hasNext()) {
        ((alge)localIterator.next()).a(this, this.jdField_a_of_type_Algg);
      }
  ...
  public void a(alge paramalge)
  {
    if (paramalge != null) {
      this.jdField_a_of_type_JavaUtilList.add(paramalge);
    }
  }
  ...
  public void a(Context paramContext, String paramString, JSONObject paramJSONObject, AppInterface paramAppInterface)
  {
    ...
    paramContext = new NewIntent(paramContext, atkg.class);
    ...
    {
      paramContext = this.jdField_a_of_type_Algg;
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    try
    {
      ...
      a();
      if (this.jdField_a_of_type_Algg != null) {
        this.jdField_a_of_type_Algg.b = System.currentTimeMillis();
      }
      return;
    }
    catch (Exception paramBundle)
