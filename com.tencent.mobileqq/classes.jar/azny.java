...
public class azny
{
  ...
  private static Handler jdField_a_of_type_AndroidOsHandler = new aznz(ThreadManager.getFileThreadLooper());
  ...
  {
    if (d == null) {
      d = bduw.a(Environment.getExternalStorageDirectory().getPath() + "/tencent/msflogs/com/tencent/mobileqq/battery/");
    }
    ...
    if (((List)localObject1).size() > 0)
    {
      ...
      if (bdcs.a((List)localObject1, (String)localObject2)) {
