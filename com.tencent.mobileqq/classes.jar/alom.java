  ...
  implements Manager
{
  ...
  private WeakReference<aloo> jdField_a_of_type_MqqUtilWeakReference;
  private WeakReference<alop> b;
  
  public alom(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Aloo = new alon(this);
  ...
  public void a(int paramInt, apollo_push_msgInfo.STPushMsgElem paramSTPushMsgElem)
  {
    ...
    for (;;)
    {
      ...
      ((amir)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155)).a(paramSTPushMsgElem);
      ...
      if ((!TextUtils.isEmpty(str)) && (!str.equals(localObject))) {
        alnr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject, "apllo_redPack_action");
      }
      if ((TextUtils.isEmpty(str)) || (str.equals(paramSTPushMsgElem))) {
        break;
      }
      alnr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramSTPushMsgElem, "apllo_redPack_action");
      return;
  ...
  public void a(aloo paramaloo)
  {
    ...
    this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(paramaloo);
  }
  ...
  public void a(alop paramalop)
  {
    ...
    this.b = new WeakReference(paramalop);
  }
  ...
  public void a(ApolloActionPush paramApolloActionPush)
  {
    ...
    if (paramApolloActionPush.mWordShowType == 1)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
      {
        ...
        localObject2 = ((amir)localObject1).a(localSpriteTaskParam.f);
        if (localObject2 == null) {
          break label253;
        }
        if (TextUtils.isEmpty(localSpriteTaskParam.jdField_c_of_type_JavaLangString)) {
          localSpriteTaskParam.jdField_c_of_type_JavaLangString = amge.a(((ApolloActionData)localObject2).bubbleText);
        }
      }
    }
    for (;;)
    {
      localObject1 = ambc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (localObject1 != null) {
        ((amaz)localObject1).a().a(localSpriteTaskParam);
      }
      ...
      ((amir)localObject1).a((List)localObject2);
    }
  }
  ...
  public void a(apollo_push_msgInfo.STPushMsgElem paramSTPushMsgElem)
  {
    ...
    do
    {
      do
      {
        for (;;)
        {
          ...
          if ((a()) && ("tab_list_android_json_v665".equals(localObject1)))
          {
            ...
            if (m > i)
            {
              ((alnr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a(true, "onLinePush", 1);
              if (!QLog.isColorLevel()) {
                continue;
              }
            ...
            if ((a()) && (anwk.a().equals(localObject1)))
            {
              i = 0;
              localObject1 = new File(amip.av);
              if (!((File)localObject1).exists())
              {
                ...
                i = 1;
                localObject1 = amip.av + "base.zip";
                if (i != 0)
                {
                  localObject2 = new Bundle();
                  ((Bundle)localObject2).putLong("version", m);
                  amdp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject1, amip.at, (Bundle)localObject2, new anwm());
                }
                if (!QLog.isColorLevel()) {
                  continue;
                }
              ...
              if ("apollo_thunder_json_v670".equals(localObject1)) {
                amfn.a(null, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, m, false);
              }
            }
          }
        }
      ...
      for (;;)
      {
        try
        {
          ...
          l = ((alnr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a(1, i) / 1000L;
          if (l != m) {
    ...
    for (;;)
    {
      try
      {
        localObject2 = (alnr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153);
        if ((!alnr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) || (localObject2 == null) || (1 != ((alnr)localObject2).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin()))) {
          break;
        }
        i = Integer.parseInt(localException1);
        l = ((alnr)localObject2).a(2, i) / 1000L;
        if (l != m) {
  ...
  public void b(apollo_push_msgInfo.STPushMsgElem paramSTPushMsgElem)
  {
    ...
    if ((localObject2 != null) && (((List)localObject2).size() > 0))
    {
        ...
        for (;;)
        {
          ...
          if (this.b != null)
          {
            ...
            if (this.b.get() != null)
            {
              ...
              {
                j = 2;
                ((alop)this.b.get()).a(1, localObject3);
              }
            }
          }
          i = j;
      ...
      localObject1 = (amir)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
      if (localObject1 != null) {
        ((amir)localObject1).a(paramSTPushMsgElem, i);
      }
      for (;;)
      {
        ((amtm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(255)).a(NetConnInfoCenter.getServerTimeMillis());
        return;
