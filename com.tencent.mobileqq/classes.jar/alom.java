  ...
  extends ClickableSpan
{
  ...
  alom(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    try
    {
      ...
      for (int j = -1; i < paramArrayOfHotWordItem.length; j = k)
      {
        ...
        if (j != str.length())
        {
          ...
          localSpannableStringBuilder.setSpan(new alom(paramQQAppInterface, paramArrayOfHotWordItem[i].hotWord), str.length(), k, 33);
          if (paramQQAppInterface != null) {
            awqx.b(paramQQAppInterface, "P_CliOper", "aio_search", "", "aio_hotword", "view_hotword", 0, 0, "", "", paramArrayOfHotWordItem[i].hotWord, "");
          }
        }
        i += 1;
      }
  ...
  private void a(Context paramContext)
  {
    ...
    localbegr.a(2131631823, 5);
    localbegr.c(2131625035);
    localbegr.a(new alon(this, paramContext, localbegr));
  ...
  public void onClick(View paramView)
  {
    ...
    awqx.b((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), "P_CliOper", "aio_search", "", "aio_hotword", "click_hotword", 0, 0, "", "", this.jdField_a_of_type_JavaLangString, "");
  }
