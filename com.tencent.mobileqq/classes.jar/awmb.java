  ...
  extends awlu
{
  ...
  private static ConcurrentHashMap<String, SoftReference<ArrayList<awlx>>> c = new ConcurrentHashMap();
  private ajxt jdField_a_of_type_Ajxt = new awmf(this);
  private aktf jdField_a_of_type_Aktf;
  private Object jdField_a_of_type_JavaLangObject = new Object();
  private String jdField_a_of_type_JavaLangString;
  private Comparator<FTSEntity> jdField_a_of_type_JavaUtilComparator = new awmd(this);
  ...
  public awmb(QQAppInterface paramQQAppInterface)
  {
  ...
  private int a(String paramString, int paramInt)
  {
    if (this.jdField_a_of_type_Aktf == null) {
      this.jdField_a_of_type_Aktf = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a();
    }
    int i = 0;
    if (!this.jdField_a_of_type_Aktf.a(paramString, paramInt)) {
      i = 10;
    }
    if (paramInt == 3000) {
      return i + 2;
  ...
  private ArrayList<awmg> a(ArrayList<FTSEntity> paramArrayList)
  {
    ...
    while (paramArrayList.hasNext())
    {
      ...
      if ((localFTSMessage != null) && (localFTSMessage.msgExts != null))
      {
        ...
        String str = akpx.a((String)localObject2, i);
        if (!((HashMap)localObject1).containsKey(str))
        {
          awmg localawmg = new awmg();
          localawmg.jdField_a_of_type_JavaUtilList = new ArrayList();
          localawmg.jdField_a_of_type_JavaUtilList.add(localFTSMessage);
          localawmg.jdField_a_of_type_Int = localFTSMessage.mSearchScene;
          localawmg.b = localFTSMessage.mProximity;
          localawmg.c = a((String)localObject2, i);
          localawmg.jdField_a_of_type_Long = ((FTSMessageCodec.TextMsgExts)localFTSMessage.msgExts).time;
          localawmg.jdField_a_of_type_JavaUtilHashSet = new HashSet();
          localawmg.jdField_a_of_type_JavaUtilHashSet.add(Long.valueOf(localFTSMessage.mOId));
          localawmg.d = localFTSMessage.searchStrategy;
          localawmg.e = localFTSMessage.senderNum;
          localawmg.f = localFTSMessage.friendNum;
          localawmg.g = localFTSMessage.friendIndex;
          ((HashMap)localObject1).put(str, localawmg);
        }
        else
        {
          localObject2 = (awmg)((HashMap)localObject1).get(str);
          if (((awmg)localObject2).jdField_a_of_type_JavaUtilHashSet.add(Long.valueOf(localFTSMessage.mOId)))
          {
            if (localFTSMessage.mSearchScene == ((awmg)localObject2).jdField_a_of_type_Int)
            {
              if (localFTSMessage.mProximity < ((awmg)localObject2).b) {
                ((awmg)localObject2).b = localFTSMessage.mProximity;
              }
              if (((FTSMessageCodec.TextMsgExts)localFTSMessage.msgExts).time > ((awmg)localObject2).jdField_a_of_type_Long) {
                ((awmg)localObject2).jdField_a_of_type_Long = ((FTSMessageCodec.TextMsgExts)localFTSMessage.msgExts).time;
              }
              if (localFTSMessage.senderNum > ((awmg)localObject2).e) {
                ((awmg)localObject2).e = localFTSMessage.senderNum;
              }
              if (localFTSMessage.friendNum > ((awmg)localObject2).f) {
                ((awmg)localObject2).f = localFTSMessage.friendNum;
              }
              if (localFTSMessage.friendIndex > ((awmg)localObject2).g) {
                ((awmg)localObject2).g = localFTSMessage.friendIndex;
              }
            }
            for (;;)
            {
              if (localFTSMessage.mSearchScene < ((awmg)localObject2).jdField_a_of_type_Int) {
                ((awmg)localObject2).jdField_a_of_type_Int = localFTSMessage.mSearchScene;
              }
              if (localFTSMessage.searchStrategy < ((awmg)localObject2).d) {
                ((awmg)localObject2).d = localFTSMessage.searchStrategy;
              }
              ((awmg)localObject2).jdField_a_of_type_JavaUtilList.add(localFTSMessage);
              break;
              if (localFTSMessage.mSearchScene < ((awmg)localObject2).jdField_a_of_type_Int)
              {
                ((awmg)localObject2).b = localFTSMessage.mProximity;
    ...
    Collections.sort(paramArrayList, new awme(this));
    return paramArrayList;
  }
  
  private List<awlx> a(String paramString1, String paramString2, String paramString3, boolean paramBoolean1, ArrayList<FTSEntity> paramArrayList, boolean paramBoolean2)
  {
    Object localObject1 = new HashMap();
    paramArrayList = paramArrayList.iterator();
    int i = 0;
    ...
    while (paramArrayList.hasNext())
    {
      ...
      if ((localObject2 != null) && (((FTSMessage)localObject2).msgExts != null))
      {
        ...
        localObject4 = akpx.a((String)localObject3, j);
        if (!((HashMap)localObject1).containsKey(localObject4))
        {
          localObject5 = new awmg();
          ((awmg)localObject5).jdField_a_of_type_JavaUtilList = new ArrayList();
          ((awmg)localObject5).jdField_a_of_type_JavaUtilList.add(localObject2);
          ((awmg)localObject5).b = ((FTSMessage)localObject2).mProximity;
          ((awmg)localObject5).c = a((String)localObject3, j);
          ((awmg)localObject5).jdField_a_of_type_Long = ((FTSMessageCodec.TextMsgExts)((FTSMessage)localObject2).msgExts).time;
          ((awmg)localObject5).jdField_a_of_type_JavaUtilHashSet = new HashSet();
          ((awmg)localObject5).jdField_a_of_type_JavaUtilHashSet.add(Long.valueOf(((FTSMessage)localObject2).mOId));
          ((awmg)localObject5).d = ((FTSMessage)localObject2).searchStrategy;
          ((HashMap)localObject1).put(localObject4, localObject5);
        }
        else
        {
          localObject3 = (awmg)((HashMap)localObject1).get(localObject4);
          if (!((awmg)localObject3).jdField_a_of_type_JavaUtilHashSet.add(Long.valueOf(((FTSMessage)localObject2).mOId)))
          {
            i = 1;
          }
          else
          {
            if (((FTSMessage)localObject2).mProximity < ((awmg)localObject3).b) {
              ((awmg)localObject3).b = ((FTSMessage)localObject2).mProximity;
            }
            if (((FTSMessageCodec.TextMsgExts)((FTSMessage)localObject2).msgExts).time > ((awmg)localObject3).jdField_a_of_type_Long) {
              ((awmg)localObject3).jdField_a_of_type_Long = ((FTSMessageCodec.TextMsgExts)((FTSMessage)localObject2).msgExts).time;
            }
            if (((FTSMessage)localObject2).searchStrategy < ((awmg)localObject3).d) {
              ((awmg)localObject3).d = ((FTSMessage)localObject2).searchStrategy;
            }
            ((awmg)localObject3).jdField_a_of_type_JavaUtilList.add(localObject2);
          }
        }
      }
    }
    ...
    Collections.sort(paramArrayList, new awmc(this));
    localObject1 = bbmo.a(paramString2);
    ...
    if (paramArrayList != null)
    {
      ...
      {
        localObject4 = (awmg)((Iterator)localObject3).next();
        if (a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(((FTSMessage)((awmg)localObject4).jdField_a_of_type_JavaUtilList.get(0)).uin), ((FTSMessage)((awmg)localObject4).jdField_a_of_type_JavaUtilList.get(0)).istroop))
        {
          ...
          {
            paramArrayList = new awmi((QQAppInterface)localObject5, paramArrayList, paramString2, (ArrayList)localObject1, ((awmg)localObject4).jdField_a_of_type_JavaUtilList, paramString3, null);
            paramArrayList.jdField_a_of_type_Int = ((awmg)localObject4).d;
            paramArrayList.b = ((awmg)localObject4).e;
            paramArrayList.c = ((awmg)localObject4).f;
            paramArrayList.d = ((awmg)localObject4).g;
            ((List)localObject2).add(paramArrayList);
            i = awin.a("fts_native_chathistory_maxnum", 3);
  ...
  private List<awlw> a(String paramString, ArrayList<FTSEntity> paramArrayList)
  {
    ArrayList localArrayList = bbmo.a(paramString);
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      paramArrayList.add(new awmh(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, localArrayList, (FTSEntity)localObject2));
    }
    return paramArrayList;
  }
  ...
  private static boolean a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    {
      paramQQAppInterface = ((ajvi)paramQQAppInterface.getManager(53)).a(paramString);
  ...
  public List<awlx> a(awvi paramawvi)
  {
    if (paramawvi == null) {
      return null;
    }
    ...
    for (boolean bool = paramawvi.jdField_a_of_type_AndroidOsBundle.getBoolean("fts_search_is_limited", true);; bool = true)
    {
      if (bbmo.g(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) == 1) {
        return b(paramawvi, bool);
      }
      return a(paramawvi, bool);
    }
  }
  
  public List<awlx> a(awvi arg1, boolean paramBoolean)
  {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          if (localObject1 != null)
          {
            ...
            axrn.a(BaseApplication.getContext()).a(null, "SearchMessageStatistic_FTS", true, (l7 - l5) / 1000000L, 0L, (HashMap)localObject5, null);
            l8 = System.nanoTime();
            if (QLog.isColorLevel()) {
              if (??? == null) {
                break label1500;
          ...
          for (int i1 = ???.size();; i1 = 0)
          {
            ...
            if (n == 0)
            {
              ...
              axrn.a(BaseApplication.getContext()).a(null, "actFtsSearchEvent", true, l1, 0L, ???, null);
            }
            ??? = (awvi)localObject1;
            if (n == 0) {
              if (localObject1 != null)
            ...
            axrn.a(BaseApplication.getContext()).a(null, "actFtsSearchEvent", true, l2, 0L, (HashMap)localObject5, null);
            return localObject4;
  ...
  public List<awlx> a(String paramString, boolean paramBoolean)
  {
    if (!bbfj.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) {
      return null;
    }
    ??? = (ajxs)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(81);
    Object localObject2 = new ArrayList();
    ((ArrayList)localObject2).add(paramString);
    ((ajxs)???).a((ArrayList)localObject2);
    ...
    axrn.a(BaseApplication.getContext()).a(null, "actFtsSearchEvent", true, l2, 0L, (HashMap)localObject2, null);
    return paramString;
    label654:
    ...
    if (localArrayList == null)
    {
      ...
      axrn.a(BaseApplication.getContext()).a(null, "SearchMessageStatistic_FTS", true, (l3 - l6) / 1000000L, 0L, paramString, null);
      l4 = System.nanoTime();
      if (QLog.isColorLevel()) {
        if (localArrayList == null) {
          break label1267;
    ...
    for (int n = localArrayList.size();; n = 0)
    {
      ...
      ((HashMap)localObject2).put("groupSortCost", String.valueOf(l1));
      axrn.a(BaseApplication.getContext()).a(null, "actFtsSearchEvent", true, l2, 0L, paramString, null);
      return ???;
  ...
  public void a(awvi paramawvi, awuv<awlx> paramawuv)
  {
    bbmp.e = System.nanoTime();
    bbmp.f = 0L;
    ThreadManager.post(new FTSMessageSearchEngine.1(this, paramawvi, paramawuv), 8, null, true);
  }
  ...
  public List<awlw> b(awvi paramawvi)
  {
    if (QLog.isColorLevel()) {
      QLog.d("FTSMessageSearchEngine", 2, "========== search message use FTSMessageSearchEngine");
    }
    ...
    Object localObject = paramawvi.jdField_a_of_type_JavaLangString;
    if (paramawvi.jdField_a_of_type_AndroidOsBundle == null) {
      return new ArrayList();
    }
    long l3 = paramawvi.jdField_a_of_type_AndroidOsBundle.getLong("uin");
    int i = paramawvi.jdField_a_of_type_AndroidOsBundle.getInt("uinType");
    paramawvi = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a((String)localObject, FTSMessage.class, false, false, l3, i);
    l3 = System.nanoTime();
    localObject = a((String)localObject, paramawvi);
    long l4 = System.nanoTime();
    if (paramawvi != null) {}
    for (i = paramawvi.size();; i = 0)
    {
  ...
  public List<awlx> b(awvi arg1, boolean paramBoolean)
  {
    if (QLog.isColorLevel()) {
      QLog.d("FTSMessageSearchEngine", 2, "========== search message use FTSMessageSearchEngine");
    }
    ...
    Object localObject4 = bbmo.a(str);
    ...
    for (int i2 = 0;; i2 = 1)
    {
      ...
      axrn.a(BaseApplication.getContext()).a(null, "actFtsSearchEvent", true, 0L, 0L, localHashMap, null);
      return localObject3;
      i1 = ???.size();
      break label362;
    }
    ...
    long l1 = System.nanoTime();
    localObject4 = bbmo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject4);
    ...
    if ((localObject4 != null) && (!((ArrayList)localObject4).isEmpty()))
    {
      ...
      while (((Iterator)localObject5).hasNext())
      {
        localObject6 = (bbmq)((Iterator)localObject5).next();
        if ((((bbmq)localObject6).jdField_a_of_type_Int != 0) && (((bbmq)localObject6).jdField_a_of_type_Int != 1004)) {
          break label2300;
        }
        j += 1;
      }
    ...
    for (;;)
    {
      ...
      if ((localObject4 != null) && (!((ArrayList)localObject4).isEmpty()))
      {
        ...
        {
          localObject5 = ((bbmq)((ArrayList)localObject4).get(i5)).jdField_a_of_type_JavaLangString;
          int i9 = ((bbmq)((ArrayList)localObject4).get(i5)).jdField_a_of_type_Int;
          localObject6 = ((bbmq)((ArrayList)localObject4).get(i5)).jdField_a_of_type_AndroidUtilPair;
          int i6 = m;
          ...
          {
            i = k;
            if (bbmo.h(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) == 1)
            {
      ...
      for (m = i;; m = i)
      {
        ...
        for (;;)
        {
          ...
          l3 += l4;
          localObject3 = bbmo.a(localHashMap);
          localObject5 = ((ArrayList)localObject5).iterator();
          while (((Iterator)localObject5).hasNext())
          {
            localObject6 = (awmg)((Iterator)localObject5).next();
            localObject7 = (FTSMessage)((awmg)localObject6).jdField_a_of_type_JavaUtilList.get(0);
            ...
            {
              localObject7 = new awmi(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localHashMap, localHashMap, (ArrayList)localObject3, ((awmg)localObject6).jdField_a_of_type_JavaUtilList, null, null);
              ((awmi)localObject7).jdField_a_of_type_Int = ((awmg)localObject6).d;
              ((awmi)localObject7).b = ((awmg)localObject6).e;
              ((awmi)localObject7).c = ((awmg)localObject6).f;
              ((awmi)localObject7).d = ((awmg)localObject6).g;
          ...
          axrn.a(BaseApplication.getContext()).a(null, "actFtsSearchEvent", true, l3, 0L, ???, null);
  ...
  public void b(awvi paramawvi, awuv<awlw> paramawuv)
  {
    ThreadManager.post(new FTSMessageSearchEngine.2(this, paramawvi, paramawuv), 8, null, true);
  }
