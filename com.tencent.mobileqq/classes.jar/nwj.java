...
public class nwj
{
  ...
  private static String a(String paramString1, String paramString2)
  {
    ...
    //   74: invokestatic 103	nwj:a	([B)Ljava/lang/String;
    //   77: areturn
    //   78: astore_0
    //   79: goto -9 -> 70
    //   82: astore_1
  ...
  private static void a(int paramInt)
  {
    ...
    bdla.b(null, "P_CliOper", "Pb_account_lifeservice", "", "mp_msg_sys_14", "lixian_security", i, paramInt, "", "3", "", "");
  ...
  private static boolean a(String paramString)
  {
    ...
    //   81: astore_3
    //   82: aload_3
    //   83: invokestatic 188	nwj:a	(Ljava/io/BufferedInputStream;)[B
    //   86: astore 4
    //   88: aload_3
    //   89: ifnull +7 -> 96
    //   92: aload_3
    ...
    //   161: iconst_1
    //   162: invokestatic 197	nwj:a	(I)V
    //   165: aload_0
    ...
    //   199: iconst_2
    //   200: invokestatic 197	nwj:a	(I)V
    //   203: aload_0
    ...
    //   224: astore_0
    //   225: aload_0
    //   226: invokestatic 188	nwj:a	(Ljava/io/BufferedInputStream;)[B
    //   229: astore_2
    //   230: aload_0
    //   231: ifnull +7 -> 238
    //   234: aload_0
    //   235: invokevirtual 189	java/io/BufferedInputStream:close	()V
    //   238: getstatic 14	nwj:b	Ljava/lang/String;
    //   241: aload 4
    //   243: aload_2
    //   244: invokestatic 204	nwj:a	(Ljava/lang/String;[B[B)Z
    //   247: istore_1
    //   248: iload_1
    //   249: ireturn
    //   250: astore_0
  ...
  private static boolean a(String paramString, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    try
    {
      ...
      paramString = bhcu.decode(paramString.getBytes("UTF-8"), 0);
  ...
  private static boolean b(String paramString)
  {
    ...
    //   61: dup
    //   62: aload_1
    //   63: invokestatic 283	nwj:a	(Ljava/io/BufferedInputStream;)Ljava/lang/String;
    ...
    //   131: invokestatic 306	nwj:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   172: bipush 6
    //   174: invokestatic 197	nwj:a	(I)V
    //   177: iconst_0
    //   178: ireturn
    //   179: astore_0
    //   180: aconst_null
    ...
    //   202: astore_2
    //   203: iconst_1
    //   204: invokestatic 197	nwj:a	(I)V
    //   207: aload_1
    //   208: astore_2
    //   209: aload_0
    ...
    //   249: astore_2
    //   250: iconst_3
    //   251: invokestatic 197	nwj:a	(I)V
    //   254: aload_0
    //   255: astore_2
    //   256: aload_1
    ...
    //   297: astore_2
    //   298: iconst_2
    //   299: invokestatic 197	nwj:a	(I)V
    //   302: aload_0
    //   303: astore_2
    //   304: aload_1
    ...
    //   339: iconst_5
    //   340: invokestatic 197	nwj:a	(I)V
  ...
  private static boolean c(String paramString1, String paramString2)
  {
    ...
    //   151: dup
    //   152: aload 4
    //   154: invokestatic 283	nwj:a	(Ljava/io/BufferedInputStream;)Ljava/lang/String;
    ...
    //   279: astore_3
    //   280: iconst_1
    //   281: invokestatic 197	nwj:a	(I)V
    //   284: aload_0
    //   285: astore_3
    //   286: aload_1
    ...
    //   312: astore_3
    //   313: iconst_3
    //   314: invokestatic 197	nwj:a	(I)V
    //   317: aload_0
    //   318: astore_3
    //   319: aload_1
    ...
    //   345: astore_3
    //   346: iconst_2
    //   347: invokestatic 197	nwj:a	(I)V
    //   350: aload_0
    //   351: astore_3
    //   352: aload_1
    ...
    //   397: iconst_5
    //   398: invokestatic 197	nwj:a	(I)V
    ...
    //   520: invokestatic 306	nwj:a	(Ljava/lang/String;)Ljava/lang/String;
    //   523: astore_1
    //   524: aload_3
    ...
    //   751: invokestatic 306	nwj:a	(Ljava/lang/String;)Ljava/lang/String;
    //   754: astore 7
    //   756: aload 6
    ...
    //   846: iconst_5
    //   847: invokestatic 197	nwj:a	(I)V
    ...
    //   893: iconst_5
    //   894: invokestatic 197	nwj:a	(I)V
  ...
  public static boolean c(String paramString1, String paramString2, String paramString3)
  {
    ...
    //   13: invokestatic 172	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   16: aload_2
    //   17: invokestatic 209	nwj:a	(Ljava/lang/String;)V
    //   20: aload_0
    ...
    //   70: aload 11
    //   72: astore_3
    //   73: getstatic 410	nuz:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   76: ifnull +123 -> 199
    //   79: aload 8
    //   81: astore 5
    //   83: aload 9
    ...
    //   91: aload 11
    //   93: astore_3
    //   94: getstatic 410	nuz:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   97: aload_2
    ...
    //   116: aload 11
    //   118: astore_3
    //   119: getstatic 410	nuz:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   122: aload_2
    ...
    //   247: astore 4
    //   249: aload 4
    //   251: invokestatic 283	nwj:a	(Ljava/io/BufferedInputStream;)Ljava/lang/String;
    //   254: astore_3
    //   255: getstatic 410	nuz:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   258: ifnull +12 -> 270
    //   261: getstatic 410	nuz:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   264: aload_2
    //   265: aload_3
    ...
    //   318: astore_3
    //   319: iconst_1
    //   320: invokestatic 197	nwj:a	(I)V
    //   323: aload 5
    //   325: astore_3
    //   326: aload_0
    ...
    //   381: astore_3
    //   382: iconst_3
    //   383: invokestatic 197	nwj:a	(I)V
    //   386: aload 6
    //   388: astore_3
    //   389: aload_0
    ...
    //   444: astore_3
    //   445: iconst_2
    //   446: invokestatic 197	nwj:a	(I)V
    //   449: aload 7
    //   451: astore_3
    //   452: aload_0
    ...
    //   532: invokestatic 306	nwj:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   573: bipush 6
    //   575: invokestatic 197	nwj:a	(I)V
    //   578: iconst_0
    //   579: ireturn
    //   580: iconst_1
    //   581: ireturn
