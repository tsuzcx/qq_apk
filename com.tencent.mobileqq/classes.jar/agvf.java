...
{
  private agvj jdField_a_of_type_Agvj;
  ...
  private void a()
  {
    this.jdField_a_of_type_Aliw = new agvg(this);
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    if ((localObject != null) && (!((ArrayList)localObject).isEmpty()))
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if ((!paramString1.equals("openVideoPlayer")) || ((!baip.a(paramString2)) && (paramString2.contains("jump play")))) {
  ...
  {
    return (paramBitmap != null) && (paramBitmap != this.jdField_a_of_type_Alis.a);
  }
  ...
  private void b()
  {
    ...
    a();
    this.jdField_a_of_type_Agvj = new agvj(this, null);
    try
    {
      QIPCClientHelper.getInstance().callServer("SpringHbIPCModule", "GetEmergencyInfo", null, new agvh(this));
      return;
    }
  ...
  private boolean b(String paramString)
  {
    ...
    agvs.a((String)localObject, i, j, paramString);
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_AndroidContentContext.registerReceiver(this.jdField_a_of_type_Agvj, localIntentFilter);
  }
  ...
  private void d()
  {
    try
    {
      if ((this.jdField_a_of_type_Agvj != null) && (this.jdField_b_of_type_Boolean))
      {
        this.jdField_a_of_type_AndroidContentContext.unregisterReceiver(this.jdField_a_of_type_Agvj);
    ...
    for (;;)
    {
      try
      {
        ...
        if (((JSONObject)localObject).optInt("cache_only", 1) == 1)
        {
          ...
          localObject = this.jdField_a_of_type_Alis.a(paramString, bool1);
    ...
    if ((paramLong == 8589934595L) || (paramLong == 8589934612L))
    {
      ...
      if ((!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) && (!TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) && (!TextUtils.isEmpty(str1)) && (str1.startsWith(this.jdField_a_of_type_JavaLangString)) && (!TextUtils.equals(this.jdField_b_of_type_JavaLangString, str1)))
      {
        ...
        if (badq.d(this.jdField_a_of_type_AndroidContentContext))
        {
          ...
          agvs.a(agvm.e, 1, 1, (Map)localObject, true);
          break label544;
        }
      }
    }
