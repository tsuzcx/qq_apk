  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    if ((agve.a(this.a).a == null) || (agve.b(this.a).a.size() == 0)) {
      if ((agve.a(this.a).a != null) && (i != -1))
      {
        ArrayList localArrayList = new ArrayList();
        String str = (String)agve.b(this.a).a.get(i);
    ...
    for (;;)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        continue;
        paramView.putStringArrayListExtra("PhotoConst.SELECTED_PATHS", agve.c(this.a).a);
        axqw.b(null, "CliOper", "", "", "0X800A6DB", "0X800A6DB", 0, 0, String.valueOf(agve.d(this.a).a.size()), "", "", "");
      }
    }
  }
}
