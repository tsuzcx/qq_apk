...
public class anmb
{
  private static anmb jdField_a_of_type_Anmb;
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private bdfq jdField_a_of_type_Bdfq;
  private Object jdField_a_of_type_JavaLangObject = new Object();
  private Runnable jdField_a_of_type_JavaLangRunnable;
  private ArrayList<anme> jdField_a_of_type_JavaUtilArrayList = new ArrayList(4);
  private boolean jdField_a_of_type_Boolean;
  private ArrayList<anme> b = new ArrayList(4);
  
  public static anmb a()
  {
    if (jdField_a_of_type_Anmb == null) {}
    try
    {
      if (jdField_a_of_type_Anmb == null) {
        jdField_a_of_type_Anmb = new anmb();
      }
      return jdField_a_of_type_Anmb;
    }
    finally {}
  }
  
  private void a(Context paramContext, ArrayList<anme> paramArrayList, LinearLayout paramLinearLayout1, LinearLayout paramLinearLayout2)
  {
    if (paramArrayList.size() <= 4) {
      paramLinearLayout2.setVisibility(8);
    }
    Drawable localDrawable = paramContext.getResources().getDrawable(2130838545);
    int i = 0;
    if (i < paramArrayList.size())
    {
      Object localObject = (anme)paramArrayList.get(i);
      View localView = LayoutInflater.from(paramContext).inflate(2131558664, null, false);
      URLImageView localURLImageView = (URLImageView)localView.findViewById(2131367810);
      TextView localTextView = (TextView)localView.findViewById(2131371299);
      QLog.d("ark.download.ctrl", 1, new Object[] { "ark.dctrl [initAppView] item[", Integer.valueOf(i), "],app name:", ((anme)localObject).b, ",appid:", ((anme)localObject).jdField_a_of_type_JavaLangString, ",icon:", ((anme)localObject).c });
      if (i < 7)
      {
        URLDrawable.URLDrawableOptions localURLDrawableOptions = URLDrawable.URLDrawableOptions.obtain();
        localURLDrawableOptions.mRequestWidth = aekt.a(47.0F, paramContext.getResources());
        localURLDrawableOptions.mRequestHeight = localURLDrawableOptions.mRequestWidth;
        localURLDrawableOptions.mLoadingDrawable = localDrawable;
        localURLDrawableOptions.mFailedDrawable = localDrawable;
        localObject = URLDrawable.getDrawable(((anme)localObject).c, localURLDrawableOptions);
      ...
      for (;;)
      {
        ...
        localURLImageView.setImageDrawable(paramContext.getResources().getDrawable(2130838547));
  ...
  private void b(String paramString)
  {
    ...
    Object localObject = new anmc(this, paramString);
    try
    {
      ...
      this.jdField_a_of_type_Bdfq = bdcd.a(localBaseActivity, 230, 2131558663, null, String.format(localBaseActivity.getString(2131690272), new Object[] { Integer.valueOf(this.jdField_a_of_type_Int) }), localBaseActivity.getString(2131690648), localBaseActivity.getString(2131690269), (DialogInterface.OnClickListener)localObject, (DialogInterface.OnClickListener)localObject);
      localObject = (LinearLayout)this.jdField_a_of_type_Bdfq.findViewById(2131369475);
      LinearLayout localLinearLayout = (LinearLayout)this.jdField_a_of_type_Bdfq.findViewById(2131369474);
      a(localBaseActivity, this.b, (LinearLayout)localObject, localLinearLayout);
      this.jdField_a_of_type_Bdfq.setOnDismissListener(new anmd(this));
      this.jdField_a_of_type_Bdfq.show();
      azmj.a(null, "dc00898", "", "", "0X800AD1C", "0X800AD1C", 3, 0, String.valueOf(this.jdField_a_of_type_Int), "", paramString, "");
      return;
    }
  ...
  public void a(String paramString1, String arg2, String paramString3, String paramString4, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    anme localanme = new anme();
    localanme.jdField_a_of_type_JavaLangString = ???;
    localanme.c = paramString4;
    localanme.b = paramString3;
    localanme.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener = paramOnClickListener;
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      this.jdField_a_of_type_JavaUtilArrayList.add(localanme);
