...
public class anmb
  extends abwi
{
  public anmb(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
  ...
  private void a(bcqt parambcqt, long paramLong1, long paramLong2, long paramLong3, int paramInt, StringBuffer paramStringBuffer, boolean paramBoolean1, MessageRecord paramMessageRecord, long paramLong4, boolean paramBoolean2, String paramString)
  {
    ...
    for (paramLong1 = System.currentTimeMillis() / 1000L;; paramLong1 = paramLong4)
    {
      ...
      localSubAccountMessage.mTimeString = bfzl.a(1000L * paramLong4, true, bcqk.jdField_a_of_type_JavaLangString);
      ...
      if (parambcqt != null) {
        parambcqt.b(localSubAccountMessage);
      }
      if (QLog.isColorLevel())
      {
  ...
  /* Error */
  private void a(bcqu parambcqu, String paramString1, String paramString2, bcqt parambcqt, long paramLong1, long paramLong2, long paramLong3, List<SubAccountMessage> paramList, ArrayList<String> paramArrayList, HashMap<String, Integer> paramHashMap, long paramLong4, List<msg_comm.Msg> paramList1, int paramInt, bbkm parambbkm)
  {
    // Byte code:
    //   0: aload 16
    ...
    //   196: lload 14
    //   198: iload 17
    //   200: invokespecial 313	anmb:a	(Ljava/util/List;Ljava/util/ArrayList;Ljava/util/HashMap;JI)V
    //   203: goto -194 -> 9
    ...
    //   213: astore 16
    //   215: sipush 193
    //   218: invokestatic 321	bbli:a	(I)Lcom/tencent/mobileqq/data/MessageRecord;
    //   221: astore 22
    //   223: aload 22
    //   225: lload 7
    ...
    //   300: aload 22
    //   302: aload_0
    //   303: getfield 14	anmb:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   345: iload 19
    //   347: iload 20
    //   349: invokespecial 364	anmb:a	(Lmsf/msgcomm/msg_comm$MsgHead;II)Z
    //   352: ifeq +262 -> 614
    //   355: aload_0
    //   356: iload 20
    //   358: invokespecial 367	anmb:a	(I)Z
    //   361: ifne -352 -> 9
    //   364: aload 24
    ...
    //   454: ifeq +21 -> 475
    //   457: aload_0
    //   458: getfield 14	anmb:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   473: astore 16
    //   475: sipush -2005
    //   478: invokestatic 321	bbli:a	(I)Lcom/tencent/mobileqq/data/MessageRecord;
    //   481: astore 22
    //   483: aload 22
    //   485: lload 7
    ...
    //   615: aload 24
    //   617: aload 18
    //   619: invokevirtual 411	anmb:a	(Lmsf/msgcomm/msg_comm$Msg;Lbbll;)Ljava/util/List;
    //   622: astore 16
    //   624: aload_0
    //   625: aload 16
    //   627: invokespecial 414	anmb:a	(Ljava/util/List;)Z
    //   630: istore 21
    //   632: iload 21
    //   634: ifne -625 -> 9
    //   637: goto -532 -> 105
    ...
    //   683: aload 24
    //   685: aload 16
    //   687: invokespecial 422	anmb:a	(Lbcqu;Ljava/lang/String;Ljava/lang/String;Lbcqt;JJLjava/util/List;Ljava/util/ArrayList;JILmsf/msgcomm/msg_comm$Msg;Ljava/util/List;)V
    //   690: goto -681 -> 9
    //   693: return
    //   694: astore 22
    //   696: goto -51 -> 645
  ...
  private void a(bcqu parambcqu, String paramString1, String paramString2, bcqt parambcqt, long paramLong1, long paramLong2, List<SubAccountMessage> paramList, ArrayList<String> paramArrayList, long paramLong3, int paramInt, msg_comm.Msg paramMsg, List<MessageRecord> paramList1)
  {
    ...
    do
    {
      try
      {
        ...
        {
          bool2 = true;
          paramList1 = bcqk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str, paramList1.msgtype, paramList1.senderuin);
          if (paramList1 == null)
          {
      ...
      if (bool2) {
        paramList = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131718751);
      }
      if (QLog.isColorLevel()) {
        QLog.d("SUB_ACCOUNT", 2, "sub.account.msg isQQMail=" + bool1);
      }
      parambcqu.jdField_c_of_type_Boolean = true;
      a(parambcqt, paramLong1, paramLong2, paramLong3, paramInt, localStringBuffer, bool1, localMessageRecord, l, bool2, paramList);
      bcqk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1, 6);
      parambcqu.d = true;
      parambcqu = bbli.a(localMessageRecord.msgtype);
      MessageRecord.copyMessageRecordBaseField(parambcqu, localMessageRecord);
      parambcqu.istroop = 7000;
      parambcqu.frienduin = paramString1;
      int i = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getConversationFacade().a(parambcqu.frienduin, parambcqu.istroop);
      paramInt = 0;
      if (parambcqt != null) {
        paramInt = parambcqt.c(paramString1);
      }
      int j = paramInt - i;
      if (j != 0)
      {
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getConversationFacade().d(parambcqu.frienduin, parambcqu.istroop, j);
        if (parambcqt != null) {
          parambcqt.c(paramString1);
        }
      }
      if (QLog.isColorLevel()) {
  ...
  private void a(bcqu parambcqu, String paramString1, String paramString2, msg_svc.PbGetMsgResp paramPbGetMsgResp, bcqt parambcqt, long paramLong1, long paramLong2, boolean paramBoolean, long paramLong3, List<SubAccountMessage> paramList, ArrayList<String> paramArrayList, HashMap<String, Integer> paramHashMap)
  {
    ...
    if (i < paramPbGetMsgResp.size())
    {
      ...
      do
      {
        ...
        localbbkm = new bbkm(paramLong2, l1, false, false, false, true);
      } while ((localList == null) || (localList.size() <= 0));
      Collections.sort(localList, new anmc(this));
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        a(parambcqu, paramString1, paramString2, parambcqt, paramLong1, paramLong2, paramLong3, paramList, paramArrayList, paramHashMap, l1, localList, j, localbbkm);
        break;
      }
    }
  }
  
  private void a(bcqu parambcqu, String paramString, msg_svc.PbGetMsgResp paramPbGetMsgResp, bcqt parambcqt, int paramInt)
  {
    parambcqu.jdField_a_of_type_Int = 1004;
    parambcqu.jdField_b_of_type_Int = paramInt;
    parambcqu.jdField_a_of_type_JavaLangString = paramPbGetMsgResp.errmsg.get();
    parambcqu.jdField_c_of_type_Boolean = true;
    bcqk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (byte)0, paramString);
    bcqk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, 6);
    parambcqu.d = true;
    parambcqt.a(paramString, null, true);
    boolean bool = parambcqt.a(paramString, 3);
    parambcqt.a(paramString, paramInt, paramPbGetMsgResp.errmsg.get());
    parambcqt.f(paramString);
    if (bool)
    {
  ...
  private void a(String paramString, bcqt parambcqt, boolean paramBoolean, long paramLong, List<SubAccountMessage> paramList, ArrayList<String> paramArrayList, HashMap<String, Integer> paramHashMap)
  {
      ...
      if (i < paramList.size())
      {
        ...
        for (;;)
        {
          ...
          if ((!localSubAccountMessage.frienduin.equals(String.valueOf(AppConstants.SYSTEM_MSG_UIN))) && (!localSubAccountMessage.frienduin.equals(String.valueOf(13002L))))
          {
            ...
            int j = 1;
            if ((j != 0) && (paramHashMap.containsKey(localSubAccountMessage.frienduin)) && (parambcqt != null)) {
              parambcqt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(paramLong), localSubAccountMessage.frienduin, ((Integer)paramHashMap.get(localSubAccountMessage.frienduin)).intValue());
            }
            if ((j == 0) && (parambcqt != null))
            {
              j = parambcqt.a(String.valueOf(paramLong), localSubAccountMessage.frienduin);
              if (j != 0)
              {
  ...
  private void a(msg_comm.Msg paramMsg, FromServiceMsg paramFromServiceMsg, msg_onlinepush.PbPushMsg paramPbPushMsg)
  {
    ...
    paramMsg.istroop = 1;
    paramMsg.sendername = amtj.a(2131718688);
    paramMsg.msg = "";
    paramPbPushMsg = (bcqt)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(61);
  ...
  {
    new anmd(this, paramRspBody, paramString2, paramString1, paramInt1, paramInt2).execute(new Void[0]);
  }
  ...
  private boolean a(bcqu parambcqu, long paramLong)
  {
    boolean bool = false;
    if (paramLong == -1L)
    {
      a(8003, false, parambcqu);
      if (QLog.isColorLevel()) {
        QLog.d("SUB_ACCOUNT", 2, "subaccount <PbGetMsg><R><---handleGetSubC2CMessageResp_PB selfUin == -1 ");
      }
      parambcqu = new HashMap();
      parambcqu.put("param_FailCode", "12014");
      parambcqu.put("fail_step", "selfUin_null");
      parambcqu.put("fail_location", "MessageHandler");
      StatisticCollector.getInstance(BaseApplication.getContext()).collectPerformance(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "actSBGetMsg", false, 0L, 0L, parambcqu, "");
      bool = true;
    }
    return bool;
  }
  
  private boolean a(bcqu parambcqu, String paramString)
  {
    boolean bool = false;
    if (paramString == null)
    {
      ...
      parambcqu = new HashMap();
      parambcqu.put("param_FailCode", "12014");
      parambcqu.put("fail_step", "backuin_null");
      parambcqu.put("fail_location", "MessageHandler");
      StatisticCollector.getInstance(BaseApplication.getContext()).collectPerformance(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "actSBGetMsg", false, 0L, 0L, parambcqu, "");
      bool = true;
    }
  ...
  private boolean a(bcqu parambcqu, String paramString, msg_svc.PbGetMsgResp paramPbGetMsgResp, bcqt parambcqt)
  {
    int i;
    ...
    for (;;)
    {
      ...
      default: 
        if (b(i)) {
          a(parambcqu, paramString, paramPbGetMsgResp, parambcqt, i);
        }
        break;
      }
      for (;;)
      {
        ...
        bcqk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "sub.uin.all");
        continue;
        parambcqu.jdField_a_of_type_Int = 1002;
        bcqk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (byte)0, paramString);
        bcqk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString);
        continue;
        parambcqu.jdField_a_of_type_Int = 1006;
        continue;
  ...
  private boolean a(bcqu parambcqu, msg_svc.PbGetMsgResp paramPbGetMsgResp)
  {
    boolean bool = false;
  ...
  private boolean a(ToServiceMsg paramToServiceMsg, bcqu parambcqu, byte paramByte, int paramInt, long paramLong, ArrayList<String> paramArrayList)
  {
    if (paramByte > 0) {
      if (paramLong > 0L)
      {
        ...
        if (paramToServiceMsg != null)
        {
          ...
          parambcqu.jdField_a_of_type_Boolean = false;
          a(8003, true, parambcqu);
          return true;
        }
      }
  ...
  {
    return (bblk.c(paramInt1)) && (paramMsgHead.c2c_cmd.has()) && ((paramInt2 == 169) || (paramInt2 == 241) || (paramInt2 == 242) || (paramInt2 == 243) || (paramInt2 == 129) || (paramInt2 == 131) || (paramInt2 == 133));
  }
        ...
        for (;;)
        {
          try
          {
            ...
            else
            {
              ...
              if (j == 0)
              {
                paramToServiceMsg = (bcqt)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(61);
                if (paramToServiceMsg != null) {
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    localbcqu.jdField_b_of_type_JavaLangString = str2;
    localbcqu.jdField_c_of_type_JavaLangString = str1;
    if (QLog.isColorLevel()) {
    ...
    {
      if (!a(localbcqu, localPbGetMsgResp)) {
        break label279;
      }
    }
    label234:
    ...
    for (;;)
    {
      ...
      break label196;
      localbcqt = (bcqt)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(61);
      if (!a(localbcqu, str1, localPbGetMsgResp, localbcqt))
      {
        localbcqt.a(str1, 1);
    ...
    for (paramFromServiceMsg = localPbGetMsgResp.sync_cookie.get().toByteArray();; paramFromServiceMsg = null)
    {
      ...
      for (int i = localPbGetMsgResp.sync_flag.get();; i = 2)
      {
        ...
        for (;;)
        {
          ...
          List localList = localbcqt.a(Long.toString(l3));
          ...
          a(localbcqu, str1, str2, localPbGetMsgResp, localbcqt, l2, l1, bool, l3, localList, paramObject, (HashMap)localObject2);
          a(str1, localbcqt, bool, l3, localList, paramObject, (HashMap)localObject2);
          localbcqt.a(str1, paramFromServiceMsg);
          ...
          if (a(paramToServiceMsg, localbcqu, b, i, l3, paramObject)) {
            break;
          }
          localbcqu.jdField_a_of_type_Int = 0;
          a(8003, true, localbcqu);
          if (!QLog.isColorLevel()) {
            break;
          }
  ...
  private String g(MessageRecord paramMessageRecord, String paramString)
  {
    ...
    do
    {
      ...
      return this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131691173);
      return f(paramMessageRecord, paramString);
      return this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131718592);
  ...
  String a(MessageRecord paramMessageRecord, String paramString)
  {
    ...
    if (TextUtils.isEmpty(str)) {
      paramMessageRecord = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131718685);
    }
  ...
  public void a(byte paramByte, int paramInt, String paramString1, String paramString2, ArrayList<String> paramArrayList)
  {
    ...
    paramArrayList = (bcqt)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(61);
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    ...
    do
    {
      ...
      return;
      localaqcz = (aqcz)apub.a().a(607);
    } while ((localaqcz == null) || (localaqcz.jdField_a_of_type_Boolean));
    if ((paramVarArgs != null) && (paramVarArgs.length == 3))
    {
  ...
  public void a(RequestPushNotify paramRequestPushNotify)
  {
    ...
    {
      localObject = abxc.a(((MsgInfo)localObject).vMsg);
    ...
    do
    {
      ...
      try
      {
        ...
        bbmq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localReqBody, paramRequestPushNotify.lBindedUin, true);
        return;
      }
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    while (i < paramObject.thirdqq_resp_info.get().size())
    {
      ...
      bcqk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramToServiceMsg, str, arrayOfByte, k, m, n, i1, i2);
      i += 1;
    }
    bcqk.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramToServiceMsg, j);
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    for (Object localObject = ((bcqt)localObject).a(paramString1);; localObject = null)
    {
      ...
      while (paramArrayList.hasNext())
      {
        ...
        if (localObject2 != null)
        {
          try
          {
            ...
            localObject3 = bcqk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject2);
  ...
  public boolean a(SubAccountInfo paramSubAccountInfo)
  {
    ...
    for (;;)
    {
      ...
      ((Oidb_0x5d0.ReqBody)localObject1).uint32_start_time.set(bcqk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin(), paramSubAccountInfo.subuin));
      try
      {
  ...
  {
    if (amrp.a(paramMessageRecord)) {
      return this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131691169);
    }
    if ((paramMessageRecord instanceof MessageForPic)) {
      return ((MessageForPic)paramMessageRecord).getSummaryMsg();
    }
    return this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131691172);
  }
  ...
  String c(MessageRecord paramMessageRecord, String paramString)
  {
    ...
    catch (Exception paramMessageRecord)
    {
      ...
      } while (paramMessageRecord.equalsIgnoreCase(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131691168)));
    }
    if (TextUtils.isEmpty(paramMessageRecord))
    {
      paramString = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131691168);
      return paramString;
    }
    return this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131691168) + paramMessageRecord;
  }
  ...
  String e(MessageRecord paramMessageRecord, String paramString)
  {
    ...
    try
    {
      if (bfti.a(paramMessageRecord.msgtype))
      {
        paramMessageRecord = bfti.a(paramMessageRecord.msg);
        ...
        if (paramMessageRecord != null)
        {
          ...
          paramMessageRecord = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgHandler().a(bftp.a(paramMessageRecord.shareAppID));
          paramString = new StringBuilder().append(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131690084));
          if (paramMessageRecord == null) {}
          for (paramMessageRecord = "";; paramMessageRecord = paramMessageRecord.messagetail + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131690085)) {
            return paramMessageRecord;
          }
        }
      }
      ...
      {
        localObject = paramString;
        if (!bfti.b(paramMessageRecord.msgtype))
        {
          localObject = paramString;
          if (paramMessageRecord.msg != null)
          {
            ...
            {
              localObject = bblk.a(paramMessageRecord.msg);
              paramString = "";
              paramMessageRecord = paramString;
              if (localObject != null)
              {
              ...
              paramMessageRecord = "[" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131719039) + "] " + paramMessageRecord;
              return paramMessageRecord;
            }
          }
        }
  ...
  String f(MessageRecord paramMessageRecord, String paramString)
  {
    if ((paramMessageRecord instanceof MessageForMarketFace))
    {
      ...
      return this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131691788);
    }
    return this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131691788);
  }
}
