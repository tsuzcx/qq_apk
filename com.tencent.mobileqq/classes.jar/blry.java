  ...
  implements Handler.Callback
{
  ...
  public Handler a;
  public View a;
  private final blsa jdField_a_of_type_Blsa;
  public boolean a;
  private boolean c;
  ...
  @TargetApi(19)
  public blry(Window paramWindow, boolean paramBoolean)
  {
    ViewGroup localViewGroup = (ViewGroup)paramWindow.getDecorView();
    if (ImmersiveUtils.isSupporImmersive() == 1) {
      this.c = paramBoolean;
    }
    this.jdField_a_of_type_Blsa = new blsa(paramWindow, this.c, null);
    if (this.c) {
  ...
  private void a(Window paramWindow, ViewGroup paramViewGroup)
  {
    ...
    paramWindow = new FrameLayout.LayoutParams(-1, this.jdField_a_of_type_Blsa.a());
