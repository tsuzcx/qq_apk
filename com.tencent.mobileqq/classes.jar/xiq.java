...
public class xiq
  implements Runnable
{
  public xiq(LoginView paramLoginView, String paramString, QQProgressDialog paramQQProgressDialog) {}
  ...
  public void run()
  {
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityRegisterGuideLoginLoginView.jdField_a_of_type_ComTencentMobileqqAppBaseActivity != null) {
        this.jdField_a_of_type_ComTencentMobileqqActivityRegisterGuideLoginLoginView.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.runOnUiThread(new xir(this));
      }
      return;
      i = 0;
    }
