...
public class mhe
{
  ...
  public mhe(Context paramContext, VideoController paramVideoController, int paramInt, QavPanel paramQavPanel, View paramView1, View paramView2, View paramView3, View paramView4, View paramView5, View paramView6)
  {
    ...
    paramInt = mue.a(paramContext);
    if (paramInt <= 320) {
      paramInt = paramContext.getResources().getDimensionPixelSize(2131297668) + paramContext.getResources().getDimensionPixelSize(2131297664);
    }
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener = new mhf(this);
      this.jdField_b_of_type_AndroidViewAnimationAnimation$AnimationListener = new mhg(this);
      this.jdField_c_of_type_AndroidViewAnimationAnimation$AnimationListener = new mhh(this);
      return;
      if (paramInt <= 480) {
        paramInt = paramContext.getResources().getDimensionPixelSize(2131297669) + paramContext.getResources().getDimensionPixelSize(2131297665);
      } else {
        paramInt = paramContext.getResources().getDimensionPixelSize(2131297671) + paramContext.getResources().getDimensionPixelSize(2131297667);
      }
    }
  }
  ...
  public void a(mhi parammhi)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentAvVideoController == null) || (this.jdField_a_of_type_ComTencentAvVideoController.a() == null) || (this.jdField_a_of_type_ComTencentAvVideoController.a().as) || (this.jdField_a_of_type_ComTencentAvUiQavPanel == null) || (this.jdField_f_of_type_AndroidViewAnimationAnimation == null) || (this.jdField_a_of_type_AndroidViewAnimationAnimation == null)) {
      ...
      {
        this.jdField_a_of_type_Mhi.a();
        this.jdField_a_of_type_Mhi.b();
      }
    }
    do
    {
  ...
  public void a(mhj parammhj)
  {
    this.jdField_a_of_type_Mhj = parammhj;
    ...
    parammhj.setAnimationListener(this.jdField_c_of_type_AndroidViewAnimationAnimation$AnimationListener);
    this.jdField_a_of_type_ComTencentAvUiQavPanel.startAnimation(parammhj);
  ...
  public void b()
  {
    ...
    this.l = null;
    this.m = null;
    this.jdField_a_of_type_Mhi = null;
