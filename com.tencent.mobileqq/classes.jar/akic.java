  ...
  extends BaseAdapter
{
  ...
  public boolean a;
  public Object b;
  protected List<akjl> b;
  
  static
  {
    jdField_b_of_type_JavaLangString = akjm.class.getSimpleName();
  }
  
  public akic(Context paramContext, blha paramblha, SessionInfo paramSessionInfo, QQAppInterface paramQQAppInterface)
  {
  ...
  protected ChatHistorySearchData a(ChatHistorySearchData paramChatHistorySearchData, ArrayList<akjl> paramArrayList)
  {
      ...
      do
      {
        ...
        while (i < paramChatHistorySearchData.mSearchData1.size())
        {
          ...
          if (a(localMessageRecord)) {
            paramArrayList.add(new akjl(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord));
          }
          i += 1;
        }
  ...
  public void a(List<akjl> paramList, int paramInt)
  {
    if (paramInt == 1) {
  ...
  public boolean a(MessageRecord paramMessageRecord)
  {
    ...
    {
      return false;
      str = bhlg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramMessageRecord.isSend(), paramMessageRecord.senderuin).toLowerCase(Locale.US);
      paramMessageRecord = akjl.a(paramMessageRecord.msg).toLowerCase(Locale.US);
    } while ((!str.contains(akjl.jdField_a_of_type_JavaLangString)) && (!paramMessageRecord.contains(akjl.jdField_a_of_type_JavaLangString)));
    return true;
  }
  
  public ChatHistorySearchData b(ChatHistorySearchData paramChatHistorySearchData, ArrayList<akjl> paramArrayList)
  {
    int i = 0;
    for (;;)
    {
