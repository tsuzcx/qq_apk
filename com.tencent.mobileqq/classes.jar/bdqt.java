...
public final class bdqt
{
  ...
  private final List<bdqx> jdField_b_of_type_JavaUtilList = new ArrayList();
  private int jdField_c_of_type_Int = -1;
  private final List<bdqu> jdField_c_of_type_JavaUtilList = new ArrayList();
  
  public bdqt(@NonNull Bitmap paramBitmap)
  {
    if ((paramBitmap == null) || (paramBitmap.isRecycled())) {
      throw new IllegalArgumentException("Bitmap is not valid");
    }
    this.jdField_c_of_type_JavaUtilList.add(bdqr.a);
    this.jdField_a_of_type_AndroidGraphicsBitmap = paramBitmap;
    this.jdField_a_of_type_JavaUtilList = null;
    this.jdField_b_of_type_JavaUtilList.add(bdqx.a);
    this.jdField_b_of_type_JavaUtilList.add(bdqx.b);
    this.jdField_b_of_type_JavaUtilList.add(bdqx.c);
    this.jdField_b_of_type_JavaUtilList.add(bdqx.d);
    this.jdField_b_of_type_JavaUtilList.add(bdqx.e);
    this.jdField_b_of_type_JavaUtilList.add(bdqx.f);
  }
  ...
  public bdqr a()
  {
    ...
    if (this.jdField_a_of_type_AndroidGraphicsBitmap != null)
    {
      ...
      {
        localObject = null;
        localObject = new bdqm(arrayOfInt, i, (bdqu[])localObject);
        if (localBitmap != this.jdField_a_of_type_AndroidGraphicsBitmap) {
          localBitmap.recycle();
        }
        localObject = ((bdqm)localObject).a();
        if (0 != 0) {
          throw new NullPointerException();
        }
      }
    ...
    for (;;)
    {
      localObject = new bdqr((List)localObject, this.jdField_b_of_type_JavaUtilList);
      ((bdqr)localObject).a();
      if (0 != 0) {
        throw new NullPointerException();
      }
      return localObject;
      localObject = (bdqu[])this.jdField_c_of_type_JavaUtilList.toArray(new bdqu[this.jdField_c_of_type_JavaUtilList.size()]);
      break;
