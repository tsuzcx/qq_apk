  ...
  implements bkhw
{
  ...
  public abdo(Context paramContext)
  {
    ...
    this.jdField_a_of_type_JavaUtilLinkedHashMap.put("com.tencent.map", anni.a(2131709217));
    this.jdField_a_of_type_JavaUtilLinkedHashMap.put("com.google.android.apps.maps", "Google地图");
    this.jdField_a_of_type_JavaUtilLinkedHashMap.put("com.autonavi.minimap", anni.a(2131709215));
    this.jdField_a_of_type_JavaUtilLinkedHashMap.put("com.baidu.BaiduMap", anni.a(2131709216));
  ...
  public static String a(double paramDouble)
  {
    if (paramDouble < 1000.0D) {
      return String.format(anni.a(2131709223), new Object[] { Double.valueOf(paramDouble) });
    }
    return String.format(anni.a(2131709222), new Object[] { Double.valueOf(paramDouble / 1000.0D) });
  }
  ...
  {
    bcst.b(null, "dc00899", "Pb_account_lifeservice", "", "rec_locate_android", paramString1, 0, 0, paramString2, paramString3, "", "");
    if (QLog.isColorLevel()) {
  ...
  {
    bcst.b(null, "P_CliOper", "Pb_account_lifeservice", "", "rec_locate", paramString1, 0, 0, paramString2, "", "", "");
    if (QLog.isColorLevel()) {
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Abdq != null) {
        if (!this.jdField_a_of_type_Abdq.b())
        {
  ...
  protected void a()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (bkgu.a(this.jdField_a_of_type_AndroidContentContext, str)) {
  ...
  public void a(abdq paramabdq)
  {
    this.jdField_a_of_type_Abdq = paramabdq;
  }
  ...
  public void a(GeoPoint paramGeoPoint1, GeoPoint paramGeoPoint2)
  {
    if (!bgnt.g(this.jdField_a_of_type_AndroidContentContext))
    {
      ...
      QQToast.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 1, paramGeoPoint1.getString(2131693948), 1).b(paramGeoPoint1.getDimensionPixelSize(2131298998));
      return;
    }
    ...
    for (;;)
    {
      ...
      new bfpn(str, "GET", new abdp(this), 1000, localBundle2, true).execute(new HashMap[] { paramGeoPoint1 });
      return;
  ...
  public void a(GeoPoint paramGeoPoint1, GeoPoint paramGeoPoint2, String paramString1, String paramString2)
  {
    ...
    {
      QQToast.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 0, anni.a(2131709220), 1).b(this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298998));
      return;
    }
    ...
    if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
      this.jdField_a_of_type_JavaLangString = anni.a(2131709218);
    }
    if (TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
      this.jdField_b_of_type_JavaLangString = anni.a(2131709214);
    }
    ...
    if (d > 1000.0D)
    {
      ...
      if ((this.jdField_a_of_type_Abdq == null) || (this.jdField_a_of_type_Abdq.b())) {
        break label469;
      }
      this.jdField_a_of_type_Bkho.c(anni.a(2131709221));
      label295:
      this.jdField_a_of_type_ArrayOfInt[0] = 0;
      this.jdField_a_of_type_Bkho.c(anni.a(2131709219));
      this.jdField_a_of_type_ArrayOfInt[1] = 1;
      this.jdField_a_of_type_Bkho.c((CharSequence)this.jdField_a_of_type_JavaUtilLinkedHashMap.get("com.tencent.map"));
      ...
      this.jdField_a_of_type_Bkho.c(paramString1);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Int = 0;
      break;
      this.jdField_a_of_type_Bkho.c(anni.a(2131709213));
      break label295;
  ...
  public void a(JSONObject paramJSONObject, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Abdq != null) {
        this.jdField_a_of_type_Abdq.a(paramJSONObject, paramInt);
      }
      return;
      if (paramInt == 1)
      {
