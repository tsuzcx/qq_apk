...
{
  public uyq(MarketFaceItemBuilder paramMarketFaceItemBuilder, Context paramContext)
  {
    super(paramContext);
  }
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          if ((MarketFaceItemBuilder.c != 0L) && (MarketFaceItemBuilder.c == localHolder.jdField_a_of_type_ComTencentMobileqqDataChatMessage.uniseq) && (localHolder.jdField_a_of_type_ComTencentMobileqqEmoticonviewPicEmoticonInfo.a()))
          {
            ...
            QQToast.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131433771, 0).b(this.a.b.getResources().getDimensionPixelSize(2131558448));
          }
        }
        for (;;)
        {
