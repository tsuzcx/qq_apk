...
public class uyq
  implements Runnable
{
  public uyq(ApolloItemBuilder paramApolloItemBuilder, MessageForApollo paramMessageForApollo, BaseChatItemLayout paramBaseChatItemLayout, ApolloItemBuilder.Holder paramHolder) {}
  ...
  public void run()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqDataMessageForApollo.mApolloMessage != null)
    {
      ...
      localObject = new uyy(this.jdField_a_of_type_ComTencentMobileqqActivityAioItemApolloItemBuilder, this.jdField_a_of_type_ComTencentMobileqqActivityAioItemApolloItemBuilder$Holder, this.jdField_a_of_type_ComTencentMobileqqDataMessageForApollo, 0);
      ThreadManager.getUIHandler().post((Runnable)localObject);
      localObject = new uyy(this.jdField_a_of_type_ComTencentMobileqqActivityAioItemApolloItemBuilder, this.jdField_a_of_type_ComTencentMobileqqActivityAioItemApolloItemBuilder$Holder, this.jdField_a_of_type_ComTencentMobileqqDataMessageForApollo, 1);
    ...
    {
      ThreadManager.getUIHandler().post(new uyr(this));
      return;
    }
