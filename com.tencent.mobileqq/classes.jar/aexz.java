...
{
  public aexz(LoginVerifyCodeActivity paramLoginVerifyCodeActivity) {}
  ...
  public void onGetStViaSMSVerifyLogin(String paramString, long paramLong1, int paramInt1, long paramLong2, int paramInt2, byte[] paramArrayOfByte, ErrMsg paramErrMsg)
  {
    ...
    if (paramInt2 == 0)
    {
      ...
      for (;;)
      {
        bdll.a(this.a.app, "dc00898", "", LoginVerifyCodeActivity.a(this.a), "0X800B10C", "0X800B10C", LoginVerifyCodeActivity.c(this.a), 0, "", "", "", "");
        this.a.finish();
        return;
    ...
    label632:
    for (paramString = this.a.getString(2131717456);; paramString = localObject1)
    {
      bdll.a(this.a.app, "dc00898", "", LoginVerifyCodeActivity.a(this.a), "0X800B10B", "0X800B10B", LoginVerifyCodeActivity.c(this.a), 0, "", "", paramString, "");
      if (paramInt2 != 155) {
        break;
      }
      this.a.finish();
  ...
  public void onGetSubaccountStViaSMSVerifyLogin(String paramString1, String paramString2, long paramLong1, int paramInt1, long paramLong2, int paramInt2, ErrMsg paramErrMsg)
  {
    ...
    if (paramInt2 == 0) {
      if ((paramString1 != null) && (paramString2 != null) && (paramString1.equals(paramString2)))
      {
        ...
        LoginVerifyCodeActivity.a(this.a, 2131718423, 0);
        this.a.finish();
      }
    }
    for (;;)
    {
      ...
      if (this.a.app != null)
      {
        ...
        bdmc.a(BaseApplication.getContext()).a(this.a.app.getCurrentAccountUin(), "actSBLogin", true, 0L, 0L, paramString1, "");
        bhsi.a(this.a.app.getApplication().getApplicationContext(), paramString2, true);
        this.a.getAppRuntime().getSubAccountKey(this.a.app.getAccount(), paramString2, this.a.a);
        paramString1 = (bdxc)this.a.app.getManager(61);
  ...
  public void onRefreshSMSVerifyLoginAccount(String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, ErrMsg paramErrMsg)
  {
    ...
    if (paramInt3 != 0)
    {
      ...
      if (TextUtils.isEmpty(paramString1))
      {
        ...
        paramString1 = this.a.getString(2131717456);
      }
      label250:
      for (;;)
      {
        bdll.a(this.a.app, "dc00898", "", LoginVerifyCodeActivity.a(this.a), "0X800B10B", "0X800B10B", LoginVerifyCodeActivity.c(this.a), 0, "", "", paramString1, "");
        return;
