...
public class bcrv
  implements bcpo
{
  public bcrv(TroopAIORobotLayout paramTroopAIORobotLayout, int paramInt, String paramString1, String paramString2, String paramString3, bcro parambcro) {}
  ...
  public void a(int paramInt, cmd0x934.RspBody paramRspBody)
  {
    ...
    if (paramInt == 0)
    {
      bcpg localbcpg = RobotPanelLayoutBase.a();
      if (localbcpg == null)
      {
      ...
      if ((this.jdField_a_of_type_Int != paramInt) && (paramRspBody.robot_uin.get() == Long.parseLong(this.jdField_a_of_type_JavaLangString)))
      {
        ...
        localbcpg.a(this.b, this.jdField_a_of_type_JavaLangString, paramRspBody);
        ...
        if ((paramRspBody != null) && (paramRspBody.size() > 0))
        {
          ...
          if (this.jdField_a_of_type_ComTencentMobileqqTroopWidgetTroopAIORobotLayout.b() > 0) {
            TroopAIORobotLayout.a(this.jdField_a_of_type_ComTencentMobileqqTroopWidgetTroopAIORobotLayout, this.jdField_a_of_type_ComTencentMobileqqTroopWidgetTroopAIORobotLayout.c, this.jdField_a_of_type_ComTencentMobileqqTroopWidgetTroopAIORobotLayout.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqTroopWidgetTroopAIORobotLayout.b, localbcpg, true);
          }
          paramRspBody = this.jdField_a_of_type_Bcro;
          if (this.jdField_a_of_type_ComTencentMobileqqTroopWidgetTroopAIORobotLayout.b() <= 0) {
            break label468;
          }
        }
      ...
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqTroopWidgetTroopAIORobotLayout.b() == 0)
        {
          ...
          byte[] arrayOfByte = localbcpg.a(this.b, this.jdField_a_of_type_JavaLangString);
          if (arrayOfByte != null) {
            for (;;)
            {
              try
    ...
    this.jdField_a_of_type_Bcro.a(false, "");
  }
}
