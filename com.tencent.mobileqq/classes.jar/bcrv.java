...
class bcrv
{
  ...
  private bffl jdField_a_of_type_Bffl;
  ...
  private void a()
  {
    ...
    this.jdField_b_of_type_JavaLangStringBuilder.append(this.jdField_a_of_type_Bcrt.a((im_msg_body.CommonElem)this.jdField_a_of_type_TencentImMsgIm_msg_body$Elem.common_elem.get()));
  }
  ...
  private void a(int paramInt, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      if (localAtTroopMemberInfo.isIncludingAll()) {
        this.jdField_a_of_type_Bffl.jdField_a_of_type_Bffm.b(13, this.jdField_a_of_type_Long);
      }
      j = m;
      i = k;
      if (localAtTroopMemberInfo.isIncludingMe(bcrt.a(this.jdField_a_of_type_Bcrt).app.getLongAccountUin()))
      {
        this.jdField_a_of_type_Bffl.jdField_a_of_type_Bffm.b(24, this.jdField_a_of_type_Long);
        j = m;
        i = k;
        if (localAtTroopMemberInfo != this.jdField_a_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo)
        {
          ...
          if (this.jdField_b_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo == null)
          {
            j = m;
            i = k;
            if (this.jdField_a_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo.isIncludingMe(bcrt.a(this.jdField_a_of_type_Bcrt).app.getLongAccountUin()))
            {
  ...
  private bcrv b()
  {
    ...
    do
    {
      ...
      {
        localObject1 = bcsc.a(((im_msg_body.Text)localObject2).str.get().toStringUtf8(), false);
    ...
    {
      if ((this.jdField_a_of_type_Bffl != null) && ((this.jdField_a_of_type_Bffl.jdField_a_of_type_Int == 3000) || (this.jdField_a_of_type_Bffl.jdField_a_of_type_Int == 1)) && (this.jdField_a_of_type_JavaUtilArrayList != null) && (localObject2 != null) && (localObject2.length != 0)) {
        b(i, (byte[])localObject2);
      }
      localObject1 = localObject3;
      if (this.jdField_a_of_type_Bffl == null) {
        break;
      }
      if ((!this.jdField_a_of_type_Bffl.jdField_a_of_type_Bffm.a(24, this.jdField_a_of_type_Long)) && (!this.jdField_a_of_type_Bffl.jdField_a_of_type_Bffm.a(13, this.jdField_a_of_type_Long)))
      {
        localObject1 = localObject3;
        if (this.jdField_b_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo != null) {
          break;
  ...
  private void b()
  {
    ...
    this.jdField_b_of_type_JavaLangStringBuilder.append(BaseApplication.getContext().getString(2131694421));
  }
