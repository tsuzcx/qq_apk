...
{
  public awsy(ShortVideoCommentsView paramShortVideoCommentsView) {}
  
  public void onClick(View paramView)
  {
    String str3 = ShortVideoCommentsView.a(this.a).getText().toString();
    if (str3.equals("")) {
      this.a.a(this.a.getContext().getResources().getString(2131695857));
    }
    for (;;)
    {
      ...
      if (str3.length() > 140)
      {
        this.a.a(this.a.getContext().getResources().getString(2131695858));
      }
      else
      {
        ...
        bcef.b(this.a.a, "dc00899", "grp_lbs", "", "new_thing", "clk_reply", 0, 0, "", "", "", "");
      }
    }
  }
}
