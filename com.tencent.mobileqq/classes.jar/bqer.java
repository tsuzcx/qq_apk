  ...
  implements GLSurfaceView.Renderer
{
  ...
  private bqhc jdField_a_of_type_Bqhc;
  ...
  private int b;
  private int c = bncu.jdField_a_of_type_Int;
  private int d;
  private int e;
  ...
  public Bitmap a(Bitmap paramBitmap, long paramLong)
  {
    ...
    Object localObject = bqeq.a(0);
    QQFilterRenderManager localQQFilterRenderManager = bncu.a(bncu.c);
    if (localQQFilterRenderManager != null)
    {
      ...
      this.jdField_a_of_type_Bqhc = new bqhc(localQQFilterRenderManager.getBusinessOperation().getCurrentAVFilterIdList(), localMusicItemInfo, this.d, this.e, null);
      this.jdField_a_of_type_Bqhc.a(true);
      if ((this.jdField_a_of_type_Bqhc == null) || (localObject == null)) {
        break label210;
      }
    }
    for (;;)
    {
      try
      {
        paramBitmap = zlx.a(paramBitmap, 1.0F, -1.0F);
        ((GPUBaseFilter)localObject).init();
        this.jdField_a_of_type_Bqhc.a(this.d, this.e);
      ...
      try
      {
        ...
        localObject = zlx.a(paramBitmap, 1.0F, -1.0F);
        this.jdField_a_of_type_Bqhc = null;
        return localObject;
      }
  ...
  public Bitmap a(Bitmap paramBitmap, GPUBaseFilter paramGPUBaseFilter)
  {
    ...
    if ((this.jdField_a_of_type_Bqhc != null) && (this.jdField_a_of_type_Bqhc.jdField_a_of_type_Boolean)) {}
    for (int i = 30;; i = 2)
    {
      int j = 0;
      while (j < i)
  ...
  public Bitmap a(Bitmap paramBitmap, List<FilterDesc> paramList, bqer parambqer)
  {
    this.jdField_a_of_type_ComTencentTtpicOpenapiFilterGPUBaseFilter = parambqer.jdField_a_of_type_ComTencentTtpicOpenapiFilterGPUBaseFilter;
    this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager = parambqer.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager;
    if ((this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager != null) && (this.jdField_a_of_type_ComTencentTtpicOpenapiFilterGPUBaseFilter != null) && (paramList != null))
    {
      ...
      this.jdField_a_of_type_AndroidGraphicsBitmap = paramBitmap;
      int i = 5;
      if (parambqer.jdField_a_of_type_Boolean)
      {
        parambqer.jdField_a_of_type_Boolean = false;
        i = 20;
      }
      int j = 0;
      while (j < i)
      ...
      return zlx.a(paramBitmap, 1.0F, -1.0F);
    }
    return null;
  }
  ...
  {
    GPUBaseFilter localGPUBaseFilter = bqeq.a(0);
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager != null) && (localGPUBaseFilter != null) && (paramList != null))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager.getBusinessOperation().setFilterEffectList(paramList);
      return zlx.a(a(paramBitmap, localGPUBaseFilter), 1.0F, -1.0F);
    }
    return null;
  }
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager != null)
    {
      ...
      this.c = bncu.jdField_a_of_type_Int;
    }
  }
  ...
  {
    this.jdField_a_of_type_Bath = new bath(paramEGLContext, 1);
    d(paramInt1, paramInt2);
  }
  ...
  {
    if (Build.VERSION.SDK_INT >= 17) {
      this.jdField_a_of_type_Bath = new bath(EGL14.EGL_NO_CONTEXT, 1);
    }
    d(paramInt1, paramInt2);
  }
  ...
  public void c(int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_ComTencentTtpicOpenapiFilterGPUBaseFilter = bqeq.a(0);
    this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager = bncu.b();
  ...
  public void onDrawFrame(GL10 paramGL10)
  {
    ...
    for (Object localObject = this.jdField_a_of_type_AndroidGraphicsBitmap;; localObject = paramGL10)
    {
      ...
      if (this.jdField_a_of_type_Bqhc != null) {
        this.b = this.jdField_a_of_type_Bqhc.a(this.d, this.e, this.b, this.jdField_a_of_type_Long);
      }
      if (this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager != null)
      {
