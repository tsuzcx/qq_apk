  ...
  implements pye
{
  ...
  private void b(BaseArticleInfo paramBaseArticleInfo, JSONObject paramJSONObject)
  {
    ...
    for (int i = 1; (i != 0) && (!puo.c(paramBaseArticleInfo)); i = 0)
    {
      paramJSONObject.put("user_desc_follow_text", ozs.g(2131717379));
  ...
  public JSONObject a(int paramInt, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    ((ptl)localObject).a(paramBaseArticleInfo).b(paramBaseArticleInfo).g(paramBaseArticleInfo).h(paramBaseArticleInfo);
    try
    {
      ((ptl)localObject).a(paramBaseArticleInfo, Long.parseLong(paramBaseArticleInfo.mSubscribeID));
