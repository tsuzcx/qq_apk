...
public class binq
{
  ...
  public TextView a;
  bhtj<Integer> jdField_a_of_type_Bhtj = new binr(this);
  public birg a;
  public birj a;
  public bisg a;
  TouchWebView.OnScrollChangedListener jdField_a_of_type_ComTencentBizUiTouchWebView$OnScrollChangedListener = new bins(this);
  ...
  void a(int paramInt, boolean paramBoolean)
  {
    ...
    {
      localObject2 = null;
      if ((paramInt < this.jdField_c_of_type_Int) || (!this.jdField_a_of_type_Birj.v)) {
        break label94;
      }
      this.jdField_a_of_type_Birj.v = false;
      if (!paramBoolean) {
        break label80;
      }
    ...
    for (;;)
    {
      ...
      {
        localObject1 = localObject2;
        if (!this.jdField_a_of_type_Birj.v)
        {
          this.jdField_a_of_type_Birj.v = true;
          if (paramBoolean)
          {
        ...
        try
        {
          ...
          if (i >= 40300)
          {
            ...
            if (i <= 40313)
            {
              ...
              {
                str1 = str2;
                if (str2.contains(anzj.a(2131713500))) {
                  str1 = BaseApplicationImpl.getApplication().getString(2131690559);
                }
              }
            }
          }
          ...
          paramIntent = str1;
          if (str1 == null) {
            paramIntent = BaseApplicationImpl.getApplication().getString(2131690559);
          }
          if (!birz.a())
          {
            ...
            if (AppSetting.jdField_c_of_type_Boolean)
            {
              ...
              paramIntent = str1;
              if (!str1.contains(BaseApplicationImpl.getApplication().getString(2131690559))) {
                paramIntent = BaseApplicationImpl.getApplication().getString(2131690559) + str1;
              }
  ...
  {
    LayoutInflater.from(this.jdField_a_of_type_Birg.d.getContext()).inflate(2131558755, this.jdField_a_of_type_Birg.d);
    this.jdField_b_of_type_AndroidContentIntent = paramIntent;
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_Birg.d.findViewById(2131376731));
    a(this.jdField_a_of_type_AndroidViewViewGroup);
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131376900);
    this.jdField_c_of_type_AndroidViewView.setVisibility(8);
    this.jdField_c_of_type_AndroidViewView.setPadding(0, -bhtq.b(12.0F), 0, 0);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131369042));
    ...
    this.jdField_a_of_type_ComTencentWidgetFadeIconImageView = ((FadeIconImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131369045));
    this.jdField_a_of_type_ComTencentWidgetFadeIconImageView.setOnClickListener(paramOnClickListener);
    this.jdField_a_of_type_ComTencentWidgetFadeIconImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131689838));
    a(paramIntent);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131369088));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131376876));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131369073));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131369056));
    ...
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_Birg.d.findViewById(2131379121);
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379119));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379122));
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131379117);
    this.jdField_b_of_type_AndroidViewView.setOnClickListener(new bint(this));
  ...
  public void a(Intent paramIntent, String paramString)
  {
    ...
    int j = 0;
    if ((paramIntent == null) || (TextUtils.isEmpty(paramString)) || (this.jdField_a_of_type_Birj.jdField_a_of_type_Boolean)) {
      return;
    }
    Object localObject;
    if ((this.jdField_a_of_type_Birj.jdField_a_of_type_Long & 0x4) == 0L)
    {
      if (!birz.a()) {
        this.jdField_a_of_type_AndroidWidgetTextView.setText(BaseApplicationImpl.getApplication().getResources().getString(2131690559));
      }
    }
    else
    {
      ...
      this.jdField_a_of_type_Birj.j = paramIntent.getBooleanExtra("ishiderefresh", false);
      this.jdField_a_of_type_Birj.k = paramIntent.getBooleanExtra("ishidebackforward", false);
      boolean bool = paramIntent.getBooleanExtra("hide_left_button", false);
      this.jdField_a_of_type_Birj.l = paramIntent.getBooleanExtra("show_right_close_button", false);
      if (QLog.isColorLevel()) {
        QLog.d("QQBrowser", 2, "QQBrowser url=" + noe.b(paramString, new String[0]));
      }
      ...
      label224:
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131690551));
      if (!this.jdField_a_of_type_Birj.jdField_e_of_type_Boolean)
      {
        this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
        localObject = this.jdField_a_of_type_AndroidWidgetImageView.getResources().getDrawable(2130840295);
        if ((!this.jdField_a_of_type_Birg.jdField_a_of_type_Birj.jdField_b_of_type_Boolean) && (!this.jdField_a_of_type_Birj.m)) {
          break label700;
        }
        paramString = bhmq.a((Drawable)localObject, -1);
        label306:
        this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(paramString);
        this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131692394));
        j();
      }
      if (b())
      {
    ...
    label844:
    label857:
    for (int i = ImmersiveUtils.getStatusBarHeight(this.jdField_a_of_type_Birg.jdField_a_of_type_AndroidAppActivity) + 0;; i = 0)
    {
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_Birj.p)
        {
          ...
          label506:
          if (this.jdField_a_of_type_Birj.l) {
            a(paramIntent.getStringExtra("left_close_button_text"));
          }
          if (TextUtils.isEmpty(this.jdField_a_of_type_Birj.jdField_a_of_type_JavaLangString)) {
            break label844;
          }
        }
        try
        {
          paramIntent = new JSONObject(URLDecoder.decode(this.jdField_a_of_type_Birj.jdField_a_of_type_JavaLangString));
          i = k;
          ...
          for (paramIntent = paramIntent.getJSONArray("subTextArray");; paramIntent = null)
          {
            ...
            if (this.jdField_a_of_type_Birj.jdField_a_of_type_ComTencentMobileqqWebviewWebViewTitleStyle == null) {
              break label306;
            }
            paramString = bhmq.a((Drawable)localObject, this.jdField_a_of_type_Birj.jdField_a_of_type_ComTencentMobileqqWebviewWebViewTitleStyle.jdField_e_of_type_Int);
            break label306;
            label732:
            if (this.jdField_a_of_type_Birj.jdField_a_of_type_ComTencentMobileqqWebviewWebViewTitleStyle == null) {
              break label372;
            }
            c(this.jdField_a_of_type_Birj.jdField_a_of_type_ComTencentMobileqqWebviewWebViewTitleStyle.jdField_e_of_type_Int);
            break label372;
            m = this.jdField_a_of_type_AndroidViewViewGroup.getTop();
            n = this.jdField_a_of_type_AndroidViewViewGroup.getBottom();
          ...
          a(new binx(this.jdField_a_of_type_Birj.jdField_a_of_type_Int, i, null, null, paramString));
        }
  ...
  public void a(View paramView, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    bhtd localbhtd = new bhtd(Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), new binu(this, paramView, paramInt2));
    localbhtd.setDuration(paramInt3);
    this.jdField_a_of_type_Birj.x = true;
    paramView.startAnimation(localbhtd);
  }
  ...
  public void a(binx parambinx)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWebviewUiWebViewTopTabView.setOnCheckedChangeListener(new binw(this));
  ...
  public void a(biny parambiny)
  {
    Object localObject1;
    Object localObject2;
    boolean bool;
    if ((parambiny != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewUiWebViewTopTabView != null))
    {
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqWebviewUiWebViewTopTabView;
      localObject2 = parambiny.jdField_a_of_type_ArrayOfInt;
      if (parambiny.jdField_a_of_type_Int != 1) {
        break label56;
      }
      bool = true;
      ((WebViewTopTabView)localObject1).setRedHotStatus((int[])localObject2, bool);
      localObject2 = this.jdField_a_of_type_Birg.a();
      if (localObject2 != null) {
        break label61;
      }
    }
    for (;;)
    {
      ...
      try
      {
        for (;;)
        {
          ...
          if (TextUtils.isEmpty(parambiny.jdField_a_of_type_JavaLangString)) {
            break;
          }
          ((TouchWebView)localObject2).callJs(parambiny.jdField_a_of_type_JavaLangString, new String[] { ((JSONObject)localObject3).toString() });
          return;
          try
          {
  ...
  public void a(TouchWebView paramTouchWebView)
  {
    ...
    if ((this.jdField_a_of_type_Birj.s) && (localViewGroup != null) && (!this.jdField_a_of_type_Birj.w) && (a()))
    {
      this.jdField_a_of_type_Birj.w = true;
      this.jdField_a_of_type_Birj.t = true;
      this.jdField_a_of_type_Birj.v = true;
      localViewGroup.setBackgroundResource(2130850817);
      if (ThemeUtil.isNowThemeIsNight(BaseApplicationImpl.getApplication().getRuntime(), false, null)) {
        this.jdField_a_of_type_AndroidWidgetImageView.setBackgroundDrawable(null);
      }
      paramTouchWebView.setOnScrollChangedListenerForBiz(new binv(this));
    }
  }
  ...
  public void a(TouchWebView paramTouchWebView, boolean paramBoolean1, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean2, String paramString1, String paramString2, String paramString3)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_AndroidViewAnimationAnimation = new bhtd(Integer.valueOf(paramInt2), Integer.valueOf(paramInt3), this.jdField_a_of_type_Bhtj);
      ...
      this.jdField_b_of_type_AndroidViewAnimationAnimation = new bhtd(Integer.valueOf(paramInt3), Integer.valueOf(paramInt2), this.jdField_a_of_type_Bhtj);
  ...
  {
    if ((this.jdField_a_of_type_AndroidViewViewGroup == null) || (this.jdField_a_of_type_Birj.jdField_a_of_type_Boolean)) {}
    do
    {
      return;
      localObject = (RelativeLayout)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131378993);
    } while (localObject == null);
    paramWebView = (TextView)((RelativeLayout)localObject).findViewById(2131379036);
    Object localObject = (TextView)((RelativeLayout)localObject).findViewById(2131378968);
    if (paramBoolean)
    {
  ...
  public void a(String paramString1, String paramString2, String paramString3, boolean paramBoolean, int paramInt1, int paramInt2, JsBridgeListener paramJsBridgeListener, View.OnClickListener paramOnClickListener, admy paramadmy)
  {
    if ((paramJsBridgeListener != null) && (paramJsBridgeListener.jdField_a_of_type_Boolean)) {}
    for (int i = 1; paramBoolean; i = 0)
    {
      this.jdField_a_of_type_Birj.jdField_e_of_type_Boolean = true;
      this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      ...
      if (paramInt1 == 0)
      {
        ...
        try
        {
          ...
          if ((paramString1 != null) && (i == 0))
          {
            ...
            if (this.jdField_a_of_type_Birj.jdField_a_of_type_OrgJsonJSONObject.has("txtclr"))
            {
              paramString2 = this.jdField_a_of_type_Birj.jdField_a_of_type_OrgJsonJSONObject.optString("txtclr", "");
              if (!TextUtils.isEmpty(paramString2))
              {
          ...
          try
          {
            ...
            paramString1 = bhmq.a(this.jdField_a_of_type_AndroidWidgetImageView.getDrawable(), paramInt1);
    ...
    this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
    if ((this.jdField_a_of_type_Birg.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment == null) || (!(this.jdField_a_of_type_Birg.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment instanceof TeamWorkDocEditBrowserActivity.TeamWorkDocEditBrowserFragment)))
    {
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      j();
    }
    paramString3 = this.jdField_a_of_type_Birj;
    if (paramInt1 != 4)
    {
      paramBoolean = true;
      label457:
      ...
      default: 
        ...
        if (paramInt1 != 0)
        {
          if (this.jdField_b_of_type_AndroidWidgetImageView == null)
          {
            ...
            paramString3 = (RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131376875);
            paramString3 = new RelativeLayout.LayoutParams(-2, -2);
            paramString3.addRule(7, 2131369056);
            paramString3.addRule(6, 2131369056);
    ...
    for (;;)
    {
      ...
      paramBoolean = false;
      break label457;
      this.jdField_a_of_type_Birg.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130843832, 2130843831);
      this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(bhmq.a(this.jdField_a_of_type_AndroidWidgetImageView.getResources().getDrawable(2130843832), this.jdField_a_of_type_AndroidWidgetImageView.getResources().getColor(2131166987)));
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131692391));
      break label597;
      this.jdField_a_of_type_Birg.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130843830, 2130843830);
      ...
      break label597;
      this.jdField_a_of_type_Birg.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130840295, 2130840295);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131692392));
      break label597;
      this.jdField_a_of_type_Birg.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130839377, 2130839377);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131692394));
      break label597;
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130843875);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131692395));
      ((AnimationDrawable)this.jdField_a_of_type_AndroidWidgetImageView.getDrawable()).start();
      break label597;
      this.jdField_a_of_type_Birg.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130842491, 2130842494);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131689551));
      break label597;
      this.jdField_a_of_type_Birg.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130850135, 2130850139);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131689551));
      break label597;
      this.jdField_a_of_type_Birg.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130838914, 2130838914);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131692393));
      break label597;
      this.jdField_a_of_type_Birg.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130850312, 2130850312);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131692393));
      break label597;
      this.jdField_a_of_type_Birg.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130846361, 2130846360);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131692393));
      break label597;
      ...
      localLayoutParams.rightMargin = bhtq.b(10.0F);
      paramString3.setLayoutParams(localLayoutParams);
      break label597;
      this.jdField_a_of_type_Birg.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130840295, 2130840295);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131717964));
      break label597;
      this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130843653);
      break label793;
  ...
  public void a(JSONObject paramJSONObject, boolean paramBoolean)
  {
    ...
    try
    {
      if ((paramJSONObject.length() > 0) && (!this.jdField_a_of_type_Birj.w))
      {
        this.jdField_a_of_type_Birj.w = a();
        if ((this.jdField_a_of_type_Birj.C) && (this.jdField_a_of_type_Birg.jdField_c_of_type_AndroidViewView != null)) {
          this.jdField_a_of_type_Birg.jdField_c_of_type_AndroidViewView.setPadding(0, (int)bhmg.a(BaseApplicationImpl.getApplication(), 30.0F), 0, 0);
        }
      }
      if (paramJSONObject == null) {
        return;
    ...
    catch (Exception paramJSONObject)
    {
      ...
      while (QLog.isColorLevel())
      {
        ...
        this.jdField_a_of_type_Birj.jdField_d_of_type_Int = j;
        return;
        continue;
        i = -1;
        continue;
    ...
    if ((this.jdField_a_of_type_Birg.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (this.jdField_a_of_type_Birg.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mSystemBarComp != null))
    {
      ...
      {
        this.jdField_a_of_type_Birg.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mSystemBarComp.setBackgroundColor(i);
        bdgb.a(true, i, this.jdField_a_of_type_Birg.jdField_a_of_type_AndroidAppActivity.getWindow());
      }
    }
    else
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject2))
      {
        ...
        {
          localObject1 = bhmq.a(this.jdField_a_of_type_ComTencentWidgetFadeIconImageView.getDrawable(), i);
        ...
        localObject1 = bhmq.a(this.jdField_a_of_type_AndroidWidgetTextView.getBackground(), i);
        if (localObject1 != null) {
          this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundDrawable((Drawable)localObject1);
        }
        localObject1 = bhmq.a(this.jdField_a_of_type_AndroidWidgetImageView.getDrawable(), i);
        if (localObject1 != null)
        {
          this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject1);
          c(i);
        }
        localObject1 = this.jdField_c_of_type_AndroidViewView.findViewById(2131371182);
        localObject2 = bhmq.a(((View)localObject1).getBackground(), i);
        if (localObject2 != null) {
        ...
        {
          if ((TextUtils.isEmpty(this.jdField_b_of_type_AndroidWidgetTextView.getText())) && (!TextUtils.isEmpty(this.jdField_a_of_type_Birg.jdField_a_of_type_JavaLangString))) {
            this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Birg.jdField_a_of_type_JavaLangString);
          }
          ...
          if ((paramBoolean) && (i > 0))
          {
            a(localViewGroup, this.jdField_a_of_type_Birj.jdField_d_of_type_Int, j, i);
            return;
          }
        }
      }
  ...
  {
    this.jdField_a_of_type_Birj.v = paramBoolean;
  ...
  public boolean a()
  {
    if ((!this.jdField_a_of_type_Birg.jdField_a_of_type_Birj.jdField_b_of_type_Boolean) && (!this.jdField_a_of_type_Birj.m) && (this.jdField_a_of_type_AndroidViewViewGroup != null) && (this.jdField_a_of_type_Birg.d != null) && (Build.VERSION.SDK_INT >= 17))
    {
      Object localObject1 = (TextView)this.jdField_a_of_type_Birg.d.findViewById(2131363682);
      if (localObject1 != null)
      {
      ...
      localObject1 = this.jdField_a_of_type_Birg.d.findViewById(2131381335);
      Object localObject2 = (FrameLayout.LayoutParams)((View)localObject1).getLayoutParams();
      if (localObject2 != null)
      {
        ((FrameLayout.LayoutParams)localObject2).topMargin -= BaseApplicationImpl.getApplication().getResources().getDimensionPixelSize(2131299018);
  ...
  public void b()
  {
    if (this.jdField_a_of_type_Birj.E)
    {
      if ((!this.jdField_a_of_type_Birj.jdField_b_of_type_Boolean) && (!this.jdField_a_of_type_Birj.m))
      {
        Resources localResources = this.jdField_a_of_type_Birg.jdField_a_of_type_AndroidAppActivity.getResources();
        this.jdField_a_of_type_AndroidViewViewGroup.setBackgroundColor(localResources.getColor(2131167212));
        if ((this.jdField_a_of_type_Birg.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (this.jdField_a_of_type_Birg.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mSystemBarComp != null)) {
          this.jdField_a_of_type_Birg.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mSystemBarComp.setBackgroundColor(0);
        }
      }
      this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(-1);
      this.jdField_c_of_type_AndroidWidgetTextView.setTextColor(-1);
      this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-1);
      this.jdField_a_of_type_Birg.a(this.jdField_a_of_type_AndroidWidgetTextView, true, 2130850113, 2130850668);
      this.jdField_a_of_type_Birg.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130840295, 2130840291);
    }
  }
  ...
  public void b(int paramInt)
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_Birg.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (this.jdField_a_of_type_Birg.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mSystemBarComp != null)) {
        this.jdField_a_of_type_Birg.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mSystemBarComp.getBackground().mutate().setAlpha(paramInt);
      }
  ...
  public void b(String paramString)
  {
    ...
    paramString = this.jdField_a_of_type_Birg.a();
  ...
  public boolean b()
  {
    if ((this.jdField_a_of_type_Birg.a() == null) || (this.jdField_a_of_type_Birg.a().getPluginEngine() == null)) {}
    WebViewPlugin localWebViewPlugin;
    do
    {
      return false;
      localWebViewPlugin = this.jdField_a_of_type_Birg.a().getPluginEngine().a(45, false);
    } while (((localWebViewPlugin instanceof UiApiPlugin)) && (((UiApiPlugin)localWebViewPlugin).g));
    if ((this.jdField_a_of_type_Birj.F) || (this.jdField_a_of_type_Birj.G)) {}
  ...
  public boolean b(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      this.jdField_a_of_type_AndroidViewViewGroup.setVisibility(0);
      if (!this.jdField_a_of_type_Birg.jdField_a_of_type_Birj.jdField_a_of_type_Boolean) {
        this.jdField_a_of_type_Birg.jdField_a_of_type_AndroidAppActivity.getWindow().clearFlags(1024);
      }
    }
    for (;;)
    {
      ...
      b(0);
      this.jdField_a_of_type_AndroidViewViewGroup.setVisibility(8);
      this.jdField_a_of_type_Birg.jdField_a_of_type_AndroidAppActivity.getWindow().addFlags(1024);
    }
  }
  ...
  public void c(int paramInt)
  {
    if (b())
    {
      View localView = this.jdField_c_of_type_AndroidViewView.findViewById(2131371182);
      localView.setBackgroundDrawable(bhmq.a(localView.getBackground(), paramInt));
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Birg.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null)
    {
      if ((paramBoolean) && (b()))
      {
        this.jdField_a_of_type_Birg.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mBusiID = 100;
        this.jdField_a_of_type_Birg.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.initNativeMiniAIOUser();
        this.jdField_a_of_type_Birg.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.setMiniAIOEntry(true);
      }
    }
    else {
      return;
    }
    this.jdField_a_of_type_Birg.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.setMiniAIOEntry(false);
  }
  ...
  public void f(int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentWidgetFadeIconImageView != null) && (this.jdField_a_of_type_ComTencentWidgetFadeIconImageView.getVisibility() == 0))
    {
      localDrawable1 = bhmq.a(this.jdField_a_of_type_ComTencentWidgetFadeIconImageView.getDrawable(), paramInt);
    ...
    if (localDrawable2 != null)
    {
      ...
      localDrawable2 = bhmq.a(localDrawable2, paramInt);
      if (localDrawable2 != null) {
    ...
    if (localDrawable1 != null)
    {
      ...
      localDrawable1 = bhmq.a(localDrawable1, paramInt);
      if (localDrawable1 != null)
      {
  ...
  public void g()
  {
    this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(BaseApplicationImpl.getApplication().getResources().getColorStateList(2131166984));
    this.jdField_c_of_type_AndroidWidgetTextView.setTextColor(BaseApplicationImpl.getApplication().getResources().getColorStateList(2131166984));
    this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(BaseApplicationImpl.getApplication().getResources().getColor(2131166987));
    Object localObject;
    if (this.jdField_a_of_type_AndroidWidgetImageView != null)
    {
    ...
    if (c())
    {
      localObject = this.jdField_c_of_type_AndroidViewView.findViewById(2131371182);
  ...
  {
    this.jdField_a_of_type_Birj.jdField_a_of_type_Int = paramInt;
    if (this.jdField_a_of_type_ComTencentMobileqqWebviewUiWebViewTopTabView != null) {
  ...
  public void h()
  {
    ...
    {
      return;
      if ((this.jdField_a_of_type_Birj.v) && (this.jdField_a_of_type_Birj.u))
      {
        this.jdField_a_of_type_Birj.u = false;
        this.jdField_a_of_type_Birj.u = true;
        this.jdField_a_of_type_AndroidViewViewGroup.setBackgroundResource(2130850817);
        this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-1);
        return;
      }
    } while ((this.jdField_a_of_type_Birj.v) || (!this.jdField_a_of_type_Birj.u));
    this.jdField_a_of_type_Birj.u = false;
    this.jdField_a_of_type_Birj.u = true;
    this.jdField_a_of_type_AndroidViewViewGroup.setBackgroundColor(BaseApplicationImpl.getApplication().getResources().getColor(2131167048));
    g();
  }
