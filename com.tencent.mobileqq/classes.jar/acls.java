...
public abstract class acls
{
  ...
  public static acls a(String paramString, JSONObject paramJSONObject)
  {
    if ("dex".equals(paramString))
    {
      ...
      do
      {
        ...
        if (PatchCommonUtil.isDalvik()) {
          return new aclv(paramJSONObject);
        }
        if (PatchCommonUtil.isArtLM()) {
          return new aclu(paramJSONObject);
        }
      } while (!PatchCommonUtil.isArtGeN());
      return new aclt(paramJSONObject);
    }
    if ("Native".equals(paramString)) {
      return new aclw(paramJSONObject);
    }
