  ...
  implements com.tencent.mobileqq.app.BusinessObserver, mqq.observer.BusinessObserver
{
  ...
  private void onUpdate_getTroopTag(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    onGetTroopTagResult(paramBoolean, paramObject);
  }
  ...
  private void onUpdate_notifyGetAllRobot(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    onGetAllRobots(paramBoolean, ((Integer)paramObject[0]).intValue(), ((Long)paramObject[1]).longValue(), (bfdk)paramObject[2]);
  }
  ...
  private void onUpdate_notifyGetHomeworkInfo(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    if ((paramObject instanceof Object[]))
    {
      ...
      if (paramObject.length > 0) {
        localObject1 = (behv)paramObject[0];
      }
    }
    onGetHomeworkInfo(paramBoolean, (behv)localObject1);
  }
  ...
  private void onUpdate_notifyHWTroopClassInfoChange(int paramInt, boolean paramBoolean, Object paramObject)
  {
    if (paramInt != 154) {
      return;
    }
    onUpdateTroopAIOTips();
  }
  ...
  private void onUpdate_notifyTroopEnterEffectPush(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    onPushTroopEnterEffect((bedr)paramObject);
  }
  ...
  private void onUpdate_notify_QueryJoinTroopCanNoVerify(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    onQueryJoinTroopCanNoVerify(paramBoolean, ((Integer)paramObject[0]).intValue(), (String)paramObject[1], (String)paramObject[2], (String)paramObject[3]);
  }
  ...
  private void onUpdate_troopLink(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    onTroopShareLink(paramBoolean, (bfli)paramObject);
  }
  ...
  public void onUpdate(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    onUpdate_notifyHWTroopClassInfoChange(paramInt, paramBoolean, paramObject);
