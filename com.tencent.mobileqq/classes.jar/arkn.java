...
public class arkn
  extends QIPCModule
{
  private static volatile arkn a;
  
  public arkn(String paramString)
  {
    super(paramString);
  }
  
  public static arkn a()
  {
    if (a == null) {}
    try
    {
      if (a == null) {
        a = new arkn("TogetherBusinessIPCModule");
      }
      return a;
    }
    finally {}
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if ("action_open_identify".equals(paramString)) {
      TogetherBusinessServlet.a("QQAIOMediaSvc.open_identify", (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramBundle, new arko(this, paramInt));
    }
    do
    {
      boolean bool2;
      do
      {
        do
        {
          ...
          {
            TogetherBusinessServlet.a("QQAIOMediaSvc.open_start", (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramBundle, new arko(this, paramInt));
            return null;
          }
        ...
        arkp.a(bool1, paramString, paramInt, bool2);
        if (QLog.isColorLevel()) {
          QLog.d("TogetherBusinessIPCModule", 2, "ACTION_SET_FLOATING " + " isShow=" + bool1 + " uin=" + paramString + " sessionType=" + paramInt + " refresh=" + bool2);
        }
      } while (!bool2);
      paramBundle = (aync)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(339);
