...
public class pgk
{
  ...
  public static float a(Context paramContext, sey paramsey)
  {
    int j = 28;
    int i;
    if (paramsey != null)
    ...
    for (;;)
    {
      return bgln.b(paramContext) - bggq.a(paramContext, i);
      label56:
      if ((paramsey.a != null) && (paramsey.a.mChannelID == 56L))
      {
        i = j;
        if (pha.u()) {}
      }
  ...
  public static float a(android.view.View paramView)
  {
    ...
    //   5: monitorenter
    //   6: aload_0
    //   7: getstatic 31	pgk:jdField_a_of_type_AndroidGraphicsRect	Landroid/graphics/Rect;
    ...
    //   18: istore_3
    //   19: getstatic 31	pgk:jdField_a_of_type_AndroidGraphicsRect	Landroid/graphics/Rect;
    //   22: getfield 97	android/graphics/Rect:top	I
    //   25: ifne +24 -> 49
    //   28: getstatic 31	pgk:jdField_a_of_type_AndroidGraphicsRect	Landroid/graphics/Rect;
    ...
    //   47: fload_1
    //   48: freturn
    //   49: getstatic 31	pgk:jdField_a_of_type_AndroidGraphicsRect	Landroid/graphics/Rect;
    //   52: getfield 97	android/graphics/Rect:top	I
    //   55: ifle +22 -> 77
    //   58: ldc 84
    //   60: iload_3
    //   61: getstatic 31	pgk:jdField_a_of_type_AndroidGraphicsRect	Landroid/graphics/Rect;
    ...
    //   77: fload_2
    //   78: fstore_1
    //   79: getstatic 31	pgk:jdField_a_of_type_AndroidGraphicsRect	Landroid/graphics/Rect;
    //   82: getfield 100	android/graphics/Rect:bottom	I
    //   85: ifle -41 -> 44
    //   88: fload_2
    //   89: fstore_1
    //   90: getstatic 31	pgk:jdField_a_of_type_AndroidGraphicsRect	Landroid/graphics/Rect;
    //   93: getfield 100	android/graphics/Rect:bottom	I
    //   96: iload_3
    //   97: if_icmpge -53 -> 44
    //   100: getstatic 31	pgk:jdField_a_of_type_AndroidGraphicsRect	Landroid/graphics/Rect;
  ...
  {
    return (paramInt - (afur.a(24.0F, paramResources) + afur.a(3.0F, paramResources))) / 2;
  }
  ...
  {
    Resources localResources = BaseApplicationImpl.getApplication().getResources();
    int i = afur.a(1.5F, localResources);
    if (paramInt2 == 56) {
      i = afur.a(3.0F, localResources);
    }
    ...
    {
      f1 = localbmqe.a;
      f2 = localbmqe.jdField_b_of_type_Float;
      paramInt2 = afur.a(localbmqe.jdField_b_of_type_Int, localResources);
    }
    for (;;)
    {
      switch (paramInt1)
      ...
      for (paramInt1 = (int)((localResources.getDisplayMetrics().widthPixels - afur.a(6, localResources) - i * 2) / 2.1F);; paramInt1 = paramInt2)
      {
        i = (int)(paramInt1 / f2);
        paramInt2 = paramInt1;
        paramInt1 = i;
        for (;;)
        {
          ...
          paramInt2 = localResources.getDisplayMetrics().widthPixels - afur.a(12, localResources);
          paramInt1 = (int)((localResources.getDisplayMetrics().widthPixels - afur.a(6, localResources) - i * 2) / 2.5F * 1.3356F);
          continue;
          paramInt2 = (int)((localResources.getDisplayMetrics().widthPixels - afur.a(12, localResources) - i) * 0.5F);
  ...
  public static String a(String paramString)
  {
    ...
    do
    {
      return str;
      str = paramString;
    } while (!bdol.a(paramString));
    paramString = new StringBuilder(paramString);
    int i = 0;
    while (i < bdnh.a.length)
    {
      str = bdnh.a[i];
      int j = -1;
      for (;;)
  ...
  {
    a(paramImageView, pha.a(paramString), paramContext);
  }
  ...
  public static void a(ImageView paramImageView, URL paramURL, Context paramContext)
  {
    if (paramURL == null)
    {
      ...
      paramImageView.setImageResource(2130841680);
      return;
    }
    ...
    for (Object localObject = (BaseActivity)paramContext;; localObject = null)
    {
      ...
      {
        if ((!bgnt.h(paramContext)) && (bool) && (!tdv.a().a(paramURL)))
        {
          paramImageView.setImageResource(2130841680);
          return;
        }
        localObject = URLDrawable.URLDrawableOptions.obtain();
        ((URLDrawable.URLDrawableOptions)localObject).mLoadingDrawable = paramContext.getResources().getDrawable(2130841680);
        ((URLDrawable.URLDrawableOptions)localObject).mFailedDrawable = paramContext.getResources().getDrawable(2130841680);
  ...
  public static void a(KandianUrlImageView paramKandianUrlImageView, URL paramURL, Context paramContext, boolean paramBoolean)
  {
    if (paramURL == null)
    {
      ...
      paramKandianUrlImageView.setImageResource(2130841680);
      return;
    }
    ...
    if (!paramBoolean)
    {
      ...
      {
        paramKandianUrlImageView.setImagePlaceHolder(paramContext.getResources().getDrawable(2130840393)).setImage(paramURL);
        return;
      }
      paramKandianUrlImageView.setImagePlaceHolder(paramContext.getResources().getDrawable(2130841680)).setImage(paramURL);
      return;
    }
  ...
  public static void a(ViewBase paramViewBase, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    pxh localpxh = pmh.a().a();
    if ((localpxh != null) && (localpxh.b()))
    {
    ...
    {
      a(true, paramViewBase, localpxh);
      return;
    }
    if ((localpxh != null) && (localpxh.a()))
    {
      a(true, paramViewBase, localpxh);
  ...
  public static void a(boolean paramBoolean, ViewBase paramViewBase, pxh parampxh)
  {
  ...
  private static boolean a(Context paramContext)
  {
    ...
    for (paramContext = (BaseActivity)paramContext;; paramContext = null)
    {
      if (paramContext != null)
      {
        ...
        for (String str = paramContext.app.getCurrentAccountUin();; str = pha.a()) {
  ...
  {
    return (a(paramContext)) && (!bgnt.h(paramContext)) && (!tdv.a().a(paramURL));
  }
  ...
  public static boolean a(sey paramsey)
  {
    ...
    return a(paramsey.c, paramsey.d);
  }
  
  public static Pair<Integer, Integer> b()
  {
    Resources localResources = BaseApplicationImpl.getApplication().getResources();
    int i = (localResources.getDisplayMetrics().widthPixels - afur.a(3.0F, localResources)) / 2;
  ...
  {
    Resources localResources = BaseApplicationImpl.getApplication().getResources();
    int i = (localResources.getDisplayMetrics().widthPixels - afur.a(3.0F, localResources)) / 3;
