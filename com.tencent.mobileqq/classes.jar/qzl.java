...
public final class qzl
{
  ...
  public static final qzl a;
  
  static
  {
    jdField_a_of_type_Qzl = new qzl();
  ...
  public static final RIJRewardTask a(@NotNull String paramString)
  {
    ...
    str3 = jdField_a_of_type_Qzl.a().getString(str3, "");
    int j = jdField_a_of_type_Qzl.a().getInt(str1, 0);
    int k = jdField_a_of_type_Qzl.a().getInt(str2, 0);
    int m = jdField_a_of_type_Qzl.a().getInt(paramString, 0);
  ...
  public static final void a(@NotNull String paramString, @Nullable RIJRewardTask paramRIJRewardTask)
  {
    ...
    SharedPreferences.Editor localEditor = jdField_a_of_type_Qzl.a().edit();
