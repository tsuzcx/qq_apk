  ...
  implements Handler.Callback
{
  ...
  private avuo jdField_a_of_type_Avuo;
  ...
  private List<avuq> jdField_a_of_type_JavaUtilList;
  ...
  public avur(GestureFrameLayout paramGestureFrameLayout, List<avuq> paramList, View.OnClickListener paramOnClickListener, avus paramavus)
  {
    ...
    this.jdField_a_of_type_Avus = paramavus;
    paramGestureFrameLayout.a().a().a().invert(this.jdField_a_of_type_AndroidGraphicsMatrix);
    this.jdField_a_of_type_Avuo = new avuo();
    this.jdField_a_of_type_Avuo.a(2131364910, this.jdField_a_of_type_AndroidContentContext.getString(2131691356), 2130838668);
    this.jdField_a_of_type_Avuo.a(2131366750, this.jdField_a_of_type_AndroidContentContext.getString(2131692835), 2130838677);
    this.jdField_a_of_type_Avuo.a(2131378200, this.jdField_a_of_type_AndroidContentContext.getString(2131699610), 2130838677);
    this.jdField_a_of_type_Avuo.a(this.jdField_a_of_type_AndroidViewView$OnClickListener);
    this.jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper(), this);
    if (avvh.a()) {}
    for (paramGestureFrameLayout = new avvh();; paramGestureFrameLayout = null)
    {
      this.jdField_a_of_type_Avvh = paramGestureFrameLayout;
      return;
    }
  }
  ...
  private void a(MotionEvent paramMotionEvent1, MotionEvent paramMotionEvent2)
  {
    ...
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      {
        avuq localavuq = (avuq)paramMotionEvent1.next();
        k = this.jdField_a_of_type_JavaUtilList.indexOf(localavuq);
        if (a(new Point(i, j), localavuq)) {
          a(localavuq, k);
        }
      }
    }
    ...
    if (this.jdField_a_of_type_AndroidGraphicsPoint != null)
    {
      ...
      while (paramMotionEvent1.hasNext())
      {
        paramMotionEvent2 = (avuq)paramMotionEvent1.next();
  ...
  private boolean a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, avuq paramavuq)
  {
    Point localPoint1 = (Point)paramavuq.jdField_a_of_type_JavaUtilList.get(0);
    Point localPoint2 = (Point)paramavuq.jdField_a_of_type_JavaUtilList.get(1);
    if (a(paramInt1, paramInt2, paramInt3, paramInt4, localPoint1.x, localPoint1.y, localPoint2.x, localPoint2.y)) {
      return true;
    }
    Point localPoint3 = (Point)paramavuq.jdField_a_of_type_JavaUtilList.get(2);
    paramavuq = (Point)paramavuq.jdField_a_of_type_JavaUtilList.get(3);
    if (a(paramInt1, paramInt2, paramInt3, paramInt4, localPoint3.x, localPoint3.y, paramavuq.x, paramavuq.y)) {
      return true;
    }
    return (a(paramInt1, paramInt2, paramInt3, paramInt4, localPoint2.x, localPoint2.y, localPoint3.x, localPoint3.y)) || (a(paramInt1, paramInt2, paramInt3, paramInt4, paramavuq.x, paramavuq.y, localPoint1.x, localPoint1.y));
  }
  
  private static boolean a(Point paramPoint, avuq paramavuq)
  {
    if ((paramPoint.y > paramavuq.e) || (paramPoint.y < paramavuq.g) || (paramPoint.x > paramavuq.d) || (paramPoint.x < paramavuq.f)) {}
    int i;
    do
    {
      Point localPoint1;
      ...
      {
        return false;
        if (paramavuq.jdField_a_of_type_Int % 90 < 1) {
          return true;
        }
        Point localPoint2 = (Point)paramavuq.jdField_a_of_type_JavaUtilList.get(0);
        localPoint1 = (Point)paramavuq.jdField_a_of_type_JavaUtilList.get(1);
        paramavuq = (Point)paramavuq.jdField_a_of_type_JavaUtilList.get(2);
        localPoint3 = a(localPoint2, localPoint1);
        i = a(localPoint3, a(localPoint2, paramPoint));
      } while ((i < 0) || (i > a(localPoint3, localPoint3)));
      paramavuq = a(localPoint1, paramavuq);
      i = a(paramavuq, a(localPoint1, paramPoint));
    } while (i < 0);
    if (i <= a(paramavuq, paramavuq)) {}
  ...
  private boolean a(MotionEvent paramMotionEvent, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      avuq localavuq = (avuq)paramMotionEvent.next();
      if (!a(new Point(j, k), localavuq)) {
        break label218;
      }
      if (!paramBoolean2)
      {
        if ((paramBoolean1) || (!localavuq.jdField_b_of_type_Boolean))
        {
          bool = true;
          localavuq.jdField_b_of_type_Boolean = bool;
          ...
          if (!localavuq.jdField_b_of_type_Boolean) {
            break label209;
          }
          i = 1;
          label184:
  ...
  public void a(MotionEvent paramMotionEvent)
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      {
        i = 1;
        azmj.b(null, "dc00898", "", "", "0X800AAEE", "0X800AAEE", i, 0, String.valueOf(this.jdField_a_of_type_Int), "0", "0", "");
      }
    }
    for (;;)
    {
  ...
  public void a(avuq paramavuq)
  {
    if (!this.jdField_a_of_type_Avuo.a())
    {
      Object localObject = (Point)paramavuq.jdField_a_of_type_JavaUtilList.get(0);
      paramavuq = (Point)paramavuq.jdField_a_of_type_JavaUtilList.get(1);
      ...
      localObject[0] = paramavuq.x;
      localObject[1] = paramavuq.y;
      ...
      this.jdField_a_of_type_Avuo.a(this.jdField_a_of_type_ComTencentMobileqqOcrViewGestureGestureFrameLayout, i, j);
    }
  }
  
  public void a(avuq paramavuq, int paramInt)
  {
    boolean bool = true;
    if (this.jdField_c_of_type_Int == -1)
    {
      if (paramavuq.jdField_b_of_type_Boolean)
      {
        paramInt = 2;
    ...
    for (;;)
    {
      if (bool != paramavuq.jdField_b_of_type_Boolean)
      {
        this.jdField_a_of_type_Int += 1;
        paramavuq.jdField_b_of_type_Boolean = bool;
        this.jdField_a_of_type_ComTencentMobileqqOcrViewGestureGestureFrameLayout.a(this.jdField_a_of_type_ComTencentMobileqqOcrViewGestureGestureFrameLayout);
  ...
  {
    this.jdField_a_of_type_Avvh.a(1);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    azmz.a(BaseApplication.getContext()).a(null, "actOcrGestureType", true, 0L, 0L, paramMessage, null);
