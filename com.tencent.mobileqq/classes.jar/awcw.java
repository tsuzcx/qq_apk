...
{
  private static awcw jdField_a_of_type_Awcw;
  ...
  private awcw(String paramString)
  {
    super(paramString);
  }
  ...
  {
    if (jdField_a_of_type_Awcw == null) {}
    try
    {
      if (jdField_a_of_type_Awcw == null) {
        jdField_a_of_type_Awcw = new awcw("JubaoIPCServer");
      }
      return jdField_a_of_type_Awcw;
    }
    finally {}
  }
  ...
  public void a(String paramString)
  {
    ...
    NewIntent localNewIntent = new NewIntent(localQQAppInterface.getApplication().getApplicationContext(), awcx.class);
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    paramString = a();
    paramBundle = new NewIntent(paramString.getApplication().getApplicationContext(), awcx.class);
