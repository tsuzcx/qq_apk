...
public class bbel
{
  ...
  bbds jdField_a_of_type_Bbds = null;
  ...
  public void a(Intent paramIntent)
  {
    ...
    do
    {
      ...
      axrl.a(BaseApplicationImpl.getApplication()).a(null, "jump_act_system_report", true, 0L, 0L, paramIntent, null);
    ...
    {
      str = this.jdField_a_of_type_Bbds.jdField_b_of_type_JavaLangString;
      paramIntent = this.jdField_a_of_type_Bbds.jdField_c_of_type_JavaLangString;
    }
    for (;;)
    {
      ...
      axrl.a(BaseApplicationImpl.getApplication()).a(null, "jump_act_business_report", true, 0L, 0L, (HashMap)localObject, null);
  ...
  public void a(QQAppInterface paramQQAppInterface, Activity paramActivity, Intent paramIntent)
  {
        ...
        do
        {
          do
          {
            do
            {
              ...
              Object localObject = bbei.a(paramActivity);
    ...
    this.jdField_a_of_type_Bbds = bbej.a(paramQQAppInterface, paramActivity, this.g);
  }
