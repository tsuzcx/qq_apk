  ...
  implements View.OnClickListener
{
  ...
  public bbel(Context paramContext, ExtendGridView paramExtendGridView)
  {
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_Int = 9;
    this.jdField_a_of_type_AndroidViewLayoutInflater = LayoutInflater.from(paramContext);
    this.jdField_a_of_type_ComTencentMobileqqTroopActivityExtendGridView = paramExtendGridView;
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = paramContext.getResources().getDrawable(2130847294);
    this.jdField_a_of_type_JavaLangCharSequence = BaseApplication.getContext().getText(2131696709);
    this.jdField_b_of_type_JavaLangCharSequence = BaseApplication.getContext().getResources().getText(2131718683);
  ...
  {
    int i = (int)bdcq.a(paramContext, 60.0F);
    int j = (int)bdcq.a(paramContext, 5.0F);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131559778, null);
      localbbem = new bbem();
      localbbem.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localView.findViewById(2131379336));
      localbbem.b = ((ImageView)localView.findViewById(2131368112));
      localbbem.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131376014));
      localView.setTag(localbbem);
      ...
      localbbem.jdField_a_of_type_ComTencentImageURLImageView.setScaleType(ImageView.ScaleType.FIT_XY);
      localbbem.jdField_a_of_type_ComTencentImageURLImageView.setImageResource(2130842141);
      localbbem.jdField_a_of_type_ComTencentImageURLImageView.setContentDescription(this.jdField_a_of_type_JavaLangCharSequence);
      localbbem.b.setVisibility(8);
    }
    label245:
    String str;
    label260:
    do
    {
      ...
      return localView;
      localbbem = (bbem)paramView.getTag();
      localView = paramView;
      break;
      paramView.width = i;
      paramView.height = i;
    ...
    if (i < 0)
    {
      ...
      label306:
      i = Math.min(100, i);
      localbbem.jdField_a_of_type_ComTencentImageURLImageView.setAdjustViewBounds(false);
    ...
    for (;;)
    {
      ...
      localbbem.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable(paramView);
      localbbem.jdField_a_of_type_ComTencentImageURLImageView.setContentDescription(this.jdField_b_of_type_JavaLangCharSequence);
      localbbem.b.setVisibility(0);
      localbbem.b.setTag(Integer.valueOf(paramInt));
      localbbem.b.setOnClickListener(this);
      localbbem.jdField_a_of_type_AndroidWidgetImageView.setImageBitmap(this.jdField_a_of_type_AndroidGraphicsBitmap);
      break;
      j = i;
      break label288;
      label469:
