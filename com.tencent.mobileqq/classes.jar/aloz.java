  ...
  extends alpd
{
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      try
      {
        paramToServiceMsg = bckz.a(l, paramFromServiceMsg.opt_msg_record.get().toByteArray(), paramFromServiceMsg.uint32_cur_cnt.get());
  ...
  private void f(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    paramToServiceMsg = (ambh)this.app.getManager(22);
    if (paramFromServiceMsg.getResultCode() != 1000)
    {
    ...
    if (bdin.a(this.app.getApplication().getApplicationContext()) == 1)
    {
  ...
  private void g(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (j == 1)
      {
        ...
        if (i == 1224)
        {
          bdne.j(this.app.getApplication().getApplicationContext(), this.app.getCurrentAccountUin(), (String)localObject2);
  ...
  {
    if ((paramToServiceMsg == null) || (paramFromServiceMsg == null)) {
      notifyUI(41, false, new Object[] { Integer.valueOf(2131696609) });
    }
    for (;;)
    {
      return;
    ...
    if (localObject != null) {
      ((amdu)localObject).j(paramObject.troopuin);
    }
    localObject = (bbqu)this.app.getManager(32);
    if (localObject != null) {
      ((bbqu)localObject).a(this.app, paramObject.troopuin);
    }
    ...
    notifyUI(41, true, new Object[] { Integer.valueOf(2131696616), paramToServiceMsg, paramFromServiceMsg, Boolean.valueOf(true) });
    return;
    label534:
  ...
  private void k(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      if (i != 0)
      {
        ...
        if (i == 1328) {
          paramToServiceMsg[2] = alud.a(2131701537);
        }
  ...
  public void a(String paramString1, int paramInt, @Nullable String paramString2)
  {
    ...
    if (bdne.a(this.app.getApplication(), this.app.getCurrentAccountUin()).contains(str))
    {
  ...
  public boolean a(String paramString, int paramInt)
  {
    ...
    if (i == 0)
    {
      QQToast.a(BaseApplication.getContext(), 2131696590, 0).b(BaseApplication.getContext().getResources().getDimensionPixelSize(2131298914));
      return false;
    }
      ...
      do
      {
        ...
        do
        {
          do
          {
            do
            {
              do
              {
                ...
                do
                {
                  do
                  {
                    do
                    {
                      do
                      {
                        ...
                        if (i == 2)
                        {
                          ((bcnu)this.app.getManager(48)).a(paramToServiceMsg, paramFromServiceMsg, paramObject);
                          return;
                        }
                        if (i == 3)
                        {
                  ...
                  paramToServiceMsg = (byte[])paramObject;
                  paramToServiceMsg = bcpa.a(this.app, i, l1, l2, l3, paramFromServiceMsg, j, paramToServiceMsg);
                ...
                {
                  bcpa.a(this.app, i, l1, l2, s, paramToServiceMsg, l3, paramFromServiceMsg, j);
                  return;
                }
                if ("OidbSvc.0x852_48".equals(localObject))
                {
                  bcpa.a(this.app, i, l1, l2, s, paramToServiceMsg, (short)k, bool);
                  return;
                }
              } while (!"OidbSvc.0x8ca_2".equals(localObject));
              ((amdu)this.app.a(20)).a(this.app, "" + l1, paramToServiceMsg, i);
              return;
            ...
            j = paramToServiceMsg.extraData.getInt("time");
            paramToServiceMsg = (byte[])paramObject;
            bcpa.a(this.app, i, l1, l2, l3, paramFromServiceMsg, j, paramToServiceMsg);
            return;
          ...
          paramToServiceMsg = (byte[])paramObject;
          paramToServiceMsg = bcpa.a(this.app, l1, l2, paramToServiceMsg, j, i, bool);
