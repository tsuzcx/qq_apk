...
{
  public int a;
  private final aljo jdField_a_of_type_Aljo = new aljo();
  ...
  private ArrayList<awbv> jdField_a_of_type_JavaUtilArrayList;
  ...
  private AccountObserver jdField_a_of_type_MqqObserverAccountObserver = new alpa(this);
  ...
  private ConcurrentHashMap<String, awbv> jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap(16);
  public boolean c;
  public int d;
  private ConcurrentHashMap<String, awbv> jdField_d_of_type_JavaUtilConcurrentConcurrentHashMap = new QQConcurrentHashMap(1011, 0, 400);
  private boolean jdField_d_of_type_Boolean;
  public int e;
  private ConcurrentHashMap<String, awbv> jdField_e_of_type_JavaUtilConcurrentConcurrentHashMap = new QQConcurrentHashMap(1012, 0, 400);
  private volatile boolean jdField_e_of_type_Boolean;
  public int f;
  private ConcurrentHashMap<String, Integer> jdField_f_of_type_JavaUtilConcurrentConcurrentHashMap;
  private boolean jdField_f_of_type_Boolean;
  public int g;
  private ConcurrentHashMap<String, ArrayList<awbv>> jdField_g_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap(4);
  ...
  public aloz(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Int = 3;
    this.jdField_b_of_type_Int = 30;
    this.jdField_c_of_type_Int = 7;
  ...
  private ConcurrentHashMap<String, ArrayList<awbv>> a(boolean paramBoolean)
  {
    label561:
    label564:
    label567:
  ...
  private void a(long paramLong, boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    for (paramString1 = "1";; paramString1 = "0")
    {
      ...
      localHashMap.put("param_WalSwitch", String.valueOf(alxk.a));
      azmz.a(BaseApplicationImpl.getContext()).a(null, "actFriendSqliteOpt", true, paramLong, 0L, localHashMap, null, false);
      return;
      str = "0";
      break;
    }
  ...
  private void a(Friends[] paramArrayOfFriends)
  {
    ...
    acex.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, BaseApplication.getContext(), localArrayList);
  }
  ...
  private void i()
  {
    anxb localanxb = anxb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    boolean bool = localanxb.a();
    if (QLog.isColorLevel()) {
      QLog.d("Q.contacttab.", 2, new Object[] { "doResetRingIdOfExtensionInfo: invoked. ", " hasResetGrayUserRingId: ", Boolean.valueOf(bool) });
    }
    if (!bool)
    {
      localanxb.a(this.jdField_d_of_type_JavaUtilConcurrentConcurrentHashMap);
      localanxb.a();
    }
  }
  ...
  private void j()
  {
    ??? = (ArrayList)this.jdField_a_of_type_Awbw.a(NoC2CExtensionInfo.class);
    if (??? != null)
    {
  ...
  private void k()
  {
    ...
    this.jdField_a_of_type_JavaUtilArrayList = ((ArrayList)this.jdField_a_of_type_Awbw.a(Groups.class, false, "group_id>=?", new String[] { "0" }, null, null, "seqid asc", null));
    Object localObject;
    if (this.jdField_a_of_type_JavaUtilArrayList != null)
    {
  ...
  public aljo a()
  {
    ...
    return this.jdField_a_of_type_Aljo;
  }
  
  public awby a()
  {
    return this.jdField_a_of_type_Awbw.a();
  }
  ...
  public Card a(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_b_of_type_AndroidSupportV4UtilMQLruCache)
      {
        ...
        if (??? == null)
        {
          ??? = (Card)this.jdField_a_of_type_Awbw.a(Card.class, paramString);
      ...
      {
        this.jdField_b_of_type_AndroidSupportV4UtilMQLruCache.put(paramString, ???);
        this.jdField_a_of_type_Awbw.a((awbv)???);
        if (l1 != 0L) {
  ...
  {
    return (ContactCard)this.jdField_a_of_type_Awbw.a(ContactCard.class, paramString);
  }
  ...
  public ExtensionInfo a(String paramString, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      localExtensionInfo = (ExtensionInfo)this.jdField_a_of_type_Awbw.a(ExtensionInfo.class, paramString);
      ??? = localExtensionInfo;
      if (localExtensionInfo == null) {
        break;
      }
  ...
  public Groups a(String paramString)
  {
    ...
    do
    {
      ...
      localGroups = (Groups)this.jdField_a_of_type_Awbw.a(Groups.class, paramString);
      localObject = localGroups;
    } while (localGroups == null);
    this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString, localGroups);
    this.jdField_a_of_type_JavaUtilArrayList = allu.a(this.jdField_a_of_type_JavaUtilArrayList, localGroups);
    return localGroups;
  }
  ...
  public KplCard a(String paramString)
  {
    ...
    for (;;)
    {
      paramString = (KplCard)this.jdField_a_of_type_Awbw.a(KplCard.class, paramString);
      if (l1 != 0L) {
        a(SystemClock.uptimeMillis() - l1, false, "query", "Card");
      }
      if (paramString != null) {
  ...
  public NoC2CExtensionInfo a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    if (localNoC2CExtensionInfo == null)
    {
      ...
      if (paramBoolean)
      {
        ...
        if (!this.jdField_e_of_type_Boolean)
        {
          paramString = (NoC2CExtensionInfo)this.jdField_a_of_type_Awbw.a(NoC2CExtensionInfo.class, "type=? and uin=?", new String[] { String.valueOf(paramInt), paramString });
          ??? = paramString;
          if (paramString != null) {
            synchronized (this.jdField_e_of_type_JavaUtilConcurrentConcurrentHashMap)
            {
  ...
  public ArrayList<awbv> a(int paramInt)
  {
    ArrayList localArrayList = new ArrayList();
  ...
  public ArrayList<awbv> a(String paramString)
  {
  ...
  public ConcurrentHashMap<String, ArrayList<awbv>> a()
  {
    return a(false);
  }
  ...
  public void a()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ((ArrayList)localObject1).add(localFriends);
        int i2 = bdbt.a(localFriends.detalStatusFlag, localFriends.iTermType);
        if ((i2 == 0) || (i2 == 6)) {
          continue;
        }
      ...
      if (this.jdField_a_of_type_JavaUtilArrayList != null)
      {
        ...
        while (((Iterator)localObject3).hasNext())
        {
          ...
          if (localObject4 != null) {
            Collections.sort((List)localObject4, allu.a);
          }
        }
      }
  ...
  public void a(int paramInt)
  {
    ...
    //   0: iconst_0
    //   1: istore_2
    //   2: new 822	java/lang/StringBuffer
    //   5: dup
    //   6: invokespecial 823	java/lang/StringBuffer:<init>	()V
    //   9: astore 6
    //   11: invokestatic 202	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   14: ifeq +19 -> 33
    //   17: aload 6
    //   19: ldc_w 825
    //   22: invokevirtual 828	java/lang/StringBuffer:append	(Ljava/lang/String;)Ljava/lang/StringBuffer;
    //   25: pop
    //   26: aload 6
    //   28: iload_1
    //   29: invokevirtual 831	java/lang/StringBuffer:append	(I)Ljava/lang/StringBuffer;
    //   32: pop
    //   33: aload_0
    //   34: iload_1
    //   35: invokevirtual 833	aloz:a	(I)Ljava/util/ArrayList;
    //   38: astore 5
    //   40: aconst_null
    //   41: astore_3
    //   42: aload_0
    //   43: getfield 162	aloz:jdField_a_of_type_Awbw	Lawbw;
    //   46: invokevirtual 594	awbw:a	()Lawby;
    //   49: astore 4
    //   51: aload 4
    //   53: astore_3
    //   54: aload_3
    //   55: invokevirtual 836	awby:a	()V
    //   58: aload 5
    //   60: invokevirtual 279	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   63: astore 4
    //   65: aload 4
    //   67: invokeinterface 228 1 0
    //   72: ifeq +115 -> 187
    //   75: aload 4
    //   77: invokeinterface 232 1 0
    //   82: checkcast 281	awbv
    //   85: checkcast 239	com/tencent/mobileqq/data/Friends
    //   88: astore 7
    //   90: aload 7
    //   92: iconst_0
    //   93: putfield 260	com/tencent/mobileqq/data/Friends:groupid	I
    //   96: aload_0
    //   97: aload 7
    //   99: invokevirtual 839	aloz:a	(Lcom/tencent/mobileqq/data/Friends;)Z
    //   102: pop
    //   103: invokestatic 202	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   106: ifeq -41 -> 65
    //   109: aload 6
    //   111: ldc_w 841
    //   114: invokevirtual 828	java/lang/StringBuffer:append	(Ljava/lang/String;)Ljava/lang/StringBuffer;
    //   117: pop
    //   118: aload 6
    //   120: aload 7
    //   122: getfield 404	com/tencent/mobileqq/data/Friends:uin	Ljava/lang/String;
    //   125: iconst_0
    //   126: iconst_4
    //   127: invokevirtual 845	java/lang/String:substring	(II)Ljava/lang/String;
    //   130: invokevirtual 828	java/lang/StringBuffer:append	(Ljava/lang/String;)Ljava/lang/StringBuffer;
    //   133: pop
    //   134: goto -69 -> 65
    //   137: astore 4
    //   139: invokestatic 202	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   142: ifeq +32 -> 174
    //   145: ldc_w 847
    //   148: iconst_2
    //   149: new 174	java/lang/StringBuilder
    //   152: dup
    //   153: invokespecial 175	java/lang/StringBuilder:<init>	()V
    //   156: ldc_w 849
    //   159: invokevirtual 183	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   162: iload_1
    //   163: invokevirtual 263	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   166: invokevirtual 188	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   169: aload 4
    //   171: invokestatic 851	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   174: aload_3
    //   175: ifnull +7 -> 182
    //   178: aload_3
    //   179: invokevirtual 853	awby:b	()V
    //   182: aload_0
    //   183: invokevirtual 514	aloz:a	()V
    //   186: return
    //   187: invokestatic 202	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   190: ifeq +15 -> 205
    //   193: ldc_w 847
    //   196: iconst_2
    //   197: aload 6
    //   199: invokevirtual 854	java/lang/StringBuffer:toString	()Ljava/lang/String;
    //   202: invokestatic 209	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   205: aload_0
    //   206: iconst_0
    //   207: invokestatic 494	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   210: invokevirtual 856	aloz:a	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/Groups;
    //   213: astore 4
    //   215: aload 4
    //   217: ifnull +26 -> 243
    //   220: aload 4
    //   222: aload 4
    //   224: getfield 289	com/tencent/mobileqq/data/Groups:group_friend_count	I
    //   227: aload 5
    //   229: invokevirtual 329	java/util/ArrayList:size	()I
    //   232: iadd
    //   233: putfield 289	com/tencent/mobileqq/data/Groups:group_friend_count	I
    //   236: aload_0
    //   237: aload 4
    //   239: invokevirtual 859	aloz:a	(Lawbv;)Z
    //   242: pop
    //   243: aload_0
    //   244: new 174	java/lang/StringBuilder
    //   247: dup
    //   248: invokespecial 175	java/lang/StringBuilder:<init>	()V
    //   251: iload_1
    //   252: invokevirtual 263	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   255: ldc_w 265
    //   258: invokevirtual 183	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   261: invokevirtual 188	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   264: invokevirtual 856	aloz:a	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/Groups;
    //   267: astore 4
    //   269: aload_0
    //   270: getfield 437	aloz:jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   273: ifnull +31 -> 304
    //   276: aload_0
    //   277: getfield 437	aloz:jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   280: new 174	java/lang/StringBuilder
    //   283: dup
    //   284: invokespecial 175	java/lang/StringBuilder:<init>	()V
    //   287: iload_1
    //   288: invokevirtual 263	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   291: ldc_w 265
    ...
    //   300: invokevirtual 862	java/util/concurrent/ConcurrentHashMap:remove	(Ljava/lang/Object;)Ljava/lang/Object;
    //   303: pop
    //   304: aload_0
    //   305: getfield 278	aloz:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   308: invokevirtual 863	java/util/ArrayList:clone	()Ljava/lang/Object;
    //   311: checkcast 271	java/util/ArrayList
    //   314: astore 5
    //   316: iload_2
    //   317: aload 5
    //   319: invokevirtual 329	java/util/ArrayList:size	()I
    //   322: if_icmpge +26 -> 348
    //   325: iload_1
    //   326: aload 5
    //   328: iload_2
    //   329: invokevirtual 485	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   332: checkcast 283	com/tencent/mobileqq/data/Groups
    //   335: getfield 286	com/tencent/mobileqq/data/Groups:group_id	I
    //   338: if_icmpne +41 -> 379
    //   341: aload 5
    //   343: iload_2
    //   344: invokevirtual 865	java/util/ArrayList:remove	(I)Ljava/lang/Object;
    //   347: pop
    //   348: aload_0
    //   349: aload 5
    //   351: putfield 278	aloz:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   354: aload_0
    //   355: getfield 162	aloz:jdField_a_of_type_Awbw	Lawbw;
    //   358: aload 4
    //   360: invokevirtual 867	awbw:b	(Lawbv;)Z
    //   363: pop
    //   364: aload_3
    //   365: invokevirtual 869	awby:c	()V
    //   368: aload_3
    //   369: ifnull -187 -> 182
    //   372: aload_3
    //   373: invokevirtual 853	awby:b	()V
    //   376: goto -194 -> 182
    //   379: iload_2
    //   380: iconst_1
    //   381: iadd
    ...
    //   391: ifnull +7 -> 398
    //   394: aload_3
    //   395: invokevirtual 853	awby:b	()V
    //   398: aload 4
    //   400: athrow
    //   401: astore 4
    //   403: goto -13 -> 390
  ...
  public void a(long paramLong)
  {
    ...
    do
    {
      ...
      i1 = bdbt.a(localFriends.detalStatusFlag, localFriends.iTermType);
    } while ((i1 != 0) && (i1 != 6));
  ...
  public void a(Groups paramGroups)
  {
    ...
    {
      this.jdField_a_of_type_Awbw.a(paramGroups);
    ...
    for (;;)
    {
      ...
      {
        if (i2 == 0) {
          this.jdField_a_of_type_JavaUtilArrayList = allu.a(this.jdField_a_of_type_JavaUtilArrayList, paramGroups);
        }
        a();
        return;
        this.jdField_a_of_type_Awbw.a(paramGroups);
  ...
  public void a(NearbyPeopleCard paramNearbyPeopleCard)
  {
    ...
    //   3: ifnull +34 -> 37
    //   6: aload_1
    //   7: getfield 888	com/tencent/mobileqq/data/NearbyPeopleCard:uin	Ljava/lang/String;
    //   10: invokestatic 463	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   13: ifne +24 -> 37
    //   16: aload_1
    //   17: getfield 891	com/tencent/mobileqq/data/NearbyPeopleCard:nickname	Ljava/lang/String;
    //   20: invokestatic 463	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   23: ifne +14 -> 37
    //   26: aload_1
    //   27: getfield 894	com/tencent/mobileqq/data/NearbyPeopleCard:lastUpdateNickTime	J
    //   30: lstore_2
    //   31: lload_2
    //   32: lconst_0
    //   33: lcmp
    ...
    //   38: monitorexit
    //   39: return
    //   40: new 693	com/tencent/mobileqq/data/DateNickNameInfo
    //   43: dup
    //   44: aload_1
    //   45: getfield 891	com/tencent/mobileqq/data/NearbyPeopleCard:nickname	Ljava/lang/String;
    //   48: aload_1
    //   49: getfield 894	com/tencent/mobileqq/data/NearbyPeopleCard:lastUpdateNickTime	J
    //   52: invokespecial 897	com/tencent/mobileqq/data/DateNickNameInfo:<init>	(Ljava/lang/String;J)V
    //   55: astore 4
    //   57: aload_0
    //   58: getfield 82	aloz:jdField_a_of_type_AndroidSupportV4UtilMQLruCache	Landroid/support/v4/util/MQLruCache;
    //   61: aload_1
    //   62: getfield 888	com/tencent/mobileqq/data/NearbyPeopleCard:uin	Ljava/lang/String;
    //   65: aload 4
    //   67: invokevirtual 615	android/support/v4/util/MQLruCache:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   70: pop
    //   71: goto -34 -> 37
    //   74: astore_1
    //   75: aload_0
          ...
          try
          {
            do
            {
              for (;;)
              {
                ...
                aupg.a(localSharedPreferences, this);
                return;
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    try
    {
      ...
      paramString = localawby;
      localObject = localawby;
      localawby.a();
      paramString = localawby;
      localObject = localawby;
      a(localFriends);
  ...
  public void a(String paramString, GetOnlineInfoResp paramGetOnlineInfoResp)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        awar.a(localFriends, paramGetOnlineInfoResp.vecMusicInfo, "AIO");
        if (QLog.isColorLevel()) {
        ...
        try
        {
          bdog.a().a(paramString);
          localCustomOnlineStatusMsg.mergeFrom(paramGetOnlineInfoResp.strCustomOnlineStatusDesc.getBytes());
          localFriends.customOnlineStatusType = bdoi.b(localCustomOnlineStatusMsg);
          localFriends.customOnlineStatus = bdoi.a(localCustomOnlineStatusMsg);
          localFriends.customModel = bdoi.b(localCustomOnlineStatusMsg);
  ...
  {
    NearbyPeopleCard localNearbyPeopleCard2 = (NearbyPeopleCard)this.jdField_a_of_type_Awbw.a(NearbyPeopleCard.class, "uin=?", new String[] { paramString1 });
  ...
  {
    byte b1 = 1;
    if ((ndv.a(paramByte1)) && (!bfua.b(paramByte1))) {
      return;
    }
    paramString1 = d(paramString1);
    ...
    if (paramArrayList != null)
    {
      ...
      while (paramArrayList.hasNext())
      {
        ...
        if (localFriends != null)
        {
          ...
          awar.a(localFriends, ((SimpleOnlineFriendInfo)localObject2).vecMusicInfo, "SimpleOnlie");
  ...
  {
    bhxr.a("queryFriends_" + paramList.size());
    if (paramList.size() > 0)
    {
      ...
      paramList = this.jdField_a_of_type_Awbw.a(Friends.class, true, ((StringBuilder)localObject).toString(), (String[])paramList.toArray(new String[paramList.size()]), null, null, null, null);
      if (paramList != null)
      {
        ...
        while (paramList.hasNext())
        {
          ...
          bfua.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (Friends)localObject);
        }
      }
    }
    bhxr.a();
  ...
  public void a(List<SpecialCareInfo> paramList, long paramLong, boolean paramBoolean)
  {
    ...
    for (int i1 = paramList.size();; i1 = 0)
    {
      ...
      Object localObject = this.jdField_a_of_type_Awbw.a();
      try
      {
        ((awby)localObject).a();
        i2 = i3;
        while (i2 < i1)
        {
          a((awbv)paramList.get(i2));
          i2 += 1;
        }
        if (paramBoolean)
        {
          paramList = ((SpecialCareInfo)SpecialCareInfo.class.newInstance()).getTableName();
          i1 = this.jdField_a_of_type_Awbw.a(paramList, "dateTime<" + paramLong, null);
          if (QLog.isColorLevel()) {
  ...
  public void a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    ...
    //   12: astore 6
    //   14: aload_0
    //   15: getfield 162	aloz:jdField_a_of_type_Awbw	Lawbw;
    //   18: invokevirtual 594	awbw:a	()Lawby;
    //   21: astore 7
    //   23: aload 7
    //   25: astore 6
    //   27: aload 6
    //   29: invokevirtual 836	awby:a	()V
    //   32: new 822	java/lang/StringBuffer
    //   35: dup
    //   36: invokespecial 823	java/lang/StringBuffer:<init>	()V
    //   39: astore 7
    //   41: invokestatic 202	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   44: ifeq +12 -> 56
    //   47: aload 7
    //   49: ldc_w 1244
    //   52: invokevirtual 828	java/lang/StringBuffer:append	(Ljava/lang/String;)Ljava/lang/StringBuffer;
    //   55: pop
    //   56: iconst_0
    //   57: istore_3
    //   58: iload_3
    ...
    //   73: iload 5
    //   75: baload
    //   76: invokestatic 494	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   79: invokevirtual 856	aloz:a	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/Groups;
    //   82: astore 8
    //   84: iload_3
    //   85: istore 4
    //   87: invokestatic 202	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   90: ifeq +70 -> 160
    //   93: iload_3
    //   94: istore 4
    //   96: aload 7
    //   98: ldc_w 1246
    //   101: invokevirtual 828	java/lang/StringBuffer:append	(Ljava/lang/String;)Ljava/lang/StringBuffer;
    //   104: pop
    //   105: iload_3
    //   106: istore 4
    //   108: aload 7
    ...
    //   111: iload 5
    //   113: baload
    //   114: invokevirtual 831	java/lang/StringBuffer:append	(I)Ljava/lang/StringBuffer;
    //   117: pop
    //   118: iload_3
    //   119: istore 4
    //   121: aload 7
    //   123: ldc_w 1248
    //   126: invokevirtual 828	java/lang/StringBuffer:append	(Ljava/lang/String;)Ljava/lang/StringBuffer;
    //   129: pop
    //   130: iload_3
    //   131: istore 4
    //   133: aload 7
    ...
    //   136: iload 5
    //   138: baload
    //   139: invokevirtual 831	java/lang/StringBuffer:append	(I)Ljava/lang/StringBuffer;
    //   142: pop
    //   143: aload 8
    ...
    //   151: aload 7
    //   153: ldc_w 1250
    //   156: invokevirtual 828	java/lang/StringBuffer:append	(Ljava/lang/String;)Ljava/lang/StringBuffer;
    //   159: pop
    //   160: iload_3
    //   161: istore 4
    //   163: aload 8
    ...
    //   169: istore 4
    //   171: aload 8
    //   173: getfield 1253	com/tencent/mobileqq/data/Groups:seqid	B
    //   176: aload_2
    //   177: iload 5
    //   179: baload
    //   180: if_icmpne +9 -> 189
    ...
    //   195: iload 5
    //   197: baload
    //   198: putfield 1253	com/tencent/mobileqq/data/Groups:seqid	B
    //   201: iconst_1
    //   202: istore_3
    //   203: iconst_1
    //   204: istore 4
    //   206: aload_0
    //   207: aload 8
    //   209: invokevirtual 859	aloz:a	(Lawbv;)Z
    //   212: pop
    //   213: iload_3
    //   214: istore 4
    //   216: goto +171 -> 387
    ...
    //   223: iload 4
    //   225: istore_3
    //   226: invokestatic 202	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   229: ifeq +33 -> 262
    //   232: ldc_w 847
    //   235: iconst_2
    //   236: new 174	java/lang/StringBuilder
    //   239: dup
    //   240: invokespecial 175	java/lang/StringBuilder:<init>	()V
    //   243: ldc_w 1255
    //   246: invokevirtual 183	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   249: aload_2
    //   250: invokevirtual 1258	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   253: invokevirtual 183	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   256: invokevirtual 188	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   259: invokestatic 209	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   262: aload_1
    //   263: ifnull +118 -> 381
    //   266: aload_1
    //   267: invokevirtual 853	awby:b	()V
    //   270: iload_3
    //   271: istore 4
    //   273: iload 4
    //   275: ifeq +7 -> 282
    //   278: aload_0
    //   279: invokevirtual 1260	aloz:d	()V
    //   282: return
    //   283: iload_3
    //   284: istore 4
    //   286: invokestatic 202	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   289: ifeq +18 -> 307
    //   292: iload_3
    //   293: istore 4
    //   295: ldc_w 847
    //   298: iconst_2
    //   299: aload 7
    //   301: invokevirtual 854	java/lang/StringBuffer:toString	()Ljava/lang/String;
    //   304: invokestatic 209	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   307: iload_3
    //   308: istore 4
    //   310: aload 6
    //   312: invokevirtual 869	awby:c	()V
    //   315: iload_3
    //   316: istore 4
    //   318: aload 6
    //   320: ifnull -47 -> 273
    //   323: aload 6
    //   325: invokevirtual 853	awby:b	()V
    //   328: iload_3
    //   329: istore 4
    //   331: goto -58 -> 273
    //   334: astore_1
    ...
    //   340: ifnull +8 -> 348
    //   343: aload 6
    //   345: invokevirtual 853	awby:b	()V
    //   348: aload_1
    //   349: athrow
    //   350: astore_1
    //   351: goto -13 -> 338
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if ((localFriends.datetime < paramLong) && (localFriends.isFriend()))
        {
          ...
          this.jdField_a_of_type_Awbw.b(localFriends);
          if (l1 != 0L)
          {
  ...
  public void a(Groups[] paramArrayOfGroups)
  {
    ...
    //   13: ldc_w 1276
    //   16: invokevirtual 183	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   19: astore_3
    //   20: aload_1
    //   21: ifnull +31 -> 52
    //   24: aload_1
    ...
    //   31: aload_3
    //   32: iload_2
    //   33: invokevirtual 263	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   36: invokevirtual 188	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   39: invokestatic 209	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   42: aload_1
    //   43: ifnull +8 -> 51
    //   46: aload_1
    //   47: arraylength
    ...
    //   53: istore_2
    //   54: goto -27 -> 27
    //   57: new 271	java/util/ArrayList
    //   60: dup
    //   61: aload_1
    //   62: arraylength
    //   63: invokespecial 775	java/util/ArrayList:<init>	(I)V
    //   66: astore 4
    ...
    //   77: astore 5
    //   79: aload_0
    //   80: getfield 162	aloz:jdField_a_of_type_Awbw	Lawbw;
    //   83: invokevirtual 594	awbw:a	()Lawby;
    //   86: astore_3
    //   87: aload_3
    //   88: invokevirtual 836	awby:a	()V
    //   91: iconst_0
    //   92: istore_2
    //   93: iload_2
    //   94: aload_1
    ...
    //   96: if_icmpge +61 -> 157
    //   99: aload 5
    //   101: new 174	java/lang/StringBuilder
    //   104: dup
    //   105: invokespecial 175	java/lang/StringBuilder:<init>	()V
    //   108: aload_1
    //   109: iload_2
    //   110: aaload
    //   111: getfield 286	com/tencent/mobileqq/data/Groups:group_id	I
    //   114: invokevirtual 263	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   117: ldc_w 265
    //   120: invokevirtual 183	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   123: invokevirtual 188	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   126: aload_1
    //   127: iload_2
    //   128: aaload
    //   129: invokevirtual 276	java/util/concurrent/ConcurrentHashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   132: pop
    //   133: aload 4
    //   135: aload_1
    //   136: iload_2
    //   137: aaload
    //   138: invokevirtual 302	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   141: pop
    //   142: aload_0
    //   143: aload_1
    //   144: iload_2
    //   145: aaload
    //   146: invokevirtual 859	aloz:a	(Lawbv;)Z
    //   149: pop
    //   150: iload_2
    //   151: iconst_1
    //   152: iadd
    ...
    //   163: aload 4
    //   165: getstatic 810	allu:a	Ljava/util/Comparator;
    //   168: invokestatic 816	java/util/Collections:sort	(Ljava/util/List;Ljava/util/Comparator;)V
    //   171: aload_0
    //   172: getfield 437	aloz:jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   175: ifnull +114 -> 289
    //   178: aload_0
    //   179: getfield 437	aloz:jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   182: invokevirtual 217	java/util/concurrent/ConcurrentHashMap:entrySet	()Ljava/util/Set;
    ...
    //   206: checkcast 234	java/util/Map$Entry
    //   209: astore 6
    //   211: aload 5
    //   213: aload 6
    //   215: invokeinterface 1279 1 0
    //   220: checkcast 249	java/lang/String
    //   223: invokevirtual 724	java/util/concurrent/ConcurrentHashMap:containsKey	(Ljava/lang/Object;)Z
    //   226: ifne -35 -> 191
    //   229: aload_0
    //   230: getfield 162	aloz:jdField_a_of_type_Awbw	Lawbw;
    //   233: aload 6
    //   235: invokeinterface 237 1 0
    //   240: checkcast 281	awbv
    //   243: invokevirtual 867	awbw:b	(Lawbv;)Z
    //   246: pop
    //   247: goto -56 -> 191
    //   250: astore_1
    //   251: invokestatic 202	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   254: ifeq +14 -> 268
    //   257: ldc_w 847
    //   260: iconst_2
    //   261: ldc_w 1281
    //   264: aload_1
    //   265: invokestatic 851	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   268: aload_3
    //   269: invokevirtual 853	awby:b	()V
    //   272: aload_0
    //   273: aload 4
    //   275: putfield 278	aloz:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   278: aload_0
    //   279: aload 5
    //   281: putfield 437	aloz:jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   284: aload_0
    //   285: invokevirtual 514	aloz:a	()V
    //   288: return
    //   289: aload_3
    //   290: invokevirtual 869	awby:c	()V
    //   293: aload_3
    //   294: invokevirtual 853	awby:b	()V
    //   297: goto -25 -> 272
    //   300: astore_1
    //   301: aload_3
    //   302: invokevirtual 853	awby:b	()V
    //   305: aload_1
    //   306: athrow
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  public boolean a()
  {
    boolean bool = b();
    h();
    this.jdField_f_of_type_Boolean = bdiv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 0);
    this.jdField_g_of_type_Boolean = bdiv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 1);
    a(bdiv.j(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()));
    g("buildFriends");
    return bool;
  }
  ...
  protected boolean a(awbv paramawbv)
  {
    ...
    QLog.d("Q.contacttab.friend", 2, "updateEntity em closed e=" + paramawbv.getTableName());
    return false;
  }
  ...
  public boolean a(Friends paramFriends)
  {
    ...
    if (this.jdField_a_of_type_Awbw.a()) {
      ...
      {
        this.jdField_a_of_type_Awbw.a(paramFriends);
    ...
    while (!QLog.isColorLevel())
    {
      ...
      return this.jdField_a_of_type_Awbw.a(paramFriends);
    }
  ...
  public boolean a(String paramString)
  {
    if (this.jdField_i_of_type_JavaUtilConcurrentConcurrentHashMap == null)
    {
      ...
      Object localObject = this.jdField_a_of_type_Awbw.a(Groups.class, false, "group_id=?", new String[] { "-1002" }, null, null, null, null);
      if (localObject != null)
      {
  ...
  public boolean a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    //   30: ldc_w 328
    //   33: invokevirtual 183	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   36: iload_2
    //   37: invokevirtual 263	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   40: ldc_w 328
    //   43: invokevirtual 183	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   46: iload_3
    //   47: invokevirtual 660	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   50: invokevirtual 188	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   53: invokestatic 209	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   56: aload_0
    //   57: getfield 162	aloz:jdField_a_of_type_Awbw	Lawbw;
    //   60: invokevirtual 594	awbw:a	()Lawby;
    //   63: astore 11
    //   65: aload 11
    //   67: astore 12
    //   69: aload 11
    //   71: invokevirtual 836	awby:a	()V
    //   74: aload 11
    //   76: astore 12
    //   78: aload_0
    //   79: aload_1
    //   80: invokevirtual 709	aloz:d	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/Friends;
    //   83: astore 10
    //   85: aload 11
    //   87: astore 12
    //   89: invokestatic 202	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   92: ifeq +48 -> 140
    //   95: aload 11
    //   97: astore 12
    //   99: ldc_w 1162
    ...
    //   120: ldc_w 1328
    //   123: invokevirtual 183	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   126: aload 10
    //   128: getfield 243	com/tencent/mobileqq/data/Friends:gathtertype	B
    //   131: invokevirtual 263	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   134: invokevirtual 188	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   137: invokestatic 209	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   140: aload 11
    //   142: astore 12
    //   144: aload_0
    //   145: aload_1
    //   146: invokevirtual 1330	aloz:a	(Ljava/lang/String;)Z
    //   149: ifeq +12 -> 161
    //   152: aload 11
    //   154: astore 12
    //   156: aload_0
    //   157: aload_1
    //   158: invokevirtual 1332	aloz:c	(Ljava/lang/String;)V
    //   161: aload 11
    //   163: astore 12
    //   165: aload 10
    //   167: getfield 260	com/tencent/mobileqq/data/Friends:groupid	I
    //   170: iconst_m1
    ...
    //   178: aload 10
    //   180: iload_2
    //   181: putfield 260	com/tencent/mobileqq/data/Friends:groupid	I
    //   184: iconst_m1
    //   185: istore 6
    //   187: iconst_1
    //   188: istore 8
    ...
    //   192: astore 12
    //   194: aload 10
    //   196: invokestatic 717	java/lang/System:currentTimeMillis	()J
    //   199: putfield 721	com/tencent/mobileqq/data/Friends:datetime	J
    //   202: iload_3
    //   203: ifeq +476 -> 679
    //   206: aload 11
    //   208: astore 12
    //   210: aload 10
    //   212: getfield 243	com/tencent/mobileqq/data/Friends:gathtertype	B
    //   215: istore 5
    //   217: iload 5
    //   219: iconst_1
    ...
    //   230: aload 10
    //   232: iconst_1
    //   233: putfield 243	com/tencent/mobileqq/data/Friends:gathtertype	B
    //   236: aload 11
    //   238: astore 12
    //   240: aload 10
    //   242: ldc_w 1333
    //   245: invokestatic 1337	alpo:a	(I)Ljava/lang/String;
    //   248: putfield 1178	com/tencent/mobileqq/data/Friends:recommReason	Ljava/lang/String;
    //   251: aload 11
    //   253: astore 12
    //   255: aload_0
    //   256: aload_0
    //   257: getfield 337	aloz:t	I
    //   260: iconst_1
    //   261: iadd
    //   262: putfield 337	aloz:t	I
    //   265: aload 11
    //   267: astore 12
    //   269: aload_0
    //   270: aload 10
    //   272: getfield 404	com/tencent/mobileqq/data/Friends:uin	Ljava/lang/String;
    //   275: invokevirtual 1339	aloz:b	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/Card;
    //   278: astore 13
    //   280: aload 13
    //   282: ifnull +43 -> 325
    //   285: aload 11
    //   287: astore 12
    //   289: aload 13
    //   291: getfield 638	com/tencent/mobileqq/data/Card:shGender	S
    //   294: ifne +246 -> 540
    //   297: iconst_1
    //   298: istore 4
    //   300: aload 11
    ...
    //   304: aload 10
    //   306: iload 4
    //   308: putfield 1092	com/tencent/mobileqq/data/Friends:gender	B
    //   311: aload 11
    //   313: astore 12
    //   315: aload 10
    //   317: aload 13
    //   319: getfield 1341	com/tencent/mobileqq/data/Card:age	B
    //   322: putfield 1095	com/tencent/mobileqq/data/Friends:age	I
    //   325: aload 11
    //   327: astore 12
    //   329: aload_0
    //   330: aload 10
    //   332: invokevirtual 859	aloz:a	(Lawbv;)Z
    //   335: pop
    //   336: aload 11
    //   338: astore 12
    //   340: aload_0
    //   341: iload_2
    //   342: invokestatic 494	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   345: invokevirtual 856	aloz:a	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/Groups;
    //   348: astore 10
    //   350: aload 10
    //   352: ifnull +33 -> 385
    //   355: aload 11
    ...
    //   359: aload 10
    //   361: aload 10
    //   363: getfield 289	com/tencent/mobileqq/data/Groups:group_friend_count	I
    //   366: iconst_1
    //   367: iadd
    //   368: putfield 289	com/tencent/mobileqq/data/Groups:group_friend_count	I
    //   371: aload 11
    //   373: astore 12
    //   375: aload_0
    //   376: getfield 162	aloz:jdField_a_of_type_Awbw	Lawbw;
    //   379: aload 10
    //   381: invokevirtual 884	awbw:a	(Lawbv;)Z
    //   384: pop
    //   385: iload 8
    //   387: ifne +61 -> 448
    //   390: iload 6
    ...
    //   405: aload_0
    //   406: iload 6
    //   408: invokestatic 494	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   411: invokevirtual 856	aloz:a	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/Groups;
    //   414: astore 10
    //   416: aload 10
    //   418: ifnull +30 -> 448
    //   421: aload 11
    ...
    //   425: aload 10
    //   427: aload 10
    //   429: getfield 289	com/tencent/mobileqq/data/Groups:group_friend_count	I
    //   432: iconst_1
    //   433: isub
    //   434: putfield 289	com/tencent/mobileqq/data/Groups:group_friend_count	I
    //   437: aload 11
    //   439: astore 12
    //   441: aload_0
    //   442: aload 10
    //   444: invokevirtual 859	aloz:a	(Lawbv;)Z
    //   447: pop
    //   448: aload 11
    //   450: astore 12
    //   452: aload 11
    //   454: invokevirtual 869	awby:c	()V
    //   457: iload 5
    //   459: istore 6
    //   461: iload 8
    //   463: istore 9
    ...
    //   467: ifnull +16 -> 483
    //   470: aload 11
    //   472: invokevirtual 853	awby:b	()V
    //   475: iload 8
    //   477: istore 9
    //   479: iload 5
    //   481: istore 6
    //   483: aload_0
    //   484: invokevirtual 514	aloz:a	()V
    //   487: iload_3
    //   488: ifeq +16 -> 504
    //   491: iload 6
    //   493: ifeq +11 -> 504
    //   496: aload_0
    //   497: getfield 144	aloz:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   500: aload_1
    //   501: invokestatic 1346	agvd:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;)V
    //   504: iload 9
    //   506: ireturn
    //   507: aload 11
    //   509: astore 12
    //   511: aload 10
    //   513: getfield 260	com/tencent/mobileqq/data/Friends:groupid	I
    //   516: istore 6
    //   518: aload 11
    //   520: astore 12
    //   522: aload 10
    //   524: iload_2
    //   525: putfield 260	com/tencent/mobileqq/data/Friends:groupid	I
    //   528: iconst_0
    //   529: istore 8
    //   531: goto -341 -> 190
    //   534: iconst_0
    ...
    //   542: astore 12
    //   544: aload 13
    //   546: getfield 638	com/tencent/mobileqq/data/Card:shGender	S
    //   549: istore 7
    //   551: iload 7
    //   553: iconst_1
    ...
    //   573: aload 11
    //   575: astore 12
    //   577: invokestatic 202	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   580: ifeq +19 -> 599
    //   583: aload 11
    //   585: astore 12
    //   587: ldc_w 847
    ...
    //   591: ldc_w 1348
    //   594: aload 10
    //   596: invokestatic 851	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   599: iload_2
    //   600: istore 6
    //   602: iload 8
    //   604: istore 9
    ...
    //   608: ifnull -125 -> 483
    //   611: aload 11
    //   613: invokevirtual 853	awby:b	()V
    //   616: iload_2
    //   617: istore 6
    //   619: iload 8
    //   621: istore 9
    ...
    //   632: ifnull +8 -> 640
    //   635: aload 12
    //   637: invokevirtual 853	awby:b	()V
    //   640: aload_1
    //   641: athrow
    //   642: astore_1
    //   643: goto -13 -> 630
    ...
    //   63	549	11	localawby1	awby
    //   67	569	12	localawby2	awby
  ...
  public boolean a(boolean paramBoolean)
  {
    ...
    if (this.q == -1)
    {
      ...
      ((alkv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(2)).q();
      paramBoolean = bool1;
    }
    for (;;)
    {
  ...
  {
    ContactCard localContactCard2 = (ContactCard)this.jdField_a_of_type_Awbw.a(ContactCard.class, paramString);
    ...
    if (localContactCard2 == null)
    {
      ...
      this.jdField_a_of_type_Awbw.a(localContactCard1);
    }
  ...
  public Friends b(String paramString)
  {
    ...
    do
    {
      ...
      localFriends = (Friends)this.jdField_a_of_type_Awbw.a(Friends.class, paramString);
      if (localFriends != null) {
    ...
    if (localFriends == null) {}
    for (paramString = "null";; paramString = bdje.e(localFriends.uin))
    {
  ...
  public List<SpecialCareInfo> b()
  {
    List localList = a();
    if (localList != null) {
      Collections.sort(localList, new alpb(this));
    }
    return localList;
  }
  ...
  public void b()
  {
    ...
    label394:
    label397:
    for (??? = this.jdField_a_of_type_Awbw.a(ExtensionInfo.class, true, ((StringBuilder)???).toString(), (String[])((List)localObject3).toArray(new String[((List)localObject3).size()]), null, null, null, null);; localObject2 = null)
    {
      for (;;)
      {
        localObject3 = ???;
        ...
        try
        {
          localObject3 = (ArrayList)this.jdField_a_of_type_Awbw.a(ExtensionInfo.class);
          if (localObject3 != null)
          {
  ...
  public boolean b()
  {
    ...
    localObject2 = (ArrayList)this.jdField_a_of_type_Awbw.a(Friends.class, false, "groupid>=?", new String[] { "0" }, null, null, null, null);
    int i1;
    ConcurrentHashMap localConcurrentHashMap;
    ...
    if (localObject2 != null)
    {
      ...
      bfua.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localFriends);
      if ((localFriends.mCompareSpell == null) || (localFriends.mCompareSpell.length() == 0))
      {
        allu.a(localFriends);
        localArrayList.add(localFriends);
    ...
    {
      localObject2 = this.jdField_a_of_type_Awbw.a();
      ((awby)localObject2).a();
      i1 = 0;
    }
    try
  ...
  public void c()
  {
    ...
    if (!this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
    {
      Object localObject1 = (ArrayList)this.jdField_a_of_type_Awbw.a(SpecialCareInfo.class, false, "globalSwitch!=?", new String[] { "0" }, null, null, null, null);
      if (localObject1 != null) {
        synchronized (this.jdField_h_of_type_JavaUtilConcurrentConcurrentHashMap)
        {
  ...
  public void c(List<SpecialCareInfo> paramList)
  {
    ...
    //   1: ifnull +12 -> 13
    //   4: aload_1
    //   5: invokeinterface 792 1 0
    //   10: ifne +20 -> 30
    //   13: invokestatic 202	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   16: ifeq +13 -> 29
    //   19: ldc_w 335
    //   22: iconst_2
    //   23: ldc_w 1481
    ...
    //   29: return
    //   30: aload_1
    //   31: invokeinterface 792 1 0
    //   36: iconst_1
    //   37: if_icmpne +18 -> 55
    //   40: aload_0
    //   41: aload_1
    //   42: iconst_0
    //   43: invokeinterface 1210 2 0
    //   48: checkcast 758	com/tencent/mobileqq/data/SpecialCareInfo
    //   51: invokevirtual 1483	aloz:a	(Lcom/tencent/mobileqq/data/SpecialCareInfo;)V
    //   54: return
    //   55: aload_0
    //   56: getfield 85	aloz:jdField_h_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   59: ifnull +73 -> 132
    //   62: aload_0
    //   63: getfield 85	aloz:jdField_h_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   66: astore_2
    //   67: aload_2
    //   68: monitorenter
    //   69: aload_1
    //   70: invokeinterface 1201 1 0
    //   75: astore_3
    //   76: aload_3
    ...
    //   91: checkcast 758	com/tencent/mobileqq/data/SpecialCareInfo
    //   94: astore 4
    //   96: aload 4
    //   98: getfield 900	com/tencent/mobileqq/data/SpecialCareInfo:uin	Ljava/lang/String;
    //   101: invokestatic 463	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   104: ifne -28 -> 76
    //   107: aload_0
    //   108: getfield 85	aloz:jdField_h_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   111: aload 4
    //   113: getfield 900	com/tencent/mobileqq/data/SpecialCareInfo:uin	Ljava/lang/String;
    //   116: aload 4
    //   118: invokevirtual 276	java/util/concurrent/ConcurrentHashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   121: pop
    //   122: goto -46 -> 76
    //   125: astore_1
    //   126: aload_2
    ...
    //   131: monitorexit
    //   132: aload_0
    //   133: getfield 162	aloz:jdField_a_of_type_Awbw	Lawbw;
    //   136: invokevirtual 594	awbw:a	()Lawby;
    //   139: astore_2
    //   140: aload_2
    //   141: invokevirtual 836	awby:a	()V
    //   144: aload_1
    //   145: invokeinterface 1201 1 0
    //   150: astore_1
    //   151: aload_1
    //   152: invokeinterface 228 1 0
    //   157: ifeq +110 -> 267
    //   160: aload_1
    //   161: invokeinterface 232 1 0
    //   166: checkcast 758	com/tencent/mobileqq/data/SpecialCareInfo
    //   169: astore_3
    //   170: aload_3
    //   171: getfield 900	com/tencent/mobileqq/data/SpecialCareInfo:uin	Ljava/lang/String;
    //   174: invokestatic 463	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   177: ifne -26 -> 151
    //   180: aload_0
    //   181: aload_3
    //   182: invokevirtual 859	aloz:a	(Lawbv;)Z
    //   185: pop
    //   186: invokestatic 202	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   189: ifeq -38 -> 151
    //   192: ldc_w 335
    //   195: iconst_2
    ...
    //   203: ldc_w 1485
    //   206: invokevirtual 183	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   209: aload_3
    //   210: invokevirtual 905	com/tencent/mobileqq/data/SpecialCareInfo:toString	()Ljava/lang/String;
    ...
    //   219: invokestatic 209	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   222: goto -71 -> 151
    //   225: astore_1
    //   226: invokestatic 202	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   229: ifeq +33 -> 262
    ...
    //   259: invokestatic 209	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   262: aload_2
    //   263: invokevirtual 853	awby:b	()V
    //   266: return
    //   267: aload_2
    //   268: invokevirtual 869	awby:c	()V
    //   271: aload_2
    //   272: invokevirtual 853	awby:b	()V
    //   275: return
    //   276: astore_1
    //   277: aload_2
    //   278: invokevirtual 853	awby:b	()V
    //   281: aload_1
    //   282: athrow
    // Local variable table:
    //   start	length	slot	name	signature
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localObject4 == null)
        {
          localObject1 = localawby;
          localObject2 = localawby;
          localObject3 = (Friends)this.jdField_a_of_type_Awbw.a(Friends.class, paramString);
        }
        if (localObject3 != null)
        {
          localObject1 = localawby;
          ...
          localObject1 = localawby;
          localObject2 = localawby;
          this.jdField_a_of_type_Awbw.b((awbv)localObject3);
        }
        localObject1 = localawby;
        localObject2 = localawby;
        localawby.c();
      ...
      a();
      if (akaj.a(paramString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
        akaj.b(paramString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      if (akaj.b(paramString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
        akaj.c(paramString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      e(paramString);
      paramString = a(paramString);
      if (paramString != null)
  ...
  public void d(List<String> paramList)
  {
    ...
    //   10: ifgt +4 -> 14
    //   13: return
    //   14: new 271	java/util/ArrayList
    //   17: dup
    //   18: invokespecial 272	java/util/ArrayList:<init>	()V
    //   21: astore_3
    //   22: aload_0
    //   23: getfield 162	aloz:jdField_a_of_type_Awbw	Lawbw;
    //   26: invokevirtual 594	awbw:a	()Lawby;
    //   29: astore_2
    //   30: aload_2
    //   31: invokevirtual 836	awby:a	()V
    //   34: aload_1
    //   35: invokeinterface 1201 1 0
    //   40: astore_1
    //   41: aload_1
    ...
    //   59: astore 4
    //   61: aload_0
    //   62: getfield 59	aloz:jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   65: aload 4
    //   67: invokevirtual 269	java/util/concurrent/ConcurrentHashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   70: checkcast 239	com/tencent/mobileqq/data/Friends
    //   73: astore 5
    //   75: aload 5
    //   77: ifnull -36 -> 41
    //   80: aload 5
    //   82: getfield 243	com/tencent/mobileqq/data/Friends:gathtertype	B
    //   85: ifeq +10 -> 95
    //   88: aload_3
    //   89: aload 4
    //   91: invokevirtual 302	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   94: pop
    //   95: aload 5
    //   97: iconst_0
    //   98: putfield 243	com/tencent/mobileqq/data/Friends:gathtertype	B
    //   101: aload_0
    //   102: aload 5
    //   104: invokevirtual 839	aloz:a	(Lcom/tencent/mobileqq/data/Friends;)Z
    //   107: pop
    //   108: aload_0
    //   109: aload_0
    //   110: getfield 337	aloz:t	I
    //   113: iconst_1
    //   114: isub
    //   115: putfield 337	aloz:t	I
    //   118: goto -77 -> 41
    //   121: astore_1
    //   122: aload_1
    //   123: invokevirtual 1233	java/lang/Exception:printStackTrace	()V
    //   126: aload_2
    //   127: invokevirtual 853	awby:b	()V
    //   130: aload_0
    //   131: invokevirtual 514	aloz:a	()V
    //   134: aload_0
    //   135: getfield 144	aloz:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   138: aload_3
    //   139: invokestatic 1533	agvd:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/util/List;)V
    //   142: return
    //   143: aload_2
    //   144: invokevirtual 869	awby:c	()V
    //   147: aload_2
    //   148: invokevirtual 853	awby:b	()V
    //   151: goto -21 -> 130
    //   154: astore_1
    //   155: aload_2
    //   156: invokevirtual 853	awby:b	()V
    //   159: aload_1
    //   160: athrow
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  public Friends e(String paramString)
  {
    ...
    do
    {
      ...
      if (localObject2 == null)
      {
        localObject2 = (Friends)this.jdField_a_of_type_Awbw.a(Friends.class, paramString);
        localObject1 = localObject2;
        if (QLog.isColorLevel())
        {
  ...
  public void e()
  {
    for (;;)
    {
      try
      {
        ...
        try
        {
          ArrayList localArrayList = (ArrayList)this.jdField_a_of_type_Awbw.a(NearbyPeopleCard.class, false, "lastUpdateNickTime>?", new String[] { "0" }, null, null, "_id desc", String.valueOf(100));
          if (!QLog.isColorLevel()) {
            break label215;
          }
        ...
        {
          this.jdField_a_of_type_Awbw.a(NearbyPeopleCard.class.getSimpleName());
          Object localObject1 = null;
          continue;
  ...
  public void e(String paramString)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_h_of_type_JavaUtilConcurrentConcurrentHashMap)
      {
        ...
        paramString = (SpecialCareInfo)this.jdField_a_of_type_Awbw.a(SpecialCareInfo.class, paramString);
        if (paramString != null)
        {
          if (!azmz.a(10)) {
            break label142;
  ...
  public void e(List<String> paramList)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localFriends.gathtertype == 0) {
          localFriends.recommReason = alpo.a(2131705316);
        }
        if (localFriends.gathtertype != 1) {
          localArrayList.add(localObject);
        }
      ...
      catch (Exception paramList)
      {
        ...
        localawby.b();
        a();
        agvd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localArrayList);
        return;
  ...
  public void f()
  {
    ...
    if (this.jdField_c_of_type_JavaUtilArrayList != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((this.jdField_b_of_type_JavaUtilArrayList != null) && (this.jdField_b_of_type_JavaUtilArrayList.contains(str))) {
          ...
          agvd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str);
        }
      }
    }
    if (this.jdField_b_of_type_JavaUtilArrayList != null)
    {
      ...
      {
        str = (String)localIterator.next();
        agvd.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str);
      }
    }
  ...
  public void f(String paramString)
  {
    ...
    RecentUser localRecentUser = localamjk.b(paramString, 0);
