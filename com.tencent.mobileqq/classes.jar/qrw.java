...
public class qrw
{
  ...
  private MqqHandler jdField_a_of_type_MqqOsMqqHandler = new qso(this, null);
  private nkw jdField_a_of_type_Nkw;
  private qsj jdField_a_of_type_Qsj;
  sgy jdField_a_of_type_Sgy;
  ...
  public qrw(Activity paramActivity, QQAppInterface paramQQAppInterface, VideoFeedsPlayManager paramVideoFeedsPlayManager, int paramInt1, boolean paramBoolean, qsj paramqsj, int paramInt2)
  {
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsPlayManager = paramVideoFeedsPlayManager;
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_Int = paramInt1;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Qsj = paramqsj;
    this.e = paramBoolean;
    this.jdField_a_of_type_Nkw = ((nkw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(136));
  ...
  public static Intent a(VideoInfo paramVideoInfo)
  {
    ...
    localIntent.putExtra("brief_key", BaseApplicationImpl.getContext().getString(2131696697, new Object[] { paramVideoInfo.jdField_c_of_type_JavaLangString }));
    if (paramVideoInfo.jdField_a_of_type_Int == 6)
    {
      ...
      localAbsStructMsg = axuy.a(localIntent.getExtras());
  ...
  public static Bundle a(VideoInfo paramVideoInfo, int paramInt)
  {
    ...
    if (paramVideoInfo.jdField_a_of_type_Int == 6)
    {
      ...
      ((Bundle)localObject).putInt("PREVIEW_START_POSI", qua.a(paramInt, paramVideoInfo.a()));
      localObject = (StructMsgForGeneralShare)axuy.a((Bundle)localObject);
      if ((!TextUtils.isEmpty(((StructMsgForGeneralShare)localObject).mMsgBrief)) && (((StructMsgForGeneralShare)localObject).mMsgBrief.indexOf(ajyc.a(2131716206)) == -1)) {
        ((StructMsgForGeneralShare)localObject).mMsgBrief = (ajyc.a(2131716228) + ((StructMsgForGeneralShare)localObject).mMsgBrief);
      }
      sew.a((StructMsgForGeneralShare)localObject);
  ...
  public static void a(VideoInfo paramVideoInfo, Activity paramActivity, int paramInt)
  {
    ...
    if (paramVideoInfo.jdField_a_of_type_Int == 0)
    {
      ...
      aqbc.a(paramActivity, localIntent);
      return;
    }
    ...
    {
      aqbc.a(paramActivity, a(paramVideoInfo), 21);
      return;
    }
    paramVideoInfo = a(paramVideoInfo, paramInt);
    Intent localIntent = new Intent();
    localIntent.putExtras(paramVideoInfo);
    aqbc.a(paramActivity, localIntent, 21);
  }
  ...
  private void a(VideoInfo paramVideoInfo, String paramString1, String paramString2, String paramString3, long paramLong, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      localJSONObject.put("network", olg.a(this.jdField_a_of_type_AndroidAppActivity));
    ...
    noo.a(null, "", "0X8009546", "0X8009546", 0, 0, "", String.valueOf(paramString2), String.valueOf(paramLong), paramVideoInfo, false);
  }
  ...
  private void a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    localObject[0] = ajyc.a(2131716230);
    localObject[1] = ajyc.a(2131716159);
    localObject[2] = ajyc.a(2131716193);
    localObject[3] = ajyc.a(2131716141);
    localObject[4] = ajyc.a(2131716188);
    localObject[5] = ajyc.a(2131716152);
    localObject[6] = ajyc.a(2131716210);
    localObject[7] = ajyc.a(2131716171);
    localObject[8] = ajyc.a(2131716164);
    ...
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString3)))
    {
      ...
      bcpw.a(this.jdField_a_of_type_AndroidAppActivity, 0, 2131719476, 0).b(this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131298865));
      return;
    }
    ...
    try
    {
      ...
      paramString3.putExtra("big_brother_source_key", onk.f(i));
  ...
  private void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt1, long paramLong, int paramInt2, int paramInt3, int paramInt4, String paramString6, boolean paramBoolean)
  {
    ...
    paramString4 = new qze(paramString4, paramString1, paramString5, paramString3).a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsPlayManager.a()).c(paramInt1 * 1000);
    if (!paramBoolean) {
    ...
    for (;;)
    {
      noo.a(null, paramString1, str1, str1, 0, 0, "0", paramString2, paramString3, paramString4.a().a(), false);
      return;
      paramString3 = "0";
    }
  }
  ...
  private static void b(Context paramContext, int paramInt1, int paramInt2, VideoInfo paramVideoInfo, int paramInt3, int paramInt4, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      noo.a(null, "", "0X800979D", "0X800979D", 0, 0, "", String.valueOf(paramVideoInfo.g), String.valueOf(paramVideoInfo.jdField_f_of_type_Long), paramContext, false);
      return;
      paramInt1 = 1;
    }
  }
  ...
  private void e()
  {
    ...
    do
    {
      ...
      try
      {
        ...
        int i = qol.b(this.jdField_a_of_type_AndroidAppActivity)[0];
    ...
    this.jdField_a_of_type_ComTencentImageURLDrawable.setURLDrawableListener(new qsf(this));
  ...
  private void f()
  {
    ...
    Object localObject = new qsg(this);
    ...
    ((ReadInJoyDisLikeDialogView)localObject).setOnUninterestConfirmListener(new qsh(this, localVideoInfo));
    ((ReadInJoyDisLikeDialogView)localObject).setOnComplainListener(new qry(this, localVideoInfo));
      ...
      try
      {
        if (!this.jdField_a_of_type_Bfol.isShowing())
        {
          if ((bfni.g()) && (!ShortVideoUtils.c()))
          {
            ...
            this.jdField_a_of_type_Bfol.setOnShowListener(new qrz(this));
          }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Sgy == null) {
      this.jdField_a_of_type_Sgy = new sgy(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new qsi(this), new qsk(this));
    }
    this.jdField_a_of_type_Sgy.a.a("biu出去让更多好友看到");
    this.jdField_a_of_type_Sgy.a.a(new qsc(this));
    this.jdField_a_of_type_Sgy.a.a(new qsd(this));
    try
    {
      if (!this.jdField_a_of_type_Sgy.a.a())
      {
        if ((bfni.g()) && (!ShortVideoUtils.c()))
        {
          this.jdField_a_of_type_Sgy.a.a().setFlags(8, 8);
          this.jdField_a_of_type_Sgy.a.a().getDecorView().setSystemUiVisibility(this.jdField_a_of_type_AndroidAppActivity.getWindow().getDecorView().getSystemUiVisibility());
          this.jdField_a_of_type_Sgy.a.a(new qse(this));
        }
  ...
  public void a(int paramInt)
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_Qsj != null) {
        this.jdField_a_of_type_Qsj.e();
      }
  ...
  void a(MessageForShortVideo paramMessageForShortVideo)
  {
    ...
    String str1 = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131719594);
    String str2 = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131719552);
    String str3 = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131719595);
    String str4 = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131719572);
    ...
    {
      localObject = bfol.b(this.jdField_a_of_type_AndroidAppActivity);
      ((bfol)localObject).c(str1);
      ((bfol)localObject).setOnDismissListener(new qrx(this));
      if (paramMessageForShortVideo.videoFileStatus != 5001) {
        ((bfol)localObject).c(str3);
      }
      if (!bool1) {
        break label334;
      }
      ((bfol)localObject).c(str2);
      ((bfol)localObject).c(str4);
    }
    for (;;)
    {
      ((bfol)localObject).d(str5);
      if (!((bfol)localObject).isShowing())
      {
        if ((bfni.g()) && (!ShortVideoUtils.c()))
        {
          ((bfol)localObject).getWindow().setFlags(8, 8);
          if (bfni.g()) {
            ((bfol)localObject).getWindow().getDecorView().setSystemUiVisibility(this.jdField_a_of_type_AndroidAppActivity.getWindow().getDecorView().getSystemUiVisibility());
          }
          ((bfol)localObject).setOnShowListener(new qsa(this, (bfol)localObject));
        }
        ((bfol)localObject).show();
      }
      ((bfol)localObject).a(new qsb(this, (bfol)localObject, str1, paramMessageForShortVideo, str3, bool1, str6, str2, str4));
      return;
      localObject = bfol.a(this.jdField_a_of_type_AndroidAppActivity);
      break;
      label334:
      ((bfol)localObject).a(str2, 7);
      ((bfol)localObject).a(str4, 7);
    }
  }
  
  public List<Integer>[] a()
  {
    List localList = sgy.a();
    ArrayList localArrayList = new ArrayList();
