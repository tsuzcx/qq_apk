...
public class pyl
{
  private static volatile pyl jdField_a_of_type_Pyl;
  private ExecutorService jdField_a_of_type_JavaUtilConcurrentExecutorService = MonitorTimeExecutor.a();
  private pln jdField_a_of_type_Pln = new pym(this);
  
  public static pyl a()
  {
    if (jdField_a_of_type_Pyl == null) {}
    try
    {
      if (jdField_a_of_type_Pyl == null) {
        jdField_a_of_type_Pyl = new pyl();
      }
      return jdField_a_of_type_Pyl;
    }
    finally {}
  }
  
  private void a(pyk parampyk, long paramLong)
  {
    parampyk = new FeedsPreloadManager.4(this, parampyk, paramLong);
    pay.b().post(parampyk);
  }
  ...
  private void c()
  {
    ...
    for (;;)
    {
      ((pks)localQQAppInterface.getManager(163)).a().a(0, (List)localObject, i, true, false, 1, null, -1L, null, 0, l1, l2, str, 1, false, null, 256);
  ...
  public pyk a(qln paramqln)
  {
    boolean bool2 = false;
    pyj localpyj = pyj.a();
    if (localpyj != null)
    {
      pyk localpyk = localpyj.a(paramqln);
      localpyj.b();
      if (localpyk != null)
      {
        QLog.d("FeedsPreloadManager", 1, "getFeedsPreloadCache, hit cache.");
        if (localpyk.jdField_a_of_type_JavaUtilList != null) {}
        for (int i = localpyk.jdField_a_of_type_JavaUtilList.size();; i = 0)
        {
          boolean bool1 = bool2;
          if (paramqln.b != null)
          {
            bool1 = bool2;
            if (paramqln.b.size() > 0) {
              bool1 = true;
            }
          }
          pyn.a(bool1, i);
  ...
  {
    boolean bool2 = false;
    QLog.d("FeedsPreloadManager", 1, new Object[] { "handleFeedsPreloadRequest, cache = ", parampyk });
    long l;
    int i;
    if (parampyk != null)
    {
      Object localObject = parampyk.jdField_a_of_type_ComTencentQphoneBaseRemoteToServiceMsg;
      l = 0L;
      ...
      a(parampyk, l);
      pyp.b();
      if (parampyk.jdField_a_of_type_JavaUtilList == null) {
        break label135;
      }
      i = parampyk.jdField_a_of_type_JavaUtilList.size();
      if (parampyk.jdField_a_of_type_ComTencentQphoneBaseRemoteToServiceMsg == null) {
        break label140;
      }
    }
    label135:
    label140:
    for (parampyk = (List)parampyk.jdField_a_of_type_ComTencentQphoneBaseRemoteToServiceMsg.getAttribute("SubscriptionArticles");; parampyk = null)
    {
      boolean bool1 = bool2;
      if (parampyk != null)
      {
  ...
  public void b()
  {
    ...
    if (jdField_a_of_type_Pyl != null) {
      try
      {
        jdField_a_of_type_Pyl.jdField_a_of_type_JavaUtilConcurrentExecutorService.shutdownNow();
        jdField_a_of_type_Pyl.jdField_a_of_type_JavaUtilConcurrentExecutorService = MonitorTimeExecutor.a();
