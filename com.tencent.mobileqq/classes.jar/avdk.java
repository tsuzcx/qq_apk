...
public class avdk
{
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, long paramLong, TroopTips0x857.NotifyMsgBody paramNotifyMsgBody)
  {
    ...
    if (i == 4)
    {
      avhf.b(paramQQAppInterface, String.valueOf(l));
      localavcw.notifyUI(5, true, new Object[] { Integer.valueOf(1), String.valueOf(l) });
      avhg.a(paramQQAppInterface);
    }
    for (;;)
    {
      localavcw.notifyUI(3, true, new Object[] { paramNotifyMsgBody });
      return;
      if ((i == 1) || (i == 2))
      {
        avhg.a(paramQQAppInterface, 1, String.valueOf(l), true);
      }
      else
      {
        if (i == 5)
        {
          ...
          avhf.b(paramQQAppInterface, String.valueOf(l));
          localavcw.notifyUI(6, true, new Object[] { Integer.valueOf(1), String.valueOf(l), Integer.valueOf(paramInt) });
          avhg.a(paramQQAppInterface);
          continue;
        }
        if (i == 3) {
  ...
  private static void a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2)
  {
    ...
    if (paramLong1 == paramQQAppInterface.getLongAccountUin()) {
      avcw.a(paramQQAppInterface).a(new avcq(1, String.valueOf(paramLong2)), false);
    }
  }
  
  static void a(QQAppInterface paramQQAppInterface, TroopTips0x857.LbsShareChangePushInfo paramLbsShareChangePushInfo)
  {
    paramQQAppInterface = avcw.a(paramQQAppInterface);
  ...
  static void a(QQAppInterface paramQQAppInterface, TroopTips0x857.LbsShareChangePushInfo paramLbsShareChangePushInfo, int paramInt)
  {
    ...
    paramLbsShareChangePushInfo = new avcq(1, String.valueOf(l1));
