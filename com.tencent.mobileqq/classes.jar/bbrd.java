...
public class bbrd
  extends QIPCModule
{
  private static bbrd a;
  
  public bbrd(String paramString)
  {
    super(paramString);
  }
  ...
  public static bbrd a()
  {
    ...
    {
      if (a == null) {
        a = new bbrd("VasMonitorIPCModule");
      }
      return a;
    }
    finally {}
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    bbrc.a(null, paramBundle.getString("key_appid"), paramBundle.getString("key_err_code"), paramBundle.getString("key_log"), paramBundle.getString("key_key4"), paramBundle.getString("key_key5"), paramBundle.getString("key_key6"), paramBundle.getFloat("key_value2"), paramBundle.getFloat("key_value3"));
    return null;
  }
}
