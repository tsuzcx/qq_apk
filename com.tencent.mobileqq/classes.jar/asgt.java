...
public class asgt
{
  ...
  private Map<String, asgu> jdField_a_of_type_JavaUtilMap = new HashMap();
  private Executor jdField_a_of_type_JavaUtilConcurrentExecutor;
  
  private asgu a(asgw paramasgw)
  {
    if ((paramasgw == null) || (paramasgw.jdField_a_of_type_JavaLangString == null)) {
      return null;
    }
    synchronized (this.jdField_a_of_type_JavaUtilMap)
    {
      paramasgw = (asgu)this.jdField_a_of_type_JavaUtilMap.get(paramasgw.jdField_a_of_type_JavaLangString);
      return paramasgw;
    }
  }
  
  private void a(asgw paramasgw, asgu paramasgu)
  {
    synchronized (this.jdField_a_of_type_JavaUtilMap)
    {
      this.jdField_a_of_type_JavaUtilMap.put(paramasgw.jdField_a_of_type_JavaLangString, paramasgu);
      return;
    }
  }
  ...
  private boolean a(asgw paramasgw, asgx paramasgx)
  {
    if ((paramasgw == null) || (TextUtils.isEmpty(paramasgw.jdField_a_of_type_JavaLangString)) || (paramasgx == null) || (TextUtils.isEmpty(paramasgx.jdField_a_of_type_JavaLangString))) {
    ...
    do
    {
      ...
      QLog.i("FileIPv6Detecter<FileAssistant>", 1, "[IPv6-File] start delectIP [" + paramasgw.jdField_a_of_type_JavaLangString + ":" + paramasgw.jdField_a_of_type_Int + "] ipInfo[" + paramasgx.jdField_a_of_type_JavaLangString + ":" + paramasgx.jdField_a_of_type_Int + "]");
      c();
    } while (this.jdField_a_of_type_JavaUtilConcurrentExecutor == null);
    this.jdField_a_of_type_JavaUtilConcurrentExecutor.execute(new FileIPv6Detecter.1(this, paramasgx, l, paramasgw));
    return true;
  }
  ...
  private void c()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 166	asgt:jdField_a_of_type_JavaUtilConcurrentExecutor	Ljava/util/concurrent/Executor;
    //   6: ifnonnull +38 -> 44
    //   9: ldc 102
    //   11: iconst_1
    //   12: ldc 185
    ...
    //   41: putfield 166	asgt:jdField_a_of_type_JavaUtilConcurrentExecutor	Ljava/util/concurrent/Executor;
    //   44: aload_0
    //   45: monitorexit
    //   46: return
    //   47: astore_1
  ...
  public void a(QQAppInterface paramQQAppInterface, asgw paramasgw, asgx paramasgx)
  {
    if ((paramasgw == null) || (TextUtils.isEmpty(paramasgw.jdField_a_of_type_JavaLangString)) || (paramasgx == null) || (TextUtils.isEmpty(paramasgx.jdField_a_of_type_JavaLangString))) {
    ...
    paramQQAppInterface = a(paramasgw);
    if (paramQQAppInterface != null)
    {
    ...
    if (a(paramasgw, paramasgx))
    {
      paramQQAppInterface = new asgu(this);
      paramQQAppInterface.b = true;
      paramQQAppInterface.jdField_a_of_type_Asgx = paramasgx;
      paramQQAppInterface.jdField_a_of_type_Long = l;
      a(paramasgw, paramQQAppInterface);
      return;
    }
    QLog.e("FileIPv6Detecter<FileAssistant>", 1, "[IPv6-File] delectIP err");
  }
  
  public boolean a(asgw paramasgw)
  {
    paramasgw = a(paramasgw);
    if (paramasgw != null) {
      return paramasgw.jdField_a_of_type_Boolean;
    }
    return false;
  }
}
