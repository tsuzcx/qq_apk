...
public class bfzb
{
  ...
  public static String a(Context paramContext, String[] paramArrayOfString)
  {
    ...
    //   1: astore_2
    //   2: aload_0
    //   3: invokestatic 27	bfzb:a	(Landroid/content/Context;)Z
    //   6: ifne +7 -> 13
    //   9: aconst_null
    //   10: astore_1
    //   11: aload_1
    //   12: areturn
    //   13: getstatic 16	bfzb:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   16: astore 4
    //   18: aload_0
    ...
    //   68: astore_0
    //   69: getstatic 14	bfzb:b	Ljava/lang/String;
    //   72: iconst_2
    ...
    //   188: aload_0
    //   189: astore_1
    //   190: getstatic 14	bfzb:b	Ljava/lang/String;
    //   193: iconst_2
  ...
  public static void a(Activity paramActivity, String paramString)
  {
    try
    {
      ...
      paramString.putExtra("android.intent.extra.shortcut.NAME", paramActivity.getResources().getString(2131690081));
      paramString.putExtra("android.intent.extra.shortcut.ICON_RESOURCE", Intent.ShortcutIconResource.fromContext(paramActivity.getApplicationContext(), 2130840385));
  ...
  static boolean a(Context paramContext)
  {
    if (jdField_a_of_type_JavaLangString == null) {
      jdField_a_of_type_JavaLangString = bfyf.a(paramContext);
    }
  ...
  public static boolean a(Context paramContext, String[] paramArrayOfString)
  {
    ...
    //   1: astore 4
    //   3: aload_0
    //   4: invokestatic 27	bfzb:a	(Landroid/content/Context;)Z
    //   7: ifne +7 -> 14
    //   10: iconst_0
    //   11: istore_2
    //   12: iload_2
    //   13: ireturn
    //   14: getstatic 16	bfzb:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   17: astore 6
    //   19: aload_0
    ...
    //   72: astore_0
    //   73: getstatic 14	bfzb:b	Ljava/lang/String;
    //   76: iconst_2
    ...
    //   176: aload_1
    //   177: astore_0
    //   178: getstatic 14	bfzb:b	Ljava/lang/String;
    //   181: iconst_2
