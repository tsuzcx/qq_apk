...
{
  private bfzb(BaseScaleAndMoveBitmapView paramBaseScaleAndMoveBitmapView) {}
  ...
  public boolean onScale(ScaleGestureDetector paramScaleGestureDetector)
  {
    ...
    for (;;)
    {
      yuk.a("QQ.Troop.homework.BaseScaleAndMoveBitmapView", "onScale %f", Float.valueOf(this.a.c));
      this.a.invalidate();
      return true;
