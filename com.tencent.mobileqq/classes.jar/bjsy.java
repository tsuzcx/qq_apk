...
public class bjsy
{
  ...
  public static void a(Context paramContext, DownloadInfo paramDownloadInfo)
  {
    ...
    {
      return;
      bdnk.a().addDownloadURL(paramDownloadInfo.jdField_d_of_type_JavaLangString);
    ...
    localHashMap.put("NetworkType", bhnv.b(paramContext) + "");
    Object localObject1;
    if (a(paramContext)) {
      localObject1 = "1";
    }
    ...
    for (;;)
    {
      ...
      {
        bdmc.a(paramContext).a(null, "UniformDownloadEvent_NO_SOURCE", true, 0L, 0L, localHashMap, "");
        ...
        {
          bdll.b(null, "dc00898", "", "", "0X800A003", "0X800A003", 1, 0, paramDownloadInfo, (String)localObject1, (String)localObject2, paramContext);
          if (!QLog.isColorLevel()) {
            break label1158;
          }
      ...
      label943:
      bdmc.a(paramContext).a(null, "UniformDownloadEvent", true, 0L, 0L, localHashMap, "");
      paramDownloadInfo = (String)localHashMap.get("isForeground");
      localObject1 = (String)localHashMap.get("isAPK");
      localObject2 = ((StringBuilder)localObject2).toString();
      localObject3 = new StringBuilder().append((String)localHashMap.get("Stack"));
      ...
      for (paramContext = (String)localHashMap.get("Stack1");; paramContext = "")
      {
        bdll.b(null, "dc00898", "", "", "0X800A002", "0X800A002", 1, 0, paramDownloadInfo, (String)localObject1, (String)localObject2, paramContext);
        break label598;
        label1158:
        break;
      }
  ...
  public static void a(Context paramContext, WadlParams paramWadlParams)
  {
    ...
    bdnk.a().addDownloadURL(paramWadlParams.e);
    HashMap localHashMap = new HashMap();
    ...
    if (a(paramContext))
    {
      ...
      localStringBuilder.append((String)a.remove(paramWadlParams.jdField_a_of_type_JavaLangString));
    }
    for (;;)
    {
      int i = 1;
      ...
      if (a.containsKey(paramWadlParams.e)) {
        localStringBuilder.append((String)a.remove(paramWadlParams.e));
      }
    }
    if (localStringBuilder.length() < 950)
    {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        break label318;
        label557:
        paramWadlParams = paramWadlParams.m;
        break label345;
        label565:
