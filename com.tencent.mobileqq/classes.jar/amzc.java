...
public class amzc
{
  ...
  public SparseArray<WeakReference<amze>> a;
  ...
  public static void a(long paramLong, int paramInt, String paramString)
  {
    ...
    try
    {
      ...
      localObject = localamzc.c(paramString);
      if (TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        localamzc.a(2, localArrayList, null, 3, paramLong, true, ((JSONObject)localObject).toString(), "");
        return;
      }
    }
  ...
  public static void a(long paramLong, int paramInt, String paramString1, String paramString2)
  {
    ...
    paramString1 = new amzd(paramString2, paramLong);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((paramArrayList != null) && (paramArrayList.size() != 0))
        {
          ...
          localamzx.a("apollo_aio_game.get_user_uin_or_openid", localJSONObject.toString(), -1L, paramInt2, false, null);
        }
      }
  ...
  public void a(int paramInt1, ArrayList<String> paramArrayList, ArrayList<Long> paramArrayList1, int paramInt2, long paramLong, boolean paramBoolean, String paramString1, String paramString2, amze paramamze)
  {
    ...
    this.jdField_a_of_type_AndroidUtilSparseArray.put(paramInt2, new WeakReference(paramamze));
  }
  ...
  public void a(ArrayList<Long> paramArrayList, ArrayList<String> paramArrayList1, int paramInt, long paramLong)
  {
    ...
    try
    {
      ...
      label252:
      amwn.a().callbackFromRequest(paramLong, 0, "cs.audioRoom_update_userinfo.local", localJSONObject1.toString());
      return;
    }
    catch (Exception paramArrayList)
    {
            ...
            if (((JSONArray)localObject1).length() > 0)
            {
              ...
              if (i < ((JSONArray)localObject1).length())
              {
                ...
                for (;;)
                {
                  ...
                  localObject2 = (amze)((WeakReference)localObject2).get();
                  if (localObject2 == null) {
                    break label741;
                  }
                  ((amze)localObject2).a(0, "", (String)localObject1);
              ...
              if (paramString.has("lState"))
              {
                ...
                if (((JSONArray)localObject3).length() > 0) {
                  amwn.a().callbackFromRequest(l, 0, "cs.audioRoom_update_userinfo.local", ((JSONObject)localObject2).toString());
                }
