...
public class bcaz
{
  private static int a(acwk paramacwk, SubMsgType0x27.ForwardBody paramForwardBody, anmw paramanmw, amhd paramamhd, Friends[] paramArrayOfFriends, int paramInt)
  {
      ...
      if (localIterator.hasNext())
      {
        ...
        case 20002: 
          for (paramInt = i2;; paramInt = n)
          {
            ...
            localObject2 = paramanmw.e(Long.toString(l2));
            paramForwardBody = null;
            if (localObject2 != null) {
              paramForwardBody = ((Friends)localObject2).name;
            }
            paramArrayOfFriends[i1] = paramanmw.a(l2 + "", (String)localObject1);
            if ((localObject2 != null) && (((Friends)localObject2).isFriend()) && (antf.a((String)localObject1, paramForwardBody))) {
              antf.a(l2, (String)localObject1, (ankw)paramacwk.a().getManager(53));
            }
            paramForwardBody = paramanmw.b(l2 + "");
            if (paramForwardBody != null)
            {
              paramForwardBody.strNick = ((String)localObject1);
              paramanmw.a(paramForwardBody);
              paramacwk.a().a(2).notifyUI(1, true, paramForwardBody);
            }
            paramacwk.a().a(1).notifyUI(3, true, Long.toString(l2));
        ...
        case 20014: 
          if (paramForwardBody.bytes_value.has())
          {
            ...
            {
              localObject1 = (anip)paramacwk.a().a(2);
              if (localObject1 != null)
              {
                i3 = paramForwardBody.byteAt(0);
                if (i3 != 101) {
                  ((anip)localObject1).d(i3);
                }
                i2 = n;
                n = i3;
              }
    ...
    for (;;)
    {
      ...
      if ((paramForwardBody != null) && (paramForwardBody.size() == 2))
      {
        ...
        ((FriendListHandler)paramacwk.a().a(1)).c(Long.toString(l2));
        paramForwardBody = paramanmw.b(l2 + "");
        if (paramForwardBody != null)
        {
          paramForwardBody.nFaceID = n;
          paramanmw.a(paramForwardBody);
          paramacwk.a().a(1).notifyUI(4, true, new Object[] { l2 + "", paramForwardBody, null });
          paramacwk.a().a(2).notifyUI(1, true, paramForwardBody);
        }
      }
      n = paramInt;
      ...
      paramacwk.a(i2);
      ((anuk)paramacwk.a().a(13)).notifyUI(101, true, Integer.valueOf(i2));
      n = k;
      if (!QLog.isColorLevel()) {
        break;
      }
      ...
      paramForwardBody = paramForwardBody.bytes_value.get();
      localObject1 = paramanmw.e(Long.toString(l2));
      n = k;
      if (localObject1 == null) {
        break;
      }
      ...
      for (;;)
      {
        ...
        paramanmw.a((Friends)localObject1);
        ((anuk)paramacwk.a().a(13)).notifyUI(100, true, null);
        if (paramacwk.a().getCurrentAccountUin().equals(Long.toString(l2)))
        {
          ...
          paramacwk.a().getApp().sendBroadcast(paramForwardBody);
        }
        if (paramacwk.a().getCurrentAccountUin().equals(Long.toString(l2)))
        {
          if (QLog.isColorLevel()) {
          ...
          paramForwardBody = (anlb)paramacwk.a().a(12);
          paramForwardBody.a(0, 0);
          paramForwardBody.a(0, 0, 1, 0);
          if (QLog.isColorLevel()) {
            QLog.d("QVipSettingMe.", 2, "[vipInfoPush] 23105 request vipInfoHandler");
          }
          bhhv.a(paramacwk.a(), "last_pull_pay_rule", 0L);
          paramForwardBody = ((TicketManager)paramacwk.a().getManager(2)).getSkey(paramacwk.a().getCurrentAccountUin());
          ((anyj)paramacwk.a().a(27)).a(paramForwardBody, l2 + "");
        }
        n = paramInt;
        paramInt = m;
        m = n;
      ...
      localObject2 = paramanmw.e((String)localObject1);
      n = k;
      if (localObject2 == null) {
        break;
      }
      ...
      for (;;)
      {
        ...
        paramanmw.a((Friends)localObject2);
        if (paramacwk.a().getCurrentAccountUin().equals(localObject1)) {
          paramacwk.a().a(13).notifyUI(100, true, null);
        }
        n = paramInt;
        paramInt = m;
        m = n;
      ...
      localObject1 = paramacwk.a().getApplication().getSharedPreferences("vip_message_roam_banner_file", 0);
      ...
      for (;;)
      {
        if (n != -1)
        {
          ((SharedPreferences)localObject1).edit().putInt("message_roam_flag" + paramacwk.a().getCurrentAccountUin(), n).apply();
          paramacwk.a().a(1).notifyUI(101, true, Integer.valueOf(n));
        }
        n = paramInt;
        paramInt = m;
        m = n;
        break;
        if (((SharedPreferences)localObject1).getInt("message_roam_flag" + paramacwk.a().getCurrentAccountUin(), -1) == 2) {
          n = 1;
        } else {
          n = -1;
        }
      ...
      {
        n = k;
        if (SettingCloneUtil.readValue(paramacwk.a().getApplication(), Long.toString(l2), null, "qqsetting_pcactive_key", false) == bool1) {
          break;
        }
        SettingCloneUtil.writeValue(paramacwk.a().getApplication(), Long.valueOf(l2).toString(), null, "qqsetting_pcactive_key", bool1);
        ...
        if (bool1)
        {
          SettingCloneUtil.writeValue(paramacwk.a().getApplication(), Long.toString(l2), null, "pcactive_config", true);
          paramacwk.a().openMsfPCActive(Long.toString(l2), "config", true);
        ...
        n = ((SharedPreferences)localObject1).getInt("message_roam_flag" + paramacwk.a().getCurrentAccountUin(), -1);
        if ((n == 4) || (n == 3))
        {
          n = 1;
          break label3333;
      ...
      localObject1 = paramanmw.a(String.valueOf(l2));
      ...
      paramacwk.a().a(1).notifyUI(66, true, paramForwardBody);
      n = paramInt;
      paramInt = m;
      m = n;
      break label729;
      ...
      if (paramForwardBody.fontEffect != i2)
      {
        ...
        ((gc)paramacwk.a().getManager(42)).e();
        n = 1;
      }
      if (n != 0) {
        paramanmw.a(paramForwardBody);
      ...
      if (paramForwardBody.colorRingId != n)
      {
        ...
        paramForwardBody.timestamp = System.currentTimeMillis();
        paramanmw.a(paramForwardBody);
        bgxe.a(paramForwardBody.uin, 1, paramacwk.a().getCurrentAccountUin());
      }
      n = k;
      if (!QLog.isColorLevel()) {
        break;
      ...
      break label729;
      i2 = ByteBuffer.wrap(paramForwardBody.bytes_value.get().toByteArray()).asShortBuffer().get();
      paramForwardBody = paramamhd.b(String.valueOf(l2));
      if (QLog.isColorLevel()) {
      ...
      paramForwardBody = paramamhd.b(String.valueOf(l2));
      if ((QLog.isColorLevel()) || (l2 == paramacwk.a().getLongAccountUin())) {
      ...
      if (paramForwardBody.apolloStatus != n)
      {
        ...
        paramamhd.a(paramForwardBody);
        if ((l2 == paramacwk.a().getLongAccountUin()) && (paramForwardBody.isApolloStatusOpen()) && (paramForwardBody.apolloLocalTS != paramForwardBody.apolloServerTS))
        {
          paramForwardBody = (VasExtensionHandler)paramacwk.a().a(71);
          if (paramForwardBody != null) {
      ...
      if (l2 == paramacwk.a().getLongAccountUin())
      {
        paramForwardBody = new Pair(localObject1, Integer.valueOf(n));
        paramacwk.a().a(71).notifyUI(3, true, paramForwardBody);
        n = paramInt;
        paramInt = m;
        m = n;
        break label729;
      ...
      localObject1 = amuo.a(paramacwk.a());
      if (localObject1 != null) {
        ((amul)localObject1).a(n, paramForwardBody);
      }
      n = paramInt;
      paramInt = m;
      m = n;
      ...
      localObject1 = paramamhd.b(paramForwardBody);
      if (paramForwardBody.equals(paramacwk.a().c())) {
        ((VasExtensionHandler)paramacwk.a().a(71)).a(new long[] { l2 });
      }
      ...
      if (((ApolloBaseInfo)localObject1).apolloServerTS != n)
      {
        ...
        paramamhd.a((ApolloBaseInfo)localObject1);
      }
      n = 0;
      localObject1 = paramacwk.a().a();
      i2 = n;
      if (localObject1 != null)
      {
        i2 = n;
      ...
      if ((!paramForwardBody.equals(paramacwk.a().c())) || (amhd.a(paramacwk.a()) != 2))
      {
        n = k;
        if (i2 == 0) {
          break;
      ...
      n = ByteBuffer.wrap(paramForwardBody.bytes_value.get().toByteArray()).asShortBuffer().get();
      if (n != amhd.a(paramacwk.a()))
      {
        paramForwardBody = (amhd)paramacwk.a().getManager(153);
        paramForwardBody.b(n);
        if (n == 1)
        {
          paramForwardBody = paramForwardBody.b(paramacwk.a().c());
      ...
      if (paramamhd != null)
      {
        paramForwardBody = paramamhd.b(paramacwk.a().c());
        if ((paramForwardBody != null) && (n != paramForwardBody.apolloAISwitch))
        {
          paramForwardBody.apolloAISwitch = n;
          if ((paramacwk.a() != null) && (String.valueOf(l2).equals(paramacwk.a().c()))) {
            paramamhd.a(n, 2);
          }
          paramamhd.a(paramForwardBody);
        }
      ...
      for (i2 = paramForwardBody[0];; i2 = ByteBuffer.wrap(paramForwardBody).asShortBuffer().get())
      {
        ...
        paramForwardBody = paramamhd.b((String)localObject2);
        ...
        if (paramForwardBody.cmshow3dFlag != i2)
        {
          ...
          paramamhd.a(paramForwardBody);
          if (paramacwk.a().getCurrentAccountUin().equals(String.valueOf(l2))) {
            paramamhd.c(n, i2);
          }
          localObject1 = new ArrayList();
          ((ArrayList)localObject1).add(localObject2);
          localObject2 = amuo.a(paramacwk.a());
          if (localObject2 != null) {
            ((amul)localObject2).a(3, (ArrayList)localObject1);
          }
        }
        n = k;
        if ((i2 & 0x1) != 1) {
      ...
      paramForwardBody = ((TicketManager)paramacwk.a().getManager(2)).getSkey(l2 + "");
      ((anyj)paramacwk.a().a(27)).a(paramForwardBody, l2 + "");
      n = paramInt;
      paramInt = m;
      m = n;
      ...
      for (n = paramForwardBody[0];; n = ByteBuffer.wrap(paramForwardBody).asShortBuffer().get())
      {
        ...
        paramForwardBody = paramanmw.e(Long.toString(l2));
        if (paramForwardBody != null)
        {
      ...
      break label729;
      n = ByteBuffer.wrap(paramForwardBody.bytes_value.get().toByteArray()).asIntBuffer().get();
      ((bgzk)paramacwk.a().getManager(235)).a.b(Long.toString(l2), n);
      if (QLog.isColorLevel()) {
        QLog.d("Q.msg.BaseMessageProcessor", 2, "push, Get faceId, uin=" + l2 + ", id=" + n);
      }
      n = ByteBuffer.wrap(paramForwardBody.bytes_value.get().toByteArray()).asIntBuffer().get();
      localObject1 = (BubbleManager)paramacwk.a().getManager(44);
      label8903:
      short s;
      if (localObject1 != null)
      {
      ...
      else
      {
        ...
        bool1 = true;
        label8986:
        localObject1 = (awhm)paramacwk.a().getManager(303);
      ...
      {
        ((awhm)localObject1).a(s, false, "", bool2);
        if (QLog.isColorLevel()) {
      ...
      {
        paramForwardBody = aypc.a(n);
        localObject1 = paramacwk.a().getOnlineStatus();
        l3 = ayox.a().a(paramacwk.a());
        if ((paramForwardBody != localObject1) || (l3 != l1))
        {
          paramacwk.a().setOnlineStatus(paramForwardBody);
          paramacwk.a().setExtOnlineStatus(l1);
          localObject2 = new Bundle();
          ((Bundle)localObject2).putSerializable("onlineStatus", paramForwardBody);
          ((Bundle)localObject2).putLong("extOnlineStatus", l1);
          paramacwk.a().notifyObservers(AccountObserver.class, 2211, true, (Bundle)localObject2);
        }
        if (QLog.isColorLevel()) {
        ...
        {
          paramacwk.a().r();
          paramacwk.a().a(paramForwardBody, l1);
          if (QLog.isColorLevel()) {
      ...
      bool1 = ThemeUtil.isNowThemeIsSimple(paramacwk.a(), false, null);
      if ((!bool1) && (bdoq.a(String.valueOf(i2)))) {
      ...
      for (;;)
      {
        ...
        m = n;
        break label729;
        bdpw.a(paramacwk.a(), String.valueOf(i2), "20000000");
      }
      i2 = ByteBuffer.wrap(paramForwardBody.bytes_value.get().toByteArray()).asIntBuffer().get();
      localObject1 = (ChatBackgroundManager)paramacwk.a().getManager(63);
      if (localObject1 != null) {
      ...
      for (;;)
      {
        aijp.a(paramacwk.a()).a(bool1);
        paramacwk.a().a(2).notifyUI(104, true, Boolean.valueOf(bool1));
        n = k;
        if (!QLog.isColorLevel()) {
          break;
        }
      ...
      if (paramForwardBody.length > 1) {
        if (paramForwardBody[1] == 1)
        {
          ...
          if (bool1)
          {
            paramForwardBody = (aqri)aqlk.a().a(442);
            bool2 = bool1;
            if (paramForwardBody != null)
            {
              bool2 = bool1;
          ...
          localObject3 = paramacwk.a().getApp().getSharedPreferences("check_update_sp_key", 0);
          paramForwardBody = "businessinfo_ptt_auto_change_text_" + paramacwk.a().getCurrentAccountUin();
          localObject1 = "businessinfo_ptt_auto_change_time_" + paramacwk.a().getCurrentAccountUin();
          localObject2 = "businessinfo_ptt_auto_change_guide_has_show_" + paramacwk.a().getCurrentAccountUin();
      ...
      for (;;)
      {
        ...
        paramForwardBody = (anip)paramacwk.a().a(2);
        localObject1 = new ArrayList();
      ...
      for (bool1 = true;; bool1 = false)
      {
        ...
        paramanmw.a(paramForwardBody);
        paramacwk.a().a(2).notifyUI(113, true, Boolean.valueOf(paramForwardBody.troopHonorSwitch));
        ((anwd)paramacwk.a().a(20)).notifyUI(80, true, null);
        n = paramInt;
        paramInt = m;
        m = n;
        break;
      ...
      if (m != 0)
      {
        ...
        paramanmw = paramanmw.a(String.valueOf(l2));
        paramForwardBody = paramanmw;
        if (paramanmw == null)
        {
          paramForwardBody = new ExtensionInfo();
          paramForwardBody.uin = String.valueOf(l2);
        ...
        gc.a(paramacwk.a(), String.valueOf(l2), paramForwardBody, m, k);
        n = i1;
      }
      return n;
      i3 = -1;
  ...
  public static void a(acwk paramacwk, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localanmw = (anmw)paramacwk.a().getManager(51);
        localTroopManager = (TroopManager)paramacwk.a().getManager(52);
        localanrs = (anrs)paramacwk.a().getManager(56);
        localamhd = (amhd)paramacwk.a().getManager(153);
        j = 0;
      ...
      catch (Exception paramacwk)
      {
        paramacwk.printStackTrace();
        return;
      }
      ...
      case 0: 
        if (paramArrayOfByte.msg_add_group.has())
        {
          ...
          localanmw.a(paramArrayOfByte);
          localObject1 = new AddGroupResp();
          ((AddGroupResp)localObject1).dwToUin = Long.valueOf(paramacwk.a().getAccount()).longValue();
          ...
          paramacwk.a().a(1).notifyUI(18, true, paramArrayOfByte);
        }
        break;
      case 1: 
        if (paramArrayOfByte.msg_del_group.has())
        {
          ...
          {
            localObject2 = localanmw.a(((SubMsgType0x27.DelGroup)localObject1).uint32_groupid.get() + "");
            if (QLog.isColorLevel()) {
            ...
            paramArrayOfByte.dwToUin = Long.valueOf(paramacwk.a().getAccount()).longValue();
            ...
            ((FriendListHandler)paramacwk.a().a(1)).a(paramArrayOfByte, true, (GroupActionResp)localObject1);
          }
        }
        break;
      case 2: 
        if (paramArrayOfByte.msg_mod_group_name.has())
        {
          ...
          if ((((SubMsgType0x27.ModGroupName)localObject1).uint32_groupid.has()) && (((SubMsgType0x27.ModGroupName)localObject1).bytes_groupname.has()))
          {
            ...
            paramArrayOfByte = localanmw.a(String.valueOf(i));
            if (paramArrayOfByte != null) {}
            for (paramArrayOfByte.group_name = ((String)localObject2);; paramArrayOfByte.group_name = ((String)localObject2))
            {
              ...
              paramacwk.a().a(1).notifyUI(19, true, paramArrayOfByte);
              break;
              paramArrayOfByte = new Groups();
    ...
    {
      break label1170;
      paramacwk.a().a(1).notifyUI(22, true, null);
      localanmw.a(paramArrayOfByte, (byte[])localObject1);
      break;
      ...
      for (i = ((Integer)((SubMsgType0x27.FriendGroup)localObject1).rpt_uint32_old_group_id.get(0)).intValue();; i = 0)
      {
        ...
        paramacwk.a().a(1).notifyUI(9, true, new Object[] { l1 + "", Byte.valueOf((byte)k), Byte.valueOf((byte)i) });
        break label1370;
        ...
        paramArrayOfByte = (wfe)paramacwk.a().getManager(253);
        ...
        for (;;)
        {
          ...
          try
          {
            localObject2 = (bjft)paramacwk.a().getManager(165);
            if ((localObject2 != null) && (((bjft)localObject2).a(l1 + "")))
            {
              paramacwk.a().a().a().a(String.valueOf(l1), true);
              localObject2 = paramacwk.a().getApplication().getBaseContext().getSharedPreferences(paramacwk.a().getCurrentAccountUin() + "_customer_transfer_sharepreference", 0).edit();
              ((SharedPreferences.Editor)localObject2).putBoolean(paramacwk.a().getCurrentAccountUin() + "_" + l1 + "", false);
          ...
          paramacwk.a().a(1).notifyUI(15, true, Long.valueOf(l1));
          localObject2 = String.valueOf(l1);
          paramArrayOfByte.a((String)localObject2);
          bajn.a(paramacwk.a(), (String)localObject2);
          bdqr.a(paramacwk.a(), (String)localObject2);
        }
        label2040:
        paramArrayOfByte = (PhoneContactManagerImp)paramacwk.a().getManager(11);
        if (paramArrayOfByte == null) {
          break;
        }
        paramArrayOfByte.b();
              ...
              if ((i == 13569) && (((SubMsgType0x27.SnsUpateBuffer)localObject3).uint32_result.get() == 0))
              {
                ...
                if (i == 0)
                {
                  if (localTroopManager.c((String)localObject5)) {
                    paramacwk.a().a(22).notifyUI(18, true, new Object[] { localObject5, Integer.valueOf(1), Integer.valueOf(0), null });
                  }
                }
                else if (i >= 4)
                {
                  ...
                  if (localTroopManager.a((String)localObject5, anqc.a((byte[])localObject7))) {
                    paramacwk.a().a(22).notifyUI(18, true, new Object[] { localObject5, Integer.valueOf(0), Integer.valueOf(0), null });
                  }
                }
              }
              else if (i == 13571)
              {
                ...
                if (i >= 6)
                {
                  ...
                  if (i == 1)
                  {
                    ...
                    if (localTroopManager.b((String)localObject5, anqc.a((byte[])localObject7))) {
                      paramacwk.a().a(20).notifyUI(54, true, new Object[] { localObject5, Integer.valueOf(i), Integer.valueOf(0), Integer.valueOf(i) });
                    }
                  }
        ...
        while (((Iterator)localObject4).hasNext())
        {
          ...
          if ((paramArrayOfByte != null) && (paramArrayOfByte.uint64_uin.has()) && (paramArrayOfByte.rpt_msg_sns_update_item.has()))
          {
            ...
            while (((Iterator)localObject6).hasNext())
            {
              ...
              if ((localObject7 != null) && (((SubMsgType0x27.SnsUpdateItem)localObject7).uint32_update_sns_type.has()) && (((SubMsgType0x27.SnsUpdateItem)localObject7).bytes_value.has()) && (!FriendsStatusUtil.a((SubMsgType0x27.SnsUpdateItem)localObject7, paramacwk.a(), (String)localObject5)))
              {
                if (((SubMsgType0x27.SnsUpdateItem)localObject7).uint32_update_sns_type.get() == 13568) {
                  alxx.a((String)localObject5, ((SubMsgType0x27.SnsUpdateItem)localObject7).bytes_value.get().toStringUtf8(), paramacwk.a());
                }
                localObject1 = (SpecialCareInfo)((HashMap)localObject3).get(localObject5);
                paramArrayOfByte = (byte[])localObject1;
                if (localObject1 == null)
                {
                  localObject1 = localanmw.a(String.valueOf(l1));
                  paramArrayOfByte = (byte[])localObject1;
                  if (localObject1 == null)
                  {
        ...
        localanmw.c((List)localObject1);
        if (((List)localObject1).size() <= 0) {
          break;
        }
        paramacwk.a().a(1).notifyUI(99, true, new Object[] { Boolean.valueOf(true), localObject1 });
        break;
        ...
        do
        {
          ...
          localObject1 = localanmw.e(String.valueOf(l1));
        } while (localObject1 == null);
        if (i == 1) {}
        for (boolean bool = true;; bool = false)
        {
          ((Friends)localObject1).setShieldFlag(bool);
          localanmw.a((Friends)localObject1);
          paramacwk.a().a(1).notifyUI(56, true, new Object[] { Long.valueOf(l1), Boolean.valueOf(bool), Boolean.valueOf(true), Boolean.valueOf(true), "" });
          break;
        }
        if (!paramArrayOfByte.msg_mod_profile.has()) {
          break;
        }
        j = a(paramacwk, paramArrayOfByte, localanmw, localamhd, arrayOfFriends, j);
        break;
        ...
        paramArrayOfByte = (FriendListHandler)paramacwk.a().a(1);
        if (((SubMsgType0x27.ModCustomFace)localObject1).uint32_type.get() == 0)
        {
          ...
          paramacwk.a().a(1).notifyUI(3, true, localObject1);
          break;
        }
        ...
        if (paramacwk.a().getCurrentAccountUin().equals(String.valueOf(l1)))
        {
          paramArrayOfByte = localanmw.c(paramacwk.a().getCurrentAccountUin());
          if ((i != paramArrayOfByte.lLoginDays) || (k != paramArrayOfByte.lQQMasterLogindays))
          {
            ...
            localanmw.a(paramArrayOfByte);
            paramacwk.a().a(2).notifyUI(1, true, paramArrayOfByte);
          }
          if (QLog.isColorLevel()) {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          if (((SubMsgType0x27.FriendRemark)localObject3).uint32_type.has()) {
            if (((SubMsgType0x27.FriendRemark)localObject3).uint32_type.get() == 0)
            {
              ...
              localObject4 = localanmw.e(Long.toString(l1));
              ...
              localanmw.b(((SubMsgType0x27.FriendRemark)localObject3).uint64_fuin.get() + "", ((SubMsgType0x27.FriendRemark)localObject3).bytes_rmk_name.get().toStringUtf8());
              localObject5 = localanmw.b(((SubMsgType0x27.FriendRemark)localObject3).uint64_fuin.get() + "");
              ...
              if ((localObject5 != null) && (!((String)localObject6).equals(((Card)localObject5).strReMark)))
              {
                ...
                localanmw.a((Card)localObject5);
              }
              if ((localObject4 != null) && (((Friends)localObject4).isFriend()) && (antf.b((String)localObject6, paramArrayOfByte))) {
                antf.b(l1, (String)localObject6, (ankw)paramacwk.a().getManager(53));
              }
              paramacwk.a().a(1).notifyUI(3, true, Long.toString(((SubMsgType0x27.FriendRemark)localObject3).uint64_fuin.get()));
              paramacwk.a().a(1).notifyUI(27, true, new Object[] { ((SubMsgType0x27.FriendRemark)localObject3).uint64_fuin.get() + "", ((SubMsgType0x27.FriendRemark)localObject3).bytes_rmk_name.get().toStringUtf8(), Byte.valueOf(1) });
        ...
        localObject1 = localanmw.a((String)localObject3);
        paramArrayOfByte = (byte[])localObject1;
        if (localObject1 == null)
        {
        ...
        paramArrayOfByte.isAdded2C2C = SignatureManager.a(paramacwk.a(), (String)localObject3, paramArrayOfByte.getRichStatus());
        if (QLog.isColorLevel()) {
        ...
        localanmw.a(paramArrayOfByte);
        paramArrayOfByte = localanmw.b(((SubMsgType0x27.ModLongNick)localObject5).uint64_uin.get() + "");
        if (paramArrayOfByte != null)
        {
        ...
        paramacwk.a().a(1).notifyUI(3, true, localObject3);
        paramacwk.a().a(1).notifyUI(2, true, new String[] { localObject3 });
        break;
        ...
        for (;;)
        {
          ...
          if (((SubMsgType0x27.GroupProfileInfo)localObject1).uint32_field.get() == 2)
          {
            ...
            if ((localObject1 != null) && (((ByteStringMicro)localObject1).size() == 2))
            {
              ...
              localTroopManager.b((TroopInfo)localObject1);
              ((FriendListHandler)paramacwk.a().a(1)).d(l1 + "");
            }
          }
        ...
        paramArrayOfByte = bglj.a().a(paramacwk.a(), l2 + "", l3 + "");
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          if ((((SubMsgType0x27.GroupMemberProfileInfo)localObject3).uint32_field.has()) && (((SubMsgType0x27.GroupMemberProfileInfo)localObject3).bytes_value.has()))
          {
            ...
            antf.a("cardpush", ((SubMsgType0x27.GroupMemberProfileInfo)localObject3).bytes_value.get().toByteArray(), ((SubMsgType0x27.GroupMemberProfileInfo)localObject3).bytes_value.get().size());
            if (paramArrayOfByte != null)
            {
              paramArrayOfByte.colorNick = bgwv.a(((SubMsgType0x27.GroupMemberProfileInfo)localObject3).bytes_value.get());
              paramArrayOfByte.name = bgwv.b(paramArrayOfByte.colorNick);
          ...
          for (;;)
          {
            ...
            bglj.a().a(paramacwk.a(), paramArrayOfByte);
            localObject3 = new ArrayList();
            ((ArrayList)localObject3).add(paramArrayOfByte);
            paramacwk.a().a(20).notifyUI(16, true, localObject3);
            paramacwk.a().a(20).notifyUI(11, true, new Object[] { localObject3, Boolean.valueOf(true) });
            break;
            ...
            else if (((SubMsgType0x27.GroupMemberProfileInfo)localObject3).uint32_field.get() == 5)
            {
              ...
              ((TroopManager)paramacwk.a().getManager(52)).a(l1 + "", l3 + "", null, -100, null, (String)localObject3, -100, -100, -100, -100L, -100L);
              if (paramArrayOfByte != null) {
        ...
        {
          paramacwk.a().a().a((SubMsgType0x27.AppointmentNotify)localObject5);
          break;
        }
        ...
        localObject1 = null;
        localObject3 = paramacwk.a().getCurrentAccountUin();
        ...
        for (paramArrayOfByte = (byte[])localObject3;; paramArrayOfByte = (byte[])localObject4)
        {
          ...
          paramacwk.a().a().a((MessageRecord)localObject6, ((MessageRecord)localObject6).selfuin);
          paramacwk.a("handleMsgType0x210SubMsgType0x27", true, (List)localObject5, false, false);
          break;
          if ((l1 == 1L) && (((SubMsgType0x27.AppointmentNotify)localObject5).bytes_sig.has()))
          {
            ...
            paramacwk.a().a().l((String)localObject4, paramArrayOfByte);
          }
        }
        if (!paramArrayOfByte.bytes_redpoint_info.has()) {
          break;
        }
        ((axzw)paramacwk.a().getManager(160)).a(paramArrayOfByte.bytes_redpoint_info.get().toByteArray());
        break;
        ...
        ((abqn)paramacwk.a().a(51)).a(39, (Bundle)localObject1);
        break;
        ...
        for (i = paramArrayOfByte.uint32_msg_type.get();; i = -1)
        {
          ...
          if (i == 1)
          {
            localObject1 = (anos)paramacwk.a().a(3);
            if (localObject1 == null) {
              break;
            }
            ((anos)localObject1).a(paramArrayOfByte);
            break;
          }
          if ((i != 2) && (i != 3)) {
            break;
          }
          localObject1 = (anqp)paramacwk.a().a(57);
          if (localObject1 == null) {
            break;
          }
          ((anqp)localObject1).a(i, paramArrayOfByte);
          break;
          ...
          for (paramArrayOfByte = paramArrayOfByte.str_msg.get();; paramArrayOfByte = null)
          {
            for (;;)
            {
              for (;;)
              {
                ...
                localObject1 = bggl.a(paramacwk.a().getApp().getResources(), 2130840337);
                localObject3 = new ToServiceMsg("mobileqq.service", paramacwk.a().getCurrentAccountUin(), "CMD_SHOW_NOTIFIYCATION");
                localObject4 = new Intent(paramacwk.a().getApp(), LikeRankingListActivity.class);
                ...
                paramacwk.a().sendToService((ToServiceMsg)localObject3);
                paramacwk.a().reportClickEvent("dc00898", "0X8007618");
                break;
                try
                {
                  ...
                  ((aqbo)paramacwk.a().getManager(240)).a(paramArrayOfByte);
                }
                catch (Exception paramArrayOfByte) {}
              }
              if (!QLog.isColorLevel()) {
