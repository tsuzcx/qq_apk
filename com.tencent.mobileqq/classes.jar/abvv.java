...
public class abvv
  extends akui
{
  public abvv(QQMapActivity paramQQMapActivity, String paramString, boolean paramBoolean)
  {
  ...
  public void onLocationFinish(int paramInt, SosoInterface.SosoLbsInfo paramSosoLbsInfo)
  {
    ...
    for (;;)
    {
      ...
      if (l - this.a.jdField_a_of_type_Long > 5000L)
      {
        ...
        {
          double d = xnn.a(localGeoPoint.getLongitudeE6() / 1000000.0D, localGeoPoint.getLatitudeE6() / 1000000.0D, this.a.jdField_b_of_type_Double, this.a.jdField_a_of_type_Double);
          this.a.m();
          this.a.e.setText(xnn.a(d));
        }
