  ...
  extends FilterOutputStream
{
  ...
  private static bmjt jdField_b_of_type_Bmjt;
  private static int c;
  protected int a;
  private bmjt jdField_a_of_type_Bmjt;
  private boolean jdField_a_of_type_Boolean;
  protected byte[] a;
  private final int jdField_b_of_type_Int = 4;
  
  private bmjt(@NonNull OutputStream paramOutputStream)
  {
    this(paramOutputStream, 8192);
  }
  
  private bmjt(@NonNull OutputStream paramOutputStream, int paramInt)
  {
  ...
  public static bmjt a(@NonNull OutputStream paramOutputStream)
  {
    bmjt localbmjt = null;
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (jdField_b_of_type_Bmjt != null)
      {
        localbmjt = jdField_b_of_type_Bmjt;
        jdField_b_of_type_Bmjt = localbmjt.jdField_a_of_type_Bmjt;
        localbmjt.jdField_a_of_type_Bmjt = null;
        c -= 1;
      }
      if (localbmjt != null)
      {
        localbmjt.out = paramOutputStream;
        localbmjt.jdField_a_of_type_Boolean = true;
        return localbmjt;
      }
    }
    return new bmjt(paramOutputStream);
  }
  ...
  private void a()
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (c < 4)
      {
        this.jdField_a_of_type_Bmjt = jdField_b_of_type_Bmjt;
        jdField_b_of_type_Bmjt = this;
        c += 1;
      }
      return;
    }
