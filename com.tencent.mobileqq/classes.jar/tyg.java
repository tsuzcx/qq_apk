...
public class tyg
{
  ...
  public tyg(tye paramtye, BaseApplicationImpl paramBaseApplicationImpl, int paramInt)
  {
    this.jdField_b_of_type_Int = paramInt;
    this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl = paramBaseApplicationImpl;
    this.jdField_a_of_type_Int = ozs.c();
  ...
  private void a(bevm parambevm)
  {
    if (parambevm != null)
    {
      if (parambevm.jdField_a_of_type_JavaUtilHashMap != null)
      {
        ...
        QLog.d(this.jdField_a_of_type_JavaLangString, 1, "resp: " + parambevm);
        return;
      }
  ...
  {
    return new tyh(this, paramURLDrawableHandler, this);
  }
  ...
  public void a(int paramInt, DownloadParams paramDownloadParams)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        switch (tzq.a((QQAppInterface)localObject2, (String)localObject1))
        {
        }
      ...
      for (;;)
      {
        ...
        bdmc.a(BaseApplication.getContext()).a(null, paramDownloadParams, this.jdField_a_of_type_Boolean, this.jdField_b_of_type_Long, this.jdField_c_of_type_Long, this.jdField_a_of_type_JavaUtilHashMap, "", true);
        return;
        j = 1;
        break;
        j = 2;
  ...
  public void a(bevm parambevm, String paramString)
  {
    a(parambevm);
    if (parambevm != null)
    {
      this.f = "none";
      paramString = (String)parambevm.jdField_a_of_type_JavaUtilHashMap.get("Content-Type");
      if ((paramString != null) && (paramString.startsWith("image/"))) {
        this.f = paramString.replace("image/", "");
      }
      this.jdField_c_of_type_Long = parambevm.jdField_a_of_type_Long;
      return;
    }
    this.d = paramString;
  }
