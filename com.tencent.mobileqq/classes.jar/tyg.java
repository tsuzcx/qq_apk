...
public class tyg
{
  ...
  private static QQHashMap<Integer, tyh> jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap;
  ...
  public static Drawable a(Context paramContext, int paramInt)
  {
    ...
    {
    default: 
      return paramContext.getResources().getDrawable(2130840264);
    case 1: 
      return paramContext.getResources().getDrawable(2130840356);
    }
    return paramContext.getResources().getDrawable(2130840361);
  }
  ...
  {
    tyh localtyh = a(paramQQAppInterface, paramContext, paramInt);
    if (localtyh != null) {
      return localtyh.a();
    }
  ...
  public static tyh a(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt)
  {
    int i1 = paramInt;
    if (paramInt == 3) {
      i1 = 2;
    ...
    return (tyh)jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.get(Integer.valueOf(i1));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (localSharedPreferences != null)
    {
      ...
      localSet = bgsh.a(localSharedPreferences, "big_data_share_channel_urls", null);
      if (localSet != null) {
  ...
  private static void a(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    if (!a(paramQQAppInterface, paramContext, bgsg.e(paramContext)))
    {
      localObject = new tyh(paramQQAppInterface, paramContext, 1, 2131695729, 2130840356);
      jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.put(Integer.valueOf(1), localObject);
    }
    Object localObject = bgsg.h(paramContext);
    String str = bgsg.i(paramContext);
    if ((TextUtils.isEmpty((CharSequence)localObject)) || (TextUtils.isEmpty(str)))
    {
      paramQQAppInterface = new tyh(paramQQAppInterface, paramContext, 2, 2131694629, 2130840361);
    ...
    for (;;)
    {
      ...
      return;
      paramQQAppInterface = new tyh(paramQQAppInterface, paramContext, 2, (String)localObject, str);
      jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.put(Integer.valueOf(2), paramQQAppInterface);
    }
  }
  ...
  public static void a(ArrayList<tyh> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      {
        tyh localtyh = (tyh)paramArrayList.next();
        jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.put(Integer.valueOf(localtyh.jdField_a_of_type_Int), localtyh);
      }
    }
  }
    ...
    try
    {
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        while (i1 < i2)
        {
          ...
          localObject = new tyh(paramQQAppInterface, paramContext, i3, ((Element)localObject).getElementsByTagName("name").item(0).getFirstChild().getNodeValue(), ((Element)localObject).getElementsByTagName("icon").item(0).getFirstChild().getNodeValue());
          if (jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap == null) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          ...
          bool = true;
          tvx.a(paramQQAppInterface, bool, (String)localObject1);
          tvx.b(paramQQAppInterface, i1);
          if (i3 == 1)
          {
        ...
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          ...
          bool = true;
          tvx.a(paramQQAppInterface, bool);
          tvx.c(paramQQAppInterface, i1);
          if (QLog.isColorLevel()) {
        ...
        if (localObject1 != null)
        {
          ...
          bool = true;
          bgsg.b((Context)localObject1, bool);
        }
        localObject1 = paramString.getElementsByTagName("channel_version");
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          i1 = Integer.valueOf(((Element)((NodeList)localObject1).item(0)).getFirstChild().getNodeValue()).intValue();
          i2 = bmqa.b(paramQQAppInterface);
          if (i1 <= i2) {
            break label2992;
          }
          ...
          bmqa.a(paramQQAppInterface, i3, (String)localObject2, i4);
          if (QLog.isColorLevel()) {
        ...
        if (localObject1 != null)
        {
          ...
          bool = true;
          bgsg.c((Context)localObject1, bool);
          localObject1 = sgc.a();
          if (i1 != 0) {
            break label3033;
          }
          bool = true;
          ((sgc)localObject1).a(bool);
          if (QLog.isColorLevel()) {
        ...
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          ...
          bool = true;
          bmqa.b(paramQQAppInterface, bool);
          if (QLog.isColorLevel()) {
        ...
        if (localObject1 != null)
        {
          ...
          bool = true;
          bgsg.a((Context)localObject1, bool, paramQQAppInterface.c());
          if (QLog.isColorLevel()) {
        ...
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          ...
          bool = true;
          bmqa.d(paramQQAppInterface, bool);
        }
        ...
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          ...
          bmqa.h(paramQQAppInterface, bool);
        }
  ...
  public static String b(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt)
  {
    ...
    default: 
      return null;
    case 1: 
      return paramContext.getString(2131695729);
    }
    return paramContext.getString(2131694629);
  }
  ...
  public static boolean b()
  {
    return "1".equals((String)aavz.a().a("subscribe_entrance_enable", "1"));
  }
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if ((localObject != null) && (((NodeList)localObject).getLength() > 0))
          {
            ...
            if (i1 > bgsg.x(paramQQAppInterface.getApp()))
            {
              ...
              if ((!TextUtils.isEmpty((CharSequence)localObject)) && (!TextUtils.isEmpty(paramString))) {
                bgsg.a(paramQQAppInterface.getApp(), (String)localObject, paramString);
              }
              bgsg.o(paramQQAppInterface.getApp(), i1);
              return false;
            }
          }
        }
  ...
  {
    return (String)aavz.a().a("subscribe_account_title", aavz.jdField_c_of_type_JavaLangString);
  }
  ...
  public static boolean c()
  {
    String str1 = (String)aavz.a().a("subscribe_entrance_enable", "1");
    String str2 = (String)aavz.a().a("newfollowlist", "1");
