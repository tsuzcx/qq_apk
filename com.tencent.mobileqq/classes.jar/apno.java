...
public class apno
  extends akif
{
  public apno(AppletsSettingFragment paramAppletsSettingFragment) {}
  ...
  protected void onGetAppletsSettingSwitch(boolean paramBoolean, List<akio> paramList)
  {
    ...
    if (paramBoolean)
    {
      ...
      if ((paramList != null) && (paramBoolean) && (paramList.size() > 0))
      {
        ...
        {
          Object localObject1 = (akio)paramList.next();
          Object localObject2;
          if ((((akio)localObject1).jdField_a_of_type_JavaUtilList != null) && (((akio)localObject1).jdField_a_of_type_JavaUtilList.size() > 0) && (((akio)localObject1).jdField_a_of_type_JavaUtilList.get(0) != null) && (((AppletItem)((akio)localObject1).jdField_a_of_type_JavaUtilList.get(0)).a() == 1L))
          {
            AppletsSettingFragment.a(this.a, (AppletItem)((akio)localObject1).jdField_a_of_type_JavaUtilList.get(0));
            ...
            {
              ((agxk)localObject2).a(paramBoolean);
              if (TextUtils.isEmpty(((akio)localObject1).jdField_a_of_type_JavaLangString)) {
                break;
              }
              AppletsSettingFragment.b(this.a).setText(((akio)localObject1).jdField_a_of_type_JavaLangString);
              this.a.a.a(((akio)localObject1).jdField_a_of_type_JavaLangString);
              break;
              paramBoolean = false;
              break label247;
            }
          ...
          if (!TextUtils.isEmpty(((akio)localObject1).jdField_a_of_type_JavaLangString))
          {
            AppletsSettingFragment.c(this.a).setText(((akio)localObject1).jdField_a_of_type_JavaLangString);
            this.a.a.b(((akio)localObject1).jdField_a_of_type_JavaLangString);
          }
          if ((((akio)localObject1).jdField_a_of_type_JavaUtilList != null) && (((akio)localObject1).jdField_a_of_type_JavaUtilList.size() > 0))
          {
            AppletsSettingFragment.a(this.a).clear();
            localObject1 = ((akio)localObject1).jdField_a_of_type_JavaUtilList.iterator();
