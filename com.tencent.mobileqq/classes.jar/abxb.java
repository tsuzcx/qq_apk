...
public class abxb
  extends Handler
{
  public abxb(QQSettingMe paramQQSettingMe, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    paramMessage.offset(((View)localObject).getLeft() + actn.a(34.0F, this.a.jdField_a_of_type_AndroidViewViewGroup.getResources()), ((View)localObject).getTop() - actn.a(18.0F, this.a.jdField_a_of_type_AndroidViewViewGroup.getResources()));
    ...
    QQSettingMe.b(this.a).setPadding(actn.a(6.0F, this.a.jdField_a_of_type_AndroidViewViewGroup.getResources()), actn.a(4.0F, this.a.jdField_a_of_type_AndroidViewViewGroup.getResources()), actn.a(6.0F, this.a.jdField_a_of_type_AndroidViewViewGroup.getResources()), actn.a(8.0F, this.a.jdField_a_of_type_AndroidViewViewGroup.getResources()));
