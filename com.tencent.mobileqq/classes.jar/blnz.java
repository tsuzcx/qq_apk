...
public class blnz
{
  ...
  private blno jdField_a_of_type_Blno = new bloa(this);
  private bloe jdField_a_of_type_Bloe;
  private JsCallParams jdField_a_of_type_CooperationQqreaderJsJsCallParams;
  
  public blnz(Activity paramActivity)
  {
  ...
  private Intent a(Activity paramActivity, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      if (paramActivity == null)
      {
        ...
        paramBundle.putExtras(blnh.a(paramBundle, 1));
      }
    ...
    str1 = bgln.a(paramActivity).a;
    String str2 = blpz.a(paramActivity);
    if (l2 != 0L) {}
    for (paramBundle = String.valueOf(l2);; paramBundle = "")
    {
      blpx.a(str1, str2, "2198", paramBundle, "2", "");
      paramActivity = a(paramActivity);
  ...
  private View a()
  {
    ...
    localTextView.setText(2131693392);
    localTextView.setTextColor(-16777216);
    localTextView.setGravity(17);
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, -2);
    localLayoutParams.addRule(13);
    localTextView.setPadding(0, bggq.a(this.jdField_a_of_type_AndroidAppActivity, 120.0F), 0, 0);
    localRelativeLayout.addView(localTextView, localLayoutParams);
    this.jdField_a_of_type_AndroidWidgetTextView = localTextView;
    bloh.a().a(this.jdField_a_of_type_AndroidAppActivity, localImageView);
  ...
  {
    boolean bool = blpe.a();
    blpu.e("ReaderSplashImpl", "jumpToPlugin: isUseShadow = " + bool);
    if (bool)
    {
      blpe.a(this.jdField_a_of_type_AndroidAppActivity, paramIntent, "com.qqreader.pureader.SSReaderActivity", new bloc(this));
      return;
    }
  ...
  private void a(View paramView)
  {
    ...
    {
      blpu.a("ReaderSplashImpl", "showLoadingView: mContentView == null");
      return;
    }
  ...
  private void a(JsCallParams paramJsCallParams)
  {
    if (blnn.a().a())
    {
      ReaderJsPluginProxy localReaderJsPluginProxy = blnn.a().a(new blob(this));
      ...
      for (;;)
      {
        d();
        return;
        blpu.a("ReaderSplashImpl", "checkPluginForHandleSpecialJsCall: plugin is ready but jsPluginProxy is null");
      }
    }
  ...
  private void b(@NonNull Bundle paramBundle)
  {
    if (this.jdField_a_of_type_AndroidAppActivity == null) {
      blpu.a("ReaderSplashImpl", "doJump: activity is null");
    }
    Intent localIntent;
    do
    {
    ...
    localIntent.putExtra("login_interval", blpz.a(BaseApplicationImpl.getApplication()));
  ...
  private void c()
  {
    ...
    {
      blpu.a("ReaderSplashImpl", "handlePendingJumpPluginIntent: mPendingJumpPluginIntent == null");
      return;
    }
    ...
    {
      blpu.b("ReaderSplashImpl", "handlePendingJumpPluginIntent: activity is destroyed");
      return;
    }
    blnh.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidContentIntent, "com.qqreader.pureader.SSReaderActivity", new blod(this));
  ...
  public void a()
  {
    blpu.d("ReaderSplashImpl", "onCreate");
    ...
    {
      this.jdField_a_of_type_Bloe = new bloe(this, null);
      this.jdField_a_of_type_AndroidAppActivity.registerReceiver(this.jdField_a_of_type_Bloe, (IntentFilter)localObject);
    }
  ...
  public void b()
  {
    if (this.jdField_a_of_type_Bloe != null)
    {
      this.jdField_a_of_type_AndroidAppActivity.unregisterReceiver(this.jdField_a_of_type_Bloe);
