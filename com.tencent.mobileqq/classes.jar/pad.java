  ...
  extends pbh
{
  ...
  public pad(AppInterface paramAppInterface, aukn paramaukn, ExecutorService paramExecutorService, pou parampou, Handler paramHandler)
  {
  ...
  private void b()
  {
    ...
    Object localObject = this.jdField_a_of_type_Aukn.a(ChannelInfo.class, true, null, null, null, null, null, null);
    if (localObject == null)
    {
  ...
  private void i(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 2) {
      if ((j == 0) && (paramToServiceMsg.msg_ks_get_subscribed_list_rsp.has()) && (((oidb_cmd0xd46.KsGetSubscribedListRsp)paramToServiceMsg.msg_ks_get_subscribed_list_rsp.get()).bytes_ks_subscribed_list.has()))
      {
        ...
        osm.a().a(new pae(this, j, paramToServiceMsg));
      }
    }
    while (i != 1) {
      for (;;)
  ...
  protected ToServiceMsg a(ppa paramppa)
  {
    ...
    if (paramppa.jdField_a_of_type_Boolean) {
      ((oidb_cmd0x69f.ReqBody)localObject).uint32_req_all_channel_list.set(1);
    }
    if (paramppa.jdField_b_of_type_Boolean) {
    ...
    for (;;)
    {
      ...
      ((oidb_cmd0x69f.ReqBody)localObject).uint32_important.set(paramppa.jdField_b_of_type_Int);
      ((oidb_cmd0x69f.ReqBody)localObject).uint32_req_channel_id.set(paramppa.jdField_c_of_type_Int);
      ((oidb_cmd0x69f.ReqBody)localObject).uint32_req_channel_cover.set(paramppa.jdField_d_of_type_Int);
      ((oidb_cmd0x69f.ReqBody)localObject).uint32_req_channel_seq.set(paramppa.jdField_e_of_type_Int);
      localObject = pow.a("OidbSvc.0x69f", 1695, 0, ((oidb_cmd0x69f.ReqBody)localObject).toByteArray());
      ((ToServiceMsg)localObject).getAttributes().put(c, Integer.valueOf(paramppa.jdField_a_of_type_Int));
      ((ToServiceMsg)localObject).getAttributes().put("debug", Boolean.valueOf(paramppa.l));
      return localObject;
  ...
  public void a(int paramInt1, int paramInt2, List<Integer> paramList, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    ((oidb_cmd0x908.ReqBody)localObject).uint64_uin.set(Long.valueOf(onk.a()).longValue());
    ...
    for (;;)
    {
      ...
      localObject = pow.a("OidbSvc.0x908", 2312, 0, ((oidb_cmd0x908.ReqBody)localObject).toByteArray());
  ...
  public void a(String paramString)
  {
    ...
    localObject = pow.a("OidbSvc.0xd46", 3398, 0, ((oidb_cmd0xd46.ReqBody)localObject).toByteArray());
  ...
  public void a(boolean paramBoolean, int paramInt, List<Integer> paramList)
  {
    ...
    localReqBody.uint64_uin.set(Long.valueOf(onk.a()).longValue());
    if (paramBoolean)
    {
      ...
      a(pow.a("OidbSvc.0x8f5", 2293, 0, localReqBody.toByteArray()));
      if (QLog.isColorLevel()) {
        if (paramList != null) {
          break label150;
        }
  ...
  public void b(List<Integer> paramList)
  {
    ...
    localObject = pow.a("OidbSvc.0x69e", 1694, 0, ((oidb_cmd0x69e.ReqBody)localObject).toByteArray());
  ...
  {
    Object localObject = new ppa();
    ((ppa)localObject).jdField_a_of_type_Int = 4;
    ((ppa)localObject).jdField_a_of_type_Boolean = true;
    ((ppa)localObject).jdField_b_of_type_Boolean = true;
    ((ppa)localObject).jdField_c_of_type_Boolean = false;
    ((ppa)localObject).jdField_d_of_type_Boolean = true;
    ((ppa)localObject).j = true;
    ((ppa)localObject).k = true;
    ((ppa)localObject).jdField_e_of_type_Boolean = false;
    ((ppa)localObject).f = false;
    ((ppa)localObject).g = false;
    ((ppa)localObject).h = false;
    ((ppa)localObject).jdField_b_of_type_Int = 1;
    ((ppa)localObject).l = paramBoolean;
    localObject = a((ppa)localObject);
  ...
  protected void c(List<qat> paramList)
  {
    if (paramList == null) {
      return;
    }
    ...
    while (paramList.hasNext())
    {
      Iterator localIterator = ((qat)paramList.next()).a.iterator();
  ...
  protected void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (j == 0) {
      if (i == 1)
      {
        ...
        {
          paramObject = pot.a(localRspBody.rpt_channel_list.get());
  ...
  public List<ChannelInfo> e()
  {
    ...
    Collections.sort((List)localObject1, new paf(this));
  ...
  {
    if (pow.a(paramFromServiceMsg, paramObject, new oidb_cmd0x69e.RspBody()) == 0) {}
  ...
  public List<Integer> g()
  {
    ...
    Collections.sort((List)localObject1, new pag(this));
    localObject2 = new ArrayList(((ArrayList)localObject1).size());
    localObject1 = ((ArrayList)localObject1).iterator();
    while (((Iterator)localObject1).hasNext()) {
  ...
  {
    int i = pow.a(paramFromServiceMsg, paramObject, new oidb_cmd0x8f5.RspBody());
    if (QLog.isColorLevel()) {
  ...
  public void h(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int k = pow.a(paramFromServiceMsg, paramObject, (MessageMicro)localObject);
    boolean bool1;
    if (k == 0)
    {
