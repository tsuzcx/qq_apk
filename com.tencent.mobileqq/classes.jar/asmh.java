  ...
  extends aslt
{
  ...
  public asmh(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, asmr paramasmr, BaseChatPie paramBaseChatPie)
  {
    super(paramQQAppInterface, paramContext, paramInt1, paramInt2, paramInt3, paramasmr);
    this.jdField_a_of_type_Asob = new asmi(this);
  ...
  private void a(URLImageView paramURLImageView, ImageView paramImageView)
  {
    ...
    if (localURLDrawable.getStatus() == 0)
    {
      ...
      if (!(paramImageView.getDrawable() instanceof Animatable)) {
        paramImageView.setImageDrawable((Drawable)BaseApplication.getContext().getResources().getDrawable(2130839410));
      }
  ...
  private RelativeLayout b()
  {
    ...
    ((ImageView)localObject).setId(2131365948);
  ...
  {
    if ((paramView == null) || (!(paramaspq instanceof asmg))) {
      QLog.e("CameraEmotionAdapter", 1, "emotionInfo or contentView = null");
    }
    for (;;)
    {
      return;
      Object localObject = (URLImageView)paramView.findViewById(2131365947);
      asmg localasmg = (asmg)paramaspq;
      paramView.setTag(localasmg);
      paramView.setVisibility(0);
      if ((QLog.isColorLevel()) && (!bhsr.a(localasmg.i))) {
        QLog.d("CameraEmotionAdapter", 2, "updateUI info = " + localasmg.i);
      }
      if (((URLImageView)localObject).getTag(2131381109) != paramaspq)
      {
        ((URLImageView)localObject).setTag(2131381109, paramaspq);
        paramaspq = (ImageView)paramView.findViewById(2131365948);
        ...
        if ("cameraEdit".equals(localasmg.i))
        {
          ((URLImageView)localObject).setImageDrawable(null);
          ((URLImageView)localObject).setBackgroundResource(2130847119);
          paramaspq.setVisibility(4);
          paramView.setVisibility(4);
          if (AppSetting.c) {
            ((URLImageView)localObject).setContentDescription(anzj.a(2131700222));
          }
        }
        else if ("cameraJump".equals(localasmg.i))
        {
          ((URLImageView)localObject).setImageDrawable(null);
          ((URLImageView)localObject).setBackgroundResource(2130838000);
          paramaspq.setVisibility(4);
          paramView.setVisibility(4);
          if (AppSetting.c) {
            ((URLImageView)localObject).setContentDescription(anzj.a(2131700219));
          }
        }
        else
        {
          Drawable localDrawable = localasmg.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Float);
          ((URLImageView)localObject).setBackgroundDrawable(localDrawable);
          if (localasmg.h.equals("needUpload"))
          {
            ((URLImageView)localObject).setImageDrawable(new ColorDrawable(-419430401));
            localObject = (Animatable)BaseApplication.getContext().getResources().getDrawable(2130839410);
            paramaspq.setImageDrawable((Drawable)localObject);
            ((Animatable)localObject).start();
            paramaspq.setVisibility(0);
            paramView.setVisibility(4);
          }
          while (!TextUtils.isEmpty(localasmg.d))
          {
            bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A370", "0X800A370", 0, 0, "", "", localasmg.d, "");
            return;
            if (localasmg.h.equals("failed"))
            {
              ((URLImageView)localObject).setImageDrawable(new ColorDrawable(-419430401));
              paramaspq.setVisibility(4);
              paramView.setVisibility(0);
            ...
            else
            {
              ...
              {
                ((URLImageView)localObject).setURLDrawableDownListener(new asmj(this, localasmg, (URLImageView)localObject, paramaspq));
                a((URLImageView)localObject, paramaspq);
              }
            }
          }
        }
  ...
  public View a(aslu paramaslu, int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (int i = 16;; i = 14)
    {
      paramaslu.setPadding(0, (int)(i * this.jdField_a_of_type_Float), 0, 0);
      i = 0;
  ...
  public void b()
  {
    ...
    {
      localaspr.a(localQQAppInterface, j, null, -1, i, false, new asmk(this));
      return;
    }
  }
}
