...
public class bjxp
  implements bkzq
{
  public bjxp(QidianProfileCardActivity paramQidianProfileCardActivity, bkzi parambkzi, URLDrawable paramURLDrawable, String paramString) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    do
    {
      ...
      if (paramView.equals(this.jdField_a_of_type_ComTencentQidianQidianProfileCardActivity.getString(2131693153)))
      {
      ...
      if (paramView.equals(this.jdField_a_of_type_ComTencentQidianQidianProfileCardActivity.getString(2131693159)))
      {
    ...
    } while (!paramView.equals(this.jdField_a_of_type_ComTencentQidianQidianProfileCardActivity.getString(2131697986)));
