...
public class anns
{
  private static int a(String paramString, int paramInt, StringBuilder paramStringBuilder, QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      do
      {
        ...
        paramString = bfwn.a(MessageRecord.getOldTableName(paramString, paramInt), MessageRecord.getTableName(paramString, paramInt), paramQQAppInterface, localStringBuilder.toString());
  ...
  private static String a(String paramString, int paramInt, QQAppInterface paramQQAppInterface)
  {
    ...
    paramInt = ((amwo)paramQQAppInterface.getManager(92)).a(paramString, paramInt, localStringBuilder);
  ...
  {
    List localList = paramQQAppInterface.getMessageFacade().getMsgList(paramString1, paramInt);
    ...
    for (long l1 = ((MessageRecord)localList.get(localList.size() - 1)).time + 2L;; l1 = 0L) {
      for (;;)
      {
        paramQQAppInterface.getMessageFacade().clearHistory(paramString1, paramInt);
        paramQQAppInterface.getMessageFacade().onCurrentMessageDeleted(paramString1, paramInt);
