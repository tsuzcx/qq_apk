...
public class bftm
{
  ...
  private anau jdField_a_of_type_Anau = new bftn(this);
  ...
  private void b(String paramString)
  {
    ...
    //   52: astore 8
    //   54: aload_0
    //   55: getfield 29	bftm:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    //   58: aload 6
    ...
    //   217: aload_0
    //   218: iload_3
    //   219: putfield 15	bftm:jdField_a_of_type_Int	I
    //   222: aload 8
    //   224: ldc 239
    ...
    //   325: aload 5
    //   327: aload 11
    //   329: invokespecial 243	bftm:a	(Landroid/os/Bundle;Ljava/lang/String;Lorg/w3c/dom/Element;)V
    //   332: aload 8
    //   334: aload 11
    //   336: ldc 245
    ...
    //   401: aload 5
    //   403: aload 9
    //   405: invokespecial 243	bftm:a	(Landroid/os/Bundle;Ljava/lang/String;Lorg/w3c/dom/Element;)V
    //   408: aload 8
    //   410: ldc 247
    //   412: aload 10
    ...
    //   430: goto -196 -> 234
    //   433: aload_0
    //   434: getfield 29	bftm:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    //   437: aload 6
    //   439: aload 7
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3)
  {
    ...
    //   10: aload_1
    //   11: aload_0
    //   12: getfield 27	bftm:jdField_a_of_type_Anau	Lanau;
    ...
    //   36: aload_0
    //   37: aload_2
    //   38: invokevirtual 324	bftm:a	(Ljava/lang/String;)J
    //   41: lstore 6
    //   43: aload_0
    //   44: aload_2
    //   45: invokevirtual 326	bftm:b	(Ljava/lang/String;)J
    //   48: lstore 8
    //   50: aload_1
    //   51: ifnull -26 -> 25
    ...
    //   70: aload_1
    //   71: bipush 34
    //   73: invokevirtual 338	com/tencent/mobileqq/app/QQAppInterface:getBusinessHandler	(I)Lcom/tencent/mobileqq/app/BusinessHandler;
    //   76: checkcast 340	anat
    //   79: aload_2
    //   80: invokevirtual 341	anat:a	(Ljava/lang/String;)V
    //   83: return
    //   84: aload_2
    //   85: ldc_w 312
    ...
    //   94: aload_0
    //   95: aload_2
    //   96: invokevirtual 348	bftm:b	(Ljava/lang/String;)Ljava/lang/String;
    //   99: astore 12
    //   101: aload_0
    //   102: ldc_w 312
    //   105: invokevirtual 173	bftm:a	(Ljava/lang/String;)Ljava/lang/String;
    //   108: astore 15
    //   110: aload 12
    //   112: invokestatic 79	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   115: istore 10
    //   117: aload_0
    //   118: getfield 15	bftm:jdField_a_of_type_Int	I
    //   121: iconst_m1
    ...
    //   134: aload_0
    //   135: aload 15
    //   137: invokevirtual 350	bftm:a	(Ljava/lang/String;)I
    //   140: putfield 15	bftm:jdField_a_of_type_Int	I
    //   143: aload_0
    //   144: getfield 15	bftm:jdField_a_of_type_Int	I
    //   147: iconst_2
    //   148: if_icmpge +6 -> 154
    //   151: iconst_1
    //   152: istore 10
    ...
    //   165: invokevirtual 354	com/tencent/qphone/base/util/BaseApplication:getAssets	()Landroid/content/res/AssetManager;
    //   168: ldc_w 356
    //   171: invokevirtual 362	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   174: astore_1
    //   175: new 364	java/io/FileOutputStream
    //   178: dup
    //   179: aload 15
    //   181: invokespecial 365	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   184: astore 11
    //   186: sipush 4096
    //   189: newarray byte
    //   191: astore_2
    //   192: aload_1
    //   193: aload_2
    //   194: invokevirtual 371	java/io/InputStream:read	([B)I
    //   197: istore 5
    //   199: iload 5
    //   201: ifle +109 -> 310
    //   204: aload 11
    ...
    //   207: iconst_0
    //   208: iload 5
    //   210: invokevirtual 377	java/io/OutputStream:write	([BII)V
    //   213: goto -21 -> 192
    //   216: astore 13
    //   218: aload_1
    //   219: astore_2
    ...
    //   233: ifnull +7 -> 240
    //   236: aload_2
    //   237: invokevirtual 380	java/io/InputStream:close	()V
    //   240: aload_1
    //   241: ifnull +7 -> 248
    //   244: aload_1
    //   245: invokevirtual 381	java/io/OutputStream:close	()V
    //   248: aload 12
    //   250: astore_1
    //   251: aload 15
    //   253: invokestatic 386	com/tencent/mobileqq/filemanager/util/FileUtil:isFileExists	(Ljava/lang/String;)Z
    //   256: ifeq +27 -> 283
    //   259: aload 15
    //   261: invokestatic 391	com/tencent/mobileqq/utils/SecUtil:getFileMd5	(Ljava/lang/String;)Ljava/lang/String;
    //   264: astore_1
    //   265: aload_0
    //   266: ldc_w 312
    //   269: aload_1
    //   270: invokevirtual 393	bftm:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   273: aload_0
    //   274: aload_0
    //   275: aload 15
    //   277: invokevirtual 350	bftm:a	(Ljava/lang/String;)I
    //   280: putfield 15	bftm:jdField_a_of_type_Int	I
    //   283: aload_1
    //   284: aload 4
    ...
    //   303: aload 4
    //   305: aload_3
    //   306: invokevirtual 396	bftm:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   309: return
    //   310: aload_1
    //   311: ifnull +7 -> 318
    //   314: aload_1
    //   315: invokevirtual 380	java/io/InputStream:close	()V
    //   318: aload 11
    //   320: ifnull -72 -> 248
    //   323: aload 11
    //   325: invokevirtual 381	java/io/OutputStream:close	()V
    //   328: goto -80 -> 248
    //   331: astore_1
    //   332: aload_1
    //   333: invokevirtual 397	java/io/IOException:printStackTrace	()V
    //   336: goto -88 -> 248
    //   339: astore_1
    //   340: aload_1
    //   341: invokevirtual 397	java/io/IOException:printStackTrace	()V
    //   344: goto -96 -> 248
    //   347: astore_2
    //   348: aconst_null
    //   349: astore_1
    ...
    //   354: ifnull +7 -> 361
    //   357: aload_1
    //   358: invokevirtual 380	java/io/InputStream:close	()V
    //   361: aload_3
    //   362: ifnull +7 -> 369
    //   365: aload_3
    ...
    //   371: astore_1
    //   372: aload_1
    //   373: invokevirtual 397	java/io/IOException:printStackTrace	()V
    //   376: goto -7 -> 369
    //   379: astore_2
    //   380: aload 13
    //   382: astore_3
