...
public class bgkw
  ...
  implements bayu
{
  private BroadcastReceiver a = new bgkx(this);
  ...
  {
    if ((paramLong == 2L) && (paramString.equals(bgkt.a))) {
      bgkt.a(this.mRuntime, null);
    }
    return false;
  }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if (paramString2.equals("qzcardstorre"))
    {
      ...
      if (paramString3.equals("setcardfinish")) {
        bgkm.a(this, this.mRuntime, paramVarArgs);
      }
      if (paramString3.equals("downloadcard"))
      {
        bgkm.a(this.mRuntime, paramVarArgs);
        return true;
      }
    }
    else
    {
      ...
      bgkr.b(this.mRuntime, paramVarArgs);
    }
    label162:
    label208:
    do
