...
{
  public aeoh(TroopMemberListActivity paramTroopMemberListActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (j == 2131365380)
        {
          ...
          if (this.a.jdField_d_of_type_Int == 20)
          {
            ...
            localObject1 = ((aepe)localObject2).a.getTag();
            ...
            localObject1 = (aeox)this.a.jdField_a_of_type_Aeoz.getItem(i);
            this.a.a((aeox)localObject1);
            break;
            i = 0;
            break label100;
            label314:
          ...
          {
            if (this.a.jdField_a_of_type_Aeoz.jdField_b_of_type_JavaUtilList.contains(localObject1)) {
              this.a.jdField_a_of_type_Aeoz.jdField_b_of_type_JavaUtilList.remove(localObject1);
            }
            for (;;)
            {
              TroopMemberListActivity.a(this.a);
              this.a.jdField_a_of_type_Aeoz.notifyDataSetChanged();
              break;
              if (i != 0) {
                this.a.jdField_a_of_type_Aeoz.jdField_b_of_type_JavaUtilList.add(localObject1);
              }
            }
          }
          if (bool1)
          {
            ...
            if (localObject2 != null) {
              ((aepe)localObject2).a.a(true);
            }
            if (!TextUtils.isEmpty(this.a.u))
            {
              localObject2 = this.a.a(this.a.u, bool1);
              if (localObject2 != null) {
                ((aepe)localObject2).a.b(true);
              }
            }
      ...
      else if ((j == 2131363868) && (this.a.c))
      {
        ...
        {
          if (this.a.isResume()) {
            QQToast.a(this.a, this.a.getString(2131694064), 0).b(this.a.getTitleBarHeight());
          }
        }
