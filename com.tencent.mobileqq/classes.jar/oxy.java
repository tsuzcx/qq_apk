...
public class oxy
{
  ...
  private final int jdField_a_of_type_Int = 133;
  ...
  private ouu jdField_a_of_type_Ouu;
  private int b = 133;
  ...
  private TemplateBean a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        if ((paramBaseArticleInfo.mProteusTemplateBean != null) && (!((rdg)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusFactoryBaseTemplateFactory).a(paramBaseArticleInfo.mProteusTemplateBean))) {
          return paramBaseArticleInfo.mProteusTemplateBean;
        }
        if (this.jdField_a_of_type_Ouu == null) {
          return null;
        }
        JSONObject localJSONObject = this.jdField_a_of_type_Ouu.a(132, paramBaseArticleInfo);
        localTemplateBean = this.jdField_a_of_type_Ouu.a(132, localJSONObject);
        try
        {
  ...
  private void a(opw paramopw, VafContext paramVafContext)
  {
    paramVafContext = paramopw.a();
    if (paramVafContext != null)
    {
      paramopw = paramVafContext.b(paramopw.g() + 1);
      if ((paramopw != null) && (paramopw.mProteusTemplateBean == null)) {
        paramopw.mProteusTemplateBean = a(paramopw);
      }
    }
  }
  ...
  private static void b(ProteusItemView paramProteusItemView)
  {
    ...
    do
    {
      ...
      if ((localContainer != null) && (localContainer.getVisibility() == 8))
      {
        ...
        aciy.a(jdField_a_of_type_JavaLangString, "", new IllegalArgumentException("container.getVisibility() == View.GONE"));
      }
    ...
    aciy.a(jdField_a_of_type_JavaLangString, "", new IllegalArgumentException("proteusItemView.getVisibility() == View.GONE"));
  }
  ...
  public int a()
  {
    if (c == 2147483647)
    {
      aciy.a(jdField_a_of_type_JavaLangString, "", new IllegalArgumentException(ajjy.a(2131637786)));
      return this.b - 132;
    }
    return c - 132;
  }
  ...
  public int a(ArticleInfo paramArticleInfo)
  {
    ...
    if ((localInteger.intValue() < 132) || (localInteger.intValue() >= this.b))
    {
      aciy.a(jdField_a_of_type_JavaLangString, "", new IllegalArgumentException(ajjy.a(2131637787)));
      return 132;
    }
  ...
  public ProteusItemView a(VafContext paramVafContext, int paramInt, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = localObject2;
        rnr.a(str, (String)localObject3, "DynamicPTS.getView", l2 - l1);
        localObject1 = localObject2;
      }
      catch (Exception localException)
      {
        ...
        aciy.a(jdField_a_of_type_JavaLangString, "getView:", new IllegalArgumentException(paramBaseArticleInfo.proteusItemsData, localException));
        continue;
      }
  ...
  public ProteusItemView a(VafContext paramVafContext, JSONObject paramJSONObject)
  {
    ...
    //   0: ldc_w 345
    //   3: iconst_1
    //   4: invokestatic 348	rdg:a	(Ljava/lang/String;Z)Lrdg;
    //   7: astore_3
    //   8: aload_3
    //   9: ifnull +64 -> 73
    //   12: aload_3
    //   13: aload_2
    //   14: invokevirtual 352	rdg:getTemplateBean	(Lorg/json/JSONObject;)Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/bean/TemplateBean;
    //   17: astore_2
    //   18: aload_1
    ...
    //   54: aconst_null
    //   55: aload_2
    //   56: invokestatic 357	oag:a	(Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/virtualview/container/Container;Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/bean/TemplateBean;Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/bean/TemplateBean;)V
    //   59: aload_3
    //   60: aload_2
    ...
    //   66: aload_1
    //   67: aload_2
    //   68: invokestatic 364	oag:a	(Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/virtualview/container/Container;Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/virtualview/core/VafContext;Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/bean/TemplateBean;)V
    //   71: aload_3
    //   72: areturn
    //   73: aconst_null
    //   74: astore_2
    ...
    //   79: aconst_null
    //   80: astore_1
    //   81: getstatic 19	oxy:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   84: iconst_1
    //   85: aload_2
    //   86: iconst_0
  ...
  public void a(ProteusItemView paramProteusItemView, int paramInt1, BaseArticleInfo paramBaseArticleInfo, VafContext paramVafContext, azwg paramazwg, qoe paramqoe, opw paramopw, int paramInt2)
  {
    beoj.a("DynamicPTS.bindData");
    long l1 = System.currentTimeMillis();
    ...
    if (oya.a()) {
      oya.a(jdField_a_of_type_JavaLangString, "[bindData] " + paramBaseArticleInfo + " adapterViewType: " + paramInt1);
    }
    Object localObject1 = localObject2;
    if (localObject2 != null)
    {
      ...
      if (localTemplateBean != null)
      {
        ...
        {
          beoj.a("DynamicPTS.bindData.reuseView");
          localObject1 = paramVafContext.getViewFactory().inflate(paramVafContext, localTemplateBean);
          if (localObject1 != null)
          {
            ((Container)localObject1).setBackgroundDrawable(paramVafContext.getContext().getResources().getDrawable(2130841186));
            paramProteusItemView.d();
            paramProteusItemView.a((Container)localObject1);
            oag.a((Container)localObject1, null, localTemplateBean);
          }
          paramBaseArticleInfo.mProteusTemplateBean = localTemplateBean;
          localObject1 = null;
          beoj.a();
    ...
    if (localTemplateBean != null)
    {
      beoj.a("DynamicPTS.bindData.compareWithOldTemplateBean");
      oag.a((Container)localObject2, (TemplateBean)localObject1, localTemplateBean);
      beoj.a();
    }
    beoj.a("DynamicPTS.bindData.bindView");
    this.jdField_a_of_type_Ouu.a(paramInt1, (Container)localObject2, paramopw, paramInt2);
    beoj.a();
    oag.a(paramInt1, (Container)localObject2, paramVafContext, paramazwg, paramqoe, paramopw, paramBaseArticleInfo);
    a(paramopw, paramVafContext);
    oag.a((Container)localObject2, paramopw, localTemplateBean);
    long l2 = System.currentTimeMillis();
    ...
    {
      rnr.a(paramBaseArticleInfo, paramProteusItemView, "DynamicPTS.bindData", l2 - l1);
      beoj.a();
      return;
    }
  }
  ...
  public void a(VafContext paramVafContext)
  {
    ...
    this.jdField_a_of_type_Ouu = new ouu(paramVafContext);
    int j = paramVafContext.getTemplateFactory().size();
    if ((this.b < j + 133) && (j > 0) && (this.b < c))
    {
  ...
  {
    return (paramInt >= 132) && (paramInt < this.b);
  }
  
  public boolean b(ArticleInfo paramArticleInfo)
  {
    return (a(paramArticleInfo)) && (a(paramArticleInfo) == 132);
  }
}
