...
{
  private lzs jdField_a_of_type_Lzs;
  mom jdField_a_of_type_Mom;
  private int i;
  
  public lzr(VideoAppInterface paramVideoAppInterface, Context paramContext, View paramView, lzs paramlzs)
  {
    super(paramVideoAppInterface, paramContext, paramView);
    this.jdField_a_of_type_Lzs = paramlzs;
    this.t = 2;
    this.jdField_a_of_type_Miw = miw.a(paramContext, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvVideoController.a().M, true);
    n();
    m();
    l();
    r();
  ...
  private void a(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      this.jdField_a_of_type_ArrayOfMee[0].a(Boolean.valueOf(true));
      this.jdField_a_of_type_ArrayOfMee[1].a(Boolean.valueOf(true));
      this.jdField_a_of_type_ArrayOfMee[2].a(Boolean.valueOf(true));
      this.jdField_a_of_type_ArrayOfMee[3].a(Boolean.valueOf(true));
      this.jdField_a_of_type_ArrayOfMee[4].a(Boolean.valueOf(true));
      if ((!this.jdField_a_of_type_ArrayOfMee[0].f()) || ((this.u != 0) && (this.u != 180)) || (this.jdField_a_of_type_ArrayOfMee[0].k())) {
        break label208;
      }
      if (this.u != 0) {
        break label181;
      }
      this.jdField_a_of_type_ArrayOfMee[0].a(0, 0, 0, this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131297609));
    }
    for (;;)
    {
      this.jdField_a_of_type_Miw.a(this.jdField_a_of_type_ComTencentAvVideoController.a(), this.jdField_a_of_type_ArrayOfMee, paramInt1, paramInt2, paramBoolean, this.u, this.o);
      return;
      label181:
      this.jdField_a_of_type_ArrayOfMee[0].a(0, this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131297609), 0, 0);
      continue;
      label208:
      this.jdField_a_of_type_ArrayOfMee[0].a(paramInt3, paramInt3, paramInt3, paramInt3);
    }
  }
  ...
  private int i()
  {
    int j = 0;
    int m;
    for (int k = 0; j < this.jdField_a_of_type_ArrayOfMee.length; k = m)
    {
      mee localmee = this.jdField_a_of_type_ArrayOfMee[j];
      String str = (String)localmee.a(0);
      m = k;
      if (localmee.a() == 0)
      {
        m = k;
  ...
  private void i(int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      m = this.jdField_a_of_type_ArrayOfMee[0].f();
      float f2 = this.jdField_a_of_type_ArrayOfMee[0].d();
      n = this.jdField_a_of_type_ArrayOfMee[0].g();
      boolean bool2 = this.jdField_a_of_type_ArrayOfMee[0].i();
      ...
      if (i1 == 4)
      {
        localObject1 = this.jdField_a_of_type_ArrayOfMee[0].a();
        k = m;
        f1 = f2;
        j = n;
        bool1 = bool2;
    ...
    int m = paramInt;
    while (m < this.jdField_a_of_type_ArrayOfMee.length) {
      if ((m < this.jdField_a_of_type_ArrayOfMee.length - 1) && (this.jdField_a_of_type_ArrayOfMee[(m + 1)].a() == 0))
      {
        n = this.jdField_a_of_type_ArrayOfMee[m].d();
        int i2 = this.jdField_a_of_type_ArrayOfMee[(m + 1)].d();
        this.jdField_a_of_type_ArrayOfMee[m].c(i2);
        this.jdField_a_of_type_ArrayOfMee[(m + 1)].c(n);
        localObject2 = this.jdField_a_of_type_ArrayOfMee[m];
        this.jdField_a_of_type_ArrayOfMee[m] = this.jdField_a_of_type_ArrayOfMee[(m + 1)];
        this.jdField_a_of_type_ArrayOfMee[(m + 1)] = localObject2;
        m += 1;
      }
      else
      {
        ...
        s_();
        ((mee)localObject2).b(null);
        ((mee)localObject2).m(true);
        ((mee)localObject2).k(false);
        ((mee)localObject2).g(false);
        ((mee)localObject2).l(true);
        ((mee)localObject2).a(null, 0);
        ((mee)localObject2).a("");
      }
    }
    u();
    if (paramInt == 0)
    {
      ...
      this.jdField_a_of_type_ArrayOfMee[0].k(k);
      this.jdField_a_of_type_ArrayOfMee[0].a(f1);
      this.jdField_a_of_type_ArrayOfMee[0].j(j);
      this.jdField_a_of_type_ArrayOfMee[0].j(bool1);
      if (i1 == 4) {
        this.jdField_a_of_type_ArrayOfMee[0].a((ImageView.ScaleType)localObject1);
      }
    }
    c(false);
  }
  ...
  private int j()
  {
    ...
    int j = 0;
    while (j < this.jdField_a_of_type_ArrayOfMee.length)
    {
      mee localmee = this.jdField_a_of_type_ArrayOfMee[j];
      String str2 = (String)localmee.a(0);
      if ((localmee.a() == 0) && (!TextUtils.isEmpty(str2)) && (!str2.equals(str1))) {
        return j;
      }
      j += 1;
    }
  ...
  private void t()
  {
    if (this.jdField_a_of_type_ArrayOfMee != null)
    {
      ...
      while (j < this.jdField_a_of_type_ArrayOfMee.length)
      {
        this.jdField_a_of_type_ArrayOfMee[j].c(-1);
        j += 1;
      }
    }
  }
  ...
  private void u()
  {
    if (this.jdField_a_of_type_ArrayOfMee[0].a() == 0)
    {
      String str1 = this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin();
      String str2 = (String)this.jdField_a_of_type_ArrayOfMee[0].a(0);
  ...
  void a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvVideoController.a().d == 4) {
      ...
      else
      {
        ...
        {
          this.jdField_a_of_type_ArrayOfMee[paramInt1].j(false);
          paramInt1 += 1;
        }
      }
    }
  ...
  void a(String paramString, int paramInt, Bitmap paramBitmap, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (k < 0)
    {
      ...
      if (k >= 0)
      {
        localmee = this.jdField_a_of_type_ArrayOfMee[k];
        localmee.a(0);
        s_();
        u();
        localmee.a(0, paramString);
        localmee.a(1, Integer.valueOf(paramInt));
        localmee.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin());
        String str = VideoLayerUI.a(paramString, paramInt);
        a(str, null);
        a(str, localmee.a());
        long l = AudioHelper.b();
        QLog.w("SmallScreenVideoLayerUI", 1, "setGlRender[setBackground], key[" + str + "], index[" + k + "], seq[" + l + "], " + localmee.c());
        boolean bool1 = bool2;
        if (paramString != null)
        {
          bool1 = bool2;
    ...
    if (j >= 0)
    {
      localmee = this.jdField_a_of_type_ArrayOfMee[j];
  ...
  void a(String paramString1, int paramInt1, String paramString2, float paramFloat, int paramInt2)
  {
    ...
    if (j >= 0)
    {
      paramString1 = this.jdField_a_of_type_ArrayOfMee[j];
      paramString1.a(0);
      s_();
      u();
  ...
  void a(String paramString, int paramInt, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    label130:
    while (lsv.a(this.jdField_a_of_type_AndroidContentContext) == 1) {
      return;
    }
    ...
    if (paramBoolean1)
    {
      ...
      if (j < 0)
      {
        ...
        localObject = this.jdField_a_of_type_ArrayOfMee[j];
        ((mee)localObject).a(paramString, paramInt);
        ((mee)localObject).a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin());
      }
    }
    for (;;)
    {
      try
      {
        a(str, ((mee)localObject).a());
        QLog.w("SmallScreenVideoLayerUI", 1, "setGlRender[RemoteHasVideo_1], key[" + str + "], index[" + j + "], " + ((mee)localObject).c());
        ...
        if (paramString != null)
        {
          ...
          paramString.a(l, this.jdField_a_of_type_Miw.b());
          paramString.k(true);
          paramString.a(0);
          s_();
          if (this.jdField_a_of_type_ComTencentAvVideoController.a().d != 4) {
      ...
      paramString = this.jdField_a_of_type_ArrayOfMee[j];
      a(str, paramString.a());
  ...
  public void a(Observable paramObservable, Object paramObject)
  {
    ...
    case 6005: 
      ...
      {
        return;
      } while (((mcq)mck.a(paramObservable)).a != 2);
      return;
    }
    o();
  ...
  boolean a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (lsv.a(this.jdField_a_of_type_AndroidContentContext) == 1) {
      return false;
    }
    int j;
    String str1;
    ...
    if (paramBoolean1)
    {
      ...
      if (j < 0)
      {
        ...
        if (k >= 0)
        {
          localObject3 = this.jdField_a_of_type_ArrayOfMee[k];
          ((mee)localObject3).a(0, str2);
          ((mee)localObject3).a(1, Integer.valueOf(1));
          ((mee)localObject3).a(str2);
        }
        try
        {
          GraphicRenderMgr.getInstance().setAccountUin(str2);
          a(str1, ((mee)localObject3).a());
        ...
        QLog.w("SmallScreenVideoLayerUI", 1, "setGlRender[LocalHasVideo_1], key[" + str1 + "], index[" + k + "], log[" + localObject1 + "], " + ((mee)localObject3).c());
    ...
    for (;;)
    {
      ...
      return true;
      localObject3 = this.jdField_a_of_type_ArrayOfMee[j];
      a(str1, ((mee)localObject3).a());
      QLog.w("SmallScreenVideoLayerUI", 1, "setGlRender[LocalHasVideo_2], key[" + str1 + "], index[" + j + "], " + ((mee)localObject3).c());
      this.jdField_a_of_type_ComTencentAvVideoController.a(l, this.jdField_a_of_type_ComTencentAvVideoController.a().d, false, false);
      label567:
  ...
  public void c(boolean paramBoolean)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.w("SmallScreenVideoLayerUI", 1, "layoutVideoView, virtical[" + paramBoolean + "], sessionType[" + locallgf.d + "], width[" + j + "], height[" + k + "]");
    }
    this.jdField_a_of_type_ArrayOfMee[0].a(0, 0, 0, 0);
    this.jdField_a_of_type_ArrayOfMee[0].b(0, 0, j, k);
    ...
    if (a(locallgf))
    {
      ...
      {
        paramBoolean = bool;
        localmiw.a(arrayOfmee, j, k, m, n, i1, paramBoolean);
        ljo.b(k, j);
      }
    }
    for (;;)
  ...
  {
    super.g(paramInt);
    if (this.jdField_a_of_type_Miw.a() != paramInt)
    {
      this.jdField_a_of_type_Miw = miw.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, paramInt, true);
      c(true);
      paramInt = 0;
      while (paramInt < this.jdField_a_of_type_ArrayOfMee.length)
      {
        this.jdField_a_of_type_ArrayOfMee[paramInt].e(this.jdField_a_of_type_Miw.b());
        a(-1049L, this.jdField_a_of_type_ArrayOfMee[paramInt]);
        paramInt += 1;
      }
    }
  }
  ...
  {
    this.jdField_a_of_type_Miw.a(this.jdField_a_of_type_ArrayOfMee, b(), c(), paramInt, this.n, this.o);
  }
  ...
  public void n()
  {
    ...
    while (j < this.jdField_a_of_type_ArrayOfMee.length)
    {
      this.jdField_a_of_type_ArrayOfMee[j].n(true);
      j += 1;
    }
  }
  ...
  void s_()
  {
    ...
    {
      this.i = j;
      if (this.jdField_a_of_type_Lzs != null) {
        this.jdField_a_of_type_Lzs.a(this.i);
      }
    }
  }
}
