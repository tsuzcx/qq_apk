...
public class lzr
{
  ...
  public static int a(Context paramContext, int paramInt)
  {
    ...
    //   4: astore 4
    //   6: ldc 97
    //   8: invokestatic 103	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   11: astore 5
    //   13: new 105	java/lang/StringBuilder
    //   16: dup
    //   17: invokespecial 108	java/lang/StringBuilder:<init>	()V
    //   20: ldc 110
    //   22: invokevirtual 114	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   25: aload_0
    //   26: invokevirtual 118	android/content/Context:getPackageName	()Ljava/lang/String;
    ...
    //   57: aconst_null
    //   58: aconst_null
    //   59: invokevirtual 131	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   62: astore 5
    //   64: aload 5
    //   66: ifnull +174 -> 240
    //   69: aload 5
    ...
    //   112: dup
    //   113: invokespecial 108	java/lang/StringBuilder:<init>	()V
    //   116: ldc 144
    //   118: invokevirtual 114	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   121: iload_3
    //   122: invokevirtual 147	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   125: ldc 149
    //   127: invokevirtual 114	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   130: iload_2
    //   131: invokevirtual 147	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   134: ldc 151
    ...
    //   142: invokestatic 157	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   145: iload_2
    //   146: istore_1
    //   147: aload 5
    //   149: ifnull +12 -> 161
    //   152: aload 5
    //   154: invokeinterface 160 1 0
    //   159: iload_2
    //   160: istore_1
    //   161: iload_1
    //   162: ireturn
    ...
    //   180: ldc 162
    //   182: aload 6
    //   184: invokestatic 165	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   187: aload 5
    //   189: astore 4
    //   191: aload_0
    //   192: iload_1
    //   193: invokestatic 167	lzr:b	(Landroid/content/Context;I)I
    //   196: istore_2
    //   197: iload_2
    //   198: istore_1
    //   199: aload 5
  ...
  public static void a(long paramLong, int paramInt, Context paramContext, boolean paramBoolean1, String paramString, boolean paramBoolean2)
  {
    ...
    try
    {
      ...
      if (AudioHelper.f()) {
        QLog.w("SmallScreenUtils", 1, "avideo actionOn isFloatWindowOpAllowed, isFloatWindowOpAllowed[" + c(paramContext) + "], isCalling[" + mtj.e(paramContext) + "], isHome[" + a(paramContext) + "], isNeedStartDialog[" + paramBoolean1 + "], actionOnFrom[" + paramInt + "], seq[" + paramLong + "]");
      }
      if (a(paramContext, paramBoolean1, paramString, paramBoolean2)) {
        bdla.b(null, "CliOper", "", "", "0X80057D8", "0X80057D8", 0, 0, "", "", "", "");
      }
      return;
    }
  ...
  public static void a(Context paramContext, lfe paramlfe)
  {
    int i = paramlfe.jdField_d_of_type_Int;
    int j = paramlfe.F;
    int k = paramlfe.jdField_g_of_type_Int;
    if (QLog.isColorLevel())
    {
    ...
    if (paramlfe.jdField_a_of_type_Lff.jdField_b_of_type_Int > 0) {
      if (paramlfe.jdField_a_of_type_Lfg.a > 0L) {
        paramlfe = "0X8005A49";
      }
    }
    for (;;)
    {
      if ((paramlfe != null) && (c(paramContext))) {
        bdla.b(null, "CliOper", "", "", paramlfe, paramlfe, 0, 0, "", "", "", "");
      }
      return;
      if (paramlfe.jdField_a_of_type_Lff.jdField_b_of_type_Int == 5)
      {
        paramlfe = "0X8005A48";
      }
      else
  ...
  public static void a(View paramView, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramView != null)
    {
      localObject = paramView.getTag(2131373436);
      if (localObject != null) {
        break label190;
      }
      bool = false;
      ...
      localObject = paramView.getTag(2131373437);
      if (localObject != null) {
        break label203;
      }
      bool = false;
    ...
    for (Object localObject = new AlphaAnimation(0.0F, 1.0F);; localObject = new AlphaAnimation(1.0F, 0.0F))
    {
      ...
      localAnimationSet.setAnimationListener(new lzs(paramView, paramBoolean1));
      paramView.startAnimation(localAnimationSet);
      paramView.setVisibility(0);
      paramView.setTag(2131373437, Boolean.valueOf(paramBoolean1));
      paramView.setTag(2131373436, Boolean.valueOf(paramBoolean2));
      return;
        ...
        if (paramVideoAppInterface.getApp() != null)
        {
          ...
          if (paramVideoAppInterface.a() != null)
          {
            ...
            if (paramVideoAppInterface.a().a() != null)
            {
              ...
              if ((((lfe)localObject).jdField_d_of_type_Int == 3) || (((lfe)localObject).jdField_d_of_type_Int == 4)) {
                str = String.valueOf(((lfe)localObject).jdField_g_of_type_Long);
              }
              ...
              mur.a((Intent)localObject, paramLong);
  ...
  public static boolean a(Context paramContext)
  {
    ...
    {
      lbd.h("SmallScreenUtils", paramContext.getMessage());
      return bool2;
    }
    return bool3;
  }
  ...
  public static boolean e(Context paramContext)
  {
    ...
    do
    {
      ...
      bool2 = mrs.a(jdField_b_of_type_ArrayOfJavaLangString, paramContext.getClassName());
      bool1 = bool2;
      if (!QLog.isDevelopLevel()) {
        break;
      }
  ...
  public static boolean f()
  {
    ...
    for (;;)
    {
      ...
      {
        bool1 = bool2;
        if (localmah.jdField_b_of_type_Int > 0) {
          bool1 = false;
        }
      }
    }
  ...
  public static boolean g()
  {
    ...
    for (;;)
    {
      ...
      {
        bool1 = bool2;
        if (localmah.jdField_d_of_type_Int > 0) {
          bool1 = false;
        }
      }
    }
