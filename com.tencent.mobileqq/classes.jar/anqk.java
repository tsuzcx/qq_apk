  ...
  extends WebViewPlugin
{
  ...
  private final BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new anql(this);
  private AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface;
  private EIPCResultCallback jdField_a_of_type_EipcEIPCResultCallback = new anqm(this);
  ...
  private void c(Bundle paramBundle)
  {
    ...
    if (paramBundle.isSuccess())
    {
      ...
      localazrb.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne = paramBundle;
      localazrb.jdField_a_of_type_ComTencentMobileqqDataCard = new Card();
      localazrb.jdField_a_of_type_ComTencentMobileqqDataCard.uin = AppConstants.BABY_Q_UIN;
      FriendProfileCardActivity.a(this.mRuntime.a(), localazrb, AppConstants.BABY_Q_UIN, 0, paramBundle.h);
    }
  }
  ...
  {
    anqq.a().a(paramString, paramBundle, this.jdField_a_of_type_EipcEIPCResultCallback);
  }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if (paramString3.equals("reportFriend"))
    {
      ...
      if (paramJsBridgeListener.isSuccess())
      {
        ...
        aaqo.a((BaseActivity)this.mRuntime.a(), AppConstants.BABY_Q_UIN, null, this.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount(), 21001, paramJsBridgeListener);
      }
      return true;
    }
