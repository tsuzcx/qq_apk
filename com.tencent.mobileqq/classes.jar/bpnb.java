  ...
  implements bpuf
{
  ...
  public bpnb(String paramString, int paramInt1, int paramInt2, long paramLong1, long paramLong2)
  {
  ...
  public bpug a(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 <= paramInt2)
    {
      ...
      localbpug.jdField_a_of_type_JavaIoFile = ((File)localObject);
      if (paramInt2 < 1280) {
        break label278;
      }
      localObject = "720p";
    ...
    label278:
    label307:
    for (localbpug.jdField_a_of_type_Int = ((int)(819200 * 1.0D / paramInt1 * paramInt2));; localbpug.jdField_a_of_type_Int = 819200)
    {
      localbpug.jdField_a_of_type_Float = (paramInt1 / paramInt2);
      paramInt2 = i;
      if (this.jdField_b_of_type_Int <= 30) {
        paramInt2 = this.jdField_b_of_type_Int;
      }
      localbpug.jdField_b_of_type_Int = paramInt2;
