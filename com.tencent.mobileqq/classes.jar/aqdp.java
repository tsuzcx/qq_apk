  ...
  extends aqdt
{
  ...
  public aqdp(Context paramContext, int paramInt, SensorManager paramSensorManager, aqdl paramaqdl)
  {
    super(paramContext, paramInt, paramSensorManager, paramaqdl);
    paramContext = paramSensorManager.getDefaultSensor(4);
    paramaqdl = paramSensorManager.getDefaultSensor(1);
    paramSensorManager = paramSensorManager.getDefaultSensor(2);
    if ((paramContext != null) && (paramaqdl != null) && (paramSensorManager != null))
    {
      this.jdField_a_of_type_JavaUtilList.add(paramContext);
      this.jdField_a_of_type_JavaUtilList.add(paramaqdl);
  ...
  private void a(SensorEvent paramSensorEvent)
  {
    ...
    if (!this.jdField_c_of_type_Boolean)
    {
      ...
      arrayOfFloat = aqdn.a(this.k);
      SensorManager.getOrientation(arrayOfFloat, new float[3]);
      this.l = aqdn.a(this.l, arrayOfFloat);
    ...
    if ((this.jdField_a_of_type_Float != 0.0F) && (this.jdField_c_of_type_Boolean))
    {
      ...
      arrayOfFloat = new float[9];
      aqdn.c(arrayOfFloat, this.jdField_d_of_type_ArrayOfFloat);
      this.l = aqdn.a(this.l, arrayOfFloat);
      SensorManager.getOrientation(this.l, this.e);
      e();
      if ((this.jdField_a_of_type_Int == 1) && (this.jdField_a_of_type_Aqdl != null)) {
  ...
  private void b(float paramFloat1, float paramFloat2, float paramFloat3, long paramLong)
  {
    ...
    this.jdField_a_of_type_Aqdl.updateGyroscope(paramFloat1, paramFloat2, paramFloat3, paramLong);
  }
  ...
  private void e()
  {
    ...
    for (;;)
    {
      this.l = aqdn.a(this.f);
      aqdn.a(this.l, this.m);
