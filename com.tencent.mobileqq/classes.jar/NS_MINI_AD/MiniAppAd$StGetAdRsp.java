...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26 }, new String[] { "extInfo", "strAdsJson", "strAdTemplateJson" }, new Object[] { null, "", "" }, StGetAdRsp.class);
