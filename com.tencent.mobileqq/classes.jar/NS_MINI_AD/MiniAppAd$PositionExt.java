  ...
  extends MessageMicro<PositionExt>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 34, 42 }, new String[] { "share_info", "deep_link_version", "get_ad_type", "specified_ads", "sub_position_id" }, new Object[] { null, localInteger, localInteger, null, "" }, PositionExt.class);
  }
}
