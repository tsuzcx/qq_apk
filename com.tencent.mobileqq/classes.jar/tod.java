  ...
  extends XBaseAdapter
{
  ...
  public tod(QQLSActivity paramQQLSActivity) {}
  ...
  private View b(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView != null)
    {
      ...
      if (!(paramViewGroup instanceof toh)) {}
    }
    for (paramViewGroup = (toh)paramViewGroup;; paramViewGroup = null)
    {
      ...
      {
        paramView = this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.getLayoutInflater().inflate(2130970425, null);
        localObject = new toh();
        ((toh)localObject).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370431));
        ((toh)localObject).jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView = ((DragTextView)paramView.findViewById(2131370435));
        ((toh)localObject).jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setOnModeChangeListener(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragFrameLayout);
        ((toh)localObject).jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setDragViewType(0);
        paramView.setTag(localObject);
      }
      ((toh)localObject).jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setTag(Integer.valueOf(paramInt));
      ((toh)localObject).jdField_a_of_type_AndroidWidgetTextView.setText(localRecentBaseData.b);
      ((toh)localObject).jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setVisibility(0);
      CustomWidgetUtil.a(((toh)localObject).jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView, 3, 1, 0);
      return paramView;
    }
  }
  ...
  public View a(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView != null)
    {
      ...
      if ((paramView.getTag() instanceof toe)) {}
    }
    else
    {
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.getLayoutInflater().inflate(2130970426, null);
      paramView = new toe();
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)((View)localObject1).findViewById(2131370431));
      paramView.jdField_b_of_type_AndroidWidgetTextView = ((TextView)((View)localObject1).findViewById(2131370432));
      paramView.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView = ((DragTextView)((View)localObject1).findViewById(2131370435));
    ...
    toe localtoe = (toe)((View)localObject1).getTag();
    localtoe.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setTag(Integer.valueOf(paramInt));
    int i = 0;
    ...
    for (;;)
    {
      ...
      if ((((RecentBaseData)localObject3).a() == 0) || (((RecentBaseData)localObject3).a() == 3000) || (((RecentBaseData)localObject3).a() == 8)) {
        if (j > 0)
        {
          ...
          if ((paramView == null) || (paramView.size() <= 0))
          {
            ...
            localtoe.jdField_a_of_type_AndroidWidgetTextView.setText(((RecentBaseData)localObject3).b);
            localtoe.jdField_b_of_type_AndroidWidgetTextView.setText(((RecentBaseData)localObject3).jdField_c_of_type_JavaLangString);
            ...
            localtoe.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setVisibility(4);
            if ((((RecentBaseData)localObject3).a().equals(AppConstants.ad)) || (((RecentBaseData)localObject3).a().equals(AppConstants.ac))) {
              localtoe.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setVisibility(8);
            }
            ...
            localtoe.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout = paramView;
            if ((paramViewGroup instanceof MessageForPtt))
            {
              ...
              ((TextView)((View)localObject1).findViewById(2131370447)).setText(paramView);
              localObject3 = (ViewGroup.MarginLayoutParams)localtoe.jdField_a_of_type_ComTencentMobileqqActivityAioItemBreathAnimationLayout.getLayoutParams();
              if (paramView.equals("")) {
                break label1563;
              }
              ...
              if (j == -1)
              {
                this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.a(localtoe, (MessageForPtt)localObject2, false, true);
                i = 2001;
              }
              if (QLog.isColorLevel()) {
                QLog.d("PTTItem->getBubbleView", 2, "fileStatus = " + i + " url " + ((MessageForPtt)localObject2).url + " uniseq " + ((MessageForPtt)localObject2).uniseq);
              }
              this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.a(localtoe, (MessageForPtt)localObject2, i, this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.a((ChatMessage)localObject2));
              ...
              if ((QQLSActivity.b()) && (localtoe.jdField_a_of_type_JavaLangStringBuilder == null)) {
                localtoe.jdField_a_of_type_JavaLangStringBuilder = new StringBuilder();
              }
              localtoe.jdField_b_of_type_Int = paramInt;
              localtoe.jdField_c_of_type_Int = paramInt;
              if (QQLSActivity.b())
              {
                localtoe.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.setContentDescription(null);
                if (!TextUtils.isEmpty(localtoe.jdField_a_of_type_JavaLangStringBuilder)) {
                  localtoe.jdField_a_of_type_JavaLangStringBuilder.replace(0, localtoe.jdField_a_of_type_JavaLangStringBuilder.length(), "");
                }
      ...
      try
      {
        ...
        localtoe.jdField_a_of_type_JavaLangStringBuilder.append(paramView).append(" ");
        localtoe.jdField_a_of_type_ComTencentMobileqqDataChatMessage = ((ChatMessage)paramViewGroup);
        ...
        if ((((RecentBaseData)localObject3).a() == 1001) || (((RecentBaseData)localObject3).a() == 1010) || (((RecentBaseData)localObject3).a() == 10002))
        {
          ...
          {
            ((RecentBaseData)localObject3).b = BaseApplicationImpl.getApplication().getString(2131437996);
            this.jdField_a_of_type_JavaLangCharSequence = BaseApplicationImpl.getApplication().getString(2131437997);
          ...
          {
            ((RecentBaseData)localObject3).b = BaseApplicationImpl.getApplication().getString(2131437998);
            this.jdField_a_of_type_JavaLangCharSequence = BaseApplicationImpl.getApplication().getString(2131437999);
        ...
        break label398;
        label1536:
        localtoe.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setVisibility(0);
        CustomWidgetUtil.a(localtoe.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView, 3, j + i, 0);
        break label464;
        label1563:
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView != null)
    {
      ...
      if ((paramView.getTag() instanceof tog)) {}
    }
    else
    {
      paramViewGroup = this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.getLayoutInflater().inflate(2130970424, null);
      paramView = new tog();
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131370431));
      paramView.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131370449));
      paramView.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131370432));
      paramView.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView = ((DragTextView)paramViewGroup.findViewById(2131370435));
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131370448));
      paramViewGroup.setTag(paramView);
      paramView.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setOnModeChangeListener(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragFrameLayout);
      paramView.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setDragViewType(0);
    }
    RecentBaseData localRecentBaseData = (RecentBaseData)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt);
    tog localtog = (tog)paramViewGroup.getTag();
    localtog.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setTag(Integer.valueOf(paramInt));
    paramInt = 0;
    int j = 0;
    ...
    if (paramInt != 0)
    {
      ...
      localtog.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      ...
      localtog.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-4210755);
      if (QLog.isColorLevel()) {
        QLog.d("QQLSActivity", 2, "recentList misscallMsg size = 0");
      }
      label425:
      localtog.jdField_c_of_type_AndroidWidgetTextView.setText(localRecentBaseData.jdField_c_of_type_JavaLangString);
    }
    label490:
    label503:
    Object localObject;
    for (;;)
    {
      ...
      localtog.jdField_a_of_type_AndroidWidgetTextView.setText(localRecentBaseData.b);
      localtog.jdField_b_of_type_AndroidWidgetTextView.setText(new QQText(this.jdField_a_of_type_JavaLangCharSequence, 5, 16, localRecentBaseData.a()));
      localtog.jdField_c_of_type_AndroidWidgetTextView.setText(localRecentBaseData.jdField_c_of_type_JavaLangString);
      ...
      label640:
      if ((!TextUtils.equals(localRecentBaseData.a(), AppConstants.at)) || (localRecentBaseData.a() != 7220))
      {
        j = paramInt;
        if (TextUtils.equals(localRecentBaseData.a(), AppConstants.as))
        {
          j = paramInt;
      ...
      localtog.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setVisibility(4);
      label716:
      ...
      localtog.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setVisibility(8);
      ...
      this.jdField_a_of_type_JavaLangCharSequence = ((MessageRecord)paramView.get(paramView.size() - 1)).msg;
      localtog.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-570319);
      break label425;
      label1019:
      localtog.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
    ...
    if ((localRecentBaseData.a() == 1001) || (localRecentBaseData.a() == 1010) || (localRecentBaseData.a() == 10002))
    {
      if (localRecentBaseData.a().equals(AppConstants.ad))
      {
        localRecentBaseData.b = BaseApplicationImpl.getApplication().getString(2131437996);
        this.jdField_a_of_type_JavaLangCharSequence = BaseApplicationImpl.getApplication().getString(2131437997);
        paramView = DeviceProfileManager.a().a(DeviceProfileManager.DpcNames.OneyWayDateMsgNotifyCfg.name());
        if (paramView.length() > 0)
        {
      ...
      for (;;)
      {
        ...
        if (localRecentBaseData.a().equals(AppConstants.ac))
        {
          localRecentBaseData.b = BaseApplicationImpl.getApplication().getString(2131437998);
          this.jdField_a_of_type_JavaLangCharSequence = BaseApplicationImpl.getApplication().getString(2131437999);
          paramView = DeviceProfileManager.a().a(DeviceProfileManager.DpcNames.OneyWayLBSFriendMsgNotifyCfg.name());
          if (paramView.length() > 0)
          {
        ...
        else
        {
          ...
          if (localMessage.msgtype == -2053)
          {
            ...
            this.jdField_a_of_type_JavaLangCharSequence = (this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.getString(2131437882) + (String)localObject + paramView.msg);
          }
          else
          {
    ...
    for (paramView = PublicAccountConfigUtil.a(QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity), BaseApplicationImpl.getContext()) + ":";; paramView = "")
    {
      ...
      break label503;
      label1809:
      localtog.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setVisibility(0);
      CustomWidgetUtil.a(localtog.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView, 3, j + i, 0);
      break label716;
      label1836:
      break label640;
      label1839:
