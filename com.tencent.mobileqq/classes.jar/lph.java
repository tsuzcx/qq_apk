  ...
  implements lpg
{
  ...
  private final List<lpo> jdField_a_of_type_JavaUtilList = new ArrayList(11);
  ...
  private void d()
  {
    ...
    if (this.jdField_a_of_type_Int < 3)
    {
      ...
      if ((!TextUtils.isEmpty(str)) && (!bbdx.a(str))) {
        break label223;
      }
  ...
  private void e()
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Lpn.a(0, this.jdField_a_of_type_JavaUtilList);
      Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
      while (localIterator.hasNext())
      {
        lpo locallpo = (lpo)localIterator.next();
        if (locallpo != null) {
          switch (locallpo.jdField_a_of_type_Int)
          {
          default: 
            break;
          case 1: 
            localAEFilterManager.setSmoothLevel(locallpo.d);
            break;
          case 2: 
          case 3: 
            localAEFilterManager.setBeautyOrTransformLevel(locallpo.jdField_a_of_type_ComTencentTtpicOpenapiConfigBeautyRealConfig$TYPE, locallpo.d);
          }
        }
      }
  ...
  public int a(int paramInt, boolean paramBoolean1, lpx paramlpx, boolean paramBoolean2)
  {
    ...
    paramlpx.a(a(), (float)a(), paramBoolean2);
    return paramInt;
  }
  ...
  {
    boolean bool;
    if ((!lqi.a(this.jdField_a_of_type_ComTencentAvBusinessManagerPendantPendantItem, paramPendantItem)) || (this.jdField_a_of_type_ComTencentTtpicOpenapiModelVideoMaterial != paramVideoMaterial))
    {
      if (QLog.isColorLevel())
      {
  ...
  public void a(FilterDesc paramFilterDesc)
  {
    ...
    if (!lqi.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc, paramFilterDesc))
    {
      ...
      str = a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc);
      if ((this.jdField_a_of_type_ComTencentAekitApiStandardFilterAEFilterManager == null) || ((!TextUtils.isEmpty(str)) && (!bbdx.a(str)))) {
        break label112;
      }
      this.jdField_a_of_type_ComTencentAekitApiStandardFilterAEFilterManager.updateLutGL(str);
      if (QLog.isColorLevel())
  ...
  public void a(lpu paramlpu, lpx paramlpx)
  {
    ...
    for (boolean bool1 = localPendantItem.hasFace();; bool1 = false)
    {
      ...
      if ((liq.a(localVideoMaterial)) && (!bool2)) {
        bool1 = false;
      }
      for (;;)
      {
        this.jdField_a_of_type_Lqj.a(paramlpu, paramlpx.jdField_a_of_type_Int, false, bool1, str1, str2);
        return;
      }
    }
  }
  ...
  public boolean a(lpn paramlpn)
  {
    ...
    for (;;)
    {
      return this.jdField_a_of_type_Lpn.b();
      this.jdField_a_of_type_Lpn.a(paramlpn);
    }
  }
