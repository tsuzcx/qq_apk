  ...
  public static void a(Context paramContext)
  {
    ...
    if (!TextUtils.isEmpty(str))
    {
      ...
      if ((l4 > 0L) || (l3 > 0L) || (l1 > 0L))
      {
        ...
        azri.a(paramContext).a("", "actSpFileStable", true, i, 0L, localHashMap, "");
        if (i == 0)
        {
          ...
          azri.a(paramContext).a("", "actSpContentStable", true, i, 0L, localHashMap, "");
        }
      }
    ...
    for (bool1 = true;; bool1 = false)
    {
      ...
      bool1 = bdhb.a(localFile.getAbsolutePath(), String.valueOf(l1), false);
