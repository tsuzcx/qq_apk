...
public class alrh
{
  ...
  {
    if (paramInt == 2052) {
      return alpo.a(2131693835);
    }
    if (paramInt == 1033) {
      return alpo.a(2131693834);
    }
    return "";
  }
  ...
  public static void a(Context paramContext)
  {
    ...
    {
      str = ammx.a(paramContext, "key_local_cache", "0");
      a("initializeAppLocale, localeIdStr:" + str);
      if (!"0".equals(str)) {
        break label182;
      }
      jdField_a_of_type_Int = 2052;
      ammx.a(paramContext, "key_local_cache", String.valueOf(jdField_a_of_type_Int));
      str = ammx.a(paramContext, "key_local_last", "0");
      if (!"0".equals(str)) {
        break label200;
      }
    ...
    {
      b = bool1;
      ammx.a(paramContext, "key_local_last", String.valueOf(jdField_a_of_type_Int));
  ...
  public static void a(Context paramContext, int paramInt)
  {
    ...
    ammx.a(paramContext, "key_local_last", String.valueOf(jdField_a_of_type_Int));
    ammx.a(paramContext, "key_local_cache", String.valueOf(paramInt));
