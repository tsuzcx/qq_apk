  ...
  implements Runnable
{
  ...
  public soo(FriendProfileCardActivity paramFriendProfileCardActivity)
  {
  ...
  public void run()
  {
    ...
    for (String str = localFriendProfileCardActivity.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a;; str = null)
    {
      ...
      for (;;)
      {
        ...
        if (localObject != null)
        {
          localFriendProfileCardActivity.jdField_m_of_type_Int = ((ApolloBaseInfo)localObject).apolloStatus;
        ...
        for (;;)
        {
          ...
          localFriendProfileCardActivity.n = ((FriendsManager)localFriendProfileCardActivity.app.getManager(50)).b(str);
          boolean bool1;
          if ((ApolloManager.a(localFriendProfileCardActivity.app) == 1) && (!localFriendProfileCardActivity.n))
          {
            bool1 = bool2;
          ...
          localFriendProfileCardActivity.jdField_m_of_type_Boolean = bool1;
          ...
          if ((i <= 0) || (arrayOfInt == null) || (arrayOfInt.length <= 0) || (localFriendProfileCardActivity.jdField_m_of_type_Int != 1) || ((i > 0) && (arrayOfInt != null) && (!ApolloActionHelper.a(str, i, arrayOfInt, localFriendProfileCardActivity.app))))
          {
            if (QLog.isColorLevel()) {
              QLog.d("FriendProfileCardActivity", 2, "roleId->" + i + " dressIds->" + arrayOfInt + " apolloStatus->" + localFriendProfileCardActivity.jdField_m_of_type_Int);
            }
