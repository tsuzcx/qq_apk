  ...
  extends AsyncTask<Integer, Integer, Integer>
{
  ...
  public agjq(ArrayList<agkf> paramArrayList)
  {
    Object localObject;
    this.jdField_a_of_type_ArrayOfAgkf = ((agkf[])localObject.toArray(new agkf[0]));
  }
  ...
  protected Integer a(Integer... paramVarArgs)
  {
    ...
    //   46: istore 4
    //   48: aload_0
    //   49: getfield 20	agjq:jdField_a_of_type_Boolean	Z
    //   52: ifne +8 -> 60
    //   55: iconst_1
    ...
    //   86: aastore
    //   87: invokevirtual 82	agjq:publishProgress	([Ljava/lang/Object;)V
    //   90: iload 4
    //   92: tableswitch	default:+1053 -> 1145, 0:+1060->1152, 1:+413->505, 2:+1060->1152
    //   121: aload_0
    //   122: getfield 31	agjq:jdField_a_of_type_ArrayOfAgkf	[Lagkf;
    //   125: arraylength
    //   126: if_icmpge +1038 -> 1164
    //   129: aload_0
    //   130: getfield 20	agjq:jdField_a_of_type_Boolean	Z
    //   133: ifne +8 -> 141
    //   136: iconst_1
    ...
    //   161: idiv
    //   162: aload_0
    //   163: getfield 31	agjq:jdField_a_of_type_ArrayOfAgkf	[Lagkf;
    //   166: arraylength
    //   167: idiv
    //   168: iadd
    //   169: ldc 78
    ...
    //   181: aastore
    //   182: invokevirtual 82	agjq:publishProgress	([Ljava/lang/Object;)V
    //   185: aload_0
    //   186: getfield 31	agjq:jdField_a_of_type_ArrayOfAgkf	[Lagkf;
    //   189: iload_2
    //   190: aaload
    //   191: astore 8
    //   193: ldc 84
    //   195: aload 8
    //   197: getfield 87	agkf:jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData	Lcom/tencent/mobileqq/activity/aio/photo/AIORichMediaData;
    //   200: invokevirtual 93	java/lang/Class:isInstance	(Ljava/lang/Object;)Z
    //   203: ifeq +289 -> 492
    //   206: aload 8
    //   208: getfield 87	agkf:jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData	Lcom/tencent/mobileqq/activity/aio/photo/AIORichMediaData;
    ...
    //   236: aload_0
    //   237: aload 8
    //   239: putfield 106	agjq:jdField_a_of_type_Agkf	Lagkf;
    //   242: aload_0
    //   243: getfield 20	agjq:jdField_a_of_type_Boolean	Z
    //   246: ifeq +164 -> 410
    //   249: aload 9
    //   251: ifnull +18 -> 269
    ...
    //   266: ifne +144 -> 410
    //   269: aload_0
    //   270: getfield 106	agjq:jdField_a_of_type_Agkf	Lagkf;
    //   273: iconst_1
    //   274: putfield 115	agkf:jdField_a_of_type_Boolean	Z
    //   277: aload_0
    //   278: getfield 15	agjq:jdField_a_of_type_Agji	Lagji;
    //   281: getfield 120	agji:jdField_a_of_type_Agki	Lagki;
    //   284: aload 7
    ...
    //   300: aload_0
    //   301: getfield 106	agjq:jdField_a_of_type_Agkf	Lagkf;
    //   304: astore 8
    //   306: aload 8
    //   308: monitorenter
    //   309: aload_0
    //   310: getfield 106	agjq:jdField_a_of_type_Agkf	Lagkf;
    //   313: getfield 115	agkf:jdField_a_of_type_Boolean	Z
    //   316: ifeq +10 -> 326
    //   319: aload_0
    //   320: getfield 106	agjq:jdField_a_of_type_Agkf	Lagkf;
    ...
    //   381: aload_0
    //   382: aload_0
    //   383: getfield 31	agjq:jdField_a_of_type_ArrayOfAgkf	[Lagkf;
    //   386: arraylength
    //   387: iload_2
    //   388: isub
    //   389: putfield 147	agjq:jdField_a_of_type_Int	I
    //   392: bipush 11
    ...
    //   409: areturn
    //   410: aload_0
    //   411: getfield 20	agjq:jdField_a_of_type_Boolean	Z
    //   414: ifne +8 -> 422
    //   417: iconst_1
    ...
    //   475: aload_0
    //   476: aload_0
    //   477: getfield 31	agjq:jdField_a_of_type_ArrayOfAgkf	[Lagkf;
    //   480: arraylength
    //   481: iload_2
    //   482: isub
    //   483: putfield 147	agjq:jdField_a_of_type_Int	I
    //   486: bipush 11
    ...
    //   539: dup
    //   540: getstatic 172	alof:bd	Ljava/lang/String;
    ...
    //   565: iload_2
    //   566: aload_0
    //   567: getfield 31	agjq:jdField_a_of_type_ArrayOfAgkf	[Lagkf;
    //   570: arraylength
    //   571: if_icmpge +537 -> 1108
    //   574: aload_0
    //   575: getfield 31	agjq:jdField_a_of_type_ArrayOfAgkf	[Lagkf;
    //   578: iload_2
    //   579: aaload
    //   580: astore 7
    //   582: aload_0
    //   583: getfield 20	agjq:jdField_a_of_type_Boolean	Z
    //   586: ifne +8 -> 594
    //   589: iconst_1
    ...
    //   594: ldc 84
    //   596: aload 7
    //   598: getfield 87	agkf:jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData	Lcom/tencent/mobileqq/activity/aio/photo/AIORichMediaData;
    //   601: invokevirtual 93	java/lang/Class:isInstance	(Ljava/lang/Object;)Z
    //   604: ifeq +222 -> 826
    //   607: aload 7
    //   609: getfield 87	agkf:jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData	Lcom/tencent/mobileqq/activity/aio/photo/AIORichMediaData;
    ...
    //   637: idiv
    //   638: aload_0
    //   639: getfield 31	agjq:jdField_a_of_type_ArrayOfAgkf	[Lagkf;
    //   642: arraylength
    //   643: idiv
    //   644: iadd
    //   645: ldc 78
    ...
    //   657: aastore
    //   658: invokevirtual 82	agjq:publishProgress	([Ljava/lang/Object;)V
    //   661: aload 7
    //   663: iconst_2
    ...
    //   807: areturn
    //   808: aload_0
    //   809: getfield 15	agjq:jdField_a_of_type_Agji	Lagji;
    //   812: invokestatic 211	agji:a	(Lagji;)Landroid/app/Activity;
    //   815: aload 8
    //   817: invokevirtual 214	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   820: invokestatic 219	bdhj:a	(Landroid/content/Context;Ljava/lang/String;)V
    //   823: goto +364 -> 1187
    //   826: ldc 221
    //   828: aload 7
    //   830: getfield 87	agkf:jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData	Lcom/tencent/mobileqq/activity/aio/photo/AIORichMediaData;
    //   833: invokevirtual 93	java/lang/Class:isInstance	(Ljava/lang/Object;)Z
    //   836: ifeq +259 -> 1095
    //   839: aload 7
    //   841: getfield 87	agkf:jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData	Lcom/tencent/mobileqq/activity/aio/photo/AIORichMediaData;
    ...
    //   869: idiv
    //   870: aload_0
    //   871: getfield 31	agjq:jdField_a_of_type_ArrayOfAgkf	[Lagkf;
    //   874: arraylength
    //   875: idiv
    //   876: iadd
    //   877: ldc 78
    ...
    //   889: aastore
    //   890: invokevirtual 82	agjq:publishProgress	([Ljava/lang/Object;)V
    //   893: aload 10
    //   895: bipush 20
    ...
    //   1076: areturn
    //   1077: aload_0
    //   1078: getfield 15	agjq:jdField_a_of_type_Agji	Lagji;
    //   1081: invokestatic 224	agji:b	(Lagji;)Landroid/app/Activity;
    //   1084: aload 8
    //   1086: invokevirtual 214	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   1089: invokestatic 219	bdhj:a	(Landroid/content/Context;Ljava/lang/String;)V
    //   1092: goto +95 -> 1187
    //   1095: ldc 154
    //   1097: aload 7
  ...
  {
    this.jdField_a_of_type_Agji.b(paramInteger.intValue(), this.jdField_a_of_type_Int);
    this.jdField_a_of_type_Agji.jdField_a_of_type_Agjq = null;
  }
  
  protected void a(Integer... paramVarArgs)
  {
    int i = paramVarArgs[(paramVarArgs.length - 1)].intValue();
    this.jdField_a_of_type_Agji.c(i >> 16, 0xFFFF & i);
  }
}
