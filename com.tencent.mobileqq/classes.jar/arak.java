...
public class arak
{
  ...
  public static arak a()
  {
    if (jdField_a_of_type_Arak == null) {}
    try
    {
      if (jdField_a_of_type_Arak == null) {
        jdField_a_of_type_Arak = new arak();
      }
      return jdField_a_of_type_Arak;
    }
    finally {}
  }
  
  private aral a(String paramString)
  {
  ...
  private void a(aral paramaral)
  {
    if (paramaral.jdField_a_of_type_Int != 0) {
      return;
    }
    for (;;)
    {
      try
      {
        int i = Integer.valueOf(paramaral.jdField_a_of_type_JavaLangString).intValue();
        Object localObject1 = "conf_" + paramaral.jdField_a_of_type_Long + "_sharepref";
        Object localObject2 = "conf_" + paramaral.jdField_a_of_type_Long + "_content_sharepref";
        ...
        int j = ((SharedPreferences)localObject3).getInt(paramaral.jdField_a_of_type_JavaLangString, -1);
        ...
        {
          ((SharedPreferences.Editor)localObject1).remove(paramaral.jdField_a_of_type_JavaLangString);
          ...
          if (bool1)
          {
            ...
            if (j != -1)
            {
              ...
              if (localObject1 != null)
              {
                ...
                ((SharedPreferences.Editor)localObject1).putLong(paramaral.jdField_a_of_type_JavaLangString, l);
          ...
          QLog.d("QConfigJourney", 2, "deleteSpConf, entry=" + paramaral + ", success=" + bool2);
          return;
        }
      }
      catch (NumberFormatException paramaral)
      {
        return;
      }
      boolean bool1 = false;
  ...
  private void a(aral paramaral, SharedPreferences.Editor paramEditor)
  {
    Object localObject1 = null;
    if (paramaral.jdField_a_of_type_Int != 2) {}
    boolean bool2;
    label125:
    do
    {
      ...
      if (localObject2 != null)
      {
        str = paramaral.jdField_a_of_type_Int + "-" + paramaral.jdField_a_of_type_JavaLangString + "-" + paramaral.jdField_a_of_type_Long;
    ...
    QLog.d("QConfigJourney", 2, "deleteStorage, entry=" + paramaral + ", path=" + (String)localObject1 + ", success=" + bool2);
  }
  ...
  private void b(aral paramaral)
  {
    if (paramaral.jdField_a_of_type_Int != 1) {}
    for (;;)
    {
      return;
      try
      {
        ...
        String str = this.jdField_a_of_type_JavaLangString + File.separator + "qstore" + File.separator + paramaral.jdField_a_of_type_Long + File.separator + "conf" + File.separator + i;
        ...
        if (bool1)
        {
          localObject2 = "conf_" + paramaral.jdField_a_of_type_Long + "_sharepref";
          localObject1 = a((String)localObject2);
          localObject2 = a((String)localObject2);
          j = ((SharedPreferences)localObject1).getInt(paramaral.jdField_a_of_type_JavaLangString, -1);
          if ((j != -1) && (localObject2 != null)) {
            ((SharedPreferences.Editor)localObject2).remove(paramaral.jdField_a_of_type_JavaLangString + "_" + j + "_defualt");
          }
          if (localObject2 != null) {
            ((SharedPreferences.Editor)localObject2).remove(paramaral.jdField_a_of_type_JavaLangString);
          }
          localObject1 = a("q_journey_safe_mode_deleted_confs_pref");
          if (localObject1 != null)
          {
        ...
        if (QLog.isColorLevel())
        {
          QLog.d("QConfigJourney", 2, "deleteFileConf, entry=" + paramaral + ", path=" + str + ", success=" + bool1);
          return;
        }
      }
      catch (NumberFormatException paramaral) {}
  ...
  void a(int paramInt, long paramLong, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      aral localaral = new aral(i, String.valueOf(paramInt), paramLong, null);
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        this.jdField_a_of_type_JavaUtilSet.add(localaral);
  ...
  void a(String arg1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      try
      {
        paramString2 = new aral(2, ???, Long.valueOf(paramString2).longValue(), paramString3);
      }
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        if (paramBoolean)
        {
          ...
          localObject4 = (aral)((Iterator)localObject3).next();
          String str = ((aral)localObject4).jdField_a_of_type_Int + "-" + ((aral)localObject4).jdField_a_of_type_JavaLangString + "-" + ((aral)localObject4).jdField_a_of_type_Long;
          if (((aral)localObject4).jdField_a_of_type_Int == 2) {
            localEditor.putString(str, ((aral)localObject4).b);
          }
  ...
  boolean a(String paramString1, String paramString2, String paramString3)
  {
    ...
    //   26: aload_0
    //   27: ldc 249
    //   29: invokespecial 55	arak:a	(Ljava/lang/String;)Landroid/content/SharedPreferences;
    //   32: astore_2
    ...
    //   63: astore_1
    //   64: aload_0
    //   65: getfield 40	arak:jdField_a_of_type_JavaUtilConcurrentLocksReadWriteLock	Ljava/util/concurrent/locks/ReadWriteLock;
    ...
    //   86: astore_1
    //   87: aload_0
    //   88: getfield 40	arak:jdField_a_of_type_JavaUtilConcurrentLocksReadWriteLock	Ljava/util/concurrent/locks/ReadWriteLock;
    ...
    //   107: astore_1
    //   108: aload_0
    //   109: getfield 40	arak:jdField_a_of_type_JavaUtilConcurrentLocksReadWriteLock	Ljava/util/concurrent/locks/ReadWriteLock;
    ...
    //   128: astore_1
    //   129: aload_0
    //   130: getfield 40	arak:jdField_a_of_type_JavaUtilConcurrentLocksReadWriteLock	Ljava/util/concurrent/locks/ReadWriteLock;
      ...
      for (;;)
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject3))
        {
          ...
          for (;;)
          {
            ...
            {
              aral localaral = a((String)((Iterator)localObject4).next());
              if (localaral != null)
              {
                ((Set)localObject3).add(localaral);
                continue;
          ...
          {
            localObject4 = (aral)((Iterator)localObject3).next();
            if (((aral)localObject4).jdField_a_of_type_Int == 0) {
              a((aral)localObject4);
            } else if (((aral)localObject4).jdField_a_of_type_Int == 1) {
              b((aral)localObject4);
            } else {
              a((aral)localObject4, localEditor);
            }
          }
        }
      }
  ...
  void b(String paramString1, String paramString2, String paramString3)
  {
    ...
    //   23: aload_0
    //   24: ldc 249
    //   26: invokespecial 55	arak:a	(Ljava/lang/String;)Landroid/content/SharedPreferences;
    //   29: astore_2
    ...
    //   82: astore_2
    //   83: aload_0
    //   84: getfield 40	arak:jdField_a_of_type_JavaUtilConcurrentLocksReadWriteLock	Ljava/util/concurrent/locks/ReadWriteLock;
    ...
    //   111: pop
    //   112: aload_0
    //   113: getfield 40	arak:jdField_a_of_type_JavaUtilConcurrentLocksReadWriteLock	Ljava/util/concurrent/locks/ReadWriteLock;
    //   116: invokeinterface 422 1 0
    //   121: invokeinterface 394 1 0
    //   126: return
    //   127: astore_1
    //   128: aload_0
    //   129: getfield 40	arak:jdField_a_of_type_JavaUtilConcurrentLocksReadWriteLock	Ljava/util/concurrent/locks/ReadWriteLock;
    //   132: invokeinterface 422 1 0
    //   137: invokeinterface 394 1 0
    //   142: return
    //   143: astore_1
    //   144: aload_0
    //   145: getfield 40	arak:jdField_a_of_type_JavaUtilConcurrentLocksReadWriteLock	Ljava/util/concurrent/locks/ReadWriteLock;
