  ...
  extends ayjh
{
  ...
  private long jdField_b_of_type_Long = aydi.L;
  ...
  public ayht(QQAppInterface paramQQAppInterface, int paramInt1, DiscussionInfo paramDiscussionInfo, List<DiscussionMemberInfo> paramList, int paramInt2)
  {
  ...
  private long a(amjk paramamjk, String paramString1, long paramLong, String paramString2)
  {
    ...
    {
    default: 
      return ayrd.a(paramString2, paramString1, paramLong);
    case 0: 
      return ayrd.a(paramString2, paramString1, paramLong);
    }
    if (paramamjk.a(this.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo.uin)) {
      return ayrd.a(paramString2, paramString1, paramLong, true, false, false);
    }
    return ayrd.a(paramString2, paramString1, paramLong);
  }
  
  private long a(List<List<ayhu>> paramList)
  {
    ...
    while (i < paramList.size())
    {
      ...
      {
        localObject = ((ayhu)((List)paramList.get(i)).get(j)).jdField_a_of_type_ComTencentMobileqqDataDiscussionMemberInfo;
        ...
        l2 = l1;
        if (((ayhu)((List)paramList.get(i)).get(j)).jdField_a_of_type_Long > l1) {
          l2 = ((ayhu)((List)paramList.get(i)).get(j)).jdField_a_of_type_Long;
        }
        j += 1;
        l1 = l2;
      }
    ...
    for (;;)
    {
      ...
      long l3 = ((ayhu)((List)paramList.get(i)).get(arrayOfInt[i])).jdField_a_of_type_Long;
      l2 = l1;
      if (l3 > l1) {
        l2 = l3;
      }
      this.jdField_a_of_type_JavaUtilSet.add(((ayhu)((List)paramList.get(i)).get(arrayOfInt[i])).jdField_a_of_type_ComTencentMobileqqDataDiscussionMemberInfo);
      this.jdField_b_of_type_JavaUtilList.add(((ayhu)((List)paramList.get(i)).get(arrayOfInt[i])).jdField_a_of_type_JavaLangString);
      i += 1;
      l1 = l2;
    }
  }
  ...
  private void a()
  {
    int i = 0;
    int n = 0;
    if ((ayrd.a(this.jdField_b_of_type_Int)) || (this.jdField_b_of_type_Int == 5))
    {
      ...
      if (this.jdField_a_of_type_JavaUtilList != null)
      {
        ...
        for (int m = 1;; m = 0)
        {
          ...
          localSpannableStringBuilder.append(ayrd.a((String)this.jdField_b_of_type_JavaUtilList.get(j), (String)this.jdField_c_of_type_JavaUtilList.get(j), 6));
          i += 1;
      ...
      this.jdField_c_of_type_JavaLangCharSequence = (i + alpo.a(2131702900));
      return;
    }
    this.jdField_a_of_type_JavaLangCharSequence = alpo.a(2131702957);
    ...
    for (;;)
    {
      ...
      if (!this.jdField_b_of_type_JavaUtilList.isEmpty())
      {
        ...
        while (i >= 0)
        {
          ((SpannableStringBuilder)localObject).append(ayrd.a((String)this.jdField_b_of_type_JavaUtilList.get(i), (String)this.jdField_c_of_type_JavaUtilList.get(i), 6));
          if (i > 0) {
            ((SpannableStringBuilder)localObject).append("、");
          }
          i -= 1;
  ...
  static boolean a(int paramInt, List<List<ayhu>> paramList, long[] paramArrayOfLong, Map<DiscussionMemberInfo, Long> paramMap1, int[] paramArrayOfInt, Map<DiscussionMemberInfo, Integer> paramMap, boolean[] paramArrayOfBoolean, Set<DiscussionMemberInfo> paramSet, Map<DiscussionMemberInfo, Long> paramMap2)
  {
    paramArrayOfBoolean[paramInt] = true;
    int i = 0;
    if (i < ((List)paramList.get(paramInt)).size())
    {
      DiscussionMemberInfo localDiscussionMemberInfo = ((ayhu)((List)paramList.get(paramInt)).get(i)).jdField_a_of_type_ComTencentMobileqqDataDiscussionMemberInfo;
      if (paramSet.contains(localDiscussionMemberInfo)) {}
      for (;;)
      {
        i += 1;
        break;
        long l = paramArrayOfLong[paramInt] + ((Long)paramMap1.get(localDiscussionMemberInfo)).longValue() - ((ayhu)((List)paramList.get(paramInt)).get(i)).jdField_a_of_type_Long;
        if (l == 0L)
        {
  ...
  private Object[] a(DiscussionMemberInfo paramDiscussionMemberInfo, String paramString)
  {
    ...
    long l1 = a(localamjk, paramDiscussionMemberInfo.inteRemark, aydi.k, paramString);
    String str;
    ...
    for (;;)
    {
      long l3 = a(localamjk, paramDiscussionMemberInfo.memberName, aydi.l, paramString);
      l1 = l2;
      if (l3 > l2)
      {
      ...
      Friends localFriends = this.jdField_a_of_type_Aloz.b(paramDiscussionMemberInfo.memberUin);
      ...
      if (localFriends != null)
      {
        ...
        {
          l3 = a(localamjk, localFriends.remark, aydi.j, paramString);
          paramDiscussionMemberInfo = str;
          l2 = l1;
          if (l3 > l1)
          {
          ...
          l1 = a(localamjk, localFriends.name, aydi.l, paramString);
          l3 = l2;
          if (l1 > l2)
          {
      ...
      while (i < paramString.length)
      {
        ...
        if (j < this.jdField_a_of_type_JavaUtilList.size())
        {
          ...
          for (;;)
          {
            ...
            {
              ayhu localayhu = new ayhu();
              localayhu.jdField_a_of_type_Long = l;
              localayhu.jdField_a_of_type_JavaLangString = ((String)arrayOfObject[1]);
              localayhu.jdField_a_of_type_ComTencentMobileqqDataDiscussionMemberInfo = ((DiscussionMemberInfo)this.jdField_a_of_type_JavaUtilList.get(j));
              localArrayList2.add(localayhu);
            }
          }
        }
  ...
  protected long a(String paramString)
  {
    ...
    {
      l1 = ayrd.b(paramString, this.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo.discussionName, aydi.e);
        ...
        for (i = 1;; i = 0)
        {
          if (i == 0)
          {
            ...
            if (paramString.a(this.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo.uin))
            {
              ...
              this.jdField_b_of_type_Long = aydi.J;
              break label389;
            }
            this.jdField_b_of_type_Long = aydi.L;
            break label389;
          }
          label564:
          i = 0;
  ...
  public void a(View paramView)
  {
    ...
    if (ayrd.a(this.jdField_b_of_type_Int))
    {
      ...
      ajgm.a(paramView.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo.uin, 3000, this.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo.discussionName, false);
      alxr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString);
      ayrd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, a().toString(), this.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo.uin, "", 3000);
      ayrd.a(this.jdField_a_of_type_JavaLangString, 20, 3, paramView);
      ayrd.a(this.jdField_a_of_type_JavaLangString, 30, paramView, false);
      ayrd.a(this.jdField_a_of_type_JavaLangString);
    ...
    for (;;)
    {
      new azmo(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_listNew").c("search_result").d("clk_grp").a(new String[] { this.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo.uin }).a();
      return;
      label299:
  ...
  public String c()
  {
    return bdbt.a(BaseApplicationImpl.sApplication, this.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo);
  }
