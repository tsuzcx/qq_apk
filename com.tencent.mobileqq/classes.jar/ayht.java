  ...
  implements View.OnClickListener
{
  ...
  public ayht(Context paramContext, View.OnClickListener paramOnClickListener)
  {
  ...
  private void a(AsyncImageView paramAsyncImageView, GroupPadTemplateInfo paramGroupPadTemplateInfo)
  {
    if (paramGroupPadTemplateInfo != null)
    {
      ...
      if (!bfng.a(paramGroupPadTemplateInfo.mobThumbUrl)) {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (paramGroupPadTemplateInfo != null)
          {
            ...
            paramGroupPadTemplateInfo.setDownloadListener(new ayhu(this, str));
  ...
  public GroupPadTemplateInfo a()
  {
    ...
    localGroupPadTemplateInfo.templateName = this.jdField_a_of_type_AndroidContentContext.getString(2131693212);
