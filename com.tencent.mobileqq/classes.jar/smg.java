...
{
  public smg(FriendProfileCardActivity paramFriendProfileCardActivity, ActionSheet paramActionSheet) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (ProfileActivity.AllInOne.a(this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.jdField_a_of_type_ComTencentMobileqqProfileProfileCardInfo.a))
      {
        ...
        {
          ThreadManager.post(new smh(this), 5, null, true);
          continue;
          Object localObject;
          ...
          if (QLog.isColorLevel())
          {
            ...
            if (!Utils.a())
            {
              Toast.makeText(this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.getApplicationContext(), this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.getString(2131434753), 0).show();
            }
            else
            {
              boolean bool2 = true;
