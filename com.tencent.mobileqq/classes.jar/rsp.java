...
public class rsp
{
  ...
  private static QQHashMap<Integer, rsq> jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap;
  ...
  public static Drawable a(Context paramContext, int paramInt)
  {
    ...
    {
    default: 
      return paramContext.getResources().getDrawable(2130839687);
    case 1: 
      return paramContext.getResources().getDrawable(2130839780);
    }
    return paramContext.getResources().getDrawable(2130839785);
  }
  ...
  {
    rsq localrsq = a(paramQQAppInterface, paramContext, paramInt);
    if (localrsq != null) {
      return localrsq.a();
    }
  ...
  public static rsq a(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt)
  {
    int i1 = paramInt;
    if (paramInt == 3) {
      i1 = 2;
    ...
    return (rsq)jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.get(Integer.valueOf(i1));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (localSharedPreferences != null)
    {
      ...
      localSet = baih.a(localSharedPreferences, "big_data_share_channel_urls", null);
      if (localSet != null) {
  ...
  private static void a(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    if (!a(paramQQAppInterface, paramContext, baig.e(paramContext)))
    {
      localObject = new rsq(paramQQAppInterface, paramContext, 1, 2131631017, 2130839780);
      jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.put(Integer.valueOf(1), localObject);
    }
    Object localObject = baig.h(paramContext);
    String str = baig.i(paramContext);
    if ((TextUtils.isEmpty((CharSequence)localObject)) || (TextUtils.isEmpty(str)))
    {
      paramQQAppInterface = new rsq(paramQQAppInterface, paramContext, 2, 2131629898, 2130839785);
    ...
    for (;;)
    {
      ...
      return;
      paramQQAppInterface = new rsq(paramQQAppInterface, paramContext, 2, (String)localObject, str);
      jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.put(Integer.valueOf(2), paramQQAppInterface);
    }
  }
  ...
  public static void a(ArrayList<rsq> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      {
        rsq localrsq = (rsq)paramArrayList.next();
        jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.put(Integer.valueOf(localrsq.jdField_a_of_type_Int), localrsq);
      }
    }
  }
    ...
    try
    {
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        while (i1 < i2)
        {
          ...
          localObject = new rsq(paramQQAppInterface, paramContext, i3, ((Element)localObject).getElementsByTagName("name").item(0).getFirstChild().getNodeValue(), ((Element)localObject).getElementsByTagName("icon").item(0).getFirstChild().getNodeValue());
          if (jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap == null) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          ...
          bool = true;
          rqc.a(paramQQAppInterface, bool, (String)localObject1);
          rqc.b(paramQQAppInterface, i1);
          if (i3 == 1)
          {
        ...
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          ...
          bool = true;
          rqc.a(paramQQAppInterface, bool);
          rqc.c(paramQQAppInterface, i1);
          if (QLog.isColorLevel()) {
        ...
        if (localObject1 != null)
        {
          ...
          bool = true;
          baig.b((Context)localObject1, bool);
        }
        localObject1 = paramString.getElementsByTagName("channel_version");
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          i1 = Integer.valueOf(((Element)((NodeList)localObject1).item(0)).getFirstChild().getNodeValue()).intValue();
          i2 = bgmq.b(paramQQAppInterface);
          if (i1 <= i2) {
            break label2992;
          }
          ...
          bgmq.a(paramQQAppInterface, i3, (String)localObject2, i4);
          if (QLog.isColorLevel()) {
        ...
        if (localObject1 != null)
        {
          ...
          bool = true;
          baig.c((Context)localObject1, bool);
          localObject1 = qji.a();
          if (i1 != 0) {
            break label3033;
          }
          bool = true;
          ((qji)localObject1).a(bool);
          if (QLog.isColorLevel()) {
        ...
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          ...
          bool = true;
          bgmq.b(paramQQAppInterface, bool);
          if (QLog.isColorLevel()) {
        ...
        if (localObject1 != null)
        {
          ...
          bool = true;
          baig.a((Context)localObject1, bool, paramQQAppInterface.c());
          if (QLog.isColorLevel()) {
        ...
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          ...
          bool = true;
          bgmq.d(paramQQAppInterface, bool);
        }
        ...
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          ...
          bgmq.h(paramQQAppInterface, bool);
        }
  ...
  public static String b(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt)
  {
    ...
    default: 
      return null;
    case 1: 
      return paramContext.getString(2131631017);
    }
    return paramContext.getString(2131629898);
  }
  ...
  public static boolean b()
  {
    return "1".equals((String)wwt.a().a("subscribe_entrance_enable", "0"));
  }
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if ((localObject != null) && (((NodeList)localObject).getLength() > 0))
          {
            ...
            if (i1 > baig.y(paramQQAppInterface.getApp()))
            {
              ...
              if ((!TextUtils.isEmpty((CharSequence)localObject)) && (!TextUtils.isEmpty(paramString))) {
                baig.a(paramQQAppInterface.getApp(), (String)localObject, paramString);
              }
              baig.p(paramQQAppInterface.getApp(), i1);
              return false;
            }
          }
        }
  ...
  {
    return (String)wwt.a().a("subscribe_account_title", wwt.jdField_c_of_type_JavaLangString);
  }
  ...
  public static boolean c()
  {
    String str1 = (String)wwt.a().a("subscribe_entrance_enable", "0");
    String str2 = (String)wwt.a().a("newfollowlist", "1");
