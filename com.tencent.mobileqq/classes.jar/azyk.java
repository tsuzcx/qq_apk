...
public class azyk
{
  ...
  public CharSequence a(arpg paramarpg)
  {
    SpannableStringBuilder localSpannableStringBuilder = new SpannableStringBuilder();
    Object localObject = paramarpg.a().jdField_a_of_type_JavaUtilArrayList;
    localSpannableStringBuilder.append(paramarpg.a().jdField_a_of_type_JavaLangString);
    int i = 0;
    while (i < ((ArrayList)localObject).size()) {
      if (TextUtils.isEmpty(((arpi)((ArrayList)localObject).get(i)).jdField_a_of_type_JavaLangString))
      {
        i += 1;
      }
      else
      {
        ...
        paramarpg = ((arpi)((ArrayList)localObject).get(i)).jdField_a_of_type_JavaLangString;
        localObject = new ForegroundColorSpan(Color.parseColor("#4D94FF"));
        localSpannableStringBuilder.append(paramarpg);
        localSpannableStringBuilder.setSpan(localObject, j, paramarpg.length() + j, 33);
      }
    }
  ...
  {
    long l = aran.a().a(529, paramQQAppInterface.getCurrentAccountUin());
  ...
  {
    boolean bool = false;
    if (aran.a().a(529, paramQQAppInterface.getCurrentAccountUin()) > paramQQAppInterface.getApp().getSharedPreferences(paramQQAppInterface.getCurrentAccountUin(), 0).getLong("recommend_topic_version", -1L)) {
      bool = true;
    }
    return bool;
  }
