  ...
  extends akim
{
  ...
  protected void a(String paramString, boolean paramBoolean, List<TroopMemberInfo> paramList, int paramInt1, long paramLong, int paramInt2)
  {
    ...
    {
      return;
      if ((paramString != null) && (paramString.equals(bady.a(this.a).a))) {
        break;
      }
    } while (!QLog.isColorLevel());
    QLog.d("AtPanel", 2, " onUpdateTroopGetMemberList troopUin =" + paramString + " mSession.troopUin=" + bady.a(this.a).a);
    return;
    ...
    while (paramList.hasNext())
    {
      ...
      paramString.add(baee.a(bady.a(this.a), localTroopMemberInfo));
    }
    bady.a(this.a).a(paramString);
    bady.a(this.a).a(bady.a(this.a), bady.a(this.a), bady.a(this.a).F());
  }
