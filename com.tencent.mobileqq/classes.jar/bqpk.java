...
public abstract class bqpk<PACKAGE extends bqow>
  extends BaseAdapter
{
  public int a;
  protected Context a;
  ...
  public bqpk(Context paramContext, FaceListPage paramFaceListPage)
  {
  ...
  {
    this.jdField_a_of_type_Bqow = paramPACKAGE;
  }
  ...
  public int getCount()
  {
    ...
    int i = this.jdField_a_of_type_Bqow.b();
    int j = this.jdField_a_of_type_Bqow.a();
    if (j < 1) {
