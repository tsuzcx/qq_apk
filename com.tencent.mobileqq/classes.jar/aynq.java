...
public class aynq
{
  ...
  Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new aynv(this);
  ...
  public aynq()
  {
    ...
    this.jdField_a_of_type_Int = actn.a(4.0F, ((Context)localObject).getResources());
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate((Context)localObject, 2131561136, null));
  ...
  void b()
  {
    ...
    int i = actn.a(1.0F, ((Context)localObject2).getResources());
    this.d.setPadding(i, i, i, i);
    this.d.setBackgroundResource(2130844308);
    ...
    try
    {
      ...
      ((ScaleAnimation)localObject1).setAnimationListener(new aynr(this));
  ...
  void e()
  {
    int j = this.jdField_a_of_type_AndroidWidgetImageView.getWidth() - actn.a(5.0F, BaseApplicationImpl.getContext().getResources());
    ...
    localObject2 = new aynt(this, localAnimatorSet);
