  ...
  implements Handler.Callback, URLDrawable.URLDrawableListener
{
  ...
  WeakReference<asxi> jdField_a_of_type_MqqUtilWeakReference;
  ...
  public void onLoadSuccessed(URLDrawable paramURLDrawable)
  {
    ...
    if ((i > 0) && (j > 0))
    {
      ...
      {
        paramURLDrawable = (asxi)this.jdField_a_of_type_MqqUtilWeakReference.get();
