...
public class asxh
  extends asxf
{
  public asxh(QQAppInterface paramQQAppInterface)
  {
  ...
  private String a(long paramLong, String paramString1, String paramString2, int paramInt)
  {
    ...
    {
      return paramString1;
      paramString2 = AppConstants.SDCARD_FILE_SAVE_TROOPTMP_PATH + ataw.a(paramLong, paramInt, paramString2);
  ...
  private boolean a(MessageRecord paramMessageRecord, List<MsgBackupResEntity> paramList)
  {
    ...
    for (Object localObject1 = (MessageForTroopFile)aszt.a((ChatMessage)paramMessageRecord);; localObject1 = (MessageForTroopFile)paramMessageRecord)
    {
    ...
    if (((becp)localObject1).jdField_a_of_type_JavaUtilUUID == null)
    {
      QLog.e("TroopFileMsgBackupHandler<QFile>", 1, "onImport: updateTroopFileRecord failed. troop file status info uuid is null");
      return false;
    }
    TroopFileTransferManager.Item localItem = localTroopFileTransferManager.a(((becp)localObject1).jdField_a_of_type_JavaUtilUUID);
    Object localObject2;
    String str;
    if (localItem != null) {
  ...
  private void c(MessageRecord paramMessageRecord, List<MsgBackupResEntity> paramList)
  {
    ...
    if (paramMessageRecord.isMultiMsg)
    {
      localObject1 = (MessageForTroopFile)aszt.a((ChatMessage)paramMessageRecord);
      l = Long.parseLong(((MessageForTroopFile)localObject1).frienduin);
      if (bfav.a(l) == null) {
        QLog.e("TroopFileMsgBackupHandler<QFile>", 1, "createTroopFileRecord: get TroopFileDataManager failed.");
      }
      localbebc = bfbb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, l).b(((MessageForTroopFile)localObject1).url, ((MessageForTroopFile)localObject1).fileName, ((MessageForTroopFile)localObject1).fileSize, ((MessageForTroopFile)localObject1).bisID);
      if ((localbebc == null) || (paramList == null) || (paramList.isEmpty())) {
        break label371;
      }
      localObject1 = "";
      localObject2 = "";
      ...
      for (;;)
      {
        if (localIterator.hasNext())
        {
          ...
          if ((a((MsgBackupResEntity)localObject2)) && (b(paramMessageRecord, (MsgBackupResEntity)localObject2)))
          {
            ...
            if (((MsgBackupResEntity)localObject2).msgSubType == 12) {
              localObject1 = a(l, str, UUID.nameUUIDFromBytes(localbebc.b.getBytes()).toString(), 640);
            }
          }
        }
      }
    ...
    for (;;)
    {
      ...
      if (((MsgBackupResEntity)localObject2).msgSubType == 11)
      {
        paramList = a(str, localbebc.c);
        continue;
        if (FileUtils.fileExistsAndNotEmpty(paramList))
        {
          localbebc.h = paramList;
          localbebc.e = 11;
        ...
        if (FileUtils.fileExistsAndNotEmpty((String)localObject1))
        {
          localbebc.j = ((String)localObject1);
        ...
        label371:
        TroopFileTransferManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, l).a(localbebc);
        return;
      }
    }
  }
  ...
  protected String a(MessageRecord paramMessageRecord, int paramInt)
  {
    ...
    try
    {
      ...
      localObject = bfby.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForTroopFile);
      if ((localObject != null) && (((becp)localObject).e > 0) && (((becp)localObject).f > 0))
      {
        localJSONObject.put("uint32_img_width", ((becp)localObject).e);
        localJSONObject.put("uint32_img_height", ((becp)localObject).f);
      }
  ...
  public void a(MessageRecord paramMessageRecord, List<MsgBackupResEntity> paramList)
  {
    ...
    for (;;)
    {
      ...
      break;
      label145:
      int i = aszt.a(((becp)localObject1).g);
      if ((i == 0) || (i == 2))
      {
        Object localObject2 = ((becp)localObject1).c;
      ...
      localObject1 = ((becp)localObject1).jdField_a_of_type_JavaLangString;
      if (FileUtils.fileExistsAndNotEmpty((String)localObject1))
      {
