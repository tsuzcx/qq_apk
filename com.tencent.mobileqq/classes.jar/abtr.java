...
class abtr
  extends nac
{
  abtr(abtp paramabtp, absf paramabsf) {}
  
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    if (QLog.isColorLevel()) {
      QLog.i(abtp.jdField_a_of_type_JavaLangString, 2, "onResult appid=" + abtp.a(this.jdField_a_of_type_Abtp).jdField_a_of_type_JavaLangString + ", openid=" + this.jdField_a_of_type_Abtp.jdField_a_of_type_Abts.jdField_a_of_type_JavaLangString + ", openkey=" + this.jdField_a_of_type_Abtp.jdField_a_of_type_Abts.b + ", code=" + paramInt);
    }
    if ((paramInt != 0) || (paramArrayOfByte == null))
    {
      abvm.a(this.jdField_a_of_type_Absf, paramInt, "getappfriends result error, try again");
      return;
    }
    ...
    catch (InvalidProtocolBufferMicroException paramBundle)
    {
      ...
      catch (JSONException paramArrayOfByte)
      {
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.e(abtp.jdField_a_of_type_JavaLangString, 2, paramArrayOfByte.getMessage(), paramArrayOfByte);
          }
        }
      }
