  ...
  extends qcu
{
  ...
  public View a(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = LayoutInflater.from(paramViewGroup.getContext()).inflate(2131560427, paramViewGroup, false);
      localView.setTag(new qdj(this.a, (WormholeView)localView, this));
    }
    paramView = (qdj)localView.getTag();
  ...
  public void a(Context paramContext, ArticleInfo paramArticleInfo, String paramString, int paramInt)
  {
    if (!TextUtils.isEmpty(paramString)) {
      if (Boolean.valueOf(bmhv.v(pkh.a())).booleanValue()) {
        tto.a(paramContext, "", "https://viola.qq.com/js/kd_pic_detail.js?_rij_violaUrl=1&v_tid=15&v_bid=3811&v_bundleName=kd_pic_detail&hideNav=1&v_nav_immer=1&v_minVersion=8.0.8&v_from_native=1&album_source=" + paramInt + "&rowkey=" + paramString, null);
      }
    }
