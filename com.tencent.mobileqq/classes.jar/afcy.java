...
public class afcy
  extends ajmm
{
  public afcy(TroopSuspiciousFragment paramTroopSuspiciousFragment) {}
  ...
  protected void a(String paramString)
  {
    if ((TroopSuspiciousFragment.a(this.a) != null) && (TroopSuspiciousFragment.a(this.a).isShowing()))
    {
      ...
      paramString = this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getString(2131654104);
      bbmy.a(this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 1, paramString, 0).b(this.a.a());
    }
  }
  ...
  protected void a(boolean paramBoolean, String paramString1, int paramInt1, String paramString2, int paramInt2, int paramInt3, String paramString3, String paramString4, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramString1 = this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getString(2131653422);
        if (TextUtils.isEmpty(paramString3)) {
          break label590;
        }
        bbmy.a(this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 1, paramString3, 0).b(this.a.a());
      ...
      paramString3 = this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getString(2131627155);
      if (paramInt1 == 1)
      {
        paramString1 = axcz.a().a(Long.valueOf(l1));
      ...
      for (;;)
      {
        bbmy.a(this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 2, paramString1, 0).b(this.a.a());
        l2 = axcz.a().a();
        ...
        try
        {
          if ((TroopSuspiciousFragment.a(this.a) != null) && (paramString1 != null)) {
            TroopSuspiciousFragment.a(this.a).a().a(ajed.O, 0, l2, paramString1.toByteArray());
          }
        }
        catch (Exception paramString1)
        {
        ...
        TroopSuspiciousFragment.e(this.a);
        return;
        paramString1 = this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getString(2131627143);
        continue;
        if (paramInt1 == 2)
        {
          paramString1 = this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getString(2131627153);
        }
        else
        {
  ...
  protected void b(boolean paramBoolean1, boolean paramBoolean2, List<MessageRecord> paramList)
  {
    ...
    for (;;)
    {
      ...
      {
        String str = this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getString(2131654099);
        bbmy.a(this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 1, str, 0).b(this.a.a());
      }
      if (QLog.isColorLevel()) {
      ...
      try
      {
        ...
        axcz.a().b(TroopSuspiciousFragment.a(this.a), 0);
        if (TroopSuspiciousFragment.a(this.a) != null)
        {
