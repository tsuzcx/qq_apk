...
public class awfu
{
  ...
  public static void a(azqj paramazqj, List<String> paramList)
  {
    if ((paramazqj != null) && ((paramazqj instanceof azqk)))
    {
      paramazqj = ((azqk)paramazqj).a;
      if ((paramazqj != null) && (paramazqj.size() > 0)) {
        paramazqj = paramazqj.iterator();
      }
    }
    else
    {
      while (paramazqj.hasNext())
      {
        a((azqj)paramazqj.next(), paramList);
        continue;
        if ((paramazqj != null) && ((paramazqj instanceof azsm)))
        {
          paramazqj = ((azsm)paramazqj).S;
          if ((TextUtils.isEmpty(paramazqj)) || (!paramazqj.startsWith("http"))) {
            break;
          }
        }
      }
    ...
    try
    {
      if (a(new URL(paramazqj).getHost())) {
        paramList.add(paramazqj);
      }
      return;
    }
    catch (MalformedURLException paramazqj)
    {
      paramazqj.printStackTrace();
    }
  }
  ...
  public static void a(MessageForStructing paramMessageForStructing, QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      if (paramMessageForStructing != null)
      {
        ...
        if ((paramQQAppInterface != null) && ((paramQQAppInterface instanceof AbsShareMsg)))
        {
          ...
          if ((localObject != null) && (((List)localObject).size() > 0))
          {
            ...
            while (((Iterator)localObject).hasNext()) {
              a((azqj)((Iterator)localObject).next(), localArrayList);
            }
          }
        }
        ...
        Object localObject = new bapo();
        ((bapo)localObject).b = paramQQAppInterface.mMsgServiceID;
        ((bapo)localObject).c = paramQQAppInterface.mMsgTemplateID;
        ((bapo)localObject).jdField_a_of_type_JavaLangString = String.valueOf(paramMessageForStructing.istroop);
        ((bapo)localObject).jdField_a_of_type_Boolean = true;
        paramMessageForStructing = localArrayList.iterator();
        while (paramMessageForStructing.hasNext()) {
          a((String)paramMessageForStructing.next(), (bapo)localObject);
        }
      }
    }
  }
  
  public static void a(String paramString, bapo parambapo)
  {
    if ((!TextUtils.isEmpty(paramString)) && (paramString.startsWith("http"))) {
      bapk.a(paramString, parambapo, null, 1);
    }
  }
