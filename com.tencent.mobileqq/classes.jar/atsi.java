...
public class atsi
{
  ...
  private HashMap<String, attf> jdField_a_of_type_JavaUtilHashMap;
  ...
  private attc a(String paramString1, int paramInt, String paramString2, MessageRecord paramMessageRecord)
  {
    ...
    paramString2 = new attc(this, paramString2, paramString1, paramInt, paramMessageRecord);
    paramString1 = paramMessageRecord.getExtInfoFromExtStr("_m_ForwardFilePath");
    if (a(paramString1)) {
      if (paramInt == 0) {
        paramString1 = new atsq(this, paramMessageRecord);
      }
    }
    for (;;)
    {
      ...
      if (paramInt == 3000)
      {
        paramString1 = new atsz(this, paramMessageRecord);
      }
      else if (paramInt == 1)
      {
        paramString1 = new attj(this, paramMessageRecord.getExtInfoFromExtStr("_m_ForwardFileName"), paramString1, null);
      }
      else
      {
        do
        {
          do
          {
            ...
            if (paramInt == 0)
            {
              paramString1 = new atsk(this, paramMessageRecord);
              break;
            }
            if (paramInt == 3000)
            {
              paramString1 = new atsm(this, paramMessageRecord);
              break;
            }
          } while (paramInt != 1);
          paramString1 = new atso(this, paramMessageRecord);
          break;
          if (paramInt == 0)
          {
            paramString1 = new atst(this, paramMessageRecord);
            break;
          }
          if (paramInt == 3000)
          {
            paramString1 = new atsv(this, paramMessageRecord);
            break;
          }
        } while (paramInt != 1);
        paramString1 = new atsx(this, paramMessageRecord);
      }
    }
    if (paramInt == 0) {
      paramInt = 3;
    ...
    for (;;)
    {
      paramString1 = new atth(this, paramMessageRecord, paramInt, null);
      break label76;
      if (paramInt == 3000)
      {
        paramInt = 106;
  ...
  {
    if (paramBoolean) {
      return BaseActivity.sTopActivity.app.getApplication().getResources().getString(2131692207);
    }
    if (paramLong > 10485760L) {
      return BaseActivity.sTopActivity.app.getApplication().getResources().getString(2131692209);
    }
    return BaseActivity.sTopActivity.app.getApplication().getResources().getString(2131692246);
  }
  
  private static void b(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt1, String paramString, long paramLong2, int paramInt2, int paramInt3, int paramInt4, int paramInt5, boolean paramBoolean, Bundle paramBundle, atte paramatte)
  {
    if (paramatte == null)
    {
    ...
    aauw.a(paramQQAppInterface, paramLong1, paramInt1, paramString, paramInt2, paramInt3, paramInt4, paramInt5, paramBoolean, paramBundle, new atsj(paramString, paramatte, paramLong2));
  }
  ...
  public void a(atzn paramatzn, HashMap<String, ArrayList<MessageRecord>> paramHashMap)
  {
    if ((paramHashMap == null) || (paramHashMap.size() <= 0)) {
      QLog.i("FileMultiMsgManager<FileAssistant>", 1, "addMultiFileUploadRequest: file message record list is null");
    }
    this.jdField_a_of_type_AndroidOsHandler.post(new QFileMsgForwardManager.1(this, paramatzn));
  }
  
  public void a(MessageRecord paramMessageRecord1, MessageRecord paramMessageRecord2)
  {
    if (auoo.a(paramMessageRecord1)) {
    ...
    for (;;)
    {
      ...
      catch (NumberFormatException localNumberFormatException)
      {
        ...
        continue;
        paramMessageRecord1 = (MessageForTroopFile)aunj.a((ChatMessage)paramMessageRecord1);
        paramMessageRecord2.saveExtInfoToExtStr("_m_ForwardFilePath", bgsk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord1).a);
        continue;
      }
      Object localObject;
      ...
      else if ((paramMessageRecord1 instanceof MessageForTroopFile))
      {
        ...
        localObject = bgsk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord1);
        if (localObject != null)
        {
          paramMessageRecord2.saveExtInfoToExtStr("_f_thumb_path_750_", ((bftf)localObject).c);
          paramMessageRecord2.saveExtInfoToExtStr("_f_thumb_path_384_", ((bftf)localObject).d);
          if (((paramMessageRecord1.width == 0) || (paramMessageRecord1.height == 0)) && (((bftf)localObject).e > 0) && (((bftf)localObject).f > 0))
          {
            paramMessageRecord2.saveExtInfoToExtStr("_m_ForwardImgWidth", String.valueOf(paramMessageRecord1.width));
            paramMessageRecord2.saveExtInfoToExtStr("_m_ForwardImgHeight", String.valueOf(paramMessageRecord1.height));
          }
          paramMessageRecord2.saveExtInfoToExtStr("_m_ForwardFilePath", ((bftf)localObject).a);
          if ((((bftf)localObject).b == 2) || (((bftf)localObject).b == 3)) {
            paramMessageRecord2.saveExtInfoToExtStr("_m_ForwardStatusPaused", "1");
          }
        }
      }
