...
public class avty
  extends RecyclerView.Adapter<avue>
{
  public avvi a;
  public List<HotPicData> a;
  
  public avty(HotPicPageView paramHotPicPageView, int paramInt)
  {
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
  }
  
  public avue a(ViewGroup paramViewGroup, int paramInt)
  {
    if (avtm.a(this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_ComTencentMobileqqHotpicHotPicMainPanel.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_Int)) {
      return new avub(this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView, LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_AndroidContentContext).inflate(2131558611, paramViewGroup, false), this.jdField_a_of_type_Avvi);
    }
    return new avue(this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView, LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_AndroidContentContext).inflate(2131558610, paramViewGroup, false), this.jdField_a_of_type_Avvi);
  }
  ...
  public void a(avue paramavue, int paramInt)
  {
    Object localObject1;
    Object localObject2;
    if ((paramavue instanceof avub))
    {
      localObject1 = (avub)paramavue;
      ((avub)localObject1).d();
      localObject2 = ((avub)localObject1).a();
      if (localObject2 != null)
      {
        ((HotVideoData)localObject2).SetPreviewDownloadListener(null);
        if (this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_Avup != null) {
          this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_Avup.a((HotVideoData)localObject2);
        }
      }
      ((avub)localObject1).a(null);
    }
    for (;;)
    {
      HotPicData localHotPicData = (HotPicData)this.jdField_a_of_type_JavaUtilList.get(paramInt);
      ViewGroup.MarginLayoutParams localMarginLayoutParams1 = (ViewGroup.MarginLayoutParams)paramavue.d.getLayoutParams();
      ...
      if ((paramInt != 0) && (paramInt != 1) && (paramInt != 2))
      {
        ...
        ViewGroup.MarginLayoutParams localMarginLayoutParams2 = (ViewGroup.MarginLayoutParams)((avub)localObject1).c.getLayoutParams();
        ...
        ((avub)localObject1).a(localHotVideoData);
        ...
        if (localObject3 == null) {
          localObject2 = new alxc(localHotVideoData.width, localHotVideoData.height);
        }
        f = i / ((alxc)localObject2).a();
        i = ((alxc)localObject2).b();
        ((avub)localObject1).jdField_b_of_type_AndroidWidgetTextView.setText(localHotVideoData.getVideoLengthString());
        ((avub)localObject1).a.setText(localHotVideoData.name);
        localMarginLayoutParams2.width = j;
        localMarginLayoutParams2.height = i;
        localObject2 = (ViewGroup.MarginLayoutParams)((avub)localObject1).jdField_b_of_type_AndroidWidgetImageView.getLayoutParams();
        ...
        if (avvc.a((HotVideoData)localObject3)) {
          break label827;
        }
        ((avub)localObject1).a(-11);
        i = 1;
      }
      for (;;)
      {
        ...
        if (localObject2 != null)
        {
          if (this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_Int != -20)
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_Avvh.a((URLDrawable)localObject2, paramInt);
            j = 16;
          ...
          if (i != 0)
          {
            ...
            ((avub)localObject1).a((Drawable)localObject2);
          }
          label717:
        ...
        {
          label648:
          EventCollector.getInstance().onRecyclerBindViewHolder(paramavue, paramInt, getItemId(paramInt));
          return;
          localMarginLayoutParams1.topMargin = 0;
          break;
          label805:
          ...
          break label355;
          label827:
          ((avub)localObject1).a(0);
          if (!((HotVideoData)localObject3).CheckIsNeedBlurBackground()) {
            break label1239;
          }
          ((avub)localObject1).b(new ColorDrawable(Color.parseColor("#7f000000")));
          if ((!this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.a()) || (Build.VERSION.SDK_INT < 17) || (this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_Avup == null)) {
            break label1239;
          }
          this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_Avup.a((avub)localObject1, (HotVideoData)localObject3);
          i = 1;
          break label564;
          label907:
          ...
          {
            i = 0;
            ((avub)localObject1).a(-10);
            ((HotVideoData)localObject3).GetPreviewURLAsync(this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0, "0", new avtz(this, (HotVideoData)localObject3, (avub)localObject1, (URLDrawable)localObject2));
            break label564;
          }
          j = 1;
          i = j;
          ...
          break label696;
          label1040:
          paramavue.d.setImageDrawable((Drawable)localObject2);
          break label717;
          label1052:
