...
public class avty
{
  private static Map<String, avty> jdField_a_of_type_JavaUtilMap = new HashMap();
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private final Context jdField_a_of_type_AndroidContentContext;
  private Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new avtz(this);
  ...
  private final List<avua> jdField_a_of_type_JavaUtilList = new LinkedList();
  ...
  private avty(Context paramContext, InstalledPlugin paramInstalledPlugin)
  {
  ...
  private Intent a()
  {
    ...
    for (int i = 1;; i = 2)
    {
      ...
      localIntent.putExtra("qqVersion", "8.4.10");
      return localIntent;
    }
  }
  
  public static avty a(Context paramContext, InstalledPlugin paramInstalledPlugin)
  {
    try
    {
      avty localavty2 = (avty)jdField_a_of_type_JavaUtilMap.get(paramInstalledPlugin.pluginFile.getName());
      avty localavty1 = localavty2;
      if (localavty2 == null)
      {
        localavty1 = new avty(paramContext, paramInstalledPlugin);
        jdField_a_of_type_JavaUtilMap.put(paramInstalledPlugin.pluginFile.getName(), localavty1);
      }
      return localavty1;
    }
    finally {}
  ...
  private RunningPlugin a()
  {
    ...
    a("HuayangPluginLauncher", anvx.a(2131705115));
    try
    {
      ...
      {
        a("HuayangPluginLauncher", anvx.a(2131705125) + (System.currentTimeMillis() - l));
    ...
    catch (Exception localException2)
    {
      ...
      a(80);
      a("HuayangPluginLauncher", anvx.a(2131705129) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile + anvx.a(2131705124) + (System.currentTimeMillis() - l));
    }
  ...
  private void a(int paramInt)
  {
    ...
    a("HuayangPluginLauncher", anvx.a(2131705123) + paramInt);
  ...
  private void a(RunningPlugin paramRunningPlugin)
  {
    ...
    long l = System.currentTimeMillis();
    a("HuayangPluginLauncher", anvx.a(2131705113) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile);
    ...
    for (;;)
    {
      try
      {
        ...
        a(true, null);
        if (!avts.a(this.jdField_a_of_type_ComTencentMobileqqIntervideoIVPluginInfo.jdField_c_of_type_JavaLangString)) {
          continue;
        }
        avue.a("2691707");
      ...
      a("HuayangPluginLauncher", anvx.a(2131705128) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile + anvx.a(2131705121) + (System.currentTimeMillis() - l));
      return;
      if (avts.b(this.jdField_a_of_type_ComTencentMobileqqIntervideoIVPluginInfo.jdField_c_of_type_JavaLangString)) {
        avue.a("2597725");
      }
    }
  }
  ...
  {
    long l = System.currentTimeMillis();
    a("HuayangPluginLauncher", anvx.a(2131705119) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile);
    Intent localIntent = a();
    try
    {
      paramRunningPlugin.startInitActivity(localIntent).get();
      a("HuayangPluginLauncher", anvx.a(2131705117) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile + anvx.a(2131705114) + (System.currentTimeMillis() - l));
      return;
    }
    catch (Throwable paramRunningPlugin)
    {
      for (;;)
      {
        ...
        avtn.a(paramRunningPlugin);
      }
    }
  }
  
  public void a(avua paramavua)
  {
    if (paramavua != null) {
      this.jdField_a_of_type_JavaUtilList.add(paramavua);
    }
  }
  ...
  public void b(avua paramavua)
  {
    if (paramavua != null) {
      this.jdField_a_of_type_JavaUtilList.remove(paramavua);
    }
  }
}
