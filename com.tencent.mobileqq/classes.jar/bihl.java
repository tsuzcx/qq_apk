  ...
  implements Closeable
{
  ...
  public bihl(String paramString, int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3)
  {
  ...
  private boolean a(RandomAccessFile paramRandomAccessFile, int paramInt, bihm parambihm)
  {
    ...
    try
    {
      ...
      l2 = a(arrayOfByte, 0);
      long l3 = parambihm.jdField_a_of_type_Long;
      if (l2 != l3) {
        return false;
      }
      k = a(arrayOfByte, 8);
      ...
      if ((parambihm.jdField_a_of_type_ArrayOfByte == null) || (parambihm.jdField_a_of_type_ArrayOfByte.length < m)) {
        parambihm.jdField_a_of_type_ArrayOfByte = new byte[m];
      }
      arrayOfByte = parambihm.jdField_a_of_type_ArrayOfByte;
      parambihm.jdField_a_of_type_Int = m;
    ...
    catch (Throwable parambihm)
    {
      QLog.e("BlobCache", 2, "getBlob failed.", parambihm);
      return false;
    }
    finally
    {
  ...
  public boolean a(bihm parambihm)
  {
    if ((a(parambihm.jdField_a_of_type_Long, this.g)) && (a(this.jdField_d_of_type_JavaIoRandomAccessFile, this.j, parambihm))) {}
    int k;
    do
    {
      return true;
      k = this.i;
      if ((!a(parambihm.jdField_a_of_type_Long, this.h)) || (!a(this.jdField_e_of_type_JavaIoRandomAccessFile, this.j, parambihm))) {
        break;
      }
    } while ((this.jdField_e_of_type_Int + 20 + parambihm.jdField_a_of_type_Int > this.jdField_b_of_type_Int) || (this.jdField_d_of_type_Int * 2 >= this.jdField_a_of_type_Int));
    this.i = k;
    try
    {
      b(parambihm.jdField_a_of_type_Long, parambihm.jdField_a_of_type_ArrayOfByte, parambihm.jdField_a_of_type_Int);
      this.jdField_d_of_type_Int += 1;
      a(this.jdField_a_of_type_ArrayOfByte, 16, this.jdField_d_of_type_Int);
      f();
      return true;
