...
public class bihl
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bihi.a(bihi.a);
    jdField_b_of_type_JavaLangString = bihi.a(bihi.a);
    c = bihi.a(bihi.a);
    d = bihi.a(bihi.a);
    e = "";
    e = bihi.a(bihi.b);
  ...
  private static String a(com.tencent.commonsdk.zip.QZipFile paramQZipFile, java.util.zip.ZipEntry paramZipEntry)
  {
    ...
    //   9: aload_1
    //   10: astore_0
    //   11: getstatic 120	bihi:m	[B
    //   14: invokestatic 44	bihi:a	([B)Ljava/lang/String;
    ...
    //   86: invokestatic 149	bihj:a	([B)Ljava/lang/String;
    //   89: astore_3
    //   90: aload_3
    //   91: astore_0
    //   92: aload_1
  ...
  private static String a(String paramString)
  {
    ...
    //   69: astore_0
    //   70: aload 4
    //   72: getstatic 190	bihi:n	[B
    //   75: invokestatic 44	bihi:a	([B)Ljava/lang/String;
    //   78: invokevirtual 194	java/lang/String:endsWith	(Ljava/lang/String;)Z
    //   81: ifeq -65 -> 16
    //   84: aload_1
    //   85: astore_0
    //   86: aload 4
    //   88: getstatic 196	bihi:o	[B
    //   91: invokestatic 44	bihi:a	([B)Ljava/lang/String;
    ...
    //   116: aload_1
    //   117: aload_3
    //   118: invokestatic 205	bihl:a	(Lcom/tencent/commonsdk/zip/QZipFile;Ljava/util/zip/ZipEntry;)Ljava/lang/String;
    //   121: astore_2
    //   122: aload_1
    //   123: ifnull +7 -> 130
    //   126: aload_1
  ...
  private static void c()
  {
    try
    {
      ...
      if (!jdField_a_of_type_Boolean)
      {
        ...
        if (localObject != null)
        {
          jdField_a_of_type_Int = bihk.a((String)localObject, g);
    ...
    for (;;)
    {
      try
      {
        ...
        if (!jdField_b_of_type_Boolean)
        {
          ...
          if ((str2 == null) || (!str2.equalsIgnoreCase(jdField_b_of_type_JavaLangString)) || (localObject3 == null) || (!((String)localObject3).equalsIgnoreCase("8.4.1.4680"))) {
            break label426;
          }
        ...
        localc.str_apkversion.set("8.4.1.4680");
      ...
      label426:
      d = bkfg.a(BaseApplication.getContext());
      jdField_a_of_type_JavaLangString = bkfg.a(localException);
      Object localObject2 = new byte[16];
      if (localObject2 != null)
      {
        bihj.a(localException, g, (byte[])localObject2);
        c = bkfg.a((byte[])localObject2);
      }
  ...
  private static void e()
  {
    try
    {
      ...
      localEditor.putString(n, "8.4.1.4680");
      localEditor.commit();
      return;
    }
    catch (Exception localException)
