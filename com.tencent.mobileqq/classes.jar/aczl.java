...
public class aczl
{
  ...
  private static aczl jdField_a_of_type_Aczl;
  private aczm jdField_a_of_type_Aczm;
  private SQLiteDatabase jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase;
  
  private aczl(Context paramContext)
  {
    this.jdField_a_of_type_Aczm = aczm.a(paramContext);
    try
    {
      this.jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase = this.jdField_a_of_type_Aczm.getWritableDatabase();
      return;
    }
  ...
  public static aczl a(Context paramContext)
  {
    if (jdField_a_of_type_Aczl == null) {}
    try
    {
      if (jdField_a_of_type_Aczl == null) {
        jdField_a_of_type_Aczl = new aczl(paramContext);
      }
      return jdField_a_of_type_Aczl;
    }
    finally {}
  }
  ...
  public java.util.List<ResultObject> a(boolean paramBoolean)
  {
    ...
    //   14: astore 7
    //   16: aload_0
    //   17: getfield 39	aczl:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   20: ifnull +13 -> 33
    //   23: aload_0
    //   24: getfield 39	aczl:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    ...
    //   38: if_icmpne +62 -> 100
    //   41: aload_0
    //   42: getfield 39	aczl:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   45: ldc 129
    //   47: aconst_null
    //   48: ldc 232
    //   50: iconst_2
    ...
    //   99: areturn
    //   100: aload_0
    //   101: getfield 39	aczl:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   104: ldc 129
    //   106: aconst_null
    //   107: aconst_null
    //   108: aconst_null
    ...
    //   150: aload_0
    //   151: aload 4
    //   153: invokespecial 247	aczl:a	(Landroid/database/Cursor;)Lcom/tencent/mfsdk/collector/ResultObject;
    //   156: astore 6
    //   158: aload 6
    //   160: ifnull +17 -> 177
    //   163: aload 4
