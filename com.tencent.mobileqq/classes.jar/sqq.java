  ...
  implements spj, spo
{
  ...
  public spi a(Context paramContext, BaseData paramBaseData, ViewGroup paramViewGroup)
  {
    ...
    try
    {
      ...
      oyj.a(((Container)localObject).getVirtualView(), localProteusItemData.a.getViewBean());
      paramViewGroup = (ViewGroup)localObject;
    ...
    return new sqr(this, (View)localObject, localProteusItemData);
  }
    ...
    for (;;)
    {
      try
      {
        if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext == null)
        {
          ...
          {
            QLog.d("WebProteusViewCreator", 1, "VIEW_TYPE_COUNT=" + spi.a + ",NAME_VIEWTYPE_MAP size=" + this.jdField_a_of_type_JavaUtilMap.size() + "type=" + i);
            spi.a += this.jdField_a_of_type_JavaUtilMap.size() + 1;
          }
        }
        else
        {
