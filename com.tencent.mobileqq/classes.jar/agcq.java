  ...
  implements Animator.AnimatorListener
{
  ...
  private agdq jdField_a_of_type_Agdq;
  private ImageView jdField_a_of_type_AndroidWidgetImageView;
  private LottieDrawable jdField_a_of_type_ComTencentMobileqqDiniflyLottieDrawable;
  private String jdField_a_of_type_JavaLangString = "";
  
  public agcq(Context paramContext)
  {
    super(paramContext);
    this.jdField_a_of_type_Agdq = new agdq(paramContext);
    this.jdField_a_of_type_Agdq.a(new agcr(this));
  }
  ...
  public void a(agdf paramagdf)
  {
    ...
    this.jdField_a_of_type_JavaLangString = axav.c();
    ...
    if ((bool) && (this.jdField_a_of_type_ComTencentMobileqqDiniflyLottieDrawable == null))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqDiniflyLottieDrawable.setImageAssetDelegate(new agcs(this));
    }
    try
    {
      ...
      LottieComposition.Factory.fromInputStream(a(), localFileInputStream, new agct(this));
      super.a(paramagdf);
      paramagdf.a(bool);
      return;
    }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Agdq != null)
    {
      this.jdField_a_of_type_Agdq.b();
      this.jdField_a_of_type_Agdq.c();
    }
    a(8);
    super.b();
  }
  ...
  public void c()
  {
    ...
    if ((this.jdField_a_of_type_Agdq != null) && (this.jdField_a_of_type_Agdq.a())) {
      this.jdField_a_of_type_Agdq.d();
    }
  }
