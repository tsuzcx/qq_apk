  ...
  implements GetChars, Spannable, CharSequence, Cloneable
{
  ...
  private ArrayList<baht> jdField_b_of_type_JavaUtilArrayList = new ArrayList();
  
  public bahs(CharSequence paramCharSequence, int paramInt)
  {
      ...
      if ((paramStringBuilder.charAt(paramInt1) == '<') && (paramInt1 < k - 2))
      {
        ...
        if ((i2 == 36) && (paramInt1 < k - 3))
        {
          ...
          for (;;)
          {
            ...
            a(new bain(i, paramInt3, 1), paramInt1, paramInt1 + 4, 33);
            paramInt1 += 4;
            break;
            if (j == 10) {
          ...
          if ((j >= 255) && (paramInt1 + 6 < k))
          {
            if (paramStringBuilder.charAt(paramInt1 + 6) == '>')
            {
              ...
              {
                bool = true;
                a(new baip(arrayOfChar, paramInt3, true, bool), paramInt1, paramInt1 + 7, 33);
                i = 2;
                label375:
                if (i >= 5) {
                  break label451;
          ...
          else if (j == 250)
          {
            ...
            a(new bain(10, paramInt3, 1), paramInt1, paramInt1 + 4, 33);
            paramInt1 += 4;
          }
        }
        else
        {
          ...
          if (((i2 == 37) || (i2 == 38)) && (paramInt1 < k - 6))
          {
            ...
            a(new bdof(i, (i1 & 0xFF) + ((j << 24) + 0 + (m << 16 & 0xFF0000) + (n << 8 & 0xFF00))), paramInt1, paramInt1 + 7, 33);
            paramInt1 += 7;
            continue;
          }
        }
  ...
  private void a(Object paramObject, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    paramObject = new baht(paramInt1, paramInt2, paramInt3);
  ...
  public int getSpanEnd(Object paramObject)
  {
    ...
    return ((baht)this.jdField_b_of_type_JavaUtilArrayList.get(i)).b;
  }
  ...
  public int getSpanFlags(Object paramObject)
  {
    ...
    return ((baht)this.jdField_b_of_type_JavaUtilArrayList.get(i)).c;
  }
  ...
  public int getSpanStart(Object paramObject)
  {
    ...
    return ((baht)this.jdField_b_of_type_JavaUtilArrayList.get(i)).jdField_a_of_type_Int;
  }
  ...
  public <T> T[] getSpans(int paramInt1, int paramInt2, Class<T> paramClass)
  {
    ...
    while (i < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      {
        baht localbaht = (baht)this.jdField_b_of_type_JavaUtilArrayList.get(i);
        if ((localbaht.jdField_a_of_type_Int >= paramInt1) && (localbaht.b <= paramInt2)) {
  ...
  public int nextSpanTransition(int paramInt1, int paramInt2, Class paramClass)
  {
    ...
    while (k < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      baht localbaht = (baht)this.jdField_b_of_type_JavaUtilArrayList.get(k);
      int i = paramInt2;
      if (((Class)localObject).isInstance(paramClass))
      {
        int j = paramInt2;
        if (localbaht.jdField_a_of_type_Int > paramInt1)
        {
          j = paramInt2;
          if (localbaht.jdField_a_of_type_Int < paramInt2) {
            j = localbaht.jdField_a_of_type_Int;
          }
        }
        i = j;
        if (localbaht.b > paramInt1)
        {
          i = j;
          if (localbaht.b < j) {
            i = localbaht.b;
  ...
  public void removeSpan(Object paramObject)
  {
    ...
    if (i >= 0)
    {
      ...
      baht localbaht = (baht)this.jdField_b_of_type_JavaUtilArrayList.remove(i);
      b(paramObject, localbaht.jdField_a_of_type_Int, localbaht.b);
    }
  }
  ...
  public void setSpan(Object paramObject, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      localbaht = (baht)this.jdField_b_of_type_JavaUtilArrayList.get(i);
      int j = localbaht.jdField_a_of_type_Int;
      int k = localbaht.b;
      localbaht.jdField_a_of_type_Int = paramInt1;
      localbaht.b = paramInt2;
      localbaht.c = paramInt3;
      a(paramObject, j, k, paramInt1, paramInt2);
    }
    if (i < 0)
    {
      this.jdField_a_of_type_JavaUtilArrayList.add(paramObject);
      localbaht = new baht(paramInt1, paramInt2, paramInt3);
      this.jdField_b_of_type_JavaUtilArrayList.add(localbaht);
