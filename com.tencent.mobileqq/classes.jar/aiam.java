  ...
  extends aiid
{
  ...
  public aiam(QQAppInterface paramQQAppInterface, Context paramContext, XListView paramXListView, aiig paramaiig, int paramInt, String paramString)
  {
  ...
  protected aihx a()
  {
    return new aiib(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false);
  }
  ...
  protected void a(boolean paramBoolean1, int paramInt1, int paramInt2, boolean paramBoolean2, ArrayList<RecommendTroopItem> paramArrayList, boolean paramBoolean3)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Aiao != null) {
        this.jdField_a_of_type_Aiao.a(paramBoolean1, i);
      }
      return;
      label358:
  ...
  public void b(boolean paramBoolean)
  {
    ...
    for (bool2 = bool1;; bool2 = true)
    {
      if (bool2)
      {
        SosoInterface.SosoLbsInfo localSosoLbsInfo = LbsManagerService.getCachedLbsInfo("recommend_troop");
        if (QLog.isColorLevel()) {
          QLog.i("ac_ft.AddContactFindTroopRTLW", 2, "getRecommendTroopList  >= M, info = " + localSosoLbsInfo);
        }
        if (localSosoLbsInfo == null) {
          LbsManagerService.startLocation(new aian(this, "recommend_troop", localanca, paramBoolean));
        }
      }
      else
      {
      ...
      localanca.a(1, this.jdField_b_of_type_Int, 25, paramBoolean, a());
      return;
      if (this.jdField_a_of_type_Int == 0)
      {
        localanca.a(this.jdField_a_of_type_Int, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_Int, 25, paramBoolean);
        return;
      }
      localanca.b(this.jdField_a_of_type_Int, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_Int, 25, paramBoolean);
      return;
      bool1 = true;
      break;
    }
