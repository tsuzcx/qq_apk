...
public class nym
{
  ...
  private nvt jdField_a_of_type_Nvt;
  ...
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null) || (this.jdField_a_of_type_Nvt == null)) {
      return -1L;
    }
    try
    {
      JSONObject localJSONObject = new JSONObject(paramString1);
      String str1 = new String(baaw.decode(localJSONObject.getString("comment"), 0));
      ...
      ((JSONObject)localObject1).put("native_version", babp.a(BaseApplicationImpl.getContext()));
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject2))
      {
        ...
        localObject2 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), ndt.class);
        ...
        ((NewIntent)localObject2).setObserver(new nyp(this, paramBoolean, l, paramInt2, paramString1, paramInt3, System.currentTimeMillis(), str1, paramString4, paramString2, paramString3, localJSONObject.optString("commentId")));
  ...
  {
    if ((paramBaseCommentData == null) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null) || (this.jdField_a_of_type_Nvt == null)) {
      return;
    }
    label393:
    for (;;)
    {
      ...
      try
      {
        ...
        ((JSONObject)localObject).put("native_version", babp.a(BaseApplicationImpl.getContext()));
        ...
        ((NewIntent)localObject).setObserver(new nyo(this, paramBaseCommentData, paramInt1, paramInt2));
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.startServlet((NewIntent)localObject);
        return;
      }
      catch (Exception paramString)
      {
        this.jdField_a_of_type_Nvt.a(false, paramBaseCommentData.commentId, paramInt1, paramInt2);
  ...
  public void a(BaseCommentData paramBaseCommentData, String paramString, int paramInt)
  {
    ...
    catch (Exception paramString)
    {
      ...
      {
        Object localObject;
        this.jdField_a_of_type_Nvt.a(false, paramBaseCommentData);
        paramString.printStackTrace();
        if (!QLog.isColorLevel()) {
          break;
        }
    ...
    if (!TextUtils.isEmpty((CharSequence)localObject))
    {
      ...
      ((NewIntent)localObject).putExtra("data", paramString.toByteArray());
      ((NewIntent)localObject).setObserver(new nyn(this, paramBaseCommentData));
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.startServlet((NewIntent)localObject);
      return;
    }
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((paramBaseCommentData instanceof CommentData))
        {
          ...
          localJSONObject.put("report_uin", obz.a());
          ...
          paramString2 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), ndt.class);
          ...
          paramString2.setObserver(new nyq(this, paramBaseCommentData));
  ...
  public void a(nvt paramnvt)
  {
    this.jdField_a_of_type_Nvt = paramnvt;
  }
}
