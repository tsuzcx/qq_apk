  ...
  extends akoq
{
  ...
  public akpi(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
  ...
  private MessageRecord a(MsgInfo paramMsgInfo, long paramLong)
  {
    ...
    long l1 = bbmx.a((byte[])localObject6, 0);
    byte b = localObject6[4];
    Object localObject5 = new ArrayList();
    Object localObject4 = (ajvg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6);
    Object localObject1 = (ajxl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
    Object localObject7 = (ajvi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53);
    ...
    case 9: 
      do
      {
        ...
        {
          return null;
          paramLong = bbmx.a((byte[])localObject6, 5);
          l2 = bbmx.a((byte[])localObject6, 9);
          ...
          ((ajvg)localObject4).a(l1);
          i = ((ajvi)localObject7).a(l1 + "");
        } while (((ajvi)localObject7).a(String.valueOf(l1), String.valueOf(l2)));
        if (QLog.isColorLevel()) {
        ...
        if ((TextUtils.isEmpty((CharSequence)localObject1)) || (bbcz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1))))
        {
          if (QLog.isColorLevel()) {
            QLog.d("Q.msg.DiscMsgPc.discuss", 2, "coptype 2 server memberName empty");
          }
          localObject1 = bbcz.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1), (String)localObject6);
        }
        localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691890, new Object[] { localObject1 });
        ((List)localObject5).add(localObject6);
        ((ajvg)localObject4).a(l1, (String)localObject6, (List)localObject5, 10009);
        if (((String)localObject6).equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))
        {
          ((ajvi)localObject7).a(String.valueOf(l1), String.valueOf(l3));
          a(b, l1, l3);
          ((ajvg)localObject4).a(String.valueOf(l1));
          return null;
        }
        ((ajvg)localObject4).a(l1);
        ((ajvi)localObject7).a(String.valueOf(l1), String.valueOf(l3));
        ...
        l2 = bbmx.a((byte[])localObject6, 5);
        k = bbmx.a((byte[])localObject6, 13);
        localObject3 = new ArrayList();
        j = 15;
        for (i = 1; i < k + 1; i = (short)(i + 1))
        {
          localObject7 = (String)((ArrayList)localObject1).get(i);
          l3 = bbmx.a((byte[])localObject6, j);
          j += 4;
          ((List)localObject5).add(String.valueOf(l3));
          ((ArrayList)localObject3).add(new Pair(String.valueOf(l3), localObject7));
        }
        localObject6 = new ajvh();
        ((ajvh)localObject6).jdField_b_of_type_Int = ((ArrayList)localObject1).size();
        ((ajvh)localObject6).jdField_a_of_type_JavaLangString = String.valueOf(l1);
        ((ajvg)localObject4).a((ajvh)localObject6);
        ((ajvg)localObject4).a(l1, String.valueOf(l2), (List)localObject5, 10004);
        ...
        if (((aktf)localObject6).b(Long.toString(l1), 3000) != null)
        {
          if (QLog.isColorLevel()) {
            QLog.d("Q.msg.DiscMsgPc.discuss", 2, "handleDiscussionMemchangeMsg ru alreadyintab");
          }
          if (bbcz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1)))
          {
        ...
        localObject5 = ((aktf)localObject6).a(Long.toString(l1), 3000);
        ahpd.a((RecentUser)localObject5, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a());
        ...
        ((aktf)localObject6).a((RecentUser)localObject5);
        if (QLog.isColorLevel()) {
        ...
        for (;;)
        {
          ...
          if (TextUtils.equals((CharSequence)localObject6, String.valueOf(l2)))
          {
            ...
            axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Multi_call", "Show_discuss_tips", 0, 0, "", "", "", "");
          }
          else
          {
            b((Pair)localObject4, paramMsgInfo, (ArrayList)localObject3, paramLong, String.valueOf(l1), b, true);
        ...
        l2 = bbmx.a((byte[])localObject6, 5);
        l3 = bbmx.a((byte[])localObject6, 9);
        bbmx.a((byte[])localObject6, 13);
        i = bbmx.a((byte[])localObject6, 17);
        localObject1 = new byte[i];
        bbmx.b((byte[])localObject6, 19, (byte[])localObject1, i);
        ...
        if (l2 == paramLong)
        {
          localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691831, new Object[] { localObject5 });
          ((ajvg)localObject4).a(String.valueOf(l1), (String)localObject5);
          a(paramMsgInfo, paramLong, l1, l2, (String)localObject1);
          return null;
        }
        localObject3 = "";
        localObject1 = ((ajvi)localObject7).a(String.valueOf(l1));
        if ((localObject1 != null) && (((DiscussionInfo)localObject1).isDiscussHrMeeting())) {
          localObject1 = bbgi.a((ajvi)localObject7, ((DiscussionInfo)localObject1).uin, String.valueOf(l2));
        }
        for (;;)
        {
          ...
          if (TextUtils.isEmpty((CharSequence)localObject1))
          {
            ...
            localObject3 = bbcz.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1), String.valueOf(l2));
          }
          localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691832, new Object[] { localObject3, localObject5 });
          break;
          localObject1 = localObject3;
          if (paramMsgInfo.vNickName != null)
          {
      ...
      } while (bbmx.a((byte[])localObject6, 5) == 0);
      k = bbmx.a((byte[])localObject6, 7);
      localObject4 = new ArrayList();
      i = 9;
      j = 0;
      while (j < k)
      {
        l3 = bbmx.a((byte[])localObject6, i);
        localObject3 = "";
        localObject1 = localObject3;
        if (paramMsgInfo.vNickName != null)
        {
      ...
      j = bbmx.a((byte[])localObject6, i);
      localObject1 = new byte[j];
      bbmx.b((byte[])localObject6, i + 2, (byte[])localObject1, j);
    ...
    case 22: 
      l3 = bbmx.a((byte[])localObject6, 5);
      bbmx.a((byte[])localObject6, 9);
      l4 = bbmx.a((byte[])localObject6, 13);
      l5 = bbmx.a((byte[])localObject6, 17);
      if (l5 == 0L) {
        break;
      }
    }
    for (int i = 1;; i = 0)
    {
      ...
      default: 
        ...
        if (((aktf)localObject1).b(Long.toString(l1), 3000) != null) {
          return null;
        }
        break;
      case 0: 
      ...
      case 2: 
        ...
        localObject1 = new ajvh();
        ((ajvh)localObject1).jdField_b_of_type_Int = k;
        ((ajvh)localObject1).jdField_a_of_type_JavaLangString = String.valueOf(l1);
        ((ajvg)localObject4).a((ajvh)localObject1);
        ...
        for (i = 1;; i = 0)
        {
          ...
          while (i < k)
          {
            String str = String.valueOf(bbmx.a((byte[])localObject6, j));
            localObject3 = "";
            localObject1 = localObject3;
            if (paramMsgInfo.vNickName != null)
            {
        ...
        for (;;)
        {
          ((ajvg)localObject4).a(l1, String.valueOf(l3), (List)localObject5, i);
          if (this.jdField_a_of_type_AndroidOsHandler == null) {
            this.jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper());
          }
      ...
      localObject3 = ((aktf)localObject1).a(Long.toString(l1), 3000);
      ...
      ((aktf)localObject1).a((RecentUser)localObject3);
      return null;
      i = localObject6.length - 5;
      localObject1 = new byte[i];
      bbmx.b((byte[])localObject6, 5, (byte[])localObject1, i);
      localObject3 = new oidb_0x858.NotifyMsgBody();
      paramMsgInfo = (MessageForQQWalletTips)axas.a(-2029);
      try
      {
        ...
        paramMsgInfo.init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), l2 + "", "", "[QQWallet Tips]", awzy.a(), -2029, 3000, awzy.a());
      ...
      return null;
      bbmx.a((byte[])localObject6, 5);
      bbmx.a((byte[])localObject6, 9);
      i = localObject6[13];
      return null;
      l3 = bbmx.a((byte[])localObject6, 5);
      l4 = bbmx.a((byte[])localObject6, 9);
      i = bbmx.a(localObject6[13]);
      bbmx.a((byte[])localObject6, 14, i);
      i += 14;
      k = bbmx.a((byte[])localObject6, i);
      j = i + 2;
      Object localObject2 = new HashSet();
      i = 0;
      while (i < k)
      {
        l5 = bbmx.a((byte[])localObject6, j);
        j += 4;
      ...
      localObject3 = (ajvg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6);
      ...
      if (((HashSet)localObject2).contains(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))
      {
        ...
        for (;;)
        {
          ((ajvg)localObject3).a(l1, String.valueOf(l3), (List)localObject5, 10005);
          return null;
          ((ajvg)localObject3).a((String)localObject4);
          a(paramMsgInfo, paramLong, l2, l2, ajya.a(2131703340));
        }
      }
      ((ajvg)localObject3).a((String)localObject4, (HashSet)localObject2);
      if (Long.getLong((String)localObject4) != null) {}
      for (paramLong = Long.getLong((String)localObject4).longValue();; paramLong = 0L)
      {
        ((ajvg)localObject3).a(paramLong);
        break;
      }
      l4 = bbmx.a((byte[])localObject6, 5);
      l3 = bbmx.a((byte[])localObject6, 9);
      if (QLog.isColorLevel()) {
      ...
      if (TextUtils.isEmpty((CharSequence)localObject2))
      {
        ...
        localObject2 = bbcz.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1), (String)localObject7);
      }
      for (;;)
      {
        k = bbmx.a((byte[])localObject6, 13);
        ...
        if (((HashSet)localObject8).size() > 0)
        {
          ...
          while (((Iterator)localObject6).hasNext())
          {
            ...
            ((StringBuffer)localObject3).append(bbcz.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1), (String)localObject9)).append("、");
          }
        }
        ...
        {
          localObject6 = (ajvg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6);
          ((ajvg)localObject6).a(l1, (String)localObject7, (List)localObject5, 10005);
          localObject3 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691887, new Object[] { localObject3 });
          if (((HashSet)localObject8).contains(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))
          {
            ...
            ((ajvg)localObject6).a(String.valueOf(l1));
            a(paramMsgInfo, paramLong, l2, l2, ajya.a(2131703339));
            return null;
          }
          localObject2 = (String)localObject2 + ajya.a(2131703338) + (String)localObject3;
          ((ajvg)localObject6).a(String.valueOf(l1), (HashSet)localObject8);
          ((ajvg)localObject4).a(l1);
          a(paramMsgInfo, paramLong, l2, l2, (String)localObject2);
          return null;
          i = (int)bbmx.a((byte[])localObject6, 5);
          localObject2 = new byte[i];
          bbmx.b((byte[])localObject6, 9, (byte[])localObject2, i);
          ...
          try
          {
            ...
            case 2: 
              ...
              if (((ajvi)localObject7).jdField_a_of_type_JavaUtilMap != null)
              {
                ((ajvi)localObject7).jdField_a_of_type_JavaUtilMap.put(localObject3, new String[] { localObject2, paramMsgInfo });
                ((ajvi)localObject7).jdField_a_of_type_JavaUtilSet.add(localObject2);
              }
              if (QLog.isColorLevel()) {
              ...
              ((ajvg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6)).a(String.valueOf(l1));
              if ((BaseActivity.sTopActivity instanceof SplashActivity)) {}
              ((ajsx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(22)).notifyUI(41, true, new Object[] { Integer.valueOf(2131696440), localObject3, localObject2, Boolean.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c().equals(paramMsgInfo)) });
            }
          }
  ...
  private MessageRecord a(MsgInfo paramMsgInfo, SvcReqPushMsg paramSvcReqPushMsg)
  {
    ...
    if ((paramMsgInfo != null) && (!akas.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMsgInfo, true))) {
      return paramMsgInfo;
    }
    return null;
  }
  ...
  {
    MessageRecord localMessageRecord = axas.a(-1050);
    String str = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131720686);
    switch (paramInt)
    {
    default: 
      if (QLog.isColorLevel()) {
    ...
    for (int i = 2131691843;; i = 2131691823)
    {
  ...
  {
    MessageRecord localMessageRecord = axas.a(-1004);
    ...
    localMessageRecord.isread = true;
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.DiscMsgPc", 2, "----------handleC2COnlinePushMsgResp after analysis friendUin: " + paramLong2 + " msgType: " + -1004 + " friendType: " + 3000 + " shMsgSeq: " + paramMsgInfo.shMsgSeq + " msgContent: " + bbbr.a(paramString));
    }
  ...
  private void a(Pair<Long, String> paramPair1, MsgInfo paramMsgInfo, long paramLong1, long paramLong2, long paramLong3, byte paramByte, long paramLong4, Pair<Long, String> paramPair2)
  {
    ...
    if (TextUtils.isEmpty(paramPair1))
    {
      ...
      paramPair1 = bbcz.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(paramLong2), String.valueOf(l1));
    }
    for (;;)
    {
      ...
      if (TextUtils.isEmpty(str))
      {
        ...
        paramPair2 = bbcz.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(paramLong2), String.valueOf(l2));
      }
      if (bbcz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(paramLong2))) {
        paramPair1 = bbcz.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(paramLong2), String.valueOf(l1));
      }
      if (paramLong4 == 0L) {
        paramPair1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691888, new Object[] { paramPair1 });
      }
      for (;;)
      {
        ...
        return;
        if (paramLong4 == 1L) {
          paramPair1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691889, new Object[] { paramPair1, paramPair2 });
        } else if (paramLong4 == 2L) {
          paramPair1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131692316, new Object[] { paramPair1 });
        } else {
          paramPair1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691884, new Object[] { paramPair1 });
        }
      }
    }
  }
  ...
  private void a(Pair<Long, String> paramPair, MsgInfo paramMsgInfo, ArrayList<Pair<String, String>> paramArrayList, long paramLong1, String paramString, byte paramByte, long paramLong2, boolean paramBoolean)
  {
    ...
    if (m > 50)
    {
      ...
      paramPair = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691893);
    ...
    for (;;)
    {
      ...
      if ((!TextUtils.isEmpty(paramPair)) && (!bbcz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString))) {
        break label133;
      }
      if (QLog.isColorLevel()) {
        QLog.d("Q.msg.DiscMsgPc.discuss", 2, "showWelcomeTips server name empty cOpType:" + paramByte);
      }
      paramPair = bbcz.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, (String)localObject);
      break label133;
      label242:
      localStringBuffer.append("、" + paramPair);
    }
    ...
    Object localObject = axas.a(i);
    paramPair = "";
    if (paramByte == 11) {
      paramPair = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691891);
    }
    if (paramByte == 22)
    {
      if (paramLong2 == 0L) {
      ...
      for (;;)
      {
        ...
        return;
        if (paramLong2 == 1L) {
          paramPair = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691892);
        } else if (paramLong2 == 2L) {
          paramPair = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131692317, new Object[] { localStringBuffer.toString() });
        }
      }
    }
    if (l == paramLong1)
    {
      ...
      paramPair = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691865);
    }
    for (;;)
    {
      paramPair = paramPair + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691884, new Object[] { localStringBuffer.toString() });
      break;
      j = 0;
      break label644;
      label721:
      ...
      if (TextUtils.isEmpty(str))
      {
        ...
        paramPair = bbcz.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, String.valueOf(l));
      }
      if (bbcz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString)) {
        paramPair = bbcz.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, String.valueOf(l));
      }
      paramPair = paramPair + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691864);
      continue;
      label841:
      paramPair = "";
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, int paramInt, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    bbmx.b(paramArrayOfByte, paramInt, paramMessageRecord, i);
  ...
  private void a(ToServiceMsg paramToServiceMsg, ArrayList<msg_comm.Msg> paramArrayList, msg_svc.PbGetDiscussMsgResp paramPbGetDiscussMsgResp)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      {
        paramToServiceMsg = (ajvg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6);
        ...
        while (j < k)
        {
          ...
          if ((paramArrayList instanceof MessageForMarketFace)) {
            aske.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForMarketFace)paramArrayList);
          }
          j += 1;
        }
        j = 0;
        ...
        if (paramToServiceMsg.size() > 0)
        {
          ...
          paramArrayList = (akom)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(3000);
          ...
          bool2 = akas.a(paramToServiceMsg);
          j = akpx.a(paramToServiceMsg, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      ...
      for (boolean bool1 = bool2;; bool1 = false)
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a(bool1)) && (!akpx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str, 3000)))
        {
          bool1 = true;
          ...
          ((bbrg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(235)).a.a(paramToServiceMsg);
        }
        for (;;)
        {
          if ((i != 0) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(str) == 1))
          {
            ...
            if (paramToServiceMsg != null)
            {
              ...
              ((akom)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(3000)).b(str, 3000, l1);
            }
          }
          return;
          bool1 = false;
  ...
  private void a(ToServiceMsg paramToServiceMsg, ArrayList<msg_comm.Msg> paramArrayList, msg_svc.PbGetDiscussMsgResp paramPbGetDiscussMsgResp, String paramString)
  {
    ...
    for (paramArrayList = ((msg_comm.DiscussInfo)localObject3).discuss_remark.get().toByteArray();; paramArrayList = null)
    {
      for (;;)
      {
        ...
        localaxav.e = l5;
        localaxav.jdField_c_of_type_Int = 3000;
        localaxav.d = m;
        ...
        try
        {
          a((msg_comm.Msg)localObject2, localArrayList3, localaxav, true, localazml);
          ...
          akas.a((List)localObject3);
          localArrayList1.addAll((Collection)localObject3);
          akas.a("Q.msg.DiscMsgPc", paramString, l3, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), String.valueOf(l5));
          if ((paramArrayList == null) || (paramArrayList.length <= 0)) {
            break;
          }
          localObject3 = String.valueOf(l1);
          localObject2 = bbea.a(paramArrayList) + ":" + (String)localObject3;
          if (((HashSet)localObject1).contains(localObject2)) {
            break;
          }
          paramArrayList = ((ajvi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).a(paramArrayList, String.valueOf(l5), (String)localObject3, false);
          if (paramArrayList == null) {
            break;
          }
      ...
      if (localArrayList2.size() > 0) {
        ((ajvi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).b(localArrayList2);
      }
      paramArrayList = (ajvg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6);
      ...
      ((asks)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(37)).a(paramArrayList + "&" + 3000, localazml);
      paramArrayList = new ArrayList();
      if (paramToServiceMsg != null)
      {
      ...
      ((bbrg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(235)).a.a(localArrayList1);
      return;
    }
  }
  ...
  {
    MessageRecord localMessageRecord = axas.a(-1016);
    long l = awzy.a();
    if ((paramArrayList != null) && (paramArrayList.size() > 1))
    {
      ...
      paramArrayList = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131691316, new Object[] { localStringBuilder });
      localMessageRecord.init(paramString2, paramString1, paramString3, paramArrayList + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131694445), l, -1016, 3000, l);
  ...
  private void a(ArrayList<msg_comm.Msg> paramArrayList, ArrayList<MessageRecord> paramArrayList1)
  {
    ...
    for (paramArrayList = ((msg_comm.DiscussInfo)localObject2).discuss_remark.get().toByteArray();; paramArrayList = null)
    {
      ...
      for (;;)
      {
        try
        {
          a(localMsg, localArrayList2, localaxav, true, (azml)localObject1);
          if (!QLog.isColorLevel()) {
            break label1003;
          }
        ...
        catch (Exception localException)
        {
          ...
          continue;
          akas.a((List)localObject2);
          paramArrayList1.addAll((Collection)localObject2);
          if ((paramArrayList != null) && (paramArrayList.length > 0))
          {
            localObject1 = String.valueOf(l4);
            String str = bbea.a(paramArrayList) + ":" + (String)localObject1;
            if (!localHashSet.contains(str))
            {
              paramArrayList = ((ajvi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).a(paramArrayList, String.valueOf(l1), (String)localObject1, false);
              if (paramArrayList != null)
              {
        ...
        if (localArrayList1.size() > 0) {
          ((ajvi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).b(localArrayList1);
        }
        if (!QLog.isColorLevel()) {
          break;
        }
    ...
    for (localObject1 = ((msg_comm.DiscussInfo)localObject2).discuss_remark.get().toByteArray();; localObject1 = null)
    {
      ...
      for (;;)
      {
        ...
        if (QLog.isColorLevel())
        {
          ...
          paramFromServiceMsg.append(" fromUin:").append(l1).append(" toUin").append(l4).append(" msgTime:").append(m).append(" msgSeq:").append(l5).append(" msgUid:").append(l6).append(" userActive:").append(n).append(" fromInstid:").append(i1).append(" disUin:").append(l2).append(" disType:").append(i2).append(" disSeq:").append(l7).append(" remarkSender:").append(bbea.a((byte[])localObject1)).append(" divSeq:").append(k).append(" pkgIndex:").append(j).append(" pkgNum:").append(i).append(" hasShare:").append(paramMsg.appshare_info.has());
          QLog.d("Q.msg.DiscMsgPc", 2, paramFromServiceMsg.toString());
        }
        ((ajvg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6)).a(l2, l1);
        ((ajxl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).a(l1);
        paramFromServiceMsg = (ajvi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53);
        localObject2 = new axav();
        ((axav)localObject2).e = l2;
        ((axav)localObject2).jdField_c_of_type_Int = 3000;
        ((axav)localObject2).d = i2;
          ...
          if (i < j)
          {
            ...
            if ((((MessageRecord)localObject5).senderuin != null) && (((MessageRecord)localObject5).senderuin.equalsIgnoreCase(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())))
            {
              ...
              if (localObject6 != null)
              {
                ...
                adgc.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((MessageRecord)localObject6).uniseq);
              }
            }
            for (;;)
            {
              ...
              this.jdField_a_of_type_ComTencentMobileqqAppMessageQQMessageFacade.a(((MessageRecord)localObject5).frienduin, 3000, ((MessageRecord)localObject5).shmsgseq);
              ...
              if ((i == 0) && (localObject1 != null) && (localObject1.length > 0))
              {
                ...
                localObject6 = bbea.a((byte[])localObject1) + ":" + str;
        ...
        if (paramFromServiceMsg.size() > 0)
        {
          ...
          boolean bool2 = akas.a(paramFromServiceMsg);
          i = akpx.a(paramFromServiceMsg, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          ...
          if ((!this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a(bool2)) || (akpx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, Long.toString(l2), 3000))) {
            break label1824;
          }
        }
        for (boolean bool1 = true;; bool1 = false)
        {
          ...
          ((bbrg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(235)).a.a(paramMsg);
          return;
        }
        i = 0;
        j = 0;
  ...
  private boolean a(long paramLong1, long paramLong2, short paramShort)
  {
    ...
    //   9: lload_1
    //   10: invokevirtual 84	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   13: ldc_w 1582
    //   16: invokevirtual 76	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   19: lload_3
    //   20: invokevirtual 84	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   23: ldc_w 1582
    //   26: invokevirtual 76	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   29: iload 5
    //   31: invokevirtual 79	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   34: invokevirtual 88	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   37: astore 7
    //   39: aload_0
    //   40: getfield 44	akpi:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   43: invokevirtual 1024	com/tencent/mobileqq/app/QQAppInterface:a	()Lawzy;
    //   46: invokevirtual 1584	awzy:a	()Ljava/util/ArrayList;
    //   49: aload 7
    //   51: invokevirtual 1585	java/util/ArrayList:contains	(Ljava/lang/Object;)Z
    //   54: ifeq +45 -> 99
    //   57: invokestatic 65	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   60: ifeq +31 -> 91
    //   63: ldc_w 582
    //   66: iconst_2
    ...
    //   88: invokestatic 1589	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   91: iconst_1
    //   92: istore 6
    //   94: aload_0
    //   95: monitorexit
    ...
    //   98: ireturn
    //   99: aload_0
    //   100: getfield 44	akpi:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   103: invokevirtual 1024	com/tencent/mobileqq/app/QQAppInterface:a	()Lawzy;
    //   106: aload 7
    //   108: invokevirtual 1590	awzy:a	(Ljava/lang/String;)V
    //   111: iconst_0
    //   112: istore 6
    //   114: goto -20 -> 94
    //   117: astore 7
  ...
  public static void b(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, int paramInt, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      if (paramInt == 11)
      {
        ...
        ((airt)paramQQAppInterface.getManager(211)).a(0, 3000, Long.toString(l), paramArrayOfByte);
        return;
      }
      if (paramInt == 12)
      {
        ...
        ((aisr)paramQQAppInterface.getManager(227)).a(3000, paramArrayOfByte);
        return;
      }
    }
    catch (Exception paramQQAppInterface)
    ...
    if (paramInt == 13)
    {
      ...
      if (paramArrayOfByte.opt_msg_goldtips.has())
      {
        ...
        if ((paramQQAppInterface.type.has()) && (paramQQAppInterface.type.get() == 3)) {
          ahbc.a(3000, null, (oidb_0x858.GoldMsgTipsElem)paramArrayOfByte.opt_msg_goldtips.get());
        }
      }
    }
  }
  ...
  public akqi a(int paramInt, MsgInfo paramMsgInfo, SvcReqPushMsg paramSvcReqPushMsg)
  {
    ...
    for (;;)
    {
      ...
      if ((paramMsgInfo != null) && (paramSvcReqPushMsg != null)) {
        return new akqi(a(paramMsgInfo, paramSvcReqPushMsg), false);
      }
      a(getClass().getName(), paramInt);
    }
  }
  
  public List<MessageRecord> a(msg_comm.Msg paramMsg, axav paramaxav)
  {
    ArrayList localArrayList1 = new ArrayList();
    ArrayList localArrayList2 = new ArrayList();
    azml localazml = new azml();
    try
    {
      a(paramMsg, localArrayList1, paramaxav, true, localazml);
      long l = paramMsg.msg_head.discuss_info.discuss_uin.get();
      ((asks)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(37)).a(String.valueOf(l) + "&" + 3000, localazml);
