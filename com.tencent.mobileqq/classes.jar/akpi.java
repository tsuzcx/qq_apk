  ...
  implements aknd
{
  ...
  protected akpi(NewPhotoPreviewActivity paramNewPhotoPreviewActivity)
  {
  ...
  public void a_(SlideItemInfo paramSlideItemInfo)
  {
    ...
    if (i < this.jdField_a_of_type_Akmr.paths.size()) {
      if (!((String)this.jdField_a_of_type_Akmr.paths.get(i)).equals(paramSlideItemInfo.b)) {}
    }
    for (;;)
    {
      if ((i >= 0) && (i < this.jdField_a_of_type_Akmr.paths.size()) && (this.jdField_a_of_type_JavaUtilHashMap != null)) {
        this.jdField_a_of_type_JavaUtilHashMap.remove(this.jdField_a_of_type_Akmr.paths.get(i));
      }
      return;
      i += 1;
      break;
  ...
  public void ak_()
  {
    ...
    if (i != -1)
    {
      String str = (String)this.jdField_a_of_type_Akmr.paths.get(i);
      if (this.c)
      {
  ...
  protected void d()
  {
    ...
    {
      aklj.a(((ArrayList)localObject1).size(), this.jdField_a_of_type_Akmr.totalPicCount);
      aklj.a(((NewPhotoPreviewActivity)this.mActivity).getIntent(), ((ArrayList)localObject1).size(), this.mPhotoCommonData.currentQualityType);
    }
    Intent localIntent = ((NewPhotoPreviewActivity)this.mActivity).getIntent();
    if (localObject1 != null) {
      alrr.a((List)localObject1);
    }
    if ((this.c) || (((akmq)this.mOtherCommonData).a()))
    {
  ...
  public void initData(Intent paramIntent)
  {
    ...
    ((akmq)this.mOtherCommonData).a(this.b, this.mPhotoCommonData);
  ...
  public void onMagicStickClick(View paramView, int paramInt1, Bundle paramBundle, int paramInt2, Intent paramIntent)
  {
    ...
    label594:
    for (paramView = (LocalMediaInfo)this.mPhotoCommonData.selectedMediaInfoHashMap.get(this.jdField_a_of_type_Akmr.a);; paramView = null)
    {
      if ((this.jdField_a_of_type_Boolean) && (AlbumUtil.getMediaType(paramView) == 1) && (this.c) && (this.jdField_a_of_type_Akmr.c))
      {
        ...
        paramBundle.putExtra("file_send_path", this.jdField_a_of_type_Akmr.a);
      ...
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_Akmr.c)
        {
          ...
          if (this.c) {
            paramView = QzoneEditPictureActivity.a(this.mActivity, this.jdField_a_of_type_Akmr.a);
          } else {
            paramView = EditPicActivity.a(this.mActivity, this.jdField_a_of_type_Akmr.a, true, true, true, true, true, 3, 99, 4, paramView);
          }
        }
        else
        {
  ...
  public void onSelectClick(View paramView)
  {
    ...
    if (i != -1) {}
    for (String str = (String)this.jdField_a_of_type_Akmr.paths.get(i);; str = "")
    {
      LocalMediaInfo localLocalMediaInfo = ((NewPhotoPreviewActivity)this.mActivity).getMediaInfo(str);
      if ((this.c) && (this.jdField_a_of_type_Akmr.paths != null) && (((NewPhotoPreviewActivity)this.mActivity).getMediaType(str) == 1) && (!AlbumUtil.checkVideoForQzoneUploadPhoto(this.mActivity, b(), localLocalMediaInfo, ((akmq)this.mOtherCommonData).a())))
      {
      ...
      str = (String)this.jdField_a_of_type_Akmr.paths.get(i);
      if ((!this.c) && (!((akmq)this.mOtherCommonData).a())) {
        break;
      }
      if (this.mPhotoCommonData.selectedMediaInfoHashMap == null) {
  ...
  public void updateButton()
  {
    ...
    {
      localObject = ((NewPhotoPreviewActivity)this.mActivity).getString(2131698924);
      if (this.jdField_a_of_type_Int == 1) {
        localObject = ((NewPhotoPreviewActivity)this.mActivity).getString(2131694638);
      }
    ...
    for (;;)
    {
      ...
      else if (this.jdField_a_of_type_Boolean)
      {
        ...
        if ((this.c) && (this.jdField_a_of_type_Akmr.paths != null)) {
      ...
      for (boolean bool1 = bool2;; bool1 = false)
      {
        ...
        c();
        return;
        localObject = ((NewPhotoPreviewActivity)this.mActivity).getString(2131694617);
        break;
        bool1 = false;
        break label132;
      }
