  ...
  implements aywc
{
  ...
  public aluf(QQAppInterface paramQQAppInterface)
  {
    this.a = paramQQAppInterface;
  }
  
  private boolean a(aywz paramaywz, String paramString)
  {
    if (paramaywz == null) {}
    while (paramaywz.a(paramString) == -1) {
      return false;
    }
    return true;
  }
  ...
  public ReqItem a(int paramInt)
  {
    ...
    if ((j - i > paramInt) || (j < i))
    {
      ...
      ((PreloadInfoCheckUpdate.ControlReqHead)localObject3).client_ver.set("8.3.3");
      ...
      ((PreloadInfoCheckUpdate.ControlReqHead)localObject3).mem.set((int)bdcb.d() / 1048576);
      ...
      Object localObject4 = bdiw.a((SharedPreferences)localObject1, "key_web_plugin_list" + this.a.getCurrentAccountUin(), null);
      if ((localObject4 != null) && (!((Set)localObject4).isEmpty()))
      {
        localObject3 = (aywz)this.a.getManager(12);
      ...
      System.arraycopy(bcwj.b(i), 0, localObject2, 0, 4);
    ...
    if (paramRespItem != null)
    {
      ...
      if (i == 2) {
        try
        {
          ...
          {
            i = (int)bdlr.a((byte[])localObject1, 0);
            paramRespItem = new byte[i - 4];
            bdlr.a(paramRespItem, 0, (byte[])localObject1, 4, i - 4);
    ...
    while (!QLog.isColorLevel())
    {
      do
      {
        do
        {
          ...
          bdiw.a(paramRespItem, "key_web_plugin_list" + this.a.getCurrentAccountUin(), (Object[])localObject2);
