...
public class ohp
{
  ...
  private static volatile ohp jdField_a_of_type_Ohp;
  private static ohz jdField_a_of_type_Ohz = new ohz(null);
  ...
  private ohp()
  {
    this.jdField_a_of_type_Oid = new oid(this);
    this.jdField_b_of_type_Oid = this.jdField_a_of_type_Oid;
    p();
  }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (m < localObject2.length)
        {
          ...
          String str = bady.a(BaseApplicationImpl.getContext(), localObject2[m]);
  ...
  private String a(awum paramawum)
  {
    paramawum = paramawum.a.iterator();
    while (paramawum.hasNext())
    {
      awul localawul = (awul)paramawum.next();
      if ((localawul instanceof StructMsgItemTitle)) {
        return ((StructMsgItemTitle)localawul).b();
      }
    }
    return "";
  }
  ...
  private String a(List<ChatMessage> paramList)
  {
    ...
    if (MessageForStructing.class.isInstance(paramList))
    {
      ...
      if (StructMsgForGeneralShare.class.isInstance(paramList))
      {
        ...
        {
          Object localObject = (awul)paramList.next();
          if ((localObject instanceof awum))
          {
            localObject = a((awum)localObject);
  ...
  public static ohp a()
  {
    if (jdField_a_of_type_Ohp == null) {}
    try
    {
      if (jdField_a_of_type_Ohp == null) {
        jdField_a_of_type_Ohp = new ohp();
      }
      return jdField_a_of_type_Ohp;
    }
    finally {}
  }
  
  private ohr a(List<ChatMessage> paramList)
  {
    ohr localohr = new ohr(this);
    int m = 0;
    int n = 0;
    Object localObject = bgmq.a();
    ...
    else
    {
      ...
      localohr.a = paramList;
      localohr.b = ((oidb_cmd0x80a.AttributeList)localObject);
      localohr.c = localAttributeList1;
      localohr.d = localAttributeList2;
      return localohr;
    }
    int i2;
  ...
  public static void a(List<oic> paramList)
  {
  ...
  {
    oid localoid = a().jdField_a_of_type_Oid;
    if (paramInt1 == 0) {}
  ...
  public static void c(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        ...
        boolean bool2;
        m = 0;
        aciy.a("onMainFragmentTabClick", "onMainFragmentTabClick", localException1);
        continue;
      }
      try
      {
                ...
                if (SPEventReportSwitch.a(paramInt))
                {
                  ...
                  if (SPEventReportSwitch.a(paramInt))
                  {
                    ...
                    if (((SPEventReportSwitch.a()) && (l1 - jdField_f_of_type_Long >= SPEventReportSwitch.c() * 1000) && (jdField_a_of_type_Int <= 1)) || (SPEventReportSwitch.a(paramInt)))
                    {
                      ...
                      try
                      {
                        Pair localPair = bgmq.b();
                        paramInt = (int)(Long.valueOf(obz.a()).longValue() % 100L);
  ...
  public static void d(boolean paramBoolean)
  {
    ...
    do
    {
      return;
      pol.a();
    } while (ohs.jdField_a_of_type_Int == 2);
    ohs.c();
  ...
  {
    Object localObject = vlf.a();
    if (TextUtils.equals((CharSequence)localObject, (String)bgmq.a("dau_report_type_" + paramInt, "")))
    {
      QLog.d("ReadinjoySPEventReport", 2, "has report dau for type today, type :" + paramInt);
      return;
    }
    bgmq.a("dau_report_type_" + paramInt, localObject);
    localObject = new oidb_cmd0x80a.AttributeList();
  ...
  public static void g()
  {
    ...
    try
    {
      ...
      BaseApplicationImpl.getContext().registerReceiver(jdField_a_of_type_Ohz, localIntentFilter);
      return;
    }
    catch (Exception localException)
    {
  ...
  public static void m()
  {
    ...
    localAttributeList.att_value.set(oab.a());
    localArrayList.add(localAttributeList);
    rtr.a(91, localArrayList);
  }
  ...
  private void r()
  {
    ...
    {
      ArrayList localArrayList = new ArrayList();
      localArrayList.add(this.jdField_a_of_type_Ohr.a);
      localArrayList.add(this.jdField_a_of_type_Ohr.c);
      localArrayList.add(this.jdField_a_of_type_Ohr.d);
      rtr.a(14, localArrayList);
    }
  }
  ...
  public ArrayList<oidb_cmd0x80a.AttributeList> a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      ((oidb_cmd0x80a.AttributeList)localObject2).att_value.set(String.valueOf(obz.jdField_d_of_type_Int));
      localArrayList.add(localObject2);
      localObject2 = new oidb_cmd0x80a.AttributeList();
      ...
      if (obz.c((QQAppInterface)localObject1)) {}
      ...
      ((oidb_cmd0x80a.AttributeList)localObject1).att_value.set(obz.jdField_a_of_type_Long + ":" + obz.jdField_d_of_type_Int);
      ...
      if (a())
      {
        ...
        if (localObject1 != null)
        {
          ((ohr)localObject1).b.att_id.set(110);
          localArrayList.add(((ohr)localObject1).b);
        }
        localObject1 = new oidb_cmd0x80a.AttributeList();
      ...
      localObject3 = ((oidb_cmd0x80a.AttributeList)localObject2).att_value;
      if ((i1 >= 0) && (i1 + 1 <= obz.jdField_a_of_type_Int)) {}
      for (localObject1 = "1";; localObject1 = "0")
      {
        ((PBStringField)localObject3).set((String)localObject1);
        localArrayList.add(localObject2);
        localObject1 = vlt.c(BaseApplicationImpl.getContext());
        if (!TextUtils.isEmpty((CharSequence)localObject1))
        {
          localObject2 = new oidb_cmd0x80a.AttributeList();
      ...
      localObject3 = ((oidb_cmd0x80a.AttributeList)localObject2).att_value;
      if ((paramInt >= 0) && (paramInt + 1 <= obz.jdField_a_of_type_Int))
      {
        localObject1 = "1";
        ((PBStringField)localObject3).set((String)localObject1);
        localArrayList.add(localObject2);
        boolean bool = SettingCloneUtil.readValue(BaseApplicationImpl.getContext(), obz.a(), "", "qqsetting_notify_showcontent_key", true);
        localObject2 = new oidb_cmd0x80a.AttributeList();
        ...
        ((PBStringField)localObject3).set((String)localObject1);
        localArrayList.add(localObject2);
        paramInt = bgmq.a((QQAppInterface)obz.a());
        if (paramInt != -1)
        {
          localObject1 = new oidb_cmd0x80a.AttributeList();
        ...
        localObject1 = babp.b(BaseApplicationImpl.getContext());
        if (!TextUtils.isEmpty((CharSequence)localObject1))
        {
          localObject2 = new oidb_cmd0x80a.AttributeList();
        ...
        if (obz.jdField_d_of_type_Int != 1) {
          break label2879;
        }
        paramInt = 0;
        label2684:
  ...
  public ohr a()
  {
    ohr localohr = this.jdField_a_of_type_Ohr;
    this.jdField_a_of_type_Ohr = null;
    return localohr;
  }
  ...
  public void a(String paramString, awul paramawul)
  {
    if ("2909288299".equals(paramString))
    {
      b("ClickMsg");
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      rvf.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Boolean, this.jdField_b_of_type_Long);
      if (paramBoolean)
      {
  ...
  public void b()
  {
    try
    {
      ...
      boolean bool = obz.c((QQAppInterface)localObject1);
      oidb_cmd0x80a.AttributeList localAttributeList1 = new oidb_cmd0x80a.AttributeList();
      localAttributeList1.att_id.set(1);
      ...
      for (localObject1 = "1";; localObject1 = "0")
      {
        ...
        ((oidb_cmd0x80a.AttributeList)localObject1).att_value.set(obz.jdField_d_of_type_Int + "");
        localObject2 = new ArrayList(3);
        ((List)localObject2).add(localAttributeList1);
        ((List)localObject2).add(localAttributeList2);
        ((List)localObject2).add(localObject1);
        rtr.a(1, (List)localObject2);
        if (!QLog.isColorLevel()) {
          break;
        }
