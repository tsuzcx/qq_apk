  ...
  implements php
{
  ...
  {
    return pdq.a(paramInt, paramBaseArticleInfo);
  }
  
  public void a(int paramInt1, Container paramContainer, pau parampau, int paramInt2)
  {
    ViewBase localViewBase = paramContainer.getVirtualView();
    if ((parampau != null) && ((parampau.a() instanceof AdvertisementInfo)) && (((AdvertisementInfo)parampau.a()).isHideForAnimate)) {}
    for (;;)
    {
      return;
      Object localObject1;
      ...
      if (NetworkState.isWifiConn())
      {
        ...
        if ((parampau == null) || (!(parampau.a() instanceof AdvertisementInfo)) || (!((AdvertisementInfo)parampau.a()).isShowingGuide)) {
          break label572;
        }
        localObject1 = (AdvertisementInfo)parampau.a();
        ...
        paramContainer = ((View)paramContainer.getParent()).findViewById(2131362000);
      ...
      try
      {
        ...
        ((ReadInJoyAdVideoGuide)paramContainer).setAppInfo(((AdvertisementInfo)localObject1).mAdProductType, ((AdvertisementInfo)localObject1).mAdCorporateLogo, ((AdvertisementInfo)localObject1).mAdCorporationName, (String)localObject2, oar.e((AdvertisementInfo)localObject1));
        while ((parampau != null) && (parampau.a() != null) && (AdvertisementInfo.isAdvertisementInfo(parampau.a())))
        {
          paramContainer = localViewBase.findViewBaseByName("id_view_AdDownloadView");
          if ((paramContainer != null) && ((paramContainer instanceof ocb)))
          {
            paramContainer = (ocb)paramContainer;
            paramContainer.a(paramInt1);
            paramContainer.a(parampau, true);
          }
          paramContainer = localViewBase.findViewBaseByName("id_view_Ad_CompleteGudie");
          if ((paramContainer == null) || (!(paramContainer instanceof pkl))) {
            break;
          }
          parampau = (AdvertisementInfo)parampau.a();
          if ((!parampau.isShowingGuide) || (!parampau.mShowAdButton)) {
            break label625;
          }
          paramContainer.setVisibility(0);
          return;
          ...
          if (localObject2 != null)
          {
            localObject1 = ajya.a(2131699819);
            if (bbwq.a() == 1)
            {
              localObject1 = ajya.a(2131699818);
              label469:
          ...
          label566:
          for (localObject1 = parampau.a();; localObject1 = null)
          {
            omr.a(localViewBase, (BaseArticleInfo)localObject1);
            break;
            if (parampau == null) {
              break label636;
            }
            ...
            localObject1 = qoi.b(l) + ajya.a(2131699820);
            break label469;
          }
          label572:
          paramContainer = ((View)paramContainer.getParent()).findViewById(2131362000);
