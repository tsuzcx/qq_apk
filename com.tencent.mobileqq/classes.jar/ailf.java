  ...
  implements ailn
{
  ...
  public ailf(QQAppInterface paramQQAppInterface, aimj paramaimj, Activity paramActivity, SessionInfo paramSessionInfo, afwy paramafwy)
  {
  ...
  {
    paramVarArgs = bbzh.a(-1016);
    long l = bbyp.a();
    String str = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
    paramVarArgs.init(str, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, str, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131691598), l, -1017, 3000, l);
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
      ...
      do
      {
        ...
        for (;;)
        {
          try
          {
            ...
            localObject1 = arcd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
            if (((arcd)localObject1).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, 2))
            {
              if (!QLog.isColorLevel()) {
                break;
              }
            ...
            localList = this.jdField_a_of_type_Afwy.a();
            if (localList == null)
            {
              if (!QLog.isColorLevel()) {
                break;
            ...
            if (!bgnt.h(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication()))
            {
              if (!QLog.isColorLevel()) {
                break;
              }
            ...
            paramInt = mue.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int);
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if ((paramInt >= 5) && (i >= 2))
        {
          if (!this.jdField_a_of_type_Aimj.a(this, new Object[0])) {
            break label1201;
          }
          ((arcd)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, 2);
        ...
        for (;;)
        {
          try
          {
            bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8003F01", "0X8003F01", 0, 0, "", "", "", "");
