...
public class awbb
{
  ...
  private boolean d(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    //   34: invokespecial 304	awbb:a	(Ljava/lang/String;)J
  ...
  private boolean i(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    for (;;)
    {
      ...
      for (int i = 1;; i = 2)
      {
        ...
        return true;
        localObject2 = awbk.a((String)localObject2);
        break;
      }
    }
  }
  ...
  private boolean l(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    ardv.a("Video", "Send video message :selfUin = " + localSvcRequestSendVideoMsg.lUin + " toUin = " + localSvcRequestSendVideoMsg.lPeerUin + " buffer[2] = " + paramToServiceMsg);
    return true;
  }
  ...
  private boolean m(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    case 1: 
      for (;;)
      {
        ...
        if (paramToServiceMsg != null)
        {
          ...
          bakz.a(localReqOffFilePack.vBody, 2, (short)0);
          bakz.a(localReqOffFilePack.vBody, 4, (short)0);
          bakz.a(localReqOffFilePack.vBody, 6, (short)1);
          bakz.a(localReqOffFilePack.vBody, 8, (short)j);
          bakz.a(localReqOffFilePack.vBody, 10, paramToServiceMsg, j);
          continue;
          localReqOffFilePack.vBody = new byte[13];
          localReqOffFilePack.vBody[0] = 6;
          bakz.a(localReqOffFilePack.vBody, 1, l);
          bakz.a(localReqOffFilePack.vBody, 5, 0L);
          bakz.a(localReqOffFilePack.vBody, 9, 0L);
        }
      }
    case 2: 
    ...
    for (k = 8 + j;; k = 8)
    {
      ...
      bakz.a(localReqOffFilePack.vBody, 2, l);
      bakz.a(localReqOffFilePack.vBody, 6, (short)j);
      bakz.a(localReqOffFilePack.vBody, 8, paramToServiceMsg, j);
      break;
  ...
  private boolean r(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    paramToServiceMsg.iMsgId = awuc.b(str);
    paramToServiceMsg.type = 1;
    paramToServiceMsg.iSendTime = 0;
    paramToServiceMsg.shPackNum = awuc.b(str);
    paramToServiceMsg.shFlowLayer = awuc.a(str);
    ...
    ((StreamData)localObject1).vData = awuc.a(str, localShort.shortValue());
    boolean bool = awuc.b(str);
    if (bool)
    {
      paramToServiceMsg.shPackNum = 0;
  ...
  private boolean s(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    paramToServiceMsg.iMsgId = awuc.b(str1);
    paramToServiceMsg.type = 1;
    paramToServiceMsg.iSendTime = 0;
    paramToServiceMsg.shPackNum = 0;
    paramToServiceMsg.shFlowLayer = awuc.a(str1);
    if (QLog.isColorLevel()) {
  ...
  public byte[] a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, byte[] paramArrayOfByte4, long paramLong)
  {
    ...
    if (paramArrayOfByte1 == null)
    {
      ...
      arrayOfByte[0] = 1;
      bakz.a(arrayOfByte, 1, 0L);
      if (paramArrayOfByte1 == null) {
        break label388;
      }
      bakz.a(arrayOfByte, 5, (short)paramArrayOfByte1.length);
      bakz.a(arrayOfByte, 7, paramArrayOfByte1, paramArrayOfByte1.length);
      i = paramArrayOfByte1.length + 7;
      label112:
      if (paramArrayOfByte1 == null) {
        break label402;
      }
      bakz.a(arrayOfByte, i, (short)paramArrayOfByte1.length);
      i += 2;
      bakz.a(arrayOfByte, i, paramArrayOfByte1, paramArrayOfByte1.length);
      i += paramArrayOfByte1.length;
      label149:
      bakz.a(arrayOfByte, i, (short)0);
      i += 2;
      bakz.a(arrayOfByte, i, paramLong);
      i += 4;
      if (paramArrayOfByte3 == null) {
        break label419;
      }
      bakz.a(arrayOfByte, i, (short)paramArrayOfByte3.length);
      i += 2;
      bakz.a(arrayOfByte, i, paramArrayOfByte3, paramArrayOfByte3.length);
      ...
      i += 1;
      bakz.a(arrayOfByte, i, paramArrayOfByte4, paramArrayOfByte4.length);
    ...
    for (;;)
    {
      ...
      bakz.a(arrayOfByte, i, (short)paramArrayOfByte2.length);
      i += 2;
      bakz.a(arrayOfByte, i, paramArrayOfByte2, paramArrayOfByte2.length);
