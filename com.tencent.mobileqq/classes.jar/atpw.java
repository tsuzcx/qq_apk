...
public class atpw
{
  ...
  public static int a(QQAppInterface paramQQAppInterface, atlh paramatlh)
  {
    if (paramatlh == null) {}
    do
    {
      ...
      {
        return 0;
        paramQQAppInterface = atln.a(paramQQAppInterface).a(paramatlh);
  ...
  public static void a()
  {
    ...
    {
      jdField_a_of_type_Int = bdiv.H(localBaseApplicationImpl);
      c = bdiv.e(localBaseApplicationImpl);
      if (QLog.isColorLevel()) {
    ...
    bdiv.a(localBaseApplicationImpl, false, 0);
  }
  ...
  public static void b()
  {
    ...
    boolean bool = atln.a((QQAppInterface)localAppRuntime).a.a();
  ...
  public static void c()
  {
    if ((jdField_a_of_type_Boolean) && (jdField_a_of_type_Int != 0))
    {
      ...
      if ((localObject instanceof QQAppInterface))
      {
        ...
        azmz.a(BaseApplication.getContext()).a(localQQAppInterface.getCurrentAccountUin(), "actLocationBgReportSampling", true, jdField_a_of_type_Int, 0L, localHashMap, "");
        if (QLog.isColorLevel()) {
  ...
  public static void e()
  {
    ...
    azmj.b(null, "CliOper", "", "", "0X800A976", "0X800A976", 0, 0, String.valueOf(l), "0", "0", "");
  }
