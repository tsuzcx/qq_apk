...
public class amwj
{
  ...
  public amwj(QQAppInterface paramQQAppInterface, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, QQMessageFacade.Message paramMessage)
  {
    ...
    boolean bool1 = bfrf.a(localBaseApplication.getApplicationContext(), paramQQAppInterface);
    boolean bool2 = FriendsStatusUtil.a(paramMessage.frienduin, paramQQAppInterface);
    boolean bool3 = afqy.a(paramMessage.frienduin, paramMessage.istroop, paramQQAppInterface);
    boolean bool4 = avre.a(paramQQAppInterface).a(paramMessage);
    boolean bool5 = bfrf.b(localBaseApplication.getApplicationContext(), paramQQAppInterface);
    if (QLog.isColorLevel()) {
  ...
  private boolean b(QQMessageFacade paramQQMessageFacade, QQMessageFacade.Message paramMessage)
  {
    if ((1008 == paramMessage.istroop) && ("2747277822".equals(paramMessage.frienduin)))
    {
      ...
      ((VasExtensionHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(71)).a(1, paramQQMessageFacade.getMessages("2747277822", 1008, this.jdField_a_of_type_Int));
    }
  ...
  {
    return QCircleChatUtil.isQCircleChatMessage(paramMessage);
  }
  ...
  {
    return (1008 == paramMessage.istroop) && (paramMessage.senderuin != null) && (uda.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessage.senderuin, paramMessage.istroop));
  }
  
  private boolean n(QQMessageFacade.Message paramMessage)
  {
    return abwz.c(paramMessage.senderuin);
  }
  ...
  {
    if ((auyo.b(paramMessage)) && (auyo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessage))) {
      if (QLog.isColorLevel()) {
    ...
    {
      return true;
      if ((!auyo.a(paramMessage)) || (!auyo.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessage))) {
        break;
      }
  ...
  private boolean s(QQMessageFacade.Message paramMessage)
  {
    ...
    {
      return true;
      if ((7220 != paramMessage.istroop) || (!AppConstants.KANDIAN_MERGE_UIN.equals(paramMessage.frienduin)) || (pay.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessage))) {
        break;
      }
    } while (!QLog.isColorLevel());
  ...
  {
    amru localamru = amru.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    boolean bool2 = ((KeyguardManager)BaseApplicationImpl.context.getSystemService("keyguard")).inKeyguardRestrictedInputMode();
    boolean bool3 = axia.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    if ((bool3) || (bool2)) {}
      ...
      if (localamru != null)
      {
        ...
        if (h(paramMessage))
        {
          ...
          if (!bool1)
          {
            ...
            localIntent = localamru.b(paramMessage.istroop, paramMessage.frienduin, paramIntent, 28);
            axvz.a("0X800AFCD", localamru.a(paramMessage.istroop));
          }
        }
      }
      if (QLog.isColorLevel()) {
        QLog.d("[NotificationRebuild] MessageNotifiableChecker", 2, new Object[] { "getMiniAioIntentIfNeed: invoked. ", " appBackgroundOrLocked: ", Boolean.valueOf(bool1), " isScreenLocked: ", Boolean.valueOf(bool2), " app.isBackgroundStop: ", Boolean.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackgroundStop), " isAppBackground: ", Boolean.valueOf(bool3), " foregroundNotifyManager: ", localamru });
      }
      return localIntent;
    }
  }
  ...
  public boolean a(QQMessageFacade.Message paramMessage)
  {
    ...
    label164:
    boolean bool3;
    if ((AppConstants.KANDIAN_LOCKSCREEN_INTERACT_MSG_UIN.equals(paramMessage.frienduin)) && (pay.v()))
    {
      i = 1;
  ...
  boolean a(boolean paramBoolean, QQMessageFacade.Message paramMessage)
  {
    ...
    {
      int i = ((akhg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(315)).a(paramMessage);
      if (QLog.isColorLevel()) {
  ...
  {
    if ((FriendsStatusUtil.a(paramMessage.frienduin, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) || (afqy.a(paramMessage.frienduin, paramMessage.istroop, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))) {}
    do
    {
      return true;
  ...
  public boolean d(QQMessageFacade.Message paramMessage)
  {
    if (paramMessage.istroop == 9002) {
      ...
      {
        aneo localaneo = (aneo)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(85);
        if (!localaneo.a(paramMessage.msgData)) {
          return true;
        }
        if (localaneo.b(paramMessage.msgData)) {
  ...
  {
    amru localamru = amru.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    return (localamru != null) && (localamru.a(paramMessage));
  }
  ...
  boolean j(QQMessageFacade.Message paramMessage)
  {
    ...
    {
      bool1 = bool2;
      if (localamru.a(paramMessage.istroop))
      {
        bool1 = bool2;
        if (localamru.a(paramMessage.frienduin))
        {
          bool1 = bool2;
          if (!localamru.a())
          {
