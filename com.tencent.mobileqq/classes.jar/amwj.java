...
public class amwj
{
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if ((!TextUtils.isEmpty(str)) && (!TextUtils.isEmpty((CharSequence)localObject)))
    {
      ...
      localReqBody.version.set("8.2.6");
    ...
    mmj.a(paramQQAppInterface, new amwk(), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, amwl paramamwl)
  {
    oidb_0x877.ReqBody localReqBody = new oidb_0x877.ReqBody();
    localReqBody.uint32_refer.set(paramInt);
    mmj.a(paramQQAppInterface, paramamwl, localReqBody.toByteArray(), "OidbSvc.0x877_0", 2167, 0);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, amwm paramamwm)
  {
    mmj.a(paramQQAppInterface, paramamwm, new oidb_0x876.ReqBody().toByteArray(), "OidbSvc.0x876_" + paramInt, 2166, paramInt);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, List<Long> paramList, Bundle paramBundle, amwn paramamwn)
  {
    ...
    mmj.a(paramQQAppInterface, paramamwn, localReqBatchGetAnchorStatus.toByteArray(), "NearbyNowTips.batch_get_anchor_stats", paramList);
  }
}
