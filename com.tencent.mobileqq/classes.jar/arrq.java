...
public class arrq
  extends amwy
{
  public arrq(Face2FaceAddFriendActivity paramFace2FaceAddFriendActivity) {}
  ...
  public void a(artf paramartf)
  {
    ...
    else if ((this.a.jdField_b_of_type_Int == 0) && (paramartf != null) && (!this.a.jdField_b_of_type_JavaUtilList.contains(paramartf)))
    {
      this.a.jdField_b_of_type_JavaUtilList.add(paramartf);
      if (this.a.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() != this.a.jdField_d_of_type_JavaUtilList.size()) {
        break label162;
      }
      Face2FaceAddFriendActivity.a(this.a, paramartf);
    }
    for (;;)
    {
      paramartf = this.a;
      ...
      ((Message)localObject).obj = paramartf;
  ...
  public void a(artj paramartj)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        if ((this.a.jdField_f_of_type_Long == 0L) || (l2 >= 1000L) || (paramartj.a != 0L)) {
          break label269;
        }
        localObject = Message.obtain();
        ((Message)localObject).what = 16;
        ((Message)localObject).obj = paramartj;
        l3 = 1000L - l2;
    ...
    } while ((this.a.jdField_b_of_type_Int != 1) || (this.a.jdField_a_of_type_JavaUtilList.contains(paramartj)));
    label269:
    this.a.jdField_a_of_type_JavaUtilList.add(paramartj);
    if ((this.a.l) && (this.a.jdField_a_of_type_Artg != null))
    {
      this.a.jdField_a_of_type_AndroidWidgetTextView.setText(String.valueOf(this.a.jdField_a_of_type_JavaUtilList.size()));
      this.a.jdField_a_of_type_Artg.a(paramartj);
      return;
    }
    Face2FaceAddFriendActivity.a(this.a, paramartj);
    this.a.e();
  }
  ...
  public void a(nearfield_group.BusiRespHead paramBusiRespHead, String paramString)
  {
    ...
    if (i == 0)
    {
      Iterator localIterator = this.a.jdField_a_of_type_Arsq.jdField_a_of_type_JavaUtilList.iterator();
      while (localIterator.hasNext())
      {
        ...
        if ((paramBusiRespHead != null) && (paramBusiRespHead.a() == 2) && (paramString.equals(paramBusiRespHead.b())))
        {
          ...
          if (!(paramBusiRespHead instanceof artf)) {
            break label477;
          }
        }
      }
    ...
    label477:
    for (paramBusiRespHead = paramBusiRespHead.e + "_" + ((artf)paramBusiRespHead).jdField_b_of_type_JavaLangString;; paramBusiRespHead = paramString)
    {
      this.a.jdField_a_of_type_Arsq.a(paramBusiRespHead);
      ...
      break;
      bcef.b(null, "P_CliOper", "Grp_set", "", "Radar_grp_guest", "suc_join", 0, 0, paramString, "8.4.8", "", this.a.app.getCurrentAccountUin());
      this.a.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceTroopDetailView.a(i, str, paramString, this.a.isFinishing());
      return;
    }
  }
  
  public void a(nearfield_group.BusiRespHead paramBusiRespHead, List<artf> paramList)
  {
    boolean bool2 = false;
    int i;
    boolean bool1;
    if (paramList == null)
    {
      ...
      if (this.a.jdField_b_of_type_Int == 1) {
        bfur.a(this.a, 230, this.a.getString(2131718947), amtj.a(2131703418), 2131690620, 2131691941, new arrr(this), null).show();
      }
    }
    label179:
    label185:
    do
    {
      ...
      for (;;)
      {
        ...
        {
          paramList = (arti)paramBusiRespHead.next();
    ...
    label421:
    bfur.a(this.a, 230, this.a.getString(2131718947), amtj.a(2131703411), 2131690620, 2131691941, new arrs(this), null).show();
  }
}
