...
public class nfe
{
  ...
  public static int a(QQAppInterface paramQQAppInterface, boolean paramBoolean1, byte[] paramArrayOfByte, boolean paramBoolean2)
  {
      ...
      try
      {
        ...
        if (((account_detail_dynamic_list.AccountDetailDynamicListResponse)localObject).ret_info.has())
        {
          ...
          if (((account_detail_dynamic_list.AccountDetailDynamicListResponse)localObject).ret_info.ret_code.get() == 0)
          {
            ...
            localArrayList = nfd.a(paramQQAppInterface).a(l1);
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          i = nfd.a(paramQQAppInterface).a(paramArrayOfByte, paramBoolean1, l1, l2, l3, localArrayList, paramBoolean2);
          break;
        }
        i = 5;
        break;
  ...
  private static void a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, int paramInt, akdn paramakdn)
  {
    if (QLog.isColorLevel()) {
      QLog.d("AccountDetailDynamicListModel", 2, "getAccountDetailDynamicList last_msg_id:" + paramLong2 + "  msg_cnt:" + paramInt + "  mLastMSgID: " + a);
    }
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApp(), nor.class);
    ...
    ((account_detail_dynamic_list.AccountDetailDynamicListRequest)localObject).versionInfo.set("8.3.0,3,4480");
    ...
    if (paramLong2 == 0L)
    {
      ...
      localObject = ((akdh)localObject).a(String.valueOf(paramLong1));
      if (localObject == null) {
        break label350;
      }
      ...
      paramInt = 1;
      i = nol.a(paramQQAppInterface, String.valueOf(paramLong1), (AccountDetail)localObject);
    }
    for (;;)
    {
      ...
      {
        nol.a(null, str1, "0X80077FF", "0X80077FF", 0, 0, "1", str2, (String)localObject, String.valueOf(i), false);
        localNewIntent.setObserver(new nff(paramQQAppInterface, bool, paramakdn));
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, akdn paramakdn)
  {
    nfd.a(paramQQAppInterface).a(paramQQAppInterface, paramLong, paramakdn);
    a(paramQQAppInterface, paramLong, 0L, 25, paramakdn);
  }
  
  public static void b(QQAppInterface paramQQAppInterface, long paramLong, akdn paramakdn)
  {
    net localnet = nfd.a(paramQQAppInterface).a(paramLong);
    if ((localnet != null) && (localnet.b > 0L))
    {
      if (a != localnet.b) {
        a(paramQQAppInterface, paramLong, localnet.b, 25, paramakdn);
      }
      return;
    }
    a(paramQQAppInterface, paramLong, paramakdn);
  }
}
