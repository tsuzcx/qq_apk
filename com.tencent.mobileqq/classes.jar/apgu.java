  ...
  extends apih
{
  ...
  private apgv jdField_a_of_type_Apgv = new apgv(this, null);
  private apgx jdField_a_of_type_Apgx = new apgx(this, null);
  private aphf jdField_a_of_type_Aphf = new aphf(this, null);
  private aphh jdField_a_of_type_Aphh = new aphh(this, null);
  public aphx a;
  private HashMap<String, apgw> jdField_a_of_type_JavaUtilHashMap = new ArkAppDeviceModule.1(this);
  
  public apgu(ark.Application paramApplication, long paramLong)
  {
    super(paramApplication, paramLong);
    this.jdField_a_of_type_Aphx = new aphx(this.jdField_a_of_type_JavaLangString);
  }
  ...
  {
    if (this.jdField_a_of_type_Aphx != null) {
      this.jdField_a_of_type_Aphx.a();
    }
  ...
  public boolean Invoke(String paramString, ark.VariantWrapper[] paramArrayOfVariantWrapper, ark.VariantWrapper paramVariantWrapper)
  {
    ...
    {
      apgw localapgw = (apgw)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
      if (localapgw != null) {
        return localapgw.a(paramString, paramArrayOfVariantWrapper, paramVariantWrapper);
      }
    }
    return false;
  }
