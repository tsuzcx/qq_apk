...
{
  public nik(MsgTabPlayMode.StoryVideoPublishStatusReceiver paramStoryVideoPublishStatusReceiver, MsgTabPlayMode paramMsgTabPlayMode, StoryVideoItem paramStoryVideoItem) {}
  ...
  public void a(ArrayList paramArrayList)
  {
    ...
    if (!paramArrayList.isEmpty()) {
      this.jdField_a_of_type_ComTencentBizQqstoryPlaymodeChildMsgTabPlayMode.a.post(new nil(this, paramArrayList));
    }
  }
}
