  ...
  implements TextWatcher
{
  ...
  public axxp(RichStatusEditText paramRichStatusEditText) {}
  ...
  public void onTextChanged(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    do
    {
      ...
      bejo localbejo = RichStatusEditText.a(this.jdField_a_of_type_ComTencentMobileqqRichstatusRichStatusEditText, paramInt1 + paramInt3, true, false);
      if ((localbejo != null) && (RichStatusEditText.a(this.jdField_a_of_type_ComTencentMobileqqRichstatusRichStatusEditText) != null) && (!RichStatusEditText.a(this.jdField_a_of_type_ComTencentMobileqqRichstatusRichStatusEditText).a(localbejo)))
      {
        this.jdField_a_of_type_JavaLangString = "";
        this.jdField_b_of_type_Boolean = true;
        return;
