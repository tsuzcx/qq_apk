...
public class xll
{
  ...
  public xll(AppInterface paramAppInterface)
  {
    ...
    if (paramAppInterface != null) {
      this.jdField_a_of_type_Aukn = paramAppInterface.createEntityManager();
    }
  }
  ...
  private JSONObject a(String paramString)
  {
    ...
    //   1: astore_2
    //   2: aload_1
    //   3: invokestatic 73	mzk:a	(Ljava/lang/String;)Ljava/lang/String;
    //   6: astore_3
    //   7: aload_3
    ...
    //   49: aload_0
    //   50: aload_1
    //   51: invokevirtual 102	xll:c	(Ljava/lang/String;)V
    //   54: aconst_null
    //   55: areturn
    //   56: getstatic 107	mze:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   59: ifnull +42 -> 101
    //   62: getstatic 107	mze:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   65: aload_1
    //   66: invokevirtual 113	java/util/concurrent/ConcurrentHashMap:containsKey	(Ljava/lang/Object;)Z
    //   69: ifeq +32 -> 101
    //   72: getstatic 107	mze:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   75: aload_1
    ...
    //   138: astore_3
    //   139: aload 4
    //   141: invokestatic 137	nas:a	(Ljava/io/BufferedInputStream;)Ljava/lang/String;
    //   144: astore_2
    //   145: aload 4
    //   147: astore_3
    //   148: getstatic 107	mze:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   151: aload_1
    //   152: aload_2
    ...
    //   281: aload_0
    //   282: aload_1
    //   283: invokevirtual 102	xll:c	(Ljava/lang/String;)V
    //   286: getstatic 107	mze:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   289: aload_1
  ...
  public static void c()
  {
    try
    {
      Object localObject = new File(BaseApplicationImpl.getApplication().getApplicationContext().getFilesDir(), bbnq.e.jdField_a_of_type_JavaLangString);
      if (((File)localObject).exists())
      {
        localObject = new JSONObject(bbdj.a((File)localObject));
  ...
  public OfflineWebRes a(String paramString)
  {
    ...
    return (OfflineWebRes)this.jdField_a_of_type_Aukn.a(OfflineWebRes.class, paramString);
  }
  ...
  public void a(OfflineWebRes paramOfflineWebRes)
  {
    ...
    do
    {
      do
      {
        ...
        {
          localObject1 = mzk.a(paramOfflineWebRes.bid);
          ...
          if (((File)localObject1).exists())
          {
            ...
            bbdj.a((File)localObject1, new File((File)localObject2, paramOfflineWebRes.hashName));
            if (QLog.isColorLevel()) {
              QLog.i("OfflineWebResManager", 2, "now copy " + paramOfflineWebRes.fileName + " into /data");
            }
            this.jdField_a_of_type_Aukn.b(paramOfflineWebRes);
            return;
          }
    ...
    if (new File((File)localObject1, paramOfflineWebRes.hashName).exists())
    {
      ...
      this.jdField_a_of_type_Aukn.a(paramOfflineWebRes);
      return;
    }
    this.jdField_a_of_type_Aukn.b(paramOfflineWebRes);
  }
  ...
  {
    Object localObject = this.jdField_a_of_type_Aukn.a(OfflineWebRes.class, false, "bid= ? and fileName= ?", new String[] { paramString2, paramString1 }, null, null, null, null);
    ...
    for (;;)
    {
      ...
      if (localFile1.exists())
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          this.jdField_a_of_type_Aukn.a(localOfflineWebRes, "bid= ? and fileName= ?", new String[] { paramString2, paramString1 });
          if (QLog.isColorLevel()) {
  ...
  public void b()
  {
    ...
    label49:
    while (!this.jdField_a_of_type_Aukn.d(OfflineWebRes.class.getSimpleName())) {
      return;
    }
    for (;;)
    {
      ...
      if ((l1 >= 4194304.0D) && (l1 < 5242880L))
      {
        ...
        localObject2 = this.jdField_a_of_type_Aukn.a(OfflineWebRes.class, (String)localObject1, null);
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          this.jdField_a_of_type_Aukn.b(localOfflineWebRes);
        }
      ...
      Object localObject2 = this.jdField_a_of_type_Aukn.a(OfflineWebRes.class, (String)localObject1, null);
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_Aukn.a(OfflineWebRes.class.getSimpleName());
        return;
      }
      i += 1;
    }
  ...
  public void b(String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        localObject1 = mze.d(paramString);
    ...
    for (;;)
    {
      for (;;)
      {
        try
        {
          ...
          localObject1 = nas.a(((MessageDigest)localObject3).digest());
        ...
        try
        {
          ...
          QLog.i("OfflineWebResManager", 2, "add or update url " + mze.d(paramString) + ", cost: " + (System.currentTimeMillis() - l));
          return;
        }
  ...
  {
    Object localObject = this.jdField_a_of_type_Aukn.a(OfflineWebRes.class, false, "bid=?", new String[] { paramString }, null, null, null, null);
    if ((localObject == null) || (((List)localObject).size() == 0)) {}
    for (;;)
    {
      return;
      ...
      if (localFile1.exists())
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          this.jdField_a_of_type_Aukn.a(localOfflineWebRes, "bid=?", new String[] { paramString });
          if (QLog.isColorLevel()) {
