...
public class mua
{
  static mua jdField_a_of_type_Mua;
  ...
  mui jdField_a_of_type_Mui = null;
  boolean jdField_a_of_type_Boolean = false;
  String jdField_b_of_type_JavaLangString = null;
  public WeakReference<Button> b;
  private boolean jdField_b_of_type_Boolean;
  public WeakReference<muj> c;
  private boolean c;
  public int d;
  private boolean d;
  ...
  public mua(Context paramContext, VideoController paramVideoController, Button paramButton)
  {
    ...
    b(paramButton);
    this.jdField_a_of_type_Mui = new mui(this);
    c();
  ...
  private Drawable a(Resources paramResources, int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean)
      {
        paramResources = mri.a(paramResources, 2130842065, false);
      }
      else
      {
        paramResources = mtz.a(paramResources, 2130842015, 2131165982);
        continue;
        if (paramBoolean)
        {
          paramResources = mri.a(paramResources, 2130842064, false);
        }
        else
        {
          paramResources = mtz.a(paramResources, 2130842014, 2131165982);
          continue;
          if (paramBoolean)
          {
            paramResources = mri.a(paramResources, 2130842013);
          }
          else
          {
            paramResources = mtz.a(paramResources, 2130842287, 2131166019);
            continue;
            if (paramBoolean)
            {
              paramResources = mri.a(paramResources, 2130842017);
            }
            else
            {
              paramResources = mtz.a(paramResources, 2130842294, 2131166019);
              continue;
              if (paramBoolean)
              {
                paramResources = mri.a(paramResources, 2130842016);
              }
              else
              {
                paramResources = mtz.a(paramResources, 2130842289, 2131166019);
                continue;
                if (paramBoolean) {
                  paramResources = mri.a(paramResources, 2130842064, false);
                } else {
                  paramResources = mtz.a(paramResources, 2130842292, 2131166019);
                }
              }
            }
          }
  ...
  public static mua a()
  {
    try
    {
      mua localmua = jdField_a_of_type_Mua;
      return localmua;
    }
    finally
    {
  ...
  public static mua a(Context paramContext, VideoController paramVideoController)
  {
    if (jdField_a_of_type_Mua == null) {}
    try
    {
      if (jdField_a_of_type_Mua == null) {
        jdField_a_of_type_Mua = new mua(paramContext, paramVideoController, null);
      }
      return jdField_a_of_type_Mua;
    }
    finally {}
  }
  ...
  private void a(String[] paramArrayOfString)
  {
    ...
    for (this.jdField_e_of_type_Boolean = Arrays.asList(paramArrayOfString).contains("DEVICE_BLUETOOTHHEADSET");; this.jdField_e_of_type_Boolean = false)
    {
      if ((this.jdField_e_of_type_Boolean != bool) && (this.jdField_e_of_type_Boolean))
      {
        ...
        bcef.b(null, "CliOper", "", "", "0X8008D1D", "0X8008D1D", 0, 0, "", "", "", "");
      }
      return;
    }
  }
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          bool1 = localSharedPreferences.getBoolean(paramVideoAppInterface.getApp().getString(2131694552), true);
          String str = paramVideoAppInterface.getCurrentAccountUin();
          if (str != null) {
            bool1 = localSharedPreferences.getBoolean(paramVideoAppInterface.getApp().getString(2131694552) + str, true);
          }
          bool2 = bool1;
        } while (bftt.a() == 0);
        bool2 = bool1;
      ...
      bool2 = bool1;
    } while (msm.d(paramVideoAppInterface.getApp()));
    return true;
  }
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            do
            {
              ...
              if (paramVideoAppInterface.getCurrentAccountUin() != null)
              {
                ...
                bool1 = bool2;
                if (str != null) {
                  bool1 = localSharedPreferences.getBoolean(paramVideoAppInterface.getApp().getString(2131694551) + str, true);
                }
              }
              bool2 = bool1;
            } while (bftt.a() == 0);
          ...
          bool2 = bool1;
        } while (msm.a(paramVideoAppInterface.getApp()));
        bool2 = bool1;
      } while (msm.c(paramVideoAppInterface.getApp()));
      bool2 = bool1;
    } while (msm.d(paramVideoAppInterface.getApp()));
    return true;
  }
  ...
  public int a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentSharpJniTraeAudioSession == null) {
      this.jdField_a_of_type_ComTencentSharpJniTraeAudioSession = new TraeAudioSession((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), this.jdField_a_of_type_Mui);
    }
  ...
  public void a(int paramInt)
  {
    ...
    {
      long l = AudioHelper.b();
      QLog.w("TraeSessionHelper", 1, "pressHandFreeBtn, isSpeakerOn[" + ((lez)localObject2).P + "], seq[" + l + "]", (Throwable)localObject1);
      Object localObject3 = ((lez)localObject2).a;
      ...
      if (localObject3 != null) {
        if ((this.jdField_e_of_type_Boolean) && (msu.a()))
        {
          if (this.jdField_b_of_type_JavaLangRefWeakReference == null) {
            break label717;
          }
      ...
      for (;;)
      {
        ...
        localObject3 = new mug((String[])localObject3);
        if (!TextUtils.isEmpty(((lez)localObject2).r)) {
          ((mug)localObject3).a(((lez)localObject2).r);
        }
        localObject2 = (bjnw)bjon.a((Context)localObject1, null);
        ((bjnw)localObject2).a(2131695147);
        ListView localListView = new ListView((Context)localObject1);
        if (this.jdField_a_of_type_Mue == null) {
          this.jdField_a_of_type_Mue = new mue((Context)localObject1, (mug)localObject3);
        }
        for (;;)
        {
          localListView.setAdapter(this.jdField_a_of_type_Mue);
          ...
          localListView.setOnItemClickListener(new mub(this, localButton, l, (bjnw)localObject2));
          ((bjnw)localObject2).a(localListView);
          ((bjnw)localObject2).c(2131690620);
          ((bjnw)localObject2).a(new muc(this));
          ((bjnw)localObject2).setOnShowListener(new mud(this));
          ((bjnw)localObject2).show();
          return;
          this.jdField_a_of_type_Mue.a((Context)localObject1, (mug)localObject3);
        }
        int k;
        if (((lez)localObject2).P)
        {
          int i = 0;
          do
          {
  ...
  public void a(long paramLong, lez paramlez)
  {
    if (paramlez == null) {
      if (QLog.isColorLevel()) {
    ...
    if (QLog.isColorLevel()) {
      QLog.w("TraeSessionHelper", 1, "switchButton_handFree, isSpeakerOn[" + paramlez.P + "], seq[" + paramLong + "]");
    }
  ...
  public boolean a(long paramLong, VideoAppInterface paramVideoAppInterface, int paramInt1, int paramInt2, MediaPlayer.OnCompletionListener paramOnCompletionListener)
  {
    if ((b(paramVideoAppInterface)) && (a(paramVideoAppInterface.getApp().getApplicationContext())))
    {
      ...
      for (;;)
      {
        ...
        bftt.a(paramInt1, paramInt2, paramOnCompletionListener);
      }
    }
    return false;
  }
