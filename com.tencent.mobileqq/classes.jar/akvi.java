  ...
  implements Handler.Callback, View.OnClickListener
{
  ...
  public WeakReference<akux> a;
  private boolean jdField_a_of_type_Boolean;
  private int jdField_b_of_type_Int = -1;
  WeakReference<Context> jdField_b_of_type_JavaLangRefWeakReference;
  
  public akvi(Activity paramActivity, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    this.jdField_a_of_type_Akvh = new akvh((Context)this.jdField_b_of_type_JavaLangRefWeakReference.get(), this);
    ...
    if (alee.jdField_a_of_type_Int > 0)
    {
      jdField_a_of_type_Int = alee.jdField_a_of_type_Int * 1000;
  ...
  private BaseChatPie a()
  {
    ...
    if (localObject2 != null)
    {
      ...
      {
        localObject2 = (akji)((AppInterface)localObject2).getManager(153);
        localObject1 = localChatFragment;
        if (localObject2 != null)
        {
          localObject2 = ((akji)localObject2).a();
          localObject1 = localChatFragment;
          if (localObject2 != null) {
  ...
  private void g()
  {
    ...
    if ((localBaseChatPie != null) && (this.jdField_a_of_type_Akvh != null) && (localBaseChatPie.a().a() == this.jdField_a_of_type_Akvh) && (this.jdField_a_of_type_Akvh.jdField_a_of_type_AndroidWidgetRelativeLayout.isShown()))
    {
      this.jdField_a_of_type_Akvh.a();
      this.jdField_a_of_type_Bhow.removeMessages(20);
      this.jdField_a_of_type_Bhow.sendEmptyMessageDelayed(20, 1000L);
    }
  }
  ...
  public void a(akux paramakux)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramakux);
  }
  
  public void a(Activity paramActivity)
  {
    this.jdField_a_of_type_Akvh = new akvh(paramActivity, this);
  }
  ...
  public void b()
  {
    ...
    if (localObject != null)
    {
      ...
      if ((localObject != null) && (((agwa)localObject).a() == this.jdField_a_of_type_Akvh))
      {
        ((agwa)localObject).a();
        if (QLog.isColorLevel()) {
  ...
  public void c()
  {
    ...
    for (localObject1 = null;; localObject1 = this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.game.name)
    {
      ...
      if (TextUtils.isEmpty((CharSequence)localObject1)) {
        localObject2 = alpo.a(2131702511);
      }
      localMessage.obj = (alpo.a(2131702507) + (String)localObject2);
  ...
  public void d()
  {
    ...
    if (this.jdField_a_of_type_Akvh != null)
    {
      ...
      this.jdField_a_of_type_Akvh.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_JavaLangString);
      this.jdField_a_of_type_Akvh.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
      this.jdField_a_of_type_Akvh.c.setVisibility(8);
    }
    label251:
    while (this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam == null)
    {
      ...
      if (this.jdField_a_of_type_Akvh != null)
      {
        if ((this.jdField_a_of_type_Akvh.jdField_a_of_type_AndroidWidgetRelativeLayout.getParent() instanceof ViewGroup)) {
          ((ViewGroup)this.jdField_a_of_type_Akvh.jdField_a_of_type_AndroidWidgetRelativeLayout.getParent()).removeView(this.jdField_a_of_type_Akvh.jdField_a_of_type_AndroidWidgetRelativeLayout);
        }
        ((agwa)localObject1).a(this.jdField_a_of_type_Akvh, new Object[0]);
      }
      if (!QLog.isColorLevel()) {
        break;
      }
    ...
    for (Object localObject1 = null;; localObject1 = this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.game.name)
    {
      Object localObject2 = localObject1;
      if (TextUtils.isEmpty((CharSequence)localObject1)) {
        localObject2 = alpo.a(2131702510);
      }
      localObject1 = alpo.a(2131702512) + (String)localObject2;
      this.jdField_a_of_type_Akvh.jdField_a_of_type_AndroidWidgetTextView.setText((CharSequence)localObject1);
      this.jdField_a_of_type_Akvh.jdField_b_of_type_AndroidWidgetTextView.setText((CharSequence)localObject1);
      break;
    }
  }
  ...
  public void e()
  {
    this.jdField_a_of_type_Bhow.removeMessages(25);
  ...
  {
    this.jdField_a_of_type_Bhow.removeMessages(25);
    this.jdField_a_of_type_Bhow.sendEmptyMessageDelayed(25, jdField_a_of_type_Int);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            do
            {
                ...
                do
                {
                  do
                  {
                    do
                    {
                      ...
                      paramMessage.ar();
                      return false;
                      if ((this.jdField_a_of_type_Akvh != null) && ((paramMessage.obj instanceof String)))
                      {
                    ...
                    if (paramMessage != null)
                    {
                      ...
                      if ((localObject3 != null) && (this.jdField_a_of_type_Akvh != null))
                      {
                        if ((this.jdField_a_of_type_Akvh.jdField_a_of_type_AndroidWidgetRelativeLayout.getParent() instanceof ViewGroup)) {
                          ((ViewGroup)this.jdField_a_of_type_Akvh.jdField_a_of_type_AndroidWidgetRelativeLayout.getParent()).removeView(this.jdField_a_of_type_Akvh.jdField_a_of_type_AndroidWidgetRelativeLayout);
                        }
                        if (this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null)
                        {
                          ...
                          if (TextUtils.isEmpty(paramMessage)) {
                            localObject1 = alpo.a(2131702513);
                          }
                          paramMessage = alpo.a(2131702508) + (String)localObject1;
                          this.jdField_a_of_type_Akvh.jdField_a_of_type_AndroidWidgetTextView.setText(paramMessage);
                          this.jdField_a_of_type_Akvh.jdField_b_of_type_AndroidWidgetTextView.setText(paramMessage);
                        }
                        this.jdField_a_of_type_Akvh.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
                        this.jdField_a_of_type_Akvh.c.setVisibility(8);
                        ((agwa)localObject3).a(this.jdField_a_of_type_Akvh, new Object[0]);
                        if (QLog.isColorLevel()) {
                          QLog.d("cmgame_process.CmGameUIManager", 2, "showGameTips");
                        }
                      }
                    }
                    Object localObject3 = akro.a();
                    MqqHandler localMqqHandler;
                    Message localMessage;
                    ...
                    for (paramMessage = (Message)localObject2;; paramMessage = this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.game.name)
                    {
                      localObject1 = paramMessage;
                      if (TextUtils.isEmpty(paramMessage)) {
                        localObject1 = alpo.a(2131702504);
                      }
                      localMessage.obj = (alpo.a(2131702506) + (String)localObject1);
                      localMqqHandler.sendMessage(localMessage);
                      ...
                      {
                        paramMessage = (akux)this.jdField_a_of_type_JavaLangRefWeakReference.get();
                        if (paramMessage != null) {
                          paramMessage.a();
                        }
                      }
                    ...
                    for (paramMessage = "";; paramMessage = this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.game.name)
                    {
                      ...
                      akre.a(this.jdField_b_of_type_Int);
                    ...
                    if (localObject2 != null)
                    {
                      ...
                      if (localObject2 != null)
                      {
                        if ((this.jdField_a_of_type_Akvh == null) || (this.jdField_a_of_type_Akvh != ((agwa)localObject2).a())) {
                          break label964;
                        }
                        ((agwa)localObject2).a();
                        if (QLog.isColorLevel()) {
                    ...
                    for (;;)
                    {
                      ...
                      {
                        localObject2 = (akux)this.jdField_a_of_type_JavaLangRefWeakReference.get();
                        if ((paramMessage.obj instanceof String)) {
                          localObject1 = (String)paramMessage.obj;
                        }
                        if (localObject2 != null) {
                          ((akux)localObject2).d((String)localObject1);
                        }
                      }
                      paramMessage = akro.a();
                      ...
                      VipUtils.a(paramMessage, "cmshow", "Apollo", "shutdown_game", 0, 0, new String[] { Integer.toString(this.jdField_b_of_type_Int), Integer.toString(akro.b()), Integer.toString(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.commFlag & 0x1) });
                      return false;
                      if (QLog.isColorLevel()) {
                    ...
                    if ((paramMessage.obj instanceof String))
                    {
                      ...
                      if (this.jdField_a_of_type_Akvh != null)
                      {
                        this.jdField_a_of_type_Akvh.c.setVisibility(8);
                        this.jdField_a_of_type_Akvh.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
                        this.jdField_a_of_type_Akvh.jdField_a_of_type_AndroidWidgetTextView.setText((String)paramMessage.obj);
                      }
                    }
                    paramMessage = akro.a();
              ...
              this.jdField_a_of_type_Bhow.sendEmptyMessageDelayed(24, 500L);
              return false;
              paramMessage = a();
            } while (paramMessage == null);
            paramMessage.ar();
        ...
        if ((!this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Akvh != null))
        {
          localObject1 = (String)paramMessage.obj;
          localObject2 = new SpannableString((String)localObject1 + alpo.a(2131702509));
          ((SpannableString)localObject2).setSpan(new ForegroundColorSpan(-16776961), 0, ((String)localObject1).length(), 17);
          this.jdField_a_of_type_Akvh.jdField_b_of_type_AndroidWidgetTextView.setText((CharSequence)localObject2);
          g();
        }
      } while (!QLog.isColorLevel());
      ...
      paramMessage = a();
    } while ((paramMessage == null) || (this.jdField_a_of_type_Akvh == null) || (paramMessage.a().a() != this.jdField_a_of_type_Akvh) || (!this.jdField_a_of_type_Akvh.jdField_a_of_type_AndroidWidgetRelativeLayout.isShown()));
    label733:
    this.jdField_a_of_type_Akvh.b();
    label964:
    return false;
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (paramView = "";; paramView = this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.game.name)
    {
      ...
      this.jdField_a_of_type_Bhow.sendEmptyMessageDelayed(18, 300L);
      return;
