...
public class akhq
  implements Runnable
{
  public akhq(ProfileCardMoreInfoView paramProfileCardMoreInfoView, Card paramCard) {}
  ...
  public void run()
  {
    ...
    new MqqHandler(Looper.getMainLooper()).post(new akhr(this, (ProfileShoppingPhotoInfo)localObject));
  }
}
