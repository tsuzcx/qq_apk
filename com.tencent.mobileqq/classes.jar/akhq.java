...
{
  public int a;
  public SparseArray<akhr> a;
  
  public akhq(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    paramObject = (ajmp)this.app.getManager(92);
    Object localObject;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((paramFromServiceMsg != null) && (paramFromServiceMsg.uint32_result.has()))
        {
          ...
          j = 0;
          if (4 <= i3) {
            l = bakz.a(paramFromServiceMsg, 0);
          }
          if (6 > i3) {
            break label868;
          }
          m = bakz.a(paramFromServiceMsg, 4);
          if (8 > i3) {
            break label862;
          }
          n = bakz.a(paramFromServiceMsg, 6);
          if (10 <= i3) {
            i = bakz.a(paramFromServiceMsg, 8);
          }
          if (12 <= i3) {
            j = bakz.a(paramFromServiceMsg, 10);
          }
          if ((i == 0) && (j == 0) && (m == 0) && (n == 0))
          {
            if (QLog.isColorLevel()) {
      ...
      while (k < i4)
      {
        ...
        if (i1 + 4 <= i3)
        {
          localObject[k] = bakz.a(paramFromServiceMsg, i1);
          i2 = i1 + 4;
        }
        k += 1;
        i1 = i2;
      ...
      if (i + 1 <= k) {
        paramToServiceMsg = bakz.a(paramFromServiceMsg, 1, i);
      }
      if (QLog.isColorLevel())
      {
    ...
    if (1000 == i)
    {
      ...
      if (paramToServiceMsg != null)
      {
        ...
        if (paramToServiceMsg.uint32_result.has())
        {
          ...
          if (j == 0)
          {
            paramToServiceMsg = (ajmp)this.app.getManager(92);
            i = j;
            if (paramToServiceMsg != null) {
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ((ajmp)this.app.getManager(92)).a(34, null);
      return;
      bool = false;
      break;
      bool = false;
  ...
  public ajmm a(int paramInt)
  {
    this.jdField_a_of_type_Int = paramInt;
    if (this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt) == null)
    {
      akhr localakhr = new akhr(this, paramInt);
      this.jdField_a_of_type_AndroidUtilSparseArray.put(paramInt, localakhr);
    }
    return (ajmm)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt);
  }
  ...
  public void a(String paramString, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    try
    {
      ...
      bakz.a(paramString, 4, paramInt1);
      bakz.a(paramString, 6, paramInt2);
      bakz.a(paramString, 8, paramInt3);
      bakz.a(paramString, 10, paramInt4);
  ...
  public void a(String paramString, Calendar paramCalendar, boolean paramBoolean, int paramInt)
  {
    ...
    paramString = (ajmp)this.app.getManager(92);
    if (paramBoolean) {}
  ...
  public void a(String paramString, Calendar paramCalendar, boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
    ...
    paramCalendar = localajmp.a((Calendar)paramCalendar.clone());
    long l1 = ((Long)paramCalendar.first).longValue();
    long l2 = ((Long)paramCalendar.second).longValue();
    this.app.a().a(paramString, l1, 0L, l2, (short)0, 0L, 1, localajmp.a(), localajmp.b(), paramBoolean1, paramInt, paramBoolean2);
  }
  ...
  public void a(short paramShort)
  {
    try
    {
      ...
      bakz.a((byte[])localObject, 7, 41813);
      bakz.a((byte[])localObject, 9, (short)2);
      bakz.a((byte[])localObject, 11, paramShort);
  ...
  {
    ajmp localajmp = (ajmp)this.app.getManager(92);
    Object localObject = localajmp.a(paramCalendar);
    if (localObject == null)
    {
      if (QLog.isColorLevel()) {
    ...
    {
      localajmp.a((Calendar)localObject);
    ...
    {
      localajmp.a((Calendar)localObject);
      paramCalendar = localajmp.a((Calendar)((Calendar)localObject).clone());
      int m = localajmp.a(paramString, ((Long)paramCalendar.first).longValue(), ((Long)paramCalendar.second).longValue());
      if (QLog.isColorLevel()) {
  ...
  public ajmm b(int paramInt)
  {
    ajmm localajmm = (ajmm)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt);
