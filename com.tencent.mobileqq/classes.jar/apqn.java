...
public class apqn
{
  ...
  private static apqp jdField_a_of_type_Apqp;
  ...
  public static void a(int paramInt, apqp paramapqp)
  {
    try
    {
      c();
      jdField_a_of_type_Apqp = paramapqp;
  ...
  {
    if (jdField_a_of_type_Apqp != null) {
      jdField_a_of_type_Apqp.a(paramInt);
    }
  }
              ...
              if (localapni != null)
              {
                ...
                for (;;)
                {
                  synchronized (jdField_a_of_type_JavaLangObject)
                  {
                    ...
                    {
                      b(1);
                      localapni.b((String)((Pair)localObject5).first, 0L, new apqo(str3, str2, str4, str1));
  ...
  private static boolean b(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    if ((!TextUtils.isEmpty(paramString1)) && (!TextUtils.isEmpty(paramString2)) && (!TextUtils.isEmpty(paramString3)) && (!TextUtils.isEmpty(paramString4))) {
      try
      {
        ...
        {
          String str = bkcx.a(paramString2);
          if ((!TextUtils.isEmpty(str)) && (str.equals(paramString3)))
          {
            bgmg.a(paramString2.getAbsolutePath(), paramString1, false);
            paramString2 = new File(paramString1 + "libarkDebuggerJSImpl.so");
            if ((paramString2 == null) || (!paramString2.exists())) {
              break label406;
            }
            if (bgmg.d(paramString1 + "libarkDebuggerJSImpl.so", paramString4 + "libarkDebuggerJSImpl.so")) {
            ...
            for (i = 0;; i = 1)
            {
              ...
              if (!bgmg.d(paramString1 + "libjsc_ark.so", paramString4 + "libjsc_ark.so")) {
                break;
              }
  ...
  {
    Object localObject1 = aqmv.b(186).a();
    ...
    {
      return;
      localObject1 = ((aqmr)localObject1).a();
      if (localObject1 == null)
      {
        ArkAppCenter.c("JSDebuggerSoLoader", String.format("updateJSDebuggerConfig, aiKeywordConfig is null", new Object[0]));
        return;
      }
      localObject1 = ((aqni)localObject1).d;
    } while (localObject1 == null);
    jdField_a_of_type_JavaUtilMap.clear();
    localObject1 = ((ArrayList)localObject1).iterator();
    while (((Iterator)localObject1).hasNext())
    {
      Object localObject2 = (aqnl)((Iterator)localObject1).next();
      if (localObject2 != null)
      {
        String str1 = ((aqnl)localObject2).jdField_a_of_type_JavaLangString;
        String str2 = ((aqnl)localObject2).b;
        localObject2 = ((aqnl)localObject2).c;
