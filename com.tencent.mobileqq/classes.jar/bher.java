...
public class bher
{
  ...
  private final Handler jdField_a_of_type_AndroidOsHandler = new bheu(this);
  private bhes jdField_a_of_type_Bhes;
  private bhet jdField_a_of_type_Bhet;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bher.class.getName();
  }
  
  public bher(Context paramContext)
  {
  ...
  public void a(bhet parambhet)
  {
    this.jdField_a_of_type_Bhet = parambhet;
  }
  
  public void a(bhev parambhev)
  {
    this.jdField_a_of_type_Bhev = parambhev;
  }
  ...
  public void c()
  {
    ...
    if (c() < 1)
    {
      this.jdField_a_of_type_AndroidOsHandler.sendMessage(a(AppLoaderFactory.g().getMiniAppEnv().getContext().getResources().getString(2131694400)));
      b();
    }
