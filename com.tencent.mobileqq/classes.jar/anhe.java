...
class anhe
  extends mya
{
  anhe(anha paramanha, long paramLong, Map paramMap, AppInterface paramAppInterface, anhg paramanhg) {}
  ...
  public void a(boolean paramBoolean, long paramLong1, long paramLong2, long paramLong3, long paramLong4)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.removeObserver(localmya);
    } while (this.jdField_a_of_type_Anhg == null);
    try
    {
      this.jdField_a_of_type_Anhg.a(paramBoolean, paramLong1, paramLong2, paramLong4);
      return;
    }
