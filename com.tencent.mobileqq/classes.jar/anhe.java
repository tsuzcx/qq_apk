...
public class anhe
  implements Handler.Callback, anhl
{
  ...
  private volatile anhc jdField_a_of_type_Anhc;
  private anhj jdField_a_of_type_Anhj = new anhj();
  ...
  private ConcurrentHashMap<String, anhf> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  static
  {
    jdField_a_of_type_JavaLangString = anvx.a(2131700025);
  }
  
  public anhe(String paramString1, String paramString2)
  {
    this.jdField_c_of_type_JavaLangString = paramString2;
    long l = jdField_a_of_type_Long;
    jdField_a_of_type_Long = 1L + l;
    this.jdField_b_of_type_JavaLangString = String.valueOf(l);
    this.jdField_d_of_type_JavaLangString = angg.a(paramString1, "apollo_task_id", String.valueOf(this.jdField_b_of_type_JavaLangString));
  ...
  public static anhe a(boolean paramBoolean, String paramString)
  {
    long l = System.currentTimeMillis();
    if (!TextUtils.isEmpty(paramString))
    {
      String str = anhg.a().a(paramString);
      if (anhg.a().a(str))
      {
        paramString = new anhe(paramString, str);
        if (QLog.isColorLevel()) {
  ...
  private void b()
  {
    ...
    {
      anhg.a().a(BaseApplicationImpl.getContext(), this.jdField_c_of_type_JavaLangString, this.jdField_e_of_type_JavaLangString, (AppInterface)localObject, this.jdField_a_of_type_Anhj);
      localObject = anhg.a().a(this.jdField_c_of_type_JavaLangString);
      if ((localObject != null) && (!((List)localObject).isEmpty()))
      {
        localObject = ((List)localObject).iterator();
        while (((Iterator)localObject).hasNext())
        {
          angy localangy = (angy)((Iterator)localObject).next();
          if (localangy.a())
          {
            anhf localanhf = new anhf(this, localangy);
            this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(localangy.jdField_a_of_type_JavaLangString, localanhf);
            localanhf.b();
          }
        }
      }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    if (3 != i)
    {
      ...
      if ((this.jdField_a_of_type_Anhc != null) && (!paramBoolean))
      {
  ...
  private void c()
  {
    ...
    this.jdField_f_of_type_JavaLangString = angg.e(this.jdField_e_of_type_JavaLangString);
    ...
    Object localObject1 = angg.d(this.jdField_f_of_type_JavaLangString);
    if (QLog.isColorLevel()) {
    ...
    localObject1 = angg.a((File)localObject2);
    this.jdField_a_of_type_Anhj.e = (System.currentTimeMillis() - l1);
    boolean bool1;
    label296:
    boolean bool2;
    if (!TextUtils.isEmpty((CharSequence)localObject1))
    {
      ...
      if (anhg.a().a(this.jdField_c_of_type_JavaLangString, (String)localObject1)) {
        break label652;
      }
      localObject1 = null;
      ...
      this.jdField_a_of_type_Anhj.a = 1;
      bool1 = false;
      label387:
      this.jdField_a_of_type_Anhj.f = (System.currentTimeMillis() - l2);
    ...
    for (;;)
    {
      ...
      break label296;
      label652:
      this.jdField_a_of_type_Anhj.a = 2;
      break label387;
      label663:
      this.jdField_a_of_type_Anhj.a = 0;
      localObject2 = localObject1;
      bool2 = bool1;
      break label451;
      label682:
  ...
  private void d()
  {
    ...
    long l1 = System.currentTimeMillis();
    this.jdField_a_of_type_Anhc = new anhc(this.jdField_e_of_type_JavaLangString, true, null, null);
    long l2 = System.currentTimeMillis();
    ...
    if (j == 0)
    {
      ...
      j = this.jdField_a_of_type_Anhc.b();
      if (QLog.isColorLevel()) {
      ...
      l2 = System.currentTimeMillis();
      localMap = this.jdField_a_of_type_Anhc.a();
      if (QLog.isColorLevel()) {
    ...
    do
    {
      for (;;)
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject))
        {
          ...
          angg.a(this.jdField_e_of_type_JavaLangString, (List)localObject);
          i = j;
        }
        if (QLog.isColorLevel()) {
  ...
  {
    int i = 2;
    Object localObject1 = this.jdField_a_of_type_Anhc.a(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean, null);
    ...
    this.jdField_a_of_type_JavaIoInputStream = new anhk(this, ((anhd)localObject1).jdField_a_of_type_JavaIoByteArrayOutputStream, ((anhd)localObject1).jdField_a_of_type_JavaIoBufferedInputStream);
    if (((anhd)localObject1).jdField_a_of_type_Boolean) {}
    for (;;)
    {
      try
      {
        localObject1 = ((anhd)localObject1).jdField_a_of_type_JavaIoByteArrayOutputStream.toString("UTF-8");
      }
      catch (Throwable localThrowable1)
      {
        try
        {
          ...
          long l = System.currentTimeMillis();
          anhg.a().b(this.jdField_e_of_type_JavaLangString, (String)localObject1);
  ...
  public anhj a()
  {
    return this.jdField_a_of_type_Anhj;
  }
  ...
  public Object a(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 345	anhe:jdField_c_of_type_Boolean	Z
    //   4: ifeq +5 -> 9
    //   7: aconst_null
    //   8: areturn
    //   9: aload_0
    //   10: getfield 286	anhe:jdField_a_of_type_ComTencentBizPubaccountCustomWebView	Lcom/tencent/biz/pubaccount/CustomWebView;
    //   13: ifnull +66 -> 79
    //   16: invokestatic 174	anhg:a	()Lanhg;
    //   19: aload_1
    //   20: invokevirtual 522	anhg:b	(Ljava/lang/String;)Z
    //   23: ifeq +56 -> 79
    ...
    //   58: invokestatic 174	anhg:a	()Lanhg;
    //   61: aload_1
    //   62: aload_0
    //   63: getfield 106	anhe:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   66: invokevirtual 527	anhg:a	(Ljava/lang/String;Ljava/lang/String;)Lcom/tencent/smtt/export/external/interfaces/WebResourceResponse;
    //   69: astore 5
    //   71: aload 5
    //   73: ifnull +6 -> 79
    //   76: aload 5
    //   78: areturn
    //   79: aload_0
    //   80: getfield 286	anhe:jdField_a_of_type_ComTencentBizPubaccountCustomWebView	Lcom/tencent/biz/pubaccount/CustomWebView;
    //   83: ifnull +139 -> 222
    //   86: aload_0
    //   87: getfield 104	anhe:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   90: invokevirtual 528	java/util/concurrent/ConcurrentHashMap:isEmpty	()Z
    //   93: ifne +129 -> 222
    //   96: aload_0
    //   97: getfield 104	anhe:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    ...
    //   127: checkcast 267	anhf
    //   130: astore 6
    //   132: aload_1
    //   133: aload 6
    //   135: invokestatic 531	anhf:a	(Lanhf;)Langy;
    //   138: getfield 271	angy:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   141: invokevirtual 534	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   144: ifeq -34 -> 110
    //   147: aload 6
    //   149: aload_1
    //   150: invokevirtual 537	anhf:a	(Ljava/lang/String;)Lcom/tencent/smtt/export/external/interfaces/WebResourceResponse;
    //   153: astore 7
    ...
    //   198: aload_0
    //   199: getfield 104	anhe:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   202: aload 6
    //   204: invokestatic 531	anhf:a	(Lanhf;)Langy;
    //   207: getfield 271	angy:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   222: aload_0
    //   223: aload_1
    //   224: invokevirtual 545	anhe:a	(Ljava/lang/String;)Z
    //   227: ifne +49 -> 276
    ...
    //   251: aload_0
    //   252: getfield 114	anhe:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   275: areturn
    //   276: aload_0
    //   277: getfield 67	anhe:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   307: aload_0
    //   308: getfield 114	anhe:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   330: aload_0
    //   331: getfield 67	anhe:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   334: iconst_0
    //   335: iconst_1
    ...
    //   363: aload_0
    //   364: getfield 114	anhe:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   407: aload_0
    //   408: getfield 114	anhe:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   433: lstore_2
    //   434: aload_0
    //   435: getfield 60	anhe:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger	Ljava/util/concurrent/atomic/AtomicInteger;
    //   438: invokevirtual 284	java/util/concurrent/atomic/AtomicInteger:get	()I
    //   441: iconst_1
    //   442: if_icmpne +357 -> 799
    //   445: aload_0
    //   446: getfield 60	anhe:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger	Ljava/util/concurrent/atomic/AtomicInteger;
    //   449: astore_1
    //   450: aload_1
    //   451: monitorenter
    //   452: aload_0
    //   453: getfield 60	anhe:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger	Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    //   484: aload_0
    //   485: getfield 114	anhe:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   503: aload_0
    //   504: getfield 60	anhe:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger	Ljava/util/concurrent/atomic/AtomicInteger;
    //   507: ldc2_w 556
    ...
    //   533: aload_0
    //   534: getfield 114	anhe:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   546: astore_1
    //   547: aload_0
    //   548: getfield 288	anhe:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   551: ifnull +298 -> 849
    //   554: iconst_1
    //   555: istore 4
    //   557: ldc 136
    ...
    //   592: aload_0
    //   593: getfield 288	anhe:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   596: ifnonnull +54 -> 650
    //   599: aload_0
    //   600: getfield 290	anhe:jdField_g_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   613: dup
    //   614: aload_0
    //   615: getfield 290	anhe:jdField_g_of_type_JavaLangString	Ljava/lang/String;
    //   618: ldc_w 503
    ...
    //   627: putfield 288	anhe:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   630: aload_0
    //   631: iconst_1
    //   632: putfield 576	anhe:jdField_d_of_type_Boolean	Z
    ...
    //   650: aload_0
    //   651: getfield 288	anhe:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   654: ifnull +236 -> 890
    //   657: aload_0
    //   658: invokespecial 436	anhe:b	()Z
    //   661: ifne +209 -> 870
    //   664: new 580	com/tencent/smtt/export/external/interfaces/WebResourceResponse
    //   667: dup
    //   668: aload_0
    //   669: getfield 128	anhe:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   672: invokestatic 581	angg:a	(Ljava/lang/String;)Ljava/lang/String;
    //   675: ldc_w 583
    //   678: aload_0
    //   679: getfield 288	anhe:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    ...
    //   685: astore_1
    //   686: aload_0
    //   687: getfield 75	anhe:jdField_e_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   690: iconst_1
    //   691: invokevirtual 308	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   694: aload_0
    //   695: getfield 576	anhe:jdField_d_of_type_Boolean	Z
    //   698: ifeq +8 -> 706
    //   701: aload_0
    //   702: iconst_0
    //   703: putfield 576	anhe:jdField_d_of_type_Boolean	Z
    ...
    //   738: aload_0
    //   739: aconst_null
    //   740: putfield 288	anhe:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   743: aload_1
    //   744: areturn
    //   745: astore 5
    //   747: ldc 136
    ...
    //   762: aload_0
    //   763: getfield 114	anhe:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   820: aload_0
    //   821: getfield 114	anhe:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   833: aload_0
    //   834: getfield 60	anhe:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger	Ljava/util/concurrent/atomic/AtomicInteger;
  ...
  public void a(boolean paramBoolean)
  {
    ...
    anhj localanhj = this.jdField_a_of_type_Anhj;
    long l = System.currentTimeMillis();
    localanhj.g = l;
    b();
    c();
    ...
    this.jdField_a_of_type_Anhj.h = System.currentTimeMillis();
  }
  ...
  public boolean b(String paramString)
  {
    ...
    {
      this.jdField_e_of_type_JavaLangString = angg.a(paramString, "apollo_task_id", String.valueOf(this.jdField_b_of_type_JavaLangString));
      this.jdField_a_of_type_Anhj.i = System.currentTimeMillis();
      if (QLog.isColorLevel())
      {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.arg1 == 1) {
      if (this.jdField_c_of_type_JavaUtilConcurrentAtomicAtomicBoolean.compareAndSet(false, true))
      {
        ...
        this.jdField_a_of_type_Anhj.j = System.currentTimeMillis();
        if (this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView != null) {
