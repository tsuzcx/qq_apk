  ...
  extends ayvz
{
  ...
  public qey(ReadInJoyDeliverUGCActivity paramReadInJoyDeliverUGCActivity, Looper paramLooper)
  {
    super(paramLooper);
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    if ((localayqm == null) || (localayqm.jdField_b_of_type_Int != 24) || (localayqm.jdField_c_of_type_Int != 10)) {}
    do
    {
      do
      {
        for (;;)
        {
          ...
          case 1003: 
            ...
            {
              int j = (int)localayqm.jdField_b_of_type_Long;
              ...
              try
              {
                ...
                ((JSONObject)localObject).put("url", localayqm.i);
                ((JSONObject)localObject).put("md5", localayqm.f);
                ...
                if ((j < ReadInJoyDeliverUGCActivity.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyUgcReadInJoyDeliverUGCActivity)) && (!localayqm.i.equals(ReadInJoyDeliverUGCActivity.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyUgcReadInJoyDeliverUGCActivity).a()[j])) && (!localayqm.f.equals(ReadInJoyDeliverUGCActivity.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyUgcReadInJoyDeliverUGCActivity).b()[j])))
                {
              ...
              catch (Exception paramMessage)
              {
                ...
                if (i == j)
                {
                  ReadInJoyDeliverUGCActivity.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyUgcReadInJoyDeliverUGCActivity).a(i, localayqm.i);
                  ReadInJoyDeliverUGCActivity.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyUgcReadInJoyDeliverUGCActivity).b(i, localayqm.f);
      ...
      int i = (int)localayqm.jdField_b_of_type_Long;
      ...
      ReadInJoyDeliverUGCActivity.h(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyUgcReadInJoyDeliverUGCActivity, 1, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyUgcReadInJoyDeliverUGCActivity.getString(2131718414));
