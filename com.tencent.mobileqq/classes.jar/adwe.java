...
public class adwe
  implements Runnable
{
  public adwe(MediaApiPlugin paramMediaApiPlugin, String paramString1, String paramString2, AtomicBoolean paramAtomicBoolean) {}
  ...
  public void run()
  {
    ...
    //   11: astore_2
    //   12: aload_0
    //   13: getfield 17	adwe:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   16: invokestatic 48	com/tencent/mobileqq/utils/FileUtils:a	(Ljava/lang/String;)[B
    //   19: astore_3
    //   20: aload_0
    //   21: getfield 15	adwe:jdField_a_of_type_ComTencentMobileqqJspMediaApiPlugin	Lcom/tencent/mobileqq/jsp/MediaApiPlugin;
    //   24: aload_3
    ...
    //   57: pop
    //   58: aload_0
    //   59: getfield 19	adwe:b	Ljava/lang/String;
    //   62: invokestatic 79	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   65: ifne +129 -> 194
    //   68: aload_0
    //   69: getfield 21	adwe:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   72: iconst_0
    //   73: iconst_1
    //   74: invokevirtual 85	java/util/concurrent/atomic/AtomicBoolean:compareAndSet	(ZZ)Z
    //   77: ifeq +117 -> 194
    //   80: aload_0
    //   81: getfield 15	adwe:jdField_a_of_type_ComTencentMobileqqJspMediaApiPlugin	Lcom/tencent/mobileqq/jsp/MediaApiPlugin;
    //   84: aload_0
    //   85: getfield 19	adwe:b	Ljava/lang/String;
    //   88: iconst_1
    ...
    //   191: goto -133 -> 58
    //   194: aload_0
    //   195: getfield 15	adwe:jdField_a_of_type_ComTencentMobileqqJspMediaApiPlugin	Lcom/tencent/mobileqq/jsp/MediaApiPlugin;
    //   198: ldc 120
    //   200: iconst_0
    //   201: aload_1
