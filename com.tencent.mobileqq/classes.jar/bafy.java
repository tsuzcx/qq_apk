  ...
  extends DynamicDrawableSpan
{
  ...
  private bafy(Context paramContext, MessageForReplyText.SourceMsgInfo paramSourceMsgInfo, int paramInt, Paint paramPaint, View.OnClickListener paramOnClickListener)
  {
    super(0);
  ...
  public static bafy a(QQAppInterface paramQQAppInterface, Context paramContext, MessageForReplyText.SourceMsgInfo paramSourceMsgInfo, int paramInt, Paint paramPaint, View.OnClickListener paramOnClickListener)
  {
    ...
    return new bafy(paramContext, paramSourceMsgInfo, paramInt, paramPaint, paramOnClickListener);
  }
  ...
  private void a(Paint paramPaint)
  {
    ...
    do
    {
      do
      {
        ...
        paramPaint.append(bbos.a(this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, ChatTextSizeSettingActivity.a(), null, 7));
        ...
        i = (int)bbdv.a(this.jdField_a_of_type_AndroidContentContext, 6.0F);
        j = (int)bbdv.a(this.jdField_a_of_type_AndroidContentContext, 23.0F);
