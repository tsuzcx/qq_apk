...
public abstract class avyw
{
  ...
  private ConcurrentHashMap<String, xfp> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
  ...
  public xfp a(String paramString)
  {
    ...
    return (xfp)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
  }
  ...
  protected void a(ToServiceMsg paramToServiceMsg, alwg paramalwg, Class<? extends MSFServlet> paramClass)
  {
    ...
    paramToServiceMsg = new PeakJceServiceBase.1(this, paramToServiceMsg, paramalwg, paramClass);
  ...
  public void a(boolean paramBoolean, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Exception paramException)
  {
    ...
    //   4: return
    //   5: aload_0
    //   6: invokevirtual 204	avyw:a	()Lcom/tencent/common/app/AppInterface;
    //   9: astore 8
    ...
    //   79: aload_0
    //   80: getfield 32	avyw:jdField_a_of_type_JavaTextDecimalFormat	Ljava/text/DecimalFormat;
    //   83: fload 5
    //   85: f2d
    ...
    //   130: invokevirtual 250	avyw:a	(Ljava/lang/String;)Lxfp;
    //   133: astore 9
    //   135: iload_1
    //   136: ifeq +323 -> 459
    //   139: aload 9
    ...
    //   146: aload_2
    //   147: aload_3
    //   148: invokevirtual 253	xfp:a	(Lcom/tencent/qphone/base/remote/ToServiceMsg;Lcom/tencent/qphone/base/remote/FromServiceMsg;)V
    //   151: aload 9
    //   153: aload_2
    //   154: aload_3
    //   155: invokevirtual 256	xfp:a	(Lcom/tencent/qphone/base/remote/ToServiceMsg;Lcom/tencent/qphone/base/remote/FromServiceMsg;)Ljava/lang/Object;
    //   158: astore 4
    //   160: aload_0
    //   161: aload_3
    //   162: invokevirtual 258	avyw:a	(Lcom/tencent/qphone/base/remote/FromServiceMsg;)V
    //   165: aload 9
    //   167: ifnull -163 -> 4
    //   170: invokestatic 263	ajfu:b	()Ljava/util/Map;
    //   173: aload_3
    ...
    //   236: aload_3
    //   237: aload 4
    //   239: invokevirtual 280	ajfb:onReceive	(Lcom/tencent/qphone/base/remote/ToServiceMsg;Lcom/tencent/qphone/base/remote/FromServiceMsg;Ljava/lang/Object;)V
    //   242: iload 6
    //   244: iconst_1
    //   245: iadd
    //   246: istore 6
    ...
    //   387: aload_0
    //   388: getfield 32	avyw:jdField_a_of_type_JavaTextDecimalFormat	Ljava/text/DecimalFormat;
    //   391: fload 5
    //   393: f2d
  ...
  protected boolean a(xfp paramxfp)
  {
    int i = 0;
    String[] arrayOfString = paramxfp.a();
    if ((arrayOfString == null) || (arrayOfString.length == 0)) {
      return false;
    }
    while (i < arrayOfString.length)
    {
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(arrayOfString[i], paramxfp);
      i += 1;
    }
    return true;
  }
  ...
  public void b(ToServiceMsg paramToServiceMsg, alwg paramalwg, Class<? extends MSFServlet> paramClass)
  {
    int i = 1;
    AppInterface localAppInterface = a();
    Object localObject1 = paramToServiceMsg.getServiceCmd();
    xfp localxfp = a((String)localObject1);
    Object localObject2;
    int j;
    if (localxfp != null)
    {
      ...
      if (localxfp.a())
      {
        localObject2 = localxfp.a(paramToServiceMsg);
    ...
    for (;;)
    {
      if (i != 0)
      {
        ...
        paramalwg = new NewIntent(localAppInterface.getApplication(), paramClass);
        paramalwg.putExtra(ToServiceMsg.class.getSimpleName(), paramToServiceMsg);
        localAppInterface.startServlet(paramalwg);
      ...
      do
      {
        ...
        {
          return;
          if (!localxfp.a(paramToServiceMsg, (UniPacket)localObject2)) {
            break label314;
          }
          paramToServiceMsg.putWupBuffer(((UniPacket)localObject2).encode());
          break;
        } while (localxfp == null);
        paramalwg = new FromServiceMsg(localAppInterface.getCurrentAccountUin(), (String)localObject1);
        paramClass = (int[])ajfu.a().get(localObject1);
      } while ((paramClass == null) || (paramClass.length <= 0));
      j = paramClass.length;
      i = 0;
      while (i < j)
      {
        localObject1 = (ajfb)localAppInterface.getBusinessHandler(paramClass[i]);
        if (localObject1 != null) {}
        try
        {
          ((ajfb)localObject1).onReceive(paramToServiceMsg, paramalwg, null);
          i += 1;
        }
