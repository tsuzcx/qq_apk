...
public class babe
{
  ...
  public static rcs a(String paramString)
  {
    if (TextUtils.isEmpty(paramString)) {
      return null;
    }
    ...
    {
      paramString = BaseApplicationImpl.sImageCache.get(paramString);
      if ((paramString instanceof rcs)) {
        return (rcs)paramString;
      }
    }
    return null;
  }
  ...
  public static void a(String paramString, rcs paramrcs)
  {
    if ((TextUtils.isEmpty(paramString)) || (paramrcs == null)) {}
    while (BaseApplicationImpl.sImageCache == null) {
      return;
    }
    BaseApplicationImpl.sImageCache.put(paramString, paramrcs);
  }
}
