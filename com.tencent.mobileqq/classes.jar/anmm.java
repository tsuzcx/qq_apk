...
public class anmm
  extends ajzm
{
  public anmm(MsgBoxListActivity paramMsgBoxListActivity) {}
  ...
  protected void e(boolean paramBoolean, Object[] paramArrayOfObject)
  {
    ...
    if (paramBoolean)
    {
      ...
      i = 1;
      if (((i & paramArrayOfObject instanceof Object[]) != 0) && (this.a.d != null) && (this.a.jdField_a_of_type_Atyo != null) && (((Integer)paramArrayOfObject[1]).intValue() == 1))
      {
        paramArrayOfObject = (List)paramArrayOfObject[0];
        localLinearLayout = (LinearLayout)this.a.d.findViewById(2131372166);
