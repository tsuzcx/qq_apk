...
public class zun
  implements zui
{
  private static zun jdField_a_of_type_Zun;
  ...
  private zun()
  {
    ...
    for (this.jdField_a_of_type_Zuh = new zuj();; this.jdField_a_of_type_Zuh = new zul())
    {
      this.jdField_a_of_type_Zuh.a(this);
      return;
      if (QLog.isColorLevel()) {
  ...
  private Map<String, APIQuotaItem> a(String paramString1, int paramInt, String paramString2)
  {
    ...
    try
    {
      ...
      if (i != 0) {
        this.jdField_a_of_type_Zuh.a(paramString1, paramInt, paramString2);
      }
      return localObject;
    }
    finally {}
  ...
  public static zun a()
  {
    if (jdField_a_of_type_Zun == null) {}
    try
    {
      if (jdField_a_of_type_Zun == null) {
        jdField_a_of_type_Zun = new zun();
      }
      return jdField_a_of_type_Zun;
    }
    finally {}
  }
  ...
  public void a(String paramString1, int paramInt, String paramString2, String paramString3)
  {
    ...
    this.jdField_a_of_type_Zuh.a(paramString1, paramInt, paramString2, paramString3);
  }
