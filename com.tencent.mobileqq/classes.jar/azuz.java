...
public class azuz
{
  ...
  public azuz(QQAppInterface paramQQAppInterface, View paramView)
  {
  ...
  public azuz(QQAppInterface paramQQAppInterface, View paramView, MessageRecord paramMessageRecord)
  {
  ...
  {
    if ((jdField_a_of_type_Bhuf == null) || (!jdField_a_of_type_Bhuf.getContext().equals(paramContext)))
    {
      jdField_a_of_type_Bhuf = bhuf.a(paramContext);
      jdField_a_of_type_Bhuf.a(2131691700, 1);
      jdField_a_of_type_Bhuf.a(2131691361, 1);
      jdField_a_of_type_Bhuf.c(2131690648);
      jdField_a_of_type_Bhuf.a(String.format(paramContext.getString(2131694909), new Object[] { paramString }));
      jdField_a_of_type_Bhuf.a(new azva(paramString, paramContext));
    }
    if (!jdField_a_of_type_Bhuf.isShowing()) {
      jdField_a_of_type_Bhuf.show();
    }
  }
      ...
      do
      {
        do
        {
          do
          {
            ...
            bool1 = bool2;
          } while (!bdeu.b(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.frienduin));
          bool1 = bool2;
        } while (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.getExtInfoFromExtStr("guide_msg_cookie")));
        paramString = bdeu.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.getExtInfoFromExtStr("guide_msg_cookie"));
        bool1 = bool2;
        ...
        try
        {
          if (((PackageManager)localObject).getPackageInfo(paramString3, 1) != null)
          {
            ...
            if (localObject != null)
            {
              ...
              amcw.a("structmsg", "", paramString3, "1", "structmsgClick", this.jdField_a_of_type_AndroidContentContext.getClass().getName());
              this.jdField_a_of_type_AndroidContentContext.startActivity((Intent)localObject);
              return true;
  ...
  public boolean a(String paramString1, String paramString2, String paramString3, String paramString4, long paramLong, Object... paramVarArgs)
  {
    ...
    else
    {
      if ((this.jdField_a_of_type_AndroidContentContext instanceof FragmentActivity))
      {
        ...
        if (localObject1 != null)
        {
          ...
          if (((((ChatFragment)localObject1).a() instanceof agti)) && ((this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord instanceof MessageForStructing)))
          {
            ...
            amrz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject2, 0, 2, paramLong, (String)localObject1);
          }
        }
      }
      label268:
    ...
    for (boolean bool1 = a(paramString2, paramLong, paramVarArgs);; bool1 = a(paramString2))
    {
      ...
      {
        amrz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject2, 0, 1, paramLong, (String)localObject1);
        break label268;
      }
      if (!(localMessageForStructing.structingMsg instanceof StructMsgForAudioShare)) {
        break label268;
      }
      amrz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject2, 0, 5, paramLong, (String)localObject1);
      break label268;
    }
    label417:
  ...
  public boolean c(String paramString1, String paramString2)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          paramString1 = bdib.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, paramString1);
          if (paramString1 != null)
          {
            ...
            paramString1.c();
            if ((this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord != null) && (!this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.isSend()) && (this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.istroop == 0) && (bdeu.b(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.frienduin)) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.getExtInfoFromExtStr("guide_msg_cookie"))))
            {
              paramString1 = bdeu.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.getExtInfoFromExtStr("guide_msg_cookie"));
              if (paramString1 != null)
              {
