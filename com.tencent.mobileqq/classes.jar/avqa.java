...
public class avqa
{
  ...
  public View a(String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    localLinearLayout.addView((View)localObject, xin.b(this.jdField_a_of_type_AndroidContentContext, 18.0F), xin.b(this.jdField_a_of_type_AndroidContentContext, 15.0F));
    ((LinearLayout.LayoutParams)((View)localObject).getLayoutParams()).leftMargin = xin.b(this.jdField_a_of_type_AndroidContentContext, 4.0F);
    ...
    paramString1.rightMargin = xin.b(this.jdField_a_of_type_AndroidContentContext, 6.0F);
    paramString1.leftMargin = xin.b(this.jdField_a_of_type_AndroidContentContext, 2.0F);
    localLinearLayout.setBackgroundResource(2130845157);
    ...
    localLinearLayout.setOnClickListener(new avqb(this));
  ...
  public void a(QQAppInterface paramQQAppInterface, View paramView, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131378031);
    this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardLabelContainer = ((LabelContainer)paramView.findViewById(2131369297));
    this.b = paramView.findViewById(2131369483);
  ...
  public void a(cmd0xac5.NearbyNowData paramNearbyNowData)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardLabelContainer.setSpace(xin.b(this.jdField_a_of_type_AndroidContentContext, 6.0F), xin.b(this.jdField_a_of_type_AndroidContentContext, 8.0F));
    ...
    for (paramNearbyNowData = paramNearbyNowData.label_info.get();; paramNearbyNowData = null)
    {
      if ((paramNearbyNowData != null) && (paramNearbyNowData.size() > 0))
      {
        ...
        while (i < paramNearbyNowData.size())
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardLabelContainer.addView((View)localObject, -2, xin.b(this.jdField_a_of_type_AndroidContentContext, 24.0F));
          i += 1;
        }
