...
public class avqa
  implements bknm
{
  public avqa(UiApiPlugin paramUiApiPlugin, JSONObject paramJSONObject, Activity paramActivity) {}
  ...
  public void a(bknl parambknl)
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_AndroidAppActivity instanceof BasePluginActivity))
      {
        ...
        ((Intent)localObject2).putExtras(parambknl);
