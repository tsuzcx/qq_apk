...
public class usj
{
  public static bdte a(MessageRecord paramMessageRecord)
  {
  ...
  public static bdte a(AbsStructMsg paramAbsStructMsg)
  {
        ...
        do
        {
          ...
          while (!((Iterator)localObject1).hasNext())
          {
            do
            {
              ...
              localObject1 = (bdnu)paramAbsStructMsg.next();
            } while (!(localObject1 instanceof bdrp));
            localObject1 = ((bdrp)localObject1).a.iterator();
          }
          localObject2 = (bdnu)((Iterator)localObject1).next();
        } while (!(localObject2 instanceof bdte));
        localObject2 = (bdte)localObject2;
      } while (!((bdte)localObject2).a());
      return localObject2;
    }
    return null;
  }
  ...
  public static String a(String paramString)
  {
    ...
    return pjj.k + bhcu.encodeToString(paramString.getBytes(), 2);
  }
        ...
        if ((localObject1 instanceof bdrp))
        {
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            if ((localObject2 instanceof bdte))
            {
              ...
              {
                ((bdte)localObject2).ag = null;
                ((bdte)localObject2).ad = null;
                ((bdte)localObject2).o = 0;
                if (QLog.isColorLevel()) {
                  QLog.d("PAVideoStructMsgUtil", 2, "simplifyForForward: summary = null");
                }
                bdla.b(null, "dc00899", "Pb_account_lifeservice", "", "0X800682F", "0X800682F", 0, 0, ((bdte)localObject2).ae, "" + ((bdte)localObject2).v, "" + ((bdte)localObject2).a.msgId, "");
              }
            }
  ...
  public static boolean a(AbsStructMsg paramAbsStructMsg)
  {
    ...
    if (paramAbsStructMsg != null)
    {
      ...
      if ((paramAbsStructMsg instanceof StructMsgForGeneralShare))
      {
        ...
        if (paramAbsStructMsg.hasNext())
        {
          Object localObject = (bdnu)paramAbsStructMsg.next();
          if (!(localObject instanceof bdrp)) {
            break label110;
          }
          localObject = ((bdrp)localObject).a.iterator();
