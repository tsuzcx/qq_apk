...
public class lze
{
  ...
  public static int a(Context paramContext, int paramInt)
  {
    ...
    //   191: aload_0
    //   192: iload_1
    //   193: invokestatic 164	lze:b	(Landroid/content/Context;I)I
    //   196: istore_2
    //   197: iload_2
    //   198: istore_1
    //   199: aload 5
  ...
  public static void a(long paramLong, Context paramContext, boolean paramBoolean1, String paramString, boolean paramBoolean2)
  {
    ...
    try
    {
      ...
      if (AudioHelper.e()) {
        QLog.w("SmallScreenUtils", 1, "actionOn isFloatWindowOpAllowed, isFloatWindowOpAllowed[" + c(paramContext) + "], isCalling[" + msf.d(paramContext) + "], isHome[" + a(paramContext) + "], isNeedStartDialog[" + paramBoolean1 + "], seq[" + paramLong + "]");
      }
      if (a(paramContext, paramBoolean1, paramString, paramBoolean2)) {
        axqy.b(null, "CliOper", "", "", "0X80057D8", "0X80057D8", 0, 0, "", "", "", "");
      }
      return;
    }
  ...
  public static void a(Context paramContext, lga paramlga)
  {
    int i = paramlga.jdField_d_of_type_Int;
    int j = paramlga.E;
    int k = paramlga.jdField_g_of_type_Int;
    if (QLog.isColorLevel())
    {
    ...
    if (paramlga.jdField_a_of_type_Lgb.jdField_b_of_type_Int > 0) {
      if (paramlga.jdField_a_of_type_Lgc.a > 0L) {
        paramlga = "0X8005A49";
      }
    }
    for (;;)
    {
      if ((paramlga != null) && (c(paramContext))) {
        axqy.b(null, "CliOper", "", "", paramlga, paramlga, 0, 0, "", "", "", "");
      }
      return;
      if (paramlga.jdField_a_of_type_Lgb.jdField_b_of_type_Int == 5)
      {
        paramlga = "0X8005A48";
      }
      else
  ...
  public static void a(View paramView, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramView != null)
    {
      localObject = paramView.getTag(2131372188);
      if (localObject != null) {
        break label190;
      }
      bool = false;
      ...
      localObject = paramView.getTag(2131372189);
      if (localObject != null) {
        break label203;
      }
      bool = false;
    ...
    for (Object localObject = new AlphaAnimation(0.0F, 1.0F);; localObject = new AlphaAnimation(1.0F, 0.0F))
    {
      ...
      localAnimationSet.setAnimationListener(new lzf(paramView, paramBoolean1));
      paramView.startAnimation(localAnimationSet);
      paramView.setVisibility(0);
      paramView.setTag(2131372189, Boolean.valueOf(paramBoolean1));
      paramView.setTag(2131372188, Boolean.valueOf(paramBoolean2));
      return;
        ...
        if (paramVideoAppInterface.getApp() != null)
        {
          ...
          if (paramVideoAppInterface.a() != null)
          {
            ...
            if (paramVideoAppInterface.a().a() != null)
            {
              ...
              if ((((lga)localObject).jdField_d_of_type_Int == 3) || (((lga)localObject).jdField_d_of_type_Int == 4)) {
                str = String.valueOf(((lga)localObject).jdField_g_of_type_Long);
              }
  ...
  public static boolean a(Context paramContext)
  {
    ...
    {
      lcg.e("SmallScreenUtils", paramContext.getMessage());
      return bool2;
    }
    return bool3;
  }
  ...
  public static boolean f()
  {
    ...
    for (;;)
    {
      ...
      {
        bool1 = bool2;
        if (locallzo.jdField_b_of_type_Int > 0) {
          bool1 = false;
        }
      }
    }
  ...
  public static boolean g()
  {
    ...
    for (;;)
    {
      ...
      {
        bool1 = bool2;
        if (locallzo.jdField_d_of_type_Int > 0) {
          bool1 = false;
        }
      }
    }
