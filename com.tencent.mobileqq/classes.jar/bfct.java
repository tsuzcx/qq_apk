...
{
  bfct(QQAppInterface paramQQAppInterface, String paramString, Activity paramActivity) {}
  ...
  public void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    ...
    for (;;)
    {
      paramDialogInterface = bfcs.jdField_a_of_type_JavaLangString.replace("$GCODE$", this.jdField_a_of_type_JavaLangString).replace("$UIN$", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).replace("$ROLE$", paramDialogInterface);
      ...
      bdla.b(null, "dc00898", "", "", "0X800B223", "0X800B223", 0, 0, "", "", "", "");
      return;
      label125:
