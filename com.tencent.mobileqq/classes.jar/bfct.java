...
public class bfct
{
  private static bfct jdField_a_of_type_Bfct;
  ...
  private bfct(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    a();
  }
  
  public static final bfct a(Context paramContext)
  {
    if (jdField_a_of_type_Bfct == null) {}
    try
    {
      if (jdField_a_of_type_Bfct == null) {
        jdField_a_of_type_Bfct = new bfct(paramContext);
      }
      return jdField_a_of_type_Bfct;
    }
    finally {}
  }
  ...
  void b()
  {
    ...
    //   9: dup
    //   10: aload_0
    //   11: getfield 36	bfct:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    ...
    //   150: aload_0
    //   151: getfield 34	bfct:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   154: aload_3
    //   155: aload 4
