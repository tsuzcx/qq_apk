...
public class azmv
{
  private static HashMap<String, azmw> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  /* Error */
  public static final azmw a(Context paramContext, String paramString)
  {
    // Byte code:
    //   0: getstatic 19	azmv:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   3: astore_2
    //   4: aload_2
    //   5: monitorenter
    //   6: getstatic 19	azmv:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   9: aload_1
    //   10: invokevirtual 51	java/util/HashMap:containsKey	(Ljava/lang/Object;)Z
    //   13: ifeq +18 -> 31
    //   16: getstatic 19	azmv:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   19: aload_1
    //   20: invokevirtual 55	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   23: checkcast 57	azmw
    //   26: astore_0
    //   27: aload_2
    //   28: monitorexit
    //   29: aload_0
    ...
    //   83: aload_0
    //   84: aload_1
    //   85: invokestatic 91	azmv:b	(Landroid/content/Context;Ljava/lang/String;)Lazmw;
    //   88: astore_0
    //   89: aload_0
    //   90: ifnull +591 -> 681
    //   93: getstatic 19	azmv:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   96: astore_2
    //   97: aload_2
    //   98: monitorenter
    //   99: getstatic 19	azmv:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   102: aload_1
    //   103: aload_0
    ...
    //   122: new 57	azmw
    //   125: dup
    //   126: invokespecial 96	azmw:<init>	()V
    //   129: astore_3
    //   130: new 98	java/io/ByteArrayInputStream
    //   133: dup
    //   134: aload 7
    //   136: invokestatic 103	bhmi:a	(Ljava/io/File;)[B
    ...
    //   168: putfield 118	azmw:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   171: aload_0
    //   172: astore 4
    //   174: aload 6
    //   176: astore_2
    ...
    //   183: putfield 124	azmw:jdField_a_of_type_Boolean	Z
    //   186: aload_0
    //   187: astore 4
    //   189: aload 6
    //   191: astore_2
    //   192: aload_3
    //   193: getfield 124	azmw:jdField_a_of_type_Boolean	Z
    //   196: ifeq +310 -> 506
    //   199: aload_0
    //   200: astore 4
    //   202: aload 6
    ...
    //   214: putfield 126	azmw:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   217: aload_0
    //   218: astore 4
    //   220: aload 6
    //   222: astore_2
    ...
    //   232: putfield 128	azmw:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   235: aload_0
    //   236: astore 4
    //   238: aload 6
    //   240: astore_2
    ...
    //   247: putfield 135	azmw:jdField_a_of_type_Int	I
    //   250: aload_0
    //   251: astore 4
    //   253: aload 6
    //   255: astore_2
    ...
    //   262: putfield 137	azmw:jdField_b_of_type_Int	I
    //   265: aload_0
    //   266: astore 4
    //   268: aload 6
    //   270: astore_2
    ...
    //   277: putfield 139	azmw:jdField_c_of_type_Int	I
    //   280: aload_0
    //   281: astore 4
    //   283: aload 6
    //   285: astore_2
    ...
    //   292: putfield 145	azmw:jdField_b_of_type_Long	J
    //   295: aload_0
    //   296: astore 4
    //   298: aload 6
    //   300: astore_2
    ...
    //   307: putfield 147	azmw:jdField_a_of_type_Long	J
    //   310: aload_0
    //   311: astore 4
    //   313: aload 6
    //   315: astore_2
    ...
    //   319: aload_3
    //   320: getfield 145	azmw:jdField_b_of_type_Long	J
    //   323: lsub
    ...
    //   340: aload_3
    //   341: iconst_1
    //   342: putfield 162	azmw:jdField_b_of_type_Boolean	Z
    //   345: aload_0
    //   346: astore 4
    //   348: aload 6
    //   350: astore_2
    ...
    //   375: putfield 173	azmw:jdField_c_of_type_Long	J
    //   378: aload_0
    //   379: astore 4
    //   381: aload 6
    //   383: astore_2
    ...
    //   411: aload_3
    //   412: getfield 145	azmw:jdField_b_of_type_Long	J
    ...
    //   469: aload_3
    //   470: getfield 126	azmw:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   481: aload_3
    //   482: getfield 137	azmw:jdField_b_of_type_Int	I
    ...
    //   493: aload_3
    //   494: getfield 139	azmw:jdField_c_of_type_Int	I
  ...
  public static final void a(Context paramContext, azmw paramazmw)
  {
    if (QLog.isColorLevel()) {
      QLog.d("OpenApi.Config", 2, "saveNewKey, " + paramazmw.jdField_b_of_type_Long + " to " + paramazmw.d);
    }
    if (paramazmw.jdField_b_of_type_Boolean)
    {
      paramazmw.jdField_b_of_type_Long = paramazmw.d;
      paramazmw.jdField_a_of_type_Long = paramazmw.jdField_c_of_type_Long;
      paramazmw.jdField_b_of_type_Boolean = false;
      b(paramContext, paramazmw);
    }
  }
  ...
  public static final boolean a(Context paramContext, String paramString1, String paramString2)
  {
    try
    {
      ...
      paramContext = bhml.a(localMessageDigest.digest()).toUpperCase();
  ...
  private static azmw b(Context paramContext, String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (i < j)
      {
        ...
        {
          localObject1 = new azmw();
          ((azmw)localObject1).jdField_a_of_type_JavaLangString = paramString;
          ((azmw)localObject1).jdField_a_of_type_Boolean = true;
          ((azmw)localObject1).jdField_b_of_type_JavaLangString = b[i];
          ((azmw)localObject1).jdField_c_of_type_JavaLangString = c[i];
          ((azmw)localObject1).jdField_b_of_type_Long = NetConnInfoCenter.getServerTimeMillis();
          ((azmw)localObject1).jdField_a_of_type_Long = new Random().nextLong();
          ((azmw)localObject1).jdField_a_of_type_Int = 1073741823;
          ((azmw)localObject1).jdField_b_of_type_Int = 2147483647;
          ((azmw)localObject1).jdField_c_of_type_Int = 7;
          b(paramContext, (azmw)localObject1);
        }
      }
      else {
        return localObject1;
  ...
  /* Error */
  public static final void b(Context paramContext, azmw paramazmw)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 19	azmv:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   6: astore_2
    //   7: aload_2
    //   8: monitorenter
    //   9: getstatic 19	azmv:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   12: aload_1
    //   13: getfield 118	azmw:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   16: aload_1
    ...
    //   164: aload_1
    //   165: getfield 118	azmw:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   190: iconst_0
    //   191: invokestatic 304	bhmi:a	(Ljava/lang/String;[BZ)Z
    //   194: pop
    //   195: aload_3
    //   196: ifnull +7 -> 203
    //   199: aload_3
