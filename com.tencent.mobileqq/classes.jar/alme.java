  ...
  implements Comparator<RecentBaseData>
{
  ...
  public alme(QQAppInterface paramQQAppInterface)
  {
  ...
  private int a(RecentUserBaseData paramRecentUserBaseData, int paramInt)
  {
    ...
    if (paramRecentUserBaseData.mUnreadNum > 0)
    {
      ...
      {
        i = j;
        if (amjp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + paramRecentUserBaseData.mUser.uin))
        {
          i = j;
  ...
  {
    if ((paramRecentUserBaseData.mUser.getType() == 1) && (!axug.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (RecentUser)paramRecentUserBaseData.mUser))) {
      ...
      else
      {
        ...
        for (;;)
        {
          ...
          if (localRecentUser.getType() == 3000)
          {
            ...
            DiscussionInfo localDiscussionInfo = ((anws)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).a(localRecentUser.uin);
          ...
          if (localRecentUser.lFlag == 16L)
          {
            ...
            nwo.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentUser);
            break;
          }
          if ((localRecentUser.getType() == 10005) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)) {
            avxx.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentUser);
          }
          break;
          a();
          return;
