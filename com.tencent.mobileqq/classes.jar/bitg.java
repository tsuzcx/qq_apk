  ...
  extends SSOAccountObserver
{
  ...
  {
    if (this.a.jdField_a_of_type_Bith != null) {
      this.a.jdField_a_of_type_Bith.a();
    }
  }
  ...
  public void onGetA1WithA1(String paramString, int paramInt1, byte[] paramArrayOfByte, int paramInt2, Bundle paramBundle)
  {
    if (paramInt1 == 0)
    {
      ...
      if ((paramArrayOfByte != null) && (paramArrayOfByte.length > 0))
      {
        ...
        paramArrayOfByte = new RSACrypt(biip.a().a()).EncryptData(this.a.a(biip.a().a(), this.a.jdField_a_of_type_Long, 1L), paramArrayOfByte);
        util.LOGD("encrypt buff:" + util.buf_to_string(paramArrayOfByte));
        if (this.a.jdField_a_of_type_Bith != null) {
          this.a.jdField_a_of_type_Bith.a(paramString, paramArrayOfByte);
        }
      }
    }
    while (this.a.jdField_a_of_type_Bith == null) {
      return;
    }
    this.a.jdField_a_of_type_Bith.a();
  }
