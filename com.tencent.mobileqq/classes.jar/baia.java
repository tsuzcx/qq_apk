...
public class baia
{
  ...
  private List<baif> jdField_a_of_type_JavaUtilList;
  ...
  public baia(String paramString, int paramInt)
  {
  ...
  private baia a(baif parambaif)
  {
    if (parambaif != null) {
      this.jdField_a_of_type_JavaUtilList.add(parambaif);
    }
  ...
  private void a(StringBuilder paramStringBuilder, int paramInt)
  {
    ...
    while (paramInt < m)
    {
      if ((paramStringBuilder.charAt(paramInt) == '<') && (paramInt < k - 2))
      {
        ...
        if ((i == 36) && (paramInt < k - 3))
        {
          ...
          for (;;)
          {
            ...
            a(new baid(paramStringBuilder.substring(paramInt, paramInt + 4), i, n));
            paramInt += 4;
            break;
            if (j == 10) {
          ...
          if ((j >= 255) && (paramInt + 6 < k))
          {
            if (paramStringBuilder.charAt(paramInt + 6) == '>')
            {
              ...
              a(new baie(paramStringBuilder.substring(paramInt, paramInt + 7), j, n));
              i = 2;
              if (i < 5)
              {
          ...
          else if (j == 250)
          {
            ...
            a(new baid(paramStringBuilder.substring(paramInt, paramInt + 4), 10, n));
            paramInt += 4;
          }
        }
        else if (((i == 37) || (i == 38)) && (paramInt < k - 6))
        {
          a(new baic(paramStringBuilder.substring(paramInt, paramInt + 7)));
          paramInt += 7;
        }
      }
      else
      {
        ...
        {
          a(new bahz(paramStringBuilder.substring(paramInt, paramInt + 2)));
          paramInt += 2;
          continue;
        }
        a(new baib(String.valueOf(paramStringBuilder.charAt(paramInt))));
      }
      label635:
      paramInt += 1;
    }
  ...
  public baia a(int paramInt)
  {
    baia localbaia = new baia();
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext())
    {
      baif localbaif = (baif)localIterator.next();
      if (localbaif.a() == paramInt) {
        localbaia.a(localbaif);
      }
    }
    return localbaia;
  }
  ...
  @NonNull
  public baif a(int paramInt)
  {
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_JavaUtilList.size())) {
      return (baif)this.jdField_a_of_type_JavaUtilList.get(paramInt);
    }
  ...
  public String a()
  {
    ...
    {
      baif localbaif = (baif)localIterator.next();
      if ((localbaif.a() == 0) || (localbaif.a() == 1)) {
        localStringBuilder.append(localbaif.a());
      }
    }
    return localStringBuilder.toString();
  }
  
  public baia b(int paramInt)
  {
    baia localbaia = new baia();
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext())
  ...
  public String b()
  {
    ...
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
      localStringBuilder.append(((baif)localIterator.next()).a());
    }
    return localStringBuilder.toString();
  }
