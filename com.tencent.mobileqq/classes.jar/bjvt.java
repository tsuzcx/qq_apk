  ...
  implements View.OnTouchListener
{
  ...
  public bjvt(bjvs parambjvs)
  {
    this.jdField_a_of_type_Bjvs = parambjvs;
  }
  
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    if (this.jdField_a_of_type_Bjvs == null) {}
    do
    {
      do
      {
        ...
        do
        {
          ...
          {
            this.jdField_a_of_type_Bjvs.a(paramMotionEvent);
            return true;
          }
          this.jdField_b_of_type_AndroidViewMotionEvent = MotionEvent.obtain(paramMotionEvent);
          this.jdField_b_of_type_Boolean = this.jdField_a_of_type_Bjvs.a(this.jdField_a_of_type_AndroidViewMotionEvent, this.jdField_b_of_type_AndroidViewMotionEvent);
    ...
    if (!this.jdField_a_of_type_Boolean) {
      this.jdField_a_of_type_Bjvs.onClick(paramView);
    }
