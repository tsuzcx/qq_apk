  ...
  implements Handler.Callback
{
  ...
  private anyz jdField_a_of_type_Anyz = new avjq(this);
  private avle jdField_a_of_type_Avle;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private long[] jdField_a_of_type_ArrayOfLong;
  private avle b;
  
  public avjn(QQAppInterface paramQQAppInterface)
  {
  ...
  public static avjn a(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    QQToast.a(paramContext, 0, anvx.a(2131704150), 2000).a();
    int j;
    if (this.b != null)
    {
    ...
    for (int i = this.b.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble.fontId;; i = this.b.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble.bubbleId)
    {
      ...
      this.b = null;
      this.jdField_a_of_type_Avle = null;
      return;
    }
  }
  ...
  private void a(BaseChatPie paramBaseChatPie)
  {
    ...
    String str = paramBaseChatPie.input.getText().toString();
    ...
    do
    {
      ...
      paramBaseChatPie.setSendTextMsgParams(localadmo);
      localadmo.i = paramBaseChatPie.isSendToRobotServer;
      paramBaseChatPie.isSendToRobotServer = false;
      this.jdField_a_of_type_ArrayOfLong = admh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramBaseChatPie.getActivity(), paramBaseChatPie.getSessionInfo(), str, new ArrayList(), localadmo);
      paramBaseChatPie.input.setText("");
      paramBaseChatPie.showInputPanel();
    } while (this.b == null);
    int j = this.b.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble.panelType;
    if (j == 3) {}
    for (int i = this.b.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble.fontId;; i = this.b.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble.bubbleId)
    {
      VasWebviewUtil.reportCommercialDrainage(paramBaseChatPie.app.getCurrentUin(), "aio_iconA", "Send", "", 1, 0, 0, "", Integer.toString(i), FontBubblePanelView.a(j), "0", "", "", "", 0, 0, 0, 0);
      this.b = null;
      return;
    }
  }
  ...
  private void a(BaseChatPie paramBaseChatPie, long paramLong, int paramInt)
  {
    ...
    if (TextUtils.isEmpty((CharSequence)localObject2)) {
      localObject1 = anvx.a(2131704151);
    }
    ...
    bhdj.a(paramBaseChatPie.getActivity(), 230, (String)localObject1, (CharSequence)localObject2, anvx.a(2131704152), (String)localObject3, new avjo(this, paramBaseChatPie, str), new avjp(this)).show();
  }
  ...
  public void a(long paramLong)
  {
    ...
    for (;;)
    {
      if (i < j)
      {
        ...
        if (this.jdField_a_of_type_Avle != null) {
          this.jdField_a_of_type_Avle.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        }
      }
      return;
      label59:
  ...
  public void a(BaseChatPie paramBaseChatPie, Bundle paramBundle)
  {
    ...
    if (this.b != null)
    {
      ...
      VasWebviewUtil.reportCommercialDrainage(paramBaseChatPie.app.getCurrentUin(), "aio_iconA", "OpenSvip", "", 1, 0, 0, "", "", FontBubblePanelView.a(i));
      this.b = new avle(this.b.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble);
  ...
  public void a(BaseChatPie paramBaseChatPie, boolean paramBoolean, SetFontBubbleRsp paramSetFontBubbleRsp, int paramInt)
  {
    if ((paramBoolean) && (paramSetFontBubbleRsp.stRet != null) && (paramSetFontBubbleRsp.stRet.ret == 0))
    {
      if ((this.b != null) && (this.b.jdField_a_of_type_Int == paramInt))
      {
        ...
        {
          a(paramBaseChatPie.getActivity());
          return;
        }
      ...
      if ((this.jdField_a_of_type_Avle != null) && (this.jdField_a_of_type_Avle.jdField_a_of_type_Int == paramInt))
      {
        if ((paramSetFontBubbleRsp.stFontRsp.authRet != 0) || (paramSetFontBubbleRsp.stBubbleRsp.authRet != 0)) {
          QLog.e("FontBubbleManager", 1, "onSetFontBubble failed," + " fontAuth:" + paramSetFontBubbleRsp.stFontRsp.authRet + " bubbleAuth:" + paramSetFontBubbleRsp.stBubbleRsp.authRet + this.jdField_a_of_type_Avle.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble);
        }
        for (;;)
        {
          this.jdField_a_of_type_Avle = null;
          return;
          if (QLog.isColorLevel()) {
            QLog.d("FontBubbleManager", 2, "onSetFontBubble mRestore success: " + this.jdField_a_of_type_Avle.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble);
          }
        }
      }
    ...
    StringBuilder localStringBuilder = AIOUtils.obtainStringBuilder().append("onSetFontBubble failed,");
    ...
    if ((this.jdField_a_of_type_Avle != null) && (this.jdField_a_of_type_Avle.jdField_a_of_type_Int == paramInt)) {
      QLog.e("FontBubbleManager", 1, "restore failed: " + this.jdField_a_of_type_Avle.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble);
    }
    a(paramBaseChatPie.getActivity());
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 1000: 
      ...
      this.jdField_a_of_type_Avle = new avle((FontBubble)paramMessage[0]);
      this.b = new avle((FontBubble)paramMessage[1]);
      this.b.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      return true;
    }
