  ...
  extends Handler
{
  ...
  public aunq(MusicPlayerActivity paramMusicPlayerActivity)
  {
  ...
  private void a(int[] paramArrayOfInt, boolean paramBoolean)
  {
    ...
    if ((paramArrayOfInt != null) && (paramArrayOfInt.length >= 2) && (localMusicPlayerActivity != null))
    {
      ...
      ((ImageView)localMusicPlayerActivity.findViewById(2131370876)).setImageDrawable(localGradientDrawable);
      localMusicPlayerActivity.findViewById(2131370879).setBackgroundColor(i);
      i = paramArrayOfInt[1];
      ...
      MusicPlayerActivity.a(localMusicPlayerActivity, 2130841452, i);
      MusicPlayerActivity.a(localMusicPlayerActivity, 2130841453, i);
      MusicPlayerActivity.a(localMusicPlayerActivity, 2130839666, i);
      if (paramBoolean)
      {
        MusicPlayerActivity.a(localMusicPlayerActivity, 2130841045, i);
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
          ...
          do
          {
            do
            {
              do
              {
                do
                {
                  ...
                  if ((paramMessage instanceof Integer))
                  {
                    ...
                    MusicPlayerActivity.a((MusicPlayerActivity)localObject1, 2130841452, j);
                  ...
                  for (;;)
                  {
                    ...
                    return;
                    MusicPlayerActivity.b((MusicPlayerActivity)localObject1).setImageResource(2130841452);
                  }
                } while (!(paramMessage.obj instanceof auns));
                localObject2 = (auns)paramMessage.obj;
                ...
                if (MusicPlayerActivity.a((MusicPlayerActivity)localObject1).isSelected()) {
                  MusicPlayerActivity.a((MusicPlayerActivity)localObject1).setImageResource(2130841046);
                }
                for (;;)
                {
                  MusicPlayerActivity.c((MusicPlayerActivity)localObject1).setVisibility(i);
                  MusicPlayerActivity.c((MusicPlayerActivity)localObject1).setImageResource(2130841045);
              ...
              for (;;)
              {
                ...
                paramMessage = (URLImageView)((MusicPlayerActivity)localObject1).findViewById(2131370885);
                localURLDrawable = URLDrawable.getDrawable((String)localObject3, URLDrawable.URLDrawableOptions.obtain());
                localObject4 = aumy.a((String)localObject3);
              ...
              for (;;)
              {
                ...
                MusicPlayerActivity.b((MusicPlayerActivity)localObject1).setText(2131694639);
                return;
                localObject3 = new aumy((String)localObject3, MusicPlayerActivity.a((MusicPlayerActivity)localObject1), Boolean.valueOf(bool1));
                if (localURLDrawable.getStatus() == 1)
                {
                  localObject4 = localURLDrawable.getCurrDrawable();
                  if ((localObject4 instanceof RegionDrawable)) {
                    ((aumy)localObject3).run(null, ((RegionDrawable)localObject4).getBitmap());
                  }
                }
                else
                {
              ...
              MusicPlayerActivity.b((MusicPlayerActivity)localObject1).setText(((MusicPlayerActivity)localObject1).getString(2131694637, new Object[] { paramMessage }));
              return;
              MusicPlayerActivity.a((MusicPlayerActivity)localObject1);
              return;
            } while (!(paramMessage.obj instanceof View));
            localObject2 = (View)paramMessage.obj;
            paramMessage = bhyv.a((Context)localObject1).b(3).a(((MusicPlayerActivity)localObject1).getString(paramMessage.arg1)).a(paramMessage.arg2);
            paramMessage.c(49);
            paramMessage = new bhyx(paramMessage).b(Color.argb(13, 255, 255, 255)).a(5).a();
      ...
      } while (!(localObject1 instanceof auns));
    ...
    WXShareHelper.a().a(String.valueOf(l), ((auns)localObject1).a, (Bitmap)localObject2, ((auns)localObject1).b, ((auns)localObject1).d, i, ((auns)localObject1).e);
  }
}
