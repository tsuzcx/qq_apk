...
public class aunq
{
  ...
  public static final String[] b = { "XG预下载配额余量", "XG当前消耗流量", "XG流量总消耗", "XG预下载总数", "XG预下载命中数", "XG预下载未命中数", "XG手动看图数", "XG消耗量余量", "WIFI预下载总数", "WIFI预下载命中数", "WIFI预下载未命中数", "WIFI手动看图数", "XG是否超过上限", ajyc.a(2131708154) };
  ...
  public static int a(QQAppInterface paramQQAppInterface, int paramInt, String paramString)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        try
        {
          bool = asfb.a().a(paramQQAppInterface, paramString);
          if (paramInt != 3000) {
            break label69;
          }
          j = 1;
  ...
  public static long a(QQAppInterface paramQQAppInterface, String paramString, long paramLong)
  {
    ...
    //   35: invokestatic 204	aunq:a	(Ljava/lang/String;J)V
    //   38: ldc 206
    //   40: ldc 208
    ...
    //   80: invokestatic 235	aune:a	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   83: lload 4
    //   85: lreturn
    //   86: aload_1
    //   87: lload_2
    //   88: invokestatic 204	aunq:a	(Ljava/lang/String;J)V
    //   91: lload_2
    //   92: lstore 4
    //   94: goto -56 -> 38
    //   97: astore_0
  ...
  public static void a(QQAppInterface paramQQAppInterface, aywa paramaywa)
  {
    if (paramaywa == null) {}
    while ((!(paramaywa.a instanceof MessageForPic)) || (paramaywa.b == 65537)) {
      return;
    }
    MessageForPic localMessageForPic = (MessageForPic)paramaywa.a;
    aune.a("PIC_TAG_PRELOAD", "updateDownState", "Before update, networkType:" + localMessageForPic.preDownNetworkType + ",state:" + localMessageForPic.preDownState + ",uniseq:" + localMessageForPic.uniseq);
    if (paramaywa.g == 1) {
      localMessageForPic.preDownState = 1;
    }
    for (;;)
    {
      aune.a("PIC_TAG_PRELOAD", "updateDownState", "After update, networkType:" + localMessageForPic.preDownNetworkType + ",state:" + localMessageForPic.preDownState + ",uniseq:" + localMessageForPic.uniseq);
    ...
    do
    {
      do
      {
        ...
        do
        {
          ...
          {
            return;
            aune.a("PIC_TAG_PRELOAD", "updateMsg", "uniseq:" + paramMessageForPic.uniseq + ",network:" + paramMessageForPic.preDownNetworkType + "state:" + paramMessageForPic.preDownState);
        ...
        localaxwt.a = paramMessageForPic;
  ...
  public static void b(QQAppInterface paramQQAppInterface, MessageForPic paramMessageForPic)
  {
    ...
    aune.a("PIC_TAG_PRELOAD", "updateDownState4SD", "networkType:" + paramMessageForPic.preDownNetworkType + ",state:" + paramMessageForPic.preDownState + ",uniseq:" + paramMessageForPic.uniseq);
