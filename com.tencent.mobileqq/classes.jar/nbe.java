...
public class nbe
{
  ...
  public static int aG = 35;
  public static int aH = 34;
  public static int aI = 37;
  public static int aJ = 18;
  public static int aK = 38;
  public static int aL = 39;
  public static int aM = 33;
  ...
  public static double a(BaseArticleInfo paramBaseArticleInfo, Context paramContext, String paramString1, String paramString2)
  {
    ...
    SosoInterface.SosoLbsInfo localSosoLbsInfo = akfu.a("readinjoy_feed_ad_distance");
  ...
  public static int a(Context paramContext, nac paramnac)
  {
    if ((paramContext == null) || (paramnac == null)) {}
    do
    {
      ...
      do
      {
        ...
        {
          return -1;
          paramContext = paramnac.jdField_f_of_type_JavaLangString;
          paramnac = paramnac.jdField_d_of_type_JavaLangString;
          if ((!TextUtils.isEmpty(paramContext)) && (!TextUtils.isEmpty(paramnac))) {
            break;
          }
        } while (!QLog.isColorLevel());
        QLog.d("NativeAdUtils", 2, "isPkgDownloading pkg:" + paramContext + ", appid:" + paramnac + " false");
        return -1;
        localDownloadInfo = bcgo.a().a(paramnac);
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("NativeAdUtils", 2, "isPkgDownloading pkg:" + paramContext + ", appid:" + paramnac + " true");
        }
  ...
  public static Dialog a(Context paramContext, String paramString1, String paramString2, View.OnClickListener paramOnClickListener1, String paramString3, View.OnClickListener paramOnClickListener2, String paramString4)
  {
    ...
    TextView localTextView = (TextView)paramContext.findViewById(2131299583);
    ...
    else
    {
      ...
      label72:
      paramString1 = (TextView)paramContext.findViewById(2131299568);
      if (paramString1 != null)
      {
    ...
    for (;;)
    {
      paramString1 = (TextView)paramContext.findViewById(2131299574);
      if (paramString1 != null)
      {
  ...
  public static String a()
  {
    for (;;)
    {
      try
      {
        ...
        Object localObject1 = bgmq.a((AppRuntime)localObject1, true, false);
        if (localObject1 != null) {
  ...
  {
    // Byte code:
    //   0: new 321	org/json/JSONObject
    //   3: dup
    //   4: invokespecial 811	org/json/JSONObject:<init>	()V
    //   7: astore 6
    //   9: invokestatic 841	nox:a	()Ljava/lang/String;
    //   12: astore 5
    //   14: invokestatic 843	nox:c	()Ljava/lang/String;
    //   17: astore 4
    //   19: aload 5
    //   21: invokestatic 319	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   24: ifne +328 -> 352
    //   27: aload 5
    //   29: invokevirtual 848	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   32: astore_3
    //   33: aload 6
    //   35: ldc_w 850
    //   38: aload_3
    //   39: invokestatic 854	bcdu:d	(Ljava/lang/String;)Ljava/lang/String;
    //   42: invokevirtual 848	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   45: invokevirtual 857	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   48: pop
    //   49: aload 6
    //   51: ldc_w 859
    //   54: iconst_1
    //   55: invokevirtual 817	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   58: pop
    //   59: aload 4
    //   61: astore 5
    //   63: aload_3
    ...
    //   69: new 861	yoz
    //   72: dup
    //   73: invokespecial 862	yoz:<init>	()V
    //   76: astore 5
    //   78: aload 5
    //   80: ldc_w 864
    //   83: putfield 865	yoz:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   86: invokestatic 871	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   89: aload 5
    //   91: invokestatic 876	yoy:a	(Landroid/content/Context;Lyoz;)Lypa;
    //   94: astore 5
    //   96: aload 5
    //   98: ifnull +51 -> 149
    //   101: aload 5
    //   103: getfield 881	ypa:a	Ltencent/gdt/qq_ad_get$QQAdGet$DeviceInfo;
    //   106: ifnull +43 -> 149
    //   109: aload 6
    //   111: ldc_w 850
    //   114: aload 5
    //   116: getfield 881	ypa:a	Ltencent/gdt/qq_ad_get$QQAdGet$DeviceInfo;
    //   119: getfield 886	tencent/gdt/qq_ad_get$QQAdGet$DeviceInfo:muid	Lcom/tencent/mobileqq/pb/PBStringField;
    //   122: invokevirtual 890	com/tencent/mobileqq/pb/PBStringField:get	()Ljava/lang/String;
    //   125: invokevirtual 857	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   128: pop
    //   129: aload 6
    //   131: ldc_w 859
    //   134: aload 5
    //   136: getfield 881	ypa:a	Ltencent/gdt/qq_ad_get$QQAdGet$DeviceInfo;
    //   139: getfield 893	tencent/gdt/qq_ad_get$QQAdGet$DeviceInfo:muid_type	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   142: invokevirtual 897	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   145: invokevirtual 817	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   148: pop
    //   149: aload 6
    //   151: ldc_w 899
    //   154: invokestatic 902	myn:a	()I
    //   157: invokevirtual 817	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   160: pop
    //   161: aload 6
    //   163: ldc_w 904
    //   166: aload_0
    //   167: invokestatic 909	vlt:c	(Landroid/content/Context;)Ljava/lang/String;
    //   170: invokevirtual 857	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   173: pop
    //   174: iconst_0
    //   175: istore_1
    //   176: invokestatic 913	babp:e	()I
    //   179: istore_2
    //   180: iload_2
    //   181: istore_1
    //   182: aload 6
    //   184: ldc_w 915
    //   187: iload_1
    //   188: invokevirtual 817	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   191: pop
    //   192: aload 6
    //   194: ldc_w 917
    //   197: invokestatic 919	babp:e	()Ljava/lang/String;
    //   200: invokevirtual 857	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   203: pop
    //   204: aload 6
    //   206: ldc_w 921
    //   209: invokestatic 922	babp:c	()Ljava/lang/String;
    //   212: invokevirtual 857	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   215: pop
    //   216: aload 6
    //   218: ldc_w 924
    //   221: invokestatic 927	com/tencent/common/config/AppSetting:a	()I
    //   224: invokestatic 931	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   227: invokevirtual 857	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   230: pop
    //   231: aload 6
    //   233: ldc_w 933
    //   236: invokestatic 938	dp:a	()J
    //   239: invokestatic 941	dp:a	(J)Ljava/lang/String;
    //   242: invokevirtual 857	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   245: pop
    //   246: aload 6
    //   248: ldc_w 943
    //   251: aload_0
    //   252: invokestatic 946	obz:c	(Landroid/content/Context;)Ljava/lang/String;
    //   255: invokevirtual 857	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   258: pop
    //   259: aload 6
    //   261: ldc_w 948
    //   264: aload_3
    //   265: invokevirtual 857	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   268: pop
    //   269: aload 6
    //   271: ldc_w 950
    //   274: iconst_2
    //   275: invokevirtual 817	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   278: pop
    //   279: aload 6
    //   281: ldc_w 952
    //   284: invokestatic 954	babp:k	()Ljava/lang/String;
    //   287: invokevirtual 857	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   290: pop
    //   291: aload 6
    //   293: ldc_w 956
    //   296: invokestatic 958	babp:i	()Ljava/lang/String;
    //   299: invokevirtual 857	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   302: pop
    //   303: aload 6
    //   305: ldc_w 960
    //   308: invokestatic 962	babp:h	()Ljava/lang/String;
    //   311: invokevirtual 857	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   314: pop
    //   315: aload 6
    //   317: ldc_w 964
    //   320: aload 4
    //   322: invokevirtual 857	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   325: pop
    //   326: aload_0
    //   327: ifnull +22 -> 349
    //   330: aload 6
    //   332: ldc_w 966
    //   335: aload_0
    //   336: invokevirtual 972	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   339: ldc_w 974
    //   342: invokestatic 979	android/provider/Settings$Secure:getString	(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;
    //   345: invokevirtual 857	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   348: pop
    //   349: aload 6
    //   351: areturn
    //   352: aload 4
    //   354: astore_3
    //   355: aload 4
    //   357: invokestatic 319	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   360: ifne +98 -> 458
    //   363: aload 4
    //   365: ldc_w 981
    //   368: ldc_w 754
    //   371: invokevirtual 984	java/lang/String:replaceAll	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   374: invokevirtual 987	java/lang/String:toUpperCase	()Ljava/lang/String;
    //   377: astore_3
    //   378: aload 6
    //   380: ldc_w 850
    //   383: aload_3
    //   384: invokestatic 854	bcdu:d	(Ljava/lang/String;)Ljava/lang/String;
    //   387: invokevirtual 848	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   390: invokevirtual 857	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   393: pop
    //   394: aload 6
    //   396: ldc_w 859
    //   399: iconst_3
    //   400: invokevirtual 817	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   403: pop
    //   404: goto +54 -> 458
    //   407: astore_0
    //   408: ldc_w 343
    //   411: iconst_1
    //   412: new 345	java/lang/StringBuilder
    //   415: dup
    //   416: invokespecial 347	java/lang/StringBuilder:<init>	()V
    //   419: ldc_w 989
    //   422: invokevirtual 353	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   425: aload_0
    //   426: invokevirtual 990	java/lang/Exception:toString	()Ljava/lang/String;
    //   429: invokevirtual 353	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   432: invokevirtual 366	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   435: invokestatic 369	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   438: aload 6
    //   440: areturn
    //   441: astore_0
    //   442: aload_0
    //   443: invokevirtual 991	java/lang/Exception:printStackTrace	()V
    //   446: aconst_null
    //   447: areturn
    //   448: astore 5
    //   450: goto -268 -> 182
  ...
  public static JSONObject a(AdData paramAdData, HashMap<String, Object> paramHashMap)
  {
    try
    {
      ...
      if (paramAdData != null)
      {
        ...
        if (npa.a(paramAdData))
        {
          localJSONObject.put("game_component_type", paramAdData.jdField_a_of_type_Nmo.x);
          localJSONObject.put("game_pkg", paramAdData.jdField_a_of_type_Nmo.jdField_b_of_type_JavaLangString);
        }
  ...
  public static void a(Activity paramActivity, nac paramnac, bcgn parambcgn)
  {
    if ((paramActivity == null) || (paramnac == null)) {}
    String str1;
    String str2;
    String str3;
    do
    {
      return;
      str1 = paramnac.jdField_f_of_type_JavaLangString;
      str2 = paramnac.jdField_d_of_type_JavaLangString;
      str3 = paramnac.jdField_j_of_type_JavaLangString;
      paramnac = paramnac.i;
    } while ((TextUtils.isEmpty(str1)) || (TextUtils.isEmpty(str2)) || (TextUtils.isEmpty(str3)) || (TextUtils.isEmpty(paramnac)));
    Bundle localBundle = new Bundle();
    localBundle.putString(bcgl.jdField_f_of_type_JavaLangString, str1);
    localBundle.putString(bcgl.jdField_b_of_type_JavaLangString, str2);
    localBundle.putString(bcgl.jdField_j_of_type_JavaLangString, str3);
    localBundle.putString(bcgl.jdField_l_of_type_JavaLangString, paramnac);
    ...
    if (QLog.isColorLevel()) {
      QLog.d("NativeAdUtils", 2, "downloadApk pkg:" + str1 + ", appid:" + str2 + ", name:" + paramnac + ", url:" + str3);
    }
    if (parambcgn != null) {
      bcgo.a().a(parambcgn);
    }
  ...
  private static void a(Context paramContext)
  {
    ...
    while ((paramContext == null) || (!badq.g(paramContext))) {
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.d("NativeAdUtils", 2, "getADPosition doStartADLocation network is Available...");
    }
    akfu.a(new nbi("readinjoy_feed_ad_distance"));
    aN += 1;
  }
  ...
  {
    if (npi.a(paramAdData))
    {
      a(new nmv().a(paramQQAppInterface).a(BaseApplication.getContext()).a(jdField_b_of_type_Int).b(a(paramAdData)).a(npk.a(paramAdData)).d(a(paramAdData)).a());
      return;
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, AdData paramAdData, float paramFloat, long paramLong)
  {
    ...
    try
    {
      ...
      if (npi.a(paramAdData))
      {
        a(new nmv().a(paramQQAppInterface).a(BaseApplication.getContext()).a(jdField_b_of_type_Int).b(a(paramAdData)).a(npk.a(paramAdData)).c(localJSONObject).d(a(paramAdData)).a());
        return;
      }
    }
    catch (JSONException localJSONException)
  ...
  {
    if (npi.a(paramAdData, false))
    {
      a(new nmv().a(paramQQAppInterface).a(BaseApplication.getContext()).a(jdField_a_of_type_Int).b(K).a(npk.a(paramAdData)).d(a(paramAdData)).d(paramInt).a());
      return;
    }
  ...
  {
    awqx.b(paramQQAppInterface, "dc04719", "ad", "0", paramString1.toUpperCase(), paramString2.toUpperCase(), paramInt1, paramInt2, paramString3, paramString4, paramString5, paramString6);
  }
  ...
  public static void a(nmt paramnmt)
  {
    if (paramnmt == null) {}
    ...
    {
      return;
      AppInterface localAppInterface = paramnmt.a();
      localContext = paramnmt.a();
      i1 = paramnmt.a();
      i2 = paramnmt.b();
      localAdvertisementInfo = paramnmt.a();
      localVideoAdInfo = paramnmt.a();
      l1 = paramnmt.a();
      str = paramnmt.a();
      localJSONObject1 = paramnmt.a();
      i3 = paramnmt.d();
      localJSONObject2 = paramnmt.b();
      localBundle = paramnmt.a();
      localJSONObject3 = paramnmt.c();
      localJSONObject4 = paramnmt.d();
      localJSONObject5 = paramnmt.f();
      localJSONObject6 = paramnmt.e();
      i4 = paramnmt.c();
      bool = paramnmt.a();
      paramnmt = localAppInterface;
        ...
        if (BaseApplicationImpl.sProcessId == 1)
        {
          ...
          if (localAppRuntime != null)
          {
            ...
            if ((localAppRuntime instanceof QQAppInterface)) {
              paramnmt = (QQAppInterface)localAppRuntime;
            }
          }
        }
      }
    } while (paramnmt == null);
    ThreadManager.post(new NativeAdUtils.3(localJSONObject3, paramnmt.getAccount(), i1, i2, i4, localContext, localAdvertisementInfo, localVideoAdInfo, i3, localJSONObject1, localJSONObject2, localBundle, str, l1, localJSONObject4, localJSONObject6, localJSONObject5, paramnmt, bool), 5, null, true);
  }
  ...
  public static boolean a(Context paramContext, String paramString)
  {
    ...
    {
      return bool1;
      bool2 = bady.a(paramContext, paramString);
      bool1 = bool2;
    } while (!QLog.isColorLevel());
  ...
  public static boolean a(Context paramContext, nac paramnac)
  {
    ...
    do
    {
      ...
      paramnac = localDownloadInfo.jdField_l_of_type_JavaLangString;
      bool1 = bool3;
      if (!TextUtils.isEmpty(paramnac))
      {
        bool1 = bool3;
        if (new File(paramnac).exists()) {
          bool1 = true;
        }
      }
      bool2 = bool1;
    } while (!QLog.isColorLevel());
    QLog.d("NativeAdUtils", 2, "isPkgExist(" + bool1 + ") pkg:" + str1 + ", appid:" + str2 + ", path:" + paramnac);
    return bool1;
  ...
  public static boolean a(nac paramnac)
  {
    String str1 = paramnac.jdField_f_of_type_JavaLangString;
    String str2 = paramnac.jdField_d_of_type_JavaLangString;
    String str3 = paramnac.jdField_j_of_type_JavaLangString;
    paramnac = paramnac.i;
    Bundle localBundle = new Bundle();
    ...
    localBundle.putString(bcgl.jdField_l_of_type_JavaLangString, paramnac);
    if (QLog.isColorLevel()) {
      QLog.d("NativeAdUtils", 2, "installApk pkg:" + str1 + ", appid:" + str2 + ", name:" + paramnac + ", url:" + str3);
    }
    return bcgh.a(localBundle);
  }
    ...
    for (;;)
    {
      ...
      if (paramBaseArticleInfo.mLocalInfo != null) {
        try
        {
          ...
          double d1 = nbj.a(paramBaseArticleInfo.mLocalInfo.jdField_e_of_type_JavaLangString, 0.0D);
          double d2 = nbj.a(str, 0.0D);
          if ((d2 != 0.0D) || (d1 != 0.0D)) {
  ...
  private static JSONObject b(Context paramContext)
  {
    ...
    for (;;)
    {
      try
      {
        localJSONObject.put("dma", nox.c());
        localJSONObject.put("hwm", babp.i());
        localJSONObject.put("hwma", babp.h());
        localJSONObject.put("osver", babp.e());
        localJSONObject.put("imei", nox.a());
        localJSONObject.put("brd", babp.k());
        localJSONObject.put("ns", mpl.a());
        ...
        localJSONObject.put("wn", vlt.c(paramContext));
        str = "";
        switch (aizc.b())
        {
        case 1: 
          localJSONObject.put("mnc", str);
          localJSONObject.put("rma", obz.c(paramContext));
          return localJSONObject;
        }
      }
      ...
      str = ajjy.a(2131641281);
      continue;
      str = ajjy.a(2131641279);
      continue;
      str = ajjy.a(2131641277);
    }
  }
  ...
  private static void b(int paramInt, AdvertisementInfo paramAdvertisementInfo, VideoAdInfo paramVideoAdInfo)
  {
    if (paramInt == jdField_b_of_type_Int)
    {
      ...
      yof.a(0, 1, rvb.a(paramAdvertisementInfo));
    }
    label270:
    label271:
    label379:
    do
    {
      do
      {
        ...
        if (paramInt == jdField_a_of_type_Int)
        {
          ...
          yof.a(1, 1, rvb.a(paramAdvertisementInfo));
        }
        for (;;)
        {
          if (paramInt == E)
          {
            ...
            yof.a(2, 1, rvb.a(paramAdvertisementInfo));
          }
          return;
          ...
          yof.a(0, 1, rvb.a(localAdvertisementInfo));
          break;
          if ((paramVideoAdInfo != null) && (paramVideoAdInfo.jdField_o_of_type_Int == 1))
          {
            ...
            if ((localAdvertisementInfo != null) && (localAdvertisementInfo.mC2SSwitch == 1))
            {
              ...
              yof.a(1, 1, rvb.a(localAdvertisementInfo));
            }
          }
        }
  ...
  public static void b(QQAppInterface paramQQAppInterface, AdData paramAdData)
  {
    if (npi.a(paramAdData))
    {
      a(new nmv().a(paramQQAppInterface).a(BaseApplication.getContext()).a(jdField_l_of_type_Int).b(a(paramAdData)).a(npk.a(paramAdData)).d(a(paramAdData)).a());
      return;
    }
