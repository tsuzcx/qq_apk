...
public final class amzw
  implements anag, Handler.Callback, INetInfoHandler
{
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private amzx jdField_a_of_type_Amzx;
  ...
  public amzw(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    if (this.jdField_a_of_type_Amzx == null)
    {
    ...
    ((CmGameMsgTunnel.TunnelMsgStream)localObject).mqqver.set("8.4.5");
    ...
    ((CmGameMsgTunnel.TunnelMsgStream)localObject).distribute_ts.set(this.jdField_a_of_type_Amzx.jdField_a_of_type_Long);
    ...
    ((CmGameMsgTunnel.TunnelMsgStream)localObject).sign.set(this.jdField_a_of_type_Amzx.b);
    ...
    try
    {
      paramString = anbd.a(paramString, this.jdField_a_of_type_Amzx.jdField_a_of_type_JavaLangString);
  ...
  {
    ((amsx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a().a(paramTunnelMsgStream);
  }
  ...
  private boolean b()
  {
    ...
    if ((this.jdField_a_of_type_Amzx.jdField_a_of_type_JavaUtilList == null) || (this.jdField_a_of_type_Amzx.jdField_a_of_type_JavaUtilList.size() == 0))
    {
      QLog.e("CmGameConnManager", 1, "[createConnection] no connection host");
      return false;
    }
    anai localanai = new anai();
    localanai.jdField_a_of_type_JavaUtilList = this.jdField_a_of_type_Amzx.jdField_a_of_type_JavaUtilList;
    localanai.jdField_a_of_type_Int = this.jdField_a_of_type_Amzx.jdField_a_of_type_Int;
    localanai.b = 10000;
    localanai.c = 3000;
    if (this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection == null) {
      this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection = new CmGameSocketConnection(localanai);
    }
    for (;;)
    {
      ...
      return true;
      this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection.a(localanai);
    }
  }
  ...
  private void f()
  {
    for (;;)
    {
      try
      {
        ...
        this.b = true;
        if (!bhnv.e(BaseApplicationImpl.getApplication().getApplicationContext()))
        {
        ...
        {
          ((VasExtensionHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(71)).e();
        }
      }
      finally {}
    }
  ...
  public void a(amzx paramamzx)
  {
    ...
    for (;;)
    {
      return;
      if (this.jdField_a_of_type_Boolean) {
        this.jdField_a_of_type_Amzx = paramamzx;
      }
  ...
  public void a(MsfSocketInputBuffer paramMsfSocketInputBuffer)
  {
    ...
    if (s == 6)
    {
      ...
      paramMsfSocketInputBuffer = this.jdField_a_of_type_Blhq.obtainMessage(5);
      paramMsfSocketInputBuffer.obj = Boolean.valueOf(true);
      this.jdField_a_of_type_Blhq.sendMessage(paramMsfSocketInputBuffer);
      return;
    }
    ...
    try
    {
      paramMsfSocketInputBuffer = anbd.b((byte[])localObject, this.jdField_a_of_type_Amzx.jdField_a_of_type_JavaLangString);
  ...
  {
    boolean bool = bhnv.e(BaseApplicationImpl.getApplication().getApplicationContext());
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean1)
    {
      this.jdField_a_of_type_Blhq.removeMessages(7);
      this.jdField_a_of_type_Blhq.sendEmptyMessageDelayed(7, 130000L);
      a("page_tag_match");
      if ((a()) && (paramBoolean2)) {
        a();
      }
  ...
  public void b()
  {
    QLog.d("CmGameConnManager", 1, new Object[] { "[onGetConnInfoFailed] mShouldKeepConnect=", Boolean.valueOf(this.jdField_a_of_type_Boolean), ", mConnInfo=", this.jdField_a_of_type_Amzx });
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Amzx != null)) {}
  ...
  public void b(String paramString)
  {
    try
    {
      ...
      if (this.jdField_a_of_type_JavaUtilList.size() == 0)
      {
        this.jdField_a_of_type_Blhq.removeMessages(1);
        this.jdField_a_of_type_Blhq.removeMessages(2);
        this.jdField_a_of_type_Blhq.sendEmptyMessageDelayed(2, 2000L);
      }
      return;
    }
    finally
  ...
  public void d()
  {
    ...
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Int <= 2))
    {
      ...
      this.jdField_a_of_type_Blhq.removeMessages(1);
      this.jdField_a_of_type_Blhq.sendEmptyMessageDelayed(1, 10000L);
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 5: 
      ...
      if ((paramMessage.obj != null) && (((Boolean)paramMessage.obj).booleanValue()))
      {
        ...
        this.jdField_a_of_type_Amzx = null;
      }
      i();
      return false;
    case 7: 
  ...
  public void onNetMobile2Wifi(String paramString)
  {
    ...
    this.jdField_a_of_type_Blhq.removeMessages(5);
    this.jdField_a_of_type_Blhq.sendEmptyMessage(5);
  }
