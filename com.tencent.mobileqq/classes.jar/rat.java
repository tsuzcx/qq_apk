...
public class rat
{
  ...
  private static volatile rat jdField_a_of_type_Rat;
  public static int b;
  ...
  private rat()
  {
    this.jdField_a_of_type_Rax = new rax(this);
    ...
    try
    {
      String str = (String)bmqa.a(jdField_a_of_type_JavaLangString, "");
      Object localObject2;
      ...
      Object localObject1 = (String)bmqa.a(jdField_b_of_type_JavaLangString, "");
    ...
    catch (NumberFormatException localNumberFormatException)
    {
      ...
      bmqa.a(jdField_a_of_type_JavaLangString, "");
      bmqa.a(jdField_b_of_type_JavaLangString, "");
    }
  }
  ...
  public static rat a()
  {
    if (jdField_a_of_type_Rat == null) {}
    try
    {
      if (jdField_a_of_type_Rat == null) {
        jdField_a_of_type_Rat = new rat();
      }
      return jdField_a_of_type_Rat;
    }
    finally {}
  }
  ...
  private void a(AbsListView paramAbsListView, boolean paramBoolean)
  {
    ...
    {
      localObject1 = (rau)this.jdField_a_of_type_JavaUtilList.get(((Integer)this.jdField_b_of_type_JavaUtilHashMap.get(str)).intValue());
      l3 = ((rau)localObject1).jdField_b_of_type_Long;
      if (i1 <= 0) {
        break label521;
      }
    }
    ...
    {
      ((rau)localObject1).jdField_b_of_type_Long = (l2 + l3);
      localObject2 = a(localView);
      if ((localObject2 != null) && (localObject2[1] - localObject2[0] >= localView.getHeight() * jdField_a_of_type_Double)) {
        ((rau)localObject1).jdField_c_of_type_Long += l1;
      }
      ((rau)localObject1).jdField_c_of_type_Boolean = this.jdField_a_of_type_JavaUtilHashMap.containsKey(str);
      if (!paramBoolean) {
        break;
      }
      ((rau)localObject1).jdField_b_of_type_Boolean = true;
      break;
      localObject1 = new rau(this);
      ((rau)localObject1).jdField_a_of_type_JavaLangString = str;
      ((rau)localObject1).jdField_a_of_type_Int = pha.a((BaseArticleInfo)localObject2);
      int m;
      label305:
      boolean bool;
      ...
      {
        m = 0;
        ((rau)localObject1).jdField_b_of_type_Int = m;
        if (this.jdField_g_of_type_Long != -1L) {
          break label504;
        }
        bool = true;
        label326:
        ((rau)localObject1).jdField_a_of_type_Boolean = bool;
        ((rau)localObject1).jdField_c_of_type_Int = localView.getHeight();
        ((rau)localObject1).jdField_b_of_type_JavaLangString = ((BaseArticleInfo)localObject2).mRecommentdReason;
        m = this.j;
        this.j = (m + 1);
        ((rau)localObject1).jdField_d_of_type_Int = m;
        localObject2 = phl.a().a();
      ...
      label504:
      label510:
      for (((rau)localObject1).jdField_c_of_type_JavaLangString = (localObject2[0] + "_" + localObject2[1] + "_" + localObject2[2] + "_" + localObject2[3]);; ((rau)localObject1).jdField_c_of_type_JavaLangString = "NULL")
      {
  ...
  private void e()
  {
    ...
    if (this.jdField_b_of_type_ArrayOfInt != null)
    {
      ...
      bmqa.a(jdField_b_of_type_JavaLangString, str);
    }
    if (this.jdField_a_of_type_JavaUtilArrayList.size() > 0)
    {
      ...
      bmqa.a(jdField_a_of_type_JavaLangString, str);
    }
  }
  
  public long a()
  {
    if (this.jdField_a_of_type_Rax.jdField_a_of_type_Long == 0L) {
      return this.jdField_e_of_type_Long;
    }
    return this.jdField_a_of_type_Rax.jdField_a_of_type_Long - this.jdField_a_of_type_Long;
  }
  ...
  public void a()
  {
    ...
    if ((this.jdField_d_of_type_Long != 0L) && (!TextUtils.isEmpty(this.jdField_c_of_type_JavaLangString)) && (this.jdField_b_of_type_JavaUtilHashMap.containsKey(this.jdField_c_of_type_JavaLangString)))
    {
      ...
      rau localrau = (rau)this.jdField_a_of_type_JavaUtilList.get(k);
      localrau.jdField_a_of_type_Long = (l + localrau.jdField_a_of_type_Long);
  ...
  public void a(AbsListView paramAbsListView, int paramInt)
  {
    ...
    this.i = bclx.a(paramAbsListView.getContext());
    ((ReadInJoyXListView)paramAbsListView).a(this.jdField_a_of_type_Rax);
  ...
  public long b()
  {
    if (this.jdField_a_of_type_Rax.jdField_b_of_type_Long == 0L) {
      return this.jdField_e_of_type_Long;
    }
    return this.jdField_c_of_type_Long - this.jdField_a_of_type_Rax.jdField_b_of_type_Long;
  }
  ...
  public void c()
  {
    ...
    new pyq(null, null, null, qnd.a(), null).a(this, BaseApplication.getContext());
    e();
    this.jdField_a_of_type_MqqUtilWeakReference = null;
    jdField_a_of_type_Rat = null;
  }
