...
public class awxf
{
  ...
  public awwm a;
  protected awxc a;
  private awxi jdField_a_of_type_Awxi = new awxg(this);
  ...
  public awxf(LyricView paramLyricView)
  {
    ...
    this.jdField_a_of_type_Awxc = new awxc();
    ...
    this.jdField_a_of_type_ComTencentMobileqqLyricWidgetLyricViewScroll.setScrollListener(this.jdField_a_of_type_Awxi);
  }
  
  private void d()
  {
    this.jdField_a_of_type_Awwm = this.jdField_a_of_type_ComTencentMobileqqLyricWidgetLyricViewInternal.a();
    awwm localawwm = this.jdField_a_of_type_Awwm;
    if ((localawwm == null) || (localawwm.a()) || (this.jdField_a_of_type_Boolean))
    {
  ...
  public void a()
  {
    ...
    awwr.a().post(new LyricViewController.4(this));
  ...
  public void a(int paramInt)
  {
    ...
    awwr.a().post(new LyricViewController.5(this, paramInt));
  }
  ...
  public void a(awwm paramawwm1, awwm paramawwm2, awwm paramawwm3)
  {
    Log.v("ModuleController", "setLyric begin");
    awwr.a().post(new LyricViewController.3(this, paramawwm3, paramawwm1, paramawwm2));
  }
  ...
  protected void b(int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_Awwm != null) || (this.jdField_a_of_type_ComTencentMobileqqLyricWidgetLyricViewInternal != null))
    {
    ...
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_Awwm.a.size()))
    {
      if (this.jdField_a_of_type_Awwm.a.get(paramInt) == null)
      {
        Log.w("ModuleController", "onScrollStop -> current sentence is null");
        return;
      }
      long l2 = ((awwo)this.jdField_a_of_type_Awwm.a.get(paramInt)).jdField_a_of_type_Long;
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_Awxc.a(l1);
  ...
  protected void c(int paramInt)
  {
    ...
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_Awwm.a.size()))
    {
      ...
      for (;;)
      {
        ...
        l1 = l2 / 10L;
        this.jdField_a_of_type_Awxc.b((l1 + 1L) * 10L);
        return;
        label178:
        l1 = l2;
        if (this.jdField_b_of_type_Int >= 0)
