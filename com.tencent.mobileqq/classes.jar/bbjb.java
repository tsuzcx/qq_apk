...
public class bbjb
{
  private long jdField_a_of_type_Long = (int)ayxc.a();
  ...
  public bbjb a(long paramLong)
  {
    this.jdField_a_of_type_Long = paramLong;
    return this;
  }
  
  public bbjb a(boolean paramBoolean)
  {
  ...
  public Pair<ArrayList<String>, ArrayList<String>> a(List<String> paramList, boolean paramBoolean, Map<String, LocalMediaInfo> paramMap1, Map<String, LocalMediaInfo> paramMap2)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      else
      {
        ...
        {
          int i = bbbj.a((LocalMediaInfo)localObject);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        for (paramMap1 = paramContext.getResources().getString(2131689881);; paramMap1 = paramContext.getResources().getString(2131689882))
        {
          ...
          bfnh.a(new SendByFile.1(this, paramContext, paramMap1));
