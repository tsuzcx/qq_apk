  ...
  extends ViewModel
{
  ...
  @NotNull
  private final MutableLiveData<amfe> a;
  
  static
  {
    jdField_a_of_type_Amey = new amey(null);
  }
  ...
  @NotNull
  public final MutableLiveData<amfe> a()
  {
  ...
  public final void a(int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidArchLifecycleMutableLiveData.postValue(new amfe(2, null, null, null, paramInt, 0, 46, null));
  }
  ...
  public final void a(@NotNull String paramString)
  {
    ...
    LbsManagerService.startLocation((LbsManagerService.OnLocationChangeListener)new amfa(this, paramString, "qq_weather", false));
  }
  ...
  public final void a(@Nullable AppActivity paramAppActivity, @NotNull String paramString)
  {
    ...
    {
      paramAppActivity.requestPermissions(new amez(this, paramString), 1, new String[] { "android.permission.ACCESS_FINE_LOCATION" });
      return;
    }
    a(paramString);
  }
  ...
  public final void b(@Nullable String paramString)
  {
    ...
    try
    {
      ...
      if (localJSONObject.optInt("type") == 1)
      {
        ...
        this.jdField_a_of_type_AndroidArchLifecycleMutableLiveData.postValue(new amfe(0, "receive_ark_msg", paramString, null, 0, i, 24, null));
        return;
      }
    }
    ...
    try
    {
      ...
      if (((JSONObject)localObject).optInt("type") == 1)
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject))
        {
          ...
          localMutableLiveData.postValue(new amfe(1, null, null, (String)localObject, 0, 0, 54, null));
        }
      }
      return;
    }
