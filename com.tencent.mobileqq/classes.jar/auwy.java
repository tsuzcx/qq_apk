  ...
  implements Manager
{
  ...
  private auxa jdField_a_of_type_Auxa;
  private NearbyAppInterface jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface;
  private final List<auwz> jdField_a_of_type_JavaUtilList = new ArrayList();
  private MqqHandler jdField_a_of_type_MqqOsMqqHandler;
  private boolean[] jdField_a_of_type_ArrayOfBoolean;
  private final List<auwz> jdField_b_of_type_JavaUtilList = new ArrayList();
  private MqqHandler jdField_b_of_type_MqqOsMqqHandler;
  
  public auwy(NearbyAppInterface paramNearbyAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface = paramNearbyAppInterface;
    this.jdField_a_of_type_Auxa = new auxa(paramNearbyAppInterface, this);
  ...
  {
    return this.jdField_a_of_type_Auxa.a(paramInt);
  }
  
  private Message b(Message paramMessage)
  {
    return this.jdField_a_of_type_Auxa.a(paramMessage);
  }
  
  private Object[] b(int paramInt, Object... paramVarArgs)
  {
    return this.jdField_a_of_type_Auxa.a(paramInt, paramVarArgs);
  }
  
  public int a()
  {
    Object[] arrayOfObject = this.jdField_a_of_type_Auxa.a(4156);
  ...
  public Message a(Message paramMessage)
  {
    ...
    ((bcxl)this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.getManager(216)).a(FaceInfo.a(i, (String)localObject, j, 3));
    return null;
  }
  ...
  public avoi a()
  {
    ...
    try
    {
      localavoi.a = ((Integer)arrayOfObject[0]).intValue();
      localavoi.b = ((Integer)arrayOfObject[1]).intValue();
      localavoi.c = ((Integer)arrayOfObject[2]).intValue();
      localavoi.d = ((Integer)arrayOfObject[3]).intValue();
      return localavoi;
    }
    catch (Exception localException)
    {
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    ...
    //   1: istore 4
    //   3: aload_0
    //   4: getfield 28	auwy:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   7: astore 5
    //   9: aload 5
    //   11: monitorenter
    //   12: iconst_0
    ...
    //   14: iload_3
    //   15: aload_0
    //   16: getfield 28	auwy:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   19: invokeinterface 290 1 0
    //   24: if_icmpge +45 -> 69
    //   27: aload_0
    //   28: getfield 28	auwy:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   31: iload_3
    //   32: invokeinterface 293 2 0
    //   37: checkcast 295	auwz
    //   40: astore 6
    //   42: aload_0
    //   43: getfield 45	auwy:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    ...
    //   53: iload_1
    //   54: aload_2
    //   55: invokespecial 300	com/tencent/mobileqq/nearby/ipc/NearbyProcManager$1:<init>	(Lauwy;Lauwz;I[Ljava/lang/Object;)V
    ...
    //   71: monitorexit
    //   72: aload_0
    //   73: getfield 26	auwy:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   76: astore 5
    //   78: aload 5
    //   80: monitorenter
    //   81: iload 4
    ...
    //   84: iload_3
    //   85: aload_0
    //   86: getfield 26	auwy:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   89: invokeinterface 290 1 0
    //   94: if_icmpge +51 -> 145
    //   97: aload_0
    //   98: getfield 26	auwy:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   101: iload_3
    //   102: invokeinterface 293 2 0
    //   107: checkcast 295	auwz
    //   110: astore 6
    //   112: aload_0
    //   113: getfield 50	auwy:jdField_b_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    ...
    //   123: iload_1
    //   124: aload_2
    //   125: invokespecial 309	com/tencent/mobileqq/nearby/ipc/NearbyProcManager$2:<init>	(Lauwy;Lauwz;I[Ljava/lang/Object;)V
  ...
  public void a(auwz paramauwz, boolean paramBoolean)
  {
    if (paramauwz == null) {
      return;
    }
    if (paramBoolean) {
      ...
      {
        if (!this.jdField_a_of_type_JavaUtilList.contains(paramauwz)) {
          this.jdField_a_of_type_JavaUtilList.add(paramauwz);
        }
        return;
      }
    }
    ...
    {
      if (!this.jdField_b_of_type_JavaUtilList.contains(paramauwz)) {
        this.jdField_b_of_type_JavaUtilList.add(paramauwz);
      }
      return;
    }
  }
  ...
  public void a(oidb_0x8dd.SelfInfo paramSelfInfo)
  {
    ...
    try
    {
      ...
      if (localObject1 == null)
      {
        ...
        ausq.a("Q.nearby", "updateSelfCard", new Object[] { paramSelfInfo, localObject1 });
        return;
      }
    }
    catch (Exception localException)
  ...
  public boolean a()
  {
    return this.jdField_a_of_type_Auxa.a();
  }
  ...
  public boolean a(int paramInt, boolean paramBoolean)
  {
    boolean bool1 = false;
    Object localObject = null;
    SharedPreferences localSharedPreferences = aush.a("nearby_event_file", this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.getAccount(), 4);
      ...
      for (;;)
      {
        for (;;)
        {
          try
          {
            ...
            if (QLog.isColorLevel()) {
              ausq.a("onGetMyTabConfig", new Object[] { Boolean.valueOf(bool2), Integer.valueOf(paramInt), Boolean.valueOf(paramBoolean) });
            }
            return bool1;
          }
          ...
          catch (Exception localException)
          {
            ...
            {
              localException.printStackTrace();
              ausq.a("onGetMyTabConfig", new Object[] { "save config", Integer.valueOf(paramInt), localException.toString() });
            }
            bool1 = true;
          }
        }
  ...
  public Object[] a(int paramInt, Object... paramVarArgs)
  {
    ...
    case 4146: 
      do
      {
        do
        {
          do
          {
            do
            {
              for (;;)
              {
                ...
                if ((paramVarArgs != null) && (paramVarArgs.length == 1) && ((paramVarArgs[0] instanceof Integer)))
                {
                  ...
                  if (QLog.isColorLevel())
                  {
                    ausq.a("MSG_NOTIFY_HAS_UNREAD_MSG", new Object[] { Integer.valueOf(paramInt) });
                    return null;
                        ...
                        if ((paramVarArgs != null) && (paramVarArgs.length == 2))
                        {
                          ...
                          if ((paramVarArgs != null) && (paramVarArgs.length == 1))
                          {
                            ...
                            if ((paramVarArgs != null) && (paramVarArgs.length == 1))
                            {
                              a(4116, paramVarArgs);
                              return null;
                              avpw.a(this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface, 0, true);
                              return null;
            ...
            return null;
            ((aogb)this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.getManager(210)).a();
            return null;
        ...
        try
        {
          ...
          ((ausf)this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.getManager(219)).a(l, paramInt, i, j);
          return null;
        }
        catch (Exception paramVarArgs)
        {
      ...
      ((alta)this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.a(3)).a(paramInt, i);
      return null;
    case 4159: 
      a(4159, new Object[0]);
      return null;
  ...
  public int b()
  {
    Object[] arrayOfObject = b(4163, new Object[] { aljq.I });
    try
    {
      int i = ((Integer)arrayOfObject[0]).intValue();
      if (QLog.isColorLevel()) {
  ...
  public void b(auwz paramauwz)
  {
    ...
    {
      if (this.jdField_b_of_type_JavaUtilList.contains(paramauwz)) {
        this.jdField_b_of_type_JavaUtilList.remove(paramauwz);
      }
    }
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      if (this.jdField_a_of_type_JavaUtilList.contains(paramauwz)) {
        this.jdField_a_of_type_JavaUtilList.remove(paramauwz);
      }
      return;
      paramauwz = finally;
      throw paramauwz;
  ...
  {
    b();
    this.jdField_a_of_type_Auxa = null;
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
