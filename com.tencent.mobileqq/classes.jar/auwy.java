...
public class auwy
  implements View.OnClickListener, auxb
{
  ...
  public auwy(boolean paramBoolean)
  {
    this.c = paramBoolean;
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramCommTaskInfo.getAccount().equalsIgnoreCase(paramCard.uin))
        {
          ...
          axqw.b(null, "dc00898", "", "", "qq_vip", "0X800A7D6", i, 0, "", "", "", "");
          return;
        }
        ...
        {
          i = k;
          axqw.b(null, "dc00898", "", paramCommTaskInfo, "qq_vip", "0X800A7DC", i, 0, "", "", "", "");
          return;
        }
      }
  ...
  public static boolean a(auuw paramauuw)
  {
    ...
    if (paramauuw.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Int == 0) {
      if (paramauuw.jdField_a_of_type_ComTencentMobileqqDataCard.switch_musicbox == 0)
      {
        i = 1;
        axqw.b(null, "dc00898", "", "", "0X800A7DB", "qq_vip", i, 0, "", "", "", "");
        if (paramauuw.jdField_a_of_type_ComTencentMobileqqDataCard.switch_musicbox != 0) {
          break label63;
        }
      }
    ...
    do
    {
      ...
      break;
      return false;
      bool1 = paramauuw.jdField_a_of_type_ComTencentMobileqqDataCard.isVipOpen(EVIPSPEC.E_SP_SUPERVIP);
      bool2 = paramauuw.jdField_a_of_type_ComTencentMobileqqDataCard.isVipOpen(EVIPSPEC.E_SP_BIGCLUB);
    } while ((paramauuw.jdField_a_of_type_ComTencentMobileqqDataCard.switch_musicbox == 0) && (!TextUtils.isEmpty(paramauuw.jdField_a_of_type_ComTencentMobileqqDataCard.songId)) && ((bool1) || (bool2)));
    return false;
  }
  ...
  public static void b(Context paramContext, String paramString)
  {
    ...
    paramString = bfng.a(amzq.a().jdField_b_of_type_JavaLangString, "uin", paramString);
  ...
  public View a(Context paramContext, String paramString)
  {
    ...
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(paramContext).inflate(2131561621, null);
    this.jdField_a_of_type_AndroidViewView.setOnClickListener(this);
    if (this.c)
    {
      this.jdField_a_of_type_AndroidViewView.findViewById(2131368109).setOnClickListener(this);
      this.jdField_a_of_type_AndroidViewView.findViewById(2131376458).setOnClickListener(this);
      this.jdField_a_of_type_ComTencentWidgetAlphaClickableImageView = ((AlphaClickableImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376458));
      this.jdField_a_of_type_AndroidViewView.findViewById(2131376319).setVisibility(8);
    }
    for (;;)
    {
      a(2);
      this.jdField_a_of_type_Int = actn.a(35.0F, paramContext.getResources());
      if (this.jdField_a_of_type_Auwz == null) {
        this.jdField_a_of_type_Auwz = ListenTogetherManager.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a();
      }
      this.jdField_a_of_type_Auwz.a(this);
      return this.jdField_a_of_type_AndroidViewView;
      this.jdField_a_of_type_AndroidViewView.findViewById(2131376319).setOnClickListener(this);
  ...
  public void a()
  {
    ...
    ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131377183)).setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
    if ((this.d) && (!this.c)) {
      this.jdField_a_of_type_AndroidViewView.findViewById(2131376319).setVisibility(8);
    }
  }
  ...
  public void a(int paramInt)
  {
    if (this.c)
    {
      if (paramInt == 1)
      {
        this.jdField_a_of_type_ComTencentWidgetAlphaClickableImageView.setImageResource(2130843991);
    ...
    TextView localTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376319);
    localTextView.setCompoundDrawablePadding(bbkx.b(4.0F));
    if (paramInt == 1)
    {
      localTextView.setCompoundDrawablesWithIntrinsicBounds(2130849171, 0, 0, 0);
      return;
    }
    localTextView.setCompoundDrawablesWithIntrinsicBounds(2130849172, 0, 0, 0);
  }
  
  public void a(Context paramContext, String paramString)
  {
    Intent localIntent = new Intent(paramContext, QQBrowserActivity.class);
    localIntent.putExtra("url", bfng.a(amzq.a().jdField_a_of_type_JavaLangString, "uin", paramString));
    paramContext.startActivity(localIntent);
    int i = 2;
    if (a()) {
      if (!this.d) {}
    ...
    for (;;)
    {
      axqw.b(null, "dc00898", "", "", "qq_vip", "0X800A7D7", i, 0, "", "", "", "");
      return;
      i = 1;
      continue;
      i = 3;
  ...
  {
    Object localObject = paramauuw.jdField_a_of_type_ComTencentMobileqqDataCard;
    ...
    for (bool1 = true;; bool1 = false)
    {
      ...
      a(true);
      localObject = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131377183);
      if (paramauuw.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Int != 0)
      {
        this.f = false;
        ((TextView)localObject).setText(ProfileCardMoreInfoView.a(paramauuw) + ((TextView)localObject).getContext().getResources().getString(2131695492));
      }
    ...
    for (;;)
    {
      a(this.jdField_a_of_type_ComTencentMobileqqMusicSongInfo, auwz.a(Long.parseLong(this.jdField_a_of_type_JavaLangString)));
      break;
  ...
  public void a(SongInfo paramSongInfo, boolean paramBoolean)
  {
    ...
    if (this.c)
    {
      ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376318)).setText(paramSongInfo.jdField_b_of_type_JavaLangString);
      ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376317)).setText(paramSongInfo.g);
      a(paramSongInfo.d);
      return;
    }
    ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376319)).setText(paramSongInfo.jdField_b_of_type_JavaLangString + "-" + paramSongInfo.g);
  ...
  public void a(String paramString)
  {
    ...
    localURLDrawableOptions.mLoadingDrawable = this.jdField_a_of_type_AndroidViewView.getContext().getResources().getDrawable(2130843990);
    localURLDrawableOptions.mFailedDrawable = this.jdField_a_of_type_AndroidViewView.getContext().getResources().getDrawable(2130843990);
    paramString = URLDrawable.getDrawable(paramString, localURLDrawableOptions);
    paramString.setTag(new int[] { this.jdField_a_of_type_Int / 2 });
    paramString.setDecodeHandler(bavi.z);
    paramString.startDownload();
    this.jdField_a_of_type_AndroidViewView.findViewById(2131376458).setBackgroundDrawable(paramString);
    if (this.jdField_a_of_type_Boolean) {}
    for (;;)
    {
      a(i);
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (!this.c)
    {
      ...
      if (paramBoolean)
      {
        if (this.e)
        {
          localTextView.setText(2131695412);
    ...
    if (paramBoolean)
    {
      this.jdField_a_of_type_AndroidViewView.findViewById(2131365670).setVisibility(0);
      this.jdField_a_of_type_AndroidViewView.findViewById(2131376458).setVisibility(8);
      this.jdField_a_of_type_AndroidViewView.findViewById(2131370556).setVisibility(8);
      return;
    }
    this.jdField_a_of_type_AndroidViewView.findViewById(2131365670).setVisibility(8);
    this.jdField_a_of_type_AndroidViewView.findViewById(2131376458).setVisibility(0);
    this.jdField_a_of_type_AndroidViewView.findViewById(2131370556).setVisibility(0);
  }
  ...
  public void onClick(View paramView)
  {
    ...
    if (this.f)
    {
      axqw.b(null, "dc00898", "", "", "qq_vip", "0X800A7D8", 0, 0, "", "", "", "");
    ...
    else
    {
      ...
      for (int i = 1;; i = 2)
      {
        axqw.b(null, "dc00898", "", str, "qq_vip", "0X800A7DD", i, 0, "", "", "", "");
        break;
      }
    }
    if (auwz.a(Long.parseLong(this.jdField_a_of_type_JavaLangString)))
    {
      this.jdField_a_of_type_Auwz.k();
      a(2);
      return;
    }
    this.jdField_a_of_type_Auwz.a(Long.parseLong(this.jdField_a_of_type_JavaLangString), this.jdField_a_of_type_ComTencentMobileqqMusicSongInfo);
  }
}
