  ...
  extends MSFServlet
{
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    try
    {
      ...
      paramFromServiceMsg = bfuc.encodeToString(((cmd0xccb.RspBody)localObject1).res_id.get().toByteArray(), 0);
    ...
    catch (Exception paramFromServiceMsg)
    {
      ...
      notifyObserver(paramIntent, 0, false, paramIntent.getExtras(), auwx.class);
      return;
    }
    if ((m == 3) || (m == 4) || (m == 5))
    {
    ...
    for (;;)
    {
      ...
      notifyObserver(paramIntent, 0, bool, paramIntent.getExtras(), auwx.class);
      return;
      if (QLog.isColorLevel())
      {
        ...
        if (!((cmd0xccb.RspBody)localObject1).local_msg.has())
        {
          ...
          awcm.a().a(a(), String.valueOf(l1), j, String.valueOf(l2), new auwz());
          return;
        }
        j = -1;
        bool = false;
