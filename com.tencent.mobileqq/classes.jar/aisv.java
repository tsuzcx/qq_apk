  ...
  implements bbwz, INetInfoHandler
{
  ...
  public aisv(AppRuntime paramAppRuntime, bbwy parambbwy)
  {
    ...
    try
    {
      if (!this.jdField_a_of_type_JavaUtilLinkedList.isEmpty())
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          {
            if (QLog.isColorLevel()) {
              QLog.d("ApolloQueue_Downloader", 2, "getTask | " + paramString + " task find =" + localbbwu);
            }
            return localbbwu;
          }
        }
  ...
  public void a()
  {
    for (;;)
    {
      try
      {
        synchronized (this.jdField_a_of_type_JavaUtilLinkedList)
        {
          ...
          if ((!localbbwu2.a()) && (l > localbbwu2.c + localbbwu2.d))
          {
            ...
            QLog.d("ApolloQueue_Downloader", 2, "remove task[" + localbbwu2.jdField_a_of_type_JavaLangString + "], isCancal=" + localbbwu2.b() + ", timeOut=" + bool);
          }
        }
        bool = false;
      }
      ...
      for (;;)
      {
        ...
        return;
        label288:
        ThreadManager.postDownLoadTask(new ApolloQueueDownloader.1(this, localbbwu1), 2, null, false);
  ...
  public void a(bbwu parambbwu)
  {
    ...
    try
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("ApolloQueue_Downloader", 2, "removeTask | task=" + parambbwu);
        }
        parambbwu.i();
  ...
  public void a(bbwu parambbwu, bbwt arg2, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaUtilLinkedList)
      {
        ...
        if (paramBundle == null)
        {
          ...
          if (parambbwu.b)
          {
            ...
            if ((parambbwu.jdField_a_of_type_JavaUtilList != null) && (parambbwu.jdField_a_of_type_JavaUtilList.size() != 0)) {
              break label328;
            }
            ??? = null;
            if (QLog.isColorLevel()) {
              QLog.d("ApolloQueue_Downloader", 2, new Object[] { "startDownload | task=" + parambbwu.jdField_a_of_type_JavaLangString, ", url:", ??? });
            }
            a();
            return;
          }
      ...
      if ((parambbwu.b) && (!paramBundle.a()) && (this.jdField_a_of_type_JavaUtilLinkedList.remove(paramBundle)))
      {
        ...
        continue;
        label328:
        ??? = (String)parambbwu.jdField_a_of_type_JavaUtilList.get(0);
      }
    }
  }
