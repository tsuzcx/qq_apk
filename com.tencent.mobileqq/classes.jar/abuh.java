...
public class abuh
  extends anad
{
  public abuh(TeamWorkDocEditBrowserActivity.TeamWorkDocEditBrowserFragment paramTeamWorkDocEditBrowserFragment) {}
  ...
  public void onResponse(Bundle paramBundle)
  {
    ...
    if ((!TextUtils.isEmpty(str)) && (TeamWorkDocEditBrowserActivity.TeamWorkDocEditBrowserFragment.a(this.a) != null) && (TeamWorkDocEditBrowserActivity.TeamWorkDocEditBrowserFragment.a(this.a).a()))
    {
      ...
      if (this.a.a().getStringExtra("tdsourcetag") != null)
      {
        ...
        str = axfs.b(str, (String)localObject);
        ...
        for (;;)
        {
          axhg.a("WebLog_WebViewFragment", "get_url_time", String.valueOf(l) + " - url:" + str);
          return;
    ...
    if ((Math.abs(i) == 115) && (!TextUtils.isEmpty((CharSequence)localObject)))
    {
      ...
      for (;;)
      {
        axhg.a("WebLog_WebViewFragment", "get_url_time", String.valueOf(l) + " - redirectUrl:" + (String)localObject);
        return;
        axfs.a(paramBundle, "0X8009ED6");
    ...
    if (TeamWorkDocEditBrowserActivity.TeamWorkDocEditBrowserFragment.a(this.a, null)) {
      axhg.a(null, "0X800A755");
    }
    axhg.a("WebLog_WebViewFragment", "get_url_time", "retCode = " + i + " errorStr = " + str);
  }
}
