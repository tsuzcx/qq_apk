  ...
  extends PagerAdapter
{
  ...
  public ahqq(CaptureVideoFilterViewPager paramCaptureVideoFilterViewPager)
  {
  ...
  public Object instantiateItem(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    for (localObject1 = (View)((Queue)localObject1).poll();; localObject1 = null)
    {
      ...
      if (localObject1 == null)
      {
        localObject2 = ((LayoutInflater)this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCaptureVideoFilterViewPager.getContext().getSystemService("layout_inflater")).inflate(2130968739, null);
