...
public class bggi
{
  private static bggi jdField_a_of_type_Bggi;
  private Pattern jdField_a_of_type_JavaUtilRegexPattern = Pattern.compile("(\\d+)\\.(\\d+).(\\d+)_(\\d+)");
  
  public static bggi a()
  {
    if (jdField_a_of_type_Bggi == null) {}
    try
    {
      if (jdField_a_of_type_Bggi == null) {
        jdField_a_of_type_Bggi = new bggi();
      }
      return jdField_a_of_type_Bggi;
    }
    finally {}
  }
      ...
      try
      {
        ...
        if (localObject.length >= 2)
        {
          ...
          if ((paramString != null) && (localObject != null) && (paramString.length >= 4) && (localObject.length >= 4))
          {
            ...
            paramString = this.jdField_a_of_type_JavaUtilRegexPattern.matcher(bgyi.a());
            if (paramString.find())
            {
