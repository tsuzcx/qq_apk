  ...
  extends MSFServlet
{
  ...
  private static mobile_monitor_report.UserCommReport a()
  {
    ...
    localUserCommReport.imei.set(String.valueOf(bdjp.c()));
    String str = akuf.b();
    ...
    if (i == 1000) {
      try
      {
        ...
        if (i == 0)
        {
          ...
          notifyObserver(paramIntent, 1000, true, new Bundle(), biab.class);
          return;
        }
        QLog.d("MonitorServlet", 2, "onReceive ret " + i);
        notifyObserver(paramIntent, 1000, false, new Bundle(), biab.class);
        return;
      }
  ...
  public static void a(List<mobile_monitor_report.ExceptionReport> paramList)
  {
    ...
    paramList = new NewIntent(localAppRuntime.getApplication(), biac.class);
    ...
    paramList.putExtra("data", bbma.a(localUniSsoServerReq.toByteArray()));
