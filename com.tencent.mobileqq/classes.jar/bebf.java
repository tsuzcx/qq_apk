...
public class bebf
{
  ...
  public void a()
  {
    ...
    label91:
    for (DisplayMetrics localDisplayMetrics = this.jdField_a_of_type_Beey.jdField_a_of_type_AndroidAppActivity.getResources().getDisplayMetrics();; localDisplayMetrics = BaseApplicationImpl.getContext().getResources().getDisplayMetrics())
    {
      this.jdField_a_of_type_Int = localDisplayMetrics.widthPixels;
      this.jdField_b_of_type_Int = localDisplayMetrics.heightPixels;
      if ((this.jdField_a_of_type_Befb == null) || (!this.jdField_a_of_type_Befb.d) || (!this.jdField_a_of_type_Befb.H)) {
        break;
      }
      c();
      return;
  ...
  {
    if (bhzc.a(paramActivity))
    {
      paramActivity = paramActivity.findViewById(16908290);
      paramActivity.addOnLayoutChangeListener(new bebj(this, paramActivity));
    }
  }
  
  public void a(View paramView)
  {
    int j = paramView.getResources().getColor(2131167081);
    if (this.jdField_a_of_type_Befb.jdField_c_of_type_Boolean) {
      j = paramView.getResources().getColor(2131167082);
    }
    for (;;)
    {
      ...
      label320:
      label326:
      for (int k = 2130842266;; k = 2130842265)
      {
  ...
  public void a(View paramView, View.OnClickListener paramOnClickListener)
  {
    ...
    if (this.jdField_a_of_type_Beey.jdField_a_of_type_AndroidAppActivity != null)
    {
      localDisplayMetrics = this.jdField_a_of_type_Beey.jdField_a_of_type_AndroidAppActivity.getResources().getDisplayMetrics();
      ...
      this.c = paramView.findViewById(2131377831);
      ...
      this.i = paramView.findViewById(2131370067);
      this.jdField_a_of_type_ComTencentBizWebviewpluginHole = ((Hole)paramView.findViewById(2131367672));
      b();
      if (this.jdField_a_of_type_Befb.jdField_c_of_type_Boolean) {
        a(paramView);
      }
      if ((this.jdField_a_of_type_Befb.jdField_c_of_type_Long & 1L) != 0L)
      {
        this.f.setVisibility(0);
        this.jdField_a_of_type_AndroidViewView.setVisibility(0);
      }
      if ((this.jdField_a_of_type_Befb.jdField_c_of_type_Long & 0x4) != 0L)
      {
        this.d.setVisibility(0);
        this.jdField_a_of_type_AndroidViewView.setVisibility(0);
      }
      if ((this.jdField_a_of_type_Befb.jdField_c_of_type_Long & 0x2) != 0L)
      {
        this.h.setVisibility(0);
        this.jdField_a_of_type_AndroidViewView.setVisibility(0);
      }
      if ((((this.jdField_a_of_type_Befb.b & 0x800) != 0L) || ((this.jdField_a_of_type_Befb.a & 0x80000000) != 0L)) && (this.jdField_a_of_type_Beey.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (myl.a().j(this.jdField_a_of_type_Beey.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.g)))
      {
      ...
      paramView.getViewTreeObserver().addOnGlobalLayoutListener(new bebg(this, paramView, localDisplayMetrics));
    }
    for (;;)
    {
      paramView = new bebh(this, localDisplayMetrics);
  ...
  public void a(View paramView, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      paramView.setBackgroundResource(2130842249);
      return;
    }
    paramView.setBackgroundResource(2130842250);
  }
  ...
  public void b()
  {
    if ((this.jdField_a_of_type_Befb != null) && (this.jdField_a_of_type_Befb.d) && (this.jdField_a_of_type_Befb.H) && (this.jdField_a_of_type_AndroidViewView != null) && (8 == this.c.getVisibility())) {
      c();
    }
  }
