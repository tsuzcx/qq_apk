...
public class apmh
  implements RecyclerView.ItemAnimator.ItemAnimatorFinishedListener, View.OnClickListener, apmt
{
  private static int jdField_a_of_type_Int = 2131167352;
  private static int jdField_b_of_type_Int = 2131167337;
  private static int jdField_c_of_type_Int = 2130839297;
  ...
  public apmh(Context paramContext, apmt paramapmt)
  {
  ...
  private void d()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqColornoteListColorNoteListLayout = ((ColorNoteListLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131364745));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364749));
    this.jdField_a_of_type_ComTencentMobileqqWidgetBounceScrollView = ((BounceScrollView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363688));
    ...
    this.jdField_a_of_type_AndroidViewViewStub = ((ViewStub)this.jdField_a_of_type_AndroidViewView.findViewById(2131364748));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new apmi(this));
    this.jdField_a_of_type_AndroidViewGestureDetector = new GestureDetector(new apmj(this));
    localObject = new apmk(this);
    this.jdField_a_of_type_AndroidViewView.setOnTouchListener((View.OnTouchListener)localObject);
    this.jdField_a_of_type_AndroidViewView.findViewById(2131363688).setOnTouchListener((View.OnTouchListener)localObject);
  ...
  private void e()
  {
    ...
    {
      localViewPropertyAnimator.translationX(f).setDuration(180L).setListener(new apmp(this)).start();
      return;
    }
  }
  ...
  private void f()
  {
    ...
    {
      jdField_a_of_type_Int = 2131165370;
      jdField_b_of_type_Int = 2131165351;
      jdField_c_of_type_Int = 2130839298;
      return;
    }
    jdField_a_of_type_Int = 2131167352;
    jdField_b_of_type_Int = 2131167337;
    jdField_c_of_type_Int = 2130839297;
  }
  ...
  {
    this.jdField_a_of_type_Apmc.a(paramList);
    a();
  }
  ...
  public void a(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    d();
    this.jdField_a_of_type_Apmc = new apmc();
    this.jdField_a_of_type_Apmc.a(this);
    this.jdField_a_of_type_Apmc.a(paramBoolean);
    Object localObject1 = ((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getProxyManager().a().a();
    this.jdField_a_of_type_Apmc.a((List)localObject1);
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.setAdapter(this.jdField_a_of_type_Apmc);
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.setVisibility(4);
    this.jdField_a_of_type_Apmc.a(new apml(this));
    Object localObject2;
    if (((List)localObject1).size() > 0)
    {
      localObject2 = (ColorNote)((List)localObject1).get(0);
      if (aplm.b((ColorNote)localObject2)) {
        bcef.b(null, "dc00898", "", "", "0X800A8AA", "0X800A8AA", apkm.b(aplm.a(((ColorNote)localObject2).getServiceType())), 0, "", "", "", "");
      }
    }
    ...
    this.jdField_a_of_type_AndroidViewView.animate().alpha(0.9F).setDuration(200L).setListener(new apmo(this, paramBoolean)).start();
    ...
    for (paramInt2 = i;; paramInt2 = i)
    {
      ...
      paramInt1 = i;
      break;
      bcef.b(null, "dc00898", "", "", "0X800A6CD", "0X800A6CD", 0, 0, ((List)localObject1).size() + "", apkm.a(paramInt1) + "", "", "");
      localObject1 = ((List)localObject1).iterator();
      while (((Iterator)localObject1).hasNext())
      {
        localObject2 = (ColorNote)((Iterator)localObject1).next();
        if (aplm.d((ColorNote)localObject2))
        {
          localObject3 = ahrr.a((ColorNote)localObject2);
          if (aplm.c((ColorNote)localObject2)) {}
          for (paramInt1 = 1;; paramInt1 = 2)
          {
            bcef.b(null, "dc00898", "", "", "0X800AE8E", "0X800AE8E", paramInt1, ((UpComingMsgModel)localObject3).reportType, "", "", "", "");
            break;
          }
        }
      }
  ...
  {
    if (this.jdField_a_of_type_Apmc.getItemCount() == 0) {
      e();
    }
  }
