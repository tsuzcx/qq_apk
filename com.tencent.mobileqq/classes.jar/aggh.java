  ...
  implements aojm
{
  ...
  private aggh(BaseBubbleBuilder paramBaseBubbleBuilder)
  {
  ...
  public void a(TroopMemberInfo paramTroopMemberInfo)
  {
    ...
    localObject1 = (aggl)this.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTag();
    Object localObject2;
    Object localObject3;
    int i;
    int j;
    ...
    int i1;
    boolean bool1;
    if ((paramTroopMemberInfo != null) && (TextUtils.equals(((aggl)localObject1).jdField_a_of_type_ComTencentMobileqqDataChatMessage.senderuin, paramTroopMemberInfo.memberuin)))
    {
      ...
      localObject1 = new begb(bhlg.c(this.jdField_a_of_type_ComTencentMobileqqActivityAioBaseBubbleBuilder.a, paramTroopMemberInfo.troopuin, paramTroopMemberInfo.memberuin, true), 13).a();
      ...
      if (((!this.jdField_a_of_type_Boolean) || (!nlj.b(this.jdField_a_of_type_ComTencentMobileqqDataChatMessage))) && (!aqzo.c(this.jdField_a_of_type_ComTencentMobileqqDataChatMessage)) && (!this.jdField_a_of_type_ComTencentMobileqqDataChatMessage.isSend())) {
        break label403;
      }
    }
    label397:
    ...
    for (boolean bool2 = true;; bool2 = false)
    {
      ...
      if (this.jdField_a_of_type_Int == 1) {
        BaseBubbleBuilder.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioBaseBubbleBuilder, ((CharSequence)localObject1).toString(), this.jdField_a_of_type_ComTencentMobileqqDataChatMessage, this.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout, this.jdField_a_of_type_Aggl);
      }
      bhwz.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioBaseBubbleBuilder.a, this.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.e, (Spannable)localObject1);
      return;
      bool1 = false;
      break;
    }
