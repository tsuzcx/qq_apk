  ...
  implements aklr, ARNativeBridge.ActionCallback
{
  ...
  private akmh jdField_a_of_type_Akmh;
  ...
  public akmg(aklt paramaklt, akmh paramakmh)
  {
    this.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Aklt = paramaklt;
    this.jdField_a_of_type_Akmh = paramakmh;
    this.jdField_a_of_type_AndroidContentContext = this.jdField_a_of_type_Aklt.a();
    this.jdField_a_of_type_ComTencentMobileqqArARNativeBridge = ((ARNativeBridge)this.jdField_a_of_type_Aklt.a(paramakmh.jdField_a_of_type_Int));
  }
  ...
  public void a(int paramInt)
  {
    ...
    case 2: 
      ...
      this.jdField_a_of_type_ComTencentMobileqqArARNativeBridge.nativeCreateEngine(this.jdField_b_of_type_Int, this.jdField_a_of_type_Akmh.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidContentContext.getAssets(), this.jdField_a_of_type_Akmh.c, this.d, this.e);
    ...
    case 7: 
      ...
      return;
    case 9: 
      this.jdField_a_of_type_Aklt.a(new GeneralAR3DRenderable.1(this));
      return;
    case 8: 
  ...
  {
    if ((this.jdField_a_of_type_Akmh != null) && (this.jdField_a_of_type_Akmh.jdField_b_of_type_Int == 1))
    {
  ...
  public int b()
  {
    if (this.jdField_a_of_type_Akmh != null) {
      return this.jdField_a_of_type_Akmh.jdField_a_of_type_Int;
    }
    return 0;
  }
  ...
  {
    if (this.jdField_a_of_type_Akmh != null) {
      return this.jdField_a_of_type_Akmh.jdField_b_of_type_Int;
    }
    return 0;
  }
  ...
  public String c()
  {
    return this.jdField_a_of_type_Akmh.jdField_a_of_type_JavaLangString;
  }
  ...
  public void callback(int paramInt1, String paramString1, int paramInt2, String paramString2)
  {
    ...
    default: 
      return;
    case 0: 
      this.jdField_a_of_type_Aklt.b(3, 0);
      return;
    }
    this.jdField_a_of_type_Aklt.b(2, 0);
  }
  ...
  public void d()
  {
    ...
    {
      this.jdField_a_of_type_Akje = new akje(this.jdField_a_of_type_Akmh.d, "");
      a(2);
    }
  }
  ...
  public void f()
  {
    ...
    if (this.jdField_a_of_type_Int == 9)
    {
      ...
      if (this.jdField_a_of_type_Aklt != null)
      {
        this.jdField_a_of_type_Aklt.a(this.jdField_a_of_type_Akmh.jdField_a_of_type_JavaLangString);
