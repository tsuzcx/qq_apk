...
public class alfw
{
  ...
  public alfw(tAdvDesc paramtAdvDesc)
  {
  ...
  public alfw(TianShuAccess.AdItem paramAdItem)
  {
  ...
  public static alfw a(tAdvDesc paramtAdvDesc)
  {
    ...
    default: 
      return null;
    case 1012: 
      return new alfw(paramtAdvDesc);
    case 1108: 
      return new bmob(paramtAdvDesc);
    }
    return new bmod(paramtAdvDesc);
  }
  
  public static alfw a(TianShuAccess.AdItem paramAdItem, String paramString)
  {
    if (paramAdItem == null) {
      return null;
    }
    if ("2".equals(paramString)) {
      return new bmob(paramAdItem);
    }
    if ("1".equals(paramString)) {
      return new bmod(paramAdItem);
    }
    return new alfw(paramAdItem);
  }
  ...
  protected void a()
  {
    ...
    try
    {
      ...
      localObject = new alfx();
      ((alfx)localObject).jdField_a_of_type_JavaLangString = str2;
      ((alfx)localObject).jdField_b_of_type_JavaLangString = str3;
      ((alfx)localObject).jdField_c_of_type_JavaLangString = alfy.a().a(str2);
      this.jdField_d_of_type_JavaLangString = ((alfx)localObject).jdField_c_of_type_JavaLangString;
  ...
  public void a(SharedPreferences paramSharedPreferences, String paramString)
  {
    ...
    try
    {
      ...
      paramSharedPreferences = new alfx();
  ...
  protected void b()
  {
    ...
    try
    {
      ...
      localObject1 = new alfx();
      ((alfx)localObject1).jdField_a_of_type_JavaLangString = ((String)localObject2);
      ((alfx)localObject1).jdField_b_of_type_JavaLangString = ((String)localObject3);
      ((alfx)localObject1).jdField_c_of_type_JavaLangString = alfy.a().a((String)localObject2);
      this.jdField_d_of_type_JavaLangString = ((alfx)localObject1).jdField_c_of_type_JavaLangString;
  ...
  public boolean b()
  {
    ...
    {
      alfx localalfx = (alfx)this.jdField_a_of_type_AndroidUtilSparseArray.valueAt(i);
      if ((localalfx == null) || (TextUtils.isEmpty(localalfx.jdField_c_of_type_JavaLangString)) || (!localalfx.a())) {
        return false;
      }
      i += 1;
    }
