...
public class lal
{
  private static lah jdField_a_of_type_Lah;
  private static lai jdField_a_of_type_Lai;
  
  /* Error */
  public static lah a(Context paramContext)
  {
    // Byte code:
    //   0: getstatic 17	lal:jdField_a_of_type_Lah	Llah;
    //   3: ifnonnull +81 -> 84
    //   6: aload_0
    //   7: ldc 19
    ...
    //   56: ldc 2
    //   58: monitorenter
    //   59: getstatic 17	lal:jdField_a_of_type_Lah	Llah;
    //   62: astore_2
    //   63: aload_2
    //   64: ifnonnull +17 -> 81
    //   67: new 62	lah
    ...
    //   73: iload_1
    //   74: i2l
    //   75: invokespecial 65	lah:<init>	(Landroid/content/Context;IJ)V
    //   78: putstatic 17	lal:jdField_a_of_type_Lah	Llah;
    //   81: ldc 2
    //   83: monitorexit
    //   84: getstatic 17	lal:jdField_a_of_type_Lah	Llah;
    //   87: areturn
    //   88: astore_0
  ...
  public static lai a(Context paramContext)
  {
    try
    {
      if (jdField_a_of_type_Lai == null) {
        jdField_a_of_type_Lai = new lai(65536);
      }
      return jdField_a_of_type_Lai;
    }
    finally {}
  }
  
  public static lah b(Context paramContext)
  {
    if (jdField_a_of_type_Lah == null) {
      ThreadManager.post(new TranslateCache.1(paramContext), 5, null, true);
    }
    return jdField_a_of_type_Lah;
  }
}
