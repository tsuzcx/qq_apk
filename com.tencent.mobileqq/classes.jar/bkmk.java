  ...
  implements bkmj
{
  ...
  public static bkmj a(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("cooperation.qappcenter.remote.IServiceHandler");
    if ((localIInterface != null) && ((localIInterface instanceof bkmj))) {
      return (bkmj)localIInterface;
    }
    return new bkml(paramIBinder);
  }
