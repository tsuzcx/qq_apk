  ...
  extends WebViewPlugin
{
  ...
  protected void a(String paramString)
  {
    ...
    if (this.jdField_a_of_type_AndroidAppDialog == null)
    {
      ...
      localTextView4.setOnClickListener(new apzz(this));
      localTextView3.setOnClickListener(new aqaa(this));
      ...
      for (;;)
      {
        ...
        for (i = j;; i = 1)
        {
          ...
          if (((String)localObject1).equals("ask"))
          {
            ...
            a(paramString.getString(2131690184));
  ...
  protected void b()
  {
    ...
    QQToast.a(localActivity, anvx.a(2131700217), 0).a();
  }
