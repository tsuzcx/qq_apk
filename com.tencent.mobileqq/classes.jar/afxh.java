...
public class afxh
{
  ...
  private static afxh jdField_a_of_type_Afxh;
  public static final String a;
  public static long b;
  public static final String b;
  public Handler a;
  public HandlerThread a;
  HashMap<String, afxi> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  public MqqHandler a;
  afxj[] jdField_a_of_type_ArrayOfAfxj = null;
  private ArrayList[] jdField_a_of_type_ArrayOfJavaUtilArrayList = new ArrayList[6];
  private ArrayList[] b;
  
  static
  {
    jdField_a_of_type_JavaLangString = bdzf.a("Tencent/MobileQQ/poke/");
  ...
  private afxh()
  {
    ...
    this.jdField_a_of_type_ArrayOfAfxj = new afxj[6];
    afxj[] arrayOfafxj = this.jdField_a_of_type_ArrayOfAfxj;
    int k = arrayOfafxj.length;
    i = j;
    while (i < k)
    {
      afxj localafxj = arrayOfafxj[i];
      localafxj = new afxj(this);
      localafxj.jdField_a_of_type_Int = 1;
      localafxj.jdField_a_of_type_Long = -1L;
      i += 1;
    }
  ...
  public static afxh a()
  {
    if (jdField_a_of_type_Afxh == null) {}
    try
    {
      if (jdField_a_of_type_Afxh == null) {
        jdField_a_of_type_Afxh = new afxh();
      }
      return jdField_a_of_type_Afxh;
    }
    finally {}
  }
  ...
  public int a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      localObject1 = new afxi(this);
      ((afxi)localObject1).jdField_a_of_type_ArrayOfAfxk = new afxk[6];
      this.jdField_a_of_type_JavaUtilHashMap.put(paramString, localObject1);
    }
    Object localObject2 = (afxi)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    if (localObject2 == null)
    {
      paramQQAppInterface = new HashMap();
      paramQQAppInterface.put(BaseConstants.RDM_NoChangeFailCode, "");
      azri.a(BaseApplication.getContext()).a(null, "pokeStrengthNullPoint", false, 0L, 0L, paramQQAppInterface, "");
      return 0;
    }
    Object localObject1 = ((afxi)localObject2).jdField_a_of_type_ArrayOfAfxk;
    paramInt2 = ((afxi)localObject2).jdField_a_of_type_Int;
    if (paramInt1 - 1 == -1) {
      paramInt1 = 0;
    }
    while ((paramInt1 >= 0) && (paramInt1 < 6))
    {
      ...
      {
        localObject1[paramInt1] = new afxk(this);
      ...
      if (paramInt3 != -1)
      {
        ...
        ((afxi)localObject2).jdField_a_of_type_Int = paramInt1;
      ...
      else
      {
        ...
        {
          if (paramInt2 != -1) {
            azqs.b(paramQQAppInterface, "CliOper", "", paramString, "0X8008914", "0X8008914", 0, 0, "" + localObject1[paramInt2].jdField_b_of_type_Int, "", "", "");
          }
          localObject1[paramInt1].jdField_a_of_type_Long = l1;
          if (QLog.isColorLevel()) {
    ...
    {
      azqs.b(paramQQAppInterface, "CliOper", "", paramString, "0X8008914", "0X8008914", 0, 0, "" + localObject1[paramInt2].jdField_b_of_type_Int, "", "", "");
      ((afxi)localObject2).jdField_a_of_type_Int = -1;
    }
    return 0;
  }
  ...
  public void a(View paramView)
  {
    ...
    Object localObject;
    if (afnk.class.isInstance(paramView))
    {
      localObject = (afnk)paramView;
      if (QLog.isColorLevel()) {
        QLog.d("GivingHeart", 2, new Object[] { "==>to be remove obj:", Integer.valueOf(((afnk)localObject).jdField_b_of_type_Int) });
      }
      if ((((afnk)localObject).jdField_a_of_type_ComTencentMobileqqDataChatMessage instanceof MessageForPoke))
      {
        paramView = (MessageForPoke)((afnk)localObject).jdField_a_of_type_ComTencentMobileqqDataChatMessage;
        if (afxl.a(paramView.interactType)) {
          break label82;
        }
      }
    }
    ...
    do
    {
      do
      {
        ...
        } while (!((afnk)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.a());
        localObject = ((afnk)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.a();
        paramView.mUnlimitedState.jdField_a_of_type_Int = ((aggf)localObject).jdField_a_of_type_Int;
        paramView.mUnlimitedState.jdField_b_of_type_Int = ((aggf)localObject).jdField_b_of_type_Int;
        paramView.mUnlimitedState.jdField_a_of_type_Long = ((aggf)localObject).jdField_a_of_type_Long;
        paramView.mFrameState.c = ((aggf)localObject).jdField_b_of_type_Boolean;
        paramView.mFrameState.jdField_a_of_type_Boolean = ((aggf)localObject).jdField_a_of_type_Boolean;
        return;
        localObject = ((afnk)localObject).jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.getBackground();
  ...
  {
    this.jdField_a_of_type_AndroidOsHandler = new bhtd(Looper.getMainLooper(), paramFitSystemWindowsRelativeLayout);
  }
}
