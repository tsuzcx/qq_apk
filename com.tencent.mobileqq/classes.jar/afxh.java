  ...
  extends afwu
{
  ...
  afxh(QQAppInterface paramQQAppInterface, String paramString)
  {
  ...
  public void a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    do
    {
      ...
      this.jdField_c_of_type_Int = 0;
      paramString = this.jdField_a_of_type_Afwv;
      this.jdField_a_of_type_Afwv = null;
  ...
  protected boolean a(String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    WeakReference localWeakReference = new WeakReference(this);
    return ((aovv)localObject).a(paramString1, paramString2, this.jdField_a_of_type_Int, paramInt2, new afxi(this, localWeakReference));
  }
