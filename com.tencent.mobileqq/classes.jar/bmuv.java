  ...
  extends bmuj
{
  private void a(boolean paramBoolean, Object paramObject)
  {
    if ((paramBoolean) && ((paramObject instanceof sweet_comm_cfg_item)))
    {
      ...
      if (a() != null)
      {
        auov localauov = (auov)a().a(153);
        if (localauov != null) {
          localauov.a(true, paramObject.wording, paramObject.dynamic_value, paramObject.url);
        }
      }
    }
    do
  ...
  {
    return new bmuw(this, paramIntent);
  }
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    {
      paramIntent = (sweet_comm_cfg_get_rsp)bmjb.a(paramFromServiceMsg.getWupBuffer(), "GetCommCfg");
