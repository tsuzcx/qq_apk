...
public class biaq
{
  ...
  public static String e()
  {
    ...
    WindowManager localWindowManager = (WindowManager)bhpc.a().a().getSystemService("window");
  ...
  public static String f()
  {
    ...
    {
      bhzm.c("getLocation", "getLocation>>>", localException);
    }
    return "";
  }
  ...
  public static String h()
  {
    try
    {
      ...
      String str = bhzh.b(localContext);
      ...
      for (int i = 1;; i = 0)
      {
        ...
        localStringBuilder.append("wifi=").append(bhzh.e(localContext));
  ...
  public static String i()
  {
    ...
    try
    {
      localJSONObject.put("qua", bhpc.a().f());
      localJSONObject.put("longitude", f());
      localJSONObject.put("platform", bhpc.a().g());
      localJSONObject.put("uin", bhpc.a().a());
      localJSONObject.put("imei", c());
      localJSONObject.put("imei", c());
      localJSONObject.put("resolution", e());
      localJSONObject.put("network", bhzh.a(bhpc.a().a()));
      ...
      localJSONObject.put("qua", bhpc.a().f());
      localJSONObject.put("qz_ver", bhpc.a().c());
      localJSONObject.put("imsi", d());
      localJSONObject.put("androidID", Settings.Secure.getString(bhpc.a().a().getContentResolver(), "android_id"));
      localJSONObject.put("os_api_level", Build.VERSION.SDK_INT);
      localJSONObject.put("sdkVersionCode", 1);
      localJSONObject.put("QVersionCode", bhpc.a().a());
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        bhzm.e("getMobileInfo", "gather mobile info exception.");
      }
    }
  }
}
