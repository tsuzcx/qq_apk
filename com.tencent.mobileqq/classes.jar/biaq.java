...
public class biaq
  extends PopupWindow
{
  private static final Drawable jdField_a_of_type_AndroidGraphicsDrawableDrawable = a(2130849670);
  ...
  private static final Drawable jdField_b_of_type_AndroidGraphicsDrawableDrawable = a(2130849671);
  ...
  private View.OnKeyListener jdField_a_of_type_AndroidViewView$OnKeyListener = new biat(this);
  private View.OnTouchListener jdField_a_of_type_AndroidViewView$OnTouchListener = new biau(this);
  ...
  public biaq(Activity paramActivity)
  {
    super(paramActivity);
  ...
  private void a(int paramInt)
  {
    ...
    bbkx.a(this.jdField_a_of_type_AndroidWidgetRelativeLayout, jdField_c_of_type_AndroidGraphicsDrawableDrawable);
  ...
  private int c()
  {
    ...
    return bbkx.b() - localRect.height();
  }
  ...
  private void f()
  {
    ...
    setWidth(-1);
    setHeight(-1);
    this.jdField_a_of_type_ComTencentComponentAnimationReboundSpring = SpringSystem.create().createSpring().setSpringConfig(jdField_a_of_type_ComTencentComponentAnimationReboundSpringConfig).addListener(new biar(this));
    this.jdField_a_of_type_Biav = new biav(this, this.jdField_a_of_type_AndroidAppActivity);
    this.jdField_a_of_type_AndroidWidgetListView = ((ListView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131365413));
    ...
    this.jdField_a_of_type_AndroidWidgetListView.setAdapter(this.jdField_a_of_type_Biav);
    this.jdField_a_of_type_AndroidWidgetListView.setOnTouchListener(new bias(this));
  }
  ...
  private void h()
  {
    ...
    for (;;)
    {
      ...
      bbkx.b(this.jdField_a_of_type_AndroidWidgetListView, f3);
      bbkx.c(this.jdField_a_of_type_AndroidWidgetListView, f3);
      if (this.jdField_c_of_type_Boolean)
      {
        bbkx.e(this.jdField_a_of_type_AndroidWidgetListView, 0.0F);
        bbkx.d(this.jdField_a_of_type_AndroidWidgetListView, this.jdField_c_of_type_Int);
      }
      for (;;)
      {
        ...
        f3 = f2;
        break;
        bbkx.e(this.jdField_a_of_type_AndroidWidgetListView, this.d);
        bbkx.d(this.jdField_a_of_type_AndroidWidgetListView, this.jdField_c_of_type_Int);
      }
      label221:
      break;
  ...
  public void a()
  {
    ...
    a(this.jdField_a_of_type_AndroidWidgetRelativeLayout, 0.0F);
    bbkx.a(this.jdField_a_of_type_AndroidWidgetListView, jdField_a_of_type_AndroidGraphicsDrawableDrawable);
  ...
  public void a(biaw parambiaw)
  {
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (parambiaw != null)) {
      this.jdField_a_of_type_JavaUtilArrayList.add(parambiaw);
    }
  }
  ...
  public boolean a(int paramInt1, int paramInt2)
  {
    ...
    paramInt1 = bbkx.a() - this.jdField_a_of_type_AndroidWidgetRelativeLayout.getPaddingRight() * 2;
    ...
    localLayoutParams1.topMargin = (paramInt2 - i - bbkx.b(5.0F));
  ...
  public int b()
  {
    ...
    {
      i = bbkx.b() - this.jdField_a_of_type_AndroidWidgetRelativeLayout.getHeight();
      if (i > bbkx.b(25.0F)) {}
    }
    int j;
    do
  ...
  public void b()
  {
    ...
    a(this.jdField_a_of_type_AndroidWidgetRelativeLayout, 0.0F);
    bbkx.a(this.jdField_a_of_type_AndroidWidgetListView, jdField_b_of_type_AndroidGraphicsDrawableDrawable);
    if (this.jdField_a_of_type_AndroidWidgetListView != null) {
      this.jdField_a_of_type_AndroidWidgetListView.setPadding(this.jdField_a_of_type_AndroidWidgetListView.getPaddingLeft(), this.jdField_a_of_type_AndroidWidgetListView.getPaddingTop() + bbkx.b(9.0F), this.jdField_a_of_type_AndroidWidgetListView.getPaddingRight(), this.jdField_a_of_type_AndroidWidgetListView.getPaddingBottom());
    }
    super.showAtLocation(a(), 17, 0, 0);
    c();
  }
  ...
  public void e()
  {
    int i = 0;
    int j = 0;
    while (i < this.jdField_a_of_type_Biav.getCount())
    {
      View localView = this.jdField_a_of_type_Biav.getView(i, null, this.jdField_a_of_type_AndroidWidgetListView);
      localView.measure(View.MeasureSpec.makeMeasureSpec(0, 0), View.MeasureSpec.makeMeasureSpec(0, 0));
      j += localView.getMeasuredHeight();
      i += 1;
    }
    this.jdField_b_of_type_Int = (bbkx.b(9.0F) + j);
  }
}
