...
public class bjph
{
  ...
  public static void a(Resources paramResources, String paramString)
  {
    ...
    {
      return;
      paramResources = paramResources.getDrawable(2130848863);
  ...
  {
    ThreadManager.post(new AIOBusinessOperation.1((ImageView)paramViewGroup.findViewById(2131378934), paramBoolean), 5, null, false);
  }
  ...
  public static void a(PatchedButton paramPatchedButton, AIOLongCaptureCtrl paramAIOLongCaptureCtrl)
  {
    if (AppSetting.d)
    {
      ...
      paramPatchedButton.setOnClickListener(new bjpi(paramAIOLongCaptureCtrl));
      return;
    }
  ...
  private static void d(ImageView paramImageView, String paramString)
  {
    ...
    Object localObject = paramImageView.getResources().getDrawable(2130843621);
    int i;
