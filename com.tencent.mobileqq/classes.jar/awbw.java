...
public class awbw
{
  ...
  awbw(alxk paramalxk, String paramString)
  {
  ...
  /* Error */
  private List<? extends awbv> a(Class<? extends awbv> paramClass, String paramString1, boolean paramBoolean, String paramString2, String[] paramArrayOfString, String paramString3, String paramString4, String paramString5, String paramString6, awcg paramawcg, int paramInt)
  {
    // Byte code:
    //   0: aload_0
    //   1: iload_3
    ...
    //   12: aload 8
    //   14: aload 9
    //   16: invokevirtual 55	awbw:a	(ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   19: astore 5
    //   21: aload 5
    //   23: ifnull +122 -> 145
    //   26: new 57	awbp
    //   29: dup
    //   30: aload 5
    //   32: invokespecial 60	awbp:<init>	(Landroid/database/Cursor;)V
    //   35: astore 4
    //   37: aload 4
    //   39: astore 5
    //   41: aload_0
    ...
    //   44: aload 4
    //   46: aload 10
    //   48: invokevirtual 63	awbw:a	(Ljava/lang/Class;Ljava/lang/String;Landroid/database/Cursor;Lawcg;)Ljava/util/List;
    //   51: astore_1
    //   52: aload 4
    //   54: ifnull +10 -> 64
    //   57: aload 4
    ...
    //   0	154	0	this	awbw
    //   0	154	1	paramClass	Class<? extends awbv>
  ...
  private boolean a(String paramString, awbv paramawbv, boolean paramBoolean)
  {
    ...
    for (boolean bool2 = ((Boolean)jdField_a_of_type_JavaUtilMap.get(str)).booleanValue();; bool2 = false)
    {
      ...
      {
        return bool1;
        bool2 = this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a(awcw.a(paramawbv));
        paramawbv = awcw.b(paramawbv);
        if (paramawbv != null) {
          this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a(paramawbv);
        }
  ...
  {
    return this.jdField_a_of_type_Alxk.a().a(paramString1, paramString2, paramArrayOfString);
  }
  
  protected ContentValues a(awbv paramawbv)
  {
    List localList = awcw.a(paramawbv.getClassForTable());
    ...
    if (i < j)
    {
      ...
      localObject = ((Field)localObject).get(paramawbv);
  ...
  public Cursor a(boolean paramBoolean, String paramString1, String[] paramArrayOfString1, String paramString2, String[] paramArrayOfString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    try
    {
      if (d(paramString1))
      {
        paramString1 = this.jdField_a_of_type_Alxk.b().a(paramString1, paramArrayOfString1, paramString2, paramArrayOfString2, paramString5, paramString6);
        return paramString1;
      }
    }
  ...
  public awbv a(Class<? extends awbv> paramClass, long paramLong)
  {
    try
    {
      paramClass = a(paramClass, awcw.a(paramClass), false, "_id=?", new String[] { String.valueOf(paramLong) }, null, null, null, null, null, 3);
      if (paramClass != null) {
        return (awbv)paramClass.get(0);
      }
    }
  ...
  public awbv a(Class<? extends awbv> paramClass, Cursor paramCursor)
  {
    try
    {
      paramClass = a(paramClass, awcw.a(paramClass), paramCursor);
      return paramClass;
    }
  ...
  public awbv a(Class<? extends awbv> paramClass, String paramString)
  {
    Object localObject = awcw.a(paramClass);
    ...
    while (i < j)
    {
      ...
      if (localField.isAnnotationPresent(awdj.class))
      {
        ...
        try
        {
          paramClass = a(paramClass, awcw.a(paramClass), false, (String)localObject, new String[] { paramString }, null, null, null, null, null, 3);
  ...
  public awbv a(Class<? extends awbv> paramClass, String paramString, Cursor paramCursor)
  {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (localawbv != null)
          {
            ...
            if (awbv.class.isAssignableFrom(localClass))
            {
              localObject = a(localClass, paramCursor);
              ((awbv)localObject)._status = 1002;
              localField.set(localawbv, localObject);
            }
            localObject = localField.getName();
            ...
            if (localClass == Long.TYPE) {
              localField.set(localawbv, Long.valueOf(paramCursor.getLong(k)));
            } else if (localClass == Integer.TYPE) {
              localField.set(localawbv, Integer.valueOf(paramCursor.getInt(k)));
            }
          }
        }
        catch (Exception paramClass)
        {
          ...
          if (localClass == String.class) {
            localField.set(localawbv, paramCursor.getString(k));
          }
        }
        ...
        {
          localField.set(localawbv, Byte.valueOf((byte)paramCursor.getShort(k)));
        }
        else if (localClass == [B.class)
        {
          localField.set(localawbv, paramCursor.getBlob(k));
        }
        else if (localClass == Short.TYPE)
        {
          localField.set(localawbv, Short.valueOf(paramCursor.getShort(k)));
        }
        else if (localClass == Boolean.TYPE)
        {
          ...
          bool = true;
          localField.set(localawbv, Boolean.valueOf(bool));
        }
        else if (localClass == Float.TYPE)
        {
          localField.set(localawbv, Float.valueOf(paramCursor.getFloat(k)));
        }
        else
        {
          label528:
          ...
          {
            localField.set(localawbv, Double.valueOf(paramCursor.getDouble(k)));
            break label568;
            label502:
            if (paramawcg != null)
            {
              paramawcg.a(new NoColumnError((String)localObject, localClass));
              break label568;
              if ((l != -1L) && (paramString != null)) {}
              for (localawbv._status = 1001;; localawbv._status = 1002)
              {
                localawbv.postRead();
                return localawbv;
              }
  ...
  public awbv a(Class<? extends awbv> paramClass, String paramString, String[] paramArrayOfString)
  {
  ...
  public awbv a(Class<? extends awbv> paramClass, String... paramVarArgs)
  {
    ...
    try
    {
      paramClass = a(paramClass, awcw.a(paramClass), false, localStringBuffer.toString(), paramVarArgs, null, null, null, null, null, 3);
      if (paramClass != null) {
        return (awbv)paramClass.get(0);
      }
    }
  ...
  public awby a()
  {
    if (this.jdField_a_of_type_Awby == null) {
      this.jdField_a_of_type_Awby = new awby(this.jdField_a_of_type_Alxk);
    }
    return this.jdField_a_of_type_Awby;
  }
  
  public List<? extends awbv> a(Class<? extends awbv> paramClass)
  {
    try
    {
      paramClass = a(paramClass, awcw.a(paramClass), false, null, null, null, null, null, null, null, 2);
      return paramClass;
    }
    catch (InstantiationException paramClass)
    {
  ...
  public List<? extends awbv> a(Class<? extends awbv> paramClass, String paramString, Cursor paramCursor)
  {
    return a(paramClass, paramString, paramCursor, null);
  }
  
  public List<? extends awbv> a(Class<? extends awbv> paramClass, String paramString, Cursor paramCursor, awcg paramawcg)
  {
    localObject4 = null;
    ...
    catch (Exception paramClass)
    {
      do
      {
        try
        {
          localawbv = a(paramClass, paramString, paramCursor, paramawcg);
          ...
          try
          {
            ...
            ((List)localObject2).add(localawbv);
            localObject1 = localObject2;
          }
  ...
  /* Error */
  public List<? extends awbv> a(Class<? extends awbv> paramClass, String paramString1, String paramString2, String paramString3, String[] paramArrayOfString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 6
    ...
    //   4: astore 7
    //   6: aload_0
    //   7: getfield 33	awbw:jdField_a_of_type_Alxk	Lalxk;
    //   10: invokevirtual 235	alxk:b	()Lcom/tencent/mobileqq/app/SQLiteDatabase;
    //   13: aload_2
    //   14: aload_3
    //   15: aload 4
    //   17: aload 5
    ...
    //   34: aconst_null
    //   35: aload_2
    //   36: invokevirtual 473	awbw:a	(Ljava/lang/Class;Ljava/lang/String;Landroid/database/Cursor;)Ljava/util/List;
    //   39: astore_1
    //   40: aload_1
    //   41: astore_3
    //   42: aload_3
    ...
    //   start	length	slot	name	signature
    //   0	119	0	this	awbw
    //   0	119	1	paramClass	Class<? extends awbv>
  ...
  public List<? extends awbv> a(Class<? extends awbv> paramClass, String paramString1, boolean paramBoolean, String paramString2, String[] paramArrayOfString, String paramString3, String paramString4, String paramString5, String paramString6)
  {
  ...
  public List<? extends awbv> a(Class<? extends awbv> paramClass, String paramString1, boolean paramBoolean, String paramString2, String[] paramArrayOfString, String paramString3, String paramString4, String paramString5, String paramString6, awcg paramawcg)
  {
    return a(paramClass, paramString1, paramBoolean, paramString2, paramArrayOfString, paramString3, paramString4, paramString5, paramString6, paramawcg, 1);
  }
  
  /* Error */
  public List<? extends awbv> a(Class<? extends awbv> paramClass, String paramString, String[] paramArrayOfString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 4
    ...
    //   30: aconst_null
    //   31: aload_2
    //   32: invokevirtual 473	awbw:a	(Ljava/lang/Class;Ljava/lang/String;Landroid/database/Cursor;)Ljava/util/List;
    //   35: astore_1
    //   36: aload_1
    //   37: astore_3
    //   38: aload_3
    ...
    //   start	length	slot	name	signature
    //   0	157	0	this	awbw
    //   0	157	1	paramClass	Class<? extends awbv>
  ...
  public List<? extends awbv> a(Class<? extends awbv> paramClass, boolean paramBoolean, String paramString1, String[] paramArrayOfString, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    try
    {
      paramString1 = a(paramClass, awcw.a(paramClass), paramBoolean, paramString1, paramArrayOfString, paramString2, paramString3, paramString4, paramString5);
      return paramString1;
    }
    catch (Exception paramString1)
    {
  ...
  public void a(awbv paramawbv)
  {
    ...
    catch (Throwable paramawbv)
    {
      while (!QLog.isColorLevel()) {}
      QLog.e("EntityManager", 2, "persist error", paramawbv);
    }
  }
  ...
  protected void a(awbv paramawbv, boolean paramBoolean)
  {
    ...
    String str;
    if (paramawbv._status == 1000)
    {
      str = paramawbv.getTableName();
      a(str, paramawbv, false);
      paramawbv.prewrite();
    }
    for (;;)
    {
      try
      {
        localContentValues = a(paramawbv);
        if (!paramBoolean) {
          continue;
        }
  ...
  public boolean a(awbv paramawbv)
  {
    ...
    try
    {
      if ((paramawbv._status == 1001) || (paramawbv._status == 1002))
      {
        ContentValues localContentValues = a(paramawbv);
        int i = this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a(paramawbv.getTableName(), localContentValues, "_id=?", new String[] { String.valueOf(paramawbv._id) });
        return i > 0;
      }
    }
    catch (Exception localException)
  ...
  public boolean a(awbv paramawbv, String paramString, String[] paramArrayOfString)
  {
    boolean bool1 = false;
    boolean bool2 = false;
    if (this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase == null) {
    ...
    paramawbv.prewrite();
    if (paramawbv._status == 1001)
    {
      bool1 = bool2;
      if (this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a(paramawbv.getTableName(), paramString, paramArrayOfString) > 0) {
        bool1 = true;
      }
      paramawbv._status = 1003;
    }
    paramawbv.postwrite();
    return bool1;
  }
  
  public boolean a(Class<? extends awbv> paramClass)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase == null) {
      this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase = this.jdField_a_of_type_Alxk.a();
    }
  ...
  public void b(awbv paramawbv)
  {
    ...
    {
      while (!QLog.isColorLevel()) {}
      QLog.e("EntityManager", 2, "persistOrReplace error", paramawbv);
    }
  }
  ...
  public boolean b(awbv paramawbv)
  {
    ...
    paramawbv.prewrite();
    if (paramawbv._status == 1001) {
      if (this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a(paramawbv.getTableName(), "_id=?", new String[] { String.valueOf(paramawbv._id) }) > 0) {
        paramawbv._status = 1003;
      }
    }
    for (;;)
  ...
  public boolean b(String paramString)
  {
    try
    {
      this.jdField_a_of_type_Alxk.b().a(paramString);
      return true;
    }
    catch (Exception paramString)
    {
  ...
  public boolean d(String paramString)
  {
    ...
    do
    {
      ...
      localSQLiteDatabase = this.jdField_a_of_type_Alxk.b();
