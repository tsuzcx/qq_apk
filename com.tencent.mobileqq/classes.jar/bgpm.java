  ...
  extends FilterOutputStream
{
  ...
  private static bgpm jdField_b_of_type_Bgpm;
  private static int c;
  protected int a;
  private bgpm jdField_a_of_type_Bgpm;
  private boolean jdField_a_of_type_Boolean;
  protected byte[] a;
  private final int jdField_b_of_type_Int = 4;
  
  private bgpm(OutputStream paramOutputStream)
  {
    this(paramOutputStream, 8192);
  }
  
  private bgpm(OutputStream paramOutputStream, int paramInt)
  {
  ...
  public static bgpm a(OutputStream paramOutputStream)
  {
    bgpm localbgpm = null;
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (jdField_b_of_type_Bgpm != null)
      {
        localbgpm = jdField_b_of_type_Bgpm;
        jdField_b_of_type_Bgpm = localbgpm.jdField_a_of_type_Bgpm;
        localbgpm.jdField_a_of_type_Bgpm = null;
        c -= 1;
      }
      if (localbgpm != null)
      {
        localbgpm.out = paramOutputStream;
        localbgpm.jdField_a_of_type_Boolean = true;
        return localbgpm;
      }
    }
    return new bgpm(paramOutputStream);
  }
  ...
  private void a()
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (c < 4)
      {
        this.jdField_a_of_type_Bgpm = jdField_b_of_type_Bgpm;
        jdField_b_of_type_Bgpm = this;
        c += 1;
      }
      return;
    }
