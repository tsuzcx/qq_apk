...
public class bgmy
{
    ...
    do
    {
      do
      {
        do
        {
          ...
          {
            return null;
            localabwp = paramQQAppInterface.getConversationFacade();
          } while ((localabwp == null) || (localabwp.a("3026775809", 1008) <= 0));
  ...
  public static boolean a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    localObject2 = bfwg.a(paramQQAppInterface, paramContext, (String)localObject1);
    ...
    for (;;)
    {
      ...
      return true;
      localObject1 = bjnd.a(bjnd.a(bjnd.a(bjnd.a((String)localObject1, "uin", paramQQAppInterface.getCurrentUin()), "puin", "3026775809"), "isHealthPublicAccountMainPage", "1"), "sourceFrom", String.valueOf(paramInt));
      ...
      ((Intent)localObject2).putExtra("assignBackText", paramContext.getResources().getString(2131690599));
      ((Intent)localObject2).putExtra("call_from", paramInt);
      ((Intent)localObject2).putExtra("FORCE_BLANK_SCREEN_REPORTE", true);
      ((Intent)localObject2).putExtra("big_brother_source_key", ugf.b("3026775809"));
