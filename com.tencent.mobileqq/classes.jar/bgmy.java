...
{
  bgmy(bgmp parambgmp, biau parambiau, String paramString1, String paramString2, String paramString3) {}
  ...
  public void onGetAppPathByName(int paramInt, String paramString, ArkAppMgr.AppPathInfo paramAppPathInfo, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (paramInt != 0)
        {
          apok.a(null, this.c, "FullScreenOrH5Show", 0, 0, 0L, 0L, 0L, "", "");
          if (this.jdField_a_of_type_Bgmp.a != null) {
            ArkFullScreenAppActivity.a(this.jdField_a_of_type_Bgmp.a, this.c, paramAppPathInfo, "0.0.0.1", paramObject, apoh.a(), null, 1);
          }
        }
        do
        {
          ...
          } while (this.jdField_a_of_type_Bgmp.a == null);
          this.jdField_a_of_type_Bgmp.a.startActivity(paramObject);
          return;
          QQToast.a(this.jdField_a_of_type_Bgmp.a, 2131690086, 0).a();
