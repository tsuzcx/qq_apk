...
public class mcz
{
  ...
  {
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131378793) != null)
    {
    ...
    int k = arrayOfInt2[1];
    float f2 = actj.a(0, this.jdField_a_of_type_AndroidViewView.getResources()) + (k - j);
  ...
  private boolean a(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if (paramBoolean)
      {
        ...
        if (!muc.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface)) {
          return false;
        }
      }
  ...
  private void b(TextView paramTextView)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetPopupWindow.setAnimationStyle(2131755783);
    paramTextView.measure(0, 0);
    ...
    int m = actj.a(0, this.jdField_a_of_type_AndroidViewView.getResources());
  ...
  private void d()
  {
    ...
    {
      TextView localTextView = (TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131378793);
  ...
  private void e()
  {
    ...
    do
    {
      ...
      localTextView = null;
      if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) {
        localTextView = (TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131378793);
      }
    ...
    float f1 = i - m - this.jdField_a_of_type_AndroidViewView.getWidth() / 2 - k / 2 - i1 + actj.a(0.0F, this.jdField_a_of_type_AndroidViewView.getResources());
    float f2 = j - n - i2 - actj.a(11.0F, this.jdField_a_of_type_AndroidViewView.getResources());
    ...
    localTextView.getViewTreeObserver().addOnPreDrawListener(new mda(this, localTextView));
    d();
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout == null) {
      b(localTextView);
    }
    for (;;)
    {
      localTextView.setOnClickListener(new mdb(this));
      return;
      a(localTextView);
    }
  }
  ...
  public void a()
  {
    ...
    muc.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
    d();
  }
