  ...
  implements View.OnClickListener
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(new umm(this));
  ...
  private sfi jdField_a_of_type_Sfi = new uml(this);
  ...
  public umk(Activity paramActivity, @Nullable ListView paramListView, String paramString)
  {
    super(paramActivity);
  ...
  private void a(String paramString)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqVpngViewVPNGImageView.setVideo(paramString, false, 1, new umn(this));
    c();
  }
  ...
  private void b(String paramString)
  {
    ...
    this.jdField_a_of_type_Spn = new spn(this.jdField_a_of_type_AndroidAppActivity);
    ukq.a("ReadInJoySuperMaskAd", "initNormalVideoPlayer  mVideoPlayerW = " + this.jdField_a_of_type_Spn);
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_Spn.b();
    if (this.jdField_c_of_type_AndroidViewView != null)
    {
      this.jdField_c_of_type_AndroidViewView.setId(2131369599);
      a(this.jdField_a_of_type_AndroidViewViewGroup);
    }
    this.jdField_a_of_type_Spn.b(2);
    this.jdField_a_of_type_Spn.a(this.jdField_a_of_type_Spn.a());
    this.jdField_a_of_type_Spn.a(this.jdField_a_of_type_Sfi);
    if (this.jdField_c_of_type_AndroidViewView != null) {
      this.jdField_c_of_type_AndroidViewView.setVisibility(0);
    }
    this.jdField_a_of_type_Spn.a(null, paramString, 3, 1L, 0L, 0);
    this.jdField_a_of_type_Spn.c(false);
    c();
  }
  
  private void e()
  {
    LayoutInflater.from(getContext()).inflate(2131560263, this, true);
    setId(2131369647);
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)findViewById(2131372526));
    this.jdField_a_of_type_ComTencentMobileqqVpngViewVPNGImageView = ((VPNGImageView)findViewById(2131369596));
    this.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131372521));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131369439));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131369436));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131369437));
    this.jdField_a_of_type_AndroidViewView = findViewById(2131372527);
    this.jdField_b_of_type_AndroidViewView = findViewById(2131372534);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131369632));
    ((ImmersiveTitleBar2)findViewById(2131379250)).a(0);
  ...
  private void f()
  {
    ...
    if (!this.jdField_c_of_type_Boolean)
    {
      ...
      this.jdField_d_of_type_AndroidWidgetImageView.setImageDrawable(this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130849525));
      ...
      {
        localspn = this.jdField_a_of_type_Spn;
        if (this.jdField_c_of_type_Boolean) {
          break label177;
        }
      }
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      bool1 = false;
      break;
      this.jdField_d_of_type_AndroidWidgetImageView.setImageDrawable(this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130849524));
      break label43;
  ...
  private void h()
  {
    ...
    Object localObject2 = this.jdField_a_of_type_AndroidAppActivity.findViewById(2131380664);
    int i;
    int j;
    ...
    for (;;)
    {
      ...
      for (int k = 1; k != 0; k = 0)
      {
        ...
        ((AnimatorSet)localObject5).addListener(new umo(this));
        return;
      }
      i();
      return;
  ...
  public void a()
  {
    ...
    if (ujg.a.a()) {
      if (this.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean.compareAndSet(false, true)) {
        ujg.a.a(ExposeMode.STRICT, uje.a.a());
      }
    }
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentWidgetListView != null)
      {
        ...
        {
          localObject = ((blcj)localObject).getWrappedAdapter();
          if ((localObject instanceof szd)) {
            ((szd)localObject).a(this.jdField_a_of_type_ComTencentWidgetListView, 0);
          }
        }
      }
      ...
      if (this.jdField_a_of_type_Spn != null)
      {
        this.jdField_a_of_type_Spn.g();
        this.jdField_a_of_type_Spn.h();
      }
      if (this.jdField_a_of_type_AndroidMediaAudioManager != null) {}
      try
      {
  ...
  public void a(int paramInt)
  {
    ...
    {
      ujg.a.a("invalidTypeWithAttach", "");
      umj.a(uje.a.a());
      return;
    }
    if (this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131369647) == null)
    {
      b(paramInt);
    ...
    if (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.compareAndSet(false, true)) {
      ujg.a.a(ExposeMode.LOOSE, uje.a.a());
    }
  ...
  public void a(ViewGroup paramViewGroup)
  {
    ...
    localLayoutParams.addRule(6, 2131369632);
    localLayoutParams.addRule(8, 2131369632);
    localLayoutParams.addRule(0, 2131369632);
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      ukq.a("ReadInJoySuperMaskAd", "click data is : " + localObject2.hashCode());
      ...
      if ((localArticleInfo instanceof AdvertisementInfo))
      {
        ...
        if (((AdvertisementInfo)localArticleInfo).mAdAid == ((AdvertisementInfo)localObject2).mAdAid)
        {
          ...
          ukq.a("ReadInJoySuperMaskAd", "clone data is : " + localObject1.hashCode());
        }
      }
      ...
      default: 
        break;
      case 2131369632: 
        ujg.a.a(26, localObject1);
        if (!ujg.a.a()) {
          break label504;
        }
        localObject2 = "skipMask";
        label203:
        ujg.a.a((String)localObject2, ((AdvertisementInfo)localObject1).mAdTraceId);
        if (this.jdField_a_of_type_ComTencentImageURLDrawable != null) {
    ...
    if (ujg.a.a())
    {
      ...
      localObject1 = "1";
      ((ufz)localObject2).g = ((String)localObject1);
      if ((this.jdField_a_of_type_ComTencentWidgetListView == null) || (this.jdField_a_of_type_ComTencentWidgetListView.getAdapter() == null) || (!(this.jdField_a_of_type_ComTencentWidgetListView.getAdapter() instanceof blcj))) {
        break label577;
      }
      localObject1 = (blcj)this.jdField_a_of_type_ComTencentWidgetListView.getAdapter();
      if ((((blcj)localObject1).getWrappedAdapter() == null) || (!(((blcj)localObject1).getWrappedAdapter() instanceof szc))) {
        break label577;
      }
      localObject1 = (szc)((blcj)localObject1).getWrappedAdapter();
      if (localObject1 != null)
      {
        ((szc)localObject1).jdField_a_of_type_ComTencentGdtadAditemGdtHandler$Params = uvp.a(getContext(), (AdvertisementInfo)localObject3, (szd)localObject1, 0, false, null);
        if (((szc)localObject1).jdField_a_of_type_ComTencentGdtadAditemGdtHandler$Params == null) {
          break label497;
        }
        l = SystemClock.elapsedRealtime();
        label421:
        ((szc)localObject1).jdField_a_of_type_Long = l;
      }
    }
    for (;;)
    {
      ((AdvertisementInfo)localObject3).clickPos = 11;
      uvp.a(this.jdField_a_of_type_AndroidAppActivity, (AdvertisementInfo)localObject3, (szd)localObject1, 0, false, false, null);
      uky.jdField_a_of_type_Boolean = false;
      if (this.jdField_a_of_type_ComTencentImageURLDrawable != null) {
        this.jdField_a_of_type_ComTencentImageURLDrawable.pauseVideo();
      }
      i();
