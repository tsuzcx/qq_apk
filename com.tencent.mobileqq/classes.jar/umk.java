...
public class umk
  extends Handler
{
  public umk(VisitorsActivity paramVisitorsActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 2: 
      ...
      this.a.jdField_a_of_type_ComTencentWidgetXListView.springBackOverScrollHeaderView();
      this.a.jdField_b_of_type_ComTencentWidgetXListView.springBackOverScrollHeaderView();
      this.a.a(1, this.a.getString(2131434827));
      return;
    case 3: 
      ...
      for (;;)
      {
        ...
        return;
        this.a.jdField_b_of_type_Unk.notifyDataSetChanged();
      }
    case 5: 
      ...
      if ((paramMessage instanceof Object[]))
      {
        ...
        this.a.jdField_a_of_type_Unk.a(this.a.jdField_a_of_type_JavaUtilArrayList);
        if (QLog.isColorLevel()) {
          QLog.d("VisitorsActivity", 2, "setDataSet favor UI_ONINIT");
        }
        this.a.jdField_b_of_type_Unk.a(this.a.jdField_b_of_type_JavaUtilArrayList);
        this.a.jdField_a_of_type_Unk.notifyDataSetChanged();
        this.a.jdField_b_of_type_Unk.notifyDataSetChanged();
      }
    ...
    case 11: 
            ...
            if (localObject.length == 2)
            {
              ...
              if (i1 >= i2)
              {
                ...
                if (i1 <= i3)
                {
                  ...
                  {
                    paramMessage = (TextView)paramMessage.findViewById(2131364895);
                    j = m;
                    if (paramMessage != null)
                    {
                      ...
                      this.a.jdField_a_of_type_ComTencentMobileqqNearbyAnimNearbyZanAnimLayout.a(localPraiseInfo, localPraiseInfo.c, f1, f2);
                      label811:
                      i -= 1;
                      if (i <= 0) {
                        break label994;
      ...
      for (;;)
      {
        ...
        break label731;
        label972:
        this.a.jdField_a_of_type_ComTencentMobileqqNearbyAnimNearbyZanAnimLayout.a(localPraiseInfo, localPraiseInfo.jdField_b_of_type_AndroidGraphicsBitmap, f1, f2);
        break label811;
