...
{
  private ArrayList<aogf> a = new ArrayList();
  
  public aoge(AppInterface paramAppInterface)
  {
    super(paramAppInterface);
  }
  
  protected aoge(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    if (paramaogf == null) {}
    while (this.a.contains(paramaogf)) {
      return;
    }
    this.a.add(paramaogf);
  }
  ...
  {
    if ((paramaogf != null) && (this.a.contains(paramaogf))) {
      this.a.remove(paramaogf);
    }
  }
