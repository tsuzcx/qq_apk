...
public class blwn
{
  public static final SparseArray<ConcurrentHashMap<String, blwn>> a;
  public static final AccelerateInterpolator a;
  public static final ConcurrentHashMap<String, blwn> a;
  public byte a;
  float jdField_a_of_type_Float = 1.0F;
  long jdField_a_of_type_Long;
  public ArrayList<WeakReference<blwo>> a;
  long b = 0L;
  long c = 0L;
  ...
  static blwn a(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      blwn localblwn2 = (blwn)localConcurrentHashMap.get(paramString);
      blwn localblwn1 = localblwn2;
      if (localblwn2 == null)
      {
        localblwn1 = new blwn();
        localConcurrentHashMap.put(paramString, localblwn1);
      }
      return localblwn1;
    }
  }
  
  public static blwn a(Object paramObject)
  {
    blwn localblwn = null;
    if ((paramObject instanceof blob)) {
      localblwn = a(1, ((blob)paramObject).a());
    }
    do
    {
      return localblwn;
      ...
      if ((paramObject instanceof bkvu)) {
        return a(3, ((bkvu)paramObject).a);
      }
      if ((paramObject instanceof MusicItemInfo)) {
        return a(2, ((MusicItemInfo)paramObject).mMusicName);
      }
      if ((paramObject instanceof bloe)) {
        return a(4, ((bloe)paramObject).a());
      }
    } while (!(paramObject instanceof blol));
    return a(5, ((blol)paramObject).a());
  }
  ...
  public void a(float paramFloat)
  {
    ...
    if (i >= 0)
    {
      blwo localblwo = (blwo)((WeakReference)this.jdField_a_of_type_JavaUtilArrayList.get(i)).get();
      if (localblwo == null) {
  ...
  public void a(blwo paramblwo)
  {
    int i = this.jdField_a_of_type_JavaUtilArrayList.size() - 1;
    while (i >= 0)
    {
      blwo localblwo = (blwo)((WeakReference)this.jdField_a_of_type_JavaUtilArrayList.get(i)).get();
      if ((localblwo == null) || (localblwo == paramblwo)) {
        this.jdField_a_of_type_JavaUtilArrayList.remove(i);
      }
      i -= 1;
    }
  ...
  public void b(blwo paramblwo)
  {
    this.jdField_a_of_type_JavaUtilArrayList.add(new WeakReference(paramblwo));
  }
