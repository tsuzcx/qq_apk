  ...
  extends bmar
{
  ...
  private static final String[] jdField_a_of_type_ArrayOfJavaLangString = { amtj.a(2131689778), amtj.a(2131689779), amtj.a(2131689780) };
  ...
  private void a()
  {
    ...
    this.jdField_b_of_type_AndroidViewAnimationAnimation.setAnimationListener(new blwo(this));
  ...
  private void a(Runnable paramRunnable)
  {
    ...
    localAnimationSet.setAnimationListener(new blwp(this, paramRunnable));
  ...
  private void b()
  {
    ...
    localAnimationSet.addAnimation(localScaleAnimation);
    localAnimationSet.addAnimation(localTranslateAnimation);
    localAnimationSet.setAnimationListener(new blwq(this));
    this.jdField_a_of_type_AndroidViewView.startAnimation(localAnimationSet);
  }
  ...
  {
    if (!this.jdField_b_of_type_Boolean) {}
    while (bmbk.a().a("has_enter_aio_gif", false, 0)) {
      return false;
    }
    return true;
  }
  ...
  {
    this.jdField_b_of_type_AndroidViewView = this.mRootView.findViewById(2131366845);
    this.jdField_a_of_type_AndroidViewView = this.mRootView.findViewById(2131367586);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367587));
  }
