...
public abstract class atsa
  implements IExcitingTransferRecvListener
{
  protected final int a;
  protected long a;
  protected final atsb a;
  private atsd a;
  ...
  public atsa(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, int paramInt, atsb paramatsb)
  {
    ...
    this.d = paramLong1;
    this.jdField_a_of_type_Atsb = paramatsb;
    this.c = paramLong2;
  ...
  protected ExcitingTransferDownloadReqInfo a()
  {
    ...
    {
      localExcitingTransferDownloadReqInfo.fileSize = this.jdField_a_of_type_Atsb.a();
      localExcitingTransferDownloadReqInfo.md5 = this.jdField_a_of_type_Atsb.a();
      localExcitingTransferDownloadReqInfo.isSupportHttps = this.jdField_a_of_type_Atsb.b();
      localExcitingTransferDownloadReqInfo.sslCName = this.jdField_a_of_type_Atsb.d();
      localExcitingTransferDownloadReqInfo.strFileName = this.jdField_a_of_type_Atsb.a();
      if (this.jdField_a_of_type_Atsb.a() != null) {
        localExcitingTransferDownloadReqInfo.mHosts = ((ExcitingTransferHostInfo[])this.jdField_a_of_type_Atsb.a().toArray(new ExcitingTransferHostInfo[this.jdField_a_of_type_Atsb.a().size()]));
      }
      localExcitingTransferDownloadReqInfo.strFileName = this.jdField_a_of_type_Atsb.a();
      localExcitingTransferDownloadReqInfo.serverPath = this.jdField_a_of_type_Atsb.b();
    }
    for (;;)
    {
  ...
  public void a(int paramInt, ExcitingTransferDownloadCompletedInfo paramExcitingTransferDownloadCompletedInfo)
  {
    ...
    if (this.jdField_a_of_type_Atsd != null) {
      this.jdField_a_of_type_Atsd.a(paramInt, paramExcitingTransferDownloadCompletedInfo);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Atsd != null) {
      this.jdField_a_of_type_Atsd.a(paramLong1, paramLong2, paramLong3);
    }
  }
  
  public void a(atsd paramatsd)
  {
    this.jdField_a_of_type_Atsd = paramatsd;
  }
  ...
  public void a(ExcitingTransferDownloadCompletedInfo paramExcitingTransferDownloadCompletedInfo)
  {
    ...
    if (this.jdField_a_of_type_Atsd != null) {
      this.jdField_a_of_type_Atsd.a(0, paramExcitingTransferDownloadCompletedInfo);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Atsb != null) {
      return "Cookie:t=0;v=" + AppSetting.a() + ";" + this.jdField_a_of_type_Atsb.c() + ";\r\n";
    }
    return "";
  }
  ...
  public void onOneSlotComplete(int paramInt, ExcitingTransferOneSlotComplete paramExcitingTransferOneSlotComplete)
  {
    ...
    for (String str = paramExcitingTransferOneSlotComplete.m_strIp;; str = "")
    {
      ...
      this.jdField_a_of_type_Atsd.a(paramInt, paramExcitingTransferOneSlotComplete);
      return;
      str = "";
      break label52;
    }
  ...
  public void onRecvComplete(int paramInt, ExcitingTransferDownloadCompletedInfo paramExcitingTransferDownloadCompletedInfo)
  {
    ...
    if (paramInt == 0)
    {
      ...
      label69:
      QLog.i("ExcitingTransfer.BaseDownloader<FileAssistant>", 1, str);
      if ((bool) && (this.jdField_a_of_type_Atsb != null)) {
        this.jdField_b_of_type_Long = this.jdField_a_of_type_Atsb.a();
      }
  ...
  public void onRecvStart()
  {
    ...
    } while (this.jdField_a_of_type_Atsd == null);
    this.jdField_a_of_type_Atsd.a();
  }
