...
{
  static final int[] jdField_a_of_type_ArrayOfInt = { 2131375580, 2131375576, 2131375575, 2131375581, 2131375578, 2131375579, 2131375577 };
  int jdField_a_of_type_Int;
  private amng jdField_a_of_type_Amng = new atsi(this);
  private View.OnLongClickListener jdField_a_of_type_AndroidViewView$OnLongClickListener = new atss(this);
  ...
  atoj jdField_a_of_type_Atoj;
  private attc jdField_a_of_type_Attc;
  private ayvz jdField_a_of_type_Ayvz = new atsr(this);
  ...
  private amng jdField_b_of_type_Amng = new atsj(this);
  ...
  private amng jdField_c_of_type_Amng = new atst(this);
  ...
  public atsa(NearbyPeopleProfileActivity paramNearbyPeopleProfileActivity)
  {
    ...
    if (Build.VERSION.SDK_INT >= 11) {
      this.jdField_a_of_type_Attc = new attc(this, this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.f);
    }
    this.jdField_h_of_type_Int = vzo.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, 2.0F);
    int k = atoj.jdField_a_of_type_ArrayOfInt.length - 1;
    this.jdField_a_of_type_ArrayOfAtfk = new atfk[k];
    int j = 0;
    while (j < k)
    {
      this.jdField_a_of_type_ArrayOfAtfk[j] = new atfk(atoj.jdField_a_of_type_ArrayOfInt[j]);
      j += 1;
    }
    this.jdField_a_of_type_Ayvz.addFilter(new Class[] { ayst.class });
    this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.a().a(this.jdField_a_of_type_Ayvz);
  }
  
  private View.OnClickListener a(int paramInt)
  {
    return new atsy(this, paramInt);
  }
  ...
  private RelativeLayout a(PicInfo paramPicInfo, Drawable paramDrawable)
  {
    ...
    localRelativeLayout.setBackgroundResource(2130844238);
    ...
    if (Build.VERSION.SDK_INT >= 11)
    {
      ...
      localRelativeLayout.setOnDragListener(this.jdField_a_of_type_Attc);
    }
  ...
  private void a(PicInfo paramPicInfo, View paramView)
  {
    ...
    paramPicInfo = bbcv.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, ajyc.a(2131707329), 0, 0, null, null);
    paramPicInfo.setPositiveButton(2131694793, new attb(this, paramPicInfo));
    paramPicInfo.show();
  }
  ...
  private void a(CustomImgView paramCustomImgView, PicInfo paramPicInfo, Drawable paramDrawable)
  {
    ...
    if (paramDrawable == null) {
      localObject = this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getResources().getDrawable(2130844863);
    }
    try
    {
    ...
    {
      paramCustomImgView.setImageDrawable(URLDrawable.getDrawable(aysr.a(paramDrawable), localURLDrawableOptions));
      return;
    }
    label258:
  }
  ...
  {
    RelativeLayout localRelativeLayout = new RelativeLayout(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity);
    localRelativeLayout.setBackgroundResource(2130840977);
    Object localObject = new RelativeLayout.LayoutParams(vzo.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, 35.0F), vzo.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, 16.0F));
    int j = vzo.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, 5.0F);
    ...
    ((TextView)localObject).setText(ajyc.a(2131707348));
  ...
  private boolean e()
  {
    ...
    if (!bbjw.a(str))
    {
      if (bbjw.d(str).length() == 0)
      {
        this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.b(ajyc.a(2131707267));
        return false;
      }
    }
    else
    {
      this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.b(ajyc.a(2131707280));
      return false;
    }
    return true;
  }
  ...
  private void j()
  {
    bfol localbfol = bfol.c(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity);
    Object localObject = (DispatchActionMoveScrollView)localbfol.findViewById(2131361923);
    ((DispatchActionMoveScrollView)localObject).jdField_a_of_type_Boolean = true;
    ((DispatchActionMoveScrollView)localObject).setBackgroundResource(17170445);
    localObject = (IphonePickerView)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity).inflate(2131560805, null);
    ((IphonePickerView)localObject).a(this.jdField_b_of_type_Amng);
    if (this.jdField_h_of_type_AndroidWidgetEditText.getTag() != null)
    {
      ...
      ((IphonePickerView)localObject).setPickListener(new atsw(this, (IphonePickerView)localObject, localbfol));
      localbfol.a(new atsx(this));
    ...
    localbfol.show();
    a(this.jdField_e_of_type_AndroidWidgetLinearLayout, localbfol.a());
        ...
        if (((RelativeLayout)localObject).getChildCount() == 2) {
          if (j == 0)
          {
            ...
            if (this.jdField_a_of_type_AndroidWidgetLinearLayout.getChildAt(j) != null) {
              this.jdField_a_of_type_AndroidWidgetLinearLayout.getChildAt(j).setContentDescription(ajyc.a(2131707258) + (j + 1));
            }
          }
        }
      }
  ...
  private void m()
  {
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "dc00899", "grp_lbs", "", "data_card", "del_pho", 0, 0, "", "", "", "");
  }
  
  private void n()
  {
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "dc00899", "grp_lbs", "", "data_card", "up_gif", 0, 0, "", "", "", "");
  }
  ...
  private void o()
  {
    ...
    {
      Object localObject = this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131694595, new Object[] { this.jdField_a_of_type_JavaLangString });
      localObject = bbcv.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, (String)localObject, 0, 0, null, null);
      ((bbgg)localObject).setPositiveButton(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131694972), new atta(this, (bbgg)localObject));
  ...
  private void p()
  {
    this.jdField_a_of_type_AndroidWidgetTextView.setText(ajyc.a(2131707287));
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    this.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131707248));
    ...
    localTextView.setOnClickListener(new atsk(this));
    ...
    this.jdField_b_of_type_AndroidViewView.findViewById(2131375327).setOnClickListener(this);
  }
  ...
  private void q()
  {
    if (this.jdField_a_of_type_JavaUtilLinkedList.size() > 0)
    {
      Object localObject = new StringBuilder(ajyc.a(2131707276));
  ...
  Intent a(String paramString)
  {
    ...
    paramString = ajsf.aW + "nearby_people_photo/";
    ...
    localIntent.putExtra("PhotoConst.QZONE_COVER_CROP_LEFT_TITLE", ajyc.a(2131707281));
  ...
  public void a()
  {
    this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.a().b(this.jdField_a_of_type_Ayvz);
  }
  ...
  public void a(int paramInt)
  {
    ...
    bbbj.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, false, true);
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X800481F", "0X800481F", 1, 0, "", "", "", "");
  }
  ...
  void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    j = paramInt2 + 1;
    int m = paramInt3 + 1;
    localObject1 = bbbd.a(paramInt2 + 1, paramInt3 + 1);
                      ...
                      if ((paramInt2 == -1) && (paramIntent != null))
                      {
                        ...
                        for (;;)
                        {
                          try
                          {
                            ...
                            paramInt1 = j;
                            if (paramInt1 < this.jdField_a_of_type_ArrayOfAtfk.length)
                            {
                              if (this.jdField_a_of_type_ArrayOfAtfk[paramInt1].jdField_a_of_type_Int != paramInt2) {
                                break label406;
                              }
                              paramIntent = this.jdField_a_of_type_ArrayOfAtfk[paramInt1];
                            ...
                            this.jdField_a_of_type_Atoj.a(this.jdField_a_of_type_ArrayOfAtfk);
                        ...
                        if ((paramInt2 == -1) && (this.jdField_d_of_type_AndroidWidgetEditText != null))
                        {
                          ...
                          if (paramInt2 == -1)
                          {
                            ...
                            try
                            {
                              paramIntent = this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.jdField_a_of_type_Ajty.a((String[])localObject2);
                              if (paramIntent != null)
                              {
  ...
  protected void a(View paramView)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131365508));
    ...
    this.jdField_a_of_type_AndroidWidgetHorizontalScrollView = ((HorizontalScrollView)paramView.findViewById(2131365509));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131365489));
    ...
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131376629));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131365506));
    this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131365507));
    this.jdField_e_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131376457));
    ...
    this.jdField_c_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131362190));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131363955));
    ...
    this.jdField_e_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131364572));
    this.jdField_d_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131364360));
    this.jdField_f_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131364359));
    this.jdField_g_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131363978));
    this.jdField_f_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131367563));
    this.jdField_g_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131379552));
    this.jdField_h_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131376452));
    ...
    this.jdField_h_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131375574));
    this.jdField_a_of_type_ComTencentWidgetImmersiveImmersiveTitleBar2 = ((ImmersiveTitleBar2)paramView.findViewById(2131377439));
    this.jdField_a_of_type_ComTencentMobileqqWidgetBounceScrollView = ((BounceScrollView)this.jdField_b_of_type_AndroidViewView.findViewById(2131365513));
    ...
    this.jdField_a_of_type_Atoj = new atoj();
    this.jdField_a_of_type_Atoj.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, paramView);
    p();
  }
  ...
  public void a(NearbyPeopleCard paramNearbyPeopleCard)
  {
    ...
    {
      j = ((Integer)atbg.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getCurrentAccountUin(), "self_gender", Integer.valueOf(-1))).intValue();
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "dc00899", "grp_lbs", "", "data_card", "exp_edit", 0, 0, atbp.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.jdField_j_of_type_Int), j + "", "", "");
      ...
      this.jdField_a_of_type_JavaLangString = ajyc.a(2131707277);
      if (!this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.godFlag) {
        break label1232;
      }
      this.jdField_d_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131694561));
      this.jdField_a_of_type_AndroidWidgetButton.setContentDescription(ajyc.a(2131707241));
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new atsc(this));
      e();
      ...
      this.jdField_b_of_type_AndroidWidgetEditText.setText(bazj.b(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.gender));
      ...
      int n = (0xFF00 & k) >> 8;
      int i1 = k & 0xFF;
      paramNearbyPeopleCard = bbbd.a(n, i1);
      ...
      this.jdField_e_of_type_AndroidWidgetTextView.setText(bazj.d(j));
      if (!bbjw.a(bazj.d(j))) {
        break label1276;
      }
      this.jdField_e_of_type_AndroidWidgetTextView.setVisibility(8);
      this.jdField_d_of_type_AndroidWidgetEditText.setText(bazj.e(j));
      ...
      paramNearbyPeopleCard = (String)atbg.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getCurrentAccountUin(), "school_name", "");
      if (!this.jdField_b_of_type_Boolean)
      {
        ...
        this.i = ((Integer)atbg.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getCurrentAccountUin(), "school_valid_state", Integer.valueOf(0))).intValue();
        if (this.i != 2) {
          break label1298;
        }
      ...
      this.jdField_h_of_type_AndroidWidgetEditText.setText(bazj.a(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.maritalStatus - 1));
      ...
      if (bazj.a(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.vGiftInfo) == 0) {
        break label1439;
      }
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.godFlag)
      {
        paramNearbyPeopleCard = this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131694596, new Object[] { this.jdField_a_of_type_JavaLangString });
        paramNearbyPeopleCard = bbcv.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, paramNearbyPeopleCard, 0, 0, null, null);
        paramNearbyPeopleCard.setPositiveButton(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131694972), new atsd(this, paramNearbyPeopleCard));
      ...
      this.jdField_b_of_type_AndroidViewView.findViewById(2131379553).setOnClickListener(this);
      this.jdField_g_of_type_AndroidWidgetEditText.setOnClickListener(this);
      this.jdField_b_of_type_AndroidViewView.findViewById(2131376457).setOnClickListener(this);
      ...
      this.jdField_b_of_type_AndroidViewView.findViewById(2131362192).setOnClickListener(this);
      ...
      this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new atse(this));
      this.jdField_g_of_type_AndroidWidgetEditText.addTextChangedListener(new atsf(this));
      this.jdField_e_of_type_AndroidWidgetEditText.addTextChangedListener(new atsg(this));
      this.jdField_a_of_type_AndroidWidgetEditText.getViewTreeObserver().addOnGlobalLayoutListener(new atsh(this));
      return;
      ...
      this.jdField_a_of_type_JavaLangString = ajyc.a(2131707332);
      break label268;
      label1232:
      if (this.jdField_a_of_type_JavaUtilArrayList.size() <= NearbyPeopleProfileActivity.jdField_b_of_type_Int) {
        break label295;
      }
      this.jdField_d_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131694562, new Object[] { this.jdField_a_of_type_JavaLangString }));
      break label295;
      label1276:
      this.jdField_e_of_type_AndroidWidgetTextView.setBackgroundResource(bazj.b(j));
      this.jdField_e_of_type_AndroidWidgetTextView.setVisibility(0);
      break label587;
      label1298:
      ...
      for (;;)
      {
        atbg.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getCurrentAccountUin(), "school_name", this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.college);
        atbg.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getCurrentAccountUin(), "school_valid_state", Integer.valueOf(this.i));
        break;
        this.jdField_g_of_type_AndroidWidgetTextView.setVisibility(0);
        this.i = 2;
        continue;
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    if (TextUtils.isEmpty(paramString))
    {
      ...
      {
        this.jdField_g_of_type_AndroidWidgetTextView.setVisibility(0);
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8006784", "0X8006784", 0, 0, "", "", "", "");
      }
    }
    else
    {
  ...
  public boolean a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard != null)
    {
      ...
      if (!bbbd.a(this.jdField_a_of_type_AndroidWidgetEditText.getText().toString(), this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.nickname)) {
        return true;
      }
      ...
      if (!bbjw.d(this.jdField_e_of_type_AndroidWidgetEditText.getText().toString()).equals(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.company)) {
        return true;
      }
      if (!bbjw.d(this.jdField_f_of_type_AndroidWidgetTextView.getText().toString()).equals(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.college)) {
        return true;
      }
      ...
      Object localObject2 = this.jdField_a_of_type_ArrayOfAtfk;
    ...
    for (int k = j;; k = j)
    {
      if (k != 0)
      {
        ...
        j = 0;
        break label440;
        localObject1 = ((atfk)localObject1).toString();
        break label507;
      }
      return false;
      break;
  ...
  public void c()
  {
    ...
    ajty localajty = (ajty)this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getManager(59);
    int j = localajty.a();
    Object localObject1;
    if (j != 0)
    {
      j = localajty.a(j, true);
      if (QLog.isColorLevel()) {
        QLog.d("Q.nearby_people_card.", 2, "startLocationSelectActivity | update result = " + j);
      }
      if (j == 2)
      {
        bcpw.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, 2131694609, 0).b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getTitleBarHeight());
        return;
      }
      if (j == 0)
      {
        ...
        localajty.c(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.jdField_a_of_type_Ajuc);
        return;
      }
      this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getResources().getString(2131691031));
    ...
    localIntent.putExtra("param_location_param", localajty.b((String[])localObject1));
  ...
  public void d()
  {
    ...
    do
    {
      ...
      str = this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.jdField_a_of_type_Ajty.a(arrayOfString);
  ...
  void e()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.oldPhotoCount > 0) && (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.age >= 14) && (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.age <= 24) && (this.jdField_a_of_type_JavaUtilArrayList.size() <= 1)) {
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X800481B", "0X800481B", 0, 0, "", "", "", "");
    }
    if (Build.VERSION.SDK_INT >= 11)
    {
  ...
  void f()
  {
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004823", "0X8004823", 0, 0, "", "", "", "");
    if (QLog.isDevelopLevel()) {
  ...
  void g()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.a(ajyc.a(2131707324));
    ArrayList localArrayList = new ArrayList();
    localArrayList.addAll(this.jdField_a_of_type_JavaUtilArrayList);
    if (d())
    {
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 10, 0, "", "", "", "");
    ...
    for (int j = 1;; j = 3)
    {
      ...
      {
        localObject = "1";
        axqw.b(null, "dc00899", "grp_lbs", "", "data_card", "upload_video", 0, 0, "", (String)localObject, "", String.valueOf(j));
        j = ((Integer)atbg.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getCurrentAccountUin(), "self_gender", Integer.valueOf(-1))).intValue();
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "dc00899", "grp_lbs", "", "data_card", "suc_edit", 0, 0, atbp.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.jdField_j_of_type_Int), j + "", "", "");
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard != null)
        {
          ...
          if (!Arrays.equals(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.xuanYan, (byte[])this.jdField_g_of_type_AndroidWidgetEditText.getTag()))
          {
            ...
            axqw.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 2, 0, "", "", "", "");
          }
          ...
          if (!((String)localObject).equals(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.nickname))
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.d = true;
            axqw.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 1, 0, "", "", "", "");
          }
          if ((this.jdField_h_of_type_AndroidWidgetEditText.getTag() != null) && (((Byte)this.jdField_h_of_type_AndroidWidgetEditText.getTag()).byteValue() != this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.maritalStatus))
          {
            localBundle.putByte("key_marital_status", ((Byte)this.jdField_h_of_type_AndroidWidgetEditText.getTag()).byteValue());
            axqw.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 3, 0, "", "", "", "");
          }
          ...
          if (b1 != this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.gender)
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.d = true;
            axqw.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 4, 0, "", "", "", "");
          }
          ...
          if (j != this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.birthday)
          {
            ...
            axqw.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 5, 0, "", "", "", "");
          }
          ...
          if (j != this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.job)
          {
            ...
            axqw.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 6, 0, "", "", "", "");
          }
          ...
          if (!((String)localObject).equals(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.company))
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.d = true;
            axqw.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 7, 0, "", "", "", "");
          }
          ...
          if (!((String)localObject).equals(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.college))
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.d = true;
            axqw.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 8, 0, "", "", "", "");
          }
          ...
          if (!Arrays.equals((Object[])localObject, new String[] { this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.hometownCountry, this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.hometownProvice, this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.hometownCity, this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.hometownDistrict }))
          {
            ...
            axqw.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 9, 0, "", "", "", "");
          }
          boolean bool2 = this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem.a();
          if (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.switchGiftVisible != 0L) {
            break label1242;
          ...
          if (bool2 != bool1)
          {
            ...
            axqw.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X80060BB", "0X80060BB", 0, 0, "", "", "", "");
          }
          if (QLog.isColorLevel()) {
        ...
        localObject = this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.jdField_a_of_type_Atbx;
        if (localObject == null) {
          break label1288;
        }
        this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.a(new NearbyProfileEditPanel.23(this, (atbx)localObject, localBundle, localArrayList));
      }
      label1242:
      label1247:
      label1252:
      while (!QLog.isDevelopLevel())
      {
        ...
        j = 1;
        break label1110;
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X80060BC", "0X80060BC", 0, 0, "", "", "", "");
        break label1158;
      }
  ...
  public void onClick(View paramView)
  {
    ...
    {
      localObject1 = bfol.c(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity);
      localObject2 = (DispatchActionMoveScrollView)((bfol)localObject1).findViewById(2131361923);
      ...
      localObject2 = (IphonePickerView)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity).inflate(2131560805, null);
      ((IphonePickerView)localObject2).a(this.jdField_c_of_type_Amng);
      if (this.jdField_b_of_type_AndroidWidgetEditText.getTag() != null)
      {
        ...
        ((IphonePickerView)localObject2).setPickListener(new atsb(this, (IphonePickerView)localObject2, (bfol)localObject1));
        ((bfol)localObject1).a(new atsl(this));
        ((bfol)localObject1).a((View)localObject2, null);
        ((bfol)localObject1).show();
        a(paramView, ((bfol)localObject1).a());
    ...
    do
    {
      do
      {
        ...
        if (paramView == this.jdField_d_of_type_AndroidWidgetLinearLayout)
        {
          ...
          paramView = bfng.a(bfng.a(bfng.a(bfng.a("https://qun.qq.com/qqweb/m/nearby/pages/school_edit.html", "_bid", "2473"), "_wv", "1031"), "schoolName", paramView), "isValid", String.valueOf(this.i));
        ...
        if ((paramView.getId() == 2131379553) || (paramView == this.jdField_g_of_type_AndroidWidgetEditText))
        {
          i();
          return;
        }
        if ((paramView.getId() == 2131376457) || (paramView == this.jdField_h_of_type_AndroidWidgetEditText))
        {
          j();
          return;
        }
      } while ((paramView.getId() != 2131362192) && (paramView != this.jdField_c_of_type_AndroidWidgetEditText));
      localObject1 = bfol.c(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity);
      localObject2 = Calendar.getInstance();
      this.jdField_b_of_type_Int = ((Calendar)localObject2).get(1);
      localObject3 = (DispatchActionMoveScrollView)((bfol)localObject1).findViewById(2131361923);
      ...
      localObject3 = (IphonePickerView)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity).inflate(2131560805, null);
      ((IphonePickerView)localObject3).a(this.jdField_a_of_type_Amng);
    ...
    for (j = 0;; j = (j & 0xFF) - 1)
    {
      ...
      ((IphonePickerView)localObject3).setPickListener(new atsu(this, (IphonePickerView)localObject3, (bfol)localObject1));
      ...
      ((bfol)localObject1).a(new atsv(this));
      ((bfol)localObject1).a((View)localObject3, null);
      ((bfol)localObject1).show();
      a(paramView, ((bfol)localObject1).a());
