...
public class blkc
  extends anii
{
  public blkc(QQAppInterface paramQQAppInterface)
  {
  ...
  private oidb_cmd0xd68.ForwardDataWireReqBody a(String paramString1, String paramString2, String paramString3, byte[] paramArrayOfByte, String paramString4, String paramString5, long paramLong)
  {
    ...
    boolean bool = atwl.b(paramString1);
    if ((TextUtils.isEmpty(paramString5)) && (bool))
    {
      localForwardDataWireReqBody.str_file_name.set(atwl.b(paramString1));
      localForwardDataWireReqBody.uint64_file_size.set(atwl.a(paramString1));
    }
  ...
  private void a(ToServiceMsg paramToServiceMsg, oidb_cmd0xd68.RspBody paramRspBody)
  {
    ...
    do
    {
      ...
      paramToServiceMsg = this.app.a().a(l);
    ...
    agjf.a().a(this.app, paramToServiceMsg.msgSeq);
  ...
  private void b(ToServiceMsg paramToServiceMsg, oidb_cmd0xd68.RspBody paramRspBody)
  {
    ...
    for (int i = 1; i == 0; i = 0)
    {
      if (paramToServiceMsg.status != 2)
      {
        ...
        this.app.a().c(paramToServiceMsg);
      }
    ...
    atvo.b(paramToServiceMsg.nSessionId);
    ...
    for (;;)
    {
      ...
      paramRspBody = new atvn();
      paramRspBody.b = "send_file_suc";
      paramRspBody.a = 1;
      atvm.a(this.app.getCurrentAccountUin(), paramRspBody);
      atvo.a(this.app, paramToServiceMsg);
      return;
  ...
  private void c(ToServiceMsg paramToServiceMsg, oidb_cmd0xd68.RspBody paramRspBody)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        paramToServiceMsg = (anjx)this.app.a(8);
        ...
        paramRspBody = this.app.a().a(i).a(l);
      ...
      {
        localObject = this.app.a().a(paramRspBody.entityID);
        if (localObject != null)
        {
