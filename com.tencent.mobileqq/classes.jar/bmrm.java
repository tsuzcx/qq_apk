...
public class bmrm
{
  ...
  private ITMAssistantDownloadClientListener jdField_a_of_type_ComTencentTmdownloaderITMAssistantDownloadClientListener = new bmrn(this);
  ...
  private HashMap<String, bmro> jdField_b_of_type_JavaUtilHashMap = new HashMap();
  
  static
  {
    jdField_a_of_type_JavaLangString = bmrm.class.getName();
  }
  
  public bmrm(Context paramContext)
  {
  ...
  public void a(String paramString1, String paramString2, bmro parambmro)
  {
    ...
    if (localFile.exists())
    {
      if (parambmro != null)
      {
        parambmro.a(paramString1, localFile.length(), localFile.length());
        parambmro.a(paramString1, 3, 0, null, paramString2);
      }
      return;
    }
    if (!this.jdField_b_of_type_JavaUtilHashMap.containsKey(paramString1))
    {
      this.jdField_b_of_type_JavaUtilHashMap.put(paramString1, parambmro);
