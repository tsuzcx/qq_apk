...
public class aroa
{
  ...
  public static arob a(int paramInt1, int paramInt2, aroc paramaroc, boolean paramBoolean)
  {
    ...
    default: 
      ...
      if (i > j)
      {
        i3 = i;
        n = j;
        switch (paramaroc.jdField_a_of_type_Int)
        {
        default: 
          paramaroc = new arob();
          paramaroc.jdField_a_of_type_Int = paramInt1;
          paramaroc.b = paramInt2;
          return paramaroc;
        }
      }
      break;
  ...
  public static arob a(int paramInt1, int paramInt2, String paramString)
  {
    int i = g;
    int j = h;
    ...
    if (bdcs.b(paramString))
    {
      ...
      localarob.jdField_a_of_type_Int = localOptions.outWidth;
      localarob.b = localOptions.outHeight;
      paramString = localarob;
  ...
  public static arob a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    int i;
    if (paramInt1 > paramInt2) {
      i = paramInt2;
    ...
    {
      aroc localaroc = a(i, j);
      i = a(paramInt1, paramInt2, jdField_a_of_type_Int);
      return a(paramInt1 * i, i * paramInt2, localaroc, false);
      i = paramInt1;
    }
  }
  
  public static arob a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    float f1;
    int k;
    if (bdcs.b(paramFileManagerEntity.strMiddleThumPath))
    {
      BitmapFactory.Options localOptions = new BitmapFactory.Options();
      localOptions.inJustDecodeBounds = true;
      ...
      localarob.jdField_a_of_type_Int = localOptions.outWidth;
      localarob.b = localOptions.outHeight;
      paramFileManagerEntity = localarob;
  ...
  private static aroc a(int paramInt1, int paramInt2)
  {
    int i = 0;
    int j = 1;
    ...
    for (;;)
    {
      ...
      localaroc.jdField_a_of_type_Int = paramInt2;
      localaroc.b = paramInt1;
      return localaroc;
      paramInt1 = 2;
      paramInt2 = 2;
      continue;
  ...
  public static String a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    if (!TextUtils.isEmpty(paramFileManagerEntity.strFileMd5)) {
      paramFileManagerEntity = bhma.a(paramFileManagerEntity.strFileMd5);
    }
    for (;;)
    {
      ...
      {
        paramFileManagerEntity = bhma.a(paramFileManagerEntity.Uuid);
      }
      else if (arof.b(paramFileManagerEntity.getFilePath()))
      {
        localObject = arni.d(paramFileManagerEntity.getFilePath());
        if ((localObject != null) && (localObject.length > 0)) {
          paramFileManagerEntity = bdcv.a((byte[])localObject).toUpperCase();
        } else {
          paramFileManagerEntity = bhma.a(paramFileManagerEntity.fileName);
        }
      }
      else
      {
  ...
  public static String a(String paramString)
  {
    ...
    {
      return null;
      String str1 = bdcv.a(arni.d(paramString));
      a();
      str1 = armo.a().d() + a(5, str1);
      ...
      for (;;)
      {
        for (;;)
        {
          ...
          {
            if (!bdcs.b(str2)) {
              awgi.a(paramString, str2, true, "", 1);
            }
            if ((!bdcs.b(str2)) || (bdcs.b(new File(str2), new File(str1)) != true)) {
              break;
            }
            return str1;
          }
  ...
  private static String a(String paramString1, String paramString2, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        awgi.a(paramString1, str, true, "", paramInt);
        if (bdcs.b(str)) {
          break label220;
        }
      ...
      continue;
      label220:
      if (!bdcs.b(new File(str), new File(paramString2)))
      {
        bdcs.a(str, true);
  ...
  public static URL a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    if (TextUtils.isEmpty((CharSequence)localObject1)) {
      localObject2 = bdcv.a(arni.d(paramFileManagerEntity.getFilePath())).toUpperCase();
    }
    localObject1 = armo.a().d() + a(5, bhma.a((String)localObject2));
    if ((bdcs.b(str)) && (!arof.b(paramFileManagerEntity.strMiddleThumPath)) && (bdcs.b(new File(str), new File((String)localObject1)) == true)) {
  ...
  {
    File localFile = new File(armo.a().d());
    if (!localFile.exists()) {
      localFile.mkdirs();
    }
  }
  ...
  private static void a(FileManagerEntity paramFileManagerEntity, String paramString)
  {
    ...
    paramString = a(paramString, armo.a().d() + a(5, str), 1);
    if (paramString == null) {
  ...
  public static boolean a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    while ((paramFileManagerEntity.cloudType == 1) && (arni.a(paramFileManagerEntity))) {
      return true;
    }
    return false;
  }
  ...
  public static URL b(FileManagerEntity paramFileManagerEntity)
  {
    ...
    if (paramFileManagerEntity.status == 16)
    {
      ...
      {
        if (!arof.b(paramFileManagerEntity.strLargeThumPath)) {
          break label129;
        }
    ...
    for (;;)
    {
      ...
      localObject1 = localObject2;
      if (!arof.b(paramFileManagerEntity.strThumbPath)) {
        break label46;
      }
  ...
  public static void d(FileManagerEntity paramFileManagerEntity)
  {
    ...
    if (bdcs.b(paramFileManagerEntity.strLargeThumPath))
    {
