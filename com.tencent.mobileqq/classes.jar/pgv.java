  ...
  implements View.OnClickListener
{
  ...
  public pgv(Context paramContext, azwg paramazwg, qoe paramqoe)
  {
  ...
  private TextView a(int paramInt)
  {
    ...
    localTextView.setId(2131309034);
    localTextView.setTextSize(2, 11.0F);
    localTextView.setGravity(17);
    localTextView.setText(ajjy.a(2131638658));
    localTextView.setWidth(azvv.a(this.jdField_a_of_type_AndroidContentContext, 30.0F));
    localTextView.setHeight(azvv.a(this.jdField_a_of_type_AndroidContentContext, 17.0F));
    if (paramInt == 0)
    {
      localTextView.setTextColor(Color.argb(255, 255, 255, 255));
      localTextView.setBackgroundResource(2130848197);
      return localTextView;
    }
    localTextView.setTextColor(-89258);
    localTextView.setBackgroundResource(2130848198);
    return localTextView;
  }
  ...
  public pez d()
  {
    ...
    View localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131494417, localRelativeLayout, true);
    this.jdField_d_of_type_AndroidViewView = localView.findViewById(2131303380);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131306044));
    this.jdField_b_of_type_AndroidViewView = localView.findViewById(2131309613);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView = ((KandianUrlImageView)localView.findViewById(2131302919));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131312553));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131312457));
    this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localView.findViewById(2131302963));
    this.jdField_c_of_type_AndroidWidgetTextView = new TextView(this.jdField_a_of_type_AndroidContentContext);
    FrameLayout.LayoutParams localLayoutParams = new FrameLayout.LayoutParams(-2, -2);
    localLayoutParams.leftMargin = azvv.a(this.jdField_a_of_type_AndroidContentContext, 5.0F);
    localLayoutParams.gravity = 16;
    this.jdField_c_of_type_AndroidWidgetTextView.setTextSize(2, 12.0F);
    this.jdField_c_of_type_AndroidWidgetTextView.setId(2131309027);
    ((FrameLayout)localView.findViewById(2131300725)).addView(this.jdField_c_of_type_AndroidWidgetTextView, localLayoutParams);
    this.jdField_a_of_type_ComTencentImageURLImageView.setOnClickListener(this);
    this.jdField_c_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)localView.findViewById(2131303682));
    this.jdField_c_of_type_AndroidViewView = localView.findViewById(2131313327);
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131297843));
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)localView.findViewById(2131300730));
    this.jdField_b_of_type_AndroidWidgetFrameLayout = ((FrameLayout)localView.findViewById(2131300729));
  ...
  public pez o()
  {
    ...
    {
      localopw = (opw)this.jdField_a_of_type_JavaLangObject;
      localArticleInfo = localopw.a();
    ...
    ((RelativeLayout.LayoutParams)localObject1).width = awmc.a;
    ...
    if (localArticleInfo.mVideoCoverUrl != null)
    {
      ...
      obj.a((KandianUrlImageView)localObject2, (URL)localObject1, this.jdField_a_of_type_AndroidContentContext, true);
      if (jdField_a_of_type_AndroidGraphicsDrawableDrawable == null) {
        jdField_a_of_type_AndroidGraphicsDrawableDrawable = bacm.b();
      }
    ...
    for (;;)
    {
      ...
      if (localopw.e() == 0)
      {
        ...
        ((FrameLayout.LayoutParams)localObject1).setMargins(azvv.a(this.jdField_a_of_type_AndroidContentContext, 5.0F), 0, 0, azvv.a(this.jdField_a_of_type_AndroidContentContext, 2.0F));
        ...
        ((ViewGroup.LayoutParams)localObject1).height = azvv.a(this.jdField_a_of_type_AndroidContentContext, 47.0F);
        this.jdField_a_of_type_AndroidWidgetLinearLayout.setLayoutParams((ViewGroup.LayoutParams)localObject1);
        this.jdField_a_of_type_AndroidWidgetLinearLayout.setBackgroundColor(this.jdField_a_of_type_AndroidWidgetLinearLayout.getResources().getColor(2131101537));
        return this;
        ...
        localObject1 = obz.a(localArticleInfo.mFirstPagePicUrl);
        break;
    ...
    for (;;)
    {
      ...
      return this;
      label766:
      this.jdField_b_of_type_AndroidWidgetTextView.setText(qcn.c(localArticleInfo.mVideoPlayCount));
