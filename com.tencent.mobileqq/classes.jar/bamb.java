  ...
  implements bats
{
  ...
  public bamb(String paramString, int paramInt, bama parambama)
  {
    this.jdField_d_of_type_JavaLangString = (FileUtils.genSeperateFileDir(paramString) + "audio_data_cache" + File.separator);
    this.jdField_a_of_type_Bama = parambama;
  }
  
  private boolean b()
  {
    return (c()) && (!TextUtils.isEmpty(this.jdField_d_of_type_JavaLangString)) && (this.jdField_a_of_type_Bama != null);
  }
  ...
  public void a()
  {
    ...
    {
      return;
      this.jdField_c_of_type_JavaLangString = (this.jdField_d_of_type_JavaLangString + bcmk.a() + ".pcm");
      ...
      try
      {
        ...
        this.e = 0;
        if ((!this.jdField_b_of_type_Boolean) || (this.jdField_a_of_type_Batq != null)) {
          continue;
        }
        this.jdField_a_of_type_Batq = new batq();
        this.jdField_a_of_type_Batq.a(bcjb.q);
        this.jdField_a_of_type_Batq.a(this);
        this.jdField_a_of_type_Batq.a(this.jdField_b_of_type_JavaLangString);
        bnzb.a("AudioChangerManager", "New mHwAudioEncoder");
        return;
      }
      ...
      for (;;)
      {
        ...
        if (localObject != null) {
          try
          {
            ...
            if ((this.jdField_a_of_type_Batq != null) && (this.jdField_b_of_type_Boolean))
            {
              byte[] arrayOfByte = new byte[localObject.length];
              System.arraycopy(localObject, 0, arrayOfByte, 0, localObject.length);
              this.jdField_a_of_type_Batq.a(arrayOfByte, 0L);
            }
  ...
  public void b()
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Batq != null) {
        this.jdField_a_of_type_Batq.c();
      }
      if (!this.jdField_b_of_type_Boolean) {
        this.jdField_a_of_type_Bama.c(this.jdField_c_of_type_JavaLangString);
      }
      return;
    }
    catch (IOException localIOException)
  ...
  public void h()
  {
    bnzb.a("AudioChangerManager", "[onAudioFileEncoded]");
    this.jdField_a_of_type_Bama.c(this.jdField_b_of_type_JavaLangString);
    this.jdField_a_of_type_Batq = null;
  }
  
  public void i()
  {
    bnzb.a("AudioChangerManager", "[onAudioFileEncodeFailed]");
    if (this.jdField_a_of_type_Bama != null) {
      this.jdField_a_of_type_Bama.a(-6);
    }
    this.jdField_a_of_type_Batq = null;
  }
}
