  ...
  implements GetChars, Spannable, CharSequence, Cloneable
{
  ...
  private ArrayList<bamc> jdField_b_of_type_JavaUtilArrayList = new ArrayList();
  
  public bamb(CharSequence paramCharSequence, int paramInt)
  {
      ...
      if ((paramStringBuilder.charAt(paramInt1) == '<') && (paramInt1 < k - 2))
      {
        ...
        if ((i2 == 36) && (paramInt1 < k - 3))
        {
          ...
          for (;;)
          {
            ...
            a(new bamw(i, paramInt3, 1), paramInt1, paramInt1 + 4, 33);
            paramInt1 += 4;
            break;
            if (j == 10) {
          ...
          if ((j >= 255) && (paramInt1 + 6 < k))
          {
            if (paramStringBuilder.charAt(paramInt1 + 6) == '>')
            {
              ...
              {
                bool = true;
                a(new bamy(arrayOfChar, paramInt3, true, bool), paramInt1, paramInt1 + 7, 33);
                i = 2;
                label375:
                if (i >= 5) {
                  break label451;
          ...
          else if (j == 250)
          {
            ...
            a(new bamw(10, paramInt3, 1), paramInt1, paramInt1 + 4, 33);
            paramInt1 += 4;
          }
        }
        else
        {
          ...
          if (((i2 == 37) || (i2 == 38)) && (paramInt1 < k - 6))
          {
            ...
            a(new bdso(i, (i1 & 0xFF) + ((j << 24) + 0 + (m << 16 & 0xFF0000) + (n << 8 & 0xFF00))), paramInt1, paramInt1 + 7, 33);
            paramInt1 += 7;
            continue;
          }
        }
  ...
  private void a(Object paramObject, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    paramObject = new bamc(paramInt1, paramInt2, paramInt3);
  ...
  public int getSpanEnd(Object paramObject)
  {
    ...
    return ((bamc)this.jdField_b_of_type_JavaUtilArrayList.get(i)).b;
  }
  ...
  public int getSpanFlags(Object paramObject)
  {
    ...
    return ((bamc)this.jdField_b_of_type_JavaUtilArrayList.get(i)).c;
  }
  ...
  public int getSpanStart(Object paramObject)
  {
    ...
    return ((bamc)this.jdField_b_of_type_JavaUtilArrayList.get(i)).jdField_a_of_type_Int;
  }
  ...
  public <T> T[] getSpans(int paramInt1, int paramInt2, Class<T> paramClass)
  {
    ...
    while (i < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      {
        bamc localbamc = (bamc)this.jdField_b_of_type_JavaUtilArrayList.get(i);
        if ((localbamc.jdField_a_of_type_Int >= paramInt1) && (localbamc.b <= paramInt2)) {
  ...
  public int nextSpanTransition(int paramInt1, int paramInt2, Class paramClass)
  {
    ...
    while (k < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      bamc localbamc = (bamc)this.jdField_b_of_type_JavaUtilArrayList.get(k);
      int i = paramInt2;
      if (((Class)localObject).isInstance(paramClass))
      {
        int j = paramInt2;
        if (localbamc.jdField_a_of_type_Int > paramInt1)
        {
          j = paramInt2;
          if (localbamc.jdField_a_of_type_Int < paramInt2) {
            j = localbamc.jdField_a_of_type_Int;
          }
        }
        i = j;
        if (localbamc.b > paramInt1)
        {
          i = j;
          if (localbamc.b < j) {
            i = localbamc.b;
  ...
  public void removeSpan(Object paramObject)
  {
    ...
    if (i >= 0)
    {
      ...
      bamc localbamc = (bamc)this.jdField_b_of_type_JavaUtilArrayList.remove(i);
      b(paramObject, localbamc.jdField_a_of_type_Int, localbamc.b);
    }
  }
  ...
  public void setSpan(Object paramObject, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      localbamc = (bamc)this.jdField_b_of_type_JavaUtilArrayList.get(i);
      int j = localbamc.jdField_a_of_type_Int;
      int k = localbamc.b;
      localbamc.jdField_a_of_type_Int = paramInt1;
      localbamc.b = paramInt2;
      localbamc.c = paramInt3;
      a(paramObject, j, k, paramInt1, paramInt2);
    }
    if (i < 0)
    {
      this.jdField_a_of_type_JavaUtilArrayList.add(paramObject);
      localbamc = new bamc(paramInt1, paramInt2, paramInt3);
      this.jdField_b_of_type_JavaUtilArrayList.add(localbamc);
