...
public class blcj
{
  ...
  public static Drawable a(int paramInt1, int paramInt2, blcn paramblcn)
  {
    if (a.containsKey(Integer.valueOf(paramInt1))) {
      return blck.a().a("https://qzonestyle.gtimg.cn/qzone/qzact/act/external/qzone_vip_icon/qzone_yellow_icon_v8.zip", paramInt2, (String)a.get(Integer.valueOf(paramInt1)), paramblcn);
    }
    switch (paramInt1)
    {
    default: 
    ...
    return BaseApplicationImpl.getContext().getResources().getDrawable(2130849229);
  }
  
  public static Drawable a(String paramString, int paramInt1, int paramInt2, int paramInt3, blcn paramblcn)
  {
    return a(paramString, paramInt1, paramInt2, paramInt3, paramblcn, 0);
  }
  
  public static Drawable a(String paramString, int paramInt1, int paramInt2, int paramInt3, blcn paramblcn, int paramInt4)
  {
    switch (paramInt4)
    {
    }
    ...
    {
      return null;
      blck.a().a(paramString, paramInt1, "border", paramblcn);
      continue;
      switch (paramInt3)
      {
      }
    }
    return blck.a().a(paramString, paramInt1, "head", paramblcn);
    return blck.a().a(paramString, paramInt1, "bottom_lv" + paramInt2, paramblcn);
    return blck.a().a(paramString, paramInt1, "right", paramblcn);
  }
  
  public static Drawable a(String paramString, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean, int paramInt4, blcn paramblcn)
  {
    String str = a(paramInt1, paramInt3, paramBoolean, paramInt4);
    if (!TextUtils.isEmpty(str)) {
      return blck.a().a(paramString, paramInt2, str, true, paramblcn);
    }
    return null;
  }
