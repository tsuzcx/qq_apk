...
public class bocd
{
  ...
  /* Error */
  public boce a(long paramLong)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 165	bocd:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   4: ifnonnull +5 -> 9
    //   7: aconst_null
    //   8: areturn
    //   9: new 174	boce
    //   12: dup
    //   13: aload_0
    //   14: invokespecial 177	boce:<init>	(Lbocd;)V
    //   17: astore 4
    //   19: aload_0
    //   20: getfield 165	bocd:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   23: lload_1
    ...
    //   42: aload 4
    //   44: iload_3
    //   45: putfield 182	boce:jdField_a_of_type_Int	I
    //   48: aload 4
    //   50: aload_0
    //   51: getfield 184	bocd:jdField_a_of_type_ArrayOfJavaNioByteBuffer	[Ljava/nio/ByteBuffer;
    //   54: iload_3
    //   55: aaload
    //   56: putfield 187	boce:jdField_a_of_type_JavaNioByteBuffer	Ljava/nio/ByteBuffer;
    //   59: aload_0
    //   60: monitorexit
    //   61: aload 4
    //   63: areturn
    ...
    //   73: aload 4
    //   75: iload_3
    //   76: putfield 182	boce:jdField_a_of_type_Int	I
    //   79: aload 4
    //   81: getstatic 146	bocd:jdField_a_of_type_JavaLangReflectMethod	Ljava/lang/reflect/Method;
    //   84: aload_0
    //   85: getfield 165	bocd:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   88: iconst_1
    ...
    //   105: putfield 187	boce:jdField_a_of_type_JavaNioByteBuffer	Ljava/nio/ByteBuffer;
    //   108: aload_0
    //   109: monitorexit
    //   110: aload 4
    //   112: areturn
    ...
    //   120: aload 4
    //   122: iconst_0
    //   123: putfield 203	boce:jdField_a_of_type_Boolean	Z
    //   126: goto -18 -> 108
    //   129: astore 4
    //   131: aload_0
    //   132: monitorexit
    ...
    //   143: aload 4
    //   145: iconst_0
    //   146: putfield 203	boce:jdField_a_of_type_Boolean	Z
    //   149: goto -41 -> 108
    //   152: astore 5
    //   154: aload 5
    ...
    //   159: aload 4
    //   161: iconst_0
    //   162: putfield 203	boce:jdField_a_of_type_Boolean	Z
    //   165: goto -57 -> 108
    //   168: aload 4
    //   170: iload_3
    //   171: putfield 182	boce:jdField_a_of_type_Int	I
    //   174: aload 4
    //   176: areturn
    ...
    //   27	144	3	i	int
    //   17	45	4	localboce1	boce
    //   64	57	4	localboce2	boce
    //   129	46	4	localboce3	boce
  ...
  public void a(boce paramboce)
  {
    try
    {
      ...
      {
        this.jdField_a_of_type_AndroidMediaMediaCodec.releaseOutputBuffer(paramboce.jdField_a_of_type_Int, false);
        if (QLog.isColorLevel()) {
          QLog.d(jdField_c_of_type_JavaLangString, 2, "releaseOutputBuffer index = " + paramboce.jdField_a_of_type_Int);
        }
      }
      return;
    }
  ...
  public void a(boce paramboce, int paramInt1, long paramLong, int paramInt2)
  {
    try
    {
      if (this.jdField_a_of_type_AndroidMediaMediaCodec != null) {
        this.jdField_a_of_type_AndroidMediaMediaCodec.queueInputBuffer(paramboce.jdField_a_of_type_Int, 0, paramInt1, paramLong, paramInt2);
      }
      return;
    }
    finally
  ...
  public boce b(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject5 = new boce(this);
        i = this.jdField_a_of_type_AndroidMediaMediaCodec.dequeueOutputBuffer(((boce)localObject5).jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo, paramLong);
        switch (i)
        {
        case -3: 
          if (i < 0) {
          ...
          if (QLog.isColorLevel()) {
            QLog.d(jdField_c_of_type_JavaLangString, 2, "dequeueOutputBuffer ok,index = " + i + ",BufferInfo[flags = " + ((boce)localObject5).jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo.flags + ",offset=" + ((boce)localObject5).jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo.offset + ",size= " + ((boce)localObject5).jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo.size + ",TimeUs=" + ((boce)localObject5).jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo.presentationTimeUs + "]");
          }
          if (Build.VERSION.SDK_INT > 20) {
            break label444;
          }
          ((boce)localObject5).jdField_a_of_type_JavaNioByteBuffer = this.jdField_b_of_type_ArrayOfJavaNioByteBuffer[i];
          ((boce)localObject5).jdField_a_of_type_Int = i;
          ((boce)localObject5).jdField_a_of_type_AndroidMediaMediaFormat = this.jdField_b_of_type_AndroidMediaMediaFormat;
          ...
          this.jdField_b_of_type_ArrayOfJavaNioByteBuffer = this.jdField_a_of_type_AndroidMediaMediaCodec.getOutputBuffers();
          ((boce)localObject5).jdField_a_of_type_Int = -3;
        }
      }
      finally {}
      ((boce)localObject5).jdField_a_of_type_Int = -2;
      ...
      if (this.jdField_b_of_type_AndroidMediaMediaFormat != null)
      {
        ...
        else if (QLog.isColorLevel())
        {
          ...
          ((boce)localObject5).jdField_a_of_type_Int = -1;
          ...
          try
          {
            ((boce)localObject5).jdField_a_of_type_JavaNioByteBuffer = ((ByteBuffer)jdField_b_of_type_JavaLangReflectMethod.invoke(this.jdField_a_of_type_AndroidMediaMediaCodec, new Object[] { Integer.valueOf(i) }));
            ((boce)localObject5).jdField_a_of_type_AndroidMediaMediaFormat = ((MediaFormat)jdField_c_of_type_JavaLangReflectMethod.invoke(this.jdField_a_of_type_AndroidMediaMediaCodec, new Object[] { Integer.valueOf(i) }));
          ...
          catch (IllegalAccessException localIllegalAccessException)
          {
            for (;;)
            {
              ...
              ((boce)localObject5).jdField_a_of_type_Boolean = false;
            }
          }
