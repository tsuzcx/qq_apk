...
{
  static final ArrayList<bftn> c = new ArrayList();
  private final ListAdapter jdField_a_of_type_AndroidWidgetListAdapter;
  ArrayList<bftn> jdField_a_of_type_JavaUtilArrayList;
  boolean jdField_a_of_type_Boolean;
  ArrayList<bftn> jdField_b_of_type_JavaUtilArrayList;
  private final boolean jdField_b_of_type_Boolean;
  
  public bfsi(ArrayList<bftn> paramArrayList1, ArrayList<bftn> paramArrayList2, ListAdapter paramListAdapter)
  {
  ...
  private boolean a(ArrayList<bftn> paramArrayList)
  {
    if (paramArrayList != null)
    {
      paramArrayList = paramArrayList.iterator();
      while (paramArrayList.hasNext()) {
        if (!((bftn)paramArrayList.next()).jdField_a_of_type_Boolean) {
          return false;
        }
      }
    }
  ...
  public boolean a(View paramView)
  {
    ...
    {
      if (((bftn)this.jdField_a_of_type_JavaUtilArrayList.get(i)).jdField_a_of_type_AndroidViewView == paramView)
      {
  ...
  public boolean b(View paramView)
  {
    ...
    {
      if (((bftn)this.jdField_b_of_type_JavaUtilArrayList.get(i)).jdField_a_of_type_AndroidViewView == paramView)
      {
  ...
  public Object getItem(int paramInt)
  {
    int i = a();
    if (paramInt < i) {
      return ((bftn)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).jdField_a_of_type_JavaLangObject;
    }
    int j = paramInt - i;
    paramInt = 0;
    if (this.jdField_a_of_type_AndroidWidgetListAdapter != null)
    ...
    return ((bftn)this.jdField_b_of_type_JavaUtilArrayList.get(j - paramInt)).jdField_a_of_type_JavaLangObject;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    int j = a();
    if (paramInt < j) {
      return ((bftn)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).jdField_a_of_type_AndroidViewView;
    }
    int k = paramInt - j;
    paramInt = 0;
    if (this.jdField_a_of_type_AndroidWidgetListAdapter != null)
    ...
    try
    {
      paramView = ((bftn)this.jdField_b_of_type_JavaUtilArrayList.get(k - paramInt)).jdField_a_of_type_AndroidViewView;
      return paramView;
    }
  ...
  public boolean isEnabled(int paramInt)
  {
    int k = a();
    if (paramInt < k) {
      return ((bftn)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).jdField_a_of_type_Boolean;
    }
    int m = paramInt - k;
    int i;
    if (this.jdField_a_of_type_AndroidWidgetListAdapter != null)
    ...
    boolean bool = ((bftn)this.jdField_b_of_type_JavaUtilArrayList.get(m - i)).jdField_a_of_type_Boolean;
    return bool;
  }
