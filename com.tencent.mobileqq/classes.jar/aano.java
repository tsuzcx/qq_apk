  ...
  implements MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnSeekCompleteListener
{
  ...
  private aanp jdField_a_of_type_Aanp;
  ...
  public void a(aanp paramaanp)
  {
    this.jdField_a_of_type_Aanp = paramaanp;
  }
  ...
  public void a(VsMusicItemInfo paramVsMusicItemInfo)
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewVsMusicItemInfo != null)
    {
      ...
      aanb.a("edit_smart_music_play", aanb.a((HashMap)localObject));
    }
    ...
    do
    {
      ...
      } while (this.jdField_a_of_type_Aanp == null);
      this.jdField_a_of_type_Aanp.a(this.jdField_a_of_type_AndroidMediaMediaPlayer, -2, -1);
      return;
    ...
    this.jdField_a_of_type_Aanp.a(this.jdField_a_of_type_AndroidMediaMediaPlayer, -1, -1);
    return;
  ...
  {
    if ((this.jdField_a_of_type_Aanp != null) && (paramInt1 != -38)) {
      this.jdField_a_of_type_Aanp.a(paramMediaPlayer, paramInt1, paramInt2);
    }
    return false;
  }
  ...
  {
    if ((paramMediaPlayer != null) && (this.jdField_a_of_type_Aanp != null) && (!paramMediaPlayer.isPlaying()))
    {
      this.c = (System.currentTimeMillis() - this.jdField_a_of_type_Long);
      this.jdField_b_of_type_Long = System.currentTimeMillis();
      this.jdField_a_of_type_Aanp.a(paramMediaPlayer, this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewVsMusicItemInfo);
    }
  }
}
