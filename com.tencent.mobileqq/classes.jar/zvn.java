...
public class zvn
{
  ...
  public zvn(String paramString)
  {
    a(paramString);
  }
  
  public static zvn a(int paramInt, String paramString)
  {
    long l;
    byte[] arrayOfByte;
    Object localObject;
    ...
    for (;;)
    {
      localObject = new zvo(paramInt, (short)4, arrayOfByte);
  ...
  public String a()
  {
    if (this.jdField_a_of_type_JavaUtilArrayList != null)
    {
      ...
      for (int i = 4;; i = ((zvo)((Iterator)localObject1).next()).a() + i)
      {
        j = i;
    ...
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (!this.jdField_a_of_type_JavaUtilArrayList.isEmpty()))
    {
      ...
      {
        zvo localzvo = (zvo)((Iterator)localObject2).next();
        ((ByteBuffer)localObject1).put((byte)localzvo.jdField_a_of_type_Int);
        ((ByteBuffer)localObject1).putShort(localzvo.jdField_a_of_type_Short);
        ((ByteBuffer)localObject1).put(localzvo.jdField_a_of_type_ArrayOfByte);
      }
    }
    ...
    return bhml.a((byte[])localObject2);
  }
  
  public zvo a()
  {
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (!this.jdField_a_of_type_JavaUtilArrayList.isEmpty())) {
      return (zvo)this.jdField_a_of_type_JavaUtilArrayList.get(0);
    }
    return null;
  }
  ...
  {
    Object localObject = bhml.a(paramString);
    ...
    {
      localObject = new zvo();
      ((zvo)localObject).jdField_a_of_type_Int = paramString.get();
      byte[] arrayOfByte = new byte[2];
      paramString.get(arrayOfByte);
      ((zvo)localObject).jdField_a_of_type_Short = zyx.a(arrayOfByte);
      arrayOfByte = new byte[((zvo)localObject).jdField_a_of_type_Short];
      paramString.get(arrayOfByte);
      ((zvo)localObject).jdField_a_of_type_ArrayOfByte = arrayOfByte;
