  ...
  implements Manager
{
  ...
  ajxl jdField_a_of_type_Ajxl = new akae(this);
  private SharedPreferences jdField_a_of_type_AndroidContentSharedPreferences;
  private askm jdField_a_of_type_Askm = new akaf(this);
  ...
  private ArrayList<afly> jdField_c_of_type_JavaUtilArrayList;
  ...
  public akac(QQAppInterface paramQQAppInterface)
  {
    ...
    if (this.jdField_a_of_type_Askm != null)
    {
      ...
      if (paramQQAppInterface != null) {
        paramQQAppInterface.a(this.jdField_a_of_type_Askm);
      }
    }
  }
  
  private afly a(oidb_0xc26.TabInfo paramTabInfo)
  {
    afly localafly = new afly();
    localafly.jdField_a_of_type_Int = paramTabInfo.uint32_tab_id.get();
    localafly.jdField_b_of_type_Int = paramTabInfo.uint32_recommend_count.get();
    String str;
    if (paramTabInfo.bytes_table_name.has())
    {
      str = paramTabInfo.bytes_table_name.get().toStringUtf8();
      localafly.jdField_a_of_type_JavaLangString = str;
      if (!paramTabInfo.bytes_icon_url_select.has()) {
        break label116;
      }
      str = paramTabInfo.bytes_icon_url_select.get().toStringUtf8();
      label77:
      localafly.jdField_b_of_type_JavaLangString = str;
  ...
  private RecentRecommendTroopItem a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      ??? = ((aktg)localObject2).b(paramString, 8113);
      paramString = localObject1;
      if (??? == null) {
        break;
      }
      ((aktg)localObject2).b((RecentUser)???);
      return localObject1;
      label249:
      k += 1;
      continue;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramBoolean)
        {
          ...
          this.jdField_a_of_type_Aukn.b((String)localObject2);
        }
        if (paramArrayList.size() > 0)
        {
          ...
          while (paramArrayList.hasNext())
          {
            ...
            this.jdField_a_of_type_Aukn.a((aukm)localObject2);
          }
        }
      }
  ...
  private <T extends MayKnowRecommend> ArrayList<T> b(@NonNull ArrayList<T> paramArrayList)
  {
    ...
    while (paramArrayList.hasNext())
    {
      ...
      if (!localajxn.b(localMayKnowRecommend.uin))
      {
        boolean bool = localajxn.a(localMayKnowRecommend.uin, false, true);
        if (bool) {}
        for (int k = 1;; k = 0)
        {
  ...
  private void c(List<oidb_0xc26.TabInfo> paramList)
  {
    ...
    for (??? = "null";; ??? = Integer.valueOf(paramList.size()))
    {
      ...
      synchronized (this.jdField_d_of_type_JavaLangObject)
      {
        ...
        if (((afly)localObject2).jdField_a_of_type_Int == 23) {
          ((afly)localObject2).jdField_b_of_type_Int += c().size();
        }
  ...
  private void d(List<afly> paramList)
  {
    for (;;)
    {
      SharedPreferences localSharedPreferences;
      ...
      synchronized (this.jdField_e_of_type_JavaLangObject)
      {
        ...
        paramList = paramList.iterator();
        if (paramList.hasNext()) {
          localJSONArray.put(afly.a((afly)paramList.next()));
        }
      }
  ...
  private void e(int paramInt)
  {
    synchronized (this.jdField_f_of_type_JavaLangObject)
    {
      ...
      {
        ArrayList localArrayList = (ArrayList)this.jdField_a_of_type_Aukn.a(MayKnowRecommend.class, false, "tabID=?", new String[] { paramInt + "" }, null, null, null, null);
        synchronized (this.jdField_f_of_type_JavaLangObject)
        {
  ...
  private void k()
  {
    ...
    {
      localaukp.a();
      this.jdField_a_of_type_Aukn.b("delete from MayKnowRecommend");
      this.jdField_a_of_type_Aukn.b("delete from MayKnowExposure");
      localaukp.c();
      bool1 = true;
    }
  ...
  private void l()
  {
    ...
    amqa localamqa = ampz.a();
    StringBuilder localStringBuilder;
    if (localamqa != null)
    {
      this.jdField_g_of_type_Int = localamqa.jdField_a_of_type_Int;
      this.jdField_a_of_type_JavaLangString = localamqa.jdField_a_of_type_JavaLangString;
      if (localamqa.jdField_b_of_type_Int == 1)
      {
        bool1 = true;
  ...
  private void m()
  {
    ...
    {
      Object localObject2 = this.jdField_a_of_type_Aukn.a(MayKnowExposure.class, false, null, null, null, null, null, null);
  ...
  private void n()
  {
    Object localObject1 = (ArrayList)this.jdField_a_of_type_Aukn.a(RecentRecommendTroopItem.class);
    Object localObject3;
    int k;
  ...
  private void o()
  {
    ...
    ArrayList localArrayList = (ArrayList)this.jdField_a_of_type_Aukn.a(MayKnowRecommend.class, false, "tabID=? or tabID is null", new String[] { "23" }, null, null, null, null);
    Object localObject3;
    if (QLog.isColorLevel())
    {
    ...
    synchronized (this.jdField_d_of_type_JavaLangObject)
    {
      ...
      synchronized (this.jdField_e_of_type_JavaLangObject)
      {
        ...
        try
        {
          ...
          {
            localArrayList.add(afly.a(((JSONArray)localObject4).getJSONObject(k)));
            k += 1;
          }
  ...
  public int a()
  {
    ...
    int k = 0;
    p();
    if (!((afsa)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(295)).c()) {}
    for (int m = 1;; m = 0) {
      label148:
      for (;;)
      {
        synchronized (this.jdField_d_of_type_JavaLangObject)
        {
          if (this.jdField_c_of_type_JavaUtilArrayList != null)
          {
            ...
            {
              afly localafly = (afly)localIterator.next();
              if ((localafly.jdField_a_of_type_Int != 23) && (m == 0)) {
                break label148;
              }
              k = localafly.jdField_b_of_type_Int + k;
              break label148;
            }
          }
          if (QLog.isColorLevel()) {
  ...
  public ArrayList<afly> a()
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_d_of_type_JavaLangObject)
      {
        ...
        localafly = afly.a((afly)localIterator.next());
        if (localafly.jdField_a_of_type_Int == 23)
        {
          localafly.jdField_a_of_type_Boolean = true;
          localArrayList.add(localafly);
        }
      }
      localafly.jdField_a_of_type_Boolean = bool;
    }
    if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        ...
        synchronized (this.jdField_d_of_type_JavaLangObject)
        {
          if (this.jdField_c_of_type_JavaUtilArrayList != null)
          {
            ...
            {
              afly localafly = (afly)((Iterator)localObject3).next();
              if ((localafly.equals(paramList)) && ((localafly.jdField_b_of_type_Int != paramList.jdField_b_of_type_Int) || (!localafly.jdField_a_of_type_JavaLangString.equals(paramList.jdField_a_of_type_JavaLangString)) || (!localafly.jdField_b_of_type_JavaLangString.equals(paramList.jdField_b_of_type_JavaLangString)) || (!localafly.c.equals(paramList.c))))
              {
                localafly.jdField_b_of_type_Int = paramList.jdField_b_of_type_Int;
                localafly.jdField_a_of_type_JavaLangString = paramList.jdField_a_of_type_JavaLangString;
                localafly.jdField_b_of_type_JavaLangString = paramList.jdField_b_of_type_JavaLangString;
                localafly.c = paramList.c;
                d(this.jdField_c_of_type_JavaUtilArrayList);
              }
            }
          }
  ...
  public void a(View paramView, Context paramContext, String paramString)
  {
    ...
    if ((paramString.equals("sp_uin_for_title")) && (k == 2131374954))
    {
      paramView = bfol.a(paramContext);
      paramView.b(2131691252);
      paramView.c(2131690596);
      paramView.a(new akad(this, paramView));
      paramView.show();
      axqw.b(null, "dc00899", "Grp_recom", "", "msg_tab", "clk_ellipsis", 0, 0, "", "", "", "");
    }
    for (;;)
    {
      return;
      if ((paramView.getTag() != null) && ((paramView.getTag() instanceof ahpc)))
      {
        paramView = (ahpc)paramView.getTag();
        if (paramView.a == null) {
          break;
        }
        ...
        for (paramView = (RecentRecommendTroopItem)paramView.a.mUser.extraInfo; paramView != null; paramView = null)
        {
          ...
          if (k == 2131363570)
          {
            ...
            axqw.b(null, "dc00899", "Grp_recom", "", "msg_tab", "clk_add", 0, 0, paramView.uin, paramView.recomAlgol, "", "");
            return;
          }
          ...
          for (;;)
          {
            try
            {
              ...
              if (TextUtils.isEmpty(paramView.recommendReason))
              {
                ...
                localObject = myd.a(paramView);
                if (localObject != null) {
                  paramString.labels = ((ArrayList)localObject);
                }
                paramString.strJoinSig = paramView.authSig;
                bamn.a(paramContext, bamn.a(107, paramString, 10018, false), 2);
                axqw.b(null, "dc00899", "Grp_recom", "", "msg_tab", "clk_grp", 0, 0, paramView.uin, paramView.recomAlgol, "", "");
                return;
              }
            }
      ...
      for (;;)
      {
        synchronized (jdField_a_of_type_JavaLangObject)
        {
          ...
          if ((paramBoolean) && (localMayKnowRecommend != null)) {
            this.jdField_a_of_type_Aukn.b(localMayKnowRecommend);
          }
          p();
          ...
          synchronized (this.jdField_c_of_type_JavaUtilArrayList)
          {
            ...
            for (;;)
            {
              ...
              localafly = (afly)localIterator.next();
              label217:
              label222:
              synchronized (this.jdField_f_of_type_JavaLangObject)
              {
                ...
                {
                  if (localafly.jdField_b_of_type_Int <= 0) {
                    break;
                  }
                  k = localafly.jdField_b_of_type_Int - 1;
                  localafly.jdField_b_of_type_Int = k;
                }
              }
            }
          }
        ...
        break label217;
        label252:
        Object localObject3 = (ArrayList)this.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(localafly.jdField_a_of_type_Int));
        if (localObject3 != null)
        {
          ...
          if (((Iterator)localObject3).hasNext())
          {
            ...
            localafly.jdField_b_of_type_Int -= 1;
          }
        }
      }
      label336:
  ...
  public void a(@NonNull ArrayList<MayKnowRecommend> paramArrayList)
  {
    ...
    //   37: aload_0
    //   38: aload_1
    //   39: invokespecial 327	akac:b	(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    //   42: astore 4
    //   44: aload 4
    //   46: astore_3
    //   47: aload 4
    ...
    //   71: astore_3
    //   72: getstatic 46	akac:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   75: astore 4
    //   77: aload 4
    //   79: monitorenter
    //   80: aload_0
    //   81: getfield 135	akac:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   84: invokevirtual 1198	java/util/ArrayList:clear	()V
    //   87: aload_0
    //   88: getfield 135	akac:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   91: aload_3
    ...
    //   98: monitorexit
    //   99: aload_0
    //   100: getfield 124	akac:jdField_a_of_type_Aukn	Laukn;
    //   103: invokevirtual 336	aukn:a	()Laukp;
    //   106: astore 4
    //   108: aload 4
    //   110: invokevirtual 340	aukp:a	()V
    //   113: aload_0
    //   114: getfield 124	akac:jdField_a_of_type_Aukn	Laukn;
    //   117: ldc_w 632
    //   120: invokevirtual 347	aukn:b	(Ljava/lang/String;)Z
    //   123: pop
    //   124: aload_3
    ...
    //   159: invokevirtual 1257	akac:a	(Laukm;)Z
    //   162: pop
    //   163: goto -23 -> 140
    //   166: astore_3
    ...
    //   183: aload 4
    //   185: invokevirtual 372	aukp:b	()V
    //   188: iconst_0
    //   189: istore_2
    //   190: aload_0
    //   191: getfield 96	akac:jdField_f_of_type_JavaLangObject	Ljava/lang/Object;
    //   194: astore_3
    //   195: aload_3
    //   196: monitorenter
    //   197: aload_0
    //   198: getfield 83	akac:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   201: ifnull +10 -> 211
    //   204: aload_0
    //   205: getfield 83	akac:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    ...
    //   243: iconst_1
    //   244: aload_0
    //   245: getfield 135	akac:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   274: athrow
    //   275: aload 4
    //   277: invokevirtual 387	aukp:c	()V
    //   280: aload 4
    //   282: invokevirtual 372	aukp:b	()V
    //   285: iconst_1
    //   286: istore_2
    //   287: goto -97 -> 190
    //   290: astore_1
    //   291: aload 4
    //   293: invokevirtual 372	aukp:b	()V
    //   296: aload_1
    //   297: athrow
    //   298: astore_1
    //   299: aload_3
  ...
  public void a(List<String> paramList, long paramLong1, long paramLong2, boolean paramBoolean)
  {
    ...
    //   21: astore 7
    //   23: getstatic 46	akac:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   26: astore 8
    //   28: aload 8
    //   30: monitorenter
    //   31: aload_0
    //   32: getfield 135	akac:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   147: ifne -134 -> 13
    //   150: aload_0
    //   151: getfield 124	akac:jdField_a_of_type_Aukn	Laukn;
    //   154: invokevirtual 336	aukn:a	()Laukp;
    //   157: astore_1
    //   158: aload_1
    //   159: invokevirtual 340	aukp:a	()V
    //   162: aload 7
    ...
    //   196: aload_0
    //   197: aload 8
    //   199: invokevirtual 1257	akac:a	(Laukm;)Z
    //   202: pop
    //   203: goto -34 -> 169
    //   206: astore 7
    //   208: ldc 237
    ...
    //   217: aload_1
    //   218: invokevirtual 372	aukp:b	()V
    //   221: return
    //   222: aload_1
    //   223: invokevirtual 387	aukp:c	()V
    //   226: aload_1
    //   227: invokevirtual 372	aukp:b	()V
    //   230: return
    //   231: astore 7
    //   233: aload_1
    //   234: invokevirtual 372	aukp:b	()V
    //   237: aload 7
    //   239: athrow
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  public void a(boolean paramBoolean, List<oidb_0xc26.RecommendInfo> arg2)
  {
    ...
    localaukp.a();
    this.jdField_a_of_type_Aukn.b("delete from RecentRecommendTroopItem");
        ...
        for (;;)
        {
          if (localIterator2.hasNext())
          {
            ...
            if (localRgroupInfo.uint64_group_code.has())
            {
              ...
              localRecentRecommendTroopItem.labelList = akfd.b(localRgroupInfo.rpt_group_label.get());
    ...
    for (;;)
    {
      ...
      for (k = localRgroupInfo.int32_uin_privilege.get();; k = -1)
      {
        ...
        this.jdField_a_of_type_Aukn.b(localRecentRecommendTroopItem);
  ...
  protected boolean a(aukm paramaukm)
  {
    ...
    QLog.d("MayknowRecommendManager", 2, "updateEntity em closed e=" + paramaukm.getTableName());
    return false;
  }
  ...
  public boolean a(String paramString)
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      paramString = localaktg.b(paramString, 8112);
      bool1 = bool2;
      if (paramString != null)
      {
  ...
  public boolean a(List<RecentBaseData> paramList)
  {
    ...
    for (;;)
    {
      ...
      if (m < paramList.size())
      {
        ...
        i1 = n;
        if (!ahmx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (RecentBaseData)localObject2)) {
          i1 = n + 1;
        }
        if (i1 == 3) {
          m += 1;
  ...
  public boolean a(boolean paramBoolean, List<MayKnowRecommend> paramList)
  {
    ...
    for (paramList = new LinkedList(this.jdField_a_of_type_JavaUtilArrayList);; paramList = null)
    {
      ...
      if ((paramList != null) && (!paramList.isEmpty()))
      {
        ...
        {
          ((aukp)???).a();
          this.jdField_a_of_type_Aukn.b("delete from MayKnowRecommend where tabID=23");
          paramList = paramList.iterator();
    ...
    try
    {
      if (this.jdField_c_of_type_JavaUtilArrayList != null)
      {
        ...
        if (!this.jdField_c_of_type_JavaUtilArrayList.isEmpty()) {
          localObject1 = (afly)this.jdField_c_of_type_JavaUtilArrayList.get(0);
        }
      }
      if (localObject1 != null)
      {
        localObject1 = a(((afly)localObject1).jdField_a_of_type_Int);
        if (localObject1 != null) {
  ...
  public void b()
  {
    ...
    if (this.jdField_c_of_type_JavaUtilArrayList != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (localafly.jdField_a_of_type_Int != 23)
        {
          a(localafly.jdField_a_of_type_Int, new ArrayList(0), true);
          a(localafly.jdField_a_of_type_Int, null);
        }
      }
    }
  }
  ...
  public void b(int paramInt)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_d_of_type_JavaLangObject)
      {
        ...
        if (localIterator.hasNext())
        {
          if (((afly)localIterator.next()).jdField_a_of_type_Int != paramInt) {
            continue;
          }
        ...
        if (bool1)
        {
          ...
          if (!TextUtils.equals(paramString, "sp_mayknow_ml_s_a_vl"))
          {
            ...
            if (!TextUtils.equals(paramString, "sp_mayknow_addpage_s_a_vl"))
            {
              ...
              {
                afsa localafsa = (afsa)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(295);
                bool2 = bool1;
                if (localafsa != null)
                {
                  bool2 = bool1;
        ...
        try
        {
          ...
          while (localIterator.hasNext())
          {
            ...
            if (??? != null)
            {
              ...
              this.jdField_a_of_type_Aukn.a((aukm)???, "uin=?", new String[] { localObject4 });
            }
          }
          return false;
        }
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaUtilList)
      {
        ...
        if ((localObject4 != null) && (!((List)localObject4).isEmpty()) && (bool))
        {
          aktg localaktg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a();
          localaktg.b(8112);
          ??? = localaktg.b(ajsf.ag, 8111);
          if (??? != null) {
            localaktg.b((RecentUser)???);
          }
          localaktg.b(8113);
          Object localObject2 = localaktg.b("sp_uin_for_title", 8113);
          ??? = localObject2;
          if (localObject2 == null) {
          ...
          ??? = localaktg.b(localRecentRecommendTroopItem.uin, 8113);
          if (??? != null) {
            break label404;
          }
  ...
  public void c(String paramString)
  {
    ...
    a(paramString);
    ((akfd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(22)).a(paramString, new akag(this, paramString));
    ...
    if (this.jdField_e_of_type_Int == 0)
    {
      ...
      axqw.b(null, "dc00899", "Grp_recom", "", "link_top", "clk_hide", 0, 0, "", "", "", "");
    }
  ...
  public void d()
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      localObject1 = localaktg.b(ajsf.ag, 8111);
      if (localObject1 != null) {
        localaktg.b((RecentUser)localObject1);
      }
      localaktg.b(8112);
      localRecentUser = localaktg.b("sp_uin_for_title", 8112);
      ...
      localRecentUser = localaktg.b(localMayKnowRecommend.uin, 8112);
      if (localRecentUser != null) {
        break label479;
      }
    ...
    for (;;)
    {
      ...
      break;
      localaktg.b(8112);
      localRecentUser = localaktg.b(ajsf.ag, 8111);
      if (QLog.isColorLevel()) {
      ...
      localObject1 = localRecentUser;
      if (localRecentUser == null) {
        localObject1 = new RecentUser(ajsf.ag, 8111);
      }
      localaktg.a((RecentUser)localObject1);
  ...
  public void d(String paramString)
  {
    ...
    ((akfd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(22)).a(paramString, new akah(this, paramString));
    ...
    {
      axqw.b(null, "dc00899", "Grp_recom", "", "msg_tab", "slide_delete", 0, 0, paramString, (String)localObject, "", "");
      return;
  ...
  public void e()
  {
    ...
    aktg localaktg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a();
    localaktg.b(8112);
    RecentUser localRecentUser = localaktg.b(ajsf.ag, 8111);
    if (QLog.isColorLevel()) {
  ...
  public void f()
  {
    if ((this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap == null) || (this.jdField_a_of_type_Aukn == null)) {}
    for (;;)
    {
      return;
