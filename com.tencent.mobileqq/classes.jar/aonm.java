...
public class aonm
{
  ...
  private static Map<String, aonn> jdField_b_of_type_JavaUtilMap = new HashMap();
  ...
  public static void a(String paramString, byte[] paramArrayOfByte)
  {
    ...
    localaonn.jdField_a_of_type_JavaLangString = paramString;
    localaonn.jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
    jdField_b_of_type_JavaUtilMap.put(paramString, localaonn);
  }
  ...
  private static boolean a(long paramLong)
  {
    ...
    {
      apcb.a(0, String.format(BaseApplicationImpl.getApplication().getResources().getString(2131627025), new Object[] { Integer.valueOf(jdField_c_of_type_Int) }), 0);
      return false;
    }
    if ((jdField_a_of_type_Long > 0L) && (d() + paramLong > jdField_a_of_type_Long))
    {
      String str = BaseApplicationImpl.getApplication().getResources().getString(2131627032);
      apcb.a(0, str + apdh.a(jdField_a_of_type_Long), 0);
      return false;
    }
    return true;
  }
  ...
  public static boolean b()
  {
    ...
    while (localIterator.hasNext())
    {
      str = apdh.a(((FileInfo)localIterator.next()).d());
      if ((str == null) || (str.length() == 0)) {
        return false;
      }
      str = str.toLowerCase();
      if (!axfs.jdField_a_of_type_JavaLangString.contains(str)) {
        return false;
      }
    }
    ...
    while (localIterator.hasNext())
    {
      str = apdh.a(((FileManagerEntity)localIterator.next()).fileName);
      if ((str == null) || (str.length() == 0)) {
        return false;
      }
      str = str.toLowerCase();
  ...
  {
    paramFileInfo = apdh.a(paramFileInfo.d());
    if ((paramFileInfo == null) || (paramFileInfo.length() == 0)) {}
    do
    {
      return false;
      paramFileInfo = paramFileInfo.toLowerCase();
    } while (!axfs.jdField_a_of_type_JavaLangString.contains(paramFileInfo));
    return true;
  }
  ...
  public static boolean b(FileManagerEntity paramFileManagerEntity)
  {
    ...
    } while (!axfs.jdField_a_of_type_JavaLangString.contains(paramFileManagerEntity));
    return true;
  }
  ...
  public static long c()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (apbf.a(localFileManagerEntity).a(false)) {
        l += apdh.a(localFileManagerEntity.getFilePath());
      }
    }
    return l;
  }
