  ...
  extends Handler
{
  ...
  public aonm(Looper paramLooper, QQAppInterface paramQQAppInterface, aone paramaone)
  {
    super(paramLooper);
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    Object localObject1 = (aoni)paramMessage.obj;
    label266:
    boolean bool;
    do
    {
      for (;;)
      {
        try
        {
          ...
          default: 
            ...
            if (System.currentTimeMillis() - this.b > 300000L)
            {
              ...
              localObject1 = (aonj)this.jdField_a_of_type_Aone.a(1);
              if (localObject1 != null) {
                paramMessage.append(((aonj)localObject1).a());
              }
              localObject1 = (aonn)this.jdField_a_of_type_Aone.a(2);
              if (localObject1 != null) {
                paramMessage.append(((aonn)localObject1).a()).append("\n");
              }
        ...
        finally
        {
          ...
          Object localObject2 = (aonj)this.jdField_a_of_type_Aone.a(1);
          if (localObject2 == null) {
            continue;
          }
          ((StringBuilder)localObject1).append(((aonj)localObject2).a());
          localObject2 = (aonn)this.jdField_a_of_type_Aone.a(2);
          if (localObject2 == null) {
            continue;
          }
          ((StringBuilder)localObject1).append(((aonn)localObject2).a()).append("\n");
          QLog.d("Q.fts.BgCpu.Total", 1, ((StringBuilder)localObject1).toString());
          this.d = 0L;
          this.c = 0L;
          this.b = System.currentTimeMillis();
        }
        if (((aoni)localObject1).c()) {
      ...
      if (((aoni)localObject1).d()) {
        ((aoni)localObject1).e();
      }
      bool = this.jdField_a_of_type_Aone.b;
      if (!bool) {
        break;
      }
      this.d += SystemClock.currentThreadTimeMillis() - l3;
