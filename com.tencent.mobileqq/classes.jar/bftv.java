...
public class bftv
{
  ...
  static
  {
    jdField_d_of_type_JavaLangString = anzj.a(2131714089);
  }
    ...
    while (this.jdField_a_of_type_JavaLangString.indexOf('[') > 0)
    {
      ...
      if ((i < this.jdField_a_of_type_JavaLangString.length() - 1) && (this.jdField_a_of_type_JavaLangString.charAt(i + 1) == '('))
      {
        ...
        if (m > 0)
        {
          ...
          localbftw.jdField_a_of_type_Int = k;
          localbftw.jdField_b_of_type_Int = (i + 1);
          localbftw.jdField_a_of_type_JavaLangString = str;
          this.jdField_a_of_type_JavaUtilArrayList.add(localbftw);
        }
      }
    }
  }
