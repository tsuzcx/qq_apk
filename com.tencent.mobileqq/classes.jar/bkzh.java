...
public class bkzh
{
  ...
  public bkzh(int paramInt1, String paramString, int paramInt2, int paramInt3)
  {
    this(paramInt1, paramString, paramInt2, paramInt3, 1);
  }
  
  public bkzh(int paramInt1, String paramString, int paramInt2, int paramInt3, int paramInt4)
  {
  ...
  public bkzh(String paramString, int paramInt1, int paramInt2)
  {
