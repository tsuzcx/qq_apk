  ...
  implements INetEngine.INetEngineListener
{
  ...
  static INetEngine.IBreakDownFix jdField_a_of_type_ComTencentMobileqqTransfileINetEngine$IBreakDownFix = new axqi();
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private INetEngine jdField_a_of_type_ComTencentMobileqqTransfileINetEngine;
  private List<axqj> jdField_a_of_type_JavaUtilList = new Vector();
  Set<String> jdField_a_of_type_JavaUtilSet = Collections.synchronizedSet(new HashSet());
  
  public axqh(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(axqj paramaxqj)
  {
    if (paramaxqj == null) {}
    while (this.jdField_a_of_type_JavaUtilList.contains(paramaxqj)) {
      return;
    }
    this.jdField_a_of_type_JavaUtilList.add(paramaxqj);
  }
    ...
    for (String str1 = ".mp4";; str2 = "")
    {
      ...
      if (paramBoolean2)
      {
        ...
        if (localObject != null)
        {
          ...
          {
            axsb.b("OlympicResources", new Object[] { "download, checkLimit == false, url=", paramString1 });
            return true;
          }
  ...
  public void b(axqj paramaxqj)
  {
    if (paramaxqj == null) {
      return;
    }
    this.jdField_a_of_type_JavaUtilList.remove(paramaxqj);
  }
  ...
  public void onResp(NetResp paramNetResp)
  {
    ...
    if (paramNetResp.mResult == 0)
    {
      ...
      localObject1 = ayja.a(((File)localObject2).getAbsolutePath());
    ...
    for (;;)
    {
      ...
      if ((j == 1) || (j == 2))
      {
        if (j == 1)
        {
          ...
          localHashMap.put("url", axsb.a(localHttpNetReq.mReqUrl));
          ...
          axsb.b("OlympicResources", new Object[] { "onResp report Download, reportKey=", localObject2, ", errcode=", Integer.valueOf(i), ", url=", localHttpNetReq.mReqUrl });
        }
      }
      else
      {
        ...
        for (;;)
        {
          ...
          {
            localObject4 = (axqj)this.jdField_a_of_type_JavaUtilList.get(j);
            if (localObject4 != null) {
              ((axqj)localObject4).a(localHttpNetReq.mReqUrl, (String)localObject1, localObject2, i, (String)localObject3);
            }
            j += 1;
            continue;
            bool1 = false;
  ...
  public void onUpdateProgeress(NetReq paramNetReq, long paramLong1, long paramLong2)
  {
    ...
    for (;;)
    {
      ...
      {
        axqj localaxqj = (axqj)this.jdField_a_of_type_JavaUtilList.get(i);
        if (localaxqj != null) {
          localaxqj.a(str, paramNetReq, localObject, paramLong1, paramLong2);
        }
        i += 1;
      }
      break;
