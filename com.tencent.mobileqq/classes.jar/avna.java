...
public class avna
{
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong, int paramInt1, int paramInt2, int paramInt3, avni paramavni)
  {
    ...
    try
    {
      ...
      new auyw(paramQQAppInterface).a(24624).b(10).a(new avnc(paramInt2, paramavni)).a(new avnb(paramavni, paramInt2)).a(localReadNearUserFeedsReq.toByteArray());
      return;
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong, int paramInt, avnh paramavnh)
  {
    ...
    new auyw(paramQQAppInterface).a(22528).b(5).a(new avne(paramavnh, paramString)).a(new avnd(paramavnh, paramString)).a(localDelFeedReq.toByteArray());
  }
  
  public static void a(QQAppInterface paramQQAppInterface, String paramString, avnj paramavnj)
  {
    new auza(paramQQAppInterface).a(paramString, new avnf(paramavnj), null);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, String paramString, avnk paramavnk)
  {
    new auza(paramQQAppInterface).b(paramString, new avng(paramavnk), null);
  }
}
