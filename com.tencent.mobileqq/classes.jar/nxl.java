  ...
  extends osm
{
  ...
  public void a(int paramInt, List<Long> paramList)
  {
    ...
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      ...
      Object localObject2 = osg.a().a(ReadInJoyVideoSubChannelActivity.c(this.a), ((Long)localObject1).longValue());
    ...
    label270:
    this.a.jdField_a_of_type_Omt.b = 0L;
    paramList = this.a;
  ...
  public void a(boolean paramBoolean1, int paramInt, List<Long> paramList, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      {
        ReadInJoyVideoSubChannelActivity.a(this.a, this.a.getResources().getString(2131718547));
        continue;
        if (ReadInJoyVideoSubChannelActivity.a(this.a).isEmpty()) {
          ReadInJoyVideoSubChannelActivity.a(this.a, this.a.getResources().getString(2131718514));
        }
      }
    }
  }
  ...
  public void b(int paramInt, List<Long> paramList)
  {
    ...
    ReadInJoyVideoSubChannelActivity.a(this.a).b(osg.a().a(Integer.valueOf(ReadInJoyVideoSubChannelActivity.c(this.a)), paramList));
  ...
  public void b(boolean paramBoolean1, int paramInt, List<Long> paramList, boolean paramBoolean2)
  {
    ...
    for (paramBoolean1 = bool;; paramBoolean1 = false)
    {
      ...
      {
        paramList = this.a.getResources().getString(2131718337);
        bcql.a(ReadInJoyVideoSubChannelActivity.a(this.a).getApplicationContext(), paramList, 0).a();
      }
      ReadInJoyVideoSubChannelActivity.d(this.a, false);
      return;
      paramBoolean2 = false;
  ...
  public void d(int paramInt)
  {
    if (paramInt == 97)
    {
      bcql.a(ReadInJoyVideoSubChannelActivity.a(this.a), ajya.a(2131712777), 0).a();
      ReadInJoyVideoSubChannelActivity.b(this.a, true);
    }
    while (paramInt != 98) {
      return;
    }
    bcql.a(ReadInJoyVideoSubChannelActivity.a(this.a), ajya.a(2131712847), 0).a();
