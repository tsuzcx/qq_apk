  ...
  extends bcgr
{
  ...
  public bceg(String paramString1, long paramLong1, String paramString2, List<bcfj> paramList, long paramLong2, String paramString3, String paramString4, List<String> paramList1, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, String paramString5, String paramString6)
  {
    this.f = paramString1;
  ...
  public void a(View paramView)
  {
    ...
    if (this.jdField_a_of_type_Long == 1002L) {
      bcmx.a(this.jdField_a_of_type_JavaUtilList, this.f);
    }
    ...
    do
    {
      ...
      localObject = bhey.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramView.getContext(), this.jdField_b_of_type_JavaLangString);
      if (localObject != null)
      {
        ((bheh)localObject).a();
        return;
    ...
    try
    {
      QLog.d("Q.uniteSearch.GroupBaseNetSearchModel", 2, "onMoreAction,moreUrl = " + this.jdField_b_of_type_JavaLangString + ",dstUrl = " + avjc.a((String)localObject));
