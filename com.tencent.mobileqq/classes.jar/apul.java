...
{
  public static ConcurrentHashMap<String, apul> a;
  ...
  private apul(Context paramContext, String paramString1, String paramString2)
  {
  ...
  public static <T extends apts<Y>, Y> T a(Y paramY, Class<T> paramClass)
  {
    apts localapts = (apts)apub.a(paramClass);
    try
    {
      localapts.a(paramY);
      return localapts;
    ...
    {
      apue.a().a(paramClass, paramY);
      throw new QStorageInstantiateException("readJsonOrXml exception too much", paramY);
    }
  }
  
  public static apul a(String paramString)
  {
    if (!a(paramString)) {
      QLog.d("QStorage", 1, "buildQStorage notRegister " + paramString);
    }
    Object localObject = (apul)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
    if (localObject == null) {
      synchronized (jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap)
      {
        apul localapul = (apul)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
        localObject = localapul;
        if (localapul == null)
        {
          localObject = new apul(BaseApplicationImpl.getContext(), paramString, MobileQQ.sMobileQQ.waitAppRuntime(null).getAccount());
  ...
  public <T extends Serializable> T a(String paramString, Class<T> paramClass, int paramInt)
  {
    ...
    return (Serializable)a(localFile, "", paramClass, paramInt, new apun(this, localFile, paramString));
  }
  
  public <JavaBean, Param> JavaBean a(File paramFile, Param paramParam, Class<JavaBean> paramClass, int paramInt, aptr<JavaBean, Param> paramaptr)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if ((paramInt == 1) || (str1 == null) || (!apty.a().a(this.jdField_a_of_type_JavaLangString, this.b, str1)) || (paramFile.exists())) {
          break;
        }
    ...
    try
    {
      paramParam = paramaptr.a(paramFile, paramParam);
    ...
    catch (Exception paramParam)
    {
      for (;;)
      {
        apue.a().a(paramaptr, paramFile, paramParam);
        ...
        if (str2 != null)
        {
          apty.a().a(this.jdField_a_of_type_JavaLangString, this.b, str2);
          paramParam = paramFile;
        }
      }
    }
  ...
  /* Error */
  public <DATA> void a(File paramFile, DATA paramDATA, aptr<String, DATA> paramaptr)
  {
    // Byte code:
    //   0: aload_3
    //   1: aload_1
    ...
    //   28: astore_2
    //   29: invokestatic 190	apty:a	()Lapty;
    //   32: aload_0
    //   33: getfield 32	apul:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   36: aload_0
    //   37: getfield 36	apul:b	Ljava/lang/String;
    //   40: aload_2
    //   41: invokevirtual 224	apty:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   44: invokestatic 190	apty:a	()Lapty;
    //   47: aload_0
    //   48: getfield 32	apul:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   51: aload_0
    //   52: getfield 36	apul:b	Ljava/lang/String;
    //   55: aload_2
    //   56: invokevirtual 220	apty:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   59: return
    //   60: astore_2
    //   61: ldc 113
    //   63: iconst_1
    ...
    //   90: invokestatic 95	apue:a	()Lapue;
    //   93: aload_3
    //   94: aload_1
    //   95: aload_2
    //   96: invokevirtual 214	apue:a	(Laptr;Ljava/io/File;Ljava/lang/Exception;)V
    //   99: return
    //   100: astore_1
    //   101: return
    ...
    //   0	102	3	paramaptr	aptr<String, DATA>
    //   17	3	4	bool	boolean
    // Exception table:
    //   from	to	target	type
  ...
  {
    a(a(paramString, ".serial"), paramT, new apum(this, paramString, paramT));
  }
}
