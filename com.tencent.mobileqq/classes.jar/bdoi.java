  ...
  implements bdlw
{
  ...
  public bdoi(WadlJsBridge paramWadlJsBridge, String paramString)
  {
  ...
  public void a(String paramString)
  {
    ...
    bdoe.a("WadlJsBridge", "##@!JsCheckUpdateCallback onException >>> " + paramString);
  ...
  {
    bdoe.b("WadlJsBridge", "##@checkUpdate(End) onResult()");
    if (!this.jdField_a_of_type_ComTencentOpenWadlWadlJsBridge.hasRight()) {
      return;
    }
