  ...
  implements bidp
{
  ...
  public bidr(QQAppInterface paramQQAppInterface)
  {
    this.a = new bids(paramQQAppInterface);
  }
  ...
  private void a()
  {
    ...
    try
    {
      bidy localbidy = (bidy)((bidq)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(374)).a().getDbManager();
      if (localbidy != null) {
        localbidy.a();
      }
      b();
