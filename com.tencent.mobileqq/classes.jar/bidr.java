  ...
  implements RecyclerView.OnChildAttachStateChangeListener
{
  ...
  public bidv mCallback;
  private RecyclerView.ChildDrawingOrderCallback mChildDrawingOrderCallback;
  private List<Integer> mDistances;
  private long mDragScrollStartTimeInMs;
  float mDx;
  float mDy;
  bidm mGestureDetector;
  float mInitialTouchX;
  float mInitialTouchY;
  float mMaxSwipeVelocity;
  private final RecyclerView.OnItemTouchListener mOnItemTouchListener = new bids(this);
  View mOverdrawChild = null;
  int mOverdrawChildPosition = -1;
  final List<View> mPendingCleanup = new ArrayList();
  List<bidz> mRecoverAnimations = new ArrayList();
  ...
  public bidr(bidv parambidv)
  {
    this.mCallback = parambidv;
  }
  ...
  private void addChildDrawingOrderCallback()
  {
    ...
    if (this.mChildDrawingOrderCallback == null) {
      this.mChildDrawingOrderCallback = new bidu(this);
    }
  ...
  private void destroyCallbacks()
  {
    ...
    while (i >= 0)
    {
      bidz localbidz = (bidz)this.mRecoverAnimations.get(0);
      this.mCallback.clearView(this.mRecyclerView, localbidz.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder);
      i -= 1;
    }
  ...
  private void initGestureDetector()
  {
    ...
    this.mGestureDetector = new bidm(this.mRecyclerView.getContext(), new bidy(this));
  }
  ...
  private int swipeIfNecessary(RecyclerView.ViewHolder paramViewHolder)
  {
    ...
    do
    {
      do
      {
        ...
        {
          if ((j & k) == 0) {
            return bidv.convertToRelativeDirection(k, ViewCompat.getLayoutDirection(this.mRecyclerView));
          }
          return k;
        }
    ...
    if ((j & i) == 0) {
      return bidv.convertToRelativeDirection(i, ViewCompat.getLayoutDirection(this.mRecyclerView));
    }
    return i;
  }
  ...
  int endRecoverAnimation(RecyclerView.ViewHolder paramViewHolder, boolean paramBoolean)
  {
    ...
    while (i >= 0)
    {
      bidz localbidz = (bidz)this.mRecoverAnimations.get(i);
      if (localbidz.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder == paramViewHolder)
      {
        localbidz.jdField_b_of_type_Boolean |= paramBoolean;
        if (!localbidz.jdField_c_of_type_Boolean) {
          localbidz.b();
        }
        this.mRecoverAnimations.remove(i);
        return localbidz.jdField_c_of_type_Int;
      }
      i -= 1;
    }
    return 0;
  ...
  bidz findAnimation(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      bidz localbidz = (bidz)this.mRecoverAnimations.get(i);
      paramMotionEvent = localbidz;
      if (localbidz.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder.itemView == localView) {
        break;
      }
      i -= 1;
    }
  ...
  View findChildView(MotionEvent paramMotionEvent)
  {
    ...
    while (i >= 0)
    {
      paramMotionEvent = (bidz)this.mRecoverAnimations.get(i);
  ...
  public boolean hasRunningRecoverAnim()
  {
    ...
    while (i < j)
    {
      if (!((bidz)this.mRecoverAnimations.get(i)).jdField_c_of_type_Boolean) {
        return true;
      }
      i += 1;
    }
  ...
  void postDispatchSwipe(bidz parambidz, int paramInt)
  {
    this.mRecyclerView.post(new ItemTouchHelper.4(this, parambidz, paramInt));
  }
    ...
    else
    {
      ...
      default: 
        ...
        if (k == 2)
        {
          ...
          localObject = new bidt(this, (RecyclerView.ViewHolder)localObject, i, k, f3, f4, f1, f2, j, (RecyclerView.ViewHolder)localObject);
          ((bidz)localObject).a(this.mCallback.getAnimationDuration(this.mRecyclerView, i, f1 - f3, f2 - f4));
