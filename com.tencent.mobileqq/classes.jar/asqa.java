  ...
  implements Handler.Callback
{
  ...
  WeakReference<asqb> b;
  
  public asqa(QQAppInterface paramQQAppInterface, int paramInt)
  {
  ...
  public void a()
  {
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      ...
      if (!this.jdField_a_of_type_Bkyc.hasMessages(0)) {
        this.jdField_a_of_type_Bkyc.sendEmptyMessageDelayed(0, 300L);
      }
      return;
    }
  }
  
  public void a(asqb paramasqb)
  {
    if (paramasqb != null)
    {
      this.b = new WeakReference(paramasqb);
      return;
    }
    this.b = null;
  }
