  ...
  extends MSFServlet
{
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      try
      {
        Object localObject = oda.a(paramFromServiceMsg.getWupBuffer());
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    if (paramIntent != null)
    {
      paramIntent = pde.a("OidbSvc.0xbf8", 3064, 0, paramIntent);
      paramPacket.setSSOCommand(paramIntent.getServiceCmd());
      paramPacket.putSendData(oda.b(paramIntent.getWupBuffer()));
