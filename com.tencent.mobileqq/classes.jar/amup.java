...
public class amup
  implements amut, amvc, Handler.Callback
{
  ...
  private volatile amuo jdField_a_of_type_Amuo;
  private volatile amus jdField_a_of_type_Amus;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = alud.a(2131701149);
    jdField_b_of_type_JavaLangString = alud.a(2131701150);
    jdField_c_of_type_JavaLangString = alud.a(2131701145);
    jdField_d_of_type_JavaLangString = alud.a(2131701146);
    jdField_e_of_type_JavaLangString = alud.a(2131701148);
    jdField_f_of_type_JavaLangString = alud.a(2131701152);
    jdField_g_of_type_JavaLangString = alud.a(2131701147);
    jdField_h_of_type_JavaLangString = alud.a(2131701151);
  }
  ...
  private boolean c()
  {
    return (a()) && (this.jdField_a_of_type_Amuo.a());
  }
  ...
  private void d(int paramInt)
  {
    ...
    if (c())
    {
      if (this.jdField_a_of_type_Amus != null)
      {
        this.jdField_a_of_type_Amus.a(0);
        this.jdField_a_of_type_Amus.b();
      }
      if ((paramInt == 2) || (paramInt == 4) || (paramInt == 6) || (paramInt == 1) || (paramInt == 3))
      {
        this.jdField_a_of_type_Amuo.a(false, true);
        this.m = paramInt;
    ...
    {
      return;
      this.jdField_a_of_type_Amuo.a(false, false);
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  private void e(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if (!this.jdField_c_of_type_Boolean) {
        if (paramInt == 11) {
          amul.a(jdField_a_of_type_JavaLangString, false);
        }
      }
      for (;;)
      {
  ...
  private void j()
  {
    ...
    {
      return;
      if ((this.jdField_a_of_type_Amuo != null) && (this.jdField_a_of_type_Amuo.a())) {
        this.jdField_a_of_type_Amuo.a(false, true);
      }
    } while (this.jdField_a_of_type_Amus == null);
    this.jdField_a_of_type_Amus.b();
  }
  ...
  private void l()
  {
    ...
    for (;;)
    {
      ...
      return;
      if ((this.m == -1) && (this.jdField_a_of_type_Amuo != null)) {
        this.jdField_a_of_type_Amuo.a(false, false);
      }
    }
  }
  ...
  private void n()
  {
    ...
    if ((this.jdField_a_of_type_Amuo == null) || (this.jdField_a_of_type_Amus == null)) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      do
      {
        ...
        {
          return;
          if (this.jdField_a_of_type_Amus.a() != 0) {
            break label145;
          }
          if (!amul.a(104857600L))
          {
            amul.a(jdField_c_of_type_JavaLangString, jdField_d_of_type_JavaLangString);
            return;
          }
          if (this.jdField_a_of_type_Amuo.a(true, null)) {
            break;
          }
          amul.a(jdField_a_of_type_JavaLangString, false);
        } while (!QLog.isColorLevel());
        ...
        return;
        a("0X8008A54");
        this.jdField_a_of_type_Amus.a(1);
      } while (!QLog.isColorLevel());
      QLog.i("ARVideoRecordUIControllerImpl", 2, "startVideoRecord end");
      return;
      if (c())
      {
        this.jdField_a_of_type_Amuo.a(true, true);
        this.m = 7;
        this.jdField_d_of_type_Boolean = true;
        a("0X8008A55");
        if (QLog.isColorLevel()) {
  ...
  public void a(Object paramObject)
  {
    ...
    {
      return;
      if ((paramObject instanceof amus))
      {
        this.jdField_a_of_type_Amus = ((amus)paramObject);
        this.jdField_a_of_type_Amus.a(this);
        return;
      }
    } while (!(paramObject instanceof amuo));
    this.jdField_a_of_type_Amuo = ((amuo)paramObject);
    this.jdField_a_of_type_Amuo.a(this);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      return;
      this.jdField_a_of_type_Amus = null;
  ...
  public boolean a()
  {
    return (this.jdField_a_of_type_Amuo != null) && (this.jdField_a_of_type_Amuo.b());
  }
  ...
  public boolean b()
  {
    return (this.jdField_a_of_type_Amuo != null) && (this.jdField_a_of_type_Amuo.b()) && (!this.jdField_a_of_type_Amuo.a());
  }
  ...
  public void d()
  {
    ...
    if ((!this.jdField_e_of_type_Boolean) || (!this.jdField_f_of_type_Boolean)) {}
    while (this.jdField_a_of_type_Amuo == null) {
      return;
    }
    this.jdField_a_of_type_Amuo.a(System.currentTimeMillis());
  }
    ...
    for (int n = ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).checkSelfPermission("android.permission.RECORD_AUDIO");; n = 0)
    {
      ...
      for (int i1 = ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).checkSelfPermission("android.permission.WRITE_EXTERNAL_STORAGE");; i1 = 0)
      {
        ...
        for (int i2 = ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).checkSelfPermission("android.permission.READ_EXTERNAL_STORAGE");; i2 = 0)
        {
          ...
          ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).requestPermissions(new amuq(this), 1, new String[] { "android.permission.RECORD_AUDIO", "android.permission.READ_EXTERNAL_STORAGE", "android.permission.WRITE_EXTERNAL_STORAGE" });
          return true;
          ...
          this.jdField_a_of_type_Amuo.a(false, null);
          return true;
          if (this.jdField_a_of_type_Amuo == null) {
            break;
          }
