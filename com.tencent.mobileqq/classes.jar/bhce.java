  ...
  extends bhbw
{
  ...
  static
  {
    jdField_a_of_type_Bhce = new bhce();
    jdField_a_of_type_JavaLangString = "theme.";
  }
  
  private boolean a(String paramString)
  {
    if ((bhdg.a()) && ((paramString.startsWith("theme.android")) || (paramString.endsWith(".cfg"))))
    {
  ...
  public boolean deleteFiles(QQAppInterface paramQQAppInterface, long paramLong, String paramString)
  {
    if (paramQQAppInterface != null) {
      if (!ThemeUtil.isIOSTheme(paramString))
      {
        ...
        {
          localObject = new bdps().a((String)localObject);
          if (paramString.startsWith(jdField_a_of_type_JavaLangString)) {}
          for (paramQQAppInterface = ((bdps)localObject).a(paramQQAppInterface.getApp(), paramString, "").c();; paramQQAppInterface = ((bdps)localObject).b(paramQQAppInterface.getApp()))
          {
  ...
  protected void doOnCompleted(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2)
  {
    if (!ThemeUtil.isIOSTheme(paramString1))
    {
      ...
      if (paramInt1 != 0)
      {
        ...
        bgzu.a(null, "individual_v2_theme_download_fail", String.valueOf(paramInt1), "from" + paramString3 + ",httpCode=" + paramInt2 + ",errorCode:" + paramInt1 + ", scid:" + paramString1 + ", cfgScid:" + paramString2, paramQQAppInterface, String.valueOf(paramInt2), null, 0.0F, 0.0F);
        paramQQAppInterface = new HashMap();
        paramQQAppInterface.put("reportKey", "errorCode:" + paramInt1);
        bctj.a(BaseApplication.getContext()).a("", "individual_v2_theme_download_fail", false, 0L, -1L, paramQQAppInterface, "", true);
      }
      return;
    }
  ...
  public VasQuickUpdateEngine.TagItemInfo getItemInfo(QQAppInterface paramQQAppInterface, long paramLong, String paramString)
  {
    ...
    localObject = new VasQuickUpdateEngine.TagItemInfo();
    localbdps = new bdps().a(str);
    if (paramString.startsWith(jdField_a_of_type_JavaLangString))
    {
      ((VasQuickUpdateEngine.TagItemInfo)localObject).bPreConfig = false;
      ((VasQuickUpdateEngine.TagItemInfo)localObject).bSaveInDir = false;
      ((VasQuickUpdateEngine.TagItemInfo)localObject).strSavePath = localbdps.a(paramQQAppInterface.getApp(), paramString, "").c();
      return localObject;
    }
    ((VasQuickUpdateEngine.TagItemInfo)localObject).bPreConfig = true;
    ((VasQuickUpdateEngine.TagItemInfo)localObject).bSaveInDir = false;
    ((VasQuickUpdateEngine.TagItemInfo)localObject).strSavePath = localbdps.b(paramQQAppInterface.getApp());
    return localObject;
