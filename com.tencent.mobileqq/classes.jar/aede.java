  ...
  implements acum
{
  ...
  static
  {
    ...
    c = (int)(localDisplayMetrics.widthPixels - bbdv.a(localBaseApplication, 40.0F) * 2.0F - BaseChatItemLayout.s - BaseChatItemLayout.t - i * 2 - bbdv.a(localBaseApplication, 10.0F));
    if (c > 640) {
      c = 640;
    }
  ...
  {
    if (paramInt1 == 0) {
      return new anox(BaseApplicationImpl.getApplication().getResources(), null, paramInt2, paramInt3, -921103);
    }
    Object localObject;
    if (paramInt1 == 1) {
      localObject = aywm.b();
    ...
    for (;;)
    {
      if ((localObject instanceof SkinnableBitmapDrawable))
      {
        ...
        return new anox(BaseApplicationImpl.getApplication().getResources(), (Bitmap)localObject, paramInt2, paramInt3, -921103);
        if (paramInt1 == 2) {
          localObject = aywm.a();
        }
      }
  ...
  /* Error */
  public static Drawable a(Context paramContext, azqv paramazqv, MessageForTroopFile paramMessageForTroopFile)
  {
    // Byte code:
    //   0: aload_1
    //   1: getfield 127	azqv:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    //   4: astore 8
    //   6: aload_1
    //   7: getfield 129	azqv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   10: ifnull +80 -> 90
    //   13: aload_1
    //   14: getfield 129	azqv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   17: astore_2
    //   18: aload_2
    //   19: invokestatic 134	apvd:a	(Ljava/lang/String;)Ljava/lang/String;
    //   22: astore_2
    //   23: aload_0
    ...
    //   62: ifeq +730 -> 792
    //   65: getstatic 33	aede:jdField_a_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
    //   68: aload 8
    ...
    //   93: goto -75 -> 18
    //   96: aload_1
    //   97: getfield 129	azqv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   100: ifnull +692 -> 792
    //   103: new 163	java/io/File
    //   106: dup
    //   107: aload_1
    //   108: getfield 129	azqv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   129: invokestatic 183	aede:a	(II)[I
    //   132: astore_2
    //   133: aload_0
    //   134: aload_2
    //   135: iconst_0
    ...
    //   192: astore_0
    //   193: getstatic 33	aede:jdField_a_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
    //   196: aload 8
    //   198: aload_0
    ...
    //   222: astore_2
    //   223: getstatic 33	aede:jdField_a_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
    //   226: aload 8
    ...
    //   267: aload_0
    //   268: invokestatic 224	bbef:a	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   271: pop
    //   272: aload_0
    ...
    //   288: invokestatic 233	aywm:a	(Ljava/lang/String;)I
    //   291: istore 7
    //   293: iload 7
    //   295: bipush 90
    ...
    //   320: iload 5
    //   322: iload 4
    //   324: invokestatic 183	aede:a	(II)[I
    //   327: astore_0
    //   328: aload_0
    //   329: iconst_0
    //   330: iaload
    ...
    //   494: iload 4
    //   496: iload 5
    //   498: invokestatic 277	bbef:b	(Landroid/graphics/Bitmap;FII)Landroid/graphics/Bitmap;
    ...
    //   512: aload_1
    //   513: astore_0
    //   514: getstatic 33	aede:jdField_a_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
    //   517: aload 8
    //   519: aload 9
    ...
    //   576: invokestatic 297	aede:a	(III)Landroid/graphics/drawable/Drawable;
    //   579: astore_0
    //   580: aload_0
    //   581: areturn
    //   582: astore_0
    ...
    //   586: iload 4
    //   588: iload 5
    //   590: invokestatic 297	aede:a	(III)Landroid/graphics/drawable/Drawable;
    //   593: astore_2
    ...
    //   655: iload 4
    //   657: iload 5
    //   659: invokestatic 297	aede:a	(III)Landroid/graphics/drawable/Drawable;
    //   662: astore 8
    //   664: aload_1
    //   665: astore_0
  ...
  private void a(azqv paramazqv, MessageForTroopFile paramMessageForTroopFile)
  {
    if (paramazqv != null)
    {
      TeamWorkFileImportInfo localTeamWorkFileImportInfo = new TeamWorkFileImportInfo();
      localTeamWorkFileImportInfo.jdField_c_of_type_JavaLangString = paramazqv.jdField_a_of_type_JavaLangString;
      localTeamWorkFileImportInfo.jdField_b_of_type_JavaLangString = paramazqv.g;
      localTeamWorkFileImportInfo.j = apug.a(paramazqv.g);
      ...
      localTeamWorkFileImportInfo.jdField_d_of_type_JavaLangString = paramazqv.e;
      localTeamWorkFileImportInfo.jdField_b_of_type_Int = paramazqv.h;
      ...
      ayee.a(localTeamWorkFileImportInfo, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localTeamWorkFileImportInfo.jdField_d_of_type_Int);
    }
  }
  
  private void a(bbmf parambbmf, azqv paramazqv, boolean paramBoolean)
  {
    if (this.f)
    {
      this.g = anbq.a().c();
    ...
    long l2 = apug.a(paramazqv.e);
    if ((this.g) && (ayfx.a(paramazqv.e, paramazqv.g, str1)) && (l2 <= l1))
    {
      int j = 1;
      i = j;
      if (paramBoolean)
      {
        if (TextUtils.isEmpty(paramazqv.e)) {
          break label217;
        }
        paramazqv = new File(paramazqv.e);
        i = j;
        if (paramazqv == null)
        {
          i = j;
    ...
    for (int i = 0;; i = 0)
    {
      if (i != 0)
      {
        ...
        parambbmf.a(2131372725, this.jdField_a_of_type_AndroidContentContext.getString(2131720132), 2130838617);
      }
      return;
    }
  }
  ...
  {
    return apug.a(((MessageForTroopFile)paramChatMessage).fileName) == 0;
  }
  ...
  public static boolean d(ChatMessage paramChatMessage)
  {
    ...
    return ((paramChatMessage.width == 0) || (paramChatMessage.height != 0)) || (apug.a(paramChatMessage.fileName) == 2);
  }
  ...
  public View a(int paramInt1, int paramInt2, ChatMessage paramChatMessage, View paramView, ViewGroup paramViewGroup, acxj paramacxj)
  {
    ...
    this.jdField_a_of_type_Aoul.a(paramViewGroup, paramView, paramChatMessage);
    return paramView;
  }
  
  public View a(ViewGroup paramViewGroup, ChatMessage paramChatMessage)
  {
    aedi localaedi = (aedi)paramViewGroup.getTag();
    if (localaedi.jdField_c_of_type_AndroidViewView != null) {
      localaedi.jdField_c_of_type_AndroidViewView.setVisibility(0);
    }
    if (localaedi.jdField_d_of_type_AndroidViewView != null) {
      localaedi.jdField_d_of_type_AndroidViewView.setVisibility(8);
    }
    if (localaedi.jdField_a_of_type_AndroidViewView != null)
    {
      ViewGroup.LayoutParams localLayoutParams = localaedi.jdField_a_of_type_AndroidViewView.getLayoutParams();
      localLayoutParams.width = BaseChatItemLayout.y;
      localLayoutParams.height = -2;
      localaedi.jdField_a_of_type_AndroidViewView.setLayoutParams(localLayoutParams);
    }
    for (;;)
    {
      a(localaedi, paramViewGroup, paramChatMessage);
      a(localaedi.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout, paramChatMessage, localaedi);
      if (jdField_e_of_type_Boolean) {}
      try
      {
        localaedi.jdField_b_of_type_JavaLangStringBuilder.append(localaedi.jdField_a_of_type_AndroidWidgetTextView.getText()).append(" ");
        localaedi.jdField_b_of_type_JavaLangStringBuilder.append(localaedi.jdField_b_of_type_AndroidWidgetTextView.getText());
        localaedi.jdField_b_of_type_JavaLangStringBuilder.append(localaedi.jdField_c_of_type_AndroidWidgetTextView.getText());
        localaedi.jdField_b_of_type_JavaLangStringBuilder.append("按钮");
        paramViewGroup.setContentDescription(localaedi.jdField_b_of_type_JavaLangStringBuilder.toString());
  ...
  {
    paramChatMessage = (aedi)paramacuj;
  ...
  {
    paramacva = (MessageForTroopFile)paramChatMessage;
    azqv localazqv = bakx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramacva);
    long l = -1L;
    if (localazqv != null) {
      ...
      do
      {
        do
        {
          do
          {
            ...
            {
              return parambbmf;
              if (((apvm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) || (apvd.b(localazqv.jdField_a_of_type_JavaLangString))) && (localazqv != null) && (localazqv.jdField_b_of_type_Int != 12) && (d(paramChatMessage))) {
              ...
              default: 
                return parambbmf;
              case 6: 
                parambbmf.a(2131366632, this.jdField_a_of_type_AndroidContentContext.getString(2131697605), 2130838606);
                if ((paramacva != null) && (paramacva.fileSize <= l)) {
                  a(parambbmf, localazqv, false);
                }
                break;
              }
            } while (actj.a(5) != 1);
            parambbmf.a(2131372714, this.jdField_a_of_type_AndroidContentContext.getString(2131697599), 2130838605);
            return parambbmf;
            parambbmf.a(2131366632, this.jdField_a_of_type_AndroidContentContext.getString(2131697605), 2130838606);
          } while (actj.a(5) != 1);
          parambbmf.a(2131372714, this.jdField_a_of_type_AndroidContentContext.getString(2131697599), 2130838605);
  ...
  protected MessageForTroopFile a(View paramView)
  {
    ...
    if (paramView.a.isMultiMsg) {
      return (MessageForTroopFile)apug.a(paramView.a);
    }
  ...
  public String a(ChatMessage paramChatMessage)
  {
    if (bbfh.a(paramChatMessage.issend)) {
      return ajya.a(2131715326);
    }
    return ajya.a(2131715330);
  }
  ...
  public void a(int paramInt, Context paramContext, ChatMessage paramChatMessage)
  {
    ...
    do
    {
      do
      {
          ...
          do
          {
            do
            {
              do
              {
                        ...
                        do
                        {
                          do
                          {
                            do
                            {
                              ...
                              localObject2 = bakx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForTroopFile)localObject1);
                            } while (localObject2 == null);
                            i = bbfj.a((Activity)paramContext);
                            localObject4 = new azpv(Long.parseLong(paramChatMessage.frienduin), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (Activity)paramContext);
                            switch (paramInt)
                            {
                            default: 
                            ...
                            case 2131372715: 
                              if (i == 0)
                              {
                                bajt.a(paramContext, this.jdField_a_of_type_AndroidContentContext.getString(2131697863));
                                return;
                              }
                              axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Grp", "Down_pause_download", 0, 0, "", paramChatMessage.frienduin, "", "");
                            }
                          } while (((azqv)localObject2).jdField_b_of_type_Int != 8);
                          ((TroopFileTransferManager)localObject3).d(((azqv)localObject2).jdField_a_of_type_JavaUtilUUID);
                          return;
                          if (i == 0)
                          {
                            bajt.a(paramContext, this.jdField_a_of_type_AndroidContentContext.getString(2131697863));
                          ...
                          axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Grp", "Up_pause_upload", 0, 0, "", paramChatMessage.frienduin, "", "");
                        } while ((((azqv)localObject2).jdField_b_of_type_Int != 0) && (((azqv)localObject2).jdField_b_of_type_Int != 1));
                        ((TroopFileTransferManager)localObject3).a(((azqv)localObject2).jdField_a_of_type_JavaUtilUUID);
                        return;
                      } while (((azqv)localObject2).jdField_b_of_type_Int != 9);
                      ((azpv)localObject4).b(((azqv)localObject2).jdField_a_of_type_JavaUtilUUID);
                      return;
                    } while (((azqv)localObject2).jdField_b_of_type_Int != 2);
                    ((azpv)localObject4).a(((azqv)localObject2).jdField_a_of_type_JavaUtilUUID);
                    return;
                  } while ((((azqv)localObject2).jdField_b_of_type_Int != 8) && (((azqv)localObject2).jdField_b_of_type_Int != 9) && (((azqv)localObject2).jdField_b_of_type_Int != 10));
                  ((TroopFileTransferManager)localObject3).d(((azqv)localObject2).jdField_a_of_type_JavaUtilUUID);
                  a(((azqv)localObject2).jdField_b_of_type_Long, (Activity)paramContext, ((azqv)localObject2).jdField_a_of_type_JavaUtilUUID);
                  return;
                  if (i == 0)
                  {
                    bajt.a(paramContext, this.jdField_a_of_type_AndroidContentContext.getString(2131697863));
                ...
                } while ((((azqv)localObject2).jdField_b_of_type_Int != 1) && (((azqv)localObject2).jdField_b_of_type_Int != 0) && (((azqv)localObject2).jdField_b_of_type_Int != 2) && (((azqv)localObject2).jdField_b_of_type_Int != 3));
                ((TroopFileTransferManager)localObject3).a(((azqv)localObject2).jdField_a_of_type_JavaUtilUUID);
                a(((azqv)localObject2).jdField_b_of_type_Long, (Activity)paramContext, ((azqv)localObject2).jdField_a_of_type_JavaUtilUUID, paramChatMessage);
                return;
                if (i == 0)
                {
                  bajt.a(paramContext, this.jdField_a_of_type_AndroidContentContext.getString(2131697863));
                ...
                localObject3 = apug.a((azqv)localObject2);
                ...
                if (!TextUtils.isEmpty(((FileManagerEntity)localObject3).getFilePath())) {
                  ((ForwardFileInfo)localObject4).a(((azqv)localObject2).jdField_a_of_type_JavaLangString);
                }
                ((ForwardFileInfo)localObject4).d(((azqv)localObject2).g);
                ((ForwardFileInfo)localObject4).d(((azqv)localObject2).jdField_c_of_type_Long);
                ((ForwardFileInfo)localObject4).a(Long.parseLong(paramChatMessage.frienduin));
                if (((azqv)localObject2).jdField_a_of_type_JavaUtilUUID != null) {
                  ((ForwardFileInfo)localObject4).e(((azqv)localObject2).jdField_a_of_type_JavaUtilUUID.toString());
                }
                if (!TextUtils.isEmpty(((azqv)localObject2).jdField_c_of_type_JavaLangString)) {
                  ((ForwardFileInfo)localObject4).f(((azqv)localObject2).jdField_c_of_type_JavaLangString);
                }
                for (;;)
                {
                  ...
                  paramChatMessage.putExtra("forward_text", ((azqv)localObject2).g);
                  ...
                  return;
                  if (!TextUtils.isEmpty(((azqv)localObject2).jdField_d_of_type_JavaLangString)) {
                    ((ForwardFileInfo)localObject4).f(((azqv)localObject2).jdField_d_of_type_JavaLangString);
                  }
                }
                bakx.a((Activity)this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage);
                return;
                apug.a((Activity)paramContext, ((azqv)localObject2).jdField_a_of_type_JavaLangString);
                return;
              } while (((azqv)localObject2).jdField_b_of_type_Int != 3);
              ((azpv)localObject4).a(((azqv)localObject2).jdField_a_of_type_JavaUtilUUID);
              return;
            } while (((azqv)localObject2).jdField_b_of_type_Int != 10);
            ((azpv)localObject4).b(((azqv)localObject2).jdField_a_of_type_JavaUtilUUID);
            return;
            axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Grp", "Down__start_download", 0, 0, "", paramChatMessage.frienduin, "", "");
          } while ((localObject2 != null) && (((azqv)localObject2).jdField_b_of_type_Int != 7));
          ((azpv)localObject4).a(((azqv)localObject2).e, ((azqv)localObject2).g, ((azqv)localObject2).jdField_c_of_type_Long, ((azqv)localObject2).h);
          return;
          axqy.b(null, "dc00898", "", "", "0X800A60C", "0X800A60C", 0, 0, "", "", "", "");
          bakx.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage);
          return;
          paramContext = apug.a((azqv)localObject2);
          localObject2 = bajy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((azqv)localObject2).jdField_b_of_type_Long).a(paramContext.strTroopFilePath);
          if (localObject2 != null)
          {
            paramContext.lastTime = ((azpi)localObject2).c;
            paramContext.selfUin = String.valueOf(((azpi)localObject2).jdField_b_of_type_Long);
          }
        ...
        for (;;)
        {
          axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_files", "", "remove_file", "remove_clk", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "", paramContext, (String)localObject1);
          a(paramChatMessage);
          return;
          paramContext = (Context)localObject1;
      ...
      a((azqv)localObject2, (MessageForTroopFile)localObject1);
    ...
    return;
    ApolloUtil.a(((azqv)localObject2).g, ((azqv)localObject2).jdField_a_of_type_JavaLangString, new aedh(this, (azqv)localObject2, (azpv)localObject4));
  }
  
  public void a(long paramLong, Activity paramActivity, UUID paramUUID)
  {
    paramUUID = new aedf(this, paramLong, paramUUID, paramActivity);
  ...
  {
    paramUUID = new aedg(this, paramLong, paramUUID, paramChatMessage, paramActivity);
  ...
  public void a(aedi paramaedi, ViewGroup paramViewGroup, ChatMessage paramChatMessage)
  {
    if (paramaedi.jdField_d_of_type_AndroidWidgetTextView == null)
    {
      paramaedi.jdField_d_of_type_AndroidWidgetTextView = new TextView(this.jdField_a_of_type_AndroidContentContext);
      paramaedi.jdField_d_of_type_AndroidWidgetTextView.setBackgroundResource(2130842092);
      paramaedi.jdField_d_of_type_AndroidWidgetTextView.setTextSize(1, 12.0F);
      paramaedi.jdField_d_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167134));
      paramaedi.jdField_d_of_type_AndroidWidgetTextView.setText(2131697479);
      paramaedi.jdField_d_of_type_AndroidWidgetTextView.setSingleLine();
      paramaedi.jdField_d_of_type_AndroidWidgetTextView.setGravity(16);
      paramaedi.jdField_d_of_type_AndroidWidgetTextView.setPadding(baxn.a(this.jdField_a_of_type_AndroidContentContext, 5.0F), 0, baxn.a(this.jdField_a_of_type_AndroidContentContext, 5.0F), 0);
      paramaedi.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
      ...
      baxn.a(this.jdField_a_of_type_AndroidContentContext, 10.0F);
      paramViewGroup.addView(paramaedi.jdField_d_of_type_AndroidWidgetTextView, localLayoutParams);
    }
    paramaedi.jdField_d_of_type_AndroidWidgetTextView.setVisibility(0);
    if (paramChatMessage.isSend())
    {
      paramViewGroup = (RelativeLayout.LayoutParams)paramaedi.jdField_d_of_type_AndroidWidgetTextView.getLayoutParams();
      ...
      paramaedi.jdField_d_of_type_AndroidWidgetTextView.setLayoutParams(paramViewGroup);
      return;
    }
    paramViewGroup = (RelativeLayout.LayoutParams)paramaedi.jdField_d_of_type_AndroidWidgetTextView.getLayoutParams();
  ...
  void a(View paramView, boolean paramBoolean)
  {
    ...
    axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_files", "", "AIOchat", "Clk_filesbubble", 0, 0, paramView.frienduin + "", "", "", "");
    azqv localazqv = bakx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForTroopFile);
    if (localazqv.jdField_b_of_type_Int == 12) {
      bajt.a(localActivity, String.format(localActivity.getString(2131697581), new Object[] { bakx.a(localazqv.g) }), 1);
    }
    do
    {
      return;
    ...
    apvm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramView, l, localazqv, localMessageForTroopFile.senderuin, localMessageForTroopFile.lastTime, 3, 3, null, false, false);
  }
  
  public void a(BaseChatItemLayout paramBaseChatItemLayout, ChatMessage paramChatMessage, aedi paramaedi)
  {
    ...
    if (!localMessageForTroopFile.bReported)
    {
      ...
      axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Grp", "Down_appear_AIO", 0, 0, "", paramChatMessage.frienduin, "", "");
    ...
    paramaedi.jdField_a_of_type_AndroidWidgetTextView.setEllipsize(TextUtils.TruncateAt.MIDDLE);
    paramaedi.jdField_a_of_type_AndroidWidgetTextView.setMaxLines(2);
    paramaedi.jdField_a_of_type_AndroidWidgetTextView.setText(localazqv.g);
    boolean bool2 = false;
    int m = 0;
    int n = 0;
    int i1 = 0;
    ...
    default: 
      ...
      if (k != 0)
      {
        paramaedi.jdField_a_of_type_AndroidWidgetProgressBar.setProgress(j);
        paramaedi.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
        label364:
        if (i == 0) {
          break label1098;
        }
        paramaedi.jdField_c_of_type_AndroidWidgetTextView.setText((CharSequence)localObject);
        paramaedi.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
        label386:
        paramaedi.jdField_b_of_type_AndroidWidgetTextView.setText(apvd.a(localazqv.jdField_c_of_type_Long));
        ...
        if (localazqv.jdField_b_of_type_JavaLangString != null) {
          break label1136;
        }
        apug.a(paramaedi.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView, localazqv.g);
        if (localazqv.jdField_a_of_type_JavaUtilUUID == null) {
          break label1110;
        }
        paramBaseChatItemLayout.a(localazqv.jdField_a_of_type_JavaUtilUUID, 128);
      }
      break;
    }
    while (ajwc.a() > 17.0F)
    {
      paramBaseChatItemLayout = (RelativeLayout.LayoutParams)paramaedi.jdField_b_of_type_AndroidWidgetTextView.getLayoutParams();
      if (paramaedi.jdField_c_of_type_AndroidWidgetTextView.getVisibility() != 0) {
        break label1200;
      }
      paramaedi.jdField_b_of_type_AndroidWidgetTextView.setGravity(5);
      paramBaseChatItemLayout.addRule(3, 2131364080);
      paramBaseChatItemLayout.addRule(2, 2131364082);
      paramBaseChatItemLayout.addRule(7, 2131364080);
      return;
      k = 1;
      j = 0;
      localObject = ajya.a(2131715331);
      i = 1;
      bool1 = bool2;
      break label332;
      String str = ajya.a(2131715379);
      localObject = str;
      i = i1;
      j = n;
      k = m;
      ...
      k = m;
      bool1 = bool2;
      if (!TextUtils.isEmpty(localazqv.e)) {
        break label332;
      }
      g(paramChatMessage);
      localObject = str;
      ...
      bool1 = bool2;
      break label332;
      localObject = ajya.a(2131715353);
      i = 1;
      k = 1;
      j = bakx.a(localazqv.jdField_d_of_type_Long, localazqv.jdField_c_of_type_Long);
      bool1 = bool2;
      break label332;
      localObject = ajya.a(2131715364);
      k = 1;
      j = bakx.a(localazqv.jdField_d_of_type_Long, localazqv.jdField_c_of_type_Long);
      i = i1;
      bool1 = bool2;
      break label332;
      i = 1;
      localObject = ajya.a(2131715342);
      k = 1;
      j = bakx.a(localazqv.jdField_d_of_type_Long, localazqv.jdField_c_of_type_Long);
      bool1 = bool2;
      break label332;
      i = 1;
      localObject = ajya.a(2131715387);
      k = 1;
      j = bakx.a(localazqv.jdField_d_of_type_Long, localazqv.jdField_c_of_type_Long);
      bool1 = bool2;
      break label332;
      localObject = ajya.a(2131715370);
      i = 1;
      j = n;
      k = m;
      bool1 = bool2;
      break label332;
      localObject = ajya.a(2131715386);
      i = 1;
      j = n;
      k = m;
      bool1 = bool2;
      break label332;
      localObject = ajya.a(2131715359);
      bool1 = true;
      i = i1;
      j = n;
      k = m;
      break label332;
      localObject = ajya.a(2131715338);
      bool1 = true;
      i = i1;
      j = n;
      k = m;
      break label332;
      localObject = ajya.a(2131715366);
      i = i1;
      j = n;
      k = m;
      bool1 = bool2;
      break label332;
      localObject = ajya.a(2131715337);
      i = 1;
      j = n;
      k = m;
      bool1 = bool2;
      break label332;
      paramaedi.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
      break label364;
      label1098:
      paramaedi.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
      break label386;
      label1110:
      paramBaseChatItemLayout.a(localazqv.e, localazqv.g, localazqv.h, 128);
      continue;
      label1136:
      if ((TextUtils.isEmpty(localazqv.jdField_b_of_type_JavaLangString)) || (!bbdx.a(localazqv.jdField_b_of_type_JavaLangString)))
      {
        apug.a(paramaedi.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView, localazqv.g);
      }
      else
      {
        apug.a(paramaedi.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView, localazqv.g);
        paramaedi.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setAsyncImage(localazqv.jdField_b_of_type_JavaLangString);
      }
    }
    label1200:
    paramaedi.jdField_b_of_type_AndroidWidgetTextView.setGravity(3);
    paramBaseChatItemLayout.addRule(3, -1);
    paramBaseChatItemLayout.addRule(2, -1);
    paramBaseChatItemLayout.addRule(12);
    paramBaseChatItemLayout.addRule(5, 2131364080);
  }
  ...
  public void a(ChatMessage paramChatMessage, Context paramContext, BaseChatItemLayout paramBaseChatItemLayout, acuj paramacuj, int paramInt1, int paramInt2)
  {
    ...
    boolean bool1 = b(paramChatMessage);
    boolean bool2 = d(paramChatMessage);
    if ((!bool1) && (!bool2) && (paramacuj.jdField_a_of_type_AndroidViewView != null))
    {
      if (paramChatMessage.isSend()) {
  ...
  public bbmf b(bbmf parambbmf, ChatMessage paramChatMessage, acva paramacva)
  {
    ...
    if (localazqv == null)
    {
      parambbmf.a(2131372713, this.jdField_a_of_type_AndroidContentContext.getString(2131697598), 2130838602);
      axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Grp", "Down_press_files", 0, 0, "", paramChatMessage.frienduin, "", "");
      super.e(parambbmf, this.jdField_a_of_type_AndroidContentContext);
      return parambbmf;
    }
    paramacva = Boolean.valueOf(false);
    int i = 0;
    int k = 0;
    int m = 0;
    int j = 0;
    ...
    default: 
      ...
      i = k;
      label263:
      ApolloUtil.a(parambbmf, localazqv.g);
      if (paramacva.booleanValue()) {
        axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Grp", "Up_press_files", 0, 0, "", paramChatMessage.frienduin, "", "");
      }
      break;
    }
    for (;;)
    {
      super.e(parambbmf, this.jdField_a_of_type_AndroidContentContext);
      if (i != 0) {
        parambbmf.a(2131366659, this.jdField_a_of_type_AndroidContentContext.getString(2131693913), 2130838614);
      }
      if ((j == 0) || (c(localMessageForTroopFile)) || (d(localMessageForTroopFile))) {
        break;
      }
      parambbmf.a(2131372720, this.jdField_a_of_type_AndroidContentContext.getString(2131697604), 2130838606);
      return parambbmf;
      parambbmf.a(2131372716, this.jdField_a_of_type_AndroidContentContext.getString(2131697600), 2130838609);
      parambbmf.a(2131372710, this.jdField_a_of_type_AndroidContentContext.getString(2131697596));
      i = 0;
      j = 0;
      paramacva = Boolean.valueOf(true);
      break label263;
      parambbmf.a(2131372712, this.jdField_a_of_type_AndroidContentContext.getString(2131697602), 2130838611);
      parambbmf.a(2131372710, this.jdField_a_of_type_AndroidContentContext.getString(2131697596), 2130838593);
      i = 0;
      j = 0;
      paramacva = Boolean.valueOf(true);
      break label263;
      parambbmf.a(2131372718, this.jdField_a_of_type_AndroidContentContext.getString(2131697602), 2130838618);
      parambbmf.a(2131372710, this.jdField_a_of_type_AndroidContentContext.getString(2131697596), 2130838593);
      i = 0;
      j = 0;
      paramacva = Boolean.valueOf(true);
      break label263;
      parambbmf.a(2131372715, this.jdField_a_of_type_AndroidContentContext.getString(2131697600), 2130838609);
      parambbmf.a(2131366632, this.jdField_a_of_type_AndroidContentContext.getString(2131697605), 2130838606);
      ...
      i = 1;
      parambbmf.a(2131370536, this.jdField_a_of_type_AndroidContentContext.getString(2131694468), 2130838614);
      if (actj.a(5) != 1) {
        break label252;
      }
      parambbmf.a(2131372714, this.jdField_a_of_type_AndroidContentContext.getString(2131697599), 2130838605);
      ...
      j = 1;
      break label263;
      parambbmf.a(2131372711, this.jdField_a_of_type_AndroidContentContext.getString(2131697597), 2130838602);
      parambbmf.a(2131372709, this.jdField_a_of_type_AndroidContentContext.getString(2131697595), 2130838593);
      parambbmf.a(2131366632, this.jdField_a_of_type_AndroidContentContext.getString(2131697605), 2130838606);
      a(paramChatMessage, parambbmf);
      if ((paramChatMessage.extraflag != 32768) && (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(paramChatMessage))) {
        a(parambbmf, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, paramChatMessage);
      ...
      j = 1;
      break label263;
      parambbmf.a(2131372717, this.jdField_a_of_type_AndroidContentContext.getString(2131697601), 2130838611);
      parambbmf.a(2131372709, this.jdField_a_of_type_AndroidContentContext.getString(2131697595), 2130838593);
      a(paramChatMessage, parambbmf);
      if ((paramChatMessage.extraflag != 32768) && (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(paramChatMessage))) {
        a(parambbmf, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, paramChatMessage);
      ...
      if ((!TextUtils.isEmpty(localazqv.jdField_a_of_type_JavaLangString)) && (bbdx.f(localazqv.jdField_a_of_type_JavaLangString))) {
        parambbmf.a(2131372719, this.jdField_a_of_type_AndroidContentContext.getString(2131697603));
      }
      parambbmf.a(2131366632, this.jdField_a_of_type_AndroidContentContext.getString(2131697605), 2130838606);
      a(paramChatMessage, parambbmf);
      if ((localMessageForTroopFile != null) && (localMessageForTroopFile.fileSize <= l)) {
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      if (!aedi.class.isInstance(localObject))
      {
        QLog.e("TroopFileItemBuilder", 1, "item click holder tag class[" + localObject.getClass().getName() + "] is not Holder");
        return;
      }
      axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A68A", "0X800A68A", 0, 0, "4", "", "", "");
      localObject = (aedi)localObject;
      localObject = a(paramView);
    } while ((b((ChatMessage)localObject)) || (d((ChatMessage)localObject)) || ((((MessageForTroopFile)localObject).isMultiMsg) && (!apug.a((ChatMessage)localObject, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext))));
    a(paramView, false);
    actj.n = true;
  }
}
