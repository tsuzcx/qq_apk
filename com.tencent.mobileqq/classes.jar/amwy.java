...
public abstract class amwy
{
  ...
  public static float a(amxc paramamxc1, amxc paramamxc2)
  {
    float f2 = 1.0F;
    float f1 = f2;
    if (paramamxc1 != null)
    {
      ...
      if (paramamxc2 != null)
      {
        f1 = a(paramamxc1.jdField_g_of_type_Float);
        f2 = paramamxc1.h * 2;
        f1 = (a(paramamxc2.jdField_g_of_type_Float) + paramamxc2.h * 2) / (f1 + f2);
      }
    }
    return f1;
  }
  ...
  /* Error */
  public Bitmap a(amxc paramamxc)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 5
    ...
    //   7: ifnull +17 -> 24
    //   10: aload_1
    //   11: getfield 96	amxc:e	I
    //   14: ifeq +10 -> 24
    //   17: aload_1
    //   18: getfield 99	amxc:f	I
    //   21: ifne +7 -> 28
    //   24: aconst_null
    //   25: astore_3
    //   26: aload_3
    ...
    //   28: aload_0
    //   29: aload_1
    //   30: invokevirtual 101	amwy:b	(Lamxc;)Landroid/graphics/Bitmap;
    //   33: astore_2
    //   34: aload_2
    //   35: ifnull +48 -> 83
    //   38: aload_2
    ...
    //   68: aload_1
    //   69: getfield 126	amxc:jdField_a_of_type_JavaLangCharSequence	Ljava/lang/CharSequence;
    ...
    //   104: aload_1
    //   105: getfield 126	amxc:jdField_a_of_type_JavaLangCharSequence	Ljava/lang/CharSequence;
    ...
    //   124: astore 6
    //   126: aload_1
    //   127: getfield 96	amxc:e	I
    //   130: aload_1
    //   131: getfield 99	amxc:f	I
    ...
    //   149: astore_2
    //   150: aload_1
    //   151: getfield 159	amxc:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   154: invokestatic 165	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   157: ifne +101 -> 258
    //   160: aload_0
    //   161: getfield 34	amwy:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   164: aload_1
    //   165: getfield 159	amxc:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   202: dup
    //   203: aload_1
    //   204: getfield 159	amxc:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   223: dup
    //   224: aload_1
    //   225: getfield 159	amxc:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   237: astore_2
    //   238: aload_0
    //   239: getfield 34	amwy:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   242: aload_1
    //   243: getfield 159	amxc:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   262: aload_0
    //   263: getfield 34	amwy:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   266: ldc 197
    ...
    //   309: astore 4
    //   311: aload_0
    //   312: getfield 34	amwy:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   315: ldc 197
    ...
    //   364: iconst_0
    //   365: aload_1
    //   366: getfield 96	amxc:e	I
    //   369: aload_1
    //   370: getfield 99	amxc:f	I
    ...
    //   381: astore_2
    //   382: aload_1
    //   383: getfield 235	amxc:jdField_a_of_type_AndroidTextStaticLayout	Landroid/text/StaticLayout;
    //   386: ifnull +27 -> 413
    //   389: aload 6
    //   391: aload_1
    //   392: getfield 237	amxc:jdField_g_of_type_Int	I
    //   395: i2f
    //   396: aload_1
    //   397: getfield 88	amxc:h	I
    //   400: i2f
    //   401: invokevirtual 241	android/graphics/Canvas:translate	(FF)V
    //   404: aload_1
    //   405: getfield 235	amxc:jdField_a_of_type_AndroidTextStaticLayout	Landroid/text/StaticLayout;
    //   408: aload 6
    //   410: invokevirtual 246	android/text/StaticLayout:draw	(Landroid/graphics/Canvas;)V
    //   413: aload_0
    //   414: aload_1
    //   415: aload_2
    //   416: invokevirtual 249	amwy:a	(Lamxc;Landroid/graphics/Bitmap;)V
    //   419: aload_2
    //   420: areturn
    //   421: aload 6
    //   423: aload 4
    ...
    //   449: iconst_0
    //   450: aload_1
    //   451: getfield 96	amxc:e	I
    //   454: aload_1
    //   455: getfield 99	amxc:f	I
  ...
  {
    if ((paramamxc == null) || (TextUtils.isEmpty(paramamxc.jdField_a_of_type_JavaLangCharSequence)) || (paramamxc.jdField_a_of_type_Boolean)) {
      return;
    }
    if (jdField_a_of_type_AndroidTextTextPaint.getTextSize() != paramamxc.jdField_g_of_type_Float) {
      jdField_a_of_type_AndroidTextTextPaint.setTextSize(paramamxc.jdField_g_of_type_Float);
    }
    jdField_a_of_type_AndroidTextTextPaint.setColor(paramamxc.b);
    String str = paramamxc.jdField_a_of_type_JavaLangCharSequence + "_" + Float.valueOf(paramamxc.jdField_g_of_type_Float);
    Integer localInteger = (Integer)c.get(str);
    Object localObject = localInteger;
    if (localInteger == null)
    {
      localObject = Integer.valueOf((int)Math.ceil(StaticLayout.getDesiredWidth(paramamxc.jdField_a_of_type_JavaLangCharSequence, jdField_a_of_type_AndroidTextTextPaint)));
      c.put(str, localObject);
    }
    localObject = new StaticLayout(paramamxc.jdField_a_of_type_JavaLangCharSequence, jdField_a_of_type_AndroidTextTextPaint, ((Integer)localObject).intValue(), Layout.Alignment.ALIGN_CENTER, 1.0F, 0.0F, true);
    paramamxc.e = (((StaticLayout)localObject).getWidth() + paramamxc.jdField_g_of_type_Int * 2);
    paramamxc.f = (((StaticLayout)localObject).getHeight() + paramamxc.h * 2);
    paramamxc.jdField_a_of_type_Boolean = true;
    paramamxc.jdField_a_of_type_AndroidTextStaticLayout = ((StaticLayout)localObject);
  }
  
  public abstract void a(amxc paramamxc, Bitmap paramBitmap);
  
  public abstract Bitmap b(amxc paramamxc);
}
