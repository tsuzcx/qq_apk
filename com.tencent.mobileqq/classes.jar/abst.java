  ...
  implements zop
{
  public void callback(Bundle paramBundle)
  {
    ...
    {
      paramBundle = abss.a(this.jdField_a_of_type_Abss, str1, str2, paramBundle, this.jdField_a_of_type_JavaUtilList);
      if (Looper.myLooper() == Looper.getMainLooper())
      {
        abss.a(this.jdField_a_of_type_Abss, this.jdField_a_of_type_AndroidAppActivity, bool1, paramBundle, this.jdField_a_of_type_Absu, this.jdField_a_of_type_JavaUtilList);
        return;
      }
