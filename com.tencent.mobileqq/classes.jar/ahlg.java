...
public class ahlg
  extends alsi
{
  public ahlg(TroopNotifyAndRecommendView paramTroopNotifyAndRecommendView) {}
    ...
    for (;;)
    {
      ...
      if (paramBoolean1)
      {
        ...
        try
        {
          ...
          if ((this.a.jdField_a_of_type_Ahke != null) && (this.a.jdField_a_of_type_Ahjp != null))
          {
            this.a.jdField_a_of_type_Ahjp.a(new TroopNotifyAndRecommendView.4.1(this));
            return;
          }
        }
