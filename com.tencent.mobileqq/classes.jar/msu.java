...
public class msu
{
  ...
  private static final String jdField_a_of_type_JavaLangString = amtj.a(2131708011);
  ...
  public static msv a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localmsv.jdField_b_of_type_Int = 2147483647;
        i = 0;
        if (i < localJSONArray.length())
        {
          JSONObject localJSONObject = localJSONArray.getJSONObject(i);
          if ((localJSONObject.getInt("type") == paramInt) && (localJSONObject.getInt("priority") < localmsv.jdField_b_of_type_Int))
          {
            localmsv.jdField_a_of_type_Int = localJSONObject.getInt("id");
            localmsv.jdField_a_of_type_JavaLangString = localJSONObject.getString("url");
            localmsv.jdField_b_of_type_Int = localJSONObject.getInt("priority");
            localmsv.c = localJSONObject.getInt("type");
          }
        }
        else if (localmsv.jdField_b_of_type_Int < 2147483647)
        {
          QLog.i("QAVConfigUtils", 1, "MoreBtnTips. getHighestPriorityMoreBtnTips. highest. id = " + localmsv.jdField_a_of_type_Int + ", url = " + localmsv.jdField_a_of_type_JavaLangString + ", priority = " + localmsv.jdField_b_of_type_Int + ", type = " + localmsv.c);
          return localmsv;
        }
      }
  ...
  public static void a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        new msv().jdField_b_of_type_Int = 2147483647;
        i = 0;
        if (i >= localJSONArray.length()) {
          break;
        }
