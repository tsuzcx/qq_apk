...
public class alyi
{
  ...
  public static Bitmap a(AppInterface paramAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, String paramString1, String paramString2, String paramString3, JSONArray paramJSONArray, alis paramalis)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        catch (OutOfMemoryError paramString1)
        {
          ...
          localPaint.setColor(-1);
          a(paramAppInterface, paramContext, paramInt1, paramInt2, paramInt3, paramString1, paramString2, paramString3, paramJSONArray, paramalis, i, j, k, m, str, localCanvas, localPaint);
          ...
          paramAppInterface = paramContext.getResources().getDrawable(2130844104);
          paramAppInterface.setBounds(i / 2 - 45, j - 102 - 42, i / 2 + 45, j - 102);
          paramAppInterface.draw(localCanvas);
          paramAppInterface = ajjy.a(2131636625);
  ...
  public static String a(AppInterface paramAppInterface, Context paramContext, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramContext = vvp.a(paramContext, str, paramBitmap);
        paramAppInterface = paramContext;
        if (QLog.isColorLevel())
        {
  ...
  public static String a(String paramString, float paramFloat)
  {
    ...
    int i;
    int j;
    if (alyl.a(paramString) > paramFloat)
    {
    ...
    for (;;)
    {
      if ((i >= paramString.length()) || (alyl.a(paramString.substring(0, i) + "…") > paramFloat))
      {
  ...
  public static String a(String paramString, AppInterface paramAppInterface)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        paramAppInterface = mpl.a(mpq.a("http://cgi.connect.qq.com/qqconnectopen/upload_share_image", 1007), str1, str2, null, localHashMap, (Map)localObject1);
        localObject2 = paramAppInterface;
        if (paramAppInterface == null) {
          localObject2 = mpl.a("http://cgi.connect.qq.com/qqconnectopen/upload_share_image", str1, str2, null, localHashMap, (Map)localObject1);
        }
        if (QLog.isColorLevel()) {
  ...
  public static ArrayList<alyt> a(JSONArray paramJSONArray)
  {
    ...
    if (i < j)
    {
      ...
      do
      {
        ...
        localArrayList.add(new alyt(str));
  ...
  public static void a(AppInterface paramAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, String paramString1, String paramString2, String paramString3, JSONArray paramJSONArray, alis paramalis, int paramInt4, int paramInt5, int paramInt6, int paramInt7, String paramString4, Canvas paramCanvas, Paint paramPaint)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject1 = (alym)paramJSONArray.next();
        localObject2 = ((alym)localObject1).jdField_a_of_type_JavaUtilArrayList.iterator();
        label721:
        if (((Iterator)localObject2).hasNext())
        {
          localObject3 = (alyn)((Iterator)localObject2).next();
          paramString3.left = (((alyn)localObject3).jdField_a_of_type_AndroidGraphicsRect.left + paramString2.left + 1);
          paramString3.top = (((alyn)localObject3).jdField_a_of_type_AndroidGraphicsRect.top + paramString2.top + 1);
          paramString3.right = (((alyn)localObject3).jdField_a_of_type_AndroidGraphicsRect.right + paramString2.left - 2);
          paramString3.bottom = (((alyn)localObject3).jdField_a_of_type_AndroidGraphicsRect.bottom + paramString2.top - 2);
          paramPaint.setColor(((alym)localObject1).jdField_a_of_type_Int);
          if (!((alym)localObject1).jdField_b_of_type_Boolean) {
            break label913;
          }
          paramInt1 = 178;
          paramPaint.setAlpha(paramInt1);
          paramPaint.setFakeBoldText(((alym)localObject1).jdField_a_of_type_Boolean);
          paramString1 = Paint.Align.CENTER;
          if (((alym)localObject1).c != -1) {
            break label920;
          }
        ...
        {
          label849:
          a(paramCanvas, paramPaint, paramString3, ((alyn)localObject3).jdField_a_of_type_JavaLangString, paramString1, ((alym)localObject1).d, ((alym)localObject1).jdField_b_of_type_Int);
          break label721;
          break;
          label913:
          paramInt1 = 255;
      ...
      if (paramalis != null)
      {
        paramAppInterface = paramalis.a(paramAppInterface.getCurrentAccountUin(), true);
        QLog.i("ConfessShareHelper", 4, "preLoadQQSelfHeaderBitmap " + paramAppInterface);
      }
      for (paramAppInterface = new BitmapDrawable(paramAppInterface);; paramAppInterface = paramContext.getResources().getDrawable(2130844097))
      {
        ...
        paramContext = a(paramString4, 8.0F) + ajjy.a(2131636626);
  ...
  public static boolean a(Context paramContext, Canvas paramCanvas, int paramInt1, int paramInt2, float paramFloat)
  {
    ...
    alyj[] arrayOfalyj = a(paramInt2, paramInt1);
    paramInt2 = arrayOfalyj.length;
    paramInt1 = 0;
    alyj localalyj;
    if (paramInt1 < paramInt2) {
      localalyj = arrayOfalyj[paramInt1];
    }
    for (;;)
    {
      try
      {
        localDrawable = paramContext.getResources().getDrawable(localalyj.jdField_a_of_type_Int);
        if (localalyj.jdField_a_of_type_Int == 2130844106) {
          break label316;
        }
        if (localalyj.jdField_a_of_type_Int != 2130844099) {
          break label309;
        }
      }
      ...
      m = (int)(localalyj.jdField_b_of_type_Int - j * localalyj.jdField_a_of_type_Float * f1 / 2.0F);
      n = (int)(localalyj.c * f2 - k * localalyj.jdField_a_of_type_Float * f1 / 2.0F);
      f3 = localalyj.jdField_b_of_type_Int;
      localDrawable.setBounds(m, n, (int)(j * localalyj.jdField_a_of_type_Float * f1 / 2.0F + f3), (int)(f2 * localalyj.c + k * localalyj.jdField_a_of_type_Float * f1 / 2.0F));
      if (localalyj.jdField_a_of_type_Boolean)
      {
  ...
  public static alyj[] a(int paramInt1, int paramInt2)
  {
    if (paramInt1 == 0) {
      switch (paramInt2)
      {
    ...
    do
    {
      ...
      {
        return new alyj[0];
        return new alyj[] { new alyj(2130844071, 60, 60, true, 0.75F), new alyj(2130844076, 458, 84, true, 0.75F), new alyj(2130844077, 142, 250, true, 0.75F), new alyj(2130844071, 368, 188, true, 0.75F), new alyj(2130844069, 168, 120, true, 0.75F), new alyj(2130844102, 120, 40, true, 0.75F), new alyj(2130844103, 120, 110, true, 0.75F), new alyj(2130844100, 30, 150, true, 0.75F), new alyj(2130844100, 180, 200, true, 0.75F), new alyj(2130844102, 420, 160, true, 0.75F), new alyj(2130844103, 495, 150, true, 0.75F), new alyj(2130844099, 257, 82, false, 1.0F) };
        return new alyj[] { new alyj(2130844078, 60, 88, true, 0.75F), new alyj(2130844070, 226, 56, true, 0.75F), new alyj(2130844077, 480, 140, true, 0.75F), new alyj(2130844075, 330, 198, true, 0.75F), new alyj(2130844076, 168, 244, true, 0.75F), new alyj(2130844102, 300, 50, true, 0.75F), new alyj(2130844103, 460, 50, true, 0.75F), new alyj(2130844100, 60, 230, true, 0.75F), new alyj(2130844102, 120, 120, true, 0.75F), new alyj(2130844102, 440, 270, true, 0.75F), new alyj(2130844099, 257, 82, false, 1.0F) };
        return new alyj[] { new alyj(2130844071, 174, 58, true, 0.75F), new alyj(2130844073, 70, 146, true, 0.75F), new alyj(2130844075, 390, 106, true, 0.75F), new alyj(2130844070, 206, 240, true, 0.75F), new alyj(2130844072, 470, 225, true, 0.75F), new alyj(2130844103, 120, 88, true, 0.75F), new alyj(2130844103, 480, 70, true, 0.75F), new alyj(2130844100, 110, 230, true, 0.75F), new alyj(2130844102, 340, 210, true, 0.75F), new alyj(2130844099, 257, 82, false, 1.0F) };
        return new alyj[] { new alyj(2130844077, 138, 88, true, 0.75F), new alyj(2130844071, 68, 232, true, 0.75F), new alyj(2130844075, 298, 206, true, 0.75F), new alyj(2130844078, 480, 140, true, 0.75F), new alyj(2130844107, 382, 140, true, 0.75F), new alyj(2130844102, 60, 90, true, 0.75F), new alyj(2130844100, 182, 64, true, 0.75F), new alyj(2130844100, 440, 210, true, 0.75F), new alyj(2130844102, 440, 30, true, 0.75F), new alyj(2130844102, 190, 200, true, 0.75F), new alyj(2130844099, 257, 82, false, 1.0F) };
        if (paramInt1 != 1) {
          break;
        }
        switch (paramInt2)
      ...
      return new alyj[] { new alyj(2130844072, 110, 230, true, 1.0F), new alyj(2130844075, 656, 170, true, 1.0F), new alyj(2130844070, 516, 350, true, 1.0F), new alyj(2130844071, 84, 550, true, 1.0F), new alyj(2130844076, 656, 586, true, 1.0F), new alyj(2130844071, 526, 735, true, 1.0F), new alyj(2130844077, 198, 830, true, 1.0F), new alyj(2130844073, 70, 1016, true, 1.0F), new alyj(2130844075, 397, 952, true, 1.0F), new alyj(2130844078, 670, 880, true, 1.0F), new alyj(2130844070, 220, 1257, true, 1.0F), new alyj(2130844074, 606, 1220, true, 1.0F), new alyj(2130844107, 452, 475, true, 1.0F), new alyj(2130844069, 240, 645, true, 1.0F), new alyj(2130844100, 160, 300, true, 1.0F), new alyj(2130844103, 660, 330, true, 1.0F), new alyj(2130844101, 620, 450, true, 1.0F), new alyj(2130844102, 175, 500, true, 1.0F), new alyj(2130844102, 460, 570, true, 1.0F), new alyj(2130844103, 180, 630, true, 1.0F), new alyj(2130844100, 40, 690, true, 1.0F), new alyj(2130844100, 260, 750, true, 1.0F), new alyj(2130844103, 710, 600, true, 1.0F), new alyj(2130844102, 600, 710, true, 1.0F), new alyj(2130844102, 140, 970, true, 1.0F), new alyj(2130844100, 85, 1200, true, 1.0F), new alyj(2130844100, 600, 1050, true, 1.0F), new alyj(2130844103, 420, 1100, true, 1.0F), new alyj(2130844102, 540, 1250, true, 1.0F), new alyj(2130844106, 375, 134, false, 1.0F) };
      return new alyj[] { new alyj(2130844075, 110, 368, true, 1.0F), new alyj(2130844076, 570, 256, true, 1.0F), new alyj(2130844071, 655, 475, true, 1.0F), new alyj(2130844078, 75, 740, true, 1.0F), new alyj(2130844070, 320, 686, true, 1.0F), new alyj(2130844077, 670, 832, true, 1.0F), new alyj(2130844075, 505, 955, true, 1.0F), new alyj(2130844076, 260, 1020, true, 1.0F), new alyj(2130844074, 75, 1216, true, 1.0F), new alyj(2130844070, 565, 1235, true, 1.0F), new alyj(2130844107, 430, 355, true, 1.0F), new alyj(2130844069, 110, 174, true, 1.0F), new alyj(2130844100, 140, 250, true, 1.0F), new alyj(2130844103, 640, 195, true, 1.0F), new alyj(2130844100, 170, 450, true, 1.0F), new alyj(2130844102, 490, 1220, true, 1.0F), new alyj(2130844101, 350, 520, true, 1.0F), new alyj(2130844101, 630, 410, true, 1.0F), new alyj(2130844103, 60, 500, true, 1.0F), new alyj(2130844103, 680, 655, true, 1.0F), new alyj(2130844103, 310, 1110, true, 1.0F), new alyj(2130844102, 470, 660, true, 1.0F), new alyj(2130844102, 190, 780, true, 1.0F), new alyj(2130844102, 680, 1060, true, 1.0F), new alyj(2130844100, 180, 1230, true, 1.0F), new alyj(2130844106, 375, 134, false, 1.0F) };
      return new alyj[] { new alyj(2130844071, 110, 220, true, 1.0F), new alyj(2130844077, 654, 240, true, 1.0F), new alyj(2130844075, 562, 482, true, 1.0F), new alyj(2130844073, 95, 537, true, 1.0F), new alyj(2130844070, 295, 672, true, 1.0F), new alyj(2130844072, 683, 660, true, 1.0F), new alyj(2130844074, 60, 850, true, 1.0F), new alyj(2130844076, 442, 872, true, 1.0F), new alyj(2130844070, 114, 1046, true, 1.0F), new alyj(2130844071, 680, 950, true, 1.0F), new alyj(2130844076, 230, 1197, true, 1.0F), new alyj(2130844078, 480, 1260, true, 1.0F), new alyj(2130844107, 670, 1200, true, 1.0F), new alyj(2130844100, 140, 630, true, 1.0F), new alyj(2130844100, 500, 960, true, 1.0F), new alyj(2130844100, 330, 1050, true, 1.0F), new alyj(2130844100, 50, 1150, true, 1.0F), new alyj(2130844101, 290, 430, true, 1.0F), new alyj(2130844101, 330, 760, true, 1.0F), new alyj(2130844102, 60, 310, true, 1.0F), new alyj(2130844102, 480, 580, true, 1.0F), new alyj(2130844102, 220, 820, true, 1.0F), new alyj(2130844103, 600, 150, true, 1.0F), new alyj(2130844103, 700, 410, true, 1.0F), new alyj(2130844103, 25, 900, true, 1.0F), new alyj(2130844103, 150, 430, true, 1.0F), new alyj(2130844106, 375, 134, false, 1.0F) };
      return new alyj[] { new alyj(2130844071, 104, 278, true, 1.0F), new alyj(2130844074, 588, 200, true, 1.0F), new alyj(2130844070, 690, 390, true, 1.0F), new alyj(2130844073, 420, 534, true, 1.0F), new alyj(2130844072, 92, 592, true, 1.0F), new alyj(2130844076, 660, 624, true, 1.0F), new alyj(2130844071, 475, 735, true, 1.0F), new alyj(2130844077, 192, 818, true, 1.0F), new alyj(2130844078, 696, 880, true, 1.0F), new alyj(2130844075, 430, 990, true, 1.0F), new alyj(2130844070, 64, 1034, true, 1.0F), new alyj(2130844070, 272, 1250, true, 1.0F), new alyj(2130844074, 584, 1205, true, 1.0F), new alyj(2130844069, 254, 638, true, 1.0F), new alyj(2130844100, 200, 320, true, 1.0F), new alyj(2130844100, 260, 780, true, 1.0F), new alyj(2130844100, 620, 1000, true, 1.0F), new alyj(2130844100, 150, 1250, true, 1.0F), new alyj(2130844101, 70, 420, true, 1.0F), new alyj(2130844101, 460, 590, true, 1.0F), new alyj(2130844101, 630, 450, true, 1.0F), new alyj(2130844102, 70, 800, true, 1.0F), new alyj(2130844102, 280, 980, true, 1.0F), new alyj(2130844102, 610, 720, true, 1.0F), new alyj(2130844102, 480, 1220, true, 1.0F), new alyj(2130844103, 170, 590, true, 1.0F), new alyj(2130844103, 330, 1160, true, 1.0F), new alyj(2130844103, 700, 680, true, 1.0F), new alyj(2130844103, 660, 290, true, 1.0F), new alyj(2130844106, 375, 134, false, 1.0F) };
    } while (paramInt1 != 2);
    return new alyj[] { new alyj(2130844072, 110, 310, true, 1.0F), new alyj(2130844075, 650, 216, true, 1.0F), new alyj(2130844070, 516, 350, true, 1.0F), new alyj(2130844072, 92, 592, true, 1.0F), new alyj(2130844076, 656, 586, true, 1.0F), new alyj(2130844071, 470, 716, true, 1.0F), new alyj(2130844077, 198, 830, true, 1.0F), new alyj(2130844078, 670, 980, true, 1.0F), new alyj(2130844075, 397, 1060, true, 1.0F), new alyj(2130844073, 70, 1016, true, 1.0F), new alyj(2130844100, 200, 320, true, 1.0F), new alyj(2130844069, 240, 438, true, 1.0F), new alyj(2130844107, 452, 475, true, 0.75F), new alyj(2130844100, 200, 600, true, 1.0F), new alyj(2130844100, 1000, 620, true, 1.0F), new alyj(2130844101, 70, 420, true, 1.0F) };
  }
  
  public static Bitmap b(AppInterface paramAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, String paramString1, String paramString2, String paramString3, JSONArray paramJSONArray, alis paramalis)
  {
    if ((paramJSONArray == null) || (paramJSONArray.length() < 1) || (paramContext == null))
    {
      paramAppInterface = null;
      ...
      for (;;)
      {
        ...
        catch (OutOfMemoryError paramString1)
        {
          try
          {
            ...
            localPaint.setColor(-1);
            a(paramAppInterface, paramContext, paramInt1, paramInt2, paramInt3, null, paramString2, paramString3, paramJSONArray, paramalis, i, j, 5, 5, str, localCanvas, localPaint);
            localPaint.setAlpha(255);
            localPaint.setColor(-1);
            return paramString1;
          }
