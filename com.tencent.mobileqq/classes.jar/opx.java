  ...
  implements opd
{
  public void a(int paramInt, @NotNull Container paramContainer, @NotNull otd paramotd, @NotNull otp paramotp, @NotNull ViewBase paramViewBase)
  {
    ...
    if ((paramViewBase instanceof owz))
    {
      ((owz)paramViewBase).a(paramotd, (View)paramContainer);
      if (tpk.a(paramotp)) {
        paramViewBase.setOnClickListener((ViewBase.OnClickListener)new opy(paramotd, paramContainer, paramotp));
      }
    }
  }
}
