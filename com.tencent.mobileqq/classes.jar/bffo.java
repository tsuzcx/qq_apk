...
public class bffo
{
  ...
  public static bffp a(String paramString)
  {
    ...
    for (;;)
    {
      localbffp.a = paramString.getString("k=");
      localbffp.b = d(paramString.getString("u="));
      localObject = b(paramString.getString("n="));
      if (localObject != null)
      {
        localbffp.c = URLDecoder.decode((String)localObject, "UTF-8");
        if (localbffp.c != null) {}
      }
      for (localbffp.c = localbffp.b;; localbffp.c = localbffp.b)
      {
        localbffp.d = paramString.getString("o=");
        localbffp.e = paramString.getString("p=");
        localbffp.f = paramString.getString("d=");
        if ((localbffp.a == null) || (localbffp.b == null) || (localbffp.d == null)) {
          break;
        }
        return localbffp;
      }
