...
public class bffo
{
    ...
    for (;;)
    {
          ...
          if (i < j)
          {
            ...
            if (!TextUtils.isEmpty(str))
            {
              ...
              if (localAssetManager.list(str).length == 0)
              {
                ...
                besl.d("[mini] AssetsUtil", String.format("copyAssetToFile from=%s, to=%s fail", new Object[] { str, localObject }));
                return false;
              }
            }
          }
      ...
      catch (Throwable paramContext)
      {
        for (;;)
        {
          ...
          for (;;)
          {
            besl.d("[mini] AssetsUtil", String.format("copyFileOrDir assetsPath=%s, destPath=%s, exception", new Object[] { paramString1, paramString2 }), paramContext);
            try
            {
              if (!new File(paramString2).exists()) {
                break;
              }
              bekq.a(paramString2, false);
              return false;
            }
            catch (Throwable paramContext)
            {
  ...
  private static boolean a(AssetManager paramAssetManager, String paramString1, String paramString2)
  {
    ...
    //   129: invokestatic 87	besl:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   132: aload 7
    //   134: ifnull +8 -> 142
    //   137: aload 7
    ...
    //   239: invokestatic 87	besl:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   242: goto -69 -> 173
    //   245: astore_0
    //   246: ldc 126
    ...
    //   288: invokestatic 87	besl:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   291: goto -97 -> 194
    //   294: astore_0
    //   295: ldc 126
    ...
    //   337: invokestatic 87	besl:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   340: aload 4
    ...
    //   391: invokestatic 87	besl:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   394: goto -200 -> 194
    //   397: astore_0
    //   398: aload 4
    ...
    //   450: invokestatic 87	besl:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   453: goto -50 -> 403
    //   456: astore_0
    //   457: ldc 126
    ...
    //   499: invokestatic 87	besl:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   502: goto -360 -> 142
    //   505: astore_0
    //   506: ldc 126
    ...
    //   548: invokestatic 87	besl:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   551: goto -388 -> 163
    //   554: astore_0
    //   555: ldc 126
    ...
    //   597: invokestatic 87	besl:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   600: aload 4
    ...
    //   651: invokestatic 87	besl:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   654: goto -491 -> 163
    //   657: astore_0
    //   658: aload 4
    ...
    //   710: invokestatic 87	besl:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   713: goto -50 -> 663
    //   716: astore_0
    //   717: aconst_null
    //   718: astore 4
    ...
    //   798: invokestatic 87	besl:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   801: goto -71 -> 730
    //   804: astore 4
    //   806: ldc 126
    ...
    //   849: invokestatic 87	besl:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   852: goto -101 -> 751
    //   855: astore 5
    //   857: ldc 126
    ...
    //   900: invokestatic 87	besl:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   903: aload 4
    ...
    //   956: invokestatic 87	besl:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   959: goto -208 -> 751
    //   962: astore_0
    //   963: aload 4
    ...
    //   1015: invokestatic 87	besl:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   1018: goto -50 -> 968
    //   1021: astore_0
    //   1022: aload 6
    //   1024: astore 4
