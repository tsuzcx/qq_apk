...
public class arof
{
  ...
  arok jdField_a_of_type_Arok = new arok();
  private String jdField_a_of_type_JavaLangString = "";
  boolean jdField_a_of_type_Boolean = true;
  arok jdField_b_of_type_Arok = new arok();
  private String jdField_b_of_type_JavaLangString = "";
  arok jdField_c_of_type_Arok = new arok();
  ...
  @NonNull
  public static arof a(@Nullable String paramString)
  {
    arof localarof = new arof();
    try
    {
      if (!TextUtils.isEmpty(paramString))
      {
        paramString = new JSONObject(paramString);
        localarof.jdField_a_of_type_Int = paramString.optInt("enable", localarof.jdField_a_of_type_Int);
        localarof.jdField_a_of_type_JavaLangString = paramString.optString("cacheFlag", localarof.jdField_a_of_type_JavaLangString);
        localarof.jdField_b_of_type_JavaLangString = paramString.optString("intructionPageUrl", localarof.jdField_b_of_type_JavaLangString);
        localarof.jdField_a_of_type_Arok = arok.a(paramString.getJSONObject("fullSpaceMessage"));
        localarof.jdField_b_of_type_Arok = arok.a(paramString.getJSONObject("redSubString"));
        localarof.jdField_c_of_type_Arok = arok.a(paramString.getJSONObject("blueSubString"));
        localarof.d = arok.a(paramString.getJSONObject("blueActionUrl"));
        localarof.e = arok.a(paramString.getJSONObject("fullAlertMessage"));
        localarof.f = arok.a(paramString.getJSONObject("bigFileAlertMessage"));
        localarof.g = arok.a(paramString.getJSONObject("alertButtonTitle"));
        localarof.h = arok.a(paramString.getJSONObject("buttonActionUrl"));
        localarof.i = arok.a(paramString.getJSONObject("AIObuttonActionUrl"));
      }
      if (QLog.isColorLevel()) {
        QLog.e("QVIP.TROOP_FILE.ConfigProcessor", 1, " : " + localarof.toString());
      }
      return localarof;
    }
  ...
  private static void b(String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      bdll.b(null, "dc00898", "", "", "qq_vip", paramString1, j, 1, 0, "", "", paramString3, "");
      return;
  ...
  {
    String str1 = this.jdField_a_of_type_Arok.a(paramString);
    String str2 = this.jdField_b_of_type_Arok.a(paramString);
    String str3 = this.jdField_c_of_type_Arok.a(paramString);
    ...
    j = str1.indexOf(str3);
    if (j > -1) {
      localSpannableString.setSpan(new arog(this, str4, paramString), j, str3.length() + j, 33);
    }
  ...
  {
    paramContext = bhlq.a(paramContext, 230, "", paramString1, this.jdField_c_of_type_JavaLangString, this.g.a(paramString2), new aroi(this, paramContext, paramBoolean1, paramString2, paramBoolean2), new aroj(this, paramRunnable, paramBoolean1, paramString2, paramBoolean2));
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        for (int j = 1;; j = 0)
        {
          ...
          localObject = new aroh(this, paramString2);
