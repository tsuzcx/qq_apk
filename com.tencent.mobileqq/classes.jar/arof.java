...
public class arof
  implements bfux
{
  public arof(UiApiPlugin paramUiApiPlugin, JSONObject paramJSONObject, Activity paramActivity) {}
  ...
  public void a(bfuw parambfuw)
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_AndroidAppActivity instanceof BasePluginActivity))
      {
        ...
        ((Intent)localObject2).putExtras(parambfuw);
