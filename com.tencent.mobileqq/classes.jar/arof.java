...
public class arof
{
  ...
  {
    return bdcr.a(paramLong, paramInt);
  }
  
  public static String a(Context paramContext)
  {
    paramContext = new File(bdal.a(paramContext) + "thumbnails/");
  ...
  public static ArrayList<FileInfo> a(String paramString, boolean paramBoolean, int paramInt)
  {
    try
    {
      ...
      if (paramInt == 0) {
        Collections.sort(localArrayList, new arog());
      }
      for (;;)
      {
        return localArrayList;
        Collections.sort(localArrayList, new arnf());
      }
      return null;
    }
    catch (Exception paramString) {}
  ...
  public static boolean a(File paramFile1, File paramFile2)
  {
    ...
    //   169: invokestatic 266	arof:a	(Ljava/io/File;Ljava/io/File;)Z
    //   172: pop
    //   173: iload_2
    //   174: iconst_1
    //   175: iadd
