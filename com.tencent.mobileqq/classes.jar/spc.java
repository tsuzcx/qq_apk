  ...
  implements soo
{
  ...
  public spc(XListView paramXListView, List<BaseData> paramList, sol paramsol)
  {
  ...
  private sol a()
  {
    ...
    {
      blmb localblmb = (blmb)this.jdField_a_of_type_ComTencentWidgetXListView.getAdapter();
      if ((localblmb.getWrappedAdapter() instanceof sol)) {
        return (sol)localblmb.getWrappedAdapter();
      }
    }
    return null;
  }
  ...
  private boolean a(int paramInt)
  {
    ...
    {
      agej.a("ItemHeightHelper", "", new IllegalArgumentException(" data == null index: " + paramInt + "   itemArrayList.size() :" + this.jdField_a_of_type_JavaUtilList.size()));
      return true;
    }
    return false;
  }
  ...
  private int b(int paramInt)
  {
    ...
    try
    {
      localObject = ((sol)localObject).a(paramInt, null, this.jdField_a_of_type_ComTencentWidgetXListView, true);
  ...
  public void a(int paramInt, View paramView)
  {
    ...
    paramView.getViewTreeObserver().addOnGlobalLayoutListener(new spd(this, paramInt, paramView));
  }
}
