...
public class bahd
  extends Dialog
  implements Handler.Callback, babt
{
  public static int d;
  public static int e;
  public int a;
  ...
  public bahd(Activity paramActivity, View paramView, QQAppInterface paramQQAppInterface, long paramLong)
  {
    super(paramActivity, 2131755332);
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_JavaLangObject = new Object();
    this.jdField_a_of_type_JavaLangString = "";
    this.jdField_a_of_type_Bago = new bahm(this);
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Bafw = ((bafw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(143));
    this.jdField_a_of_type_Long = paramLong;
    a(paramActivity);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131375671));
    this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)findViewById(2131376229));
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)findViewById(2131369749));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131369751));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131378929));
    this.jdField_a_of_type_AndroidViewView = findViewById(2131364298);
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Bago);
    a(paramView);
  }
  
  private void e()
  {
    this.jdField_a_of_type_AndroidWidgetImageButton.setOnClickListener(new bahk(this));
    Button localButton = (Button)findViewById(2131363520);
    localButton.setVisibility(0);
    localButton.setOnClickListener(new bahl(this));
  }
  
  protected float a()
  {
    float f2 = this.jdField_a_of_type_AndroidWidgetEditText.getWidth() - bdcq.a(this.jdField_a_of_type_AndroidAppActivity, 20.0F);
    float f1 = f2;
    if (this.jdField_b_of_type_Int > 0) {
      f1 = f2 - (this.jdField_a_of_type_AndroidWidgetEditText.getPaint().measureText(a(this.jdField_b_of_type_Int)) + bdcq.a(this.jdField_a_of_type_AndroidAppActivity, 16.0F));
    }
    f2 = f1;
    if (this.jdField_a_of_type_AndroidWidgetImageButton.getVisibility() == 0) {
      f2 = f1 - (this.jdField_a_of_type_AndroidWidgetImageButton.getWidth() + bdcq.a(this.jdField_a_of_type_AndroidAppActivity, 8.0F));
    }
    return f2;
  }
  ...
  {
    if (paramInt > 1000) {
      return this.jdField_a_of_type_AndroidAppActivity.getString(2131697787);
    }
    return this.jdField_a_of_type_AndroidAppActivity.getString(2131697785, new Object[] { Integer.valueOf(paramInt) });
  }
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.setHint(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131719568));
    this.jdField_a_of_type_AndroidWidgetEditText.setImeOptions(3);
    this.jdField_a_of_type_AndroidWidgetEditText.setOnEditorActionListener(new bahi(this));
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new bahj(this));
  ...
  public final void a(long paramLong, String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Bafw != null) {
        this.jdField_a_of_type_Bafw.a(paramLong, paramString, paramInt1, paramInt2, paramInt3);
      }
    }
  }
  ...
  protected void a(Activity paramActivity)
  {
    ...
    for (;;)
    {
      setContentView(2131559767);
      findViewById(2131369784).setOnClickListener(new bahe(this));
      ...
      if (ImmersiveUtils.isSupporImmersive() == 1)
      {
        ...
        int i = paramActivity.getResources().getColor(2131166957);
        if (ImmersiveUtils.a(getWindow(), true)) {
          i = paramActivity.getResources().getColor(2131167113);
        }
        new SystemBarCompact(this, true, i).init();
        localObject = (LinearLayout)findViewById(2131369784);
  ...
  protected void a(Activity paramActivity, QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqTeamworkforgroupGroupTeamWordkMoreView.setBackgroundResource(2130838591);
    this.jdField_a_of_type_ComTencentMobileqqTeamworkforgroupGroupTeamWordkMoreView.setTextColor(paramActivity.getResources().getColor(2131166901));
    ...
    this.jdField_a_of_type_Bafu = new bafu(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, this, this.jdField_a_of_type_AndroidOsHandler);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Bafu);
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnScrollListener(new bahf(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnTouchListener(new bahg(this));
    this.jdField_a_of_type_Bafu.a(new bahh(this));
  }
  ...
  public void a(String paramString)
  {
    ...
    //   13: return
    //   14: aload_0
    //   15: getfield 128	bahd:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   18: iconst_1
    //   19: invokevirtual 534	android/os/Handler:sendEmptyMessage	(I)Z
    //   22: pop
    //   23: aload_0
    //   24: aload_0
    //   25: getfield 83	bahd:jdField_a_of_type_Long	J
    //   28: aload_1
    //   29: iconst_0
    //   30: bipush 50
    //   32: iconst_0
    //   33: invokevirtual 535	bahd:a	(JLjava/lang/String;III)V
    //   36: goto -25 -> 11
    //   39: astore_1
    //   40: aload_0
    //   41: monitorexit
  ...
  public void a(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablesWithIntrinsicBounds(2130839224, 0, 0, 0);
      this.jdField_a_of_type_AndroidWidgetTextView.setText(2131695287);
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    this.jdField_a_of_type_ComTencentWidgetXListView.setVisibility(8);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidAppActivity.getString(2131694766));
    this.jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
      this.jdField_a_of_type_ComTencentWidgetXListView.setVisibility(8);
      this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidAppActivity.getString(2131697782, new Object[] { this.jdField_a_of_type_JavaLangString }));
      this.jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablesWithIntrinsicBounds(0, 2130843309, 0, 0);
      return;
    }
    this.jdField_a_of_type_ComTencentWidgetXListView.setVisibility(0);
    Drawable localDrawable = this.jdField_a_of_type_AndroidWidgetTextView.getCompoundDrawables()[0];
  ...
  protected void c(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      this.jdField_a_of_type_ComTencentMobileqqTeamworkforgroupGroupTeamWordkMoreView.setText(2131720332);
      this.jdField_a_of_type_ComTencentMobileqqTeamworkforgroupGroupTeamWordkMoreView.a();
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqTeamworkforgroupGroupTeamWordkMoreView.setText(2131695287);
    this.jdField_a_of_type_ComTencentMobileqqTeamworkforgroupGroupTeamWordkMoreView.setTextLeftDrawable(2130839224);
  }
  ...
  public void dismiss()
  {
    ...
    if (this.jdField_a_of_type_Bafu != null)
    {
      ...
      this.jdField_a_of_type_Bafu = null;
    }
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Bago);
    try
    {
      super.dismiss();
      return;
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Bafu.a(this.jdField_a_of_type_JavaUtilList);
