  ...
  implements View.OnClickListener
{
  ...
  public bahd(BulkSendMessageFragment paramBulkSendMessageFragment)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramViewGroup = new bahe(localView);
      ...
      localObject2 = (ajxl)this.jdField_a_of_type_ComTencentMobileqqTroopTroop_appsEntryUiBulkSendMessageFragment.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
      if (paramInt >= this.jdField_a_of_type_JavaUtilArrayList.size()) {
        break label395;
      }
      localImageView.setImageResource(2130844140);
      ...
      localObject1 = bbcz.h(this.jdField_a_of_type_ComTencentMobileqqTroopTroop_appsEntryUiBulkSendMessageFragment.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTroopTroop_appsEntryUiBulkSendMessageFragment.jdField_a_of_type_JavaLangString, str);
      ...
      localImageView.setImageDrawable(bbef.b());
      label230:
      paramViewGroup.jdField_a_of_type_AndroidViewView.setTag(2131376844, null);
    ...
    for (;;)
    {
      ...
      return localView;
      paramViewGroup = (bahe)paramView.getTag();
      localView = paramView;
      break;
      label277:
        ...
        if (localObject2 != null)
        {
          ...
          if (localObject2 != null)
          {
            ...
            if (((Friends)localObject2).isFriend()) {
              paramView = bbcz.a(this.jdField_a_of_type_ComTencentMobileqqTroopTroop_appsEntryUiBulkSendMessageFragment.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str);
            }
          }
        }
      }
      ...
      if (TextUtils.isEmpty(paramView)) {
        localObject1 = ajya.a(2131701233);
      }
      ...
      localImageView.setTag(2131376870, str);
      ...
      paramViewGroup.jdField_a_of_type_AndroidViewView.setTag(2131376844, Integer.valueOf(0));
  ...
  {
    paramView = (Integer)paramView.getTag(2131376844);
    if (paramView == null) {}
    ...
    paramView.putStringArrayListExtra("param_pick_selected_list", this.jdField_a_of_type_ComTencentMobileqqTroopTroop_appsEntryUiBulkSendMessageFragment.jdField_a_of_type_Bahd.jdField_a_of_type_JavaUtilArrayList);
    ...
    paramView.putExtra("param_pick_max_num_exceeds_wording", 2131697835);
    paramView.putExtra("param_pick_title_string", ajya.a(2131701226));
