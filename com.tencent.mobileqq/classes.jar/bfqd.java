...
public class bfqd
{
  private static volatile bfqd jdField_a_of_type_Bfqd;
  ...
  private Vector<bfqf> jdField_a_of_type_JavaUtilVector = new Vector();
  ...
  {
    if (jdField_a_of_type_Bfqd == null) {}
    try
    {
      if (jdField_a_of_type_Bfqd == null) {
        jdField_a_of_type_Bfqd = new bfqd();
      }
      return jdField_a_of_type_Bfqd;
    }
    finally {}
  }
  ...
  private void a()
  {
    ...
    if (Build.VERSION.SDK_INT > 16)
    {
      if (this.jdField_a_of_type_AndroidViewChoreographer$FrameCallback == null) {
        this.jdField_a_of_type_AndroidViewChoreographer$FrameCallback = new bfqe(this);
      }
  ...
  private void a(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          ((bfqf)this.jdField_a_of_type_JavaUtilVector.get(i)).onInfo(this.jdField_a_of_type_Long, d);
          i += 1;
        }
      }
      finally {}
  ...
  public void a(bfqf parambfqf)
  {
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      if (!this.jdField_a_of_type_JavaUtilVector.contains(parambfqf)) {
        this.jdField_a_of_type_JavaUtilVector.add(parambfqf);
      }
  ...
  public void b(bfqf parambfqf)
  {
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      if (this.jdField_a_of_type_JavaUtilVector.contains(parambfqf)) {
        this.jdField_a_of_type_JavaUtilVector.remove(parambfqf);
      }
      if (this.jdField_a_of_type_JavaUtilVector.size() <= 0) {
        b();
      }
