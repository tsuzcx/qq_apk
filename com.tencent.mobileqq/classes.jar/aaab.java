  ...
  implements apsw
{
  ...
  {
    paramString = new aaad(this, paramString);
    ...
    this.jdField_a_of_type_Aanz.c(localBundle);
  }
  ...
  private void a(String paramString, String[] paramArrayOfString)
  {
          ...
          do
          {
            do
            {
              do
              {
                  ...
                  do
                  {
                    do
                    {
                      do
                      {
                        ...
                        {
                          return;
                          paramString = new aaad(this, paramArrayOfString[0]);
                          QLog.d(this.TAG, 2, paramString.toString());
                          if ((this.mRuntime != null) && ((this.mRuntime.a() instanceof SubscribeHybirdFragment)))
                          {
                            ((SubscribeHybirdFragment)this.mRuntime.a()).a(aaae.a(paramString.getString("feedid"), paramString.getString("uin"), paramString.getInt("type"), paramString.getInt("width"), paramString.getInt("height"), Long.valueOf(paramString.getString("createtime")).longValue()));
                            return;
                          }
                        } while ((this.mRuntime == null) || (this.mRuntime.a() == null));
                        aaae.a(null, aaae.a(paramString.getString("feedid"), paramString.getString("uin"), paramString.getInt("type"), paramString.getInt("width"), paramString.getInt("height"), Long.valueOf(paramString.getString("createtime")).longValue()));
                        return;
                ...
                paramString = new aaad(this, paramArrayOfString[0]).optString("puin");
                new Intent().putExtra("postUin", paramString);
                blsb.a(this.mRuntime.a().getActivity(), null, 0);
                return;
    ...
    aaae.a(null, new aaad(this, paramArrayOfString[0]).optString("uid"));
  }
  ...
  {
    paramString = new aaad(this, paramString).getJSONArray("goods");
    if (paramString != null)
    {
  ...
  private void c(String paramString)
  {
    ...
    Object localObject = new aaad(this, paramString);
    paramString = ((aaad)localObject).optString("uin");
    String str = ((aaad)localObject).optString("nick");
    localObject = ((aaad)localObject).optString("callback");
    aajj.a(this.mRuntime.a().getActivity(), paramString, str, new aaac(this, (String)localObject, str));
  }
  ...
  private void d(String paramString)
  {
    ...
    if ("1".equals(paramString.getString("avatarType")))
    {
      ...
      this.jdField_a_of_type_Apss = new apss(this.mRuntime.a(), i);
      this.jdField_a_of_type_Apss.a();
      this.jdField_a_of_type_Apss.a(this);
    }
    for (;;)
    {
      ...
      break;
      label130:
      this.jdField_a_of_type_Apss.a(i);
    }
  }
  ...
  public void onDestroy()
  {
    ...
    if (this.jdField_a_of_type_Apss != null)
    {
      ...
      this.jdField_a_of_type_Apss = null;
    }
  }
}
