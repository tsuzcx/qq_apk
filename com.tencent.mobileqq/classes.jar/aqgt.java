  ...
  extends MSFServlet
{
  ...
  private void a(aqgn paramaqgn, oidb_0xdea.GetBarrageListRspBody paramGetBarrageListRspBody)
  {
    ...
    paramaqgn.a(aqgm.a().a(localList1, paramaqgn.jdField_a_of_type_Aqgl.b)).b(localList2).a(m).b(n).c(k).a(bool).a();
  }
  
  void a(aqgn paramaqgn)
  {
    if (paramaqgn == null)
    {
      if (QLog.isColorLevel()) {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("DanmuDataHolder", 2, "request called, param:" + paramaqgn.a());
    }
    Object localObject = new oidb_0xdea.GetBarrageListReqBody();
    ((oidb_0xdea.GetBarrageListReqBody)localObject).uint64_group_code.set(paramaqgn.jdField_a_of_type_Aqgl.b);
    ((oidb_0xdea.GetBarrageListReqBody)localObject).uint64_barrage_seq.set(paramaqgn.jdField_a_of_type_Aqgl.jdField_a_of_type_Long);
    ((oidb_0xdea.GetBarrageListReqBody)localObject).uint32_last_update_time.set(paramaqgn.jdField_a_of_type_Int);
    ((oidb_0xdea.GetBarrageListReqBody)localObject).uint32_start_index.set(paramaqgn.e);
    ((oidb_0xdea.GetBarrageListReqBody)localObject).uint32_barrage_count.set(paramaqgn.f);
    int i;
    if ((paramaqgn.jdField_a_of_type_Aqgl.jdField_a_of_type_Int == 101) || (paramaqgn.jdField_a_of_type_Aqgl.jdField_a_of_type_Int == 103))
    {
      i = 1;
      if (i == 0) {
        break label327;
      }
      ((oidb_0xdea.GetBarrageListReqBody)localObject).uint32_video_start_time.set(paramaqgn.jdField_c_of_type_Int);
      ((oidb_0xdea.GetBarrageListReqBody)localObject).uint32_video_end_time.set(paramaqgn.jdField_d_of_type_Int);
      label182:
      ((oidb_0xdea.GetBarrageListReqBody)localObject).terminal.set(0);
      switch (paramaqgn.jdField_a_of_type_Aqgl.jdField_a_of_type_Int)
      {
      }
    }
    for (;;)
    {
      ...
      localObject = aqgm.a().a();
      NewIntent localNewIntent = new NewIntent(((QQAppInterface)localObject).getApp(), aqgt.class);
      localNewIntent.putExtra("KEY_SEND_DATA", localReqBody.toByteArray());
      localNewIntent.putExtra("KEY_GROUP_UIN", paramaqgn.jdField_a_of_type_Aqgl.b);
      localNewIntent.putExtra("KEY_TOPIC_UIN", paramaqgn.jdField_a_of_type_Aqgl.jdField_a_of_type_Long);
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if ((l1 == 0L) || (l2 == 0L))
    {
      ...
      for (;;)
      {
        aqgv.a(bool1, i, -1, false, "onReceive, topicUin:0, groupUin:0");
        return;
        bool1 = false;
      }
    }
    paramIntent = aqgm.a().a(l2, l1);
    aqgn localaqgn = aqgm.a().a(paramIntent);
    if (localaqgn == null)
    {
      if (QLog.isColorLevel()) {
      ...
      {
        aqgv.a(bool1, i, -1, false, "onReceive, holder null");
        return;
      }
    }
    ...
    for (bool1 = true;; bool1 = false)
    {
      ...
      {
        bool2 = true;
        int j = localaqgn.jdField_a_of_type_Aqgl.jdField_a_of_type_Int;
        if (!bool1) {
          break label379;
        }
        paramIntent = "DanmuRsp Valid";
        label246:
        aqgv.a(bool2, i, j, bool1, paramIntent);
        if (!bool1) {
          break label395;
        }
        paramFromServiceMsg = localaqgn.jdField_a_of_type_Aqgr;
        aqgl localaqgl = localaqgn.jdField_a_of_type_Aqgl;
        bool2 = localaqgn.jdField_a_of_type_Boolean;
        i = localaqgn.b;
        if (!localaqgn.jdField_a_of_type_Aqgl.jdField_a_of_type_Boolean) {
          break label386;
        }
        paramIntent = localaqgn.jdField_c_of_type_JavaUtilList;
        label305:
        paramFromServiceMsg.a(localaqgl, true, bool2, i, (ArrayList)paramIntent, localaqgn.jdField_a_of_type_JavaUtilList);
        localaqgn.jdField_a_of_type_Aqgl.jdField_a_of_type_Boolean = true;
      }
      for (;;)
      {
        if ((!bool1) || (localaqgn.jdField_a_of_type_Boolean)) {
          break label424;
        }
        if (QLog.isColorLevel()) {
        ...
        break label246;
        label386:
        paramIntent = localaqgn.jdField_d_of_type_JavaUtilList;
        break label305;
        label395:
        localaqgn.jdField_a_of_type_Aqgr.a(localaqgn.jdField_a_of_type_Aqgl, false, localaqgn.jdField_a_of_type_Boolean, localaqgn.b, null, null);
      }
      label424:
      break;
    }
