...
public class bfpg
{
  ...
  {
    byte[] arrayOfByte = bhmi.a(BaseApplication.getContext().getFileStreamPath("0x496_aio_keyword"));
  ...
  public static List<bfph> a(oidb_0x496.AioKeyword paramAioKeyword)
  {
    ...
    while (paramAioKeyword.hasNext())
    {
      ...
      bfph localbfph = new bfph();
      localbfph.jdField_a_of_type_JavaLangString = localAioKeywordInfo.word.get();
      localbfph.jdField_a_of_type_JavaUtilList = localAioKeywordInfo.rule_id.get();
      localArrayList.add(localbfph);
    }
    return localArrayList;
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, oidb_0x496.AioKeyword paramAioKeyword)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = localFileOutputStream;
        localObject2 = localFileOutputStream;
        bhsi.P(BaseApplicationImpl.getApplication(), paramQQAppInterface.getCurrentAccountUin(), paramAioKeyword.version.get());
      }
  ...
  public static List<bfpi> b(oidb_0x496.AioKeyword paramAioKeyword)
  {
    ...
    while (paramAioKeyword.hasNext())
    {
      ...
      bfpi localbfpi = new bfpi();
      localbfpi.jdField_a_of_type_Int = localAioKeywordRuleInfo.rule_id.get();
      localbfpi.b = localAioKeywordRuleInfo.start_time.get();
      localbfpi.c = localAioKeywordRuleInfo.end_time.get();
      localbfpi.d = localAioKeywordRuleInfo.postion_flag.get();
      localbfpi.jdField_a_of_type_JavaUtilList = localAioKeywordRuleInfo.match_group_class.get();
      localbfpi.e = localAioKeywordRuleInfo.version.get();
      localArrayList.add(localbfpi);
    }
    return localArrayList;
  }
}
