...
public class axrb
{
  ...
  private void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if ((paramBoolean) && (this.jdField_a_of_type_Axrf != null)) {
          this.jdField_a_of_type_Axrf.k();
        }
        return;
        if (QLog.isColorLevel()) {
  ...
  public void a(MediaFormat paramMediaFormat)
  {
    ...
    if (this.jdField_a_of_type_Axrf != null) {
      this.jdField_a_of_type_Axrf.a(this.jdField_a_of_type_AndroidMediaMediaFormat);
    }
    return;
    label114:
    this.jdField_a_of_type_Axrs.a(0, paramMediaFormat);
  }
  ...
  public void a(axqz paramaxqz)
  {
    ...
    if (paramaxqz.j != -1) {
      ((MediaFormat)localObject).setInteger("bitrate-mode", paramaxqz.j);
    }
    if (paramaxqz.k != -1)
    {
    ...
    if (paramaxqz.jdField_b_of_type_Boolean)
    {
      ((MediaFormat)localObject).setInteger("profile", 1);
      ((MediaFormat)localObject).setInteger("level", 512);
    }
    if (QLog.isColorLevel()) {
      QLog.d("HWVideoEncoder", 2, "start : encodeConfig = + " + paramaxqz.toString() + " ; format: " + localObject);
    }
    ...
    if (paramaxqz.jdField_a_of_type_Axrs == null)
    {
    ...
    for (;;)
    {
      if (paramaxqz.jdField_a_of_type_Axrf != null) {
        this.jdField_a_of_type_Axrf = paramaxqz.jdField_a_of_type_Axrf;
      }
      this.jdField_a_of_type_Int = -1;
      this.jdField_a_of_type_Boolean = false;
      return;
      this.jdField_a_of_type_Axrs = paramaxqz.jdField_a_of_type_Axrs;
      this.jdField_a_of_type_Axrs.jdField_a_of_type_AndroidMediaMediaMuxer.setOrientationHint(paramaxqz.g);
    }
  }
  ...
  public void a(ByteBuffer paramByteBuffer, MediaCodec.BufferInfo paramBufferInfo)
  {
    if (this.jdField_a_of_type_Axrs == null)
    {
      ...
      if (this.jdField_a_of_type_Axrf != null)
      {
        ...
        this.jdField_a_of_type_Axrf.a(paramBufferInfo);
    ...
    this.jdField_a_of_type_Axrs.a(0, paramByteBuffer, paramBufferInfo);
  }
    ...
    catch (Exception localException1)
    {
      try
      {
        for (;;)
        {
          ...
          if ((this.jdField_a_of_type_Axrs != null) || (this.jdField_a_of_type_AndroidMediaMediaMuxer == null)) {
            break label237;
          }
          try
          {
      ...
      catch (Exception localException2)
      {
        ...
        } while (this.jdField_a_of_type_Axrs == null);
