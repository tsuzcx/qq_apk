...
public class tzx
{
  ...
  {
    return new ArrayList(Arrays.asList(new FeedCloudCommon.Entry[] { tzy.a("host_uin", String.valueOf(bfbm.a().a())), tzy.a("qua", bjdm.a()), tzy.a("network_type", tzy.b()), tzy.a("client_time", String.valueOf(System.currentTimeMillis())), tzy.a("event_id", paramString), tzy.a("mobile_type", Build.MODEL + "_" + Build.VERSION.RELEASE), tzy.a("version", "8.3.5.4555"), tzy.a("platform", "AND"), tzy.a("unique_id", String.valueOf(a())) }));
  }
  ...
  public static void a(String paramString, List<FeedCloudCommon.Entry> paramList, boolean paramBoolean)
  {
    ...
    uab.a().a().post(new QCircleQualityReporter.1(paramString, paramList));
  }
