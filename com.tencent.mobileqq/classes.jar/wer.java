  ...
  extends wjh
{
  private boolean a(List<String> paramList)
  {
    ...
    if (paramList.isEmpty())
    {
      ...
      localwjl.b("key_story_msg_tab_show", Boolean.valueOf(false));
      bool = true;
    }
    for (;;)
    {
      ((vzu)localQQAppInterface.getBusinessHandler(BusinessHandlerFactory.QQSTORY_HANDLER)).notifyUI(1021, true, null);
      return bool;
      ...
      if (paramList != null)
      {
        ...
        try
        {
          ...
          {
            localwjl.b("key_story_msg_tab_show", Boolean.valueOf(bool));
            localwjl.b("key_story_msg_tab_autoshow_quota", Integer.valueOf(paramList.optInt("StoryAutoExpInMsgTab", 2)));
            bool = true;
            break;
          }
          bool = false;
  ...
  private boolean b(List<String> paramList)
  {
    ...
    try
    {
      ...
      wjl localwjl = (wjl)wjs.a(10);
      localwjl.b("key_story_msg_tab_node_preload", Integer.valueOf(i));
      localwjl.b("key_story_msg_tab_node_preload_4g", Boolean.valueOf("1".equals(paramList)));
      return true;
    }
    catch (JSONException paramList)
    {
