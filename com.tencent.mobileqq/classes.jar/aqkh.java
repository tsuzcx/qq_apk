  ...
  implements Manager
{
  ...
  public aqkh(QQAppInterface paramQQAppInterface)
  {
  ...
  public IntimateInfo a(String paramString)
  {
    ...
    return (IntimateInfo)this.jdField_a_of_type_Aukn.a(IntimateInfo.class, paramString);
  }
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          b(str);
        } while (this.jdField_a_of_type_Ayxq == null);
        Object localObject = new ayrv();
        ((ayrv)localObject).jdField_a_of_type_Aysa = new aqki(this);
        ((ayrv)localObject).jdField_a_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
        ((ayrv)localObject).jdField_a_of_type_Int = 0;
        ((ayrv)localObject).c = str;
        ((ayrv)localObject).e = 0;
        ((ayrv)localObject).jdField_a_of_type_Ayrz = new aqkj(this);
        localObject = new ayxo(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.b, new aqkk(this), (ayrv)localObject);
        this.jdField_a_of_type_Ayxq.a(10089, "prd", this.b, 0, this.jdField_a_of_type_JavaLangString, str, 2, 0, false, (ayxn)localObject);
        return;
      } while (c());
      bool1 = b(str, a());
      bool2 = c();
  ...
  public void a(IntimateInfo paramIntimateInfo)
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_Aukn != null) && (this.jdField_a_of_type_Aukn.a())) {
        this.jdField_a_of_type_Aukn.a(paramIntimateInfo);
      }
    } while (!QLog.isColorLevel());
  ...
  public void a(String paramString)
  {
    ...
    do
    {
      ...
      paramString = (IntimateInfo)this.jdField_a_of_type_Aukn.a(IntimateInfo.class, paramString);
      if (paramString != null) {
  ...
  public void a(String paramString, IntimateInfo paramIntimateInfo)
  {
    ...
    do
    {
      return;
      if ((this.jdField_a_of_type_Aukn != null) && (this.jdField_a_of_type_Aukn.a())) {
        this.jdField_a_of_type_Aukn.b(paramIntimateInfo);
      }
    } while (!QLog.isColorLevel());
