  ...
  extends ajtb
{
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0) {
      ((aqkj)this.mApp.getManager(323)).a(paramToServiceMsg);
    }
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      {
        paramObject = (aqkj)this.mApp.getManager(323);
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      ...
      if (!paramFromServiceMsg.isEmpty()) {
        ((assi)this.app.getManager(329)).a(l2, paramFromServiceMsg);
      }
      return;
    }
    if (com.tencent.qphone.base.util.QLog.isColorLevel()) {
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      ...
      paramToServiceMsg = (assi)this.app.getManager(329);
  ...
  public void b(String paramString)
  {
    try
    {
      ...
      mxf.a(this.app, new aqki(this), localReqBody.toByteArray(), "OidbSvc.0xd6f_0", 3439, 0);
      return;
    }
    catch (Exception localException)
    {
