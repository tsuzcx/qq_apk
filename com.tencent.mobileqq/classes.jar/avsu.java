  ...
  extends Animation
{
  ...
  @TargetApi(11)
  public avsu(Path paramPath, float paramFloat, View paramView1, View paramView2, avst paramavst)
  {
    ...
    this.jdField_a_of_type_Avst = paramavst;
  ...
  protected void applyTransformation(float paramFloat, Transformation paramTransformation)
  {
    ...
    if (Build.VERSION.SDK_INT >= 11)
    {
      ...
      avst localavst = this.jdField_a_of_type_Avst;
      ((View)localObject).setRotation(f * paramFloat * avst.jdField_b_of_type_Float);
    }
    if (this.jdField_a_of_type_Avst.jdField_b_of_type_Boolean)
    {
      f = this.jdField_a_of_type_AndroidViewAnimationInterpolator.getInterpolation(paramFloat);
      this.jdField_a_of_type_AndroidViewView.setScaleX(this.jdField_a_of_type_Avst.c * f);
      this.jdField_a_of_type_AndroidViewView.setScaleY(f * this.jdField_a_of_type_Avst.c);
    }
