  ...
  extends DynamicTextItem
{
  ...
  static
  {
    jdField_a_of_type_Float = bclx.a(22.0F);
    jdField_b_of_type_Float = bclx.a(3.0F);
    Resources localResources = BaseApplicationImpl.getContext().getResources();
    jdField_b_of_type_Int = afur.a(27.0F, localResources);
    jdField_d_of_type_Int = afur.a(6.0F, localResources);
    int i = bppm.a();
    jdField_c_of_type_Int = localResources.getDisplayMetrics().widthPixels - yxm.a - i * 2;
  }
  
  public borp(int paramInt, List<String> paramList, Typeface paramTypeface)
  {
