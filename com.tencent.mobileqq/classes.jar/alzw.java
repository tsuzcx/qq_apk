...
public class alzw
{
  ...
  private final Map<Integer, alzl> jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  private final Object jdField_b_of_type_JavaLangObject = new Object();
  private final Map<Integer, alzx> jdField_b_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  static
  {
    jdField_a_of_type_ArrayOfInt = new int[] { 390, 26, 76, 95, 455, 524, 409, 469, 412, 359, 413, 563, 427, 428, 465, 477, 491, 542, 414, 419, 416, 445, 418, 424, 411, 423, 406, 417, 425, 426, 67, 430, 68, 526, 463, 380, 159, 170, 186, 250, 92, 368, 158, 361, 207, 585, 292, 168, 433, 432, 434, 456, 460, 435, 438, 441, 106, 132, 172, 176, 192, 216, 249, 263, 270, 276, 287, 367, 370, 382, 298, 431, 543, 439, 442, 488, 444, 362, 396, 449, 85, 32, 35, 70, 81, 383, 346, 294, 327, 334, 335, 338, 342, 344, 348, 377, 429, 437, 440, 525, 164, 325, 252, 304, 305, 306, 307, 309, 310, 446, 447, 15, 458, 453, 454, 452, 457, 547, 462, 451, 261, 467, 466, 490, 470, 478, 479, 473, 474, 485, 483, 484, 487, 489, 486, 492, 498, 493, 500, 251, 587, 521, 495, 496, 502, 503, 504, 505, 506, 507, 508, 560, 509, 520, 516, 515, 519, 518, 517, 514, 512, 511, 513, 510, 493, 500, 251, 587, 521, 482, 501, 497, 522, 529, 499, 528, 527, 541, 562, 580, 533, 534, 532, 535, 537, 538, 545, 539, 540, 548, 546, 544, 550, 530, 561, 575, 551, 552, 553, 531, 549, 554, 555, 556, 557, 559, 564, 581, 566, 578, 567, 568, 576, 579, 583, 574, 573, 586, 577, 589 };
  }
  ...
  private int a(alzl paramalzl, int paramInt, long paramLong)
  {
    int i = a(paramLong).getInt(String.valueOf(paramInt), -1);
    paramInt = i;
    if (i == -1) {
      paramInt = paramalzl.b();
    }
    return paramInt;
  }
  ...
  private <T> T a(alzl<T> paramalzl, int paramInt)
  {
    Object localObject2 = paramalzl.a(paramInt);
    Object localObject1 = localObject2;
    if (localObject2 == null) {
      localObject1 = a(paramalzl.a());
    }
    return localObject1;
  }
  
  private Object a(alzl paramalzl, long paramLong, int paramInt)
  {
    Object localObject2 = a(paramalzl.a());
    if (localObject2 != null)
    {
      int i = paramalzl.a();
      int j = a(paramalzl, i, paramLong);
    ...
    for (Object localObject1 = localObject2;; localObject1 = paramalzl.a(0))
    {
      if (QLog.isColorLevel()) {
        QLog.d("QConfigManager", 2, "loadNewConfigFailBackport, version=" + paramInt + ", type" + paramalzl.a() + ", conf=" + localObject1);
      }
      return localObject1;
    }
  }
  
  private Object a(alzl paramalzl, alzs[] paramArrayOfalzs, int paramInt)
  {
    try
    {
      Object localObject = paramalzl.b(paramArrayOfalzs);
      return localObject;
    }
    catch (Exception localException)
    {
      alzz.a().a(paramalzl, paramArrayOfalzs, paramInt, localException);
    }
    return null;
  }
  ...
  private void a(alzl paramalzl, ConfigurationService.Config paramConfig, long paramLong, String paramString, int paramInt1, int paramInt2)
  {
    int i = paramConfig.msg_content_list.size();
    if (i == 0) {
      paramConfig = paramalzl.a(1);
    }
    label312:
    for (;;)
    {
      ...
      {
        a(paramalzl, paramConfig, paramInt2, paramLong, bool);
        return;
        ...
        if (paramInt1 < i)
        {
          ...
          if ((localContent != null) && (localContent.content.has()))
          {
            ...
            localObject1 = atiu.a(localContent.content.get().toByteArray());
            if (localObject1 == null) {
              break label193;
            }
          }
          for (;;)
          {
            try
            {
              ...
              if (!TextUtils.isEmpty((CharSequence)localObject1)) {
                localArrayList.add(new alzs(localContent.task_id.get(), (String)localObject1));
              }
              paramInt1 += 1;
            }
        ...
        Object localObject2 = new alzs[localArrayList.size()];
        localArrayList.toArray((Object[])localObject2);
        paramConfig = a(paramalzl, (alzs[])localObject2, paramInt2);
        if (paramConfig != null)
        {
          a(paramalzl, (alzs[])localObject2, paramLong, paramString);
          if (!QLog.isColorLevel()) {
            break label312;
          }
        ...
        paramConfig = a(paramalzl, paramLong, paramInt2);
        break;
      }
    }
  }
  
  private void a(alzl paramalzl, Object paramObject, int paramInt, long paramLong, boolean paramBoolean)
  {
    if (paramObject != null)
    {
      a(paramLong).edit().putInt(String.valueOf(paramalzl.a()), paramInt).putBoolean(paramalzl.a() + "_" + paramInt + "_defualt", paramBoolean).apply();
      this.jdField_b_of_type_JavaUtilMap.put(Integer.valueOf(paramalzl.a()), new alzx(paramLong, paramInt, paramObject));
      paramalzl.a(paramObject);
    }
  }
  
  private void a(alzl paramalzl, alzs[] paramArrayOfalzs, long paramLong, String paramString)
  {
    int j = 0;
    int i = 0;
    if (paramalzl.b())
    {
      ...
      {
        paramalzl = a(paramString, String.valueOf(paramArrayOfalzs[i].jdField_a_of_type_Int));
        if (paramalzl != null) {
          a(paramArrayOfalzs[i].jdField_a_of_type_JavaLangString, paramalzl);
        }
        i += 1;
      }
    }
    ...
    while (i < paramArrayOfalzs.length)
    {
      localHashSet.add(String.valueOf(paramArrayOfalzs[i].jdField_a_of_type_Int));
      paramString.putString(paramalzl.a() + "_" + paramArrayOfalzs[i].jdField_a_of_type_Int, paramArrayOfalzs[i].jdField_a_of_type_JavaLangString);
      i += 1;
    }
    a(paramLong).edit().putStringSet(paramalzl.a() + "_ids", localHashSet).apply();
    paramString.apply();
  }
  ...
  private alzs[] a(int paramInt, long paramLong)
  {
    ...
    Object localObject = new alzs[arrayOfFile.length];
    paramInt = 0;
    while (paramInt < arrayOfFile.length)
    {
      File localFile = arrayOfFile[paramInt];
      localObject[paramInt] = new alzs(a(localFile), a(localFile));
      paramInt += 1;
    }
    return localObject;
  }
  
  private alzl b(int paramInt)
  {
    switch (paramInt)
    {
    default: 
  ...
  private void b(alzl paramalzl, ConfigurationService.Config paramConfig, long paramLong, String paramString, int paramInt1, int paramInt2)
  {
    if (paramConfig.content_list.isEmpty()) {
      paramString = paramalzl.a(1);
    }
    for (;;)
    {
      a(paramalzl, paramString, paramInt2, paramLong, paramConfig.content_list.isEmpty());
      return;
      int i = paramConfig.content_list.size();
      alzs[] arrayOfalzs = new alzs[i];
      paramInt1 = 0;
      while (paramInt1 < i)
      {
        arrayOfalzs[paramInt1] = new alzs(paramInt1, (String)paramConfig.content_list.get(paramInt1));
        paramInt1 += 1;
      }
      Object localObject = a(paramalzl, arrayOfalzs, paramInt2);
      if (localObject != null)
      {
        a(paramalzl, arrayOfalzs, paramLong, paramString);
        if (QLog.isColorLevel())
        {
      ...
      {
        paramString = a(paramalzl, paramLong, paramInt2);
        continue;
      }
      paramString = localObject;
    }
  ...
  private alzs[] b(int paramInt, long paramLong)
  {
    if (a(paramInt) == null)
    {
      if (QLog.isColorLevel()) {
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      localObject1[i] = new alzs(Integer.valueOf(str).intValue(), localSharedPreferences.getString(paramInt + "_" + str, null));
      i += 1;
    }
    return localObject1;
  }
  
  private alzl c(int paramInt)
  {
    alzl localalzl = a(paramInt);
    if (localalzl == null) {}
    return localalzl;
  }
  ...
  public int a(int paramInt, long paramLong)
  {
    ...
    return a(localalzl, paramInt, paramLong);
  }
  ...
  public int a(int paramInt, String paramString)
  {
    ...
    return a(localalzl, paramInt, a(paramString, localalzl.a()));
  }
  
  public alzl a(int paramInt)
  {
    Object localObject1 = (alzl)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
    if (localObject1 == null) {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        alzl localalzl2 = (alzl)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
        localObject1 = localalzl2;
        if (localalzl2 == null)
        {
          localalzl2 = b(paramInt);
          localObject1 = localalzl2;
          if (localalzl2 != null)
          {
            this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(paramInt), localalzl2);
            localObject1 = localalzl2;
          }
        }
        return localObject1;
  ...
  public <T> T a(int paramInt)
  {
    ...
    int i;
    for (long l = a(((SimpleAccount)localObject1).getUin(), localalzl.a());; l = 0L)
    {
      localObject1 = a(l);
      ...
      return a(localalzl, 0);
      if (QLog.isColorLevel()) {
        QLog.d("QConfigManager", 2, "Can not get an runtime.May be in a process of none appRuntime.");
      }
      return a(localalzl, 1);
    }
    ??? = (alzx)this.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
    if ((??? != null) && (((alzx)???).jdField_a_of_type_Int == i) && (((alzx)???).jdField_a_of_type_Long == l) && (((alzx)???).jdField_a_of_type_JavaLangObject != null)) {
      return ((alzx)???).jdField_a_of_type_JavaLangObject;
    }
    if (((SharedPreferences)localObject1).getBoolean(localalzl.a() + "_" + i + "_defualt", false)) {
      return a(localalzl, 0);
    }
    Object localObject3;
    for (;;)
    {
      ...
      {
        alzt.a().a(paramInt, l, localalzl.b());
        if (localalzl.b())
        {
    ...
    try
    {
      Object localObject5 = localalzl.b((alzs[])localObject3);
      this.jdField_b_of_type_JavaUtilMap.put(Integer.valueOf(paramInt), new alzx(l, i, localObject5));
      return localObject5;
    }
    catch (Exception localException)
    {
      alzz.a().a(localalzl, (alzs[])localObject3, i, localException);
      localObject3 = a(localalzl.a());
    }
    return localObject3;
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    {
      l1 = l2;
      if (((alzl)localObject).a())
      {
        AppRuntime localAppRuntime = MobileQQ.sMobileQQ.waitAppRuntime(null);
        l1 = l2;
        if (localAppRuntime != null) {
          l1 = a(localAppRuntime.getAccount(), ((alzl)localObject).a());
        }
      }
    }
    localObject = a(l1);
  ...
  public void a(int paramInt1, int paramInt2, ConfigurationService.Config paramConfig, String arg4)
  {
    ...
    if (localalzl.c()) {
      a(localalzl, paramConfig, l, str, i, paramInt2);
    }
    for (;;)
    {
      alzt.a().a(paramInt1, l, localalzl.b());
      return;
      b(localalzl, paramConfig, l, str, i, paramInt2);
    }
  }
  ...
  public void a(int[] paramArrayOfInt)
  {
    ...
    amnh.jdField_a_of_type_JavaLangString = str;
    NewIntent localNewIntent = new NewIntent(BaseApplicationImpl.getApplication(), amnh.class);
  ...
  public int b(int paramInt, long paramLong)
  {
    ...
    alzl localalzl = a(paramInt);
    if ((localalzl != null) && (localalzl.d()) && (i == 0)) {
