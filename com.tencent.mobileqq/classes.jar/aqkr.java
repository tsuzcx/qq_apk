...
public class aqkr
{
  ...
  public final ConcurrentHashMap<Integer, HashMap<String, aqly>> a;
  public final CopyOnWriteArrayList<aqmm> a;
  ...
  public static aqkr a()
  {
    if (jdField_a_of_type_Aqkr == null) {}
    try
    {
      if (jdField_a_of_type_Aqkr == null) {
        jdField_a_of_type_Aqkr = new aqkr();
      }
      return jdField_a_of_type_Aqkr;
    }
    finally {}
  }
  
  public Bitmap a(aqmm paramaqmm, aqlz paramaqlz)
  {
    if ((paramaqmm == null) || (paramaqlz == null)) {
      return null;
    }
    paramaqmm = "BubbleDiyFetcher_" + paramaqlz.jdField_a_of_type_Int + "_" + paramaqlz.jdField_a_of_type_JavaLangString.toUpperCase() + "_" + "chartlet";
    paramaqlz = (Bitmap)BaseApplicationImpl.sImageCache.get(paramaqmm);
    if (paramaqlz != null)
    {
      this.c.remove(paramaqmm);
      return paramaqlz;
    }
    this.c.add(paramaqmm);
    paramaqmm = BaseApplicationImpl.getApplication().getRuntime();
    if ((paramaqmm instanceof QQAppInterface)) {
      a((QQAppInterface)paramaqmm, 500);
    }
    return null;
  }
  
  public String a(aqmm paramaqmm, String paramString)
  {
    Object localObject;
    if ((paramaqmm == null) || (TextUtils.isEmpty(paramString))) {
      localObject = "";
    }
    String str;
    do
    ...
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(paramaqmm);
    paramaqmm = BaseApplicationImpl.getApplication().getRuntime();
    if ((paramaqmm instanceof QQAppInterface)) {
      a((QQAppInterface)paramaqmm, 500);
    }
  ...
  public void a()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((localaqmm != null) && (localaqmm.getCallback() != null) && (a(localaqmm.jdField_a_of_type_JavaLangString))) {
        localHashSet.add(localaqmm.jdField_a_of_type_JavaLangString);
      }
    }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString, anui paramanui)
  {
    ...
    do
    {
      ...
      } while (paramanui == null);
      paramanui.onUpdate(1, true, paramString);
      return;
    ...
    paramanui.onUpdate(1, true, paramQQAppInterface);
    return;
    if (QLog.isColorLevel()) {
    ...
    ((aqks)paramQQAppInterface.a(70)).a((List)localObject, paramanui);
  }
  ...
  public Bitmap b(aqmm paramaqmm, aqlz paramaqlz)
  {
    if ((paramaqmm == null) || (paramaqlz == null) || (TextUtils.isEmpty(paramaqmm.jdField_a_of_type_JavaLangString))) {
      return null;
    }
    if (this.jdField_b_of_type_JavaUtilMap.containsKey(paramaqmm.jdField_a_of_type_JavaLangString))
    {
      Object localObject = (HashMap)this.jdField_b_of_type_JavaUtilMap.get(paramaqmm.jdField_a_of_type_JavaLangString);
      if ((localObject != null) && (((HashMap)localObject).containsKey(paramaqlz.jdField_a_of_type_JavaLangString.toUpperCase())))
      {
        localObject = (String)((HashMap)localObject).get(paramaqlz.jdField_a_of_type_JavaLangString.toUpperCase());
        if (TextUtils.isEmpty((CharSequence)localObject))
        {
          if (QLog.isColorLevel()) {
            QLog.i("BubbleDiyFetcher", 2, "diy id " + paramaqmm.jdField_a_of_type_JavaLangString + " has no pasterId for align: " + paramaqlz.jdField_a_of_type_JavaLangString.toUpperCase());
          }
          return null;
        }
      }
      ...
      paramaqlz = "BubbleDiyFetcher_" + paramaqlz.jdField_a_of_type_Int + "_" + paramaqlz.jdField_a_of_type_JavaLangString.toUpperCase() + "_" + (String)localObject;
      localObject = (Bitmap)BaseApplicationImpl.sImageCache.get(paramaqlz);
      if (localObject != null)
      {
        this.jdField_b_of_type_JavaUtilConcurrentCopyOnWriteArraySet.remove(paramaqlz);
        return localObject;
      }
      if (QLog.isColorLevel()) {
        QLog.i("BubbleDiyFetcher", 2, "can not found bitmap cache in BaseApplicationImpl.sImageCache! " + paramaqlz);
      }
      this.jdField_b_of_type_JavaUtilConcurrentCopyOnWriteArraySet.add(paramaqlz);
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
      ...
      return null;
      if (QLog.isColorLevel()) {
        QLog.i("BubbleDiyFetcher", 2, "can not found cache in diyPasterCache! " + paramaqmm.jdField_a_of_type_JavaLangString);
      }
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArraySet.add(paramaqmm.jdField_a_of_type_JavaLangString);
    }
  }
  ...
  public void c(String paramString)
  {
      ...
      if (BaseApplicationImpl.sImageCache.get(paramString) == null)
      {
        ...
        if (localObject2 == null)
        {
          ...
          if (((File)localObject6).exists())
          {
            ...
            localObject2 = bhgm.a(((File)localObject6).getAbsolutePath());
            localObject1 = localObject2;
            if (localObject2 != null)
            {
    ...
    try
    {
      ...
      {
        localObject2 = (aqly)((HashMap)localObject2).get(localObject4);
      ...
      if (BaseApplicationImpl.sImageCache.get(paramString) == null)
      {
        ...
        if (localObject2 == null)
        {
          ...
          if (localFile.exists())
          {
            ...
            localObject2 = bhgm.a(localFile.getAbsolutePath());
            localObject1 = localObject2;
            if (localObject2 != null)
            {
