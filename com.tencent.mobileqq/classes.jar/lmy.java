...
public class lmy
{
  ...
  ArrayList<lmx> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  lmy()
  {
    ...
    this.jdField_a_of_type_Int = lnd.a(this.jdField_a_of_type_Lmv);
  ...
  boolean a(BaseApplicationImpl paramBaseApplicationImpl)
  {
    ...
    return paramBaseApplicationImpl.registerReceiver(new lmz(this), localIntentFilter) != null;
  }
