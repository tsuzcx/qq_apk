  ...
  extends pwd
{
  ...
  private SparseArray<WeakReference<pww>> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
  private AtomicInteger jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger = new AtomicInteger(0);
  
  public pwu(AppInterface paramAppInterface, EntityManager paramEntityManager, ExecutorService paramExecutorService, qli paramqli, Handler paramHandler)
  {
    super(paramAppInterface, paramEntityManager, paramExecutorService, paramqli, paramHandler);
  }
  
  public pwu(EntityManager paramEntityManager, ExecutorService paramExecutorService, qli paramqli, Handler paramHandler)
  {
    super(null, paramEntityManager, paramExecutorService, paramqli, paramHandler);
  }
  ...
  private ToServiceMsg a(List<ReportInfo> paramList)
  {
    ...
    return qlk.a("OidbSvc.0x64e", 1614, 0, localReqBody.toByteArray());
  }
  ...
  private void a(int paramInt1, String paramString1, String paramString2, int paramInt2, boolean paramBoolean)
  {
    ...
    {
      qoj.a.a().a(paramInt1, paramString1, paramString2, paramInt2, paramBoolean);
      return;
    }
    ...
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      ...
      while (paramList.hasNext())
      {
        ...
        if (localReportInfo.mFolderStatus == 0) {
          localReportInfo.mFolderStatus = pay.d;
        }
        ...
        localReportInfo1.bytes_device_id.set(ByteStringMicro.copyFromUtf8(pay.k()));
  ...
  private void b(oidb_cmd0x64e.ReportInfo paramReportInfo, ReportInfo paramReportInfo1)
  {
    ...
    if (localObject != null)
    {
      ...
      paramReportInfo1.uint64_feeds_id.set(((rdy)localObject).jdField_a_of_type_Long);
      paramReportInfo1.uint64_publish_uin.set(((rdy)localObject).jdField_b_of_type_Long);
      paramReportInfo1.uint32_like_total_count.set(((rdy)localObject).jdField_a_of_type_Int);
      paramReportInfo1.uint32_comment_total_count.set(((rdy)localObject).jdField_b_of_type_Int);
      ArrayList localArrayList2 = new ArrayList();
      if ((((rdy)localObject).jdField_a_of_type_JavaUtilList != null) && (!((rdy)localObject).jdField_a_of_type_JavaUtilList.isEmpty()))
      {
        localObject = ((rdy)localObject).jdField_a_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject).hasNext()) {
  ...
  {
    rdz localrdz = paramReportInfo1.mVideoExtraRepoerData;
    if (localrdz != null)
    {
      paramReportInfo.enum_network_type.set(b());
      paramReportInfo.operator_platform.set(3);
      if (localrdz.jdField_b_of_type_Boolean) {
        paramReportInfo.whether_click_in.set(localrdz.jdField_a_of_type_Boolean);
      }
      if (localrdz.jdField_a_of_type_Int != -1) {
        paramReportInfo.enum_jumpway_which.set(localrdz.jdField_a_of_type_Int);
      }
      if (localrdz.jdField_b_of_type_Int != -1) {
        paramReportInfo.enum_in_onetree_source.set(localrdz.jdField_b_of_type_Int);
      }
      if (localrdz.c != -1) {
        paramReportInfo.enum_in_videochannel_source.set(localrdz.c);
      }
      if (localrdz.d != -1) {
        paramReportInfo.uint32_current_video_time.set(localrdz.d);
      }
      if (localrdz.e != -1) {
        paramReportInfo.uint32_video_duration.set(localrdz.e);
      }
      if ((paramReportInfo1.mOpSource == 5) && (localrdz.f != -1)) {
        paramReportInfo.uint32_onetree_video_from_type.set(localrdz.f);
      }
    }
  }
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (long l1 = paramToServiceMsg.uint64_uin.get();; l1 = 0L)
    {
      ...
      if ((paramToServiceMsg.AIOPulseMaxCnt.has()) && (paramToServiceMsg.firstScnRedPntPulseMaxCnt.has()) && (paramToServiceMsg.leftBtmRedPntPulseMaxCnt.has()))
      {
        ...
        bkwm.a(pay.a(), l1, l2, l3);
      }
      if ((paramToServiceMsg.lastRecvMsgDuration.has()) && (paramToServiceMsg.lastSendMsgDuration.has())) {
        bkwm.a((int)paramToServiceMsg.lastRecvMsgDuration.get(), (int)paramToServiceMsg.lastSendMsgDuration.get());
      }
      if ((paramToServiceMsg.pulseTimerDuration.has()) && (paramToServiceMsg.pulseTimerDuration.get() != 12345678L)) {
        ple.a().b((int)paramToServiceMsg.pulseTimerDuration.get());
      }
      if (paramToServiceMsg.leftBtmRedCntMaxForExitAIO.has()) {
        bkwm.e((int)paramToServiceMsg.leftBtmRedCntMaxForExitAIO.get());
      }
      if ((paramToServiceMsg.uint64_main_video_tab_red.has()) && (paramToServiceMsg.uint64_main_video_tab_red.get() > 0L)) {
        ((KandianMergeManager)pay.a().getManager(162)).a(new KandianRedDotInfo("kandian_video_tab_reddot_info"));
      }
      if (paramToServiceMsg.uint64_scroll_interval_time.has()) {
        plr.jdField_a_of_type_Long = paramToServiceMsg.uint64_scroll_interval_time.get();
      }
      if (paramToServiceMsg.uint64_scroll_all_time.has()) {
        plr.jdField_b_of_type_Long = paramToServiceMsg.uint64_scroll_all_time.get();
      }
      if (paramToServiceMsg.uint64_chat_aio_time.has()) {
        ple.c = paramToServiceMsg.uint64_chat_aio_time.get();
      }
      ...
      if (paramToServiceMsg.idle_push_wake_param.has()) {
        uio.a(paramToServiceMsg.idle_push_wake_param.get());
      }
      if (paramToServiceMsg.msg_srt_rule_list.has()) {
        pau.a().a(paramToServiceMsg.msg_srt_rule_list.get());
      }
      if ((paramToServiceMsg.uint64_delete_kdtab_num_redpnt.has()) && (paramToServiceMsg.uint64_delete_kdtab_num_redpnt.get() == 1L))
      {
        ...
        if (paramFromServiceMsg != null) {
          ((KandianMergeManager)paramFromServiceMsg.getManager(162)).q();
        }
      }
      ...
      {
        bkwm.a("sp_msg_box_80a_enable_receive", Boolean.valueOf(bool));
  ...
  {
    int i = qlk.a(paramFromServiceMsg, paramObject, new oidb_cmd0x64e.RspBody());
    if (QLog.isColorLevel()) {
  ...
  {
    int i = qlk.a(paramFromServiceMsg, paramObject, new oidb_cmd0xde0.RspBody());
  ...
  public void a(int paramInt1, String paramString1, int paramInt2, List<oidb_cmd0x80a.AttributeList> paramList, String paramString2, int paramInt3)
  {
    ...
    if (bbyp.b())
    {
      ...
      localReqBody.uint32_privacy_status.set(uhh.b());
      if (!bkwm.j()) {
        break label223;
      }
    ...
    for (;;)
    {
      ...
      a(qlk.a(paramString2, paramInt3, 0, localReqBody.toByteArray()));
      return;
      i = 0;
      break;
      label223:
  ...
  public void a(String paramString)
  {
    ...
    try
    {
      ...
      paramString = qlk.a("OidbSvc.0x480_9", 1152, 9, paramString);
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    try
    {
      ...
      paramString = qlk.a("OidbSvc.0x4ff_9", 1279, 9, paramString);
      paramString.extraData.putBoolean("reqFromReadinjoyHandler", true);
      a(paramString);
      return;
    }
  ...
  public void a(String paramString1, long paramLong, boolean paramBoolean, String paramString2, pwy parampwy, int paramInt)
  {
    a(paramString1, String.valueOf(paramLong), paramBoolean, paramString2, parampwy, paramInt);
  }
  
  public void a(String paramString1, String paramString2, boolean paramBoolean, String paramString3, pwy parampwy)
  {
    a(paramString1, paramString2, paramBoolean, paramString3, parampwy, 2);
  }
  
  public void a(String paramString1, String paramString2, boolean paramBoolean, String paramString3, pwy parampwy, int paramInt)
  {
    a(paramString1, paramString2, paramBoolean, paramString3, parampwy, paramInt, false);
  }
  
  public void a(String paramString1, String paramString2, boolean paramBoolean1, String paramString3, pwy parampwy, int paramInt, boolean paramBoolean2)
  {
    int i = 2;
    if (QLog.isColorLevel()) {
    ...
    catch (NumberFormatException localNumberFormatException1)
    {
      try
      {
        ...
        Object localObject1 = qlk.a("OidbSvc.0x978", 2424, 0, ((oidb_cmd0x978.ReqBody)localObject2).toByteArray());
        paramInt = this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.incrementAndGet();
        this.jdField_a_of_type_AndroidUtilSparseArray.put(paramInt, new WeakReference(parampwy));
  ...
  public void a(ArrayList<pue> paramArrayList, pwx parampwx, int paramInt)
  {
    a(paramArrayList, true, parampwx, paramInt);
  }
  
  protected void a(ArrayList<pue> paramArrayList, boolean paramBoolean, pww parampww, int paramInt)
  {
    int i = 2;
    if (QLog.isColorLevel()) {
      QLog.d("UserOperationModule", 2, "batch0x978, followList = " + paramArrayList + ", isFollow = " + paramBoolean + ", callback = " + parampww + ", refer = " + paramInt);
    }
    ...
    {
      localObject = (pue)paramArrayList.get(i);
      oidb_cmd0x978.OneFollowOperationInfo localOneFollowOperationInfo = new oidb_cmd0x978.OneFollowOperationInfo();
      localOneFollowOperationInfo.uint64_dst_uin.set(Long.valueOf(((pue)localObject).jdField_a_of_type_Long).longValue());
      localOneFollowOperationInfo.uint32_op_account_type.set(((pue)localObject).jdField_a_of_type_Int);
    ...
    paramArrayList = qlk.a("OidbSvc.0x978", 2424, 0, paramArrayList.toByteArray());
    paramInt = this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.incrementAndGet();
    this.jdField_a_of_type_AndroidUtilSparseArray.put(paramInt, new WeakReference(parampww));
  ...
  public void a(qxg paramqxg, Context paramContext)
  {
    ThreadManager.executeOnSubThread(new UserOperationModule.7(this, paramqxg, paramContext));
  }
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramToServiceMsg.getAttribute("distUin") != null)
    {
      ...
      paramToServiceMsg = (pww)((WeakReference)this.jdField_a_of_type_AndroidUtilSparseArray.get(i)).get();
      this.jdField_a_of_type_AndroidUtilSparseArray.remove(i);
      localRspBody = new oidb_cmd0x978.RspBody();
      i = qlk.a(paramFromServiceMsg, paramObject, localRspBody);
    ...
    if (bool1)
    {
      ...
      if (((Iterator)localObject1).hasNext())
      {
        ...
        {
          paramObject.add(new pue(l, i, bool1));
          break;
        }
      }
    ...
    while (paramFromServiceMsg.hasNext())
    {
      ...
      {
        pkm.a().b(Long.valueOf((String)localObject1).longValue(), paramObject.enum_follow_status.get());
  ...
  public void b(ArrayList<pue> paramArrayList, pwx parampwx, int paramInt)
  {
    a(paramArrayList, false, parampwx, paramInt);
  }
