  ...
  extends BaseBubbleBuilder
{
  ...
  private static final int c = bhtq.b(180.0F);
  private final View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new ahbc(this);
  
  static
  {
    jdField_a_of_type_AndroidGraphicsDrawableDrawable = new ColorDrawable(-1);
    b = new ColorDrawable(-1);
    b.setBounds(0, 0, bhtq.a(), c);
  }
  
  public ahbb(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
  ...
  private void a(URLImageView paramURLImageView, String paramString, Drawable paramDrawable)
  {
    ...
    localURLDrawableOptions.mGifRoundCorner = bhtq.b(2.0F);
  ...
  public View a(int paramInt1, int paramInt2, ChatMessage paramChatMessage, View paramView, ViewGroup paramViewGroup, agjk paramagjk)
  {
    ...
    ahbd localahbd = (ahbd)paramagjk.getTag();
    localahbd.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.setHeadIconVisible(false);
    if ((localahbd.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.a != null) && (localahbd.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.a.getVisibility() == 0)) {}
    for (paramInt2 = bhtq.b(33.0F);; paramInt2 = 0)
    {
      paramView = (ViewGroup.MarginLayoutParams)ahbd.a(localahbd).getLayoutParams();
      if (paramView.leftMargin != paramInt2)
      {
        paramView.leftMargin = paramInt2;
        ahbd.a(localahbd).setLayoutParams(paramView);
      }
      ...
      try
      {
        ...
        {
          aanu.a().b(localahbd, paramInt1);
          paramagjk.setVisibility(8);
          return paramagjk;
        }
      }
      ...
      localahbd.e = localVideoItem.width;
      localahbd.f = localVideoItem.height;
      localahbd.b = localVideoItem.videoUrl;
      if (localahbd.f != 0) {}
      for (paramInt2 = c * localahbd.e / localahbd.f;; paramInt2 = 0)
      {
        paramView = (RelativeLayout.LayoutParams)localahbd.jdField_a_of_type_ComTencentImageURLImageView.getLayoutParams();
        paramView.width = paramInt2;
        localahbd.jdField_a_of_type_ComTencentImageURLImageView.setLayoutParams(paramView);
        ahbd.a(localahbd).setVisibility(8);
        localahbd.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
        ahbd.a(localahbd).setText(localVideoItem.title);
        ahbd.a(localahbd, localVideoItem.schema);
        a(localahbd.jdField_a_of_type_ComTencentImageURLImageView, localVideoItem.coverUrl, b);
        aanu.a().a(localahbd, paramInt1);
        ...
        return paramagjk;
        label387:
        localahbd.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
        ahbd.a(localahbd).setText(paramView.title);
        ahbd.a(localahbd, paramView.schema);
        ...
        for (;;)
        {
          aanu.a().b(localahbd, paramInt1);
          break;
          ahbd.a(localahbd).setVisibility(0);
          a(ahbd.a(localahbd), paramView.imageUrl, jdField_a_of_type_AndroidGraphicsDrawableDrawable);
        }
      }
    }
  }
  ...
  public View a(ChatMessage paramChatMessage, aggl paramaggl, View paramView, BaseChatItemLayout paramBaseChatItemLayout, agjk paramagjk)
  {
    ...
    if (paramView == null)
    {
      ...
      int i = paramBaseChatItemLayout.getDimensionPixelSize(2131298911);
      paramView.setMargins(i, 0, i, 0);
      paramView.addRule(1, 2131368212);
      paramView.addRule(1, 2131364449);
      ...
      ((RelativeLayout)localObject2).setId(2131364455);
      ...
      paramView.setId(2131364456);
      paramView.setAllRadius(i);
      Object localObject1 = new RelativeLayout.LayoutParams(agej.a(133.0F, paramBaseChatItemLayout), agej.a(74.5F, paramBaseChatItemLayout));
      ((RelativeLayout.LayoutParams)localObject1).setMargins(agej.a(9.0F, paramBaseChatItemLayout), 0, 0, 0);
      ...
      ((TextView)localObject1).setText(anzj.a(2131699774));
      ((TextView)localObject1).setId(2131364457);
      ...
      ((RelativeLayout.LayoutParams)localObject3).addRule(3, 2131364455);
      ((RelativeLayout.LayoutParams)localObject3).setMargins(0, agej.a(10.0F, paramBaseChatItemLayout), 0, 0);
      ...
      ((URLImageView)localObject3).setId(2131364465);
      ...
      ((TextView)localObject4).setBackgroundResource(2130837974);
      ...
      Object localObject5 = new RelativeLayout.LayoutParams(agej.a(43.0F, paramBaseChatItemLayout), agej.a(21.0F, paramBaseChatItemLayout));
      ((RelativeLayout.LayoutParams)localObject5).addRule(12);
      ((RelativeLayout.LayoutParams)localObject5).addRule(11);
      i = agej.a(5.0F, paramBaseChatItemLayout);
      ...
      ((ImageView)localObject5).setBackgroundResource(2130837973);
      ((ImageView)localObject5).setImageResource(2130847708);
      i = agej.a(17.0F, paramBaseChatItemLayout);
      ((ImageView)localObject5).setPadding(i, i, i, i);
      ((ImageView)localObject5).setScaleType(ImageView.ScaleType.FIT_CENTER);
      i = agej.a(50.0F, paramBaseChatItemLayout);
      ...
      paramChatMessage.setTag(paramaggl);
      ...
      paramaggl = (ahbd)paramaggl;
      ahbd.a(paramaggl, paramChatMessage);
      paramaggl.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localObject2);
      paramaggl.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localObject3);
      paramaggl.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localObject5);
      paramaggl.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localObject4);
      ahbd.a(paramaggl, paramView);
      ahbd.a(paramaggl, (TextView)localObject1);
    }
  ...
  public void a(ChatMessage paramChatMessage, Context paramContext, BaseChatItemLayout paramBaseChatItemLayout, aggl paramaggl, int paramInt1, int paramInt2)
  {
    ...
    paramaggl.a.setBackgroundResource(2130837972);
    paramInt1 = agej.a(10.0F, paramChatMessage);
    paramInt2 = agej.a(14.0F, paramChatMessage);
    paramaggl.a.setPadding(paramInt1, paramInt2, paramInt1, paramInt2);
  }
