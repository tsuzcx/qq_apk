...
public class aixg
{
  ...
  public static int a(MessageRecord paramMessageRecord)
  {
    ...
    if (((paramMessageRecord instanceof MessageForText)) || ((paramMessageRecord instanceof MessageForLongMsg))) {
      if (behh.c(paramMessageRecord.msg)) {
        i = 12;
      }
    }
    do
    {
      ...
      return 11;
    } while (aout.a(paramMessageRecord));
    return 7;
  }
      ...
      do
      {
        do
        {
          ...
          if (paramMessageRecord.msgtype == -2005) {
            return aunj.a(paramQQAppInterface, paramMessageRecord);
          }
          if (!bhka.a(paramMessageRecord.msgtype)) {
            break;
          }
  ...
  private static int b(MessageRecord paramMessageRecord)
  {
    ...
    {
      if (aunj.a(((MessageForFile)paramMessageRecord).fileName) != 0) {}
    }
    else {
      do
      {
    ...
    while ((!(paramMessageRecord instanceof MessageForTroopFile)) || (aunj.a(((MessageForTroopFile)paramMessageRecord).fileName) != 0)) {
      return 5;
    }
    return 2;
  }
