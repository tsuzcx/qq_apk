...
public class bnxe
{
  private static bnxe jdField_a_of_type_Bnxe;
  ...
  private Downloader.DownloadListener jdField_a_of_type_ComTencentComponentNetworkDownloaderDownloader$DownloadListener = new bnxf(this);
  private final MultiHashMap<String, bnxg> jdField_a_of_type_CooperationQzoneUtilMultiHashMap = new MultiHashMap();
  ...
  private bmvo a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 88	bnxe:jdField_a_of_type_Bmvo	Lbmvo;
    //   6: ifnull +12 -> 18
    //   9: aload_0
    //   10: getfield 88	bnxe:jdField_a_of_type_Bmvo	Lbmvo;
    //   13: astore_1
    //   14: aload_0
    //   15: monitorexit
    //   16: aload_1
    //   17: areturn
    //   18: aload_0
    //   19: invokestatic 92	bmvo:a	()Lbmvo;
    //   22: putfield 88	bnxe:jdField_a_of_type_Bmvo	Lbmvo;
    //   25: aload_0
    //   26: getfield 88	bnxe:jdField_a_of_type_Bmvo	Lbmvo;
    //   29: astore_1
    //   30: goto -16 -> 14
    //   33: astore_1
    //   34: aload_0
  ...
  public static bnxe a()
  {
    if (jdField_a_of_type_Bnxe == null) {}
    try
    {
      if (jdField_a_of_type_Bnxe == null) {
        jdField_a_of_type_Bnxe = new bnxe();
      }
      return jdField_a_of_type_Bnxe;
    }
    finally {}
  }
  
  private bnxg a(String paramString1, int paramInt, String paramString2, bnxh parambnxh)
  {
    return bnxg.a(paramString1, paramInt, paramString2, new WeakReference(parambnxh));
  }
  
  private Collection<bnxg> a(String paramString, boolean paramBoolean)
  {
    return a(paramString, paramBoolean, null);
  }
  
  private Collection<bnxg> a(String paramString, boolean paramBoolean, Collection<bnxg> paramCollection)
  {
  ...
  private void a(bnxg parambnxg)
  {
    if (URLUtil.isNetworkUrl(parambnxg.b))
    {
      String str = c(parambnxg.b);
      a().a(parambnxg.b, str, true, this.jdField_a_of_type_ComTencentComponentNetworkDownloaderDownloader$DownloadListener);
    }
  }
  ...
  private boolean a(String paramString, bnxg parambnxg)
  {
    for (;;)
    {
      synchronized (this.jdField_a_of_type_CooperationQzoneUtilMultiHashMap)
      {
        ...
        this.jdField_a_of_type_CooperationQzoneUtilMultiHashMap.add(paramString, parambnxg);
        if (i == 0)
        {
          bool = true;
          return bool;
  ...
  private static File b(String paramString)
  {
    ...
    for (paramString = b + bnwv.a(paramString);; paramString = b + bnwv.b(paramString)) {
  ...
  private static File b(String paramString1, String paramString2)
  {
    ...
    for (paramString1 = b + bnwv.a(paramString1) + File.separator + paramString2 + ".png";; paramString1 = b + bnwv.b(paramString1) + File.separator + paramString2 + ".png") {
  ...
  private static String c(String paramString)
  {
    ...
    if (jdField_a_of_type_JavaUtilArrayList.contains(paramString)) {}
    for (paramString = bnwv.a(paramString) + ".zip";; paramString = bnwv.b(paramString) + ".zip") {
  ...
  private static void c(String paramString)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      a(localFile);
      bnjl.b(new File(paramString), localFile);
    }
  }
  ...
  /* Error */
  public Bitmap a(String paramString1, int paramInt, String paramString2, bnxh parambnxh)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 7
    ...
    //   12: areturn
    //   13: aload_0
    //   14: getfield 84	bnxe:jdField_a_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
    ...
    //   58: aload_1
    //   59: aload_3
    //   60: invokestatic 116	bnxe:b	(Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;
    //   63: astore 8
    //   65: aload 5
    //   67: astore 6
    //   69: aload 8
    //   71: invokestatic 237	bnxe:c	(Ljava/io/File;)Z
    //   74: ifeq +167 -> 241
    //   77: aload_0
    //   78: monitorenter
    //   79: aload 5
    //   81: astore 6
    //   83: aload_0
    //   84: getfield 84	bnxe:jdField_a_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
    ...
    //   147: aconst_null
    //   148: invokestatic 300	bnwv:a	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   151: astore 7
    //   153: aload 7
    //   155: astore 5
    //   157: aload_0
    ...
    //   165: ifnull +76 -> 241
    //   168: aload_0
    //   169: getfield 84	bnxe:jdField_a_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
    ...
    //   244: aload_3
    //   245: aload 4
    //   247: invokespecial 100	bnxe:a	(Ljava/lang/String;ILjava/lang/String;Lbnxh;)Lbnxg;
    //   250: astore_3
    //   251: aload 6
    //   253: astore 7
    //   255: aload_0
    //   256: aload_1
    //   257: aload_3
    //   258: invokespecial 186	bnxe:a	(Ljava/lang/String;Lbnxg;)Z
    //   261: ifeq -251 -> 10
    //   264: aload_0
    //   265: aload_3
    //   266: invokespecial 151	bnxe:a	(Lbnxg;)V
    //   269: aload 6
    //   271: areturn
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  public Drawable a(String paramString1, int paramInt, String paramString2, bnxh parambnxh)
  {
    return a(paramString1, paramInt, paramString2, false, parambnxh);
  }
  
  public Drawable a(String paramString1, int paramInt, String paramString2, boolean paramBoolean, bnxh parambnxh)
  {
    ...
    paramString1 = b(paramString1, paramInt, paramString2, parambnxh);
    if (paramString1 != null)
    {
      paramString1.setDensity(320);
      paramString1 = new BitmapDrawable(paramString1);
      paramString1.setTargetDensity((int)bhtq.c());
      return paramString1;
    }
    if (parambnxh != null) {
      try
  ...
  public String a(String paramString, bnxh parambnxh)
  {
    ...
    parambnxh = a(paramString, 999, str, parambnxh);
    if (a(paramString, parambnxh)) {
      a(parambnxh);
    }
    return null;
  }
  ...
  {
    if (jdField_a_of_type_JavaUtilArrayList.contains(paramString)) {
      paramString = b + bnwv.a(paramString) + File.separator;
    }
    try
    {
      for (;;)
      {
        ...
        return true;
        paramString = b + bnwv.b(paramString) + File.separator;
      }
      return false;
    }
  ...
  public Bitmap b(String paramString1, int paramInt, String paramString2, bnxh parambnxh)
  {
    Object localObject;
    ...
    QzoneHandlerThreadFactory.getHandlerThread("BackGround_HandlerThread").postDelayed(new ZipResDownloadManager.2(this, paramString1, paramString2, parambnxh, paramInt), 400L);
    return localBitmap;
  }
}
