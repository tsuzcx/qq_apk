...
public class blni
{
  private static final blni jdField_a_of_type_Blni = new blni();
  ...
  private blni()
  {
    a(blpy.a(BaseApplicationImpl.getContext()));
    a();
  }
  
  public static blni a()
  {
    return jdField_a_of_type_Blni;
  }
  
  private void a()
  {
    blqm.a(blqm.b, new blnj(this), true);
  }
  ...
  private void a(String paramString)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        {
          blpu.a("QRLocalManager", "json parse err", paramString);
          return;
        }
