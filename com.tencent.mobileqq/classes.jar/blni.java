  ...
  extends blng
{
  ...
  public blni(FilterDesc paramFilterDesc)
  {
    super(paramFilterDesc);
    this.jdField_a_of_type_Float = -1.0F;
    this.jdField_a_of_type_Blnk = new blnk(this);
    this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc = paramFilterDesc;
  }
  
  public static int a(Context paramContext, List<FilterDesc> paramList, blnt paramblnt, int paramInt)
  {
    boolean bool2 = true;
    boolean bool1 = true;
    if (paramInt == 0) {
  ...
  public static void a(Context paramContext, List<FilterDesc> paramList)
  {
    ...
    QQFilterRenderManager localQQFilterRenderManager = bkka.a(bkka.b);
    if ((localQQFilterRenderManager == null) && (bkou.a() == null))
    {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if ((bkou.a() == null) || (paramContext == null) || (paramContext.size() <= 0)) {
          break;
        }
  ...
  public static boolean a(blob paramblob, int paramInt)
  {
    if (paramblob != null)
    {
      blob localblob = bncp.a().a[paramInt];
      if ((paramblob != null) && (localblob != null) && (paramblob.b().equals(localblob.b()))) {}
      for (boolean bool = true;; bool = false)
      {
        if (QLog.isColorLevel()) {
          QLog.d("QCombo", 2, new Object[] { "isApplying :" + paramblob + " ", Boolean.valueOf(bool) });
        }
        return bool;
      }
    }
  ...
  public static void b(List<FilterDesc> paramList, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      new blnj(bool2, bool1, localArrayList, paramBoolean).execute(new Void[0]);
      return;
      if (localFilterDesc.id == 9)
      {
        localArrayList.clear();
  ...
  public int a()
  {
    ...
    String str = this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc.getResFold(bngf.b);
    if ((!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc.resurl)) && (!TextUtils.isEmpty(str)) && (bncl.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc)))
    {
      b(2);
      return 2;
    }
  ...
  public int b()
  {
    ...
    bncl.a().a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc, this.jdField_a_of_type_Blnk);
    a();
    return super.b();
  }
