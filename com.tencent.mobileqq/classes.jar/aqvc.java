...
public class aqvc
{
        ...
        try
        {
          ...
          if (i < j)
          {
            ...
            if (((String)localObject1).equals("align")) {
              ((aquu)localObject3).a(1, localObject4);
            }
            i += 1;
            continue;
          }
                  ...
                  else
                  {
                    ...
                    else
                    {
                      ...
                      else
                      {
                        ...
                        break label1192;
                        localObject5 = localObject1;
                        bool = a(paramString, (aquu)localObject3, localXmlPullParser);
                        localObject4 = paramString;
                        localObject3 = paramString;
                        paramString = (String)localObject1;
                        localObject1 = localObject3;
                        ...
                        {
                          localObject5 = localObject1;
                          if (((aquu)localObject4).a())
                          {
                            localObject5 = localObject1;
                            if (!TextUtils.isEmpty((CharSequence)localObject3))
                            {
                              localObject5 = localObject1;
                              ((aquu)localObject4).a(2, localObject3);
                              localObject3 = paramString;
                              paramString = (String)localObject1;
                              localObject1 = localObject3;
                              break label1154;
  ...
  public static MessageForUniteGrayTip a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2, long paramLong1, aqut paramaqut, long paramLong2, long paramLong3, byte[] paramArrayOfByte)
  {
    Object localObject1 = (badj)paramQQAppInterface.getManager(346);
    ((badj)localObject1).b(paramString);
    int i;
    if ((badm.a(paramLong2, paramLong3)) && ((axmv.b()) || (!((badj)localObject1).b(paramString))))
    {
      i = 1;
      if ((paramaqut != null) && (i == 0)) {
        break label65;
      }
    }
    label65:
    ...
    do
    {
      ...
      localaqvb = new aqvb(paramString, paramQQAppInterface.getCurrentAccountUin(), localStringBuilder.toString(), paramInt1, paramInt2, 655397, paramLong1);
      localObject1 = paramaqut.a();
    } while (localObject1 == null);
    Object localObject2 = "";
    Object localObject3 = ((aquu)localObject1).a();
    Object localObject4 = ((HashMap)localObject3).keySet().iterator();
    Object localObject5;
    if (((Iterator)localObject4).hasNext())
    {
      paramaqut = (Integer)((Iterator)localObject4).next();
      localObject5 = ((HashMap)localObject3).get(paramaqut);
      if (paramaqut.intValue() != 1) {
        break label1264;
      }
    }
    label1264:
    for (paramaqut = (String)localObject5;; paramaqut = (aqut)localObject2)
    {
      localObject2 = paramaqut;
      break;
      localObject3 = ((aquu)localObject1).jdField_a_of_type_JavaUtilArrayList.iterator();
      while (((Iterator)localObject3).hasNext())
      {
        paramaqut = (aquu)((Iterator)localObject3).next();
        switch (paramaqut.jdField_a_of_type_Int)
        {
        default: 
          break;
        case 2: 
          paramaqut = paramaqut.a();
          localObject1 = paramaqut.keySet().iterator();
          while (((Iterator)localObject1).hasNext())
          {
            localObject4 = (Integer)((Iterator)localObject1).next();
            localObject5 = paramaqut.get(localObject4);
        ...
        case 3: 
          ...
          if (((Iterator)localObject4).hasNext())
          {
            ...
            {
              localObject5 = (String)paramaqut.get(localObject5);
          ...
          localaqvb.a(i, paramInt2, (Bundle)localObject1);
          break;
        case 4: 
          localObject5 = paramaqut.a();
          ...
          if (((Iterator)localObject6).hasNext())
          {
            ...
            for (;;)
            {
              ...
              {
                paramaqut = (String)((HashMap)localObject5).get(localObject7);
              }
              else
              {
          ...
          if (((String)localObject1).equals(paramQQAppInterface.getCurrentAccountUin())) {
            paramaqut = ajya.a(2131715909);
          }
          localStringBuilder.append(paramaqut);
          localaqvb.a(paramInt2, paramaqut.length() + paramInt2, (Bundle)localObject4);
          break;
        case 5: 
          paramaqut = paramaqut.a();
          localObject4 = paramaqut.keySet();
      ...
      localaqvb.jdField_c_of_type_JavaLangString = localStringBuilder.toString();
      QLog.d(jdField_a_of_type_JavaLangString, 2, "createUniteGrayTip content :" + localStringBuilder);
      paramaqut = new MessageForUniteGrayTip();
      paramaqut.initGrayTipMsg(paramQQAppInterface, localaqvb);
      paramaqut.saveExtInfoToExtStr("unite_gray_tips_align", (String)localObject2);
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageForUniteGrayTip paramMessageForUniteGrayTip, List<MessageRecord> paramList, int paramInt, String paramString, aqvb paramaqvb)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (((localMessageRecord.msgtype != -1000) && (localMessageRecord.msgtype != -1051)) || (!bbfh.a(localMessageRecord.issend)))
      {
        if (QLog.isColorLevel()) {
      ...
      else
      {
        ...
        for (;;)
        {
          ...
          if (paramInt == 1)
          {
            paramList = localMessageRecord.getExtInfoFromExtStr(axaf.i);
            label243:
          ...
          else
          {
            try
            {
              ...
              paramList = localMessageRecord.getExtInfoFromExtStr(axaf.j);
            }
    ...
    for (;;)
    {
      try
      {
        ...
        paramList.put(axaf.k, localObject);
        paramList.put(axaf.l, paramInt);
      ...
      if ((localStringBuilder != null) && (localStringBuilder.length() > 0))
      {
        ...
        localObject = BaseApplicationImpl.getApplication().getString(2131694431);
        paramString = paramString.concat(" ");
        j = paramString.length();
        k = ((String)localObject).length() + j;
        paramString = paramString.concat((String)localObject);
        paramaqvb.jdField_c_of_type_JavaLangString = paramString;
        ...
        paramaqvb.a(j, k, (Bundle)localObject);
        if (QLog.isColorLevel())
        {
          if (paramMessageForUniteGrayTip.editMsgData != null)
          {
            ...
            paramaqvb = jdField_a_of_type_JavaLangString;
            ...
            QLog.d(paramaqvb, 2, new Object[] { "revoke msg beding edit,time=", Long.valueOf(l1), ",wording=", paramString, ",msguid=", Long.valueOf(l2), ",uniseq=", Long.valueOf(l3), ",start =", Integer.valueOf(j), ",end=", Integer.valueOf(k), ",msgDta[0-2]=", paramList, ",msgGray.editMsgData.length=", Integer.valueOf(paramMessageForUniteGrayTip.editMsgData.length()), ",atString=", localJSONArray.toString() });
          }
        }
        else {
          axqy.b(paramQQAppInterface, "dc00898", "", "", "0X8008E55", "0X8008E55", 0, 0, "", "", "", "");
        }
      }
      label873:
      while (!QLog.isColorLevel()) {
  ...
  private static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, long paramLong1, long paramLong2, byte[] paramArrayOfByte)
  {
    ...
    //   3: ifeq +46 -> 49
    //   6: getstatic 16	aqvc:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   9: iconst_2
    //   10: ldc_w 625
    //   13: iconst_4
    ...
    //   49: lload_3
    //   50: lload 5
    //   52: invokestatic 184	badm:a	(JJ)Z
    //   55: ifeq +30 -> 85
    //   58: aload 7
    //   60: ifnull +25 -> 85
    //   63: iload_2
    ...
    //   75: checkcast 176	badj
    //   78: aload_1
    //   79: aload 7
    //   81: iconst_1
    //   82: invokevirtual 632	badj:a	(Ljava/lang/String;[BI)V
    //   85: ldc2_w 633
    //   88: lload 5
    //   90: lcmp
    //   91: ifne +187 -> 278
    ...
    //   221: return
    //   222: astore_0
    //   223: getstatic 16	aqvc:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   226: iconst_1
    //   227: ldc_w 671
    //   230: aload_0
    ...
    //   240: getstatic 16	aqvc:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   243: iconst_1
    //   244: ldc_w 678
    //   247: aload_0
    ...
    //   251: return
    //   252: astore_0
    //   253: getstatic 16	aqvc:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   256: iconst_1
    //   257: ldc_w 680
    //   260: aload_0
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong, boolean paramBoolean1, boolean paramBoolean2, Bundle paramBundle)
  {
    ...
    Object localObject = (akhp)paramQQAppInterface.a(20);
    if (QLog.isColorLevel()) {
      QLog.d(".troop.joinSplitMsg", 2, "addFriendTipsMr troopUin=" + paramString);
    }
    ((akhp)localObject).a(paramString, paramBundle);
    int j;
    if (paramBoolean1)
    {
  ...
  public static void a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, long paramLong1, long paramLong2, msg_comm.MsgHead paramMsgHead)
  {
    ...
    if (paramArrayOfByte == null)
    {
      ...
      ((akhp)localObject).j(paramArrayOfByte.troopuin);
      ((akhp)localObject).a(1, ajsx.a(paramArrayOfByte.troopuin), 0L, 2, 0, 0, true);
    }
    for (;;)
    {
      ((akhp)localObject).a(paramArrayOfByte.troopuin, Boolean.valueOf(false));
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      try
      {
        ...
        if ((localObject != null) && (localObject.length > 0))
        {
          ...
          paramArrayOfByte = a(paramQQAppInterface, String.valueOf(paramMsgInfo.lFromUin), i, n, paramMsgInfo.uMsgTime, (aqut)localObject, l1, l2, paramArrayOfByte);
          if (paramArrayOfByte == null) {
            break label556;
          }
          ...
          i = 1;
          axqy.b(paramQQAppInterface, "CliOper", "", "", "0X800A560", "0X800A560", i, 0, "" + l2, "" + l1, "", "");
      ...
      avdg.a().a((submsgtype0x122.MsgBody)localObject, paramMsgInfo, paramQQAppInterface);
      return;
      label553:
      continue;
      label556:
  ...
  private static boolean a(aquu paramaquu1, aquu paramaquu2, XmlPullParser paramXmlPullParser)
  {
    paramaquu1.a(paramaquu2);
    int j = paramXmlPullParser.getAttributeCount();
    int i = 0;
    if (i < j)
    {
      paramaquu2 = paramXmlPullParser.getAttributeName(i);
      String str = paramXmlPullParser.getAttributeValue(i);
      if (paramaquu2.equals("txt")) {
        paramaquu1.a(2, str);
      }
      for (;;)
      {
        i += 1;
        break;
        if (paramaquu2.equals("jp"))
        {
          paramaquu1.a(4, str);
        }
        else if (paramaquu2.equals("uin"))
        {
          paramaquu1.a(6, str);
        }
        else if (paramaquu2.equals("nm"))
        {
          paramaquu1.a(7, str);
        }
        else if (paramaquu2.equals("si"))
        {
          paramaquu1.a(3, str);
        }
        else if (paramaquu2.equals("col"))
        {
          paramaquu1.a(5, str);
        }
        else if (paramaquu2.equals("jp"))
        {
          paramaquu1.a(4, str);
        }
        else if (paramaquu2.equals("src"))
        {
          paramaquu1.a(8, str);
        }
        else
        {
          if (!paramaquu2.equals("align")) {
            break label225;
          }
          paramaquu1.a(1, str);
        }
      ...
      label225:
      if (QLog.isColorLevel()) {
        QLog.i("handleC2COnlinePushMsgGrayTipResp", 2, "parseXML, illegel field: " + paramaquu2);
      }
      return false;
    }
    return true;
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageForUniteGrayTip paramMessageForUniteGrayTip)
  {
    ...
    do
    {
      ...
      {
        return false;
        if (((paramMessageForUniteGrayTip.tipParam.jdField_a_of_type_Boolean) || (akpx.g(paramMessageForUniteGrayTip.msgtype))) && ((paramMessageForUniteGrayTip.tipParam.jdField_c_of_type_Boolean) || (akpx.h(paramMessageForUniteGrayTip.msgtype)))) {
          break;
        }
      } while (!QLog.isColorLevel());
    ...
    if (paramMessageForUniteGrayTip != null)
    {
      ...
      if (paramMessageForUniteGrayTip.editState == 1)
      {
        ...
        else
        {
          ...
          String str = " " + BaseApplicationImpl.getApplication().getString(2131694431);
          ...
          if ((b != null) && (paramMessageForUniteGrayTip.uniseq == b.uniseq)) {
            axqy.b(paramQQAppInterface, "dc00898", "", "", "0X8008E55", "0X8008E55", 1, 0, "", "", "", "");
          }
          if ((b != null) && (paramMessageForUniteGrayTip.uniseq == b.uniseq)) {
            b = null;
          }
