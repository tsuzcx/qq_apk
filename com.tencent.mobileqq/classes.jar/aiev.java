...
public class aiev
{
  private static volatile aiex a;
  public SplashActivity a;
  
  public aiev(SplashActivity paramSplashActivity)
  {
  ...
  private int a()
  {
    ...
    azbw localazbw = (azbw)this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.getManager(10);
    if (localazbw != null)
    {
      int j = localazbw.a(1);
      i = j;
      ...
      {
        QLog.d("UndealCount.MainAssistObserver", 2, "getQZoneMsgCount TYPE_PASSIVE_FEED: " + localazbw.a(1));
        i = j;
      }
    }
    return i;
  ...
  private com.tencent.util.Pair<java.lang.Integer, java.lang.Boolean> a()
  {
    ...
    //   25: checkcast 101	axlx
    //   28: astore 4
    //   30: aload 4
    //   32: ldc 103
    //   34: invokevirtual 106	axlx:a	(Ljava/lang/String;)Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$AppInfo;
    //   37: astore 5
    //   39: aload 5
    //   41: ifnonnull +5 -> 46
    //   44: aconst_null
    ...
    //   46: aload 4
    //   48: aconst_null
    //   49: invokevirtual 109	axlx:a	(Laxma;)I
    //   52: istore_1
    //   53: aload 5
  ...
  private boolean a()
  {
    ...
    Iterator localIterator = ((axlx)this.jdField_a_of_type_ComTencentMobileqqActivitySplashActivity.app.getManager(36)).a().iterator();
  ...
  private int b()
  {
    ...
    if (localazbw != null)
    {
      ...
      if (QLog.isColorLevel())
      {
        QLog.d("UndealCount.MainAssistObserver", 2, "isNewQzoneMsgExist TYPE_ACTIVE_FEED: " + localazbw.a(2) + " TYPE_ZEBRA_ALBUM:" + localazbw.a(17));
        i = j;
      }
    }
  ...
  {
    aiex localaiex = jdField_a_of_type_Aiex;
    StringBuilder localStringBuilder = new StringBuilder().append("doQZoneRedPointClickReport: ");
    if (localaiex == null) {}
    for (String str = "null";; str = aiex.a(localaiex) + " " + aiex.a(localaiex))
    {
      QLog.i("MainAssistObserver.LebaTabRedTouch", 4, str);
      if ((localaiex != null) && (aiex.a(localaiex) <= 0) && (aiex.a(localaiex))) {
        break;
      }
  ...
  private static void b(int paramInt1, int paramInt2)
  {
    ...
    {
      return;
      localaiex = new aiex(paramInt1, paramInt2, null);
    } while (localaiex.equals(jdField_a_of_type_Aiex));
    jdField_a_of_type_Aiex = localaiex;
    QLog.i("MainAssistObserver.LebaTabRedTouch", 4, "doQZoneRedPointExposeReport: " + aiex.a(localaiex) + " " + aiex.a(localaiex));
    if (aiex.a(localaiex) > 0)
    {
  ...
  public static void c()
  {
    ...
    jdField_a_of_type_Aiex = null;
  }
  
  public Runnable a(aiey paramaiey)
  {
    return new LebaTabRedTouch.1(this, paramaiey);
  }
