...
public class syp
{
  ...
  private static volatile syp jdField_a_of_type_Syp;
  ...
  public syp()
  {
    this.jdField_a_of_type_Syq = null;
  }
  
  public static syp a()
  {
    if (jdField_a_of_type_Syp == null) {}
    try
    {
      if (jdField_a_of_type_Syp == null) {
        jdField_a_of_type_Syp = new syp();
      }
      return jdField_a_of_type_Syp;
    }
    finally {}
  }
  ...
  {
    return jdField_a_of_type_Syp != null;
  }
  ...
  public void a()
  {
    ...
    try
    {
      ...
      localJSONObject.put("articles_request_type", ptv.a());
      if (!ptv.b()) {
        break label339;
      }
      i = 1;
    ...
    if (this.jdField_b_of_type_Boolean) {
      odq.a(null, "", "0X8009296", "0X8009296", 0, 0, String.valueOf((NetConnInfoCenter.getServerTimeMillis() - this.jdField_b_of_type_Long) / 1000.0D), "", "", localJSONObject.toString(), false);
    }
    for (;;)
    {
      ptv.a(false);
      ...
      str = "0";
      break;
      odq.a(null, "", "0X80089D1", "0X80089D1", 0, 0, String.valueOf((NetConnInfoCenter.getServerTimeMillis() - this.jdField_b_of_type_Long) / 1000.0D), "", "", localJSONObject.toString(), false);
    }
  }
  ...
  public void d()
  {
    if (this.jdField_a_of_type_Syq == null) {
      this.jdField_a_of_type_Syq = new syq(this, null);
    }
