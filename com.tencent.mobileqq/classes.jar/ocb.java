  ...
  implements View.OnClickListener
{
  ...
  public ocb(VafContext paramVafContext)
  {
  ...
  private void a(Drawable paramDrawable)
  {
    ...
    if (this.jdField_b_of_type_OrgJsonJSONObject != null)
    {
      ...
      if (i > 0)
      {
        i = actj.a(i, this.jdField_a_of_type_AndroidContentContext.getResources());
  ...
  private void a(VafContext paramVafContext)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131369623));
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setVisibility(8);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362648));
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_a_of_type_ComTencentBizPubaccountNativeAdViewNativeAdDownloadView = ((NativeAdDownloadView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379158));
  ...
  private int d()
  {
    int j = actj.a(4.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    int i = j;
    if (this.jdField_b_of_type_OrgJsonJSONObject != null)
    {
      ...
      i = j;
      if (k > 0) {
        i = actj.a(k, this.jdField_a_of_type_AndroidContentContext.getResources());
      }
    }
    return i;
  }
  ...
  private boolean i()
  {
    if ((b()) && (this.jdField_a_of_type_Qjc != null)) {
      try
      {
        ...
        if (!TextUtils.isEmpty(str))
        {
          ...
          if ((nlu.a(this.jdField_a_of_type_AndroidContentContext, str)) && (localDownloadInfo != null) && (localDownloadInfo.a() == 4))
          {
            m();
            return true;
          }
  ...
  private void p()
  {
    if ((b()) && (this.jdField_a_of_type_Qjc != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_Qjc.c)))
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setClickable(true);
      this.jdField_a_of_type_AndroidViewView.setClickable(true);
  ...
  private void r()
  {
    ...
    try
    {
      if (!TextUtils.isEmpty(this.jdField_b_of_type_OrgJsonJSONObject.optString("buttonTextColor"))) {
        i = nmh.a(this.jdField_b_of_type_OrgJsonJSONObject.optString("buttonTextColor"), "#12B7F5");
      }
      ...
      do
      {
        ...
        {
          return;
        } while ((this.jdField_a_of_type_Pau == null) || (this.jdField_a_of_type_Pau.a() == null) || (this.jdField_a_of_type_Qjc == null) || (this.jdField_a_of_type_Qjc.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo == null));
        localObject = this.jdField_a_of_type_Pau.a().a();
      } while (localObject == null);
      ((nlu)localObject).b(this.jdField_a_of_type_Qjc, this.jdField_a_of_type_Qjc.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.downloadState);
      return;
    }
    catch (Exception localException)
    {
  ...
  protected Drawable a()
  {
    ...
    if (this.jdField_b_of_type_OrgJsonJSONObject != null)
    {
      ...
      {
        localDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130842182);
        if ((this.jdField_a_of_type_Qjc == null) || (!bbfr.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Qjc.d))) {
          break label87;
        }
        localObject1 = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130842182);
      }
    }
    label87:
    do
    {
      return localObject1;
      if (f()) {
        return this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130842180);
      }
      if ((d()) || (e())) {
        return this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130842183);
      }
      localObject1 = localObject2;
    } while (c());
  ...
  protected String a()
  {
    return oar.b(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo);
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    case 1: 
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
      this.jdField_a_of_type_AndroidWidgetTextView.setText(ajya.a(2131712882));
      this.jdField_a_of_type_ComTencentBizPubaccountNativeAdViewNativeAdDownloadView.a(paramInt1, paramInt2);
      this.jdField_a_of_type_ComTencentBizPubaccountNativeAdViewNativeAdDownloadView.setVisibility(8);
      return;
    case 4: 
    ...
    case 6: 
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
      this.jdField_a_of_type_ComTencentBizPubaccountNativeAdViewNativeAdDownloadView.setVisibility(8);
      bcql.a(this.jdField_a_of_type_AndroidContentContext, ajya.a(2131712988), 0).a();
      return;
    }
    f();
  }
  ...
  protected void a(AdData paramAdData)
  {
    this.jdField_a_of_type_ComTencentBizPubaccountNativeAdViewNativeAdDownloadView.setVisibility(8);
    c();
    if (((paramAdData != null) && (oau.a(paramAdData))) || (oau.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo))) {
      a();
    }
    int i;
    do
  ...
  protected void d()
  {
    for (;;)
    {
      ...
      try
      {
        ...
        i1 = 0;
        String str1 = b();
        oky.a(this.jdField_a_of_type_AndroidWidgetTextView, null);
        f2 = f1;
        if (this.jdField_b_of_type_OrgJsonJSONObject != null)
        {
          if (TextUtils.isEmpty(this.jdField_b_of_type_OrgJsonJSONObject.optString("buttonTextColor"))) {
          ...
          i1 = nmh.a(this.jdField_b_of_type_OrgJsonJSONObject.optString("buttonTextColor"), "#40A0FF");
          if (!TextUtils.isEmpty(this.jdField_b_of_type_OrgJsonJSONObject.optString("buttonTextSize")))
          {
            f1 = nmh.a(this.jdField_b_of_type_OrgJsonJSONObject.optString("buttonTextSize"), 14);
            f2 = f1;
            if (f1 >= 10.0F) {
              break label1094;
            }
          ...
          if ((!TextUtils.isEmpty((CharSequence)localObject2)) || (!TextUtils.isEmpty((CharSequence)localObject1)) || (!TextUtils.isEmpty(str2)) || (!TextUtils.isEmpty(str3)))
          {
            ...
            if (!TextUtils.isEmpty(str2)) {
              localGradientDrawable.setColor(nmh.a(str2, "#40A0FF"));
            }
            if (nmh.a((String)localObject1, 0.0F) > 0.0F)
            {
              f3 = nmh.a((String)localObject1, 0.0F);
              f2 = f3;
              if (f3 > 2.0F) {
                f2 = 2.0F;
              }
              localGradientDrawable.setStroke(actj.a(f2, this.jdField_a_of_type_AndroidContentContext.getResources()), nmh.a((String)localObject2, "#40A0FF"));
            }
            if (!TextUtils.isEmpty(str3))
            {
              ...
              f2 = 0.0F;
              localGradientDrawable.setCornerRadius(actj.a(f2, this.jdField_a_of_type_AndroidContentContext.getResources()));
            }
          ...
          f3 = nmh.a(this.jdField_b_of_type_OrgJsonJSONObject.optString("buttonHorizontalPadding").trim(), 0.0F);
          f4 = nmh.a(this.jdField_b_of_type_OrgJsonJSONObject.optString("buttonVerticalPadding").trim(), 0.0F);
          if (f3 >= 0.0F) {
            break label1140;
          }
          f2 = 0.0F;
          ...
          k = actj.a(f2, this.jdField_a_of_type_AndroidContentContext.getResources());
          j = k;
          if (f3 <= 0.0F) {
            break label1068;
          }
          n = actj.a(f3, this.jdField_a_of_type_AndroidContentContext.getResources());
          m = n;
          ...
          int i7 = a(i1);
          f2 = nmh.a(this.jdField_b_of_type_OrgJsonJSONObject.optString("buttonWidth").trim(), 0.0F);
          f3 = nmh.a(this.jdField_b_of_type_OrgJsonJSONObject.optString("buttonHeight").trim(), 0.0F);
          if ((f2 <= 0.0F) || (f3 <= 0.0F)) {
            break label1041;
          }
          localObject2 = (FrameLayout.LayoutParams)this.jdField_a_of_type_AndroidWidgetTextView.getLayoutParams();
          ((FrameLayout.LayoutParams)localObject2).height = actj.a(f3, this.jdField_a_of_type_AndroidContentContext.getResources());
          ((FrameLayout.LayoutParams)localObject2).width = actj.a(f2, this.jdField_a_of_type_AndroidContentContext.getResources());
          this.jdField_a_of_type_AndroidWidgetTextView.setLayoutParams((ViewGroup.LayoutParams)localObject2);
          ...
          k = 0;
          j = 0;
          f4 = nmh.a(this.jdField_b_of_type_OrgJsonJSONObject.optString("width").trim(), 0.0F);
          i1 = j;
          i2 = k;
          i3 = m;
          i4 = n;
          ...
          if (f4 > 0.0F)
          {
            ...
            ((Layout.Params)localObject1).mLayoutWidth = actj.a(f2 * 2.0F + f4, this.jdField_a_of_type_AndroidContentContext.getResources());
  ...
  protected void e()
  {
    ...
    localnxz.c = true;
    shq.a((Activity)this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo, this.jdField_a_of_type_Pau.a(), (int)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mChannelID, true, localnxz);
  }
  
  protected boolean e()
  {
    return oar.e(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo);
  }
  
  public void f()
  {
    if ((this.jdField_a_of_type_Qjc == null) || (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo == null)) {
      return;
    }
    if (nlt.a(this.jdField_a_of_type_Qjc, c()))
    {
      ...
      nmc.a(new nyd().a(this.jdField_a_of_type_AndroidContentContext).a(nmc.jdField_a_of_type_Int).b(nmc.L).a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo).a());
      return;
    }
    h();
    nmc.a(new nyd().a(this.jdField_a_of_type_AndroidContentContext).a(nmc.jdField_a_of_type_Int).b(nmc.aa).a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo).a());
  }
  
  protected boolean f()
  {
    return oar.c(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo);
  }
  
  protected void g()
  {
    if ((this.jdField_a_of_type_Pau != null) && (this.jdField_a_of_type_Pau.a() != null) && (this.jdField_a_of_type_Qjc != null))
    {
      nlu localnlu = this.jdField_a_of_type_Pau.a().a();
      if (localnlu != null) {
        localnlu.b(this.jdField_a_of_type_Qjc);
      }
    }
  }
  ...
  protected boolean g()
  {
    return oaq.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo);
  }
  ...
  protected void h()
  {
    if ((this.jdField_a_of_type_Pau != null) && (this.jdField_a_of_type_Pau.a() != null) && (this.jdField_a_of_type_Qjc != null))
    {
      nlu localnlu = this.jdField_a_of_type_Pau.a().a();
      if (localnlu != null) {
        localnlu.a(this.jdField_a_of_type_Qjc);
      }
  ...
  protected void i()
  {
    if ((this.jdField_a_of_type_Pau != null) && (this.jdField_a_of_type_Pau.a() != null) && (this.jdField_a_of_type_Qjc != null))
    {
      nlu localnlu = this.jdField_a_of_type_Pau.a().a();
      if (localnlu != null) {
        localnlu.e(this.jdField_a_of_type_Qjc);
      }
    }
  }
  ...
  protected void j()
  {
    if ((this.jdField_a_of_type_Pau != null) && (this.jdField_a_of_type_Pau.a() != null) && (this.jdField_a_of_type_Qjc != null))
    {
      nlu localnlu = this.jdField_a_of_type_Pau.a().a();
      if (localnlu != null) {
        localnlu.c(this.jdField_a_of_type_Qjc);
      }
    }
  }
  ...
  protected void k()
  {
    ...
    shq.b(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo, null, (int)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mChannelID, true);
  }
  ...
  public void l()
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo != null)
    {
      String str = oar.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo);
      if (b()) {
        r();
      }
      if (!TextUtils.isEmpty(str)) {
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      do
      {
        ...
        case 2131362648: 
          try
          {
            if (oau.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo))
            {
              oau.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo);
              return;
            }
          }
          ...
          j = oar.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo);
        }
      } while (j == 1);
      if (e())
      {
        s();
        nmc.a(new nyd().a(this.jdField_a_of_type_AndroidContentContext).a(nmc.J).b(nmc.L).a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo).a());
        return;
      }
    } while (this.jdField_a_of_type_Qjc == null);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mProgressFromFeeds = true;
    paramView = this.jdField_a_of_type_Qjc.d;
    if (bbfr.a(BaseApplicationImpl.getContext(), paramView))
    {
      k();
    ...
    {
      paramView = bdhk.a().c(this.jdField_a_of_type_Qjc.d);
      bdhk.a().a(paramView);
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.downloadState = 5;
      nmc.a(new nyd().a(this.jdField_a_of_type_AndroidContentContext).a(nmc.jdField_a_of_type_Int).b(nmc.X).a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo).a());
      return;
    }
    if (nlt.a(this.jdField_a_of_type_Qjc, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.downloadState))
    {
      i();
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.downloadState = 5;
      nmc.a(new nyd().a(this.jdField_a_of_type_AndroidContentContext).a(nmc.jdField_a_of_type_Int).b(nmc.L).a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo).a());
    ...
    if ((bbfj.b(this.jdField_a_of_type_AndroidContentContext)) && (oaq.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdExtInfo))) {}
    for (;;)
    {
      for (;;)
      {
        ...
        shq.a((Activity)this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo, this.jdField_a_of_type_Pau.a(), (int)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mChannelID, true, null);
        nmc.a(new nyd().a(this.jdField_a_of_type_AndroidContentContext).a(nmc.jdField_a_of_type_Int).b(nmc.L).a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo).a());
        return;
        try
        {
          ...
          paramView = this.jdField_a_of_type_Qjc.d;
          i = oar.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo);
          if (bbfr.a(BaseApplicationImpl.getContext(), paramView))
          {
            k();
            this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.downloadState = 1;
      ...
      if ((i == 2) && (nlt.a(this.jdField_a_of_type_Qjc, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.downloadState)))
      {
        i();
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.downloadState = 5;
        nmc.a(new nyd().a(this.jdField_a_of_type_AndroidContentContext).a(nmc.jdField_a_of_type_Int).b(nmc.L).a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo).a());
      ...
      {
        i = j;
        if (oaq.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdExtInfo)) {
          i = 1;
        }
      }
      if ((yyn.a()) || (i != 0)) {
        ...
        do
        {
          do
          {
            do
            {
              ...
              this.jdField_a_of_type_Qjc = qjc.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo);
              return true;
              bool1 = bool2;
