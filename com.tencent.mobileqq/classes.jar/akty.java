...
public class akty
  implements akux
{
  aktz jdField_a_of_type_Aktz = new aktz(this);
  ...
  public akty(Activity paramActivity, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    paramActivity = new akvi(paramActivity, paramStartCheckParam);
    paramActivity.a(this);
    this.jdField_a_of_type_Akvi = paramActivity;
    this.jdField_a_of_type_Bhow = new bhow(Looper.getMainLooper(), this.jdField_a_of_type_Akvi);
  ...
  public static akty a(String paramString)
  {
    Object localObject;
    ...
    do
    {
      return localObject;
      localakty = a();
      if ((localakty == null) || (localakty.jdField_a_of_type_JavaUtilSet == null)) {
        break;
      }
      localObject = localakty;
    } while (localakty.jdField_a_of_type_JavaUtilSet.contains(paramString));
    return null;
  }
  ...
  private BaseChatPie a()
  {
    ...
    if (localObject != null)
    {
      localObject = (akji)((AppInterface)localObject).getManager(153);
      if (localObject != null)
      {
  ...
  public static void a(String paramString)
  {
    akty localakty = a();
    if ((localakty != null) && (localakty.jdField_a_of_type_JavaUtilSet != null)) {
      localakty.jdField_a_of_type_JavaUtilSet.add(paramString);
    }
    if (QLog.isColorLevel()) {
      QLog.d("cmgame_process.CmGameMainManager", 2, "onShare2Aio currentApolloGame:" + localakty + ",aioUin:" + paramString);
    }
  }
  ...
  {
    akty localakty = a();
    if ((localakty != null) && (localakty.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null)) {
      VipUtils.a(null, "cmshow", "Apollo", "clk_game_banner", 3, 0, new String[] { localakty.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId + "" });
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Akvi != null) {
      this.jdField_a_of_type_Akvi.a(paramActivity);
    }
  }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (((aluw)localAppInterface.getManager(56)).a(Long.valueOf(Long.parseLong((String)localObject))))
        {
          i = 1;
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_Bhow.obtainMessage(21).sendToTarget();
  }
  ...
  public void b(String paramString)
  {
    ...
    label794:
    label803:
    for (paramString = bdbt.e(localQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.sessionUin, (String)localObject3);; paramString = null)
    {
      if (TextUtils.isEmpty(paramString))
      {
        localObject1 = ((aloz)localQQAppInterface.getManager(51)).b((String)localObject3);
      ...
      for (localObject1 = ((Friends)localObject1).getFriendNick();; localObject1 = paramString)
      {
        ...
        if (TextUtils.isEmpty((CharSequence)localObject1)) {
          paramString = bdbt.c(localQQAppInterface, (String)localObject3, true);
        }
        if (QLog.isColorLevel()) {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject1))
        {
          paramString = this.jdField_a_of_type_Bhow.obtainMessage(26);
        ...
        this.jdField_a_of_type_Aliq.jdField_a_of_type_Int = i;
        this.jdField_a_of_type_Aliq.jdField_a_of_type_Long = l;
        this.jdField_a_of_type_Aliq.jdField_c_of_type_Int = j;
        localObject2 = (aleh)localQQAppInterface.getManager(155);
        localObject1 = ((aleh)localObject2).a(i);
        paramString = alpo.a(2131702479);
        if ((localObject1 != null) && (!TextUtils.isEmpty(((ApolloGameData)localObject1).name)))
        {
          localObject2 = ((aleh)localObject2).a(((ApolloGameData)localObject1).actionId);
        ...
        for (;;)
        {
          ...
          this.jdField_a_of_type_Aliq.jdField_b_of_type_JavaLangString = ((ApolloGameData)localObject1).name;
          for (;;)
          {
            this.jdField_a_of_type_Aliq.jdField_a_of_type_JavaLangString = paramString;
            this.jdField_a_of_type_Aliq.jdField_b_of_type_Int = i;
            ...
            return;
            this.jdField_a_of_type_Aliq.jdField_b_of_type_JavaLangString = alpo.a(2131702480);
            i = 0;
          }
          this.jdField_a_of_type_Aliq.jdField_c_of_type_JavaLangString = ((JSONObject)localObject1).toString();
          return;
        }
      }
    }
    ...
    do
    {
      do
      {
        ...
        try
        {
          ...
          paramString = ((aleh)((QQAppInterface)localObject1).getManager(155)).a(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
        ...
        this.jdField_a_of_type_Aktz.jdField_a_of_type_Int = paramString.gameId;
        this.jdField_a_of_type_Aktz.jdField_b_of_type_Int = paramInt;
        ((WtloginManager)localObject1).GetOpenKeyWithoutPasswd((String)localObject2, 16L, paramString.appId, this.jdField_a_of_type_Aktz);
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Bhow.obtainMessage(22).sendToTarget();
  }
  ...
  public void e(String paramString)
  {
    ...
    Message localMessage = this.jdField_a_of_type_Bhow.obtainMessage(28);
  ...
  public void f(String paramString)
  {
    ...
    Message localMessage = this.jdField_a_of_type_Bhow.obtainMessage(23);
    localMessage.obj = paramString;
    localMessage.sendToTarget();
  }
  ...
  public void g(String paramString)
  {
    ...
    this.jdField_a_of_type_Bhow.removeMessages(19);
    this.jdField_a_of_type_Bhow.removeMessages(20);
    Message localMessage = this.jdField_a_of_type_Bhow.obtainMessage(19);
    localMessage.obj = paramString;
    localMessage.sendToTarget();
    b(paramString);
  }
  ...
  {
    if (this.jdField_a_of_type_Akvi != null) {
      this.jdField_a_of_type_Akvi.b();
    }
  }
  
  public void h(String paramString)
  {
    this.jdField_a_of_type_Akvi.a(true);
    c(paramString);
  ...
  public void i(String paramString)
  {
    ...
    Message localMessage = this.jdField_a_of_type_Bhow.obtainMessage(17);
    localMessage.obj = paramString;
    localMessage.sendToTarget();
  }
  ...
  public void j()
  {
    ...
    this.b = null;
    this.jdField_a_of_type_Aliq = null;
