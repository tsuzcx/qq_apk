  ...
  extends bjbw
{
  ...
  public bjdr(int paramInt)
  {
    super(null);
    this.jdField_a_of_type_Bjdv = new bjds(this);
    this.d = paramInt;
    this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo = ((QIMMusicConfigManager)bjav.a(2)).b(paramInt);
  }
  ...
  public int a()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        bool = bbdx.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.getLocalPath());
        if (bool) {
          continue;
        }
      }
  ...
  public int a(Activity paramActivity, int paramInt)
  {
    ...
    MusicProviderView localMusicProviderView2 = (MusicProviderView)paramActivity.findViewById(2131363891);
    ...
    if (localMusicProviderView2 == null)
    {
      ...
      localMusicProviderView1 = (MusicProviderView)paramActivity.findViewById(2131363891);
      localMusicProviderView1.g();
    }
    paramActivity = ((bjed)bjav.a().c(8)).a();
  ...
  public int b()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          if (!bbdx.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.getLocalPath()))
          {
            if (QLog.isColorLevel()) {
            ...
            QimMusicDownloader.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.mUrl, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.getLocalPath(), this.jdField_a_of_type_Bjdv);
            a();
            i = 2;
            continue;
          }
