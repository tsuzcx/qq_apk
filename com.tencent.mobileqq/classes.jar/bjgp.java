...
public class bjgp
{
  protected static bjgp a;
  protected static byte[] a;
  public int a;
  protected List<bjgq> a;
  public int b;
  ...
  public static bjgp a()
  {
    if (jdField_a_of_type_Bjgp == null) {}
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      if (jdField_a_of_type_Bjgp == null) {
        jdField_a_of_type_Bjgp = new bjgp();
      }
      return jdField_a_of_type_Bjgp;
    }
  }
  ...
  {
    List localList = ((bjgq)this.jdField_a_of_type_JavaUtilList.get(paramInt)).jdField_a_of_type_JavaUtilList;
    if (localList != null) {
  ...
  public Friend a(String paramString)
  {
    ...
    do
    {
      ...
      while (!localIterator2.hasNext())
      {
        ...
        localIterator2 = ((bjgq)localIterator1.next()).jdField_a_of_type_JavaUtilList.iterator();
      }
  ...
  {
    return ((bjgq)this.jdField_a_of_type_JavaUtilList.get(paramInt)).jdField_a_of_type_JavaLangString;
  }
  ...
  public List<Friend> a()
  {
    ...
    {
      Iterator localIterator2 = ((bjgq)localIterator1.next()).jdField_a_of_type_JavaUtilList.iterator();
      while (localIterator2.hasNext()) {
  ...
  {
    return ((bjgq)this.jdField_a_of_type_JavaUtilList.get(paramInt)).jdField_a_of_type_JavaUtilList;
  }
  ...
  public void a(List<bjgq> paramList, int paramInt1, int paramInt2)
  {
    label9:
    String str2;
    ...
    else
    {
      ...
      this.c.clear();
      str2 = bizw.a().a().getResources().getString(2131690923);
    ...
    for (;;)
    {
      if (localIterator1.hasNext())
      {
        paramList = (bjgq)localIterator1.next();
