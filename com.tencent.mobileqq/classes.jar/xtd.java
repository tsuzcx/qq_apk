  ...
  implements View.OnClickListener
{
  ...
  public xtd(LoginView paramLoginView, Context paramContext)
  {
    super(paramContext, 2130968588, 2131362751, paramLoginView.jdField_a_of_type_JavaUtilList);
  }
  ...
  public Filter getFilter()
  {
    if (this.jdField_a_of_type_AndroidWidgetFilter == null) {
      this.jdField_a_of_type_AndroidWidgetFilter = new xte(this);
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup = (LinearLayout)paramView.findViewById(2131362750);
    ImageView localImageView = (ImageView)paramView.findViewById(2131362752);
    ...
    for (;;)
    {
      localImageView = (ImageView)paramView.findViewById(2131362753);
