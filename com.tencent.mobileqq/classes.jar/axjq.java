  ...
  implements Manager
{
  ...
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new axjr(this);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajsf.aW + "VideoRedbagRes" + File.separator;
  ...
  public axjq(AppInterface paramAppInterface)
  {
  ...
  private RelativeLayout.LayoutParams a(CustomFrameAnimationDrawable paramCustomFrameAnimationDrawable)
  {
    if ((paramCustomFrameAnimationDrawable != null) && (this.jdField_a_of_type_AndroidAppActivity != null))
    {
      ...
      paramCustomFrameAnimationDrawable = new RelativeLayout.LayoutParams(actn.a(j / 2, this.jdField_a_of_type_AndroidAppActivity.getResources()), actn.a(k / 2, this.jdField_a_of_type_AndroidAppActivity.getResources()));
  ...
  public static axjq a(AppInterface paramAppInterface)
  {
    if (jdField_a_of_type_Axjq == null) {}
    try
    {
      if (jdField_a_of_type_Axjq == null) {
        jdField_a_of_type_Axjq = new axjq(paramAppInterface);
      }
  ...
  private CustomFrameAnimationDrawable a(String paramString)
  {
    ...
    //   11: getstatic 57	axjq:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   154: aload_1
    //   155: invokestatic 229	bbdr:a	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   158: astore_1
    ...
    //   169: aload_1
    //   170: aload_0
    //   171: getfield 235	axjq:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
  ...
  public static void a(Intent paramIntent, Activity paramActivity)
  {
    ...
    ahpf.a(paramActivity, paramIntent);
  }
  
  public static void a(View paramView, aeah paramaeah, ChatMessage paramChatMessage, Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (j != 0)
        {
          if (paramView.findViewById(2131372975) != null)
          {
            paramView.findViewById(2131372974).setVisibility(0);
            paramaeah = (ImageView)paramView.findViewById(2131372975);
            if (j == 1) {
              paramaeah.setImageResource(2130848674);
            }
            for (;;)
            {
              paramaeah.setVisibility(0);
              paramView = (RelativeLayout.LayoutParams)((ImageView)paramView.findViewById(2131372974)).getLayoutParams();
              if (!paramChatMessage.isSend()) {
                break label213;
              }
              paramView.rightMargin = actn.a(6.0F, paramContext.getResources());
              ...
              break;
              if (j == 2) {
                paramaeah.setImageResource(2130848675);
              } else if (j == 3) {
                paramaeah.setImageResource(2130848673);
              }
            }
            paramView.rightMargin = 0;
            paramView.leftMargin = actn.a(6.0F, paramContext.getResources());
            return;
          }
          paramaeah = new ImageView(paramContext);
          paramaeah.setBackgroundDrawable(paramContext.getResources().getDrawable(2130848672));
          paramaeah.setId(2131372974);
          paramaeah.setVisibility(0);
          RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, actn.a(70.0F, paramContext.getResources()));
          localLayoutParams.addRule(7, 2131371608);
          localLayoutParams.addRule(8, 2131371608);
          if (paramChatMessage.isSend())
          {
            localLayoutParams.rightMargin = actn.a(6.0F, paramContext.getResources());
            localLayoutParams.leftMargin = 0;
            ((RelativeLayout)paramView).addView(paramaeah, localLayoutParams);
            paramaeah = new ImageView(paramContext);
            if (j != 1) {
              break label441;
            }
          ...
          for (;;)
          {
            paramaeah.setId(2131372975);
            paramaeah.setVisibility(0);
            paramChatMessage = new RelativeLayout.LayoutParams(-2, -2);
            paramChatMessage.addRule(8, 2131371608);
            paramChatMessage.addRule(14);
            ((RelativeLayout)paramView).addView(paramaeah, paramChatMessage);
            return;
            localLayoutParams.rightMargin = 0;
            localLayoutParams.leftMargin = actn.a(6.0F, paramContext.getResources());
            break;
            if (j == 2) {
              paramaeah.setImageResource(2130848675);
            } else if (j == 3) {
        ...
        paramView.findViewById(2131372975).setVisibility(4);
        paramView.findViewById(2131372974).setVisibility(4);
        return;
        j = 0;
      }
    }
  ...
  {
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApp(), axka.class);
  ...
  private static String b(String paramString)
  {
    ...
    catch (UnsatisfiedLinkError localUnsatisfiedLinkError)
    {
      ...
      for (;;)
      {
        try
        {
          paramString = bfjx.a(paramString);
          if (paramString == null) {
            continue;
          }
        }
  ...
  private void b(AIOShortVideoData paramAIOShortVideoData)
  {
    ...
    if (paramAIOShortVideoData.h == 0)
    {
      ...
      new axjy(this).execute(new String[] { paramAIOShortVideoData.jdField_c_of_type_JavaLangString });
    }
    for (;;)
    {
  ...
  private static boolean b(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    if (bbjn.c(paramQQAppInterface.getApp()))
    {
      if (QLog.isColorLevel()) {
    ...
    if ((paramQQAppInterface.exists()) && (!paramQQAppInterface.isDirectory()))
    {
      try
      {
        paramQQAppInterface = bbdj.b(paramQQAppInterface);
  ...
  public static void c()
  {
    try
    {
      if (!jdField_a_of_type_Boolean) {
        bbjn.e(BaseApplication.getContext(), true);
      }
      return;
    }
    finally {}
  ...
  private void c(AIOShortVideoData paramAIOShortVideoData)
  {
    ...
    {
      this.jdField_c_of_type_AndroidWidgetImageView.setBackgroundResource(2130848676);
    ...
    if (paramAIOShortVideoData.h == 0)
    {
      ...
      {
        this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130848685);
        this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      }
    ...
    for (;;)
    {
      ...
      break;
      label207:
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130848686);
      c();
    }
  }
  ...
  private void d()
  {
    ...
    do
    {
      for (;;)
      {
        ...
        if (!ajyc.a(2131713286).trim().equals(localObject)) {
          break;
        }
    ...
    } while (!ajyc.a(2131713284).trim().equals(localObject));
    ahub.b("", "0X80088E6");
    j();
    a();
  }
  ...
  private void g()
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(ajyc.a(2131713283));
      this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(0);
      this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColorStateList(2131166816));
      this.jdField_a_of_type_AndroidWidgetTextView.setTextSize(14.0F);
      this.jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130848677, 0);
  ...
  private void h()
  {
    if ((this.jdField_a_of_type_AndroidWidgetTextView != null) && (this.jdField_a_of_type_AndroidAppActivity != null))
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(ajyc.a(2131713287));
      this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(0);
  ...
  private void i()
  {
    ...
    if (localCustomFrameAnimationDrawable != null)
    {
      ...
      localCustomFrameAnimationDrawable.c();
      localCustomFrameAnimationDrawable.a(new axjx(this));
      if (this.jdField_a_of_type_AndroidOsHandler == null) {
        this.jdField_a_of_type_AndroidOsHandler = new Handler();
      }
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      return;
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130848680);
      k();
      c();
    }
  }
  ...
  private void k()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(ajyc.a(2131713285));
    this.jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
    this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColorStateList(2131166817));
    this.jdField_a_of_type_AndroidWidgetTextView.setTextSize(16.0F);
    this.jdField_a_of_type_AndroidWidgetTextView.setPadding(actn.a(12.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), actn.a(5.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), actn.a(12.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), actn.a(5.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()));
    this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130848681);
    this.jdField_a_of_type_AndroidWidgetTextView.bringToFront();
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    ObjectAnimator.ofFloat(this.jdField_a_of_type_AndroidWidgetTextView, "alpha", new float[] { 0.0F, 1.0F }).setDuration(180L).start();
  }
  ...
  private void l()
  {
    ...
    if (localCustomFrameAnimationDrawable != null)
    {
      ...
      localCustomFrameAnimationDrawable.a(new axjs(this, localCustomFrameAnimationDrawable));
      return;
    }
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130848680);
    c();
  ...
  private void n()
  {
    ...
    for (;;)
    {
      ...
      h();
      return;
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130848684);
      c();
    }
  }
  ...
  public ImageView a(Activity paramActivity, ViewGroup paramViewGroup, String paramString)
  {
    ...
    paramString.setId(2131373027);
    Object localObject = new RelativeLayout.LayoutParams(-1, actn.a(180.0F, paramActivity.getResources()));
    ...
    ((TextView)localObject).setId(2131373028);
    localLayoutParams = new RelativeLayout.LayoutParams(-2, -2);
    localLayoutParams.addRule(12);
    localLayoutParams.addRule(14);
    localLayoutParams.bottomMargin = actn.a(10.0F, paramActivity.getResources());
    paramViewGroup.addView((View)localObject, localLayoutParams);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localObject);
    ((TextView)localObject).bringToFront();
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new axjw(this));
    e();
    return paramString;
  }
  ...
  public void a(int paramInt)
  {
    if (paramInt == -1)
    {
      ...
      localCustomFrameAnimationDrawable.c();
      localCustomFrameAnimationDrawable.a(new axjt(this));
    }
    for (;;)
    {
  ...
  public void a(Activity paramActivity)
  {
    if (a())
    {
      ...
      Bundle localBundle = bifx.a(null, paramActivity.getClass().getName(), 10004, 8);
      vwm.a().a(paramActivity, localBundle, 9010);
    }
  }
