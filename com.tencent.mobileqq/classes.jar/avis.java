...
public class avis
{
  ...
  public static String a(Bitmap paramBitmap, String paramString, int[] paramArrayOfInt)
  {
    ...
    //   52: iload_3
    //   53: iaload
    //   54: invokestatic 66	avis:a	(Landroid/graphics/Bitmap;Ljava/io/ByteArrayOutputStream;I)Z
    //   57: istore 4
    //   59: iload 4
    //   61: ifeq +54 -> 115
    //   64: aload 6
    ...
    //   82: aload 6
    //   84: bipush 10
    //   86: invokestatic 66	avis:a	(Landroid/graphics/Bitmap;Ljava/io/ByteArrayOutputStream;I)Z
    //   89: istore 4
    //   91: iload 4
    //   93: ifne +29 -> 122
    ...
    //   147: iconst_0
    //   148: invokestatic 100	ayzp:a	(Ljava/lang/String;Z)Ljava/lang/String;
    //   151: astore_2
  ...
  private static boolean a(Bitmap paramBitmap, ByteArrayOutputStream paramByteArrayOutputStream, int paramInt)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.e(avis.class.getName(), 2, "doCompress Exception:", paramBitmap);
      }
      paramByteArrayOutputStream.reset();
      return false;
    }
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.e(avis.class.getName(), 2, "doCompress OutOfMemoryError:", paramBitmap);
      }
      paramByteArrayOutputStream.reset();
    }
    return false;
