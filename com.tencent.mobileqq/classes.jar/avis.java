...
public class avis
{
  ...
  {
    String str = ((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getCurrentAccountUin();
    return PreferenceManager.getDefaultSharedPreferences(BaseApplicationImpl.getContext()).getString("pref_net_search_function_title" + str, ajjy.a(2131647835));
  }
  ...
  public static void a(Context paramContext, com.tencent.mobileqq.config.struct.splashproto.ConfigurationService.Config paramConfig, String paramString)
  {
    ...
    //   75: invokestatic 153	atiu:a	([B)[B
    //   78: astore_1
    //   79: aload_1
    //   80: ifnull +516 -> 596
    ...
    //   186: ldc 200
    //   188: ldc 201
    //   190: invokestatic 81	ajjy:a	(I)Ljava/lang/String;
    ...
    //   550: pop
    //   551: aconst_null
    //   552: putstatic 236	avwc:a	Ljava/lang/String;
    //   555: return
    //   556: astore_1
    ...
    //   659: iconst_m1
    //   660: aload_2
    //   661: invokestatic 251	avis:a	(Landroid/content/Context;ILjava/lang/String;)V
    //   664: return
    //   665: ldc 11
    //   667: astore 8
    //   669: goto -648 -> 21
  ...
  public static String b()
  {
    ...
    String str1 = ajjy.a(2131653232);
    if (TextUtils.isEmpty(avwc.a))
    {
      if (!avwc.a(((QQAppInterface)localObject).getCurrentAccountUin())) {
        break label184;
      }
    ...
    for (;;)
    {
      ...
      return str1;
      str1 = ajjy.a(2131653232);
      continue;
      if (QLog.isColorLevel()) {
        QLog.d("Q.uniteSearch.SearchEntryConfigManager", 2, "getFtsSearchBarWording() cache wording is not null. " + avwc.a);
      }
      str1 = avwc.a;
    }
  }
