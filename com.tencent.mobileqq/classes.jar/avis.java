...
public class avis
{
  ...
  public static Pair<StringBuilder, StringBuilder> a(Context paramContext, File paramFile)
  {
    ...
    a = true;
    paramContext = zmk.a(Uri.parse("file://" + paramFile.getAbsolutePath()), paramContext);
    a = false;
    return paramContext;
  }
  ...
  public static String a(String paramString)
  {
    ...
    //   85: invokestatic 158	com/tencent/mobileqq/utils/HexUtil:bytes2HexStr	([B)Ljava/lang/String;
    //   88: astore_2
  ...
  public static msg_ctrl.MsgCtrl a(String paramString)
  {
    ...
    Object localObject2;
    long l2;
    if ((avjd.a().f()) && (!TextUtils.isEmpty(paramString)))
    {
  ...
  {
    Object localObject = avjd.a();
    if (!((avjd)localObject).e()) {}
    String str;
    do
    {
      return false;
      str = ((avjd)localObject).a();
      localObject = ((avjd)localObject).b();
