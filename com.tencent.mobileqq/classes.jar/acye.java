  ...
  extends BaseAdapter
{
  ...
  private ArrayList<aevk> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  
  public acye(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = paramContext.getResources().getDrawable(2130841045);
  }
  ...
  public void a(List<aevk> paramList)
  {
  ...
  {
    int k = a();
    int i = (XPanelContainer.jdField_a_of_type_Int - actn.a(70.0F, this.jdField_a_of_type_AndroidContentContext.getResources()) - actn.a(64.0F, this.jdField_a_of_type_AndroidContentContext.getResources()) * 2) / 3;
    int j;
    if (i >= 0)
    {
    ...
    for (;;)
    {
      j = (this.jdField_a_of_type_AndroidContentContext.getResources().getDisplayMetrics().widthPixels - actn.a(64.0F, this.jdField_a_of_type_AndroidContentContext.getResources()) * 4) / 8;
      Object localObject1;
      Object localObject2;
      if (paramView == null)
      {
        paramViewGroup = new StickerBubbleLinearLayout(this.jdField_a_of_type_AndroidContentContext);
        paramViewGroup.setMinimumHeight(actn.a(64.0F, this.jdField_a_of_type_AndroidContentContext.getResources()) + i);
        ...
        for (;;)
        {
          ...
          localObject1 = new LinearLayout.LayoutParams(actn.a(64.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actn.a(64.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
          ...
          int n = actn.a(64.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      ...
      if (paramInt == 0)
      {
        ...
        localObject2 = (aevk)this.jdField_a_of_type_JavaUtilArrayList.get(j);
        if (localObject2 != null) {
          ((ImageView)localObject1).setImageDrawable(a(((aevk)localObject2).jdField_a_of_type_JavaLangString));
        }
        ((View)localObject1).setTag(Integer.valueOf(j));
        if (AppSetting.d) {
          ((View)localObject1).setContentDescription(aevl.a(((aevk)localObject2).jdField_a_of_type_Int) + ajyc.a(2131708320));
        }
      }
      for (;;)
      {
