...
public class pot
{
  ...
  private static String[] jdField_a_of_type_ArrayOfJavaLangString = { ajyc.a(2131712810), ajyc.a(2131713124), ajyc.a(2131712796), ajyc.a(2131712843), ajyc.a(2131712803), ajyc.a(2131713131), ajyc.a(2131712985), ajyc.a(2131713060), ajyc.a(2131712930), ajyc.a(2131712753) };
  ...
  public static ArticleInfo a(articlesummary.ArticleSummary paramArticleSummary, int paramInt1, int paramInt2, ArticleInfo paramArticleInfo)
  {
      ...
      catch (Exception paramArticleInfo)
      {
        ...
        catch (InvalidProtocolBufferMicroException paramArticleInfo)
        {
          ...
          if (paramArticleSummary.msg_pack_info.has())
          {
            ...
            localArticleInfo.mPolymericInfo = qbv.a(localArticleInfo.mPackInfoObj);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          localArticleInfo.mNewPolymericInfo = qbq.a((articlesummary.NewPackInfo)paramArticleSummary.msg_new_pack_info.get());
          if ((localArticleInfo.mTopicRecommendFeedsInfo != null) && (localArticleInfo.mTopicRecommendFeedsInfo.jdField_a_of_type_JavaUtilArrayList != null) && (localArticleInfo.mTopicRecommendFeedsInfo.jdField_a_of_type_JavaUtilArrayList.size() > 0)) {
            localArticleInfo.businessId = ((qdv)localArticleInfo.mTopicRecommendFeedsInfo.jdField_a_of_type_JavaUtilArrayList.get(0)).jdField_a_of_type_Int;
          }
        }
        ...
        if (paramArticleSummary.recommend_info.has()) {
          localArticleInfo.mRecommendFollowInfos = qca.a((articlesummary.RecommendFollowInfos)paramArticleSummary.recommend_info.get());
        }
        if (paramArticleSummary.hot_word_info.has()) {
          localArticleInfo.hotWordInfo = qbf.a((articlesummary.HotWordInfo)paramArticleSummary.hot_word_info.get());
        }
        ...
        else
        {
          ...
          if ((paramArticleSummary.msg_feeds_info.has()) && (paramArticleSummary.msg_feeds_info.msg_aggregated_list.has()))
          {
            ...
            localArticleInfo.mExtraBiuBriefInfo = qay.a(paramArticleInfo);
          ...
          if (paramArticleSummary.awesome_comment_icon.has())
          {
            ...
            qap.a(localArticleInfo, (articlesummary.AwesomeCommentInfo)paramArticleSummary.awesome_comment_icon.get());
          }
          if (paramArticleSummary.msg_family_comment_info.has())
          {
            ...
            localObject1 = new qba();
            if (paramArticleInfo.icon_url.has()) {
              ((qba)localObject1).jdField_a_of_type_JavaLangString = paramArticleInfo.icon_url.get().toStringUtf8();
            }
            if (paramArticleInfo.jump_url.has()) {
              ((qba)localObject1).jdField_b_of_type_JavaLangString = paramArticleInfo.jump_url.get().toStringUtf8();
            }
            if (paramArticleInfo.medal_urls_width.has()) {
              ((qba)localObject1).jdField_a_of_type_Int = paramArticleInfo.medal_urls_width.get();
            }
            if (paramArticleInfo.medal_urls_height.has()) {
              ((qba)localObject1).jdField_b_of_type_Int = paramArticleInfo.medal_urls_height.get();
            }
            localArticleInfo.familyCommentInfo = ((qba)localObject1);
          ...
          if ((paramArticleSummary.video_multi_column_info.has()) && (paramArticleSummary.video_multi_column_info.get() != null))
          {
            ...
            localArticleInfo.multiVideoColumnInfo = qbp.a((articlesummary.VideoColumnInfo)paramArticleSummary.video_multi_column_info.get());
            if (QLog.isColorLevel()) {
          ...
          {
            localArticleInfo.scripCmsInfo = qce.a((articlesummary.ScripCmsInfo)paramArticleSummary.msg_scrip_cms_info.get());
            ...
            pce.a(BaseApplicationImpl.getApplication(), paramArticleInfo, pce.a(BaseApplicationImpl.getApplication(), paramArticleInfo) + 1);
            if (QLog.isColorLevel()) {
          ...
          if ((paramArticleSummary.msg_kd_live_info.has()) && (paramArticleSummary.msg_kd_live_info.get() != null))
          {
            ...
            localArticleInfo.mKdLiveInfo = qbi.a((articlesummary.KdLiveInfo)paramArticleSummary.msg_kd_live_info.get());
            if (QLog.isColorLevel()) {
  ...
  public static ChannelCoverInfo a(oidb_cmd0x69f.ChannelInfo paramChannelInfo, int paramInt)
  {
    ...
    //   493: invokestatic 1372	osj:a	()Losj;
    //   496: iload_1
    //   497: invokevirtual 1375	osj:a	(I)Ljava/util/List;
  ...
  public static void a(ArticleInfo paramArticleInfo, articlesummary.FeedsInfo paramFeedsInfo)
  {
    ...
    if (((!paramFeedsInfo.msg_pos_ad_info.has()) || (paramFeedsInfo.msg_pos_ad_info.get() == null)) || ((paramFeedsInfo.msg_topic_recommend_feeds_info.has()) && (paramFeedsInfo.msg_topic_recommend_feeds_info.get() != null)))
    {
      ...
      paramArticleInfo.mTopicRecommendFeedsInfo = qdt.a((articlesummary.TopicRecommendFeedsInfo)localObject);
    ...
    for (long l = paramArticleInfo.mTopicRecommendFeedsInfo.jdField_a_of_type_Long;; l = 0L)
    {
      ...
      paramArticleInfo.mArkAppFeedsInfo = qan.a(paramFeedsInfo);
  ...
  private static void a(TabChannelCoverInfo paramTabChannelCoverInfo)
  {
    ...
    rpx.a(str, String.valueOf(paramTabChannelCoverInfo.bid));
    rpx.b(str);
    try
    {
  ...
  public static void a(List<ArticleInfo> paramList)
  {
    ...
    for (;;)
    {
      ...
      paramList = paramList.iterator();
      while (paramList.hasNext()) {
        onk.a((ArticleInfo)paramList.next());
      }
    }
  }
  ...
  public static List<qax> c(List<oidb_cmd0x46f.DislikeResult> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    if ((paramList == null) || (paramList.size() == 0)) {
      return localArrayList;
    ...
    while (paramList.hasNext())
    {
      ...
      qax localqax = new qax();
      if (localDislikeResult.uint64_articleid.has()) {
        localqax.jdField_a_of_type_Long = localDislikeResult.uint64_articleid.get();
      }
      if (localDislikeResult.uint32_result.has()) {
        localqax.jdField_a_of_type_Int = localDislikeResult.uint32_result.get();
      }
      if (localDislikeResult.str_message.has()) {
        localqax.jdField_a_of_type_JavaLangString = localDislikeResult.str_message.get();
      }
      localArrayList.add(localqax);
    }
    return localArrayList;
  }
