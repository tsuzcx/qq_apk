...
public class pot
{
  ...
  static
  {
    jdField_c_of_type_Int = ((Integer)bgmq.a(h, Integer.valueOf(0))).intValue();
  }
  ...
  {
    jdField_c_of_type_Int = ((Integer)bgmq.a(h, Integer.valueOf(0))).intValue();
    NativeAwesomeCommentView.jdField_a_of_type_Int = ((Integer)bgmq.a(i, Integer.valueOf(1))).intValue();
  }
  ...
  public static void a(BaseArticleInfo paramBaseArticleInfo, String paramString)
  {
    ...
    try
    {
      if ((paramBaseArticleInfo.mResolvedFeedType == 0) && ((paramBaseArticleInfo instanceof ArticleInfo))) {
        paramBaseArticleInfo.mResolvedFeedType = qoe.a((ArticleInfo)paramBaseArticleInfo, 0);
      }
    ...
    if (paramBaseArticleInfo != null) {
      ndn.a(null, "", paramString, paramString, 0, 0, paramBaseArticleInfo.mArticleID + "", paramBaseArticleInfo.mStrategyId + "", paramBaseArticleInfo.rawkey, localJSONObject.toString(), false);
    }
  }
