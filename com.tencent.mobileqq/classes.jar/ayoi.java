...
public abstract class ayoi
  extends ProtocolDownloader.Adapter
{
  public static final String a = ajsd.aW + "chatpic" + File.separator;
  ...
  public static String a(String paramString1, String paramString2)
  {
    ...
    return azac.a(localStringBuffer.toString());
  }
  
  public static void a(String paramString1, String paramString2, String paramString3)
  {
    int i = bbdx.a(paramString2, paramString3);
  ...
  public static final String d(String paramString)
  {
    ...
    for (;;)
    {
      ...
      Object localObject1 = aywm.a + File.separator + str;
      try
      {
  ...
  public File loadImageFile(DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    //   1: istore_3
    //   2: aload_0
    //   3: invokevirtual 218	ayoi:a	()Z
    //   6: ifeq +387 -> 393
    //   9: aload_1
    //   10: getfield 223	com/tencent/image/DownloadParams:urlStr	Ljava/lang/String;
    //   13: astore 6
    //   15: aload 6
    //   17: invokestatic 154	ayoi:a	(Ljava/lang/String;)Ljava/io/File;
    //   20: astore 7
    //   22: aload 7
    //   24: ifnull +38 -> 62
    //   27: ldc 116
    ...
    //   54: invokestatic 242	aung:a	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   57: aload 7
    //   59: astore_1
    //   60: aload_1
    //   61: areturn
    //   62: aload_1
    //   63: getfield 246	com/tencent/image/DownloadParams:mHttpDownloaderParams	Ljava/lang/Object;
    //   66: ifnull +14 -> 80
    //   69: aload_0
    //   70: aconst_null
    //   71: aload_1
    //   72: aload_2
    //   73: invokevirtual 248	ayoi:a	(Ljava/io/OutputStream;Lcom/tencent/image/DownloadParams;Lcom/tencent/image/URLDrawableHandler;)Ljava/io/File;
    //   76: pop
    //   77: aload 7
    //   79: areturn
    //   80: aload 6
    //   82: invokestatic 176	ayoi:c	(Ljava/lang/String;)Ljava/lang/String;
    //   85: astore 9
    //   87: getstatic 253	com/tencent/mobileqq/startup/step/InitUrlDrawable:a	Layqe;
    //   90: aload 9
    //   92: invokevirtual 258	ayqe:a	(Ljava/lang/String;)Layqf;
    //   95: astore 10
    //   97: aload_0
    //   98: invokevirtual 260	ayoi:b	()Z
    //   101: istore 4
    //   103: iload 4
    //   105: ifeq +338 -> 443
    //   108: aload_1
    //   109: aload 10
    //   111: getfield 263	ayqf:a	Ljava/io/File;
    //   114: invokevirtual 266	java/io/File:length	()J
    //   117: putfield 270	com/tencent/image/DownloadParams:downloaded	J
    //   120: aload_0
    //   121: aload_1
    //   122: invokevirtual 272	ayoi:a	(Lcom/tencent/image/DownloadParams;)Z
    //   125: istore 5
    //   127: iload 5
    //   129: ifne +5 -> 134
    //   132: iconst_1
    ...
    //   137: iand
    //   138: istore 4
    //   140: new 274	java/io/FileOutputStream
    //   143: dup
    //   144: aload 10
    //   146: getfield 263	ayqf:a	Ljava/io/File;
    //   149: iload 4
    //   151: invokespecial 277	java/io/FileOutputStream:<init>	(Ljava/io/File;Z)V
    //   154: astore 8
    //   156: aload 8
    //   158: astore 7
    //   160: aload_0
    ...
    //   163: aload_1
    //   164: aload_2
    //   165: invokevirtual 248	ayoi:a	(Ljava/io/OutputStream;Lcom/tencent/image/DownloadParams;Lcom/tencent/image/URLDrawableHandler;)Ljava/io/File;
    //   168: pop
    //   169: aload 8
    //   171: astore 7
    //   173: aload 6
    //   175: ldc_w 279
    //   178: invokevirtual 282	java/lang/String:endsWith	(Ljava/lang/String;)Z
    //   181: ifeq +256 -> 437
    //   184: aload 8
    //   186: astore 7
    //   188: aload 6
    ...
    //   191: aload 6
    //   193: ldc_w 279
    //   196: invokevirtual 286	java/lang/String:indexOf	(Ljava/lang/String;)I
    //   199: invokevirtual 108	java/lang/String:substring	(II)Ljava/lang/String;
    //   202: astore_1
    //   203: aload 8
    //   205: astore 7
    //   207: aload_1
    //   208: invokestatic 154	ayoi:a	(Ljava/lang/String;)Ljava/io/File;
    //   211: astore_2
    //   212: aload_2
    //   213: ifnull +67 -> 280
    //   216: aload 8
    ...
    //   237: aload_2
    //   238: invokevirtual 237	java/io/File:getAbsolutePath	()Ljava/lang/String;
    ...
    //   247: invokestatic 242	aung:a	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   250: aload 8
    //   252: astore 7
    //   254: aload 10
    //   256: getfield 263	ayqf:a	Ljava/io/File;
    //   259: invokevirtual 291	java/io/File:delete	()Z
    //   262: pop
    //   263: aload_2
    //   264: astore_1
    //   265: aload 8
    //   267: ifnull -207 -> 60
    //   270: aload 8
    //   272: invokevirtual 296	java/io/OutputStream:close	()V
    //   275: aload_2
    //   276: areturn
    //   277: astore_1
    //   278: aload_2
    ...
    //   282: astore 7
    //   284: aload 10
    //   286: invokevirtual 299	ayqf:a	()Ljava/io/File;
    //   289: astore_2
    //   290: aload_2
    //   291: astore_1
    //   292: aload 8
    //   294: ifnull -234 -> 60
    //   297: aload 8
    //   299: invokevirtual 296	java/io/OutputStream:close	()V
    //   302: aload_2
    //   303: areturn
    //   304: astore_1
    //   305: aload_2
    ...
    //   318: aload 10
    //   320: iload 4
    //   322: invokevirtual 302	ayqf:a	(Z)V
    //   325: aload_2
    //   326: astore 7
    //   328: ldc_w 304
    //   331: ldc 232
    ...
    //   365: invokestatic 310	aung:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   368: aload_2
    //   369: astore 7
    //   371: aload_1
    //   372: invokevirtual 311	java/lang/Exception:printStackTrace	()V
    //   375: aload_2
    //   376: astore 7
    //   378: aload_1
    //   379: athrow
    ...
    //   383: ifnull +8 -> 391
    //   386: aload 7
    //   388: invokevirtual 296	java/io/OutputStream:close	()V
    //   391: aload_1
    //   392: athrow
    //   393: aload_0
    //   394: aconst_null
    //   395: aload_1
    //   396: aload_2
    //   397: invokevirtual 248	ayoi:a	(Ljava/io/OutputStream;Lcom/tencent/image/DownloadParams;Lcom/tencent/image/URLDrawableHandler;)Ljava/io/File;
    //   400: areturn
    //   401: astore_2
    //   402: goto -11 -> 391
    //   405: astore_1
