...
public class udv
{
  public static void a(Context paramContext, ViewBase paramViewBase, uei paramuei, TextView paramTextView, NativeAdDownloadView paramNativeAdDownloadView)
  {
    int n = Color.parseColor("#40A0FF");
    if (!TextUtils.isEmpty(paramuei.jdField_a_of_type_JavaLangString)) {
      n = oix.a(paramuei.jdField_a_of_type_JavaLangString, "#FFFFFF");
    }
    for (;;)
    {
      int i2 = (int)paramuei.g;
      float f2 = paramuei.jdField_a_of_type_Int;
      int i = 0;
      int j = 0;
      float f1 = f2;
      if (f2 < 10.0F) {
      ...
      {
        Object localObject = paramuei.b;
        f2 = paramuei.jdField_c_of_type_Float;
        String str = paramuei.jdField_c_of_type_JavaLangString;
        float f3 = paramuei.d;
        GradientDrawable localGradientDrawable = new GradientDrawable();
        if (!TextUtils.isEmpty(str)) {
          localGradientDrawable.setColor(oix.a(str, "#40A0FF"));
        }
        f1 = f2;
        if (f2 > 0.0F)
        {
          ...
          localGradientDrawable.setStroke(AIOUtils.dp2px(f1, paramContext.getResources()), oix.a((String)localObject, "#40A0FF"));
        }
        if (f3 < 0.0F) {
          f2 = 0.0F;
        }
        for (;;)
        {
          ...
          pic.a(paramTextView, localGradientDrawable);
          f3 = paramuei.e;
          float f5 = paramuei.f;
          label228:
          label238:
          ...
          for (;;)
          {
            ...
            for (;;)
            {
              ...
              for (;;)
              {
                paramNativeAdDownloadView = paramViewBase.getComLayoutParams();
                paramuei = paramNativeAdDownloadView;
                if (paramNativeAdDownloadView == null) {
                  paramuei = new Layout.Params();
                }
                paramuei.mLayoutWidth = AIOUtils.dp2px(f1 * 2.0F + f2, paramContext.getResources());
                paramViewBase.setComLayoutParams(paramuei);
