  ...
  implements Manager
{
  ...
  private final BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new azxh(this);
  private final GuardProcessExitListener jdField_a_of_type_ComTencentMobileqqAppGuardProcessExitListener = new azxg(this);
  ...
  public azxf(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(Context paramContext)
  {
    ...
    if ((localazxi != null) && (localazxi.a()) && (bdee.a(paramContext)))
    {
      ...
      if (l - this.jdField_a_of_type_Long > 1800000L)
      {
        ...
        azye.a(paramContext, new Bundle(), true, new azyg());
      }
    }
    else
    {
  ...
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c()) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().d()))
    {
    ...
    if (localObject1 != null)
    {
      ...
      if ((localObject2 == null) || (((lpp)localObject2).a <= 0)) {
        break label375;
      }
      ...
      {
        lpo locallpo = (lpo)((Iterator)localObject2).next();
        if ((locallpo != null) && (TextUtils.equals(String.valueOf(locallpo.jdField_a_of_type_Long), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c()))) {
          i = 1;
        }
      }
    }
    ...
    for (;;)
    {
      ...
      if (j != 0)
      {
        ...
        QQToast.a(paramContext, 2131696352, 1).b(paramContext.getResources().getDimensionPixelSize(2131298914));
        return;
      }
