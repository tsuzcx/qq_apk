  ...
  implements bjxx
{
  ...
  public bkah(WadlJsBridge paramWadlJsBridge, String paramString)
  {
  ...
  public void a(String paramString)
  {
    ...
    bkad.a("WadlJsBridge", "##@!JsCheckUpdateCallback onException >>> " + paramString);
  ...
  {
    bkad.c("WadlJsBridge", "##@checkUpdate(End) onResult()");
    if (!this.jdField_a_of_type_ComTencentOpenWadlWadlJsBridge.hasRight()) {
      return;
    }
