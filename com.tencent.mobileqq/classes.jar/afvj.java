  ...
  extends afup
{
  ...
  public afvj(int paramInt, AIOAnimationConatiner paramAIOAnimationConatiner, ListView paramListView)
  {
  ...
  private BaseChatItemLayout a(long paramLong)
  {
    ...
    if (paramLong == 0L)
    {
      ...
      while (k < this.jdField_a_of_type_ComTencentWidgetListView.getChildCount())
      {
        ...
        {
          localObject2 = (afqr)AIOUtils.getHolder((View)localObject1);
          if ((((afqr)localObject2).jdField_a_of_type_Int != 0) && (((afqr)localObject2).jdField_a_of_type_AndroidViewView.getTop() + ((View)localObject1).getTop() + BaseChatItemLayout.h > 0)) {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          if (((localObject2 instanceof BaseChatItemLayout)) && (((afqr)AIOUtils.getHolder((View)localObject2)).jdField_a_of_type_Int != 0)) {
  ...
  private void a(afuw paramafuw, ChatMessage paramChatMessage)
  {
    afvi.a(null, "0X800B072", paramChatMessage.frienduin, paramafuw);
  }
  
  private void a(Object[] paramArrayOfObject)
  {
    if ((paramArrayOfObject.length < 5) || (!(paramArrayOfObject[3] instanceof afuw)) || (!(paramArrayOfObject[4] instanceof ChatMessage))) {}
    afuw localafuw;
    do
    {
      return;
      localafuw = (afuw)paramArrayOfObject[3];
    } while (!a(localafuw.a));
    paramArrayOfObject = (ChatMessage)paramArrayOfObject[4];
    if (QLog.isColorLevel()) {
      QLog.d("FloorJumper", 2, "set jump url, url = " + localafuw.a);
    }
    this.jdField_a_of_type_AndroidViewView.setOnClickListener(new afvk(this, localafuw, paramArrayOfObject));
  }
  ...
  int a(int paramInt, afqr paramafqr)
  {
    int k;
    int m;
    int n;
    if (paramafqr.jdField_a_of_type_ComTencentMobileqqDataChatMessage.isSend())
    {
      k = paramafqr.jdField_a_of_type_AndroidViewView.getLeft() + BaseChatItemLayout.k + BaseChatItemLayout.p;
      m = paramafqr.jdField_a_of_type_AndroidViewView.getRight() - BaseChatItemLayout.j - BaseChatItemLayout.o;
      if (paramInt > k) {
        break label135;
      }
    ...
    {
      return n;
      k = paramafqr.jdField_a_of_type_AndroidViewView.getLeft() + BaseChatItemLayout.j + BaseChatItemLayout.o;
      m = paramafqr.jdField_a_of_type_AndroidViewView.getRight() - BaseChatItemLayout.k - BaseChatItemLayout.k;
      break;
      d1 = Math.random();
  ...
  public long a()
  {
    ...
    case 3: 
      ...
      if (this.jdField_b_of_type_Int == 1)
      {
        ...
        {
          localafqr = (afqr)AIOUtils.getHolder(localBaseChatItemLayout);
          if (localafqr != null)
          {
            this.jdField_b_of_type_Int = 2;
            this.jdField_a_of_type_Long = 0L;
            this.jdField_b_of_type_Long = localafqr.jdField_a_of_type_ComTencentMobileqqDataChatMessage.uniseq;
            this.jdField_d_of_type_Long = 0L;
            this.jdField_e_of_type_Int = 0;
            k = localafqr.jdField_a_of_type_AndroidViewView.getTop();
            ...
            this.jdField_g_of_type_Int = a((localafqr.jdField_a_of_type_AndroidViewView.getLeft() + localafqr.jdField_a_of_type_AndroidViewView.getRight()) / 2, localafqr);
            this.h = 0;
      ...
      if (localBaseChatItemLayout != null)
      {
        ...
        if (localafqr != null)
        {
          ...
          this.jdField_e_of_type_Int = (a(this.i, localafqr) - this.i);
  ...
  public boolean a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      while ((this.jdField_a_of_type_ComTencentMobileqqActivityAioAnimAIOAnimationConatiner == null) || (this.jdField_a_of_type_AndroidViewView == null))
      {
        ...
        {
          afqr localafqr = (afqr)AIOUtils.getHolder(AIOUtils.getViewByPostion(this.jdField_a_of_type_ComTencentWidgetListView, k));
          if (localafqr != null)
          {
            k = localafqr.jdField_a_of_type_AndroidViewView.getTop();
            k = localafqr.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() + k + BaseChatItemLayout.h - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - (this.h + this.jdField_f_of_type_Int);
            if (k != 0)
            {
              this.h += k;
              this.j += k;
          ...
          else
          {
            ...
            {
              localafqr = (afqr)AIOUtils.getHolder(AIOUtils.getViewByPostion(this.jdField_a_of_type_ComTencentWidgetListView, k));
              if (localafqr != null)
              {
                k = localafqr.jdField_a_of_type_AndroidViewView.getTop();
                k = localafqr.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() + k + BaseChatItemLayout.h - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - (this.h + this.jdField_f_of_type_Int);
            ...
            {
              localafqr = (afqr)AIOUtils.getHolder(AIOUtils.getViewByPostion(this.jdField_a_of_type_ComTencentWidgetListView, m));
              if (localafqr != null)
              {
                k = localafqr.jdField_a_of_type_AndroidViewView.getTop();
                k = localafqr.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() + k + BaseChatItemLayout.h - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - (this.h + this.jdField_f_of_type_Int);
