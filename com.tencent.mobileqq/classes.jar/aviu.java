...
public class aviu
  ...
  implements Handler.Callback, bnyx
{
  ...
  private bnym jdField_a_of_type_Bnym;
  ...
  public aviu(Context paramContext, QQAppInterface paramQQAppInterface, QQGamePubAccountFragment paramQQGamePubAccountFragment)
  {
  ...
  public void a()
  {
    RelativeLayout localRelativeLayout = (RelativeLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559198, null, false);
    localRelativeLayout.setLayoutParams(new RecyclerView.LayoutParams(-1, 0));
    this.jdField_a_of_type_Avjl = new avjl(localRelativeLayout, this.jdField_a_of_type_AndroidContentContext);
  ...
  {
    this.jdField_a_of_type_AndroidAppDialog = new ReportDialog(this.jdField_a_of_type_AndroidContentContext, 2131755266);
    Object localObject = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131559205, null);
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(agej.a(280.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), -1);
    ((ImageView)((View)localObject).findViewById(2131368572)).setImageDrawable(URLDrawable.getDrawable("https://cmshow.gtimg.cn/client/gameCenter/gameCenter_popView_card@2x.png"));
    TextView localTextView1 = (TextView)((View)localObject).findViewById(2131380159);
    if ((!TextUtils.isEmpty(paramString2)) && (!TextUtils.isEmpty(paramString3)))
    {
      localTextView1.setText(paramString2);
      localTextView1.setTextColor(avmd.a(-16733441, 1593879295));
      ...
      paramString2 = (CheckBox)((View)localObject).findViewById(2131364501);
      TextView localTextView2 = (TextView)((View)localObject).findViewById(2131379739);
      TextView localTextView3 = (TextView)((View)localObject).findViewById(2131379907);
      localTextView3.setTextColor(avmd.a(-16733441, 1593879295));
      ...
      paramString2.setOnCheckedChangeListener(new avix(this, paramString1));
      localTextView2.setOnClickListener(new aviy(this, paramString4));
      localTextView1.setOnClickListener(new aviz(this, paramString4, paramString3));
      localTextView3.setOnClickListener(new avja(this, paramString4, paramJSONObject, (String)localObject));
      this.jdField_a_of_type_AndroidAppDialog.show();
      paramString1 = new HashMap();
      acik.a(paramString1, paramString4);
    ...
    for (;;)
    {
      ...
      acik.a(anbd.a(), "769", "205710", a().gameAppId, "76905", "1", "160", paramString1);
      return;
      localTextView1.setText(anzj.a(2131709198));
      break;
      label410:
  ...
  {
    b();
    this.jdField_a_of_type_AndroidWidgetFrameLayout$LayoutParams.topMargin = agej.a(20.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    ...
    if (paramBoolean1)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setText(anzj.a(2131709182));
      return;
    }
    if (paramBoolean2)
    {
    ...
    this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
    this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
    this.jdField_b_of_type_AndroidWidgetTextView.setText(anzj.a(2131709184));
  }
  ...
  public void b()
  {
    if (this.jdField_b_of_type_AndroidWidgetLinearLayout == null)
    {
      ...
      ((FrameLayout.LayoutParams)localObject2).leftMargin = agej.a(7.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      this.jdField_b_of_type_AndroidWidgetTextView.setText(anzj.a(2131709185));
      ...
      ((URLDrawable.URLDrawableOptions)localObject1).mFailedDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130847177);
      ((URLDrawable.URLDrawableOptions)localObject1).mLoadingDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130847177);
      ...
      this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
      localObject3 = new LinearLayout.LayoutParams(agej.a(15.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), agej.a(15.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ...
      localFrameLayout.setLayoutParams(new RecyclerView.LayoutParams(-1, agej.a(120.0F, this.jdField_a_of_type_AndroidContentContext.getResources())));
      this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setText(anzj.a(2131709175));
      ...
      ((LinearLayout.LayoutParams)localObject3).leftMargin = agej.a(7.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      this.jdField_c_of_type_AndroidWidgetTextView.setText(anzj.a(2131709200));
    ...
    this.jdField_b_of_type_AndroidWidgetImageView.clearAnimation();
    this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
    this.jdField_b_of_type_AndroidWidgetTextView.setText(anzj.a(2131709192));
  ...
  {
    bnyy.a().b(this);
    if (this.jdField_a_of_type_Bnym != null) {
      bnyp.b(this.jdField_a_of_type_Bnym);
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.arg1 == 0)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setText(anzj.a(2131709193));
      return false;
    }
    this.jdField_a_of_type_AndroidWidgetImageView.clearAnimation();
  ...
  {
    if (a(paramInt)) {
      if ((paramViewHolder instanceof avjl)) {
        ((avjl)paramViewHolder).a(this.jdField_a_of_type_ComTencentMobileqqGamecenterDataFeedsItemData$TopCardInfo, this);
      }
    }
    do
    {
      do
      {
        do
        {
          do
          {
            ...
            if ((!(paramViewHolder instanceof avjd)) && (!(paramViewHolder instanceof avjb))) {
              break;
            }
          ...
          {
            localObject2 = (avjd)paramViewHolder;
            ((avjd)localObject2).a(this, (FeedsItemData)localObject1, paramInt);
            ((avjd)localObject2).d.setTag(a().gameAppId);
            localObject2 = new HashMap();
            acik.a((Map)localObject2, ((FeedsItemData)localObject1).msgId);
            ...
            {
              acik.a(anbd.a(), "769", "205021", (String)localObject1, "76902", "1", "160", (Map)localObject2);
              break;
            }
          }
        } while (((FeedsItemData)localObject1).type != 4);
        ((avjb)paramViewHolder).a(this, (FeedsItemData)localObject1, paramInt);
        localObject2 = new HashMap();
        acik.a((Map)localObject2, ((FeedsItemData)localObject1).msgId);
        ((Map)localObject2).put(Integer.valueOf(2), ((FeedsItemData)localObject1).msgId);
        ((Map)localObject2).put(Integer.valueOf(4), "8");
      ...
      } while (!(paramViewHolder instanceof avkb));
      localObject1 = a(paramInt);
    } while (localObject1 == null);
    ((avkb)paramViewHolder).a((FeedsItemData)localObject1);
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    if (this.jdField_a_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt) != null)
    {
      ...
      return new aviv(this, (View)this.jdField_a_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt));
    }
    if (this.jdField_b_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt) != null) {
      return new aviw(this, (View)this.jdField_b_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt));
    }
    if (paramInt == 4)
    {
      ...
      ((LinearLayout)localObject1).setPadding(agej.a(5.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0, agej.a(5.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
      ...
      ((TextView)localObject3).setId(2131378936);
      ((TextView)localObject3).setEllipsize(TextUtils.TruncateAt.END);
      Object localObject4 = new RelativeLayout.LayoutParams(-1, agej.a(45.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ((RelativeLayout.LayoutParams)localObject4).setMargins(agej.a(12.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), agej.a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), agej.a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
      ...
      ((TextView)localObject4).setId(2131363053);
      ((TextView)localObject4).setEllipsize(TextUtils.TruncateAt.END);
      ((TextView)localObject4).setMaxWidth(agej.a(80.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      RelativeLayout.LayoutParams localLayoutParams2 = new RelativeLayout.LayoutParams(-2, -2);
      localLayoutParams2.setMargins(agej.a(12.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), agej.a(8.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0, agej.a(8.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      localLayoutParams2.addRule(3, 2131378936);
      ((RelativeLayout)localObject2).addView((View)localObject4, localLayoutParams2);
      localObject4 = new TextView(this.jdField_a_of_type_AndroidContentContext);
      ((TextView)localObject4).setTextColor(-6052957);
      ((TextView)localObject4).setTextSize(12.0F);
      ((TextView)localObject4).setMaxLines(1);
      ((TextView)localObject4).setId(2131372002);
      ((TextView)localObject4).setEllipsize(TextUtils.TruncateAt.END);
      localLayoutParams2 = new RelativeLayout.LayoutParams(-2, -2);
      localLayoutParams2.leftMargin = agej.a(8.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      localLayoutParams2.addRule(6, 2131363053);
      localLayoutParams2.addRule(1, 2131363053);
      ((RelativeLayout)localObject2).addView((View)localObject4, localLayoutParams2);
      localObject4 = new TextView(this.jdField_a_of_type_AndroidContentContext);
      ((TextView)localObject4).setTextColor(-6052957);
      ((TextView)localObject4).setTextSize(10.0F);
      ((TextView)localObject4).setMaxLines(1);
      ((TextView)localObject4).setId(2131367382);
      ((TextView)localObject4).setBackgroundColor(1270796256);
      ((TextView)localObject4).setPadding(agej.a(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), agej.a(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), agej.a(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), agej.a(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ((TextView)localObject3).setEllipsize(TextUtils.TruncateAt.END);
      localObject3 = new RelativeLayout.LayoutParams(-2, -2);
      ((RelativeLayout.LayoutParams)localObject3).setMargins(0, agej.a(-1.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), agej.a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
      ((RelativeLayout.LayoutParams)localObject3).addRule(6, 2131363053);
      ...
      ((CornerImageView)localObject2).setId(2131368451);
      localLayoutParams = new LinearLayout.LayoutParams(0, agej.a(71.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      localLayoutParams.weight = 3.0F;
      localLayoutParams.gravity = 16;
      ((LinearLayout)localObject1).addView((View)localObject2, localLayoutParams);
      paramViewGroup.addView((View)localObject1, localLayoutParams1);
      localObject1 = new ImageView(this.jdField_a_of_type_AndroidContentContext);
      localLayoutParams1 = new RelativeLayout.LayoutParams(-1, agej.a(1.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ((ImageView)localObject1).setImageDrawable(new ColorDrawable(-263173));
      ((ImageView)localObject1).setId(2131365632);
      ((ImageView)localObject1).setPadding(agej.a(25.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0, 0, 0);
      localLayoutParams1.rightMargin = agej.a(4.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      paramViewGroup.addView((View)localObject1, localLayoutParams1);
      return new avjb(paramViewGroup);
    }
    if ((paramInt == 5) || (paramInt == 7) || (paramInt == 6)) {
      return avkg.a(this.jdField_a_of_type_AndroidContentContext, paramInt, paramViewGroup);
    }
    return new avjd(LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559197, paramViewGroup, false));
  }
  
  public void onViewDetachedFromWindow(RecyclerView.ViewHolder paramViewHolder)
  {
    super.onViewDetachedFromWindow(paramViewHolder);
    if ((paramViewHolder instanceof avjd))
    {
      paramViewHolder = (avjd)paramViewHolder;
      if ((paramViewHolder.a != null) && (avky.a().a() == paramViewHolder.a))
      {
        paramViewHolder.a.i();
        paramViewHolder.a.l();
      }
