...
{
  public awmu(MapWidget paramMapWidget, int paramInt, awmz paramawmz) {}
  ...
  public void onFailure(int paramInt, String paramString, Throwable paramThrowable)
  {
    ...
    if (MapWidget.a(this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget) != null) {
      MapWidget.a(this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget).a(false, this.jdField_a_of_type_Awmz);
    }
  }
  ...
  public void onSuccess(int paramInt, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      {
        ((awmy)localObject1).a(bool, this.jdField_a_of_type_Awmz);
        return;
        ...
        this.jdField_a_of_type_Awmz.a = paramObject.duration;
        this.jdField_a_of_type_Awmz.b = paramObject.distance;
        ...
        this.jdField_a_of_type_Awmz.a = ((float)((TransitResultObject.Route)localObject1).duration);
        this.jdField_a_of_type_Awmz.b = ((TransitResultObject.Route)localObject1).distance;
