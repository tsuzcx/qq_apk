  ...
  implements bkua
{
  ...
  private bkue a(Bitmap paramBitmap, ArrayList<bkub> paramArrayList)
  {
    bkue localbkue = new bkue(this);
    ...
    {
      paramBitmap = (bkub)paramArrayList.get(i);
      int j = paramBitmap.jdField_b_of_type_Int;
      double d2 = paramBitmap.jdField_a_of_type_Int * j;
      double d3 = localbkue.jdField_a_of_type_Double;
      localbkue.jdField_a_of_type_Double = (d2 / d1 + d3);
      if (localbkue.jdField_a_of_type_Double > jdField_a_of_type_JavaLangDouble.doubleValue()) {
        localbkue.jdField_a_of_type_Boolean = true;
      }
      i += 1;
    }
    if ((paramArrayList.size() > 1) && (localbkue.jdField_a_of_type_Double > b.doubleValue())) {
      localbkue.b = true;
    }
    return localbkue;
  }
  
  private bkug a(String paramString)
  {
    ...
    while (i < localJSONArray1.length())
    {
      ...
      if (j < localJSONArray2.length())
      {
        ...
        {
          localbkug.jdField_a_of_type_Int = localJSONObject1.optInt("sceneLvOne");
          localbkug.jdField_b_of_type_Int = localJSONObject2.optInt("sceneLvTwo");
          localbkug.jdField_a_of_type_JavaLangString = localJSONObject2.optString("sceneName");
          localbkug.jdField_b_of_type_JavaLangString = localJSONObject2.optString("sceneFilterID");
          localbkug.jdField_a_of_type_Double = localJSONObject2.optDouble("sceneFilterPercent");
        }
      }
      else
      {
  ...
  private bkug a(JSONArray paramJSONArray)
  {
    double d2 = -1.0D;
    Object localObject1 = new bkug();
    ...
    if (paramJSONArray.length() > 0)
    {
      ...
      if (i < paramJSONArray.length())
      {
        ...
        bkug localbkug = a((String)localObject3);
        double d6;
        double d5;
        if (localbkug == null)
        {
        ...
        for (;;)
        {
          ...
          d5 = d2;
          d6 = d3;
          if (localbkug.jdField_b_of_type_Int != -1)
          {
            localObject3 = localObject1;
            double d1 = d2;
            if (localbkug.jdField_a_of_type_Int == 3)
            {
              localObject3 = localObject1;
              d1 = d2;
              if (d4 > c.doubleValue())
  ...
  private String a(Bitmap paramBitmap, int paramInt)
  {
    ...
    if (i > paramInt)
    {
      paramBitmap = awci.a(paramBitmap, i / paramInt);
      localByteArrayOutputStream = new ByteArrayOutputStream();
      paramBitmap.compress(Bitmap.CompressFormat.JPEG, 100, localByteArrayOutputStream);
      return bkty.a(localByteArrayOutputStream.toByteArray());
    }
  ...
  private JSONObject a()
  {
    ...
    try
    {
      JSONObject localJSONObject2 = new JSONObject(bdhb.d("video_story_aiSceneParams.json"));
  ...
  private JSONObject a(String paramString)
  {
    ...
    try
    {
      ...
      paramString = bktz.a("https://tu.qq.com/cgi-bin/qq/get_face_detail.fcg", localJSONObject2.toString());
      return paramString;
    }
  ...
  private JSONObject b(String paramString)
  {
    ...
    try
    {
      ...
      localJSONObject2.put("token", b(paramString));
      paramString = bktz.a("https://tu.qq.com/cgi-bin/qq/do_image_classify.fcg", localJSONObject2.toString());
      return paramString;
    }
    catch (Exception paramString)
    {
  ...
  public void a(Bitmap paramBitmap, ArrayList<bkub> paramArrayList, bkuc parambkuc)
  {
    if (paramBitmap == null)
    {
      parambkuc.a("image is null");
      return;
    }
    ...
    if (paramArrayList.jdField_a_of_type_Boolean) {
      if (paramArrayList.b) {
        paramBitmap = a(alud.a(2131716222));
      }
    }
    while (paramBitmap == null)
    {
      parambkuc.a("unknown error");
      bktz.a(System.currentTimeMillis() - l, 1);
      return;
      paramBitmap = a(paramBitmap);
      if ((paramBitmap == null) || (paramBitmap.isNull("retcode")))
      {
        parambkuc.a("network error");
        bktz.a(System.currentTimeMillis() - l, 1);
        return;
      }
      if ((paramBitmap != null) && (paramBitmap.has("retcode")) && (paramBitmap.optInt("retcode") == 0))
      {
        ...
        if (i <= 5) {
          paramBitmap = a(alud.a(2131716225));
        } else if (j < 50) {
          paramBitmap = a(alud.a(2131716223));
        } else {
          paramBitmap = a(alud.a(2131716220));
        }
      }
      else
      {
        paramBitmap = a(alud.a(2131716224));
        continue;
        ...
        if ((paramArrayList == null) || (paramArrayList.isNull("retcode")))
        {
          ...
          bktz.a(l, 1);
          zaj.a("record_smart_filter", zaj.a(1L, l));
          return;
        }
        paramBitmap = localbkug;
    ...
    parambkuc.a(paramBitmap);
    l = System.currentTimeMillis() - l;
    bktz.a(l, 0);
    zaj.a("record_smart_filter", zaj.a(0L, l));
  }
}
