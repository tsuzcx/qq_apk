...
{
  public bfoj(ARMapHongBaoListView paramARMapHongBaoListView) {}
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 1: 
      ...
      if ((bool1) && (bool2))
      {
        this.a.jdField_a_of_type_Alww.c(-this.a.e);
      ...
      {
        float f = j * 1.0F / 6.0F;
        if (this.a.jdField_a_of_type_Alwu != null) {
          this.a.jdField_a_of_type_Alwu.a((int)(f * this.a.e), j * 300L);
        }
        k = j - 1;
        i = k;
        if (k > 0)
    ...
    for (int i = k;; i = j)
    {
      ...
      this.a.jdField_a_of_type_Alww.c(-i);
      if (this.a.jdField_a_of_type_Alwu != null) {
        this.a.jdField_a_of_type_Alwu.a(this.a.e / 3, 300L);
      }
