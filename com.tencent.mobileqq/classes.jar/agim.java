...
public class agim
{
  ...
  AdapterView.OnItemClickListener jdField_a_of_type_AndroidWidgetAdapterView$OnItemClickListener = new agin(this);
  private bhsg jdField_a_of_type_Bhsg;
  ...
  public agim(FragmentActivity paramFragmentActivity, QQAppInterface paramQQAppInterface, IntimateInfo paramIntimateInfo, Bitmap paramBitmap1, Bitmap paramBitmap2, Bitmap paramBitmap3)
  {
    ...
    if ((this.c == null) || (this.c.isRecycled())) {
      this.c = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130846408);
    }
    if ((this.d == null) || (this.d.isRecycled())) {
      this.d = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130846408);
    }
    jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693119) + this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693120) + this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693121);
  }
  ...
  private void a(Bitmap paramBitmap, int paramInt)
  {
    ...
    {
      this.jdField_a_of_type_Bjig = new agio(this);
  ...
  private void b(Bitmap paramBitmap)
  {
    ...
    localbmtk.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount();
    bmtd.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, localbmtk, paramBitmap, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693123), "", 20001);
  }
  
  private void c()
  {
    this.jdField_a_of_type_Bhsg = new bhsg(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity);
    this.jdField_a_of_type_ArrayOfJavaUtilList = a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity);
    this.jdField_a_of_type_Bhsg.setActionSheetItems(this.jdField_a_of_type_ArrayOfJavaUtilList);
    this.jdField_a_of_type_Bhsg.setItemClickListener(this.jdField_a_of_type_AndroidWidgetAdapterView$OnItemClickListener);
  }
  ...
  private void c(Bitmap paramBitmap)
  {
    try
    {
      ...
      auxu.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, (Intent)localObject, 21);
      return;
    }
  ...
  private void e(Bitmap paramBitmap)
  {
    if (Build.VERSION.SDK_INT >= 23)
    {
      ...
      {
        this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.requestPermissions(new agip(this, paramBitmap), 1, new String[] { "android.permission.WRITE_EXTERNAL_STORAGE" });
        return;
      }
      a(paramBitmap);
      return;
  ...
  public Bitmap a(Bitmap paramBitmap)
  {
    ...
    localCanvas.restore();
    localCanvas.drawBitmap(a(BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130840448), 194, 40), 512.0F, 1185.0F, null);
    return paramBitmap;
  }
  ...
  public Bitmap a(IntimateInfo paramIntimateInfo)
  {
    ...
    {
    default: 
      localObject = this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693112);
      j = Color.parseColor("#03081A");
      i = Color.parseColor("#878B99");
      localBitmap1 = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130840444);
      ...
      a(localCanvas, localTextPaint, 8.0F + (f + 146.0F), 410.0F, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693068, new Object[] { "" }));
      ...
      localStringBuilder.append(((Resources)localObject).getString(2131693107));
      localStringBuilder.append("\r\n");
      localStringBuilder.append(((Resources)localObject).getString(2131693108));
      localStringBuilder.append("\r\n");
      j = 2;
      if ((paramIntimateInfo.commonTroopInfoList != null) && (paramIntimateInfo.commonTroopInfoList.size() > 0))
      {
        localStringBuilder.append(((Resources)localObject).getString(2131693091));
        localStringBuilder.append(this.jdField_a_of_type_ComTencentMobileqqDataIntimateInfo.commonTroopInfoList.size());
        localStringBuilder.append(((Resources)localObject).getString(2131693079));
        localStringBuilder.append("\r\n");
        label493:
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (k < j)
        {
          ...
          k += 1;
          continue;
          localObject = this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693115);
          j = Color.parseColor("#FF6FA3");
          i = Color.parseColor("#FF8AB5");
          localBitmap1 = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130840447);
          break;
          localObject = this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693113);
          j = Color.parseColor("#FF8A2D");
          i = Color.parseColor("#FF9F40");
          localBitmap1 = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130840445);
          break;
          localObject = this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693114);
          j = Color.parseColor("#2493FF");
          i = Color.parseColor("#4DA7FF");
          localBitmap1 = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130840446);
          break;
          j = 3;
          break label493;
        }
      }
      localStringBuilder.append(((Resources)localObject).getString(2131693109));
      localStringBuilder.append("\r\n");
      localStringBuilder.append(((Resources)localObject).getString(2131693110));
  ...
  public String a(Bitmap paramBitmap)
  {
    ...
    //   19: aload_0
    //   20: getfield 35	agim:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   47: dup
    //   48: getstatic 700	antf:ba	Ljava/lang/String;
    //   51: ldc_w 702
    ...
    //   60: invokestatic 712	bigv:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   75: ifnonnull +11 -> 86
    //   78: aload_0
    //   79: getfield 33	agim:jdField_a_of_type_AndroidSupportV4AppFragmentActivity	Landroid/support/v4/app/FragmentActivity;
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Bhsg == null) {
      c();
    }
    ...
    this.jdField_a_of_type_Bhsg.a(this.jdField_a_of_type_AndroidGraphicsBitmap);
    this.jdField_a_of_type_Bhsg.show();
  }
  ...
  public void a(int paramInt, Bitmap paramBitmap)
  {
    if ((paramInt == 3) || (paramInt == 4))
    {
      ...
      QQToast.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131693117), 0).b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getTitleBarHeight());
    }
    for (;;)
    {
      d();
      ...
      if (!WXShareHelper.a().b()) {
        QQToast.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131693124), 0).b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getTitleBarHeight());
      }
    }
  }
  ...
  public List<ShareActionSheetBuilder.ActionSheetItem>[] a(Context paramContext)
  {
    ...
    localArrayList.add(localActionSheetItem);
    localActionSheetItem = new ShareActionSheetBuilder.ActionSheetItem();
    localActionSheetItem.label = paramContext.getString(2131693126);
    localActionSheetItem.icon = 2130840160;
    localActionSheetItem.iconNeedBg = true;
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Bhsg != null) {
      this.jdField_a_of_type_Bhsg.dismiss();
    }
  }
}
