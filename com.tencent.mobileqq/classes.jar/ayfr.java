...
class ayfr
{
  ...
  {
    return this.jdField_a_of_type_Aygw.a(paramInt);
  }
  ...
  ArrayList<ayfo> a(BaseChatPie paramBaseChatPie)
  {
    this.jdField_a_of_type_Aygw.a(paramBaseChatPie);
    ArrayList localArrayList = new ArrayList();
    List localList = this.jdField_a_of_type_Aygw.a();
    int j = localList.size();
    int i = 0;
    while (i < j)
    {
      Object localObject = (PlusPanelAppInfo)localList.get(i);
      localObject = this.jdField_a_of_type_Aygw.a(paramBaseChatPie, (PlusPanelAppInfo)localObject, i);
      if (localObject != null) {
        localArrayList.add(localObject);
      }
      i += 1;
    }
    if ((!localArrayList.isEmpty()) && (this.jdField_a_of_type_Aygw.a() >= 0)) {
      this.jdField_a_of_type_AndroidArchLifecycleMutableLiveData.setValue(Integer.valueOf(this.jdField_a_of_type_Aygw.a()));
    }
  ...
  void a()
  {
    ...
    if (this.jdField_a_of_type_JavaUtilMap == null)
    {
      ...
      this.jdField_a_of_type_JavaUtilMap.put(afim.class, Integer.valueOf(6));
      this.jdField_a_of_type_JavaUtilMap.put(ahik.class, Integer.valueOf(3));
      this.jdField_a_of_type_JavaUtilMap.put(afiw.class, Integer.valueOf(2));
      this.jdField_a_of_type_JavaUtilMap.put(ahdt.class, Integer.valueOf(2));
      this.jdField_a_of_type_JavaUtilMap.put(ahkw.class, Integer.valueOf(2));
      this.jdField_a_of_type_JavaUtilMap.put(ahkz.class, Integer.valueOf(7));
      this.jdField_a_of_type_JavaUtilMap.put(ahfo.class, Integer.valueOf(7));
    }
  }
  ...
  {
    a();
    this.jdField_a_of_type_Aygw = new aygz().a(paramBaseChatPie, paramBoolean);
  }
