...
public class ayfr
  extends Handler
{
  public ayfr(TroopBarPublishActivity paramTroopBarPublishActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    for (String str = "interestcircle";; str = "qqbuluo")
    {
      ...
      localBundle.putString("title", azho.a(this.a.a).trim());
      localBundle.putString("content", azho.a(this.a.jdField_b_of_type_ComTencentMobileqqTribeViewTEditText).trim());
    ...
    {
      awqx.b(null, "dc00899", "pub_page_new", "", "pub_page", "Clk_music", i, 0, paramMessage, "", "", "");
      i = 4;
      break;
      i = 1;
      break label210;
    ...
    for (paramMessage = "0";; paramMessage = this.a.q)
    {
      awqx.b(null, "dc00899", "pub_page_new", "", "pub_page", "Clk_record", i, 0, paramMessage, "", "", "");
      return;
      i = 1;
      break;
    }
