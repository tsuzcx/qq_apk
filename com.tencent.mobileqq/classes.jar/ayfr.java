  ...
  extends bbjc
{
  ...
  public ayfr(Context paramContext)
  {
    super(paramContext);
  ...
  private void a(View paramView)
  {
    ...
    {
      this.jdField_a_of_type_Aydx = this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.b().a().a();
      paramView = (RelativeLayout)paramView.findViewById(2131362879);
      if ((this.jdField_a_of_type_Aydx == null) || (!this.jdField_a_of_type_Aydx.jdField_a_of_type_Boolean)) {
        break label372;
      }
      paramView.setVisibility(0);
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131378058));
      this.jdField_c_of_type_AndroidWidgetTextView.setOnClickListener(new ayfs(this));
      if (this.jdField_a_of_type_Aydx.jdField_c_of_type_Int != 1) {
        break label269;
      }
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131375558));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131378058));
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131378056));
      this.jdField_d_of_type_AndroidWidgetTextView.setTextColor(Color.parseColor("#000000"));
      if (this.jdField_a_of_type_Aydx.jdField_c_of_type_Int == 2) {
        this.jdField_d_of_type_AndroidWidgetTextView.setTextColor(Color.parseColor("#fe6c6c"));
      }
      this.jdField_d_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Aydx.jdField_a_of_type_JavaLangString);
      this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131378057));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368503));
      if (2 != this.jdField_a_of_type_Aydx.jdField_c_of_type_Int) {
        break label322;
      }
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Aydx.b)) {
        break;
      }
    ...
    this.jdField_e_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Aydx.b);
    return;
    label322:
    if (TextUtils.isEmpty(this.jdField_a_of_type_Aydx.f))
    {
      this.jdField_e_of_type_AndroidWidgetTextView.setVisibility(8);
      return;
    }
    this.jdField_e_of_type_AndroidWidgetTextView.setVisibility(0);
    a(this.jdField_a_of_type_Aydx.f, this.jdField_a_of_type_Aydx.jdField_d_of_type_Int);
    return;
    label372:
  ...
  protected View a()
  {
    View localView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131562495, null);
    a(localView);
      ...
      for (int k = 0;; k = 1)
      {
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            ...
            ((TextView)localObject1).setOnClickListener(new ayft(this));
            if (j == 0) {
  ...
  {
    super.a(new ayfu(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity, this.jdField_a_of_type_ComTencentSmttSdkWebView, this.jdField_a_of_type_ComTencentMobileqqTeamworkTeamWorkFileImportInfo, parambcur));
  }
  ...
  {
    String str = this.jdField_a_of_type_Aydx.g;
    if (paramInt == 0)
    {
      this.jdField_e_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.getString(2131720103));
      return;
    }
