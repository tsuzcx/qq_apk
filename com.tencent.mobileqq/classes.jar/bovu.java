...
public class bovu
{
  ...
  private bota jdField_a_of_type_Bota;
  private bovv jdField_a_of_type_Bovv;
  private int jdField_b_of_type_Int = 320;
  private String jdField_b_of_type_JavaLangString = boey.jdField_b_of_type_JavaLangString;
  private int jdField_c_of_type_Int;
  private String jdField_c_of_type_JavaLangString;
  private int d;
  
  public bovu(String paramString)
  {
  ...
  {
    this.jdField_a_of_type_Bovv = parambovv;
    QLog.d(jdField_a_of_type_JavaLangString, 4, "start add text to png");
    this.jdField_a_of_type_AndroidOsHandler.post(new PngsTextDrawer.2(this, parambovv));
  }
