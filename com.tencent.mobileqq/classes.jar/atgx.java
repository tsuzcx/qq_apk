...
public class atgx
  implements athc
{
  public atgx(OlympicManager paramOlympicManager) {}
  ...
  public void a(String paramString1, String paramString2, Object paramObject, int paramInt, String paramString3)
  {
    ...
    do
    {
      ...
      {
        return;
        atiu.b("OlympicManager", new Object[] { "onDownloadFinish, url=", paramString1, ", md5=", paramString2, ", errCode=", Integer.valueOf(paramInt) });
        if (paramInt == 0) {
        ...
        else if ("shuayishua_anim".equals(str))
        {
          if (paramInt == 0) {
            try
            {
              ...
              paramString1 = atha.a(paramString2);
              bace.a(paramString3, paramString1, false);
              if (QLog.isColorLevel()) {
        ...
        else if ("ActConfig".equals(str))
        {
          ...
          atiu.a("OlympicManager", new Object[] { "mDownloadListener.onDownloadFinish, type=", str, ", itemType=", paramObject, ", url=", paramString1, ", md5=", paramString2, ", errCode=", Integer.valueOf(paramInt), ", filePath=", paramString3 });
