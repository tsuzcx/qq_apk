...
{
  public xwc(NewFlowCameraActivity paramNewFlowCameraActivity, int paramInt) {}
  ...
  public void onLayoutChange(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaNewFlowCameraActivity.e.addOnLayoutChangeListener(new xwd(this));
  }
}
