...
public class bopx
  extends Handler
{
  public bopx(CropVideoActivity paramCropVideoActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 2: 
      do
      {
        ...
        if ((CropVideoActivity.a(this.a) >= CropVideoActivity.b(this.a)) && (CropVideoActivity.b(this.a) >= 0L))
        {
          ...
          QQToast.a(this.a.getApplicationContext(), anvx.a(2131702119), 1).a();
          return;
        }
      } while (CropVideoActivity.a(this.a, CropVideoActivity.a(this.a)) != 0);
      if (Build.VERSION.SDK_INT >= 18) {
        boqa.a(CropVideoActivity.a(this.a), CropVideoActivity.b(this.a), CropVideoActivity.a(this.a), CropVideoActivity.b(this.a), CropVideoActivity.c(this.a), CropVideoActivity.d(this.a), CropVideoActivity.e(this.a), CropVideoActivity.f(this.a), CropVideoActivity.a(this.a), CropVideoActivity.b(this.a), new bopy(this));
      }
      for (;;)
      {
        this.a.a();
    ...
    case 4: 
      ...
      QQToast.a(this.a.getApplicationContext(), 1, anvx.a(2131702117), 1).a();
      this.a.finish();
      return;
    }
    if (QLog.isColorLevel()) {
