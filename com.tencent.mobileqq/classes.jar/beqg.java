...
public abstract class beqg
{
  ...
  private static final Interpolator sDragScrollInterpolator = new beqh();
  private static final Interpolator sDragViewScrollCapInterpolator = new beqi();
  private static final beqn sUICallback = new beqp();
  ...
  public static beqn getDefaultUIUtil()
  {
    return sUICallback;
  }
  ...
  private int getMaxDragScroll(RecyclerView paramRecyclerView)
  {
    if (this.mCachedMaxScrollSpeed == -1) {
      this.mCachedMaxScrollSpeed = paramRecyclerView.getResources().getDimensionPixelSize(2131166047);
    }
  ...
  void onDraw(Canvas paramCanvas, RecyclerView paramRecyclerView, RecyclerView.ViewHolder paramViewHolder, List<beqk> paramList, int paramInt, float paramFloat1, float paramFloat2)
  {
    int j = paramList.size();
    int i = 0;
    while (i < j)
    {
      beqk localbeqk = (beqk)paramList.get(i);
      localbeqk.c();
      int k = paramCanvas.save();
      onChildDraw(paramCanvas, paramRecyclerView, localbeqk.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder, localbeqk.e, localbeqk.f, localbeqk.jdField_b_of_type_Int, false);
  ...
  void onDrawOver(Canvas paramCanvas, RecyclerView paramRecyclerView, RecyclerView.ViewHolder paramViewHolder, List<beqk> paramList, int paramInt, float paramFloat1, float paramFloat2)
  {
    int j = paramList.size();
    int i = 0;
    while (i < j)
    {
      beqk localbeqk = (beqk)paramList.get(i);
      int k = paramCanvas.save();
      onChildDrawOver(paramCanvas, paramRecyclerView, localbeqk.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder, localbeqk.e, localbeqk.f, localbeqk.jdField_b_of_type_Int, false);
      paramCanvas.restoreToCount(k);
      i += 1;
    }
    if (paramViewHolder != null)
    ...
    if (i >= 0)
    {
      paramCanvas = (beqk)paramList.get(i);
  ...
  public void onMoved(RecyclerView paramRecyclerView, RecyclerView.ViewHolder paramViewHolder1, int paramInt1, RecyclerView.ViewHolder paramViewHolder2, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if ((localLayoutManager instanceof beqm)) {
      ((beqm)localLayoutManager).a(paramViewHolder1.itemView, paramViewHolder2.itemView, paramInt3, paramInt4);
    }
    do
    {
      do
