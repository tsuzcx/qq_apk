  ...
  implements TroopHomeworkHelper.UploadCallback
{
  ...
  public aiwd(ImageInfo.UploadMediaSegment paramUploadMediaSegment)
  {
  ...
  public void a(int paramInt)
  {
    ...
    ThreadManager.getUIHandler().post(new aiwf(this, paramInt));
  }
  ...
  public void a(String paramString)
  {
    ...
    while (!this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkXmediaeditorModelImageInfo$UploadMediaSegment.isCanceled())
    {
      ...
      ThreadManager.getUIHandler().post(new aiwe(this, localVideoInfo));
      continue;
