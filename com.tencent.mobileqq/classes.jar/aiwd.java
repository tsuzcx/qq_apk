...
{
  public aiwd(ShortVideoForwardProcessor paramShortVideoForwardProcessor, long paramLong, String paramString) {}
  ...
  public void onFailed(int paramInt, byte[] paramArrayOfByte, HashMap paramHashMap)
  {
    ...
    ThreadManager.post(new aiwf(this, l2, l3, l4, l5), 5, null, true);
  ...
  public void onSuccess(byte[] paramArrayOfByte, HashMap paramHashMap)
  {
    ...
    try
    {
      ...
      ThreadManager.post(new aiwe(this, l2, l3, l4, l5), 5, null, true);
  ...
  public void onSwitch2BackupChannel()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoForwardProcessor.ap_();
  }
