  ...
  extends alko
{
  ...
  public asiv(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
  }
  
  private asik a(GameUserInfo paramGameUserInfo)
  {
    if (paramGameUserInfo == null) {
      return null;
    }
    asil localasil = (asil)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(358);
    if (GameUserInfo.isUsrInfoUpdate(localasil.a(paramGameUserInfo.mRoleId), paramGameUserInfo))
    {
      QLog.i(b, 1, "[notifyGameUsrInfoChanged], roleId:" + paramGameUserInfo.mRoleId);
      return asik.a(localasil.a(paramGameUserInfo.mAppId), paramGameUserInfo);
    }
    return null;
  }
      ...
      try
      {
        if (paramFromServiceMsg.isSuccess())
        {
          ...
          if (paramIntent != null)
          {
            ...
            ((asil)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(358)).c(paramFromServiceMsg);
          }
        }
      }
  ...
  private void c(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      paramIntent = (asil)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(358);
  ...
  public void a()
  {
    ...
    try
    {
      ...
      localObject = new NewIntent(this.app.getApp(), asix.class);
  ...
  public void a(ArrayList<String> paramArrayList)
  {
    ...
    paramArrayList = new NewIntent(this.app.getApp(), asix.class);
