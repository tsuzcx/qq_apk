  ...
  extends bcvs
{
  ...
  protected bcvt(Collection<bcvs> paramCollection)
  {
    this.jdField_a_of_type_JavaLangString = "item";
  ...
  public void a(View paramView)
  {
    ...
    default: 
      return;
    case 0: 
      paramView.setBackgroundResource(2130838302);
      return;
    case 1: 
      paramView.setBackgroundResource(2130838303);
      return;
    case 2: 
      paramView.setBackgroundResource(2130838301);
      return;
    }
  ...
  {
    if (((parambcvs instanceof bcvu)) && (!b())) {
      ((bcvu)parambcvs).aa = null;
    }
  ...
  public void a(AbsShareMsg paramAbsShareMsg)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (localIterator.hasNext()) {
      ((bcvs)localIterator.next()).a(paramAbsShareMsg);
    }
  }
  ...
  public void a(ObjectInput paramObjectInput)
  {
    ...
    String str;
    Object localObject;
    if ((this.jdField_a_of_type_Int > 0) && (this.jdField_a_of_type_Int <= 17))
    {
      ...
      if ((2 <= this.jdField_a_of_type_Int) && (this.jdField_a_of_type_Int <= 17)) {
    ...
    for (;;)
    {
      label182:
      str = b();
      if ((str != null) && (localObject != null) && ((localObject instanceof bcxv)))
      {
        if ((!str.endsWith("Layout4")) && (!str.endsWith("Layout2")) && (!str.endsWith("Layout9"))) {
          break label350;
        }
        ((bcxv)localObject).t = bcxv.jdField_q_of_type_Int;
      }
      int j;
      for (;;)
      {
        ...
        k += 1;
        break;
        localObject = bcwc.a(str);
        j = i;
        if ("button".equals(str))
        {
          ((bcvs)localObject).Y = String.valueOf(i);
          ((bcvs)localObject).Z = this.Z;
          j = i + 1;
        }
        if ((localObject == null) || (!bcvt.class.isInstance(localObject))) {
          break label1012;
        }
        ...
        if (str.endsWith("Layout3")) {
          ((bcxv)localObject).t = bcxv.jdField_r_of_type_Int;
        }
      }
      if ((this.jdField_a_of_type_Int >= 3) && (this.jdField_a_of_type_Int <= 17))
      {
  ...
  public void a(ObjectOutput paramObjectOutput)
  {
    ...
    label1319:
    label1583:
    for (localObject = "";; localObject = this.W)
    {
      paramObjectOutput.writeUTF((String)localObject);
      return;
      label1255:
  ...
  public void a(String paramString1, String paramString2, int paramInt, String paramString3)
  {
    ...
    a(new bcxv(paramString1, paramString3));
  ...
  {
    this.jdField_o_of_type_Int = paramInt;
    a(new bcxv(paramString1, paramString4));
    a(new StructMsgItemTitle(paramString2));
    a(new bdaq(paramString3));
  }
  ...
  public void a(XmlSerializer paramXmlSerializer)
  {
    ...
    for (Object localObject = "0";; localObject = String.valueOf(this.jdField_r_of_type_Int))
    {
      ...
      localObject = this.jdField_a_of_type_JavaUtilArrayList.iterator();
      while (((Iterator)localObject).hasNext()) {
        ((bcvs)((Iterator)localObject).next()).a(paramXmlSerializer);
      }
    }
  ...
  public boolean a(bcxj parambcxj)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_d_of_type_JavaLangString = parambcxj.a("actionData");
      this.jdField_e_of_type_JavaLangString = parambcxj.a("a_actionData");
      this.jdField_f_of_type_JavaLangString = parambcxj.a("i_actionData");
      this.b = parambcxj.a("url");
      this.jdField_g_of_type_JavaLangString = parambcxj.a("brief");
      this.jdField_q_of_type_JavaLangString = parambcxj.a("apurl");
      Object localObject1 = parambcxj.a("flag");
      if (!TextUtils.isEmpty((CharSequence)localObject1)) {}
      try
      {
        this.jdField_m_of_type_Int = Integer.parseInt((String)localObject1);
        localObject1 = parambcxj.a("mode");
        if (TextUtils.isEmpty((CharSequence)localObject1)) {}
      }
      catch (NumberFormatException localNumberFormatException11)
      {
        ...
        catch (NumberFormatException localNumberFormatException11)
        {
          try
          {
            ...
            {
              this.jdField_h_of_type_JavaLangString = parambcxj.a("businessData");
              this.jdField_i_of_type_JavaLangString = parambcxj.a("commonData");
              this.jdField_j_of_type_JavaLangString = parambcxj.a("index");
              this.jdField_k_of_type_JavaLangString = parambcxj.a("index_name");
              this.jdField_l_of_type_JavaLangString = parambcxj.a("index_type");
              this.jdField_o_of_type_JavaLangString = parambcxj.a("canvas");
              this.jdField_m_of_type_JavaLangString = parambcxj.a("rurl");
              this.jdField_p_of_type_JavaLangString = parambcxj.a("disType");
              this.n = parambcxj.a("tid");
              if (this.jdField_a_of_type_Int > 10)
              {
                localObject1 = parambcxj.a;
                if (localObject1 != null)
                {
                  localObject3 = ((bcxj)localObject1).a("action_type");
          ...
          catch (IllegalArgumentException localNumberFormatException11)
          {
            try
            {
              ...
              localObject3 = ((bcxj)localObject1).a("dest_type");
              if (TextUtils.isEmpty((CharSequence)localObject3)) {}
            }
            catch (NumberFormatException localNumberFormatException11)
            {
              try
              {
                ...
                localObject3 = ((bcxj)localObject1).a("product_type");
                if (TextUtils.isEmpty((CharSequence)localObject3)) {}
              }
              catch (NumberFormatException localNumberFormatException11)
              {
                try
                {
                  ...
                  this.jdField_r_of_type_JavaLangString = ((bcxj)localObject1).a("advertiser_id");
                  this.s = ((bcxj)localObject1).a("aid");
                  this.t = ((bcxj)localObject1).a("app_download_schema");
                  this.u = ((bcxj)localObject1).a("canvas_json");
                  this.v = ((bcxj)localObject1).a("customized_invoke_url");
                  this.w = ((bcxj)localObject1).a("effect_url");
                  this.x = ((bcxj)localObject1).a("landing_page");
                  this.y = ((bcxj)localObject1).a("landing_page_report_url");
                  this.z = ((bcxj)localObject1).a("noco_id");
                  this.A = ((bcxj)localObject1).a("product_id");
                  this.B = ((bcxj)localObject1).a("rl");
                  this.C = ((bcxj)localObject1).a("subordinate_product_id");
                  this.D = ((bcxj)localObject1).a("traceid");
                  this.E = ((bcxj)localObject1).a("via");
                  this.F = ((bcxj)localObject1).a("video_url");
                  this.G = ((bcxj)localObject1).a("appname");
                  this.H = ((bcxj)localObject1).a("customized_invoke_url");
                  this.I = ((bcxj)localObject1).a("pkg_name");
                  this.J = ((bcxj)localObject1).a("pkgurl");
                  this.jdField_q_of_type_JavaLangString = ((bcxj)localObject1).a("apurl");
                  if (this.jdField_a_of_type_Int > 11)
                  {
                    localObject1 = parambcxj.a;
                    if (localObject1 != null)
                    {
                      this.K = ((bcxj)localObject1).a("api_click_monitor_url");
                      this.L = ((bcxj)localObject1).a("api_exposure_monitor_url");
                      this.M = ((bcxj)localObject1).a("trace_info_aid");
                    }
                  }
                  if (this.jdField_a_of_type_Int > 12)
                  {
                    ...
                    if (localObject1 != null)
                    {
                      this.N = ((bcxj)localObject1).a("corporate_image_name");
                      this.O = ((bcxj)localObject1).a("corporate_logo");
                    }
                  }
                  if (this.jdField_a_of_type_Int > 13)
                  {
                    localObject1 = parambcxj.a.a("mini_program_type");
                    if (TextUtils.isEmpty((CharSequence)localObject1)) {}
                  }
                }
                catch (NumberFormatException localNumberFormatException11)
                {
                  try
                  {
                    ...
                    if (this.jdField_a_of_type_Int > 14)
                    {
                      ...
                      if (localObject1 != null)
                      {
                        localObject3 = ((bcxj)localObject1).a("tab_id");
                  ...
                  catch (NumberFormatException localNumberFormatException11)
                  {
                    try
                    {
                      ...
                      localObject1 = ((bcxj)localObject1).a("is_hidden");
                    ...
                    catch (NumberFormatException localNumberFormatException11)
                    {
                      try
                      {
                        ...
                        {
                          localObject1 = parambcxj.a;
                          this.P = ((bcxj)localObject1).a("negative_feedback_url");
                          this.Q = ((bcxj)localObject1).a("sdk_exposure_monitor_url");
                          this.R = ((bcxj)localObject1).a("sdk_click_monitor_url");
                          localObject3 = ((bcxj)localObject1).a("media_duration");
                          if (bgsp.a((String)localObject3)) {}
                        }
                      }
                      catch (NumberFormatException localNumberFormatException11)
                      {
                        try
                        {
                          ...
                          localObject3 = ((bcxj)localObject1).a("video_file_size");
                          if (bgsp.a((String)localObject3)) {}
                        }
                        catch (NumberFormatException localNumberFormatException11)
                        {
                          try
                          {
                            ...
                            localObject3 = ((bcxj)localObject1).a("app_score_num");
                            if (bgsp.a((String)localObject3)) {}
                          }
                          catch (NumberFormatException localNumberFormatException11)
                          {
                            try
                            {
                              ...
                              localObject3 = ((bcxj)localObject1).a("download_num");
                              if (bgsp.a((String)localObject3)) {}
                            }
                            catch (NumberFormatException localNumberFormatException11)
                            {
                              try
                              {
                                for (;;)
                                {
                                  ...
                                  this.S = ((bcxj)localObject1).a("universal_link");
                                  this.T = ((bcxj)localObject1).a("sdk_data");
                                  this.U = ((bcxj)localObject1).a("tencent_video_id");
                                  this.V = ((bcxj)localObject1).a("view_id");
                                  if (this.jdField_a_of_type_Int > 16) {
                                    this.W = parambcxj.a.a("qgg_ext");
                                  }
                                  int k = parambcxj.a();
                                  int i = 0;
                                  for (;;)
                              ...
                              catch (NumberFormatException localNumberFormatException12)
                              {
                                ...
                                for (Object localObject2 = localNumberFormatException12.a("layout");; localObject2 = bcwc.a(localNumberFormatException12.b))
                                {
                                  try
                                  {
                                    ...
                                    {
                                      localObject2 = bcwc.a(j);
                                      bool1 = bool2;
                                      if (localObject2 == null) {
                                        break;
                                      }
                                      bool1 = bool2;
                                      if (!((bcvs)localObject2).a(localNumberFormatException12)) {
                                        break;
                                      }
                                      a((bcvs)localObject2);
                                      break label1087;
  ...
  public void b(View paramView)
  {
    if (!TextUtils.isEmpty(this.b))
    {
      ...
      default: 
        ...
        localObject = paramView.findViewById(2131368420);
    ...
    do
    {
      ...
      paramView.setBackgroundResource(2130838300);
      break;
      paramView = paramView.findViewById(2131377935);
  ...
  public void c(View paramView)
  {
    ...
    for (;;)
    {
      ...
      continue;
      paramView.setBackgroundResource(2130838317);
      continue;
  ...
  protected void d(View paramView)
  {
    ...
    do
    {
      do
      {
        ...
        if (!TextUtils.isEmpty(this.b))
        {
          this.jdField_q_of_type_Int = 2130838304;
          break;
        }
        this.jdField_q_of_type_Int = 2130838318;
        break;
        if (!TextUtils.isEmpty(this.b))
        {
          this.jdField_q_of_type_Int = 2130838305;
          break;
        }
        this.jdField_q_of_type_Int = 2130838319;
        break;
        paramView.setBackgroundResource(2130838303);
        return;
      ...
      float f3 = i;
      float f4 = i;
      localStateListDrawable = bcxm.a(paramView.getResources(), this.jdField_p_of_type_Int, new float[] { f1, f2, f3, f4, 0.0F, 0.0F, 0.0F, 0.0F });
