  ...
  implements AladdinConfigHandler
{
  ...
  public static int a()
  {
    String[] arrayOfString = ((String)bmqa.a("readinjoy_comment_guide_show_num_one_day", "0_0")).split("_");
  ...
  public static TemplateBean a(VafContext paramVafContext)
  {
    ...
    {
      teh localteh = teh.a("comment_feeds", true);
      paramVafContext = localteh;
      if (localteh == null) {
        return null;
      }
    }
    ...
    {
      paramVafContext = (teh)paramVafContext.getTemplateFactory();
    }
    if (paramVafContext != null) {}
    for (;;)
    {
  ...
  {
    String str = (String)bmqa.a("readinjoy_comment_guide_wording", anni.a(2131700986));
  ...
  {
    String str2 = (String)bmqa.a("readinjoy_comment_guide_base_jump_url", "");
    ...
    do
    {
      ...
      str3 = (String)bkgj.a(str2).get("appSchema");
      str1 = str2;
    ...
    try
    {
      ...
      paramString = bkgj.a(bkgj.a(str2, "appSchema"), "appSchema", paramString);
  ...
  public static JSONObject a()
  {
    ...
    try
    {
      ...
      localJSONObject.put("guide_image", bmqa.a("readinjoy_comment_guide_image_url", "readinjoy_comment_guide_big_bg"));
      localJSONObject.put("guide_wording", a());
      localJSONObject.put("jump_button_text", anni.a(2131700985));
  ...
  public static void a(int paramInt)
  {
    ...
    bmqa.a("readinjoy_comment_guide_show_num_one_day", str + "_" + paramInt);
  }
  
  public static boolean a()
  {
    if (((Integer)bmqa.a("readinjoy_comment_guide_pic_button_should_show", Integer.valueOf(-1))).intValue() == 1) {}
  ...
  {
    boolean bool1;
    if (((Integer)bmqa.a("readinjoy_comment_guide_should_show", Integer.valueOf(-1))).intValue() == 1)
    {
      bool1 = true;
      bool2 = bool1;
      if (bool1)
      {
        int i = ((Integer)bmqa.a("readinjoy_comment_guide_max_show_count", Integer.valueOf(3))).intValue();
        int j = a();
  ...
  public boolean onReceiveConfig(int paramInt1, int paramInt2, String paramString)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (TextUtils.equals(str1, "should_show")) {
        bmqa.a("readinjoy_comment_guide_should_show", Integer.valueOf(Integer.valueOf(str2).intValue()));
      } else if (TextUtils.equals(str1, "wording")) {
        bmqa.a("readinjoy_comment_guide_wording", str2);
      } else if (TextUtils.equals(str1, "image_url")) {
        bmqa.a("readinjoy_comment_guide_image_url", str2);
      } else if (TextUtils.equals(str1, "base_jump_url")) {
        bmqa.a("readinjoy_comment_guide_base_jump_url", str2);
      } else if (TextUtils.equals(str1, "max_show_count")) {
        bmqa.a("readinjoy_comment_guide_max_show_count", Integer.valueOf(Integer.valueOf(str2).intValue()));
      } else if (TextUtils.equals(str1, "pic_button_should_show")) {
        bmqa.a("readinjoy_comment_guide_pic_button_should_show", Integer.valueOf(Integer.valueOf(str2).intValue()));
      }
    }
    return true;
  }
  ...
  public void onWipeConfig(int paramInt)
  {
    ...
    bmqa.a("readinjoy_comment_guide_should_show", Integer.valueOf(0));
  }
}
