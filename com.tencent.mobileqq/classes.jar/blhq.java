  ...
  implements RecyclerView.OnChildAttachStateChangeListener
{
  ...
  public blhu mCallback;
  private RecyclerView.ChildDrawingOrderCallback mChildDrawingOrderCallback;
  private List<Integer> mDistances;
  private long mDragScrollStartTimeInMs;
  float mDx;
  float mDy;
  blhl mGestureDetector;
  float mInitialTouchX;
  float mInitialTouchY;
  float mMaxSwipeVelocity;
  private final RecyclerView.OnItemTouchListener mOnItemTouchListener = new blhr(this);
  View mOverdrawChild = null;
  int mOverdrawChildPosition = -1;
  final List<View> mPendingCleanup = new ArrayList();
  List<blhy> mRecoverAnimations = new ArrayList();
  ...
  public blhq(blhu paramblhu)
  {
    this.mCallback = paramblhu;
  }
  ...
  private void addChildDrawingOrderCallback()
  {
    ...
    if (this.mChildDrawingOrderCallback == null) {
      this.mChildDrawingOrderCallback = new blht(this);
    }
  ...
  private void destroyCallbacks()
  {
    ...
    while (i >= 0)
    {
      blhy localblhy = (blhy)this.mRecoverAnimations.get(0);
      this.mCallback.clearView(this.mRecyclerView, localblhy.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder);
      i -= 1;
    }
  ...
  private void initGestureDetector()
  {
    ...
    this.mGestureDetector = new blhl(this.mRecyclerView.getContext(), new blhx(this));
  }
  ...
  private int swipeIfNecessary(RecyclerView.ViewHolder paramViewHolder)
  {
    ...
    do
    {
      do
      {
        ...
        {
          if ((j & k) == 0) {
            return blhu.convertToRelativeDirection(k, ViewCompat.getLayoutDirection(this.mRecyclerView));
          }
          return k;
        }
    ...
    if ((j & i) == 0) {
      return blhu.convertToRelativeDirection(i, ViewCompat.getLayoutDirection(this.mRecyclerView));
    }
    return i;
  }
  ...
  int endRecoverAnimation(RecyclerView.ViewHolder paramViewHolder, boolean paramBoolean)
  {
    ...
    while (i >= 0)
    {
      blhy localblhy = (blhy)this.mRecoverAnimations.get(i);
      if (localblhy.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder == paramViewHolder)
      {
        localblhy.jdField_b_of_type_Boolean |= paramBoolean;
        if (!localblhy.jdField_c_of_type_Boolean) {
          localblhy.b();
        }
        this.mRecoverAnimations.remove(i);
        return localblhy.jdField_c_of_type_Int;
      }
      i -= 1;
    }
    return 0;
  ...
  blhy findAnimation(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      blhy localblhy = (blhy)this.mRecoverAnimations.get(i);
      paramMotionEvent = localblhy;
      if (localblhy.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder.itemView == localView) {
        break;
      }
      i -= 1;
    }
  ...
  View findChildView(MotionEvent paramMotionEvent)
  {
    ...
    while (i >= 0)
    {
      paramMotionEvent = (blhy)this.mRecoverAnimations.get(i);
  ...
  public boolean hasRunningRecoverAnim()
  {
    ...
    while (i < j)
    {
      if (!((blhy)this.mRecoverAnimations.get(i)).jdField_c_of_type_Boolean) {
        return true;
      }
      i += 1;
    }
  ...
  void postDispatchSwipe(blhy paramblhy, int paramInt)
  {
    this.mRecyclerView.post(new ItemTouchHelper.4(this, paramblhy, paramInt));
  }
    ...
    else
    {
      ...
      default: 
        ...
        if (k == 2)
        {
          ...
          localObject = new blhs(this, (RecyclerView.ViewHolder)localObject, i, k, f3, f4, f1, f2, j, (RecyclerView.ViewHolder)localObject);
          ((blhy)localObject).a(this.mCallback.getAnimationDuration(this.mRecyclerView, i, f1 - f3, f2 - f4));
