...
public class wcl
{
  ...
  public String b;
  private List<wcm> jdField_b_of_type_JavaUtilList = new ArrayList();
  public int c;
  private long c;
  public String c;
  public int d;
  ...
  public wcl(int paramInt, List<wcm> paramList)
  {
    this.jdField_a_of_type_Long = -1L;
    this.jdField_c_of_type_Int = 6;
    this.jdField_d_of_type_Int = 0;
    if ((paramList == null) || (paramList.isEmpty())) {
      zkb.a("It not allowed to new the story album by null picList", new Object[0]);
    }
    for (;;)
    {
      this.jdField_a_of_type_Int = paramInt;
  ...
  public static wcl a(int paramInt)
  {
    wcl localwcl = new wcl(-1);
    localwcl.jdField_d_of_type_Int = paramInt;
    return localwcl;
  }
  
  public static wcl a(StoryAlbumEntry paramStoryAlbumEntry)
  {
    wcl localwcl = new wcl(paramStoryAlbumEntry.albumType);
    localwcl.jdField_b_of_type_Long = paramStoryAlbumEntry.startTime;
    localwcl.jdField_c_of_type_Long = paramStoryAlbumEntry.endTime;
    localwcl.jdField_b_of_type_JavaLangString = paramStoryAlbumEntry.albumName;
    localwcl.jdField_a_of_type_JavaLangString = paramStoryAlbumEntry.transId;
    localwcl.jdField_b_of_type_Int = paramStoryAlbumEntry.textId;
    localwcl.jdField_c_of_type_JavaLangString = paramStoryAlbumEntry.albumDesc;
    localwcl.jdField_d_of_type_JavaLangString = paramStoryAlbumEntry.geoHashStr;
    localwcl.f = paramStoryAlbumEntry.state;
    localwcl.jdField_c_of_type_Int = paramStoryAlbumEntry.minCount;
    localwcl.e = paramStoryAlbumEntry.debugInfo;
    localwcl.jdField_a_of_type_Long = paramStoryAlbumEntry.getId();
    localwcl.a(paramStoryAlbumEntry.extraInfo);
    return localwcl;
  }
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    while (i < paramArrayOfByte.size())
    {
      ...
      localwcm.a((SerializationPB.PicInfo)paramArrayOfByte.get(i));
      ((List)localObject).add(localwcm);
      i += 1;
    }
  ...
  {
    return TextUtils.equals(paramString1.substring(0, paramString1.indexOf(anni.a(2131713092))), paramString2.substring(0, paramString2.indexOf(anni.a(2131713089))));
  }
  ...
  private byte[] a()
  {
    ...
    if ((this.jdField_b_of_type_JavaUtilList != null) && (this.jdField_b_of_type_JavaUtilList.size() > 0))
    {
      ...
      {
        localArrayList.add(((wcm)this.jdField_b_of_type_JavaUtilList.get(i)).a());
        i += 1;
      }
  ...
  public String a()
  {
    ...
    long l1 = ((wcm)this.jdField_b_of_type_JavaUtilList.get(0)).jdField_b_of_type_Long;
    long l2 = ((wcm)this.jdField_b_of_type_JavaUtilList.get(this.jdField_b_of_type_JavaUtilList.size() - 1)).jdField_b_of_type_Long;
    ...
    boolean bool = zkk.a(l1 * 1000L);
    if (bool) {}
    for (localObject1 = str1.substring(str1.indexOf(anni.a(2131713086)) + 1);; localObject1 = str1)
    {
      ...
      if (!TextUtils.equals(str1.substring(0, str1.indexOf(anni.a(2131713088))), str2.substring(0, str2.indexOf(anni.a(2131713091))))) {
        break label273;
      }
      return (String)localObject1 + "-" + str2.substring(str2.indexOf(anni.a(2131713087)) + 1);
    }
    label273:
    return (String)localObject1 + "-" + str2.substring(str2.indexOf(anni.a(2131713090)) + 1);
    label316:
  ...
  {
    yqp.d("Q.qqstory.recommendAlbum.logic.StoryAlbum", "setState:" + paramInt);
    this.f = paramInt;
  }
  ...
  public void a(List<wcm> paramList)
  {
    ...
    this.jdField_b_of_type_JavaUtilList.addAll(paramList);
    wca.b(this.jdField_b_of_type_JavaUtilList);
  }
  
  public void a(wcl paramwcl)
  {
    a(paramwcl.b(), paramwcl.c());
    if (!TextUtils.isEmpty(paramwcl.jdField_d_of_type_JavaLangString)) {
      this.jdField_d_of_type_JavaLangString = paramwcl.jdField_d_of_type_JavaLangString;
    }
    if (paramwcl.jdField_a_of_type_JavaUtilList != null) {
      this.jdField_a_of_type_JavaUtilList = paramwcl.jdField_a_of_type_JavaUtilList;
    }
  }
  
  public void a(wcz paramwcz)
  {
    this.e = paramwcz.toString();
  }
  ...
  public void a(wdi paramwdi)
  {
    ...
    if (paramwdi != null)
    {
      if ((paramwdi.jdField_a_of_type_JavaUtilList == null) || (paramwdi.jdField_a_of_type_JavaUtilList.size() <= 0)) {
        break label85;
      }
      i = new Random().nextInt(paramwdi.jdField_a_of_type_JavaUtilList.size());
    }
    label85:
    for (this.jdField_a_of_type_JavaLangString = ((String)paramwdi.jdField_a_of_type_JavaUtilList.get(i));; this.jdField_a_of_type_JavaLangString = paramwdi.jdField_b_of_type_JavaLangString)
    {
      this.jdField_c_of_type_JavaLangString = paramwdi.jdField_a_of_type_JavaLangString;
      this.jdField_c_of_type_Int = paramwdi.jdField_b_of_type_Int;
      this.jdField_b_of_type_Int = paramwdi.jdField_c_of_type_Int;
      return;
    }
  }
  ...
  {
    zkb.a(paramwcl);
    yqp.a("Q.qqstory.recommendAlbum.logic.StoryAlbum", "%s merge album %s", this, paramwcl);
    this.f = 0;
    paramwcl = paramwcl.jdField_b_of_type_JavaUtilList.iterator();
    while (paramwcl.hasNext())
    {
      wcm localwcm = (wcm)paramwcl.next();
      if (!this.jdField_b_of_type_JavaUtilList.contains(localwcm)) {
        this.jdField_b_of_type_JavaUtilList.add(localwcm);
      }
    }
    wca.b(this.jdField_b_of_type_JavaUtilList);
  }
  ...
  public boolean c()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (new File(localwcm.jdField_a_of_type_JavaLangString).exists()) {
  ...
  public long d()
  {
    ...
    return ((wcm)this.jdField_b_of_type_JavaUtilList.get(0)).jdField_b_of_type_Long;
  }
  ...
  public long e()
  {
    ...
    return ((wcm)this.jdField_b_of_type_JavaUtilList.get(this.jdField_b_of_type_JavaUtilList.size() - 1)).d;
  }
  
  public boolean equals(Object paramObject)
  {
    boolean bool = true;
    if ((paramObject instanceof wcl))
    {
      if ((a()) && (((wcl)paramObject).a())) {
        return this.jdField_d_of_type_Int == ((wcl)paramObject).jdField_d_of_type_Int;
      }
      if (this.jdField_a_of_type_Long == ((wcl)paramObject).jdField_a_of_type_Long) {}
      for (;;)
      {
        return bool;
        bool = false;
  ...
  public long g()
  {
    ...
    return ((wcm)this.jdField_b_of_type_JavaUtilList.get(this.jdField_b_of_type_JavaUtilList.size() - 1)).jdField_b_of_type_Long;
  }
