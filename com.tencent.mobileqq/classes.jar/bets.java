...
public class bets
  extends betp
  implements SeekBar.OnSeekBarChangeListener, betd, IVideoOuterStatusListener
{
  ...
  public bets(Context paramContext)
  {
    super(paramContext);
  }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        if (this.jdField_e_of_type_AndroidWidgetImageView != null)
        {
          ...
          if (paramBoolean)
          {
            ...
            this.jdField_e_of_type_AndroidWidgetImageView.setImageResource(2130837943);
        ...
        for (;;)
        {
          ...
          this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundColor(localResources.getColor(2131166854));
          return;
          ((ViewGroup.LayoutParams)localObject).width = -1;
          ((ViewGroup.LayoutParams)localObject).height = -1;
          this.jdField_e_of_type_AndroidWidgetImageView.setImageResource(2130845721);
          break label64;
          m = 40;
          k = 16;
          if (localResources == null) {
          ...
          m = aekt.a(20.0F, localResources);
          k = aekt.a(8.0F, localResources);
          break label118;
      ...
      {
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130845722);
        return;
      }
    } while (localResources == null);
    label235:
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundColor(localResources.getColor(2131167138));
    label265:
    label275:
    label277:
    return;
  ...
  private void b()
  {
    ...
    do
    {
      ...
      {
        if ((this.jdField_a_of_type_Betn == null) || (!this.jdField_a_of_type_Betn.a(this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer.a(), this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer.b())))
        {
  ...
  private void c(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166854));
    }
    if (this.jdField_f_of_type_AndroidWidgetImageView != null)
    {
      if (!a(paramInt)) {
      ...
      this.jdField_f_of_type_AndroidWidgetImageView.setImageResource(2130845720);
    ...
    for (;;)
    {
      if (this.jdField_c_of_type_AndroidWidgetTextView != null)
      {
        ...
        this.jdField_c_of_type_AndroidWidgetTextView.setText(2131699994);
      }
      return;
      label138:
    ...
    if (paramInt == 401)
    {
      this.jdField_c_of_type_AndroidWidgetTextView.setText(2131699995);
      return;
    }
    if (paramInt == 402)
    {
      this.jdField_c_of_type_AndroidWidgetTextView.setText(2131699997);
      return;
    }
    if (paramInt == 403)
    {
      this.jdField_c_of_type_AndroidWidgetTextView.setText(2131699996);
      return;
    }
    this.jdField_c_of_type_AndroidWidgetTextView.setText(2131699995);
  }
  ...
  private void c(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      return;
      label97:
      aqcn.a(this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer, this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130845715));
    }
  }
  ...
  private void d(int paramInt)
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null)
      {
        ...
        this.jdField_a_of_type_AndroidAnimationObjectAnimator.addUpdateListener(new betu(this, f2, f1));
        this.jdField_a_of_type_AndroidAnimationObjectAnimator.addListener(new betv(this, paramInt));
  ...
  private void h()
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer.b())
      {
        ...
        {
          this.jdField_a_of_type_AndroidWidgetRelativeLayout.setContentDescription(alpo.a(2131705010));
          return;
        }
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.setContentDescription(alpo.a(2131705011));
        return;
      }
      if (this.jdField_f_of_type_Int == 0)
      {
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.setContentDescription(alpo.a(2131705014));
        return;
      }
    } while (this.jdField_f_of_type_Int != 1);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setContentDescription(alpo.a(2131705008));
  }
  ...
  public void a(Context paramContext)
  {
    ...
    this.jdField_b_of_type_AndroidWidgetFrameLayout.setId(2131373613);
    this.jdField_b_of_type_AndroidWidgetImageView = new ImageView(this.jdField_a_of_type_AndroidContentContext);
    this.jdField_b_of_type_AndroidWidgetImageView.setId(2131373599);
    this.jdField_b_of_type_AndroidWidgetImageView.setScaleType(ImageView.ScaleType.FIT_XY);
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373603));
    this.jdField_c_of_type_AndroidWidgetImageView.setContentDescription(alpo.a(2131705016));
    this.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373602));
    this.jdField_d_of_type_AndroidWidgetImageView.setContentDescription(alpo.a(2131705012));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373609));
    this.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(alpo.a(2131705013));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373608));
    this.jdField_b_of_type_AndroidWidgetTextView.setContentDescription(alpo.a(2131705009));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373606));
    this.jdField_e_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373604));
    this.jdField_e_of_type_AndroidWidgetImageView.setContentDescription(alpo.a(2131705015));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373610));
    this.jdField_f_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373605));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373612));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373611));
    ...
    this.jdField_a_of_type_AndroidWidgetSeekBar = ((SeekBar)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373615));
    this.jdField_a_of_type_AndroidWidgetSeekBar.setOnSeekBarChangeListener(this);
    this.jdField_a_of_type_AndroidWidgetSeekBar.setThumb(paramContext.getResources().getDrawable(2130849128));
    this.jdField_a_of_type_AndroidWidgetSeekBar.setProgressDrawable(paramContext.getResources().getDrawable(2130845551));
  ...
  {
    this.jdField_a_of_type_Betm = parambetm;
  }
  ...
  public void d()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenStatusReceiver == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenStatusReceiver.a(0, new bett(this));
    }
  }
  ...
  public void onVideoStart(int paramInt)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        return;
        if ((this.jdField_a_of_type_AndroidContentContext != null) && (this.jdField_a_of_type_AndroidContentContext.getResources() != null)) {
          this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167138));
        }
      }
