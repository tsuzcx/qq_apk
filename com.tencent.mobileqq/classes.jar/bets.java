...
{
  public bets(TribeVideoPreviewFragment paramTribeVideoPreviewFragment, String paramString) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoPreviewFragment.getActivity().app, "dc00899", "Grp_tribe", "", "post", "save_video", 0, 0, "", "", "", "");
      EventCollector.getInstance().onViewClicked(paramView);
      return;
      localFragmentActivity.requestPermissions(new bett(this), 1, new String[] { "android.permission.WRITE_EXTERNAL_STORAGE" });
    }
  }
}
