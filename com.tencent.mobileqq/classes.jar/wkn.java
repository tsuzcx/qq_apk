...
public class wkn
  extends woz<CertifiedAccountMeta.StFollowRcmd>
{
  public static int a;
  ...
  private View a(ViewGroup paramViewGroup)
  {
    ...
    URLImageView localURLImageView = (URLImageView)paramViewGroup.findViewById(2131368671);
    ...
    if (this.e)
    {
      ...
      ((TextView)paramViewGroup.findViewById(2131378435)).setTextColor(-10132123);
      paramViewGroup.findViewById(2131365275).setBackgroundColor(-14540254);
  ...
  {
    xhb.b("auth_follow", "exp_more", 0, 0, new String[0]);
    paramViewGroup = LayoutInflater.from(a()).inflate(2131558660, paramViewGroup, false);
    LinearLayout localLinearLayout = (LinearLayout)paramViewGroup.findViewById(2131369429);
    ...
    for (int i = -13224394;; i = -460552)
    {
      ...
      localLinearLayout.setOnClickListener(new wkp(this));
      if (this.e) {
        ((TextView)paramViewGroup.findViewById(2131378434)).setTextColor(-5723992);
      }
      return paramViewGroup;
    }
  }
  ...
  protected void a(Rect paramRect, View paramView, RecyclerView paramRecyclerView, RecyclerView.State paramState)
  {
    ...
    while (paramView.getId() != 2131375509) {
      return;
    }
  ...
  public void a(wkq paramwkq)
  {
    if (a() != null)
    {
      ...
      VSNetworkHelper.a().a(localSubscribeGetFollowRcmdRequest, new wko(this, localSubscribeGetFollowRcmdRequest, paramwkq));
    }
  }
  ...
  public void onBindViewHolder(RecyclerView.ViewHolder paramViewHolder, int paramInt)
  {
    ...
    ((wkr)paramViewHolder).a(localStFollowRcmd, i);
  }
  
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    if (paramInt == 100000) {
      return new wkr(this, a(paramViewGroup));
    }
    if (paramInt == 100001) {
      return new wkr(this, b(paramViewGroup));
    }
    paramViewGroup = new BlankRecommendItemView(paramViewGroup.getContext());
    paramViewGroup.setIsInNightMode(this.e);
    return new wkr(this, paramViewGroup);
  }
