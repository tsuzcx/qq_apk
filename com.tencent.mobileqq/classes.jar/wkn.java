...
public class wkn
{
  ...
  public static <I> I a(Class<I> paramClass)
  {
    ...
    {
      ClassLoader localClassLoader = wkn.class.getClassLoader();
      wko localwko = new wko();
      return Proxy.newProxyInstance(localClassLoader, new Class[] { paramClass }, localwko);
    }
  ...
  public static <T> T a(Class<T> paramClass, Object[] paramArrayOfObject)
  {
    ...
    for (int j = 0;; j = arrayOfClass1.length)
    {
      ...
      catch (InstantiationException paramArrayOfObject)
      {
        int k;
        Class[] arrayOfClass2;
        throw new IllegalStateException(paramClass.getName() + "(" + Arrays.toString(arrayOfClass1) + anni.a(2131706448), paramArrayOfObject);
      }
      catch (IllegalAccessException paramArrayOfObject)
      {
        throw new IllegalStateException(paramClass.getName() + "(" + Arrays.toString(arrayOfClass1) + anni.a(2131706449), paramArrayOfObject);
      }
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        throw new IllegalStateException(anni.a(2131706447) + paramClass.getName() + "(" + Arrays.toString(arrayOfClass1) + anni.a(2131706450), localNoSuchMethodException);
        if (arrayOfClass2[i].isPrimitive()) {
          if (arrayOfClass1[i] == null)
          {
            i = 0;
      ...
      break label107;
      label300:
      yqp.e("NullableObjectFactoryImplement", "虽然不是直接匹配, 但是还是找到了" + paramClass.getName() + "(" + Arrays.toString(arrayOfClass1) + ")的构造函数");
      break;
      i = 1;
      break label131;
      label492:
