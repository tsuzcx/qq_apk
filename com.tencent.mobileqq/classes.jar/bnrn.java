...
public class bnrn
{
  ...
  private bnrm jdField_a_of_type_Bnrm = new bnro(this);
  ...
  public float a(int paramInt)
  {
    ...
    if ((this.b) && (this.jdField_a_of_type_Bnrl != null) && (this.jdField_a_of_type_Bnrl.jdField_a_of_type_Boolean) && (paramInt >= this.jdField_a_of_type_Int)) {
      return this.jdField_a_of_type_Bnrl.a(paramInt - this.jdField_a_of_type_Int);
    }
    return -1.0F;
  }
