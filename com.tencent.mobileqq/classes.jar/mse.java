  ...
  extends aojs
{
  ...
  {
    msj localmsj = (msj)msd.a(this.a).a(paramLong);
    if (paramBoolean)
    {
      msd.a(this.a, SystemClock.elapsedRealtime());
      paramString2 = new msl(SystemClock.elapsedRealtime(), paramInt3, paramString2, paramString3, paramString4);
      msd.a(this.a).put(paramString1, paramString2);
      if (localmsj != null)
      {
        localmsj.a(paramInt3, paramString2, paramInt5);
        msd.a(this.a).a(paramLong);
        this.a.a = paramInt4;
        if (msd.a(this.a) == null) {
          break label261;
        }
        msd.a(this.a).a(paramInt4);
        msd.a(this.a, null);
      }
    }
    for (;;)
    {
      ...
      break;
      paramString1 = (msj)msd.a(this.a).a(paramLong);
