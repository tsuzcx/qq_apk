...
public class bfms
{
  ...
  {
    PackageManager localPackageManager = bfbm.a().a().getPackageManager();
    try
    {
    ...
    {
      bflp.b("AppUtil", "getApkVersonCode>>>", paramString);
    }
    return 0;
  }
  ...
  public static Bitmap a(String paramString)
  {
    try
    {
      ...
      if ((paramString != null) && (paramString.applicationInfo != null))
      {
        ...
        if (paramString != null)
        {
          paramString = bfln.b(paramString);
          return paramString;
        }
      }
    }
  ...
  public static String a(Context paramContext, String paramString)
  {
    try
    {
      ...
      if (paramContext != null)
      {
        ...
        {
          paramContext = bflr.d(paramContext[(paramContext.length - 1)].toCharsString());
          return paramContext;
        }
      }
    }
  ...
  public static String a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramString = bfbm.a().a().getPackageManager().getPackageArchiveInfo(paramString, 1);
        if (paramString != null)
        {
      ...
      {
        bflp.c("AppUtil", "getApkName>>>", paramString);
      }
    }
    return null;
  }
    ...
    catch (Exception localException)
    {
      ...
      if (paramString1 != null)
      {
        ...
        catch (Exception paramString1)
        {
          ...
          Toast.makeText(paramContext, alud.a(2131701014), 0).show();
          return;
        }
      }
      Toast.makeText(paramContext, alud.a(2131701015), 0).show();
    }
  }
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    ...
    if (!TextUtils.isEmpty(paramString3))
    {
      ...
      bflp.c("add", ">>has add appCustom=" + paramString3);
    }
    paramString1.putExtra("platformId", "qzone_m");
    bflp.c("add", ">>has add platformid=qzone_m");
    try
    ...
    {
      Toast.makeText(paramContext, alud.a(2131701016), 0).show();
    }
  }
  ...
  public static boolean a(Context paramContext)
  {
    if (paramContext == null)
    {
      bflp.e("AppUtil", "isPackageScanAllowed context is null");
      return true;
    }
    try
    {
      boolean bool = bfbm.a().a().getSharedPreferences("package_scan", 0).getBoolean("qqsetting_package_scan_flag", true);
      return bool;
    }
    catch (Exception paramContext)
    {
    ...
    if (localIntent == null)
    {
      ...
      try
      {
        for (;;)
        {
          ...
          try
          {
            ((amcw)((BaseActivity)paramContext).app.a(23)).b(paramString.trim(), paramContext, localIntent);
            return true;
          }
          catch (Exception paramBundle)
          {
            for (;;)
            {
              try
              {
                new amcw((QQAppInterface)null).a(paramString.trim(), paramContext, localIntent);
              }
              catch (Exception paramString)
              {
      ...
      {
        Toast.makeText(paramContext, alud.a(2131701017), 0).show();
        return false;
      }
    }
  }
  ...
  public static boolean a(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    try
    {
      ...
      if (new File(paramString1).exists())
      {
        ...
        {
          bflp.b("AppUtil", "installApp>>> put source " + paramString2);
          paramString1.putExtra("big_brother_source_key", paramString2);
        }
        if (!TextUtils.isEmpty(paramString3))
        {
          bflp.b("AppUtil", "installApp>>> put ref id " + paramString3);
    ...
    {
      bflp.c("AppUtil", "installApp>>>", paramContext);
    }
    return false;
  }
  ...
  {
    return bdiv.a(bfbm.a().a(), paramString);
  }
  ...
  public static int b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        bflp.c("AppUtil", "getApkVersonCodeFromApkFile>>>", paramString);
      }
    }
    return 0;
  }
  ...
  public static String b(Context paramContext)
  {
    ...
    {
      bflp.b("AppUtil", "getCurProcessName err", paramContext);
    }
    return null;
  }
  ...
  {
    bflp.b("AppUtil", "getAppVersionCode: " + paramString);
    localObject1 = null;
    try
    {
      a(paramString);
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        bflp.e("AppUtil", "openManifest failed: " + localException.getMessage());
      }
    }
    ...
    for (;;)
    {
      ...
      {
        String str;
        bflp.e("AppUtil", "error: " + paramString.getMessage());
        localObject1.close();
        return 0;
      }
      ...
      if ((!TextUtils.isEmpty(str)) && (str.equals("manifest")))
      {
        ...
        if (i < localObject1.getAttributeCount())
        {
          if (localObject1.getAttributeName(i).equals("versionCode"))
          {
            ...
            localObject1.close();
            bflp.b("AppUtil", "apkPath:" + paramString + ",versionCode:" + str);
