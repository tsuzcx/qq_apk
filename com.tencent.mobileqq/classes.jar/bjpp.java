...
public class bjpp
{
  ...
  {
    boolean bool = true;
    jdField_a_of_type_JavaLangString = bjpp.class.getSimpleName();
  ...
  public static boolean b()
  {
    ...
    QzoneModuleManager.getInstance().downloadModule("animatedWebp.so", new bjpq());
    return false;
  }
  ...
  {
    String str = bfjp.a().getString("PREFERENCE_SO_MD5_KEY", null);
    if (TextUtils.isEmpty(str)) {}
