...
public class arpx
  extends azip
{
  public arpx(ContactSyncManager paramContactSyncManager) {}
  
  protected void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    awyz localawyz = (awyz)this.a.a.getManager(QQManagerFactory.CONTACT_MANAGER);
    int i = localawyz.d();
    ...
    do
    {
      do
      {
        ...
        ContactSyncManager.a(this.a).sendEmptyMessage(1);
        return;
      } while ((i != 5) && (i != 1) && ((i != 6) || (localawyz.a() == null) || (localawyz.a().lastUsedFlag != 3L)) && ((i != 7) || (localawyz.a() == null) || (!localawyz.a().isStopFindMatch)));
      if ((i == 5) || (i == 1)) {
