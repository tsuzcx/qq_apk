...
class uzu
  implements Runnable
{
  uzu(uzt paramuzt, boolean paramBoolean, SosoInterface.SosoLbsInfo paramSosoLbsInfo) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      synchronized (ArkAppLocationManager.a(this.jdField_a_of_type_Uzt.a))
      {
        Object localObject2 = new ArrayList(ArkAppLocationManager.a(this.jdField_a_of_type_Uzt.a));
        if (((ArrayList)localObject2).size() == 0) {
          SosoInterface.b(ArkAppLocationManager.a(this.jdField_a_of_type_Uzt.a));
        }
    ...
    if (!this.jdField_a_of_type_Boolean) {
      synchronized (ArkAppLocationManager.a(this.jdField_a_of_type_Uzt.a))
      {
        ArkAppLocationManager.a(this.jdField_a_of_type_Uzt.a).clear();
      }
    }
    synchronized (ArkAppLocationManager.b(this.jdField_a_of_type_Uzt.a))
    {
      Object localObject4 = new ArrayList(ArkAppLocationManager.b(this.jdField_a_of_type_Uzt.a));
      ArkAppLocationManager.b(this.jdField_a_of_type_Uzt.a).removeAll((Collection)localObject4);
    ...
    synchronized (ArkAppLocationManager.c(this.jdField_a_of_type_Uzt.a))
    {
      ArrayList localArrayList = new ArrayList(ArkAppLocationManager.c(this.jdField_a_of_type_Uzt.a));
      ArkAppLocationManager.c(this.jdField_a_of_type_Uzt.a).removeAll(localArrayList);
