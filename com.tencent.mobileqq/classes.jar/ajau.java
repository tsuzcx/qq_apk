  ...
  extends ajax
{
  ...
  public ajau(MayKnowRecommend paramMayKnowRecommend)
  {
  ...
  public String a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      paramQQAppInterface = (anpk)paramQQAppInterface.getManager(159);
    ...
    for (boolean bool = paramQQAppInterface.a();; bool = false)
    {
      ...
      this.jdField_a_of_type_JavaLangString = String.format(BaseApplicationImpl.sApplication.getString(2131689652), new Object[] { paramQQAppInterface });
