  ...
  implements Manager
{
  ...
  private static final String[] b = { "", ajjy.a(2131647780), ajjy.a(2131647776) };
  protected SparseArray<String[]> a;
  protected final QQAppInterface a;
  protected LinkedHashMap<String, azha> a;
  
  static
  {
    jdField_a_of_type_JavaLangString = ".troop.school_troop." + azgz.class.getSimpleName();
    jdField_a_of_type_ArrayOfJavaLangString = new String[] { "", ajjy.a(2131647777), ajjy.a(2131647779) };
  }
  
  public azgz(QQAppInterface paramQQAppInterface)
  {
  ...
  public azha a(SessionInfo paramSessionInfo, MessageRecord paramMessageRecord)
  {
    ...
    do
    {
      ...
      str1 = l2 + "_" + i;
      localazha = (azha)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(str1);
      if (localazha == null) {
        break;
      }
      paramSessionInfo = localazha;
    ...
    azha localazha = new azha();
    localazha.jdField_a_of_type_Long = l2;
    localazha.jdField_a_of_type_Int = i;
    localazha.jdField_a_of_type_JavaLangString = paramSessionInfo.jdField_a_of_type_JavaLangString;
    localazha.a(paramMessageRecord);
    ...
    while (i < k)
    {
      ...
      while (j < n)
      {
        ...
        if (i1 != -1)
        {
          localazha.jdField_b_of_type_Int = m;
          localazha.jdField_b_of_type_JavaLangString = str2;
          localazha.c = i1;
          localazha.d = (str2.length() + i1);
          this.jdField_a_of_type_JavaUtilLinkedHashMap.put(str1, localazha);
          return localazha;
        }
        j += 1;
      }
    ...
    localazha.jdField_b_of_type_Int = -1;
    this.jdField_a_of_type_JavaUtilLinkedHashMap.put(str1, localazha);
    if (QLog.isColorLevel()) {
      QLog.i(jdField_a_of_type_JavaLangString, 2, "detectKeyword time cost: " + (System.currentTimeMillis() - l1) + ", result = " + localazha.jdField_b_of_type_Int);
    }
    return localazha;
  }
