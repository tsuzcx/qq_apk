  ...
  implements View.OnTouchListener
{
  ...
  public axre(Context paramContext)
  {
    this.jdField_a_of_type_Bilh = new axri(this);
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new axrj(this);
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidWidgetTextView = new TextView(this.jdField_a_of_type_AndroidContentContext);
    this.jdField_a_of_type_AndroidWidgetTextView.setOnTouchListener(this);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(anvx.a(2131704557));
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setPadding(0, 0, 0, DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 15.0F));
  ...
  private void b()
  {
    ...
    {
      j = j - this.jdField_a_of_type_AndroidWidgetTextView.getWidth() - DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 10.0F);
      if (localLayoutParams.y - this.jdField_a_of_type_AndroidWidgetTextView.getHeight() / 2 <= i * 0.8F) {
        break label251;
      }
      i = i - this.jdField_a_of_type_AndroidWidgetTextView.getHeight() - DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 10.0F);
    }
    for (;;)
    {
      ValueAnimator localValueAnimator = ValueAnimator.ofInt(new int[] { localLayoutParams.x, j });
      localValueAnimator.addUpdateListener(new axrg(this, localLayoutParams, localValueAnimator));
      ...
      localValueAnimator.addUpdateListener(new axrh(this, localLayoutParams, localValueAnimator));
      localValueAnimator.setDuration(200L);
      localValueAnimator.setTarget(this.jdField_a_of_type_AndroidWidgetTextView);
      localValueAnimator.start();
      return;
      j = DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 10.0F);
      break;
      label251:
  ...
  public void a()
  {
    ...
    try
    {
      ...
      ((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).removeObserver(this.jdField_a_of_type_Bilh);
      return;
    }
  ...
  public void a(int paramInt1, String paramString1, int paramInt2, long paramLong, String paramString2)
  {
    ...
    Object localObject;
    if (!this.jdField_b_of_type_Boolean) {
      if (!lzr.c(this.jdField_a_of_type_AndroidContentContext))
      {
        if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        ((WindowManager.LayoutParams)localObject).x = (j - DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 62.0F) - DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 10.0F));
        ((WindowManager.LayoutParams)localObject).y = ((int)((k - DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 67.0F)) * 0.25F));
        this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130842295);
        try
        {
          ...
          if (paramInt1 == 0)
          {
            this.jdField_a_of_type_AndroidWidgetTextView.setText(anvx.a(2131704608));
            this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new axrf(this, paramInt1, paramLong, paramString2, paramString1, paramInt2));
            ((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).addObserver(this.jdField_a_of_type_Bilh);
            return;
            i = 2010;
          }
        }
        catch (Exception localException1)
        {
          for (;;)
          {
            ...
            continue;
            this.jdField_a_of_type_AndroidWidgetTextView.setText(anvx.a(2131704599));
          }
        }
      }
    }
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      ...
      if (i == 2)
      {
        if ((this.jdField_a_of_type_Boolean) || (Math.abs(paramMotionEvent.getX() - this.jdField_a_of_type_Int) > DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 10.0F)) || (Math.abs(paramMotionEvent.getY() - this.jdField_b_of_type_Int) > DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 10.0F)))
        {
          ...
          paramView.y = (k - this.jdField_b_of_type_Int - DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 25.0F));
