  ...
  implements Manager
{
  ...
  public aumb(QQAppInterface paramQQAppInterface)
  {
  ...
  public int a(String paramString)
  {
    ...
    while (!bbfd.a(paramString, localSQLiteDatabase)) {
      return 0;
    }
  ...
  public long a(String paramString)
  {
    ...
    do
    {
      return l3;
      l2 = l1;
      if (bbfd.a(paramString, localSQLiteDatabase)) {
        l3 = l1;
      }
      try
      {
  ...
  public Cursor a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      paramString2 = bbfd.b(null, paramString1, localSQLiteDatabase, (String)localObject1);
    ...
    for (;;)
    {
      ...
      if (paramString1.indexOf("mr_discusssion_") != -1)
      {
        ...
        paramString2 = bbfd.b(null, paramString1, localSQLiteDatabase, (String)localObject2);
      ...
      Object localObject2 = bbfd.a(null, paramString1, localSQLiteDatabase, paramString2, null);
  ...
  public aukq a()
  {
    ...
    try
    {
      if (this.jdField_a_of_type_ComTencentMobileqqDataQQEntityManagerFactory == null)
      {
        this.jdField_a_of_type_ComTencentMobileqqDataQQEntityManagerFactory = new auma(str);
  ...
  public aukx a()
  {
    ...
    {
      if ((this.jdField_a_of_type_Aukx == null) || (!this.jdField_a_of_type_Aukx.a())) {
        this.jdField_a_of_type_Aukx = ((aukx)a().createMessageRecordEntityManager());
      }
  ...
  public List<MessageRecord> a(String paramString1, String paramString2)
  {
    ...
    {
      return null;
      paramString1 = bbfd.a(null, paramString1, localSQLiteDatabase, paramString2, null);
