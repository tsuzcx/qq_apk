...
public class axem
{
  ...
  public axem(axel paramaxel)
  {
    this.jdField_a_of_type_Axel = paramaxel;
  }
  
  public static axem a(AppInterface paramAppInterface)
  {
    if (QLog.isColorLevel()) {
      QLog.d("MultiAioContext", 2, "create() called with: app = [" + paramAppInterface + "]");
    }
    paramAppInterface = (axel)paramAppInterface.getManager(QQManagerFactory.AIO_MULTI_WINDOW_MANAGER);
    axem localaxem = new axem(paramAppInterface);
    localaxem.c(paramAppInterface.a(localaxem));
    return localaxem;
  }
  ...
  public akfg a(MultiAIOItemFragment paramMultiAIOItemFragment)
  {
    ...
    if (i >= 0)
    {
      ...
      if (i < this.jdField_a_of_type_JavaUtilList.size()) {
        localObject1 = (akfg)this.jdField_a_of_type_JavaUtilList.get(i);
      }
    }
    localObject2 = localObject1;
    if (localObject1 == null)
    {
      localObject2 = akfn.a(paramMultiAIOItemFragment.getActivity(), paramMultiAIOItemFragment.a(), paramMultiAIOItemFragment.getActivity().app);
      a(i, (akfg)localObject2);
    }
    return localObject2;
  }
  ...
  public axeq a()
  {
    return this.jdField_a_of_type_Axeq;
  }
  ...
  public List<RecentBaseData> a(QQAppInterface paramQQAppInterface, FragmentActivity paramFragmentActivity, String paramString1, int paramInt, String paramString2, String paramString3)
  {
    ...
    if (localList2 == null)
    {
      localList1 = axea.a(paramFragmentActivity, paramQQAppInterface, paramString1, paramInt, paramString2, paramString3);
      a(localList1);
    }
    return localList1;
  }
  ...
  public void a(int paramInt, akfg paramakfg)
  {
    while (this.jdField_a_of_type_JavaUtilList.size() <= paramInt) {
      this.jdField_a_of_type_JavaUtilList.add(null);
    }
    if (QLog.isColorLevel()) {
      QLog.d("MultiAioContext", 2, "setMiniPie() called with: position = [" + paramInt + "], miniPie = [" + paramakfg + "]");
    }
    this.jdField_a_of_type_JavaUtilList.set(paramInt, paramakfg);
  }
  
  public void a(Intent paramIntent)
  {
    if (this.jdField_a_of_type_Axep != null) {
      this.jdField_a_of_type_Axep.a(paramIntent);
    }
  }
  ...
  public void a(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, int paramInt)
  {
    while (paramInt > 0)
    {
      a(paramLayoutInflater.inflate(2131558900, paramViewGroup, false));
      paramInt -= 1;
    }
  }
  ...
  public void a(axep paramaxep)
  {
    this.jdField_a_of_type_Axep = paramaxep;
  }
  
  public void a(axeq paramaxeq)
  {
    this.jdField_a_of_type_Axeq = paramaxeq;
  }
