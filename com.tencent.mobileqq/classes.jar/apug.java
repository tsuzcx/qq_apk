...
final class apug
  implements apvf
{
  apug(QQAppInterface paramQQAppInterface, int paramInt) {}
  ...
  public long a(String paramString1, int paramInt1, String paramString2, int paramInt2, String paramString3, String paramString4, String paramString5, long paramLong1, int paramInt3, long paramLong2, int paramInt4)
  {
    ...
    {
      localDataLineMsgRecord.thumbPath = apvb.a(apvb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication()), apue.a(paramString5));
      bbdj.d(paramString5, localDataLineMsgRecord.thumbPath);
    }
    ...
    for (localDataLineMsgRecord.nOpType = 29;; localDataLineMsgRecord.nOpType = 31)
    {
      ...
      paramString1 = (ajuo)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(8);
      ...
      ((akfw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(13)).a(localDataLineMsgRecord);
      localDataLineMsgRecord.time = awzw.a();
      localDataLineMsgRecord.progress = 0.2F;
      localDataLineMsgRecord.fileMsgStatus = 0L;
      localDataLineMsgRecord.msgtype = ajuo.a(0);
      ...
      paramString1.a(7, true, new Object[] { Long.valueOf(0L), Long.valueOf(localDataLineMsgRecord.sessionid), localDataLineMsgRecord.path, Byte.valueOf((byte)ajuo.b(localDataLineMsgRecord.msgtype)), Boolean.valueOf(false), Boolean.valueOf(false), Long.valueOf(localDataLineMsgRecord.filesize) });
