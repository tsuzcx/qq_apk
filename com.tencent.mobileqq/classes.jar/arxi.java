...
{
  private static arxi jdField_a_of_type_Arxi;
  public static boolean a;
  private int jdField_a_of_type_Int;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new arxk(this);
  private WindowManager jdField_a_of_type_AndroidViewWindowManager;
  private DataReportViewer jdField_a_of_type_ComTencentMobileqqDatareportviewerDataReportViewer;
  private ArrayList<arwk> jdField_a_of_type_JavaUtilArrayList;
  private HashMap<String, arxl> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private boolean b;
  private boolean c;
  private boolean d;
  ...
  public static arxi a()
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 46	arxi:jdField_a_of_type_Arxi	Larxi;
    //   6: ifnonnull +19 -> 25
    //   9: ldc 2
    //   11: monitorenter
    //   12: new 2	arxi
    //   15: dup
    //   16: invokespecial 47	arxi:<init>	()V
    //   19: putstatic 46	arxi:jdField_a_of_type_Arxi	Larxi;
    //   22: ldc 2
    //   24: monitorexit
    //   25: ldc 2
    //   27: monitorexit
    //   28: getstatic 46	arxi:jdField_a_of_type_Arxi	Larxi;
    //   31: areturn
    //   32: astore_0
    //   33: ldc 2
    //   35: monitorexit
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i < ((JSONArray)localObject1).length())
        {
          ...
          {
            localObject2 = arxl.a((JSONObject)localObject2);
            this.jdField_a_of_type_JavaUtilArrayList.add(localObject2);
            this.jdField_a_of_type_JavaUtilHashMap.put(((arxl)localObject2).b, localObject2);
          }
          else
          {
            localObject2 = arxm.a((JSONObject)localObject2);
            this.jdField_a_of_type_JavaUtilArrayList.add(localObject2);
            localObject2 = ((arxm)localObject2).jdField_a_of_type_JavaUtilArrayList.iterator();
            if (((Iterator)localObject2).hasNext())
            {
              arxl localarxl = (arxl)((Iterator)localObject2).next();
              this.jdField_a_of_type_JavaUtilHashMap.put(localarxl.b, localarxl);
              continue;
            }
          }
        }
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqDatareportviewerDataReportViewer == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqDatareportviewerDataReportViewer = new arxj(this, localBaseApplication, localBaseApplication);
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        catch (Exception localException1)
        {
          for (;;)
          {
            QQToast.a(localBaseApplication, 1, anvx.a(2131702256), 0).a();
          }
        }
      }
    }
  ...
  public void a(arwk paramarwk)
  {
    this.jdField_a_of_type_JavaUtilArrayList.add(paramarwk);
    e();
    if ((paramarwk instanceof arxl)) {
      this.jdField_a_of_type_JavaUtilHashMap.put(((arxl)paramarwk).b, (arxl)paramarwk);
    }
  }
  
  public void a(ArrayList<arwk> paramArrayList)
  {
    int k = 0;
    ...
    {
      localObject2 = (arwk)((Iterator)localObject1).next();
      localHashMap.put(((arwk)localObject2).jdField_a_of_type_JavaLangString, Boolean.valueOf(((arwk)localObject2).jdField_a_of_type_Boolean));
    }
    int i = 0;
    int j = k;
    if (i < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      localObject1 = (arwk)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      j = i;
      if (!((arwk)localObject1).a())
      {
        this.jdField_a_of_type_JavaUtilArrayList.remove(i);
        i -= 1;
        if (!(localObject1 instanceof arxl)) {
          break label150;
        }
        this.jdField_a_of_type_JavaUtilHashMap.remove(((arxl)localObject1).b);
        j = i;
      }
      label150:
      do
      {
        ...
        break;
        j = i;
      } while (!(localObject1 instanceof arxm));
      localObject1 = ((arxm)localObject1).jdField_a_of_type_JavaUtilArrayList.iterator();
      for (;;)
      {
        j = i;
        ...
        localObject2 = (arxl)((Iterator)localObject1).next();
        this.jdField_a_of_type_JavaUtilHashMap.remove(((arxl)localObject2).b);
      }
    }
    if (j < paramArrayList.size())
    {
      localObject1 = (arwk)paramArrayList.get(j);
      if (localHashMap.containsKey(((arwk)localObject1).jdField_a_of_type_JavaLangString))
      {
        ((arwk)localObject1).jdField_a_of_type_Boolean = ((Boolean)localHashMap.get(((arwk)localObject1).jdField_a_of_type_JavaLangString)).booleanValue();
        label265:
        if (!(localObject1 instanceof arxl)) {
          break label310;
        }
        this.jdField_a_of_type_JavaUtilHashMap.put(((arxl)localObject1).b, (arxl)localObject1);
      }
      for (;;)
      {
        j += 1;
        break;
        ((arwk)localObject1).jdField_a_of_type_Boolean = true;
        break label265;
        label310:
        if ((localObject1 instanceof arxm))
        {
          localObject1 = ((arxm)localObject1).jdField_a_of_type_JavaUtilArrayList.iterator();
          while (((Iterator)localObject1).hasNext())
          {
  ...
  public void b(arwk paramarwk)
  {
    this.jdField_a_of_type_JavaUtilArrayList.remove(paramarwk);
    e();
    if ((paramarwk instanceof arxl)) {
      this.jdField_a_of_type_JavaUtilHashMap.remove(((arxl)paramarwk).b);
    }
    for (;;)
    {
      return;
      if ((paramarwk instanceof arxm))
      {
        paramarwk = ((arxm)paramarwk).jdField_a_of_type_JavaUtilArrayList.iterator();
        while (paramarwk.hasNext())
        {
          arxl localarxl = (arxl)paramarwk.next();
          this.jdField_a_of_type_JavaUtilHashMap.remove(localarxl.b);
        }
      }
    }
  }
  ...
  public void e()
  {
    ...
    while (localIterator.hasNext()) {
      localJSONArray.put(((arwk)localIterator.next()).a());
    }
