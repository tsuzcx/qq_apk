...
{
  public arxi(MessageForGrayTips.HightlightClickableSpan paramHightlightClickableSpan) {}
  
  public void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    if (bhnv.d(MessageForGrayTips.HightlightClickableSpan.access$100(this.a)))
    {
    ...
    QQToast.a(BaseApplication.getContext(), 1, 2131691310, 0).a();
  }
}
