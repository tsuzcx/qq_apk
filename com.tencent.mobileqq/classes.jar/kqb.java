...
public class kqb
  implements Runnable
{
  public kqb(AccountDetailBaseAdapter paramAccountDetailBaseAdapter, long paramLong1, List paramList, int paramInt1, int paramInt2, long paramLong2) {}
  ...
  public void run()
  {
    ...
    do
    {
      do
      {
        ...
        for (;;)
        {
          ...
          try
          {
            ...
            localLinkedList.add(kqo.a(new URL(localDynamicInfo.jdField_a_of_type_ComTencentBizPubaccountAccountDetailBeanVideoAttr.d), ReadInJoyDisplayUtils.b()));
          }
          ...
          {
            return;
            localLinkedList.add(kqo.a(new URL(localException.jdField_a_of_type_ComTencentBizPubaccountAccountDetailBeanVideoAttr.jdField_a_of_type_JavaLangString), ReadInJoyDisplayUtils.a()));
            continue;
            if (localException.jdField_a_of_type_ComTencentBizPubaccountAccountDetailBeanPictureAttr != null) {
              if (localException.jdField_a_of_type_ComTencentBizPubaccountAccountDetailBeanPictureAttr.jdField_a_of_type_Int == 1) {
                localLinkedList.add(kqo.a(new URL(localException.jdField_a_of_type_ComTencentBizPubaccountAccountDetailBeanPictureAttr.b), ReadInJoyDisplayUtils.b()));
              } else {
                localLinkedList.add(kqo.a(new URL(localException.jdField_a_of_type_ComTencentBizPubaccountAccountDetailBeanPictureAttr.jdField_a_of_type_JavaLangString), ReadInJoyDisplayUtils.a()));
              }
            }
          }
        }
      ...
      {
        kqo localkqo = (kqo)localIterator.next();
        if ((localkqo != null) && (localkqo.jdField_a_of_type_JavaNetURL != null))
        {
          ImageRequest localImageRequest = new ImageRequest();
          localImageRequest.jdField_a_of_type_JavaNetURL = localkqo.jdField_a_of_type_JavaNetURL;
          localImageRequest.jdField_a_of_type_Int = ((Integer)localkqo.jdField_a_of_type_AndroidUtilPair.first).intValue();
          localImageRequest.jdField_b_of_type_Int = ((Integer)localkqo.jdField_a_of_type_AndroidUtilPair.second).intValue();
