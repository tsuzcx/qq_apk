  ...
  extends AccountObserver
{
  ...
  public void onRegQueryAccountResp(boolean paramBoolean, int paramInt, byte[] paramArrayOfByte)
  {
    ...
    {
      this.a.c();
      bcpw.a(this.a.getApplicationContext(), ajyc.a(2131713356), 1).a();
      return;
    }
    label166:
    for (;;)
        ...
        try
        {
          ...
          default: 
            ...
            if (TextUtils.isEmpty(paramArrayOfByte)) {
              localObject = ajyc.a(2131713347);
            }
            bcpw.a(this.a.getApplicationContext(), (CharSequence)localObject, 1).a();
            return;
          }
        }
    ...
    return;
    this.a.c();
    this.a.b("该手机号码已绑定其他QQ号码", ajyc.a(2131713361));
    return;
    this.a.c();
  ...
  public void onRegisterCommitMobileResp(boolean paramBoolean, int paramInt, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, String paramString)
  {
    ...
    do
    {
      ...
      if (!paramBoolean)
      {
        bcpw.a(this.a.getApplicationContext(), ajyc.a(2131713332), 1).a();
        return;
      }
      switch (paramInt)
      {
      default: 
        bcpw.a(this.a.getApplicationContext(), ajyc.a(2131713353), 1).a();
        return;
      case 0: 
        ...
        catch (UnsupportedEncodingException paramArrayOfByte2)
        {
          try
          {
            for (;;)
            {
              ...
              bcpw.a(this.a.getApplicationContext(), ajyc.a(2131713358), 1).a();
              return;
      ...
      case 3: 
        try
        {
          ...
          {
            bcpw.a(this.a.getApplicationContext(), ajyc.a(2131713350), 1).a();
            return;
          }
        }
        catch (UnsupportedEncodingException paramArrayOfByte1)
  ...
  public void onRegisterCommitPassResp(boolean paramBoolean, int paramInt, String paramString, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    ...
    {
      this.a.c();
      bcpw.a(this.a.getApplicationContext(), ajyc.a(2131713343), 1).a();
      return;
    }
  ...
  public void onRegisterCommitSmsCodeResp(boolean paramBoolean, int paramInt, String paramString1, String paramString2, String paramString3, byte[] paramArrayOfByte)
  {
    ...
    {
      this.a.c();
      bcpw.a(this.a.getApplicationContext(), ajyc.a(2131713349), 1).a();
      return;
    }
    if (paramInt == 0) {
      this.a.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(8);
    ...
    for (;;)
    {
      ...
      return;
      this.a.jdField_a_of_type_JavaLangString = ajyc.a(2131713336);
  ...
  public void onRegisterQuerySmsStatResp(boolean paramBoolean, int paramInt1, byte[] paramArrayOfByte, int paramInt2, int paramInt3, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    do
    {
      ...
      if (!paramBoolean)
      {
        ...
        bcpw.a(this.a.getApplicationContext(), ajyc.a(2131713344), 1).a();
        return;
      }
      paramString1 = null;
  ...
  public void onRegisterSendResendSmsreqResp(boolean paramBoolean, int paramInt1, byte[] paramArrayOfByte, int paramInt2, int paramInt3)
  {
    ...
    if (!paramBoolean)
    {
      bcpw.a(this.a.getApplicationContext(), ajyc.a(2131713348), 1).a();
      return;
    }
    try
    {
