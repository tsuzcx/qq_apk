...
public class afpm
  extends aipl
  implements View.OnClickListener, View.OnLongClickListener, bfpu, bfru, bfwc
{
  public int a;
  public ajvi a;
  akil jdField_a_of_type_Akil = new afps(this);
  protected Context a;
  protected bfwg a;
  ...
  public afpm(Context paramContext, QQAppInterface paramQQAppInterface, ExpandableListView paramExpandableListView)
  {
    ...
    this.jdField_b_of_type_Int = actj.a(56.0F, paramContext.getResources());
    this.jdField_c_of_type_Int = actj.a(44.0F, paramContext.getResources());
    this.jdField_a_of_type_Bfwg = new afpn(this, 1, 1, new int[] { paramContext.getResources().getDimensionPixelSize(2131296675) }, -1, new int[] { 2131369930, 2131369930 }, new int[] { 2131693201, 2131693199 }, new int[] { 2130839240, 2130839240 });
  ...
  private int a(List<aipz> paramList)
  {
    paramList = paramList.iterator();
    int i = 0;
    if (paramList.hasNext())
    {
      aipz localaipz = (aipz)paramList.next();
      if ((localaipz.a == null) || (!(localaipz.a instanceof TroopInfo)) || (((TroopInfo)localaipz.a).lastMsgTime <= 0L)) {
        break label100;
      }
      i += 1;
    }
  ...
  private auko a(int paramInt1, int paramInt2)
  {
    ...
    default: 
      return null;
    case 0: 
      return (auko)this.jdField_b_of_type_JavaUtilList.get(paramInt2);
    case 4: 
      return ((aipz)this.jdField_c_of_type_JavaUtilList.get(paramInt2)).a;
    case 6: 
      return ((aipz)this.d.get(paramInt2)).a;
    case 2: 
      return ((aipz)this.e.get(paramInt2)).a;
    case 8: 
      return ((aipz)this.f.get(paramInt2)).a;
    }
    return ((aipz)this.g.get(paramInt2)).a;
  }
  ...
  private void a(ailv paramailv)
  {
    ...
    for (;;)
    {
      ...
      i += 1;
      continue;
      i = paramailv.jdField_a_of_type_Int;
      break;
      label100:
      int j = 0;
  ...
  private void a(ailv paramailv, int paramInt, boolean paramBoolean)
  {
    ...
    if (paramailv != null)
    {
      ...
      default: 
        ...
        if (j <= 10)
        {
          ...
          str2 = k + "/" + j;
          localStringBuilder1 = paramailv.jdField_a_of_type_JavaLangStringBuilder;
          ...
          paramailv.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setText(str1);
          ...
          paramailv.jdField_a_of_type_ComTencentMobileqqActivityContactSimpleTextView.setText(str2);
          if (AppSetting.d) {
    ...
    for (;;)
    {
      paramailv.jdField_a_of_type_ComTencentMobileqqActivityContactSimpleTextView.setContentDescription(localStringBuilder2.toString());
      baww.a(paramailv.jdField_a_of_type_AndroidWidgetCheckBox, false);
      return;
      str1 = ajya.a(2131702564);
      j = this.jdField_b_of_type_JavaUtilList.size();
      this.jdField_a_of_type_ArrayOfInt[paramInt] = 3;
      i = 0;
      break;
      str1 = ajya.a(2131715829);
      j = this.jdField_c_of_type_JavaUtilList.size();
      i = a(this.jdField_c_of_type_JavaUtilList);
      break;
      str1 = ajya.a(2131715832);
      j = this.d.size();
      i = a(this.d);
      break;
      str1 = ajya.a(2131715825);
      j = this.e.size();
      i = a(this.e);
      break;
      str1 = ajya.a(2131715830);
      j = this.f.size();
      i = a(this.f);
      break;
      str1 = ajya.a(2131702580);
      j = this.g.size();
      i = a(this.g);
      break;
      k = i;
  ...
  private void a(aiqt paramaiqt, DiscussionInfo paramDiscussionInfo)
  {
    bbbn.a(true);
    Intent localIntent = actj.a(new Intent(this.jdField_a_of_type_AndroidContentContext, SplashActivity.class), null);
    ...
    int i;
    switch (((Integer)this.jdField_a_of_type_JavaUtilList.get(paramaiqt.jdField_b_of_type_Int)).intValue())
    {
    case 1: 
    case 3: 
    case 5: 
    ...
    for (;;)
    {
      new axrc(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_listNew").c("Grp_contactlist").d("clk_grp").a(new String[] { paramDiscussionInfo.uin, String.valueOf(i) }).a();
      return;
      i = 0;
      continue;
      i = 1;
  ...
  private void g()
  {
    ...
    for (;;)
    {
      ...
      {
        j = a(i);
        new axrc(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_listNew").c("Grp_contactlist").d("exp_inactive").a(new String[] { "", String.valueOf(j) }).a();
      }
      i += 1;
      break label170;
      break;
  ...
  protected void a(int paramInt, bfwf[] paramArrayOfbfwf, Object paramObject)
  {
    int i = 1;
    ...
    for (;;)
    {
      ...
      if (paramArrayOfbfwf.length < 0) {
        if ((paramObject instanceof TroopInfo))
        {
          ...
          {
            paramInt = 1;
            paramArrayOfbfwf[0].jdField_b_of_type_Int = paramInt;
  ...
  public void a(View paramView, int paramInt, aiqp paramaiqp, View.OnClickListener paramOnClickListener, Object paramObject)
  {
    if (this.jdField_a_of_type_Bfwg != null) {}
    for (int i = this.jdField_a_of_type_Bfwg.a(this.jdField_a_of_type_AndroidContentContext, paramView, paramInt, paramObject, paramaiqp, paramOnClickListener);; i = 0)
    {
  ...
  public View getChildView(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if ((paramInt2 == getChildrenCount(paramInt1) - 1) && (this.jdField_a_of_type_ArrayOfInt[paramInt1] == 1))
    {
      ...
      localObject = ajya.a(2131702552) + this.jdField_c_of_type_ArrayOfInt[paramInt1] + ")";
      paramView.setText((CharSequence)localObject);
      paramViewGroup.setOnClickListener(new afpo(this, paramInt1));
      paramViewGroup.setOnTouchListener(new afpp(this, paramView));
      paramViewGroup.setContentDescription((String)localObject + ajya.a(2131702525));
    }
    label479:
    label504:
    do
    {
      ...
      {
        localObject = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131562539, null);
        ((View)localObject).setMinimumHeight(this.jdField_b_of_type_Int);
        paramViewGroup = new aiqt();
        paramView = this.jdField_a_of_type_Bfwg.a(this.jdField_a_of_type_AndroidContentContext, (View)localObject, paramViewGroup, -1);
        ...
        paramViewGroup.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131377035));
        paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131367679));
        paramViewGroup.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131369803));
        paramViewGroup.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131376452));
        paramViewGroup.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370498));
        ...
        paramViewGroup.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130849335);
        ...
        paramViewGroup.d.setBackgroundResource(2130843233);
        if (localTroopInfo.troopCreditLevel != 2L) {
          break label909;
        }
        paramViewGroup.jdField_c_of_type_AndroidWidgetImageView.setVisibility(0);
        paramViewGroup.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
        paramViewGroup.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130849338);
      }
      for (;;)
      {
        if (AppSetting.d) {
        ...
        if (localTroopInfo.troopCreditLevel == 1L)
        {
          paramViewGroup.jdField_c_of_type_AndroidWidgetImageView.setVisibility(0);
          paramViewGroup.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
          paramViewGroup.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130849336);
        }
        else
        {
      ...
      if ((localObject != null) && ((localObject instanceof DiscussionInfo)))
      {
        ...
        i = this.jdField_a_of_type_Ajvi.a(((DiscussionInfo)localObject).uin);
  ...
  public void onClick(View paramView)
  {
    ...
    int i;
    if ((paramView instanceof ailv))
    {
      a((ailv)paramView);
      paramView = (ailv)paramView;
      ...
      if ((paramView.jdField_a_of_type_Int >= 0) && (paramView.jdField_a_of_type_Int < this.jdField_a_of_type_ArrayOfInt.length))
      {
        ...
        if ((this.jdField_a_of_type_ArrayOfInt[paramView.jdField_a_of_type_Int] == 1) && (this.jdField_a_of_type_ComTencentWidgetExpandableListView.c(i)))
        {
          ...
          new axrc(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_listNew").c("Grp_contactlist").d("exp_inactive").a(new String[] { "", String.valueOf(i) }).a();
        }
      }
    }
    label158:
    do
    {
      ...
      {
        localObject = (aiqt)paramView;
        if ((((aiqt)localObject).jdField_a_of_type_JavaLangObject instanceof DiscussionInfo))
        {
          a((aiqt)localObject, (DiscussionInfo)((aiqt)localObject).jdField_a_of_type_JavaLangObject);
          return;
        }
        paramView = (TroopInfo)((aiqt)localObject).jdField_a_of_type_JavaLangObject;
        int j;
        switch (((Integer)this.jdField_a_of_type_JavaUtilList.get(((aiqt)localObject).jdField_b_of_type_Int)).intValue())
        {
        case 1: 
        case 3: 
        case 5: 
        ...
        for (;;)
        {
          if (((aiqt)localObject).jdField_a_of_type_Boolean) {
            new axrc(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_listNew").c("Grp_contactlist").d("clk_inactiveGrp").a(new String[] { paramView.troopuin, String.valueOf(i) }).a();
          }
          axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_contacts", "", "choose_grp", "grplist", 0, 0, paramView.troopuin + "", String.valueOf(i), j + "", "");
          new axrc(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_listNew").c("Grp_contactlist").d("clk_grp").a(new String[] { paramView.troopuin, String.valueOf(i) }).a();
          if (i == 5) {
            new axrc(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_listNew").c("Grp_contactlist").d("clk_unnamedGrp").a(new String[] { paramView.troopuin }).a();
          }
          bbbn.a(true);
          localObject = actj.a(new Intent(this.jdField_a_of_type_AndroidContentContext, SplashActivity.class), null);
    ...
    paramView = (ajsx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(22);
    label806:
    label828:
    axrc localaxrc;
    label900:
    ...
    if (bool)
    {
      ...
      axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_set", "", "Grp_contactlist", paramView, 0, 0, ((TroopInfo)localObject).troopuin, "", "", "");
      localaxrc = new axrc(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_set").c("Grp_contactlist");
      if (!bool) {
        break label961;
      }
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    paramView = paramView.getTag();
    boolean bool;
    if ((paramView != null) && ((paramView instanceof aiqp)))
    {
      paramView = ((aiqp)paramView).jdField_a_of_type_JavaLangObject;
      if (paramView != null) {
        if ((paramView instanceof TroopInfo))
        {
          localObject1 = (bfpc)bfpp.a(this.jdField_a_of_type_AndroidContentContext, null);
          ...
          {
            i = 2131693199;
            ((bfpc)localObject1).b(i);
            ((bfpc)localObject1).c(2131690596);
            ((bfpc)localObject1).a(new afpq(this, bool, paramView, (bfpc)localObject1));
          }
        }
      }
    }
    for (;;)
    {
      try
      {
        ...
        localObject1 = (bfpc)bfpp.a(this.jdField_a_of_type_AndroidContentContext, null);
        localObject2 = (ajvg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6);
        paramView = (DiscussionInfo)paramView;
        bool = ((ajvg)localObject2).a(paramView);
        if (bool)
        {
          ((bfpc)localObject1).b(i);
          ((bfpc)localObject1).c(2131690596);
          ((bfpc)localObject1).a(new afpr(this, (ajvg)localObject2, paramView, bool, (bfpc)localObject1));
          try
          {
            ((bfpc)localObject1).show();
          }
