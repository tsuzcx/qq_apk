  ...
  implements TroopHomeworkHelper.UploadCallback
{
  ...
  public void a(String paramString)
  {
    ...
    for (int i = 11;; i = 0)
    {
      ...
      localObject = this.a.jdField_a_of_type_CooperationTroop_homeworkJspTroopHWJsPlugin.a(this.a.jdField_a_of_type_CooperationTroop_homeworkJspTroopHWJsPlugin$RequestSource.c, this.a.jdField_a_of_type_Int, this.a.b, (String)localObject, paramString, i);
  ...
  public void b(int paramInt)
  {
    ...
    this.a.jdField_a_of_type_Boolean = false;
    JSONObject localJSONObject = this.a.jdField_a_of_type_CooperationTroop_homeworkJspTroopHWJsPlugin.a(this.a.jdField_a_of_type_CooperationTroop_homeworkJspTroopHWJsPlugin$RequestSource.c, this.a.jdField_a_of_type_Int, this.a.b, "uploaded", "", 0);
    try
    {
