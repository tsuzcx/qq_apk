...
public class TroopHWFileDownloadManager
{
  ...
  private ITMAssistantDownloadClientListener jdField_a_of_type_ComTencentTmdownloaderITMAssistantDownloadClientListener = new ampk(this);
  ...
  {
    ThreadManager.post(new ampj(this, paramString), 5, null, true);
  }
  ...
  public void a(String paramString1, String paramString2, TroopHWFileDownloadManager.OnDownloadStateListener paramOnDownloadStateListener)
  {
    ...
    ThreadManager.post(new ampi(this, paramString1, str), 5, null, true);
  }
}
