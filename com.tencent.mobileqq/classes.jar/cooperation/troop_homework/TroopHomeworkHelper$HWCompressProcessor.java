  ...
  public VideoConverter.VideoConvertConfig a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localVideoConvertConfig.jdField_a_of_type_Float = (m / k);
        ...
        if (localVideoConvertConfig.jdField_a_of_type_Int <= i * 1024) {
          break label382;
        }
        localVideoConvertConfig.jdField_a_of_type_Int = (i * 1024);
        paramInt2 = paramInt1;
        ...
        if (QLog.isColorLevel()) {
          QLog.d("TroopHomeworkHelper", 2, "CompressTask, step: getEncodeConfig() config.setRotation = " + localVideoConvertConfig.jdField_b_of_type_Boolean);
        }
      ...
      continue;
      label382:
      if (localVideoConvertConfig.jdField_a_of_type_Int < j * 1024)
      {
        localVideoConvertConfig.jdField_a_of_type_Int = (j * 1024);
        continue;
        paramInt2 = 0;
        paramInt1 = 0;
        j = 0;
