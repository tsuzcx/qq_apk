  ...
  implements Handler.Callback
{
  ...
  private String a(android.net.Uri paramUri)
  {
    ...
    //   227: iconst_0
    //   228: aaload
    //   229: invokestatic 127	com/tencent/mobileqq/utils/FileUtils:a	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    //   267: aload_0
    //   268: ldc 138
    //   270: invokestatic 142	com/tencent/mobileqq/app/HardCodeUtil:a	(I)Ljava/lang/String;
    ...
    //   370: new 159	com/tencent/mobileqq/utils/QQCustomDialog
    //   373: dup
    //   374: aload_0
    //   375: ldc 160
    //   377: invokespecial 163	com/tencent/mobileqq/utils/QQCustomDialog:<init>	(Landroid/content/Context;I)V
    //   380: astore 8
    //   382: aload 8
    //   384: ldc 164
    //   386: invokevirtual 168	com/tencent/mobileqq/utils/QQCustomDialog:setContentView	(I)V
    //   389: aload 8
    //   391: aload_0
    //   392: ldc 169
    //   394: invokevirtual 92	cooperation/qqfav/widget/QfavJumpActivity:getString	(I)Ljava/lang/String;
    //   397: invokevirtual 173	com/tencent/mobileqq/utils/QQCustomDialog:setTitle	(Ljava/lang/String;)Lcom/tencent/mobileqq/utils/QQCustomDialog;
    //   400: pop
    //   401: aload 8
    //   403: aload_0
    //   404: ldc 174
    //   406: invokevirtual 92	cooperation/qqfav/widget/QfavJumpActivity:getString	(I)Ljava/lang/String;
    //   409: invokevirtual 178	com/tencent/mobileqq/utils/QQCustomDialog:setMessage	(Ljava/lang/CharSequence;)Lcom/tencent/mobileqq/utils/QQCustomDialog;
    //   412: pop
    //   413: aload 8
    //   415: iconst_0
    //   416: invokevirtual 182	com/tencent/mobileqq/utils/QQCustomDialog:setCanceledOnTouchOutside	(Z)V
    //   419: aload 8
    //   421: iconst_0
    //   422: invokevirtual 185	com/tencent/mobileqq/utils/QQCustomDialog:setCancelable	(Z)V
    //   425: aload 8
    //   427: aload_0
    //   428: ldc 186
    //   430: invokevirtual 92	cooperation/qqfav/widget/QfavJumpActivity:getString	(I)Ljava/lang/String;
    //   433: new 188	cooperation/qqfav/widget/QfavJumpActivity$1
    //   436: dup
    //   437: aload_0
    //   438: aload_1
    //   439: invokespecial 191	cooperation/qqfav/widget/QfavJumpActivity$1:<init>	(Lcooperation/qqfav/widget/QfavJumpActivity;Ljava/io/InputStream;)V
    //   442: invokevirtual 195	com/tencent/mobileqq/utils/QQCustomDialog:setNegativeButton	(Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;)Lcom/tencent/mobileqq/utils/QQCustomDialog;
    //   445: pop
    //   446: aload 8
    //   448: aload_0
    //   449: ldc 196
    //   451: invokevirtual 92	cooperation/qqfav/widget/QfavJumpActivity:getString	(I)Ljava/lang/String;
    //   454: new 198	cooperation/qqfav/widget/QfavJumpActivity$2
    //   457: dup
    //   458: aload_0
    //   459: aload 7
    //   461: aload_1
    //   462: lload 4
    //   464: invokespecial 201	cooperation/qqfav/widget/QfavJumpActivity$2:<init>	(Lcooperation/qqfav/widget/QfavJumpActivity;Ljava/lang/String;Ljava/io/InputStream;J)V
    //   467: invokevirtual 204	com/tencent/mobileqq/utils/QQCustomDialog:setPositiveButton	(Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;)Lcom/tencent/mobileqq/utils/QQCustomDialog;
    //   470: pop
    //   471: aload 8
    //   473: invokevirtual 207	com/tencent/mobileqq/utils/QQCustomDialog:show	()V
    //   476: aload 7
    //   478: astore_1
    //   479: aload 6
    //   481: ifnull -430 -> 51
  ...
  private void a(String paramString)
  {
    ...
    localQQCustomDialog.setNegativeButton(getString(2131690778), new QfavJumpActivity.6(this));
  ...
  private void a(String paramString, InputStream paramInputStream, long paramLong)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog == null)
    {
      this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = DialogUtil.a(this, getString(2131691377), HardCodeUtil.a(2131709570), new QfavJumpActivity.4(this));
  ...
  public boolean doOnCreate(android.os.Bundle paramBundle)
  {
    ...
    //   0: aload_0
    //   1: iconst_0
    //   2: putfield 376	cooperation/qqfav/widget/QfavJumpActivity:mNeedStatusTrans	Z
    //   5: aload_0
    //   6: aload_1
    //   7: invokespecial 378	com/tencent/mobileqq/app/BaseActivity:doOnCreate	(Landroid/os/Bundle;)Z
    //   10: pop
    //   11: aload_0
    //   12: iconst_1
    //   13: invokestatic 383	com/tencent/mobileqq/utils/JumpForwardPkgUtil:a	(Landroid/app/Activity;Z)Z
    //   16: ifne +9 -> 25
    //   19: aload_0
    ...
    //   24: ireturn
    //   25: aload_0
    //   26: invokespecial 384	com/tencent/mobileqq/app/BaseActivity:getIntent	()Landroid/content/Intent;
    //   29: astore 5
    //   31: aload 5
    //   33: ifnonnull +45 -> 78
    //   36: aload_0
    ...
    //   59: aload_1
    //   60: invokevirtual 389	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   69: invokestatic 392	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   72: aload_0
    ...
    //   83: astore_1
    //   84: aload 5
    //   86: invokevirtual 395	android/content/Intent:getType	()Ljava/lang/String;
    //   89: astore 6
    //   91: aload_0
    //   92: aconst_null
    //   93: putfield 397	cooperation/qqfav/widget/QfavJumpActivity:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   96: ldc_w 263
    //   99: aload_1
    ...
    //   116: aload 5
    //   118: ldc_w 399
    //   121: invokevirtual 403	android/content/Intent:getParcelableExtra	(Ljava/lang/String;)Landroid/os/Parcelable;
    //   124: astore_1
    //   125: aload_1
    //   126: instanceof 405
    //   129: ifeq +282 -> 411
    //   132: aload_0
    //   133: aload_1
    //   134: checkcast 405	android/net/Uri
    //   137: invokestatic 410	com/tencent/mobileqq/forward/ForwardFileOption:a	(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
    //   140: astore 7
    //   142: aload 7
    //   144: ifnull +267 -> 411
    ...
    //   163: ifeq +80 -> 243
    //   166: aload 7
    //   168: invokevirtual 413	java/io/File:isFile	()Z
    //   171: istore 4
    //   173: iload 4
    //   175: ifeq +68 -> 243
    //   178: iconst_1
    ...
    //   181: istore_3
    //   182: aload 6
    //   184: invokestatic 419	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   187: ifne +93 -> 280
    //   190: iload_2
    //   191: istore_3
    //   192: aload 6
    //   194: ldc_w 421
    //   197: invokevirtual 425	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   200: ifeq +80 -> 280
    //   203: iload_2
    //   204: istore_3
    //   205: iload_2
    ...
    //   219: aload_0
    //   220: aload_1
    //   221: checkcast 405	android/net/Uri
    //   224: invokespecial 427	cooperation/qqfav/widget/QfavJumpActivity:a	(Landroid/net/Uri;)Ljava/lang/String;
    //   227: putfield 397	cooperation/qqfav/widget/QfavJumpActivity:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   230: aload_0
    //   231: getfield 397	cooperation/qqfav/widget/QfavJumpActivity:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   234: astore_1
    //   235: iload_2
    //   236: istore_3
    //   237: aload_1
    ...
    //   249: iconst_0
    //   250: istore_2
    //   251: new 429	java/util/ArrayList
    //   254: dup
    //   255: invokespecial 430	java/util/ArrayList:<init>	()V
    //   258: pop
    //   259: aload 5
    //   261: ldc_w 399
    //   264: invokevirtual 434	android/content/Intent:getParcelableArrayListExtra	(Ljava/lang/String;)Ljava/util/ArrayList;
    //   267: pop
    //   268: ldc 52
    //   270: iconst_1
    //   271: aload_1
    //   272: invokevirtual 435	java/lang/Exception:toString	()Ljava/lang/String;
    //   275: invokestatic 392	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   278: iload_2
    //   279: istore_3
    //   280: aload 6
    //   282: invokestatic 419	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   285: ifne +61 -> 346
    //   288: aload 6
    //   290: ldc_w 421
    //   293: invokevirtual 425	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   296: ifne +14 -> 310
    //   299: aload 6
    //   301: ldc_w 437
    //   304: invokevirtual 425	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   307: ifeq +39 -> 346
    //   310: iload_3
    //   311: ifne +35 -> 346
    //   314: aload 5
    //   316: aload_0
    //   317: ldc_w 439
    //   320: invokevirtual 443	android/content/Intent:setClass	(Landroid/content/Context;Ljava/lang/Class;)Landroid/content/Intent;
    //   323: pop
    //   324: aload 5
    //   326: ldc_w 445
    //   329: iconst_1
    //   330: invokevirtual 448	android/content/Intent:putExtra	(Ljava/lang/String;Z)Landroid/content/Intent;
    //   333: pop
    //   334: aload_0
    //   335: aload 5
    //   337: invokespecial 452	com/tencent/mobileqq/app/BaseActivity:startActivity	(Landroid/content/Intent;)V
    //   340: aload_0
    ...
    //   350: invokevirtual 455	com/tencent/mobileqq/app/QQAppInterface:isLogin	()Z
    //   353: ifne +39 -> 392
    //   356: new 258	android/content/Intent
    //   359: dup
    //   360: invokespecial 270	android/content/Intent:<init>	()V
    //   363: astore_1
    //   364: aload_1
    //   365: ldc_w 456
    //   368: invokevirtual 460	android/content/Intent:addFlags	(I)Landroid/content/Intent;
    //   371: pop
    //   372: aload_1
    //   373: ldc_w 462
    //   376: iconst_1
    //   377: invokevirtual 448	android/content/Intent:putExtra	(Ljava/lang/String;Z)Landroid/content/Intent;
    //   380: pop
    //   381: aload_0
    //   382: aload_1
    //   383: ldc_w 464
    //   386: iconst_0
    //   387: invokestatic 469	com/tencent/mobileqq/app/utils/RouteUtils:a	(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;I)V
    //   390: iconst_1
    //   391: ireturn
    //   392: aload_0
    //   393: aload 5
    //   395: invokespecial 365	cooperation/qqfav/widget/QfavJumpActivity:a	(Landroid/content/Intent;)Z
    //   398: ifne +7 -> 405
    //   401: aload_0
    //   402: invokespecial 359	com/tencent/mobileqq/app/BaseActivity:finish	()V
    //   405: iconst_1
    //   406: ireturn
    //   407: astore_1
    //   408: goto -157 -> 251
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	416	0	this	QfavJumpActivity
    //   0	416	1	paramBundle	android.os.Bundle
    //   179	234	2	i	int
    //   181	130	3	j	int
    //   171	3	4	bool	boolean
    //   29	365	5	localIntent	Intent
    //   89	211	6	str	String
    ...
    //   346	390	42	java/lang/Exception
    //   392	405	42	java/lang/Exception
    //   125	142	248	java/lang/Exception
    //   147	173	248	java/lang/Exception
    //   182	190	407	java/lang/Exception
    //   192	203	407	java/lang/Exception
    //   211	235	407	java/lang/Exception
  }
