  ...
  implements Handler.Callback
{
  ...
  private String a(Uri paramUri)
  {
    ...
    //   376: aload_0
    //   377: aload_1
    //   378: invokespecial 183	alzm:<init>	(Lcooperation/qqfav/widget/QfavJumpActivity;Ljava/io/InputStream;)V
    ...
    //   400: aload_1
    //   401: lload 4
    //   403: invokespecial 193	alzn:<init>	(Lcooperation/qqfav/widget/QfavJumpActivity;Ljava/lang/String;Ljava/io/InputStream;J)V
  ...
  private void a(String paramString)
  {
    ...
    localQQCustomDialog.setNegativeButton(getString(2131433681), new alzr(this));
  ...
  private void a(String paramString, InputStream paramInputStream, long paramLong)
  {
    ...
    ThreadManager.post(new alzo(this, paramString, paramInputStream, paramLong), 5, null, true);
    if (this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog == null)
    {
      this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = DialogUtil.a(this, getString(2131436278), "取消", new alzp(this));
      this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setOnDismissListener(new alzq(this));
    }
