  ...
  implements View.OnClickListener
{
  ...
  public FavoriteActionSheet(Activity paramActivity, FavoriteActionSheet.Actions paramActions, int paramInt1, int paramInt2, AppRuntime paramAppRuntime)
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetActionSheet.setOnDismissListener(new alzh(this));
    this.jdField_a_of_type_ComTencentWidgetActionSheet.a(new alzi(this));
  }
