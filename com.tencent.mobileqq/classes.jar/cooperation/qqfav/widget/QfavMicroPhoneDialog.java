  ...
  implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener, View.OnClickListener, VoicePlayer.VoicePlayerListener
{
  ...
  public QfavMicroPhoneDialog(Context paramContext, AppRuntime paramAppRuntime, int paramInt, QfavMicroPhoneDialog.Listener paramListener)
  {
    ...
    super.setNegativeButton(2131432998, this);
    super.setPositiveButton(2131431546, this);
    super.setTitle(2131431586);
    ((TextView)super.findViewById(2131364010)).setGravity(3);
    ...
    this.jdField_a_of_type_AndroidWidgetButton.setId(2131363762);
    this.jdField_a_of_type_AndroidWidgetButton.setTextColor(-1);
    this.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130841512);
    ...
    this.jdField_a_of_type_AndroidWidgetButton.setCompoundDrawablesWithIntrinsicBounds(2130841517, 0, 0, 0);
    this.jdField_a_of_type_AndroidWidgetButton.setHeight(k);
    paramContext.addView(this.jdField_a_of_type_AndroidWidgetButton);
    super.findViewById(2131362758).setVisibility(8);
    paramAppRuntime = (RelativeLayout)super.findViewById(2131364008);
    paramListener = new RelativeLayout.LayoutParams(0, -2);
    paramListener.addRule(3, 2131364010);
    paramListener.addRule(5, 2131364010);
    paramListener.addRule(7, 2131364010);
    paramListener.bottomMargin = i;
    paramListener.topMargin = paramInt;
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)super.findViewById(2131363479));
    this.jdField_a_of_type_AndroidWidgetEditText.setHint(2131431628);
    ...
    paramContext.setId(2131364094);
    ((RelativeLayout.LayoutParams)localObject).addRule(3, 2131364094);
