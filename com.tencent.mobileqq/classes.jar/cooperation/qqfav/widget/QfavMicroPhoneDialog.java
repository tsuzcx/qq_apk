  ...
  implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener, View.OnClickListener, VoicePlayer.VoicePlayerListener
{
  ...
  public QfavMicroPhoneDialog(Context paramContext, AppRuntime paramAppRuntime, int paramInt, QfavMicroPhoneDialog.Listener paramListener)
  {
    ...
    super.setContentView(2131559099);
    super.setNegativeButton(2131690800, this);
    super.setPositiveButton(2131692258, this);
    super.setTitle(2131689619);
    ((TextView)super.findViewById(2131365811)).setGravity(3);
    ...
    this.jdField_a_of_type_AndroidWidgetButton.setId(2131373606);
    this.jdField_a_of_type_AndroidWidgetButton.setTextColor(-1);
    this.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130844296);
    this.jdField_a_of_type_AndroidGraphicsDrawableAnimationDrawable = ((AnimationDrawable)this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130844318));
    this.jdField_a_of_type_AndroidWidgetButton.setCompoundDrawablesWithIntrinsicBounds(2130844301, 0, 0, 0);
    this.jdField_a_of_type_AndroidWidgetButton.setHeight(k);
    paramContext.addView(this.jdField_a_of_type_AndroidWidgetButton);
    super.findViewById(2131365807).setVisibility(8);
    paramAppRuntime = (RelativeLayout)super.findViewById(2131365803);
    paramListener = new RelativeLayout.LayoutParams(0, -2);
    paramListener.addRule(3, 2131365811);
    paramListener.addRule(5, 2131365811);
    paramListener.addRule(7, 2131365811);
    paramListener.bottomMargin = i;
    paramListener.topMargin = paramInt;
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)super.findViewById(2131369141));
    this.jdField_a_of_type_AndroidWidgetEditText.setHint(2131692264);
    ...
    paramContext.setId(2131365304);
    ((RelativeLayout.LayoutParams)localObject).addRule(3, 2131365304);
