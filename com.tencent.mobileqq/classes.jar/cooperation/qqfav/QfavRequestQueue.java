...
public class QfavRequestQueue
{
  ...
  public QfavRequestQueue.RequestItem a(long paramLong)
  {
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      ...
      {
        QfavRequestQueue.RequestItem localRequestItem = (QfavRequestQueue.RequestItem)localIterator.next();
  ...
  public byte[] a()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      ...
      if (localIterator.hasNext()) {
        localArrayList1.add(((QfavRequestQueue.RequestItem)localIterator.next()).jdField_a_of_type_AndroidContentIntent.getExtras());
      }
    }
