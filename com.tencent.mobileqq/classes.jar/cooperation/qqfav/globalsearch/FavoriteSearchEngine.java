  ...
  implements aypx<birs>
{
  ...
  private List<birs> jdField_a_of_type_JavaUtilList = new ArrayList();
  private Thread b;
  ...
  public List<birs> a(ayql paramayql)
  {
    if (paramayql != null) {}
    int i;
    long l;
    ...
    for (;;)
    {
      try
      {
        if (paramayql.jdField_a_of_type_JavaLangString != null)
        {
          i = paramayql.jdField_a_of_type_JavaLangString.trim().length();
          if (i != 0) {}
        }
        else
        {
        ...
        if (!jdField_a_of_type_Boolean) {
          jdField_a_of_type_Boolean = biqv.a(false);
        }
        this.jdField_a_of_type_CooperationQqfavGlobalsearchFavoriteSearchEngine$SearchRunnable.jdField_a_of_type_Ayql = paramayql;
        if (paramayql.jdField_a_of_type_AndroidOsBundle == null) {
          break label1090;
        }
        i = paramayql.jdField_a_of_type_AndroidOsBundle.getInt("iNumber", 1);
        l = paramayql.jdField_a_of_type_AndroidOsBundle.getLong("lModifyTime", 9223372036854775807L);
        bool2 = paramayql.jdField_a_of_type_AndroidOsBundle.getBoolean("bMore", false);
        bool1 = paramayql.jdField_a_of_type_AndroidOsBundle.getBoolean("bSearchNet", false);
        if ((!paramayql.jdField_a_of_type_JavaLangString.equals(this.jdField_a_of_type_JavaLangString)) || ((bool1) && (this.jdField_a_of_type_Int == 1)))
        {
      ...
      for (;;)
      {
        synchronized (this.jdField_a_of_type_CooperationQqfavGlobalsearchFavoriteSearchEngine$QueryRunnable)
        {
          ...
          try
          {
            ...
            ??? = new birs();
            ((birs)???).jdField_a_of_type_JavaLangString = paramayql.jdField_a_of_type_JavaLangString;
            ((birs)???).jdField_a_of_type_Long = ((Cursor)localObject1).getLong(0);
            ((birs)???).jdField_b_of_type_Long = ((Cursor)localObject1).getLong(4);
            ((birs)???).jdField_c_of_type_Long = ((Cursor)localObject1).getLong(5);
            ((birs)???).jdField_b_of_type_JavaLangString = ((Cursor)localObject1).getString(1);
            ((birs)???).jdField_c_of_type_JavaLangString = ((Cursor)localObject1).getString(2);
            ((birs)???).jdField_d_of_type_JavaLangString = ((Cursor)localObject1).getString(3);
            ((birs)???).e = ((Cursor)localObject1).getInt(6);
            ((birs)???).jdField_d_of_type_Int = ((Cursor)localObject1).getInt(8);
            ((birs)???).jdField_a_of_type_ArrayOfByte = ((Cursor)localObject1).getBlob(7);
            ((birs)???).f = ((Cursor)localObject1).getInt(9);
            if (((Cursor)localObject1).getInt(10) <= 0) {
              break label1139;
            }
            bool3 = true;
            ((birs)???).jdField_a_of_type_Boolean = bool3;
            ((birs)???).jdField_b_of_type_Int = ((Cursor)localObject1).getInt(11);
            ((birs)???).jdField_c_of_type_Int = ((Cursor)localObject1).getInt(12);
            ((birs)???).jdField_a_of_type_Int = ((Cursor)localObject1).getInt(13);
            ((birs)???).g = ((Cursor)localObject1).getInt(14);
            ((birs)???).h = this.jdField_a_of_type_JavaUtilList.size();
            this.jdField_a_of_type_JavaUtilList.add(???);
            if (((Cursor)localObject1).moveToNext()) {
              continue;
            }
            if (((birs)???).jdField_a_of_type_Long < 0L)
            {
              if (((birs)???).jdField_a_of_type_Long != -2L) {
                break label918;
              }
              this.jdField_a_of_type_Long = ((birs)???).jdField_b_of_type_Long;
              if (!bool1) {
                break label1145;
              }
              j = 2;
          ...
          n = k - j;
          paramayql = (birs)this.jdField_a_of_type_JavaUtilList.get(n);
          if (paramayql.g > ((birs)this.jdField_a_of_type_JavaUtilList.get(n + 1)).g)
          {
            this.jdField_a_of_type_JavaUtilList.set(n, this.jdField_a_of_type_JavaUtilList.get(n + 1));
            this.jdField_a_of_type_JavaUtilList.set(n + 1, paramayql);
          }
          j -= 1;
          continue;
        ...
        label918:
        if ((localInterruptedException.getCount() > 1) || (l > ((birs)???).jdField_b_of_type_Long)) {
          this.jdField_a_of_type_Long = ((birs)???).jdField_b_of_type_Long;
        } else {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if ((this.jdField_a_of_type_Int == -1) && (this.jdField_a_of_type_JavaUtilList.size() > 0)) {
          ((birs)this.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_JavaUtilList.size() - 1)).jdField_a_of_type_Long = -3L;
        }
        localArrayList = new ArrayList(this.jdField_a_of_type_JavaUtilList);
        paramayql = localArrayList;
        if (bool2) {
          break;
        }
        if (this.jdField_a_of_type_JavaUtilList.size() <= 1) {
  ...
  public void a(ayql paramayql, aypy<birs> paramaypy)
  {
    ...
    {
      this.jdField_a_of_type_CooperationQqfavGlobalsearchFavoriteSearchEngine$SearchRunnable.jdField_a_of_type_Ayql = paramayql;
      this.jdField_a_of_type_CooperationQqfavGlobalsearchFavoriteSearchEngine$SearchRunnable.jdField_a_of_type_Aypy = paramaypy;
  ...
  public void b()
  {
    synchronized (this.jdField_a_of_type_CooperationQqfavGlobalsearchFavoriteSearchEngine$SearchRunnable)
    {
      this.jdField_a_of_type_CooperationQqfavGlobalsearchFavoriteSearchEngine$SearchRunnable.jdField_a_of_type_Ayql = null;
      this.jdField_a_of_type_CooperationQqfavGlobalsearchFavoriteSearchEngine$SearchRunnable.jdField_a_of_type_Aypy = null;
      ThreadManager.removeJobFromThreadPool(this.jdField_a_of_type_CooperationQqfavGlobalsearchFavoriteSearchEngine$SearchRunnable, 32);
