...
class TroopPluginManager$1
  implements Runnable
{
  TroopPluginManager$1(TroopPluginManager paramTroopPluginManager, String paramString, bjyn parambjyn) {}
  ...
  public void run()
  {
    ...
    if (((bimg)((QQAppInterface)localObject).getManager(27)).isPlugininstalled(this.jdField_a_of_type_JavaLangString))
    {
      localObject = this.this$0.jdField_a_of_type_AndroidOsHandler.obtainMessage(1001);
      ((Message)localObject).obj = this.jdField_a_of_type_Bjyn;
    ...
    ThreadManager.post(new TroopPluginManager.InstallRunable(this.this$0, this.jdField_a_of_type_Bjyn, this.jdField_a_of_type_JavaLangString), 8, null, true);
  }
}
