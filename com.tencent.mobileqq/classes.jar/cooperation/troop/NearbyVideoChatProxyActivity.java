  ...
  extends TroopBaseProxyActivity
{
  ...
  protected static void a(Activity paramActivity, Intent paramIntent, Dialog paramDialog, String paramString1, AppInterface paramAppInterface, String paramString2, oidb_0x8dd.SelfInfo paramSelfInfo, int paramInt)
  {
    ...
    localObject = new bfdi(1);
    ((bfdi)localObject).jdField_b_of_type_JavaLangString = "nearby_video_chat_plugin.apk";
    ((bfdi)localObject).d = PluginInfo.l;
    ((bfdi)localObject).jdField_a_of_type_JavaLangString = paramAppInterface.getCurrentAccountUin();
    ((bfdi)localObject).e = paramString1;
    ((bfdi)localObject).jdField_a_of_type_JavaLangClass = NearbyVideoChatProxyActivity.class;
    paramString1 = paramIntent;
    if (paramIntent == null) {
      paramString1 = new Intent();
    }
    ((bfdi)localObject).jdField_a_of_type_AndroidContentIntent = paramString1;
    ((bfdi)localObject).jdField_a_of_type_AndroidAppDialog = paramDialog;
    ((bfdi)localObject).jdField_a_of_type_AndroidContentIntent.putExtra("userQqResources", 2);
    ((bfdi)localObject).jdField_a_of_type_AndroidContentIntent.putExtra("param_plugin_gesturelock", true);
    ((bfdi)localObject).jdField_a_of_type_AndroidContentIntent.putExtra("sessionType", 2);
    ((bfdi)localObject).jdField_a_of_type_AndroidContentIntent.putExtra("uinType", 10003);
    ((bfdi)localObject).jdField_a_of_type_AndroidContentIntent.putExtra("MultiAVType", 0);
    ((bfdi)localObject).jdField_a_of_type_AndroidContentIntent.putExtra("lon", l2);
    ((bfdi)localObject).jdField_a_of_type_AndroidContentIntent.putExtra("lat", l1);
    if (!TextUtils.isEmpty(paramString2)) {
      ((bfdi)localObject).jdField_a_of_type_AndroidContentIntent.putExtra("nearbyVideoConfig", paramString2);
    }
    if ((paramAppInterface instanceof QQAppInterface))
    {
      ...
      if ((paramIntent.c()) && (paramIntent.a().k()))
      {
        ...
        ((bfdi)localObject).jdField_a_of_type_AndroidContentIntent.putExtra("Fromwhere", "SmallScreen");
      }
    }
    paramIntent = ((bfdi)localObject).jdField_a_of_type_AndroidContentIntent;
    boolean bool;
    int i;
    int j;
    int k;
    if (paramSelfInfo != null)
    {
      ...
      ((bfdi)localObject).jdField_a_of_type_AndroidContentIntent.putExtra("selfInfoLevel", paramSelfInfo.uint32_charm_level.get());
      ((bfdi)localObject).jdField_a_of_type_AndroidContentIntent.putExtra("selfInfoAge", paramSelfInfo.uint32_age.get());
      ((bfdi)localObject).jdField_a_of_type_AndroidContentIntent.putExtra("selfInfoGender", paramSelfInfo.uint32_gender.get() + 1);
    ...
    for (;;)
    {
      ...
      ((bfdi)localObject).c = 10000;
      ((bfdi)localObject).f = null;
      paramIntent = null;
      if (paramInt == 123987) {
        paramIntent = new bgnn(paramActivity);
      }
      bfcz.a(paramActivity, (bfdi)localObject, paramIntent);
      awqx.b(null, "dc00899", "grp_lbs", "", "video_chat", "num_entry", 0, 0, i + "", j + "", k + "", "");
      return;
      bool = false;
      break;
      label557:
