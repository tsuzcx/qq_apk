  ...
  extends RemoteCommand
{
  ...
  public Bundle invoke(Bundle paramBundle, RemoteCommand.OnInvokeFinishLinstener paramOnInvokeFinishLinstener)
  {
    ...
    for (;;)
    {
      ...
      localObject2 = ((FriendsManager)localObject1).b(paramBundle);
      if ((localObject2 == null) || (!((Friends)localObject2).isFriend())) {
        break label1318;
      }
      paramBundle = ((FriendsManager)localObject1).a(paramBundle);
    ...
    for (long l1 = MessageCache.a();; l1 = 0L)
    {
      ...
      break;
      paramBundle = paramBundle.getString("troopUin");
      ((TroopHandler)this.a.getBusinessHandler(BusinessHandlerFactory.TROOP_HANDLER)).k(paramBundle);
      paramBundle = localBundle;
      break;
      paramBundle = paramBundle.getString("troopUin");
      ((TroopHandler)this.a.getBusinessHandler(BusinessHandlerFactory.TROOP_HANDLER)).j(paramBundle);
      paramBundle = localBundle;
      break;
      paramBundle = paramBundle.getString("uin");
      paramBundle = MutualMarkDataCenter.a(this.a, paramBundle, false);
      if (paramBundle != null)
      {
        localObject1 = IntimateUtil.a(this.a.getApp(), paramBundle.a);
        i = paramBundle.c;
        localBundle.putString("bind_name", (String)localObject1);
