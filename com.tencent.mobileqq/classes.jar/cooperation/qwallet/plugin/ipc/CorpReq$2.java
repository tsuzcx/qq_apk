        ...
        if (((oidb_sso.OIDBSSOPkg)localObject1).bytes_bodybuffer.has())
        {
          ...
          if (((Iterator)localObject4).hasNext())
          {
            ...
            if (QLog.isColorLevel())
            {
              ...
              ((StringBuffer)localObject3).append(bbbd.a((String)localObject1));
              paramBundle = (Bundle)localObject1;
            }
      ...
      catch (Exception paramBundle)
      {
        ...
        if (!TextUtils.isEmpty(this.this$0.memUin))
        {
          ...
          if (TextUtils.isEmpty((CharSequence)localObject1)) {
            paramBundle = bbcl.h(this.val$app, this.this$0.troopUin, this.this$0.memUin);
          }
        ...
        try
        {
          ...
          paramBundle = (Bundle)localObject1;
          if (TextUtils.isEmpty((CharSequence)localObject1)) {
            paramBundle = bbcl.h(this.val$app, this.this$0.troopUin, (String)localObject7);
          }
