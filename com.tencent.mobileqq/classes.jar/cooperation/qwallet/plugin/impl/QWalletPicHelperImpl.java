...
public class QWalletPicHelperImpl
  implements IQWalletPicHelper
{
  ...
  public void decodeDrawable(Drawable paramDrawable, IQWalletPicHelper.OnDecodeListener paramOnDecodeListener)
  {
    ...
    {
      return;
      ThreadManager.excute(new QWalletPicHelperImpl.1(this, paramDrawable, paramOnDecodeListener), 16, null, false);
      return;
    }
    paramOnDecodeListener.onDecodeFinished(true, paramDrawable);
  }
  
  public Drawable getNetDrawableForAIO(String paramString, Drawable paramDrawable)
  {
  ...
  public URLDrawable getNetDrawableForQWallet(String paramString, Drawable paramDrawable1, Drawable paramDrawable2)
  {
 ...
 * Qualified Name:     cooperation.qwallet.plugin.impl.QWalletPicHelperImpl
