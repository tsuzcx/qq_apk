  ...
  implements IFakeUrl
{
  ...
  protected IFakeUrl.FakeInfo fakeInfo = new IFakeUrl.FakeInfo();
  protected IFakeUrl.FakeListener fl = null;
  private DialogInterface.OnClickListener lListener = new FakeUrlImpl.1(this);
  private QQCustomDialog mDialog = null;
  private boolean mIsCloseAfterClickUrl = true;
  private DialogInterface.OnClickListener rListener = new FakeUrlImpl.2(this);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        while (localMatcher.find())
        {
          ...
          localSpannableString.setSpan(new FakeUrlImpl.3(this, str2), 0, str1.length(), 33);
          localSpannableString.setSpan(new ForegroundColorSpan(this.context.getResources().getColor(2131165804)), 0, str1.length(), 33);
  ...
  public boolean onFakePros(String paramString1, String paramString2, IFakeUrl.FakeListener paramFakeListener)
  {
    try
    {
  ...
  public boolean onFakePros(String paramString, JSONObject paramJSONObject, IFakeUrl.FakeListener paramFakeListener)
  {
    ...
    {
      this.mDialog = new QQCustomDialog(this.context, 2131755842);
      this.mDialog.setContentView(2131559084);
 ...
 * Qualified Name:     cooperation.qwallet.plugin.impl.FakeUrlImpl
