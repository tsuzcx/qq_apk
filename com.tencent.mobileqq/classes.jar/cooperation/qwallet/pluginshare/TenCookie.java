...
public class TenCookie
{
  ...
  public static TenCookie a()
  {
    return TenCookie.Instance.a;
  }
  ...
  {
    return MD5.toMD5(MD5.toMD5(new StringBuilder().append(paramString).append("_").append(DeviceInfoUtil.a()).toString()) + "q$WaQ3#k").substring(8, 24);
  }
 ...
 * Qualified Name:     cooperation.qwallet.pluginshare.TenCookie
