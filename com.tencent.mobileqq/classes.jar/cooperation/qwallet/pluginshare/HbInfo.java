...
public class HbInfo
{
  ...
  public static void a(Bundle paramBundle, HbInfo.BundleInfo paramBundleInfo)
  {
    ...
    for (Object localObject = paramBundleInfo.getClass(); localObject != null; localObject = ((Class)localObject).getSuperclass()) {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (str2.equals("String")) {
            ((Field)localObject).set(paramBundleInfo, str3);
          }
        }
 ...
 * Qualified Name:     cooperation.qwallet.pluginshare.HbInfo
