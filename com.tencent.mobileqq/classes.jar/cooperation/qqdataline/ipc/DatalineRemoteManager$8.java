...
public class DatalineRemoteManager$8
  implements Runnable
{
  public DatalineRemoteManager$8(bkok parambkok, FileManagerEntity paramFileManagerEntity, ForwardFileInfo paramForwardFileInfo) {}
  ...
  public void run()
  {
    ...
    {
      if (!aszt.b(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.getFilePath())) {
        break label163;
      }
