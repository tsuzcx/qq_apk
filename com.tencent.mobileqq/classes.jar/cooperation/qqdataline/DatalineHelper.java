...
public class DatalineHelper
{
  ...
  public static com.tencent.common.app.AppInterface a(BaseApplicationImpl paramBaseApplicationImpl, String paramString)
  {
    ...
    //   22: invokestatic 46	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   25: aload_0
    //   26: ifnull +7 -> 33
    //   29: aload_1
    //   30: ifnonnull +13 -> 43
    ...
    //   35: iconst_1
    //   36: ldc 48
    //   38: invokestatic 51	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   41: aconst_null
    //   42: areturn
    //   43: ldc 53
    //   45: invokestatic 59	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   48: astore_2
    //   49: aload_2
    //   50: ifnonnull +41 -> 91
    //   53: ldc 27
    //   55: iconst_1
    //   56: ldc 61
    //   58: invokestatic 51	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   61: aconst_null
    //   62: areturn
    //   63: astore_3
    //   64: aload_0
    //   65: invokestatic 64	cooperation/qqdataline/DatalineHelper:a	(Landroid/content/Context;)Ljava/lang/ClassLoader;
    //   68: astore 4
    //   70: aload 4
    //   72: ldc 53
    //   74: invokevirtual 69	java/lang/ClassLoader:loadClass	(Ljava/lang/String;)Ljava/lang/Class;
    //   77: astore_2
    //   78: iconst_1
    //   79: aload 4
    //   81: invokestatic 75	com/qq/jce/wup/BasicClassTypeUtil:setClassLoader	(ZLjava/lang/ClassLoader;)V
    //   84: aload_3
    //   85: invokevirtual 78	java/lang/ClassNotFoundException:printStackTrace	()V
    //   88: goto -39 -> 49
    //   91: aload_2
    //   92: iconst_2
    //   93: anewarray 55	java/lang/Class
    //   96: dup
    //   97: iconst_0
    //   98: aload_0
    //   99: invokevirtual 82	java/lang/Object:getClass	()Ljava/lang/Class;
    //   102: aastore
    //   103: dup
    //   104: iconst_1
    //   105: aload_1
    //   106: invokevirtual 82	java/lang/Object:getClass	()Ljava/lang/Class;
    //   109: aastore
    //   110: invokevirtual 86	java/lang/Class:getDeclaredConstructor	([Ljava/lang/Class;)Ljava/lang/reflect/Constructor;
    //   113: iconst_2
    ...
    //   123: aload_1
    //   124: aastore
    //   125: invokevirtual 92	java/lang/reflect/Constructor:newInstance	([Ljava/lang/Object;)Ljava/lang/Object;
    //   128: astore_0
    //   129: aload_0
    //   130: ifnull +15 -> 145
    //   133: aload_0
    ...
    //   137: ifeq +8 -> 145
    //   140: aload_0
    //   141: checkcast 94	com/tencent/common/app/AppInterface
    //   144: areturn
    //   145: ldc 27
    //   147: iconst_1
    //   148: ldc 96
    //   150: invokestatic 51	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   153: aconst_null
    //   154: areturn
    //   155: astore_0
    //   156: aload_0
    //   157: invokevirtual 78	java/lang/ClassNotFoundException:printStackTrace	()V
    //   160: goto -7 -> 153
    //   163: astore_0
    //   164: aload_0
    //   165: invokevirtual 97	java/lang/IllegalArgumentException:printStackTrace	()V
    //   168: goto -15 -> 153
    //   171: astore_0
    //   172: aload_0
    //   173: invokevirtual 98	java/lang/IllegalAccessException:printStackTrace	()V
    //   176: goto -23 -> 153
    //   179: astore_0
    //   180: aload_0
    //   181: invokevirtual 99	java/lang/InstantiationException:printStackTrace	()V
    //   184: goto -31 -> 153
    //   187: astore_0
    //   188: aload_0
    //   189: invokevirtual 100	java/lang/reflect/InvocationTargetException:printStackTrace	()V
    //   192: goto -39 -> 153
    //   195: astore_0
    //   196: aload_0
    //   197: invokevirtual 101	java/lang/NoSuchMethodException:printStackTrace	()V
    //   200: goto -47 -> 153
    //   203: astore_0
    //   204: aload_0
    //   205: invokevirtual 102	java/lang/Exception:printStackTrace	()V
    //   208: goto -55 -> 153
  ...
  public static void a(String paramString, int paramInt)
  {
    ...
    {
      ReportController.b((AppRuntime)localObject, "CliOper", "", "", "DatalineClickReport", paramString, 0, paramInt, 0, "", "", "", "");
      return;
    }
  }
}
