...
import cooperation.qqreader.QRJumpAction;
  ...
  implements MultiNameSpacePluginCompact
{
  ...
  private ReaderJsPluginHelper jdField_a_of_type_CooperationQqreaderJsReaderJsPluginHelper = new ReaderJsPluginHelper(this);
  private ReaderJsCallback jdField_a_of_type_CooperationQqreaderProxyReaderJsCallback = new ReaderJsPlugin.1(this);
  private ReaderJsPluginProxy jdField_a_of_type_CooperationQqreaderProxyReaderJsPluginProxy = null;
  ...
  private void a(JsBridgeListener paramJsBridgeListener, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramJsBridgeListener))
    {
      ...
      paramString.put("graylevel", GrayUpdateManager.a());
      paramString.put("is_update_newstyle", GrayUpdateManager.a());
  ...
  private void a(JSONObject paramJSONObject)
  {
    ...
    android.util.Log.i("ReaderJsPlugin", "registerWebSearch");
  ...
  private void b(String paramString)
  {
    ...
    localIntent.putExtras(QRJumpAction.a(localIntent, 2));
  ...
  private void b(String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    {
      cooperation.qqreader.utils.Log.e("ReaderJsPlugin", "pluginHandleJS ->  handleJsCall");
      a(paramString1, paramString2, paramString3, paramVarArgs);
      return;
    }
    cooperation.qqreader.utils.Log.e("ReaderJsPlugin", "js plugin is not ready...");
    ...
    this.jdField_a_of_type_CooperationQqreaderJsReaderJsPluginHelper.a(paramString1, paramString2, paramString3, paramVarArgs);
  }
  ...
  public ReaderJsPlugin a(Handler paramHandler)
  {
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    this.b = paramString2;
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new ReaderJsPlugin.2(this));
  }
  ...
  void a(String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    {
      cooperation.qqreader.utils.Log.d("ReaderJsPlugin", "create a new js plugin");
      this.jdField_a_of_type_CooperationQqreaderProxyReaderJsPluginProxy = QRPluginManagerClient.a().a(this.jdField_a_of_type_CooperationQqreaderProxyReaderJsCallback);
    }
    if (this.jdField_a_of_type_CooperationQqreaderProxyReaderJsPluginProxy != null)
    {
      ...
      cooperation.qqreader.utils.Log.d("ReaderJsPlugin", "create a new js ,method=" + paramString3);
    }
    do
    {
      return;
      cooperation.qqreader.utils.Log.a("ReaderJsPlugin", "handleJsCall mJsPlugin is null!");
  ...
  public boolean b()
  {
    ...
    for (;;)
    {
      android.util.Log.i("ReaderJsPlugin", "registerWebSearch callWebSearch=" + bool);
      return bool;
      bool = false;
    }
  }
  ...
  {
    cooperation.qqreader.utils.Log.e("ReaderJsPlugin", "handleJsRequest, url=" + paramString1 + " ,pakName=" + paramString2 + " ,method=" + paramString3);
    ...
    else if ("JSContent".equals(paramString2))
    {
      if ("registerWebSearch".equals(paramString3))
      {
        ...
        catch (JSONException paramJsBridgeListener)
        {
          for (;;)
          {
            cooperation.qqreader.utils.Log.a("ReaderJsPlugin", "Failed to parse json str,json=" + paramVarArgs[0]);
          }
        }
      }
      ...
      if ("JSbookshelf".equals(paramString2))
      {
        if ("getGrayUpdateData".equals(paramString3))
        {
          ...
          catch (Exception paramJsBridgeListener)
          {
            for (;;)
            {
              cooperation.qqreader.utils.Log.e("ReaderJsPlugin", paramJsBridgeListener.getMessage());
            }
          }
        }
  ...
  public void onCreate()
  {
    ...
    this.jdField_a_of_type_CooperationQqreaderJsReaderJsPluginHelper.a();
  }
  ...
  public void onDestroy()
  {
    ...
    this.jdField_a_of_type_CooperationQqreaderJsReaderJsPluginHelper.b();
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes13.jar
 * Qualified Name:     cooperation.qqreader.js.ReaderJsPlugin
