...
public class ReaderTabConfigDataHelper
{
  public static final int a;
  public static final int b;
  public static final int c;
  private Context jdField_a_of_type_AndroidContentContext;
  private INetInfoHandler jdField_a_of_type_ComTencentMobileqqMsfSdkHandlerINetInfoHandler = new ReaderTabConfigDataHelper.1(this);
  private ReaderCgiListener jdField_a_of_type_CooperationQqreaderNetReaderCgiListener = new ReaderTabConfigDataHelper.2(this);
  private String jdField_a_of_type_JavaLangString = "#FDFDFD";
  private ArrayList<TabItemData> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  private ArrayList<TabItemData> jdField_b_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public ReaderTabConfigDataHelper(Activity paramActivity)
  {
  ...
  private String a(String paramString)
  {
    ...
    for (paramString = "&";; paramString = "?")
    {
      ...
      if (!((String)localObject).contains("&ChannelID=")) {
        paramString = (String)localObject + "&ChannelID=" + Utility.a();
      }
      localObject = paramString;
      if (QRDebugEnvUrlUtils.isDebugEnv()) {
        localObject = QRDebugEnvUrlUtils.getTestUrl(paramString);
      }
      Log.e("ReaderTabConfigDataHelper", " url=" + (String)localObject);
      return localObject;
    }
  }
  ...
  private void a(ArrayList<TabItemData> paramArrayList)
  {
    ...
    while (i < j)
    {
      ...
      this.jdField_c_of_type_ArrayOfJavaLangString[i] = localTabItemData.jdField_c_of_type_JavaLangString;
      int k = localTabItemData.jdField_a_of_type_Int;
  ...
  private boolean a(ArrayList<TabItemData> paramArrayList1, ArrayList<TabItemData> paramArrayList2)
  {
    ...
    if (paramArrayList1.size() == paramArrayList2.size())
    {
      ...
      while (i < j)
      {
        if (!((TabItemData)paramArrayList1.get(i)).equals(paramArrayList2.get(i))) {
          return false;
        }
        i += 1;
      }
  ...
  private boolean a(JSONObject paramJSONObject, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      localObject1 = new TabItemData(((JSONObject)localObject1).optInt("tabID", -1), ((JSONObject)localObject1).optString("tabName"), ((JSONObject)localObject1).optString("n_tabIcon"), ((JSONObject)localObject1).optString("h_tabIcon"), localArrayList, k);
      if (k != 0) {
        break label397;
      }
    ...
    {
      Config.UserConfig.d(paramJSONObject, paramBoolean);
  ...
  private void e()
  {
    ...
    for (;;)
    {
      ...
      return;
      Log.d("ReaderTabConfigDataHelper", "tab url from local");
      a(4);
      this.jdField_a_of_type_JavaUtilArrayList.clear();
      TabItemData localTabItemData = new TabItemData();
      localTabItemData.jdField_a_of_type_Int = 100;
      localTabItemData.jdField_a_of_type_JavaLangString = "书城";
      localTabItemData.jdField_b_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_ELPT79nUxC.png";
      localTabItemData.jdField_c_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_AXwBTwpLm8.png";
      ...
      localTabItemData.jdField_a_of_type_JavaUtilArrayList = localArrayList;
      this.jdField_a_of_type_JavaUtilArrayList.add(localTabItemData);
      localTabItemData = new TabItemData();
      localTabItemData.jdField_a_of_type_Int = 101;
      localTabItemData.jdField_a_of_type_JavaLangString = "分类";
      localTabItemData.jdField_b_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_u3wddLskp6.png";
      localTabItemData.jdField_c_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_xYKQeprMCg.png";
      localArrayList = new ArrayList(1);
      localArrayList.add(a("https://cdn.vip.qq.com/club/client/read/6/rel/category_index.html?configfrom=local&_bid=2036"));
      localTabItemData.jdField_a_of_type_JavaUtilArrayList = localArrayList;
      this.jdField_a_of_type_JavaUtilArrayList.add(localTabItemData);
      localTabItemData = new TabItemData();
      localTabItemData.jdField_a_of_type_Int = 102;
      localTabItemData.jdField_a_of_type_JavaLangString = "书架";
      localTabItemData.jdField_b_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_G6VUELHdgC.png";
      localTabItemData.jdField_c_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_f9xtLKYkBV.png";
      localArrayList = new ArrayList(2);
      ...
      this.jdField_a_of_type_JavaUtilArrayList.add(localTabItemData);
      localTabItemData = new TabItemData();
      localTabItemData.jdField_a_of_type_Int = 104;
      localTabItemData.jdField_a_of_type_JavaLangString = "我的";
      localTabItemData.jdField_b_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190604150617_XAeQPgB9Z8.png";
      localTabItemData.jdField_c_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_wdBlMCyKuS.png";
      localArrayList = new ArrayList(1);
  ...
  private void f()
  {
    ...
    {
      Log.a("ReaderTabConfigDataHelper", "getTabConfigDataFromDB," + localJSONException.getMessage());
    }
  }
  ...
  @NonNull
  public ArrayList<TabItemData> a()
  {
  ...
  public String d()
  {
    ...
    return "&height=" + (DisplayUtil.b(this.jdField_a_of_type_AndroidContentContext, i) + 50);
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes13.jar
 * Qualified Name:     cooperation.qqreader.helper.ReaderTabConfigDataHelper
