...
public class QRLocalManager
{
  private static final QRLocalManager jdField_a_of_type_CooperationQqreaderQRLocalManager = new QRLocalManager();
  ...
  public static QRLocalManager a()
  {
    return jdField_a_of_type_CooperationQqreaderQRLocalManager;
  }
  
  private boolean a()
  {
    if (!QRPluginManager.a().a())
    {
      QRPluginManager.a().a();
      return false;
    }
 ...
 * Qualified Name:     cooperation.qqreader.QRLocalManager
