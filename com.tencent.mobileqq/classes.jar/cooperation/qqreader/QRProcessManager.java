  ...
  implements Manager
{
  ...
  public QRProcessManager(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_CooperationComicPluginPreloadStrategy$PreloadServerParam = null;
    this.jdField_a_of_type_CooperationComicPluginPreloadStrategy$PreloadPublicParam = null;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Long = (DeviceInfoUtil.a() / 1048576L);
    c();
  }
  ...
  private void c()
  {
    Object localObject = ((IDPCApi)QRoute.api(IDPCApi.class)).getFeatureValue(DPCNames.qr_process_config.name(), "0|24");
    if (localObject != null)
    {
