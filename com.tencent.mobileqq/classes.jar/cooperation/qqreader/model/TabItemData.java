package cooperation.qqreader.model;
...
public class TabItemData
{
  ...
  public TabItemData(int paramInt1, String paramString1, String paramString2, String paramString3, ArrayList<String> paramArrayList, int paramInt2)
  {
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
        ...
        do
        {
          do
          {
            do
            {
              ...
              paramObject = (TabItemData)paramObject;
              bool1 = bool3;
 ...
 * Qualified Name:     cooperation.qqreader.model.TabItemData
