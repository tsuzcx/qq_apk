...
public class ReaderPluginHelper
{
  private static int a = -1;
  
  public static void a(Context paramContext)
  {
    ReaderShadowImpl.a().enter(paramContext, 1002L, BaseApplicationImpl.getApplication().getRuntime().getAccount(), "", new Bundle(), null);
  }
  ...
  public static void a(Context paramContext, Intent paramIntent, String paramString, EnterCallback paramEnterCallback)
  {
    ...
    ReaderShadowImpl.a().enter(paramContext, 1003L, BaseApplicationImpl.getApplication().getRuntime().getAccount(), "", paramIntent, paramEnterCallback);
  }
  ...
  public static void a(Context paramContext, boolean paramBoolean)
  {
    ...
    {
      Log.c("ReaderPluginHelper", "[loadPluginRuntime] sIsPluginReady = true ! mGrayState = " + a);
      return;
    }
    Log.c("ReaderPluginHelper", "[loadPluginRuntime] sIsPluginReady = false, mGrayState = " + a + " isShadowOnly = " + paramBoolean);
    if (a()) {
      a(paramContext);
    }
    for (;;)
    {
      ReportUtils.a(paramContext, String.valueOf(a));
      return;
      if (paramBoolean) {
        break;
      }
 ...
 * Qualified Name:     cooperation.qqreader.shadow.ReaderPluginHelper
