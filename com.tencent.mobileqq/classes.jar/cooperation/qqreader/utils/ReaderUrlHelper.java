...
public final class ReaderUrlHelper
{
  ...
  public static String a(String paramString, boolean paramBoolean)
  {
    ...
    for (paramString = "&";; paramString = "?")
    {
      ...
      Log.e("ReaderUrlHelper", "getUrlWithBid = " + (String)localObject);
      return localObject;
  ...
  private static String d(String paramString)
  {
    String str2 = null;
    String str1;
    if ((ReaderUrlConfigDataHelper.a != null) && (ReaderUrlConfigDataHelper.a.size() > 0)) {
      str1 = (String)ReaderUrlConfigDataHelper.a.get(paramString);
    }
    for (;;)
    {
      Log.d("ReaderUrlHelper", "getUrl = " + str1);
      return str1;
      if (ReaderUrlConfigDataHelper.a != null) {
        str2 = (String)ReaderUrlConfigDataHelper.a.get(paramString);
      }
      str1 = str2;
      if (str2 == null) {
 ...
 * Qualified Name:     cooperation.qqreader.utils.ReaderUrlHelper
