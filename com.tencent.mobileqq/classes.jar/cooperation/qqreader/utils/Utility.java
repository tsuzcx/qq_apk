...
public final class Utility
{
  ...
  {
    long l1 = SharedPrefrenceForQQ.a(paramContext);
    if (l1 == -1L)
    {
      SharedPrefrenceForQQ.a(paramContext);
      return 0L;
    }
  ...
  public static void a(Activity paramActivity)
  {
    ...
    if (((IDPCApi)QRoute.api(IDPCApi.class)).parseComplexParamsByStringToIntParser(paramActivity, arrayOfInteger) >= arrayOfInteger.length) {
  ...
  public static void a(Context paramContext)
  {
    ...
    localBusinessTask.a(new Utility.1(paramContext), true);
    localBusinessTask.a();
  }
 ...
 * Qualified Name:     cooperation.qqreader.utils.Utility
