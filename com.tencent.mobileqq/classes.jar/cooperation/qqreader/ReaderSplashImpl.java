...
public class ReaderSplashImpl
{
  ...
  private QRPluginManagerClient.OnPluginReadyListener jdField_a_of_type_CooperationQqreaderQRPluginManagerClient$OnPluginReadyListener = new ReaderSplashImpl.1(this);
  private ReaderSplashImpl.StartReaderActCompletedReceiver jdField_a_of_type_CooperationQqreaderReaderSplashImpl$StartReaderActCompletedReceiver;
  private JsCallParams jdField_a_of_type_CooperationQqreaderJsJsCallParams;
  
  public ReaderSplashImpl(Activity paramActivity)
  {
  ...
  private Intent a(Activity paramActivity)
  {
    ...
    localIntent.putExtra("readerDpcConfig", ((IDPCApi)QRoute.api(IDPCApi.class)).getFeatureValue(DPCNames.qr_process_config.name(), "0|0|0|0|0|0"));
    return localIntent;
  }
  ...
  private Intent a(Activity paramActivity, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      if (paramActivity == null)
      {
        ...
        paramBundle.putExtras(QRJumpAction.a(paramBundle, 1));
      }
    ...
    str1 = DeviceInfoUtil.a(paramActivity).a;
    String str2 = Utility.a(paramActivity);
    if (l2 != 0L) {}
    for (paramBundle = String.valueOf(l2);; paramBundle = "")
    {
      ReportUtils.a(str1, str2, "2198", paramBundle, "2", "");
      paramActivity = a(paramActivity);
  ...
  private View a()
  {
    ...
    localTextView.setText(2131693849);
    localTextView.setTextColor(-16777216);
    localTextView.setGravity(17);
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, -2);
    localLayoutParams.addRule(13);
    localTextView.setPadding(0, DisplayUtil.a(this.jdField_a_of_type_AndroidAppActivity, 120.0F), 0, 0);
    localRelativeLayout.addView(localTextView, localLayoutParams);
    this.jdField_a_of_type_AndroidWidgetTextView = localTextView;
    LoadingAnimationManager.a().a(this.jdField_a_of_type_AndroidAppActivity, localImageView);
    return localRelativeLayout;
  }
  
  private void a(Intent paramIntent)
  {
    boolean bool = ReaderPluginHelper.a();
    Log.e("ReaderSplashImpl", "jumpToPlugin: isUseShadow = " + bool);
    if (bool)
    {
      ReaderPluginHelper.a(this.jdField_a_of_type_AndroidAppActivity, paramIntent, "com.qqreader.pureader.SSReaderActivity", new ReaderSplashImpl.3(this));
      return;
    }
  ...
  private void a(View paramView)
  {
    ...
    {
      Log.a("ReaderSplashImpl", "showLoadingView: mContentView == null");
      return;
    }
  ...
  private void a(JsCallParams paramJsCallParams)
  {
    ...
    {
      ReaderJsPluginProxy localReaderJsPluginProxy = QRPluginManagerClient.a().a(new ReaderSplashImpl.2(this));
      ...
      for (;;)
      {
        d();
        return;
        Log.a("ReaderSplashImpl", "checkPluginForHandleSpecialJsCall: plugin is ready but jsPluginProxy is null");
      }
    }
  ...
  private void b(@NonNull Bundle paramBundle)
  {
    if (this.jdField_a_of_type_AndroidAppActivity == null) {
      Log.a("ReaderSplashImpl", "doJump: activity is null");
    }
    Intent localIntent;
    do
    {
    ...
    localIntent.putExtra("login_interval", Utility.a(BaseApplicationImpl.getApplication()));
  ...
  private void c()
  {
    ...
    {
      Log.a("ReaderSplashImpl", "handlePendingJumpPluginIntent: mPendingJumpPluginIntent == null");
      return;
    }
    ...
    {
      Log.b("ReaderSplashImpl", "handlePendingJumpPluginIntent: activity is destroyed");
      return;
    }
    QRJumpAction.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidContentIntent, "com.qqreader.pureader.SSReaderActivity", new ReaderSplashImpl.4(this));
  ...
  public void a()
  {
    Log.d("ReaderSplashImpl", "onCreate");
    Object localObject = new IntentFilter();
    ((IntentFilter)localObject).addAction("cooperation.qqreader.start_reader_act_completed");
    if (this.jdField_a_of_type_CooperationQqreaderReaderSplashImpl$StartReaderActCompletedReceiver == null)
    {
      this.jdField_a_of_type_CooperationQqreaderReaderSplashImpl$StartReaderActCompletedReceiver = new ReaderSplashImpl.StartReaderActCompletedReceiver(this, null);
      this.jdField_a_of_type_AndroidAppActivity.registerReceiver(this.jdField_a_of_type_CooperationQqreaderReaderSplashImpl$StartReaderActCompletedReceiver, (IntentFilter)localObject);
    }
  ...
  public void b()
  {
    if (this.jdField_a_of_type_CooperationQqreaderReaderSplashImpl$StartReaderActCompletedReceiver != null)
    {
      this.jdField_a_of_type_AndroidAppActivity.unregisterReceiver(this.jdField_a_of_type_CooperationQqreaderReaderSplashImpl$StartReaderActCompletedReceiver);
      this.jdField_a_of_type_CooperationQqreaderReaderSplashImpl$StartReaderActCompletedReceiver = null;
    }
  }
}
 ...
 * Qualified Name:     cooperation.qqreader.ReaderSplashImpl
