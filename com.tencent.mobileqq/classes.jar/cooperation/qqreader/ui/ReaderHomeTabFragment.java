  ...
  implements Handler.Callback
{
  ...
  private Handler jdField_b_of_type_AndroidOsHandler = new bkgm(Looper.getMainLooper(), this);
  ...
  private void a(ViewGroup paramViewGroup, boolean paramBoolean)
  {
    if (paramBoolean) {
      if (this.jdField_a_of_type_AndroidViewView == null)
      {
        ...
        this.jdField_a_of_type_AndroidViewView.setId(2131371728);
  ...
  private void a(JSONObject paramJSONObject)
  {
    try
    {
      ...
      blpx.a(bgln.a((Context)localObject).a, blpz.a((Activity)localObject), "69", "335", "", "2", "", "", "");
      blpy.a((Context)localObject, i, j);
      blpy.a((Context)localObject, i, paramJSONObject);
      blpy.a((Context)localObject, i, true);
      return;
    }
  ...
  private void b()
  {
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new blpq(this);
    IntentFilter localIntentFilter = new IntentFilter();
    localIntentFilter.addAction(blow.c);
  ...
  private void c()
  {
    blop localblop = ((ReaderBaseWebActivity)getActivity()).a(this.webView);
    if (localblop != null) {
      localblop.b();
    }
  }
  ...
  public int doCreateLoopStep_InitTitleBar(Bundle paramBundle)
  {
    ...
    blpu.a("ReaderHomeTabFragment", "tabBarView  is null or  tabBarView.getParent() is null");
    return i;
  }
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    blpu.e("ReaderHomeTabFragment", "onCreate");
  }
  ...
  public void onPageFinished(WebView paramWebView, String paramString)
  {
    ...
    String str = bgln.a(getActivity()).a;
    long l2 = 0L;
    ...
    if (getActivity().getIntent().hasExtra("isHomePageFristLaunch"))
    {
      ...
      if (this.jdField_a_of_type_Long > 0L)
      {
        ...
        blpx.a(str, "8", "", 0, 0.0F, 0, l1, paramString);
      }
    }
    long l3 = 0L;
    l2 = l3;
      ...
      if (!b())
      {
        ...
        if (!getActivity().getIntent().hasExtra("isHomePageFristLaunch"))
        {
          ...
          if (l5 > 0L)
          {
            ...
            l2 = l4 - l5;
            boolean bool = blps.a(getActivity());
            blpu.e("ReaderHomeTabFragment", "isFristEnterHomePageFromLeba =" + bool);
            if (!bool) {
              break label450;
            }
            blps.a(getActivity(), false);
            blpx.a(str, "7", "", 0, 0.0F, 0, l2, paramWebView);
          }
        }
      }
    }
    for (;;)
    {
      blpu.e("ReaderHomeTabFragment", "onPageFinished ,fristSwitchTabPageTime=" + l1 + ", homePageFristLaunchTime=" + l2 + ",repoertExtraInfo=" + paramWebView);
      return;
      label450:
      blpx.a(str, "9", "", 0, 0.0F, 0, l2, paramWebView);
    }
  }
  ...
  public void onResume()
  {
    ...
    if ((localReaderTabBarView != null) && (localReaderTabBarView.b())) {
      blpc.a().a("EVENT_PRE_FETCH_GAME_AD_DATA_AND_GET_READ_RECORD", null);
    }
  }
}
