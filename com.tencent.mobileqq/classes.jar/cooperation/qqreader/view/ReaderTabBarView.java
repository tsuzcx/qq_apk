  ...
  extends LinearLayout
{
  ...
  private SparseArray<bfnq> jdField_a_of_type_AndroidUtilSparseArray;
  ...
  private HashMap<Integer, bfns> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  public ReaderTabBarView(Context paramContext, @Nullable AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout$LayoutParams = new LinearLayout.LayoutParams(0, azvv.a(paramContext, 54.0F));
  ...
  {
    Object localObject = (bfnq)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt1);
    if ((localObject == null) || (((bfnq)localObject).jdField_a_of_type_AndroidViewView == null) || (this.jdField_a_of_type_JavaUtilHashMap.containsKey(Integer.valueOf(paramInt1)))) {
      return;
    }
    localObject = (RedTouchUI)new RedTouchUI(this.jdField_a_of_type_AndroidContentContext, ((bfnq)localObject).jdField_a_of_type_AndroidViewView).a(5).a();
    ((RedTouchUI)localObject).setRedpointImgResID(2130849053);
    ((RedTouchUI)localObject).setTextOrNumImgRedID(2130849057);
    paramString = new bfns(this, paramInt2, paramString, paramBoolean, paramInt3, (RedTouchUI)localObject);
  ...
  private void a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    while (i < j)
    {
      bfnq localbfnq = (bfnq)this.jdField_a_of_type_AndroidUtilSparseArray.valueAt(i);
      if (localbfnq != null)
      {
        localbfnq.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(localbfnq.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
        localbfnq.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.d);
        if (paramInt2 == localbfnq.jdField_a_of_type_Int)
        {
          localbfnq.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(localbfnq.jdField_b_of_type_AndroidGraphicsDrawableDrawable);
          localbfnq.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.e);
        }
      }
      i += 1;
    }
    ...
    bfne.d("ReaderTabBarView", "mSelectedTab =" + paramInt1 + ",tabIndex=" + paramInt2 + ",isHumanClick=" + paramBoolean);
  }
  ...
  {
    if (this.jdField_a_of_type_Bfml != null) {
      this.jdField_a_of_type_Bfml.a(paramString);
    }
  }
  ...
  private void a(Map<String, RedAppInfo> paramMap)
  {
    ...
    if (this.jdField_a_of_type_Bfml.a("769.100900")) {
      setRedIconShow(1, true);
    }
    if (this.jdField_a_of_type_Bfml.a("769.100920")) {
      setRedIconShow(0, true);
    }
    if (this.jdField_a_of_type_Bfml.a("769.100916")) {
      setRedIconShow(3, true);
    }
    if (this.jdField_a_of_type_Bfml.a("769.100970")) {
      setRedIconShow(2, true);
    }
    if (this.jdField_a_of_type_Bfml.a("769.100980")) {
      setRedIconShow(6, true);
    }
    if (this.jdField_a_of_type_Bfml.a("769.100990")) {
  ...
  private View[] a(int paramInt, String paramString)
  {
    ...
    bfnt localbfnt = new bfnt(null);
    localbfnt.jdField_a_of_type_AndroidWidgetTextView = localTabItemView.jdField_a_of_type_AndroidWidgetTextView;
    localbfnt.jdField_a_of_type_AndroidWidgetImageView = localTabItemView.jdField_a_of_type_AndroidWidgetImageView;
    localTabItemView.setTag(-3, localbfnt);
    localTabItemView.setBackgroundDrawable(null);
    localTabItemView.setOnClickListener(new bfnr(this, paramInt, this.jdField_a_of_type_JavaUtilList));
  ...
  {
    a(paramInt);
    bfnl.a(this.jdField_a_of_type_AndroidContentContext, paramInt, false);
    a(bfnl.a(this.jdField_a_of_type_AndroidContentContext, paramInt), paramInt, a(paramInt), false, new Object[] { bfnl.a(this.jdField_a_of_type_AndroidContentContext, paramInt) });
  }
  ...
  private void b(int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Bfmk == null) {
      this.jdField_a_of_type_Bfmk = new bfmk();
    }
    ...
    this.jdField_a_of_type_Bfmk.a("EVENT_REPORT_TAB_SWITCH", localBundle);
  }
  
  private void b(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    bfns localbfns = (bfns)this.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(paramInt1));
    if (localbfns == null)
    {
      a(paramInt1, paramBoolean);
      localbfns = (bfns)this.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(paramInt1));
    }
    for (;;)
    {
      if (localbfns != null) {
        localbfns.a(paramInt1, paramBoolean);
      }
      do
      {
        return;
      } while (paramInt2 < localbfns.jdField_b_of_type_Int);
      localbfns.jdField_b_of_type_Int = paramInt2;
      localbfns.jdField_a_of_type_Int = 1;
    }
  }
  ...
  private void d()
  {
    ...
    while (i <= 3)
    {
      if (bfnl.a(this.jdField_a_of_type_AndroidContentContext, i))
      {
        setTextMsg(i, bfnl.a(this.jdField_a_of_type_AndroidContentContext, i), a(i) + 1, true);
        bfnk.a(b(), a(), "69", "335", "", "2", "", "", "");
      }
      i += 1;
    }
  ...
  {
    bfns localbfns = (bfns)this.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(paramInt));
    if (localbfns == null) {
      return 0;
    }
    return localbfns.jdField_b_of_type_Int;
  }
  
  public String a()
  {
    return bfnm.a((Activity)this.jdField_a_of_type_AndroidContentContext);
  }
  ...
  public void a(Intent paramIntent, @NonNull List<WebViewTabBarData> paramList, bbom parambbom)
  {
    ...
    if (paramIntent != null)
    {
      this.jdField_a_of_type_ArrayOfInt = paramIntent.getIntArrayExtra("key_tab_item_ids");
      if (this.jdField_a_of_type_ArrayOfInt == null) {
        bfne.a("ReaderTabBarView", "mItemids is null");
      }
      this.jdField_a_of_type_ArrayOfJavaLangString = paramIntent.getStringArrayExtra("key_report_tab_page_ids");
      this.jdField_b_of_type_ArrayOfJavaLangString = paramIntent.getStringArrayExtra("key_report_tab_module_ids");
      this.jdField_c_of_type_ArrayOfJavaLangString = paramIntent.getStringArrayExtra("key_tab_icon_selected_urls");
      i = paramIntent.getIntExtra("key_tab_main_tab_pos", 0);
      bfne.c("ReaderTabBarView", " targetTabPos=" + i);
      paramIntent.removeExtra("key_tab_main_tab_pos");
      j = paramIntent.getIntExtra("key_tab_color", 16645629);
      paramIntent.removeExtra("key_tab_color");
      setBackgroundDrawable(new ColorDrawable(j));
      this.d = paramIntent.getIntExtra("key_tab_name_color", 0);
      paramIntent.removeExtra("key_tab_name_color");
      this.e = paramIntent.getIntExtra("key_name_selected_color", 0);
      paramIntent.removeExtra("key_tab_name_color");
    }
    for (;;)
    {
      ...
      if (j < m)
      {
        paramIntent = new bfnq();
        paramIntent.jdField_a_of_type_Int = this.jdField_c_of_type_Int;
        if (this.jdField_a_of_type_ArrayOfInt == null) {}
        for (int k = bflv.a(Integer.parseInt(((WebViewTabBarData)paramList.get(j)).tag));; k = this.jdField_a_of_type_ArrayOfInt[this.jdField_c_of_type_Int])
        {
          ...
          parambbom = a(((WebViewTabBarData)paramList.get(j)).tabName);
          paramIntent.jdField_a_of_type_AndroidViewView = parambbom[0];
          paramIntent.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)parambbom[1]);
          paramIntent.jdField_a_of_type_AndroidWidgetTextView = ((TextView)parambbom[2]);
          paramIntent.jdField_a_of_type_AndroidGraphicsDrawableDrawable = bfnm.a(((WebViewTabBarData)paramList.get(j)).tabIcon);
          paramIntent.jdField_b_of_type_AndroidGraphicsDrawableDrawable = bfnm.a(this.jdField_c_of_type_ArrayOfJavaLangString[this.jdField_c_of_type_Int]);
      ...
      i = bfnc.c(this.jdField_a_of_type_AndroidContentContext);
      if (i > 0)
      {
        a(0, i);
        bfnk.a(b(), a(), "69", "335", "", "2", "", "", "");
  ...
  public boolean a(int paramInt)
  {
    ...
    return ((bfns)this.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(paramInt))).jdField_a_of_type_Boolean;
  }
  
  public String b()
  {
    return babp.a(this.jdField_a_of_type_AndroidContentContext).jdField_a_of_type_JavaLangString;
  }
  ...
  public void setSelectedTab(int paramInt, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Int != paramInt)
    {
      if (this.jdField_a_of_type_Bbom != null) {
        this.jdField_a_of_type_Bbom.onTabSelected(this.jdField_a_of_type_Int, paramInt);
      }
  ...
  public void setTextMsg(int paramInt1, String paramString, int paramInt2, boolean paramBoolean)
  {
    ...
    for (paramString = (bfns)this.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(paramInt1));; paramString = localbfns)
    {
      if (paramString != null) {
      ...
      localbfns.jdField_b_of_type_Int = paramInt2;
      localbfns.jdField_a_of_type_Int = 2;
      localbfns.jdField_a_of_type_JavaLangString = paramString;
    }
  }
  ...
  public void setUnReadMsg(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      if (localbfns != null) {
        localbfns.a(paramInt1, true);
      }
      do
      {
        return;
      } while (paramInt3 < localbfns.jdField_b_of_type_Int);
      localbfns.jdField_b_of_type_Int = paramInt3;
      localbfns.jdField_a_of_type_Int = 3;
      localbfns.jdField_a_of_type_JavaLangString = String.valueOf(paramInt2);
    }
  }
}
