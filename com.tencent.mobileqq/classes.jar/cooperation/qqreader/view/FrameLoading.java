  ...
  extends FrameLayout
{
  ...
  private void a(Context paramContext)
  {
    ...
    int i = DisplayUtil.a(paramContext, 35.0F);
    ...
    localLayoutParams2.setMargins(0, DisplayUtil.a(paramContext, 15.0F) + ImmersiveUtils.getStatusBarHeight(getContext()), 0, 0);
  ...
  {
    this.jdField_a_of_type_AndroidWidgetTextView.setText(getResources().getString(2131716995, new Object[] { Integer.valueOf(paramInt) }));
  }
}
