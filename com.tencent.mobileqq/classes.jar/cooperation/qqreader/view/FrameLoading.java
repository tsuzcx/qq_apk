  ...
  extends FrameLayout
{
  ...
  private void a(Context paramContext)
  {
    ...
    int i = bcwh.a(paramContext, 35.0F);
    ...
    localLayoutParams2.setMargins(0, bcwh.a(paramContext, 15.0F) + ImmersiveUtils.getStatusBarHeight(getContext()), 0, 0);
  ...
  {
    this.jdField_a_of_type_AndroidWidgetTextView.setText(getResources().getString(2131717560, new Object[] { Integer.valueOf(paramInt) }));
  }
}
