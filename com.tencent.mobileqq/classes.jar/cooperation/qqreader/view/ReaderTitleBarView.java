...
public class ReaderTitleBarView
  extends SwiftIphoneTitleBarUI
{
  private Activity jdField_a_of_type_AndroidAppActivity;
  private LinearLayout jdField_a_of_type_AndroidWidgetLinearLayout;
  private RadioGroup jdField_a_of_type_AndroidWidgetRadioGroup = null;
  private Intent b;
  private View c;
  private String e;
  ...
  public ReaderTitleBarView(SwiftBrowserUIStyleHandler paramSwiftBrowserUIStyleHandler)
  {
    super(paramSwiftBrowserUIStyleHandler);
    this.jdField_c_of_type_AndroidViewView = null;
    this.jdField_a_of_type_AndroidAppActivity = paramSwiftBrowserUIStyleHandler.jdField_a_of_type_AndroidAppActivity;
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserUIStyleHandler$SwiftBrowserUIStyle.jdField_a_of_type_Int != i) {
      g(i);
    }
    this.jdField_g_of_type_JavaLangString = DeviceInfoUtil.a(this.jdField_a_of_type_AndroidAppActivity).jdField_a_of_type_JavaLangString;
    this.h = Utility.a(this.jdField_a_of_type_AndroidAppActivity);
  }
  ...
  private ImageView a(int paramInt, String paramString, View.OnClickListener paramOnClickListener)
  {
    if ((this.jdField_a_of_type_AndroidWidgetImageView != null) && (this.jdField_a_of_type_AndroidWidgetImageView.getVisibility() == 0))
    {
      ...
      ((RelativeLayout.LayoutParams)localObject).leftMargin = (((RelativeLayout.LayoutParams)localObject).width + DisplayUtil.a(this.jdField_a_of_type_AndroidAppActivity, 13.0F));
  ...
  {
    paramRadioButton.setBackgroundDrawable(this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130847346));
  ...
  private void i(int paramInt)
  {
    if (this.jdField_a_of_type_AndroidWidgetTextView == null) {
      Log.a("ReaderTitleBarView", "leftView is null");
    }
    ...
    do
    {
      ...
      {
        return;
        localDrawable = this.jdField_a_of_type_AndroidWidgetTextView.getBackground();
  ...
  private void j(int paramInt)
  {
    ...
    if ((!TextUtils.isEmpty(this.e)) && (!TextUtils.isEmpty(this.jdField_f_of_type_JavaLangString))) {
      ...
      default: 
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserUIStyleHandler.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) {
          this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserUIStyleHandler.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.webView.loadUrl(str);
        }
        break;
      }
    }
    for (int i = paramInt;; i = 0)
    {
      k(i);
      return;
      ReportUtils.a(this.jdField_g_of_type_JavaLangString, this.h, "5", "502", "", "3", "", "", "");
      str = this.e;
      paramInt = 0;
      break;
      ReportUtils.a(this.jdField_g_of_type_JavaLangString, this.h, "5", "2206", "", "3", "", "", "");
      paramInt = 1;
  ...
  private void k()
  {
    if (this.jdField_a_of_type_AndroidWidgetLinearLayout == null)
    {
      ...
      localRadioButton.setId(2131375153);
      localLayoutParams = new ViewGroup.LayoutParams(DisplayUtil.a(this.jdField_a_of_type_AndroidAppActivity, 68.0F), DisplayUtil.a(this.jdField_a_of_type_AndroidAppActivity, 34.0F));
      a(localRadioButton, true);
      localRadioButton.setText(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131716990));
      ...
      localRadioButton.setId(2131375154);
      a(localRadioButton, false);
      localRadioButton.setText(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131716992));
      this.jdField_a_of_type_AndroidWidgetRadioGroup.addView(localRadioButton, localLayoutParams);
    }
    this.jdField_a_of_type_AndroidWidgetRadioGroup.setOnCheckedChangeListener(new ReaderTitleBarView.2(this));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.removeAllViews();
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.addView(this.jdField_a_of_type_AndroidWidgetLinearLayout, new ViewGroup.LayoutParams(DisplayUtil.a(this.jdField_a_of_type_AndroidAppActivity, 186.0F), DisplayUtil.a(this.jdField_a_of_type_AndroidAppActivity, 44.0F)));
  }
  ...
  public void a(Intent paramIntent, String paramString)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserUIStyleHandler$SwiftBrowserUIStyle.jdField_a_of_type_JavaLangString = null;
    ...
    if (d())
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserUIStyleHandler.a() != null) && (!this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserUIStyleHandler$SwiftBrowserUIStyle.jdField_a_of_type_Boolean))
      {
        this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserUIStyleHandler$SwiftBrowserUIStyle.s = true;
        a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserUIStyleHandler.a());
      }
    }
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundDrawable(this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130851152));
    int i;
    int j;
    int k;
    int m;
    ...
    if (d())
    {
      ...
      Utility.a(this.jdField_a_of_type_AndroidViewViewGroup, ImmersiveUtils.getStatusBarHeight(this.jdField_a_of_type_AndroidAppActivity));
      if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserUIStyleHandler.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null)
      {
        j = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserUIStyleHandler.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getResources().getDimensionPixelSize(2131299166);
        if (!d()) {
          break label665;
        }
        Utility.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserUIStyleHandler.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.contentView, -i);
        this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserUIStyleHandler.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mNeedStatusTrans = true;
        this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserUIStyleHandler.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mActNeedImmersive = true;
        if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserUIStyleHandler.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mSystemBarComp != null)
        {
          if (!ThemeUtil.isNowThemeIsNight(BaseApplicationImpl.getApplication().getRuntime(), false, null)) {
            break label705;
          }
          this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserUIStyleHandler.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mSystemBarComp.setBackgroundColor(-6710887);
          localObject = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserUIStyleHandler.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getHostActivity().getWindow();
          if (d()) {
            break label783;
          }
          bool = true;
          ImmersiveUtils.setStatusTextColor(bool, (Window)localObject);
          this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserUIStyleHandler$SwiftBrowserUIStyle.i = true;
        }
      }
      ...
      localDrawable = this.jdField_a_of_type_AndroidWidgetImageView.getResources().getDrawable(2130847324);
      if (!d()) {
        break label789;
      }
      localObject = ImageUtil.a(localDrawable, -1);
      label522:
      this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131694094));
      label551:
    ...
    for (;;)
    {
      if (this.jdField_c_of_type_AndroidViewView == null) {
        this.jdField_c_of_type_AndroidViewView = a(2130847325, this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131716991), new ReaderTitleBarView.1(this));
      }
      return;
      f(-16777216);
      d(-16777216);
      ...
      break label311;
      label665:
      if (!(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserUIStyleHandler.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment instanceof ReaderHomeTabFragment)) {
        break label361;
      }
      Utility.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserUIStyleHandler.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.webView, -j - ImmersiveUtils.getStatusBarHeight(this.jdField_a_of_type_AndroidAppActivity));
      break label361;
      label705:
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserUIStyleHandler.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mSystemBarComp.setBackgroundColor(-1);
      ...
      localObject = ImageUtil.a(localDrawable, this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserUIStyleHandler$SwiftBrowserUIStyle.jdField_a_of_type_ComTencentMobileqqWebviewWebViewTitleStyle.e);
      break label522;
      label823:
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      break label551;
      label835:
      Log.a("ReaderTitleBarView", "mTitleBarLeftTabUrl=" + this.e + ",mTitleBarRightTabUrl=" + this.jdField_f_of_type_JavaLangString);
    }
  }
  ...
  public void h(int paramInt)
  {
    if (paramInt > 0)
    {
      ...
      Window localWindow = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserUIStyleHandler.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getHostActivity().getWindow();
      a(d(), localWindow);
    }
  }
}
 ...
 * Qualified Name:     cooperation.qqreader.view.ReaderTitleBarView
