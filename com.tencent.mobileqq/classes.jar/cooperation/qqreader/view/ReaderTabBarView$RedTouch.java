...
class ReaderTabBarView$RedTouch
{
  ...
  public ReaderTabBarView$RedTouch(ReaderTabBarView paramReaderTabBarView, int paramInt1, String paramString, boolean paramBoolean, int paramInt2, RedTouchUI paramRedTouchUI)
  {
      ...
      do
      {
        ...
        for (;;)
        {
          ...
          catch (NumberFormatException localNumberFormatException)
          {
            for (;;)
            {
              Log.a("ReaderTabBarView", localNumberFormatException.getMessage());
              continue;
              paramBoolean = false;
            }
          }
        ...
        catch (JSONException localJSONException)
        {
          for (;;)
          {
            Log.a("ReaderTabBarView", localJSONException.getMessage());
          }
        }
 ...
 * Qualified Name:     cooperation.qqreader.view.ReaderTabBarView.RedTouch
