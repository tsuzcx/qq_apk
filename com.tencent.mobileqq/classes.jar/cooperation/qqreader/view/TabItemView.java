  ...
  extends LinearLayout
{
  ...
  private void a(Context paramContext)
  {
    ...
    LinearLayout.LayoutParams localLayoutParams1 = new LinearLayout.LayoutParams(-1, bggq.a(paramContext, 54.0F));
    this.jdField_a_of_type_AndroidViewView = new View(paramContext);
    LinearLayout.LayoutParams localLayoutParams2 = new LinearLayout.LayoutParams(-1, bggq.a(paramContext, 1.0F));
    localLinearLayout.addView(this.jdField_a_of_type_AndroidViewView, localLayoutParams2);
    this.jdField_a_of_type_AndroidWidgetImageView = new ImageView(paramContext);
    int i = bggq.a(paramContext, 25.0F);
    localLayoutParams2 = new LinearLayout.LayoutParams(i, i);
    localLayoutParams2.gravity = 17;
    localLayoutParams2.setMargins(0, bggq.a(paramContext, 5.0F), 0, bggq.a(paramContext, 2.0F));
