...
public final class QRJumpAction
{
  private static Intent a(Activity paramActivity, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      default: 
        ...
        if (paramIntent.getBooleanExtra("is_from_qreader_shortcut", false)) {
          ...
          {
            Log.e("QRJumpAction", localNumberFormatException.toString());
          }
        } else {
          i = -1;
        }
    ...
    paramActivity.putExtras(paramIntent);
    return paramActivity;
    paramIntent.putExtra("url", ReaderUrlHelper.b(a(paramIntent.getStringExtra("url"))));
    paramIntent.putExtra("item_type", 2);
    paramActivity = new Intent(paramActivity, ReaderContentPageActivity.class);
  ...
  public static Intent a(Activity paramActivity, Intent paramIntent, String paramString)
  {
    ...
    {
      Log.e("QRJumpAction", "jumpAction args error");
      return new Intent();
    }
  ...
  public static void a(Context paramContext, Intent paramIntent, String paramString, IPluginManager.OnOpenPluginListener paramOnOpenPluginListener)
  {
    if ((paramContext == null) || (paramIntent == null) || (TextUtils.isEmpty(paramString)))
    {
      Log.a("QRJumpAction", "jumpToPlugin args error");
      return;
    }
    String str = BaseApplicationImpl.getApplication().getRuntime().getAccount();
    IPluginManager.PluginParams localPluginParams = new IPluginManager.PluginParams(1);
    localPluginParams.b = "qqreaderplugin.apk";
    localPluginParams.e = HardCodeUtil.a(2131711173);
    localPluginParams.jdField_a_of_type_JavaLangString = str;
    localPluginParams.f = paramString;
    localPluginParams.jdField_a_of_type_JavaLangClass = QRPluginProxyActivity.a(paramString);
    ...
    try
    {
      IPluginManager.a(paramContext, localPluginParams, paramOnOpenPluginListener);
      return;
    }
    catch (Exception paramContext)
    {
      Log.a("QRJumpAction", "[jumpToPlugin] error!", paramContext);
    }
  }
}
