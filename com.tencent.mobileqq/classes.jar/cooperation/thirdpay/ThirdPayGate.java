...
public class ThirdPayGate
{
  ...
  private void _newInstallPlugin(Activity paramActivity, PluginInterface paramPluginInterface, Bundle paramBundle, String paramString)
  {
    ...
    Object localObject2 = new anmz(this, paramBundle, paramActivity);
    localObject2 = DialogUtil.a(paramActivity, 0, "下载失败", "当前网络不给力，下载失败", "取消", "继续下载", new anna(this, paramString, paramPluginInterface, paramActivity, paramBundle), (DialogInterface.OnClickListener)localObject2);
    ((QQCustomDialog)localObject2).setCancelable(false);
    Object localObject1 = new annc(this, paramPluginInterface, paramString, System.currentTimeMillis(), new annb(this, paramString, l, (Channel)localObject1, paramBundle, paramActivity, (QQCustomDialog)localObject2));
  ...
  private void _showStartAllTip(Activity paramActivity, PluginInterface paramPluginInterface, Bundle paramBundle, String paramString)
  {
    ...
    paramActivity = DialogUtil.a(paramActivity, 0, "", "当前网络不可用，请检查网络设置！", "确定", "", null, new anmy(this, paramBundle, paramActivity));
  ...
  private void startPlugin(Bundle paramBundle, Activity paramActivity, String paramString)
  {
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        ...
        paramBundle = new anmx(this, paramBundle, paramActivity);
