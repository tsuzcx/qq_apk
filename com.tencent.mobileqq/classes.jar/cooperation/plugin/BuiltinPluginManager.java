...
public class BuiltinPluginManager
{
  ...
  void b()
  {
    ...
    //   0: aconst_null
    //   1: astore_2
    //   2: new 104	java/io/BufferedReader
    //   5: dup
    //   6: new 106	java/io/InputStreamReader
    //   9: dup
    //   10: aload_0
    //   11: getfield 35	cooperation/plugin/BuiltinPluginManager:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   14: invokevirtual 112	android/content/Context:getAssets	()Landroid/content/res/AssetManager;
    //   17: ldc 114
    //   19: invokevirtual 120	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   22: invokespecial 123	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   25: invokespecial 126	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   28: astore_1
    //   29: aload_1
    //   30: invokevirtual 129	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   33: astore_2
    //   34: aload_2
    //   35: ifnull +139 -> 174
    //   38: aload_2
    //   39: invokevirtual 132	java/lang/String:trim	()Ljava/lang/String;
    //   42: ldc 134
    //   44: invokevirtual 138	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   47: astore 4
    //   49: aload 4
    //   51: iconst_0
    //   52: aaload
    ...
    //   67: aaload
    //   68: astore_2
    //   69: new 61	cooperation/plugin/PluginInfo
    //   72: dup
    //   73: invokespecial 141	cooperation/plugin/PluginInfo:<init>	()V
    //   76: astore 4
    //   78: aload 4
    //   80: aload_3
    //   81: putfield 145	cooperation/plugin/PluginInfo:mID	Ljava/lang/String;
    //   84: aload 4
    //   86: aload_2
    //   87: putfield 148	cooperation/plugin/PluginInfo:mMD5	Ljava/lang/String;
    //   90: aload 4
    //   92: iconst_1
    //   93: putfield 152	cooperation/plugin/PluginInfo:mUpdateType	I
    //   96: aload 4
    //   98: iconst_0
    //   99: putfield 155	cooperation/plugin/PluginInfo:mInstallType	I
    //   102: invokestatic 69	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   105: ifeq +45 -> 150
    //   108: ldc 71
    //   110: iconst_2
    ...
    //   123: aload 4
    //   125: getfield 145	cooperation/plugin/PluginInfo:mID	Ljava/lang/String;
    ...
    //   136: aload 4
    //   138: getfield 148	cooperation/plugin/PluginInfo:mMD5	Ljava/lang/String;
    ...
    //   147: invokestatic 95	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   150: aload_0
    //   151: getfield 33	cooperation/plugin/BuiltinPluginManager:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   154: aload_3
    //   155: aload 4
    //   157: invokevirtual 163	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   160: pop
    //   161: goto -132 -> 29
    //   164: astore_2
    //   165: aload_1
    //   166: ifnull +7 -> 173
    //   169: aload_1
    //   170: invokevirtual 166	java/io/BufferedReader:close	()V
    //   173: return
    //   174: aload_1
    //   175: ifnull -2 -> 173
    //   178: aload_1
    //   179: invokevirtual 166	java/io/BufferedReader:close	()V
    //   182: return
    //   183: astore_1
    //   184: return
    //   185: astore_1
    ...
    //   187: ifnull +7 -> 194
    //   190: aload_2
    //   191: invokevirtual 166	java/io/BufferedReader:close	()V
    //   194: aload_1
    //   195: athrow
    //   196: astore_1
    //   197: return
    ...
    //   0	216	0	this	BuiltinPluginManager
