...
public final class Dex2Oat
{
  ...
  {
    String str2 = (String)bhvn.a("dalvik.system.VMRuntime", "getCurrentInstructionSet");
    String str1 = str2;
  ...
  public static boolean a(Collection<File> paramCollection, File paramFile, boolean paramBoolean, String paramString, bmgi parambmgi)
  {
    return a(paramCollection, paramFile, paramBoolean, paramString, new AtomicInteger(0), parambmgi, 2);
  }
  
  private static boolean a(Collection<File> paramCollection, File paramFile, boolean paramBoolean, String paramString, AtomicInteger paramAtomicInteger, bmgi parambmgi, int paramInt)
  {
    try
    {
      CountDownLatch localCountDownLatch = new CountDownLatch(paramCollection.size());
      ExecutorService localExecutorService = Executors.newFixedThreadPool(paramInt, new bmgg());
      long l = System.nanoTime();
      Object localObject = new ArrayList(paramCollection);
      Collections.sort((List)localObject, new bmgh());
      Collections.reverse((List)localObject);
      localObject = ((ArrayList)localObject).iterator();
      while (((Iterator)localObject).hasNext()) {
        localExecutorService.submit(new Dex2Oat.OptimizeWorker((File)((Iterator)localObject).next(), paramFile, paramBoolean, paramString, paramAtomicInteger, localCountDownLatch, parambmgi));
      }
      try
      {
