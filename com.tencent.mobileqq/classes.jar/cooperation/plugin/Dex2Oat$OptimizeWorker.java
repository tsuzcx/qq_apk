  ...
  implements Runnable
{
  ...
  private final blff jdField_a_of_type_Blff;
  ...
  Dex2Oat$OptimizeWorker(File paramFile1, File paramFile2, boolean paramBoolean, String paramString, AtomicInteger paramAtomicInteger, CountDownLatch paramCountDownLatch, blff paramblff)
  {
  ...
  public void run()
  {
    try
    {
      if ((!Dex2Oat.a(this.jdField_a_of_type_JavaIoFile)) && (this.jdField_a_of_type_Blff != null)) {
        this.jdField_a_of_type_Blff.a(this.jdField_a_of_type_JavaIoFile, this.b, new IOException("dex file " + this.jdField_a_of_type_JavaIoFile.getAbsolutePath() + " is not exist!"));
      }
      if (this.jdField_a_of_type_Blff != null) {
        this.jdField_a_of_type_Blff.a(this.jdField_a_of_type_JavaIoFile, this.b);
      }
      ...
      if (this.jdField_a_of_type_Blff != null) {
        this.jdField_a_of_type_Blff.a(this.jdField_a_of_type_JavaIoFile, this.b, new File(str));
      }
      return;
    }
    catch (Throwable localThrowable)
    {
      ...
      if (this.jdField_a_of_type_Blff != null) {
        this.jdField_a_of_type_Blff.a(this.jdField_a_of_type_JavaIoFile, this.b, localThrowable);
      }
      return;
    }
    finally
