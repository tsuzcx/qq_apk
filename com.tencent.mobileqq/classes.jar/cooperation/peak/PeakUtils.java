...
public final class PeakUtils
{
  ...
  public static java.util.ArrayList<java.lang.Integer> a(String paramString)
  {
    ...
    //   22: ifeq -15 -> 7
    //   25: invokestatic 104	com/tencent/mobileqq/utils/LogTag:a	()V
    ...
    //   194: ldc 147
    //   196: ldc 149
    //   198: invokestatic 152	com/tencent/mobileqq/utils/LogTag:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   201: aload_0
    //   202: areturn
    //   203: iconst_1
    //   204: istore_2
  ...
  public static boolean a(String paramString)
  {
    ...
    //   39: ifeq -17 -> 22
    //   42: aload_0
    //   43: invokestatic 360	com/tencent/mobileqq/utils/ImageUtil:b	(Ljava/lang/String;)Z
    //   46: ifeq -24 -> 22
    //   49: invokestatic 104	com/tencent/mobileqq/utils/LogTag:a	()V
    ...
    //   73: astore 8
    //   75: aload 5
    //   77: invokevirtual 364	java/io/FileInputStream:getChannel	()Ljava/nio/channels/FileChannel;
    //   80: astore_0
    //   81: aload_0
    //   82: astore 6
    //   84: aload_0
    ...
    //   88: astore 8
    //   90: aload_0
    //   91: getstatic 370	java/nio/channels/FileChannel$MapMode:READ_ONLY	Ljava/nio/channels/FileChannel$MapMode;
    //   94: lconst_0
    //   95: aload_0
    //   96: invokevirtual 375	java/nio/channels/FileChannel:size	()J
    //   99: invokevirtual 379	java/nio/channels/FileChannel:map	(Ljava/nio/channels/FileChannel$MapMode;JJ)Ljava/nio/MappedByteBuffer;
    //   102: astore 9
    //   104: aload_0
    //   105: astore 6
    //   107: aload_0
    ...
    //   111: astore 8
    //   113: aload_0
    //   114: invokevirtual 375	java/nio/channels/FileChannel:size	()J
    //   117: l2i
    //   118: istore_3
    //   119: iconst_0
    //   120: istore_1
    ...
    //   139: aload 9
    //   141: iload_1
    //   142: invokevirtual 385	java/nio/MappedByteBuffer:get	(I)B
    //   145: iconst_m1
    ...
    //   167: aload 9
    //   169: iload_2
    //   170: invokevirtual 385	java/nio/MappedByteBuffer:get	(I)B
    //   173: istore_2
    //   174: iload_2
    //   175: bipush 194
    ...
    //   202: ifnull +7 -> 209
    //   205: aload_0
    //   206: invokevirtual 386	java/nio/channels/FileChannel:close	()V
    //   209: aload 5
    //   211: ifnull +269 -> 480
    //   214: aload 5
    //   216: invokevirtual 387	java/io/FileInputStream:close	()V
    //   219: ldc 147
    //   221: ldc_w 389
    //   224: invokestatic 152	com/tencent/mobileqq/utils/LogTag:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   227: iload 4
    //   229: ireturn
    //   230: astore_0
    //   231: aload_0
    ...
    //   251: ifnull +8 -> 259
    //   254: aload 8
    //   256: invokevirtual 386	java/nio/channels/FileChannel:close	()V
    //   259: aload_0
    //   260: ifnull +214 -> 474
    //   263: aload_0
    //   264: invokevirtual 387	java/io/FileInputStream:close	()V
    //   267: iconst_0
    //   268: istore 4
    //   270: goto -51 -> 219
    //   273: astore 5
    ...
    //   300: ifnull +8 -> 308
    //   303: aload 7
    //   305: invokevirtual 386	java/nio/channels/FileChannel:close	()V
    //   308: aload 5
    //   310: ifnull +164 -> 474
    //   313: aload 5
    //   315: invokevirtual 387	java/io/FileInputStream:close	()V
    //   318: iconst_0
    //   319: istore 4
    //   321: goto -102 -> 219
    //   324: astore_0
    ...
    //   349: ifnull +8 -> 357
    //   352: aload 6
    //   354: invokevirtual 386	java/nio/channels/FileChannel:close	()V
    //   357: aload 5
    //   359: ifnull +115 -> 474
    //   362: aload 5
    //   364: invokevirtual 387	java/io/FileInputStream:close	()V
    //   367: iconst_0
    //   368: istore 4
    //   370: goto -151 -> 219
    //   373: astore_0
    ...
    //   401: ifnull +8 -> 409
    //   404: aload 6
    //   406: invokevirtual 386	java/nio/channels/FileChannel:close	()V
    //   409: aload 5
    //   411: ifnull +8 -> 419
    //   414: aload 5
    //   416: invokevirtual 387	java/io/FileInputStream:close	()V
    //   419: aload_0
    //   420: athrow
    //   421: astore 6
    //   423: aload 6
  ...
  public static void b(Context paramContext, Bundle paramBundle, IAIOImageProvider paramIAIOImageProvider, AIORichMediaData paramAIORichMediaData, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 < 0)
    {
      ...
      if ((bool) && ((paramContext instanceof Activity))) {
        ((Activity)paramContext).overridePendingTransition(2130772052, 2130772062);
      }
    }
    for (;;)
    {
