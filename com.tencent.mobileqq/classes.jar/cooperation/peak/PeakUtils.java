...
public final class PeakUtils
{
  ...
  public static java.util.ArrayList a(String paramString)
  {
    ...
    //   17: astore_0
    //   18: aload_0
    //   19: invokevirtual 90	java/io/File:exists	()Z
    //   22: ifeq -15 -> 7
    //   25: invokestatic 94	com/tencent/mobileqq/utils/LogTag:a	()V
    //   28: new 96	java/io/ByteArrayOutputStream
    //   31: dup
    //   32: aload_0
    //   33: invokevirtual 100	java/io/File:length	()J
    //   36: l2i
    //   37: invokespecial 103	java/io/ByteArrayOutputStream:<init>	(I)V
    //   40: astore 7
    //   42: new 105	java/io/BufferedInputStream
    //   45: dup
    //   46: new 107	java/io/FileInputStream
    //   49: dup
    //   50: aload_0
    //   51: invokespecial 110	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   54: invokespecial 113	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   57: astore 4
    //   59: aload 4
    //   61: astore_0
    //   62: sipush 1024
    ...
    //   76: iconst_0
    //   77: sipush 1024
    //   80: invokevirtual 117	java/io/BufferedInputStream:read	([BII)I
    //   83: istore_1
    //   84: iconst_m1
    //   85: iload_1
    ...
    //   96: iconst_0
    //   97: iload_1
    //   98: invokevirtual 121	java/io/ByteArrayOutputStream:write	([BII)V
    //   101: goto -32 -> 69
    //   104: astore 5
    //   106: aload 4
    //   108: astore_0
    //   109: aload 5
    //   111: invokevirtual 124	java/io/IOException:printStackTrace	()V
    //   114: aload 4
    //   116: ifnull +205 -> 321
    //   119: aload 4
    //   121: invokevirtual 127	java/io/BufferedInputStream:close	()V
    //   124: iconst_0
    //   125: istore_1
    //   126: aload 6
    //   128: astore_0
    //   129: iload_1
    //   130: ifeq +59 -> 189
    //   133: new 129	java/util/ArrayList
    //   136: dup
    //   137: bipush 10
    //   139: invokespecial 130	java/util/ArrayList:<init>	(I)V
    //   142: astore 4
    //   144: aload 7
    //   146: invokevirtual 134	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   149: astore 5
    //   151: aload 5
    //   153: arraylength
    //   154: istore_3
    ...
    //   188: astore_0
    //   189: aload 7
    //   191: invokevirtual 135	java/io/ByteArrayOutputStream:close	()V
    //   194: ldc 137
    //   196: ldc 139
    //   198: invokestatic 142	com/tencent/mobileqq/utils/LogTag:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   201: aload_0
    //   202: areturn
    //   203: iconst_1
    //   204: istore_2
    ...
    //   209: ifnull -83 -> 126
    //   212: aload 4
    //   214: invokevirtual 127	java/io/BufferedInputStream:close	()V
    //   217: iload_2
    //   218: istore_1
    //   219: goto -93 -> 126
    //   222: astore_0
    //   223: aload_0
    //   224: invokevirtual 124	java/io/IOException:printStackTrace	()V
    //   227: iload_2
    //   228: istore_1
    //   229: goto -103 -> 126
    //   232: astore_0
    //   233: aload_0
    //   234: invokevirtual 124	java/io/IOException:printStackTrace	()V
    //   237: iconst_0
    //   238: istore_1
    //   239: goto -113 -> 126
    //   242: astore 4
    ...
    //   247: ifnull +7 -> 254
    //   250: aload_0
    //   251: invokevirtual 127	java/io/BufferedInputStream:close	()V
    //   254: aload 4
    //   256: athrow
    //   257: astore_0
    //   258: aload_0
    //   259: invokevirtual 124	java/io/IOException:printStackTrace	()V
    //   262: goto -8 -> 254
    //   265: aload 5
    //   267: iload_2
    //   268: baload
    ...
    //   277: iconst_1
    //   278: isub
    //   279: invokestatic 148	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   282: invokevirtual 151	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   285: pop
    //   286: iload_2
    //   287: iconst_1
    //   288: iadd
    ...
    //   293: astore 4
    //   295: aload 4
    //   297: invokevirtual 124	java/io/IOException:printStackTrace	()V
    //   300: goto -106 -> 194
    //   303: astore 4
    //   305: goto -59 -> 246
    //   308: astore 5
  ...
  public static void a(Context paramContext, Bundle paramBundle, IAIOImageProvider paramIAIOImageProvider, AIORichMediaData paramAIORichMediaData, int paramInt)
  {
    ...
    if (((paramContext instanceof SplashActivity)) || ((paramContext instanceof ChatActivity)))
    {
      ...
      if ((paramIAIOImageProvider instanceof QQAppInterface))
      {
        ...
        localBundle.putString("uin", ((MultiForwardActivity)paramContext).getChatFragment().a().a().a);
        paramAIORichMediaData = localBundle.getString("extra.GROUP_UIN");
        if ((paramAIORichMediaData != null) && (((QQAppInterface)paramIAIOImageProvider).b(paramAIORichMediaData) == 2)) {
  ...
  public static boolean a(String paramString)
  {
    ...
    //   27: dup
    //   28: aload_0
    //   29: invokespecial 87	java/io/File:<init>	(Ljava/lang/String;)V
    //   32: astore 5
    //   34: aload 5
    //   36: invokevirtual 90	java/io/File:exists	()Z
    //   39: ifeq -17 -> 22
    //   42: aload_0
    //   43: invokestatic 281	com/tencent/mobileqq/utils/ImageUtil:b	(Ljava/lang/String;)Z
    //   46: ifeq -24 -> 22
    //   49: invokestatic 94	com/tencent/mobileqq/utils/LogTag:a	()V
    //   52: new 107	java/io/FileInputStream
    //   55: dup
    //   56: aload 5
    //   58: invokespecial 110	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   61: astore 5
    //   63: aload 11
    //   65: astore 6
    //   67: aload 10
    ...
    //   73: astore 8
    //   75: aload 5
    //   77: invokevirtual 285	java/io/FileInputStream:getChannel	()Ljava/nio/channels/FileChannel;
    //   80: astore_0
    //   81: aload_0
    //   82: astore 6
    //   84: aload_0
    ...
    //   88: astore 8
    //   90: aload_0
    //   91: getstatic 291	java/nio/channels/FileChannel$MapMode:READ_ONLY	Ljava/nio/channels/FileChannel$MapMode;
    //   94: lconst_0
    //   95: aload_0
    //   96: invokevirtual 296	java/nio/channels/FileChannel:size	()J
    //   99: invokevirtual 300	java/nio/channels/FileChannel:map	(Ljava/nio/channels/FileChannel$MapMode;JJ)Ljava/nio/MappedByteBuffer;
    //   102: astore 9
    //   104: aload_0
    //   105: astore 6
    //   107: aload_0
    ...
    //   111: astore 8
    //   113: aload_0
    //   114: invokevirtual 296	java/nio/channels/FileChannel:size	()J
    //   117: l2i
    //   118: istore_3
    //   119: iconst_0
    //   120: istore_1
    ...
    //   139: aload 9
    //   141: iload_1
    //   142: invokevirtual 306	java/nio/MappedByteBuffer:get	(I)B
    //   145: iconst_m1
    ...
    //   167: aload 9
    //   169: iload_2
    //   170: invokevirtual 306	java/nio/MappedByteBuffer:get	(I)B
    //   173: istore_2
    //   174: iload_2
    //   175: bipush 194
    ...
    //   202: ifnull +7 -> 209
    //   205: aload_0
    //   206: invokevirtual 307	java/nio/channels/FileChannel:close	()V
    //   209: aload 5
    //   211: ifnull +269 -> 480
    //   214: aload 5
    //   216: invokevirtual 308	java/io/FileInputStream:close	()V
    //   219: ldc 137
    //   221: ldc_w 310
    //   224: invokestatic 142	com/tencent/mobileqq/utils/LogTag:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   227: iload 4
    //   229: ireturn
    //   230: astore_0
    //   231: aload_0
    //   232: invokevirtual 124	java/io/IOException:printStackTrace	()V
    //   235: goto -26 -> 209
    //   238: astore_0
    //   239: aload_0
    ...
    //   251: ifnull +8 -> 259
    //   254: aload 8
    //   256: invokevirtual 307	java/nio/channels/FileChannel:close	()V
    //   259: aload_0
    //   260: ifnull +214 -> 474
    //   263: aload_0
    //   264: invokevirtual 308	java/io/FileInputStream:close	()V
    //   267: iconst_0
    //   268: istore 4
    //   270: goto -51 -> 219
    //   273: astore 5
    //   275: aload 5
    //   277: invokevirtual 124	java/io/IOException:printStackTrace	()V
    //   280: goto -21 -> 259
    //   283: astore_0
    //   284: aload_0
    //   285: invokevirtual 124	java/io/IOException:printStackTrace	()V
    //   288: iconst_0
    //   289: istore 4
    //   291: goto -72 -> 219
    //   294: astore_0
    ...
    //   300: ifnull +8 -> 308
    //   303: aload 7
    //   305: invokevirtual 307	java/nio/channels/FileChannel:close	()V
    //   308: aload 5
    //   310: ifnull +164 -> 474
    //   313: aload 5
    //   315: invokevirtual 308	java/io/FileInputStream:close	()V
    //   318: iconst_0
    //   319: istore 4
    //   321: goto -102 -> 219
    //   324: astore_0
    //   325: aload_0
    //   326: invokevirtual 124	java/io/IOException:printStackTrace	()V
    //   329: goto -21 -> 308
    //   332: astore_0
    //   333: aload_0
    //   334: invokevirtual 124	java/io/IOException:printStackTrace	()V
    //   337: iconst_0
    //   338: istore 4
    //   340: goto -121 -> 219
    //   343: astore_0
    ...
    //   349: ifnull +8 -> 357
    //   352: aload 6
    //   354: invokevirtual 307	java/nio/channels/FileChannel:close	()V
    //   357: aload 5
    //   359: ifnull +115 -> 474
    //   362: aload 5
    //   364: invokevirtual 308	java/io/FileInputStream:close	()V
    //   367: iconst_0
    //   368: istore 4
    //   370: goto -151 -> 219
    //   373: astore_0
    //   374: aload_0
    //   375: invokevirtual 124	java/io/IOException:printStackTrace	()V
    //   378: goto -21 -> 357
    //   381: astore_0
    //   382: aload_0
    //   383: invokevirtual 124	java/io/IOException:printStackTrace	()V
    //   386: iconst_0
    //   387: istore 4
    //   389: goto -170 -> 219
    //   392: astore_0
    ...
    //   401: ifnull +8 -> 409
    //   404: aload 6
    //   406: invokevirtual 307	java/nio/channels/FileChannel:close	()V
    //   409: aload 5
    //   411: ifnull +8 -> 419
    //   414: aload 5
    //   416: invokevirtual 308	java/io/FileInputStream:close	()V
    //   419: aload_0
    //   420: athrow
    //   421: astore 6
    //   423: aload 6
    //   425: invokevirtual 124	java/io/IOException:printStackTrace	()V
    //   428: goto -19 -> 409
    //   431: astore 5
    //   433: aload 5
    //   435: invokevirtual 124	java/io/IOException:printStackTrace	()V
    //   438: goto -19 -> 419
    //   441: astore_0
    //   442: aconst_null
    //   443: astore 6
  ...
  public static void b(Context paramContext, Bundle paramBundle, IAIOImageProvider paramIAIOImageProvider, AIORichMediaData paramAIORichMediaData, int paramInt)
  {
    Bundle localBundle = paramBundle;
    if (paramBundle == null) {
      localBundle = new Bundle();
    ...
    if (paramInt < 0)
    {
      ...
      if ((bool) && ((paramContext instanceof Activity))) {
        ((Activity)paramContext).overridePendingTransition(2131034173, 2131034178);
      }
    }
    for (;;)
    {
