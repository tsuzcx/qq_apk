...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 32, 42, 48, 56, 66, 72 }, new String[] { "room_id", "room_title", "room_icon", "room_viewer", "room_schema", "is_living", "interval", "viewer_text", "puin" }, new Object[] { Long.valueOf(0L), "", "", Long.valueOf(0L), "", Integer.valueOf(0), Integer.valueOf(0), "", Long.valueOf(0L) }, GetLiveGroupTipsRsp.class);
