  ...
  implements Runnable
{
  ...
  public void run()
  {
    try
    {
      Object localObject = LiveAuth.access$200(new URL(LiveAuth.access$100(this.val$accountId, this.val$authKey, "1037", "16594", pha.h(), "10000", "1037")), null);
      ...
      for (localObject = "fail";; localObject = "success")
      {
        ...
        bhak.a("login_auth", localHashMap, System.currentTimeMillis() - this.val$authTime);
        blet.b("liveToken");
        return;
