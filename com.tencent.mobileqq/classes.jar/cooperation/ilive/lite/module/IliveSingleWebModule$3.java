  ...
  implements Runnable
{
  ...
  public void run()
  {
    TouchWebView localTouchWebView = IliveSingleWebModule.b(this.this$0);
    ...
    ((StringBuilder)localObject).append(IliveSingleWebModule.c(this.this$0));
    ((StringBuilder)localObject).append(" consumeTime = ");
    ((StringBuilder)localObject).append(System.currentTimeMillis() - IliveSingleWebModule.d(this.this$0));
    ...
    if (IliveSingleWebModule.d(this.this$0) != 0L) {
