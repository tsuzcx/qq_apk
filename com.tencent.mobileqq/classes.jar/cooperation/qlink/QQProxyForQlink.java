  ...
  implements QlAndQQInterface.QQ2Ql, QlAndQQInterface.Ql2QQ
{
  ...
  private void a(Activity paramActivity, int paramInt, String paramString, QrHandleResultCallBack paramQrHandleResultCallBack)
  {
    ...
    String str = HardCodeUtil.a(2131710674);
    if (1 == paramInt) {
      paramString = str + HardCodeUtil.a(2131710677) + paramString + HardCodeUtil.a(2131710672);
    }
    for (;;)
    {
      DialogUtil.a(paramActivity, 230, paramActivity.getString(2131698333), paramString, 2131698327, 2131698327, new QQProxyForQlink.8(this, paramQrHandleResultCallBack), null).show();
      return;
      if (2 == paramInt) {
        paramString = str + HardCodeUtil.a(2131710676) + paramString + HardCodeUtil.a(2131710671);
      } else {
        paramString = HardCodeUtil.a(2131710673);
      }
    }
  }
  ...
  public static void a(Context paramContext, int paramInt, Bundle paramBundle)
  {
    if (paramContext == null)
    {
      ...
      Toast.makeText(BaseApplication.getContext(), HardCodeUtil.a(2131710675), 0).show();
      return;
    }
  ...
  private void h()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 169	cooperation/qlink/QQProxyForQlink:jdField_a_of_type_JavaUtilTimer	Ljava/util/Timer;
    //   6: astore_1
    //   7: aload_1
    //   8: ifnull +6 -> 14
    //   11: aload_0
    ...
    //   16: iconst_1
    //   17: ldc 171
    //   19: invokestatic 173	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   22: aload_0
    //   23: new 175	java/util/Timer
    //   26: dup
    //   27: invokespecial 176	java/util/Timer:<init>	()V
    //   30: putfield 169	cooperation/qlink/QQProxyForQlink:jdField_a_of_type_JavaUtilTimer	Ljava/util/Timer;
    //   33: aload_0
    //   34: getfield 169	cooperation/qlink/QQProxyForQlink:jdField_a_of_type_JavaUtilTimer	Ljava/util/Timer;
    //   37: new 178	cooperation/qlink/QQProxyForQlink$9
    //   40: dup
    //   41: aload_0
    //   42: invokespecial 180	cooperation/qlink/QQProxyForQlink$9:<init>	(Lcooperation/qlink/QQProxyForQlink;)V
    //   45: lconst_0
    //   46: ldc2_w 181
    //   49: invokevirtual 186	java/util/Timer:schedule	(Ljava/util/TimerTask;JJ)V
    //   52: goto -41 -> 11
    //   55: astore_1
    //   56: aload_0
    //   57: monitorexit
  ...
  private void l()
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 32	cooperation/qlink/QQProxyForQlink:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   8: ifnonnull +58 -> 66
    //   11: aload_0
    //   12: new 229	cooperation/qlink/QQProxyForQlink$11
    //   15: dup
    //   16: aload_0
    //   17: invokespecial 230	cooperation/qlink/QQProxyForQlink$11:<init>	(Lcooperation/qlink/QQProxyForQlink;)V
    //   20: putfield 32	cooperation/qlink/QQProxyForQlink:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   23: new 196	android/content/IntentFilter
    //   26: dup
    //   27: invokespecial 197	android/content/IntentFilter:<init>	()V
    //   30: astore_2
    //   31: aload_2
    //   32: ldc 232
    //   34: invokevirtual 203	android/content/IntentFilter:addAction	(Ljava/lang/String;)V
    //   37: aload_0
    //   38: getfield 38	cooperation/qlink/QQProxyForQlink:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   41: ifnull +11 -> 52
    //   44: aload_0
    //   45: getfield 38	cooperation/qlink/QQProxyForQlink:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   48: invokevirtual 214	com/tencent/mobileqq/app/QQAppInterface:getApp	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   51: astore_1
    //   52: aload_1
    //   53: ifnull +16 -> 69
    //   56: aload_1
    //   57: aload_0
    //   58: getfield 32	cooperation/qlink/QQProxyForQlink:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   61: aload_2
    //   62: invokevirtual 218	com/tencent/qphone/base/util/BaseApplication:registerReceiver	(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
    //   65: pop
    //   66: aload_0
    //   67: monitorexit
    //   68: return
    ...
    //   71: iconst_1
    //   72: ldc 234
    //   74: invokestatic 106	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   77: aload_0
    //   78: aconst_null
    //   79: putfield 32	cooperation/qlink/QQProxyForQlink:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   82: goto -16 -> 66
    //   85: astore_1
    //   86: aload_0
    //   87: monitorexit
  ...
  private void m()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 32	cooperation/qlink/QQProxyForQlink:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   6: ifnull +28 -> 34
    //   9: aload_0
    //   10: getfield 38	cooperation/qlink/QQProxyForQlink:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   13: ifnull +13 -> 26
    //   16: aload_0
    //   17: getfield 38	cooperation/qlink/QQProxyForQlink:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   20: invokevirtual 214	com/tencent/mobileqq/app/QQAppInterface:getApp	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   23: ifnonnull +14 -> 37
    //   26: ldc 100
    //   28: iconst_1
    //   29: ldc 237
    //   31: invokestatic 106	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   34: aload_0
    //   35: monitorexit
    //   36: return
    //   37: aload_0
    //   38: getfield 38	cooperation/qlink/QQProxyForQlink:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   41: invokevirtual 214	com/tencent/mobileqq/app/QQAppInterface:getApp	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   44: aload_0
    //   45: getfield 32	cooperation/qlink/QQProxyForQlink:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   48: invokevirtual 227	com/tencent/qphone/base/util/BaseApplication:unregisterReceiver	(Landroid/content/BroadcastReceiver;)V
    //   51: aload_0
    //   52: aconst_null
    //   53: putfield 32	cooperation/qlink/QQProxyForQlink:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   56: goto -22 -> 34
    //   59: astore_1
    //   60: aload_0
    //   61: monitorexit
  ...
  public void a(int paramInt)
  {
    ...
    if (i != this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mTransferingCount)
    {
      ...
      localBannerManager = BannerManager.a();
    ...
    {
      localBannerManager.a(43, paramInt, null);
      return;
    }
  }
  ...
  public void a(Activity paramActivity, DialogInterface.OnClickListener paramOnClickListener1, DialogInterface.OnClickListener paramOnClickListener2, DialogInterface.OnClickListener paramOnClickListener3, String paramString)
  {
    ...
    {
      return;
      String str2 = ContactUtils.j(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mPeerUin);
      String str1;
      if (str2 != null)
      {
        str1 = str2;
      ...
      {
        a("0X8004854", 1);
        paramOnClickListener3 = paramActivity.getResources().getString(2131698373) + str1 + paramActivity.getResources().getString(2131698374);
        ...
        {
          this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = DialogUtil.a(paramActivity, 230, paramActivity.getResources().getString(2131698334), paramOnClickListener3, paramActivity.getResources().getString(2131698375), paramActivity.getResources().getString(2131698375), paramOnClickListener2, null);
          label194:
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setOnDismissListener(new QQProxyForQlink.5(this));
        return;
        label224:
        str1 = this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mPeerUin;
        break;
        this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = DialogUtil.a(paramActivity, 230, paramActivity.getResources().getString(2131698334), paramOnClickListener3, paramActivity.getResources().getString(2131698375), paramActivity.getResources().getString(2131698376), paramOnClickListener1, paramOnClickListener2);
        break label194;
        if (this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mMode == 2)
        {
          a("0X8004856", 1);
          paramOnClickListener1 = str1 + paramActivity.getResources().getString(2131698372);
          this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = DialogUtil.a(paramActivity, 230, paramActivity.getResources().getString(2131698334), paramOnClickListener1, paramActivity.getResources().getString(2131698371), paramActivity.getResources().getString(2131698371), paramOnClickListener3, null);
          this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.show();
        }
  ...
  {
    String str = ContactUtils.i(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString);
    FriendsManager localFriendsManager = (FriendsManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER);
  ...
  public void a(AppActivity paramAppActivity, QrHandleResultCallBack paramQrHandleResultCallBack)
  {
    ...
    DialogUtil.a(paramAppActivity, 230, paramAppActivity.getString(2131698351), paramAppActivity.getString(2131698352), 2131698327, 2131698327, new QQProxyForQlink.7(this, paramQrHandleResultCallBack), null).show();
  }
  ...
  public void a(AppActivity paramAppActivity, String paramString, QrHandleResultCallBack paramQrHandleResultCallBack)
  {
    ...
    {
      DialogUtil.a(paramAppActivity, 230, paramAppActivity.getString(2131698333), paramAppActivity.getString(2131698353), 2131698327, 2131698327, new QQProxyForQlink.6(this, paramQrHandleResultCallBack), null).show();
      return;
    }
    if (this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mWorking)
    {
    ...
    paramQrHandleResultCallBack.putString("preSharedKey", localQRScanInfo.f);
