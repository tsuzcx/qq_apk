  ...
  extends VasWebviewJsPlugin
{
  ...
  QQComicJsCallback jdField_a_of_type_CooperationComicJspQQComicJsCallback = new altp(this);
  ...
  public void a(String paramString)
  {
    ...
    //   30: dup
    //   31: aload_0
    //   32: invokespecial 184	altt:<init>	(Lcooperation/comic/jsp/QQComicJsPlugin;)V
    //   35: iconst_5
    //   36: aconst_null
    //   37: iconst_1
  ...
  {
    jdField_a_of_type_AndroidOsHandler.post(new altr(this, paramLong, paramString1, paramJSONObject, paramString2));
  }
  ...
  protected boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    for (i = 1;; i = 2)
    {
      ...
      {
        ThreadManager.getUIHandler().post(new altq(this, paramString3, paramJsBridgeListener, paramString2));
      }
      else
      {
        if (QLog.isColorLevel()) {
