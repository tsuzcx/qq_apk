...
public class QQComicJsPlugin$3
  implements Runnable
{
  public QQComicJsPlugin$3(blbd paramblbd, long paramLong, String paramString1, JSONObject paramJSONObject, String paramString2) {}
  ...
  public void run()
  {
    ...
    if (!blbu.a)
    {
      blbu.a(BaseApplication.getContext());
      for (long l = 0L; (!blbu.a) && (l < this.jdField_a_of_type_Long); l += 50L) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        blbd.b(this.this$0, this.b, new String[] { localJSONObject.toString() });
      }
