...
public class QQComicJsPlugin$3
  implements Runnable
{
  public QQComicJsPlugin$3(bmcg parambmcg, long paramLong, String paramString1, JSONObject paramJSONObject, String paramString2) {}
  ...
  public void run()
  {
    ...
    if (!bmcx.a)
    {
      bmcx.a(BaseApplication.getContext());
      for (long l = 0L; (!bmcx.a) && (l < this.jdField_a_of_type_Long); l += 50L) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        bmcg.b(this.this$0, this.b, new String[] { localJSONObject.toString() });
      }
