...
public class QQComicJsPlugin$3
  implements Runnable
{
  public QQComicJsPlugin$3(bghs parambghs, long paramLong, String paramString1, JSONObject paramJSONObject, String paramString2) {}
  ...
  public void run()
  {
    ...
    if (!bgij.a)
    {
      bgij.a(BaseApplication.getContext());
      for (long l = 0L; (!bgij.a) && (l < this.jdField_a_of_type_Long); l += 50L) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        bghs.b(this.this$0, this.b, new String[] { localJSONObject.toString() });
      }
