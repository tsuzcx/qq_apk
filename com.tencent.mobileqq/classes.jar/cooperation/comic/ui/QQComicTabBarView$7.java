  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    Object localObject = (blby)((AppInterface)MobileQQ.sMobileQQ.waitAppRuntime(null).getAppRuntime("modular_web")).getManager(213);
    ArrayList localArrayList = new ArrayList();
    if (((blby)localObject).a(1113)) {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      localObject = ((blby)localObject).a(localArrayList);
      if (QLog.isColorLevel()) {
