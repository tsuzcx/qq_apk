  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    Object localObject = (QQComicRedTouchManager)((AppInterface)MobileQQ.sMobileQQ.waitAppRuntime(null).getAppRuntime("modular_web")).getManager(QQManagerFactory.COMIC_RED_TOUCH_MANAGER);
