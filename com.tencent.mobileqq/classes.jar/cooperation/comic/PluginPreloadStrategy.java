...
public abstract class PluginPreloadStrategy
{
  ...
  public int a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    Object localObject1 = (TroopRedTouchManager)paramQQAppInterface.getManager(QQManagerFactory.MGR_RED_TOUCH_EX);
    int m;
    ...
    {
      Object localObject2 = (RedTouchManager)paramQQAppInterface.getManager(QQManagerFactory.MGR_RED_TOUCH);
      int i = 0;
      int j = 0;
      boolean bool1 = false;
      boolean bool2 = bool1;
      ...
      {
        n = ((RedTouchManager)localObject2).b(0);
        localObject1 = ((RedTouchManager)localObject2).b(0);
        localObject2 = ((RedTouchManager)localObject2).a();
      ...
      for (;;)
      {
        paramString = (QZoneManagerImp)paramQQAppInterface.getManager(QQManagerFactory.QZONE_MANAGER);
        int i2 = 0;
        i1 = 0;
        if (paramString != null)
        {
  ...
  public boolean a(PluginPreloadStrategy.PreloadPublicParam paramPreloadPublicParam, String paramString1, QQAppInterface paramQQAppInterface, String paramString2, int paramInt, long paramLong, int[] paramArrayOfInt, PluginPreloader.ExtraResult paramExtraResult)
  {
    ...
    if ((paramPreloadPublicParam.jdField_h_of_type_Boolean) && (!a(paramString2, paramQQAppInterface)))
    {
    ...
    if ((paramPreloadPublicParam.jdField_a_of_type_Boolean) && (!a(paramPreloadPublicParam.jdField_b_of_type_Int, paramPreloadPublicParam.jdField_c_of_type_Int)))
    {
  ...
  protected abstract boolean a(PluginPreloader.ExtraResult paramExtraResult);
  
  public boolean a(String paramString, QQAppInterface paramQQAppInterface)
  {
    paramQQAppInterface = (ILebaHelperService)paramQQAppInterface.getRuntimeService(ILebaHelperService.class, "");
    if (paramQQAppInterface == null)
    {
      QLog.d("PluginPreloadStrategy", 1, "checkInLebaList lebaHelperService == null");
      return false;
    }
    paramQQAppInterface = paramQQAppInterface.getLebaShowList();
    ...
    {
      LebaViewItem localLebaViewItem = (LebaViewItem)paramQQAppInterface.next();
