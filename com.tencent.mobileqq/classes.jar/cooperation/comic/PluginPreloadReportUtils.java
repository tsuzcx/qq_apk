...
public class PluginPreloadReportUtils
{
  ...
  private static final ConcurrentHashMap<Integer, PluginPreloadReportUtils.HitRateHelper> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  
  public static PluginPreloadReportUtils.HitRateHelper a(int paramInt)
  {
    return (PluginPreloadReportUtils.HitRateHelper)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt));
  }
 ...
 * Qualified Name:     cooperation.comic.PluginPreloadReportUtils
