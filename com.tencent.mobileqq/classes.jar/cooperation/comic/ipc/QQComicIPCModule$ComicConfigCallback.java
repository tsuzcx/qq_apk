  ...
  extends CallBacker
{
  ...
  public void callback(long paramLong, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2)
  {
    ...
    {
      paramString1 = VasUpdateUtil.a(BaseApplicationImpl.getApplication().getRuntime(), paramString1, false, null);
 ...
 * Qualified Name:     cooperation.comic.ipc.QQComicIPCModule.ComicConfigCallback
