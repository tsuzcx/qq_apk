...
public class VipComicUrlHelper
{
  ...
  public static void a(android.content.Intent paramIntent)
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 13	cooperation/comic/utils/VipComicUrlHelper:jdField_a_of_type_Boolean	Z
    //   6: istore_1
    //   7: iload_1
    //   8: ifeq +7 -> 15
    //   11: ldc 2
    ...
    //   19: aload_0
    //   20: ldc 171
    //   22: invokevirtual 177	android/content/Intent:getSerializableExtra	(Ljava/lang/String;)Ljava/io/Serializable;
    //   25: astore_0
    //   26: aload_0
    //   27: instanceof 15
    //   30: ifeq -19 -> 11
    //   33: aload_0
    //   34: checkcast 15	java/util/HashMap
    //   37: astore_0
    //   38: aload_0
    //   39: invokevirtual 178	java/util/HashMap:isEmpty	()Z
    //   42: ifne -31 -> 11
    //   45: getstatic 115	cooperation/comic/utils/VipComicUrlHelper:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   48: ifnonnull +13 -> 61
    //   51: new 15	java/util/HashMap
    //   54: dup
    //   55: invokespecial 18	java/util/HashMap:<init>	()V
    //   58: putstatic 115	cooperation/comic/utils/VipComicUrlHelper:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   61: getstatic 115	cooperation/comic/utils/VipComicUrlHelper:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   64: invokeinterface 181 1 0
    //   69: getstatic 115	cooperation/comic/utils/VipComicUrlHelper:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   72: aload_0
    //   73: invokeinterface 185 2 0
    //   78: iconst_1
    //   79: putstatic 13	cooperation/comic/utils/VipComicUrlHelper:jdField_a_of_type_Boolean	Z
    //   82: goto -71 -> 11
    //   85: astore_0
    //   86: ldc 2
    //   88: monitorexit
