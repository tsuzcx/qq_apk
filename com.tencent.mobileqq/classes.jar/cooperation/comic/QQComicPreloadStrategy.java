  ...
  extends PluginPreloadStrategy
{
  ...
  protected void a()
  {
    ...
    localPluginParams.jdField_d_of_type_JavaLangString = "comic_plugin";
  ...
  protected boolean a(PluginPreloader.ExtraResult paramExtraResult)
  {
    ...
    for (boolean bool = "1".equals(localObject[2]);; bool = false)
    {
      ...
      for (localObject = "preload:ok:dpc";; localObject = "preload:fail:dpc")
      {
        ...
        paramExtraResult = (QQComicPreloadManager)BaseApplicationImpl.getApplication().getRuntime().getManager(141);
        if (paramExtraResult != null)
        {
          paramExtraResult.a();
  ...
  protected boolean b(PluginPreloader.ExtraResult paramExtraResult)
  {
    ...
    for (;;)
    {
      QQComicPreloadManager localQQComicPreloadManager = (QQComicPreloadManager)BaseApplicationImpl.getApplication().getRuntime().getManager(141);
      int i;
