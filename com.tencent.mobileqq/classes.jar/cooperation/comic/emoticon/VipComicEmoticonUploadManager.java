  ...
  implements Manager
{
  ...
  private UpCallBack jdField_a_of_type_ComTencentMobileqqPicUpCallBack = new VipComicEmoticonUploadManager.1(this);
  ...
  public void a(Bundle paramBundle, RemoteCommand.OnInvokeFinishLinstener paramOnInvokeFinishLinstener)
  {
    ...
    for (;;)
    {
      ...
      paramOnInvokeFinishLinstener.mUpCallBack = this.jdField_a_of_type_ComTencentMobileqqPicUpCallBack;
      ...
      try
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqTransfileApiITransFileController.transferAsync(paramOnInvokeFinishLinstener);
        return;
      }
