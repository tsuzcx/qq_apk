...
public class VipComicReportUtils
{
  ...
  private static ThreadLocal jdField_a_of_type_JavaLangThreadLocal = new altl();
  ...
  public static void a(AppInterface paramAppInterface, String paramString1, Context paramContext, String paramString2, String paramString3, String paramString4, String paramString5, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      paramString1 = Arrays.asList(new String[] { "1", paramString1, jdField_a_of_type_JavaLangString, "", "android", "201", Build.VERSION.RELEASE, "8001", "8001001", "", "", "", "", "", "", paramString2, "", "", paramString3, paramString4, paramString5, "", "", "7.6.0", "", "", "", "", "", "android", str, jdField_b_of_type_JavaLangString, "", paramContext[0], paramContext[1], paramContext[2], paramContext[3], paramContext[4], paramContext[5], paramContext[6], paramContext[7], paramContext[8] });
  ...
  {
    ThreadManager.executeOnNetWorkThread(new altm(paramString1, paramString2, paramString3, paramInt, paramString4, paramString5, paramString6, paramString7));
  }
}
