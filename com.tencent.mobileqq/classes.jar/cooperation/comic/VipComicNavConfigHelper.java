...
{
  private static final ArrayList<String> jdField_a_of_type_JavaUtilArrayList;
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      if (!b()) {
        ((IVasQuickUpdateService)paramQQAppInterface.getRuntimeService(IVasQuickUpdateService.class, "")).downloadItem(100L, "vipComic_nav_tabIcon.zip", "helper");
      }
      return;
      ((IVasQuickUpdateService)paramQQAppInterface.getRuntimeService(IVasQuickUpdateService.class, "")).downloadItem(100L, "vipComic_nav_config.json", "helper");
    }
  }
