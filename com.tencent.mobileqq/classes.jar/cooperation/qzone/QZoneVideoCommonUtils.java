...
public class QZoneVideoCommonUtils
{
  ...
  public static void a(long paramLong, Activity paramActivity, String paramString, QZoneVideoCommonUtils.onForwardVideoActivityFailedListener paramonForwardVideoActivityFailedListener)
  {
    ...
    if ((!localVideoSupport1.a()) && (!localVideoSupport2.a()))
    {
      ...
      for (paramString = localVideoSupport1.a();; paramString = null)
      {
        ...
        {
          str = paramActivity.getString(2131432816);
        }
  ...
  public static void a(long paramLong, Activity paramActivity, String paramString, QZoneVideoCommonUtils.onForwardVideoActivityFailedListener paramonForwardVideoActivityFailedListener, Bundle paramBundle)
  {
    PerfTracer.traceStart("Video_component_pre_launch");
    if (paramActivity == null)
    {
    ...
    if ((!localVideoSupport1.a()) && (!localVideoSupport2.a()))
    {
      ...
      for (paramString = localVideoSupport1.a();; paramString = null)
      {
        ...
        {
          paramBundle = paramActivity.getString(2131432816);
        }
        if (paramonForwardVideoActivityFailedListener != null) {
        ...
        QLog.w("QZoneVideoCommonUtils", 2, "qzone video is not supported, recordSupport tips=" + localVideoSupport1.a() + ",trimSupport tips=" + localVideoSupport2.a() + ",show tips=" + paramBundle);
        return;
      }
    }
  ...
  {
    QZoneVideoCommonUtils.VideoSupport localVideoSupport = c();
    if (localVideoSupport.a()) {
  ...
  public static QZoneVideoCommonUtils.VideoSupport c()
  {
    ...
    j = ShortVideoCodec.b(MobileQQ.getContext());
    if (((j & 0x1) > 0) && ((j & 0x2) > 0)) {}
    while (i == 0)
    {
      return QZoneVideoCommonUtils.VideoSupport.h;
      i = 0;
    }
    return QZoneVideoCommonUtils.VideoSupport.a;
  }
