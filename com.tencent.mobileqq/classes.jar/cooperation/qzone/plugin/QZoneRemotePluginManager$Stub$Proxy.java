...
class QZoneRemotePluginManager$Stub$Proxy
  implements QZoneRemotePluginManager
{
  private IBinder mRemote;
  
  QZoneRemotePluginManager$Stub$Proxy(IBinder paramIBinder)
  {
  ...
  public void installPituSo(OnQZoneLiveSoDownloadListener paramOnQZoneLiveSoDownloadListener, int paramInt)
  {
    ...
    //   36: aload_0
    //   37: getfield 15	cooperation/qzone/plugin/QZoneRemotePluginManager$Stub$Proxy:mRemote	Landroid/os/IBinder;
    //   40: bipush 7
    //   42: aload_3
    //   43: aload 4
    //   45: iconst_0
    ...
    //   0	84	0	this	Proxy
    //   0	84	1	paramOnQZoneLiveSoDownloadListener	OnQZoneLiveSoDownloadListener
    //   0	84	2	paramInt	int
  ...
  public boolean installPlugin(String paramString, OnQZonePluginInstallListner paramOnQZonePluginInstallListner, int paramInt)
  {
    ...
    //   43: aload 5
    //   45: iload_3
    //   46: invokevirtual 66	android/os/Parcel:writeInt	(I)V
    //   49: aload_0
    //   50: getfield 15	cooperation/qzone/plugin/QZoneRemotePluginManager$Stub$Proxy:mRemote	Landroid/os/IBinder;
    //   53: iconst_3
    //   54: aload 5
    //   56: aload 6
    //   58: iconst_0
    ...
    //   0	114	2	paramOnQZonePluginInstallListner	OnQZonePluginInstallListner
  ...
  public boolean isReady()
  {
    ...
    //   17: aload_0
    //   18: getfield 15	cooperation/qzone/plugin/QZoneRemotePluginManager$Stub$Proxy:mRemote	Landroid/os/IBinder;
    //   21: iconst_1
    //   22: aload_3
    //   23: aload 4
    //   25: iconst_0
  ...
  public PluginRecord queryPlugin(String paramString)
  {
    ...
    //   14: aload_2
    //   15: aload_1
    //   16: invokevirtual 35	android/os/Parcel:writeString	(Ljava/lang/String;)V
    //   19: aload_0
    //   20: getfield 15	cooperation/qzone/plugin/QZoneRemotePluginManager$Stub$Proxy:mRemote	Landroid/os/IBinder;
    //   23: bipush 6
    //   25: aload_2
    //   26: aload_3
    //   27: iconst_0
    ...
    //   39: invokevirtual 48	android/os/Parcel:readInt	()I
    //   42: ifeq +26 -> 68
    //   45: getstatic 82	cooperation/qzone/plugin/PluginRecord:CREATOR	Landroid/os/Parcelable$Creator;
    //   48: aload_3
    //   49: invokeinterface 88 2 0
    //   54: checkcast 78	cooperation/qzone/plugin/PluginRecord
    //   57: astore_1
    //   58: aload_3
    //   59: invokevirtual 51	android/os/Parcel:recycle	()V
    //   62: aload_2
