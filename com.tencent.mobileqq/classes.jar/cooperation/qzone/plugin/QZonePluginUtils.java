...
public class QZonePluginUtils
{
  ...
  public static PluginRecord a(File paramFile)
  {
    ...
    //   21: aload_2
    //   22: aload_0
    //   23: invokevirtual 64	java/io/FileInputStream:read	([B)I
    //   26: pop
    //   27: aload_2
    //   28: astore_1
    ...
    //   33: aload_0
    //   34: iconst_0
    //   35: invokestatic 70	com/tencent/mobileqq/utils/Base64Util:decode	([BI)[B
    //   38: invokespecial 73	java/lang/String:<init>	([B)V
    //   41: astore_3
    //   42: aload_2
    //   43: astore_1
    //   44: new 75	cooperation/qzone/plugin/PluginRecord
    //   47: dup
    //   48: invokespecial 76	cooperation/qzone/plugin/PluginRecord:<init>	()V
    //   51: astore_0
    //   52: aload_2
    //   53: astore_1
    //   54: aload_0
    //   55: aload_3
    //   56: invokevirtual 79	cooperation/qzone/plugin/PluginRecord:a	(Ljava/lang/String;)V
    //   59: aload_0
    //   60: astore_1
    //   61: aload_2
    //   62: ifnull +9 -> 71
    //   65: aload_2
    //   66: invokevirtual 82	java/io/FileInputStream:close	()V
    //   69: aload_0
    //   70: astore_1
    //   71: aload_1
    //   72: areturn
    //   73: astore_1
    //   74: aload_1
    //   75: invokevirtual 85	java/io/IOException:printStackTrace	()V
    //   78: aload_0
    //   79: areturn
    //   80: astore_3
    //   81: aconst_null
    ...
    //   86: astore_1
    //   87: aload_3
    //   88: invokevirtual 86	java/io/FileNotFoundException:printStackTrace	()V
    //   91: aload_0
    //   92: astore_1
    //   93: aload_2
    //   94: ifnull -23 -> 71
    //   97: aload_2
    //   98: invokevirtual 82	java/io/FileInputStream:close	()V
    //   101: aload_0
    //   102: areturn
    //   103: astore_1
    //   104: aload_1
    //   105: invokevirtual 85	java/io/IOException:printStackTrace	()V
    //   108: aload_0
    //   109: areturn
    //   110: astore_3
    //   111: aconst_null
    ...
    //   116: astore_1
    //   117: aload_3
    //   118: invokevirtual 85	java/io/IOException:printStackTrace	()V
    //   121: aload_0
    //   122: astore_1
    //   123: aload_2
    //   124: ifnull -53 -> 71
    ...
    //   133: astore_1
    //   134: aload_1
    //   135: invokevirtual 85	java/io/IOException:printStackTrace	()V
    //   138: aload_0
    //   139: areturn
    //   140: astore_0
    //   141: aconst_null
    ...
    //   144: ifnull +7 -> 151
    //   147: aload_1
    //   148: invokevirtual 82	java/io/FileInputStream:close	()V
    //   151: aload_0
    //   152: athrow
    //   153: astore_1
    //   154: aload_1
    //   155: invokevirtual 85	java/io/IOException:printStackTrace	()V
    //   158: goto -7 -> 151
    //   161: astore_0
    //   162: goto -19 -> 143
    //   165: astore_3
  ...
  public static String a()
  {
    ...
    int k = QzoneConfig.getInstance().getConfig("LiveSetting", "useQQPluginManager", 0);
    ...
    for (;;)
    {
      ...
      while (i < k)
      {
        ...
        if (((File)localObject).exists())
        {
          ...
          if (localObject != null) {
            paramMap.put(((PluginRecord)localObject).f, localObject);
          }
        }
        i += 1;
      }
      ...
      if (i < j)
      {
        ...
        if (localFile.exists())
        {
          ...
          if (localPluginRecord != null)
          {
            ...
            paramMap.put(localPluginRecord.f, localPluginRecord);
          }
        }
        for (;;)
        {
  ...
  public static void a(PluginRecord paramPluginRecord)
  {
    try
    {
      File localFile = c(BaseApplicationImpl.getContext(), paramPluginRecord.f);
  ...
  private static boolean a(File paramFile, PluginRecord paramPluginRecord)
  {
    ...
    //   6: astore 4
    //   8: aload_1
    //   9: invokevirtual 328	cooperation/qzone/plugin/PluginRecord:a	()Ljava/lang/String;
    //   12: astore 6
    //   14: invokestatic 178	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   17: ifeq +29 -> 46
    //   20: ldc 180
    //   22: iconst_2
    //   23: new 182	java/lang/StringBuilder
    //   26: dup
    //   27: invokespecial 183	java/lang/StringBuilder:<init>	()V
    //   30: ldc_w 330
    //   33: invokevirtual 189	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   36: aload_1
    //   37: invokevirtual 333	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   40: invokevirtual 192	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   43: invokestatic 336	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   46: aload 6
    //   48: invokevirtual 340	java/lang/String:getBytes	()[B
    //   51: iconst_0
    //   52: invokestatic 343	com/tencent/mobileqq/utils/Base64Util:encode	([BI)[B
    //   55: astore_1
    //   56: new 345	java/io/FileOutputStream
    //   59: dup
    //   60: aload_0
    //   61: invokespecial 346	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   64: astore_0
    //   65: aload_0
    //   66: aload_1
    //   67: invokevirtual 349	java/io/FileOutputStream:write	([B)V
    //   70: iconst_1
    //   71: istore_3
    //   72: iload_3
    //   73: istore_2
    ...
    //   75: ifnull +9 -> 84
    //   78: aload_0
    //   79: invokevirtual 350	java/io/FileOutputStream:close	()V
    //   82: iload_3
    //   83: istore_2
    //   84: iload_2
    //   85: ireturn
    ...
    //   91: ifnull -7 -> 84
    //   94: aload_0
    //   95: invokevirtual 350	java/io/FileOutputStream:close	()V
    //   98: iconst_0
    //   99: ireturn
    //   100: astore_0
    //   101: iconst_0
    ...
    //   108: ifnull +7 -> 115
    //   111: aload_1
    //   112: invokevirtual 350	java/io/FileOutputStream:close	()V
    //   115: aload_0
    //   116: athrow
    //   117: astore_0
    //   118: iconst_1
  ...
  public static void b(PluginRecord paramPluginRecord)
  {
    try
    {
      File localFile = d(BaseApplicationImpl.getContext(), paramPluginRecord.f);
      if ((localFile.isFile()) && (localFile.exists()))
      {
        localFile.delete();
        localFile.createNewFile();
  ...
  public static void c(PluginRecord paramPluginRecord)
  {
    try
    {
      paramPluginRecord = d(BaseApplicationImpl.getContext(), paramPluginRecord.f);
