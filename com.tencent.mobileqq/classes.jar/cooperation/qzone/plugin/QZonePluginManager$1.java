...
public class QZonePluginManager$1
  implements Runnable
{
  public QZonePluginManager$1(bjlh parambjlh, String paramString, int paramInt) {}
  ...
  public void run()
  {
    ...
    azly.a(BaseApplicationImpl.getContext()).reportKVEvent("QzonePluginDownloadRefer", localProperties);
  }
}
