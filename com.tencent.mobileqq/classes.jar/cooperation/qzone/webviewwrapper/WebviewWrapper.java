  ...
  implements IWebviewWrapper
{
  ...
  private long mWebviewStartTime = System.currentTimeMillis();
  ...
  public WebviewWrapper(Context paramContext, boolean paramBoolean)
  {
    this.forceSysWebView = paramBoolean;
