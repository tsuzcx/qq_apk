...
public class QZoneStartupMonitor
{
  ...
  private static avki<QZoneStartupMonitor, Void> singleton = new QZoneStartupMonitor.1();
  ...
  private void backupQZoneDex()
  {
    ...
    File localFile1 = new File(QZoneFilePath.BACKUP_DIR);
    boolean bool1;
  ...
  private static Pair<Integer, Throwable> checkElfFile(Context paramContext, String paramString)
  {
    if (isArt())
    {
      ...
      paramContext = optimizedFileFor(PluginUtils.getInstalledPluginPath(paramContext, paramString), localFile);
  ...
  private void reInstallQzone()
  {
    if (!QzonePluginProxyActivity.isQzoneExist())
    {
      ...
      do
      {
        ...
        localObject2 = (bkkq)((QQAppInterface)localObject1).getManager(27);
        QLog.i("QZoneStartupMonitor", 1, "reInstallQzone cancelInstall:qzone_plugin.apk");
        ((bkkq)localObject2).cancelInstall("qzone_plugin.apk");
      } while (((bkkq)localObject2).isPlugininstalled("qzone_plugin.apk"));
      ...
      QZoneHelper.preloadQzone((QQAppInterface)localObject1, "reInstallQzone");
      return;
    }
  ...
  private void report(int paramInt1, boolean paramBoolean, int paramInt2)
  {
    ...
    do
    {
      ...
      {
        if (paramInt2 >= 1) {
          StatisticCollector.getInstance(BaseApplication.getContext()).collectPerformance((String)localObject, "qzoneRecovery", paramBoolean, 0L, 0L, null, "");
        }
        if (!this.hasReported) {
          break label126;
        }
    ...
    {
      localStatisticCollector.collectPerformance((String)localObject, "qzoneOdexCheck", paramBoolean, 0L, 0L, localHashMap, "");
      return;
      j = 0;
      break;
      i = 0;
  ...
  public void monitor()
  {
    ...
    //   2: aload_0
    //   3: monitorenter
    //   4: invokestatic 450	common/config/service/QzoneConfig:getInstance	()Lcommon/config/service/QzoneConfig;
    //   7: ldc_w 452
    //   10: ldc_w 454
    //   13: iconst_1
    //   14: invokevirtual 458	common/config/service/QzoneConfig:getConfig	(Ljava/lang/String;Ljava/lang/String;I)I
    //   17: iconst_1
    //   18: if_icmpne +19 -> 37
    //   21: iload_1
    //   22: ifne +20 -> 42
    ...
    //   39: goto -18 -> 21
    //   42: aload_0
    //   43: getfield 462	cooperation/qzone/QZoneStartupMonitor:observer	Landroid/os/FileObserver;
    //   46: ifnonnull -12 -> 34
    ...
    //   94: aload_0
    //   95: new 466	cooperation/qzone/QZoneStartupMonitor$3
    //   98: dup
    //   99: aload_0
    //   100: aload_2
    //   101: invokevirtual 224	java/io/File:getPath	()Ljava/lang/String;
    //   104: sipush 768
    //   107: invokespecial 469	cooperation/qzone/QZoneStartupMonitor$3:<init>	(Lcooperation/qzone/QZoneStartupMonitor;Ljava/lang/String;I)V
    //   110: putfield 462	cooperation/qzone/QZoneStartupMonitor:observer	Landroid/os/FileObserver;
    //   113: aload_0
    //   114: getfield 462	cooperation/qzone/QZoneStartupMonitor:observer	Landroid/os/FileObserver;
    //   117: invokevirtual 474	android/os/FileObserver:startWatching	()V
    //   120: goto -86 -> 34
    //   123: astore_2
    //   124: aload_0
    //   125: monitorexit
