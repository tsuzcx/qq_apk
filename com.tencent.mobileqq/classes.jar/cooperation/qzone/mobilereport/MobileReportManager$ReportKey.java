...
class MobileReportManager$ReportKey
{
  final String adId;
  final int appId;
  ...
  public MobileReportManager$ReportKey(String paramString1, int paramInt1, String paramString2, int paramInt2, String paramString3, String paramString4)
  {
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((this.traceNum == paramObject.traceNum) && (this.traceId.equals(paramObject.traceId)) && (this.adId.equals(paramObject.adId)) && (this.appId == paramObject.appId) && (this.pageAppId.equals(paramObject.pageAppId)) && (this.pageId.equals(paramObject.pageId)));
    return false;
  }
 ...
 * Qualified Name:     cooperation.qzone.mobilereport.MobileReportManager.ReportKey
