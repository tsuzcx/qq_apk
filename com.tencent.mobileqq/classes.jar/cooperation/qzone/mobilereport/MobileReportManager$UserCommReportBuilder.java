...
class MobileReportManager$UserCommReportBuilder
{
  ...
  public UserCommReport build()
  {
    ...
    localUserCommReport.os_version = DeviceInfoUtil.getDeviceOSVersion();
 ...
 * Qualified Name:     cooperation.qzone.mobilereport.MobileReportManager.UserCommReportBuilder
