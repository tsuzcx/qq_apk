  ...
  implements PluginManagerHelper.OnPluginManagerLoadedListener
{
  ...
  public void onPluginManagerLoaded(PluginManagerClient paramPluginManagerClient)
  {
    if (paramPluginManagerClient == null)
    {
      ...
      paramPluginManagerClient = BaseApplicationImpl.getContext().getString(2131652099);
      bbmy.a(BaseApplicationImpl.getContext(), paramPluginManagerClient, 1).a();
      return;
    }
    ...
    if ((3 == this.c) && (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) && (mpl.a(this.jdField_a_of_type_JavaLangString)))
    {
      ...
      bfpr.a(this, paramPluginManagerClient, -1, null, null);
      if (bgau.b()) {
        c();
      }
      a();
