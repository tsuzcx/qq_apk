  ...
  implements QzoneGiftFullScreenActionManager.MagicfaceActionListener
{
  ...
  public void magicfaceActionEnd(avli paramavli)
  {
    this.this$0.uiHandler.post(new QzoneGiftFullScreenViewController.3.2(this));
  }
  
  public void magicfaceActionStart(avli paramavli)
  {
    ...
    this.this$0.uiHandler.post(new QzoneGiftFullScreenViewController.3.1(this, paramavli));
  }
}
