  ...
  implements Serializable
{
  ...
  public static MQUserClientShowInfo readFrom(byte[] paramArrayOfByte)
  {
    ...
    paramArrayOfByte = (AllInfo)bkyr.a(AllInfo.class, paramArrayOfByte);
    if (paramArrayOfByte != null)
    {
      Object localObject = (UserClientShowInfo)bkyr.a(UserClientShowInfo.class, paramArrayOfByte.vecQQBigVipInfo);
      if (localObject == null) {
        return null;
      }
      ...
      localObject = blcj.a(8, (UserClientShowInfo)localObject);
      if (localObject != null)
      {
