  ...
  implements Serializable
{
  ...
  public static MQUserClientShowInfo readFrom(byte[] paramArrayOfByte)
  {
    ...
    paramArrayOfByte = (AllInfo)bgop.a(AllInfo.class, paramArrayOfByte);
    if (paramArrayOfByte != null)
    {
      Object localObject = (UserClientShowInfo)bgop.a(UserClientShowInfo.class, paramArrayOfByte.vecQQBigVipInfo);
      if (localObject == null) {
        return null;
      }
      ...
      localObject = bgri.a(8, (UserClientShowInfo)localObject);
      if (localObject != null)
      {
