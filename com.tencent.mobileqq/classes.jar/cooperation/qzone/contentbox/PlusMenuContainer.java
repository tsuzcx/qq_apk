  ...
  extends RelativeLayout
{
  ...
  public static int[] defaultIcon = { 2130848457, 2130848453, 2130848462 };
  ...
  public void initView()
  {
    ...
    this.reminder.setId(2131375834);
    ...
    try
    {
      ...
      ((ImageView)localObject1).setId(2131375830);
      ((ImageView)localObject1).setContentDescription(anvx.a(2131707756));
      ...
      ((ImageView)localObject1).setImageResource(2130848467);
      this.mContainer.addView((View)localObject1);
      ...
      ((LinearLayout)localObject1).setId(2131375833);
      ((LinearLayout)localObject1).setWeightSum(3.0F);
      localObject2 = new RelativeLayout.LayoutParams(-1, -2);
      ((RelativeLayout.LayoutParams)localObject2).addRule(3, 2131375830);
      ((LinearLayout)localObject1).setLayoutParams((ViewGroup.LayoutParams)localObject2);
      localObject2 = (LayoutInflater)this.context.getSystemService("layout_inflater");
      int i = 0;
      while (i < 3)
      {
        RelativeLayout localRelativeLayout = (RelativeLayout)((LayoutInflater)localObject2).inflate(2131562413, null);
        LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(0, -1, 1.0F);
        ImageView localImageView = (ImageView)localRelativeLayout.findViewById(2131375661);
        TextView localTextView = (TextView)localRelativeLayout.findViewById(2131375663);
        localImageView.setImageDrawable(getResources().getDrawable(defaultIcon[i]));
        localTextView.setText(defaultTitle[i]);
        localTextView.setTextColor(getResources().getColor(2131166714));
    ...
    catch (Exception localException)
    {
      ...
      ((RelativeLayout.LayoutParams)localObject2).addRule(3, 2131375833);
      localFrameLayout.setLayoutParams((ViewGroup.LayoutParams)localObject2);
      localFrameLayout.setBackgroundResource(2130848494);
