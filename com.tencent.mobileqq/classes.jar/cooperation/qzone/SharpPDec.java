...
public class SharpPDec
{
  ...
  public static int a(Context paramContext)
  {
    ...
    try
    {
      String str = bgfp.a(paramContext);
      localObject = str;
    }
    ...
    do
    {
      ...
      {
        return i;
        if (((!bgfp.b((String)localObject)) && (!bgfp.e((String)localObject))) || (QzoneConfig.getInstance().getConfig("QZoneSetting", "qzoneSharppGate", 1) != 0)) {
          break;
        }
  ...
  private static void a()
  {
    ...
    try
    {
      localObject2 = bgfp.a((Context)localObject2);
    ...
    bool = bgfp.g((String)localObject1);
    ...
    if (bool)
    {
      ...
      {
        localObject1 = (amyp)((QQAppInterface)localObject1).getManager(77);
        if (localObject1 == null) {
          break label199;
        }
        localObject1 = ((amyp)localObject1).a(amzo.e());
        if (localObject1 == null) {
          break label191;
        }
        ((amza)localObject1).a(false);
  ...
  public static int b(Context paramContext)
  {
    ...
    //   6: bipush 12
    //   8: if_icmpge +18 -> 26
    //   11: invokestatic 293	java/lang/System:currentTimeMillis	()J
    //   14: getstatic 295	cooperation/qzone/SharpPDec:jdField_a_of_type_Long	J
    //   17: lsub
    ...
    //   39: aload_0
    //   40: invokestatic 297	cooperation/qzone/SharpPDec:a	(Landroid/content/Context;)Z
    //   43: ifne +68 -> 111
    //   46: invokestatic 293	java/lang/System:currentTimeMillis	()J
    //   49: putstatic 295	cooperation/qzone/SharpPDec:jdField_a_of_type_Long	J
    //   52: getstatic 21	cooperation/qzone/SharpPDec:b	I
    //   55: iconst_m1
    //   56: if_icmpne +48 -> 104
    //   59: invokestatic 86	common/config/service/QzoneConfig:getInstance	()Lcommon/config/service/QzoneConfig;
    //   62: ldc 88
    //   64: ldc_w 299
    //   67: sipush 3000
    //   70: invokevirtual 94	common/config/service/QzoneConfig:getConfig	(Ljava/lang/String;Ljava/lang/String;I)I
    //   73: putstatic 21	cooperation/qzone/SharpPDec:b	I
    //   76: ldc 37
    //   78: iconst_1
    //   79: new 106	java/lang/StringBuilder
    //   82: dup
    //   83: invokespecial 107	java/lang/StringBuilder:<init>	()V
    //   86: ldc_w 301
    //   89: invokevirtual 116	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   92: getstatic 21	cooperation/qzone/SharpPDec:b	I
    //   95: invokevirtual 304	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   98: invokevirtual 123	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   101: invokestatic 71	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   104: getstatic 15	cooperation/qzone/SharpPDec:jdField_a_of_type_Int	I
    //   107: istore_1
    //   108: goto -78 -> 30
    //   111: new 2	cooperation/qzone/SharpPDec
    //   114: dup
    //   115: invokespecial 305	cooperation/qzone/SharpPDec:<init>	()V
    //   118: invokespecial 307	cooperation/qzone/SharpPDec:GetVersion	()I
    //   121: putstatic 15	cooperation/qzone/SharpPDec:jdField_a_of_type_Int	I
    //   124: ldc 37
    //   126: iconst_1
    //   127: new 106	java/lang/StringBuilder
    //   130: dup
    //   131: invokespecial 107	java/lang/StringBuilder:<init>	()V
    //   134: ldc_w 309
    //   137: invokevirtual 116	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   140: getstatic 15	cooperation/qzone/SharpPDec:jdField_a_of_type_Int	I
    //   143: invokevirtual 304	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   146: invokevirtual 123	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   149: invokestatic 71	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   152: getstatic 15	cooperation/qzone/SharpPDec:jdField_a_of_type_Int	I
    //   155: istore_1
    //   156: goto -126 -> 30
    //   159: astore_0
    //   160: ldc 37
    ...
    //   168: invokestatic 312	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   171: goto -19 -> 152
    //   174: astore_0
    //   175: ldc 2
    //   177: monitorexit
