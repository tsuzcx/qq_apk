  ...
  extends RelativeLayout
{
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131363657));
    this.b = ((TextView)findViewById(2131363658));
  }
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (paramBoolean)
    {
      ...
      paramInt2 = getWidth();
      paramInt3 = paramInt2 - (int)(this.jdField_a_of_type_AndroidContentContext.getResources().getDimension(2131560638) + 0.5D) - (int)(this.jdField_a_of_type_AndroidContentContext.getResources().getDimension(2131560639) + 0.5D) - (int)(this.jdField_a_of_type_AndroidContentContext.getResources().getDimension(2131560637) + 0.5D) - paramInt1 - 1;
