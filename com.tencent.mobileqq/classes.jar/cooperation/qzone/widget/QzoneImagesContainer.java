  ...
  extends LinearLayout
{
  ...
  private void a(List<ByteStringMicro> paramList, int paramInt)
  {
    ...
    if (paramList.hasNext())
    {
      ...
      if (j < jdField_a_of_type_Int)
      {
        ...
        localObject1 = new LinearLayout.LayoutParams(aciy.a(60.0F, getResources()), aciy.a(60.0F, getResources()));
        ((LinearLayout.LayoutParams)localObject1).setMargins(0, 0, aciy.a(2.0F, getResources()), 0);
    ...
    for (;;)
    {
      ...
      if (j == jdField_a_of_type_Int)
      {
        ...
        addViewInLayout((View)localObject2, j - 1, new LinearLayout.LayoutParams(aciy.a(60.0F, getResources()), aciy.a(60.0F, getResources())));
  ...
  public void setImages(List<ByteStringMicro> paramList, int paramInt, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      addView((View)localObject1, new LinearLayout.LayoutParams(aciy.a(60.0F, getResources()), aciy.a(60.0F, getResources())));
