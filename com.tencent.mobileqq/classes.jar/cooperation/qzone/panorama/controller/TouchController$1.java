  ...
  extends TimerTask
{
  ...
  public TouchController$1(bhgv parambhgv, int paramInt1, int[] paramArrayOfInt, int paramInt2) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      {
        bhgv.a(this.this$0).cancel();
        cancel();
      }
      float f1 = this.jdField_a_of_type_ArrayOfInt[0];
      float f2 = bhgv.a(this.this$0);
      bhgv.a(this.this$0, 0.0F, f1 * f2);
      return;
