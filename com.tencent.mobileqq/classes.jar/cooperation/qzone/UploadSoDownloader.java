...
public class UploadSoDownloader
{
  ...
  private void a(boolean paramBoolean)
  {
    ...
    SharedPreferences localSharedPreferences = BaseApplicationImpl.getApplication().getSharedPreferences("qzone_upload_so", 0);
    if (localSharedPreferences != null) {
      localSharedPreferences.edit().putBoolean("upload_so_download_success", paramBoolean);
    }
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if ((!bool1) && (bool2))
        {
          ...
          jdField_a_of_type_Boolean = false;
          ThreadManager.post(new anbc(this), 5, null, true);
          continue;
        }
        if (b) {
          continue;
      ...
      jdField_a_of_type_Boolean = false;
      a(false);
      QzoneModuleConfigManager.QzoneModuleRecord localQzoneModuleRecord = QzoneModuleConfigManager.a().a("upload.so");
      ...
      try
      {
        ...
        QzoneModuleManager.getInstance().downloadModule("upload.so", new anbd(this));
      }
  ...
  public boolean a(String paramString)
  {
    ...
    //   2: aload_0
    //   3: monitorenter
    //   4: invokestatic 324	common/config/service/QzoneAlphaConfig:a	()Lcommon/config/service/QzoneAlphaConfig;
    //   7: ldc_w 326
    //   10: ldc_w 328
    //   13: iconst_0
    //   14: invokevirtual 331	common/config/service/QzoneAlphaConfig:a	(Ljava/lang/String;Ljava/lang/String;I)I
    //   17: istore_2
    //   18: ldc 60
    //   20: iconst_1
    ...
    //   44: getstatic 143	cooperation/qzone/UploadSoDownloader:jdField_a_of_type_Boolean	Z
    ...
    //   58: if_icmpeq +7 -> 65
    //   61: iconst_0
    //   62: putstatic 143	cooperation/qzone/UploadSoDownloader:jdField_a_of_type_Boolean	Z
    //   65: aload_0
    //   66: invokespecial 255	cooperation/qzone/UploadSoDownloader:a	()Z
    //   69: istore 4
    //   71: ldc 60
    //   73: iconst_1
    ...
    //   100: ifne +7 -> 107
    //   103: iconst_0
    //   104: putstatic 143	cooperation/qzone/UploadSoDownloader:jdField_a_of_type_Boolean	Z
    //   107: getstatic 143	cooperation/qzone/UploadSoDownloader:jdField_a_of_type_Boolean	Z
    //   110: ifeq +149 -> 259
    ...
    //   124: getstatic 29	cooperation/qzone/UploadSoDownloader:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    ...
    //   243: iconst_0
    //   244: putstatic 143	cooperation/qzone/UploadSoDownloader:jdField_a_of_type_Boolean	Z
    //   247: aload_0
    //   248: iconst_0
    //   249: invokespecial 91	cooperation/qzone/UploadSoDownloader:a	(Z)V
    //   252: getstatic 29	cooperation/qzone/UploadSoDownloader:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   255: invokevirtual 299	java/io/File:delete	()Z
    //   258: pop
    //   259: getstatic 143	cooperation/qzone/UploadSoDownloader:jdField_a_of_type_Boolean	Z
    //   262: istore_3
    //   263: goto -54 -> 209
    //   266: iconst_0
    //   267: putstatic 143	cooperation/qzone/UploadSoDownloader:jdField_a_of_type_Boolean	Z
    //   270: ldc 60
    //   272: iconst_1
    ...
    //   296: aload_0
    //   297: iconst_0
    //   298: invokespecial 91	cooperation/qzone/UploadSoDownloader:a	(Z)V
    //   301: getstatic 29	cooperation/qzone/UploadSoDownloader:jdField_a_of_type_JavaIoFile	Ljava/io/File;
