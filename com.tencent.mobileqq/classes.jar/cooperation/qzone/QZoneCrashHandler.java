  ...
  extends CrashHandler
{
  ...
  public static void appendLog(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    //   6: dup
    //   7: getstatic 38	com/tencent/mobileqq/app/AppConstants:LOG_PATH_SDCARD	Ljava/lang/String;
    //   10: invokestatic 44	com/tencent/mobileqq/vfs/VFSAssistantUtils:getSDKPrivatePath	(Ljava/lang/String;)Ljava/lang/String;
    //   13: invokespecial 47	java/io/File:<init>	(Ljava/lang/String;)V
    //   16: astore 4
    //   18: aload 4
    //   20: invokevirtual 51	java/io/File:exists	()Z
    //   23: ifne +9 -> 32
    //   26: aload 4
    //   28: invokevirtual 54	java/io/File:mkdirs	()Z
    //   31: pop
    //   32: new 33	java/io/File
    //   35: dup
    //   36: new 56	java/lang/StringBuilder
    //   39: dup
    //   40: invokespecial 57	java/lang/StringBuilder:<init>	()V
    //   43: getstatic 38	com/tencent/mobileqq/app/AppConstants:LOG_PATH_SDCARD	Ljava/lang/String;
    ...
    //   57: invokestatic 44	com/tencent/mobileqq/vfs/VFSAssistantUtils:getSDKPrivatePath	(Ljava/lang/String;)Ljava/lang/String;
    //   60: invokespecial 47	java/io/File:<init>	(Ljava/lang/String;)V
    //   63: astore 4
    //   65: aload 4
    //   67: invokevirtual 51	java/io/File:exists	()Z
    //   70: ifne +231 -> 301
    //   73: iconst_1
    //   74: istore_3
    //   75: new 69	java/io/FileWriter
    //   78: dup
    //   79: aload 4
    //   81: iconst_1
    //   82: invokespecial 72	java/io/FileWriter:<init>	(Ljava/io/File;Z)V
    //   85: astore 4
    //   87: iload_3
    //   88: ifeq +105 -> 193
    //   91: aload 4
    ...
    //   105: getstatic 79	android/os/Build:MODEL	Ljava/lang/String;
    //   108: invokevirtual 61	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   111: ldc 81
    //   113: invokevirtual 61	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   116: getstatic 86	android/os/Build$VERSION:RELEASE	Ljava/lang/String;
    ...
    //   125: invokevirtual 89	java/io/FileWriter:write	(Ljava/lang/String;)V
    //   128: aload 4
    //   130: ldc 91
    //   132: invokevirtual 89	java/io/FileWriter:write	(Ljava/lang/String;)V
    //   135: new 93	android/text/format/Time
    //   138: dup
    //   139: invokespecial 94	android/text/format/Time:<init>	()V
    //   142: astore 5
    //   144: aload 5
    //   146: invokevirtual 97	android/text/format/Time:setToNow	()V
    //   149: aload 4
    //   151: new 56	java/lang/StringBuilder
    //   154: dup
    //   155: invokespecial 57	java/lang/StringBuilder:<init>	()V
    //   158: aload 5
    //   160: ldc 99
    //   162: invokevirtual 102	android/text/format/Time:format	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   176: invokevirtual 89	java/io/FileWriter:write	(Ljava/lang/String;)V
    //   179: aload 4
    //   181: ldc 106
    //   183: invokevirtual 89	java/io/FileWriter:write	(Ljava/lang/String;)V
    //   186: aload 4
    //   188: ldc 91
    //   190: invokevirtual 89	java/io/FileWriter:write	(Ljava/lang/String;)V
    //   193: new 93	android/text/format/Time
    //   196: dup
    //   197: invokespecial 94	android/text/format/Time:<init>	()V
    //   200: astore 5
    //   202: aload 5
    //   204: invokevirtual 97	android/text/format/Time:setToNow	()V
    //   207: aload 4
    ...
    //   216: aload 5
    //   218: ldc 99
    //   220: invokevirtual 102	android/text/format/Time:format	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   234: invokevirtual 89	java/io/FileWriter:write	(Ljava/lang/String;)V
    //   237: aload_0
    //   238: ifnull +32 -> 270
    //   241: aload 4
    //   243: new 56	java/lang/StringBuilder
    //   246: dup
    //   247: invokespecial 57	java/lang/StringBuilder:<init>	()V
    //   250: ldc 108
    //   252: invokevirtual 61	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   255: aload_0
    //   256: invokevirtual 61	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   259: ldc 110
    ...
    //   267: invokevirtual 89	java/io/FileWriter:write	(Ljava/lang/String;)V
    //   270: aload 4
    //   272: aload_1
    //   273: invokevirtual 89	java/io/FileWriter:write	(Ljava/lang/String;)V
    //   276: aload 4
    //   278: ldc 91
    //   280: invokevirtual 89	java/io/FileWriter:write	(Ljava/lang/String;)V
    //   283: aload 4
    //   285: invokevirtual 113	java/io/FileWriter:close	()V
    //   288: iconst_0
    //   289: ifeq +11 -> 300
    //   292: new 115	java/lang/NullPointerException
    //   295: dup
    //   296: invokespecial 116	java/lang/NullPointerException:<init>	()V
    //   299: athrow
    //   300: return
    //   301: iconst_0
    //   302: istore_3
    //   303: goto -228 -> 75
    //   306: astore_0
    //   307: invokestatic 121	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   310: ifeq -10 -> 300
    //   313: ldc 123
    //   315: iconst_1
    //   316: new 56	java/lang/StringBuilder
    //   319: dup
    ...
    //   328: aload_0
    //   329: invokevirtual 128	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   345: astore_0
    //   346: aload_1
    //   347: invokevirtual 135	java/lang/Exception:printStackTrace	()V
    //   350: aload_0
    //   351: ifnull -51 -> 300
    //   354: aload_0
    //   355: invokevirtual 113	java/io/FileWriter:close	()V
    //   358: return
    //   359: astore_0
    ...
    //   376: ldc 125
    //   378: invokevirtual 61	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   381: aload_0
    //   382: invokevirtual 128	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   385: invokevirtual 61	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   388: invokevirtual 67	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   391: invokestatic 132	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   394: return
    //   395: astore_0
    //   396: aconst_null
    //   397: astore_1
    ...
    //   399: ifnull +7 -> 406
    //   402: aload_1
    //   403: invokevirtual 113	java/io/FileWriter:close	()V
    //   406: aload_0
    //   407: athrow
    //   408: astore_1
    //   409: invokestatic 121	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   412: ifeq -6 -> 406
    //   415: ldc 123
    //   417: iconst_1
    //   418: new 56	java/lang/StringBuilder
    //   421: dup
    //   422: invokespecial 57	java/lang/StringBuilder:<init>	()V
    //   425: ldc 125
    //   427: invokevirtual 61	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   430: aload_1
    //   431: invokevirtual 128	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   434: invokevirtual 61	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   437: invokevirtual 67	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   440: invokestatic 132	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   443: goto -37 -> 406
    //   446: astore_0
    //   447: aload 4
    //   449: astore_1
