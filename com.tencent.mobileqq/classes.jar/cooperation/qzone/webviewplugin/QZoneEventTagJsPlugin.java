  ...
  implements WebEventListener
{
  ...
  private void a(WebViewPlugin paramWebViewPlugin, WebViewPlugin.PluginRuntime paramPluginRuntime, String[] paramArrayOfString)
  {
    try
    {
      long l = new JSONObject(paramArrayOfString[0]).getLong("uin");
      paramWebViewPlugin = paramPluginRuntime.a();
      paramWebViewPlugin.startActivity(AddFriendLogicActivity.a(paramWebViewPlugin, 1, String.valueOf(l), "", 3011, 1, null, null, null, null, null));
      return;
    }
  ...
  private void b(String paramString)
  {
    try
    {
      ...
      if ((paramString != null) && (paramString.length() > 0))
      {
        ...
        RemoteHandleManager.a().a().b(localBundle);
        return;
      }
      RemoteHandleManager.a().a().b(null);
      return;
    }
    catch (JSONException paramString)
    {
  ...
  private void c(String paramString)
  {
    try
    {
      ...
      RemoteHandleManager.a().a().c(paramString);
      return;
    }
    catch (JSONException paramString)
    {
