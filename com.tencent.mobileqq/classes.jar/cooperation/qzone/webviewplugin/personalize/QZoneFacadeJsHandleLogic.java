...
public class QZoneFacadeJsHandleLogic
{
  ...
  {
    Object localObject1 = "";
    Object localObject2 = getAvatarFileCacheDir(null);
  ...
  public static void handleCheckDownloadedIdList(bgve parambgve, String... paramVarArgs)
  {
    ...
    if (parambgve != null) {
      parambgve.callJs("window.QzAvatarDressJSInterface.onReceive({type:\"idlist\",data:\"" + paramVarArgs + "\"});");
    }
  }
  
  public static void handleDownloadFacadeFinish(bgve parambgve, String... paramVarArgs)
  {
    if (QLog.isColorLevel()) {
    ...
    if ((!TextUtils.isEmpty(localObject2)) && (parambgve.a() != null))
    {
  ...
  public static void handleSetFacadeFinish(bgve parambgve, String... paramVarArgs)
  {
    j = 1;
    if (QLog.isColorLevel()) {
      QLog.d("QZoneFacadeJsHandleLogic", 2, "handleSetFacadeFinish");
    }
    if ((parambgve.a() == null) || (parambgve.a() == null)) {
      return;
    }
    LocalMultiProcConfig.putInt4Uin("key_personalize_prefix_19", 0, Long.valueOf(parambgve.a().getCurrentAccountUin()).longValue());
