  ...
  extends WebViewPlugin
{
  ...
  private void c(String... paramVarArgs)
  {
    try
    {
      ...
      paramVarArgs.putExtra("key_left_tab_title", this.mRuntime.a().getString(2131432715));
      paramVarArgs.putExtra("key_right_tab_title", this.mRuntime.a().getString(2131432717));
