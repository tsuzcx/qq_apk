  ...
  extends WebViewPlugin
{
  ...
  private void openAlbum(String... paramVarArgs)
  {
    try
    {
      ...
      paramVarArgs.putExtra("key_left_tab_title", this.mRuntime.a().getString(2131716546));
      paramVarArgs.putExtra("key_right_tab_title", this.mRuntime.a().getString(2131716627));
