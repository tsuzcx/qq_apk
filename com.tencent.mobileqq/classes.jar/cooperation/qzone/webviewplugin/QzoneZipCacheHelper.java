...
public class QzoneZipCacheHelper
{
  ...
  public static boolean checkAndDownLoadFileIfNeeded(AppInterface paramAppInterface, String paramString1, String paramString2, String paramString3, int paramInt, QzoneZipCacheHelperCallBack paramQzoneZipCacheHelperCallBack)
  {
    for (;;)
    {
      ...
      label274:
      ThreadManager.postDownLoadTask(new amnn(paramString2, str, paramInt, paramString1, paramAppInterface), 2, null, false);
      continue;
      label300:
      return true;
      label302:
  ...
  {
    PriorityThreadPool.getDefault().submit(new amnm(paramString1, paramString2), PriorityThreadPool.Priority.LOW);
  }
}
