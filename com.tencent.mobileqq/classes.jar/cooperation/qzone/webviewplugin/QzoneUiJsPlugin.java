  ...
  implements WebEventListener
{
      ...
      try
      {
        ...
        if (!TextUtils.isEmpty(str1))
        {
          ...
          if (QZoneVipInfoManager.a().a() > 0)
          {
            bool1 = true;
            break label512;
            QZoneVideoCommonUtils.a(paramString, "ref_h5_record_video", bool1, bool2, bool3, bool4, bool5, bool6, str1, str2, (Intent)localObject);
          }
        }
        else
        {
  ...
  private void b(String paramString)
  {
    ...
    QZoneVideoCommonUtils.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), i, paramString, l2, localBundle);
    return;
    label201:
    if (i == 1) {
      QZoneHelper.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), QZoneHelper.UserInfo.a(), i, paramString, l1, l1 + l2);
    }
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if ("ptucamera".equals(paramString.optString("shoot")))
        {
          ...
          QZoneVideoCommonUtils.a(0L, paramString, true, true, "QZonePublishMoodTabActivity", bool2, true, str, bool1, null, null, null);
          return;
        }
      }
      catch (JSONException paramString)
  ...
  public void onWebEvent(String paramString, Bundle paramBundle)
  {
    ...
    if (TextUtils.isEmpty(paramString)) {}
    for (paramString = "";; paramString = QzoneDynamicAlbumPlugin.a(paramString, i, j))
    {
