...
public class QzoneAudioRecordPlugin$SimpleAACRecorder
{
  ...
  public void a(String paramString)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_AndroidMediaMediaRecorder.setOnInfoListener(new ankf(this));
      this.jdField_a_of_type_AndroidMediaMediaRecorder.setOnErrorListener(new ankg(this));
