  ...
  implements WebEventListener
{
  ...
  private void a(amnd paramamnd)
  {
    int i = 0;
    if (TextUtils.isEmpty(paramamnd.jdField_a_of_type_JavaLangString)) {
      return;
    }
    if (TextUtils.isEmpty(paramamnd.jdField_a_of_type_JavaLangString)) {
      i = 101;
    ...
    while (i != 0)
    {
      ...
      try
      {
        ...
        localJSONObject2.put("id", paramamnd.jdField_a_of_type_Int);
        localJSONObject2.put("url", "");
        localJSONObject1.put("data", localJSONObject2);
        localJSONObject1.put("msg", "");
        this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.callJs(paramamnd.c, new String[] { localJSONObject1.toString() });
        return;
      }
      catch (JSONException paramamnd)
      {
        QLog.w("js-upload: QzoneUploadPlugin", 1, "JSONException error !", paramamnd);
        return;
        paramamnd.d = QzoneUploadInterface.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), paramamnd.jdField_a_of_type_JavaLangString);
        if ((!TextUtils.isEmpty(paramamnd.d)) && (new File(paramamnd.d).exists()))
        {
          this.jdField_a_of_type_JavaUtilMap.put(paramamnd.d, Integer.valueOf(paramamnd.jdField_a_of_type_Int));
          if (!QzoneUploadInterface.a(paramamnd.d, paramamnd.b)) {
            i = 102;
          }
        }
        else
      ...
      catch (Exception paramamnd)
      {
        QLog.w("js-upload: QzoneUploadPlugin", 1, "parentPlugin.callJs error !", paramamnd);
      }
    }
  }
  ...
  protected void a(String... paramVarArgs)
  {
    ...
    //   86: aload_0
    //   87: aload_1
    //   88: invokespecial 206	cooperation/qzone/webviewplugin/QzoneUploadPlugin:a	(Lamnd;)V
    //   91: return
    //   92: astore_2
    //   93: aconst_null
    //   94: astore_1
  ...
  public void onWebEvent(String paramString, Bundle paramBundle)
  {
    ...
    paramBundle = (amnd)this.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(j));
    if (paramBundle == null)
    {
