  ...
  extends QzoneInternalWebViewPlugin
{
  ...
  private void handleFeedActionPanel(String... paramVarArgs)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        i8 = i14;
        i9 = i13;
        this.acceptEncoded = ((JSONObject)localObject6).optBoolean("acceptEncoded");
        i2 = i12;
        bool4 = bool9;
        bool5 = bool10;
        bool6 = bool11;
        ...
        i8 = i14;
        i9 = i13;
        sAcceptEncoded = this.acceptEncoded;
        i2 = i12;
        bool4 = bool9;
        bool5 = bool10;
        bool6 = bool11;
        ...
        if (((JSONObject)localObject6).optInt("isFromDIY") == 1)
        {
          ...
          i8 = i10;
          i9 = i11;
          this.mSwitchFontCallback = ((JSONObject)localObject6).optString("switchFontCallback");
          bool4 = bool8;
          i4 = i10;
          i3 = i1;
          i2 = i;
          ...
          if (QLog.isDevelopLevel()) {
            QLog.d("QZoneFeedActionJsPlugin", 4, new Object[] { "handleFeedActionPanel hint is: " + (String)localObject5 + "\t autofill:" + paramVarArgs + ",needEmoticonBtn: " + i2 + ",needAtBtn: " + i1 + ",needPrivateBtn: " + m + ",isReply: " + i3 + ",privateCommentStatus: " + i10 + ",maxLen: " + i4 + ",troopid: " + i11, "acceptEncoded:" + this.acceptEncoded + " disableAutoClose:" + bool8 + " cachePanelHeight:" + bool4 + " cahcePanelClose:" + bool3 });
          }
          ...
          i = QZoneWebViewPlugin.generateRequestCode(this.parentPlugin, this.parentPlugin.mRuntime, 2);
          QZoneHelper.forwardToFeedActionPanel(this.parentPlugin.mRuntime.a(), QZoneHelper.UserInfo.getInstance(), i, (String)localObject5, paramVarArgs, "", "", i10, false, i1, i2, 0, m, i3, (String)localObject4, i4, i11, false, "", false, (Bundle)localObject1);
          return;
        }
        bool1 = false;
        continue;
  ...
  private void notifyH5FontSelect(Intent paramIntent)
  {
    ...
    try
    {
      ...
      paramIntent = "window." + this.mSwitchFontCallback + "(" + localJSONObject.toString() + ");";
      if (QLog.isColorLevel()) {
  ...
  private void notifyInputPanelClosed(Intent paramIntent)
  {
    ...
    try
    {
      paramIntent = "window." + name + "(" + "{event_type:\"PANEL_CLOSED\"}" + ");";
      if (QLog.isColorLevel()) {
        QLog.d("QZoneFeedActionJsPlugin", 2, "invoke callback js:" + paramIntent);
      }
      this.parentPlugin.mRuntime.a().callJs(paramIntent);
  ...
  private void notifyPanelHeightChanged(Intent paramIntent)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        paramIntent = "window." + name + "(" + paramIntent + ");";
        if (QLog.isColorLevel()) {
          QLog.d("QZoneFeedActionJsPlugin", 2, "invoke callback js:" + paramIntent);
        }
        this.parentPlugin.mRuntime.a().callJs(paramIntent);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((paramString.has("status")) && ("success".equalsIgnoreCase(paramString.getString("status"))))
        {
          ...
          {
            QZoneVipInfoManager.getInstance().setVipType(2);
            return;
          }
        }
      }
