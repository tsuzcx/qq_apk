...
public class ResDownloadManger$1
  implements Runnable
{
  public ResDownloadManger$1(bggh parambggh, int paramInt, String paramString, bggj parambggj, BitmapFactory.Options paramOptions) {}
  ...
  public void run()
  {
    ...
    //   2: aconst_null
    //   3: astore_2
    //   4: invokestatic 39	bggh:a	()[Ljava/lang/String;
    //   7: aload_0
    ...
    //   18: invokestatic 42	bggh:a	(Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;
    //   21: astore 4
    //   23: aload 4
    //   25: invokestatic 45	bggh:a	(Ljava/io/File;)Z
    //   28: ifeq +207 -> 235
    //   31: aload_0
    //   32: monitorenter
    //   33: aload_0
    //   34: getfield 17	cooperation/qzone/util/ResDownloadManger$1:this$0	Lbggh;
    //   37: invokestatic 48	bggh:a	(Lbggh;)Landroid/support/v4/util/LruCache;
    ...
    //   77: ifnull +31 -> 108
    //   80: aload_0
    //   81: getfield 23	cooperation/qzone/util/ResDownloadManger$1:jdField_a_of_type_Bggj	Lbggj;
    //   84: ifnull +21 -> 105
    //   87: aload_0
    //   88: getfield 23	cooperation/qzone/util/ResDownloadManger$1:jdField_a_of_type_Bggj	Lbggj;
    //   91: aload_0
    ...
    //   117: invokestatic 85	bggh:a	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   120: astore_2
    //   121: aload_2
    //   122: astore_1
    //   123: aload_0
    ...
    //   126: ifnull -19 -> 107
    //   129: aload_0
    //   130: getfield 17	cooperation/qzone/util/ResDownloadManger$1:this$0	Lbggh;
    //   133: invokestatic 48	bggh:a	(Lbggh;)Landroid/support/v4/util/LruCache;
    ...
    //   169: pop
    //   170: aload_0
    //   171: getfield 23	cooperation/qzone/util/ResDownloadManger$1:jdField_a_of_type_Bggj	Lbggj;
    //   174: ifnull -67 -> 107
    //   177: aload_0
    //   178: getfield 23	cooperation/qzone/util/ResDownloadManger$1:jdField_a_of_type_Bggj	Lbggj;
    //   181: aload_0
    ...
    //   232: goto -109 -> 123
    //   235: aload_0
    //   236: getfield 17	cooperation/qzone/util/ResDownloadManger$1:this$0	Lbggh;
    //   239: aload_1
    //   240: aload_0
    ...
    //   248: aload_0
    //   249: getfield 23	cooperation/qzone/util/ResDownloadManger$1:jdField_a_of_type_Bggj	Lbggj;
    //   252: invokestatic 102	bggh:a	(Lbggh;Ljava/lang/String;ILjava/lang/String;Lbggj;)Lbggk;
    //   255: astore_2
    //   256: aload_0
    //   257: getfield 17	cooperation/qzone/util/ResDownloadManger$1:this$0	Lbggh;
    //   260: aload_1
    //   261: aload_2
    //   262: invokestatic 105	bggh:a	(Lbggh;Ljava/lang/String;Lbggk;)Z
    //   265: ifeq -158 -> 107
    //   268: aload_0
    //   269: getfield 17	cooperation/qzone/util/ResDownloadManger$1:this$0	Lbggh;
    //   272: aload_2
    //   273: invokestatic 108	bggh:a	(Lbggh;Lbggk;)V
    //   276: return
    //   277: astore_2
    //   278: goto -56 -> 222
    //   281: astore_2
