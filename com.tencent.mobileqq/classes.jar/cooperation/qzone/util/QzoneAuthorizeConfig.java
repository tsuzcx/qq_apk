...
{
  private static QzoneAuthorizeConfig jdField_a_of_type_CooperationQzoneUtilQzoneAuthorizeConfig;
  ...
  private final ConcurrentHashMap jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  
  public static QzoneAuthorizeConfig a()
  {
    if (jdField_a_of_type_CooperationQzoneUtilQzoneAuthorizeConfig == null) {}
    try
    {
      if (jdField_a_of_type_CooperationQzoneUtilQzoneAuthorizeConfig == null) {
        jdField_a_of_type_CooperationQzoneUtilQzoneAuthorizeConfig = new QzoneAuthorizeConfig();
      }
      return jdField_a_of_type_CooperationQzoneUtilQzoneAuthorizeConfig;
    }
    finally {}
  }
  
  private void a(String paramString, ConcurrentHashMap paramConcurrentHashMap)
  {
