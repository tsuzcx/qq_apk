...
{
  private static XMPCoreUtil jdField_a_of_type_CooperationQzoneUtilXMPCoreUtil;
  ...
  {
    if (jdField_a_of_type_CooperationQzoneUtilXMPCoreUtil == null) {}
    try
    {
      if (jdField_a_of_type_CooperationQzoneUtilXMPCoreUtil == null) {
        jdField_a_of_type_CooperationQzoneUtilXMPCoreUtil = new XMPCoreUtil();
      }
      return jdField_a_of_type_CooperationQzoneUtilXMPCoreUtil;
    }
    finally {}
  }
  
  private HashMap a(String paramString1, String paramString2, String[] paramArrayOfString)
  {
    ...
    do
    {
      ...
      {
        return paramString1;
        localObject1 = JarReflectUtil.a("com.adobe.xmp.XmpUtil", "extractXMPMeta", false, a(new Class[] { String.class }), new Object[] { paramString1 });
    ...
    for (;;)
    {
      i += 1;
      break;
      Object localObject2 = JarReflectUtil.a(localObject1, "getProperty", false, a(new Class[] { String.class, String.class }), new Object[] { paramString2, paramString1 });
      if (localObject2 != null)
      {
        localObject2 = JarReflectUtil.a(localObject2, "getValue", false, new Class[0], new Object[0]);
        if (localObject2 != null) {
  ...
  public void a(XMPCoreUtil.XMPCoreJarLoadListener paramXMPCoreJarLoadListener)
  {
    ...
    QzoneModuleManager.getInstance().downloadModule("xmpcore.jar", new anjb(this, paramXMPCoreJarLoadListener));
  }
