...
public class PhotoUtils
{
  ...
  public static ArrayList a(Context paramContext, int paramInt1, long paramLong1, long paramLong2, int paramInt2, int paramInt3)
  {
    ...
    //   2: lload_2
    //   3: lload 4
    //   5: invokestatic 259	cooperation/qzone/util/PhotoUtils:a	(Landroid/content/Context;IJJ)Landroid/database/Cursor;
    //   8: astore_0
    //   9: aload_0
    ...
    //   16: iload_1
    //   17: ifle +370 -> 387
    //   20: new 266	java/util/ArrayList
    //   23: dup
    //   24: iload_1
    //   25: invokespecial 269	java/util/ArrayList:<init>	(I)V
    //   28: astore 9
    //   30: aload_0
    //   31: ldc_w 271
    //   34: invokeinterface 274 2 0
    //   39: istore_1
    //   40: new 266	java/util/ArrayList
    //   43: dup
    //   44: invokespecial 275	java/util/ArrayList:<init>	()V
    //   47: astore 8
    //   49: iload 7
    ...
    //   81: ldc 52
    //   83: iconst_1
    //   84: invokevirtual 56	common/config/service/QzoneConfig:getConfig	(Ljava/lang/String;Ljava/lang/String;I)I
    //   87: istore 7
    //   89: aload_0
    ...
    //   98: aload_0
    //   99: iload_1
    //   100: invokeinterface 282 2 0
    //   105: astore 10
    //   107: aload 10
    //   109: ifnull -20 -> 89
    //   112: aload 8
    //   114: aload 10
    //   116: invokeinterface 287 2 0
    //   121: ifne -32 -> 89
    //   124: new 137	java/io/File
    //   127: dup
    //   128: aload 10
    //   130: invokespecial 140	java/io/File:<init>	(Ljava/lang/String;)V
    //   133: astore 11
    //   135: aload 11
    //   137: ifnull -48 -> 89
    //   140: aload 11
    //   142: invokevirtual 144	java/io/File:exists	()Z
    //   145: ifeq -56 -> 89
    //   148: aload 11
    //   150: invokevirtual 290	java/io/File:isDirectory	()Z
    //   153: ifne -64 -> 89
    //   156: iload 7
    //   158: ifne +14 -> 172
    //   161: aload 10
    //   163: invokestatic 292	cooperation/qzone/util/PhotoUtils:a	(Ljava/lang/String;)Landroid/media/ExifInterface;
    //   166: invokestatic 295	cooperation/qzone/util/PhotoUtils:a	(Landroid/media/ExifInterface;)Z
    //   169: ifeq -80 -> 89
    //   172: aload 9
    //   174: aload 10
    //   176: invokevirtual 298	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   179: pop
    //   180: aload 9
    //   182: invokevirtual 301	java/util/ArrayList:size	()I
    //   185: iload 6
    //   187: if_icmplt -98 -> 89
    //   190: invokestatic 304	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   193: ifeq +187 -> 380
    //   196: ldc 207
    //   198: iconst_4
    //   199: ldc_w 306
    //   202: invokestatic 309	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   205: aload 9
    //   207: astore 8
    //   209: aload 8
    //   211: astore 9
    ...
    //   229: areturn
    //   230: ldc_w 314
    //   233: invokestatic 319	cooperation/qzone/util/RecentPhotoManger:a	(Ljava/lang/String;)Ljava/util/List;
    //   236: astore 8
    //   238: goto -162 -> 76
    //   241: ldc_w 321
    //   244: invokestatic 319	cooperation/qzone/util/RecentPhotoManger:a	(Ljava/lang/String;)Ljava/util/List;
    //   247: astore 8
    //   249: goto -173 -> 76
    //   252: ldc_w 323
    //   255: invokestatic 319	cooperation/qzone/util/RecentPhotoManger:a	(Ljava/lang/String;)Ljava/util/List;
    //   258: astore 8
    //   260: goto -184 -> 76
    //   263: astore_0
    //   264: aload_0
    //   265: invokevirtual 30	java/lang/Exception:printStackTrace	()V
    //   268: aload 8
    //   270: areturn
    //   271: astore 9
    //   273: aconst_null
    ...
    //   276: astore 8
    //   278: aload 9
    //   280: invokevirtual 30	java/lang/Exception:printStackTrace	()V
    //   283: aload_0
    //   284: astore 9
    //   286: aload 8
    //   288: ifnull -61 -> 227
    ...
    //   300: astore 8
    //   302: aload 8
    //   304: invokevirtual 30	java/lang/Exception:printStackTrace	()V
    //   307: aload_0
    //   308: areturn
    //   309: astore 8
    //   311: aconst_null
    ...
    //   326: astore_0
    //   327: aload_0
    //   328: invokevirtual 30	java/lang/Exception:printStackTrace	()V
    //   331: goto -8 -> 323
    //   334: astore 8
    //   336: goto -23 -> 313
    //   339: astore 9
  ...
  public static boolean a(Bitmap paramBitmap, String paramString, android.graphics.Bitmap.CompressFormat paramCompressFormat, int paramInt, boolean paramBoolean)
  {
    ...
    //   8: astore_1
    //   9: aload_1
    //   10: invokevirtual 144	java/io/File:exists	()Z
    //   13: ifne +8 -> 21
    //   16: aload_1
    //   17: invokevirtual 327	java/io/File:createNewFile	()Z
    //   20: pop
    //   21: new 329	java/io/BufferedOutputStream
    //   24: dup
    //   25: new 331	java/io/FileOutputStream
    //   28: dup
    //   29: aload_1
    //   30: invokespecial 334	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   33: invokespecial 337	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   36: astore 7
    //   38: aload 7
    //   40: astore_1
    //   41: aload_0
    ...
    //   43: iload_3
    //   44: aload 7
    //   46: invokevirtual 343	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   49: istore 5
    //   51: aload 7
    //   53: astore_1
    //   54: aload 7
    //   56: invokevirtual 346	java/io/BufferedOutputStream:flush	()V
    //   59: iload 4
    //   61: ifeq +10 -> 71
    //   64: aload 7
    //   66: astore_1
    //   67: aload_0
    //   68: invokevirtual 349	android/graphics/Bitmap:recycle	()V
    //   71: iload 5
    //   73: istore 6
    //   75: aload 7
    //   77: ifnull +12 -> 89
    //   80: aload 7
    //   82: invokevirtual 350	java/io/BufferedOutputStream:close	()V
    //   85: iload 5
    //   87: istore 6
    //   89: iload 6
    //   91: ireturn
    ...
    //   97: ldc_w 352
    //   100: aload 7
    //   102: invokestatic 356	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   105: goto -84 -> 21
    //   108: astore_0
    //   109: aload_0
    //   110: invokevirtual 357	java/io/IOException:printStackTrace	()V
    //   113: iload 5
    //   115: ireturn
    //   116: astore_0
    //   117: aconst_null
    ...
    //   127: ldc_w 359
    //   130: aload_0
    //   131: invokestatic 356	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   134: iload 4
    //   136: istore 6
    //   138: aload_2
    //   139: ifnull -50 -> 89
    //   142: aload_2
    //   143: invokevirtual 350	java/io/BufferedOutputStream:close	()V
    //   146: iload 4
    //   148: ireturn
    //   149: astore_0
    //   150: aload_0
    //   151: invokevirtual 357	java/io/IOException:printStackTrace	()V
    //   154: iload 4
    //   156: ireturn
    //   157: astore_0
    //   158: aconst_null
    ...
    //   161: ifnull +7 -> 168
    //   164: aload_1
    //   165: invokevirtual 350	java/io/BufferedOutputStream:close	()V
    //   168: aload_0
    //   169: athrow
    //   170: astore_1
    //   171: aload_1
    //   172: invokevirtual 357	java/io/IOException:printStackTrace	()V
    //   175: goto -7 -> 168
    //   178: astore_0
    //   179: goto -19 -> 160
    //   182: astore_0
