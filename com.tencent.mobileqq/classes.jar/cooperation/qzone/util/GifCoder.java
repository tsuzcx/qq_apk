...
public class GifCoder
{
  ...
  private int jdField_a_of_type_Int = bggt.b();
  ...
  private static boolean a()
  {
    ...
    bget.a().b(new bgfe(arrayOfBoolean, localCountDownLatch));
    try
    {
  ...
  public boolean a(String paramString, ArrayList<String> paramArrayList, int paramInt, boolean paramBoolean)
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      if (this.jdField_c_of_type_Boolean)
      {
        localObject2 = bgfo.a(str, (Bitmap)localObject1);
        label98:
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        break;
        localObject2 = bgfo.a(str, this.jdField_a_of_type_Int, this.jdField_a_of_type_Int, this.jdField_b_of_type_Boolean, (Bitmap)localObject1);
        break label98;
  ...
  public boolean a(String paramString, JSONArray paramJSONArray, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (i < paramJSONArray.length()) {
      if (paramBoolean2)
      {
        ...
        if (!bgic.a((String)localObject2))
        {
          QLog.e("GifCoder", 1, "file name is invalid. name=" + (String)localObject2);
          return false;
        }
        localObject2 = bftg.b().a((String)localObject2);
    ...
    for (;;)
    {
      try
      {
        localObject3 = bgjb.a((File)localObject3);
