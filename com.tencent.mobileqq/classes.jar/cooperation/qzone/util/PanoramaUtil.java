...
public class PanoramaUtil
{
  ...
  private static PanoramaUtil jdField_a_of_type_CooperationQzoneUtilPanoramaUtil;
  ...
  {
    if (jdField_a_of_type_CooperationQzoneUtilPanoramaUtil == null) {}
    try
    {
      if (jdField_a_of_type_CooperationQzoneUtilPanoramaUtil == null) {
        jdField_a_of_type_CooperationQzoneUtilPanoramaUtil = new PanoramaUtil();
      }
      return jdField_a_of_type_CooperationQzoneUtilPanoramaUtil;
    }
    finally {}
  }
  
  private ArrayList a(ArrayList paramArrayList, float paramFloat, boolean paramBoolean)
  {
    ArrayList localArrayList = paramArrayList;
    if (paramArrayList == null) {
      localArrayList = new ArrayList();
    }
    QZLog.i("PanoramaUtil", 4, new Object[] { "cylinderList size = ", Integer.valueOf(localArrayList.size()) });
    if ((localArrayList.size() == 2) && (localArrayList.get(0) != null) && (((float[])localArrayList.get(0)).length > 0) && (localArrayList.get(1) != null) && (((float[])localArrayList.get(1)).length > 0)) {
  ...
  public ArrayList a(float paramFloat, boolean paramBoolean)
  {
