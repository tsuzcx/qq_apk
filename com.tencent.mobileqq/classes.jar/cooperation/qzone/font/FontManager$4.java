...
public class FontManager$4
  implements Runnable
{
  public FontManager$4(bfva parambfva, String paramString, int paramInt) {}
  ...
  public void run()
  {
    ...
    if (HttpDownloadUtil.a(null, this.jdField_a_of_type_JavaLangString, new File(bfva.a(this.this$0, this.jdField_a_of_type_Int)))) {
      bfva.a(this.this$0, this.jdField_a_of_type_Int);
    }
    for (;;)
    {
      bfva.a(this.this$0, this.jdField_a_of_type_Int);
