...
public class FontManager$4
  implements Runnable
{
  public FontManager$4(blya paramblya, String paramString, int paramInt) {}
  ...
  public void run()
  {
    ...
    if (HttpDownloadUtil.a(null, this.jdField_a_of_type_JavaLangString, new File(blya.a(this.this$0, this.jdField_a_of_type_Int)))) {
      blya.a(this.this$0, this.jdField_a_of_type_Int);
    }
    for (;;)
    {
      blya.a(this.this$0, this.jdField_a_of_type_Int);
