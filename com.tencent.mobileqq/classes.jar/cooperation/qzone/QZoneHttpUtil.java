...
public class QZoneHttpUtil
{
  ...
  public static int a(String paramString, java.io.File paramFile)
  {
    ...
    //   9: aconst_null
    //   10: astore 6
    //   12: invokestatic 33	cooperation/qzone/util/NetworkState:isWap	()Z
    //   15: ifeq +231 -> 246
    //   18: getstatic 38	cooperation/qzone/QZoneHttpUtil$HttpProxy:a	Lcooperation/qzone/QZoneHttpUtil$HttpProxy;
    //   21: astore 4
    //   23: aload 4
    //   25: ifnull +395 -> 420
    //   28: aload_0
    //   29: invokestatic 41	cooperation/qzone/QZoneHttpUtil:a	(Ljava/lang/String;)[Ljava/lang/String;
    //   32: astore 5
    //   34: new 43	java/lang/StringBuilder
    //   37: dup
    //   38: invokespecial 44	java/lang/StringBuilder:<init>	()V
    //   41: aload 4
    //   43: invokevirtual 48	cooperation/qzone/QZoneHttpUtil$HttpProxy:toString	()Ljava/lang/String;
    ...
    //   59: astore_0
    //   60: aload_0
    //   61: invokevirtual 56	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   64: ldc 10
    //   66: invokevirtual 60	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   69: ifeq +183 -> 252
    //   72: new 62	java/net/URL
    //   75: dup
    //   76: aload_0
    //   77: invokespecial 65	java/net/URL:<init>	(Ljava/lang/String;)V
    //   80: invokevirtual 69	java/net/URL:openConnection	()Ljava/net/URLConnection;
    //   83: checkcast 71	java/net/HttpURLConnection
    //   86: astore_0
    //   87: aload_0
    //   88: sipush 30000
    //   91: invokevirtual 75	java/net/HttpURLConnection:setReadTimeout	(I)V
    //   94: aload_0
    //   95: sipush 15000
    //   98: invokevirtual 78	java/net/HttpURLConnection:setConnectTimeout	(I)V
    //   101: aload_0
    //   102: ldc 80
    //   104: invokevirtual 83	java/net/HttpURLConnection:setRequestMethod	(Ljava/lang/String;)V
    //   107: aload_0
    //   108: iconst_1
    //   109: invokevirtual 87	java/net/HttpURLConnection:setDoInput	(Z)V
    //   112: aload 4
    //   114: ifnull +13 -> 127
    //   117: aload_0
    //   118: ldc 89
    ...
    //   122: iconst_0
    //   123: aaload
    //   124: invokevirtual 93	java/net/HttpURLConnection:setRequestProperty	(Ljava/lang/String;Ljava/lang/String;)V
    //   127: aload_0
    //   128: invokevirtual 96	java/net/HttpURLConnection:getResponseCode	()I
    //   131: istore_2
    //   132: aload 9
    //   134: astore 4
    //   136: iload_2
    //   137: invokestatic 99	cooperation/qzone/QZoneHttpUtil:a	(I)Z
    //   140: ifeq +133 -> 273
    //   143: new 101	java/io/BufferedOutputStream
    //   146: dup
    //   147: new 103	java/io/FileOutputStream
    //   150: dup
    //   151: aload_1
    //   152: iconst_1
    //   153: invokespecial 106	java/io/FileOutputStream:<init>	(Ljava/io/File;Z)V
    //   156: invokespecial 109	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   159: astore_1
    //   160: aload_0
    //   161: invokevirtual 113	java/net/HttpURLConnection:getInputStream	()Ljava/io/InputStream;
    //   164: astore 4
    //   166: sipush 8192
    //   169: newarray byte
    //   171: astore 5
    ...
    //   178: aload 5
    //   180: arraylength
    //   181: invokevirtual 119	java/io/InputStream:read	([BII)I
    //   184: istore_3
    //   185: iconst_m1
    //   186: iload_3
    ...
    //   193: iconst_0
    //   194: iload_3
    //   195: invokevirtual 123	java/io/BufferedOutputStream:write	([BII)V
    //   198: goto -25 -> 173
    //   201: astore 5
    //   203: aload_1
    //   204: astore 6
    ...
    //   215: ldc 127
    //   217: aload 5
    //   219: invokestatic 133	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   222: sipush 1024
    //   225: istore_3
    //   226: aload 6
    //   228: invokestatic 138	cooperation/qzone/util/DataUtils:a	(Ljava/lang/Object;)Z
    //   231: pop
    //   232: iload_3
    //   233: istore_2
    //   234: aload_0
    ...
    //   271: astore 4
    //   273: aload 4
    //   275: invokestatic 138	cooperation/qzone/util/DataUtils:a	(Ljava/lang/Object;)Z
    //   278: pop
    //   279: aload_0
    //   280: ifnull +138 -> 418
    //   283: aload_0
    ...
    //   306: ldc 153
    //   308: aload 5
    //   310: invokestatic 133	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   313: sipush 4096
    //   316: istore_2
    //   317: aload 6
    //   319: invokestatic 138	cooperation/qzone/util/DataUtils:a	(Ljava/lang/Object;)Z
    //   322: pop
    //   323: aload_0
    //   324: ifnull -80 -> 244
    //   327: aload_0
    ...
    //   340: astore 4
    //   342: aload 4
    //   344: invokestatic 138	cooperation/qzone/util/DataUtils:a	(Ljava/lang/Object;)Z
    //   347: pop
    //   348: aload_1
    //   349: ifnull +7 -> 356
    //   352: aload_1
